...
class GetPublisherAccountRequest extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'GetPublisherAccountRequest', package: const $pb.PackageName(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'google.ads.admob.v1'), createEmptyInstance: create)
  ...
  'Will be removed in next major version')
  GetPublisherAccountRequest copyWith(void Function(GetPublisherAccountRequest) updates) => super.copyWith((message) => updates(message as GetPublisherAccountRequest)) as GetPublisherAccountRequest; // ignore: deprecated_member_use
...
class ListPublisherAccountsRequest extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'ListPublisherAccountsRequest', package: const $pb.PackageName(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'google.ads.admob.v1'), createEmptyInstance: create)
  ...
  'Use [GeneratedMessageGenericExtensions.rebuild] instead. '
  'Will be removed in next major version')
  ListPublisherAccountsRequest copyWith(void Function(ListPublisherAccountsRequest) updates) => super.copyWith((message) => updates(message as ListPublisherAccountsRequest)) as ListPublisherAccountsRequest; // ignore: deprecated_member_use
  $pb.BuilderInfo get info_ => _i;
  @$core.pragma('dart2js:noInline')
...
class ListPublisherAccountsResponse extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'ListPublisherAccountsResponse', package: const $pb.PackageName(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'google.ads.admob.v1'), createEmptyInstance: create)
    ..pc<$1.PublisherAccount>(1, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'account', $pb.PbFieldType.PM, subBuilder: $1.PublisherAccount.create)
  ...
  'Use [GeneratedMessageGenericExtensions.rebuild] instead. '
  'Will be removed in next major version')
  ListPublisherAccountsResponse copyWith(void Function(ListPublisherAccountsResponse) updates) => super.copyWith((message) => updates(message as ListPublisherAccountsResponse)) as ListPublisherAccountsResponse; // ignore: deprecated_member_use
  $pb.BuilderInfo get info_ => _i;
  @$core.pragma('dart2js:noInline')
...
class GenerateMediationReportRequest extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'GenerateMediationReportRequest', package: const $pb.PackageName(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'google.ads.admob.v1'), createEmptyInstance: create)
    ..aOS(1, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'parent')
    ..aOM<$1.MediationReportSpec>(2, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'reportSpec', subBuilder: $1.MediationReportSpec.create)
    ..hasRequiredFields = false
  ;
  ...
  'Use [GeneratedMessageGenericExtensions.rebuild] instead. '
  'Will be removed in next major version')
  GenerateMediationReportRequest copyWith(void Function(GenerateMediationReportRequest) updates) => super.copyWith((message) => updates(message as GenerateMediationReportRequest)) as GenerateMediationReportRequest; // ignore: deprecated_member_use
  $pb.BuilderInfo get info_ => _i;
  @$core.pragma('dart2js:noInline')
  ...
  @$pb.TagNumber(2)
  set reportSpec($1.MediationReportSpec v) { setField(2, v); }
  @$pb.TagNumber(2)
...
class GenerateMediationReportResponse extends $pb.GeneratedMessage {
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'GenerateMediationReportResponse', package: const $pb.PackageName(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'google.ads.admob.v1'), createEmptyInstance: create)
    ..oo(0, [1, 2, 3])
    ..aOM<$1.ReportHeader>(1, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'header', subBuilder: $1.ReportHeader.create)
    ..aOM<$1.ReportRow>(2, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'row', subBuilder: $1.ReportRow.create)
    ..aOM<$1.ReportFooter>(3, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'footer', subBuilder: $1.ReportFooter.create)
    ..hasRequiredFields = false
  ;
  ...
  'Use [GeneratedMessageGenericExtensions.rebuild] instead. '
  'Will be removed in next major version')
  GenerateMediationReportResponse copyWith(void Function(GenerateMediationReportResponse) updates) => super.copyWith((message) => updates(message as GenerateMediationReportResponse)) as GenerateMediationReportResponse; // ignore: deprecated_member_use
  $pb.BuilderInfo get info_ => _i;
  @$core.pragma('dart2js:noInline')
  ...
  @$pb.TagNumber(1)
  set header($1.ReportHeader v) { setField(1, v); }
  @$pb.TagNumber(1)
  ...
  @$pb.TagNumber(2)
  set row($1.ReportRow v) { setField(2, v); }
  @$pb.TagNumber(2)
  ...
  @$pb.TagNumber(3)
  set footer($1.ReportFooter v) { setField(3, v); }
  @$pb.TagNumber(3)
...
class GenerateNetworkReportRequest extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'GenerateNetworkReportRequest', package: const $pb.PackageName(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'google.ads.admob.v1'), createEmptyInstance: create)
    ..aOS(1, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'parent')
    ..aOM<$1.NetworkReportSpec>(2, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'reportSpec', subBuilder: $1.NetworkReportSpec.create)
    ..hasRequiredFields = false
  ;
  ...
  'Use [GeneratedMessageGenericExtensions.rebuild] instead. '
  'Will be removed in next major version')
  GenerateNetworkReportRequest copyWith(void Function(GenerateNetworkReportRequest) updates) => super.copyWith((message) => updates(message as GenerateNetworkReportRequest)) as GenerateNetworkReportRequest; // ignore: deprecated_member_use
  $pb.BuilderInfo get info_ => _i;
  @$core.pragma('dart2js:noInline')
  ...
  @$pb.TagNumber(2)
  set reportSpec($1.NetworkReportSpec v) { setField(2, v); }
  @$pb.TagNumber(2)
  $core.bool hasReportSpec() => $_has(1);
  @$pb.TagNumber(2)
  void clearReportSpec() => clearField(2);
...
class GenerateNetworkReportResponse extends $pb.GeneratedMessage {
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'GenerateNetworkReportResponse', package: const $pb.PackageName(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'google.ads.admob.v1'), createEmptyInstance: create)
    ..oo(0, [1, 2, 3])
    ..aOM<$1.ReportHeader>(1, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'header', subBuilder: $1.ReportHeader.create)
    ..aOM<$1.ReportRow>(2, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'row', subBuilder: $1.ReportRow.create)
    ..aOM<$1.ReportFooter>(3, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'footer', subBuilder: $1.ReportFooter.create)
  ...
  'Use [GeneratedMessageGenericExtensions.rebuild] instead. '
  'Will be removed in next major version')
  GenerateNetworkReportResponse copyWith(void Function(GenerateNetworkReportResponse) updates) => super.copyWith((message) => updates(message as GenerateNetworkReportResponse)) as GenerateNetworkReportResponse; // ignore: deprecated_member_use
  $pb.BuilderInfo get info_ => _i;
  @$core.pragma('dart2js:noInline')

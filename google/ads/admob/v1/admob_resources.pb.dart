...
class PublisherAccount extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'PublisherAccount', package: const $pb.PackageName(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'google.ads.admob.v1'), createEmptyInstance: create)
    ..aOS(1, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'name')
    ..aOS(2, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'publisherId')
    ..aOS(3, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'reportingTimeZone')
  ...
  'Will be removed in next major version')
  PublisherAccount copyWith(void Function(PublisherAccount) updates) => super.copyWith((message) => updates(message as PublisherAccount)) as PublisherAccount; // ignore: deprecated_member_use
...
class NetworkReportSpec_DimensionFilter extends $pb.GeneratedMessage {
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'NetworkReportSpec.DimensionFilter', package: const $pb.PackageName(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'google.ads.admob.v1'), createEmptyInstance: create)
    ..oo(0, [2])
    ..e<NetworkReportSpec_Dimension>(1, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'dimension', $pb.PbFieldType.OE, defaultOrMaker: NetworkReportSpec_Dimension.DIMENSION_UNSPECIFIED, valueOf: NetworkReportSpec_Dimension.valueOf, enumValues: NetworkReportSpec_Dimension.values)
    ..aOM<StringList>(2, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'matchesAny', subBuilder: StringList.create)
    ..hasRequiredFields = false
  ;
  ...
  'Use [GeneratedMessageGenericExtensions.rebuild] instead. '
  'Will be removed in next major version')
  NetworkReportSpec_DimensionFilter copyWith(void Function(NetworkReportSpec_DimensionFilter) updates) => super.copyWith((message) => updates(message as NetworkReportSpec_DimensionFilter)) as NetworkReportSpec_DimensionFilter; // ignore: deprecated_member_use
  $pb.BuilderInfo get info_ => _i;
  @$core.pragma('dart2js:noInline')
...
class NetworkReportSpec_SortCondition extends $pb.GeneratedMessage {
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'NetworkReportSpec.SortCondition', package: const $pb.PackageName(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'google.ads.admob.v1'), createEmptyInstance: create)
    ..oo(0, [1, 2])
    ..e<NetworkReportSpec_Dimension>(1, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'dimension', $pb.PbFieldType.OE, defaultOrMaker: NetworkReportSpec_Dimension.DIMENSION_UNSPECIFIED, valueOf: NetworkReportSpec_Dimension.valueOf, enumValues: NetworkReportSpec_Dimension.values)
    ..e<NetworkReportSpec_Metric>(2, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'metric', $pb.PbFieldType.OE, defaultOrMaker: NetworkReportSpec_Metric.METRIC_UNSPECIFIED, valueOf: NetworkReportSpec_Metric.valueOf, enumValues: NetworkReportSpec_Metric.values)
    ..e<SortOrder>(3, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'order', $pb.PbFieldType.OE, defaultOrMaker: SortOrder.SORT_ORDER_UNSPECIFIED, valueOf: SortOrder.valueOf, enumValues: SortOrder.values)
    ..hasRequiredFields = false
  ;
  ...
  'Use [GeneratedMessageGenericExtensions.rebuild] instead. '
  'Will be removed in next major version')
  NetworkReportSpec_SortCondition copyWith(void Function(NetworkReportSpec_SortCondition) updates) => super.copyWith((message) => updates(message as NetworkReportSpec_SortCondition)) as NetworkReportSpec_SortCondition; // ignore: deprecated_member_use
  $pb.BuilderInfo get info_ => _i;
  @$core.pragma('dart2js:noInline')
...
class NetworkReportSpec extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'NetworkReportSpec', package: const $pb.PackageName(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'google.ads.admob.v1'), createEmptyInstance: create)
    ..aOM<DateRange>(1, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'dateRange', subBuilder: DateRange.create)
    ..pc<NetworkReportSpec_Dimension>(2, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'dimensions', $pb.PbFieldType.PE, valueOf: NetworkReportSpec_Dimension.valueOf, enumValues: NetworkReportSpec_Dimension.values)
    ..pc<NetworkReportSpec_Metric>(3, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'metrics', $pb.PbFieldType.PE, valueOf: NetworkReportSpec_Metric.valueOf, enumValues: NetworkReportSpec_Metric.values)
    ..pc<NetworkReportSpec_DimensionFilter>(4, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'dimensionFilters', $pb.PbFieldType.PM, subBuilder: NetworkReportSpec_DimensionFilter.create)
    ..pc<NetworkReportSpec_SortCondition>(5, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'sortConditions', $pb.PbFieldType.PM, subBuilder: NetworkReportSpec_SortCondition.create)
    ..aOM<LocalizationSettings>(6, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'localizationSettings', subBuilder: LocalizationSettings.create)
    ..a<$core.int>(7, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'maxReportRows', $pb.PbFieldType.O3)
    ..aOS(8, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'timeZone')
    ..hasRequiredFields = false
  ;
  ...
  'Use [GeneratedMessageGenericExtensions.rebuild] instead. '
  'Will be removed in next major version')
  NetworkReportSpec copyWith(void Function(NetworkReportSpec) updates) => super.copyWith((message) => updates(message as NetworkReportSpec)) as NetworkReportSpec; // ignore: deprecated_member_use
  $pb.BuilderInfo get info_ => _i;
  @$core.pragma('dart2js:noInline')
...
class MediationReportSpec_DimensionFilter extends $pb.GeneratedMessage {
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'MediationReportSpec.DimensionFilter', package: const $pb.PackageName(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'google.ads.admob.v1'), createEmptyInstance: create)
    ..oo(0, [2])
    ..e<MediationReportSpec_Dimension>(1, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'dimension', $pb.PbFieldType.OE, defaultOrMaker: MediationReportSpec_Dimension.DIMENSION_UNSPECIFIED, valueOf: MediationReportSpec_Dimension.valueOf, enumValues: MediationReportSpec_Dimension.values)
    ..aOM<StringList>(2, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'matchesAny', subBuilder: StringList.create)
    ..hasRequiredFields = false
  ;
  ...
  'Use [GeneratedMessageGenericExtensions.rebuild] instead. '
  'Will be removed in next major version')
  MediationReportSpec_DimensionFilter copyWith(void Function(MediationReportSpec_DimensionFilter) updates) => super.copyWith((message) => updates(message as MediationReportSpec_DimensionFilter)) as MediationReportSpec_DimensionFilter; // ignore: deprecated_member_use
  $pb.BuilderInfo get info_ => _i;
  @$core.pragma('dart2js:noInline')
...
class MediationReportSpec_SortCondition extends $pb.GeneratedMessage {
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'MediationReportSpec.SortCondition', package: const $pb.PackageName(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'google.ads.admob.v1'), createEmptyInstance: create)
    ..oo(0, [1, 2])
    ..e<MediationReportSpec_Dimension>(1, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'dimension', $pb.PbFieldType.OE, defaultOrMaker: MediationReportSpec_Dimension.DIMENSION_UNSPECIFIED, valueOf: MediationReportSpec_Dimension.valueOf, enumValues: MediationReportSpec_Dimension.values)
    ..e<MediationReportSpec_Metric>(2, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'metric', $pb.PbFieldType.OE, defaultOrMaker: MediationReportSpec_Metric.METRIC_UNSPECIFIED, valueOf: MediationReportSpec_Metric.valueOf, enumValues: MediationReportSpec_Metric.values)
    ..e<SortOrder>(3, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'order', $pb.PbFieldType.OE, defaultOrMaker: SortOrder.SORT_ORDER_UNSPECIFIED, valueOf: SortOrder.valueOf, enumValues: SortOrder.values)
    ..hasRequiredFields = false
  ;
  ...
  'Use [GeneratedMessageGenericExtensions.rebuild] instead. '
  'Will be removed in next major version')
  MediationReportSpec_SortCondition copyWith(void Function(MediationReportSpec_SortCondition) updates) => super.copyWith((message) => updates(message as MediationReportSpec_SortCondition)) as MediationReportSpec_SortCondition; // ignore: deprecated_member_use
  $pb.BuilderInfo get info_ => _i;
  @$core.pragma('dart2js:noInline')
...
class MediationReportSpec extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'MediationReportSpec', package: const $pb.PackageName(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'google.ads.admob.v1'), createEmptyInstance: create)
    ..aOM<DateRange>(1, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'dateRange', subBuilder: DateRange.create)
    ..pc<MediationReportSpec_Dimension>(2, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'dimensions', $pb.PbFieldType.PE, valueOf: MediationReportSpec_Dimension.valueOf, enumValues: MediationReportSpec_Dimension.values)
    ..pc<MediationReportSpec_Metric>(3, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'metrics', $pb.PbFieldType.PE, valueOf: MediationReportSpec_Metric.valueOf, enumValues: MediationReportSpec_Metric.values)
    ..pc<MediationReportSpec_DimensionFilter>(4, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'dimensionFilters', $pb.PbFieldType.PM, subBuilder: MediationReportSpec_DimensionFilter.create)
    ..pc<MediationReportSpec_SortCondition>(5, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'sortConditions', $pb.PbFieldType.PM, subBuilder: MediationReportSpec_SortCondition.create)
    ..aOM<LocalizationSettings>(6, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'localizationSettings', subBuilder: LocalizationSettings.create)
    ..a<$core.int>(7, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'maxReportRows', $pb.PbFieldType.O3)
    ..aOS(8, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'timeZone')
    ..hasRequiredFields = false
  ...
  'Use [GeneratedMessageGenericExtensions.rebuild] instead. '
  'Will be removed in next major version')
  MediationReportSpec copyWith(void Function(MediationReportSpec) updates) => super.copyWith((message) => updates(message as MediationReportSpec)) as MediationReportSpec; // ignore: deprecated_member_use
  $pb.BuilderInfo get info_ => _i;
  @$core.pragma('dart2js:noInline')
...
class ReportRow_DimensionValue extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'ReportRow.DimensionValue', package: const $pb.PackageName(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'google.ads.admob.v1'), createEmptyInstance: create)
    ..aOS(1, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'value')
    ..aOS(2, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'displayLabel')
    ..hasRequiredFields = false
  ;
  ...
  'Use [GeneratedMessageGenericExtensions.rebuild] instead. '
  'Will be removed in next major version')
  ReportRow_DimensionValue copyWith(void Function(ReportRow_DimensionValue) updates) => super.copyWith((message) => updates(message as ReportRow_DimensionValue)) as ReportRow_DimensionValue; // ignore: deprecated_member_use
  $pb.BuilderInfo get info_ => _i;
  @$core.pragma('dart2js:noInline')
...
class ReportRow_MetricValue extends $pb.GeneratedMessage {
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'ReportRow.MetricValue', package: const $pb.PackageName(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'google.ads.admob.v1'), createEmptyInstance: create)
    ..oo(0, [1, 2, 3])
    ...
    ..aInt64(3, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'microsValue')
    ..hasRequiredFields = false
  ;
  ...
  'Use [GeneratedMessageGenericExtensions.rebuild] instead. '
  'Will be removed in next major version')
  ReportRow_MetricValue copyWith(void Function(ReportRow_MetricValue) updates) => super.copyWith((message) => updates(message as ReportRow_MetricValue)) as ReportRow_MetricValue; // ignore: deprecated_member_use
  $pb.BuilderInfo get info_ => _i;
  @$core.pragma('dart2js:noInline')
...
class ReportRow extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'ReportRow', package: const $pb.PackageName(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'google.ads.admob.v1'), createEmptyInstance: create)
    ..m<$core.String, ReportRow_DimensionValue>(1, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'dimensionValues', entryClassName: 'ReportRow.DimensionValuesEntry', keyFieldType: $pb.PbFieldType.OS, valueFieldType: $pb.PbFieldType.OM, valueCreator: ReportRow_DimensionValue.create, packageName: const $pb.PackageName('google.ads.admob.v1'))
    ..m<$core.String, ReportRow_MetricValue>(2, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'metricValues', entryClassName: 'ReportRow.MetricValuesEntry', keyFieldType: $pb.PbFieldType.OS, valueFieldType: $pb.PbFieldType.OM, valueCreator: ReportRow_MetricValue.create, packageName: const $pb.PackageName('google.ads.admob.v1'))
    ..hasRequiredFields = false
  ;
  ...
  'Use [GeneratedMessageGenericExtensions.rebuild] instead. '
  'Will be removed in next major version')
  ReportRow copyWith(void Function(ReportRow) updates) => super.copyWith((message) => updates(message as ReportRow)) as ReportRow; // ignore: deprecated_member_use
  $pb.BuilderInfo get info_ => _i;
  @$core.pragma('dart2js:noInline')
...
class ReportWarning extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'ReportWarning', package: const $pb.PackageName(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'google.ads.admob.v1'), createEmptyInstance: create)
    ..e<ReportWarning_Type>(1, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'type', $pb.PbFieldType.OE, defaultOrMaker: ReportWarning_Type.TYPE_UNSPECIFIED, valueOf: ReportWarning_Type.valueOf, enumValues: ReportWarning_Type.values)
  ...
  'Use [GeneratedMessageGenericExtensions.rebuild] instead. '
  'Will be removed in next major version')
  ReportWarning copyWith(void Function(ReportWarning) updates) => super.copyWith((message) => updates(message as ReportWarning)) as ReportWarning; // ignore: deprecated_member_use
  $pb.BuilderInfo get info_ => _i;
  @$core.pragma('dart2js:noInline')
...
class ReportHeader extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'ReportHeader', package: const $pb.PackageName(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'google.ads.admob.v1'), createEmptyInstance: create)
    ..aOM<DateRange>(1, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'dateRange', subBuilder: DateRange.create)
    ..aOM<LocalizationSettings>(2, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'localizationSettings', subBuilder: LocalizationSettings.create)
    ..aOS(3, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'reportingTimeZone')
    ..hasRequiredFields = false
  ;
  ...
  'Use [GeneratedMessageGenericExtensions.rebuild] instead. '
  'Will be removed in next major version')
  ReportHeader copyWith(void Function(ReportHeader) updates) => super.copyWith((message) => updates(message as ReportHeader)) as ReportHeader; // ignore: deprecated_member_use
  $pb.BuilderInfo get info_ => _i;
  @$core.pragma('dart2js:noInline')
...
class ReportFooter extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'ReportFooter', package: const $pb.PackageName(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'google.ads.admob.v1'), createEmptyInstance: create)
    ..pc<ReportWarning>(1, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'warnings', $pb.PbFieldType.PM, subBuilder: ReportWarning.create)
    ..aInt64(2, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'matchingRowCount')
    ..hasRequiredFields = false
  ;
  ...
  'Use [GeneratedMessageGenericExtensions.rebuild] instead. '
  'Will be removed in next major version')
  ReportFooter copyWith(void Function(ReportFooter) updates) => super.copyWith((message) => updates(message as ReportFooter)) as ReportFooter; // ignore: deprecated_member_use
  $pb.BuilderInfo get info_ => _i;
  @$core.pragma('dart2js:noInline')
...
class DateRange extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'DateRange', package: const $pb.PackageName(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'google.ads.admob.v1'), createEmptyInstance: create)
    ..aOM<$0.Date>(1, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'startDate', subBuilder: $0.Date.create)
    ..aOM<$0.Date>(2, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'endDate', subBuilder: $0.Date.create)
    ..hasRequiredFields = false
  ;
  ...
  @$pb.TagNumber(1)
  set startDate($0.Date v) { setField(1, v); }
  @$pb.TagNumber(1)
  ...
  @$pb.TagNumber(2)
  set endDate($0.Date v) { setField(2, v); }
  @$pb.TagNumber(2)
...
class LocalizationSettings extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'LocalizationSettings', package: const $pb.PackageName(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'google.ads.admob.v1'), createEmptyInstance: create)
  ...
  'Use [GeneratedMessageGenericExtensions.rebuild] instead. '
  'Will be removed in next major version')
  LocalizationSettings copyWith(void Function(LocalizationSettings) updates) => super.copyWith((message) => updates(message as LocalizationSettings)) as LocalizationSettings; // ignore: deprecated_member_use
  $pb.BuilderInfo get info_ => _i;
  @$core.pragma('dart2js:noInline')
...
class StringList extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'StringList', package: const $pb.PackageName(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'google.ads.admob.v1'), createEmptyInstance: create)
  ...
  'Use [GeneratedMessageGenericExtensions.rebuild] instead. '
  'Will be removed in next major version')
  StringList copyWith(void Function(StringList) updates) => super.copyWith((message) => updates(message as StringList)) as StringList; // ignore: deprecated_member_use
  $pb.BuilderInfo get info_ => _i;
  @$core.pragma('dart2js:noInline')

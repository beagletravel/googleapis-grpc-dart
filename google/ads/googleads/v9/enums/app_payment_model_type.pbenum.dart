...
class AppPaymentModelTypeEnum_AppPaymentModelType extends $pb.ProtobufEnum {
  static const AppPaymentModelTypeEnum_AppPaymentModelType UNSPECIFIED = AppPaymentModelTypeEnum_AppPaymentModelType._(0, const $core.bool.fromEnvironment('protobuf.omit_enum_names') ? '' : 'UNSPECIFIED');
  static const AppPaymentModelTypeEnum_AppPaymentModelType UNKNOWN = AppPaymentModelTypeEnum_AppPaymentModelType._(1, const $core.bool.fromEnvironment('protobuf.omit_enum_names') ? '' : 'UNKNOWN');
  static const AppPaymentModelTypeEnum_AppPaymentModelType PAID = AppPaymentModelTypeEnum_AppPaymentModelType._(30, const $core.bool.fromEnvironment('protobuf.omit_enum_names') ? '' : 'PAID');

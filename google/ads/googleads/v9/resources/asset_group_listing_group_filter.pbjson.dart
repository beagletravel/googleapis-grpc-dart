...
const AssetGroupListingGroupFilter$json = const {
  ...
  '2': const [
    ...
    const {'1': 'type', '3': 4, '4': 1, '5': 14, '6': '.google.ads.googleads.v9.enums.ListingGroupFilterTypeEnum.ListingGroupFilterType', '8': const {}, '10': 'type'},
    const {'1': 'vertical', '3': 5, '4': 1, '5': 14, '6': '.google.ads.googleads.v9.enums.ListingGroupFilterVerticalEnum.ListingGroupFilterVertical', '8': const {}, '10': 'vertical'},
    const {'1': 'case_value', '3': 6, '4': 1, '5': 11, '6': '.google.ads.googleads.v9.resources.ListingGroupFilterDimension', '10': 'caseValue'},
...
const ListingGroupFilterDimension$json = const {
  ...
  '2': const [
    const {'1': 'product_bidding_category', '3': 1, '4': 1, '5': 11, '6': '.google.ads.googleads.v9.resources.ListingGroupFilterDimension.ProductBiddingCategory', '9': 0, '10': 'productBiddingCategory'},
    const {'1': 'product_brand', '3': 2, '4': 1, '5': 11, '6': '.google.ads.googleads.v9.resources.ListingGroupFilterDimension.ProductBrand', '9': 0, '10': 'productBrand'},
    const {'1': 'product_channel', '3': 3, '4': 1, '5': 11, '6': '.google.ads.googleads.v9.resources.ListingGroupFilterDimension.ProductChannel', '9': 0, '10': 'productChannel'},
    const {'1': 'product_condition', '3': 4, '4': 1, '5': 11, '6': '.google.ads.googleads.v9.resources.ListingGroupFilterDimension.ProductCondition', '9': 0, '10': 'productCondition'},
    const {'1': 'product_custom_attribute', '3': 5, '4': 1, '5': 11, '6': '.google.ads.googleads.v9.resources.ListingGroupFilterDimension.ProductCustomAttribute', '9': 0, '10': 'productCustomAttribute'},
    const {'1': 'product_item_id', '3': 6, '4': 1, '5': 11, '6': '.google.ads.googleads.v9.resources.ListingGroupFilterDimension.ProductItemId', '9': 0, '10': 'productItemId'},
    const {'1': 'product_type', '3': 7, '4': 1, '5': 11, '6': '.google.ads.googleads.v9.resources.ListingGroupFilterDimension.ProductType', '9': 0, '10': 'productType'},
  ],
  '3': const [ListingGroupFilterDimension_ProductBiddingCategory$json, ListingGroupFilterDimension_ProductBrand$json, ListingGroupFilterDimension_ProductChannel$json, ListingGroupFilterDimension_ProductCustomAttribute$json, ListingGroupFilterDimension_ProductCondition$json, ListingGroupFilterDimension_ProductItemId$json, ListingGroupFilterDimension_ProductType$json],
  '8': const [
    const {'1': 'dimension'},
  ],
};
...
const ListingGroupFilterDimension_ProductBiddingCategory$json = const {
  ...
  '2': const [
    ...
    const {'1': 'level', '3': 2, '4': 1, '5': 14, '6': '.google.ads.googleads.v9.enums.ListingGroupFilterBiddingCategoryLevelEnum.ListingGroupFilterBiddingCategoryLevel', '10': 'level'},
  ],
  '8': const [
    const {'1': '_id'},
  ],
...
const ListingGroupFilterDimension_ProductChannel$json = const {
  '1': 'ProductChannel',
  '2': const [
    const {'1': 'channel', '3': 1, '4': 1, '5': 14, '6': '.google.ads.googleads.v9.enums.ListingGroupFilterProductChannelEnum.ListingGroupFilterProductChannel', '10': 'channel'},
  ],
};
...
const ListingGroupFilterDimension_ProductCustomAttribute$json = const {
  ...
  '2': const [
    const {'1': 'value', '3': 1, '4': 1, '5': 9, '9': 0, '10': 'value', '17': true},
    const {'1': 'index', '3': 2, '4': 1, '5': 14, '6': '.google.ads.googleads.v9.enums.ListingGroupFilterCustomAttributeIndexEnum.ListingGroupFilterCustomAttributeIndex', '10': 'index'},
  ],
  '8': const [
    const {'1': '_value'},
  ],
...
const ListingGroupFilterDimension_ProductCondition$json = const {
  '1': 'ProductCondition',
  '2': const [
    const {'1': 'condition', '3': 1, '4': 1, '5': 14, '6': '.google.ads.googleads.v9.enums.ListingGroupFilterProductConditionEnum.ListingGroupFilterProductCondition', '10': 'condition'},
  ],
};
...
const ListingGroupFilterDimension_ProductType$json = const {
  ...
  '2': const [
    const {'1': 'value', '3': 1, '4': 1, '5': 9, '9': 0, '10': 'value', '17': true},
    const {'1': 'level', '3': 2, '4': 1, '5': 14, '6': '.google.ads.googleads.v9.enums.ListingGroupFilterProductTypeLevelEnum.ListingGroupFilterProductTypeLevel', '10': 'level'},
  ],
  '8': const [
    const {'1': '_value'},
  ],

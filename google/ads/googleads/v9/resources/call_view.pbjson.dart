...
const CallView$json = const {
  ...
  '2': const [
    ...
    const {'1': 'call_tracking_display_location', '3': 7, '4': 1, '5': 14, '6': '.google.ads.googleads.v9.enums.CallTrackingDisplayLocationEnum.CallTrackingDisplayLocation', '8': const {}, '10': 'callTrackingDisplayLocation'},
    const {'1': 'type', '3': 8, '4': 1, '5': 14, '6': '.google.ads.googleads.v9.enums.CallTypeEnum.CallType', '8': const {}, '10': 'type'},
    const {'1': 'call_status', '3': 9, '4': 1, '5': 14, '6': '.google.ads.googleads.v9.enums.GoogleVoiceCallStatusEnum.GoogleVoiceCallStatus', '8': const {}, '10': 'callStatus'},
  ],
  '7': const {},
};

/// Descriptor for `CallView`. Decode as a `google.protobuf.DescriptorProto`.
final $typed_data.Uint8List callViewDescriptor = $convert.base64Decode('');

...
class AssetGroupListingGroupFilter extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'AssetGroupListingGroupFilter', package: const $pb.PackageName(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'google.ads.googleads.v9.resources'), createEmptyInstance: create)
    ...
    ..e<$0.ListingGroupFilterTypeEnum_ListingGroupFilterType>(4, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'type', $pb.PbFieldType.OE, defaultOrMaker: $0.ListingGroupFilterTypeEnum_ListingGroupFilterType.UNSPECIFIED, valueOf: $0.ListingGroupFilterTypeEnum_ListingGroupFilterType.valueOf, enumValues: $0.ListingGroupFilterTypeEnum_ListingGroupFilterType.values)
    ..e<$1.ListingGroupFilterVerticalEnum_ListingGroupFilterVertical>(5, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'vertical', $pb.PbFieldType.OE, defaultOrMaker: $1.ListingGroupFilterVerticalEnum_ListingGroupFilterVertical.UNSPECIFIED, valueOf: $1.ListingGroupFilterVerticalEnum_ListingGroupFilterVertical.valueOf, enumValues: $1.ListingGroupFilterVerticalEnum_ListingGroupFilterVertical.values)
    ..aOM<ListingGroupFilterDimension>(6, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'caseValue', subBuilder: ListingGroupFilterDimension.create)
    ..aOS(7, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'parentListingGroupFilter')
  ...
  'Will be removed in next major version')
  AssetGroupListingGroupFilter copyWith(void Function(AssetGroupListingGroupFilter) updates) => super.copyWith((message) => updates(message as AssetGroupListingGroupFilter)) as AssetGroupListingGroupFilter; // ignore: deprecated_member_use
  ...
  @$pb.TagNumber(4)
  set type($0.ListingGroupFilterTypeEnum_ListingGroupFilterType v) { setField(4, v); }
  @$pb.TagNumber(4)
  ...
  @$pb.TagNumber(5)
  $1.ListingGroupFilterVerticalEnum_ListingGroupFilterVertical get vertical => $_getN(4);
  @$pb.TagNumber(5)
  set vertical($1.ListingGroupFilterVerticalEnum_ListingGroupFilterVertical v) { setField(5, v); }
  @$pb.TagNumber(5)
...
class ListingGroupFilterDimension_ProductBiddingCategory extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'ListingGroupFilterDimension.ProductBiddingCategory', package: const $pb.PackageName(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'google.ads.googleads.v9.resources'), createEmptyInstance: create)
    ..aInt64(1, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'id')
    ..e<$2.ListingGroupFilterBiddingCategoryLevelEnum_ListingGroupFilterBiddingCategoryLevel>(2, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'level', $pb.PbFieldType.OE, defaultOrMaker: $2.ListingGroupFilterBiddingCategoryLevelEnum_ListingGroupFilterBiddingCategoryLevel.UNSPECIFIED, valueOf: $2.ListingGroupFilterBiddingCategoryLevelEnum_ListingGroupFilterBiddingCategoryLevel.valueOf, enumValues: $2.ListingGroupFilterBiddingCategoryLevelEnum_ListingGroupFilterBiddingCategoryLevel.values)
    ..hasRequiredFields = false
  ;
  ...
  factory ListingGroupFilterDimension_ProductBiddingCategory({
    $fixnum.Int64? id,
    $2.ListingGroupFilterBiddingCategoryLevelEnum_ListingGroupFilterBiddingCategoryLevel? level,
  }) {
    final _result = create();
    if (id != null) {
      _result.id = id;
  ...
  'Use [GeneratedMessageGenericExtensions.rebuild] instead. '
  'Will be removed in next major version')
  ListingGroupFilterDimension_ProductBiddingCategory copyWith(void Function(ListingGroupFilterDimension_ProductBiddingCategory) updates) => super.copyWith((message) => updates(message as ListingGroupFilterDimension_ProductBiddingCategory)) as ListingGroupFilterDimension_ProductBiddingCategory; // ignore: deprecated_member_use
  $pb.BuilderInfo get info_ => _i;
  @$core.pragma('dart2js:noInline')
  ...
  @$pb.TagNumber(2)
  $2.ListingGroupFilterBiddingCategoryLevelEnum_ListingGroupFilterBiddingCategoryLevel get level => $_getN(1);
  @$pb.TagNumber(2)
  set level($2.ListingGroupFilterBiddingCategoryLevelEnum_ListingGroupFilterBiddingCategoryLevel v) { setField(2, v); }
  @$pb.TagNumber(2)
...
class ListingGroupFilterDimension_ProductBrand extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'ListingGroupFilterDimension.ProductBrand', package: const $pb.PackageName(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'google.ads.googleads.v9.resources'), createEmptyInstance: create)
  ...
  'Use [GeneratedMessageGenericExtensions.rebuild] instead. '
  'Will be removed in next major version')
  ListingGroupFilterDimension_ProductBrand copyWith(void Function(ListingGroupFilterDimension_ProductBrand) updates) => super.copyWith((message) => updates(message as ListingGroupFilterDimension_ProductBrand)) as ListingGroupFilterDimension_ProductBrand; // ignore: deprecated_member_use
  $pb.BuilderInfo get info_ => _i;
  @$core.pragma('dart2js:noInline')
...
class ListingGroupFilterDimension_ProductChannel extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'ListingGroupFilterDimension.ProductChannel', package: const $pb.PackageName(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'google.ads.googleads.v9.resources'), createEmptyInstance: create)
    ..e<$3.ListingGroupFilterProductChannelEnum_ListingGroupFilterProductChannel>(1, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'channel', $pb.PbFieldType.OE, defaultOrMaker: $3.ListingGroupFilterProductChannelEnum_ListingGroupFilterProductChannel.UNSPECIFIED, valueOf: $3.ListingGroupFilterProductChannelEnum_ListingGroupFilterProductChannel.valueOf, enumValues: $3.ListingGroupFilterProductChannelEnum_ListingGroupFilterProductChannel.values)
    ..hasRequiredFields = false
  ;

  ListingGroupFilterDimension_ProductChannel._() : super();
  factory ListingGroupFilterDimension_ProductChannel({
    $3.ListingGroupFilterProductChannelEnum_ListingGroupFilterProductChannel? channel,
  }) {
    final _result = create();
    if (channel != null) {
  ...
  'Use [GeneratedMessageGenericExtensions.rebuild] instead. '
  'Will be removed in next major version')
  ListingGroupFilterDimension_ProductChannel copyWith(void Function(ListingGroupFilterDimension_ProductChannel) updates) => super.copyWith((message) => updates(message as ListingGroupFilterDimension_ProductChannel)) as ListingGroupFilterDimension_ProductChannel; // ignore: deprecated_member_use
  $pb.BuilderInfo get info_ => _i;
  @$core.pragma('dart2js:noInline')
  ...
  @$pb.TagNumber(1)
  $3.ListingGroupFilterProductChannelEnum_ListingGroupFilterProductChannel get channel => $_getN(0);
  @$pb.TagNumber(1)
  set channel($3.ListingGroupFilterProductChannelEnum_ListingGroupFilterProductChannel v) { setField(1, v); }
  @$pb.TagNumber(1)
...
class ListingGroupFilterDimension_ProductCustomAttribute extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'ListingGroupFilterDimension.ProductCustomAttribute', package: const $pb.PackageName(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'google.ads.googleads.v9.resources'), createEmptyInstance: create)
    ..aOS(1, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'value')
    ..e<$4.ListingGroupFilterCustomAttributeIndexEnum_ListingGroupFilterCustomAttributeIndex>(2, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'index', $pb.PbFieldType.OE, defaultOrMaker: $4.ListingGroupFilterCustomAttributeIndexEnum_ListingGroupFilterCustomAttributeIndex.UNSPECIFIED, valueOf: $4.ListingGroupFilterCustomAttributeIndexEnum_ListingGroupFilterCustomAttributeIndex.valueOf, enumValues: $4.ListingGroupFilterCustomAttributeIndexEnum_ListingGroupFilterCustomAttributeIndex.values)
    ..hasRequiredFields = false
  ;
  ...
  factory ListingGroupFilterDimension_ProductCustomAttribute({
    $core.String? value,
    $4.ListingGroupFilterCustomAttributeIndexEnum_ListingGroupFilterCustomAttributeIndex? index,
  }) {
    final _result = create();
    if (value != null) {
      _result.value = value;
  ...
  'Use [GeneratedMessageGenericExtensions.rebuild] instead. '
  'Will be removed in next major version')
  ListingGroupFilterDimension_ProductCustomAttribute copyWith(void Function(ListingGroupFilterDimension_ProductCustomAttribute) updates) => super.copyWith((message) => updates(message as ListingGroupFilterDimension_ProductCustomAttribute)) as ListingGroupFilterDimension_ProductCustomAttribute; // ignore: deprecated_member_use
  $pb.BuilderInfo get info_ => _i;
  @$core.pragma('dart2js:noInline')
  ...
  @$pb.TagNumber(2)
  $4.ListingGroupFilterCustomAttributeIndexEnum_ListingGroupFilterCustomAttributeIndex get index => $_getN(1);
  @$pb.TagNumber(2)
  set index($4.ListingGroupFilterCustomAttributeIndexEnum_ListingGroupFilterCustomAttributeIndex v) { setField(2, v); }
  @$pb.TagNumber(2)
...
class ListingGroupFilterDimension_ProductCondition extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'ListingGroupFilterDimension.ProductCondition', package: const $pb.PackageName(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'google.ads.googleads.v9.resources'), createEmptyInstance: create)
    ..e<$5.ListingGroupFilterProductConditionEnum_ListingGroupFilterProductCondition>(1, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'condition', $pb.PbFieldType.OE, defaultOrMaker: $5.ListingGroupFilterProductConditionEnum_ListingGroupFilterProductCondition.UNSPECIFIED, valueOf: $5.ListingGroupFilterProductConditionEnum_ListingGroupFilterProductCondition.valueOf, enumValues: $5.ListingGroupFilterProductConditionEnum_ListingGroupFilterProductCondition.values)
    ..hasRequiredFields = false
  ;

  ListingGroupFilterDimension_ProductCondition._() : super();
  factory ListingGroupFilterDimension_ProductCondition({
    $5.ListingGroupFilterProductConditionEnum_ListingGroupFilterProductCondition? condition,
  }) {
    final _result = create();
    if (condition != null) {
  ...
  'Use [GeneratedMessageGenericExtensions.rebuild] instead. '
  'Will be removed in next major version')
  ListingGroupFilterDimension_ProductCondition copyWith(void Function(ListingGroupFilterDimension_ProductCondition) updates) => super.copyWith((message) => updates(message as ListingGroupFilterDimension_ProductCondition)) as ListingGroupFilterDimension_ProductCondition; // ignore: deprecated_member_use
  $pb.BuilderInfo get info_ => _i;
  @$core.pragma('dart2js:noInline')
  ...
  @$pb.TagNumber(1)
  $5.ListingGroupFilterProductConditionEnum_ListingGroupFilterProductCondition get condition => $_getN(0);
  @$pb.TagNumber(1)
  set condition($5.ListingGroupFilterProductConditionEnum_ListingGroupFilterProductCondition v) { setField(1, v); }
  @$pb.TagNumber(1)
...
class ListingGroupFilterDimension_ProductItemId extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'ListingGroupFilterDimension.ProductItemId', package: const $pb.PackageName(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'google.ads.googleads.v9.resources'), createEmptyInstance: create)
    ..aOS(1, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'value')
    ..hasRequiredFields = false
  ;
  ...
  'Use [GeneratedMessageGenericExtensions.rebuild] instead. '
  'Will be removed in next major version')
  ListingGroupFilterDimension_ProductItemId copyWith(void Function(ListingGroupFilterDimension_ProductItemId) updates) => super.copyWith((message) => updates(message as ListingGroupFilterDimension_ProductItemId)) as ListingGroupFilterDimension_ProductItemId; // ignore: deprecated_member_use
  $pb.BuilderInfo get info_ => _i;
  @$core.pragma('dart2js:noInline')
...
class ListingGroupFilterDimension_ProductType extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'ListingGroupFilterDimension.ProductType', package: const $pb.PackageName(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'google.ads.googleads.v9.resources'), createEmptyInstance: create)
    ..aOS(1, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'value')
    ..e<$6.ListingGroupFilterProductTypeLevelEnum_ListingGroupFilterProductTypeLevel>(2, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'level', $pb.PbFieldType.OE, defaultOrMaker: $6.ListingGroupFilterProductTypeLevelEnum_ListingGroupFilterProductTypeLevel.UNSPECIFIED, valueOf: $6.ListingGroupFilterProductTypeLevelEnum_ListingGroupFilterProductTypeLevel.valueOf, enumValues: $6.ListingGroupFilterProductTypeLevelEnum_ListingGroupFilterProductTypeLevel.values)
    ..hasRequiredFields = false
  ;
  ...
  factory ListingGroupFilterDimension_ProductType({
    $core.String? value,
    $6.ListingGroupFilterProductTypeLevelEnum_ListingGroupFilterProductTypeLevel? level,
  }) {
    final _result = create();
    if (value != null) {
      _result.value = value;
  ...
  'Use [GeneratedMessageGenericExtensions.rebuild] instead. '
  'Will be removed in next major version')
  ListingGroupFilterDimension_ProductType copyWith(void Function(ListingGroupFilterDimension_ProductType) updates) => super.copyWith((message) => updates(message as ListingGroupFilterDimension_ProductType)) as ListingGroupFilterDimension_ProductType; // ignore: deprecated_member_use
  $pb.BuilderInfo get info_ => _i;
  @$core.pragma('dart2js:noInline')
  ...
  @$pb.TagNumber(2)
  $6.ListingGroupFilterProductTypeLevelEnum_ListingGroupFilterProductTypeLevel get level => $_getN(1);
  @$pb.TagNumber(2)
  set level($6.ListingGroupFilterProductTypeLevelEnum_ListingGroupFilterProductTypeLevel v) { setField(2, v); }
  @$pb.TagNumber(2)
  $core.bool hasLevel() => $_has(1);
  @$pb.TagNumber(2)
  void clearLevel() => clearField(2);
...
class ListingGroupFilterDimension extends $pb.GeneratedMessage {
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'ListingGroupFilterDimension', package: const $pb.PackageName(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'google.ads.googleads.v9.resources'), createEmptyInstance: create)
    ..oo(0, [1, 2, 3, 4, 5, 6, 7])
    ..aOM<ListingGroupFilterDimension_ProductBiddingCategory>(1, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'productBiddingCategory', subBuilder: ListingGroupFilterDimension_ProductBiddingCategory.create)
    ..aOM<ListingGroupFilterDimension_ProductBrand>(2, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'productBrand', subBuilder: ListingGroupFilterDimension_ProductBrand.create)
    ..aOM<ListingGroupFilterDimension_ProductChannel>(3, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'productChannel', subBuilder: ListingGroupFilterDimension_ProductChannel.create)
    ..aOM<ListingGroupFilterDimension_ProductCondition>(4, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'productCondition', subBuilder: ListingGroupFilterDimension_ProductCondition.create)
    ..aOM<ListingGroupFilterDimension_ProductCustomAttribute>(5, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'productCustomAttribute', subBuilder: ListingGroupFilterDimension_ProductCustomAttribute.create)
    ..aOM<ListingGroupFilterDimension_ProductItemId>(6, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'productItemId', subBuilder: ListingGroupFilterDimension_ProductItemId.create)
    ..aOM<ListingGroupFilterDimension_ProductType>(7, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'productType', subBuilder: ListingGroupFilterDimension_ProductType.create)
    ..hasRequiredFields = false
  ;
  ...
  'Use [GeneratedMessageGenericExtensions.rebuild] instead. '
  'Will be removed in next major version')
  ListingGroupFilterDimension copyWith(void Function(ListingGroupFilterDimension) updates) => super.copyWith((message) => updates(message as ListingGroupFilterDimension)) as ListingGroupFilterDimension; // ignore: deprecated_member_use
  $pb.BuilderInfo get info_ => _i;
  @$core.pragma('dart2js:noInline')

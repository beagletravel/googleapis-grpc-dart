...
const AccountLink$json = const {
  ...
  '2': const [
    ...
    const {'1': 'status', '3': 3, '4': 1, '5': 14, '6': '.google.ads.googleads.v9.enums.AccountLinkStatusEnum.AccountLinkStatus', '10': 'status'},
    const {'1': 'type', '3': 4, '4': 1, '5': 14, '6': '.google.ads.googleads.v9.enums.LinkedAccountTypeEnum.LinkedAccountType', '8': const {}, '10': 'type'},
    const {'1': 'third_party_app_analytics', '3': 5, '4': 1, '5': 11, '6': '.google.ads.googleads.v9.resources.ThirdPartyAppAnalyticsLinkIdentifier', '8': const {}, '9': 0, '10': 'thirdPartyAppAnalytics'},
    const {'1': 'data_partner', '3': 6, '4': 1, '5': 11, '6': '.google.ads.googleads.v9.resources.DataPartnerLinkIdentifier', '8': const {}, '9': 0, '10': 'dataPartner'},
    const {'1': 'google_ads', '3': 7, '4': 1, '5': 11, '6': '.google.ads.googleads.v9.resources.GoogleAdsLinkIdentifier', '8': const {}, '9': 0, '10': 'googleAds'},
  ],
  '7': const {},
  '8': const [
...
final $typed_data.Uint8List accountLinkDescriptor = $convert.base64Decode('');
...
const ThirdPartyAppAnalyticsLinkIdentifier$json = const {
  ...
  '2': const [
    ...
    const {'1': 'app_vendor', '3': 3, '4': 1, '5': 14, '6': '.google.ads.googleads.v9.enums.MobileAppVendorEnum.MobileAppVendor', '8': const {}, '10': 'appVendor'},
  ],
  '8': const [
...
final $typed_data.Uint8List thirdPartyAppAnalyticsLinkIdentifierDescriptor = $convert.base64Decode('');

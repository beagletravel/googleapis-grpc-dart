...
const AdGroupAdAssetView$json = const {
  ...
  '2': const [
    ...
    const {'1': 'field_type', '3': 2, '4': 1, '5': 14, '6': '.google.ads.googleads.v9.enums.AssetFieldTypeEnum.AssetFieldType', '8': const {}, '10': 'fieldType'},
    const {'1': 'enabled', '3': 8, '4': 1, '5': 8, '8': const {}, '9': 2, '10': 'enabled', '17': true},
    const {'1': 'policy_summary', '3': 3, '4': 1, '5': 11, '6': '.google.ads.googleads.v9.resources.AdGroupAdAssetPolicySummary', '8': const {}, '10': 'policySummary'},
    const {'1': 'performance_label', '3': 4, '4': 1, '5': 14, '6': '.google.ads.googleads.v9.enums.AssetPerformanceLabelEnum.AssetPerformanceLabel', '8': const {}, '10': 'performanceLabel'},
  ],
  '7': const {},
  '8': const [
...
final $typed_data.Uint8List adGroupAdAssetPolicySummaryDescriptor = $convert.base64Decode('');

...
import '../enums/conversion_origin.pbenum.dart' as $6;
import '../enums/attribution_model.pbenum.dart' as $7;
import '../enums/data_driven_model_status.pbenum.dart' as $8;

class ConversionAction_AttributionModelSettings extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'ConversionAction.AttributionModelSettings', package: const $pb.PackageName(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'google.ads.googleads.v9.resources'), createEmptyInstance: create)
    ..e<$7.AttributionModelEnum_AttributionModel>(1, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'attributionModel', $pb.PbFieldType.OE, defaultOrMaker: $7.AttributionModelEnum_AttributionModel.UNSPECIFIED, valueOf: $7.AttributionModelEnum_AttributionModel.valueOf, enumValues: $7.AttributionModelEnum_AttributionModel.values)
    ..e<$8.DataDrivenModelStatusEnum_DataDrivenModelStatus>(2, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'dataDrivenModelStatus', $pb.PbFieldType.OE, defaultOrMaker: $8.DataDrivenModelStatusEnum_DataDrivenModelStatus.UNSPECIFIED, valueOf: $8.DataDrivenModelStatusEnum_DataDrivenModelStatus.valueOf, enumValues: $8.DataDrivenModelStatusEnum_DataDrivenModelStatus.values)
    ..hasRequiredFields = false
  ;

  ConversionAction_AttributionModelSettings._() : super();
  factory ConversionAction_AttributionModelSettings({
    $7.AttributionModelEnum_AttributionModel? attributionModel,
    $8.DataDrivenModelStatusEnum_DataDrivenModelStatus? dataDrivenModelStatus,
  }) {
  ...
  'Will be removed in next major version')
  ConversionAction_AttributionModelSettings copyWith(void Function(ConversionAction_AttributionModelSettings) updates) => super.copyWith((message) => updates(message as ConversionAction_AttributionModelSettings)) as ConversionAction_AttributionModelSettings; // ignore: deprecated_member_use
  ...
  @$pb.TagNumber(1)
  $7.AttributionModelEnum_AttributionModel get attributionModel => $_getN(0);
  @$pb.TagNumber(1)
  set attributionModel($7.AttributionModelEnum_AttributionModel v) { setField(1, v); }
  @$pb.TagNumber(1)
  ...
  @$pb.TagNumber(2)
  $8.DataDrivenModelStatusEnum_DataDrivenModelStatus get dataDrivenModelStatus => $_getN(1);
  @$pb.TagNumber(2)
  set dataDrivenModelStatus($8.DataDrivenModelStatusEnum_DataDrivenModelStatus v) { setField(2, v); }
  @$pb.TagNumber(2)
...
class ConversionAction_ValueSettings extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'ConversionAction.ValueSettings', package: const $pb.PackageName(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'google.ads.googleads.v9.resources'), createEmptyInstance: create)
    ..a<$core.double>(4, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'defaultValue', $pb.PbFieldType.OD)
    ..aOS(5, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'defaultCurrencyCode')
    ..aOB(6, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'alwaysUseDefaultValue')
    ..hasRequiredFields = false
  ;
  ...
  'Use [GeneratedMessageGenericExtensions.rebuild] instead. '
  'Will be removed in next major version')
  ConversionAction_ValueSettings copyWith(void Function(ConversionAction_ValueSettings) updates) => super.copyWith((message) => updates(message as ConversionAction_ValueSettings)) as ConversionAction_ValueSettings; // ignore: deprecated_member_use
  $pb.BuilderInfo get info_ => _i;
  @$core.pragma('dart2js:noInline')
...
class ConversionAction_ThirdPartyAppAnalyticsSettings extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'ConversionAction.ThirdPartyAppAnalyticsSettings', package: const $pb.PackageName(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'google.ads.googleads.v9.resources'), createEmptyInstance: create)
  ...
  'Use [GeneratedMessageGenericExtensions.rebuild] instead. '
  'Will be removed in next major version')
  ConversionAction_ThirdPartyAppAnalyticsSettings copyWith(void Function(ConversionAction_ThirdPartyAppAnalyticsSettings) updates) => super.copyWith((message) => updates(message as ConversionAction_ThirdPartyAppAnalyticsSettings)) as ConversionAction_ThirdPartyAppAnalyticsSettings; // ignore: deprecated_member_use
  $pb.BuilderInfo get info_ => _i;
  @$core.pragma('dart2js:noInline')
...
class ConversionAction_FirebaseSettings extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'ConversionAction.FirebaseSettings', package: const $pb.PackageName(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'google.ads.googleads.v9.resources'), createEmptyInstance: create)
  ...
  'Use [GeneratedMessageGenericExtensions.rebuild] instead. '
  'Will be removed in next major version')
  ConversionAction_FirebaseSettings copyWith(void Function(ConversionAction_FirebaseSettings) updates) => super.copyWith((message) => updates(message as ConversionAction_FirebaseSettings)) as ConversionAction_FirebaseSettings; // ignore: deprecated_member_use
  $pb.BuilderInfo get info_ => _i;
  @$core.pragma('dart2js:noInline')
...
class ConversionAction extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'ConversionAction', package: const $pb.PackageName(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'google.ads.googleads.v9.resources'), createEmptyInstance: create)
    ..aOS(1, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'resourceName')
    ..e<$1.ConversionActionStatusEnum_ConversionActionStatus>(4, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'status', $pb.PbFieldType.OE, defaultOrMaker: $1.ConversionActionStatusEnum_ConversionActionStatus.UNSPECIFIED, valueOf: $1.ConversionActionStatusEnum_ConversionActionStatus.valueOf, enumValues: $1.ConversionActionStatusEnum_ConversionActionStatus.values)
    ..e<$2.ConversionActionTypeEnum_ConversionActionType>(5, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'type', $pb.PbFieldType.OE, defaultOrMaker: $2.ConversionActionTypeEnum_ConversionActionType.UNSPECIFIED, valueOf: $2.ConversionActionTypeEnum_ConversionActionType.valueOf, enumValues: $2.ConversionActionTypeEnum_ConversionActionType.values)
    ..e<$3.ConversionActionCategoryEnum_ConversionActionCategory>(6, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'category', $pb.PbFieldType.OE, defaultOrMaker: $3.ConversionActionCategoryEnum_ConversionActionCategory.UNSPECIFIED, valueOf: $3.ConversionActionCategoryEnum_ConversionActionCategory.valueOf, enumValues: $3.ConversionActionCategoryEnum_ConversionActionCategory.values)
    ..aOM<ConversionAction_ValueSettings>(11, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'valueSettings', subBuilder: ConversionAction_ValueSettings.create)
    ..e<$4.ConversionActionCountingTypeEnum_ConversionActionCountingType>(12, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'countingType', $pb.PbFieldType.OE, defaultOrMaker: $4.ConversionActionCountingTypeEnum_ConversionActionCountingType.UNSPECIFIED, valueOf: $4.ConversionActionCountingTypeEnum_ConversionActionCountingType.valueOf, enumValues: $4.ConversionActionCountingTypeEnum_ConversionActionCountingType.values)
    ..aOM<ConversionAction_AttributionModelSettings>(13, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'attributionModelSettings', subBuilder: ConversionAction_AttributionModelSettings.create)
    ..pc<$0.TagSnippet>(14, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'tagSnippets', $pb.PbFieldType.PM, subBuilder: $0.TagSnippet.create)
    ..e<$5.MobileAppVendorEnum_MobileAppVendor>(17, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'mobileAppVendor', $pb.PbFieldType.OE, defaultOrMaker: $5.MobileAppVendorEnum_MobileAppVendor.UNSPECIFIED, valueOf: $5.MobileAppVendorEnum_MobileAppVendor.valueOf, enumValues: $5.MobileAppVendorEnum_MobileAppVendor.values)
    ..aOM<ConversionAction_FirebaseSettings>(18, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'firebaseSettings', subBuilder: ConversionAction_FirebaseSettings.create)
    ..aOM<ConversionAction_ThirdPartyAppAnalyticsSettings>(19, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'thirdPartyAppAnalyticsSettings', subBuilder: ConversionAction_ThirdPartyAppAnalyticsSettings.create)
    ..aInt64(21, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'id')
    ..aOS(22, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'name')
    ..aOS(23, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'ownerCustomer')
    ..aOB(24, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'includeInConversionsMetric')
    ..aInt64(25, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'clickThroughLookbackWindowDays')
    ..aInt64(26, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'viewThroughLookbackWindowDays')
    ..aInt64(27, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'phoneCallDurationSeconds')
    ..aOS(28, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'appId')
    ..e<$6.ConversionOriginEnum_ConversionOrigin>(30, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'origin', $pb.PbFieldType.OE, defaultOrMaker: $6.ConversionOriginEnum_ConversionOrigin.UNSPECIFIED, valueOf: $6.ConversionOriginEnum_ConversionOrigin.valueOf, enumValues: $6.ConversionOriginEnum_ConversionOrigin.values)
    ..aOB(31, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'primaryForGoal')
    ..hasRequiredFields = false
  ;
  ...
  factory ConversionAction({
    ...
    $4.ConversionActionCountingTypeEnum_ConversionActionCountingType? countingType,
    ...
    $core.String? appId,
    $6.ConversionOriginEnum_ConversionOrigin? origin,
    ...
    if (primaryForGoal != null) {
      _result.primaryForGoal = primaryForGoal;
    }
    return _result;
  }
  ...
  'Use [GeneratedMessageGenericExtensions.rebuild] instead. '
  'Will be removed in next major version')
  ConversionAction copyWith(void Function(ConversionAction) updates) => super.copyWith((message) => updates(message as ConversionAction)) as ConversionAction; // ignore: deprecated_member_use
  $pb.BuilderInfo get info_ => _i;
  @$core.pragma('dart2js:noInline')
  ...
  @$pb.TagNumber(4)
  set status($1.ConversionActionStatusEnum_ConversionActionStatus v) { setField(4, v); }
  @$pb.TagNumber(4)
  ...
  @$pb.TagNumber(5)
  set type($2.ConversionActionTypeEnum_ConversionActionType v) { setField(5, v); }
  @$pb.TagNumber(5)
  ...
  @$pb.TagNumber(6)
  $3.ConversionActionCategoryEnum_ConversionActionCategory get category => $_getN(3);
  @$pb.TagNumber(6)
  set category($3.ConversionActionCategoryEnum_ConversionActionCategory v) { setField(6, v); }
  @$pb.TagNumber(6)
  ...
  @$pb.TagNumber(12)
  $4.ConversionActionCountingTypeEnum_ConversionActionCountingType get countingType => $_getN(5);
  @$pb.TagNumber(12)
  set countingType($4.ConversionActionCountingTypeEnum_ConversionActionCountingType v) { setField(12, v); }
  @$pb.TagNumber(12)
  ...
  @$pb.TagNumber(17)
  set mobileAppVendor($5.MobileAppVendorEnum_MobileAppVendor v) { setField(17, v); }
  @$pb.TagNumber(17)
  ...
  @$pb.TagNumber(30)
  $6.ConversionOriginEnum_ConversionOrigin get origin => $_getN(19);
  @$pb.TagNumber(30)
  set origin($6.ConversionOriginEnum_ConversionOrigin v) { setField(30, v); }
  @$pb.TagNumber(30)

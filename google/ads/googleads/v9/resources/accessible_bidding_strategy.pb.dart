...
class AccessibleBiddingStrategy_MaximizeConversionValue extends $pb.GeneratedMessage {
  ...
  'Will be removed in next major version')
  AccessibleBiddingStrategy_MaximizeConversionValue copyWith(void Function(AccessibleBiddingStrategy_MaximizeConversionValue) updates) => super.copyWith((message) => updates(message as AccessibleBiddingStrategy_MaximizeConversionValue)) as AccessibleBiddingStrategy_MaximizeConversionValue; // ignore: deprecated_member_use
...
class AccessibleBiddingStrategy_MaximizeConversions extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'AccessibleBiddingStrategy.MaximizeConversions', package: const $pb.PackageName(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'google.ads.googleads.v9.resources'), createEmptyInstance: create)
  ...
  'Use [GeneratedMessageGenericExtensions.rebuild] instead. '
  'Will be removed in next major version')
  AccessibleBiddingStrategy_MaximizeConversions copyWith(void Function(AccessibleBiddingStrategy_MaximizeConversions) updates) => super.copyWith((message) => updates(message as AccessibleBiddingStrategy_MaximizeConversions)) as AccessibleBiddingStrategy_MaximizeConversions; // ignore: deprecated_member_use
  $pb.BuilderInfo get info_ => _i;
  @$core.pragma('dart2js:noInline')
...
class AccessibleBiddingStrategy_TargetRoas extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'AccessibleBiddingStrategy.TargetRoas', package: const $pb.PackageName(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'google.ads.googleads.v9.resources'), createEmptyInstance: create)
    ..a<$core.double>(1, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'targetRoas', $pb.PbFieldType.OD)
    ..hasRequiredFields = false
  ;
  ...
  'Use [GeneratedMessageGenericExtensions.rebuild] instead. '
  'Will be removed in next major version')
  AccessibleBiddingStrategy_TargetRoas copyWith(void Function(AccessibleBiddingStrategy_TargetRoas) updates) => super.copyWith((message) => updates(message as AccessibleBiddingStrategy_TargetRoas)) as AccessibleBiddingStrategy_TargetRoas; // ignore: deprecated_member_use
  $pb.BuilderInfo get info_ => _i;
  @$core.pragma('dart2js:noInline')
...
class AccessibleBiddingStrategy_TargetCpa extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'AccessibleBiddingStrategy.TargetCpa', package: const $pb.PackageName(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'google.ads.googleads.v9.resources'), createEmptyInstance: create)
    ..aInt64(1, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'targetCpaMicros')
    ..hasRequiredFields = false
  ;
  ...
  'Use [GeneratedMessageGenericExtensions.rebuild] instead. '
  'Will be removed in next major version')
  AccessibleBiddingStrategy_TargetCpa copyWith(void Function(AccessibleBiddingStrategy_TargetCpa) updates) => super.copyWith((message) => updates(message as AccessibleBiddingStrategy_TargetCpa)) as AccessibleBiddingStrategy_TargetCpa; // ignore: deprecated_member_use
  $pb.BuilderInfo get info_ => _i;
  @$core.pragma('dart2js:noInline')
...
class AccessibleBiddingStrategy_TargetImpressionShare extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'AccessibleBiddingStrategy.TargetImpressionShare', package: const $pb.PackageName(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'google.ads.googleads.v9.resources'), createEmptyInstance: create)
    ..e<$1.TargetImpressionShareLocationEnum_TargetImpressionShareLocation>(1, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'location', $pb.PbFieldType.OE, defaultOrMaker: $1.TargetImpressionShareLocationEnum_TargetImpressionShareLocation.UNSPECIFIED, valueOf: $1.TargetImpressionShareLocationEnum_TargetImpressionShareLocation.valueOf, enumValues: $1.TargetImpressionShareLocationEnum_TargetImpressionShareLocation.values)
    ..aInt64(2, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'locationFractionMicros')
  ...
  factory AccessibleBiddingStrategy_TargetImpressionShare({
    $1.TargetImpressionShareLocationEnum_TargetImpressionShareLocation? location,
  ...
  'Use [GeneratedMessageGenericExtensions.rebuild] instead. '
  'Will be removed in next major version')
  AccessibleBiddingStrategy_TargetImpressionShare copyWith(void Function(AccessibleBiddingStrategy_TargetImpressionShare) updates) => super.copyWith((message) => updates(message as AccessibleBiddingStrategy_TargetImpressionShare)) as AccessibleBiddingStrategy_TargetImpressionShare; // ignore: deprecated_member_use
  $pb.BuilderInfo get info_ => _i;
  @$core.pragma('dart2js:noInline')
  ...
  @$pb.TagNumber(1)
  $1.TargetImpressionShareLocationEnum_TargetImpressionShareLocation get location => $_getN(0);
  @$pb.TagNumber(1)
  set location($1.TargetImpressionShareLocationEnum_TargetImpressionShareLocation v) { setField(1, v); }
  @$pb.TagNumber(1)
...
class AccessibleBiddingStrategy_TargetSpend extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'AccessibleBiddingStrategy.TargetSpend', package: const $pb.PackageName(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'google.ads.googleads.v9.resources'), createEmptyInstance: create)
    ..aInt64(1, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'targetSpendMicros')
  ...
  'Use [GeneratedMessageGenericExtensions.rebuild] instead. '
  'Will be removed in next major version')
  AccessibleBiddingStrategy_TargetSpend copyWith(void Function(AccessibleBiddingStrategy_TargetSpend) updates) => super.copyWith((message) => updates(message as AccessibleBiddingStrategy_TargetSpend)) as AccessibleBiddingStrategy_TargetSpend; // ignore: deprecated_member_use
  $pb.BuilderInfo get info_ => _i;
  @$core.pragma('dart2js:noInline')
...
class AccessibleBiddingStrategy extends $pb.GeneratedMessage {
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'AccessibleBiddingStrategy', package: const $pb.PackageName(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'google.ads.googleads.v9.resources'), createEmptyInstance: create)
    ..oo(0, [7, 8, 9, 10, 11, 12])
    ...
    ..e<$0.BiddingStrategyTypeEnum_BiddingStrategyType>(4, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'type', $pb.PbFieldType.OE, defaultOrMaker: $0.BiddingStrategyTypeEnum_BiddingStrategyType.UNSPECIFIED, valueOf: $0.BiddingStrategyTypeEnum_BiddingStrategyType.valueOf, enumValues: $0.BiddingStrategyTypeEnum_BiddingStrategyType.values)
    ..aInt64(5, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'ownerCustomerId')
    ..aOS(6, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'ownerDescriptiveName')
    ..aOM<AccessibleBiddingStrategy_MaximizeConversionValue>(7, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'maximizeConversionValue', subBuilder: AccessibleBiddingStrategy_MaximizeConversionValue.create)
    ..aOM<AccessibleBiddingStrategy_MaximizeConversions>(8, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'maximizeConversions', subBuilder: AccessibleBiddingStrategy_MaximizeConversions.create)
    ..aOM<AccessibleBiddingStrategy_TargetCpa>(9, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'targetCpa', subBuilder: AccessibleBiddingStrategy_TargetCpa.create)
    ..aOM<AccessibleBiddingStrategy_TargetImpressionShare>(10, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'targetImpressionShare', subBuilder: AccessibleBiddingStrategy_TargetImpressionShare.create)
    ..aOM<AccessibleBiddingStrategy_TargetRoas>(11, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'targetRoas', subBuilder: AccessibleBiddingStrategy_TargetRoas.create)
    ..aOM<AccessibleBiddingStrategy_TargetSpend>(12, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'targetSpend', subBuilder: AccessibleBiddingStrategy_TargetSpend.create)
    ..hasRequiredFields = false
  ;
  ...
  'Use [GeneratedMessageGenericExtensions.rebuild] instead. '
  'Will be removed in next major version')
  AccessibleBiddingStrategy copyWith(void Function(AccessibleBiddingStrategy) updates) => super.copyWith((message) => updates(message as AccessibleBiddingStrategy)) as AccessibleBiddingStrategy; // ignore: deprecated_member_use
  $pb.BuilderInfo get info_ => _i;
  @$core.pragma('dart2js:noInline')
  ...
  @$pb.TagNumber(4)
  set type($0.BiddingStrategyTypeEnum_BiddingStrategyType v) { setField(4, v); }
  @$pb.TagNumber(4)

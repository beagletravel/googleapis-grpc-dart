...
class CustomerCustomizerErrorEnum_CustomerCustomizerError extends $pb.ProtobufEnum {
  static const CustomerCustomizerErrorEnum_CustomerCustomizerError UNSPECIFIED = CustomerCustomizerErrorEnum_CustomerCustomizerError._(0, const $core.bool.fromEnvironment('protobuf.omit_enum_names') ? '' : 'UNSPECIFIED');
  static const CustomerCustomizerErrorEnum_CustomerCustomizerError UNKNOWN = CustomerCustomizerErrorEnum_CustomerCustomizerError._(1, const $core.bool.fromEnvironment('protobuf.omit_enum_names') ? '' : 'UNKNOWN');

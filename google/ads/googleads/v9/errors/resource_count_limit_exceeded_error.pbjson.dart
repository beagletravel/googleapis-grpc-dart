...
const ResourceCountLimitExceededErrorEnum$json = const {
  ...
  '4': const [ResourceCountLimitExceededErrorEnum_ResourceCountLimitExceededError$json],
};

@$core.Deprecated('Use resourceCountLimitExceededErrorEnumDescriptor instead')
const ResourceCountLimitExceededErrorEnum_ResourceCountLimitExceededError$json = const {
...
final $typed_data.Uint8List resourceCountLimitExceededErrorEnumDescriptor = $convert.base64Decode('');

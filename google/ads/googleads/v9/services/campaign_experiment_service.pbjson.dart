...
final $typed_data.Uint8List getCampaignExperimentRequestDescriptor = $convert.base64Decode('ChxHZXRDYW1wYWlnbkV4cGVyaW1lbnRSZXF1ZXN0ElgKDXJlc291cmNlX25hbWUYASABKAlCM+BBAvpBLQorZ29vZ2xlYWRzLmdvb2dsZWFwaXMuY29tL0NhbXBhaWduRXhwZXJpbWVudFIMcmVzb3VyY2VOYW1l');
...
const MutateCampaignExperimentsRequest$json = const {
  ...
  '2': const [
    ...
    const {'1': 'operations', '3': 2, '4': 3, '5': 11, '6': '.google.ads.googleads.v9.services.CampaignExperimentOperation', '8': const {}, '10': 'operations'},
    const {'1': 'partial_failure', '3': 3, '4': 1, '5': 8, '10': 'partialFailure'},
    const {'1': 'validate_only', '3': 4, '4': 1, '5': 8, '10': 'validateOnly'},
    const {'1': 'response_content_type', '3': 5, '4': 1, '5': 14, '6': '.google.ads.googleads.v9.enums.ResponseContentTypeEnum.ResponseContentType', '10': 'responseContentType'},
  ],
};

/// Descriptor for `MutateCampaignExperimentsRequest`. Decode as a `google.protobuf.DescriptorProto`.
final $typed_data.Uint8List mutateCampaignExperimentsRequestDescriptor = $convert.base64Decode('');
...
const CampaignExperimentOperation$json = const {
  ...
  '2': const [
    ...
    const {'1': 'update', '3': 1, '4': 1, '5': 11, '6': '.google.ads.googleads.v9.resources.CampaignExperiment', '9': 0, '10': 'update'},
...
final $typed_data.Uint8List campaignExperimentOperationDescriptor = $convert.base64Decode('');
...
const MutateCampaignExperimentsResponse$json = const {
  ...
  '2': const [
    ...
    const {'1': 'results', '3': 2, '4': 3, '5': 11, '6': '.google.ads.googleads.v9.services.MutateCampaignExperimentResult', '10': 'results'},
  ],
};

/// Descriptor for `MutateCampaignExperimentsResponse`. Decode as a `google.protobuf.DescriptorProto`.
final $typed_data.Uint8List mutateCampaignExperimentsResponseDescriptor = $convert.base64Decode('');
...
const MutateCampaignExperimentResult$json = const {
  ...
  '2': const [
    ...
    const {'1': 'campaign_experiment', '3': 2, '4': 1, '5': 11, '6': '.google.ads.googleads.v9.resources.CampaignExperiment', '10': 'campaignExperiment'},
  ],
};

/// Descriptor for `MutateCampaignExperimentResult`. Decode as a `google.protobuf.DescriptorProto`.
final $typed_data.Uint8List mutateCampaignExperimentResultDescriptor = $convert.base64Decode('Ch5NdXRhdGVDYW1wYWlnbkV4cGVyaW1lbnRSZXN1bHQSIwoNcmVzb3VyY2VfbmFtZRgBIAEoCVIMcmVzb3VyY2VOYW1lEmYKE2NhbXBhaWduX2V4cGVyaW1lbnQYAiABKAsyNS5nb29nbGUuYWRzLmdvb2dsZWFkcy52OS5yZXNvdXJjZXMuQ2FtcGFpZ25FeHBlcmltZW50UhJjYW1wYWlnbkV4cGVyaW1lbnQ=');
...
const CreateCampaignExperimentRequest$json = const {
  ...
  '2': const [
    const {'1': 'customer_id', '3': 1, '4': 1, '5': 9, '8': const {}, '10': 'customerId'},
    const {'1': 'campaign_experiment', '3': 2, '4': 1, '5': 11, '6': '.google.ads.googleads.v9.resources.CampaignExperiment', '8': const {}, '10': 'campaignExperiment'},
...
final $typed_data.Uint8List createCampaignExperimentRequestDescriptor = $convert.base64Decode('');
...
final $typed_data.Uint8List graduateCampaignExperimentRequestDescriptor = $convert.base64Decode('CiFHcmFkdWF0ZUNhbXBhaWduRXhwZXJpbWVudFJlcXVlc3QSNAoTY2FtcGFpZ25fZXhwZXJpbWVudBgBIAEoCUID4EECUhJjYW1wYWlnbkV4cGVyaW1lbnQSLAoPY2FtcGFpZ25fYnVkZ2V0GAIgASgJQgPgQQJSDmNhbXBhaWduQnVkZ2V0EiMKDXZhbGlkYXRlX29ubHkYAyABKAhSDHZhbGlkYXRlT25seQ==');
...
final $typed_data.Uint8List promoteCampaignExperimentRequestDescriptor = $convert.base64Decode('CiBQcm9tb3RlQ2FtcGFpZ25FeHBlcmltZW50UmVxdWVzdBI0ChNjYW1wYWlnbl9leHBlcmltZW50GAEgASgJQgPgQQJSEmNhbXBhaWduRXhwZXJpbWVudBIjCg12YWxpZGF0ZV9vbmx5GAIgASgIUgx2YWxpZGF0ZU9ubHk=');
...
final $typed_data.Uint8List endCampaignExperimentRequestDescriptor = $convert.base64Decode('ChxFbmRDYW1wYWlnbkV4cGVyaW1lbnRSZXF1ZXN0EjQKE2NhbXBhaWduX2V4cGVyaW1lbnQYASABKAlCA+BBAlISY2FtcGFpZ25FeHBlcmltZW50EiMKDXZhbGlkYXRlX29ubHkYAiABKAhSDHZhbGlkYXRlT25seQ==');

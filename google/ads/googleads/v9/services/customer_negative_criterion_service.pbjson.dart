...
const MutateCustomerNegativeCriteriaRequest$json = const {
  ...
  '2': const [
    ...
    const {'1': 'operations', '3': 2, '4': 3, '5': 11, '6': '.google.ads.googleads.v9.services.CustomerNegativeCriterionOperation', '8': const {}, '10': 'operations'},
...
const CustomerNegativeCriterionOperation$json = const {
  ...
  '2': const [
    const {'1': 'create', '3': 1, '4': 1, '5': 11, '6': '.google.ads.googleads.v9.resources.CustomerNegativeCriterion', '9': 0, '10': 'create'},
...
final $typed_data.Uint8List customerNegativeCriterionOperationDescriptor = $convert.base64Decode('CiJDdXN0b21lck5lZ2F0aXZlQ3JpdGVyaW9uT3BlcmF0aW9uElYKBmNyZWF0ZRgBIAEoCzI8Lmdvb2dsZS5hZHMuZ29vZ2xlYWRzLnY5LnJlc291cmNlcy5DdXN0b21lck5lZ2F0aXZlQ3JpdGVyaW9uSABSBmNyZWF0ZRIYCgZyZW1vdmUYAiABKAlIAFIGcmVtb3ZlQgsKCW9wZXJhdGlvbg==');
...
const MutateCustomerNegativeCriteriaResponse$json = const {
  ...
  '2': const [
    ...
    const {'1': 'results', '3': 2, '4': 3, '5': 11, '6': '.google.ads.googleads.v9.services.MutateCustomerNegativeCriteriaResult', '10': 'results'},
  ],
};

/// Descriptor for `MutateCustomerNegativeCriteriaResponse`. Decode as a `google.protobuf.DescriptorProto`.
final $typed_data.Uint8List mutateCustomerNegativeCriteriaResponseDescriptor = $convert.base64Decode('');
...
const MutateCustomerNegativeCriteriaResult$json = const {
  ...
  '2': const [
    ...
    const {'1': 'customer_negative_criterion', '3': 2, '4': 1, '5': 11, '6': '.google.ads.googleads.v9.resources.CustomerNegativeCriterion', '10': 'customerNegativeCriterion'},
  ],
};

/// Descriptor for `MutateCustomerNegativeCriteriaResult`. Decode as a `google.protobuf.DescriptorProto`.
final $typed_data.Uint8List mutateCustomerNegativeCriteriaResultDescriptor = $convert.base64Decode('');

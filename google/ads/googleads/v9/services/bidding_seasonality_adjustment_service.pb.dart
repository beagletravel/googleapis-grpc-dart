...
class GetBiddingSeasonalityAdjustmentRequest extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'GetBiddingSeasonalityAdjustmentRequest', package: const $pb.PackageName(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'google.ads.googleads.v9.services'), createEmptyInstance: create)
  ...
  factory GetBiddingSeasonalityAdjustmentRequest.fromBuffer($core.List<$core.int> i, [$pb.ExtensionRegistry r = $pb.ExtensionRegistry.EMPTY]) => create()..mergeFromBuffer(i, r);
  factory GetBiddingSeasonalityAdjustmentRequest.fromJson($core.String i, [$pb.ExtensionRegistry r = $pb.ExtensionRegistry.EMPTY]) => create()..mergeFromJson(i, r);
  @$core.Deprecated(
  'Using this can add significant overhead to your binary. '
  'Use [GeneratedMessageGenericExtensions.deepCopy] instead. '
  'Will be removed in next major version')
  GetBiddingSeasonalityAdjustmentRequest clone() => GetBiddingSeasonalityAdjustmentRequest()..mergeFromMessage(this);
  @$core.Deprecated(
  'Using this can add significant overhead to your binary. '
  'Use [GeneratedMessageGenericExtensions.rebuild] instead. '
  'Will be removed in next major version')
  GetBiddingSeasonalityAdjustmentRequest copyWith(void Function(GetBiddingSeasonalityAdjustmentRequest) updates) => super.copyWith((message) => updates(message as GetBiddingSeasonalityAdjustmentRequest)) as GetBiddingSeasonalityAdjustmentRequest; // ignore: deprecated_member_use
  $pb.BuilderInfo get info_ => _i;
  @$core.pragma('dart2js:noInline')
  static GetBiddingSeasonalityAdjustmentRequest create() => GetBiddingSeasonalityAdjustmentRequest._();
  GetBiddingSeasonalityAdjustmentRequest createEmptyInstance() => create();
  static $pb.PbList<GetBiddingSeasonalityAdjustmentRequest> createRepeated() => $pb.PbList<GetBiddingSeasonalityAdjustmentRequest>();
  @$core.pragma('dart2js:noInline')
  static GetBiddingSeasonalityAdjustmentRequest getDefault() => _defaultInstance ??= $pb.GeneratedMessage.$_defaultFor<GetBiddingSeasonalityAdjustmentRequest>(create);
...
class MutateBiddingSeasonalityAdjustmentsRequest extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'MutateBiddingSeasonalityAdjustmentsRequest', package: const $pb.PackageName(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'google.ads.googleads.v9.services'), createEmptyInstance: create)
    ..aOS(1, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'customerId')
    ..pc<BiddingSeasonalityAdjustmentOperation>(2, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'operations', $pb.PbFieldType.PM, subBuilder: BiddingSeasonalityAdjustmentOperation.create)
  ...
  'Use [GeneratedMessageGenericExtensions.rebuild] instead. '
  'Will be removed in next major version')
  MutateBiddingSeasonalityAdjustmentsRequest copyWith(void Function(MutateBiddingSeasonalityAdjustmentsRequest) updates) => super.copyWith((message) => updates(message as MutateBiddingSeasonalityAdjustmentsRequest)) as MutateBiddingSeasonalityAdjustmentsRequest; // ignore: deprecated_member_use
  $pb.BuilderInfo get info_ => _i;
  @$core.pragma('dart2js:noInline')
...
class BiddingSeasonalityAdjustmentOperation extends $pb.GeneratedMessage {
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'BiddingSeasonalityAdjustmentOperation', package: const $pb.PackageName(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'google.ads.googleads.v9.services'), createEmptyInstance: create)
    ..oo(0, [1, 2, 3])
    ..aOM<$1.BiddingSeasonalityAdjustment>(1, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'create', subBuilder: $1.BiddingSeasonalityAdjustment.create)
    ..aOM<$1.BiddingSeasonalityAdjustment>(2, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'update', subBuilder: $1.BiddingSeasonalityAdjustment.create)
  ...
  'Use [GeneratedMessageGenericExtensions.rebuild] instead. '
  'Will be removed in next major version')
  BiddingSeasonalityAdjustmentOperation copyWith(void Function(BiddingSeasonalityAdjustmentOperation) updates) => super.copyWith((message) => updates(message as BiddingSeasonalityAdjustmentOperation)) as BiddingSeasonalityAdjustmentOperation; // ignore: deprecated_member_use
  $pb.BuilderInfo get info_ => _i;
  @$core.pragma('dart2js:noInline')
  ...
  @$pb.TagNumber(1)
  set create_1($1.BiddingSeasonalityAdjustment v) { setField(1, v); }
  @$pb.TagNumber(1)
  ...
  @$pb.TagNumber(2)
  set update($1.BiddingSeasonalityAdjustment v) { setField(2, v); }
  @$pb.TagNumber(2)
...
class MutateBiddingSeasonalityAdjustmentsResponse extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'MutateBiddingSeasonalityAdjustmentsResponse', package: const $pb.PackageName(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'google.ads.googleads.v9.services'), createEmptyInstance: create)
    ..pc<MutateBiddingSeasonalityAdjustmentsResult>(2, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'results', $pb.PbFieldType.PM, subBuilder: MutateBiddingSeasonalityAdjustmentsResult.create)
  ...
  'Use [GeneratedMessageGenericExtensions.rebuild] instead. '
  'Will be removed in next major version')
  MutateBiddingSeasonalityAdjustmentsResponse copyWith(void Function(MutateBiddingSeasonalityAdjustmentsResponse) updates) => super.copyWith((message) => updates(message as MutateBiddingSeasonalityAdjustmentsResponse)) as MutateBiddingSeasonalityAdjustmentsResponse; // ignore: deprecated_member_use
  $pb.BuilderInfo get info_ => _i;
  @$core.pragma('dart2js:noInline')
...
class MutateBiddingSeasonalityAdjustmentsResult extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'MutateBiddingSeasonalityAdjustmentsResult', package: const $pb.PackageName(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'google.ads.googleads.v9.services'), createEmptyInstance: create)
    ..aOS(1, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'resourceName')
    ..aOM<$1.BiddingSeasonalityAdjustment>(2, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'biddingSeasonalityAdjustment', subBuilder: $1.BiddingSeasonalityAdjustment.create)
    ..hasRequiredFields = false
  ;
  ...
  'Use [GeneratedMessageGenericExtensions.rebuild] instead. '
  'Will be removed in next major version')
  MutateBiddingSeasonalityAdjustmentsResult copyWith(void Function(MutateBiddingSeasonalityAdjustmentsResult) updates) => super.copyWith((message) => updates(message as MutateBiddingSeasonalityAdjustmentsResult)) as MutateBiddingSeasonalityAdjustmentsResult; // ignore: deprecated_member_use
  $pb.BuilderInfo get info_ => _i;
  @$core.pragma('dart2js:noInline')
  ...
  @$pb.TagNumber(2)
  set biddingSeasonalityAdjustment($1.BiddingSeasonalityAdjustment v) { setField(2, v); }
  @$pb.TagNumber(2)
  $core.bool hasBiddingSeasonalityAdjustment() => $_has(1);
  @$pb.TagNumber(2)
  void clearBiddingSeasonalityAdjustment() => clearField(2);
  @$pb.TagNumber(2)
  $1.BiddingSeasonalityAdjustment ensureBiddingSeasonalityAdjustment() => $_ensure(1);
}

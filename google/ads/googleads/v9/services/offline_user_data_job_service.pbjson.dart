...
const CreateOfflineUserDataJobRequest$json = const {
  ...
  '2': const [
    ...
    const {'1': 'job', '3': 2, '4': 1, '5': 11, '6': '.google.ads.googleads.v9.resources.OfflineUserDataJob', '8': const {}, '10': 'job'},
...
final $typed_data.Uint8List createOfflineUserDataJobRequestDescriptor = $convert.base64Decode('');
...
final $typed_data.Uint8List createOfflineUserDataJobResponseDescriptor = $convert.base64Decode('CiBDcmVhdGVPZmZsaW5lVXNlckRhdGFKb2JSZXNwb25zZRIjCg1yZXNvdXJjZV9uYW1lGAEgASgJUgxyZXNvdXJjZU5hbWU=');
...
final $typed_data.Uint8List getOfflineUserDataJobRequestDescriptor = $convert.base64Decode('ChxHZXRPZmZsaW5lVXNlckRhdGFKb2JSZXF1ZXN0ElgKDXJlc291cmNlX25hbWUYASABKAlCM+BBAvpBLQorZ29vZ2xlYWRzLmdvb2dsZWFwaXMuY29tL09mZmxpbmVVc2VyRGF0YUpvYlIMcmVzb3VyY2VOYW1l');
...
const AddOfflineUserDataJobOperationsRequest$json = const {
  ...
  '2': const [
    ...
    const {'1': 'operations', '3': 3, '4': 3, '5': 11, '6': '.google.ads.googleads.v9.services.OfflineUserDataJobOperation', '8': const {}, '10': 'operations'},
...
final $typed_data.Uint8List addOfflineUserDataJobOperationsRequestDescriptor = $convert.base64Decode('');
...
const OfflineUserDataJobOperation$json = const {
  ...
  '2': const [
    const {'1': 'create', '3': 1, '4': 1, '5': 11, '6': '.google.ads.googleads.v9.common.UserData', '9': 0, '10': 'create'},
    const {'1': 'remove', '3': 2, '4': 1, '5': 11, '6': '.google.ads.googleads.v9.common.UserData', '9': 0, '10': 'remove'},
...
final $typed_data.Uint8List offlineUserDataJobOperationDescriptor = $convert.base64Decode('');

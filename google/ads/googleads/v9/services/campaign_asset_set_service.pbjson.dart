...
const MutateCampaignAssetSetsRequest$json = const {
  ...
  '2': const [
    ...
    const {'1': 'operations', '3': 2, '4': 3, '5': 11, '6': '.google.ads.googleads.v9.services.CampaignAssetSetOperation', '8': const {}, '10': 'operations'},
...
const CampaignAssetSetOperation$json = const {
  ...
  '2': const [
    const {'1': 'create', '3': 1, '4': 1, '5': 11, '6': '.google.ads.googleads.v9.resources.CampaignAssetSet', '9': 0, '10': 'create'},
...
final $typed_data.Uint8List campaignAssetSetOperationDescriptor = $convert.base64Decode('ChlDYW1wYWlnbkFzc2V0U2V0T3BlcmF0aW9uEk0KBmNyZWF0ZRgBIAEoCzIzLmdvb2dsZS5hZHMuZ29vZ2xlYWRzLnY5LnJlc291cmNlcy5DYW1wYWlnbkFzc2V0U2V0SABSBmNyZWF0ZRIYCgZyZW1vdmUYAiABKAlIAFIGcmVtb3ZlQgsKCW9wZXJhdGlvbg==');
...
const MutateCampaignAssetSetsResponse$json = const {
  ...
  '2': const [
    const {'1': 'results', '3': 1, '4': 3, '5': 11, '6': '.google.ads.googleads.v9.services.MutateCampaignAssetSetResult', '10': 'results'},
...
final $typed_data.Uint8List mutateCampaignAssetSetsResponseDescriptor = $convert.base64Decode('');
...
const MutateCampaignAssetSetResult$json = const {
  ...
  '2': const [
    ...
    const {'1': 'campaign_asset_set', '3': 2, '4': 1, '5': 11, '6': '.google.ads.googleads.v9.resources.CampaignAssetSet', '10': 'campaignAssetSet'},
  ],
};

/// Descriptor for `MutateCampaignAssetSetResult`. Decode as a `google.protobuf.DescriptorProto`.
final $typed_data.Uint8List mutateCampaignAssetSetResultDescriptor = $convert.base64Decode('ChxNdXRhdGVDYW1wYWlnbkFzc2V0U2V0UmVzdWx0EiMKDXJlc291cmNlX25hbWUYASABKAlSDHJlc291cmNlTmFtZRJhChJjYW1wYWlnbl9hc3NldF9zZXQYAiABKAsyMy5nb29nbGUuYWRzLmdvb2dsZWFkcy52OS5yZXNvdXJjZXMuQ2FtcGFpZ25Bc3NldFNldFIQY2FtcGFpZ25Bc3NldFNldA==');

...
class CreateOfflineUserDataJobRequest extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'CreateOfflineUserDataJobRequest', package: const $pb.PackageName(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'google.ads.googleads.v9.services'), createEmptyInstance: create)
    ..aOS(1, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'customerId')
    ..aOM<$3.OfflineUserDataJob>(2, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'job', subBuilder: $3.OfflineUserDataJob.create)
    ..aOB(3, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'validateOnly')
    ..aOB(5, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'enableMatchRateRangePreview')
  ...
  'Will be removed in next major version')
  CreateOfflineUserDataJobRequest copyWith(void Function(CreateOfflineUserDataJobRequest) updates) => super.copyWith((message) => updates(message as CreateOfflineUserDataJobRequest)) as CreateOfflineUserDataJobRequest; // ignore: deprecated_member_use
  ...
  @$pb.TagNumber(2)
  set job($3.OfflineUserDataJob v) { setField(2, v); }
  @$pb.TagNumber(2)
...
class CreateOfflineUserDataJobResponse extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'CreateOfflineUserDataJobResponse', package: const $pb.PackageName(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'google.ads.googleads.v9.services'), createEmptyInstance: create)
  ...
  'Use [GeneratedMessageGenericExtensions.rebuild] instead. '
  'Will be removed in next major version')
  CreateOfflineUserDataJobResponse copyWith(void Function(CreateOfflineUserDataJobResponse) updates) => super.copyWith((message) => updates(message as CreateOfflineUserDataJobResponse)) as CreateOfflineUserDataJobResponse; // ignore: deprecated_member_use
  $pb.BuilderInfo get info_ => _i;
  @$core.pragma('dart2js:noInline')
...
class GetOfflineUserDataJobRequest extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'GetOfflineUserDataJobRequest', package: const $pb.PackageName(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'google.ads.googleads.v9.services'), createEmptyInstance: create)
    ..aOS(1, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'resourceName')
    ..hasRequiredFields = false
  ;
  ...
  factory GetOfflineUserDataJobRequest.fromBuffer($core.List<$core.int> i, [$pb.ExtensionRegistry r = $pb.ExtensionRegistry.EMPTY]) => create()..mergeFromBuffer(i, r);
  factory GetOfflineUserDataJobRequest.fromJson($core.String i, [$pb.ExtensionRegistry r = $pb.ExtensionRegistry.EMPTY]) => create()..mergeFromJson(i, r);
  @$core.Deprecated(
  'Using this can add significant overhead to your binary. '
  'Use [GeneratedMessageGenericExtensions.deepCopy] instead. '
  'Will be removed in next major version')
  GetOfflineUserDataJobRequest clone() => GetOfflineUserDataJobRequest()..mergeFromMessage(this);
  @$core.Deprecated(
  'Using this can add significant overhead to your binary. '
  'Use [GeneratedMessageGenericExtensions.rebuild] instead. '
  'Will be removed in next major version')
  GetOfflineUserDataJobRequest copyWith(void Function(GetOfflineUserDataJobRequest) updates) => super.copyWith((message) => updates(message as GetOfflineUserDataJobRequest)) as GetOfflineUserDataJobRequest; // ignore: deprecated_member_use
  $pb.BuilderInfo get info_ => _i;
  @$core.pragma('dart2js:noInline')
  static GetOfflineUserDataJobRequest create() => GetOfflineUserDataJobRequest._();
  GetOfflineUserDataJobRequest createEmptyInstance() => create();
  static $pb.PbList<GetOfflineUserDataJobRequest> createRepeated() => $pb.PbList<GetOfflineUserDataJobRequest>();
  @$core.pragma('dart2js:noInline')
  static GetOfflineUserDataJobRequest getDefault() => _defaultInstance ??= $pb.GeneratedMessage.$_defaultFor<GetOfflineUserDataJobRequest>(create);
...
class RunOfflineUserDataJobRequest extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'RunOfflineUserDataJobRequest', package: const $pb.PackageName(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'google.ads.googleads.v9.services'), createEmptyInstance: create)
    ..aOS(1, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'resourceName')
  ...
  'Use [GeneratedMessageGenericExtensions.rebuild] instead. '
  'Will be removed in next major version')
  RunOfflineUserDataJobRequest copyWith(void Function(RunOfflineUserDataJobRequest) updates) => super.copyWith((message) => updates(message as RunOfflineUserDataJobRequest)) as RunOfflineUserDataJobRequest; // ignore: deprecated_member_use
  $pb.BuilderInfo get info_ => _i;
  @$core.pragma('dart2js:noInline')
...
class AddOfflineUserDataJobOperationsRequest extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'AddOfflineUserDataJobOperationsRequest', package: const $pb.PackageName(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'google.ads.googleads.v9.services'), createEmptyInstance: create)
    ..aOS(1, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'resourceName')
    ..pc<OfflineUserDataJobOperation>(3, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'operations', $pb.PbFieldType.PM, subBuilder: OfflineUserDataJobOperation.create)
    ..aOB(4, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'enablePartialFailure')
    ..aOB(5, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'validateOnly')
    ..aOB(6, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'enableWarnings')
    ..hasRequiredFields = false
  ;
  ...
  'Use [GeneratedMessageGenericExtensions.rebuild] instead. '
  'Will be removed in next major version')
  AddOfflineUserDataJobOperationsRequest copyWith(void Function(AddOfflineUserDataJobOperationsRequest) updates) => super.copyWith((message) => updates(message as AddOfflineUserDataJobOperationsRequest)) as AddOfflineUserDataJobOperationsRequest; // ignore: deprecated_member_use
  $pb.BuilderInfo get info_ => _i;
  @$core.pragma('dart2js:noInline')
...
class OfflineUserDataJobOperation extends $pb.GeneratedMessage {
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'OfflineUserDataJobOperation', package: const $pb.PackageName(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'google.ads.googleads.v9.services'), createEmptyInstance: create)
    ..oo(0, [1, 2, 3])
    ..aOM<$4.UserData>(1, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'create', subBuilder: $4.UserData.create)
    ..aOM<$4.UserData>(2, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'remove', subBuilder: $4.UserData.create)
    ..aOB(3, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'removeAll')
    ..hasRequiredFields = false
  ;
  ...
  'Use [GeneratedMessageGenericExtensions.rebuild] instead. '
  'Will be removed in next major version')
  OfflineUserDataJobOperation copyWith(void Function(OfflineUserDataJobOperation) updates) => super.copyWith((message) => updates(message as OfflineUserDataJobOperation)) as OfflineUserDataJobOperation; // ignore: deprecated_member_use
  $pb.BuilderInfo get info_ => _i;
  @$core.pragma('dart2js:noInline')
  ...
  @$pb.TagNumber(1)
  set create_1($4.UserData v) { setField(1, v); }
  @$pb.TagNumber(1)
  ...
  @$pb.TagNumber(2)
  set remove($4.UserData v) { setField(2, v); }
  @$pb.TagNumber(2)
...
class AddOfflineUserDataJobOperationsResponse extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'AddOfflineUserDataJobOperationsResponse', package: const $pb.PackageName(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'google.ads.googleads.v9.services'), createEmptyInstance: create)
    ..aOM<$5.Status>(1, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'partialFailureError', subBuilder: $5.Status.create)
    ..aOM<$5.Status>(2, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'warning', subBuilder: $5.Status.create)
    ..hasRequiredFields = false
  ;
  ...
  'Use [GeneratedMessageGenericExtensions.rebuild] instead. '
  'Will be removed in next major version')
  AddOfflineUserDataJobOperationsResponse copyWith(void Function(AddOfflineUserDataJobOperationsResponse) updates) => super.copyWith((message) => updates(message as AddOfflineUserDataJobOperationsResponse)) as AddOfflineUserDataJobOperationsResponse; // ignore: deprecated_member_use
  $pb.BuilderInfo get info_ => _i;
  @$core.pragma('dart2js:noInline')
  ...
  @$pb.TagNumber(2)
  set warning($5.Status v) { setField(2, v); }
  @$pb.TagNumber(2)

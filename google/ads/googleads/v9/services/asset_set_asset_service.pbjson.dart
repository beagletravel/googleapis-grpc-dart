...
const MutateAssetSetAssetsRequest$json = const {
  ...
  '2': const [
    ...
    const {'1': 'operations', '3': 2, '4': 3, '5': 11, '6': '.google.ads.googleads.v9.services.AssetSetAssetOperation', '8': const {}, '10': 'operations'},
...
const AssetSetAssetOperation$json = const {
  ...
  '2': const [
    const {'1': 'create', '3': 1, '4': 1, '5': 11, '6': '.google.ads.googleads.v9.resources.AssetSetAsset', '9': 0, '10': 'create'},
...
final $typed_data.Uint8List assetSetAssetOperationDescriptor = $convert.base64Decode('ChZBc3NldFNldEFzc2V0T3BlcmF0aW9uEkoKBmNyZWF0ZRgBIAEoCzIwLmdvb2dsZS5hZHMuZ29vZ2xlYWRzLnY5LnJlc291cmNlcy5Bc3NldFNldEFzc2V0SABSBmNyZWF0ZRIYCgZyZW1vdmUYAiABKAlIAFIGcmVtb3ZlQgsKCW9wZXJhdGlvbg==');
...
const MutateAssetSetAssetsResponse$json = const {
  ...
  '2': const [
    const {'1': 'results', '3': 1, '4': 3, '5': 11, '6': '.google.ads.googleads.v9.services.MutateAssetSetAssetResult', '10': 'results'},
...
final $typed_data.Uint8List mutateAssetSetAssetsResponseDescriptor = $convert.base64Decode('ChxNdXRhdGVBc3NldFNldEFzc2V0c1Jlc3BvbnNlElUKB3Jlc3VsdHMYASADKAsyOy5nb29nbGUuYWRzLmdvb2dsZWFkcy52OS5zZXJ2aWNlcy5NdXRhdGVBc3NldFNldEFzc2V0UmVzdWx0UgdyZXN1bHRzEkYKFXBhcnRpYWxfZmFpbHVyZV9lcnJvchgCIAEoCzISLmdvb2dsZS5ycGMuU3RhdHVzUhNwYXJ0aWFsRmFpbHVyZUVycm9y');
...
const MutateAssetSetAssetResult$json = const {
  ...
  '2': const [
    ...
    const {'1': 'asset_set_asset', '3': 2, '4': 1, '5': 11, '6': '.google.ads.googleads.v9.resources.AssetSetAsset', '10': 'assetSetAsset'},
  ],
};

/// Descriptor for `MutateAssetSetAssetResult`. Decode as a `google.protobuf.DescriptorProto`.
final $typed_data.Uint8List mutateAssetSetAssetResultDescriptor = $convert.base64Decode('ChlNdXRhdGVBc3NldFNldEFzc2V0UmVzdWx0EiMKDXJlc291cmNlX25hbWUYASABKAlSDHJlc291cmNlTmFtZRJYCg9hc3NldF9zZXRfYXNzZXQYAiABKAsyMC5nb29nbGUuYWRzLmdvb2dsZWFkcy52OS5yZXNvdXJjZXMuQXNzZXRTZXRBc3NldFINYXNzZXRTZXRBc3NldA==');

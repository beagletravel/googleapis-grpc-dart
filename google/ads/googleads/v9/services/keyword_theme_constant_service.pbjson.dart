...
const SuggestKeywordThemeConstantsResponse$json = const {
  ...
  '2': const [
    const {'1': 'keyword_theme_constants', '3': 1, '4': 3, '5': 11, '6': '.google.ads.googleads.v9.resources.KeywordThemeConstant', '10': 'keywordThemeConstants'},
  ],
};

/// Descriptor for `SuggestKeywordThemeConstantsResponse`. Decode as a `google.protobuf.DescriptorProto`.
final $typed_data.Uint8List suggestKeywordThemeConstantsResponseDescriptor = $convert.base64Decode('CiRTdWdnZXN0S2V5d29yZFRoZW1lQ29uc3RhbnRzUmVzcG9uc2USbwoXa2V5d29yZF90aGVtZV9jb25zdGFudHMYASADKAsyNy5nb29nbGUuYWRzLmdvb2dsZWFkcy52OS5yZXNvdXJjZXMuS2V5d29yZFRoZW1lQ29uc3RhbnRSFWtleXdvcmRUaGVtZUNvbnN0YW50cw==');

...
const MutateKeywordPlanAdGroupKeywordsRequest$json = const {
  ...
  '2': const [
    ...
    const {'1': 'operations', '3': 2, '4': 3, '5': 11, '6': '.google.ads.googleads.v9.services.KeywordPlanAdGroupKeywordOperation', '8': const {}, '10': 'operations'},
...
const KeywordPlanAdGroupKeywordOperation$json = const {
  ...
  '2': const [
    ...
    const {'1': 'create', '3': 1, '4': 1, '5': 11, '6': '.google.ads.googleads.v9.resources.KeywordPlanAdGroupKeyword', '9': 0, '10': 'create'},
    const {'1': 'update', '3': 2, '4': 1, '5': 11, '6': '.google.ads.googleads.v9.resources.KeywordPlanAdGroupKeyword', '9': 0, '10': 'update'},
...
final $typed_data.Uint8List keywordPlanAdGroupKeywordOperationDescriptor = $convert.base64Decode('');
...
const MutateKeywordPlanAdGroupKeywordsResponse$json = const {
  ...
  '2': const [
    ...
    const {'1': 'results', '3': 2, '4': 3, '5': 11, '6': '.google.ads.googleads.v9.services.MutateKeywordPlanAdGroupKeywordResult', '10': 'results'},
  ],
};

/// Descriptor for `MutateKeywordPlanAdGroupKeywordsResponse`. Decode as a `google.protobuf.DescriptorProto`.
final $typed_data.Uint8List mutateKeywordPlanAdGroupKeywordsResponseDescriptor = $convert.base64Decode('');

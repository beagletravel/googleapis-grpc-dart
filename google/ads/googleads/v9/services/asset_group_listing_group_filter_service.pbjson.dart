...
const MutateAssetGroupListingGroupFiltersRequest$json = const {
  ...
  '2': const [
    ...
    const {'1': 'operations', '3': 2, '4': 3, '5': 11, '6': '.google.ads.googleads.v9.services.AssetGroupListingGroupFilterOperation', '8': const {}, '10': 'operations'},
...
const AssetGroupListingGroupFilterOperation$json = const {
  ...
  '2': const [
    ...
    const {'1': 'create', '3': 1, '4': 1, '5': 11, '6': '.google.ads.googleads.v9.resources.AssetGroupListingGroupFilter', '9': 0, '10': 'create'},
    const {'1': 'update', '3': 2, '4': 1, '5': 11, '6': '.google.ads.googleads.v9.resources.AssetGroupListingGroupFilter', '9': 0, '10': 'update'},
...
final $typed_data.Uint8List assetGroupListingGroupFilterOperationDescriptor = $convert.base64Decode('');
...
const MutateAssetGroupListingGroupFiltersResponse$json = const {
  ...
  '2': const [
    const {'1': 'results', '3': 1, '4': 3, '5': 11, '6': '.google.ads.googleads.v9.services.MutateAssetGroupListingGroupFilterResult', '10': 'results'},
  ],
};

/// Descriptor for `MutateAssetGroupListingGroupFiltersResponse`. Decode as a `google.protobuf.DescriptorProto`.
final $typed_data.Uint8List mutateAssetGroupListingGroupFiltersResponseDescriptor = $convert.base64Decode('CitNdXRhdGVBc3NldEdyb3VwTGlzdGluZ0dyb3VwRmlsdGVyc1Jlc3BvbnNlEmQKB3Jlc3VsdHMYASADKAsySi5nb29nbGUuYWRzLmdvb2dsZWFkcy52OS5zZXJ2aWNlcy5NdXRhdGVBc3NldEdyb3VwTGlzdGluZ0dyb3VwRmlsdGVyUmVzdWx0UgdyZXN1bHRz');
...
const MutateAssetGroupListingGroupFilterResult$json = const {
  ...
  '2': const [
    ...
    const {'1': 'asset_group_listing_group_filter', '3': 2, '4': 1, '5': 11, '6': '.google.ads.googleads.v9.resources.AssetGroupListingGroupFilter', '10': 'assetGroupListingGroupFilter'},
  ],
};

/// Descriptor for `MutateAssetGroupListingGroupFilterResult`. Decode as a `google.protobuf.DescriptorProto`.
final $typed_data.Uint8List mutateAssetGroupListingGroupFilterResultDescriptor = $convert.base64Decode('');

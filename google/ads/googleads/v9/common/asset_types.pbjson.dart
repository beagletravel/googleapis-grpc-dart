...
const ImageAsset$json = const {
  ...
  '2': const [
    ...
    const {'1': 'mime_type', '3': 3, '4': 1, '5': 14, '6': '.google.ads.googleads.v9.enums.MimeTypeEnum.MimeType', '10': 'mimeType'},
    const {'1': 'full_size', '3': 4, '4': 1, '5': 11, '6': '.google.ads.googleads.v9.common.ImageDimension', '10': 'fullSize'},
  ],
  '8': const [
    const {'1': '_data'},
    const {'1': '_file_size'},
...
final $typed_data.Uint8List imageAssetDescriptor = $convert.base64Decode('');
...
const LeadFormAsset$json = const {
  ...
  '2': const [
    ...
    const {'1': 'call_to_action_type', '3': 17, '4': 1, '5': 14, '6': '.google.ads.googleads.v9.enums.LeadFormCallToActionTypeEnum.LeadFormCallToActionType', '8': const {}, '10': 'callToActionType'},
    ...
    const {'1': 'fields', '3': 8, '4': 3, '5': 11, '6': '.google.ads.googleads.v9.common.LeadFormField', '10': 'fields'},
    const {'1': 'delivery_methods', '3': 9, '4': 3, '5': 11, '6': '.google.ads.googleads.v9.common.LeadFormDeliveryMethod', '10': 'deliveryMethods'},
    const {'1': 'post_submit_call_to_action_type', '3': 19, '4': 1, '5': 14, '6': '.google.ads.googleads.v9.enums.LeadFormPostSubmitCallToActionTypeEnum.LeadFormPostSubmitCallToActionType', '10': 'postSubmitCallToActionType'},
    const {'1': 'background_image_asset', '3': 20, '4': 1, '5': 9, '9': 2, '10': 'backgroundImageAsset', '17': true},
    const {'1': 'desired_intent', '3': 21, '4': 1, '5': 14, '6': '.google.ads.googleads.v9.enums.LeadFormDesiredIntentEnum.LeadFormDesiredIntent', '10': 'desiredIntent'},
...
const LeadFormField$json = const {
  '1': 'LeadFormField',
  '2': const [
    const {'1': 'input_type', '3': 1, '4': 1, '5': 14, '6': '.google.ads.googleads.v9.enums.LeadFormFieldUserInputTypeEnum.LeadFormFieldUserInputType', '10': 'inputType'},
    const {'1': 'single_choice_answers', '3': 2, '4': 1, '5': 11, '6': '.google.ads.googleads.v9.common.LeadFormSingleChoiceAnswers', '9': 0, '10': 'singleChoiceAnswers'},
  ],
  '8': const [
    const {'1': 'answers'},
  ],
...
final $typed_data.Uint8List leadFormFieldDescriptor = $convert.base64Decode('');
...
const LeadFormDeliveryMethod$json = const {
  ...
  '2': const [
    const {'1': 'webhook', '3': 1, '4': 1, '5': 11, '6': '.google.ads.googleads.v9.common.WebhookDelivery', '9': 0, '10': 'webhook'},
  ],
  '8': const [
...
final $typed_data.Uint8List leadFormDeliveryMethodDescriptor = $convert.base64Decode('ChZMZWFkRm9ybURlbGl2ZXJ5TWV0aG9kEksKB3dlYmhvb2sYASABKAsyLy5nb29nbGUuYWRzLmdvb2dsZWFkcy52OS5jb21tb24uV2ViaG9va0RlbGl2ZXJ5SABSB3dlYmhvb2tCEgoQZGVsaXZlcnlfZGV0YWlscw==');
...
const PromotionAsset$json = const {
  ...
  '2': const [
    ...
    const {'1': 'discount_modifier', '3': 2, '4': 1, '5': 14, '6': '.google.ads.googleads.v9.enums.PromotionExtensionDiscountModifierEnum.PromotionExtensionDiscountModifier', '10': 'discountModifier'},
    ...
    const {'1': 'occasion', '3': 9, '4': 1, '5': 14, '6': '.google.ads.googleads.v9.enums.PromotionExtensionOccasionEnum.PromotionExtensionOccasion', '10': 'occasion'},
    ...
    const {'1': 'ad_schedule_targets', '3': 13, '4': 3, '5': 11, '6': '.google.ads.googleads.v9.common.AdScheduleInfo', '10': 'adScheduleTargets'},
    const {'1': 'percent_off', '3': 3, '4': 1, '5': 3, '9': 0, '10': 'percentOff'},
    const {'1': 'money_amount_off', '3': 4, '4': 1, '5': 11, '6': '.google.ads.googleads.v9.common.Money', '9': 0, '10': 'moneyAmountOff'},
    const {'1': 'promotion_code', '3': 5, '4': 1, '5': 9, '9': 1, '10': 'promotionCode'},
    const {'1': 'orders_over_amount', '3': 6, '4': 1, '5': 11, '6': '.google.ads.googleads.v9.common.Money', '9': 1, '10': 'ordersOverAmount'},
  ],
  '8': const [
...
final $typed_data.Uint8List promotionAssetDescriptor = $convert.base64Decode('');
...
const CalloutAsset$json = const {
  ...
  '2': const [
    ...
    const {'1': 'ad_schedule_targets', '3': 4, '4': 3, '5': 11, '6': '.google.ads.googleads.v9.common.AdScheduleInfo', '10': 'adScheduleTargets'},
  ],
};

/// Descriptor for `CalloutAsset`. Decode as a `google.protobuf.DescriptorProto`.
final $typed_data.Uint8List calloutAssetDescriptor = $convert.base64Decode('');
...
const SitelinkAsset$json = const {
  ...
  '2': const [
    ...
    const {'1': 'ad_schedule_targets', '3': 6, '4': 3, '5': 11, '6': '.google.ads.googleads.v9.common.AdScheduleInfo', '10': 'adScheduleTargets'},
  ],
};

/// Descriptor for `SitelinkAsset`. Decode as a `google.protobuf.DescriptorProto`.
final $typed_data.Uint8List sitelinkAssetDescriptor = $convert.base64Decode('');
...
const MobileAppAsset$json = const {
  ...
  '2': const [
    ...
    const {'1': 'app_store', '3': 2, '4': 1, '5': 14, '6': '.google.ads.googleads.v9.enums.MobileAppVendorEnum.MobileAppVendor', '8': const {}, '10': 'appStore'},
...
final $typed_data.Uint8List mobileAppAssetDescriptor = $convert.base64Decode('');
...
const CallAsset$json = const {
  ...
  '2': const [
    ...
    const {'1': 'call_conversion_reporting_state', '3': 3, '4': 1, '5': 14, '6': '.google.ads.googleads.v9.enums.CallConversionReportingStateEnum.CallConversionReportingState', '10': 'callConversionReportingState'},
    const {'1': 'call_conversion_action', '3': 4, '4': 1, '5': 9, '8': const {}, '10': 'callConversionAction'},
    const {'1': 'ad_schedule_targets', '3': 5, '4': 3, '5': 11, '6': '.google.ads.googleads.v9.common.AdScheduleInfo', '10': 'adScheduleTargets'},
  ],
};

/// Descriptor for `CallAsset`. Decode as a `google.protobuf.DescriptorProto`.
final $typed_data.Uint8List callAssetDescriptor = $convert.base64Decode('');
@$core.Deprecated('Use priceAssetDescriptor instead')
const PriceAsset$json = const {
  '1': 'PriceAsset',
  '2': const [
    const {'1': 'type', '3': 1, '4': 1, '5': 14, '6': '.google.ads.googleads.v9.enums.PriceExtensionTypeEnum.PriceExtensionType', '8': const {}, '10': 'type'},
    const {'1': 'price_qualifier', '3': 2, '4': 1, '5': 14, '6': '.google.ads.googleads.v9.enums.PriceExtensionPriceQualifierEnum.PriceExtensionPriceQualifier', '10': 'priceQualifier'},
    const {'1': 'language_code', '3': 3, '4': 1, '5': 9, '8': const {}, '10': 'languageCode'},
    const {'1': 'price_offerings', '3': 4, '4': 3, '5': 11, '6': '.google.ads.googleads.v9.common.PriceOffering', '10': 'priceOfferings'},
  ],
};

/// Descriptor for `PriceAsset`. Decode as a `google.protobuf.DescriptorProto`.
final $typed_data.Uint8List priceAssetDescriptor = $convert.base64Decode('');
...
const PriceOffering$json = const {
  ...
  '2': const [
    ...
    const {'1': 'price', '3': 3, '4': 1, '5': 11, '6': '.google.ads.googleads.v9.common.Money', '8': const {}, '10': 'price'},
    const {'1': 'unit', '3': 4, '4': 1, '5': 14, '6': '.google.ads.googleads.v9.enums.PriceExtensionPriceUnitEnum.PriceExtensionPriceUnit', '10': 'unit'},
...
const CallToActionAsset$json = const {
  '1': 'CallToActionAsset',
  '2': const [
    const {'1': 'call_to_action', '3': 1, '4': 1, '5': 14, '6': '.google.ads.googleads.v9.enums.CallToActionTypeEnum.CallToActionType', '10': 'callToAction'},
  ],
};

/// Descriptor for `CallToActionAsset`. Decode as a `google.protobuf.DescriptorProto`.
final $typed_data.Uint8List callToActionAssetDescriptor = $convert.base64Decode('ChFDYWxsVG9BY3Rpb25Bc3NldBJqCg5jYWxsX3RvX2FjdGlvbhgBIAEoDjJELmdvb2dsZS5hZHMuZ29vZ2xlYWRzLnY5LmVudW1zLkNhbGxUb0FjdGlvblR5cGVFbnVtLkNhbGxUb0FjdGlvblR5cGVSDGNhbGxUb0FjdGlvbg==');

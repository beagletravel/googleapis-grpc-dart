...
import '../enums/budget_campaign_association_status.pbenum.dart' as $24;

class Segments extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'Segments', package: const $pb.PackageName(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'google.ads.googleads.v9.common'), createEmptyInstance: create)
...
class Keyword extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'Keyword', package: const $pb.PackageName(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'google.ads.googleads.v9.common'), createEmptyInstance: create)
...
class BudgetCampaignAssociationStatus extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'BudgetCampaignAssociationStatus', package: const $pb.PackageName(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'google.ads.googleads.v9.common'), createEmptyInstance: create)
    ..aOS(1, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'campaign')
    ..e<$24.BudgetCampaignAssociationStatusEnum_BudgetCampaignAssociationStatus>(2, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'status', $pb.PbFieldType.OE, defaultOrMaker: $24.BudgetCampaignAssociationStatusEnum_BudgetCampaignAssociationStatus.UNSPECIFIED, valueOf: $24.BudgetCampaignAssociationStatusEnum_BudgetCampaignAssociationStatus.valueOf, enumValues: $24.BudgetCampaignAssociationStatusEnum_BudgetCampaignAssociationStatus.values)
    ..hasRequiredFields = false
  ;
  ...
  factory BudgetCampaignAssociationStatus({
    ...
    $24.BudgetCampaignAssociationStatusEnum_BudgetCampaignAssociationStatus? status,
  }) {
    final _result = create();
    if (campaign != null) {
  ...
  @$pb.TagNumber(2)
  $24.BudgetCampaignAssociationStatusEnum_BudgetCampaignAssociationStatus get status => $_getN(1);
  @$pb.TagNumber(2)
  set status($24.BudgetCampaignAssociationStatusEnum_BudgetCampaignAssociationStatus v) { setField(2, v); }
  @$pb.TagNumber(2)
...
class AssetInteractionTarget extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'AssetInteractionTarget', package: const $pb.PackageName(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'google.ads.googleads.v9.common'), createEmptyInstance: create)

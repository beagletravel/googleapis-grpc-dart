...
const DynamicLocationSetFilter$json = const {
  ...
  '2': const [
    ...
    const {'1': 'business_name_filter', '3': 2, '4': 1, '5': 11, '6': '.google.ads.googleads.v9.common.BusinessNameFilter', '10': 'businessNameFilter'},
  ],
};

/// Descriptor for `DynamicLocationSetFilter`. Decode as a `google.protobuf.DescriptorProto`.
final $typed_data.Uint8List dynamicLocationSetFilterDescriptor = $convert.base64Decode('ChhEeW5hbWljTG9jYXRpb25TZXRGaWx0ZXISFgoGbGFiZWxzGAEgAygJUgZsYWJlbHMSZAoUYnVzaW5lc3NfbmFtZV9maWx0ZXIYAiABKAsyMi5nb29nbGUuYWRzLmdvb2dsZWFkcy52OS5jb21tb24uQnVzaW5lc3NOYW1lRmlsdGVyUhJidXNpbmVzc05hbWVGaWx0ZXI=');
...
const BusinessNameFilter$json = const {
  ...
  '2': const [
    ...
    const {'1': 'filter_type', '3': 2, '4': 1, '5': 14, '6': '.google.ads.googleads.v9.enums.FeedItemSetStringFilterTypeEnum.FeedItemSetStringFilterType', '10': 'filterType'},
  ],
};

/// Descriptor for `BusinessNameFilter`. Decode as a `google.protobuf.DescriptorProto`.
final $typed_data.Uint8List businessNameFilterDescriptor = $convert.base64Decode('ChJCdXNpbmVzc05hbWVGaWx0ZXISIwoNYnVzaW5lc3NfbmFtZRgBIAEoCVIMYnVzaW5lc3NOYW1lEnsKC2ZpbHRlcl90eXBlGAIgASgOMlouZ29vZ2xlLmFkcy5nb29nbGVhZHMudjkuZW51bXMuRmVlZEl0ZW1TZXRTdHJpbmdGaWx0ZXJUeXBlRW51bS5GZWVkSXRlbVNldFN0cmluZ0ZpbHRlclR5cGVSCmZpbHRlclR5cGU=');

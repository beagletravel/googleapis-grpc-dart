...
import '../enums/criterion_category_channel_availability_mode.pbenum.dart' as $0;
...
class CriterionCategoryAvailability extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'CriterionCategoryAvailability', package: const $pb.PackageName(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'google.ads.googleads.v10.common'), createEmptyInstance: create)
    ..aOM<CriterionCategoryChannelAvailability>(1, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'channel', subBuilder: CriterionCategoryChannelAvailability.create)
    ..pc<CriterionCategoryLocaleAvailability>(2, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'locale', $pb.PbFieldType.PM, subBuilder: CriterionCategoryLocaleAvailability.create)
  ...
  'Will be removed in next major version')
  CriterionCategoryAvailability copyWith(void Function(CriterionCategoryAvailability) updates) => super.copyWith((message) => updates(message as CriterionCategoryAvailability)) as CriterionCategoryAvailability; // ignore: deprecated_member_use
...
class CriterionCategoryChannelAvailability extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'CriterionCategoryChannelAvailability', package: const $pb.PackageName(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'google.ads.googleads.v10.common'), createEmptyInstance: create)
    ..e<$0.CriterionCategoryChannelAvailabilityModeEnum_CriterionCategoryChannelAvailabilityMode>(1, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'availabilityMode', $pb.PbFieldType.OE, defaultOrMaker: $0.CriterionCategoryChannelAvailabilityModeEnum_CriterionCategoryChannelAvailabilityMode.UNSPECIFIED, valueOf: $0.CriterionCategoryChannelAvailabilityModeEnum_CriterionCategoryChannelAvailabilityMode.valueOf, enumValues: $0.CriterionCategoryChannelAvailabilityModeEnum_CriterionCategoryChannelAvailabilityMode.values)
    ..e<$1.AdvertisingChannelTypeEnum_AdvertisingChannelType>(2, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'advertisingChannelType', $pb.PbFieldType.OE, defaultOrMaker: $1.AdvertisingChannelTypeEnum_AdvertisingChannelType.UNSPECIFIED, valueOf: $1.AdvertisingChannelTypeEnum_AdvertisingChannelType.valueOf, enumValues: $1.AdvertisingChannelTypeEnum_AdvertisingChannelType.values)
    ..pc<$2.AdvertisingChannelSubTypeEnum_AdvertisingChannelSubType>(3, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'advertisingChannelSubType', $pb.PbFieldType.PE, valueOf: $2.AdvertisingChannelSubTypeEnum_AdvertisingChannelSubType.valueOf, enumValues: $2.AdvertisingChannelSubTypeEnum_AdvertisingChannelSubType.values)
    ..aOB(5, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'includeDefaultChannelSubType')
    ..hasRequiredFields = false
  ;

  CriterionCategoryChannelAvailability._() : super();
  factory CriterionCategoryChannelAvailability({
    $0.CriterionCategoryChannelAvailabilityModeEnum_CriterionCategoryChannelAvailabilityMode? availabilityMode,
    $1.AdvertisingChannelTypeEnum_AdvertisingChannelType? advertisingChannelType,
    $core.Iterable<$2.AdvertisingChannelSubTypeEnum_AdvertisingChannelSubType>? advertisingChannelSubType,
  ...
  'Use [GeneratedMessageGenericExtensions.rebuild] instead. '
  'Will be removed in next major version')
  CriterionCategoryChannelAvailability copyWith(void Function(CriterionCategoryChannelAvailability) updates) => super.copyWith((message) => updates(message as CriterionCategoryChannelAvailability)) as CriterionCategoryChannelAvailability; // ignore: deprecated_member_use
  $pb.BuilderInfo get info_ => _i;
  @$core.pragma('dart2js:noInline')
  ...
  @$pb.TagNumber(1)
  $0.CriterionCategoryChannelAvailabilityModeEnum_CriterionCategoryChannelAvailabilityMode get availabilityMode => $_getN(0);
  @$pb.TagNumber(1)
  set availabilityMode($0.CriterionCategoryChannelAvailabilityModeEnum_CriterionCategoryChannelAvailabilityMode v) { setField(1, v); }
  @$pb.TagNumber(1)
  ...
  @$pb.TagNumber(2)
  $1.AdvertisingChannelTypeEnum_AdvertisingChannelType get advertisingChannelType => $_getN(1);
  @$pb.TagNumber(2)
  set advertisingChannelType($1.AdvertisingChannelTypeEnum_AdvertisingChannelType v) { setField(2, v); }
  @$pb.TagNumber(2)
  ...
  @$pb.TagNumber(3)
  $core.List<$2.AdvertisingChannelSubTypeEnum_AdvertisingChannelSubType> get advertisingChannelSubType => $_getList(2);
...
class CriterionCategoryLocaleAvailability extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'CriterionCategoryLocaleAvailability', package: const $pb.PackageName(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'google.ads.googleads.v10.common'), createEmptyInstance: create)
    ..e<$3.CriterionCategoryLocaleAvailabilityModeEnum_CriterionCategoryLocaleAvailabilityMode>(1, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'availabilityMode', $pb.PbFieldType.OE, defaultOrMaker: $3.CriterionCategoryLocaleAvailabilityModeEnum_CriterionCategoryLocaleAvailabilityMode.UNSPECIFIED, valueOf: $3.CriterionCategoryLocaleAvailabilityModeEnum_CriterionCategoryLocaleAvailabilityMode.valueOf, enumValues: $3.CriterionCategoryLocaleAvailabilityModeEnum_CriterionCategoryLocaleAvailabilityMode.values)
  ...
  factory CriterionCategoryLocaleAvailability({
    $3.CriterionCategoryLocaleAvailabilityModeEnum_CriterionCategoryLocaleAvailabilityMode? availabilityMode,
  ...
  'Use [GeneratedMessageGenericExtensions.rebuild] instead. '
  'Will be removed in next major version')
  CriterionCategoryLocaleAvailability copyWith(void Function(CriterionCategoryLocaleAvailability) updates) => super.copyWith((message) => updates(message as CriterionCategoryLocaleAvailability)) as CriterionCategoryLocaleAvailability; // ignore: deprecated_member_use
  $pb.BuilderInfo get info_ => _i;
  @$core.pragma('dart2js:noInline')
  ...
  @$pb.TagNumber(1)
  $3.CriterionCategoryLocaleAvailabilityModeEnum_CriterionCategoryLocaleAvailabilityMode get availabilityMode => $_getN(0);
  @$pb.TagNumber(1)
  set availabilityMode($3.CriterionCategoryLocaleAvailabilityModeEnum_CriterionCategoryLocaleAvailabilityMode v) { setField(1, v); }
  @$pb.TagNumber(1)
  $core.bool hasAvailabilityMode() => $_has(0);
  @$pb.TagNumber(1)
  void clearAvailabilityMode() => clearField(1);

...
class FinalAppUrl extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'FinalAppUrl', package: const $pb.PackageName(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'google.ads.googleads.v10.common'), createEmptyInstance: create)
    ..e<$0.AppUrlOperatingSystemTypeEnum_AppUrlOperatingSystemType>(1, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'osType', $pb.PbFieldType.OE, defaultOrMaker: $0.AppUrlOperatingSystemTypeEnum_AppUrlOperatingSystemType.UNSPECIFIED, valueOf: $0.AppUrlOperatingSystemTypeEnum_AppUrlOperatingSystemType.valueOf, enumValues: $0.AppUrlOperatingSystemTypeEnum_AppUrlOperatingSystemType.values)
  ...
  'Will be removed in next major version')
  FinalAppUrl copyWith(void Function(FinalAppUrl) updates) => super.copyWith((message) => updates(message as FinalAppUrl)) as FinalAppUrl; // ignore: deprecated_member_use
  ...
  @$pb.TagNumber(1)
  $0.AppUrlOperatingSystemTypeEnum_AppUrlOperatingSystemType get osType => $_getN(0);
  @$pb.TagNumber(1)
  set osType($0.AppUrlOperatingSystemTypeEnum_AppUrlOperatingSystemType v) { setField(1, v); }
  @$pb.TagNumber(1)

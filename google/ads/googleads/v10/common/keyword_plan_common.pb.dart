...
class KeywordPlanHistoricalMetrics extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'KeywordPlanHistoricalMetrics', package: const $pb.PackageName(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'google.ads.googleads.v10.common'), createEmptyInstance: create)
    ..e<$1.KeywordPlanCompetitionLevelEnum_KeywordPlanCompetitionLevel>(2, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'competition', $pb.PbFieldType.OE, defaultOrMaker: $1.KeywordPlanCompetitionLevelEnum_KeywordPlanCompetitionLevel.UNSPECIFIED, valueOf: $1.KeywordPlanCompetitionLevelEnum_KeywordPlanCompetitionLevel.valueOf, enumValues: $1.KeywordPlanCompetitionLevelEnum_KeywordPlanCompetitionLevel.values)
    ..pc<MonthlySearchVolume>(6, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'monthlySearchVolumes', $pb.PbFieldType.PM, subBuilder: MonthlySearchVolume.create)
    ..aInt64(7, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'avgMonthlySearches')
    ..aInt64(8, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'competitionIndex')
    ..aInt64(9, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'lowTopOfPageBidMicros')
    ..aInt64(10, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'highTopOfPageBidMicros')
    ..aInt64(11, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'averageCpcMicros')
  ...
  factory KeywordPlanHistoricalMetrics({
    ...
    if (averageCpcMicros != null) {
      _result.averageCpcMicros = averageCpcMicros;
    }
    return _result;
  }
  ...
  'Will be removed in next major version')
  KeywordPlanHistoricalMetrics copyWith(void Function(KeywordPlanHistoricalMetrics) updates) => super.copyWith((message) => updates(message as KeywordPlanHistoricalMetrics)) as KeywordPlanHistoricalMetrics; // ignore: deprecated_member_use
  ...
  @$pb.TagNumber(2)
  $1.KeywordPlanCompetitionLevelEnum_KeywordPlanCompetitionLevel get competition => $_getN(0);
  @$pb.TagNumber(2)
...
class HistoricalMetricsOptions extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'HistoricalMetricsOptions', package: const $pb.PackageName(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'google.ads.googleads.v10.common'), createEmptyInstance: create)
    ..aOM<$0.YearMonthRange>(1, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'yearMonthRange', subBuilder: $0.YearMonthRange.create)
    ..aOB(2, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'includeAverageCpc')
    ..hasRequiredFields = false
  ;
  ...
  factory HistoricalMetricsOptions({
    ...
    if (includeAverageCpc != null) {
      _result.includeAverageCpc = includeAverageCpc;
    }
    return _result;
  }
  ...
  'Use [GeneratedMessageGenericExtensions.rebuild] instead. '
  'Will be removed in next major version')
  HistoricalMetricsOptions copyWith(void Function(HistoricalMetricsOptions) updates) => super.copyWith((message) => updates(message as HistoricalMetricsOptions)) as HistoricalMetricsOptions; // ignore: deprecated_member_use
  $pb.BuilderInfo get info_ => _i;
  @$core.pragma('dart2js:noInline')
  ...
  @$pb.TagNumber(1)
  set yearMonthRange($0.YearMonthRange v) { setField(1, v); }
  @$pb.TagNumber(1)
...
class MonthlySearchVolume extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'MonthlySearchVolume', package: const $pb.PackageName(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'google.ads.googleads.v10.common'), createEmptyInstance: create)
    ..e<$2.MonthOfYearEnum_MonthOfYear>(2, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'month', $pb.PbFieldType.OE, defaultOrMaker: $2.MonthOfYearEnum_MonthOfYear.UNSPECIFIED, valueOf: $2.MonthOfYearEnum_MonthOfYear.valueOf, enumValues: $2.MonthOfYearEnum_MonthOfYear.values)
    ..aInt64(4, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'year')
    ..aInt64(5, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'monthlySearches')
    ..hasRequiredFields = false
  ;
  ...
  'Use [GeneratedMessageGenericExtensions.rebuild] instead. '
  'Will be removed in next major version')
  MonthlySearchVolume copyWith(void Function(MonthlySearchVolume) updates) => super.copyWith((message) => updates(message as MonthlySearchVolume)) as MonthlySearchVolume; // ignore: deprecated_member_use
  $pb.BuilderInfo get info_ => _i;
  @$core.pragma('dart2js:noInline')
  ...
  @$pb.TagNumber(2)
  set month($2.MonthOfYearEnum_MonthOfYear v) { setField(2, v); }
  @$pb.TagNumber(2)
...
class KeywordPlanAggregateMetrics extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'KeywordPlanAggregateMetrics', package: const $pb.PackageName(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'google.ads.googleads.v10.common'), createEmptyInstance: create)
    ..pc<$3.KeywordPlanAggregateMetricTypeEnum_KeywordPlanAggregateMetricType>(1, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'aggregateMetricTypes', $pb.PbFieldType.PE, valueOf: $3.KeywordPlanAggregateMetricTypeEnum_KeywordPlanAggregateMetricType.valueOf, enumValues: $3.KeywordPlanAggregateMetricTypeEnum_KeywordPlanAggregateMetricType.values)
    ..hasRequiredFields = false
  ;

  KeywordPlanAggregateMetrics._() : super();
  factory KeywordPlanAggregateMetrics({
    $core.Iterable<$3.KeywordPlanAggregateMetricTypeEnum_KeywordPlanAggregateMetricType>? aggregateMetricTypes,
  }) {
    final _result = create();
  ...
  'Use [GeneratedMessageGenericExtensions.rebuild] instead. '
  'Will be removed in next major version')
  KeywordPlanAggregateMetrics copyWith(void Function(KeywordPlanAggregateMetrics) updates) => super.copyWith((message) => updates(message as KeywordPlanAggregateMetrics)) as KeywordPlanAggregateMetrics; // ignore: deprecated_member_use
  $pb.BuilderInfo get info_ => _i;
  @$core.pragma('dart2js:noInline')
  ...
  @$pb.TagNumber(1)
  $core.List<$3.KeywordPlanAggregateMetricTypeEnum_KeywordPlanAggregateMetricType> get aggregateMetricTypes => $_getList(0);
}

class KeywordPlanAggregateMetricResults extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'KeywordPlanAggregateMetricResults', package: const $pb.PackageName(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'google.ads.googleads.v10.common'), createEmptyInstance: create)
    ..pc<KeywordPlanDeviceSearches>(1, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'deviceSearches', $pb.PbFieldType.PM, subBuilder: KeywordPlanDeviceSearches.create)
    ..hasRequiredFields = false
  ;
  ...
  'Use [GeneratedMessageGenericExtensions.rebuild] instead. '
  'Will be removed in next major version')
  KeywordPlanAggregateMetricResults copyWith(void Function(KeywordPlanAggregateMetricResults) updates) => super.copyWith((message) => updates(message as KeywordPlanAggregateMetricResults)) as KeywordPlanAggregateMetricResults; // ignore: deprecated_member_use
  $pb.BuilderInfo get info_ => _i;
  @$core.pragma('dart2js:noInline')
...
class KeywordPlanDeviceSearches extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'KeywordPlanDeviceSearches', package: const $pb.PackageName(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'google.ads.googleads.v10.common'), createEmptyInstance: create)
    ..e<$4.DeviceEnum_Device>(1, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'device', $pb.PbFieldType.OE, defaultOrMaker: $4.DeviceEnum_Device.UNSPECIFIED, valueOf: $4.DeviceEnum_Device.valueOf, enumValues: $4.DeviceEnum_Device.values)
    ..aInt64(2, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'searchCount')
    ..hasRequiredFields = false
  ;
  ...
  'Use [GeneratedMessageGenericExtensions.rebuild] instead. '
  'Will be removed in next major version')
  KeywordPlanDeviceSearches copyWith(void Function(KeywordPlanDeviceSearches) updates) => super.copyWith((message) => updates(message as KeywordPlanDeviceSearches)) as KeywordPlanDeviceSearches; // ignore: deprecated_member_use
  $pb.BuilderInfo get info_ => _i;
  @$core.pragma('dart2js:noInline')
  ...
  @$pb.TagNumber(1)
  set device($4.DeviceEnum_Device v) { setField(1, v); }
  @$pb.TagNumber(1)
...
class KeywordAnnotations extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'KeywordAnnotations', package: const $pb.PackageName(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'google.ads.googleads.v10.common'), createEmptyInstance: create)
    ..pc<KeywordConcept>(1, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'concepts', $pb.PbFieldType.PM, subBuilder: KeywordConcept.create)
    ..hasRequiredFields = false
  ;
  ...
  'Use [GeneratedMessageGenericExtensions.rebuild] instead. '
  'Will be removed in next major version')
  KeywordAnnotations copyWith(void Function(KeywordAnnotations) updates) => super.copyWith((message) => updates(message as KeywordAnnotations)) as KeywordAnnotations; // ignore: deprecated_member_use
  $pb.BuilderInfo get info_ => _i;
  @$core.pragma('dart2js:noInline')
...
class KeywordConcept extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'KeywordConcept', package: const $pb.PackageName(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'google.ads.googleads.v10.common'), createEmptyInstance: create)
    ..aOS(1, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'name')
    ..aOM<ConceptGroup>(2, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'conceptGroup', subBuilder: ConceptGroup.create)
    ..hasRequiredFields = false
  ;
  ...
  'Use [GeneratedMessageGenericExtensions.rebuild] instead. '
  'Will be removed in next major version')
  KeywordConcept copyWith(void Function(KeywordConcept) updates) => super.copyWith((message) => updates(message as KeywordConcept)) as KeywordConcept; // ignore: deprecated_member_use
  $pb.BuilderInfo get info_ => _i;
  @$core.pragma('dart2js:noInline')
...
class ConceptGroup extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'ConceptGroup', package: const $pb.PackageName(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'google.ads.googleads.v10.common'), createEmptyInstance: create)
    ..aOS(1, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'name')
    ..e<$5.KeywordPlanConceptGroupTypeEnum_KeywordPlanConceptGroupType>(2, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'type', $pb.PbFieldType.OE, defaultOrMaker: $5.KeywordPlanConceptGroupTypeEnum_KeywordPlanConceptGroupType.UNSPECIFIED, valueOf: $5.KeywordPlanConceptGroupTypeEnum_KeywordPlanConceptGroupType.valueOf, enumValues: $5.KeywordPlanConceptGroupTypeEnum_KeywordPlanConceptGroupType.values)
    ..hasRequiredFields = false
  ;
  ...
  'Use [GeneratedMessageGenericExtensions.rebuild] instead. '
  'Will be removed in next major version')
  ConceptGroup copyWith(void Function(ConceptGroup) updates) => super.copyWith((message) => updates(message as ConceptGroup)) as ConceptGroup; // ignore: deprecated_member_use
  $pb.BuilderInfo get info_ => _i;
  @$core.pragma('dart2js:noInline')
  ...
  @$pb.TagNumber(2)
  $5.KeywordPlanConceptGroupTypeEnum_KeywordPlanConceptGroupType get type => $_getN(1);
  @$pb.TagNumber(2)
  set type($5.KeywordPlanConceptGroupTypeEnum_KeywordPlanConceptGroupType v) { setField(2, v); }
  @$pb.TagNumber(2)

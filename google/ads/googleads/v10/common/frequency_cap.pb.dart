...
class FrequencyCapEntry extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'FrequencyCapEntry', package: const $pb.PackageName(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'google.ads.googleads.v10.common'), createEmptyInstance: create)
    ..aOM<FrequencyCapKey>(1, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'key', subBuilder: FrequencyCapKey.create)
    ..a<$core.int>(3, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'cap', $pb.PbFieldType.O3)
  ...
  'Will be removed in next major version')
  FrequencyCapEntry copyWith(void Function(FrequencyCapEntry) updates) => super.copyWith((message) => updates(message as FrequencyCapEntry)) as FrequencyCapEntry; // ignore: deprecated_member_use
...
class FrequencyCapKey extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'FrequencyCapKey', package: const $pb.PackageName(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'google.ads.googleads.v10.common'), createEmptyInstance: create)
    ..e<$0.FrequencyCapLevelEnum_FrequencyCapLevel>(1, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'level', $pb.PbFieldType.OE, defaultOrMaker: $0.FrequencyCapLevelEnum_FrequencyCapLevel.UNSPECIFIED, valueOf: $0.FrequencyCapLevelEnum_FrequencyCapLevel.valueOf, enumValues: $0.FrequencyCapLevelEnum_FrequencyCapLevel.values)
    ..e<$1.FrequencyCapTimeUnitEnum_FrequencyCapTimeUnit>(2, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'timeUnit', $pb.PbFieldType.OE, defaultOrMaker: $1.FrequencyCapTimeUnitEnum_FrequencyCapTimeUnit.UNSPECIFIED, valueOf: $1.FrequencyCapTimeUnitEnum_FrequencyCapTimeUnit.valueOf, enumValues: $1.FrequencyCapTimeUnitEnum_FrequencyCapTimeUnit.values)
    ..e<$2.FrequencyCapEventTypeEnum_FrequencyCapEventType>(3, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'eventType', $pb.PbFieldType.OE, defaultOrMaker: $2.FrequencyCapEventTypeEnum_FrequencyCapEventType.UNSPECIFIED, valueOf: $2.FrequencyCapEventTypeEnum_FrequencyCapEventType.valueOf, enumValues: $2.FrequencyCapEventTypeEnum_FrequencyCapEventType.values)
    ..a<$core.int>(5, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'timeLength', $pb.PbFieldType.O3)
    ..hasRequiredFields = false
  ;
  ...
  'Use [GeneratedMessageGenericExtensions.rebuild] instead. '
  'Will be removed in next major version')
  FrequencyCapKey copyWith(void Function(FrequencyCapKey) updates) => super.copyWith((message) => updates(message as FrequencyCapKey)) as FrequencyCapKey; // ignore: deprecated_member_use
  $pb.BuilderInfo get info_ => _i;
  @$core.pragma('dart2js:noInline')
  ...
  @$pb.TagNumber(1)
  set level($0.FrequencyCapLevelEnum_FrequencyCapLevel v) { setField(1, v); }
  @$pb.TagNumber(1)
  ...
  @$pb.TagNumber(2)
  set timeUnit($1.FrequencyCapTimeUnitEnum_FrequencyCapTimeUnit v) { setField(2, v); }
  @$pb.TagNumber(2)
  ...
  @$pb.TagNumber(3)
  set eventType($2.FrequencyCapEventTypeEnum_FrequencyCapEventType v) { setField(3, v); }
  @$pb.TagNumber(3)

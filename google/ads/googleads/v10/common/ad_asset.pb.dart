...
class AdTextAsset extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'AdTextAsset', package: const $pb.PackageName(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'google.ads.googleads.v10.common'), createEmptyInstance: create)
    ..e<$1.ServedAssetFieldTypeEnum_ServedAssetFieldType>(2, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'pinnedField', $pb.PbFieldType.OE, defaultOrMaker: $1.ServedAssetFieldTypeEnum_ServedAssetFieldType.UNSPECIFIED, valueOf: $1.ServedAssetFieldTypeEnum_ServedAssetFieldType.valueOf, enumValues: $1.ServedAssetFieldTypeEnum_ServedAssetFieldType.values)
    ..aOS(4, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'text')
    ..e<$2.AssetPerformanceLabelEnum_AssetPerformanceLabel>(5, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'assetPerformanceLabel', $pb.PbFieldType.OE, defaultOrMaker: $2.AssetPerformanceLabelEnum_AssetPerformanceLabel.UNSPECIFIED, valueOf: $2.AssetPerformanceLabelEnum_AssetPerformanceLabel.valueOf, enumValues: $2.AssetPerformanceLabelEnum_AssetPerformanceLabel.values)
    ..aOM<$0.AdAssetPolicySummary>(6, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'policySummaryInfo', subBuilder: $0.AdAssetPolicySummary.create)
  ...
  'Will be removed in next major version')
  AdTextAsset copyWith(void Function(AdTextAsset) updates) => super.copyWith((message) => updates(message as AdTextAsset)) as AdTextAsset; // ignore: deprecated_member_use
  ...
  @$pb.TagNumber(2)
  set pinnedField($1.ServedAssetFieldTypeEnum_ServedAssetFieldType v) { setField(2, v); }
  @$pb.TagNumber(2)
  ...
  @$pb.TagNumber(5)
  $2.AssetPerformanceLabelEnum_AssetPerformanceLabel get assetPerformanceLabel => $_getN(2);
  @$pb.TagNumber(5)
  set assetPerformanceLabel($2.AssetPerformanceLabelEnum_AssetPerformanceLabel v) { setField(5, v); }
  @$pb.TagNumber(5)
  ...
  @$pb.TagNumber(6)
  set policySummaryInfo($0.AdAssetPolicySummary v) { setField(6, v); }
  @$pb.TagNumber(6)
...
class AdImageAsset extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'AdImageAsset', package: const $pb.PackageName(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'google.ads.googleads.v10.common'), createEmptyInstance: create)
  ...
  'Use [GeneratedMessageGenericExtensions.rebuild] instead. '
  'Will be removed in next major version')
  AdImageAsset copyWith(void Function(AdImageAsset) updates) => super.copyWith((message) => updates(message as AdImageAsset)) as AdImageAsset; // ignore: deprecated_member_use
  $pb.BuilderInfo get info_ => _i;
  @$core.pragma('dart2js:noInline')
...
class AdVideoAsset extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'AdVideoAsset', package: const $pb.PackageName(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'google.ads.googleads.v10.common'), createEmptyInstance: create)
    ..aOS(2, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'asset')
    ..hasRequiredFields = false
  ;
  ...
  'Use [GeneratedMessageGenericExtensions.rebuild] instead. '
  'Will be removed in next major version')
  AdVideoAsset copyWith(void Function(AdVideoAsset) updates) => super.copyWith((message) => updates(message as AdVideoAsset)) as AdVideoAsset; // ignore: deprecated_member_use
  $pb.BuilderInfo get info_ => _i;
  @$core.pragma('dart2js:noInline')
...
class AdMediaBundleAsset extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'AdMediaBundleAsset', package: const $pb.PackageName(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'google.ads.googleads.v10.common'), createEmptyInstance: create)
    ..aOS(2, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'asset')
    ..hasRequiredFields = false
  ;
  ...
  'Use [GeneratedMessageGenericExtensions.rebuild] instead. '
  'Will be removed in next major version')
  AdMediaBundleAsset copyWith(void Function(AdMediaBundleAsset) updates) => super.copyWith((message) => updates(message as AdMediaBundleAsset)) as AdMediaBundleAsset; // ignore: deprecated_member_use
  $pb.BuilderInfo get info_ => _i;
  @$core.pragma('dart2js:noInline')
...
class AdDiscoveryCarouselCardAsset extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'AdDiscoveryCarouselCardAsset', package: const $pb.PackageName(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'google.ads.googleads.v10.common'), createEmptyInstance: create)
  ...
  'Use [GeneratedMessageGenericExtensions.rebuild] instead. '
  'Will be removed in next major version')
  AdDiscoveryCarouselCardAsset copyWith(void Function(AdDiscoveryCarouselCardAsset) updates) => super.copyWith((message) => updates(message as AdDiscoveryCarouselCardAsset)) as AdDiscoveryCarouselCardAsset; // ignore: deprecated_member_use
  $pb.BuilderInfo get info_ => _i;
  @$core.pragma('dart2js:noInline')

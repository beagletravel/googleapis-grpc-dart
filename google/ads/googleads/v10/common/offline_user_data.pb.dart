...
class OfflineUserAddressInfo extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'OfflineUserAddressInfo', package: const $pb.PackageName(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'google.ads.googleads.v10.common'), createEmptyInstance: create)
    ..aOS(7, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'hashedFirstName')
    ..aOS(8, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'hashedLastName')
    ...
    ..aOS(13, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'hashedStreetAddress')
  ...
  'Will be removed in next major version')
  OfflineUserAddressInfo copyWith(void Function(OfflineUserAddressInfo) updates) => super.copyWith((message) => updates(message as OfflineUserAddressInfo)) as OfflineUserAddressInfo; // ignore: deprecated_member_use
...
class UserIdentifier extends $pb.GeneratedMessage {
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'UserIdentifier', package: const $pb.PackageName(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'google.ads.googleads.v10.common'), createEmptyInstance: create)
    ..oo(0, [5, 7, 8, 9, 10])
    ..aOM<OfflineUserAddressInfo>(5, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'addressInfo', subBuilder: OfflineUserAddressInfo.create)
    ..e<$0.UserIdentifierSourceEnum_UserIdentifierSource>(6, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'userIdentifierSource', $pb.PbFieldType.OE, defaultOrMaker: $0.UserIdentifierSourceEnum_UserIdentifierSource.UNSPECIFIED, valueOf: $0.UserIdentifierSourceEnum_UserIdentifierSource.valueOf, enumValues: $0.UserIdentifierSourceEnum_UserIdentifierSource.values)
    ..aOS(7, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'hashedEmail')
    ..aOS(8, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'hashedPhoneNumber')
    ..aOS(9, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'mobileId')
    ..aOS(10, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'thirdPartyUserId')
    ..hasRequiredFields = false
  ;
  ...
  @$pb.TagNumber(6)
  $0.UserIdentifierSourceEnum_UserIdentifierSource get userIdentifierSource => $_getN(1);
  @$pb.TagNumber(6)
  set userIdentifierSource($0.UserIdentifierSourceEnum_UserIdentifierSource v) { setField(6, v); }
  @$pb.TagNumber(6)
...
class TransactionAttribute extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'TransactionAttribute', package: const $pb.PackageName(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'google.ads.googleads.v10.common'), createEmptyInstance: create)
    ..aOM<StoreAttribute>(6, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'storeAttribute', subBuilder: StoreAttribute.create)
    ..aOS(8, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'transactionDateTime')
    ..a<$core.double>(9, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'transactionAmountMicros', $pb.PbFieldType.OD)
    ..aOS(10, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'currencyCode')
    ..aOS(11, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'conversionAction')
    ..aOS(12, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'orderId')
    ..aOS(13, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'customValue')
    ..aOM<ItemAttribute>(14, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'itemAttribute', subBuilder: ItemAttribute.create)
    ..hasRequiredFields = false
  ;
  ...
  'Use [GeneratedMessageGenericExtensions.rebuild] instead. '
  'Will be removed in next major version')
  TransactionAttribute copyWith(void Function(TransactionAttribute) updates) => super.copyWith((message) => updates(message as TransactionAttribute)) as TransactionAttribute; // ignore: deprecated_member_use
  $pb.BuilderInfo get info_ => _i;
  @$core.pragma('dart2js:noInline')
...
class StoreAttribute extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'StoreAttribute', package: const $pb.PackageName(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'google.ads.googleads.v10.common'), createEmptyInstance: create)
    ..aOS(2, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'storeCode')
    ..hasRequiredFields = false
  ;
  ...
  'Use [GeneratedMessageGenericExtensions.rebuild] instead. '
  'Will be removed in next major version')
  StoreAttribute copyWith(void Function(StoreAttribute) updates) => super.copyWith((message) => updates(message as StoreAttribute)) as StoreAttribute; // ignore: deprecated_member_use
  $pb.BuilderInfo get info_ => _i;
  @$core.pragma('dart2js:noInline')
...
class ItemAttribute extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'ItemAttribute', package: const $pb.PackageName(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'google.ads.googleads.v10.common'), createEmptyInstance: create)
    ..aOS(1, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'itemId')
    ..aInt64(2, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'merchantId')
    ...
    ..aInt64(5, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'quantity')
    ..hasRequiredFields = false
  ;
  ...
  'Use [GeneratedMessageGenericExtensions.rebuild] instead. '
  'Will be removed in next major version')
  ItemAttribute copyWith(void Function(ItemAttribute) updates) => super.copyWith((message) => updates(message as ItemAttribute)) as ItemAttribute; // ignore: deprecated_member_use
  $pb.BuilderInfo get info_ => _i;
  @$core.pragma('dart2js:noInline')
...
class UserData extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'UserData', package: const $pb.PackageName(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'google.ads.googleads.v10.common'), createEmptyInstance: create)
    ..pc<UserIdentifier>(1, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'userIdentifiers', $pb.PbFieldType.PM, subBuilder: UserIdentifier.create)
    ..aOM<TransactionAttribute>(2, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'transactionAttribute', subBuilder: TransactionAttribute.create)
    ..aOM<UserAttribute>(3, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'userAttribute', subBuilder: UserAttribute.create)
    ..hasRequiredFields = false
  ;
...
class UserAttribute extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'UserAttribute', package: const $pb.PackageName(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'google.ads.googleads.v10.common'), createEmptyInstance: create)
    ..aInt64(1, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'lifetimeValueMicros')
    ..a<$core.int>(2, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'lifetimeValueBucket', $pb.PbFieldType.O3)
    ..aOS(3, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'lastPurchaseDateTime')
    ..a<$core.int>(4, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'averagePurchaseCount', $pb.PbFieldType.O3)
    ..aInt64(5, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'averagePurchaseValueMicros')
    ..aOS(6, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'acquisitionDateTime')
    ..aOM<ShoppingLoyalty>(7, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'shoppingLoyalty', subBuilder: ShoppingLoyalty.create)
    ..hasRequiredFields = false
  ;
  ...
  factory UserAttribute({
    ...
    if (shoppingLoyalty != null) {
      _result.shoppingLoyalty = shoppingLoyalty;
    }
    return _result;
  }
  ...
  'Use [GeneratedMessageGenericExtensions.rebuild] instead. '
  'Will be removed in next major version')
  UserAttribute copyWith(void Function(UserAttribute) updates) => super.copyWith((message) => updates(message as UserAttribute)) as UserAttribute; // ignore: deprecated_member_use
  $pb.BuilderInfo get info_ => _i;
  @$core.pragma('dart2js:noInline')
...
class ShoppingLoyalty extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'ShoppingLoyalty', package: const $pb.PackageName(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'google.ads.googleads.v10.common'), createEmptyInstance: create)
    ..aOS(1, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'loyaltyTier')
    ..hasRequiredFields = false
  ;
  ...
  factory ShoppingLoyalty({
    ...
    final _result = create();
    if (loyaltyTier != null) {
      _result.loyaltyTier = loyaltyTier;
    }
    return _result;
  }
  ...
  'Use [GeneratedMessageGenericExtensions.rebuild] instead. '
  'Will be removed in next major version')
  ShoppingLoyalty copyWith(void Function(ShoppingLoyalty) updates) => super.copyWith((message) => updates(message as ShoppingLoyalty)) as ShoppingLoyalty; // ignore: deprecated_member_use
  $pb.BuilderInfo get info_ => _i;
  @$core.pragma('dart2js:noInline')
...
class CustomerMatchUserListMetadata extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'CustomerMatchUserListMetadata', package: const $pb.PackageName(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'google.ads.googleads.v10.common'), createEmptyInstance: create)
  ...
  'Use [GeneratedMessageGenericExtensions.rebuild] instead. '
  'Will be removed in next major version')
  CustomerMatchUserListMetadata copyWith(void Function(CustomerMatchUserListMetadata) updates) => super.copyWith((message) => updates(message as CustomerMatchUserListMetadata)) as CustomerMatchUserListMetadata; // ignore: deprecated_member_use
  $pb.BuilderInfo get info_ => _i;
  @$core.pragma('dart2js:noInline')
...
class StoreSalesMetadata extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'StoreSalesMetadata', package: const $pb.PackageName(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'google.ads.googleads.v10.common'), createEmptyInstance: create)
    ..aOM<StoreSalesThirdPartyMetadata>(3, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'thirdPartyMetadata', subBuilder: StoreSalesThirdPartyMetadata.create)
    ..a<$core.double>(5, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'loyaltyFraction', $pb.PbFieldType.OD)
    ..a<$core.double>(6, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'transactionUploadFraction', $pb.PbFieldType.OD)
    ..aOS(7, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'customKey')
    ..hasRequiredFields = false
  ;
  ...
  'Use [GeneratedMessageGenericExtensions.rebuild] instead. '
  'Will be removed in next major version')
  StoreSalesMetadata copyWith(void Function(StoreSalesMetadata) updates) => super.copyWith((message) => updates(message as StoreSalesMetadata)) as StoreSalesMetadata; // ignore: deprecated_member_use
  $pb.BuilderInfo get info_ => _i;
  @$core.pragma('dart2js:noInline')
...
class StoreSalesThirdPartyMetadata extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'StoreSalesThirdPartyMetadata', package: const $pb.PackageName(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'google.ads.googleads.v10.common'), createEmptyInstance: create)
    ..aOS(7, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'advertiserUploadDateTime')
    ..a<$core.double>(8, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'validTransactionFraction', $pb.PbFieldType.OD)
    ..a<$core.double>(9, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'partnerMatchFraction', $pb.PbFieldType.OD)
    ..a<$core.double>(10, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'partnerUploadFraction', $pb.PbFieldType.OD)
    ..aOS(11, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'bridgeMapVersionId')
    ..aInt64(12, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'partnerId')
    ..hasRequiredFields = false
  ;
  ...
  'Use [GeneratedMessageGenericExtensions.rebuild] instead. '
  'Will be removed in next major version')
  StoreSalesThirdPartyMetadata copyWith(void Function(StoreSalesThirdPartyMetadata) updates) => super.copyWith((message) => updates(message as StoreSalesThirdPartyMetadata)) as StoreSalesThirdPartyMetadata; // ignore: deprecated_member_use
  $pb.BuilderInfo get info_ => _i;
  @$core.pragma('dart2js:noInline')

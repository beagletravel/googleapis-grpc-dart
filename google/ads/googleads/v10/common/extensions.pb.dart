...
class AppFeedItem extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'AppFeedItem', package: const $pb.PackageName(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'google.ads.googleads.v10.common'), createEmptyInstance: create)
    ..e<$2.AppStoreEnum_AppStore>(3, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'appStore', $pb.PbFieldType.OE, defaultOrMaker: $2.AppStoreEnum_AppStore.UNSPECIFIED, valueOf: $2.AppStoreEnum_AppStore.valueOf, enumValues: $2.AppStoreEnum_AppStore.values)
    ..pc<$0.CustomParameter>(7, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'urlCustomParameters', $pb.PbFieldType.PM, subBuilder: $0.CustomParameter.create)
    ..aOS(9, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'linkText')
    ..aOS(10, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'appId')
    ..pPS(11, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'finalUrls')
    ..pPS(12, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'finalMobileUrls')
    ..aOS(13, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'trackingUrlTemplate')
    ..aOS(14, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'finalUrlSuffix')
  ...
  'Will be removed in next major version')
  AppFeedItem copyWith(void Function(AppFeedItem) updates) => super.copyWith((message) => updates(message as AppFeedItem)) as AppFeedItem; // ignore: deprecated_member_use
  ...
  @$pb.TagNumber(3)
  set appStore($2.AppStoreEnum_AppStore v) { setField(3, v); }
  @$pb.TagNumber(3)
...
class CallFeedItem extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'CallFeedItem', package: const $pb.PackageName(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'google.ads.googleads.v10.common'), createEmptyInstance: create)
    ..e<$3.CallConversionReportingStateEnum_CallConversionReportingState>(6, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'callConversionReportingState', $pb.PbFieldType.OE, defaultOrMaker: $3.CallConversionReportingStateEnum_CallConversionReportingState.UNSPECIFIED, valueOf: $3.CallConversionReportingStateEnum_CallConversionReportingState.valueOf, enumValues: $3.CallConversionReportingStateEnum_CallConversionReportingState.values)
    ...
    ..aOB(9, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'callTrackingEnabled')
    ..aOS(10, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'callConversionAction')
    ..aOB(11, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'callConversionTrackingDisabled')
    ..hasRequiredFields = false
  ;

  CallFeedItem._() : super();
  factory CallFeedItem({
    $3.CallConversionReportingStateEnum_CallConversionReportingState? callConversionReportingState,
  ...
  'Use [GeneratedMessageGenericExtensions.rebuild] instead. '
  'Will be removed in next major version')
  CallFeedItem copyWith(void Function(CallFeedItem) updates) => super.copyWith((message) => updates(message as CallFeedItem)) as CallFeedItem; // ignore: deprecated_member_use
  $pb.BuilderInfo get info_ => _i;
  @$core.pragma('dart2js:noInline')
  ...
  @$pb.TagNumber(6)
  $3.CallConversionReportingStateEnum_CallConversionReportingState get callConversionReportingState => $_getN(0);
  @$pb.TagNumber(6)
  set callConversionReportingState($3.CallConversionReportingStateEnum_CallConversionReportingState v) { setField(6, v); }
  @$pb.TagNumber(6)
...
class CalloutFeedItem extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'CalloutFeedItem', package: const $pb.PackageName(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'google.ads.googleads.v10.common'), createEmptyInstance: create)
    ..aOS(2, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'calloutText')
    ..hasRequiredFields = false
  ;
  ...
  'Use [GeneratedMessageGenericExtensions.rebuild] instead. '
  'Will be removed in next major version')
  CalloutFeedItem copyWith(void Function(CalloutFeedItem) updates) => super.copyWith((message) => updates(message as CalloutFeedItem)) as CalloutFeedItem; // ignore: deprecated_member_use
  $pb.BuilderInfo get info_ => _i;
  @$core.pragma('dart2js:noInline')
...
class LocationFeedItem extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'LocationFeedItem', package: const $pb.PackageName(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'google.ads.googleads.v10.common'), createEmptyInstance: create)
    ..aOS(9, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'businessName')
    ..aOS(10, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'addressLine1', protoName: 'address_line_1')
    ..aOS(11, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'addressLine2', protoName: 'address_line_2')
    ..aOS(12, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'city')
    ..aOS(13, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'province')
    ..aOS(14, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'postalCode')
    ..aOS(15, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'countryCode')
    ..aOS(16, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'phoneNumber')
    ..hasRequiredFields = false
  ;
  ...
  'Use [GeneratedMessageGenericExtensions.rebuild] instead. '
  'Will be removed in next major version')
  LocationFeedItem copyWith(void Function(LocationFeedItem) updates) => super.copyWith((message) => updates(message as LocationFeedItem)) as LocationFeedItem; // ignore: deprecated_member_use
  $pb.BuilderInfo get info_ => _i;
  @$core.pragma('dart2js:noInline')
...
class AffiliateLocationFeedItem extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'AffiliateLocationFeedItem', package: const $pb.PackageName(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'google.ads.googleads.v10.common'), createEmptyInstance: create)
    ..aOS(11, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'businessName')
    ..aOS(12, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'addressLine1', protoName: 'address_line_1')
    ..aOS(13, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'addressLine2', protoName: 'address_line_2')
    ..aOS(14, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'city')
    ..aOS(15, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'province')
    ..aOS(16, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'postalCode')
    ..aOS(17, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'countryCode')
    ..aOS(18, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'phoneNumber')
    ..aInt64(19, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'chainId')
    ..aOS(20, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'chainName')
    ..hasRequiredFields = false
  ;
  ...
  'Use [GeneratedMessageGenericExtensions.rebuild] instead. '
  'Will be removed in next major version')
  AffiliateLocationFeedItem copyWith(void Function(AffiliateLocationFeedItem) updates) => super.copyWith((message) => updates(message as AffiliateLocationFeedItem)) as AffiliateLocationFeedItem; // ignore: deprecated_member_use
  $pb.BuilderInfo get info_ => _i;
  @$core.pragma('dart2js:noInline')
...
class TextMessageFeedItem extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'TextMessageFeedItem', package: const $pb.PackageName(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'google.ads.googleads.v10.common'), createEmptyInstance: create)
    ..aOS(6, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'businessName')
    ...
    ..aOS(9, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'text')
    ..aOS(10, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'extensionText')
    ..hasRequiredFields = false
  ;
  ...
  'Use [GeneratedMessageGenericExtensions.rebuild] instead. '
  'Will be removed in next major version')
  TextMessageFeedItem copyWith(void Function(TextMessageFeedItem) updates) => super.copyWith((message) => updates(message as TextMessageFeedItem)) as TextMessageFeedItem; // ignore: deprecated_member_use
  $pb.BuilderInfo get info_ => _i;
  @$core.pragma('dart2js:noInline')
...
class PriceFeedItem extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'PriceFeedItem', package: const $pb.PackageName(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'google.ads.googleads.v10.common'), createEmptyInstance: create)
    ..e<$4.PriceExtensionTypeEnum_PriceExtensionType>(1, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'type', $pb.PbFieldType.OE, defaultOrMaker: $4.PriceExtensionTypeEnum_PriceExtensionType.UNSPECIFIED, valueOf: $4.PriceExtensionTypeEnum_PriceExtensionType.valueOf, enumValues: $4.PriceExtensionTypeEnum_PriceExtensionType.values)
    ..e<$5.PriceExtensionPriceQualifierEnum_PriceExtensionPriceQualifier>(2, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'priceQualifier', $pb.PbFieldType.OE, defaultOrMaker: $5.PriceExtensionPriceQualifierEnum_PriceExtensionPriceQualifier.UNSPECIFIED, valueOf: $5.PriceExtensionPriceQualifierEnum_PriceExtensionPriceQualifier.valueOf, enumValues: $5.PriceExtensionPriceQualifierEnum_PriceExtensionPriceQualifier.values)
    ..pc<PriceOffer>(5, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'priceOfferings', $pb.PbFieldType.PM, subBuilder: PriceOffer.create)
    ..aOS(7, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'trackingUrlTemplate')
    ..aOS(8, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'languageCode')
    ..aOS(9, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'finalUrlSuffix')
    ..hasRequiredFields = false
  ;
  ...
  factory PriceFeedItem({
    ...
    $5.PriceExtensionPriceQualifierEnum_PriceExtensionPriceQualifier? priceQualifier,
  ...
  'Use [GeneratedMessageGenericExtensions.rebuild] instead. '
  'Will be removed in next major version')
  PriceFeedItem copyWith(void Function(PriceFeedItem) updates) => super.copyWith((message) => updates(message as PriceFeedItem)) as PriceFeedItem; // ignore: deprecated_member_use
  $pb.BuilderInfo get info_ => _i;
  @$core.pragma('dart2js:noInline')
  ...
  @$pb.TagNumber(1)
  set type($4.PriceExtensionTypeEnum_PriceExtensionType v) { setField(1, v); }
  @$pb.TagNumber(1)
  ...
  @$pb.TagNumber(2)
  $5.PriceExtensionPriceQualifierEnum_PriceExtensionPriceQualifier get priceQualifier => $_getN(1);
  @$pb.TagNumber(2)
  set priceQualifier($5.PriceExtensionPriceQualifierEnum_PriceExtensionPriceQualifier v) { setField(2, v); }
  @$pb.TagNumber(2)
...
class PriceOffer extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'PriceOffer', package: const $pb.PackageName(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'google.ads.googleads.v10.common'), createEmptyInstance: create)
    ..aOM<$1.Money>(3, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'price', subBuilder: $1.Money.create)
    ..e<$6.PriceExtensionPriceUnitEnum_PriceExtensionPriceUnit>(4, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'unit', $pb.PbFieldType.OE, defaultOrMaker: $6.PriceExtensionPriceUnitEnum_PriceExtensionPriceUnit.UNSPECIFIED, valueOf: $6.PriceExtensionPriceUnitEnum_PriceExtensionPriceUnit.valueOf, enumValues: $6.PriceExtensionPriceUnitEnum_PriceExtensionPriceUnit.values)
    ..aOS(7, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'header')
    ..aOS(8, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'description')
    ..pPS(9, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'finalUrls')
    ..pPS(10, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'finalMobileUrls')
    ..hasRequiredFields = false
  ;
  ...
  'Use [GeneratedMessageGenericExtensions.rebuild] instead. '
  'Will be removed in next major version')
  PriceOffer copyWith(void Function(PriceOffer) updates) => super.copyWith((message) => updates(message as PriceOffer)) as PriceOffer; // ignore: deprecated_member_use
  $pb.BuilderInfo get info_ => _i;
  @$core.pragma('dart2js:noInline')
  ...
  @$pb.TagNumber(3)
  set price($1.Money v) { setField(3, v); }
  @$pb.TagNumber(3)
  ...
  @$pb.TagNumber(4)
  set unit($6.PriceExtensionPriceUnitEnum_PriceExtensionPriceUnit v) { setField(4, v); }
  @$pb.TagNumber(4)
...
class PromotionFeedItem extends $pb.GeneratedMessage {
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'PromotionFeedItem', package: const $pb.PackageName(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'google.ads.googleads.v10.common'), createEmptyInstance: create)
    ..oo(0, [4, 17])
    ..oo(1, [6, 18])
    ...
    ..aOM<$1.Money>(4, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'moneyAmountOff', subBuilder: $1.Money.create)
    ..aOM<$1.Money>(6, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'ordersOverAmount', subBuilder: $1.Money.create)
    ...
    ..pc<$0.CustomParameter>(13, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'urlCustomParameters', $pb.PbFieldType.PM, subBuilder: $0.CustomParameter.create)
    ..aOS(16, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'promotionTarget')
    ..aInt64(17, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'percentOff')
    ..aOS(18, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'promotionCode')
    ..aOS(19, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'promotionStartDate')
    ..aOS(20, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'promotionEndDate')
    ..pPS(21, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'finalUrls')
    ..pPS(22, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'finalMobileUrls')
    ...
    ..aOS(25, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'languageCode')
    ..hasRequiredFields = false
  ;
  ...
  'Use [GeneratedMessageGenericExtensions.rebuild] instead. '
  'Will be removed in next major version')
  PromotionFeedItem copyWith(void Function(PromotionFeedItem) updates) => super.copyWith((message) => updates(message as PromotionFeedItem)) as PromotionFeedItem; // ignore: deprecated_member_use
  $pb.BuilderInfo get info_ => _i;
  @$core.pragma('dart2js:noInline')
  ...
  @$pb.TagNumber(2)
  $7.PromotionExtensionDiscountModifierEnum_PromotionExtensionDiscountModifier get discountModifier => $_getN(0);
  @$pb.TagNumber(2)
  ...
  @$pb.TagNumber(4)
  set moneyAmountOff($1.Money v) { setField(4, v); }
  @$pb.TagNumber(4)
  ...
  @$pb.TagNumber(6)
  set ordersOverAmount($1.Money v) { setField(6, v); }
  @$pb.TagNumber(6)
  ...
  @$pb.TagNumber(9)
  $8.PromotionExtensionOccasionEnum_PromotionExtensionOccasion get occasion => $_getN(3);
  @$pb.TagNumber(9)
...
class StructuredSnippetFeedItem extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'StructuredSnippetFeedItem', package: const $pb.PackageName(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'google.ads.googleads.v10.common'), createEmptyInstance: create)
    ..aOS(3, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'header')
    ..pPS(4, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'values')
    ..hasRequiredFields = false
  ;
  ...
  'Use [GeneratedMessageGenericExtensions.rebuild] instead. '
  'Will be removed in next major version')
  StructuredSnippetFeedItem copyWith(void Function(StructuredSnippetFeedItem) updates) => super.copyWith((message) => updates(message as StructuredSnippetFeedItem)) as StructuredSnippetFeedItem; // ignore: deprecated_member_use
  $pb.BuilderInfo get info_ => _i;
  @$core.pragma('dart2js:noInline')
...
class SitelinkFeedItem extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'SitelinkFeedItem', package: const $pb.PackageName(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'google.ads.googleads.v10.common'), createEmptyInstance: create)
    ..pc<$0.CustomParameter>(7, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'urlCustomParameters', $pb.PbFieldType.PM, subBuilder: $0.CustomParameter.create)
    ..aOS(9, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'linkText')
    ..aOS(10, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'line1')
    ..aOS(11, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'line2')
    ..pPS(12, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'finalUrls')
    ..pPS(13, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'finalMobileUrls')
    ..aOS(14, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'trackingUrlTemplate')
    ..aOS(15, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'finalUrlSuffix')
    ..hasRequiredFields = false
  ;
  ...
  'Use [GeneratedMessageGenericExtensions.rebuild] instead. '
  'Will be removed in next major version')
  SitelinkFeedItem copyWith(void Function(SitelinkFeedItem) updates) => super.copyWith((message) => updates(message as SitelinkFeedItem)) as SitelinkFeedItem; // ignore: deprecated_member_use
  $pb.BuilderInfo get info_ => _i;
  @$core.pragma('dart2js:noInline')
...
class HotelCalloutFeedItem extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'HotelCalloutFeedItem', package: const $pb.PackageName(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'google.ads.googleads.v10.common'), createEmptyInstance: create)
  ...
  'Use [GeneratedMessageGenericExtensions.rebuild] instead. '
  'Will be removed in next major version')
  HotelCalloutFeedItem copyWith(void Function(HotelCalloutFeedItem) updates) => super.copyWith((message) => updates(message as HotelCalloutFeedItem)) as HotelCalloutFeedItem; // ignore: deprecated_member_use
  $pb.BuilderInfo get info_ => _i;
  @$core.pragma('dart2js:noInline')
...
class ImageFeedItem extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'ImageFeedItem', package: const $pb.PackageName(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'google.ads.googleads.v10.common'), createEmptyInstance: create)
    ..aOS(1, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'imageAsset')
    ..hasRequiredFields = false
  ;
  ...
  'Use [GeneratedMessageGenericExtensions.rebuild] instead. '
  'Will be removed in next major version')
  ImageFeedItem copyWith(void Function(ImageFeedItem) updates) => super.copyWith((message) => updates(message as ImageFeedItem)) as ImageFeedItem; // ignore: deprecated_member_use
  $pb.BuilderInfo get info_ => _i;
  @$core.pragma('dart2js:noInline')

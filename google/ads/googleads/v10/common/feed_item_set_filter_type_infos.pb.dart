...
class DynamicLocationSetFilter extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'DynamicLocationSetFilter', package: const $pb.PackageName(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'google.ads.googleads.v10.common'), createEmptyInstance: create)
    ..pPS(1, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'labels')
    ..aOM<BusinessNameFilter>(2, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'businessNameFilter', subBuilder: BusinessNameFilter.create)
  ...
  'Will be removed in next major version')
  DynamicLocationSetFilter copyWith(void Function(DynamicLocationSetFilter) updates) => super.copyWith((message) => updates(message as DynamicLocationSetFilter)) as DynamicLocationSetFilter; // ignore: deprecated_member_use
...
class BusinessNameFilter extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'BusinessNameFilter', package: const $pb.PackageName(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'google.ads.googleads.v10.common'), createEmptyInstance: create)
    ..aOS(1, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'businessName')
    ..e<$0.FeedItemSetStringFilterTypeEnum_FeedItemSetStringFilterType>(2, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'filterType', $pb.PbFieldType.OE, defaultOrMaker: $0.FeedItemSetStringFilterTypeEnum_FeedItemSetStringFilterType.UNSPECIFIED, valueOf: $0.FeedItemSetStringFilterTypeEnum_FeedItemSetStringFilterType.valueOf, enumValues: $0.FeedItemSetStringFilterTypeEnum_FeedItemSetStringFilterType.values)
    ..hasRequiredFields = false
  ;
  ...
  'Use [GeneratedMessageGenericExtensions.rebuild] instead. '
  'Will be removed in next major version')
  BusinessNameFilter copyWith(void Function(BusinessNameFilter) updates) => super.copyWith((message) => updates(message as BusinessNameFilter)) as BusinessNameFilter; // ignore: deprecated_member_use
  $pb.BuilderInfo get info_ => _i;
  @$core.pragma('dart2js:noInline')
  ...
  @$pb.TagNumber(2)
  $0.FeedItemSetStringFilterTypeEnum_FeedItemSetStringFilterType get filterType => $_getN(1);
  @$pb.TagNumber(2)
  set filterType($0.FeedItemSetStringFilterTypeEnum_FeedItemSetStringFilterType v) { setField(2, v); }
  @$pb.TagNumber(2)
...
class DynamicAffiliateLocationSetFilter extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'DynamicAffiliateLocationSetFilter', package: const $pb.PackageName(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'google.ads.googleads.v10.common'), createEmptyInstance: create)
    ..p<$fixnum.Int64>(1, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'chainIds', $pb.PbFieldType.P6)
    ..hasRequiredFields = false
  ;
  ...
  'Use [GeneratedMessageGenericExtensions.rebuild] instead. '
  'Will be removed in next major version')
  DynamicAffiliateLocationSetFilter copyWith(void Function(DynamicAffiliateLocationSetFilter) updates) => super.copyWith((message) => updates(message as DynamicAffiliateLocationSetFilter)) as DynamicAffiliateLocationSetFilter; // ignore: deprecated_member_use
  $pb.BuilderInfo get info_ => _i;
  @$core.pragma('dart2js:noInline')

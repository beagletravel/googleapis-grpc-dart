...
class CustomizerValue extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'CustomizerValue', package: const $pb.PackageName(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'google.ads.googleads.v10.common'), createEmptyInstance: create)
  ...
  'Will be removed in next major version')
  CustomizerValue copyWith(void Function(CustomizerValue) updates) => super.copyWith((message) => updates(message as CustomizerValue)) as CustomizerValue; // ignore: deprecated_member_use
  ...
  @$pb.TagNumber(1)
  set type($0.CustomizerAttributeTypeEnum_CustomizerAttributeType v) { setField(1, v); }
  @$pb.TagNumber(1)

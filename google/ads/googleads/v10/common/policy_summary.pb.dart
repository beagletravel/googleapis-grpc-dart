...
class PolicySummary extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'PolicySummary', package: const $pb.PackageName(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'google.ads.googleads.v10.common'), createEmptyInstance: create)
  ...
  'Will be removed in next major version')
  PolicySummary copyWith(void Function(PolicySummary) updates) => super.copyWith((message) => updates(message as PolicySummary)) as PolicySummary; // ignore: deprecated_member_use

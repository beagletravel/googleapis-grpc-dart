...
import '../enums/policy_topic_evidence_destination_mismatch_url_type.pbenum.dart' as $1;
import '../enums/policy_topic_evidence_destination_not_working_dns_error_type.pbenum.dart' as $2;
import '../enums/policy_topic_evidence_destination_not_working_device.pbenum.dart' as $3;

class PolicyViolationKey extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'PolicyViolationKey', package: const $pb.PackageName(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'google.ads.googleads.v10.common'), createEmptyInstance: create)
    ..aOS(3, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'policyName')
    ..aOS(4, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'violatingText')
  ...
  'Will be removed in next major version')
  PolicyViolationKey copyWith(void Function(PolicyViolationKey) updates) => super.copyWith((message) => updates(message as PolicyViolationKey)) as PolicyViolationKey; // ignore: deprecated_member_use
...
class PolicyValidationParameter extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'PolicyValidationParameter', package: const $pb.PackageName(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'google.ads.googleads.v10.common'), createEmptyInstance: create)
    ..pc<PolicyViolationKey>(2, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'exemptPolicyViolationKeys', $pb.PbFieldType.PM, subBuilder: PolicyViolationKey.create)
    ..pPS(3, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'ignorablePolicyTopics')
    ..hasRequiredFields = false
  ;
  ...
  'Use [GeneratedMessageGenericExtensions.rebuild] instead. '
  'Will be removed in next major version')
  PolicyValidationParameter copyWith(void Function(PolicyValidationParameter) updates) => super.copyWith((message) => updates(message as PolicyValidationParameter)) as PolicyValidationParameter; // ignore: deprecated_member_use
  $pb.BuilderInfo get info_ => _i;
  @$core.pragma('dart2js:noInline')
...
class PolicyTopicEntry extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'PolicyTopicEntry', package: const $pb.PackageName(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'google.ads.googleads.v10.common'), createEmptyInstance: create)
    ..e<$0.PolicyTopicEntryTypeEnum_PolicyTopicEntryType>(2, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'type', $pb.PbFieldType.OE, defaultOrMaker: $0.PolicyTopicEntryTypeEnum_PolicyTopicEntryType.UNSPECIFIED, valueOf: $0.PolicyTopicEntryTypeEnum_PolicyTopicEntryType.valueOf, enumValues: $0.PolicyTopicEntryTypeEnum_PolicyTopicEntryType.values)
    ..pc<PolicyTopicEvidence>(3, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'evidences', $pb.PbFieldType.PM, subBuilder: PolicyTopicEvidence.create)
    ..pc<PolicyTopicConstraint>(4, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'constraints', $pb.PbFieldType.PM, subBuilder: PolicyTopicConstraint.create)
  ...
  'Use [GeneratedMessageGenericExtensions.rebuild] instead. '
  'Will be removed in next major version')
  PolicyTopicEntry copyWith(void Function(PolicyTopicEntry) updates) => super.copyWith((message) => updates(message as PolicyTopicEntry)) as PolicyTopicEntry; // ignore: deprecated_member_use
  $pb.BuilderInfo get info_ => _i;
  @$core.pragma('dart2js:noInline')
  ...
  @$pb.TagNumber(2)
  set type($0.PolicyTopicEntryTypeEnum_PolicyTopicEntryType v) { setField(2, v); }
  @$pb.TagNumber(2)
...
class PolicyTopicEvidence_TextList extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'PolicyTopicEvidence.TextList', package: const $pb.PackageName(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'google.ads.googleads.v10.common'), createEmptyInstance: create)
    ..pPS(2, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'texts')
    ..hasRequiredFields = false
  ;
  ...
  'Use [GeneratedMessageGenericExtensions.rebuild] instead. '
  'Will be removed in next major version')
  PolicyTopicEvidence_TextList copyWith(void Function(PolicyTopicEvidence_TextList) updates) => super.copyWith((message) => updates(message as PolicyTopicEvidence_TextList)) as PolicyTopicEvidence_TextList; // ignore: deprecated_member_use
  $pb.BuilderInfo get info_ => _i;
  @$core.pragma('dart2js:noInline')
...
class PolicyTopicEvidence_WebsiteList extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'PolicyTopicEvidence.WebsiteList', package: const $pb.PackageName(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'google.ads.googleads.v10.common'), createEmptyInstance: create)
    ..pPS(2, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'websites')
    ..hasRequiredFields = false
  ;
  ...
  'Use [GeneratedMessageGenericExtensions.rebuild] instead. '
  'Will be removed in next major version')
  PolicyTopicEvidence_WebsiteList copyWith(void Function(PolicyTopicEvidence_WebsiteList) updates) => super.copyWith((message) => updates(message as PolicyTopicEvidence_WebsiteList)) as PolicyTopicEvidence_WebsiteList; // ignore: deprecated_member_use
  $pb.BuilderInfo get info_ => _i;
  @$core.pragma('dart2js:noInline')
...
class PolicyTopicEvidence_DestinationTextList extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'PolicyTopicEvidence.DestinationTextList', package: const $pb.PackageName(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'google.ads.googleads.v10.common'), createEmptyInstance: create)
    ..pPS(2, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'destinationTexts')
    ..hasRequiredFields = false
  ;
  ...
  'Use [GeneratedMessageGenericExtensions.rebuild] instead. '
  'Will be removed in next major version')
  PolicyTopicEvidence_DestinationTextList copyWith(void Function(PolicyTopicEvidence_DestinationTextList) updates) => super.copyWith((message) => updates(message as PolicyTopicEvidence_DestinationTextList)) as PolicyTopicEvidence_DestinationTextList; // ignore: deprecated_member_use
  $pb.BuilderInfo get info_ => _i;
  @$core.pragma('dart2js:noInline')
...
class PolicyTopicEvidence_DestinationMismatch extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'PolicyTopicEvidence.DestinationMismatch', package: const $pb.PackageName(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'google.ads.googleads.v10.common'), createEmptyInstance: create)
    ..pc<$1.PolicyTopicEvidenceDestinationMismatchUrlTypeEnum_PolicyTopicEvidenceDestinationMismatchUrlType>(1, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'urlTypes', $pb.PbFieldType.PE, valueOf: $1.PolicyTopicEvidenceDestinationMismatchUrlTypeEnum_PolicyTopicEvidenceDestinationMismatchUrlType.valueOf, enumValues: $1.PolicyTopicEvidenceDestinationMismatchUrlTypeEnum_PolicyTopicEvidenceDestinationMismatchUrlType.values)
    ..hasRequiredFields = false
  ;

  PolicyTopicEvidence_DestinationMismatch._() : super();
  factory PolicyTopicEvidence_DestinationMismatch({
    $core.Iterable<$1.PolicyTopicEvidenceDestinationMismatchUrlTypeEnum_PolicyTopicEvidenceDestinationMismatchUrlType>? urlTypes,
  }) {
    final _result = create();
    if (urlTypes != null) {
  ...
  'Use [GeneratedMessageGenericExtensions.rebuild] instead. '
  'Will be removed in next major version')
  PolicyTopicEvidence_DestinationMismatch copyWith(void Function(PolicyTopicEvidence_DestinationMismatch) updates) => super.copyWith((message) => updates(message as PolicyTopicEvidence_DestinationMismatch)) as PolicyTopicEvidence_DestinationMismatch; // ignore: deprecated_member_use
  $pb.BuilderInfo get info_ => _i;
  @$core.pragma('dart2js:noInline')
  ...
  @$pb.TagNumber(1)
  $core.List<$1.PolicyTopicEvidenceDestinationMismatchUrlTypeEnum_PolicyTopicEvidenceDestinationMismatchUrlType> get urlTypes => $_getList(0);
}
...
class PolicyTopicEvidence_DestinationNotWorking extends $pb.GeneratedMessage {
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'PolicyTopicEvidence.DestinationNotWorking', package: const $pb.PackageName(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'google.ads.googleads.v10.common'), createEmptyInstance: create)
    ..oo(0, [1, 6])
    ..e<$2.PolicyTopicEvidenceDestinationNotWorkingDnsErrorTypeEnum_PolicyTopicEvidenceDestinationNotWorkingDnsErrorType>(1, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'dnsErrorType', $pb.PbFieldType.OE, defaultOrMaker: $2.PolicyTopicEvidenceDestinationNotWorkingDnsErrorTypeEnum_PolicyTopicEvidenceDestinationNotWorkingDnsErrorType.UNSPECIFIED, valueOf: $2.PolicyTopicEvidenceDestinationNotWorkingDnsErrorTypeEnum_PolicyTopicEvidenceDestinationNotWorkingDnsErrorType.valueOf, enumValues: $2.PolicyTopicEvidenceDestinationNotWorkingDnsErrorTypeEnum_PolicyTopicEvidenceDestinationNotWorkingDnsErrorType.values)
    ..e<$3.PolicyTopicEvidenceDestinationNotWorkingDeviceEnum_PolicyTopicEvidenceDestinationNotWorkingDevice>(4, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'device', $pb.PbFieldType.OE, defaultOrMaker: $3.PolicyTopicEvidenceDestinationNotWorkingDeviceEnum_PolicyTopicEvidenceDestinationNotWorkingDevice.UNSPECIFIED, valueOf: $3.PolicyTopicEvidenceDestinationNotWorkingDeviceEnum_PolicyTopicEvidenceDestinationNotWorkingDevice.valueOf, enumValues: $3.PolicyTopicEvidenceDestinationNotWorkingDeviceEnum_PolicyTopicEvidenceDestinationNotWorkingDevice.values)
    ..aInt64(6, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'httpErrorCode')
    ..aOS(7, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'expandedUrl')
    ..aOS(8, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'lastCheckedDateTime')
    ..hasRequiredFields = false
  ;

  PolicyTopicEvidence_DestinationNotWorking._() : super();
  factory PolicyTopicEvidence_DestinationNotWorking({
    $2.PolicyTopicEvidenceDestinationNotWorkingDnsErrorTypeEnum_PolicyTopicEvidenceDestinationNotWorkingDnsErrorType? dnsErrorType,
    $3.PolicyTopicEvidenceDestinationNotWorkingDeviceEnum_PolicyTopicEvidenceDestinationNotWorkingDevice? device,
  ...
  'Use [GeneratedMessageGenericExtensions.rebuild] instead. '
  'Will be removed in next major version')
  PolicyTopicEvidence_DestinationNotWorking copyWith(void Function(PolicyTopicEvidence_DestinationNotWorking) updates) => super.copyWith((message) => updates(message as PolicyTopicEvidence_DestinationNotWorking)) as PolicyTopicEvidence_DestinationNotWorking; // ignore: deprecated_member_use
  $pb.BuilderInfo get info_ => _i;
  @$core.pragma('dart2js:noInline')
  ...
  @$pb.TagNumber(1)
  $2.PolicyTopicEvidenceDestinationNotWorkingDnsErrorTypeEnum_PolicyTopicEvidenceDestinationNotWorkingDnsErrorType get dnsErrorType => $_getN(0);
  @$pb.TagNumber(1)
  set dnsErrorType($2.PolicyTopicEvidenceDestinationNotWorkingDnsErrorTypeEnum_PolicyTopicEvidenceDestinationNotWorkingDnsErrorType v) { setField(1, v); }
  @$pb.TagNumber(1)
  ...
  @$pb.TagNumber(4)
  $3.PolicyTopicEvidenceDestinationNotWorkingDeviceEnum_PolicyTopicEvidenceDestinationNotWorkingDevice get device => $_getN(1);
  @$pb.TagNumber(4)
  set device($3.PolicyTopicEvidenceDestinationNotWorkingDeviceEnum_PolicyTopicEvidenceDestinationNotWorkingDevice v) { setField(4, v); }
  @$pb.TagNumber(4)
...
class PolicyTopicEvidence extends $pb.GeneratedMessage {
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'PolicyTopicEvidence', package: const $pb.PackageName(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'google.ads.googleads.v10.common'), createEmptyInstance: create)
    ..oo(0, [3, 4, 6, 7, 8, 9])
    ..aOM<PolicyTopicEvidence_WebsiteList>(3, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'websiteList', subBuilder: PolicyTopicEvidence_WebsiteList.create)
    ..aOM<PolicyTopicEvidence_TextList>(4, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'textList', subBuilder: PolicyTopicEvidence_TextList.create)
    ..aOM<PolicyTopicEvidence_DestinationTextList>(6, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'destinationTextList', subBuilder: PolicyTopicEvidence_DestinationTextList.create)
    ..aOM<PolicyTopicEvidence_DestinationMismatch>(7, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'destinationMismatch', subBuilder: PolicyTopicEvidence_DestinationMismatch.create)
    ..aOM<PolicyTopicEvidence_DestinationNotWorking>(8, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'destinationNotWorking', subBuilder: PolicyTopicEvidence_DestinationNotWorking.create)
  ...
  'Use [GeneratedMessageGenericExtensions.rebuild] instead. '
  'Will be removed in next major version')
  PolicyTopicEvidence copyWith(void Function(PolicyTopicEvidence) updates) => super.copyWith((message) => updates(message as PolicyTopicEvidence)) as PolicyTopicEvidence; // ignore: deprecated_member_use
  $pb.BuilderInfo get info_ => _i;
  @$core.pragma('dart2js:noInline')
...
class PolicyTopicConstraint_CountryConstraintList extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'PolicyTopicConstraint.CountryConstraintList', package: const $pb.PackageName(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'google.ads.googleads.v10.common'), createEmptyInstance: create)
    ..pc<PolicyTopicConstraint_CountryConstraint>(2, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'countries', $pb.PbFieldType.PM, subBuilder: PolicyTopicConstraint_CountryConstraint.create)
    ..a<$core.int>(3, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'totalTargetedCountries', $pb.PbFieldType.O3)
    ..hasRequiredFields = false
  ;
  ...
  'Use [GeneratedMessageGenericExtensions.rebuild] instead. '
  'Will be removed in next major version')
  PolicyTopicConstraint_CountryConstraintList copyWith(void Function(PolicyTopicConstraint_CountryConstraintList) updates) => super.copyWith((message) => updates(message as PolicyTopicConstraint_CountryConstraintList)) as PolicyTopicConstraint_CountryConstraintList; // ignore: deprecated_member_use
  $pb.BuilderInfo get info_ => _i;
  @$core.pragma('dart2js:noInline')
...
class PolicyTopicConstraint_ResellerConstraint extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'PolicyTopicConstraint.ResellerConstraint', package: const $pb.PackageName(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'google.ads.googleads.v10.common'), createEmptyInstance: create)
    ..hasRequiredFields = false
  ;
  ...
  'Use [GeneratedMessageGenericExtensions.rebuild] instead. '
  'Will be removed in next major version')
  PolicyTopicConstraint_ResellerConstraint copyWith(void Function(PolicyTopicConstraint_ResellerConstraint) updates) => super.copyWith((message) => updates(message as PolicyTopicConstraint_ResellerConstraint)) as PolicyTopicConstraint_ResellerConstraint; // ignore: deprecated_member_use
  $pb.BuilderInfo get info_ => _i;
  @$core.pragma('dart2js:noInline')
...
class PolicyTopicConstraint_CountryConstraint extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'PolicyTopicConstraint.CountryConstraint', package: const $pb.PackageName(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'google.ads.googleads.v10.common'), createEmptyInstance: create)
    ..aOS(2, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'countryCriterion')
    ..hasRequiredFields = false
  ;
  ...
  'Use [GeneratedMessageGenericExtensions.rebuild] instead. '
  'Will be removed in next major version')
  PolicyTopicConstraint_CountryConstraint copyWith(void Function(PolicyTopicConstraint_CountryConstraint) updates) => super.copyWith((message) => updates(message as PolicyTopicConstraint_CountryConstraint)) as PolicyTopicConstraint_CountryConstraint; // ignore: deprecated_member_use
  $pb.BuilderInfo get info_ => _i;
  @$core.pragma('dart2js:noInline')
...
class PolicyTopicConstraint extends $pb.GeneratedMessage {
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'PolicyTopicConstraint', package: const $pb.PackageName(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'google.ads.googleads.v10.common'), createEmptyInstance: create)
    ..oo(0, [1, 2, 3, 4])
    ..aOM<PolicyTopicConstraint_CountryConstraintList>(1, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'countryConstraintList', subBuilder: PolicyTopicConstraint_CountryConstraintList.create)
    ..aOM<PolicyTopicConstraint_ResellerConstraint>(2, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'resellerConstraint', subBuilder: PolicyTopicConstraint_ResellerConstraint.create)
    ..aOM<PolicyTopicConstraint_CountryConstraintList>(3, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'certificateMissingInCountryList', subBuilder: PolicyTopicConstraint_CountryConstraintList.create)
    ..aOM<PolicyTopicConstraint_CountryConstraintList>(4, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'certificateDomainMismatchInCountryList', subBuilder: PolicyTopicConstraint_CountryConstraintList.create)
    ..hasRequiredFields = false
  ;
  ...
  factory PolicyTopicConstraint({
    ...
    if (certificateDomainMismatchInCountryList != null) {
      _result.certificateDomainMismatchInCountryList = certificateDomainMismatchInCountryList;
    }
    return _result;
  }
  ...
  'Use [GeneratedMessageGenericExtensions.rebuild] instead. '
  'Will be removed in next major version')
  PolicyTopicConstraint copyWith(void Function(PolicyTopicConstraint) updates) => super.copyWith((message) => updates(message as PolicyTopicConstraint)) as PolicyTopicConstraint; // ignore: deprecated_member_use
  $pb.BuilderInfo get info_ => _i;
  @$core.pragma('dart2js:noInline')

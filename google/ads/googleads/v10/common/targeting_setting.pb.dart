...
class TargetingSetting extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'TargetingSetting', package: const $pb.PackageName(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'google.ads.googleads.v10.common'), createEmptyInstance: create)
    ..pc<TargetRestriction>(1, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'targetRestrictions', $pb.PbFieldType.PM, subBuilder: TargetRestriction.create)
    ..pc<TargetRestrictionOperation>(2, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'targetRestrictionOperations', $pb.PbFieldType.PM, subBuilder: TargetRestrictionOperation.create)
  ...
  'Will be removed in next major version')
  TargetingSetting copyWith(void Function(TargetingSetting) updates) => super.copyWith((message) => updates(message as TargetingSetting)) as TargetingSetting; // ignore: deprecated_member_use
...
class TargetRestriction extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'TargetRestriction', package: const $pb.PackageName(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'google.ads.googleads.v10.common'), createEmptyInstance: create)
    ..e<$0.TargetingDimensionEnum_TargetingDimension>(1, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'targetingDimension', $pb.PbFieldType.OE, defaultOrMaker: $0.TargetingDimensionEnum_TargetingDimension.UNSPECIFIED, valueOf: $0.TargetingDimensionEnum_TargetingDimension.valueOf, enumValues: $0.TargetingDimensionEnum_TargetingDimension.values)
    ..aOB(3, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'bidOnly')
    ..hasRequiredFields = false
  ;
  ...
  'Use [GeneratedMessageGenericExtensions.rebuild] instead. '
  'Will be removed in next major version')
  TargetRestriction copyWith(void Function(TargetRestriction) updates) => super.copyWith((message) => updates(message as TargetRestriction)) as TargetRestriction; // ignore: deprecated_member_use
  $pb.BuilderInfo get info_ => _i;
  @$core.pragma('dart2js:noInline')
  ...
  @$pb.TagNumber(1)
  $0.TargetingDimensionEnum_TargetingDimension get targetingDimension => $_getN(0);
  @$pb.TagNumber(1)
  set targetingDimension($0.TargetingDimensionEnum_TargetingDimension v) { setField(1, v); }
  @$pb.TagNumber(1)
...
class TargetRestrictionOperation extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'TargetRestrictionOperation', package: const $pb.PackageName(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'google.ads.googleads.v10.common'), createEmptyInstance: create)
    ..e<TargetRestrictionOperation_Operator>(1, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'operator', $pb.PbFieldType.OE, defaultOrMaker: TargetRestrictionOperation_Operator.UNSPECIFIED, valueOf: TargetRestrictionOperation_Operator.valueOf, enumValues: TargetRestrictionOperation_Operator.values)
    ..aOM<TargetRestriction>(2, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'value', subBuilder: TargetRestriction.create)
    ..hasRequiredFields = false
  ;
  ...
  'Use [GeneratedMessageGenericExtensions.rebuild] instead. '
  'Will be removed in next major version')
  TargetRestrictionOperation copyWith(void Function(TargetRestrictionOperation) updates) => super.copyWith((message) => updates(message as TargetRestrictionOperation)) as TargetRestrictionOperation; // ignore: deprecated_member_use
  $pb.BuilderInfo get info_ => _i;
  @$core.pragma('dart2js:noInline')

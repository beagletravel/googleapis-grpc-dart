...
class AdAssetPolicySummary extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'AdAssetPolicySummary', package: const $pb.PackageName(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'google.ads.googleads.v10.common'), createEmptyInstance: create)
    ...
    ..e<$1.PolicyReviewStatusEnum_PolicyReviewStatus>(2, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'reviewStatus', $pb.PbFieldType.OE, defaultOrMaker: $1.PolicyReviewStatusEnum_PolicyReviewStatus.UNSPECIFIED, valueOf: $1.PolicyReviewStatusEnum_PolicyReviewStatus.valueOf, enumValues: $1.PolicyReviewStatusEnum_PolicyReviewStatus.values)
    ..e<$2.PolicyApprovalStatusEnum_PolicyApprovalStatus>(3, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'approvalStatus', $pb.PbFieldType.OE, defaultOrMaker: $2.PolicyApprovalStatusEnum_PolicyApprovalStatus.UNSPECIFIED, valueOf: $2.PolicyApprovalStatusEnum_PolicyApprovalStatus.valueOf, enumValues: $2.PolicyApprovalStatusEnum_PolicyApprovalStatus.values)
  ...
  'Will be removed in next major version')
  AdAssetPolicySummary copyWith(void Function(AdAssetPolicySummary) updates) => super.copyWith((message) => updates(message as AdAssetPolicySummary)) as AdAssetPolicySummary; // ignore: deprecated_member_use
  ...
  @$pb.TagNumber(2)
  set reviewStatus($1.PolicyReviewStatusEnum_PolicyReviewStatus v) { setField(2, v); }
  @$pb.TagNumber(2)
  ...
  @$pb.TagNumber(3)
  $2.PolicyApprovalStatusEnum_PolicyApprovalStatus get approvalStatus => $_getN(2);
  @$pb.TagNumber(3)
  set approvalStatus($2.PolicyApprovalStatusEnum_PolicyApprovalStatus v) { setField(3, v); }
  @$pb.TagNumber(3)

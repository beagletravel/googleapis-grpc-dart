...
class TagSnippet extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'TagSnippet', package: const $pb.PackageName(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'google.ads.googleads.v10.common'), createEmptyInstance: create)
    ..e<$0.TrackingCodeTypeEnum_TrackingCodeType>(1, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'type', $pb.PbFieldType.OE, defaultOrMaker: $0.TrackingCodeTypeEnum_TrackingCodeType.UNSPECIFIED, valueOf: $0.TrackingCodeTypeEnum_TrackingCodeType.valueOf, enumValues: $0.TrackingCodeTypeEnum_TrackingCodeType.values)
    ..e<$1.TrackingCodePageFormatEnum_TrackingCodePageFormat>(2, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'pageFormat', $pb.PbFieldType.OE, defaultOrMaker: $1.TrackingCodePageFormatEnum_TrackingCodePageFormat.UNSPECIFIED, valueOf: $1.TrackingCodePageFormatEnum_TrackingCodePageFormat.valueOf, enumValues: $1.TrackingCodePageFormatEnum_TrackingCodePageFormat.values)
    ..aOS(5, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'globalSiteTag')
    ..aOS(6, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'eventSnippet')
  ...
  'Will be removed in next major version')
  TagSnippet copyWith(void Function(TagSnippet) updates) => super.copyWith((message) => updates(message as TagSnippet)) as TagSnippet; // ignore: deprecated_member_use
  ...
  @$pb.TagNumber(1)
  set type($0.TrackingCodeTypeEnum_TrackingCodeType v) { setField(1, v); }
  @$pb.TagNumber(1)
  ...
  @$pb.TagNumber(2)
  $1.TrackingCodePageFormatEnum_TrackingCodePageFormat get pageFormat => $_getN(1);
  @$pb.TagNumber(2)
  set pageFormat($1.TrackingCodePageFormatEnum_TrackingCodePageFormat v) { setField(2, v); }
  @$pb.TagNumber(2)

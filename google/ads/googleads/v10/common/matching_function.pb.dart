...
class MatchingFunction extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'MatchingFunction', package: const $pb.PackageName(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'google.ads.googleads.v10.common'), createEmptyInstance: create)
    ..pc<Operand>(2, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'leftOperands', $pb.PbFieldType.PM, subBuilder: Operand.create)
    ..pc<Operand>(3, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'rightOperands', $pb.PbFieldType.PM, subBuilder: Operand.create)
    ..e<$0.MatchingFunctionOperatorEnum_MatchingFunctionOperator>(4, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'operator', $pb.PbFieldType.OE, defaultOrMaker: $0.MatchingFunctionOperatorEnum_MatchingFunctionOperator.UNSPECIFIED, valueOf: $0.MatchingFunctionOperatorEnum_MatchingFunctionOperator.valueOf, enumValues: $0.MatchingFunctionOperatorEnum_MatchingFunctionOperator.values)
    ..aOS(5, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'functionString')
  ...
  'Will be removed in next major version')
  MatchingFunction copyWith(void Function(MatchingFunction) updates) => super.copyWith((message) => updates(message as MatchingFunction)) as MatchingFunction; // ignore: deprecated_member_use
  ...
  @$pb.TagNumber(4)
  $0.MatchingFunctionOperatorEnum_MatchingFunctionOperator get operator => $_getN(2);
  @$pb.TagNumber(4)
  set operator($0.MatchingFunctionOperatorEnum_MatchingFunctionOperator v) { setField(4, v); }
  @$pb.TagNumber(4)
...
class Operand_ConstantOperand extends $pb.GeneratedMessage {
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'Operand.ConstantOperand', package: const $pb.PackageName(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'google.ads.googleads.v10.common'), createEmptyInstance: create)
    ..oo(0, [5, 6, 7, 8])
    ..aOS(5, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'stringValue')
    ..aInt64(6, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'longValue')
    ..aOB(7, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'booleanValue')
  ...
  'Use [GeneratedMessageGenericExtensions.rebuild] instead. '
  'Will be removed in next major version')
  Operand_ConstantOperand copyWith(void Function(Operand_ConstantOperand) updates) => super.copyWith((message) => updates(message as Operand_ConstantOperand)) as Operand_ConstantOperand; // ignore: deprecated_member_use
  $pb.BuilderInfo get info_ => _i;
  @$core.pragma('dart2js:noInline')
...
class Operand_FeedAttributeOperand extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'Operand.FeedAttributeOperand', package: const $pb.PackageName(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'google.ads.googleads.v10.common'), createEmptyInstance: create)
    ..aInt64(3, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'feedId')
    ..aInt64(4, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'feedAttributeId')
    ..hasRequiredFields = false
  ;
  ...
  'Use [GeneratedMessageGenericExtensions.rebuild] instead. '
  'Will be removed in next major version')
  Operand_FeedAttributeOperand copyWith(void Function(Operand_FeedAttributeOperand) updates) => super.copyWith((message) => updates(message as Operand_FeedAttributeOperand)) as Operand_FeedAttributeOperand; // ignore: deprecated_member_use
  $pb.BuilderInfo get info_ => _i;
  @$core.pragma('dart2js:noInline')
...
class Operand_FunctionOperand extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'Operand.FunctionOperand', package: const $pb.PackageName(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'google.ads.googleads.v10.common'), createEmptyInstance: create)
    ..aOM<MatchingFunction>(1, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'matchingFunction', subBuilder: MatchingFunction.create)
    ..hasRequiredFields = false
  ;
  ...
  'Use [GeneratedMessageGenericExtensions.rebuild] instead. '
  'Will be removed in next major version')
  Operand_FunctionOperand copyWith(void Function(Operand_FunctionOperand) updates) => super.copyWith((message) => updates(message as Operand_FunctionOperand)) as Operand_FunctionOperand; // ignore: deprecated_member_use
  $pb.BuilderInfo get info_ => _i;
  @$core.pragma('dart2js:noInline')
...
class Operand_RequestContextOperand extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'Operand.RequestContextOperand', package: const $pb.PackageName(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'google.ads.googleads.v10.common'), createEmptyInstance: create)
    ..e<$1.MatchingFunctionContextTypeEnum_MatchingFunctionContextType>(1, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'contextType', $pb.PbFieldType.OE, defaultOrMaker: $1.MatchingFunctionContextTypeEnum_MatchingFunctionContextType.UNSPECIFIED, valueOf: $1.MatchingFunctionContextTypeEnum_MatchingFunctionContextType.valueOf, enumValues: $1.MatchingFunctionContextTypeEnum_MatchingFunctionContextType.values)
    ..hasRequiredFields = false
  ;
  ...
  'Use [GeneratedMessageGenericExtensions.rebuild] instead. '
  'Will be removed in next major version')
  Operand_RequestContextOperand copyWith(void Function(Operand_RequestContextOperand) updates) => super.copyWith((message) => updates(message as Operand_RequestContextOperand)) as Operand_RequestContextOperand; // ignore: deprecated_member_use
  $pb.BuilderInfo get info_ => _i;
  @$core.pragma('dart2js:noInline')
  ...
  @$pb.TagNumber(1)
  $1.MatchingFunctionContextTypeEnum_MatchingFunctionContextType get contextType => $_getN(0);
  @$pb.TagNumber(1)
  set contextType($1.MatchingFunctionContextTypeEnum_MatchingFunctionContextType v) { setField(1, v); }
  @$pb.TagNumber(1)
...
class Operand extends $pb.GeneratedMessage {
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'Operand', package: const $pb.PackageName(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'google.ads.googleads.v10.common'), createEmptyInstance: create)
    ..oo(0, [1, 2, 3, 4])
    ..aOM<Operand_ConstantOperand>(1, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'constantOperand', subBuilder: Operand_ConstantOperand.create)
    ..aOM<Operand_FeedAttributeOperand>(2, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'feedAttributeOperand', subBuilder: Operand_FeedAttributeOperand.create)
    ..aOM<Operand_FunctionOperand>(3, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'functionOperand', subBuilder: Operand_FunctionOperand.create)
    ..aOM<Operand_RequestContextOperand>(4, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'requestContextOperand', subBuilder: Operand_RequestContextOperand.create)
    ..hasRequiredFields = false
  ;
  ...
  'Use [GeneratedMessageGenericExtensions.rebuild] instead. '
  'Will be removed in next major version')
  Operand copyWith(void Function(Operand) updates) => super.copyWith((message) => updates(message as Operand)) as Operand; // ignore: deprecated_member_use
  $pb.BuilderInfo get info_ => _i;
  @$core.pragma('dart2js:noInline')

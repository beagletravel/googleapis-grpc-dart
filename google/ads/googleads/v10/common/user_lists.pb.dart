...
class SimilarUserListInfo extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'SimilarUserListInfo', package: const $pb.PackageName(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'google.ads.googleads.v10.common'), createEmptyInstance: create)
    ..aOS(2, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'seedUserList')
  ...
  'Will be removed in next major version')
  SimilarUserListInfo copyWith(void Function(SimilarUserListInfo) updates) => super.copyWith((message) => updates(message as SimilarUserListInfo)) as SimilarUserListInfo; // ignore: deprecated_member_use
...
class CrmBasedUserListInfo extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'CrmBasedUserListInfo', package: const $pb.PackageName(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'google.ads.googleads.v10.common'), createEmptyInstance: create)
    ..e<$0.CustomerMatchUploadKeyTypeEnum_CustomerMatchUploadKeyType>(2, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'uploadKeyType', $pb.PbFieldType.OE, defaultOrMaker: $0.CustomerMatchUploadKeyTypeEnum_CustomerMatchUploadKeyType.UNSPECIFIED, valueOf: $0.CustomerMatchUploadKeyTypeEnum_CustomerMatchUploadKeyType.valueOf, enumValues: $0.CustomerMatchUploadKeyTypeEnum_CustomerMatchUploadKeyType.values)
    ..e<$1.UserListCrmDataSourceTypeEnum_UserListCrmDataSourceType>(3, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'dataSourceType', $pb.PbFieldType.OE, defaultOrMaker: $1.UserListCrmDataSourceTypeEnum_UserListCrmDataSourceType.UNSPECIFIED, valueOf: $1.UserListCrmDataSourceTypeEnum_UserListCrmDataSourceType.valueOf, enumValues: $1.UserListCrmDataSourceTypeEnum_UserListCrmDataSourceType.values)
  ...
  'Use [GeneratedMessageGenericExtensions.rebuild] instead. '
  'Will be removed in next major version')
  CrmBasedUserListInfo copyWith(void Function(CrmBasedUserListInfo) updates) => super.copyWith((message) => updates(message as CrmBasedUserListInfo)) as CrmBasedUserListInfo; // ignore: deprecated_member_use
  $pb.BuilderInfo get info_ => _i;
  @$core.pragma('dart2js:noInline')
  ...
  @$pb.TagNumber(2)
  $0.CustomerMatchUploadKeyTypeEnum_CustomerMatchUploadKeyType get uploadKeyType => $_getN(0);
  @$pb.TagNumber(2)
  set uploadKeyType($0.CustomerMatchUploadKeyTypeEnum_CustomerMatchUploadKeyType v) { setField(2, v); }
  @$pb.TagNumber(2)
  ...
  @$pb.TagNumber(3)
  $1.UserListCrmDataSourceTypeEnum_UserListCrmDataSourceType get dataSourceType => $_getN(1);
  @$pb.TagNumber(3)
  set dataSourceType($1.UserListCrmDataSourceTypeEnum_UserListCrmDataSourceType v) { setField(3, v); }
  @$pb.TagNumber(3)
...
class UserListRuleInfo extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'UserListRuleInfo', package: const $pb.PackageName(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'google.ads.googleads.v10.common'), createEmptyInstance: create)
    ..e<$2.UserListRuleTypeEnum_UserListRuleType>(1, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'ruleType', $pb.PbFieldType.OE, defaultOrMaker: $2.UserListRuleTypeEnum_UserListRuleType.UNSPECIFIED, valueOf: $2.UserListRuleTypeEnum_UserListRuleType.valueOf, enumValues: $2.UserListRuleTypeEnum_UserListRuleType.values)
    ..pc<UserListRuleItemGroupInfo>(2, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'ruleItemGroups', $pb.PbFieldType.PM, subBuilder: UserListRuleItemGroupInfo.create)
    ..hasRequiredFields = false
  ;
  ...
  'Use [GeneratedMessageGenericExtensions.rebuild] instead. '
  'Will be removed in next major version')
  UserListRuleInfo copyWith(void Function(UserListRuleInfo) updates) => super.copyWith((message) => updates(message as UserListRuleInfo)) as UserListRuleInfo; // ignore: deprecated_member_use
  $pb.BuilderInfo get info_ => _i;
  @$core.pragma('dart2js:noInline')
  ...
  @$pb.TagNumber(1)
  set ruleType($2.UserListRuleTypeEnum_UserListRuleType v) { setField(1, v); }
  @$pb.TagNumber(1)
...
class UserListRuleItemGroupInfo extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'UserListRuleItemGroupInfo', package: const $pb.PackageName(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'google.ads.googleads.v10.common'), createEmptyInstance: create)
    ..pc<UserListRuleItemInfo>(1, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'ruleItems', $pb.PbFieldType.PM, subBuilder: UserListRuleItemInfo.create)
    ..hasRequiredFields = false
  ;
  ...
  'Use [GeneratedMessageGenericExtensions.rebuild] instead. '
  'Will be removed in next major version')
  UserListRuleItemGroupInfo copyWith(void Function(UserListRuleItemGroupInfo) updates) => super.copyWith((message) => updates(message as UserListRuleItemGroupInfo)) as UserListRuleItemGroupInfo; // ignore: deprecated_member_use
  $pb.BuilderInfo get info_ => _i;
  @$core.pragma('dart2js:noInline')
...
class UserListRuleItemInfo extends $pb.GeneratedMessage {
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'UserListRuleItemInfo', package: const $pb.PackageName(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'google.ads.googleads.v10.common'), createEmptyInstance: create)
    ..oo(0, [2, 3, 4])
    ..aOM<UserListNumberRuleItemInfo>(2, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'numberRuleItem', subBuilder: UserListNumberRuleItemInfo.create)
    ..aOM<UserListStringRuleItemInfo>(3, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'stringRuleItem', subBuilder: UserListStringRuleItemInfo.create)
    ..aOM<UserListDateRuleItemInfo>(4, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'dateRuleItem', subBuilder: UserListDateRuleItemInfo.create)
  ...
  'Use [GeneratedMessageGenericExtensions.rebuild] instead. '
  'Will be removed in next major version')
  UserListRuleItemInfo copyWith(void Function(UserListRuleItemInfo) updates) => super.copyWith((message) => updates(message as UserListRuleItemInfo)) as UserListRuleItemInfo; // ignore: deprecated_member_use
  $pb.BuilderInfo get info_ => _i;
  @$core.pragma('dart2js:noInline')
...
class UserListDateRuleItemInfo extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'UserListDateRuleItemInfo', package: const $pb.PackageName(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'google.ads.googleads.v10.common'), createEmptyInstance: create)
    ..e<$3.UserListDateRuleItemOperatorEnum_UserListDateRuleItemOperator>(1, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'operator', $pb.PbFieldType.OE, defaultOrMaker: $3.UserListDateRuleItemOperatorEnum_UserListDateRuleItemOperator.UNSPECIFIED, valueOf: $3.UserListDateRuleItemOperatorEnum_UserListDateRuleItemOperator.valueOf, enumValues: $3.UserListDateRuleItemOperatorEnum_UserListDateRuleItemOperator.values)
    ..aOS(4, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'value')
    ..aInt64(5, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'offsetInDays')
    ..hasRequiredFields = false
  ;
  ...
  'Use [GeneratedMessageGenericExtensions.rebuild] instead. '
  'Will be removed in next major version')
  UserListDateRuleItemInfo copyWith(void Function(UserListDateRuleItemInfo) updates) => super.copyWith((message) => updates(message as UserListDateRuleItemInfo)) as UserListDateRuleItemInfo; // ignore: deprecated_member_use
  $pb.BuilderInfo get info_ => _i;
  @$core.pragma('dart2js:noInline')
  ...
  @$pb.TagNumber(1)
  $3.UserListDateRuleItemOperatorEnum_UserListDateRuleItemOperator get operator => $_getN(0);
  @$pb.TagNumber(1)
  set operator($3.UserListDateRuleItemOperatorEnum_UserListDateRuleItemOperator v) { setField(1, v); }
  @$pb.TagNumber(1)
...
class UserListNumberRuleItemInfo extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'UserListNumberRuleItemInfo', package: const $pb.PackageName(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'google.ads.googleads.v10.common'), createEmptyInstance: create)
    ..e<$4.UserListNumberRuleItemOperatorEnum_UserListNumberRuleItemOperator>(1, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'operator', $pb.PbFieldType.OE, defaultOrMaker: $4.UserListNumberRuleItemOperatorEnum_UserListNumberRuleItemOperator.UNSPECIFIED, valueOf: $4.UserListNumberRuleItemOperatorEnum_UserListNumberRuleItemOperator.valueOf, enumValues: $4.UserListNumberRuleItemOperatorEnum_UserListNumberRuleItemOperator.values)
  ...
  factory UserListNumberRuleItemInfo({
    $4.UserListNumberRuleItemOperatorEnum_UserListNumberRuleItemOperator? operator,
    $core.double? value,
  }) {
    final _result = create();
    if (operator != null) {
  ...
  'Use [GeneratedMessageGenericExtensions.rebuild] instead. '
  'Will be removed in next major version')
  UserListNumberRuleItemInfo copyWith(void Function(UserListNumberRuleItemInfo) updates) => super.copyWith((message) => updates(message as UserListNumberRuleItemInfo)) as UserListNumberRuleItemInfo; // ignore: deprecated_member_use
  $pb.BuilderInfo get info_ => _i;
  @$core.pragma('dart2js:noInline')
  ...
  @$pb.TagNumber(1)
  $4.UserListNumberRuleItemOperatorEnum_UserListNumberRuleItemOperator get operator => $_getN(0);
  @$pb.TagNumber(1)
  set operator($4.UserListNumberRuleItemOperatorEnum_UserListNumberRuleItemOperator v) { setField(1, v); }
  @$pb.TagNumber(1)
  $core.bool hasOperator() => $_has(0);
  @$pb.TagNumber(1)
  void clearOperator() => clearField(1);
...
class UserListStringRuleItemInfo extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'UserListStringRuleItemInfo', package: const $pb.PackageName(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'google.ads.googleads.v10.common'), createEmptyInstance: create)
    ..e<$5.UserListStringRuleItemOperatorEnum_UserListStringRuleItemOperator>(1, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'operator', $pb.PbFieldType.OE, defaultOrMaker: $5.UserListStringRuleItemOperatorEnum_UserListStringRuleItemOperator.UNSPECIFIED, valueOf: $5.UserListStringRuleItemOperatorEnum_UserListStringRuleItemOperator.valueOf, enumValues: $5.UserListStringRuleItemOperatorEnum_UserListStringRuleItemOperator.values)
  ...
  factory UserListStringRuleItemInfo({
    $5.UserListStringRuleItemOperatorEnum_UserListStringRuleItemOperator? operator,
    $core.String? value,
  }) {
    final _result = create();
    if (operator != null) {
  ...
  'Use [GeneratedMessageGenericExtensions.rebuild] instead. '
  'Will be removed in next major version')
  UserListStringRuleItemInfo copyWith(void Function(UserListStringRuleItemInfo) updates) => super.copyWith((message) => updates(message as UserListStringRuleItemInfo)) as UserListStringRuleItemInfo; // ignore: deprecated_member_use
  $pb.BuilderInfo get info_ => _i;
  @$core.pragma('dart2js:noInline')
  ...
  @$pb.TagNumber(1)
  $5.UserListStringRuleItemOperatorEnum_UserListStringRuleItemOperator get operator => $_getN(0);
  @$pb.TagNumber(1)
  set operator($5.UserListStringRuleItemOperatorEnum_UserListStringRuleItemOperator v) { setField(1, v); }
  @$pb.TagNumber(1)
  $core.bool hasOperator() => $_has(0);
  @$pb.TagNumber(1)
  void clearOperator() => clearField(1);
...
class CombinedRuleUserListInfo extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'CombinedRuleUserListInfo', package: const $pb.PackageName(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'google.ads.googleads.v10.common'), createEmptyInstance: create)
    ..aOM<UserListRuleInfo>(1, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'leftOperand', subBuilder: UserListRuleInfo.create)
    ..aOM<UserListRuleInfo>(2, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'rightOperand', subBuilder: UserListRuleInfo.create)
    ..e<$6.UserListCombinedRuleOperatorEnum_UserListCombinedRuleOperator>(3, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'ruleOperator', $pb.PbFieldType.OE, defaultOrMaker: $6.UserListCombinedRuleOperatorEnum_UserListCombinedRuleOperator.UNSPECIFIED, valueOf: $6.UserListCombinedRuleOperatorEnum_UserListCombinedRuleOperator.valueOf, enumValues: $6.UserListCombinedRuleOperatorEnum_UserListCombinedRuleOperator.values)
    ..hasRequiredFields = false
  ;
  ...
  factory CombinedRuleUserListInfo({
    ...
    $6.UserListCombinedRuleOperatorEnum_UserListCombinedRuleOperator? ruleOperator,
  }) {
    final _result = create();
    if (leftOperand != null) {
  ...
  factory CombinedRuleUserListInfo.fromBuffer($core.List<$core.int> i, [$pb.ExtensionRegistry r = $pb.ExtensionRegistry.EMPTY]) => create()..mergeFromBuffer(i, r);
  factory CombinedRuleUserListInfo.fromJson($core.String i, [$pb.ExtensionRegistry r = $pb.ExtensionRegistry.EMPTY]) => create()..mergeFromJson(i, r);
  @$core.Deprecated(
  'Using this can add significant overhead to your binary. '
  'Use [GeneratedMessageGenericExtensions.deepCopy] instead. '
  'Will be removed in next major version')
  ...
  'Use [GeneratedMessageGenericExtensions.rebuild] instead. '
  'Will be removed in next major version')
  CombinedRuleUserListInfo copyWith(void Function(CombinedRuleUserListInfo) updates) => super.copyWith((message) => updates(message as CombinedRuleUserListInfo)) as CombinedRuleUserListInfo; // ignore: deprecated_member_use
  $pb.BuilderInfo get info_ => _i;
  @$core.pragma('dart2js:noInline')
  ...
  @$core.pragma('dart2js:noInline')
  static CombinedRuleUserListInfo getDefault() => _defaultInstance ??= $pb.GeneratedMessage.$_defaultFor<CombinedRuleUserListInfo>(create);
  ...
  @$pb.TagNumber(3)
  $6.UserListCombinedRuleOperatorEnum_UserListCombinedRuleOperator get ruleOperator => $_getN(2);
  @$pb.TagNumber(3)
  set ruleOperator($6.UserListCombinedRuleOperatorEnum_UserListCombinedRuleOperator v) { setField(3, v); }
  @$pb.TagNumber(3)
...
class DateSpecificRuleUserListInfo extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'DateSpecificRuleUserListInfo', package: const $pb.PackageName(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'google.ads.googleads.v10.common'), createEmptyInstance: create)
    ..aOM<UserListRuleInfo>(1, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'rule', subBuilder: UserListRuleInfo.create)
  ...
  factory DateSpecificRuleUserListInfo.fromBuffer($core.List<$core.int> i, [$pb.ExtensionRegistry r = $pb.ExtensionRegistry.EMPTY]) => create()..mergeFromBuffer(i, r);
  factory DateSpecificRuleUserListInfo.fromJson($core.String i, [$pb.ExtensionRegistry r = $pb.ExtensionRegistry.EMPTY]) => create()..mergeFromJson(i, r);
  @$core.Deprecated(
  'Using this can add significant overhead to your binary. '
  'Use [GeneratedMessageGenericExtensions.deepCopy] instead. '
  'Will be removed in next major version')
  ...
  'Use [GeneratedMessageGenericExtensions.rebuild] instead. '
  'Will be removed in next major version')
  DateSpecificRuleUserListInfo copyWith(void Function(DateSpecificRuleUserListInfo) updates) => super.copyWith((message) => updates(message as DateSpecificRuleUserListInfo)) as DateSpecificRuleUserListInfo; // ignore: deprecated_member_use
  $pb.BuilderInfo get info_ => _i;
  @$core.pragma('dart2js:noInline')
  static DateSpecificRuleUserListInfo create() => DateSpecificRuleUserListInfo._();
  ...
  @$core.pragma('dart2js:noInline')
  static DateSpecificRuleUserListInfo getDefault() => _defaultInstance ??= $pb.GeneratedMessage.$_defaultFor<DateSpecificRuleUserListInfo>(create);
...
class ExpressionRuleUserListInfo extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'ExpressionRuleUserListInfo', package: const $pb.PackageName(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'google.ads.googleads.v10.common'), createEmptyInstance: create)
    ..aOM<UserListRuleInfo>(1, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'rule', subBuilder: UserListRuleInfo.create)
    ..hasRequiredFields = false
  ;
  ...
  factory ExpressionRuleUserListInfo.fromBuffer($core.List<$core.int> i, [$pb.ExtensionRegistry r = $pb.ExtensionRegistry.EMPTY]) => create()..mergeFromBuffer(i, r);
  factory ExpressionRuleUserListInfo.fromJson($core.String i, [$pb.ExtensionRegistry r = $pb.ExtensionRegistry.EMPTY]) => create()..mergeFromJson(i, r);
  @$core.Deprecated(
  'Using this can add significant overhead to your binary. '
  'Use [GeneratedMessageGenericExtensions.deepCopy] instead. '
  'Will be removed in next major version')
  ...
  'Use [GeneratedMessageGenericExtensions.rebuild] instead. '
  'Will be removed in next major version')
  ExpressionRuleUserListInfo copyWith(void Function(ExpressionRuleUserListInfo) updates) => super.copyWith((message) => updates(message as ExpressionRuleUserListInfo)) as ExpressionRuleUserListInfo; // ignore: deprecated_member_use
  $pb.BuilderInfo get info_ => _i;
  @$core.pragma('dart2js:noInline')
  ...
  @$core.pragma('dart2js:noInline')
  static ExpressionRuleUserListInfo getDefault() => _defaultInstance ??= $pb.GeneratedMessage.$_defaultFor<ExpressionRuleUserListInfo>(create);
...
class RuleBasedUserListInfo extends $pb.GeneratedMessage {
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'RuleBasedUserListInfo', package: const $pb.PackageName(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'google.ads.googleads.v10.common'), createEmptyInstance: create)
    ..oo(0, [2, 3, 4])
    ..e<$7.UserListPrepopulationStatusEnum_UserListPrepopulationStatus>(1, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'prepopulationStatus', $pb.PbFieldType.OE, defaultOrMaker: $7.UserListPrepopulationStatusEnum_UserListPrepopulationStatus.UNSPECIFIED, valueOf: $7.UserListPrepopulationStatusEnum_UserListPrepopulationStatus.valueOf, enumValues: $7.UserListPrepopulationStatusEnum_UserListPrepopulationStatus.values)
    ..aOM<CombinedRuleUserListInfo>(2, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'combinedRuleUserList', subBuilder: CombinedRuleUserListInfo.create)
    ..aOM<DateSpecificRuleUserListInfo>(3, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'dateSpecificRuleUserList', subBuilder: DateSpecificRuleUserListInfo.create)
    ..aOM<ExpressionRuleUserListInfo>(4, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'expressionRuleUserList', subBuilder: ExpressionRuleUserListInfo.create)
    ..hasRequiredFields = false
  ;

  RuleBasedUserListInfo._() : super();
  factory RuleBasedUserListInfo({
    $7.UserListPrepopulationStatusEnum_UserListPrepopulationStatus? prepopulationStatus,
  ...
  'Use [GeneratedMessageGenericExtensions.rebuild] instead. '
  'Will be removed in next major version')
  RuleBasedUserListInfo copyWith(void Function(RuleBasedUserListInfo) updates) => super.copyWith((message) => updates(message as RuleBasedUserListInfo)) as RuleBasedUserListInfo; // ignore: deprecated_member_use
  $pb.BuilderInfo get info_ => _i;
  @$core.pragma('dart2js:noInline')
  ...
  @$pb.TagNumber(1)
  $7.UserListPrepopulationStatusEnum_UserListPrepopulationStatus get prepopulationStatus => $_getN(0);
  @$pb.TagNumber(1)
  set prepopulationStatus($7.UserListPrepopulationStatusEnum_UserListPrepopulationStatus v) { setField(1, v); }
  @$pb.TagNumber(1)
...
class LogicalUserListInfo extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'LogicalUserListInfo', package: const $pb.PackageName(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'google.ads.googleads.v10.common'), createEmptyInstance: create)
    ..pc<UserListLogicalRuleInfo>(1, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'rules', $pb.PbFieldType.PM, subBuilder: UserListLogicalRuleInfo.create)
    ..hasRequiredFields = false
  ;
  ...
  'Use [GeneratedMessageGenericExtensions.rebuild] instead. '
  'Will be removed in next major version')
  LogicalUserListInfo copyWith(void Function(LogicalUserListInfo) updates) => super.copyWith((message) => updates(message as LogicalUserListInfo)) as LogicalUserListInfo; // ignore: deprecated_member_use
  $pb.BuilderInfo get info_ => _i;
  @$core.pragma('dart2js:noInline')
...
class UserListLogicalRuleInfo extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'UserListLogicalRuleInfo', package: const $pb.PackageName(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'google.ads.googleads.v10.common'), createEmptyInstance: create)
    ..e<$8.UserListLogicalRuleOperatorEnum_UserListLogicalRuleOperator>(1, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'operator', $pb.PbFieldType.OE, defaultOrMaker: $8.UserListLogicalRuleOperatorEnum_UserListLogicalRuleOperator.UNSPECIFIED, valueOf: $8.UserListLogicalRuleOperatorEnum_UserListLogicalRuleOperator.valueOf, enumValues: $8.UserListLogicalRuleOperatorEnum_UserListLogicalRuleOperator.values)
    ..pc<LogicalUserListOperandInfo>(2, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'ruleOperands', $pb.PbFieldType.PM, subBuilder: LogicalUserListOperandInfo.create)
    ..hasRequiredFields = false
  ;
  ...
  'Use [GeneratedMessageGenericExtensions.rebuild] instead. '
  'Will be removed in next major version')
  UserListLogicalRuleInfo copyWith(void Function(UserListLogicalRuleInfo) updates) => super.copyWith((message) => updates(message as UserListLogicalRuleInfo)) as UserListLogicalRuleInfo; // ignore: deprecated_member_use
  $pb.BuilderInfo get info_ => _i;
  @$core.pragma('dart2js:noInline')
  ...
  @$pb.TagNumber(1)
  $8.UserListLogicalRuleOperatorEnum_UserListLogicalRuleOperator get operator => $_getN(0);
  @$pb.TagNumber(1)
  set operator($8.UserListLogicalRuleOperatorEnum_UserListLogicalRuleOperator v) { setField(1, v); }
  @$pb.TagNumber(1)
  $core.bool hasOperator() => $_has(0);
  @$pb.TagNumber(1)
  void clearOperator() => clearField(1);
...
class LogicalUserListOperandInfo extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'LogicalUserListOperandInfo', package: const $pb.PackageName(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'google.ads.googleads.v10.common'), createEmptyInstance: create)
  ...
  'Use [GeneratedMessageGenericExtensions.rebuild] instead. '
  'Will be removed in next major version')
  LogicalUserListOperandInfo copyWith(void Function(LogicalUserListOperandInfo) updates) => super.copyWith((message) => updates(message as LogicalUserListOperandInfo)) as LogicalUserListOperandInfo; // ignore: deprecated_member_use
  $pb.BuilderInfo get info_ => _i;
  @$core.pragma('dart2js:noInline')
...
class BasicUserListInfo extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'BasicUserListInfo', package: const $pb.PackageName(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'google.ads.googleads.v10.common'), createEmptyInstance: create)
    ..pc<UserListActionInfo>(1, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'actions', $pb.PbFieldType.PM, subBuilder: UserListActionInfo.create)
    ..hasRequiredFields = false
  ;
  ...
  'Use [GeneratedMessageGenericExtensions.rebuild] instead. '
  'Will be removed in next major version')
  BasicUserListInfo copyWith(void Function(BasicUserListInfo) updates) => super.copyWith((message) => updates(message as BasicUserListInfo)) as BasicUserListInfo; // ignore: deprecated_member_use
  $pb.BuilderInfo get info_ => _i;
  @$core.pragma('dart2js:noInline')
...
class UserListActionInfo extends $pb.GeneratedMessage {
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'UserListActionInfo', package: const $pb.PackageName(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'google.ads.googleads.v10.common'), createEmptyInstance: create)
    ..oo(0, [3, 4])
    ..aOS(3, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'conversionAction')
    ..aOS(4, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'remarketingAction')
    ..hasRequiredFields = false
  ;
  ...
  'Use [GeneratedMessageGenericExtensions.rebuild] instead. '
  'Will be removed in next major version')
  UserListActionInfo copyWith(void Function(UserListActionInfo) updates) => super.copyWith((message) => updates(message as UserListActionInfo)) as UserListActionInfo; // ignore: deprecated_member_use
  $pb.BuilderInfo get info_ => _i;
  @$core.pragma('dart2js:noInline')

...
class ImageErrorEnum extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'ImageErrorEnum', package: const $pb.PackageName(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'google.ads.googleads.v10.errors'), createEmptyInstance: create)
  ...
  'Will be removed in next major version')
  ImageErrorEnum copyWith(void Function(ImageErrorEnum) updates) => super.copyWith((message) => updates(message as ImageErrorEnum)) as ImageErrorEnum; // ignore: deprecated_member_use

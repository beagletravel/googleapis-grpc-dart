...
class CampaignSharedSetErrorEnum_CampaignSharedSetError extends $pb.ProtobufEnum {
  static const CampaignSharedSetErrorEnum_CampaignSharedSetError UNSPECIFIED = CampaignSharedSetErrorEnum_CampaignSharedSetError._(0, const $core.bool.fromEnvironment('protobuf.omit_enum_names') ? '' : 'UNSPECIFIED');
  static const CampaignSharedSetErrorEnum_CampaignSharedSetError UNKNOWN = CampaignSharedSetErrorEnum_CampaignSharedSetError._(1, const $core.bool.fromEnvironment('protobuf.omit_enum_names') ? '' : 'UNKNOWN');
  static const CampaignSharedSetErrorEnum_CampaignSharedSetError SHARED_SET_ACCESS_DENIED = CampaignSharedSetErrorEnum_CampaignSharedSetError._(2, const $core.bool.fromEnvironment('protobuf.omit_enum_names') ? '' : 'SHARED_SET_ACCESS_DENIED');

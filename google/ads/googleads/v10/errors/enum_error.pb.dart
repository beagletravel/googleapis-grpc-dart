...
class EnumErrorEnum extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'EnumErrorEnum', package: const $pb.PackageName(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'google.ads.googleads.v10.errors'), createEmptyInstance: create)
  ...
  'Will be removed in next major version')
  EnumErrorEnum copyWith(void Function(EnumErrorEnum) updates) => super.copyWith((message) => updates(message as EnumErrorEnum)) as EnumErrorEnum; // ignore: deprecated_member_use

...
class QueryErrorEnum extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'QueryErrorEnum', package: const $pb.PackageName(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'google.ads.googleads.v10.errors'), createEmptyInstance: create)
  ...
  'Will be removed in next major version')
  QueryErrorEnum copyWith(void Function(QueryErrorEnum) updates) => super.copyWith((message) => updates(message as QueryErrorEnum)) as QueryErrorEnum; // ignore: deprecated_member_use

...
class FeedItemValidationErrorEnum extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'FeedItemValidationErrorEnum', package: const $pb.PackageName(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'google.ads.googleads.v10.errors'), createEmptyInstance: create)
  ...
  'Will be removed in next major version')
  FeedItemValidationErrorEnum copyWith(void Function(FeedItemValidationErrorEnum) updates) => super.copyWith((message) => updates(message as FeedItemValidationErrorEnum)) as FeedItemValidationErrorEnum; // ignore: deprecated_member_use

...
class InvoiceErrorEnum extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'InvoiceErrorEnum', package: const $pb.PackageName(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'google.ads.googleads.v10.errors'), createEmptyInstance: create)
  ...
  'Will be removed in next major version')
  InvoiceErrorEnum copyWith(void Function(InvoiceErrorEnum) updates) => super.copyWith((message) => updates(message as InvoiceErrorEnum)) as InvoiceErrorEnum; // ignore: deprecated_member_use

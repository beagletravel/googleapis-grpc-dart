...
class QuotaErrorEnum extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'QuotaErrorEnum', package: const $pb.PackageName(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'google.ads.googleads.v10.errors'), createEmptyInstance: create)
  ...
  'Will be removed in next major version')
  QuotaErrorEnum copyWith(void Function(QuotaErrorEnum) updates) => super.copyWith((message) => updates(message as QuotaErrorEnum)) as QuotaErrorEnum; // ignore: deprecated_member_use

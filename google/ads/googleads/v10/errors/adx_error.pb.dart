...
class AdxErrorEnum extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'AdxErrorEnum', package: const $pb.PackageName(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'google.ads.googleads.v10.errors'), createEmptyInstance: create)
  ...
  'Will be removed in next major version')
  AdxErrorEnum copyWith(void Function(AdxErrorEnum) updates) => super.copyWith((message) => updates(message as AdxErrorEnum)) as AdxErrorEnum; // ignore: deprecated_member_use

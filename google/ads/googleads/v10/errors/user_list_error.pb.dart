...
class UserListErrorEnum extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'UserListErrorEnum', package: const $pb.PackageName(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'google.ads.googleads.v10.errors'), createEmptyInstance: create)
  ...
  'Will be removed in next major version')
  UserListErrorEnum copyWith(void Function(UserListErrorEnum) updates) => super.copyWith((message) => updates(message as UserListErrorEnum)) as UserListErrorEnum; // ignore: deprecated_member_use

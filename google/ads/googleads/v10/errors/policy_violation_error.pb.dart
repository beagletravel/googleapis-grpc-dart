...
class PolicyViolationErrorEnum extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'PolicyViolationErrorEnum', package: const $pb.PackageName(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'google.ads.googleads.v10.errors'), createEmptyInstance: create)
  ...
  'Will be removed in next major version')
  PolicyViolationErrorEnum copyWith(void Function(PolicyViolationErrorEnum) updates) => super.copyWith((message) => updates(message as PolicyViolationErrorEnum)) as PolicyViolationErrorEnum; // ignore: deprecated_member_use

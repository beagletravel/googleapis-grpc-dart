...
class ContextErrorEnum extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'ContextErrorEnum', package: const $pb.PackageName(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'google.ads.googleads.v10.errors'), createEmptyInstance: create)
  ...
  'Will be removed in next major version')
  ContextErrorEnum copyWith(void Function(ContextErrorEnum) updates) => super.copyWith((message) => updates(message as ContextErrorEnum)) as ContextErrorEnum; // ignore: deprecated_member_use

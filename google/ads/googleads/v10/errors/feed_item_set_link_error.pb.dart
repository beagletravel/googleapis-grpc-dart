...
class FeedItemSetLinkErrorEnum extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'FeedItemSetLinkErrorEnum', package: const $pb.PackageName(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'google.ads.googleads.v10.errors'), createEmptyInstance: create)
  ...
  'Will be removed in next major version')
  FeedItemSetLinkErrorEnum copyWith(void Function(FeedItemSetLinkErrorEnum) updates) => super.copyWith((message) => updates(message as FeedItemSetLinkErrorEnum)) as FeedItemSetLinkErrorEnum; // ignore: deprecated_member_use

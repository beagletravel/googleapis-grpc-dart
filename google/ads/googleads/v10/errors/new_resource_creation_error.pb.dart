...
class NewResourceCreationErrorEnum extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'NewResourceCreationErrorEnum', package: const $pb.PackageName(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'google.ads.googleads.v10.errors'), createEmptyInstance: create)
  ...
  'Will be removed in next major version')
  NewResourceCreationErrorEnum copyWith(void Function(NewResourceCreationErrorEnum) updates) => super.copyWith((message) => updates(message as NewResourceCreationErrorEnum)) as NewResourceCreationErrorEnum; // ignore: deprecated_member_use

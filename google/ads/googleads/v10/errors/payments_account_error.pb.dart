...
class PaymentsAccountErrorEnum extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'PaymentsAccountErrorEnum', package: const $pb.PackageName(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'google.ads.googleads.v10.errors'), createEmptyInstance: create)
  ...
  'Will be removed in next major version')
  PaymentsAccountErrorEnum copyWith(void Function(PaymentsAccountErrorEnum) updates) => super.copyWith((message) => updates(message as PaymentsAccountErrorEnum)) as PaymentsAccountErrorEnum; // ignore: deprecated_member_use

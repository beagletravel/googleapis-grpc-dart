...
class CustomerManagerLinkErrorEnum extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'CustomerManagerLinkErrorEnum', package: const $pb.PackageName(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'google.ads.googleads.v10.errors'), createEmptyInstance: create)
  ...
  'Will be removed in next major version')
  CustomerManagerLinkErrorEnum copyWith(void Function(CustomerManagerLinkErrorEnum) updates) => super.copyWith((message) => updates(message as CustomerManagerLinkErrorEnum)) as CustomerManagerLinkErrorEnum; // ignore: deprecated_member_use

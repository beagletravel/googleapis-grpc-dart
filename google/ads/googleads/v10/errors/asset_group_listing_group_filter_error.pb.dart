...
class AssetGroupListingGroupFilterErrorEnum extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'AssetGroupListingGroupFilterErrorEnum', package: const $pb.PackageName(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'google.ads.googleads.v10.errors'), createEmptyInstance: create)
  ...
  'Will be removed in next major version')
  AssetGroupListingGroupFilterErrorEnum copyWith(void Function(AssetGroupListingGroupFilterErrorEnum) updates) => super.copyWith((message) => updates(message as AssetGroupListingGroupFilterErrorEnum)) as AssetGroupListingGroupFilterErrorEnum; // ignore: deprecated_member_use

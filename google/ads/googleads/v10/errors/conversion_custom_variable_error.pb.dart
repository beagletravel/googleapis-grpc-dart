...
class ConversionCustomVariableErrorEnum extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'ConversionCustomVariableErrorEnum', package: const $pb.PackageName(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'google.ads.googleads.v10.errors'), createEmptyInstance: create)
  ...
  'Will be removed in next major version')
  ConversionCustomVariableErrorEnum copyWith(void Function(ConversionCustomVariableErrorEnum) updates) => super.copyWith((message) => updates(message as ConversionCustomVariableErrorEnum)) as ConversionCustomVariableErrorEnum; // ignore: deprecated_member_use

...
class BiddingErrorEnum extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'BiddingErrorEnum', package: const $pb.PackageName(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'google.ads.googleads.v10.errors'), createEmptyInstance: create)
  ...
  'Will be removed in next major version')
  BiddingErrorEnum copyWith(void Function(BiddingErrorEnum) updates) => super.copyWith((message) => updates(message as BiddingErrorEnum)) as BiddingErrorEnum; // ignore: deprecated_member_use

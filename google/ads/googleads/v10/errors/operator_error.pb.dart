...
class OperatorErrorEnum extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'OperatorErrorEnum', package: const $pb.PackageName(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'google.ads.googleads.v10.errors'), createEmptyInstance: create)
  ...
  'Will be removed in next major version')
  OperatorErrorEnum copyWith(void Function(OperatorErrorEnum) updates) => super.copyWith((message) => updates(message as OperatorErrorEnum)) as OperatorErrorEnum; // ignore: deprecated_member_use

...
class DatabaseErrorEnum extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'DatabaseErrorEnum', package: const $pb.PackageName(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'google.ads.googleads.v10.errors'), createEmptyInstance: create)
  ...
  'Will be removed in next major version')
  DatabaseErrorEnum copyWith(void Function(DatabaseErrorEnum) updates) => super.copyWith((message) => updates(message as DatabaseErrorEnum)) as DatabaseErrorEnum; // ignore: deprecated_member_use

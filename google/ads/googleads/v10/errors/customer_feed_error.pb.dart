...
class CustomerFeedErrorEnum extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'CustomerFeedErrorEnum', package: const $pb.PackageName(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'google.ads.googleads.v10.errors'), createEmptyInstance: create)
  ...
  'Will be removed in next major version')
  CustomerFeedErrorEnum copyWith(void Function(CustomerFeedErrorEnum) updates) => super.copyWith((message) => updates(message as CustomerFeedErrorEnum)) as CustomerFeedErrorEnum; // ignore: deprecated_member_use

...
class BatchJobErrorEnum extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'BatchJobErrorEnum', package: const $pb.PackageName(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'google.ads.googleads.v10.errors'), createEmptyInstance: create)
  ...
  'Will be removed in next major version')
  BatchJobErrorEnum copyWith(void Function(BatchJobErrorEnum) updates) => super.copyWith((message) => updates(message as BatchJobErrorEnum)) as BatchJobErrorEnum; // ignore: deprecated_member_use

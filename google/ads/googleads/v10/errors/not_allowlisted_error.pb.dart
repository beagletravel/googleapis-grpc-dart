...
class NotAllowlistedErrorEnum extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'NotAllowlistedErrorEnum', package: const $pb.PackageName(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'google.ads.googleads.v10.errors'), createEmptyInstance: create)
  ...
  'Will be removed in next major version')
  NotAllowlistedErrorEnum copyWith(void Function(NotAllowlistedErrorEnum) updates) => super.copyWith((message) => updates(message as NotAllowlistedErrorEnum)) as NotAllowlistedErrorEnum; // ignore: deprecated_member_use

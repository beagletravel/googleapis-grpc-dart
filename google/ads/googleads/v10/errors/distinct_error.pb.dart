...
class DistinctErrorEnum extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'DistinctErrorEnum', package: const $pb.PackageName(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'google.ads.googleads.v10.errors'), createEmptyInstance: create)
  ...
  'Will be removed in next major version')
  DistinctErrorEnum copyWith(void Function(DistinctErrorEnum) updates) => super.copyWith((message) => updates(message as DistinctErrorEnum)) as DistinctErrorEnum; // ignore: deprecated_member_use

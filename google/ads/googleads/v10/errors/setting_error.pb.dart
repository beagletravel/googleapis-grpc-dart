...
class SettingErrorEnum extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'SettingErrorEnum', package: const $pb.PackageName(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'google.ads.googleads.v10.errors'), createEmptyInstance: create)
  ...
  'Will be removed in next major version')
  SettingErrorEnum copyWith(void Function(SettingErrorEnum) updates) => super.copyWith((message) => updates(message as SettingErrorEnum)) as SettingErrorEnum; // ignore: deprecated_member_use

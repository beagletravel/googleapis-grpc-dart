...
class AssetErrorEnum extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'AssetErrorEnum', package: const $pb.PackageName(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'google.ads.googleads.v10.errors'), createEmptyInstance: create)
  ...
  'Will be removed in next major version')
  AssetErrorEnum copyWith(void Function(AssetErrorEnum) updates) => super.copyWith((message) => updates(message as AssetErrorEnum)) as AssetErrorEnum; // ignore: deprecated_member_use

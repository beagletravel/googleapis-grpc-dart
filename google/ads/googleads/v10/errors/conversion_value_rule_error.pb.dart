...
class ConversionValueRuleErrorEnum extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'ConversionValueRuleErrorEnum', package: const $pb.PackageName(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'google.ads.googleads.v10.errors'), createEmptyInstance: create)
  ...
  'Will be removed in next major version')
  ConversionValueRuleErrorEnum copyWith(void Function(ConversionValueRuleErrorEnum) updates) => super.copyWith((message) => updates(message as ConversionValueRuleErrorEnum)) as ConversionValueRuleErrorEnum; // ignore: deprecated_member_use

...
class FunctionParsingErrorEnum extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'FunctionParsingErrorEnum', package: const $pb.PackageName(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'google.ads.googleads.v10.errors'), createEmptyInstance: create)
  ...
  'Will be removed in next major version')
  FunctionParsingErrorEnum copyWith(void Function(FunctionParsingErrorEnum) updates) => super.copyWith((message) => updates(message as FunctionParsingErrorEnum)) as FunctionParsingErrorEnum; // ignore: deprecated_member_use

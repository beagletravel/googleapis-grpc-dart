...
class AdGroupCustomizerErrorEnum extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'AdGroupCustomizerErrorEnum', package: const $pb.PackageName(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'google.ads.googleads.v10.errors'), createEmptyInstance: create)
  ...
  'Will be removed in next major version')
  AdGroupCustomizerErrorEnum copyWith(void Function(AdGroupCustomizerErrorEnum) updates) => super.copyWith((message) => updates(message as AdGroupCustomizerErrorEnum)) as AdGroupCustomizerErrorEnum; // ignore: deprecated_member_use

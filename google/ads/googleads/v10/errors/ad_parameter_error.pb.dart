...
class AdParameterErrorEnum extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'AdParameterErrorEnum', package: const $pb.PackageName(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'google.ads.googleads.v10.errors'), createEmptyInstance: create)
  ...
  'Will be removed in next major version')
  AdParameterErrorEnum copyWith(void Function(AdParameterErrorEnum) updates) => super.copyWith((message) => updates(message as AdParameterErrorEnum)) as AdParameterErrorEnum; // ignore: deprecated_member_use

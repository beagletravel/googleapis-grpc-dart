...
class CustomerCustomizerErrorEnum extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'CustomerCustomizerErrorEnum', package: const $pb.PackageName(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'google.ads.googleads.v10.errors'), createEmptyInstance: create)
  ...
  'Will be removed in next major version')
  CustomerCustomizerErrorEnum copyWith(void Function(CustomerCustomizerErrorEnum) updates) => super.copyWith((message) => updates(message as CustomerCustomizerErrorEnum)) as CustomerCustomizerErrorEnum; // ignore: deprecated_member_use

...
class KeywordPlanAdGroupKeywordErrorEnum extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'KeywordPlanAdGroupKeywordErrorEnum', package: const $pb.PackageName(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'google.ads.googleads.v10.errors'), createEmptyInstance: create)
  ...
  'Will be removed in next major version')
  KeywordPlanAdGroupKeywordErrorEnum copyWith(void Function(KeywordPlanAdGroupKeywordErrorEnum) updates) => super.copyWith((message) => updates(message as KeywordPlanAdGroupKeywordErrorEnum)) as KeywordPlanAdGroupKeywordErrorEnum; // ignore: deprecated_member_use

...
class BiddingStrategyErrorEnum extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'BiddingStrategyErrorEnum', package: const $pb.PackageName(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'google.ads.googleads.v10.errors'), createEmptyInstance: create)
  ...
  'Will be removed in next major version')
  BiddingStrategyErrorEnum copyWith(void Function(BiddingStrategyErrorEnum) updates) => super.copyWith((message) => updates(message as BiddingStrategyErrorEnum)) as BiddingStrategyErrorEnum; // ignore: deprecated_member_use

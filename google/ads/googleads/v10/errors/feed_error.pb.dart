...
class FeedErrorEnum extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'FeedErrorEnum', package: const $pb.PackageName(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'google.ads.googleads.v10.errors'), createEmptyInstance: create)
  ...
  'Will be removed in next major version')
  FeedErrorEnum copyWith(void Function(FeedErrorEnum) updates) => super.copyWith((message) => updates(message as FeedErrorEnum)) as FeedErrorEnum; // ignore: deprecated_member_use

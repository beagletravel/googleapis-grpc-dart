...
class KeywordPlanIdeaErrorEnum extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'KeywordPlanIdeaErrorEnum', package: const $pb.PackageName(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'google.ads.googleads.v10.errors'), createEmptyInstance: create)
  ...
  'Will be removed in next major version')
  KeywordPlanIdeaErrorEnum copyWith(void Function(KeywordPlanIdeaErrorEnum) updates) => super.copyWith((message) => updates(message as KeywordPlanIdeaErrorEnum)) as KeywordPlanIdeaErrorEnum; // ignore: deprecated_member_use

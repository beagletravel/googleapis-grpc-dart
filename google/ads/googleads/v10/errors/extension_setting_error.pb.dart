...
class ExtensionSettingErrorEnum extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'ExtensionSettingErrorEnum', package: const $pb.PackageName(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'google.ads.googleads.v10.errors'), createEmptyInstance: create)
  ...
  'Will be removed in next major version')
  ExtensionSettingErrorEnum copyWith(void Function(ExtensionSettingErrorEnum) updates) => super.copyWith((message) => updates(message as ExtensionSettingErrorEnum)) as ExtensionSettingErrorEnum; // ignore: deprecated_member_use

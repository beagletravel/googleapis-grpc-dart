...
class CriterionErrorEnum extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'CriterionErrorEnum', package: const $pb.PackageName(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'google.ads.googleads.v10.errors'), createEmptyInstance: create)
  ...
  'Will be removed in next major version')
  CriterionErrorEnum copyWith(void Function(CriterionErrorEnum) updates) => super.copyWith((message) => updates(message as CriterionErrorEnum)) as CriterionErrorEnum; // ignore: deprecated_member_use

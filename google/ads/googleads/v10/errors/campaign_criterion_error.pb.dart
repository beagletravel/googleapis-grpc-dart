...
class CampaignCriterionErrorEnum extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'CampaignCriterionErrorEnum', package: const $pb.PackageName(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'google.ads.googleads.v10.errors'), createEmptyInstance: create)
  ...
  'Will be removed in next major version')
  CampaignCriterionErrorEnum copyWith(void Function(CampaignCriterionErrorEnum) updates) => super.copyWith((message) => updates(message as CampaignCriterionErrorEnum)) as CampaignCriterionErrorEnum; // ignore: deprecated_member_use

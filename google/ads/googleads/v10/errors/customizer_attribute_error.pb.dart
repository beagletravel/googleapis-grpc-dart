...
class CustomizerAttributeErrorEnum extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'CustomizerAttributeErrorEnum', package: const $pb.PackageName(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'google.ads.googleads.v10.errors'), createEmptyInstance: create)
  ...
  'Will be removed in next major version')
  CustomizerAttributeErrorEnum copyWith(void Function(CustomizerAttributeErrorEnum) updates) => super.copyWith((message) => updates(message as CustomizerAttributeErrorEnum)) as CustomizerAttributeErrorEnum; // ignore: deprecated_member_use

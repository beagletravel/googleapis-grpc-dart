...
class NullErrorEnum extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'NullErrorEnum', package: const $pb.PackageName(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'google.ads.googleads.v10.errors'), createEmptyInstance: create)
  ...
  'Will be removed in next major version')
  NullErrorEnum copyWith(void Function(NullErrorEnum) updates) => super.copyWith((message) => updates(message as NullErrorEnum)) as NullErrorEnum; // ignore: deprecated_member_use

...
class MediaFileErrorEnum extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'MediaFileErrorEnum', package: const $pb.PackageName(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'google.ads.googleads.v10.errors'), createEmptyInstance: create)
  ...
  'Will be removed in next major version')
  MediaFileErrorEnum copyWith(void Function(MediaFileErrorEnum) updates) => super.copyWith((message) => updates(message as MediaFileErrorEnum)) as MediaFileErrorEnum; // ignore: deprecated_member_use

...
class CampaignDraftErrorEnum extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'CampaignDraftErrorEnum', package: const $pb.PackageName(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'google.ads.googleads.v10.errors'), createEmptyInstance: create)
  ...
  'Will be removed in next major version')
  CampaignDraftErrorEnum copyWith(void Function(CampaignDraftErrorEnum) updates) => super.copyWith((message) => updates(message as CampaignDraftErrorEnum)) as CampaignDraftErrorEnum; // ignore: deprecated_member_use

...
class AdSharingErrorEnum extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'AdSharingErrorEnum', package: const $pb.PackageName(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'google.ads.googleads.v10.errors'), createEmptyInstance: create)
  ...
  'Will be removed in next major version')
  AdSharingErrorEnum copyWith(void Function(AdSharingErrorEnum) updates) => super.copyWith((message) => updates(message as AdSharingErrorEnum)) as AdSharingErrorEnum; // ignore: deprecated_member_use

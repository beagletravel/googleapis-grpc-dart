...
class ThirdPartyAppAnalyticsLinkErrorEnum extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'ThirdPartyAppAnalyticsLinkErrorEnum', package: const $pb.PackageName(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'google.ads.googleads.v10.errors'), createEmptyInstance: create)
  ...
  'Will be removed in next major version')
  ThirdPartyAppAnalyticsLinkErrorEnum copyWith(void Function(ThirdPartyAppAnalyticsLinkErrorEnum) updates) => super.copyWith((message) => updates(message as ThirdPartyAppAnalyticsLinkErrorEnum)) as ThirdPartyAppAnalyticsLinkErrorEnum; // ignore: deprecated_member_use

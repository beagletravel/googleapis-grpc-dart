...
class MerchantCenterErrorEnum extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'MerchantCenterErrorEnum', package: const $pb.PackageName(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'google.ads.googleads.v10.errors'), createEmptyInstance: create)
  ...
  'Will be removed in next major version')
  MerchantCenterErrorEnum copyWith(void Function(MerchantCenterErrorEnum) updates) => super.copyWith((message) => updates(message as MerchantCenterErrorEnum)) as MerchantCenterErrorEnum; // ignore: deprecated_member_use

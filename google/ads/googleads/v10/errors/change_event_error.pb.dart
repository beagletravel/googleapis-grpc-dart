...
class ChangeEventErrorEnum extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'ChangeEventErrorEnum', package: const $pb.PackageName(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'google.ads.googleads.v10.errors'), createEmptyInstance: create)
  ...
  'Will be removed in next major version')
  ChangeEventErrorEnum copyWith(void Function(ChangeEventErrorEnum) updates) => super.copyWith((message) => updates(message as ChangeEventErrorEnum)) as ChangeEventErrorEnum; // ignore: deprecated_member_use

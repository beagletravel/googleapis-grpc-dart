...
class CountryCodeErrorEnum extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'CountryCodeErrorEnum', package: const $pb.PackageName(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'google.ads.googleads.v10.errors'), createEmptyInstance: create)
  ...
  'Will be removed in next major version')
  CountryCodeErrorEnum copyWith(void Function(CountryCodeErrorEnum) updates) => super.copyWith((message) => updates(message as CountryCodeErrorEnum)) as CountryCodeErrorEnum; // ignore: deprecated_member_use

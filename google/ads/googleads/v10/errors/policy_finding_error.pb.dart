...
class PolicyFindingErrorEnum extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'PolicyFindingErrorEnum', package: const $pb.PackageName(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'google.ads.googleads.v10.errors'), createEmptyInstance: create)
  ...
  'Will be removed in next major version')
  PolicyFindingErrorEnum copyWith(void Function(PolicyFindingErrorEnum) updates) => super.copyWith((message) => updates(message as PolicyFindingErrorEnum)) as PolicyFindingErrorEnum; // ignore: deprecated_member_use

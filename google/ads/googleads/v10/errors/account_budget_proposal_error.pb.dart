...
class AccountBudgetProposalErrorEnum extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'AccountBudgetProposalErrorEnum', package: const $pb.PackageName(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'google.ads.googleads.v10.errors'), createEmptyInstance: create)
  ...
  'Will be removed in next major version')
  AccountBudgetProposalErrorEnum copyWith(void Function(AccountBudgetProposalErrorEnum) updates) => super.copyWith((message) => updates(message as AccountBudgetProposalErrorEnum)) as AccountBudgetProposalErrorEnum; // ignore: deprecated_member_use

...
class CampaignCustomizerErrorEnum extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'CampaignCustomizerErrorEnum', package: const $pb.PackageName(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'google.ads.googleads.v10.errors'), createEmptyInstance: create)
  ...
  'Will be removed in next major version')
  CampaignCustomizerErrorEnum copyWith(void Function(CampaignCustomizerErrorEnum) updates) => super.copyWith((message) => updates(message as CampaignCustomizerErrorEnum)) as CampaignCustomizerErrorEnum; // ignore: deprecated_member_use

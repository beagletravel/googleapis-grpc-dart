...
class ConversionValueRuleSetErrorEnum extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'ConversionValueRuleSetErrorEnum', package: const $pb.PackageName(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'google.ads.googleads.v10.errors'), createEmptyInstance: create)
  ...
  'Will be removed in next major version')
  ConversionValueRuleSetErrorEnum copyWith(void Function(ConversionValueRuleSetErrorEnum) updates) => super.copyWith((message) => updates(message as ConversionValueRuleSetErrorEnum)) as ConversionValueRuleSetErrorEnum; // ignore: deprecated_member_use

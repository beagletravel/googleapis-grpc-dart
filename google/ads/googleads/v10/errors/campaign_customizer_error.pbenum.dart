...
class CampaignCustomizerErrorEnum_CampaignCustomizerError extends $pb.ProtobufEnum {
  static const CampaignCustomizerErrorEnum_CampaignCustomizerError UNSPECIFIED = CampaignCustomizerErrorEnum_CampaignCustomizerError._(0, const $core.bool.fromEnvironment('protobuf.omit_enum_names') ? '' : 'UNSPECIFIED');
  static const CampaignCustomizerErrorEnum_CampaignCustomizerError UNKNOWN = CampaignCustomizerErrorEnum_CampaignCustomizerError._(1, const $core.bool.fromEnvironment('protobuf.omit_enum_names') ? '' : 'UNKNOWN');

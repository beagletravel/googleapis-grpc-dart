...
class OfflineUserDataJobErrorEnum extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'OfflineUserDataJobErrorEnum', package: const $pb.PackageName(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'google.ads.googleads.v10.errors'), createEmptyInstance: create)
  ...
  'Will be removed in next major version')
  OfflineUserDataJobErrorEnum copyWith(void Function(OfflineUserDataJobErrorEnum) updates) => super.copyWith((message) => updates(message as OfflineUserDataJobErrorEnum)) as OfflineUserDataJobErrorEnum; // ignore: deprecated_member_use

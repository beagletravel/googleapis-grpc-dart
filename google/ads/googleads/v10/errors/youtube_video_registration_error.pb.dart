...
class YoutubeVideoRegistrationErrorEnum extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'YoutubeVideoRegistrationErrorEnum', package: const $pb.PackageName(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'google.ads.googleads.v10.errors'), createEmptyInstance: create)
  ...
  'Will be removed in next major version')
  YoutubeVideoRegistrationErrorEnum copyWith(void Function(YoutubeVideoRegistrationErrorEnum) updates) => super.copyWith((message) => updates(message as YoutubeVideoRegistrationErrorEnum)) as YoutubeVideoRegistrationErrorEnum; // ignore: deprecated_member_use

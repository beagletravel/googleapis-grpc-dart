...
class ConversionUploadErrorEnum extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'ConversionUploadErrorEnum', package: const $pb.PackageName(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'google.ads.googleads.v10.errors'), createEmptyInstance: create)
  ...
  'Will be removed in next major version')
  ConversionUploadErrorEnum copyWith(void Function(ConversionUploadErrorEnum) updates) => super.copyWith((message) => updates(message as ConversionUploadErrorEnum)) as ConversionUploadErrorEnum; // ignore: deprecated_member_use

...
class SizeLimitErrorEnum extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'SizeLimitErrorEnum', package: const $pb.PackageName(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'google.ads.googleads.v10.errors'), createEmptyInstance: create)
  ...
  'Will be removed in next major version')
  SizeLimitErrorEnum copyWith(void Function(SizeLimitErrorEnum) updates) => super.copyWith((message) => updates(message as SizeLimitErrorEnum)) as SizeLimitErrorEnum; // ignore: deprecated_member_use

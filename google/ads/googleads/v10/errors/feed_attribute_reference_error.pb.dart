...
class FeedAttributeReferenceErrorEnum extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'FeedAttributeReferenceErrorEnum', package: const $pb.PackageName(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'google.ads.googleads.v10.errors'), createEmptyInstance: create)
  ...
  'Will be removed in next major version')
  FeedAttributeReferenceErrorEnum copyWith(void Function(FeedAttributeReferenceErrorEnum) updates) => super.copyWith((message) => updates(message as FeedAttributeReferenceErrorEnum)) as FeedAttributeReferenceErrorEnum; // ignore: deprecated_member_use

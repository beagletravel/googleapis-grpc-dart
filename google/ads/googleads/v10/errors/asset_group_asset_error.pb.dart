...
class AssetGroupAssetErrorEnum extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'AssetGroupAssetErrorEnum', package: const $pb.PackageName(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'google.ads.googleads.v10.errors'), createEmptyInstance: create)
  ...
  'Will be removed in next major version')
  AssetGroupAssetErrorEnum copyWith(void Function(AssetGroupAssetErrorEnum) updates) => super.copyWith((message) => updates(message as AssetGroupAssetErrorEnum)) as AssetGroupAssetErrorEnum; // ignore: deprecated_member_use

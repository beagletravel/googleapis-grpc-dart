...
class AdGroupCriterionCustomizerErrorEnum extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'AdGroupCriterionCustomizerErrorEnum', package: const $pb.PackageName(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'google.ads.googleads.v10.errors'), createEmptyInstance: create)
  ...
  'Will be removed in next major version')
  AdGroupCriterionCustomizerErrorEnum copyWith(void Function(AdGroupCriterionCustomizerErrorEnum) updates) => super.copyWith((message) => updates(message as AdGroupCriterionCustomizerErrorEnum)) as AdGroupCriterionCustomizerErrorEnum; // ignore: deprecated_member_use

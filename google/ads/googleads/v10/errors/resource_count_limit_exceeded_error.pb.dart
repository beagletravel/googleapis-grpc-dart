...
class ResourceCountLimitExceededErrorEnum extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'ResourceCountLimitExceededErrorEnum', package: const $pb.PackageName(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'google.ads.googleads.v10.errors'), createEmptyInstance: create)
  ...
  'Will be removed in next major version')
  ResourceCountLimitExceededErrorEnum copyWith(void Function(ResourceCountLimitExceededErrorEnum) updates) => super.copyWith((message) => updates(message as ResourceCountLimitExceededErrorEnum)) as ResourceCountLimitExceededErrorEnum; // ignore: deprecated_member_use

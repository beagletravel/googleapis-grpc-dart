...
class CampaignErrorEnum extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'CampaignErrorEnum', package: const $pb.PackageName(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'google.ads.googleads.v10.errors'), createEmptyInstance: create)
  ...
  'Will be removed in next major version')
  CampaignErrorEnum copyWith(void Function(CampaignErrorEnum) updates) => super.copyWith((message) => updates(message as CampaignErrorEnum)) as CampaignErrorEnum; // ignore: deprecated_member_use

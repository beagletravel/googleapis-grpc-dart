...
class RegionCodeErrorEnum extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'RegionCodeErrorEnum', package: const $pb.PackageName(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'google.ads.googleads.v10.errors'), createEmptyInstance: create)
  ...
  'Will be removed in next major version')
  RegionCodeErrorEnum copyWith(void Function(RegionCodeErrorEnum) updates) => super.copyWith((message) => updates(message as RegionCodeErrorEnum)) as RegionCodeErrorEnum; // ignore: deprecated_member_use

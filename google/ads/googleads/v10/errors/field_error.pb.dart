...
class FieldErrorEnum extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'FieldErrorEnum', package: const $pb.PackageName(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'google.ads.googleads.v10.errors'), createEmptyInstance: create)
  ...
  'Will be removed in next major version')
  FieldErrorEnum copyWith(void Function(FieldErrorEnum) updates) => super.copyWith((message) => updates(message as FieldErrorEnum)) as FieldErrorEnum; // ignore: deprecated_member_use

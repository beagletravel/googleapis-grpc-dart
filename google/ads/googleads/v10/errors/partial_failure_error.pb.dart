...
class PartialFailureErrorEnum extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'PartialFailureErrorEnum', package: const $pb.PackageName(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'google.ads.googleads.v10.errors'), createEmptyInstance: create)
  ...
  'Will be removed in next major version')
  PartialFailureErrorEnum copyWith(void Function(PartialFailureErrorEnum) updates) => super.copyWith((message) => updates(message as PartialFailureErrorEnum)) as PartialFailureErrorEnum; // ignore: deprecated_member_use

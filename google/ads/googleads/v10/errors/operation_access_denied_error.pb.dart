...
class OperationAccessDeniedErrorEnum extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'OperationAccessDeniedErrorEnum', package: const $pb.PackageName(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'google.ads.googleads.v10.errors'), createEmptyInstance: create)
  ...
  'Will be removed in next major version')
  OperationAccessDeniedErrorEnum copyWith(void Function(OperationAccessDeniedErrorEnum) updates) => super.copyWith((message) => updates(message as OperationAccessDeniedErrorEnum)) as OperationAccessDeniedErrorEnum; // ignore: deprecated_member_use

...
class ReachPlanErrorEnum extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'ReachPlanErrorEnum', package: const $pb.PackageName(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'google.ads.googleads.v10.errors'), createEmptyInstance: create)
  ...
  'Will be removed in next major version')
  ReachPlanErrorEnum copyWith(void Function(ReachPlanErrorEnum) updates) => super.copyWith((message) => updates(message as ReachPlanErrorEnum)) as ReachPlanErrorEnum; // ignore: deprecated_member_use

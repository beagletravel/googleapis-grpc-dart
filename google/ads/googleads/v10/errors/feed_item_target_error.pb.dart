...
class FeedItemTargetErrorEnum extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'FeedItemTargetErrorEnum', package: const $pb.PackageName(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'google.ads.googleads.v10.errors'), createEmptyInstance: create)
  ...
  'Will be removed in next major version')
  FeedItemTargetErrorEnum copyWith(void Function(FeedItemTargetErrorEnum) updates) => super.copyWith((message) => updates(message as FeedItemTargetErrorEnum)) as FeedItemTargetErrorEnum; // ignore: deprecated_member_use

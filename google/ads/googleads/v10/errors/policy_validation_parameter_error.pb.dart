...
class PolicyValidationParameterErrorEnum extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'PolicyValidationParameterErrorEnum', package: const $pb.PackageName(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'google.ads.googleads.v10.errors'), createEmptyInstance: create)
  ...
  'Will be removed in next major version')
  PolicyValidationParameterErrorEnum copyWith(void Function(PolicyValidationParameterErrorEnum) updates) => super.copyWith((message) => updates(message as PolicyValidationParameterErrorEnum)) as PolicyValidationParameterErrorEnum; // ignore: deprecated_member_use

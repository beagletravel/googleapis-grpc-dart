...
class CurrencyCodeErrorEnum extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'CurrencyCodeErrorEnum', package: const $pb.PackageName(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'google.ads.googleads.v10.errors'), createEmptyInstance: create)
  ...
  'Will be removed in next major version')
  CurrencyCodeErrorEnum copyWith(void Function(CurrencyCodeErrorEnum) updates) => super.copyWith((message) => updates(message as CurrencyCodeErrorEnum)) as CurrencyCodeErrorEnum; // ignore: deprecated_member_use

...
class UploadUserDataRequest extends $pb.GeneratedMessage {
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'UploadUserDataRequest', package: const $pb.PackageName(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'google.ads.googleads.v10.services'), createEmptyInstance: create)
    ..oo(0, [2])
    ..aOS(1, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'customerId')
    ..aOM<$1.CustomerMatchUserListMetadata>(2, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'customerMatchUserListMetadata', subBuilder: $1.CustomerMatchUserListMetadata.create)
    ..pc<UserDataOperation>(3, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'operations', $pb.PbFieldType.PM, subBuilder: UserDataOperation.create)
  ...
  'Will be removed in next major version')
  UploadUserDataRequest copyWith(void Function(UploadUserDataRequest) updates) => super.copyWith((message) => updates(message as UploadUserDataRequest)) as UploadUserDataRequest; // ignore: deprecated_member_use
  ...
  @$pb.TagNumber(2)
  $1.CustomerMatchUserListMetadata get customerMatchUserListMetadata => $_getN(1);
  @$pb.TagNumber(2)
  set customerMatchUserListMetadata($1.CustomerMatchUserListMetadata v) { setField(2, v); }
  @$pb.TagNumber(2)
  $core.bool hasCustomerMatchUserListMetadata() => $_has(1);
  @$pb.TagNumber(2)
  void clearCustomerMatchUserListMetadata() => clearField(2);
  @$pb.TagNumber(2)
  $1.CustomerMatchUserListMetadata ensureCustomerMatchUserListMetadata() => $_ensure(1);
...
class UserDataOperation extends $pb.GeneratedMessage {
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'UserDataOperation', package: const $pb.PackageName(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'google.ads.googleads.v10.services'), createEmptyInstance: create)
    ..oo(0, [1, 2])
    ..aOM<$1.UserData>(1, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'create', subBuilder: $1.UserData.create)
    ..aOM<$1.UserData>(2, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'remove', subBuilder: $1.UserData.create)
    ..hasRequiredFields = false
  ;
  ...
  'Use [GeneratedMessageGenericExtensions.rebuild] instead. '
  'Will be removed in next major version')
  UserDataOperation copyWith(void Function(UserDataOperation) updates) => super.copyWith((message) => updates(message as UserDataOperation)) as UserDataOperation; // ignore: deprecated_member_use
  $pb.BuilderInfo get info_ => _i;
  @$core.pragma('dart2js:noInline')
  ...
  @$pb.TagNumber(1)
  set create_1($1.UserData v) { setField(1, v); }
  @$pb.TagNumber(1)
  ...
  @$pb.TagNumber(2)
  set remove($1.UserData v) { setField(2, v); }
  @$pb.TagNumber(2)
...
class UploadUserDataResponse extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'UploadUserDataResponse', package: const $pb.PackageName(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'google.ads.googleads.v10.services'), createEmptyInstance: create)
    ..aOS(3, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'uploadDateTime')
    ..a<$core.int>(4, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'receivedOperationsCount', $pb.PbFieldType.O3)
    ..hasRequiredFields = false
  ;
  ...
  'Use [GeneratedMessageGenericExtensions.rebuild] instead. '
  'Will be removed in next major version')
  UploadUserDataResponse copyWith(void Function(UploadUserDataResponse) updates) => super.copyWith((message) => updates(message as UploadUserDataResponse)) as UploadUserDataResponse; // ignore: deprecated_member_use
  $pb.BuilderInfo get info_ => _i;
  @$core.pragma('dart2js:noInline')

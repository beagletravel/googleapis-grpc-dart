...
class SmartCampaignSuggestServiceClient extends $grpc.Client {
  ...
  static final _$suggestKeywordThemes = $grpc.ClientMethod<
          $0.SuggestKeywordThemesRequest, $0.SuggestKeywordThemesResponse>(
      '/google.ads.googleads.v10.services.SmartCampaignSuggestService/SuggestKeywordThemes',
      ($0.SuggestKeywordThemesRequest value) => value.writeToBuffer(),
      ($core.List<$core.int> value) =>
          $0.SuggestKeywordThemesResponse.fromBuffer(value));
  ...
  $grpc.ResponseFuture<$0.SuggestKeywordThemesResponse> suggestKeywordThemes(
      $0.SuggestKeywordThemesRequest request,
      {$grpc.CallOptions? options}) {
...
abstract class SmartCampaignSuggestServiceBase extends $grpc.Service {
  ...
  SmartCampaignSuggestServiceBase() {
    ...
    $addMethod($grpc.ServiceMethod<$0.SuggestKeywordThemesRequest,
            $0.SuggestKeywordThemesResponse>(
        'SuggestKeywordThemes',
        suggestKeywordThemes_Pre,
        false,
        false,
        ($core.List<$core.int> value) =>
            $0.SuggestKeywordThemesRequest.fromBuffer(value),
        ($0.SuggestKeywordThemesResponse value) => value.writeToBuffer()));
  }
  ...
  $async.Future<$0.SuggestKeywordThemesResponse> suggestKeywordThemes_Pre(
      $grpc.ServiceCall call,
      $async.Future<$0.SuggestKeywordThemesRequest> request) async {
  ...
  $async.Future<$0.SuggestKeywordThemesResponse> suggestKeywordThemes(
      $grpc.ServiceCall call, $0.SuggestKeywordThemesRequest request);
}

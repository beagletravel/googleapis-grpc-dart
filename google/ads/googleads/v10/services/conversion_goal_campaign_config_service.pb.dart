...
class MutateConversionGoalCampaignConfigsRequest extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'MutateConversionGoalCampaignConfigsRequest', package: const $pb.PackageName(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'google.ads.googleads.v10.services'), createEmptyInstance: create)
    ..aOS(1, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'customerId')
    ..pc<ConversionGoalCampaignConfigOperation>(2, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'operations', $pb.PbFieldType.PM, subBuilder: ConversionGoalCampaignConfigOperation.create)
  ...
  'Will be removed in next major version')
  MutateConversionGoalCampaignConfigsRequest copyWith(void Function(MutateConversionGoalCampaignConfigsRequest) updates) => super.copyWith((message) => updates(message as MutateConversionGoalCampaignConfigsRequest)) as MutateConversionGoalCampaignConfigsRequest; // ignore: deprecated_member_use
...
class ConversionGoalCampaignConfigOperation extends $pb.GeneratedMessage {
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'ConversionGoalCampaignConfigOperation', package: const $pb.PackageName(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'google.ads.googleads.v10.services'), createEmptyInstance: create)
    ..oo(0, [1])
    ..aOM<$1.ConversionGoalCampaignConfig>(1, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'update', subBuilder: $1.ConversionGoalCampaignConfig.create)
  ...
  'Use [GeneratedMessageGenericExtensions.rebuild] instead. '
  'Will be removed in next major version')
  ConversionGoalCampaignConfigOperation copyWith(void Function(ConversionGoalCampaignConfigOperation) updates) => super.copyWith((message) => updates(message as ConversionGoalCampaignConfigOperation)) as ConversionGoalCampaignConfigOperation; // ignore: deprecated_member_use
  $pb.BuilderInfo get info_ => _i;
  @$core.pragma('dart2js:noInline')
  ...
  @$pb.TagNumber(1)
  set update($1.ConversionGoalCampaignConfig v) { setField(1, v); }
  @$pb.TagNumber(1)
...
class MutateConversionGoalCampaignConfigsResponse extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'MutateConversionGoalCampaignConfigsResponse', package: const $pb.PackageName(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'google.ads.googleads.v10.services'), createEmptyInstance: create)
    ..pc<MutateConversionGoalCampaignConfigResult>(1, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'results', $pb.PbFieldType.PM, subBuilder: MutateConversionGoalCampaignConfigResult.create)
    ..hasRequiredFields = false
  ;
  ...
  'Use [GeneratedMessageGenericExtensions.rebuild] instead. '
  'Will be removed in next major version')
  MutateConversionGoalCampaignConfigsResponse copyWith(void Function(MutateConversionGoalCampaignConfigsResponse) updates) => super.copyWith((message) => updates(message as MutateConversionGoalCampaignConfigsResponse)) as MutateConversionGoalCampaignConfigsResponse; // ignore: deprecated_member_use
  $pb.BuilderInfo get info_ => _i;
  @$core.pragma('dart2js:noInline')
...
class MutateConversionGoalCampaignConfigResult extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'MutateConversionGoalCampaignConfigResult', package: const $pb.PackageName(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'google.ads.googleads.v10.services'), createEmptyInstance: create)
    ..aOS(1, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'resourceName')
    ..aOM<$1.ConversionGoalCampaignConfig>(2, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'conversionGoalCampaignConfig', subBuilder: $1.ConversionGoalCampaignConfig.create)
    ..hasRequiredFields = false
  ;
  ...
  'Use [GeneratedMessageGenericExtensions.rebuild] instead. '
  'Will be removed in next major version')
  MutateConversionGoalCampaignConfigResult copyWith(void Function(MutateConversionGoalCampaignConfigResult) updates) => super.copyWith((message) => updates(message as MutateConversionGoalCampaignConfigResult)) as MutateConversionGoalCampaignConfigResult; // ignore: deprecated_member_use
  $pb.BuilderInfo get info_ => _i;
  @$core.pragma('dart2js:noInline')
  ...
  @$pb.TagNumber(2)
  set conversionGoalCampaignConfig($1.ConversionGoalCampaignConfig v) { setField(2, v); }
  @$pb.TagNumber(2)
  $core.bool hasConversionGoalCampaignConfig() => $_has(1);
  @$pb.TagNumber(2)
  void clearConversionGoalCampaignConfig() => clearField(2);
  @$pb.TagNumber(2)
  $1.ConversionGoalCampaignConfig ensureConversionGoalCampaignConfig() => $_ensure(1);
}

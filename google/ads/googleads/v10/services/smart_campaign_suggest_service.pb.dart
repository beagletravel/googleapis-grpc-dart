...
import '../resources/keyword_theme_constant.pb.dart' as $3;
...
class SuggestSmartCampaignBudgetOptionsRequest extends $pb.GeneratedMessage {
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'SuggestSmartCampaignBudgetOptionsRequest', package: const $pb.PackageName(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'google.ads.googleads.v10.services'), createEmptyInstance: create)
    ..oo(0, [2, 3])
    ...
    ..aOM<SmartCampaignSuggestionInfo>(3, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'suggestionInfo', subBuilder: SmartCampaignSuggestionInfo.create)
  ...
  'Will be removed in next major version')
  SuggestSmartCampaignBudgetOptionsRequest copyWith(void Function(SuggestSmartCampaignBudgetOptionsRequest) updates) => super.copyWith((message) => updates(message as SuggestSmartCampaignBudgetOptionsRequest)) as SuggestSmartCampaignBudgetOptionsRequest; // ignore: deprecated_member_use
...
class SmartCampaignSuggestionInfo_LocationList extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'SmartCampaignSuggestionInfo.LocationList', package: const $pb.PackageName(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'google.ads.googleads.v10.services'), createEmptyInstance: create)
    ..pc<$1.LocationInfo>(1, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'locations', $pb.PbFieldType.PM, subBuilder: $1.LocationInfo.create)
    ..hasRequiredFields = false
  ;
  ...
  'Use [GeneratedMessageGenericExtensions.rebuild] instead. '
  'Will be removed in next major version')
  SmartCampaignSuggestionInfo_LocationList copyWith(void Function(SmartCampaignSuggestionInfo_LocationList) updates) => super.copyWith((message) => updates(message as SmartCampaignSuggestionInfo_LocationList)) as SmartCampaignSuggestionInfo_LocationList; // ignore: deprecated_member_use
  $pb.BuilderInfo get info_ => _i;
  @$core.pragma('dart2js:noInline')
...
class SmartCampaignSuggestionInfo_BusinessContext extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'SmartCampaignSuggestionInfo.BusinessContext', package: const $pb.PackageName(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'google.ads.googleads.v10.services'), createEmptyInstance: create)
  ...
  'Use [GeneratedMessageGenericExtensions.rebuild] instead. '
  'Will be removed in next major version')
  SmartCampaignSuggestionInfo_BusinessContext copyWith(void Function(SmartCampaignSuggestionInfo_BusinessContext) updates) => super.copyWith((message) => updates(message as SmartCampaignSuggestionInfo_BusinessContext)) as SmartCampaignSuggestionInfo_BusinessContext; // ignore: deprecated_member_use
  $pb.BuilderInfo get info_ => _i;
  @$core.pragma('dart2js:noInline')
...
class SmartCampaignSuggestionInfo extends $pb.GeneratedMessage {
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'SmartCampaignSuggestionInfo', package: const $pb.PackageName(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'google.ads.googleads.v10.services'), createEmptyInstance: create)
    ..oo(0, [2, 8])
    ..oo(1, [4, 5])
    ..aOS(1, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'finalUrl')
    ..aInt64(2, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'businessLocationId')
    ..aOS(3, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'languageCode')
    ..aOM<SmartCampaignSuggestionInfo_LocationList>(4, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'locationList', subBuilder: SmartCampaignSuggestionInfo_LocationList.create)
    ..aOM<$1.ProximityInfo>(5, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'proximity', subBuilder: $1.ProximityInfo.create)
    ..pc<$1.AdScheduleInfo>(6, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'adSchedules', $pb.PbFieldType.PM, subBuilder: $1.AdScheduleInfo.create)
    ..pc<$1.KeywordThemeInfo>(7, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'keywordThemes', $pb.PbFieldType.PM, subBuilder: $1.KeywordThemeInfo.create)
    ..aOM<SmartCampaignSuggestionInfo_BusinessContext>(8, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'businessContext', subBuilder: SmartCampaignSuggestionInfo_BusinessContext.create)
    ..hasRequiredFields = false
  ;
  ...
  'Use [GeneratedMessageGenericExtensions.rebuild] instead. '
  'Will be removed in next major version')
  SmartCampaignSuggestionInfo copyWith(void Function(SmartCampaignSuggestionInfo) updates) => super.copyWith((message) => updates(message as SmartCampaignSuggestionInfo)) as SmartCampaignSuggestionInfo; // ignore: deprecated_member_use
  $pb.BuilderInfo get info_ => _i;
  @$core.pragma('dart2js:noInline')
  ...
  @$pb.TagNumber(2)
  set businessLocationId($fixnum.Int64 v) { $_setInt64(1, v); }
  @$pb.TagNumber(2)
  ...
  @$pb.TagNumber(5)
  set proximity($1.ProximityInfo v) { setField(5, v); }
  @$pb.TagNumber(5)
  ...
  @$pb.TagNumber(8)
  SmartCampaignSuggestionInfo_BusinessContext ensureBusinessContext() => $_ensure(7);
}

class SuggestSmartCampaignBudgetOptionsResponse_Metrics extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'SuggestSmartCampaignBudgetOptionsResponse.Metrics', package: const $pb.PackageName(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'google.ads.googleads.v10.services'), createEmptyInstance: create)
    ..aInt64(1, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'minDailyClicks')
    ..aInt64(2, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'maxDailyClicks')
    ..hasRequiredFields = false
  ;
  ...
  'Use [GeneratedMessageGenericExtensions.rebuild] instead. '
  'Will be removed in next major version')
  SuggestSmartCampaignBudgetOptionsResponse_Metrics copyWith(void Function(SuggestSmartCampaignBudgetOptionsResponse_Metrics) updates) => super.copyWith((message) => updates(message as SuggestSmartCampaignBudgetOptionsResponse_Metrics)) as SuggestSmartCampaignBudgetOptionsResponse_Metrics; // ignore: deprecated_member_use
  $pb.BuilderInfo get info_ => _i;
  @$core.pragma('dart2js:noInline')
...
class SuggestSmartCampaignBudgetOptionsResponse_BudgetOption extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'SuggestSmartCampaignBudgetOptionsResponse.BudgetOption', package: const $pb.PackageName(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'google.ads.googleads.v10.services'), createEmptyInstance: create)
    ..aInt64(1, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'dailyAmountMicros')
    ..aOM<SuggestSmartCampaignBudgetOptionsResponse_Metrics>(2, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'metrics', subBuilder: SuggestSmartCampaignBudgetOptionsResponse_Metrics.create)
    ..hasRequiredFields = false
  ;
  ...
  'Use [GeneratedMessageGenericExtensions.rebuild] instead. '
  'Will be removed in next major version')
  SuggestSmartCampaignBudgetOptionsResponse_BudgetOption copyWith(void Function(SuggestSmartCampaignBudgetOptionsResponse_BudgetOption) updates) => super.copyWith((message) => updates(message as SuggestSmartCampaignBudgetOptionsResponse_BudgetOption)) as SuggestSmartCampaignBudgetOptionsResponse_BudgetOption; // ignore: deprecated_member_use
  $pb.BuilderInfo get info_ => _i;
  @$core.pragma('dart2js:noInline')
...
class SuggestSmartCampaignBudgetOptionsResponse extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'SuggestSmartCampaignBudgetOptionsResponse', package: const $pb.PackageName(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'google.ads.googleads.v10.services'), createEmptyInstance: create)
    ..aOM<SuggestSmartCampaignBudgetOptionsResponse_BudgetOption>(1, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'low', subBuilder: SuggestSmartCampaignBudgetOptionsResponse_BudgetOption.create)
    ..aOM<SuggestSmartCampaignBudgetOptionsResponse_BudgetOption>(2, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'recommended', subBuilder: SuggestSmartCampaignBudgetOptionsResponse_BudgetOption.create)
    ..aOM<SuggestSmartCampaignBudgetOptionsResponse_BudgetOption>(3, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'high', subBuilder: SuggestSmartCampaignBudgetOptionsResponse_BudgetOption.create)
    ..hasRequiredFields = false
  ;
  ...
  'Use [GeneratedMessageGenericExtensions.rebuild] instead. '
  'Will be removed in next major version')
  SuggestSmartCampaignBudgetOptionsResponse copyWith(void Function(SuggestSmartCampaignBudgetOptionsResponse) updates) => super.copyWith((message) => updates(message as SuggestSmartCampaignBudgetOptionsResponse)) as SuggestSmartCampaignBudgetOptionsResponse; // ignore: deprecated_member_use
  $pb.BuilderInfo get info_ => _i;
  @$core.pragma('dart2js:noInline')
...
class SuggestSmartCampaignAdRequest extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'SuggestSmartCampaignAdRequest', package: const $pb.PackageName(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'google.ads.googleads.v10.services'), createEmptyInstance: create)
    ..aOS(1, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'customerId')
    ..aOM<SmartCampaignSuggestionInfo>(2, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'suggestionInfo', subBuilder: SmartCampaignSuggestionInfo.create)
    ..hasRequiredFields = false
  ;
  ...
  'Use [GeneratedMessageGenericExtensions.rebuild] instead. '
  'Will be removed in next major version')
  SuggestSmartCampaignAdRequest copyWith(void Function(SuggestSmartCampaignAdRequest) updates) => super.copyWith((message) => updates(message as SuggestSmartCampaignAdRequest)) as SuggestSmartCampaignAdRequest; // ignore: deprecated_member_use
  $pb.BuilderInfo get info_ => _i;
  @$core.pragma('dart2js:noInline')
...
class SuggestSmartCampaignAdResponse extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'SuggestSmartCampaignAdResponse', package: const $pb.PackageName(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'google.ads.googleads.v10.services'), createEmptyInstance: create)
    ..aOM<$2.SmartCampaignAdInfo>(1, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'adInfo', subBuilder: $2.SmartCampaignAdInfo.create)
    ..hasRequiredFields = false
  ;
  ...
  'Use [GeneratedMessageGenericExtensions.rebuild] instead. '
  'Will be removed in next major version')
  SuggestSmartCampaignAdResponse copyWith(void Function(SuggestSmartCampaignAdResponse) updates) => super.copyWith((message) => updates(message as SuggestSmartCampaignAdResponse)) as SuggestSmartCampaignAdResponse; // ignore: deprecated_member_use
  $pb.BuilderInfo get info_ => _i;
  @$core.pragma('dart2js:noInline')
  ...
  @$pb.TagNumber(1)
  set adInfo($2.SmartCampaignAdInfo v) { setField(1, v); }
  @$pb.TagNumber(1)
...
class SuggestKeywordThemesRequest extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'SuggestKeywordThemesRequest', package: const $pb.PackageName(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'google.ads.googleads.v10.services'), createEmptyInstance: create)
    ..aOS(1, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'customerId')
    ..aOM<SmartCampaignSuggestionInfo>(2, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'suggestionInfo', subBuilder: SmartCampaignSuggestionInfo.create)
    ..hasRequiredFields = false
  ;
  ...
  'Use [GeneratedMessageGenericExtensions.rebuild] instead. '
  'Will be removed in next major version')
  SuggestKeywordThemesRequest copyWith(void Function(SuggestKeywordThemesRequest) updates) => super.copyWith((message) => updates(message as SuggestKeywordThemesRequest)) as SuggestKeywordThemesRequest; // ignore: deprecated_member_use
  $pb.BuilderInfo get info_ => _i;
  @$core.pragma('dart2js:noInline')
...
class SuggestKeywordThemesResponse extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'SuggestKeywordThemesResponse', package: const $pb.PackageName(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'google.ads.googleads.v10.services'), createEmptyInstance: create)
    ..pc<$3.KeywordThemeConstant>(1, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'keywordThemes', $pb.PbFieldType.PM, subBuilder: $3.KeywordThemeConstant.create)
    ..hasRequiredFields = false
  ;

  SuggestKeywordThemesResponse._() : super();
  factory SuggestKeywordThemesResponse({
    $core.Iterable<$3.KeywordThemeConstant>? keywordThemes,
  }) {
    final _result = create();
    if (keywordThemes != null) {
      _result.keywordThemes.addAll(keywordThemes);
  ...
  'Use [GeneratedMessageGenericExtensions.rebuild] instead. '
  'Will be removed in next major version')
  SuggestKeywordThemesResponse copyWith(void Function(SuggestKeywordThemesResponse) updates) => super.copyWith((message) => updates(message as SuggestKeywordThemesResponse)) as SuggestKeywordThemesResponse; // ignore: deprecated_member_use
  $pb.BuilderInfo get info_ => _i;
  @$core.pragma('dart2js:noInline')
  ...
  @$pb.TagNumber(1)
  $core.List<$3.KeywordThemeConstant> get keywordThemes => $_getList(0);
}

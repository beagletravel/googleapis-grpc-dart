...
class ListInvoicesRequest extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'ListInvoicesRequest', package: const $pb.PackageName(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'google.ads.googleads.v10.services'), createEmptyInstance: create)
    ..aOS(1, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'customerId')
    ..aOS(2, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'billingSetup')
    ..aOS(3, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'issueYear')
    ..e<$2.MonthOfYearEnum_MonthOfYear>(4, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'issueMonth', $pb.PbFieldType.OE, defaultOrMaker: $2.MonthOfYearEnum_MonthOfYear.UNSPECIFIED, valueOf: $2.MonthOfYearEnum_MonthOfYear.valueOf, enumValues: $2.MonthOfYearEnum_MonthOfYear.values)
  ...
  @$pb.TagNumber(4)
  set issueMonth($2.MonthOfYearEnum_MonthOfYear v) { setField(4, v); }
  @$pb.TagNumber(4)
...
class ListInvoicesResponse extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'ListInvoicesResponse', package: const $pb.PackageName(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'google.ads.googleads.v10.services'), createEmptyInstance: create)
    ..pc<$1.Invoice>(1, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'invoices', $pb.PbFieldType.PM, subBuilder: $1.Invoice.create)
    ..hasRequiredFields = false
  ;

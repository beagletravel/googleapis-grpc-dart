...
import '../resources/batch_job.pb.dart' as $81;
import 'google_ads_service.pb.dart' as $79;
import '../../../../rpc/status.pb.dart' as $82;

import '../enums/response_content_type.pbenum.dart' as $83;

class MutateBatchJobRequest extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'MutateBatchJobRequest', package: const $pb.PackageName(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'google.ads.googleads.v10.services'), createEmptyInstance: create)
...
class BatchJobOperation extends $pb.GeneratedMessage {
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'BatchJobOperation', package: const $pb.PackageName(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'google.ads.googleads.v10.services'), createEmptyInstance: create)
    ..oo(0, [1, 4])
    ..aOM<$81.BatchJob>(1, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'create', subBuilder: $81.BatchJob.create)
    ..aOS(4, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'remove')
    ..hasRequiredFields = false
  ;

  BatchJobOperation._() : super();
  factory BatchJobOperation({
    $81.BatchJob? create_1,
    $core.String? remove,
  }) {
    final _result = create();
    if (create_1 != null) {
  ...
  @$pb.TagNumber(1)
  $81.BatchJob get create_1 => $_getN(0);
  @$pb.TagNumber(1)
  set create_1($81.BatchJob v) { setField(1, v); }
  @$pb.TagNumber(1)
  $core.bool hasCreate_1() => $_has(0);
  @$pb.TagNumber(1)
  void clearCreate_1() => clearField(1);
  @$pb.TagNumber(1)
  $81.BatchJob ensureCreate_1() => $_ensure(0);
...
class MutateBatchJobResponse extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'MutateBatchJobResponse', package: const $pb.PackageName(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'google.ads.googleads.v10.services'), createEmptyInstance: create)
...
class MutateBatchJobResult extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'MutateBatchJobResult', package: const $pb.PackageName(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'google.ads.googleads.v10.services'), createEmptyInstance: create)
...
class RunBatchJobRequest extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'RunBatchJobRequest', package: const $pb.PackageName(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'google.ads.googleads.v10.services'), createEmptyInstance: create)
    ..aOS(1, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'resourceName')
    ..hasRequiredFields = false
  ;
...
class AddBatchJobOperationsRequest extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'AddBatchJobOperationsRequest', package: const $pb.PackageName(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'google.ads.googleads.v10.services'), createEmptyInstance: create)
    ..aOS(1, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'resourceName')
    ..aOS(2, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'sequenceToken')
    ..pc<$79.MutateOperation>(3, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'mutateOperations', $pb.PbFieldType.PM, subBuilder: $79.MutateOperation.create)
    ..hasRequiredFields = false
  ;
  ...
  factory AddBatchJobOperationsRequest({
    ...
    $core.Iterable<$79.MutateOperation>? mutateOperations,
  }) {
    final _result = create();
    if (resourceName != null) {
      _result.resourceName = resourceName;
  ...
  @$pb.TagNumber(3)
  $core.List<$79.MutateOperation> get mutateOperations => $_getList(2);
}

class AddBatchJobOperationsResponse extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'AddBatchJobOperationsResponse', package: const $pb.PackageName(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'google.ads.googleads.v10.services'), createEmptyInstance: create)
...
class ListBatchJobResultsRequest extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'ListBatchJobResultsRequest', package: const $pb.PackageName(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'google.ads.googleads.v10.services'), createEmptyInstance: create)
    ..aOS(1, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'resourceName')
    ...
    ..e<$83.ResponseContentTypeEnum_ResponseContentType>(4, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'responseContentType', $pb.PbFieldType.OE, defaultOrMaker: $83.ResponseContentTypeEnum_ResponseContentType.UNSPECIFIED, valueOf: $83.ResponseContentTypeEnum_ResponseContentType.valueOf, enumValues: $83.ResponseContentTypeEnum_ResponseContentType.values)
    ..hasRequiredFields = false
  ;
  ...
  factory ListBatchJobResultsRequest({
    ...
    $core.int? pageSize,
    $83.ResponseContentTypeEnum_ResponseContentType? responseContentType,
  }) {
    final _result = create();
    if (resourceName != null) {
      _result.resourceName = resourceName;
  ...
  @$pb.TagNumber(4)
  $83.ResponseContentTypeEnum_ResponseContentType get responseContentType => $_getN(3);
  @$pb.TagNumber(4)
  set responseContentType($83.ResponseContentTypeEnum_ResponseContentType v) { setField(4, v); }
  @$pb.TagNumber(4)
...
class ListBatchJobResultsResponse extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'ListBatchJobResultsResponse', package: const $pb.PackageName(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'google.ads.googleads.v10.services'), createEmptyInstance: create)
...
class BatchJobResult extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'BatchJobResult', package: const $pb.PackageName(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'google.ads.googleads.v10.services'), createEmptyInstance: create)
    ..aInt64(1, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'operationIndex')
    ..aOM<$79.MutateOperationResponse>(2, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'mutateOperationResponse', subBuilder: $79.MutateOperationResponse.create)
    ..aOM<$82.Status>(3, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'status', subBuilder: $82.Status.create)
    ..hasRequiredFields = false
  ;
  ...
  factory BatchJobResult({
    ...
    $79.MutateOperationResponse? mutateOperationResponse,
    $82.Status? status,
  }) {
    final _result = create();
  ...
  @$pb.TagNumber(2)
  $79.MutateOperationResponse get mutateOperationResponse => $_getN(1);
  @$pb.TagNumber(2)
  set mutateOperationResponse($79.MutateOperationResponse v) { setField(2, v); }
  @$pb.TagNumber(2)
  $core.bool hasMutateOperationResponse() => $_has(1);
  @$pb.TagNumber(2)
  void clearMutateOperationResponse() => clearField(2);
  @$pb.TagNumber(2)
  $79.MutateOperationResponse ensureMutateOperationResponse() => $_ensure(1);

  @$pb.TagNumber(3)
  $82.Status get status => $_getN(2);
  @$pb.TagNumber(3)
  set status($82.Status v) { setField(3, v); }
  @$pb.TagNumber(3)
  $core.bool hasStatus() => $_has(2);
  @$pb.TagNumber(3)
  void clearStatus() => clearField(3);
  @$pb.TagNumber(3)
  $82.Status ensureStatus() => $_ensure(2);
}

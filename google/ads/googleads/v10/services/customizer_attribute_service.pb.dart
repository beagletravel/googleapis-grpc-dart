...
class MutateCustomizerAttributesRequest extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'MutateCustomizerAttributesRequest', package: const $pb.PackageName(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'google.ads.googleads.v10.services'), createEmptyInstance: create)
    ..aOS(1, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'customerId')
    ..pc<CustomizerAttributeOperation>(2, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'operations', $pb.PbFieldType.PM, subBuilder: CustomizerAttributeOperation.create)
  ...
  'Will be removed in next major version')
  MutateCustomizerAttributesRequest copyWith(void Function(MutateCustomizerAttributesRequest) updates) => super.copyWith((message) => updates(message as MutateCustomizerAttributesRequest)) as MutateCustomizerAttributesRequest; // ignore: deprecated_member_use
...
class CustomizerAttributeOperation extends $pb.GeneratedMessage {
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'CustomizerAttributeOperation', package: const $pb.PackageName(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'google.ads.googleads.v10.services'), createEmptyInstance: create)
    ..oo(0, [1, 2])
    ..aOM<$1.CustomizerAttribute>(1, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'create', subBuilder: $1.CustomizerAttribute.create)
  ...
  'Use [GeneratedMessageGenericExtensions.rebuild] instead. '
  'Will be removed in next major version')
  CustomizerAttributeOperation copyWith(void Function(CustomizerAttributeOperation) updates) => super.copyWith((message) => updates(message as CustomizerAttributeOperation)) as CustomizerAttributeOperation; // ignore: deprecated_member_use
  $pb.BuilderInfo get info_ => _i;
  @$core.pragma('dart2js:noInline')
  ...
  @$pb.TagNumber(1)
  set create_1($1.CustomizerAttribute v) { setField(1, v); }
  @$pb.TagNumber(1)
...
class MutateCustomizerAttributesResponse extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'MutateCustomizerAttributesResponse', package: const $pb.PackageName(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'google.ads.googleads.v10.services'), createEmptyInstance: create)
    ..pc<MutateCustomizerAttributeResult>(1, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'results', $pb.PbFieldType.PM, subBuilder: MutateCustomizerAttributeResult.create)
  ...
  'Use [GeneratedMessageGenericExtensions.rebuild] instead. '
  'Will be removed in next major version')
  MutateCustomizerAttributesResponse copyWith(void Function(MutateCustomizerAttributesResponse) updates) => super.copyWith((message) => updates(message as MutateCustomizerAttributesResponse)) as MutateCustomizerAttributesResponse; // ignore: deprecated_member_use
  $pb.BuilderInfo get info_ => _i;
  @$core.pragma('dart2js:noInline')
...
class MutateCustomizerAttributeResult extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'MutateCustomizerAttributeResult', package: const $pb.PackageName(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'google.ads.googleads.v10.services'), createEmptyInstance: create)
    ..aOS(1, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'resourceName')
    ..aOM<$1.CustomizerAttribute>(2, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'customizerAttribute', subBuilder: $1.CustomizerAttribute.create)
    ..hasRequiredFields = false
  ;
  ...
  'Use [GeneratedMessageGenericExtensions.rebuild] instead. '
  'Will be removed in next major version')
  MutateCustomizerAttributeResult copyWith(void Function(MutateCustomizerAttributeResult) updates) => super.copyWith((message) => updates(message as MutateCustomizerAttributeResult)) as MutateCustomizerAttributeResult; // ignore: deprecated_member_use
  $pb.BuilderInfo get info_ => _i;
  @$core.pragma('dart2js:noInline')
  ...
  @$pb.TagNumber(2)
  set customizerAttribute($1.CustomizerAttribute v) { setField(2, v); }
  @$pb.TagNumber(2)

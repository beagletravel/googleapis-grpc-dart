...
class MutateAdGroupCriterionCustomizersRequest extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'MutateAdGroupCriterionCustomizersRequest', package: const $pb.PackageName(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'google.ads.googleads.v10.services'), createEmptyInstance: create)
    ..aOS(1, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'customerId')
    ..pc<AdGroupCriterionCustomizerOperation>(2, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'operations', $pb.PbFieldType.PM, subBuilder: AdGroupCriterionCustomizerOperation.create)
  ...
  'Will be removed in next major version')
  MutateAdGroupCriterionCustomizersRequest copyWith(void Function(MutateAdGroupCriterionCustomizersRequest) updates) => super.copyWith((message) => updates(message as MutateAdGroupCriterionCustomizersRequest)) as MutateAdGroupCriterionCustomizersRequest; // ignore: deprecated_member_use
...
class AdGroupCriterionCustomizerOperation extends $pb.GeneratedMessage {
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'AdGroupCriterionCustomizerOperation', package: const $pb.PackageName(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'google.ads.googleads.v10.services'), createEmptyInstance: create)
    ..oo(0, [1, 2])
    ..aOM<$1.AdGroupCriterionCustomizer>(1, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'create', subBuilder: $1.AdGroupCriterionCustomizer.create)
  ...
  'Use [GeneratedMessageGenericExtensions.rebuild] instead. '
  'Will be removed in next major version')
  AdGroupCriterionCustomizerOperation copyWith(void Function(AdGroupCriterionCustomizerOperation) updates) => super.copyWith((message) => updates(message as AdGroupCriterionCustomizerOperation)) as AdGroupCriterionCustomizerOperation; // ignore: deprecated_member_use
  $pb.BuilderInfo get info_ => _i;
  @$core.pragma('dart2js:noInline')
  ...
  @$pb.TagNumber(1)
  set create_1($1.AdGroupCriterionCustomizer v) { setField(1, v); }
  @$pb.TagNumber(1)
...
class MutateAdGroupCriterionCustomizersResponse extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'MutateAdGroupCriterionCustomizersResponse', package: const $pb.PackageName(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'google.ads.googleads.v10.services'), createEmptyInstance: create)
    ..pc<MutateAdGroupCriterionCustomizerResult>(1, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'results', $pb.PbFieldType.PM, subBuilder: MutateAdGroupCriterionCustomizerResult.create)
  ...
  'Use [GeneratedMessageGenericExtensions.rebuild] instead. '
  'Will be removed in next major version')
  MutateAdGroupCriterionCustomizersResponse copyWith(void Function(MutateAdGroupCriterionCustomizersResponse) updates) => super.copyWith((message) => updates(message as MutateAdGroupCriterionCustomizersResponse)) as MutateAdGroupCriterionCustomizersResponse; // ignore: deprecated_member_use
  $pb.BuilderInfo get info_ => _i;
  @$core.pragma('dart2js:noInline')
...
class MutateAdGroupCriterionCustomizerResult extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'MutateAdGroupCriterionCustomizerResult', package: const $pb.PackageName(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'google.ads.googleads.v10.services'), createEmptyInstance: create)
    ..aOS(1, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'resourceName')
    ..aOM<$1.AdGroupCriterionCustomizer>(2, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'adGroupCriterionCustomizer', subBuilder: $1.AdGroupCriterionCustomizer.create)
    ..hasRequiredFields = false
  ;
  ...
  'Use [GeneratedMessageGenericExtensions.rebuild] instead. '
  'Will be removed in next major version')
  MutateAdGroupCriterionCustomizerResult copyWith(void Function(MutateAdGroupCriterionCustomizerResult) updates) => super.copyWith((message) => updates(message as MutateAdGroupCriterionCustomizerResult)) as MutateAdGroupCriterionCustomizerResult; // ignore: deprecated_member_use
  $pb.BuilderInfo get info_ => _i;
  @$core.pragma('dart2js:noInline')
  ...
  @$pb.TagNumber(2)
  set adGroupCriterionCustomizer($1.AdGroupCriterionCustomizer v) { setField(2, v); }
  @$pb.TagNumber(2)
  $core.bool hasAdGroupCriterionCustomizer() => $_has(1);
  @$pb.TagNumber(2)
  void clearAdGroupCriterionCustomizer() => clearField(2);
  @$pb.TagNumber(2)
  $1.AdGroupCriterionCustomizer ensureAdGroupCriterionCustomizer() => $_ensure(1);
}

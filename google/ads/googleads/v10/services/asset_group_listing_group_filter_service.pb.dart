...
class MutateAssetGroupListingGroupFiltersRequest extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'MutateAssetGroupListingGroupFiltersRequest', package: const $pb.PackageName(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'google.ads.googleads.v10.services'), createEmptyInstance: create)
    ..aOS(1, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'customerId')
    ..pc<AssetGroupListingGroupFilterOperation>(2, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'operations', $pb.PbFieldType.PM, subBuilder: AssetGroupListingGroupFilterOperation.create)
    ..aOB(3, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'validateOnly')
    ..e<$3.ResponseContentTypeEnum_ResponseContentType>(4, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'responseContentType', $pb.PbFieldType.OE, defaultOrMaker: $3.ResponseContentTypeEnum_ResponseContentType.UNSPECIFIED, valueOf: $3.ResponseContentTypeEnum_ResponseContentType.valueOf, enumValues: $3.ResponseContentTypeEnum_ResponseContentType.values)
  ...
  'Will be removed in next major version')
  MutateAssetGroupListingGroupFiltersRequest copyWith(void Function(MutateAssetGroupListingGroupFiltersRequest) updates) => super.copyWith((message) => updates(message as MutateAssetGroupListingGroupFiltersRequest)) as MutateAssetGroupListingGroupFiltersRequest; // ignore: deprecated_member_use
  ...
  @$pb.TagNumber(4)
  set responseContentType($3.ResponseContentTypeEnum_ResponseContentType v) { setField(4, v); }
  @$pb.TagNumber(4)
...
class AssetGroupListingGroupFilterOperation extends $pb.GeneratedMessage {
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'AssetGroupListingGroupFilterOperation', package: const $pb.PackageName(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'google.ads.googleads.v10.services'), createEmptyInstance: create)
    ..oo(0, [1, 2, 3])
    ..aOM<$1.AssetGroupListingGroupFilter>(1, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'create', subBuilder: $1.AssetGroupListingGroupFilter.create)
    ..aOM<$1.AssetGroupListingGroupFilter>(2, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'update', subBuilder: $1.AssetGroupListingGroupFilter.create)
  ...
  'Use [GeneratedMessageGenericExtensions.rebuild] instead. '
  'Will be removed in next major version')
  AssetGroupListingGroupFilterOperation copyWith(void Function(AssetGroupListingGroupFilterOperation) updates) => super.copyWith((message) => updates(message as AssetGroupListingGroupFilterOperation)) as AssetGroupListingGroupFilterOperation; // ignore: deprecated_member_use
  $pb.BuilderInfo get info_ => _i;
  @$core.pragma('dart2js:noInline')
  ...
  @$pb.TagNumber(1)
  set create_1($1.AssetGroupListingGroupFilter v) { setField(1, v); }
  @$pb.TagNumber(1)
  ...
  @$pb.TagNumber(2)
  set update($1.AssetGroupListingGroupFilter v) { setField(2, v); }
  @$pb.TagNumber(2)
...
class MutateAssetGroupListingGroupFiltersResponse extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'MutateAssetGroupListingGroupFiltersResponse', package: const $pb.PackageName(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'google.ads.googleads.v10.services'), createEmptyInstance: create)
    ..pc<MutateAssetGroupListingGroupFilterResult>(1, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'results', $pb.PbFieldType.PM, subBuilder: MutateAssetGroupListingGroupFilterResult.create)
    ..hasRequiredFields = false
  ;
  ...
  'Use [GeneratedMessageGenericExtensions.rebuild] instead. '
  'Will be removed in next major version')
  MutateAssetGroupListingGroupFiltersResponse copyWith(void Function(MutateAssetGroupListingGroupFiltersResponse) updates) => super.copyWith((message) => updates(message as MutateAssetGroupListingGroupFiltersResponse)) as MutateAssetGroupListingGroupFiltersResponse; // ignore: deprecated_member_use
  $pb.BuilderInfo get info_ => _i;
  @$core.pragma('dart2js:noInline')
...
class MutateAssetGroupListingGroupFilterResult extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'MutateAssetGroupListingGroupFilterResult', package: const $pb.PackageName(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'google.ads.googleads.v10.services'), createEmptyInstance: create)
    ..aOS(1, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'resourceName')
    ..aOM<$1.AssetGroupListingGroupFilter>(2, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'assetGroupListingGroupFilter', subBuilder: $1.AssetGroupListingGroupFilter.create)
    ..hasRequiredFields = false
  ;
  ...
  'Use [GeneratedMessageGenericExtensions.rebuild] instead. '
  'Will be removed in next major version')
  MutateAssetGroupListingGroupFilterResult copyWith(void Function(MutateAssetGroupListingGroupFilterResult) updates) => super.copyWith((message) => updates(message as MutateAssetGroupListingGroupFilterResult)) as MutateAssetGroupListingGroupFilterResult; // ignore: deprecated_member_use
  $pb.BuilderInfo get info_ => _i;
  @$core.pragma('dart2js:noInline')
  ...
  @$pb.TagNumber(2)
  set assetGroupListingGroupFilter($1.AssetGroupListingGroupFilter v) { setField(2, v); }
  @$pb.TagNumber(2)
  $core.bool hasAssetGroupListingGroupFilter() => $_has(1);
  @$pb.TagNumber(2)
  void clearAssetGroupListingGroupFilter() => clearField(2);
  @$pb.TagNumber(2)
  $1.AssetGroupListingGroupFilter ensureAssetGroupListingGroupFilter() => $_ensure(1);
}

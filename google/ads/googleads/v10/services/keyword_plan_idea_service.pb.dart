...
class GenerateKeywordIdeasRequest extends $pb.GeneratedMessage {
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'GenerateKeywordIdeasRequest', package: const $pb.PackageName(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'google.ads.googleads.v10.services'), createEmptyInstance: create)
    ..oo(0, [2, 3, 5, 11])
    ..aOS(1, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'customerId')
    ..aOM<KeywordAndUrlSeed>(2, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'keywordAndUrlSeed', subBuilder: KeywordAndUrlSeed.create)
    ..aOM<KeywordSeed>(3, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'keywordSeed', subBuilder: KeywordSeed.create)
    ..aOM<UrlSeed>(5, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'urlSeed', subBuilder: UrlSeed.create)
    ..e<$2.KeywordPlanNetworkEnum_KeywordPlanNetwork>(9, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'keywordPlanNetwork', $pb.PbFieldType.OE, defaultOrMaker: $2.KeywordPlanNetworkEnum_KeywordPlanNetwork.UNSPECIFIED, valueOf: $2.KeywordPlanNetworkEnum_KeywordPlanNetwork.valueOf, enumValues: $2.KeywordPlanNetworkEnum_KeywordPlanNetwork.values)
    ..aOB(10, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'includeAdultKeywords')
    ..aOM<SiteSeed>(11, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'siteSeed', subBuilder: SiteSeed.create)
    ..aOS(12, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'pageToken')
    ..a<$core.int>(13, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'pageSize', $pb.PbFieldType.O3)
    ..aOS(14, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'language')
    ..pPS(15, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'geoTargetConstants')
    ..aOM<$1.KeywordPlanAggregateMetrics>(16, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'aggregateMetrics', subBuilder: $1.KeywordPlanAggregateMetrics.create)
    ..pc<$3.KeywordPlanKeywordAnnotationEnum_KeywordPlanKeywordAnnotation>(17, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'keywordAnnotation', $pb.PbFieldType.PE, valueOf: $3.KeywordPlanKeywordAnnotationEnum_KeywordPlanKeywordAnnotation.valueOf, enumValues: $3.KeywordPlanKeywordAnnotationEnum_KeywordPlanKeywordAnnotation.values)
    ..aOM<$1.HistoricalMetricsOptions>(18, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'historicalMetricsOptions', subBuilder: $1.HistoricalMetricsOptions.create)
  ...
  factory GenerateKeywordIdeasRequest({
    ...
    $core.Iterable<$3.KeywordPlanKeywordAnnotationEnum_KeywordPlanKeywordAnnotation>? keywordAnnotation,
  ...
  'Will be removed in next major version')
  GenerateKeywordIdeasRequest copyWith(void Function(GenerateKeywordIdeasRequest) updates) => super.copyWith((message) => updates(message as GenerateKeywordIdeasRequest)) as GenerateKeywordIdeasRequest; // ignore: deprecated_member_use
  ...
  @$pb.TagNumber(9)
  $2.KeywordPlanNetworkEnum_KeywordPlanNetwork get keywordPlanNetwork => $_getN(4);
  @$pb.TagNumber(9)
  set keywordPlanNetwork($2.KeywordPlanNetworkEnum_KeywordPlanNetwork v) { setField(9, v); }
  @$pb.TagNumber(9)
  ...
  @$pb.TagNumber(16)
  set aggregateMetrics($1.KeywordPlanAggregateMetrics v) { setField(16, v); }
  @$pb.TagNumber(16)
  ...
  @$pb.TagNumber(17)
  $core.List<$3.KeywordPlanKeywordAnnotationEnum_KeywordPlanKeywordAnnotation> get keywordAnnotation => $_getList(12);

  @$pb.TagNumber(18)
  $1.HistoricalMetricsOptions get historicalMetricsOptions => $_getN(13);
  @$pb.TagNumber(18)
  set historicalMetricsOptions($1.HistoricalMetricsOptions v) { setField(18, v); }
  @$pb.TagNumber(18)
...
class KeywordAndUrlSeed extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'KeywordAndUrlSeed', package: const $pb.PackageName(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'google.ads.googleads.v10.services'), createEmptyInstance: create)
    ..aOS(3, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'url')
    ..pPS(4, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'keywords')
    ..hasRequiredFields = false
  ;
  ...
  'Use [GeneratedMessageGenericExtensions.rebuild] instead. '
  'Will be removed in next major version')
  KeywordAndUrlSeed copyWith(void Function(KeywordAndUrlSeed) updates) => super.copyWith((message) => updates(message as KeywordAndUrlSeed)) as KeywordAndUrlSeed; // ignore: deprecated_member_use
  $pb.BuilderInfo get info_ => _i;
  @$core.pragma('dart2js:noInline')
...
class KeywordSeed extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'KeywordSeed', package: const $pb.PackageName(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'google.ads.googleads.v10.services'), createEmptyInstance: create)
    ..pPS(2, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'keywords')
    ..hasRequiredFields = false
  ;
  ...
  'Use [GeneratedMessageGenericExtensions.rebuild] instead. '
  'Will be removed in next major version')
  KeywordSeed copyWith(void Function(KeywordSeed) updates) => super.copyWith((message) => updates(message as KeywordSeed)) as KeywordSeed; // ignore: deprecated_member_use
  $pb.BuilderInfo get info_ => _i;
  @$core.pragma('dart2js:noInline')
...
class SiteSeed extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'SiteSeed', package: const $pb.PackageName(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'google.ads.googleads.v10.services'), createEmptyInstance: create)
  ...
  'Use [GeneratedMessageGenericExtensions.rebuild] instead. '
  'Will be removed in next major version')
  SiteSeed copyWith(void Function(SiteSeed) updates) => super.copyWith((message) => updates(message as SiteSeed)) as SiteSeed; // ignore: deprecated_member_use
  $pb.BuilderInfo get info_ => _i;
  @$core.pragma('dart2js:noInline')
...
class UrlSeed extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'UrlSeed', package: const $pb.PackageName(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'google.ads.googleads.v10.services'), createEmptyInstance: create)
  ...
  'Use [GeneratedMessageGenericExtensions.rebuild] instead. '
  'Will be removed in next major version')
  UrlSeed copyWith(void Function(UrlSeed) updates) => super.copyWith((message) => updates(message as UrlSeed)) as UrlSeed; // ignore: deprecated_member_use
  $pb.BuilderInfo get info_ => _i;
  @$core.pragma('dart2js:noInline')
...
class GenerateKeywordIdeaResponse extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'GenerateKeywordIdeaResponse', package: const $pb.PackageName(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'google.ads.googleads.v10.services'), createEmptyInstance: create)
    ..pc<GenerateKeywordIdeaResult>(1, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'results', $pb.PbFieldType.PM, subBuilder: GenerateKeywordIdeaResult.create)
    ..aOS(2, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'nextPageToken')
    ..aInt64(3, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'totalSize')
    ..aOM<$1.KeywordPlanAggregateMetricResults>(4, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'aggregateMetricResults', subBuilder: $1.KeywordPlanAggregateMetricResults.create)
    ..hasRequiredFields = false
  ;
  ...
  'Use [GeneratedMessageGenericExtensions.rebuild] instead. '
  'Will be removed in next major version')
  GenerateKeywordIdeaResponse copyWith(void Function(GenerateKeywordIdeaResponse) updates) => super.copyWith((message) => updates(message as GenerateKeywordIdeaResponse)) as GenerateKeywordIdeaResponse; // ignore: deprecated_member_use
  $pb.BuilderInfo get info_ => _i;
  @$core.pragma('dart2js:noInline')
  ...
  @$pb.TagNumber(4)
  set aggregateMetricResults($1.KeywordPlanAggregateMetricResults v) { setField(4, v); }
  @$pb.TagNumber(4)
  $core.bool hasAggregateMetricResults() => $_has(3);
  @$pb.TagNumber(4)
  void clearAggregateMetricResults() => clearField(4);
  @$pb.TagNumber(4)
  $1.KeywordPlanAggregateMetricResults ensureAggregateMetricResults() => $_ensure(3);
}

class GenerateKeywordIdeaResult extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'GenerateKeywordIdeaResult', package: const $pb.PackageName(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'google.ads.googleads.v10.services'), createEmptyInstance: create)
    ..aOM<$1.KeywordPlanHistoricalMetrics>(3, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'keywordIdeaMetrics', subBuilder: $1.KeywordPlanHistoricalMetrics.create)
    ..aOS(5, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'text')
    ..aOM<$1.KeywordAnnotations>(6, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'keywordAnnotations', subBuilder: $1.KeywordAnnotations.create)
    ..pPS(7, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'closeVariants')
    ..hasRequiredFields = false
  ;
  ...
  'Use [GeneratedMessageGenericExtensions.rebuild] instead. '
  'Will be removed in next major version')
  GenerateKeywordIdeaResult copyWith(void Function(GenerateKeywordIdeaResult) updates) => super.copyWith((message) => updates(message as GenerateKeywordIdeaResult)) as GenerateKeywordIdeaResult; // ignore: deprecated_member_use
  $pb.BuilderInfo get info_ => _i;
  @$core.pragma('dart2js:noInline')
  ...
  @$pb.TagNumber(3)
  set keywordIdeaMetrics($1.KeywordPlanHistoricalMetrics v) { setField(3, v); }
  @$pb.TagNumber(3)
  ...
  @$pb.TagNumber(6)
  set keywordAnnotations($1.KeywordAnnotations v) { setField(6, v); }
  @$pb.TagNumber(6)
...
class GenerateKeywordHistoricalMetricsRequest extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'GenerateKeywordHistoricalMetricsRequest', package: const $pb.PackageName(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'google.ads.googleads.v10.services'), createEmptyInstance: create)
    ..aOS(1, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'customerId')
    ..pPS(2, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'keywords')
    ..aOM<$1.HistoricalMetricsOptions>(3, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'historicalMetricsOptions', subBuilder: $1.HistoricalMetricsOptions.create)
    ..hasRequiredFields = false
  ;
  ...
  'Use [GeneratedMessageGenericExtensions.rebuild] instead. '
  'Will be removed in next major version')
  GenerateKeywordHistoricalMetricsRequest copyWith(void Function(GenerateKeywordHistoricalMetricsRequest) updates) => super.copyWith((message) => updates(message as GenerateKeywordHistoricalMetricsRequest)) as GenerateKeywordHistoricalMetricsRequest; // ignore: deprecated_member_use
  $pb.BuilderInfo get info_ => _i;
  @$core.pragma('dart2js:noInline')
  ...
  @$pb.TagNumber(3)
  $1.HistoricalMetricsOptions get historicalMetricsOptions => $_getN(2);
  @$pb.TagNumber(3)
  set historicalMetricsOptions($1.HistoricalMetricsOptions v) { setField(3, v); }
  @$pb.TagNumber(3)
  $core.bool hasHistoricalMetricsOptions() => $_has(2);
  @$pb.TagNumber(3)
  void clearHistoricalMetricsOptions() => clearField(3);
  @$pb.TagNumber(3)
  $1.HistoricalMetricsOptions ensureHistoricalMetricsOptions() => $_ensure(2);
}

class GenerateKeywordHistoricalMetricsResponse extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'GenerateKeywordHistoricalMetricsResponse', package: const $pb.PackageName(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'google.ads.googleads.v10.services'), createEmptyInstance: create)
    ..pc<GenerateKeywordHistoricalMetricsResult>(1, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'results', $pb.PbFieldType.PM, subBuilder: GenerateKeywordHistoricalMetricsResult.create)
    ..hasRequiredFields = false
  ;
  ...
  'Use [GeneratedMessageGenericExtensions.rebuild] instead. '
  'Will be removed in next major version')
  GenerateKeywordHistoricalMetricsResponse copyWith(void Function(GenerateKeywordHistoricalMetricsResponse) updates) => super.copyWith((message) => updates(message as GenerateKeywordHistoricalMetricsResponse)) as GenerateKeywordHistoricalMetricsResponse; // ignore: deprecated_member_use
  $pb.BuilderInfo get info_ => _i;
  @$core.pragma('dart2js:noInline')
...
class GenerateKeywordHistoricalMetricsResult extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'GenerateKeywordHistoricalMetricsResult', package: const $pb.PackageName(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'google.ads.googleads.v10.services'), createEmptyInstance: create)
    ..aOS(1, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'text')
    ..aOM<$1.KeywordPlanHistoricalMetrics>(2, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'keywordMetrics', subBuilder: $1.KeywordPlanHistoricalMetrics.create)
  ...
  factory GenerateKeywordHistoricalMetricsResult({
    $core.String? text,
    $1.KeywordPlanHistoricalMetrics? keywordMetrics,
    $core.Iterable<$core.String>? closeVariants,
  }) {
    final _result = create();
    if (text != null) {
  ...
  'Use [GeneratedMessageGenericExtensions.rebuild] instead. '
  'Will be removed in next major version')
  GenerateKeywordHistoricalMetricsResult copyWith(void Function(GenerateKeywordHistoricalMetricsResult) updates) => super.copyWith((message) => updates(message as GenerateKeywordHistoricalMetricsResult)) as GenerateKeywordHistoricalMetricsResult; // ignore: deprecated_member_use
  $pb.BuilderInfo get info_ => _i;
  @$core.pragma('dart2js:noInline')
  ...
  @$pb.TagNumber(2)
  $1.KeywordPlanHistoricalMetrics get keywordMetrics => $_getN(1);
  @$pb.TagNumber(2)
  set keywordMetrics($1.KeywordPlanHistoricalMetrics v) { setField(2, v); }
  @$pb.TagNumber(2)
  $core.bool hasKeywordMetrics() => $_has(1);
  @$pb.TagNumber(2)
  void clearKeywordMetrics() => clearField(2);
  @$pb.TagNumber(2)
  $1.KeywordPlanHistoricalMetrics ensureKeywordMetrics() => $_ensure(1);

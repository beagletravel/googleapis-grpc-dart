...
class MutateCampaignCustomizersRequest extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'MutateCampaignCustomizersRequest', package: const $pb.PackageName(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'google.ads.googleads.v10.services'), createEmptyInstance: create)
    ..aOS(1, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'customerId')
    ..pc<CampaignCustomizerOperation>(2, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'operations', $pb.PbFieldType.PM, subBuilder: CampaignCustomizerOperation.create)
  ...
  'Will be removed in next major version')
  MutateCampaignCustomizersRequest copyWith(void Function(MutateCampaignCustomizersRequest) updates) => super.copyWith((message) => updates(message as MutateCampaignCustomizersRequest)) as MutateCampaignCustomizersRequest; // ignore: deprecated_member_use
...
class CampaignCustomizerOperation extends $pb.GeneratedMessage {
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'CampaignCustomizerOperation', package: const $pb.PackageName(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'google.ads.googleads.v10.services'), createEmptyInstance: create)
    ..oo(0, [1, 2])
    ..aOM<$1.CampaignCustomizer>(1, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'create', subBuilder: $1.CampaignCustomizer.create)
  ...
  'Use [GeneratedMessageGenericExtensions.rebuild] instead. '
  'Will be removed in next major version')
  CampaignCustomizerOperation copyWith(void Function(CampaignCustomizerOperation) updates) => super.copyWith((message) => updates(message as CampaignCustomizerOperation)) as CampaignCustomizerOperation; // ignore: deprecated_member_use
  $pb.BuilderInfo get info_ => _i;
  @$core.pragma('dart2js:noInline')
  ...
  @$pb.TagNumber(1)
  set create_1($1.CampaignCustomizer v) { setField(1, v); }
  @$pb.TagNumber(1)
...
class MutateCampaignCustomizersResponse extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'MutateCampaignCustomizersResponse', package: const $pb.PackageName(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'google.ads.googleads.v10.services'), createEmptyInstance: create)
    ..pc<MutateCampaignCustomizerResult>(1, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'results', $pb.PbFieldType.PM, subBuilder: MutateCampaignCustomizerResult.create)
  ...
  'Use [GeneratedMessageGenericExtensions.rebuild] instead. '
  'Will be removed in next major version')
  MutateCampaignCustomizersResponse copyWith(void Function(MutateCampaignCustomizersResponse) updates) => super.copyWith((message) => updates(message as MutateCampaignCustomizersResponse)) as MutateCampaignCustomizersResponse; // ignore: deprecated_member_use
  $pb.BuilderInfo get info_ => _i;
  @$core.pragma('dart2js:noInline')
...
class MutateCampaignCustomizerResult extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'MutateCampaignCustomizerResult', package: const $pb.PackageName(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'google.ads.googleads.v10.services'), createEmptyInstance: create)
    ..aOS(1, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'resourceName')
    ..aOM<$1.CampaignCustomizer>(2, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'campaignCustomizer', subBuilder: $1.CampaignCustomizer.create)
    ..hasRequiredFields = false
  ;
  ...
  'Use [GeneratedMessageGenericExtensions.rebuild] instead. '
  'Will be removed in next major version')
  MutateCampaignCustomizerResult copyWith(void Function(MutateCampaignCustomizerResult) updates) => super.copyWith((message) => updates(message as MutateCampaignCustomizerResult)) as MutateCampaignCustomizerResult; // ignore: deprecated_member_use
  $pb.BuilderInfo get info_ => _i;
  @$core.pragma('dart2js:noInline')
  ...
  @$pb.TagNumber(2)
  set campaignCustomizer($1.CampaignCustomizer v) { setField(2, v); }
  @$pb.TagNumber(2)

...
class GroupPlacementView extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'GroupPlacementView', package: const $pb.PackageName(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'google.ads.googleads.v10.resources'), createEmptyInstance: create)
    ..aOS(1, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'resourceName')
    ..e<$0.PlacementTypeEnum_PlacementType>(5, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'placementType', $pb.PbFieldType.OE, defaultOrMaker: $0.PlacementTypeEnum_PlacementType.UNSPECIFIED, valueOf: $0.PlacementTypeEnum_PlacementType.valueOf, enumValues: $0.PlacementTypeEnum_PlacementType.values)
    ..aOS(6, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'placement')
    ..aOS(7, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'displayName')
    ..aOS(8, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'targetUrl')
  ...
  'Will be removed in next major version')
  GroupPlacementView copyWith(void Function(GroupPlacementView) updates) => super.copyWith((message) => updates(message as GroupPlacementView)) as GroupPlacementView; // ignore: deprecated_member_use
  ...
  @$pb.TagNumber(5)
  set placementType($0.PlacementTypeEnum_PlacementType v) { setField(5, v); }
  @$pb.TagNumber(5)

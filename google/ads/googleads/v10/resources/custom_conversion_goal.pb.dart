...
class CustomConversionGoal extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'CustomConversionGoal', package: const $pb.PackageName(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'google.ads.googleads.v10.resources'), createEmptyInstance: create)
    ...
    ..pPS(4, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'conversionActions')
    ..e<$0.CustomConversionGoalStatusEnum_CustomConversionGoalStatus>(5, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'status', $pb.PbFieldType.OE, defaultOrMaker: $0.CustomConversionGoalStatusEnum_CustomConversionGoalStatus.UNSPECIFIED, valueOf: $0.CustomConversionGoalStatusEnum_CustomConversionGoalStatus.valueOf, enumValues: $0.CustomConversionGoalStatusEnum_CustomConversionGoalStatus.values)
  ...
  'Will be removed in next major version')
  CustomConversionGoal copyWith(void Function(CustomConversionGoal) updates) => super.copyWith((message) => updates(message as CustomConversionGoal)) as CustomConversionGoal; // ignore: deprecated_member_use
  ...
  @$pb.TagNumber(5)
  $0.CustomConversionGoalStatusEnum_CustomConversionGoalStatus get status => $_getN(4);
  @$pb.TagNumber(5)
  set status($0.CustomConversionGoalStatusEnum_CustomConversionGoalStatus v) { setField(5, v); }
  @$pb.TagNumber(5)

...
class Feed_PlacesLocationFeedData_OAuthInfo extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'Feed.PlacesLocationFeedData.OAuthInfo', package: const $pb.PackageName(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'google.ads.googleads.v10.resources'), createEmptyInstance: create)
    ..aOS(4, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'httpMethod')
    ..aOS(5, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'httpRequestUrl')
    ..aOS(6, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'httpAuthorizationHeader')
  ...
  'Will be removed in next major version')
  Feed_PlacesLocationFeedData_OAuthInfo copyWith(void Function(Feed_PlacesLocationFeedData_OAuthInfo) updates) => super.copyWith((message) => updates(message as Feed_PlacesLocationFeedData_OAuthInfo)) as Feed_PlacesLocationFeedData_OAuthInfo; // ignore: deprecated_member_use
...
class Feed_PlacesLocationFeedData extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'Feed.PlacesLocationFeedData', package: const $pb.PackageName(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'google.ads.googleads.v10.resources'), createEmptyInstance: create)
    ..aOM<Feed_PlacesLocationFeedData_OAuthInfo>(1, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'oauthInfo', subBuilder: Feed_PlacesLocationFeedData_OAuthInfo.create)
    ..aOS(7, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'emailAddress')
    ..aOS(8, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'businessAccountId')
    ..aOS(9, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'businessNameFilter')
    ..pPS(11, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'categoryFilters')
    ..pPS(12, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'labelFilters')
    ..hasRequiredFields = false
  ;
  ...
  'Use [GeneratedMessageGenericExtensions.rebuild] instead. '
  'Will be removed in next major version')
  Feed_PlacesLocationFeedData copyWith(void Function(Feed_PlacesLocationFeedData) updates) => super.copyWith((message) => updates(message as Feed_PlacesLocationFeedData)) as Feed_PlacesLocationFeedData; // ignore: deprecated_member_use
  $pb.BuilderInfo get info_ => _i;
  @$core.pragma('dart2js:noInline')
...
class Feed_AffiliateLocationFeedData extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'Feed.AffiliateLocationFeedData', package: const $pb.PackageName(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'google.ads.googleads.v10.resources'), createEmptyInstance: create)
    ..e<$2.AffiliateLocationFeedRelationshipTypeEnum_AffiliateLocationFeedRelationshipType>(2, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'relationshipType', $pb.PbFieldType.OE, defaultOrMaker: $2.AffiliateLocationFeedRelationshipTypeEnum_AffiliateLocationFeedRelationshipType.UNSPECIFIED, valueOf: $2.AffiliateLocationFeedRelationshipTypeEnum_AffiliateLocationFeedRelationshipType.valueOf, enumValues: $2.AffiliateLocationFeedRelationshipTypeEnum_AffiliateLocationFeedRelationshipType.values)
    ..p<$fixnum.Int64>(3, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'chainIds', $pb.PbFieldType.P6)
    ..hasRequiredFields = false
  ;

  Feed_AffiliateLocationFeedData._() : super();
  factory Feed_AffiliateLocationFeedData({
    $2.AffiliateLocationFeedRelationshipTypeEnum_AffiliateLocationFeedRelationshipType? relationshipType,
  ...
  'Use [GeneratedMessageGenericExtensions.rebuild] instead. '
  'Will be removed in next major version')
  Feed_AffiliateLocationFeedData copyWith(void Function(Feed_AffiliateLocationFeedData) updates) => super.copyWith((message) => updates(message as Feed_AffiliateLocationFeedData)) as Feed_AffiliateLocationFeedData; // ignore: deprecated_member_use
  $pb.BuilderInfo get info_ => _i;
  @$core.pragma('dart2js:noInline')
  ...
  @$pb.TagNumber(2)
  $2.AffiliateLocationFeedRelationshipTypeEnum_AffiliateLocationFeedRelationshipType get relationshipType => $_getN(0);
  @$pb.TagNumber(2)
  set relationshipType($2.AffiliateLocationFeedRelationshipTypeEnum_AffiliateLocationFeedRelationshipType v) { setField(2, v); }
  @$pb.TagNumber(2)
...
class Feed extends $pb.GeneratedMessage {
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'Feed', package: const $pb.PackageName(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'google.ads.googleads.v10.resources'), createEmptyInstance: create)
    ..oo(0, [6, 7])
    ..aOS(1, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'resourceName')
    ..pc<FeedAttribute>(4, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'attributes', $pb.PbFieldType.PM, subBuilder: FeedAttribute.create)
    ..e<$0.FeedOriginEnum_FeedOrigin>(5, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'origin', $pb.PbFieldType.OE, defaultOrMaker: $0.FeedOriginEnum_FeedOrigin.UNSPECIFIED, valueOf: $0.FeedOriginEnum_FeedOrigin.valueOf, enumValues: $0.FeedOriginEnum_FeedOrigin.values)
    ..aOM<Feed_PlacesLocationFeedData>(6, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'placesLocationFeedData', subBuilder: Feed_PlacesLocationFeedData.create)
    ..aOM<Feed_AffiliateLocationFeedData>(7, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'affiliateLocationFeedData', subBuilder: Feed_AffiliateLocationFeedData.create)
    ..e<$1.FeedStatusEnum_FeedStatus>(8, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'status', $pb.PbFieldType.OE, defaultOrMaker: $1.FeedStatusEnum_FeedStatus.UNSPECIFIED, valueOf: $1.FeedStatusEnum_FeedStatus.valueOf, enumValues: $1.FeedStatusEnum_FeedStatus.values)
    ..pc<FeedAttributeOperation>(9, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'attributeOperations', $pb.PbFieldType.PM, subBuilder: FeedAttributeOperation.create)
  ...
  @$pb.TagNumber(5)
  set origin($0.FeedOriginEnum_FeedOrigin v) { setField(5, v); }
  @$pb.TagNumber(5)
  ...
  @$pb.TagNumber(8)
  set status($1.FeedStatusEnum_FeedStatus v) { setField(8, v); }
  @$pb.TagNumber(8)
...
class FeedAttribute extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'FeedAttribute', package: const $pb.PackageName(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'google.ads.googleads.v10.resources'), createEmptyInstance: create)
    ..e<$3.FeedAttributeTypeEnum_FeedAttributeType>(3, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'type', $pb.PbFieldType.OE, defaultOrMaker: $3.FeedAttributeTypeEnum_FeedAttributeType.UNSPECIFIED, valueOf: $3.FeedAttributeTypeEnum_FeedAttributeType.valueOf, enumValues: $3.FeedAttributeTypeEnum_FeedAttributeType.values)
    ...
    ..aOB(7, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'isPartOfKey')
    ..hasRequiredFields = false
  ;
  ...
  'Use [GeneratedMessageGenericExtensions.rebuild] instead. '
  'Will be removed in next major version')
  FeedAttribute copyWith(void Function(FeedAttribute) updates) => super.copyWith((message) => updates(message as FeedAttribute)) as FeedAttribute; // ignore: deprecated_member_use
  $pb.BuilderInfo get info_ => _i;
  @$core.pragma('dart2js:noInline')
  ...
  @$pb.TagNumber(3)
  set type($3.FeedAttributeTypeEnum_FeedAttributeType v) { setField(3, v); }
  @$pb.TagNumber(3)
...
class FeedAttributeOperation extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'FeedAttributeOperation', package: const $pb.PackageName(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'google.ads.googleads.v10.resources'), createEmptyInstance: create)
    ..e<FeedAttributeOperation_Operator>(1, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'operator', $pb.PbFieldType.OE, defaultOrMaker: FeedAttributeOperation_Operator.UNSPECIFIED, valueOf: FeedAttributeOperation_Operator.valueOf, enumValues: FeedAttributeOperation_Operator.values)
    ..aOM<FeedAttribute>(2, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'value', subBuilder: FeedAttribute.create)
    ..hasRequiredFields = false
  ;
  ...
  'Use [GeneratedMessageGenericExtensions.rebuild] instead. '
  'Will be removed in next major version')
  FeedAttributeOperation copyWith(void Function(FeedAttributeOperation) updates) => super.copyWith((message) => updates(message as FeedAttributeOperation)) as FeedAttributeOperation; // ignore: deprecated_member_use
  $pb.BuilderInfo get info_ => _i;
  @$core.pragma('dart2js:noInline')

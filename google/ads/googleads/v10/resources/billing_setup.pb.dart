...
class BillingSetup_PaymentsAccountInfo extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'BillingSetup.PaymentsAccountInfo', package: const $pb.PackageName(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'google.ads.googleads.v10.resources'), createEmptyInstance: create)
    ..aOS(6, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'paymentsAccountId')
    ..aOS(7, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'paymentsAccountName')
    ..aOS(8, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'paymentsProfileId')
    ..aOS(9, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'paymentsProfileName')
    ..aOS(10, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'secondaryPaymentsProfileId')
  ...
  'Will be removed in next major version')
  BillingSetup_PaymentsAccountInfo copyWith(void Function(BillingSetup_PaymentsAccountInfo) updates) => super.copyWith((message) => updates(message as BillingSetup_PaymentsAccountInfo)) as BillingSetup_PaymentsAccountInfo; // ignore: deprecated_member_use
...
class BillingSetup extends $pb.GeneratedMessage {
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'BillingSetup', package: const $pb.PackageName(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'google.ads.googleads.v10.resources'), createEmptyInstance: create)
    ..oo(0, [10, 16])
    ..oo(1, [14, 17])
    ..aOS(1, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'resourceName')
    ..e<$0.BillingSetupStatusEnum_BillingSetupStatus>(3, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'status', $pb.PbFieldType.OE, defaultOrMaker: $0.BillingSetupStatusEnum_BillingSetupStatus.UNSPECIFIED, valueOf: $0.BillingSetupStatusEnum_BillingSetupStatus.valueOf, enumValues: $0.BillingSetupStatusEnum_BillingSetupStatus.values)
    ..e<$1.TimeTypeEnum_TimeType>(10, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'startTimeType', $pb.PbFieldType.OE, defaultOrMaker: $1.TimeTypeEnum_TimeType.UNSPECIFIED, valueOf: $1.TimeTypeEnum_TimeType.valueOf, enumValues: $1.TimeTypeEnum_TimeType.values)
    ..aOM<BillingSetup_PaymentsAccountInfo>(12, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'paymentsAccountInfo', subBuilder: BillingSetup_PaymentsAccountInfo.create)
    ..e<$1.TimeTypeEnum_TimeType>(14, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'endTimeType', $pb.PbFieldType.OE, defaultOrMaker: $1.TimeTypeEnum_TimeType.UNSPECIFIED, valueOf: $1.TimeTypeEnum_TimeType.valueOf, enumValues: $1.TimeTypeEnum_TimeType.values)
    ..aInt64(15, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'id')
    ..aOS(16, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'startDateTime')
    ..aOS(17, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'endDateTime')
    ..aOS(18, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'paymentsAccount')
    ..hasRequiredFields = false
  ;
  ...
  'Use [GeneratedMessageGenericExtensions.rebuild] instead. '
  'Will be removed in next major version')
  BillingSetup copyWith(void Function(BillingSetup) updates) => super.copyWith((message) => updates(message as BillingSetup)) as BillingSetup; // ignore: deprecated_member_use
  $pb.BuilderInfo get info_ => _i;
  @$core.pragma('dart2js:noInline')
  ...
  @$pb.TagNumber(3)
  set status($0.BillingSetupStatusEnum_BillingSetupStatus v) { setField(3, v); }
  @$pb.TagNumber(3)
  ...
  @$pb.TagNumber(10)
  set startTimeType($1.TimeTypeEnum_TimeType v) { setField(10, v); }
  @$pb.TagNumber(10)
  ...
  @$pb.TagNumber(14)
  set endTimeType($1.TimeTypeEnum_TimeType v) { setField(14, v); }
  @$pb.TagNumber(14)

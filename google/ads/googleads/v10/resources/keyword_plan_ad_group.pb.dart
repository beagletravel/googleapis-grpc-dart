...
class KeywordPlanAdGroup extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'KeywordPlanAdGroup', package: const $pb.PackageName(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'google.ads.googleads.v10.resources'), createEmptyInstance: create)
    ..aOS(1, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'resourceName')
    ..aOS(6, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'keywordPlanCampaign')
    ...
    ..aInt64(9, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'cpcBidMicros')
  ...
  'Will be removed in next major version')
  KeywordPlanAdGroup copyWith(void Function(KeywordPlanAdGroup) updates) => super.copyWith((message) => updates(message as KeywordPlanAdGroup)) as KeywordPlanAdGroup; // ignore: deprecated_member_use

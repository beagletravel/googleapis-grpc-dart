...
const KeywordPlanAdGroup$json = const {
  ...
  '2': const [
    ...
    const {'1': 'keyword_plan_campaign', '3': 6, '4': 1, '5': 9, '8': const {}, '9': 0, '10': 'keywordPlanCampaign', '17': true},
    const {'1': 'id', '3': 7, '4': 1, '5': 3, '8': const {}, '9': 1, '10': 'id', '17': true},
    const {'1': 'name', '3': 8, '4': 1, '5': 9, '9': 2, '10': 'name', '17': true},
    const {'1': 'cpc_bid_micros', '3': 9, '4': 1, '5': 3, '9': 3, '10': 'cpcBidMicros', '17': true},
  ],
  '7': const {},
  '8': const [
...
final $typed_data.Uint8List keywordPlanAdGroupDescriptor = $convert.base64Decode('');

...
class AdGroupCustomizer extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'AdGroupCustomizer', package: const $pb.PackageName(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'google.ads.googleads.v10.resources'), createEmptyInstance: create)
  ...
  'Will be removed in next major version')
  AdGroupCustomizer copyWith(void Function(AdGroupCustomizer) updates) => super.copyWith((message) => updates(message as AdGroupCustomizer)) as AdGroupCustomizer; // ignore: deprecated_member_use

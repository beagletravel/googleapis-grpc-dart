...
class CustomerConversionGoal extends $pb.GeneratedMessage {
  ...
  'Will be removed in next major version')
  CustomerConversionGoal copyWith(void Function(CustomerConversionGoal) updates) => super.copyWith((message) => updates(message as CustomerConversionGoal)) as CustomerConversionGoal; // ignore: deprecated_member_use
  ...
  @$pb.TagNumber(2)
  $0.ConversionActionCategoryEnum_ConversionActionCategory get category => $_getN(1);
  @$pb.TagNumber(2)
  set category($0.ConversionActionCategoryEnum_ConversionActionCategory v) { setField(2, v); }
  @$pb.TagNumber(2)
  ...
  @$pb.TagNumber(3)
  set origin($1.ConversionOriginEnum_ConversionOrigin v) { setField(3, v); }
  @$pb.TagNumber(3)

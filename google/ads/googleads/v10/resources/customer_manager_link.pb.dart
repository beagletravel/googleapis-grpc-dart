...
class CustomerManagerLink extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'CustomerManagerLink', package: const $pb.PackageName(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'google.ads.googleads.v10.resources'), createEmptyInstance: create)
    ...
    ..aOS(6, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'managerCustomer')
    ..aInt64(7, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'managerLinkId')
  ...
  'Will be removed in next major version')
  CustomerManagerLink copyWith(void Function(CustomerManagerLink) updates) => super.copyWith((message) => updates(message as CustomerManagerLink)) as CustomerManagerLink; // ignore: deprecated_member_use

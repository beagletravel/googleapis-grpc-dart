...
class AdScheduleView extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'AdScheduleView', package: const $pb.PackageName(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'google.ads.googleads.v10.resources'), createEmptyInstance: create)
  ...
  'Will be removed in next major version')
  AdScheduleView copyWith(void Function(AdScheduleView) updates) => super.copyWith((message) => updates(message as AdScheduleView)) as AdScheduleView; // ignore: deprecated_member_use

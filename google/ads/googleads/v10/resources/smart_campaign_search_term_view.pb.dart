...
class SmartCampaignSearchTermView extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'SmartCampaignSearchTermView', package: const $pb.PackageName(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'google.ads.googleads.v10.resources'), createEmptyInstance: create)
    ..aOS(1, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'resourceName')
    ..aOS(2, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'searchTerm')
    ..aOS(3, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'campaign')
  ...
  'Will be removed in next major version')
  SmartCampaignSearchTermView copyWith(void Function(SmartCampaignSearchTermView) updates) => super.copyWith((message) => updates(message as SmartCampaignSearchTermView)) as SmartCampaignSearchTermView; // ignore: deprecated_member_use

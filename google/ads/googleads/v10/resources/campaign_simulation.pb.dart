...
class CampaignSimulation extends $pb.GeneratedMessage {
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'CampaignSimulation', package: const $pb.PackageName(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'google.ads.googleads.v10.resources'), createEmptyInstance: create)
    ..oo(0, [7, 8, 9, 10, 11])
    ..aOS(1, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'resourceName')
    ..aInt64(2, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'campaignId')
    ..e<$1.SimulationTypeEnum_SimulationType>(3, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'type', $pb.PbFieldType.OE, defaultOrMaker: $1.SimulationTypeEnum_SimulationType.UNSPECIFIED, valueOf: $1.SimulationTypeEnum_SimulationType.valueOf, enumValues: $1.SimulationTypeEnum_SimulationType.values)
    ..e<$2.SimulationModificationMethodEnum_SimulationModificationMethod>(4, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'modificationMethod', $pb.PbFieldType.OE, defaultOrMaker: $2.SimulationModificationMethodEnum_SimulationModificationMethod.UNSPECIFIED, valueOf: $2.SimulationModificationMethodEnum_SimulationModificationMethod.valueOf, enumValues: $2.SimulationModificationMethodEnum_SimulationModificationMethod.values)
    ...
    ..aOM<$0.CpcBidSimulationPointList>(7, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'cpcBidPointList', subBuilder: $0.CpcBidSimulationPointList.create)
    ..aOM<$0.TargetCpaSimulationPointList>(8, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'targetCpaPointList', subBuilder: $0.TargetCpaSimulationPointList.create)
    ..aOM<$0.TargetRoasSimulationPointList>(9, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'targetRoasPointList', subBuilder: $0.TargetRoasSimulationPointList.create)
    ..aOM<$0.TargetImpressionShareSimulationPointList>(10, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'targetImpressionSharePointList', subBuilder: $0.TargetImpressionShareSimulationPointList.create)
    ..aOM<$0.BudgetSimulationPointList>(11, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'budgetPointList', subBuilder: $0.BudgetSimulationPointList.create)
  ...
  factory CampaignSimulation({
    ...
    $2.SimulationModificationMethodEnum_SimulationModificationMethod? modificationMethod,
  ...
  'Will be removed in next major version')
  CampaignSimulation copyWith(void Function(CampaignSimulation) updates) => super.copyWith((message) => updates(message as CampaignSimulation)) as CampaignSimulation; // ignore: deprecated_member_use
  ...
  @$pb.TagNumber(3)
  set type($1.SimulationTypeEnum_SimulationType v) { setField(3, v); }
  @$pb.TagNumber(3)
  ...
  @$pb.TagNumber(4)
  $2.SimulationModificationMethodEnum_SimulationModificationMethod get modificationMethod => $_getN(3);
  @$pb.TagNumber(4)
  set modificationMethod($2.SimulationModificationMethodEnum_SimulationModificationMethod v) { setField(4, v); }
  @$pb.TagNumber(4)
  ...
  @$pb.TagNumber(7)
  set cpcBidPointList($0.CpcBidSimulationPointList v) { setField(7, v); }
  @$pb.TagNumber(7)
  ...
  @$pb.TagNumber(8)
  set targetCpaPointList($0.TargetCpaSimulationPointList v) { setField(8, v); }
  @$pb.TagNumber(8)
  ...
  @$pb.TagNumber(9)
  set targetRoasPointList($0.TargetRoasSimulationPointList v) { setField(9, v); }
  @$pb.TagNumber(9)
  ...
  @$pb.TagNumber(10)
  $0.TargetImpressionShareSimulationPointList get targetImpressionSharePointList => $_getN(9);
  @$pb.TagNumber(10)
  set targetImpressionSharePointList($0.TargetImpressionShareSimulationPointList v) { setField(10, v); }
  @$pb.TagNumber(10)
  $core.bool hasTargetImpressionSharePointList() => $_has(9);
  @$pb.TagNumber(10)
  void clearTargetImpressionSharePointList() => clearField(10);
  @$pb.TagNumber(10)
  $0.TargetImpressionShareSimulationPointList ensureTargetImpressionSharePointList() => $_ensure(9);

  @$pb.TagNumber(11)
  $0.BudgetSimulationPointList get budgetPointList => $_getN(10);
  @$pb.TagNumber(11)
  set budgetPointList($0.BudgetSimulationPointList v) { setField(11, v); }
  @$pb.TagNumber(11)

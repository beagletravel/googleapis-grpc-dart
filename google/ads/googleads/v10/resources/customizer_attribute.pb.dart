...
class CustomizerAttribute extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'CustomizerAttribute', package: const $pb.PackageName(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'google.ads.googleads.v10.resources'), createEmptyInstance: create)
    ...
    ..e<$0.CustomizerAttributeTypeEnum_CustomizerAttributeType>(4, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'type', $pb.PbFieldType.OE, defaultOrMaker: $0.CustomizerAttributeTypeEnum_CustomizerAttributeType.UNSPECIFIED, valueOf: $0.CustomizerAttributeTypeEnum_CustomizerAttributeType.valueOf, enumValues: $0.CustomizerAttributeTypeEnum_CustomizerAttributeType.values)
    ..e<$1.CustomizerAttributeStatusEnum_CustomizerAttributeStatus>(5, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'status', $pb.PbFieldType.OE, defaultOrMaker: $1.CustomizerAttributeStatusEnum_CustomizerAttributeStatus.UNSPECIFIED, valueOf: $1.CustomizerAttributeStatusEnum_CustomizerAttributeStatus.valueOf, enumValues: $1.CustomizerAttributeStatusEnum_CustomizerAttributeStatus.values)
  ...
  'Will be removed in next major version')
  CustomizerAttribute copyWith(void Function(CustomizerAttribute) updates) => super.copyWith((message) => updates(message as CustomizerAttribute)) as CustomizerAttribute; // ignore: deprecated_member_use
  ...
  @$pb.TagNumber(4)
  set type($0.CustomizerAttributeTypeEnum_CustomizerAttributeType v) { setField(4, v); }
  @$pb.TagNumber(4)
  ...
  @$pb.TagNumber(5)
  $1.CustomizerAttributeStatusEnum_CustomizerAttributeStatus get status => $_getN(4);
  @$pb.TagNumber(5)
  set status($1.CustomizerAttributeStatusEnum_CustomizerAttributeStatus v) { setField(5, v); }
  @$pb.TagNumber(5)

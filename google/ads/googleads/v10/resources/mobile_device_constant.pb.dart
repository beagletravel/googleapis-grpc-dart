...
class MobileDeviceConstant extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'MobileDeviceConstant', package: const $pb.PackageName(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'google.ads.googleads.v10.resources'), createEmptyInstance: create)
    ..aOS(1, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'resourceName')
    ..e<$0.MobileDeviceTypeEnum_MobileDeviceType>(6, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'type', $pb.PbFieldType.OE, defaultOrMaker: $0.MobileDeviceTypeEnum_MobileDeviceType.UNSPECIFIED, valueOf: $0.MobileDeviceTypeEnum_MobileDeviceType.valueOf, enumValues: $0.MobileDeviceTypeEnum_MobileDeviceType.values)
    ...
    ..aOS(9, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'manufacturerName')
    ..aOS(10, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'operatingSystemName')
  ...
  'Will be removed in next major version')
  MobileDeviceConstant copyWith(void Function(MobileDeviceConstant) updates) => super.copyWith((message) => updates(message as MobileDeviceConstant)) as MobileDeviceConstant; // ignore: deprecated_member_use
  ...
  @$pb.TagNumber(6)
  set type($0.MobileDeviceTypeEnum_MobileDeviceType v) { setField(6, v); }
  @$pb.TagNumber(6)

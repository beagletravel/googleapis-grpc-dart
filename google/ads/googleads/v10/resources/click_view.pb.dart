...
class ClickView extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'ClickView', package: const $pb.PackageName(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'google.ads.googleads.v10.resources'), createEmptyInstance: create)
    ..aOS(1, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'resourceName')
    ..aOM<$0.ClickLocation>(3, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'areaOfInterest', subBuilder: $0.ClickLocation.create)
    ..aOM<$0.ClickLocation>(4, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'locationOfPresence', subBuilder: $0.ClickLocation.create)
    ..aOS(8, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'gclid')
    ..aInt64(9, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'pageNumber')
    ..aOS(10, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'adGroupAd')
    ..aOS(11, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'campaignLocationTarget')
    ..aOS(12, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'userList')
    ..aOS(13, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'keyword')
    ..aOM<$1.KeywordInfo>(14, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'keywordInfo', subBuilder: $1.KeywordInfo.create)
  ...
  'Will be removed in next major version')
  ClickView copyWith(void Function(ClickView) updates) => super.copyWith((message) => updates(message as ClickView)) as ClickView; // ignore: deprecated_member_use
  ...
  @$pb.TagNumber(3)
  set areaOfInterest($0.ClickLocation v) { setField(3, v); }
  @$pb.TagNumber(3)
  ...
  @$pb.TagNumber(4)
  set locationOfPresence($0.ClickLocation v) { setField(4, v); }
  @$pb.TagNumber(4)
  ...
  @$pb.TagNumber(14)
  set keywordInfo($1.KeywordInfo v) { setField(14, v); }
  @$pb.TagNumber(14)

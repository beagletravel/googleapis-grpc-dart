...
class SearchTermView extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'SearchTermView', package: const $pb.PackageName(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'google.ads.googleads.v10.resources'), createEmptyInstance: create)
    ..aOS(1, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'resourceName')
    ..e<$0.SearchTermTargetingStatusEnum_SearchTermTargetingStatus>(4, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'status', $pb.PbFieldType.OE, defaultOrMaker: $0.SearchTermTargetingStatusEnum_SearchTermTargetingStatus.UNSPECIFIED, valueOf: $0.SearchTermTargetingStatusEnum_SearchTermTargetingStatus.valueOf, enumValues: $0.SearchTermTargetingStatusEnum_SearchTermTargetingStatus.values)
    ..aOS(5, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'searchTerm')
  ...
  'Will be removed in next major version')
  SearchTermView copyWith(void Function(SearchTermView) updates) => super.copyWith((message) => updates(message as SearchTermView)) as SearchTermView; // ignore: deprecated_member_use
  ...
  @$pb.TagNumber(4)
  $0.SearchTermTargetingStatusEnum_SearchTermTargetingStatus get status => $_getN(1);
  @$pb.TagNumber(4)
  set status($0.SearchTermTargetingStatusEnum_SearchTermTargetingStatus v) { setField(4, v); }
  @$pb.TagNumber(4)

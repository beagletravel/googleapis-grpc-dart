...
class BatchJob_BatchJobMetadata extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'BatchJob.BatchJobMetadata', package: const $pb.PackageName(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'google.ads.googleads.v10.resources'), createEmptyInstance: create)
    ..aOS(7, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'startDateTime')
    ..aOS(8, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'creationDateTime')
    ..aOS(9, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'completionDateTime')
    ..a<$core.double>(10, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'estimatedCompletionRatio', $pb.PbFieldType.OD)
    ..aInt64(11, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'operationCount')
    ..aInt64(12, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'executedOperationCount')
  ...
  'Will be removed in next major version')
  BatchJob_BatchJobMetadata copyWith(void Function(BatchJob_BatchJobMetadata) updates) => super.copyWith((message) => updates(message as BatchJob_BatchJobMetadata)) as BatchJob_BatchJobMetadata; // ignore: deprecated_member_use
...
class BatchJob extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'BatchJob', package: const $pb.PackageName(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'google.ads.googleads.v10.resources'), createEmptyInstance: create)
    ..aOS(1, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'resourceName')
    ..aOM<BatchJob_BatchJobMetadata>(4, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'metadata', subBuilder: BatchJob_BatchJobMetadata.create)
    ..e<$0.BatchJobStatusEnum_BatchJobStatus>(5, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'status', $pb.PbFieldType.OE, defaultOrMaker: $0.BatchJobStatusEnum_BatchJobStatus.UNSPECIFIED, valueOf: $0.BatchJobStatusEnum_BatchJobStatus.valueOf, enumValues: $0.BatchJobStatusEnum_BatchJobStatus.values)
    ..aInt64(7, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'id')
    ..aOS(8, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'nextAddSequenceToken')
    ..aOS(9, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'longRunningOperation')
    ..hasRequiredFields = false
  ;
  ...
  'Use [GeneratedMessageGenericExtensions.rebuild] instead. '
  'Will be removed in next major version')
  BatchJob copyWith(void Function(BatchJob) updates) => super.copyWith((message) => updates(message as BatchJob)) as BatchJob; // ignore: deprecated_member_use
  $pb.BuilderInfo get info_ => _i;
  @$core.pragma('dart2js:noInline')
  ...
  @$pb.TagNumber(5)
  set status($0.BatchJobStatusEnum_BatchJobStatus v) { setField(5, v); }
  @$pb.TagNumber(5)

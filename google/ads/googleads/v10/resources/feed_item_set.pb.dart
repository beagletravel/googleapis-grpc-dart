...
class FeedItemSet extends $pb.GeneratedMessage {
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'FeedItemSet', package: const $pb.PackageName(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'google.ads.googleads.v10.resources'), createEmptyInstance: create)
    ..oo(0, [5, 6])
    ..aOS(1, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'resourceName')
    ..aOS(2, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'feed')
    ..aInt64(3, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'feedItemSetId')
    ..aOS(4, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'displayName')
    ..aOM<$0.DynamicLocationSetFilter>(5, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'dynamicLocationSetFilter', subBuilder: $0.DynamicLocationSetFilter.create)
    ..aOM<$0.DynamicAffiliateLocationSetFilter>(6, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'dynamicAffiliateLocationSetFilter', subBuilder: $0.DynamicAffiliateLocationSetFilter.create)
    ..e<$1.FeedItemSetStatusEnum_FeedItemSetStatus>(8, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'status', $pb.PbFieldType.OE, defaultOrMaker: $1.FeedItemSetStatusEnum_FeedItemSetStatus.UNSPECIFIED, valueOf: $1.FeedItemSetStatusEnum_FeedItemSetStatus.valueOf, enumValues: $1.FeedItemSetStatusEnum_FeedItemSetStatus.values)
  ...
  factory FeedItemSet({
    ...
    if (dynamicAffiliateLocationSetFilter != null) {
      _result.dynamicAffiliateLocationSetFilter = dynamicAffiliateLocationSetFilter;
    }
    if (status != null) {
  ...
  'Will be removed in next major version')
  FeedItemSet copyWith(void Function(FeedItemSet) updates) => super.copyWith((message) => updates(message as FeedItemSet)) as FeedItemSet; // ignore: deprecated_member_use
  ...
  @$pb.TagNumber(5)
  set dynamicLocationSetFilter($0.DynamicLocationSetFilter v) { setField(5, v); }
  @$pb.TagNumber(5)
  ...
  @$pb.TagNumber(6)
  $0.DynamicAffiliateLocationSetFilter get dynamicAffiliateLocationSetFilter => $_getN(5);
  @$pb.TagNumber(6)
  set dynamicAffiliateLocationSetFilter($0.DynamicAffiliateLocationSetFilter v) { setField(6, v); }
  @$pb.TagNumber(6)
  $core.bool hasDynamicAffiliateLocationSetFilter() => $_has(5);
  @$pb.TagNumber(6)
  void clearDynamicAffiliateLocationSetFilter() => clearField(6);
  @$pb.TagNumber(6)
  $0.DynamicAffiliateLocationSetFilter ensureDynamicAffiliateLocationSetFilter() => $_ensure(5);

  @$pb.TagNumber(8)
  $1.FeedItemSetStatusEnum_FeedItemSetStatus get status => $_getN(6);
  @$pb.TagNumber(8)
  set status($1.FeedItemSetStatusEnum_FeedItemSetStatus v) { setField(8, v); }
  @$pb.TagNumber(8)

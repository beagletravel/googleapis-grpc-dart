...
class AdGroupBidModifier extends $pb.GeneratedMessage {
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'AdGroupBidModifier', package: const $pb.PackageName(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'google.ads.googleads.v10.resources'), createEmptyInstance: create)
    ..oo(0, [5, 6, 7, 8, 11, 12, 17])
    ..aOS(1, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'resourceName')
    ..aOM<$0.HotelDateSelectionTypeInfo>(5, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'hotelDateSelectionType', subBuilder: $0.HotelDateSelectionTypeInfo.create)
    ..aOM<$0.HotelAdvanceBookingWindowInfo>(6, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'hotelAdvanceBookingWindow', subBuilder: $0.HotelAdvanceBookingWindowInfo.create)
    ..aOM<$0.HotelLengthOfStayInfo>(7, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'hotelLengthOfStay', subBuilder: $0.HotelLengthOfStayInfo.create)
    ..aOM<$0.HotelCheckInDayInfo>(8, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'hotelCheckInDay', subBuilder: $0.HotelCheckInDayInfo.create)
    ..e<$1.BidModifierSourceEnum_BidModifierSource>(10, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'bidModifierSource', $pb.PbFieldType.OE, defaultOrMaker: $1.BidModifierSourceEnum_BidModifierSource.UNSPECIFIED, valueOf: $1.BidModifierSourceEnum_BidModifierSource.valueOf, enumValues: $1.BidModifierSourceEnum_BidModifierSource.values)
    ..aOM<$0.DeviceInfo>(11, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'device', subBuilder: $0.DeviceInfo.create)
    ..aOM<$0.PreferredContentInfo>(12, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'preferredContent', subBuilder: $0.PreferredContentInfo.create)
    ..aOS(13, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'adGroup')
    ..aInt64(14, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'criterionId')
    ..a<$core.double>(15, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'bidModifier', $pb.PbFieldType.OD)
    ..aOS(16, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'baseAdGroup')
    ..aOM<$0.HotelCheckInDateRangeInfo>(17, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'hotelCheckInDateRange', subBuilder: $0.HotelCheckInDateRangeInfo.create)
  ...
  'Will be removed in next major version')
  AdGroupBidModifier copyWith(void Function(AdGroupBidModifier) updates) => super.copyWith((message) => updates(message as AdGroupBidModifier)) as AdGroupBidModifier; // ignore: deprecated_member_use
  ...
  @$pb.TagNumber(5)
  set hotelDateSelectionType($0.HotelDateSelectionTypeInfo v) { setField(5, v); }
  @$pb.TagNumber(5)
  ...
  @$pb.TagNumber(6)
  set hotelAdvanceBookingWindow($0.HotelAdvanceBookingWindowInfo v) { setField(6, v); }
  @$pb.TagNumber(6)
  $core.bool hasHotelAdvanceBookingWindow() => $_has(2);
  @$pb.TagNumber(6)
  void clearHotelAdvanceBookingWindow() => clearField(6);
  @$pb.TagNumber(6)
  $0.HotelAdvanceBookingWindowInfo ensureHotelAdvanceBookingWindow() => $_ensure(2);

  @$pb.TagNumber(7)
  $0.HotelLengthOfStayInfo get hotelLengthOfStay => $_getN(3);
  @$pb.TagNumber(7)
  set hotelLengthOfStay($0.HotelLengthOfStayInfo v) { setField(7, v); }
  @$pb.TagNumber(7)
  ...
  @$pb.TagNumber(8)
  set hotelCheckInDay($0.HotelCheckInDayInfo v) { setField(8, v); }
  @$pb.TagNumber(8)
  ...
  @$pb.TagNumber(10)
  set bidModifierSource($1.BidModifierSourceEnum_BidModifierSource v) { setField(10, v); }
  @$pb.TagNumber(10)
  ...
  @$pb.TagNumber(11)
  set device($0.DeviceInfo v) { setField(11, v); }
  @$pb.TagNumber(11)
  ...
  @$pb.TagNumber(12)
  set preferredContent($0.PreferredContentInfo v) { setField(12, v); }
  @$pb.TagNumber(12)
  ...
  @$pb.TagNumber(13)
  set adGroup($core.String v) { $_setString(8, v); }
  @$pb.TagNumber(13)
  ...
  @$pb.TagNumber(15)
  set bidModifier($core.double v) { $_setDouble(10, v); }
  @$pb.TagNumber(15)
  ...
  @$pb.TagNumber(17)
  set hotelCheckInDateRange($0.HotelCheckInDateRangeInfo v) { setField(17, v); }
  @$pb.TagNumber(17)

...
class AdGroupAsset extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'AdGroupAsset', package: const $pb.PackageName(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'google.ads.googleads.v10.resources'), createEmptyInstance: create)
    ..aOS(1, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'resourceName')
    ..aOS(2, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'adGroup')
  ...
  'Will be removed in next major version')
  AdGroupAsset copyWith(void Function(AdGroupAsset) updates) => super.copyWith((message) => updates(message as AdGroupAsset)) as AdGroupAsset; // ignore: deprecated_member_use

...
class BiddingSeasonalityAdjustment extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'BiddingSeasonalityAdjustment', package: const $pb.PackageName(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'google.ads.googleads.v10.resources'), createEmptyInstance: create)
    ..aOS(1, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'resourceName')
    ..aInt64(2, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'seasonalityAdjustmentId')
    ..e<$0.SeasonalityEventScopeEnum_SeasonalityEventScope>(3, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'scope', $pb.PbFieldType.OE, defaultOrMaker: $0.SeasonalityEventScopeEnum_SeasonalityEventScope.UNSPECIFIED, valueOf: $0.SeasonalityEventScopeEnum_SeasonalityEventScope.valueOf, enumValues: $0.SeasonalityEventScopeEnum_SeasonalityEventScope.values)
    ..e<$1.SeasonalityEventStatusEnum_SeasonalityEventStatus>(4, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'status', $pb.PbFieldType.OE, defaultOrMaker: $1.SeasonalityEventStatusEnum_SeasonalityEventStatus.UNSPECIFIED, valueOf: $1.SeasonalityEventStatusEnum_SeasonalityEventStatus.valueOf, enumValues: $1.SeasonalityEventStatusEnum_SeasonalityEventStatus.values)
    ..aOS(5, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'startDateTime')
    ..aOS(6, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'endDateTime')
    ...
    ..pc<$2.DeviceEnum_Device>(9, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'devices', $pb.PbFieldType.PE, valueOf: $2.DeviceEnum_Device.valueOf, enumValues: $2.DeviceEnum_Device.values)
    ..a<$core.double>(10, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'conversionRateModifier', $pb.PbFieldType.OD)
    ..pPS(11, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'campaigns')
    ..pc<$3.AdvertisingChannelTypeEnum_AdvertisingChannelType>(12, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'advertisingChannelTypes', $pb.PbFieldType.PE, valueOf: $3.AdvertisingChannelTypeEnum_AdvertisingChannelType.valueOf, enumValues: $3.AdvertisingChannelTypeEnum_AdvertisingChannelType.values)
  ...
  factory BiddingSeasonalityAdjustment({
    ...
    $core.Iterable<$3.AdvertisingChannelTypeEnum_AdvertisingChannelType>? advertisingChannelTypes,
  }) {
  ...
  'Will be removed in next major version')
  BiddingSeasonalityAdjustment copyWith(void Function(BiddingSeasonalityAdjustment) updates) => super.copyWith((message) => updates(message as BiddingSeasonalityAdjustment)) as BiddingSeasonalityAdjustment; // ignore: deprecated_member_use
  ...
  @$pb.TagNumber(3)
  set scope($0.SeasonalityEventScopeEnum_SeasonalityEventScope v) { setField(3, v); }
  @$pb.TagNumber(3)
  ...
  @$pb.TagNumber(4)
  set status($1.SeasonalityEventStatusEnum_SeasonalityEventStatus v) { setField(4, v); }
  @$pb.TagNumber(4)
  ...
  @$pb.TagNumber(12)
  $core.List<$3.AdvertisingChannelTypeEnum_AdvertisingChannelType> get advertisingChannelTypes => $_getList(11);
}

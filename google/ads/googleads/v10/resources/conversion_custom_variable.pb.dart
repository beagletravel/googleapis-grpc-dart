...
class ConversionCustomVariable extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'ConversionCustomVariable', package: const $pb.PackageName(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'google.ads.googleads.v10.resources'), createEmptyInstance: create)
    ...
    ..e<$0.ConversionCustomVariableStatusEnum_ConversionCustomVariableStatus>(5, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'status', $pb.PbFieldType.OE, defaultOrMaker: $0.ConversionCustomVariableStatusEnum_ConversionCustomVariableStatus.UNSPECIFIED, valueOf: $0.ConversionCustomVariableStatusEnum_ConversionCustomVariableStatus.valueOf, enumValues: $0.ConversionCustomVariableStatusEnum_ConversionCustomVariableStatus.values)
    ..aOS(6, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'ownerCustomer')
  ...
  factory ConversionCustomVariable({
    ...
    $core.String? name,
    $core.String? tag,
    $0.ConversionCustomVariableStatusEnum_ConversionCustomVariableStatus? status,
  ...
  'Will be removed in next major version')
  ConversionCustomVariable copyWith(void Function(ConversionCustomVariable) updates) => super.copyWith((message) => updates(message as ConversionCustomVariable)) as ConversionCustomVariable; // ignore: deprecated_member_use
  ...
  @$pb.TagNumber(5)
  $0.ConversionCustomVariableStatusEnum_ConversionCustomVariableStatus get status => $_getN(4);
  @$pb.TagNumber(5)
  set status($0.ConversionCustomVariableStatusEnum_ConversionCustomVariableStatus v) { setField(5, v); }
  @$pb.TagNumber(5)

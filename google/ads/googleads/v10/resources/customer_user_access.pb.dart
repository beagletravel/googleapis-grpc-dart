...
class CustomerUserAccess extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'CustomerUserAccess', package: const $pb.PackageName(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'google.ads.googleads.v10.resources'), createEmptyInstance: create)
    ...
    ..aOS(3, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'emailAddress')
    ..e<$0.AccessRoleEnum_AccessRole>(4, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'accessRole', $pb.PbFieldType.OE, defaultOrMaker: $0.AccessRoleEnum_AccessRole.UNSPECIFIED, valueOf: $0.AccessRoleEnum_AccessRole.valueOf, enumValues: $0.AccessRoleEnum_AccessRole.values)
    ..aOS(6, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'accessCreationDateTime')
    ..aOS(7, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'inviterUserEmailAddress')
  ...
  'Will be removed in next major version')
  CustomerUserAccess copyWith(void Function(CustomerUserAccess) updates) => super.copyWith((message) => updates(message as CustomerUserAccess)) as CustomerUserAccess; // ignore: deprecated_member_use
  ...
  @$pb.TagNumber(4)
  set accessRole($0.AccessRoleEnum_AccessRole v) { setField(4, v); }
  @$pb.TagNumber(4)

...
class UserList extends $pb.GeneratedMessage {
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'UserList', package: const $pb.PackageName(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'google.ads.googleads.v10.resources'), createEmptyInstance: create)
    ..oo(0, [19, 20, 21, 22, 23])
    ..aOS(1, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'resourceName')
    ..e<$1.UserListMembershipStatusEnum_UserListMembershipStatus>(6, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'membershipStatus', $pb.PbFieldType.OE, defaultOrMaker: $1.UserListMembershipStatusEnum_UserListMembershipStatus.UNSPECIFIED, valueOf: $1.UserListMembershipStatusEnum_UserListMembershipStatus.valueOf, enumValues: $1.UserListMembershipStatusEnum_UserListMembershipStatus.values)
    ..e<$2.UserListSizeRangeEnum_UserListSizeRange>(10, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'sizeRangeForDisplay', $pb.PbFieldType.OE, defaultOrMaker: $2.UserListSizeRangeEnum_UserListSizeRange.UNSPECIFIED, valueOf: $2.UserListSizeRangeEnum_UserListSizeRange.valueOf, enumValues: $2.UserListSizeRangeEnum_UserListSizeRange.values)
    ..e<$2.UserListSizeRangeEnum_UserListSizeRange>(12, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'sizeRangeForSearch', $pb.PbFieldType.OE, defaultOrMaker: $2.UserListSizeRangeEnum_UserListSizeRange.UNSPECIFIED, valueOf: $2.UserListSizeRangeEnum_UserListSizeRange.valueOf, enumValues: $2.UserListSizeRangeEnum_UserListSizeRange.values)
    ..e<$3.UserListTypeEnum_UserListType>(13, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'type', $pb.PbFieldType.OE, defaultOrMaker: $3.UserListTypeEnum_UserListType.UNSPECIFIED, valueOf: $3.UserListTypeEnum_UserListType.valueOf, enumValues: $3.UserListTypeEnum_UserListType.values)
    ..e<$4.UserListClosingReasonEnum_UserListClosingReason>(14, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'closingReason', $pb.PbFieldType.OE, defaultOrMaker: $4.UserListClosingReasonEnum_UserListClosingReason.UNSPECIFIED, valueOf: $4.UserListClosingReasonEnum_UserListClosingReason.valueOf, enumValues: $4.UserListClosingReasonEnum_UserListClosingReason.values)
    ..e<$5.AccessReasonEnum_AccessReason>(15, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'accessReason', $pb.PbFieldType.OE, defaultOrMaker: $5.AccessReasonEnum_AccessReason.UNSPECIFIED, valueOf: $5.AccessReasonEnum_AccessReason.valueOf, enumValues: $5.AccessReasonEnum_AccessReason.values)
    ..e<$6.UserListAccessStatusEnum_UserListAccessStatus>(16, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'accountUserListStatus', $pb.PbFieldType.OE, defaultOrMaker: $6.UserListAccessStatusEnum_UserListAccessStatus.UNSPECIFIED, valueOf: $6.UserListAccessStatusEnum_UserListAccessStatus.valueOf, enumValues: $6.UserListAccessStatusEnum_UserListAccessStatus.values)
    ..aOM<$0.CrmBasedUserListInfo>(19, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'crmBasedUserList', subBuilder: $0.CrmBasedUserListInfo.create)
    ..aOM<$0.SimilarUserListInfo>(20, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'similarUserList', subBuilder: $0.SimilarUserListInfo.create)
    ..aOM<$0.RuleBasedUserListInfo>(21, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'ruleBasedUserList', subBuilder: $0.RuleBasedUserListInfo.create)
    ..aOM<$0.LogicalUserListInfo>(22, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'logicalUserList', subBuilder: $0.LogicalUserListInfo.create)
    ..aOM<$0.BasicUserListInfo>(23, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'basicUserList', subBuilder: $0.BasicUserListInfo.create)
    ..a<$core.int>(24, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'matchRatePercentage', $pb.PbFieldType.O3)
    ..aInt64(25, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'id')
    ..aOB(26, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'readOnly')
    ..aOS(27, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'name')
    ..aOS(28, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'description')
    ..aOS(29, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'integrationCode')
    ..aInt64(30, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'membershipLifeSpan')
    ..aInt64(31, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'sizeForDisplay')
    ..aInt64(32, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'sizeForSearch')
    ..aOB(33, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'eligibleForSearch')
    ..aOB(34, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'eligibleForDisplay')
  ...
  @$pb.TagNumber(6)
  $1.UserListMembershipStatusEnum_UserListMembershipStatus get membershipStatus => $_getN(1);
  @$pb.TagNumber(6)
  set membershipStatus($1.UserListMembershipStatusEnum_UserListMembershipStatus v) { setField(6, v); }
  @$pb.TagNumber(6)
  ...
  @$pb.TagNumber(10)
  $2.UserListSizeRangeEnum_UserListSizeRange get sizeRangeForDisplay => $_getN(2);
  @$pb.TagNumber(10)
  set sizeRangeForDisplay($2.UserListSizeRangeEnum_UserListSizeRange v) { setField(10, v); }
  @$pb.TagNumber(10)
  ...
  @$pb.TagNumber(12)
  $2.UserListSizeRangeEnum_UserListSizeRange get sizeRangeForSearch => $_getN(3);
  @$pb.TagNumber(12)
  set sizeRangeForSearch($2.UserListSizeRangeEnum_UserListSizeRange v) { setField(12, v); }
  @$pb.TagNumber(12)
  ...
  @$pb.TagNumber(13)
  set type($3.UserListTypeEnum_UserListType v) { setField(13, v); }
  @$pb.TagNumber(13)
  ...
  @$pb.TagNumber(14)
  $4.UserListClosingReasonEnum_UserListClosingReason get closingReason => $_getN(5);
  @$pb.TagNumber(14)
  set closingReason($4.UserListClosingReasonEnum_UserListClosingReason v) { setField(14, v); }
  @$pb.TagNumber(14)
  ...
  @$pb.TagNumber(15)
  set accessReason($5.AccessReasonEnum_AccessReason v) { setField(15, v); }
  @$pb.TagNumber(15)
  ...
  @$pb.TagNumber(16)
  $6.UserListAccessStatusEnum_UserListAccessStatus get accountUserListStatus => $_getN(7);
  @$pb.TagNumber(16)
  set accountUserListStatus($6.UserListAccessStatusEnum_UserListAccessStatus v) { setField(16, v); }
  @$pb.TagNumber(16)
  ...
  @$pb.TagNumber(19)
  set crmBasedUserList($0.CrmBasedUserListInfo v) { setField(19, v); }
  @$pb.TagNumber(19)
  ...
  @$pb.TagNumber(20)
  set similarUserList($0.SimilarUserListInfo v) { setField(20, v); }
  @$pb.TagNumber(20)
  ...
  @$pb.TagNumber(21)
  set ruleBasedUserList($0.RuleBasedUserListInfo v) { setField(21, v); }
  @$pb.TagNumber(21)
  ...
  @$pb.TagNumber(22)
  set logicalUserList($0.LogicalUserListInfo v) { setField(22, v); }
  @$pb.TagNumber(22)
  ...
  @$pb.TagNumber(23)
  set basicUserList($0.BasicUserListInfo v) { setField(23, v); }
  @$pb.TagNumber(23)

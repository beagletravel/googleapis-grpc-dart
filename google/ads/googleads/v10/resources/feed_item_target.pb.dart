...
class FeedItemTarget extends $pb.GeneratedMessage {
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'FeedItemTarget', package: const $pb.PackageName(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'google.ads.googleads.v10.resources'), createEmptyInstance: create)
    ..oo(0, [7, 9, 10, 14, 15, 16])
    ..aOS(1, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'resourceName')
    ..e<$1.FeedItemTargetTypeEnum_FeedItemTargetType>(3, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'feedItemTargetType', $pb.PbFieldType.OE, defaultOrMaker: $1.FeedItemTargetTypeEnum_FeedItemTargetType.UNSPECIFIED, valueOf: $1.FeedItemTargetTypeEnum_FeedItemTargetType.valueOf, enumValues: $1.FeedItemTargetTypeEnum_FeedItemTargetType.values)
    ..aOM<$0.KeywordInfo>(7, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'keyword', subBuilder: $0.KeywordInfo.create)
    ..e<$2.FeedItemTargetDeviceEnum_FeedItemTargetDevice>(9, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'device', $pb.PbFieldType.OE, defaultOrMaker: $2.FeedItemTargetDeviceEnum_FeedItemTargetDevice.UNSPECIFIED, valueOf: $2.FeedItemTargetDeviceEnum_FeedItemTargetDevice.valueOf, enumValues: $2.FeedItemTargetDeviceEnum_FeedItemTargetDevice.values)
    ..aOM<$0.AdScheduleInfo>(10, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'adSchedule', subBuilder: $0.AdScheduleInfo.create)
    ..e<$3.FeedItemTargetStatusEnum_FeedItemTargetStatus>(11, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'status', $pb.PbFieldType.OE, defaultOrMaker: $3.FeedItemTargetStatusEnum_FeedItemTargetStatus.UNSPECIFIED, valueOf: $3.FeedItemTargetStatusEnum_FeedItemTargetStatus.valueOf, enumValues: $3.FeedItemTargetStatusEnum_FeedItemTargetStatus.values)
    ..aOS(12, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'feedItem')
    ..aInt64(13, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'feedItemTargetId')
    ..aOS(14, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'campaign')
    ..aOS(15, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'adGroup')
    ..aOS(16, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'geoTargetConstant')
  ...
  'Will be removed in next major version')
  FeedItemTarget copyWith(void Function(FeedItemTarget) updates) => super.copyWith((message) => updates(message as FeedItemTarget)) as FeedItemTarget; // ignore: deprecated_member_use
  ...
  @$pb.TagNumber(3)
  $1.FeedItemTargetTypeEnum_FeedItemTargetType get feedItemTargetType => $_getN(1);
  @$pb.TagNumber(3)
  set feedItemTargetType($1.FeedItemTargetTypeEnum_FeedItemTargetType v) { setField(3, v); }
  @$pb.TagNumber(3)
  ...
  @$pb.TagNumber(7)
  set keyword($0.KeywordInfo v) { setField(7, v); }
  @$pb.TagNumber(7)
  ...
  @$pb.TagNumber(9)
  set device($2.FeedItemTargetDeviceEnum_FeedItemTargetDevice v) { setField(9, v); }
  @$pb.TagNumber(9)
  ...
  @$pb.TagNumber(10)
  set adSchedule($0.AdScheduleInfo v) { setField(10, v); }
  @$pb.TagNumber(10)
  ...
  @$pb.TagNumber(11)
  set status($3.FeedItemTargetStatusEnum_FeedItemTargetStatus v) { setField(11, v); }
  @$pb.TagNumber(11)

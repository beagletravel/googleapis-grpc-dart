...
class AdGroupLabel extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'AdGroupLabel', package: const $pb.PackageName(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'google.ads.googleads.v10.resources'), createEmptyInstance: create)
  ...
  'Will be removed in next major version')
  AdGroupLabel copyWith(void Function(AdGroupLabel) updates) => super.copyWith((message) => updates(message as AdGroupLabel)) as AdGroupLabel; // ignore: deprecated_member_use

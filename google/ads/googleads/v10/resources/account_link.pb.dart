...
class AccountLink extends $pb.GeneratedMessage {
  static const $core.Map<$core.int, AccountLink_LinkedAccount> _AccountLink_LinkedAccountByTag = {
    ...
    9 : AccountLink_LinkedAccount.hotelCenter,
    0 : AccountLink_LinkedAccount.notSet
  };
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'AccountLink', package: const $pb.PackageName(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'google.ads.googleads.v10.resources'), createEmptyInstance: create)
    ..oo(0, [5, 6, 7, 9])
    ..aOS(1, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'resourceName')
    ..e<$0.AccountLinkStatusEnum_AccountLinkStatus>(3, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'status', $pb.PbFieldType.OE, defaultOrMaker: $0.AccountLinkStatusEnum_AccountLinkStatus.UNSPECIFIED, valueOf: $0.AccountLinkStatusEnum_AccountLinkStatus.valueOf, enumValues: $0.AccountLinkStatusEnum_AccountLinkStatus.values)
    ..e<$1.LinkedAccountTypeEnum_LinkedAccountType>(4, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'type', $pb.PbFieldType.OE, defaultOrMaker: $1.LinkedAccountTypeEnum_LinkedAccountType.UNSPECIFIED, valueOf: $1.LinkedAccountTypeEnum_LinkedAccountType.valueOf, enumValues: $1.LinkedAccountTypeEnum_LinkedAccountType.values)
    ..aOM<ThirdPartyAppAnalyticsLinkIdentifier>(5, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'thirdPartyAppAnalytics', subBuilder: ThirdPartyAppAnalyticsLinkIdentifier.create)
    ..aOM<DataPartnerLinkIdentifier>(6, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'dataPartner', subBuilder: DataPartnerLinkIdentifier.create)
    ..aOM<GoogleAdsLinkIdentifier>(7, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'googleAds', subBuilder: GoogleAdsLinkIdentifier.create)
    ..aInt64(8, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'accountLinkId')
    ..aOM<HotelCenterLinkIdentifier>(9, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'hotelCenter', subBuilder: HotelCenterLinkIdentifier.create)
  ...
  factory AccountLink({
    ...
    HotelCenterLinkIdentifier? hotelCenter,
  }) {
    ...
    if (hotelCenter != null) {
      _result.hotelCenter = hotelCenter;
    }
    return _result;
  }
  ...
  'Will be removed in next major version')
  AccountLink copyWith(void Function(AccountLink) updates) => super.copyWith((message) => updates(message as AccountLink)) as AccountLink; // ignore: deprecated_member_use
  ...
  @$pb.TagNumber(3)
  set status($0.AccountLinkStatusEnum_AccountLinkStatus v) { setField(3, v); }
  @$pb.TagNumber(3)
  ...
  @$pb.TagNumber(4)
  set type($1.LinkedAccountTypeEnum_LinkedAccountType v) { setField(4, v); }
  @$pb.TagNumber(4)
  ...
  @$pb.TagNumber(9)
  HotelCenterLinkIdentifier get hotelCenter => $_getN(7);
  @$pb.TagNumber(9)
  set hotelCenter(HotelCenterLinkIdentifier v) { setField(9, v); }
  @$pb.TagNumber(9)
  $core.bool hasHotelCenter() => $_has(7);
  @$pb.TagNumber(9)
  void clearHotelCenter() => clearField(9);
  @$pb.TagNumber(9)
  HotelCenterLinkIdentifier ensureHotelCenter() => $_ensure(7);
}

class ThirdPartyAppAnalyticsLinkIdentifier extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'ThirdPartyAppAnalyticsLinkIdentifier', package: const $pb.PackageName(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'google.ads.googleads.v10.resources'), createEmptyInstance: create)
    ..e<$2.MobileAppVendorEnum_MobileAppVendor>(3, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'appVendor', $pb.PbFieldType.OE, defaultOrMaker: $2.MobileAppVendorEnum_MobileAppVendor.UNSPECIFIED, valueOf: $2.MobileAppVendorEnum_MobileAppVendor.valueOf, enumValues: $2.MobileAppVendorEnum_MobileAppVendor.values)
    ..aInt64(4, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'appAnalyticsProviderId')
  ...
  'Use [GeneratedMessageGenericExtensions.rebuild] instead. '
  'Will be removed in next major version')
  ThirdPartyAppAnalyticsLinkIdentifier copyWith(void Function(ThirdPartyAppAnalyticsLinkIdentifier) updates) => super.copyWith((message) => updates(message as ThirdPartyAppAnalyticsLinkIdentifier)) as ThirdPartyAppAnalyticsLinkIdentifier; // ignore: deprecated_member_use
  $pb.BuilderInfo get info_ => _i;
  @$core.pragma('dart2js:noInline')
  ...
  @$pb.TagNumber(3)
  set appVendor($2.MobileAppVendorEnum_MobileAppVendor v) { setField(3, v); }
  @$pb.TagNumber(3)
...
class DataPartnerLinkIdentifier extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'DataPartnerLinkIdentifier', package: const $pb.PackageName(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'google.ads.googleads.v10.resources'), createEmptyInstance: create)
    ..aInt64(1, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'dataPartnerId')
    ..hasRequiredFields = false
  ;
  ...
  'Use [GeneratedMessageGenericExtensions.rebuild] instead. '
  'Will be removed in next major version')
  DataPartnerLinkIdentifier copyWith(void Function(DataPartnerLinkIdentifier) updates) => super.copyWith((message) => updates(message as DataPartnerLinkIdentifier)) as DataPartnerLinkIdentifier; // ignore: deprecated_member_use
  $pb.BuilderInfo get info_ => _i;
  @$core.pragma('dart2js:noInline')
...
class HotelCenterLinkIdentifier extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'HotelCenterLinkIdentifier', package: const $pb.PackageName(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'google.ads.googleads.v10.resources'), createEmptyInstance: create)
    ..aInt64(1, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'hotelCenterId')
    ..hasRequiredFields = false
  ;

  HotelCenterLinkIdentifier._() : super();
  factory HotelCenterLinkIdentifier({
  ...
  factory HotelCenterLinkIdentifier.fromBuffer($core.List<$core.int> i, [$pb.ExtensionRegistry r = $pb.ExtensionRegistry.EMPTY]) => create()..mergeFromBuffer(i, r);
  factory HotelCenterLinkIdentifier.fromJson($core.String i, [$pb.ExtensionRegistry r = $pb.ExtensionRegistry.EMPTY]) => create()..mergeFromJson(i, r);
  @$core.Deprecated(
  'Using this can add significant overhead to your binary. '
  'Use [GeneratedMessageGenericExtensions.deepCopy] instead. '
  'Will be removed in next major version')
  HotelCenterLinkIdentifier clone() => HotelCenterLinkIdentifier()..mergeFromMessage(this);
  @$core.Deprecated(
  'Using this can add significant overhead to your binary. '
  'Use [GeneratedMessageGenericExtensions.rebuild] instead. '
  'Will be removed in next major version')
  HotelCenterLinkIdentifier copyWith(void Function(HotelCenterLinkIdentifier) updates) => super.copyWith((message) => updates(message as HotelCenterLinkIdentifier)) as HotelCenterLinkIdentifier; // ignore: deprecated_member_use
  $pb.BuilderInfo get info_ => _i;
  @$core.pragma('dart2js:noInline')
  static HotelCenterLinkIdentifier create() => HotelCenterLinkIdentifier._();
  HotelCenterLinkIdentifier createEmptyInstance() => create();
  static $pb.PbList<HotelCenterLinkIdentifier> createRepeated() => $pb.PbList<HotelCenterLinkIdentifier>();
  @$core.pragma('dart2js:noInline')
  static HotelCenterLinkIdentifier getDefault() => _defaultInstance ??= $pb.GeneratedMessage.$_defaultFor<HotelCenterLinkIdentifier>(create);
  static HotelCenterLinkIdentifier? _defaultInstance;
...
class GoogleAdsLinkIdentifier extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'GoogleAdsLinkIdentifier', package: const $pb.PackageName(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'google.ads.googleads.v10.resources'), createEmptyInstance: create)
    ..aOS(3, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'customer')
    ..hasRequiredFields = false
  ;
  ...
  'Use [GeneratedMessageGenericExtensions.rebuild] instead. '
  'Will be removed in next major version')
  GoogleAdsLinkIdentifier copyWith(void Function(GoogleAdsLinkIdentifier) updates) => super.copyWith((message) => updates(message as GoogleAdsLinkIdentifier)) as GoogleAdsLinkIdentifier; // ignore: deprecated_member_use
  $pb.BuilderInfo get info_ => _i;
  @$core.pragma('dart2js:noInline')

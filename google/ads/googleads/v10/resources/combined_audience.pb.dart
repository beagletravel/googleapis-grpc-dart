...
class CombinedAudience extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'CombinedAudience', package: const $pb.PackageName(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'google.ads.googleads.v10.resources'), createEmptyInstance: create)
    ...
    ..e<$0.CombinedAudienceStatusEnum_CombinedAudienceStatus>(3, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'status', $pb.PbFieldType.OE, defaultOrMaker: $0.CombinedAudienceStatusEnum_CombinedAudienceStatus.UNSPECIFIED, valueOf: $0.CombinedAudienceStatusEnum_CombinedAudienceStatus.valueOf, enumValues: $0.CombinedAudienceStatusEnum_CombinedAudienceStatus.values)
  ...
  'Will be removed in next major version')
  CombinedAudience copyWith(void Function(CombinedAudience) updates) => super.copyWith((message) => updates(message as CombinedAudience)) as CombinedAudience; // ignore: deprecated_member_use
  ...
  @$pb.TagNumber(3)
  set status($0.CombinedAudienceStatusEnum_CombinedAudienceStatus v) { setField(3, v); }
  @$pb.TagNumber(3)

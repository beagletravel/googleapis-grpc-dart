...
class SharedSet extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'SharedSet', package: const $pb.PackageName(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'google.ads.googleads.v10.resources'), createEmptyInstance: create)
    ..aOS(1, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'resourceName')
    ..e<$0.SharedSetTypeEnum_SharedSetType>(3, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'type', $pb.PbFieldType.OE, defaultOrMaker: $0.SharedSetTypeEnum_SharedSetType.UNSPECIFIED, valueOf: $0.SharedSetTypeEnum_SharedSetType.valueOf, enumValues: $0.SharedSetTypeEnum_SharedSetType.values)
    ..e<$1.SharedSetStatusEnum_SharedSetStatus>(5, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'status', $pb.PbFieldType.OE, defaultOrMaker: $1.SharedSetStatusEnum_SharedSetStatus.UNSPECIFIED, valueOf: $1.SharedSetStatusEnum_SharedSetStatus.valueOf, enumValues: $1.SharedSetStatusEnum_SharedSetStatus.values)
    ...
    ..aInt64(10, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'memberCount')
    ..aInt64(11, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'referenceCount')
  ...
  'Will be removed in next major version')
  SharedSet copyWith(void Function(SharedSet) updates) => super.copyWith((message) => updates(message as SharedSet)) as SharedSet; // ignore: deprecated_member_use
  ...
  @$pb.TagNumber(3)
  set type($0.SharedSetTypeEnum_SharedSetType v) { setField(3, v); }
  @$pb.TagNumber(3)
  ...
  @$pb.TagNumber(5)
  set status($1.SharedSetStatusEnum_SharedSetStatus v) { setField(5, v); }
  @$pb.TagNumber(5)

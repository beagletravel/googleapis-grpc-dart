...
class IncomeRangeView extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'IncomeRangeView', package: const $pb.PackageName(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'google.ads.googleads.v10.resources'), createEmptyInstance: create)
  ...
  'Will be removed in next major version')
  IncomeRangeView copyWith(void Function(IncomeRangeView) updates) => super.copyWith((message) => updates(message as IncomeRangeView)) as IncomeRangeView; // ignore: deprecated_member_use

...
class DistanceView extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'DistanceView', package: const $pb.PackageName(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'google.ads.googleads.v10.resources'), createEmptyInstance: create)
    ..aOS(1, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'resourceName')
    ..e<$0.DistanceBucketEnum_DistanceBucket>(2, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'distanceBucket', $pb.PbFieldType.OE, defaultOrMaker: $0.DistanceBucketEnum_DistanceBucket.UNSPECIFIED, valueOf: $0.DistanceBucketEnum_DistanceBucket.valueOf, enumValues: $0.DistanceBucketEnum_DistanceBucket.values)
    ..aOB(4, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'metricSystem')
  ...
  'Will be removed in next major version')
  DistanceView copyWith(void Function(DistanceView) updates) => super.copyWith((message) => updates(message as DistanceView)) as DistanceView; // ignore: deprecated_member_use
  ...
  @$pb.TagNumber(2)
  set distanceBucket($0.DistanceBucketEnum_DistanceBucket v) { setField(2, v); }
  @$pb.TagNumber(2)

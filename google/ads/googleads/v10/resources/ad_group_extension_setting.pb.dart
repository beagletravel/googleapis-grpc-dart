...
class AdGroupExtensionSetting extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'AdGroupExtensionSetting', package: const $pb.PackageName(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'google.ads.googleads.v10.resources'), createEmptyInstance: create)
  ...
  'Will be removed in next major version')
  AdGroupExtensionSetting copyWith(void Function(AdGroupExtensionSetting) updates) => super.copyWith((message) => updates(message as AdGroupExtensionSetting)) as AdGroupExtensionSetting; // ignore: deprecated_member_use

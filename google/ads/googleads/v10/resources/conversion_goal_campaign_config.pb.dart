...
class ConversionGoalCampaignConfig extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'ConversionGoalCampaignConfig', package: const $pb.PackageName(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'google.ads.googleads.v10.resources'), createEmptyInstance: create)
    ...
    ..e<$0.GoalConfigLevelEnum_GoalConfigLevel>(3, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'goalConfigLevel', $pb.PbFieldType.OE, defaultOrMaker: $0.GoalConfigLevelEnum_GoalConfigLevel.UNSPECIFIED, valueOf: $0.GoalConfigLevelEnum_GoalConfigLevel.valueOf, enumValues: $0.GoalConfigLevelEnum_GoalConfigLevel.values)
    ..aOS(4, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'customConversionGoal')
  ...
  'Will be removed in next major version')
  ConversionGoalCampaignConfig copyWith(void Function(ConversionGoalCampaignConfig) updates) => super.copyWith((message) => updates(message as ConversionGoalCampaignConfig)) as ConversionGoalCampaignConfig; // ignore: deprecated_member_use
  ...
  @$pb.TagNumber(3)
  set goalConfigLevel($0.GoalConfigLevelEnum_GoalConfigLevel v) { setField(3, v); }
  @$pb.TagNumber(3)

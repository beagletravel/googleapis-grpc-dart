...
class Label extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'Label', package: const $pb.PackageName(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'google.ads.googleads.v10.resources'), createEmptyInstance: create)
    ..aOS(1, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'resourceName')
    ..e<$1.LabelStatusEnum_LabelStatus>(4, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'status', $pb.PbFieldType.OE, defaultOrMaker: $1.LabelStatusEnum_LabelStatus.UNSPECIFIED, valueOf: $1.LabelStatusEnum_LabelStatus.valueOf, enumValues: $1.LabelStatusEnum_LabelStatus.values)
    ..aOM<$0.TextLabel>(5, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'textLabel', subBuilder: $0.TextLabel.create)
  ...
  @$pb.TagNumber(4)
  set status($1.LabelStatusEnum_LabelStatus v) { setField(4, v); }
  @$pb.TagNumber(4)
  ...
  @$pb.TagNumber(5)
  set textLabel($0.TextLabel v) { setField(5, v); }
  @$pb.TagNumber(5)

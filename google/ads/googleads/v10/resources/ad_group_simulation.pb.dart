...
class AdGroupSimulation extends $pb.GeneratedMessage {
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'AdGroupSimulation', package: const $pb.PackageName(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'google.ads.googleads.v10.resources'), createEmptyInstance: create)
    ..oo(0, [8, 9, 10, 11])
    ...
    ..aOM<$0.CpcBidSimulationPointList>(8, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'cpcBidPointList', subBuilder: $0.CpcBidSimulationPointList.create)
    ..aOM<$0.TargetCpaSimulationPointList>(9, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'targetCpaPointList', subBuilder: $0.TargetCpaSimulationPointList.create)
    ..aOM<$0.CpvBidSimulationPointList>(10, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'cpvBidPointList', subBuilder: $0.CpvBidSimulationPointList.create)
    ..aOM<$0.TargetRoasSimulationPointList>(11, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'targetRoasPointList', subBuilder: $0.TargetRoasSimulationPointList.create)
    ..aInt64(12, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'adGroupId')
    ..aOS(13, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'startDate')
    ..aOS(14, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'endDate')
  ...
  'Will be removed in next major version')
  AdGroupSimulation copyWith(void Function(AdGroupSimulation) updates) => super.copyWith((message) => updates(message as AdGroupSimulation)) as AdGroupSimulation; // ignore: deprecated_member_use
  ...
  @$pb.TagNumber(4)
  $2.SimulationModificationMethodEnum_SimulationModificationMethod get modificationMethod => $_getN(2);
  @$pb.TagNumber(4)
  ...
  @$pb.TagNumber(8)
  set cpcBidPointList($0.CpcBidSimulationPointList v) { setField(8, v); }
  @$pb.TagNumber(8)
  ...
  @$pb.TagNumber(9)
  set targetCpaPointList($0.TargetCpaSimulationPointList v) { setField(9, v); }
  @$pb.TagNumber(9)
  ...
  @$pb.TagNumber(10)
  set cpvBidPointList($0.CpvBidSimulationPointList v) { setField(10, v); }
  @$pb.TagNumber(10)
  ...
  @$pb.TagNumber(11)
  set targetRoasPointList($0.TargetRoasSimulationPointList v) { setField(11, v); }
  @$pb.TagNumber(11)

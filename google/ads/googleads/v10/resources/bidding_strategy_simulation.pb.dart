...
class BiddingStrategySimulation extends $pb.GeneratedMessage {
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'BiddingStrategySimulation', package: const $pb.PackageName(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'google.ads.googleads.v10.resources'), createEmptyInstance: create)
    ..oo(0, [7, 8])
    ..aOS(1, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'resourceName')
    ..aInt64(2, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'biddingStrategyId')
    ...
    ..aOM<$0.TargetCpaSimulationPointList>(7, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'targetCpaPointList', subBuilder: $0.TargetCpaSimulationPointList.create)
    ..aOM<$0.TargetRoasSimulationPointList>(8, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'targetRoasPointList', subBuilder: $0.TargetRoasSimulationPointList.create)
  ...
  factory BiddingStrategySimulation({
    ...
    if (biddingStrategyId != null) {
      _result.biddingStrategyId = biddingStrategyId;
    }
    if (type != null) {
      _result.type = type;
    }
  ...
  'Will be removed in next major version')
  BiddingStrategySimulation copyWith(void Function(BiddingStrategySimulation) updates) => super.copyWith((message) => updates(message as BiddingStrategySimulation)) as BiddingStrategySimulation; // ignore: deprecated_member_use
  ...
  @$pb.TagNumber(7)
  $0.TargetCpaSimulationPointList get targetCpaPointList => $_getN(6);
  @$pb.TagNumber(7)
  set targetCpaPointList($0.TargetCpaSimulationPointList v) { setField(7, v); }
  @$pb.TagNumber(7)
  $core.bool hasTargetCpaPointList() => $_has(6);
  @$pb.TagNumber(7)
  void clearTargetCpaPointList() => clearField(7);
  @$pb.TagNumber(7)
  $0.TargetCpaSimulationPointList ensureTargetCpaPointList() => $_ensure(6);

  @$pb.TagNumber(8)
  $0.TargetRoasSimulationPointList get targetRoasPointList => $_getN(7);
  @$pb.TagNumber(8)
  set targetRoasPointList($0.TargetRoasSimulationPointList v) { setField(8, v); }
  @$pb.TagNumber(8)
  $core.bool hasTargetRoasPointList() => $_has(7);
  @$pb.TagNumber(8)
  void clearTargetRoasPointList() => clearField(8);
  @$pb.TagNumber(8)
  $0.TargetRoasSimulationPointList ensureTargetRoasPointList() => $_ensure(7);
}

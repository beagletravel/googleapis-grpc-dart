...
class OperatingSystemVersionConstant extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'OperatingSystemVersionConstant', package: const $pb.PackageName(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'google.ads.googleads.v10.resources'), createEmptyInstance: create)
    ..aOS(1, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'resourceName')
    ..e<$0.OperatingSystemVersionOperatorTypeEnum_OperatingSystemVersionOperatorType>(6, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'operatorType', $pb.PbFieldType.OE, defaultOrMaker: $0.OperatingSystemVersionOperatorTypeEnum_OperatingSystemVersionOperatorType.UNSPECIFIED, valueOf: $0.OperatingSystemVersionOperatorTypeEnum_OperatingSystemVersionOperatorType.valueOf, enumValues: $0.OperatingSystemVersionOperatorTypeEnum_OperatingSystemVersionOperatorType.values)
    ...
    ..a<$core.int>(9, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'osMajorVersion', $pb.PbFieldType.O3)
    ..a<$core.int>(10, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'osMinorVersion', $pb.PbFieldType.O3)
  ...
  factory OperatingSystemVersionConstant({
    ...
    $0.OperatingSystemVersionOperatorTypeEnum_OperatingSystemVersionOperatorType? operatorType,
    $fixnum.Int64? id,
    $core.String? name,
  ...
  'Will be removed in next major version')
  OperatingSystemVersionConstant copyWith(void Function(OperatingSystemVersionConstant) updates) => super.copyWith((message) => updates(message as OperatingSystemVersionConstant)) as OperatingSystemVersionConstant; // ignore: deprecated_member_use
  ...
  @$pb.TagNumber(6)
  $0.OperatingSystemVersionOperatorTypeEnum_OperatingSystemVersionOperatorType get operatorType => $_getN(1);
  @$pb.TagNumber(6)
  set operatorType($0.OperatingSystemVersionOperatorTypeEnum_OperatingSystemVersionOperatorType v) { setField(6, v); }
  @$pb.TagNumber(6)

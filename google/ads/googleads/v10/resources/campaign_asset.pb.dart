...
class CampaignAsset extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'CampaignAsset', package: const $pb.PackageName(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'google.ads.googleads.v10.resources'), createEmptyInstance: create)
    ..aOS(1, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'resourceName')
    ..e<$0.AssetFieldTypeEnum_AssetFieldType>(4, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'fieldType', $pb.PbFieldType.OE, defaultOrMaker: $0.AssetFieldTypeEnum_AssetFieldType.UNSPECIFIED, valueOf: $0.AssetFieldTypeEnum_AssetFieldType.valueOf, enumValues: $0.AssetFieldTypeEnum_AssetFieldType.values)
    ..e<$1.AssetLinkStatusEnum_AssetLinkStatus>(5, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'status', $pb.PbFieldType.OE, defaultOrMaker: $1.AssetLinkStatusEnum_AssetLinkStatus.UNSPECIFIED, valueOf: $1.AssetLinkStatusEnum_AssetLinkStatus.valueOf, enumValues: $1.AssetLinkStatusEnum_AssetLinkStatus.values)
    ..aOS(6, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'campaign')
  ...
  'Will be removed in next major version')
  CampaignAsset copyWith(void Function(CampaignAsset) updates) => super.copyWith((message) => updates(message as CampaignAsset)) as CampaignAsset; // ignore: deprecated_member_use
  ...
  @$pb.TagNumber(4)
  set fieldType($0.AssetFieldTypeEnum_AssetFieldType v) { setField(4, v); }
  @$pb.TagNumber(4)
  ...
  @$pb.TagNumber(5)
  set status($1.AssetLinkStatusEnum_AssetLinkStatus v) { setField(5, v); }
  @$pb.TagNumber(5)

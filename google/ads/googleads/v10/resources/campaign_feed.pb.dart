...
class CampaignFeed extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'CampaignFeed', package: const $pb.PackageName(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'google.ads.googleads.v10.resources'), createEmptyInstance: create)
    ..aOS(1, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'resourceName')
    ..pc<$1.PlaceholderTypeEnum_PlaceholderType>(4, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'placeholderTypes', $pb.PbFieldType.PE, valueOf: $1.PlaceholderTypeEnum_PlaceholderType.valueOf, enumValues: $1.PlaceholderTypeEnum_PlaceholderType.values)
    ..aOM<$0.MatchingFunction>(5, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'matchingFunction', subBuilder: $0.MatchingFunction.create)
    ..e<$2.FeedLinkStatusEnum_FeedLinkStatus>(6, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'status', $pb.PbFieldType.OE, defaultOrMaker: $2.FeedLinkStatusEnum_FeedLinkStatus.UNSPECIFIED, valueOf: $2.FeedLinkStatusEnum_FeedLinkStatus.valueOf, enumValues: $2.FeedLinkStatusEnum_FeedLinkStatus.values)
    ..aOS(7, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'feed')
    ..aOS(8, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'campaign')
  ...
  'Will be removed in next major version')
  CampaignFeed copyWith(void Function(CampaignFeed) updates) => super.copyWith((message) => updates(message as CampaignFeed)) as CampaignFeed; // ignore: deprecated_member_use
  ...
  @$pb.TagNumber(4)
  $core.List<$1.PlaceholderTypeEnum_PlaceholderType> get placeholderTypes => $_getList(1);

  @$pb.TagNumber(5)
  $0.MatchingFunction get matchingFunction => $_getN(2);
  @$pb.TagNumber(5)
  set matchingFunction($0.MatchingFunction v) { setField(5, v); }
  @$pb.TagNumber(5)
  ...
  @$pb.TagNumber(6)
  set status($2.FeedLinkStatusEnum_FeedLinkStatus v) { setField(6, v); }
  @$pb.TagNumber(6)

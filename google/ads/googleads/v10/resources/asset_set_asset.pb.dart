...
class AssetSetAsset extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'AssetSetAsset', package: const $pb.PackageName(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'google.ads.googleads.v10.resources'), createEmptyInstance: create)
    ..aOS(1, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'resourceName')
    ..aOS(2, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'assetSet')
    ..aOS(3, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'asset')
    ..e<$0.AssetSetAssetStatusEnum_AssetSetAssetStatus>(4, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'status', $pb.PbFieldType.OE, defaultOrMaker: $0.AssetSetAssetStatusEnum_AssetSetAssetStatus.UNSPECIFIED, valueOf: $0.AssetSetAssetStatusEnum_AssetSetAssetStatus.valueOf, enumValues: $0.AssetSetAssetStatusEnum_AssetSetAssetStatus.values)
  ...
  'Will be removed in next major version')
  AssetSetAsset copyWith(void Function(AssetSetAsset) updates) => super.copyWith((message) => updates(message as AssetSetAsset)) as AssetSetAsset; // ignore: deprecated_member_use
  ...
  @$pb.TagNumber(4)
  set status($0.AssetSetAssetStatusEnum_AssetSetAssetStatus v) { setField(4, v); }
  @$pb.TagNumber(4)

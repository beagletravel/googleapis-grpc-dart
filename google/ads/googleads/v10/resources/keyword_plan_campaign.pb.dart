...
class KeywordPlanCampaign extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'KeywordPlanCampaign', package: const $pb.PackageName(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'google.ads.googleads.v10.resources'), createEmptyInstance: create)
    ..aOS(1, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'resourceName')
    ..e<$0.KeywordPlanNetworkEnum_KeywordPlanNetwork>(6, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'keywordPlanNetwork', $pb.PbFieldType.OE, defaultOrMaker: $0.KeywordPlanNetworkEnum_KeywordPlanNetwork.UNSPECIFIED, valueOf: $0.KeywordPlanNetworkEnum_KeywordPlanNetwork.valueOf, enumValues: $0.KeywordPlanNetworkEnum_KeywordPlanNetwork.values)
    ..pc<KeywordPlanGeoTarget>(8, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'geoTargets', $pb.PbFieldType.PM, subBuilder: KeywordPlanGeoTarget.create)
    ..aOS(9, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'keywordPlan')
    ...
    ..pPS(12, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'languageConstants')
    ..aInt64(13, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'cpcBidMicros')
  ...
  'Will be removed in next major version')
  KeywordPlanCampaign copyWith(void Function(KeywordPlanCampaign) updates) => super.copyWith((message) => updates(message as KeywordPlanCampaign)) as KeywordPlanCampaign; // ignore: deprecated_member_use
  ...
  @$pb.TagNumber(6)
  $0.KeywordPlanNetworkEnum_KeywordPlanNetwork get keywordPlanNetwork => $_getN(1);
  @$pb.TagNumber(6)
  set keywordPlanNetwork($0.KeywordPlanNetworkEnum_KeywordPlanNetwork v) { setField(6, v); }
  @$pb.TagNumber(6)
...
class KeywordPlanGeoTarget extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'KeywordPlanGeoTarget', package: const $pb.PackageName(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'google.ads.googleads.v10.resources'), createEmptyInstance: create)
  ...
  'Use [GeneratedMessageGenericExtensions.rebuild] instead. '
  'Will be removed in next major version')
  KeywordPlanGeoTarget copyWith(void Function(KeywordPlanGeoTarget) updates) => super.copyWith((message) => updates(message as KeywordPlanGeoTarget)) as KeywordPlanGeoTarget; // ignore: deprecated_member_use
  $pb.BuilderInfo get info_ => _i;
  @$core.pragma('dart2js:noInline')

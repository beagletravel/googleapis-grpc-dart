...
class ParentalStatusView extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'ParentalStatusView', package: const $pb.PackageName(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'google.ads.googleads.v10.resources'), createEmptyInstance: create)
  ...
  'Will be removed in next major version')
  ParentalStatusView copyWith(void Function(ParentalStatusView) updates) => super.copyWith((message) => updates(message as ParentalStatusView)) as ParentalStatusView; // ignore: deprecated_member_use

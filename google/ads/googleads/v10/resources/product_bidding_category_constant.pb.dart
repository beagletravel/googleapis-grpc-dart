...
class ProductBiddingCategoryConstant extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'ProductBiddingCategoryConstant', package: const $pb.PackageName(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'google.ads.googleads.v10.resources'), createEmptyInstance: create)
    ..aOS(1, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'resourceName')
    ..e<$0.ProductBiddingCategoryLevelEnum_ProductBiddingCategoryLevel>(5, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'level', $pb.PbFieldType.OE, defaultOrMaker: $0.ProductBiddingCategoryLevelEnum_ProductBiddingCategoryLevel.UNSPECIFIED, valueOf: $0.ProductBiddingCategoryLevelEnum_ProductBiddingCategoryLevel.valueOf, enumValues: $0.ProductBiddingCategoryLevelEnum_ProductBiddingCategoryLevel.values)
    ..e<$1.ProductBiddingCategoryStatusEnum_ProductBiddingCategoryStatus>(6, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'status', $pb.PbFieldType.OE, defaultOrMaker: $1.ProductBiddingCategoryStatusEnum_ProductBiddingCategoryStatus.UNSPECIFIED, valueOf: $1.ProductBiddingCategoryStatusEnum_ProductBiddingCategoryStatus.valueOf, enumValues: $1.ProductBiddingCategoryStatusEnum_ProductBiddingCategoryStatus.values)
    ...
    ..aOS(12, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'productBiddingCategoryConstantParent')
    ..aOS(13, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'languageCode')
    ..aOS(14, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'localizedName')
  ...
  factory ProductBiddingCategoryConstant({
    ...
    if (productBiddingCategoryConstantParent != null) {
      _result.productBiddingCategoryConstantParent = productBiddingCategoryConstantParent;
    }
  ...
  'Will be removed in next major version')
  ProductBiddingCategoryConstant copyWith(void Function(ProductBiddingCategoryConstant) updates) => super.copyWith((message) => updates(message as ProductBiddingCategoryConstant)) as ProductBiddingCategoryConstant; // ignore: deprecated_member_use
  ...
  @$pb.TagNumber(5)
  $0.ProductBiddingCategoryLevelEnum_ProductBiddingCategoryLevel get level => $_getN(1);
  @$pb.TagNumber(5)
  set level($0.ProductBiddingCategoryLevelEnum_ProductBiddingCategoryLevel v) { setField(5, v); }
  @$pb.TagNumber(5)
  ...
  @$pb.TagNumber(6)
  $1.ProductBiddingCategoryStatusEnum_ProductBiddingCategoryStatus get status => $_getN(2);
  @$pb.TagNumber(6)
  set status($1.ProductBiddingCategoryStatusEnum_ProductBiddingCategoryStatus v) { setField(6, v); }
  @$pb.TagNumber(6)

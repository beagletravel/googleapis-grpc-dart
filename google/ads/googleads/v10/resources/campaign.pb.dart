...
import '../enums/location_source_type.pbenum.dart' as $17;
import '../enums/app_campaign_bidding_strategy_goal_type.pbenum.dart' as $18;
import '../enums/app_campaign_app_store.pbenum.dart' as $19;
...
class Campaign_NetworkSettings extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'Campaign.NetworkSettings', package: const $pb.PackageName(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'google.ads.googleads.v10.resources'), createEmptyInstance: create)
    ..aOB(5, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'targetGoogleSearch')
    ..aOB(6, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'targetSearchNetwork')
    ..aOB(7, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'targetContentNetwork')
    ..aOB(8, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'targetPartnerSearchNetwork')
  ...
  'Will be removed in next major version')
  Campaign_NetworkSettings copyWith(void Function(Campaign_NetworkSettings) updates) => super.copyWith((message) => updates(message as Campaign_NetworkSettings)) as Campaign_NetworkSettings; // ignore: deprecated_member_use
...
class Campaign_HotelSettingInfo extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'Campaign.HotelSettingInfo', package: const $pb.PackageName(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'google.ads.googleads.v10.resources'), createEmptyInstance: create)
    ..aInt64(2, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'hotelCenterId')
    ..hasRequiredFields = false
  ;
  ...
  'Use [GeneratedMessageGenericExtensions.rebuild] instead. '
  'Will be removed in next major version')
  Campaign_HotelSettingInfo copyWith(void Function(Campaign_HotelSettingInfo) updates) => super.copyWith((message) => updates(message as Campaign_HotelSettingInfo)) as Campaign_HotelSettingInfo; // ignore: deprecated_member_use
  $pb.BuilderInfo get info_ => _i;
  @$core.pragma('dart2js:noInline')
...
class Campaign_DynamicSearchAdsSetting extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'Campaign.DynamicSearchAdsSetting', package: const $pb.PackageName(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'google.ads.googleads.v10.resources'), createEmptyInstance: create)
    ..aOS(6, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'domainName')
    ..aOS(7, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'languageCode')
    ..aOB(8, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'useSuppliedUrlsOnly')
    ..pPS(9, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'feeds')
    ..hasRequiredFields = false
  ;
  ...
  'Use [GeneratedMessageGenericExtensions.rebuild] instead. '
  'Will be removed in next major version')
  Campaign_DynamicSearchAdsSetting copyWith(void Function(Campaign_DynamicSearchAdsSetting) updates) => super.copyWith((message) => updates(message as Campaign_DynamicSearchAdsSetting)) as Campaign_DynamicSearchAdsSetting; // ignore: deprecated_member_use
  $pb.BuilderInfo get info_ => _i;
  @$core.pragma('dart2js:noInline')
...
class Campaign_ShoppingSetting extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'Campaign.ShoppingSetting', package: const $pb.PackageName(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'google.ads.googleads.v10.resources'), createEmptyInstance: create)
    ..aInt64(5, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'merchantId')
    ..aOS(6, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'salesCountry')
    ..a<$core.int>(7, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'campaignPriority', $pb.PbFieldType.O3)
    ..aOB(8, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'enableLocal')
    ..aOB(9, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'useVehicleInventory')
    ..hasRequiredFields = false
  ;
  ...
  factory Campaign_ShoppingSetting({
    ...
    if (useVehicleInventory != null) {
      _result.useVehicleInventory = useVehicleInventory;
    }
    return _result;
  }
  ...
  'Use [GeneratedMessageGenericExtensions.rebuild] instead. '
  'Will be removed in next major version')
  Campaign_ShoppingSetting copyWith(void Function(Campaign_ShoppingSetting) updates) => super.copyWith((message) => updates(message as Campaign_ShoppingSetting)) as Campaign_ShoppingSetting; // ignore: deprecated_member_use
  $pb.BuilderInfo get info_ => _i;
  @$core.pragma('dart2js:noInline')
...
class Campaign_TrackingSetting extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'Campaign.TrackingSetting', package: const $pb.PackageName(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'google.ads.googleads.v10.resources'), createEmptyInstance: create)
    ..aOS(2, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'trackingUrl')
    ..hasRequiredFields = false
  ;
  ...
  'Use [GeneratedMessageGenericExtensions.rebuild] instead. '
  'Will be removed in next major version')
  Campaign_TrackingSetting copyWith(void Function(Campaign_TrackingSetting) updates) => super.copyWith((message) => updates(message as Campaign_TrackingSetting)) as Campaign_TrackingSetting; // ignore: deprecated_member_use
  $pb.BuilderInfo get info_ => _i;
  @$core.pragma('dart2js:noInline')
...
class Campaign_GeoTargetTypeSetting extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'Campaign.GeoTargetTypeSetting', package: const $pb.PackageName(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'google.ads.googleads.v10.resources'), createEmptyInstance: create)
    ..e<$15.PositiveGeoTargetTypeEnum_PositiveGeoTargetType>(1, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'positiveGeoTargetType', $pb.PbFieldType.OE, defaultOrMaker: $15.PositiveGeoTargetTypeEnum_PositiveGeoTargetType.UNSPECIFIED, valueOf: $15.PositiveGeoTargetTypeEnum_PositiveGeoTargetType.valueOf, enumValues: $15.PositiveGeoTargetTypeEnum_PositiveGeoTargetType.values)
    ..e<$16.NegativeGeoTargetTypeEnum_NegativeGeoTargetType>(2, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'negativeGeoTargetType', $pb.PbFieldType.OE, defaultOrMaker: $16.NegativeGeoTargetTypeEnum_NegativeGeoTargetType.UNSPECIFIED, valueOf: $16.NegativeGeoTargetTypeEnum_NegativeGeoTargetType.valueOf, enumValues: $16.NegativeGeoTargetTypeEnum_NegativeGeoTargetType.values)
    ..hasRequiredFields = false
  ;
  ...
  'Use [GeneratedMessageGenericExtensions.rebuild] instead. '
  'Will be removed in next major version')
  Campaign_GeoTargetTypeSetting copyWith(void Function(Campaign_GeoTargetTypeSetting) updates) => super.copyWith((message) => updates(message as Campaign_GeoTargetTypeSetting)) as Campaign_GeoTargetTypeSetting; // ignore: deprecated_member_use
  $pb.BuilderInfo get info_ => _i;
  @$core.pragma('dart2js:noInline')
  ...
  @$pb.TagNumber(1)
  $15.PositiveGeoTargetTypeEnum_PositiveGeoTargetType get positiveGeoTargetType => $_getN(0);
  @$pb.TagNumber(1)
  set positiveGeoTargetType($15.PositiveGeoTargetTypeEnum_PositiveGeoTargetType v) { setField(1, v); }
  @$pb.TagNumber(1)
  ...
  @$pb.TagNumber(2)
  $16.NegativeGeoTargetTypeEnum_NegativeGeoTargetType get negativeGeoTargetType => $_getN(1);
  @$pb.TagNumber(2)
  set negativeGeoTargetType($16.NegativeGeoTargetTypeEnum_NegativeGeoTargetType v) { setField(2, v); }
  @$pb.TagNumber(2)
...
class Campaign_LocalCampaignSetting extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'Campaign.LocalCampaignSetting', package: const $pb.PackageName(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'google.ads.googleads.v10.resources'), createEmptyInstance: create)
    ..e<$17.LocationSourceTypeEnum_LocationSourceType>(1, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'locationSourceType', $pb.PbFieldType.OE, defaultOrMaker: $17.LocationSourceTypeEnum_LocationSourceType.UNSPECIFIED, valueOf: $17.LocationSourceTypeEnum_LocationSourceType.valueOf, enumValues: $17.LocationSourceTypeEnum_LocationSourceType.values)
    ..hasRequiredFields = false
  ;

  Campaign_LocalCampaignSetting._() : super();
  factory Campaign_LocalCampaignSetting({
    $17.LocationSourceTypeEnum_LocationSourceType? locationSourceType,
  }) {
    final _result = create();
  ...
  'Use [GeneratedMessageGenericExtensions.rebuild] instead. '
  'Will be removed in next major version')
  Campaign_LocalCampaignSetting copyWith(void Function(Campaign_LocalCampaignSetting) updates) => super.copyWith((message) => updates(message as Campaign_LocalCampaignSetting)) as Campaign_LocalCampaignSetting; // ignore: deprecated_member_use
  $pb.BuilderInfo get info_ => _i;
  @$core.pragma('dart2js:noInline')
  ...
  @$pb.TagNumber(1)
  $17.LocationSourceTypeEnum_LocationSourceType get locationSourceType => $_getN(0);
  @$pb.TagNumber(1)
  set locationSourceType($17.LocationSourceTypeEnum_LocationSourceType v) { setField(1, v); }
  @$pb.TagNumber(1)
...
class Campaign_AppCampaignSetting extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'Campaign.AppCampaignSetting', package: const $pb.PackageName(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'google.ads.googleads.v10.resources'), createEmptyInstance: create)
    ..e<$18.AppCampaignBiddingStrategyGoalTypeEnum_AppCampaignBiddingStrategyGoalType>(1, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'biddingStrategyGoalType', $pb.PbFieldType.OE, defaultOrMaker: $18.AppCampaignBiddingStrategyGoalTypeEnum_AppCampaignBiddingStrategyGoalType.UNSPECIFIED, valueOf: $18.AppCampaignBiddingStrategyGoalTypeEnum_AppCampaignBiddingStrategyGoalType.valueOf, enumValues: $18.AppCampaignBiddingStrategyGoalTypeEnum_AppCampaignBiddingStrategyGoalType.values)
    ..e<$19.AppCampaignAppStoreEnum_AppCampaignAppStore>(3, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'appStore', $pb.PbFieldType.OE, defaultOrMaker: $19.AppCampaignAppStoreEnum_AppCampaignAppStore.UNSPECIFIED, valueOf: $19.AppCampaignAppStoreEnum_AppCampaignAppStore.valueOf, enumValues: $19.AppCampaignAppStoreEnum_AppCampaignAppStore.values)
  ...
  factory Campaign_AppCampaignSetting({
    $18.AppCampaignBiddingStrategyGoalTypeEnum_AppCampaignBiddingStrategyGoalType? biddingStrategyGoalType,
    $19.AppCampaignAppStoreEnum_AppCampaignAppStore? appStore,
    $core.String? appId,
  }) {
    final _result = create();
  ...
  'Use [GeneratedMessageGenericExtensions.rebuild] instead. '
  'Will be removed in next major version')
  Campaign_AppCampaignSetting copyWith(void Function(Campaign_AppCampaignSetting) updates) => super.copyWith((message) => updates(message as Campaign_AppCampaignSetting)) as Campaign_AppCampaignSetting; // ignore: deprecated_member_use
  $pb.BuilderInfo get info_ => _i;
  @$core.pragma('dart2js:noInline')
  ...
  @$pb.TagNumber(1)
  $18.AppCampaignBiddingStrategyGoalTypeEnum_AppCampaignBiddingStrategyGoalType get biddingStrategyGoalType => $_getN(0);
  @$pb.TagNumber(1)
  set biddingStrategyGoalType($18.AppCampaignBiddingStrategyGoalTypeEnum_AppCampaignBiddingStrategyGoalType v) { setField(1, v); }
  @$pb.TagNumber(1)
  ...
  @$pb.TagNumber(3)
  $19.AppCampaignAppStoreEnum_AppCampaignAppStore get appStore => $_getN(1);
  @$pb.TagNumber(3)
  set appStore($19.AppCampaignAppStoreEnum_AppCampaignAppStore v) { setField(3, v); }
  @$pb.TagNumber(3)
...
class Campaign_VanityPharma extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'Campaign.VanityPharma', package: const $pb.PackageName(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'google.ads.googleads.v10.resources'), createEmptyInstance: create)
    ..e<$20.VanityPharmaDisplayUrlModeEnum_VanityPharmaDisplayUrlMode>(1, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'vanityPharmaDisplayUrlMode', $pb.PbFieldType.OE, defaultOrMaker: $20.VanityPharmaDisplayUrlModeEnum_VanityPharmaDisplayUrlMode.UNSPECIFIED, valueOf: $20.VanityPharmaDisplayUrlModeEnum_VanityPharmaDisplayUrlMode.valueOf, enumValues: $20.VanityPharmaDisplayUrlModeEnum_VanityPharmaDisplayUrlMode.values)
    ..e<$21.VanityPharmaTextEnum_VanityPharmaText>(2, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'vanityPharmaText', $pb.PbFieldType.OE, defaultOrMaker: $21.VanityPharmaTextEnum_VanityPharmaText.UNSPECIFIED, valueOf: $21.VanityPharmaTextEnum_VanityPharmaText.valueOf, enumValues: $21.VanityPharmaTextEnum_VanityPharmaText.values)
    ..hasRequiredFields = false
  ;

  Campaign_VanityPharma._() : super();
  factory Campaign_VanityPharma({
    $20.VanityPharmaDisplayUrlModeEnum_VanityPharmaDisplayUrlMode? vanityPharmaDisplayUrlMode,
  ...
  'Use [GeneratedMessageGenericExtensions.rebuild] instead. '
  'Will be removed in next major version')
  Campaign_VanityPharma copyWith(void Function(Campaign_VanityPharma) updates) => super.copyWith((message) => updates(message as Campaign_VanityPharma)) as Campaign_VanityPharma; // ignore: deprecated_member_use
  $pb.BuilderInfo get info_ => _i;
  @$core.pragma('dart2js:noInline')
  ...
  @$pb.TagNumber(1)
  $20.VanityPharmaDisplayUrlModeEnum_VanityPharmaDisplayUrlMode get vanityPharmaDisplayUrlMode => $_getN(0);
  @$pb.TagNumber(1)
  set vanityPharmaDisplayUrlMode($20.VanityPharmaDisplayUrlModeEnum_VanityPharmaDisplayUrlMode v) { setField(1, v); }
  @$pb.TagNumber(1)
  ...
  @$pb.TagNumber(2)
  set vanityPharmaText($21.VanityPharmaTextEnum_VanityPharmaText v) { setField(2, v); }
  @$pb.TagNumber(2)
...
class Campaign_SelectiveOptimization extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'Campaign.SelectiveOptimization', package: const $pb.PackageName(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'google.ads.googleads.v10.resources'), createEmptyInstance: create)
    ..pPS(2, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'conversionActions')
    ..hasRequiredFields = false
  ;
  ...
  'Use [GeneratedMessageGenericExtensions.rebuild] instead. '
  'Will be removed in next major version')
  Campaign_SelectiveOptimization copyWith(void Function(Campaign_SelectiveOptimization) updates) => super.copyWith((message) => updates(message as Campaign_SelectiveOptimization)) as Campaign_SelectiveOptimization; // ignore: deprecated_member_use
  $pb.BuilderInfo get info_ => _i;
  @$core.pragma('dart2js:noInline')
...
class Campaign_OptimizationGoalSetting extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'Campaign.OptimizationGoalSetting', package: const $pb.PackageName(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'google.ads.googleads.v10.resources'), createEmptyInstance: create)
    ..pc<$22.OptimizationGoalTypeEnum_OptimizationGoalType>(1, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'optimizationGoalTypes', $pb.PbFieldType.PE, valueOf: $22.OptimizationGoalTypeEnum_OptimizationGoalType.valueOf, enumValues: $22.OptimizationGoalTypeEnum_OptimizationGoalType.values)
    ..hasRequiredFields = false
  ;

  Campaign_OptimizationGoalSetting._() : super();
  factory Campaign_OptimizationGoalSetting({
    $core.Iterable<$22.OptimizationGoalTypeEnum_OptimizationGoalType>? optimizationGoalTypes,
  }) {
    final _result = create();
  ...
  'Use [GeneratedMessageGenericExtensions.rebuild] instead. '
  'Will be removed in next major version')
  Campaign_OptimizationGoalSetting copyWith(void Function(Campaign_OptimizationGoalSetting) updates) => super.copyWith((message) => updates(message as Campaign_OptimizationGoalSetting)) as Campaign_OptimizationGoalSetting; // ignore: deprecated_member_use
  $pb.BuilderInfo get info_ => _i;
  @$core.pragma('dart2js:noInline')
  ...
  @$pb.TagNumber(1)
  $core.List<$22.OptimizationGoalTypeEnum_OptimizationGoalType> get optimizationGoalTypes => $_getList(0);
}

class Campaign_AudienceSetting extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'Campaign.AudienceSetting', package: const $pb.PackageName(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'google.ads.googleads.v10.resources'), createEmptyInstance: create)
    ..aOB(1, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'useAudienceGrouped')
    ..hasRequiredFields = false
  ;
  ...
  factory Campaign_AudienceSetting({
    ...
    if (useAudienceGrouped != null) {
      _result.useAudienceGrouped = useAudienceGrouped;
    }
    return _result;
  }
  ...
  'Use [GeneratedMessageGenericExtensions.rebuild] instead. '
  'Will be removed in next major version')
  Campaign_AudienceSetting copyWith(void Function(Campaign_AudienceSetting) updates) => super.copyWith((message) => updates(message as Campaign_AudienceSetting)) as Campaign_AudienceSetting; // ignore: deprecated_member_use
  $pb.BuilderInfo get info_ => _i;
  @$core.pragma('dart2js:noInline')
...
class Campaign extends $pb.GeneratedMessage {
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'Campaign', package: const $pb.PackageName(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'google.ads.googleads.v10.resources'), createEmptyInstance: create)
    ..oo(0, [24, 25, 26, 27, 29, 30, 31, 34, 37, 41, 48, 49, 67])
    ..aOS(1, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'resourceName')
    ..e<$5.CampaignStatusEnum_CampaignStatus>(5, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'status', $pb.PbFieldType.OE, defaultOrMaker: $5.CampaignStatusEnum_CampaignStatus.UNSPECIFIED, valueOf: $5.CampaignStatusEnum_CampaignStatus.valueOf, enumValues: $5.CampaignStatusEnum_CampaignStatus.values)
    ..e<$6.AdServingOptimizationStatusEnum_AdServingOptimizationStatus>(8, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'adServingOptimizationStatus', $pb.PbFieldType.OE, defaultOrMaker: $6.AdServingOptimizationStatusEnum_AdServingOptimizationStatus.UNSPECIFIED, valueOf: $6.AdServingOptimizationStatusEnum_AdServingOptimizationStatus.valueOf, enumValues: $6.AdServingOptimizationStatusEnum_AdServingOptimizationStatus.values)
    ..e<$7.AdvertisingChannelTypeEnum_AdvertisingChannelType>(9, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'advertisingChannelType', $pb.PbFieldType.OE, defaultOrMaker: $7.AdvertisingChannelTypeEnum_AdvertisingChannelType.UNSPECIFIED, valueOf: $7.AdvertisingChannelTypeEnum_AdvertisingChannelType.valueOf, enumValues: $7.AdvertisingChannelTypeEnum_AdvertisingChannelType.values)
    ..e<$8.AdvertisingChannelSubTypeEnum_AdvertisingChannelSubType>(10, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'advertisingChannelSubType', $pb.PbFieldType.OE, defaultOrMaker: $8.AdvertisingChannelSubTypeEnum_AdvertisingChannelSubType.UNSPECIFIED, valueOf: $8.AdvertisingChannelSubTypeEnum_AdvertisingChannelSubType.valueOf, enumValues: $8.AdvertisingChannelSubTypeEnum_AdvertisingChannelSubType.values)
    ..pc<$0.CustomParameter>(12, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'urlCustomParameters', $pb.PbFieldType.PM, subBuilder: $0.CustomParameter.create)
    ..aOM<Campaign_NetworkSettings>(14, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'networkSettings', subBuilder: Campaign_NetworkSettings.create)
    ..e<$9.CampaignExperimentTypeEnum_CampaignExperimentType>(17, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'experimentType', $pb.PbFieldType.OE, defaultOrMaker: $9.CampaignExperimentTypeEnum_CampaignExperimentType.UNSPECIFIED, valueOf: $9.CampaignExperimentTypeEnum_CampaignExperimentType.valueOf, enumValues: $9.CampaignExperimentTypeEnum_CampaignExperimentType.values)
    ..e<$10.CampaignServingStatusEnum_CampaignServingStatus>(21, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'servingStatus', $pb.PbFieldType.OE, defaultOrMaker: $10.CampaignServingStatusEnum_CampaignServingStatus.UNSPECIFIED, valueOf: $10.CampaignServingStatusEnum_CampaignServingStatus.valueOf, enumValues: $10.CampaignServingStatusEnum_CampaignServingStatus.values)
    ..e<$11.BiddingStrategyTypeEnum_BiddingStrategyType>(22, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'biddingStrategyType', $pb.PbFieldType.OE, defaultOrMaker: $11.BiddingStrategyTypeEnum_BiddingStrategyType.UNSPECIFIED, valueOf: $11.BiddingStrategyTypeEnum_BiddingStrategyType.valueOf, enumValues: $11.BiddingStrategyTypeEnum_BiddingStrategyType.values)
    ..aOM<$1.ManualCpc>(24, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'manualCpc', subBuilder: $1.ManualCpc.create)
    ..aOM<$1.ManualCpm>(25, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'manualCpm', subBuilder: $1.ManualCpm.create)
    ..aOM<$1.TargetCpa>(26, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'targetCpa', subBuilder: $1.TargetCpa.create)
    ..aOM<$1.TargetSpend>(27, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'targetSpend', subBuilder: $1.TargetSpend.create)
    ..aOM<$1.TargetRoas>(29, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'targetRoas', subBuilder: $1.TargetRoas.create)
    ..aOM<$1.MaximizeConversions>(30, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'maximizeConversions', subBuilder: $1.MaximizeConversions.create)
    ..aOM<$1.MaximizeConversionValue>(31, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'maximizeConversionValue', subBuilder: $1.MaximizeConversionValue.create)
    ..aOM<Campaign_HotelSettingInfo>(32, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'hotelSetting', subBuilder: Campaign_HotelSettingInfo.create)
    ..aOM<Campaign_DynamicSearchAdsSetting>(33, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'dynamicSearchAdsSetting', subBuilder: Campaign_DynamicSearchAdsSetting.create)
    ..aOM<$1.PercentCpc>(34, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'percentCpc', subBuilder: $1.PercentCpc.create)
    ..aOM<Campaign_ShoppingSetting>(36, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'shoppingSetting', subBuilder: Campaign_ShoppingSetting.create)
    ..aOM<$1.ManualCpv>(37, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'manualCpv', subBuilder: $1.ManualCpv.create)
    ..aOM<$2.RealTimeBiddingSetting>(39, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'realTimeBiddingSetting', subBuilder: $2.RealTimeBiddingSetting.create)
    ..pc<$3.FrequencyCapEntry>(40, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'frequencyCaps', $pb.PbFieldType.PM, subBuilder: $3.FrequencyCapEntry.create)
    ..aOM<$1.TargetCpm>(41, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'targetCpm', subBuilder: $1.TargetCpm.create)
    ..e<$12.BrandSafetySuitabilityEnum_BrandSafetySuitability>(42, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'videoBrandSafetySuitability', $pb.PbFieldType.OE, defaultOrMaker: $12.BrandSafetySuitabilityEnum_BrandSafetySuitability.UNSPECIFIED, valueOf: $12.BrandSafetySuitabilityEnum_BrandSafetySuitability.valueOf, enumValues: $12.BrandSafetySuitabilityEnum_BrandSafetySuitability.values)
    ..aOM<$4.TargetingSetting>(43, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'targetingSetting', subBuilder: $4.TargetingSetting.create)
    ..aOM<Campaign_VanityPharma>(44, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'vanityPharma', subBuilder: Campaign_VanityPharma.create)
    ..aOM<Campaign_SelectiveOptimization>(45, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'selectiveOptimization', subBuilder: Campaign_SelectiveOptimization.create)
    ..aOM<Campaign_TrackingSetting>(46, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'trackingSetting', subBuilder: Campaign_TrackingSetting.create)
    ..aOM<Campaign_GeoTargetTypeSetting>(47, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'geoTargetTypeSetting', subBuilder: Campaign_GeoTargetTypeSetting.create)
    ..aOM<$1.TargetImpressionShare>(48, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'targetImpressionShare', subBuilder: $1.TargetImpressionShare.create)
    ..aOM<$1.Commission>(49, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'commission', subBuilder: $1.Commission.create)
    ..aOM<Campaign_LocalCampaignSetting>(50, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'localCampaignSetting', subBuilder: Campaign_LocalCampaignSetting.create)
    ..aOM<Campaign_AppCampaignSetting>(51, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'appCampaignSetting', subBuilder: Campaign_AppCampaignSetting.create)
    ..e<$13.PaymentModeEnum_PaymentMode>(52, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'paymentMode', $pb.PbFieldType.OE, defaultOrMaker: $13.PaymentModeEnum_PaymentMode.UNSPECIFIED, valueOf: $13.PaymentModeEnum_PaymentMode.valueOf, enumValues: $13.PaymentModeEnum_PaymentMode.values)
    ..aOM<Campaign_OptimizationGoalSetting>(54, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'optimizationGoalSetting', subBuilder: Campaign_OptimizationGoalSetting.create)
    ..aOS(56, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'baseCampaign')
    ..aOS(58, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'name')
    ..aInt64(59, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'id')
    ..aOS(60, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'trackingUrlTemplate')
    ..pPS(61, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'labels')
    ..aOS(62, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'campaignBudget')
    ..aOS(63, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'startDate')
    ..aOS(64, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'endDate')
    ..aOS(65, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'finalUrlSuffix')
    ..a<$core.double>(66, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'optimizationScore', $pb.PbFieldType.OD)
    ..aOS(67, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'biddingStrategy')
    ..pc<$14.AssetFieldTypeEnum_AssetFieldType>(69, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'excludedParentAssetFieldTypes', $pb.PbFieldType.PE, valueOf: $14.AssetFieldTypeEnum_AssetFieldType.valueOf, enumValues: $14.AssetFieldTypeEnum_AssetFieldType.values)
    ..aOS(71, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'accessibleBiddingStrategy')
    ..aOB(72, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'urlExpansionOptOut')
    ..aOM<Campaign_AudienceSetting>(73, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'audienceSetting', subBuilder: Campaign_AudienceSetting.create)
    ..aOS(76, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'campaignGroup')
    ..hasRequiredFields = false
  ;
  ...
  factory Campaign({
    ...
    $6.AdServingOptimizationStatusEnum_AdServingOptimizationStatus? adServingOptimizationStatus,
    $7.AdvertisingChannelTypeEnum_AdvertisingChannelType? advertisingChannelType,
    $8.AdvertisingChannelSubTypeEnum_AdvertisingChannelSubType? advertisingChannelSubType,
    ...
    $12.BrandSafetySuitabilityEnum_BrandSafetySuitability? videoBrandSafetySuitability,
    ...
    $core.Iterable<$14.AssetFieldTypeEnum_AssetFieldType>? excludedParentAssetFieldTypes,
    ...
    if (excludedParentAssetFieldTypes != null) {
      _result.excludedParentAssetFieldTypes.addAll(excludedParentAssetFieldTypes);
    }
    if (accessibleBiddingStrategy != null) {
      _result.accessibleBiddingStrategy = accessibleBiddingStrategy;
    }
    if (urlExpansionOptOut != null) {
      _result.urlExpansionOptOut = urlExpansionOptOut;
    }
    if (audienceSetting != null) {
      _result.audienceSetting = audienceSetting;
    }
  ...
  'Use [GeneratedMessageGenericExtensions.rebuild] instead. '
  'Will be removed in next major version')
  Campaign copyWith(void Function(Campaign) updates) => super.copyWith((message) => updates(message as Campaign)) as Campaign; // ignore: deprecated_member_use
  $pb.BuilderInfo get info_ => _i;
  @$core.pragma('dart2js:noInline')
  ...
  @$pb.TagNumber(5)
  set status($5.CampaignStatusEnum_CampaignStatus v) { setField(5, v); }
  @$pb.TagNumber(5)
  ...
  @$pb.TagNumber(8)
  $6.AdServingOptimizationStatusEnum_AdServingOptimizationStatus get adServingOptimizationStatus => $_getN(2);
  @$pb.TagNumber(8)
  set adServingOptimizationStatus($6.AdServingOptimizationStatusEnum_AdServingOptimizationStatus v) { setField(8, v); }
  @$pb.TagNumber(8)
  ...
  @$pb.TagNumber(9)
  $7.AdvertisingChannelTypeEnum_AdvertisingChannelType get advertisingChannelType => $_getN(3);
  @$pb.TagNumber(9)
  set advertisingChannelType($7.AdvertisingChannelTypeEnum_AdvertisingChannelType v) { setField(9, v); }
  @$pb.TagNumber(9)
  ...
  @$pb.TagNumber(10)
  $8.AdvertisingChannelSubTypeEnum_AdvertisingChannelSubType get advertisingChannelSubType => $_getN(4);
  @$pb.TagNumber(10)
  set advertisingChannelSubType($8.AdvertisingChannelSubTypeEnum_AdvertisingChannelSubType v) { setField(10, v); }
  @$pb.TagNumber(10)
  ...
  @$pb.TagNumber(17)
  $9.CampaignExperimentTypeEnum_CampaignExperimentType get experimentType => $_getN(7);
  @$pb.TagNumber(17)
  set experimentType($9.CampaignExperimentTypeEnum_CampaignExperimentType v) { setField(17, v); }
  @$pb.TagNumber(17)
  ...
  @$pb.TagNumber(21)
  $10.CampaignServingStatusEnum_CampaignServingStatus get servingStatus => $_getN(8);
  @$pb.TagNumber(21)
  set servingStatus($10.CampaignServingStatusEnum_CampaignServingStatus v) { setField(21, v); }
  @$pb.TagNumber(21)
  ...
  @$pb.TagNumber(22)
  $11.BiddingStrategyTypeEnum_BiddingStrategyType get biddingStrategyType => $_getN(9);
  @$pb.TagNumber(22)
  set biddingStrategyType($11.BiddingStrategyTypeEnum_BiddingStrategyType v) { setField(22, v); }
  @$pb.TagNumber(22)
  ...
  @$pb.TagNumber(24)
  set manualCpc($1.ManualCpc v) { setField(24, v); }
  @$pb.TagNumber(24)
  ...
  @$pb.TagNumber(25)
  set manualCpm($1.ManualCpm v) { setField(25, v); }
  @$pb.TagNumber(25)
  ...
  @$pb.TagNumber(26)
  set targetCpa($1.TargetCpa v) { setField(26, v); }
  @$pb.TagNumber(26)
  ...
  @$pb.TagNumber(27)
  set targetSpend($1.TargetSpend v) { setField(27, v); }
  @$pb.TagNumber(27)
  ...
  @$pb.TagNumber(29)
  set targetRoas($1.TargetRoas v) { setField(29, v); }
  @$pb.TagNumber(29)
  ...
  @$pb.TagNumber(30)
  set maximizeConversions($1.MaximizeConversions v) { setField(30, v); }
  @$pb.TagNumber(30)
  ...
  @$pb.TagNumber(31)
  set maximizeConversionValue($1.MaximizeConversionValue v) { setField(31, v); }
  @$pb.TagNumber(31)
  ...
  @$pb.TagNumber(34)
  set percentCpc($1.PercentCpc v) { setField(34, v); }
  @$pb.TagNumber(34)
  ...
  @$pb.TagNumber(37)
  set manualCpv($1.ManualCpv v) { setField(37, v); }
  @$pb.TagNumber(37)
  ...
  @$pb.TagNumber(39)
  set realTimeBiddingSetting($2.RealTimeBiddingSetting v) { setField(39, v); }
  @$pb.TagNumber(39)
  ...
  @$pb.TagNumber(41)
  set targetCpm($1.TargetCpm v) { setField(41, v); }
  @$pb.TagNumber(41)
  ...
  @$pb.TagNumber(42)
  $12.BrandSafetySuitabilityEnum_BrandSafetySuitability get videoBrandSafetySuitability => $_getN(25);
  @$pb.TagNumber(42)
  set videoBrandSafetySuitability($12.BrandSafetySuitabilityEnum_BrandSafetySuitability v) { setField(42, v); }
  @$pb.TagNumber(42)
  ...
  @$pb.TagNumber(43)
  set targetingSetting($4.TargetingSetting v) { setField(43, v); }
  @$pb.TagNumber(43)
  ...
  @$pb.TagNumber(48)
  set targetImpressionShare($1.TargetImpressionShare v) { setField(48, v); }
  @$pb.TagNumber(48)
  ...
  @$pb.TagNumber(49)
  set commission($1.Commission v) { setField(49, v); }
  @$pb.TagNumber(49)
  ...
  @$pb.TagNumber(52)
  set paymentMode($13.PaymentModeEnum_PaymentMode v) { setField(52, v); }
  @$pb.TagNumber(52)
  ...
  @$pb.TagNumber(69)
  $core.List<$14.AssetFieldTypeEnum_AssetFieldType> get excludedParentAssetFieldTypes => $_getList(48);
  ...
  @$pb.TagNumber(76)
  $core.String get campaignGroup => $_getSZ(52);
  @$pb.TagNumber(76)
  set campaignGroup($core.String v) { $_setString(52, v); }
  @$pb.TagNumber(76)
  $core.bool hasCampaignGroup() => $_has(52);
  @$pb.TagNumber(76)

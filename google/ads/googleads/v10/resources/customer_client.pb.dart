...
import '../enums/customer_status.pbenum.dart' as $0;

class CustomerClient extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'CustomerClient', package: const $pb.PackageName(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'google.ads.googleads.v10.resources'), createEmptyInstance: create)
    ..aOS(1, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'resourceName')
    ..aOS(12, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'clientCustomer')
    ..aOB(13, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'hidden')
    ..aInt64(14, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'level')
    ..aOS(15, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'timeZone')
    ..aOB(16, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'testAccount')
    ..aOB(17, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'manager')
    ..aOS(18, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'descriptiveName')
    ..aOS(19, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'currencyCode')
    ..aInt64(20, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'id')
    ..pPS(21, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'appliedLabels')
    ..e<$0.CustomerStatusEnum_CustomerStatus>(22, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'status', $pb.PbFieldType.OE, defaultOrMaker: $0.CustomerStatusEnum_CustomerStatus.UNSPECIFIED, valueOf: $0.CustomerStatusEnum_CustomerStatus.valueOf, enumValues: $0.CustomerStatusEnum_CustomerStatus.values)
  ...
  factory CustomerClient({
    ...
    $0.CustomerStatusEnum_CustomerStatus? status,
  }) {
    ...
    if (appliedLabels != null) {
      _result.appliedLabels.addAll(appliedLabels);
    }
    if (status != null) {
  ...
  'Will be removed in next major version')
  CustomerClient copyWith(void Function(CustomerClient) updates) => super.copyWith((message) => updates(message as CustomerClient)) as CustomerClient; // ignore: deprecated_member_use
  ...
  @$pb.TagNumber(22)
  $0.CustomerStatusEnum_CustomerStatus get status => $_getN(11);
  @$pb.TagNumber(22)
  set status($0.CustomerStatusEnum_CustomerStatus v) { setField(22, v); }
  @$pb.TagNumber(22)

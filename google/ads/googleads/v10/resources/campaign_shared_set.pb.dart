...
class CampaignSharedSet extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'CampaignSharedSet', package: const $pb.PackageName(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'google.ads.googleads.v10.resources'), createEmptyInstance: create)
    ..aOS(1, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'resourceName')
    ..e<$0.CampaignSharedSetStatusEnum_CampaignSharedSetStatus>(2, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'status', $pb.PbFieldType.OE, defaultOrMaker: $0.CampaignSharedSetStatusEnum_CampaignSharedSetStatus.UNSPECIFIED, valueOf: $0.CampaignSharedSetStatusEnum_CampaignSharedSetStatus.valueOf, enumValues: $0.CampaignSharedSetStatusEnum_CampaignSharedSetStatus.values)
    ..aOS(5, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'campaign')
    ..aOS(6, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'sharedSet')
  ...
  'Will be removed in next major version')
  CampaignSharedSet copyWith(void Function(CampaignSharedSet) updates) => super.copyWith((message) => updates(message as CampaignSharedSet)) as CampaignSharedSet; // ignore: deprecated_member_use
  ...
  @$pb.TagNumber(2)
  $0.CampaignSharedSetStatusEnum_CampaignSharedSetStatus get status => $_getN(1);
  @$pb.TagNumber(2)
  set status($0.CampaignSharedSetStatusEnum_CampaignSharedSetStatus v) { setField(2, v); }
  @$pb.TagNumber(2)

...
class CustomAudience extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'CustomAudience', package: const $pb.PackageName(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'google.ads.googleads.v10.resources'), createEmptyInstance: create)
    ...
    ..e<$0.CustomAudienceStatusEnum_CustomAudienceStatus>(3, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'status', $pb.PbFieldType.OE, defaultOrMaker: $0.CustomAudienceStatusEnum_CustomAudienceStatus.UNSPECIFIED, valueOf: $0.CustomAudienceStatusEnum_CustomAudienceStatus.valueOf, enumValues: $0.CustomAudienceStatusEnum_CustomAudienceStatus.values)
    ..aOS(4, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'name')
    ..e<$1.CustomAudienceTypeEnum_CustomAudienceType>(5, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'type', $pb.PbFieldType.OE, defaultOrMaker: $1.CustomAudienceTypeEnum_CustomAudienceType.UNSPECIFIED, valueOf: $1.CustomAudienceTypeEnum_CustomAudienceType.valueOf, enumValues: $1.CustomAudienceTypeEnum_CustomAudienceType.values)
    ..aOS(6, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'description')
    ..pc<CustomAudienceMember>(7, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'members', $pb.PbFieldType.PM, subBuilder: CustomAudienceMember.create)
  ...
  'Will be removed in next major version')
  CustomAudience copyWith(void Function(CustomAudience) updates) => super.copyWith((message) => updates(message as CustomAudience)) as CustomAudience; // ignore: deprecated_member_use
  ...
  @$pb.TagNumber(3)
  set status($0.CustomAudienceStatusEnum_CustomAudienceStatus v) { setField(3, v); }
  @$pb.TagNumber(3)
  ...
  @$pb.TagNumber(5)
  set type($1.CustomAudienceTypeEnum_CustomAudienceType v) { setField(5, v); }
  @$pb.TagNumber(5)
...
class CustomAudienceMember extends $pb.GeneratedMessage {
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'CustomAudienceMember', package: const $pb.PackageName(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'google.ads.googleads.v10.resources'), createEmptyInstance: create)
    ..oo(0, [2, 3, 4, 5])
    ..e<$2.CustomAudienceMemberTypeEnum_CustomAudienceMemberType>(1, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'memberType', $pb.PbFieldType.OE, defaultOrMaker: $2.CustomAudienceMemberTypeEnum_CustomAudienceMemberType.UNSPECIFIED, valueOf: $2.CustomAudienceMemberTypeEnum_CustomAudienceMemberType.valueOf, enumValues: $2.CustomAudienceMemberTypeEnum_CustomAudienceMemberType.values)
    ...
    ..aInt64(4, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'placeCategory')
  ...
  'Use [GeneratedMessageGenericExtensions.rebuild] instead. '
  'Will be removed in next major version')
  CustomAudienceMember copyWith(void Function(CustomAudienceMember) updates) => super.copyWith((message) => updates(message as CustomAudienceMember)) as CustomAudienceMember; // ignore: deprecated_member_use
  $pb.BuilderInfo get info_ => _i;
  @$core.pragma('dart2js:noInline')
  ...
  @$pb.TagNumber(1)
  $2.CustomAudienceMemberTypeEnum_CustomAudienceMemberType get memberType => $_getN(0);
  @$pb.TagNumber(1)
  set memberType($2.CustomAudienceMemberTypeEnum_CustomAudienceMemberType v) { setField(1, v); }
  @$pb.TagNumber(1)

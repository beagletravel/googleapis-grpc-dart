...
class CarrierConstant extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'CarrierConstant', package: const $pb.PackageName(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'google.ads.googleads.v10.resources'), createEmptyInstance: create)
  ...
  'Will be removed in next major version')
  CarrierConstant copyWith(void Function(CarrierConstant) updates) => super.copyWith((message) => updates(message as CarrierConstant)) as CarrierConstant; // ignore: deprecated_member_use

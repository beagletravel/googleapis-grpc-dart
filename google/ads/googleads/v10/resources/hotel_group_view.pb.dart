...
class HotelGroupView extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'HotelGroupView', package: const $pb.PackageName(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'google.ads.googleads.v10.resources'), createEmptyInstance: create)
  ...
  'Will be removed in next major version')
  HotelGroupView copyWith(void Function(HotelGroupView) updates) => super.copyWith((message) => updates(message as HotelGroupView)) as HotelGroupView; // ignore: deprecated_member_use

...
class CurrencyConstant extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'CurrencyConstant', package: const $pb.PackageName(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'google.ads.googleads.v10.resources'), createEmptyInstance: create)
    ...
    ..aOS(8, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'symbol')
    ..aInt64(9, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'billableUnitMicros')
  ...
  'Will be removed in next major version')
  CurrencyConstant copyWith(void Function(CurrencyConstant) updates) => super.copyWith((message) => updates(message as CurrencyConstant)) as CurrencyConstant; // ignore: deprecated_member_use

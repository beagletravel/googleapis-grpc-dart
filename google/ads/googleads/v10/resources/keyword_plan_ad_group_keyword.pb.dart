...
class KeywordPlanAdGroupKeyword extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'KeywordPlanAdGroupKeyword', package: const $pb.PackageName(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'google.ads.googleads.v10.resources'), createEmptyInstance: create)
    ...
    ..aOS(8, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'keywordPlanAdGroup')
    ...
    ..aInt64(11, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'cpcBidMicros')
    ..aOB(12, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'negative')
  ...
  'Will be removed in next major version')
  KeywordPlanAdGroupKeyword copyWith(void Function(KeywordPlanAdGroupKeyword) updates) => super.copyWith((message) => updates(message as KeywordPlanAdGroupKeyword)) as KeywordPlanAdGroupKeyword; // ignore: deprecated_member_use

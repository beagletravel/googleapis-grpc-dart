...
class LifeEvent extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'LifeEvent', package: const $pb.PackageName(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'google.ads.googleads.v10.resources'), createEmptyInstance: create)
  ...
  'Will be removed in next major version')
  LifeEvent copyWith(void Function(LifeEvent) updates) => super.copyWith((message) => updates(message as LifeEvent)) as LifeEvent; // ignore: deprecated_member_use

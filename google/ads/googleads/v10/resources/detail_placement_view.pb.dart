...
class DetailPlacementView extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'DetailPlacementView', package: const $pb.PackageName(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'google.ads.googleads.v10.resources'), createEmptyInstance: create)
    ..aOS(1, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'resourceName')
    ..e<$0.PlacementTypeEnum_PlacementType>(6, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'placementType', $pb.PbFieldType.OE, defaultOrMaker: $0.PlacementTypeEnum_PlacementType.UNSPECIFIED, valueOf: $0.PlacementTypeEnum_PlacementType.valueOf, enumValues: $0.PlacementTypeEnum_PlacementType.values)
    ..aOS(7, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'placement')
    ..aOS(8, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'displayName')
    ..aOS(9, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'groupPlacementTargetUrl')
    ..aOS(10, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'targetUrl')
  ...
  'Will be removed in next major version')
  DetailPlacementView copyWith(void Function(DetailPlacementView) updates) => super.copyWith((message) => updates(message as DetailPlacementView)) as DetailPlacementView; // ignore: deprecated_member_use
  ...
  @$pb.TagNumber(6)
  set placementType($0.PlacementTypeEnum_PlacementType v) { setField(6, v); }
  @$pb.TagNumber(6)

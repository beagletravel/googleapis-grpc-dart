...
class CampaignCriterionSimulation extends $pb.GeneratedMessage {
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'CampaignCriterionSimulation', package: const $pb.PackageName(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'google.ads.googleads.v10.resources'), createEmptyInstance: create)
    ..oo(0, [8])
    ..aOS(1, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'resourceName')
    ..e<$1.SimulationTypeEnum_SimulationType>(4, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'type', $pb.PbFieldType.OE, defaultOrMaker: $1.SimulationTypeEnum_SimulationType.UNSPECIFIED, valueOf: $1.SimulationTypeEnum_SimulationType.valueOf, enumValues: $1.SimulationTypeEnum_SimulationType.values)
    ...
    ..aOM<$0.BidModifierSimulationPointList>(8, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'bidModifierPointList', subBuilder: $0.BidModifierSimulationPointList.create)
    ..aInt64(9, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'campaignId')
    ..aInt64(10, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'criterionId')
  ...
  factory CampaignCriterionSimulation.fromBuffer($core.List<$core.int> i, [$pb.ExtensionRegistry r = $pb.ExtensionRegistry.EMPTY]) => create()..mergeFromBuffer(i, r);
  factory CampaignCriterionSimulation.fromJson($core.String i, [$pb.ExtensionRegistry r = $pb.ExtensionRegistry.EMPTY]) => create()..mergeFromJson(i, r);
  @$core.Deprecated(
  ...
  'Will be removed in next major version')
  CampaignCriterionSimulation copyWith(void Function(CampaignCriterionSimulation) updates) => super.copyWith((message) => updates(message as CampaignCriterionSimulation)) as CampaignCriterionSimulation; // ignore: deprecated_member_use
  $pb.BuilderInfo get info_ => _i;
  @$core.pragma('dart2js:noInline')
  static CampaignCriterionSimulation create() => CampaignCriterionSimulation._();
  ...
  @$core.pragma('dart2js:noInline')
  static CampaignCriterionSimulation getDefault() => _defaultInstance ??= $pb.GeneratedMessage.$_defaultFor<CampaignCriterionSimulation>(create);
  ...
  @$pb.TagNumber(4)
  set type($1.SimulationTypeEnum_SimulationType v) { setField(4, v); }
  @$pb.TagNumber(4)
  ...
  @$pb.TagNumber(5)
  set modificationMethod($2.SimulationModificationMethodEnum_SimulationModificationMethod v) { setField(5, v); }
  @$pb.TagNumber(5)
  ...
  @$pb.TagNumber(8)
  set bidModifierPointList($0.BidModifierSimulationPointList v) { setField(8, v); }
  @$pb.TagNumber(8)
  ...
  @$pb.TagNumber(9)
  set campaignId($fixnum.Int64 v) { $_setInt64(4, v); }
  @$pb.TagNumber(9)

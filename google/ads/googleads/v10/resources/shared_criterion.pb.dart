...
class SharedCriterion extends $pb.GeneratedMessage {
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'SharedCriterion', package: const $pb.PackageName(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'google.ads.googleads.v10.resources'), createEmptyInstance: create)
    ..oo(0, [3, 5, 6, 7, 8, 9])
    ..aOS(1, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'resourceName')
    ..aOM<$0.KeywordInfo>(3, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'keyword', subBuilder: $0.KeywordInfo.create)
    ..e<$1.CriterionTypeEnum_CriterionType>(4, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'type', $pb.PbFieldType.OE, defaultOrMaker: $1.CriterionTypeEnum_CriterionType.UNSPECIFIED, valueOf: $1.CriterionTypeEnum_CriterionType.valueOf, enumValues: $1.CriterionTypeEnum_CriterionType.values)
    ..aOM<$0.YouTubeVideoInfo>(5, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'youtubeVideo', subBuilder: $0.YouTubeVideoInfo.create)
    ..aOM<$0.YouTubeChannelInfo>(6, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'youtubeChannel', subBuilder: $0.YouTubeChannelInfo.create)
    ..aOM<$0.PlacementInfo>(7, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'placement', subBuilder: $0.PlacementInfo.create)
    ..aOM<$0.MobileAppCategoryInfo>(8, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'mobileAppCategory', subBuilder: $0.MobileAppCategoryInfo.create)
    ..aOM<$0.MobileApplicationInfo>(9, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'mobileApplication', subBuilder: $0.MobileApplicationInfo.create)
    ..aOS(10, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'sharedSet')
    ..aInt64(11, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'criterionId')
  ...
  'Will be removed in next major version')
  SharedCriterion copyWith(void Function(SharedCriterion) updates) => super.copyWith((message) => updates(message as SharedCriterion)) as SharedCriterion; // ignore: deprecated_member_use
  ...
  @$pb.TagNumber(3)
  set keyword($0.KeywordInfo v) { setField(3, v); }
  @$pb.TagNumber(3)
  ...
  @$pb.TagNumber(4)
  set type($1.CriterionTypeEnum_CriterionType v) { setField(4, v); }
  @$pb.TagNumber(4)
  ...
  @$pb.TagNumber(5)
  set youtubeVideo($0.YouTubeVideoInfo v) { setField(5, v); }
  @$pb.TagNumber(5)
  ...
  @$pb.TagNumber(6)
  set youtubeChannel($0.YouTubeChannelInfo v) { setField(6, v); }
  @$pb.TagNumber(6)
  ...
  @$pb.TagNumber(7)
  set placement($0.PlacementInfo v) { setField(7, v); }
  @$pb.TagNumber(7)
  ...
  @$pb.TagNumber(8)
  set mobileAppCategory($0.MobileAppCategoryInfo v) { setField(8, v); }
  @$pb.TagNumber(8)
  ...
  @$pb.TagNumber(9)
  set mobileApplication($0.MobileApplicationInfo v) { setField(9, v); }
  @$pb.TagNumber(9)

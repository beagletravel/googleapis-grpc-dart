...
class RemarketingAction extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'RemarketingAction', package: const $pb.PackageName(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'google.ads.googleads.v10.resources'), createEmptyInstance: create)
    ..aOS(1, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'resourceName')
    ..pc<$0.TagSnippet>(4, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'tagSnippets', $pb.PbFieldType.PM, subBuilder: $0.TagSnippet.create)
  ...
  'Will be removed in next major version')
  RemarketingAction copyWith(void Function(RemarketingAction) updates) => super.copyWith((message) => updates(message as RemarketingAction)) as RemarketingAction; // ignore: deprecated_member_use

...
class KeywordPlanCampaignKeyword extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'KeywordPlanCampaignKeyword', package: const $pb.PackageName(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'google.ads.googleads.v10.resources'), createEmptyInstance: create)
    ...
    ..aOS(8, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'keywordPlanCampaign')
    ...
    ..aOB(11, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'negative')
  ...
  'Will be removed in next major version')
  KeywordPlanCampaignKeyword copyWith(void Function(KeywordPlanCampaignKeyword) updates) => super.copyWith((message) => updates(message as KeywordPlanCampaignKeyword)) as KeywordPlanCampaignKeyword; // ignore: deprecated_member_use
  ...
  @$pb.TagNumber(5)
  set matchType($0.KeywordMatchTypeEnum_KeywordMatchType v) { setField(5, v); }
  @$pb.TagNumber(5)

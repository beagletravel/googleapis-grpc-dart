...
//  source: google/ads/googleads/v10/resources/ad_parameter.proto
//
// @dart = 2.12
...
class AdParameter extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'AdParameter', package: const $pb.PackageName(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'google.ads.googleads.v10.resources'), createEmptyInstance: create)
    ..aOS(1, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'resourceName')
    ..aOS(5, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'adGroupCriterion')
    ..aInt64(6, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'parameterIndex')
    ..aOS(7, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'insertionText')
  ...
  'Will be removed in next major version')
  AdParameter copyWith(void Function(AdParameter) updates) => super.copyWith((message) => updates(message as AdParameter)) as AdParameter; // ignore: deprecated_member_use

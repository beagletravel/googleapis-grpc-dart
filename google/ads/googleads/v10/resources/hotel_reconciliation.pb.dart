...
class HotelReconciliation extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'HotelReconciliation', package: const $pb.PackageName(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'google.ads.googleads.v10.resources'), createEmptyInstance: create)
    ..aOS(1, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'resourceName')
    ..aOS(2, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'commissionId')
    ..aOS(3, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'orderId')
    ..aInt64(4, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'hotelCenterId')
    ..aOS(5, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'hotelId')
    ..aOS(6, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'checkInDate')
    ..aOS(7, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'checkOutDate')
    ..aInt64(8, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'reconciledValueMicros')
    ..aOB(9, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'billed')
    ..e<$0.HotelReconciliationStatusEnum_HotelReconciliationStatus>(10, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'status', $pb.PbFieldType.OE, defaultOrMaker: $0.HotelReconciliationStatusEnum_HotelReconciliationStatus.UNSPECIFIED, valueOf: $0.HotelReconciliationStatusEnum_HotelReconciliationStatus.valueOf, enumValues: $0.HotelReconciliationStatusEnum_HotelReconciliationStatus.values)
  ...
  'Will be removed in next major version')
  HotelReconciliation copyWith(void Function(HotelReconciliation) updates) => super.copyWith((message) => updates(message as HotelReconciliation)) as HotelReconciliation; // ignore: deprecated_member_use
  ...
  @$pb.TagNumber(10)
  $0.HotelReconciliationStatusEnum_HotelReconciliationStatus get status => $_getN(9);
  @$pb.TagNumber(10)
  set status($0.HotelReconciliationStatusEnum_HotelReconciliationStatus v) { setField(10, v); }
  @$pb.TagNumber(10)

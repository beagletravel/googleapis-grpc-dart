...
class Invoice_AccountBudgetSummary extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'Invoice.AccountBudgetSummary', package: const $pb.PackageName(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'google.ads.googleads.v10.resources'), createEmptyInstance: create)
    ..aOM<$0.DateRange>(9, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'billableActivityDateRange', subBuilder: $0.DateRange.create)
    ..aOS(10, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'customer')
    ..aOS(11, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'customerDescriptiveName')
    ..aOS(12, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'accountBudget')
    ..aOS(13, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'accountBudgetName')
    ..aOS(14, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'purchaseOrderNumber')
    ..aInt64(15, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'subtotalAmountMicros')
    ..aInt64(16, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'taxAmountMicros')
    ..aInt64(17, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'totalAmountMicros')
  ...
  'Will be removed in next major version')
  Invoice_AccountBudgetSummary copyWith(void Function(Invoice_AccountBudgetSummary) updates) => super.copyWith((message) => updates(message as Invoice_AccountBudgetSummary)) as Invoice_AccountBudgetSummary; // ignore: deprecated_member_use
  ...
  @$pb.TagNumber(9)
  set billableActivityDateRange($0.DateRange v) { setField(9, v); }
  @$pb.TagNumber(9)
...
class Invoice extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'Invoice', package: const $pb.PackageName(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'google.ads.googleads.v10.resources'), createEmptyInstance: create)
    ..aOS(1, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'resourceName')
    ..e<$1.InvoiceTypeEnum_InvoiceType>(3, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'type', $pb.PbFieldType.OE, defaultOrMaker: $1.InvoiceTypeEnum_InvoiceType.UNSPECIFIED, valueOf: $1.InvoiceTypeEnum_InvoiceType.valueOf, enumValues: $1.InvoiceTypeEnum_InvoiceType.values)
    ..aOM<$0.DateRange>(9, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'serviceDateRange', subBuilder: $0.DateRange.create)
    ..pc<Invoice_AccountBudgetSummary>(18, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'accountBudgetSummaries', $pb.PbFieldType.PM, subBuilder: Invoice_AccountBudgetSummary.create)
    ..aInt64(19, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'adjustmentsSubtotalAmountMicros')
    ..aInt64(20, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'adjustmentsTaxAmountMicros')
    ..aInt64(21, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'adjustmentsTotalAmountMicros')
    ..aInt64(22, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'regulatoryCostsSubtotalAmountMicros')
    ..aInt64(23, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'regulatoryCostsTaxAmountMicros')
    ..aInt64(24, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'regulatoryCostsTotalAmountMicros')
    ..aOS(25, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'id')
    ..aOS(26, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'billingSetup')
    ..aOS(27, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'paymentsAccountId')
    ..aOS(28, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'paymentsProfileId')
    ..aOS(29, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'issueDate')
    ..aOS(30, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'dueDate')
    ..aOS(31, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'currencyCode')
    ..aInt64(33, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'subtotalAmountMicros')
    ..aInt64(34, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'taxAmountMicros')
    ..aInt64(35, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'totalAmountMicros')
    ..aOS(36, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'correctedInvoice')
    ..pPS(37, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'replacedInvoices')
    ..aOS(38, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'pdfUrl')
    ..hasRequiredFields = false
  ;
  ...
  factory Invoice({
    ...
    if (regulatoryCostsSubtotalAmountMicros != null) {
      _result.regulatoryCostsSubtotalAmountMicros = regulatoryCostsSubtotalAmountMicros;
    }
    ...
    if (regulatoryCostsTotalAmountMicros != null) {
      _result.regulatoryCostsTotalAmountMicros = regulatoryCostsTotalAmountMicros;
    }
    if (id != null) {
      _result.id = id;
    }
  ...
  @$pb.TagNumber(3)
  set type($1.InvoiceTypeEnum_InvoiceType v) { setField(3, v); }
  @$pb.TagNumber(3)
  ...
  @$pb.TagNumber(9)
  set serviceDateRange($0.DateRange v) { setField(9, v); }
  @$pb.TagNumber(9)

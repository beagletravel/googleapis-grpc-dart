...
class AssetGroupAsset extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'AssetGroupAsset', package: const $pb.PackageName(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'google.ads.googleads.v10.resources'), createEmptyInstance: create)
    ...
    ..e<$1.AssetFieldTypeEnum_AssetFieldType>(4, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'fieldType', $pb.PbFieldType.OE, defaultOrMaker: $1.AssetFieldTypeEnum_AssetFieldType.UNSPECIFIED, valueOf: $1.AssetFieldTypeEnum_AssetFieldType.valueOf, enumValues: $1.AssetFieldTypeEnum_AssetFieldType.values)
    ..e<$2.AssetLinkStatusEnum_AssetLinkStatus>(5, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'status', $pb.PbFieldType.OE, defaultOrMaker: $2.AssetLinkStatusEnum_AssetLinkStatus.UNSPECIFIED, valueOf: $2.AssetLinkStatusEnum_AssetLinkStatus.valueOf, enumValues: $2.AssetLinkStatusEnum_AssetLinkStatus.values)
    ..e<$3.AssetPerformanceLabelEnum_AssetPerformanceLabel>(6, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'performanceLabel', $pb.PbFieldType.OE, defaultOrMaker: $3.AssetPerformanceLabelEnum_AssetPerformanceLabel.UNSPECIFIED, valueOf: $3.AssetPerformanceLabelEnum_AssetPerformanceLabel.valueOf, enumValues: $3.AssetPerformanceLabelEnum_AssetPerformanceLabel.values)
    ..aOM<$0.PolicySummary>(7, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'policySummary', subBuilder: $0.PolicySummary.create)
  ...
  'Will be removed in next major version')
  AssetGroupAsset copyWith(void Function(AssetGroupAsset) updates) => super.copyWith((message) => updates(message as AssetGroupAsset)) as AssetGroupAsset; // ignore: deprecated_member_use
  ...
  @$pb.TagNumber(4)
  set fieldType($1.AssetFieldTypeEnum_AssetFieldType v) { setField(4, v); }
  @$pb.TagNumber(4)
  ...
  @$pb.TagNumber(5)
  set status($2.AssetLinkStatusEnum_AssetLinkStatus v) { setField(5, v); }
  @$pb.TagNumber(5)
  ...
  @$pb.TagNumber(6)
  $3.AssetPerformanceLabelEnum_AssetPerformanceLabel get performanceLabel => $_getN(5);
  @$pb.TagNumber(6)
  set performanceLabel($3.AssetPerformanceLabelEnum_AssetPerformanceLabel v) { setField(6, v); }
  @$pb.TagNumber(6)
  ...
  @$pb.TagNumber(7)
  set policySummary($0.PolicySummary v) { setField(7, v); }
  @$pb.TagNumber(7)

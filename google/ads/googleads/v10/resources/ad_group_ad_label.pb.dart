...
class AdGroupAdLabel extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'AdGroupAdLabel', package: const $pb.PackageName(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'google.ads.googleads.v10.resources'), createEmptyInstance: create)
    ..aOS(1, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'resourceName')
    ..aOS(4, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'adGroupAd')
  ...
  'Will be removed in next major version')
  AdGroupAdLabel copyWith(void Function(AdGroupAdLabel) updates) => super.copyWith((message) => updates(message as AdGroupAdLabel)) as AdGroupAdLabel; // ignore: deprecated_member_use

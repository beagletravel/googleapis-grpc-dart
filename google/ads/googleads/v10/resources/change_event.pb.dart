...
import 'asset_set.pb.dart' as $17;
import 'asset_set_asset.pb.dart' as $18;
import 'campaign_asset_set.pb.dart' as $19;

import '../enums/change_event_resource_type.pbenum.dart' as $20;
import '../enums/change_client_type.pbenum.dart' as $21;
import '../enums/resource_change_operation.pbenum.dart' as $22;

class ChangeEvent_ChangedResource extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'ChangeEvent.ChangedResource', package: const $pb.PackageName(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'google.ads.googleads.v10.resources'), createEmptyInstance: create)
    ..aOM<$1.Ad>(1, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'ad', subBuilder: $1.Ad.create)
    ..aOM<$2.AdGroup>(2, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'adGroup', subBuilder: $2.AdGroup.create)
    ..aOM<$3.AdGroupCriterion>(3, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'adGroupCriterion', subBuilder: $3.AdGroupCriterion.create)
    ..aOM<$4.Campaign>(4, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'campaign', subBuilder: $4.Campaign.create)
    ..aOM<$5.CampaignBudget>(5, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'campaignBudget', subBuilder: $5.CampaignBudget.create)
    ..aOM<$6.AdGroupBidModifier>(6, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'adGroupBidModifier', subBuilder: $6.AdGroupBidModifier.create)
    ..aOM<$7.CampaignCriterion>(7, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'campaignCriterion', subBuilder: $7.CampaignCriterion.create)
    ..aOM<$8.Feed>(8, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'feed', subBuilder: $8.Feed.create)
    ..aOM<$9.FeedItem>(9, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'feedItem', subBuilder: $9.FeedItem.create)
    ..aOM<$10.CampaignFeed>(10, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'campaignFeed', subBuilder: $10.CampaignFeed.create)
    ..aOM<$11.AdGroupFeed>(11, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'adGroupFeed', subBuilder: $11.AdGroupFeed.create)
    ..aOM<$12.AdGroupAd>(12, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'adGroupAd', subBuilder: $12.AdGroupAd.create)
    ..aOM<$13.Asset>(13, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'asset', subBuilder: $13.Asset.create)
    ..aOM<$14.CustomerAsset>(14, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'customerAsset', subBuilder: $14.CustomerAsset.create)
    ..aOM<$15.CampaignAsset>(15, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'campaignAsset', subBuilder: $15.CampaignAsset.create)
    ..aOM<$16.AdGroupAsset>(16, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'adGroupAsset', subBuilder: $16.AdGroupAsset.create)
    ..aOM<$17.AssetSet>(17, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'assetSet', subBuilder: $17.AssetSet.create)
    ..aOM<$18.AssetSetAsset>(18, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'assetSetAsset', subBuilder: $18.AssetSetAsset.create)
    ..aOM<$19.CampaignAssetSet>(19, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'campaignAssetSet', subBuilder: $19.CampaignAssetSet.create)
  ...
  factory ChangeEvent_ChangedResource({
    ...
    $17.AssetSet? assetSet,
    $18.AssetSetAsset? assetSetAsset,
    $19.CampaignAssetSet? campaignAssetSet,
  }) {
  ...
  'Will be removed in next major version')
  ChangeEvent_ChangedResource copyWith(void Function(ChangeEvent_ChangedResource) updates) => super.copyWith((message) => updates(message as ChangeEvent_ChangedResource)) as ChangeEvent_ChangedResource; // ignore: deprecated_member_use
  ...
  @$pb.TagNumber(2)
  set adGroup($2.AdGroup v) { setField(2, v); }
  @$pb.TagNumber(2)
  ...
  @$pb.TagNumber(3)
  set adGroupCriterion($3.AdGroupCriterion v) { setField(3, v); }
  @$pb.TagNumber(3)
  ...
  @$pb.TagNumber(4)
  set campaign($4.Campaign v) { setField(4, v); }
  @$pb.TagNumber(4)
  ...
  @$pb.TagNumber(5)
  set campaignBudget($5.CampaignBudget v) { setField(5, v); }
  @$pb.TagNumber(5)
  ...
  @$pb.TagNumber(6)
  set adGroupBidModifier($6.AdGroupBidModifier v) { setField(6, v); }
  @$pb.TagNumber(6)
  ...
  @$pb.TagNumber(7)
  set campaignCriterion($7.CampaignCriterion v) { setField(7, v); }
  @$pb.TagNumber(7)
  ...
  @$pb.TagNumber(8)
  set feed($8.Feed v) { setField(8, v); }
  @$pb.TagNumber(8)
  ...
  @$pb.TagNumber(9)
  set feedItem($9.FeedItem v) { setField(9, v); }
  @$pb.TagNumber(9)
  ...
  @$pb.TagNumber(10)
  set campaignFeed($10.CampaignFeed v) { setField(10, v); }
  @$pb.TagNumber(10)
  ...
  @$pb.TagNumber(11)
  set adGroupFeed($11.AdGroupFeed v) { setField(11, v); }
  @$pb.TagNumber(11)
  ...
  @$pb.TagNumber(12)
  set adGroupAd($12.AdGroupAd v) { setField(12, v); }
  @$pb.TagNumber(12)
  ...
  @$pb.TagNumber(13)
  set asset($13.Asset v) { setField(13, v); }
  @$pb.TagNumber(13)
  ...
  @$pb.TagNumber(14)
  set customerAsset($14.CustomerAsset v) { setField(14, v); }
  @$pb.TagNumber(14)
  ...
  @$pb.TagNumber(15)
  set campaignAsset($15.CampaignAsset v) { setField(15, v); }
  @$pb.TagNumber(15)
  ...
  @$pb.TagNumber(16)
  set adGroupAsset($16.AdGroupAsset v) { setField(16, v); }
  @$pb.TagNumber(16)
  ...
  @$pb.TagNumber(17)
  $17.AssetSet get assetSet => $_getN(16);
  @$pb.TagNumber(17)
  set assetSet($17.AssetSet v) { setField(17, v); }
  @$pb.TagNumber(17)
  $core.bool hasAssetSet() => $_has(16);
  @$pb.TagNumber(17)
  void clearAssetSet() => clearField(17);
  @$pb.TagNumber(17)
  $17.AssetSet ensureAssetSet() => $_ensure(16);

  @$pb.TagNumber(18)
  $18.AssetSetAsset get assetSetAsset => $_getN(17);
  @$pb.TagNumber(18)
  set assetSetAsset($18.AssetSetAsset v) { setField(18, v); }
  @$pb.TagNumber(18)
  $core.bool hasAssetSetAsset() => $_has(17);
  @$pb.TagNumber(18)
  void clearAssetSetAsset() => clearField(18);
  @$pb.TagNumber(18)
  $18.AssetSetAsset ensureAssetSetAsset() => $_ensure(17);

  @$pb.TagNumber(19)
  $19.CampaignAssetSet get campaignAssetSet => $_getN(18);
  @$pb.TagNumber(19)
  set campaignAssetSet($19.CampaignAssetSet v) { setField(19, v); }
  @$pb.TagNumber(19)
  $core.bool hasCampaignAssetSet() => $_has(18);
  @$pb.TagNumber(19)
  void clearCampaignAssetSet() => clearField(19);
  @$pb.TagNumber(19)
  $19.CampaignAssetSet ensureCampaignAssetSet() => $_ensure(18);
}

class ChangeEvent extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'ChangeEvent', package: const $pb.PackageName(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'google.ads.googleads.v10.resources'), createEmptyInstance: create)
    ..aOS(1, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'resourceName')
    ..aOS(2, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'changeDateTime')
    ..e<$20.ChangeEventResourceTypeEnum_ChangeEventResourceType>(3, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'changeResourceType', $pb.PbFieldType.OE, defaultOrMaker: $20.ChangeEventResourceTypeEnum_ChangeEventResourceType.UNSPECIFIED, valueOf: $20.ChangeEventResourceTypeEnum_ChangeEventResourceType.valueOf, enumValues: $20.ChangeEventResourceTypeEnum_ChangeEventResourceType.values)
    ..aOS(4, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'changeResourceName')
    ..e<$21.ChangeClientTypeEnum_ChangeClientType>(5, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'clientType', $pb.PbFieldType.OE, defaultOrMaker: $21.ChangeClientTypeEnum_ChangeClientType.UNSPECIFIED, valueOf: $21.ChangeClientTypeEnum_ChangeClientType.valueOf, enumValues: $21.ChangeClientTypeEnum_ChangeClientType.values)
    ..aOS(6, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'userEmail')
    ..aOM<ChangeEvent_ChangedResource>(7, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'oldResource', subBuilder: ChangeEvent_ChangedResource.create)
    ..aOM<ChangeEvent_ChangedResource>(8, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'newResource', subBuilder: ChangeEvent_ChangedResource.create)
    ..e<$22.ResourceChangeOperationEnum_ResourceChangeOperation>(9, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'resourceChangeOperation', $pb.PbFieldType.OE, defaultOrMaker: $22.ResourceChangeOperationEnum_ResourceChangeOperation.UNSPECIFIED, valueOf: $22.ResourceChangeOperationEnum_ResourceChangeOperation.valueOf, enumValues: $22.ResourceChangeOperationEnum_ResourceChangeOperation.values)
    ..aOM<$0.FieldMask>(10, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'changedFields', subBuilder: $0.FieldMask.create)
    ..aOS(11, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'campaign')
    ..aOS(12, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'adGroup')
    ..aOS(13, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'feed')
    ..aOS(14, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'feedItem')
    ..aOS(20, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'asset')
    ..hasRequiredFields = false
  ;
  ...
  factory ChangeEvent({
    ...
    $20.ChangeEventResourceTypeEnum_ChangeEventResourceType? changeResourceType,
    $core.String? changeResourceName,
    $21.ChangeClientTypeEnum_ChangeClientType? clientType,
    $core.String? userEmail,
    ChangeEvent_ChangedResource? oldResource,
    ChangeEvent_ChangedResource? newResource,
    $22.ResourceChangeOperationEnum_ResourceChangeOperation? resourceChangeOperation,
  ...
  'Use [GeneratedMessageGenericExtensions.rebuild] instead. '
  'Will be removed in next major version')
  ChangeEvent copyWith(void Function(ChangeEvent) updates) => super.copyWith((message) => updates(message as ChangeEvent)) as ChangeEvent; // ignore: deprecated_member_use
  $pb.BuilderInfo get info_ => _i;
  @$core.pragma('dart2js:noInline')
  ...
  @$pb.TagNumber(3)
  $20.ChangeEventResourceTypeEnum_ChangeEventResourceType get changeResourceType => $_getN(2);
  @$pb.TagNumber(3)
  set changeResourceType($20.ChangeEventResourceTypeEnum_ChangeEventResourceType v) { setField(3, v); }
  @$pb.TagNumber(3)
  ...
  @$pb.TagNumber(5)
  $21.ChangeClientTypeEnum_ChangeClientType get clientType => $_getN(4);
  @$pb.TagNumber(5)
  set clientType($21.ChangeClientTypeEnum_ChangeClientType v) { setField(5, v); }
  @$pb.TagNumber(5)
  ...
  @$pb.TagNumber(9)
  $22.ResourceChangeOperationEnum_ResourceChangeOperation get resourceChangeOperation => $_getN(8);
  @$pb.TagNumber(9)
  set resourceChangeOperation($22.ResourceChangeOperationEnum_ResourceChangeOperation v) { setField(9, v); }
  @$pb.TagNumber(9)
  ...
  @$pb.TagNumber(10)
  set changedFields($0.FieldMask v) { setField(10, v); }
  @$pb.TagNumber(10)

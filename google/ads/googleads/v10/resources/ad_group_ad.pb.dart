...
class AdGroupAd extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'AdGroupAd', package: const $pb.PackageName(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'google.ads.googleads.v10.resources'), createEmptyInstance: create)
    ..aOS(1, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'resourceName')
    ..e<$2.AdGroupAdStatusEnum_AdGroupAdStatus>(3, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'status', $pb.PbFieldType.OE, defaultOrMaker: $2.AdGroupAdStatusEnum_AdGroupAdStatus.UNSPECIFIED, valueOf: $2.AdGroupAdStatusEnum_AdGroupAdStatus.valueOf, enumValues: $2.AdGroupAdStatusEnum_AdGroupAdStatus.values)
    ..aOM<$0.Ad>(5, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'ad', subBuilder: $0.Ad.create)
    ..aOM<AdGroupAdPolicySummary>(6, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'policySummary', subBuilder: AdGroupAdPolicySummary.create)
    ..e<$3.AdStrengthEnum_AdStrength>(7, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'adStrength', $pb.PbFieldType.OE, defaultOrMaker: $3.AdStrengthEnum_AdStrength.UNSPECIFIED, valueOf: $3.AdStrengthEnum_AdStrength.valueOf, enumValues: $3.AdStrengthEnum_AdStrength.values)
    ..aOS(9, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'adGroup')
    ..pPS(10, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'labels')
    ..pPS(13, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'actionItems')
  ...
  'Will be removed in next major version')
  AdGroupAd copyWith(void Function(AdGroupAd) updates) => super.copyWith((message) => updates(message as AdGroupAd)) as AdGroupAd; // ignore: deprecated_member_use
  ...
  @$pb.TagNumber(3)
  set status($2.AdGroupAdStatusEnum_AdGroupAdStatus v) { setField(3, v); }
  @$pb.TagNumber(3)
  ...
  @$pb.TagNumber(7)
  set adStrength($3.AdStrengthEnum_AdStrength v) { setField(7, v); }
  @$pb.TagNumber(7)
...
class AdGroupAdPolicySummary extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'AdGroupAdPolicySummary', package: const $pb.PackageName(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'google.ads.googleads.v10.resources'), createEmptyInstance: create)
  ...
  'Use [GeneratedMessageGenericExtensions.rebuild] instead. '
  'Will be removed in next major version')
  AdGroupAdPolicySummary copyWith(void Function(AdGroupAdPolicySummary) updates) => super.copyWith((message) => updates(message as AdGroupAdPolicySummary)) as AdGroupAdPolicySummary; // ignore: deprecated_member_use
  $pb.BuilderInfo get info_ => _i;
  @$core.pragma('dart2js:noInline')

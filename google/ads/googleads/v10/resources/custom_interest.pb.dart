...
class CustomInterest extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'CustomInterest', package: const $pb.PackageName(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'google.ads.googleads.v10.resources'), createEmptyInstance: create)
    ..aOS(1, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'resourceName')
    ..e<$0.CustomInterestStatusEnum_CustomInterestStatus>(3, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'status', $pb.PbFieldType.OE, defaultOrMaker: $0.CustomInterestStatusEnum_CustomInterestStatus.UNSPECIFIED, valueOf: $0.CustomInterestStatusEnum_CustomInterestStatus.valueOf, enumValues: $0.CustomInterestStatusEnum_CustomInterestStatus.values)
    ..e<$1.CustomInterestTypeEnum_CustomInterestType>(5, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'type', $pb.PbFieldType.OE, defaultOrMaker: $1.CustomInterestTypeEnum_CustomInterestType.UNSPECIFIED, valueOf: $1.CustomInterestTypeEnum_CustomInterestType.valueOf, enumValues: $1.CustomInterestTypeEnum_CustomInterestType.values)
    ..pc<CustomInterestMember>(7, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'members', $pb.PbFieldType.PM, subBuilder: CustomInterestMember.create)
  ...
  'Will be removed in next major version')
  CustomInterest copyWith(void Function(CustomInterest) updates) => super.copyWith((message) => updates(message as CustomInterest)) as CustomInterest; // ignore: deprecated_member_use
  ...
  @$pb.TagNumber(3)
  set status($0.CustomInterestStatusEnum_CustomInterestStatus v) { setField(3, v); }
  @$pb.TagNumber(3)
  ...
  @$pb.TagNumber(5)
  set type($1.CustomInterestTypeEnum_CustomInterestType v) { setField(5, v); }
  @$pb.TagNumber(5)
...
class CustomInterestMember extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'CustomInterestMember', package: const $pb.PackageName(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'google.ads.googleads.v10.resources'), createEmptyInstance: create)
    ..e<$2.CustomInterestMemberTypeEnum_CustomInterestMemberType>(1, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'memberType', $pb.PbFieldType.OE, defaultOrMaker: $2.CustomInterestMemberTypeEnum_CustomInterestMemberType.UNSPECIFIED, valueOf: $2.CustomInterestMemberTypeEnum_CustomInterestMemberType.valueOf, enumValues: $2.CustomInterestMemberTypeEnum_CustomInterestMemberType.values)
    ..aOS(3, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'parameter')
    ..hasRequiredFields = false
  ;
  ...
  'Use [GeneratedMessageGenericExtensions.rebuild] instead. '
  'Will be removed in next major version')
  CustomInterestMember copyWith(void Function(CustomInterestMember) updates) => super.copyWith((message) => updates(message as CustomInterestMember)) as CustomInterestMember; // ignore: deprecated_member_use
  $pb.BuilderInfo get info_ => _i;
  @$core.pragma('dart2js:noInline')
  ...
  @$pb.TagNumber(1)
  $2.CustomInterestMemberTypeEnum_CustomInterestMemberType get memberType => $_getN(0);
  @$pb.TagNumber(1)
  set memberType($2.CustomInterestMemberTypeEnum_CustomInterestMemberType v) { setField(1, v); }
  @$pb.TagNumber(1)

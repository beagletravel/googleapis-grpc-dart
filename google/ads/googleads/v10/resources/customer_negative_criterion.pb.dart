...
class CustomerNegativeCriterion extends $pb.GeneratedMessage {
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'CustomerNegativeCriterion', package: const $pb.PackageName(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'google.ads.googleads.v10.resources'), createEmptyInstance: create)
    ..oo(0, [4, 5, 6, 7, 8, 9])
    ..aOS(1, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'resourceName')
    ..e<$1.CriterionTypeEnum_CriterionType>(3, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'type', $pb.PbFieldType.OE, defaultOrMaker: $1.CriterionTypeEnum_CriterionType.UNSPECIFIED, valueOf: $1.CriterionTypeEnum_CriterionType.valueOf, enumValues: $1.CriterionTypeEnum_CriterionType.values)
    ..aOM<$0.ContentLabelInfo>(4, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'contentLabel', subBuilder: $0.ContentLabelInfo.create)
    ..aOM<$0.MobileApplicationInfo>(5, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'mobileApplication', subBuilder: $0.MobileApplicationInfo.create)
    ..aOM<$0.MobileAppCategoryInfo>(6, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'mobileAppCategory', subBuilder: $0.MobileAppCategoryInfo.create)
    ...
    ..aOM<$0.YouTubeVideoInfo>(8, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'youtubeVideo', subBuilder: $0.YouTubeVideoInfo.create)
    ..aOM<$0.YouTubeChannelInfo>(9, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'youtubeChannel', subBuilder: $0.YouTubeChannelInfo.create)
    ..aInt64(10, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'id')
  ...
  'Will be removed in next major version')
  CustomerNegativeCriterion copyWith(void Function(CustomerNegativeCriterion) updates) => super.copyWith((message) => updates(message as CustomerNegativeCriterion)) as CustomerNegativeCriterion; // ignore: deprecated_member_use
  ...
  @$pb.TagNumber(3)
  set type($1.CriterionTypeEnum_CriterionType v) { setField(3, v); }
  @$pb.TagNumber(3)
  ...
  @$pb.TagNumber(4)
  set contentLabel($0.ContentLabelInfo v) { setField(4, v); }
  @$pb.TagNumber(4)
  ...
  @$pb.TagNumber(5)
  set mobileApplication($0.MobileApplicationInfo v) { setField(5, v); }
  @$pb.TagNumber(5)
  ...
  @$pb.TagNumber(6)
  set mobileAppCategory($0.MobileAppCategoryInfo v) { setField(6, v); }
  @$pb.TagNumber(6)
  ...
  @$pb.TagNumber(8)
  set youtubeVideo($0.YouTubeVideoInfo v) { setField(8, v); }
  @$pb.TagNumber(8)
  ...
  @$pb.TagNumber(9)
  set youtubeChannel($0.YouTubeChannelInfo v) { setField(9, v); }
  @$pb.TagNumber(9)

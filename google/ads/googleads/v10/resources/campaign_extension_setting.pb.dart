...
class CampaignExtensionSetting extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'CampaignExtensionSetting', package: const $pb.PackageName(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'google.ads.googleads.v10.resources'), createEmptyInstance: create)
  ...
  'Will be removed in next major version')
  CampaignExtensionSetting copyWith(void Function(CampaignExtensionSetting) updates) => super.copyWith((message) => updates(message as CampaignExtensionSetting)) as CampaignExtensionSetting; // ignore: deprecated_member_use
  ...
  @$pb.TagNumber(5)
  set device($1.ExtensionSettingDeviceEnum_ExtensionSettingDevice v) { setField(5, v); }
  @$pb.TagNumber(5)

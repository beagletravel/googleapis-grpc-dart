...
class CustomerUserAccessInvitation extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'CustomerUserAccessInvitation', package: const $pb.PackageName(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'google.ads.googleads.v10.resources'), createEmptyInstance: create)
    ..aOS(1, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'resourceName')
    ..aInt64(2, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'invitationId')
    ..e<$0.AccessRoleEnum_AccessRole>(3, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'accessRole', $pb.PbFieldType.OE, defaultOrMaker: $0.AccessRoleEnum_AccessRole.UNSPECIFIED, valueOf: $0.AccessRoleEnum_AccessRole.valueOf, enumValues: $0.AccessRoleEnum_AccessRole.values)
    ..aOS(4, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'emailAddress')
    ..aOS(5, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'creationDateTime')
    ..e<$1.AccessInvitationStatusEnum_AccessInvitationStatus>(6, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'invitationStatus', $pb.PbFieldType.OE, defaultOrMaker: $1.AccessInvitationStatusEnum_AccessInvitationStatus.UNSPECIFIED, valueOf: $1.AccessInvitationStatusEnum_AccessInvitationStatus.valueOf, enumValues: $1.AccessInvitationStatusEnum_AccessInvitationStatus.values)
  ...
  'Will be removed in next major version')
  CustomerUserAccessInvitation copyWith(void Function(CustomerUserAccessInvitation) updates) => super.copyWith((message) => updates(message as CustomerUserAccessInvitation)) as CustomerUserAccessInvitation; // ignore: deprecated_member_use
  ...
  @$pb.TagNumber(3)
  set accessRole($0.AccessRoleEnum_AccessRole v) { setField(3, v); }
  @$pb.TagNumber(3)
  ...
  @$pb.TagNumber(6)
  $1.AccessInvitationStatusEnum_AccessInvitationStatus get invitationStatus => $_getN(5);
  @$pb.TagNumber(6)
  set invitationStatus($1.AccessInvitationStatusEnum_AccessInvitationStatus v) { setField(6, v); }
  @$pb.TagNumber(6)

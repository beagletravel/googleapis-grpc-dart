...
class DetailedDemographic extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'DetailedDemographic', package: const $pb.PackageName(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'google.ads.googleads.v10.resources'), createEmptyInstance: create)
    ...
    ..aOB(5, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'launchedToAll')
    ..pc<$0.CriterionCategoryAvailability>(6, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'availabilities', $pb.PbFieldType.PM, subBuilder: $0.CriterionCategoryAvailability.create)
  ...
  'Will be removed in next major version')
  DetailedDemographic copyWith(void Function(DetailedDemographic) updates) => super.copyWith((message) => updates(message as DetailedDemographic)) as DetailedDemographic; // ignore: deprecated_member_use
  ...
  @$pb.TagNumber(6)
  $core.List<$0.CriterionCategoryAvailability> get availabilities => $_getList(5);
}

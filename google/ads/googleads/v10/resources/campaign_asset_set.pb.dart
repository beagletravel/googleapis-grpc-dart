...
class CampaignAssetSet extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'CampaignAssetSet', package: const $pb.PackageName(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'google.ads.googleads.v10.resources'), createEmptyInstance: create)
    ...
    ..aOS(3, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'assetSet')
    ..e<$0.AssetSetLinkStatusEnum_AssetSetLinkStatus>(4, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'status', $pb.PbFieldType.OE, defaultOrMaker: $0.AssetSetLinkStatusEnum_AssetSetLinkStatus.UNSPECIFIED, valueOf: $0.AssetSetLinkStatusEnum_AssetSetLinkStatus.valueOf, enumValues: $0.AssetSetLinkStatusEnum_AssetSetLinkStatus.values)
  ...
  'Will be removed in next major version')
  CampaignAssetSet copyWith(void Function(CampaignAssetSet) updates) => super.copyWith((message) => updates(message as CampaignAssetSet)) as CampaignAssetSet; // ignore: deprecated_member_use
  ...
  @$pb.TagNumber(4)
  set status($0.AssetSetLinkStatusEnum_AssetSetLinkStatus v) { setField(4, v); }
  @$pb.TagNumber(4)

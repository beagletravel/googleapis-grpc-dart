...
class AdGroup_AudienceSetting extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'AdGroup.AudienceSetting', package: const $pb.PackageName(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'google.ads.googleads.v10.resources'), createEmptyInstance: create)
  ...
  'Will be removed in next major version')
  AdGroup_AudienceSetting copyWith(void Function(AdGroup_AudienceSetting) updates) => super.copyWith((message) => updates(message as AdGroup_AudienceSetting)) as AdGroup_AudienceSetting; // ignore: deprecated_member_use
...
class AdGroup extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'AdGroup', package: const $pb.PackageName(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'google.ads.googleads.v10.resources'), createEmptyInstance: create)
    ..aOS(1, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'resourceName')
    ..e<$3.AdGroupStatusEnum_AdGroupStatus>(5, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'status', $pb.PbFieldType.OE, defaultOrMaker: $3.AdGroupStatusEnum_AdGroupStatus.UNSPECIFIED, valueOf: $3.AdGroupStatusEnum_AdGroupStatus.valueOf, enumValues: $3.AdGroupStatusEnum_AdGroupStatus.values)
    ..pc<$0.CustomParameter>(6, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'urlCustomParameters', $pb.PbFieldType.PM, subBuilder: $0.CustomParameter.create)
    ..e<$4.AdGroupTypeEnum_AdGroupType>(12, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'type', $pb.PbFieldType.OE, defaultOrMaker: $4.AdGroupTypeEnum_AdGroupType.UNSPECIFIED, valueOf: $4.AdGroupTypeEnum_AdGroupType.valueOf, enumValues: $4.AdGroupTypeEnum_AdGroupType.values)
    ..aOM<$1.ExplorerAutoOptimizerSetting>(21, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'explorerAutoOptimizerSetting', subBuilder: $1.ExplorerAutoOptimizerSetting.create)
    ..e<$5.AdGroupAdRotationModeEnum_AdGroupAdRotationMode>(22, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'adRotationMode', $pb.PbFieldType.OE, defaultOrMaker: $5.AdGroupAdRotationModeEnum_AdGroupAdRotationMode.UNSPECIFIED, valueOf: $5.AdGroupAdRotationModeEnum_AdGroupAdRotationMode.valueOf, enumValues: $5.AdGroupAdRotationModeEnum_AdGroupAdRotationMode.values)
    ..e<$6.TargetingDimensionEnum_TargetingDimension>(23, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'displayCustomBidDimension', $pb.PbFieldType.OE, defaultOrMaker: $6.TargetingDimensionEnum_TargetingDimension.UNSPECIFIED, valueOf: $6.TargetingDimensionEnum_TargetingDimension.valueOf, enumValues: $6.TargetingDimensionEnum_TargetingDimension.values)
    ..aOM<$2.TargetingSetting>(25, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'targetingSetting', subBuilder: $2.TargetingSetting.create)
    ..e<$7.BiddingSourceEnum_BiddingSource>(29, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'effectiveTargetCpaSource', $pb.PbFieldType.OE, defaultOrMaker: $7.BiddingSourceEnum_BiddingSource.UNSPECIFIED, valueOf: $7.BiddingSourceEnum_BiddingSource.valueOf, enumValues: $7.BiddingSourceEnum_BiddingSource.values)
    ..e<$7.BiddingSourceEnum_BiddingSource>(32, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'effectiveTargetRoasSource', $pb.PbFieldType.OE, defaultOrMaker: $7.BiddingSourceEnum_BiddingSource.UNSPECIFIED, valueOf: $7.BiddingSourceEnum_BiddingSource.valueOf, enumValues: $7.BiddingSourceEnum_BiddingSource.values)
    ..aInt64(34, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'id')
    ..aOS(35, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'name')
    ..aOS(36, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'baseAdGroup')
    ..aOS(37, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'trackingUrlTemplate')
    ..aOS(38, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'campaign')
    ..aInt64(39, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'cpcBidMicros')
    ..aInt64(40, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'cpmBidMicros')
    ..aInt64(41, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'targetCpaMicros')
    ..aInt64(42, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'cpvBidMicros')
    ..aInt64(43, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'targetCpmMicros')
    ..a<$core.double>(44, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'targetRoas', $pb.PbFieldType.OD)
    ..aInt64(45, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'percentCpcBidMicros')
    ..aOS(46, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'finalUrlSuffix')
    ..aInt64(47, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'effectiveTargetCpaMicros')
    ..a<$core.double>(48, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'effectiveTargetRoas', $pb.PbFieldType.OD)
    ..pPS(49, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'labels')
    ..pc<$8.AssetFieldTypeEnum_AssetFieldType>(54, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'excludedParentAssetFieldTypes', $pb.PbFieldType.PE, valueOf: $8.AssetFieldTypeEnum_AssetFieldType.valueOf, enumValues: $8.AssetFieldTypeEnum_AssetFieldType.values)
    ..aOM<AdGroup_AudienceSetting>(56, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'audienceSetting', subBuilder: AdGroup_AudienceSetting.create)
    ..aInt64(57, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'effectiveCpcBidMicros')
    ..hasRequiredFields = false
  ;
  ...
  factory AdGroup({
    ...
    $core.Iterable<$8.AssetFieldTypeEnum_AssetFieldType>? excludedParentAssetFieldTypes,
  ...
  'Use [GeneratedMessageGenericExtensions.rebuild] instead. '
  'Will be removed in next major version')
  AdGroup copyWith(void Function(AdGroup) updates) => super.copyWith((message) => updates(message as AdGroup)) as AdGroup; // ignore: deprecated_member_use
  $pb.BuilderInfo get info_ => _i;
  @$core.pragma('dart2js:noInline')
  ...
  @$pb.TagNumber(5)
  set status($3.AdGroupStatusEnum_AdGroupStatus v) { setField(5, v); }
  @$pb.TagNumber(5)
  ...
  @$pb.TagNumber(12)
  set type($4.AdGroupTypeEnum_AdGroupType v) { setField(12, v); }
  @$pb.TagNumber(12)
  ...
  @$pb.TagNumber(21)
  set explorerAutoOptimizerSetting($1.ExplorerAutoOptimizerSetting v) { setField(21, v); }
  @$pb.TagNumber(21)
  $core.bool hasExplorerAutoOptimizerSetting() => $_has(4);
  @$pb.TagNumber(21)
  void clearExplorerAutoOptimizerSetting() => clearField(21);
  @$pb.TagNumber(21)
  $1.ExplorerAutoOptimizerSetting ensureExplorerAutoOptimizerSetting() => $_ensure(4);

  @$pb.TagNumber(22)
  $5.AdGroupAdRotationModeEnum_AdGroupAdRotationMode get adRotationMode => $_getN(5);
  @$pb.TagNumber(22)
  set adRotationMode($5.AdGroupAdRotationModeEnum_AdGroupAdRotationMode v) { setField(22, v); }
  @$pb.TagNumber(22)
  ...
  @$pb.TagNumber(23)
  $6.TargetingDimensionEnum_TargetingDimension get displayCustomBidDimension => $_getN(6);
  @$pb.TagNumber(23)
  set displayCustomBidDimension($6.TargetingDimensionEnum_TargetingDimension v) { setField(23, v); }
  @$pb.TagNumber(23)
  ...
  @$pb.TagNumber(25)
  set targetingSetting($2.TargetingSetting v) { setField(25, v); }
  @$pb.TagNumber(25)
  ...
  @$pb.TagNumber(29)
  set effectiveTargetCpaSource($7.BiddingSourceEnum_BiddingSource v) { setField(29, v); }
  @$pb.TagNumber(29)
  ...
  @$pb.TagNumber(32)
  set effectiveTargetRoasSource($7.BiddingSourceEnum_BiddingSource v) { setField(32, v); }
  @$pb.TagNumber(32)
  ...
  @$pb.TagNumber(36)
  set baseAdGroup($core.String v) { $_setString(12, v); }
  @$pb.TagNumber(36)
  ...
  @$pb.TagNumber(37)
  set trackingUrlTemplate($core.String v) { $_setString(13, v); }
  @$pb.TagNumber(37)
  ...
  @$pb.TagNumber(38)
  set campaign($core.String v) { $_setString(14, v); }
  @$pb.TagNumber(38)
  ...
  @$pb.TagNumber(39)
  set cpcBidMicros($fixnum.Int64 v) { $_setInt64(15, v); }
  @$pb.TagNumber(39)
  ...
  @$pb.TagNumber(40)
  set cpmBidMicros($fixnum.Int64 v) { $_setInt64(16, v); }
  @$pb.TagNumber(40)
  ...
  @$pb.TagNumber(41)
  set targetCpaMicros($fixnum.Int64 v) { $_setInt64(17, v); }
  @$pb.TagNumber(41)
  ...
  @$pb.TagNumber(42)
  set cpvBidMicros($fixnum.Int64 v) { $_setInt64(18, v); }
  @$pb.TagNumber(42)
  ...
  @$pb.TagNumber(43)
  set targetCpmMicros($fixnum.Int64 v) { $_setInt64(19, v); }
  @$pb.TagNumber(43)
  ...
  @$pb.TagNumber(44)
  set targetRoas($core.double v) { $_setDouble(20, v); }
  @$pb.TagNumber(44)
  ...
  @$pb.TagNumber(45)
  set percentCpcBidMicros($fixnum.Int64 v) { $_setInt64(21, v); }
  @$pb.TagNumber(45)
  ...
  @$pb.TagNumber(46)
  set finalUrlSuffix($core.String v) { $_setString(22, v); }
  @$pb.TagNumber(46)
  ...
  @$pb.TagNumber(47)
  set effectiveTargetCpaMicros($fixnum.Int64 v) { $_setInt64(23, v); }
  @$pb.TagNumber(47)
  ...
  @$pb.TagNumber(48)
  set effectiveTargetRoas($core.double v) { $_setDouble(24, v); }
  @$pb.TagNumber(48)
  ...
  @$pb.TagNumber(54)
  $core.List<$8.AssetFieldTypeEnum_AssetFieldType> get excludedParentAssetFieldTypes => $_getList(26);

  @$pb.TagNumber(56)
  AdGroup_AudienceSetting get audienceSetting => $_getN(27);
  @$pb.TagNumber(56)
  set audienceSetting(AdGroup_AudienceSetting v) { setField(56, v); }
  @$pb.TagNumber(56)
  $core.bool hasAudienceSetting() => $_has(27);
  @$pb.TagNumber(56)
  void clearAudienceSetting() => clearField(56);
  @$pb.TagNumber(56)
  AdGroup_AudienceSetting ensureAudienceSetting() => $_ensure(27);

  @$pb.TagNumber(57)
  $fixnum.Int64 get effectiveCpcBidMicros => $_getI64(28);
  @$pb.TagNumber(57)
  set effectiveCpcBidMicros($fixnum.Int64 v) { $_setInt64(28, v); }
  @$pb.TagNumber(57)
  $core.bool hasEffectiveCpcBidMicros() => $_has(28);
  @$pb.TagNumber(57)

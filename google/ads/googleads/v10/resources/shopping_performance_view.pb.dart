...
class ShoppingPerformanceView extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'ShoppingPerformanceView', package: const $pb.PackageName(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'google.ads.googleads.v10.resources'), createEmptyInstance: create)
  ...
  'Will be removed in next major version')
  ShoppingPerformanceView copyWith(void Function(ShoppingPerformanceView) updates) => super.copyWith((message) => updates(message as ShoppingPerformanceView)) as ShoppingPerformanceView; // ignore: deprecated_member_use

...
class GeoTargetConstant extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'GeoTargetConstant', package: const $pb.PackageName(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'google.ads.googleads.v10.resources'), createEmptyInstance: create)
    ..aOS(1, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'resourceName')
    ..e<$0.GeoTargetConstantStatusEnum_GeoTargetConstantStatus>(7, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'status', $pb.PbFieldType.OE, defaultOrMaker: $0.GeoTargetConstantStatusEnum_GeoTargetConstantStatus.UNSPECIFIED, valueOf: $0.GeoTargetConstantStatusEnum_GeoTargetConstantStatus.valueOf, enumValues: $0.GeoTargetConstantStatusEnum_GeoTargetConstantStatus.values)
    ..aOS(9, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'parentGeoTarget')
    ...
    ..aOS(13, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'targetType')
  ...
  'Will be removed in next major version')
  GeoTargetConstant copyWith(void Function(GeoTargetConstant) updates) => super.copyWith((message) => updates(message as GeoTargetConstant)) as GeoTargetConstant; // ignore: deprecated_member_use
  ...
  @$pb.TagNumber(7)
  $0.GeoTargetConstantStatusEnum_GeoTargetConstantStatus get status => $_getN(1);
  @$pb.TagNumber(7)
  set status($0.GeoTargetConstantStatusEnum_GeoTargetConstantStatus v) { setField(7, v); }
  @$pb.TagNumber(7)

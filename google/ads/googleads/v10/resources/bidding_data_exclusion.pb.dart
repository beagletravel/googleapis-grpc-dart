...
class BiddingDataExclusion extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'BiddingDataExclusion', package: const $pb.PackageName(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'google.ads.googleads.v10.resources'), createEmptyInstance: create)
    ..aOS(1, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'resourceName')
    ..aInt64(2, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'dataExclusionId')
    ...
    ..pPS(10, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'campaigns')
    ..pc<$3.AdvertisingChannelTypeEnum_AdvertisingChannelType>(11, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'advertisingChannelTypes', $pb.PbFieldType.PE, valueOf: $3.AdvertisingChannelTypeEnum_AdvertisingChannelType.valueOf, enumValues: $3.AdvertisingChannelTypeEnum_AdvertisingChannelType.values)
  ...
  'Will be removed in next major version')
  BiddingDataExclusion copyWith(void Function(BiddingDataExclusion) updates) => super.copyWith((message) => updates(message as BiddingDataExclusion)) as BiddingDataExclusion; // ignore: deprecated_member_use
  ...
  @$pb.TagNumber(11)
  $core.List<$3.AdvertisingChannelTypeEnum_AdvertisingChannelType> get advertisingChannelTypes => $_getList(10);
}

...
class UserInterest extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'UserInterest', package: const $pb.PackageName(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'google.ads.googleads.v10.resources'), createEmptyInstance: create)
    ..aOS(1, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'resourceName')
    ..e<$1.UserInterestTaxonomyTypeEnum_UserInterestTaxonomyType>(2, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'taxonomyType', $pb.PbFieldType.OE, defaultOrMaker: $1.UserInterestTaxonomyTypeEnum_UserInterestTaxonomyType.UNSPECIFIED, valueOf: $1.UserInterestTaxonomyTypeEnum_UserInterestTaxonomyType.valueOf, enumValues: $1.UserInterestTaxonomyTypeEnum_UserInterestTaxonomyType.values)
    ..pc<$0.CriterionCategoryAvailability>(7, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'availabilities', $pb.PbFieldType.PM, subBuilder: $0.CriterionCategoryAvailability.create)
    ..aInt64(8, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'userInterestId')
    ..aOS(9, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'name')
    ..aOS(10, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'userInterestParent')
    ..aOB(11, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'launchedToAll')
  ...
  'Will be removed in next major version')
  UserInterest copyWith(void Function(UserInterest) updates) => super.copyWith((message) => updates(message as UserInterest)) as UserInterest; // ignore: deprecated_member_use
  ...
  @$pb.TagNumber(2)
  $1.UserInterestTaxonomyTypeEnum_UserInterestTaxonomyType get taxonomyType => $_getN(1);
  @$pb.TagNumber(2)
  set taxonomyType($1.UserInterestTaxonomyTypeEnum_UserInterestTaxonomyType v) { setField(2, v); }
  @$pb.TagNumber(2)
  ...
  @$pb.TagNumber(7)
  $core.List<$0.CriterionCategoryAvailability> get availabilities => $_getList(2);

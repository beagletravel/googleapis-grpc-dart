...
class AccountBudget_PendingAccountBudgetProposal extends $pb.GeneratedMessage {
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'AccountBudget.PendingAccountBudgetProposal', package: const $pb.PackageName(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'google.ads.googleads.v10.resources'), createEmptyInstance: create)
    ..oo(0, [6, 15])
    ..oo(1, [8, 16])
    ..e<$3.AccountBudgetProposalTypeEnum_AccountBudgetProposalType>(2, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'proposalType', $pb.PbFieldType.OE, defaultOrMaker: $3.AccountBudgetProposalTypeEnum_AccountBudgetProposalType.UNSPECIFIED, valueOf: $3.AccountBudgetProposalTypeEnum_AccountBudgetProposalType.valueOf, enumValues: $3.AccountBudgetProposalTypeEnum_AccountBudgetProposalType.values)
    ..e<$1.TimeTypeEnum_TimeType>(6, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'endTimeType', $pb.PbFieldType.OE, defaultOrMaker: $1.TimeTypeEnum_TimeType.UNSPECIFIED, valueOf: $1.TimeTypeEnum_TimeType.valueOf, enumValues: $1.TimeTypeEnum_TimeType.values)
    ..e<$2.SpendingLimitTypeEnum_SpendingLimitType>(8, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'spendingLimitType', $pb.PbFieldType.OE, defaultOrMaker: $2.SpendingLimitTypeEnum_SpendingLimitType.UNSPECIFIED, valueOf: $2.SpendingLimitTypeEnum_SpendingLimitType.valueOf, enumValues: $2.SpendingLimitTypeEnum_SpendingLimitType.values)
    ..aOS(12, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'accountBudgetProposal')
    ..aOS(13, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'name')
    ..aOS(14, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'startDateTime')
    ..aOS(15, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'endDateTime')
    ..aInt64(16, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'spendingLimitMicros')
    ..aOS(17, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'purchaseOrderNumber')
    ..aOS(18, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'notes')
    ..aOS(19, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'creationDateTime')
  ...
  'Will be removed in next major version')
  AccountBudget_PendingAccountBudgetProposal copyWith(void Function(AccountBudget_PendingAccountBudgetProposal) updates) => super.copyWith((message) => updates(message as AccountBudget_PendingAccountBudgetProposal)) as AccountBudget_PendingAccountBudgetProposal; // ignore: deprecated_member_use
  ...
  @$pb.TagNumber(2)
  $3.AccountBudgetProposalTypeEnum_AccountBudgetProposalType get proposalType => $_getN(0);
  @$pb.TagNumber(2)
  set proposalType($3.AccountBudgetProposalTypeEnum_AccountBudgetProposalType v) { setField(2, v); }
  @$pb.TagNumber(2)
  ...
  @$pb.TagNumber(6)
  set endTimeType($1.TimeTypeEnum_TimeType v) { setField(6, v); }
  @$pb.TagNumber(6)
  ...
  @$pb.TagNumber(8)
  set spendingLimitType($2.SpendingLimitTypeEnum_SpendingLimitType v) { setField(8, v); }
  @$pb.TagNumber(8)
...
class AccountBudget extends $pb.GeneratedMessage {
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'AccountBudget', package: const $pb.PackageName(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'google.ads.googleads.v10.resources'), createEmptyInstance: create)
    ..oo(0, [9, 28])
    ..oo(1, [11, 29])
    ..oo(2, [13, 30])
    ..oo(3, [15, 31])
    ...
    ..e<$0.AccountBudgetStatusEnum_AccountBudgetStatus>(4, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'status', $pb.PbFieldType.OE, defaultOrMaker: $0.AccountBudgetStatusEnum_AccountBudgetStatus.UNSPECIFIED, valueOf: $0.AccountBudgetStatusEnum_AccountBudgetStatus.valueOf, enumValues: $0.AccountBudgetStatusEnum_AccountBudgetStatus.values)
    ..e<$1.TimeTypeEnum_TimeType>(9, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'proposedEndTimeType', $pb.PbFieldType.OE, defaultOrMaker: $1.TimeTypeEnum_TimeType.UNSPECIFIED, valueOf: $1.TimeTypeEnum_TimeType.valueOf, enumValues: $1.TimeTypeEnum_TimeType.values)
    ..e<$1.TimeTypeEnum_TimeType>(11, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'approvedEndTimeType', $pb.PbFieldType.OE, defaultOrMaker: $1.TimeTypeEnum_TimeType.UNSPECIFIED, valueOf: $1.TimeTypeEnum_TimeType.valueOf, enumValues: $1.TimeTypeEnum_TimeType.values)
    ..e<$2.SpendingLimitTypeEnum_SpendingLimitType>(13, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'proposedSpendingLimitType', $pb.PbFieldType.OE, defaultOrMaker: $2.SpendingLimitTypeEnum_SpendingLimitType.UNSPECIFIED, valueOf: $2.SpendingLimitTypeEnum_SpendingLimitType.valueOf, enumValues: $2.SpendingLimitTypeEnum_SpendingLimitType.values)
    ..e<$2.SpendingLimitTypeEnum_SpendingLimitType>(15, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'approvedSpendingLimitType', $pb.PbFieldType.OE, defaultOrMaker: $2.SpendingLimitTypeEnum_SpendingLimitType.UNSPECIFIED, valueOf: $2.SpendingLimitTypeEnum_SpendingLimitType.valueOf, enumValues: $2.SpendingLimitTypeEnum_SpendingLimitType.values)
    ..e<$2.SpendingLimitTypeEnum_SpendingLimitType>(17, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'adjustedSpendingLimitType', $pb.PbFieldType.OE, defaultOrMaker: $2.SpendingLimitTypeEnum_SpendingLimitType.UNSPECIFIED, valueOf: $2.SpendingLimitTypeEnum_SpendingLimitType.valueOf, enumValues: $2.SpendingLimitTypeEnum_SpendingLimitType.values)
    ..aOM<AccountBudget_PendingAccountBudgetProposal>(22, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'pendingProposal', subBuilder: AccountBudget_PendingAccountBudgetProposal.create)
    ..aInt64(23, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'id')
    ..aOS(24, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'billingSetup')
    ..aOS(25, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'name')
    ..aOS(26, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'proposedStartDateTime')
    ..aOS(27, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'approvedStartDateTime')
    ..aOS(28, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'proposedEndDateTime')
    ..aOS(29, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'approvedEndDateTime')
    ..aInt64(30, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'proposedSpendingLimitMicros')
    ..aInt64(31, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'approvedSpendingLimitMicros')
    ..aInt64(32, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'adjustedSpendingLimitMicros')
    ..aInt64(33, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'totalAdjustmentsMicros')
    ..aInt64(34, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'amountServedMicros')
    ..aOS(35, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'purchaseOrderNumber')
    ..aOS(36, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'notes')
    ..hasRequiredFields = false
  ;
  ...
  'Use [GeneratedMessageGenericExtensions.rebuild] instead. '
  'Will be removed in next major version')
  AccountBudget copyWith(void Function(AccountBudget) updates) => super.copyWith((message) => updates(message as AccountBudget)) as AccountBudget; // ignore: deprecated_member_use
  $pb.BuilderInfo get info_ => _i;
  @$core.pragma('dart2js:noInline')
  ...
  @$pb.TagNumber(4)
  set status($0.AccountBudgetStatusEnum_AccountBudgetStatus v) { setField(4, v); }
  @$pb.TagNumber(4)
  ...
  @$pb.TagNumber(9)
  set proposedEndTimeType($1.TimeTypeEnum_TimeType v) { setField(9, v); }
  @$pb.TagNumber(9)
  ...
  @$pb.TagNumber(11)
  set approvedEndTimeType($1.TimeTypeEnum_TimeType v) { setField(11, v); }
  @$pb.TagNumber(11)
  ...
  @$pb.TagNumber(13)
  $2.SpendingLimitTypeEnum_SpendingLimitType get proposedSpendingLimitType => $_getN(4);
  @$pb.TagNumber(13)
  set proposedSpendingLimitType($2.SpendingLimitTypeEnum_SpendingLimitType v) { setField(13, v); }
  @$pb.TagNumber(13)
  ...
  @$pb.TagNumber(15)
  $2.SpendingLimitTypeEnum_SpendingLimitType get approvedSpendingLimitType => $_getN(5);
  @$pb.TagNumber(15)
  set approvedSpendingLimitType($2.SpendingLimitTypeEnum_SpendingLimitType v) { setField(15, v); }
  @$pb.TagNumber(15)
  ...
  @$pb.TagNumber(17)
  $2.SpendingLimitTypeEnum_SpendingLimitType get adjustedSpendingLimitType => $_getN(6);
  @$pb.TagNumber(17)
  set adjustedSpendingLimitType($2.SpendingLimitTypeEnum_SpendingLimitType v) { setField(17, v); }
  @$pb.TagNumber(17)

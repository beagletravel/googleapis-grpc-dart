...
class AssetGroup extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'AssetGroup', package: const $pb.PackageName(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'google.ads.googleads.v10.resources'), createEmptyInstance: create)
    ...
    ..pPS(4, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'finalUrls')
    ..pPS(5, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'finalMobileUrls')
    ..e<$0.AssetGroupStatusEnum_AssetGroupStatus>(6, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'status', $pb.PbFieldType.OE, defaultOrMaker: $0.AssetGroupStatusEnum_AssetGroupStatus.UNSPECIFIED, valueOf: $0.AssetGroupStatusEnum_AssetGroupStatus.valueOf, enumValues: $0.AssetGroupStatusEnum_AssetGroupStatus.values)
    ..aOS(7, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'path1')
    ..aOS(8, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'path2')
  ...
  'Will be removed in next major version')
  AssetGroup copyWith(void Function(AssetGroup) updates) => super.copyWith((message) => updates(message as AssetGroup)) as AssetGroup; // ignore: deprecated_member_use
  ...
  @$pb.TagNumber(6)
  set status($0.AssetGroupStatusEnum_AssetGroupStatus v) { setField(6, v); }
  @$pb.TagNumber(6)

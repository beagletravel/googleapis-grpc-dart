...
class CampaignBudget extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'CampaignBudget', package: const $pb.PackageName(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'google.ads.googleads.v10.resources'), createEmptyInstance: create)
    ..aOS(1, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'resourceName')
    ..e<$0.BudgetStatusEnum_BudgetStatus>(6, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'status', $pb.PbFieldType.OE, defaultOrMaker: $0.BudgetStatusEnum_BudgetStatus.UNSPECIFIED, valueOf: $0.BudgetStatusEnum_BudgetStatus.valueOf, enumValues: $0.BudgetStatusEnum_BudgetStatus.values)
    ..e<$1.BudgetDeliveryMethodEnum_BudgetDeliveryMethod>(7, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'deliveryMethod', $pb.PbFieldType.OE, defaultOrMaker: $1.BudgetDeliveryMethodEnum_BudgetDeliveryMethod.UNSPECIFIED, valueOf: $1.BudgetDeliveryMethodEnum_BudgetDeliveryMethod.valueOf, enumValues: $1.BudgetDeliveryMethodEnum_BudgetDeliveryMethod.values)
    ..e<$2.BudgetPeriodEnum_BudgetPeriod>(13, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'period', $pb.PbFieldType.OE, defaultOrMaker: $2.BudgetPeriodEnum_BudgetPeriod.UNSPECIFIED, valueOf: $2.BudgetPeriodEnum_BudgetPeriod.valueOf, enumValues: $2.BudgetPeriodEnum_BudgetPeriod.values)
    ..e<$3.BudgetTypeEnum_BudgetType>(18, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'type', $pb.PbFieldType.OE, defaultOrMaker: $3.BudgetTypeEnum_BudgetType.UNSPECIFIED, valueOf: $3.BudgetTypeEnum_BudgetType.valueOf, enumValues: $3.BudgetTypeEnum_BudgetType.values)
    ...
    ..aInt64(21, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'amountMicros')
    ..aInt64(22, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'totalAmountMicros')
    ..aOB(23, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'explicitlyShared')
    ..aInt64(24, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'referenceCount')
    ..aOB(25, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'hasRecommendedBudget')
    ..aInt64(26, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'recommendedBudgetAmountMicros')
    ..aInt64(27, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'recommendedBudgetEstimatedChangeWeeklyClicks')
    ..aInt64(28, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'recommendedBudgetEstimatedChangeWeeklyCostMicros')
    ..aInt64(29, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'recommendedBudgetEstimatedChangeWeeklyInteractions')
    ..aInt64(30, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'recommendedBudgetEstimatedChangeWeeklyViews')
  ...
  factory CampaignBudget({
    ...
    if (recommendedBudgetEstimatedChangeWeeklyClicks != null) {
      _result.recommendedBudgetEstimatedChangeWeeklyClicks = recommendedBudgetEstimatedChangeWeeklyClicks;
    }
    if (recommendedBudgetEstimatedChangeWeeklyCostMicros != null) {
      _result.recommendedBudgetEstimatedChangeWeeklyCostMicros = recommendedBudgetEstimatedChangeWeeklyCostMicros;
    }
    if (recommendedBudgetEstimatedChangeWeeklyInteractions != null) {
      _result.recommendedBudgetEstimatedChangeWeeklyInteractions = recommendedBudgetEstimatedChangeWeeklyInteractions;
    }
    if (recommendedBudgetEstimatedChangeWeeklyViews != null) {
      _result.recommendedBudgetEstimatedChangeWeeklyViews = recommendedBudgetEstimatedChangeWeeklyViews;
    }
    return _result;
  }
  ...
  'Will be removed in next major version')
  CampaignBudget copyWith(void Function(CampaignBudget) updates) => super.copyWith((message) => updates(message as CampaignBudget)) as CampaignBudget; // ignore: deprecated_member_use
  ...
  @$pb.TagNumber(6)
  set status($0.BudgetStatusEnum_BudgetStatus v) { setField(6, v); }
  @$pb.TagNumber(6)
  ...
  @$pb.TagNumber(7)
  $1.BudgetDeliveryMethodEnum_BudgetDeliveryMethod get deliveryMethod => $_getN(2);
  @$pb.TagNumber(7)
  set deliveryMethod($1.BudgetDeliveryMethodEnum_BudgetDeliveryMethod v) { setField(7, v); }
  @$pb.TagNumber(7)
  ...
  @$pb.TagNumber(13)
  set period($2.BudgetPeriodEnum_BudgetPeriod v) { setField(13, v); }
  @$pb.TagNumber(13)
  ...
  @$pb.TagNumber(18)
  set type($3.BudgetTypeEnum_BudgetType v) { setField(18, v); }
  @$pb.TagNumber(18)

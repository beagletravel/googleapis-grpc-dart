...
class AdGroupFeed extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'AdGroupFeed', package: const $pb.PackageName(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'google.ads.googleads.v10.resources'), createEmptyInstance: create)
    ...
    ..aOS(8, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'adGroup')
  ...
  'Will be removed in next major version')
  AdGroupFeed copyWith(void Function(AdGroupFeed) updates) => super.copyWith((message) => updates(message as AdGroupFeed)) as AdGroupFeed; // ignore: deprecated_member_use

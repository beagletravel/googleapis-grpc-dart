...
class KeywordPlan extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'KeywordPlan', package: const $pb.PackageName(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'google.ads.googleads.v10.resources'), createEmptyInstance: create)
    ..aOS(1, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'resourceName')
    ..aOM<KeywordPlanForecastPeriod>(4, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'forecastPeriod', subBuilder: KeywordPlanForecastPeriod.create)
  ...
  'Will be removed in next major version')
  KeywordPlan copyWith(void Function(KeywordPlan) updates) => super.copyWith((message) => updates(message as KeywordPlan)) as KeywordPlan; // ignore: deprecated_member_use
...
class KeywordPlanForecastPeriod extends $pb.GeneratedMessage {
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'KeywordPlanForecastPeriod', package: const $pb.PackageName(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'google.ads.googleads.v10.resources'), createEmptyInstance: create)
    ..oo(0, [1, 2])
    ..e<$1.KeywordPlanForecastIntervalEnum_KeywordPlanForecastInterval>(1, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'dateInterval', $pb.PbFieldType.OE, defaultOrMaker: $1.KeywordPlanForecastIntervalEnum_KeywordPlanForecastInterval.UNSPECIFIED, valueOf: $1.KeywordPlanForecastIntervalEnum_KeywordPlanForecastInterval.valueOf, enumValues: $1.KeywordPlanForecastIntervalEnum_KeywordPlanForecastInterval.values)
    ..aOM<$0.DateRange>(2, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'dateRange', subBuilder: $0.DateRange.create)
    ..hasRequiredFields = false
  ;

  KeywordPlanForecastPeriod._() : super();
  factory KeywordPlanForecastPeriod({
    $1.KeywordPlanForecastIntervalEnum_KeywordPlanForecastInterval? dateInterval,
  ...
  'Use [GeneratedMessageGenericExtensions.rebuild] instead. '
  'Will be removed in next major version')
  KeywordPlanForecastPeriod copyWith(void Function(KeywordPlanForecastPeriod) updates) => super.copyWith((message) => updates(message as KeywordPlanForecastPeriod)) as KeywordPlanForecastPeriod; // ignore: deprecated_member_use
  $pb.BuilderInfo get info_ => _i;
  @$core.pragma('dart2js:noInline')
  ...
  @$pb.TagNumber(1)
  $1.KeywordPlanForecastIntervalEnum_KeywordPlanForecastInterval get dateInterval => $_getN(0);
  @$pb.TagNumber(1)
  set dateInterval($1.KeywordPlanForecastIntervalEnum_KeywordPlanForecastInterval v) { setField(1, v); }
  @$pb.TagNumber(1)
  ...
  @$pb.TagNumber(2)
  set dateRange($0.DateRange v) { setField(2, v); }
  @$pb.TagNumber(2)

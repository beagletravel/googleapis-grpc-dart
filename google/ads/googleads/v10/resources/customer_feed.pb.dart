...
class CustomerFeed extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'CustomerFeed', package: const $pb.PackageName(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'google.ads.googleads.v10.resources'), createEmptyInstance: create)
    ..aOS(1, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'resourceName')
    ..pc<$1.PlaceholderTypeEnum_PlaceholderType>(3, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'placeholderTypes', $pb.PbFieldType.PE, valueOf: $1.PlaceholderTypeEnum_PlaceholderType.valueOf, enumValues: $1.PlaceholderTypeEnum_PlaceholderType.values)
    ..aOM<$0.MatchingFunction>(4, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'matchingFunction', subBuilder: $0.MatchingFunction.create)
    ..e<$2.FeedLinkStatusEnum_FeedLinkStatus>(5, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'status', $pb.PbFieldType.OE, defaultOrMaker: $2.FeedLinkStatusEnum_FeedLinkStatus.UNSPECIFIED, valueOf: $2.FeedLinkStatusEnum_FeedLinkStatus.valueOf, enumValues: $2.FeedLinkStatusEnum_FeedLinkStatus.values)
    ..aOS(6, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'feed')
  ...
  'Will be removed in next major version')
  CustomerFeed copyWith(void Function(CustomerFeed) updates) => super.copyWith((message) => updates(message as CustomerFeed)) as CustomerFeed; // ignore: deprecated_member_use
  ...
  @$pb.TagNumber(4)
  set matchingFunction($0.MatchingFunction v) { setField(4, v); }
  @$pb.TagNumber(4)
  ...
  @$pb.TagNumber(5)
  set status($2.FeedLinkStatusEnum_FeedLinkStatus v) { setField(5, v); }
  @$pb.TagNumber(5)

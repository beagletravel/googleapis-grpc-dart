...
class SmartCampaignSetting_PhoneNumber extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'SmartCampaignSetting.PhoneNumber', package: const $pb.PackageName(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'google.ads.googleads.v10.resources'), createEmptyInstance: create)
  ...
  'Will be removed in next major version')
  SmartCampaignSetting_PhoneNumber copyWith(void Function(SmartCampaignSetting_PhoneNumber) updates) => super.copyWith((message) => updates(message as SmartCampaignSetting_PhoneNumber)) as SmartCampaignSetting_PhoneNumber; // ignore: deprecated_member_use
...
class SmartCampaignSetting extends $pb.GeneratedMessage {
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'SmartCampaignSetting', package: const $pb.PackageName(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'google.ads.googleads.v10.resources'), createEmptyInstance: create)
    ..oo(0, [5, 6])
    ...
    ..aOM<SmartCampaignSetting_PhoneNumber>(3, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'phoneNumber', subBuilder: SmartCampaignSetting_PhoneNumber.create)
    ..aOS(4, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'finalUrl')
    ..aOS(5, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'businessName')
    ..aInt64(6, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'businessLocationId')
    ..aOS(7, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'advertisingLanguageCode')
    ..hasRequiredFields = false
  ;
  ...
  'Use [GeneratedMessageGenericExtensions.rebuild] instead. '
  'Will be removed in next major version')
  SmartCampaignSetting copyWith(void Function(SmartCampaignSetting) updates) => super.copyWith((message) => updates(message as SmartCampaignSetting)) as SmartCampaignSetting; // ignore: deprecated_member_use
  $pb.BuilderInfo get info_ => _i;
  @$core.pragma('dart2js:noInline')
  ...
  SmartCampaignSetting_BusinessSetting whichBusinessSetting() => _SmartCampaignSetting_BusinessSettingByTag[$_whichOneof(0)]!;
  ...
  @$pb.TagNumber(4)
  set finalUrl($core.String v) { $_setString(3, v); }
  @$pb.TagNumber(4)
  ...
  @$pb.TagNumber(6)
  set businessLocationId($fixnum.Int64 v) { $_setInt64(5, v); }
  @$pb.TagNumber(6)
  ...
  @$pb.TagNumber(7)
  set advertisingLanguageCode($core.String v) { $_setString(6, v); }
  @$pb.TagNumber(7)

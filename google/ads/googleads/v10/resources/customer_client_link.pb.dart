...
class CustomerClientLink extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'CustomerClientLink', package: const $pb.PackageName(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'google.ads.googleads.v10.resources'), createEmptyInstance: create)
    ..aOS(1, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'resourceName')
    ..e<$0.ManagerLinkStatusEnum_ManagerLinkStatus>(5, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'status', $pb.PbFieldType.OE, defaultOrMaker: $0.ManagerLinkStatusEnum_ManagerLinkStatus.UNSPECIFIED, valueOf: $0.ManagerLinkStatusEnum_ManagerLinkStatus.valueOf, enumValues: $0.ManagerLinkStatusEnum_ManagerLinkStatus.values)
    ..aOS(7, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'clientCustomer')
    ..aInt64(8, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'managerLinkId')
    ..aOB(9, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'hidden')
  ...
  'Will be removed in next major version')
  CustomerClientLink copyWith(void Function(CustomerClientLink) updates) => super.copyWith((message) => updates(message as CustomerClientLink)) as CustomerClientLink; // ignore: deprecated_member_use
  ...
  @$pb.TagNumber(5)
  set status($0.ManagerLinkStatusEnum_ManagerLinkStatus v) { setField(5, v); }
  @$pb.TagNumber(5)

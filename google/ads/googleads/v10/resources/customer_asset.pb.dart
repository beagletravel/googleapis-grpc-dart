...
class CustomerAsset extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'CustomerAsset', package: const $pb.PackageName(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'google.ads.googleads.v10.resources'), createEmptyInstance: create)
    ...
    ..e<$0.AssetFieldTypeEnum_AssetFieldType>(3, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'fieldType', $pb.PbFieldType.OE, defaultOrMaker: $0.AssetFieldTypeEnum_AssetFieldType.UNSPECIFIED, valueOf: $0.AssetFieldTypeEnum_AssetFieldType.valueOf, enumValues: $0.AssetFieldTypeEnum_AssetFieldType.values)
    ..e<$1.AssetLinkStatusEnum_AssetLinkStatus>(4, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'status', $pb.PbFieldType.OE, defaultOrMaker: $1.AssetLinkStatusEnum_AssetLinkStatus.UNSPECIFIED, valueOf: $1.AssetLinkStatusEnum_AssetLinkStatus.valueOf, enumValues: $1.AssetLinkStatusEnum_AssetLinkStatus.values)
  ...
  'Will be removed in next major version')
  CustomerAsset copyWith(void Function(CustomerAsset) updates) => super.copyWith((message) => updates(message as CustomerAsset)) as CustomerAsset; // ignore: deprecated_member_use
  ...
  @$pb.TagNumber(3)
  set fieldType($0.AssetFieldTypeEnum_AssetFieldType v) { setField(3, v); }
  @$pb.TagNumber(3)
  ...
  @$pb.TagNumber(4)
  set status($1.AssetLinkStatusEnum_AssetLinkStatus v) { setField(4, v); }
  @$pb.TagNumber(4)

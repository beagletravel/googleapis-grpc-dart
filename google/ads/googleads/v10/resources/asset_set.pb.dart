...
class AssetSet_MerchantCenterFeed extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'AssetSet.MerchantCenterFeed', package: const $pb.PackageName(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'google.ads.googleads.v10.resources'), createEmptyInstance: create)
    ..aInt64(1, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'merchantId')
    ..aOS(2, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'feedLabel')
  ...
  'Will be removed in next major version')
  AssetSet_MerchantCenterFeed copyWith(void Function(AssetSet_MerchantCenterFeed) updates) => super.copyWith((message) => updates(message as AssetSet_MerchantCenterFeed)) as AssetSet_MerchantCenterFeed; // ignore: deprecated_member_use
...
class AssetSet extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'AssetSet', package: const $pb.PackageName(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'google.ads.googleads.v10.resources'), createEmptyInstance: create)
    ..aOS(1, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'resourceName')
    ..aOS(2, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'name')
    ..e<$0.AssetSetTypeEnum_AssetSetType>(3, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'type', $pb.PbFieldType.OE, defaultOrMaker: $0.AssetSetTypeEnum_AssetSetType.UNSPECIFIED, valueOf: $0.AssetSetTypeEnum_AssetSetType.valueOf, enumValues: $0.AssetSetTypeEnum_AssetSetType.values)
    ..e<$1.AssetSetStatusEnum_AssetSetStatus>(4, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'status', $pb.PbFieldType.OE, defaultOrMaker: $1.AssetSetStatusEnum_AssetSetStatus.UNSPECIFIED, valueOf: $1.AssetSetStatusEnum_AssetSetStatus.valueOf, enumValues: $1.AssetSetStatusEnum_AssetSetStatus.values)
    ..aOM<AssetSet_MerchantCenterFeed>(5, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'merchantCenterFeed', subBuilder: AssetSet_MerchantCenterFeed.create)
  ...
  'Use [GeneratedMessageGenericExtensions.rebuild] instead. '
  'Will be removed in next major version')
  AssetSet copyWith(void Function(AssetSet) updates) => super.copyWith((message) => updates(message as AssetSet)) as AssetSet; // ignore: deprecated_member_use
  $pb.BuilderInfo get info_ => _i;
  @$core.pragma('dart2js:noInline')
  ...
  @$pb.TagNumber(3)
  set type($0.AssetSetTypeEnum_AssetSetType v) { setField(3, v); }
  @$pb.TagNumber(3)
  ...
  @$pb.TagNumber(4)
  set status($1.AssetSetStatusEnum_AssetSetStatus v) { setField(4, v); }
  @$pb.TagNumber(4)

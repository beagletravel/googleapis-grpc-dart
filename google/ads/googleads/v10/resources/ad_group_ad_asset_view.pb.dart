...
class AdGroupAdAssetView extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'AdGroupAdAssetView', package: const $pb.PackageName(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'google.ads.googleads.v10.resources'), createEmptyInstance: create)
    ..aOS(1, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'resourceName')
    ..e<$1.AssetFieldTypeEnum_AssetFieldType>(2, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'fieldType', $pb.PbFieldType.OE, defaultOrMaker: $1.AssetFieldTypeEnum_AssetFieldType.UNSPECIFIED, valueOf: $1.AssetFieldTypeEnum_AssetFieldType.valueOf, enumValues: $1.AssetFieldTypeEnum_AssetFieldType.values)
    ..aOM<AdGroupAdAssetPolicySummary>(3, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'policySummary', subBuilder: AdGroupAdAssetPolicySummary.create)
    ..e<$2.AssetPerformanceLabelEnum_AssetPerformanceLabel>(4, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'performanceLabel', $pb.PbFieldType.OE, defaultOrMaker: $2.AssetPerformanceLabelEnum_AssetPerformanceLabel.UNSPECIFIED, valueOf: $2.AssetPerformanceLabelEnum_AssetPerformanceLabel.valueOf, enumValues: $2.AssetPerformanceLabelEnum_AssetPerformanceLabel.values)
    ..aOB(8, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'enabled')
    ..aOS(9, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'adGroupAd')
  ...
  'Will be removed in next major version')
  AdGroupAdAssetView copyWith(void Function(AdGroupAdAssetView) updates) => super.copyWith((message) => updates(message as AdGroupAdAssetView)) as AdGroupAdAssetView; // ignore: deprecated_member_use
  ...
  @$pb.TagNumber(2)
  set fieldType($1.AssetFieldTypeEnum_AssetFieldType v) { setField(2, v); }
  @$pb.TagNumber(2)
  ...
  @$pb.TagNumber(4)
  $2.AssetPerformanceLabelEnum_AssetPerformanceLabel get performanceLabel => $_getN(3);
  @$pb.TagNumber(4)
  set performanceLabel($2.AssetPerformanceLabelEnum_AssetPerformanceLabel v) { setField(4, v); }
  @$pb.TagNumber(4)
...
class AdGroupAdAssetPolicySummary extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'AdGroupAdAssetPolicySummary', package: const $pb.PackageName(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'google.ads.googleads.v10.resources'), createEmptyInstance: create)
    ..pc<$0.PolicyTopicEntry>(1, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'policyTopicEntries', $pb.PbFieldType.PM, subBuilder: $0.PolicyTopicEntry.create)
    ..e<$3.PolicyReviewStatusEnum_PolicyReviewStatus>(2, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'reviewStatus', $pb.PbFieldType.OE, defaultOrMaker: $3.PolicyReviewStatusEnum_PolicyReviewStatus.UNSPECIFIED, valueOf: $3.PolicyReviewStatusEnum_PolicyReviewStatus.valueOf, enumValues: $3.PolicyReviewStatusEnum_PolicyReviewStatus.values)
    ..e<$4.PolicyApprovalStatusEnum_PolicyApprovalStatus>(3, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'approvalStatus', $pb.PbFieldType.OE, defaultOrMaker: $4.PolicyApprovalStatusEnum_PolicyApprovalStatus.UNSPECIFIED, valueOf: $4.PolicyApprovalStatusEnum_PolicyApprovalStatus.valueOf, enumValues: $4.PolicyApprovalStatusEnum_PolicyApprovalStatus.values)
    ..hasRequiredFields = false
  ;
  ...
  'Use [GeneratedMessageGenericExtensions.rebuild] instead. '
  'Will be removed in next major version')
  AdGroupAdAssetPolicySummary copyWith(void Function(AdGroupAdAssetPolicySummary) updates) => super.copyWith((message) => updates(message as AdGroupAdAssetPolicySummary)) as AdGroupAdAssetPolicySummary; // ignore: deprecated_member_use
  $pb.BuilderInfo get info_ => _i;
  @$core.pragma('dart2js:noInline')
  ...
  @$pb.TagNumber(2)
  set reviewStatus($3.PolicyReviewStatusEnum_PolicyReviewStatus v) { setField(2, v); }
  @$pb.TagNumber(2)
  ...
  @$pb.TagNumber(3)
  $4.PolicyApprovalStatusEnum_PolicyApprovalStatus get approvalStatus => $_getN(2);
  @$pb.TagNumber(3)
  set approvalStatus($4.PolicyApprovalStatusEnum_PolicyApprovalStatus v) { setField(3, v); }
  @$pb.TagNumber(3)

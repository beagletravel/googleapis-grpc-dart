...
class GoogleAdsField extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'GoogleAdsField', package: const $pb.PackageName(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'google.ads.googleads.v10.resources'), createEmptyInstance: create)
    ..aOS(1, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'resourceName')
    ..e<$0.GoogleAdsFieldCategoryEnum_GoogleAdsFieldCategory>(3, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'category', $pb.PbFieldType.OE, defaultOrMaker: $0.GoogleAdsFieldCategoryEnum_GoogleAdsFieldCategory.UNSPECIFIED, valueOf: $0.GoogleAdsFieldCategoryEnum_GoogleAdsFieldCategory.valueOf, enumValues: $0.GoogleAdsFieldCategoryEnum_GoogleAdsFieldCategory.values)
    ..e<$1.GoogleAdsFieldDataTypeEnum_GoogleAdsFieldDataType>(12, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'dataType', $pb.PbFieldType.OE, defaultOrMaker: $1.GoogleAdsFieldDataTypeEnum_GoogleAdsFieldDataType.UNSPECIFIED, valueOf: $1.GoogleAdsFieldDataTypeEnum_GoogleAdsFieldDataType.valueOf, enumValues: $1.GoogleAdsFieldDataTypeEnum_GoogleAdsFieldDataType.values)
    ..aOS(21, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'name')
    ..aOB(22, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'selectable')
    ..aOB(23, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'filterable')
    ..aOB(24, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'sortable')
    ..pPS(25, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'selectableWith')
    ..pPS(26, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'attributeResources')
    ..pPS(27, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'metrics')
    ..pPS(28, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'segments')
    ..pPS(29, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'enumValues')
    ..aOS(30, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'typeUrl')
    ..aOB(31, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'isRepeated')
  ...
  'Will be removed in next major version')
  GoogleAdsField copyWith(void Function(GoogleAdsField) updates) => super.copyWith((message) => updates(message as GoogleAdsField)) as GoogleAdsField; // ignore: deprecated_member_use
  ...
  @$pb.TagNumber(3)
  $0.GoogleAdsFieldCategoryEnum_GoogleAdsFieldCategory get category => $_getN(1);
  @$pb.TagNumber(3)
  set category($0.GoogleAdsFieldCategoryEnum_GoogleAdsFieldCategory v) { setField(3, v); }
  @$pb.TagNumber(3)
  ...
  @$pb.TagNumber(12)
  $1.GoogleAdsFieldDataTypeEnum_GoogleAdsFieldDataType get dataType => $_getN(2);
  @$pb.TagNumber(12)
  set dataType($1.GoogleAdsFieldDataTypeEnum_GoogleAdsFieldDataType v) { setField(12, v); }
  @$pb.TagNumber(12)

...
class MobileAppCategoryConstant extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'MobileAppCategoryConstant', package: const $pb.PackageName(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'google.ads.googleads.v10.resources'), createEmptyInstance: create)
  ...
  'Will be removed in next major version')
  MobileAppCategoryConstant copyWith(void Function(MobileAppCategoryConstant) updates) => super.copyWith((message) => updates(message as MobileAppCategoryConstant)) as MobileAppCategoryConstant; // ignore: deprecated_member_use

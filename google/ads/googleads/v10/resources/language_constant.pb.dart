...
class LanguageConstant extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'LanguageConstant', package: const $pb.PackageName(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'google.ads.googleads.v10.resources'), createEmptyInstance: create)
    ...
    ..aOB(9, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'targetable')
  ...
  'Will be removed in next major version')
  LanguageConstant copyWith(void Function(LanguageConstant) updates) => super.copyWith((message) => updates(message as LanguageConstant)) as LanguageConstant; // ignore: deprecated_member_use

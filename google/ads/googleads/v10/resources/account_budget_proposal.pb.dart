...
class AccountBudgetProposal extends $pb.GeneratedMessage {
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'AccountBudgetProposal', package: const $pb.PackageName(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'google.ads.googleads.v10.resources'), createEmptyInstance: create)
    ..oo(0, [7, 29])
    ..oo(1, [9, 31])
    ..oo(2, [22, 32])
    ..oo(3, [11, 33])
    ...
    ..e<$0.AccountBudgetProposalTypeEnum_AccountBudgetProposalType>(4, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'proposalType', $pb.PbFieldType.OE, defaultOrMaker: $0.AccountBudgetProposalTypeEnum_AccountBudgetProposalType.UNSPECIFIED, valueOf: $0.AccountBudgetProposalTypeEnum_AccountBudgetProposalType.valueOf, enumValues: $0.AccountBudgetProposalTypeEnum_AccountBudgetProposalType.values)
    ..e<$1.TimeTypeEnum_TimeType>(7, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'proposedStartTimeType', $pb.PbFieldType.OE, defaultOrMaker: $1.TimeTypeEnum_TimeType.UNSPECIFIED, valueOf: $1.TimeTypeEnum_TimeType.valueOf, enumValues: $1.TimeTypeEnum_TimeType.values)
    ...
    ..e<$3.AccountBudgetProposalStatusEnum_AccountBudgetProposalStatus>(15, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'status', $pb.PbFieldType.OE, defaultOrMaker: $3.AccountBudgetProposalStatusEnum_AccountBudgetProposalStatus.UNSPECIFIED, valueOf: $3.AccountBudgetProposalStatusEnum_AccountBudgetProposalStatus.valueOf, enumValues: $3.AccountBudgetProposalStatusEnum_AccountBudgetProposalStatus.values)
    ..e<$1.TimeTypeEnum_TimeType>(22, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'approvedEndTimeType', $pb.PbFieldType.OE, defaultOrMaker: $1.TimeTypeEnum_TimeType.UNSPECIFIED, valueOf: $1.TimeTypeEnum_TimeType.valueOf, enumValues: $1.TimeTypeEnum_TimeType.values)
    ...
    ..aOS(26, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'billingSetup')
    ..aOS(27, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'accountBudget')
    ..aOS(28, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'proposedName')
    ..aOS(29, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'proposedStartDateTime')
    ..aOS(30, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'approvedStartDateTime')
    ..aOS(31, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'proposedEndDateTime')
    ..aOS(32, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'approvedEndDateTime')
    ..aInt64(33, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'proposedSpendingLimitMicros')
    ..aInt64(34, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'approvedSpendingLimitMicros')
    ..aOS(35, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'proposedPurchaseOrderNumber')
    ..aOS(36, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'proposedNotes')
    ..aOS(37, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'creationDateTime')
    ..aOS(38, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'approvalDateTime')
  ...
  'Will be removed in next major version')
  AccountBudgetProposal copyWith(void Function(AccountBudgetProposal) updates) => super.copyWith((message) => updates(message as AccountBudgetProposal)) as AccountBudgetProposal; // ignore: deprecated_member_use
  ...
  @$pb.TagNumber(4)
  $0.AccountBudgetProposalTypeEnum_AccountBudgetProposalType get proposalType => $_getN(1);
  @$pb.TagNumber(4)
  set proposalType($0.AccountBudgetProposalTypeEnum_AccountBudgetProposalType v) { setField(4, v); }
  @$pb.TagNumber(4)
  ...
  @$pb.TagNumber(7)
  set proposedStartTimeType($1.TimeTypeEnum_TimeType v) { setField(7, v); }
  @$pb.TagNumber(7)
  ...
  @$pb.TagNumber(11)
  set proposedSpendingLimitType($2.SpendingLimitTypeEnum_SpendingLimitType v) { setField(11, v); }
  @$pb.TagNumber(11)
  ...
  @$pb.TagNumber(15)
  $3.AccountBudgetProposalStatusEnum_AccountBudgetProposalStatus get status => $_getN(5);
  @$pb.TagNumber(15)
  set status($3.AccountBudgetProposalStatusEnum_AccountBudgetProposalStatus v) { setField(15, v); }
  @$pb.TagNumber(15)
  ...
  @$pb.TagNumber(22)
  set approvedEndTimeType($1.TimeTypeEnum_TimeType v) { setField(22, v); }
  @$pb.TagNumber(22)
  ...
  @$pb.TagNumber(24)
  $2.SpendingLimitTypeEnum_SpendingLimitType get approvedSpendingLimitType => $_getN(7);
  @$pb.TagNumber(24)
  set approvedSpendingLimitType($2.SpendingLimitTypeEnum_SpendingLimitType v) { setField(24, v); }
  @$pb.TagNumber(24)

...
class MerchantCenterLink extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'MerchantCenterLink', package: const $pb.PackageName(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'google.ads.googleads.v10.resources'), createEmptyInstance: create)
    ..aOS(1, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'resourceName')
    ..e<$0.MerchantCenterLinkStatusEnum_MerchantCenterLinkStatus>(5, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'status', $pb.PbFieldType.OE, defaultOrMaker: $0.MerchantCenterLinkStatusEnum_MerchantCenterLinkStatus.UNSPECIFIED, valueOf: $0.MerchantCenterLinkStatusEnum_MerchantCenterLinkStatus.valueOf, enumValues: $0.MerchantCenterLinkStatusEnum_MerchantCenterLinkStatus.values)
    ..aInt64(6, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'id')
    ..aOS(7, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'merchantCenterAccountName')
  ...
  @$pb.TagNumber(5)
  $0.MerchantCenterLinkStatusEnum_MerchantCenterLinkStatus get status => $_getN(1);
  @$pb.TagNumber(5)
  set status($0.MerchantCenterLinkStatusEnum_MerchantCenterLinkStatus v) { setField(5, v); }
  @$pb.TagNumber(5)
  ...
  @$pb.TagNumber(7)
  set merchantCenterAccountName($core.String v) { $_setString(3, v); }
  @$pb.TagNumber(7)

...
class ChangeStatus extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'ChangeStatus', package: const $pb.PackageName(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'google.ads.googleads.v10.resources'), createEmptyInstance: create)
    ..aOS(1, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'resourceName')
    ..e<$0.ChangeStatusResourceTypeEnum_ChangeStatusResourceType>(4, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'resourceType', $pb.PbFieldType.OE, defaultOrMaker: $0.ChangeStatusResourceTypeEnum_ChangeStatusResourceType.UNSPECIFIED, valueOf: $0.ChangeStatusResourceTypeEnum_ChangeStatusResourceType.valueOf, enumValues: $0.ChangeStatusResourceTypeEnum_ChangeStatusResourceType.values)
    ..e<$1.ChangeStatusOperationEnum_ChangeStatusOperation>(8, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'resourceStatus', $pb.PbFieldType.OE, defaultOrMaker: $1.ChangeStatusOperationEnum_ChangeStatusOperation.UNSPECIFIED, valueOf: $1.ChangeStatusOperationEnum_ChangeStatusOperation.valueOf, enumValues: $1.ChangeStatusOperationEnum_ChangeStatusOperation.values)
    ..aOS(17, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'campaign')
    ..aOS(18, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'adGroup')
    ..aOS(24, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'lastChangeDateTime')
    ..aOS(25, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'adGroupAd')
    ..aOS(26, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'adGroupCriterion')
    ..aOS(27, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'campaignCriterion')
    ..aOS(28, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'feed')
    ..aOS(29, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'feedItem')
    ..aOS(30, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'adGroupFeed')
    ..aOS(31, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'campaignFeed')
    ..aOS(32, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'adGroupBidModifier')
    ..aOS(33, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'sharedSet')
    ..aOS(34, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'campaignSharedSet')
    ..aOS(35, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'asset')
    ..aOS(36, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'customerAsset')
    ..aOS(37, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'campaignAsset')
    ..aOS(38, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'adGroupAsset')
  ...
  'Will be removed in next major version')
  ChangeStatus copyWith(void Function(ChangeStatus) updates) => super.copyWith((message) => updates(message as ChangeStatus)) as ChangeStatus; // ignore: deprecated_member_use
  ...
  @$pb.TagNumber(4)
  $0.ChangeStatusResourceTypeEnum_ChangeStatusResourceType get resourceType => $_getN(1);
  @$pb.TagNumber(4)
  set resourceType($0.ChangeStatusResourceTypeEnum_ChangeStatusResourceType v) { setField(4, v); }
  @$pb.TagNumber(4)
  ...
  @$pb.TagNumber(8)
  $1.ChangeStatusOperationEnum_ChangeStatusOperation get resourceStatus => $_getN(2);
  @$pb.TagNumber(8)
  set resourceStatus($1.ChangeStatusOperationEnum_ChangeStatusOperation v) { setField(8, v); }
  @$pb.TagNumber(8)

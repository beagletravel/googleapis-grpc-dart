...
class CampaignDraft extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'CampaignDraft', package: const $pb.PackageName(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'google.ads.googleads.v10.resources'), createEmptyInstance: create)
    ..aOS(1, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'resourceName')
    ..e<$0.CampaignDraftStatusEnum_CampaignDraftStatus>(6, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'status', $pb.PbFieldType.OE, defaultOrMaker: $0.CampaignDraftStatusEnum_CampaignDraftStatus.UNSPECIFIED, valueOf: $0.CampaignDraftStatusEnum_CampaignDraftStatus.valueOf, enumValues: $0.CampaignDraftStatusEnum_CampaignDraftStatus.values)
    ..aInt64(9, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'draftId')
    ..aOS(10, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'baseCampaign')
    ..aOS(11, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'name')
    ..aOS(12, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'draftCampaign')
    ..aOB(13, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'hasExperimentRunning')
    ..aOS(14, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'longRunningOperation')
  ...
  'Will be removed in next major version')
  CampaignDraft copyWith(void Function(CampaignDraft) updates) => super.copyWith((message) => updates(message as CampaignDraft)) as CampaignDraft; // ignore: deprecated_member_use
  ...
  @$pb.TagNumber(6)
  set status($0.CampaignDraftStatusEnum_CampaignDraftStatus v) { setField(6, v); }
  @$pb.TagNumber(6)

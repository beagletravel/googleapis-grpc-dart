...
class ExtensionFeedItem extends $pb.GeneratedMessage {
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'ExtensionFeedItem', package: const $pb.PackageName(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'google.ads.googleads.v10.resources'), createEmptyInstance: create)
    ..oo(0, [2, 3, 7, 8, 9, 10, 11, 12, 14, 15, 23, 31])
    ..oo(1, [28, 29])
    ..aOS(1, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'resourceName')
    ..aOM<$0.SitelinkFeedItem>(2, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'sitelinkFeedItem', subBuilder: $0.SitelinkFeedItem.create)
    ..aOM<$0.StructuredSnippetFeedItem>(3, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'structuredSnippetFeedItem', subBuilder: $0.StructuredSnippetFeedItem.create)
    ..e<$2.FeedItemStatusEnum_FeedItemStatus>(4, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'status', $pb.PbFieldType.OE, defaultOrMaker: $2.FeedItemStatusEnum_FeedItemStatus.UNSPECIFIED, valueOf: $2.FeedItemStatusEnum_FeedItemStatus.valueOf, enumValues: $2.FeedItemStatusEnum_FeedItemStatus.values)
    ..aOM<$0.AppFeedItem>(7, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'appFeedItem', subBuilder: $0.AppFeedItem.create)
    ..aOM<$0.CallFeedItem>(8, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'callFeedItem', subBuilder: $0.CallFeedItem.create)
    ..aOM<$0.CalloutFeedItem>(9, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'calloutFeedItem', subBuilder: $0.CalloutFeedItem.create)
    ..aOM<$0.TextMessageFeedItem>(10, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'textMessageFeedItem', subBuilder: $0.TextMessageFeedItem.create)
    ..aOM<$0.PriceFeedItem>(11, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'priceFeedItem', subBuilder: $0.PriceFeedItem.create)
    ..aOM<$0.PromotionFeedItem>(12, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'promotionFeedItem', subBuilder: $0.PromotionFeedItem.create)
    ..e<$3.ExtensionTypeEnum_ExtensionType>(13, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'extensionType', $pb.PbFieldType.OE, defaultOrMaker: $3.ExtensionTypeEnum_ExtensionType.UNSPECIFIED, valueOf: $3.ExtensionTypeEnum_ExtensionType.valueOf, enumValues: $3.ExtensionTypeEnum_ExtensionType.values)
    ..aOM<$0.LocationFeedItem>(14, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'locationFeedItem', subBuilder: $0.LocationFeedItem.create)
    ..aOM<$0.AffiliateLocationFeedItem>(15, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'affiliateLocationFeedItem', subBuilder: $0.AffiliateLocationFeedItem.create)
    ..pc<$1.AdScheduleInfo>(16, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'adSchedules', $pb.PbFieldType.PM, subBuilder: $1.AdScheduleInfo.create)
    ..e<$4.FeedItemTargetDeviceEnum_FeedItemTargetDevice>(17, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'device', $pb.PbFieldType.OE, defaultOrMaker: $4.FeedItemTargetDeviceEnum_FeedItemTargetDevice.UNSPECIFIED, valueOf: $4.FeedItemTargetDeviceEnum_FeedItemTargetDevice.valueOf, enumValues: $4.FeedItemTargetDeviceEnum_FeedItemTargetDevice.values)
    ..aOM<$1.KeywordInfo>(22, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'targetedKeyword', subBuilder: $1.KeywordInfo.create)
    ..aOM<$0.HotelCalloutFeedItem>(23, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'hotelCalloutFeedItem', subBuilder: $0.HotelCalloutFeedItem.create)
    ..aInt64(25, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'id')
    ..aOS(26, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'startDateTime')
    ..aOS(27, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'endDateTime')
    ..aOS(28, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'targetedCampaign')
    ..aOS(29, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'targetedAdGroup')
    ..aOS(30, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'targetedGeoTargetConstant')
    ..aOM<$0.ImageFeedItem>(31, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'imageFeedItem', subBuilder: $0.ImageFeedItem.create)
  ...
  'Will be removed in next major version')
  ExtensionFeedItem copyWith(void Function(ExtensionFeedItem) updates) => super.copyWith((message) => updates(message as ExtensionFeedItem)) as ExtensionFeedItem; // ignore: deprecated_member_use
  ...
  @$pb.TagNumber(2)
  set sitelinkFeedItem($0.SitelinkFeedItem v) { setField(2, v); }
  @$pb.TagNumber(2)
  ...
  @$pb.TagNumber(3)
  set structuredSnippetFeedItem($0.StructuredSnippetFeedItem v) { setField(3, v); }
  @$pb.TagNumber(3)
  ...
  @$pb.TagNumber(4)
  set status($2.FeedItemStatusEnum_FeedItemStatus v) { setField(4, v); }
  @$pb.TagNumber(4)
  ...
  @$pb.TagNumber(7)
  set appFeedItem($0.AppFeedItem v) { setField(7, v); }
  @$pb.TagNumber(7)
  ...
  @$pb.TagNumber(8)
  set callFeedItem($0.CallFeedItem v) { setField(8, v); }
  @$pb.TagNumber(8)
  ...
  @$pb.TagNumber(9)
  set calloutFeedItem($0.CalloutFeedItem v) { setField(9, v); }
  @$pb.TagNumber(9)
  ...
  @$pb.TagNumber(10)
  set textMessageFeedItem($0.TextMessageFeedItem v) { setField(10, v); }
  @$pb.TagNumber(10)
  ...
  @$pb.TagNumber(11)
  set priceFeedItem($0.PriceFeedItem v) { setField(11, v); }
  @$pb.TagNumber(11)
  ...
  @$pb.TagNumber(12)
  set promotionFeedItem($0.PromotionFeedItem v) { setField(12, v); }
  @$pb.TagNumber(12)
  ...
  @$pb.TagNumber(13)
  set extensionType($3.ExtensionTypeEnum_ExtensionType v) { setField(13, v); }
  @$pb.TagNumber(13)
  ...
  @$pb.TagNumber(14)
  set locationFeedItem($0.LocationFeedItem v) { setField(14, v); }
  @$pb.TagNumber(14)
  ...
  @$pb.TagNumber(15)
  set affiliateLocationFeedItem($0.AffiliateLocationFeedItem v) { setField(15, v); }
  @$pb.TagNumber(15)
  $core.bool hasAffiliateLocationFeedItem() => $_has(12);
  @$pb.TagNumber(15)
  void clearAffiliateLocationFeedItem() => clearField(15);
  @$pb.TagNumber(15)
  $0.AffiliateLocationFeedItem ensureAffiliateLocationFeedItem() => $_ensure(12);
  ...
  @$pb.TagNumber(17)
  set device($4.FeedItemTargetDeviceEnum_FeedItemTargetDevice v) { setField(17, v); }
  @$pb.TagNumber(17)
  ...
  @$pb.TagNumber(22)
  set targetedKeyword($1.KeywordInfo v) { setField(22, v); }
  @$pb.TagNumber(22)
  ...
  @$pb.TagNumber(23)
  set hotelCalloutFeedItem($0.HotelCalloutFeedItem v) { setField(23, v); }
  @$pb.TagNumber(23)
  ...
  @$pb.TagNumber(31)
  set imageFeedItem($0.ImageFeedItem v) { setField(31, v); }
  @$pb.TagNumber(31)

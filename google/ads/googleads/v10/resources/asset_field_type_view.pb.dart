...
class AssetFieldTypeView extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'AssetFieldTypeView', package: const $pb.PackageName(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'google.ads.googleads.v10.resources'), createEmptyInstance: create)
  ...
  'Will be removed in next major version')
  AssetFieldTypeView copyWith(void Function(AssetFieldTypeView) updates) => super.copyWith((message) => updates(message as AssetFieldTypeView)) as AssetFieldTypeView; // ignore: deprecated_member_use

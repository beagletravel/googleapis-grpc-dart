...
class CampaignBidModifier extends $pb.GeneratedMessage {
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'CampaignBidModifier', package: const $pb.PackageName(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'google.ads.googleads.v10.resources'), createEmptyInstance: create)
    ..oo(0, [5])
    ..aOS(1, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'resourceName')
    ..aOM<$0.InteractionTypeInfo>(5, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'interactionType', subBuilder: $0.InteractionTypeInfo.create)
    ..aOS(6, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'campaign')
    ..aInt64(7, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'criterionId')
    ..a<$core.double>(8, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'bidModifier', $pb.PbFieldType.OD)
  ...
  'Will be removed in next major version')
  CampaignBidModifier copyWith(void Function(CampaignBidModifier) updates) => super.copyWith((message) => updates(message as CampaignBidModifier)) as CampaignBidModifier; // ignore: deprecated_member_use
  ...
  @$pb.TagNumber(5)
  set interactionType($0.InteractionTypeInfo v) { setField(5, v); }
  @$pb.TagNumber(5)

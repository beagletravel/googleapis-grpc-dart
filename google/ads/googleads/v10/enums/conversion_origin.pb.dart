...
class ConversionOriginEnum extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'ConversionOriginEnum', package: const $pb.PackageName(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'google.ads.googleads.v10.enums'), createEmptyInstance: create)
  ...
  'Will be removed in next major version')
  ConversionOriginEnum copyWith(void Function(ConversionOriginEnum) updates) => super.copyWith((message) => updates(message as ConversionOriginEnum)) as ConversionOriginEnum; // ignore: deprecated_member_use

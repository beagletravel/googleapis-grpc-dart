...
class UserListPrepopulationStatusEnum extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'UserListPrepopulationStatusEnum', package: const $pb.PackageName(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'google.ads.googleads.v10.enums'), createEmptyInstance: create)
  ...
  'Will be removed in next major version')
  UserListPrepopulationStatusEnum copyWith(void Function(UserListPrepopulationStatusEnum) updates) => super.copyWith((message) => updates(message as UserListPrepopulationStatusEnum)) as UserListPrepopulationStatusEnum; // ignore: deprecated_member_use

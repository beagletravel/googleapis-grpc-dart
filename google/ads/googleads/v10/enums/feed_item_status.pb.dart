...
class FeedItemStatusEnum extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'FeedItemStatusEnum', package: const $pb.PackageName(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'google.ads.googleads.v10.enums'), createEmptyInstance: create)
  ...
  'Will be removed in next major version')
  FeedItemStatusEnum copyWith(void Function(FeedItemStatusEnum) updates) => super.copyWith((message) => updates(message as FeedItemStatusEnum)) as FeedItemStatusEnum; // ignore: deprecated_member_use

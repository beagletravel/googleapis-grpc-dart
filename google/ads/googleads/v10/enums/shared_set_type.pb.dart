...
class SharedSetTypeEnum extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'SharedSetTypeEnum', package: const $pb.PackageName(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'google.ads.googleads.v10.enums'), createEmptyInstance: create)
  ...
  'Will be removed in next major version')
  SharedSetTypeEnum copyWith(void Function(SharedSetTypeEnum) updates) => super.copyWith((message) => updates(message as SharedSetTypeEnum)) as SharedSetTypeEnum; // ignore: deprecated_member_use

...
class KeywordPlanForecastIntervalEnum extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'KeywordPlanForecastIntervalEnum', package: const $pb.PackageName(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'google.ads.googleads.v10.enums'), createEmptyInstance: create)
  ...
  'Will be removed in next major version')
  KeywordPlanForecastIntervalEnum copyWith(void Function(KeywordPlanForecastIntervalEnum) updates) => super.copyWith((message) => updates(message as KeywordPlanForecastIntervalEnum)) as KeywordPlanForecastIntervalEnum; // ignore: deprecated_member_use

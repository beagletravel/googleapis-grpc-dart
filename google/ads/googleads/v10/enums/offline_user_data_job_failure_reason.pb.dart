...
class OfflineUserDataJobFailureReasonEnum extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'OfflineUserDataJobFailureReasonEnum', package: const $pb.PackageName(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'google.ads.googleads.v10.enums'), createEmptyInstance: create)
  ...
  'Will be removed in next major version')
  OfflineUserDataJobFailureReasonEnum copyWith(void Function(OfflineUserDataJobFailureReasonEnum) updates) => super.copyWith((message) => updates(message as OfflineUserDataJobFailureReasonEnum)) as OfflineUserDataJobFailureReasonEnum; // ignore: deprecated_member_use

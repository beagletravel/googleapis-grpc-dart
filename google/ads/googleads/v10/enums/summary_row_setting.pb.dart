...
class SummaryRowSettingEnum extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'SummaryRowSettingEnum', package: const $pb.PackageName(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'google.ads.googleads.v10.enums'), createEmptyInstance: create)
  ...
  'Will be removed in next major version')
  SummaryRowSettingEnum copyWith(void Function(SummaryRowSettingEnum) updates) => super.copyWith((message) => updates(message as SummaryRowSettingEnum)) as SummaryRowSettingEnum; // ignore: deprecated_member_use

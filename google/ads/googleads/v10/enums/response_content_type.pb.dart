...
class ResponseContentTypeEnum extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'ResponseContentTypeEnum', package: const $pb.PackageName(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'google.ads.googleads.v10.enums'), createEmptyInstance: create)
  ...
  'Will be removed in next major version')
  ResponseContentTypeEnum copyWith(void Function(ResponseContentTypeEnum) updates) => super.copyWith((message) => updates(message as ResponseContentTypeEnum)) as ResponseContentTypeEnum; // ignore: deprecated_member_use

...
class AdStrengthEnum extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'AdStrengthEnum', package: const $pb.PackageName(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'google.ads.googleads.v10.enums'), createEmptyInstance: create)
  ...
  'Will be removed in next major version')
  AdStrengthEnum copyWith(void Function(AdStrengthEnum) updates) => super.copyWith((message) => updates(message as AdStrengthEnum)) as AdStrengthEnum; // ignore: deprecated_member_use

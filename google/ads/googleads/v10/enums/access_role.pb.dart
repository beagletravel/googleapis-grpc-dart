...
class AccessRoleEnum extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'AccessRoleEnum', package: const $pb.PackageName(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'google.ads.googleads.v10.enums'), createEmptyInstance: create)
  ...
  'Will be removed in next major version')
  AccessRoleEnum copyWith(void Function(AccessRoleEnum) updates) => super.copyWith((message) => updates(message as AccessRoleEnum)) as AccessRoleEnum; // ignore: deprecated_member_use

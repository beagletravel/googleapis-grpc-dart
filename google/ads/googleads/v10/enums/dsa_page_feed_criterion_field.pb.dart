...
class DsaPageFeedCriterionFieldEnum extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'DsaPageFeedCriterionFieldEnum', package: const $pb.PackageName(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'google.ads.googleads.v10.enums'), createEmptyInstance: create)
  ...
  'Will be removed in next major version')
  DsaPageFeedCriterionFieldEnum copyWith(void Function(DsaPageFeedCriterionFieldEnum) updates) => super.copyWith((message) => updates(message as DsaPageFeedCriterionFieldEnum)) as DsaPageFeedCriterionFieldEnum; // ignore: deprecated_member_use

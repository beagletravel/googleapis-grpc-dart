...
class ServedAssetFieldTypeEnum extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'ServedAssetFieldTypeEnum', package: const $pb.PackageName(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'google.ads.googleads.v10.enums'), createEmptyInstance: create)
  ...
  'Will be removed in next major version')
  ServedAssetFieldTypeEnum copyWith(void Function(ServedAssetFieldTypeEnum) updates) => super.copyWith((message) => updates(message as ServedAssetFieldTypeEnum)) as ServedAssetFieldTypeEnum; // ignore: deprecated_member_use

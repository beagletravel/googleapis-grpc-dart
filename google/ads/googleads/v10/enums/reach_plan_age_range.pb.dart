...
class ReachPlanAgeRangeEnum extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'ReachPlanAgeRangeEnum', package: const $pb.PackageName(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'google.ads.googleads.v10.enums'), createEmptyInstance: create)
  ...
  'Will be removed in next major version')
  ReachPlanAgeRangeEnum copyWith(void Function(ReachPlanAgeRangeEnum) updates) => super.copyWith((message) => updates(message as ReachPlanAgeRangeEnum)) as ReachPlanAgeRangeEnum; // ignore: deprecated_member_use

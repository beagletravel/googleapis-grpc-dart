...
class AssetSetStatusEnum extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'AssetSetStatusEnum', package: const $pb.PackageName(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'google.ads.googleads.v10.enums'), createEmptyInstance: create)
  ...
  'Will be removed in next major version')
  AssetSetStatusEnum copyWith(void Function(AssetSetStatusEnum) updates) => super.copyWith((message) => updates(message as AssetSetStatusEnum)) as AssetSetStatusEnum; // ignore: deprecated_member_use

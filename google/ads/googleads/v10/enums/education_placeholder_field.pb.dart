...
class EducationPlaceholderFieldEnum extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'EducationPlaceholderFieldEnum', package: const $pb.PackageName(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'google.ads.googleads.v10.enums'), createEmptyInstance: create)
  ...
  'Will be removed in next major version')
  EducationPlaceholderFieldEnum copyWith(void Function(EducationPlaceholderFieldEnum) updates) => super.copyWith((message) => updates(message as EducationPlaceholderFieldEnum)) as EducationPlaceholderFieldEnum; // ignore: deprecated_member_use

...
class AdDestinationTypeEnum extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'AdDestinationTypeEnum', package: const $pb.PackageName(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'google.ads.googleads.v10.enums'), createEmptyInstance: create)
  ...
  'Will be removed in next major version')
  AdDestinationTypeEnum copyWith(void Function(AdDestinationTypeEnum) updates) => super.copyWith((message) => updates(message as AdDestinationTypeEnum)) as AdDestinationTypeEnum; // ignore: deprecated_member_use

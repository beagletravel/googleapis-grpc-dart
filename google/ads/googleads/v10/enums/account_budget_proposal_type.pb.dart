...
class AccountBudgetProposalTypeEnum extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'AccountBudgetProposalTypeEnum', package: const $pb.PackageName(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'google.ads.googleads.v10.enums'), createEmptyInstance: create)
  ...
  'Will be removed in next major version')
  AccountBudgetProposalTypeEnum copyWith(void Function(AccountBudgetProposalTypeEnum) updates) => super.copyWith((message) => updates(message as AccountBudgetProposalTypeEnum)) as AccountBudgetProposalTypeEnum; // ignore: deprecated_member_use

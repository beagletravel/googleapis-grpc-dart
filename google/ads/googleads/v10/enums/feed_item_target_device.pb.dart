...
class FeedItemTargetDeviceEnum extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'FeedItemTargetDeviceEnum', package: const $pb.PackageName(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'google.ads.googleads.v10.enums'), createEmptyInstance: create)
  ...
  'Will be removed in next major version')
  FeedItemTargetDeviceEnum copyWith(void Function(FeedItemTargetDeviceEnum) updates) => super.copyWith((message) => updates(message as FeedItemTargetDeviceEnum)) as FeedItemTargetDeviceEnum; // ignore: deprecated_member_use

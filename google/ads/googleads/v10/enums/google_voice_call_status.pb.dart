...
class GoogleVoiceCallStatusEnum extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'GoogleVoiceCallStatusEnum', package: const $pb.PackageName(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'google.ads.googleads.v10.enums'), createEmptyInstance: create)
  ...
  'Will be removed in next major version')
  GoogleVoiceCallStatusEnum copyWith(void Function(GoogleVoiceCallStatusEnum) updates) => super.copyWith((message) => updates(message as GoogleVoiceCallStatusEnum)) as GoogleVoiceCallStatusEnum; // ignore: deprecated_member_use

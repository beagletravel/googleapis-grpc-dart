...
class ProductTypeLevelEnum extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'ProductTypeLevelEnum', package: const $pb.PackageName(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'google.ads.googleads.v10.enums'), createEmptyInstance: create)
  ...
  'Will be removed in next major version')
  ProductTypeLevelEnum copyWith(void Function(ProductTypeLevelEnum) updates) => super.copyWith((message) => updates(message as ProductTypeLevelEnum)) as ProductTypeLevelEnum; // ignore: deprecated_member_use

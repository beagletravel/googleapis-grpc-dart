...
class ConversionOrAdjustmentLagBucketEnum extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'ConversionOrAdjustmentLagBucketEnum', package: const $pb.PackageName(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'google.ads.googleads.v10.enums'), createEmptyInstance: create)
  ...
  'Will be removed in next major version')
  ConversionOrAdjustmentLagBucketEnum copyWith(void Function(ConversionOrAdjustmentLagBucketEnum) updates) => super.copyWith((message) => updates(message as ConversionOrAdjustmentLagBucketEnum)) as ConversionOrAdjustmentLagBucketEnum; // ignore: deprecated_member_use

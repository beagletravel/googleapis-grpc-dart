...
class SkAdNetworkAttributionCreditEnum extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'SkAdNetworkAttributionCreditEnum', package: const $pb.PackageName(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'google.ads.googleads.v10.enums'), createEmptyInstance: create)
  ...
  'Will be removed in next major version')
  SkAdNetworkAttributionCreditEnum copyWith(void Function(SkAdNetworkAttributionCreditEnum) updates) => super.copyWith((message) => updates(message as SkAdNetworkAttributionCreditEnum)) as SkAdNetworkAttributionCreditEnum; // ignore: deprecated_member_use

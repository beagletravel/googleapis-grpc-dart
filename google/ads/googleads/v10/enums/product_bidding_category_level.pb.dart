...
class ProductBiddingCategoryLevelEnum extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'ProductBiddingCategoryLevelEnum', package: const $pb.PackageName(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'google.ads.googleads.v10.enums'), createEmptyInstance: create)
  ...
  'Will be removed in next major version')
  ProductBiddingCategoryLevelEnum copyWith(void Function(ProductBiddingCategoryLevelEnum) updates) => super.copyWith((message) => updates(message as ProductBiddingCategoryLevelEnum)) as ProductBiddingCategoryLevelEnum; // ignore: deprecated_member_use

...
class NegativeGeoTargetTypeEnum extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'NegativeGeoTargetTypeEnum', package: const $pb.PackageName(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'google.ads.googleads.v10.enums'), createEmptyInstance: create)
  ...
  'Will be removed in next major version')
  NegativeGeoTargetTypeEnum copyWith(void Function(NegativeGeoTargetTypeEnum) updates) => super.copyWith((message) => updates(message as NegativeGeoTargetTypeEnum)) as NegativeGeoTargetTypeEnum; // ignore: deprecated_member_use

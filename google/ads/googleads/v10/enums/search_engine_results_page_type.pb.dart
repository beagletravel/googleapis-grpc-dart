...
class SearchEngineResultsPageTypeEnum extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'SearchEngineResultsPageTypeEnum', package: const $pb.PackageName(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'google.ads.googleads.v10.enums'), createEmptyInstance: create)
  ...
  'Will be removed in next major version')
  SearchEngineResultsPageTypeEnum copyWith(void Function(SearchEngineResultsPageTypeEnum) updates) => super.copyWith((message) => updates(message as SearchEngineResultsPageTypeEnum)) as SearchEngineResultsPageTypeEnum; // ignore: deprecated_member_use

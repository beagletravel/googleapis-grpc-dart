...
class KeywordPlanNetworkEnum extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'KeywordPlanNetworkEnum', package: const $pb.PackageName(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'google.ads.googleads.v10.enums'), createEmptyInstance: create)
  ...
  'Will be removed in next major version')
  KeywordPlanNetworkEnum copyWith(void Function(KeywordPlanNetworkEnum) updates) => super.copyWith((message) => updates(message as KeywordPlanNetworkEnum)) as KeywordPlanNetworkEnum; // ignore: deprecated_member_use

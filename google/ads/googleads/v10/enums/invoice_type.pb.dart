...
class InvoiceTypeEnum extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'InvoiceTypeEnum', package: const $pb.PackageName(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'google.ads.googleads.v10.enums'), createEmptyInstance: create)
  ...
  'Will be removed in next major version')
  InvoiceTypeEnum copyWith(void Function(InvoiceTypeEnum) updates) => super.copyWith((message) => updates(message as InvoiceTypeEnum)) as InvoiceTypeEnum; // ignore: deprecated_member_use

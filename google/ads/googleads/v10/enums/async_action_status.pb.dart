...
class AsyncActionStatusEnum extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'AsyncActionStatusEnum', package: const $pb.PackageName(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'google.ads.googleads.v10.enums'), createEmptyInstance: create)
  ...
  'Will be removed in next major version')
  AsyncActionStatusEnum copyWith(void Function(AsyncActionStatusEnum) updates) => super.copyWith((message) => updates(message as AsyncActionStatusEnum)) as AsyncActionStatusEnum; // ignore: deprecated_member_use

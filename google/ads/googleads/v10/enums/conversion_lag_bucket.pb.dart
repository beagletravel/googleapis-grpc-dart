...
class ConversionLagBucketEnum extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'ConversionLagBucketEnum', package: const $pb.PackageName(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'google.ads.googleads.v10.enums'), createEmptyInstance: create)
  ...
  'Will be removed in next major version')
  ConversionLagBucketEnum copyWith(void Function(ConversionLagBucketEnum) updates) => super.copyWith((message) => updates(message as ConversionLagBucketEnum)) as ConversionLagBucketEnum; // ignore: deprecated_member_use

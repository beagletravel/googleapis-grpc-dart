...
class BudgetDeliveryMethodEnum extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'BudgetDeliveryMethodEnum', package: const $pb.PackageName(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'google.ads.googleads.v10.enums'), createEmptyInstance: create)
  ...
  'Will be removed in next major version')
  BudgetDeliveryMethodEnum copyWith(void Function(BudgetDeliveryMethodEnum) updates) => super.copyWith((message) => updates(message as BudgetDeliveryMethodEnum)) as BudgetDeliveryMethodEnum; // ignore: deprecated_member_use

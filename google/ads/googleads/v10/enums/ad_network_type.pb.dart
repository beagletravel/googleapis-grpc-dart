...
class AdNetworkTypeEnum extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'AdNetworkTypeEnum', package: const $pb.PackageName(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'google.ads.googleads.v10.enums'), createEmptyInstance: create)
  ...
  'Will be removed in next major version')
  AdNetworkTypeEnum copyWith(void Function(AdNetworkTypeEnum) updates) => super.copyWith((message) => updates(message as AdNetworkTypeEnum)) as AdNetworkTypeEnum; // ignore: deprecated_member_use

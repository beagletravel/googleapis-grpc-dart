...
class CampaignGroupStatusEnum extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'CampaignGroupStatusEnum', package: const $pb.PackageName(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'google.ads.googleads.v10.enums'), createEmptyInstance: create)
  ...
  'Will be removed in next major version')
  CampaignGroupStatusEnum copyWith(void Function(CampaignGroupStatusEnum) updates) => super.copyWith((message) => updates(message as CampaignGroupStatusEnum)) as CampaignGroupStatusEnum; // ignore: deprecated_member_use

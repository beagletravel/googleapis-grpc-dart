...
class AssetFieldTypeEnum_AssetFieldType extends $pb.ProtobufEnum {
  ...
  static const AssetFieldTypeEnum_AssetFieldType MOBILE_APP = AssetFieldTypeEnum_AssetFieldType._(14, const $core.bool.fromEnvironment('protobuf.omit_enum_names') ? '' : 'MOBILE_APP');
  static const AssetFieldTypeEnum_AssetFieldType HOTEL_CALLOUT = AssetFieldTypeEnum_AssetFieldType._(15, const $core.bool.fromEnvironment('protobuf.omit_enum_names') ? '' : 'HOTEL_CALLOUT');
  static const AssetFieldTypeEnum_AssetFieldType CALL = AssetFieldTypeEnum_AssetFieldType._(16, const $core.bool.fromEnvironment('protobuf.omit_enum_names') ? '' : 'CALL');
  static const AssetFieldTypeEnum_AssetFieldType PRICE = AssetFieldTypeEnum_AssetFieldType._(24, const $core.bool.fromEnvironment('protobuf.omit_enum_names') ? '' : 'PRICE');
  static const AssetFieldTypeEnum_AssetFieldType LONG_HEADLINE = AssetFieldTypeEnum_AssetFieldType._(17, const $core.bool.fromEnvironment('protobuf.omit_enum_names') ? '' : 'LONG_HEADLINE');
  static const AssetFieldTypeEnum_AssetFieldType BUSINESS_NAME = AssetFieldTypeEnum_AssetFieldType._(18, const $core.bool.fromEnvironment('protobuf.omit_enum_names') ? '' : 'BUSINESS_NAME');
  static const AssetFieldTypeEnum_AssetFieldType SQUARE_MARKETING_IMAGE = AssetFieldTypeEnum_AssetFieldType._(19, const $core.bool.fromEnvironment('protobuf.omit_enum_names') ? '' : 'SQUARE_MARKETING_IMAGE');
  static const AssetFieldTypeEnum_AssetFieldType PORTRAIT_MARKETING_IMAGE = AssetFieldTypeEnum_AssetFieldType._(20, const $core.bool.fromEnvironment('protobuf.omit_enum_names') ? '' : 'PORTRAIT_MARKETING_IMAGE');
  static const AssetFieldTypeEnum_AssetFieldType LOGO = AssetFieldTypeEnum_AssetFieldType._(21, const $core.bool.fromEnvironment('protobuf.omit_enum_names') ? '' : 'LOGO');
  static const AssetFieldTypeEnum_AssetFieldType LANDSCAPE_LOGO = AssetFieldTypeEnum_AssetFieldType._(22, const $core.bool.fromEnvironment('protobuf.omit_enum_names') ? '' : 'LANDSCAPE_LOGO');
  static const AssetFieldTypeEnum_AssetFieldType VIDEO = AssetFieldTypeEnum_AssetFieldType._(23, const $core.bool.fromEnvironment('protobuf.omit_enum_names') ? '' : 'VIDEO');
  static const AssetFieldTypeEnum_AssetFieldType CALL_TO_ACTION_SELECTION = AssetFieldTypeEnum_AssetFieldType._(25, const $core.bool.fromEnvironment('protobuf.omit_enum_names') ? '' : 'CALL_TO_ACTION_SELECTION');

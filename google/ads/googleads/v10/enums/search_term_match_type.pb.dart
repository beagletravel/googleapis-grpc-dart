...
class SearchTermMatchTypeEnum extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'SearchTermMatchTypeEnum', package: const $pb.PackageName(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'google.ads.googleads.v10.enums'), createEmptyInstance: create)
  ...
  'Will be removed in next major version')
  SearchTermMatchTypeEnum copyWith(void Function(SearchTermMatchTypeEnum) updates) => super.copyWith((message) => updates(message as SearchTermMatchTypeEnum)) as SearchTermMatchTypeEnum; // ignore: deprecated_member_use

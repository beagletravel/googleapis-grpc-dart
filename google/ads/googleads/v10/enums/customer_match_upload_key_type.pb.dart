...
class CustomerMatchUploadKeyTypeEnum extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'CustomerMatchUploadKeyTypeEnum', package: const $pb.PackageName(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'google.ads.googleads.v10.enums'), createEmptyInstance: create)
  ...
  'Will be removed in next major version')
  CustomerMatchUploadKeyTypeEnum copyWith(void Function(CustomerMatchUploadKeyTypeEnum) updates) => super.copyWith((message) => updates(message as CustomerMatchUploadKeyTypeEnum)) as CustomerMatchUploadKeyTypeEnum; // ignore: deprecated_member_use

...
class FeedItemTargetStatusEnum extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'FeedItemTargetStatusEnum', package: const $pb.PackageName(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'google.ads.googleads.v10.enums'), createEmptyInstance: create)
  ...
  'Will be removed in next major version')
  FeedItemTargetStatusEnum copyWith(void Function(FeedItemTargetStatusEnum) updates) => super.copyWith((message) => updates(message as FeedItemTargetStatusEnum)) as FeedItemTargetStatusEnum; // ignore: deprecated_member_use

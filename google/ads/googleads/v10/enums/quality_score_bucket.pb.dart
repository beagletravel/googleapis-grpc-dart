...
class QualityScoreBucketEnum extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'QualityScoreBucketEnum', package: const $pb.PackageName(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'google.ads.googleads.v10.enums'), createEmptyInstance: create)
  ...
  'Will be removed in next major version')
  QualityScoreBucketEnum copyWith(void Function(QualityScoreBucketEnum) updates) => super.copyWith((message) => updates(message as QualityScoreBucketEnum)) as QualityScoreBucketEnum; // ignore: deprecated_member_use

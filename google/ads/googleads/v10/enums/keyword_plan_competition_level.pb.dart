...
class KeywordPlanCompetitionLevelEnum extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'KeywordPlanCompetitionLevelEnum', package: const $pb.PackageName(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'google.ads.googleads.v10.enums'), createEmptyInstance: create)
  ...
  'Will be removed in next major version')
  KeywordPlanCompetitionLevelEnum copyWith(void Function(KeywordPlanCompetitionLevelEnum) updates) => super.copyWith((message) => updates(message as KeywordPlanCompetitionLevelEnum)) as KeywordPlanCompetitionLevelEnum; // ignore: deprecated_member_use

...
class CustomInterestStatusEnum extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'CustomInterestStatusEnum', package: const $pb.PackageName(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'google.ads.googleads.v10.enums'), createEmptyInstance: create)
  ...
  'Will be removed in next major version')
  CustomInterestStatusEnum copyWith(void Function(CustomInterestStatusEnum) updates) => super.copyWith((message) => updates(message as CustomInterestStatusEnum)) as CustomInterestStatusEnum; // ignore: deprecated_member_use

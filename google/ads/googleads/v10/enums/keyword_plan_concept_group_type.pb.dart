...
class KeywordPlanConceptGroupTypeEnum extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'KeywordPlanConceptGroupTypeEnum', package: const $pb.PackageName(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'google.ads.googleads.v10.enums'), createEmptyInstance: create)
  ...
  'Will be removed in next major version')
  KeywordPlanConceptGroupTypeEnum copyWith(void Function(KeywordPlanConceptGroupTypeEnum) updates) => super.copyWith((message) => updates(message as KeywordPlanConceptGroupTypeEnum)) as KeywordPlanConceptGroupTypeEnum; // ignore: deprecated_member_use

...
class CallPlaceholderFieldEnum extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'CallPlaceholderFieldEnum', package: const $pb.PackageName(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'google.ads.googleads.v10.enums'), createEmptyInstance: create)
  ...
  'Will be removed in next major version')
  CallPlaceholderFieldEnum copyWith(void Function(CallPlaceholderFieldEnum) updates) => super.copyWith((message) => updates(message as CallPlaceholderFieldEnum)) as CallPlaceholderFieldEnum; // ignore: deprecated_member_use

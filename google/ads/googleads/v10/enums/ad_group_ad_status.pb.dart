...
class AdGroupAdStatusEnum extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'AdGroupAdStatusEnum', package: const $pb.PackageName(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'google.ads.googleads.v10.enums'), createEmptyInstance: create)
  ...
  'Will be removed in next major version')
  AdGroupAdStatusEnum copyWith(void Function(AdGroupAdStatusEnum) updates) => super.copyWith((message) => updates(message as AdGroupAdStatusEnum)) as AdGroupAdStatusEnum; // ignore: deprecated_member_use

...
class ClickTypeEnum extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'ClickTypeEnum', package: const $pb.PackageName(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'google.ads.googleads.v10.enums'), createEmptyInstance: create)
  ...
  'Will be removed in next major version')
  ClickTypeEnum copyWith(void Function(ClickTypeEnum) updates) => super.copyWith((message) => updates(message as ClickTypeEnum)) as ClickTypeEnum; // ignore: deprecated_member_use

...
class DayOfWeekEnum extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'DayOfWeekEnum', package: const $pb.PackageName(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'google.ads.googleads.v10.enums'), createEmptyInstance: create)
  ...
  'Will be removed in next major version')
  DayOfWeekEnum copyWith(void Function(DayOfWeekEnum) updates) => super.copyWith((message) => updates(message as DayOfWeekEnum)) as DayOfWeekEnum; // ignore: deprecated_member_use

...
class VanityPharmaTextEnum extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'VanityPharmaTextEnum', package: const $pb.PackageName(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'google.ads.googleads.v10.enums'), createEmptyInstance: create)
  ...
  'Will be removed in next major version')
  VanityPharmaTextEnum copyWith(void Function(VanityPharmaTextEnum) updates) => super.copyWith((message) => updates(message as VanityPharmaTextEnum)) as VanityPharmaTextEnum; // ignore: deprecated_member_use

...
class CustomizerAttributeTypeEnum extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'CustomizerAttributeTypeEnum', package: const $pb.PackageName(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'google.ads.googleads.v10.enums'), createEmptyInstance: create)
  ...
  'Will be removed in next major version')
  CustomizerAttributeTypeEnum copyWith(void Function(CustomizerAttributeTypeEnum) updates) => super.copyWith((message) => updates(message as CustomizerAttributeTypeEnum)) as CustomizerAttributeTypeEnum; // ignore: deprecated_member_use

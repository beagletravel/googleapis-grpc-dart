...
class ReachPlanNetworkEnum extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'ReachPlanNetworkEnum', package: const $pb.PackageName(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'google.ads.googleads.v10.enums'), createEmptyInstance: create)
  ...
  'Will be removed in next major version')
  ReachPlanNetworkEnum copyWith(void Function(ReachPlanNetworkEnum) updates) => super.copyWith((message) => updates(message as ReachPlanNetworkEnum)) as ReachPlanNetworkEnum; // ignore: deprecated_member_use

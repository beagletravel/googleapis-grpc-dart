...
class ChangeStatusResourceTypeEnum extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'ChangeStatusResourceTypeEnum', package: const $pb.PackageName(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'google.ads.googleads.v10.enums'), createEmptyInstance: create)
  ...
  'Will be removed in next major version')
  ChangeStatusResourceTypeEnum copyWith(void Function(ChangeStatusResourceTypeEnum) updates) => super.copyWith((message) => updates(message as ChangeStatusResourceTypeEnum)) as ChangeStatusResourceTypeEnum; // ignore: deprecated_member_use

...
class BrandSafetySuitabilityEnum extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'BrandSafetySuitabilityEnum', package: const $pb.PackageName(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'google.ads.googleads.v10.enums'), createEmptyInstance: create)
  ...
  'Will be removed in next major version')
  BrandSafetySuitabilityEnum copyWith(void Function(BrandSafetySuitabilityEnum) updates) => super.copyWith((message) => updates(message as BrandSafetySuitabilityEnum)) as BrandSafetySuitabilityEnum; // ignore: deprecated_member_use

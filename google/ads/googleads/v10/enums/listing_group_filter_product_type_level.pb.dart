...
class ListingGroupFilterProductTypeLevelEnum extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'ListingGroupFilterProductTypeLevelEnum', package: const $pb.PackageName(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'google.ads.googleads.v10.enums'), createEmptyInstance: create)
  ...
  'Will be removed in next major version')
  ListingGroupFilterProductTypeLevelEnum copyWith(void Function(ListingGroupFilterProductTypeLevelEnum) updates) => super.copyWith((message) => updates(message as ListingGroupFilterProductTypeLevelEnum)) as ListingGroupFilterProductTypeLevelEnum; // ignore: deprecated_member_use

...
class GenderTypeEnum extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'GenderTypeEnum', package: const $pb.PackageName(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'google.ads.googleads.v10.enums'), createEmptyInstance: create)
  ...
  'Will be removed in next major version')
  GenderTypeEnum copyWith(void Function(GenderTypeEnum) updates) => super.copyWith((message) => updates(message as GenderTypeEnum)) as GenderTypeEnum; // ignore: deprecated_member_use

...
class LeadFormPostSubmitCallToActionTypeEnum extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'LeadFormPostSubmitCallToActionTypeEnum', package: const $pb.PackageName(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'google.ads.googleads.v10.enums'), createEmptyInstance: create)
  ...
  'Will be removed in next major version')
  LeadFormPostSubmitCallToActionTypeEnum copyWith(void Function(LeadFormPostSubmitCallToActionTypeEnum) updates) => super.copyWith((message) => updates(message as LeadFormPostSubmitCallToActionTypeEnum)) as LeadFormPostSubmitCallToActionTypeEnum; // ignore: deprecated_member_use

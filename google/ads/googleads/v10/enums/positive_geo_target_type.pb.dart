...
class PositiveGeoTargetTypeEnum extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'PositiveGeoTargetTypeEnum', package: const $pb.PackageName(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'google.ads.googleads.v10.enums'), createEmptyInstance: create)
  ...
  'Will be removed in next major version')
  PositiveGeoTargetTypeEnum copyWith(void Function(PositiveGeoTargetTypeEnum) updates) => super.copyWith((message) => updates(message as PositiveGeoTargetTypeEnum)) as PositiveGeoTargetTypeEnum; // ignore: deprecated_member_use

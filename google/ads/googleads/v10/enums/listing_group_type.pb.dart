...
class ListingGroupTypeEnum extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'ListingGroupTypeEnum', package: const $pb.PackageName(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'google.ads.googleads.v10.enums'), createEmptyInstance: create)
  ...
  'Will be removed in next major version')
  ListingGroupTypeEnum copyWith(void Function(ListingGroupTypeEnum) updates) => super.copyWith((message) => updates(message as ListingGroupTypeEnum)) as ListingGroupTypeEnum; // ignore: deprecated_member_use

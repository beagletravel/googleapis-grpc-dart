...
class ResourceChangeOperationEnum extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'ResourceChangeOperationEnum', package: const $pb.PackageName(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'google.ads.googleads.v10.enums'), createEmptyInstance: create)
  ...
  'Will be removed in next major version')
  ResourceChangeOperationEnum copyWith(void Function(ResourceChangeOperationEnum) updates) => super.copyWith((message) => updates(message as ResourceChangeOperationEnum)) as ResourceChangeOperationEnum; // ignore: deprecated_member_use

...
class CriterionSystemServingStatusEnum extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'CriterionSystemServingStatusEnum', package: const $pb.PackageName(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'google.ads.googleads.v10.enums'), createEmptyInstance: create)
  ...
  'Will be removed in next major version')
  CriterionSystemServingStatusEnum copyWith(void Function(CriterionSystemServingStatusEnum) updates) => super.copyWith((message) => updates(message as CriterionSystemServingStatusEnum)) as CriterionSystemServingStatusEnum; // ignore: deprecated_member_use

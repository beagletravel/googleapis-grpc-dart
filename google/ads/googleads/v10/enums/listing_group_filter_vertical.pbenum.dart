...
class ListingGroupFilterVerticalEnum_ListingGroupFilterVertical extends $pb.ProtobufEnum {
  static const ListingGroupFilterVerticalEnum_ListingGroupFilterVertical UNSPECIFIED = ListingGroupFilterVerticalEnum_ListingGroupFilterVertical._(0, const $core.bool.fromEnvironment('protobuf.omit_enum_names') ? '' : 'UNSPECIFIED');
  static const ListingGroupFilterVerticalEnum_ListingGroupFilterVertical UNKNOWN = ListingGroupFilterVerticalEnum_ListingGroupFilterVertical._(1, const $core.bool.fromEnvironment('protobuf.omit_enum_names') ? '' : 'UNKNOWN');
  static const ListingGroupFilterVerticalEnum_ListingGroupFilterVertical SHOPPING = ListingGroupFilterVerticalEnum_ListingGroupFilterVertical._(2, const $core.bool.fromEnvironment('protobuf.omit_enum_names') ? '' : 'SHOPPING');

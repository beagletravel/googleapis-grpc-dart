...
class GoalConfigLevelEnum extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'GoalConfigLevelEnum', package: const $pb.PackageName(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'google.ads.googleads.v10.enums'), createEmptyInstance: create)
  ...
  'Will be removed in next major version')
  GoalConfigLevelEnum copyWith(void Function(GoalConfigLevelEnum) updates) => super.copyWith((message) => updates(message as GoalConfigLevelEnum)) as GoalConfigLevelEnum; // ignore: deprecated_member_use

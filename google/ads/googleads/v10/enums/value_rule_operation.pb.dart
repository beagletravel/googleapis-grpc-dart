...
class ValueRuleOperationEnum extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'ValueRuleOperationEnum', package: const $pb.PackageName(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'google.ads.googleads.v10.enums'), createEmptyInstance: create)
  ...
  'Will be removed in next major version')
  ValueRuleOperationEnum copyWith(void Function(ValueRuleOperationEnum) updates) => super.copyWith((message) => updates(message as ValueRuleOperationEnum)) as ValueRuleOperationEnum; // ignore: deprecated_member_use

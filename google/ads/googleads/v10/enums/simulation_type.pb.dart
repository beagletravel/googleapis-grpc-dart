...
class SimulationTypeEnum extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'SimulationTypeEnum', package: const $pb.PackageName(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'google.ads.googleads.v10.enums'), createEmptyInstance: create)
  ...
  'Will be removed in next major version')
  SimulationTypeEnum copyWith(void Function(SimulationTypeEnum) updates) => super.copyWith((message) => updates(message as SimulationTypeEnum)) as SimulationTypeEnum; // ignore: deprecated_member_use

...
class SystemManagedResourceSourceEnum extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'SystemManagedResourceSourceEnum', package: const $pb.PackageName(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'google.ads.googleads.v10.enums'), createEmptyInstance: create)
  ...
  'Will be removed in next major version')
  SystemManagedResourceSourceEnum copyWith(void Function(SystemManagedResourceSourceEnum) updates) => super.copyWith((message) => updates(message as SystemManagedResourceSourceEnum)) as SystemManagedResourceSourceEnum; // ignore: deprecated_member_use

...
class GeoTargetingTypeEnum extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'GeoTargetingTypeEnum', package: const $pb.PackageName(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'google.ads.googleads.v10.enums'), createEmptyInstance: create)
  ...
  'Will be removed in next major version')
  GeoTargetingTypeEnum copyWith(void Function(GeoTargetingTypeEnum) updates) => super.copyWith((message) => updates(message as GeoTargetingTypeEnum)) as GeoTargetingTypeEnum; // ignore: deprecated_member_use

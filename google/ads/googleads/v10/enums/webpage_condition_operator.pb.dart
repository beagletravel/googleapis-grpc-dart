...
class WebpageConditionOperatorEnum extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'WebpageConditionOperatorEnum', package: const $pb.PackageName(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'google.ads.googleads.v10.enums'), createEmptyInstance: create)
  ...
  'Will be removed in next major version')
  WebpageConditionOperatorEnum copyWith(void Function(WebpageConditionOperatorEnum) updates) => super.copyWith((message) => updates(message as WebpageConditionOperatorEnum)) as WebpageConditionOperatorEnum; // ignore: deprecated_member_use

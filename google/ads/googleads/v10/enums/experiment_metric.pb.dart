...
class ExperimentMetricEnum extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'ExperimentMetricEnum', package: const $pb.PackageName(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'google.ads.googleads.v10.enums'), createEmptyInstance: create)
  ...
  'Will be removed in next major version')
  ExperimentMetricEnum copyWith(void Function(ExperimentMetricEnum) updates) => super.copyWith((message) => updates(message as ExperimentMetricEnum)) as ExperimentMetricEnum; // ignore: deprecated_member_use

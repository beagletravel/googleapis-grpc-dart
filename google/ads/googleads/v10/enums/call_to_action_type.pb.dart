...
class CallToActionTypeEnum extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'CallToActionTypeEnum', package: const $pb.PackageName(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'google.ads.googleads.v10.enums'), createEmptyInstance: create)
  ...
  'Will be removed in next major version')
  CallToActionTypeEnum copyWith(void Function(CallToActionTypeEnum) updates) => super.copyWith((message) => updates(message as CallToActionTypeEnum)) as CallToActionTypeEnum; // ignore: deprecated_member_use

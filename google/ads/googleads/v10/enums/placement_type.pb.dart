...
class PlacementTypeEnum extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'PlacementTypeEnum', package: const $pb.PackageName(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'google.ads.googleads.v10.enums'), createEmptyInstance: create)
  ...
  'Will be removed in next major version')
  PlacementTypeEnum copyWith(void Function(PlacementTypeEnum) updates) => super.copyWith((message) => updates(message as PlacementTypeEnum)) as PlacementTypeEnum; // ignore: deprecated_member_use

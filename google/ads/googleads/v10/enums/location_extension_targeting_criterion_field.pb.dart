...
class LocationExtensionTargetingCriterionFieldEnum extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'LocationExtensionTargetingCriterionFieldEnum', package: const $pb.PackageName(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'google.ads.googleads.v10.enums'), createEmptyInstance: create)
  ...
  'Will be removed in next major version')
  LocationExtensionTargetingCriterionFieldEnum copyWith(void Function(LocationExtensionTargetingCriterionFieldEnum) updates) => super.copyWith((message) => updates(message as LocationExtensionTargetingCriterionFieldEnum)) as LocationExtensionTargetingCriterionFieldEnum; // ignore: deprecated_member_use

...
class CallConversionReportingStateEnum extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'CallConversionReportingStateEnum', package: const $pb.PackageName(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'google.ads.googleads.v10.enums'), createEmptyInstance: create)
  ...
  'Will be removed in next major version')
  CallConversionReportingStateEnum copyWith(void Function(CallConversionReportingStateEnum) updates) => super.copyWith((message) => updates(message as CallConversionReportingStateEnum)) as CallConversionReportingStateEnum; // ignore: deprecated_member_use

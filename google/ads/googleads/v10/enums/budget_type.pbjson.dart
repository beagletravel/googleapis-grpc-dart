...
const BudgetTypeEnum_BudgetType$json = const {
  ...
  '2': const [
    ...
    const {'1': 'LOCAL_SERVICES', '2': 6},
  ],
};

/// Descriptor for `BudgetTypeEnum`. Decode as a `google.protobuf.DescriptorProto`.
final $typed_data.Uint8List budgetTypeEnumDescriptor = $convert.base64Decode('Cg5CdWRnZXRUeXBlRW51bSJvCgpCdWRnZXRUeXBlEg8KC1VOU1BFQ0lGSUVEEAASCwoHVU5LTk9XThABEgwKCFNUQU5EQVJEEAISDQoJRklYRURfQ1BBEAQSEgoOU01BUlRfQ0FNUEFJR04QBRISCg5MT0NBTF9TRVJWSUNFUxAG');

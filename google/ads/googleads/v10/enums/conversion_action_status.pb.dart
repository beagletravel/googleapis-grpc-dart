...
class ConversionActionStatusEnum extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'ConversionActionStatusEnum', package: const $pb.PackageName(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'google.ads.googleads.v10.enums'), createEmptyInstance: create)
  ...
  'Will be removed in next major version')
  ConversionActionStatusEnum copyWith(void Function(ConversionActionStatusEnum) updates) => super.copyWith((message) => updates(message as ConversionActionStatusEnum)) as ConversionActionStatusEnum; // ignore: deprecated_member_use

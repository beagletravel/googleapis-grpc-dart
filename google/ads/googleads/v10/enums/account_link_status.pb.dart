...
class AccountLinkStatusEnum extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'AccountLinkStatusEnum', package: const $pb.PackageName(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'google.ads.googleads.v10.enums'), createEmptyInstance: create)
  ...
  'Will be removed in next major version')
  AccountLinkStatusEnum copyWith(void Function(AccountLinkStatusEnum) updates) => super.copyWith((message) => updates(message as AccountLinkStatusEnum)) as AccountLinkStatusEnum; // ignore: deprecated_member_use

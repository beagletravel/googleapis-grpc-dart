...
class MatchingFunctionOperatorEnum extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'MatchingFunctionOperatorEnum', package: const $pb.PackageName(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'google.ads.googleads.v10.enums'), createEmptyInstance: create)
  ...
  'Will be removed in next major version')
  MatchingFunctionOperatorEnum copyWith(void Function(MatchingFunctionOperatorEnum) updates) => super.copyWith((message) => updates(message as MatchingFunctionOperatorEnum)) as MatchingFunctionOperatorEnum; // ignore: deprecated_member_use

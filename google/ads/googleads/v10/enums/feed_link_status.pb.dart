...
class FeedLinkStatusEnum extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'FeedLinkStatusEnum', package: const $pb.PackageName(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'google.ads.googleads.v10.enums'), createEmptyInstance: create)
  ...
  'Will be removed in next major version')
  FeedLinkStatusEnum copyWith(void Function(FeedLinkStatusEnum) updates) => super.copyWith((message) => updates(message as FeedLinkStatusEnum)) as FeedLinkStatusEnum; // ignore: deprecated_member_use

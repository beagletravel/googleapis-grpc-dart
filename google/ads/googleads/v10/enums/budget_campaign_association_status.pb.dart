...
class BudgetCampaignAssociationStatusEnum extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'BudgetCampaignAssociationStatusEnum', package: const $pb.PackageName(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'google.ads.googleads.v10.enums'), createEmptyInstance: create)
  ...
  'Will be removed in next major version')
  BudgetCampaignAssociationStatusEnum copyWith(void Function(BudgetCampaignAssociationStatusEnum) updates) => super.copyWith((message) => updates(message as BudgetCampaignAssociationStatusEnum)) as BudgetCampaignAssociationStatusEnum; // ignore: deprecated_member_use

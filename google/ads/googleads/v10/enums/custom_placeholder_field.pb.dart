...
class CustomPlaceholderFieldEnum extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'CustomPlaceholderFieldEnum', package: const $pb.PackageName(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'google.ads.googleads.v10.enums'), createEmptyInstance: create)
  ...
  'Will be removed in next major version')
  CustomPlaceholderFieldEnum copyWith(void Function(CustomPlaceholderFieldEnum) updates) => super.copyWith((message) => updates(message as CustomPlaceholderFieldEnum)) as CustomPlaceholderFieldEnum; // ignore: deprecated_member_use

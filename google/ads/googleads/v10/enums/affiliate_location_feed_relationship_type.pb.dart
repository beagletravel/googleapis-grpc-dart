...
class AffiliateLocationFeedRelationshipTypeEnum extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'AffiliateLocationFeedRelationshipTypeEnum', package: const $pb.PackageName(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'google.ads.googleads.v10.enums'), createEmptyInstance: create)
  ...
  'Will be removed in next major version')
  AffiliateLocationFeedRelationshipTypeEnum copyWith(void Function(AffiliateLocationFeedRelationshipTypeEnum) updates) => super.copyWith((message) => updates(message as AffiliateLocationFeedRelationshipTypeEnum)) as AffiliateLocationFeedRelationshipTypeEnum; // ignore: deprecated_member_use

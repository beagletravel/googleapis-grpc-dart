...
class MinuteOfHourEnum extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'MinuteOfHourEnum', package: const $pb.PackageName(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'google.ads.googleads.v10.enums'), createEmptyInstance: create)
  ...
  'Will be removed in next major version')
  MinuteOfHourEnum copyWith(void Function(MinuteOfHourEnum) updates) => super.copyWith((message) => updates(message as MinuteOfHourEnum)) as MinuteOfHourEnum; // ignore: deprecated_member_use

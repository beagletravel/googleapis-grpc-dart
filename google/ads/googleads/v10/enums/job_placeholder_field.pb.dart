...
class JobPlaceholderFieldEnum extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'JobPlaceholderFieldEnum', package: const $pb.PackageName(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'google.ads.googleads.v10.enums'), createEmptyInstance: create)
  ...
  'Will be removed in next major version')
  JobPlaceholderFieldEnum copyWith(void Function(JobPlaceholderFieldEnum) updates) => super.copyWith((message) => updates(message as JobPlaceholderFieldEnum)) as JobPlaceholderFieldEnum; // ignore: deprecated_member_use

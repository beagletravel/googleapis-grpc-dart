...
class SeasonalityEventScopeEnum extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'SeasonalityEventScopeEnum', package: const $pb.PackageName(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'google.ads.googleads.v10.enums'), createEmptyInstance: create)
  ...
  'Will be removed in next major version')
  SeasonalityEventScopeEnum copyWith(void Function(SeasonalityEventScopeEnum) updates) => super.copyWith((message) => updates(message as SeasonalityEventScopeEnum)) as SeasonalityEventScopeEnum; // ignore: deprecated_member_use

...
class PromotionExtensionOccasionEnum extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'PromotionExtensionOccasionEnum', package: const $pb.PackageName(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'google.ads.googleads.v10.enums'), createEmptyInstance: create)
  ...
  'Will be removed in next major version')
  PromotionExtensionOccasionEnum copyWith(void Function(PromotionExtensionOccasionEnum) updates) => super.copyWith((message) => updates(message as PromotionExtensionOccasionEnum)) as PromotionExtensionOccasionEnum; // ignore: deprecated_member_use

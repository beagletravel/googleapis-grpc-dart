...
class MobileAppVendorEnum extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'MobileAppVendorEnum', package: const $pb.PackageName(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'google.ads.googleads.v10.enums'), createEmptyInstance: create)
  ...
  'Will be removed in next major version')
  MobileAppVendorEnum copyWith(void Function(MobileAppVendorEnum) updates) => super.copyWith((message) => updates(message as MobileAppVendorEnum)) as MobileAppVendorEnum; // ignore: deprecated_member_use

...
class LinkedAccountTypeEnum extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'LinkedAccountTypeEnum', package: const $pb.PackageName(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'google.ads.googleads.v10.enums'), createEmptyInstance: create)
  ...
  'Will be removed in next major version')
  LinkedAccountTypeEnum copyWith(void Function(LinkedAccountTypeEnum) updates) => super.copyWith((message) => updates(message as LinkedAccountTypeEnum)) as LinkedAccountTypeEnum; // ignore: deprecated_member_use

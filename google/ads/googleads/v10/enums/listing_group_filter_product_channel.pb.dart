...
class ListingGroupFilterProductChannelEnum extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'ListingGroupFilterProductChannelEnum', package: const $pb.PackageName(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'google.ads.googleads.v10.enums'), createEmptyInstance: create)
  ...
  'Will be removed in next major version')
  ListingGroupFilterProductChannelEnum copyWith(void Function(ListingGroupFilterProductChannelEnum) updates) => super.copyWith((message) => updates(message as ListingGroupFilterProductChannelEnum)) as ListingGroupFilterProductChannelEnum; // ignore: deprecated_member_use

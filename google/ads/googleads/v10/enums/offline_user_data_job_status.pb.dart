...
class OfflineUserDataJobStatusEnum extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'OfflineUserDataJobStatusEnum', package: const $pb.PackageName(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'google.ads.googleads.v10.enums'), createEmptyInstance: create)
  ...
  'Will be removed in next major version')
  OfflineUserDataJobStatusEnum copyWith(void Function(OfflineUserDataJobStatusEnum) updates) => super.copyWith((message) => updates(message as OfflineUserDataJobStatusEnum)) as OfflineUserDataJobStatusEnum; // ignore: deprecated_member_use

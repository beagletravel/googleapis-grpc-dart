...
class TravelPlaceholderFieldEnum extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'TravelPlaceholderFieldEnum', package: const $pb.PackageName(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'google.ads.googleads.v10.enums'), createEmptyInstance: create)
  ...
  'Will be removed in next major version')
  TravelPlaceholderFieldEnum copyWith(void Function(TravelPlaceholderFieldEnum) updates) => super.copyWith((message) => updates(message as TravelPlaceholderFieldEnum)) as TravelPlaceholderFieldEnum; // ignore: deprecated_member_use

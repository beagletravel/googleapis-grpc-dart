...
class OfflineUserDataJobTypeEnum extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'OfflineUserDataJobTypeEnum', package: const $pb.PackageName(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'google.ads.googleads.v10.enums'), createEmptyInstance: create)
  ...
  'Will be removed in next major version')
  OfflineUserDataJobTypeEnum copyWith(void Function(OfflineUserDataJobTypeEnum) updates) => super.copyWith((message) => updates(message as OfflineUserDataJobTypeEnum)) as OfflineUserDataJobTypeEnum; // ignore: deprecated_member_use

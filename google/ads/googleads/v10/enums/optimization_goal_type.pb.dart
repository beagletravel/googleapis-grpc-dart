...
class OptimizationGoalTypeEnum extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'OptimizationGoalTypeEnum', package: const $pb.PackageName(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'google.ads.googleads.v10.enums'), createEmptyInstance: create)
  ...
  'Will be removed in next major version')
  OptimizationGoalTypeEnum copyWith(void Function(OptimizationGoalTypeEnum) updates) => super.copyWith((message) => updates(message as OptimizationGoalTypeEnum)) as OptimizationGoalTypeEnum; // ignore: deprecated_member_use

...
class ValueRuleGeoLocationMatchTypeEnum extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'ValueRuleGeoLocationMatchTypeEnum', package: const $pb.PackageName(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'google.ads.googleads.v10.enums'), createEmptyInstance: create)
  ...
  'Will be removed in next major version')
  ValueRuleGeoLocationMatchTypeEnum copyWith(void Function(ValueRuleGeoLocationMatchTypeEnum) updates) => super.copyWith((message) => updates(message as ValueRuleGeoLocationMatchTypeEnum)) as ValueRuleGeoLocationMatchTypeEnum; // ignore: deprecated_member_use

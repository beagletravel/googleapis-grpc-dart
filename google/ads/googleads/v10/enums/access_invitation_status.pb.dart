...
class AccessInvitationStatusEnum extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'AccessInvitationStatusEnum', package: const $pb.PackageName(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'google.ads.googleads.v10.enums'), createEmptyInstance: create)
  ...
  'Will be removed in next major version')
  AccessInvitationStatusEnum copyWith(void Function(AccessInvitationStatusEnum) updates) => super.copyWith((message) => updates(message as AccessInvitationStatusEnum)) as AccessInvitationStatusEnum; // ignore: deprecated_member_use

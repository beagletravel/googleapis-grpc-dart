...
class AssetPerformanceLabelEnum extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'AssetPerformanceLabelEnum', package: const $pb.PackageName(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'google.ads.googleads.v10.enums'), createEmptyInstance: create)
  ...
  'Will be removed in next major version')
  AssetPerformanceLabelEnum copyWith(void Function(AssetPerformanceLabelEnum) updates) => super.copyWith((message) => updates(message as AssetPerformanceLabelEnum)) as AssetPerformanceLabelEnum; // ignore: deprecated_member_use

...
class PolicyTopicEvidenceDestinationNotWorkingDeviceEnum extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'PolicyTopicEvidenceDestinationNotWorkingDeviceEnum', package: const $pb.PackageName(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'google.ads.googleads.v10.enums'), createEmptyInstance: create)
  ...
  'Will be removed in next major version')
  PolicyTopicEvidenceDestinationNotWorkingDeviceEnum copyWith(void Function(PolicyTopicEvidenceDestinationNotWorkingDeviceEnum) updates) => super.copyWith((message) => updates(message as PolicyTopicEvidenceDestinationNotWorkingDeviceEnum)) as PolicyTopicEvidenceDestinationNotWorkingDeviceEnum; // ignore: deprecated_member_use

...
class ChangeStatusOperationEnum extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'ChangeStatusOperationEnum', package: const $pb.PackageName(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'google.ads.googleads.v10.enums'), createEmptyInstance: create)
  ...
  'Will be removed in next major version')
  ChangeStatusOperationEnum copyWith(void Function(ChangeStatusOperationEnum) updates) => super.copyWith((message) => updates(message as ChangeStatusOperationEnum)) as ChangeStatusOperationEnum; // ignore: deprecated_member_use

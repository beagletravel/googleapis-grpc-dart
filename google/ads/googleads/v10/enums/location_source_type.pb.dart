...
class LocationSourceTypeEnum extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'LocationSourceTypeEnum', package: const $pb.PackageName(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'google.ads.googleads.v10.enums'), createEmptyInstance: create)
  ...
  'Will be removed in next major version')
  LocationSourceTypeEnum copyWith(void Function(LocationSourceTypeEnum) updates) => super.copyWith((message) => updates(message as LocationSourceTypeEnum)) as LocationSourceTypeEnum; // ignore: deprecated_member_use

...
class ImagePlaceholderFieldEnum extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'ImagePlaceholderFieldEnum', package: const $pb.PackageName(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'google.ads.googleads.v10.enums'), createEmptyInstance: create)
  ...
  'Will be removed in next major version')
  ImagePlaceholderFieldEnum copyWith(void Function(ImagePlaceholderFieldEnum) updates) => super.copyWith((message) => updates(message as ImagePlaceholderFieldEnum)) as ImagePlaceholderFieldEnum; // ignore: deprecated_member_use

...
class AppUrlOperatingSystemTypeEnum extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'AppUrlOperatingSystemTypeEnum', package: const $pb.PackageName(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'google.ads.googleads.v10.enums'), createEmptyInstance: create)
  ...
  'Will be removed in next major version')
  AppUrlOperatingSystemTypeEnum copyWith(void Function(AppUrlOperatingSystemTypeEnum) updates) => super.copyWith((message) => updates(message as AppUrlOperatingSystemTypeEnum)) as AppUrlOperatingSystemTypeEnum; // ignore: deprecated_member_use

...
class CustomizerAttributeStatusEnum extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'CustomizerAttributeStatusEnum', package: const $pb.PackageName(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'google.ads.googleads.v10.enums'), createEmptyInstance: create)
  ...
  'Will be removed in next major version')
  CustomizerAttributeStatusEnum copyWith(void Function(CustomizerAttributeStatusEnum) updates) => super.copyWith((message) => updates(message as CustomizerAttributeStatusEnum)) as CustomizerAttributeStatusEnum; // ignore: deprecated_member_use

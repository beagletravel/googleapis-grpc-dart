...
class ConversionActionCountingTypeEnum extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'ConversionActionCountingTypeEnum', package: const $pb.PackageName(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'google.ads.googleads.v10.enums'), createEmptyInstance: create)
  ...
  'Will be removed in next major version')
  ConversionActionCountingTypeEnum copyWith(void Function(ConversionActionCountingTypeEnum) updates) => super.copyWith((message) => updates(message as ConversionActionCountingTypeEnum)) as ConversionActionCountingTypeEnum; // ignore: deprecated_member_use

...
class CampaignSharedSetStatusEnum extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'CampaignSharedSetStatusEnum', package: const $pb.PackageName(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'google.ads.googleads.v10.enums'), createEmptyInstance: create)
  ...
  'Will be removed in next major version')
  CampaignSharedSetStatusEnum copyWith(void Function(CampaignSharedSetStatusEnum) updates) => super.copyWith((message) => updates(message as CampaignSharedSetStatusEnum)) as CampaignSharedSetStatusEnum; // ignore: deprecated_member_use

...
class LeadFormDesiredIntentEnum extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'LeadFormDesiredIntentEnum', package: const $pb.PackageName(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'google.ads.googleads.v10.enums'), createEmptyInstance: create)
  ...
  'Will be removed in next major version')
  LeadFormDesiredIntentEnum copyWith(void Function(LeadFormDesiredIntentEnum) updates) => super.copyWith((message) => updates(message as LeadFormDesiredIntentEnum)) as LeadFormDesiredIntentEnum; // ignore: deprecated_member_use

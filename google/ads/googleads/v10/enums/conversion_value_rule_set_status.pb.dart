...
class ConversionValueRuleSetStatusEnum extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'ConversionValueRuleSetStatusEnum', package: const $pb.PackageName(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'google.ads.googleads.v10.enums'), createEmptyInstance: create)
  ...
  'Will be removed in next major version')
  ConversionValueRuleSetStatusEnum copyWith(void Function(ConversionValueRuleSetStatusEnum) updates) => super.copyWith((message) => updates(message as ConversionValueRuleSetStatusEnum)) as ConversionValueRuleSetStatusEnum; // ignore: deprecated_member_use

...
class WebpageConditionOperandEnum extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'WebpageConditionOperandEnum', package: const $pb.PackageName(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'google.ads.googleads.v10.enums'), createEmptyInstance: create)
  ...
  'Will be removed in next major version')
  WebpageConditionOperandEnum copyWith(void Function(WebpageConditionOperandEnum) updates) => super.copyWith((message) => updates(message as WebpageConditionOperandEnum)) as WebpageConditionOperandEnum; // ignore: deprecated_member_use

...
class ListingGroupFilterCustomAttributeIndexEnum extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'ListingGroupFilterCustomAttributeIndexEnum', package: const $pb.PackageName(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'google.ads.googleads.v10.enums'), createEmptyInstance: create)
  ...
  'Will be removed in next major version')
  ListingGroupFilterCustomAttributeIndexEnum copyWith(void Function(ListingGroupFilterCustomAttributeIndexEnum) updates) => super.copyWith((message) => updates(message as ListingGroupFilterCustomAttributeIndexEnum)) as ListingGroupFilterCustomAttributeIndexEnum; // ignore: deprecated_member_use

...
class AppCampaignBiddingStrategyGoalTypeEnum extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'AppCampaignBiddingStrategyGoalTypeEnum', package: const $pb.PackageName(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'google.ads.googleads.v10.enums'), createEmptyInstance: create)
  ...
  'Will be removed in next major version')
  AppCampaignBiddingStrategyGoalTypeEnum copyWith(void Function(AppCampaignBiddingStrategyGoalTypeEnum) updates) => super.copyWith((message) => updates(message as AppCampaignBiddingStrategyGoalTypeEnum)) as AppCampaignBiddingStrategyGoalTypeEnum; // ignore: deprecated_member_use

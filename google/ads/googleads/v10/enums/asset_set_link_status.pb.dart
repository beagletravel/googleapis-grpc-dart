...
class AssetSetLinkStatusEnum extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'AssetSetLinkStatusEnum', package: const $pb.PackageName(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'google.ads.googleads.v10.enums'), createEmptyInstance: create)
  ...
  'Will be removed in next major version')
  AssetSetLinkStatusEnum copyWith(void Function(AssetSetLinkStatusEnum) updates) => super.copyWith((message) => updates(message as AssetSetLinkStatusEnum)) as AssetSetLinkStatusEnum; // ignore: deprecated_member_use

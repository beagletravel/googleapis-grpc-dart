...
class AssetFieldTypeEnum extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'AssetFieldTypeEnum', package: const $pb.PackageName(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'google.ads.googleads.v10.enums'), createEmptyInstance: create)
  ...
  'Will be removed in next major version')
  AssetFieldTypeEnum copyWith(void Function(AssetFieldTypeEnum) updates) => super.copyWith((message) => updates(message as AssetFieldTypeEnum)) as AssetFieldTypeEnum; // ignore: deprecated_member_use

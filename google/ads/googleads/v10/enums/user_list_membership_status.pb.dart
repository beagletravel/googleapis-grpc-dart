...
class UserListMembershipStatusEnum extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'UserListMembershipStatusEnum', package: const $pb.PackageName(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'google.ads.googleads.v10.enums'), createEmptyInstance: create)
  ...
  'Will be removed in next major version')
  UserListMembershipStatusEnum copyWith(void Function(UserListMembershipStatusEnum) updates) => super.copyWith((message) => updates(message as UserListMembershipStatusEnum)) as UserListMembershipStatusEnum; // ignore: deprecated_member_use

...
class SimulationModificationMethodEnum extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'SimulationModificationMethodEnum', package: const $pb.PackageName(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'google.ads.googleads.v10.enums'), createEmptyInstance: create)
  ...
  'Will be removed in next major version')
  SimulationModificationMethodEnum copyWith(void Function(SimulationModificationMethodEnum) updates) => super.copyWith((message) => updates(message as SimulationModificationMethodEnum)) as SimulationModificationMethodEnum; // ignore: deprecated_member_use

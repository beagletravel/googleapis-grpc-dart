...
class ChangeClientTypeEnum extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'ChangeClientTypeEnum', package: const $pb.PackageName(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'google.ads.googleads.v10.enums'), createEmptyInstance: create)
  ...
  'Will be removed in next major version')
  ChangeClientTypeEnum copyWith(void Function(ChangeClientTypeEnum) updates) => super.copyWith((message) => updates(message as ChangeClientTypeEnum)) as ChangeClientTypeEnum; // ignore: deprecated_member_use

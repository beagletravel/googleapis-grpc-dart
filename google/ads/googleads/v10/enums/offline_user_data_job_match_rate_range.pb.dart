...
class OfflineUserDataJobMatchRateRangeEnum extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'OfflineUserDataJobMatchRateRangeEnum', package: const $pb.PackageName(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'google.ads.googleads.v10.enums'), createEmptyInstance: create)
  ...
  'Will be removed in next major version')
  OfflineUserDataJobMatchRateRangeEnum copyWith(void Function(OfflineUserDataJobMatchRateRangeEnum) updates) => super.copyWith((message) => updates(message as OfflineUserDataJobMatchRateRangeEnum)) as OfflineUserDataJobMatchRateRangeEnum; // ignore: deprecated_member_use

...
class CustomAudienceTypeEnum extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'CustomAudienceTypeEnum', package: const $pb.PackageName(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'google.ads.googleads.v10.enums'), createEmptyInstance: create)
  ...
  'Will be removed in next major version')
  CustomAudienceTypeEnum copyWith(void Function(CustomAudienceTypeEnum) updates) => super.copyWith((message) => updates(message as CustomAudienceTypeEnum)) as CustomAudienceTypeEnum; // ignore: deprecated_member_use

...
class SeasonalityEventStatusEnum extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'SeasonalityEventStatusEnum', package: const $pb.PackageName(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'google.ads.googleads.v10.enums'), createEmptyInstance: create)
  ...
  'Will be removed in next major version')
  SeasonalityEventStatusEnum copyWith(void Function(SeasonalityEventStatusEnum) updates) => super.copyWith((message) => updates(message as SeasonalityEventStatusEnum)) as SeasonalityEventStatusEnum; // ignore: deprecated_member_use

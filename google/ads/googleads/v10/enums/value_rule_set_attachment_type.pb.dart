...
class ValueRuleSetAttachmentTypeEnum extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'ValueRuleSetAttachmentTypeEnum', package: const $pb.PackageName(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'google.ads.googleads.v10.enums'), createEmptyInstance: create)
  ...
  'Will be removed in next major version')
  ValueRuleSetAttachmentTypeEnum copyWith(void Function(ValueRuleSetAttachmentTypeEnum) updates) => super.copyWith((message) => updates(message as ValueRuleSetAttachmentTypeEnum)) as ValueRuleSetAttachmentTypeEnum; // ignore: deprecated_member_use

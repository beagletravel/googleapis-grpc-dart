...
class UserListClosingReasonEnum extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'UserListClosingReasonEnum', package: const $pb.PackageName(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'google.ads.googleads.v10.enums'), createEmptyInstance: create)
  ...
  'Will be removed in next major version')
  UserListClosingReasonEnum copyWith(void Function(UserListClosingReasonEnum) updates) => super.copyWith((message) => updates(message as UserListClosingReasonEnum)) as UserListClosingReasonEnum; // ignore: deprecated_member_use

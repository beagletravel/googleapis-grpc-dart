...
class GeoTargetingRestrictionEnum extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'GeoTargetingRestrictionEnum', package: const $pb.PackageName(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'google.ads.googleads.v10.enums'), createEmptyInstance: create)
  ...
  'Will be removed in next major version')
  GeoTargetingRestrictionEnum copyWith(void Function(GeoTargetingRestrictionEnum) updates) => super.copyWith((message) => updates(message as GeoTargetingRestrictionEnum)) as GeoTargetingRestrictionEnum; // ignore: deprecated_member_use

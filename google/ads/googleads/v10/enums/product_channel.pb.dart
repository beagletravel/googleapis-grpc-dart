...
class ProductChannelEnum extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'ProductChannelEnum', package: const $pb.PackageName(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'google.ads.googleads.v10.enums'), createEmptyInstance: create)
  ...
  'Will be removed in next major version')
  ProductChannelEnum copyWith(void Function(ProductChannelEnum) updates) => super.copyWith((message) => updates(message as ProductChannelEnum)) as ProductChannelEnum; // ignore: deprecated_member_use

...
class ExternalConversionSourceEnum extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'ExternalConversionSourceEnum', package: const $pb.PackageName(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'google.ads.googleads.v10.enums'), createEmptyInstance: create)
  ...
  'Will be removed in next major version')
  ExternalConversionSourceEnum copyWith(void Function(ExternalConversionSourceEnum) updates) => super.copyWith((message) => updates(message as ExternalConversionSourceEnum)) as ExternalConversionSourceEnum; // ignore: deprecated_member_use

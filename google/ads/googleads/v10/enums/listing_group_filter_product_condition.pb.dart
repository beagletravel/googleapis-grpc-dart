...
class ListingGroupFilterProductConditionEnum extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'ListingGroupFilterProductConditionEnum', package: const $pb.PackageName(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'google.ads.googleads.v10.enums'), createEmptyInstance: create)
  ...
  'Will be removed in next major version')
  ListingGroupFilterProductConditionEnum copyWith(void Function(ListingGroupFilterProductConditionEnum) updates) => super.copyWith((message) => updates(message as ListingGroupFilterProductConditionEnum)) as ListingGroupFilterProductConditionEnum; // ignore: deprecated_member_use

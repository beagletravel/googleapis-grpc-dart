...
class FeedAttributeTypeEnum extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'FeedAttributeTypeEnum', package: const $pb.PackageName(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'google.ads.googleads.v10.enums'), createEmptyInstance: create)
  ...
  'Will be removed in next major version')
  FeedAttributeTypeEnum copyWith(void Function(FeedAttributeTypeEnum) updates) => super.copyWith((message) => updates(message as FeedAttributeTypeEnum)) as FeedAttributeTypeEnum; // ignore: deprecated_member_use

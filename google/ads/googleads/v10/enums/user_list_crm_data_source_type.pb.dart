...
class UserListCrmDataSourceTypeEnum extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'UserListCrmDataSourceTypeEnum', package: const $pb.PackageName(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'google.ads.googleads.v10.enums'), createEmptyInstance: create)
  ...
  'Will be removed in next major version')
  UserListCrmDataSourceTypeEnum copyWith(void Function(UserListCrmDataSourceTypeEnum) updates) => super.copyWith((message) => updates(message as UserListCrmDataSourceTypeEnum)) as UserListCrmDataSourceTypeEnum; // ignore: deprecated_member_use

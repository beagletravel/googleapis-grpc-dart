...
class UserListRuleTypeEnum extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'UserListRuleTypeEnum', package: const $pb.PackageName(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'google.ads.googleads.v10.enums'), createEmptyInstance: create)
  ...
  'Will be removed in next major version')
  UserListRuleTypeEnum copyWith(void Function(UserListRuleTypeEnum) updates) => super.copyWith((message) => updates(message as UserListRuleTypeEnum)) as UserListRuleTypeEnum; // ignore: deprecated_member_use

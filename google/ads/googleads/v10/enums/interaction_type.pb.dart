...
class InteractionTypeEnum extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'InteractionTypeEnum', package: const $pb.PackageName(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'google.ads.googleads.v10.enums'), createEmptyInstance: create)
  ...
  'Will be removed in next major version')
  InteractionTypeEnum copyWith(void Function(InteractionTypeEnum) updates) => super.copyWith((message) => updates(message as InteractionTypeEnum)) as InteractionTypeEnum; // ignore: deprecated_member_use

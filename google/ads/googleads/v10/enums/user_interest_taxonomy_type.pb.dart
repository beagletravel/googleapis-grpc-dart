...
class UserInterestTaxonomyTypeEnum extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'UserInterestTaxonomyTypeEnum', package: const $pb.PackageName(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'google.ads.googleads.v10.enums'), createEmptyInstance: create)
  ...
  'Will be removed in next major version')
  UserInterestTaxonomyTypeEnum copyWith(void Function(UserInterestTaxonomyTypeEnum) updates) => super.copyWith((message) => updates(message as UserInterestTaxonomyTypeEnum)) as UserInterestTaxonomyTypeEnum; // ignore: deprecated_member_use

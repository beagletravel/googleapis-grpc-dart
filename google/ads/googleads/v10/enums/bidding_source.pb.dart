...
class BiddingSourceEnum extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'BiddingSourceEnum', package: const $pb.PackageName(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'google.ads.googleads.v10.enums'), createEmptyInstance: create)
  ...
  'Will be removed in next major version')
  BiddingSourceEnum copyWith(void Function(BiddingSourceEnum) updates) => super.copyWith((message) => updates(message as BiddingSourceEnum)) as BiddingSourceEnum; // ignore: deprecated_member_use

...
class CustomAudienceStatusEnum extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'CustomAudienceStatusEnum', package: const $pb.PackageName(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'google.ads.googleads.v10.enums'), createEmptyInstance: create)
  ...
  'Will be removed in next major version')
  CustomAudienceStatusEnum copyWith(void Function(CustomAudienceStatusEnum) updates) => super.copyWith((message) => updates(message as CustomAudienceStatusEnum)) as CustomAudienceStatusEnum; // ignore: deprecated_member_use

...
class AppStoreEnum extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'AppStoreEnum', package: const $pb.PackageName(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'google.ads.googleads.v10.enums'), createEmptyInstance: create)
  ...
  'Will be removed in next major version')
  AppStoreEnum copyWith(void Function(AppStoreEnum) updates) => super.copyWith((message) => updates(message as AppStoreEnum)) as AppStoreEnum; // ignore: deprecated_member_use

...
class AffiliateLocationPlaceholderFieldEnum extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'AffiliateLocationPlaceholderFieldEnum', package: const $pb.PackageName(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'google.ads.googleads.v10.enums'), createEmptyInstance: create)
  ...
  'Will be removed in next major version')
  AffiliateLocationPlaceholderFieldEnum copyWith(void Function(AffiliateLocationPlaceholderFieldEnum) updates) => super.copyWith((message) => updates(message as AffiliateLocationPlaceholderFieldEnum)) as AffiliateLocationPlaceholderFieldEnum; // ignore: deprecated_member_use

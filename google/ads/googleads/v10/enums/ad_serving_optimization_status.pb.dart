...
class AdServingOptimizationStatusEnum extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'AdServingOptimizationStatusEnum', package: const $pb.PackageName(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'google.ads.googleads.v10.enums'), createEmptyInstance: create)
  ...
  'Will be removed in next major version')
  AdServingOptimizationStatusEnum copyWith(void Function(AdServingOptimizationStatusEnum) updates) => super.copyWith((message) => updates(message as AdServingOptimizationStatusEnum)) as AdServingOptimizationStatusEnum; // ignore: deprecated_member_use

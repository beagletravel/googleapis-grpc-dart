...
class InteractionEventTypeEnum extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'InteractionEventTypeEnum', package: const $pb.PackageName(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'google.ads.googleads.v10.enums'), createEmptyInstance: create)
  ...
  'Will be removed in next major version')
  InteractionEventTypeEnum copyWith(void Function(InteractionEventTypeEnum) updates) => super.copyWith((message) => updates(message as InteractionEventTypeEnum)) as InteractionEventTypeEnum; // ignore: deprecated_member_use

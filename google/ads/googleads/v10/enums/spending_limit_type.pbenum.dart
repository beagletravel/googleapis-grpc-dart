...
class SpendingLimitTypeEnum_SpendingLimitType extends $pb.ProtobufEnum {
  static const SpendingLimitTypeEnum_SpendingLimitType UNSPECIFIED = SpendingLimitTypeEnum_SpendingLimitType._(0, const $core.bool.fromEnvironment('protobuf.omit_enum_names') ? '' : 'UNSPECIFIED');
  static const SpendingLimitTypeEnum_SpendingLimitType UNKNOWN = SpendingLimitTypeEnum_SpendingLimitType._(1, const $core.bool.fromEnvironment('protobuf.omit_enum_names') ? '' : 'UNKNOWN');
  static const SpendingLimitTypeEnum_SpendingLimitType INFINITE = SpendingLimitTypeEnum_SpendingLimitType._(2, const $core.bool.fromEnvironment('protobuf.omit_enum_names') ? '' : 'INFINITE');

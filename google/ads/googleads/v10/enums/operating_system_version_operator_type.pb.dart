...
class OperatingSystemVersionOperatorTypeEnum extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'OperatingSystemVersionOperatorTypeEnum', package: const $pb.PackageName(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'google.ads.googleads.v10.enums'), createEmptyInstance: create)
  ...
  'Will be removed in next major version')
  OperatingSystemVersionOperatorTypeEnum copyWith(void Function(OperatingSystemVersionOperatorTypeEnum) updates) => super.copyWith((message) => updates(message as OperatingSystemVersionOperatorTypeEnum)) as OperatingSystemVersionOperatorTypeEnum; // ignore: deprecated_member_use

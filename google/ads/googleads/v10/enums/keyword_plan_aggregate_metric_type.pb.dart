...
class KeywordPlanAggregateMetricTypeEnum extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'KeywordPlanAggregateMetricTypeEnum', package: const $pb.PackageName(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'google.ads.googleads.v10.enums'), createEmptyInstance: create)
  ...
  'Will be removed in next major version')
  KeywordPlanAggregateMetricTypeEnum copyWith(void Function(KeywordPlanAggregateMetricTypeEnum) updates) => super.copyWith((message) => updates(message as KeywordPlanAggregateMetricTypeEnum)) as KeywordPlanAggregateMetricTypeEnum; // ignore: deprecated_member_use

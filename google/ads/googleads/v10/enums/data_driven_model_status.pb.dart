...
class DataDrivenModelStatusEnum extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'DataDrivenModelStatusEnum', package: const $pb.PackageName(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'google.ads.googleads.v10.enums'), createEmptyInstance: create)
  ...
  'Will be removed in next major version')
  DataDrivenModelStatusEnum copyWith(void Function(DataDrivenModelStatusEnum) updates) => super.copyWith((message) => updates(message as DataDrivenModelStatusEnum)) as DataDrivenModelStatusEnum; // ignore: deprecated_member_use

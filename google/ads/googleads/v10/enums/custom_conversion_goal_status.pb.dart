...
class CustomConversionGoalStatusEnum extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'CustomConversionGoalStatusEnum', package: const $pb.PackageName(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'google.ads.googleads.v10.enums'), createEmptyInstance: create)
  ...
  'Will be removed in next major version')
  CustomConversionGoalStatusEnum copyWith(void Function(CustomConversionGoalStatusEnum) updates) => super.copyWith((message) => updates(message as CustomConversionGoalStatusEnum)) as CustomConversionGoalStatusEnum; // ignore: deprecated_member_use

...
class UserListSizeRangeEnum extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'UserListSizeRangeEnum', package: const $pb.PackageName(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'google.ads.googleads.v10.enums'), createEmptyInstance: create)
  ...
  'Will be removed in next major version')
  UserListSizeRangeEnum copyWith(void Function(UserListSizeRangeEnum) updates) => super.copyWith((message) => updates(message as UserListSizeRangeEnum)) as UserListSizeRangeEnum; // ignore: deprecated_member_use

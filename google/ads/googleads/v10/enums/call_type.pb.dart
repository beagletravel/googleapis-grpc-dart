...
class CallTypeEnum extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'CallTypeEnum', package: const $pb.PackageName(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'google.ads.googleads.v10.enums'), createEmptyInstance: create)
  ...
  'Will be removed in next major version')
  CallTypeEnum copyWith(void Function(CallTypeEnum) updates) => super.copyWith((message) => updates(message as CallTypeEnum)) as CallTypeEnum; // ignore: deprecated_member_use

...
class CustomerPayPerConversionEligibilityFailureReasonEnum extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'CustomerPayPerConversionEligibilityFailureReasonEnum', package: const $pb.PackageName(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'google.ads.googleads.v10.enums'), createEmptyInstance: create)
  ...
  'Will be removed in next major version')
  CustomerPayPerConversionEligibilityFailureReasonEnum copyWith(void Function(CustomerPayPerConversionEligibilityFailureReasonEnum) updates) => super.copyWith((message) => updates(message as CustomerPayPerConversionEligibilityFailureReasonEnum)) as CustomerPayPerConversionEligibilityFailureReasonEnum; // ignore: deprecated_member_use

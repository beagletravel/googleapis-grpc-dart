...
class CampaignStatusEnum extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'CampaignStatusEnum', package: const $pb.PackageName(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'google.ads.googleads.v10.enums'), createEmptyInstance: create)
  ...
  'Will be removed in next major version')
  CampaignStatusEnum copyWith(void Function(CampaignStatusEnum) updates) => super.copyWith((message) => updates(message as CampaignStatusEnum)) as CampaignStatusEnum; // ignore: deprecated_member_use

...
class ConversionCustomVariableStatusEnum extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'ConversionCustomVariableStatusEnum', package: const $pb.PackageName(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'google.ads.googleads.v10.enums'), createEmptyInstance: create)
  ...
  'Will be removed in next major version')
  ConversionCustomVariableStatusEnum copyWith(void Function(ConversionCustomVariableStatusEnum) updates) => super.copyWith((message) => updates(message as ConversionCustomVariableStatusEnum)) as ConversionCustomVariableStatusEnum; // ignore: deprecated_member_use

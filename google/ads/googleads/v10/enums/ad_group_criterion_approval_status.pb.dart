...
class AdGroupCriterionApprovalStatusEnum extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'AdGroupCriterionApprovalStatusEnum', package: const $pb.PackageName(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'google.ads.googleads.v10.enums'), createEmptyInstance: create)
  ...
  'Will be removed in next major version')
  AdGroupCriterionApprovalStatusEnum copyWith(void Function(AdGroupCriterionApprovalStatusEnum) updates) => super.copyWith((message) => updates(message as AdGroupCriterionApprovalStatusEnum)) as AdGroupCriterionApprovalStatusEnum; // ignore: deprecated_member_use

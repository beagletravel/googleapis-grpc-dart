...
class MatchingFunctionContextTypeEnum extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'MatchingFunctionContextTypeEnum', package: const $pb.PackageName(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'google.ads.googleads.v10.enums'), createEmptyInstance: create)
  ...
  'Will be removed in next major version')
  MatchingFunctionContextTypeEnum copyWith(void Function(MatchingFunctionContextTypeEnum) updates) => super.copyWith((message) => updates(message as MatchingFunctionContextTypeEnum)) as MatchingFunctionContextTypeEnum; // ignore: deprecated_member_use

...
class UploadConversionAdjustmentsRequest extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'UploadConversionAdjustmentsRequest', package: const $pb.PackageName(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'google.ads.googleads.v7.services'), createEmptyInstance: create)
...
class UploadConversionAdjustmentsResponse extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'UploadConversionAdjustmentsResponse', package: const $pb.PackageName(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'google.ads.googleads.v7.services'), createEmptyInstance: create)
...
class ConversionAdjustment extends $pb.GeneratedMessage {
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'ConversionAdjustment', package: const $pb.PackageName(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'google.ads.googleads.v7.services'), createEmptyInstance: create)
    ..oo(0, [1, 7])
    ...
    ..e<$2.ConversionAdjustmentTypeEnum_ConversionAdjustmentType>(5, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'adjustmentType', $pb.PbFieldType.OE, defaultOrMaker: $2.ConversionAdjustmentTypeEnum_ConversionAdjustmentType.UNSPECIFIED, valueOf: $2.ConversionAdjustmentTypeEnum_ConversionAdjustmentType.valueOf, enumValues: $2.ConversionAdjustmentTypeEnum_ConversionAdjustmentType.values)
  ...
  factory ConversionAdjustment({
    ...
    $2.ConversionAdjustmentTypeEnum_ConversionAdjustmentType? adjustmentType,
  ...
  @$pb.TagNumber(5)
  $2.ConversionAdjustmentTypeEnum_ConversionAdjustmentType get adjustmentType => $_getN(1);
  @$pb.TagNumber(5)
  set adjustmentType($2.ConversionAdjustmentTypeEnum_ConversionAdjustmentType v) { setField(5, v); }
  @$pb.TagNumber(5)
...
class RestatementValue extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'RestatementValue', package: const $pb.PackageName(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'google.ads.googleads.v7.services'), createEmptyInstance: create)
...
class GclidDateTimePair extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'GclidDateTimePair', package: const $pb.PackageName(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'google.ads.googleads.v7.services'), createEmptyInstance: create)
...
class ConversionAdjustmentResult extends $pb.GeneratedMessage {
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'ConversionAdjustmentResult', package: const $pb.PackageName(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'google.ads.googleads.v7.services'), createEmptyInstance: create)
    ..oo(0, [1, 6])
    ..aOM<GclidDateTimePair>(1, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'gclidDateTimePair', subBuilder: GclidDateTimePair.create)
    ..e<$2.ConversionAdjustmentTypeEnum_ConversionAdjustmentType>(5, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'adjustmentType', $pb.PbFieldType.OE, defaultOrMaker: $2.ConversionAdjustmentTypeEnum_ConversionAdjustmentType.UNSPECIFIED, valueOf: $2.ConversionAdjustmentTypeEnum_ConversionAdjustmentType.valueOf, enumValues: $2.ConversionAdjustmentTypeEnum_ConversionAdjustmentType.values)

...
const CreateOfflineUserDataJobRequest$json = const {
  ...
  '2': const [
    ...
    const {'1': 'job', '3': 2, '4': 1, '5': 11, '6': '.google.ads.googleads.v7.resources.OfflineUserDataJob', '8': const {}, '10': 'job'},
...
final $typed_data.Uint8List createOfflineUserDataJobRequestDescriptor = $convert.base64Decode('Ch9DcmVhdGVPZmZsaW5lVXNlckRhdGFKb2JSZXF1ZXN0EiQKC2N1c3RvbWVyX2lkGAEgASgJQgPgQQJSCmN1c3RvbWVySWQSTAoDam9iGAIgASgLMjUuZ29vZ2xlLmFkcy5nb29nbGVhZHMudjcucmVzb3VyY2VzLk9mZmxpbmVVc2VyRGF0YUpvYkID4EECUgNqb2ISIwoNdmFsaWRhdGVfb25seRgDIAEoCFIMdmFsaWRhdGVPbmx5');
...
const AddOfflineUserDataJobOperationsRequest$json = const {
  ...
  '2': const [
    ...
    const {'1': 'operations', '3': 3, '4': 3, '5': 11, '6': '.google.ads.googleads.v7.services.OfflineUserDataJobOperation', '8': const {}, '10': 'operations'},
...
final $typed_data.Uint8List addOfflineUserDataJobOperationsRequestDescriptor = $convert.base64Decode('');
...
const OfflineUserDataJobOperation$json = const {
  ...
  '2': const [
    const {'1': 'create', '3': 1, '4': 1, '5': 11, '6': '.google.ads.googleads.v7.common.UserData', '9': 0, '10': 'create'},
    const {'1': 'remove', '3': 2, '4': 1, '5': 11, '6': '.google.ads.googleads.v7.common.UserData', '9': 0, '10': 'remove'},
...
final $typed_data.Uint8List offlineUserDataJobOperationDescriptor = $convert.base64Decode('');

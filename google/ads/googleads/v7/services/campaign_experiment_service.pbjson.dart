...
const MutateCampaignExperimentsRequest$json = const {
  ...
  '2': const [
    ...
    const {'1': 'operations', '3': 2, '4': 3, '5': 11, '6': '.google.ads.googleads.v7.services.CampaignExperimentOperation', '8': const {}, '10': 'operations'},
    const {'1': 'partial_failure', '3': 3, '4': 1, '5': 8, '10': 'partialFailure'},
    const {'1': 'validate_only', '3': 4, '4': 1, '5': 8, '10': 'validateOnly'},
    const {'1': 'response_content_type', '3': 5, '4': 1, '5': 14, '6': '.google.ads.googleads.v7.enums.ResponseContentTypeEnum.ResponseContentType', '10': 'responseContentType'},
  ],
};

/// Descriptor for `MutateCampaignExperimentsRequest`. Decode as a `google.protobuf.DescriptorProto`.
final $typed_data.Uint8List mutateCampaignExperimentsRequestDescriptor = $convert.base64Decode('');
...
const CampaignExperimentOperation$json = const {
  ...
  '2': const [
    ...
    const {'1': 'update', '3': 1, '4': 1, '5': 11, '6': '.google.ads.googleads.v7.resources.CampaignExperiment', '9': 0, '10': 'update'},
...
final $typed_data.Uint8List campaignExperimentOperationDescriptor = $convert.base64Decode('');
...
const MutateCampaignExperimentsResponse$json = const {
  ...
  '2': const [
    ...
    const {'1': 'results', '3': 2, '4': 3, '5': 11, '6': '.google.ads.googleads.v7.services.MutateCampaignExperimentResult', '10': 'results'},
  ],
};

/// Descriptor for `MutateCampaignExperimentsResponse`. Decode as a `google.protobuf.DescriptorProto`.
final $typed_data.Uint8List mutateCampaignExperimentsResponseDescriptor = $convert.base64Decode('');
...
const MutateCampaignExperimentResult$json = const {
  ...
  '2': const [
    ...
    const {'1': 'campaign_experiment', '3': 2, '4': 1, '5': 11, '6': '.google.ads.googleads.v7.resources.CampaignExperiment', '10': 'campaignExperiment'},
  ],
};

/// Descriptor for `MutateCampaignExperimentResult`. Decode as a `google.protobuf.DescriptorProto`.
final $typed_data.Uint8List mutateCampaignExperimentResultDescriptor = $convert.base64Decode('Ch5NdXRhdGVDYW1wYWlnbkV4cGVyaW1lbnRSZXN1bHQSIwoNcmVzb3VyY2VfbmFtZRgBIAEoCVIMcmVzb3VyY2VOYW1lEmYKE2NhbXBhaWduX2V4cGVyaW1lbnQYAiABKAsyNS5nb29nbGUuYWRzLmdvb2dsZWFkcy52Ny5yZXNvdXJjZXMuQ2FtcGFpZ25FeHBlcmltZW50UhJjYW1wYWlnbkV4cGVyaW1lbnQ=');
...
const CreateCampaignExperimentRequest$json = const {
  ...
  '2': const [
    const {'1': 'customer_id', '3': 1, '4': 1, '5': 9, '8': const {}, '10': 'customerId'},
    const {'1': 'campaign_experiment', '3': 2, '4': 1, '5': 11, '6': '.google.ads.googleads.v7.resources.CampaignExperiment', '8': const {}, '10': 'campaignExperiment'},
...
final $typed_data.Uint8List createCampaignExperimentRequestDescriptor = $convert.base64Decode('');

...
const MutateCampaignDraftsRequest$json = const {
  ...
  '2': const [
    ...
    const {'1': 'operations', '3': 2, '4': 3, '5': 11, '6': '.google.ads.googleads.v7.services.CampaignDraftOperation', '8': const {}, '10': 'operations'},
...
final $typed_data.Uint8List mutateCampaignDraftsRequestDescriptor = $convert.base64Decode('');
...
const CampaignDraftOperation$json = const {
  ...
  '2': const [
    ...
    const {'1': 'create', '3': 1, '4': 1, '5': 11, '6': '.google.ads.googleads.v7.resources.CampaignDraft', '9': 0, '10': 'create'},
    const {'1': 'update', '3': 2, '4': 1, '5': 11, '6': '.google.ads.googleads.v7.resources.CampaignDraft', '9': 0, '10': 'update'},
...
final $typed_data.Uint8List campaignDraftOperationDescriptor = $convert.base64Decode('');
...
const MutateCampaignDraftsResponse$json = const {
  ...
  '2': const [
    ...
    const {'1': 'results', '3': 2, '4': 3, '5': 11, '6': '.google.ads.googleads.v7.services.MutateCampaignDraftResult', '10': 'results'},
  ],
};

/// Descriptor for `MutateCampaignDraftsResponse`. Decode as a `google.protobuf.DescriptorProto`.
final $typed_data.Uint8List mutateCampaignDraftsResponseDescriptor = $convert.base64Decode('ChxNdXRhdGVDYW1wYWlnbkRyYWZ0c1Jlc3BvbnNlEkYKFXBhcnRpYWxfZmFpbHVyZV9lcnJvchgDIAEoCzISLmdvb2dsZS5ycGMuU3RhdHVzUhNwYXJ0aWFsRmFpbHVyZUVycm9yElUKB3Jlc3VsdHMYAiADKAsyOy5nb29nbGUuYWRzLmdvb2dsZWFkcy52Ny5zZXJ2aWNlcy5NdXRhdGVDYW1wYWlnbkRyYWZ0UmVzdWx0UgdyZXN1bHRz');
...
const MutateCampaignDraftResult$json = const {
  ...
  '2': const [
    ...
    const {'1': 'campaign_draft', '3': 2, '4': 1, '5': 11, '6': '.google.ads.googleads.v7.resources.CampaignDraft', '10': 'campaignDraft'},
  ],
};

/// Descriptor for `MutateCampaignDraftResult`. Decode as a `google.protobuf.DescriptorProto`.
final $typed_data.Uint8List mutateCampaignDraftResultDescriptor = $convert.base64Decode('ChlNdXRhdGVDYW1wYWlnbkRyYWZ0UmVzdWx0EiMKDXJlc291cmNlX25hbWUYASABKAlSDHJlc291cmNlTmFtZRJXCg5jYW1wYWlnbl9kcmFmdBgCIAEoCzIwLmdvb2dsZS5hZHMuZ29vZ2xlYWRzLnY3LnJlc291cmNlcy5DYW1wYWlnbkRyYWZ0Ug1jYW1wYWlnbkRyYWZ0');

...
const MutateCampaignBidModifiersRequest$json = const {
  ...
  '2': const [
    ...
    const {'1': 'operations', '3': 2, '4': 3, '5': 11, '6': '.google.ads.googleads.v7.services.CampaignBidModifierOperation', '8': const {}, '10': 'operations'},
...
const CampaignBidModifierOperation$json = const {
  ...
  '2': const [
    ...
    const {'1': 'create', '3': 1, '4': 1, '5': 11, '6': '.google.ads.googleads.v7.resources.CampaignBidModifier', '9': 0, '10': 'create'},
    const {'1': 'update', '3': 2, '4': 1, '5': 11, '6': '.google.ads.googleads.v7.resources.CampaignBidModifier', '9': 0, '10': 'update'},
...
final $typed_data.Uint8List campaignBidModifierOperationDescriptor = $convert.base64Decode('');
...
const MutateCampaignBidModifiersResponse$json = const {
  ...
  '2': const [
    ...
    const {'1': 'results', '3': 2, '4': 3, '5': 11, '6': '.google.ads.googleads.v7.services.MutateCampaignBidModifierResult', '10': 'results'},
  ],
};

/// Descriptor for `MutateCampaignBidModifiersResponse`. Decode as a `google.protobuf.DescriptorProto`.
final $typed_data.Uint8List mutateCampaignBidModifiersResponseDescriptor = $convert.base64Decode('');
...
const MutateCampaignBidModifierResult$json = const {
  ...
  '2': const [
    ...
    const {'1': 'campaign_bid_modifier', '3': 2, '4': 1, '5': 11, '6': '.google.ads.googleads.v7.resources.CampaignBidModifier', '10': 'campaignBidModifier'},
  ],
};

/// Descriptor for `MutateCampaignBidModifierResult`. Decode as a `google.protobuf.DescriptorProto`.
final $typed_data.Uint8List mutateCampaignBidModifierResultDescriptor = $convert.base64Decode('Ch9NdXRhdGVDYW1wYWlnbkJpZE1vZGlmaWVyUmVzdWx0EiMKDXJlc291cmNlX25hbWUYASABKAlSDHJlc291cmNlTmFtZRJqChVjYW1wYWlnbl9iaWRfbW9kaWZpZXIYAiABKAsyNi5nb29nbGUuYWRzLmdvb2dsZWFkcy52Ny5yZXNvdXJjZXMuQ2FtcGFpZ25CaWRNb2RpZmllclITY2FtcGFpZ25CaWRNb2RpZmllcg==');

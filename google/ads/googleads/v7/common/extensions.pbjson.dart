...
const AppFeedItem$json = const {
  ...
  '2': const [
    ...
    const {'1': 'app_store', '3': 3, '4': 1, '5': 14, '6': '.google.ads.googleads.v7.enums.AppStoreEnum.AppStore', '10': 'appStore'},
    ...
    const {'1': 'url_custom_parameters', '3': 7, '4': 3, '5': 11, '6': '.google.ads.googleads.v7.common.CustomParameter', '10': 'urlCustomParameters'},
...
final $typed_data.Uint8List appFeedItemDescriptor = $convert.base64Decode('');
...
const CallFeedItem$json = const {
  ...
  '2': const [
    ...
    const {'1': 'call_conversion_reporting_state', '3': 6, '4': 1, '5': 14, '6': '.google.ads.googleads.v7.enums.CallConversionReportingStateEnum.CallConversionReportingState', '10': 'callConversionReportingState'},
  ],
  '8': const [
...
final $typed_data.Uint8List callFeedItemDescriptor = $convert.base64Decode('');
...
const PriceFeedItem$json = const {
  '1': 'PriceFeedItem',
  '2': const [
    const {'1': 'type', '3': 1, '4': 1, '5': 14, '6': '.google.ads.googleads.v7.enums.PriceExtensionTypeEnum.PriceExtensionType', '10': 'type'},
    const {'1': 'price_qualifier', '3': 2, '4': 1, '5': 14, '6': '.google.ads.googleads.v7.enums.PriceExtensionPriceQualifierEnum.PriceExtensionPriceQualifier', '10': 'priceQualifier'},
    ...
    const {'1': 'price_offerings', '3': 5, '4': 3, '5': 11, '6': '.google.ads.googleads.v7.common.PriceOffer', '10': 'priceOfferings'},
...
final $typed_data.Uint8List priceFeedItemDescriptor = $convert.base64Decode('');
...
const PriceOffer$json = const {
  ...
  '2': const [
    ...
    const {'1': 'price', '3': 3, '4': 1, '5': 11, '6': '.google.ads.googleads.v7.common.Money', '10': 'price'},
    const {'1': 'unit', '3': 4, '4': 1, '5': 14, '6': '.google.ads.googleads.v7.enums.PriceExtensionPriceUnitEnum.PriceExtensionPriceUnit', '10': 'unit'},
...
final $typed_data.Uint8List priceOfferDescriptor = $convert.base64Decode('');
...
const PromotionFeedItem$json = const {
  ...
  '2': const [
    ...
    const {'1': 'discount_modifier', '3': 2, '4': 1, '5': 14, '6': '.google.ads.googleads.v7.enums.PromotionExtensionDiscountModifierEnum.PromotionExtensionDiscountModifier', '10': 'discountModifier'},
    ...
    const {'1': 'occasion', '3': 9, '4': 1, '5': 14, '6': '.google.ads.googleads.v7.enums.PromotionExtensionOccasionEnum.PromotionExtensionOccasion', '10': 'occasion'},
    ...
    const {'1': 'url_custom_parameters', '3': 13, '4': 3, '5': 11, '6': '.google.ads.googleads.v7.common.CustomParameter', '10': 'urlCustomParameters'},
    ...
    const {'1': 'money_amount_off', '3': 4, '4': 1, '5': 11, '6': '.google.ads.googleads.v7.common.Money', '9': 0, '10': 'moneyAmountOff'},
    const {'1': 'promotion_code', '3': 18, '4': 1, '5': 9, '9': 1, '10': 'promotionCode'},
    const {'1': 'orders_over_amount', '3': 6, '4': 1, '5': 11, '6': '.google.ads.googleads.v7.common.Money', '9': 1, '10': 'ordersOverAmount'},
  ],
  '8': const [
...
final $typed_data.Uint8List promotionFeedItemDescriptor = $convert.base64Decode('');
...
final $typed_data.Uint8List sitelinkFeedItemDescriptor = $convert.base64Decode('');

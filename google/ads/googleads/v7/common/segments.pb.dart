...
class Segments extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'Segments', package: const $pb.PackageName(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'google.ads.googleads.v7.common'), createEmptyInstance: create)
...
class Keyword extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'Keyword', package: const $pb.PackageName(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'google.ads.googleads.v7.common'), createEmptyInstance: create)
...
class BudgetCampaignAssociationStatus extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'BudgetCampaignAssociationStatus', package: const $pb.PackageName(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'google.ads.googleads.v7.common'), createEmptyInstance: create)
    ..aOS(1, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'campaign')
    ..e<$22.BudgetCampaignAssociationStatusEnum_BudgetCampaignAssociationStatus>(2, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'status', $pb.PbFieldType.OE, defaultOrMaker: $22.BudgetCampaignAssociationStatusEnum_BudgetCampaignAssociationStatus.UNSPECIFIED, valueOf: $22.BudgetCampaignAssociationStatusEnum_BudgetCampaignAssociationStatus.valueOf, enumValues: $22.BudgetCampaignAssociationStatusEnum_BudgetCampaignAssociationStatus.values)
    ..hasRequiredFields = false
  ;
  ...
  factory BudgetCampaignAssociationStatus({
    ...
    $22.BudgetCampaignAssociationStatusEnum_BudgetCampaignAssociationStatus? status,
  }) {
    final _result = create();
    if (campaign != null) {
  ...
  @$pb.TagNumber(2)
  $22.BudgetCampaignAssociationStatusEnum_BudgetCampaignAssociationStatus get status => $_getN(1);
  @$pb.TagNumber(2)
  set status($22.BudgetCampaignAssociationStatusEnum_BudgetCampaignAssociationStatus v) { setField(2, v); }
  @$pb.TagNumber(2)

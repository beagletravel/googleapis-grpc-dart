...
const ImageAsset$json = const {
  ...
  '2': const [
    ...
    const {'1': 'mime_type', '3': 3, '4': 1, '5': 14, '6': '.google.ads.googleads.v7.enums.MimeTypeEnum.MimeType', '10': 'mimeType'},
    const {'1': 'full_size', '3': 4, '4': 1, '5': 11, '6': '.google.ads.googleads.v7.common.ImageDimension', '10': 'fullSize'},
  ],
  '8': const [
    const {'1': '_data'},
    const {'1': '_file_size'},
...
final $typed_data.Uint8List imageAssetDescriptor = $convert.base64Decode('');
...
const LeadFormAsset$json = const {
  ...
  '2': const [
    ...
    const {'1': 'call_to_action_type', '3': 17, '4': 1, '5': 14, '6': '.google.ads.googleads.v7.enums.LeadFormCallToActionTypeEnum.LeadFormCallToActionType', '8': const {}, '10': 'callToActionType'},
    ...
    const {'1': 'fields', '3': 8, '4': 3, '5': 11, '6': '.google.ads.googleads.v7.common.LeadFormField', '10': 'fields'},
    const {'1': 'delivery_methods', '3': 9, '4': 3, '5': 11, '6': '.google.ads.googleads.v7.common.LeadFormDeliveryMethod', '10': 'deliveryMethods'},
    const {'1': 'post_submit_call_to_action_type', '3': 19, '4': 1, '5': 14, '6': '.google.ads.googleads.v7.enums.LeadFormPostSubmitCallToActionTypeEnum.LeadFormPostSubmitCallToActionType', '10': 'postSubmitCallToActionType'},
    const {'1': 'background_image_asset', '3': 20, '4': 1, '5': 9, '9': 2, '10': 'backgroundImageAsset', '17': true},
    const {'1': 'desired_intent', '3': 21, '4': 1, '5': 14, '6': '.google.ads.googleads.v7.enums.LeadFormDesiredIntentEnum.LeadFormDesiredIntent', '10': 'desiredIntent'},
...
const LeadFormField$json = const {
  '1': 'LeadFormField',
  '2': const [
    const {'1': 'input_type', '3': 1, '4': 1, '5': 14, '6': '.google.ads.googleads.v7.enums.LeadFormFieldUserInputTypeEnum.LeadFormFieldUserInputType', '10': 'inputType'},
    const {'1': 'single_choice_answers', '3': 2, '4': 1, '5': 11, '6': '.google.ads.googleads.v7.common.LeadFormSingleChoiceAnswers', '9': 0, '10': 'singleChoiceAnswers'},
  ],
  '8': const [
    const {'1': 'answers'},
  ],
...
final $typed_data.Uint8List leadFormFieldDescriptor = $convert.base64Decode('');
...
const LeadFormDeliveryMethod$json = const {
  ...
  '2': const [
    const {'1': 'webhook', '3': 1, '4': 1, '5': 11, '6': '.google.ads.googleads.v7.common.WebhookDelivery', '9': 0, '10': 'webhook'},
  ],
  '8': const [
...
final $typed_data.Uint8List leadFormDeliveryMethodDescriptor = $convert.base64Decode('ChZMZWFkRm9ybURlbGl2ZXJ5TWV0aG9kEksKB3dlYmhvb2sYASABKAsyLy5nb29nbGUuYWRzLmdvb2dsZWFkcy52Ny5jb21tb24uV2ViaG9va0RlbGl2ZXJ5SABSB3dlYmhvb2tCEgoQZGVsaXZlcnlfZGV0YWlscw==');
...
const PromotionAsset$json = const {
  ...
  '2': const [
    ...
    const {'1': 'ad_schedule_targets', '3': 13, '4': 3, '5': 11, '6': '.google.ads.googleads.v7.common.AdScheduleInfo', '10': 'adScheduleTargets'},
...
final $typed_data.Uint8List promotionAssetDescriptor = $convert.base64Decode('');
...
const CalloutAsset$json = const {
  ...
  '2': const [
    ...
    const {'1': 'ad_schedule_targets', '3': 4, '4': 3, '5': 11, '6': '.google.ads.googleads.v7.common.AdScheduleInfo', '10': 'adScheduleTargets'},
  ],
};

/// Descriptor for `CalloutAsset`. Decode as a `google.protobuf.DescriptorProto`.
final $typed_data.Uint8List calloutAssetDescriptor = $convert.base64Decode('');
...
const SitelinkAsset$json = const {
  ...
  '2': const [
    ...
    const {'1': 'ad_schedule_targets', '3': 6, '4': 3, '5': 11, '6': '.google.ads.googleads.v7.common.AdScheduleInfo', '10': 'adScheduleTargets'},
  ],
};

/// Descriptor for `SitelinkAsset`. Decode as a `google.protobuf.DescriptorProto`.
final $typed_data.Uint8List sitelinkAssetDescriptor = $convert.base64Decode('');

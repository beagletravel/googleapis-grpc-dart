...
class UserListClosingReasonEnum_UserListClosingReason extends $pb.ProtobufEnum {
  static const UserListClosingReasonEnum_UserListClosingReason UNSPECIFIED = UserListClosingReasonEnum_UserListClosingReason._(0, const $core.bool.fromEnvironment('protobuf.omit_enum_names') ? '' : 'UNSPECIFIED');
  static const UserListClosingReasonEnum_UserListClosingReason UNKNOWN = UserListClosingReasonEnum_UserListClosingReason._(1, const $core.bool.fromEnvironment('protobuf.omit_enum_names') ? '' : 'UNKNOWN');
  static const UserListClosingReasonEnum_UserListClosingReason UNUSED = UserListClosingReasonEnum_UserListClosingReason._(2, const $core.bool.fromEnvironment('protobuf.omit_enum_names') ? '' : 'UNUSED');

...
class ChangeEventResourceTypeEnum extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'ChangeEventResourceTypeEnum', package: const $pb.PackageName(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'google.ads.googleads.v7.enums'), createEmptyInstance: create)
  ...
  'Will be removed in next major version')
  ChangeEventResourceTypeEnum copyWith(void Function(ChangeEventResourceTypeEnum) updates) => super.copyWith((message) => updates(message as ChangeEventResourceTypeEnum)) as ChangeEventResourceTypeEnum; // ignore: deprecated_member_use

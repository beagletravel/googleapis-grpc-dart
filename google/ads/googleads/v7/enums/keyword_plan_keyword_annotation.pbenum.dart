...
class KeywordPlanKeywordAnnotationEnum_KeywordPlanKeywordAnnotation extends $pb.ProtobufEnum {
  static const KeywordPlanKeywordAnnotationEnum_KeywordPlanKeywordAnnotation UNSPECIFIED = KeywordPlanKeywordAnnotationEnum_KeywordPlanKeywordAnnotation._(0, const $core.bool.fromEnvironment('protobuf.omit_enum_names') ? '' : 'UNSPECIFIED');
  static const KeywordPlanKeywordAnnotationEnum_KeywordPlanKeywordAnnotation UNKNOWN = KeywordPlanKeywordAnnotationEnum_KeywordPlanKeywordAnnotation._(1, const $core.bool.fromEnvironment('protobuf.omit_enum_names') ? '' : 'UNKNOWN');
  static const KeywordPlanKeywordAnnotationEnum_KeywordPlanKeywordAnnotation KEYWORD_CONCEPT = KeywordPlanKeywordAnnotationEnum_KeywordPlanKeywordAnnotation._(2, const $core.bool.fromEnvironment('protobuf.omit_enum_names') ? '' : 'KEYWORD_CONCEPT');

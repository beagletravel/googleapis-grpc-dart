...
class HotelRateTypeEnum extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'HotelRateTypeEnum', package: const $pb.PackageName(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'google.ads.googleads.v7.enums'), createEmptyInstance: create)
  ...
  'Will be removed in next major version')
  HotelRateTypeEnum copyWith(void Function(HotelRateTypeEnum) updates) => super.copyWith((message) => updates(message as HotelRateTypeEnum)) as HotelRateTypeEnum; // ignore: deprecated_member_use

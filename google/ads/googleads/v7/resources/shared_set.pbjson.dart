...
const SharedSet$json = const {
  ...
  '2': const [
    ...
    const {'1': 'type', '3': 3, '4': 1, '5': 14, '6': '.google.ads.googleads.v7.enums.SharedSetTypeEnum.SharedSetType', '8': const {}, '10': 'type'},
    const {'1': 'name', '3': 9, '4': 1, '5': 9, '9': 1, '10': 'name', '17': true},
    const {'1': 'status', '3': 5, '4': 1, '5': 14, '6': '.google.ads.googleads.v7.enums.SharedSetStatusEnum.SharedSetStatus', '8': const {}, '10': 'status'},
...
final $typed_data.Uint8List sharedSetDescriptor = $convert.base64Decode('');

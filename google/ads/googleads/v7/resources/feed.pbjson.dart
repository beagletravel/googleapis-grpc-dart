...
const Feed$json = const {
  ...
  '2': const [
    ...
    const {'1': 'attributes', '3': 4, '4': 3, '5': 11, '6': '.google.ads.googleads.v7.resources.FeedAttribute', '10': 'attributes'},
    const {'1': 'attribute_operations', '3': 9, '4': 3, '5': 11, '6': '.google.ads.googleads.v7.resources.FeedAttributeOperation', '10': 'attributeOperations'},
    const {'1': 'origin', '3': 5, '4': 1, '5': 14, '6': '.google.ads.googleads.v7.enums.FeedOriginEnum.FeedOrigin', '8': const {}, '10': 'origin'},
    const {'1': 'status', '3': 8, '4': 1, '5': 14, '6': '.google.ads.googleads.v7.enums.FeedStatusEnum.FeedStatus', '8': const {}, '10': 'status'},
    const {'1': 'places_location_feed_data', '3': 6, '4': 1, '5': 11, '6': '.google.ads.googleads.v7.resources.Feed.PlacesLocationFeedData', '9': 0, '10': 'placesLocationFeedData'},
    const {'1': 'affiliate_location_feed_data', '3': 7, '4': 1, '5': 11, '6': '.google.ads.googleads.v7.resources.Feed.AffiliateLocationFeedData', '9': 0, '10': 'affiliateLocationFeedData'},
  ],
...
const Feed_PlacesLocationFeedData$json = const {
  ...
  '2': const [
    const {'1': 'oauth_info', '3': 1, '4': 1, '5': 11, '6': '.google.ads.googleads.v7.resources.Feed.PlacesLocationFeedData.OAuthInfo', '8': const {}, '10': 'oauthInfo'},
...
const Feed_AffiliateLocationFeedData$json = const {
  ...
  '2': const [
    ...
    const {'1': 'relationship_type', '3': 2, '4': 1, '5': 14, '6': '.google.ads.googleads.v7.enums.AffiliateLocationFeedRelationshipTypeEnum.AffiliateLocationFeedRelationshipType', '10': 'relationshipType'},
  ],
};
...
const FeedAttribute$json = const {
  ...
  '2': const [
    ...
    const {'1': 'type', '3': 3, '4': 1, '5': 14, '6': '.google.ads.googleads.v7.enums.FeedAttributeTypeEnum.FeedAttributeType', '10': 'type'},
...
final $typed_data.Uint8List feedAttributeDescriptor = $convert.base64Decode('');
...
const FeedAttributeOperation$json = const {
  ...
  '2': const [
    const {'1': 'operator', '3': 1, '4': 1, '5': 14, '6': '.google.ads.googleads.v7.resources.FeedAttributeOperation.Operator', '8': const {}, '10': 'operator'},
    const {'1': 'value', '3': 2, '4': 1, '5': 11, '6': '.google.ads.googleads.v7.resources.FeedAttribute', '8': const {}, '10': 'value'},
  ],
...
final $typed_data.Uint8List feedAttributeOperationDescriptor = $convert.base64Decode('');

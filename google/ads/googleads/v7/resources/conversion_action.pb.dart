...
class ConversionAction_AttributionModelSettings extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'ConversionAction.AttributionModelSettings', package: const $pb.PackageName(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'google.ads.googleads.v7.resources'), createEmptyInstance: create)
    ..e<$6.AttributionModelEnum_AttributionModel>(1, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'attributionModel', $pb.PbFieldType.OE, defaultOrMaker: $6.AttributionModelEnum_AttributionModel.UNSPECIFIED, valueOf: $6.AttributionModelEnum_AttributionModel.valueOf, enumValues: $6.AttributionModelEnum_AttributionModel.values)
    ..e<$7.DataDrivenModelStatusEnum_DataDrivenModelStatus>(2, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'dataDrivenModelStatus', $pb.PbFieldType.OE, defaultOrMaker: $7.DataDrivenModelStatusEnum_DataDrivenModelStatus.UNSPECIFIED, valueOf: $7.DataDrivenModelStatusEnum_DataDrivenModelStatus.valueOf, enumValues: $7.DataDrivenModelStatusEnum_DataDrivenModelStatus.values)
  ...
  @$pb.TagNumber(1)
  set attributionModel($6.AttributionModelEnum_AttributionModel v) { setField(1, v); }
  @$pb.TagNumber(1)
  ...
  @$pb.TagNumber(2)
  $7.DataDrivenModelStatusEnum_DataDrivenModelStatus get dataDrivenModelStatus => $_getN(1);
  @$pb.TagNumber(2)
  set dataDrivenModelStatus($7.DataDrivenModelStatusEnum_DataDrivenModelStatus v) { setField(2, v); }
  @$pb.TagNumber(2)
...
class ConversionAction_ValueSettings extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'ConversionAction.ValueSettings', package: const $pb.PackageName(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'google.ads.googleads.v7.resources'), createEmptyInstance: create)
...
class ConversionAction_FirebaseSettings extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'ConversionAction.FirebaseSettings', package: const $pb.PackageName(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'google.ads.googleads.v7.resources'), createEmptyInstance: create)
...
class ConversionAction extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'ConversionAction', package: const $pb.PackageName(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'google.ads.googleads.v7.resources'), createEmptyInstance: create)

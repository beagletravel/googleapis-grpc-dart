...
const Customer$json = const {
  ...
  '2': const [
    ...
    const {'1': 'call_reporting_setting', '3': 10, '4': 1, '5': 11, '6': '.google.ads.googleads.v7.resources.CallReportingSetting', '10': 'callReportingSetting'},
    const {'1': 'conversion_tracking_setting', '3': 14, '4': 1, '5': 11, '6': '.google.ads.googleads.v7.resources.ConversionTrackingSetting', '8': const {}, '10': 'conversionTrackingSetting'},
    const {'1': 'remarketing_setting', '3': 15, '4': 1, '5': 11, '6': '.google.ads.googleads.v7.resources.RemarketingSetting', '8': const {}, '10': 'remarketingSetting'},
    const {'1': 'pay_per_conversion_eligibility_failure_reasons', '3': 16, '4': 3, '5': 14, '6': '.google.ads.googleads.v7.enums.CustomerPayPerConversionEligibilityFailureReasonEnum.CustomerPayPerConversionEligibilityFailureReason', '8': const {}, '10': 'payPerConversionEligibilityFailureReasons'},
...
final $typed_data.Uint8List conversionTrackingSettingDescriptor = $convert.base64Decode('');

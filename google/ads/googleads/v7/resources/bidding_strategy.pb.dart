...
class BiddingStrategy extends $pb.GeneratedMessage {
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'BiddingStrategy', package: const $pb.PackageName(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'google.ads.googleads.v7.resources'), createEmptyInstance: create)
    ..oo(0, [7, 9, 11, 12, 21, 22, 48])
    ..aOS(1, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'resourceName')
    ..e<$1.BiddingStrategyTypeEnum_BiddingStrategyType>(5, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'type', $pb.PbFieldType.OE, defaultOrMaker: $1.BiddingStrategyTypeEnum_BiddingStrategyType.UNSPECIFIED, valueOf: $1.BiddingStrategyTypeEnum_BiddingStrategyType.valueOf, enumValues: $1.BiddingStrategyTypeEnum_BiddingStrategyType.values)
    ..aOM<$0.EnhancedCpc>(7, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'enhancedCpc', subBuilder: $0.EnhancedCpc.create)
    ..aOM<$0.TargetCpa>(9, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'targetCpa', subBuilder: $0.TargetCpa.create)
    ..aOM<$0.TargetRoas>(11, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'targetRoas', subBuilder: $0.TargetRoas.create)
    ..aOM<$0.TargetSpend>(12, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'targetSpend', subBuilder: $0.TargetSpend.create)
    ..e<$2.BiddingStrategyStatusEnum_BiddingStrategyStatus>(15, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'status', $pb.PbFieldType.OE, defaultOrMaker: $2.BiddingStrategyStatusEnum_BiddingStrategyStatus.UNSPECIFIED, valueOf: $2.BiddingStrategyStatusEnum_BiddingStrategyStatus.valueOf, enumValues: $2.BiddingStrategyStatusEnum_BiddingStrategyStatus.values)
    ..aInt64(16, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'id')
    ..aOS(17, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'name')
    ..aInt64(18, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'campaignCount')
    ..aInt64(19, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'nonRemovedCampaignCount')
    ..aOS(20, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'effectiveCurrencyCode')
    ..aOM<$0.MaximizeConversionValue>(21, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'maximizeConversionValue', subBuilder: $0.MaximizeConversionValue.create)
    ..aOM<$0.MaximizeConversions>(22, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'maximizeConversions', subBuilder: $0.MaximizeConversions.create)
    ..aOM<$0.TargetImpressionShare>(48, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'targetImpressionShare', subBuilder: $0.TargetImpressionShare.create)
  ...
  'Will be removed in next major version')
  BiddingStrategy copyWith(void Function(BiddingStrategy) updates) => super.copyWith((message) => updates(message as BiddingStrategy)) as BiddingStrategy; // ignore: deprecated_member_use
  ...
  @$pb.TagNumber(5)
  set type($1.BiddingStrategyTypeEnum_BiddingStrategyType v) { setField(5, v); }
  @$pb.TagNumber(5)
  ...
  @$pb.TagNumber(7)
  set enhancedCpc($0.EnhancedCpc v) { setField(7, v); }
  @$pb.TagNumber(7)
  ...
  @$pb.TagNumber(9)
  set targetCpa($0.TargetCpa v) { setField(9, v); }
  @$pb.TagNumber(9)
  ...
  @$pb.TagNumber(11)
  set targetRoas($0.TargetRoas v) { setField(11, v); }
  @$pb.TagNumber(11)
  ...
  @$pb.TagNumber(12)
  set targetSpend($0.TargetSpend v) { setField(12, v); }
  @$pb.TagNumber(12)
  ...
  @$pb.TagNumber(15)
  set status($2.BiddingStrategyStatusEnum_BiddingStrategyStatus v) { setField(15, v); }
  @$pb.TagNumber(15)
  ...
  @$pb.TagNumber(21)
  set maximizeConversionValue($0.MaximizeConversionValue v) { setField(21, v); }
  @$pb.TagNumber(21)
  ...
  @$pb.TagNumber(22)
  set maximizeConversions($0.MaximizeConversions v) { setField(22, v); }
  @$pb.TagNumber(22)
  ...
  @$pb.TagNumber(48)
  $0.TargetImpressionShare get targetImpressionShare => $_getN(14);
  @$pb.TagNumber(48)
  set targetImpressionShare($0.TargetImpressionShare v) { setField(48, v); }
  @$pb.TagNumber(48)
  $core.bool hasTargetImpressionShare() => $_has(14);
  @$pb.TagNumber(48)
  void clearTargetImpressionShare() => clearField(48);
  @$pb.TagNumber(48)
  $0.TargetImpressionShare ensureTargetImpressionShare() => $_ensure(14);
}

...
const ClickView$json = const {
  ...
  '2': const [
    ...
    const {'1': 'area_of_interest', '3': 3, '4': 1, '5': 11, '6': '.google.ads.googleads.v7.common.ClickLocation', '8': const {}, '10': 'areaOfInterest'},
    const {'1': 'location_of_presence', '3': 4, '4': 1, '5': 11, '6': '.google.ads.googleads.v7.common.ClickLocation', '8': const {}, '10': 'locationOfPresence'},
    ...
    const {'1': 'keyword_info', '3': 14, '4': 1, '5': 11, '6': '.google.ads.googleads.v7.common.KeywordInfo', '8': const {}, '10': 'keywordInfo'},
  ],
  '7': const {},
  '8': const [
    const {'1': '_gclid'},
...
final $typed_data.Uint8List clickViewDescriptor = $convert.base64Decode('');

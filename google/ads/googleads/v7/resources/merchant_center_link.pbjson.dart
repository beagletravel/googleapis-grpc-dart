...
const MerchantCenterLink$json = const {
  ...
  '2': const [
    ...
    const {'1': 'status', '3': 5, '4': 1, '5': 14, '6': '.google.ads.googleads.v7.enums.MerchantCenterLinkStatusEnum.MerchantCenterLinkStatus', '10': 'status'},
  ],
  '7': const {},
  '8': const [
    const {'1': '_id'},
...
final $typed_data.Uint8List merchantCenterLinkDescriptor = $convert.base64Decode('');

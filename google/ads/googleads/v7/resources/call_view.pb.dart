...
class CallView extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'CallView', package: const $pb.PackageName(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'google.ads.googleads.v7.resources'), createEmptyInstance: create)
    ..aOS(1, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'resourceName')
    ..aOS(2, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'callerRegionCode')
    ..aOS(3, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'callerAreaCode')
    ..aInt64(4, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'callDurationSeconds')
    ..aOS(5, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'startCallDateTime')
    ..aOS(6, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'endCallDateTime')
    ..e<$0.CallTrackingDisplayLocationEnum_CallTrackingDisplayLocation>(7, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'callTrackingDisplayLocation', $pb.PbFieldType.OE, defaultOrMaker: $0.CallTrackingDisplayLocationEnum_CallTrackingDisplayLocation.UNSPECIFIED, valueOf: $0.CallTrackingDisplayLocationEnum_CallTrackingDisplayLocation.valueOf, enumValues: $0.CallTrackingDisplayLocationEnum_CallTrackingDisplayLocation.values)
    ..e<$1.CallTypeEnum_CallType>(8, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'type', $pb.PbFieldType.OE, defaultOrMaker: $1.CallTypeEnum_CallType.UNSPECIFIED, valueOf: $1.CallTypeEnum_CallType.valueOf, enumValues: $1.CallTypeEnum_CallType.values)
    ..e<$2.GoogleVoiceCallStatusEnum_GoogleVoiceCallStatus>(9, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'callStatus', $pb.PbFieldType.OE, defaultOrMaker: $2.GoogleVoiceCallStatusEnum_GoogleVoiceCallStatus.UNSPECIFIED, valueOf: $2.GoogleVoiceCallStatusEnum_GoogleVoiceCallStatus.valueOf, enumValues: $2.GoogleVoiceCallStatusEnum_GoogleVoiceCallStatus.values)
  ...
  factory CallView({
    ...
    $core.String? callerRegionCode,
    $core.String? callerAreaCode,
    $fixnum.Int64? callDurationSeconds,
    $core.String? startCallDateTime,
    $core.String? endCallDateTime,
    $0.CallTrackingDisplayLocationEnum_CallTrackingDisplayLocation? callTrackingDisplayLocation,
    ...
    if (callerRegionCode != null) {
      _result.callerRegionCode = callerRegionCode;
    }
  ...
  'Will be removed in next major version')
  CallView copyWith(void Function(CallView) updates) => super.copyWith((message) => updates(message as CallView)) as CallView; // ignore: deprecated_member_use
  ...
  @$pb.TagNumber(2)
  $core.String get callerRegionCode => $_getSZ(1);
  @$pb.TagNumber(2)
  set callerRegionCode($core.String v) { $_setString(1, v); }
  @$pb.TagNumber(2)
  $core.bool hasCallerRegionCode() => $_has(1);
  @$pb.TagNumber(2)
  void clearCallerRegionCode() => clearField(2);
  ...
  @$pb.TagNumber(7)
  $0.CallTrackingDisplayLocationEnum_CallTrackingDisplayLocation get callTrackingDisplayLocation => $_getN(6);
  @$pb.TagNumber(7)
  set callTrackingDisplayLocation($0.CallTrackingDisplayLocationEnum_CallTrackingDisplayLocation v) { setField(7, v); }
  @$pb.TagNumber(7)
  ...
  @$pb.TagNumber(8)
  set type($1.CallTypeEnum_CallType v) { setField(8, v); }
  @$pb.TagNumber(8)
  ...
  @$pb.TagNumber(9)
  $2.GoogleVoiceCallStatusEnum_GoogleVoiceCallStatus get callStatus => $_getN(8);
  @$pb.TagNumber(9)
  set callStatus($2.GoogleVoiceCallStatusEnum_GoogleVoiceCallStatus v) { setField(9, v); }
  @$pb.TagNumber(9)

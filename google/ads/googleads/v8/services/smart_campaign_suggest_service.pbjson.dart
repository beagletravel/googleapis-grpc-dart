...
const SuggestSmartCampaignBudgetOptionsRequest$json = const {
  ...
  '2': const [
    ...
    const {'1': 'suggestion_info', '3': 3, '4': 1, '5': 11, '6': '.google.ads.googleads.v8.services.SmartCampaignSuggestionInfo', '8': const {}, '9': 0, '10': 'suggestionInfo'},
  ],
  '8': const [
...
final $typed_data.Uint8List suggestSmartCampaignBudgetOptionsRequestDescriptor = $convert.base64Decode('');
...
const SmartCampaignSuggestionInfo$json = const {
  ...
  '2': const [
    ...
    const {'1': 'ad_schedules', '3': 6, '4': 3, '5': 11, '6': '.google.ads.googleads.v8.common.AdScheduleInfo', '8': const {}, '10': 'adSchedules'},
    const {'1': 'keyword_themes', '3': 7, '4': 3, '5': 11, '6': '.google.ads.googleads.v8.common.KeywordThemeInfo', '8': const {}, '10': 'keywordThemes'},
    const {'1': 'business_context', '3': 8, '4': 1, '5': 11, '6': '.google.ads.googleads.v8.services.SmartCampaignSuggestionInfo.BusinessContext', '8': const {}, '9': 0, '10': 'businessContext'},
    const {'1': 'business_location_id', '3': 2, '4': 1, '5': 3, '8': const {}, '9': 0, '10': 'businessLocationId'},
    const {'1': 'location_list', '3': 4, '4': 1, '5': 11, '6': '.google.ads.googleads.v8.services.SmartCampaignSuggestionInfo.LocationList', '8': const {}, '9': 1, '10': 'locationList'},
    const {'1': 'proximity', '3': 5, '4': 1, '5': 11, '6': '.google.ads.googleads.v8.common.ProximityInfo', '8': const {}, '9': 1, '10': 'proximity'},
  ],
...
const SmartCampaignSuggestionInfo_LocationList$json = const {
  '1': 'LocationList',
  '2': const [
    const {'1': 'locations', '3': 1, '4': 3, '5': 11, '6': '.google.ads.googleads.v8.common.LocationInfo', '8': const {}, '10': 'locations'},
  ],
};
...
const SuggestSmartCampaignBudgetOptionsResponse$json = const {
  ...
  '2': const [
    const {'1': 'low', '3': 1, '4': 1, '5': 11, '6': '.google.ads.googleads.v8.services.SuggestSmartCampaignBudgetOptionsResponse.BudgetOption', '8': const {}, '9': 0, '10': 'low', '17': true},
    const {'1': 'recommended', '3': 2, '4': 1, '5': 11, '6': '.google.ads.googleads.v8.services.SuggestSmartCampaignBudgetOptionsResponse.BudgetOption', '8': const {}, '9': 1, '10': 'recommended', '17': true},
    const {'1': 'high', '3': 3, '4': 1, '5': 11, '6': '.google.ads.googleads.v8.services.SuggestSmartCampaignBudgetOptionsResponse.BudgetOption', '8': const {}, '9': 2, '10': 'high', '17': true},
  ],
...
const SuggestSmartCampaignAdRequest$json = const {
  ...
  '2': const [
    const {'1': 'customer_id', '3': 1, '4': 1, '5': 9, '8': const {}, '10': 'customerId'},
    const {'1': 'suggestion_info', '3': 2, '4': 1, '5': 11, '6': '.google.ads.googleads.v8.services.SmartCampaignSuggestionInfo', '8': const {}, '10': 'suggestionInfo'},
  ],
};

/// Descriptor for `SuggestSmartCampaignAdRequest`. Decode as a `google.protobuf.DescriptorProto`.
final $typed_data.Uint8List suggestSmartCampaignAdRequestDescriptor = $convert.base64Decode('Ch1TdWdnZXN0U21hcnRDYW1wYWlnbkFkUmVxdWVzdBIkCgtjdXN0b21lcl9pZBgBIAEoCUID4EECUgpjdXN0b21lcklkEmsKD3N1Z2dlc3Rpb25faW5mbxgCIAEoCzI9Lmdvb2dsZS5hZHMuZ29vZ2xlYWRzLnY4LnNlcnZpY2VzLlNtYXJ0Q2FtcGFpZ25TdWdnZXN0aW9uSW5mb0ID4EECUg5zdWdnZXN0aW9uSW5mbw==');
...
const SuggestSmartCampaignAdResponse$json = const {
  ...
  '2': const [
    const {'1': 'ad_info', '3': 1, '4': 1, '5': 11, '6': '.google.ads.googleads.v8.common.SmartCampaignAdInfo', '8': const {}, '10': 'adInfo'},
  ],
};

/// Descriptor for `SuggestSmartCampaignAdResponse`. Decode as a `google.protobuf.DescriptorProto`.
final $typed_data.Uint8List suggestSmartCampaignAdResponseDescriptor = $convert.base64Decode('Ch5TdWdnZXN0U21hcnRDYW1wYWlnbkFkUmVzcG9uc2USUQoHYWRfaW5mbxgBIAEoCzIzLmdvb2dsZS5hZHMuZ29vZ2xlYWRzLnY4LmNvbW1vbi5TbWFydENhbXBhaWduQWRJbmZvQgPgQQFSBmFkSW5mbw==');

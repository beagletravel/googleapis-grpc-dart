...
class GetConversionValueRuleSetRequest extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'GetConversionValueRuleSetRequest', package: const $pb.PackageName(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'google.ads.googleads.v8.services'), createEmptyInstance: create)
  ...
  factory GetConversionValueRuleSetRequest.fromBuffer($core.List<$core.int> i, [$pb.ExtensionRegistry r = $pb.ExtensionRegistry.EMPTY]) => create()..mergeFromBuffer(i, r);
  factory GetConversionValueRuleSetRequest.fromJson($core.String i, [$pb.ExtensionRegistry r = $pb.ExtensionRegistry.EMPTY]) => create()..mergeFromJson(i, r);
  @$core.Deprecated(
  'Using this can add significant overhead to your binary. '
  'Use [GeneratedMessageGenericExtensions.deepCopy] instead. '
  'Will be removed in next major version')
  GetConversionValueRuleSetRequest clone() => GetConversionValueRuleSetRequest()..mergeFromMessage(this);
  @$core.Deprecated(
  'Using this can add significant overhead to your binary. '
  'Use [GeneratedMessageGenericExtensions.rebuild] instead. '
  'Will be removed in next major version')
  GetConversionValueRuleSetRequest copyWith(void Function(GetConversionValueRuleSetRequest) updates) => super.copyWith((message) => updates(message as GetConversionValueRuleSetRequest)) as GetConversionValueRuleSetRequest; // ignore: deprecated_member_use
  $pb.BuilderInfo get info_ => _i;
  @$core.pragma('dart2js:noInline')
  static GetConversionValueRuleSetRequest create() => GetConversionValueRuleSetRequest._();
  GetConversionValueRuleSetRequest createEmptyInstance() => create();
  static $pb.PbList<GetConversionValueRuleSetRequest> createRepeated() => $pb.PbList<GetConversionValueRuleSetRequest>();
  @$core.pragma('dart2js:noInline')
  static GetConversionValueRuleSetRequest getDefault() => _defaultInstance ??= $pb.GeneratedMessage.$_defaultFor<GetConversionValueRuleSetRequest>(create);
...
class MutateConversionValueRuleSetsRequest extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'MutateConversionValueRuleSetsRequest', package: const $pb.PackageName(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'google.ads.googleads.v8.services'), createEmptyInstance: create)
    ..aOS(1, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'customerId')
    ..pc<ConversionValueRuleSetOperation>(2, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'operations', $pb.PbFieldType.PM, subBuilder: ConversionValueRuleSetOperation.create)
  ...
  'Use [GeneratedMessageGenericExtensions.rebuild] instead. '
  'Will be removed in next major version')
  MutateConversionValueRuleSetsRequest copyWith(void Function(MutateConversionValueRuleSetsRequest) updates) => super.copyWith((message) => updates(message as MutateConversionValueRuleSetsRequest)) as MutateConversionValueRuleSetsRequest; // ignore: deprecated_member_use
  $pb.BuilderInfo get info_ => _i;
  @$core.pragma('dart2js:noInline')
  ...
  @$pb.TagNumber(4)
  $4.ResponseContentTypeEnum_ResponseContentType get responseContentType => $_getN(3);
  @$pb.TagNumber(4)
  set responseContentType($4.ResponseContentTypeEnum_ResponseContentType v) { setField(4, v); }
  @$pb.TagNumber(4)
...
class ConversionValueRuleSetOperation extends $pb.GeneratedMessage {
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'ConversionValueRuleSetOperation', package: const $pb.PackageName(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'google.ads.googleads.v8.services'), createEmptyInstance: create)
    ..oo(0, [1, 2, 3])
    ..aOM<$1.ConversionValueRuleSet>(1, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'create', subBuilder: $1.ConversionValueRuleSet.create)
    ..aOM<$1.ConversionValueRuleSet>(2, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'update', subBuilder: $1.ConversionValueRuleSet.create)
  ...
  'Use [GeneratedMessageGenericExtensions.rebuild] instead. '
  'Will be removed in next major version')
  ConversionValueRuleSetOperation copyWith(void Function(ConversionValueRuleSetOperation) updates) => super.copyWith((message) => updates(message as ConversionValueRuleSetOperation)) as ConversionValueRuleSetOperation; // ignore: deprecated_member_use
  $pb.BuilderInfo get info_ => _i;
  @$core.pragma('dart2js:noInline')
  ...
  @$pb.TagNumber(1)
  set create_1($1.ConversionValueRuleSet v) { setField(1, v); }
  @$pb.TagNumber(1)
  ...
  @$pb.TagNumber(2)
  set update($1.ConversionValueRuleSet v) { setField(2, v); }
  @$pb.TagNumber(2)
...
class MutateConversionValueRuleSetsResponse extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'MutateConversionValueRuleSetsResponse', package: const $pb.PackageName(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'google.ads.googleads.v8.services'), createEmptyInstance: create)
    ..pc<MutateConversionValueRuleSetResult>(1, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'results', $pb.PbFieldType.PM, subBuilder: MutateConversionValueRuleSetResult.create)
  ...
  'Use [GeneratedMessageGenericExtensions.rebuild] instead. '
  'Will be removed in next major version')
  MutateConversionValueRuleSetsResponse copyWith(void Function(MutateConversionValueRuleSetsResponse) updates) => super.copyWith((message) => updates(message as MutateConversionValueRuleSetsResponse)) as MutateConversionValueRuleSetsResponse; // ignore: deprecated_member_use
  $pb.BuilderInfo get info_ => _i;
  @$core.pragma('dart2js:noInline')
...
class MutateConversionValueRuleSetResult extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'MutateConversionValueRuleSetResult', package: const $pb.PackageName(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'google.ads.googleads.v8.services'), createEmptyInstance: create)
    ..aOS(1, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'resourceName')
    ..aOM<$1.ConversionValueRuleSet>(2, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'conversionValueRuleSet', subBuilder: $1.ConversionValueRuleSet.create)
    ..hasRequiredFields = false
  ;
  ...
  'Use [GeneratedMessageGenericExtensions.rebuild] instead. '
  'Will be removed in next major version')
  MutateConversionValueRuleSetResult copyWith(void Function(MutateConversionValueRuleSetResult) updates) => super.copyWith((message) => updates(message as MutateConversionValueRuleSetResult)) as MutateConversionValueRuleSetResult; // ignore: deprecated_member_use
  $pb.BuilderInfo get info_ => _i;
  @$core.pragma('dart2js:noInline')
  ...
  @$pb.TagNumber(2)
  set conversionValueRuleSet($1.ConversionValueRuleSet v) { setField(2, v); }
  @$pb.TagNumber(2)

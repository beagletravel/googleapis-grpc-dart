...
class GetBiddingDataExclusionRequest extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'GetBiddingDataExclusionRequest', package: const $pb.PackageName(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'google.ads.googleads.v8.services'), createEmptyInstance: create)
  ...
  factory GetBiddingDataExclusionRequest.fromBuffer($core.List<$core.int> i, [$pb.ExtensionRegistry r = $pb.ExtensionRegistry.EMPTY]) => create()..mergeFromBuffer(i, r);
  factory GetBiddingDataExclusionRequest.fromJson($core.String i, [$pb.ExtensionRegistry r = $pb.ExtensionRegistry.EMPTY]) => create()..mergeFromJson(i, r);
  @$core.Deprecated(
  'Using this can add significant overhead to your binary. '
  'Use [GeneratedMessageGenericExtensions.deepCopy] instead. '
  'Will be removed in next major version')
  GetBiddingDataExclusionRequest clone() => GetBiddingDataExclusionRequest()..mergeFromMessage(this);
  @$core.Deprecated(
  'Using this can add significant overhead to your binary. '
  'Use [GeneratedMessageGenericExtensions.rebuild] instead. '
  'Will be removed in next major version')
  GetBiddingDataExclusionRequest copyWith(void Function(GetBiddingDataExclusionRequest) updates) => super.copyWith((message) => updates(message as GetBiddingDataExclusionRequest)) as GetBiddingDataExclusionRequest; // ignore: deprecated_member_use
  $pb.BuilderInfo get info_ => _i;
  @$core.pragma('dart2js:noInline')
  static GetBiddingDataExclusionRequest create() => GetBiddingDataExclusionRequest._();
  GetBiddingDataExclusionRequest createEmptyInstance() => create();
  static $pb.PbList<GetBiddingDataExclusionRequest> createRepeated() => $pb.PbList<GetBiddingDataExclusionRequest>();
  @$core.pragma('dart2js:noInline')
  static GetBiddingDataExclusionRequest getDefault() => _defaultInstance ??= $pb.GeneratedMessage.$_defaultFor<GetBiddingDataExclusionRequest>(create);
...
class MutateBiddingDataExclusionsRequest extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'MutateBiddingDataExclusionsRequest', package: const $pb.PackageName(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'google.ads.googleads.v8.services'), createEmptyInstance: create)
    ..aOS(1, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'customerId')
    ..pc<BiddingDataExclusionOperation>(2, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'operations', $pb.PbFieldType.PM, subBuilder: BiddingDataExclusionOperation.create)
  ...
  'Use [GeneratedMessageGenericExtensions.rebuild] instead. '
  'Will be removed in next major version')
  MutateBiddingDataExclusionsRequest copyWith(void Function(MutateBiddingDataExclusionsRequest) updates) => super.copyWith((message) => updates(message as MutateBiddingDataExclusionsRequest)) as MutateBiddingDataExclusionsRequest; // ignore: deprecated_member_use
  $pb.BuilderInfo get info_ => _i;
  @$core.pragma('dart2js:noInline')
...
class BiddingDataExclusionOperation extends $pb.GeneratedMessage {
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'BiddingDataExclusionOperation', package: const $pb.PackageName(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'google.ads.googleads.v8.services'), createEmptyInstance: create)
    ..oo(0, [1, 2, 3])
    ..aOM<$1.BiddingDataExclusion>(1, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'create', subBuilder: $1.BiddingDataExclusion.create)
    ..aOM<$1.BiddingDataExclusion>(2, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'update', subBuilder: $1.BiddingDataExclusion.create)
  ...
  'Use [GeneratedMessageGenericExtensions.rebuild] instead. '
  'Will be removed in next major version')
  BiddingDataExclusionOperation copyWith(void Function(BiddingDataExclusionOperation) updates) => super.copyWith((message) => updates(message as BiddingDataExclusionOperation)) as BiddingDataExclusionOperation; // ignore: deprecated_member_use
  $pb.BuilderInfo get info_ => _i;
  @$core.pragma('dart2js:noInline')
  ...
  @$pb.TagNumber(1)
  set create_1($1.BiddingDataExclusion v) { setField(1, v); }
  @$pb.TagNumber(1)
  ...
  @$pb.TagNumber(2)
  set update($1.BiddingDataExclusion v) { setField(2, v); }
  @$pb.TagNumber(2)
...
class MutateBiddingDataExclusionsResponse extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'MutateBiddingDataExclusionsResponse', package: const $pb.PackageName(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'google.ads.googleads.v8.services'), createEmptyInstance: create)
    ..pc<MutateBiddingDataExclusionsResult>(2, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'results', $pb.PbFieldType.PM, subBuilder: MutateBiddingDataExclusionsResult.create)
  ...
  'Use [GeneratedMessageGenericExtensions.rebuild] instead. '
  'Will be removed in next major version')
  MutateBiddingDataExclusionsResponse copyWith(void Function(MutateBiddingDataExclusionsResponse) updates) => super.copyWith((message) => updates(message as MutateBiddingDataExclusionsResponse)) as MutateBiddingDataExclusionsResponse; // ignore: deprecated_member_use
  $pb.BuilderInfo get info_ => _i;
  @$core.pragma('dart2js:noInline')
...
class MutateBiddingDataExclusionsResult extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'MutateBiddingDataExclusionsResult', package: const $pb.PackageName(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'google.ads.googleads.v8.services'), createEmptyInstance: create)
    ..aOS(1, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'resourceName')
    ..aOM<$1.BiddingDataExclusion>(2, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'biddingDataExclusion', subBuilder: $1.BiddingDataExclusion.create)
    ..hasRequiredFields = false
  ;
  ...
  'Use [GeneratedMessageGenericExtensions.rebuild] instead. '
  'Will be removed in next major version')
  MutateBiddingDataExclusionsResult copyWith(void Function(MutateBiddingDataExclusionsResult) updates) => super.copyWith((message) => updates(message as MutateBiddingDataExclusionsResult)) as MutateBiddingDataExclusionsResult; // ignore: deprecated_member_use
  $pb.BuilderInfo get info_ => _i;
  @$core.pragma('dart2js:noInline')
  ...
  @$pb.TagNumber(2)
  set biddingDataExclusion($1.BiddingDataExclusion v) { setField(2, v); }
  @$pb.TagNumber(2)

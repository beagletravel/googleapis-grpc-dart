...
const MutateCustomerRequest$json = const {
  ...
  '2': const [
    ...
    const {'1': 'operation', '3': 4, '4': 1, '5': 11, '6': '.google.ads.googleads.v8.services.CustomerOperation', '8': const {}, '10': 'operation'},
    const {'1': 'validate_only', '3': 5, '4': 1, '5': 8, '10': 'validateOnly'},
    const {'1': 'response_content_type', '3': 6, '4': 1, '5': 14, '6': '.google.ads.googleads.v8.enums.ResponseContentTypeEnum.ResponseContentType', '10': 'responseContentType'},
  ],
};

/// Descriptor for `MutateCustomerRequest`. Decode as a `google.protobuf.DescriptorProto`.
final $typed_data.Uint8List mutateCustomerRequestDescriptor = $convert.base64Decode('');
...
const CreateCustomerClientRequest$json = const {
  ...
  '2': const [
    const {'1': 'customer_id', '3': 1, '4': 1, '5': 9, '8': const {}, '10': 'customerId'},
    const {'1': 'customer_client', '3': 2, '4': 1, '5': 11, '6': '.google.ads.googleads.v8.resources.Customer', '8': const {}, '10': 'customerClient'},
    const {'1': 'email_address', '3': 5, '4': 1, '5': 9, '9': 0, '10': 'emailAddress', '17': true},
    const {'1': 'access_role', '3': 4, '4': 1, '5': 14, '6': '.google.ads.googleads.v8.enums.AccessRoleEnum.AccessRole', '10': 'accessRole'},
...
const CustomerOperation$json = const {
  '1': 'CustomerOperation',
  '2': const [
    const {'1': 'update', '3': 1, '4': 1, '5': 11, '6': '.google.ads.googleads.v8.resources.Customer', '10': 'update'},
    const {'1': 'update_mask', '3': 2, '4': 1, '5': 11, '6': '.google.protobuf.FieldMask', '10': 'updateMask'},
  ],
};

/// Descriptor for `CustomerOperation`. Decode as a `google.protobuf.DescriptorProto`.
final $typed_data.Uint8List customerOperationDescriptor = $convert.base64Decode('ChFDdXN0b21lck9wZXJhdGlvbhJDCgZ1cGRhdGUYASABKAsyKy5nb29nbGUuYWRzLmdvb2dsZWFkcy52OC5yZXNvdXJjZXMuQ3VzdG9tZXJSBnVwZGF0ZRI7Cgt1cGRhdGVfbWFzaxgCIAEoCzIaLmdvb2dsZS5wcm90b2J1Zi5GaWVsZE1hc2tSCnVwZGF0ZU1hc2s=');
...
const MutateCustomerResponse$json = const {
  ...
  '2': const [
    const {'1': 'result', '3': 2, '4': 1, '5': 11, '6': '.google.ads.googleads.v8.services.MutateCustomerResult', '10': 'result'},
  ],
};

/// Descriptor for `MutateCustomerResponse`. Decode as a `google.protobuf.DescriptorProto`.
final $typed_data.Uint8List mutateCustomerResponseDescriptor = $convert.base64Decode('ChZNdXRhdGVDdXN0b21lclJlc3BvbnNlEk4KBnJlc3VsdBgCIAEoCzI2Lmdvb2dsZS5hZHMuZ29vZ2xlYWRzLnY4LnNlcnZpY2VzLk11dGF0ZUN1c3RvbWVyUmVzdWx0UgZyZXN1bHQ=');
...
const MutateCustomerResult$json = const {
  ...
  '2': const [
    ...
    const {'1': 'customer', '3': 2, '4': 1, '5': 11, '6': '.google.ads.googleads.v8.resources.Customer', '10': 'customer'},
  ],
};

/// Descriptor for `MutateCustomerResult`. Decode as a `google.protobuf.DescriptorProto`.
final $typed_data.Uint8List mutateCustomerResultDescriptor = $convert.base64Decode('ChRNdXRhdGVDdXN0b21lclJlc3VsdBIjCg1yZXNvdXJjZV9uYW1lGAEgASgJUgxyZXNvdXJjZU5hbWUSRwoIY3VzdG9tZXIYAiABKAsyKy5nb29nbGUuYWRzLmdvb2dsZWFkcy52OC5yZXNvdXJjZXMuQ3VzdG9tZXJSCGN1c3RvbWVy');

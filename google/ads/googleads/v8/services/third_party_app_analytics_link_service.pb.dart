...
class GetThirdPartyAppAnalyticsLinkRequest extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'GetThirdPartyAppAnalyticsLinkRequest', package: const $pb.PackageName(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'google.ads.googleads.v8.services'), createEmptyInstance: create)
  ...
  factory GetThirdPartyAppAnalyticsLinkRequest.fromBuffer($core.List<$core.int> i, [$pb.ExtensionRegistry r = $pb.ExtensionRegistry.EMPTY]) => create()..mergeFromBuffer(i, r);
  factory GetThirdPartyAppAnalyticsLinkRequest.fromJson($core.String i, [$pb.ExtensionRegistry r = $pb.ExtensionRegistry.EMPTY]) => create()..mergeFromJson(i, r);
  @$core.Deprecated(
  'Using this can add significant overhead to your binary. '
  'Use [GeneratedMessageGenericExtensions.deepCopy] instead. '
  'Will be removed in next major version')
  GetThirdPartyAppAnalyticsLinkRequest clone() => GetThirdPartyAppAnalyticsLinkRequest()..mergeFromMessage(this);
  @$core.Deprecated(
  'Using this can add significant overhead to your binary. '
  'Use [GeneratedMessageGenericExtensions.rebuild] instead. '
  'Will be removed in next major version')
  GetThirdPartyAppAnalyticsLinkRequest copyWith(void Function(GetThirdPartyAppAnalyticsLinkRequest) updates) => super.copyWith((message) => updates(message as GetThirdPartyAppAnalyticsLinkRequest)) as GetThirdPartyAppAnalyticsLinkRequest; // ignore: deprecated_member_use
  $pb.BuilderInfo get info_ => _i;
  @$core.pragma('dart2js:noInline')
  static GetThirdPartyAppAnalyticsLinkRequest create() => GetThirdPartyAppAnalyticsLinkRequest._();
  GetThirdPartyAppAnalyticsLinkRequest createEmptyInstance() => create();
  static $pb.PbList<GetThirdPartyAppAnalyticsLinkRequest> createRepeated() => $pb.PbList<GetThirdPartyAppAnalyticsLinkRequest>();
  @$core.pragma('dart2js:noInline')
  static GetThirdPartyAppAnalyticsLinkRequest getDefault() => _defaultInstance ??= $pb.GeneratedMessage.$_defaultFor<GetThirdPartyAppAnalyticsLinkRequest>(create);
...
class RegenerateShareableLinkIdRequest extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'RegenerateShareableLinkIdRequest', package: const $pb.PackageName(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'google.ads.googleads.v8.services'), createEmptyInstance: create)
    ..aOS(1, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'resourceName')
    ..hasRequiredFields = false
  ;
  ...
  'Use [GeneratedMessageGenericExtensions.rebuild] instead. '
  'Will be removed in next major version')
  RegenerateShareableLinkIdRequest copyWith(void Function(RegenerateShareableLinkIdRequest) updates) => super.copyWith((message) => updates(message as RegenerateShareableLinkIdRequest)) as RegenerateShareableLinkIdRequest; // ignore: deprecated_member_use
  $pb.BuilderInfo get info_ => _i;
  @$core.pragma('dart2js:noInline')
...
class RegenerateShareableLinkIdResponse extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'RegenerateShareableLinkIdResponse', package: const $pb.PackageName(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'google.ads.googleads.v8.services'), createEmptyInstance: create)
    ..hasRequiredFields = false
  ;
  ...
  'Use [GeneratedMessageGenericExtensions.rebuild] instead. '
  'Will be removed in next major version')
  RegenerateShareableLinkIdResponse copyWith(void Function(RegenerateShareableLinkIdResponse) updates) => super.copyWith((message) => updates(message as RegenerateShareableLinkIdResponse)) as RegenerateShareableLinkIdResponse; // ignore: deprecated_member_use
  $pb.BuilderInfo get info_ => _i;
  @$core.pragma('dart2js:noInline')

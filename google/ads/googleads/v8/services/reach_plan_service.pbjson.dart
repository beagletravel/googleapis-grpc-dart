...
const ListPlannableLocationsResponse$json = const {
  ...
  '2': const [
    const {'1': 'plannable_locations', '3': 1, '4': 3, '5': 11, '6': '.google.ads.googleads.v8.services.PlannableLocation', '10': 'plannableLocations'},
  ],
};

/// Descriptor for `ListPlannableLocationsResponse`. Decode as a `google.protobuf.DescriptorProto`.
final $typed_data.Uint8List listPlannableLocationsResponseDescriptor = $convert.base64Decode('Ch5MaXN0UGxhbm5hYmxlTG9jYXRpb25zUmVzcG9uc2USZAoTcGxhbm5hYmxlX2xvY2F0aW9ucxgBIAMoCzIzLmdvb2dsZS5hZHMuZ29vZ2xlYWRzLnY4LnNlcnZpY2VzLlBsYW5uYWJsZUxvY2F0aW9uUhJwbGFubmFibGVMb2NhdGlvbnM=');
...
final $typed_data.Uint8List plannableLocationDescriptor = $convert.base64Decode('ChFQbGFubmFibGVMb2NhdGlvbhITCgJpZBgEIAEoCUgAUgJpZIgBARIXCgRuYW1lGAUgASgJSAFSBG5hbWWIAQESLwoRcGFyZW50X2NvdW50cnlfaWQYBiABKANIAlIPcGFyZW50Q291bnRyeUlkiAEBQgUKA19pZEIHCgVfbmFtZUIUChJfcGFyZW50X2NvdW50cnlfaWQ=');
...
const ListPlannableProductsResponse$json = const {
  ...
  '2': const [
    const {'1': 'product_metadata', '3': 1, '4': 3, '5': 11, '6': '.google.ads.googleads.v8.services.ProductMetadata', '10': 'productMetadata'},
  ],
};

/// Descriptor for `ListPlannableProductsResponse`. Decode as a `google.protobuf.DescriptorProto`.
final $typed_data.Uint8List listPlannableProductsResponseDescriptor = $convert.base64Decode('Ch1MaXN0UGxhbm5hYmxlUHJvZHVjdHNSZXNwb25zZRJcChBwcm9kdWN0X21ldGFkYXRhGAEgAygLMjEuZ29vZ2xlLmFkcy5nb29nbGVhZHMudjguc2VydmljZXMuUHJvZHVjdE1ldGFkYXRhUg9wcm9kdWN0TWV0YWRhdGE=');
...
const ProductMetadata$json = const {
  ...
  '2': const [
    ...
    const {'1': 'plannable_targeting', '3': 2, '4': 1, '5': 11, '6': '.google.ads.googleads.v8.services.PlannableTargeting', '10': 'plannableTargeting'},
  ],
  '8': const [
...
final $typed_data.Uint8List productMetadataDescriptor = $convert.base64Decode('');
@$core.Deprecated('Use plannableTargetingDescriptor instead')
const PlannableTargeting$json = const {
  '1': 'PlannableTargeting',
  '2': const [
    const {'1': 'age_ranges', '3': 1, '4': 3, '5': 14, '6': '.google.ads.googleads.v8.enums.ReachPlanAgeRangeEnum.ReachPlanAgeRange', '10': 'ageRanges'},
    const {'1': 'genders', '3': 2, '4': 3, '5': 11, '6': '.google.ads.googleads.v8.common.GenderInfo', '10': 'genders'},
    const {'1': 'devices', '3': 3, '4': 3, '5': 11, '6': '.google.ads.googleads.v8.common.DeviceInfo', '10': 'devices'},
    const {'1': 'networks', '3': 4, '4': 3, '5': 14, '6': '.google.ads.googleads.v8.enums.ReachPlanNetworkEnum.ReachPlanNetwork', '10': 'networks'},
  ],
};

/// Descriptor for `PlannableTargeting`. Decode as a `google.protobuf.DescriptorProto`.
final $typed_data.Uint8List plannableTargetingDescriptor = $convert.base64Decode('');
...
const GenerateProductMixIdeasRequest$json = const {
  ...
  '2': const [
    ...
    const {'1': 'preferences', '3': 5, '4': 1, '5': 11, '6': '.google.ads.googleads.v8.services.Preferences', '10': 'preferences'},
  ],
};

/// Descriptor for `GenerateProductMixIdeasRequest`. Decode as a `google.protobuf.DescriptorProto`.
final $typed_data.Uint8List generateProductMixIdeasRequestDescriptor = $convert.base64Decode('');
...
const Preferences$json = const {
  ...
  '2': const [
    ...
    const {'1': 'ad_length', '3': 3, '4': 1, '5': 14, '6': '.google.ads.googleads.v8.enums.ReachPlanAdLengthEnum.ReachPlanAdLength', '10': 'adLength'},
...
final $typed_data.Uint8List preferencesDescriptor = $convert.base64Decode('');
...
const GenerateProductMixIdeasResponse$json = const {
  ...
  '2': const [
    const {'1': 'product_allocation', '3': 1, '4': 3, '5': 11, '6': '.google.ads.googleads.v8.services.ProductAllocation', '10': 'productAllocation'},
  ],
};

/// Descriptor for `GenerateProductMixIdeasResponse`. Decode as a `google.protobuf.DescriptorProto`.
final $typed_data.Uint8List generateProductMixIdeasResponseDescriptor = $convert.base64Decode('Ch9HZW5lcmF0ZVByb2R1Y3RNaXhJZGVhc1Jlc3BvbnNlEmIKEnByb2R1Y3RfYWxsb2NhdGlvbhgBIAMoCzIzLmdvb2dsZS5hZHMuZ29vZ2xlYWRzLnY4LnNlcnZpY2VzLlByb2R1Y3RBbGxvY2F0aW9uUhFwcm9kdWN0QWxsb2NhdGlvbg==');
...
const GenerateReachForecastRequest$json = const {
  ...
  '2': const [
    ...
    const {'1': 'campaign_duration', '3': 3, '4': 1, '5': 11, '6': '.google.ads.googleads.v8.services.CampaignDuration', '8': const {}, '10': 'campaignDuration'},
    const {'1': 'cookie_frequency_cap', '3': 10, '4': 1, '5': 5, '9': 1, '10': 'cookieFrequencyCap', '17': true},
    const {'1': 'cookie_frequency_cap_setting', '3': 8, '4': 1, '5': 11, '6': '.google.ads.googleads.v8.services.FrequencyCap', '10': 'cookieFrequencyCapSetting'},
    const {'1': 'min_effective_frequency', '3': 11, '4': 1, '5': 5, '9': 2, '10': 'minEffectiveFrequency', '17': true},
    const {'1': 'effective_frequency_limit', '3': 12, '4': 1, '5': 11, '6': '.google.ads.googleads.v8.services.EffectiveFrequencyLimit', '9': 3, '10': 'effectiveFrequencyLimit', '17': true},
    const {'1': 'targeting', '3': 6, '4': 1, '5': 11, '6': '.google.ads.googleads.v8.services.Targeting', '10': 'targeting'},
    const {'1': 'planned_products', '3': 7, '4': 3, '5': 11, '6': '.google.ads.googleads.v8.services.PlannedProduct', '8': const {}, '10': 'plannedProducts'},
  ],
  '8': const [
...
final $typed_data.Uint8List generateReachForecastRequestDescriptor = $convert.base64Decode('');
...
const FrequencyCap$json = const {
  ...
  '2': const [
    ...
    const {'1': 'time_unit', '3': 2, '4': 1, '5': 14, '6': '.google.ads.googleads.v8.enums.FrequencyCapTimeUnitEnum.FrequencyCapTimeUnit', '8': const {}, '10': 'timeUnit'},
  ],
};

/// Descriptor for `FrequencyCap`. Decode as a `google.protobuf.DescriptorProto`.
final $typed_data.Uint8List frequencyCapDescriptor = $convert.base64Decode('CgxGcmVxdWVuY3lDYXASJQoLaW1wcmVzc2lvbnMYAyABKAVCA+BBAlILaW1wcmVzc2lvbnMSbgoJdGltZV91bml0GAIgASgOMkwuZ29vZ2xlLmFkcy5nb29nbGVhZHMudjguZW51bXMuRnJlcXVlbmN5Q2FwVGltZVVuaXRFbnVtLkZyZXF1ZW5jeUNhcFRpbWVVbml0QgPgQQJSCHRpbWVVbml0');
...
const Targeting$json = const {
  ...
  '2': const [
    ...
    const {'1': 'age_range', '3': 2, '4': 1, '5': 14, '6': '.google.ads.googleads.v8.enums.ReachPlanAgeRangeEnum.ReachPlanAgeRange', '10': 'ageRange'},
    const {'1': 'genders', '3': 3, '4': 3, '5': 11, '6': '.google.ads.googleads.v8.common.GenderInfo', '10': 'genders'},
    const {'1': 'devices', '3': 4, '4': 3, '5': 11, '6': '.google.ads.googleads.v8.common.DeviceInfo', '10': 'devices'},
    const {'1': 'network', '3': 5, '4': 1, '5': 14, '6': '.google.ads.googleads.v8.enums.ReachPlanNetworkEnum.ReachPlanNetwork', '10': 'network'},
  ],
  '8': const [
...
final $typed_data.Uint8List targetingDescriptor = $convert.base64Decode('');
...
final $typed_data.Uint8List campaignDurationDescriptor = $convert.base64Decode('ChBDYW1wYWlnbkR1cmF0aW9uEi0KEGR1cmF0aW9uX2luX2RheXMYAiABKAVIAFIOZHVyYXRpb25JbkRheXOIAQFCEwoRX2R1cmF0aW9uX2luX2RheXM=');
...
const GenerateReachForecastResponse$json = const {
  ...
  '2': const [
    const {'1': 'on_target_audience_metrics', '3': 1, '4': 1, '5': 11, '6': '.google.ads.googleads.v8.services.OnTargetAudienceMetrics', '10': 'onTargetAudienceMetrics'},
    const {'1': 'reach_curve', '3': 2, '4': 1, '5': 11, '6': '.google.ads.googleads.v8.services.ReachCurve', '10': 'reachCurve'},
  ],
};

/// Descriptor for `GenerateReachForecastResponse`. Decode as a `google.protobuf.DescriptorProto`.
final $typed_data.Uint8List generateReachForecastResponseDescriptor = $convert.base64Decode('');
@$core.Deprecated('Use reachCurveDescriptor instead')
const ReachCurve$json = const {
  '1': 'ReachCurve',
  '2': const [
    const {'1': 'reach_forecasts', '3': 1, '4': 3, '5': 11, '6': '.google.ads.googleads.v8.services.ReachForecast', '10': 'reachForecasts'},
  ],
};

/// Descriptor for `ReachCurve`. Decode as a `google.protobuf.DescriptorProto`.
final $typed_data.Uint8List reachCurveDescriptor = $convert.base64Decode('CgpSZWFjaEN1cnZlElgKD3JlYWNoX2ZvcmVjYXN0cxgBIAMoCzIvLmdvb2dsZS5hZHMuZ29vZ2xlYWRzLnY4LnNlcnZpY2VzLlJlYWNoRm9yZWNhc3RSDnJlYWNoRm9yZWNhc3Rz');
...
const ReachForecast$json = const {
  ...
  '2': const [
    ...
    const {'1': 'forecast', '3': 2, '4': 1, '5': 11, '6': '.google.ads.googleads.v8.services.Forecast', '10': 'forecast'},
    const {'1': 'planned_product_reach_forecasts', '3': 4, '4': 3, '5': 11, '6': '.google.ads.googleads.v8.services.PlannedProductReachForecast', '10': 'plannedProductReachForecasts'},
  ],
};

/// Descriptor for `ReachForecast`. Decode as a `google.protobuf.DescriptorProto`.
final $typed_data.Uint8List reachForecastDescriptor = $convert.base64Decode('');
...
const Forecast$json = const {
  ...
  '2': const [
    ...
    const {'1': 'effective_frequency_breakdowns', '3': 10, '4': 3, '5': 11, '6': '.google.ads.googleads.v8.services.EffectiveFrequencyBreakdown', '10': 'effectiveFrequencyBreakdowns'},
  ],
  '8': const [
...
final $typed_data.Uint8List forecastDescriptor = $convert.base64Decode('');
...
const PlannedProductReachForecast$json = const {
  ...
  '2': const [
    ...
    const {'1': 'planned_product_forecast', '3': 3, '4': 1, '5': 11, '6': '.google.ads.googleads.v8.services.PlannedProductForecast', '10': 'plannedProductForecast'},
  ],
};

/// Descriptor for `PlannedProductReachForecast`. Decode as a `google.protobuf.DescriptorProto`.
final $typed_data.Uint8List plannedProductReachForecastDescriptor = $convert.base64Decode('');

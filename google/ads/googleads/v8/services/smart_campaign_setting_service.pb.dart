...
class GetSmartCampaignSettingRequest extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'GetSmartCampaignSettingRequest', package: const $pb.PackageName(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'google.ads.googleads.v8.services'), createEmptyInstance: create)
  ...
  factory GetSmartCampaignSettingRequest.fromBuffer($core.List<$core.int> i, [$pb.ExtensionRegistry r = $pb.ExtensionRegistry.EMPTY]) => create()..mergeFromBuffer(i, r);
  factory GetSmartCampaignSettingRequest.fromJson($core.String i, [$pb.ExtensionRegistry r = $pb.ExtensionRegistry.EMPTY]) => create()..mergeFromJson(i, r);
  @$core.Deprecated(
  'Using this can add significant overhead to your binary. '
  'Use [GeneratedMessageGenericExtensions.deepCopy] instead. '
  'Will be removed in next major version')
  GetSmartCampaignSettingRequest clone() => GetSmartCampaignSettingRequest()..mergeFromMessage(this);
  @$core.Deprecated(
  'Using this can add significant overhead to your binary. '
  'Use [GeneratedMessageGenericExtensions.rebuild] instead. '
  'Will be removed in next major version')
  GetSmartCampaignSettingRequest copyWith(void Function(GetSmartCampaignSettingRequest) updates) => super.copyWith((message) => updates(message as GetSmartCampaignSettingRequest)) as GetSmartCampaignSettingRequest; // ignore: deprecated_member_use
  $pb.BuilderInfo get info_ => _i;
  @$core.pragma('dart2js:noInline')
  static GetSmartCampaignSettingRequest create() => GetSmartCampaignSettingRequest._();
  GetSmartCampaignSettingRequest createEmptyInstance() => create();
  static $pb.PbList<GetSmartCampaignSettingRequest> createRepeated() => $pb.PbList<GetSmartCampaignSettingRequest>();
  @$core.pragma('dart2js:noInline')
  static GetSmartCampaignSettingRequest getDefault() => _defaultInstance ??= $pb.GeneratedMessage.$_defaultFor<GetSmartCampaignSettingRequest>(create);
...
class MutateSmartCampaignSettingsRequest extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'MutateSmartCampaignSettingsRequest', package: const $pb.PackageName(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'google.ads.googleads.v8.services'), createEmptyInstance: create)
    ..aOS(1, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'customerId')
    ..pc<SmartCampaignSettingOperation>(2, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'operations', $pb.PbFieldType.PM, subBuilder: SmartCampaignSettingOperation.create)
  ...
  'Use [GeneratedMessageGenericExtensions.rebuild] instead. '
  'Will be removed in next major version')
  MutateSmartCampaignSettingsRequest copyWith(void Function(MutateSmartCampaignSettingsRequest) updates) => super.copyWith((message) => updates(message as MutateSmartCampaignSettingsRequest)) as MutateSmartCampaignSettingsRequest; // ignore: deprecated_member_use
  $pb.BuilderInfo get info_ => _i;
  @$core.pragma('dart2js:noInline')
...
class SmartCampaignSettingOperation extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'SmartCampaignSettingOperation', package: const $pb.PackageName(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'google.ads.googleads.v8.services'), createEmptyInstance: create)
    ..aOM<$1.SmartCampaignSetting>(1, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'update', subBuilder: $1.SmartCampaignSetting.create)
  ...
  'Use [GeneratedMessageGenericExtensions.rebuild] instead. '
  'Will be removed in next major version')
  SmartCampaignSettingOperation copyWith(void Function(SmartCampaignSettingOperation) updates) => super.copyWith((message) => updates(message as SmartCampaignSettingOperation)) as SmartCampaignSettingOperation; // ignore: deprecated_member_use
  $pb.BuilderInfo get info_ => _i;
  @$core.pragma('dart2js:noInline')
  ...
  @$pb.TagNumber(1)
  set update($1.SmartCampaignSetting v) { setField(1, v); }
  @$pb.TagNumber(1)
...
class MutateSmartCampaignSettingsResponse extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'MutateSmartCampaignSettingsResponse', package: const $pb.PackageName(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'google.ads.googleads.v8.services'), createEmptyInstance: create)
    ..aOM<$3.Status>(1, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'partialFailureError', subBuilder: $3.Status.create)
    ..pc<MutateSmartCampaignSettingResult>(2, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'results', $pb.PbFieldType.PM, subBuilder: MutateSmartCampaignSettingResult.create)
    ..hasRequiredFields = false
  ;
  ...
  'Use [GeneratedMessageGenericExtensions.rebuild] instead. '
  'Will be removed in next major version')
  MutateSmartCampaignSettingsResponse copyWith(void Function(MutateSmartCampaignSettingsResponse) updates) => super.copyWith((message) => updates(message as MutateSmartCampaignSettingsResponse)) as MutateSmartCampaignSettingsResponse; // ignore: deprecated_member_use
  $pb.BuilderInfo get info_ => _i;
  @$core.pragma('dart2js:noInline')
...
class MutateSmartCampaignSettingResult extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'MutateSmartCampaignSettingResult', package: const $pb.PackageName(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'google.ads.googleads.v8.services'), createEmptyInstance: create)
    ..aOS(1, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'resourceName')
    ..aOM<$1.SmartCampaignSetting>(2, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'smartCampaignSetting', subBuilder: $1.SmartCampaignSetting.create)
    ..hasRequiredFields = false
  ;
  ...
  'Use [GeneratedMessageGenericExtensions.rebuild] instead. '
  'Will be removed in next major version')
  MutateSmartCampaignSettingResult copyWith(void Function(MutateSmartCampaignSettingResult) updates) => super.copyWith((message) => updates(message as MutateSmartCampaignSettingResult)) as MutateSmartCampaignSettingResult; // ignore: deprecated_member_use
  $pb.BuilderInfo get info_ => _i;
  @$core.pragma('dart2js:noInline')
  ...
  @$pb.TagNumber(2)
  set smartCampaignSetting($1.SmartCampaignSetting v) { setField(2, v); }
  @$pb.TagNumber(2)

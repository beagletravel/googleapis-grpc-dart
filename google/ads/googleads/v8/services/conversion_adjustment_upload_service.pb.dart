...
class UploadConversionAdjustmentsRequest extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'UploadConversionAdjustmentsRequest', package: const $pb.PackageName(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'google.ads.googleads.v8.services'), createEmptyInstance: create)
    ..aOS(1, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'customerId')
    ..pc<ConversionAdjustment>(2, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'conversionAdjustments', $pb.PbFieldType.PM, subBuilder: ConversionAdjustment.create)
  ...
  'Will be removed in next major version')
  UploadConversionAdjustmentsRequest copyWith(void Function(UploadConversionAdjustmentsRequest) updates) => super.copyWith((message) => updates(message as UploadConversionAdjustmentsRequest)) as UploadConversionAdjustmentsRequest; // ignore: deprecated_member_use
...
class UploadConversionAdjustmentsResponse extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'UploadConversionAdjustmentsResponse', package: const $pb.PackageName(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'google.ads.googleads.v8.services'), createEmptyInstance: create)
    ..aOM<$1.Status>(1, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'partialFailureError', subBuilder: $1.Status.create)
    ..pc<ConversionAdjustmentResult>(2, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'results', $pb.PbFieldType.PM, subBuilder: ConversionAdjustmentResult.create)
    ..hasRequiredFields = false
  ;
  ...
  'Use [GeneratedMessageGenericExtensions.rebuild] instead. '
  'Will be removed in next major version')
  UploadConversionAdjustmentsResponse copyWith(void Function(UploadConversionAdjustmentsResponse) updates) => super.copyWith((message) => updates(message as UploadConversionAdjustmentsResponse)) as UploadConversionAdjustmentsResponse; // ignore: deprecated_member_use
  $pb.BuilderInfo get info_ => _i;
  @$core.pragma('dart2js:noInline')
...
class ConversionAdjustment extends $pb.GeneratedMessage {
  static const $core.Map<$core.int, ConversionAdjustment_ConversionIdentifier> _ConversionAdjustment_ConversionIdentifierByTag = {
    1 : ConversionAdjustment_ConversionIdentifier.gclidDateTimePair,
    7 : ConversionAdjustment_ConversionIdentifier.orderId,
    0 : ConversionAdjustment_ConversionIdentifier.notSet
  };
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'ConversionAdjustment', package: const $pb.PackageName(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'google.ads.googleads.v8.services'), createEmptyInstance: create)
    ..oo(0, [1, 7])
    ..aOM<GclidDateTimePair>(1, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'gclidDateTimePair', subBuilder: GclidDateTimePair.create)
    ..e<$3.ConversionAdjustmentTypeEnum_ConversionAdjustmentType>(5, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'adjustmentType', $pb.PbFieldType.OE, defaultOrMaker: $3.ConversionAdjustmentTypeEnum_ConversionAdjustmentType.UNSPECIFIED, valueOf: $3.ConversionAdjustmentTypeEnum_ConversionAdjustmentType.valueOf, enumValues: $3.ConversionAdjustmentTypeEnum_ConversionAdjustmentType.values)
    ..aOM<RestatementValue>(6, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'restatementValue', subBuilder: RestatementValue.create)
    ..aOS(7, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'orderId')
    ..aOS(8, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'conversionAction')
    ..aOS(9, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'adjustmentDateTime')
    ..pc<$2.UserIdentifier>(10, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'userIdentifiers', $pb.PbFieldType.PM, subBuilder: $2.UserIdentifier.create)
    ..aOS(11, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'userAgent')
    ..hasRequiredFields = false
  ;
  ...
  'Use [GeneratedMessageGenericExtensions.rebuild] instead. '
  'Will be removed in next major version')
  ConversionAdjustment copyWith(void Function(ConversionAdjustment) updates) => super.copyWith((message) => updates(message as ConversionAdjustment)) as ConversionAdjustment; // ignore: deprecated_member_use
  $pb.BuilderInfo get info_ => _i;
  @$core.pragma('dart2js:noInline')
  ...
  ConversionAdjustment_ConversionIdentifier whichConversionIdentifier() => _ConversionAdjustment_ConversionIdentifierByTag[$_whichOneof(0)]!;
  void clearConversionIdentifier() => clearField($_whichOneof(0));

  @$pb.TagNumber(1)
  GclidDateTimePair get gclidDateTimePair => $_getN(0);
  @$pb.TagNumber(1)
  set gclidDateTimePair(GclidDateTimePair v) { setField(1, v); }
  @$pb.TagNumber(1)
  ...
  @$pb.TagNumber(5)
  $3.ConversionAdjustmentTypeEnum_ConversionAdjustmentType get adjustmentType => $_getN(1);
  @$pb.TagNumber(5)
  set adjustmentType($3.ConversionAdjustmentTypeEnum_ConversionAdjustmentType v) { setField(5, v); }
  @$pb.TagNumber(5)
  ...
  @$pb.TagNumber(6)
  RestatementValue get restatementValue => $_getN(2);
  @$pb.TagNumber(6)
  set restatementValue(RestatementValue v) { setField(6, v); }
  @$pb.TagNumber(6)
  $core.bool hasRestatementValue() => $_has(2);
  @$pb.TagNumber(6)
  void clearRestatementValue() => clearField(6);
  @$pb.TagNumber(6)
  RestatementValue ensureRestatementValue() => $_ensure(2);
  ...
  @$pb.TagNumber(9)
  $core.String get adjustmentDateTime => $_getSZ(5);
  @$pb.TagNumber(9)
  set adjustmentDateTime($core.String v) { $_setString(5, v); }
  @$pb.TagNumber(9)
  $core.bool hasAdjustmentDateTime() => $_has(5);
  @$pb.TagNumber(9)
  void clearAdjustmentDateTime() => clearField(9);

  @$pb.TagNumber(10)
  $core.List<$2.UserIdentifier> get userIdentifiers => $_getList(6);
...
class RestatementValue extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'RestatementValue', package: const $pb.PackageName(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'google.ads.googleads.v8.services'), createEmptyInstance: create)
    ..a<$core.double>(3, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'adjustedValue', $pb.PbFieldType.OD)
  ...
  'Use [GeneratedMessageGenericExtensions.rebuild] instead. '
  'Will be removed in next major version')
  RestatementValue copyWith(void Function(RestatementValue) updates) => super.copyWith((message) => updates(message as RestatementValue)) as RestatementValue; // ignore: deprecated_member_use
  $pb.BuilderInfo get info_ => _i;
  @$core.pragma('dart2js:noInline')
...
class GclidDateTimePair extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'GclidDateTimePair', package: const $pb.PackageName(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'google.ads.googleads.v8.services'), createEmptyInstance: create)
    ..aOS(3, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'gclid')
    ..aOS(4, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'conversionDateTime')
    ..hasRequiredFields = false
  ;
  ...
  'Use [GeneratedMessageGenericExtensions.rebuild] instead. '
  'Will be removed in next major version')
  GclidDateTimePair copyWith(void Function(GclidDateTimePair) updates) => super.copyWith((message) => updates(message as GclidDateTimePair)) as GclidDateTimePair; // ignore: deprecated_member_use
  $pb.BuilderInfo get info_ => _i;
  @$core.pragma('dart2js:noInline')
...
class ConversionAdjustmentResult extends $pb.GeneratedMessage {
  static const $core.Map<$core.int, ConversionAdjustmentResult_ConversionIdentifier> _ConversionAdjustmentResult_ConversionIdentifierByTag = {
    1 : ConversionAdjustmentResult_ConversionIdentifier.gclidDateTimePair,
    6 : ConversionAdjustmentResult_ConversionIdentifier.orderId,
    0 : ConversionAdjustmentResult_ConversionIdentifier.notSet
  };
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'ConversionAdjustmentResult', package: const $pb.PackageName(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'google.ads.googleads.v8.services'), createEmptyInstance: create)
    ..oo(0, [1, 6])
    ..aOM<GclidDateTimePair>(1, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'gclidDateTimePair', subBuilder: GclidDateTimePair.create)
    ..e<$3.ConversionAdjustmentTypeEnum_ConversionAdjustmentType>(5, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'adjustmentType', $pb.PbFieldType.OE, defaultOrMaker: $3.ConversionAdjustmentTypeEnum_ConversionAdjustmentType.UNSPECIFIED, valueOf: $3.ConversionAdjustmentTypeEnum_ConversionAdjustmentType.valueOf, enumValues: $3.ConversionAdjustmentTypeEnum_ConversionAdjustmentType.values)
    ...
    ..aOS(8, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'adjustmentDateTime')
    ..hasRequiredFields = false
  ;
  ...
  'Use [GeneratedMessageGenericExtensions.rebuild] instead. '
  'Will be removed in next major version')
  ConversionAdjustmentResult copyWith(void Function(ConversionAdjustmentResult) updates) => super.copyWith((message) => updates(message as ConversionAdjustmentResult)) as ConversionAdjustmentResult; // ignore: deprecated_member_use
  $pb.BuilderInfo get info_ => _i;
  @$core.pragma('dart2js:noInline')
  ...
  ConversionAdjustmentResult_ConversionIdentifier whichConversionIdentifier() => _ConversionAdjustmentResult_ConversionIdentifierByTag[$_whichOneof(0)]!;
  void clearConversionIdentifier() => clearField($_whichOneof(0));
  ...
  @$pb.TagNumber(7)
  $core.String get conversionAction => $_getSZ(3);
  @$pb.TagNumber(7)
  set conversionAction($core.String v) { $_setString(3, v); }
  @$pb.TagNumber(7)
  $core.bool hasConversionAction() => $_has(3);
  @$pb.TagNumber(7)
  void clearConversionAction() => clearField(7);

  @$pb.TagNumber(8)
  $core.String get adjustmentDateTime => $_getSZ(4);
  @$pb.TagNumber(8)
  set adjustmentDateTime($core.String v) { $_setString(4, v); }
  @$pb.TagNumber(8)
  $core.bool hasAdjustmentDateTime() => $_has(4);
  @$pb.TagNumber(8)

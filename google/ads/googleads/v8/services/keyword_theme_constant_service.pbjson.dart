...
final $typed_data.Uint8List getKeywordThemeConstantRequestDescriptor = $convert.base64Decode('Ch5HZXRLZXl3b3JkVGhlbWVDb25zdGFudFJlcXVlc3QSWgoNcmVzb3VyY2VfbmFtZRgBIAEoCUI14EEC+kEvCi1nb29nbGVhZHMuZ29vZ2xlYXBpcy5jb20vS2V5d29yZFRoZW1lQ29uc3RhbnRSDHJlc291cmNlTmFtZQ==');
...
final $typed_data.Uint8List suggestKeywordThemeConstantsRequestDescriptor = $convert.base64Decode('CiNTdWdnZXN0S2V5d29yZFRoZW1lQ29uc3RhbnRzUmVxdWVzdBIdCgpxdWVyeV90ZXh0GAEgASgJUglxdWVyeVRleHQSIQoMY291bnRyeV9jb2RlGAIgASgJUgtjb3VudHJ5Q29kZRIjCg1sYW5ndWFnZV9jb2RlGAMgASgJUgxsYW5ndWFnZUNvZGU=');
...
const SuggestKeywordThemeConstantsResponse$json = const {
  ...
  '2': const [
    const {'1': 'keyword_theme_constants', '3': 1, '4': 3, '5': 11, '6': '.google.ads.googleads.v8.resources.KeywordThemeConstant', '10': 'keywordThemeConstants'},
  ],
};

/// Descriptor for `SuggestKeywordThemeConstantsResponse`. Decode as a `google.protobuf.DescriptorProto`.
final $typed_data.Uint8List suggestKeywordThemeConstantsResponseDescriptor = $convert.base64Decode('CiRTdWdnZXN0S2V5d29yZFRoZW1lQ29uc3RhbnRzUmVzcG9uc2USbwoXa2V5d29yZF90aGVtZV9jb25zdGFudHMYASADKAsyNy5nb29nbGUuYWRzLmdvb2dsZWFkcy52OC5yZXNvdXJjZXMuS2V5d29yZFRoZW1lQ29uc3RhbnRSFWtleXdvcmRUaGVtZUNvbnN0YW50cw==');

...
class GetConversionCustomVariableRequest extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'GetConversionCustomVariableRequest', package: const $pb.PackageName(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'google.ads.googleads.v8.services'), createEmptyInstance: create)
  ...
  factory GetConversionCustomVariableRequest.fromBuffer($core.List<$core.int> i, [$pb.ExtensionRegistry r = $pb.ExtensionRegistry.EMPTY]) => create()..mergeFromBuffer(i, r);
  factory GetConversionCustomVariableRequest.fromJson($core.String i, [$pb.ExtensionRegistry r = $pb.ExtensionRegistry.EMPTY]) => create()..mergeFromJson(i, r);
  @$core.Deprecated(
  'Using this can add significant overhead to your binary. '
  'Use [GeneratedMessageGenericExtensions.deepCopy] instead. '
  'Will be removed in next major version')
  GetConversionCustomVariableRequest clone() => GetConversionCustomVariableRequest()..mergeFromMessage(this);
  @$core.Deprecated(
  'Using this can add significant overhead to your binary. '
  'Use [GeneratedMessageGenericExtensions.rebuild] instead. '
  'Will be removed in next major version')
  GetConversionCustomVariableRequest copyWith(void Function(GetConversionCustomVariableRequest) updates) => super.copyWith((message) => updates(message as GetConversionCustomVariableRequest)) as GetConversionCustomVariableRequest; // ignore: deprecated_member_use
  $pb.BuilderInfo get info_ => _i;
  @$core.pragma('dart2js:noInline')
  static GetConversionCustomVariableRequest create() => GetConversionCustomVariableRequest._();
  GetConversionCustomVariableRequest createEmptyInstance() => create();
  static $pb.PbList<GetConversionCustomVariableRequest> createRepeated() => $pb.PbList<GetConversionCustomVariableRequest>();
  @$core.pragma('dart2js:noInline')
  static GetConversionCustomVariableRequest getDefault() => _defaultInstance ??= $pb.GeneratedMessage.$_defaultFor<GetConversionCustomVariableRequest>(create);
...
class MutateConversionCustomVariablesRequest extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'MutateConversionCustomVariablesRequest', package: const $pb.PackageName(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'google.ads.googleads.v8.services'), createEmptyInstance: create)
    ..aOS(1, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'customerId')
    ..pc<ConversionCustomVariableOperation>(2, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'operations', $pb.PbFieldType.PM, subBuilder: ConversionCustomVariableOperation.create)
  ...
  'Use [GeneratedMessageGenericExtensions.rebuild] instead. '
  'Will be removed in next major version')
  MutateConversionCustomVariablesRequest copyWith(void Function(MutateConversionCustomVariablesRequest) updates) => super.copyWith((message) => updates(message as MutateConversionCustomVariablesRequest)) as MutateConversionCustomVariablesRequest; // ignore: deprecated_member_use
  $pb.BuilderInfo get info_ => _i;
  @$core.pragma('dart2js:noInline')
...
class ConversionCustomVariableOperation extends $pb.GeneratedMessage {
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'ConversionCustomVariableOperation', package: const $pb.PackageName(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'google.ads.googleads.v8.services'), createEmptyInstance: create)
    ..oo(0, [1, 2])
    ..aOM<$1.ConversionCustomVariable>(1, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'create', subBuilder: $1.ConversionCustomVariable.create)
    ..aOM<$1.ConversionCustomVariable>(2, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'update', subBuilder: $1.ConversionCustomVariable.create)
  ...
  'Use [GeneratedMessageGenericExtensions.rebuild] instead. '
  'Will be removed in next major version')
  ConversionCustomVariableOperation copyWith(void Function(ConversionCustomVariableOperation) updates) => super.copyWith((message) => updates(message as ConversionCustomVariableOperation)) as ConversionCustomVariableOperation; // ignore: deprecated_member_use
  $pb.BuilderInfo get info_ => _i;
  @$core.pragma('dart2js:noInline')
  ...
  @$pb.TagNumber(1)
  set create_1($1.ConversionCustomVariable v) { setField(1, v); }
  @$pb.TagNumber(1)
  ...
  @$pb.TagNumber(2)
  set update($1.ConversionCustomVariable v) { setField(2, v); }
  @$pb.TagNumber(2)
...
class MutateConversionCustomVariablesResponse extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'MutateConversionCustomVariablesResponse', package: const $pb.PackageName(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'google.ads.googleads.v8.services'), createEmptyInstance: create)
    ..aOM<$3.Status>(1, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'partialFailureError', subBuilder: $3.Status.create)
    ..pc<MutateConversionCustomVariableResult>(2, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'results', $pb.PbFieldType.PM, subBuilder: MutateConversionCustomVariableResult.create)
    ..hasRequiredFields = false
  ;
  ...
  'Use [GeneratedMessageGenericExtensions.rebuild] instead. '
  'Will be removed in next major version')
  MutateConversionCustomVariablesResponse copyWith(void Function(MutateConversionCustomVariablesResponse) updates) => super.copyWith((message) => updates(message as MutateConversionCustomVariablesResponse)) as MutateConversionCustomVariablesResponse; // ignore: deprecated_member_use
  $pb.BuilderInfo get info_ => _i;
  @$core.pragma('dart2js:noInline')
...
class MutateConversionCustomVariableResult extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'MutateConversionCustomVariableResult', package: const $pb.PackageName(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'google.ads.googleads.v8.services'), createEmptyInstance: create)
    ..aOS(1, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'resourceName')
    ..aOM<$1.ConversionCustomVariable>(2, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'conversionCustomVariable', subBuilder: $1.ConversionCustomVariable.create)
    ..hasRequiredFields = false
  ;
  ...
  'Use [GeneratedMessageGenericExtensions.rebuild] instead. '
  'Will be removed in next major version')
  MutateConversionCustomVariableResult copyWith(void Function(MutateConversionCustomVariableResult) updates) => super.copyWith((message) => updates(message as MutateConversionCustomVariableResult)) as MutateConversionCustomVariableResult; // ignore: deprecated_member_use
  $pb.BuilderInfo get info_ => _i;
  @$core.pragma('dart2js:noInline')
  ...
  @$pb.TagNumber(2)
  set conversionCustomVariable($1.ConversionCustomVariable v) { setField(2, v); }
  @$pb.TagNumber(2)

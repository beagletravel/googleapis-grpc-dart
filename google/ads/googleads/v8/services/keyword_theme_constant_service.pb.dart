...
class GetKeywordThemeConstantRequest extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'GetKeywordThemeConstantRequest', package: const $pb.PackageName(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'google.ads.googleads.v8.services'), createEmptyInstance: create)
  ...
  factory GetKeywordThemeConstantRequest.fromBuffer($core.List<$core.int> i, [$pb.ExtensionRegistry r = $pb.ExtensionRegistry.EMPTY]) => create()..mergeFromBuffer(i, r);
  factory GetKeywordThemeConstantRequest.fromJson($core.String i, [$pb.ExtensionRegistry r = $pb.ExtensionRegistry.EMPTY]) => create()..mergeFromJson(i, r);
  @$core.Deprecated(
  'Using this can add significant overhead to your binary. '
  'Use [GeneratedMessageGenericExtensions.deepCopy] instead. '
  'Will be removed in next major version')
  GetKeywordThemeConstantRequest clone() => GetKeywordThemeConstantRequest()..mergeFromMessage(this);
  @$core.Deprecated(
  'Using this can add significant overhead to your binary. '
  'Use [GeneratedMessageGenericExtensions.rebuild] instead. '
  'Will be removed in next major version')
  GetKeywordThemeConstantRequest copyWith(void Function(GetKeywordThemeConstantRequest) updates) => super.copyWith((message) => updates(message as GetKeywordThemeConstantRequest)) as GetKeywordThemeConstantRequest; // ignore: deprecated_member_use
  $pb.BuilderInfo get info_ => _i;
  @$core.pragma('dart2js:noInline')
  static GetKeywordThemeConstantRequest create() => GetKeywordThemeConstantRequest._();
  GetKeywordThemeConstantRequest createEmptyInstance() => create();
  static $pb.PbList<GetKeywordThemeConstantRequest> createRepeated() => $pb.PbList<GetKeywordThemeConstantRequest>();
  @$core.pragma('dart2js:noInline')
  static GetKeywordThemeConstantRequest getDefault() => _defaultInstance ??= $pb.GeneratedMessage.$_defaultFor<GetKeywordThemeConstantRequest>(create);
...
class SuggestKeywordThemeConstantsRequest extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'SuggestKeywordThemeConstantsRequest', package: const $pb.PackageName(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'google.ads.googleads.v8.services'), createEmptyInstance: create)
  ...
  'Use [GeneratedMessageGenericExtensions.rebuild] instead. '
  'Will be removed in next major version')
  SuggestKeywordThemeConstantsRequest copyWith(void Function(SuggestKeywordThemeConstantsRequest) updates) => super.copyWith((message) => updates(message as SuggestKeywordThemeConstantsRequest)) as SuggestKeywordThemeConstantsRequest; // ignore: deprecated_member_use
  $pb.BuilderInfo get info_ => _i;
  @$core.pragma('dart2js:noInline')
...
class SuggestKeywordThemeConstantsResponse extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'SuggestKeywordThemeConstantsResponse', package: const $pb.PackageName(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'google.ads.googleads.v8.services'), createEmptyInstance: create)
    ..pc<$1.KeywordThemeConstant>(1, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'keywordThemeConstants', $pb.PbFieldType.PM, subBuilder: $1.KeywordThemeConstant.create)
    ..hasRequiredFields = false
  ;
  ...
  'Use [GeneratedMessageGenericExtensions.rebuild] instead. '
  'Will be removed in next major version')
  SuggestKeywordThemeConstantsResponse copyWith(void Function(SuggestKeywordThemeConstantsResponse) updates) => super.copyWith((message) => updates(message as SuggestKeywordThemeConstantsResponse)) as SuggestKeywordThemeConstantsResponse; // ignore: deprecated_member_use
  $pb.BuilderInfo get info_ => _i;
  @$core.pragma('dart2js:noInline')

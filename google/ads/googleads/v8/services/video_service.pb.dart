...
class GetVideoRequest extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'GetVideoRequest', package: const $pb.PackageName(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'google.ads.googleads.v8.services'), createEmptyInstance: create)
  ...
  'Will be removed in next major version')
  GetVideoRequest copyWith(void Function(GetVideoRequest) updates) => super.copyWith((message) => updates(message as GetVideoRequest)) as GetVideoRequest; // ignore: deprecated_member_use

...
const Segments$json = const {
  '1': 'Segments',
  '2': const [
    const {'1': 'ad_destination_type', '3': 136, '4': 1, '5': 14, '6': '.google.ads.googleads.v8.enums.AdDestinationTypeEnum.AdDestinationType', '10': 'adDestinationType'},
    const {'1': 'ad_network_type', '3': 3, '4': 1, '5': 14, '6': '.google.ads.googleads.v8.enums.AdNetworkTypeEnum.AdNetworkType', '10': 'adNetworkType'},
    const {'1': 'budget_campaign_association_status', '3': 134, '4': 1, '5': 11, '6': '.google.ads.googleads.v8.common.BudgetCampaignAssociationStatus', '10': 'budgetCampaignAssociationStatus'},
    const {'1': 'click_type', '3': 26, '4': 1, '5': 14, '6': '.google.ads.googleads.v8.enums.ClickTypeEnum.ClickType', '10': 'clickType'},
    const {'1': 'conversion_action', '3': 113, '4': 1, '5': 9, '9': 0, '10': 'conversionAction', '17': true},
    const {'1': 'conversion_action_category', '3': 53, '4': 1, '5': 14, '6': '.google.ads.googleads.v8.enums.ConversionActionCategoryEnum.ConversionActionCategory', '10': 'conversionActionCategory'},
    ...
    const {'1': 'conversion_attribution_event_type', '3': 2, '4': 1, '5': 14, '6': '.google.ads.googleads.v8.enums.ConversionAttributionEventTypeEnum.ConversionAttributionEventType', '10': 'conversionAttributionEventType'},
    const {'1': 'conversion_lag_bucket', '3': 50, '4': 1, '5': 14, '6': '.google.ads.googleads.v8.enums.ConversionLagBucketEnum.ConversionLagBucket', '10': 'conversionLagBucket'},
    const {'1': 'conversion_or_adjustment_lag_bucket', '3': 51, '4': 1, '5': 14, '6': '.google.ads.googleads.v8.enums.ConversionOrAdjustmentLagBucketEnum.ConversionOrAdjustmentLagBucket', '10': 'conversionOrAdjustmentLagBucket'},
    ...
    const {'1': 'device', '3': 1, '4': 1, '5': 14, '6': '.google.ads.googleads.v8.enums.DeviceEnum.Device', '10': 'device'},
    const {'1': 'external_conversion_source', '3': 55, '4': 1, '5': 14, '6': '.google.ads.googleads.v8.enums.ExternalConversionSourceEnum.ExternalConversionSource', '10': 'externalConversionSource'},
    ...
    const {'1': 'hotel_check_in_day_of_week', '3': 9, '4': 1, '5': 14, '6': '.google.ads.googleads.v8.enums.DayOfWeekEnum.DayOfWeek', '10': 'hotelCheckInDayOfWeek'},
    ...
    const {'1': 'hotel_date_selection_type', '3': 13, '4': 1, '5': 14, '6': '.google.ads.googleads.v8.enums.HotelDateSelectionTypeEnum.HotelDateSelectionType', '10': 'hotelDateSelectionType'},
    ...
    const {'1': 'hotel_rate_type', '3': 74, '4': 1, '5': 14, '6': '.google.ads.googleads.v8.enums.HotelRateTypeEnum.HotelRateType', '10': 'hotelRateType'},
    const {'1': 'hotel_price_bucket', '3': 78, '4': 1, '5': 14, '6': '.google.ads.googleads.v8.enums.HotelPriceBucketEnum.HotelPriceBucket', '10': 'hotelPriceBucket'},
    ...
    const {'1': 'keyword', '3': 61, '4': 1, '5': 11, '6': '.google.ads.googleads.v8.common.Keyword', '10': 'keyword'},
    const {'1': 'month', '3': 90, '4': 1, '5': 9, '9': 27, '10': 'month', '17': true},
    const {'1': 'month_of_year', '3': 18, '4': 1, '5': 14, '6': '.google.ads.googleads.v8.enums.MonthOfYearEnum.MonthOfYear', '10': 'monthOfYear'},
    const {'1': 'partner_hotel_id', '3': 91, '4': 1, '5': 9, '9': 28, '10': 'partnerHotelId', '17': true},
    const {'1': 'placeholder_type', '3': 20, '4': 1, '5': 14, '6': '.google.ads.googleads.v8.enums.PlaceholderTypeEnum.PlaceholderType', '10': 'placeholderType'},
    ...
    const {'1': 'product_channel', '3': 30, '4': 1, '5': 14, '6': '.google.ads.googleads.v8.enums.ProductChannelEnum.ProductChannel', '10': 'productChannel'},
    const {'1': 'product_channel_exclusivity', '3': 31, '4': 1, '5': 14, '6': '.google.ads.googleads.v8.enums.ProductChannelExclusivityEnum.ProductChannelExclusivity', '10': 'productChannelExclusivity'},
    const {'1': 'product_condition', '3': 32, '4': 1, '5': 14, '6': '.google.ads.googleads.v8.enums.ProductConditionEnum.ProductCondition', '10': 'productCondition'},
    ...
    const {'1': 'recommendation_type', '3': 140, '4': 1, '5': 14, '6': '.google.ads.googleads.v8.enums.RecommendationTypeEnum.RecommendationType', '10': 'recommendationType'},
    const {'1': 'search_engine_results_page_type', '3': 70, '4': 1, '5': 14, '6': '.google.ads.googleads.v8.enums.SearchEngineResultsPageTypeEnum.SearchEngineResultsPageType', '10': 'searchEngineResultsPageType'},
    const {'1': 'search_term_match_type', '3': 22, '4': 1, '5': 14, '6': '.google.ads.googleads.v8.enums.SearchTermMatchTypeEnum.SearchTermMatchType', '10': 'searchTermMatchType'},
    const {'1': 'slot', '3': 23, '4': 1, '5': 14, '6': '.google.ads.googleads.v8.enums.SlotEnum.Slot', '10': 'slot'},
    const {'1': 'conversion_value_rule_primary_dimension', '3': 138, '4': 1, '5': 14, '6': '.google.ads.googleads.v8.enums.ConversionValueRulePrimaryDimensionEnum.ConversionValueRulePrimaryDimension', '10': 'conversionValueRulePrimaryDimension'},
    ...
    const {'1': 'asset_interaction_target', '3': 139, '4': 1, '5': 11, '6': '.google.ads.googleads.v8.common.AssetInteractionTarget', '9': 57, '10': 'assetInteractionTarget', '17': true},
  ],
  '8': const [
...
const Keyword$json = const {
  ...
  '2': const [
    ...
    const {'1': 'info', '3': 2, '4': 1, '5': 11, '6': '.google.ads.googleads.v8.common.KeywordInfo', '10': 'info'},
  ],
  '8': const [
...
final $typed_data.Uint8List keywordDescriptor = $convert.base64Decode('CgdLZXl3b3JkEjEKEmFkX2dyb3VwX2NyaXRlcmlvbhgDIAEoCUgAUhBhZEdyb3VwQ3JpdGVyaW9uiAEBEj8KBGluZm8YAiABKAsyKy5nb29nbGUuYWRzLmdvb2dsZWFkcy52OC5jb21tb24uS2V5d29yZEluZm9SBGluZm9CFQoTX2FkX2dyb3VwX2NyaXRlcmlvbg==');
...
const BudgetCampaignAssociationStatus$json = const {
  ...
  '2': const [
    ...
    const {'1': 'status', '3': 2, '4': 1, '5': 14, '6': '.google.ads.googleads.v8.enums.BudgetCampaignAssociationStatusEnum.BudgetCampaignAssociationStatus', '10': 'status'},
  ],
  '8': const [
    const {'1': '_campaign'},
  ],
...
final $typed_data.Uint8List budgetCampaignAssociationStatusDescriptor = $convert.base64Decode('');

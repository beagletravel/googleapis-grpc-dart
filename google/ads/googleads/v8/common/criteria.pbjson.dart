...
const KeywordInfo$json = const {
  ...
  '2': const [
    ...
    const {'1': 'match_type', '3': 2, '4': 1, '5': 14, '6': '.google.ads.googleads.v8.enums.KeywordMatchTypeEnum.KeywordMatchType', '10': 'matchType'},
  ],
  '8': const [
    const {'1': '_text'},
  ],
...
final $typed_data.Uint8List keywordInfoDescriptor = $convert.base64Decode('CgtLZXl3b3JkSW5mbxIXCgR0ZXh0GAMgASgJSABSBHRleHSIAQESYwoKbWF0Y2hfdHlwZRgCIAEoDjJELmdvb2dsZS5hZHMuZ29vZ2xlYWRzLnY4LmVudW1zLktleXdvcmRNYXRjaFR5cGVFbnVtLktleXdvcmRNYXRjaFR5cGVSCW1hdGNoVHlwZUIHCgVfdGV4dA==');
...
const DeviceInfo$json = const {
  '1': 'DeviceInfo',
  '2': const [
    const {'1': 'type', '3': 1, '4': 1, '5': 14, '6': '.google.ads.googleads.v8.enums.DeviceEnum.Device', '10': 'type'},
  ],
};

/// Descriptor for `DeviceInfo`. Decode as a `google.protobuf.DescriptorProto`.
final $typed_data.Uint8List deviceInfoDescriptor = $convert.base64Decode('CgpEZXZpY2VJbmZvEkQKBHR5cGUYASABKA4yMC5nb29nbGUuYWRzLmdvb2dsZWFkcy52OC5lbnVtcy5EZXZpY2VFbnVtLkRldmljZVIEdHlwZQ==');
@$core.Deprecated('Use preferredContentInfoDescriptor instead')
const PreferredContentInfo$json = const {
  '1': 'PreferredContentInfo',
  '2': const [
    const {'1': 'type', '3': 2, '4': 1, '5': 14, '6': '.google.ads.googleads.v8.enums.PreferredContentTypeEnum.PreferredContentType', '10': 'type'},
  ],
};

/// Descriptor for `PreferredContentInfo`. Decode as a `google.protobuf.DescriptorProto`.
final $typed_data.Uint8List preferredContentInfoDescriptor = $convert.base64Decode('ChRQcmVmZXJyZWRDb250ZW50SW5mbxJgCgR0eXBlGAIgASgOMkwuZ29vZ2xlLmFkcy5nb29nbGVhZHMudjguZW51bXMuUHJlZmVycmVkQ29udGVudFR5cGVFbnVtLlByZWZlcnJlZENvbnRlbnRUeXBlUgR0eXBl');
@$core.Deprecated('Use listingGroupInfoDescriptor instead')
const ListingGroupInfo$json = const {
  '1': 'ListingGroupInfo',
  '2': const [
    const {'1': 'type', '3': 1, '4': 1, '5': 14, '6': '.google.ads.googleads.v8.enums.ListingGroupTypeEnum.ListingGroupType', '10': 'type'},
    const {'1': 'case_value', '3': 2, '4': 1, '5': 11, '6': '.google.ads.googleads.v8.common.ListingDimensionInfo', '10': 'caseValue'},
...
final $typed_data.Uint8List listingGroupInfoDescriptor = $convert.base64Decode('');
@$core.Deprecated('Use listingScopeInfoDescriptor instead')
const ListingScopeInfo$json = const {
  '1': 'ListingScopeInfo',
  '2': const [
    const {'1': 'dimensions', '3': 2, '4': 3, '5': 11, '6': '.google.ads.googleads.v8.common.ListingDimensionInfo', '10': 'dimensions'},
  ],
};

/// Descriptor for `ListingScopeInfo`. Decode as a `google.protobuf.DescriptorProto`.
final $typed_data.Uint8List listingScopeInfoDescriptor = $convert.base64Decode('ChBMaXN0aW5nU2NvcGVJbmZvElQKCmRpbWVuc2lvbnMYAiADKAsyNC5nb29nbGUuYWRzLmdvb2dsZWFkcy52OC5jb21tb24uTGlzdGluZ0RpbWVuc2lvbkluZm9SCmRpbWVuc2lvbnM=');
@$core.Deprecated('Use listingDimensionInfoDescriptor instead')
const ListingDimensionInfo$json = const {
  '1': 'ListingDimensionInfo',
  '2': const [
    const {'1': 'hotel_id', '3': 2, '4': 1, '5': 11, '6': '.google.ads.googleads.v8.common.HotelIdInfo', '9': 0, '10': 'hotelId'},
    const {'1': 'hotel_class', '3': 3, '4': 1, '5': 11, '6': '.google.ads.googleads.v8.common.HotelClassInfo', '9': 0, '10': 'hotelClass'},
    const {'1': 'hotel_country_region', '3': 4, '4': 1, '5': 11, '6': '.google.ads.googleads.v8.common.HotelCountryRegionInfo', '9': 0, '10': 'hotelCountryRegion'},
    const {'1': 'hotel_state', '3': 5, '4': 1, '5': 11, '6': '.google.ads.googleads.v8.common.HotelStateInfo', '9': 0, '10': 'hotelState'},
    const {'1': 'hotel_city', '3': 6, '4': 1, '5': 11, '6': '.google.ads.googleads.v8.common.HotelCityInfo', '9': 0, '10': 'hotelCity'},
    const {'1': 'product_bidding_category', '3': 13, '4': 1, '5': 11, '6': '.google.ads.googleads.v8.common.ProductBiddingCategoryInfo', '9': 0, '10': 'productBiddingCategory'},
    const {'1': 'product_brand', '3': 15, '4': 1, '5': 11, '6': '.google.ads.googleads.v8.common.ProductBrandInfo', '9': 0, '10': 'productBrand'},
    const {'1': 'product_channel', '3': 8, '4': 1, '5': 11, '6': '.google.ads.googleads.v8.common.ProductChannelInfo', '9': 0, '10': 'productChannel'},
    const {'1': 'product_channel_exclusivity', '3': 9, '4': 1, '5': 11, '6': '.google.ads.googleads.v8.common.ProductChannelExclusivityInfo', '9': 0, '10': 'productChannelExclusivity'},
    const {'1': 'product_condition', '3': 10, '4': 1, '5': 11, '6': '.google.ads.googleads.v8.common.ProductConditionInfo', '9': 0, '10': 'productCondition'},
    const {'1': 'product_custom_attribute', '3': 16, '4': 1, '5': 11, '6': '.google.ads.googleads.v8.common.ProductCustomAttributeInfo', '9': 0, '10': 'productCustomAttribute'},
    const {'1': 'product_item_id', '3': 11, '4': 1, '5': 11, '6': '.google.ads.googleads.v8.common.ProductItemIdInfo', '9': 0, '10': 'productItemId'},
    const {'1': 'product_type', '3': 12, '4': 1, '5': 11, '6': '.google.ads.googleads.v8.common.ProductTypeInfo', '9': 0, '10': 'productType'},
    const {'1': 'unknown_listing_dimension', '3': 14, '4': 1, '5': 11, '6': '.google.ads.googleads.v8.common.UnknownListingDimensionInfo', '9': 0, '10': 'unknownListingDimension'},
  ],
  '8': const [
    const {'1': 'dimension'},
  ],
...
final $typed_data.Uint8List listingDimensionInfoDescriptor = $convert.base64Decode('');
...
const ProductBiddingCategoryInfo$json = const {
  ...
  '2': const [
    ...
    const {'1': 'level', '3': 3, '4': 1, '5': 14, '6': '.google.ads.googleads.v8.enums.ProductBiddingCategoryLevelEnum.ProductBiddingCategoryLevel', '10': 'level'},
  ],
  '8': const [
    const {'1': '_id'},
...
final $typed_data.Uint8List productBiddingCategoryInfoDescriptor = $convert.base64Decode('');
...
const ProductChannelInfo$json = const {
  ...
  '2': const [
    const {'1': 'channel', '3': 1, '4': 1, '5': 14, '6': '.google.ads.googleads.v8.enums.ProductChannelEnum.ProductChannel', '10': 'channel'},
  ],
};

/// Descriptor for `ProductChannelInfo`. Decode as a `google.protobuf.DescriptorProto`.
final $typed_data.Uint8List productChannelInfoDescriptor = $convert.base64Decode('ChJQcm9kdWN0Q2hhbm5lbEluZm8SWgoHY2hhbm5lbBgBIAEoDjJALmdvb2dsZS5hZHMuZ29vZ2xlYWRzLnY4LmVudW1zLlByb2R1Y3RDaGFubmVsRW51bS5Qcm9kdWN0Q2hhbm5lbFIHY2hhbm5lbA==');
...
const ProductChannelExclusivityInfo$json = const {
  ...
  '2': const [
    const {'1': 'channel_exclusivity', '3': 1, '4': 1, '5': 14, '6': '.google.ads.googleads.v8.enums.ProductChannelExclusivityEnum.ProductChannelExclusivity', '10': 'channelExclusivity'},
  ],
};

/// Descriptor for `ProductChannelExclusivityInfo`. Decode as a `google.protobuf.DescriptorProto`.
final $typed_data.Uint8List productChannelExclusivityInfoDescriptor = $convert.base64Decode('Ch1Qcm9kdWN0Q2hhbm5lbEV4Y2x1c2l2aXR5SW5mbxKHAQoTY2hhbm5lbF9leGNsdXNpdml0eRgBIAEoDjJWLmdvb2dsZS5hZHMuZ29vZ2xlYWRzLnY4LmVudW1zLlByb2R1Y3RDaGFubmVsRXhjbHVzaXZpdHlFbnVtLlByb2R1Y3RDaGFubmVsRXhjbHVzaXZpdHlSEmNoYW5uZWxFeGNsdXNpdml0eQ==');
@$core.Deprecated('Use productConditionInfoDescriptor instead')
const ProductConditionInfo$json = const {
  '1': 'ProductConditionInfo',
  '2': const [
    const {'1': 'condition', '3': 1, '4': 1, '5': 14, '6': '.google.ads.googleads.v8.enums.ProductConditionEnum.ProductCondition', '10': 'condition'},
  ],
};

/// Descriptor for `ProductConditionInfo`. Decode as a `google.protobuf.DescriptorProto`.
final $typed_data.Uint8List productConditionInfoDescriptor = $convert.base64Decode('ChRQcm9kdWN0Q29uZGl0aW9uSW5mbxJiCgljb25kaXRpb24YASABKA4yRC5nb29nbGUuYWRzLmdvb2dsZWFkcy52OC5lbnVtcy5Qcm9kdWN0Q29uZGl0aW9uRW51bS5Qcm9kdWN0Q29uZGl0aW9uUgljb25kaXRpb24=');
...
const ProductCustomAttributeInfo$json = const {
  ...
  '2': const [
    ...
    const {'1': 'index', '3': 2, '4': 1, '5': 14, '6': '.google.ads.googleads.v8.enums.ProductCustomAttributeIndexEnum.ProductCustomAttributeIndex', '10': 'index'},
  ],
  '8': const [
    const {'1': '_value'},
  ],
...
final $typed_data.Uint8List productCustomAttributeInfoDescriptor = $convert.base64Decode('ChpQcm9kdWN0Q3VzdG9tQXR0cmlidXRlSW5mbxIZCgV2YWx1ZRgDIAEoCUgAUgV2YWx1ZYgBARJwCgVpbmRleBgCIAEoDjJaLmdvb2dsZS5hZHMuZ29vZ2xlYWRzLnY4LmVudW1zLlByb2R1Y3RDdXN0b21BdHRyaWJ1dGVJbmRleEVudW0uUHJvZHVjdEN1c3RvbUF0dHJpYnV0ZUluZGV4UgVpbmRleEIICgZfdmFsdWU=');
...
const ProductTypeInfo$json = const {
  ...
  '2': const [
    const {'1': 'value', '3': 3, '4': 1, '5': 9, '9': 0, '10': 'value', '17': true},
    const {'1': 'level', '3': 2, '4': 1, '5': 14, '6': '.google.ads.googleads.v8.enums.ProductTypeLevelEnum.ProductTypeLevel', '10': 'level'},
  ],
  '8': const [
    const {'1': '_value'},
  ],
...
final $typed_data.Uint8List productTypeInfoDescriptor = $convert.base64Decode('Cg9Qcm9kdWN0VHlwZUluZm8SGQoFdmFsdWUYAyABKAlIAFIFdmFsdWWIAQESWgoFbGV2ZWwYAiABKA4yRC5nb29nbGUuYWRzLmdvb2dsZWFkcy52OC5lbnVtcy5Qcm9kdWN0VHlwZUxldmVsRW51bS5Qcm9kdWN0VHlwZUxldmVsUgVsZXZlbEIICgZfdmFsdWU=');
...
const HotelDateSelectionTypeInfo$json = const {
  ...
  '2': const [
    const {'1': 'type', '3': 1, '4': 1, '5': 14, '6': '.google.ads.googleads.v8.enums.HotelDateSelectionTypeEnum.HotelDateSelectionType', '10': 'type'},
  ],
};

/// Descriptor for `HotelDateSelectionTypeInfo`. Decode as a `google.protobuf.DescriptorProto`.
final $typed_data.Uint8List hotelDateSelectionTypeInfoDescriptor = $convert.base64Decode('ChpIb3RlbERhdGVTZWxlY3Rpb25UeXBlSW5mbxJkCgR0eXBlGAEgASgOMlAuZ29vZ2xlLmFkcy5nb29nbGVhZHMudjguZW51bXMuSG90ZWxEYXRlU2VsZWN0aW9uVHlwZUVudW0uSG90ZWxEYXRlU2VsZWN0aW9uVHlwZVIEdHlwZQ==');
...
const HotelCheckInDayInfo$json = const {
  ...
  '2': const [
    const {'1': 'day_of_week', '3': 1, '4': 1, '5': 14, '6': '.google.ads.googleads.v8.enums.DayOfWeekEnum.DayOfWeek', '10': 'dayOfWeek'},
  ],
};

/// Descriptor for `HotelCheckInDayInfo`. Decode as a `google.protobuf.DescriptorProto`.
final $typed_data.Uint8List hotelCheckInDayInfoDescriptor = $convert.base64Decode('ChNIb3RlbENoZWNrSW5EYXlJbmZvElYKC2RheV9vZl93ZWVrGAEgASgOMjYuZ29vZ2xlLmFkcy5nb29nbGVhZHMudjguZW51bXMuRGF5T2ZXZWVrRW51bS5EYXlPZldlZWtSCWRheU9mV2Vlaw==');
@$core.Deprecated('Use interactionTypeInfoDescriptor instead')
const InteractionTypeInfo$json = const {
  '1': 'InteractionTypeInfo',
  '2': const [
    const {'1': 'type', '3': 1, '4': 1, '5': 14, '6': '.google.ads.googleads.v8.enums.InteractionTypeEnum.InteractionType', '10': 'type'},
  ],
};

/// Descriptor for `InteractionTypeInfo`. Decode as a `google.protobuf.DescriptorProto`.
final $typed_data.Uint8List interactionTypeInfoDescriptor = $convert.base64Decode('ChNJbnRlcmFjdGlvblR5cGVJbmZvElYKBHR5cGUYASABKA4yQi5nb29nbGUuYWRzLmdvb2dsZWFkcy52OC5lbnVtcy5JbnRlcmFjdGlvblR5cGVFbnVtLkludGVyYWN0aW9uVHlwZVIEdHlwZQ==');
@$core.Deprecated('Use adScheduleInfoDescriptor instead')
const AdScheduleInfo$json = const {
  '1': 'AdScheduleInfo',
  '2': const [
    const {'1': 'start_minute', '3': 1, '4': 1, '5': 14, '6': '.google.ads.googleads.v8.enums.MinuteOfHourEnum.MinuteOfHour', '10': 'startMinute'},
    const {'1': 'end_minute', '3': 2, '4': 1, '5': 14, '6': '.google.ads.googleads.v8.enums.MinuteOfHourEnum.MinuteOfHour', '10': 'endMinute'},
    const {'1': 'start_hour', '3': 6, '4': 1, '5': 5, '9': 0, '10': 'startHour', '17': true},
    const {'1': 'end_hour', '3': 7, '4': 1, '5': 5, '9': 1, '10': 'endHour', '17': true},
    const {'1': 'day_of_week', '3': 5, '4': 1, '5': 14, '6': '.google.ads.googleads.v8.enums.DayOfWeekEnum.DayOfWeek', '10': 'dayOfWeek'},
  ],
  '8': const [
    const {'1': '_start_hour'},
    const {'1': '_end_hour'},
...
final $typed_data.Uint8List adScheduleInfoDescriptor = $convert.base64Decode('');
@$core.Deprecated('Use ageRangeInfoDescriptor instead')
const AgeRangeInfo$json = const {
  '1': 'AgeRangeInfo',
  '2': const [
    const {'1': 'type', '3': 1, '4': 1, '5': 14, '6': '.google.ads.googleads.v8.enums.AgeRangeTypeEnum.AgeRangeType', '10': 'type'},
  ],
};

/// Descriptor for `AgeRangeInfo`. Decode as a `google.protobuf.DescriptorProto`.
final $typed_data.Uint8List ageRangeInfoDescriptor = $convert.base64Decode('CgxBZ2VSYW5nZUluZm8SUAoEdHlwZRgBIAEoDjI8Lmdvb2dsZS5hZHMuZ29vZ2xlYWRzLnY4LmVudW1zLkFnZVJhbmdlVHlwZUVudW0uQWdlUmFuZ2VUeXBlUgR0eXBl');
@$core.Deprecated('Use genderInfoDescriptor instead')
const GenderInfo$json = const {
  '1': 'GenderInfo',
  '2': const [
    const {'1': 'type', '3': 1, '4': 1, '5': 14, '6': '.google.ads.googleads.v8.enums.GenderTypeEnum.GenderType', '10': 'type'},
  ],
};

/// Descriptor for `GenderInfo`. Decode as a `google.protobuf.DescriptorProto`.
final $typed_data.Uint8List genderInfoDescriptor = $convert.base64Decode('CgpHZW5kZXJJbmZvEkwKBHR5cGUYASABKA4yOC5nb29nbGUuYWRzLmdvb2dsZWFkcy52OC5lbnVtcy5HZW5kZXJUeXBlRW51bS5HZW5kZXJUeXBlUgR0eXBl');
@$core.Deprecated('Use incomeRangeInfoDescriptor instead')
const IncomeRangeInfo$json = const {
  '1': 'IncomeRangeInfo',
  '2': const [
    const {'1': 'type', '3': 1, '4': 1, '5': 14, '6': '.google.ads.googleads.v8.enums.IncomeRangeTypeEnum.IncomeRangeType', '10': 'type'},
  ],
};

/// Descriptor for `IncomeRangeInfo`. Decode as a `google.protobuf.DescriptorProto`.
final $typed_data.Uint8List incomeRangeInfoDescriptor = $convert.base64Decode('Cg9JbmNvbWVSYW5nZUluZm8SVgoEdHlwZRgBIAEoDjJCLmdvb2dsZS5hZHMuZ29vZ2xlYWRzLnY4LmVudW1zLkluY29tZVJhbmdlVHlwZUVudW0uSW5jb21lUmFuZ2VUeXBlUgR0eXBl');
@$core.Deprecated('Use parentalStatusInfoDescriptor instead')
const ParentalStatusInfo$json = const {
  '1': 'ParentalStatusInfo',
  '2': const [
    const {'1': 'type', '3': 1, '4': 1, '5': 14, '6': '.google.ads.googleads.v8.enums.ParentalStatusTypeEnum.ParentalStatusType', '10': 'type'},
  ],
};

/// Descriptor for `ParentalStatusInfo`. Decode as a `google.protobuf.DescriptorProto`.
final $typed_data.Uint8List parentalStatusInfoDescriptor = $convert.base64Decode('ChJQYXJlbnRhbFN0YXR1c0luZm8SXAoEdHlwZRgBIAEoDjJILmdvb2dsZS5hZHMuZ29vZ2xlYWRzLnY4LmVudW1zLlBhcmVudGFsU3RhdHVzVHlwZUVudW0uUGFyZW50YWxTdGF0dXNUeXBlUgR0eXBl');
...
const ProximityInfo$json = const {
  '1': 'ProximityInfo',
  '2': const [
    const {'1': 'geo_point', '3': 1, '4': 1, '5': 11, '6': '.google.ads.googleads.v8.common.GeoPointInfo', '10': 'geoPoint'},
    const {'1': 'radius', '3': 5, '4': 1, '5': 1, '9': 0, '10': 'radius', '17': true},
    const {'1': 'radius_units', '3': 3, '4': 1, '5': 14, '6': '.google.ads.googleads.v8.enums.ProximityRadiusUnitsEnum.ProximityRadiusUnits', '10': 'radiusUnits'},
    const {'1': 'address', '3': 4, '4': 1, '5': 11, '6': '.google.ads.googleads.v8.common.AddressInfo', '10': 'address'},
  ],
  '8': const [
    const {'1': '_radius'},
  ],
...
final $typed_data.Uint8List proximityInfoDescriptor = $convert.base64Decode('');
...
const ContentLabelInfo$json = const {
  '1': 'ContentLabelInfo',
  '2': const [
    const {'1': 'type', '3': 1, '4': 1, '5': 14, '6': '.google.ads.googleads.v8.enums.ContentLabelTypeEnum.ContentLabelType', '10': 'type'},
  ],
};

/// Descriptor for `ContentLabelInfo`. Decode as a `google.protobuf.DescriptorProto`.
final $typed_data.Uint8List contentLabelInfoDescriptor = $convert.base64Decode('ChBDb250ZW50TGFiZWxJbmZvElgKBHR5cGUYASABKA4yRC5nb29nbGUuYWRzLmdvb2dsZWFkcy52OC5lbnVtcy5Db250ZW50TGFiZWxUeXBlRW51bS5Db250ZW50TGFiZWxUeXBlUgR0eXBl');
...
const WebpageInfo$json = const {
  ...
  '2': const [
    ...
    const {'1': 'conditions', '3': 2, '4': 3, '5': 11, '6': '.google.ads.googleads.v8.common.WebpageConditionInfo', '10': 'conditions'},
    const {'1': 'coverage_percentage', '3': 4, '4': 1, '5': 1, '10': 'coveragePercentage'},
    const {'1': 'sample', '3': 5, '4': 1, '5': 11, '6': '.google.ads.googleads.v8.common.WebpageSampleInfo', '10': 'sample'},
  ],
  '8': const [
...
final $typed_data.Uint8List webpageInfoDescriptor = $convert.base64Decode('');
@$core.Deprecated('Use webpageConditionInfoDescriptor instead')
const WebpageConditionInfo$json = const {
  '1': 'WebpageConditionInfo',
  '2': const [
    const {'1': 'operand', '3': 1, '4': 1, '5': 14, '6': '.google.ads.googleads.v8.enums.WebpageConditionOperandEnum.WebpageConditionOperand', '10': 'operand'},
    const {'1': 'operator', '3': 2, '4': 1, '5': 14, '6': '.google.ads.googleads.v8.enums.WebpageConditionOperatorEnum.WebpageConditionOperator', '10': 'operator'},
...
final $typed_data.Uint8List webpageConditionInfoDescriptor = $convert.base64Decode('');
...
const AppPaymentModelInfo$json = const {
  ...
  '2': const [
    const {'1': 'type', '3': 1, '4': 1, '5': 14, '6': '.google.ads.googleads.v8.enums.AppPaymentModelTypeEnum.AppPaymentModelType', '10': 'type'},
  ],
};

/// Descriptor for `AppPaymentModelInfo`. Decode as a `google.protobuf.DescriptorProto`.
final $typed_data.Uint8List appPaymentModelInfoDescriptor = $convert.base64Decode('ChNBcHBQYXltZW50TW9kZWxJbmZvEl4KBHR5cGUYASABKA4ySi5nb29nbGUuYWRzLmdvb2dsZWFkcy52OC5lbnVtcy5BcHBQYXltZW50TW9kZWxUeXBlRW51bS5BcHBQYXltZW50TW9kZWxUeXBlUgR0eXBl');
...
const LocationGroupInfo$json = const {
  ...
  '2': const [
    ...
    const {'1': 'radius_units', '3': 4, '4': 1, '5': 14, '6': '.google.ads.googleads.v8.enums.LocationGroupRadiusUnitsEnum.LocationGroupRadiusUnits', '10': 'radiusUnits'},
...
final $typed_data.Uint8List locationGroupInfoDescriptor = $convert.base64Decode('');

...
class KeywordPlanCampaignKeywordErrorEnum_KeywordPlanCampaignKeywordError extends $pb.ProtobufEnum {
  static const KeywordPlanCampaignKeywordErrorEnum_KeywordPlanCampaignKeywordError UNSPECIFIED = KeywordPlanCampaignKeywordErrorEnum_KeywordPlanCampaignKeywordError._(0, const $core.bool.fromEnvironment('protobuf.omit_enum_names') ? '' : 'UNSPECIFIED');
  static const KeywordPlanCampaignKeywordErrorEnum_KeywordPlanCampaignKeywordError UNKNOWN = KeywordPlanCampaignKeywordErrorEnum_KeywordPlanCampaignKeywordError._(1, const $core.bool.fromEnvironment('protobuf.omit_enum_names') ? '' : 'UNKNOWN');
  static const KeywordPlanCampaignKeywordErrorEnum_KeywordPlanCampaignKeywordError CAMPAIGN_KEYWORD_IS_POSITIVE = KeywordPlanCampaignKeywordErrorEnum_KeywordPlanCampaignKeywordError._(8, const $core.bool.fromEnvironment('protobuf.omit_enum_names') ? '' : 'CAMPAIGN_KEYWORD_IS_POSITIVE');

...
const Invoice$json = const {
  ...
  '2': const [
    ...
    const {'1': 'type', '3': 3, '4': 1, '5': 14, '6': '.google.ads.googleads.v8.enums.InvoiceTypeEnum.InvoiceType', '8': const {}, '10': 'type'},
    ...
    const {'1': 'service_date_range', '3': 9, '4': 1, '5': 11, '6': '.google.ads.googleads.v8.common.DateRange', '8': const {}, '10': 'serviceDateRange'},
    ...
    const {'1': 'account_budget_summaries', '3': 18, '4': 3, '5': 11, '6': '.google.ads.googleads.v8.resources.Invoice.AccountBudgetSummary', '8': const {}, '10': 'accountBudgetSummaries'},
  ],
...
const Invoice_AccountBudgetSummary$json = const {
  ...
  '2': const [
    ...
    const {'1': 'billable_activity_date_range', '3': 9, '4': 1, '5': 11, '6': '.google.ads.googleads.v8.common.DateRange', '8': const {}, '10': 'billableActivityDateRange'},
  ],
  '8': const [
    const {'1': '_customer'},
...
final $typed_data.Uint8List invoiceDescriptor = $convert.base64Decode('');

...
const ConversionValueRule$json = const {
  ...
  '2': const [
    ...
    const {'1': 'action', '3': 3, '4': 1, '5': 11, '6': '.google.ads.googleads.v8.resources.ConversionValueRule.ValueRuleAction', '10': 'action'},
    const {'1': 'geo_location_condition', '3': 4, '4': 1, '5': 11, '6': '.google.ads.googleads.v8.resources.ConversionValueRule.ValueRuleGeoLocationCondition', '10': 'geoLocationCondition'},
    const {'1': 'device_condition', '3': 5, '4': 1, '5': 11, '6': '.google.ads.googleads.v8.resources.ConversionValueRule.ValueRuleDeviceCondition', '10': 'deviceCondition'},
    const {'1': 'audience_condition', '3': 6, '4': 1, '5': 11, '6': '.google.ads.googleads.v8.resources.ConversionValueRule.ValueRuleAudienceCondition', '10': 'audienceCondition'},
    const {'1': 'owner_customer', '3': 7, '4': 1, '5': 9, '8': const {}, '10': 'ownerCustomer'},
    const {'1': 'status', '3': 8, '4': 1, '5': 14, '6': '.google.ads.googleads.v8.enums.ConversionValueRuleStatusEnum.ConversionValueRuleStatus', '10': 'status'},
  ],
...
const ConversionValueRule_ValueRuleAction$json = const {
  '1': 'ValueRuleAction',
  '2': const [
    const {'1': 'operation', '3': 1, '4': 1, '5': 14, '6': '.google.ads.googleads.v8.enums.ValueRuleOperationEnum.ValueRuleOperation', '10': 'operation'},
...
const ConversionValueRule_ValueRuleGeoLocationCondition$json = const {
  ...
  '2': const [
    ...
    const {'1': 'excluded_geo_match_type', '3': 2, '4': 1, '5': 14, '6': '.google.ads.googleads.v8.enums.ValueRuleGeoLocationMatchTypeEnum.ValueRuleGeoLocationMatchType', '10': 'excludedGeoMatchType'},
    const {'1': 'geo_target_constants', '3': 3, '4': 3, '5': 9, '8': const {}, '10': 'geoTargetConstants'},
    const {'1': 'geo_match_type', '3': 4, '4': 1, '5': 14, '6': '.google.ads.googleads.v8.enums.ValueRuleGeoLocationMatchTypeEnum.ValueRuleGeoLocationMatchType', '10': 'geoMatchType'},
  ],
};
...
const ConversionValueRule_ValueRuleDeviceCondition$json = const {
  ...
  '2': const [
    const {'1': 'device_types', '3': 1, '4': 3, '5': 14, '6': '.google.ads.googleads.v8.enums.ValueRuleDeviceTypeEnum.ValueRuleDeviceType', '10': 'deviceTypes'},
  ],
};

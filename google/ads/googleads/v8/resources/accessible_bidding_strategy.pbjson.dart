...
const AccessibleBiddingStrategy$json = const {
  ...
  '2': const [
    ...
    const {'1': 'type', '3': 4, '4': 1, '5': 14, '6': '.google.ads.googleads.v8.enums.BiddingStrategyTypeEnum.BiddingStrategyType', '8': const {}, '10': 'type'},
    ...
    const {'1': 'maximize_conversion_value', '3': 7, '4': 1, '5': 11, '6': '.google.ads.googleads.v8.resources.AccessibleBiddingStrategy.MaximizeConversionValue', '8': const {}, '9': 0, '10': 'maximizeConversionValue'},
    const {'1': 'maximize_conversions', '3': 8, '4': 1, '5': 11, '6': '.google.ads.googleads.v8.resources.AccessibleBiddingStrategy.MaximizeConversions', '8': const {}, '9': 0, '10': 'maximizeConversions'},
    const {'1': 'target_cpa', '3': 9, '4': 1, '5': 11, '6': '.google.ads.googleads.v8.resources.AccessibleBiddingStrategy.TargetCpa', '8': const {}, '9': 0, '10': 'targetCpa'},
    const {'1': 'target_impression_share', '3': 10, '4': 1, '5': 11, '6': '.google.ads.googleads.v8.resources.AccessibleBiddingStrategy.TargetImpressionShare', '8': const {}, '9': 0, '10': 'targetImpressionShare'},
    const {'1': 'target_roas', '3': 11, '4': 1, '5': 11, '6': '.google.ads.googleads.v8.resources.AccessibleBiddingStrategy.TargetRoas', '8': const {}, '9': 0, '10': 'targetRoas'},
    const {'1': 'target_spend', '3': 12, '4': 1, '5': 11, '6': '.google.ads.googleads.v8.resources.AccessibleBiddingStrategy.TargetSpend', '8': const {}, '9': 0, '10': 'targetSpend'},
  ],
...
const AccessibleBiddingStrategy_TargetImpressionShare$json = const {
  ...
  '2': const [
    const {'1': 'location', '3': 1, '4': 1, '5': 14, '6': '.google.ads.googleads.v8.enums.TargetImpressionShareLocationEnum.TargetImpressionShareLocation', '8': const {}, '10': 'location'},

...
const CustomerFeed$json = const {
  ...
  '2': const [
    ...
    const {'1': 'placeholder_types', '3': 3, '4': 3, '5': 14, '6': '.google.ads.googleads.v8.enums.PlaceholderTypeEnum.PlaceholderType', '10': 'placeholderTypes'},
    const {'1': 'matching_function', '3': 4, '4': 1, '5': 11, '6': '.google.ads.googleads.v8.common.MatchingFunction', '10': 'matchingFunction'},
    const {'1': 'status', '3': 5, '4': 1, '5': 14, '6': '.google.ads.googleads.v8.enums.FeedLinkStatusEnum.FeedLinkStatus', '8': const {}, '10': 'status'},
  ],
  '7': const {},
  '8': const [
    const {'1': '_feed'},

...
class ConversionValueRule_ValueRuleAction extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'ConversionValueRule.ValueRuleAction', package: const $pb.PackageName(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'google.ads.googleads.v8.resources'), createEmptyInstance: create)
    ..e<$1.ValueRuleOperationEnum_ValueRuleOperation>(1, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'operation', $pb.PbFieldType.OE, defaultOrMaker: $1.ValueRuleOperationEnum_ValueRuleOperation.UNSPECIFIED, valueOf: $1.ValueRuleOperationEnum_ValueRuleOperation.valueOf, enumValues: $1.ValueRuleOperationEnum_ValueRuleOperation.values)
  ...
  'Will be removed in next major version')
  ConversionValueRule_ValueRuleAction copyWith(void Function(ConversionValueRule_ValueRuleAction) updates) => super.copyWith((message) => updates(message as ConversionValueRule_ValueRuleAction)) as ConversionValueRule_ValueRuleAction; // ignore: deprecated_member_use
  ...
  @$pb.TagNumber(1)
  set operation($1.ValueRuleOperationEnum_ValueRuleOperation v) { setField(1, v); }
  @$pb.TagNumber(1)
...
class ConversionValueRule_ValueRuleGeoLocationCondition extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'ConversionValueRule.ValueRuleGeoLocationCondition', package: const $pb.PackageName(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'google.ads.googleads.v8.resources'), createEmptyInstance: create)
    ..pPS(1, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'excludedGeoTargetConstants')
    ..e<$2.ValueRuleGeoLocationMatchTypeEnum_ValueRuleGeoLocationMatchType>(2, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'excludedGeoMatchType', $pb.PbFieldType.OE, defaultOrMaker: $2.ValueRuleGeoLocationMatchTypeEnum_ValueRuleGeoLocationMatchType.UNSPECIFIED, valueOf: $2.ValueRuleGeoLocationMatchTypeEnum_ValueRuleGeoLocationMatchType.valueOf, enumValues: $2.ValueRuleGeoLocationMatchTypeEnum_ValueRuleGeoLocationMatchType.values)
    ..pPS(3, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'geoTargetConstants')
    ..e<$2.ValueRuleGeoLocationMatchTypeEnum_ValueRuleGeoLocationMatchType>(4, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'geoMatchType', $pb.PbFieldType.OE, defaultOrMaker: $2.ValueRuleGeoLocationMatchTypeEnum_ValueRuleGeoLocationMatchType.UNSPECIFIED, valueOf: $2.ValueRuleGeoLocationMatchTypeEnum_ValueRuleGeoLocationMatchType.valueOf, enumValues: $2.ValueRuleGeoLocationMatchTypeEnum_ValueRuleGeoLocationMatchType.values)
    ..hasRequiredFields = false
  ;
  ...
  factory ConversionValueRule_ValueRuleGeoLocationCondition({
    ...
    $2.ValueRuleGeoLocationMatchTypeEnum_ValueRuleGeoLocationMatchType? excludedGeoMatchType,
    $core.Iterable<$core.String>? geoTargetConstants,
    $2.ValueRuleGeoLocationMatchTypeEnum_ValueRuleGeoLocationMatchType? geoMatchType,
  }) {
    final _result = create();
  ...
  'Use [GeneratedMessageGenericExtensions.rebuild] instead. '
  'Will be removed in next major version')
  ConversionValueRule_ValueRuleGeoLocationCondition copyWith(void Function(ConversionValueRule_ValueRuleGeoLocationCondition) updates) => super.copyWith((message) => updates(message as ConversionValueRule_ValueRuleGeoLocationCondition)) as ConversionValueRule_ValueRuleGeoLocationCondition; // ignore: deprecated_member_use
  $pb.BuilderInfo get info_ => _i;
  @$core.pragma('dart2js:noInline')
  ...
  @$pb.TagNumber(2)
  $2.ValueRuleGeoLocationMatchTypeEnum_ValueRuleGeoLocationMatchType get excludedGeoMatchType => $_getN(1);
  @$pb.TagNumber(2)
  set excludedGeoMatchType($2.ValueRuleGeoLocationMatchTypeEnum_ValueRuleGeoLocationMatchType v) { setField(2, v); }
  @$pb.TagNumber(2)
  ...
  @$pb.TagNumber(4)
  $2.ValueRuleGeoLocationMatchTypeEnum_ValueRuleGeoLocationMatchType get geoMatchType => $_getN(3);
  @$pb.TagNumber(4)
  set geoMatchType($2.ValueRuleGeoLocationMatchTypeEnum_ValueRuleGeoLocationMatchType v) { setField(4, v); }
  @$pb.TagNumber(4)
...
class ConversionValueRule_ValueRuleDeviceCondition extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'ConversionValueRule.ValueRuleDeviceCondition', package: const $pb.PackageName(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'google.ads.googleads.v8.resources'), createEmptyInstance: create)
    ..pc<$3.ValueRuleDeviceTypeEnum_ValueRuleDeviceType>(1, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'deviceTypes', $pb.PbFieldType.PE, valueOf: $3.ValueRuleDeviceTypeEnum_ValueRuleDeviceType.valueOf, enumValues: $3.ValueRuleDeviceTypeEnum_ValueRuleDeviceType.values)
    ..hasRequiredFields = false
  ;
  ...
  'Use [GeneratedMessageGenericExtensions.rebuild] instead. '
  'Will be removed in next major version')
  ConversionValueRule_ValueRuleDeviceCondition copyWith(void Function(ConversionValueRule_ValueRuleDeviceCondition) updates) => super.copyWith((message) => updates(message as ConversionValueRule_ValueRuleDeviceCondition)) as ConversionValueRule_ValueRuleDeviceCondition; // ignore: deprecated_member_use
  $pb.BuilderInfo get info_ => _i;
  @$core.pragma('dart2js:noInline')
  ...
  @$pb.TagNumber(1)
  $core.List<$3.ValueRuleDeviceTypeEnum_ValueRuleDeviceType> get deviceTypes => $_getList(0);
}

class ConversionValueRule_ValueRuleAudienceCondition extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'ConversionValueRule.ValueRuleAudienceCondition', package: const $pb.PackageName(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'google.ads.googleads.v8.resources'), createEmptyInstance: create)
    ..pPS(1, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'userLists')
    ..pPS(2, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'userInterests')
    ..hasRequiredFields = false
  ;
  ...
  'Use [GeneratedMessageGenericExtensions.rebuild] instead. '
  'Will be removed in next major version')
  ConversionValueRule_ValueRuleAudienceCondition copyWith(void Function(ConversionValueRule_ValueRuleAudienceCondition) updates) => super.copyWith((message) => updates(message as ConversionValueRule_ValueRuleAudienceCondition)) as ConversionValueRule_ValueRuleAudienceCondition; // ignore: deprecated_member_use
  $pb.BuilderInfo get info_ => _i;
  @$core.pragma('dart2js:noInline')
...
class ConversionValueRule extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'ConversionValueRule', package: const $pb.PackageName(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'google.ads.googleads.v8.resources'), createEmptyInstance: create)
    ...
    ..aOM<ConversionValueRule_ValueRuleAction>(3, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'action', subBuilder: ConversionValueRule_ValueRuleAction.create)
    ..aOM<ConversionValueRule_ValueRuleGeoLocationCondition>(4, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'geoLocationCondition', subBuilder: ConversionValueRule_ValueRuleGeoLocationCondition.create)
    ..aOM<ConversionValueRule_ValueRuleDeviceCondition>(5, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'deviceCondition', subBuilder: ConversionValueRule_ValueRuleDeviceCondition.create)
    ..aOM<ConversionValueRule_ValueRuleAudienceCondition>(6, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'audienceCondition', subBuilder: ConversionValueRule_ValueRuleAudienceCondition.create)
    ..aOS(7, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'ownerCustomer')
    ..e<$0.ConversionValueRuleStatusEnum_ConversionValueRuleStatus>(8, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'status', $pb.PbFieldType.OE, defaultOrMaker: $0.ConversionValueRuleStatusEnum_ConversionValueRuleStatus.UNSPECIFIED, valueOf: $0.ConversionValueRuleStatusEnum_ConversionValueRuleStatus.valueOf, enumValues: $0.ConversionValueRuleStatusEnum_ConversionValueRuleStatus.values)
    ..hasRequiredFields = false
  ;
  ...
  'Use [GeneratedMessageGenericExtensions.rebuild] instead. '
  'Will be removed in next major version')
  ConversionValueRule copyWith(void Function(ConversionValueRule) updates) => super.copyWith((message) => updates(message as ConversionValueRule)) as ConversionValueRule; // ignore: deprecated_member_use
  $pb.BuilderInfo get info_ => _i;
  @$core.pragma('dart2js:noInline')
  ...
  @$pb.TagNumber(8)
  $0.ConversionValueRuleStatusEnum_ConversionValueRuleStatus get status => $_getN(7);
  @$pb.TagNumber(8)
  set status($0.ConversionValueRuleStatusEnum_ConversionValueRuleStatus v) { setField(8, v); }
  @$pb.TagNumber(8)

...
class ImagePlaceholderFieldEnum_ImagePlaceholderField extends $pb.ProtobufEnum {
  static const ImagePlaceholderFieldEnum_ImagePlaceholderField UNSPECIFIED = ImagePlaceholderFieldEnum_ImagePlaceholderField._(0, const $core.bool.fromEnvironment('protobuf.omit_enum_names') ? '' : 'UNSPECIFIED');
  static const ImagePlaceholderFieldEnum_ImagePlaceholderField UNKNOWN = ImagePlaceholderFieldEnum_ImagePlaceholderField._(1, const $core.bool.fromEnvironment('protobuf.omit_enum_names') ? '' : 'UNKNOWN');
  static const ImagePlaceholderFieldEnum_ImagePlaceholderField ASSET_ID = ImagePlaceholderFieldEnum_ImagePlaceholderField._(2, const $core.bool.fromEnvironment('protobuf.omit_enum_names') ? '' : 'ASSET_ID');

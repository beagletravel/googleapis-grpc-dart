...
class ChatAppLogEntry extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'ChatAppLogEntry', package: const $pb.PackageName(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'google.chat.logging.v1'), createEmptyInstance: create)
  ...
  'Will be removed in next major version')
  ChatAppLogEntry copyWith(void Function(ChatAppLogEntry) updates) => super.copyWith((message) => updates(message as ChatAppLogEntry)) as ChatAppLogEntry; // ignore: deprecated_member_use

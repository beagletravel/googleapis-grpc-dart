...
class Four extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'Four', package: const $pb.PackageName(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'one.two.a_three.and'), createEmptyInstance: create)
    ..aOS(1, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'anotherString')
  ...
  factory Four({
    ...
    if (anotherString != null) {
      _result.anotherString = anotherString;
    }
    return _result;
  }
  ...
  @$pb.TagNumber(1)
  set anotherString($core.String v) { $_setString(0, v); }
  @$pb.TagNumber(1)
  $core.bool hasAnotherString() => $_has(0);
  @$pb.TagNumber(1)
  void clearAnotherString() => clearField(1);
}

...
class Aggregate extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'Aggregate', package: const $pb.PackageName(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'protobuf_unittest'), createEmptyInstance: create)
    ...
    ..aOM<$1.FileOptions>(4, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'file', subBuilder: $1.FileOptions.create)
    ...
    ..aOM<$2.Any>(6, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'any', subBuilder: $2.Any.create)
  ;
  ...
  @$pb.TagNumber(4)
  $1.FileOptions get file => $_getN(3);
  @$pb.TagNumber(4)
  set file($1.FileOptions v) { setField(4, v); }
  @$pb.TagNumber(4)
  $core.bool hasFile() => $_has(3);
  @$pb.TagNumber(4)
  void clearFile() => clearField(4);
  @$pb.TagNumber(4)
  $1.FileOptions ensureFile() => $_ensure(3);
  ...
  @$pb.TagNumber(6)
  $2.Any get any => $_getN(5);
  @$pb.TagNumber(6)
  set any($2.Any v) { setField(6, v); }
  @$pb.TagNumber(6)
  $core.bool hasAny() => $_has(5);
  @$pb.TagNumber(6)
  void clearAny() => clearField(6);
  @$pb.TagNumber(6)
  $2.Any ensureAny() => $_ensure(5);
}

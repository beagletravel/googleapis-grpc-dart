...
import 'unittest_import_public.pb.dart' as $1;
...
class TestAllTypes extends $pb.GeneratedMessage {
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'TestAllTypes', package: const $pb.PackageName(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'proto3_arena_lite_unittest'), createEmptyInstance: create)
    ...
    ..aOM<$1.PublicImportMessage>(26, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'optionalPublicImportMessage', subBuilder: $1.PublicImportMessage.create)
  ...
  factory TestAllTypes({
    ...
    $1.PublicImportMessage? optionalPublicImportMessage,
  ...
  @$pb.TagNumber(20)
  $0.ImportMessage get optionalImportMessage => $_getN(17);
  @$pb.TagNumber(20)
  ...
  @$pb.TagNumber(20)
  $0.ImportMessage ensureOptionalImportMessage() => $_ensure(17);
  ...
  @$pb.TagNumber(26)
  $1.PublicImportMessage get optionalPublicImportMessage => $_getN(22);
  @$pb.TagNumber(26)
  set optionalPublicImportMessage($1.PublicImportMessage v) { setField(26, v); }
  @$pb.TagNumber(26)
  $core.bool hasOptionalPublicImportMessage() => $_has(22);
  @$pb.TagNumber(26)
  void clearOptionalPublicImportMessage() => clearField(26);
  @$pb.TagNumber(26)
  $1.PublicImportMessage ensureOptionalPublicImportMessage() => $_ensure(22);
  ...
  @$pb.TagNumber(50)
  $core.List<$0.ImportMessage> get repeatedImportMessage => $_getList(41);

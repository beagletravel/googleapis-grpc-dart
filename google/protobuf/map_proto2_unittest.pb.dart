...
class TestImportEnumMap extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'TestImportEnumMap', package: const $pb.PackageName(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'protobuf_unittest'), createEmptyInstance: create)
    ..m<$core.int, $0.ImportEnumForMap>(1, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'importEnumAmp', entryClassName: 'TestImportEnumMap.ImportEnumAmpEntry', keyFieldType: $pb.PbFieldType.O3, valueFieldType: $pb.PbFieldType.OE, valueOf: $0.ImportEnumForMap.valueOf, enumValues: $0.ImportEnumForMap.values, packageName: const $pb.PackageName('protobuf_unittest'))
    ..hasRequiredFields = false
  ;

  TestImportEnumMap._() : super();
  factory TestImportEnumMap({
    $core.Map<$core.int, $0.ImportEnumForMap>? importEnumAmp,
  }) {
    final _result = create();
  ...
  @$pb.TagNumber(1)
  $core.Map<$core.int, $0.ImportEnumForMap> get importEnumAmp => $_getMap(0);
}

...
import 'unittest_lazy_dependencies_custom_option.pb.dart' as $0;
...
class ImportedMessage extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'ImportedMessage', package: const $pb.PackageName(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'protobuf_unittest.lazy_imports'), createEmptyInstance: create)
    ..aOM<$0.LazyMessage>(1, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'lazyMessage', subBuilder: $0.LazyMessage.create)
    ..hasRequiredFields = false
  ;

  ImportedMessage._() : super();
  factory ImportedMessage({
    $0.LazyMessage? lazyMessage,
  }) {
  ...
  @$pb.TagNumber(1)
  $0.LazyMessage get lazyMessage => $_getN(0);
  @$pb.TagNumber(1)
  set lazyMessage($0.LazyMessage v) { setField(1, v); }
  @$pb.TagNumber(1)
  $core.bool hasLazyMessage() => $_has(0);
  @$pb.TagNumber(1)
  void clearLazyMessage() => clearField(1);
  @$pb.TagNumber(1)
  $0.LazyMessage ensureLazyMessage() => $_ensure(0);
}

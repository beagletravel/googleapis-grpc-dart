...
class TrafficDirectorLogEntry extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'TrafficDirectorLogEntry', package: const $pb.PackageName(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'google.networking.trafficdirector.type'), createEmptyInstance: create)
    ..aOS(1, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'nodeId')
    ..aOS(2, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'nodeIp')
    ..aOS(4, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'description')
    ..e<TrafficDirectorLogEntry_ClientType>(5, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'clientType', $pb.PbFieldType.OE, defaultOrMaker: TrafficDirectorLogEntry_ClientType.CLIENT_TYPE_UNSPECIFIED, valueOf: TrafficDirectorLogEntry_ClientType.valueOf, enumValues: TrafficDirectorLogEntry_ClientType.values)
    ..aOS(6, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'clientVersion')
    ..e<TrafficDirectorLogEntry_TransportApiVersion>(7, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'transportApiVersion', $pb.PbFieldType.OE, defaultOrMaker: TrafficDirectorLogEntry_TransportApiVersion.TRANSPORT_API_VERSION_UNSPECIFIED, valueOf: TrafficDirectorLogEntry_TransportApiVersion.valueOf, enumValues: TrafficDirectorLogEntry_TransportApiVersion.values)
  ...
  'Will be removed in next major version')
  TrafficDirectorLogEntry copyWith(void Function(TrafficDirectorLogEntry) updates) => super.copyWith((message) => updates(message as TrafficDirectorLogEntry)) as TrafficDirectorLogEntry; // ignore: deprecated_member_use

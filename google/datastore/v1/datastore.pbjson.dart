...
const LookupRequest$json = const {
  '1': 'LookupRequest',
  '2': const [
    const {'1': 'project_id', '3': 8, '4': 1, '5': 9, '8': const {}, '10': 'projectId'},
    const {'1': 'read_options', '3': 1, '4': 1, '5': 11, '6': '.google.datastore.v1.ReadOptions', '10': 'readOptions'},
    const {'1': 'keys', '3': 3, '4': 3, '5': 11, '6': '.google.datastore.v1.Key', '8': const {}, '10': 'keys'},
  ],
};

/// Descriptor for `LookupRequest`. Decode as a `google.protobuf.DescriptorProto`.
final $typed_data.Uint8List lookupRequestDescriptor = $convert.base64Decode('Cg1Mb29rdXBSZXF1ZXN0EiIKCnByb2plY3RfaWQYCCABKAlCA+BBAlIJcHJvamVjdElkEkMKDHJlYWRfb3B0aW9ucxgBIAEoCzIgLmdvb2dsZS5kYXRhc3RvcmUudjEuUmVhZE9wdGlvbnNSC3JlYWRPcHRpb25zEjEKBGtleXMYAyADKAsyGC5nb29nbGUuZGF0YXN0b3JlLnYxLktleUID4EECUgRrZXlz');
...
const LookupResponse$json = const {
  ...
  '2': const [
    ...
    const {'1': 'read_time', '3': 7, '4': 1, '5': 11, '6': '.google.protobuf.Timestamp', '10': 'readTime'},
  ],
};

/// Descriptor for `LookupResponse`. Decode as a `google.protobuf.DescriptorProto`.
final $typed_data.Uint8List lookupResponseDescriptor = $convert.base64Decode('');
...
final $typed_data.Uint8List runQueryRequestDescriptor = $convert.base64Decode('');
...
final $typed_data.Uint8List runQueryResponseDescriptor = $convert.base64Decode('ChBSdW5RdWVyeVJlc3BvbnNlEjsKBWJhdGNoGAEgASgLMiUuZ29vZ2xlLmRhdGFzdG9yZS52MS5RdWVyeVJlc3VsdEJhdGNoUgViYXRjaBIwCgVxdWVyeRgCIAEoCzIaLmdvb2dsZS5kYXRhc3RvcmUudjEuUXVlcnlSBXF1ZXJ5');
...
final $typed_data.Uint8List beginTransactionRequestDescriptor = $convert.base64Decode('ChdCZWdpblRyYW5zYWN0aW9uUmVxdWVzdBIiCgpwcm9qZWN0X2lkGAggASgJQgPgQQJSCXByb2plY3RJZBJYChN0cmFuc2FjdGlvbl9vcHRpb25zGAogASgLMicuZ29vZ2xlLmRhdGFzdG9yZS52MS5UcmFuc2FjdGlvbk9wdGlvbnNSEnRyYW5zYWN0aW9uT3B0aW9ucw==');
...
const RollbackRequest$json = const {
  ...
  '2': const [
    const {'1': 'project_id', '3': 8, '4': 1, '5': 9, '8': const {}, '10': 'projectId'},
    const {'1': 'transaction', '3': 1, '4': 1, '5': 12, '8': const {}, '10': 'transaction'},
  ],
};

/// Descriptor for `RollbackRequest`. Decode as a `google.protobuf.DescriptorProto`.
final $typed_data.Uint8List rollbackRequestDescriptor = $convert.base64Decode('Cg9Sb2xsYmFja1JlcXVlc3QSIgoKcHJvamVjdF9pZBgIIAEoCUID4EECUglwcm9qZWN0SWQSJQoLdHJhbnNhY3Rpb24YASABKAxCA+BBAlILdHJhbnNhY3Rpb24=');
...
final $typed_data.Uint8List rollbackResponseDescriptor = $convert.base64Decode('ChBSb2xsYmFja1Jlc3BvbnNl');
...
const CommitResponse$json = const {
  ...
  '2': const [
    ...
    const {'1': 'commit_time', '3': 8, '4': 1, '5': 11, '6': '.google.protobuf.Timestamp', '10': 'commitTime'},
  ],
};

/// Descriptor for `CommitResponse`. Decode as a `google.protobuf.DescriptorProto`.
final $typed_data.Uint8List commitResponseDescriptor = $convert.base64Decode('');
@$core.Deprecated('Use allocateIdsRequestDescriptor instead')
const AllocateIdsRequest$json = const {
  '1': 'AllocateIdsRequest',
  '2': const [
    const {'1': 'project_id', '3': 8, '4': 1, '5': 9, '8': const {}, '10': 'projectId'},
    const {'1': 'keys', '3': 1, '4': 3, '5': 11, '6': '.google.datastore.v1.Key', '8': const {}, '10': 'keys'},
  ],
};

/// Descriptor for `AllocateIdsRequest`. Decode as a `google.protobuf.DescriptorProto`.
final $typed_data.Uint8List allocateIdsRequestDescriptor = $convert.base64Decode('ChJBbGxvY2F0ZUlkc1JlcXVlc3QSIgoKcHJvamVjdF9pZBgIIAEoCUID4EECUglwcm9qZWN0SWQSMQoEa2V5cxgBIAMoCzIYLmdvb2dsZS5kYXRhc3RvcmUudjEuS2V5QgPgQQJSBGtleXM=');
...
final $typed_data.Uint8List allocateIdsResponseDescriptor = $convert.base64Decode('ChNBbGxvY2F0ZUlkc1Jlc3BvbnNlEiwKBGtleXMYASADKAsyGC5nb29nbGUuZGF0YXN0b3JlLnYxLktleVIEa2V5cw==');
...
final $typed_data.Uint8List reserveIdsRequestDescriptor = $convert.base64Decode('ChFSZXNlcnZlSWRzUmVxdWVzdBIiCgpwcm9qZWN0X2lkGAggASgJQgPgQQJSCXByb2plY3RJZBIfCgtkYXRhYmFzZV9pZBgJIAEoCVIKZGF0YWJhc2VJZBIxCgRrZXlzGAEgAygLMhguZ29vZ2xlLmRhdGFzdG9yZS52MS5LZXlCA+BBAlIEa2V5cw==');
...
final $typed_data.Uint8List reserveIdsResponseDescriptor = $convert.base64Decode('ChJSZXNlcnZlSWRzUmVzcG9uc2U=');
...
const Mutation$json = const {
  ...
  '2': const [
    ...
    const {'1': 'update_time', '3': 11, '4': 1, '5': 11, '6': '.google.protobuf.Timestamp', '9': 1, '10': 'updateTime'},
  ],
  '8': const [
    const {'1': 'operation'},
...
final $typed_data.Uint8List mutationDescriptor = $convert.base64Decode('');
...
final $typed_data.Uint8List mutationResultDescriptor = $convert.base64Decode('');
...
const ReadOptions$json = const {
  ...
  '2': const [
    ...
    const {'1': 'read_time', '3': 4, '4': 1, '5': 11, '6': '.google.protobuf.Timestamp', '9': 0, '10': 'readTime'},
  ],
...
final $typed_data.Uint8List readOptionsDescriptor = $convert.base64Decode('');
...
final $typed_data.Uint8List transactionOptionsDescriptor = $convert.base64Decode('');

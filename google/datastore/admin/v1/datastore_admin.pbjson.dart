...
final $typed_data.Uint8List operationTypeDescriptor = $convert.base64Decode('Cg1PcGVyYXRpb25UeXBlEh4KGk9QRVJBVElPTl9UWVBFX1VOU1BFQ0lGSUVEEAASEwoPRVhQT1JUX0VOVElUSUVTEAESEwoPSU1QT1JUX0VOVElUSUVTEAISEAoMQ1JFQVRFX0lOREVYEAMSEAoMREVMRVRFX0lOREVYEAQ=');
...
final $typed_data.Uint8List commonMetadataDescriptor = $convert.base64Decode('');
...
final $typed_data.Uint8List progressDescriptor = $convert.base64Decode('CghQcm9ncmVzcxIlCg53b3JrX2NvbXBsZXRlZBgBIAEoA1INd29ya0NvbXBsZXRlZBIlCg53b3JrX2VzdGltYXRlZBgCIAEoA1INd29ya0VzdGltYXRlZA==');
...
const ExportEntitiesRequest$json = const {
  ...
  '2': const [
    ...
    const {'1': 'output_url_prefix', '3': 4, '4': 1, '5': 9, '8': const {}, '10': 'outputUrlPrefix'},
  ],
...
const ImportEntitiesRequest$json = const {
  ...
  '2': const [
    ...
    const {'1': 'input_url', '3': 3, '4': 1, '5': 9, '8': const {}, '10': 'inputUrl'},
...
final $typed_data.Uint8List importEntitiesRequestDescriptor = $convert.base64Decode('');
...
final $typed_data.Uint8List exportEntitiesResponseDescriptor = $convert.base64Decode('ChZFeHBvcnRFbnRpdGllc1Jlc3BvbnNlEh0KCm91dHB1dF91cmwYASABKAlSCW91dHB1dFVybA==');
...
final $typed_data.Uint8List exportEntitiesMetadataDescriptor = $convert.base64Decode('');
...
final $typed_data.Uint8List importEntitiesMetadataDescriptor = $convert.base64Decode('');
...
final $typed_data.Uint8List entityFilterDescriptor = $convert.base64Decode('CgxFbnRpdHlGaWx0ZXISFAoFa2luZHMYASADKAlSBWtpbmRzEiMKDW5hbWVzcGFjZV9pZHMYAiADKAlSDG5hbWVzcGFjZUlkcw==');
@$core.Deprecated('Use createIndexRequestDescriptor instead')
const CreateIndexRequest$json = const {
  '1': 'CreateIndexRequest',
  '2': const [
    const {'1': 'project_id', '3': 1, '4': 1, '5': 9, '10': 'projectId'},
    const {'1': 'index', '3': 3, '4': 1, '5': 11, '6': '.google.datastore.admin.v1.Index', '10': 'index'},
  ],
};

/// Descriptor for `CreateIndexRequest`. Decode as a `google.protobuf.DescriptorProto`.
final $typed_data.Uint8List createIndexRequestDescriptor = $convert.base64Decode('ChJDcmVhdGVJbmRleFJlcXVlc3QSHQoKcHJvamVjdF9pZBgBIAEoCVIJcHJvamVjdElkEjYKBWluZGV4GAMgASgLMiAuZ29vZ2xlLmRhdGFzdG9yZS5hZG1pbi52MS5JbmRleFIFaW5kZXg=');
...
final $typed_data.Uint8List deleteIndexRequestDescriptor = $convert.base64Decode('ChJEZWxldGVJbmRleFJlcXVlc3QSHQoKcHJvamVjdF9pZBgBIAEoCVIJcHJvamVjdElkEhkKCGluZGV4X2lkGAMgASgJUgdpbmRleElk');
...
final $typed_data.Uint8List getIndexRequestDescriptor = $convert.base64Decode('Cg9HZXRJbmRleFJlcXVlc3QSHQoKcHJvamVjdF9pZBgBIAEoCVIJcHJvamVjdElkEhkKCGluZGV4X2lkGAMgASgJUgdpbmRleElk');
...
final $typed_data.Uint8List listIndexesRequestDescriptor = $convert.base64Decode('ChJMaXN0SW5kZXhlc1JlcXVlc3QSHQoKcHJvamVjdF9pZBgBIAEoCVIJcHJvamVjdElkEhYKBmZpbHRlchgDIAEoCVIGZmlsdGVyEhsKCXBhZ2Vfc2l6ZRgEIAEoBVIIcGFnZVNpemUSHQoKcGFnZV90b2tlbhgFIAEoCVIJcGFnZVRva2Vu');
...
final $typed_data.Uint8List listIndexesResponseDescriptor = $convert.base64Decode('ChNMaXN0SW5kZXhlc1Jlc3BvbnNlEjoKB2luZGV4ZXMYASADKAsyIC5nb29nbGUuZGF0YXN0b3JlLmFkbWluLnYxLkluZGV4UgdpbmRleGVzEiYKD25leHRfcGFnZV90b2tlbhgCIAEoCVINbmV4dFBhZ2VUb2tlbg==');
...
const DatastoreFirestoreMigrationMetadata$json = const {
  ...
  '2': const [
    const {'1': 'migration_state', '3': 1, '4': 1, '5': 14, '6': '.google.datastore.admin.v1.MigrationState', '10': 'migrationState'},
    const {'1': 'migration_step', '3': 2, '4': 1, '5': 14, '6': '.google.datastore.admin.v1.MigrationStep', '10': 'migrationStep'},
  ],
};

/// Descriptor for `DatastoreFirestoreMigrationMetadata`. Decode as a `google.protobuf.DescriptorProto`.
final $typed_data.Uint8List datastoreFirestoreMigrationMetadataDescriptor = $convert.base64Decode('');

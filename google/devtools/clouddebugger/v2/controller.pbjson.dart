...
const RegisterDebuggeeRequest$json = const {
  ...
  '2': const [
    const {'1': 'debuggee', '3': 1, '4': 1, '5': 11, '6': '.google.devtools.clouddebugger.v2.Debuggee', '8': const {}, '10': 'debuggee'},
  ],
};

/// Descriptor for `RegisterDebuggeeRequest`. Decode as a `google.protobuf.DescriptorProto`.
final $typed_data.Uint8List registerDebuggeeRequestDescriptor = $convert.base64Decode('ChdSZWdpc3RlckRlYnVnZ2VlUmVxdWVzdBJLCghkZWJ1Z2dlZRgBIAEoCzIqLmdvb2dsZS5kZXZ0b29scy5jbG91ZGRlYnVnZ2VyLnYyLkRlYnVnZ2VlQgPgQQJSCGRlYnVnZ2Vl');
...
final $typed_data.Uint8List registerDebuggeeResponseDescriptor = $convert.base64Decode('ChhSZWdpc3RlckRlYnVnZ2VlUmVzcG9uc2USRgoIZGVidWdnZWUYASABKAsyKi5nb29nbGUuZGV2dG9vbHMuY2xvdWRkZWJ1Z2dlci52Mi5EZWJ1Z2dlZVIIZGVidWdnZWU=');
...
final $typed_data.Uint8List listActiveBreakpointsRequestDescriptor = $convert.base64Decode('ChxMaXN0QWN0aXZlQnJlYWtwb2ludHNSZXF1ZXN0EiQKC2RlYnVnZ2VlX2lkGAEgASgJQgPgQQJSCmRlYnVnZ2VlSWQSHQoKd2FpdF90b2tlbhgCIAEoCVIJd2FpdFRva2VuEiwKEnN1Y2Nlc3Nfb25fdGltZW91dBgDIAEoCFIQc3VjY2Vzc09uVGltZW91dA==');
...
final $typed_data.Uint8List listActiveBreakpointsResponseDescriptor = $convert.base64Decode('Ch1MaXN0QWN0aXZlQnJlYWtwb2ludHNSZXNwb25zZRJOCgticmVha3BvaW50cxgBIAMoCzIsLmdvb2dsZS5kZXZ0b29scy5jbG91ZGRlYnVnZ2VyLnYyLkJyZWFrcG9pbnRSC2JyZWFrcG9pbnRzEiYKD25leHRfd2FpdF90b2tlbhgCIAEoCVINbmV4dFdhaXRUb2tlbhIhCgx3YWl0X2V4cGlyZWQYAyABKAhSC3dhaXRFeHBpcmVk');
...
final $typed_data.Uint8List updateActiveBreakpointRequestDescriptor = $convert.base64Decode('Ch1VcGRhdGVBY3RpdmVCcmVha3BvaW50UmVxdWVzdBIkCgtkZWJ1Z2dlZV9pZBgBIAEoCUID4EECUgpkZWJ1Z2dlZUlkElEKCmJyZWFrcG9pbnQYAiABKAsyLC5nb29nbGUuZGV2dG9vbHMuY2xvdWRkZWJ1Z2dlci52Mi5CcmVha3BvaW50QgPgQQJSCmJyZWFrcG9pbnQ=');
...
final $typed_data.Uint8List updateActiveBreakpointResponseDescriptor = $convert.base64Decode('Ch5VcGRhdGVBY3RpdmVCcmVha3BvaW50UmVzcG9uc2U=');

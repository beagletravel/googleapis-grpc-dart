...
class PublishLifecycleEventRequest_ServiceLevel extends $pb.ProtobufEnum {
  static const PublishLifecycleEventRequest_ServiceLevel NONINTERACTIVE = PublishLifecycleEventRequest_ServiceLevel._(0, const $core.bool.fromEnvironment('protobuf.omit_enum_names') ? '' : 'NONINTERACTIVE');
  static const PublishLifecycleEventRequest_ServiceLevel INTERACTIVE = PublishLifecycleEventRequest_ServiceLevel._(1, const $core.bool.fromEnvironment('protobuf.omit_enum_names') ? '' : 'INTERACTIVE');

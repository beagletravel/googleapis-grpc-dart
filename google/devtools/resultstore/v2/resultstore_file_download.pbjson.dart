...
final $typed_data.Uint8List getFileRequestDescriptor = $convert.base64Decode('Cg5HZXRGaWxlUmVxdWVzdBIQCgN1cmkYASABKAlSA3VyaRIfCgtyZWFkX29mZnNldBgCIAEoA1IKcmVhZE9mZnNldBIdCgpyZWFkX2xpbWl0GAMgASgDUglyZWFkTGltaXQSIwoNYXJjaGl2ZV9lbnRyeRgEIAEoCVIMYXJjaGl2ZUVudHJ5');
...
final $typed_data.Uint8List getFileResponseDescriptor = $convert.base64Decode('Cg9HZXRGaWxlUmVzcG9uc2USEgoEZGF0YRgBIAEoDFIEZGF0YQ==');
...
final $typed_data.Uint8List getFileTailRequestDescriptor = $convert.base64Decode('ChJHZXRGaWxlVGFpbFJlcXVlc3QSEAoDdXJpGAEgASgJUgN1cmkSHwoLcmVhZF9vZmZzZXQYAiABKANSCnJlYWRPZmZzZXQSHQoKcmVhZF9saW1pdBgDIAEoA1IJcmVhZExpbWl0EiMKDWFyY2hpdmVfZW50cnkYBCABKAlSDGFyY2hpdmVFbnRyeQ==');
...
final $typed_data.Uint8List getFileTailResponseDescriptor = $convert.base64Decode('ChNHZXRGaWxlVGFpbFJlc3BvbnNlEhIKBGRhdGEYASABKAxSBGRhdGE=');

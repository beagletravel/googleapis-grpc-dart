...
const Invocation$json = const {
  ...
  '2': const [
    ...
    const {'1': 'aggregate_coverage', '3': 10, '4': 1, '5': 11, '6': '.google.devtools.resultstore.v2.AggregateCoverage', '10': 'aggregateCoverage'},
    const {'1': 'file_processing_errors', '3': 11, '4': 3, '5': 11, '6': '.google.devtools.resultstore.v2.FileProcessingErrors', '10': 'fileProcessingErrors'},
  ],
...
final $typed_data.Uint8List workspaceContextDescriptor = $convert.base64Decode('ChBXb3Jrc3BhY2VDb250ZXh0');
...
final $typed_data.Uint8List workspaceInfoDescriptor = $convert.base64Decode('');
...
final $typed_data.Uint8List commandLineDescriptor = $convert.base64Decode('CgtDb21tYW5kTGluZRIUCgVsYWJlbBgBIAEoCVIFbGFiZWwSEgoEdG9vbBgCIAEoCVIEdG9vbBISCgRhcmdzGAMgAygJUgRhcmdzEhgKB2NvbW1hbmQYBCABKAlSB2NvbW1hbmQ=');
...
final $typed_data.Uint8List invocationAttributesDescriptor = $convert.base64Decode('');
...
final $typed_data.Uint8List invocationContextDescriptor = $convert.base64Decode('ChFJbnZvY2F0aW9uQ29udGV4dBIhCgxkaXNwbGF5X25hbWUYASABKAlSC2Rpc3BsYXlOYW1lEhAKA3VybBgCIAEoCVIDdXJs');

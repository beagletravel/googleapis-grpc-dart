...
class TestSuite extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'TestSuite', package: const $pb.PackageName(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'google.devtools.resultstore.v2'), createEmptyInstance: create)
    ..aOS(1, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'suiteName')
    ..pc<Test>(2, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'tests', $pb.PbFieldType.PM, subBuilder: Test.create)
    ..pc<TestFailure>(3, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'failures', $pb.PbFieldType.PM, subBuilder: TestFailure.create)
    ..pc<TestError>(4, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'errors', $pb.PbFieldType.PM, subBuilder: TestError.create)
    ..aOM<$0.Timing>(6, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'timing', subBuilder: $0.Timing.create)
  ...
  'Will be removed in next major version')
  TestSuite copyWith(void Function(TestSuite) updates) => super.copyWith((message) => updates(message as TestSuite)) as TestSuite; // ignore: deprecated_member_use
  ...
  @$pb.TagNumber(1)
  set suiteName($core.String v) { $_setString(0, v); }
  @$pb.TagNumber(1)
  ...
  @$pb.TagNumber(6)
  set timing($0.Timing v) { setField(6, v); }
  @$pb.TagNumber(6)
...
class Test extends $pb.GeneratedMessage {
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'Test', package: const $pb.PackageName(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'google.devtools.resultstore.v2'), createEmptyInstance: create)
    ..oo(0, [1, 2])
    ..aOM<TestCase>(1, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'testCase', subBuilder: TestCase.create)
    ..aOM<TestSuite>(2, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'testSuite', subBuilder: TestSuite.create)
    ..hasRequiredFields = false
  ;
  ...
  @$pb.TagNumber(2)
  set testSuite(TestSuite v) { setField(2, v); }
  @$pb.TagNumber(2)
...
class TestCase extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'TestCase', package: const $pb.PackageName(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'google.devtools.resultstore.v2'), createEmptyInstance: create)
    ..aOS(1, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'caseName')
    ..aOS(2, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'className')
    ..e<TestCase_Result>(3, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'result', $pb.PbFieldType.OE, defaultOrMaker: TestCase_Result.RESULT_UNSPECIFIED, valueOf: TestCase_Result.valueOf, enumValues: TestCase_Result.values)
    ..pc<TestFailure>(4, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'failures', $pb.PbFieldType.PM, subBuilder: TestFailure.create)
    ..pc<TestError>(5, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'errors', $pb.PbFieldType.PM, subBuilder: TestError.create)
    ..aOM<$0.Timing>(7, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'timing', subBuilder: $0.Timing.create)
    ..pc<$0.Property>(8, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'properties', $pb.PbFieldType.PM, subBuilder: $0.Property.create)
    ..pc<$1.File>(9, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'files', $pb.PbFieldType.PM, subBuilder: $1.File.create)
    ..hasRequiredFields = false
  ;
  ...
  @$pb.TagNumber(1)
  set caseName($core.String v) { $_setString(0, v); }
  @$pb.TagNumber(1)
  ...
  @$pb.TagNumber(3)
  set result(TestCase_Result v) { setField(3, v); }
  @$pb.TagNumber(3)
  ...
  @$pb.TagNumber(7)
  set timing($0.Timing v) { setField(7, v); }
  @$pb.TagNumber(7)
...
class TestFailure extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'TestFailure', package: const $pb.PackageName(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'google.devtools.resultstore.v2'), createEmptyInstance: create)
    ..aOS(1, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'failureMessage')
    ..aOS(2, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'exceptionType')
    ..aOS(3, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'stackTrace')
    ..pPS(4, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'expected')
    ..pPS(5, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'actual')
    ..hasRequiredFields = false
  ;
  ...
  factory TestFailure.fromBuffer($core.List<$core.int> i, [$pb.ExtensionRegistry r = $pb.ExtensionRegistry.EMPTY]) => create()..mergeFromBuffer(i, r);
  factory TestFailure.fromJson($core.String i, [$pb.ExtensionRegistry r = $pb.ExtensionRegistry.EMPTY]) => create()..mergeFromJson(i, r);
  @$core.Deprecated(
  'Using this can add significant overhead to your binary. '
  'Use [GeneratedMessageGenericExtensions.deepCopy] instead. '
  'Will be removed in next major version')
  ...
  'Use [GeneratedMessageGenericExtensions.rebuild] instead. '
  'Will be removed in next major version')
  TestFailure copyWith(void Function(TestFailure) updates) => super.copyWith((message) => updates(message as TestFailure)) as TestFailure; // ignore: deprecated_member_use
  $pb.BuilderInfo get info_ => _i;
  @$core.pragma('dart2js:noInline')
  ...
  @$core.pragma('dart2js:noInline')
  static TestFailure getDefault() => _defaultInstance ??= $pb.GeneratedMessage.$_defaultFor<TestFailure>(create);
  static TestFailure? _defaultInstance;

  @$pb.TagNumber(1)
  $core.String get failureMessage => $_getSZ(0);
  @$pb.TagNumber(1)
  set failureMessage($core.String v) { $_setString(0, v); }
  @$pb.TagNumber(1)
...
class TestError extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'TestError', package: const $pb.PackageName(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'google.devtools.resultstore.v2'), createEmptyInstance: create)

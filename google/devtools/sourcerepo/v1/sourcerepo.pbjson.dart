...
final $typed_data.Uint8List repoDescriptor = $convert.base64Decode('CgRSZXBvEhIKBG5hbWUYASABKAlSBG5hbWUSEgoEc2l6ZRgCIAEoA1IEc2l6ZRIQCgN1cmwYAyABKAlSA3VybBJQCg1taXJyb3JfY29uZmlnGAQgASgLMisuZ29vZ2xlLmRldnRvb2xzLnNvdXJjZXJlcG8udjEuTWlycm9yQ29uZmlnUgxtaXJyb3JDb25maWc=');
...
final $typed_data.Uint8List mirrorConfigDescriptor = $convert.base64Decode('CgxNaXJyb3JDb25maWcSEAoDdXJsGAEgASgJUgN1cmwSHQoKd2ViaG9va19pZBgCIAEoCVIJd2ViaG9va0lkEiIKDWRlcGxveV9rZXlfaWQYAyABKAlSC2RlcGxveUtleUlk');
...
final $typed_data.Uint8List getRepoRequestDescriptor = $convert.base64Decode('Cg5HZXRSZXBvUmVxdWVzdBISCgRuYW1lGAEgASgJUgRuYW1l');
...
final $typed_data.Uint8List listReposRequestDescriptor = $convert.base64Decode('ChBMaXN0UmVwb3NSZXF1ZXN0EhIKBG5hbWUYASABKAlSBG5hbWUSGwoJcGFnZV9zaXplGAIgASgFUghwYWdlU2l6ZRIdCgpwYWdlX3Rva2VuGAMgASgJUglwYWdlVG9rZW4=');
...
final $typed_data.Uint8List listReposResponseDescriptor = $convert.base64Decode('ChFMaXN0UmVwb3NSZXNwb25zZRI5CgVyZXBvcxgBIAMoCzIjLmdvb2dsZS5kZXZ0b29scy5zb3VyY2VyZXBvLnYxLlJlcG9SBXJlcG9zEiYKD25leHRfcGFnZV90b2tlbhgCIAEoCVINbmV4dFBhZ2VUb2tlbg==');
...
final $typed_data.Uint8List createRepoRequestDescriptor = $convert.base64Decode('ChFDcmVhdGVSZXBvUmVxdWVzdBIWCgZwYXJlbnQYASABKAlSBnBhcmVudBI3CgRyZXBvGAIgASgLMiMuZ29vZ2xlLmRldnRvb2xzLnNvdXJjZXJlcG8udjEuUmVwb1IEcmVwbw==');
...
final $typed_data.Uint8List deleteRepoRequestDescriptor = $convert.base64Decode('ChFEZWxldGVSZXBvUmVxdWVzdBISCgRuYW1lGAEgASgJUgRuYW1l');

...
class Repository_MavenRepositoryConfig extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'Repository.MavenRepositoryConfig', package: const $pb.PackageName(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'google.devtools.artifactregistry.v1beta2'), createEmptyInstance: create)
    ..aOB(1, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'allowSnapshotOverwrites')
    ..e<Repository_MavenRepositoryConfig_VersionPolicy>(2, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'versionPolicy', $pb.PbFieldType.OE, defaultOrMaker: Repository_MavenRepositoryConfig_VersionPolicy.VERSION_POLICY_UNSPECIFIED, valueOf: Repository_MavenRepositoryConfig_VersionPolicy.valueOf, enumValues: Repository_MavenRepositoryConfig_VersionPolicy.values)
  ...
  factory Repository_MavenRepositoryConfig.fromBuffer($core.List<$core.int> i, [$pb.ExtensionRegistry r = $pb.ExtensionRegistry.EMPTY]) => create()..mergeFromBuffer(i, r);
  factory Repository_MavenRepositoryConfig.fromJson($core.String i, [$pb.ExtensionRegistry r = $pb.ExtensionRegistry.EMPTY]) => create()..mergeFromJson(i, r);
  @$core.Deprecated(
  'Using this can add significant overhead to your binary. '
  'Use [GeneratedMessageGenericExtensions.deepCopy] instead. '
  'Will be removed in next major version')
  Repository_MavenRepositoryConfig clone() => Repository_MavenRepositoryConfig()..mergeFromMessage(this);
  @$core.Deprecated(
  'Using this can add significant overhead to your binary. '
  'Use [GeneratedMessageGenericExtensions.rebuild] instead. '
  'Will be removed in next major version')
  Repository_MavenRepositoryConfig copyWith(void Function(Repository_MavenRepositoryConfig) updates) => super.copyWith((message) => updates(message as Repository_MavenRepositoryConfig)) as Repository_MavenRepositoryConfig; // ignore: deprecated_member_use
  $pb.BuilderInfo get info_ => _i;
  @$core.pragma('dart2js:noInline')
  static Repository_MavenRepositoryConfig create() => Repository_MavenRepositoryConfig._();
  Repository_MavenRepositoryConfig createEmptyInstance() => create();
  static $pb.PbList<Repository_MavenRepositoryConfig> createRepeated() => $pb.PbList<Repository_MavenRepositoryConfig>();
  @$core.pragma('dart2js:noInline')
  static Repository_MavenRepositoryConfig getDefault() => _defaultInstance ??= $pb.GeneratedMessage.$_defaultFor<Repository_MavenRepositoryConfig>(create);
  static Repository_MavenRepositoryConfig? _defaultInstance;

  @$pb.TagNumber(1)
  $core.bool get allowSnapshotOverwrites => $_getBF(0);
  @$pb.TagNumber(1)
  set allowSnapshotOverwrites($core.bool v) { $_setBool(0, v); }
  @$pb.TagNumber(1)
  ...
  @$pb.TagNumber(2)
  set versionPolicy(Repository_MavenRepositoryConfig_VersionPolicy v) { setField(2, v); }
  @$pb.TagNumber(2)
...
enum Repository_FormatConfig {
  mavenConfig, 
  notSet
}

class Repository extends $pb.GeneratedMessage {
  static const $core.Map<$core.int, Repository_FormatConfig> _Repository_FormatConfigByTag = {
    9 : Repository_FormatConfig.mavenConfig,
    0 : Repository_FormatConfig.notSet
  };
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'Repository', package: const $pb.PackageName(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'google.devtools.artifactregistry.v1beta2'), createEmptyInstance: create)
    ..oo(0, [9])
    ..aOS(1, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'name')
    ..e<Repository_Format>(2, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'format', $pb.PbFieldType.OE, defaultOrMaker: Repository_Format.FORMAT_UNSPECIFIED, valueOf: Repository_Format.valueOf, enumValues: Repository_Format.values)
    ..aOS(3, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'description')
    ..m<$core.String, $core.String>(4, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'labels', entryClassName: 'Repository.LabelsEntry', keyFieldType: $pb.PbFieldType.OS, valueFieldType: $pb.PbFieldType.OS, packageName: const $pb.PackageName('google.devtools.artifactregistry.v1beta2'))
    ...
    ..aOS(8, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'kmsKeyName')
    ..aOM<Repository_MavenRepositoryConfig>(9, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'mavenConfig', subBuilder: Repository_MavenRepositoryConfig.create)
    ..hasRequiredFields = false
  ;
  ...
  Repository_FormatConfig whichFormatConfig() => _Repository_FormatConfigByTag[$_whichOneof(0)]!;
  ...
  @$pb.TagNumber(2)
  set format(Repository_Format v) { setField(2, v); }
  @$pb.TagNumber(2)
  ...
  @$pb.TagNumber(9)
  set mavenConfig(Repository_MavenRepositoryConfig v) { setField(9, v); }
  @$pb.TagNumber(9)
...
class ListRepositoriesRequest extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'ListRepositoriesRequest', package: const $pb.PackageName(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'google.devtools.artifactregistry.v1beta2'), createEmptyInstance: create)
  ...
  'Use [GeneratedMessageGenericExtensions.rebuild] instead. '
  'Will be removed in next major version')
  ListRepositoriesRequest copyWith(void Function(ListRepositoriesRequest) updates) => super.copyWith((message) => updates(message as ListRepositoriesRequest)) as ListRepositoriesRequest; // ignore: deprecated_member_use
  $pb.BuilderInfo get info_ => _i;
  @$core.pragma('dart2js:noInline')
...
class ListRepositoriesResponse extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'ListRepositoriesResponse', package: const $pb.PackageName(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'google.devtools.artifactregistry.v1beta2'), createEmptyInstance: create)
    ..pc<Repository>(1, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'repositories', $pb.PbFieldType.PM, subBuilder: Repository.create)
  ...
  'Use [GeneratedMessageGenericExtensions.rebuild] instead. '
  'Will be removed in next major version')
  ListRepositoriesResponse copyWith(void Function(ListRepositoriesResponse) updates) => super.copyWith((message) => updates(message as ListRepositoriesResponse)) as ListRepositoriesResponse; // ignore: deprecated_member_use
  $pb.BuilderInfo get info_ => _i;
  @$core.pragma('dart2js:noInline')
...
class GetRepositoryRequest extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'GetRepositoryRequest', package: const $pb.PackageName(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'google.devtools.artifactregistry.v1beta2'), createEmptyInstance: create)
    ..aOS(1, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'name')
    ..hasRequiredFields = false
  ;
  ...
  'Use [GeneratedMessageGenericExtensions.rebuild] instead. '
  'Will be removed in next major version')
  GetRepositoryRequest copyWith(void Function(GetRepositoryRequest) updates) => super.copyWith((message) => updates(message as GetRepositoryRequest)) as GetRepositoryRequest; // ignore: deprecated_member_use
  $pb.BuilderInfo get info_ => _i;
  @$core.pragma('dart2js:noInline')
...
class CreateRepositoryRequest extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'CreateRepositoryRequest', package: const $pb.PackageName(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'google.devtools.artifactregistry.v1beta2'), createEmptyInstance: create)
    ..aOS(1, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'parent')
    ..aOS(2, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'repositoryId')
    ..aOM<Repository>(3, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'repository', subBuilder: Repository.create)
    ..hasRequiredFields = false
  ;
  ...
  'Use [GeneratedMessageGenericExtensions.rebuild] instead. '
  'Will be removed in next major version')
  CreateRepositoryRequest copyWith(void Function(CreateRepositoryRequest) updates) => super.copyWith((message) => updates(message as CreateRepositoryRequest)) as CreateRepositoryRequest; // ignore: deprecated_member_use
  $pb.BuilderInfo get info_ => _i;
  @$core.pragma('dart2js:noInline')
  ...
  @$pb.TagNumber(2)
  set repositoryId($core.String v) { $_setString(1, v); }
  @$pb.TagNumber(2)
  ...
  @$pb.TagNumber(3)
  set repository(Repository v) { setField(3, v); }
  @$pb.TagNumber(3)
...
class UpdateRepositoryRequest extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'UpdateRepositoryRequest', package: const $pb.PackageName(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'google.devtools.artifactregistry.v1beta2'), createEmptyInstance: create)
    ..aOM<Repository>(1, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'repository', subBuilder: Repository.create)
  ...
  'Use [GeneratedMessageGenericExtensions.rebuild] instead. '
  'Will be removed in next major version')
  UpdateRepositoryRequest copyWith(void Function(UpdateRepositoryRequest) updates) => super.copyWith((message) => updates(message as UpdateRepositoryRequest)) as UpdateRepositoryRequest; // ignore: deprecated_member_use
  $pb.BuilderInfo get info_ => _i;
  @$core.pragma('dart2js:noInline')
  ...
  @$pb.TagNumber(1)
  set repository(Repository v) { setField(1, v); }
  @$pb.TagNumber(1)
...
class DeleteRepositoryRequest extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'DeleteRepositoryRequest', package: const $pb.PackageName(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'google.devtools.artifactregistry.v1beta2'), createEmptyInstance: create)
    ..aOS(1, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'name')
    ..hasRequiredFields = false
  ;
  ...
  'Use [GeneratedMessageGenericExtensions.rebuild] instead. '
  'Will be removed in next major version')
  DeleteRepositoryRequest copyWith(void Function(DeleteRepositoryRequest) updates) => super.copyWith((message) => updates(message as DeleteRepositoryRequest)) as DeleteRepositoryRequest; // ignore: deprecated_member_use
  $pb.BuilderInfo get info_ => _i;
  @$core.pragma('dart2js:noInline')

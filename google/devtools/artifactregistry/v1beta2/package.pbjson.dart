...
final $typed_data.Uint8List listPackagesRequestDescriptor = $convert.base64Decode('ChNMaXN0UGFja2FnZXNSZXF1ZXN0EhYKBnBhcmVudBgBIAEoCVIGcGFyZW50EhsKCXBhZ2Vfc2l6ZRgCIAEoBVIIcGFnZVNpemUSHQoKcGFnZV90b2tlbhgDIAEoCVIJcGFnZVRva2Vu');
@$core.Deprecated('Use listPackagesResponseDescriptor instead')
const ListPackagesResponse$json = const {
  '1': 'ListPackagesResponse',
  '2': const [
    const {'1': 'packages', '3': 1, '4': 3, '5': 11, '6': '.google.devtools.artifactregistry.v1beta2.Package', '10': 'packages'},
    const {'1': 'next_page_token', '3': 2, '4': 1, '5': 9, '10': 'nextPageToken'},
  ],
};

/// Descriptor for `ListPackagesResponse`. Decode as a `google.protobuf.DescriptorProto`.
final $typed_data.Uint8List listPackagesResponseDescriptor = $convert.base64Decode('ChRMaXN0UGFja2FnZXNSZXNwb25zZRJNCghwYWNrYWdlcxgBIAMoCzIxLmdvb2dsZS5kZXZ0b29scy5hcnRpZmFjdHJlZ2lzdHJ5LnYxYmV0YTIuUGFja2FnZVIIcGFja2FnZXMSJgoPbmV4dF9wYWdlX3Rva2VuGAIgASgJUg1uZXh0UGFnZVRva2Vu');
...
final $typed_data.Uint8List getPackageRequestDescriptor = $convert.base64Decode('ChFHZXRQYWNrYWdlUmVxdWVzdBISCgRuYW1lGAEgASgJUgRuYW1l');
...
final $typed_data.Uint8List deletePackageRequestDescriptor = $convert.base64Decode('ChREZWxldGVQYWNrYWdlUmVxdWVzdBISCgRuYW1lGAEgASgJUgRuYW1l');

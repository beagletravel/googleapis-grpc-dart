...
final $typed_data.Uint8List sourceContextDescriptor = $convert.base64Decode('');
...
final $typed_data.Uint8List extendedSourceContextDescriptor = $convert.base64Decode('');
...
final $typed_data.Uint8List aliasContextDescriptor = $convert.base64Decode('CgxBbGlhc0NvbnRleHQSQAoEa2luZBgBIAEoDjIsLmdvb2dsZS5kZXZ0b29scy5zb3VyY2UudjEuQWxpYXNDb250ZXh0LktpbmRSBGtpbmQSEgoEbmFtZRgCIAEoCVIEbmFtZSIyCgRLaW5kEgcKA0FOWRAAEgkKBUZJWEVEEAESCwoHTU9WQUJMRRACEgkKBU9USEVSEAQ=');
...
final $typed_data.Uint8List cloudRepoSourceContextDescriptor = $convert.base64Decode('');
...
final $typed_data.Uint8List cloudWorkspaceSourceContextDescriptor = $convert.base64Decode('ChtDbG91ZFdvcmtzcGFjZVNvdXJjZUNvbnRleHQSTgoMd29ya3NwYWNlX2lkGAEgASgLMisuZ29vZ2xlLmRldnRvb2xzLnNvdXJjZS52MS5DbG91ZFdvcmtzcGFjZUlkUgt3b3Jrc3BhY2VJZBIfCgtzbmFwc2hvdF9pZBgCIAEoCVIKc25hcHNob3RJZA==');
...
final $typed_data.Uint8List gerritSourceContextDescriptor = $convert.base64Decode('');
...
final $typed_data.Uint8List gitSourceContextDescriptor = $convert.base64Decode('ChBHaXRTb3VyY2VDb250ZXh0EhAKA3VybBgBIAEoCVIDdXJsEh8KC3JldmlzaW9uX2lkGAIgASgJUgpyZXZpc2lvbklk');
...
final $typed_data.Uint8List repoIdDescriptor = $convert.base64Decode('CgZSZXBvSWQSUgoPcHJvamVjdF9yZXBvX2lkGAEgASgLMiguZ29vZ2xlLmRldnRvb2xzLnNvdXJjZS52MS5Qcm9qZWN0UmVwb0lkSABSDXByb2plY3RSZXBvSWQSEgoDdWlkGAIgASgJSABSA3VpZEIECgJpZA==');
...
final $typed_data.Uint8List projectRepoIdDescriptor = $convert.base64Decode('Cg1Qcm9qZWN0UmVwb0lkEh0KCnByb2plY3RfaWQYASABKAlSCXByb2plY3RJZBIbCglyZXBvX25hbWUYAiABKAlSCHJlcG9OYW1l');
...
final $typed_data.Uint8List cloudWorkspaceIdDescriptor = $convert.base64Decode('ChBDbG91ZFdvcmtzcGFjZUlkEjoKB3JlcG9faWQYASABKAsyIS5nb29nbGUuZGV2dG9vbHMuc291cmNlLnYxLlJlcG9JZFIGcmVwb0lkEhIKBG5hbWUYAiABKAlSBG5hbWU=');

...
class Layer extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'Layer', package: const $pb.PackageName(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'grafeas.v1beta1.image'), createEmptyInstance: create)
    ..e<Layer_Directive>(1, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'directive', $pb.PbFieldType.OE, defaultOrMaker: Layer_Directive.DIRECTIVE_UNSPECIFIED, valueOf: Layer_Directive.valueOf, enumValues: Layer_Directive.values)
    ..aOS(2, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'arguments')
...
class Fingerprint extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'Fingerprint', package: const $pb.PackageName(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'grafeas.v1beta1.image'), createEmptyInstance: create)
    ..aOS(1, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'v1Name')
    ..pPS(2, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'v2Blob')
    ..aOS(3, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'v2Name')
    ..hasRequiredFields = false
  ;
...
class Basis extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'Basis', package: const $pb.PackageName(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'grafeas.v1beta1.image'), createEmptyInstance: create)
    ..aOS(1, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'resourceUrl')
    ..aOM<Fingerprint>(2, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'fingerprint', subBuilder: Fingerprint.create)
    ..hasRequiredFields = false
  ;
  ...
  factory Basis.fromBuffer($core.List<$core.int> i, [$pb.ExtensionRegistry r = $pb.ExtensionRegistry.EMPTY]) => create()..mergeFromBuffer(i, r);
  factory Basis.fromJson($core.String i, [$pb.ExtensionRegistry r = $pb.ExtensionRegistry.EMPTY]) => create()..mergeFromJson(i, r);
  @$core.Deprecated(
  'Using this can add significant overhead to your binary. '
  'Use [GeneratedMessageGenericExtensions.deepCopy] instead. '
  'Will be removed in next major version')
  ...
  'Use [GeneratedMessageGenericExtensions.rebuild] instead. '
  'Will be removed in next major version')
  Basis copyWith(void Function(Basis) updates) => super.copyWith((message) => updates(message as Basis)) as Basis; // ignore: deprecated_member_use
  $pb.BuilderInfo get info_ => _i;
  @$core.pragma('dart2js:noInline')
  ...
  @$core.pragma('dart2js:noInline')
  static Basis getDefault() => _defaultInstance ??= $pb.GeneratedMessage.$_defaultFor<Basis>(create);
...
class Details extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'Details', package: const $pb.PackageName(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'grafeas.v1beta1.image'), createEmptyInstance: create)
    ..aOM<Derived>(1, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'derivedImage', subBuilder: Derived.create)
    ..hasRequiredFields = false
  ;
...
class Derived extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'Derived', package: const $pb.PackageName(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'grafeas.v1beta1.image'), createEmptyInstance: create)
    ..aOM<Fingerprint>(1, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'fingerprint', subBuilder: Fingerprint.create)
    ..a<$core.int>(2, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'distance', $pb.PbFieldType.O3)
    ..pc<Layer>(3, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'layerInfo', $pb.PbFieldType.PM, subBuilder: Layer.create)
    ..aOS(4, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'baseResourceUrl')
    ..hasRequiredFields = false
  ;
  ...
  factory Derived.fromBuffer($core.List<$core.int> i, [$pb.ExtensionRegistry r = $pb.ExtensionRegistry.EMPTY]) => create()..mergeFromBuffer(i, r);
  factory Derived.fromJson($core.String i, [$pb.ExtensionRegistry r = $pb.ExtensionRegistry.EMPTY]) => create()..mergeFromJson(i, r);
  @$core.Deprecated(
  'Using this can add significant overhead to your binary. '
  'Use [GeneratedMessageGenericExtensions.deepCopy] instead. '
  'Will be removed in next major version')
  ...
  'Use [GeneratedMessageGenericExtensions.rebuild] instead. '
  'Will be removed in next major version')
  Derived copyWith(void Function(Derived) updates) => super.copyWith((message) => updates(message as Derived)) as Derived; // ignore: deprecated_member_use
  $pb.BuilderInfo get info_ => _i;
  @$core.pragma('dart2js:noInline')
  ...
  @$core.pragma('dart2js:noInline')
  static Derived getDefault() => _defaultInstance ??= $pb.GeneratedMessage.$_defaultFor<Derived>(create);

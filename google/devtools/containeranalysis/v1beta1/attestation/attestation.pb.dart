...
class PgpSignedAttestation extends $pb.GeneratedMessage {
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'PgpSignedAttestation', package: const $pb.PackageName(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'grafeas.v1beta1.attestation'), createEmptyInstance: create)
    ..oo(0, [2])
    ..aOS(1, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'signature')
    ..aOS(2, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'pgpKeyId')
    ..e<PgpSignedAttestation_ContentType>(3, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'contentType', $pb.PbFieldType.OE, defaultOrMaker: PgpSignedAttestation_ContentType.CONTENT_TYPE_UNSPECIFIED, valueOf: PgpSignedAttestation_ContentType.valueOf, enumValues: PgpSignedAttestation_ContentType.values)
  ...
  factory PgpSignedAttestation.fromBuffer($core.List<$core.int> i, [$pb.ExtensionRegistry r = $pb.ExtensionRegistry.EMPTY]) => create()..mergeFromBuffer(i, r);
  factory PgpSignedAttestation.fromJson($core.String i, [$pb.ExtensionRegistry r = $pb.ExtensionRegistry.EMPTY]) => create()..mergeFromJson(i, r);
  @$core.Deprecated(
  ...
  'Will be removed in next major version')
  PgpSignedAttestation copyWith(void Function(PgpSignedAttestation) updates) => super.copyWith((message) => updates(message as PgpSignedAttestation)) as PgpSignedAttestation; // ignore: deprecated_member_use
  ...
  @$core.pragma('dart2js:noInline')
  static PgpSignedAttestation getDefault() => _defaultInstance ??= $pb.GeneratedMessage.$_defaultFor<PgpSignedAttestation>(create);
...
class GenericSignedAttestation extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'GenericSignedAttestation', package: const $pb.PackageName(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'grafeas.v1beta1.attestation'), createEmptyInstance: create)
    ..e<GenericSignedAttestation_ContentType>(1, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'contentType', $pb.PbFieldType.OE, defaultOrMaker: GenericSignedAttestation_ContentType.CONTENT_TYPE_UNSPECIFIED, valueOf: GenericSignedAttestation_ContentType.valueOf, enumValues: GenericSignedAttestation_ContentType.values)
    ..a<$core.List<$core.int>>(2, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'serializedPayload', $pb.PbFieldType.OY)
    ..pc<$0.Signature>(3, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'signatures', $pb.PbFieldType.PM, subBuilder: $0.Signature.create)
    ..hasRequiredFields = false
  ;
  ...
  factory GenericSignedAttestation.fromBuffer($core.List<$core.int> i, [$pb.ExtensionRegistry r = $pb.ExtensionRegistry.EMPTY]) => create()..mergeFromBuffer(i, r);
  factory GenericSignedAttestation.fromJson($core.String i, [$pb.ExtensionRegistry r = $pb.ExtensionRegistry.EMPTY]) => create()..mergeFromJson(i, r);
  @$core.Deprecated(
  'Using this can add significant overhead to your binary. '
  'Use [GeneratedMessageGenericExtensions.deepCopy] instead. '
  'Will be removed in next major version')
  GenericSignedAttestation clone() => GenericSignedAttestation()..mergeFromMessage(this);
  @$core.Deprecated(
  'Using this can add significant overhead to your binary. '
  'Use [GeneratedMessageGenericExtensions.rebuild] instead. '
  'Will be removed in next major version')
  GenericSignedAttestation copyWith(void Function(GenericSignedAttestation) updates) => super.copyWith((message) => updates(message as GenericSignedAttestation)) as GenericSignedAttestation; // ignore: deprecated_member_use
  $pb.BuilderInfo get info_ => _i;
  @$core.pragma('dart2js:noInline')
  static GenericSignedAttestation create() => GenericSignedAttestation._();
  GenericSignedAttestation createEmptyInstance() => create();
  static $pb.PbList<GenericSignedAttestation> createRepeated() => $pb.PbList<GenericSignedAttestation>();
  @$core.pragma('dart2js:noInline')
  static GenericSignedAttestation getDefault() => _defaultInstance ??= $pb.GeneratedMessage.$_defaultFor<GenericSignedAttestation>(create);
  static GenericSignedAttestation? _defaultInstance;

  @$pb.TagNumber(1)
  GenericSignedAttestation_ContentType get contentType => $_getN(0);
  @$pb.TagNumber(1)
  set contentType(GenericSignedAttestation_ContentType v) { setField(1, v); }
  @$pb.TagNumber(1)
  ...
  @$pb.TagNumber(2)
  set serializedPayload($core.List<$core.int> v) { $_setBytes(1, v); }
  @$pb.TagNumber(2)
...
class Authority_Hint extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'Authority.Hint', package: const $pb.PackageName(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'grafeas.v1beta1.attestation'), createEmptyInstance: create)
    ..aOS(1, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'humanReadableName')
    ..hasRequiredFields = false
  ;
  ...
  factory Authority_Hint.fromBuffer($core.List<$core.int> i, [$pb.ExtensionRegistry r = $pb.ExtensionRegistry.EMPTY]) => create()..mergeFromBuffer(i, r);
  factory Authority_Hint.fromJson($core.String i, [$pb.ExtensionRegistry r = $pb.ExtensionRegistry.EMPTY]) => create()..mergeFromJson(i, r);
  @$core.Deprecated(
  'Using this can add significant overhead to your binary. '
  'Use [GeneratedMessageGenericExtensions.deepCopy] instead. '
  'Will be removed in next major version')
  ...
  'Use [GeneratedMessageGenericExtensions.rebuild] instead. '
  'Will be removed in next major version')
  Authority_Hint copyWith(void Function(Authority_Hint) updates) => super.copyWith((message) => updates(message as Authority_Hint)) as Authority_Hint; // ignore: deprecated_member_use
  $pb.BuilderInfo get info_ => _i;
  @$core.pragma('dart2js:noInline')
  static Authority_Hint create() => Authority_Hint._();
  Authority_Hint createEmptyInstance() => create();
  static $pb.PbList<Authority_Hint> createRepeated() => $pb.PbList<Authority_Hint>();
  @$core.pragma('dart2js:noInline')
  static Authority_Hint getDefault() => _defaultInstance ??= $pb.GeneratedMessage.$_defaultFor<Authority_Hint>(create);
...
class Authority extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'Authority', package: const $pb.PackageName(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'grafeas.v1beta1.attestation'), createEmptyInstance: create)
    ..aOM<Authority_Hint>(1, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'hint', subBuilder: Authority_Hint.create)
    ..hasRequiredFields = false
  ;
  ...
  @$pb.TagNumber(1)
  set hint(Authority_Hint v) { setField(1, v); }
  @$pb.TagNumber(1)
...
class Details extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'Details', package: const $pb.PackageName(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'grafeas.v1beta1.attestation'), createEmptyInstance: create)
    ..aOM<Attestation>(1, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'attestation', subBuilder: Attestation.create)
    ..hasRequiredFields = false
  ;
  ...
  @$pb.TagNumber(1)
  set attestation(Attestation v) { setField(1, v); }
  @$pb.TagNumber(1)
...
class Attestation extends $pb.GeneratedMessage {
  static const $core.Map<$core.int, Attestation_Signature> _Attestation_SignatureByTag = {
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'Attestation', package: const $pb.PackageName(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'grafeas.v1beta1.attestation'), createEmptyInstance: create)
    ..oo(0, [1, 2])
    ..aOM<PgpSignedAttestation>(1, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'pgpSignedAttestation', subBuilder: PgpSignedAttestation.create)
    ..aOM<GenericSignedAttestation>(2, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'genericSignedAttestation', subBuilder: GenericSignedAttestation.create)
    ..hasRequiredFields = false
  ;
  ...
  Attestation_Signature whichSignature() => _Attestation_SignatureByTag[$_whichOneof(0)]!;
  ...
  @$pb.TagNumber(2)
  set genericSignedAttestation(GenericSignedAttestation v) { setField(2, v); }
  @$pb.TagNumber(2)

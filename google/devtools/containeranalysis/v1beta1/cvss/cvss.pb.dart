...
class CVSSv3 extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'CVSSv3', package: const $pb.PackageName(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'grafeas.v1beta1.vulnerability'), createEmptyInstance: create)
    ..a<$core.double>(1, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'baseScore', $pb.PbFieldType.OF)
    ..a<$core.double>(2, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'exploitabilityScore', $pb.PbFieldType.OF)
    ..a<$core.double>(3, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'impactScore', $pb.PbFieldType.OF)
    ..e<CVSSv3_AttackVector>(5, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'attackVector', $pb.PbFieldType.OE, defaultOrMaker: CVSSv3_AttackVector.ATTACK_VECTOR_UNSPECIFIED, valueOf: CVSSv3_AttackVector.valueOf, enumValues: CVSSv3_AttackVector.values)
    ..e<CVSSv3_AttackComplexity>(6, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'attackComplexity', $pb.PbFieldType.OE, defaultOrMaker: CVSSv3_AttackComplexity.ATTACK_COMPLEXITY_UNSPECIFIED, valueOf: CVSSv3_AttackComplexity.valueOf, enumValues: CVSSv3_AttackComplexity.values)
    ..e<CVSSv3_PrivilegesRequired>(7, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'privilegesRequired', $pb.PbFieldType.OE, defaultOrMaker: CVSSv3_PrivilegesRequired.PRIVILEGES_REQUIRED_UNSPECIFIED, valueOf: CVSSv3_PrivilegesRequired.valueOf, enumValues: CVSSv3_PrivilegesRequired.values)
    ..e<CVSSv3_UserInteraction>(8, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'userInteraction', $pb.PbFieldType.OE, defaultOrMaker: CVSSv3_UserInteraction.USER_INTERACTION_UNSPECIFIED, valueOf: CVSSv3_UserInteraction.valueOf, enumValues: CVSSv3_UserInteraction.values)
    ..e<CVSSv3_Scope>(9, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'scope', $pb.PbFieldType.OE, defaultOrMaker: CVSSv3_Scope.SCOPE_UNSPECIFIED, valueOf: CVSSv3_Scope.valueOf, enumValues: CVSSv3_Scope.values)
    ..e<CVSSv3_Impact>(10, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'confidentialityImpact', $pb.PbFieldType.OE, defaultOrMaker: CVSSv3_Impact.IMPACT_UNSPECIFIED, valueOf: CVSSv3_Impact.valueOf, enumValues: CVSSv3_Impact.values)
    ..e<CVSSv3_Impact>(11, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'integrityImpact', $pb.PbFieldType.OE, defaultOrMaker: CVSSv3_Impact.IMPACT_UNSPECIFIED, valueOf: CVSSv3_Impact.valueOf, enumValues: CVSSv3_Impact.values)
    ..e<CVSSv3_Impact>(12, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'availabilityImpact', $pb.PbFieldType.OE, defaultOrMaker: CVSSv3_Impact.IMPACT_UNSPECIFIED, valueOf: CVSSv3_Impact.valueOf, enumValues: CVSSv3_Impact.values)
  ...
  'Will be removed in next major version')
  CVSSv3 copyWith(void Function(CVSSv3) updates) => super.copyWith((message) => updates(message as CVSSv3)) as CVSSv3; // ignore: deprecated_member_use
  ...
  @$pb.TagNumber(1)
  set baseScore($core.double v) { $_setFloat(0, v); }
  @$pb.TagNumber(1)
  ...
  @$pb.TagNumber(2)
  set exploitabilityScore($core.double v) { $_setFloat(1, v); }
  @$pb.TagNumber(2)
  ...
  @$pb.TagNumber(3)
  set impactScore($core.double v) { $_setFloat(2, v); }
  @$pb.TagNumber(3)

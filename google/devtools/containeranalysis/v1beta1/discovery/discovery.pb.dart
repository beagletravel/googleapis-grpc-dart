...
class Discovery extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'Discovery', package: const $pb.PackageName(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'grafeas.v1beta1.discovery'), createEmptyInstance: create)
    ..e<$2.NoteKind>(1, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'analysisKind', $pb.PbFieldType.OE, defaultOrMaker: $2.NoteKind.NOTE_KIND_UNSPECIFIED, valueOf: $2.NoteKind.valueOf, enumValues: $2.NoteKind.values)
  ...
  @$pb.TagNumber(1)
  set analysisKind($2.NoteKind v) { setField(1, v); }
  @$pb.TagNumber(1)
...
class Details extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'Details', package: const $pb.PackageName(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'grafeas.v1beta1.discovery'), createEmptyInstance: create)
    ..aOM<Discovered>(1, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'discovered', subBuilder: Discovered.create)
    ..hasRequiredFields = false
  ;
  ...
  @$pb.TagNumber(1)
  set discovered(Discovered v) { setField(1, v); }
  @$pb.TagNumber(1)
...
class Discovered extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'Discovered', package: const $pb.PackageName(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'grafeas.v1beta1.discovery'), createEmptyInstance: create)
    ..e<Discovered_ContinuousAnalysis>(1, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'continuousAnalysis', $pb.PbFieldType.OE, defaultOrMaker: Discovered_ContinuousAnalysis.CONTINUOUS_ANALYSIS_UNSPECIFIED, valueOf: Discovered_ContinuousAnalysis.valueOf, enumValues: Discovered_ContinuousAnalysis.values)
    ..aOM<$0.Timestamp>(2, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'lastAnalysisTime', subBuilder: $0.Timestamp.create)
    ..e<Discovered_AnalysisStatus>(3, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'analysisStatus', $pb.PbFieldType.OE, defaultOrMaker: Discovered_AnalysisStatus.ANALYSIS_STATUS_UNSPECIFIED, valueOf: Discovered_AnalysisStatus.valueOf, enumValues: Discovered_AnalysisStatus.values)
    ..aOM<$1.Status>(4, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'analysisStatusError', subBuilder: $1.Status.create)
    ..hasRequiredFields = false
  ;
  ...
  factory Discovered.fromBuffer($core.List<$core.int> i, [$pb.ExtensionRegistry r = $pb.ExtensionRegistry.EMPTY]) => create()..mergeFromBuffer(i, r);
  factory Discovered.fromJson($core.String i, [$pb.ExtensionRegistry r = $pb.ExtensionRegistry.EMPTY]) => create()..mergeFromJson(i, r);
  @$core.Deprecated(
  'Using this can add significant overhead to your binary. '
  'Use [GeneratedMessageGenericExtensions.deepCopy] instead. '
  'Will be removed in next major version')
  ...
  'Use [GeneratedMessageGenericExtensions.rebuild] instead. '
  'Will be removed in next major version')
  Discovered copyWith(void Function(Discovered) updates) => super.copyWith((message) => updates(message as Discovered)) as Discovered; // ignore: deprecated_member_use
  $pb.BuilderInfo get info_ => _i;
  @$core.pragma('dart2js:noInline')
  ...
  @$core.pragma('dart2js:noInline')
  static Discovered getDefault() => _defaultInstance ??= $pb.GeneratedMessage.$_defaultFor<Discovered>(create);
  static Discovered? _defaultInstance;

  @$pb.TagNumber(1)
  Discovered_ContinuousAnalysis get continuousAnalysis => $_getN(0);
  @$pb.TagNumber(1)
  set continuousAnalysis(Discovered_ContinuousAnalysis v) { setField(1, v); }
  @$pb.TagNumber(1)
  ...
  @$pb.TagNumber(2)
  set lastAnalysisTime($0.Timestamp v) { setField(2, v); }
  @$pb.TagNumber(2)
  ...
  @$pb.TagNumber(3)
  set analysisStatus(Discovered_AnalysisStatus v) { setField(3, v); }
  @$pb.TagNumber(3)
  ...
  @$pb.TagNumber(4)
  set analysisStatusError($1.Status v) { setField(4, v); }
  @$pb.TagNumber(4)

...
class Span_Attributes extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'Span.Attributes', package: const $pb.PackageName(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'google.devtools.cloudtrace.v2'), createEmptyInstance: create)
    ..m<$core.String, AttributeValue>(1, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'attributeMap', entryClassName: 'Span.Attributes.AttributeMapEntry', keyFieldType: $pb.PbFieldType.OS, valueFieldType: $pb.PbFieldType.OM, valueCreator: AttributeValue.create, packageName: const $pb.PackageName('google.devtools.cloudtrace.v2'))
    ..a<$core.int>(2, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'droppedAttributesCount', $pb.PbFieldType.O3)
  ...
  'Will be removed in next major version')
  Span_Attributes copyWith(void Function(Span_Attributes) updates) => super.copyWith((message) => updates(message as Span_Attributes)) as Span_Attributes; // ignore: deprecated_member_use
...
class Span_TimeEvent_Annotation extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'Span.TimeEvent.Annotation', package: const $pb.PackageName(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'google.devtools.cloudtrace.v2'), createEmptyInstance: create)
    ..aOM<TruncatableString>(1, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'description', subBuilder: TruncatableString.create)
    ..aOM<Span_Attributes>(2, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'attributes', subBuilder: Span_Attributes.create)
    ..hasRequiredFields = false
  ;
  ...
  'Use [GeneratedMessageGenericExtensions.rebuild] instead. '
  'Will be removed in next major version')
  Span_TimeEvent_Annotation copyWith(void Function(Span_TimeEvent_Annotation) updates) => super.copyWith((message) => updates(message as Span_TimeEvent_Annotation)) as Span_TimeEvent_Annotation; // ignore: deprecated_member_use
  $pb.BuilderInfo get info_ => _i;
  @$core.pragma('dart2js:noInline')
...
class Span_TimeEvent_MessageEvent extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'Span.TimeEvent.MessageEvent', package: const $pb.PackageName(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'google.devtools.cloudtrace.v2'), createEmptyInstance: create)
    ..e<Span_TimeEvent_MessageEvent_Type>(1, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'type', $pb.PbFieldType.OE, defaultOrMaker: Span_TimeEvent_MessageEvent_Type.TYPE_UNSPECIFIED, valueOf: Span_TimeEvent_MessageEvent_Type.valueOf, enumValues: Span_TimeEvent_MessageEvent_Type.values)
    ..aInt64(2, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'id')
    ..aInt64(3, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'uncompressedSizeBytes')
    ..aInt64(4, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'compressedSizeBytes')
    ..hasRequiredFields = false
  ;
  ...
  'Use [GeneratedMessageGenericExtensions.rebuild] instead. '
  'Will be removed in next major version')
  Span_TimeEvent_MessageEvent copyWith(void Function(Span_TimeEvent_MessageEvent) updates) => super.copyWith((message) => updates(message as Span_TimeEvent_MessageEvent)) as Span_TimeEvent_MessageEvent; // ignore: deprecated_member_use
  $pb.BuilderInfo get info_ => _i;
  @$core.pragma('dart2js:noInline')
  ...
  @$pb.TagNumber(3)
  set uncompressedSizeBytes($fixnum.Int64 v) { $_setInt64(2, v); }
  @$pb.TagNumber(3)
  ...
  @$pb.TagNumber(4)
  set compressedSizeBytes($fixnum.Int64 v) { $_setInt64(3, v); }
  @$pb.TagNumber(4)
...
class Span_TimeEvent extends $pb.GeneratedMessage {
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'Span.TimeEvent', package: const $pb.PackageName(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'google.devtools.cloudtrace.v2'), createEmptyInstance: create)
    ..oo(0, [2, 3])
    ..aOM<$0.Timestamp>(1, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'time', subBuilder: $0.Timestamp.create)
    ..aOM<Span_TimeEvent_Annotation>(2, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'annotation', subBuilder: Span_TimeEvent_Annotation.create)
    ..aOM<Span_TimeEvent_MessageEvent>(3, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'messageEvent', subBuilder: Span_TimeEvent_MessageEvent.create)
    ..hasRequiredFields = false
  ;
  ...
  'Use [GeneratedMessageGenericExtensions.rebuild] instead. '
  'Will be removed in next major version')
  Span_TimeEvent copyWith(void Function(Span_TimeEvent) updates) => super.copyWith((message) => updates(message as Span_TimeEvent)) as Span_TimeEvent; // ignore: deprecated_member_use
  $pb.BuilderInfo get info_ => _i;
  @$core.pragma('dart2js:noInline')
...
class Span_TimeEvents extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'Span.TimeEvents', package: const $pb.PackageName(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'google.devtools.cloudtrace.v2'), createEmptyInstance: create)
    ..pc<Span_TimeEvent>(1, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'timeEvent', $pb.PbFieldType.PM, subBuilder: Span_TimeEvent.create)
    ..a<$core.int>(2, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'droppedAnnotationsCount', $pb.PbFieldType.O3)
    ..a<$core.int>(3, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'droppedMessageEventsCount', $pb.PbFieldType.O3)
    ..hasRequiredFields = false
  ;
  ...
  'Use [GeneratedMessageGenericExtensions.rebuild] instead. '
  'Will be removed in next major version')
  Span_TimeEvents copyWith(void Function(Span_TimeEvents) updates) => super.copyWith((message) => updates(message as Span_TimeEvents)) as Span_TimeEvents; // ignore: deprecated_member_use
  $pb.BuilderInfo get info_ => _i;
  @$core.pragma('dart2js:noInline')
...
class Span_Link extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'Span.Link', package: const $pb.PackageName(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'google.devtools.cloudtrace.v2'), createEmptyInstance: create)
    ..aOS(1, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'traceId')
    ..aOS(2, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'spanId')
    ..e<Span_Link_Type>(3, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'type', $pb.PbFieldType.OE, defaultOrMaker: Span_Link_Type.TYPE_UNSPECIFIED, valueOf: Span_Link_Type.valueOf, enumValues: Span_Link_Type.values)
    ..aOM<Span_Attributes>(4, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'attributes', subBuilder: Span_Attributes.create)
    ..hasRequiredFields = false
  ;
...
class Span_Links extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'Span.Links', package: const $pb.PackageName(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'google.devtools.cloudtrace.v2'), createEmptyInstance: create)
    ..pc<Span_Link>(1, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'link', $pb.PbFieldType.PM, subBuilder: Span_Link.create)
    ..a<$core.int>(2, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'droppedLinksCount', $pb.PbFieldType.O3)
    ..hasRequiredFields = false
  ;
  ...
  'Use [GeneratedMessageGenericExtensions.rebuild] instead. '
  'Will be removed in next major version')
  Span_Links copyWith(void Function(Span_Links) updates) => super.copyWith((message) => updates(message as Span_Links)) as Span_Links; // ignore: deprecated_member_use
  $pb.BuilderInfo get info_ => _i;
  @$core.pragma('dart2js:noInline')
...
class Span extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'Span', package: const $pb.PackageName(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'google.devtools.cloudtrace.v2'), createEmptyInstance: create)
    ..aOS(1, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'name')
    ..aOS(2, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'spanId')
    ..aOS(3, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'parentSpanId')
    ..aOM<TruncatableString>(4, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'displayName', subBuilder: TruncatableString.create)
    ...
    ..aOM<Span_Attributes>(7, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'attributes', subBuilder: Span_Attributes.create)
    ..aOM<StackTrace>(8, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'stackTrace', subBuilder: StackTrace.create)
    ..aOM<Span_TimeEvents>(9, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'timeEvents', subBuilder: Span_TimeEvents.create)
    ..aOM<Span_Links>(10, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'links', subBuilder: Span_Links.create)
    ..aOM<$1.Status>(11, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'status', subBuilder: $1.Status.create)
    ..aOM<$2.BoolValue>(12, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'sameProcessAsParentSpan', subBuilder: $2.BoolValue.create)
    ..aOM<$2.Int32Value>(13, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'childSpanCount', subBuilder: $2.Int32Value.create)
    ..e<Span_SpanKind>(14, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'spanKind', $pb.PbFieldType.OE, defaultOrMaker: Span_SpanKind.SPAN_KIND_UNSPECIFIED, valueOf: Span_SpanKind.valueOf, enumValues: Span_SpanKind.values)
    ..hasRequiredFields = false
  ;
  ...
  @$pb.TagNumber(4)
  set displayName(TruncatableString v) { setField(4, v); }
  @$pb.TagNumber(4)
  ...
  @$pb.TagNumber(11)
  set status($1.Status v) { setField(11, v); }
  @$pb.TagNumber(11)
  ...
  @$pb.TagNumber(12)
  set sameProcessAsParentSpan($2.BoolValue v) { setField(12, v); }
  @$pb.TagNumber(12)
  ...
  @$pb.TagNumber(13)
  set childSpanCount($2.Int32Value v) { setField(13, v); }
  @$pb.TagNumber(13)
  ...
  @$pb.TagNumber(14)
  set spanKind(Span_SpanKind v) { setField(14, v); }
  @$pb.TagNumber(14)
...
class AttributeValue extends $pb.GeneratedMessage {
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'AttributeValue', package: const $pb.PackageName(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'google.devtools.cloudtrace.v2'), createEmptyInstance: create)
    ..oo(0, [1, 2, 3])
    ..aOM<TruncatableString>(1, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'stringValue', subBuilder: TruncatableString.create)
  ...
  'Use [GeneratedMessageGenericExtensions.rebuild] instead. '
  'Will be removed in next major version')
  AttributeValue copyWith(void Function(AttributeValue) updates) => super.copyWith((message) => updates(message as AttributeValue)) as AttributeValue; // ignore: deprecated_member_use
  $pb.BuilderInfo get info_ => _i;
  @$core.pragma('dart2js:noInline')
...
class StackTrace_StackFrame extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'StackTrace.StackFrame', package: const $pb.PackageName(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'google.devtools.cloudtrace.v2'), createEmptyInstance: create)
    ..aOM<TruncatableString>(1, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'functionName', subBuilder: TruncatableString.create)
    ..aOM<TruncatableString>(2, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'originalFunctionName', subBuilder: TruncatableString.create)
    ..aOM<TruncatableString>(3, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'fileName', subBuilder: TruncatableString.create)
    ..aInt64(4, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'lineNumber')
    ..aInt64(5, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'columnNumber')
    ..aOM<Module>(6, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'loadModule', subBuilder: Module.create)
    ..aOM<TruncatableString>(7, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'sourceVersion', subBuilder: TruncatableString.create)
    ..hasRequiredFields = false
  ;
  ...
  'Use [GeneratedMessageGenericExtensions.rebuild] instead. '
  'Will be removed in next major version')
  StackTrace_StackFrame copyWith(void Function(StackTrace_StackFrame) updates) => super.copyWith((message) => updates(message as StackTrace_StackFrame)) as StackTrace_StackFrame; // ignore: deprecated_member_use
  $pb.BuilderInfo get info_ => _i;
  @$core.pragma('dart2js:noInline')
...
class StackTrace_StackFrames extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'StackTrace.StackFrames', package: const $pb.PackageName(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'google.devtools.cloudtrace.v2'), createEmptyInstance: create)
    ..pc<StackTrace_StackFrame>(1, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'frame', $pb.PbFieldType.PM, subBuilder: StackTrace_StackFrame.create)
    ..a<$core.int>(2, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'droppedFramesCount', $pb.PbFieldType.O3)
    ..hasRequiredFields = false
  ;
  ...
  'Use [GeneratedMessageGenericExtensions.rebuild] instead. '
  'Will be removed in next major version')
  StackTrace_StackFrames copyWith(void Function(StackTrace_StackFrames) updates) => super.copyWith((message) => updates(message as StackTrace_StackFrames)) as StackTrace_StackFrames; // ignore: deprecated_member_use
  $pb.BuilderInfo get info_ => _i;
  @$core.pragma('dart2js:noInline')
...
class StackTrace extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'StackTrace', package: const $pb.PackageName(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'google.devtools.cloudtrace.v2'), createEmptyInstance: create)
    ..aOM<StackTrace_StackFrames>(1, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'stackFrames', subBuilder: StackTrace_StackFrames.create)
    ..aInt64(2, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'stackTraceHashId')
    ..hasRequiredFields = false
  ;
  ...
  'Use [GeneratedMessageGenericExtensions.rebuild] instead. '
  'Will be removed in next major version')
  StackTrace copyWith(void Function(StackTrace) updates) => super.copyWith((message) => updates(message as StackTrace)) as StackTrace; // ignore: deprecated_member_use
  $pb.BuilderInfo get info_ => _i;
  @$core.pragma('dart2js:noInline')
...
class Module extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'Module', package: const $pb.PackageName(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'google.devtools.cloudtrace.v2'), createEmptyInstance: create)
    ..aOM<TruncatableString>(1, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'module', subBuilder: TruncatableString.create)
    ..aOM<TruncatableString>(2, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'buildId', subBuilder: TruncatableString.create)
    ..hasRequiredFields = false
  ;
...
class TruncatableString extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'TruncatableString', package: const $pb.PackageName(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'google.devtools.cloudtrace.v2'), createEmptyInstance: create)
    ..aOS(1, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'value')
    ..a<$core.int>(2, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'truncatedByteCount', $pb.PbFieldType.O3)
    ..hasRequiredFields = false
  ;
  ...
  'Use [GeneratedMessageGenericExtensions.rebuild] instead. '
  'Will be removed in next major version')
  TruncatableString copyWith(void Function(TruncatableString) updates) => super.copyWith((message) => updates(message as TruncatableString)) as TruncatableString; // ignore: deprecated_member_use
  $pb.BuilderInfo get info_ => _i;
  @$core.pragma('dart2js:noInline')

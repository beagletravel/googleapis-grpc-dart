...
final $typed_data.Uint8List traceDescriptor = $convert.base64Decode('CgVUcmFjZRIdCgpwcm9qZWN0X2lkGAEgASgJUglwcm9qZWN0SWQSGQoIdHJhY2VfaWQYAiABKAlSB3RyYWNlSWQSPgoFc3BhbnMYAyADKAsyKC5nb29nbGUuZGV2dG9vbHMuY2xvdWR0cmFjZS52MS5UcmFjZVNwYW5SBXNwYW5z');
...
final $typed_data.Uint8List tracesDescriptor = $convert.base64Decode('CgZUcmFjZXMSPAoGdHJhY2VzGAEgAygLMiQuZ29vZ2xlLmRldnRvb2xzLmNsb3VkdHJhY2UudjEuVHJhY2VSBnRyYWNlcw==');
...
const TraceSpan$json = const {
  ...
  '2': const [
    ...
    const {'1': 'parent_span_id', '3': 6, '4': 1, '5': 6, '8': const {}, '10': 'parentSpanId'},
...
final $typed_data.Uint8List traceSpanDescriptor = $convert.base64Decode('');
...
const ListTracesRequest$json = const {
  ...
  '2': const [
    ...
    const {'1': 'view', '3': 2, '4': 1, '5': 14, '6': '.google.devtools.cloudtrace.v1.ListTracesRequest.ViewType', '8': const {}, '10': 'view'},
    ...
    const {'1': 'order_by', '3': 8, '4': 1, '5': 9, '8': const {}, '10': 'orderBy'},
  ],
...
final $typed_data.Uint8List listTracesResponseDescriptor = $convert.base64Decode('ChJMaXN0VHJhY2VzUmVzcG9uc2USPAoGdHJhY2VzGAEgAygLMiQuZ29vZ2xlLmRldnRvb2xzLmNsb3VkdHJhY2UudjEuVHJhY2VSBnRyYWNlcxImCg9uZXh0X3BhZ2VfdG9rZW4YAiABKAlSDW5leHRQYWdlVG9rZW4=');
@$core.Deprecated('Use getTraceRequestDescriptor instead')
const GetTraceRequest$json = const {
  '1': 'GetTraceRequest',
  '2': const [
    const {'1': 'project_id', '3': 1, '4': 1, '5': 9, '8': const {}, '10': 'projectId'},
    const {'1': 'trace_id', '3': 2, '4': 1, '5': 9, '8': const {}, '10': 'traceId'},
  ],
};

/// Descriptor for `GetTraceRequest`. Decode as a `google.protobuf.DescriptorProto`.
final $typed_data.Uint8List getTraceRequestDescriptor = $convert.base64Decode('Cg9HZXRUcmFjZVJlcXVlc3QSIgoKcHJvamVjdF9pZBgBIAEoCUID4EECUglwcm9qZWN0SWQSHgoIdHJhY2VfaWQYAiABKAlCA+BBAlIHdHJhY2VJZA==');
@$core.Deprecated('Use patchTracesRequestDescriptor instead')
const PatchTracesRequest$json = const {
  '1': 'PatchTracesRequest',
  '2': const [
    const {'1': 'project_id', '3': 1, '4': 1, '5': 9, '8': const {}, '10': 'projectId'},
    const {'1': 'traces', '3': 2, '4': 1, '5': 11, '6': '.google.devtools.cloudtrace.v1.Traces', '8': const {}, '10': 'traces'},
  ],
};

/// Descriptor for `PatchTracesRequest`. Decode as a `google.protobuf.DescriptorProto`.
final $typed_data.Uint8List patchTracesRequestDescriptor = $convert.base64Decode('ChJQYXRjaFRyYWNlc1JlcXVlc3QSIgoKcHJvamVjdF9pZBgBIAEoCUID4EECUglwcm9qZWN0SWQSQgoGdHJhY2VzGAIgASgLMiUuZ29vZ2xlLmRldnRvb2xzLmNsb3VkdHJhY2UudjEuVHJhY2VzQgPgQQJSBnRyYWNlcw==');

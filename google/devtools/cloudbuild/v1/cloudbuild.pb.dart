...
class RetryBuildRequest extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'RetryBuildRequest', package: const $pb.PackageName(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'google.devtools.cloudbuild.v1'), createEmptyInstance: create)
  ...
  factory RetryBuildRequest.fromBuffer($core.List<$core.int> i, [$pb.ExtensionRegistry r = $pb.ExtensionRegistry.EMPTY]) => create()..mergeFromBuffer(i, r);
  factory RetryBuildRequest.fromJson($core.String i, [$pb.ExtensionRegistry r = $pb.ExtensionRegistry.EMPTY]) => create()..mergeFromJson(i, r);
  @$core.Deprecated(
  ...
  'Will be removed in next major version')
  RetryBuildRequest copyWith(void Function(RetryBuildRequest) updates) => super.copyWith((message) => updates(message as RetryBuildRequest)) as RetryBuildRequest; // ignore: deprecated_member_use
  ...
  @$core.pragma('dart2js:noInline')
  static RetryBuildRequest getDefault() => _defaultInstance ??= $pb.GeneratedMessage.$_defaultFor<RetryBuildRequest>(create);
...
class RunBuildTriggerRequest extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'RunBuildTriggerRequest', package: const $pb.PackageName(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'google.devtools.cloudbuild.v1'), createEmptyInstance: create)
    ..aOS(1, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'projectId')
    ..aOS(2, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'triggerId')
    ..aOM<RepoSource>(3, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'source', subBuilder: RepoSource.create)
  ...
  factory RunBuildTriggerRequest.fromBuffer($core.List<$core.int> i, [$pb.ExtensionRegistry r = $pb.ExtensionRegistry.EMPTY]) => create()..mergeFromBuffer(i, r);
  factory RunBuildTriggerRequest.fromJson($core.String i, [$pb.ExtensionRegistry r = $pb.ExtensionRegistry.EMPTY]) => create()..mergeFromJson(i, r);
  @$core.Deprecated(
  'Using this can add significant overhead to your binary. '
  'Use [GeneratedMessageGenericExtensions.deepCopy] instead. '
  'Will be removed in next major version')
  ...
  'Use [GeneratedMessageGenericExtensions.rebuild] instead. '
  'Will be removed in next major version')
  RunBuildTriggerRequest copyWith(void Function(RunBuildTriggerRequest) updates) => super.copyWith((message) => updates(message as RunBuildTriggerRequest)) as RunBuildTriggerRequest; // ignore: deprecated_member_use
  $pb.BuilderInfo get info_ => _i;
  @$core.pragma('dart2js:noInline')
  ...
  @$core.pragma('dart2js:noInline')
  static RunBuildTriggerRequest getDefault() => _defaultInstance ??= $pb.GeneratedMessage.$_defaultFor<RunBuildTriggerRequest>(create);
...
class StorageSource extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'StorageSource', package: const $pb.PackageName(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'google.devtools.cloudbuild.v1'), createEmptyInstance: create)
...
class RepoSource extends $pb.GeneratedMessage {
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'RepoSource', package: const $pb.PackageName(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'google.devtools.cloudbuild.v1'), createEmptyInstance: create)
    ..oo(0, [3, 4, 5])
    ..aOS(1, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'projectId')
    ...
    ..m<$core.String, $core.String>(9, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'substitutions', entryClassName: 'RepoSource.SubstitutionsEntry', keyFieldType: $pb.PbFieldType.OS, valueFieldType: $pb.PbFieldType.OS, packageName: const $pb.PackageName('google.devtools.cloudbuild.v1'))
    ..hasRequiredFields = false
  ;
...
class StorageSourceManifest extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'StorageSourceManifest', package: const $pb.PackageName(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'google.devtools.cloudbuild.v1'), createEmptyInstance: create)
    ..aOS(1, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'bucket')
    ..aOS(2, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'object')
    ..aInt64(3, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'generation')
    ..hasRequiredFields = false
  ...
  factory StorageSourceManifest.fromBuffer($core.List<$core.int> i, [$pb.ExtensionRegistry r = $pb.ExtensionRegistry.EMPTY]) => create()..mergeFromBuffer(i, r);
  factory StorageSourceManifest.fromJson($core.String i, [$pb.ExtensionRegistry r = $pb.ExtensionRegistry.EMPTY]) => create()..mergeFromJson(i, r);
  @$core.Deprecated(
  'Using this can add significant overhead to your binary. '
  'Use [GeneratedMessageGenericExtensions.deepCopy] instead. '
  'Will be removed in next major version')
  StorageSourceManifest clone() => StorageSourceManifest()..mergeFromMessage(this);
  @$core.Deprecated(
  'Using this can add significant overhead to your binary. '
  'Use [GeneratedMessageGenericExtensions.rebuild] instead. '
  'Will be removed in next major version')
  StorageSourceManifest copyWith(void Function(StorageSourceManifest) updates) => super.copyWith((message) => updates(message as StorageSourceManifest)) as StorageSourceManifest; // ignore: deprecated_member_use
  $pb.BuilderInfo get info_ => _i;
  @$core.pragma('dart2js:noInline')
  static StorageSourceManifest create() => StorageSourceManifest._();
  StorageSourceManifest createEmptyInstance() => create();
  static $pb.PbList<StorageSourceManifest> createRepeated() => $pb.PbList<StorageSourceManifest>();
  @$core.pragma('dart2js:noInline')
  static StorageSourceManifest getDefault() => _defaultInstance ??= $pb.GeneratedMessage.$_defaultFor<StorageSourceManifest>(create);
...
class Source extends $pb.GeneratedMessage {
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'Source', package: const $pb.PackageName(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'google.devtools.cloudbuild.v1'), createEmptyInstance: create)
    ..oo(0, [2, 3, 8])
    ...
    ..aOM<StorageSourceManifest>(8, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'storageSourceManifest', subBuilder: StorageSourceManifest.create)
    ..hasRequiredFields = false
  ;
  ...
  @$pb.TagNumber(8)
  set storageSourceManifest(StorageSourceManifest v) { setField(8, v); }
  @$pb.TagNumber(8)
...
class BuiltImage extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'BuiltImage', package: const $pb.PackageName(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'google.devtools.cloudbuild.v1'), createEmptyInstance: create)
...
class BuildStep extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'BuildStep', package: const $pb.PackageName(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'google.devtools.cloudbuild.v1'), createEmptyInstance: create)
    ..aOS(1, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'name')
    ...
    ..aOM<$3.Duration>(11, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'timeout', subBuilder: $3.Duration.create)
    ..e<Build_Status>(12, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'status', $pb.PbFieldType.OE, defaultOrMaker: Build_Status.STATUS_UNKNOWN, valueOf: Build_Status.valueOf, enumValues: Build_Status.values)
    ..aOM<TimeSpan>(13, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'pullTiming', subBuilder: TimeSpan.create)
    ..aOS(19, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'script')
    ..hasRequiredFields = false
  ;
  ...
  @$pb.TagNumber(11)
  set timeout($3.Duration v) { setField(11, v); }
  @$pb.TagNumber(11)
  ...
  @$pb.TagNumber(19)
  set script($core.String v) { $_setString(13, v); }
  @$pb.TagNumber(19)
...
class Volume extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'Volume', package: const $pb.PackageName(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'google.devtools.cloudbuild.v1'), createEmptyInstance: create)
    ..aOS(1, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'name')
...
class Results extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'Results', package: const $pb.PackageName(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'google.devtools.cloudbuild.v1'), createEmptyInstance: create)
...
class ArtifactResult extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'ArtifactResult', package: const $pb.PackageName(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'google.devtools.cloudbuild.v1'), createEmptyInstance: create)
    ..aOS(1, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'location')
    ..pc<FileHashes>(2, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'fileHash', $pb.PbFieldType.PM, subBuilder: FileHashes.create)
    ..hasRequiredFields = false
  ;
  ...
  factory ArtifactResult.fromBuffer($core.List<$core.int> i, [$pb.ExtensionRegistry r = $pb.ExtensionRegistry.EMPTY]) => create()..mergeFromBuffer(i, r);
  factory ArtifactResult.fromJson($core.String i, [$pb.ExtensionRegistry r = $pb.ExtensionRegistry.EMPTY]) => create()..mergeFromJson(i, r);
  @$core.Deprecated(
  'Using this can add significant overhead to your binary. '
  'Use [GeneratedMessageGenericExtensions.deepCopy] instead. '
  'Will be removed in next major version')
  ...
  'Use [GeneratedMessageGenericExtensions.rebuild] instead. '
  'Will be removed in next major version')
  ArtifactResult copyWith(void Function(ArtifactResult) updates) => super.copyWith((message) => updates(message as ArtifactResult)) as ArtifactResult; // ignore: deprecated_member_use
  $pb.BuilderInfo get info_ => _i;
  @$core.pragma('dart2js:noInline')
  ...
  @$core.pragma('dart2js:noInline')
  static ArtifactResult getDefault() => _defaultInstance ??= $pb.GeneratedMessage.$_defaultFor<ArtifactResult>(create);
...
class Build_Warning extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'Build.Warning', package: const $pb.PackageName(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'google.devtools.cloudbuild.v1'), createEmptyInstance: create)
    ..aOS(1, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'text')
    ..e<Build_Warning_Priority>(2, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'priority', $pb.PbFieldType.OE, defaultOrMaker: Build_Warning_Priority.PRIORITY_UNSPECIFIED, valueOf: Build_Warning_Priority.valueOf, enumValues: Build_Warning_Priority.values)
    ..hasRequiredFields = false
  ;
  ...
  factory Build_Warning.fromBuffer($core.List<$core.int> i, [$pb.ExtensionRegistry r = $pb.ExtensionRegistry.EMPTY]) => create()..mergeFromBuffer(i, r);
  factory Build_Warning.fromJson($core.String i, [$pb.ExtensionRegistry r = $pb.ExtensionRegistry.EMPTY]) => create()..mergeFromJson(i, r);
  @$core.Deprecated(
  'Using this can add significant overhead to your binary. '
  'Use [GeneratedMessageGenericExtensions.deepCopy] instead. '
  'Will be removed in next major version')
  ...
  'Use [GeneratedMessageGenericExtensions.rebuild] instead. '
  'Will be removed in next major version')
  Build_Warning copyWith(void Function(Build_Warning) updates) => super.copyWith((message) => updates(message as Build_Warning)) as Build_Warning; // ignore: deprecated_member_use
  $pb.BuilderInfo get info_ => _i;
  @$core.pragma('dart2js:noInline')
  static Build_Warning create() => Build_Warning._();
  Build_Warning createEmptyInstance() => create();
  static $pb.PbList<Build_Warning> createRepeated() => $pb.PbList<Build_Warning>();
  @$core.pragma('dart2js:noInline')
  static Build_Warning getDefault() => _defaultInstance ??= $pb.GeneratedMessage.$_defaultFor<Build_Warning>(create);
  ...
  @$pb.TagNumber(2)
  set priority(Build_Warning_Priority v) { setField(2, v); }
  @$pb.TagNumber(2)
...
class Build_FailureInfo extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'Build.FailureInfo', package: const $pb.PackageName(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'google.devtools.cloudbuild.v1'), createEmptyInstance: create)
    ..e<Build_FailureInfo_FailureType>(1, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'type', $pb.PbFieldType.OE, defaultOrMaker: Build_FailureInfo_FailureType.FAILURE_TYPE_UNSPECIFIED, valueOf: Build_FailureInfo_FailureType.valueOf, enumValues: Build_FailureInfo_FailureType.values)
  ...
  factory Build_FailureInfo.fromBuffer($core.List<$core.int> i, [$pb.ExtensionRegistry r = $pb.ExtensionRegistry.EMPTY]) => create()..mergeFromBuffer(i, r);
  factory Build_FailureInfo.fromJson($core.String i, [$pb.ExtensionRegistry r = $pb.ExtensionRegistry.EMPTY]) => create()..mergeFromJson(i, r);
  @$core.Deprecated(
  'Using this can add significant overhead to your binary. '
  'Use [GeneratedMessageGenericExtensions.deepCopy] instead. '
  'Will be removed in next major version')
  ...
  'Use [GeneratedMessageGenericExtensions.rebuild] instead. '
  'Will be removed in next major version')
  Build_FailureInfo copyWith(void Function(Build_FailureInfo) updates) => super.copyWith((message) => updates(message as Build_FailureInfo)) as Build_FailureInfo; // ignore: deprecated_member_use
  $pb.BuilderInfo get info_ => _i;
  @$core.pragma('dart2js:noInline')
  static Build_FailureInfo create() => Build_FailureInfo._();
  Build_FailureInfo createEmptyInstance() => create();
  static $pb.PbList<Build_FailureInfo> createRepeated() => $pb.PbList<Build_FailureInfo>();
  @$core.pragma('dart2js:noInline')
  static Build_FailureInfo getDefault() => _defaultInstance ??= $pb.GeneratedMessage.$_defaultFor<Build_FailureInfo>(create);
  static Build_FailureInfo? _defaultInstance;

  @$pb.TagNumber(1)
  Build_FailureInfo_FailureType get type => $_getN(0);
  @$pb.TagNumber(1)
  set type(Build_FailureInfo_FailureType v) { setField(1, v); }
  @$pb.TagNumber(1)
...
class Build extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'Build', package: const $pb.PackageName(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'google.devtools.cloudbuild.v1'), createEmptyInstance: create)
    ..aOS(1, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'id')
    ..e<Build_Status>(2, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'status', $pb.PbFieldType.OE, defaultOrMaker: Build_Status.STATUS_UNKNOWN, valueOf: Build_Status.valueOf, enumValues: Build_Status.values)
    ...
    ..aOM<$3.Duration>(12, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'timeout', subBuilder: $3.Duration.create)
    ...
    ..m<$core.String, $core.String>(29, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'substitutions', entryClassName: 'Build.SubstitutionsEntry', keyFieldType: $pb.PbFieldType.OS, valueFieldType: $pb.PbFieldType.OS, packageName: const $pb.PackageName('google.devtools.cloudbuild.v1'))
    ...
    ..m<$core.String, TimeSpan>(33, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'timing', entryClassName: 'Build.TimingEntry', keyFieldType: $pb.PbFieldType.OS, valueFieldType: $pb.PbFieldType.OM, valueCreator: TimeSpan.create, packageName: const $pb.PackageName('google.devtools.cloudbuild.v1'))
    ..aOM<Artifacts>(37, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'artifacts', subBuilder: Artifacts.create)
    ..aOM<$3.Duration>(40, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'queueTtl', subBuilder: $3.Duration.create)
    ..aOS(42, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'serviceAccount')
    ..aOM<BuildApproval>(44, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'approval', subBuilder: BuildApproval.create)
    ..aOS(45, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'name')
    ..aOM<Secrets>(47, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'availableSecrets', subBuilder: Secrets.create)
    ..pc<Build_Warning>(49, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'warnings', $pb.PbFieldType.PM, subBuilder: Build_Warning.create)
    ..aOM<Build_FailureInfo>(51, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'failureInfo', subBuilder: Build_FailureInfo.create)
    ..hasRequiredFields = false
  ;
  ...
  @$pb.TagNumber(12)
  set timeout($3.Duration v) { setField(12, v); }
  @$pb.TagNumber(12)
  ...
  @$pb.TagNumber(40)
  set queueTtl($3.Duration v) { setField(40, v); }
  @$pb.TagNumber(40)
  ...
  @$pb.TagNumber(42)
  set serviceAccount($core.String v) { $_setString(23, v); }
  @$pb.TagNumber(42)
  ...
  @$pb.TagNumber(44)
  set approval(BuildApproval v) { setField(44, v); }
  @$pb.TagNumber(44)
  ...
  @$pb.TagNumber(47)
  set availableSecrets(Secrets v) { setField(47, v); }
  @$pb.TagNumber(47)
  ...
  @$pb.TagNumber(51)
  set failureInfo(Build_FailureInfo v) { setField(51, v); }
  @$pb.TagNumber(51)
...
class Artifacts_ArtifactObjects extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'Artifacts.ArtifactObjects', package: const $pb.PackageName(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'google.devtools.cloudbuild.v1'), createEmptyInstance: create)
    ..aOS(1, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'location')
...
class Artifacts extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'Artifacts', package: const $pb.PackageName(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'google.devtools.cloudbuild.v1'), createEmptyInstance: create)
...
class TimeSpan extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'TimeSpan', package: const $pb.PackageName(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'google.devtools.cloudbuild.v1'), createEmptyInstance: create)
...
class BuildOperationMetadata extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'BuildOperationMetadata', package: const $pb.PackageName(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'google.devtools.cloudbuild.v1'), createEmptyInstance: create)
    ..aOM<Build>(1, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'build', subBuilder: Build.create)
    ..hasRequiredFields = false
  ;
  ...
  factory BuildOperationMetadata.fromBuffer($core.List<$core.int> i, [$pb.ExtensionRegistry r = $pb.ExtensionRegistry.EMPTY]) => create()..mergeFromBuffer(i, r);
  factory BuildOperationMetadata.fromJson($core.String i, [$pb.ExtensionRegistry r = $pb.ExtensionRegistry.EMPTY]) => create()..mergeFromJson(i, r);
  @$core.Deprecated(
  'Using this can add significant overhead to your binary. '
  'Use [GeneratedMessageGenericExtensions.deepCopy] instead. '
  'Will be removed in next major version')
  ...
  'Use [GeneratedMessageGenericExtensions.rebuild] instead. '
  'Will be removed in next major version')
  BuildOperationMetadata copyWith(void Function(BuildOperationMetadata) updates) => super.copyWith((message) => updates(message as BuildOperationMetadata)) as BuildOperationMetadata; // ignore: deprecated_member_use
  $pb.BuilderInfo get info_ => _i;
  @$core.pragma('dart2js:noInline')
  ...
  @$core.pragma('dart2js:noInline')
  static BuildOperationMetadata getDefault() => _defaultInstance ??= $pb.GeneratedMessage.$_defaultFor<BuildOperationMetadata>(create);
...
class SourceProvenance extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'SourceProvenance', package: const $pb.PackageName(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'google.devtools.cloudbuild.v1'), createEmptyInstance: create)
    ...
    ..aOM<StorageSourceManifest>(9, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'resolvedStorageSourceManifest', subBuilder: StorageSourceManifest.create)
    ..hasRequiredFields = false
  ;
  ...
  @$pb.TagNumber(9)
  set resolvedStorageSourceManifest(StorageSourceManifest v) { setField(9, v); }
  @$pb.TagNumber(9)
...
class FileHashes extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'FileHashes', package: const $pb.PackageName(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'google.devtools.cloudbuild.v1'), createEmptyInstance: create)
...
class Hash extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'Hash', package: const $pb.PackageName(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'google.devtools.cloudbuild.v1'), createEmptyInstance: create)
...
class Secrets extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'Secrets', package: const $pb.PackageName(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'google.devtools.cloudbuild.v1'), createEmptyInstance: create)
    ..pc<SecretManagerSecret>(1, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'secretManager', $pb.PbFieldType.PM, subBuilder: SecretManagerSecret.create)
    ..pc<InlineSecret>(2, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'inline', $pb.PbFieldType.PM, subBuilder: InlineSecret.create)
    ..hasRequiredFields = false
  ;
  ...
  factory Secrets.fromBuffer($core.List<$core.int> i, [$pb.ExtensionRegistry r = $pb.ExtensionRegistry.EMPTY]) => create()..mergeFromBuffer(i, r);
  factory Secrets.fromJson($core.String i, [$pb.ExtensionRegistry r = $pb.ExtensionRegistry.EMPTY]) => create()..mergeFromJson(i, r);
  @$core.Deprecated(
  'Using this can add significant overhead to your binary. '
  'Use [GeneratedMessageGenericExtensions.deepCopy] instead. '
  'Will be removed in next major version')
  ...
  'Use [GeneratedMessageGenericExtensions.rebuild] instead. '
  'Will be removed in next major version')
  Secrets copyWith(void Function(Secrets) updates) => super.copyWith((message) => updates(message as Secrets)) as Secrets; // ignore: deprecated_member_use
  $pb.BuilderInfo get info_ => _i;
  @$core.pragma('dart2js:noInline')
  ...
  @$core.pragma('dart2js:noInline')
  static Secrets getDefault() => _defaultInstance ??= $pb.GeneratedMessage.$_defaultFor<Secrets>(create);
...
class InlineSecret extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'InlineSecret', package: const $pb.PackageName(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'google.devtools.cloudbuild.v1'), createEmptyInstance: create)
    ..aOS(1, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'kmsKeyName')
    ..m<$core.String, $core.List<$core.int>>(2, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'envMap', entryClassName: 'InlineSecret.EnvMapEntry', keyFieldType: $pb.PbFieldType.OS, valueFieldType: $pb.PbFieldType.OY, packageName: const $pb.PackageName('google.devtools.cloudbuild.v1'))
    ..hasRequiredFields = false
  ;
  ...
  factory InlineSecret.fromBuffer($core.List<$core.int> i, [$pb.ExtensionRegistry r = $pb.ExtensionRegistry.EMPTY]) => create()..mergeFromBuffer(i, r);
  factory InlineSecret.fromJson($core.String i, [$pb.ExtensionRegistry r = $pb.ExtensionRegistry.EMPTY]) => create()..mergeFromJson(i, r);
  @$core.Deprecated(
  'Using this can add significant overhead to your binary. '
  'Use [GeneratedMessageGenericExtensions.deepCopy] instead. '
  'Will be removed in next major version')
  ...
  'Use [GeneratedMessageGenericExtensions.rebuild] instead. '
  'Will be removed in next major version')
  InlineSecret copyWith(void Function(InlineSecret) updates) => super.copyWith((message) => updates(message as InlineSecret)) as InlineSecret; // ignore: deprecated_member_use
  $pb.BuilderInfo get info_ => _i;
  @$core.pragma('dart2js:noInline')
  static InlineSecret create() => InlineSecret._();
  InlineSecret createEmptyInstance() => create();
  static $pb.PbList<InlineSecret> createRepeated() => $pb.PbList<InlineSecret>();
  @$core.pragma('dart2js:noInline')
  static InlineSecret getDefault() => _defaultInstance ??= $pb.GeneratedMessage.$_defaultFor<InlineSecret>(create);
...
class SecretManagerSecret extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'SecretManagerSecret', package: const $pb.PackageName(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'google.devtools.cloudbuild.v1'), createEmptyInstance: create)
    ..aOS(1, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'versionName')
    ..aOS(2, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'env')
    ..hasRequiredFields = false
  ;
  ...
  factory SecretManagerSecret.fromBuffer($core.List<$core.int> i, [$pb.ExtensionRegistry r = $pb.ExtensionRegistry.EMPTY]) => create()..mergeFromBuffer(i, r);
  factory SecretManagerSecret.fromJson($core.String i, [$pb.ExtensionRegistry r = $pb.ExtensionRegistry.EMPTY]) => create()..mergeFromJson(i, r);
  @$core.Deprecated(
  'Using this can add significant overhead to your binary. '
  'Use [GeneratedMessageGenericExtensions.deepCopy] instead. '
  'Will be removed in next major version')
  ...
  'Use [GeneratedMessageGenericExtensions.rebuild] instead. '
  'Will be removed in next major version')
  SecretManagerSecret copyWith(void Function(SecretManagerSecret) updates) => super.copyWith((message) => updates(message as SecretManagerSecret)) as SecretManagerSecret; // ignore: deprecated_member_use
  $pb.BuilderInfo get info_ => _i;
  @$core.pragma('dart2js:noInline')
  static SecretManagerSecret create() => SecretManagerSecret._();
  SecretManagerSecret createEmptyInstance() => create();
  static $pb.PbList<SecretManagerSecret> createRepeated() => $pb.PbList<SecretManagerSecret>();
  @$core.pragma('dart2js:noInline')
  static SecretManagerSecret getDefault() => _defaultInstance ??= $pb.GeneratedMessage.$_defaultFor<SecretManagerSecret>(create);
  static SecretManagerSecret? _defaultInstance;

  @$pb.TagNumber(1)
  $core.String get versionName => $_getSZ(0);
  @$pb.TagNumber(1)
  set versionName($core.String v) { $_setString(0, v); }
  @$pb.TagNumber(1)
...
class Secret extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'Secret', package: const $pb.PackageName(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'google.devtools.cloudbuild.v1'), createEmptyInstance: create)
    ..aOS(1, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'kmsKeyName')
    ..m<$core.String, $core.List<$core.int>>(3, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'secretEnv', entryClassName: 'Secret.SecretEnvEntry', keyFieldType: $pb.PbFieldType.OS, valueFieldType: $pb.PbFieldType.OY, packageName: const $pb.PackageName('google.devtools.cloudbuild.v1'))
    ..hasRequiredFields = false
  ;
...
class CreateBuildRequest extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'CreateBuildRequest', package: const $pb.PackageName(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'google.devtools.cloudbuild.v1'), createEmptyInstance: create)
    ..aOS(1, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'projectId')
    ..aOM<Build>(2, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'build', subBuilder: Build.create)
  ...
  factory CreateBuildRequest.fromBuffer($core.List<$core.int> i, [$pb.ExtensionRegistry r = $pb.ExtensionRegistry.EMPTY]) => create()..mergeFromBuffer(i, r);
  factory CreateBuildRequest.fromJson($core.String i, [$pb.ExtensionRegistry r = $pb.ExtensionRegistry.EMPTY]) => create()..mergeFromJson(i, r);
  @$core.Deprecated(
  'Using this can add significant overhead to your binary. '
  'Use [GeneratedMessageGenericExtensions.deepCopy] instead. '
  'Will be removed in next major version')
  ...
  'Use [GeneratedMessageGenericExtensions.rebuild] instead. '
  'Will be removed in next major version')
  CreateBuildRequest copyWith(void Function(CreateBuildRequest) updates) => super.copyWith((message) => updates(message as CreateBuildRequest)) as CreateBuildRequest; // ignore: deprecated_member_use
  $pb.BuilderInfo get info_ => _i;
  @$core.pragma('dart2js:noInline')
  ...
  @$core.pragma('dart2js:noInline')
  static CreateBuildRequest getDefault() => _defaultInstance ??= $pb.GeneratedMessage.$_defaultFor<CreateBuildRequest>(create);
...
class GetBuildRequest extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'GetBuildRequest', package: const $pb.PackageName(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'google.devtools.cloudbuild.v1'), createEmptyInstance: create)
    ..aOS(1, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'projectId')
    ..aOS(2, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'id')
    ..aOS(4, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'name')
    ..hasRequiredFields = false
  ...
  factory GetBuildRequest.fromBuffer($core.List<$core.int> i, [$pb.ExtensionRegistry r = $pb.ExtensionRegistry.EMPTY]) => create()..mergeFromBuffer(i, r);
  factory GetBuildRequest.fromJson($core.String i, [$pb.ExtensionRegistry r = $pb.ExtensionRegistry.EMPTY]) => create()..mergeFromJson(i, r);
  @$core.Deprecated(
  'Using this can add significant overhead to your binary. '
  'Use [GeneratedMessageGenericExtensions.deepCopy] instead. '
  'Will be removed in next major version')
  ...
  'Use [GeneratedMessageGenericExtensions.rebuild] instead. '
  'Will be removed in next major version')
  GetBuildRequest copyWith(void Function(GetBuildRequest) updates) => super.copyWith((message) => updates(message as GetBuildRequest)) as GetBuildRequest; // ignore: deprecated_member_use
  $pb.BuilderInfo get info_ => _i;
  @$core.pragma('dart2js:noInline')
  ...
  @$core.pragma('dart2js:noInline')
  static GetBuildRequest getDefault() => _defaultInstance ??= $pb.GeneratedMessage.$_defaultFor<GetBuildRequest>(create);
...
class ListBuildsRequest extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'ListBuildsRequest', package: const $pb.PackageName(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'google.devtools.cloudbuild.v1'), createEmptyInstance: create)
    ..aOS(1, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'projectId')
    ..a<$core.int>(2, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'pageSize', $pb.PbFieldType.O3)
    ..aOS(3, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'pageToken')
    ..aOS(8, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'filter')
    ..aOS(9, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'parent')
    ..hasRequiredFields = false
  ;
  ...
  'Use [GeneratedMessageGenericExtensions.rebuild] instead. '
  'Will be removed in next major version')
  ListBuildsRequest copyWith(void Function(ListBuildsRequest) updates) => super.copyWith((message) => updates(message as ListBuildsRequest)) as ListBuildsRequest; // ignore: deprecated_member_use
  $pb.BuilderInfo get info_ => _i;
  @$core.pragma('dart2js:noInline')
...
class ListBuildsResponse extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'ListBuildsResponse', package: const $pb.PackageName(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'google.devtools.cloudbuild.v1'), createEmptyInstance: create)
    ..pc<Build>(1, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'builds', $pb.PbFieldType.PM, subBuilder: Build.create)
  ...
  'Use [GeneratedMessageGenericExtensions.rebuild] instead. '
  'Will be removed in next major version')
  ListBuildsResponse copyWith(void Function(ListBuildsResponse) updates) => super.copyWith((message) => updates(message as ListBuildsResponse)) as ListBuildsResponse; // ignore: deprecated_member_use
  $pb.BuilderInfo get info_ => _i;
  @$core.pragma('dart2js:noInline')
...
class CancelBuildRequest extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'CancelBuildRequest', package: const $pb.PackageName(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'google.devtools.cloudbuild.v1'), createEmptyInstance: create)
    ..aOS(1, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'projectId')
    ..aOS(2, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'id')
    ..aOS(4, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'name')
    ..hasRequiredFields = false
  ...
  factory CancelBuildRequest.fromBuffer($core.List<$core.int> i, [$pb.ExtensionRegistry r = $pb.ExtensionRegistry.EMPTY]) => create()..mergeFromBuffer(i, r);
  factory CancelBuildRequest.fromJson($core.String i, [$pb.ExtensionRegistry r = $pb.ExtensionRegistry.EMPTY]) => create()..mergeFromJson(i, r);
  @$core.Deprecated(
  'Using this can add significant overhead to your binary. '
  'Use [GeneratedMessageGenericExtensions.deepCopy] instead. '
  'Will be removed in next major version')
  ...
  'Use [GeneratedMessageGenericExtensions.rebuild] instead. '
  'Will be removed in next major version')
  CancelBuildRequest copyWith(void Function(CancelBuildRequest) updates) => super.copyWith((message) => updates(message as CancelBuildRequest)) as CancelBuildRequest; // ignore: deprecated_member_use
  $pb.BuilderInfo get info_ => _i;
  @$core.pragma('dart2js:noInline')
  ...
  @$core.pragma('dart2js:noInline')
  static CancelBuildRequest getDefault() => _defaultInstance ??= $pb.GeneratedMessage.$_defaultFor<CancelBuildRequest>(create);
...
class ApproveBuildRequest extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'ApproveBuildRequest', package: const $pb.PackageName(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'google.devtools.cloudbuild.v1'), createEmptyInstance: create)
    ..aOS(1, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'name')
    ..aOM<ApprovalResult>(2, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'approvalResult', subBuilder: ApprovalResult.create)
    ..hasRequiredFields = false
  ;
  ...
  factory ApproveBuildRequest.fromBuffer($core.List<$core.int> i, [$pb.ExtensionRegistry r = $pb.ExtensionRegistry.EMPTY]) => create()..mergeFromBuffer(i, r);
  factory ApproveBuildRequest.fromJson($core.String i, [$pb.ExtensionRegistry r = $pb.ExtensionRegistry.EMPTY]) => create()..mergeFromJson(i, r);
  @$core.Deprecated(
  'Using this can add significant overhead to your binary. '
  'Use [GeneratedMessageGenericExtensions.deepCopy] instead. '
  'Will be removed in next major version')
  ...
  'Use [GeneratedMessageGenericExtensions.rebuild] instead. '
  'Will be removed in next major version')
  ApproveBuildRequest copyWith(void Function(ApproveBuildRequest) updates) => super.copyWith((message) => updates(message as ApproveBuildRequest)) as ApproveBuildRequest; // ignore: deprecated_member_use
  $pb.BuilderInfo get info_ => _i;
  @$core.pragma('dart2js:noInline')
  static ApproveBuildRequest create() => ApproveBuildRequest._();
  ApproveBuildRequest createEmptyInstance() => create();
  static $pb.PbList<ApproveBuildRequest> createRepeated() => $pb.PbList<ApproveBuildRequest>();
  @$core.pragma('dart2js:noInline')
  static ApproveBuildRequest getDefault() => _defaultInstance ??= $pb.GeneratedMessage.$_defaultFor<ApproveBuildRequest>(create);
...
class BuildApproval extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'BuildApproval', package: const $pb.PackageName(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'google.devtools.cloudbuild.v1'), createEmptyInstance: create)
    ..e<BuildApproval_State>(1, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'state', $pb.PbFieldType.OE, defaultOrMaker: BuildApproval_State.STATE_UNSPECIFIED, valueOf: BuildApproval_State.valueOf, enumValues: BuildApproval_State.values)
    ..aOM<ApprovalConfig>(2, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'config', subBuilder: ApprovalConfig.create)
    ..aOM<ApprovalResult>(3, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'result', subBuilder: ApprovalResult.create)
    ..hasRequiredFields = false
  ;
  ...
  factory BuildApproval.fromBuffer($core.List<$core.int> i, [$pb.ExtensionRegistry r = $pb.ExtensionRegistry.EMPTY]) => create()..mergeFromBuffer(i, r);
  factory BuildApproval.fromJson($core.String i, [$pb.ExtensionRegistry r = $pb.ExtensionRegistry.EMPTY]) => create()..mergeFromJson(i, r);
  @$core.Deprecated(
  'Using this can add significant overhead to your binary. '
  'Use [GeneratedMessageGenericExtensions.deepCopy] instead. '
  'Will be removed in next major version')
  ...
  'Use [GeneratedMessageGenericExtensions.rebuild] instead. '
  'Will be removed in next major version')
  BuildApproval copyWith(void Function(BuildApproval) updates) => super.copyWith((message) => updates(message as BuildApproval)) as BuildApproval; // ignore: deprecated_member_use
  $pb.BuilderInfo get info_ => _i;
  @$core.pragma('dart2js:noInline')
  static BuildApproval create() => BuildApproval._();
  BuildApproval createEmptyInstance() => create();
  static $pb.PbList<BuildApproval> createRepeated() => $pb.PbList<BuildApproval>();
  @$core.pragma('dart2js:noInline')
  static BuildApproval getDefault() => _defaultInstance ??= $pb.GeneratedMessage.$_defaultFor<BuildApproval>(create);
  static BuildApproval? _defaultInstance;

  @$pb.TagNumber(1)
  BuildApproval_State get state => $_getN(0);
  @$pb.TagNumber(1)
  set state(BuildApproval_State v) { setField(1, v); }
  @$pb.TagNumber(1)
  ...
  @$pb.TagNumber(2)
  set config(ApprovalConfig v) { setField(2, v); }
  @$pb.TagNumber(2)
  ...
  @$pb.TagNumber(3)
  set result(ApprovalResult v) { setField(3, v); }
  @$pb.TagNumber(3)
...
class ApprovalConfig extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'ApprovalConfig', package: const $pb.PackageName(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'google.devtools.cloudbuild.v1'), createEmptyInstance: create)
    ..aOB(1, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'approvalRequired')
    ..hasRequiredFields = false
  ;
  ...
  factory ApprovalConfig.fromBuffer($core.List<$core.int> i, [$pb.ExtensionRegistry r = $pb.ExtensionRegistry.EMPTY]) => create()..mergeFromBuffer(i, r);
  factory ApprovalConfig.fromJson($core.String i, [$pb.ExtensionRegistry r = $pb.ExtensionRegistry.EMPTY]) => create()..mergeFromJson(i, r);
  @$core.Deprecated(
  'Using this can add significant overhead to your binary. '
  'Use [GeneratedMessageGenericExtensions.deepCopy] instead. '
  'Will be removed in next major version')
  ...
  'Use [GeneratedMessageGenericExtensions.rebuild] instead. '
  'Will be removed in next major version')
  ApprovalConfig copyWith(void Function(ApprovalConfig) updates) => super.copyWith((message) => updates(message as ApprovalConfig)) as ApprovalConfig; // ignore: deprecated_member_use
  $pb.BuilderInfo get info_ => _i;
  @$core.pragma('dart2js:noInline')
  static ApprovalConfig create() => ApprovalConfig._();
  ApprovalConfig createEmptyInstance() => create();
  static $pb.PbList<ApprovalConfig> createRepeated() => $pb.PbList<ApprovalConfig>();
  @$core.pragma('dart2js:noInline')
  static ApprovalConfig getDefault() => _defaultInstance ??= $pb.GeneratedMessage.$_defaultFor<ApprovalConfig>(create);
  static ApprovalConfig? _defaultInstance;

  @$pb.TagNumber(1)
  $core.bool get approvalRequired => $_getBF(0);
  @$pb.TagNumber(1)
  set approvalRequired($core.bool v) { $_setBool(0, v); }
  @$pb.TagNumber(1)
...
class ApprovalResult extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'ApprovalResult', package: const $pb.PackageName(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'google.devtools.cloudbuild.v1'), createEmptyInstance: create)
    ..aOS(2, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'approverAccount')
    ..aOM<$4.Timestamp>(3, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'approvalTime', subBuilder: $4.Timestamp.create)
    ..e<ApprovalResult_Decision>(4, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'decision', $pb.PbFieldType.OE, defaultOrMaker: ApprovalResult_Decision.DECISION_UNSPECIFIED, valueOf: ApprovalResult_Decision.valueOf, enumValues: ApprovalResult_Decision.values)
  ...
  @$pb.TagNumber(2)
  set approverAccount($core.String v) { $_setString(0, v); }
  @$pb.TagNumber(2)
  ...
  @$pb.TagNumber(3)
  set approvalTime($4.Timestamp v) { setField(3, v); }
  @$pb.TagNumber(3)
  ...
  @$pb.TagNumber(4)
  set decision(ApprovalResult_Decision v) { setField(4, v); }
  @$pb.TagNumber(4)
...
class BuildTrigger extends $pb.GeneratedMessage {
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'BuildTrigger', package: const $pb.PackageName(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'google.devtools.cloudbuild.v1'), createEmptyInstance: create)
    ..oo(0, [4, 8, 18])
    ..aOS(1, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'id')
    ..aOM<Build>(4, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'build', subBuilder: Build.create)
    ..aOM<$4.Timestamp>(5, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'createTime', subBuilder: $4.Timestamp.create)
    ..aOM<RepoSource>(7, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'triggerTemplate', subBuilder: RepoSource.create)
    ...
    ..m<$core.String, $core.String>(11, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'substitutions', entryClassName: 'BuildTrigger.SubstitutionsEntry', keyFieldType: $pb.PbFieldType.OS, valueFieldType: $pb.PbFieldType.OS, packageName: const $pb.PackageName('google.devtools.cloudbuild.v1'))
    ..aOM<GitHubEventsConfig>(13, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'github', subBuilder: GitHubEventsConfig.create)
    ..pPS(15, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'ignoredFiles')
    ..pPS(16, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'includedFiles')
    ..aOB(18, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'autodetect')
    ..pPS(19, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'tags')
    ..aOS(21, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'name')
    ..aOM<PubsubConfig>(29, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'pubsubConfig', subBuilder: PubsubConfig.create)
    ..aOS(30, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'filter')
    ..aOM<WebhookConfig>(31, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'webhookConfig', subBuilder: WebhookConfig.create)
    ..aOS(33, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'serviceAccount')
    ..aOS(34, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'resourceName')
    ..hasRequiredFields = false
  ;
  ...
  factory BuildTrigger.fromBuffer($core.List<$core.int> i, [$pb.ExtensionRegistry r = $pb.ExtensionRegistry.EMPTY]) => create()..mergeFromBuffer(i, r);
  factory BuildTrigger.fromJson($core.String i, [$pb.ExtensionRegistry r = $pb.ExtensionRegistry.EMPTY]) => create()..mergeFromJson(i, r);
  @$core.Deprecated(
  'Using this can add significant overhead to your binary. '
  'Use [GeneratedMessageGenericExtensions.deepCopy] instead. '
  'Will be removed in next major version')
  ...
  'Use [GeneratedMessageGenericExtensions.rebuild] instead. '
  'Will be removed in next major version')
  BuildTrigger copyWith(void Function(BuildTrigger) updates) => super.copyWith((message) => updates(message as BuildTrigger)) as BuildTrigger; // ignore: deprecated_member_use
  $pb.BuilderInfo get info_ => _i;
  @$core.pragma('dart2js:noInline')
  ...
  @$core.pragma('dart2js:noInline')
  static BuildTrigger getDefault() => _defaultInstance ??= $pb.GeneratedMessage.$_defaultFor<BuildTrigger>(create);
  ...
  @$pb.TagNumber(13)
  set github(GitHubEventsConfig v) { setField(13, v); }
  @$pb.TagNumber(13)
  ...
  @$pb.TagNumber(18)
  set autodetect($core.bool v) { $_setBool(11, v); }
  @$pb.TagNumber(18)
  ...
  @$pb.TagNumber(29)
  set pubsubConfig(PubsubConfig v) { setField(29, v); }
  @$pb.TagNumber(29)
  ...
  @$pb.TagNumber(31)
  set webhookConfig(WebhookConfig v) { setField(31, v); }
  @$pb.TagNumber(31)
  ...
  @$pb.TagNumber(33)
  set serviceAccount($core.String v) { $_setString(17, v); }
  @$pb.TagNumber(33)
...
class GitHubEventsConfig extends $pb.GeneratedMessage {
  static const $core.Map<$core.int, GitHubEventsConfig_Event> _GitHubEventsConfig_EventByTag = {
    4 : GitHubEventsConfig_Event.pullRequest,
    5 : GitHubEventsConfig_Event.push,
    0 : GitHubEventsConfig_Event.notSet
  };
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'GitHubEventsConfig', package: const $pb.PackageName(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'google.devtools.cloudbuild.v1'), createEmptyInstance: create)
    ..oo(0, [4, 5])
    ..aInt64(1, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'installationId')
    ..aOM<PullRequestFilter>(4, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'pullRequest', subBuilder: PullRequestFilter.create)
    ..aOM<PushFilter>(5, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'push', subBuilder: PushFilter.create)
  ...
  factory GitHubEventsConfig.fromBuffer($core.List<$core.int> i, [$pb.ExtensionRegistry r = $pb.ExtensionRegistry.EMPTY]) => create()..mergeFromBuffer(i, r);
  factory GitHubEventsConfig.fromJson($core.String i, [$pb.ExtensionRegistry r = $pb.ExtensionRegistry.EMPTY]) => create()..mergeFromJson(i, r);
  @$core.Deprecated(
  'Using this can add significant overhead to your binary. '
  'Use [GeneratedMessageGenericExtensions.deepCopy] instead. '
  'Will be removed in next major version')
  ...
  'Use [GeneratedMessageGenericExtensions.rebuild] instead. '
  'Will be removed in next major version')
  GitHubEventsConfig copyWith(void Function(GitHubEventsConfig) updates) => super.copyWith((message) => updates(message as GitHubEventsConfig)) as GitHubEventsConfig; // ignore: deprecated_member_use
  $pb.BuilderInfo get info_ => _i;
  @$core.pragma('dart2js:noInline')
  static GitHubEventsConfig create() => GitHubEventsConfig._();
  GitHubEventsConfig createEmptyInstance() => create();
  static $pb.PbList<GitHubEventsConfig> createRepeated() => $pb.PbList<GitHubEventsConfig>();
  @$core.pragma('dart2js:noInline')
  static GitHubEventsConfig getDefault() => _defaultInstance ??= $pb.GeneratedMessage.$_defaultFor<GitHubEventsConfig>(create);
  static GitHubEventsConfig? _defaultInstance;

  GitHubEventsConfig_Event whichEvent() => _GitHubEventsConfig_EventByTag[$_whichOneof(0)]!;
  ...
  @$core.Deprecated('This field is deprecated.')
  @$pb.TagNumber(1)
  set installationId($fixnum.Int64 v) { $_setInt64(0, v); }
  @$core.Deprecated('This field is deprecated.')
  @$pb.TagNumber(1)
  ...
  @$pb.TagNumber(4)
  set pullRequest(PullRequestFilter v) { setField(4, v); }
  @$pb.TagNumber(4)
  ...
  @$pb.TagNumber(5)
  set push(PushFilter v) { setField(5, v); }
  @$pb.TagNumber(5)
...
class PubsubConfig extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'PubsubConfig', package: const $pb.PackageName(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'google.devtools.cloudbuild.v1'), createEmptyInstance: create)
    ..aOS(1, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'subscription')
    ..aOS(2, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'topic')
    ..aOS(3, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'serviceAccountEmail')
    ..e<PubsubConfig_State>(4, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'state', $pb.PbFieldType.OE, defaultOrMaker: PubsubConfig_State.STATE_UNSPECIFIED, valueOf: PubsubConfig_State.valueOf, enumValues: PubsubConfig_State.values)
    ..hasRequiredFields = false
  ;
  ...
  factory PubsubConfig.fromBuffer($core.List<$core.int> i, [$pb.ExtensionRegistry r = $pb.ExtensionRegistry.EMPTY]) => create()..mergeFromBuffer(i, r);
  factory PubsubConfig.fromJson($core.String i, [$pb.ExtensionRegistry r = $pb.ExtensionRegistry.EMPTY]) => create()..mergeFromJson(i, r);
  @$core.Deprecated(
  'Using this can add significant overhead to your binary. '
  'Use [GeneratedMessageGenericExtensions.deepCopy] instead. '
  'Will be removed in next major version')
  ...
  'Use [GeneratedMessageGenericExtensions.rebuild] instead. '
  'Will be removed in next major version')
  PubsubConfig copyWith(void Function(PubsubConfig) updates) => super.copyWith((message) => updates(message as PubsubConfig)) as PubsubConfig; // ignore: deprecated_member_use
  $pb.BuilderInfo get info_ => _i;
  @$core.pragma('dart2js:noInline')
  static PubsubConfig create() => PubsubConfig._();
  PubsubConfig createEmptyInstance() => create();
  static $pb.PbList<PubsubConfig> createRepeated() => $pb.PbList<PubsubConfig>();
  @$core.pragma('dart2js:noInline')
  static PubsubConfig getDefault() => _defaultInstance ??= $pb.GeneratedMessage.$_defaultFor<PubsubConfig>(create);
  ...
  @$pb.TagNumber(4)
  set state(PubsubConfig_State v) { setField(4, v); }
  @$pb.TagNumber(4)
...
enum WebhookConfig_AuthMethod {
  secret, 
  notSet
}

class WebhookConfig extends $pb.GeneratedMessage {
  static const $core.Map<$core.int, WebhookConfig_AuthMethod> _WebhookConfig_AuthMethodByTag = {
    3 : WebhookConfig_AuthMethod.secret,
    0 : WebhookConfig_AuthMethod.notSet
  };
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'WebhookConfig', package: const $pb.PackageName(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'google.devtools.cloudbuild.v1'), createEmptyInstance: create)
    ..oo(0, [3])
    ..aOS(3, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'secret')
    ..e<WebhookConfig_State>(4, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'state', $pb.PbFieldType.OE, defaultOrMaker: WebhookConfig_State.STATE_UNSPECIFIED, valueOf: WebhookConfig_State.valueOf, enumValues: WebhookConfig_State.values)
    ..hasRequiredFields = false
  ;
  ...
  factory WebhookConfig.fromBuffer($core.List<$core.int> i, [$pb.ExtensionRegistry r = $pb.ExtensionRegistry.EMPTY]) => create()..mergeFromBuffer(i, r);
  factory WebhookConfig.fromJson($core.String i, [$pb.ExtensionRegistry r = $pb.ExtensionRegistry.EMPTY]) => create()..mergeFromJson(i, r);
  @$core.Deprecated(
  'Using this can add significant overhead to your binary. '
  'Use [GeneratedMessageGenericExtensions.deepCopy] instead. '
  'Will be removed in next major version')
  ...
  'Use [GeneratedMessageGenericExtensions.rebuild] instead. '
  'Will be removed in next major version')
  WebhookConfig copyWith(void Function(WebhookConfig) updates) => super.copyWith((message) => updates(message as WebhookConfig)) as WebhookConfig; // ignore: deprecated_member_use
  $pb.BuilderInfo get info_ => _i;
  @$core.pragma('dart2js:noInline')
  ...
  WebhookConfig_AuthMethod whichAuthMethod() => _WebhookConfig_AuthMethodByTag[$_whichOneof(0)]!;
  ...
  @$pb.TagNumber(4)
  set state(WebhookConfig_State v) { setField(4, v); }
  @$pb.TagNumber(4)
...
enum PullRequestFilter_GitRef {
  branch, 
  notSet
}

class PullRequestFilter extends $pb.GeneratedMessage {
  static const $core.Map<$core.int, PullRequestFilter_GitRef> _PullRequestFilter_GitRefByTag = {
    2 : PullRequestFilter_GitRef.branch,
    0 : PullRequestFilter_GitRef.notSet
  };
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'PullRequestFilter', package: const $pb.PackageName(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'google.devtools.cloudbuild.v1'), createEmptyInstance: create)
    ..oo(0, [2])
    ..aOS(2, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'branch')
    ..e<PullRequestFilter_CommentControl>(5, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'commentControl', $pb.PbFieldType.OE, defaultOrMaker: PullRequestFilter_CommentControl.COMMENTS_DISABLED, valueOf: PullRequestFilter_CommentControl.valueOf, enumValues: PullRequestFilter_CommentControl.values)
    ..aOB(6, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'invertRegex')
    ..hasRequiredFields = false
  ;
  ...
  factory PullRequestFilter.fromBuffer($core.List<$core.int> i, [$pb.ExtensionRegistry r = $pb.ExtensionRegistry.EMPTY]) => create()..mergeFromBuffer(i, r);
  factory PullRequestFilter.fromJson($core.String i, [$pb.ExtensionRegistry r = $pb.ExtensionRegistry.EMPTY]) => create()..mergeFromJson(i, r);
  @$core.Deprecated(
  'Using this can add significant overhead to your binary. '
  'Use [GeneratedMessageGenericExtensions.deepCopy] instead. '
  'Will be removed in next major version')
  ...
  'Use [GeneratedMessageGenericExtensions.rebuild] instead. '
  'Will be removed in next major version')
  PullRequestFilter copyWith(void Function(PullRequestFilter) updates) => super.copyWith((message) => updates(message as PullRequestFilter)) as PullRequestFilter; // ignore: deprecated_member_use
  $pb.BuilderInfo get info_ => _i;
  @$core.pragma('dart2js:noInline')
  static PullRequestFilter create() => PullRequestFilter._();
  PullRequestFilter createEmptyInstance() => create();
  static $pb.PbList<PullRequestFilter> createRepeated() => $pb.PbList<PullRequestFilter>();
  @$core.pragma('dart2js:noInline')
  static PullRequestFilter getDefault() => _defaultInstance ??= $pb.GeneratedMessage.$_defaultFor<PullRequestFilter>(create);
  static PullRequestFilter? _defaultInstance;

  PullRequestFilter_GitRef whichGitRef() => _PullRequestFilter_GitRefByTag[$_whichOneof(0)]!;
  ...
  @$pb.TagNumber(5)
  set commentControl(PullRequestFilter_CommentControl v) { setField(5, v); }
  @$pb.TagNumber(5)
  ...
  @$pb.TagNumber(6)
  set invertRegex($core.bool v) { $_setBool(2, v); }
  @$pb.TagNumber(6)
...
class PushFilter extends $pb.GeneratedMessage {
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'PushFilter', package: const $pb.PackageName(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'google.devtools.cloudbuild.v1'), createEmptyInstance: create)
    ..oo(0, [2, 3])
    ..aOS(2, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'branch')
    ..aOS(3, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'tag')
    ..aOB(4, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'invertRegex')
    ..hasRequiredFields = false
  ;
  ...
  factory PushFilter.fromBuffer($core.List<$core.int> i, [$pb.ExtensionRegistry r = $pb.ExtensionRegistry.EMPTY]) => create()..mergeFromBuffer(i, r);
  factory PushFilter.fromJson($core.String i, [$pb.ExtensionRegistry r = $pb.ExtensionRegistry.EMPTY]) => create()..mergeFromJson(i, r);
  @$core.Deprecated(
  'Using this can add significant overhead to your binary. '
  'Use [GeneratedMessageGenericExtensions.deepCopy] instead. '
  'Will be removed in next major version')
  ...
  'Use [GeneratedMessageGenericExtensions.rebuild] instead. '
  'Will be removed in next major version')
  PushFilter copyWith(void Function(PushFilter) updates) => super.copyWith((message) => updates(message as PushFilter)) as PushFilter; // ignore: deprecated_member_use
  $pb.BuilderInfo get info_ => _i;
  @$core.pragma('dart2js:noInline')
  ...
  @$core.pragma('dart2js:noInline')
  static PushFilter getDefault() => _defaultInstance ??= $pb.GeneratedMessage.$_defaultFor<PushFilter>(create);
...
class CreateBuildTriggerRequest extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'CreateBuildTriggerRequest', package: const $pb.PackageName(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'google.devtools.cloudbuild.v1'), createEmptyInstance: create)
    ..aOS(1, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'projectId')
    ..aOM<BuildTrigger>(2, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'trigger', subBuilder: BuildTrigger.create)
  ...
  factory CreateBuildTriggerRequest.fromBuffer($core.List<$core.int> i, [$pb.ExtensionRegistry r = $pb.ExtensionRegistry.EMPTY]) => create()..mergeFromBuffer(i, r);
  factory CreateBuildTriggerRequest.fromJson($core.String i, [$pb.ExtensionRegistry r = $pb.ExtensionRegistry.EMPTY]) => create()..mergeFromJson(i, r);
  @$core.Deprecated(
  'Using this can add significant overhead to your binary. '
  'Use [GeneratedMessageGenericExtensions.deepCopy] instead. '
  'Will be removed in next major version')
  ...
  'Use [GeneratedMessageGenericExtensions.rebuild] instead. '
  'Will be removed in next major version')
  CreateBuildTriggerRequest copyWith(void Function(CreateBuildTriggerRequest) updates) => super.copyWith((message) => updates(message as CreateBuildTriggerRequest)) as CreateBuildTriggerRequest; // ignore: deprecated_member_use
  $pb.BuilderInfo get info_ => _i;
  @$core.pragma('dart2js:noInline')
  ...
  @$core.pragma('dart2js:noInline')
  static CreateBuildTriggerRequest getDefault() => _defaultInstance ??= $pb.GeneratedMessage.$_defaultFor<CreateBuildTriggerRequest>(create);
...
class GetBuildTriggerRequest extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'GetBuildTriggerRequest', package: const $pb.PackageName(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'google.devtools.cloudbuild.v1'), createEmptyInstance: create)
    ..aOS(1, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'projectId')
    ..aOS(2, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'triggerId')
    ..aOS(3, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'name')
    ..hasRequiredFields = false
  ...
  factory GetBuildTriggerRequest.fromBuffer($core.List<$core.int> i, [$pb.ExtensionRegistry r = $pb.ExtensionRegistry.EMPTY]) => create()..mergeFromBuffer(i, r);
  factory GetBuildTriggerRequest.fromJson($core.String i, [$pb.ExtensionRegistry r = $pb.ExtensionRegistry.EMPTY]) => create()..mergeFromJson(i, r);
  @$core.Deprecated(
  'Using this can add significant overhead to your binary. '
  'Use [GeneratedMessageGenericExtensions.deepCopy] instead. '
  'Will be removed in next major version')
  ...
  'Use [GeneratedMessageGenericExtensions.rebuild] instead. '
  'Will be removed in next major version')
  GetBuildTriggerRequest copyWith(void Function(GetBuildTriggerRequest) updates) => super.copyWith((message) => updates(message as GetBuildTriggerRequest)) as GetBuildTriggerRequest; // ignore: deprecated_member_use
  $pb.BuilderInfo get info_ => _i;
  @$core.pragma('dart2js:noInline')
  ...
  @$core.pragma('dart2js:noInline')
  static GetBuildTriggerRequest getDefault() => _defaultInstance ??= $pb.GeneratedMessage.$_defaultFor<GetBuildTriggerRequest>(create);
...
class ListBuildTriggersRequest extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'ListBuildTriggersRequest', package: const $pb.PackageName(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'google.devtools.cloudbuild.v1'), createEmptyInstance: create)
    ..aOS(1, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'projectId')
    ..a<$core.int>(2, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'pageSize', $pb.PbFieldType.O3)
    ..aOS(3, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'pageToken')
    ..aOS(4, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'parent')
  ...
  factory ListBuildTriggersRequest.fromBuffer($core.List<$core.int> i, [$pb.ExtensionRegistry r = $pb.ExtensionRegistry.EMPTY]) => create()..mergeFromBuffer(i, r);
  factory ListBuildTriggersRequest.fromJson($core.String i, [$pb.ExtensionRegistry r = $pb.ExtensionRegistry.EMPTY]) => create()..mergeFromJson(i, r);
  @$core.Deprecated(
  'Using this can add significant overhead to your binary. '
  'Use [GeneratedMessageGenericExtensions.deepCopy] instead. '
  'Will be removed in next major version')
  ...
  'Use [GeneratedMessageGenericExtensions.rebuild] instead. '
  'Will be removed in next major version')
  ListBuildTriggersRequest copyWith(void Function(ListBuildTriggersRequest) updates) => super.copyWith((message) => updates(message as ListBuildTriggersRequest)) as ListBuildTriggersRequest; // ignore: deprecated_member_use
  $pb.BuilderInfo get info_ => _i;
  @$core.pragma('dart2js:noInline')
  ...
  @$core.pragma('dart2js:noInline')
  static ListBuildTriggersRequest getDefault() => _defaultInstance ??= $pb.GeneratedMessage.$_defaultFor<ListBuildTriggersRequest>(create);
...
class ListBuildTriggersResponse extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'ListBuildTriggersResponse', package: const $pb.PackageName(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'google.devtools.cloudbuild.v1'), createEmptyInstance: create)
    ..pc<BuildTrigger>(1, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'triggers', $pb.PbFieldType.PM, subBuilder: BuildTrigger.create)
    ..aOS(2, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'nextPageToken')
    ..hasRequiredFields = false
  ;
  ...
  factory ListBuildTriggersResponse.fromBuffer($core.List<$core.int> i, [$pb.ExtensionRegistry r = $pb.ExtensionRegistry.EMPTY]) => create()..mergeFromBuffer(i, r);
  factory ListBuildTriggersResponse.fromJson($core.String i, [$pb.ExtensionRegistry r = $pb.ExtensionRegistry.EMPTY]) => create()..mergeFromJson(i, r);
  @$core.Deprecated(
  'Using this can add significant overhead to your binary. '
  'Use [GeneratedMessageGenericExtensions.deepCopy] instead. '
  'Will be removed in next major version')
  ...
  'Use [GeneratedMessageGenericExtensions.rebuild] instead. '
  'Will be removed in next major version')
  ListBuildTriggersResponse copyWith(void Function(ListBuildTriggersResponse) updates) => super.copyWith((message) => updates(message as ListBuildTriggersResponse)) as ListBuildTriggersResponse; // ignore: deprecated_member_use
  $pb.BuilderInfo get info_ => _i;
  @$core.pragma('dart2js:noInline')
  ...
  @$core.pragma('dart2js:noInline')
  static ListBuildTriggersResponse getDefault() => _defaultInstance ??= $pb.GeneratedMessage.$_defaultFor<ListBuildTriggersResponse>(create);
...
class DeleteBuildTriggerRequest extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'DeleteBuildTriggerRequest', package: const $pb.PackageName(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'google.devtools.cloudbuild.v1'), createEmptyInstance: create)
    ..aOS(1, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'projectId')
    ..aOS(2, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'triggerId')
    ..aOS(3, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'name')
    ..hasRequiredFields = false
  ...
  factory DeleteBuildTriggerRequest.fromBuffer($core.List<$core.int> i, [$pb.ExtensionRegistry r = $pb.ExtensionRegistry.EMPTY]) => create()..mergeFromBuffer(i, r);
  factory DeleteBuildTriggerRequest.fromJson($core.String i, [$pb.ExtensionRegistry r = $pb.ExtensionRegistry.EMPTY]) => create()..mergeFromJson(i, r);
  @$core.Deprecated(
  'Using this can add significant overhead to your binary. '
  'Use [GeneratedMessageGenericExtensions.deepCopy] instead. '
  'Will be removed in next major version')
  ...
  'Use [GeneratedMessageGenericExtensions.rebuild] instead. '
  'Will be removed in next major version')
  DeleteBuildTriggerRequest copyWith(void Function(DeleteBuildTriggerRequest) updates) => super.copyWith((message) => updates(message as DeleteBuildTriggerRequest)) as DeleteBuildTriggerRequest; // ignore: deprecated_member_use
  $pb.BuilderInfo get info_ => _i;
  @$core.pragma('dart2js:noInline')
  ...
  @$core.pragma('dart2js:noInline')
  static DeleteBuildTriggerRequest getDefault() => _defaultInstance ??= $pb.GeneratedMessage.$_defaultFor<DeleteBuildTriggerRequest>(create);
...
class UpdateBuildTriggerRequest extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'UpdateBuildTriggerRequest', package: const $pb.PackageName(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'google.devtools.cloudbuild.v1'), createEmptyInstance: create)
    ..aOS(1, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'projectId')
    ..aOS(2, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'triggerId')
    ..aOM<BuildTrigger>(3, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'trigger', subBuilder: BuildTrigger.create)
    ..hasRequiredFields = false
  ;
  ...
  factory UpdateBuildTriggerRequest.fromBuffer($core.List<$core.int> i, [$pb.ExtensionRegistry r = $pb.ExtensionRegistry.EMPTY]) => create()..mergeFromBuffer(i, r);
  factory UpdateBuildTriggerRequest.fromJson($core.String i, [$pb.ExtensionRegistry r = $pb.ExtensionRegistry.EMPTY]) => create()..mergeFromJson(i, r);
  @$core.Deprecated(
  'Using this can add significant overhead to your binary. '
  'Use [GeneratedMessageGenericExtensions.deepCopy] instead. '
  'Will be removed in next major version')
  ...
  'Use [GeneratedMessageGenericExtensions.rebuild] instead. '
  'Will be removed in next major version')
  UpdateBuildTriggerRequest copyWith(void Function(UpdateBuildTriggerRequest) updates) => super.copyWith((message) => updates(message as UpdateBuildTriggerRequest)) as UpdateBuildTriggerRequest; // ignore: deprecated_member_use
  $pb.BuilderInfo get info_ => _i;
  @$core.pragma('dart2js:noInline')
  ...
  @$core.pragma('dart2js:noInline')
  static UpdateBuildTriggerRequest getDefault() => _defaultInstance ??= $pb.GeneratedMessage.$_defaultFor<UpdateBuildTriggerRequest>(create);
...
class BuildOptions_PoolOption extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'BuildOptions.PoolOption', package: const $pb.PackageName(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'google.devtools.cloudbuild.v1'), createEmptyInstance: create)
    ..aOS(1, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'name')
    ..hasRequiredFields = false
  ;
  ...
  factory BuildOptions_PoolOption.fromBuffer($core.List<$core.int> i, [$pb.ExtensionRegistry r = $pb.ExtensionRegistry.EMPTY]) => create()..mergeFromBuffer(i, r);
  factory BuildOptions_PoolOption.fromJson($core.String i, [$pb.ExtensionRegistry r = $pb.ExtensionRegistry.EMPTY]) => create()..mergeFromJson(i, r);
  @$core.Deprecated(
  'Using this can add significant overhead to your binary. '
  'Use [GeneratedMessageGenericExtensions.deepCopy] instead. '
  'Will be removed in next major version')
  BuildOptions_PoolOption clone() => BuildOptions_PoolOption()..mergeFromMessage(this);
  @$core.Deprecated(
  'Using this can add significant overhead to your binary. '
  'Use [GeneratedMessageGenericExtensions.rebuild] instead. '
  'Will be removed in next major version')
  BuildOptions_PoolOption copyWith(void Function(BuildOptions_PoolOption) updates) => super.copyWith((message) => updates(message as BuildOptions_PoolOption)) as BuildOptions_PoolOption; // ignore: deprecated_member_use
  $pb.BuilderInfo get info_ => _i;
  @$core.pragma('dart2js:noInline')
  static BuildOptions_PoolOption create() => BuildOptions_PoolOption._();
  BuildOptions_PoolOption createEmptyInstance() => create();
  static $pb.PbList<BuildOptions_PoolOption> createRepeated() => $pb.PbList<BuildOptions_PoolOption>();
  @$core.pragma('dart2js:noInline')
  static BuildOptions_PoolOption getDefault() => _defaultInstance ??= $pb.GeneratedMessage.$_defaultFor<BuildOptions_PoolOption>(create);
...
class BuildOptions extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'BuildOptions', package: const $pb.PackageName(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'google.devtools.cloudbuild.v1'), createEmptyInstance: create)
    ...
    ..aOB(17, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'dynamicSubstitutions')
    ..aOM<BuildOptions_PoolOption>(19, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'pool', subBuilder: BuildOptions_PoolOption.create)
    ..hasRequiredFields = false
  ;
  ...
  @$pb.TagNumber(17)
  set dynamicSubstitutions($core.bool v) { $_setBool(11, v); }
  @$pb.TagNumber(17)
  ...
  @$pb.TagNumber(19)
  set pool(BuildOptions_PoolOption v) { setField(19, v); }
  @$pb.TagNumber(19)
...
class ReceiveTriggerWebhookRequest extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'ReceiveTriggerWebhookRequest', package: const $pb.PackageName(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'google.devtools.cloudbuild.v1'), createEmptyInstance: create)
    ..aOM<$5.HttpBody>(1, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'body', subBuilder: $5.HttpBody.create)
    ..aOS(2, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'projectId')
    ..aOS(3, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'trigger')
  ...
  factory ReceiveTriggerWebhookRequest.fromBuffer($core.List<$core.int> i, [$pb.ExtensionRegistry r = $pb.ExtensionRegistry.EMPTY]) => create()..mergeFromBuffer(i, r);
  factory ReceiveTriggerWebhookRequest.fromJson($core.String i, [$pb.ExtensionRegistry r = $pb.ExtensionRegistry.EMPTY]) => create()..mergeFromJson(i, r);
  @$core.Deprecated(
  'Using this can add significant overhead to your binary. '
  'Use [GeneratedMessageGenericExtensions.deepCopy] instead. '
  'Will be removed in next major version')
  ReceiveTriggerWebhookRequest clone() => ReceiveTriggerWebhookRequest()..mergeFromMessage(this);
  @$core.Deprecated(
  'Using this can add significant overhead to your binary. '
  'Use [GeneratedMessageGenericExtensions.rebuild] instead. '
  'Will be removed in next major version')
  ReceiveTriggerWebhookRequest copyWith(void Function(ReceiveTriggerWebhookRequest) updates) => super.copyWith((message) => updates(message as ReceiveTriggerWebhookRequest)) as ReceiveTriggerWebhookRequest; // ignore: deprecated_member_use
  $pb.BuilderInfo get info_ => _i;
  @$core.pragma('dart2js:noInline')
  static ReceiveTriggerWebhookRequest create() => ReceiveTriggerWebhookRequest._();
  ReceiveTriggerWebhookRequest createEmptyInstance() => create();
  static $pb.PbList<ReceiveTriggerWebhookRequest> createRepeated() => $pb.PbList<ReceiveTriggerWebhookRequest>();
  @$core.pragma('dart2js:noInline')
  static ReceiveTriggerWebhookRequest getDefault() => _defaultInstance ??= $pb.GeneratedMessage.$_defaultFor<ReceiveTriggerWebhookRequest>(create);
  static ReceiveTriggerWebhookRequest? _defaultInstance;

  @$pb.TagNumber(1)
  $5.HttpBody get body => $_getN(0);
  @$pb.TagNumber(1)
  set body($5.HttpBody v) { setField(1, v); }
  @$pb.TagNumber(1)
...
class ReceiveTriggerWebhookResponse extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'ReceiveTriggerWebhookResponse', package: const $pb.PackageName(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'google.devtools.cloudbuild.v1'), createEmptyInstance: create)
    ..hasRequiredFields = false
  ;

  ReceiveTriggerWebhookResponse._() : super();
  factory ReceiveTriggerWebhookResponse() => create();
  factory ReceiveTriggerWebhookResponse.fromBuffer($core.List<$core.int> i, [$pb.ExtensionRegistry r = $pb.ExtensionRegistry.EMPTY]) => create()..mergeFromBuffer(i, r);
  factory ReceiveTriggerWebhookResponse.fromJson($core.String i, [$pb.ExtensionRegistry r = $pb.ExtensionRegistry.EMPTY]) => create()..mergeFromJson(i, r);
  @$core.Deprecated(
  'Using this can add significant overhead to your binary. '
  'Use [GeneratedMessageGenericExtensions.deepCopy] instead. '
  'Will be removed in next major version')
  ReceiveTriggerWebhookResponse clone() => ReceiveTriggerWebhookResponse()..mergeFromMessage(this);
  @$core.Deprecated(
  'Using this can add significant overhead to your binary. '
  'Use [GeneratedMessageGenericExtensions.rebuild] instead. '
  'Will be removed in next major version')
  ReceiveTriggerWebhookResponse copyWith(void Function(ReceiveTriggerWebhookResponse) updates) => super.copyWith((message) => updates(message as ReceiveTriggerWebhookResponse)) as ReceiveTriggerWebhookResponse; // ignore: deprecated_member_use
  $pb.BuilderInfo get info_ => _i;
  @$core.pragma('dart2js:noInline')
  static ReceiveTriggerWebhookResponse create() => ReceiveTriggerWebhookResponse._();
  ReceiveTriggerWebhookResponse createEmptyInstance() => create();
  static $pb.PbList<ReceiveTriggerWebhookResponse> createRepeated() => $pb.PbList<ReceiveTriggerWebhookResponse>();
  @$core.pragma('dart2js:noInline')
  static ReceiveTriggerWebhookResponse getDefault() => _defaultInstance ??= $pb.GeneratedMessage.$_defaultFor<ReceiveTriggerWebhookResponse>(create);
  static ReceiveTriggerWebhookResponse? _defaultInstance;
}

enum WorkerPool_Config {
  privatePoolV1Config, 
  notSet
}
...
class WorkerPool extends $pb.GeneratedMessage {
  static const $core.Map<$core.int, WorkerPool_Config> _WorkerPool_ConfigByTag = {
    12 : WorkerPool_Config.privatePoolV1Config,
    0 : WorkerPool_Config.notSet
  };
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'WorkerPool', package: const $pb.PackageName(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'google.devtools.cloudbuild.v1'), createEmptyInstance: create)
    ..oo(0, [12])
    ..aOS(1, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'name')
    ...
    ..m<$core.String, $core.String>(4, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'annotations', entryClassName: 'WorkerPool.AnnotationsEntry', keyFieldType: $pb.PbFieldType.OS, valueFieldType: $pb.PbFieldType.OS, packageName: const $pb.PackageName('google.devtools.cloudbuild.v1'))
    ..aOM<$4.Timestamp>(5, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'createTime', subBuilder: $4.Timestamp.create)
    ..aOM<$4.Timestamp>(6, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'updateTime', subBuilder: $4.Timestamp.create)
    ..aOM<$4.Timestamp>(7, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'deleteTime', subBuilder: $4.Timestamp.create)
    ..e<WorkerPool_State>(8, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'state', $pb.PbFieldType.OE, defaultOrMaker: WorkerPool_State.STATE_UNSPECIFIED, valueOf: WorkerPool_State.valueOf, enumValues: WorkerPool_State.values)
    ..aOS(11, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'etag')
    ..aOM<PrivatePoolV1Config>(12, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'privatePoolV1Config', subBuilder: PrivatePoolV1Config.create)
    ..hasRequiredFields = false
  ;
  ...
  'Use [GeneratedMessageGenericExtensions.rebuild] instead. '
  'Will be removed in next major version')
  WorkerPool copyWith(void Function(WorkerPool) updates) => super.copyWith((message) => updates(message as WorkerPool)) as WorkerPool; // ignore: deprecated_member_use
  $pb.BuilderInfo get info_ => _i;
  @$core.pragma('dart2js:noInline')
  ...
  @$pb.TagNumber(7)
  set deleteTime($4.Timestamp v) { setField(7, v); }
  @$pb.TagNumber(7)
  ...
  @$pb.TagNumber(8)
  set state(WorkerPool_State v) { setField(8, v); }
  @$pb.TagNumber(8)
  ...
  @$pb.TagNumber(12)
  set privatePoolV1Config(PrivatePoolV1Config v) { setField(12, v); }
  @$pb.TagNumber(12)
...
class PrivatePoolV1Config_WorkerConfig extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'PrivatePoolV1Config.WorkerConfig', package: const $pb.PackageName(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'google.devtools.cloudbuild.v1'), createEmptyInstance: create)
    ..aOS(1, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'machineType')
    ..aInt64(2, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'diskSizeGb')
    ..hasRequiredFields = false
  ;
  ...
  factory PrivatePoolV1Config_WorkerConfig.fromBuffer($core.List<$core.int> i, [$pb.ExtensionRegistry r = $pb.ExtensionRegistry.EMPTY]) => create()..mergeFromBuffer(i, r);
  factory PrivatePoolV1Config_WorkerConfig.fromJson($core.String i, [$pb.ExtensionRegistry r = $pb.ExtensionRegistry.EMPTY]) => create()..mergeFromJson(i, r);
  @$core.Deprecated(
  'Using this can add significant overhead to your binary. '
  'Use [GeneratedMessageGenericExtensions.deepCopy] instead. '
  'Will be removed in next major version')
  PrivatePoolV1Config_WorkerConfig clone() => PrivatePoolV1Config_WorkerConfig()..mergeFromMessage(this);
  @$core.Deprecated(
  'Using this can add significant overhead to your binary. '
  'Use [GeneratedMessageGenericExtensions.rebuild] instead. '
  'Will be removed in next major version')
  PrivatePoolV1Config_WorkerConfig copyWith(void Function(PrivatePoolV1Config_WorkerConfig) updates) => super.copyWith((message) => updates(message as PrivatePoolV1Config_WorkerConfig)) as PrivatePoolV1Config_WorkerConfig; // ignore: deprecated_member_use
  $pb.BuilderInfo get info_ => _i;
  @$core.pragma('dart2js:noInline')
  static PrivatePoolV1Config_WorkerConfig create() => PrivatePoolV1Config_WorkerConfig._();
  PrivatePoolV1Config_WorkerConfig createEmptyInstance() => create();
  static $pb.PbList<PrivatePoolV1Config_WorkerConfig> createRepeated() => $pb.PbList<PrivatePoolV1Config_WorkerConfig>();
  @$core.pragma('dart2js:noInline')
  static PrivatePoolV1Config_WorkerConfig getDefault() => _defaultInstance ??= $pb.GeneratedMessage.$_defaultFor<PrivatePoolV1Config_WorkerConfig>(create);
...
class PrivatePoolV1Config_NetworkConfig extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'PrivatePoolV1Config.NetworkConfig', package: const $pb.PackageName(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'google.devtools.cloudbuild.v1'), createEmptyInstance: create)
    ..aOS(1, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'peeredNetwork')
    ..e<PrivatePoolV1Config_NetworkConfig_EgressOption>(2, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'egressOption', $pb.PbFieldType.OE, defaultOrMaker: PrivatePoolV1Config_NetworkConfig_EgressOption.EGRESS_OPTION_UNSPECIFIED, valueOf: PrivatePoolV1Config_NetworkConfig_EgressOption.valueOf, enumValues: PrivatePoolV1Config_NetworkConfig_EgressOption.values)
    ..hasRequiredFields = false
  ;
  ...
  factory PrivatePoolV1Config_NetworkConfig.fromBuffer($core.List<$core.int> i, [$pb.ExtensionRegistry r = $pb.ExtensionRegistry.EMPTY]) => create()..mergeFromBuffer(i, r);
  factory PrivatePoolV1Config_NetworkConfig.fromJson($core.String i, [$pb.ExtensionRegistry r = $pb.ExtensionRegistry.EMPTY]) => create()..mergeFromJson(i, r);
  @$core.Deprecated(
  'Using this can add significant overhead to your binary. '
  'Use [GeneratedMessageGenericExtensions.deepCopy] instead. '
  'Will be removed in next major version')
  PrivatePoolV1Config_NetworkConfig clone() => PrivatePoolV1Config_NetworkConfig()..mergeFromMessage(this);
  @$core.Deprecated(
  'Using this can add significant overhead to your binary. '
  'Use [GeneratedMessageGenericExtensions.rebuild] instead. '
  'Will be removed in next major version')
  PrivatePoolV1Config_NetworkConfig copyWith(void Function(PrivatePoolV1Config_NetworkConfig) updates) => super.copyWith((message) => updates(message as PrivatePoolV1Config_NetworkConfig)) as PrivatePoolV1Config_NetworkConfig; // ignore: deprecated_member_use
  $pb.BuilderInfo get info_ => _i;
  @$core.pragma('dart2js:noInline')
  static PrivatePoolV1Config_NetworkConfig create() => PrivatePoolV1Config_NetworkConfig._();
  PrivatePoolV1Config_NetworkConfig createEmptyInstance() => create();
  static $pb.PbList<PrivatePoolV1Config_NetworkConfig> createRepeated() => $pb.PbList<PrivatePoolV1Config_NetworkConfig>();
  @$core.pragma('dart2js:noInline')
  static PrivatePoolV1Config_NetworkConfig getDefault() => _defaultInstance ??= $pb.GeneratedMessage.$_defaultFor<PrivatePoolV1Config_NetworkConfig>(create);
  ...
  @$pb.TagNumber(2)
  set egressOption(PrivatePoolV1Config_NetworkConfig_EgressOption v) { setField(2, v); }
  @$pb.TagNumber(2)
...
class PrivatePoolV1Config extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'PrivatePoolV1Config', package: const $pb.PackageName(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'google.devtools.cloudbuild.v1'), createEmptyInstance: create)
    ..aOM<PrivatePoolV1Config_WorkerConfig>(1, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'workerConfig', subBuilder: PrivatePoolV1Config_WorkerConfig.create)
    ..aOM<PrivatePoolV1Config_NetworkConfig>(2, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'networkConfig', subBuilder: PrivatePoolV1Config_NetworkConfig.create)
    ..hasRequiredFields = false
  ;
  ...
  factory PrivatePoolV1Config.fromBuffer($core.List<$core.int> i, [$pb.ExtensionRegistry r = $pb.ExtensionRegistry.EMPTY]) => create()..mergeFromBuffer(i, r);
  factory PrivatePoolV1Config.fromJson($core.String i, [$pb.ExtensionRegistry r = $pb.ExtensionRegistry.EMPTY]) => create()..mergeFromJson(i, r);
  @$core.Deprecated(
  'Using this can add significant overhead to your binary. '
  'Use [GeneratedMessageGenericExtensions.deepCopy] instead. '
  'Will be removed in next major version')
  ...
  'Use [GeneratedMessageGenericExtensions.rebuild] instead. '
  'Will be removed in next major version')
  PrivatePoolV1Config copyWith(void Function(PrivatePoolV1Config) updates) => super.copyWith((message) => updates(message as PrivatePoolV1Config)) as PrivatePoolV1Config; // ignore: deprecated_member_use
  $pb.BuilderInfo get info_ => _i;
  @$core.pragma('dart2js:noInline')
  static PrivatePoolV1Config create() => PrivatePoolV1Config._();
  PrivatePoolV1Config createEmptyInstance() => create();
  static $pb.PbList<PrivatePoolV1Config> createRepeated() => $pb.PbList<PrivatePoolV1Config>();
  @$core.pragma('dart2js:noInline')
  static PrivatePoolV1Config getDefault() => _defaultInstance ??= $pb.GeneratedMessage.$_defaultFor<PrivatePoolV1Config>(create);
  static PrivatePoolV1Config? _defaultInstance;

  @$pb.TagNumber(1)
  PrivatePoolV1Config_WorkerConfig get workerConfig => $_getN(0);
  @$pb.TagNumber(1)
  set workerConfig(PrivatePoolV1Config_WorkerConfig v) { setField(1, v); }
  @$pb.TagNumber(1)
  ...
  @$pb.TagNumber(2)
  set networkConfig(PrivatePoolV1Config_NetworkConfig v) { setField(2, v); }
  @$pb.TagNumber(2)
...
class CreateWorkerPoolRequest extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'CreateWorkerPoolRequest', package: const $pb.PackageName(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'google.devtools.cloudbuild.v1'), createEmptyInstance: create)
    ..aOS(1, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'parent')
    ..aOM<WorkerPool>(2, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'workerPool', subBuilder: WorkerPool.create)
    ..aOS(3, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'workerPoolId')
  ...
  factory CreateWorkerPoolRequest.fromBuffer($core.List<$core.int> i, [$pb.ExtensionRegistry r = $pb.ExtensionRegistry.EMPTY]) => create()..mergeFromBuffer(i, r);
  factory CreateWorkerPoolRequest.fromJson($core.String i, [$pb.ExtensionRegistry r = $pb.ExtensionRegistry.EMPTY]) => create()..mergeFromJson(i, r);
  @$core.Deprecated(
  'Using this can add significant overhead to your binary. '
  'Use [GeneratedMessageGenericExtensions.deepCopy] instead. '
  'Will be removed in next major version')
  CreateWorkerPoolRequest clone() => CreateWorkerPoolRequest()..mergeFromMessage(this);
  @$core.Deprecated(
  'Using this can add significant overhead to your binary. '
  'Use [GeneratedMessageGenericExtensions.rebuild] instead. '
  'Will be removed in next major version')
  CreateWorkerPoolRequest copyWith(void Function(CreateWorkerPoolRequest) updates) => super.copyWith((message) => updates(message as CreateWorkerPoolRequest)) as CreateWorkerPoolRequest; // ignore: deprecated_member_use
  $pb.BuilderInfo get info_ => _i;
  @$core.pragma('dart2js:noInline')
  static CreateWorkerPoolRequest create() => CreateWorkerPoolRequest._();
  CreateWorkerPoolRequest createEmptyInstance() => create();
  static $pb.PbList<CreateWorkerPoolRequest> createRepeated() => $pb.PbList<CreateWorkerPoolRequest>();
  @$core.pragma('dart2js:noInline')
  static CreateWorkerPoolRequest getDefault() => _defaultInstance ??= $pb.GeneratedMessage.$_defaultFor<CreateWorkerPoolRequest>(create);
  ...
  @$pb.TagNumber(2)
  set workerPool(WorkerPool v) { setField(2, v); }
  @$pb.TagNumber(2)
  ...
  @$pb.TagNumber(3)
  set workerPoolId($core.String v) { $_setString(2, v); }
  @$pb.TagNumber(3)
...
class GetWorkerPoolRequest extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'GetWorkerPoolRequest', package: const $pb.PackageName(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'google.devtools.cloudbuild.v1'), createEmptyInstance: create)
    ..aOS(1, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'name')
    ..hasRequiredFields = false
  ;
  ...
  factory GetWorkerPoolRequest.fromBuffer($core.List<$core.int> i, [$pb.ExtensionRegistry r = $pb.ExtensionRegistry.EMPTY]) => create()..mergeFromBuffer(i, r);
  factory GetWorkerPoolRequest.fromJson($core.String i, [$pb.ExtensionRegistry r = $pb.ExtensionRegistry.EMPTY]) => create()..mergeFromJson(i, r);
  @$core.Deprecated(
  'Using this can add significant overhead to your binary. '
  'Use [GeneratedMessageGenericExtensions.deepCopy] instead. '
  'Will be removed in next major version')
  GetWorkerPoolRequest clone() => GetWorkerPoolRequest()..mergeFromMessage(this);
  @$core.Deprecated(
  'Using this can add significant overhead to your binary. '
  'Use [GeneratedMessageGenericExtensions.rebuild] instead. '
  'Will be removed in next major version')
  GetWorkerPoolRequest copyWith(void Function(GetWorkerPoolRequest) updates) => super.copyWith((message) => updates(message as GetWorkerPoolRequest)) as GetWorkerPoolRequest; // ignore: deprecated_member_use
  $pb.BuilderInfo get info_ => _i;
  @$core.pragma('dart2js:noInline')
  static GetWorkerPoolRequest create() => GetWorkerPoolRequest._();
  GetWorkerPoolRequest createEmptyInstance() => create();
  static $pb.PbList<GetWorkerPoolRequest> createRepeated() => $pb.PbList<GetWorkerPoolRequest>();
  @$core.pragma('dart2js:noInline')
  static GetWorkerPoolRequest getDefault() => _defaultInstance ??= $pb.GeneratedMessage.$_defaultFor<GetWorkerPoolRequest>(create);
...
class DeleteWorkerPoolRequest extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'DeleteWorkerPoolRequest', package: const $pb.PackageName(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'google.devtools.cloudbuild.v1'), createEmptyInstance: create)
    ..aOS(1, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'name')
  ...
  factory DeleteWorkerPoolRequest.fromBuffer($core.List<$core.int> i, [$pb.ExtensionRegistry r = $pb.ExtensionRegistry.EMPTY]) => create()..mergeFromBuffer(i, r);
  factory DeleteWorkerPoolRequest.fromJson($core.String i, [$pb.ExtensionRegistry r = $pb.ExtensionRegistry.EMPTY]) => create()..mergeFromJson(i, r);
  @$core.Deprecated(
  'Using this can add significant overhead to your binary. '
  'Use [GeneratedMessageGenericExtensions.deepCopy] instead. '
  'Will be removed in next major version')
  DeleteWorkerPoolRequest clone() => DeleteWorkerPoolRequest()..mergeFromMessage(this);
  @$core.Deprecated(
  'Using this can add significant overhead to your binary. '
  'Use [GeneratedMessageGenericExtensions.rebuild] instead. '
  'Will be removed in next major version')
  DeleteWorkerPoolRequest copyWith(void Function(DeleteWorkerPoolRequest) updates) => super.copyWith((message) => updates(message as DeleteWorkerPoolRequest)) as DeleteWorkerPoolRequest; // ignore: deprecated_member_use
  $pb.BuilderInfo get info_ => _i;
  @$core.pragma('dart2js:noInline')
  static DeleteWorkerPoolRequest create() => DeleteWorkerPoolRequest._();
  DeleteWorkerPoolRequest createEmptyInstance() => create();
  static $pb.PbList<DeleteWorkerPoolRequest> createRepeated() => $pb.PbList<DeleteWorkerPoolRequest>();
  @$core.pragma('dart2js:noInline')
  static DeleteWorkerPoolRequest getDefault() => _defaultInstance ??= $pb.GeneratedMessage.$_defaultFor<DeleteWorkerPoolRequest>(create);
...
class UpdateWorkerPoolRequest extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'UpdateWorkerPoolRequest', package: const $pb.PackageName(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'google.devtools.cloudbuild.v1'), createEmptyInstance: create)
    ..aOM<WorkerPool>(1, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'workerPool', subBuilder: WorkerPool.create)
  ...
  factory UpdateWorkerPoolRequest.fromBuffer($core.List<$core.int> i, [$pb.ExtensionRegistry r = $pb.ExtensionRegistry.EMPTY]) => create()..mergeFromBuffer(i, r);
  factory UpdateWorkerPoolRequest.fromJson($core.String i, [$pb.ExtensionRegistry r = $pb.ExtensionRegistry.EMPTY]) => create()..mergeFromJson(i, r);
  @$core.Deprecated(
  'Using this can add significant overhead to your binary. '
  'Use [GeneratedMessageGenericExtensions.deepCopy] instead. '
  'Will be removed in next major version')
  UpdateWorkerPoolRequest clone() => UpdateWorkerPoolRequest()..mergeFromMessage(this);
  @$core.Deprecated(
  'Using this can add significant overhead to your binary. '
  'Use [GeneratedMessageGenericExtensions.rebuild] instead. '
  'Will be removed in next major version')
  UpdateWorkerPoolRequest copyWith(void Function(UpdateWorkerPoolRequest) updates) => super.copyWith((message) => updates(message as UpdateWorkerPoolRequest)) as UpdateWorkerPoolRequest; // ignore: deprecated_member_use
  $pb.BuilderInfo get info_ => _i;
  @$core.pragma('dart2js:noInline')
  static UpdateWorkerPoolRequest create() => UpdateWorkerPoolRequest._();
  UpdateWorkerPoolRequest createEmptyInstance() => create();
  static $pb.PbList<UpdateWorkerPoolRequest> createRepeated() => $pb.PbList<UpdateWorkerPoolRequest>();
  @$core.pragma('dart2js:noInline')
  static UpdateWorkerPoolRequest getDefault() => _defaultInstance ??= $pb.GeneratedMessage.$_defaultFor<UpdateWorkerPoolRequest>(create);
  static UpdateWorkerPoolRequest? _defaultInstance;

  @$pb.TagNumber(1)
  WorkerPool get workerPool => $_getN(0);
  @$pb.TagNumber(1)
  set workerPool(WorkerPool v) { setField(1, v); }
  @$pb.TagNumber(1)
...
class ListWorkerPoolsRequest extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'ListWorkerPoolsRequest', package: const $pb.PackageName(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'google.devtools.cloudbuild.v1'), createEmptyInstance: create)
    ..aOS(1, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'parent')
    ..a<$core.int>(2, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'pageSize', $pb.PbFieldType.O3)
    ..aOS(3, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'pageToken')
    ..hasRequiredFields = false
  ...
  factory ListWorkerPoolsRequest.fromBuffer($core.List<$core.int> i, [$pb.ExtensionRegistry r = $pb.ExtensionRegistry.EMPTY]) => create()..mergeFromBuffer(i, r);
  factory ListWorkerPoolsRequest.fromJson($core.String i, [$pb.ExtensionRegistry r = $pb.ExtensionRegistry.EMPTY]) => create()..mergeFromJson(i, r);
  @$core.Deprecated(
  'Using this can add significant overhead to your binary. '
  'Use [GeneratedMessageGenericExtensions.deepCopy] instead. '
  'Will be removed in next major version')
  ListWorkerPoolsRequest clone() => ListWorkerPoolsRequest()..mergeFromMessage(this);
  @$core.Deprecated(
  'Using this can add significant overhead to your binary. '
  'Use [GeneratedMessageGenericExtensions.rebuild] instead. '
  'Will be removed in next major version')
  ListWorkerPoolsRequest copyWith(void Function(ListWorkerPoolsRequest) updates) => super.copyWith((message) => updates(message as ListWorkerPoolsRequest)) as ListWorkerPoolsRequest; // ignore: deprecated_member_use
  $pb.BuilderInfo get info_ => _i;
  @$core.pragma('dart2js:noInline')
  static ListWorkerPoolsRequest create() => ListWorkerPoolsRequest._();
  ListWorkerPoolsRequest createEmptyInstance() => create();
  static $pb.PbList<ListWorkerPoolsRequest> createRepeated() => $pb.PbList<ListWorkerPoolsRequest>();
  @$core.pragma('dart2js:noInline')
  static ListWorkerPoolsRequest getDefault() => _defaultInstance ??= $pb.GeneratedMessage.$_defaultFor<ListWorkerPoolsRequest>(create);
...
class ListWorkerPoolsResponse extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'ListWorkerPoolsResponse', package: const $pb.PackageName(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'google.devtools.cloudbuild.v1'), createEmptyInstance: create)
    ..pc<WorkerPool>(1, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'workerPools', $pb.PbFieldType.PM, subBuilder: WorkerPool.create)
    ..aOS(2, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'nextPageToken')
    ..hasRequiredFields = false
  ;
  ...
  factory ListWorkerPoolsResponse.fromBuffer($core.List<$core.int> i, [$pb.ExtensionRegistry r = $pb.ExtensionRegistry.EMPTY]) => create()..mergeFromBuffer(i, r);
  factory ListWorkerPoolsResponse.fromJson($core.String i, [$pb.ExtensionRegistry r = $pb.ExtensionRegistry.EMPTY]) => create()..mergeFromJson(i, r);
  @$core.Deprecated(
  'Using this can add significant overhead to your binary. '
  'Use [GeneratedMessageGenericExtensions.deepCopy] instead. '
  'Will be removed in next major version')
  ListWorkerPoolsResponse clone() => ListWorkerPoolsResponse()..mergeFromMessage(this);
  @$core.Deprecated(
  'Using this can add significant overhead to your binary. '
  'Use [GeneratedMessageGenericExtensions.rebuild] instead. '
  'Will be removed in next major version')
  ListWorkerPoolsResponse copyWith(void Function(ListWorkerPoolsResponse) updates) => super.copyWith((message) => updates(message as ListWorkerPoolsResponse)) as ListWorkerPoolsResponse; // ignore: deprecated_member_use
  $pb.BuilderInfo get info_ => _i;
  @$core.pragma('dart2js:noInline')
  static ListWorkerPoolsResponse create() => ListWorkerPoolsResponse._();
  ListWorkerPoolsResponse createEmptyInstance() => create();
  static $pb.PbList<ListWorkerPoolsResponse> createRepeated() => $pb.PbList<ListWorkerPoolsResponse>();
  @$core.pragma('dart2js:noInline')
  static ListWorkerPoolsResponse getDefault() => _defaultInstance ??= $pb.GeneratedMessage.$_defaultFor<ListWorkerPoolsResponse>(create);
...
class CreateWorkerPoolOperationMetadata extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'CreateWorkerPoolOperationMetadata', package: const $pb.PackageName(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'google.devtools.cloudbuild.v1'), createEmptyInstance: create)
    ..aOS(1, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'workerPool')
    ..aOM<$4.Timestamp>(2, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'createTime', subBuilder: $4.Timestamp.create)
    ..aOM<$4.Timestamp>(3, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'completeTime', subBuilder: $4.Timestamp.create)
    ..hasRequiredFields = false
  ;
  ...
  factory CreateWorkerPoolOperationMetadata.fromBuffer($core.List<$core.int> i, [$pb.ExtensionRegistry r = $pb.ExtensionRegistry.EMPTY]) => create()..mergeFromBuffer(i, r);
  factory CreateWorkerPoolOperationMetadata.fromJson($core.String i, [$pb.ExtensionRegistry r = $pb.ExtensionRegistry.EMPTY]) => create()..mergeFromJson(i, r);
  @$core.Deprecated(
  'Using this can add significant overhead to your binary. '
  'Use [GeneratedMessageGenericExtensions.deepCopy] instead. '
  'Will be removed in next major version')
  CreateWorkerPoolOperationMetadata clone() => CreateWorkerPoolOperationMetadata()..mergeFromMessage(this);
  @$core.Deprecated(
  'Using this can add significant overhead to your binary. '
  'Use [GeneratedMessageGenericExtensions.rebuild] instead. '
  'Will be removed in next major version')
  CreateWorkerPoolOperationMetadata copyWith(void Function(CreateWorkerPoolOperationMetadata) updates) => super.copyWith((message) => updates(message as CreateWorkerPoolOperationMetadata)) as CreateWorkerPoolOperationMetadata; // ignore: deprecated_member_use
  $pb.BuilderInfo get info_ => _i;
  @$core.pragma('dart2js:noInline')
  static CreateWorkerPoolOperationMetadata create() => CreateWorkerPoolOperationMetadata._();
  CreateWorkerPoolOperationMetadata createEmptyInstance() => create();
  static $pb.PbList<CreateWorkerPoolOperationMetadata> createRepeated() => $pb.PbList<CreateWorkerPoolOperationMetadata>();
  @$core.pragma('dart2js:noInline')
  static CreateWorkerPoolOperationMetadata getDefault() => _defaultInstance ??= $pb.GeneratedMessage.$_defaultFor<CreateWorkerPoolOperationMetadata>(create);
  ...
  @$pb.TagNumber(3)
  set completeTime($4.Timestamp v) { setField(3, v); }
  @$pb.TagNumber(3)
...
class UpdateWorkerPoolOperationMetadata extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'UpdateWorkerPoolOperationMetadata', package: const $pb.PackageName(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'google.devtools.cloudbuild.v1'), createEmptyInstance: create)
    ..aOS(1, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'workerPool')
    ..aOM<$4.Timestamp>(2, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'createTime', subBuilder: $4.Timestamp.create)
    ..aOM<$4.Timestamp>(3, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'completeTime', subBuilder: $4.Timestamp.create)
    ..hasRequiredFields = false
  ...
  factory UpdateWorkerPoolOperationMetadata.fromBuffer($core.List<$core.int> i, [$pb.ExtensionRegistry r = $pb.ExtensionRegistry.EMPTY]) => create()..mergeFromBuffer(i, r);
  factory UpdateWorkerPoolOperationMetadata.fromJson($core.String i, [$pb.ExtensionRegistry r = $pb.ExtensionRegistry.EMPTY]) => create()..mergeFromJson(i, r);
  @$core.Deprecated(
  'Using this can add significant overhead to your binary. '
  'Use [GeneratedMessageGenericExtensions.deepCopy] instead. '
  'Will be removed in next major version')
  UpdateWorkerPoolOperationMetadata clone() => UpdateWorkerPoolOperationMetadata()..mergeFromMessage(this);
  @$core.Deprecated(
  'Using this can add significant overhead to your binary. '
  'Use [GeneratedMessageGenericExtensions.rebuild] instead. '
  'Will be removed in next major version')
  UpdateWorkerPoolOperationMetadata copyWith(void Function(UpdateWorkerPoolOperationMetadata) updates) => super.copyWith((message) => updates(message as UpdateWorkerPoolOperationMetadata)) as UpdateWorkerPoolOperationMetadata; // ignore: deprecated_member_use
  $pb.BuilderInfo get info_ => _i;
  @$core.pragma('dart2js:noInline')
  static UpdateWorkerPoolOperationMetadata create() => UpdateWorkerPoolOperationMetadata._();
  UpdateWorkerPoolOperationMetadata createEmptyInstance() => create();
  static $pb.PbList<UpdateWorkerPoolOperationMetadata> createRepeated() => $pb.PbList<UpdateWorkerPoolOperationMetadata>();
  @$core.pragma('dart2js:noInline')
  static UpdateWorkerPoolOperationMetadata getDefault() => _defaultInstance ??= $pb.GeneratedMessage.$_defaultFor<UpdateWorkerPoolOperationMetadata>(create);
...
class DeleteWorkerPoolOperationMetadata extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'DeleteWorkerPoolOperationMetadata', package: const $pb.PackageName(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'google.devtools.cloudbuild.v1'), createEmptyInstance: create)
    ..aOS(1, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'workerPool')
    ..aOM<$4.Timestamp>(2, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'createTime', subBuilder: $4.Timestamp.create)
    ..aOM<$4.Timestamp>(3, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'completeTime', subBuilder: $4.Timestamp.create)
    ..hasRequiredFields = false
  ...
  factory DeleteWorkerPoolOperationMetadata.fromBuffer($core.List<$core.int> i, [$pb.ExtensionRegistry r = $pb.ExtensionRegistry.EMPTY]) => create()..mergeFromBuffer(i, r);
  factory DeleteWorkerPoolOperationMetadata.fromJson($core.String i, [$pb.ExtensionRegistry r = $pb.ExtensionRegistry.EMPTY]) => create()..mergeFromJson(i, r);
  @$core.Deprecated(
  'Using this can add significant overhead to your binary. '
  'Use [GeneratedMessageGenericExtensions.deepCopy] instead. '
  'Will be removed in next major version')
  DeleteWorkerPoolOperationMetadata clone() => DeleteWorkerPoolOperationMetadata()..mergeFromMessage(this);
  @$core.Deprecated(
  'Using this can add significant overhead to your binary. '
  'Use [GeneratedMessageGenericExtensions.rebuild] instead. '
  'Will be removed in next major version')
  DeleteWorkerPoolOperationMetadata copyWith(void Function(DeleteWorkerPoolOperationMetadata) updates) => super.copyWith((message) => updates(message as DeleteWorkerPoolOperationMetadata)) as DeleteWorkerPoolOperationMetadata; // ignore: deprecated_member_use
  $pb.BuilderInfo get info_ => _i;
  @$core.pragma('dart2js:noInline')
  static DeleteWorkerPoolOperationMetadata create() => DeleteWorkerPoolOperationMetadata._();
  DeleteWorkerPoolOperationMetadata createEmptyInstance() => create();
  static $pb.PbList<DeleteWorkerPoolOperationMetadata> createRepeated() => $pb.PbList<DeleteWorkerPoolOperationMetadata>();
  @$core.pragma('dart2js:noInline')
  static DeleteWorkerPoolOperationMetadata getDefault() => _defaultInstance ??= $pb.GeneratedMessage.$_defaultFor<DeleteWorkerPoolOperationMetadata>(create);

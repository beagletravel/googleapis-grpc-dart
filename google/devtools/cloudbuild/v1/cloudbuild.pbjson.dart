...
final $typed_data.Uint8List retryBuildRequestDescriptor = $convert.base64Decode('ChFSZXRyeUJ1aWxkUmVxdWVzdBI4CgRuYW1lGAMgASgJQiT6QSEKH2Nsb3VkYnVpbGQuZ29vZ2xlYXBpcy5jb20vQnVpbGRSBG5hbWUSIgoKcHJvamVjdF9pZBgBIAEoCUID4EECUglwcm9qZWN0SWQSEwoCaWQYAiABKAlCA+BBAlICaWQ=');
...
const RunBuildTriggerRequest$json = const {
  ...
  '2': const [
    ...
    const {'1': 'project_id', '3': 1, '4': 1, '5': 9, '8': const {}, '10': 'projectId'},
    const {'1': 'trigger_id', '3': 2, '4': 1, '5': 9, '8': const {}, '10': 'triggerId'},
...
final $typed_data.Uint8List runBuildTriggerRequestDescriptor = $convert.base64Decode('');
...
const RepoSource$json = const {
  ...
  '2': const [
    ...
    const {'1': 'substitutions', '3': 9, '4': 3, '5': 11, '6': '.google.devtools.cloudbuild.v1.RepoSource.SubstitutionsEntry', '10': 'substitutions'},
  ],
...
final $typed_data.Uint8List repoSourceDescriptor = $convert.base64Decode('');
...
final $typed_data.Uint8List storageSourceManifestDescriptor = $convert.base64Decode('ChVTdG9yYWdlU291cmNlTWFuaWZlc3QSFgoGYnVja2V0GAEgASgJUgZidWNrZXQSFgoGb2JqZWN0GAIgASgJUgZvYmplY3QSHgoKZ2VuZXJhdGlvbhgDIAEoA1IKZ2VuZXJhdGlvbg==');
...
const Source$json = const {
  ...
  '2': const [
    ...
    const {'1': 'storage_source_manifest', '3': 8, '4': 1, '5': 11, '6': '.google.devtools.cloudbuild.v1.StorageSourceManifest', '9': 0, '10': 'storageSourceManifest'},
  ],
  '8': const [
    const {'1': 'source'},
  ],
...
final $typed_data.Uint8List sourceDescriptor = $convert.base64Decode('');
...
const BuiltImage$json = const {
  ...
  '2': const [
    ...
    const {'1': 'push_timing', '3': 4, '4': 1, '5': 11, '6': '.google.devtools.cloudbuild.v1.TimeSpan', '8': const {}, '10': 'pushTiming'},
  ],
};

/// Descriptor for `BuiltImage`. Decode as a `google.protobuf.DescriptorProto`.
final $typed_data.Uint8List builtImageDescriptor = $convert.base64Decode('CgpCdWlsdEltYWdlEhIKBG5hbWUYASABKAlSBG5hbWUSFgoGZGlnZXN0GAMgASgJUgZkaWdlc3QSTQoLcHVzaF90aW1pbmcYBCABKAsyJy5nb29nbGUuZGV2dG9vbHMuY2xvdWRidWlsZC52MS5UaW1lU3BhbkID4EEDUgpwdXNoVGltaW5n');
...
const Results$json = const {
  ...
  '2': const [
    ...
    const {'1': 'artifact_timing', '3': 7, '4': 1, '5': 11, '6': '.google.devtools.cloudbuild.v1.TimeSpan', '10': 'artifactTiming'},
  ],
};

/// Descriptor for `Results`. Decode as a `google.protobuf.DescriptorProto`.
final $typed_data.Uint8List resultsDescriptor = $convert.base64Decode('');
...
final $typed_data.Uint8List artifactResultDescriptor = $convert.base64Decode('Cg5BcnRpZmFjdFJlc3VsdBIaCghsb2NhdGlvbhgBIAEoCVIIbG9jYXRpb24SRgoJZmlsZV9oYXNoGAIgAygLMikuZ29vZ2xlLmRldnRvb2xzLmNsb3VkYnVpbGQudjEuRmlsZUhhc2hlc1IIZmlsZUhhc2g=');
...
const Build$json = const {
  ...
  '2': const [
    ...
    const {'1': 'project_id', '3': 16, '4': 1, '5': 9, '8': const {}, '10': 'projectId'},
    const {'1': 'status', '3': 2, '4': 1, '5': 14, '6': '.google.devtools.cloudbuild.v1.Build.Status', '8': const {}, '10': 'status'},
    const {'1': 'status_detail', '3': 24, '4': 1, '5': 9, '8': const {}, '10': 'statusDetail'},
    ...
    const {'1': 'results', '3': 10, '4': 1, '5': 11, '6': '.google.devtools.cloudbuild.v1.Results', '8': const {}, '10': 'results'},
    ...
    const {'1': 'finish_time', '3': 8, '4': 1, '5': 11, '6': '.google.protobuf.Timestamp', '8': const {}, '10': 'finishTime'},
    ...
    const {'1': 'source_provenance', '3': 21, '4': 1, '5': 11, '6': '.google.devtools.cloudbuild.v1.SourceProvenance', '8': const {}, '10': 'sourceProvenance'},
    const {'1': 'build_trigger_id', '3': 22, '4': 1, '5': 9, '8': const {}, '10': 'buildTriggerId'},
    const {'1': 'options', '3': 23, '4': 1, '5': 11, '6': '.google.devtools.cloudbuild.v1.BuildOptions', '10': 'options'},
    const {'1': 'log_url', '3': 25, '4': 1, '5': 9, '8': const {}, '10': 'logUrl'},
    ...
    const {'1': 'timing', '3': 33, '4': 3, '5': 11, '6': '.google.devtools.cloudbuild.v1.Build.TimingEntry', '8': const {}, '10': 'timing'},
    const {'1': 'approval', '3': 44, '4': 1, '5': 11, '6': '.google.devtools.cloudbuild.v1.BuildApproval', '8': const {}, '10': 'approval'},
    const {'1': 'service_account', '3': 42, '4': 1, '5': 9, '8': const {}, '10': 'serviceAccount'},
    const {'1': 'available_secrets', '3': 47, '4': 1, '5': 11, '6': '.google.devtools.cloudbuild.v1.Secrets', '10': 'availableSecrets'},
    const {'1': 'warnings', '3': 49, '4': 3, '5': 11, '6': '.google.devtools.cloudbuild.v1.Build.Warning', '8': const {}, '10': 'warnings'},
    const {'1': 'failure_info', '3': 51, '4': 1, '5': 11, '6': '.google.devtools.cloudbuild.v1.Build.FailureInfo', '8': const {}, '10': 'failureInfo'},
  ],
  '3': const [Build_Warning$json, Build_FailureInfo$json, Build_SubstitutionsEntry$json, Build_TimingEntry$json],
...
const Build_Warning$json = const {
  ...
  '2': const [
    ...
    const {'1': 'priority', '3': 2, '4': 1, '5': 14, '6': '.google.devtools.cloudbuild.v1.Build.Warning.Priority', '10': 'priority'},
  ],
...
const Build_FailureInfo$json = const {
  '1': 'FailureInfo',
  '2': const [
    const {'1': 'type', '3': 1, '4': 1, '5': 14, '6': '.google.devtools.cloudbuild.v1.Build.FailureInfo.FailureType', '10': 'type'},
...
const Artifacts_ArtifactObjects$json = const {
  ...
  '2': const [
    ...
    const {'1': 'timing', '3': 3, '4': 1, '5': 11, '6': '.google.devtools.cloudbuild.v1.TimeSpan', '8': const {}, '10': 'timing'},
  ],
};

/// Descriptor for `Artifacts`. Decode as a `google.protobuf.DescriptorProto`.
final $typed_data.Uint8List artifactsDescriptor = $convert.base64Decode('');
...
final $typed_data.Uint8List buildOperationMetadataDescriptor = $convert.base64Decode('ChZCdWlsZE9wZXJhdGlvbk1ldGFkYXRhEjoKBWJ1aWxkGAEgASgLMiQuZ29vZ2xlLmRldnRvb2xzLmNsb3VkYnVpbGQudjEuQnVpbGRSBWJ1aWxk');
...
const SourceProvenance$json = const {
  ...
  '2': const [
    ...
    const {'1': 'resolved_storage_source_manifest', '3': 9, '4': 1, '5': 11, '6': '.google.devtools.cloudbuild.v1.StorageSourceManifest', '10': 'resolvedStorageSourceManifest'},
    const {'1': 'file_hashes', '3': 4, '4': 3, '5': 11, '6': '.google.devtools.cloudbuild.v1.SourceProvenance.FileHashesEntry', '8': const {}, '10': 'fileHashes'},
  ],
...
final $typed_data.Uint8List sourceProvenanceDescriptor = $convert.base64Decode('');
...
final $typed_data.Uint8List fileHashesDescriptor = $convert.base64Decode('CgpGaWxlSGFzaGVzEkAKCWZpbGVfaGFzaBgBIAMoCzIjLmdvb2dsZS5kZXZ0b29scy5jbG91ZGJ1aWxkLnYxLkhhc2hSCGZpbGVIYXNo');
...
final $typed_data.Uint8List hashDescriptor = $convert.base64Decode('CgRIYXNoEkAKBHR5cGUYASABKA4yLC5nb29nbGUuZGV2dG9vbHMuY2xvdWRidWlsZC52MS5IYXNoLkhhc2hUeXBlUgR0eXBlEhQKBXZhbHVlGAIgASgMUgV2YWx1ZSIpCghIYXNoVHlwZRIICgROT05FEAASCgoGU0hBMjU2EAESBwoDTUQ1EAI=');
@$core.Deprecated('Use secretsDescriptor instead')
const Secrets$json = const {
  '1': 'Secrets',
  '2': const [
    const {'1': 'secret_manager', '3': 1, '4': 3, '5': 11, '6': '.google.devtools.cloudbuild.v1.SecretManagerSecret', '10': 'secretManager'},
    const {'1': 'inline', '3': 2, '4': 3, '5': 11, '6': '.google.devtools.cloudbuild.v1.InlineSecret', '10': 'inline'},
  ],
};

/// Descriptor for `Secrets`. Decode as a `google.protobuf.DescriptorProto`.
final $typed_data.Uint8List secretsDescriptor = $convert.base64Decode('CgdTZWNyZXRzElkKDnNlY3JldF9tYW5hZ2VyGAEgAygLMjIuZ29vZ2xlLmRldnRvb2xzLmNsb3VkYnVpbGQudjEuU2VjcmV0TWFuYWdlclNlY3JldFINc2VjcmV0TWFuYWdlchJDCgZpbmxpbmUYAiADKAsyKy5nb29nbGUuZGV2dG9vbHMuY2xvdWRidWlsZC52MS5JbmxpbmVTZWNyZXRSBmlubGluZQ==');
@$core.Deprecated('Use inlineSecretDescriptor instead')
const InlineSecret$json = const {
  '1': 'InlineSecret',
  '2': const [
    const {'1': 'kms_key_name', '3': 1, '4': 1, '5': 9, '8': const {}, '10': 'kmsKeyName'},
    const {'1': 'env_map', '3': 2, '4': 3, '5': 11, '6': '.google.devtools.cloudbuild.v1.InlineSecret.EnvMapEntry', '10': 'envMap'},
  ],
...
final $typed_data.Uint8List inlineSecretDescriptor = $convert.base64Decode('');
@$core.Deprecated('Use secretManagerSecretDescriptor instead')
const SecretManagerSecret$json = const {
  '1': 'SecretManagerSecret',
  '2': const [
    const {'1': 'version_name', '3': 1, '4': 1, '5': 9, '8': const {}, '10': 'versionName'},
    const {'1': 'env', '3': 2, '4': 1, '5': 9, '10': 'env'},
  ],
};

/// Descriptor for `SecretManagerSecret`. Decode as a `google.protobuf.DescriptorProto`.
final $typed_data.Uint8List secretManagerSecretDescriptor = $convert.base64Decode('ChNTZWNyZXRNYW5hZ2VyU2VjcmV0ElIKDHZlcnNpb25fbmFtZRgBIAEoCUIv+kEsCipzZWNyZXRtYW5hZ2VyLmdvb2dsZWFwaXMuY29tL1NlY3JldFZlcnNpb25SC3ZlcnNpb25OYW1lEhAKA2VudhgCIAEoCVIDZW52');
...
final $typed_data.Uint8List secretDescriptor = $convert.base64Decode('CgZTZWNyZXQSIAoMa21zX2tleV9uYW1lGAEgASgJUgprbXNLZXlOYW1lElMKCnNlY3JldF9lbnYYAyADKAsyNC5nb29nbGUuZGV2dG9vbHMuY2xvdWRidWlsZC52MS5TZWNyZXQuU2VjcmV0RW52RW50cnlSCXNlY3JldEVudho8Cg5TZWNyZXRFbnZFbnRyeRIQCgNrZXkYASABKAlSA2tleRIUCgV2YWx1ZRgCIAEoDFIFdmFsdWU6AjgB');
...
const CreateBuildRequest$json = const {
  ...
  '2': const [
    ...
    const {'1': 'project_id', '3': 1, '4': 1, '5': 9, '8': const {}, '10': 'projectId'},
    const {'1': 'build', '3': 2, '4': 1, '5': 11, '6': '.google.devtools.cloudbuild.v1.Build', '8': const {}, '10': 'build'},
  ],
};

/// Descriptor for `CreateBuildRequest`. Decode as a `google.protobuf.DescriptorProto`.
final $typed_data.Uint8List createBuildRequestDescriptor = $convert.base64Decode('ChJDcmVhdGVCdWlsZFJlcXVlc3QSPAoGcGFyZW50GAQgASgJQiT6QSESH2Nsb3VkYnVpbGQuZ29vZ2xlYXBpcy5jb20vQnVpbGRSBnBhcmVudBIiCgpwcm9qZWN0X2lkGAEgASgJQgPgQQJSCXByb2plY3RJZBI/CgVidWlsZBgCIAEoCzIkLmdvb2dsZS5kZXZ0b29scy5jbG91ZGJ1aWxkLnYxLkJ1aWxkQgPgQQJSBWJ1aWxk');
...
final $typed_data.Uint8List getBuildRequestDescriptor = $convert.base64Decode('Cg9HZXRCdWlsZFJlcXVlc3QSOAoEbmFtZRgEIAEoCUIk+kEhCh9jbG91ZGJ1aWxkLmdvb2dsZWFwaXMuY29tL0J1aWxkUgRuYW1lEiIKCnByb2plY3RfaWQYASABKAlCA+BBAlIJcHJvamVjdElkEhMKAmlkGAIgASgJQgPgQQJSAmlk');
@$core.Deprecated('Use listBuildsRequestDescriptor instead')
const ListBuildsRequest$json = const {
  '1': 'ListBuildsRequest',
  '2': const [
    const {'1': 'parent', '3': 9, '4': 1, '5': 9, '8': const {}, '10': 'parent'},
    const {'1': 'project_id', '3': 1, '4': 1, '5': 9, '8': const {}, '10': 'projectId'},
...
final $typed_data.Uint8List listBuildsRequestDescriptor = $convert.base64Decode('');
...
final $typed_data.Uint8List listBuildsResponseDescriptor = $convert.base64Decode('ChJMaXN0QnVpbGRzUmVzcG9uc2USPAoGYnVpbGRzGAEgAygLMiQuZ29vZ2xlLmRldnRvb2xzLmNsb3VkYnVpbGQudjEuQnVpbGRSBmJ1aWxkcxImCg9uZXh0X3BhZ2VfdG9rZW4YAiABKAlSDW5leHRQYWdlVG9rZW4=');
...
final $typed_data.Uint8List cancelBuildRequestDescriptor = $convert.base64Decode('ChJDYW5jZWxCdWlsZFJlcXVlc3QSOAoEbmFtZRgEIAEoCUIk+kEhCh9jbG91ZGJ1aWxkLmdvb2dsZWFwaXMuY29tL0J1aWxkUgRuYW1lEiIKCnByb2plY3RfaWQYASABKAlCA+BBAlIJcHJvamVjdElkEhMKAmlkGAIgASgJQgPgQQJSAmlk');
...
const ApproveBuildRequest$json = const {
  ...
  '2': const [
    ...
    const {'1': 'approval_result', '3': 2, '4': 1, '5': 11, '6': '.google.devtools.cloudbuild.v1.ApprovalResult', '10': 'approvalResult'},
  ],
};

/// Descriptor for `ApproveBuildRequest`. Decode as a `google.protobuf.DescriptorProto`.
final $typed_data.Uint8List approveBuildRequestDescriptor = $convert.base64Decode('ChNBcHByb3ZlQnVpbGRSZXF1ZXN0EhcKBG5hbWUYASABKAlCA+BBAlIEbmFtZRJWCg9hcHByb3ZhbF9yZXN1bHQYAiABKAsyLS5nb29nbGUuZGV2dG9vbHMuY2xvdWRidWlsZC52MS5BcHByb3ZhbFJlc3VsdFIOYXBwcm92YWxSZXN1bHQ=');
@$core.Deprecated('Use buildApprovalDescriptor instead')
const BuildApproval$json = const {
  '1': 'BuildApproval',
  '2': const [
    const {'1': 'state', '3': 1, '4': 1, '5': 14, '6': '.google.devtools.cloudbuild.v1.BuildApproval.State', '8': const {}, '10': 'state'},
    const {'1': 'config', '3': 2, '4': 1, '5': 11, '6': '.google.devtools.cloudbuild.v1.ApprovalConfig', '8': const {}, '10': 'config'},
    const {'1': 'result', '3': 3, '4': 1, '5': 11, '6': '.google.devtools.cloudbuild.v1.ApprovalResult', '8': const {}, '10': 'result'},
  ],
...
final $typed_data.Uint8List buildApprovalDescriptor = $convert.base64Decode('');
@$core.Deprecated('Use approvalConfigDescriptor instead')
const ApprovalConfig$json = const {
  '1': 'ApprovalConfig',
  '2': const [
    const {'1': 'approval_required', '3': 1, '4': 1, '5': 8, '10': 'approvalRequired'},
  ],
};

/// Descriptor for `ApprovalConfig`. Decode as a `google.protobuf.DescriptorProto`.
final $typed_data.Uint8List approvalConfigDescriptor = $convert.base64Decode('Cg5BcHByb3ZhbENvbmZpZxIrChFhcHByb3ZhbF9yZXF1aXJlZBgBIAEoCFIQYXBwcm92YWxSZXF1aXJlZA==');
@$core.Deprecated('Use approvalResultDescriptor instead')
const ApprovalResult$json = const {
  '1': 'ApprovalResult',
  '2': const [
    const {'1': 'approver_account', '3': 2, '4': 1, '5': 9, '8': const {}, '10': 'approverAccount'},
    const {'1': 'approval_time', '3': 3, '4': 1, '5': 11, '6': '.google.protobuf.Timestamp', '8': const {}, '10': 'approvalTime'},
    const {'1': 'decision', '3': 4, '4': 1, '5': 14, '6': '.google.devtools.cloudbuild.v1.ApprovalResult.Decision', '8': const {}, '10': 'decision'},
    const {'1': 'comment', '3': 5, '4': 1, '5': 9, '8': const {}, '10': 'comment'},
...
final $typed_data.Uint8List approvalResultDescriptor = $convert.base64Decode('');
...
const BuildTrigger$json = const {
  ...
  '2': const [
    ...
    const {'1': 'github', '3': 13, '4': 1, '5': 11, '6': '.google.devtools.cloudbuild.v1.GitHubEventsConfig', '10': 'github'},
    const {'1': 'pubsub_config', '3': 29, '4': 1, '5': 11, '6': '.google.devtools.cloudbuild.v1.PubsubConfig', '10': 'pubsubConfig'},
    const {'1': 'webhook_config', '3': 31, '4': 1, '5': 11, '6': '.google.devtools.cloudbuild.v1.WebhookConfig', '10': 'webhookConfig'},
    const {'1': 'autodetect', '3': 18, '4': 1, '5': 8, '9': 0, '10': 'autodetect'},
    ...
    const {'1': 'filter', '3': 30, '4': 1, '5': 9, '8': const {}, '10': 'filter'},
    const {'1': 'service_account', '3': 33, '4': 1, '5': 9, '8': const {}, '10': 'serviceAccount'},
  ],
...
final $typed_data.Uint8List buildTriggerDescriptor = $convert.base64Decode('');
...
const GitHubEventsConfig$json = const {
  ...
  '2': const [
    ...
    const {'1': 'pull_request', '3': 4, '4': 1, '5': 11, '6': '.google.devtools.cloudbuild.v1.PullRequestFilter', '9': 0, '10': 'pullRequest'},
    const {'1': 'push', '3': 5, '4': 1, '5': 11, '6': '.google.devtools.cloudbuild.v1.PushFilter', '9': 0, '10': 'push'},
  ],
  '8': const [
    const {'1': 'event'},
  ],
...
final $typed_data.Uint8List gitHubEventsConfigDescriptor = $convert.base64Decode('');
@$core.Deprecated('Use pubsubConfigDescriptor instead')
const PubsubConfig$json = const {
  '1': 'PubsubConfig',
  '2': const [
    const {'1': 'subscription', '3': 1, '4': 1, '5': 9, '8': const {}, '10': 'subscription'},
    const {'1': 'topic', '3': 2, '4': 1, '5': 9, '8': const {}, '10': 'topic'},
    const {'1': 'service_account_email', '3': 3, '4': 1, '5': 9, '8': const {}, '10': 'serviceAccountEmail'},
    const {'1': 'state', '3': 4, '4': 1, '5': 14, '6': '.google.devtools.cloudbuild.v1.PubsubConfig.State', '10': 'state'},
  ],
...
final $typed_data.Uint8List webhookConfigDescriptor = $convert.base64Decode('');
...
const PullRequestFilter$json = const {
  ...
  '2': const [
    ...
    const {'1': 'comment_control', '3': 5, '4': 1, '5': 14, '6': '.google.devtools.cloudbuild.v1.PullRequestFilter.CommentControl', '10': 'commentControl'},
...
final $typed_data.Uint8List pullRequestFilterDescriptor = $convert.base64Decode('');
...
final $typed_data.Uint8List pushFilterDescriptor = $convert.base64Decode('CgpQdXNoRmlsdGVyEhgKBmJyYW5jaBgCIAEoCUgAUgZicmFuY2gSEgoDdGFnGAMgASgJSABSA3RhZxIhCgxpbnZlcnRfcmVnZXgYBCABKAhSC2ludmVydFJlZ2V4QgkKB2dpdF9yZWY=');
...
const CreateBuildTriggerRequest$json = const {
  ...
  '2': const [
    ...
    const {'1': 'project_id', '3': 1, '4': 1, '5': 9, '8': const {}, '10': 'projectId'},
    const {'1': 'trigger', '3': 2, '4': 1, '5': 11, '6': '.google.devtools.cloudbuild.v1.BuildTrigger', '8': const {}, '10': 'trigger'},
  ],
};

/// Descriptor for `CreateBuildTriggerRequest`. Decode as a `google.protobuf.DescriptorProto`.
final $typed_data.Uint8List createBuildTriggerRequestDescriptor = $convert.base64Decode('');
...
final $typed_data.Uint8List getBuildTriggerRequestDescriptor = $convert.base64Decode('ChZHZXRCdWlsZFRyaWdnZXJSZXF1ZXN0Ej8KBG5hbWUYAyABKAlCK/pBKAomY2xvdWRidWlsZC5nb29nbGVhcGlzLmNvbS9CdWlsZFRyaWdnZXJSBG5hbWUSIgoKcHJvamVjdF9pZBgBIAEoCUID4EECUglwcm9qZWN0SWQSIgoKdHJpZ2dlcl9pZBgCIAEoCUID4EECUgl0cmlnZ2VySWQ=');
...
final $typed_data.Uint8List listBuildTriggersRequestDescriptor = $convert.base64Decode('ChhMaXN0QnVpbGRUcmlnZ2Vyc1JlcXVlc3QSQwoGcGFyZW50GAQgASgJQiv6QSgSJmNsb3VkYnVpbGQuZ29vZ2xlYXBpcy5jb20vQnVpbGRUcmlnZ2VyUgZwYXJlbnQSIgoKcHJvamVjdF9pZBgBIAEoCUID4EECUglwcm9qZWN0SWQSGwoJcGFnZV9zaXplGAIgASgFUghwYWdlU2l6ZRIdCgpwYWdlX3Rva2VuGAMgASgJUglwYWdlVG9rZW4=');
...
final $typed_data.Uint8List listBuildTriggersResponseDescriptor = $convert.base64Decode('ChlMaXN0QnVpbGRUcmlnZ2Vyc1Jlc3BvbnNlEkcKCHRyaWdnZXJzGAEgAygLMisuZ29vZ2xlLmRldnRvb2xzLmNsb3VkYnVpbGQudjEuQnVpbGRUcmlnZ2VyUgh0cmlnZ2VycxImCg9uZXh0X3BhZ2VfdG9rZW4YAiABKAlSDW5leHRQYWdlVG9rZW4=');
...
final $typed_data.Uint8List deleteBuildTriggerRequestDescriptor = $convert.base64Decode('ChlEZWxldGVCdWlsZFRyaWdnZXJSZXF1ZXN0Ej8KBG5hbWUYAyABKAlCK/pBKAomY2xvdWRidWlsZC5nb29nbGVhcGlzLmNvbS9CdWlsZFRyaWdnZXJSBG5hbWUSIgoKcHJvamVjdF9pZBgBIAEoCUID4EECUglwcm9qZWN0SWQSIgoKdHJpZ2dlcl9pZBgCIAEoCUID4EECUgl0cmlnZ2VySWQ=');
...
const UpdateBuildTriggerRequest$json = const {
  ...
  '2': const [
    const {'1': 'project_id', '3': 1, '4': 1, '5': 9, '8': const {}, '10': 'projectId'},
    const {'1': 'trigger_id', '3': 2, '4': 1, '5': 9, '8': const {}, '10': 'triggerId'},
    const {'1': 'trigger', '3': 3, '4': 1, '5': 11, '6': '.google.devtools.cloudbuild.v1.BuildTrigger', '8': const {}, '10': 'trigger'},
  ],
};

/// Descriptor for `UpdateBuildTriggerRequest`. Decode as a `google.protobuf.DescriptorProto`.
final $typed_data.Uint8List updateBuildTriggerRequestDescriptor = $convert.base64Decode('ChlVcGRhdGVCdWlsZFRyaWdnZXJSZXF1ZXN0EiIKCnByb2plY3RfaWQYASABKAlCA+BBAlIJcHJvamVjdElkEiIKCnRyaWdnZXJfaWQYAiABKAlCA+BBAlIJdHJpZ2dlcklkEkoKB3RyaWdnZXIYAyABKAsyKy5nb29nbGUuZGV2dG9vbHMuY2xvdWRidWlsZC52MS5CdWlsZFRyaWdnZXJCA+BBAlIHdHJpZ2dlcg==');
...
const BuildOptions$json = const {
  ...
  '2': const [
    ...
    const {'1': 'dynamic_substitutions', '3': 17, '4': 1, '5': 8, '10': 'dynamicSubstitutions'},
    ...
    const {'1': 'pool', '3': 19, '4': 1, '5': 11, '6': '.google.devtools.cloudbuild.v1.BuildOptions.PoolOption', '8': const {}, '10': 'pool'},
...
const ReceiveTriggerWebhookRequest$json = const {
  ...
  '2': const [
    ...
    const {'1': 'body', '3': 1, '4': 1, '5': 11, '6': '.google.api.HttpBody', '10': 'body'},
...
final $typed_data.Uint8List receiveTriggerWebhookRequestDescriptor = $convert.base64Decode('ChxSZWNlaXZlVHJpZ2dlcldlYmhvb2tSZXF1ZXN0EhIKBG5hbWUYBSABKAlSBG5hbWUSKAoEYm9keRgBIAEoCzIULmdvb2dsZS5hcGkuSHR0cEJvZHlSBGJvZHkSHQoKcHJvamVjdF9pZBgCIAEoCVIJcHJvamVjdElkEhgKB3RyaWdnZXIYAyABKAlSB3RyaWdnZXISFgoGc2VjcmV0GAQgASgJUgZzZWNyZXQ=');
...
final $typed_data.Uint8List receiveTriggerWebhookResponseDescriptor = $convert.base64Decode('Ch1SZWNlaXZlVHJpZ2dlcldlYmhvb2tSZXNwb25zZQ==');
...
const WorkerPool$json = const {
  ...
  '2': const [
    ...
    const {'1': 'annotations', '3': 4, '4': 3, '5': 11, '6': '.google.devtools.cloudbuild.v1.WorkerPool.AnnotationsEntry', '10': 'annotations'},
    const {'1': 'create_time', '3': 5, '4': 1, '5': 11, '6': '.google.protobuf.Timestamp', '8': const {}, '10': 'createTime'},
    const {'1': 'update_time', '3': 6, '4': 1, '5': 11, '6': '.google.protobuf.Timestamp', '8': const {}, '10': 'updateTime'},
    const {'1': 'delete_time', '3': 7, '4': 1, '5': 11, '6': '.google.protobuf.Timestamp', '8': const {}, '10': 'deleteTime'},
    const {'1': 'state', '3': 8, '4': 1, '5': 14, '6': '.google.devtools.cloudbuild.v1.WorkerPool.State', '8': const {}, '10': 'state'},
    const {'1': 'private_pool_v1_config', '3': 12, '4': 1, '5': 11, '6': '.google.devtools.cloudbuild.v1.PrivatePoolV1Config', '9': 0, '10': 'privatePoolV1Config'},
...
final $typed_data.Uint8List workerPoolDescriptor = $convert.base64Decode('');
@$core.Deprecated('Use privatePoolV1ConfigDescriptor instead')
const PrivatePoolV1Config$json = const {
  '1': 'PrivatePoolV1Config',
  '2': const [
    const {'1': 'worker_config', '3': 1, '4': 1, '5': 11, '6': '.google.devtools.cloudbuild.v1.PrivatePoolV1Config.WorkerConfig', '10': 'workerConfig'},
    const {'1': 'network_config', '3': 2, '4': 1, '5': 11, '6': '.google.devtools.cloudbuild.v1.PrivatePoolV1Config.NetworkConfig', '10': 'networkConfig'},
  ],
  '3': const [PrivatePoolV1Config_WorkerConfig$json, PrivatePoolV1Config_NetworkConfig$json],
};
...
const PrivatePoolV1Config_NetworkConfig$json = const {
  '1': 'NetworkConfig',
  '2': const [
    const {'1': 'peered_network', '3': 1, '4': 1, '5': 9, '8': const {}, '10': 'peeredNetwork'},
    const {'1': 'egress_option', '3': 2, '4': 1, '5': 14, '6': '.google.devtools.cloudbuild.v1.PrivatePoolV1Config.NetworkConfig.EgressOption', '10': 'egressOption'},
  ],
...
final $typed_data.Uint8List privatePoolV1ConfigDescriptor = $convert.base64Decode('');
...
const CreateWorkerPoolRequest$json = const {
  ...
  '2': const [
    ...
    const {'1': 'worker_pool', '3': 2, '4': 1, '5': 11, '6': '.google.devtools.cloudbuild.v1.WorkerPool', '8': const {}, '10': 'workerPool'},
    const {'1': 'worker_pool_id', '3': 3, '4': 1, '5': 9, '8': const {}, '10': 'workerPoolId'},
    const {'1': 'validate_only', '3': 4, '4': 1, '5': 8, '10': 'validateOnly'},
  ],
};

/// Descriptor for `CreateWorkerPoolRequest`. Decode as a `google.protobuf.DescriptorProto`.
final $typed_data.Uint8List createWorkerPoolRequestDescriptor = $convert.base64Decode('');
...
final $typed_data.Uint8List getWorkerPoolRequestDescriptor = $convert.base64Decode('ChRHZXRXb3JrZXJQb29sUmVxdWVzdBJACgRuYW1lGAEgASgJQizgQQL6QSYKJGNsb3VkYnVpbGQuZ29vZ2xlYXBpcy5jb20vV29ya2VyUG9vbFIEbmFtZQ==');
...
final $typed_data.Uint8List deleteWorkerPoolRequestDescriptor = $convert.base64Decode('ChdEZWxldGVXb3JrZXJQb29sUmVxdWVzdBJACgRuYW1lGAEgASgJQizgQQL6QSYKJGNsb3VkYnVpbGQuZ29vZ2xlYXBpcy5jb20vV29ya2VyUG9vbFIEbmFtZRISCgRldGFnGAIgASgJUgRldGFnEiMKDWFsbG93X21pc3NpbmcYAyABKAhSDGFsbG93TWlzc2luZxIjCg12YWxpZGF0ZV9vbmx5GAQgASgIUgx2YWxpZGF0ZU9ubHk=');
...
const UpdateWorkerPoolRequest$json = const {
  ...
  '2': const [
    const {'1': 'worker_pool', '3': 1, '4': 1, '5': 11, '6': '.google.devtools.cloudbuild.v1.WorkerPool', '8': const {}, '10': 'workerPool'},
...
final $typed_data.Uint8List updateWorkerPoolRequestDescriptor = $convert.base64Decode('');
...
final $typed_data.Uint8List listWorkerPoolsRequestDescriptor = $convert.base64Decode('ChZMaXN0V29ya2VyUG9vbHNSZXF1ZXN0EkEKBnBhcmVudBgBIAEoCUIp4EEC+kEjCiFsb2NhdGlvbnMuZ29vZ2xlYXBpcy5jb20vTG9jYXRpb25SBnBhcmVudBIbCglwYWdlX3NpemUYAiABKAVSCHBhZ2VTaXplEh0KCnBhZ2VfdG9rZW4YAyABKAlSCXBhZ2VUb2tlbg==');
...
const ListWorkerPoolsResponse$json = const {
  ...
  '2': const [
    const {'1': 'worker_pools', '3': 1, '4': 3, '5': 11, '6': '.google.devtools.cloudbuild.v1.WorkerPool', '10': 'workerPools'},
    const {'1': 'next_page_token', '3': 2, '4': 1, '5': 9, '10': 'nextPageToken'},
  ],
};

/// Descriptor for `ListWorkerPoolsResponse`. Decode as a `google.protobuf.DescriptorProto`.
final $typed_data.Uint8List listWorkerPoolsResponseDescriptor = $convert.base64Decode('ChdMaXN0V29ya2VyUG9vbHNSZXNwb25zZRJMCgx3b3JrZXJfcG9vbHMYASADKAsyKS5nb29nbGUuZGV2dG9vbHMuY2xvdWRidWlsZC52MS5Xb3JrZXJQb29sUgt3b3JrZXJQb29scxImCg9uZXh0X3BhZ2VfdG9rZW4YAiABKAlSDW5leHRQYWdlVG9rZW4=');
...
const CreateWorkerPoolOperationMetadata$json = const {
  ...
  '2': const [
    const {'1': 'worker_pool', '3': 1, '4': 1, '5': 9, '8': const {}, '10': 'workerPool'},
    const {'1': 'create_time', '3': 2, '4': 1, '5': 11, '6': '.google.protobuf.Timestamp', '10': 'createTime'},
    const {'1': 'complete_time', '3': 3, '4': 1, '5': 11, '6': '.google.protobuf.Timestamp', '10': 'completeTime'},
  ],
};

/// Descriptor for `CreateWorkerPoolOperationMetadata`. Decode as a `google.protobuf.DescriptorProto`.
final $typed_data.Uint8List createWorkerPoolOperationMetadataDescriptor = $convert.base64Decode('');
...
final $typed_data.Uint8List updateWorkerPoolOperationMetadataDescriptor = $convert.base64Decode('');
...
final $typed_data.Uint8List deleteWorkerPoolOperationMetadataDescriptor = $convert.base64Decode('');

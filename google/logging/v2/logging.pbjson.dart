...
final $typed_data.Uint8List deleteLogRequestDescriptor = $convert.base64Decode('ChBEZWxldGVMb2dSZXF1ZXN0Ej0KCGxvZ19uYW1lGAEgASgJQiLgQQL6QRwKGmxvZ2dpbmcuZ29vZ2xlYXBpcy5jb20vTG9nUgdsb2dOYW1l');
...
final $typed_data.Uint8List writeLogEntriesRequestDescriptor = $convert.base64Decode('');
...
final $typed_data.Uint8List writeLogEntriesResponseDescriptor = $convert.base64Decode('ChdXcml0ZUxvZ0VudHJpZXNSZXNwb25zZQ==');
...
final $typed_data.Uint8List listLogEntriesRequestDescriptor = $convert.base64Decode('');
...
final $typed_data.Uint8List listLogEntriesResponseDescriptor = $convert.base64Decode('ChZMaXN0TG9nRW50cmllc1Jlc3BvbnNlEjUKB2VudHJpZXMYASADKAsyGy5nb29nbGUubG9nZ2luZy52Mi5Mb2dFbnRyeVIHZW50cmllcxImCg9uZXh0X3BhZ2VfdG9rZW4YAiABKAlSDW5leHRQYWdlVG9rZW4=');
...
final $typed_data.Uint8List listMonitoredResourceDescriptorsRequestDescriptor = $convert.base64Decode('CidMaXN0TW9uaXRvcmVkUmVzb3VyY2VEZXNjcmlwdG9yc1JlcXVlc3QSIAoJcGFnZV9zaXplGAEgASgFQgPgQQFSCHBhZ2VTaXplEiIKCnBhZ2VfdG9rZW4YAiABKAlCA+BBAVIJcGFnZVRva2Vu');
...
final $typed_data.Uint8List listLogsRequestDescriptor = $convert.base64Decode('');
...
final $typed_data.Uint8List listLogsResponseDescriptor = $convert.base64Decode('ChBMaXN0TG9nc1Jlc3BvbnNlEhsKCWxvZ19uYW1lcxgDIAMoCVIIbG9nTmFtZXMSJgoPbmV4dF9wYWdlX3Rva2VuGAIgASgJUg1uZXh0UGFnZVRva2Vu');
...
final $typed_data.Uint8List tailLogEntriesRequestDescriptor = $convert.base64Decode('ChVUYWlsTG9nRW50cmllc1JlcXVlc3QSKgoOcmVzb3VyY2VfbmFtZXMYASADKAlCA+BBAlINcmVzb3VyY2VOYW1lcxIbCgZmaWx0ZXIYAiABKAlCA+BBAVIGZmlsdGVyEkMKDWJ1ZmZlcl93aW5kb3cYAyABKAsyGS5nb29nbGUucHJvdG9idWYuRHVyYXRpb25CA+BBAVIMYnVmZmVyV2luZG93');

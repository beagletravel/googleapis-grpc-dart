...
const LogMetric$json = const {
  ...
  '2': const [
    ...
    const {'1': 'disabled', '3': 12, '4': 1, '5': 8, '8': const {}, '10': 'disabled'},
    const {'1': 'metric_descriptor', '3': 5, '4': 1, '5': 11, '6': '.google.api.MetricDescriptor', '8': const {}, '10': 'metricDescriptor'},
    const {'1': 'value_extractor', '3': 6, '4': 1, '5': 9, '8': const {}, '10': 'valueExtractor'},
    const {'1': 'label_extractors', '3': 7, '4': 3, '5': 11, '6': '.google.logging.v2.LogMetric.LabelExtractorsEntry', '8': const {}, '10': 'labelExtractors'},
    const {'1': 'bucket_options', '3': 8, '4': 1, '5': 11, '6': '.google.api.Distribution.BucketOptions', '8': const {}, '10': 'bucketOptions'},
...
final $typed_data.Uint8List listLogMetricsResponseDescriptor = $convert.base64Decode('ChZMaXN0TG9nTWV0cmljc1Jlc3BvbnNlEjYKB21ldHJpY3MYASADKAsyHC5nb29nbGUubG9nZ2luZy52Mi5Mb2dNZXRyaWNSB21ldHJpY3MSJgoPbmV4dF9wYWdlX3Rva2VuGAIgASgJUg1uZXh0UGFnZVRva2Vu');
...
final $typed_data.Uint8List getLogMetricRequestDescriptor = $convert.base64Decode('ChNHZXRMb2dNZXRyaWNSZXF1ZXN0EkkKC21ldHJpY19uYW1lGAEgASgJQijgQQL6QSIKIGxvZ2dpbmcuZ29vZ2xlYXBpcy5jb20vTG9nTWV0cmljUgptZXRyaWNOYW1l');
...
const CreateLogMetricRequest$json = const {
  ...
  '2': const [
    const {'1': 'parent', '3': 1, '4': 1, '5': 9, '8': const {}, '10': 'parent'},
    const {'1': 'metric', '3': 2, '4': 1, '5': 11, '6': '.google.logging.v2.LogMetric', '8': const {}, '10': 'metric'},
  ],
};

/// Descriptor for `CreateLogMetricRequest`. Decode as a `google.protobuf.DescriptorProto`.
final $typed_data.Uint8List createLogMetricRequestDescriptor = $convert.base64Decode('ChZDcmVhdGVMb2dNZXRyaWNSZXF1ZXN0EkAKBnBhcmVudBgBIAEoCUIo4EEC+kEiEiBsb2dnaW5nLmdvb2dsZWFwaXMuY29tL0xvZ01ldHJpY1IGcGFyZW50EjkKBm1ldHJpYxgCIAEoCzIcLmdvb2dsZS5sb2dnaW5nLnYyLkxvZ01ldHJpY0ID4EECUgZtZXRyaWM=');
...
final $typed_data.Uint8List updateLogMetricRequestDescriptor = $convert.base64Decode('ChZVcGRhdGVMb2dNZXRyaWNSZXF1ZXN0EkkKC21ldHJpY19uYW1lGAEgASgJQijgQQL6QSIKIGxvZ2dpbmcuZ29vZ2xlYXBpcy5jb20vTG9nTWV0cmljUgptZXRyaWNOYW1lEjkKBm1ldHJpYxgCIAEoCzIcLmdvb2dsZS5sb2dnaW5nLnYyLkxvZ01ldHJpY0ID4EECUgZtZXRyaWM=');
...
final $typed_data.Uint8List deleteLogMetricRequestDescriptor = $convert.base64Decode('ChZEZWxldGVMb2dNZXRyaWNSZXF1ZXN0EkkKC21ldHJpY19uYW1lGAEgASgJQijgQQL6QSIKIGxvZ2dpbmcuZ29vZ2xlYXBpcy5jb20vTG9nTWV0cmljUgptZXRyaWNOYW1l');

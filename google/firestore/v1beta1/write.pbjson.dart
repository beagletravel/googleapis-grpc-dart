...
const Write$json = const {
  ...
  '2': const [
    ...
    const {'1': 'update_transforms', '3': 7, '4': 3, '5': 11, '6': '.google.firestore.v1beta1.DocumentTransform.FieldTransform', '10': 'updateTransforms'},
...
final $typed_data.Uint8List writeDescriptor = $convert.base64Decode('');
...
final $typed_data.Uint8List documentTransformDescriptor = $convert.base64Decode('');
...
final $typed_data.Uint8List writeResultDescriptor = $convert.base64Decode('CgtXcml0ZVJlc3VsdBI7Cgt1cGRhdGVfdGltZRgBIAEoCzIaLmdvb2dsZS5wcm90b2J1Zi5UaW1lc3RhbXBSCnVwZGF0ZVRpbWUSTAoRdHJhbnNmb3JtX3Jlc3VsdHMYAiADKAsyHy5nb29nbGUuZmlyZXN0b3JlLnYxYmV0YTEuVmFsdWVSEHRyYW5zZm9ybVJlc3VsdHM=');
...
final $typed_data.Uint8List documentChangeDescriptor = $convert.base64Decode('Cg5Eb2N1bWVudENoYW5nZRI+Cghkb2N1bWVudBgBIAEoCzIiLmdvb2dsZS5maXJlc3RvcmUudjFiZXRhMS5Eb2N1bWVudFIIZG9jdW1lbnQSHQoKdGFyZ2V0X2lkcxgFIAMoBVIJdGFyZ2V0SWRzEiwKEnJlbW92ZWRfdGFyZ2V0X2lkcxgGIAMoBVIQcmVtb3ZlZFRhcmdldElkcw==');
...
final $typed_data.Uint8List documentDeleteDescriptor = $convert.base64Decode('Cg5Eb2N1bWVudERlbGV0ZRIaCghkb2N1bWVudBgBIAEoCVIIZG9jdW1lbnQSLAoScmVtb3ZlZF90YXJnZXRfaWRzGAYgAygFUhByZW1vdmVkVGFyZ2V0SWRzEjcKCXJlYWRfdGltZRgEIAEoCzIaLmdvb2dsZS5wcm90b2J1Zi5UaW1lc3RhbXBSCHJlYWRUaW1l');
...
final $typed_data.Uint8List documentRemoveDescriptor = $convert.base64Decode('Cg5Eb2N1bWVudFJlbW92ZRIaCghkb2N1bWVudBgBIAEoCVIIZG9jdW1lbnQSLAoScmVtb3ZlZF90YXJnZXRfaWRzGAIgAygFUhByZW1vdmVkVGFyZ2V0SWRzEjcKCXJlYWRfdGltZRgEIAEoCzIaLmdvb2dsZS5wcm90b2J1Zi5UaW1lc3RhbXBSCHJlYWRUaW1l');
...
final $typed_data.Uint8List existenceFilterDescriptor = $convert.base64Decode('Cg9FeGlzdGVuY2VGaWx0ZXISGwoJdGFyZ2V0X2lkGAEgASgFUgh0YXJnZXRJZBIUCgVjb3VudBgCIAEoBVIFY291bnQ=');

...
class Index_IndexField extends $pb.GeneratedMessage {
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'Index.IndexField', package: const $pb.PackageName(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'google.firestore.admin.v1beta2'), createEmptyInstance: create)
    ..oo(0, [2, 3])
    ..aOS(1, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'fieldPath')
    ..e<Index_IndexField_Order>(2, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'order', $pb.PbFieldType.OE, defaultOrMaker: Index_IndexField_Order.ORDER_UNSPECIFIED, valueOf: Index_IndexField_Order.valueOf, enumValues: Index_IndexField_Order.values)
    ..e<Index_IndexField_ArrayConfig>(3, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'arrayConfig', $pb.PbFieldType.OE, defaultOrMaker: Index_IndexField_ArrayConfig.ARRAY_CONFIG_UNSPECIFIED, valueOf: Index_IndexField_ArrayConfig.valueOf, enumValues: Index_IndexField_ArrayConfig.values)
  ...
  'Will be removed in next major version')
  Index_IndexField copyWith(void Function(Index_IndexField) updates) => super.copyWith((message) => updates(message as Index_IndexField)) as Index_IndexField; // ignore: deprecated_member_use
...
class Index extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'Index', package: const $pb.PackageName(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'google.firestore.admin.v1beta2'), createEmptyInstance: create)
    ..aOS(1, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'name')
    ..e<Index_QueryScope>(2, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'queryScope', $pb.PbFieldType.OE, defaultOrMaker: Index_QueryScope.QUERY_SCOPE_UNSPECIFIED, valueOf: Index_QueryScope.valueOf, enumValues: Index_QueryScope.values)
    ..pc<Index_IndexField>(3, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'fields', $pb.PbFieldType.PM, subBuilder: Index_IndexField.create)
    ..e<Index_State>(4, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'state', $pb.PbFieldType.OE, defaultOrMaker: Index_State.STATE_UNSPECIFIED, valueOf: Index_State.valueOf, enumValues: Index_State.values)
    ..hasRequiredFields = false
  ;

...
class Field_IndexConfig extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'Field.IndexConfig', package: const $pb.PackageName(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'google.firestore.admin.v1beta2'), createEmptyInstance: create)
    ..pc<$0.Index>(1, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'indexes', $pb.PbFieldType.PM, subBuilder: $0.Index.create)
    ..aOB(2, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'usesAncestorConfig')
    ..aOS(3, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'ancestorField')
    ..aOB(4, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'reverting')
  ...
  'Will be removed in next major version')
  Field_IndexConfig copyWith(void Function(Field_IndexConfig) updates) => super.copyWith((message) => updates(message as Field_IndexConfig)) as Field_IndexConfig; // ignore: deprecated_member_use
...
class Field extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'Field', package: const $pb.PackageName(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'google.firestore.admin.v1beta2'), createEmptyInstance: create)
    ..aOS(1, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'name')
    ..aOM<Field_IndexConfig>(2, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'indexConfig', subBuilder: Field_IndexConfig.create)
    ..hasRequiredFields = false
  ;

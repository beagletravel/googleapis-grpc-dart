...
const UploadRef$json = const {
  '1': 'UploadRef',
  '2': const [
    const {'1': 'upload_url', '3': 1, '4': 1, '5': 9, '9': 0, '10': 'uploadUrl'},
  ],
  '8': const [
    const {'1': 'file_source'},
  ],
...
final $typed_data.Uint8List uploadRefDescriptor = $convert.base64Decode('CglVcGxvYWRSZWYSHwoKdXBsb2FkX3VybBgBIAEoCUgAUgl1cGxvYWRVcmxCDQoLZmlsZV9zb3VyY2U=');
...
final $typed_data.Uint8List photoIdDescriptor = $convert.base64Decode('CgdQaG90b0lkEg4KAmlkGAEgASgJUgJpZA==');
@$core.Deprecated('Use levelDescriptor instead')
const Level$json = const {
  '1': 'Level',
  '2': const [
    const {'1': 'number', '3': 1, '4': 1, '5': 1, '8': const {}, '10': 'number'},
    const {'1': 'name', '3': 2, '4': 1, '5': 9, '8': const {}, '10': 'name'},
  ],
};

/// Descriptor for `Level`. Decode as a `google.protobuf.DescriptorProto`.
final $typed_data.Uint8List levelDescriptor = $convert.base64Decode('CgVMZXZlbBIbCgZudW1iZXIYASABKAFCA+BBAVIGbnVtYmVyEhcKBG5hbWUYAiABKAlCA+BBAlIEbmFtZQ==');
...
final $typed_data.Uint8List poseDescriptor = $convert.base64Decode('');
...
final $typed_data.Uint8List placeDescriptor = $convert.base64Decode('CgVQbGFjZRIZCghwbGFjZV9pZBgBIAEoCVIHcGxhY2VJZBIXCgRuYW1lGAIgASgJQgPgQQNSBG5hbWUSKAoNbGFuZ3VhZ2VfY29kZRgDIAEoCUID4EEDUgxsYW5ndWFnZUNvZGU=');
@$core.Deprecated('Use connectionDescriptor instead')
const Connection$json = const {
  '1': 'Connection',
  '2': const [
    const {'1': 'target', '3': 1, '4': 1, '5': 11, '6': '.google.streetview.publish.v1.PhotoId', '8': const {}, '10': 'target'},
  ],
};

/// Descriptor for `Connection`. Decode as a `google.protobuf.DescriptorProto`.
final $typed_data.Uint8List connectionDescriptor = $convert.base64Decode('CgpDb25uZWN0aW9uEkIKBnRhcmdldBgBIAEoCzIlLmdvb2dsZS5zdHJlZXR2aWV3LnB1Ymxpc2gudjEuUGhvdG9JZEID4EECUgZ0YXJnZXQ=');
@$core.Deprecated('Use photoDescriptor instead')
const Photo$json = const {
  '1': 'Photo',
  '2': const [
    const {'1': 'photo_id', '3': 1, '4': 1, '5': 11, '6': '.google.streetview.publish.v1.PhotoId', '8': const {}, '10': 'photoId'},
    const {'1': 'upload_reference', '3': 2, '4': 1, '5': 11, '6': '.google.streetview.publish.v1.UploadRef', '8': const {}, '10': 'uploadReference'},
    const {'1': 'download_url', '3': 3, '4': 1, '5': 9, '8': const {}, '10': 'downloadUrl'},
    const {'1': 'thumbnail_url', '3': 9, '4': 1, '5': 9, '8': const {}, '10': 'thumbnailUrl'},
    const {'1': 'share_link', '3': 11, '4': 1, '5': 9, '8': const {}, '10': 'shareLink'},
    const {'1': 'pose', '3': 4, '4': 1, '5': 11, '6': '.google.streetview.publish.v1.Pose', '8': const {}, '10': 'pose'},
    const {'1': 'connections', '3': 5, '4': 3, '5': 11, '6': '.google.streetview.publish.v1.Connection', '8': const {}, '10': 'connections'},
    const {'1': 'capture_time', '3': 6, '4': 1, '5': 11, '6': '.google.protobuf.Timestamp', '8': const {}, '10': 'captureTime'},
    const {'1': 'upload_time', '3': 14, '4': 1, '5': 11, '6': '.google.protobuf.Timestamp', '8': const {}, '10': 'uploadTime'},
    const {'1': 'places', '3': 7, '4': 3, '5': 11, '6': '.google.streetview.publish.v1.Place', '8': const {}, '10': 'places'},
    const {'1': 'view_count', '3': 10, '4': 1, '5': 3, '8': const {}, '10': 'viewCount'},
    const {'1': 'transfer_status', '3': 12, '4': 1, '5': 14, '6': '.google.streetview.publish.v1.Photo.TransferStatus', '8': const {}, '10': 'transferStatus'},
    const {'1': 'maps_publish_status', '3': 13, '4': 1, '5': 14, '6': '.google.streetview.publish.v1.Photo.MapsPublishStatus', '8': const {}, '10': 'mapsPublishStatus'},
  ],

...
enum UploadRef_FileSource {
  uploadUrl, 
  notSet
}

class UploadRef extends $pb.GeneratedMessage {
  static const $core.Map<$core.int, UploadRef_FileSource> _UploadRef_FileSourceByTag = {
    1 : UploadRef_FileSource.uploadUrl,
    0 : UploadRef_FileSource.notSet
  };
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'UploadRef', package: const $pb.PackageName(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'google.streetview.publish.v1'), createEmptyInstance: create)
    ..oo(0, [1])
  ...
  factory UploadRef.fromBuffer($core.List<$core.int> i, [$pb.ExtensionRegistry r = $pb.ExtensionRegistry.EMPTY]) => create()..mergeFromBuffer(i, r);
  factory UploadRef.fromJson($core.String i, [$pb.ExtensionRegistry r = $pb.ExtensionRegistry.EMPTY]) => create()..mergeFromJson(i, r);
  @$core.Deprecated(
  ...
  'Will be removed in next major version')
  UploadRef copyWith(void Function(UploadRef) updates) => super.copyWith((message) => updates(message as UploadRef)) as UploadRef; // ignore: deprecated_member_use
  ...
  @$core.pragma('dart2js:noInline')
  static UploadRef getDefault() => _defaultInstance ??= $pb.GeneratedMessage.$_defaultFor<UploadRef>(create);
  static UploadRef? _defaultInstance;

  UploadRef_FileSource whichFileSource() => _UploadRef_FileSourceByTag[$_whichOneof(0)]!;
...
class PhotoId extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'PhotoId', package: const $pb.PackageName(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'google.streetview.publish.v1'), createEmptyInstance: create)
  ...
  factory PhotoId.fromBuffer($core.List<$core.int> i, [$pb.ExtensionRegistry r = $pb.ExtensionRegistry.EMPTY]) => create()..mergeFromBuffer(i, r);
  factory PhotoId.fromJson($core.String i, [$pb.ExtensionRegistry r = $pb.ExtensionRegistry.EMPTY]) => create()..mergeFromJson(i, r);
  @$core.Deprecated(
  'Using this can add significant overhead to your binary. '
  'Use [GeneratedMessageGenericExtensions.deepCopy] instead. '
  'Will be removed in next major version')
  ...
  'Use [GeneratedMessageGenericExtensions.rebuild] instead. '
  'Will be removed in next major version')
  PhotoId copyWith(void Function(PhotoId) updates) => super.copyWith((message) => updates(message as PhotoId)) as PhotoId; // ignore: deprecated_member_use
  $pb.BuilderInfo get info_ => _i;
  @$core.pragma('dart2js:noInline')
  ...
  @$core.pragma('dart2js:noInline')
  static PhotoId getDefault() => _defaultInstance ??= $pb.GeneratedMessage.$_defaultFor<PhotoId>(create);
...
class Level extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'Level', package: const $pb.PackageName(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'google.streetview.publish.v1'), createEmptyInstance: create)
  ...
  'Use [GeneratedMessageGenericExtensions.rebuild] instead. '
  'Will be removed in next major version')
  Level copyWith(void Function(Level) updates) => super.copyWith((message) => updates(message as Level)) as Level; // ignore: deprecated_member_use
  $pb.BuilderInfo get info_ => _i;
  @$core.pragma('dart2js:noInline')
...
class Pose extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'Pose', package: const $pb.PackageName(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'google.streetview.publish.v1'), createEmptyInstance: create)
    ..aOM<$0.LatLng>(1, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'latLngPair', subBuilder: $0.LatLng.create)
    ..a<$core.double>(2, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'altitude', $pb.PbFieldType.OD)
    ..a<$core.double>(3, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'heading', $pb.PbFieldType.OD)
    ..a<$core.double>(4, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'pitch', $pb.PbFieldType.OD)
    ..a<$core.double>(5, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'roll', $pb.PbFieldType.OD)
    ..aOM<Level>(7, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'level', subBuilder: Level.create)
    ..a<$core.double>(9, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'accuracyMeters', $pb.PbFieldType.OF)
    ..hasRequiredFields = false
  ;
...
class Place extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'Place', package: const $pb.PackageName(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'google.streetview.publish.v1'), createEmptyInstance: create)
...
class Connection extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'Connection', package: const $pb.PackageName(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'google.streetview.publish.v1'), createEmptyInstance: create)
    ..aOM<PhotoId>(1, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'target', subBuilder: PhotoId.create)
    ..hasRequiredFields = false
  ;
...
class Photo extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'Photo', package: const $pb.PackageName(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'google.streetview.publish.v1'), createEmptyInstance: create)
    ..aOM<PhotoId>(1, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'photoId', subBuilder: PhotoId.create)
    ..aOM<UploadRef>(2, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'uploadReference', subBuilder: UploadRef.create)
    ..aOS(3, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'downloadUrl')
    ..aOM<Pose>(4, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'pose', subBuilder: Pose.create)
    ..pc<Connection>(5, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'connections', $pb.PbFieldType.PM, subBuilder: Connection.create)
    ..aOM<$1.Timestamp>(6, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'captureTime', subBuilder: $1.Timestamp.create)
    ..pc<Place>(7, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'places', $pb.PbFieldType.PM, subBuilder: Place.create)
    ..aOS(9, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'thumbnailUrl')
    ..aInt64(10, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'viewCount')
    ..aOS(11, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'shareLink')
    ..e<Photo_TransferStatus>(12, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'transferStatus', $pb.PbFieldType.OE, defaultOrMaker: Photo_TransferStatus.TRANSFER_STATUS_UNKNOWN, valueOf: Photo_TransferStatus.valueOf, enumValues: Photo_TransferStatus.values)
    ..e<Photo_MapsPublishStatus>(13, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'mapsPublishStatus', $pb.PbFieldType.OE, defaultOrMaker: Photo_MapsPublishStatus.UNSPECIFIED_MAPS_PUBLISH_STATUS, valueOf: Photo_MapsPublishStatus.valueOf, enumValues: Photo_MapsPublishStatus.values)
    ..aOM<$1.Timestamp>(14, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'uploadTime', subBuilder: $1.Timestamp.create)
    ..hasRequiredFields = false
  ;
  ...
  @$pb.TagNumber(10)
  set viewCount($fixnum.Int64 v) { $_setInt64(8, v); }
  @$pb.TagNumber(10)
  ...
  @$pb.TagNumber(14)
  set uploadTime($1.Timestamp v) { setField(14, v); }
  @$pb.TagNumber(14)

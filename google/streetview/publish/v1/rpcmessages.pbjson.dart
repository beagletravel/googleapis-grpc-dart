...
final $typed_data.Uint8List photoViewDescriptor = $convert.base64Decode('CglQaG90b1ZpZXcSCQoFQkFTSUMQABIYChRJTkNMVURFX0RPV05MT0FEX1VSTBAB');
@$core.Deprecated('Use createPhotoRequestDescriptor instead')
const CreatePhotoRequest$json = const {
  '1': 'CreatePhotoRequest',
  '2': const [
    const {'1': 'photo', '3': 1, '4': 1, '5': 11, '6': '.google.streetview.publish.v1.Photo', '8': const {}, '10': 'photo'},
  ],
};

/// Descriptor for `CreatePhotoRequest`. Decode as a `google.protobuf.DescriptorProto`.
final $typed_data.Uint8List createPhotoRequestDescriptor = $convert.base64Decode('ChJDcmVhdGVQaG90b1JlcXVlc3QSPgoFcGhvdG8YASABKAsyIy5nb29nbGUuc3RyZWV0dmlldy5wdWJsaXNoLnYxLlBob3RvQgPgQQJSBXBob3Rv');
@$core.Deprecated('Use getPhotoRequestDescriptor instead')
const GetPhotoRequest$json = const {
  '1': 'GetPhotoRequest',
  '2': const [
    const {'1': 'photo_id', '3': 1, '4': 1, '5': 9, '8': const {}, '10': 'photoId'},
    const {'1': 'view', '3': 2, '4': 1, '5': 14, '6': '.google.streetview.publish.v1.PhotoView', '8': const {}, '10': 'view'},
...
final $typed_data.Uint8List getPhotoRequestDescriptor = $convert.base64Decode('Cg9HZXRQaG90b1JlcXVlc3QSHgoIcGhvdG9faWQYASABKAlCA+BBAlIHcGhvdG9JZBJACgR2aWV3GAIgASgOMicuZ29vZ2xlLnN0cmVldHZpZXcucHVibGlzaC52MS5QaG90b1ZpZXdCA+BBAlIEdmlldxIjCg1sYW5ndWFnZV9jb2RlGAMgASgJUgxsYW5ndWFnZUNvZGU=');
@$core.Deprecated('Use batchGetPhotosRequestDescriptor instead')
const BatchGetPhotosRequest$json = const {
  '1': 'BatchGetPhotosRequest',
  '2': const [
    const {'1': 'photo_ids', '3': 1, '4': 3, '5': 9, '8': const {}, '10': 'photoIds'},
    const {'1': 'view', '3': 2, '4': 1, '5': 14, '6': '.google.streetview.publish.v1.PhotoView', '8': const {}, '10': 'view'},
...
final $typed_data.Uint8List batchGetPhotosRequestDescriptor = $convert.base64Decode('ChVCYXRjaEdldFBob3Rvc1JlcXVlc3QSIAoJcGhvdG9faWRzGAEgAygJQgPgQQJSCHBob3RvSWRzEkAKBHZpZXcYAiABKA4yJy5nb29nbGUuc3RyZWV0dmlldy5wdWJsaXNoLnYxLlBob3RvVmlld0ID4EECUgR2aWV3EigKDWxhbmd1YWdlX2NvZGUYAyABKAlCA+BBAVIMbGFuZ3VhZ2VDb2Rl');
...
final $typed_data.Uint8List batchGetPhotosResponseDescriptor = $convert.base64Decode('ChZCYXRjaEdldFBob3Rvc1Jlc3BvbnNlEkUKB3Jlc3VsdHMYASADKAsyKy5nb29nbGUuc3RyZWV0dmlldy5wdWJsaXNoLnYxLlBob3RvUmVzcG9uc2VSB3Jlc3VsdHM=');
...
final $typed_data.Uint8List photoResponseDescriptor = $convert.base64Decode('Cg1QaG90b1Jlc3BvbnNlEioKBnN0YXR1cxgBIAEoCzISLmdvb2dsZS5ycGMuU3RhdHVzUgZzdGF0dXMSOQoFcGhvdG8YAiABKAsyIy5nb29nbGUuc3RyZWV0dmlldy5wdWJsaXNoLnYxLlBob3RvUgVwaG90bw==');
@$core.Deprecated('Use listPhotosRequestDescriptor instead')
const ListPhotosRequest$json = const {
  '1': 'ListPhotosRequest',
  '2': const [
    const {'1': 'view', '3': 1, '4': 1, '5': 14, '6': '.google.streetview.publish.v1.PhotoView', '8': const {}, '10': 'view'},
...
final $typed_data.Uint8List listPhotosResponseDescriptor = $convert.base64Decode('ChJMaXN0UGhvdG9zUmVzcG9uc2USOwoGcGhvdG9zGAEgAygLMiMuZ29vZ2xlLnN0cmVldHZpZXcucHVibGlzaC52MS5QaG90b1IGcGhvdG9zEiYKD25leHRfcGFnZV90b2tlbhgCIAEoCVINbmV4dFBhZ2VUb2tlbg==');
...
final $typed_data.Uint8List updatePhotoRequestDescriptor = $convert.base64Decode('ChJVcGRhdGVQaG90b1JlcXVlc3QSPgoFcGhvdG8YASABKAsyIy5nb29nbGUuc3RyZWV0dmlldy5wdWJsaXNoLnYxLlBob3RvQgPgQQJSBXBob3RvEkAKC3VwZGF0ZV9tYXNrGAIgASgLMhouZ29vZ2xlLnByb3RvYnVmLkZpZWxkTWFza0ID4EECUgp1cGRhdGVNYXNr');
...
const BatchUpdatePhotosRequest$json = const {
  ...
  '2': const [
    const {'1': 'update_photo_requests', '3': 1, '4': 3, '5': 11, '6': '.google.streetview.publish.v1.UpdatePhotoRequest', '8': const {}, '10': 'updatePhotoRequests'},
  ],
};

/// Descriptor for `BatchUpdatePhotosRequest`. Decode as a `google.protobuf.DescriptorProto`.
final $typed_data.Uint8List batchUpdatePhotosRequestDescriptor = $convert.base64Decode('ChhCYXRjaFVwZGF0ZVBob3Rvc1JlcXVlc3QSaQoVdXBkYXRlX3Bob3RvX3JlcXVlc3RzGAEgAygLMjAuZ29vZ2xlLnN0cmVldHZpZXcucHVibGlzaC52MS5VcGRhdGVQaG90b1JlcXVlc3RCA+BBAlITdXBkYXRlUGhvdG9SZXF1ZXN0cw==');
...
final $typed_data.Uint8List batchUpdatePhotosResponseDescriptor = $convert.base64Decode('ChlCYXRjaFVwZGF0ZVBob3Rvc1Jlc3BvbnNlEkUKB3Jlc3VsdHMYASADKAsyKy5nb29nbGUuc3RyZWV0dmlldy5wdWJsaXNoLnYxLlBob3RvUmVzcG9uc2VSB3Jlc3VsdHM=');
...
final $typed_data.Uint8List deletePhotoRequestDescriptor = $convert.base64Decode('ChJEZWxldGVQaG90b1JlcXVlc3QSHgoIcGhvdG9faWQYASABKAlCA+BBAlIHcGhvdG9JZA==');
...
final $typed_data.Uint8List batchDeletePhotosRequestDescriptor = $convert.base64Decode('ChhCYXRjaERlbGV0ZVBob3Rvc1JlcXVlc3QSIAoJcGhvdG9faWRzGAEgAygJQgPgQQJSCHBob3RvSWRz');
...
final $typed_data.Uint8List batchDeletePhotosResponseDescriptor = $convert.base64Decode('ChlCYXRjaERlbGV0ZVBob3Rvc1Jlc3BvbnNlEioKBnN0YXR1cxgBIAMoCzISLmdvb2dsZS5ycGMuU3RhdHVzUgZzdGF0dXM=');

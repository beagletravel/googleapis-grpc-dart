...
class DriveAddOnManifest extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'DriveAddOnManifest', package: const $pb.PackageName(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'google.apps.script.type.drive'), createEmptyInstance: create)
    ...
    ..aOM<DriveExtensionPoint>(2, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'onItemsSelectedTrigger', subBuilder: DriveExtensionPoint.create)
  ...
  'Will be removed in next major version')
  DriveAddOnManifest copyWith(void Function(DriveAddOnManifest) updates) => super.copyWith((message) => updates(message as DriveAddOnManifest)) as DriveAddOnManifest; // ignore: deprecated_member_use
...
class DriveExtensionPoint extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'DriveExtensionPoint', package: const $pb.PackageName(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'google.apps.script.type.drive'), createEmptyInstance: create)
  ...
  'Use [GeneratedMessageGenericExtensions.rebuild] instead. '
  'Will be removed in next major version')
  DriveExtensionPoint copyWith(void Function(DriveExtensionPoint) updates) => super.copyWith((message) => updates(message as DriveExtensionPoint)) as DriveExtensionPoint; // ignore: deprecated_member_use
  $pb.BuilderInfo get info_ => _i;
  @$core.pragma('dart2js:noInline')

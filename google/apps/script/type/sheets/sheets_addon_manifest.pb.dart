...
class SheetsAddOnManifest extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'SheetsAddOnManifest', package: const $pb.PackageName(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'google.apps.script.type.sheets'), createEmptyInstance: create)
    ..aOM<$0.HomepageExtensionPoint>(3, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'homepageTrigger', subBuilder: $0.HomepageExtensionPoint.create)
    ..aOM<SheetsExtensionPoint>(5, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'onFileScopeGrantedTrigger', subBuilder: SheetsExtensionPoint.create)
  ...
  'Will be removed in next major version')
  SheetsAddOnManifest copyWith(void Function(SheetsAddOnManifest) updates) => super.copyWith((message) => updates(message as SheetsAddOnManifest)) as SheetsAddOnManifest; // ignore: deprecated_member_use
  ...
  @$pb.TagNumber(3)
  set homepageTrigger($0.HomepageExtensionPoint v) { setField(3, v); }
  @$pb.TagNumber(3)
...
class SheetsExtensionPoint extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'SheetsExtensionPoint', package: const $pb.PackageName(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'google.apps.script.type.sheets'), createEmptyInstance: create)
  ...
  'Use [GeneratedMessageGenericExtensions.rebuild] instead. '
  'Will be removed in next major version')
  SheetsExtensionPoint copyWith(void Function(SheetsExtensionPoint) updates) => super.copyWith((message) => updates(message as SheetsExtensionPoint)) as SheetsExtensionPoint; // ignore: deprecated_member_use
  $pb.BuilderInfo get info_ => _i;
  @$core.pragma('dart2js:noInline')

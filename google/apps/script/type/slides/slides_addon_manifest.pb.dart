...
class SlidesAddOnManifest extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'SlidesAddOnManifest', package: const $pb.PackageName(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'google.apps.script.type.slides'), createEmptyInstance: create)
    ...
    ..aOM<SlidesExtensionPoint>(2, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'onFileScopeGrantedTrigger', subBuilder: SlidesExtensionPoint.create)
  ...
  'Will be removed in next major version')
  SlidesAddOnManifest copyWith(void Function(SlidesAddOnManifest) updates) => super.copyWith((message) => updates(message as SlidesAddOnManifest)) as SlidesAddOnManifest; // ignore: deprecated_member_use
...
class SlidesExtensionPoint extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'SlidesExtensionPoint', package: const $pb.PackageName(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'google.apps.script.type.slides'), createEmptyInstance: create)
  ...
  'Use [GeneratedMessageGenericExtensions.rebuild] instead. '
  'Will be removed in next major version')
  SlidesExtensionPoint copyWith(void Function(SlidesExtensionPoint) updates) => super.copyWith((message) => updates(message as SlidesExtensionPoint)) as SlidesExtensionPoint; // ignore: deprecated_member_use
  $pb.BuilderInfo get info_ => _i;
  @$core.pragma('dart2js:noInline')

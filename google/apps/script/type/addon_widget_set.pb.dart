...
class AddOnWidgetSet extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'AddOnWidgetSet', package: const $pb.PackageName(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'google.apps.script.type'), createEmptyInstance: create)
    ..pc<AddOnWidgetSet_WidgetType>(1, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'usedWidgets', $pb.PbFieldType.PE, valueOf: AddOnWidgetSet_WidgetType.valueOf, enumValues: AddOnWidgetSet_WidgetType.values)
  ...
  'Will be removed in next major version')
  AddOnWidgetSet copyWith(void Function(AddOnWidgetSet) updates) => super.copyWith((message) => updates(message as AddOnWidgetSet)) as AddOnWidgetSet; // ignore: deprecated_member_use

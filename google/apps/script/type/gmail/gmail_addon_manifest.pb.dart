...
class GmailAddOnManifest extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'GmailAddOnManifest', package: const $pb.PackageName(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'google.apps.script.type.gmail'), createEmptyInstance: create)
    ..pc<ContextualTrigger>(3, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'contextualTriggers', $pb.PbFieldType.PM, subBuilder: ContextualTrigger.create)
    ..pc<UniversalAction>(4, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'universalActions', $pb.PbFieldType.PM, subBuilder: UniversalAction.create)
    ..aOS(7, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'authorizationCheckFunction')
    ..aOM<ComposeTrigger>(12, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'composeTrigger', subBuilder: ComposeTrigger.create)
    ..aOM<$0.HomepageExtensionPoint>(14, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'homepageTrigger', subBuilder: $0.HomepageExtensionPoint.create)
  ...
  'Will be removed in next major version')
  GmailAddOnManifest copyWith(void Function(GmailAddOnManifest) updates) => super.copyWith((message) => updates(message as GmailAddOnManifest)) as GmailAddOnManifest; // ignore: deprecated_member_use
  ...
  @$pb.TagNumber(14)
  set homepageTrigger($0.HomepageExtensionPoint v) { setField(14, v); }
  @$pb.TagNumber(14)
...
class UniversalAction extends $pb.GeneratedMessage {
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'UniversalAction', package: const $pb.PackageName(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'google.apps.script.type.gmail'), createEmptyInstance: create)
    ..oo(0, [2, 3])
  ...
  'Use [GeneratedMessageGenericExtensions.rebuild] instead. '
  'Will be removed in next major version')
  UniversalAction copyWith(void Function(UniversalAction) updates) => super.copyWith((message) => updates(message as UniversalAction)) as UniversalAction; // ignore: deprecated_member_use
  $pb.BuilderInfo get info_ => _i;
  @$core.pragma('dart2js:noInline')
...
class ComposeTrigger extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'ComposeTrigger', package: const $pb.PackageName(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'google.apps.script.type.gmail'), createEmptyInstance: create)
    ..e<ComposeTrigger_DraftAccess>(4, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'draftAccess', $pb.PbFieldType.OE, defaultOrMaker: ComposeTrigger_DraftAccess.UNSPECIFIED, valueOf: ComposeTrigger_DraftAccess.valueOf, enumValues: ComposeTrigger_DraftAccess.values)
    ..pc<$0.MenuItemExtensionPoint>(5, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'actions', $pb.PbFieldType.PM, subBuilder: $0.MenuItemExtensionPoint.create)
    ..hasRequiredFields = false
  ;
  ...
  'Use [GeneratedMessageGenericExtensions.rebuild] instead. '
  'Will be removed in next major version')
  ComposeTrigger copyWith(void Function(ComposeTrigger) updates) => super.copyWith((message) => updates(message as ComposeTrigger)) as ComposeTrigger; // ignore: deprecated_member_use
  $pb.BuilderInfo get info_ => _i;
  @$core.pragma('dart2js:noInline')
...
class ContextualTrigger extends $pb.GeneratedMessage {
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'ContextualTrigger', package: const $pb.PackageName(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'google.apps.script.type.gmail'), createEmptyInstance: create)
    ..oo(0, [1])
    ..aOM<UnconditionalTrigger>(1, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'unconditional', subBuilder: UnconditionalTrigger.create)
    ..aOS(4, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'onTriggerFunction')
    ..hasRequiredFields = false
  ;
  ...
  'Use [GeneratedMessageGenericExtensions.rebuild] instead. '
  'Will be removed in next major version')
  ContextualTrigger copyWith(void Function(ContextualTrigger) updates) => super.copyWith((message) => updates(message as ContextualTrigger)) as ContextualTrigger; // ignore: deprecated_member_use
  $pb.BuilderInfo get info_ => _i;
  @$core.pragma('dart2js:noInline')
...
class UnconditionalTrigger extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'UnconditionalTrigger', package: const $pb.PackageName(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'google.apps.script.type.gmail'), createEmptyInstance: create)
    ..hasRequiredFields = false
  ;
  ...
  'Use [GeneratedMessageGenericExtensions.rebuild] instead. '
  'Will be removed in next major version')
  UnconditionalTrigger copyWith(void Function(UnconditionalTrigger) updates) => super.copyWith((message) => updates(message as UnconditionalTrigger)) as UnconditionalTrigger; // ignore: deprecated_member_use
  $pb.BuilderInfo get info_ => _i;
  @$core.pragma('dart2js:noInline')

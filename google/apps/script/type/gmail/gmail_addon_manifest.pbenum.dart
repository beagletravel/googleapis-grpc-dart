...
class ComposeTrigger_DraftAccess extends $pb.ProtobufEnum {
  static const ComposeTrigger_DraftAccess UNSPECIFIED = ComposeTrigger_DraftAccess._(0, const $core.bool.fromEnvironment('protobuf.omit_enum_names') ? '' : 'UNSPECIFIED');
  static const ComposeTrigger_DraftAccess NONE = ComposeTrigger_DraftAccess._(1, const $core.bool.fromEnvironment('protobuf.omit_enum_names') ? '' : 'NONE');
  static const ComposeTrigger_DraftAccess METADATA = ComposeTrigger_DraftAccess._(2, const $core.bool.fromEnvironment('protobuf.omit_enum_names') ? '' : 'METADATA');

...
class TopologyConfig extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'TopologyConfig', package: const $pb.PackageName(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'google.dataflow.v1beta3'), createEmptyInstance: create)
    ..pc<ComputationTopology>(1, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'computations', $pb.PbFieldType.PM, subBuilder: ComputationTopology.create)
    ..pc<DataDiskAssignment>(2, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'dataDiskAssignments', $pb.PbFieldType.PM, subBuilder: DataDiskAssignment.create)
    ..m<$core.String, $core.String>(3, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'userStageToComputationNameMap', entryClassName: 'TopologyConfig.UserStageToComputationNameMapEntry', keyFieldType: $pb.PbFieldType.OS, valueFieldType: $pb.PbFieldType.OS, packageName: const $pb.PackageName('google.dataflow.v1beta3'))
    ..a<$core.int>(4, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'forwardingKeyBits', $pb.PbFieldType.O3)
    ..a<$core.int>(5, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'persistentStateVersion', $pb.PbFieldType.O3)
  ...
  factory TopologyConfig({
    ...
    if (userStageToComputationNameMap != null) {
      _result.userStageToComputationNameMap.addAll(userStageToComputationNameMap);
    }
  ...
  'Will be removed in next major version')
  TopologyConfig copyWith(void Function(TopologyConfig) updates) => super.copyWith((message) => updates(message as TopologyConfig)) as TopologyConfig; // ignore: deprecated_member_use
...
class PubsubLocation extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'PubsubLocation', package: const $pb.PackageName(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'google.dataflow.v1beta3'), createEmptyInstance: create)
    ...
    ..aOS(3, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'timestampLabel')
    ..aOS(4, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'idLabel')
    ..aOB(5, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'dropLateData')
    ..aOS(6, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'trackingSubscription')
    ..aOB(7, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'withAttributes')
    ..hasRequiredFields = false
  ;
  ...
  'Use [GeneratedMessageGenericExtensions.rebuild] instead. '
  'Will be removed in next major version')
  PubsubLocation copyWith(void Function(PubsubLocation) updates) => super.copyWith((message) => updates(message as PubsubLocation)) as PubsubLocation; // ignore: deprecated_member_use
  $pb.BuilderInfo get info_ => _i;
  @$core.pragma('dart2js:noInline')
...
class StreamingStageLocation extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'StreamingStageLocation', package: const $pb.PackageName(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'google.dataflow.v1beta3'), createEmptyInstance: create)
  ...
  'Use [GeneratedMessageGenericExtensions.rebuild] instead. '
  'Will be removed in next major version')
  StreamingStageLocation copyWith(void Function(StreamingStageLocation) updates) => super.copyWith((message) => updates(message as StreamingStageLocation)) as StreamingStageLocation; // ignore: deprecated_member_use
  $pb.BuilderInfo get info_ => _i;
  @$core.pragma('dart2js:noInline')
...
class StreamingSideInputLocation extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'StreamingSideInputLocation', package: const $pb.PackageName(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'google.dataflow.v1beta3'), createEmptyInstance: create)
    ..aOS(1, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'tag')
    ..aOS(2, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'stateFamily')
    ..hasRequiredFields = false
  ;
  ...
  'Use [GeneratedMessageGenericExtensions.rebuild] instead. '
  'Will be removed in next major version')
  StreamingSideInputLocation copyWith(void Function(StreamingSideInputLocation) updates) => super.copyWith((message) => updates(message as StreamingSideInputLocation)) as StreamingSideInputLocation; // ignore: deprecated_member_use
  $pb.BuilderInfo get info_ => _i;
  @$core.pragma('dart2js:noInline')
...
class CustomSourceLocation extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'CustomSourceLocation', package: const $pb.PackageName(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'google.dataflow.v1beta3'), createEmptyInstance: create)
    ..aOB(1, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'stateful')
    ..hasRequiredFields = false
  ;
  ...
  'Use [GeneratedMessageGenericExtensions.rebuild] instead. '
  'Will be removed in next major version')
  CustomSourceLocation copyWith(void Function(CustomSourceLocation) updates) => super.copyWith((message) => updates(message as CustomSourceLocation)) as CustomSourceLocation; // ignore: deprecated_member_use
  $pb.BuilderInfo get info_ => _i;
  @$core.pragma('dart2js:noInline')
...
class StreamLocation extends $pb.GeneratedMessage {
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'StreamLocation', package: const $pb.PackageName(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'google.dataflow.v1beta3'), createEmptyInstance: create)
    ..oo(0, [1, 2, 3, 4])
    ..aOM<StreamingStageLocation>(1, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'streamingStageLocation', subBuilder: StreamingStageLocation.create)
    ..aOM<PubsubLocation>(2, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'pubsubLocation', subBuilder: PubsubLocation.create)
    ..aOM<StreamingSideInputLocation>(3, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'sideInputLocation', subBuilder: StreamingSideInputLocation.create)
    ..aOM<CustomSourceLocation>(4, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'customSourceLocation', subBuilder: CustomSourceLocation.create)
    ..hasRequiredFields = false
  ;
  ...
  'Use [GeneratedMessageGenericExtensions.rebuild] instead. '
  'Will be removed in next major version')
  StreamLocation copyWith(void Function(StreamLocation) updates) => super.copyWith((message) => updates(message as StreamLocation)) as StreamLocation; // ignore: deprecated_member_use
  $pb.BuilderInfo get info_ => _i;
  @$core.pragma('dart2js:noInline')
...
class StateFamilyConfig extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'StateFamilyConfig', package: const $pb.PackageName(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'google.dataflow.v1beta3'), createEmptyInstance: create)
    ..aOS(1, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'stateFamily')
    ..aOB(2, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'isRead')
    ..hasRequiredFields = false
  ;
  ...
  'Use [GeneratedMessageGenericExtensions.rebuild] instead. '
  'Will be removed in next major version')
  StateFamilyConfig copyWith(void Function(StateFamilyConfig) updates) => super.copyWith((message) => updates(message as StateFamilyConfig)) as StateFamilyConfig; // ignore: deprecated_member_use
  $pb.BuilderInfo get info_ => _i;
  @$core.pragma('dart2js:noInline')
...
class ComputationTopology extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'ComputationTopology', package: const $pb.PackageName(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'google.dataflow.v1beta3'), createEmptyInstance: create)
    ..aOS(1, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'systemStageName')
    ..pc<KeyRangeLocation>(2, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'keyRanges', $pb.PbFieldType.PM, subBuilder: KeyRangeLocation.create)
    ..pc<StreamLocation>(3, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'inputs', $pb.PbFieldType.PM, subBuilder: StreamLocation.create)
    ..pc<StreamLocation>(4, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'outputs', $pb.PbFieldType.PM, subBuilder: StreamLocation.create)
    ..aOS(5, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'computationId')
    ..pc<StateFamilyConfig>(7, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'stateFamilies', $pb.PbFieldType.PM, subBuilder: StateFamilyConfig.create)
    ..hasRequiredFields = false
  ;
  ...
  'Use [GeneratedMessageGenericExtensions.rebuild] instead. '
  'Will be removed in next major version')
  ComputationTopology copyWith(void Function(ComputationTopology) updates) => super.copyWith((message) => updates(message as ComputationTopology)) as ComputationTopology; // ignore: deprecated_member_use
  $pb.BuilderInfo get info_ => _i;
  @$core.pragma('dart2js:noInline')
...
class KeyRangeLocation extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'KeyRangeLocation', package: const $pb.PackageName(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'google.dataflow.v1beta3'), createEmptyInstance: create)
    ...
    ..aOS(3, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'deliveryEndpoint')
    ..aOS(4, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'deprecatedPersistentDirectory')
    ..aOS(5, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'dataDisk')
    ..hasRequiredFields = false
  ;
  ...
  'Use [GeneratedMessageGenericExtensions.rebuild] instead. '
  'Will be removed in next major version')
  KeyRangeLocation copyWith(void Function(KeyRangeLocation) updates) => super.copyWith((message) => updates(message as KeyRangeLocation)) as KeyRangeLocation; // ignore: deprecated_member_use
  $pb.BuilderInfo get info_ => _i;
  @$core.pragma('dart2js:noInline')
...
class MountedDataDisk extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'MountedDataDisk', package: const $pb.PackageName(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'google.dataflow.v1beta3'), createEmptyInstance: create)
    ..aOS(1, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'dataDisk')
    ..hasRequiredFields = false
  ;
  ...
  'Use [GeneratedMessageGenericExtensions.rebuild] instead. '
  'Will be removed in next major version')
  MountedDataDisk copyWith(void Function(MountedDataDisk) updates) => super.copyWith((message) => updates(message as MountedDataDisk)) as MountedDataDisk; // ignore: deprecated_member_use
  $pb.BuilderInfo get info_ => _i;
  @$core.pragma('dart2js:noInline')
...
class DataDiskAssignment extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'DataDiskAssignment', package: const $pb.PackageName(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'google.dataflow.v1beta3'), createEmptyInstance: create)
    ..aOS(1, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'vmInstance')
    ..pPS(2, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'dataDisks')
    ..hasRequiredFields = false
  ;
  ...
  'Use [GeneratedMessageGenericExtensions.rebuild] instead. '
  'Will be removed in next major version')
  DataDiskAssignment copyWith(void Function(DataDiskAssignment) updates) => super.copyWith((message) => updates(message as DataDiskAssignment)) as DataDiskAssignment; // ignore: deprecated_member_use
  $pb.BuilderInfo get info_ => _i;
  @$core.pragma('dart2js:noInline')
...
class KeyRangeDataDiskAssignment extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'KeyRangeDataDiskAssignment', package: const $pb.PackageName(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'google.dataflow.v1beta3'), createEmptyInstance: create)
    ..aOS(1, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'start')
    ..aOS(2, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'end')
    ..aOS(3, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'dataDisk')
    ..hasRequiredFields = false
  ;
  ...
  'Use [GeneratedMessageGenericExtensions.rebuild] instead. '
  'Will be removed in next major version')
  KeyRangeDataDiskAssignment copyWith(void Function(KeyRangeDataDiskAssignment) updates) => super.copyWith((message) => updates(message as KeyRangeDataDiskAssignment)) as KeyRangeDataDiskAssignment; // ignore: deprecated_member_use
  $pb.BuilderInfo get info_ => _i;
  @$core.pragma('dart2js:noInline')
...
class StreamingComputationRanges extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'StreamingComputationRanges', package: const $pb.PackageName(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'google.dataflow.v1beta3'), createEmptyInstance: create)
    ..aOS(1, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'computationId')
    ..pc<KeyRangeDataDiskAssignment>(2, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'rangeAssignments', $pb.PbFieldType.PM, subBuilder: KeyRangeDataDiskAssignment.create)
    ..hasRequiredFields = false
  ;
  ...
  'Use [GeneratedMessageGenericExtensions.rebuild] instead. '
  'Will be removed in next major version')
  StreamingComputationRanges copyWith(void Function(StreamingComputationRanges) updates) => super.copyWith((message) => updates(message as StreamingComputationRanges)) as StreamingComputationRanges; // ignore: deprecated_member_use
  $pb.BuilderInfo get info_ => _i;
  @$core.pragma('dart2js:noInline')
...
class StreamingApplianceSnapshotConfig extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'StreamingApplianceSnapshotConfig', package: const $pb.PackageName(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'google.dataflow.v1beta3'), createEmptyInstance: create)
    ..aOS(1, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'snapshotId')
    ..aOS(2, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'importStateEndpoint')
    ..hasRequiredFields = false
  ;
  ...
  'Use [GeneratedMessageGenericExtensions.rebuild] instead. '
  'Will be removed in next major version')
  StreamingApplianceSnapshotConfig copyWith(void Function(StreamingApplianceSnapshotConfig) updates) => super.copyWith((message) => updates(message as StreamingApplianceSnapshotConfig)) as StreamingApplianceSnapshotConfig; // ignore: deprecated_member_use
  $pb.BuilderInfo get info_ => _i;
  @$core.pragma('dart2js:noInline')

...
class Environment extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'Environment', package: const $pb.PackageName(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'google.dataflow.v1beta3'), createEmptyInstance: create)
    ..aOS(1, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'tempStoragePrefix')
    ..aOS(2, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'clusterManagerApiService')
    ..pPS(3, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'experiments')
    ..pc<WorkerPool>(4, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'workerPools', $pb.PbFieldType.PM, subBuilder: WorkerPool.create)
    ..aOM<$0.Struct>(5, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'userAgent', subBuilder: $0.Struct.create)
    ..aOM<$0.Struct>(6, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'version', subBuilder: $0.Struct.create)
    ..aOS(7, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'dataset')
    ..aOM<$0.Struct>(8, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'sdkPipelineOptions', subBuilder: $0.Struct.create)
    ..aOM<$1.Any>(9, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'internalExperiments', subBuilder: $1.Any.create)
    ..aOS(10, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'serviceAccountEmail')
    ..e<FlexResourceSchedulingGoal>(11, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'flexResourceSchedulingGoal', $pb.PbFieldType.OE, defaultOrMaker: FlexResourceSchedulingGoal.FLEXRS_UNSPECIFIED, valueOf: FlexResourceSchedulingGoal.valueOf, enumValues: FlexResourceSchedulingGoal.values)
    ..aOS(12, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'serviceKmsKeyName')
    ...
    ..e<ShuffleMode>(15, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'shuffleMode', $pb.PbFieldType.OE, defaultOrMaker: ShuffleMode.SHUFFLE_MODE_UNSPECIFIED, valueOf: ShuffleMode.valueOf, enumValues: ShuffleMode.values)
    ..pPS(16, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'serviceOptions')
    ..aOM<DebugOptions>(17, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'debugOptions', subBuilder: DebugOptions.create)
  ...
  @$pb.TagNumber(9)
  set internalExperiments($1.Any v) { setField(9, v); }
  @$pb.TagNumber(9)
...
class Package extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'Package', package: const $pb.PackageName(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'google.dataflow.v1beta3'), createEmptyInstance: create)
...
class Disk extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'Disk', package: const $pb.PackageName(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'google.dataflow.v1beta3'), createEmptyInstance: create)
    ..a<$core.int>(1, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'sizeGb', $pb.PbFieldType.O3)
    ..aOS(2, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'diskType')
    ..aOS(3, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'mountPoint')
    ..hasRequiredFields = false
  ;
...
class WorkerSettings extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'WorkerSettings', package: const $pb.PackageName(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'google.dataflow.v1beta3'), createEmptyInstance: create)
    ..aOS(1, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'baseUrl')
    ..aOB(2, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'reportingEnabled')
    ..aOS(3, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'servicePath')
    ..aOS(4, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'shuffleServicePath')
    ..aOS(5, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'workerId')
    ..aOS(6, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'tempStoragePrefix')
    ..hasRequiredFields = false
  ;
  ...
  'Use [GeneratedMessageGenericExtensions.rebuild] instead. '
  'Will be removed in next major version')
  WorkerSettings copyWith(void Function(WorkerSettings) updates) => super.copyWith((message) => updates(message as WorkerSettings)) as WorkerSettings; // ignore: deprecated_member_use
  $pb.BuilderInfo get info_ => _i;
  @$core.pragma('dart2js:noInline')
...
class TaskRunnerSettings extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'TaskRunnerSettings', package: const $pb.PackageName(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'google.dataflow.v1beta3'), createEmptyInstance: create)
    ..aOS(1, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'taskUser')
    ..aOS(2, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'taskGroup')
    ..pPS(3, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'oauthScopes')
    ..aOS(4, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'baseUrl')
    ..aOS(5, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'dataflowApiVersion')
    ..aOM<WorkerSettings>(6, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'parallelWorkerSettings', subBuilder: WorkerSettings.create)
    ..aOS(7, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'baseTaskDir')
    ..aOB(8, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'continueOnException')
    ..aOB(9, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'logToSerialconsole')
    ..aOB(10, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'alsologtostderr')
    ..aOS(11, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'logUploadLocation')
    ..aOS(12, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'logDir')
    ..aOS(13, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'tempStoragePrefix')
    ..aOS(14, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'harnessCommand')
    ..aOS(15, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'workflowFileName')
    ..aOS(16, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'commandlinesFileName')
    ..aOS(17, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'vmId')
    ..aOS(18, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'languageHint')
    ..aOS(19, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'streamingWorkerMainClass')
    ..hasRequiredFields = false
  ;
  ...
  'Use [GeneratedMessageGenericExtensions.rebuild] instead. '
  'Will be removed in next major version')
  TaskRunnerSettings copyWith(void Function(TaskRunnerSettings) updates) => super.copyWith((message) => updates(message as TaskRunnerSettings)) as TaskRunnerSettings; // ignore: deprecated_member_use
  $pb.BuilderInfo get info_ => _i;
  @$core.pragma('dart2js:noInline')
...
class AutoscalingSettings extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'AutoscalingSettings', package: const $pb.PackageName(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'google.dataflow.v1beta3'), createEmptyInstance: create)
    ..e<AutoscalingAlgorithm>(1, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'algorithm', $pb.PbFieldType.OE, defaultOrMaker: AutoscalingAlgorithm.AUTOSCALING_ALGORITHM_UNKNOWN, valueOf: AutoscalingAlgorithm.valueOf, enumValues: AutoscalingAlgorithm.values)
    ..a<$core.int>(2, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'maxNumWorkers', $pb.PbFieldType.O3)
    ..hasRequiredFields = false
  ;
  ...
  'Use [GeneratedMessageGenericExtensions.rebuild] instead. '
  'Will be removed in next major version')
  AutoscalingSettings copyWith(void Function(AutoscalingSettings) updates) => super.copyWith((message) => updates(message as AutoscalingSettings)) as AutoscalingSettings; // ignore: deprecated_member_use
  $pb.BuilderInfo get info_ => _i;
  @$core.pragma('dart2js:noInline')
...
class SdkHarnessContainerImage extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'SdkHarnessContainerImage', package: const $pb.PackageName(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'google.dataflow.v1beta3'), createEmptyInstance: create)
    ..aOS(1, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'containerImage')
    ..aOB(2, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'useSingleCorePerContainer')
    ..aOS(3, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'environmentId')
    ..pPS(4, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'capabilities')
    ..hasRequiredFields = false
  ;
  ...
  'Use [GeneratedMessageGenericExtensions.rebuild] instead. '
  'Will be removed in next major version')
  SdkHarnessContainerImage copyWith(void Function(SdkHarnessContainerImage) updates) => super.copyWith((message) => updates(message as SdkHarnessContainerImage)) as SdkHarnessContainerImage; // ignore: deprecated_member_use
  $pb.BuilderInfo get info_ => _i;
  @$core.pragma('dart2js:noInline')
...
class WorkerPool extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'WorkerPool', package: const $pb.PackageName(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'google.dataflow.v1beta3'), createEmptyInstance: create)
    ..aOS(1, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'kind')
    ..a<$core.int>(2, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'numWorkers', $pb.PbFieldType.O3)
    ...
    ..e<DefaultPackageSet>(4, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'defaultPackageSet', $pb.PbFieldType.OE, defaultOrMaker: DefaultPackageSet.DEFAULT_PACKAGE_SET_UNKNOWN, valueOf: DefaultPackageSet.valueOf, enumValues: DefaultPackageSet.values)
    ..aOS(5, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'machineType')
    ..e<TeardownPolicy>(6, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'teardownPolicy', $pb.PbFieldType.OE, defaultOrMaker: TeardownPolicy.TEARDOWN_POLICY_UNKNOWN, valueOf: TeardownPolicy.valueOf, enumValues: TeardownPolicy.values)
    ..a<$core.int>(7, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'diskSizeGb', $pb.PbFieldType.O3)
    ..aOS(8, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'diskSourceImage')
    ..aOS(9, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'zone')
    ..aOM<TaskRunnerSettings>(10, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'taskrunnerSettings', subBuilder: TaskRunnerSettings.create)
    ..aOS(11, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'onHostMaintenance')
    ..pc<Disk>(12, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'dataDisks', $pb.PbFieldType.PM, subBuilder: Disk.create)
    ..m<$core.String, $core.String>(13, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'metadata', entryClassName: 'WorkerPool.MetadataEntry', keyFieldType: $pb.PbFieldType.OS, valueFieldType: $pb.PbFieldType.OS, packageName: const $pb.PackageName('google.dataflow.v1beta3'))
    ..aOM<AutoscalingSettings>(14, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'autoscalingSettings', subBuilder: AutoscalingSettings.create)
    ..aOM<$1.Any>(15, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'poolArgs', subBuilder: $1.Any.create)
    ..aOS(16, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'diskType')
    ..aOS(17, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'network')
    ..aOS(18, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'workerHarnessContainerImage')
    ..aOS(19, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'subnetwork')
    ..a<$core.int>(20, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'numThreadsPerWorker', $pb.PbFieldType.O3)
    ..e<WorkerIPAddressConfiguration>(21, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'ipConfiguration', $pb.PbFieldType.OE, defaultOrMaker: WorkerIPAddressConfiguration.WORKER_IP_UNSPECIFIED, valueOf: WorkerIPAddressConfiguration.valueOf, enumValues: WorkerIPAddressConfiguration.values)
    ..pc<SdkHarnessContainerImage>(22, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'sdkHarnessContainerImages', $pb.PbFieldType.PM, subBuilder: SdkHarnessContainerImage.create)
    ..hasRequiredFields = false
  ;
  ...
  @$pb.TagNumber(15)
  set poolArgs($1.Any v) { setField(15, v); }
  @$pb.TagNumber(15)
...
class DebugOptions extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'DebugOptions', package: const $pb.PackageName(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'google.dataflow.v1beta3'), createEmptyInstance: create)
    ..aOB(1, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'enableHotKeyLogging')
    ..hasRequiredFields = false
  ;
  ...
  'Use [GeneratedMessageGenericExtensions.rebuild] instead. '
  'Will be removed in next major version')
  DebugOptions copyWith(void Function(DebugOptions) updates) => super.copyWith((message) => updates(message as DebugOptions)) as DebugOptions; // ignore: deprecated_member_use
  $pb.BuilderInfo get info_ => _i;
  @$core.pragma('dart2js:noInline')

...
class LaunchFlexTemplateResponse extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'LaunchFlexTemplateResponse', package: const $pb.PackageName(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'google.dataflow.v1beta3'), createEmptyInstance: create)
    ..aOM<$1.Job>(1, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'job', subBuilder: $1.Job.create)
  ...
  'Will be removed in next major version')
  LaunchFlexTemplateResponse copyWith(void Function(LaunchFlexTemplateResponse) updates) => super.copyWith((message) => updates(message as LaunchFlexTemplateResponse)) as LaunchFlexTemplateResponse; // ignore: deprecated_member_use
...
class ContainerSpec extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'ContainerSpec', package: const $pb.PackageName(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'google.dataflow.v1beta3'), createEmptyInstance: create)
    ..aOS(1, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'image')
    ..aOM<TemplateMetadata>(2, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'metadata', subBuilder: TemplateMetadata.create)
    ..aOM<SDKInfo>(3, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'sdkInfo', subBuilder: SDKInfo.create)
    ..aOM<FlexTemplateRuntimeEnvironment>(4, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'defaultEnvironment', subBuilder: FlexTemplateRuntimeEnvironment.create)
    ..hasRequiredFields = false
  ;
  ...
  'Use [GeneratedMessageGenericExtensions.rebuild] instead. '
  'Will be removed in next major version')
  ContainerSpec copyWith(void Function(ContainerSpec) updates) => super.copyWith((message) => updates(message as ContainerSpec)) as ContainerSpec; // ignore: deprecated_member_use
  $pb.BuilderInfo get info_ => _i;
  @$core.pragma('dart2js:noInline')
...
class LaunchFlexTemplateParameter extends $pb.GeneratedMessage {
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'LaunchFlexTemplateParameter', package: const $pb.PackageName(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'google.dataflow.v1beta3'), createEmptyInstance: create)
    ..oo(0, [4, 5])
    ..aOS(1, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'jobName')
    ..m<$core.String, $core.String>(2, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'parameters', entryClassName: 'LaunchFlexTemplateParameter.ParametersEntry', keyFieldType: $pb.PbFieldType.OS, valueFieldType: $pb.PbFieldType.OS, packageName: const $pb.PackageName('google.dataflow.v1beta3'))
    ..aOM<ContainerSpec>(4, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'containerSpec', subBuilder: ContainerSpec.create)
    ..aOS(5, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'containerSpecGcsPath')
    ..m<$core.String, $core.String>(6, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'launchOptions', entryClassName: 'LaunchFlexTemplateParameter.LaunchOptionsEntry', keyFieldType: $pb.PbFieldType.OS, valueFieldType: $pb.PbFieldType.OS, packageName: const $pb.PackageName('google.dataflow.v1beta3'))
    ..aOM<FlexTemplateRuntimeEnvironment>(7, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'environment', subBuilder: FlexTemplateRuntimeEnvironment.create)
    ..aOB(8, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'update')
    ..m<$core.String, $core.String>(9, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'transformNameMappings', entryClassName: 'LaunchFlexTemplateParameter.TransformNameMappingsEntry', keyFieldType: $pb.PbFieldType.OS, valueFieldType: $pb.PbFieldType.OS, packageName: const $pb.PackageName('google.dataflow.v1beta3'))
    ..hasRequiredFields = false
  ;
  ...
  'Use [GeneratedMessageGenericExtensions.rebuild] instead. '
  'Will be removed in next major version')
  LaunchFlexTemplateParameter copyWith(void Function(LaunchFlexTemplateParameter) updates) => super.copyWith((message) => updates(message as LaunchFlexTemplateParameter)) as LaunchFlexTemplateParameter; // ignore: deprecated_member_use
  $pb.BuilderInfo get info_ => _i;
  @$core.pragma('dart2js:noInline')
...
class FlexTemplateRuntimeEnvironment extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'FlexTemplateRuntimeEnvironment', package: const $pb.PackageName(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'google.dataflow.v1beta3'), createEmptyInstance: create)
    ..a<$core.int>(1, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'numWorkers', $pb.PbFieldType.O3)
    ..a<$core.int>(2, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'maxWorkers', $pb.PbFieldType.O3)
    ...
    ..aOS(5, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'tempLocation')
    ..aOS(6, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'machineType')
    ..pPS(7, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'additionalExperiments')
    ..aOS(8, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'network')
    ..aOS(9, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'subnetwork')
    ..m<$core.String, $core.String>(10, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'additionalUserLabels', entryClassName: 'FlexTemplateRuntimeEnvironment.AdditionalUserLabelsEntry', keyFieldType: $pb.PbFieldType.OS, valueFieldType: $pb.PbFieldType.OS, packageName: const $pb.PackageName('google.dataflow.v1beta3'))
    ..aOS(11, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'kmsKeyName')
    ..e<$4.WorkerIPAddressConfiguration>(12, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'ipConfiguration', $pb.PbFieldType.OE, defaultOrMaker: $4.WorkerIPAddressConfiguration.WORKER_IP_UNSPECIFIED, valueOf: $4.WorkerIPAddressConfiguration.valueOf, enumValues: $4.WorkerIPAddressConfiguration.values)
    ..aOS(13, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'workerRegion')
    ..aOS(14, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'workerZone')
    ..aOB(15, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'enableStreamingEngine')
    ..e<$4.FlexResourceSchedulingGoal>(16, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'flexrsGoal', $pb.PbFieldType.OE, defaultOrMaker: $4.FlexResourceSchedulingGoal.FLEXRS_UNSPECIFIED, valueOf: $4.FlexResourceSchedulingGoal.valueOf, enumValues: $4.FlexResourceSchedulingGoal.values)
    ..aOS(17, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'stagingLocation')
    ..aOS(18, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'sdkContainerImage')
    ..a<$core.int>(20, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'diskSizeGb', $pb.PbFieldType.O3)
    ..e<$4.AutoscalingAlgorithm>(21, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'autoscalingAlgorithm', $pb.PbFieldType.OE, defaultOrMaker: $4.AutoscalingAlgorithm.AUTOSCALING_ALGORITHM_UNKNOWN, valueOf: $4.AutoscalingAlgorithm.valueOf, enumValues: $4.AutoscalingAlgorithm.values)
    ..aOB(22, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'dumpHeapOnOom')
    ..aOS(23, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'saveHeapDumpsToGcsPath')
    ..aOS(24, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'launcherMachineType')
    ..hasRequiredFields = false
  ;
  ...
  'Use [GeneratedMessageGenericExtensions.rebuild] instead. '
  'Will be removed in next major version')
  FlexTemplateRuntimeEnvironment copyWith(void Function(FlexTemplateRuntimeEnvironment) updates) => super.copyWith((message) => updates(message as FlexTemplateRuntimeEnvironment)) as FlexTemplateRuntimeEnvironment; // ignore: deprecated_member_use
  $pb.BuilderInfo get info_ => _i;
  @$core.pragma('dart2js:noInline')
  ...
  @$pb.TagNumber(12)
  set ipConfiguration($4.WorkerIPAddressConfiguration v) { setField(12, v); }
  @$pb.TagNumber(12)
  ...
  @$pb.TagNumber(16)
  set flexrsGoal($4.FlexResourceSchedulingGoal v) { setField(16, v); }
  @$pb.TagNumber(16)
  ...
  @$pb.TagNumber(21)
  set autoscalingAlgorithm($4.AutoscalingAlgorithm v) { setField(21, v); }
  @$pb.TagNumber(21)
...
class LaunchFlexTemplateRequest extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'LaunchFlexTemplateRequest', package: const $pb.PackageName(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'google.dataflow.v1beta3'), createEmptyInstance: create)
    ..aOS(1, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'projectId')
    ..aOM<LaunchFlexTemplateParameter>(2, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'launchParameter', subBuilder: LaunchFlexTemplateParameter.create)
  ...
  'Use [GeneratedMessageGenericExtensions.rebuild] instead. '
  'Will be removed in next major version')
  LaunchFlexTemplateRequest copyWith(void Function(LaunchFlexTemplateRequest) updates) => super.copyWith((message) => updates(message as LaunchFlexTemplateRequest)) as LaunchFlexTemplateRequest; // ignore: deprecated_member_use
  $pb.BuilderInfo get info_ => _i;
  @$core.pragma('dart2js:noInline')
...
class RuntimeEnvironment extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'RuntimeEnvironment', package: const $pb.PackageName(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'google.dataflow.v1beta3'), createEmptyInstance: create)
    ..a<$core.int>(1, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'maxWorkers', $pb.PbFieldType.O3)
    ...
    ..aOS(4, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'tempLocation')
    ..aOB(5, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'bypassTempDirValidation')
    ..aOS(6, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'machineType')
    ..pPS(7, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'additionalExperiments')
    ..aOS(8, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'network')
    ..aOS(9, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'subnetwork')
    ..m<$core.String, $core.String>(10, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'additionalUserLabels', entryClassName: 'RuntimeEnvironment.AdditionalUserLabelsEntry', keyFieldType: $pb.PbFieldType.OS, valueFieldType: $pb.PbFieldType.OS, packageName: const $pb.PackageName('google.dataflow.v1beta3'))
    ..a<$core.int>(11, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'numWorkers', $pb.PbFieldType.O3)
    ..aOS(12, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'kmsKeyName')
    ..e<$4.WorkerIPAddressConfiguration>(14, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'ipConfiguration', $pb.PbFieldType.OE, defaultOrMaker: $4.WorkerIPAddressConfiguration.WORKER_IP_UNSPECIFIED, valueOf: $4.WorkerIPAddressConfiguration.valueOf, enumValues: $4.WorkerIPAddressConfiguration.values)
    ..aOS(15, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'workerRegion')
    ..aOS(16, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'workerZone')
    ..aOB(17, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'enableStreamingEngine')
    ..hasRequiredFields = false
  ;
  ...
  'Use [GeneratedMessageGenericExtensions.rebuild] instead. '
  'Will be removed in next major version')
  RuntimeEnvironment copyWith(void Function(RuntimeEnvironment) updates) => super.copyWith((message) => updates(message as RuntimeEnvironment)) as RuntimeEnvironment; // ignore: deprecated_member_use
  $pb.BuilderInfo get info_ => _i;
  @$core.pragma('dart2js:noInline')
  ...
  @$pb.TagNumber(14)
  set ipConfiguration($4.WorkerIPAddressConfiguration v) { setField(14, v); }
  @$pb.TagNumber(14)
...
class ParameterMetadata extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'ParameterMetadata', package: const $pb.PackageName(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'google.dataflow.v1beta3'), createEmptyInstance: create)
    ..aOS(1, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'name')
    ..aOS(2, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'label')
    ..aOS(3, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'helpText')
    ..aOB(4, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'isOptional')
    ..pPS(5, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'regexes')
    ..e<ParameterType>(6, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'paramType', $pb.PbFieldType.OE, defaultOrMaker: ParameterType.DEFAULT, valueOf: ParameterType.valueOf, enumValues: ParameterType.values)
    ..m<$core.String, $core.String>(7, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'customMetadata', entryClassName: 'ParameterMetadata.CustomMetadataEntry', keyFieldType: $pb.PbFieldType.OS, valueFieldType: $pb.PbFieldType.OS, packageName: const $pb.PackageName('google.dataflow.v1beta3'))
    ..hasRequiredFields = false
  ;
  ...
  'Use [GeneratedMessageGenericExtensions.rebuild] instead. '
  'Will be removed in next major version')
  ParameterMetadata copyWith(void Function(ParameterMetadata) updates) => super.copyWith((message) => updates(message as ParameterMetadata)) as ParameterMetadata; // ignore: deprecated_member_use
  $pb.BuilderInfo get info_ => _i;
  @$core.pragma('dart2js:noInline')
...
class TemplateMetadata extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'TemplateMetadata', package: const $pb.PackageName(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'google.dataflow.v1beta3'), createEmptyInstance: create)
    ..aOS(1, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'name')
    ..aOS(2, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'description')
    ..pc<ParameterMetadata>(3, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'parameters', $pb.PbFieldType.PM, subBuilder: ParameterMetadata.create)
    ..hasRequiredFields = false
  ;
  ...
  'Use [GeneratedMessageGenericExtensions.rebuild] instead. '
  'Will be removed in next major version')
  TemplateMetadata copyWith(void Function(TemplateMetadata) updates) => super.copyWith((message) => updates(message as TemplateMetadata)) as TemplateMetadata; // ignore: deprecated_member_use
  $pb.BuilderInfo get info_ => _i;
  @$core.pragma('dart2js:noInline')
...
class SDKInfo extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'SDKInfo', package: const $pb.PackageName(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'google.dataflow.v1beta3'), createEmptyInstance: create)
    ..e<SDKInfo_Language>(1, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'language', $pb.PbFieldType.OE, defaultOrMaker: SDKInfo_Language.UNKNOWN, valueOf: SDKInfo_Language.valueOf, enumValues: SDKInfo_Language.values)
  ...
  'Use [GeneratedMessageGenericExtensions.rebuild] instead. '
  'Will be removed in next major version')
  SDKInfo copyWith(void Function(SDKInfo) updates) => super.copyWith((message) => updates(message as SDKInfo)) as SDKInfo; // ignore: deprecated_member_use
  $pb.BuilderInfo get info_ => _i;
  @$core.pragma('dart2js:noInline')
...
class RuntimeMetadata extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'RuntimeMetadata', package: const $pb.PackageName(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'google.dataflow.v1beta3'), createEmptyInstance: create)
    ..aOM<SDKInfo>(1, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'sdkInfo', subBuilder: SDKInfo.create)
    ..pc<ParameterMetadata>(2, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'parameters', $pb.PbFieldType.PM, subBuilder: ParameterMetadata.create)
    ..hasRequiredFields = false
  ;
  ...
  'Use [GeneratedMessageGenericExtensions.rebuild] instead. '
  'Will be removed in next major version')
  RuntimeMetadata copyWith(void Function(RuntimeMetadata) updates) => super.copyWith((message) => updates(message as RuntimeMetadata)) as RuntimeMetadata; // ignore: deprecated_member_use
  $pb.BuilderInfo get info_ => _i;
  @$core.pragma('dart2js:noInline')
...
class CreateJobFromTemplateRequest extends $pb.GeneratedMessage {
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'CreateJobFromTemplateRequest', package: const $pb.PackageName(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'google.dataflow.v1beta3'), createEmptyInstance: create)
    ..oo(0, [2])
    ..aOS(1, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'projectId')
    ..aOS(2, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'gcsPath')
    ..m<$core.String, $core.String>(3, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'parameters', entryClassName: 'CreateJobFromTemplateRequest.ParametersEntry', keyFieldType: $pb.PbFieldType.OS, valueFieldType: $pb.PbFieldType.OS, packageName: const $pb.PackageName('google.dataflow.v1beta3'))
    ..aOS(4, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'jobName')
    ..aOM<RuntimeEnvironment>(5, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'environment', subBuilder: RuntimeEnvironment.create)
  ...
  'Use [GeneratedMessageGenericExtensions.rebuild] instead. '
  'Will be removed in next major version')
  CreateJobFromTemplateRequest copyWith(void Function(CreateJobFromTemplateRequest) updates) => super.copyWith((message) => updates(message as CreateJobFromTemplateRequest)) as CreateJobFromTemplateRequest; // ignore: deprecated_member_use
  $pb.BuilderInfo get info_ => _i;
  @$core.pragma('dart2js:noInline')
...
class GetTemplateRequest extends $pb.GeneratedMessage {
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'GetTemplateRequest', package: const $pb.PackageName(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'google.dataflow.v1beta3'), createEmptyInstance: create)
    ..oo(0, [2])
    ..aOS(1, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'projectId')
    ..aOS(2, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'gcsPath')
    ..e<GetTemplateRequest_TemplateView>(3, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'view', $pb.PbFieldType.OE, defaultOrMaker: GetTemplateRequest_TemplateView.METADATA_ONLY, valueOf: GetTemplateRequest_TemplateView.valueOf, enumValues: GetTemplateRequest_TemplateView.values)
...
class GetTemplateResponse extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'GetTemplateResponse', package: const $pb.PackageName(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'google.dataflow.v1beta3'), createEmptyInstance: create)
    ..aOM<$3.Status>(1, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'status', subBuilder: $3.Status.create)
    ..aOM<TemplateMetadata>(2, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'metadata', subBuilder: TemplateMetadata.create)
    ..e<GetTemplateResponse_TemplateType>(3, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'templateType', $pb.PbFieldType.OE, defaultOrMaker: GetTemplateResponse_TemplateType.UNKNOWN, valueOf: GetTemplateResponse_TemplateType.valueOf, enumValues: GetTemplateResponse_TemplateType.values)
    ..aOM<RuntimeMetadata>(4, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'runtimeMetadata', subBuilder: RuntimeMetadata.create)
    ..hasRequiredFields = false
  ;
...
class LaunchTemplateParameters extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'LaunchTemplateParameters', package: const $pb.PackageName(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'google.dataflow.v1beta3'), createEmptyInstance: create)
    ..aOS(1, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'jobName')
    ..m<$core.String, $core.String>(2, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'parameters', entryClassName: 'LaunchTemplateParameters.ParametersEntry', keyFieldType: $pb.PbFieldType.OS, valueFieldType: $pb.PbFieldType.OS, packageName: const $pb.PackageName('google.dataflow.v1beta3'))
    ..aOM<RuntimeEnvironment>(3, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'environment', subBuilder: RuntimeEnvironment.create)
    ..aOB(4, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'update')
    ..m<$core.String, $core.String>(5, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'transformNameMapping', entryClassName: 'LaunchTemplateParameters.TransformNameMappingEntry', keyFieldType: $pb.PbFieldType.OS, valueFieldType: $pb.PbFieldType.OS, packageName: const $pb.PackageName('google.dataflow.v1beta3'))
    ..hasRequiredFields = false
  ;
  ...
  'Use [GeneratedMessageGenericExtensions.rebuild] instead. '
  'Will be removed in next major version')
  LaunchTemplateParameters copyWith(void Function(LaunchTemplateParameters) updates) => super.copyWith((message) => updates(message as LaunchTemplateParameters)) as LaunchTemplateParameters; // ignore: deprecated_member_use
  $pb.BuilderInfo get info_ => _i;
  @$core.pragma('dart2js:noInline')
...
class LaunchTemplateRequest extends $pb.GeneratedMessage {
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'LaunchTemplateRequest', package: const $pb.PackageName(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'google.dataflow.v1beta3'), createEmptyInstance: create)
    ..oo(0, [3, 6])
    ..aOS(1, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'projectId')
    ..aOB(2, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'validateOnly')
    ..aOS(3, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'gcsPath')
    ..aOM<LaunchTemplateParameters>(4, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'launchParameters', subBuilder: LaunchTemplateParameters.create)
    ..aOS(5, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'location')
    ..aOM<DynamicTemplateLaunchParams>(6, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'dynamicTemplate', subBuilder: DynamicTemplateLaunchParams.create)
    ..hasRequiredFields = false
  ;
  ...
  'Use [GeneratedMessageGenericExtensions.rebuild] instead. '
  'Will be removed in next major version')
  LaunchTemplateRequest copyWith(void Function(LaunchTemplateRequest) updates) => super.copyWith((message) => updates(message as LaunchTemplateRequest)) as LaunchTemplateRequest; // ignore: deprecated_member_use
  $pb.BuilderInfo get info_ => _i;
  @$core.pragma('dart2js:noInline')
...
class LaunchTemplateResponse extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'LaunchTemplateResponse', package: const $pb.PackageName(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'google.dataflow.v1beta3'), createEmptyInstance: create)
    ..aOM<$1.Job>(1, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'job', subBuilder: $1.Job.create)
    ..hasRequiredFields = false
  ;
  ...
  'Use [GeneratedMessageGenericExtensions.rebuild] instead. '
  'Will be removed in next major version')
  LaunchTemplateResponse copyWith(void Function(LaunchTemplateResponse) updates) => super.copyWith((message) => updates(message as LaunchTemplateResponse)) as LaunchTemplateResponse; // ignore: deprecated_member_use
  $pb.BuilderInfo get info_ => _i;
  @$core.pragma('dart2js:noInline')
...
class InvalidTemplateParameters_ParameterViolation extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'InvalidTemplateParameters.ParameterViolation', package: const $pb.PackageName(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'google.dataflow.v1beta3'), createEmptyInstance: create)
    ..aOS(1, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'parameter')
    ..aOS(2, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'description')
    ..hasRequiredFields = false
  ;
  ...
  'Use [GeneratedMessageGenericExtensions.rebuild] instead. '
  'Will be removed in next major version')
  InvalidTemplateParameters_ParameterViolation copyWith(void Function(InvalidTemplateParameters_ParameterViolation) updates) => super.copyWith((message) => updates(message as InvalidTemplateParameters_ParameterViolation)) as InvalidTemplateParameters_ParameterViolation; // ignore: deprecated_member_use
  $pb.BuilderInfo get info_ => _i;
  @$core.pragma('dart2js:noInline')
...
class InvalidTemplateParameters extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'InvalidTemplateParameters', package: const $pb.PackageName(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'google.dataflow.v1beta3'), createEmptyInstance: create)
    ..pc<InvalidTemplateParameters_ParameterViolation>(1, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'parameterViolations', $pb.PbFieldType.PM, subBuilder: InvalidTemplateParameters_ParameterViolation.create)
    ..hasRequiredFields = false
  ;
  ...
  'Use [GeneratedMessageGenericExtensions.rebuild] instead. '
  'Will be removed in next major version')
  InvalidTemplateParameters copyWith(void Function(InvalidTemplateParameters) updates) => super.copyWith((message) => updates(message as InvalidTemplateParameters)) as InvalidTemplateParameters; // ignore: deprecated_member_use
  $pb.BuilderInfo get info_ => _i;
  @$core.pragma('dart2js:noInline')
...
class DynamicTemplateLaunchParams extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'DynamicTemplateLaunchParams', package: const $pb.PackageName(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'google.dataflow.v1beta3'), createEmptyInstance: create)
    ..aOS(1, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'gcsPath')
    ..aOS(2, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'stagingLocation')
    ..hasRequiredFields = false
  ;
  ...
  'Use [GeneratedMessageGenericExtensions.rebuild] instead. '
  'Will be removed in next major version')
  DynamicTemplateLaunchParams copyWith(void Function(DynamicTemplateLaunchParams) updates) => super.copyWith((message) => updates(message as DynamicTemplateLaunchParams)) as DynamicTemplateLaunchParams; // ignore: deprecated_member_use
  $pb.BuilderInfo get info_ => _i;
  @$core.pragma('dart2js:noInline')

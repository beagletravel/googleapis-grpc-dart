...
class DateTimeRange extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'DateTimeRange', package: const $pb.PackageName(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'google.actions.type'), createEmptyInstance: create)
    ..aOM<$0.DateTime>(1, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'start', subBuilder: $0.DateTime.create)
    ..aOM<$0.DateTime>(2, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'end', subBuilder: $0.DateTime.create)
  ...
  'Will be removed in next major version')
  DateTimeRange copyWith(void Function(DateTimeRange) updates) => super.copyWith((message) => updates(message as DateTimeRange)) as DateTimeRange; // ignore: deprecated_member_use
  ...
  @$pb.TagNumber(1)
  set start($0.DateTime v) { setField(1, v); }
  @$pb.TagNumber(1)
  ...
  @$pb.TagNumber(2)
  set end($0.DateTime v) { setField(2, v); }
  @$pb.TagNumber(2)

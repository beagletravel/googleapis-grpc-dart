...
class Slot extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'Slot', package: const $pb.PackageName(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'google.actions.sdk.v2.conversation'), createEmptyInstance: create)
    ..e<Slot_SlotMode>(1, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'mode', $pb.PbFieldType.OE, defaultOrMaker: Slot_SlotMode.MODE_UNSPECIFIED, valueOf: Slot_SlotMode.valueOf, enumValues: Slot_SlotMode.values)
    ..e<Slot_SlotStatus>(2, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'status', $pb.PbFieldType.OE, defaultOrMaker: Slot_SlotStatus.SLOT_UNSPECIFIED, valueOf: Slot_SlotStatus.valueOf, enumValues: Slot_SlotStatus.values)
    ...
    ..aOM<$1.Prompt>(5, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'prompt', subBuilder: $1.Prompt.create)
  ...
  @$pb.TagNumber(5)
  set prompt($1.Prompt v) { setField(5, v); }
  @$pb.TagNumber(5)

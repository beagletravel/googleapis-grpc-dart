...
class Prompt extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'Prompt', package: const $pb.PackageName(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'google.actions.sdk.v2.conversation'), createEmptyInstance: create)
    ..aOB(1, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'append')
    ..aOM<$0.Simple>(2, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'firstSimple', subBuilder: $0.Simple.create)
    ..aOM<$1.Content>(3, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'content', subBuilder: $1.Content.create)
    ..aOM<$0.Simple>(4, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'lastSimple', subBuilder: $0.Simple.create)
    ...
    ..aOM<$3.Link>(6, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'link', subBuilder: $3.Link.create)
    ..aOB(8, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'override')
    ..aOM<$4.Canvas>(9, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'canvas', subBuilder: $4.Canvas.create)
  ...
  @$pb.TagNumber(2)
  set firstSimple($0.Simple v) { setField(2, v); }
  @$pb.TagNumber(2)
  ...
  @$pb.TagNumber(4)
  set lastSimple($0.Simple v) { setField(4, v); }
  @$pb.TagNumber(4)
  ...
  @$pb.TagNumber(6)
  set link($3.Link v) { setField(6, v); }
  @$pb.TagNumber(6)
  ...
  @$pb.TagNumber(9)
  set canvas($4.Canvas v) { setField(9, v); }
  @$pb.TagNumber(9)

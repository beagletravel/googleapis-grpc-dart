...
class Collection_CollectionItem extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'Collection.CollectionItem', package: const $pb.PackageName(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'google.actions.sdk.v2.conversation'), createEmptyInstance: create)
  ...
  'Will be removed in next major version')
  Collection_CollectionItem copyWith(void Function(Collection_CollectionItem) updates) => super.copyWith((message) => updates(message as Collection_CollectionItem)) as Collection_CollectionItem; // ignore: deprecated_member_use
...
class Collection extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'Collection', package: const $pb.PackageName(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'google.actions.sdk.v2.conversation'), createEmptyInstance: create)
    ..aOS(1, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'title')
    ..aOS(2, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'subtitle')
    ..pc<Collection_CollectionItem>(3, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'items', $pb.PbFieldType.PM, subBuilder: Collection_CollectionItem.create)
    ..e<$0.Image_ImageFill>(4, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'imageFill', $pb.PbFieldType.OE, defaultOrMaker: $0.Image_ImageFill.UNSPECIFIED, valueOf: $0.Image_ImageFill.valueOf, enumValues: $0.Image_ImageFill.values)
    ..hasRequiredFields = false
  ;
  ...
  @$pb.TagNumber(4)
  set imageFill($0.Image_ImageFill v) { setField(4, v); }
  @$pb.TagNumber(4)

...
class Card extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'Card', package: const $pb.PackageName(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'google.actions.sdk.v2.conversation'), createEmptyInstance: create)
    ...
    ..e<$0.Image_ImageFill>(5, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'imageFill', $pb.PbFieldType.OE, defaultOrMaker: $0.Image_ImageFill.UNSPECIFIED, valueOf: $0.Image_ImageFill.valueOf, enumValues: $0.Image_ImageFill.values)
    ..aOM<$1.Link>(6, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'button', subBuilder: $1.Link.create)
  ...
  @$pb.TagNumber(5)
  set imageFill($0.Image_ImageFill v) { setField(5, v); }
  @$pb.TagNumber(5)
  ...
  @$pb.TagNumber(6)
  set button($1.Link v) { setField(6, v); }
  @$pb.TagNumber(6)

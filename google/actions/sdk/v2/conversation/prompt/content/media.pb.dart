...
class Media extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'Media', package: const $pb.PackageName(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'google.actions.sdk.v2.conversation'), createEmptyInstance: create)
    ..aOM<$0.Duration>(5, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'startOffset', subBuilder: $0.Duration.create)
    ..pc<Media_OptionalMediaControls>(6, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'optionalMediaControls', $pb.PbFieldType.PE, valueOf: Media_OptionalMediaControls.valueOf, enumValues: Media_OptionalMediaControls.values)
    ...
    ..e<Media_MediaType>(8, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'mediaType', $pb.PbFieldType.OE, defaultOrMaker: Media_MediaType.MEDIA_TYPE_UNSPECIFIED, valueOf: Media_MediaType.valueOf, enumValues: Media_MediaType.values)
...
class MediaObject extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'MediaObject', package: const $pb.PackageName(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'google.actions.sdk.v2.conversation'), createEmptyInstance: create)
...
class MediaImage extends $pb.GeneratedMessage {
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'MediaImage', package: const $pb.PackageName(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'google.actions.sdk.v2.conversation'), createEmptyInstance: create)
    ..oo(0, [1, 2])
    ..aOM<$1.Image>(1, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'large', subBuilder: $1.Image.create)
    ..aOM<$1.Image>(2, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'icon', subBuilder: $1.Image.create)
    ..hasRequiredFields = false
  ;
  ...
  @$pb.TagNumber(1)
  set large($1.Image v) { setField(1, v); }
  @$pb.TagNumber(1)
  ...
  @$pb.TagNumber(2)
  set icon($1.Image v) { setField(2, v); }
  @$pb.TagNumber(2)

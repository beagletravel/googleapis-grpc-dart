...
class Simple extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'Simple', package: const $pb.PackageName(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'google.actions.sdk.v2.conversation'), createEmptyInstance: create)
  ...
  'Will be removed in next major version')
  Simple copyWith(void Function(Simple) updates) => super.copyWith((message) => updates(message as Simple)) as Simple; // ignore: deprecated_member_use

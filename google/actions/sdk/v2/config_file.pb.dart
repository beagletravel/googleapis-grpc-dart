...
class ConfigFiles extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'ConfigFiles', package: const $pb.PackageName(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'google.actions.sdk.v2'), createEmptyInstance: create)
    ..pc<ConfigFile>(1, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'configFiles', $pb.PbFieldType.PM, subBuilder: ConfigFile.create)
  ...
  'Will be removed in next major version')
  ConfigFiles copyWith(void Function(ConfigFiles) updates) => super.copyWith((message) => updates(message as ConfigFiles)) as ConfigFiles; // ignore: deprecated_member_use
...
class ConfigFile extends $pb.GeneratedMessage {
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'ConfigFile', package: const $pb.PackageName(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'google.actions.sdk.v2'), createEmptyInstance: create)
    ..oo(0, [2, 3, 4, 6, 7, 8, 9, 10, 11, 12, 13, 15])
    ..aOS(1, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'filePath')
    ..aOM<$0.Manifest>(2, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'manifest', subBuilder: $0.Manifest.create)
    ..aOM<$1.Actions>(3, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'actions', subBuilder: $1.Actions.create)
    ..aOM<$2.Settings>(4, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'settings', subBuilder: $2.Settings.create)
    ..aOM<$3.Webhook>(6, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'webhook', subBuilder: $3.Webhook.create)
    ..aOM<$4.Intent>(7, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'intent', subBuilder: $4.Intent.create)
    ..aOM<$5.Type>(8, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'type', subBuilder: $5.Type.create)
    ..aOM<$6.GlobalIntentEvent>(9, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'globalIntentEvent', subBuilder: $6.GlobalIntentEvent.create)
    ..aOM<$7.Scene>(10, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'scene', subBuilder: $7.Scene.create)
    ..aOM<$8.StaticPrompt>(11, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'staticPrompt', subBuilder: $8.StaticPrompt.create)
    ..aOM<$9.Struct>(12, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'resourceBundle', subBuilder: $9.Struct.create)
    ..aOM<$10.AccountLinkingSecret>(13, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'accountLinkingSecret', subBuilder: $10.AccountLinkingSecret.create)
    ..aOM<$11.EntitySet>(15, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'entitySet', subBuilder: $11.EntitySet.create)
    ..hasRequiredFields = false
  ;
  ...
  @$pb.TagNumber(2)
  set manifest($0.Manifest v) { setField(2, v); }
  @$pb.TagNumber(2)
  ...
  @$pb.TagNumber(3)
  set actions($1.Actions v) { setField(3, v); }
  @$pb.TagNumber(3)
  ...
  @$pb.TagNumber(4)
  set settings($2.Settings v) { setField(4, v); }
  @$pb.TagNumber(4)
  ...
  @$pb.TagNumber(6)
  set webhook($3.Webhook v) { setField(6, v); }
  @$pb.TagNumber(6)
  ...
  @$pb.TagNumber(7)
  set intent($4.Intent v) { setField(7, v); }
  @$pb.TagNumber(7)
  ...
  @$pb.TagNumber(8)
  set type($5.Type v) { setField(8, v); }
  @$pb.TagNumber(8)
  ...
  @$pb.TagNumber(9)
  set globalIntentEvent($6.GlobalIntentEvent v) { setField(9, v); }
  @$pb.TagNumber(9)
  ...
  @$pb.TagNumber(10)
  set scene($7.Scene v) { setField(10, v); }
  @$pb.TagNumber(10)
  ...
  @$pb.TagNumber(11)
  set staticPrompt($8.StaticPrompt v) { setField(11, v); }
  @$pb.TagNumber(11)
  ...
  @$pb.TagNumber(12)
  set resourceBundle($9.Struct v) { setField(12, v); }
  @$pb.TagNumber(12)
  ...
  @$pb.TagNumber(13)
  set accountLinkingSecret($10.AccountLinkingSecret v) { setField(13, v); }
  @$pb.TagNumber(13)
  ...
  @$pb.TagNumber(15)
  set entitySet($11.EntitySet v) { setField(15, v); }
  @$pb.TagNumber(15)

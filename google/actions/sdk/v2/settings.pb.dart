...
class Settings extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'Settings', package: const $pb.PackageName(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'google.actions.sdk.v2'), createEmptyInstance: create)
    ..aOS(1, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'projectId')
    ..aOS(2, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'defaultLocale')
    ..pPS(3, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'enabledRegions')
    ..pPS(4, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'disabledRegions')
    ..e<Settings_Category>(5, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'category', $pb.PbFieldType.OE, defaultOrMaker: Settings_Category.CATEGORY_UNSPECIFIED, valueOf: Settings_Category.valueOf, enumValues: Settings_Category.values)
    ..aOB(6, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'usesTransactionsApi')
    ..aOB(7, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'usesDigitalPurchaseApi')
    ..aOB(8, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'usesInteractiveCanvas')
    ..aOB(9, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'designedForFamily')
    ..aOB(11, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'containsAlcoholOrTobaccoContent')
    ..aOB(12, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'keepsMicOpen')
    ..aOM<$0.SurfaceRequirements>(13, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'surfaceRequirements', subBuilder: $0.SurfaceRequirements.create)
    ..aOS(14, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'testingInstructions')
    ..aOM<$1.LocalizedSettings>(15, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'localizedSettings', subBuilder: $1.LocalizedSettings.create)
    ..aOM<$2.AccountLinking>(16, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'accountLinking', subBuilder: $2.AccountLinking.create)
    ..aOB(17, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'usesHomeStorage')
    ..pPS(20, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'selectedAndroidApps')
  ...
  @$pb.TagNumber(13)
  set surfaceRequirements($0.SurfaceRequirements v) { setField(13, v); }
  @$pb.TagNumber(13)
  ...
  @$pb.TagNumber(15)
  set localizedSettings($1.LocalizedSettings v) { setField(15, v); }
  @$pb.TagNumber(15)
  ...
  @$pb.TagNumber(16)
  set accountLinking($2.AccountLinking v) { setField(16, v); }
  @$pb.TagNumber(16)

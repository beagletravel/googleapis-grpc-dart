...
class Version_VersionState extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'Version.VersionState', package: const $pb.PackageName(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'google.actions.sdk.v2'), createEmptyInstance: create)
    ..e<Version_VersionState_State>(1, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'state', $pb.PbFieldType.OE, defaultOrMaker: Version_VersionState_State.STATE_UNSPECIFIED, valueOf: Version_VersionState_State.valueOf, enumValues: Version_VersionState_State.values)
  ...
  'Will be removed in next major version')
  Version_VersionState copyWith(void Function(Version_VersionState) updates) => super.copyWith((message) => updates(message as Version_VersionState)) as Version_VersionState; // ignore: deprecated_member_use
...
class Version extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'Version', package: const $pb.PackageName(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'google.actions.sdk.v2'), createEmptyInstance: create)
    ..aOS(1, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'name')
    ..aOM<Version_VersionState>(2, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'versionState', subBuilder: Version_VersionState.create)

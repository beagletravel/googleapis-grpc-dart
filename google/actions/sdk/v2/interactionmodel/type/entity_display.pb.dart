...
class EntityDisplay extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'EntityDisplay', package: const $pb.PackageName(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'google.actions.sdk.v2.interactionmodel.type'), createEmptyInstance: create)
    ..aOS(1, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'iconTitle')
  ...
  'Will be removed in next major version')
  EntityDisplay copyWith(void Function(EntityDisplay) updates) => super.copyWith((message) => updates(message as EntityDisplay)) as EntityDisplay; // ignore: deprecated_member_use

...
class SynonymType_Entity extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'SynonymType.Entity', package: const $pb.PackageName(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'google.actions.sdk.v2.interactionmodel.type'), createEmptyInstance: create)
    ..aOM<$0.EntityDisplay>(1, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'display', subBuilder: $0.EntityDisplay.create)
  ...
  'Will be removed in next major version')
  SynonymType_Entity copyWith(void Function(SynonymType_Entity) updates) => super.copyWith((message) => updates(message as SynonymType_Entity)) as SynonymType_Entity; // ignore: deprecated_member_use
  ...
  @$pb.TagNumber(1)
  set display($0.EntityDisplay v) { setField(1, v); }
  @$pb.TagNumber(1)
...
class SynonymType extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'SynonymType', package: const $pb.PackageName(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'google.actions.sdk.v2.interactionmodel.type'), createEmptyInstance: create)
    ..e<SynonymType_MatchType>(1, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'matchType', $pb.PbFieldType.OE, defaultOrMaker: SynonymType_MatchType.UNSPECIFIED, valueOf: SynonymType_MatchType.valueOf, enumValues: SynonymType_MatchType.values)
    ..m<$core.String, SynonymType_Entity>(2, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'entities', entryClassName: 'SynonymType.EntitiesEntry', keyFieldType: $pb.PbFieldType.OS, valueFieldType: $pb.PbFieldType.OM, valueCreator: SynonymType_Entity.create, packageName: const $pb.PackageName('google.actions.sdk.v2.interactionmodel.type'))
    ..aOB(3, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'acceptUnknownValues')
    ..hasRequiredFields = false
  ;
  ...
  'Use [GeneratedMessageGenericExtensions.rebuild] instead. '
  'Will be removed in next major version')
  SynonymType copyWith(void Function(SynonymType) updates) => super.copyWith((message) => updates(message as SynonymType)) as SynonymType; // ignore: deprecated_member_use
  $pb.BuilderInfo get info_ => _i;
  @$core.pragma('dart2js:noInline')

...
class RegularExpressionType_Entity extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'RegularExpressionType.Entity', package: const $pb.PackageName(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'google.actions.sdk.v2.interactionmodel.type'), createEmptyInstance: create)
    ...
    ..pPS(2, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'regularExpressions')
  ...
  'Will be removed in next major version')
  RegularExpressionType_Entity copyWith(void Function(RegularExpressionType_Entity) updates) => super.copyWith((message) => updates(message as RegularExpressionType_Entity)) as RegularExpressionType_Entity; // ignore: deprecated_member_use
...
class RegularExpressionType extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'RegularExpressionType', package: const $pb.PackageName(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'google.actions.sdk.v2.interactionmodel.type'), createEmptyInstance: create)
    ..m<$core.String, RegularExpressionType_Entity>(1, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'entities', entryClassName: 'RegularExpressionType.EntitiesEntry', keyFieldType: $pb.PbFieldType.OS, valueFieldType: $pb.PbFieldType.OM, valueCreator: RegularExpressionType_Entity.create, packageName: const $pb.PackageName('google.actions.sdk.v2.interactionmodel.type'))
    ..hasRequiredFields = false
  ;
  ...
  'Use [GeneratedMessageGenericExtensions.rebuild] instead. '
  'Will be removed in next major version')
  RegularExpressionType copyWith(void Function(RegularExpressionType) updates) => super.copyWith((message) => updates(message as RegularExpressionType)) as RegularExpressionType; // ignore: deprecated_member_use
  $pb.BuilderInfo get info_ => _i;
  @$core.pragma('dart2js:noInline')

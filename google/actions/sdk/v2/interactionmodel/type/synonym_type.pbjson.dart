...
const SynonymType$json = const {
  '1': 'SynonymType',
  '2': const [
    const {'1': 'match_type', '3': 1, '4': 1, '5': 14, '6': '.google.actions.sdk.v2.interactionmodel.type.SynonymType.MatchType', '8': const {}, '10': 'matchType'},
    const {'1': 'accept_unknown_values', '3': 3, '4': 1, '5': 8, '8': const {}, '10': 'acceptUnknownValues'},
    const {'1': 'entities', '3': 2, '4': 3, '5': 11, '6': '.google.actions.sdk.v2.interactionmodel.type.SynonymType.EntitiesEntry', '8': const {}, '10': 'entities'},
  ],
...
const SynonymType_EntitiesEntry$json = const {
  ...
  '2': const [
    ...
    const {'1': 'value', '3': 2, '4': 1, '5': 11, '6': '.google.actions.sdk.v2.interactionmodel.type.SynonymType.Entity', '10': 'value'},
  ],
  '7': const {'7': true},
};

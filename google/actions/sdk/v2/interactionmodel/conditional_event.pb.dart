...
class ConditionalEvent extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'ConditionalEvent', package: const $pb.PackageName(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'google.actions.sdk.v2.interactionmodel'), createEmptyInstance: create)
    ..aOS(1, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'condition')
    ..aOS(2, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'transitionToScene')
    ..aOM<$0.EventHandler>(3, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'handler', subBuilder: $0.EventHandler.create)
  ...
  'Will be removed in next major version')
  ConditionalEvent copyWith(void Function(ConditionalEvent) updates) => super.copyWith((message) => updates(message as ConditionalEvent)) as ConditionalEvent; // ignore: deprecated_member_use
  ...
  @$pb.TagNumber(3)
  set handler($0.EventHandler v) { setField(3, v); }
  @$pb.TagNumber(3)

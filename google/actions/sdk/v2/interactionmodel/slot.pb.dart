...
class Slot_PromptSettings extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'Slot.PromptSettings', package: const $pb.PackageName(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'google.actions.sdk.v2.interactionmodel'), createEmptyInstance: create)
    ..aOM<$2.EventHandler>(1, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'initialPrompt', subBuilder: $2.EventHandler.create)
    ..aOM<$2.EventHandler>(2, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'noMatchPrompt1', subBuilder: $2.EventHandler.create)
    ..aOM<$2.EventHandler>(3, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'noMatchPrompt2', subBuilder: $2.EventHandler.create)
    ..aOM<$2.EventHandler>(4, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'noMatchFinalPrompt', subBuilder: $2.EventHandler.create)
    ..aOM<$2.EventHandler>(5, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'noInputPrompt1', subBuilder: $2.EventHandler.create)
    ..aOM<$2.EventHandler>(6, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'noInputPrompt2', subBuilder: $2.EventHandler.create)
    ..aOM<$2.EventHandler>(7, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'noInputFinalPrompt', subBuilder: $2.EventHandler.create)
  ...
  'Will be removed in next major version')
  Slot_PromptSettings copyWith(void Function(Slot_PromptSettings) updates) => super.copyWith((message) => updates(message as Slot_PromptSettings)) as Slot_PromptSettings; // ignore: deprecated_member_use
  ...
  @$pb.TagNumber(1)
  set initialPrompt($2.EventHandler v) { setField(1, v); }
  @$pb.TagNumber(1)
  ...
  @$pb.TagNumber(2)
  set noMatchPrompt1($2.EventHandler v) { setField(2, v); }
  @$pb.TagNumber(2)
  ...
  @$pb.TagNumber(3)
  set noMatchPrompt2($2.EventHandler v) { setField(3, v); }
  @$pb.TagNumber(3)
  ...
  @$pb.TagNumber(4)
  set noMatchFinalPrompt($2.EventHandler v) { setField(4, v); }
  @$pb.TagNumber(4)
  ...
  @$pb.TagNumber(5)
  set noInputPrompt1($2.EventHandler v) { setField(5, v); }
  @$pb.TagNumber(5)
  ...
  @$pb.TagNumber(6)
  set noInputPrompt2($2.EventHandler v) { setField(6, v); }
  @$pb.TagNumber(6)
  ...
  @$pb.TagNumber(7)
  set noInputFinalPrompt($2.EventHandler v) { setField(7, v); }
  @$pb.TagNumber(7)
...
class Slot_CommitBehavior extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'Slot.CommitBehavior', package: const $pb.PackageName(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'google.actions.sdk.v2.interactionmodel'), createEmptyInstance: create)
    ..aOS(1, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'writeSessionParam')
    ..hasRequiredFields = false
  ;
  ...
  'Use [GeneratedMessageGenericExtensions.rebuild] instead. '
  'Will be removed in next major version')
  Slot_CommitBehavior copyWith(void Function(Slot_CommitBehavior) updates) => super.copyWith((message) => updates(message as Slot_CommitBehavior)) as Slot_CommitBehavior; // ignore: deprecated_member_use
  $pb.BuilderInfo get info_ => _i;
  @$core.pragma('dart2js:noInline')
...
class Slot_DefaultValue extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'Slot.DefaultValue', package: const $pb.PackageName(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'google.actions.sdk.v2.interactionmodel'), createEmptyInstance: create)
    ..aOS(1, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'sessionParam')
    ..aOM<$1.Value>(2, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'constant', subBuilder: $1.Value.create)
    ..hasRequiredFields = false
  ;
  ...
  'Use [GeneratedMessageGenericExtensions.rebuild] instead. '
  'Will be removed in next major version')
  Slot_DefaultValue copyWith(void Function(Slot_DefaultValue) updates) => super.copyWith((message) => updates(message as Slot_DefaultValue)) as Slot_DefaultValue; // ignore: deprecated_member_use
  $pb.BuilderInfo get info_ => _i;
  @$core.pragma('dart2js:noInline')
  ...
  @$pb.TagNumber(2)
  set constant($1.Value v) { setField(2, v); }
  @$pb.TagNumber(2)
...
class Slot extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'Slot', package: const $pb.PackageName(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'google.actions.sdk.v2.interactionmodel'), createEmptyInstance: create)
    ..aOS(1, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'name')
    ..aOM<$0.ClassReference>(2, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'type', subBuilder: $0.ClassReference.create)
    ..aOB(3, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'required')
    ..aOM<Slot_PromptSettings>(4, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'promptSettings', subBuilder: Slot_PromptSettings.create)
    ..aOM<Slot_CommitBehavior>(5, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'commitBehavior', subBuilder: Slot_CommitBehavior.create)
    ..aOM<$1.Value>(6, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'config', subBuilder: $1.Value.create)
    ..aOM<Slot_DefaultValue>(7, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'defaultValue', subBuilder: Slot_DefaultValue.create)
    ..hasRequiredFields = false
  ;
  ...
  @$pb.TagNumber(2)
  set type($0.ClassReference v) { setField(2, v); }
  @$pb.TagNumber(2)
  ...
  @$pb.TagNumber(6)
  set config($1.Value v) { setField(6, v); }
  @$pb.TagNumber(6)

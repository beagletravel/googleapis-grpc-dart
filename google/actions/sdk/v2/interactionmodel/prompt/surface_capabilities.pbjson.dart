...
const SurfaceCapabilities$json = const {
  ...
  '2': const [
    const {'1': 'capabilities', '3': 1, '4': 3, '5': 14, '6': '.google.actions.sdk.v2.interactionmodel.prompt.SurfaceCapabilities.Capability', '8': const {}, '10': 'capabilities'},
  ],
...
final $typed_data.Uint8List surfaceCapabilitiesDescriptor = $convert.base64Decode('');

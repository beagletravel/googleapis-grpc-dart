...
class StaticSimplePrompt_Variant extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'StaticSimplePrompt.Variant', package: const $pb.PackageName(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'google.actions.sdk.v2.interactionmodel.prompt'), createEmptyInstance: create)
    ..aOS(1, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'speech')
  ...
  'Will be removed in next major version')
  StaticSimplePrompt_Variant copyWith(void Function(StaticSimplePrompt_Variant) updates) => super.copyWith((message) => updates(message as StaticSimplePrompt_Variant)) as StaticSimplePrompt_Variant; // ignore: deprecated_member_use
...
class StaticSimplePrompt extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'StaticSimplePrompt', package: const $pb.PackageName(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'google.actions.sdk.v2.interactionmodel.prompt'), createEmptyInstance: create)
    ..pc<StaticSimplePrompt_Variant>(1, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'variants', $pb.PbFieldType.PM, subBuilder: StaticSimplePrompt_Variant.create)
    ..hasRequiredFields = false
  ;
  ...
  'Use [GeneratedMessageGenericExtensions.rebuild] instead. '
  'Will be removed in next major version')
  StaticSimplePrompt copyWith(void Function(StaticSimplePrompt) updates) => super.copyWith((message) => updates(message as StaticSimplePrompt)) as StaticSimplePrompt; // ignore: deprecated_member_use
  $pb.BuilderInfo get info_ => _i;
  @$core.pragma('dart2js:noInline')

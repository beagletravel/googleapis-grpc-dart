...
class StaticPrompt_StaticPromptCandidate_StaticPromptResponse extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'StaticPrompt.StaticPromptCandidate.StaticPromptResponse', package: const $pb.PackageName(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'google.actions.sdk.v2.interactionmodel.prompt'), createEmptyInstance: create)
    ..aOM<$0.StaticSimplePrompt>(2, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'firstSimple', subBuilder: $0.StaticSimplePrompt.create)
    ..aOM<$1.StaticContentPrompt>(3, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'content', subBuilder: $1.StaticContentPrompt.create)
    ..aOM<$0.StaticSimplePrompt>(4, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'lastSimple', subBuilder: $0.StaticSimplePrompt.create)
    ..pc<$2.Suggestion>(5, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'suggestions', $pb.PbFieldType.PM, subBuilder: $2.Suggestion.create)
    ..aOM<$3.StaticLinkPrompt>(6, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'link', subBuilder: $3.StaticLinkPrompt.create)
    ..aOB(7, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'override')
    ..aOM<$4.StaticCanvasPrompt>(8, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'canvas', subBuilder: $4.StaticCanvasPrompt.create)
  ...
  'Will be removed in next major version')
  StaticPrompt_StaticPromptCandidate_StaticPromptResponse copyWith(void Function(StaticPrompt_StaticPromptCandidate_StaticPromptResponse) updates) => super.copyWith((message) => updates(message as StaticPrompt_StaticPromptCandidate_StaticPromptResponse)) as StaticPrompt_StaticPromptCandidate_StaticPromptResponse; // ignore: deprecated_member_use
  ...
  @$pb.TagNumber(2)
  set firstSimple($0.StaticSimplePrompt v) { setField(2, v); }
  @$pb.TagNumber(2)
  ...
  @$pb.TagNumber(3)
  set content($1.StaticContentPrompt v) { setField(3, v); }
  @$pb.TagNumber(3)
  ...
  @$pb.TagNumber(4)
  set lastSimple($0.StaticSimplePrompt v) { setField(4, v); }
  @$pb.TagNumber(4)
  ...
  @$pb.TagNumber(6)
  set link($3.StaticLinkPrompt v) { setField(6, v); }
  @$pb.TagNumber(6)
  ...
  @$pb.TagNumber(8)
  set canvas($4.StaticCanvasPrompt v) { setField(8, v); }
  @$pb.TagNumber(8)
...
class StaticPrompt_StaticPromptCandidate extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'StaticPrompt.StaticPromptCandidate', package: const $pb.PackageName(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'google.actions.sdk.v2.interactionmodel.prompt'), createEmptyInstance: create)
    ..aOM<StaticPrompt_Selector>(1, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'selector', subBuilder: StaticPrompt_Selector.create)
    ..aOM<StaticPrompt_StaticPromptCandidate_StaticPromptResponse>(2, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'promptResponse', subBuilder: StaticPrompt_StaticPromptCandidate_StaticPromptResponse.create)
    ..hasRequiredFields = false
  ;
  ...
  'Use [GeneratedMessageGenericExtensions.rebuild] instead. '
  'Will be removed in next major version')
  StaticPrompt_StaticPromptCandidate copyWith(void Function(StaticPrompt_StaticPromptCandidate) updates) => super.copyWith((message) => updates(message as StaticPrompt_StaticPromptCandidate)) as StaticPrompt_StaticPromptCandidate; // ignore: deprecated_member_use
  $pb.BuilderInfo get info_ => _i;
  @$core.pragma('dart2js:noInline')
...
class StaticPrompt_Selector extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'StaticPrompt.Selector', package: const $pb.PackageName(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'google.actions.sdk.v2.interactionmodel.prompt'), createEmptyInstance: create)
    ..aOM<$5.SurfaceCapabilities>(1, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'surfaceCapabilities', subBuilder: $5.SurfaceCapabilities.create)
    ..hasRequiredFields = false
  ;
  ...
  'Use [GeneratedMessageGenericExtensions.rebuild] instead. '
  'Will be removed in next major version')
  StaticPrompt_Selector copyWith(void Function(StaticPrompt_Selector) updates) => super.copyWith((message) => updates(message as StaticPrompt_Selector)) as StaticPrompt_Selector; // ignore: deprecated_member_use
  $pb.BuilderInfo get info_ => _i;
  @$core.pragma('dart2js:noInline')
  ...
  @$pb.TagNumber(1)
  set surfaceCapabilities($5.SurfaceCapabilities v) { setField(1, v); }
  @$pb.TagNumber(1)
...
class StaticPrompt extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'StaticPrompt', package: const $pb.PackageName(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'google.actions.sdk.v2.interactionmodel.prompt'), createEmptyInstance: create)
    ..pc<StaticPrompt_StaticPromptCandidate>(1, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'candidates', $pb.PbFieldType.PM, subBuilder: StaticPrompt_StaticPromptCandidate.create)
    ..hasRequiredFields = false
  ;
  ...
  'Use [GeneratedMessageGenericExtensions.rebuild] instead. '
  'Will be removed in next major version')
  StaticPrompt copyWith(void Function(StaticPrompt) updates) => super.copyWith((message) => updates(message as StaticPrompt)) as StaticPrompt; // ignore: deprecated_member_use
  $pb.BuilderInfo get info_ => _i;
  @$core.pragma('dart2js:noInline')

...
class StaticCardPrompt extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'StaticCardPrompt', package: const $pb.PackageName(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'google.actions.sdk.v2.interactionmodel.prompt'), createEmptyInstance: create)
    ...
    ..e<$0.StaticImagePrompt_ImageFill>(5, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'imageFill', $pb.PbFieldType.OE, defaultOrMaker: $0.StaticImagePrompt_ImageFill.UNSPECIFIED, valueOf: $0.StaticImagePrompt_ImageFill.valueOf, enumValues: $0.StaticImagePrompt_ImageFill.values)
  ...
  'Will be removed in next major version')
  StaticCardPrompt copyWith(void Function(StaticCardPrompt) updates) => super.copyWith((message) => updates(message as StaticCardPrompt)) as StaticCardPrompt; // ignore: deprecated_member_use
  ...
  @$pb.TagNumber(5)
  set imageFill($0.StaticImagePrompt_ImageFill v) { setField(5, v); }
  @$pb.TagNumber(5)

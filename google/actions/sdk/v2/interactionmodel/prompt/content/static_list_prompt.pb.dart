...
class StaticListPrompt_ListItem extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'StaticListPrompt.ListItem', package: const $pb.PackageName(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'google.actions.sdk.v2.interactionmodel.prompt'), createEmptyInstance: create)
  ...
  'Will be removed in next major version')
  StaticListPrompt_ListItem copyWith(void Function(StaticListPrompt_ListItem) updates) => super.copyWith((message) => updates(message as StaticListPrompt_ListItem)) as StaticListPrompt_ListItem; // ignore: deprecated_member_use
...
class StaticListPrompt extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'StaticListPrompt', package: const $pb.PackageName(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'google.actions.sdk.v2.interactionmodel.prompt'), createEmptyInstance: create)
    ..aOS(1, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'title')
    ..aOS(2, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'subtitle')
    ..pc<StaticListPrompt_ListItem>(3, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'items', $pb.PbFieldType.PM, subBuilder: StaticListPrompt_ListItem.create)
    ..hasRequiredFields = false
  ;
  ...
  'Use [GeneratedMessageGenericExtensions.rebuild] instead. '
  'Will be removed in next major version')
  StaticListPrompt copyWith(void Function(StaticListPrompt) updates) => super.copyWith((message) => updates(message as StaticListPrompt)) as StaticListPrompt; // ignore: deprecated_member_use
  $pb.BuilderInfo get info_ => _i;
  @$core.pragma('dart2js:noInline')

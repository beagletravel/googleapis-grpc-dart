...
const StaticListPrompt$json = const {
  ...
  '2': const [
    ...
    const {'1': 'items', '3': 3, '4': 3, '5': 11, '6': '.google.actions.sdk.v2.interactionmodel.prompt.StaticListPrompt.ListItem', '8': const {}, '10': 'items'},
  ],
...
final $typed_data.Uint8List staticListPromptDescriptor = $convert.base64Decode('');

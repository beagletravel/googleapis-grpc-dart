...
class StaticContentPrompt extends $pb.GeneratedMessage {
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'StaticContentPrompt', package: const $pb.PackageName(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'google.actions.sdk.v2.interactionmodel.prompt'), createEmptyInstance: create)
    ..oo(0, [1, 2, 3, 4, 5, 6, 7])
    ..aOM<$0.StaticCardPrompt>(1, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'card', subBuilder: $0.StaticCardPrompt.create)
    ..aOM<$1.StaticImagePrompt>(2, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'image', subBuilder: $1.StaticImagePrompt.create)
    ..aOM<$2.StaticTablePrompt>(3, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'table', subBuilder: $2.StaticTablePrompt.create)
    ..aOM<$3.StaticMediaPrompt>(4, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'media', subBuilder: $3.StaticMediaPrompt.create)
    ..aOM<$4.StaticListPrompt>(5, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'list', subBuilder: $4.StaticListPrompt.create)
    ..aOM<$5.StaticCollectionPrompt>(6, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'collection', subBuilder: $5.StaticCollectionPrompt.create)
    ..aOM<$6.StaticCollectionBrowsePrompt>(7, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'collectionBrowse', subBuilder: $6.StaticCollectionBrowsePrompt.create)
  ...
  'Will be removed in next major version')
  StaticContentPrompt copyWith(void Function(StaticContentPrompt) updates) => super.copyWith((message) => updates(message as StaticContentPrompt)) as StaticContentPrompt; // ignore: deprecated_member_use
  ...
  @$pb.TagNumber(1)
  set card($0.StaticCardPrompt v) { setField(1, v); }
  @$pb.TagNumber(1)
  ...
  @$pb.TagNumber(2)
  set image($1.StaticImagePrompt v) { setField(2, v); }
  @$pb.TagNumber(2)
  ...
  @$pb.TagNumber(3)
  set table($2.StaticTablePrompt v) { setField(3, v); }
  @$pb.TagNumber(3)
  ...
  @$pb.TagNumber(4)
  set media($3.StaticMediaPrompt v) { setField(4, v); }
  @$pb.TagNumber(4)
  ...
  @$pb.TagNumber(5)
  set list($4.StaticListPrompt v) { setField(5, v); }
  @$pb.TagNumber(5)
  ...
  @$pb.TagNumber(6)
  set collection($5.StaticCollectionPrompt v) { setField(6, v); }
  @$pb.TagNumber(6)
  ...
  @$pb.TagNumber(7)
  set collectionBrowse($6.StaticCollectionBrowsePrompt v) { setField(7, v); }
  @$pb.TagNumber(7)

...
class StaticCollectionBrowsePrompt_CollectionBrowseItem extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'StaticCollectionBrowsePrompt.CollectionBrowseItem', package: const $pb.PackageName(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'google.actions.sdk.v2.interactionmodel.prompt'), createEmptyInstance: create)
    ..aOS(1, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'title')
    ..aOS(2, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'description')
    ..aOS(3, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'footer')
    ...
    ..aOM<$1.OpenUrl>(5, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'openUriAction', subBuilder: $1.OpenUrl.create)
  ...
  'Will be removed in next major version')
  StaticCollectionBrowsePrompt_CollectionBrowseItem copyWith(void Function(StaticCollectionBrowsePrompt_CollectionBrowseItem) updates) => super.copyWith((message) => updates(message as StaticCollectionBrowsePrompt_CollectionBrowseItem)) as StaticCollectionBrowsePrompt_CollectionBrowseItem; // ignore: deprecated_member_use
  ...
  @$pb.TagNumber(5)
  set openUriAction($1.OpenUrl v) { setField(5, v); }
  @$pb.TagNumber(5)
...
class StaticCollectionBrowsePrompt extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'StaticCollectionBrowsePrompt', package: const $pb.PackageName(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'google.actions.sdk.v2.interactionmodel.prompt'), createEmptyInstance: create)
    ..pc<StaticCollectionBrowsePrompt_CollectionBrowseItem>(1, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'items', $pb.PbFieldType.PM, subBuilder: StaticCollectionBrowsePrompt_CollectionBrowseItem.create)
    ..e<$0.StaticImagePrompt_ImageFill>(2, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'imageFill', $pb.PbFieldType.OE, defaultOrMaker: $0.StaticImagePrompt_ImageFill.UNSPECIFIED, valueOf: $0.StaticImagePrompt_ImageFill.valueOf, enumValues: $0.StaticImagePrompt_ImageFill.values)
    ..hasRequiredFields = false
  ;
  ...
  'Use [GeneratedMessageGenericExtensions.rebuild] instead. '
  'Will be removed in next major version')
  StaticCollectionBrowsePrompt copyWith(void Function(StaticCollectionBrowsePrompt) updates) => super.copyWith((message) => updates(message as StaticCollectionBrowsePrompt)) as StaticCollectionBrowsePrompt; // ignore: deprecated_member_use
  $pb.BuilderInfo get info_ => _i;
  @$core.pragma('dart2js:noInline')
  ...
  @$pb.TagNumber(2)
  set imageFill($0.StaticImagePrompt_ImageFill v) { setField(2, v); }
  @$pb.TagNumber(2)

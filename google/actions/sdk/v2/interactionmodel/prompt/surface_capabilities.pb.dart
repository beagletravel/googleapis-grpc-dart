...
class SurfaceCapabilities extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'SurfaceCapabilities', package: const $pb.PackageName(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'google.actions.sdk.v2.interactionmodel.prompt'), createEmptyInstance: create)
    ..pc<SurfaceCapabilities_Capability>(1, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'capabilities', $pb.PbFieldType.PE, valueOf: SurfaceCapabilities_Capability.valueOf, enumValues: SurfaceCapabilities_Capability.values)
  ...
  'Will be removed in next major version')
  SurfaceCapabilities copyWith(void Function(SurfaceCapabilities) updates) => super.copyWith((message) => updates(message as SurfaceCapabilities)) as SurfaceCapabilities; // ignore: deprecated_member_use

...
class EventHandler extends $pb.GeneratedMessage {
  static const $core.Map<$core.int, EventHandler_Prompt> _EventHandler_PromptByTag = {
    2 : EventHandler_Prompt.staticPrompt,
    3 : EventHandler_Prompt.staticPromptName,
    0 : EventHandler_Prompt.notSet
  };
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'EventHandler', package: const $pb.PackageName(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'google.actions.sdk.v2.interactionmodel'), createEmptyInstance: create)
    ..oo(0, [2, 3])
    ..aOS(1, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'webhookHandler')
    ..aOM<$0.StaticPrompt>(2, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'staticPrompt', subBuilder: $0.StaticPrompt.create)
    ..aOS(3, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'staticPromptName')
  ...
  EventHandler_Prompt whichPrompt() => _EventHandler_PromptByTag[$_whichOneof(0)]!;
  void clearPrompt() => clearField($_whichOneof(0));

  @$pb.TagNumber(1)
  $core.String get webhookHandler => $_getSZ(0);
  @$pb.TagNumber(1)
  set webhookHandler($core.String v) { $_setString(0, v); }
  @$pb.TagNumber(1)
  ...
  @$pb.TagNumber(2)
  set staticPrompt($0.StaticPrompt v) { setField(2, v); }
  @$pb.TagNumber(2)
  ...
  @$pb.TagNumber(3)
  set staticPromptName($core.String v) { $_setString(2, v); }
  @$pb.TagNumber(3)

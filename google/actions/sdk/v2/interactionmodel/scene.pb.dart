...
class Scene extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'Scene', package: const $pb.PackageName(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'google.actions.sdk.v2.interactionmodel'), createEmptyInstance: create)
    ..aOM<$0.EventHandler>(1, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'onEnter', subBuilder: $0.EventHandler.create)
    ..pc<$1.IntentEvent>(2, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'intentEvents', $pb.PbFieldType.PM, subBuilder: $1.IntentEvent.create)
    ..pc<$2.ConditionalEvent>(3, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'conditionalEvents', $pb.PbFieldType.PM, subBuilder: $2.ConditionalEvent.create)
    ..pc<$3.Slot>(4, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'slots', $pb.PbFieldType.PM, subBuilder: $3.Slot.create)
    ..aOM<$0.EventHandler>(5, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'onSlotUpdated', subBuilder: $0.EventHandler.create)
  ...
  @$pb.TagNumber(1)
  set onEnter($0.EventHandler v) { setField(1, v); }
  @$pb.TagNumber(1)
  ...
  @$pb.TagNumber(5)
  set onSlotUpdated($0.EventHandler v) { setField(5, v); }
  @$pb.TagNumber(5)

...
class Intent_IntentParameter_EntitySetReferences_EntitySetReference extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'Intent.IntentParameter.EntitySetReferences.EntitySetReference', package: const $pb.PackageName(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'google.actions.sdk.v2.interactionmodel'), createEmptyInstance: create)
    ..aOS(1, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'entitySet')
...
class Intent_IntentParameter_EntitySetReferences extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'Intent.IntentParameter.EntitySetReferences', package: const $pb.PackageName(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'google.actions.sdk.v2.interactionmodel'), createEmptyInstance: create)
    ..pc<Intent_IntentParameter_EntitySetReferences_EntitySetReference>(1, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'entitySetReferences', $pb.PbFieldType.PM, subBuilder: Intent_IntentParameter_EntitySetReferences_EntitySetReference.create)
    ..hasRequiredFields = false
  ;
  ...
  'Use [GeneratedMessageGenericExtensions.rebuild] instead. '
  'Will be removed in next major version')
  Intent_IntentParameter_EntitySetReferences copyWith(void Function(Intent_IntentParameter_EntitySetReferences) updates) => super.copyWith((message) => updates(message as Intent_IntentParameter_EntitySetReferences)) as Intent_IntentParameter_EntitySetReferences; // ignore: deprecated_member_use
  $pb.BuilderInfo get info_ => _i;
  @$core.pragma('dart2js:noInline')
...
class Intent_IntentParameter extends $pb.GeneratedMessage {
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'Intent.IntentParameter', package: const $pb.PackageName(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'google.actions.sdk.v2.interactionmodel'), createEmptyInstance: create)
    ..oo(0, [2, 3])
    ...
    ..aOM<Intent_IntentParameter_EntitySetReferences>(3, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'entitySetReferences', subBuilder: Intent_IntentParameter_EntitySetReferences.create)
    ..hasRequiredFields = false
  ;
  ...
  'Use [GeneratedMessageGenericExtensions.rebuild] instead. '
  'Will be removed in next major version')
  Intent_IntentParameter copyWith(void Function(Intent_IntentParameter) updates) => super.copyWith((message) => updates(message as Intent_IntentParameter)) as Intent_IntentParameter; // ignore: deprecated_member_use
  $pb.BuilderInfo get info_ => _i;
  @$core.pragma('dart2js:noInline')
...
class Intent extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'Intent', package: const $pb.PackageName(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'google.actions.sdk.v2.interactionmodel'), createEmptyInstance: create)
    ..pc<Intent_IntentParameter>(1, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'parameters', $pb.PbFieldType.PM, subBuilder: Intent_IntentParameter.create)
    ..pPS(2, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'trainingPhrases')
    ..hasRequiredFields = false
  ;

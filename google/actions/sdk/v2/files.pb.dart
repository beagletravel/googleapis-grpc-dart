...
class Files extends $pb.GeneratedMessage {
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'Files', package: const $pb.PackageName(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'google.actions.sdk.v2'), createEmptyInstance: create)
    ..oo(0, [1, 2])
    ..aOM<$0.ConfigFiles>(1, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'configFiles', subBuilder: $0.ConfigFiles.create)
    ..aOM<$1.DataFiles>(2, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'dataFiles', subBuilder: $1.DataFiles.create)
  ...
  @$pb.TagNumber(1)
  set configFiles($0.ConfigFiles v) { setField(1, v); }
  @$pb.TagNumber(1)
  ...
  @$pb.TagNumber(2)
  set dataFiles($1.DataFiles v) { setField(2, v); }
  @$pb.TagNumber(2)

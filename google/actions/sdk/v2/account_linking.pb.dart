...
class AccountLinking extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'AccountLinking', package: const $pb.PackageName(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'google.actions.sdk.v2'), createEmptyInstance: create)
    ..aOB(1, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'enableAccountCreation')
    ..e<AccountLinking_LinkingType>(2, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'linkingType', $pb.PbFieldType.OE, defaultOrMaker: AccountLinking_LinkingType.LINKING_TYPE_UNSPECIFIED, valueOf: AccountLinking_LinkingType.valueOf, enumValues: AccountLinking_LinkingType.values)
    ..e<AccountLinking_AuthGrantType>(3, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'authGrantType', $pb.PbFieldType.OE, defaultOrMaker: AccountLinking_AuthGrantType.AUTH_GRANT_TYPE_UNSPECIFIED, valueOf: AccountLinking_AuthGrantType.valueOf, enumValues: AccountLinking_AuthGrantType.values)
    ..aOS(4, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'appClientId')
    ..aOS(5, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'authorizationUrl')
    ..aOS(6, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'tokenUrl')
    ..pPS(7, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'scopes')
    ..aOS(8, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'learnMoreUrl')
    ..aOB(9, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'useBasicAuthHeader')
  ...
  'Will be removed in next major version')
  AccountLinking copyWith(void Function(AccountLinking) updates) => super.copyWith((message) => updates(message as AccountLinking)) as AccountLinking; // ignore: deprecated_member_use

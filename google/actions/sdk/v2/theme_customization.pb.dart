...
class ThemeCustomization extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'ThemeCustomization', package: const $pb.PackageName(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'google.actions.sdk.v2'), createEmptyInstance: create)
    ...
    ..aOS(3, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'fontFamily')
    ..e<ThemeCustomization_ImageCornerStyle>(4, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'imageCornerStyle', $pb.PbFieldType.OE, defaultOrMaker: ThemeCustomization_ImageCornerStyle.IMAGE_CORNER_STYLE_UNSPECIFIED, valueOf: ThemeCustomization_ImageCornerStyle.valueOf, enumValues: ThemeCustomization_ImageCornerStyle.values)
    ..aOS(5, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'landscapeBackgroundImage')
    ..aOS(6, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'portraitBackgroundImage')
  ...
  factory ThemeCustomization.fromBuffer($core.List<$core.int> i, [$pb.ExtensionRegistry r = $pb.ExtensionRegistry.EMPTY]) => create()..mergeFromBuffer(i, r);
  factory ThemeCustomization.fromJson($core.String i, [$pb.ExtensionRegistry r = $pb.ExtensionRegistry.EMPTY]) => create()..mergeFromJson(i, r);
  @$core.Deprecated(
  ...
  'Will be removed in next major version')
  ThemeCustomization copyWith(void Function(ThemeCustomization) updates) => super.copyWith((message) => updates(message as ThemeCustomization)) as ThemeCustomization; // ignore: deprecated_member_use
  $pb.BuilderInfo get info_ => _i;
  @$core.pragma('dart2js:noInline')
  static ThemeCustomization create() => ThemeCustomization._();
  ThemeCustomization createEmptyInstance() => create();
  static $pb.PbList<ThemeCustomization> createRepeated() => $pb.PbList<ThemeCustomization>();
  @$core.pragma('dart2js:noInline')
  static ThemeCustomization getDefault() => _defaultInstance ??= $pb.GeneratedMessage.$_defaultFor<ThemeCustomization>(create);
  ...
  @$pb.TagNumber(4)
  set imageCornerStyle(ThemeCustomization_ImageCornerStyle v) { setField(4, v); }
  @$pb.TagNumber(4)
  ...
  @$pb.TagNumber(5)
  set landscapeBackgroundImage($core.String v) { $_setString(4, v); }
  @$pb.TagNumber(5)
  ...
  @$pb.TagNumber(6)
  set portraitBackgroundImage($core.String v) { $_setString(5, v); }
  @$pb.TagNumber(6)

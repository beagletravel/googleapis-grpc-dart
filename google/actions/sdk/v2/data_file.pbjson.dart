...
const DataFiles$json = const {
  '1': 'DataFiles',
  '2': const [
    const {'1': 'data_files', '3': 1, '4': 3, '5': 11, '6': '.google.actions.sdk.v2.DataFile', '10': 'dataFiles'},
  ],
};

/// Descriptor for `DataFiles`. Decode as a `google.protobuf.DescriptorProto`.
final $typed_data.Uint8List dataFilesDescriptor = $convert.base64Decode('CglEYXRhRmlsZXMSPgoKZGF0YV9maWxlcxgBIAMoCzIfLmdvb2dsZS5hY3Rpb25zLnNkay52Mi5EYXRhRmlsZVIJZGF0YUZpbGVz');
...
final $typed_data.Uint8List dataFileDescriptor = $convert.base64Decode('CghEYXRhRmlsZRIbCglmaWxlX3BhdGgYASABKAlSCGZpbGVQYXRoEiEKDGNvbnRlbnRfdHlwZRgCIAEoCVILY29udGVudFR5cGUSGAoHcGF5bG9hZBgDIAEoDFIHcGF5bG9hZA==');

...
final $typed_data.Uint8List fileTypeDescriptor = $convert.base64Decode('CghGaWxlVHlwZRIZChVGSUxFX1RZUEVfVU5TUEVDSUZJRUQQABIPCgtCSU5BUllfRklMRRABEg0KCVRFWFRfRklMRRACEgkKBUlNQUdFEAMSCAoEV09SRBAFEgcKA1BERhAGEggKBEFWUk8QBxIHCgNDU1YQCBIHCgNUU1YQCRIOCgpQT1dFUlBPSU5UEAsSCQoFRVhDRUwQDA==');
...
final $typed_data.Uint8List infoTypeDescriptor = $convert.base64Decode('CghJbmZvVHlwZRISCgRuYW1lGAEgASgJUgRuYW1lEhgKB3ZlcnNpb24YAiABKAlSB3ZlcnNpb24=');
...
final $typed_data.Uint8List storedTypeDescriptor = $convert.base64Decode('CgpTdG9yZWRUeXBlEhIKBG5hbWUYASABKAlSBG5hbWUSOwoLY3JlYXRlX3RpbWUYAiABKAsyGi5nb29nbGUucHJvdG9idWYuVGltZXN0YW1wUgpjcmVhdGVUaW1l');
...
final $typed_data.Uint8List customInfoTypeDescriptor = $convert.base64Decode('');
...
final $typed_data.Uint8List fieldIdDescriptor = $convert.base64Decode('CgdGaWVsZElkEhIKBG5hbWUYASABKAlSBG5hbWU=');
...
final $typed_data.Uint8List partitionIdDescriptor = $convert.base64Decode('CgtQYXJ0aXRpb25JZBIdCgpwcm9qZWN0X2lkGAIgASgJUglwcm9qZWN0SWQSIQoMbmFtZXNwYWNlX2lkGAQgASgJUgtuYW1lc3BhY2VJZA==');
...
final $typed_data.Uint8List kindExpressionDescriptor = $convert.base64Decode('Cg5LaW5kRXhwcmVzc2lvbhISCgRuYW1lGAEgASgJUgRuYW1l');
...
final $typed_data.Uint8List datastoreOptionsDescriptor = $convert.base64Decode('ChBEYXRhc3RvcmVPcHRpb25zEkUKDHBhcnRpdGlvbl9pZBgBIAEoCzIiLmdvb2dsZS5wcml2YWN5LmRscC52Mi5QYXJ0aXRpb25JZFILcGFydGl0aW9uSWQSOQoEa2luZBgCIAEoCzIlLmdvb2dsZS5wcml2YWN5LmRscC52Mi5LaW5kRXhwcmVzc2lvblIEa2luZA==');
...
final $typed_data.Uint8List cloudStorageRegexFileSetDescriptor = $convert.base64Decode('ChhDbG91ZFN0b3JhZ2VSZWdleEZpbGVTZXQSHwoLYnVja2V0X25hbWUYASABKAlSCmJ1Y2tldE5hbWUSIwoNaW5jbHVkZV9yZWdleBgCIAMoCVIMaW5jbHVkZVJlZ2V4EiMKDWV4Y2x1ZGVfcmVnZXgYAyADKAlSDGV4Y2x1ZGVSZWdleA==');
...
final $typed_data.Uint8List cloudStorageOptionsDescriptor = $convert.base64Decode('');
...
final $typed_data.Uint8List cloudStorageFileSetDescriptor = $convert.base64Decode('ChNDbG91ZFN0b3JhZ2VGaWxlU2V0EhAKA3VybBgBIAEoCVIDdXJs');
...
final $typed_data.Uint8List cloudStoragePathDescriptor = $convert.base64Decode('ChBDbG91ZFN0b3JhZ2VQYXRoEhIKBHBhdGgYASABKAlSBHBhdGg=');
...
const BigQueryOptions$json = const {
  ...
  '2': const [
    ...
    const {'1': 'included_fields', '3': 7, '4': 3, '5': 11, '6': '.google.privacy.dlp.v2.FieldId', '10': 'includedFields'},
  ],
...
final $typed_data.Uint8List bigQueryOptionsDescriptor = $convert.base64Decode('');
...
const StorageConfig$json = const {
  ...
  '2': const [
    ...
    const {'1': 'hybrid_options', '3': 9, '4': 1, '5': 11, '6': '.google.privacy.dlp.v2.HybridOptions', '9': 0, '10': 'hybridOptions'},
...
final $typed_data.Uint8List storageConfigDescriptor = $convert.base64Decode('');
@$core.Deprecated('Use hybridOptionsDescriptor instead')
const HybridOptions$json = const {
  '1': 'HybridOptions',
  '2': const [
    const {'1': 'description', '3': 1, '4': 1, '5': 9, '10': 'description'},
    const {'1': 'required_finding_label_keys', '3': 2, '4': 3, '5': 9, '10': 'requiredFindingLabelKeys'},
    const {'1': 'labels', '3': 3, '4': 3, '5': 11, '6': '.google.privacy.dlp.v2.HybridOptions.LabelsEntry', '10': 'labels'},
...
final $typed_data.Uint8List hybridOptionsDescriptor = $convert.base64Decode('');
...
final $typed_data.Uint8List bigQueryKeyDescriptor = $convert.base64Decode('CgtCaWdRdWVyeUtleRJNCg90YWJsZV9yZWZlcmVuY2UYASABKAsyJC5nb29nbGUucHJpdmFjeS5kbHAudjIuQmlnUXVlcnlUYWJsZVIOdGFibGVSZWZlcmVuY2USHQoKcm93X251bWJlchgCIAEoA1IJcm93TnVtYmVy');
...
final $typed_data.Uint8List datastoreKeyDescriptor = $convert.base64Decode('CgxEYXRhc3RvcmVLZXkSOQoKZW50aXR5X2tleRgBIAEoCzIaLmdvb2dsZS5wcml2YWN5LmRscC52Mi5LZXlSCWVudGl0eUtleQ==');
...
final $typed_data.Uint8List keyDescriptor = $convert.base64Decode('');
...
final $typed_data.Uint8List recordKeyDescriptor = $convert.base64Decode('');
...
final $typed_data.Uint8List bigQueryTableDescriptor = $convert.base64Decode('Cg1CaWdRdWVyeVRhYmxlEh0KCnByb2plY3RfaWQYASABKAlSCXByb2plY3RJZBIdCgpkYXRhc2V0X2lkGAIgASgJUglkYXRhc2V0SWQSGQoIdGFibGVfaWQYAyABKAlSB3RhYmxlSWQ=');
...
final $typed_data.Uint8List bigQueryFieldDescriptor = $convert.base64Decode('Cg1CaWdRdWVyeUZpZWxkEjoKBXRhYmxlGAEgASgLMiQuZ29vZ2xlLnByaXZhY3kuZGxwLnYyLkJpZ1F1ZXJ5VGFibGVSBXRhYmxlEjQKBWZpZWxkGAIgASgLMh4uZ29vZ2xlLnByaXZhY3kuZGxwLnYyLkZpZWxkSWRSBWZpZWxk');
...
final $typed_data.Uint8List entityIdDescriptor = $convert.base64Decode('CghFbnRpdHlJZBI0CgVmaWVsZBgBIAEoCzIeLmdvb2dsZS5wcml2YWN5LmRscC52Mi5GaWVsZElkUgVmaWVsZA==');
@$core.Deprecated('Use tableOptionsDescriptor instead')
const TableOptions$json = const {
  '1': 'TableOptions',
  '2': const [
    const {'1': 'identifying_fields', '3': 1, '4': 3, '5': 11, '6': '.google.privacy.dlp.v2.FieldId', '10': 'identifyingFields'},
  ],
};

/// Descriptor for `TableOptions`. Decode as a `google.protobuf.DescriptorProto`.
final $typed_data.Uint8List tableOptionsDescriptor = $convert.base64Decode('CgxUYWJsZU9wdGlvbnMSTQoSaWRlbnRpZnlpbmdfZmllbGRzGAEgAygLMh4uZ29vZ2xlLnByaXZhY3kuZGxwLnYyLkZpZWxkSWRSEWlkZW50aWZ5aW5nRmllbGRz');

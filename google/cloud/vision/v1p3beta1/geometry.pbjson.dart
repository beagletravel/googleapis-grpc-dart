...
const BoundingPoly$json = const {
  '1': 'BoundingPoly',
  '2': const [
    const {'1': 'vertices', '3': 1, '4': 3, '5': 11, '6': '.google.cloud.vision.v1p3beta1.Vertex', '10': 'vertices'},
    const {'1': 'normalized_vertices', '3': 2, '4': 3, '5': 11, '6': '.google.cloud.vision.v1p3beta1.NormalizedVertex', '10': 'normalizedVertices'},
  ],
};

/// Descriptor for `BoundingPoly`. Decode as a `google.protobuf.DescriptorProto`.
final $typed_data.Uint8List boundingPolyDescriptor = $convert.base64Decode('CgxCb3VuZGluZ1BvbHkSQQoIdmVydGljZXMYASADKAsyJS5nb29nbGUuY2xvdWQudmlzaW9uLnYxcDNiZXRhMS5WZXJ0ZXhSCHZlcnRpY2VzEmAKE25vcm1hbGl6ZWRfdmVydGljZXMYAiADKAsyLy5nb29nbGUuY2xvdWQudmlzaW9uLnYxcDNiZXRhMS5Ob3JtYWxpemVkVmVydGV4UhJub3JtYWxpemVkVmVydGljZXM=');
...
final $typed_data.Uint8List positionDescriptor = $convert.base64Decode('CghQb3NpdGlvbhIMCgF4GAEgASgCUgF4EgwKAXkYAiABKAJSAXkSDAoBehgDIAEoAlIBeg==');

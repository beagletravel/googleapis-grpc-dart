...
class WebDetection_WebEntity extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'WebDetection.WebEntity', package: const $pb.PackageName(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'google.cloud.vision.v1p4beta1'), createEmptyInstance: create)
  ...
  'Will be removed in next major version')
  WebDetection_WebEntity copyWith(void Function(WebDetection_WebEntity) updates) => super.copyWith((message) => updates(message as WebDetection_WebEntity)) as WebDetection_WebEntity; // ignore: deprecated_member_use
...
class WebDetection_WebImage extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'WebDetection.WebImage', package: const $pb.PackageName(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'google.cloud.vision.v1p4beta1'), createEmptyInstance: create)
  ...
  'Use [GeneratedMessageGenericExtensions.rebuild] instead. '
  'Will be removed in next major version')
  WebDetection_WebImage copyWith(void Function(WebDetection_WebImage) updates) => super.copyWith((message) => updates(message as WebDetection_WebImage)) as WebDetection_WebImage; // ignore: deprecated_member_use
  $pb.BuilderInfo get info_ => _i;
  @$core.pragma('dart2js:noInline')
...
class WebDetection_WebPage extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'WebDetection.WebPage', package: const $pb.PackageName(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'google.cloud.vision.v1p4beta1'), createEmptyInstance: create)
    ..aOS(1, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'url')
    ..a<$core.double>(2, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'score', $pb.PbFieldType.OF)
    ..aOS(3, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'pageTitle')
    ..pc<WebDetection_WebImage>(4, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'fullMatchingImages', $pb.PbFieldType.PM, subBuilder: WebDetection_WebImage.create)
    ..pc<WebDetection_WebImage>(5, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'partialMatchingImages', $pb.PbFieldType.PM, subBuilder: WebDetection_WebImage.create)
    ..hasRequiredFields = false
  ;
  ...
  'Use [GeneratedMessageGenericExtensions.rebuild] instead. '
  'Will be removed in next major version')
  WebDetection_WebPage copyWith(void Function(WebDetection_WebPage) updates) => super.copyWith((message) => updates(message as WebDetection_WebPage)) as WebDetection_WebPage; // ignore: deprecated_member_use
  $pb.BuilderInfo get info_ => _i;
  @$core.pragma('dart2js:noInline')
...
class WebDetection_WebLabel extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'WebDetection.WebLabel', package: const $pb.PackageName(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'google.cloud.vision.v1p4beta1'), createEmptyInstance: create)
  ...
  'Use [GeneratedMessageGenericExtensions.rebuild] instead. '
  'Will be removed in next major version')
  WebDetection_WebLabel copyWith(void Function(WebDetection_WebLabel) updates) => super.copyWith((message) => updates(message as WebDetection_WebLabel)) as WebDetection_WebLabel; // ignore: deprecated_member_use
  $pb.BuilderInfo get info_ => _i;
  @$core.pragma('dart2js:noInline')
...
class WebDetection extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'WebDetection', package: const $pb.PackageName(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'google.cloud.vision.v1p4beta1'), createEmptyInstance: create)
    ..pc<WebDetection_WebEntity>(1, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'webEntities', $pb.PbFieldType.PM, subBuilder: WebDetection_WebEntity.create)
    ..pc<WebDetection_WebImage>(2, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'fullMatchingImages', $pb.PbFieldType.PM, subBuilder: WebDetection_WebImage.create)
    ..pc<WebDetection_WebImage>(3, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'partialMatchingImages', $pb.PbFieldType.PM, subBuilder: WebDetection_WebImage.create)
    ..pc<WebDetection_WebPage>(4, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'pagesWithMatchingImages', $pb.PbFieldType.PM, subBuilder: WebDetection_WebPage.create)
    ..pc<WebDetection_WebImage>(6, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'visuallySimilarImages', $pb.PbFieldType.PM, subBuilder: WebDetection_WebImage.create)
    ..pc<WebDetection_WebLabel>(8, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'bestGuessLabels', $pb.PbFieldType.PM, subBuilder: WebDetection_WebLabel.create)
    ..hasRequiredFields = false
  ;
  ...
  'Use [GeneratedMessageGenericExtensions.rebuild] instead. '
  'Will be removed in next major version')
  WebDetection copyWith(void Function(WebDetection) updates) => super.copyWith((message) => updates(message as WebDetection)) as WebDetection; // ignore: deprecated_member_use
  $pb.BuilderInfo get info_ => _i;
  @$core.pragma('dart2js:noInline')

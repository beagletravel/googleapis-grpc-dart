...
const Instance$json = const {
  ...
  '2': const [
    ...
    const {'1': 'vm_image', '3': 2, '4': 1, '5': 11, '6': '.google.cloud.notebooks.v1beta1.VmImage', '9': 0, '10': 'vmImage'},
    const {'1': 'container_image', '3': 3, '4': 1, '5': 11, '6': '.google.cloud.notebooks.v1beta1.ContainerImage', '9': 0, '10': 'containerImage'},
    ...
    const {'1': 'accelerator_config', '3': 9, '4': 1, '5': 11, '6': '.google.cloud.notebooks.v1beta1.Instance.AcceleratorConfig', '10': 'acceleratorConfig'},
    const {'1': 'state', '3': 10, '4': 1, '5': 14, '6': '.google.cloud.notebooks.v1beta1.Instance.State', '8': const {}, '10': 'state'},
    ...
    const {'1': 'boot_disk_type', '3': 13, '4': 1, '5': 14, '6': '.google.cloud.notebooks.v1beta1.Instance.DiskType', '8': const {}, '10': 'bootDiskType'},
    const {'1': 'boot_disk_size_gb', '3': 14, '4': 1, '5': 3, '8': const {}, '10': 'bootDiskSizeGb'},
    const {'1': 'data_disk_type', '3': 25, '4': 1, '5': 14, '6': '.google.cloud.notebooks.v1beta1.Instance.DiskType', '8': const {}, '10': 'dataDiskType'},
    ...
    const {'1': 'disk_encryption', '3': 15, '4': 1, '5': 14, '6': '.google.cloud.notebooks.v1beta1.Instance.DiskEncryption', '8': const {}, '10': 'diskEncryption'},
    ...
    const {'1': 'labels', '3': 21, '4': 3, '5': 11, '6': '.google.cloud.notebooks.v1beta1.Instance.LabelsEntry', '10': 'labels'},
    const {'1': 'metadata', '3': 22, '4': 3, '5': 11, '6': '.google.cloud.notebooks.v1beta1.Instance.MetadataEntry', '10': 'metadata'},
  ...
  '3': const [Instance_AcceleratorConfig$json, Instance_LabelsEntry$json, Instance_MetadataEntry$json],
  '4': const [Instance_AcceleratorType$json, Instance_State$json, Instance_DiskType$json, Instance_DiskEncryption$json],
  '7': const {},
  '8': const [
    const {'1': 'environment'},
  ],
...
const Instance_AcceleratorConfig$json = const {
  '1': 'AcceleratorConfig',
  '2': const [
    const {'1': 'type', '3': 1, '4': 1, '5': 14, '6': '.google.cloud.notebooks.v1beta1.Instance.AcceleratorType', '10': 'type'},

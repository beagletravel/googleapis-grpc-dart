...
class Event_EventType extends $pb.ProtobufEnum {
  ...
  static const Event_EventType IDLE = Event_EventType._(1, const $core.bool.fromEnvironment('protobuf.omit_enum_names') ? '' : 'IDLE');
  static const Event_EventType HEARTBEAT = Event_EventType._(2, const $core.bool.fromEnvironment('protobuf.omit_enum_names') ? '' : 'HEARTBEAT');
  static const Event_EventType HEALTH = Event_EventType._(3, const $core.bool.fromEnvironment('protobuf.omit_enum_names') ? '' : 'HEALTH');
  static const Event_EventType MAINTENANCE = Event_EventType._(4, const $core.bool.fromEnvironment('protobuf.omit_enum_names') ? '' : 'MAINTENANCE');

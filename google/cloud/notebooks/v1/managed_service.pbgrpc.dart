...
class ManagedNotebookServiceClient extends $grpc.Client {
  ...
  static final _$reportRuntimeEvent = $grpc.ClientMethod<
      ...
      ($core.List<$core.int> value) => $0.Operation.fromBuffer(value));
  static final _$refreshRuntimeTokenInternal = $grpc.ClientMethod<
          $2.RefreshRuntimeTokenInternalRequest,
          $2.RefreshRuntimeTokenInternalResponse>(
      '/google.cloud.notebooks.v1.ManagedNotebookService/RefreshRuntimeTokenInternal',
      ($2.RefreshRuntimeTokenInternalRequest value) => value.writeToBuffer(),
      ($core.List<$core.int> value) =>
          $2.RefreshRuntimeTokenInternalResponse.fromBuffer(value));
  ...
  $grpc.ResponseFuture<$2.RefreshRuntimeTokenInternalResponse>
      refreshRuntimeTokenInternal($2.RefreshRuntimeTokenInternalRequest request,
          {$grpc.CallOptions? options}) {
    return $createUnaryCall(_$refreshRuntimeTokenInternal, request,
        options: options);
  }
}
...
abstract class ManagedNotebookServiceBase extends $grpc.Service {
  ...
  ManagedNotebookServiceBase() {
    ...
    $addMethod($grpc.ServiceMethod<$2.ReportRuntimeEventRequest, $0.Operation>(
        ...
        ($0.Operation value) => value.writeToBuffer()));
    $addMethod($grpc.ServiceMethod<$2.RefreshRuntimeTokenInternalRequest,
            $2.RefreshRuntimeTokenInternalResponse>(
        ...
        false,
        ($core.List<$core.int> value) =>
            $2.RefreshRuntimeTokenInternalRequest.fromBuffer(value),
        ($2.RefreshRuntimeTokenInternalResponse value) =>
            value.writeToBuffer()));
  }
  ...
  $async.Future<$2.RefreshRuntimeTokenInternalResponse>
      refreshRuntimeTokenInternal_Pre($grpc.ServiceCall call,
          $async.Future<$2.RefreshRuntimeTokenInternalRequest> request) async {
  ...
  $async.Future<$2.RefreshRuntimeTokenInternalResponse>
      refreshRuntimeTokenInternal($grpc.ServiceCall call,
          $2.RefreshRuntimeTokenInternalRequest request);
}

...
class Schedule extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'Schedule', package: const $pb.PackageName(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'google.cloud.notebooks.v1'), createEmptyInstance: create)
    ..aOS(1, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'name')
    ..aOS(2, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'displayName')
    ..aOS(3, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'description')
    ..e<Schedule_State>(4, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'state', $pb.PbFieldType.OE, defaultOrMaker: Schedule_State.STATE_UNSPECIFIED, valueOf: Schedule_State.valueOf, enumValues: Schedule_State.values)
    ..aOS(5, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'cronSchedule')
    ...
    ..aOM<$1.ExecutionTemplate>(9, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'executionTemplate', subBuilder: $1.ExecutionTemplate.create)
    ..pc<$1.Execution>(10, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'recentExecutions', $pb.PbFieldType.PM, subBuilder: $1.Execution.create)
  ...
  @$pb.TagNumber(9)
  set executionTemplate($1.ExecutionTemplate v) { setField(9, v); }
  @$pb.TagNumber(9)

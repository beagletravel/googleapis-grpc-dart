...
class ReservationAffinity extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'ReservationAffinity', package: const $pb.PackageName(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'google.cloud.notebooks.v1'), createEmptyInstance: create)
...
class Instance_AcceleratorConfig extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'Instance.AcceleratorConfig', package: const $pb.PackageName(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'google.cloud.notebooks.v1'), createEmptyInstance: create)
    ..e<Instance_AcceleratorType>(1, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'type', $pb.PbFieldType.OE, defaultOrMaker: Instance_AcceleratorType.ACCELERATOR_TYPE_UNSPECIFIED, valueOf: Instance_AcceleratorType.valueOf, enumValues: Instance_AcceleratorType.values)
  ...
  'Use [GeneratedMessageGenericExtensions.rebuild] instead. '
  'Will be removed in next major version')
  Instance_AcceleratorConfig copyWith(void Function(Instance_AcceleratorConfig) updates) => super.copyWith((message) => updates(message as Instance_AcceleratorConfig)) as Instance_AcceleratorConfig; // ignore: deprecated_member_use
  $pb.BuilderInfo get info_ => _i;
  @$core.pragma('dart2js:noInline')
...
class Instance_Disk_GuestOsFeature extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'Instance.Disk.GuestOsFeature', package: const $pb.PackageName(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'google.cloud.notebooks.v1'), createEmptyInstance: create)
  ...
  'Use [GeneratedMessageGenericExtensions.rebuild] instead. '
  'Will be removed in next major version')
  Instance_Disk_GuestOsFeature copyWith(void Function(Instance_Disk_GuestOsFeature) updates) => super.copyWith((message) => updates(message as Instance_Disk_GuestOsFeature)) as Instance_Disk_GuestOsFeature; // ignore: deprecated_member_use
  $pb.BuilderInfo get info_ => _i;
  @$core.pragma('dart2js:noInline')
...
class Instance_Disk extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'Instance.Disk', package: const $pb.PackageName(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'google.cloud.notebooks.v1'), createEmptyInstance: create)
    ...
    ..aInt64(4, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'diskSizeGb')
    ..pc<Instance_Disk_GuestOsFeature>(5, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'guestOsFeatures', $pb.PbFieldType.PM, subBuilder: Instance_Disk_GuestOsFeature.create)
  ...
  'Use [GeneratedMessageGenericExtensions.rebuild] instead. '
  'Will be removed in next major version')
  Instance_Disk copyWith(void Function(Instance_Disk) updates) => super.copyWith((message) => updates(message as Instance_Disk)) as Instance_Disk; // ignore: deprecated_member_use
  $pb.BuilderInfo get info_ => _i;
  @$core.pragma('dart2js:noInline')
...
class Instance_ShieldedInstanceConfig extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'Instance.ShieldedInstanceConfig', package: const $pb.PackageName(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'google.cloud.notebooks.v1'), createEmptyInstance: create)
  ...
  'Use [GeneratedMessageGenericExtensions.rebuild] instead. '
  'Will be removed in next major version')
  Instance_ShieldedInstanceConfig copyWith(void Function(Instance_ShieldedInstanceConfig) updates) => super.copyWith((message) => updates(message as Instance_ShieldedInstanceConfig)) as Instance_ShieldedInstanceConfig; // ignore: deprecated_member_use
  $pb.BuilderInfo get info_ => _i;
  @$core.pragma('dart2js:noInline')
...
class Instance_UpgradeHistoryEntry extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'Instance.UpgradeHistoryEntry', package: const $pb.PackageName(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'google.cloud.notebooks.v1'), createEmptyInstance: create)
    ..aOS(1, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'snapshot')
    ..aOS(2, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'vmImage')
    ..aOS(3, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'containerImage')
    ..aOS(4, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'framework')
    ..aOS(5, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'version')
    ..e<Instance_UpgradeHistoryEntry_State>(6, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'state', $pb.PbFieldType.OE, defaultOrMaker: Instance_UpgradeHistoryEntry_State.STATE_UNSPECIFIED, valueOf: Instance_UpgradeHistoryEntry_State.valueOf, enumValues: Instance_UpgradeHistoryEntry_State.values)
    ..aOM<$1.Timestamp>(7, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'createTime', subBuilder: $1.Timestamp.create)
    ..aOS(8, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'targetImage')
    ..e<Instance_UpgradeHistoryEntry_Action>(9, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'action', $pb.PbFieldType.OE, defaultOrMaker: Instance_UpgradeHistoryEntry_Action.ACTION_UNSPECIFIED, valueOf: Instance_UpgradeHistoryEntry_Action.valueOf, enumValues: Instance_UpgradeHistoryEntry_Action.values)
    ..aOS(10, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'targetVersion')
    ..hasRequiredFields = false
  ;
  ...
  'Use [GeneratedMessageGenericExtensions.rebuild] instead. '
  'Will be removed in next major version')
  Instance_UpgradeHistoryEntry copyWith(void Function(Instance_UpgradeHistoryEntry) updates) => super.copyWith((message) => updates(message as Instance_UpgradeHistoryEntry)) as Instance_UpgradeHistoryEntry; // ignore: deprecated_member_use
  $pb.BuilderInfo get info_ => _i;
  @$core.pragma('dart2js:noInline')
...
class Instance extends $pb.GeneratedMessage {
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'Instance', package: const $pb.PackageName(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'google.cloud.notebooks.v1'), createEmptyInstance: create)
    ..oo(0, [2, 3])
    ..aOS(1, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'name')
    ..aOM<$0.VmImage>(2, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'vmImage', subBuilder: $0.VmImage.create)
    ..aOM<$0.ContainerImage>(3, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'containerImage', subBuilder: $0.ContainerImage.create)
    ..aOS(4, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'postStartupScript')
    ..aOS(5, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'proxyUri')
    ..pPS(6, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'instanceOwners')
    ..aOS(7, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'serviceAccount')
    ..aOS(8, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'machineType')
    ..aOM<Instance_AcceleratorConfig>(9, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'acceleratorConfig', subBuilder: Instance_AcceleratorConfig.create)
    ..e<Instance_State>(10, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'state', $pb.PbFieldType.OE, defaultOrMaker: Instance_State.STATE_UNSPECIFIED, valueOf: Instance_State.valueOf, enumValues: Instance_State.values)
    ..aOB(11, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'installGpuDriver')
    ..aOS(12, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'customGpuDriverPath')
    ..e<Instance_DiskType>(13, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'bootDiskType', $pb.PbFieldType.OE, defaultOrMaker: Instance_DiskType.DISK_TYPE_UNSPECIFIED, valueOf: Instance_DiskType.valueOf, enumValues: Instance_DiskType.values)
    ..aInt64(14, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'bootDiskSizeGb')
    ..e<Instance_DiskEncryption>(15, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'diskEncryption', $pb.PbFieldType.OE, defaultOrMaker: Instance_DiskEncryption.DISK_ENCRYPTION_UNSPECIFIED, valueOf: Instance_DiskEncryption.valueOf, enumValues: Instance_DiskEncryption.values)
    ..aOS(16, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'kmsKey')
    ..aOB(17, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'noPublicIp')
    ..aOB(18, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'noProxyAccess')
    ..aOS(19, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'network')
    ..aOS(20, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'subnet')
    ..m<$core.String, $core.String>(21, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'labels', entryClassName: 'Instance.LabelsEntry', keyFieldType: $pb.PbFieldType.OS, valueFieldType: $pb.PbFieldType.OS, packageName: const $pb.PackageName('google.cloud.notebooks.v1'))
    ..m<$core.String, $core.String>(22, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'metadata', entryClassName: 'Instance.MetadataEntry', keyFieldType: $pb.PbFieldType.OS, valueFieldType: $pb.PbFieldType.OS, packageName: const $pb.PackageName('google.cloud.notebooks.v1'))
    ..aOM<$1.Timestamp>(23, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'createTime', subBuilder: $1.Timestamp.create)
    ..aOM<$1.Timestamp>(24, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'updateTime', subBuilder: $1.Timestamp.create)
    ..e<Instance_DiskType>(25, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'dataDiskType', $pb.PbFieldType.OE, defaultOrMaker: Instance_DiskType.DISK_TYPE_UNSPECIFIED, valueOf: Instance_DiskType.valueOf, enumValues: Instance_DiskType.values)
    ..aInt64(26, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'dataDiskSizeGb')
    ..aOB(27, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'noRemoveDataDisk')
    ..pc<Instance_Disk>(28, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'disks', $pb.PbFieldType.PM, subBuilder: Instance_Disk.create)
    ..pc<Instance_UpgradeHistoryEntry>(29, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'upgradeHistory', $pb.PbFieldType.PM, subBuilder: Instance_UpgradeHistoryEntry.create)
    ..aOM<Instance_ShieldedInstanceConfig>(30, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'shieldedInstanceConfig', subBuilder: Instance_ShieldedInstanceConfig.create)
    ..pPS(31, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'serviceAccountScopes')
    ..pPS(32, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'tags')
    ..e<Instance_NicType>(33, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'nicType', $pb.PbFieldType.OE, defaultOrMaker: Instance_NicType.UNSPECIFIED_NIC_TYPE, valueOf: Instance_NicType.valueOf, enumValues: Instance_NicType.values)
    ..aOM<ReservationAffinity>(34, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'reservationAffinity', subBuilder: ReservationAffinity.create)
    ..aOS(36, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'creator')
    ..aOB(39, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'canIpForward')
    ..hasRequiredFields = false
  ;
  ...
  factory Instance({
    ...
    if (canIpForward != null) {
      _result.canIpForward = canIpForward;
    }
    return _result;
  }
  ...
  @$pb.TagNumber(2)
  set vmImage($0.VmImage v) { setField(2, v); }
  @$pb.TagNumber(2)
  $core.bool hasVmImage() => $_has(1);
  @$pb.TagNumber(2)
  void clearVmImage() => clearField(2);
  ...
  @$pb.TagNumber(3)
  set containerImage($0.ContainerImage v) { setField(3, v); }
  @$pb.TagNumber(3)
  $core.bool hasContainerImage() => $_has(2);
  @$pb.TagNumber(3)
  void clearContainerImage() => clearField(3);
  ...
  @$pb.TagNumber(23)
  set createTime($1.Timestamp v) { setField(23, v); }
  @$pb.TagNumber(23)
  ...
  @$pb.TagNumber(24)
  set updateTime($1.Timestamp v) { setField(24, v); }
  @$pb.TagNumber(24)

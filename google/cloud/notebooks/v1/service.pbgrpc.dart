...
class NotebookServiceClient extends $grpc.Client {
  ...
  static final _$setInstanceLabels =
      $grpc.ClientMethod<$2.SetInstanceLabelsRequest, $0.Operation>(
          ...
          ($core.List<$core.int> value) => $0.Operation.fromBuffer(value));
  static final _$updateInstanceMetadataItems = $grpc.ClientMethod<
          $2.UpdateInstanceMetadataItemsRequest,
          $2.UpdateInstanceMetadataItemsResponse>(
      '/google.cloud.notebooks.v1.NotebookService/UpdateInstanceMetadataItems',
      ($2.UpdateInstanceMetadataItemsRequest value) => value.writeToBuffer(),
      ($core.List<$core.int> value) =>
          $2.UpdateInstanceMetadataItemsResponse.fromBuffer(value));
  ...
  $grpc.ResponseFuture<$2.UpdateInstanceMetadataItemsResponse>
      updateInstanceMetadataItems($2.UpdateInstanceMetadataItemsRequest request,
          {$grpc.CallOptions? options}) {
    return $createUnaryCall(_$updateInstanceMetadataItems, request,
        options: options);
  }
...
abstract class NotebookServiceBase extends $grpc.Service {
  ...
  NotebookServiceBase() {
    ...
    $addMethod($grpc.ServiceMethod<$2.SetInstanceLabelsRequest, $0.Operation>(
        ...
        ($0.Operation value) => value.writeToBuffer()));
    $addMethod($grpc.ServiceMethod<$2.UpdateInstanceMetadataItemsRequest,
            $2.UpdateInstanceMetadataItemsResponse>(
        ...
        false,
        ($core.List<$core.int> value) =>
            $2.UpdateInstanceMetadataItemsRequest.fromBuffer(value),
        ($2.UpdateInstanceMetadataItemsResponse value) =>
            value.writeToBuffer()));
  ...
  $async.Future<$2.UpdateInstanceMetadataItemsResponse>
      updateInstanceMetadataItems_Pre($grpc.ServiceCall call,
          $async.Future<$2.UpdateInstanceMetadataItemsRequest> request) async {
  ...
  $async.Future<$2.UpdateInstanceMetadataItemsResponse>
      updateInstanceMetadataItems($grpc.ServiceCall call,
          $2.UpdateInstanceMetadataItemsRequest request);

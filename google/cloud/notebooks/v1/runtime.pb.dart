...
class Runtime extends $pb.GeneratedMessage {
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'Runtime', package: const $pb.PackageName(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'google.cloud.notebooks.v1'), createEmptyInstance: create)
    ..oo(0, [2])
    ..aOS(1, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'name')
    ..aOM<VirtualMachine>(2, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'virtualMachine', subBuilder: VirtualMachine.create)
    ..e<Runtime_State>(3, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'state', $pb.PbFieldType.OE, defaultOrMaker: Runtime_State.STATE_UNSPECIFIED, valueOf: Runtime_State.valueOf, enumValues: Runtime_State.values)
    ..e<Runtime_HealthState>(4, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'healthState', $pb.PbFieldType.OE, defaultOrMaker: Runtime_HealthState.HEALTH_STATE_UNSPECIFIED, valueOf: Runtime_HealthState.valueOf, enumValues: Runtime_HealthState.values)
    ..aOM<RuntimeAccessConfig>(5, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'accessConfig', subBuilder: RuntimeAccessConfig.create)
    ..aOM<RuntimeSoftwareConfig>(6, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'softwareConfig', subBuilder: RuntimeSoftwareConfig.create)
    ..aOM<RuntimeMetrics>(7, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'metrics', subBuilder: RuntimeMetrics.create)
    ..aOM<$0.Timestamp>(20, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'createTime', subBuilder: $0.Timestamp.create)
    ..aOM<$0.Timestamp>(21, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'updateTime', subBuilder: $0.Timestamp.create)
  ...
  'Will be removed in next major version')
  Runtime copyWith(void Function(Runtime) updates) => super.copyWith((message) => updates(message as Runtime)) as Runtime; // ignore: deprecated_member_use
  ...
  @$pb.TagNumber(20)
  set createTime($0.Timestamp v) { setField(20, v); }
  @$pb.TagNumber(20)
  ...
  @$pb.TagNumber(21)
  set updateTime($0.Timestamp v) { setField(21, v); }
  @$pb.TagNumber(21)
...
class RuntimeAcceleratorConfig extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'RuntimeAcceleratorConfig', package: const $pb.PackageName(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'google.cloud.notebooks.v1'), createEmptyInstance: create)
    ..e<RuntimeAcceleratorConfig_AcceleratorType>(1, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'type', $pb.PbFieldType.OE, defaultOrMaker: RuntimeAcceleratorConfig_AcceleratorType.ACCELERATOR_TYPE_UNSPECIFIED, valueOf: RuntimeAcceleratorConfig_AcceleratorType.valueOf, enumValues: RuntimeAcceleratorConfig_AcceleratorType.values)
    ..aInt64(2, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'coreCount')
    ..hasRequiredFields = false
  ;
  ...
  'Use [GeneratedMessageGenericExtensions.rebuild] instead. '
  'Will be removed in next major version')
  RuntimeAcceleratorConfig copyWith(void Function(RuntimeAcceleratorConfig) updates) => super.copyWith((message) => updates(message as RuntimeAcceleratorConfig)) as RuntimeAcceleratorConfig; // ignore: deprecated_member_use
  $pb.BuilderInfo get info_ => _i;
  @$core.pragma('dart2js:noInline')
...
class EncryptionConfig extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'EncryptionConfig', package: const $pb.PackageName(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'google.cloud.notebooks.v1'), createEmptyInstance: create)
...
class LocalDisk_RuntimeGuestOsFeature extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'LocalDisk.RuntimeGuestOsFeature', package: const $pb.PackageName(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'google.cloud.notebooks.v1'), createEmptyInstance: create)
  ...
  'Use [GeneratedMessageGenericExtensions.rebuild] instead. '
  'Will be removed in next major version')
  LocalDisk_RuntimeGuestOsFeature copyWith(void Function(LocalDisk_RuntimeGuestOsFeature) updates) => super.copyWith((message) => updates(message as LocalDisk_RuntimeGuestOsFeature)) as LocalDisk_RuntimeGuestOsFeature; // ignore: deprecated_member_use
  $pb.BuilderInfo get info_ => _i;
  @$core.pragma('dart2js:noInline')
...
class LocalDisk extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'LocalDisk', package: const $pb.PackageName(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'google.cloud.notebooks.v1'), createEmptyInstance: create)
    ..aOB(1, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'autoDelete')
    ..aOB(2, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'boot')
    ..aOS(3, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'deviceName')
    ..pc<LocalDisk_RuntimeGuestOsFeature>(4, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'guestOsFeatures', $pb.PbFieldType.PM, subBuilder: LocalDisk_RuntimeGuestOsFeature.create)
    ..a<$core.int>(5, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'index', $pb.PbFieldType.O3)
    ..aOM<LocalDiskInitializeParams>(6, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'initializeParams', subBuilder: LocalDiskInitializeParams.create)
    ..aOS(7, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'interface')
    ..aOS(8, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'kind')
    ..pPS(9, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'licenses')
    ..aOS(10, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'mode')
    ..aOS(11, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'source')
  ...
  'Use [GeneratedMessageGenericExtensions.rebuild] instead. '
  'Will be removed in next major version')
  LocalDisk copyWith(void Function(LocalDisk) updates) => super.copyWith((message) => updates(message as LocalDisk)) as LocalDisk; // ignore: deprecated_member_use
  $pb.BuilderInfo get info_ => _i;
  @$core.pragma('dart2js:noInline')
...
class LocalDiskInitializeParams extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'LocalDiskInitializeParams', package: const $pb.PackageName(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'google.cloud.notebooks.v1'), createEmptyInstance: create)
    ..aOS(1, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'description')
    ..aOS(2, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'diskName')
    ..aInt64(3, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'diskSizeGb')
    ..e<LocalDiskInitializeParams_DiskType>(4, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'diskType', $pb.PbFieldType.OE, defaultOrMaker: LocalDiskInitializeParams_DiskType.DISK_TYPE_UNSPECIFIED, valueOf: LocalDiskInitializeParams_DiskType.valueOf, enumValues: LocalDiskInitializeParams_DiskType.values)
    ..m<$core.String, $core.String>(5, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'labels', entryClassName: 'LocalDiskInitializeParams.LabelsEntry', keyFieldType: $pb.PbFieldType.OS, valueFieldType: $pb.PbFieldType.OS, packageName: const $pb.PackageName('google.cloud.notebooks.v1'))
    ..hasRequiredFields = false
  ;
  ...
  'Use [GeneratedMessageGenericExtensions.rebuild] instead. '
  'Will be removed in next major version')
  LocalDiskInitializeParams copyWith(void Function(LocalDiskInitializeParams) updates) => super.copyWith((message) => updates(message as LocalDiskInitializeParams)) as LocalDiskInitializeParams; // ignore: deprecated_member_use
  $pb.BuilderInfo get info_ => _i;
  @$core.pragma('dart2js:noInline')
...
class RuntimeAccessConfig extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'RuntimeAccessConfig', package: const $pb.PackageName(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'google.cloud.notebooks.v1'), createEmptyInstance: create)
    ..e<RuntimeAccessConfig_RuntimeAccessType>(1, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'accessType', $pb.PbFieldType.OE, defaultOrMaker: RuntimeAccessConfig_RuntimeAccessType.RUNTIME_ACCESS_TYPE_UNSPECIFIED, valueOf: RuntimeAccessConfig_RuntimeAccessType.valueOf, enumValues: RuntimeAccessConfig_RuntimeAccessType.values)
    ..aOS(2, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'runtimeOwner')
    ..aOS(3, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'proxyUri')
    ..hasRequiredFields = false
  ;
  ...
  'Use [GeneratedMessageGenericExtensions.rebuild] instead. '
  'Will be removed in next major version')
  RuntimeAccessConfig copyWith(void Function(RuntimeAccessConfig) updates) => super.copyWith((message) => updates(message as RuntimeAccessConfig)) as RuntimeAccessConfig; // ignore: deprecated_member_use
  $pb.BuilderInfo get info_ => _i;
  @$core.pragma('dart2js:noInline')
...
class RuntimeSoftwareConfig extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'RuntimeSoftwareConfig', package: const $pb.PackageName(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'google.cloud.notebooks.v1'), createEmptyInstance: create)
    ..aOS(1, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'notebookUpgradeSchedule')
    ..aOB(2, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'enableHealthMonitoring')
    ..aOB(3, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'idleShutdown')
    ..a<$core.int>(4, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'idleShutdownTimeout', $pb.PbFieldType.O3)
    ..aOB(5, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'installGpuDriver')
    ..aOS(6, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'customGpuDriverPath')
    ..aOS(7, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'postStartupScript')
    ..pc<$1.ContainerImage>(8, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'kernels', $pb.PbFieldType.PM, subBuilder: $1.ContainerImage.create)
    ..aOB(9, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'upgradeable')
    ..hasRequiredFields = false
  ;
  ...
  factory RuntimeSoftwareConfig({
    ...
    $core.Iterable<$1.ContainerImage>? kernels,
    ...
    if (kernels != null) {
      _result.kernels.addAll(kernels);
    }
    if (upgradeable != null) {
  ...
  'Use [GeneratedMessageGenericExtensions.rebuild] instead. '
  'Will be removed in next major version')
  RuntimeSoftwareConfig copyWith(void Function(RuntimeSoftwareConfig) updates) => super.copyWith((message) => updates(message as RuntimeSoftwareConfig)) as RuntimeSoftwareConfig; // ignore: deprecated_member_use
  $pb.BuilderInfo get info_ => _i;
  @$core.pragma('dart2js:noInline')
  ...
  @$pb.TagNumber(8)
  $core.List<$1.ContainerImage> get kernels => $_getList(7);
...
class RuntimeMetrics extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'RuntimeMetrics', package: const $pb.PackageName(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'google.cloud.notebooks.v1'), createEmptyInstance: create)
    ..m<$core.String, $core.String>(1, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'systemMetrics', entryClassName: 'RuntimeMetrics.SystemMetricsEntry', keyFieldType: $pb.PbFieldType.OS, valueFieldType: $pb.PbFieldType.OS, packageName: const $pb.PackageName('google.cloud.notebooks.v1'))
    ..hasRequiredFields = false
  ;
  ...
  'Use [GeneratedMessageGenericExtensions.rebuild] instead. '
  'Will be removed in next major version')
  RuntimeMetrics copyWith(void Function(RuntimeMetrics) updates) => super.copyWith((message) => updates(message as RuntimeMetrics)) as RuntimeMetrics; // ignore: deprecated_member_use
  $pb.BuilderInfo get info_ => _i;
  @$core.pragma('dart2js:noInline')
...
class RuntimeShieldedInstanceConfig extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'RuntimeShieldedInstanceConfig', package: const $pb.PackageName(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'google.cloud.notebooks.v1'), createEmptyInstance: create)
  ...
  'Use [GeneratedMessageGenericExtensions.rebuild] instead. '
  'Will be removed in next major version')
  RuntimeShieldedInstanceConfig copyWith(void Function(RuntimeShieldedInstanceConfig) updates) => super.copyWith((message) => updates(message as RuntimeShieldedInstanceConfig)) as RuntimeShieldedInstanceConfig; // ignore: deprecated_member_use
  $pb.BuilderInfo get info_ => _i;
  @$core.pragma('dart2js:noInline')
...
class VirtualMachine extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'VirtualMachine', package: const $pb.PackageName(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'google.cloud.notebooks.v1'), createEmptyInstance: create)
    ...
    ..aOM<VirtualMachineConfig>(3, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'virtualMachineConfig', subBuilder: VirtualMachineConfig.create)
    ..hasRequiredFields = false
  ;
...
class VirtualMachineConfig_BootImage extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'VirtualMachineConfig.BootImage', package: const $pb.PackageName(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'google.cloud.notebooks.v1'), createEmptyInstance: create)
    ..hasRequiredFields = false
  ;
  ...
  'Use [GeneratedMessageGenericExtensions.rebuild] instead. '
  'Will be removed in next major version')
  VirtualMachineConfig_BootImage copyWith(void Function(VirtualMachineConfig_BootImage) updates) => super.copyWith((message) => updates(message as VirtualMachineConfig_BootImage)) as VirtualMachineConfig_BootImage; // ignore: deprecated_member_use
  $pb.BuilderInfo get info_ => _i;
  @$core.pragma('dart2js:noInline')
...
class VirtualMachineConfig extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'VirtualMachineConfig', package: const $pb.PackageName(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'google.cloud.notebooks.v1'), createEmptyInstance: create)
    ...
    ..pc<$1.ContainerImage>(3, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'containerImages', $pb.PbFieldType.PM, subBuilder: $1.ContainerImage.create)
    ..aOM<LocalDisk>(4, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'dataDisk', subBuilder: LocalDisk.create)
    ..aOM<EncryptionConfig>(5, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'encryptionConfig', subBuilder: EncryptionConfig.create)
    ..aOM<RuntimeShieldedInstanceConfig>(6, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'shieldedInstanceConfig', subBuilder: RuntimeShieldedInstanceConfig.create)
    ..aOM<RuntimeAcceleratorConfig>(7, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'acceleratorConfig', subBuilder: RuntimeAcceleratorConfig.create)
    ..aOS(8, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'network')
    ..aOS(9, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'subnet')
    ..aOB(10, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'internalIpOnly')
    ..pPS(13, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'tags')
    ..m<$core.String, $core.String>(14, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'guestAttributes', entryClassName: 'VirtualMachineConfig.GuestAttributesEntry', keyFieldType: $pb.PbFieldType.OS, valueFieldType: $pb.PbFieldType.OS, packageName: const $pb.PackageName('google.cloud.notebooks.v1'))
    ..m<$core.String, $core.String>(15, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'metadata', entryClassName: 'VirtualMachineConfig.MetadataEntry', keyFieldType: $pb.PbFieldType.OS, valueFieldType: $pb.PbFieldType.OS, packageName: const $pb.PackageName('google.cloud.notebooks.v1'))
    ..m<$core.String, $core.String>(16, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'labels', entryClassName: 'VirtualMachineConfig.LabelsEntry', keyFieldType: $pb.PbFieldType.OS, valueFieldType: $pb.PbFieldType.OS, packageName: const $pb.PackageName('google.cloud.notebooks.v1'))
    ..e<VirtualMachineConfig_NicType>(17, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'nicType', $pb.PbFieldType.OE, defaultOrMaker: VirtualMachineConfig_NicType.UNSPECIFIED_NIC_TYPE, valueOf: VirtualMachineConfig_NicType.valueOf, enumValues: VirtualMachineConfig_NicType.values)
    ..aOS(18, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'reservedIpRange')
    ..aOM<VirtualMachineConfig_BootImage>(19, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'bootImage', subBuilder: VirtualMachineConfig_BootImage.create)
    ..hasRequiredFields = false
  ;
  ...
  'Use [GeneratedMessageGenericExtensions.rebuild] instead. '
  'Will be removed in next major version')
  VirtualMachineConfig copyWith(void Function(VirtualMachineConfig) updates) => super.copyWith((message) => updates(message as VirtualMachineConfig)) as VirtualMachineConfig; // ignore: deprecated_member_use
  $pb.BuilderInfo get info_ => _i;
  @$core.pragma('dart2js:noInline')

...
class ExecutionTemplate_SchedulerAcceleratorConfig extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'ExecutionTemplate.SchedulerAcceleratorConfig', package: const $pb.PackageName(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'google.cloud.notebooks.v1'), createEmptyInstance: create)
    ..e<ExecutionTemplate_SchedulerAcceleratorType>(1, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'type', $pb.PbFieldType.OE, defaultOrMaker: ExecutionTemplate_SchedulerAcceleratorType.SCHEDULER_ACCELERATOR_TYPE_UNSPECIFIED, valueOf: ExecutionTemplate_SchedulerAcceleratorType.valueOf, enumValues: ExecutionTemplate_SchedulerAcceleratorType.values)
  ...
  'Will be removed in next major version')
  ExecutionTemplate_SchedulerAcceleratorConfig copyWith(void Function(ExecutionTemplate_SchedulerAcceleratorConfig) updates) => super.copyWith((message) => updates(message as ExecutionTemplate_SchedulerAcceleratorConfig)) as ExecutionTemplate_SchedulerAcceleratorConfig; // ignore: deprecated_member_use
...
class ExecutionTemplate_DataprocParameters extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'ExecutionTemplate.DataprocParameters', package: const $pb.PackageName(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'google.cloud.notebooks.v1'), createEmptyInstance: create)
  ...
  'Use [GeneratedMessageGenericExtensions.rebuild] instead. '
  'Will be removed in next major version')
  ExecutionTemplate_DataprocParameters copyWith(void Function(ExecutionTemplate_DataprocParameters) updates) => super.copyWith((message) => updates(message as ExecutionTemplate_DataprocParameters)) as ExecutionTemplate_DataprocParameters; // ignore: deprecated_member_use
  $pb.BuilderInfo get info_ => _i;
  @$core.pragma('dart2js:noInline')
...
class ExecutionTemplate_VertexAIParameters extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'ExecutionTemplate.VertexAIParameters', package: const $pb.PackageName(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'google.cloud.notebooks.v1'), createEmptyInstance: create)
    ..aOS(1, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'network')
    ..m<$core.String, $core.String>(2, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'env', entryClassName: 'ExecutionTemplate.VertexAIParameters.EnvEntry', keyFieldType: $pb.PbFieldType.OS, valueFieldType: $pb.PbFieldType.OS, packageName: const $pb.PackageName('google.cloud.notebooks.v1'))
    ..hasRequiredFields = false
  ;
  ...
  'Use [GeneratedMessageGenericExtensions.rebuild] instead. '
  'Will be removed in next major version')
  ExecutionTemplate_VertexAIParameters copyWith(void Function(ExecutionTemplate_VertexAIParameters) updates) => super.copyWith((message) => updates(message as ExecutionTemplate_VertexAIParameters)) as ExecutionTemplate_VertexAIParameters; // ignore: deprecated_member_use
  $pb.BuilderInfo get info_ => _i;
  @$core.pragma('dart2js:noInline')
...
class ExecutionTemplate extends $pb.GeneratedMessage {
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'ExecutionTemplate', package: const $pb.PackageName(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'google.cloud.notebooks.v1'), createEmptyInstance: create)
    ..oo(0, [12, 13])
    ..e<ExecutionTemplate_ScaleTier>(1, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'scaleTier', $pb.PbFieldType.OE, defaultOrMaker: ExecutionTemplate_ScaleTier.SCALE_TIER_UNSPECIFIED, valueOf: ExecutionTemplate_ScaleTier.valueOf, enumValues: ExecutionTemplate_ScaleTier.values)
    ..aOS(2, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'masterType')
    ..aOM<ExecutionTemplate_SchedulerAcceleratorConfig>(3, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'acceleratorConfig', subBuilder: ExecutionTemplate_SchedulerAcceleratorConfig.create)
    ..m<$core.String, $core.String>(4, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'labels', entryClassName: 'ExecutionTemplate.LabelsEntry', keyFieldType: $pb.PbFieldType.OS, valueFieldType: $pb.PbFieldType.OS, packageName: const $pb.PackageName('google.cloud.notebooks.v1'))
    ..aOS(5, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'inputNotebookFile')
    ..aOS(6, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'containerImageUri')
    ..aOS(7, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'outputNotebookFolder')
    ..aOS(8, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'paramsYamlFile')
    ..aOS(9, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'parameters')
    ..aOS(10, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'serviceAccount')
    ..e<ExecutionTemplate_JobType>(11, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'jobType', $pb.PbFieldType.OE, defaultOrMaker: ExecutionTemplate_JobType.JOB_TYPE_UNSPECIFIED, valueOf: ExecutionTemplate_JobType.valueOf, enumValues: ExecutionTemplate_JobType.values)
    ..aOM<ExecutionTemplate_DataprocParameters>(12, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'dataprocParameters', subBuilder: ExecutionTemplate_DataprocParameters.create)
    ..aOM<ExecutionTemplate_VertexAIParameters>(13, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'vertexAiParameters', subBuilder: ExecutionTemplate_VertexAIParameters.create)
    ..aOS(14, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'kernelSpec')
    ..aOS(15, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'tensorboard')
    ..hasRequiredFields = false
  ;
  ...
  @$core.Deprecated('This field is deprecated.')
    ...
    if (vertexAiParameters != null) {
      _result.vertexAiParameters = vertexAiParameters;
    }
    if (kernelSpec != null) {
      _result.kernelSpec = kernelSpec;
    }
    if (tensorboard != null) {
  ...
  'Use [GeneratedMessageGenericExtensions.rebuild] instead. '
  'Will be removed in next major version')
  ExecutionTemplate copyWith(void Function(ExecutionTemplate) updates) => super.copyWith((message) => updates(message as ExecutionTemplate)) as ExecutionTemplate; // ignore: deprecated_member_use
  $pb.BuilderInfo get info_ => _i;
  @$core.pragma('dart2js:noInline')
...
class Execution extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'Execution', package: const $pb.PackageName(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'google.cloud.notebooks.v1'), createEmptyInstance: create)
    ..aOM<ExecutionTemplate>(1, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'executionTemplate', subBuilder: ExecutionTemplate.create)
    ...
    ..e<Execution_State>(7, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'state', $pb.PbFieldType.OE, defaultOrMaker: Execution_State.STATE_UNSPECIFIED, valueOf: Execution_State.valueOf, enumValues: Execution_State.values)
    ..aOS(8, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'outputNotebookFile')
    ..aOS(9, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'jobUri')
    ..hasRequiredFields = false
  ;

...
const AuditLog$json = const {
  ...
  '2': const [
    ...
    const {'1': 'resource_location', '3': 20, '4': 1, '5': 11, '6': '.google.cloud.audit.ResourceLocation', '10': 'resourceLocation'},
...
final $typed_data.Uint8List auditLogDescriptor = $convert.base64Decode('');
...
const AuthenticationInfo$json = const {
  ...
  '2': const [
    ...
    const {'1': 'service_account_delegation_info', '3': 6, '4': 3, '5': 11, '6': '.google.cloud.audit.ServiceAccountDelegationInfo', '10': 'serviceAccountDelegationInfo'},
...
final $typed_data.Uint8List authenticationInfoDescriptor = $convert.base64Decode('');
...
const ServiceAccountDelegationInfo$json = const {
  ...
  '2': const [
    const {'1': 'principal_subject', '3': 3, '4': 1, '5': 9, '10': 'principalSubject'},
    const {'1': 'first_party_principal', '3': 1, '4': 1, '5': 11, '6': '.google.cloud.audit.ServiceAccountDelegationInfo.FirstPartyPrincipal', '9': 0, '10': 'firstPartyPrincipal'},
    const {'1': 'third_party_principal', '3': 2, '4': 1, '5': 11, '6': '.google.cloud.audit.ServiceAccountDelegationInfo.ThirdPartyPrincipal', '9': 0, '10': 'thirdPartyPrincipal'},
  ],
...
final $typed_data.Uint8List serviceAccountDelegationInfoDescriptor = $convert.base64Decode('');

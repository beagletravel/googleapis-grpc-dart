...
class EngineCallLog_CallArg extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'EngineCallLog.CallArg', package: const $pb.PackageName(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'google.cloud.workflows.type'), createEmptyInstance: create)
  ...
  'Will be removed in next major version')
  EngineCallLog_CallArg copyWith(void Function(EngineCallLog_CallArg) updates) => super.copyWith((message) => updates(message as EngineCallLog_CallArg)) as EngineCallLog_CallArg; // ignore: deprecated_member_use
...
class EngineCallLog_Begun extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'EngineCallLog.Begun', package: const $pb.PackageName(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'google.cloud.workflows.type'), createEmptyInstance: create)
    ..pc<EngineCallLog_CallArg>(1, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'args', $pb.PbFieldType.PM, subBuilder: EngineCallLog_CallArg.create)
    ..m<$core.String, $1.Value>(2, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'namedArgs', entryClassName: 'EngineCallLog.Begun.NamedArgsEntry', keyFieldType: $pb.PbFieldType.OS, valueFieldType: $pb.PbFieldType.OM, valueCreator: $1.Value.create, packageName: const $pb.PackageName('google.cloud.workflows.type'))
    ..hasRequiredFields = false
  ;
  ...
  factory EngineCallLog_Begun({
    ...
    $core.Map<$core.String, $1.Value>? namedArgs,
  }) {
    final _result = create();
    if (args != null) {
    ...
    if (namedArgs != null) {
      _result.namedArgs.addAll(namedArgs);
    }
    return _result;
  }
  ...
  'Use [GeneratedMessageGenericExtensions.rebuild] instead. '
  'Will be removed in next major version')
  EngineCallLog_Begun copyWith(void Function(EngineCallLog_Begun) updates) => super.copyWith((message) => updates(message as EngineCallLog_Begun)) as EngineCallLog_Begun; // ignore: deprecated_member_use
  $pb.BuilderInfo get info_ => _i;
  @$core.pragma('dart2js:noInline')
  ...
  @$pb.TagNumber(2)
  $core.Map<$core.String, $1.Value> get namedArgs => $_getMap(1);
}

class EngineCallLog_Succeeded extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'EngineCallLog.Succeeded', package: const $pb.PackageName(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'google.cloud.workflows.type'), createEmptyInstance: create)
    ..aOM<$0.Timestamp>(1, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'callStartTime', subBuilder: $0.Timestamp.create)
  ...
  'Use [GeneratedMessageGenericExtensions.rebuild] instead. '
  'Will be removed in next major version')
  EngineCallLog_Succeeded copyWith(void Function(EngineCallLog_Succeeded) updates) => super.copyWith((message) => updates(message as EngineCallLog_Succeeded)) as EngineCallLog_Succeeded; // ignore: deprecated_member_use
  $pb.BuilderInfo get info_ => _i;
  @$core.pragma('dart2js:noInline')
  ...
  @$pb.TagNumber(1)
  set callStartTime($0.Timestamp v) { setField(1, v); }
  @$pb.TagNumber(1)
...
class EngineCallLog_ExceptionRaised extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'EngineCallLog.ExceptionRaised', package: const $pb.PackageName(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'google.cloud.workflows.type'), createEmptyInstance: create)
    ..aOM<$0.Timestamp>(1, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'callStartTime', subBuilder: $0.Timestamp.create)
    ..aOS(2, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'exception')
    ..aOS(3, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'origin')
    ..hasRequiredFields = false
  ;
  ...
  'Use [GeneratedMessageGenericExtensions.rebuild] instead. '
  'Will be removed in next major version')
  EngineCallLog_ExceptionRaised copyWith(void Function(EngineCallLog_ExceptionRaised) updates) => super.copyWith((message) => updates(message as EngineCallLog_ExceptionRaised)) as EngineCallLog_ExceptionRaised; // ignore: deprecated_member_use
  $pb.BuilderInfo get info_ => _i;
  @$core.pragma('dart2js:noInline')
...
class EngineCallLog_ExceptionHandled extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'EngineCallLog.ExceptionHandled', package: const $pb.PackageName(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'google.cloud.workflows.type'), createEmptyInstance: create)
    ..aOM<$0.Timestamp>(1, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'callStartTime', subBuilder: $0.Timestamp.create)
    ..aOS(2, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'exception')
    ..aOS(3, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'origin')
    ..hasRequiredFields = false
  ...
  'Use [GeneratedMessageGenericExtensions.rebuild] instead. '
  'Will be removed in next major version')
  EngineCallLog_ExceptionHandled copyWith(void Function(EngineCallLog_ExceptionHandled) updates) => super.copyWith((message) => updates(message as EngineCallLog_ExceptionHandled)) as EngineCallLog_ExceptionHandled; // ignore: deprecated_member_use
  $pb.BuilderInfo get info_ => _i;
  @$core.pragma('dart2js:noInline')
...
class EngineCallLog extends $pb.GeneratedMessage {
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'EngineCallLog', package: const $pb.PackageName(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'google.cloud.workflows.type'), createEmptyInstance: create)
    ..oo(0, [6, 7, 8, 9])
    ..aOS(1, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'executionId')
    ..aOM<$0.Timestamp>(2, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'activityTime', subBuilder: $0.Timestamp.create)
    ..e<EngineCallLog_State>(3, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'state', $pb.PbFieldType.OE, defaultOrMaker: EngineCallLog_State.STATE_UNSPECIFIED, valueOf: EngineCallLog_State.valueOf, enumValues: EngineCallLog_State.values)
    ..aOS(4, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'step')
    ..aOS(5, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'callee')
    ..aOM<EngineCallLog_Begun>(6, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'begun', subBuilder: EngineCallLog_Begun.create)
    ..aOM<EngineCallLog_Succeeded>(7, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'succeeded', subBuilder: EngineCallLog_Succeeded.create)
    ..aOM<EngineCallLog_ExceptionRaised>(8, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'exceptionRaised', subBuilder: EngineCallLog_ExceptionRaised.create)
    ..aOM<EngineCallLog_ExceptionHandled>(9, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'exceptionHandled', subBuilder: EngineCallLog_ExceptionHandled.create)
    ..hasRequiredFields = false
  ;
  ...
  factory EngineCallLog({
    ...
    if (exceptionHandled != null) {
      _result.exceptionHandled = exceptionHandled;
    }
    return _result;
  }
  ...
  'Use [GeneratedMessageGenericExtensions.rebuild] instead. '
  'Will be removed in next major version')
  EngineCallLog copyWith(void Function(EngineCallLog) updates) => super.copyWith((message) => updates(message as EngineCallLog)) as EngineCallLog; // ignore: deprecated_member_use
  $pb.BuilderInfo get info_ => _i;
  @$core.pragma('dart2js:noInline')
  ...
  @$pb.TagNumber(2)
  set activityTime($0.Timestamp v) { setField(2, v); }
  @$pb.TagNumber(2)

...
class ExecutionsSystemLog_Start extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'ExecutionsSystemLog.Start', package: const $pb.PackageName(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'google.cloud.workflows.type'), createEmptyInstance: create)
    ..aOS(2, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'argument')
  ...
  'Will be removed in next major version')
  ExecutionsSystemLog_Start copyWith(void Function(ExecutionsSystemLog_Start) updates) => super.copyWith((message) => updates(message as ExecutionsSystemLog_Start)) as ExecutionsSystemLog_Start; // ignore: deprecated_member_use
...
class ExecutionsSystemLog_Success extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'ExecutionsSystemLog.Success', package: const $pb.PackageName(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'google.cloud.workflows.type'), createEmptyInstance: create)
  ...
  'Use [GeneratedMessageGenericExtensions.rebuild] instead. '
  'Will be removed in next major version')
  ExecutionsSystemLog_Success copyWith(void Function(ExecutionsSystemLog_Success) updates) => super.copyWith((message) => updates(message as ExecutionsSystemLog_Success)) as ExecutionsSystemLog_Success; // ignore: deprecated_member_use
  $pb.BuilderInfo get info_ => _i;
  @$core.pragma('dart2js:noInline')
...
class ExecutionsSystemLog_Failure extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'ExecutionsSystemLog.Failure', package: const $pb.PackageName(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'google.cloud.workflows.type'), createEmptyInstance: create)
  ...
  'Use [GeneratedMessageGenericExtensions.rebuild] instead. '
  'Will be removed in next major version')
  ExecutionsSystemLog_Failure copyWith(void Function(ExecutionsSystemLog_Failure) updates) => super.copyWith((message) => updates(message as ExecutionsSystemLog_Failure)) as ExecutionsSystemLog_Failure; // ignore: deprecated_member_use
  $pb.BuilderInfo get info_ => _i;
  @$core.pragma('dart2js:noInline')
...
class ExecutionsSystemLog extends $pb.GeneratedMessage {
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'ExecutionsSystemLog', package: const $pb.PackageName(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'google.cloud.workflows.type'), createEmptyInstance: create)
    ..oo(0, [4, 5, 6])
    ...
    ..e<ExecutionsSystemLog_State>(3, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'state', $pb.PbFieldType.OE, defaultOrMaker: ExecutionsSystemLog_State.STATE_UNSPECIFIED, valueOf: ExecutionsSystemLog_State.valueOf, enumValues: ExecutionsSystemLog_State.values)
    ..aOM<ExecutionsSystemLog_Start>(4, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'start', subBuilder: ExecutionsSystemLog_Start.create)
    ..aOM<ExecutionsSystemLog_Success>(5, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'success', subBuilder: ExecutionsSystemLog_Success.create)
    ..aOM<ExecutionsSystemLog_Failure>(6, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'failure', subBuilder: ExecutionsSystemLog_Failure.create)
    ..hasRequiredFields = false
  ;
  ...
  'Use [GeneratedMessageGenericExtensions.rebuild] instead. '
  'Will be removed in next major version')
  ExecutionsSystemLog copyWith(void Function(ExecutionsSystemLog) updates) => super.copyWith((message) => updates(message as ExecutionsSystemLog)) as ExecutionsSystemLog; // ignore: deprecated_member_use
  $pb.BuilderInfo get info_ => _i;
  @$core.pragma('dart2js:noInline')

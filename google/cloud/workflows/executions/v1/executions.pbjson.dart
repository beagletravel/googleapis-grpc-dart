...
final $typed_data.Uint8List executionViewDescriptor = $convert.base64Decode('Cg1FeGVjdXRpb25WaWV3Eh4KGkVYRUNVVElPTl9WSUVXX1VOU1BFQ0lGSUVEEAASCQoFQkFTSUMQARIICgRGVUxMEAI=');
...
const Execution$json = const {
  ...
  '2': const [
    ...
    const {'1': 'state', '3': 4, '4': 1, '5': 14, '6': '.google.cloud.workflows.executions.v1.Execution.State', '8': const {}, '10': 'state'},
    const {'1': 'argument', '3': 5, '4': 1, '5': 9, '10': 'argument'},
    const {'1': 'result', '3': 6, '4': 1, '5': 9, '8': const {}, '10': 'result'},
    const {'1': 'error', '3': 7, '4': 1, '5': 11, '6': '.google.cloud.workflows.executions.v1.Execution.Error', '8': const {}, '10': 'error'},
    const {'1': 'workflow_revision_id', '3': 8, '4': 1, '5': 9, '8': const {}, '10': 'workflowRevisionId'},
    const {'1': 'call_log_level', '3': 9, '4': 1, '5': 14, '6': '.google.cloud.workflows.executions.v1.Execution.CallLogLevel', '10': 'callLogLevel'},
  ],
  '3': const [Execution_StackTraceElement$json, Execution_StackTrace$json, Execution_Error$json],
...
const Execution_StackTraceElement$json = const {
  ...
  '2': const [
    ...
    const {'1': 'position', '3': 3, '4': 1, '5': 11, '6': '.google.cloud.workflows.executions.v1.Execution.StackTraceElement.Position', '10': 'position'},
  ],
...
const Execution_StackTrace$json = const {
  '1': 'StackTrace',
  '2': const [
    const {'1': 'elements', '3': 1, '4': 3, '5': 11, '6': '.google.cloud.workflows.executions.v1.Execution.StackTraceElement', '10': 'elements'},
  ],
};
...
const Execution_Error$json = const {
  ...
  '2': const [
    ...
    const {'1': 'stack_trace', '3': 3, '4': 1, '5': 11, '6': '.google.cloud.workflows.executions.v1.Execution.StackTrace', '10': 'stackTrace'},
  ],
};
...
const ListExecutionsRequest$json = const {
  ...
  '2': const [
    ...
    const {'1': 'view', '3': 4, '4': 1, '5': 14, '6': '.google.cloud.workflows.executions.v1.ExecutionView', '8': const {}, '10': 'view'},
  ],
};

/// Descriptor for `ListExecutionsRequest`. Decode as a `google.protobuf.DescriptorProto`.
final $typed_data.Uint8List listExecutionsRequestDescriptor = $convert.base64Decode('');
...
const ListExecutionsResponse$json = const {
  ...
  '2': const [
    const {'1': 'executions', '3': 1, '4': 3, '5': 11, '6': '.google.cloud.workflows.executions.v1.Execution', '10': 'executions'},
    const {'1': 'next_page_token', '3': 2, '4': 1, '5': 9, '10': 'nextPageToken'},
  ],
};

/// Descriptor for `ListExecutionsResponse`. Decode as a `google.protobuf.DescriptorProto`.
final $typed_data.Uint8List listExecutionsResponseDescriptor = $convert.base64Decode('ChZMaXN0RXhlY3V0aW9uc1Jlc3BvbnNlEk8KCmV4ZWN1dGlvbnMYASADKAsyLy5nb29nbGUuY2xvdWQud29ya2Zsb3dzLmV4ZWN1dGlvbnMudjEuRXhlY3V0aW9uUgpleGVjdXRpb25zEiYKD25leHRfcGFnZV90b2tlbhgCIAEoCVINbmV4dFBhZ2VUb2tlbg==');
...
const CreateExecutionRequest$json = const {
  ...
  '2': const [
    const {'1': 'parent', '3': 1, '4': 1, '5': 9, '8': const {}, '10': 'parent'},
    const {'1': 'execution', '3': 2, '4': 1, '5': 11, '6': '.google.cloud.workflows.executions.v1.Execution', '8': const {}, '10': 'execution'},
  ],
};

/// Descriptor for `CreateExecutionRequest`. Decode as a `google.protobuf.DescriptorProto`.
final $typed_data.Uint8List createExecutionRequestDescriptor = $convert.base64Decode('ChZDcmVhdGVFeGVjdXRpb25SZXF1ZXN0EkEKBnBhcmVudBgBIAEoCUIp4EEC+kEjCiF3b3JrZmxvd3MuZ29vZ2xlYXBpcy5jb20vV29ya2Zsb3dSBnBhcmVudBJSCglleGVjdXRpb24YAiABKAsyLy5nb29nbGUuY2xvdWQud29ya2Zsb3dzLmV4ZWN1dGlvbnMudjEuRXhlY3V0aW9uQgPgQQJSCWV4ZWN1dGlvbg==');
@$core.Deprecated('Use getExecutionRequestDescriptor instead')
const GetExecutionRequest$json = const {
  '1': 'GetExecutionRequest',
  '2': const [
    const {'1': 'name', '3': 1, '4': 1, '5': 9, '8': const {}, '10': 'name'},
    const {'1': 'view', '3': 2, '4': 1, '5': 14, '6': '.google.cloud.workflows.executions.v1.ExecutionView', '8': const {}, '10': 'view'},
  ],
};

/// Descriptor for `GetExecutionRequest`. Decode as a `google.protobuf.DescriptorProto`.
final $typed_data.Uint8List getExecutionRequestDescriptor = $convert.base64Decode('ChNHZXRFeGVjdXRpb25SZXF1ZXN0EkcKBG5hbWUYASABKAlCM+BBAvpBLQord29ya2Zsb3dleGVjdXRpb25zLmdvb2dsZWFwaXMuY29tL0V4ZWN1dGlvblIEbmFtZRJMCgR2aWV3GAIgASgOMjMuZ29vZ2xlLmNsb3VkLndvcmtmbG93cy5leGVjdXRpb25zLnYxLkV4ZWN1dGlvblZpZXdCA+BBAVIEdmlldw==');
...
final $typed_data.Uint8List cancelExecutionRequestDescriptor = $convert.base64Decode('ChZDYW5jZWxFeGVjdXRpb25SZXF1ZXN0EkcKBG5hbWUYASABKAlCM+BBAvpBLQord29ya2Zsb3dleGVjdXRpb25zLmdvb2dsZWFwaXMuY29tL0V4ZWN1dGlvblIEbmFtZQ==');

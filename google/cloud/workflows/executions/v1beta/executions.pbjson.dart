...
const Execution$json = const {
  ...
  '2': const [
    ...
    const {'1': 'state', '3': 4, '4': 1, '5': 14, '6': '.google.cloud.workflows.executions.v1beta.Execution.State', '8': const {}, '10': 'state'},
    const {'1': 'argument', '3': 5, '4': 1, '5': 9, '10': 'argument'},
    const {'1': 'result', '3': 6, '4': 1, '5': 9, '8': const {}, '10': 'result'},
    const {'1': 'error', '3': 7, '4': 1, '5': 11, '6': '.google.cloud.workflows.executions.v1beta.Execution.Error', '8': const {}, '10': 'error'},
...
const ListExecutionsRequest$json = const {
  ...
  '2': const [
    ...
    const {'1': 'view', '3': 4, '4': 1, '5': 14, '6': '.google.cloud.workflows.executions.v1beta.ExecutionView', '8': const {}, '10': 'view'},
  ],
};

/// Descriptor for `ListExecutionsRequest`. Decode as a `google.protobuf.DescriptorProto`.
final $typed_data.Uint8List listExecutionsRequestDescriptor = $convert.base64Decode('');
...
const ListExecutionsResponse$json = const {
  ...
  '2': const [
    const {'1': 'executions', '3': 1, '4': 3, '5': 11, '6': '.google.cloud.workflows.executions.v1beta.Execution', '10': 'executions'},
    const {'1': 'next_page_token', '3': 2, '4': 1, '5': 9, '10': 'nextPageToken'},
  ],
};

/// Descriptor for `ListExecutionsResponse`. Decode as a `google.protobuf.DescriptorProto`.
final $typed_data.Uint8List listExecutionsResponseDescriptor = $convert.base64Decode('ChZMaXN0RXhlY3V0aW9uc1Jlc3BvbnNlElMKCmV4ZWN1dGlvbnMYASADKAsyMy5nb29nbGUuY2xvdWQud29ya2Zsb3dzLmV4ZWN1dGlvbnMudjFiZXRhLkV4ZWN1dGlvblIKZXhlY3V0aW9ucxImCg9uZXh0X3BhZ2VfdG9rZW4YAiABKAlSDW5leHRQYWdlVG9rZW4=');
...
const CreateExecutionRequest$json = const {
  ...
  '2': const [
    const {'1': 'parent', '3': 1, '4': 1, '5': 9, '8': const {}, '10': 'parent'},
    const {'1': 'execution', '3': 2, '4': 1, '5': 11, '6': '.google.cloud.workflows.executions.v1beta.Execution', '8': const {}, '10': 'execution'},
  ],
};

/// Descriptor for `CreateExecutionRequest`. Decode as a `google.protobuf.DescriptorProto`.
final $typed_data.Uint8List createExecutionRequestDescriptor = $convert.base64Decode('ChZDcmVhdGVFeGVjdXRpb25SZXF1ZXN0EkEKBnBhcmVudBgBIAEoCUIp4EEC+kEjCiF3b3JrZmxvd3MuZ29vZ2xlYXBpcy5jb20vV29ya2Zsb3dSBnBhcmVudBJWCglleGVjdXRpb24YAiABKAsyMy5nb29nbGUuY2xvdWQud29ya2Zsb3dzLmV4ZWN1dGlvbnMudjFiZXRhLkV4ZWN1dGlvbkID4EECUglleGVjdXRpb24=');
@$core.Deprecated('Use getExecutionRequestDescriptor instead')
const GetExecutionRequest$json = const {
  '1': 'GetExecutionRequest',
  '2': const [
    const {'1': 'name', '3': 1, '4': 1, '5': 9, '8': const {}, '10': 'name'},
    const {'1': 'view', '3': 2, '4': 1, '5': 14, '6': '.google.cloud.workflows.executions.v1beta.ExecutionView', '8': const {}, '10': 'view'},
  ],
};

/// Descriptor for `GetExecutionRequest`. Decode as a `google.protobuf.DescriptorProto`.
final $typed_data.Uint8List getExecutionRequestDescriptor = $convert.base64Decode('ChNHZXRFeGVjdXRpb25SZXF1ZXN0EkcKBG5hbWUYASABKAlCM+BBAvpBLQord29ya2Zsb3dleGVjdXRpb25zLmdvb2dsZWFwaXMuY29tL0V4ZWN1dGlvblIEbmFtZRJQCgR2aWV3GAIgASgOMjcuZ29vZ2xlLmNsb3VkLndvcmtmbG93cy5leGVjdXRpb25zLnYxYmV0YS5FeGVjdXRpb25WaWV3QgPgQQFSBHZpZXc=');

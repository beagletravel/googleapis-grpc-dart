...
const Workflow$json = const {
  ...
  '2': const [
    ...
    const {'1': 'state', '3': 3, '4': 1, '5': 14, '6': '.google.cloud.workflows.v1.Workflow.State', '8': const {}, '10': 'state'},
    ...
    const {'1': 'labels', '3': 8, '4': 3, '5': 11, '6': '.google.cloud.workflows.v1.Workflow.LabelsEntry', '10': 'labels'},
...
const ListWorkflowsResponse$json = const {
  ...
  '2': const [
    const {'1': 'workflows', '3': 1, '4': 3, '5': 11, '6': '.google.cloud.workflows.v1.Workflow', '10': 'workflows'},
...
final $typed_data.Uint8List listWorkflowsResponseDescriptor = $convert.base64Decode('ChVMaXN0V29ya2Zsb3dzUmVzcG9uc2USQQoJd29ya2Zsb3dzGAEgAygLMiMuZ29vZ2xlLmNsb3VkLndvcmtmbG93cy52MS5Xb3JrZmxvd1IJd29ya2Zsb3dzEiYKD25leHRfcGFnZV90b2tlbhgCIAEoCVINbmV4dFBhZ2VUb2tlbhIgCgt1bnJlYWNoYWJsZRgDIAMoCVILdW5yZWFjaGFibGU=');
...
const CreateWorkflowRequest$json = const {
  ...
  '2': const [
    const {'1': 'parent', '3': 1, '4': 1, '5': 9, '8': const {}, '10': 'parent'},
    const {'1': 'workflow', '3': 2, '4': 1, '5': 11, '6': '.google.cloud.workflows.v1.Workflow', '8': const {}, '10': 'workflow'},
...
final $typed_data.Uint8List createWorkflowRequestDescriptor = $convert.base64Decode('');
...
const UpdateWorkflowRequest$json = const {
  ...
  '2': const [
    const {'1': 'workflow', '3': 1, '4': 1, '5': 11, '6': '.google.cloud.workflows.v1.Workflow', '8': const {}, '10': 'workflow'},
    const {'1': 'update_mask', '3': 2, '4': 1, '5': 11, '6': '.google.protobuf.FieldMask', '10': 'updateMask'},
  ],
};

/// Descriptor for `UpdateWorkflowRequest`. Decode as a `google.protobuf.DescriptorProto`.
final $typed_data.Uint8List updateWorkflowRequestDescriptor = $convert.base64Decode('ChVVcGRhdGVXb3JrZmxvd1JlcXVlc3QSRAoId29ya2Zsb3cYASABKAsyIy5nb29nbGUuY2xvdWQud29ya2Zsb3dzLnYxLldvcmtmbG93QgPgQQJSCHdvcmtmbG93EjsKC3VwZGF0ZV9tYXNrGAIgASgLMhouZ29vZ2xlLnByb3RvYnVmLkZpZWxkTWFza1IKdXBkYXRlTWFzaw==');

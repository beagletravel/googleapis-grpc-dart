...
class Workflow_State extends $pb.ProtobufEnum {
  static const Workflow_State STATE_UNSPECIFIED = Workflow_State._(0, const $core.bool.fromEnvironment('protobuf.omit_enum_names') ? '' : 'STATE_UNSPECIFIED');
  static const Workflow_State ACTIVE = Workflow_State._(1, const $core.bool.fromEnvironment('protobuf.omit_enum_names') ? '' : 'ACTIVE');

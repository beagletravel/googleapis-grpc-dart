...
class Constraint_ListConstraint extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'Constraint.ListConstraint', package: const $pb.PackageName(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'google.cloud.orgpolicy.v2'), createEmptyInstance: create)
    ..aOB(1, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'supportsIn')
    ..aOB(2, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'supportsUnder')
  ...
  'Will be removed in next major version')
  Constraint_ListConstraint copyWith(void Function(Constraint_ListConstraint) updates) => super.copyWith((message) => updates(message as Constraint_ListConstraint)) as Constraint_ListConstraint; // ignore: deprecated_member_use
...
class Constraint_BooleanConstraint extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'Constraint.BooleanConstraint', package: const $pb.PackageName(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'google.cloud.orgpolicy.v2'), createEmptyInstance: create)
    ..hasRequiredFields = false
  ;
  ...
  'Use [GeneratedMessageGenericExtensions.rebuild] instead. '
  'Will be removed in next major version')
  Constraint_BooleanConstraint copyWith(void Function(Constraint_BooleanConstraint) updates) => super.copyWith((message) => updates(message as Constraint_BooleanConstraint)) as Constraint_BooleanConstraint; // ignore: deprecated_member_use
  $pb.BuilderInfo get info_ => _i;
  @$core.pragma('dart2js:noInline')
...
class Constraint extends $pb.GeneratedMessage {
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'Constraint', package: const $pb.PackageName(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'google.cloud.orgpolicy.v2'), createEmptyInstance: create)
    ..oo(0, [5, 6])
    ..aOS(1, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'name')
    ..aOS(2, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'displayName')
    ..aOS(3, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'description')
    ..e<Constraint_ConstraintDefault>(4, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'constraintDefault', $pb.PbFieldType.OE, defaultOrMaker: Constraint_ConstraintDefault.CONSTRAINT_DEFAULT_UNSPECIFIED, valueOf: Constraint_ConstraintDefault.valueOf, enumValues: Constraint_ConstraintDefault.values)
    ..aOM<Constraint_ListConstraint>(5, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'listConstraint', subBuilder: Constraint_ListConstraint.create)
    ..aOM<Constraint_BooleanConstraint>(6, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'booleanConstraint', subBuilder: Constraint_BooleanConstraint.create)
    ..hasRequiredFields = false
  ;

...
class Policy_ListPolicy extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'Policy.ListPolicy', package: const $pb.PackageName(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'google.cloud.orgpolicy.v1'), createEmptyInstance: create)
    ...
    ..e<Policy_ListPolicy_AllValues>(3, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'allValues', $pb.PbFieldType.OE, defaultOrMaker: Policy_ListPolicy_AllValues.ALL_VALUES_UNSPECIFIED, valueOf: Policy_ListPolicy_AllValues.valueOf, enumValues: Policy_ListPolicy_AllValues.values)
    ..aOS(4, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'suggestedValue')
    ..aOB(5, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'inheritFromParent')
  ...
  'Will be removed in next major version')
  Policy_ListPolicy copyWith(void Function(Policy_ListPolicy) updates) => super.copyWith((message) => updates(message as Policy_ListPolicy)) as Policy_ListPolicy; // ignore: deprecated_member_use
...
class Policy_BooleanPolicy extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'Policy.BooleanPolicy', package: const $pb.PackageName(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'google.cloud.orgpolicy.v1'), createEmptyInstance: create)
    ..aOB(1, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'enforced')
    ..hasRequiredFields = false
  ;
  ...
  'Use [GeneratedMessageGenericExtensions.rebuild] instead. '
  'Will be removed in next major version')
  Policy_BooleanPolicy copyWith(void Function(Policy_BooleanPolicy) updates) => super.copyWith((message) => updates(message as Policy_BooleanPolicy)) as Policy_BooleanPolicy; // ignore: deprecated_member_use
  $pb.BuilderInfo get info_ => _i;
  @$core.pragma('dart2js:noInline')
...
class Policy_RestoreDefault extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'Policy.RestoreDefault', package: const $pb.PackageName(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'google.cloud.orgpolicy.v1'), createEmptyInstance: create)
    ..hasRequiredFields = false
  ;
  ...
  'Use [GeneratedMessageGenericExtensions.rebuild] instead. '
  'Will be removed in next major version')
  Policy_RestoreDefault copyWith(void Function(Policy_RestoreDefault) updates) => super.copyWith((message) => updates(message as Policy_RestoreDefault)) as Policy_RestoreDefault; // ignore: deprecated_member_use
  $pb.BuilderInfo get info_ => _i;
  @$core.pragma('dart2js:noInline')
...
class Policy extends $pb.GeneratedMessage {
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'Policy', package: const $pb.PackageName(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'google.cloud.orgpolicy.v1'), createEmptyInstance: create)
    ..oo(0, [5, 6, 7])
    ..a<$core.int>(1, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'version', $pb.PbFieldType.O3)
    ..aOS(2, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'constraint')
    ...
    ..aOM<Policy_ListPolicy>(5, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'listPolicy', subBuilder: Policy_ListPolicy.create)
    ..aOM<Policy_BooleanPolicy>(6, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'booleanPolicy', subBuilder: Policy_BooleanPolicy.create)
    ..aOM<Policy_RestoreDefault>(7, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'restoreDefault', subBuilder: Policy_RestoreDefault.create)
    ..hasRequiredFields = false
  ;

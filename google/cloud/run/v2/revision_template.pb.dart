...
class RevisionTemplate extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'RevisionTemplate', package: const $pb.PackageName(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'google.cloud.run.v2'), createEmptyInstance: create)
    ..aOS(1, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'revision')
    ..m<$core.String, $core.String>(2, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'labels', entryClassName: 'RevisionTemplate.LabelsEntry', keyFieldType: $pb.PbFieldType.OS, valueFieldType: $pb.PbFieldType.OS, packageName: const $pb.PackageName('google.cloud.run.v2'))
    ..m<$core.String, $core.String>(3, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'annotations', entryClassName: 'RevisionTemplate.AnnotationsEntry', keyFieldType: $pb.PbFieldType.OS, valueFieldType: $pb.PbFieldType.OS, packageName: const $pb.PackageName('google.cloud.run.v2'))
    ..aOM<$0.RevisionScaling>(4, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'scaling', subBuilder: $0.RevisionScaling.create)
    ..aOM<$0.VpcAccess>(6, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'vpcAccess', subBuilder: $0.VpcAccess.create)
    ...
    ..pc<$2.Container>(10, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'containers', $pb.PbFieldType.PM, subBuilder: $2.Container.create)
    ..pc<$2.Volume>(11, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'volumes', $pb.PbFieldType.PM, subBuilder: $2.Volume.create)
    ..e<$0.ExecutionEnvironment>(13, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'executionEnvironment', $pb.PbFieldType.OE, defaultOrMaker: $0.ExecutionEnvironment.EXECUTION_ENVIRONMENT_UNSPECIFIED, valueOf: $0.ExecutionEnvironment.valueOf, enumValues: $0.ExecutionEnvironment.values)
    ..aOS(14, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'encryptionKey')
    ..a<$core.int>(15, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'maxInstanceRequestConcurrency', $pb.PbFieldType.O3)
  ...
  'Will be removed in next major version')
  RevisionTemplate copyWith(void Function(RevisionTemplate) updates) => super.copyWith((message) => updates(message as RevisionTemplate)) as RevisionTemplate; // ignore: deprecated_member_use
  ...
  @$pb.TagNumber(4)
  set scaling($0.RevisionScaling v) { setField(4, v); }
  @$pb.TagNumber(4)
  ...
  @$pb.TagNumber(6)
  set vpcAccess($0.VpcAccess v) { setField(6, v); }
  @$pb.TagNumber(6)
  ...
  @$pb.TagNumber(13)
  set executionEnvironment($0.ExecutionEnvironment v) { setField(13, v); }
  @$pb.TagNumber(13)

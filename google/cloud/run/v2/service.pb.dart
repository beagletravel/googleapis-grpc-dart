...
class CreateServiceRequest extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'CreateServiceRequest', package: const $pb.PackageName(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'google.cloud.run.v2'), createEmptyInstance: create)
...
class UpdateServiceRequest extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'UpdateServiceRequest', package: const $pb.PackageName(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'google.cloud.run.v2'), createEmptyInstance: create)
...
class ListServicesRequest extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'ListServicesRequest', package: const $pb.PackageName(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'google.cloud.run.v2'), createEmptyInstance: create)
    ..aOS(1, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'parent')
...
class ListServicesResponse extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'ListServicesResponse', package: const $pb.PackageName(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'google.cloud.run.v2'), createEmptyInstance: create)
...
class GetServiceRequest extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'GetServiceRequest', package: const $pb.PackageName(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'google.cloud.run.v2'), createEmptyInstance: create)
...
class DeleteServiceRequest extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'DeleteServiceRequest', package: const $pb.PackageName(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'google.cloud.run.v2'), createEmptyInstance: create)
    ..aOS(1, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'name')
...
class Service extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'Service', package: const $pb.PackageName(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'google.cloud.run.v2'), createEmptyInstance: create)
    ..aOS(1, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'name')
    ...
    ..m<$core.String, $core.String>(5, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'labels', entryClassName: 'Service.LabelsEntry', keyFieldType: $pb.PbFieldType.OS, valueFieldType: $pb.PbFieldType.OS, packageName: const $pb.PackageName('google.cloud.run.v2'))
    ..m<$core.String, $core.String>(6, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'annotations', entryClassName: 'Service.AnnotationsEntry', keyFieldType: $pb.PbFieldType.OS, valueFieldType: $pb.PbFieldType.OS, packageName: const $pb.PackageName('google.cloud.run.v2'))
    ..aOM<$5.Timestamp>(7, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'createTime', subBuilder: $5.Timestamp.create)
    ..aOM<$5.Timestamp>(8, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'updateTime', subBuilder: $5.Timestamp.create)
    ..aOM<$5.Timestamp>(9, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'deleteTime', subBuilder: $5.Timestamp.create)
    ..aOM<$5.Timestamp>(10, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'expireTime', subBuilder: $5.Timestamp.create)
    ..aOS(11, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'creator')
    ..aOS(12, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'lastModifier')
    ..aOS(13, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'client')
    ..aOS(14, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'clientVersion')
    ..e<$6.IngressTraffic>(15, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'ingress', $pb.PbFieldType.OE, defaultOrMaker: $6.IngressTraffic.INGRESS_TRAFFIC_UNSPECIFIED, valueOf: $6.IngressTraffic.valueOf, enumValues: $6.IngressTraffic.values)
    ..e<$10.LaunchStage>(16, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'launchStage', $pb.PbFieldType.OE, defaultOrMaker: $10.LaunchStage.LAUNCH_STAGE_UNSPECIFIED, valueOf: $10.LaunchStage.valueOf, enumValues: $10.LaunchStage.values)
    ..aOM<$6.BinaryAuthorization>(17, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'binaryAuthorization', subBuilder: $6.BinaryAuthorization.create)
    ..aOM<$7.RevisionTemplate>(18, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'template', subBuilder: $7.RevisionTemplate.create)
    ..pc<$8.TrafficTarget>(19, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'traffic', $pb.PbFieldType.PM, subBuilder: $8.TrafficTarget.create)
    ..aInt64(30, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'observedGeneration')
    ..aOM<$9.Condition>(31, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'terminalCondition', subBuilder: $9.Condition.create)
    ..pc<$9.Condition>(32, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'conditions', $pb.PbFieldType.PM, subBuilder: $9.Condition.create)
    ..aOS(33, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'latestReadyRevision')
    ..aOS(34, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'latestCreatedRevision')
    ..pc<$8.TrafficTargetStatus>(35, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'trafficStatuses', $pb.PbFieldType.PM, subBuilder: $8.TrafficTargetStatus.create)
    ..aOS(36, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'uri')
    ..aOB(98, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'reconciling')
    ..aOS(99, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'etag')
    ..hasRequiredFields = false
  ;
  ...
  @$pb.TagNumber(8)
  set updateTime($5.Timestamp v) { setField(8, v); }
  @$pb.TagNumber(8)
  ...
  @$pb.TagNumber(9)
  set deleteTime($5.Timestamp v) { setField(9, v); }
  @$pb.TagNumber(9)
  ...
  @$pb.TagNumber(10)
  set expireTime($5.Timestamp v) { setField(10, v); }
  @$pb.TagNumber(10)
  ...
  @$pb.TagNumber(15)
  set ingress($6.IngressTraffic v) { setField(15, v); }
  @$pb.TagNumber(15)
  ...
  @$pb.TagNumber(16)
  set launchStage($10.LaunchStage v) { setField(16, v); }
  @$pb.TagNumber(16)
  ...
  @$pb.TagNumber(17)
  set binaryAuthorization($6.BinaryAuthorization v) { setField(17, v); }
  @$pb.TagNumber(17)
  ...
  @$pb.TagNumber(18)
  set template($7.RevisionTemplate v) { setField(18, v); }
  @$pb.TagNumber(18)
  ...
  @$pb.TagNumber(30)
  set observedGeneration($fixnum.Int64 v) { $_setInt64(19, v); }
  @$pb.TagNumber(30)
  ...
  @$pb.TagNumber(31)
  set terminalCondition($9.Condition v) { setField(31, v); }
  @$pb.TagNumber(31)
  ...
  @$pb.TagNumber(33)
  set latestReadyRevision($core.String v) { $_setString(22, v); }
  @$pb.TagNumber(33)
  ...
  @$pb.TagNumber(34)
  set latestCreatedRevision($core.String v) { $_setString(23, v); }
  @$pb.TagNumber(34)
  ...
  @$pb.TagNumber(36)
  set uri($core.String v) { $_setString(25, v); }
  @$pb.TagNumber(36)
  ...
  @$pb.TagNumber(98)
  set reconciling($core.bool v) { $_setBool(26, v); }
  @$pb.TagNumber(98)
  ...
  @$pb.TagNumber(99)
  set etag($core.String v) { $_setString(27, v); }
  @$pb.TagNumber(99)

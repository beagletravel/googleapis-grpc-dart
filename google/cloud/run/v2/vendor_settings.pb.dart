...
class VpcAccess extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'VpcAccess', package: const $pb.PackageName(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'google.cloud.run.v2'), createEmptyInstance: create)
    ..aOS(1, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'connector')
    ..e<VpcAccess_VpcEgress>(2, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'egress', $pb.PbFieldType.OE, defaultOrMaker: VpcAccess_VpcEgress.VPC_EGRESS_UNSPECIFIED, valueOf: VpcAccess_VpcEgress.valueOf, enumValues: VpcAccess_VpcEgress.values)
  ...
  'Will be removed in next major version')
  VpcAccess copyWith(void Function(VpcAccess) updates) => super.copyWith((message) => updates(message as VpcAccess)) as VpcAccess; // ignore: deprecated_member_use
...
class BinaryAuthorization extends $pb.GeneratedMessage {
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'BinaryAuthorization', package: const $pb.PackageName(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'google.cloud.run.v2'), createEmptyInstance: create)
    ..oo(0, [1])
    ..aOB(1, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'useDefault')
    ..aOS(2, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'breakglassJustification')
    ..hasRequiredFields = false
  ;
...
class RevisionScaling extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'RevisionScaling', package: const $pb.PackageName(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'google.cloud.run.v2'), createEmptyInstance: create)
    ..a<$core.int>(1, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'minInstanceCount', $pb.PbFieldType.O3)
    ..a<$core.int>(2, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'maxInstanceCount', $pb.PbFieldType.O3)
    ..hasRequiredFields = false
  ;
  ...
  'Use [GeneratedMessageGenericExtensions.rebuild] instead. '
  'Will be removed in next major version')
  RevisionScaling copyWith(void Function(RevisionScaling) updates) => super.copyWith((message) => updates(message as RevisionScaling)) as RevisionScaling; // ignore: deprecated_member_use
  $pb.BuilderInfo get info_ => _i;
  @$core.pragma('dart2js:noInline')

...
class Condition extends $pb.GeneratedMessage {
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'Condition', package: const $pb.PackageName(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'google.cloud.run.v2'), createEmptyInstance: create)
    ..oo(0, [6, 9, 11])
    ..aOS(1, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'type')
    ..e<Condition_State>(2, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'state', $pb.PbFieldType.OE, defaultOrMaker: Condition_State.STATE_UNSPECIFIED, valueOf: Condition_State.valueOf, enumValues: Condition_State.values)
    ..aOS(3, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'message')
    ..aOM<$0.Timestamp>(4, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'lastTransitionTime', subBuilder: $0.Timestamp.create)
    ..e<Condition_Severity>(5, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'severity', $pb.PbFieldType.OE, defaultOrMaker: Condition_Severity.SEVERITY_UNSPECIFIED, valueOf: Condition_Severity.valueOf, enumValues: Condition_Severity.values)
    ..e<Condition_CommonReason>(6, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'reason', $pb.PbFieldType.OE, defaultOrMaker: Condition_CommonReason.COMMON_REASON_UNDEFINED, valueOf: Condition_CommonReason.valueOf, enumValues: Condition_CommonReason.values)
    ..e<Condition_RevisionReason>(9, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'revisionReason', $pb.PbFieldType.OE, defaultOrMaker: Condition_RevisionReason.REVISION_REASON_UNDEFINED, valueOf: Condition_RevisionReason.valueOf, enumValues: Condition_RevisionReason.values)
    ..e<Condition_ExecutionReason>(11, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'executionReason', $pb.PbFieldType.OE, defaultOrMaker: Condition_ExecutionReason.EXECUTION_REASON_UNDEFINED, valueOf: Condition_ExecutionReason.valueOf, enumValues: Condition_ExecutionReason.values)
  ...
  @$pb.TagNumber(4)
  set lastTransitionTime($0.Timestamp v) { setField(4, v); }
  @$pb.TagNumber(4)

...
class GetRevisionRequest extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'GetRevisionRequest', package: const $pb.PackageName(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'google.cloud.run.v2'), createEmptyInstance: create)
  ...
  'Will be removed in next major version')
  GetRevisionRequest copyWith(void Function(GetRevisionRequest) updates) => super.copyWith((message) => updates(message as GetRevisionRequest)) as GetRevisionRequest; // ignore: deprecated_member_use
...
class ListRevisionsRequest extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'ListRevisionsRequest', package: const $pb.PackageName(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'google.cloud.run.v2'), createEmptyInstance: create)
  ...
  'Use [GeneratedMessageGenericExtensions.rebuild] instead. '
  'Will be removed in next major version')
  ListRevisionsRequest copyWith(void Function(ListRevisionsRequest) updates) => super.copyWith((message) => updates(message as ListRevisionsRequest)) as ListRevisionsRequest; // ignore: deprecated_member_use
  $pb.BuilderInfo get info_ => _i;
  @$core.pragma('dart2js:noInline')
...
class ListRevisionsResponse extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'ListRevisionsResponse', package: const $pb.PackageName(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'google.cloud.run.v2'), createEmptyInstance: create)
    ..pc<Revision>(1, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'revisions', $pb.PbFieldType.PM, subBuilder: Revision.create)
  ...
  'Use [GeneratedMessageGenericExtensions.rebuild] instead. '
  'Will be removed in next major version')
  ListRevisionsResponse copyWith(void Function(ListRevisionsResponse) updates) => super.copyWith((message) => updates(message as ListRevisionsResponse)) as ListRevisionsResponse; // ignore: deprecated_member_use
  $pb.BuilderInfo get info_ => _i;
  @$core.pragma('dart2js:noInline')
...
class DeleteRevisionRequest extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'DeleteRevisionRequest', package: const $pb.PackageName(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'google.cloud.run.v2'), createEmptyInstance: create)
    ..aOS(1, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'name')
  ...
  'Use [GeneratedMessageGenericExtensions.rebuild] instead. '
  'Will be removed in next major version')
  DeleteRevisionRequest copyWith(void Function(DeleteRevisionRequest) updates) => super.copyWith((message) => updates(message as DeleteRevisionRequest)) as DeleteRevisionRequest; // ignore: deprecated_member_use
  $pb.BuilderInfo get info_ => _i;
  @$core.pragma('dart2js:noInline')
...
class Revision extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'Revision', package: const $pb.PackageName(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'google.cloud.run.v2'), createEmptyInstance: create)
    ..aOS(1, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'name')
    ...
    ..m<$core.String, $core.String>(4, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'labels', entryClassName: 'Revision.LabelsEntry', keyFieldType: $pb.PbFieldType.OS, valueFieldType: $pb.PbFieldType.OS, packageName: const $pb.PackageName('google.cloud.run.v2'))
    ..m<$core.String, $core.String>(5, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'annotations', entryClassName: 'Revision.AnnotationsEntry', keyFieldType: $pb.PbFieldType.OS, valueFieldType: $pb.PbFieldType.OS, packageName: const $pb.PackageName('google.cloud.run.v2'))
    ...
    ..aOM<$3.Timestamp>(9, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'expireTime', subBuilder: $3.Timestamp.create)
    ..e<$8.LaunchStage>(10, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'launchStage', $pb.PbFieldType.OE, defaultOrMaker: $8.LaunchStage.LAUNCH_STAGE_UNSPECIFIED, valueOf: $8.LaunchStage.valueOf, enumValues: $8.LaunchStage.values)
    ..aOS(11, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'service')
    ..aOM<$4.RevisionScaling>(12, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'scaling', subBuilder: $4.RevisionScaling.create)
    ..aOM<$4.VpcAccess>(13, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'vpcAccess', subBuilder: $4.VpcAccess.create)
    ..aOM<$5.Duration>(15, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'timeout', subBuilder: $5.Duration.create)
    ..aOS(16, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'serviceAccount')
    ..pc<$6.Container>(17, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'containers', $pb.PbFieldType.PM, subBuilder: $6.Container.create)
    ..pc<$6.Volume>(18, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'volumes', $pb.PbFieldType.PM, subBuilder: $6.Volume.create)
    ..e<$4.ExecutionEnvironment>(20, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'executionEnvironment', $pb.PbFieldType.OE, defaultOrMaker: $4.ExecutionEnvironment.EXECUTION_ENVIRONMENT_UNSPECIFIED, valueOf: $4.ExecutionEnvironment.valueOf, enumValues: $4.ExecutionEnvironment.values)
    ..aOS(21, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'encryptionKey')
    ..aOB(30, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'reconciling')
    ..pc<$7.Condition>(31, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'conditions', $pb.PbFieldType.PM, subBuilder: $7.Condition.create)
    ..aInt64(32, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'observedGeneration')
    ..aOS(33, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'logUri')
    ..a<$core.int>(34, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'maxInstanceRequestConcurrency', $pb.PbFieldType.O3)
  ...
  @$pb.TagNumber(9)
  set expireTime($3.Timestamp v) { setField(9, v); }
  @$pb.TagNumber(9)
  ...
  @$pb.TagNumber(10)
  set launchStage($8.LaunchStage v) { setField(10, v); }
  @$pb.TagNumber(10)
  ...
  @$pb.TagNumber(12)
  set scaling($4.RevisionScaling v) { setField(12, v); }
  @$pb.TagNumber(12)
  ...
  @$pb.TagNumber(13)
  set vpcAccess($4.VpcAccess v) { setField(13, v); }
  @$pb.TagNumber(13)
  ...
  @$pb.TagNumber(15)
  set timeout($5.Duration v) { setField(15, v); }
  @$pb.TagNumber(15)
  ...
  @$pb.TagNumber(20)
  set executionEnvironment($4.ExecutionEnvironment v) { setField(20, v); }
  @$pb.TagNumber(20)
  ...
  @$pb.TagNumber(30)
  $core.bool get reconciling => $_getBF(19);
  @$pb.TagNumber(30)
  set reconciling($core.bool v) { $_setBool(19, v); }
  @$pb.TagNumber(30)
  $core.bool hasReconciling() => $_has(19);
  @$pb.TagNumber(30)
  void clearReconciling() => clearField(30);

  @$pb.TagNumber(31)
  $core.List<$7.Condition> get conditions => $_getList(20);
  ...
  @$pb.TagNumber(33)
  $core.String get logUri => $_getSZ(22);
  @$pb.TagNumber(33)
  set logUri($core.String v) { $_setString(22, v); }
  @$pb.TagNumber(33)
  $core.bool hasLogUri() => $_has(22);
  @$pb.TagNumber(33)
  void clearLogUri() => clearField(33);

  @$pb.TagNumber(34)
  $core.int get maxInstanceRequestConcurrency => $_getIZ(23);
  @$pb.TagNumber(34)
  set maxInstanceRequestConcurrency($core.int v) { $_setSignedInt32(23, v); }
  @$pb.TagNumber(34)
  $core.bool hasMaxInstanceRequestConcurrency() => $_has(23);
  @$pb.TagNumber(34)
  void clearMaxInstanceRequestConcurrency() => clearField(34);

  @$pb.TagNumber(99)
  $core.String get etag => $_getSZ(24);
  @$pb.TagNumber(99)
  set etag($core.String v) { $_setString(24, v); }
  @$pb.TagNumber(99)
  $core.bool hasEtag() => $_has(24);
  @$pb.TagNumber(99)

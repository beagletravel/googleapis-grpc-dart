...
class TranslateSpeechConfig extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'TranslateSpeechConfig', package: const $pb.PackageName(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'google.cloud.mediatranslation.v1alpha1'), createEmptyInstance: create)
    ..aOS(1, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'audioEncoding')
    ...
    ..pPS(6, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'alternativeSourceLanguageCodes')
  ...
  factory TranslateSpeechConfig({
    ...
    if (alternativeSourceLanguageCodes != null) {
      _result.alternativeSourceLanguageCodes.addAll(alternativeSourceLanguageCodes);
    }
    return _result;
  }
  ...
  'Will be removed in next major version')
  TranslateSpeechConfig copyWith(void Function(TranslateSpeechConfig) updates) => super.copyWith((message) => updates(message as TranslateSpeechConfig)) as TranslateSpeechConfig; // ignore: deprecated_member_use
...
class StreamingTranslateSpeechConfig extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'StreamingTranslateSpeechConfig', package: const $pb.PackageName(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'google.cloud.mediatranslation.v1alpha1'), createEmptyInstance: create)
    ..aOM<TranslateSpeechConfig>(1, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'audioConfig', subBuilder: TranslateSpeechConfig.create)
    ..aOB(2, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'singleUtterance')
    ..aOS(3, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'stability')
    ..aOS(4, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'translationMode')
    ..aOB(5, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'disableInterimResults')
    ..hasRequiredFields = false
  ;
  ...
  'Use [GeneratedMessageGenericExtensions.rebuild] instead. '
  'Will be removed in next major version')
  StreamingTranslateSpeechConfig copyWith(void Function(StreamingTranslateSpeechConfig) updates) => super.copyWith((message) => updates(message as StreamingTranslateSpeechConfig)) as StreamingTranslateSpeechConfig; // ignore: deprecated_member_use
  $pb.BuilderInfo get info_ => _i;
  @$core.pragma('dart2js:noInline')
...
class StreamingTranslateSpeechRequest extends $pb.GeneratedMessage {
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'StreamingTranslateSpeechRequest', package: const $pb.PackageName(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'google.cloud.mediatranslation.v1alpha1'), createEmptyInstance: create)
    ..oo(0, [1, 2])
    ..aOM<StreamingTranslateSpeechConfig>(1, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'streamingConfig', subBuilder: StreamingTranslateSpeechConfig.create)
  ...
  'Use [GeneratedMessageGenericExtensions.rebuild] instead. '
  'Will be removed in next major version')
  StreamingTranslateSpeechRequest copyWith(void Function(StreamingTranslateSpeechRequest) updates) => super.copyWith((message) => updates(message as StreamingTranslateSpeechRequest)) as StreamingTranslateSpeechRequest; // ignore: deprecated_member_use
  $pb.BuilderInfo get info_ => _i;
  @$core.pragma('dart2js:noInline')
...
class StreamingTranslateSpeechResult_TextTranslationResult extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'StreamingTranslateSpeechResult.TextTranslationResult', package: const $pb.PackageName(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'google.cloud.mediatranslation.v1alpha1'), createEmptyInstance: create)
    ..aOS(1, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'translation')
  ...
  'Use [GeneratedMessageGenericExtensions.rebuild] instead. '
  'Will be removed in next major version')
  StreamingTranslateSpeechResult_TextTranslationResult copyWith(void Function(StreamingTranslateSpeechResult_TextTranslationResult) updates) => super.copyWith((message) => updates(message as StreamingTranslateSpeechResult_TextTranslationResult)) as StreamingTranslateSpeechResult_TextTranslationResult; // ignore: deprecated_member_use
  $pb.BuilderInfo get info_ => _i;
  @$core.pragma('dart2js:noInline')
...
class StreamingTranslateSpeechResult_AudioTranslationResult extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'StreamingTranslateSpeechResult.AudioTranslationResult', package: const $pb.PackageName(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'google.cloud.mediatranslation.v1alpha1'), createEmptyInstance: create)
    ..a<$core.List<$core.int>>(1, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'audioTranslation', $pb.PbFieldType.OY)
    ..hasRequiredFields = false
  ;
  ...
  'Use [GeneratedMessageGenericExtensions.rebuild] instead. '
  'Will be removed in next major version')
  StreamingTranslateSpeechResult_AudioTranslationResult copyWith(void Function(StreamingTranslateSpeechResult_AudioTranslationResult) updates) => super.copyWith((message) => updates(message as StreamingTranslateSpeechResult_AudioTranslationResult)) as StreamingTranslateSpeechResult_AudioTranslationResult; // ignore: deprecated_member_use
  $pb.BuilderInfo get info_ => _i;
  @$core.pragma('dart2js:noInline')
...
class StreamingTranslateSpeechResult extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'StreamingTranslateSpeechResult', package: const $pb.PackageName(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'google.cloud.mediatranslation.v1alpha1'), createEmptyInstance: create)
    ..aOM<StreamingTranslateSpeechResult_TextTranslationResult>(1, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'textTranslationResult', subBuilder: StreamingTranslateSpeechResult_TextTranslationResult.create)
    ..aOM<StreamingTranslateSpeechResult_AudioTranslationResult>(2, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'audioTranslationResult', subBuilder: StreamingTranslateSpeechResult_AudioTranslationResult.create)
    ..aOS(3, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'recognitionResult')
    ..aOS(4, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'detectedSourceLanguageCode')
    ..hasRequiredFields = false
  ;
  ...
  'Use [GeneratedMessageGenericExtensions.rebuild] instead. '
  'Will be removed in next major version')
  StreamingTranslateSpeechResult copyWith(void Function(StreamingTranslateSpeechResult) updates) => super.copyWith((message) => updates(message as StreamingTranslateSpeechResult)) as StreamingTranslateSpeechResult; // ignore: deprecated_member_use
  $pb.BuilderInfo get info_ => _i;
  @$core.pragma('dart2js:noInline')
...
class StreamingTranslateSpeechResponse extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'StreamingTranslateSpeechResponse', package: const $pb.PackageName(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'google.cloud.mediatranslation.v1alpha1'), createEmptyInstance: create)
    ..aOM<$1.Status>(1, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'error', subBuilder: $1.Status.create)
    ..aOM<StreamingTranslateSpeechResult>(2, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'result', subBuilder: StreamingTranslateSpeechResult.create)
    ..e<StreamingTranslateSpeechResponse_SpeechEventType>(3, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'speechEventType', $pb.PbFieldType.OE, defaultOrMaker: StreamingTranslateSpeechResponse_SpeechEventType.SPEECH_EVENT_TYPE_UNSPECIFIED, valueOf: StreamingTranslateSpeechResponse_SpeechEventType.valueOf, enumValues: StreamingTranslateSpeechResponse_SpeechEventType.values)
    ..hasRequiredFields = false
  ;
  ...
  'Use [GeneratedMessageGenericExtensions.rebuild] instead. '
  'Will be removed in next major version')
  StreamingTranslateSpeechResponse copyWith(void Function(StreamingTranslateSpeechResponse) updates) => super.copyWith((message) => updates(message as StreamingTranslateSpeechResponse)) as StreamingTranslateSpeechResponse; // ignore: deprecated_member_use
  $pb.BuilderInfo get info_ => _i;
  @$core.pragma('dart2js:noInline')

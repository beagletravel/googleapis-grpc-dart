...
class StreamingTranslateSpeechResponse_SpeechEventType extends $pb.ProtobufEnum {
  static const StreamingTranslateSpeechResponse_SpeechEventType SPEECH_EVENT_TYPE_UNSPECIFIED = StreamingTranslateSpeechResponse_SpeechEventType._(0, const $core.bool.fromEnvironment('protobuf.omit_enum_names') ? '' : 'SPEECH_EVENT_TYPE_UNSPECIFIED');
  static const StreamingTranslateSpeechResponse_SpeechEventType END_OF_SINGLE_UTTERANCE = StreamingTranslateSpeechResponse_SpeechEventType._(1, const $core.bool.fromEnvironment('protobuf.omit_enum_names') ? '' : 'END_OF_SINGLE_UTTERANCE');

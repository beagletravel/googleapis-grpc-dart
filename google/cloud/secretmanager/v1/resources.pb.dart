...
class Secret extends $pb.GeneratedMessage {
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'Secret', package: const $pb.PackageName(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'google.cloud.secretmanager.v1'), createEmptyInstance: create)
    ..oo(0, [6, 7])
    ..aOS(1, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'name')
    ..aOM<Replication>(2, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'replication', subBuilder: Replication.create)
    ..aOM<$0.Timestamp>(3, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'createTime', subBuilder: $0.Timestamp.create)
    ..m<$core.String, $core.String>(4, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'labels', entryClassName: 'Secret.LabelsEntry', keyFieldType: $pb.PbFieldType.OS, valueFieldType: $pb.PbFieldType.OS, packageName: const $pb.PackageName('google.cloud.secretmanager.v1'))
    ..pc<Topic>(5, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'topics', $pb.PbFieldType.PM, subBuilder: Topic.create)
    ..aOM<$0.Timestamp>(6, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'expireTime', subBuilder: $0.Timestamp.create)
    ..aOM<$1.Duration>(7, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'ttl', subBuilder: $1.Duration.create)
    ..aOS(8, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'etag')
    ..aOM<Rotation>(9, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'rotation', subBuilder: Rotation.create)
    ..m<$core.String, $fixnum.Int64>(11, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'versionAliases', entryClassName: 'Secret.VersionAliasesEntry', keyFieldType: $pb.PbFieldType.OS, valueFieldType: $pb.PbFieldType.O6, packageName: const $pb.PackageName('google.cloud.secretmanager.v1'))
  ...
  @$pb.TagNumber(6)
  set expireTime($0.Timestamp v) { setField(6, v); }
  @$pb.TagNumber(6)
  ...
  @$pb.TagNumber(7)
  set ttl($1.Duration v) { setField(7, v); }
  @$pb.TagNumber(7)
...
class SecretVersion extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'SecretVersion', package: const $pb.PackageName(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'google.cloud.secretmanager.v1'), createEmptyInstance: create)
    ..aOS(1, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'name')
    ..aOM<$0.Timestamp>(2, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'createTime', subBuilder: $0.Timestamp.create)
    ..aOM<$0.Timestamp>(3, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'destroyTime', subBuilder: $0.Timestamp.create)
    ..e<SecretVersion_State>(4, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'state', $pb.PbFieldType.OE, defaultOrMaker: SecretVersion_State.STATE_UNSPECIFIED, valueOf: SecretVersion_State.valueOf, enumValues: SecretVersion_State.values)
    ..aOM<ReplicationStatus>(5, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'replicationStatus', subBuilder: ReplicationStatus.create)
    ..aOS(6, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'etag')
    ..aOB(7, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'clientSpecifiedPayloadChecksum')
    ..hasRequiredFields = false
  ;
  ...
  factory SecretVersion({
    ...
    if (clientSpecifiedPayloadChecksum != null) {
      _result.clientSpecifiedPayloadChecksum = clientSpecifiedPayloadChecksum;
    }
    return _result;
  }
  ...
  'Use [GeneratedMessageGenericExtensions.rebuild] instead. '
  'Will be removed in next major version')
  SecretVersion copyWith(void Function(SecretVersion) updates) => super.copyWith((message) => updates(message as SecretVersion)) as SecretVersion; // ignore: deprecated_member_use
  $pb.BuilderInfo get info_ => _i;
  @$core.pragma('dart2js:noInline')
  ...
  @$pb.TagNumber(3)
  set destroyTime($0.Timestamp v) { setField(3, v); }
  @$pb.TagNumber(3)
...
class Replication_Automatic extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'Replication.Automatic', package: const $pb.PackageName(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'google.cloud.secretmanager.v1'), createEmptyInstance: create)
    ..aOM<CustomerManagedEncryption>(1, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'customerManagedEncryption', subBuilder: CustomerManagedEncryption.create)
    ..hasRequiredFields = false
  ;
  ...
  'Use [GeneratedMessageGenericExtensions.rebuild] instead. '
  'Will be removed in next major version')
  Replication_Automatic copyWith(void Function(Replication_Automatic) updates) => super.copyWith((message) => updates(message as Replication_Automatic)) as Replication_Automatic; // ignore: deprecated_member_use
  $pb.BuilderInfo get info_ => _i;
  @$core.pragma('dart2js:noInline')
...
class Replication_UserManaged_Replica extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'Replication.UserManaged.Replica', package: const $pb.PackageName(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'google.cloud.secretmanager.v1'), createEmptyInstance: create)
    ..aOS(1, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'location')
    ..aOM<CustomerManagedEncryption>(2, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'customerManagedEncryption', subBuilder: CustomerManagedEncryption.create)
    ..hasRequiredFields = false
  ;
  ...
  'Use [GeneratedMessageGenericExtensions.rebuild] instead. '
  'Will be removed in next major version')
  Replication_UserManaged_Replica copyWith(void Function(Replication_UserManaged_Replica) updates) => super.copyWith((message) => updates(message as Replication_UserManaged_Replica)) as Replication_UserManaged_Replica; // ignore: deprecated_member_use
  $pb.BuilderInfo get info_ => _i;
  @$core.pragma('dart2js:noInline')
...
class Replication_UserManaged extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'Replication.UserManaged', package: const $pb.PackageName(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'google.cloud.secretmanager.v1'), createEmptyInstance: create)
    ..pc<Replication_UserManaged_Replica>(1, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'replicas', $pb.PbFieldType.PM, subBuilder: Replication_UserManaged_Replica.create)
    ..hasRequiredFields = false
  ;
  ...
  'Use [GeneratedMessageGenericExtensions.rebuild] instead. '
  'Will be removed in next major version')
  Replication_UserManaged copyWith(void Function(Replication_UserManaged) updates) => super.copyWith((message) => updates(message as Replication_UserManaged)) as Replication_UserManaged; // ignore: deprecated_member_use
  $pb.BuilderInfo get info_ => _i;
  @$core.pragma('dart2js:noInline')
...
class Replication extends $pb.GeneratedMessage {
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'Replication', package: const $pb.PackageName(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'google.cloud.secretmanager.v1'), createEmptyInstance: create)
    ..oo(0, [1, 2])
    ..aOM<Replication_Automatic>(1, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'automatic', subBuilder: Replication_Automatic.create)
    ..aOM<Replication_UserManaged>(2, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'userManaged', subBuilder: Replication_UserManaged.create)
    ..hasRequiredFields = false
  ;
  ...
  'Use [GeneratedMessageGenericExtensions.rebuild] instead. '
  'Will be removed in next major version')
  Replication copyWith(void Function(Replication) updates) => super.copyWith((message) => updates(message as Replication)) as Replication; // ignore: deprecated_member_use
  $pb.BuilderInfo get info_ => _i;
  @$core.pragma('dart2js:noInline')
...
class CustomerManagedEncryption extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'CustomerManagedEncryption', package: const $pb.PackageName(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'google.cloud.secretmanager.v1'), createEmptyInstance: create)
  ...
  'Use [GeneratedMessageGenericExtensions.rebuild] instead. '
  'Will be removed in next major version')
  CustomerManagedEncryption copyWith(void Function(CustomerManagedEncryption) updates) => super.copyWith((message) => updates(message as CustomerManagedEncryption)) as CustomerManagedEncryption; // ignore: deprecated_member_use
  $pb.BuilderInfo get info_ => _i;
  @$core.pragma('dart2js:noInline')
...
class ReplicationStatus_AutomaticStatus extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'ReplicationStatus.AutomaticStatus', package: const $pb.PackageName(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'google.cloud.secretmanager.v1'), createEmptyInstance: create)
    ..aOM<CustomerManagedEncryptionStatus>(1, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'customerManagedEncryption', subBuilder: CustomerManagedEncryptionStatus.create)
    ..hasRequiredFields = false
  ;
  ...
  'Use [GeneratedMessageGenericExtensions.rebuild] instead. '
  'Will be removed in next major version')
  ReplicationStatus_AutomaticStatus copyWith(void Function(ReplicationStatus_AutomaticStatus) updates) => super.copyWith((message) => updates(message as ReplicationStatus_AutomaticStatus)) as ReplicationStatus_AutomaticStatus; // ignore: deprecated_member_use
  $pb.BuilderInfo get info_ => _i;
  @$core.pragma('dart2js:noInline')
...
class ReplicationStatus_UserManagedStatus_ReplicaStatus extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'ReplicationStatus.UserManagedStatus.ReplicaStatus', package: const $pb.PackageName(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'google.cloud.secretmanager.v1'), createEmptyInstance: create)
    ..aOS(1, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'location')
    ..aOM<CustomerManagedEncryptionStatus>(2, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'customerManagedEncryption', subBuilder: CustomerManagedEncryptionStatus.create)
    ..hasRequiredFields = false
  ;
  ...
  'Use [GeneratedMessageGenericExtensions.rebuild] instead. '
  'Will be removed in next major version')
  ReplicationStatus_UserManagedStatus_ReplicaStatus copyWith(void Function(ReplicationStatus_UserManagedStatus_ReplicaStatus) updates) => super.copyWith((message) => updates(message as ReplicationStatus_UserManagedStatus_ReplicaStatus)) as ReplicationStatus_UserManagedStatus_ReplicaStatus; // ignore: deprecated_member_use
  $pb.BuilderInfo get info_ => _i;
  @$core.pragma('dart2js:noInline')
...
class ReplicationStatus_UserManagedStatus extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'ReplicationStatus.UserManagedStatus', package: const $pb.PackageName(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'google.cloud.secretmanager.v1'), createEmptyInstance: create)
    ..pc<ReplicationStatus_UserManagedStatus_ReplicaStatus>(1, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'replicas', $pb.PbFieldType.PM, subBuilder: ReplicationStatus_UserManagedStatus_ReplicaStatus.create)
    ..hasRequiredFields = false
  ;
  ...
  'Use [GeneratedMessageGenericExtensions.rebuild] instead. '
  'Will be removed in next major version')
  ReplicationStatus_UserManagedStatus copyWith(void Function(ReplicationStatus_UserManagedStatus) updates) => super.copyWith((message) => updates(message as ReplicationStatus_UserManagedStatus)) as ReplicationStatus_UserManagedStatus; // ignore: deprecated_member_use
  $pb.BuilderInfo get info_ => _i;
  @$core.pragma('dart2js:noInline')
...
class ReplicationStatus extends $pb.GeneratedMessage {
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'ReplicationStatus', package: const $pb.PackageName(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'google.cloud.secretmanager.v1'), createEmptyInstance: create)
    ..oo(0, [1, 2])
    ..aOM<ReplicationStatus_AutomaticStatus>(1, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'automatic', subBuilder: ReplicationStatus_AutomaticStatus.create)
    ..aOM<ReplicationStatus_UserManagedStatus>(2, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'userManaged', subBuilder: ReplicationStatus_UserManagedStatus.create)
    ..hasRequiredFields = false
  ;
  ...
  'Use [GeneratedMessageGenericExtensions.rebuild] instead. '
  'Will be removed in next major version')
  ReplicationStatus copyWith(void Function(ReplicationStatus) updates) => super.copyWith((message) => updates(message as ReplicationStatus)) as ReplicationStatus; // ignore: deprecated_member_use
  $pb.BuilderInfo get info_ => _i;
  @$core.pragma('dart2js:noInline')
...
class CustomerManagedEncryptionStatus extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'CustomerManagedEncryptionStatus', package: const $pb.PackageName(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'google.cloud.secretmanager.v1'), createEmptyInstance: create)
  ...
  'Use [GeneratedMessageGenericExtensions.rebuild] instead. '
  'Will be removed in next major version')
  CustomerManagedEncryptionStatus copyWith(void Function(CustomerManagedEncryptionStatus) updates) => super.copyWith((message) => updates(message as CustomerManagedEncryptionStatus)) as CustomerManagedEncryptionStatus; // ignore: deprecated_member_use
  $pb.BuilderInfo get info_ => _i;
  @$core.pragma('dart2js:noInline')
...
class Topic extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'Topic', package: const $pb.PackageName(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'google.cloud.secretmanager.v1'), createEmptyInstance: create)
    ..aOS(1, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'name')
    ..hasRequiredFields = false
  ;
...
class Rotation extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'Rotation', package: const $pb.PackageName(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'google.cloud.secretmanager.v1'), createEmptyInstance: create)
    ..aOM<$0.Timestamp>(1, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'nextRotationTime', subBuilder: $0.Timestamp.create)
    ..aOM<$1.Duration>(2, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'rotationPeriod', subBuilder: $1.Duration.create)
    ..hasRequiredFields = false
  ;
  ...
  @$pb.TagNumber(1)
  set nextRotationTime($0.Timestamp v) { setField(1, v); }
  @$pb.TagNumber(1)
  ...
  @$pb.TagNumber(2)
  set rotationPeriod($1.Duration v) { setField(2, v); }
  @$pb.TagNumber(2)
...
class SecretPayload extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'SecretPayload', package: const $pb.PackageName(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'google.cloud.secretmanager.v1'), createEmptyInstance: create)
    ..a<$core.List<$core.int>>(1, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'data', $pb.PbFieldType.OY)
    ..aInt64(2, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'dataCrc32c')
    ..hasRequiredFields = false
  ;
  ...
  'Use [GeneratedMessageGenericExtensions.rebuild] instead. '
  'Will be removed in next major version')
  SecretPayload copyWith(void Function(SecretPayload) updates) => super.copyWith((message) => updates(message as SecretPayload)) as SecretPayload; // ignore: deprecated_member_use
  $pb.BuilderInfo get info_ => _i;
  @$core.pragma('dart2js:noInline')

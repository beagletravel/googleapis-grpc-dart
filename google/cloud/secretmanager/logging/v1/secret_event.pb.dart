...
class SecretEvent extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'SecretEvent', package: const $pb.PackageName(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'google.cloud.secretmanager.logging.v1'), createEmptyInstance: create)
    ..aOS(1, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'name')
    ..e<SecretEvent_EventType>(2, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'type', $pb.PbFieldType.OE, defaultOrMaker: SecretEvent_EventType.EVENT_TYPE_UNSPECIFIED, valueOf: SecretEvent_EventType.valueOf, enumValues: SecretEvent_EventType.values)
  ...
  'Will be removed in next major version')
  SecretEvent copyWith(void Function(SecretEvent) updates) => super.copyWith((message) => updates(message as SecretEvent)) as SecretEvent; // ignore: deprecated_member_use

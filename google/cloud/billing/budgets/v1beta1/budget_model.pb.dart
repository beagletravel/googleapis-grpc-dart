...
class Budget extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'Budget', package: const $pb.PackageName(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'google.cloud.billing.budgets.v1beta1'), createEmptyInstance: create)
    ..aOS(1, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'name')
    ..aOS(2, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'displayName')
    ..aOM<Filter>(3, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'budgetFilter', subBuilder: Filter.create)
    ..aOM<BudgetAmount>(4, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'amount', subBuilder: BudgetAmount.create)
    ..pc<ThresholdRule>(5, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'thresholdRules', $pb.PbFieldType.PM, subBuilder: ThresholdRule.create)
    ..aOM<AllUpdatesRule>(6, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'allUpdatesRule', subBuilder: AllUpdatesRule.create)
  ...
  'Will be removed in next major version')
  Budget copyWith(void Function(Budget) updates) => super.copyWith((message) => updates(message as Budget)) as Budget; // ignore: deprecated_member_use
  ...
  @$pb.TagNumber(6)
  set allUpdatesRule(AllUpdatesRule v) { setField(6, v); }
  @$pb.TagNumber(6)
...
class BudgetAmount extends $pb.GeneratedMessage {
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'BudgetAmount', package: const $pb.PackageName(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'google.cloud.billing.budgets.v1beta1'), createEmptyInstance: create)
    ..oo(0, [1, 2])
    ..aOM<$0.Money>(1, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'specifiedAmount', subBuilder: $0.Money.create)
    ..aOM<LastPeriodAmount>(2, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'lastPeriodAmount', subBuilder: LastPeriodAmount.create)
    ..hasRequiredFields = false
  ;
  ...
  'Use [GeneratedMessageGenericExtensions.rebuild] instead. '
  'Will be removed in next major version')
  BudgetAmount copyWith(void Function(BudgetAmount) updates) => super.copyWith((message) => updates(message as BudgetAmount)) as BudgetAmount; // ignore: deprecated_member_use
  $pb.BuilderInfo get info_ => _i;
  @$core.pragma('dart2js:noInline')
  ...
  @$pb.TagNumber(1)
  set specifiedAmount($0.Money v) { setField(1, v); }
  @$pb.TagNumber(1)
...
class LastPeriodAmount extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'LastPeriodAmount', package: const $pb.PackageName(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'google.cloud.billing.budgets.v1beta1'), createEmptyInstance: create)
    ..hasRequiredFields = false
  ;
  ...
  'Use [GeneratedMessageGenericExtensions.rebuild] instead. '
  'Will be removed in next major version')
  LastPeriodAmount copyWith(void Function(LastPeriodAmount) updates) => super.copyWith((message) => updates(message as LastPeriodAmount)) as LastPeriodAmount; // ignore: deprecated_member_use
  $pb.BuilderInfo get info_ => _i;
  @$core.pragma('dart2js:noInline')
...
class ThresholdRule extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'ThresholdRule', package: const $pb.PackageName(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'google.cloud.billing.budgets.v1beta1'), createEmptyInstance: create)
    ..a<$core.double>(1, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'thresholdPercent', $pb.PbFieldType.OD)
    ..e<ThresholdRule_Basis>(2, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'spendBasis', $pb.PbFieldType.OE, defaultOrMaker: ThresholdRule_Basis.BASIS_UNSPECIFIED, valueOf: ThresholdRule_Basis.valueOf, enumValues: ThresholdRule_Basis.values)
    ..hasRequiredFields = false
  ;
  ...
  'Use [GeneratedMessageGenericExtensions.rebuild] instead. '
  'Will be removed in next major version')
  ThresholdRule copyWith(void Function(ThresholdRule) updates) => super.copyWith((message) => updates(message as ThresholdRule)) as ThresholdRule; // ignore: deprecated_member_use
  $pb.BuilderInfo get info_ => _i;
  @$core.pragma('dart2js:noInline')
...
class AllUpdatesRule extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'AllUpdatesRule', package: const $pb.PackageName(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'google.cloud.billing.budgets.v1beta1'), createEmptyInstance: create)
    ..aOS(1, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'pubsubTopic')
    ..aOS(2, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'schemaVersion')
    ..pPS(3, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'monitoringNotificationChannels')
    ..aOB(4, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'disableDefaultIamRecipients')
    ..hasRequiredFields = false
  ;
  ...
  factory AllUpdatesRule({
    ...
    if (monitoringNotificationChannels != null) {
      _result.monitoringNotificationChannels.addAll(monitoringNotificationChannels);
    }
  ...
  factory AllUpdatesRule.fromBuffer($core.List<$core.int> i, [$pb.ExtensionRegistry r = $pb.ExtensionRegistry.EMPTY]) => create()..mergeFromBuffer(i, r);
  factory AllUpdatesRule.fromJson($core.String i, [$pb.ExtensionRegistry r = $pb.ExtensionRegistry.EMPTY]) => create()..mergeFromJson(i, r);
  @$core.Deprecated(
  'Using this can add significant overhead to your binary. '
  'Use [GeneratedMessageGenericExtensions.deepCopy] instead. '
  'Will be removed in next major version')
  ...
  'Use [GeneratedMessageGenericExtensions.rebuild] instead. '
  'Will be removed in next major version')
  AllUpdatesRule copyWith(void Function(AllUpdatesRule) updates) => super.copyWith((message) => updates(message as AllUpdatesRule)) as AllUpdatesRule; // ignore: deprecated_member_use
  $pb.BuilderInfo get info_ => _i;
  @$core.pragma('dart2js:noInline')
  static AllUpdatesRule create() => AllUpdatesRule._();
  AllUpdatesRule createEmptyInstance() => create();
  static $pb.PbList<AllUpdatesRule> createRepeated() => $pb.PbList<AllUpdatesRule>();
  @$core.pragma('dart2js:noInline')
  static AllUpdatesRule getDefault() => _defaultInstance ??= $pb.GeneratedMessage.$_defaultFor<AllUpdatesRule>(create);
...
class Filter extends $pb.GeneratedMessage {
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'Filter', package: const $pb.PackageName(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'google.cloud.billing.budgets.v1beta1'), createEmptyInstance: create)
    ..oo(0, [8, 9])
    ..pPS(1, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'projects')
    ..pPS(3, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'services')
    ..e<Filter_CreditTypesTreatment>(4, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'creditTypesTreatment', $pb.PbFieldType.OE, defaultOrMaker: Filter_CreditTypesTreatment.CREDIT_TYPES_TREATMENT_UNSPECIFIED, valueOf: Filter_CreditTypesTreatment.valueOf, enumValues: Filter_CreditTypesTreatment.values)
    ..pPS(5, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'subaccounts')
    ..m<$core.String, $1.ListValue>(6, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'labels', entryClassName: 'Filter.LabelsEntry', keyFieldType: $pb.PbFieldType.OS, valueFieldType: $pb.PbFieldType.OM, valueCreator: $1.ListValue.create, packageName: const $pb.PackageName('google.cloud.billing.budgets.v1beta1'))
    ..pPS(7, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'creditTypes')
    ..e<CalendarPeriod>(8, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'calendarPeriod', $pb.PbFieldType.OE, defaultOrMaker: CalendarPeriod.CALENDAR_PERIOD_UNSPECIFIED, valueOf: CalendarPeriod.valueOf, enumValues: CalendarPeriod.values)
    ..aOM<CustomPeriod>(9, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'customPeriod', subBuilder: CustomPeriod.create)
    ..hasRequiredFields = false
  ;
...
class CustomPeriod extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'CustomPeriod', package: const $pb.PackageName(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'google.cloud.billing.budgets.v1beta1'), createEmptyInstance: create)
    ..aOM<$2.Date>(1, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'startDate', subBuilder: $2.Date.create)
    ..aOM<$2.Date>(2, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'endDate', subBuilder: $2.Date.create)
    ..hasRequiredFields = false
  ;
  ...
  'Use [GeneratedMessageGenericExtensions.rebuild] instead. '
  'Will be removed in next major version')
  CustomPeriod copyWith(void Function(CustomPeriod) updates) => super.copyWith((message) => updates(message as CustomPeriod)) as CustomPeriod; // ignore: deprecated_member_use
  $pb.BuilderInfo get info_ => _i;
  @$core.pragma('dart2js:noInline')
  ...
  @$pb.TagNumber(1)
  set startDate($2.Date v) { setField(1, v); }
  @$pb.TagNumber(1)
  ...
  @$pb.TagNumber(2)
  set endDate($2.Date v) { setField(2, v); }
  @$pb.TagNumber(2)

...
const CreateWorkloadRequest$json = const {
  ...
  '2': const [
    ...
    const {'1': 'workload', '3': 2, '4': 1, '5': 11, '6': '.google.cloud.assuredworkloads.v1.Workload', '8': const {}, '10': 'workload'},
...
final $typed_data.Uint8List createWorkloadRequestDescriptor = $convert.base64Decode('');
@$core.Deprecated('Use updateWorkloadRequestDescriptor instead')
const UpdateWorkloadRequest$json = const {
  '1': 'UpdateWorkloadRequest',
  '2': const [
    const {'1': 'workload', '3': 1, '4': 1, '5': 11, '6': '.google.cloud.assuredworkloads.v1.Workload', '8': const {}, '10': 'workload'},
...
final $typed_data.Uint8List updateWorkloadRequestDescriptor = $convert.base64Decode('ChVVcGRhdGVXb3JrbG9hZFJlcXVlc3QSSwoId29ya2xvYWQYASABKAsyKi5nb29nbGUuY2xvdWQuYXNzdXJlZHdvcmtsb2Fkcy52MS5Xb3JrbG9hZEID4EECUgh3b3JrbG9hZBJACgt1cGRhdGVfbWFzaxgCIAEoCzIaLmdvb2dsZS5wcm90b2J1Zi5GaWVsZE1hc2tCA+BBAlIKdXBkYXRlTWFzaw==');
...
const ListWorkloadsResponse$json = const {
  ...
  '2': const [
    const {'1': 'workloads', '3': 1, '4': 3, '5': 11, '6': '.google.cloud.assuredworkloads.v1.Workload', '10': 'workloads'},
    const {'1': 'next_page_token', '3': 2, '4': 1, '5': 9, '10': 'nextPageToken'},
  ],
};

/// Descriptor for `ListWorkloadsResponse`. Decode as a `google.protobuf.DescriptorProto`.
final $typed_data.Uint8List listWorkloadsResponseDescriptor = $convert.base64Decode('ChVMaXN0V29ya2xvYWRzUmVzcG9uc2USSAoJd29ya2xvYWRzGAEgAygLMiouZ29vZ2xlLmNsb3VkLmFzc3VyZWR3b3JrbG9hZHMudjEuV29ya2xvYWRSCXdvcmtsb2FkcxImCg9uZXh0X3BhZ2VfdG9rZW4YAiABKAlSDW5leHRQYWdlVG9rZW4=');
...
const Workload$json = const {
  ...
  '2': const [
    ...
    const {'1': 'resources', '3': 3, '4': 3, '5': 11, '6': '.google.cloud.assuredworkloads.v1.Workload.ResourceInfo', '8': const {}, '10': 'resources'},
    const {'1': 'compliance_regime', '3': 4, '4': 1, '5': 14, '6': '.google.cloud.assuredworkloads.v1.Workload.ComplianceRegime', '8': const {}, '10': 'complianceRegime'},
    ...
    const {'1': 'labels', '3': 10, '4': 3, '5': 11, '6': '.google.cloud.assuredworkloads.v1.Workload.LabelsEntry', '8': const {}, '10': 'labels'},
    const {'1': 'provisioned_resources_parent', '3': 13, '4': 1, '5': 9, '8': const {}, '10': 'provisionedResourcesParent'},
    const {'1': 'kms_settings', '3': 14, '4': 1, '5': 11, '6': '.google.cloud.assuredworkloads.v1.Workload.KMSSettings', '8': const {}, '10': 'kmsSettings'},
    const {'1': 'resource_settings', '3': 15, '4': 3, '5': 11, '6': '.google.cloud.assuredworkloads.v1.Workload.ResourceSettings', '8': const {}, '10': 'resourceSettings'},
    const {'1': 'kaj_enrollment_state', '3': 17, '4': 1, '5': 14, '6': '.google.cloud.assuredworkloads.v1.Workload.KajEnrollmentState', '8': const {}, '10': 'kajEnrollmentState'},
    const {'1': 'enable_sovereign_controls', '3': 18, '4': 1, '5': 8, '8': const {}, '10': 'enableSovereignControls'},
    const {'1': 'saa_enrollment_response', '3': 20, '4': 1, '5': 11, '6': '.google.cloud.assuredworkloads.v1.Workload.SaaEnrollmentResponse', '8': const {}, '10': 'saaEnrollmentResponse'},
  ],
  '3': const [Workload_ResourceInfo$json, Workload_KMSSettings$json, Workload_ResourceSettings$json, Workload_SaaEnrollmentResponse$json, Workload_LabelsEntry$json],
...
const Workload_ResourceInfo$json = const {
  ...
  '2': const [
    ...
    const {'1': 'resource_type', '3': 2, '4': 1, '5': 14, '6': '.google.cloud.assuredworkloads.v1.Workload.ResourceInfo.ResourceType', '10': 'resourceType'},
  ],
...
const Workload_SaaEnrollmentResponse$json = const {
  ...
  '2': const [
    const {'1': 'setup_status', '3': 1, '4': 1, '5': 14, '6': '.google.cloud.assuredworkloads.v1.Workload.SaaEnrollmentResponse.SetupState', '9': 0, '10': 'setupStatus', '17': true},
    const {'1': 'setup_errors', '3': 2, '4': 3, '5': 14, '6': '.google.cloud.assuredworkloads.v1.Workload.SaaEnrollmentResponse.SetupError', '10': 'setupErrors'},
  ],

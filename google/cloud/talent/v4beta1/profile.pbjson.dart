...
const Profile$json = const {
  ...
  '2': const [
    ...
    const {'1': 'candidate_update_time', '3': 67, '4': 1, '5': 11, '6': '.google.protobuf.Timestamp', '10': 'candidateUpdateTime'},
    const {'1': 'resume_update_time', '3': 68, '4': 1, '5': 11, '6': '.google.protobuf.Timestamp', '10': 'resumeUpdateTime'},
    ...
    const {'1': 'applications', '3': 47, '4': 3, '5': 9, '8': const {}, '10': 'applications'},
    const {'1': 'assignments', '3': 48, '4': 3, '5': 9, '8': const {}, '10': 'assignments'},
    const {'1': 'custom_attributes', '3': 26, '4': 3, '5': 11, '6': '.google.cloud.talent.v4beta1.Profile.CustomAttributesEntry', '10': 'customAttributes'},
    const {'1': 'processed', '3': 27, '4': 1, '5': 8, '8': const {}, '10': 'processed'},
    const {'1': 'keyword_snippet', '3': 28, '4': 1, '5': 9, '8': const {}, '10': 'keywordSnippet'},
    const {'1': 'availability_signals', '3': 70, '4': 3, '5': 11, '6': '.google.cloud.talent.v4beta1.AvailabilitySignal', '8': const {}, '10': 'availabilitySignals'},
    const {'1': 'derived_addresses', '3': 64, '4': 3, '5': 11, '6': '.google.cloud.talent.v4beta1.Location', '8': const {}, '10': 'derivedAddresses'},
  ],
...
final $typed_data.Uint8List profileDescriptor = $convert.base64Decode('');
@$core.Deprecated('Use availabilitySignalDescriptor instead')
const AvailabilitySignal$json = const {
  '1': 'AvailabilitySignal',
  '2': const [
    const {'1': 'type', '3': 1, '4': 1, '5': 14, '6': '.google.cloud.talent.v4beta1.AvailabilitySignalType', '10': 'type'},
    const {'1': 'last_update_time', '3': 2, '4': 1, '5': 11, '6': '.google.protobuf.Timestamp', '10': 'lastUpdateTime'},
    const {'1': 'filter_satisfied', '3': 3, '4': 1, '5': 11, '6': '.google.protobuf.BoolValue', '10': 'filterSatisfied'},
  ],
};

/// Descriptor for `AvailabilitySignal`. Decode as a `google.protobuf.DescriptorProto`.
final $typed_data.Uint8List availabilitySignalDescriptor = $convert.base64Decode('');
...
final $typed_data.Uint8List resumeDescriptor = $convert.base64Decode('');
...
final $typed_data.Uint8List personNameDescriptor = $convert.base64Decode('');
...
final $typed_data.Uint8List addressDescriptor = $convert.base64Decode('');
...
final $typed_data.Uint8List emailDescriptor = $convert.base64Decode('CgVFbWFpbBJDCgV1c2FnZRgBIAEoDjItLmdvb2dsZS5jbG91ZC50YWxlbnQudjRiZXRhMS5Db250YWN0SW5mb1VzYWdlUgV1c2FnZRIjCg1lbWFpbF9hZGRyZXNzGAIgASgJUgxlbWFpbEFkZHJlc3M=');
...
final $typed_data.Uint8List phoneDescriptor = $convert.base64Decode('');
...
final $typed_data.Uint8List personalUriDescriptor = $convert.base64Decode('CgtQZXJzb25hbFVyaRIQCgN1cmkYASABKAlSA3VyaQ==');
...
final $typed_data.Uint8List additionalContactInfoDescriptor = $convert.base64Decode('ChVBZGRpdGlvbmFsQ29udGFjdEluZm8SQwoFdXNhZ2UYASABKA4yLS5nb29nbGUuY2xvdWQudGFsZW50LnY0YmV0YTEuQ29udGFjdEluZm9Vc2FnZVIFdXNhZ2USEgoEbmFtZRgCIAEoCVIEbmFtZRIdCgpjb250YWN0X2lkGAMgASgJUgljb250YWN0SWQ=');
...
const EmploymentRecord$json = const {
  ...
  '2': const [
    ...
    const {'1': 'job_title_snippet', '3': 11, '4': 1, '5': 9, '8': const {}, '10': 'jobTitleSnippet'},
    const {'1': 'job_description_snippet', '3': 12, '4': 1, '5': 9, '8': const {}, '10': 'jobDescriptionSnippet'},
    const {'1': 'employer_name_snippet', '3': 13, '4': 1, '5': 9, '8': const {}, '10': 'employerNameSnippet'},
  ],
};

/// Descriptor for `EmploymentRecord`. Decode as a `google.protobuf.DescriptorProto`.
final $typed_data.Uint8List employmentRecordDescriptor = $convert.base64Decode('');
...
const EducationRecord$json = const {
  ...
  '2': const [
    ...
    const {'1': 'school_name_snippet', '3': 10, '4': 1, '5': 9, '8': const {}, '10': 'schoolNameSnippet'},
    const {'1': 'degree_snippet', '3': 11, '4': 1, '5': 9, '8': const {}, '10': 'degreeSnippet'},
  ],
  '8': const [
    const {'1': 'degree'},
  ],
...
final $typed_data.Uint8List degreeDescriptor = $convert.base64Decode('CgZEZWdyZWUSSAoLZGVncmVlX3R5cGUYASABKA4yJy5nb29nbGUuY2xvdWQudGFsZW50LnY0YmV0YTEuRGVncmVlVHlwZVIKZGVncmVlVHlwZRIfCgtkZWdyZWVfbmFtZRgCIAEoCVIKZGVncmVlTmFtZRImCg9maWVsZHNfb2Zfc3R1ZHkYAyADKAlSDWZpZWxkc09mU3R1ZHk=');
...
const Activity$json = const {
  ...
  '2': const [
    ...
    const {'1': 'activity_name_snippet', '3': 8, '4': 1, '5': 9, '8': const {}, '10': 'activityNameSnippet'},
    const {'1': 'activity_description_snippet', '3': 9, '4': 1, '5': 9, '8': const {}, '10': 'activityDescriptionSnippet'},
    const {'1': 'skills_used_snippet', '3': 10, '4': 3, '5': 9, '8': const {}, '10': 'skillsUsedSnippet'},
  ],
};

/// Descriptor for `Activity`. Decode as a `google.protobuf.DescriptorProto`.
final $typed_data.Uint8List activityDescriptor = $convert.base64Decode('');
...
final $typed_data.Uint8List publicationDescriptor = $convert.base64Decode('');

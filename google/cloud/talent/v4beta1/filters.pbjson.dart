...
const JobQuery$json = const {
  ...
  '2': const [
    ...
    const {'1': 'query_language_code', '3': 14, '4': 1, '5': 9, '10': 'queryLanguageCode'},
...
final $typed_data.Uint8List jobQueryDescriptor = $convert.base64Decode('');
...
const ProfileQuery$json = const {
  ...
  '2': const [
    ...
    const {'1': 'availability_filters', '3': 18, '4': 3, '5': 11, '6': '.google.cloud.talent.v4beta1.AvailabilityFilter', '10': 'availabilityFilters'},
    const {'1': 'person_name_filters', '3': 17, '4': 3, '5': 11, '6': '.google.cloud.talent.v4beta1.PersonNameFilter', '10': 'personNameFilters'},
  ],
};

/// Descriptor for `ProfileQuery`. Decode as a `google.protobuf.DescriptorProto`.
final $typed_data.Uint8List profileQueryDescriptor = $convert.base64Decode('');
...
final $typed_data.Uint8List locationFilterDescriptor = $convert.base64Decode('');
@$core.Deprecated('Use compensationFilterDescriptor instead')
const CompensationFilter$json = const {
  '1': 'CompensationFilter',
  '2': const [
    const {'1': 'type', '3': 1, '4': 1, '5': 14, '6': '.google.cloud.talent.v4beta1.CompensationFilter.FilterType', '8': const {}, '10': 'type'},
    const {'1': 'units', '3': 2, '4': 3, '5': 14, '6': '.google.cloud.talent.v4beta1.CompensationInfo.CompensationUnit', '8': const {}, '10': 'units'},
...
final $typed_data.Uint8List compensationFilterDescriptor = $convert.base64Decode('');
@$core.Deprecated('Use commuteFilterDescriptor instead')
const CommuteFilter$json = const {
  '1': 'CommuteFilter',
  '2': const [
    const {'1': 'commute_method', '3': 1, '4': 1, '5': 14, '6': '.google.cloud.talent.v4beta1.CommuteMethod', '8': const {}, '10': 'commuteMethod'},
    const {'1': 'start_coordinates', '3': 2, '4': 1, '5': 11, '6': '.google.type.LatLng', '8': const {}, '10': 'startCoordinates'},
    const {'1': 'travel_duration', '3': 3, '4': 1, '5': 11, '6': '.google.protobuf.Duration', '8': const {}, '10': 'travelDuration'},
...
final $typed_data.Uint8List skillFilterDescriptor = $convert.base64Decode('CgtTa2lsbEZpbHRlchIZCgVza2lsbBgBIAEoCUID4EECUgVza2lsbBIYCgduZWdhdGVkGAIgASgIUgduZWdhdGVk');
@$core.Deprecated('Use employerFilterDescriptor instead')
const EmployerFilter$json = const {
  '1': 'EmployerFilter',
  '2': const [
    const {'1': 'employer', '3': 1, '4': 1, '5': 9, '8': const {}, '10': 'employer'},
...
final $typed_data.Uint8List employerFilterDescriptor = $convert.base64Decode('');
...
final $typed_data.Uint8List educationFilterDescriptor = $convert.base64Decode('Cg9FZHVjYXRpb25GaWx0ZXISFgoGc2Nob29sGAEgASgJUgZzY2hvb2wSJAoOZmllbGRfb2Zfc3R1ZHkYAiABKAlSDGZpZWxkT2ZTdHVkeRJICgtkZWdyZWVfdHlwZRgDIAEoDjInLmdvb2dsZS5jbG91ZC50YWxlbnQudjRiZXRhMS5EZWdyZWVUeXBlUgpkZWdyZWVUeXBlEhgKB25lZ2F0ZWQYBiABKAhSB25lZ2F0ZWQ=');
...
final $typed_data.Uint8List workExperienceFilterDescriptor = $convert.base64Decode('ChRXb3JrRXhwZXJpZW5jZUZpbHRlchJACg5taW5fZXhwZXJpZW5jZRgBIAEoCzIZLmdvb2dsZS5wcm90b2J1Zi5EdXJhdGlvblINbWluRXhwZXJpZW5jZRJACg5tYXhfZXhwZXJpZW5jZRgCIAEoCzIZLmdvb2dsZS5wcm90b2J1Zi5EdXJhdGlvblINbWF4RXhwZXJpZW5jZQ==');
...
final $typed_data.Uint8List applicationDateFilterDescriptor = $convert.base64Decode('ChVBcHBsaWNhdGlvbkRhdGVGaWx0ZXISMAoKc3RhcnRfZGF0ZRgBIAEoCzIRLmdvb2dsZS50eXBlLkRhdGVSCXN0YXJ0RGF0ZRIsCghlbmRfZGF0ZRgCIAEoCzIRLmdvb2dsZS50eXBlLkRhdGVSB2VuZERhdGU=');
...
const ApplicationOutcomeNotesFilter$json = const {
  ...
  '2': const [
    const {'1': 'outcome_notes', '3': 1, '4': 1, '5': 9, '8': const {}, '10': 'outcomeNotes'},
    const {'1': 'negated', '3': 2, '4': 1, '5': 8, '10': 'negated'},
  ],
};

/// Descriptor for `ApplicationOutcomeNotesFilter`. Decode as a `google.protobuf.DescriptorProto`.
final $typed_data.Uint8List applicationOutcomeNotesFilterDescriptor = $convert.base64Decode('Ch1BcHBsaWNhdGlvbk91dGNvbWVOb3Rlc0ZpbHRlchIoCg1vdXRjb21lX25vdGVzGAEgASgJQgPgQQJSDG91dGNvbWVOb3RlcxIYCgduZWdhdGVkGAIgASgIUgduZWdhdGVk');
...
final $typed_data.Uint8List applicationJobFilterDescriptor = $convert.base64Decode('ChRBcHBsaWNhdGlvbkpvYkZpbHRlchIsChJqb2JfcmVxdWlzaXRpb25faWQYAiABKAlSEGpvYlJlcXVpc2l0aW9uSWQSGwoJam9iX3RpdGxlGAMgASgJUghqb2JUaXRsZRIYCgduZWdhdGVkGAQgASgIUgduZWdhdGVk');
...
final $typed_data.Uint8List timeFilterDescriptor = $convert.base64Decode('');
...
final $typed_data.Uint8List candidateAvailabilityFilterDescriptor = $convert.base64Decode('ChtDYW5kaWRhdGVBdmFpbGFiaWxpdHlGaWx0ZXISGAoHbmVnYXRlZBgBIAEoCFIHbmVnYXRlZDoCGAE=');
@$core.Deprecated('Use availabilityFilterDescriptor instead')
const AvailabilityFilter$json = const {
  '1': 'AvailabilityFilter',
  '2': const [
    const {'1': 'signal_type', '3': 1, '4': 1, '5': 14, '6': '.google.cloud.talent.v4beta1.AvailabilitySignalType', '8': const {}, '10': 'signalType'},
    const {'1': 'range', '3': 2, '4': 1, '5': 11, '6': '.google.cloud.talent.v4beta1.TimestampRange', '8': const {}, '10': 'range'},
    const {'1': 'required', '3': 3, '4': 1, '5': 8, '10': 'required'},
  ],
};

/// Descriptor for `AvailabilityFilter`. Decode as a `google.protobuf.DescriptorProto`.
final $typed_data.Uint8List availabilityFilterDescriptor = $convert.base64Decode('');
@$core.Deprecated('Use personNameFilterDescriptor instead')
const PersonNameFilter$json = const {
  '1': 'PersonNameFilter',
  '2': const [
    const {'1': 'person_name', '3': 1, '4': 1, '5': 9, '8': const {}, '10': 'personName'},
  ],
};

/// Descriptor for `PersonNameFilter`. Decode as a `google.protobuf.DescriptorProto`.
final $typed_data.Uint8List personNameFilterDescriptor = $convert.base64Decode('ChBQZXJzb25OYW1lRmlsdGVyEiQKC3BlcnNvbl9uYW1lGAEgASgJQgPgQQJSCnBlcnNvbk5hbWU=');

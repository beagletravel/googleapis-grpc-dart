...
class TimestampRange extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'TimestampRange', package: const $pb.PackageName(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'google.cloud.talent.v4beta1'), createEmptyInstance: create)
...
class Location extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'Location', package: const $pb.PackageName(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'google.cloud.talent.v4beta1'), createEmptyInstance: create)
    ..e<Location_LocationType>(1, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'locationType', $pb.PbFieldType.OE, defaultOrMaker: Location_LocationType.LOCATION_TYPE_UNSPECIFIED, valueOf: Location_LocationType.valueOf, enumValues: Location_LocationType.values)
    ..aOM<$1.PostalAddress>(2, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'postalAddress', subBuilder: $1.PostalAddress.create)
    ..aOM<$2.LatLng>(3, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'latLng', subBuilder: $2.LatLng.create)
    ..a<$core.double>(4, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'radiusMiles', $pb.PbFieldType.OD)
    ..hasRequiredFields = false
  ;
  ...
  @$pb.TagNumber(2)
  set postalAddress($1.PostalAddress v) { setField(2, v); }
  @$pb.TagNumber(2)
...
class RequestMetadata extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'RequestMetadata', package: const $pb.PackageName(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'google.cloud.talent.v4beta1'), createEmptyInstance: create)
    ...
    ..aOB(4, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'allowMissingIds')
    ..aOM<DeviceInfo>(5, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'deviceInfo', subBuilder: DeviceInfo.create)
    ..hasRequiredFields = false
  ;
...
class ResponseMetadata extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'ResponseMetadata', package: const $pb.PackageName(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'google.cloud.talent.v4beta1'), createEmptyInstance: create)
...
class DeviceInfo extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'DeviceInfo', package: const $pb.PackageName(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'google.cloud.talent.v4beta1'), createEmptyInstance: create)
    ..e<DeviceInfo_DeviceType>(1, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'deviceType', $pb.PbFieldType.OE, defaultOrMaker: DeviceInfo_DeviceType.DEVICE_TYPE_UNSPECIFIED, valueOf: DeviceInfo_DeviceType.valueOf, enumValues: DeviceInfo_DeviceType.values)
...
class CustomAttribute extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'CustomAttribute', package: const $pb.PackageName(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'google.cloud.talent.v4beta1'), createEmptyInstance: create)
    ..pPS(1, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'stringValues')
    ..p<$fixnum.Int64>(2, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'longValues', $pb.PbFieldType.P6)
    ..aOB(3, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'filterable')
    ..hasRequiredFields = false
  ;
...
class SpellingCorrection extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'SpellingCorrection', package: const $pb.PackageName(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'google.cloud.talent.v4beta1'), createEmptyInstance: create)
    ..aOB(1, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'corrected')
    ..aOS(2, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'correctedText')
    ..aOS(3, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'correctedHtml')
    ..hasRequiredFields = false
  ;
  ...
  'Use [GeneratedMessageGenericExtensions.rebuild] instead. '
  'Will be removed in next major version')
  SpellingCorrection copyWith(void Function(SpellingCorrection) updates) => super.copyWith((message) => updates(message as SpellingCorrection)) as SpellingCorrection; // ignore: deprecated_member_use
  $pb.BuilderInfo get info_ => _i;
  @$core.pragma('dart2js:noInline')
...
class CompensationInfo_CompensationEntry extends $pb.GeneratedMessage {
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'CompensationInfo.CompensationEntry', package: const $pb.PackageName(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'google.cloud.talent.v4beta1'), createEmptyInstance: create)
    ..oo(0, [3, 4])
    ..e<CompensationInfo_CompensationType>(1, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'type', $pb.PbFieldType.OE, defaultOrMaker: CompensationInfo_CompensationType.COMPENSATION_TYPE_UNSPECIFIED, valueOf: CompensationInfo_CompensationType.valueOf, enumValues: CompensationInfo_CompensationType.values)
    ..e<CompensationInfo_CompensationUnit>(2, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'unit', $pb.PbFieldType.OE, defaultOrMaker: CompensationInfo_CompensationUnit.COMPENSATION_UNIT_UNSPECIFIED, valueOf: CompensationInfo_CompensationUnit.valueOf, enumValues: CompensationInfo_CompensationUnit.values)
    ..aOM<$3.Money>(3, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'amount', subBuilder: $3.Money.create)
    ..aOM<CompensationInfo_CompensationRange>(4, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'range', subBuilder: CompensationInfo_CompensationRange.create)
    ..aOS(5, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'description')
    ..aOM<$4.DoubleValue>(6, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'expectedUnitsPerYear', subBuilder: $4.DoubleValue.create)
    ..hasRequiredFields = false
  ;
  ...
  'Use [GeneratedMessageGenericExtensions.rebuild] instead. '
  'Will be removed in next major version')
  CompensationInfo_CompensationEntry copyWith(void Function(CompensationInfo_CompensationEntry) updates) => super.copyWith((message) => updates(message as CompensationInfo_CompensationEntry)) as CompensationInfo_CompensationEntry; // ignore: deprecated_member_use
  $pb.BuilderInfo get info_ => _i;
  @$core.pragma('dart2js:noInline')
  ...
  @$pb.TagNumber(3)
  set amount($3.Money v) { setField(3, v); }
  @$pb.TagNumber(3)
  ...
  @$pb.TagNumber(6)
  set expectedUnitsPerYear($4.DoubleValue v) { setField(6, v); }
  @$pb.TagNumber(6)
...
class CompensationInfo_CompensationRange extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'CompensationInfo.CompensationRange', package: const $pb.PackageName(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'google.cloud.talent.v4beta1'), createEmptyInstance: create)
    ..aOM<$3.Money>(1, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'minCompensation', subBuilder: $3.Money.create)
    ..aOM<$3.Money>(2, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'maxCompensation', subBuilder: $3.Money.create)
    ..hasRequiredFields = false
  ;
  ...
  'Use [GeneratedMessageGenericExtensions.rebuild] instead. '
  'Will be removed in next major version')
  CompensationInfo_CompensationRange copyWith(void Function(CompensationInfo_CompensationRange) updates) => super.copyWith((message) => updates(message as CompensationInfo_CompensationRange)) as CompensationInfo_CompensationRange; // ignore: deprecated_member_use
  $pb.BuilderInfo get info_ => _i;
  @$core.pragma('dart2js:noInline')
  ...
  @$pb.TagNumber(1)
  set minCompensation($3.Money v) { setField(1, v); }
  @$pb.TagNumber(1)
  ...
  @$pb.TagNumber(2)
  set maxCompensation($3.Money v) { setField(2, v); }
  @$pb.TagNumber(2)
...
class CompensationInfo extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'CompensationInfo', package: const $pb.PackageName(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'google.cloud.talent.v4beta1'), createEmptyInstance: create)
    ..pc<CompensationInfo_CompensationEntry>(1, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'entries', $pb.PbFieldType.PM, subBuilder: CompensationInfo_CompensationEntry.create)
    ..aOM<CompensationInfo_CompensationRange>(2, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'annualizedBaseCompensationRange', subBuilder: CompensationInfo_CompensationRange.create)
    ..aOM<CompensationInfo_CompensationRange>(3, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'annualizedTotalCompensationRange', subBuilder: CompensationInfo_CompensationRange.create)
    ..hasRequiredFields = false
  ;
  ...
  factory CompensationInfo({
    ...
    if (annualizedTotalCompensationRange != null) {
      _result.annualizedTotalCompensationRange = annualizedTotalCompensationRange;
    }
    return _result;
  }
  ...
  'Use [GeneratedMessageGenericExtensions.rebuild] instead. '
  'Will be removed in next major version')
  CompensationInfo copyWith(void Function(CompensationInfo) updates) => super.copyWith((message) => updates(message as CompensationInfo)) as CompensationInfo; // ignore: deprecated_member_use
  $pb.BuilderInfo get info_ => _i;
  @$core.pragma('dart2js:noInline')
...
class Certification extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'Certification', package: const $pb.PackageName(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'google.cloud.talent.v4beta1'), createEmptyInstance: create)
    ..aOS(1, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'displayName')
    ..aOM<$5.Date>(2, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'acquireDate', subBuilder: $5.Date.create)
    ..aOM<$5.Date>(3, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'expireDate', subBuilder: $5.Date.create)
    ..aOS(4, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'authority')
    ..aOS(5, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'description')
    ..hasRequiredFields = false
  ;
  ...
  factory Certification({
    ...
    if (acquireDate != null) {
      _result.acquireDate = acquireDate;
    }
    if (expireDate != null) {
  ...
  'Use [GeneratedMessageGenericExtensions.rebuild] instead. '
  'Will be removed in next major version')
  Certification copyWith(void Function(Certification) updates) => super.copyWith((message) => updates(message as Certification)) as Certification; // ignore: deprecated_member_use
  $pb.BuilderInfo get info_ => _i;
  @$core.pragma('dart2js:noInline')
  ...
  @$pb.TagNumber(2)
  set acquireDate($5.Date v) { setField(2, v); }
  @$pb.TagNumber(2)
  ...
  @$pb.TagNumber(3)
  set expireDate($5.Date v) { setField(3, v); }
  @$pb.TagNumber(3)
  ...
  @$pb.TagNumber(4)
  set authority($core.String v) { $_setString(3, v); }
  @$pb.TagNumber(4)
...
class Skill extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'Skill', package: const $pb.PackageName(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'google.cloud.talent.v4beta1'), createEmptyInstance: create)
    ..aOS(1, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'displayName')
    ..aOM<$5.Date>(2, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'lastUsedDate', subBuilder: $5.Date.create)
    ..e<SkillProficiencyLevel>(3, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'level', $pb.PbFieldType.OE, defaultOrMaker: SkillProficiencyLevel.SKILL_PROFICIENCY_LEVEL_UNSPECIFIED, valueOf: SkillProficiencyLevel.valueOf, enumValues: SkillProficiencyLevel.values)
    ..aOS(4, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'context')
    ..aOS(5, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'skillNameSnippet')
    ..hasRequiredFields = false
  ;
  ...
  factory Skill({
    ...
    if (lastUsedDate != null) {
      _result.lastUsedDate = lastUsedDate;
    }
    if (level != null) {
      _result.level = level;
    }
    ...
    if (skillNameSnippet != null) {
      _result.skillNameSnippet = skillNameSnippet;
    }
    return _result;
  }
  ...
  @$pb.TagNumber(2)
  set lastUsedDate($5.Date v) { setField(2, v); }
  @$pb.TagNumber(2)
  ...
  @$pb.TagNumber(3)
  set level(SkillProficiencyLevel v) { setField(3, v); }
  @$pb.TagNumber(3)
  ...
  @$pb.TagNumber(5)
  set skillNameSnippet($core.String v) { $_setString(4, v); }
  @$pb.TagNumber(5)
...
class Interview extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'Interview', package: const $pb.PackageName(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'google.cloud.talent.v4beta1'), createEmptyInstance: create)
    ..aOM<Rating>(6, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'rating', subBuilder: Rating.create)
    ..e<Outcome>(7, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'outcome', $pb.PbFieldType.OE, defaultOrMaker: Outcome.OUTCOME_UNSPECIFIED, valueOf: Outcome.valueOf, enumValues: Outcome.values)
    ..hasRequiredFields = false
  ;
  ...
  factory Interview.fromBuffer($core.List<$core.int> i, [$pb.ExtensionRegistry r = $pb.ExtensionRegistry.EMPTY]) => create()..mergeFromBuffer(i, r);
  factory Interview.fromJson($core.String i, [$pb.ExtensionRegistry r = $pb.ExtensionRegistry.EMPTY]) => create()..mergeFromJson(i, r);
  @$core.Deprecated(
  'Using this can add significant overhead to your binary. '
  'Use [GeneratedMessageGenericExtensions.deepCopy] instead. '
  'Will be removed in next major version')
  ...
  'Use [GeneratedMessageGenericExtensions.rebuild] instead. '
  'Will be removed in next major version')
  Interview copyWith(void Function(Interview) updates) => super.copyWith((message) => updates(message as Interview)) as Interview; // ignore: deprecated_member_use
  $pb.BuilderInfo get info_ => _i;
  @$core.pragma('dart2js:noInline')
  ...
  @$core.pragma('dart2js:noInline')
  static Interview getDefault() => _defaultInstance ??= $pb.GeneratedMessage.$_defaultFor<Interview>(create);
  static Interview? _defaultInstance;

  @$pb.TagNumber(6)
  Rating get rating => $_getN(0);
  @$pb.TagNumber(6)
  set rating(Rating v) { setField(6, v); }
  @$pb.TagNumber(6)
  ...
  @$pb.TagNumber(7)
  set outcome(Outcome v) { setField(7, v); }
  @$pb.TagNumber(7)
...
class Rating extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'Rating', package: const $pb.PackageName(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'google.cloud.talent.v4beta1'), createEmptyInstance: create)
    ..a<$core.double>(1, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'overall', $pb.PbFieldType.OD)
    ...
    ..a<$core.double>(4, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'interval', $pb.PbFieldType.OD)
    ..hasRequiredFields = false
  ;
  ...
  @$pb.TagNumber(1)
  set overall($core.double v) { $_setDouble(0, v); }
  @$pb.TagNumber(1)
  ...
  @$pb.TagNumber(4)
  set interval($core.double v) { $_setDouble(3, v); }
  @$pb.TagNumber(4)
...
class BatchOperationMetadata extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'BatchOperationMetadata', package: const $pb.PackageName(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'google.cloud.talent.v4beta1'), createEmptyInstance: create)
    ...
    ..aOS(2, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'stateDescription')
    ..a<$core.int>(3, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'successCount', $pb.PbFieldType.O3)
    ..a<$core.int>(4, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'failureCount', $pb.PbFieldType.O3)
    ..a<$core.int>(5, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'totalCount', $pb.PbFieldType.O3)

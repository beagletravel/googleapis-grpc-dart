...
class ProfileEvent_ProfileEventType extends $pb.ProtobufEnum {
  static const ProfileEvent_ProfileEventType PROFILE_EVENT_TYPE_UNSPECIFIED = ProfileEvent_ProfileEventType._(0, const $core.bool.fromEnvironment('protobuf.omit_enum_names') ? '' : 'PROFILE_EVENT_TYPE_UNSPECIFIED');
  static const ProfileEvent_ProfileEventType IMPRESSION = ProfileEvent_ProfileEventType._(1, const $core.bool.fromEnvironment('protobuf.omit_enum_names') ? '' : 'IMPRESSION');
  static const ProfileEvent_ProfileEventType VIEW = ProfileEvent_ProfileEventType._(2, const $core.bool.fromEnvironment('protobuf.omit_enum_names') ? '' : 'VIEW');
  static const ProfileEvent_ProfileEventType BOOKMARK = ProfileEvent_ProfileEventType._(3, const $core.bool.fromEnvironment('protobuf.omit_enum_names') ? '' : 'BOOKMARK');

  static const $core.List<ProfileEvent_ProfileEventType> values = <ProfileEvent_ProfileEventType> [
  ...
  static final $core.Map<$core.int, ProfileEvent_ProfileEventType> _byValue = $pb.ProtobufEnum.initByValue(values);
  static ProfileEvent_ProfileEventType? valueOf($core.int value) => _byValue[value];

  const ProfileEvent_ProfileEventType._($core.int v, $core.String n) : super(v, n);
}

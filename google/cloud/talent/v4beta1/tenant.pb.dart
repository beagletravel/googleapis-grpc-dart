...
class Tenant extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'Tenant', package: const $pb.PackageName(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'google.cloud.talent.v4beta1'), createEmptyInstance: create)
    ..aOS(1, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'name')
    ..aOS(2, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'externalId')
    ..e<Tenant_DataUsageType>(3, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'usageType', $pb.PbFieldType.OE, defaultOrMaker: Tenant_DataUsageType.DATA_USAGE_TYPE_UNSPECIFIED, valueOf: Tenant_DataUsageType.valueOf, enumValues: Tenant_DataUsageType.values)
    ..pPS(4, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'keywordSearchableProfileCustomAttributes')
  ...
  factory Tenant({
    ...
    if (keywordSearchableProfileCustomAttributes != null) {
      _result.keywordSearchableProfileCustomAttributes.addAll(keywordSearchableProfileCustomAttributes);
    }
    return _result;
  }
  ...
  'Will be removed in next major version')
  Tenant copyWith(void Function(Tenant) updates) => super.copyWith((message) => updates(message as Tenant)) as Tenant; // ignore: deprecated_member_use

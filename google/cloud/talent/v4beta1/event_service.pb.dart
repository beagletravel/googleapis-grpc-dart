...
class CreateClientEventRequest extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'CreateClientEventRequest', package: const $pb.PackageName(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'google.cloud.talent.v4beta1'), createEmptyInstance: create)
    ..aOS(1, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'parent')
    ..aOM<$1.ClientEvent>(2, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'clientEvent', subBuilder: $1.ClientEvent.create)
  ...
  'Will be removed in next major version')
  CreateClientEventRequest copyWith(void Function(CreateClientEventRequest) updates) => super.copyWith((message) => updates(message as CreateClientEventRequest)) as CreateClientEventRequest; // ignore: deprecated_member_use
  ...
  @$pb.TagNumber(2)
  set clientEvent($1.ClientEvent v) { setField(2, v); }
  @$pb.TagNumber(2)

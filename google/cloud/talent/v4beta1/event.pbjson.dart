...
const JobEvent$json = const {
  '1': 'JobEvent',
  '2': const [
    const {'1': 'type', '3': 1, '4': 1, '5': 14, '6': '.google.cloud.talent.v4beta1.JobEvent.JobEventType', '8': const {}, '10': 'type'},
...
final $typed_data.Uint8List profileEventDescriptor = $convert.base64Decode('');

...
class Company_DerivedInfo extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'Company.DerivedInfo', package: const $pb.PackageName(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'google.cloud.talent.v4beta1'), createEmptyInstance: create)
    ..aOM<$0.Location>(1, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'headquartersLocation', subBuilder: $0.Location.create)
  ...
  'Will be removed in next major version')
  Company_DerivedInfo copyWith(void Function(Company_DerivedInfo) updates) => super.copyWith((message) => updates(message as Company_DerivedInfo)) as Company_DerivedInfo; // ignore: deprecated_member_use
...
class Company extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'Company', package: const $pb.PackageName(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'google.cloud.talent.v4beta1'), createEmptyInstance: create)
    ...
    ..e<$0.CompanySize>(4, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'size', $pb.PbFieldType.OE, defaultOrMaker: $0.CompanySize.COMPANY_SIZE_UNSPECIFIED, valueOf: $0.CompanySize.valueOf, enumValues: $0.CompanySize.values)
    ..aOS(5, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'headquartersAddress')
    ..aOB(6, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'hiringAgency')
    ..aOS(7, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'eeoText')
    ..aOS(8, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'websiteUri')
    ..aOS(9, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'careerSiteUri')
    ..aOS(10, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'imageUri')
    ..pPS(11, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'keywordSearchableJobCustomAttributes')
    ..aOM<Company_DerivedInfo>(12, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'derivedInfo', subBuilder: Company_DerivedInfo.create)
    ..aOB(13, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'suspended')
    ..hasRequiredFields = false
  ;
  ...
  factory Company({
    ...
    if (keywordSearchableJobCustomAttributes != null) {
      _result.keywordSearchableJobCustomAttributes.addAll(keywordSearchableJobCustomAttributes);
    }
    if (derivedInfo != null) {

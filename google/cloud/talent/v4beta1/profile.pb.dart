...
class Profile extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'Profile', package: const $pb.PackageName(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'google.cloud.talent.v4beta1'), createEmptyInstance: create)
    ...
    ..aOM<$0.BoolValue>(6, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'isHirable', subBuilder: $0.BoolValue.create)
    ...
    ..pc<PersonName>(11, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'personNames', $pb.PbFieldType.PM, subBuilder: PersonName.create)
    ..pc<Address>(12, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'addresses', $pb.PbFieldType.PM, subBuilder: Address.create)
    ..pc<Email>(13, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'emailAddresses', $pb.PbFieldType.PM, subBuilder: Email.create)
    ..pc<Phone>(14, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'phoneNumbers', $pb.PbFieldType.PM, subBuilder: Phone.create)
    ..pc<PersonalUri>(15, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'personalUris', $pb.PbFieldType.PM, subBuilder: PersonalUri.create)
    ..pc<AdditionalContactInfo>(16, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'additionalContactInfo', $pb.PbFieldType.PM, subBuilder: AdditionalContactInfo.create)
    ..pc<EmploymentRecord>(17, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'employmentRecords', $pb.PbFieldType.PM, subBuilder: EmploymentRecord.create)
    ..pc<EducationRecord>(18, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'educationRecords', $pb.PbFieldType.PM, subBuilder: EducationRecord.create)
    ..pc<$2.Skill>(19, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'skills', $pb.PbFieldType.PM, subBuilder: $2.Skill.create)
    ..pc<Activity>(20, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'activities', $pb.PbFieldType.PM, subBuilder: Activity.create)
    ..pc<Publication>(21, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'publications', $pb.PbFieldType.PM, subBuilder: Publication.create)
    ..pc<Patent>(22, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'patents', $pb.PbFieldType.PM, subBuilder: Patent.create)
    ..pc<$2.Certification>(23, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'certifications', $pb.PbFieldType.PM, subBuilder: $2.Certification.create)
    ..m<$core.String, $2.CustomAttribute>(26, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'customAttributes', entryClassName: 'Profile.CustomAttributesEntry', keyFieldType: $pb.PbFieldType.OS, valueFieldType: $pb.PbFieldType.OM, valueCreator: $2.CustomAttribute.create, packageName: const $pb.PackageName('google.cloud.talent.v4beta1'))
    ..aOB(27, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'processed')
    ..aOS(28, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'keywordSnippet')
    ..pPS(47, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'applications')
    ..pPS(48, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'assignments')
    ..aOM<Resume>(53, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'resume', subBuilder: Resume.create)
    ..pc<$2.Location>(64, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'derivedAddresses', $pb.PbFieldType.PM, subBuilder: $2.Location.create)
    ..aOM<$1.Timestamp>(67, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'candidateUpdateTime', subBuilder: $1.Timestamp.create)
    ..aOM<$1.Timestamp>(68, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'resumeUpdateTime', subBuilder: $1.Timestamp.create)
    ..pc<AvailabilitySignal>(70, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'availabilitySignals', $pb.PbFieldType.PM, subBuilder: AvailabilitySignal.create)
  ...
  @$pb.TagNumber(67)
  set candidateUpdateTime($1.Timestamp v) { setField(67, v); }
  @$pb.TagNumber(67)
  ...
  @$pb.TagNumber(68)
  set resumeUpdateTime($1.Timestamp v) { setField(68, v); }
  @$pb.TagNumber(68)
...
class AvailabilitySignal extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'AvailabilitySignal', package: const $pb.PackageName(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'google.cloud.talent.v4beta1'), createEmptyInstance: create)
    ..e<$2.AvailabilitySignalType>(1, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'type', $pb.PbFieldType.OE, defaultOrMaker: $2.AvailabilitySignalType.AVAILABILITY_SIGNAL_TYPE_UNSPECIFIED, valueOf: $2.AvailabilitySignalType.valueOf, enumValues: $2.AvailabilitySignalType.values)
    ..aOM<$1.Timestamp>(2, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'lastUpdateTime', subBuilder: $1.Timestamp.create)
    ..aOM<$0.BoolValue>(3, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'filterSatisfied', subBuilder: $0.BoolValue.create)
    ..hasRequiredFields = false
  ;
  ...
  factory AvailabilitySignal.fromBuffer($core.List<$core.int> i, [$pb.ExtensionRegistry r = $pb.ExtensionRegistry.EMPTY]) => create()..mergeFromBuffer(i, r);
  factory AvailabilitySignal.fromJson($core.String i, [$pb.ExtensionRegistry r = $pb.ExtensionRegistry.EMPTY]) => create()..mergeFromJson(i, r);
  @$core.Deprecated(
  'Using this can add significant overhead to your binary. '
  'Use [GeneratedMessageGenericExtensions.deepCopy] instead. '
  'Will be removed in next major version')
  ...
  'Use [GeneratedMessageGenericExtensions.rebuild] instead. '
  'Will be removed in next major version')
  AvailabilitySignal copyWith(void Function(AvailabilitySignal) updates) => super.copyWith((message) => updates(message as AvailabilitySignal)) as AvailabilitySignal; // ignore: deprecated_member_use
  $pb.BuilderInfo get info_ => _i;
  @$core.pragma('dart2js:noInline')
  static AvailabilitySignal create() => AvailabilitySignal._();
  AvailabilitySignal createEmptyInstance() => create();
  static $pb.PbList<AvailabilitySignal> createRepeated() => $pb.PbList<AvailabilitySignal>();
  @$core.pragma('dart2js:noInline')
  static AvailabilitySignal getDefault() => _defaultInstance ??= $pb.GeneratedMessage.$_defaultFor<AvailabilitySignal>(create);
  static AvailabilitySignal? _defaultInstance;

  @$pb.TagNumber(1)
  $2.AvailabilitySignalType get type => $_getN(0);
  @$pb.TagNumber(1)
  set type($2.AvailabilitySignalType v) { setField(1, v); }
  @$pb.TagNumber(1)
  ...
  @$pb.TagNumber(2)
  set lastUpdateTime($1.Timestamp v) { setField(2, v); }
  @$pb.TagNumber(2)
  ...
  @$pb.TagNumber(3)
  set filterSatisfied($0.BoolValue v) { setField(3, v); }
  @$pb.TagNumber(3)
...
class Resume extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'Resume', package: const $pb.PackageName(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'google.cloud.talent.v4beta1'), createEmptyInstance: create)
    ..aOS(1, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'structuredResume')
    ..e<Resume_ResumeType>(2, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'resumeType', $pb.PbFieldType.OE, defaultOrMaker: Resume_ResumeType.RESUME_TYPE_UNSPECIFIED, valueOf: Resume_ResumeType.valueOf, enumValues: Resume_ResumeType.values)
    ..hasRequiredFields = false
  ;
...
class PersonName_PersonStructuredName extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'PersonName.PersonStructuredName', package: const $pb.PackageName(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'google.cloud.talent.v4beta1'), createEmptyInstance: create)
    ..aOS(1, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'givenName')
    ..aOS(2, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'middleInitial')
    ..aOS(3, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'familyName')
    ..pPS(4, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'suffixes')
    ..pPS(5, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'prefixes')
    ..aOS(6, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'preferredName')
    ..hasRequiredFields = false
  ;
  ...
  factory PersonName_PersonStructuredName.fromBuffer($core.List<$core.int> i, [$pb.ExtensionRegistry r = $pb.ExtensionRegistry.EMPTY]) => create()..mergeFromBuffer(i, r);
  factory PersonName_PersonStructuredName.fromJson($core.String i, [$pb.ExtensionRegistry r = $pb.ExtensionRegistry.EMPTY]) => create()..mergeFromJson(i, r);
  @$core.Deprecated(
  'Using this can add significant overhead to your binary. '
  'Use [GeneratedMessageGenericExtensions.deepCopy] instead. '
  'Will be removed in next major version')
  ...
  'Use [GeneratedMessageGenericExtensions.rebuild] instead. '
  'Will be removed in next major version')
  PersonName_PersonStructuredName copyWith(void Function(PersonName_PersonStructuredName) updates) => super.copyWith((message) => updates(message as PersonName_PersonStructuredName)) as PersonName_PersonStructuredName; // ignore: deprecated_member_use
  $pb.BuilderInfo get info_ => _i;
  @$core.pragma('dart2js:noInline')
  static PersonName_PersonStructuredName create() => PersonName_PersonStructuredName._();
  ...
  @$core.pragma('dart2js:noInline')
  static PersonName_PersonStructuredName getDefault() => _defaultInstance ??= $pb.GeneratedMessage.$_defaultFor<PersonName_PersonStructuredName>(create);
...
class PersonName extends $pb.GeneratedMessage {
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'PersonName', package: const $pb.PackageName(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'google.cloud.talent.v4beta1'), createEmptyInstance: create)
    ..oo(0, [1, 2])
    ..aOS(1, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'formattedName')
    ..aOM<PersonName_PersonStructuredName>(2, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'structuredName', subBuilder: PersonName_PersonStructuredName.create)
    ..aOS(3, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'preferredName')
    ..hasRequiredFields = false
  ;
  ...
  factory PersonName.fromBuffer($core.List<$core.int> i, [$pb.ExtensionRegistry r = $pb.ExtensionRegistry.EMPTY]) => create()..mergeFromBuffer(i, r);
  factory PersonName.fromJson($core.String i, [$pb.ExtensionRegistry r = $pb.ExtensionRegistry.EMPTY]) => create()..mergeFromJson(i, r);
  @$core.Deprecated(
  'Using this can add significant overhead to your binary. '
  'Use [GeneratedMessageGenericExtensions.deepCopy] instead. '
  'Will be removed in next major version')
  ...
  'Use [GeneratedMessageGenericExtensions.rebuild] instead. '
  'Will be removed in next major version')
  PersonName copyWith(void Function(PersonName) updates) => super.copyWith((message) => updates(message as PersonName)) as PersonName; // ignore: deprecated_member_use
  $pb.BuilderInfo get info_ => _i;
  @$core.pragma('dart2js:noInline')
  ...
  @$core.pragma('dart2js:noInline')
  static PersonName getDefault() => _defaultInstance ??= $pb.GeneratedMessage.$_defaultFor<PersonName>(create);
...
class Address extends $pb.GeneratedMessage {
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'Address', package: const $pb.PackageName(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'google.cloud.talent.v4beta1'), createEmptyInstance: create)
    ..oo(0, [2, 3])
    ..e<$2.ContactInfoUsage>(1, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'usage', $pb.PbFieldType.OE, defaultOrMaker: $2.ContactInfoUsage.CONTACT_INFO_USAGE_UNSPECIFIED, valueOf: $2.ContactInfoUsage.valueOf, enumValues: $2.ContactInfoUsage.values)
    ..aOS(2, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'unstructuredAddress')
    ..aOM<$3.PostalAddress>(3, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'structuredAddress', subBuilder: $3.PostalAddress.create)
    ..aOM<$0.BoolValue>(4, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'current', subBuilder: $0.BoolValue.create)
    ..hasRequiredFields = false
  ;
...
class Email extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'Email', package: const $pb.PackageName(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'google.cloud.talent.v4beta1'), createEmptyInstance: create)
    ..e<$2.ContactInfoUsage>(1, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'usage', $pb.PbFieldType.OE, defaultOrMaker: $2.ContactInfoUsage.CONTACT_INFO_USAGE_UNSPECIFIED, valueOf: $2.ContactInfoUsage.valueOf, enumValues: $2.ContactInfoUsage.values)
...
class Phone extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'Phone', package: const $pb.PackageName(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'google.cloud.talent.v4beta1'), createEmptyInstance: create)
    ..e<$2.ContactInfoUsage>(1, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'usage', $pb.PbFieldType.OE, defaultOrMaker: $2.ContactInfoUsage.CONTACT_INFO_USAGE_UNSPECIFIED, valueOf: $2.ContactInfoUsage.valueOf, enumValues: $2.ContactInfoUsage.values)
    ..e<Phone_PhoneType>(2, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'type', $pb.PbFieldType.OE, defaultOrMaker: Phone_PhoneType.PHONE_TYPE_UNSPECIFIED, valueOf: Phone_PhoneType.valueOf, enumValues: Phone_PhoneType.values)
    ..aOS(3, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'number')
    ..aOS(4, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'whenAvailable')
    ..hasRequiredFields = false
  ;
...
class PersonalUri extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'PersonalUri', package: const $pb.PackageName(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'google.cloud.talent.v4beta1'), createEmptyInstance: create)
  ...
  factory PersonalUri.fromBuffer($core.List<$core.int> i, [$pb.ExtensionRegistry r = $pb.ExtensionRegistry.EMPTY]) => create()..mergeFromBuffer(i, r);
  factory PersonalUri.fromJson($core.String i, [$pb.ExtensionRegistry r = $pb.ExtensionRegistry.EMPTY]) => create()..mergeFromJson(i, r);
  @$core.Deprecated(
  'Using this can add significant overhead to your binary. '
  'Use [GeneratedMessageGenericExtensions.deepCopy] instead. '
  'Will be removed in next major version')
  ...
  'Use [GeneratedMessageGenericExtensions.rebuild] instead. '
  'Will be removed in next major version')
  PersonalUri copyWith(void Function(PersonalUri) updates) => super.copyWith((message) => updates(message as PersonalUri)) as PersonalUri; // ignore: deprecated_member_use
  $pb.BuilderInfo get info_ => _i;
  @$core.pragma('dart2js:noInline')
  ...
  @$core.pragma('dart2js:noInline')
  static PersonalUri getDefault() => _defaultInstance ??= $pb.GeneratedMessage.$_defaultFor<PersonalUri>(create);
...
class AdditionalContactInfo extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'AdditionalContactInfo', package: const $pb.PackageName(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'google.cloud.talent.v4beta1'), createEmptyInstance: create)
    ..e<$2.ContactInfoUsage>(1, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'usage', $pb.PbFieldType.OE, defaultOrMaker: $2.ContactInfoUsage.CONTACT_INFO_USAGE_UNSPECIFIED, valueOf: $2.ContactInfoUsage.valueOf, enumValues: $2.ContactInfoUsage.values)
    ..aOS(2, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'name')
    ..aOS(3, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'contactId')
    ..hasRequiredFields = false
  ;
  ...
  factory AdditionalContactInfo.fromBuffer($core.List<$core.int> i, [$pb.ExtensionRegistry r = $pb.ExtensionRegistry.EMPTY]) => create()..mergeFromBuffer(i, r);
  factory AdditionalContactInfo.fromJson($core.String i, [$pb.ExtensionRegistry r = $pb.ExtensionRegistry.EMPTY]) => create()..mergeFromJson(i, r);
  @$core.Deprecated(
  'Using this can add significant overhead to your binary. '
  'Use [GeneratedMessageGenericExtensions.deepCopy] instead. '
  'Will be removed in next major version')
  ...
  'Use [GeneratedMessageGenericExtensions.rebuild] instead. '
  'Will be removed in next major version')
  AdditionalContactInfo copyWith(void Function(AdditionalContactInfo) updates) => super.copyWith((message) => updates(message as AdditionalContactInfo)) as AdditionalContactInfo; // ignore: deprecated_member_use
  $pb.BuilderInfo get info_ => _i;
  @$core.pragma('dart2js:noInline')
  ...
  @$core.pragma('dart2js:noInline')
  static AdditionalContactInfo getDefault() => _defaultInstance ??= $pb.GeneratedMessage.$_defaultFor<AdditionalContactInfo>(create);
...
class EmploymentRecord extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'EmploymentRecord', package: const $pb.PackageName(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'google.cloud.talent.v4beta1'), createEmptyInstance: create)
    ..aOM<$4.Date>(1, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'startDate', subBuilder: $4.Date.create)
    ..aOM<$4.Date>(2, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'endDate', subBuilder: $4.Date.create)
    ..aOS(3, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'employerName')
    ..aOS(4, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'divisionName')
    ..aOM<Address>(5, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'address', subBuilder: Address.create)
    ..aOS(6, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'jobTitle')
    ..aOS(7, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'jobDescription')
    ..aOM<$0.BoolValue>(8, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'isSupervisor', subBuilder: $0.BoolValue.create)
    ..aOM<$0.BoolValue>(9, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'isSelfEmployed', subBuilder: $0.BoolValue.create)
    ..aOM<$0.BoolValue>(10, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'isCurrent', subBuilder: $0.BoolValue.create)
    ..aOS(11, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'jobTitleSnippet')
    ..aOS(12, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'jobDescriptionSnippet')
    ..aOS(13, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'employerNameSnippet')
    ..hasRequiredFields = false
  ;
  ...
  factory EmploymentRecord.fromBuffer($core.List<$core.int> i, [$pb.ExtensionRegistry r = $pb.ExtensionRegistry.EMPTY]) => create()..mergeFromBuffer(i, r);
  factory EmploymentRecord.fromJson($core.String i, [$pb.ExtensionRegistry r = $pb.ExtensionRegistry.EMPTY]) => create()..mergeFromJson(i, r);
  @$core.Deprecated(
  'Using this can add significant overhead to your binary. '
  'Use [GeneratedMessageGenericExtensions.deepCopy] instead. '
  'Will be removed in next major version')
  ...
  'Use [GeneratedMessageGenericExtensions.rebuild] instead. '
  'Will be removed in next major version')
  EmploymentRecord copyWith(void Function(EmploymentRecord) updates) => super.copyWith((message) => updates(message as EmploymentRecord)) as EmploymentRecord; // ignore: deprecated_member_use
  $pb.BuilderInfo get info_ => _i;
  @$core.pragma('dart2js:noInline')
  ...
  @$core.pragma('dart2js:noInline')
  static EmploymentRecord getDefault() => _defaultInstance ??= $pb.GeneratedMessage.$_defaultFor<EmploymentRecord>(create);
...
class EducationRecord extends $pb.GeneratedMessage {
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'EducationRecord', package: const $pb.PackageName(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'google.cloud.talent.v4beta1'), createEmptyInstance: create)
    ..oo(0, [6, 7])
    ..aOM<$4.Date>(1, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'startDate', subBuilder: $4.Date.create)
    ..aOM<$4.Date>(2, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'endDate', subBuilder: $4.Date.create)
    ..aOM<$4.Date>(3, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'expectedGraduationDate', subBuilder: $4.Date.create)
    ..aOS(4, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'schoolName')
    ..aOM<Address>(5, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'address', subBuilder: Address.create)
    ..aOS(6, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'degreeDescription')
    ..aOM<Degree>(7, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'structuredDegree', subBuilder: Degree.create)
    ..aOS(8, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'description')
    ..aOM<$0.BoolValue>(9, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'isCurrent', subBuilder: $0.BoolValue.create)
    ..aOS(10, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'schoolNameSnippet')
    ..aOS(11, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'degreeSnippet')
    ..hasRequiredFields = false
  ;
  ...
  factory EducationRecord.fromBuffer($core.List<$core.int> i, [$pb.ExtensionRegistry r = $pb.ExtensionRegistry.EMPTY]) => create()..mergeFromBuffer(i, r);
  factory EducationRecord.fromJson($core.String i, [$pb.ExtensionRegistry r = $pb.ExtensionRegistry.EMPTY]) => create()..mergeFromJson(i, r);
  @$core.Deprecated(
  'Using this can add significant overhead to your binary. '
  'Use [GeneratedMessageGenericExtensions.deepCopy] instead. '
  'Will be removed in next major version')
  ...
  'Use [GeneratedMessageGenericExtensions.rebuild] instead. '
  'Will be removed in next major version')
  EducationRecord copyWith(void Function(EducationRecord) updates) => super.copyWith((message) => updates(message as EducationRecord)) as EducationRecord; // ignore: deprecated_member_use
  $pb.BuilderInfo get info_ => _i;
  @$core.pragma('dart2js:noInline')
  ...
  @$core.pragma('dart2js:noInline')
  static EducationRecord getDefault() => _defaultInstance ??= $pb.GeneratedMessage.$_defaultFor<EducationRecord>(create);
...
class Degree extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'Degree', package: const $pb.PackageName(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'google.cloud.talent.v4beta1'), createEmptyInstance: create)
    ..e<$2.DegreeType>(1, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'degreeType', $pb.PbFieldType.OE, defaultOrMaker: $2.DegreeType.DEGREE_TYPE_UNSPECIFIED, valueOf: $2.DegreeType.valueOf, enumValues: $2.DegreeType.values)
    ..aOS(2, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'degreeName')
    ..pPS(3, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'fieldsOfStudy')
    ..hasRequiredFields = false
  ;
  ...
  factory Degree.fromBuffer($core.List<$core.int> i, [$pb.ExtensionRegistry r = $pb.ExtensionRegistry.EMPTY]) => create()..mergeFromBuffer(i, r);
  factory Degree.fromJson($core.String i, [$pb.ExtensionRegistry r = $pb.ExtensionRegistry.EMPTY]) => create()..mergeFromJson(i, r);
  @$core.Deprecated(
  'Using this can add significant overhead to your binary. '
  'Use [GeneratedMessageGenericExtensions.deepCopy] instead. '
  'Will be removed in next major version')
  ...
  'Use [GeneratedMessageGenericExtensions.rebuild] instead. '
  'Will be removed in next major version')
  Degree copyWith(void Function(Degree) updates) => super.copyWith((message) => updates(message as Degree)) as Degree; // ignore: deprecated_member_use
  $pb.BuilderInfo get info_ => _i;
  @$core.pragma('dart2js:noInline')
  ...
  @$core.pragma('dart2js:noInline')
  static Degree getDefault() => _defaultInstance ??= $pb.GeneratedMessage.$_defaultFor<Degree>(create);
...
class Activity extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'Activity', package: const $pb.PackageName(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'google.cloud.talent.v4beta1'), createEmptyInstance: create)
    ...
    ..aOM<$4.Date>(4, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'createDate', subBuilder: $4.Date.create)
    ..aOM<$4.Date>(5, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'updateDate', subBuilder: $4.Date.create)
    ..pPS(6, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'teamMembers')
    ..pc<$2.Skill>(7, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'skillsUsed', $pb.PbFieldType.PM, subBuilder: $2.Skill.create)
    ..aOS(8, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'activityNameSnippet')
    ..aOS(9, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'activityDescriptionSnippet')
    ..pPS(10, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'skillsUsedSnippet')
    ..hasRequiredFields = false
  ;
...
class Publication extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'Publication', package: const $pb.PackageName(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'google.cloud.talent.v4beta1'), createEmptyInstance: create)
    ..pPS(1, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'authors')
    ..aOS(2, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'title')
    ..aOS(3, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'description')
    ..aOS(4, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'journal')
    ...
    ..aOM<$4.Date>(7, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'publicationDate', subBuilder: $4.Date.create)
    ..aOS(8, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'publicationType')
    ..aOS(9, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'isbn')
    ..hasRequiredFields = false
  ;
...
class Patent extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'Patent', package: const $pb.PackageName(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'google.cloud.talent.v4beta1'), createEmptyInstance: create)
    ..aOS(1, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'displayName')
    ..pPS(2, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'inventors')
    ..aOS(3, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'patentStatus')
    ..aOM<$4.Date>(4, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'patentStatusDate', subBuilder: $4.Date.create)
    ..aOM<$4.Date>(5, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'patentFilingDate', subBuilder: $4.Date.create)
    ..aOS(6, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'patentOffice')
    ..aOS(7, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'patentNumber')
    ..aOS(8, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'patentDescription')
    ..pc<$2.Skill>(9, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'skillsUsed', $pb.PbFieldType.PM, subBuilder: $2.Skill.create)
    ..hasRequiredFields = false
  ;
  ...
  factory Patent.fromBuffer($core.List<$core.int> i, [$pb.ExtensionRegistry r = $pb.ExtensionRegistry.EMPTY]) => create()..mergeFromBuffer(i, r);
  factory Patent.fromJson($core.String i, [$pb.ExtensionRegistry r = $pb.ExtensionRegistry.EMPTY]) => create()..mergeFromJson(i, r);
  @$core.Deprecated(
  'Using this can add significant overhead to your binary. '
  'Use [GeneratedMessageGenericExtensions.deepCopy] instead. '
  'Will be removed in next major version')
  ...
  'Use [GeneratedMessageGenericExtensions.rebuild] instead. '
  'Will be removed in next major version')
  Patent copyWith(void Function(Patent) updates) => super.copyWith((message) => updates(message as Patent)) as Patent; // ignore: deprecated_member_use
  $pb.BuilderInfo get info_ => _i;
  @$core.pragma('dart2js:noInline')
  ...
  @$core.pragma('dart2js:noInline')
  static Patent getDefault() => _defaultInstance ??= $pb.GeneratedMessage.$_defaultFor<Patent>(create);

...
class JobQuery extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'JobQuery', package: const $pb.PackageName(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'google.cloud.talent.v4beta1'), createEmptyInstance: create)
    ..aOS(1, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'query')
    ..pPS(2, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'companies')
    ..pc<LocationFilter>(3, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'locationFilters', $pb.PbFieldType.PM, subBuilder: LocationFilter.create)
    ..pc<$0.JobCategory>(4, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'jobCategories', $pb.PbFieldType.PE, valueOf: $0.JobCategory.valueOf, enumValues: $0.JobCategory.values)
    ..aOM<CommuteFilter>(5, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'commuteFilter', subBuilder: CommuteFilter.create)
    ..pPS(6, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'companyDisplayNames')
    ..aOM<CompensationFilter>(7, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'compensationFilter', subBuilder: CompensationFilter.create)
    ..aOS(8, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'customAttributeFilter')
    ..aOB(9, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'disableSpellCheck')
    ..pc<$0.EmploymentType>(10, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'employmentTypes', $pb.PbFieldType.PE, valueOf: $0.EmploymentType.valueOf, enumValues: $0.EmploymentType.values)
    ..pPS(11, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'languageCodes')
    ..aOM<$0.TimestampRange>(12, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'publishTimeRange', subBuilder: $0.TimestampRange.create)
    ..pPS(13, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'excludedJobs')
    ..aOS(14, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'queryLanguageCode')
  ...
  'Will be removed in next major version')
  JobQuery copyWith(void Function(JobQuery) updates) => super.copyWith((message) => updates(message as JobQuery)) as JobQuery; // ignore: deprecated_member_use
...
class ProfileQuery extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'ProfileQuery', package: const $pb.PackageName(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'google.cloud.talent.v4beta1'), createEmptyInstance: create)
    ..aOS(1, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'query')
    ..pc<LocationFilter>(2, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'locationFilters', $pb.PbFieldType.PM, subBuilder: LocationFilter.create)
    ..pc<JobTitleFilter>(3, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'jobTitleFilters', $pb.PbFieldType.PM, subBuilder: JobTitleFilter.create)
    ..pc<EmployerFilter>(4, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'employerFilters', $pb.PbFieldType.PM, subBuilder: EmployerFilter.create)
    ..pc<EducationFilter>(5, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'educationFilters', $pb.PbFieldType.PM, subBuilder: EducationFilter.create)
    ..pc<SkillFilter>(6, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'skillFilters', $pb.PbFieldType.PM, subBuilder: SkillFilter.create)
    ..pc<WorkExperienceFilter>(7, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'workExperienceFilter', $pb.PbFieldType.PM, subBuilder: WorkExperienceFilter.create)
    ..pc<TimeFilter>(8, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'timeFilters', $pb.PbFieldType.PM, subBuilder: TimeFilter.create)
    ..aOM<$1.BoolValue>(9, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'hirableFilter', subBuilder: $1.BoolValue.create)
    ..pc<ApplicationDateFilter>(10, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'applicationDateFilters', $pb.PbFieldType.PM, subBuilder: ApplicationDateFilter.create)
    ..pc<ApplicationOutcomeNotesFilter>(11, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'applicationOutcomeNotesFilters', $pb.PbFieldType.PM, subBuilder: ApplicationOutcomeNotesFilter.create)
    ..pc<ApplicationJobFilter>(13, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'applicationJobFilters', $pb.PbFieldType.PM, subBuilder: ApplicationJobFilter.create)
    ..aOS(15, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'customAttributeFilter')
    ..aOM<CandidateAvailabilityFilter>(16, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'candidateAvailabilityFilter', subBuilder: CandidateAvailabilityFilter.create)
    ..pc<PersonNameFilter>(17, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'personNameFilters', $pb.PbFieldType.PM, subBuilder: PersonNameFilter.create)
    ..pc<AvailabilityFilter>(18, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'availabilityFilters', $pb.PbFieldType.PM, subBuilder: AvailabilityFilter.create)
    ..hasRequiredFields = false
  ;
  ...
  factory ProfileQuery({
    ...
    $core.Iterable<ApplicationOutcomeNotesFilter>? applicationOutcomeNotesFilters,
  ...
  @$core.Deprecated('This field is deprecated.')
    ...
    if (applicationOutcomeNotesFilters != null) {
      _result.applicationOutcomeNotesFilters.addAll(applicationOutcomeNotesFilters);
    }
  ...
  factory ProfileQuery.fromBuffer($core.List<$core.int> i, [$pb.ExtensionRegistry r = $pb.ExtensionRegistry.EMPTY]) => create()..mergeFromBuffer(i, r);
  factory ProfileQuery.fromJson($core.String i, [$pb.ExtensionRegistry r = $pb.ExtensionRegistry.EMPTY]) => create()..mergeFromJson(i, r);
  @$core.Deprecated(
  'Using this can add significant overhead to your binary. '
  'Use [GeneratedMessageGenericExtensions.deepCopy] instead. '
  'Will be removed in next major version')
  ...
  'Use [GeneratedMessageGenericExtensions.rebuild] instead. '
  'Will be removed in next major version')
  ProfileQuery copyWith(void Function(ProfileQuery) updates) => super.copyWith((message) => updates(message as ProfileQuery)) as ProfileQuery; // ignore: deprecated_member_use
  $pb.BuilderInfo get info_ => _i;
  @$core.pragma('dart2js:noInline')
  ...
  @$core.pragma('dart2js:noInline')
  static ProfileQuery getDefault() => _defaultInstance ??= $pb.GeneratedMessage.$_defaultFor<ProfileQuery>(create);
  ...
  @$core.Deprecated('This field is deprecated.')
  @$pb.TagNumber(16)
  set candidateAvailabilityFilter(CandidateAvailabilityFilter v) { setField(16, v); }
  @$core.Deprecated('This field is deprecated.')
  @$pb.TagNumber(16)
  ...
  @$core.Deprecated('This field is deprecated.')
  @$pb.TagNumber(16)
  CandidateAvailabilityFilter ensureCandidateAvailabilityFilter() => $_ensure(13);
...
class LocationFilter extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'LocationFilter', package: const $pb.PackageName(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'google.cloud.talent.v4beta1'), createEmptyInstance: create)
    ..aOS(1, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'address')
    ..aOS(2, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'regionCode')
    ..aOM<$2.LatLng>(3, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'latLng', subBuilder: $2.LatLng.create)
    ..a<$core.double>(4, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'distanceInMiles', $pb.PbFieldType.OD)
    ..e<LocationFilter_TelecommutePreference>(5, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'telecommutePreference', $pb.PbFieldType.OE, defaultOrMaker: LocationFilter_TelecommutePreference.TELECOMMUTE_PREFERENCE_UNSPECIFIED, valueOf: LocationFilter_TelecommutePreference.valueOf, enumValues: LocationFilter_TelecommutePreference.values)
    ..aOB(6, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'negated')
    ..hasRequiredFields = false
  ;
  ...
  'Use [GeneratedMessageGenericExtensions.rebuild] instead. '
  'Will be removed in next major version')
  LocationFilter copyWith(void Function(LocationFilter) updates) => super.copyWith((message) => updates(message as LocationFilter)) as LocationFilter; // ignore: deprecated_member_use
  $pb.BuilderInfo get info_ => _i;
  @$core.pragma('dart2js:noInline')
...
class CompensationFilter extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'CompensationFilter', package: const $pb.PackageName(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'google.cloud.talent.v4beta1'), createEmptyInstance: create)
    ..e<CompensationFilter_FilterType>(1, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'type', $pb.PbFieldType.OE, defaultOrMaker: CompensationFilter_FilterType.FILTER_TYPE_UNSPECIFIED, valueOf: CompensationFilter_FilterType.valueOf, enumValues: CompensationFilter_FilterType.values)
    ..pc<$0.CompensationInfo_CompensationUnit>(2, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'units', $pb.PbFieldType.PE, valueOf: $0.CompensationInfo_CompensationUnit.valueOf, enumValues: $0.CompensationInfo_CompensationUnit.values)
    ..aOM<$0.CompensationInfo_CompensationRange>(3, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'range', subBuilder: $0.CompensationInfo_CompensationRange.create)
    ..aOB(4, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'includeJobsWithUnspecifiedCompensationRange')
    ..hasRequiredFields = false
  ;
  ...
  factory CompensationFilter({
    ...
    if (includeJobsWithUnspecifiedCompensationRange != null) {
      _result.includeJobsWithUnspecifiedCompensationRange = includeJobsWithUnspecifiedCompensationRange;
    }
    return _result;
  }
  ...
  'Use [GeneratedMessageGenericExtensions.rebuild] instead. '
  'Will be removed in next major version')
  CompensationFilter copyWith(void Function(CompensationFilter) updates) => super.copyWith((message) => updates(message as CompensationFilter)) as CompensationFilter; // ignore: deprecated_member_use
  $pb.BuilderInfo get info_ => _i;
  @$core.pragma('dart2js:noInline')
...
class CommuteFilter extends $pb.GeneratedMessage {
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'CommuteFilter', package: const $pb.PackageName(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'google.cloud.talent.v4beta1'), createEmptyInstance: create)
    ..oo(0, [5, 6])
    ..e<$0.CommuteMethod>(1, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'commuteMethod', $pb.PbFieldType.OE, defaultOrMaker: $0.CommuteMethod.COMMUTE_METHOD_UNSPECIFIED, valueOf: $0.CommuteMethod.valueOf, enumValues: $0.CommuteMethod.values)
    ..aOM<$2.LatLng>(2, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'startCoordinates', subBuilder: $2.LatLng.create)
    ..aOM<$3.Duration>(3, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'travelDuration', subBuilder: $3.Duration.create)
    ..aOB(4, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'allowImpreciseAddresses')
    ..e<CommuteFilter_RoadTraffic>(5, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'roadTraffic', $pb.PbFieldType.OE, defaultOrMaker: CommuteFilter_RoadTraffic.ROAD_TRAFFIC_UNSPECIFIED, valueOf: CommuteFilter_RoadTraffic.valueOf, enumValues: CommuteFilter_RoadTraffic.values)
    ..aOM<$4.TimeOfDay>(6, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'departureTime', subBuilder: $4.TimeOfDay.create)
    ..hasRequiredFields = false
  ;
  ...
  'Use [GeneratedMessageGenericExtensions.rebuild] instead. '
  'Will be removed in next major version')
  CommuteFilter copyWith(void Function(CommuteFilter) updates) => super.copyWith((message) => updates(message as CommuteFilter)) as CommuteFilter; // ignore: deprecated_member_use
  $pb.BuilderInfo get info_ => _i;
  @$core.pragma('dart2js:noInline')
...
class JobTitleFilter extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'JobTitleFilter', package: const $pb.PackageName(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'google.cloud.talent.v4beta1'), createEmptyInstance: create)
    ..aOS(1, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'jobTitle')
  ...
  factory JobTitleFilter.fromBuffer($core.List<$core.int> i, [$pb.ExtensionRegistry r = $pb.ExtensionRegistry.EMPTY]) => create()..mergeFromBuffer(i, r);
  factory JobTitleFilter.fromJson($core.String i, [$pb.ExtensionRegistry r = $pb.ExtensionRegistry.EMPTY]) => create()..mergeFromJson(i, r);
  @$core.Deprecated(
  'Using this can add significant overhead to your binary. '
  'Use [GeneratedMessageGenericExtensions.deepCopy] instead. '
  'Will be removed in next major version')
  ...
  'Use [GeneratedMessageGenericExtensions.rebuild] instead. '
  'Will be removed in next major version')
  JobTitleFilter copyWith(void Function(JobTitleFilter) updates) => super.copyWith((message) => updates(message as JobTitleFilter)) as JobTitleFilter; // ignore: deprecated_member_use
  $pb.BuilderInfo get info_ => _i;
  @$core.pragma('dart2js:noInline')
  ...
  @$core.pragma('dart2js:noInline')
  static JobTitleFilter getDefault() => _defaultInstance ??= $pb.GeneratedMessage.$_defaultFor<JobTitleFilter>(create);
...
class SkillFilter extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'SkillFilter', package: const $pb.PackageName(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'google.cloud.talent.v4beta1'), createEmptyInstance: create)
    ..aOS(1, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'skill')
    ..aOB(2, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'negated')
    ..hasRequiredFields = false
  ;
  ...
  factory SkillFilter.fromBuffer($core.List<$core.int> i, [$pb.ExtensionRegistry r = $pb.ExtensionRegistry.EMPTY]) => create()..mergeFromBuffer(i, r);
  factory SkillFilter.fromJson($core.String i, [$pb.ExtensionRegistry r = $pb.ExtensionRegistry.EMPTY]) => create()..mergeFromJson(i, r);
  @$core.Deprecated(
  'Using this can add significant overhead to your binary. '
  'Use [GeneratedMessageGenericExtensions.deepCopy] instead. '
  'Will be removed in next major version')
  ...
  'Use [GeneratedMessageGenericExtensions.rebuild] instead. '
  'Will be removed in next major version')
  SkillFilter copyWith(void Function(SkillFilter) updates) => super.copyWith((message) => updates(message as SkillFilter)) as SkillFilter; // ignore: deprecated_member_use
  $pb.BuilderInfo get info_ => _i;
  @$core.pragma('dart2js:noInline')
  ...
  @$core.pragma('dart2js:noInline')
  static SkillFilter getDefault() => _defaultInstance ??= $pb.GeneratedMessage.$_defaultFor<SkillFilter>(create);
...
class EmployerFilter extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'EmployerFilter', package: const $pb.PackageName(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'google.cloud.talent.v4beta1'), createEmptyInstance: create)
    ..aOS(1, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'employer')
    ..e<EmployerFilter_EmployerFilterMode>(2, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'mode', $pb.PbFieldType.OE, defaultOrMaker: EmployerFilter_EmployerFilterMode.EMPLOYER_FILTER_MODE_UNSPECIFIED, valueOf: EmployerFilter_EmployerFilterMode.valueOf, enumValues: EmployerFilter_EmployerFilterMode.values)
    ..aOB(3, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'negated')
    ..hasRequiredFields = false
  ;
  ...
  factory EmployerFilter.fromBuffer($core.List<$core.int> i, [$pb.ExtensionRegistry r = $pb.ExtensionRegistry.EMPTY]) => create()..mergeFromBuffer(i, r);
  factory EmployerFilter.fromJson($core.String i, [$pb.ExtensionRegistry r = $pb.ExtensionRegistry.EMPTY]) => create()..mergeFromJson(i, r);
  @$core.Deprecated(
  'Using this can add significant overhead to your binary. '
  'Use [GeneratedMessageGenericExtensions.deepCopy] instead. '
  'Will be removed in next major version')
  ...
  'Use [GeneratedMessageGenericExtensions.rebuild] instead. '
  'Will be removed in next major version')
  EmployerFilter copyWith(void Function(EmployerFilter) updates) => super.copyWith((message) => updates(message as EmployerFilter)) as EmployerFilter; // ignore: deprecated_member_use
  $pb.BuilderInfo get info_ => _i;
  @$core.pragma('dart2js:noInline')
  ...
  @$core.pragma('dart2js:noInline')
  static EmployerFilter getDefault() => _defaultInstance ??= $pb.GeneratedMessage.$_defaultFor<EmployerFilter>(create);
...
class EducationFilter extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'EducationFilter', package: const $pb.PackageName(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'google.cloud.talent.v4beta1'), createEmptyInstance: create)
    ..aOS(1, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'school')
    ..aOS(2, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'fieldOfStudy')
    ..e<$0.DegreeType>(3, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'degreeType', $pb.PbFieldType.OE, defaultOrMaker: $0.DegreeType.DEGREE_TYPE_UNSPECIFIED, valueOf: $0.DegreeType.valueOf, enumValues: $0.DegreeType.values)
    ..aOB(6, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'negated')
    ..hasRequiredFields = false
  ;
  ...
  factory EducationFilter.fromBuffer($core.List<$core.int> i, [$pb.ExtensionRegistry r = $pb.ExtensionRegistry.EMPTY]) => create()..mergeFromBuffer(i, r);
  factory EducationFilter.fromJson($core.String i, [$pb.ExtensionRegistry r = $pb.ExtensionRegistry.EMPTY]) => create()..mergeFromJson(i, r);
  @$core.Deprecated(
  'Using this can add significant overhead to your binary. '
  'Use [GeneratedMessageGenericExtensions.deepCopy] instead. '
  'Will be removed in next major version')
  ...
  'Use [GeneratedMessageGenericExtensions.rebuild] instead. '
  'Will be removed in next major version')
  EducationFilter copyWith(void Function(EducationFilter) updates) => super.copyWith((message) => updates(message as EducationFilter)) as EducationFilter; // ignore: deprecated_member_use
  $pb.BuilderInfo get info_ => _i;
  @$core.pragma('dart2js:noInline')
  ...
  @$core.pragma('dart2js:noInline')
  static EducationFilter getDefault() => _defaultInstance ??= $pb.GeneratedMessage.$_defaultFor<EducationFilter>(create);
...
class WorkExperienceFilter extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'WorkExperienceFilter', package: const $pb.PackageName(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'google.cloud.talent.v4beta1'), createEmptyInstance: create)
    ..aOM<$3.Duration>(1, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'minExperience', subBuilder: $3.Duration.create)
    ..aOM<$3.Duration>(2, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'maxExperience', subBuilder: $3.Duration.create)
    ..hasRequiredFields = false
  ;
  ...
  factory WorkExperienceFilter.fromBuffer($core.List<$core.int> i, [$pb.ExtensionRegistry r = $pb.ExtensionRegistry.EMPTY]) => create()..mergeFromBuffer(i, r);
  factory WorkExperienceFilter.fromJson($core.String i, [$pb.ExtensionRegistry r = $pb.ExtensionRegistry.EMPTY]) => create()..mergeFromJson(i, r);
  @$core.Deprecated(
  'Using this can add significant overhead to your binary. '
  'Use [GeneratedMessageGenericExtensions.deepCopy] instead. '
  'Will be removed in next major version')
  ...
  'Use [GeneratedMessageGenericExtensions.rebuild] instead. '
  'Will be removed in next major version')
  WorkExperienceFilter copyWith(void Function(WorkExperienceFilter) updates) => super.copyWith((message) => updates(message as WorkExperienceFilter)) as WorkExperienceFilter; // ignore: deprecated_member_use
  $pb.BuilderInfo get info_ => _i;
  @$core.pragma('dart2js:noInline')
  ...
  @$core.pragma('dart2js:noInline')
  static WorkExperienceFilter getDefault() => _defaultInstance ??= $pb.GeneratedMessage.$_defaultFor<WorkExperienceFilter>(create);
...
class ApplicationDateFilter extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'ApplicationDateFilter', package: const $pb.PackageName(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'google.cloud.talent.v4beta1'), createEmptyInstance: create)
    ..aOM<$5.Date>(1, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'startDate', subBuilder: $5.Date.create)
    ..aOM<$5.Date>(2, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'endDate', subBuilder: $5.Date.create)
    ..hasRequiredFields = false
  ;
  ...
  factory ApplicationDateFilter.fromBuffer($core.List<$core.int> i, [$pb.ExtensionRegistry r = $pb.ExtensionRegistry.EMPTY]) => create()..mergeFromBuffer(i, r);
  factory ApplicationDateFilter.fromJson($core.String i, [$pb.ExtensionRegistry r = $pb.ExtensionRegistry.EMPTY]) => create()..mergeFromJson(i, r);
  @$core.Deprecated(
  'Using this can add significant overhead to your binary. '
  'Use [GeneratedMessageGenericExtensions.deepCopy] instead. '
  'Will be removed in next major version')
  ...
  'Use [GeneratedMessageGenericExtensions.rebuild] instead. '
  'Will be removed in next major version')
  ApplicationDateFilter copyWith(void Function(ApplicationDateFilter) updates) => super.copyWith((message) => updates(message as ApplicationDateFilter)) as ApplicationDateFilter; // ignore: deprecated_member_use
  $pb.BuilderInfo get info_ => _i;
  @$core.pragma('dart2js:noInline')
  ...
  @$core.pragma('dart2js:noInline')
  static ApplicationDateFilter getDefault() => _defaultInstance ??= $pb.GeneratedMessage.$_defaultFor<ApplicationDateFilter>(create);
...
class ApplicationOutcomeNotesFilter extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'ApplicationOutcomeNotesFilter', package: const $pb.PackageName(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'google.cloud.talent.v4beta1'), createEmptyInstance: create)
    ..aOS(1, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'outcomeNotes')
    ..aOB(2, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'negated')
    ..hasRequiredFields = false
  ;
  ...
  factory ApplicationOutcomeNotesFilter.fromBuffer($core.List<$core.int> i, [$pb.ExtensionRegistry r = $pb.ExtensionRegistry.EMPTY]) => create()..mergeFromBuffer(i, r);
  factory ApplicationOutcomeNotesFilter.fromJson($core.String i, [$pb.ExtensionRegistry r = $pb.ExtensionRegistry.EMPTY]) => create()..mergeFromJson(i, r);
  @$core.Deprecated(
  'Using this can add significant overhead to your binary. '
  'Use [GeneratedMessageGenericExtensions.deepCopy] instead. '
  'Will be removed in next major version')
  ...
  'Use [GeneratedMessageGenericExtensions.rebuild] instead. '
  'Will be removed in next major version')
  ApplicationOutcomeNotesFilter copyWith(void Function(ApplicationOutcomeNotesFilter) updates) => super.copyWith((message) => updates(message as ApplicationOutcomeNotesFilter)) as ApplicationOutcomeNotesFilter; // ignore: deprecated_member_use
  $pb.BuilderInfo get info_ => _i;
  @$core.pragma('dart2js:noInline')
  static ApplicationOutcomeNotesFilter create() => ApplicationOutcomeNotesFilter._();
  ...
  @$core.pragma('dart2js:noInline')
  static ApplicationOutcomeNotesFilter getDefault() => _defaultInstance ??= $pb.GeneratedMessage.$_defaultFor<ApplicationOutcomeNotesFilter>(create);
...
class ApplicationJobFilter extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'ApplicationJobFilter', package: const $pb.PackageName(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'google.cloud.talent.v4beta1'), createEmptyInstance: create)
    ..aOS(2, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'jobRequisitionId')
    ..aOS(3, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'jobTitle')
    ..aOB(4, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'negated')
    ..hasRequiredFields = false
  ;
  ...
  factory ApplicationJobFilter.fromBuffer($core.List<$core.int> i, [$pb.ExtensionRegistry r = $pb.ExtensionRegistry.EMPTY]) => create()..mergeFromBuffer(i, r);
  factory ApplicationJobFilter.fromJson($core.String i, [$pb.ExtensionRegistry r = $pb.ExtensionRegistry.EMPTY]) => create()..mergeFromJson(i, r);
  @$core.Deprecated(
  'Using this can add significant overhead to your binary. '
  'Use [GeneratedMessageGenericExtensions.deepCopy] instead. '
  'Will be removed in next major version')
  ...
  'Use [GeneratedMessageGenericExtensions.rebuild] instead. '
  'Will be removed in next major version')
  ApplicationJobFilter copyWith(void Function(ApplicationJobFilter) updates) => super.copyWith((message) => updates(message as ApplicationJobFilter)) as ApplicationJobFilter; // ignore: deprecated_member_use
  $pb.BuilderInfo get info_ => _i;
  @$core.pragma('dart2js:noInline')
  ...
  @$core.pragma('dart2js:noInline')
  static ApplicationJobFilter getDefault() => _defaultInstance ??= $pb.GeneratedMessage.$_defaultFor<ApplicationJobFilter>(create);
...
class TimeFilter extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'TimeFilter', package: const $pb.PackageName(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'google.cloud.talent.v4beta1'), createEmptyInstance: create)
    ..aOM<$6.Timestamp>(1, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'startTime', subBuilder: $6.Timestamp.create)
    ..aOM<$6.Timestamp>(2, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'endTime', subBuilder: $6.Timestamp.create)
    ..e<TimeFilter_TimeField>(3, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'timeField', $pb.PbFieldType.OE, defaultOrMaker: TimeFilter_TimeField.TIME_FIELD_UNSPECIFIED, valueOf: TimeFilter_TimeField.valueOf, enumValues: TimeFilter_TimeField.values)
    ..hasRequiredFields = false
  ;
...
class CandidateAvailabilityFilter extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'CandidateAvailabilityFilter', package: const $pb.PackageName(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'google.cloud.talent.v4beta1'), createEmptyInstance: create)
    ..aOB(1, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'negated')
    ..hasRequiredFields = false
  ;
  ...
  factory CandidateAvailabilityFilter.fromBuffer($core.List<$core.int> i, [$pb.ExtensionRegistry r = $pb.ExtensionRegistry.EMPTY]) => create()..mergeFromBuffer(i, r);
  factory CandidateAvailabilityFilter.fromJson($core.String i, [$pb.ExtensionRegistry r = $pb.ExtensionRegistry.EMPTY]) => create()..mergeFromJson(i, r);
  @$core.Deprecated(
  'Using this can add significant overhead to your binary. '
  'Use [GeneratedMessageGenericExtensions.deepCopy] instead. '
  'Will be removed in next major version')
  CandidateAvailabilityFilter clone() => CandidateAvailabilityFilter()..mergeFromMessage(this);
  @$core.Deprecated(
  'Using this can add significant overhead to your binary. '
  'Use [GeneratedMessageGenericExtensions.rebuild] instead. '
  'Will be removed in next major version')
  CandidateAvailabilityFilter copyWith(void Function(CandidateAvailabilityFilter) updates) => super.copyWith((message) => updates(message as CandidateAvailabilityFilter)) as CandidateAvailabilityFilter; // ignore: deprecated_member_use
  $pb.BuilderInfo get info_ => _i;
  @$core.pragma('dart2js:noInline')
  static CandidateAvailabilityFilter create() => CandidateAvailabilityFilter._();
  CandidateAvailabilityFilter createEmptyInstance() => create();
  static $pb.PbList<CandidateAvailabilityFilter> createRepeated() => $pb.PbList<CandidateAvailabilityFilter>();
  @$core.pragma('dart2js:noInline')
  static CandidateAvailabilityFilter getDefault() => _defaultInstance ??= $pb.GeneratedMessage.$_defaultFor<CandidateAvailabilityFilter>(create);
  static CandidateAvailabilityFilter? _defaultInstance;

  @$pb.TagNumber(1)
  $core.bool get negated => $_getBF(0);
  @$pb.TagNumber(1)
  set negated($core.bool v) { $_setBool(0, v); }
  @$pb.TagNumber(1)
...
class AvailabilityFilter extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'AvailabilityFilter', package: const $pb.PackageName(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'google.cloud.talent.v4beta1'), createEmptyInstance: create)
    ..e<$0.AvailabilitySignalType>(1, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'signalType', $pb.PbFieldType.OE, defaultOrMaker: $0.AvailabilitySignalType.AVAILABILITY_SIGNAL_TYPE_UNSPECIFIED, valueOf: $0.AvailabilitySignalType.valueOf, enumValues: $0.AvailabilitySignalType.values)
    ..aOM<$0.TimestampRange>(2, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'range', subBuilder: $0.TimestampRange.create)
  ...
  factory AvailabilityFilter.fromBuffer($core.List<$core.int> i, [$pb.ExtensionRegistry r = $pb.ExtensionRegistry.EMPTY]) => create()..mergeFromBuffer(i, r);
  factory AvailabilityFilter.fromJson($core.String i, [$pb.ExtensionRegistry r = $pb.ExtensionRegistry.EMPTY]) => create()..mergeFromJson(i, r);
  @$core.Deprecated(
  'Using this can add significant overhead to your binary. '
  'Use [GeneratedMessageGenericExtensions.deepCopy] instead. '
  'Will be removed in next major version')
  ...
  'Use [GeneratedMessageGenericExtensions.rebuild] instead. '
  'Will be removed in next major version')
  AvailabilityFilter copyWith(void Function(AvailabilityFilter) updates) => super.copyWith((message) => updates(message as AvailabilityFilter)) as AvailabilityFilter; // ignore: deprecated_member_use
  $pb.BuilderInfo get info_ => _i;
  @$core.pragma('dart2js:noInline')
  static AvailabilityFilter create() => AvailabilityFilter._();
  AvailabilityFilter createEmptyInstance() => create();
  static $pb.PbList<AvailabilityFilter> createRepeated() => $pb.PbList<AvailabilityFilter>();
  @$core.pragma('dart2js:noInline')
  static AvailabilityFilter getDefault() => _defaultInstance ??= $pb.GeneratedMessage.$_defaultFor<AvailabilityFilter>(create);
  static AvailabilityFilter? _defaultInstance;

  @$pb.TagNumber(1)
  $0.AvailabilitySignalType get signalType => $_getN(0);
  @$pb.TagNumber(1)
  set signalType($0.AvailabilitySignalType v) { setField(1, v); }
  @$pb.TagNumber(1)
  ...
  @$pb.TagNumber(2)
  set range($0.TimestampRange v) { setField(2, v); }
  @$pb.TagNumber(2)
...
class PersonNameFilter extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'PersonNameFilter', package: const $pb.PackageName(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'google.cloud.talent.v4beta1'), createEmptyInstance: create)
    ..aOS(1, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'personName')
    ..hasRequiredFields = false
  ;
  ...
  factory PersonNameFilter.fromBuffer($core.List<$core.int> i, [$pb.ExtensionRegistry r = $pb.ExtensionRegistry.EMPTY]) => create()..mergeFromBuffer(i, r);
  factory PersonNameFilter.fromJson($core.String i, [$pb.ExtensionRegistry r = $pb.ExtensionRegistry.EMPTY]) => create()..mergeFromJson(i, r);
  @$core.Deprecated(
  'Using this can add significant overhead to your binary. '
  'Use [GeneratedMessageGenericExtensions.deepCopy] instead. '
  'Will be removed in next major version')
  ...
  'Use [GeneratedMessageGenericExtensions.rebuild] instead. '
  'Will be removed in next major version')
  PersonNameFilter copyWith(void Function(PersonNameFilter) updates) => super.copyWith((message) => updates(message as PersonNameFilter)) as PersonNameFilter; // ignore: deprecated_member_use
  $pb.BuilderInfo get info_ => _i;
  @$core.pragma('dart2js:noInline')
  static PersonNameFilter create() => PersonNameFilter._();
  PersonNameFilter createEmptyInstance() => create();
  static $pb.PbList<PersonNameFilter> createRepeated() => $pb.PbList<PersonNameFilter>();
  @$core.pragma('dart2js:noInline')
  static PersonNameFilter getDefault() => _defaultInstance ??= $pb.GeneratedMessage.$_defaultFor<PersonNameFilter>(create);

...
class ClientEvent extends $pb.GeneratedMessage {
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'ClientEvent', package: const $pb.PackageName(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'google.cloud.talent.v4beta1'), createEmptyInstance: create)
    ..oo(0, [5, 6])
    ...
    ..aOM<JobEvent>(5, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'jobEvent', subBuilder: JobEvent.create)
    ..aOM<ProfileEvent>(6, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'profileEvent', subBuilder: ProfileEvent.create)
    ..aOS(9, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'eventNotes')
  ...
  @$pb.TagNumber(6)
  set profileEvent(ProfileEvent v) { setField(6, v); }
  @$pb.TagNumber(6)
  ...
  @$pb.TagNumber(9)
  set eventNotes($core.String v) { $_setString(5, v); }
  @$pb.TagNumber(9)
...
class JobEvent extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'JobEvent', package: const $pb.PackageName(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'google.cloud.talent.v4beta1'), createEmptyInstance: create)
    ..e<JobEvent_JobEventType>(1, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'type', $pb.PbFieldType.OE, defaultOrMaker: JobEvent_JobEventType.JOB_EVENT_TYPE_UNSPECIFIED, valueOf: JobEvent_JobEventType.valueOf, enumValues: JobEvent_JobEventType.values)
    ..pPS(2, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'jobs')
    ..aOS(3, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'profile')
    ..hasRequiredFields = false
  ;
...
class ProfileEvent extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'ProfileEvent', package: const $pb.PackageName(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'google.cloud.talent.v4beta1'), createEmptyInstance: create)
    ..e<ProfileEvent_ProfileEventType>(1, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'type', $pb.PbFieldType.OE, defaultOrMaker: ProfileEvent_ProfileEventType.PROFILE_EVENT_TYPE_UNSPECIFIED, valueOf: ProfileEvent_ProfileEventType.valueOf, enumValues: ProfileEvent_ProfileEventType.values)
    ..pPS(2, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'profiles')
    ..pPS(6, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'jobs')
    ..hasRequiredFields = false
  ;
  ...
  factory ProfileEvent.fromBuffer($core.List<$core.int> i, [$pb.ExtensionRegistry r = $pb.ExtensionRegistry.EMPTY]) => create()..mergeFromBuffer(i, r);
  factory ProfileEvent.fromJson($core.String i, [$pb.ExtensionRegistry r = $pb.ExtensionRegistry.EMPTY]) => create()..mergeFromJson(i, r);
  @$core.Deprecated(
  'Using this can add significant overhead to your binary. '
  'Use [GeneratedMessageGenericExtensions.deepCopy] instead. '
  'Will be removed in next major version')
  ...
  'Use [GeneratedMessageGenericExtensions.rebuild] instead. '
  'Will be removed in next major version')
  ProfileEvent copyWith(void Function(ProfileEvent) updates) => super.copyWith((message) => updates(message as ProfileEvent)) as ProfileEvent; // ignore: deprecated_member_use
  $pb.BuilderInfo get info_ => _i;
  @$core.pragma('dart2js:noInline')
  static ProfileEvent create() => ProfileEvent._();
  ProfileEvent createEmptyInstance() => create();
  static $pb.PbList<ProfileEvent> createRepeated() => $pb.PbList<ProfileEvent>();
  @$core.pragma('dart2js:noInline')
  static ProfileEvent getDefault() => _defaultInstance ??= $pb.GeneratedMessage.$_defaultFor<ProfileEvent>(create);
  static ProfileEvent? _defaultInstance;

  @$pb.TagNumber(1)
  ProfileEvent_ProfileEventType get type => $_getN(0);
  @$pb.TagNumber(1)
  set type(ProfileEvent_ProfileEventType v) { setField(1, v); }
  @$pb.TagNumber(1)
  $core.bool hasType() => $_has(0);
  @$pb.TagNumber(1)
  void clearType() => clearField(1);

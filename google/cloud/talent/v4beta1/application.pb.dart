...
class Application extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'Application', package: const $pb.PackageName(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'google.cloud.talent.v4beta1'), createEmptyInstance: create)
    ..aOS(1, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'name')
    ..aOS(2, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'profile')
    ..aOS(4, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'job')
    ..aOS(5, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'company')
    ..aOM<$0.Date>(7, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'applicationDate', subBuilder: $0.Date.create)
    ..e<Application_ApplicationStage>(11, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'stage', $pb.PbFieldType.OE, defaultOrMaker: Application_ApplicationStage.APPLICATION_STAGE_UNSPECIFIED, valueOf: Application_ApplicationStage.valueOf, enumValues: Application_ApplicationStage.values)
    ..e<Application_ApplicationState>(13, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'state', $pb.PbFieldType.OE, defaultOrMaker: Application_ApplicationState.APPLICATION_STATE_UNSPECIFIED, valueOf: Application_ApplicationState.valueOf, enumValues: Application_ApplicationState.values)
    ..pc<$1.Interview>(16, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'interviews', $pb.PbFieldType.PM, subBuilder: $1.Interview.create)
    ..aOM<$2.BoolValue>(18, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'referral', subBuilder: $2.BoolValue.create)
    ..aOM<$3.Timestamp>(19, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'createTime', subBuilder: $3.Timestamp.create)
    ..aOM<$3.Timestamp>(20, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'updateTime', subBuilder: $3.Timestamp.create)
    ..aOS(21, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'outcomeNotes')
    ..e<$1.Outcome>(22, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'outcome', $pb.PbFieldType.OE, defaultOrMaker: $1.Outcome.OUTCOME_UNSPECIFIED, valueOf: $1.Outcome.valueOf, enumValues: $1.Outcome.values)
    ..aOM<$2.BoolValue>(28, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'isMatch', subBuilder: $2.BoolValue.create)
    ..aOS(29, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'jobTitleSnippet')
    ..aOS(31, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'externalId')
  ...
  @$pb.TagNumber(4)
  set job($core.String v) { $_setString(2, v); }
  @$pb.TagNumber(4)
  ...
  @$pb.TagNumber(7)
  set applicationDate($0.Date v) { setField(7, v); }
  @$pb.TagNumber(7)
  ...
  @$pb.TagNumber(11)
  set stage(Application_ApplicationStage v) { setField(11, v); }
  @$pb.TagNumber(11)
  ...
  @$pb.TagNumber(13)
  set state(Application_ApplicationState v) { setField(13, v); }
  @$pb.TagNumber(13)
  ...
  @$pb.TagNumber(18)
  set referral($2.BoolValue v) { setField(18, v); }
  @$pb.TagNumber(18)
  ...
  @$pb.TagNumber(19)
  set createTime($3.Timestamp v) { setField(19, v); }
  @$pb.TagNumber(19)
  ...
  @$pb.TagNumber(20)
  set updateTime($3.Timestamp v) { setField(20, v); }
  @$pb.TagNumber(20)
  ...
  @$pb.TagNumber(21)
  set outcomeNotes($core.String v) { $_setString(11, v); }
  @$pb.TagNumber(21)
  ...
  @$pb.TagNumber(22)
  set outcome($1.Outcome v) { setField(22, v); }
  @$pb.TagNumber(22)
  ...
  @$pb.TagNumber(28)
  set isMatch($2.BoolValue v) { setField(28, v); }
  @$pb.TagNumber(28)
  ...
  @$pb.TagNumber(29)
  set jobTitleSnippet($core.String v) { $_setString(14, v); }
  @$pb.TagNumber(29)
  ...
  @$pb.TagNumber(31)
  set externalId($core.String v) { $_setString(15, v); }
  @$pb.TagNumber(31)

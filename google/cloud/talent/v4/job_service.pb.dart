...
class CreateJobRequest extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'CreateJobRequest', package: const $pb.PackageName(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'google.cloud.talent.v4'), createEmptyInstance: create)
    ..aOS(1, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'parent')
    ..aOM<$3.Job>(2, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'job', subBuilder: $3.Job.create)
...
class GetJobRequest extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'GetJobRequest', package: const $pb.PackageName(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'google.cloud.talent.v4'), createEmptyInstance: create)
...
class UpdateJobRequest extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'UpdateJobRequest', package: const $pb.PackageName(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'google.cloud.talent.v4'), createEmptyInstance: create)
    ..aOM<$3.Job>(1, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'job', subBuilder: $3.Job.create)
...
class DeleteJobRequest extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'DeleteJobRequest', package: const $pb.PackageName(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'google.cloud.talent.v4'), createEmptyInstance: create)
    ..aOS(1, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'name')
    ..hasRequiredFields = false
  ;
...
class ListJobsRequest extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'ListJobsRequest', package: const $pb.PackageName(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'google.cloud.talent.v4'), createEmptyInstance: create)
    ..aOS(1, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'parent')
    ...
    ..e<JobView>(5, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'jobView', $pb.PbFieldType.OE, defaultOrMaker: JobView.JOB_VIEW_UNSPECIFIED, valueOf: JobView.valueOf, enumValues: JobView.values)
    ..hasRequiredFields = false
  ;
...
class ListJobsResponse extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'ListJobsResponse', package: const $pb.PackageName(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'google.cloud.talent.v4'), createEmptyInstance: create)
...
class SearchJobsRequest_CustomRankingInfo extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'SearchJobsRequest.CustomRankingInfo', package: const $pb.PackageName(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'google.cloud.talent.v4'), createEmptyInstance: create)
    ..e<SearchJobsRequest_CustomRankingInfo_ImportanceLevel>(1, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'importanceLevel', $pb.PbFieldType.OE, defaultOrMaker: SearchJobsRequest_CustomRankingInfo_ImportanceLevel.IMPORTANCE_LEVEL_UNSPECIFIED, valueOf: SearchJobsRequest_CustomRankingInfo_ImportanceLevel.valueOf, enumValues: SearchJobsRequest_CustomRankingInfo_ImportanceLevel.values)
    ..aOS(2, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'rankingExpression')
    ..hasRequiredFields = false
  ;
  ...
  'Use [GeneratedMessageGenericExtensions.rebuild] instead. '
  'Will be removed in next major version')
  SearchJobsRequest_CustomRankingInfo copyWith(void Function(SearchJobsRequest_CustomRankingInfo) updates) => super.copyWith((message) => updates(message as SearchJobsRequest_CustomRankingInfo)) as SearchJobsRequest_CustomRankingInfo; // ignore: deprecated_member_use
  $pb.BuilderInfo get info_ => _i;
  @$core.pragma('dart2js:noInline')
...
class SearchJobsRequest extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'SearchJobsRequest', package: const $pb.PackageName(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'google.cloud.talent.v4'), createEmptyInstance: create)
    ..aOS(1, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'parent')
    ..e<SearchJobsRequest_SearchMode>(2, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'searchMode', $pb.PbFieldType.OE, defaultOrMaker: SearchJobsRequest_SearchMode.SEARCH_MODE_UNSPECIFIED, valueOf: SearchJobsRequest_SearchMode.valueOf, enumValues: SearchJobsRequest_SearchMode.values)
    ..aOM<$5.RequestMetadata>(3, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'requestMetadata', subBuilder: $5.RequestMetadata.create)
    ..aOM<$6.JobQuery>(4, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'jobQuery', subBuilder: $6.JobQuery.create)
    ..aOB(5, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'enableBroadening')
    ..pc<$7.HistogramQuery>(7, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'histogramQueries', $pb.PbFieldType.PM, subBuilder: $7.HistogramQuery.create)
    ..e<JobView>(8, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'jobView', $pb.PbFieldType.OE, defaultOrMaker: JobView.JOB_VIEW_UNSPECIFIED, valueOf: JobView.valueOf, enumValues: JobView.values)
    ..a<$core.int>(9, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'offset', $pb.PbFieldType.O3)
    ..a<$core.int>(10, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'maxPageSize', $pb.PbFieldType.O3)
    ..aOS(11, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'pageToken')
    ..aOS(12, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'orderBy')
    ..e<SearchJobsRequest_DiversificationLevel>(13, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'diversificationLevel', $pb.PbFieldType.OE, defaultOrMaker: SearchJobsRequest_DiversificationLevel.DIVERSIFICATION_LEVEL_UNSPECIFIED, valueOf: SearchJobsRequest_DiversificationLevel.valueOf, enumValues: SearchJobsRequest_DiversificationLevel.values)
    ..aOM<SearchJobsRequest_CustomRankingInfo>(14, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'customRankingInfo', subBuilder: SearchJobsRequest_CustomRankingInfo.create)
    ..aOB(16, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'disableKeywordMatch')
    ..e<SearchJobsRequest_KeywordMatchMode>(18, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'keywordMatchMode', $pb.PbFieldType.OE, defaultOrMaker: SearchJobsRequest_KeywordMatchMode.KEYWORD_MATCH_MODE_UNSPECIFIED, valueOf: SearchJobsRequest_KeywordMatchMode.valueOf, enumValues: SearchJobsRequest_KeywordMatchMode.values)
    ..hasRequiredFields = false
  ;
  ...
  'Use [GeneratedMessageGenericExtensions.rebuild] instead. '
  'Will be removed in next major version')
  SearchJobsRequest copyWith(void Function(SearchJobsRequest) updates) => super.copyWith((message) => updates(message as SearchJobsRequest)) as SearchJobsRequest; // ignore: deprecated_member_use
  $pb.BuilderInfo get info_ => _i;
  @$core.pragma('dart2js:noInline')
  ...
  @$pb.TagNumber(3)
  set requestMetadata($5.RequestMetadata v) { setField(3, v); }
  @$pb.TagNumber(3)
  ...
  @$pb.TagNumber(4)
  set jobQuery($6.JobQuery v) { setField(4, v); }
  @$pb.TagNumber(4)
  ...
  @$pb.TagNumber(10)
  set maxPageSize($core.int v) { $_setSignedInt32(8, v); }
  @$pb.TagNumber(10)
  ...
  @$pb.TagNumber(12)
  set orderBy($core.String v) { $_setString(10, v); }
  @$pb.TagNumber(12)
  ...
  @$core.Deprecated('This field is deprecated.')
  @$pb.TagNumber(16)
  set disableKeywordMatch($core.bool v) { $_setBool(13, v); }
  @$core.Deprecated('This field is deprecated.')
  @$pb.TagNumber(16)
...
class SearchJobsResponse_MatchingJob extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'SearchJobsResponse.MatchingJob', package: const $pb.PackageName(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'google.cloud.talent.v4'), createEmptyInstance: create)
    ..aOM<$3.Job>(1, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'job', subBuilder: $3.Job.create)
    ..aOS(2, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'jobSummary')
    ..aOS(3, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'jobTitleSnippet')
    ..aOS(4, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'searchTextSnippet')
    ..aOM<SearchJobsResponse_CommuteInfo>(5, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'commuteInfo', subBuilder: SearchJobsResponse_CommuteInfo.create)
    ..hasRequiredFields = false
  ;
  ...
  'Use [GeneratedMessageGenericExtensions.rebuild] instead. '
  'Will be removed in next major version')
  SearchJobsResponse_MatchingJob copyWith(void Function(SearchJobsResponse_MatchingJob) updates) => super.copyWith((message) => updates(message as SearchJobsResponse_MatchingJob)) as SearchJobsResponse_MatchingJob; // ignore: deprecated_member_use
  $pb.BuilderInfo get info_ => _i;
  @$core.pragma('dart2js:noInline')
...
class SearchJobsResponse_CommuteInfo extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'SearchJobsResponse.CommuteInfo', package: const $pb.PackageName(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'google.cloud.talent.v4'), createEmptyInstance: create)
    ..aOM<$5.Location>(1, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'jobLocation', subBuilder: $5.Location.create)
    ..aOM<$8.Duration>(2, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'travelDuration', subBuilder: $8.Duration.create)
    ..hasRequiredFields = false
  ;
  ...
  'Use [GeneratedMessageGenericExtensions.rebuild] instead. '
  'Will be removed in next major version')
  SearchJobsResponse_CommuteInfo copyWith(void Function(SearchJobsResponse_CommuteInfo) updates) => super.copyWith((message) => updates(message as SearchJobsResponse_CommuteInfo)) as SearchJobsResponse_CommuteInfo; // ignore: deprecated_member_use
  $pb.BuilderInfo get info_ => _i;
  @$core.pragma('dart2js:noInline')
  ...
  @$pb.TagNumber(1)
  set jobLocation($5.Location v) { setField(1, v); }
  @$pb.TagNumber(1)
  ...
  @$pb.TagNumber(2)
  set travelDuration($8.Duration v) { setField(2, v); }
  @$pb.TagNumber(2)
...
class SearchJobsResponse extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'SearchJobsResponse', package: const $pb.PackageName(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'google.cloud.talent.v4'), createEmptyInstance: create)
    ..pc<SearchJobsResponse_MatchingJob>(1, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'matchingJobs', $pb.PbFieldType.PM, subBuilder: SearchJobsResponse_MatchingJob.create)
    ..pc<$7.HistogramQueryResult>(2, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'histogramQueryResults', $pb.PbFieldType.PM, subBuilder: $7.HistogramQueryResult.create)
    ..aOS(3, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'nextPageToken')
    ..pc<$5.Location>(4, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'locationFilters', $pb.PbFieldType.PM, subBuilder: $5.Location.create)
    ..a<$core.int>(6, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'totalSize', $pb.PbFieldType.O3)
    ..aOM<$5.ResponseMetadata>(7, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'metadata', subBuilder: $5.ResponseMetadata.create)
    ..a<$core.int>(8, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'broadenedQueryJobsCount', $pb.PbFieldType.O3)
    ..aOM<$5.SpellingCorrection>(9, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'spellCorrection', subBuilder: $5.SpellingCorrection.create)
    ..hasRequiredFields = false
  ;
  ...
  'Use [GeneratedMessageGenericExtensions.rebuild] instead. '
  'Will be removed in next major version')
  SearchJobsResponse copyWith(void Function(SearchJobsResponse) updates) => super.copyWith((message) => updates(message as SearchJobsResponse)) as SearchJobsResponse; // ignore: deprecated_member_use
  $pb.BuilderInfo get info_ => _i;
  @$core.pragma('dart2js:noInline')
  ...
  @$pb.TagNumber(6)
  set totalSize($core.int v) { $_setSignedInt32(4, v); }
  @$pb.TagNumber(6)
  ...
  @$pb.TagNumber(7)
  set metadata($5.ResponseMetadata v) { setField(7, v); }
  @$pb.TagNumber(7)
  ...
  @$pb.TagNumber(8)
  set broadenedQueryJobsCount($core.int v) { $_setSignedInt32(6, v); }
  @$pb.TagNumber(8)
  ...
  @$pb.TagNumber(9)
  set spellCorrection($5.SpellingCorrection v) { setField(9, v); }
  @$pb.TagNumber(9)
...
class BatchCreateJobsRequest extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'BatchCreateJobsRequest', package: const $pb.PackageName(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'google.cloud.talent.v4'), createEmptyInstance: create)
    ..aOS(1, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'parent')
    ..pc<$3.Job>(2, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'jobs', $pb.PbFieldType.PM, subBuilder: $3.Job.create)
    ..hasRequiredFields = false
  ;
  ...
  'Use [GeneratedMessageGenericExtensions.rebuild] instead. '
  'Will be removed in next major version')
  BatchCreateJobsRequest copyWith(void Function(BatchCreateJobsRequest) updates) => super.copyWith((message) => updates(message as BatchCreateJobsRequest)) as BatchCreateJobsRequest; // ignore: deprecated_member_use
  $pb.BuilderInfo get info_ => _i;
  @$core.pragma('dart2js:noInline')
...
class BatchUpdateJobsRequest extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'BatchUpdateJobsRequest', package: const $pb.PackageName(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'google.cloud.talent.v4'), createEmptyInstance: create)
    ..aOS(1, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'parent')
    ..pc<$3.Job>(2, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'jobs', $pb.PbFieldType.PM, subBuilder: $3.Job.create)
  ...
  'Use [GeneratedMessageGenericExtensions.rebuild] instead. '
  'Will be removed in next major version')
  BatchUpdateJobsRequest copyWith(void Function(BatchUpdateJobsRequest) updates) => super.copyWith((message) => updates(message as BatchUpdateJobsRequest)) as BatchUpdateJobsRequest; // ignore: deprecated_member_use
  $pb.BuilderInfo get info_ => _i;
  @$core.pragma('dart2js:noInline')
...
class BatchDeleteJobsRequest extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'BatchDeleteJobsRequest', package: const $pb.PackageName(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'google.cloud.talent.v4'), createEmptyInstance: create)
    ..aOS(1, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'parent')
  ...
  'Use [GeneratedMessageGenericExtensions.rebuild] instead. '
  'Will be removed in next major version')
  BatchDeleteJobsRequest copyWith(void Function(BatchDeleteJobsRequest) updates) => super.copyWith((message) => updates(message as BatchDeleteJobsRequest)) as BatchDeleteJobsRequest; // ignore: deprecated_member_use
  $pb.BuilderInfo get info_ => _i;
  @$core.pragma('dart2js:noInline')
...
class JobResult extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'JobResult', package: const $pb.PackageName(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'google.cloud.talent.v4'), createEmptyInstance: create)
    ..aOM<$3.Job>(1, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'job', subBuilder: $3.Job.create)
    ..aOM<$9.Status>(2, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'status', subBuilder: $9.Status.create)
    ..hasRequiredFields = false
  ;
  ...
  factory JobResult.fromBuffer($core.List<$core.int> i, [$pb.ExtensionRegistry r = $pb.ExtensionRegistry.EMPTY]) => create()..mergeFromBuffer(i, r);
  factory JobResult.fromJson($core.String i, [$pb.ExtensionRegistry r = $pb.ExtensionRegistry.EMPTY]) => create()..mergeFromJson(i, r);
  @$core.Deprecated(
  'Using this can add significant overhead to your binary. '
  'Use [GeneratedMessageGenericExtensions.deepCopy] instead. '
  'Will be removed in next major version')
  ...
  'Use [GeneratedMessageGenericExtensions.rebuild] instead. '
  'Will be removed in next major version')
  JobResult copyWith(void Function(JobResult) updates) => super.copyWith((message) => updates(message as JobResult)) as JobResult; // ignore: deprecated_member_use
  $pb.BuilderInfo get info_ => _i;
  @$core.pragma('dart2js:noInline')
  ...
  @$core.pragma('dart2js:noInline')
  static JobResult getDefault() => _defaultInstance ??= $pb.GeneratedMessage.$_defaultFor<JobResult>(create);
  ...
  @$pb.TagNumber(2)
  set status($9.Status v) { setField(2, v); }
  @$pb.TagNumber(2)
...
class BatchCreateJobsResponse extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'BatchCreateJobsResponse', package: const $pb.PackageName(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'google.cloud.talent.v4'), createEmptyInstance: create)
    ..pc<JobResult>(1, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'jobResults', $pb.PbFieldType.PM, subBuilder: JobResult.create)
    ..hasRequiredFields = false
  ;
  ...
  factory BatchCreateJobsResponse.fromBuffer($core.List<$core.int> i, [$pb.ExtensionRegistry r = $pb.ExtensionRegistry.EMPTY]) => create()..mergeFromBuffer(i, r);
  factory BatchCreateJobsResponse.fromJson($core.String i, [$pb.ExtensionRegistry r = $pb.ExtensionRegistry.EMPTY]) => create()..mergeFromJson(i, r);
  @$core.Deprecated(
  'Using this can add significant overhead to your binary. '
  'Use [GeneratedMessageGenericExtensions.deepCopy] instead. '
  'Will be removed in next major version')
  BatchCreateJobsResponse clone() => BatchCreateJobsResponse()..mergeFromMessage(this);
  @$core.Deprecated(
  'Using this can add significant overhead to your binary. '
  'Use [GeneratedMessageGenericExtensions.rebuild] instead. '
  'Will be removed in next major version')
  BatchCreateJobsResponse copyWith(void Function(BatchCreateJobsResponse) updates) => super.copyWith((message) => updates(message as BatchCreateJobsResponse)) as BatchCreateJobsResponse; // ignore: deprecated_member_use
  $pb.BuilderInfo get info_ => _i;
  @$core.pragma('dart2js:noInline')
  static BatchCreateJobsResponse create() => BatchCreateJobsResponse._();
  BatchCreateJobsResponse createEmptyInstance() => create();
  static $pb.PbList<BatchCreateJobsResponse> createRepeated() => $pb.PbList<BatchCreateJobsResponse>();
  @$core.pragma('dart2js:noInline')
  static BatchCreateJobsResponse getDefault() => _defaultInstance ??= $pb.GeneratedMessage.$_defaultFor<BatchCreateJobsResponse>(create);
...
class BatchUpdateJobsResponse extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'BatchUpdateJobsResponse', package: const $pb.PackageName(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'google.cloud.talent.v4'), createEmptyInstance: create)
    ..pc<JobResult>(1, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'jobResults', $pb.PbFieldType.PM, subBuilder: JobResult.create)
    ..hasRequiredFields = false
  ;
  ...
  factory BatchUpdateJobsResponse.fromBuffer($core.List<$core.int> i, [$pb.ExtensionRegistry r = $pb.ExtensionRegistry.EMPTY]) => create()..mergeFromBuffer(i, r);
  factory BatchUpdateJobsResponse.fromJson($core.String i, [$pb.ExtensionRegistry r = $pb.ExtensionRegistry.EMPTY]) => create()..mergeFromJson(i, r);
  @$core.Deprecated(
  'Using this can add significant overhead to your binary. '
  'Use [GeneratedMessageGenericExtensions.deepCopy] instead. '
  'Will be removed in next major version')
  BatchUpdateJobsResponse clone() => BatchUpdateJobsResponse()..mergeFromMessage(this);
  @$core.Deprecated(
  'Using this can add significant overhead to your binary. '
  'Use [GeneratedMessageGenericExtensions.rebuild] instead. '
  'Will be removed in next major version')
  BatchUpdateJobsResponse copyWith(void Function(BatchUpdateJobsResponse) updates) => super.copyWith((message) => updates(message as BatchUpdateJobsResponse)) as BatchUpdateJobsResponse; // ignore: deprecated_member_use
  $pb.BuilderInfo get info_ => _i;
  @$core.pragma('dart2js:noInline')
  static BatchUpdateJobsResponse create() => BatchUpdateJobsResponse._();
  BatchUpdateJobsResponse createEmptyInstance() => create();
  static $pb.PbList<BatchUpdateJobsResponse> createRepeated() => $pb.PbList<BatchUpdateJobsResponse>();
  @$core.pragma('dart2js:noInline')
  static BatchUpdateJobsResponse getDefault() => _defaultInstance ??= $pb.GeneratedMessage.$_defaultFor<BatchUpdateJobsResponse>(create);
...
class BatchDeleteJobsResponse extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'BatchDeleteJobsResponse', package: const $pb.PackageName(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'google.cloud.talent.v4'), createEmptyInstance: create)
    ..pc<JobResult>(1, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'jobResults', $pb.PbFieldType.PM, subBuilder: JobResult.create)
    ..hasRequiredFields = false
  ;
  ...
  factory BatchDeleteJobsResponse.fromBuffer($core.List<$core.int> i, [$pb.ExtensionRegistry r = $pb.ExtensionRegistry.EMPTY]) => create()..mergeFromBuffer(i, r);
  factory BatchDeleteJobsResponse.fromJson($core.String i, [$pb.ExtensionRegistry r = $pb.ExtensionRegistry.EMPTY]) => create()..mergeFromJson(i, r);
  @$core.Deprecated(
  'Using this can add significant overhead to your binary. '
  'Use [GeneratedMessageGenericExtensions.deepCopy] instead. '
  'Will be removed in next major version')
  BatchDeleteJobsResponse clone() => BatchDeleteJobsResponse()..mergeFromMessage(this);
  @$core.Deprecated(
  'Using this can add significant overhead to your binary. '
  'Use [GeneratedMessageGenericExtensions.rebuild] instead. '
  'Will be removed in next major version')
  BatchDeleteJobsResponse copyWith(void Function(BatchDeleteJobsResponse) updates) => super.copyWith((message) => updates(message as BatchDeleteJobsResponse)) as BatchDeleteJobsResponse; // ignore: deprecated_member_use
  $pb.BuilderInfo get info_ => _i;
  @$core.pragma('dart2js:noInline')
  static BatchDeleteJobsResponse create() => BatchDeleteJobsResponse._();
  BatchDeleteJobsResponse createEmptyInstance() => create();
  static $pb.PbList<BatchDeleteJobsResponse> createRepeated() => $pb.PbList<BatchDeleteJobsResponse>();
  @$core.pragma('dart2js:noInline')
  static BatchDeleteJobsResponse getDefault() => _defaultInstance ??= $pb.GeneratedMessage.$_defaultFor<BatchDeleteJobsResponse>(create);

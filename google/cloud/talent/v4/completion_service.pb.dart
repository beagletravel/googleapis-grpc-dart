...
class CompleteQueryRequest extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'CompleteQueryRequest', package: const $pb.PackageName(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'google.cloud.talent.v4'), createEmptyInstance: create)
    ..aOS(1, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'tenant')
    ...
    ..e<CompleteQueryRequest_CompletionScope>(6, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'scope', $pb.PbFieldType.OE, defaultOrMaker: CompleteQueryRequest_CompletionScope.COMPLETION_SCOPE_UNSPECIFIED, valueOf: CompleteQueryRequest_CompletionScope.valueOf, enumValues: CompleteQueryRequest_CompletionScope.values)
    ..e<CompleteQueryRequest_CompletionType>(7, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'type', $pb.PbFieldType.OE, defaultOrMaker: CompleteQueryRequest_CompletionType.COMPLETION_TYPE_UNSPECIFIED, valueOf: CompleteQueryRequest_CompletionType.valueOf, enumValues: CompleteQueryRequest_CompletionType.values)
...
class CompleteQueryResponse_CompletionResult extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'CompleteQueryResponse.CompletionResult', package: const $pb.PackageName(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'google.cloud.talent.v4'), createEmptyInstance: create)
    ..aOS(1, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'suggestion')
    ..e<CompleteQueryRequest_CompletionType>(2, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'type', $pb.PbFieldType.OE, defaultOrMaker: CompleteQueryRequest_CompletionType.COMPLETION_TYPE_UNSPECIFIED, valueOf: CompleteQueryRequest_CompletionType.valueOf, enumValues: CompleteQueryRequest_CompletionType.values)
...
class CompleteQueryResponse extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'CompleteQueryResponse', package: const $pb.PackageName(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'google.cloud.talent.v4'), createEmptyInstance: create)
    ...
    ..aOM<$1.ResponseMetadata>(2, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'metadata', subBuilder: $1.ResponseMetadata.create)
    ..hasRequiredFields = false
  ;
  ...
  @$pb.TagNumber(2)
  set metadata($1.ResponseMetadata v) { setField(2, v); }
  @$pb.TagNumber(2)

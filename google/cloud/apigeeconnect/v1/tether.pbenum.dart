...
class Action extends $pb.ProtobufEnum {
  ...
  static const Action OPEN_NEW_STREAM = Action._(1, const $core.bool.fromEnvironment('protobuf.omit_enum_names') ? '' : 'OPEN_NEW_STREAM');
...
class TetherEndpoint extends $pb.ProtobufEnum {
  static const TetherEndpoint TETHER_ENDPOINT_UNSPECIFIED = TetherEndpoint._(0, const $core.bool.fromEnvironment('protobuf.omit_enum_names') ? '' : 'TETHER_ENDPOINT_UNSPECIFIED');
  static const TetherEndpoint APIGEE_MART = TetherEndpoint._(1, const $core.bool.fromEnvironment('protobuf.omit_enum_names') ? '' : 'APIGEE_MART');
  static const TetherEndpoint APIGEE_RUNTIME = TetherEndpoint._(2, const $core.bool.fromEnvironment('protobuf.omit_enum_names') ? '' : 'APIGEE_RUNTIME');
  static const TetherEndpoint APIGEE_MINT_RATING = TetherEndpoint._(3, const $core.bool.fromEnvironment('protobuf.omit_enum_names') ? '' : 'APIGEE_MINT_RATING');
...
class Scheme extends $pb.ProtobufEnum {
  static const Scheme SCHEME_UNSPECIFIED = Scheme._(0, const $core.bool.fromEnvironment('protobuf.omit_enum_names') ? '' : 'SCHEME_UNSPECIFIED');
  static const Scheme HTTPS = Scheme._(1, const $core.bool.fromEnvironment('protobuf.omit_enum_names') ? '' : 'HTTPS');

...
class BillingSettings extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'BillingSettings', package: const $pb.PackageName(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'google.cloud.securitycenter.settings.v1beta1'), createEmptyInstance: create)
    ..e<BillingTier>(1, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'billingTier', $pb.PbFieldType.OE, defaultOrMaker: BillingTier.BILLING_TIER_UNSPECIFIED, valueOf: BillingTier.valueOf, enumValues: BillingTier.values)
    ..e<BillingType>(2, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'billingType', $pb.PbFieldType.OE, defaultOrMaker: BillingType.BILLING_TYPE_UNSPECIFIED, valueOf: BillingType.valueOf, enumValues: BillingType.values)
    ..aOM<$0.Timestamp>(3, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'startTime', subBuilder: $0.Timestamp.create)
    ..aOM<$0.Timestamp>(4, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'expireTime', subBuilder: $0.Timestamp.create)
  ...
  'Will be removed in next major version')
  BillingSettings copyWith(void Function(BillingSettings) updates) => super.copyWith((message) => updates(message as BillingSettings)) as BillingSettings; // ignore: deprecated_member_use
  ...
  @$pb.TagNumber(4)
  set expireTime($0.Timestamp v) { setField(4, v); }
  @$pb.TagNumber(4)

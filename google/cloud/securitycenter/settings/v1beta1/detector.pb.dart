...
class Detector extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'Detector', package: const $pb.PackageName(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'google.cloud.securitycenter.settings.v1beta1'), createEmptyInstance: create)
    ..aOS(1, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'detector')
    ..aOS(2, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'component')
    ..e<$0.BillingTier>(3, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'billingTier', $pb.PbFieldType.OE, defaultOrMaker: $0.BillingTier.BILLING_TIER_UNSPECIFIED, valueOf: $0.BillingTier.valueOf, enumValues: $0.BillingTier.values)
    ..pPS(4, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'detectorLabels')
  ...
  'Will be removed in next major version')
  Detector copyWith(void Function(Detector) updates) => super.copyWith((message) => updates(message as Detector)) as Detector; // ignore: deprecated_member_use
  ...
  @$pb.TagNumber(3)
  set billingTier($0.BillingTier v) { setField(3, v); }
  @$pb.TagNumber(3)

...
class SinkSettings extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'SinkSettings', package: const $pb.PackageName(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'google.cloud.securitycenter.settings.v1beta1'), createEmptyInstance: create)
    ..aOS(1, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'loggingSinkProject')
  ...
  'Will be removed in next major version')
  SinkSettings copyWith(void Function(SinkSettings) updates) => super.copyWith((message) => updates(message as SinkSettings)) as SinkSettings; // ignore: deprecated_member_use

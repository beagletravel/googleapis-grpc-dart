...
class Settings_DetectorGroupSettings extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'Settings.DetectorGroupSettings', package: const $pb.PackageName(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'google.cloud.securitycenter.settings.v1beta1'), createEmptyInstance: create)
    ..e<$3.ComponentEnablementState>(1, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'state', $pb.PbFieldType.OE, defaultOrMaker: $3.ComponentEnablementState.COMPONENT_ENABLEMENT_STATE_UNSPECIFIED, valueOf: $3.ComponentEnablementState.valueOf, enumValues: $3.ComponentEnablementState.values)
  ...
  'Will be removed in next major version')
  Settings_DetectorGroupSettings copyWith(void Function(Settings_DetectorGroupSettings) updates) => super.copyWith((message) => updates(message as Settings_DetectorGroupSettings)) as Settings_DetectorGroupSettings; // ignore: deprecated_member_use
  ...
  @$pb.TagNumber(1)
  set state($3.ComponentEnablementState v) { setField(1, v); }
  @$pb.TagNumber(1)
...
class Settings extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'Settings', package: const $pb.PackageName(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'google.cloud.securitycenter.settings.v1beta1'), createEmptyInstance: create)
    ..aOS(1, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'name')
    ..aOM<$0.BillingSettings>(2, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'billingSettings', subBuilder: $0.BillingSettings.create)
    ..e<Settings_OnboardingState>(3, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'state', $pb.PbFieldType.OE, defaultOrMaker: Settings_OnboardingState.ONBOARDING_STATE_UNSPECIFIED, valueOf: Settings_OnboardingState.valueOf, enumValues: Settings_OnboardingState.values)
    ..aOS(5, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'orgServiceAccount')
    ..aOM<$1.SinkSettings>(6, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'sinkSettings', subBuilder: $1.SinkSettings.create)
    ..m<$core.String, $3.ComponentSettings>(7, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'componentSettings', entryClassName: 'Settings.ComponentSettingsEntry', keyFieldType: $pb.PbFieldType.OS, valueFieldType: $pb.PbFieldType.OM, valueCreator: $3.ComponentSettings.create, packageName: const $pb.PackageName('google.cloud.securitycenter.settings.v1beta1'))
    ..m<$core.String, Settings_DetectorGroupSettings>(8, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'detectorGroupSettings', entryClassName: 'Settings.DetectorGroupSettingsEntry', keyFieldType: $pb.PbFieldType.OS, valueFieldType: $pb.PbFieldType.OM, valueCreator: Settings_DetectorGroupSettings.create, packageName: const $pb.PackageName('google.cloud.securitycenter.settings.v1beta1'))
    ..aOS(9, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'etag')
    ..aOM<$2.Timestamp>(10, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'updateTime', subBuilder: $2.Timestamp.create)
    ..hasRequiredFields = false
  ;
  ...
  @$pb.TagNumber(2)
  set billingSettings($0.BillingSettings v) { setField(2, v); }
  @$pb.TagNumber(2)
  ...
  @$pb.TagNumber(6)
  set sinkSettings($1.SinkSettings v) { setField(6, v); }
  @$pb.TagNumber(6)
  ...
  @$pb.TagNumber(7)
  $core.Map<$core.String, $3.ComponentSettings> get componentSettings => $_getMap(5);
  ...
  @$pb.TagNumber(10)
  set updateTime($2.Timestamp v) { setField(10, v); }
  @$pb.TagNumber(10)

...
class NotificationConfig_StreamingConfig extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'NotificationConfig.StreamingConfig', package: const $pb.PackageName(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'google.cloud.securitycenter.v1p1beta1'), createEmptyInstance: create)
  ...
  'Will be removed in next major version')
  NotificationConfig_StreamingConfig copyWith(void Function(NotificationConfig_StreamingConfig) updates) => super.copyWith((message) => updates(message as NotificationConfig_StreamingConfig)) as NotificationConfig_StreamingConfig; // ignore: deprecated_member_use
...
class NotificationConfig extends $pb.GeneratedMessage {
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'NotificationConfig', package: const $pb.PackageName(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'google.cloud.securitycenter.v1p1beta1'), createEmptyInstance: create)
    ..oo(0, [6])
    ..aOS(1, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'name')
    ..aOS(2, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'description')
    ..e<NotificationConfig_EventType>(3, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'eventType', $pb.PbFieldType.OE, defaultOrMaker: NotificationConfig_EventType.EVENT_TYPE_UNSPECIFIED, valueOf: NotificationConfig_EventType.valueOf, enumValues: NotificationConfig_EventType.values)
    ..aOS(4, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'pubsubTopic')
    ..aOS(5, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'serviceAccount')
    ..aOM<NotificationConfig_StreamingConfig>(6, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'streamingConfig', subBuilder: NotificationConfig_StreamingConfig.create)
    ..hasRequiredFields = false
  ;
  ...
  @$pb.TagNumber(3)
  set eventType(NotificationConfig_EventType v) { setField(3, v); }
  @$pb.TagNumber(3)
  ...
  @$pb.TagNumber(4)
  set pubsubTopic($core.String v) { $_setString(3, v); }
  @$pb.TagNumber(4)
  ...
  @$pb.TagNumber(6)
  set streamingConfig(NotificationConfig_StreamingConfig v) { setField(6, v); }
  @$pb.TagNumber(6)

...
class RunAssetDiscoveryResponse extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'RunAssetDiscoveryResponse', package: const $pb.PackageName(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'google.cloud.securitycenter.v1p1beta1'), createEmptyInstance: create)
    ..e<RunAssetDiscoveryResponse_State>(1, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'state', $pb.PbFieldType.OE, defaultOrMaker: RunAssetDiscoveryResponse_State.STATE_UNSPECIFIED, valueOf: RunAssetDiscoveryResponse_State.valueOf, enumValues: RunAssetDiscoveryResponse_State.values)
  ...
  'Will be removed in next major version')
  RunAssetDiscoveryResponse copyWith(void Function(RunAssetDiscoveryResponse) updates) => super.copyWith((message) => updates(message as RunAssetDiscoveryResponse)) as RunAssetDiscoveryResponse; // ignore: deprecated_member_use

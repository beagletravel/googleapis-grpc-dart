...
class NotificationMessage extends $pb.GeneratedMessage {
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'NotificationMessage', package: const $pb.PackageName(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'google.cloud.securitycenter.v1p1beta1'), createEmptyInstance: create)
    ..oo(0, [2])
    ..aOS(1, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'notificationConfigName')
    ..aOM<$0.Finding>(2, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'finding', subBuilder: $0.Finding.create)
    ..aOM<$1.Resource>(3, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'resource', subBuilder: $1.Resource.create)
  ...
  'Will be removed in next major version')
  NotificationMessage copyWith(void Function(NotificationMessage) updates) => super.copyWith((message) => updates(message as NotificationMessage)) as NotificationMessage; // ignore: deprecated_member_use
  ...
  @$pb.TagNumber(2)
  set finding($0.Finding v) { setField(2, v); }
  @$pb.TagNumber(2)
  ...
  @$pb.TagNumber(3)
  set resource($1.Resource v) { setField(3, v); }
  @$pb.TagNumber(3)

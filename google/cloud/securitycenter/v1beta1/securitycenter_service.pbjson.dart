...
const CreateFindingRequest$json = const {
  ...
  '2': const [
    ...
    const {'1': 'finding', '3': 3, '4': 1, '5': 11, '6': '.google.cloud.securitycenter.v1beta1.Finding', '8': const {}, '10': 'finding'},
  ],
};

/// Descriptor for `CreateFindingRequest`. Decode as a `google.protobuf.DescriptorProto`.
final $typed_data.Uint8List createFindingRequestDescriptor = $convert.base64Decode('');
@$core.Deprecated('Use createSourceRequestDescriptor instead')
const CreateSourceRequest$json = const {
  '1': 'CreateSourceRequest',
  '2': const [
    const {'1': 'parent', '3': 1, '4': 1, '5': 9, '8': const {}, '10': 'parent'},
    const {'1': 'source', '3': 2, '4': 1, '5': 11, '6': '.google.cloud.securitycenter.v1beta1.Source', '8': const {}, '10': 'source'},
  ],
};

/// Descriptor for `CreateSourceRequest`. Decode as a `google.protobuf.DescriptorProto`.
final $typed_data.Uint8List createSourceRequestDescriptor = $convert.base64Decode('ChNDcmVhdGVTb3VyY2VSZXF1ZXN0ElAKBnBhcmVudBgBIAEoCUI44EEC+kEyCjBjbG91ZHJlc291cmNlbWFuYWdlci5nb29nbGVhcGlzLmNvbS9Pcmdhbml6YXRpb25SBnBhcmVudBJICgZzb3VyY2UYAiABKAsyKy5nb29nbGUuY2xvdWQuc2VjdXJpdHljZW50ZXIudjFiZXRhMS5Tb3VyY2VCA+BBAlIGc291cmNl');
...
final $typed_data.Uint8List groupAssetsRequestDescriptor = $convert.base64Decode('');
...
final $typed_data.Uint8List groupAssetsResponseDescriptor = $convert.base64Decode('');
...
final $typed_data.Uint8List groupFindingsResponseDescriptor = $convert.base64Decode('');
...
final $typed_data.Uint8List groupResultDescriptor = $convert.base64Decode('');
...
final $typed_data.Uint8List listSourcesRequestDescriptor = $convert.base64Decode('ChJMaXN0U291cmNlc1JlcXVlc3QSUAoGcGFyZW50GAEgASgJQjjgQQL6QTIKMGNsb3VkcmVzb3VyY2VtYW5hZ2VyLmdvb2dsZWFwaXMuY29tL09yZ2FuaXphdGlvblIGcGFyZW50Eh0KCnBhZ2VfdG9rZW4YAiABKAlSCXBhZ2VUb2tlbhIbCglwYWdlX3NpemUYByABKAVSCHBhZ2VTaXpl');
...
final $typed_data.Uint8List listSourcesResponseDescriptor = $convert.base64Decode('ChNMaXN0U291cmNlc1Jlc3BvbnNlEkUKB3NvdXJjZXMYASADKAsyKy5nb29nbGUuY2xvdWQuc2VjdXJpdHljZW50ZXIudjFiZXRhMS5Tb3VyY2VSB3NvdXJjZXMSJgoPbmV4dF9wYWdlX3Rva2VuGAIgASgJUg1uZXh0UGFnZVRva2Vu');
...
const ListAssetsRequest$json = const {
  ...
  '2': const [
    ...
    const {'1': 'field_mask', '3': 7, '4': 1, '5': 11, '6': '.google.protobuf.FieldMask', '8': const {}, '10': 'fieldMask'},
...
final $typed_data.Uint8List listAssetsRequestDescriptor = $convert.base64Decode('');
...
final $typed_data.Uint8List listAssetsResponseDescriptor = $convert.base64Decode('');
...
const ListFindingsRequest$json = const {
  ...
  '2': const [
    ...
    const {'1': 'order_by', '3': 3, '4': 1, '5': 9, '10': 'orderBy'},
    const {'1': 'read_time', '3': 4, '4': 1, '5': 11, '6': '.google.protobuf.Timestamp', '10': 'readTime'},
    const {'1': 'field_mask', '3': 5, '4': 1, '5': 11, '6': '.google.protobuf.FieldMask', '8': const {}, '10': 'fieldMask'},
...
final $typed_data.Uint8List listFindingsResponseDescriptor = $convert.base64Decode('');
...
const SetFindingStateRequest$json = const {
  ...
  '2': const [
    const {'1': 'name', '3': 1, '4': 1, '5': 9, '8': const {}, '10': 'name'},
    const {'1': 'state', '3': 2, '4': 1, '5': 14, '6': '.google.cloud.securitycenter.v1beta1.Finding.State', '8': const {}, '10': 'state'},
...
final $typed_data.Uint8List setFindingStateRequestDescriptor = $convert.base64Decode('');
...
const UpdateFindingRequest$json = const {
  ...
  '2': const [
    const {'1': 'finding', '3': 1, '4': 1, '5': 11, '6': '.google.cloud.securitycenter.v1beta1.Finding', '8': const {}, '10': 'finding'},
    const {'1': 'update_mask', '3': 2, '4': 1, '5': 11, '6': '.google.protobuf.FieldMask', '10': 'updateMask'},
  ],
};

/// Descriptor for `UpdateFindingRequest`. Decode as a `google.protobuf.DescriptorProto`.
final $typed_data.Uint8List updateFindingRequestDescriptor = $convert.base64Decode('ChRVcGRhdGVGaW5kaW5nUmVxdWVzdBJLCgdmaW5kaW5nGAEgASgLMiwuZ29vZ2xlLmNsb3VkLnNlY3VyaXR5Y2VudGVyLnYxYmV0YTEuRmluZGluZ0ID4EECUgdmaW5kaW5nEjsKC3VwZGF0ZV9tYXNrGAIgASgLMhouZ29vZ2xlLnByb3RvYnVmLkZpZWxkTWFza1IKdXBkYXRlTWFzaw==');
...
const UpdateOrganizationSettingsRequest$json = const {
  ...
  '2': const [
    const {'1': 'organization_settings', '3': 1, '4': 1, '5': 11, '6': '.google.cloud.securitycenter.v1beta1.OrganizationSettings', '8': const {}, '10': 'organizationSettings'},
    const {'1': 'update_mask', '3': 2, '4': 1, '5': 11, '6': '.google.protobuf.FieldMask', '10': 'updateMask'},
  ],
};

/// Descriptor for `UpdateOrganizationSettingsRequest`. Decode as a `google.protobuf.DescriptorProto`.
final $typed_data.Uint8List updateOrganizationSettingsRequestDescriptor = $convert.base64Decode('');
@$core.Deprecated('Use updateSourceRequestDescriptor instead')
const UpdateSourceRequest$json = const {
  '1': 'UpdateSourceRequest',
  '2': const [
    const {'1': 'source', '3': 1, '4': 1, '5': 11, '6': '.google.cloud.securitycenter.v1beta1.Source', '8': const {}, '10': 'source'},
    const {'1': 'update_mask', '3': 2, '4': 1, '5': 11, '6': '.google.protobuf.FieldMask', '10': 'updateMask'},
  ],
};

/// Descriptor for `UpdateSourceRequest`. Decode as a `google.protobuf.DescriptorProto`.
final $typed_data.Uint8List updateSourceRequestDescriptor = $convert.base64Decode('ChNVcGRhdGVTb3VyY2VSZXF1ZXN0EkgKBnNvdXJjZRgBIAEoCzIrLmdvb2dsZS5jbG91ZC5zZWN1cml0eWNlbnRlci52MWJldGExLlNvdXJjZUID4EECUgZzb3VyY2USOwoLdXBkYXRlX21hc2sYAiABKAsyGi5nb29nbGUucHJvdG9idWYuRmllbGRNYXNrUgp1cGRhdGVNYXNr');
...
const UpdateSecurityMarksRequest$json = const {
  ...
  '2': const [
    const {'1': 'security_marks', '3': 1, '4': 1, '5': 11, '6': '.google.cloud.securitycenter.v1beta1.SecurityMarks', '8': const {}, '10': 'securityMarks'},
    const {'1': 'update_mask', '3': 2, '4': 1, '5': 11, '6': '.google.protobuf.FieldMask', '10': 'updateMask'},
...
final $typed_data.Uint8List updateSecurityMarksRequestDescriptor = $convert.base64Decode('');

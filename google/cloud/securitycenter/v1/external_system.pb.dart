...
class ExternalSystem extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'ExternalSystem', package: const $pb.PackageName(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'google.cloud.securitycenter.v1'), createEmptyInstance: create)
    ..aOS(1, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'name')
    ..pPS(2, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'assignees')
    ..aOS(3, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'externalUid')
    ..aOS(4, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'status')
    ..aOM<$0.Timestamp>(5, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'externalSystemUpdateTime', subBuilder: $0.Timestamp.create)
  ...
  'Will be removed in next major version')
  ExternalSystem copyWith(void Function(ExternalSystem) updates) => super.copyWith((message) => updates(message as ExternalSystem)) as ExternalSystem; // ignore: deprecated_member_use
  ...
  @$pb.TagNumber(5)
  set externalSystemUpdateTime($0.Timestamp v) { setField(5, v); }
  @$pb.TagNumber(5)

...
class MuteConfig extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'MuteConfig', package: const $pb.PackageName(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'google.cloud.securitycenter.v1'), createEmptyInstance: create)
  ...
  'Will be removed in next major version')
  MuteConfig copyWith(void Function(MuteConfig) updates) => super.copyWith((message) => updates(message as MuteConfig)) as MuteConfig; // ignore: deprecated_member_use

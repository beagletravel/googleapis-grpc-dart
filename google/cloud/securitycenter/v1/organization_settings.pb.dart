...
class OrganizationSettings_AssetDiscoveryConfig extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'OrganizationSettings.AssetDiscoveryConfig', package: const $pb.PackageName(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'google.cloud.securitycenter.v1'), createEmptyInstance: create)
    ..pPS(1, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'projectIds')
    ..e<OrganizationSettings_AssetDiscoveryConfig_InclusionMode>(2, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'inclusionMode', $pb.PbFieldType.OE, defaultOrMaker: OrganizationSettings_AssetDiscoveryConfig_InclusionMode.INCLUSION_MODE_UNSPECIFIED, valueOf: OrganizationSettings_AssetDiscoveryConfig_InclusionMode.valueOf, enumValues: OrganizationSettings_AssetDiscoveryConfig_InclusionMode.values)
    ..pPS(3, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'folderIds')
  ...
  'Will be removed in next major version')
  OrganizationSettings_AssetDiscoveryConfig copyWith(void Function(OrganizationSettings_AssetDiscoveryConfig) updates) => super.copyWith((message) => updates(message as OrganizationSettings_AssetDiscoveryConfig)) as OrganizationSettings_AssetDiscoveryConfig; // ignore: deprecated_member_use
...
class OrganizationSettings extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'OrganizationSettings', package: const $pb.PackageName(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'google.cloud.securitycenter.v1'), createEmptyInstance: create)
    ..aOS(1, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'name')
    ..aOB(2, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'enableAssetDiscovery')
    ..aOM<OrganizationSettings_AssetDiscoveryConfig>(3, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'assetDiscoveryConfig', subBuilder: OrganizationSettings_AssetDiscoveryConfig.create)
    ..hasRequiredFields = false
  ;
  ...
  'Use [GeneratedMessageGenericExtensions.rebuild] instead. '
  'Will be removed in next major version')
  OrganizationSettings copyWith(void Function(OrganizationSettings) updates) => super.copyWith((message) => updates(message as OrganizationSettings)) as OrganizationSettings; // ignore: deprecated_member_use
  $pb.BuilderInfo get info_ => _i;
  @$core.pragma('dart2js:noInline')

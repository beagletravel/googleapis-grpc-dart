...
class InstanceEvent extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'InstanceEvent', package: const $pb.PackageName(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'google.cloud.saasaccelerator.management.logs.v1'), createEmptyInstance: create)
    ..aOS(1, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'verb')
    ...
    ..aOS(4, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'traceId')
  ...
  'Will be removed in next major version')
  InstanceEvent copyWith(void Function(InstanceEvent) updates) => super.copyWith((message) => updates(message as InstanceEvent)) as InstanceEvent; // ignore: deprecated_member_use

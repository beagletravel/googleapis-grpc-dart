...
class NotificationStage extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'NotificationStage', package: const $pb.PackageName(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'google.cloud.saasaccelerator.management.logs.v1'), createEmptyInstance: create)
    ..e<NotificationStage_Stage>(1, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'stage', $pb.PbFieldType.OE, defaultOrMaker: NotificationStage_Stage.STAGE_UNSPECIFIED, valueOf: NotificationStage_Stage.valueOf, enumValues: NotificationStage_Stage.values)
    ..aOM<$0.Timestamp>(2, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'eventTime', subBuilder: $0.Timestamp.create)
    ..aOS(3, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'notificationId')
    ..e<NotificationStage_Event>(4, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'event', $pb.PbFieldType.OE, defaultOrMaker: NotificationStage_Event.EVENT_UNSPECIFIED, valueOf: NotificationStage_Event.valueOf, enumValues: NotificationStage_Event.values)
  ...
  'Will be removed in next major version')
  NotificationStage copyWith(void Function(NotificationStage) updates) => super.copyWith((message) => updates(message as NotificationStage)) as NotificationStage; // ignore: deprecated_member_use

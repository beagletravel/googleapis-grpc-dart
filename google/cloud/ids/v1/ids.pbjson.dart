...
const Endpoint$json = const {
  ...
  '2': const [
    ...
    const {'1': 'labels', '3': 4, '4': 3, '5': 11, '6': '.google.cloud.ids.v1.Endpoint.LabelsEntry', '10': 'labels'},
    const {'1': 'network', '3': 5, '4': 1, '5': 9, '8': const {}, '10': 'network'},
    const {'1': 'endpoint_forwarding_rule', '3': 6, '4': 1, '5': 9, '8': const {}, '10': 'endpointForwardingRule'},
    const {'1': 'endpoint_ip', '3': 7, '4': 1, '5': 9, '8': const {}, '10': 'endpointIp'},
    const {'1': 'description', '3': 8, '4': 1, '5': 9, '10': 'description'},
    const {'1': 'severity', '3': 9, '4': 1, '5': 14, '6': '.google.cloud.ids.v1.Endpoint.Severity', '8': const {}, '10': 'severity'},
    const {'1': 'state', '3': 12, '4': 1, '5': 14, '6': '.google.cloud.ids.v1.Endpoint.State', '8': const {}, '10': 'state'},
...
final $typed_data.Uint8List listEndpointsRequestDescriptor = $convert.base64Decode('');
@$core.Deprecated('Use listEndpointsResponseDescriptor instead')
const ListEndpointsResponse$json = const {
  '1': 'ListEndpointsResponse',
  '2': const [
    const {'1': 'endpoints', '3': 1, '4': 3, '5': 11, '6': '.google.cloud.ids.v1.Endpoint', '10': 'endpoints'},
...
final $typed_data.Uint8List listEndpointsResponseDescriptor = $convert.base64Decode('ChVMaXN0RW5kcG9pbnRzUmVzcG9uc2USOwoJZW5kcG9pbnRzGAEgAygLMh0uZ29vZ2xlLmNsb3VkLmlkcy52MS5FbmRwb2ludFIJZW5kcG9pbnRzEiYKD25leHRfcGFnZV90b2tlbhgCIAEoCVINbmV4dFBhZ2VUb2tlbhIgCgt1bnJlYWNoYWJsZRgDIAMoCVILdW5yZWFjaGFibGU=');
...
final $typed_data.Uint8List getEndpointRequestDescriptor = $convert.base64Decode('ChJHZXRFbmRwb2ludFJlcXVlc3QSNwoEbmFtZRgBIAEoCUIj4EEC+kEdChtpZHMuZ29vZ2xlYXBpcy5jb20vRW5kcG9pbnRSBG5hbWU=');
...
const CreateEndpointRequest$json = const {
  ...
  '2': const [
    ...
    const {'1': 'endpoint', '3': 3, '4': 1, '5': 11, '6': '.google.cloud.ids.v1.Endpoint', '8': const {}, '10': 'endpoint'},
...
final $typed_data.Uint8List createEndpointRequestDescriptor = $convert.base64Decode('');
...
final $typed_data.Uint8List deleteEndpointRequestDescriptor = $convert.base64Decode('ChVEZWxldGVFbmRwb2ludFJlcXVlc3QSNwoEbmFtZRgBIAEoCUIj4EEC+kEdChtpZHMuZ29vZ2xlYXBpcy5jb20vRW5kcG9pbnRSBG5hbWUSHQoKcmVxdWVzdF9pZBgCIAEoCVIJcmVxdWVzdElk');

...
class MemcacheVersion extends $pb.ProtobufEnum {
  static const MemcacheVersion MEMCACHE_VERSION_UNSPECIFIED = MemcacheVersion._(0, const $core.bool.fromEnvironment('protobuf.omit_enum_names') ? '' : 'MEMCACHE_VERSION_UNSPECIFIED');
  static const MemcacheVersion MEMCACHE_1_5 = MemcacheVersion._(1, const $core.bool.fromEnvironment('protobuf.omit_enum_names') ? '' : 'MEMCACHE_1_5');
...
class Instance_State extends $pb.ProtobufEnum {
  ...
  static const Instance_State PERFORMING_MAINTENANCE = Instance_State._(5, const $core.bool.fromEnvironment('protobuf.omit_enum_names') ? '' : 'PERFORMING_MAINTENANCE');
...
class Instance_Node_State extends $pb.ProtobufEnum {
  static const Instance_Node_State STATE_UNSPECIFIED = Instance_Node_State._(0, const $core.bool.fromEnvironment('protobuf.omit_enum_names') ? '' : 'STATE_UNSPECIFIED');
  static const Instance_Node_State CREATING = Instance_Node_State._(1, const $core.bool.fromEnvironment('protobuf.omit_enum_names') ? '' : 'CREATING');
  static const Instance_Node_State READY = Instance_Node_State._(2, const $core.bool.fromEnvironment('protobuf.omit_enum_names') ? '' : 'READY');
  static const Instance_Node_State DELETING = Instance_Node_State._(3, const $core.bool.fromEnvironment('protobuf.omit_enum_names') ? '' : 'DELETING');
  static const Instance_Node_State UPDATING = Instance_Node_State._(4, const $core.bool.fromEnvironment('protobuf.omit_enum_names') ? '' : 'UPDATING');
...
class Instance_InstanceMessage_Code extends $pb.ProtobufEnum {
  static const Instance_InstanceMessage_Code CODE_UNSPECIFIED = Instance_InstanceMessage_Code._(0, const $core.bool.fromEnvironment('protobuf.omit_enum_names') ? '' : 'CODE_UNSPECIFIED');
  static const Instance_InstanceMessage_Code ZONE_DISTRIBUTION_UNBALANCED = Instance_InstanceMessage_Code._(1, const $core.bool.fromEnvironment('protobuf.omit_enum_names') ? '' : 'ZONE_DISTRIBUTION_UNBALANCED');

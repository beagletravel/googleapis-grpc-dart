...
class Instance_NodeConfig extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'Instance.NodeConfig', package: const $pb.PackageName(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'google.cloud.memcache.v1beta2'), createEmptyInstance: create)
    ..a<$core.int>(1, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'cpuCount', $pb.PbFieldType.O3)
    ..a<$core.int>(2, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'memorySizeMb', $pb.PbFieldType.O3)
  ...
  'Will be removed in next major version')
  Instance_NodeConfig copyWith(void Function(Instance_NodeConfig) updates) => super.copyWith((message) => updates(message as Instance_NodeConfig)) as Instance_NodeConfig; // ignore: deprecated_member_use
...
class Instance_Node extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'Instance.Node', package: const $pb.PackageName(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'google.cloud.memcache.v1beta2'), createEmptyInstance: create)
    ...
    ..e<Instance_Node_State>(3, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'state', $pb.PbFieldType.OE, defaultOrMaker: Instance_Node_State.STATE_UNSPECIFIED, valueOf: Instance_Node_State.valueOf, enumValues: Instance_Node_State.values)
    ...
    ..aOM<MemcacheParameters>(6, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'parameters', subBuilder: MemcacheParameters.create)
    ..aOB(7, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'updateAvailable')
    ..hasRequiredFields = false
  ;
  ...
  factory Instance_Node({
    ...
    if (updateAvailable != null) {
      _result.updateAvailable = updateAvailable;
    }
    return _result;
  }
  ...
  'Use [GeneratedMessageGenericExtensions.rebuild] instead. '
  'Will be removed in next major version')
  Instance_Node copyWith(void Function(Instance_Node) updates) => super.copyWith((message) => updates(message as Instance_Node)) as Instance_Node; // ignore: deprecated_member_use
  $pb.BuilderInfo get info_ => _i;
  @$core.pragma('dart2js:noInline')
  ...
  @$pb.TagNumber(7)
  $core.bool get updateAvailable => $_getBF(6);
  @$pb.TagNumber(7)
  set updateAvailable($core.bool v) { $_setBool(6, v); }
  @$pb.TagNumber(7)
  $core.bool hasUpdateAvailable() => $_has(6);
  @$pb.TagNumber(7)
  void clearUpdateAvailable() => clearField(7);
}

class Instance_InstanceMessage extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'Instance.InstanceMessage', package: const $pb.PackageName(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'google.cloud.memcache.v1beta2'), createEmptyInstance: create)
    ..e<Instance_InstanceMessage_Code>(1, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'code', $pb.PbFieldType.OE, defaultOrMaker: Instance_InstanceMessage_Code.CODE_UNSPECIFIED, valueOf: Instance_InstanceMessage_Code.valueOf, enumValues: Instance_InstanceMessage_Code.values)
  ...
  'Use [GeneratedMessageGenericExtensions.rebuild] instead. '
  'Will be removed in next major version')
  Instance_InstanceMessage copyWith(void Function(Instance_InstanceMessage) updates) => super.copyWith((message) => updates(message as Instance_InstanceMessage)) as Instance_InstanceMessage; // ignore: deprecated_member_use
  $pb.BuilderInfo get info_ => _i;
  @$core.pragma('dart2js:noInline')
...
class Instance extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'Instance', package: const $pb.PackageName(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'google.cloud.memcache.v1beta2'), createEmptyInstance: create)
    ..aOS(1, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'name')
    ..aOS(2, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'displayName')
    ..m<$core.String, $core.String>(3, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'labels', entryClassName: 'Instance.LabelsEntry', keyFieldType: $pb.PbFieldType.OS, valueFieldType: $pb.PbFieldType.OS, packageName: const $pb.PackageName('google.cloud.memcache.v1beta2'))
    ..aOS(4, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'authorizedNetwork')
    ..pPS(5, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'zones')
    ..a<$core.int>(6, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'nodeCount', $pb.PbFieldType.O3)
    ..aOM<Instance_NodeConfig>(7, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'nodeConfig', subBuilder: Instance_NodeConfig.create)
    ..e<MemcacheVersion>(9, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'memcacheVersion', $pb.PbFieldType.OE, defaultOrMaker: MemcacheVersion.MEMCACHE_VERSION_UNSPECIFIED, valueOf: MemcacheVersion.valueOf, enumValues: MemcacheVersion.values)
    ..aOM<MemcacheParameters>(11, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'parameters', subBuilder: MemcacheParameters.create)
    ..pc<Instance_Node>(12, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'memcacheNodes', $pb.PbFieldType.PM, subBuilder: Instance_Node.create)
    ...
    ..e<Instance_State>(15, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'state', $pb.PbFieldType.OE, defaultOrMaker: Instance_State.STATE_UNSPECIFIED, valueOf: Instance_State.valueOf, enumValues: Instance_State.values)
    ..aOS(18, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'memcacheFullVersion')
    ..pc<Instance_InstanceMessage>(19, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'instanceMessages', $pb.PbFieldType.PM, subBuilder: Instance_InstanceMessage.create)
    ..aOS(20, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'discoveryEndpoint')
    ..aOB(21, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'updateAvailable')
    ..hasRequiredFields = false
  ;
  ...
  @$pb.TagNumber(21)
  $core.bool get updateAvailable => $_getBF(16);
  @$pb.TagNumber(21)
  set updateAvailable($core.bool v) { $_setBool(16, v); }
  @$pb.TagNumber(21)
  $core.bool hasUpdateAvailable() => $_has(16);
  @$pb.TagNumber(21)
  void clearUpdateAvailable() => clearField(21);
}

class ListInstancesRequest extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'ListInstancesRequest', package: const $pb.PackageName(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'google.cloud.memcache.v1beta2'), createEmptyInstance: create)
...
class ListInstancesResponse extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'ListInstancesResponse', package: const $pb.PackageName(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'google.cloud.memcache.v1beta2'), createEmptyInstance: create)
    ..pc<Instance>(1, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'resources', $pb.PbFieldType.PM, subBuilder: Instance.create)
  ...
  factory ListInstancesResponse({
    $core.Iterable<Instance>? resources,
  ...
  @$pb.TagNumber(1)
  $core.List<Instance> get resources => $_getList(0);
...
class GetInstanceRequest extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'GetInstanceRequest', package: const $pb.PackageName(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'google.cloud.memcache.v1beta2'), createEmptyInstance: create)
    ..aOS(1, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'name')
    ..hasRequiredFields = false
  ;
...
class CreateInstanceRequest extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'CreateInstanceRequest', package: const $pb.PackageName(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'google.cloud.memcache.v1beta2'), createEmptyInstance: create)
    ..aOS(1, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'parent')
    ..aOS(2, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'instanceId')
    ..aOM<Instance>(3, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'resource', subBuilder: Instance.create)
    ..hasRequiredFields = false
  ;
  ...
  @$pb.TagNumber(3)
  Instance get resource => $_getN(2);
  @$pb.TagNumber(3)
  set resource(Instance v) { setField(3, v); }
  @$pb.TagNumber(3)
  $core.bool hasResource() => $_has(2);
  @$pb.TagNumber(3)
  void clearResource() => clearField(3);
  @$pb.TagNumber(3)
  Instance ensureResource() => $_ensure(2);
}

class UpdateInstanceRequest extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'UpdateInstanceRequest', package: const $pb.PackageName(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'google.cloud.memcache.v1beta2'), createEmptyInstance: create)
    ..aOM<$4.FieldMask>(1, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'updateMask', subBuilder: $4.FieldMask.create)
    ..aOM<Instance>(2, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'resource', subBuilder: Instance.create)
    ..hasRequiredFields = false
  ;
  ...
  @$pb.TagNumber(2)
  Instance get resource => $_getN(1);
  @$pb.TagNumber(2)
  set resource(Instance v) { setField(2, v); }
  @$pb.TagNumber(2)
  $core.bool hasResource() => $_has(1);
  @$pb.TagNumber(2)
  void clearResource() => clearField(2);
  @$pb.TagNumber(2)
  Instance ensureResource() => $_ensure(1);
}

class DeleteInstanceRequest extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'DeleteInstanceRequest', package: const $pb.PackageName(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'google.cloud.memcache.v1beta2'), createEmptyInstance: create)
    ..aOS(1, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'name')
    ..hasRequiredFields = false
  ;
...
class ApplyParametersRequest extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'ApplyParametersRequest', package: const $pb.PackageName(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'google.cloud.memcache.v1beta2'), createEmptyInstance: create)
    ..aOS(1, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'name')
    ..pPS(2, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'nodeIds')
    ..aOB(3, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'applyAll')
    ..hasRequiredFields = false
  ;
  ...
  'Use [GeneratedMessageGenericExtensions.rebuild] instead. '
  'Will be removed in next major version')
  ApplyParametersRequest copyWith(void Function(ApplyParametersRequest) updates) => super.copyWith((message) => updates(message as ApplyParametersRequest)) as ApplyParametersRequest; // ignore: deprecated_member_use
  $pb.BuilderInfo get info_ => _i;
  @$core.pragma('dart2js:noInline')
...
class UpdateParametersRequest extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'UpdateParametersRequest', package: const $pb.PackageName(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'google.cloud.memcache.v1beta2'), createEmptyInstance: create)
    ..aOS(1, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'name')
    ..aOM<$4.FieldMask>(2, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'updateMask', subBuilder: $4.FieldMask.create)
    ..aOM<MemcacheParameters>(3, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'parameters', subBuilder: MemcacheParameters.create)
    ..hasRequiredFields = false
  ;
  ...
  'Use [GeneratedMessageGenericExtensions.rebuild] instead. '
  'Will be removed in next major version')
  UpdateParametersRequest copyWith(void Function(UpdateParametersRequest) updates) => super.copyWith((message) => updates(message as UpdateParametersRequest)) as UpdateParametersRequest; // ignore: deprecated_member_use
  $pb.BuilderInfo get info_ => _i;
  @$core.pragma('dart2js:noInline')
...
class ApplySoftwareUpdateRequest extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'ApplySoftwareUpdateRequest', package: const $pb.PackageName(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'google.cloud.memcache.v1beta2'), createEmptyInstance: create)
  ...
  ApplySoftwareUpdateRequest._() : super();
  factory ApplySoftwareUpdateRequest({
  ...
  factory ApplySoftwareUpdateRequest.fromBuffer($core.List<$core.int> i, [$pb.ExtensionRegistry r = $pb.ExtensionRegistry.EMPTY]) => create()..mergeFromBuffer(i, r);
  factory ApplySoftwareUpdateRequest.fromJson($core.String i, [$pb.ExtensionRegistry r = $pb.ExtensionRegistry.EMPTY]) => create()..mergeFromJson(i, r);
  @$core.Deprecated(
  'Using this can add significant overhead to your binary. '
  'Use [GeneratedMessageGenericExtensions.deepCopy] instead. '
  'Will be removed in next major version')
  ApplySoftwareUpdateRequest clone() => ApplySoftwareUpdateRequest()..mergeFromMessage(this);
  @$core.Deprecated(
  'Using this can add significant overhead to your binary. '
  'Use [GeneratedMessageGenericExtensions.rebuild] instead. '
  'Will be removed in next major version')
  ApplySoftwareUpdateRequest copyWith(void Function(ApplySoftwareUpdateRequest) updates) => super.copyWith((message) => updates(message as ApplySoftwareUpdateRequest)) as ApplySoftwareUpdateRequest; // ignore: deprecated_member_use
  $pb.BuilderInfo get info_ => _i;
  @$core.pragma('dart2js:noInline')
  static ApplySoftwareUpdateRequest create() => ApplySoftwareUpdateRequest._();
  ApplySoftwareUpdateRequest createEmptyInstance() => create();
  static $pb.PbList<ApplySoftwareUpdateRequest> createRepeated() => $pb.PbList<ApplySoftwareUpdateRequest>();
  @$core.pragma('dart2js:noInline')
  static ApplySoftwareUpdateRequest getDefault() => _defaultInstance ??= $pb.GeneratedMessage.$_defaultFor<ApplySoftwareUpdateRequest>(create);
  static ApplySoftwareUpdateRequest? _defaultInstance;
...
class MemcacheParameters extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'MemcacheParameters', package: const $pb.PackageName(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'google.cloud.memcache.v1beta2'), createEmptyInstance: create)
    ..aOS(1, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'id')
    ..m<$core.String, $core.String>(3, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'params', entryClassName: 'MemcacheParameters.ParamsEntry', keyFieldType: $pb.PbFieldType.OS, valueFieldType: $pb.PbFieldType.OS, packageName: const $pb.PackageName('google.cloud.memcache.v1beta2'))
    ..hasRequiredFields = false
  ;
  ...
  'Use [GeneratedMessageGenericExtensions.rebuild] instead. '
  'Will be removed in next major version')
  MemcacheParameters copyWith(void Function(MemcacheParameters) updates) => super.copyWith((message) => updates(message as MemcacheParameters)) as MemcacheParameters; // ignore: deprecated_member_use
  $pb.BuilderInfo get info_ => _i;
  @$core.pragma('dart2js:noInline')
...
class OperationMetadata extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'OperationMetadata', package: const $pb.PackageName(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'google.cloud.memcache.v1beta2'), createEmptyInstance: create)
...
class LocationMetadata extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'LocationMetadata', package: const $pb.PackageName(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'google.cloud.memcache.v1beta2'), createEmptyInstance: create)
    ..m<$core.String, ZoneMetadata>(1, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'availableZones', entryClassName: 'LocationMetadata.AvailableZonesEntry', keyFieldType: $pb.PbFieldType.OS, valueFieldType: $pb.PbFieldType.OM, valueCreator: ZoneMetadata.create, packageName: const $pb.PackageName('google.cloud.memcache.v1beta2'))
    ..hasRequiredFields = false
  ;
...
class ZoneMetadata extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'ZoneMetadata', package: const $pb.PackageName(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'google.cloud.memcache.v1beta2'), createEmptyInstance: create)
    ..hasRequiredFields = false
  ;

...
class ContinuousValidationEvent_ContinuousValidationPodEvent_PolicyConformanceVerdict extends $pb.ProtobufEnum {
  static const ContinuousValidationEvent_ContinuousValidationPodEvent_PolicyConformanceVerdict POLICY_CONFORMANCE_VERDICT_UNSPECIFIED = ContinuousValidationEvent_ContinuousValidationPodEvent_PolicyConformanceVerdict._(0, const $core.bool.fromEnvironment('protobuf.omit_enum_names') ? '' : 'POLICY_CONFORMANCE_VERDICT_UNSPECIFIED');
  static const ContinuousValidationEvent_ContinuousValidationPodEvent_PolicyConformanceVerdict VIOLATES_POLICY = ContinuousValidationEvent_ContinuousValidationPodEvent_PolicyConformanceVerdict._(1, const $core.bool.fromEnvironment('protobuf.omit_enum_names') ? '' : 'VIOLATES_POLICY');
...
class ContinuousValidationEvent_ContinuousValidationPodEvent_ImageDetails_AuditResult extends $pb.ProtobufEnum {
  static const ContinuousValidationEvent_ContinuousValidationPodEvent_ImageDetails_AuditResult AUDIT_RESULT_UNSPECIFIED = ContinuousValidationEvent_ContinuousValidationPodEvent_ImageDetails_AuditResult._(0, const $core.bool.fromEnvironment('protobuf.omit_enum_names') ? '' : 'AUDIT_RESULT_UNSPECIFIED');
  static const ContinuousValidationEvent_ContinuousValidationPodEvent_ImageDetails_AuditResult ALLOW = ContinuousValidationEvent_ContinuousValidationPodEvent_ImageDetails_AuditResult._(1, const $core.bool.fromEnvironment('protobuf.omit_enum_names') ? '' : 'ALLOW');
  static const ContinuousValidationEvent_ContinuousValidationPodEvent_ImageDetails_AuditResult DENY = ContinuousValidationEvent_ContinuousValidationPodEvent_ImageDetails_AuditResult._(2, const $core.bool.fromEnvironment('protobuf.omit_enum_names') ? '' : 'DENY');

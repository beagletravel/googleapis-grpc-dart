...
class Policy extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'Policy', package: const $pb.PackageName(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'google.cloud.binaryauthorization.v1beta1'), createEmptyInstance: create)
    ..aOS(1, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'name')
    ..pc<AdmissionWhitelistPattern>(2, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'admissionWhitelistPatterns', $pb.PbFieldType.PM, subBuilder: AdmissionWhitelistPattern.create)
    ..m<$core.String, AdmissionRule>(3, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'clusterAdmissionRules', entryClassName: 'Policy.ClusterAdmissionRulesEntry', keyFieldType: $pb.PbFieldType.OS, valueFieldType: $pb.PbFieldType.OM, valueCreator: AdmissionRule.create, packageName: const $pb.PackageName('google.cloud.binaryauthorization.v1beta1'))
    ..aOM<AdmissionRule>(4, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'defaultAdmissionRule', subBuilder: AdmissionRule.create)
    ...
    ..e<Policy_GlobalPolicyEvaluationMode>(7, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'globalPolicyEvaluationMode', $pb.PbFieldType.OE, defaultOrMaker: Policy_GlobalPolicyEvaluationMode.GLOBAL_POLICY_EVALUATION_MODE_UNSPECIFIED, valueOf: Policy_GlobalPolicyEvaluationMode.valueOf, enumValues: Policy_GlobalPolicyEvaluationMode.values)
    ..m<$core.String, AdmissionRule>(8, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'kubernetesServiceAccountAdmissionRules', entryClassName: 'Policy.KubernetesServiceAccountAdmissionRulesEntry', keyFieldType: $pb.PbFieldType.OS, valueFieldType: $pb.PbFieldType.OM, valueCreator: AdmissionRule.create, packageName: const $pb.PackageName('google.cloud.binaryauthorization.v1beta1'))
    ..m<$core.String, AdmissionRule>(9, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'istioServiceIdentityAdmissionRules', entryClassName: 'Policy.IstioServiceIdentityAdmissionRulesEntry', keyFieldType: $pb.PbFieldType.OS, valueFieldType: $pb.PbFieldType.OM, valueCreator: AdmissionRule.create, packageName: const $pb.PackageName('google.cloud.binaryauthorization.v1beta1'))
    ..m<$core.String, AdmissionRule>(10, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'kubernetesNamespaceAdmissionRules', entryClassName: 'Policy.KubernetesNamespaceAdmissionRulesEntry', keyFieldType: $pb.PbFieldType.OS, valueFieldType: $pb.PbFieldType.OM, valueCreator: AdmissionRule.create, packageName: const $pb.PackageName('google.cloud.binaryauthorization.v1beta1'))
  ...
  factory Policy({
    ...
    if (kubernetesServiceAccountAdmissionRules != null) {
      _result.kubernetesServiceAccountAdmissionRules.addAll(kubernetesServiceAccountAdmissionRules);
    }
    if (istioServiceIdentityAdmissionRules != null) {
      _result.istioServiceIdentityAdmissionRules.addAll(istioServiceIdentityAdmissionRules);
    }
    if (kubernetesNamespaceAdmissionRules != null) {
      _result.kubernetesNamespaceAdmissionRules.addAll(kubernetesNamespaceAdmissionRules);
    }
    return _result;
  }
...
class AdmissionWhitelistPattern extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'AdmissionWhitelistPattern', package: const $pb.PackageName(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'google.cloud.binaryauthorization.v1beta1'), createEmptyInstance: create)
    ..aOS(1, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'namePattern')
    ..hasRequiredFields = false
  ;
  ...
  'Use [GeneratedMessageGenericExtensions.rebuild] instead. '
  'Will be removed in next major version')
  AdmissionWhitelistPattern copyWith(void Function(AdmissionWhitelistPattern) updates) => super.copyWith((message) => updates(message as AdmissionWhitelistPattern)) as AdmissionWhitelistPattern; // ignore: deprecated_member_use
  $pb.BuilderInfo get info_ => _i;
  @$core.pragma('dart2js:noInline')
...
class AdmissionRule extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'AdmissionRule', package: const $pb.PackageName(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'google.cloud.binaryauthorization.v1beta1'), createEmptyInstance: create)
    ..e<AdmissionRule_EvaluationMode>(1, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'evaluationMode', $pb.PbFieldType.OE, defaultOrMaker: AdmissionRule_EvaluationMode.EVALUATION_MODE_UNSPECIFIED, valueOf: AdmissionRule_EvaluationMode.valueOf, enumValues: AdmissionRule_EvaluationMode.values)
    ..pPS(2, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'requireAttestationsBy')
    ..e<AdmissionRule_EnforcementMode>(3, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'enforcementMode', $pb.PbFieldType.OE, defaultOrMaker: AdmissionRule_EnforcementMode.ENFORCEMENT_MODE_UNSPECIFIED, valueOf: AdmissionRule_EnforcementMode.valueOf, enumValues: AdmissionRule_EnforcementMode.values)
    ..hasRequiredFields = false
  ;
  ...
  'Use [GeneratedMessageGenericExtensions.rebuild] instead. '
  'Will be removed in next major version')
  AdmissionRule copyWith(void Function(AdmissionRule) updates) => super.copyWith((message) => updates(message as AdmissionRule)) as AdmissionRule; // ignore: deprecated_member_use
  $pb.BuilderInfo get info_ => _i;
  @$core.pragma('dart2js:noInline')
...
class Attestor extends $pb.GeneratedMessage {
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'Attestor', package: const $pb.PackageName(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'google.cloud.binaryauthorization.v1beta1'), createEmptyInstance: create)
    ..oo(0, [3])
    ..aOS(1, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'name')
    ..aOM<UserOwnedDrydockNote>(3, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'userOwnedDrydockNote', subBuilder: UserOwnedDrydockNote.create)
  ...
  'Use [GeneratedMessageGenericExtensions.rebuild] instead. '
  'Will be removed in next major version')
  Attestor copyWith(void Function(Attestor) updates) => super.copyWith((message) => updates(message as Attestor)) as Attestor; // ignore: deprecated_member_use
  $pb.BuilderInfo get info_ => _i;
  @$core.pragma('dart2js:noInline')
...
class UserOwnedDrydockNote extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'UserOwnedDrydockNote', package: const $pb.PackageName(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'google.cloud.binaryauthorization.v1beta1'), createEmptyInstance: create)
    ..aOS(1, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'noteReference')
    ..pc<AttestorPublicKey>(2, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'publicKeys', $pb.PbFieldType.PM, subBuilder: AttestorPublicKey.create)
    ..aOS(3, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'delegationServiceAccountEmail')
    ..hasRequiredFields = false
  ;
  ...
  factory UserOwnedDrydockNote.fromBuffer($core.List<$core.int> i, [$pb.ExtensionRegistry r = $pb.ExtensionRegistry.EMPTY]) => create()..mergeFromBuffer(i, r);
  factory UserOwnedDrydockNote.fromJson($core.String i, [$pb.ExtensionRegistry r = $pb.ExtensionRegistry.EMPTY]) => create()..mergeFromJson(i, r);
  @$core.Deprecated(
  'Using this can add significant overhead to your binary. '
  'Use [GeneratedMessageGenericExtensions.deepCopy] instead. '
  'Will be removed in next major version')
  ...
  'Use [GeneratedMessageGenericExtensions.rebuild] instead. '
  'Will be removed in next major version')
  UserOwnedDrydockNote copyWith(void Function(UserOwnedDrydockNote) updates) => super.copyWith((message) => updates(message as UserOwnedDrydockNote)) as UserOwnedDrydockNote; // ignore: deprecated_member_use
  $pb.BuilderInfo get info_ => _i;
  @$core.pragma('dart2js:noInline')
  ...
  @$core.pragma('dart2js:noInline')
  static UserOwnedDrydockNote getDefault() => _defaultInstance ??= $pb.GeneratedMessage.$_defaultFor<UserOwnedDrydockNote>(create);
...
class PkixPublicKey extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'PkixPublicKey', package: const $pb.PackageName(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'google.cloud.binaryauthorization.v1beta1'), createEmptyInstance: create)
    ..aOS(1, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'publicKeyPem')
    ..e<PkixPublicKey_SignatureAlgorithm>(2, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'signatureAlgorithm', $pb.PbFieldType.OE, defaultOrMaker: PkixPublicKey_SignatureAlgorithm.SIGNATURE_ALGORITHM_UNSPECIFIED, valueOf: PkixPublicKey_SignatureAlgorithm.valueOf, enumValues: PkixPublicKey_SignatureAlgorithm.values)
    ..hasRequiredFields = false
  ;
  ...
  'Use [GeneratedMessageGenericExtensions.rebuild] instead. '
  'Will be removed in next major version')
  PkixPublicKey copyWith(void Function(PkixPublicKey) updates) => super.copyWith((message) => updates(message as PkixPublicKey)) as PkixPublicKey; // ignore: deprecated_member_use
  $pb.BuilderInfo get info_ => _i;
  @$core.pragma('dart2js:noInline')
...
class AttestorPublicKey extends $pb.GeneratedMessage {
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'AttestorPublicKey', package: const $pb.PackageName(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'google.cloud.binaryauthorization.v1beta1'), createEmptyInstance: create)
    ..oo(0, [3, 5])
    ..aOS(1, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'comment')
    ..aOS(2, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'id')
    ..aOS(3, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'asciiArmoredPgpPublicKey')
    ..aOM<PkixPublicKey>(5, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'pkixPublicKey', subBuilder: PkixPublicKey.create)
    ..hasRequiredFields = false
  ;
  ...
  'Use [GeneratedMessageGenericExtensions.rebuild] instead. '
  'Will be removed in next major version')
  AttestorPublicKey copyWith(void Function(AttestorPublicKey) updates) => super.copyWith((message) => updates(message as AttestorPublicKey)) as AttestorPublicKey; // ignore: deprecated_member_use
  $pb.BuilderInfo get info_ => _i;
  @$core.pragma('dart2js:noInline')

...
const Policy$json = const {
  ...
  '2': const [
    ...
    const {'1': 'global_policy_evaluation_mode', '3': 7, '4': 1, '5': 14, '6': '.google.cloud.binaryauthorization.v1beta1.Policy.GlobalPolicyEvaluationMode', '8': const {}, '10': 'globalPolicyEvaluationMode'},
    const {'1': 'admission_whitelist_patterns', '3': 2, '4': 3, '5': 11, '6': '.google.cloud.binaryauthorization.v1beta1.AdmissionWhitelistPattern', '8': const {}, '10': 'admissionWhitelistPatterns'},
    const {'1': 'cluster_admission_rules', '3': 3, '4': 3, '5': 11, '6': '.google.cloud.binaryauthorization.v1beta1.Policy.ClusterAdmissionRulesEntry', '8': const {}, '10': 'clusterAdmissionRules'},
    const {'1': 'kubernetes_namespace_admission_rules', '3': 10, '4': 3, '5': 11, '6': '.google.cloud.binaryauthorization.v1beta1.Policy.KubernetesNamespaceAdmissionRulesEntry', '8': const {}, '10': 'kubernetesNamespaceAdmissionRules'},
    const {'1': 'kubernetes_service_account_admission_rules', '3': 8, '4': 3, '5': 11, '6': '.google.cloud.binaryauthorization.v1beta1.Policy.KubernetesServiceAccountAdmissionRulesEntry', '8': const {}, '10': 'kubernetesServiceAccountAdmissionRules'},
    const {'1': 'istio_service_identity_admission_rules', '3': 9, '4': 3, '5': 11, '6': '.google.cloud.binaryauthorization.v1beta1.Policy.IstioServiceIdentityAdmissionRulesEntry', '8': const {}, '10': 'istioServiceIdentityAdmissionRules'},
    const {'1': 'default_admission_rule', '3': 4, '4': 1, '5': 11, '6': '.google.cloud.binaryauthorization.v1beta1.AdmissionRule', '8': const {}, '10': 'defaultAdmissionRule'},
    const {'1': 'update_time', '3': 5, '4': 1, '5': 11, '6': '.google.protobuf.Timestamp', '8': const {}, '10': 'updateTime'},
  ],
  '3': const [Policy_ClusterAdmissionRulesEntry$json, Policy_KubernetesNamespaceAdmissionRulesEntry$json, Policy_KubernetesServiceAccountAdmissionRulesEntry$json, Policy_IstioServiceIdentityAdmissionRulesEntry$json],
...
final $typed_data.Uint8List admissionWhitelistPatternDescriptor = $convert.base64Decode('ChlBZG1pc3Npb25XaGl0ZWxpc3RQYXR0ZXJuEiEKDG5hbWVfcGF0dGVybhgBIAEoCVILbmFtZVBhdHRlcm4=');
@$core.Deprecated('Use admissionRuleDescriptor instead')
const AdmissionRule$json = const {
  '1': 'AdmissionRule',
  '2': const [
    const {'1': 'evaluation_mode', '3': 1, '4': 1, '5': 14, '6': '.google.cloud.binaryauthorization.v1beta1.AdmissionRule.EvaluationMode', '8': const {}, '10': 'evaluationMode'},
    const {'1': 'require_attestations_by', '3': 2, '4': 3, '5': 9, '8': const {}, '10': 'requireAttestationsBy'},
    const {'1': 'enforcement_mode', '3': 3, '4': 1, '5': 14, '6': '.google.cloud.binaryauthorization.v1beta1.AdmissionRule.EnforcementMode', '8': const {}, '10': 'enforcementMode'},
  ],
...
final $typed_data.Uint8List admissionRuleDescriptor = $convert.base64Decode('');
...
final $typed_data.Uint8List attestorDescriptor = $convert.base64Decode('');
@$core.Deprecated('Use userOwnedDrydockNoteDescriptor instead')
const UserOwnedDrydockNote$json = const {
  '1': 'UserOwnedDrydockNote',
  '2': const [
    const {'1': 'note_reference', '3': 1, '4': 1, '5': 9, '8': const {}, '10': 'noteReference'},
    const {'1': 'public_keys', '3': 2, '4': 3, '5': 11, '6': '.google.cloud.binaryauthorization.v1beta1.AttestorPublicKey', '8': const {}, '10': 'publicKeys'},
    const {'1': 'delegation_service_account_email', '3': 3, '4': 1, '5': 9, '8': const {}, '10': 'delegationServiceAccountEmail'},
  ],
};

/// Descriptor for `UserOwnedDrydockNote`. Decode as a `google.protobuf.DescriptorProto`.
final $typed_data.Uint8List userOwnedDrydockNoteDescriptor = $convert.base64Decode('');
...
final $typed_data.Uint8List pkixPublicKeyDescriptor = $convert.base64Decode('');
@$core.Deprecated('Use attestorPublicKeyDescriptor instead')
const AttestorPublicKey$json = const {
  '1': 'AttestorPublicKey',
  '2': const [
    const {'1': 'comment', '3': 1, '4': 1, '5': 9, '8': const {}, '10': 'comment'},
...
final $typed_data.Uint8List attestorPublicKeyDescriptor = $convert.base64Decode('');

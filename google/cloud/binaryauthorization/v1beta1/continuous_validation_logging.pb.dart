...
class ContinuousValidationEvent_ContinuousValidationPodEvent_ImageDetails extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'ContinuousValidationEvent.ContinuousValidationPodEvent.ImageDetails', package: const $pb.PackageName(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'google.cloud.binaryauthorization.v1beta1'), createEmptyInstance: create)
    ..aOS(1, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'image')
    ..e<ContinuousValidationEvent_ContinuousValidationPodEvent_ImageDetails_AuditResult>(2, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'result', $pb.PbFieldType.OE, defaultOrMaker: ContinuousValidationEvent_ContinuousValidationPodEvent_ImageDetails_AuditResult.AUDIT_RESULT_UNSPECIFIED, valueOf: ContinuousValidationEvent_ContinuousValidationPodEvent_ImageDetails_AuditResult.valueOf, enumValues: ContinuousValidationEvent_ContinuousValidationPodEvent_ImageDetails_AuditResult.values)
...
class ContinuousValidationEvent_ContinuousValidationPodEvent extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'ContinuousValidationEvent.ContinuousValidationPodEvent', package: const $pb.PackageName(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'google.cloud.binaryauthorization.v1beta1'), createEmptyInstance: create)
    ..aOS(1, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'pod')
    ..aOM<$0.Timestamp>(2, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'deployTime', subBuilder: $0.Timestamp.create)
    ..aOM<$0.Timestamp>(3, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'endTime', subBuilder: $0.Timestamp.create)
    ..e<ContinuousValidationEvent_ContinuousValidationPodEvent_PolicyConformanceVerdict>(4, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'verdict', $pb.PbFieldType.OE, defaultOrMaker: ContinuousValidationEvent_ContinuousValidationPodEvent_PolicyConformanceVerdict.POLICY_CONFORMANCE_VERDICT_UNSPECIFIED, valueOf: ContinuousValidationEvent_ContinuousValidationPodEvent_PolicyConformanceVerdict.valueOf, enumValues: ContinuousValidationEvent_ContinuousValidationPodEvent_PolicyConformanceVerdict.values)
    ..pc<ContinuousValidationEvent_ContinuousValidationPodEvent_ImageDetails>(5, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'images', $pb.PbFieldType.PM, subBuilder: ContinuousValidationEvent_ContinuousValidationPodEvent_ImageDetails.create)
    ..hasRequiredFields = false
  ;
  ...
  'Use [GeneratedMessageGenericExtensions.rebuild] instead. '
  'Will be removed in next major version')
  ContinuousValidationEvent_ContinuousValidationPodEvent copyWith(void Function(ContinuousValidationEvent_ContinuousValidationPodEvent) updates) => super.copyWith((message) => updates(message as ContinuousValidationEvent_ContinuousValidationPodEvent)) as ContinuousValidationEvent_ContinuousValidationPodEvent; // ignore: deprecated_member_use
  $pb.BuilderInfo get info_ => _i;
  @$core.pragma('dart2js:noInline')
  ...
  @$pb.TagNumber(2)
  set deployTime($0.Timestamp v) { setField(2, v); }
  @$pb.TagNumber(2)
...
class ContinuousValidationEvent_UnsupportedPolicyEvent extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'ContinuousValidationEvent.UnsupportedPolicyEvent', package: const $pb.PackageName(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'google.cloud.binaryauthorization.v1beta1'), createEmptyInstance: create)
  ...
  factory ContinuousValidationEvent_UnsupportedPolicyEvent.fromBuffer($core.List<$core.int> i, [$pb.ExtensionRegistry r = $pb.ExtensionRegistry.EMPTY]) => create()..mergeFromBuffer(i, r);
  factory ContinuousValidationEvent_UnsupportedPolicyEvent.fromJson($core.String i, [$pb.ExtensionRegistry r = $pb.ExtensionRegistry.EMPTY]) => create()..mergeFromJson(i, r);
  @$core.Deprecated(
  'Using this can add significant overhead to your binary. '
  'Use [GeneratedMessageGenericExtensions.deepCopy] instead. '
  'Will be removed in next major version')
  ContinuousValidationEvent_UnsupportedPolicyEvent clone() => ContinuousValidationEvent_UnsupportedPolicyEvent()..mergeFromMessage(this);
  @$core.Deprecated(
  'Using this can add significant overhead to your binary. '
  'Use [GeneratedMessageGenericExtensions.rebuild] instead. '
  'Will be removed in next major version')
  ContinuousValidationEvent_UnsupportedPolicyEvent copyWith(void Function(ContinuousValidationEvent_UnsupportedPolicyEvent) updates) => super.copyWith((message) => updates(message as ContinuousValidationEvent_UnsupportedPolicyEvent)) as ContinuousValidationEvent_UnsupportedPolicyEvent; // ignore: deprecated_member_use
  $pb.BuilderInfo get info_ => _i;
  @$core.pragma('dart2js:noInline')
  static ContinuousValidationEvent_UnsupportedPolicyEvent create() => ContinuousValidationEvent_UnsupportedPolicyEvent._();
  ContinuousValidationEvent_UnsupportedPolicyEvent createEmptyInstance() => create();
  static $pb.PbList<ContinuousValidationEvent_UnsupportedPolicyEvent> createRepeated() => $pb.PbList<ContinuousValidationEvent_UnsupportedPolicyEvent>();
  @$core.pragma('dart2js:noInline')
  static ContinuousValidationEvent_UnsupportedPolicyEvent getDefault() => _defaultInstance ??= $pb.GeneratedMessage.$_defaultFor<ContinuousValidationEvent_UnsupportedPolicyEvent>(create);
...
class ContinuousValidationEvent extends $pb.GeneratedMessage {
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'ContinuousValidationEvent', package: const $pb.PackageName(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'google.cloud.binaryauthorization.v1beta1'), createEmptyInstance: create)
    ..oo(0, [1, 2])
    ..aOM<ContinuousValidationEvent_ContinuousValidationPodEvent>(1, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'podEvent', subBuilder: ContinuousValidationEvent_ContinuousValidationPodEvent.create)
    ..aOM<ContinuousValidationEvent_UnsupportedPolicyEvent>(2, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'unsupportedPolicyEvent', subBuilder: ContinuousValidationEvent_UnsupportedPolicyEvent.create)
    ..hasRequiredFields = false
  ;
  ...
  'Use [GeneratedMessageGenericExtensions.rebuild] instead. '
  'Will be removed in next major version')
  ContinuousValidationEvent copyWith(void Function(ContinuousValidationEvent) updates) => super.copyWith((message) => updates(message as ContinuousValidationEvent)) as ContinuousValidationEvent; // ignore: deprecated_member_use
  $pb.BuilderInfo get info_ => _i;
  @$core.pragma('dart2js:noInline')
  ...
  @$pb.TagNumber(2)
  ContinuousValidationEvent_UnsupportedPolicyEvent get unsupportedPolicyEvent => $_getN(1);
  @$pb.TagNumber(2)
  set unsupportedPolicyEvent(ContinuousValidationEvent_UnsupportedPolicyEvent v) { setField(2, v); }
  @$pb.TagNumber(2)
  $core.bool hasUnsupportedPolicyEvent() => $_has(1);
  @$pb.TagNumber(2)
  void clearUnsupportedPolicyEvent() => clearField(2);
  @$pb.TagNumber(2)
  ContinuousValidationEvent_UnsupportedPolicyEvent ensureUnsupportedPolicyEvent() => $_ensure(1);
}

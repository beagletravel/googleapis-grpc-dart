...
class ClusterSize extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'ClusterSize', package: const $pb.PackageName(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'google.cloud.dataproc.logging'), createEmptyInstance: create)
    ..a<$core.int>(1, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'primaryWorkerCount', $pb.PbFieldType.O3)
    ..a<$core.int>(2, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'secondaryWorkerCount', $pb.PbFieldType.O3)
  ...
  'Will be removed in next major version')
  ClusterSize copyWith(void Function(ClusterSize) updates) => super.copyWith((message) => updates(message as ClusterSize)) as ClusterSize; // ignore: deprecated_member_use
...
class AutoscalerLog extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'AutoscalerLog', package: const $pb.PackageName(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'google.cloud.dataproc.logging'), createEmptyInstance: create)
    ..aOM<AutoscalerStatus>(1, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'status', subBuilder: AutoscalerStatus.create)
    ..aOM<AutoscalerRecommendation>(2, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'recommendation', subBuilder: AutoscalerRecommendation.create)
    ..hasRequiredFields = false
  ;
  ...
  'Use [GeneratedMessageGenericExtensions.rebuild] instead. '
  'Will be removed in next major version')
  AutoscalerLog copyWith(void Function(AutoscalerLog) updates) => super.copyWith((message) => updates(message as AutoscalerLog)) as AutoscalerLog; // ignore: deprecated_member_use
  $pb.BuilderInfo get info_ => _i;
  @$core.pragma('dart2js:noInline')
...
class AutoscalerStatus extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'AutoscalerStatus', package: const $pb.PackageName(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'google.cloud.dataproc.logging'), createEmptyInstance: create)
    ..e<AutoscalerState>(1, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'state', $pb.PbFieldType.OE, defaultOrMaker: AutoscalerState.AUTOSCALER_STATE_UNSPECIFIED, valueOf: AutoscalerState.valueOf, enumValues: AutoscalerState.values)
    ..aOS(2, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'details')
    ..aOS(3, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'updateClusterOperationId')
  ...
  'Use [GeneratedMessageGenericExtensions.rebuild] instead. '
  'Will be removed in next major version')
  AutoscalerStatus copyWith(void Function(AutoscalerStatus) updates) => super.copyWith((message) => updates(message as AutoscalerStatus)) as AutoscalerStatus; // ignore: deprecated_member_use
  $pb.BuilderInfo get info_ => _i;
  @$core.pragma('dart2js:noInline')
...
class AutoscalerRecommendation_Inputs extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'AutoscalerRecommendation.Inputs', package: const $pb.PackageName(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'google.cloud.dataproc.logging'), createEmptyInstance: create)
    ..m<$core.String, $core.String>(1, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'clusterMetrics', entryClassName: 'AutoscalerRecommendation.Inputs.ClusterMetricsEntry', keyFieldType: $pb.PbFieldType.OS, valueFieldType: $pb.PbFieldType.OS, packageName: const $pb.PackageName('google.cloud.dataproc.logging'))
    ..aOM<ClusterSize>(2, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'currentClusterSize', subBuilder: ClusterSize.create)
    ..aOM<ClusterSize>(3, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'minWorkerCounts', subBuilder: ClusterSize.create)
    ..aOM<ClusterSize>(4, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'maxWorkerCounts', subBuilder: ClusterSize.create)
    ..hasRequiredFields = false
  ;
  ...
  'Use [GeneratedMessageGenericExtensions.rebuild] instead. '
  'Will be removed in next major version')
  AutoscalerRecommendation_Inputs copyWith(void Function(AutoscalerRecommendation_Inputs) updates) => super.copyWith((message) => updates(message as AutoscalerRecommendation_Inputs)) as AutoscalerRecommendation_Inputs; // ignore: deprecated_member_use
  $pb.BuilderInfo get info_ => _i;
  @$core.pragma('dart2js:noInline')
...
class AutoscalerRecommendation_Outputs extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'AutoscalerRecommendation.Outputs', package: const $pb.PackageName(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'google.cloud.dataproc.logging'), createEmptyInstance: create)
    ..e<ScalingDecisionType>(1, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'decision', $pb.PbFieldType.OE, defaultOrMaker: ScalingDecisionType.SCALING_DECISION_TYPE_UNSPECIFIED, valueOf: ScalingDecisionType.valueOf, enumValues: ScalingDecisionType.values)
    ..aOM<ClusterSize>(2, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'recommendedClusterSize', subBuilder: ClusterSize.create)
    ..aOM<$0.Duration>(3, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'gracefulDecommissionTimeout', subBuilder: $0.Duration.create)
    ..pc<ConstrainingFactor>(4, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'constraintsReached', $pb.PbFieldType.PE, valueOf: ConstrainingFactor.valueOf, enumValues: ConstrainingFactor.values)
    ..pPS(5, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'additionalRecommendationDetails')
    ..aOS(6, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'recommendationId')
    ..hasRequiredFields = false
  ;
  ...
  factory AutoscalerRecommendation_Outputs({
    ...
    if (additionalRecommendationDetails != null) {
      _result.additionalRecommendationDetails.addAll(additionalRecommendationDetails);
    }
  ...
  'Use [GeneratedMessageGenericExtensions.rebuild] instead. '
  'Will be removed in next major version')
  AutoscalerRecommendation_Outputs copyWith(void Function(AutoscalerRecommendation_Outputs) updates) => super.copyWith((message) => updates(message as AutoscalerRecommendation_Outputs)) as AutoscalerRecommendation_Outputs; // ignore: deprecated_member_use
  $pb.BuilderInfo get info_ => _i;
  @$core.pragma('dart2js:noInline')
  ...
  @$pb.TagNumber(3)
  set gracefulDecommissionTimeout($0.Duration v) { setField(3, v); }
  @$pb.TagNumber(3)
...
class AutoscalerRecommendation extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'AutoscalerRecommendation', package: const $pb.PackageName(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'google.cloud.dataproc.logging'), createEmptyInstance: create)
    ..aOM<AutoscalerRecommendation_Inputs>(1, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'inputs', subBuilder: AutoscalerRecommendation_Inputs.create)
    ..aOM<AutoscalerRecommendation_Outputs>(2, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'outputs', subBuilder: AutoscalerRecommendation_Outputs.create)
    ..hasRequiredFields = false
  ;
  ...
  'Use [GeneratedMessageGenericExtensions.rebuild] instead. '
  'Will be removed in next major version')
  AutoscalerRecommendation copyWith(void Function(AutoscalerRecommendation) updates) => super.copyWith((message) => updates(message as AutoscalerRecommendation)) as AutoscalerRecommendation; // ignore: deprecated_member_use
  $pb.BuilderInfo get info_ => _i;
  @$core.pragma('dart2js:noInline')

...
class Cluster extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'Cluster', package: const $pb.PackageName(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'google.cloud.dataproc.v1'), createEmptyInstance: create)
    ..aOS(1, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'projectId')
    ..aOS(2, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'clusterName')
    ..aOM<ClusterConfig>(3, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'config', subBuilder: ClusterConfig.create)
    ..aOM<ClusterStatus>(4, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'status', subBuilder: ClusterStatus.create)
    ..aOS(6, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'clusterUuid')
    ..pc<ClusterStatus>(7, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'statusHistory', $pb.PbFieldType.PM, subBuilder: ClusterStatus.create)
    ..m<$core.String, $core.String>(8, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'labels', entryClassName: 'Cluster.LabelsEntry', keyFieldType: $pb.PbFieldType.OS, valueFieldType: $pb.PbFieldType.OS, packageName: const $pb.PackageName('google.cloud.dataproc.v1'))
    ..aOM<ClusterMetrics>(9, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'metrics', subBuilder: ClusterMetrics.create)
    ..aOM<VirtualClusterConfig>(10, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'virtualClusterConfig', subBuilder: VirtualClusterConfig.create)
  ...
  factory Cluster({
    ...
    if (virtualClusterConfig != null) {
      _result.virtualClusterConfig = virtualClusterConfig;
    }
    return _result;
  }
...
class ClusterConfig extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'ClusterConfig', package: const $pb.PackageName(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'google.cloud.dataproc.v1'), createEmptyInstance: create)
    ..aOS(1, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'configBucket')
    ..aOS(2, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'tempBucket')
    ..aOM<GceClusterConfig>(8, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'gceClusterConfig', subBuilder: GceClusterConfig.create)
    ..aOM<InstanceGroupConfig>(9, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'masterConfig', subBuilder: InstanceGroupConfig.create)
    ..aOM<InstanceGroupConfig>(10, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'workerConfig', subBuilder: InstanceGroupConfig.create)
    ..pc<NodeInitializationAction>(11, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'initializationActions', $pb.PbFieldType.PM, subBuilder: NodeInitializationAction.create)
    ..aOM<InstanceGroupConfig>(12, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'secondaryWorkerConfig', subBuilder: InstanceGroupConfig.create)
    ..aOM<SoftwareConfig>(13, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'softwareConfig', subBuilder: SoftwareConfig.create)
    ..aOM<EncryptionConfig>(15, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'encryptionConfig', subBuilder: EncryptionConfig.create)
    ..aOM<SecurityConfig>(16, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'securityConfig', subBuilder: SecurityConfig.create)
    ..aOM<LifecycleConfig>(17, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'lifecycleConfig', subBuilder: LifecycleConfig.create)
    ..aOM<AutoscalingConfig>(18, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'autoscalingConfig', subBuilder: AutoscalingConfig.create)
    ..aOM<EndpointConfig>(19, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'endpointConfig', subBuilder: EndpointConfig.create)
    ..aOM<MetastoreConfig>(20, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'metastoreConfig', subBuilder: MetastoreConfig.create)
    ..hasRequiredFields = false
  ;
  ...
  'Use [GeneratedMessageGenericExtensions.rebuild] instead. '
  'Will be removed in next major version')
  ClusterConfig copyWith(void Function(ClusterConfig) updates) => super.copyWith((message) => updates(message as ClusterConfig)) as ClusterConfig; // ignore: deprecated_member_use
  $pb.BuilderInfo get info_ => _i;
  @$core.pragma('dart2js:noInline')
...
class VirtualClusterConfig extends $pb.GeneratedMessage {
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'VirtualClusterConfig', package: const $pb.PackageName(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'google.cloud.dataproc.v1'), createEmptyInstance: create)
    ..oo(0, [6])
    ..aOS(1, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'stagingBucket')
    ..aOM<$3.KubernetesClusterConfig>(6, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'kubernetesClusterConfig', subBuilder: $3.KubernetesClusterConfig.create)
    ..aOM<AuxiliaryServicesConfig>(7, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'auxiliaryServicesConfig', subBuilder: AuxiliaryServicesConfig.create)
    ..hasRequiredFields = false
  ;
  ...
  factory VirtualClusterConfig({
    ...
    $3.KubernetesClusterConfig? kubernetesClusterConfig,
    AuxiliaryServicesConfig? auxiliaryServicesConfig,
  }) {
    final _result = create();
    if (stagingBucket != null) {
      _result.stagingBucket = stagingBucket;
    }
    if (kubernetesClusterConfig != null) {
      _result.kubernetesClusterConfig = kubernetesClusterConfig;
    }
    if (auxiliaryServicesConfig != null) {
      _result.auxiliaryServicesConfig = auxiliaryServicesConfig;
    }
    return _result;
  }
  ...
  'Use [GeneratedMessageGenericExtensions.rebuild] instead. '
  'Will be removed in next major version')
  VirtualClusterConfig copyWith(void Function(VirtualClusterConfig) updates) => super.copyWith((message) => updates(message as VirtualClusterConfig)) as VirtualClusterConfig; // ignore: deprecated_member_use
  $pb.BuilderInfo get info_ => _i;
  @$core.pragma('dart2js:noInline')
  ...
  @$pb.TagNumber(6)
  $3.KubernetesClusterConfig get kubernetesClusterConfig => $_getN(1);
  @$pb.TagNumber(6)
  set kubernetesClusterConfig($3.KubernetesClusterConfig v) { setField(6, v); }
  @$pb.TagNumber(6)
  $core.bool hasKubernetesClusterConfig() => $_has(1);
  @$pb.TagNumber(6)
  void clearKubernetesClusterConfig() => clearField(6);
  @$pb.TagNumber(6)
  $3.KubernetesClusterConfig ensureKubernetesClusterConfig() => $_ensure(1);
...
class AuxiliaryServicesConfig extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'AuxiliaryServicesConfig', package: const $pb.PackageName(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'google.cloud.dataproc.v1'), createEmptyInstance: create)
    ..aOM<MetastoreConfig>(1, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'metastoreConfig', subBuilder: MetastoreConfig.create)
    ..aOM<$3.SparkHistoryServerConfig>(2, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'sparkHistoryServerConfig', subBuilder: $3.SparkHistoryServerConfig.create)
    ..hasRequiredFields = false
  ;
  ...
  'Use [GeneratedMessageGenericExtensions.rebuild] instead. '
  'Will be removed in next major version')
  AuxiliaryServicesConfig copyWith(void Function(AuxiliaryServicesConfig) updates) => super.copyWith((message) => updates(message as AuxiliaryServicesConfig)) as AuxiliaryServicesConfig; // ignore: deprecated_member_use
  $pb.BuilderInfo get info_ => _i;
  @$core.pragma('dart2js:noInline')
  ...
  @$pb.TagNumber(2)
  $3.SparkHistoryServerConfig get sparkHistoryServerConfig => $_getN(1);
  @$pb.TagNumber(2)
  set sparkHistoryServerConfig($3.SparkHistoryServerConfig v) { setField(2, v); }
  @$pb.TagNumber(2)
  $core.bool hasSparkHistoryServerConfig() => $_has(1);
  @$pb.TagNumber(2)
  void clearSparkHistoryServerConfig() => clearField(2);
  @$pb.TagNumber(2)
  $3.SparkHistoryServerConfig ensureSparkHistoryServerConfig() => $_ensure(1);
}

class EndpointConfig extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'EndpointConfig', package: const $pb.PackageName(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'google.cloud.dataproc.v1'), createEmptyInstance: create)
    ..m<$core.String, $core.String>(1, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'httpPorts', entryClassName: 'EndpointConfig.HttpPortsEntry', keyFieldType: $pb.PbFieldType.OS, valueFieldType: $pb.PbFieldType.OS, packageName: const $pb.PackageName('google.cloud.dataproc.v1'))
    ..aOB(2, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'enableHttpPortAccess')
    ..hasRequiredFields = false
  ;
  ...
  'Use [GeneratedMessageGenericExtensions.rebuild] instead. '
  'Will be removed in next major version')
  EndpointConfig copyWith(void Function(EndpointConfig) updates) => super.copyWith((message) => updates(message as EndpointConfig)) as EndpointConfig; // ignore: deprecated_member_use
  $pb.BuilderInfo get info_ => _i;
  @$core.pragma('dart2js:noInline')
...
class AutoscalingConfig extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'AutoscalingConfig', package: const $pb.PackageName(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'google.cloud.dataproc.v1'), createEmptyInstance: create)
    ..aOS(1, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'policyUri')
    ..hasRequiredFields = false
  ;
  ...
  'Use [GeneratedMessageGenericExtensions.rebuild] instead. '
  'Will be removed in next major version')
  AutoscalingConfig copyWith(void Function(AutoscalingConfig) updates) => super.copyWith((message) => updates(message as AutoscalingConfig)) as AutoscalingConfig; // ignore: deprecated_member_use
  $pb.BuilderInfo get info_ => _i;
  @$core.pragma('dart2js:noInline')
...
class EncryptionConfig extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'EncryptionConfig', package: const $pb.PackageName(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'google.cloud.dataproc.v1'), createEmptyInstance: create)
    ..aOS(1, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'gcePdKmsKeyName')
    ..hasRequiredFields = false
  ;
  ...
  'Use [GeneratedMessageGenericExtensions.rebuild] instead. '
  'Will be removed in next major version')
  EncryptionConfig copyWith(void Function(EncryptionConfig) updates) => super.copyWith((message) => updates(message as EncryptionConfig)) as EncryptionConfig; // ignore: deprecated_member_use
  $pb.BuilderInfo get info_ => _i;
  @$core.pragma('dart2js:noInline')
...
class GceClusterConfig extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'GceClusterConfig', package: const $pb.PackageName(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'google.cloud.dataproc.v1'), createEmptyInstance: create)
    ..aOS(1, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'zoneUri')
    ..aOS(2, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'networkUri')
    ..pPS(3, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'serviceAccountScopes')
    ..pPS(4, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'tags')
    ..m<$core.String, $core.String>(5, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'metadata', entryClassName: 'GceClusterConfig.MetadataEntry', keyFieldType: $pb.PbFieldType.OS, valueFieldType: $pb.PbFieldType.OS, packageName: const $pb.PackageName('google.cloud.dataproc.v1'))
    ..aOS(6, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'subnetworkUri')
    ..aOB(7, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'internalIpOnly')
    ..aOS(8, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'serviceAccount')
    ..aOM<ReservationAffinity>(11, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'reservationAffinity', subBuilder: ReservationAffinity.create)
    ..e<GceClusterConfig_PrivateIpv6GoogleAccess>(12, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'privateIpv6GoogleAccess', $pb.PbFieldType.OE, defaultOrMaker: GceClusterConfig_PrivateIpv6GoogleAccess.PRIVATE_IPV6_GOOGLE_ACCESS_UNSPECIFIED, valueOf: GceClusterConfig_PrivateIpv6GoogleAccess.valueOf, enumValues: GceClusterConfig_PrivateIpv6GoogleAccess.values)
    ..aOM<NodeGroupAffinity>(13, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'nodeGroupAffinity', subBuilder: NodeGroupAffinity.create)
    ..aOM<ShieldedInstanceConfig>(14, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'shieldedInstanceConfig', subBuilder: ShieldedInstanceConfig.create)
    ..aOM<ConfidentialInstanceConfig>(15, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'confidentialInstanceConfig', subBuilder: ConfidentialInstanceConfig.create)
    ..hasRequiredFields = false
  ;
  ...
  'Use [GeneratedMessageGenericExtensions.rebuild] instead. '
  'Will be removed in next major version')
  GceClusterConfig copyWith(void Function(GceClusterConfig) updates) => super.copyWith((message) => updates(message as GceClusterConfig)) as GceClusterConfig; // ignore: deprecated_member_use
  $pb.BuilderInfo get info_ => _i;
  @$core.pragma('dart2js:noInline')
...
class NodeGroupAffinity extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'NodeGroupAffinity', package: const $pb.PackageName(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'google.cloud.dataproc.v1'), createEmptyInstance: create)
    ..aOS(1, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'nodeGroupUri')
    ..hasRequiredFields = false
  ;
  ...
  'Use [GeneratedMessageGenericExtensions.rebuild] instead. '
  'Will be removed in next major version')
  NodeGroupAffinity copyWith(void Function(NodeGroupAffinity) updates) => super.copyWith((message) => updates(message as NodeGroupAffinity)) as NodeGroupAffinity; // ignore: deprecated_member_use
  $pb.BuilderInfo get info_ => _i;
  @$core.pragma('dart2js:noInline')
...
class ShieldedInstanceConfig extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'ShieldedInstanceConfig', package: const $pb.PackageName(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'google.cloud.dataproc.v1'), createEmptyInstance: create)
    ..aOB(1, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'enableSecureBoot')
    ..aOB(2, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'enableVtpm')
    ..aOB(3, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'enableIntegrityMonitoring')
    ..hasRequiredFields = false
  ;
...
class ConfidentialInstanceConfig extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'ConfidentialInstanceConfig', package: const $pb.PackageName(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'google.cloud.dataproc.v1'), createEmptyInstance: create)
    ..aOB(1, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'enableConfidentialCompute')
    ..hasRequiredFields = false
  ;
  ...
  'Use [GeneratedMessageGenericExtensions.rebuild] instead. '
  'Will be removed in next major version')
  ConfidentialInstanceConfig copyWith(void Function(ConfidentialInstanceConfig) updates) => super.copyWith((message) => updates(message as ConfidentialInstanceConfig)) as ConfidentialInstanceConfig; // ignore: deprecated_member_use
  $pb.BuilderInfo get info_ => _i;
  @$core.pragma('dart2js:noInline')
...
class InstanceGroupConfig extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'InstanceGroupConfig', package: const $pb.PackageName(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'google.cloud.dataproc.v1'), createEmptyInstance: create)
    ..a<$core.int>(1, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'numInstances', $pb.PbFieldType.O3)
    ..pPS(2, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'instanceNames')
    ..aOS(3, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'imageUri')
    ..aOS(4, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'machineTypeUri')
    ..aOM<DiskConfig>(5, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'diskConfig', subBuilder: DiskConfig.create)
    ..aOB(6, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'isPreemptible')
    ..aOM<ManagedGroupConfig>(7, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'managedGroupConfig', subBuilder: ManagedGroupConfig.create)
    ..pc<AcceleratorConfig>(8, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'accelerators', $pb.PbFieldType.PM, subBuilder: AcceleratorConfig.create)
    ..aOS(9, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'minCpuPlatform')
    ..e<InstanceGroupConfig_Preemptibility>(10, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'preemptibility', $pb.PbFieldType.OE, defaultOrMaker: InstanceGroupConfig_Preemptibility.PREEMPTIBILITY_UNSPECIFIED, valueOf: InstanceGroupConfig_Preemptibility.valueOf, enumValues: InstanceGroupConfig_Preemptibility.values)
    ..hasRequiredFields = false
  ;
  ...
  'Use [GeneratedMessageGenericExtensions.rebuild] instead. '
  'Will be removed in next major version')
  InstanceGroupConfig copyWith(void Function(InstanceGroupConfig) updates) => super.copyWith((message) => updates(message as InstanceGroupConfig)) as InstanceGroupConfig; // ignore: deprecated_member_use
  $pb.BuilderInfo get info_ => _i;
  @$core.pragma('dart2js:noInline')
...
class ManagedGroupConfig extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'ManagedGroupConfig', package: const $pb.PackageName(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'google.cloud.dataproc.v1'), createEmptyInstance: create)
    ..aOS(1, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'instanceTemplateName')
    ..aOS(2, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'instanceGroupManagerName')
    ..hasRequiredFields = false
  ;
  ...
  'Use [GeneratedMessageGenericExtensions.rebuild] instead. '
  'Will be removed in next major version')
  ManagedGroupConfig copyWith(void Function(ManagedGroupConfig) updates) => super.copyWith((message) => updates(message as ManagedGroupConfig)) as ManagedGroupConfig; // ignore: deprecated_member_use
  $pb.BuilderInfo get info_ => _i;
  @$core.pragma('dart2js:noInline')
...
class AcceleratorConfig extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'AcceleratorConfig', package: const $pb.PackageName(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'google.cloud.dataproc.v1'), createEmptyInstance: create)
    ..aOS(1, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'acceleratorTypeUri')
    ..a<$core.int>(2, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'acceleratorCount', $pb.PbFieldType.O3)
    ..hasRequiredFields = false
  ;
...
class DiskConfig extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'DiskConfig', package: const $pb.PackageName(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'google.cloud.dataproc.v1'), createEmptyInstance: create)
    ..a<$core.int>(1, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'bootDiskSizeGb', $pb.PbFieldType.O3)
    ..a<$core.int>(2, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'numLocalSsds', $pb.PbFieldType.O3)
    ..aOS(3, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'bootDiskType')
    ..aOS(4, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'localSsdInterface')
    ..hasRequiredFields = false
  ;
  ...
  factory DiskConfig({
    ...
    if (localSsdInterface != null) {
      _result.localSsdInterface = localSsdInterface;
    }
    return _result;
  }
  ...
  'Use [GeneratedMessageGenericExtensions.rebuild] instead. '
  'Will be removed in next major version')
  DiskConfig copyWith(void Function(DiskConfig) updates) => super.copyWith((message) => updates(message as DiskConfig)) as DiskConfig; // ignore: deprecated_member_use
  $pb.BuilderInfo get info_ => _i;
  @$core.pragma('dart2js:noInline')
...
class NodeInitializationAction extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'NodeInitializationAction', package: const $pb.PackageName(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'google.cloud.dataproc.v1'), createEmptyInstance: create)
    ..aOS(1, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'executableFile')
    ..aOM<$4.Duration>(2, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'executionTimeout', subBuilder: $4.Duration.create)
    ..hasRequiredFields = false
  ;
  ...
  'Use [GeneratedMessageGenericExtensions.rebuild] instead. '
  'Will be removed in next major version')
  NodeInitializationAction copyWith(void Function(NodeInitializationAction) updates) => super.copyWith((message) => updates(message as NodeInitializationAction)) as NodeInitializationAction; // ignore: deprecated_member_use
  $pb.BuilderInfo get info_ => _i;
  @$core.pragma('dart2js:noInline')
  ...
  @$pb.TagNumber(2)
  $4.Duration get executionTimeout => $_getN(1);
  @$pb.TagNumber(2)
  set executionTimeout($4.Duration v) { setField(2, v); }
  @$pb.TagNumber(2)
  $core.bool hasExecutionTimeout() => $_has(1);
  @$pb.TagNumber(2)
  void clearExecutionTimeout() => clearField(2);
  @$pb.TagNumber(2)
  $4.Duration ensureExecutionTimeout() => $_ensure(1);
}

class ClusterStatus extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'ClusterStatus', package: const $pb.PackageName(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'google.cloud.dataproc.v1'), createEmptyInstance: create)
    ..e<ClusterStatus_State>(1, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'state', $pb.PbFieldType.OE, defaultOrMaker: ClusterStatus_State.UNKNOWN, valueOf: ClusterStatus_State.valueOf, enumValues: ClusterStatus_State.values)
    ..aOS(2, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'detail')
    ..aOM<$5.Timestamp>(3, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'stateStartTime', subBuilder: $5.Timestamp.create)
    ..e<ClusterStatus_Substate>(4, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'substate', $pb.PbFieldType.OE, defaultOrMaker: ClusterStatus_Substate.UNSPECIFIED, valueOf: ClusterStatus_Substate.valueOf, enumValues: ClusterStatus_Substate.values)
    ..hasRequiredFields = false
  ;
  ...
  'Use [GeneratedMessageGenericExtensions.rebuild] instead. '
  'Will be removed in next major version')
  ClusterStatus copyWith(void Function(ClusterStatus) updates) => super.copyWith((message) => updates(message as ClusterStatus)) as ClusterStatus; // ignore: deprecated_member_use
  $pb.BuilderInfo get info_ => _i;
  @$core.pragma('dart2js:noInline')
  ...
  @$pb.TagNumber(3)
  $5.Timestamp get stateStartTime => $_getN(2);
  @$pb.TagNumber(3)
  set stateStartTime($5.Timestamp v) { setField(3, v); }
  @$pb.TagNumber(3)
  $core.bool hasStateStartTime() => $_has(2);
  @$pb.TagNumber(3)
  void clearStateStartTime() => clearField(3);
  @$pb.TagNumber(3)
  $5.Timestamp ensureStateStartTime() => $_ensure(2);
...
class SecurityConfig extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'SecurityConfig', package: const $pb.PackageName(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'google.cloud.dataproc.v1'), createEmptyInstance: create)
    ..aOM<KerberosConfig>(1, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'kerberosConfig', subBuilder: KerberosConfig.create)
    ..aOM<IdentityConfig>(2, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'identityConfig', subBuilder: IdentityConfig.create)
    ..hasRequiredFields = false
  ;
  ...
  'Use [GeneratedMessageGenericExtensions.rebuild] instead. '
  'Will be removed in next major version')
  SecurityConfig copyWith(void Function(SecurityConfig) updates) => super.copyWith((message) => updates(message as SecurityConfig)) as SecurityConfig; // ignore: deprecated_member_use
  $pb.BuilderInfo get info_ => _i;
  @$core.pragma('dart2js:noInline')
...
class KerberosConfig extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'KerberosConfig', package: const $pb.PackageName(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'google.cloud.dataproc.v1'), createEmptyInstance: create)
    ..aOB(1, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'enableKerberos')
    ..aOS(2, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'rootPrincipalPasswordUri')
    ..aOS(3, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'kmsKeyUri')
    ..aOS(4, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'keystoreUri')
    ..aOS(5, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'truststoreUri')
    ..aOS(6, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'keystorePasswordUri')
    ..aOS(7, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'keyPasswordUri')
    ..aOS(8, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'truststorePasswordUri')
    ..aOS(9, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'crossRealmTrustRealm')
    ..aOS(10, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'crossRealmTrustKdc')
    ..aOS(11, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'crossRealmTrustAdminServer')
    ..aOS(12, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'crossRealmTrustSharedPasswordUri')
    ..aOS(13, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'kdcDbKeyUri')
    ..a<$core.int>(14, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'tgtLifetimeHours', $pb.PbFieldType.O3)
    ..aOS(15, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'realm')
    ..hasRequiredFields = false
  ;
  ...
  factory KerberosConfig({
    ...
    if (crossRealmTrustSharedPasswordUri != null) {
      _result.crossRealmTrustSharedPasswordUri = crossRealmTrustSharedPasswordUri;
    }
    if (kdcDbKeyUri != null) {
  ...
  'Use [GeneratedMessageGenericExtensions.rebuild] instead. '
  'Will be removed in next major version')
  KerberosConfig copyWith(void Function(KerberosConfig) updates) => super.copyWith((message) => updates(message as KerberosConfig)) as KerberosConfig; // ignore: deprecated_member_use
  $pb.BuilderInfo get info_ => _i;
  @$core.pragma('dart2js:noInline')
...
class IdentityConfig extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'IdentityConfig', package: const $pb.PackageName(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'google.cloud.dataproc.v1'), createEmptyInstance: create)
    ..m<$core.String, $core.String>(1, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'userServiceAccountMapping', entryClassName: 'IdentityConfig.UserServiceAccountMappingEntry', keyFieldType: $pb.PbFieldType.OS, valueFieldType: $pb.PbFieldType.OS, packageName: const $pb.PackageName('google.cloud.dataproc.v1'))
    ..hasRequiredFields = false
  ;
  ...
  'Use [GeneratedMessageGenericExtensions.rebuild] instead. '
  'Will be removed in next major version')
  IdentityConfig copyWith(void Function(IdentityConfig) updates) => super.copyWith((message) => updates(message as IdentityConfig)) as IdentityConfig; // ignore: deprecated_member_use
  $pb.BuilderInfo get info_ => _i;
  @$core.pragma('dart2js:noInline')
...
class SoftwareConfig extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'SoftwareConfig', package: const $pb.PackageName(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'google.cloud.dataproc.v1'), createEmptyInstance: create)
    ..aOS(1, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'imageVersion')
    ..m<$core.String, $core.String>(2, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'properties', entryClassName: 'SoftwareConfig.PropertiesEntry', keyFieldType: $pb.PbFieldType.OS, valueFieldType: $pb.PbFieldType.OS, packageName: const $pb.PackageName('google.cloud.dataproc.v1'))
    ..pc<$3.Component>(3, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'optionalComponents', $pb.PbFieldType.PE, valueOf: $3.Component.valueOf, enumValues: $3.Component.values)
    ..hasRequiredFields = false
  ;
  ...
  factory SoftwareConfig({
    ...
    $core.Iterable<$3.Component>? optionalComponents,
  }) {
    final _result = create();
  ...
  'Use [GeneratedMessageGenericExtensions.rebuild] instead. '
  'Will be removed in next major version')
  SoftwareConfig copyWith(void Function(SoftwareConfig) updates) => super.copyWith((message) => updates(message as SoftwareConfig)) as SoftwareConfig; // ignore: deprecated_member_use
  $pb.BuilderInfo get info_ => _i;
  @$core.pragma('dart2js:noInline')
  ...
  @$pb.TagNumber(3)
  $core.List<$3.Component> get optionalComponents => $_getList(2);
}
...
class LifecycleConfig extends $pb.GeneratedMessage {
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'LifecycleConfig', package: const $pb.PackageName(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'google.cloud.dataproc.v1'), createEmptyInstance: create)
    ..oo(0, [2, 3])
    ..aOM<$4.Duration>(1, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'idleDeleteTtl', subBuilder: $4.Duration.create)
    ..aOM<$5.Timestamp>(2, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'autoDeleteTime', subBuilder: $5.Timestamp.create)
    ..aOM<$4.Duration>(3, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'autoDeleteTtl', subBuilder: $4.Duration.create)
    ..aOM<$5.Timestamp>(4, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'idleStartTime', subBuilder: $5.Timestamp.create)
    ..hasRequiredFields = false
  ;

  LifecycleConfig._() : super();
  factory LifecycleConfig({
    $4.Duration? idleDeleteTtl,
    $5.Timestamp? autoDeleteTime,
    $4.Duration? autoDeleteTtl,
    $5.Timestamp? idleStartTime,
  }) {
    final _result = create();
  ...
  'Use [GeneratedMessageGenericExtensions.rebuild] instead. '
  'Will be removed in next major version')
  LifecycleConfig copyWith(void Function(LifecycleConfig) updates) => super.copyWith((message) => updates(message as LifecycleConfig)) as LifecycleConfig; // ignore: deprecated_member_use
  $pb.BuilderInfo get info_ => _i;
  @$core.pragma('dart2js:noInline')
  ...
  @$pb.TagNumber(1)
  $4.Duration get idleDeleteTtl => $_getN(0);
  @$pb.TagNumber(1)
  set idleDeleteTtl($4.Duration v) { setField(1, v); }
  @$pb.TagNumber(1)
  $core.bool hasIdleDeleteTtl() => $_has(0);
  @$pb.TagNumber(1)
  void clearIdleDeleteTtl() => clearField(1);
  @$pb.TagNumber(1)
  $4.Duration ensureIdleDeleteTtl() => $_ensure(0);

  @$pb.TagNumber(2)
  $5.Timestamp get autoDeleteTime => $_getN(1);
  @$pb.TagNumber(2)
  set autoDeleteTime($5.Timestamp v) { setField(2, v); }
  @$pb.TagNumber(2)
  $core.bool hasAutoDeleteTime() => $_has(1);
  @$pb.TagNumber(2)
  void clearAutoDeleteTime() => clearField(2);
  @$pb.TagNumber(2)
  $5.Timestamp ensureAutoDeleteTime() => $_ensure(1);

  @$pb.TagNumber(3)
  $4.Duration get autoDeleteTtl => $_getN(2);
  @$pb.TagNumber(3)
  set autoDeleteTtl($4.Duration v) { setField(3, v); }
  @$pb.TagNumber(3)
  $core.bool hasAutoDeleteTtl() => $_has(2);
  @$pb.TagNumber(3)
  void clearAutoDeleteTtl() => clearField(3);
  @$pb.TagNumber(3)
  $4.Duration ensureAutoDeleteTtl() => $_ensure(2);

  @$pb.TagNumber(4)
  $5.Timestamp get idleStartTime => $_getN(3);
  @$pb.TagNumber(4)
  set idleStartTime($5.Timestamp v) { setField(4, v); }
  @$pb.TagNumber(4)
  $core.bool hasIdleStartTime() => $_has(3);
  @$pb.TagNumber(4)
  void clearIdleStartTime() => clearField(4);
  @$pb.TagNumber(4)
  $5.Timestamp ensureIdleStartTime() => $_ensure(3);
}

class MetastoreConfig extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'MetastoreConfig', package: const $pb.PackageName(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'google.cloud.dataproc.v1'), createEmptyInstance: create)
    ..aOS(1, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'dataprocMetastoreService')
    ..hasRequiredFields = false
  ;
  ...
  'Use [GeneratedMessageGenericExtensions.rebuild] instead. '
  'Will be removed in next major version')
  MetastoreConfig copyWith(void Function(MetastoreConfig) updates) => super.copyWith((message) => updates(message as MetastoreConfig)) as MetastoreConfig; // ignore: deprecated_member_use
  $pb.BuilderInfo get info_ => _i;
  @$core.pragma('dart2js:noInline')
...
class ClusterMetrics extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'ClusterMetrics', package: const $pb.PackageName(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'google.cloud.dataproc.v1'), createEmptyInstance: create)
    ..m<$core.String, $fixnum.Int64>(1, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'hdfsMetrics', entryClassName: 'ClusterMetrics.HdfsMetricsEntry', keyFieldType: $pb.PbFieldType.OS, valueFieldType: $pb.PbFieldType.O6, packageName: const $pb.PackageName('google.cloud.dataproc.v1'))
    ..m<$core.String, $fixnum.Int64>(2, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'yarnMetrics', entryClassName: 'ClusterMetrics.YarnMetricsEntry', keyFieldType: $pb.PbFieldType.OS, valueFieldType: $pb.PbFieldType.O6, packageName: const $pb.PackageName('google.cloud.dataproc.v1'))
    ..hasRequiredFields = false
  ;
  ...
  'Use [GeneratedMessageGenericExtensions.rebuild] instead. '
  'Will be removed in next major version')
  ClusterMetrics copyWith(void Function(ClusterMetrics) updates) => super.copyWith((message) => updates(message as ClusterMetrics)) as ClusterMetrics; // ignore: deprecated_member_use
  $pb.BuilderInfo get info_ => _i;
  @$core.pragma('dart2js:noInline')
...
class CreateClusterRequest extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'CreateClusterRequest', package: const $pb.PackageName(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'google.cloud.dataproc.v1'), createEmptyInstance: create)
    ..aOS(1, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'projectId')
    ..aOM<Cluster>(2, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'cluster', subBuilder: Cluster.create)
    ...
    ..e<$3.FailureAction>(5, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'actionOnFailedPrimaryWorkers', $pb.PbFieldType.OE, defaultOrMaker: $3.FailureAction.FAILURE_ACTION_UNSPECIFIED, valueOf: $3.FailureAction.valueOf, enumValues: $3.FailureAction.values)
    ..hasRequiredFields = false
  ;
  ...
  factory CreateClusterRequest({
    ...
    $3.FailureAction? actionOnFailedPrimaryWorkers,
  }) {
    final _result = create();
    if (projectId != null) {
      _result.projectId = projectId;
  ...
  @$pb.TagNumber(5)
  $3.FailureAction get actionOnFailedPrimaryWorkers => $_getN(4);
  @$pb.TagNumber(5)
  set actionOnFailedPrimaryWorkers($3.FailureAction v) { setField(5, v); }
  @$pb.TagNumber(5)
...
class UpdateClusterRequest extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'UpdateClusterRequest', package: const $pb.PackageName(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'google.cloud.dataproc.v1'), createEmptyInstance: create)
    ..aOS(1, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'projectId')
    ..aOS(2, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'clusterName')
    ..aOM<Cluster>(3, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'cluster', subBuilder: Cluster.create)
    ..aOM<$6.FieldMask>(4, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'updateMask', subBuilder: $6.FieldMask.create)
    ..aOS(5, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'region')
    ..aOM<$4.Duration>(6, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'gracefulDecommissionTimeout', subBuilder: $4.Duration.create)
  ...
  factory UpdateClusterRequest({
    ...
    $core.String? region,
    $4.Duration? gracefulDecommissionTimeout,
    $core.String? requestId,
  }) {
    final _result = create();
    if (projectId != null) {
  ...
  @$pb.TagNumber(4)
  $6.FieldMask get updateMask => $_getN(3);
  @$pb.TagNumber(4)
  set updateMask($6.FieldMask v) { setField(4, v); }
  @$pb.TagNumber(4)
  $core.bool hasUpdateMask() => $_has(3);
  @$pb.TagNumber(4)
  void clearUpdateMask() => clearField(4);
  @$pb.TagNumber(4)
  $6.FieldMask ensureUpdateMask() => $_ensure(3);
  ...
  @$pb.TagNumber(6)
  $4.Duration get gracefulDecommissionTimeout => $_getN(5);
  @$pb.TagNumber(6)
  set gracefulDecommissionTimeout($4.Duration v) { setField(6, v); }
  @$pb.TagNumber(6)
  $core.bool hasGracefulDecommissionTimeout() => $_has(5);
  @$pb.TagNumber(6)
  void clearGracefulDecommissionTimeout() => clearField(6);
  @$pb.TagNumber(6)
  $4.Duration ensureGracefulDecommissionTimeout() => $_ensure(5);
...
class StopClusterRequest extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'StopClusterRequest', package: const $pb.PackageName(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'google.cloud.dataproc.v1'), createEmptyInstance: create)
    ..aOS(1, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'projectId')
    ..aOS(2, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'region')
    ..aOS(3, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'clusterName')
    ..aOS(4, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'clusterUuid')
  ...
  'Use [GeneratedMessageGenericExtensions.rebuild] instead. '
  'Will be removed in next major version')
  StopClusterRequest copyWith(void Function(StopClusterRequest) updates) => super.copyWith((message) => updates(message as StopClusterRequest)) as StopClusterRequest; // ignore: deprecated_member_use
  $pb.BuilderInfo get info_ => _i;
  @$core.pragma('dart2js:noInline')
...
class StartClusterRequest extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'StartClusterRequest', package: const $pb.PackageName(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'google.cloud.dataproc.v1'), createEmptyInstance: create)
    ..aOS(1, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'projectId')
    ..aOS(2, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'region')
    ..aOS(3, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'clusterName')
    ..aOS(4, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'clusterUuid')
  ...
  'Use [GeneratedMessageGenericExtensions.rebuild] instead. '
  'Will be removed in next major version')
  StartClusterRequest copyWith(void Function(StartClusterRequest) updates) => super.copyWith((message) => updates(message as StartClusterRequest)) as StartClusterRequest; // ignore: deprecated_member_use
  $pb.BuilderInfo get info_ => _i;
  @$core.pragma('dart2js:noInline')
...
class DeleteClusterRequest extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'DeleteClusterRequest', package: const $pb.PackageName(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'google.cloud.dataproc.v1'), createEmptyInstance: create)
    ..aOS(1, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'projectId')
    ..aOS(2, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'clusterName')
    ..aOS(3, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'region')
    ..aOS(4, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'clusterUuid')
...
class GetClusterRequest extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'GetClusterRequest', package: const $pb.PackageName(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'google.cloud.dataproc.v1'), createEmptyInstance: create)
    ..aOS(1, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'projectId')
    ..aOS(2, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'clusterName')
    ..aOS(3, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'region')
    ..hasRequiredFields = false
...
class ListClustersRequest extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'ListClustersRequest', package: const $pb.PackageName(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'google.cloud.dataproc.v1'), createEmptyInstance: create)
    ..aOS(1, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'projectId')
...
class ListClustersResponse extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'ListClustersResponse', package: const $pb.PackageName(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'google.cloud.dataproc.v1'), createEmptyInstance: create)
...
class DiagnoseClusterRequest extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'DiagnoseClusterRequest', package: const $pb.PackageName(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'google.cloud.dataproc.v1'), createEmptyInstance: create)
    ..aOS(1, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'projectId')
    ..aOS(2, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'clusterName')
    ..aOS(3, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'region')
    ..hasRequiredFields = false
  ...
  'Use [GeneratedMessageGenericExtensions.rebuild] instead. '
  'Will be removed in next major version')
  DiagnoseClusterRequest copyWith(void Function(DiagnoseClusterRequest) updates) => super.copyWith((message) => updates(message as DiagnoseClusterRequest)) as DiagnoseClusterRequest; // ignore: deprecated_member_use
  $pb.BuilderInfo get info_ => _i;
  @$core.pragma('dart2js:noInline')
...
class DiagnoseClusterResults extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'DiagnoseClusterResults', package: const $pb.PackageName(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'google.cloud.dataproc.v1'), createEmptyInstance: create)
    ..aOS(1, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'outputUri')
    ..hasRequiredFields = false
  ;
  ...
  'Use [GeneratedMessageGenericExtensions.rebuild] instead. '
  'Will be removed in next major version')
  DiagnoseClusterResults copyWith(void Function(DiagnoseClusterResults) updates) => super.copyWith((message) => updates(message as DiagnoseClusterResults)) as DiagnoseClusterResults; // ignore: deprecated_member_use
  $pb.BuilderInfo get info_ => _i;
  @$core.pragma('dart2js:noInline')
...
class ReservationAffinity extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'ReservationAffinity', package: const $pb.PackageName(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'google.cloud.dataproc.v1'), createEmptyInstance: create)
    ..e<ReservationAffinity_Type>(1, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'consumeReservationType', $pb.PbFieldType.OE, defaultOrMaker: ReservationAffinity_Type.TYPE_UNSPECIFIED, valueOf: ReservationAffinity_Type.valueOf, enumValues: ReservationAffinity_Type.values)

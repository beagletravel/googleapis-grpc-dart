...
class CreateBatchRequest extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'CreateBatchRequest', package: const $pb.PackageName(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'google.cloud.dataproc.v1'), createEmptyInstance: create)
    ..aOS(1, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'parent')
    ..aOM<Batch>(2, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'batch', subBuilder: Batch.create)
  ...
  'Will be removed in next major version')
  CreateBatchRequest copyWith(void Function(CreateBatchRequest) updates) => super.copyWith((message) => updates(message as CreateBatchRequest)) as CreateBatchRequest; // ignore: deprecated_member_use
...
class GetBatchRequest extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'GetBatchRequest', package: const $pb.PackageName(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'google.cloud.dataproc.v1'), createEmptyInstance: create)
  ...
  'Use [GeneratedMessageGenericExtensions.rebuild] instead. '
  'Will be removed in next major version')
  GetBatchRequest copyWith(void Function(GetBatchRequest) updates) => super.copyWith((message) => updates(message as GetBatchRequest)) as GetBatchRequest; // ignore: deprecated_member_use
  $pb.BuilderInfo get info_ => _i;
  @$core.pragma('dart2js:noInline')
...
class ListBatchesRequest extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'ListBatchesRequest', package: const $pb.PackageName(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'google.cloud.dataproc.v1'), createEmptyInstance: create)
    ..aOS(1, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'parent')
  ...
  'Use [GeneratedMessageGenericExtensions.rebuild] instead. '
  'Will be removed in next major version')
  ListBatchesRequest copyWith(void Function(ListBatchesRequest) updates) => super.copyWith((message) => updates(message as ListBatchesRequest)) as ListBatchesRequest; // ignore: deprecated_member_use
  $pb.BuilderInfo get info_ => _i;
  @$core.pragma('dart2js:noInline')
...
class ListBatchesResponse extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'ListBatchesResponse', package: const $pb.PackageName(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'google.cloud.dataproc.v1'), createEmptyInstance: create)
    ..pc<Batch>(1, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'batches', $pb.PbFieldType.PM, subBuilder: Batch.create)
  ...
  'Use [GeneratedMessageGenericExtensions.rebuild] instead. '
  'Will be removed in next major version')
  ListBatchesResponse copyWith(void Function(ListBatchesResponse) updates) => super.copyWith((message) => updates(message as ListBatchesResponse)) as ListBatchesResponse; // ignore: deprecated_member_use
  $pb.BuilderInfo get info_ => _i;
  @$core.pragma('dart2js:noInline')
...
class DeleteBatchRequest extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'DeleteBatchRequest', package: const $pb.PackageName(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'google.cloud.dataproc.v1'), createEmptyInstance: create)
    ..aOS(1, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'name')
    ..hasRequiredFields = false
  ;
  ...
  'Use [GeneratedMessageGenericExtensions.rebuild] instead. '
  'Will be removed in next major version')
  DeleteBatchRequest copyWith(void Function(DeleteBatchRequest) updates) => super.copyWith((message) => updates(message as DeleteBatchRequest)) as DeleteBatchRequest; // ignore: deprecated_member_use
  $pb.BuilderInfo get info_ => _i;
  @$core.pragma('dart2js:noInline')
...
class Batch_StateHistory extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'Batch.StateHistory', package: const $pb.PackageName(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'google.cloud.dataproc.v1'), createEmptyInstance: create)
    ..e<Batch_State>(1, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'state', $pb.PbFieldType.OE, defaultOrMaker: Batch_State.STATE_UNSPECIFIED, valueOf: Batch_State.valueOf, enumValues: Batch_State.values)
    ..aOS(2, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'stateMessage')
    ..aOM<$3.Timestamp>(3, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'stateStartTime', subBuilder: $3.Timestamp.create)
    ..hasRequiredFields = false
  ;
  ...
  'Use [GeneratedMessageGenericExtensions.rebuild] instead. '
  'Will be removed in next major version')
  Batch_StateHistory copyWith(void Function(Batch_StateHistory) updates) => super.copyWith((message) => updates(message as Batch_StateHistory)) as Batch_StateHistory; // ignore: deprecated_member_use
  $pb.BuilderInfo get info_ => _i;
  @$core.pragma('dart2js:noInline')
  ...
  @$pb.TagNumber(3)
  set stateStartTime($3.Timestamp v) { setField(3, v); }
  @$pb.TagNumber(3)
...
class Batch extends $pb.GeneratedMessage {
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'Batch', package: const $pb.PackageName(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'google.cloud.dataproc.v1'), createEmptyInstance: create)
    ..oo(0, [4, 5, 6, 7])
    ..aOS(1, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'name')
    ...
    ..aOM<PySparkBatch>(4, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'pysparkBatch', subBuilder: PySparkBatch.create)
    ..aOM<SparkBatch>(5, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'sparkBatch', subBuilder: SparkBatch.create)
    ..aOM<SparkRBatch>(6, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'sparkRBatch', subBuilder: SparkRBatch.create)
    ..aOM<SparkSqlBatch>(7, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'sparkSqlBatch', subBuilder: SparkSqlBatch.create)
    ..aOM<$4.RuntimeInfo>(8, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'runtimeInfo', subBuilder: $4.RuntimeInfo.create)
    ..e<Batch_State>(9, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'state', $pb.PbFieldType.OE, defaultOrMaker: Batch_State.STATE_UNSPECIFIED, valueOf: Batch_State.valueOf, enumValues: Batch_State.values)
    ..aOS(10, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'stateMessage')
    ..aOM<$3.Timestamp>(11, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'stateTime', subBuilder: $3.Timestamp.create)
    ..aOS(12, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'creator')
    ..m<$core.String, $core.String>(13, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'labels', entryClassName: 'Batch.LabelsEntry', keyFieldType: $pb.PbFieldType.OS, valueFieldType: $pb.PbFieldType.OS, packageName: const $pb.PackageName('google.cloud.dataproc.v1'))
    ..aOM<$4.RuntimeConfig>(14, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'runtimeConfig', subBuilder: $4.RuntimeConfig.create)
    ..aOM<$4.EnvironmentConfig>(15, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'environmentConfig', subBuilder: $4.EnvironmentConfig.create)
    ..aOS(16, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'operation')
    ..pc<Batch_StateHistory>(17, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'stateHistory', $pb.PbFieldType.PM, subBuilder: Batch_StateHistory.create)
    ..hasRequiredFields = false
  ;
  ...
  'Use [GeneratedMessageGenericExtensions.rebuild] instead. '
  'Will be removed in next major version')
  Batch copyWith(void Function(Batch) updates) => super.copyWith((message) => updates(message as Batch)) as Batch; // ignore: deprecated_member_use
  $pb.BuilderInfo get info_ => _i;
  @$core.pragma('dart2js:noInline')
  ...
  @$pb.TagNumber(8)
  set runtimeInfo($4.RuntimeInfo v) { setField(8, v); }
  @$pb.TagNumber(8)
  ...
  @$pb.TagNumber(11)
  set stateTime($3.Timestamp v) { setField(11, v); }
  @$pb.TagNumber(11)
  ...
  @$pb.TagNumber(14)
  set runtimeConfig($4.RuntimeConfig v) { setField(14, v); }
  @$pb.TagNumber(14)
  ...
  @$pb.TagNumber(15)
  set environmentConfig($4.EnvironmentConfig v) { setField(15, v); }
  @$pb.TagNumber(15)
...
class PySparkBatch extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'PySparkBatch', package: const $pb.PackageName(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'google.cloud.dataproc.v1'), createEmptyInstance: create)
  ...
  'Use [GeneratedMessageGenericExtensions.rebuild] instead. '
  'Will be removed in next major version')
  PySparkBatch copyWith(void Function(PySparkBatch) updates) => super.copyWith((message) => updates(message as PySparkBatch)) as PySparkBatch; // ignore: deprecated_member_use
  $pb.BuilderInfo get info_ => _i;
  @$core.pragma('dart2js:noInline')
...
class SparkBatch extends $pb.GeneratedMessage {
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'SparkBatch', package: const $pb.PackageName(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'google.cloud.dataproc.v1'), createEmptyInstance: create)
    ..oo(0, [1, 2])
  ...
  'Use [GeneratedMessageGenericExtensions.rebuild] instead. '
  'Will be removed in next major version')
  SparkBatch copyWith(void Function(SparkBatch) updates) => super.copyWith((message) => updates(message as SparkBatch)) as SparkBatch; // ignore: deprecated_member_use
  $pb.BuilderInfo get info_ => _i;
  @$core.pragma('dart2js:noInline')
...
class SparkRBatch extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'SparkRBatch', package: const $pb.PackageName(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'google.cloud.dataproc.v1'), createEmptyInstance: create)
  ...
  'Use [GeneratedMessageGenericExtensions.rebuild] instead. '
  'Will be removed in next major version')
  SparkRBatch copyWith(void Function(SparkRBatch) updates) => super.copyWith((message) => updates(message as SparkRBatch)) as SparkRBatch; // ignore: deprecated_member_use
  $pb.BuilderInfo get info_ => _i;
  @$core.pragma('dart2js:noInline')
...
class SparkSqlBatch extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'SparkSqlBatch', package: const $pb.PackageName(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'google.cloud.dataproc.v1'), createEmptyInstance: create)
    ..aOS(1, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'queryFileUri')
    ..m<$core.String, $core.String>(2, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'queryVariables', entryClassName: 'SparkSqlBatch.QueryVariablesEntry', keyFieldType: $pb.PbFieldType.OS, valueFieldType: $pb.PbFieldType.OS, packageName: const $pb.PackageName('google.cloud.dataproc.v1'))
    ..pPS(3, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'jarFileUris')
    ..hasRequiredFields = false
  ;
  ...
  'Use [GeneratedMessageGenericExtensions.rebuild] instead. '
  'Will be removed in next major version')
  SparkSqlBatch copyWith(void Function(SparkSqlBatch) updates) => super.copyWith((message) => updates(message as SparkSqlBatch)) as SparkSqlBatch; // ignore: deprecated_member_use
  $pb.BuilderInfo get info_ => _i;
  @$core.pragma('dart2js:noInline')

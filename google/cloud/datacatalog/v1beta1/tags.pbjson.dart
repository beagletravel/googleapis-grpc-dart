...
const Tag$json = const {
  ...
  '2': const [
    ...
    const {'1': 'fields', '3': 3, '4': 3, '5': 11, '6': '.google.cloud.datacatalog.v1beta1.Tag.FieldsEntry', '8': const {}, '10': 'fields'},
  ],
...
const Tag_FieldsEntry$json = const {
  ...
  '2': const [
    ...
    const {'1': 'value', '3': 2, '4': 1, '5': 11, '6': '.google.cloud.datacatalog.v1beta1.TagField', '10': 'value'},
  ],
  '7': const {'7': true},
};
...
const TagField$json = const {
  ...
  '2': const [
    ...
    const {'1': 'enum_value', '3': 6, '4': 1, '5': 11, '6': '.google.cloud.datacatalog.v1beta1.TagField.EnumValue', '9': 0, '10': 'enumValue'},
...
final $typed_data.Uint8List tagFieldDescriptor = $convert.base64Decode('');
...
const TagTemplate$json = const {
  ...
  '2': const [
    ...
    const {'1': 'fields', '3': 3, '4': 3, '5': 11, '6': '.google.cloud.datacatalog.v1beta1.TagTemplate.FieldsEntry', '8': const {}, '10': 'fields'},
  ],
...
const TagTemplateField$json = const {
  ...
  '2': const [
    ...
    const {'1': 'display_name', '3': 1, '4': 1, '5': 9, '10': 'displayName'},
    const {'1': 'type', '3': 2, '4': 1, '5': 11, '6': '.google.cloud.datacatalog.v1beta1.FieldType', '8': const {}, '10': 'type'},
...
const FieldType$json = const {
  '1': 'FieldType',
  '2': const [
    const {'1': 'primitive_type', '3': 1, '4': 1, '5': 14, '6': '.google.cloud.datacatalog.v1beta1.FieldType.PrimitiveType', '9': 0, '10': 'primitiveType'},
    const {'1': 'enum_type', '3': 2, '4': 1, '5': 11, '6': '.google.cloud.datacatalog.v1beta1.FieldType.EnumType', '9': 0, '10': 'enumType'},
  ],
...
const FieldType_EnumType$json = const {
  '1': 'EnumType',
  '2': const [
    const {'1': 'allowed_values', '3': 1, '4': 3, '5': 11, '6': '.google.cloud.datacatalog.v1beta1.FieldType.EnumType.EnumValue', '10': 'allowedValues'},
  ],
...
final $typed_data.Uint8List fieldTypeDescriptor = $convert.base64Decode('');

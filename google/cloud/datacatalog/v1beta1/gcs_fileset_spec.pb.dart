...
class GcsFilesetSpec extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'GcsFilesetSpec', package: const $pb.PackageName(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'google.cloud.datacatalog.v1beta1'), createEmptyInstance: create)
    ..pPS(1, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'filePatterns')
    ..pc<GcsFileSpec>(2, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'sampleGcsFileSpecs', $pb.PbFieldType.PM, subBuilder: GcsFileSpec.create)
  ...
  'Will be removed in next major version')
  GcsFilesetSpec copyWith(void Function(GcsFilesetSpec) updates) => super.copyWith((message) => updates(message as GcsFilesetSpec)) as GcsFilesetSpec; // ignore: deprecated_member_use
...
class GcsFileSpec extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'GcsFileSpec', package: const $pb.PackageName(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'google.cloud.datacatalog.v1beta1'), createEmptyInstance: create)
    ..aOS(1, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'filePath')
    ..aOM<$0.SystemTimestamps>(2, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'gcsTimestamps', subBuilder: $0.SystemTimestamps.create)
  ...
  'Use [GeneratedMessageGenericExtensions.rebuild] instead. '
  'Will be removed in next major version')
  GcsFileSpec copyWith(void Function(GcsFileSpec) updates) => super.copyWith((message) => updates(message as GcsFileSpec)) as GcsFileSpec; // ignore: deprecated_member_use
  $pb.BuilderInfo get info_ => _i;
  @$core.pragma('dart2js:noInline')
  ...
  @$pb.TagNumber(2)
  set gcsTimestamps($0.SystemTimestamps v) { setField(2, v); }
  @$pb.TagNumber(2)

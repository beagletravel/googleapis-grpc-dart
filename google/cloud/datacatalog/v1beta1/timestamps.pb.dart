...
class SystemTimestamps extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'SystemTimestamps', package: const $pb.PackageName(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'google.cloud.datacatalog.v1beta1'), createEmptyInstance: create)
    ...
    ..aOM<$0.Timestamp>(3, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'expireTime', subBuilder: $0.Timestamp.create)
  ...
  'Will be removed in next major version')
  SystemTimestamps copyWith(void Function(SystemTimestamps) updates) => super.copyWith((message) => updates(message as SystemTimestamps)) as SystemTimestamps; // ignore: deprecated_member_use

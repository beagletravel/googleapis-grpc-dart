...
class BigQueryConnectionSpec_ConnectionType extends $pb.ProtobufEnum {
  static const BigQueryConnectionSpec_ConnectionType CONNECTION_TYPE_UNSPECIFIED = BigQueryConnectionSpec_ConnectionType._(0, const $core.bool.fromEnvironment('protobuf.omit_enum_names') ? '' : 'CONNECTION_TYPE_UNSPECIFIED');
  static const BigQueryConnectionSpec_ConnectionType CLOUD_SQL = BigQueryConnectionSpec_ConnectionType._(1, const $core.bool.fromEnvironment('protobuf.omit_enum_names') ? '' : 'CLOUD_SQL');
...
class CloudSqlBigQueryConnectionSpec_DatabaseType extends $pb.ProtobufEnum {
  static const CloudSqlBigQueryConnectionSpec_DatabaseType DATABASE_TYPE_UNSPECIFIED = CloudSqlBigQueryConnectionSpec_DatabaseType._(0, const $core.bool.fromEnvironment('protobuf.omit_enum_names') ? '' : 'DATABASE_TYPE_UNSPECIFIED');
  static const CloudSqlBigQueryConnectionSpec_DatabaseType POSTGRES = CloudSqlBigQueryConnectionSpec_DatabaseType._(1, const $core.bool.fromEnvironment('protobuf.omit_enum_names') ? '' : 'POSTGRES');
  static const CloudSqlBigQueryConnectionSpec_DatabaseType MYSQL = CloudSqlBigQueryConnectionSpec_DatabaseType._(2, const $core.bool.fromEnvironment('protobuf.omit_enum_names') ? '' : 'MYSQL');

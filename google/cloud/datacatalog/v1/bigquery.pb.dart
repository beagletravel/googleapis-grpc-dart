...
class BigQueryConnectionSpec extends $pb.GeneratedMessage {
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'BigQueryConnectionSpec', package: const $pb.PackageName(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'google.cloud.datacatalog.v1'), createEmptyInstance: create)
    ..oo(0, [2])
    ..e<BigQueryConnectionSpec_ConnectionType>(1, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'connectionType', $pb.PbFieldType.OE, defaultOrMaker: BigQueryConnectionSpec_ConnectionType.CONNECTION_TYPE_UNSPECIFIED, valueOf: BigQueryConnectionSpec_ConnectionType.valueOf, enumValues: BigQueryConnectionSpec_ConnectionType.values)
    ..aOM<CloudSqlBigQueryConnectionSpec>(2, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'cloudSql', subBuilder: CloudSqlBigQueryConnectionSpec.create)
    ..aOB(3, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'hasCredential')
  ...
  'Will be removed in next major version')
  BigQueryConnectionSpec copyWith(void Function(BigQueryConnectionSpec) updates) => super.copyWith((message) => updates(message as BigQueryConnectionSpec)) as BigQueryConnectionSpec; // ignore: deprecated_member_use
...
class CloudSqlBigQueryConnectionSpec extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'CloudSqlBigQueryConnectionSpec', package: const $pb.PackageName(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'google.cloud.datacatalog.v1'), createEmptyInstance: create)
    ...
    ..e<CloudSqlBigQueryConnectionSpec_DatabaseType>(3, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'type', $pb.PbFieldType.OE, defaultOrMaker: CloudSqlBigQueryConnectionSpec_DatabaseType.DATABASE_TYPE_UNSPECIFIED, valueOf: CloudSqlBigQueryConnectionSpec_DatabaseType.valueOf, enumValues: CloudSqlBigQueryConnectionSpec_DatabaseType.values)
    ..hasRequiredFields = false
  ;
  ...
  'Use [GeneratedMessageGenericExtensions.rebuild] instead. '
  'Will be removed in next major version')
  CloudSqlBigQueryConnectionSpec copyWith(void Function(CloudSqlBigQueryConnectionSpec) updates) => super.copyWith((message) => updates(message as CloudSqlBigQueryConnectionSpec)) as CloudSqlBigQueryConnectionSpec; // ignore: deprecated_member_use
  $pb.BuilderInfo get info_ => _i;
  @$core.pragma('dart2js:noInline')
...
class BigQueryRoutineSpec extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'BigQueryRoutineSpec', package: const $pb.PackageName(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'google.cloud.datacatalog.v1'), createEmptyInstance: create)
    ..pPS(1, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'importedLibraries')
    ..hasRequiredFields = false
  ;
  ...
  'Use [GeneratedMessageGenericExtensions.rebuild] instead. '
  'Will be removed in next major version')
  BigQueryRoutineSpec copyWith(void Function(BigQueryRoutineSpec) updates) => super.copyWith((message) => updates(message as BigQueryRoutineSpec)) as BigQueryRoutineSpec; // ignore: deprecated_member_use
  $pb.BuilderInfo get info_ => _i;
  @$core.pragma('dart2js:noInline')

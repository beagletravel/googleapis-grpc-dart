...
const Tag$json = const {
  ...
  '2': const [
    ...
    const {'1': 'template', '3': 2, '4': 1, '5': 9, '8': const {}, '10': 'template'},
    const {'1': 'template_display_name', '3': 5, '4': 1, '5': 9, '8': const {}, '10': 'templateDisplayName'},
    const {'1': 'column', '3': 4, '4': 1, '5': 9, '9': 0, '10': 'column'},
    const {'1': 'fields', '3': 3, '4': 3, '5': 11, '6': '.google.cloud.datacatalog.v1.Tag.FieldsEntry', '8': const {}, '10': 'fields'},
  ],
...
const TagField$json = const {
  ...
  '2': const [
    ...
    const {'1': 'enum_value', '3': 6, '4': 1, '5': 11, '6': '.google.cloud.datacatalog.v1.TagField.EnumValue', '9': 0, '10': 'enumValue'},
    const {'1': 'richtext_value', '3': 8, '4': 1, '5': 9, '9': 0, '10': 'richtextValue'},
...
final $typed_data.Uint8List tagFieldDescriptor = $convert.base64Decode('');
...
const TagTemplate$json = const {
  ...
  '2': const [
    ...
    const {'1': 'is_publicly_readable', '3': 5, '4': 1, '5': 8, '10': 'isPubliclyReadable'},
    const {'1': 'fields', '3': 3, '4': 3, '5': 11, '6': '.google.cloud.datacatalog.v1.TagTemplate.FieldsEntry', '8': const {}, '10': 'fields'},
  ],
...
const TagTemplate_FieldsEntry$json = const {
  ...
  '2': const [
    const {'1': 'key', '3': 1, '4': 1, '5': 9, '10': 'key'},
    const {'1': 'value', '3': 2, '4': 1, '5': 11, '6': '.google.cloud.datacatalog.v1.TagTemplateField', '10': 'value'},
  ],
  '7': const {'7': true},
};

/// Descriptor for `TagTemplate`. Decode as a `google.protobuf.DescriptorProto`.
final $typed_data.Uint8List tagTemplateDescriptor = $convert.base64Decode('');
...
const TagTemplateField$json = const {
  ...
  '2': const [
    ...
    const {'1': 'display_name', '3': 1, '4': 1, '5': 9, '10': 'displayName'},
    const {'1': 'type', '3': 2, '4': 1, '5': 11, '6': '.google.cloud.datacatalog.v1.FieldType', '8': const {}, '10': 'type'},
...
const FieldType_EnumType$json = const {
  '1': 'EnumType',
  '2': const [
    const {'1': 'allowed_values', '3': 1, '4': 3, '5': 11, '6': '.google.cloud.datacatalog.v1.FieldType.EnumType.EnumValue', '10': 'allowedValues'},
  ],
...
final $typed_data.Uint8List fieldTypeDescriptor = $convert.base64Decode('');

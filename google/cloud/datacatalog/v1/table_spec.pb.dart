...
class BigQueryTableSpec extends $pb.GeneratedMessage {
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'BigQueryTableSpec', package: const $pb.PackageName(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'google.cloud.datacatalog.v1'), createEmptyInstance: create)
    ..oo(0, [2, 3])
    ..e<TableSourceType>(1, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'tableSourceType', $pb.PbFieldType.OE, defaultOrMaker: TableSourceType.TABLE_SOURCE_TYPE_UNSPECIFIED, valueOf: TableSourceType.valueOf, enumValues: TableSourceType.values)
    ..aOM<ViewSpec>(2, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'viewSpec', subBuilder: ViewSpec.create)
    ..aOM<TableSpec>(3, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'tableSpec', subBuilder: TableSpec.create)
  ...
  'Will be removed in next major version')
  BigQueryTableSpec copyWith(void Function(BigQueryTableSpec) updates) => super.copyWith((message) => updates(message as BigQueryTableSpec)) as BigQueryTableSpec; // ignore: deprecated_member_use
...
class ViewSpec extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'ViewSpec', package: const $pb.PackageName(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'google.cloud.datacatalog.v1'), createEmptyInstance: create)
    ..aOS(1, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'viewQuery')
    ..hasRequiredFields = false
  ;
  ...
  'Use [GeneratedMessageGenericExtensions.rebuild] instead. '
  'Will be removed in next major version')
  ViewSpec copyWith(void Function(ViewSpec) updates) => super.copyWith((message) => updates(message as ViewSpec)) as ViewSpec; // ignore: deprecated_member_use
  $pb.BuilderInfo get info_ => _i;
  @$core.pragma('dart2js:noInline')
...
class TableSpec extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'TableSpec', package: const $pb.PackageName(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'google.cloud.datacatalog.v1'), createEmptyInstance: create)
    ..aOS(1, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'groupedEntry')
    ..hasRequiredFields = false
  ;
  ...
  'Use [GeneratedMessageGenericExtensions.rebuild] instead. '
  'Will be removed in next major version')
  TableSpec copyWith(void Function(TableSpec) updates) => super.copyWith((message) => updates(message as TableSpec)) as TableSpec; // ignore: deprecated_member_use
  $pb.BuilderInfo get info_ => _i;
  @$core.pragma('dart2js:noInline')
...
class BigQueryDateShardedSpec extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'BigQueryDateShardedSpec', package: const $pb.PackageName(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'google.cloud.datacatalog.v1'), createEmptyInstance: create)
    ...
    ..aInt64(3, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'shardCount')
    ..aOS(4, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'latestShardResource')
    ..hasRequiredFields = false
  ;
  ...
  'Use [GeneratedMessageGenericExtensions.rebuild] instead. '
  'Will be removed in next major version')
  BigQueryDateShardedSpec copyWith(void Function(BigQueryDateShardedSpec) updates) => super.copyWith((message) => updates(message as BigQueryDateShardedSpec)) as BigQueryDateShardedSpec; // ignore: deprecated_member_use
  $pb.BuilderInfo get info_ => _i;
  @$core.pragma('dart2js:noInline')
  ...
  @$pb.TagNumber(4)
  set latestShardResource($core.String v) { $_setString(3, v); }
  @$pb.TagNumber(4)

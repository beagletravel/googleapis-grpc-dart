...
class UsageStats extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'UsageStats', package: const $pb.PackageName(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'google.cloud.datacatalog.v1'), createEmptyInstance: create)
    ..a<$core.double>(1, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'totalCompletions', $pb.PbFieldType.OF)
    ..a<$core.double>(2, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'totalFailures', $pb.PbFieldType.OF)
    ..a<$core.double>(3, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'totalCancellations', $pb.PbFieldType.OF)
    ..a<$core.double>(4, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'totalExecutionTimeForCompletionsMillis', $pb.PbFieldType.OF)
  ...
  factory UsageStats({
    ...
    if (totalExecutionTimeForCompletionsMillis != null) {
      _result.totalExecutionTimeForCompletionsMillis = totalExecutionTimeForCompletionsMillis;
    }
    return _result;
  }
  ...
  'Will be removed in next major version')
  UsageStats copyWith(void Function(UsageStats) updates) => super.copyWith((message) => updates(message as UsageStats)) as UsageStats; // ignore: deprecated_member_use
...
class UsageSignal extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'UsageSignal', package: const $pb.PackageName(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'google.cloud.datacatalog.v1'), createEmptyInstance: create)
    ..aOM<$0.Timestamp>(1, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'updateTime', subBuilder: $0.Timestamp.create)
    ..m<$core.String, UsageStats>(2, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'usageWithinTimeRange', entryClassName: 'UsageSignal.UsageWithinTimeRangeEntry', keyFieldType: $pb.PbFieldType.OS, valueFieldType: $pb.PbFieldType.OM, valueCreator: UsageStats.create, packageName: const $pb.PackageName('google.cloud.datacatalog.v1'))
    ..hasRequiredFields = false
  ;
  ...
  'Use [GeneratedMessageGenericExtensions.rebuild] instead. '
  'Will be removed in next major version')
  UsageSignal copyWith(void Function(UsageSignal) updates) => super.copyWith((message) => updates(message as UsageSignal)) as UsageSignal; // ignore: deprecated_member_use
  $pb.BuilderInfo get info_ => _i;
  @$core.pragma('dart2js:noInline')

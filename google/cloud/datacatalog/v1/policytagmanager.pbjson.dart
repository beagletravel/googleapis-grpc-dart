...
const Taxonomy$json = const {
  ...
  '2': const [
    ...
    const {'1': 'policy_tag_count', '3': 4, '4': 1, '5': 5, '8': const {}, '10': 'policyTagCount'},
    const {'1': 'taxonomy_timestamps', '3': 5, '4': 1, '5': 11, '6': '.google.cloud.datacatalog.v1.SystemTimestamps', '8': const {}, '10': 'taxonomyTimestamps'},
    const {'1': 'activated_policy_types', '3': 6, '4': 3, '5': 14, '6': '.google.cloud.datacatalog.v1.Taxonomy.PolicyType', '8': const {}, '10': 'activatedPolicyTypes'},
  ],
...
const CreateTaxonomyRequest$json = const {
  ...
  '2': const [
    ...
    const {'1': 'taxonomy', '3': 2, '4': 1, '5': 11, '6': '.google.cloud.datacatalog.v1.Taxonomy', '10': 'taxonomy'},
  ],
};

/// Descriptor for `CreateTaxonomyRequest`. Decode as a `google.protobuf.DescriptorProto`.
final $typed_data.Uint8List createTaxonomyRequestDescriptor = $convert.base64Decode('ChVDcmVhdGVUYXhvbm9teVJlcXVlc3QSQwoGcGFyZW50GAEgASgJQivgQQL6QSUSI2RhdGFjYXRhbG9nLmdvb2dsZWFwaXMuY29tL1RheG9ub215UgZwYXJlbnQSQQoIdGF4b25vbXkYAiABKAsyJS5nb29nbGUuY2xvdWQuZGF0YWNhdGFsb2cudjEuVGF4b25vbXlSCHRheG9ub215');
...
const UpdateTaxonomyRequest$json = const {
  ...
  '2': const [
    const {'1': 'taxonomy', '3': 1, '4': 1, '5': 11, '6': '.google.cloud.datacatalog.v1.Taxonomy', '10': 'taxonomy'},
    const {'1': 'update_mask', '3': 2, '4': 1, '5': 11, '6': '.google.protobuf.FieldMask', '10': 'updateMask'},
  ],
};

/// Descriptor for `UpdateTaxonomyRequest`. Decode as a `google.protobuf.DescriptorProto`.
final $typed_data.Uint8List updateTaxonomyRequestDescriptor = $convert.base64Decode('ChVVcGRhdGVUYXhvbm9teVJlcXVlc3QSQQoIdGF4b25vbXkYASABKAsyJS5nb29nbGUuY2xvdWQuZGF0YWNhdGFsb2cudjEuVGF4b25vbXlSCHRheG9ub215EjsKC3VwZGF0ZV9tYXNrGAIgASgLMhouZ29vZ2xlLnByb3RvYnVmLkZpZWxkTWFza1IKdXBkYXRlTWFzaw==');
...
final $typed_data.Uint8List listTaxonomiesResponseDescriptor = $convert.base64Decode('ChZMaXN0VGF4b25vbWllc1Jlc3BvbnNlEkUKCnRheG9ub21pZXMYASADKAsyJS5nb29nbGUuY2xvdWQuZGF0YWNhdGFsb2cudjEuVGF4b25vbXlSCnRheG9ub21pZXMSJgoPbmV4dF9wYWdlX3Rva2VuGAIgASgJUg1uZXh0UGFnZVRva2Vu');
...
const CreatePolicyTagRequest$json = const {
  ...
  '2': const [
    const {'1': 'parent', '3': 1, '4': 1, '5': 9, '8': const {}, '10': 'parent'},
    const {'1': 'policy_tag', '3': 2, '4': 1, '5': 11, '6': '.google.cloud.datacatalog.v1.PolicyTag', '10': 'policyTag'},
  ],
};

/// Descriptor for `CreatePolicyTagRequest`. Decode as a `google.protobuf.DescriptorProto`.
final $typed_data.Uint8List createPolicyTagRequestDescriptor = $convert.base64Decode('ChZDcmVhdGVQb2xpY3lUYWdSZXF1ZXN0EkQKBnBhcmVudBgBIAEoCUIs4EEC+kEmEiRkYXRhY2F0YWxvZy5nb29nbGVhcGlzLmNvbS9Qb2xpY3lUYWdSBnBhcmVudBJFCgpwb2xpY3lfdGFnGAIgASgLMiYuZ29vZ2xlLmNsb3VkLmRhdGFjYXRhbG9nLnYxLlBvbGljeVRhZ1IJcG9saWN5VGFn');
...
const UpdatePolicyTagRequest$json = const {
  ...
  '2': const [
    const {'1': 'policy_tag', '3': 1, '4': 1, '5': 11, '6': '.google.cloud.datacatalog.v1.PolicyTag', '10': 'policyTag'},
    const {'1': 'update_mask', '3': 2, '4': 1, '5': 11, '6': '.google.protobuf.FieldMask', '10': 'updateMask'},
  ],
};

/// Descriptor for `UpdatePolicyTagRequest`. Decode as a `google.protobuf.DescriptorProto`.
final $typed_data.Uint8List updatePolicyTagRequestDescriptor = $convert.base64Decode('ChZVcGRhdGVQb2xpY3lUYWdSZXF1ZXN0EkUKCnBvbGljeV90YWcYASABKAsyJi5nb29nbGUuY2xvdWQuZGF0YWNhdGFsb2cudjEuUG9saWN5VGFnUglwb2xpY3lUYWcSOwoLdXBkYXRlX21hc2sYAiABKAsyGi5nb29nbGUucHJvdG9idWYuRmllbGRNYXNrUgp1cGRhdGVNYXNr');
...
const ListPolicyTagsResponse$json = const {
  ...
  '2': const [
    const {'1': 'policy_tags', '3': 1, '4': 3, '5': 11, '6': '.google.cloud.datacatalog.v1.PolicyTag', '10': 'policyTags'},
    const {'1': 'next_page_token', '3': 2, '4': 1, '5': 9, '10': 'nextPageToken'},
  ],
};

/// Descriptor for `ListPolicyTagsResponse`. Decode as a `google.protobuf.DescriptorProto`.
final $typed_data.Uint8List listPolicyTagsResponseDescriptor = $convert.base64Decode('ChZMaXN0UG9saWN5VGFnc1Jlc3BvbnNlEkcKC3BvbGljeV90YWdzGAEgAygLMiYuZ29vZ2xlLmNsb3VkLmRhdGFjYXRhbG9nLnYxLlBvbGljeVRhZ1IKcG9saWN5VGFncxImCg9uZXh0X3BhZ2VfdG9rZW4YAiABKAlSDW5leHRQYWdlVG9rZW4=');

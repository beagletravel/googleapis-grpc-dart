...
class Taxonomy_PolicyType extends $pb.ProtobufEnum {
  static const Taxonomy_PolicyType POLICY_TYPE_UNSPECIFIED = Taxonomy_PolicyType._(0, const $core.bool.fromEnvironment('protobuf.omit_enum_names') ? '' : 'POLICY_TYPE_UNSPECIFIED');
  static const Taxonomy_PolicyType FINE_GRAINED_ACCESS_CONTROL = Taxonomy_PolicyType._(1, const $core.bool.fromEnvironment('protobuf.omit_enum_names') ? '' : 'FINE_GRAINED_ACCESS_CONTROL');

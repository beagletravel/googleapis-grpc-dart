...
class SearchCatalogResult extends $pb.GeneratedMessage {
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'SearchCatalogResult', package: const $pb.PackageName(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'google.cloud.datacatalog.v1'), createEmptyInstance: create)
    ..oo(0, [8, 9])
    ..e<SearchResultType>(1, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'searchResultType', $pb.PbFieldType.OE, defaultOrMaker: SearchResultType.SEARCH_RESULT_TYPE_UNSPECIFIED, valueOf: SearchResultType.valueOf, enumValues: SearchResultType.values)
    ..aOS(2, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'searchResultSubtype')
    ..aOS(3, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'relativeResourceName')
    ..aOS(4, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'linkedResource')
    ..aOM<$0.Timestamp>(7, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'modifyTime', subBuilder: $0.Timestamp.create)
    ..e<$1.IntegratedSystem>(8, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'integratedSystem', $pb.PbFieldType.OE, defaultOrMaker: $1.IntegratedSystem.INTEGRATED_SYSTEM_UNSPECIFIED, valueOf: $1.IntegratedSystem.valueOf, enumValues: $1.IntegratedSystem.values)
    ..aOS(9, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'userSpecifiedSystem')
    ..aOS(10, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'fullyQualifiedName')
  ...
  'Will be removed in next major version')
  SearchCatalogResult copyWith(void Function(SearchCatalogResult) updates) => super.copyWith((message) => updates(message as SearchCatalogResult)) as SearchCatalogResult; // ignore: deprecated_member_use
  ...
  @$pb.TagNumber(7)
  set modifyTime($0.Timestamp v) { setField(7, v); }
  @$pb.TagNumber(7)
  ...
  @$pb.TagNumber(8)
  set integratedSystem($1.IntegratedSystem v) { setField(8, v); }
  @$pb.TagNumber(8)

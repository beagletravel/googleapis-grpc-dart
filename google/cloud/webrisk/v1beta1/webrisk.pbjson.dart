...
const ComputeThreatListDiffRequest$json = const {
  ...
  '2': const [
    const {'1': 'threat_type', '3': 1, '4': 1, '5': 14, '6': '.google.cloud.webrisk.v1beta1.ThreatType', '8': const {}, '10': 'threatType'},
    const {'1': 'version_token', '3': 2, '4': 1, '5': 12, '10': 'versionToken'},
    const {'1': 'constraints', '3': 3, '4': 1, '5': 11, '6': '.google.cloud.webrisk.v1beta1.ComputeThreatListDiffRequest.Constraints', '8': const {}, '10': 'constraints'},
  ],
...
final $typed_data.Uint8List computeThreatListDiffRequestDescriptor = $convert.base64Decode('');
...
final $typed_data.Uint8List computeThreatListDiffResponseDescriptor = $convert.base64Decode('');
...
const SearchUrisRequest$json = const {
  ...
  '2': const [
    ...
    const {'1': 'threat_types', '3': 2, '4': 3, '5': 14, '6': '.google.cloud.webrisk.v1beta1.ThreatType', '8': const {}, '10': 'threatTypes'},
  ],
};

/// Descriptor for `SearchUrisRequest`. Decode as a `google.protobuf.DescriptorProto`.
final $typed_data.Uint8List searchUrisRequestDescriptor = $convert.base64Decode('ChFTZWFyY2hVcmlzUmVxdWVzdBIVCgN1cmkYASABKAlCA+BBAlIDdXJpElAKDHRocmVhdF90eXBlcxgCIAMoDjIoLmdvb2dsZS5jbG91ZC53ZWJyaXNrLnYxYmV0YTEuVGhyZWF0VHlwZUID4EECUgt0aHJlYXRUeXBlcw==');
...
final $typed_data.Uint8List searchUrisResponseDescriptor = $convert.base64Decode('');
...
final $typed_data.Uint8List searchHashesRequestDescriptor = $convert.base64Decode('ChNTZWFyY2hIYXNoZXNSZXF1ZXN0Eh8KC2hhc2hfcHJlZml4GAEgASgMUgpoYXNoUHJlZml4ElAKDHRocmVhdF90eXBlcxgCIAMoDjIoLmdvb2dsZS5jbG91ZC53ZWJyaXNrLnYxYmV0YTEuVGhyZWF0VHlwZUID4EECUgt0aHJlYXRUeXBlcw==');
...
final $typed_data.Uint8List searchHashesResponseDescriptor = $convert.base64Decode('');
...
final $typed_data.Uint8List threatEntryAdditionsDescriptor = $convert.base64Decode('ChRUaHJlYXRFbnRyeUFkZGl0aW9ucxJGCgpyYXdfaGFzaGVzGAEgAygLMicuZ29vZ2xlLmNsb3VkLndlYnJpc2sudjFiZXRhMS5SYXdIYXNoZXNSCXJhd0hhc2hlcxJQCgtyaWNlX2hhc2hlcxgCIAEoCzIvLmdvb2dsZS5jbG91ZC53ZWJyaXNrLnYxYmV0YTEuUmljZURlbHRhRW5jb2RpbmdSCnJpY2VIYXNoZXM=');
...
final $typed_data.Uint8List threatEntryRemovalsDescriptor = $convert.base64Decode('ChNUaHJlYXRFbnRyeVJlbW92YWxzEkkKC3Jhd19pbmRpY2VzGAEgASgLMiguZ29vZ2xlLmNsb3VkLndlYnJpc2sudjFiZXRhMS5SYXdJbmRpY2VzUgpyYXdJbmRpY2VzElIKDHJpY2VfaW5kaWNlcxgCIAEoCzIvLmdvb2dsZS5jbG91ZC53ZWJyaXNrLnYxYmV0YTEuUmljZURlbHRhRW5jb2RpbmdSC3JpY2VJbmRpY2Vz');

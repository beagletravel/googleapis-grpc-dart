...
class AccessTuple extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'AccessTuple', package: const $pb.PackageName(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'google.cloud.policytroubleshooter.v1'), createEmptyInstance: create)
    ...
    ..aOS(3, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'permission')
...
class ExplainedPolicy extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'ExplainedPolicy', package: const $pb.PackageName(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'google.cloud.policytroubleshooter.v1'), createEmptyInstance: create)
    ..e<AccessState>(1, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'access', $pb.PbFieldType.OE, defaultOrMaker: AccessState.ACCESS_STATE_UNSPECIFIED, valueOf: AccessState.valueOf, enumValues: AccessState.values)
    ..aOS(2, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'fullResourceName')
    ..aOM<$0.Policy>(3, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'policy', subBuilder: $0.Policy.create)
    ..pc<BindingExplanation>(4, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'bindingExplanations', $pb.PbFieldType.PM, subBuilder: BindingExplanation.create)
    ..e<HeuristicRelevance>(5, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'relevance', $pb.PbFieldType.OE, defaultOrMaker: HeuristicRelevance.HEURISTIC_RELEVANCE_UNSPECIFIED, valueOf: HeuristicRelevance.valueOf, enumValues: HeuristicRelevance.values)
    ..hasRequiredFields = false
  ;
  ...
  'Use [GeneratedMessageGenericExtensions.rebuild] instead. '
  'Will be removed in next major version')
  ExplainedPolicy copyWith(void Function(ExplainedPolicy) updates) => super.copyWith((message) => updates(message as ExplainedPolicy)) as ExplainedPolicy; // ignore: deprecated_member_use
  $pb.BuilderInfo get info_ => _i;
  @$core.pragma('dart2js:noInline')
  ...
  @$pb.TagNumber(3)
  set policy($0.Policy v) { setField(3, v); }
  @$pb.TagNumber(3)
...
class BindingExplanation_AnnotatedMembership extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'BindingExplanation.AnnotatedMembership', package: const $pb.PackageName(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'google.cloud.policytroubleshooter.v1'), createEmptyInstance: create)
    ..e<BindingExplanation_Membership>(1, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'membership', $pb.PbFieldType.OE, defaultOrMaker: BindingExplanation_Membership.MEMBERSHIP_UNSPECIFIED, valueOf: BindingExplanation_Membership.valueOf, enumValues: BindingExplanation_Membership.values)
    ..e<HeuristicRelevance>(2, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'relevance', $pb.PbFieldType.OE, defaultOrMaker: HeuristicRelevance.HEURISTIC_RELEVANCE_UNSPECIFIED, valueOf: HeuristicRelevance.valueOf, enumValues: HeuristicRelevance.values)
    ..hasRequiredFields = false
  ;
  ...
  'Use [GeneratedMessageGenericExtensions.rebuild] instead. '
  'Will be removed in next major version')
  BindingExplanation_AnnotatedMembership copyWith(void Function(BindingExplanation_AnnotatedMembership) updates) => super.copyWith((message) => updates(message as BindingExplanation_AnnotatedMembership)) as BindingExplanation_AnnotatedMembership; // ignore: deprecated_member_use
  $pb.BuilderInfo get info_ => _i;
  @$core.pragma('dart2js:noInline')
...
class BindingExplanation extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'BindingExplanation', package: const $pb.PackageName(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'google.cloud.policytroubleshooter.v1'), createEmptyInstance: create)
    ..e<AccessState>(1, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'access', $pb.PbFieldType.OE, defaultOrMaker: AccessState.ACCESS_STATE_UNSPECIFIED, valueOf: AccessState.valueOf, enumValues: AccessState.values)
    ..aOS(2, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'role')
    ..e<BindingExplanation_RolePermission>(3, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'rolePermission', $pb.PbFieldType.OE, defaultOrMaker: BindingExplanation_RolePermission.ROLE_PERMISSION_UNSPECIFIED, valueOf: BindingExplanation_RolePermission.valueOf, enumValues: BindingExplanation_RolePermission.values)
    ..e<HeuristicRelevance>(4, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'rolePermissionRelevance', $pb.PbFieldType.OE, defaultOrMaker: HeuristicRelevance.HEURISTIC_RELEVANCE_UNSPECIFIED, valueOf: HeuristicRelevance.valueOf, enumValues: HeuristicRelevance.values)
    ..m<$core.String, BindingExplanation_AnnotatedMembership>(5, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'memberships', entryClassName: 'BindingExplanation.MembershipsEntry', keyFieldType: $pb.PbFieldType.OS, valueFieldType: $pb.PbFieldType.OM, valueCreator: BindingExplanation_AnnotatedMembership.create, packageName: const $pb.PackageName('google.cloud.policytroubleshooter.v1'))
    ..e<HeuristicRelevance>(6, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'relevance', $pb.PbFieldType.OE, defaultOrMaker: HeuristicRelevance.HEURISTIC_RELEVANCE_UNSPECIFIED, valueOf: HeuristicRelevance.valueOf, enumValues: HeuristicRelevance.values)
    ..aOM<$1.Expr>(7, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'condition', subBuilder: $1.Expr.create)
    ..hasRequiredFields = false
  ;
  ...
  'Use [GeneratedMessageGenericExtensions.rebuild] instead. '
  'Will be removed in next major version')
  BindingExplanation copyWith(void Function(BindingExplanation) updates) => super.copyWith((message) => updates(message as BindingExplanation)) as BindingExplanation; // ignore: deprecated_member_use
  $pb.BuilderInfo get info_ => _i;
  @$core.pragma('dart2js:noInline')
  ...
  @$pb.TagNumber(7)
  set condition($1.Expr v) { setField(7, v); }
  @$pb.TagNumber(7)

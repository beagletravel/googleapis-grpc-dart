...
class TroubleshootIamPolicyRequest extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'TroubleshootIamPolicyRequest', package: const $pb.PackageName(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'google.cloud.policytroubleshooter.v1'), createEmptyInstance: create)
    ..aOM<$1.AccessTuple>(1, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'accessTuple', subBuilder: $1.AccessTuple.create)
  ...
  'Will be removed in next major version')
  TroubleshootIamPolicyRequest copyWith(void Function(TroubleshootIamPolicyRequest) updates) => super.copyWith((message) => updates(message as TroubleshootIamPolicyRequest)) as TroubleshootIamPolicyRequest; // ignore: deprecated_member_use
  ...
  @$pb.TagNumber(1)
  set accessTuple($1.AccessTuple v) { setField(1, v); }
  @$pb.TagNumber(1)
...
class TroubleshootIamPolicyResponse extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'TroubleshootIamPolicyResponse', package: const $pb.PackageName(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'google.cloud.policytroubleshooter.v1'), createEmptyInstance: create)
    ..e<$1.AccessState>(1, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'access', $pb.PbFieldType.OE, defaultOrMaker: $1.AccessState.ACCESS_STATE_UNSPECIFIED, valueOf: $1.AccessState.valueOf, enumValues: $1.AccessState.values)
    ..pc<$1.ExplainedPolicy>(2, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'explainedPolicies', $pb.PbFieldType.PM, subBuilder: $1.ExplainedPolicy.create)
    ..hasRequiredFields = false
  ;
  ...
  'Use [GeneratedMessageGenericExtensions.rebuild] instead. '
  'Will be removed in next major version')
  TroubleshootIamPolicyResponse copyWith(void Function(TroubleshootIamPolicyResponse) updates) => super.copyWith((message) => updates(message as TroubleshootIamPolicyResponse)) as TroubleshootIamPolicyResponse; // ignore: deprecated_member_use
  $pb.BuilderInfo get info_ => _i;
  @$core.pragma('dart2js:noInline')
  ...
  @$pb.TagNumber(1)
  set access($1.AccessState v) { setField(1, v); }
  @$pb.TagNumber(1)

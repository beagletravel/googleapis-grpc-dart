...
final $typed_data.Uint8List listConfigsRequestDescriptor = $convert.base64Decode('ChJMaXN0Q29uZmlnc1JlcXVlc3QSFgoGcGFyZW50GAEgASgJUgZwYXJlbnQSGwoJcGFnZV9zaXplGAIgASgFUghwYWdlU2l6ZRIdCgpwYWdlX3Rva2VuGAMgASgJUglwYWdlVG9rZW4=');
...
final $typed_data.Uint8List listConfigsResponseDescriptor = $convert.base64Decode('ChNMaXN0Q29uZmlnc1Jlc3BvbnNlEksKB2NvbmZpZ3MYASADKAsyMS5nb29nbGUuY2xvdWQucnVudGltZWNvbmZpZy52MWJldGExLlJ1bnRpbWVDb25maWdSB2NvbmZpZ3MSJgoPbmV4dF9wYWdlX3Rva2VuGAIgASgJUg1uZXh0UGFnZVRva2Vu');
...
final $typed_data.Uint8List getConfigRequestDescriptor = $convert.base64Decode('ChBHZXRDb25maWdSZXF1ZXN0EhIKBG5hbWUYAiABKAlSBG5hbWU=');
...
final $typed_data.Uint8List createConfigRequestDescriptor = $convert.base64Decode('ChNDcmVhdGVDb25maWdSZXF1ZXN0EhYKBnBhcmVudBgBIAEoCVIGcGFyZW50EkkKBmNvbmZpZxgCIAEoCzIxLmdvb2dsZS5jbG91ZC5ydW50aW1lY29uZmlnLnYxYmV0YTEuUnVudGltZUNvbmZpZ1IGY29uZmlnEh0KCnJlcXVlc3RfaWQYAyABKAlSCXJlcXVlc3RJZA==');
...
final $typed_data.Uint8List updateConfigRequestDescriptor = $convert.base64Decode('ChNVcGRhdGVDb25maWdSZXF1ZXN0EhIKBG5hbWUYASABKAlSBG5hbWUSSQoGY29uZmlnGAIgASgLMjEuZ29vZ2xlLmNsb3VkLnJ1bnRpbWVjb25maWcudjFiZXRhMS5SdW50aW1lQ29uZmlnUgZjb25maWc=');
...
final $typed_data.Uint8List deleteConfigRequestDescriptor = $convert.base64Decode('ChNEZWxldGVDb25maWdSZXF1ZXN0EhIKBG5hbWUYASABKAlSBG5hbWU=');
...
final $typed_data.Uint8List listVariablesRequestDescriptor = $convert.base64Decode('ChRMaXN0VmFyaWFibGVzUmVxdWVzdBIWCgZwYXJlbnQYASABKAlSBnBhcmVudBIWCgZmaWx0ZXIYAiABKAlSBmZpbHRlchIbCglwYWdlX3NpemUYAyABKAVSCHBhZ2VTaXplEh0KCnBhZ2VfdG9rZW4YBCABKAlSCXBhZ2VUb2tlbhIjCg1yZXR1cm5fdmFsdWVzGAUgASgIUgxyZXR1cm5WYWx1ZXM=');
...
final $typed_data.Uint8List listVariablesResponseDescriptor = $convert.base64Decode('ChVMaXN0VmFyaWFibGVzUmVzcG9uc2USSgoJdmFyaWFibGVzGAEgAygLMiwuZ29vZ2xlLmNsb3VkLnJ1bnRpbWVjb25maWcudjFiZXRhMS5WYXJpYWJsZVIJdmFyaWFibGVzEiYKD25leHRfcGFnZV90b2tlbhgCIAEoCVINbmV4dFBhZ2VUb2tlbg==');
...
final $typed_data.Uint8List watchVariableRequestDescriptor = $convert.base64Decode('ChRXYXRjaFZhcmlhYmxlUmVxdWVzdBISCgRuYW1lGAEgASgJUgRuYW1lEjkKCm5ld2VyX3RoYW4YBCABKAsyGi5nb29nbGUucHJvdG9idWYuVGltZXN0YW1wUgluZXdlclRoYW4=');
...
final $typed_data.Uint8List getVariableRequestDescriptor = $convert.base64Decode('ChJHZXRWYXJpYWJsZVJlcXVlc3QSEgoEbmFtZRgBIAEoCVIEbmFtZQ==');
...
final $typed_data.Uint8List createVariableRequestDescriptor = $convert.base64Decode('ChVDcmVhdGVWYXJpYWJsZVJlcXVlc3QSFgoGcGFyZW50GAEgASgJUgZwYXJlbnQSSAoIdmFyaWFibGUYAiABKAsyLC5nb29nbGUuY2xvdWQucnVudGltZWNvbmZpZy52MWJldGExLlZhcmlhYmxlUgh2YXJpYWJsZRIdCgpyZXF1ZXN0X2lkGAMgASgJUglyZXF1ZXN0SWQ=');
...
final $typed_data.Uint8List updateVariableRequestDescriptor = $convert.base64Decode('ChVVcGRhdGVWYXJpYWJsZVJlcXVlc3QSEgoEbmFtZRgBIAEoCVIEbmFtZRJICgh2YXJpYWJsZRgCIAEoCzIsLmdvb2dsZS5jbG91ZC5ydW50aW1lY29uZmlnLnYxYmV0YTEuVmFyaWFibGVSCHZhcmlhYmxl');
...
final $typed_data.Uint8List deleteVariableRequestDescriptor = $convert.base64Decode('ChVEZWxldGVWYXJpYWJsZVJlcXVlc3QSEgoEbmFtZRgBIAEoCVIEbmFtZRIcCglyZWN1cnNpdmUYAiABKAhSCXJlY3Vyc2l2ZQ==');
...
final $typed_data.Uint8List listWaitersRequestDescriptor = $convert.base64Decode('ChJMaXN0V2FpdGVyc1JlcXVlc3QSFgoGcGFyZW50GAEgASgJUgZwYXJlbnQSGwoJcGFnZV9zaXplGAIgASgFUghwYWdlU2l6ZRIdCgpwYWdlX3Rva2VuGAMgASgJUglwYWdlVG9rZW4=');
...
final $typed_data.Uint8List listWaitersResponseDescriptor = $convert.base64Decode('ChNMaXN0V2FpdGVyc1Jlc3BvbnNlEkQKB3dhaXRlcnMYASADKAsyKi5nb29nbGUuY2xvdWQucnVudGltZWNvbmZpZy52MWJldGExLldhaXRlclIHd2FpdGVycxImCg9uZXh0X3BhZ2VfdG9rZW4YAiABKAlSDW5leHRQYWdlVG9rZW4=');
...
final $typed_data.Uint8List getWaiterRequestDescriptor = $convert.base64Decode('ChBHZXRXYWl0ZXJSZXF1ZXN0EhIKBG5hbWUYASABKAlSBG5hbWU=');
...
final $typed_data.Uint8List createWaiterRequestDescriptor = $convert.base64Decode('ChNDcmVhdGVXYWl0ZXJSZXF1ZXN0EhYKBnBhcmVudBgBIAEoCVIGcGFyZW50EkIKBndhaXRlchgCIAEoCzIqLmdvb2dsZS5jbG91ZC5ydW50aW1lY29uZmlnLnYxYmV0YTEuV2FpdGVyUgZ3YWl0ZXISHQoKcmVxdWVzdF9pZBgDIAEoCVIJcmVxdWVzdElk');
...
final $typed_data.Uint8List deleteWaiterRequestDescriptor = $convert.base64Decode('ChNEZWxldGVXYWl0ZXJSZXF1ZXN0EhIKBG5hbWUYASABKAlSBG5hbWU=');

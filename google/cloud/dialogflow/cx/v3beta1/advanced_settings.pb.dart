...
class AdvancedSettings_LoggingSettings extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'AdvancedSettings.LoggingSettings', package: const $pb.PackageName(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'google.cloud.dialogflow.cx.v3beta1'), createEmptyInstance: create)
    ..aOB(2, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'enableStackdriverLogging')
    ..aOB(3, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'enableInteractionLogging')
  ...
  'Will be removed in next major version')
  AdvancedSettings_LoggingSettings copyWith(void Function(AdvancedSettings_LoggingSettings) updates) => super.copyWith((message) => updates(message as AdvancedSettings_LoggingSettings)) as AdvancedSettings_LoggingSettings; // ignore: deprecated_member_use
...
class AdvancedSettings extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'AdvancedSettings', package: const $pb.PackageName(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'google.cloud.dialogflow.cx.v3beta1'), createEmptyInstance: create)
    ..aOM<AdvancedSettings_LoggingSettings>(6, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'loggingSettings', subBuilder: AdvancedSettings_LoggingSettings.create)
    ..hasRequiredFields = false
  ;
  ...
  'Use [GeneratedMessageGenericExtensions.rebuild] instead. '
  'Will be removed in next major version')
  AdvancedSettings copyWith(void Function(AdvancedSettings) updates) => super.copyWith((message) => updates(message as AdvancedSettings)) as AdvancedSettings; // ignore: deprecated_member_use
  $pb.BuilderInfo get info_ => _i;
  @$core.pragma('dart2js:noInline')

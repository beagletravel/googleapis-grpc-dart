...
class SecuritySettings_RedactionStrategy extends $pb.ProtobufEnum {
  static const SecuritySettings_RedactionStrategy REDACTION_STRATEGY_UNSPECIFIED = SecuritySettings_RedactionStrategy._(0, const $core.bool.fromEnvironment('protobuf.omit_enum_names') ? '' : 'REDACTION_STRATEGY_UNSPECIFIED');
  static const SecuritySettings_RedactionStrategy REDACT_WITH_SERVICE = SecuritySettings_RedactionStrategy._(1, const $core.bool.fromEnvironment('protobuf.omit_enum_names') ? '' : 'REDACT_WITH_SERVICE');
...
class SecuritySettings_RedactionScope extends $pb.ProtobufEnum {
  static const SecuritySettings_RedactionScope REDACTION_SCOPE_UNSPECIFIED = SecuritySettings_RedactionScope._(0, const $core.bool.fromEnvironment('protobuf.omit_enum_names') ? '' : 'REDACTION_SCOPE_UNSPECIFIED');
  static const SecuritySettings_RedactionScope REDACT_DISK_STORAGE = SecuritySettings_RedactionScope._(2, const $core.bool.fromEnvironment('protobuf.omit_enum_names') ? '' : 'REDACT_DISK_STORAGE');
...
class SecuritySettings_PurgeDataType extends $pb.ProtobufEnum {
  static const SecuritySettings_PurgeDataType PURGE_DATA_TYPE_UNSPECIFIED = SecuritySettings_PurgeDataType._(0, const $core.bool.fromEnvironment('protobuf.omit_enum_names') ? '' : 'PURGE_DATA_TYPE_UNSPECIFIED');
  static const SecuritySettings_PurgeDataType DIALOGFLOW_HISTORY = SecuritySettings_PurgeDataType._(1, const $core.bool.fromEnvironment('protobuf.omit_enum_names') ? '' : 'DIALOGFLOW_HISTORY');
...
class SecuritySettings_AudioExportSettings_AudioFormat extends $pb.ProtobufEnum {
  static const SecuritySettings_AudioExportSettings_AudioFormat AUDIO_FORMAT_UNSPECIFIED = SecuritySettings_AudioExportSettings_AudioFormat._(0, const $core.bool.fromEnvironment('protobuf.omit_enum_names') ? '' : 'AUDIO_FORMAT_UNSPECIFIED');
  static const SecuritySettings_AudioExportSettings_AudioFormat MULAW = SecuritySettings_AudioExportSettings_AudioFormat._(1, const $core.bool.fromEnvironment('protobuf.omit_enum_names') ? '' : 'MULAW');
  static const SecuritySettings_AudioExportSettings_AudioFormat MP3 = SecuritySettings_AudioExportSettings_AudioFormat._(2, const $core.bool.fromEnvironment('protobuf.omit_enum_names') ? '' : 'MP3');
  static const SecuritySettings_AudioExportSettings_AudioFormat OGG = SecuritySettings_AudioExportSettings_AudioFormat._(3, const $core.bool.fromEnvironment('protobuf.omit_enum_names') ? '' : 'OGG');

...
const Webhook$json = const {
  ...
  '2': const [
    ...
    const {'1': 'service_directory', '3': 7, '4': 1, '5': 11, '6': '.google.cloud.dialogflow.cx.v3beta1.Webhook.ServiceDirectoryConfig', '9': 0, '10': 'serviceDirectory'},
...
final $typed_data.Uint8List listWebhooksResponseDescriptor = $convert.base64Decode('ChRMaXN0V2ViaG9va3NSZXNwb25zZRJHCgh3ZWJob29rcxgBIAMoCzIrLmdvb2dsZS5jbG91ZC5kaWFsb2dmbG93LmN4LnYzYmV0YTEuV2ViaG9va1IId2ViaG9va3MSJgoPbmV4dF9wYWdlX3Rva2VuGAIgASgJUg1uZXh0UGFnZVRva2Vu');
...
final $typed_data.Uint8List createWebhookRequestDescriptor = $convert.base64Decode('ChRDcmVhdGVXZWJob29rUmVxdWVzdBJBCgZwYXJlbnQYASABKAlCKeBBAvpBIxIhZGlhbG9nZmxvdy5nb29nbGVhcGlzLmNvbS9XZWJob29rUgZwYXJlbnQSSgoHd2ViaG9vaxgCIAEoCzIrLmdvb2dsZS5jbG91ZC5kaWFsb2dmbG93LmN4LnYzYmV0YTEuV2ViaG9va0ID4EECUgd3ZWJob29r');
...
final $typed_data.Uint8List updateWebhookRequestDescriptor = $convert.base64Decode('ChRVcGRhdGVXZWJob29rUmVxdWVzdBJKCgd3ZWJob29rGAEgASgLMisuZ29vZ2xlLmNsb3VkLmRpYWxvZ2Zsb3cuY3gudjNiZXRhMS5XZWJob29rQgPgQQJSB3dlYmhvb2sSOwoLdXBkYXRlX21hc2sYAiABKAsyGi5nb29nbGUucHJvdG9idWYuRmllbGRNYXNrUgp1cGRhdGVNYXNr');
...
final $typed_data.Uint8List webhookResponseDescriptor = $convert.base64Decode('');
...
final $typed_data.Uint8List pageInfoDescriptor = $convert.base64Decode('');
...
final $typed_data.Uint8List sessionInfoDescriptor = $convert.base64Decode('');

...
class TransitionRouteGroup extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'TransitionRouteGroup', package: const $pb.PackageName(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'google.cloud.dialogflow.cx.v3beta1'), createEmptyInstance: create)
    ..aOS(1, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'name')
    ..aOS(2, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'displayName')
    ..pc<$0.TransitionRoute>(5, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'transitionRoutes', $pb.PbFieldType.PM, subBuilder: $0.TransitionRoute.create)
  ...
  'Will be removed in next major version')
  TransitionRouteGroup copyWith(void Function(TransitionRouteGroup) updates) => super.copyWith((message) => updates(message as TransitionRouteGroup)) as TransitionRouteGroup; // ignore: deprecated_member_use
...
class ListTransitionRouteGroupsRequest extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'ListTransitionRouteGroupsRequest', package: const $pb.PackageName(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'google.cloud.dialogflow.cx.v3beta1'), createEmptyInstance: create)
  ...
  'Use [GeneratedMessageGenericExtensions.rebuild] instead. '
  'Will be removed in next major version')
  ListTransitionRouteGroupsRequest copyWith(void Function(ListTransitionRouteGroupsRequest) updates) => super.copyWith((message) => updates(message as ListTransitionRouteGroupsRequest)) as ListTransitionRouteGroupsRequest; // ignore: deprecated_member_use
  $pb.BuilderInfo get info_ => _i;
  @$core.pragma('dart2js:noInline')
...
class ListTransitionRouteGroupsResponse extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'ListTransitionRouteGroupsResponse', package: const $pb.PackageName(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'google.cloud.dialogflow.cx.v3beta1'), createEmptyInstance: create)
    ..pc<TransitionRouteGroup>(1, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'transitionRouteGroups', $pb.PbFieldType.PM, subBuilder: TransitionRouteGroup.create)
  ...
  'Use [GeneratedMessageGenericExtensions.rebuild] instead. '
  'Will be removed in next major version')
  ListTransitionRouteGroupsResponse copyWith(void Function(ListTransitionRouteGroupsResponse) updates) => super.copyWith((message) => updates(message as ListTransitionRouteGroupsResponse)) as ListTransitionRouteGroupsResponse; // ignore: deprecated_member_use
  $pb.BuilderInfo get info_ => _i;
  @$core.pragma('dart2js:noInline')
...
class GetTransitionRouteGroupRequest extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'GetTransitionRouteGroupRequest', package: const $pb.PackageName(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'google.cloud.dialogflow.cx.v3beta1'), createEmptyInstance: create)
    ..aOS(1, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'name')
  ...
  'Use [GeneratedMessageGenericExtensions.rebuild] instead. '
  'Will be removed in next major version')
  GetTransitionRouteGroupRequest copyWith(void Function(GetTransitionRouteGroupRequest) updates) => super.copyWith((message) => updates(message as GetTransitionRouteGroupRequest)) as GetTransitionRouteGroupRequest; // ignore: deprecated_member_use
  $pb.BuilderInfo get info_ => _i;
  @$core.pragma('dart2js:noInline')
...
class CreateTransitionRouteGroupRequest extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'CreateTransitionRouteGroupRequest', package: const $pb.PackageName(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'google.cloud.dialogflow.cx.v3beta1'), createEmptyInstance: create)
    ..aOS(1, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'parent')
    ..aOM<TransitionRouteGroup>(2, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'transitionRouteGroup', subBuilder: TransitionRouteGroup.create)
  ...
  'Use [GeneratedMessageGenericExtensions.rebuild] instead. '
  'Will be removed in next major version')
  CreateTransitionRouteGroupRequest copyWith(void Function(CreateTransitionRouteGroupRequest) updates) => super.copyWith((message) => updates(message as CreateTransitionRouteGroupRequest)) as CreateTransitionRouteGroupRequest; // ignore: deprecated_member_use
  $pb.BuilderInfo get info_ => _i;
  @$core.pragma('dart2js:noInline')
...
class UpdateTransitionRouteGroupRequest extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'UpdateTransitionRouteGroupRequest', package: const $pb.PackageName(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'google.cloud.dialogflow.cx.v3beta1'), createEmptyInstance: create)
    ..aOM<TransitionRouteGroup>(1, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'transitionRouteGroup', subBuilder: TransitionRouteGroup.create)
  ...
  'Use [GeneratedMessageGenericExtensions.rebuild] instead. '
  'Will be removed in next major version')
  UpdateTransitionRouteGroupRequest copyWith(void Function(UpdateTransitionRouteGroupRequest) updates) => super.copyWith((message) => updates(message as UpdateTransitionRouteGroupRequest)) as UpdateTransitionRouteGroupRequest; // ignore: deprecated_member_use
  $pb.BuilderInfo get info_ => _i;
  @$core.pragma('dart2js:noInline')
...
class DeleteTransitionRouteGroupRequest extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'DeleteTransitionRouteGroupRequest', package: const $pb.PackageName(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'google.cloud.dialogflow.cx.v3beta1'), createEmptyInstance: create)
    ..aOS(1, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'name')
  ...
  'Use [GeneratedMessageGenericExtensions.rebuild] instead. '
  'Will be removed in next major version')
  DeleteTransitionRouteGroupRequest copyWith(void Function(DeleteTransitionRouteGroupRequest) updates) => super.copyWith((message) => updates(message as DeleteTransitionRouteGroupRequest)) as DeleteTransitionRouteGroupRequest; // ignore: deprecated_member_use
  $pb.BuilderInfo get info_ => _i;
  @$core.pragma('dart2js:noInline')

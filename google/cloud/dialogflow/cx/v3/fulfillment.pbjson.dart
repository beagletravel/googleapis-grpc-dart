...
const Fulfillment$json = const {
  ...
  '2': const [
    ...
    const {'1': 'return_partial_responses', '3': 8, '4': 1, '5': 8, '10': 'returnPartialResponses'},
    const {'1': 'tag', '3': 3, '4': 1, '5': 9, '10': 'tag'},
    const {'1': 'set_parameter_actions', '3': 4, '4': 3, '5': 11, '6': '.google.cloud.dialogflow.cx.v3.Fulfillment.SetParameterAction', '10': 'setParameterActions'},
    const {'1': 'conditional_cases', '3': 5, '4': 3, '5': 11, '6': '.google.cloud.dialogflow.cx.v3.Fulfillment.ConditionalCases', '10': 'conditionalCases'},
  ],
...
const Fulfillment_ConditionalCases$json = const {
  '1': 'ConditionalCases',
  '2': const [
    const {'1': 'cases', '3': 1, '4': 3, '5': 11, '6': '.google.cloud.dialogflow.cx.v3.Fulfillment.ConditionalCases.Case', '10': 'cases'},
  ],
...
const Fulfillment_ConditionalCases_Case$json = const {
  ...
  '2': const [
    ...
    const {'1': 'case_content', '3': 2, '4': 3, '5': 11, '6': '.google.cloud.dialogflow.cx.v3.Fulfillment.ConditionalCases.Case.CaseContent', '10': 'caseContent'},
  ],
...
const Fulfillment_ConditionalCases_Case_CaseContent$json = const {
  '1': 'CaseContent',
  '2': const [
    const {'1': 'message', '3': 1, '4': 1, '5': 11, '6': '.google.cloud.dialogflow.cx.v3.ResponseMessage', '9': 0, '10': 'message'},
    const {'1': 'additional_cases', '3': 2, '4': 1, '5': 11, '6': '.google.cloud.dialogflow.cx.v3.Fulfillment.ConditionalCases', '9': 0, '10': 'additionalCases'},
  ],
  '8': const [

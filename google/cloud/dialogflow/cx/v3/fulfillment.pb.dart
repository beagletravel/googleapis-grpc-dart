...
import 'response_message.pb.dart' as $0;
import '../../../../protobuf/struct.pb.dart' as $1;

class Fulfillment_SetParameterAction extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'Fulfillment.SetParameterAction', package: const $pb.PackageName(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'google.cloud.dialogflow.cx.v3'), createEmptyInstance: create)
  ...
  'Will be removed in next major version')
  Fulfillment_SetParameterAction copyWith(void Function(Fulfillment_SetParameterAction) updates) => super.copyWith((message) => updates(message as Fulfillment_SetParameterAction)) as Fulfillment_SetParameterAction; // ignore: deprecated_member_use
...
class Fulfillment_ConditionalCases_Case_CaseContent extends $pb.GeneratedMessage {
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'Fulfillment.ConditionalCases.Case.CaseContent', package: const $pb.PackageName(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'google.cloud.dialogflow.cx.v3'), createEmptyInstance: create)
    ..oo(0, [1, 2])
    ..aOM<$0.ResponseMessage>(1, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'message', subBuilder: $0.ResponseMessage.create)
    ..aOM<Fulfillment_ConditionalCases>(2, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'additionalCases', subBuilder: Fulfillment_ConditionalCases.create)
    ..hasRequiredFields = false
  ;

  Fulfillment_ConditionalCases_Case_CaseContent._() : super();
  factory Fulfillment_ConditionalCases_Case_CaseContent({
    $0.ResponseMessage? message,
  ...
  'Use [GeneratedMessageGenericExtensions.rebuild] instead. '
  'Will be removed in next major version')
  Fulfillment_ConditionalCases_Case_CaseContent copyWith(void Function(Fulfillment_ConditionalCases_Case_CaseContent) updates) => super.copyWith((message) => updates(message as Fulfillment_ConditionalCases_Case_CaseContent)) as Fulfillment_ConditionalCases_Case_CaseContent; // ignore: deprecated_member_use
  $pb.BuilderInfo get info_ => _i;
  @$core.pragma('dart2js:noInline')
  ...
  @$pb.TagNumber(1)
  $0.ResponseMessage get message => $_getN(0);
  @$pb.TagNumber(1)
  set message($0.ResponseMessage v) { setField(1, v); }
  @$pb.TagNumber(1)
  $core.bool hasMessage() => $_has(0);
  @$pb.TagNumber(1)
  void clearMessage() => clearField(1);
  @$pb.TagNumber(1)
  $0.ResponseMessage ensureMessage() => $_ensure(0);
...
class Fulfillment_ConditionalCases_Case extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'Fulfillment.ConditionalCases.Case', package: const $pb.PackageName(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'google.cloud.dialogflow.cx.v3'), createEmptyInstance: create)
    ..aOS(1, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'condition')
    ..pc<Fulfillment_ConditionalCases_Case_CaseContent>(2, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'caseContent', $pb.PbFieldType.PM, subBuilder: Fulfillment_ConditionalCases_Case_CaseContent.create)
    ..hasRequiredFields = false
  ;
  ...
  'Use [GeneratedMessageGenericExtensions.rebuild] instead. '
  'Will be removed in next major version')
  Fulfillment_ConditionalCases_Case copyWith(void Function(Fulfillment_ConditionalCases_Case) updates) => super.copyWith((message) => updates(message as Fulfillment_ConditionalCases_Case)) as Fulfillment_ConditionalCases_Case; // ignore: deprecated_member_use
  $pb.BuilderInfo get info_ => _i;
  @$core.pragma('dart2js:noInline')
...
class Fulfillment_ConditionalCases extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'Fulfillment.ConditionalCases', package: const $pb.PackageName(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'google.cloud.dialogflow.cx.v3'), createEmptyInstance: create)
    ..pc<Fulfillment_ConditionalCases_Case>(1, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'cases', $pb.PbFieldType.PM, subBuilder: Fulfillment_ConditionalCases_Case.create)
    ..hasRequiredFields = false
  ;
  ...
  'Use [GeneratedMessageGenericExtensions.rebuild] instead. '
  'Will be removed in next major version')
  Fulfillment_ConditionalCases copyWith(void Function(Fulfillment_ConditionalCases) updates) => super.copyWith((message) => updates(message as Fulfillment_ConditionalCases)) as Fulfillment_ConditionalCases; // ignore: deprecated_member_use
  $pb.BuilderInfo get info_ => _i;
  @$core.pragma('dart2js:noInline')
...
class Fulfillment extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'Fulfillment', package: const $pb.PackageName(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'google.cloud.dialogflow.cx.v3'), createEmptyInstance: create)
    ..pc<$0.ResponseMessage>(1, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'messages', $pb.PbFieldType.PM, subBuilder: $0.ResponseMessage.create)
    ..aOS(2, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'webhook')
    ...
    ..aOB(8, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'returnPartialResponses')
    ..hasRequiredFields = false
  ;

  Fulfillment._() : super();
  factory Fulfillment({
    $core.Iterable<$0.ResponseMessage>? messages,
    $core.String? webhook,
    $core.String? tag,
    ...
    if (returnPartialResponses != null) {
      _result.returnPartialResponses = returnPartialResponses;
    }
    return _result;
  }
  ...
  'Use [GeneratedMessageGenericExtensions.rebuild] instead. '
  'Will be removed in next major version')
  Fulfillment copyWith(void Function(Fulfillment) updates) => super.copyWith((message) => updates(message as Fulfillment)) as Fulfillment; // ignore: deprecated_member_use
  $pb.BuilderInfo get info_ => _i;
  @$core.pragma('dart2js:noInline')
  ...
  @$pb.TagNumber(1)
  $core.List<$0.ResponseMessage> get messages => $_getList(0);
  ...
  @$pb.TagNumber(8)
  $core.bool get returnPartialResponses => $_getBF(5);
  @$pb.TagNumber(8)
  set returnPartialResponses($core.bool v) { $_setBool(5, v); }
  @$pb.TagNumber(8)
  $core.bool hasReturnPartialResponses() => $_has(5);
  @$pb.TagNumber(8)

...
const EntityType$json = const {
  ...
  '2': const [
    ...
    const {'1': 'kind', '3': 3, '4': 1, '5': 14, '6': '.google.cloud.dialogflow.cx.v3.EntityType.Kind', '8': const {}, '10': 'kind'},
    const {'1': 'auto_expansion_mode', '3': 4, '4': 1, '5': 14, '6': '.google.cloud.dialogflow.cx.v3.EntityType.AutoExpansionMode', '10': 'autoExpansionMode'},
    const {'1': 'entities', '3': 5, '4': 3, '5': 11, '6': '.google.cloud.dialogflow.cx.v3.EntityType.Entity', '10': 'entities'},
    const {'1': 'excluded_phrases', '3': 6, '4': 3, '5': 11, '6': '.google.cloud.dialogflow.cx.v3.EntityType.ExcludedPhrase', '10': 'excludedPhrases'},
...
const ListEntityTypesResponse$json = const {
  ...
  '2': const [
    const {'1': 'entity_types', '3': 1, '4': 3, '5': 11, '6': '.google.cloud.dialogflow.cx.v3.EntityType', '10': 'entityTypes'},
    const {'1': 'next_page_token', '3': 2, '4': 1, '5': 9, '10': 'nextPageToken'},
  ],
};

/// Descriptor for `ListEntityTypesResponse`. Decode as a `google.protobuf.DescriptorProto`.
final $typed_data.Uint8List listEntityTypesResponseDescriptor = $convert.base64Decode('ChdMaXN0RW50aXR5VHlwZXNSZXNwb25zZRJMCgxlbnRpdHlfdHlwZXMYASADKAsyKS5nb29nbGUuY2xvdWQuZGlhbG9nZmxvdy5jeC52My5FbnRpdHlUeXBlUgtlbnRpdHlUeXBlcxImCg9uZXh0X3BhZ2VfdG9rZW4YAiABKAlSDW5leHRQYWdlVG9rZW4=');
...
const CreateEntityTypeRequest$json = const {
  ...
  '2': const [
    const {'1': 'parent', '3': 1, '4': 1, '5': 9, '8': const {}, '10': 'parent'},
    const {'1': 'entity_type', '3': 2, '4': 1, '5': 11, '6': '.google.cloud.dialogflow.cx.v3.EntityType', '8': const {}, '10': 'entityType'},
...
final $typed_data.Uint8List createEntityTypeRequestDescriptor = $convert.base64Decode('');
...
const UpdateEntityTypeRequest$json = const {
  ...
  '2': const [
    const {'1': 'entity_type', '3': 1, '4': 1, '5': 11, '6': '.google.cloud.dialogflow.cx.v3.EntityType', '8': const {}, '10': 'entityType'},
    const {'1': 'language_code', '3': 2, '4': 1, '5': 9, '10': 'languageCode'},
...
final $typed_data.Uint8List updateEntityTypeRequestDescriptor = $convert.base64Decode('');

...
const Agent$json = const {
  ...
  '2': const [
    ...
    const {'1': 'speech_to_text_settings', '3': 13, '4': 1, '5': 11, '6': '.google.cloud.dialogflow.cx.v3.SpeechToTextSettings', '10': 'speechToTextSettings'},
    ...
    const {'1': 'advanced_settings', '3': 22, '4': 1, '5': 11, '6': '.google.cloud.dialogflow.cx.v3.AdvancedSettings', '10': 'advancedSettings'},
  ],
  '7': const {},
};

/// Descriptor for `Agent`. Decode as a `google.protobuf.DescriptorProto`.
final $typed_data.Uint8List agentDescriptor = $convert.base64Decode('');
...
const ListAgentsResponse$json = const {
  ...
  '2': const [
    const {'1': 'agents', '3': 1, '4': 3, '5': 11, '6': '.google.cloud.dialogflow.cx.v3.Agent', '10': 'agents'},
    const {'1': 'next_page_token', '3': 2, '4': 1, '5': 9, '10': 'nextPageToken'},
  ],
};

/// Descriptor for `ListAgentsResponse`. Decode as a `google.protobuf.DescriptorProto`.
final $typed_data.Uint8List listAgentsResponseDescriptor = $convert.base64Decode('ChJMaXN0QWdlbnRzUmVzcG9uc2USPAoGYWdlbnRzGAEgAygLMiQuZ29vZ2xlLmNsb3VkLmRpYWxvZ2Zsb3cuY3gudjMuQWdlbnRSBmFnZW50cxImCg9uZXh0X3BhZ2VfdG9rZW4YAiABKAlSDW5leHRQYWdlVG9rZW4=');
...
const CreateAgentRequest$json = const {
  ...
  '2': const [
    const {'1': 'parent', '3': 1, '4': 1, '5': 9, '8': const {}, '10': 'parent'},
    const {'1': 'agent', '3': 2, '4': 1, '5': 11, '6': '.google.cloud.dialogflow.cx.v3.Agent', '8': const {}, '10': 'agent'},
  ],
};

/// Descriptor for `CreateAgentRequest`. Decode as a `google.protobuf.DescriptorProto`.
final $typed_data.Uint8List createAgentRequestDescriptor = $convert.base64Decode('ChJDcmVhdGVBZ2VudFJlcXVlc3QSPwoGcGFyZW50GAEgASgJQifgQQL6QSESH2RpYWxvZ2Zsb3cuZ29vZ2xlYXBpcy5jb20vQWdlbnRSBnBhcmVudBI/CgVhZ2VudBgCIAEoCzIkLmdvb2dsZS5jbG91ZC5kaWFsb2dmbG93LmN4LnYzLkFnZW50QgPgQQJSBWFnZW50');
@$core.Deprecated('Use updateAgentRequestDescriptor instead')
const UpdateAgentRequest$json = const {
  '1': 'UpdateAgentRequest',
  '2': const [
    const {'1': 'agent', '3': 1, '4': 1, '5': 11, '6': '.google.cloud.dialogflow.cx.v3.Agent', '8': const {}, '10': 'agent'},
    const {'1': 'update_mask', '3': 2, '4': 1, '5': 11, '6': '.google.protobuf.FieldMask', '10': 'updateMask'},
  ],
};

/// Descriptor for `UpdateAgentRequest`. Decode as a `google.protobuf.DescriptorProto`.
final $typed_data.Uint8List updateAgentRequestDescriptor = $convert.base64Decode('ChJVcGRhdGVBZ2VudFJlcXVlc3QSPwoFYWdlbnQYASABKAsyJC5nb29nbGUuY2xvdWQuZGlhbG9nZmxvdy5jeC52My5BZ2VudEID4EECUgVhZ2VudBI7Cgt1cGRhdGVfbWFzaxgCIAEoCzIaLmdvb2dsZS5wcm90b2J1Zi5GaWVsZE1hc2tSCnVwZGF0ZU1hc2s=');
...
const ExportAgentRequest$json = const {
  ...
  '2': const [
    ...
    const {'1': 'data_format', '3': 3, '4': 1, '5': 14, '6': '.google.cloud.dialogflow.cx.v3.ExportAgentRequest.DataFormat', '8': const {}, '10': 'dataFormat'},
...
final $typed_data.Uint8List exportAgentRequestDescriptor = $convert.base64Decode('');
...
const RestoreAgentRequest$json = const {
  ...
  '2': const [
    ...
    const {'1': 'restore_option', '3': 5, '4': 1, '5': 14, '6': '.google.cloud.dialogflow.cx.v3.RestoreAgentRequest.RestoreOption', '10': 'restoreOption'},
  ],
...
final $typed_data.Uint8List restoreAgentRequestDescriptor = $convert.base64Decode('');
...
const AgentValidationResult$json = const {
  ...
  '2': const [
    const {'1': 'name', '3': 1, '4': 1, '5': 9, '10': 'name'},
    const {'1': 'flow_validation_results', '3': 2, '4': 3, '5': 11, '6': '.google.cloud.dialogflow.cx.v3.FlowValidationResult', '10': 'flowValidationResults'},
  ],
  '7': const {},
};

/// Descriptor for `AgentValidationResult`. Decode as a `google.protobuf.DescriptorProto`.
final $typed_data.Uint8List agentValidationResultDescriptor = $convert.base64Decode('');

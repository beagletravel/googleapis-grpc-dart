...
const Intent$json = const {
  ...
  '2': const [
    ...
    const {'1': 'labels', '3': 7, '4': 3, '5': 11, '6': '.google.cloud.dialogflow.cx.v3.Intent.LabelsEntry', '10': 'labels'},
...
final $typed_data.Uint8List intentDescriptor = $convert.base64Decode('');
...
final $typed_data.Uint8List listIntentsRequestDescriptor = $convert.base64Decode('');
...
final $typed_data.Uint8List listIntentsResponseDescriptor = $convert.base64Decode('ChNMaXN0SW50ZW50c1Jlc3BvbnNlEj8KB2ludGVudHMYASADKAsyJS5nb29nbGUuY2xvdWQuZGlhbG9nZmxvdy5jeC52My5JbnRlbnRSB2ludGVudHMSJgoPbmV4dF9wYWdlX3Rva2VuGAIgASgJUg1uZXh0UGFnZVRva2Vu');
...
final $typed_data.Uint8List createIntentRequestDescriptor = $convert.base64Decode('');
...
final $typed_data.Uint8List updateIntentRequestDescriptor = $convert.base64Decode('ChNVcGRhdGVJbnRlbnRSZXF1ZXN0EkIKBmludGVudBgBIAEoCzIlLmdvb2dsZS5jbG91ZC5kaWFsb2dmbG93LmN4LnYzLkludGVudEID4EECUgZpbnRlbnQSIwoNbGFuZ3VhZ2VfY29kZRgCIAEoCVIMbGFuZ3VhZ2VDb2RlEjsKC3VwZGF0ZV9tYXNrGAMgASgLMhouZ29vZ2xlLnByb3RvYnVmLkZpZWxkTWFza1IKdXBkYXRlTWFzaw==');

...
class DetectIntentRequest extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'DetectIntentRequest', package: const $pb.PackageName(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'google.cloud.dialogflow.v2'), createEmptyInstance: create)
    ...
    ..aOM<$7.OutputAudioConfig>(4, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'outputAudioConfig', subBuilder: $7.OutputAudioConfig.create)
    ..a<$core.List<$core.int>>(5, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'inputAudio', $pb.PbFieldType.OY)
    ..aOM<$8.FieldMask>(7, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'outputAudioConfigMask', subBuilder: $8.FieldMask.create)
  ...
  factory DetectIntentRequest({
    ...
    $8.FieldMask? outputAudioConfigMask,
  }) {
  ...
  @$pb.TagNumber(4)
  set outputAudioConfig($7.OutputAudioConfig v) { setField(4, v); }
  @$pb.TagNumber(4)
  $core.bool hasOutputAudioConfig() => $_has(3);
  @$pb.TagNumber(4)
  void clearOutputAudioConfig() => clearField(4);
  @$pb.TagNumber(4)
  $7.OutputAudioConfig ensureOutputAudioConfig() => $_ensure(3);
  ...
  @$pb.TagNumber(7)
  $8.FieldMask get outputAudioConfigMask => $_getN(5);
  @$pb.TagNumber(7)
  set outputAudioConfigMask($8.FieldMask v) { setField(7, v); }
  @$pb.TagNumber(7)
  $core.bool hasOutputAudioConfigMask() => $_has(5);
  @$pb.TagNumber(7)
  void clearOutputAudioConfigMask() => clearField(7);
  @$pb.TagNumber(7)
  $8.FieldMask ensureOutputAudioConfigMask() => $_ensure(5);
}

class DetectIntentResponse extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'DetectIntentResponse', package: const $pb.PackageName(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'google.cloud.dialogflow.v2'), createEmptyInstance: create)
    ...
    ..aOM<$9.Status>(3, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'webhookStatus', subBuilder: $9.Status.create)
    ..a<$core.List<$core.int>>(4, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'outputAudio', $pb.PbFieldType.OY)
    ..aOM<$7.OutputAudioConfig>(6, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'outputAudioConfig', subBuilder: $7.OutputAudioConfig.create)
    ..hasRequiredFields = false
  ;
  ...
  @$pb.TagNumber(3)
  set webhookStatus($9.Status v) { setField(3, v); }
  @$pb.TagNumber(3)
  $core.bool hasWebhookStatus() => $_has(2);
  @$pb.TagNumber(3)
  void clearWebhookStatus() => clearField(3);
  @$pb.TagNumber(3)
  $9.Status ensureWebhookStatus() => $_ensure(2);
  ...
  @$pb.TagNumber(6)
  set outputAudioConfig($7.OutputAudioConfig v) { setField(6, v); }
  @$pb.TagNumber(6)
  $core.bool hasOutputAudioConfig() => $_has(4);
  @$pb.TagNumber(6)
  void clearOutputAudioConfig() => clearField(6);
  @$pb.TagNumber(6)
  $7.OutputAudioConfig ensureOutputAudioConfig() => $_ensure(4);
}

class QueryParameters extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'QueryParameters', package: const $pb.PackageName(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'google.cloud.dialogflow.v2'), createEmptyInstance: create)
    ..aOS(1, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'timeZone')
    ..aOM<$10.LatLng>(2, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'geoLocation', subBuilder: $10.LatLng.create)
    ..pc<$0.Context>(3, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'contexts', $pb.PbFieldType.PM, subBuilder: $0.Context.create)
    ..aOB(4, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'resetContexts')
    ..pc<$5.SessionEntityType>(5, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'sessionEntityTypes', $pb.PbFieldType.PM, subBuilder: $5.SessionEntityType.create)
    ..aOM<$11.Struct>(6, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'payload', subBuilder: $11.Struct.create)
  ...
  factory QueryParameters({
    ...
    $10.LatLng? geoLocation,
    $core.Iterable<$0.Context>? contexts,
    $core.bool? resetContexts,
    $core.Iterable<$5.SessionEntityType>? sessionEntityTypes,
    $11.Struct? payload,
  ...
  @$pb.TagNumber(2)
  set geoLocation($10.LatLng v) { setField(2, v); }
  @$pb.TagNumber(2)
  $core.bool hasGeoLocation() => $_has(1);
  @$pb.TagNumber(2)
  void clearGeoLocation() => clearField(2);
  @$pb.TagNumber(2)
  $10.LatLng ensureGeoLocation() => $_ensure(1);
  ...
  @$pb.TagNumber(6)
  set payload($11.Struct v) { setField(6, v); }
  @$pb.TagNumber(6)
  $core.bool hasPayload() => $_has(5);
  @$pb.TagNumber(6)
  void clearPayload() => clearField(6);
  @$pb.TagNumber(6)
  $11.Struct ensurePayload() => $_ensure(5);
...
class QueryInput extends $pb.GeneratedMessage {
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'QueryInput', package: const $pb.PackageName(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'google.cloud.dialogflow.v2'), createEmptyInstance: create)
    ..oo(0, [1, 2, 3])
    ..aOM<$7.InputAudioConfig>(1, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'audioConfig', subBuilder: $7.InputAudioConfig.create)
  ...
  QueryInput._() : super();
  factory QueryInput({
    $7.InputAudioConfig? audioConfig,
    TextInput? text,
    EventInput? event,
  }) {
    final _result = create();
  ...
  @$pb.TagNumber(1)
  set audioConfig($7.InputAudioConfig v) { setField(1, v); }
  @$pb.TagNumber(1)
  $core.bool hasAudioConfig() => $_has(0);
  @$pb.TagNumber(1)
  void clearAudioConfig() => clearField(1);
  @$pb.TagNumber(1)
  $7.InputAudioConfig ensureAudioConfig() => $_ensure(0);
...
class QueryResult extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'QueryResult', package: const $pb.PackageName(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'google.cloud.dialogflow.v2'), createEmptyInstance: create)
    ...
    ..aOM<$11.Struct>(4, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'parameters', subBuilder: $11.Struct.create)
    ...
    ..pc<$3.Intent_Message>(7, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'fulfillmentMessages', $pb.PbFieldType.PM, subBuilder: $3.Intent_Message.create)
    ..aOS(8, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'webhookSource')
    ..aOM<$11.Struct>(9, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'webhookPayload', subBuilder: $11.Struct.create)
    ..pc<$0.Context>(10, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'outputContexts', $pb.PbFieldType.PM, subBuilder: $0.Context.create)
    ..aOM<$3.Intent>(11, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'intent', subBuilder: $3.Intent.create)
    ..a<$core.double>(12, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'intentDetectionConfidence', $pb.PbFieldType.OF)
    ..aOM<$11.Struct>(14, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'diagnosticInfo', subBuilder: $11.Struct.create)
  ...
  factory QueryResult({
    ...
    $core.Iterable<$3.Intent_Message>? fulfillmentMessages,
    $core.String? webhookSource,
    $11.Struct? webhookPayload,
  ...
  @$pb.TagNumber(4)
  set parameters($11.Struct v) { setField(4, v); }
  @$pb.TagNumber(4)
  $core.bool hasParameters() => $_has(3);
  @$pb.TagNumber(4)
  void clearParameters() => clearField(4);
  @$pb.TagNumber(4)
  $11.Struct ensureParameters() => $_ensure(3);
  ...
  @$pb.TagNumber(9)
  set webhookPayload($11.Struct v) { setField(9, v); }
  @$pb.TagNumber(9)
  $core.bool hasWebhookPayload() => $_has(8);
  @$pb.TagNumber(9)
  void clearWebhookPayload() => clearField(9);
  @$pb.TagNumber(9)
  $11.Struct ensureWebhookPayload() => $_ensure(8);
  ...
  @$pb.TagNumber(11)
  set intent($3.Intent v) { setField(11, v); }
  @$pb.TagNumber(11)
  $core.bool hasIntent() => $_has(10);
  @$pb.TagNumber(11)
  void clearIntent() => clearField(11);
  @$pb.TagNumber(11)
  $3.Intent ensureIntent() => $_ensure(10);
  ...
  @$pb.TagNumber(14)
  set diagnosticInfo($11.Struct v) { setField(14, v); }
  @$pb.TagNumber(14)
  $core.bool hasDiagnosticInfo() => $_has(12);
  @$pb.TagNumber(14)
  void clearDiagnosticInfo() => clearField(14);
  @$pb.TagNumber(14)
  $11.Struct ensureDiagnosticInfo() => $_ensure(12);
...
class StreamingDetectIntentRequest extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'StreamingDetectIntentRequest', package: const $pb.PackageName(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'google.cloud.dialogflow.v2'), createEmptyInstance: create)
    ..aOS(1, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'session')
    ..aOM<QueryParameters>(2, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'queryParams', subBuilder: QueryParameters.create)
    ..aOM<QueryInput>(3, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'queryInput', subBuilder: QueryInput.create)
    ..aOB(4, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'singleUtterance')
    ..aOM<$7.OutputAudioConfig>(5, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'outputAudioConfig', subBuilder: $7.OutputAudioConfig.create)
  ...
  $7.OutputAudioConfig get outputAudioConfig => $_getN(4);
  @$pb.TagNumber(5)
  set outputAudioConfig($7.OutputAudioConfig v) { setField(5, v); }
  @$pb.TagNumber(5)
  $core.bool hasOutputAudioConfig() => $_has(4);
  @$pb.TagNumber(5)
  ...
  @$pb.TagNumber(7)
  $8.FieldMask get outputAudioConfigMask => $_getN(6);
  @$pb.TagNumber(7)
  set outputAudioConfigMask($8.FieldMask v) { setField(7, v); }
  @$pb.TagNumber(7)
  ...
  void clearOutputAudioConfigMask() => clearField(7);
  @$pb.TagNumber(7)
  $8.FieldMask ensureOutputAudioConfigMask() => $_ensure(6);
}

class StreamingDetectIntentResponse extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'StreamingDetectIntentResponse', package: const $pb.PackageName(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'google.cloud.dialogflow.v2'), createEmptyInstance: create)
    ..aOS(1, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'responseId')
    ...
    ..aOM<$9.Status>(4, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'webhookStatus', subBuilder: $9.Status.create)
  ...
  @$pb.TagNumber(4)
  set webhookStatus($9.Status v) { setField(4, v); }
  @$pb.TagNumber(4)
  $core.bool hasWebhookStatus() => $_has(3);
  @$pb.TagNumber(4)
  void clearWebhookStatus() => clearField(4);
  @$pb.TagNumber(4)
  $9.Status ensureWebhookStatus() => $_ensure(3);
  ...
  void clearOutputAudioConfig() => clearField(6);
  @$pb.TagNumber(6)
  $7.OutputAudioConfig ensureOutputAudioConfig() => $_ensure(5);
}

class StreamingRecognitionResult extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'StreamingRecognitionResult', package: const $pb.PackageName(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'google.cloud.dialogflow.v2'), createEmptyInstance: create)
    ...
    ..pc<$7.SpeechWordInfo>(7, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'speechWordInfo', $pb.PbFieldType.PM, subBuilder: $7.SpeechWordInfo.create)
    ..aOM<$12.Duration>(8, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'speechEndOffset', subBuilder: $12.Duration.create)
  ...
  factory StreamingRecognitionResult({
    ...
    $core.Iterable<$7.SpeechWordInfo>? speechWordInfo,
    $12.Duration? speechEndOffset,
    $core.String? languageCode,
  }) {
    final _result = create();
    if (messageType != null) {
  ...
  @$pb.TagNumber(7)
  $core.List<$7.SpeechWordInfo> get speechWordInfo => $_getList(4);

  @$pb.TagNumber(8)
  $12.Duration get speechEndOffset => $_getN(5);
  @$pb.TagNumber(8)
  set speechEndOffset($12.Duration v) { setField(8, v); }
  @$pb.TagNumber(8)
  $core.bool hasSpeechEndOffset() => $_has(5);
  @$pb.TagNumber(8)
  void clearSpeechEndOffset() => clearField(8);
  @$pb.TagNumber(8)
  $12.Duration ensureSpeechEndOffset() => $_ensure(5);
...
class TextInput extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'TextInput', package: const $pb.PackageName(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'google.cloud.dialogflow.v2'), createEmptyInstance: create)
...
class EventInput extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'EventInput', package: const $pb.PackageName(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'google.cloud.dialogflow.v2'), createEmptyInstance: create)
    ..aOS(1, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'name')
    ..aOM<$11.Struct>(2, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'parameters', subBuilder: $11.Struct.create)
  ...
  @$pb.TagNumber(2)
  set parameters($11.Struct v) { setField(2, v); }
  @$pb.TagNumber(2)
  $core.bool hasParameters() => $_has(1);
  @$pb.TagNumber(2)
  void clearParameters() => clearField(2);
  @$pb.TagNumber(2)
  $11.Struct ensureParameters() => $_ensure(1);
...
class SentimentAnalysisRequestConfig extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'SentimentAnalysisRequestConfig', package: const $pb.PackageName(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'google.cloud.dialogflow.v2'), createEmptyInstance: create)
...
class SentimentAnalysisResult extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'SentimentAnalysisResult', package: const $pb.PackageName(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'google.cloud.dialogflow.v2'), createEmptyInstance: create)
...
class Sentiment extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'Sentiment', package: const $pb.PackageName(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'google.cloud.dialogflow.v2'), createEmptyInstance: create)

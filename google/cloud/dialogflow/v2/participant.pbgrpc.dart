...
class ParticipantsClient extends $grpc.Client {
  ...
  static final _$suggestSmartReplies = $grpc.ClientMethod<
          $7.SuggestSmartRepliesRequest, $7.SuggestSmartRepliesResponse>(
      '/google.cloud.dialogflow.v2.Participants/SuggestSmartReplies',
      ($7.SuggestSmartRepliesRequest value) => value.writeToBuffer(),
      ($core.List<$core.int> value) =>
          $7.SuggestSmartRepliesResponse.fromBuffer(value));
  ...
  $grpc.ResponseFuture<$7.SuggestSmartRepliesResponse> suggestSmartReplies(
      $7.SuggestSmartRepliesRequest request,
      {$grpc.CallOptions? options}) {
...
abstract class ParticipantsServiceBase extends $grpc.Service {
  ...
  ParticipantsServiceBase() {
    ...
    $addMethod($grpc.ServiceMethod<$7.SuggestSmartRepliesRequest,
            $7.SuggestSmartRepliesResponse>(
        'SuggestSmartReplies',
        suggestSmartReplies_Pre,
        false,
        false,
        ($core.List<$core.int> value) =>
            $7.SuggestSmartRepliesRequest.fromBuffer(value),
        ($7.SuggestSmartRepliesResponse value) => value.writeToBuffer()));
  }
  ...
  $async.Future<$7.SuggestSmartRepliesResponse> suggestSmartReplies_Pre(
      $grpc.ServiceCall call,
      $async.Future<$7.SuggestSmartRepliesRequest> request) async {
  ...
  $async.Future<$7.SuggestSmartRepliesResponse> suggestSmartReplies(
      $grpc.ServiceCall call, $7.SuggestSmartRepliesRequest request);
}

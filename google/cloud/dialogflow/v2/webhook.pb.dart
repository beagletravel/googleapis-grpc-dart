...
class WebhookRequest extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'WebhookRequest', package: const $pb.PackageName(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'google.cloud.dialogflow.v2'), createEmptyInstance: create)
    ..aOS(1, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'responseId')
    ..aOM<$6.QueryResult>(2, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'queryResult', subBuilder: $6.QueryResult.create)
    ..aOM<OriginalDetectIntentRequest>(3, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'originalDetectIntentRequest', subBuilder: OriginalDetectIntentRequest.create)
  ...
  @$pb.TagNumber(2)
  set queryResult($6.QueryResult v) { setField(2, v); }
  @$pb.TagNumber(2)
...
class WebhookResponse extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'WebhookResponse', package: const $pb.PackageName(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'google.cloud.dialogflow.v2'), createEmptyInstance: create)
    ..aOS(1, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'fulfillmentText')
    ..pc<$3.Intent_Message>(2, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'fulfillmentMessages', $pb.PbFieldType.PM, subBuilder: $3.Intent_Message.create)
    ..aOS(3, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'source')
    ..aOM<$7.Struct>(4, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'payload', subBuilder: $7.Struct.create)
    ..pc<$0.Context>(5, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'outputContexts', $pb.PbFieldType.PM, subBuilder: $0.Context.create)
    ..aOM<$6.EventInput>(6, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'followupEventInput', subBuilder: $6.EventInput.create)
    ..pc<$5.SessionEntityType>(10, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'sessionEntityTypes', $pb.PbFieldType.PM, subBuilder: $5.SessionEntityType.create)
    ..hasRequiredFields = false
  ;
  ...
  @$pb.TagNumber(4)
  set payload($7.Struct v) { setField(4, v); }
  @$pb.TagNumber(4)
  ...
  @$pb.TagNumber(6)
  set followupEventInput($6.EventInput v) { setField(6, v); }
  @$pb.TagNumber(6)
...
class OriginalDetectIntentRequest extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'OriginalDetectIntentRequest', package: const $pb.PackageName(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'google.cloud.dialogflow.v2'), createEmptyInstance: create)
    ...
    ..aOM<$7.Struct>(3, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'payload', subBuilder: $7.Struct.create)
    ..hasRequiredFields = false
  ;
  ...
  'Use [GeneratedMessageGenericExtensions.rebuild] instead. '
  'Will be removed in next major version')
  OriginalDetectIntentRequest copyWith(void Function(OriginalDetectIntentRequest) updates) => super.copyWith((message) => updates(message as OriginalDetectIntentRequest)) as OriginalDetectIntentRequest; // ignore: deprecated_member_use
  $pb.BuilderInfo get info_ => _i;
  @$core.pragma('dart2js:noInline')
  ...
  @$pb.TagNumber(3)
  set payload($7.Struct v) { setField(3, v); }
  @$pb.TagNumber(3)

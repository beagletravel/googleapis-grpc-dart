...
final $typed_data.Uint8List inputAudioConfigDescriptor = $convert.base64Decode('');
...
final $typed_data.Uint8List voiceSelectionParamsDescriptor = $convert.base64Decode('ChRWb2ljZVNlbGVjdGlvblBhcmFtcxISCgRuYW1lGAEgASgJUgRuYW1lEkwKC3NzbWxfZ2VuZGVyGAIgASgOMisuZ29vZ2xlLmNsb3VkLmRpYWxvZ2Zsb3cudjIuU3NtbFZvaWNlR2VuZGVyUgpzc21sR2VuZGVy');
...
final $typed_data.Uint8List synthesizeSpeechConfigDescriptor = $convert.base64Decode('');
...
final $typed_data.Uint8List outputAudioConfigDescriptor = $convert.base64Decode('');
@$core.Deprecated('Use speechToTextConfigDescriptor instead')
const SpeechToTextConfig$json = const {
  '1': 'SpeechToTextConfig',
  '2': const [
    const {'1': 'speech_model_variant', '3': 1, '4': 1, '5': 14, '6': '.google.cloud.dialogflow.v2.SpeechModelVariant', '10': 'speechModelVariant'},
  ],
};

/// Descriptor for `SpeechToTextConfig`. Decode as a `google.protobuf.DescriptorProto`.
final $typed_data.Uint8List speechToTextConfigDescriptor = $convert.base64Decode('ChJTcGVlY2hUb1RleHRDb25maWcSYAoUc3BlZWNoX21vZGVsX3ZhcmlhbnQYASABKA4yLi5nb29nbGUuY2xvdWQuZGlhbG9nZmxvdy52Mi5TcGVlY2hNb2RlbFZhcmlhbnRSEnNwZWVjaE1vZGVsVmFyaWFudA==');

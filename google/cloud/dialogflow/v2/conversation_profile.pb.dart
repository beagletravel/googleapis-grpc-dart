...
import 'participant.pbenum.dart' as $7;

export 'conversation_profile.pbenum.dart';

class ConversationProfile extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'ConversationProfile', package: const $pb.PackageName(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'google.cloud.dialogflow.v2'), createEmptyInstance: create)
    ..aOS(1, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'name')
    ..aOS(2, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'displayName')
    ..aOM<AutomatedAgentConfig>(3, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'automatedAgentConfig', subBuilder: AutomatedAgentConfig.create)
    ..aOM<HumanAgentAssistantConfig>(4, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'humanAgentAssistantConfig', subBuilder: HumanAgentAssistantConfig.create)
    ..aOM<HumanAgentHandoffConfig>(5, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'humanAgentHandoffConfig', subBuilder: HumanAgentHandoffConfig.create)
    ...
    ..aOM<$9.SpeechToTextConfig>(9, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'sttConfig', subBuilder: $9.SpeechToTextConfig.create)
    ..aOS(10, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'languageCode')
    ..aOM<$10.Timestamp>(11, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'createTime', subBuilder: $10.Timestamp.create)
    ..aOM<$10.Timestamp>(12, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'updateTime', subBuilder: $10.Timestamp.create)
    ..aOS(13, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'securitySettings')
  ...
  factory ConversationProfile({
    ...
    if (newMessageEventNotificationConfig != null) {
      _result.newMessageEventNotificationConfig = newMessageEventNotificationConfig;
    }
    if (sttConfig != null) {
  ...
  'Will be removed in next major version')
  ConversationProfile copyWith(void Function(ConversationProfile) updates) => super.copyWith((message) => updates(message as ConversationProfile)) as ConversationProfile; // ignore: deprecated_member_use
  ...
  @$pb.TagNumber(9)
  $9.SpeechToTextConfig get sttConfig => $_getN(8);
  @$pb.TagNumber(9)
  set sttConfig($9.SpeechToTextConfig v) { setField(9, v); }
  @$pb.TagNumber(9)
  $core.bool hasSttConfig() => $_has(8);
  @$pb.TagNumber(9)
  void clearSttConfig() => clearField(9);
  @$pb.TagNumber(9)
  $9.SpeechToTextConfig ensureSttConfig() => $_ensure(8);
  ...
  @$pb.TagNumber(11)
  $10.Timestamp get createTime => $_getN(10);
  @$pb.TagNumber(11)
  set createTime($10.Timestamp v) { setField(11, v); }
  @$pb.TagNumber(11)
  $core.bool hasCreateTime() => $_has(10);
  @$pb.TagNumber(11)
  void clearCreateTime() => clearField(11);
  @$pb.TagNumber(11)
  $10.Timestamp ensureCreateTime() => $_ensure(10);

  @$pb.TagNumber(12)
  $10.Timestamp get updateTime => $_getN(11);
  @$pb.TagNumber(12)
  set updateTime($10.Timestamp v) { setField(12, v); }
  @$pb.TagNumber(12)
...
class ListConversationProfilesRequest extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'ListConversationProfilesRequest', package: const $pb.PackageName(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'google.cloud.dialogflow.v2'), createEmptyInstance: create)
  ...
  'Use [GeneratedMessageGenericExtensions.rebuild] instead. '
  'Will be removed in next major version')
  ListConversationProfilesRequest copyWith(void Function(ListConversationProfilesRequest) updates) => super.copyWith((message) => updates(message as ListConversationProfilesRequest)) as ListConversationProfilesRequest; // ignore: deprecated_member_use
  $pb.BuilderInfo get info_ => _i;
  @$core.pragma('dart2js:noInline')
...
class ListConversationProfilesResponse extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'ListConversationProfilesResponse', package: const $pb.PackageName(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'google.cloud.dialogflow.v2'), createEmptyInstance: create)
    ..pc<ConversationProfile>(1, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'conversationProfiles', $pb.PbFieldType.PM, subBuilder: ConversationProfile.create)
  ...
  'Use [GeneratedMessageGenericExtensions.rebuild] instead. '
  'Will be removed in next major version')
  ListConversationProfilesResponse copyWith(void Function(ListConversationProfilesResponse) updates) => super.copyWith((message) => updates(message as ListConversationProfilesResponse)) as ListConversationProfilesResponse; // ignore: deprecated_member_use
  $pb.BuilderInfo get info_ => _i;
  @$core.pragma('dart2js:noInline')
...
class GetConversationProfileRequest extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'GetConversationProfileRequest', package: const $pb.PackageName(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'google.cloud.dialogflow.v2'), createEmptyInstance: create)
    ..aOS(1, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'name')
    ..hasRequiredFields = false
  ;
  ...
  'Use [GeneratedMessageGenericExtensions.rebuild] instead. '
  'Will be removed in next major version')
  GetConversationProfileRequest copyWith(void Function(GetConversationProfileRequest) updates) => super.copyWith((message) => updates(message as GetConversationProfileRequest)) as GetConversationProfileRequest; // ignore: deprecated_member_use
  $pb.BuilderInfo get info_ => _i;
  @$core.pragma('dart2js:noInline')
...
class CreateConversationProfileRequest extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'CreateConversationProfileRequest', package: const $pb.PackageName(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'google.cloud.dialogflow.v2'), createEmptyInstance: create)
    ..aOS(1, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'parent')
    ..aOM<ConversationProfile>(2, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'conversationProfile', subBuilder: ConversationProfile.create)
    ..hasRequiredFields = false
  ;
  ...
  'Use [GeneratedMessageGenericExtensions.rebuild] instead. '
  'Will be removed in next major version')
  CreateConversationProfileRequest copyWith(void Function(CreateConversationProfileRequest) updates) => super.copyWith((message) => updates(message as CreateConversationProfileRequest)) as CreateConversationProfileRequest; // ignore: deprecated_member_use
  $pb.BuilderInfo get info_ => _i;
  @$core.pragma('dart2js:noInline')
...
class UpdateConversationProfileRequest extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'UpdateConversationProfileRequest', package: const $pb.PackageName(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'google.cloud.dialogflow.v2'), createEmptyInstance: create)
    ..aOM<ConversationProfile>(1, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'conversationProfile', subBuilder: ConversationProfile.create)
  ...
  'Use [GeneratedMessageGenericExtensions.rebuild] instead. '
  'Will be removed in next major version')
  UpdateConversationProfileRequest copyWith(void Function(UpdateConversationProfileRequest) updates) => super.copyWith((message) => updates(message as UpdateConversationProfileRequest)) as UpdateConversationProfileRequest; // ignore: deprecated_member_use
  $pb.BuilderInfo get info_ => _i;
  @$core.pragma('dart2js:noInline')
...
class DeleteConversationProfileRequest extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'DeleteConversationProfileRequest', package: const $pb.PackageName(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'google.cloud.dialogflow.v2'), createEmptyInstance: create)
    ..aOS(1, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'name')
    ..hasRequiredFields = false
  ;
  ...
  'Use [GeneratedMessageGenericExtensions.rebuild] instead. '
  'Will be removed in next major version')
  DeleteConversationProfileRequest copyWith(void Function(DeleteConversationProfileRequest) updates) => super.copyWith((message) => updates(message as DeleteConversationProfileRequest)) as DeleteConversationProfileRequest; // ignore: deprecated_member_use
  $pb.BuilderInfo get info_ => _i;
  @$core.pragma('dart2js:noInline')
...
class AutomatedAgentConfig extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'AutomatedAgentConfig', package: const $pb.PackageName(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'google.cloud.dialogflow.v2'), createEmptyInstance: create)
  ...
  'Use [GeneratedMessageGenericExtensions.rebuild] instead. '
  'Will be removed in next major version')
  AutomatedAgentConfig copyWith(void Function(AutomatedAgentConfig) updates) => super.copyWith((message) => updates(message as AutomatedAgentConfig)) as AutomatedAgentConfig; // ignore: deprecated_member_use
  $pb.BuilderInfo get info_ => _i;
  @$core.pragma('dart2js:noInline')
...
class HumanAgentAssistantConfig_SuggestionTriggerSettings extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'HumanAgentAssistantConfig.SuggestionTriggerSettings', package: const $pb.PackageName(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'google.cloud.dialogflow.v2'), createEmptyInstance: create)
    ..aOB(1, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'noSmalltalk')
    ..aOB(2, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'onlyEndUser')
    ..hasRequiredFields = false
  ;
  ...
  'Use [GeneratedMessageGenericExtensions.rebuild] instead. '
  'Will be removed in next major version')
  HumanAgentAssistantConfig_SuggestionTriggerSettings copyWith(void Function(HumanAgentAssistantConfig_SuggestionTriggerSettings) updates) => super.copyWith((message) => updates(message as HumanAgentAssistantConfig_SuggestionTriggerSettings)) as HumanAgentAssistantConfig_SuggestionTriggerSettings; // ignore: deprecated_member_use
  $pb.BuilderInfo get info_ => _i;
  @$core.pragma('dart2js:noInline')
...
class HumanAgentAssistantConfig_SuggestionFeatureConfig extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'HumanAgentAssistantConfig.SuggestionFeatureConfig', package: const $pb.PackageName(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'google.cloud.dialogflow.v2'), createEmptyInstance: create)
    ..aOB(3, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'enableEventBasedSuggestion')
    ..aOM<SuggestionFeature>(5, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'suggestionFeature', subBuilder: SuggestionFeature.create)
    ..aOM<HumanAgentAssistantConfig_SuggestionQueryConfig>(6, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'queryConfig', subBuilder: HumanAgentAssistantConfig_SuggestionQueryConfig.create)
    ..aOM<HumanAgentAssistantConfig_ConversationModelConfig>(7, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'conversationModelConfig', subBuilder: HumanAgentAssistantConfig_ConversationModelConfig.create)
    ..aOM<HumanAgentAssistantConfig_ConversationProcessConfig>(8, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'conversationProcessConfig', subBuilder: HumanAgentAssistantConfig_ConversationProcessConfig.create)
    ..aOM<HumanAgentAssistantConfig_SuggestionTriggerSettings>(10, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'suggestionTriggerSettings', subBuilder: HumanAgentAssistantConfig_SuggestionTriggerSettings.create)
    ..hasRequiredFields = false
  ;
  ...
  factory HumanAgentAssistantConfig_SuggestionFeatureConfig({
    ...
    if (conversationProcessConfig != null) {
      _result.conversationProcessConfig = conversationProcessConfig;
    }
  ...
  'Use [GeneratedMessageGenericExtensions.rebuild] instead. '
  'Will be removed in next major version')
  HumanAgentAssistantConfig_SuggestionFeatureConfig copyWith(void Function(HumanAgentAssistantConfig_SuggestionFeatureConfig) updates) => super.copyWith((message) => updates(message as HumanAgentAssistantConfig_SuggestionFeatureConfig)) as HumanAgentAssistantConfig_SuggestionFeatureConfig; // ignore: deprecated_member_use
  $pb.BuilderInfo get info_ => _i;
  @$core.pragma('dart2js:noInline')
  ...
  @$pb.TagNumber(5)
  set suggestionFeature(SuggestionFeature v) { setField(5, v); }
  @$pb.TagNumber(5)
...
class HumanAgentAssistantConfig_SuggestionConfig extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'HumanAgentAssistantConfig.SuggestionConfig', package: const $pb.PackageName(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'google.cloud.dialogflow.v2'), createEmptyInstance: create)
    ..pc<HumanAgentAssistantConfig_SuggestionFeatureConfig>(2, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'featureConfigs', $pb.PbFieldType.PM, subBuilder: HumanAgentAssistantConfig_SuggestionFeatureConfig.create)
    ..aOB(3, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'groupSuggestionResponses')
    ..hasRequiredFields = false
  ;
  ...
  'Use [GeneratedMessageGenericExtensions.rebuild] instead. '
  'Will be removed in next major version')
  HumanAgentAssistantConfig_SuggestionConfig copyWith(void Function(HumanAgentAssistantConfig_SuggestionConfig) updates) => super.copyWith((message) => updates(message as HumanAgentAssistantConfig_SuggestionConfig)) as HumanAgentAssistantConfig_SuggestionConfig; // ignore: deprecated_member_use
  $pb.BuilderInfo get info_ => _i;
  @$core.pragma('dart2js:noInline')
...
class HumanAgentAssistantConfig_SuggestionQueryConfig_KnowledgeBaseQuerySource extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'HumanAgentAssistantConfig.SuggestionQueryConfig.KnowledgeBaseQuerySource', package: const $pb.PackageName(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'google.cloud.dialogflow.v2'), createEmptyInstance: create)
    ..pPS(1, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'knowledgeBases')
    ..hasRequiredFields = false
  ;
...
class HumanAgentAssistantConfig_SuggestionQueryConfig_DocumentQuerySource extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'HumanAgentAssistantConfig.SuggestionQueryConfig.DocumentQuerySource', package: const $pb.PackageName(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'google.cloud.dialogflow.v2'), createEmptyInstance: create)
    ..pPS(1, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'documents')
    ..hasRequiredFields = false
  ;
...
class HumanAgentAssistantConfig_SuggestionQueryConfig_DialogflowQuerySource extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'HumanAgentAssistantConfig.SuggestionQueryConfig.DialogflowQuerySource', package: const $pb.PackageName(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'google.cloud.dialogflow.v2'), createEmptyInstance: create)
    ..aOS(1, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'agent')
    ..hasRequiredFields = false
  ;
...
class HumanAgentAssistantConfig_SuggestionQueryConfig_ContextFilterSettings extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'HumanAgentAssistantConfig.SuggestionQueryConfig.ContextFilterSettings', package: const $pb.PackageName(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'google.cloud.dialogflow.v2'), createEmptyInstance: create)
    ..aOB(1, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'dropHandoffMessages')
    ..aOB(2, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'dropVirtualAgentMessages')
    ..aOB(3, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'dropIvrMessages')
    ..hasRequiredFields = false
  ;
  ...
  'Use [GeneratedMessageGenericExtensions.rebuild] instead. '
  'Will be removed in next major version')
  HumanAgentAssistantConfig_SuggestionQueryConfig_ContextFilterSettings copyWith(void Function(HumanAgentAssistantConfig_SuggestionQueryConfig_ContextFilterSettings) updates) => super.copyWith((message) => updates(message as HumanAgentAssistantConfig_SuggestionQueryConfig_ContextFilterSettings)) as HumanAgentAssistantConfig_SuggestionQueryConfig_ContextFilterSettings; // ignore: deprecated_member_use
  $pb.BuilderInfo get info_ => _i;
  @$core.pragma('dart2js:noInline')
...
class HumanAgentAssistantConfig_SuggestionQueryConfig extends $pb.GeneratedMessage {
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'HumanAgentAssistantConfig.SuggestionQueryConfig', package: const $pb.PackageName(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'google.cloud.dialogflow.v2'), createEmptyInstance: create)
    ..oo(0, [1, 2, 3])
    ..aOM<HumanAgentAssistantConfig_SuggestionQueryConfig_KnowledgeBaseQuerySource>(1, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'knowledgeBaseQuerySource', subBuilder: HumanAgentAssistantConfig_SuggestionQueryConfig_KnowledgeBaseQuerySource.create)
    ..aOM<HumanAgentAssistantConfig_SuggestionQueryConfig_DocumentQuerySource>(2, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'documentQuerySource', subBuilder: HumanAgentAssistantConfig_SuggestionQueryConfig_DocumentQuerySource.create)
  ...
  'Use [GeneratedMessageGenericExtensions.rebuild] instead. '
  'Will be removed in next major version')
  HumanAgentAssistantConfig_SuggestionQueryConfig copyWith(void Function(HumanAgentAssistantConfig_SuggestionQueryConfig) updates) => super.copyWith((message) => updates(message as HumanAgentAssistantConfig_SuggestionQueryConfig)) as HumanAgentAssistantConfig_SuggestionQueryConfig; // ignore: deprecated_member_use
  $pb.BuilderInfo get info_ => _i;
  @$core.pragma('dart2js:noInline')
...
class HumanAgentAssistantConfig_ConversationModelConfig extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'HumanAgentAssistantConfig.ConversationModelConfig', package: const $pb.PackageName(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'google.cloud.dialogflow.v2'), createEmptyInstance: create)
  ...
  'Use [GeneratedMessageGenericExtensions.rebuild] instead. '
  'Will be removed in next major version')
  HumanAgentAssistantConfig_ConversationModelConfig copyWith(void Function(HumanAgentAssistantConfig_ConversationModelConfig) updates) => super.copyWith((message) => updates(message as HumanAgentAssistantConfig_ConversationModelConfig)) as HumanAgentAssistantConfig_ConversationModelConfig; // ignore: deprecated_member_use
  $pb.BuilderInfo get info_ => _i;
  @$core.pragma('dart2js:noInline')
...
class HumanAgentAssistantConfig_ConversationProcessConfig extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'HumanAgentAssistantConfig.ConversationProcessConfig', package: const $pb.PackageName(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'google.cloud.dialogflow.v2'), createEmptyInstance: create)
    ..a<$core.int>(2, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'recentSentencesCount', $pb.PbFieldType.O3)
    ..hasRequiredFields = false
  ;
  ...
  factory HumanAgentAssistantConfig_ConversationProcessConfig({
    ...
    if (recentSentencesCount != null) {
      _result.recentSentencesCount = recentSentencesCount;
    }
    return _result;
  }
  ...
  'Use [GeneratedMessageGenericExtensions.rebuild] instead. '
  'Will be removed in next major version')
  HumanAgentAssistantConfig_ConversationProcessConfig copyWith(void Function(HumanAgentAssistantConfig_ConversationProcessConfig) updates) => super.copyWith((message) => updates(message as HumanAgentAssistantConfig_ConversationProcessConfig)) as HumanAgentAssistantConfig_ConversationProcessConfig; // ignore: deprecated_member_use
  $pb.BuilderInfo get info_ => _i;
  @$core.pragma('dart2js:noInline')
...
class HumanAgentAssistantConfig_MessageAnalysisConfig extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'HumanAgentAssistantConfig.MessageAnalysisConfig', package: const $pb.PackageName(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'google.cloud.dialogflow.v2'), createEmptyInstance: create)
    ..aOB(2, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'enableEntityExtraction')
    ..aOB(3, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'enableSentimentAnalysis')
    ..hasRequiredFields = false
  ;
  ...
  'Use [GeneratedMessageGenericExtensions.rebuild] instead. '
  'Will be removed in next major version')
  HumanAgentAssistantConfig_MessageAnalysisConfig copyWith(void Function(HumanAgentAssistantConfig_MessageAnalysisConfig) updates) => super.copyWith((message) => updates(message as HumanAgentAssistantConfig_MessageAnalysisConfig)) as HumanAgentAssistantConfig_MessageAnalysisConfig; // ignore: deprecated_member_use
  $pb.BuilderInfo get info_ => _i;
  @$core.pragma('dart2js:noInline')
...
class HumanAgentAssistantConfig extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'HumanAgentAssistantConfig', package: const $pb.PackageName(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'google.cloud.dialogflow.v2'), createEmptyInstance: create)
    ..aOM<NotificationConfig>(2, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'notificationConfig', subBuilder: NotificationConfig.create)
    ..aOM<HumanAgentAssistantConfig_SuggestionConfig>(3, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'humanAgentSuggestionConfig', subBuilder: HumanAgentAssistantConfig_SuggestionConfig.create)
    ..aOM<HumanAgentAssistantConfig_SuggestionConfig>(4, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'endUserSuggestionConfig', subBuilder: HumanAgentAssistantConfig_SuggestionConfig.create)
    ..aOM<HumanAgentAssistantConfig_MessageAnalysisConfig>(5, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'messageAnalysisConfig', subBuilder: HumanAgentAssistantConfig_MessageAnalysisConfig.create)
    ..hasRequiredFields = false
  ;
  ...
  'Use [GeneratedMessageGenericExtensions.rebuild] instead. '
  'Will be removed in next major version')
  HumanAgentAssistantConfig copyWith(void Function(HumanAgentAssistantConfig) updates) => super.copyWith((message) => updates(message as HumanAgentAssistantConfig)) as HumanAgentAssistantConfig; // ignore: deprecated_member_use
  $pb.BuilderInfo get info_ => _i;
  @$core.pragma('dart2js:noInline')
...
class HumanAgentHandoffConfig_LivePersonConfig extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'HumanAgentHandoffConfig.LivePersonConfig', package: const $pb.PackageName(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'google.cloud.dialogflow.v2'), createEmptyInstance: create)
  ...
  'Use [GeneratedMessageGenericExtensions.rebuild] instead. '
  'Will be removed in next major version')
  HumanAgentHandoffConfig_LivePersonConfig copyWith(void Function(HumanAgentHandoffConfig_LivePersonConfig) updates) => super.copyWith((message) => updates(message as HumanAgentHandoffConfig_LivePersonConfig)) as HumanAgentHandoffConfig_LivePersonConfig; // ignore: deprecated_member_use
  $pb.BuilderInfo get info_ => _i;
  @$core.pragma('dart2js:noInline')
...
class HumanAgentHandoffConfig_SalesforceLiveAgentConfig extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'HumanAgentHandoffConfig.SalesforceLiveAgentConfig', package: const $pb.PackageName(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'google.cloud.dialogflow.v2'), createEmptyInstance: create)
    ...
    ..aOS(3, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'buttonId')
    ..aOS(4, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'endpointDomain')
    ..hasRequiredFields = false
  ;
  ...
  'Use [GeneratedMessageGenericExtensions.rebuild] instead. '
  'Will be removed in next major version')
  HumanAgentHandoffConfig_SalesforceLiveAgentConfig copyWith(void Function(HumanAgentHandoffConfig_SalesforceLiveAgentConfig) updates) => super.copyWith((message) => updates(message as HumanAgentHandoffConfig_SalesforceLiveAgentConfig)) as HumanAgentHandoffConfig_SalesforceLiveAgentConfig; // ignore: deprecated_member_use
  $pb.BuilderInfo get info_ => _i;
  @$core.pragma('dart2js:noInline')
...
class HumanAgentHandoffConfig extends $pb.GeneratedMessage {
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'HumanAgentHandoffConfig', package: const $pb.PackageName(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'google.cloud.dialogflow.v2'), createEmptyInstance: create)
    ..oo(0, [1, 2])
    ..aOM<HumanAgentHandoffConfig_LivePersonConfig>(1, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'livePersonConfig', subBuilder: HumanAgentHandoffConfig_LivePersonConfig.create)
    ..aOM<HumanAgentHandoffConfig_SalesforceLiveAgentConfig>(2, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'salesforceLiveAgentConfig', subBuilder: HumanAgentHandoffConfig_SalesforceLiveAgentConfig.create)
    ..hasRequiredFields = false
  ;
  ...
  'Use [GeneratedMessageGenericExtensions.rebuild] instead. '
  'Will be removed in next major version')
  HumanAgentHandoffConfig copyWith(void Function(HumanAgentHandoffConfig) updates) => super.copyWith((message) => updates(message as HumanAgentHandoffConfig)) as HumanAgentHandoffConfig; // ignore: deprecated_member_use
  $pb.BuilderInfo get info_ => _i;
  @$core.pragma('dart2js:noInline')
...
class NotificationConfig extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'NotificationConfig', package: const $pb.PackageName(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'google.cloud.dialogflow.v2'), createEmptyInstance: create)
    ..aOS(1, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'topic')
    ..e<NotificationConfig_MessageFormat>(2, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'messageFormat', $pb.PbFieldType.OE, defaultOrMaker: NotificationConfig_MessageFormat.MESSAGE_FORMAT_UNSPECIFIED, valueOf: NotificationConfig_MessageFormat.valueOf, enumValues: NotificationConfig_MessageFormat.values)
    ..hasRequiredFields = false
  ;
...
class LoggingConfig extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'LoggingConfig', package: const $pb.PackageName(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'google.cloud.dialogflow.v2'), createEmptyInstance: create)
    ..aOB(3, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'enableStackdriverLogging')
    ..hasRequiredFields = false
  ;
...
class SuggestionFeature extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'SuggestionFeature', package: const $pb.PackageName(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'google.cloud.dialogflow.v2'), createEmptyInstance: create)
...
class SetSuggestionFeatureConfigRequest extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'SetSuggestionFeatureConfigRequest', package: const $pb.PackageName(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'google.cloud.dialogflow.v2'), createEmptyInstance: create)
    ..aOS(1, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'conversationProfile')
    ..e<$7.Participant_Role>(2, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'participantRole', $pb.PbFieldType.OE, defaultOrMaker: $7.Participant_Role.ROLE_UNSPECIFIED, valueOf: $7.Participant_Role.valueOf, enumValues: $7.Participant_Role.values)
    ..aOM<HumanAgentAssistantConfig_SuggestionFeatureConfig>(3, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'suggestionFeatureConfig', subBuilder: HumanAgentAssistantConfig_SuggestionFeatureConfig.create)
    ..hasRequiredFields = false
  ;
  ...
  factory SetSuggestionFeatureConfigRequest({
    ...
    $7.Participant_Role? participantRole,
    ...
    if (suggestionFeatureConfig != null) {
      _result.suggestionFeatureConfig = suggestionFeatureConfig;
    }
    return _result;
  }
  ...
  'Use [GeneratedMessageGenericExtensions.rebuild] instead. '
  'Will be removed in next major version')
  SetSuggestionFeatureConfigRequest copyWith(void Function(SetSuggestionFeatureConfigRequest) updates) => super.copyWith((message) => updates(message as SetSuggestionFeatureConfigRequest)) as SetSuggestionFeatureConfigRequest; // ignore: deprecated_member_use
  $pb.BuilderInfo get info_ => _i;
  @$core.pragma('dart2js:noInline')
  ...
  @$pb.TagNumber(2)
  $7.Participant_Role get participantRole => $_getN(1);
  @$pb.TagNumber(2)
  set participantRole($7.Participant_Role v) { setField(2, v); }
  @$pb.TagNumber(2)
...
class ClearSuggestionFeatureConfigRequest extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'ClearSuggestionFeatureConfigRequest', package: const $pb.PackageName(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'google.cloud.dialogflow.v2'), createEmptyInstance: create)
    ..aOS(1, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'conversationProfile')
    ..e<$7.Participant_Role>(2, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'participantRole', $pb.PbFieldType.OE, defaultOrMaker: $7.Participant_Role.ROLE_UNSPECIFIED, valueOf: $7.Participant_Role.valueOf, enumValues: $7.Participant_Role.values)
    ..e<SuggestionFeature_Type>(3, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'suggestionFeatureType', $pb.PbFieldType.OE, defaultOrMaker: SuggestionFeature_Type.TYPE_UNSPECIFIED, valueOf: SuggestionFeature_Type.valueOf, enumValues: SuggestionFeature_Type.values)
    ..hasRequiredFields = false
  ;
  ...
  factory ClearSuggestionFeatureConfigRequest({
    ...
    if (suggestionFeatureType != null) {
      _result.suggestionFeatureType = suggestionFeatureType;
    }
    return _result;
  }
  ...
  'Use [GeneratedMessageGenericExtensions.rebuild] instead. '
  'Will be removed in next major version')
  ClearSuggestionFeatureConfigRequest copyWith(void Function(ClearSuggestionFeatureConfigRequest) updates) => super.copyWith((message) => updates(message as ClearSuggestionFeatureConfigRequest)) as ClearSuggestionFeatureConfigRequest; // ignore: deprecated_member_use
  $pb.BuilderInfo get info_ => _i;
  @$core.pragma('dart2js:noInline')
  ...
  @$pb.TagNumber(3)
  SuggestionFeature_Type get suggestionFeatureType => $_getN(2);
  @$pb.TagNumber(3)
  set suggestionFeatureType(SuggestionFeature_Type v) { setField(3, v); }
  @$pb.TagNumber(3)
...
class SetSuggestionFeatureConfigOperationMetadata extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'SetSuggestionFeatureConfigOperationMetadata', package: const $pb.PackageName(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'google.cloud.dialogflow.v2'), createEmptyInstance: create)
    ..aOS(1, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'conversationProfile')
    ..e<$7.Participant_Role>(2, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'participantRole', $pb.PbFieldType.OE, defaultOrMaker: $7.Participant_Role.ROLE_UNSPECIFIED, valueOf: $7.Participant_Role.valueOf, enumValues: $7.Participant_Role.values)
    ..e<SuggestionFeature_Type>(3, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'suggestionFeatureType', $pb.PbFieldType.OE, defaultOrMaker: SuggestionFeature_Type.TYPE_UNSPECIFIED, valueOf: SuggestionFeature_Type.valueOf, enumValues: SuggestionFeature_Type.values)
    ..aOM<$10.Timestamp>(4, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'createTime', subBuilder: $10.Timestamp.create)
    ..hasRequiredFields = false
  ;
  ...
  'Use [GeneratedMessageGenericExtensions.rebuild] instead. '
  'Will be removed in next major version')
  SetSuggestionFeatureConfigOperationMetadata copyWith(void Function(SetSuggestionFeatureConfigOperationMetadata) updates) => super.copyWith((message) => updates(message as SetSuggestionFeatureConfigOperationMetadata)) as SetSuggestionFeatureConfigOperationMetadata; // ignore: deprecated_member_use
  $pb.BuilderInfo get info_ => _i;
  @$core.pragma('dart2js:noInline')
  ...
  @$pb.TagNumber(4)
  set createTime($10.Timestamp v) { setField(4, v); }
  @$pb.TagNumber(4)
...
class ClearSuggestionFeatureConfigOperationMetadata extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'ClearSuggestionFeatureConfigOperationMetadata', package: const $pb.PackageName(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'google.cloud.dialogflow.v2'), createEmptyInstance: create)
    ..aOS(1, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'conversationProfile')
    ..e<$7.Participant_Role>(2, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'participantRole', $pb.PbFieldType.OE, defaultOrMaker: $7.Participant_Role.ROLE_UNSPECIFIED, valueOf: $7.Participant_Role.valueOf, enumValues: $7.Participant_Role.values)
    ..e<SuggestionFeature_Type>(3, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'suggestionFeatureType', $pb.PbFieldType.OE, defaultOrMaker: SuggestionFeature_Type.TYPE_UNSPECIFIED, valueOf: SuggestionFeature_Type.valueOf, enumValues: SuggestionFeature_Type.values)
    ..aOM<$10.Timestamp>(4, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'createTime', subBuilder: $10.Timestamp.create)
  ...
  'Use [GeneratedMessageGenericExtensions.rebuild] instead. '
  'Will be removed in next major version')
  ClearSuggestionFeatureConfigOperationMetadata copyWith(void Function(ClearSuggestionFeatureConfigOperationMetadata) updates) => super.copyWith((message) => updates(message as ClearSuggestionFeatureConfigOperationMetadata)) as ClearSuggestionFeatureConfigOperationMetadata; // ignore: deprecated_member_use
  $pb.BuilderInfo get info_ => _i;
  @$core.pragma('dart2js:noInline')

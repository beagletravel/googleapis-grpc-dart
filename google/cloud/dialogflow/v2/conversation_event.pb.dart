...
class ConversationEvent extends $pb.GeneratedMessage {
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'ConversationEvent', package: const $pb.PackageName(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'google.cloud.dialogflow.v2'), createEmptyInstance: create)
    ..oo(0, [4])
    ..aOS(1, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'conversation')
    ..e<ConversationEvent_Type>(2, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'type', $pb.PbFieldType.OE, defaultOrMaker: ConversationEvent_Type.TYPE_UNSPECIFIED, valueOf: ConversationEvent_Type.valueOf, enumValues: ConversationEvent_Type.values)
    ..aOM<$8.Status>(3, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'errorStatus', subBuilder: $8.Status.create)
    ..aOM<$7.Message>(4, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'newMessagePayload', subBuilder: $7.Message.create)
  ...
  'Will be removed in next major version')
  ConversationEvent copyWith(void Function(ConversationEvent) updates) => super.copyWith((message) => updates(message as ConversationEvent)) as ConversationEvent; // ignore: deprecated_member_use
  ...
  @$pb.TagNumber(3)
  $8.Status get errorStatus => $_getN(2);
  @$pb.TagNumber(3)
  set errorStatus($8.Status v) { setField(3, v); }
  @$pb.TagNumber(3)
  $core.bool hasErrorStatus() => $_has(2);
  @$pb.TagNumber(3)
  void clearErrorStatus() => clearField(3);
  @$pb.TagNumber(3)
  $8.Status ensureErrorStatus() => $_ensure(2);

  @$pb.TagNumber(4)
  $7.Message get newMessagePayload => $_getN(3);
  @$pb.TagNumber(4)
  set newMessagePayload($7.Message v) { setField(4, v); }
  @$pb.TagNumber(4)
  $core.bool hasNewMessagePayload() => $_has(3);
  @$pb.TagNumber(4)
  void clearNewMessagePayload() => clearField(4);
  @$pb.TagNumber(4)
  $7.Message ensureNewMessagePayload() => $_ensure(3);
}

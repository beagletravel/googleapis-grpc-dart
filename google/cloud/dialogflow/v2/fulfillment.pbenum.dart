...
class Fulfillment_Feature_Type extends $pb.ProtobufEnum {
  static const Fulfillment_Feature_Type TYPE_UNSPECIFIED = Fulfillment_Feature_Type._(0, const $core.bool.fromEnvironment('protobuf.omit_enum_names') ? '' : 'TYPE_UNSPECIFIED');
  static const Fulfillment_Feature_Type SMALLTALK = Fulfillment_Feature_Type._(1, const $core.bool.fromEnvironment('protobuf.omit_enum_names') ? '' : 'SMALLTALK');

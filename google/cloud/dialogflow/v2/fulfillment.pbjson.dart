...
const Fulfillment$json = const {
  ...
  '2': const [
    ...
    const {'1': 'generic_web_service', '3': 3, '4': 1, '5': 11, '6': '.google.cloud.dialogflow.v2.Fulfillment.GenericWebService', '9': 0, '10': 'genericWebService'},
    const {'1': 'enabled', '3': 4, '4': 1, '5': 8, '8': const {}, '10': 'enabled'},
    const {'1': 'features', '3': 5, '4': 3, '5': 11, '6': '.google.cloud.dialogflow.v2.Fulfillment.Feature', '8': const {}, '10': 'features'},
  ],
...
const Fulfillment_GenericWebService$json = const {
  ...
  '2': const [
    ...
    const {'1': 'request_headers', '3': 4, '4': 3, '5': 11, '6': '.google.cloud.dialogflow.v2.Fulfillment.GenericWebService.RequestHeadersEntry', '8': const {}, '10': 'requestHeaders'},
    const {
      '1': 'is_cloud_function',
      '3': 5,
      '4': 1,
...
const Fulfillment_Feature$json = const {
  '1': 'Feature',
  '2': const [
    const {'1': 'type', '3': 1, '4': 1, '5': 14, '6': '.google.cloud.dialogflow.v2.Fulfillment.Feature.Type', '10': 'type'},
  ],
...
const UpdateFulfillmentRequest$json = const {
  ...
  '2': const [
    const {'1': 'fulfillment', '3': 1, '4': 1, '5': 11, '6': '.google.cloud.dialogflow.v2.Fulfillment', '8': const {}, '10': 'fulfillment'},
...
final $typed_data.Uint8List updateFulfillmentRequestDescriptor = $convert.base64Decode('ChhVcGRhdGVGdWxmaWxsbWVudFJlcXVlc3QSTgoLZnVsZmlsbG1lbnQYASABKAsyJy5nb29nbGUuY2xvdWQuZGlhbG9nZmxvdy52Mi5GdWxmaWxsbWVudEID4EECUgtmdWxmaWxsbWVudBJACgt1cGRhdGVfbWFzaxgCIAEoCzIaLmdvb2dsZS5wcm90b2J1Zi5GaWVsZE1hc2tCA+BBAlIKdXBkYXRlTWFzaw==');

...
class ConversationProfilesClient extends $grpc.Client {
  ...
  $grpc.ResponseFuture<$2.Operation> setSuggestionFeatureConfig(
      $8.SetSuggestionFeatureConfigRequest request,
      {$grpc.CallOptions? options}) {
    return $createUnaryCall(_$setSuggestionFeatureConfig, request,
        options: options);
  }

  $grpc.ResponseFuture<$2.Operation> clearSuggestionFeatureConfig(
      $8.ClearSuggestionFeatureConfigRequest request,
      {$grpc.CallOptions? options}) {
...
abstract class ConversationProfilesServiceBase extends $grpc.Service {
  ...
  ConversationProfilesServiceBase() {
    ...
    $addMethod(
        $grpc.ServiceMethod<$8.SetSuggestionFeatureConfigRequest, $2.Operation>(
            'SetSuggestionFeatureConfig',
            setSuggestionFeatureConfig_Pre,
            false,
            false,
            ($core.List<$core.int> value) =>
                $8.SetSuggestionFeatureConfigRequest.fromBuffer(value),
            ($2.Operation value) => value.writeToBuffer()));
    $addMethod($grpc.ServiceMethod<$8.ClearSuggestionFeatureConfigRequest,
            $2.Operation>(
        ...
        false,
        ($core.List<$core.int> value) =>
            $8.ClearSuggestionFeatureConfigRequest.fromBuffer(value),
        ($2.Operation value) => value.writeToBuffer()));
  }
  ...
  $async.Future<$2.Operation> setSuggestionFeatureConfig_Pre(
      $grpc.ServiceCall call,
      $async.Future<$8.SetSuggestionFeatureConfigRequest> request) async {
    return setSuggestionFeatureConfig(call, await request);
  }

  $async.Future<$2.Operation> clearSuggestionFeatureConfig_Pre(
      $grpc.ServiceCall call,
      $async.Future<$8.ClearSuggestionFeatureConfigRequest> request) async {
  ...
  $async.Future<$2.Operation> setSuggestionFeatureConfig(
      $grpc.ServiceCall call, $8.SetSuggestionFeatureConfigRequest request);
  $async.Future<$2.Operation> clearSuggestionFeatureConfig(
      $grpc.ServiceCall call, $8.ClearSuggestionFeatureConfigRequest request);
}

...
class AnswerRecord extends $pb.GeneratedMessage {
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'AnswerRecord', package: const $pb.PackageName(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'google.cloud.dialogflow.v2'), createEmptyInstance: create)
    ..oo(0, [4])
    ..aOS(1, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'name')
    ..aOM<AnswerFeedback>(2, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'answerFeedback', subBuilder: AnswerFeedback.create)
  ...
  @$pb.TagNumber(2)
  set answerFeedback(AnswerFeedback v) { setField(2, v); }
  @$pb.TagNumber(2)
...
class ListAnswerRecordsRequest extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'ListAnswerRecordsRequest', package: const $pb.PackageName(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'google.cloud.dialogflow.v2'), createEmptyInstance: create)
...
class ListAnswerRecordsResponse extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'ListAnswerRecordsResponse', package: const $pb.PackageName(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'google.cloud.dialogflow.v2'), createEmptyInstance: create)
...
class UpdateAnswerRecordRequest extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'UpdateAnswerRecordRequest', package: const $pb.PackageName(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'google.cloud.dialogflow.v2'), createEmptyInstance: create)
...
class AnswerFeedback extends $pb.GeneratedMessage {
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'AnswerFeedback', package: const $pb.PackageName(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'google.cloud.dialogflow.v2'), createEmptyInstance: create)
    ..oo(0, [2])
    ...
    ..aOM<$10.Timestamp>(5, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'clickTime', subBuilder: $10.Timestamp.create)
    ..aOM<$10.Timestamp>(6, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'displayTime', subBuilder: $10.Timestamp.create)
    ..hasRequiredFields = false
  ;
  ...
  factory AnswerFeedback({
    ...
    $core.bool? clicked,
    $core.bool? displayed,
    $10.Timestamp? clickTime,
    $10.Timestamp? displayTime,
  }) {
    final _result = create();
  ...
  @$pb.TagNumber(5)
  $10.Timestamp get clickTime => $_getN(4);
  @$pb.TagNumber(5)
  set clickTime($10.Timestamp v) { setField(5, v); }
  @$pb.TagNumber(5)
  $core.bool hasClickTime() => $_has(4);
  @$pb.TagNumber(5)
  void clearClickTime() => clearField(5);
  @$pb.TagNumber(5)
  $10.Timestamp ensureClickTime() => $_ensure(4);

  @$pb.TagNumber(6)
  $10.Timestamp get displayTime => $_getN(5);
  @$pb.TagNumber(6)
  set displayTime($10.Timestamp v) { setField(6, v); }
  @$pb.TagNumber(6)
  $core.bool hasDisplayTime() => $_has(5);
  @$pb.TagNumber(6)
  void clearDisplayTime() => clearField(6);
  @$pb.TagNumber(6)
  $10.Timestamp ensureDisplayTime() => $_ensure(5);
}

class AgentAssistantFeedback extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'AgentAssistantFeedback', package: const $pb.PackageName(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'google.cloud.dialogflow.v2'), createEmptyInstance: create)
...
class AgentAssistantRecord extends $pb.GeneratedMessage {
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'AgentAssistantRecord', package: const $pb.PackageName(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'google.cloud.dialogflow.v2'), createEmptyInstance: create)
    ..oo(0, [5, 6])
    ..aOM<$7.ArticleAnswer>(5, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'articleSuggestionAnswer', subBuilder: $7.ArticleAnswer.create)
    ..aOM<$7.FaqAnswer>(6, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'faqAnswer', subBuilder: $7.FaqAnswer.create)
    ..hasRequiredFields = false
  ;

  AgentAssistantRecord._() : super();
  factory AgentAssistantRecord({
    $7.ArticleAnswer? articleSuggestionAnswer,
    $7.FaqAnswer? faqAnswer,
  }) {
    final _result = create();
  ...
  @$pb.TagNumber(5)
  $7.ArticleAnswer get articleSuggestionAnswer => $_getN(0);
  @$pb.TagNumber(5)
  set articleSuggestionAnswer($7.ArticleAnswer v) { setField(5, v); }
  @$pb.TagNumber(5)
  $core.bool hasArticleSuggestionAnswer() => $_has(0);
  @$pb.TagNumber(5)
  void clearArticleSuggestionAnswer() => clearField(5);
  @$pb.TagNumber(5)
  $7.ArticleAnswer ensureArticleSuggestionAnswer() => $_ensure(0);

  @$pb.TagNumber(6)
  $7.FaqAnswer get faqAnswer => $_getN(1);
  @$pb.TagNumber(6)
  set faqAnswer($7.FaqAnswer v) { setField(6, v); }
  @$pb.TagNumber(6)
  $core.bool hasFaqAnswer() => $_has(1);
  @$pb.TagNumber(6)
  void clearFaqAnswer() => clearField(6);
  @$pb.TagNumber(6)
  $7.FaqAnswer ensureFaqAnswer() => $_ensure(1);
}

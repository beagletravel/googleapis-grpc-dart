...
class HumanAgentAssistantEvent extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'HumanAgentAssistantEvent', package: const $pb.PackageName(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'google.cloud.dialogflow.v2'), createEmptyInstance: create)
    ..aOS(1, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'conversation')
    ..aOS(3, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'participant')
    ..pc<$7.SuggestionResult>(5, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'suggestionResults', $pb.PbFieldType.PM, subBuilder: $7.SuggestionResult.create)
  ...
  factory HumanAgentAssistantEvent({
    ...
    $core.Iterable<$7.SuggestionResult>? suggestionResults,
  }) {
  ...
  'Will be removed in next major version')
  HumanAgentAssistantEvent copyWith(void Function(HumanAgentAssistantEvent) updates) => super.copyWith((message) => updates(message as HumanAgentAssistantEvent)) as HumanAgentAssistantEvent; // ignore: deprecated_member_use
  ...
  @$pb.TagNumber(5)
  $core.List<$7.SuggestionResult> get suggestionResults => $_getList(2);
}

...
const EntityType$json = const {
  ...
  '2': const [
    ...
    const {'1': 'kind', '3': 3, '4': 1, '5': 14, '6': '.google.cloud.dialogflow.v2beta1.EntityType.Kind', '8': const {}, '10': 'kind'},
    const {'1': 'auto_expansion_mode', '3': 4, '4': 1, '5': 14, '6': '.google.cloud.dialogflow.v2beta1.EntityType.AutoExpansionMode', '8': const {}, '10': 'autoExpansionMode'},
    const {'1': 'entities', '3': 6, '4': 3, '5': 11, '6': '.google.cloud.dialogflow.v2beta1.EntityType.Entity', '8': const {}, '10': 'entities'},
...
final $typed_data.Uint8List listEntityTypesRequestDescriptor = $convert.base64Decode('');
...
const ListEntityTypesResponse$json = const {
  ...
  '2': const [
    const {'1': 'entity_types', '3': 1, '4': 3, '5': 11, '6': '.google.cloud.dialogflow.v2beta1.EntityType', '10': 'entityTypes'},
    const {'1': 'next_page_token', '3': 2, '4': 1, '5': 9, '10': 'nextPageToken'},
  ],
};

/// Descriptor for `ListEntityTypesResponse`. Decode as a `google.protobuf.DescriptorProto`.
final $typed_data.Uint8List listEntityTypesResponseDescriptor = $convert.base64Decode('ChdMaXN0RW50aXR5VHlwZXNSZXNwb25zZRJOCgxlbnRpdHlfdHlwZXMYASADKAsyKy5nb29nbGUuY2xvdWQuZGlhbG9nZmxvdy52MmJldGExLkVudGl0eVR5cGVSC2VudGl0eVR5cGVzEiYKD25leHRfcGFnZV90b2tlbhgCIAEoCVINbmV4dFBhZ2VUb2tlbg==');
...
final $typed_data.Uint8List getEntityTypeRequestDescriptor = $convert.base64Decode('ChRHZXRFbnRpdHlUeXBlUmVxdWVzdBJACgRuYW1lGAEgASgJQizgQQL6QSYKJGRpYWxvZ2Zsb3cuZ29vZ2xlYXBpcy5jb20vRW50aXR5VHlwZVIEbmFtZRIoCg1sYW5ndWFnZV9jb2RlGAIgASgJQgPgQQFSDGxhbmd1YWdlQ29kZQ==');
...
const CreateEntityTypeRequest$json = const {
  ...
  '2': const [
    const {'1': 'parent', '3': 1, '4': 1, '5': 9, '8': const {}, '10': 'parent'},
    const {'1': 'entity_type', '3': 2, '4': 1, '5': 11, '6': '.google.cloud.dialogflow.v2beta1.EntityType', '8': const {}, '10': 'entityType'},
...
final $typed_data.Uint8List createEntityTypeRequestDescriptor = $convert.base64Decode('');
...
const UpdateEntityTypeRequest$json = const {
  ...
  '2': const [
    const {'1': 'entity_type', '3': 1, '4': 1, '5': 11, '6': '.google.cloud.dialogflow.v2beta1.EntityType', '8': const {}, '10': 'entityType'},
    const {'1': 'language_code', '3': 2, '4': 1, '5': 9, '8': const {}, '10': 'languageCode'},
...
final $typed_data.Uint8List updateEntityTypeRequestDescriptor = $convert.base64Decode('');
...
final $typed_data.Uint8List deleteEntityTypeRequestDescriptor = $convert.base64Decode('ChdEZWxldGVFbnRpdHlUeXBlUmVxdWVzdBJACgRuYW1lGAEgASgJQizgQQL6QSYKJGRpYWxvZ2Zsb3cuZ29vZ2xlYXBpcy5jb20vRW50aXR5VHlwZVIEbmFtZQ==');
...
const BatchUpdateEntityTypesRequest$json = const {
  ...
  '2': const [
    ...
    const {'1': 'entity_type_batch_inline', '3': 3, '4': 1, '5': 11, '6': '.google.cloud.dialogflow.v2beta1.EntityTypeBatch', '9': 0, '10': 'entityTypeBatchInline'},
...
final $typed_data.Uint8List batchUpdateEntityTypesRequestDescriptor = $convert.base64Decode('');
...
final $typed_data.Uint8List batchUpdateEntityTypesResponseDescriptor = $convert.base64Decode('Ch5CYXRjaFVwZGF0ZUVudGl0eVR5cGVzUmVzcG9uc2USTgoMZW50aXR5X3R5cGVzGAEgAygLMisuZ29vZ2xlLmNsb3VkLmRpYWxvZ2Zsb3cudjJiZXRhMS5FbnRpdHlUeXBlUgtlbnRpdHlUeXBlcw==');
...
final $typed_data.Uint8List batchDeleteEntityTypesRequestDescriptor = $convert.base64Decode('Ch1CYXRjaERlbGV0ZUVudGl0eVR5cGVzUmVxdWVzdBJECgZwYXJlbnQYASABKAlCLOBBAvpBJhIkZGlhbG9nZmxvdy5nb29nbGVhcGlzLmNvbS9FbnRpdHlUeXBlUgZwYXJlbnQSLwoRZW50aXR5X3R5cGVfbmFtZXMYAiADKAlCA+BBAlIPZW50aXR5VHlwZU5hbWVz');
...
const BatchCreateEntitiesRequest$json = const {
  ...
  '2': const [
    const {'1': 'parent', '3': 1, '4': 1, '5': 9, '8': const {}, '10': 'parent'},
    const {'1': 'entities', '3': 2, '4': 3, '5': 11, '6': '.google.cloud.dialogflow.v2beta1.EntityType.Entity', '8': const {}, '10': 'entities'},
    const {'1': 'language_code', '3': 3, '4': 1, '5': 9, '8': const {}, '10': 'languageCode'},
  ],
};

/// Descriptor for `BatchCreateEntitiesRequest`. Decode as a `google.protobuf.DescriptorProto`.
final $typed_data.Uint8List batchCreateEntitiesRequestDescriptor = $convert.base64Decode('');
...
final $typed_data.Uint8List batchUpdateEntitiesRequestDescriptor = $convert.base64Decode('');
...
final $typed_data.Uint8List batchDeleteEntitiesRequestDescriptor = $convert.base64Decode('ChpCYXRjaERlbGV0ZUVudGl0aWVzUmVxdWVzdBJECgZwYXJlbnQYASABKAlCLOBBAvpBJgokZGlhbG9nZmxvdy5nb29nbGVhcGlzLmNvbS9FbnRpdHlUeXBlUgZwYXJlbnQSKAoNZW50aXR5X3ZhbHVlcxgCIAMoCUID4EECUgxlbnRpdHlWYWx1ZXMSKAoNbGFuZ3VhZ2VfY29kZRgDIAEoCUID4EEBUgxsYW5ndWFnZUNvZGU=');
...
final $typed_data.Uint8List entityTypeBatchDescriptor = $convert.base64Decode('Cg9FbnRpdHlUeXBlQmF0Y2gSTgoMZW50aXR5X3R5cGVzGAEgAygLMisuZ29vZ2xlLmNsb3VkLmRpYWxvZ2Zsb3cudjJiZXRhMS5FbnRpdHlUeXBlUgtlbnRpdHlUeXBlcw==');

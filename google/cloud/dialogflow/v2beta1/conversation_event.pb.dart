...
class ConversationEvent extends $pb.GeneratedMessage {
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'ConversationEvent', package: const $pb.PackageName(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'google.cloud.dialogflow.v2beta1'), createEmptyInstance: create)
    ..oo(0, [4])
    ...
    ..aOM<$10.Status>(3, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'errorStatus', subBuilder: $10.Status.create)
  ...
  @$pb.TagNumber(3)
  $10.Status get errorStatus => $_getN(2);
  @$pb.TagNumber(3)
  set errorStatus($10.Status v) { setField(3, v); }
  @$pb.TagNumber(3)
  $core.bool hasErrorStatus() => $_has(2);
  @$pb.TagNumber(3)
  void clearErrorStatus() => clearField(3);
  @$pb.TagNumber(3)
  $10.Status ensureErrorStatus() => $_ensure(2);

  @$pb.TagNumber(4)
  $9.Message get newMessagePayload => $_getN(3);
  @$pb.TagNumber(4)
  set newMessagePayload($9.Message v) { setField(4, v); }
  @$pb.TagNumber(4)

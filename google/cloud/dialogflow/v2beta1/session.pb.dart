...
import '../../../type/latlng.pb.dart' as $12;
...
class DetectIntentRequest extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'DetectIntentRequest', package: const $pb.PackageName(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'google.cloud.dialogflow.v2beta1'), createEmptyInstance: create)
    ...
    ..aOM<$9.OutputAudioConfig>(4, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'outputAudioConfig', subBuilder: $9.OutputAudioConfig.create)
    ..a<$core.List<$core.int>>(5, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'inputAudio', $pb.PbFieldType.OY)
    ..aOM<$10.FieldMask>(7, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'outputAudioConfigMask', subBuilder: $10.FieldMask.create)
  ...
  factory DetectIntentRequest({
    ...
    $9.OutputAudioConfig? outputAudioConfig,
    $core.List<$core.int>? inputAudio,
    $10.FieldMask? outputAudioConfigMask,
  }) {
  ...
  @$pb.TagNumber(4)
  set outputAudioConfig($9.OutputAudioConfig v) { setField(4, v); }
  @$pb.TagNumber(4)
  ...
  @$pb.TagNumber(7)
  $10.FieldMask get outputAudioConfigMask => $_getN(5);
  @$pb.TagNumber(7)
  set outputAudioConfigMask($10.FieldMask v) { setField(7, v); }
  @$pb.TagNumber(7)
  $core.bool hasOutputAudioConfigMask() => $_has(5);
  @$pb.TagNumber(7)
  void clearOutputAudioConfigMask() => clearField(7);
  @$pb.TagNumber(7)
  $10.FieldMask ensureOutputAudioConfigMask() => $_ensure(5);
}

class DetectIntentResponse extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'DetectIntentResponse', package: const $pb.PackageName(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'google.cloud.dialogflow.v2beta1'), createEmptyInstance: create)
    ...
    ..aOM<$11.Status>(3, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'webhookStatus', subBuilder: $11.Status.create)
    ...
    ..aOM<$9.OutputAudioConfig>(6, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'outputAudioConfig', subBuilder: $9.OutputAudioConfig.create)
    ..hasRequiredFields = false
  ;
  ...
  @$pb.TagNumber(3)
  $11.Status get webhookStatus => $_getN(2);
  @$pb.TagNumber(3)
  set webhookStatus($11.Status v) { setField(3, v); }
  @$pb.TagNumber(3)
  $core.bool hasWebhookStatus() => $_has(2);
  @$pb.TagNumber(3)
  void clearWebhookStatus() => clearField(3);
  @$pb.TagNumber(3)
  $11.Status ensureWebhookStatus() => $_ensure(2);
  ...
  @$pb.TagNumber(6)
  set outputAudioConfig($9.OutputAudioConfig v) { setField(6, v); }
  @$pb.TagNumber(6)
...
class QueryParameters extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'QueryParameters', package: const $pb.PackageName(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'google.cloud.dialogflow.v2beta1'), createEmptyInstance: create)
    ..aOS(1, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'timeZone')
    ..aOM<$12.LatLng>(2, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'geoLocation', subBuilder: $12.LatLng.create)
    ..pc<$4.Context>(3, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'contexts', $pb.PbFieldType.PM, subBuilder: $4.Context.create)
    ...
    ..aOM<$13.Struct>(6, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'payload', subBuilder: $13.Struct.create)
    ...
    ..pc<$2.SubAgent>(13, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'subAgents', $pb.PbFieldType.PM, subBuilder: $2.SubAgent.create)
  ...
  factory QueryParameters({
    ...
    $core.Iterable<$2.SubAgent>? subAgents,
  ...
  @$pb.TagNumber(2)
  $12.LatLng get geoLocation => $_getN(1);
  @$pb.TagNumber(2)
  set geoLocation($12.LatLng v) { setField(2, v); }
  @$pb.TagNumber(2)
  $core.bool hasGeoLocation() => $_has(1);
  @$pb.TagNumber(2)
  void clearGeoLocation() => clearField(2);
  @$pb.TagNumber(2)
  $12.LatLng ensureGeoLocation() => $_ensure(1);
  ...
  @$pb.TagNumber(6)
  $13.Struct get payload => $_getN(5);
  @$pb.TagNumber(6)
  set payload($13.Struct v) { setField(6, v); }
  @$pb.TagNumber(6)
  $core.bool hasPayload() => $_has(5);
  @$pb.TagNumber(6)
  void clearPayload() => clearField(6);
  @$pb.TagNumber(6)
  $13.Struct ensurePayload() => $_ensure(5);
  ...
  @$pb.TagNumber(13)
  $core.List<$2.SubAgent> get subAgents => $_getList(8);
...
class QueryInput extends $pb.GeneratedMessage {
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'QueryInput', package: const $pb.PackageName(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'google.cloud.dialogflow.v2beta1'), createEmptyInstance: create)
    ..oo(0, [1, 2, 3, 4])
    ..aOM<$9.InputAudioConfig>(1, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'audioConfig', subBuilder: $9.InputAudioConfig.create)
    ..aOM<TextInput>(2, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'text', subBuilder: TextInput.create)
    ..aOM<EventInput>(3, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'event', subBuilder: EventInput.create)
    ..aOM<$9.TelephonyDtmfEvents>(4, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'dtmf', subBuilder: $9.TelephonyDtmfEvents.create)
    ..hasRequiredFields = false
  ;

  QueryInput._() : super();
  factory QueryInput({
    $9.InputAudioConfig? audioConfig,
    TextInput? text,
    EventInput? event,
    $9.TelephonyDtmfEvents? dtmf,
  }) {
    final _result = create();
    if (audioConfig != null) {
  ...
  @$pb.TagNumber(1)
  set audioConfig($9.InputAudioConfig v) { setField(1, v); }
  @$pb.TagNumber(1)
  ...
  @$pb.TagNumber(4)
  $9.TelephonyDtmfEvents get dtmf => $_getN(3);
  @$pb.TagNumber(4)
  set dtmf($9.TelephonyDtmfEvents v) { setField(4, v); }
  @$pb.TagNumber(4)
  $core.bool hasDtmf() => $_has(3);
  @$pb.TagNumber(4)
  void clearDtmf() => clearField(4);
  @$pb.TagNumber(4)
  $9.TelephonyDtmfEvents ensureDtmf() => $_ensure(3);
}

class QueryResult extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'QueryResult', package: const $pb.PackageName(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'google.cloud.dialogflow.v2beta1'), createEmptyInstance: create)
    ..aOS(1, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'queryText')
    ..a<$core.double>(2, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'speechRecognitionConfidence', $pb.PbFieldType.OF)
    ..aOS(3, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'action')
    ..aOM<$13.Struct>(4, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'parameters', subBuilder: $13.Struct.create)
    ...
    ..aOM<$13.Struct>(9, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'webhookPayload', subBuilder: $13.Struct.create)
    ...
    ..aOM<$13.Struct>(14, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'diagnosticInfo', subBuilder: $13.Struct.create)
    ...
    ..aOB(21, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'cancelsSlotFilling')
    ..hasRequiredFields = false
  ;
  ...
  factory QueryResult({
    ...
    if (cancelsSlotFilling != null) {
      _result.cancelsSlotFilling = cancelsSlotFilling;
    }
    return _result;
  }
  ...
  @$pb.TagNumber(4)
  $13.Struct get parameters => $_getN(3);
  @$pb.TagNumber(4)
  set parameters($13.Struct v) { setField(4, v); }
  @$pb.TagNumber(4)
  $core.bool hasParameters() => $_has(3);
  @$pb.TagNumber(4)
  void clearParameters() => clearField(4);
  @$pb.TagNumber(4)
  $13.Struct ensureParameters() => $_ensure(3);
  ...
  @$pb.TagNumber(9)
  $13.Struct get webhookPayload => $_getN(8);
  @$pb.TagNumber(9)
  set webhookPayload($13.Struct v) { setField(9, v); }
  @$pb.TagNumber(9)
  $core.bool hasWebhookPayload() => $_has(8);
  @$pb.TagNumber(9)
  void clearWebhookPayload() => clearField(9);
  @$pb.TagNumber(9)
  $13.Struct ensureWebhookPayload() => $_ensure(8);
  ...
  @$pb.TagNumber(14)
  $13.Struct get diagnosticInfo => $_getN(12);
  @$pb.TagNumber(14)
  set diagnosticInfo($13.Struct v) { setField(14, v); }
  @$pb.TagNumber(14)
  $core.bool hasDiagnosticInfo() => $_has(12);
  @$pb.TagNumber(14)
  void clearDiagnosticInfo() => clearField(14);
  @$pb.TagNumber(14)
  $13.Struct ensureDiagnosticInfo() => $_ensure(12);
...
class KnowledgeAnswers_Answer extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'KnowledgeAnswers.Answer', package: const $pb.PackageName(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'google.cloud.dialogflow.v2beta1'), createEmptyInstance: create)
    ..aOS(1, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'source')
    ..aOS(2, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'faqQuestion')
    ..aOS(3, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'answer')
    ..e<KnowledgeAnswers_Answer_MatchConfidenceLevel>(4, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'matchConfidenceLevel', $pb.PbFieldType.OE, defaultOrMaker: KnowledgeAnswers_Answer_MatchConfidenceLevel.MATCH_CONFIDENCE_LEVEL_UNSPECIFIED, valueOf: KnowledgeAnswers_Answer_MatchConfidenceLevel.valueOf, enumValues: KnowledgeAnswers_Answer_MatchConfidenceLevel.values)
  ...
  'Use [GeneratedMessageGenericExtensions.rebuild] instead. '
  'Will be removed in next major version')
  KnowledgeAnswers_Answer copyWith(void Function(KnowledgeAnswers_Answer) updates) => super.copyWith((message) => updates(message as KnowledgeAnswers_Answer)) as KnowledgeAnswers_Answer; // ignore: deprecated_member_use
  $pb.BuilderInfo get info_ => _i;
  @$core.pragma('dart2js:noInline')
...
class KnowledgeAnswers extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'KnowledgeAnswers', package: const $pb.PackageName(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'google.cloud.dialogflow.v2beta1'), createEmptyInstance: create)
    ..pc<KnowledgeAnswers_Answer>(1, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'answers', $pb.PbFieldType.PM, subBuilder: KnowledgeAnswers_Answer.create)
    ..hasRequiredFields = false
  ;
  ...
  'Use [GeneratedMessageGenericExtensions.rebuild] instead. '
  'Will be removed in next major version')
  KnowledgeAnswers copyWith(void Function(KnowledgeAnswers) updates) => super.copyWith((message) => updates(message as KnowledgeAnswers)) as KnowledgeAnswers; // ignore: deprecated_member_use
  $pb.BuilderInfo get info_ => _i;
  @$core.pragma('dart2js:noInline')
...
class StreamingDetectIntentRequest extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'StreamingDetectIntentRequest', package: const $pb.PackageName(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'google.cloud.dialogflow.v2beta1'), createEmptyInstance: create)
    ..aOS(1, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'session')
    ..aOM<QueryParameters>(2, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'queryParams', subBuilder: QueryParameters.create)
    ..aOM<QueryInput>(3, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'queryInput', subBuilder: QueryInput.create)
    ..aOB(4, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'singleUtterance')
    ..aOM<$9.OutputAudioConfig>(5, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'outputAudioConfig', subBuilder: $9.OutputAudioConfig.create)
  ...
  @$pb.TagNumber(5)
  set outputAudioConfig($9.OutputAudioConfig v) { setField(5, v); }
  @$pb.TagNumber(5)
  ...
  @$pb.TagNumber(7)
  $10.FieldMask get outputAudioConfigMask => $_getN(6);
  @$pb.TagNumber(7)
  set outputAudioConfigMask($10.FieldMask v) { setField(7, v); }
  @$pb.TagNumber(7)
  ...
  void clearOutputAudioConfigMask() => clearField(7);
  @$pb.TagNumber(7)
  $10.FieldMask ensureOutputAudioConfigMask() => $_ensure(6);
}

class StreamingDetectIntentResponse extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'StreamingDetectIntentResponse', package: const $pb.PackageName(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'google.cloud.dialogflow.v2beta1'), createEmptyInstance: create)
    ..aOS(1, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'responseId')
    ..aOM<StreamingRecognitionResult>(2, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'recognitionResult', subBuilder: StreamingRecognitionResult.create)
    ..aOM<QueryResult>(3, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'queryResult', subBuilder: QueryResult.create)
    ..aOM<$11.Status>(4, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'webhookStatus', subBuilder: $11.Status.create)
  ...
  @$pb.TagNumber(4)
  $11.Status get webhookStatus => $_getN(3);
  @$pb.TagNumber(4)
  set webhookStatus($11.Status v) { setField(4, v); }
  @$pb.TagNumber(4)
  $core.bool hasWebhookStatus() => $_has(3);
  @$pb.TagNumber(4)
  void clearWebhookStatus() => clearField(4);
  @$pb.TagNumber(4)
  $11.Status ensureWebhookStatus() => $_ensure(3);
...
class StreamingRecognitionResult extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'StreamingRecognitionResult', package: const $pb.PackageName(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'google.cloud.dialogflow.v2beta1'), createEmptyInstance: create)
    ...
    ..aOM<$9.TelephonyDtmfEvents>(5, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'dtmfDigits', subBuilder: $9.TelephonyDtmfEvents.create)
    ..a<$core.double>(6, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'stability', $pb.PbFieldType.OF)
    ..pc<$9.SpeechWordInfo>(7, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'speechWordInfo', $pb.PbFieldType.PM, subBuilder: $9.SpeechWordInfo.create)
    ..aOM<$14.Duration>(8, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'speechEndOffset', subBuilder: $14.Duration.create)
  ...
  factory StreamingRecognitionResult({
    ...
    $9.TelephonyDtmfEvents? dtmfDigits,
    $core.double? stability,
    $core.Iterable<$9.SpeechWordInfo>? speechWordInfo,
    $14.Duration? speechEndOffset,
    $core.String? languageCode,
  }) {
    final _result = create();
    if (messageType != null) {
  ...
  @$pb.TagNumber(5)
  $9.TelephonyDtmfEvents get dtmfDigits => $_getN(4);
  @$pb.TagNumber(5)
  set dtmfDigits($9.TelephonyDtmfEvents v) { setField(5, v); }
  @$pb.TagNumber(5)
  $core.bool hasDtmfDigits() => $_has(4);
  @$pb.TagNumber(5)
  void clearDtmfDigits() => clearField(5);
  @$pb.TagNumber(5)
  $9.TelephonyDtmfEvents ensureDtmfDigits() => $_ensure(4);
  ...
  @$pb.TagNumber(7)
  $core.List<$9.SpeechWordInfo> get speechWordInfo => $_getList(6);

  @$pb.TagNumber(8)
  $14.Duration get speechEndOffset => $_getN(7);
  @$pb.TagNumber(8)
  set speechEndOffset($14.Duration v) { setField(8, v); }
  @$pb.TagNumber(8)
  $core.bool hasSpeechEndOffset() => $_has(7);
  @$pb.TagNumber(8)
  void clearSpeechEndOffset() => clearField(8);
  @$pb.TagNumber(8)
  $14.Duration ensureSpeechEndOffset() => $_ensure(7);
...
class TextInput extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'TextInput', package: const $pb.PackageName(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'google.cloud.dialogflow.v2beta1'), createEmptyInstance: create)
...
class EventInput extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'EventInput', package: const $pb.PackageName(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'google.cloud.dialogflow.v2beta1'), createEmptyInstance: create)
    ..aOS(1, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'name')
    ..aOM<$13.Struct>(2, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'parameters', subBuilder: $13.Struct.create)
  ...
  @$pb.TagNumber(2)
  $13.Struct get parameters => $_getN(1);
  @$pb.TagNumber(2)
  set parameters($13.Struct v) { setField(2, v); }
  @$pb.TagNumber(2)
  $core.bool hasParameters() => $_has(1);
  @$pb.TagNumber(2)
  void clearParameters() => clearField(2);
  @$pb.TagNumber(2)
  $13.Struct ensureParameters() => $_ensure(1);
...
class SentimentAnalysisRequestConfig extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'SentimentAnalysisRequestConfig', package: const $pb.PackageName(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'google.cloud.dialogflow.v2beta1'), createEmptyInstance: create)
    ..aOB(1, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'analyzeQueryTextSentiment')
    ..hasRequiredFields = false
  ;
  ...
  'Use [GeneratedMessageGenericExtensions.rebuild] instead. '
  'Will be removed in next major version')
  SentimentAnalysisRequestConfig copyWith(void Function(SentimentAnalysisRequestConfig) updates) => super.copyWith((message) => updates(message as SentimentAnalysisRequestConfig)) as SentimentAnalysisRequestConfig; // ignore: deprecated_member_use
  $pb.BuilderInfo get info_ => _i;
  @$core.pragma('dart2js:noInline')
...
class SentimentAnalysisResult extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'SentimentAnalysisResult', package: const $pb.PackageName(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'google.cloud.dialogflow.v2beta1'), createEmptyInstance: create)
    ..aOM<Sentiment>(1, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'queryTextSentiment', subBuilder: Sentiment.create)
    ..hasRequiredFields = false
  ;
...
class Sentiment extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'Sentiment', package: const $pb.PackageName(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'google.cloud.dialogflow.v2beta1'), createEmptyInstance: create)

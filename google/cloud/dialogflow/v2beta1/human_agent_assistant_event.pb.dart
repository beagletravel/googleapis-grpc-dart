...
class HumanAgentAssistantEvent extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'HumanAgentAssistantEvent', package: const $pb.PackageName(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'google.cloud.dialogflow.v2beta1'), createEmptyInstance: create)
    ...
    ..pc<$9.SuggestionResult>(5, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'suggestionResults', $pb.PbFieldType.PM, subBuilder: $9.SuggestionResult.create)

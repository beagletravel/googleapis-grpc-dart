...
const Environment$json = const {
  ...
  '2': const [
    ...
    const {'1': 'state', '3': 4, '4': 1, '5': 14, '6': '.google.cloud.dialogflow.v2beta1.Environment.State', '8': const {}, '10': 'state'},
    const {'1': 'update_time', '3': 5, '4': 1, '5': 11, '6': '.google.protobuf.Timestamp', '8': const {}, '10': 'updateTime'},
    const {'1': 'text_to_speech_settings', '3': 7, '4': 1, '5': 11, '6': '.google.cloud.dialogflow.v2beta1.TextToSpeechSettings', '8': const {}, '10': 'textToSpeechSettings'},
    const {'1': 'fulfillment', '3': 8, '4': 1, '5': 11, '6': '.google.cloud.dialogflow.v2beta1.Fulfillment', '8': const {}, '10': 'fulfillment'},
  ],
...
const TextToSpeechSettings$json = const {
  ...
  '2': const [
    ...
    const {'1': 'output_audio_encoding', '3': 2, '4': 1, '5': 14, '6': '.google.cloud.dialogflow.v2beta1.OutputAudioEncoding', '8': const {}, '10': 'outputAudioEncoding'},
    const {'1': 'sample_rate_hertz', '3': 3, '4': 1, '5': 5, '8': const {}, '10': 'sampleRateHertz'},
    const {'1': 'synthesize_speech_configs', '3': 4, '4': 3, '5': 11, '6': '.google.cloud.dialogflow.v2beta1.TextToSpeechSettings.SynthesizeSpeechConfigsEntry', '8': const {}, '10': 'synthesizeSpeechConfigs'},
  ],
...
const TextToSpeechSettings_SynthesizeSpeechConfigsEntry$json = const {
  ...
  '2': const [
    ...
    const {'1': 'value', '3': 2, '4': 1, '5': 11, '6': '.google.cloud.dialogflow.v2beta1.SynthesizeSpeechConfig', '10': 'value'},
  ],
  '7': const {'7': true},
};

/// Descriptor for `TextToSpeechSettings`. Decode as a `google.protobuf.DescriptorProto`.
final $typed_data.Uint8List textToSpeechSettingsDescriptor = $convert.base64Decode('');
...
const ListEnvironmentsResponse$json = const {
  ...
  '2': const [
    const {'1': 'environments', '3': 1, '4': 3, '5': 11, '6': '.google.cloud.dialogflow.v2beta1.Environment', '10': 'environments'},
    const {'1': 'next_page_token', '3': 2, '4': 1, '5': 9, '10': 'nextPageToken'},
  ],
};

/// Descriptor for `ListEnvironmentsResponse`. Decode as a `google.protobuf.DescriptorProto`.
final $typed_data.Uint8List listEnvironmentsResponseDescriptor = $convert.base64Decode('ChhMaXN0RW52aXJvbm1lbnRzUmVzcG9uc2USUAoMZW52aXJvbm1lbnRzGAEgAygLMiwuZ29vZ2xlLmNsb3VkLmRpYWxvZ2Zsb3cudjJiZXRhMS5FbnZpcm9ubWVudFIMZW52aXJvbm1lbnRzEiYKD25leHRfcGFnZV90b2tlbhgCIAEoCVINbmV4dFBhZ2VUb2tlbg==');
...
const CreateEnvironmentRequest$json = const {
  ...
  '2': const [
    const {'1': 'parent', '3': 1, '4': 1, '5': 9, '8': const {}, '10': 'parent'},
    const {'1': 'environment', '3': 2, '4': 1, '5': 11, '6': '.google.cloud.dialogflow.v2beta1.Environment', '8': const {}, '10': 'environment'},
...
final $typed_data.Uint8List createEnvironmentRequestDescriptor = $convert.base64Decode('');
...
const UpdateEnvironmentRequest$json = const {
  ...
  '2': const [
    const {'1': 'environment', '3': 1, '4': 1, '5': 11, '6': '.google.cloud.dialogflow.v2beta1.Environment', '8': const {}, '10': 'environment'},
...
final $typed_data.Uint8List updateEnvironmentRequestDescriptor = $convert.base64Decode('');
...
const EnvironmentHistory$json = const {
  ...
  '2': const [
    const {'1': 'parent', '3': 1, '4': 1, '5': 9, '8': const {}, '10': 'parent'},
    const {'1': 'entries', '3': 2, '4': 3, '5': 11, '6': '.google.cloud.dialogflow.v2beta1.EnvironmentHistory.Entry', '8': const {}, '10': 'entries'},

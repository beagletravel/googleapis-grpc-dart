...
class ValidationError extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'ValidationError', package: const $pb.PackageName(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'google.cloud.dialogflow.v2beta1'), createEmptyInstance: create)
    ..e<ValidationError_Severity>(1, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'severity', $pb.PbFieldType.OE, defaultOrMaker: ValidationError_Severity.SEVERITY_UNSPECIFIED, valueOf: ValidationError_Severity.valueOf, enumValues: ValidationError_Severity.values)
    ..pPS(3, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'entries')
  ...
  'Will be removed in next major version')
  ValidationError copyWith(void Function(ValidationError) updates) => super.copyWith((message) => updates(message as ValidationError)) as ValidationError; // ignore: deprecated_member_use
...
class ValidationResult extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'ValidationResult', package: const $pb.PackageName(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'google.cloud.dialogflow.v2beta1'), createEmptyInstance: create)
    ..pc<ValidationError>(1, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'validationErrors', $pb.PbFieldType.PM, subBuilder: ValidationError.create)
    ..hasRequiredFields = false
  ;

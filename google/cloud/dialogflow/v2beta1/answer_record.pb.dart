...
class AnswerRecord extends $pb.GeneratedMessage {
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'AnswerRecord', package: const $pb.PackageName(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'google.cloud.dialogflow.v2beta1'), createEmptyInstance: create)
    ..oo(0, [4])
    ..aOS(1, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'name')
    ..aOM<AnswerFeedback>(3, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'answerFeedback', subBuilder: AnswerFeedback.create)
    ..aOM<AgentAssistantRecord>(4, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'agentAssistantRecord', subBuilder: AgentAssistantRecord.create)
  ...
  'Will be removed in next major version')
  AnswerRecord copyWith(void Function(AnswerRecord) updates) => super.copyWith((message) => updates(message as AnswerRecord)) as AnswerRecord; // ignore: deprecated_member_use
...
class AgentAssistantRecord extends $pb.GeneratedMessage {
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'AgentAssistantRecord', package: const $pb.PackageName(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'google.cloud.dialogflow.v2beta1'), createEmptyInstance: create)
    ..oo(0, [5, 6])
    ..aOM<$9.ArticleAnswer>(5, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'articleSuggestionAnswer', subBuilder: $9.ArticleAnswer.create)
    ..aOM<$9.FaqAnswer>(6, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'faqAnswer', subBuilder: $9.FaqAnswer.create)
    ..hasRequiredFields = false
  ;
  ...
  'Use [GeneratedMessageGenericExtensions.rebuild] instead. '
  'Will be removed in next major version')
  AgentAssistantRecord copyWith(void Function(AgentAssistantRecord) updates) => super.copyWith((message) => updates(message as AgentAssistantRecord)) as AgentAssistantRecord; // ignore: deprecated_member_use
  $pb.BuilderInfo get info_ => _i;
  @$core.pragma('dart2js:noInline')
  ...
  @$pb.TagNumber(5)
  set articleSuggestionAnswer($9.ArticleAnswer v) { setField(5, v); }
  @$pb.TagNumber(5)
  ...
  @$pb.TagNumber(6)
  set faqAnswer($9.FaqAnswer v) { setField(6, v); }
  @$pb.TagNumber(6)
...
class AnswerFeedback extends $pb.GeneratedMessage {
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'AnswerFeedback', package: const $pb.PackageName(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'google.cloud.dialogflow.v2beta1'), createEmptyInstance: create)
    ..oo(0, [2])
    ...
    ..aOM<AgentAssistantFeedback>(2, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'agentAssistantDetailFeedback', subBuilder: AgentAssistantFeedback.create)
    ...
    ..aOM<$11.Timestamp>(5, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'clickTime', subBuilder: $11.Timestamp.create)
    ..aOM<$11.Timestamp>(6, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'displayTime', subBuilder: $11.Timestamp.create)
    ..hasRequiredFields = false
  ;
  ...
  factory AnswerFeedback({
    ...
    $core.bool? clicked,
    $core.bool? displayed,
    $11.Timestamp? clickTime,
    $11.Timestamp? displayTime,
  }) {
    final _result = create();
  ...
  @$pb.TagNumber(5)
  $11.Timestamp get clickTime => $_getN(4);
  @$pb.TagNumber(5)
  set clickTime($11.Timestamp v) { setField(5, v); }
  @$pb.TagNumber(5)
  $core.bool hasClickTime() => $_has(4);
  @$pb.TagNumber(5)
  void clearClickTime() => clearField(5);
  @$pb.TagNumber(5)
  $11.Timestamp ensureClickTime() => $_ensure(4);

  @$pb.TagNumber(6)
  $11.Timestamp get displayTime => $_getN(5);
  @$pb.TagNumber(6)
  set displayTime($11.Timestamp v) { setField(6, v); }
  @$pb.TagNumber(6)
  $core.bool hasDisplayTime() => $_has(5);
  @$pb.TagNumber(6)
  void clearDisplayTime() => clearField(6);
  @$pb.TagNumber(6)
  $11.Timestamp ensureDisplayTime() => $_ensure(5);
}

class AgentAssistantFeedback_SummarizationFeedback extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'AgentAssistantFeedback.SummarizationFeedback', package: const $pb.PackageName(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'google.cloud.dialogflow.v2beta1'), createEmptyInstance: create)
    ..aOM<$11.Timestamp>(1, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'startTimestamp', subBuilder: $11.Timestamp.create)
    ..aOM<$11.Timestamp>(2, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'submitTimestamp', subBuilder: $11.Timestamp.create)
  ...
  factory AgentAssistantFeedback_SummarizationFeedback({
    $11.Timestamp? startTimestamp,
    $11.Timestamp? submitTimestamp,
  ...
  'Use [GeneratedMessageGenericExtensions.rebuild] instead. '
  'Will be removed in next major version')
  AgentAssistantFeedback_SummarizationFeedback copyWith(void Function(AgentAssistantFeedback_SummarizationFeedback) updates) => super.copyWith((message) => updates(message as AgentAssistantFeedback_SummarizationFeedback)) as AgentAssistantFeedback_SummarizationFeedback; // ignore: deprecated_member_use
  $pb.BuilderInfo get info_ => _i;
  @$core.pragma('dart2js:noInline')
  ...
  @$pb.TagNumber(1)
  $11.Timestamp get startTimestamp => $_getN(0);
  @$pb.TagNumber(1)
  set startTimestamp($11.Timestamp v) { setField(1, v); }
  @$pb.TagNumber(1)
  $core.bool hasStartTimestamp() => $_has(0);
  @$pb.TagNumber(1)
  void clearStartTimestamp() => clearField(1);
  @$pb.TagNumber(1)
  $11.Timestamp ensureStartTimestamp() => $_ensure(0);

  @$pb.TagNumber(2)
  $11.Timestamp get submitTimestamp => $_getN(1);
  @$pb.TagNumber(2)
  set submitTimestamp($11.Timestamp v) { setField(2, v); }
  @$pb.TagNumber(2)
  $core.bool hasSubmitTimestamp() => $_has(1);
  @$pb.TagNumber(2)
  void clearSubmitTimestamp() => clearField(2);
  @$pb.TagNumber(2)
  $11.Timestamp ensureSubmitTimestamp() => $_ensure(1);
...
class AgentAssistantFeedback extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'AgentAssistantFeedback', package: const $pb.PackageName(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'google.cloud.dialogflow.v2beta1'), createEmptyInstance: create)
    ..e<AgentAssistantFeedback_AnswerRelevance>(1, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'answerRelevance', $pb.PbFieldType.OE, defaultOrMaker: AgentAssistantFeedback_AnswerRelevance.ANSWER_RELEVANCE_UNSPECIFIED, valueOf: AgentAssistantFeedback_AnswerRelevance.valueOf, enumValues: AgentAssistantFeedback_AnswerRelevance.values)
    ..e<AgentAssistantFeedback_DocumentCorrectness>(2, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'documentCorrectness', $pb.PbFieldType.OE, defaultOrMaker: AgentAssistantFeedback_DocumentCorrectness.DOCUMENT_CORRECTNESS_UNSPECIFIED, valueOf: AgentAssistantFeedback_DocumentCorrectness.valueOf, enumValues: AgentAssistantFeedback_DocumentCorrectness.values)
    ..e<AgentAssistantFeedback_DocumentEfficiency>(3, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'documentEfficiency', $pb.PbFieldType.OE, defaultOrMaker: AgentAssistantFeedback_DocumentEfficiency.DOCUMENT_EFFICIENCY_UNSPECIFIED, valueOf: AgentAssistantFeedback_DocumentEfficiency.valueOf, enumValues: AgentAssistantFeedback_DocumentEfficiency.values)
  ...
  'Use [GeneratedMessageGenericExtensions.rebuild] instead. '
  'Will be removed in next major version')
  AgentAssistantFeedback copyWith(void Function(AgentAssistantFeedback) updates) => super.copyWith((message) => updates(message as AgentAssistantFeedback)) as AgentAssistantFeedback; // ignore: deprecated_member_use
  $pb.BuilderInfo get info_ => _i;
  @$core.pragma('dart2js:noInline')
...
class GetAnswerRecordRequest extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'GetAnswerRecordRequest', package: const $pb.PackageName(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'google.cloud.dialogflow.v2beta1'), createEmptyInstance: create)
    ..aOS(1, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'name')
    ..hasRequiredFields = false
  ;
  ...
  'Use [GeneratedMessageGenericExtensions.rebuild] instead. '
  'Will be removed in next major version')
  GetAnswerRecordRequest copyWith(void Function(GetAnswerRecordRequest) updates) => super.copyWith((message) => updates(message as GetAnswerRecordRequest)) as GetAnswerRecordRequest; // ignore: deprecated_member_use
  $pb.BuilderInfo get info_ => _i;
  @$core.pragma('dart2js:noInline')
...
class ListAnswerRecordsRequest extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'ListAnswerRecordsRequest', package: const $pb.PackageName(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'google.cloud.dialogflow.v2beta1'), createEmptyInstance: create)
  ...
  'Use [GeneratedMessageGenericExtensions.rebuild] instead. '
  'Will be removed in next major version')
  ListAnswerRecordsRequest copyWith(void Function(ListAnswerRecordsRequest) updates) => super.copyWith((message) => updates(message as ListAnswerRecordsRequest)) as ListAnswerRecordsRequest; // ignore: deprecated_member_use
  $pb.BuilderInfo get info_ => _i;
  @$core.pragma('dart2js:noInline')
...
class ListAnswerRecordsResponse extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'ListAnswerRecordsResponse', package: const $pb.PackageName(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'google.cloud.dialogflow.v2beta1'), createEmptyInstance: create)
    ..pc<AnswerRecord>(1, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'answerRecords', $pb.PbFieldType.PM, subBuilder: AnswerRecord.create)
  ...
  'Use [GeneratedMessageGenericExtensions.rebuild] instead. '
  'Will be removed in next major version')
  ListAnswerRecordsResponse copyWith(void Function(ListAnswerRecordsResponse) updates) => super.copyWith((message) => updates(message as ListAnswerRecordsResponse)) as ListAnswerRecordsResponse; // ignore: deprecated_member_use
  $pb.BuilderInfo get info_ => _i;
  @$core.pragma('dart2js:noInline')
...
class UpdateAnswerRecordRequest extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'UpdateAnswerRecordRequest', package: const $pb.PackageName(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'google.cloud.dialogflow.v2beta1'), createEmptyInstance: create)
    ..aOM<AnswerRecord>(1, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'answerRecord', subBuilder: AnswerRecord.create)
  ...
  'Use [GeneratedMessageGenericExtensions.rebuild] instead. '
  'Will be removed in next major version')
  UpdateAnswerRecordRequest copyWith(void Function(UpdateAnswerRecordRequest) updates) => super.copyWith((message) => updates(message as UpdateAnswerRecordRequest)) as UpdateAnswerRecordRequest; // ignore: deprecated_member_use
  $pb.BuilderInfo get info_ => _i;
  @$core.pragma('dart2js:noInline')

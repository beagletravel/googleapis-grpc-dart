...
class WebhookRequest extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'WebhookRequest', package: const $pb.PackageName(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'google.cloud.dialogflow.v2beta1'), createEmptyInstance: create)
    ..aOS(1, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'responseId')
    ..aOM<$8.QueryResult>(2, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'queryResult', subBuilder: $8.QueryResult.create)
    ...
    ..pc<$8.QueryResult>(5, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'alternativeQueryResults', $pb.PbFieldType.PM, subBuilder: $8.QueryResult.create)
  ...
  factory WebhookRequest({
    ...
    $core.String? session,
    $core.Iterable<$8.QueryResult>? alternativeQueryResults,
  }) {
  ...
  @$pb.TagNumber(2)
  set queryResult($8.QueryResult v) { setField(2, v); }
  @$pb.TagNumber(2)
  ...
  @$pb.TagNumber(5)
  $core.List<$8.QueryResult> get alternativeQueryResults => $_getList(4);
}

class WebhookResponse extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'WebhookResponse', package: const $pb.PackageName(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'google.cloud.dialogflow.v2beta1'), createEmptyInstance: create)
  ...
  @$pb.TagNumber(6)
  set followupEventInput($8.EventInput v) { setField(6, v); }
  @$pb.TagNumber(6)
  ...
  @$pb.TagNumber(10)
  $core.List<$7.SessionEntityType> get sessionEntityTypes => $_getList(8);
}

class OriginalDetectIntentRequest extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'OriginalDetectIntentRequest', package: const $pb.PackageName(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'google.cloud.dialogflow.v2beta1'), createEmptyInstance: create)
    ...
    ..aOM<$9.Struct>(3, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'payload', subBuilder: $9.Struct.create)
    ..hasRequiredFields = false
  ;
  ...
  @$pb.TagNumber(3)
  set payload($9.Struct v) { setField(3, v); }
  @$pb.TagNumber(3)

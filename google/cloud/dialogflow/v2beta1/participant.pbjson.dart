...
const Participant$json = const {
  ...
  '2': const [
    ...
    const {'1': 'documents_metadata_filters', '3': 8, '4': 3, '5': 11, '6': '.google.cloud.dialogflow.v2beta1.Participant.DocumentsMetadataFiltersEntry', '8': const {}, '10': 'documentsMetadataFilters'},
  ],
...
final $typed_data.Uint8List participantDescriptor = $convert.base64Decode('');
...
final $typed_data.Uint8List createParticipantRequestDescriptor = $convert.base64Decode('ChhDcmVhdGVQYXJ0aWNpcGFudFJlcXVlc3QSRQoGcGFyZW50GAEgASgJQi3gQQL6QScSJWRpYWxvZ2Zsb3cuZ29vZ2xlYXBpcy5jb20vUGFydGljaXBhbnRSBnBhcmVudBJTCgtwYXJ0aWNpcGFudBgCIAEoCzIsLmdvb2dsZS5jbG91ZC5kaWFsb2dmbG93LnYyYmV0YTEuUGFydGljaXBhbnRCA+BBAlILcGFydGljaXBhbnQ=');
...
final $typed_data.Uint8List listParticipantsResponseDescriptor = $convert.base64Decode('ChhMaXN0UGFydGljaXBhbnRzUmVzcG9uc2USUAoMcGFydGljaXBhbnRzGAEgAygLMiwuZ29vZ2xlLmNsb3VkLmRpYWxvZ2Zsb3cudjJiZXRhMS5QYXJ0aWNpcGFudFIMcGFydGljaXBhbnRzEiYKD25leHRfcGFnZV90b2tlbhgCIAEoCVINbmV4dFBhZ2VUb2tlbg==');
...
final $typed_data.Uint8List updateParticipantRequestDescriptor = $convert.base64Decode('ChhVcGRhdGVQYXJ0aWNpcGFudFJlcXVlc3QSUwoLcGFydGljaXBhbnQYASABKAsyLC5nb29nbGUuY2xvdWQuZGlhbG9nZmxvdy52MmJldGExLlBhcnRpY2lwYW50QgPgQQJSC3BhcnRpY2lwYW50EkAKC3VwZGF0ZV9tYXNrGAIgASgLMhouZ29vZ2xlLnByb3RvYnVmLkZpZWxkTWFza0ID4EECUgp1cGRhdGVNYXNr');
...
final $typed_data.Uint8List outputAudioDescriptor = $convert.base64Decode('CgtPdXRwdXRBdWRpbxJKCgZjb25maWcYASABKAsyMi5nb29nbGUuY2xvdWQuZGlhbG9nZmxvdy52MmJldGExLk91dHB1dEF1ZGlvQ29uZmlnUgZjb25maWcSFAoFYXVkaW8YAiABKAxSBWF1ZGlv');
...
const AutomatedAgentReply$json = const {
  ...
  '2': const [
    ...
    const {'1': 'match_confidence', '3': 9, '4': 1, '5': 2, '10': 'matchConfidence'},
    const {'1': 'parameters', '3': 10, '4': 1, '5': 11, '6': '.google.protobuf.Struct', '10': 'parameters'},
    const {
    ...
    const {'1': 'automated_agent_reply_type', '3': 7, '4': 1, '5': 14, '6': '.google.cloud.dialogflow.v2beta1.AutomatedAgentReply.AutomatedAgentReplyType', '10': 'automatedAgentReplyType'},
...
final $typed_data.Uint8List automatedAgentReplyDescriptor = $convert.base64Decode('');
...
final $typed_data.Uint8List suggestionFeatureDescriptor = $convert.base64Decode('ChFTdWdnZXN0aW9uRmVhdHVyZRJLCgR0eXBlGAEgASgOMjcuZ29vZ2xlLmNsb3VkLmRpYWxvZ2Zsb3cudjJiZXRhMS5TdWdnZXN0aW9uRmVhdHVyZS5UeXBlUgR0eXBlIk4KBFR5cGUSFAoQVFlQRV9VTlNQRUNJRklFRBAAEhYKEkFSVElDTEVfU1VHR0VTVElPThABEgcKA0ZBURACEg8KC1NNQVJUX1JFUExZEAM=');
@$core.Deprecated('Use assistQueryParametersDescriptor instead')
const AssistQueryParameters$json = const {
  '1': 'AssistQueryParameters',
  '2': const [
    const {'1': 'documents_metadata_filters', '3': 1, '4': 3, '5': 11, '6': '.google.cloud.dialogflow.v2beta1.AssistQueryParameters.DocumentsMetadataFiltersEntry', '10': 'documentsMetadataFilters'},
  ],
...
final $typed_data.Uint8List assistQueryParametersDescriptor = $convert.base64Decode('');
...
const AnalyzeContentRequest$json = const {
  ...
  '2': const [
    ...
    const {'1': 'assist_query_params', '3': 14, '4': 1, '5': 11, '6': '.google.cloud.dialogflow.v2beta1.AssistQueryParameters', '10': 'assistQueryParams'},
...
final $typed_data.Uint8List analyzeContentRequestDescriptor = $convert.base64Decode('');
...
final $typed_data.Uint8List analyzeContentResponseDescriptor = $convert.base64Decode('');
...
final $typed_data.Uint8List inputTextConfigDescriptor = $convert.base64Decode('Cg9JbnB1dFRleHRDb25maWcSIwoNbGFuZ3VhZ2VfY29kZRgBIAEoCVIMbGFuZ3VhZ2VDb2Rl');
...
const StreamingAnalyzeContentRequest$json = const {
  ...
  '2': const [
    ...
    const {'1': 'assist_query_params', '3': 8, '4': 1, '5': 11, '6': '.google.cloud.dialogflow.v2beta1.AssistQueryParameters', '10': 'assistQueryParams'},
    const {'1': 'cx_parameters', '3': 13, '4': 1, '5': 11, '6': '.google.protobuf.Struct', '10': 'cxParameters'},
    const {'1': 'enable_partial_automated_agent_reply', '3': 12, '4': 1, '5': 8, '10': 'enablePartialAutomatedAgentReply'},
  ],
  '8': const [
    const {'1': 'config'},
    const {'1': 'input'},
...
final $typed_data.Uint8List streamingAnalyzeContentRequestDescriptor = $convert.base64Decode('');
...
final $typed_data.Uint8List streamingAnalyzeContentResponseDescriptor = $convert.base64Decode('');
...
final $typed_data.Uint8List messageAnnotationDescriptor = $convert.base64Decode('ChFNZXNzYWdlQW5ub3RhdGlvbhJLCgVwYXJ0cxgBIAMoCzI1Lmdvb2dsZS5jbG91ZC5kaWFsb2dmbG93LnYyYmV0YTEuQW5ub3RhdGVkTWVzc2FnZVBhcnRSBXBhcnRzEikKEGNvbnRhaW5fZW50aXRpZXMYAiABKAhSD2NvbnRhaW5FbnRpdGllcw==');
...
final $typed_data.Uint8List articleAnswerDescriptor = $convert.base64Decode('');
...
final $typed_data.Uint8List faqAnswerDescriptor = $convert.base64Decode('');
...
final $typed_data.Uint8List suggestionResultDescriptor = $convert.base64Decode('');
...
const SuggestArticlesRequest$json = const {
  ...
  '2': const [
    ...
    const {'1': 'assist_query_params', '3': 4, '4': 1, '5': 11, '6': '.google.cloud.dialogflow.v2beta1.AssistQueryParameters', '8': const {}, '10': 'assistQueryParams'},
  ],
};

/// Descriptor for `SuggestArticlesRequest`. Decode as a `google.protobuf.DescriptorProto`.
final $typed_data.Uint8List suggestArticlesRequestDescriptor = $convert.base64Decode('');
...
final $typed_data.Uint8List suggestArticlesResponseDescriptor = $convert.base64Decode('ChdTdWdnZXN0QXJ0aWNsZXNSZXNwb25zZRJXCg9hcnRpY2xlX2Fuc3dlcnMYASADKAsyLi5nb29nbGUuY2xvdWQuZGlhbG9nZmxvdy52MmJldGExLkFydGljbGVBbnN3ZXJSDmFydGljbGVBbnN3ZXJzEiUKDmxhdGVzdF9tZXNzYWdlGAIgASgJUg1sYXRlc3RNZXNzYWdlEiEKDGNvbnRleHRfc2l6ZRgDIAEoBVILY29udGV4dFNpemU=');
...
final $typed_data.Uint8List suggestFaqAnswersRequestDescriptor = $convert.base64Decode('');
...
final $typed_data.Uint8List suggestFaqAnswersResponseDescriptor = $convert.base64Decode('ChlTdWdnZXN0RmFxQW5zd2Vyc1Jlc3BvbnNlEksKC2ZhcV9hbnN3ZXJzGAEgAygLMiouZ29vZ2xlLmNsb3VkLmRpYWxvZ2Zsb3cudjJiZXRhMS5GYXFBbnN3ZXJSCmZhcUFuc3dlcnMSJQoObGF0ZXN0X21lc3NhZ2UYAiABKAlSDWxhdGVzdE1lc3NhZ2USIQoMY29udGV4dF9zaXplGAMgASgFUgtjb250ZXh0U2l6ZQ==');
...
final $typed_data.Uint8List suggestSmartRepliesRequestDescriptor = $convert.base64Decode('');
...
final $typed_data.Uint8List suggestSmartRepliesResponseDescriptor = $convert.base64Decode('');
...
final $typed_data.Uint8List suggestionDescriptor = $convert.base64Decode('');
...
final $typed_data.Uint8List listSuggestionsRequestDescriptor = $convert.base64Decode('ChZMaXN0U3VnZ2VzdGlvbnNSZXF1ZXN0EhYKBnBhcmVudBgBIAEoCVIGcGFyZW50EhsKCXBhZ2Vfc2l6ZRgCIAEoBVIIcGFnZVNpemUSHQoKcGFnZV90b2tlbhgDIAEoCVIJcGFnZVRva2VuEhYKBmZpbHRlchgEIAEoCVIGZmlsdGVyOgIYAQ==');
...
final $typed_data.Uint8List listSuggestionsResponseDescriptor = $convert.base64Decode('ChdMaXN0U3VnZ2VzdGlvbnNSZXNwb25zZRJNCgtzdWdnZXN0aW9ucxgBIAMoCzIrLmdvb2dsZS5jbG91ZC5kaWFsb2dmbG93LnYyYmV0YTEuU3VnZ2VzdGlvblILc3VnZ2VzdGlvbnMSJgoPbmV4dF9wYWdlX3Rva2VuGAIgASgJUg1uZXh0UGFnZVRva2VuOgIYAQ==');
...
final $typed_data.Uint8List compileSuggestionRequestDescriptor = $convert.base64Decode('ChhDb21waWxlU3VnZ2VzdGlvblJlcXVlc3QSFgoGcGFyZW50GAEgASgJUgZwYXJlbnQSJQoObGF0ZXN0X21lc3NhZ2UYAiABKAlSDWxhdGVzdE1lc3NhZ2USIQoMY29udGV4dF9zaXplGAMgASgFUgtjb250ZXh0U2l6ZToCGAE=');
...
final $typed_data.Uint8List compileSuggestionResponseDescriptor = $convert.base64Decode('ChlDb21waWxlU3VnZ2VzdGlvblJlc3BvbnNlEksKCnN1Z2dlc3Rpb24YASABKAsyKy5nb29nbGUuY2xvdWQuZGlhbG9nZmxvdy52MmJldGExLlN1Z2dlc3Rpb25SCnN1Z2dlc3Rpb24SJQoObGF0ZXN0X21lc3NhZ2UYAiABKAlSDWxhdGVzdE1lc3NhZ2USIQoMY29udGV4dF9zaXplGAMgASgFUgtjb250ZXh0U2l6ZToCGAE=');
...
const ResponseMessage$json = const {
  ...
  '2': const [
    ...
    const {'1': 'mixed_audio', '3': 5, '4': 1, '5': 11, '6': '.google.cloud.dialogflow.v2beta1.ResponseMessage.MixedAudio', '9': 0, '10': 'mixedAudio'},
    const {'1': 'telephony_transfer_call', '3': 6, '4': 1, '5': 11, '6': '.google.cloud.dialogflow.v2beta1.ResponseMessage.TelephonyTransferCall', '9': 0, '10': 'telephonyTransferCall'},
  ],
  '3': const [ResponseMessage_Text$json, ResponseMessage_LiveAgentHandoff$json, ResponseMessage_EndInteraction$json, ResponseMessage_MixedAudio$json, ResponseMessage_TelephonyTransferCall$json],
  '8': const [
    const {'1': 'message'},
  ],
};
...
const ResponseMessage_MixedAudio$json = const {
  '1': 'MixedAudio',
  '2': const [
    const {'1': 'segments', '3': 1, '4': 3, '5': 11, '6': '.google.cloud.dialogflow.v2beta1.ResponseMessage.MixedAudio.Segment', '10': 'segments'},
  ],
...
const ResponseMessage_MixedAudio_Segment$json = const {
  ...
  '2': const [
    ...
    const {'1': 'allow_playback_interruption', '3': 3, '4': 1, '5': 8, '10': 'allowPlaybackInterruption'},
  ],
  '8': const [
    const {'1': 'content'},
  ],
...
const ResponseMessage_TelephonyTransferCall$json = const {
  ...
  '2': const [
    ...
    const {'1': 'sip_uri', '3': 2, '4': 1, '5': 9, '9': 0, '10': 'sipUri'},
  ],
  '8': const [
    const {'1': 'endpoint'},
  ],
...
final $typed_data.Uint8List responseMessageDescriptor = $convert.base64Decode('');

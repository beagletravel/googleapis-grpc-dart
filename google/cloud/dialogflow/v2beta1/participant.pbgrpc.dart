...
class ParticipantsClient extends $grpc.Client {
  ...
  static final _$suggestSmartReplies = $grpc.ClientMethod<
          $9.SuggestSmartRepliesRequest, $9.SuggestSmartRepliesResponse>(
      '/google.cloud.dialogflow.v2beta1.Participants/SuggestSmartReplies',
      ($9.SuggestSmartRepliesRequest value) => value.writeToBuffer(),
      ($core.List<$core.int> value) =>
          $9.SuggestSmartRepliesResponse.fromBuffer(value));
  static final _$listSuggestions =
      $grpc.ClientMethod<$9.ListSuggestionsRequest, $9.ListSuggestionsResponse>(
          '/google.cloud.dialogflow.v2beta1.Participants/ListSuggestions',
          ($9.ListSuggestionsRequest value) => value.writeToBuffer(),
          ($core.List<$core.int> value) =>
              $9.ListSuggestionsResponse.fromBuffer(value));
  static final _$compileSuggestion = $grpc.ClientMethod<
          $9.CompileSuggestionRequest, $9.CompileSuggestionResponse>(
      '/google.cloud.dialogflow.v2beta1.Participants/CompileSuggestion',
      ($9.CompileSuggestionRequest value) => value.writeToBuffer(),
      ($core.List<$core.int> value) =>
          $9.CompileSuggestionResponse.fromBuffer(value));
  ...
  $grpc.ResponseFuture<$9.SuggestSmartRepliesResponse> suggestSmartReplies(
      $9.SuggestSmartRepliesRequest request,
      {$grpc.CallOptions? options}) {
    return $createUnaryCall(_$suggestSmartReplies, request, options: options);
  }

  $grpc.ResponseFuture<$9.ListSuggestionsResponse> listSuggestions(
      $9.ListSuggestionsRequest request,
      {$grpc.CallOptions? options}) {
    return $createUnaryCall(_$listSuggestions, request, options: options);
  }

  $grpc.ResponseFuture<$9.CompileSuggestionResponse> compileSuggestion(
      $9.CompileSuggestionRequest request,
      {$grpc.CallOptions? options}) {
...
abstract class ParticipantsServiceBase extends $grpc.Service {
  ...
  ParticipantsServiceBase() {
    ...
    $addMethod($grpc.ServiceMethod<$9.SuggestSmartRepliesRequest,
            $9.SuggestSmartRepliesResponse>(
        'SuggestSmartReplies',
        suggestSmartReplies_Pre,
        false,
        false,
        ($core.List<$core.int> value) =>
            $9.SuggestSmartRepliesRequest.fromBuffer(value),
        ($9.SuggestSmartRepliesResponse value) => value.writeToBuffer()));
    $addMethod($grpc.ServiceMethod<$9.ListSuggestionsRequest,
            $9.ListSuggestionsResponse>(
        'ListSuggestions',
        listSuggestions_Pre,
        false,
        false,
        ($core.List<$core.int> value) =>
            $9.ListSuggestionsRequest.fromBuffer(value),
        ($9.ListSuggestionsResponse value) => value.writeToBuffer()));
    $addMethod($grpc.ServiceMethod<$9.CompileSuggestionRequest,
            $9.CompileSuggestionResponse>(
        'CompileSuggestion',
        compileSuggestion_Pre,
        false,
        false,
        ($core.List<$core.int> value) =>
            $9.CompileSuggestionRequest.fromBuffer(value),
        ($9.CompileSuggestionResponse value) => value.writeToBuffer()));
  }
  ...
  $async.Future<$9.SuggestSmartRepliesResponse> suggestSmartReplies_Pre(
      $grpc.ServiceCall call,
      $async.Future<$9.SuggestSmartRepliesRequest> request) async {
    return suggestSmartReplies(call, await request);
  }

  $async.Future<$9.ListSuggestionsResponse> listSuggestions_Pre(
      $grpc.ServiceCall call,
      $async.Future<$9.ListSuggestionsRequest> request) async {
    return listSuggestions(call, await request);
  }

  $async.Future<$9.CompileSuggestionResponse> compileSuggestion_Pre(
      $grpc.ServiceCall call,
      $async.Future<$9.CompileSuggestionRequest> request) async {
  ...
  $async.Future<$9.SuggestSmartRepliesResponse> suggestSmartReplies(
      $grpc.ServiceCall call, $9.SuggestSmartRepliesRequest request);
  $async.Future<$9.ListSuggestionsResponse> listSuggestions(
      $grpc.ServiceCall call, $9.ListSuggestionsRequest request);
  $async.Future<$9.CompileSuggestionResponse> compileSuggestion(
      $grpc.ServiceCall call, $9.CompileSuggestionRequest request);
}

...
const CreateCatalogItemRequest$json = const {
  ...
  '2': const [
    ...
    const {'1': 'catalog_item', '3': 2, '4': 1, '5': 11, '6': '.google.cloud.recommendationengine.v1beta1.CatalogItem', '8': const {}, '10': 'catalogItem'},
  ],
};

/// Descriptor for `CreateCatalogItemRequest`. Decode as a `google.protobuf.DescriptorProto`.
final $typed_data.Uint8List createCatalogItemRequestDescriptor = $convert.base64Decode('');
...
final $typed_data.Uint8List getCatalogItemRequestDescriptor = $convert.base64Decode('ChVHZXRDYXRhbG9nSXRlbVJlcXVlc3QSTwoEbmFtZRgBIAEoCUI74EEC+kE1CjNyZWNvbW1lbmRhdGlvbmVuZ2luZS5nb29nbGVhcGlzLmNvbS9DYXRhbG9nSXRlbVBhdGhSBG5hbWU=');
...
final $typed_data.Uint8List listCatalogItemsRequestDescriptor = $convert.base64Decode('');
...
const ListCatalogItemsResponse$json = const {
  ...
  '2': const [
    const {'1': 'catalog_items', '3': 1, '4': 3, '5': 11, '6': '.google.cloud.recommendationengine.v1beta1.CatalogItem', '10': 'catalogItems'},
    const {'1': 'next_page_token', '3': 2, '4': 1, '5': 9, '10': 'nextPageToken'},
  ],
};

/// Descriptor for `ListCatalogItemsResponse`. Decode as a `google.protobuf.DescriptorProto`.
final $typed_data.Uint8List listCatalogItemsResponseDescriptor = $convert.base64Decode('ChhMaXN0Q2F0YWxvZ0l0ZW1zUmVzcG9uc2USWwoNY2F0YWxvZ19pdGVtcxgBIAMoCzI2Lmdvb2dsZS5jbG91ZC5yZWNvbW1lbmRhdGlvbmVuZ2luZS52MWJldGExLkNhdGFsb2dJdGVtUgxjYXRhbG9nSXRlbXMSJgoPbmV4dF9wYWdlX3Rva2VuGAIgASgJUg1uZXh0UGFnZVRva2Vu');
...
final $typed_data.Uint8List deleteCatalogItemRequestDescriptor = $convert.base64Decode('ChhEZWxldGVDYXRhbG9nSXRlbVJlcXVlc3QSTwoEbmFtZRgBIAEoCUI74EEC+kE1CjNyZWNvbW1lbmRhdGlvbmVuZ2luZS5nb29nbGVhcGlzLmNvbS9DYXRhbG9nSXRlbVBhdGhSBG5hbWU=');

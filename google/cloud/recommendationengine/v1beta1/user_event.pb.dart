...
class UserEvent extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'UserEvent', package: const $pb.PackageName(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'google.cloud.recommendationengine.v1beta1'), createEmptyInstance: create)
    ...
    ..aOM<EventDetail>(3, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'eventDetail', subBuilder: EventDetail.create)
    ..aOM<ProductEventDetail>(4, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'productEventDetail', subBuilder: ProductEventDetail.create)
    ..aOM<$0.Timestamp>(5, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'eventTime', subBuilder: $0.Timestamp.create)
    ..e<UserEvent_EventSource>(6, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'eventSource', $pb.PbFieldType.OE, defaultOrMaker: UserEvent_EventSource.EVENT_SOURCE_UNSPECIFIED, valueOf: UserEvent_EventSource.valueOf, enumValues: UserEvent_EventSource.values)
  ...
  @$pb.TagNumber(5)
  set eventTime($0.Timestamp v) { setField(5, v); }
  @$pb.TagNumber(5)
...
class UserInfo extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'UserInfo', package: const $pb.PackageName(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'google.cloud.recommendationengine.v1beta1'), createEmptyInstance: create)
    ..aOS(1, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'visitorId')
    ..aOS(2, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'userId')
    ..aOS(3, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'ipAddress')
    ..aOS(4, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'userAgent')
    ..aOB(5, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'directUserRequest')
    ..hasRequiredFields = false
  ;
...
class EventDetail extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'EventDetail', package: const $pb.PackageName(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'google.cloud.recommendationengine.v1beta1'), createEmptyInstance: create)
    ..aOS(1, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'uri')
    ..aOS(2, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'pageViewId')
    ..pPS(3, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'experimentIds')
    ..aOS(4, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'recommendationToken')
    ..aOM<$1.FeatureMap>(5, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'eventAttributes', subBuilder: $1.FeatureMap.create)
    ..aOS(6, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'referrerUri')
    ..hasRequiredFields = false
  ;
  ...
  'Use [GeneratedMessageGenericExtensions.rebuild] instead. '
  'Will be removed in next major version')
  EventDetail copyWith(void Function(EventDetail) updates) => super.copyWith((message) => updates(message as EventDetail)) as EventDetail; // ignore: deprecated_member_use
  $pb.BuilderInfo get info_ => _i;
  @$core.pragma('dart2js:noInline')
  ...
  @$pb.TagNumber(5)
  set eventAttributes($1.FeatureMap v) { setField(5, v); }
  @$pb.TagNumber(5)
...
class ProductEventDetail extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'ProductEventDetail', package: const $pb.PackageName(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'google.cloud.recommendationengine.v1beta1'), createEmptyInstance: create)
    ..aOS(1, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'searchQuery')
    ..pc<$2.CatalogItem_CategoryHierarchy>(2, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'pageCategories', $pb.PbFieldType.PM, subBuilder: $2.CatalogItem_CategoryHierarchy.create)
    ..pc<ProductDetail>(3, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'productDetails', $pb.PbFieldType.PM, subBuilder: ProductDetail.create)
    ..aOS(4, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'listId')
    ..aOS(5, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'cartId')
    ..aOM<PurchaseTransaction>(6, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'purchaseTransaction', subBuilder: PurchaseTransaction.create)
    ..hasRequiredFields = false
  ;
  ...
  'Use [GeneratedMessageGenericExtensions.rebuild] instead. '
  'Will be removed in next major version')
  ProductEventDetail copyWith(void Function(ProductEventDetail) updates) => super.copyWith((message) => updates(message as ProductEventDetail)) as ProductEventDetail; // ignore: deprecated_member_use
  $pb.BuilderInfo get info_ => _i;
  @$core.pragma('dart2js:noInline')
  ...
  @$pb.TagNumber(2)
  $core.List<$2.CatalogItem_CategoryHierarchy> get pageCategories => $_getList(1);
...
class PurchaseTransaction extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'PurchaseTransaction', package: const $pb.PackageName(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'google.cloud.recommendationengine.v1beta1'), createEmptyInstance: create)
    ..aOS(1, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'id')
    ..a<$core.double>(2, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'revenue', $pb.PbFieldType.OF)
    ..m<$core.String, $core.double>(3, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'taxes', entryClassName: 'PurchaseTransaction.TaxesEntry', keyFieldType: $pb.PbFieldType.OS, valueFieldType: $pb.PbFieldType.OF, packageName: const $pb.PackageName('google.cloud.recommendationengine.v1beta1'))
    ..m<$core.String, $core.double>(4, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'costs', entryClassName: 'PurchaseTransaction.CostsEntry', keyFieldType: $pb.PbFieldType.OS, valueFieldType: $pb.PbFieldType.OF, packageName: const $pb.PackageName('google.cloud.recommendationengine.v1beta1'))
    ..aOS(6, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'currencyCode')
    ..hasRequiredFields = false
  ;
  ...
  'Use [GeneratedMessageGenericExtensions.rebuild] instead. '
  'Will be removed in next major version')
  PurchaseTransaction copyWith(void Function(PurchaseTransaction) updates) => super.copyWith((message) => updates(message as PurchaseTransaction)) as PurchaseTransaction; // ignore: deprecated_member_use
  $pb.BuilderInfo get info_ => _i;
  @$core.pragma('dart2js:noInline')
...
class ProductDetail extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'ProductDetail', package: const $pb.PackageName(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'google.cloud.recommendationengine.v1beta1'), createEmptyInstance: create)
    ..aOS(1, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'id')
    ...
    ..a<$core.double>(4, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'displayPrice', $pb.PbFieldType.OF)
    ..e<$2.ProductCatalogItem_StockState>(5, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'stockState', $pb.PbFieldType.OE, defaultOrMaker: $2.ProductCatalogItem_StockState.STOCK_STATE_UNSPECIFIED, valueOf: $2.ProductCatalogItem_StockState.valueOf, enumValues: $2.ProductCatalogItem_StockState.values)
    ..a<$core.int>(6, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'quantity', $pb.PbFieldType.O3)
    ..a<$core.int>(7, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'availableQuantity', $pb.PbFieldType.O3)
    ..aOM<$1.FeatureMap>(8, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'itemAttributes', subBuilder: $1.FeatureMap.create)
    ..hasRequiredFields = false
  ;
  ...
  @$pb.TagNumber(5)
  set stockState($2.ProductCatalogItem_StockState v) { setField(5, v); }
  @$pb.TagNumber(5)
  ...
  @$pb.TagNumber(8)
  set itemAttributes($1.FeatureMap v) { setField(8, v); }
  @$pb.TagNumber(8)

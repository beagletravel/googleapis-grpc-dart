...
class CatalogItem_CategoryHierarchy extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'CatalogItem.CategoryHierarchy', package: const $pb.PackageName(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'google.cloud.recommendationengine.v1beta1'), createEmptyInstance: create)
  ...
  'Will be removed in next major version')
  CatalogItem_CategoryHierarchy copyWith(void Function(CatalogItem_CategoryHierarchy) updates) => super.copyWith((message) => updates(message as CatalogItem_CategoryHierarchy)) as CatalogItem_CategoryHierarchy; // ignore: deprecated_member_use
...
class CatalogItem extends $pb.GeneratedMessage {
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'CatalogItem', package: const $pb.PackageName(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'google.cloud.recommendationengine.v1beta1'), createEmptyInstance: create)
    ..oo(0, [10])
    ..aOS(1, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'id')
    ..pc<CatalogItem_CategoryHierarchy>(2, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'categoryHierarchies', $pb.PbFieldType.PM, subBuilder: CatalogItem_CategoryHierarchy.create)
    ..aOS(3, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'title')
    ..aOS(4, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'description')
    ..aOM<$0.FeatureMap>(5, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'itemAttributes', subBuilder: $0.FeatureMap.create)
    ...
    ..aOS(9, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'itemGroupId')
    ..aOM<ProductCatalogItem>(10, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'productMetadata', subBuilder: ProductCatalogItem.create)
    ..hasRequiredFields = false
  ;
  ...
  'Use [GeneratedMessageGenericExtensions.rebuild] instead. '
  'Will be removed in next major version')
  CatalogItem copyWith(void Function(CatalogItem) updates) => super.copyWith((message) => updates(message as CatalogItem)) as CatalogItem; // ignore: deprecated_member_use
  $pb.BuilderInfo get info_ => _i;
  @$core.pragma('dart2js:noInline')
  ...
  @$pb.TagNumber(5)
  set itemAttributes($0.FeatureMap v) { setField(5, v); }
  @$pb.TagNumber(5)
...
class ProductCatalogItem_ExactPrice extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'ProductCatalogItem.ExactPrice', package: const $pb.PackageName(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'google.cloud.recommendationengine.v1beta1'), createEmptyInstance: create)
    ..a<$core.double>(1, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'displayPrice', $pb.PbFieldType.OF)
    ..a<$core.double>(2, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'originalPrice', $pb.PbFieldType.OF)
    ..hasRequiredFields = false
  ;
  ...
  'Use [GeneratedMessageGenericExtensions.rebuild] instead. '
  'Will be removed in next major version')
  ProductCatalogItem_ExactPrice copyWith(void Function(ProductCatalogItem_ExactPrice) updates) => super.copyWith((message) => updates(message as ProductCatalogItem_ExactPrice)) as ProductCatalogItem_ExactPrice; // ignore: deprecated_member_use
  $pb.BuilderInfo get info_ => _i;
  @$core.pragma('dart2js:noInline')
...
class ProductCatalogItem_PriceRange extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'ProductCatalogItem.PriceRange', package: const $pb.PackageName(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'google.cloud.recommendationengine.v1beta1'), createEmptyInstance: create)
  ...
  'Use [GeneratedMessageGenericExtensions.rebuild] instead. '
  'Will be removed in next major version')
  ProductCatalogItem_PriceRange copyWith(void Function(ProductCatalogItem_PriceRange) updates) => super.copyWith((message) => updates(message as ProductCatalogItem_PriceRange)) as ProductCatalogItem_PriceRange; // ignore: deprecated_member_use
  $pb.BuilderInfo get info_ => _i;
  @$core.pragma('dart2js:noInline')
...
class ProductCatalogItem extends $pb.GeneratedMessage {
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'ProductCatalogItem', package: const $pb.PackageName(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'google.cloud.recommendationengine.v1beta1'), createEmptyInstance: create)
    ..oo(0, [1, 2])
    ..aOM<ProductCatalogItem_ExactPrice>(1, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'exactPrice', subBuilder: ProductCatalogItem_ExactPrice.create)
    ..aOM<ProductCatalogItem_PriceRange>(2, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'priceRange', subBuilder: ProductCatalogItem_PriceRange.create)
    ..m<$core.String, $core.double>(3, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'costs', entryClassName: 'ProductCatalogItem.CostsEntry', keyFieldType: $pb.PbFieldType.OS, valueFieldType: $pb.PbFieldType.OF, packageName: const $pb.PackageName('google.cloud.recommendationengine.v1beta1'))
    ..aOS(4, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'currencyCode')
    ..e<ProductCatalogItem_StockState>(5, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'stockState', $pb.PbFieldType.OE, defaultOrMaker: ProductCatalogItem_StockState.STOCK_STATE_UNSPECIFIED, valueOf: ProductCatalogItem_StockState.valueOf, enumValues: ProductCatalogItem_StockState.values)
    ..aInt64(6, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'availableQuantity')
    ..aOS(7, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'canonicalProductUri')
  ...
  'Use [GeneratedMessageGenericExtensions.rebuild] instead. '
  'Will be removed in next major version')
  ProductCatalogItem copyWith(void Function(ProductCatalogItem) updates) => super.copyWith((message) => updates(message as ProductCatalogItem)) as ProductCatalogItem; // ignore: deprecated_member_use
  $pb.BuilderInfo get info_ => _i;
  @$core.pragma('dart2js:noInline')
...
class Image extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'Image', package: const $pb.PackageName(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'google.cloud.recommendationengine.v1beta1'), createEmptyInstance: create)

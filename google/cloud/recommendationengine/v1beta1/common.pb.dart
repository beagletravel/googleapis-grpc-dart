...
class FeatureMap_StringList extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'FeatureMap.StringList', package: const $pb.PackageName(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'google.cloud.recommendationengine.v1beta1'), createEmptyInstance: create)
  ...
  'Will be removed in next major version')
  FeatureMap_StringList copyWith(void Function(FeatureMap_StringList) updates) => super.copyWith((message) => updates(message as FeatureMap_StringList)) as FeatureMap_StringList; // ignore: deprecated_member_use
...
class FeatureMap_FloatList extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'FeatureMap.FloatList', package: const $pb.PackageName(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'google.cloud.recommendationengine.v1beta1'), createEmptyInstance: create)
    ..p<$core.double>(1, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'value', $pb.PbFieldType.PF)
    ..hasRequiredFields = false
  ;
  ...
  'Use [GeneratedMessageGenericExtensions.rebuild] instead. '
  'Will be removed in next major version')
  FeatureMap_FloatList copyWith(void Function(FeatureMap_FloatList) updates) => super.copyWith((message) => updates(message as FeatureMap_FloatList)) as FeatureMap_FloatList; // ignore: deprecated_member_use
  $pb.BuilderInfo get info_ => _i;
  @$core.pragma('dart2js:noInline')
...
class FeatureMap extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'FeatureMap', package: const $pb.PackageName(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'google.cloud.recommendationengine.v1beta1'), createEmptyInstance: create)
    ..m<$core.String, FeatureMap_StringList>(1, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'categoricalFeatures', entryClassName: 'FeatureMap.CategoricalFeaturesEntry', keyFieldType: $pb.PbFieldType.OS, valueFieldType: $pb.PbFieldType.OM, valueCreator: FeatureMap_StringList.create, packageName: const $pb.PackageName('google.cloud.recommendationengine.v1beta1'))
    ..m<$core.String, FeatureMap_FloatList>(2, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'numericalFeatures', entryClassName: 'FeatureMap.NumericalFeaturesEntry', keyFieldType: $pb.PbFieldType.OS, valueFieldType: $pb.PbFieldType.OM, valueCreator: FeatureMap_FloatList.create, packageName: const $pb.PackageName('google.cloud.recommendationengine.v1beta1'))
    ..hasRequiredFields = false
  ;
  ...
  'Use [GeneratedMessageGenericExtensions.rebuild] instead. '
  'Will be removed in next major version')
  FeatureMap copyWith(void Function(FeatureMap) updates) => super.copyWith((message) => updates(message as FeatureMap)) as FeatureMap; // ignore: deprecated_member_use
  $pb.BuilderInfo get info_ => _i;
  @$core.pragma('dart2js:noInline')

...
const Environment$json = const {
  ...
  '2': const [
    ...
    const {'1': 'docker_image', '3': 3, '4': 1, '5': 9, '8': const {}, '10': 'dockerImage'},
    const {'1': 'state', '3': 4, '4': 1, '5': 14, '6': '.google.cloud.shell.v1.Environment.State', '8': const {}, '10': 'state'},
    const {'1': 'web_host', '3': 12, '4': 1, '5': 9, '8': const {}, '10': 'webHost'},
    const {'1': 'ssh_username', '3': 5, '4': 1, '5': 9, '8': const {}, '10': 'sshUsername'},
    const {'1': 'ssh_host', '3': 6, '4': 1, '5': 9, '8': const {}, '10': 'sshHost'},
    const {'1': 'ssh_port', '3': 7, '4': 1, '5': 5, '8': const {}, '10': 'sshPort'},
    const {'1': 'public_keys', '3': 8, '4': 3, '5': 9, '8': const {}, '10': 'publicKeys'},
  ],
...
final $typed_data.Uint8List environmentDescriptor = $convert.base64Decode('');
...
final $typed_data.Uint8List getEnvironmentRequestDescriptor = $convert.base64Decode('ChVHZXRFbnZpcm9ubWVudFJlcXVlc3QSQQoEbmFtZRgBIAEoCUIt4EEC+kEnCiVjbG91ZHNoZWxsLmdvb2dsZWFwaXMuY29tL0Vudmlyb25tZW50UgRuYW1l');
...
final $typed_data.Uint8List createEnvironmentMetadataDescriptor = $convert.base64Decode('ChlDcmVhdGVFbnZpcm9ubWVudE1ldGFkYXRh');
...
final $typed_data.Uint8List deleteEnvironmentMetadataDescriptor = $convert.base64Decode('ChlEZWxldGVFbnZpcm9ubWVudE1ldGFkYXRh');
...
final $typed_data.Uint8List startEnvironmentRequestDescriptor = $convert.base64Decode('ChdTdGFydEVudmlyb25tZW50UmVxdWVzdBISCgRuYW1lGAEgASgJUgRuYW1lEiEKDGFjY2Vzc190b2tlbhgCIAEoCVILYWNjZXNzVG9rZW4SHwoLcHVibGljX2tleXMYAyADKAlSCnB1YmxpY0tleXM=');
...
final $typed_data.Uint8List authorizeEnvironmentRequestDescriptor = $convert.base64Decode('ChtBdXRob3JpemVFbnZpcm9ubWVudFJlcXVlc3QSEgoEbmFtZRgBIAEoCVIEbmFtZRIhCgxhY2Nlc3NfdG9rZW4YAiABKAlSC2FjY2Vzc1Rva2VuEhkKCGlkX3Rva2VuGAQgASgJUgdpZFRva2VuEjsKC2V4cGlyZV90aW1lGAMgASgLMhouZ29vZ2xlLnByb3RvYnVmLlRpbWVzdGFtcFIKZXhwaXJlVGltZQ==');
...
final $typed_data.Uint8List authorizeEnvironmentResponseDescriptor = $convert.base64Decode('ChxBdXRob3JpemVFbnZpcm9ubWVudFJlc3BvbnNl');
...
final $typed_data.Uint8List authorizeEnvironmentMetadataDescriptor = $convert.base64Decode('ChxBdXRob3JpemVFbnZpcm9ubWVudE1ldGFkYXRh');
...
const StartEnvironmentMetadata$json = const {
  ...
  '2': const [
    const {'1': 'state', '3': 1, '4': 1, '5': 14, '6': '.google.cloud.shell.v1.StartEnvironmentMetadata.State', '10': 'state'},
  ],
...
final $typed_data.Uint8List startEnvironmentMetadataDescriptor = $convert.base64Decode('');
...
const StartEnvironmentResponse$json = const {
  ...
  '2': const [
    const {'1': 'environment', '3': 1, '4': 1, '5': 11, '6': '.google.cloud.shell.v1.Environment', '10': 'environment'},
  ],
};

/// Descriptor for `StartEnvironmentResponse`. Decode as a `google.protobuf.DescriptorProto`.
final $typed_data.Uint8List startEnvironmentResponseDescriptor = $convert.base64Decode('ChhTdGFydEVudmlyb25tZW50UmVzcG9uc2USRAoLZW52aXJvbm1lbnQYASABKAsyIi5nb29nbGUuY2xvdWQuc2hlbGwudjEuRW52aXJvbm1lbnRSC2Vudmlyb25tZW50');
...
final $typed_data.Uint8List addPublicKeyRequestDescriptor = $convert.base64Decode('ChNBZGRQdWJsaWNLZXlSZXF1ZXN0EiAKC2Vudmlyb25tZW50GAEgASgJUgtlbnZpcm9ubWVudBIQCgNrZXkYAiABKAlSA2tleQ==');
...
final $typed_data.Uint8List addPublicKeyResponseDescriptor = $convert.base64Decode('ChRBZGRQdWJsaWNLZXlSZXNwb25zZRIQCgNrZXkYASABKAlSA2tleQ==');
...
final $typed_data.Uint8List addPublicKeyMetadataDescriptor = $convert.base64Decode('ChRBZGRQdWJsaWNLZXlNZXRhZGF0YQ==');
...
final $typed_data.Uint8List removePublicKeyRequestDescriptor = $convert.base64Decode('ChZSZW1vdmVQdWJsaWNLZXlSZXF1ZXN0EiAKC2Vudmlyb25tZW50GAEgASgJUgtlbnZpcm9ubWVudBIQCgNrZXkYAiABKAlSA2tleQ==');
...
final $typed_data.Uint8List removePublicKeyResponseDescriptor = $convert.base64Decode('ChdSZW1vdmVQdWJsaWNLZXlSZXNwb25zZQ==');
...
final $typed_data.Uint8List removePublicKeyMetadataDescriptor = $convert.base64Decode('ChdSZW1vdmVQdWJsaWNLZXlNZXRhZGF0YQ==');
...
const CloudShellErrorDetails$json = const {
  ...
  '2': const [
    const {'1': 'code', '3': 1, '4': 1, '5': 14, '6': '.google.cloud.shell.v1.CloudShellErrorDetails.CloudShellErrorCode', '10': 'code'},
  ],
...
final $typed_data.Uint8List cloudShellErrorDetailsDescriptor = $convert.base64Decode('');

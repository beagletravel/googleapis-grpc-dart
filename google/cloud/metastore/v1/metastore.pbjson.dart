...
const Service$json = const {
  '1': 'Service',
  '2': const [
    const {'1': 'hive_metastore_config', '3': 5, '4': 1, '5': 11, '6': '.google.cloud.metastore.v1.HiveMetastoreConfig', '9': 0, '10': 'hiveMetastoreConfig'},
    ...
    const {'1': 'labels', '3': 4, '4': 3, '5': 11, '6': '.google.cloud.metastore.v1.Service.LabelsEntry', '10': 'labels'},
    ...
    const {'1': 'state', '3': 10, '4': 1, '5': 14, '6': '.google.cloud.metastore.v1.Service.State', '8': const {}, '10': 'state'},
    ...
    const {'1': 'tier', '3': 13, '4': 1, '5': 14, '6': '.google.cloud.metastore.v1.Service.Tier', '10': 'tier'},
    const {'1': 'maintenance_window', '3': 15, '4': 1, '5': 11, '6': '.google.cloud.metastore.v1.MaintenanceWindow', '10': 'maintenanceWindow'},
    const {'1': 'uid', '3': 16, '4': 1, '5': 9, '8': const {}, '10': 'uid'},
    const {'1': 'metadata_management_activity', '3': 17, '4': 1, '5': 11, '6': '.google.cloud.metastore.v1.MetadataManagementActivity', '8': const {}, '10': 'metadataManagementActivity'},
    const {'1': 'release_channel', '3': 19, '4': 1, '5': 14, '6': '.google.cloud.metastore.v1.Service.ReleaseChannel', '8': const {}, '10': 'releaseChannel'},
  ],
  '3': const [Service_LabelsEntry$json],
  '4': const [Service_State$json, Service_Tier$json, Service_ReleaseChannel$json],
  '7': const {},
  '8': const [
...
final $typed_data.Uint8List serviceDescriptor = $convert.base64Decode('');
...
const HiveMetastoreConfig$json = const {
  ...
  '2': const [
    ...
    const {'1': 'config_overrides', '3': 2, '4': 3, '5': 11, '6': '.google.cloud.metastore.v1.HiveMetastoreConfig.ConfigOverridesEntry', '10': 'configOverrides'},
    const {'1': 'kerberos_config', '3': 3, '4': 1, '5': 11, '6': '.google.cloud.metastore.v1.KerberosConfig', '10': 'kerberosConfig'},
  ],
...
final $typed_data.Uint8List hiveMetastoreConfigDescriptor = $convert.base64Decode('');
@$core.Deprecated('Use kerberosConfigDescriptor instead')
const KerberosConfig$json = const {
  '1': 'KerberosConfig',
  '2': const [
    const {'1': 'keytab', '3': 1, '4': 1, '5': 11, '6': '.google.cloud.metastore.v1.Secret', '10': 'keytab'},
...
final $typed_data.Uint8List kerberosConfigDescriptor = $convert.base64Decode('Cg5LZXJiZXJvc0NvbmZpZxI5CgZrZXl0YWIYASABKAsyIS5nb29nbGUuY2xvdWQubWV0YXN0b3JlLnYxLlNlY3JldFIGa2V5dGFiEhwKCXByaW5jaXBhbBgCIAEoCVIJcHJpbmNpcGFsEi0KE2tyYjVfY29uZmlnX2djc191cmkYAyABKAlSEGtyYjVDb25maWdHY3NVcmk=');
...
const MetadataManagementActivity$json = const {
  ...
  '2': const [
    const {'1': 'metadata_exports', '3': 1, '4': 3, '5': 11, '6': '.google.cloud.metastore.v1.MetadataExport', '8': const {}, '10': 'metadataExports'},
    const {'1': 'restores', '3': 2, '4': 3, '5': 11, '6': '.google.cloud.metastore.v1.Restore', '8': const {}, '10': 'restores'},
  ],
};

/// Descriptor for `MetadataManagementActivity`. Decode as a `google.protobuf.DescriptorProto`.
final $typed_data.Uint8List metadataManagementActivityDescriptor = $convert.base64Decode('ChpNZXRhZGF0YU1hbmFnZW1lbnRBY3Rpdml0eRJZChBtZXRhZGF0YV9leHBvcnRzGAEgAygLMikuZ29vZ2xlLmNsb3VkLm1ldGFzdG9yZS52MS5NZXRhZGF0YUV4cG9ydEID4EEDUg9tZXRhZGF0YUV4cG9ydHMSQwoIcmVzdG9yZXMYAiADKAsyIi5nb29nbGUuY2xvdWQubWV0YXN0b3JlLnYxLlJlc3RvcmVCA+BBA1IIcmVzdG9yZXM=');
@$core.Deprecated('Use metadataImportDescriptor instead')
const MetadataImport$json = const {
  '1': 'MetadataImport',
  '2': const [
    const {'1': 'database_dump', '3': 6, '4': 1, '5': 11, '6': '.google.cloud.metastore.v1.MetadataImport.DatabaseDump', '8': const {}, '9': 0, '10': 'databaseDump'},
    const {'1': 'name', '3': 1, '4': 1, '5': 9, '8': const {}, '10': 'name'},
    ...
    const {'1': 'state', '3': 5, '4': 1, '5': 14, '6': '.google.cloud.metastore.v1.MetadataImport.State', '8': const {}, '10': 'state'},
  ],
...
const MetadataImport_DatabaseDump$json = const {
  ...
  '2': const [
    ...
    const {'1': 'type', '3': 4, '4': 1, '5': 14, '6': '.google.cloud.metastore.v1.DatabaseDumpSpec.Type', '8': const {}, '10': 'type'},
  ],
...
final $typed_data.Uint8List metadataImportDescriptor = $convert.base64Decode('');
...
const MetadataExport$json = const {
  ...
  '2': const [
    ...
    const {'1': 'state', '3': 3, '4': 1, '5': 14, '6': '.google.cloud.metastore.v1.MetadataExport.State', '8': const {}, '10': 'state'},
    const {'1': 'database_dump_type', '3': 5, '4': 1, '5': 14, '6': '.google.cloud.metastore.v1.DatabaseDumpSpec.Type', '8': const {}, '10': 'databaseDumpType'},
  ],
...
final $typed_data.Uint8List metadataExportDescriptor = $convert.base64Decode('');
...
const Backup$json = const {
  ...
  '2': const [
    ...
    const {'1': 'state', '3': 4, '4': 1, '5': 14, '6': '.google.cloud.metastore.v1.Backup.State', '8': const {}, '10': 'state'},
    const {'1': 'service_revision', '3': 5, '4': 1, '5': 11, '6': '.google.cloud.metastore.v1.Service', '8': const {}, '10': 'serviceRevision'},
...
final $typed_data.Uint8List backupDescriptor = $convert.base64Decode('');
...
const Restore$json = const {
  ...
  '2': const [
    const {'1': 'start_time', '3': 1, '4': 1, '5': 11, '6': '.google.protobuf.Timestamp', '8': const {}, '10': 'startTime'},
    const {'1': 'end_time', '3': 2, '4': 1, '5': 11, '6': '.google.protobuf.Timestamp', '8': const {}, '10': 'endTime'},
    const {'1': 'state', '3': 3, '4': 1, '5': 14, '6': '.google.cloud.metastore.v1.Restore.State', '8': const {}, '10': 'state'},
    const {'1': 'backup', '3': 4, '4': 1, '5': 9, '8': const {}, '10': 'backup'},
    const {'1': 'type', '3': 5, '4': 1, '5': 14, '6': '.google.cloud.metastore.v1.Restore.RestoreType', '8': const {}, '10': 'type'},
...
final $typed_data.Uint8List restoreDescriptor = $convert.base64Decode('');
...
const ListServicesResponse$json = const {
  ...
  '2': const [
    const {'1': 'services', '3': 1, '4': 3, '5': 11, '6': '.google.cloud.metastore.v1.Service', '10': 'services'},
...
final $typed_data.Uint8List listServicesResponseDescriptor = $convert.base64Decode('ChRMaXN0U2VydmljZXNSZXNwb25zZRI+CghzZXJ2aWNlcxgBIAMoCzIiLmdvb2dsZS5jbG91ZC5tZXRhc3RvcmUudjEuU2VydmljZVIIc2VydmljZXMSJgoPbmV4dF9wYWdlX3Rva2VuGAIgASgJUg1uZXh0UGFnZVRva2VuEiAKC3VucmVhY2hhYmxlGAMgAygJUgt1bnJlYWNoYWJsZQ==');
...
const CreateServiceRequest$json = const {
  ...
  '2': const [
    ...
    const {'1': 'service', '3': 3, '4': 1, '5': 11, '6': '.google.cloud.metastore.v1.Service', '8': const {}, '10': 'service'},
...
final $typed_data.Uint8List createServiceRequestDescriptor = $convert.base64Decode('');
...
const UpdateServiceRequest$json = const {
  ...
  '2': const [
    ...
    const {'1': 'service', '3': 2, '4': 1, '5': 11, '6': '.google.cloud.metastore.v1.Service', '8': const {}, '10': 'service'},
...
final $typed_data.Uint8List updateServiceRequestDescriptor = $convert.base64Decode('ChRVcGRhdGVTZXJ2aWNlUmVxdWVzdBJACgt1cGRhdGVfbWFzaxgBIAEoCzIaLmdvb2dsZS5wcm90b2J1Zi5GaWVsZE1hc2tCA+BBAlIKdXBkYXRlTWFzaxJBCgdzZXJ2aWNlGAIgASgLMiIuZ29vZ2xlLmNsb3VkLm1ldGFzdG9yZS52MS5TZXJ2aWNlQgPgQQJSB3NlcnZpY2USIgoKcmVxdWVzdF9pZBgDIAEoCUID4EEBUglyZXF1ZXN0SWQ=');
...
const ListMetadataImportsResponse$json = const {
  ...
  '2': const [
    const {'1': 'metadata_imports', '3': 1, '4': 3, '5': 11, '6': '.google.cloud.metastore.v1.MetadataImport', '10': 'metadataImports'},
    const {'1': 'next_page_token', '3': 2, '4': 1, '5': 9, '10': 'nextPageToken'},
    const {'1': 'unreachable', '3': 3, '4': 3, '5': 9, '10': 'unreachable'},
  ],
};
...
final $typed_data.Uint8List listMetadataImportsResponseDescriptor = $convert.base64Decode('ChtMaXN0TWV0YWRhdGFJbXBvcnRzUmVzcG9uc2USVAoQbWV0YWRhdGFfaW1wb3J0cxgBIAMoCzIpLmdvb2dsZS5jbG91ZC5tZXRhc3RvcmUudjEuTWV0YWRhdGFJbXBvcnRSD21ldGFkYXRhSW1wb3J0cxImCg9uZXh0X3BhZ2VfdG9rZW4YAiABKAlSDW5leHRQYWdlVG9rZW4SIAoLdW5yZWFjaGFibGUYAyADKAlSC3VucmVhY2hhYmxl');
...
const CreateMetadataImportRequest$json = const {
  ...
  '2': const [
    ...
    const {'1': 'metadata_import', '3': 3, '4': 1, '5': 11, '6': '.google.cloud.metastore.v1.MetadataImport', '8': const {}, '10': 'metadataImport'},
    const {'1': 'request_id', '3': 4, '4': 1, '5': 9, '8': const {}, '10': 'requestId'},
  ],
};

/// Descriptor for `CreateMetadataImportRequest`. Decode as a `google.protobuf.DescriptorProto`.
final $typed_data.Uint8List createMetadataImportRequestDescriptor = $convert.base64Decode('');
...
const UpdateMetadataImportRequest$json = const {
  ...
  '2': const [
    const {'1': 'update_mask', '3': 1, '4': 1, '5': 11, '6': '.google.protobuf.FieldMask', '8': const {}, '10': 'updateMask'},
    const {'1': 'metadata_import', '3': 2, '4': 1, '5': 11, '6': '.google.cloud.metastore.v1.MetadataImport', '8': const {}, '10': 'metadataImport'},
    const {'1': 'request_id', '3': 3, '4': 1, '5': 9, '8': const {}, '10': 'requestId'},
  ],
};

/// Descriptor for `UpdateMetadataImportRequest`. Decode as a `google.protobuf.DescriptorProto`.
final $typed_data.Uint8List updateMetadataImportRequestDescriptor = $convert.base64Decode('');
...
const ListBackupsResponse$json = const {
  ...
  '2': const [
    const {'1': 'backups', '3': 1, '4': 3, '5': 11, '6': '.google.cloud.metastore.v1.Backup', '10': 'backups'},
    const {'1': 'next_page_token', '3': 2, '4': 1, '5': 9, '10': 'nextPageToken'},
    const {'1': 'unreachable', '3': 3, '4': 3, '5': 9, '10': 'unreachable'},
  ],
};
...
final $typed_data.Uint8List listBackupsResponseDescriptor = $convert.base64Decode('ChNMaXN0QmFja3Vwc1Jlc3BvbnNlEjsKB2JhY2t1cHMYASADKAsyIS5nb29nbGUuY2xvdWQubWV0YXN0b3JlLnYxLkJhY2t1cFIHYmFja3VwcxImCg9uZXh0X3BhZ2VfdG9rZW4YAiABKAlSDW5leHRQYWdlVG9rZW4SIAoLdW5yZWFjaGFibGUYAyADKAlSC3VucmVhY2hhYmxl');
...
const CreateBackupRequest$json = const {
  ...
  '2': const [
    ...
    const {'1': 'backup', '3': 3, '4': 1, '5': 11, '6': '.google.cloud.metastore.v1.Backup', '8': const {}, '10': 'backup'},
    const {'1': 'request_id', '3': 4, '4': 1, '5': 9, '8': const {}, '10': 'requestId'},
  ],
};

/// Descriptor for `CreateBackupRequest`. Decode as a `google.protobuf.DescriptorProto`.
final $typed_data.Uint8List createBackupRequestDescriptor = $convert.base64Decode('');
...
const ExportMetadataRequest$json = const {
  ...
  '2': const [
    ...
    const {'1': 'request_id', '3': 3, '4': 1, '5': 9, '8': const {}, '10': 'requestId'},
    const {'1': 'database_dump_type', '3': 4, '4': 1, '5': 14, '6': '.google.cloud.metastore.v1.DatabaseDumpSpec.Type', '8': const {}, '10': 'databaseDumpType'},
  ],
  '8': const [
    const {'1': 'destination'},
  ],
...
const RestoreServiceRequest$json = const {
  ...
  '2': const [
    ...
    const {'1': 'restore_type', '3': 3, '4': 1, '5': 14, '6': '.google.cloud.metastore.v1.Restore.RestoreType', '8': const {}, '10': 'restoreType'},
    const {'1': 'request_id', '3': 4, '4': 1, '5': 9, '8': const {}, '10': 'requestId'},
  ],
};

/// Descriptor for `RestoreServiceRequest`. Decode as a `google.protobuf.DescriptorProto`.
final $typed_data.Uint8List restoreServiceRequestDescriptor = $convert.base64Decode('');
...
const LocationMetadata$json = const {
  '1': 'LocationMetadata',
  '2': const [
    const {'1': 'supported_hive_metastore_versions', '3': 1, '4': 3, '5': 11, '6': '.google.cloud.metastore.v1.LocationMetadata.HiveMetastoreVersion', '10': 'supportedHiveMetastoreVersions'},
  ],
...
final $typed_data.Uint8List locationMetadataDescriptor = $convert.base64Decode('');

...
class RequestsLogEntry extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'RequestsLogEntry', package: const $pb.PackageName(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'google.cloud.metastore.logging.v1'), createEmptyInstance: create)
  ...
  'Will be removed in next major version')
  RequestsLogEntry copyWith(void Function(RequestsLogEntry) updates) => super.copyWith((message) => updates(message as RequestsLogEntry)) as RequestsLogEntry; // ignore: deprecated_member_use
...
class SystemActivityLogEntry extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'SystemActivityLogEntry', package: const $pb.PackageName(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'google.cloud.metastore.logging.v1'), createEmptyInstance: create)
    ..aOS(1, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'message')
    ..hasRequiredFields = false
  ;
  ...
  'Use [GeneratedMessageGenericExtensions.rebuild] instead. '
  'Will be removed in next major version')
  SystemActivityLogEntry copyWith(void Function(SystemActivityLogEntry) updates) => super.copyWith((message) => updates(message as SystemActivityLogEntry)) as SystemActivityLogEntry; // ignore: deprecated_member_use
  $pb.BuilderInfo get info_ => _i;
  @$core.pragma('dart2js:noInline')

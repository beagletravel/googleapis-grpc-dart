...
const Service$json = const {
  '1': 'Service',
  '2': const [
    const {'1': 'hive_metastore_config', '3': 5, '4': 1, '5': 11, '6': '.google.cloud.metastore.v1beta.HiveMetastoreConfig', '9': 0, '10': 'hiveMetastoreConfig'},
    ...
    const {'1': 'labels', '3': 4, '4': 3, '5': 11, '6': '.google.cloud.metastore.v1beta.Service.LabelsEntry', '10': 'labels'},
    ...
    const {'1': 'state', '3': 10, '4': 1, '5': 14, '6': '.google.cloud.metastore.v1beta.Service.State', '8': const {}, '10': 'state'},
    ...
    const {'1': 'tier', '3': 13, '4': 1, '5': 14, '6': '.google.cloud.metastore.v1beta.Service.Tier', '10': 'tier'},
    const {'1': 'metadata_integration', '3': 14, '4': 1, '5': 11, '6': '.google.cloud.metastore.v1beta.MetadataIntegration', '10': 'metadataIntegration'},
    const {'1': 'maintenance_window', '3': 15, '4': 1, '5': 11, '6': '.google.cloud.metastore.v1beta.MaintenanceWindow', '10': 'maintenanceWindow'},
    const {'1': 'uid', '3': 16, '4': 1, '5': 9, '8': const {}, '10': 'uid'},
    const {'1': 'metadata_management_activity', '3': 17, '4': 1, '5': 11, '6': '.google.cloud.metastore.v1beta.MetadataManagementActivity', '8': const {}, '10': 'metadataManagementActivity'},
    const {'1': 'release_channel', '3': 19, '4': 1, '5': 14, '6': '.google.cloud.metastore.v1beta.Service.ReleaseChannel', '8': const {}, '10': 'releaseChannel'},
  ],
...
final $typed_data.Uint8List serviceDescriptor = $convert.base64Decode('');
@$core.Deprecated('Use metadataIntegrationDescriptor instead')
const MetadataIntegration$json = const {
  '1': 'MetadataIntegration',
  '2': const [
    const {'1': 'data_catalog_config', '3': 1, '4': 1, '5': 11, '6': '.google.cloud.metastore.v1beta.DataCatalogConfig', '10': 'dataCatalogConfig'},
  ],
};

/// Descriptor for `MetadataIntegration`. Decode as a `google.protobuf.DescriptorProto`.
final $typed_data.Uint8List metadataIntegrationDescriptor = $convert.base64Decode('ChNNZXRhZGF0YUludGVncmF0aW9uEmAKE2RhdGFfY2F0YWxvZ19jb25maWcYASABKAsyMC5nb29nbGUuY2xvdWQubWV0YXN0b3JlLnYxYmV0YS5EYXRhQ2F0YWxvZ0NvbmZpZ1IRZGF0YUNhdGFsb2dDb25maWc=');
...
const HiveMetastoreConfig$json = const {
  ...
  '2': const [
    ...
    const {'1': 'config_overrides', '3': 2, '4': 3, '5': 11, '6': '.google.cloud.metastore.v1beta.HiveMetastoreConfig.ConfigOverridesEntry', '10': 'configOverrides'},
    const {'1': 'kerberos_config', '3': 3, '4': 1, '5': 11, '6': '.google.cloud.metastore.v1beta.KerberosConfig', '10': 'kerberosConfig'},
  ],
...
final $typed_data.Uint8List hiveMetastoreConfigDescriptor = $convert.base64Decode('');
@$core.Deprecated('Use kerberosConfigDescriptor instead')
const KerberosConfig$json = const {
  '1': 'KerberosConfig',
  '2': const [
    const {'1': 'keytab', '3': 1, '4': 1, '5': 11, '6': '.google.cloud.metastore.v1beta.Secret', '10': 'keytab'},
...
final $typed_data.Uint8List kerberosConfigDescriptor = $convert.base64Decode('Cg5LZXJiZXJvc0NvbmZpZxI9CgZrZXl0YWIYASABKAsyJS5nb29nbGUuY2xvdWQubWV0YXN0b3JlLnYxYmV0YS5TZWNyZXRSBmtleXRhYhIcCglwcmluY2lwYWwYAiABKAlSCXByaW5jaXBhbBItChNrcmI1X2NvbmZpZ19nY3NfdXJpGAMgASgJUhBrcmI1Q29uZmlnR2NzVXJp');
...
const MetadataManagementActivity$json = const {
  ...
  '2': const [
    const {'1': 'metadata_exports', '3': 1, '4': 3, '5': 11, '6': '.google.cloud.metastore.v1beta.MetadataExport', '8': const {}, '10': 'metadataExports'},
    const {'1': 'restores', '3': 2, '4': 3, '5': 11, '6': '.google.cloud.metastore.v1beta.Restore', '8': const {}, '10': 'restores'},
  ],
};

/// Descriptor for `MetadataManagementActivity`. Decode as a `google.protobuf.DescriptorProto`.
final $typed_data.Uint8List metadataManagementActivityDescriptor = $convert.base64Decode('');
@$core.Deprecated('Use metadataImportDescriptor instead')
const MetadataImport$json = const {
  '1': 'MetadataImport',
  '2': const [
    const {'1': 'database_dump', '3': 6, '4': 1, '5': 11, '6': '.google.cloud.metastore.v1beta.MetadataImport.DatabaseDump', '8': const {}, '9': 0, '10': 'databaseDump'},
    const {'1': 'name', '3': 1, '4': 1, '5': 9, '8': const {}, '10': 'name'},
    ...
    const {'1': 'state', '3': 5, '4': 1, '5': 14, '6': '.google.cloud.metastore.v1beta.MetadataImport.State', '8': const {}, '10': 'state'},
  ],
...
const MetadataImport_DatabaseDump$json = const {
  ...
  '2': const [
    ...
    const {'1': 'type', '3': 4, '4': 1, '5': 14, '6': '.google.cloud.metastore.v1beta.DatabaseDumpSpec.Type', '8': const {}, '10': 'type'},
  ],
...
const MetadataExport$json = const {
  ...
  '2': const [
    ...
    const {'1': 'state', '3': 3, '4': 1, '5': 14, '6': '.google.cloud.metastore.v1beta.MetadataExport.State', '8': const {}, '10': 'state'},
    const {'1': 'database_dump_type', '3': 5, '4': 1, '5': 14, '6': '.google.cloud.metastore.v1beta.DatabaseDumpSpec.Type', '8': const {}, '10': 'databaseDumpType'},
  ],
...
const Backup$json = const {
  ...
  '2': const [
    ...
    const {'1': 'state', '3': 4, '4': 1, '5': 14, '6': '.google.cloud.metastore.v1beta.Backup.State', '8': const {}, '10': 'state'},
    const {'1': 'service_revision', '3': 5, '4': 1, '5': 11, '6': '.google.cloud.metastore.v1beta.Service', '8': const {}, '10': 'serviceRevision'},
...
final $typed_data.Uint8List backupDescriptor = $convert.base64Decode('');
...
const Restore$json = const {
  ...
  '2': const [
    const {'1': 'start_time', '3': 1, '4': 1, '5': 11, '6': '.google.protobuf.Timestamp', '8': const {}, '10': 'startTime'},
    const {'1': 'end_time', '3': 2, '4': 1, '5': 11, '6': '.google.protobuf.Timestamp', '8': const {}, '10': 'endTime'},
    const {'1': 'state', '3': 3, '4': 1, '5': 14, '6': '.google.cloud.metastore.v1beta.Restore.State', '8': const {}, '10': 'state'},
    const {'1': 'backup', '3': 4, '4': 1, '5': 9, '8': const {}, '10': 'backup'},
    const {'1': 'type', '3': 5, '4': 1, '5': 14, '6': '.google.cloud.metastore.v1beta.Restore.RestoreType', '8': const {}, '10': 'type'},
...
const ListServicesResponse$json = const {
  ...
  '2': const [
    const {'1': 'services', '3': 1, '4': 3, '5': 11, '6': '.google.cloud.metastore.v1beta.Service', '10': 'services'},
...
final $typed_data.Uint8List listServicesResponseDescriptor = $convert.base64Decode('ChRMaXN0U2VydmljZXNSZXNwb25zZRJCCghzZXJ2aWNlcxgBIAMoCzImLmdvb2dsZS5jbG91ZC5tZXRhc3RvcmUudjFiZXRhLlNlcnZpY2VSCHNlcnZpY2VzEiYKD25leHRfcGFnZV90b2tlbhgCIAEoCVINbmV4dFBhZ2VUb2tlbhIgCgt1bnJlYWNoYWJsZRgDIAMoCVILdW5yZWFjaGFibGU=');
...
const CreateServiceRequest$json = const {
  ...
  '2': const [
    ...
    const {'1': 'service', '3': 3, '4': 1, '5': 11, '6': '.google.cloud.metastore.v1beta.Service', '8': const {}, '10': 'service'},
...
final $typed_data.Uint8List createServiceRequestDescriptor = $convert.base64Decode('');
...
const UpdateServiceRequest$json = const {
  ...
  '2': const [
    ...
    const {'1': 'service', '3': 2, '4': 1, '5': 11, '6': '.google.cloud.metastore.v1beta.Service', '8': const {}, '10': 'service'},
...
final $typed_data.Uint8List updateServiceRequestDescriptor = $convert.base64Decode('');
...
const ListMetadataImportsResponse$json = const {
  ...
  '2': const [
    const {'1': 'metadata_imports', '3': 1, '4': 3, '5': 11, '6': '.google.cloud.metastore.v1beta.MetadataImport', '10': 'metadataImports'},
    const {'1': 'next_page_token', '3': 2, '4': 1, '5': 9, '10': 'nextPageToken'},
    const {'1': 'unreachable', '3': 3, '4': 3, '5': 9, '10': 'unreachable'},
  ],
};
...
final $typed_data.Uint8List listMetadataImportsResponseDescriptor = $convert.base64Decode('');
...
const CreateMetadataImportRequest$json = const {
  ...
  '2': const [
    ...
    const {'1': 'metadata_import', '3': 3, '4': 1, '5': 11, '6': '.google.cloud.metastore.v1beta.MetadataImport', '8': const {}, '10': 'metadataImport'},
    const {'1': 'request_id', '3': 4, '4': 1, '5': 9, '8': const {}, '10': 'requestId'},
  ],
};

/// Descriptor for `CreateMetadataImportRequest`. Decode as a `google.protobuf.DescriptorProto`.
final $typed_data.Uint8List createMetadataImportRequestDescriptor = $convert.base64Decode('');
...
const UpdateMetadataImportRequest$json = const {
  ...
  '2': const [
    const {'1': 'update_mask', '3': 1, '4': 1, '5': 11, '6': '.google.protobuf.FieldMask', '8': const {}, '10': 'updateMask'},
    const {'1': 'metadata_import', '3': 2, '4': 1, '5': 11, '6': '.google.cloud.metastore.v1beta.MetadataImport', '8': const {}, '10': 'metadataImport'},
    const {'1': 'request_id', '3': 3, '4': 1, '5': 9, '8': const {}, '10': 'requestId'},
  ],
};

/// Descriptor for `UpdateMetadataImportRequest`. Decode as a `google.protobuf.DescriptorProto`.
final $typed_data.Uint8List updateMetadataImportRequestDescriptor = $convert.base64Decode('');
...
const ListBackupsResponse$json = const {
  ...
  '2': const [
    const {'1': 'backups', '3': 1, '4': 3, '5': 11, '6': '.google.cloud.metastore.v1beta.Backup', '10': 'backups'},
    const {'1': 'next_page_token', '3': 2, '4': 1, '5': 9, '10': 'nextPageToken'},
    const {'1': 'unreachable', '3': 3, '4': 3, '5': 9, '10': 'unreachable'},
  ],
};
...
final $typed_data.Uint8List listBackupsResponseDescriptor = $convert.base64Decode('ChNMaXN0QmFja3Vwc1Jlc3BvbnNlEj8KB2JhY2t1cHMYASADKAsyJS5nb29nbGUuY2xvdWQubWV0YXN0b3JlLnYxYmV0YS5CYWNrdXBSB2JhY2t1cHMSJgoPbmV4dF9wYWdlX3Rva2VuGAIgASgJUg1uZXh0UGFnZVRva2VuEiAKC3VucmVhY2hhYmxlGAMgAygJUgt1bnJlYWNoYWJsZQ==');
...
const CreateBackupRequest$json = const {
  ...
  '2': const [
    ...
    const {'1': 'backup', '3': 3, '4': 1, '5': 11, '6': '.google.cloud.metastore.v1beta.Backup', '8': const {}, '10': 'backup'},
    const {'1': 'request_id', '3': 4, '4': 1, '5': 9, '8': const {}, '10': 'requestId'},
  ],
};

/// Descriptor for `CreateBackupRequest`. Decode as a `google.protobuf.DescriptorProto`.
final $typed_data.Uint8List createBackupRequestDescriptor = $convert.base64Decode('');
...
const ExportMetadataRequest$json = const {
  ...
  '2': const [
    ...
    const {'1': 'request_id', '3': 3, '4': 1, '5': 9, '8': const {}, '10': 'requestId'},
    const {'1': 'database_dump_type', '3': 4, '4': 1, '5': 14, '6': '.google.cloud.metastore.v1beta.DatabaseDumpSpec.Type', '8': const {}, '10': 'databaseDumpType'},
  ],
  '8': const [
    const {'1': 'destination'},
  ],
...
const RestoreServiceRequest$json = const {
  ...
  '2': const [
    ...
    const {'1': 'restore_type', '3': 3, '4': 1, '5': 14, '6': '.google.cloud.metastore.v1beta.Restore.RestoreType', '8': const {}, '10': 'restoreType'},
    const {'1': 'request_id', '3': 4, '4': 1, '5': 9, '8': const {}, '10': 'requestId'},
  ],
};
...
const LocationMetadata$json = const {
  '1': 'LocationMetadata',
  '2': const [
    const {'1': 'supported_hive_metastore_versions', '3': 1, '4': 3, '5': 11, '6': '.google.cloud.metastore.v1beta.LocationMetadata.HiveMetastoreVersion', '10': 'supportedHiveMetastoreVersions'},
  ],
...
final $typed_data.Uint8List locationMetadataDescriptor = $convert.base64Decode('');
...
final $typed_data.Uint8List databaseDumpSpecDescriptor = $convert.base64Decode('ChBEYXRhYmFzZUR1bXBTcGVjIicKBFR5cGUSFAoQVFlQRV9VTlNQRUNJRklFRBAAEgkKBU1ZU1FMEAE=');

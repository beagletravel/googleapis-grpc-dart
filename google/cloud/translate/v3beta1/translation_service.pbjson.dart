...
const TranslateTextRequest$json = const {
  ...
  '2': const [
    ...
    const {'1': 'glossary_config', '3': 7, '4': 1, '5': 11, '6': '.google.cloud.translation.v3beta1.TranslateTextGlossaryConfig', '8': const {}, '10': 'glossaryConfig'},
    const {'1': 'labels', '3': 10, '4': 3, '5': 11, '6': '.google.cloud.translation.v3beta1.TranslateTextRequest.LabelsEntry', '8': const {}, '10': 'labels'},
  ],
...
final $typed_data.Uint8List translateTextResponseDescriptor = $convert.base64Decode('');
...
final $typed_data.Uint8List translationDescriptor = $convert.base64Decode('');
...
const DetectLanguageRequest$json = const {
  ...
  '2': const [
    ...
    const {'1': 'mime_type', '3': 3, '4': 1, '5': 9, '8': const {}, '10': 'mimeType'},
    const {'1': 'labels', '3': 6, '4': 3, '5': 11, '6': '.google.cloud.translation.v3beta1.DetectLanguageRequest.LabelsEntry', '8': const {}, '10': 'labels'},
  ],
...
final $typed_data.Uint8List detectLanguageResponseDescriptor = $convert.base64Decode('ChZEZXRlY3RMYW5ndWFnZVJlc3BvbnNlElAKCWxhbmd1YWdlcxgBIAMoCzIyLmdvb2dsZS5jbG91ZC50cmFuc2xhdGlvbi52M2JldGExLkRldGVjdGVkTGFuZ3VhZ2VSCWxhbmd1YWdlcw==');
...
final $typed_data.Uint8List supportedLanguagesDescriptor = $convert.base64Decode('ChJTdXBwb3J0ZWRMYW5ndWFnZXMSUQoJbGFuZ3VhZ2VzGAEgAygLMjMuZ29vZ2xlLmNsb3VkLnRyYW5zbGF0aW9uLnYzYmV0YTEuU3VwcG9ydGVkTGFuZ3VhZ2VSCWxhbmd1YWdlcw==');
...
const GcsSource$json = const {
  '1': 'GcsSource',
  '2': const [
    const {'1': 'input_uri', '3': 1, '4': 1, '5': 9, '8': const {}, '10': 'inputUri'},
  ],
};

/// Descriptor for `GcsSource`. Decode as a `google.protobuf.DescriptorProto`.
final $typed_data.Uint8List gcsSourceDescriptor = $convert.base64Decode('CglHY3NTb3VyY2USIAoJaW5wdXRfdXJpGAEgASgJQgPgQQJSCGlucHV0VXJp');
...
final $typed_data.Uint8List inputConfigDescriptor = $convert.base64Decode('CgtJbnB1dENvbmZpZxIgCgltaW1lX3R5cGUYASABKAlCA+BBAVIIbWltZVR5cGUSTAoKZ2NzX3NvdXJjZRgCIAEoCzIrLmdvb2dsZS5jbG91ZC50cmFuc2xhdGlvbi52M2JldGExLkdjc1NvdXJjZUgAUglnY3NTb3VyY2VCCAoGc291cmNl');
@$core.Deprecated('Use gcsDestinationDescriptor instead')
const GcsDestination$json = const {
  '1': 'GcsDestination',
  '2': const [
    const {'1': 'output_uri_prefix', '3': 1, '4': 1, '5': 9, '8': const {}, '10': 'outputUriPrefix'},
  ],
};

/// Descriptor for `GcsDestination`. Decode as a `google.protobuf.DescriptorProto`.
final $typed_data.Uint8List gcsDestinationDescriptor = $convert.base64Decode('Cg5HY3NEZXN0aW5hdGlvbhIvChFvdXRwdXRfdXJpX3ByZWZpeBgBIAEoCUID4EECUg9vdXRwdXRVcmlQcmVmaXg=');
...
final $typed_data.Uint8List outputConfigDescriptor = $convert.base64Decode('CgxPdXRwdXRDb25maWcSWwoPZ2NzX2Rlc3RpbmF0aW9uGAEgASgLMjAuZ29vZ2xlLmNsb3VkLnRyYW5zbGF0aW9uLnYzYmV0YTEuR2NzRGVzdGluYXRpb25IAFIOZ2NzRGVzdGluYXRpb25CDQoLZGVzdGluYXRpb24=');
...
final $typed_data.Uint8List documentInputConfigDescriptor = $convert.base64Decode('ChNEb2N1bWVudElucHV0Q29uZmlnEhoKB2NvbnRlbnQYASABKAxIAFIHY29udGVudBJMCgpnY3Nfc291cmNlGAIgASgLMisuZ29vZ2xlLmNsb3VkLnRyYW5zbGF0aW9uLnYzYmV0YTEuR2NzU291cmNlSABSCWdjc1NvdXJjZRIbCgltaW1lX3R5cGUYBCABKAlSCG1pbWVUeXBlQggKBnNvdXJjZQ==');
@$core.Deprecated('Use documentOutputConfigDescriptor instead')
const DocumentOutputConfig$json = const {
  '1': 'DocumentOutputConfig',
  '2': const [
    const {'1': 'gcs_destination', '3': 1, '4': 1, '5': 11, '6': '.google.cloud.translation.v3beta1.GcsDestination', '8': const {}, '9': 0, '10': 'gcsDestination'},
    const {'1': 'mime_type', '3': 3, '4': 1, '5': 9, '8': const {}, '10': 'mimeType'},
  ],
  '8': const [
    const {'1': 'destination'},
...
final $typed_data.Uint8List documentOutputConfigDescriptor = $convert.base64Decode('ChREb2N1bWVudE91dHB1dENvbmZpZxJgCg9nY3NfZGVzdGluYXRpb24YASABKAsyMC5nb29nbGUuY2xvdWQudHJhbnNsYXRpb24udjNiZXRhMS5HY3NEZXN0aW5hdGlvbkID4EEBSABSDmdjc0Rlc3RpbmF0aW9uEiAKCW1pbWVfdHlwZRgDIAEoCUID4EEBUghtaW1lVHlwZUINCgtkZXN0aW5hdGlvbg==');
...
const TranslateDocumentRequest$json = const {
  ...
  '2': const [
    ...
    const {'1': 'target_language_code', '3': 3, '4': 1, '5': 9, '8': const {}, '10': 'targetLanguageCode'},
    const {'1': 'document_input_config', '3': 4, '4': 1, '5': 11, '6': '.google.cloud.translation.v3beta1.DocumentInputConfig', '8': const {}, '10': 'documentInputConfig'},
    const {'1': 'document_output_config', '3': 5, '4': 1, '5': 11, '6': '.google.cloud.translation.v3beta1.DocumentOutputConfig', '8': const {}, '10': 'documentOutputConfig'},
    const {'1': 'model', '3': 6, '4': 1, '5': 9, '8': const {}, '10': 'model'},
    const {'1': 'glossary_config', '3': 7, '4': 1, '5': 11, '6': '.google.cloud.translation.v3beta1.TranslateTextGlossaryConfig', '8': const {}, '10': 'glossaryConfig'},
    const {'1': 'labels', '3': 8, '4': 3, '5': 11, '6': '.google.cloud.translation.v3beta1.TranslateDocumentRequest.LabelsEntry', '8': const {}, '10': 'labels'},
  ],
...
const TranslateDocumentResponse$json = const {
  ...
  '2': const [
    const {'1': 'document_translation', '3': 1, '4': 1, '5': 11, '6': '.google.cloud.translation.v3beta1.DocumentTranslation', '10': 'documentTranslation'},
    const {'1': 'glossary_document_translation', '3': 2, '4': 1, '5': 11, '6': '.google.cloud.translation.v3beta1.DocumentTranslation', '10': 'glossaryDocumentTranslation'},
    const {'1': 'model', '3': 3, '4': 1, '5': 9, '10': 'model'},
    const {'1': 'glossary_config', '3': 4, '4': 1, '5': 11, '6': '.google.cloud.translation.v3beta1.TranslateTextGlossaryConfig', '10': 'glossaryConfig'},
  ],
};

/// Descriptor for `TranslateDocumentResponse`. Decode as a `google.protobuf.DescriptorProto`.
final $typed_data.Uint8List translateDocumentResponseDescriptor = $convert.base64Decode('');
...
const BatchTranslateTextRequest$json = const {
  ...
  '2': const [
    ...
    const {'1': 'models', '3': 4, '4': 3, '5': 11, '6': '.google.cloud.translation.v3beta1.BatchTranslateTextRequest.ModelsEntry', '8': const {}, '10': 'models'},
    const {'1': 'input_configs', '3': 5, '4': 3, '5': 11, '6': '.google.cloud.translation.v3beta1.InputConfig', '8': const {}, '10': 'inputConfigs'},
    const {'1': 'output_config', '3': 6, '4': 1, '5': 11, '6': '.google.cloud.translation.v3beta1.OutputConfig', '8': const {}, '10': 'outputConfig'},
    const {'1': 'glossaries', '3': 7, '4': 3, '5': 11, '6': '.google.cloud.translation.v3beta1.BatchTranslateTextRequest.GlossariesEntry', '8': const {}, '10': 'glossaries'},
    const {'1': 'labels', '3': 9, '4': 3, '5': 11, '6': '.google.cloud.translation.v3beta1.BatchTranslateTextRequest.LabelsEntry', '8': const {}, '10': 'labels'},
  ],
...
final $typed_data.Uint8List batchTranslateTextRequestDescriptor = $convert.base64Decode('');
...
final $typed_data.Uint8List batchTranslateMetadataDescriptor = $convert.base64Decode('');
...
final $typed_data.Uint8List glossaryInputConfigDescriptor = $convert.base64Decode('ChNHbG9zc2FyeUlucHV0Q29uZmlnEkwKCmdjc19zb3VyY2UYASABKAsyKy5nb29nbGUuY2xvdWQudHJhbnNsYXRpb24udjNiZXRhMS5HY3NTb3VyY2VIAFIJZ2NzU291cmNlQggKBnNvdXJjZQ==');
...
final $typed_data.Uint8List glossaryDescriptor = $convert.base64Decode('');
@$core.Deprecated('Use createGlossaryRequestDescriptor instead')
const CreateGlossaryRequest$json = const {
  '1': 'CreateGlossaryRequest',
  '2': const [
    const {'1': 'parent', '3': 1, '4': 1, '5': 9, '8': const {}, '10': 'parent'},
    const {'1': 'glossary', '3': 2, '4': 1, '5': 11, '6': '.google.cloud.translation.v3beta1.Glossary', '8': const {}, '10': 'glossary'},
  ],
};

/// Descriptor for `CreateGlossaryRequest`. Decode as a `google.protobuf.DescriptorProto`.
final $typed_data.Uint8List createGlossaryRequestDescriptor = $convert.base64Decode('ChVDcmVhdGVHbG9zc2FyeVJlcXVlc3QSQQoGcGFyZW50GAEgASgJQingQQL6QSMKIWxvY2F0aW9ucy5nb29nbGVhcGlzLmNvbS9Mb2NhdGlvblIGcGFyZW50EksKCGdsb3NzYXJ5GAIgASgLMiouZ29vZ2xlLmNsb3VkLnRyYW5zbGF0aW9uLnYzYmV0YTEuR2xvc3NhcnlCA+BBAlIIZ2xvc3Nhcnk=');
...
final $typed_data.Uint8List listGlossariesResponseDescriptor = $convert.base64Decode('ChZMaXN0R2xvc3Nhcmllc1Jlc3BvbnNlEkoKCmdsb3NzYXJpZXMYASADKAsyKi5nb29nbGUuY2xvdWQudHJhbnNsYXRpb24udjNiZXRhMS5HbG9zc2FyeVIKZ2xvc3NhcmllcxImCg9uZXh0X3BhZ2VfdG9rZW4YAiABKAlSDW5leHRQYWdlVG9rZW4=');
...
final $typed_data.Uint8List createGlossaryMetadataDescriptor = $convert.base64Decode('');
...
final $typed_data.Uint8List deleteGlossaryMetadataDescriptor = $convert.base64Decode('');
...
const BatchTranslateDocumentRequest$json = const {
  ...
  '2': const [
    ...
    const {'1': 'source_language_code', '3': 2, '4': 1, '5': 9, '8': const {}, '10': 'sourceLanguageCode'},
    const {'1': 'target_language_codes', '3': 3, '4': 3, '5': 9, '8': const {}, '10': 'targetLanguageCodes'},
    const {'1': 'input_configs', '3': 4, '4': 3, '5': 11, '6': '.google.cloud.translation.v3beta1.BatchDocumentInputConfig', '8': const {}, '10': 'inputConfigs'},
    const {'1': 'output_config', '3': 5, '4': 1, '5': 11, '6': '.google.cloud.translation.v3beta1.BatchDocumentOutputConfig', '8': const {}, '10': 'outputConfig'},
    const {'1': 'models', '3': 6, '4': 3, '5': 11, '6': '.google.cloud.translation.v3beta1.BatchTranslateDocumentRequest.ModelsEntry', '8': const {}, '10': 'models'},
    const {'1': 'glossaries', '3': 7, '4': 3, '5': 11, '6': '.google.cloud.translation.v3beta1.BatchTranslateDocumentRequest.GlossariesEntry', '8': const {}, '10': 'glossaries'},
    const {'1': 'format_conversions', '3': 8, '4': 3, '5': 11, '6': '.google.cloud.translation.v3beta1.BatchTranslateDocumentRequest.FormatConversionsEntry', '8': const {}, '10': 'formatConversions'},
  ],
  '3': const [BatchTranslateDocumentRequest_ModelsEntry$json, BatchTranslateDocumentRequest_GlossariesEntry$json, BatchTranslateDocumentRequest_FormatConversionsEntry$json],
};
...
final $typed_data.Uint8List batchDocumentInputConfigDescriptor = $convert.base64Decode('ChhCYXRjaERvY3VtZW50SW5wdXRDb25maWcSTAoKZ2NzX3NvdXJjZRgBIAEoCzIrLmdvb2dsZS5jbG91ZC50cmFuc2xhdGlvbi52M2JldGExLkdjc1NvdXJjZUgAUglnY3NTb3VyY2VCCAoGc291cmNl');
...
final $typed_data.Uint8List batchDocumentOutputConfigDescriptor = $convert.base64Decode('ChlCYXRjaERvY3VtZW50T3V0cHV0Q29uZmlnElsKD2djc19kZXN0aW5hdGlvbhgBIAEoCzIwLmdvb2dsZS5jbG91ZC50cmFuc2xhdGlvbi52M2JldGExLkdjc0Rlc3RpbmF0aW9uSABSDmdjc0Rlc3RpbmF0aW9uQg0KC2Rlc3RpbmF0aW9u');
...
const BatchTranslateDocumentResponse$json = const {
  ...
  '2': const [
    ...
    const {'1': 'translated_pages', '3': 2, '4': 1, '5': 3, '10': 'translatedPages'},
    const {'1': 'failed_pages', '3': 3, '4': 1, '5': 3, '10': 'failedPages'},
    const {'1': 'total_billable_pages', '3': 4, '4': 1, '5': 3, '10': 'totalBillablePages'},
    const {'1': 'total_characters', '3': 5, '4': 1, '5': 3, '10': 'totalCharacters'},
    const {'1': 'translated_characters', '3': 6, '4': 1, '5': 3, '10': 'translatedCharacters'},
    const {'1': 'failed_characters', '3': 7, '4': 1, '5': 3, '10': 'failedCharacters'},
    const {'1': 'total_billable_characters', '3': 8, '4': 1, '5': 3, '10': 'totalBillableCharacters'},
    const {'1': 'submit_time', '3': 9, '4': 1, '5': 11, '6': '.google.protobuf.Timestamp', '10': 'submitTime'},
...
final $typed_data.Uint8List batchTranslateDocumentResponseDescriptor = $convert.base64Decode('');
...
const BatchTranslateDocumentMetadata$json = const {
  ...
  '2': const [
    const {'1': 'state', '3': 1, '4': 1, '5': 14, '6': '.google.cloud.translation.v3beta1.BatchTranslateDocumentMetadata.State', '10': 'state'},
    const {'1': 'total_pages', '3': 2, '4': 1, '5': 3, '10': 'totalPages'},
    const {'1': 'translated_pages', '3': 3, '4': 1, '5': 3, '10': 'translatedPages'},
    const {'1': 'failed_pages', '3': 4, '4': 1, '5': 3, '10': 'failedPages'},
    const {'1': 'total_billable_pages', '3': 5, '4': 1, '5': 3, '10': 'totalBillablePages'},
    const {'1': 'total_characters', '3': 6, '4': 1, '5': 3, '10': 'totalCharacters'},
    const {'1': 'translated_characters', '3': 7, '4': 1, '5': 3, '10': 'translatedCharacters'},
    const {'1': 'failed_characters', '3': 8, '4': 1, '5': 3, '10': 'failedCharacters'},
    const {'1': 'total_billable_characters', '3': 9, '4': 1, '5': 3, '10': 'totalBillableCharacters'},
    const {'1': 'submit_time', '3': 10, '4': 1, '5': 11, '6': '.google.protobuf.Timestamp', '10': 'submitTime'},
  ],
...
final $typed_data.Uint8List batchTranslateDocumentMetadataDescriptor = $convert.base64Decode('');

...
final $typed_data.Uint8List documentInputConfigDescriptor = $convert.base64Decode('ChNEb2N1bWVudElucHV0Q29uZmlnEhoKB2NvbnRlbnQYASABKAxIAFIHY29udGVudBJHCgpnY3Nfc291cmNlGAIgASgLMiYuZ29vZ2xlLmNsb3VkLnRyYW5zbGF0aW9uLnYzLkdjc1NvdXJjZUgAUglnY3NTb3VyY2USGwoJbWltZV90eXBlGAQgASgJUghtaW1lVHlwZUIICgZzb3VyY2U=');
@$core.Deprecated('Use documentOutputConfigDescriptor instead')
const DocumentOutputConfig$json = const {
  '1': 'DocumentOutputConfig',
  '2': const [
    const {'1': 'gcs_destination', '3': 1, '4': 1, '5': 11, '6': '.google.cloud.translation.v3.GcsDestination', '8': const {}, '9': 0, '10': 'gcsDestination'},
    const {'1': 'mime_type', '3': 3, '4': 1, '5': 9, '8': const {}, '10': 'mimeType'},
  ],
  '8': const [
    const {'1': 'destination'},
...
final $typed_data.Uint8List documentOutputConfigDescriptor = $convert.base64Decode('ChREb2N1bWVudE91dHB1dENvbmZpZxJbCg9nY3NfZGVzdGluYXRpb24YASABKAsyKy5nb29nbGUuY2xvdWQudHJhbnNsYXRpb24udjMuR2NzRGVzdGluYXRpb25CA+BBAUgAUg5nY3NEZXN0aW5hdGlvbhIgCgltaW1lX3R5cGUYAyABKAlCA+BBAVIIbWltZVR5cGVCDQoLZGVzdGluYXRpb24=');
...
const TranslateDocumentRequest$json = const {
  ...
  '2': const [
    ...
    const {'1': 'document_input_config', '3': 4, '4': 1, '5': 11, '6': '.google.cloud.translation.v3.DocumentInputConfig', '8': const {}, '10': 'documentInputConfig'},
    const {'1': 'document_output_config', '3': 5, '4': 1, '5': 11, '6': '.google.cloud.translation.v3.DocumentOutputConfig', '8': const {}, '10': 'documentOutputConfig'},
    const {'1': 'model', '3': 6, '4': 1, '5': 9, '8': const {}, '10': 'model'},
    const {'1': 'glossary_config', '3': 7, '4': 1, '5': 11, '6': '.google.cloud.translation.v3.TranslateTextGlossaryConfig', '8': const {}, '10': 'glossaryConfig'},
    const {'1': 'labels', '3': 8, '4': 3, '5': 11, '6': '.google.cloud.translation.v3.TranslateDocumentRequest.LabelsEntry', '8': const {}, '10': 'labels'},
  ],
...
const TranslateDocumentResponse$json = const {
  ...
  '2': const [
    const {'1': 'document_translation', '3': 1, '4': 1, '5': 11, '6': '.google.cloud.translation.v3.DocumentTranslation', '10': 'documentTranslation'},
    const {'1': 'glossary_document_translation', '3': 2, '4': 1, '5': 11, '6': '.google.cloud.translation.v3.DocumentTranslation', '10': 'glossaryDocumentTranslation'},
    const {'1': 'model', '3': 3, '4': 1, '5': 9, '10': 'model'},
    const {'1': 'glossary_config', '3': 4, '4': 1, '5': 11, '6': '.google.cloud.translation.v3.TranslateTextGlossaryConfig', '10': 'glossaryConfig'},
  ],
};

/// Descriptor for `TranslateDocumentResponse`. Decode as a `google.protobuf.DescriptorProto`.
final $typed_data.Uint8List translateDocumentResponseDescriptor = $convert.base64Decode('');
...
final $typed_data.Uint8List glossaryDescriptor = $convert.base64Decode('');
...
const BatchTranslateDocumentRequest$json = const {
  ...
  '2': const [
    ...
    const {'1': 'source_language_code', '3': 2, '4': 1, '5': 9, '8': const {}, '10': 'sourceLanguageCode'},
    const {'1': 'target_language_codes', '3': 3, '4': 3, '5': 9, '8': const {}, '10': 'targetLanguageCodes'},
    const {'1': 'input_configs', '3': 4, '4': 3, '5': 11, '6': '.google.cloud.translation.v3.BatchDocumentInputConfig', '8': const {}, '10': 'inputConfigs'},
    const {'1': 'output_config', '3': 5, '4': 1, '5': 11, '6': '.google.cloud.translation.v3.BatchDocumentOutputConfig', '8': const {}, '10': 'outputConfig'},
    const {'1': 'models', '3': 6, '4': 3, '5': 11, '6': '.google.cloud.translation.v3.BatchTranslateDocumentRequest.ModelsEntry', '8': const {}, '10': 'models'},
    const {'1': 'glossaries', '3': 7, '4': 3, '5': 11, '6': '.google.cloud.translation.v3.BatchTranslateDocumentRequest.GlossariesEntry', '8': const {}, '10': 'glossaries'},
    const {'1': 'format_conversions', '3': 8, '4': 3, '5': 11, '6': '.google.cloud.translation.v3.BatchTranslateDocumentRequest.FormatConversionsEntry', '8': const {}, '10': 'formatConversions'},
  ],
...
final $typed_data.Uint8List batchDocumentInputConfigDescriptor = $convert.base64Decode('ChhCYXRjaERvY3VtZW50SW5wdXRDb25maWcSRwoKZ2NzX3NvdXJjZRgBIAEoCzImLmdvb2dsZS5jbG91ZC50cmFuc2xhdGlvbi52My5HY3NTb3VyY2VIAFIJZ2NzU291cmNlQggKBnNvdXJjZQ==');
...
final $typed_data.Uint8List batchDocumentOutputConfigDescriptor = $convert.base64Decode('ChlCYXRjaERvY3VtZW50T3V0cHV0Q29uZmlnElYKD2djc19kZXN0aW5hdGlvbhgBIAEoCzIrLmdvb2dsZS5jbG91ZC50cmFuc2xhdGlvbi52My5HY3NEZXN0aW5hdGlvbkgAUg5nY3NEZXN0aW5hdGlvbkINCgtkZXN0aW5hdGlvbg==');
...
const BatchTranslateDocumentMetadata$json = const {
  ...
  '2': const [
    const {'1': 'state', '3': 1, '4': 1, '5': 14, '6': '.google.cloud.translation.v3.BatchTranslateDocumentMetadata.State', '10': 'state'},
...
final $typed_data.Uint8List batchTranslateDocumentMetadataDescriptor = $convert.base64Decode('');

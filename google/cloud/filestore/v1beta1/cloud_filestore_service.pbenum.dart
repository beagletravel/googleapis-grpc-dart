...
class NetworkConfig_AddressMode extends $pb.ProtobufEnum {
  static const NetworkConfig_AddressMode ADDRESS_MODE_UNSPECIFIED = NetworkConfig_AddressMode._(0, const $core.bool.fromEnvironment('protobuf.omit_enum_names') ? '' : 'ADDRESS_MODE_UNSPECIFIED');
  static const NetworkConfig_AddressMode MODE_IPV4 = NetworkConfig_AddressMode._(1, const $core.bool.fromEnvironment('protobuf.omit_enum_names') ? '' : 'MODE_IPV4');
...
class NfsExportOptions_AccessMode extends $pb.ProtobufEnum {
  static const NfsExportOptions_AccessMode ACCESS_MODE_UNSPECIFIED = NfsExportOptions_AccessMode._(0, const $core.bool.fromEnvironment('protobuf.omit_enum_names') ? '' : 'ACCESS_MODE_UNSPECIFIED');
  static const NfsExportOptions_AccessMode READ_ONLY = NfsExportOptions_AccessMode._(1, const $core.bool.fromEnvironment('protobuf.omit_enum_names') ? '' : 'READ_ONLY');
  static const NfsExportOptions_AccessMode READ_WRITE = NfsExportOptions_AccessMode._(2, const $core.bool.fromEnvironment('protobuf.omit_enum_names') ? '' : 'READ_WRITE');
...
class NfsExportOptions_SquashMode extends $pb.ProtobufEnum {
  static const NfsExportOptions_SquashMode SQUASH_MODE_UNSPECIFIED = NfsExportOptions_SquashMode._(0, const $core.bool.fromEnvironment('protobuf.omit_enum_names') ? '' : 'SQUASH_MODE_UNSPECIFIED');
  static const NfsExportOptions_SquashMode NO_ROOT_SQUASH = NfsExportOptions_SquashMode._(1, const $core.bool.fromEnvironment('protobuf.omit_enum_names') ? '' : 'NO_ROOT_SQUASH');
  static const NfsExportOptions_SquashMode ROOT_SQUASH = NfsExportOptions_SquashMode._(2, const $core.bool.fromEnvironment('protobuf.omit_enum_names') ? '' : 'ROOT_SQUASH');
...
class Instance_State extends $pb.ProtobufEnum {
  ...
  static const Instance_State REPAIRING = Instance_State._(3, const $core.bool.fromEnvironment('protobuf.omit_enum_names') ? '' : 'REPAIRING');
  ...
  static const Instance_State ERROR = Instance_State._(6, const $core.bool.fromEnvironment('protobuf.omit_enum_names') ? '' : 'ERROR');
  static const Instance_State RESTORING = Instance_State._(7, const $core.bool.fromEnvironment('protobuf.omit_enum_names') ? '' : 'RESTORING');
...
class Instance_Tier extends $pb.ProtobufEnum {
  ...
  static const Instance_Tier STANDARD = Instance_Tier._(1, const $core.bool.fromEnvironment('protobuf.omit_enum_names') ? '' : 'STANDARD');
  static const Instance_Tier PREMIUM = Instance_Tier._(2, const $core.bool.fromEnvironment('protobuf.omit_enum_names') ? '' : 'PREMIUM');
  static const Instance_Tier BASIC_HDD = Instance_Tier._(3, const $core.bool.fromEnvironment('protobuf.omit_enum_names') ? '' : 'BASIC_HDD');
  static const Instance_Tier BASIC_SSD = Instance_Tier._(4, const $core.bool.fromEnvironment('protobuf.omit_enum_names') ? '' : 'BASIC_SSD');
  static const Instance_Tier HIGH_SCALE_SSD = Instance_Tier._(6, const $core.bool.fromEnvironment('protobuf.omit_enum_names') ? '' : 'HIGH_SCALE_SSD');
...
class Snapshot_State extends $pb.ProtobufEnum {
  static const Snapshot_State STATE_UNSPECIFIED = Snapshot_State._(0, const $core.bool.fromEnvironment('protobuf.omit_enum_names') ? '' : 'STATE_UNSPECIFIED');
  static const Snapshot_State CREATING = Snapshot_State._(1, const $core.bool.fromEnvironment('protobuf.omit_enum_names') ? '' : 'CREATING');
  static const Snapshot_State READY = Snapshot_State._(3, const $core.bool.fromEnvironment('protobuf.omit_enum_names') ? '' : 'READY');
  static const Snapshot_State DELETING = Snapshot_State._(4, const $core.bool.fromEnvironment('protobuf.omit_enum_names') ? '' : 'DELETING');
...
class Backup_State extends $pb.ProtobufEnum {
  ...
  static const Backup_State FINALIZING = Backup_State._(2, const $core.bool.fromEnvironment('protobuf.omit_enum_names') ? '' : 'FINALIZING');
  static const Backup_State READY = Backup_State._(3, const $core.bool.fromEnvironment('protobuf.omit_enum_names') ? '' : 'READY');
  static const Backup_State DELETING = Backup_State._(4, const $core.bool.fromEnvironment('protobuf.omit_enum_names') ? '' : 'DELETING');

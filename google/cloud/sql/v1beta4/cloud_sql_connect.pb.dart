...
class GetConnectSettingsRequest extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'GetConnectSettingsRequest', package: const $pb.PackageName(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'google.cloud.sql.v1beta4'), createEmptyInstance: create)
    ...
    ..aOM<$1.Timestamp>(7, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'readTime', subBuilder: $1.Timestamp.create)
  ...
  'Will be removed in next major version')
  GetConnectSettingsRequest copyWith(void Function(GetConnectSettingsRequest) updates) => super.copyWith((message) => updates(message as GetConnectSettingsRequest)) as GetConnectSettingsRequest; // ignore: deprecated_member_use
...
class ConnectSettings extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'ConnectSettings', package: const $pb.PackageName(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'google.cloud.sql.v1beta4'), createEmptyInstance: create)
    ..aOS(1, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'kind')
    ..aOM<$2.SslCert>(2, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'serverCaCert', subBuilder: $2.SslCert.create)
    ..pc<$2.IpMapping>(3, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'ipAddresses', $pb.PbFieldType.PM, subBuilder: $2.IpMapping.create)
    ..aOS(4, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'region')
    ..e<$2.SqlDatabaseVersion>(31, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'databaseVersion', $pb.PbFieldType.OE, defaultOrMaker: $2.SqlDatabaseVersion.SQL_DATABASE_VERSION_UNSPECIFIED, valueOf: $2.SqlDatabaseVersion.valueOf, enumValues: $2.SqlDatabaseVersion.values)
    ..e<$2.SqlBackendType>(32, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'backendType', $pb.PbFieldType.OE, defaultOrMaker: $2.SqlBackendType.SQL_BACKEND_TYPE_UNSPECIFIED, valueOf: $2.SqlBackendType.valueOf, enumValues: $2.SqlBackendType.values)
    ..hasRequiredFields = false
  ;
  ...
  'Use [GeneratedMessageGenericExtensions.rebuild] instead. '
  'Will be removed in next major version')
  ConnectSettings copyWith(void Function(ConnectSettings) updates) => super.copyWith((message) => updates(message as ConnectSettings)) as ConnectSettings; // ignore: deprecated_member_use
  $pb.BuilderInfo get info_ => _i;
  @$core.pragma('dart2js:noInline')
  ...
  @$pb.TagNumber(2)
  set serverCaCert($2.SslCert v) { setField(2, v); }
  @$pb.TagNumber(2)
  ...
  @$pb.TagNumber(31)
  set databaseVersion($2.SqlDatabaseVersion v) { setField(31, v); }
  @$pb.TagNumber(31)
  ...
  @$pb.TagNumber(32)
  set backendType($2.SqlBackendType v) { setField(32, v); }
  @$pb.TagNumber(32)
...
class GenerateEphemeralCertRequest extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'GenerateEphemeralCertRequest', package: const $pb.PackageName(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'google.cloud.sql.v1beta4'), createEmptyInstance: create)
    ..aOS(1, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'instance')
    ..aOS(2, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'project')
    ...
    ..aOM<$1.Timestamp>(7, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'readTime', subBuilder: $1.Timestamp.create)
    ..aOM<$3.Duration>(12, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'validDuration', subBuilder: $3.Duration.create)
    ..hasRequiredFields = false
  ;
  ...
  'Use [GeneratedMessageGenericExtensions.rebuild] instead. '
  'Will be removed in next major version')
  GenerateEphemeralCertRequest copyWith(void Function(GenerateEphemeralCertRequest) updates) => super.copyWith((message) => updates(message as GenerateEphemeralCertRequest)) as GenerateEphemeralCertRequest; // ignore: deprecated_member_use
  $pb.BuilderInfo get info_ => _i;
  @$core.pragma('dart2js:noInline')
  ...
  @$pb.TagNumber(12)
  set validDuration($3.Duration v) { setField(12, v); }
  @$pb.TagNumber(12)
...
class GenerateEphemeralCertResponse extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'GenerateEphemeralCertResponse', package: const $pb.PackageName(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'google.cloud.sql.v1beta4'), createEmptyInstance: create)
    ..aOM<$2.SslCert>(1, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'ephemeralCert', subBuilder: $2.SslCert.create)
    ..hasRequiredFields = false
  ;
  ...
  'Use [GeneratedMessageGenericExtensions.rebuild] instead. '
  'Will be removed in next major version')
  GenerateEphemeralCertResponse copyWith(void Function(GenerateEphemeralCertResponse) updates) => super.copyWith((message) => updates(message as GenerateEphemeralCertResponse)) as GenerateEphemeralCertResponse; // ignore: deprecated_member_use
  $pb.BuilderInfo get info_ => _i;
  @$core.pragma('dart2js:noInline')
  ...
  @$pb.TagNumber(1)
  set ephemeralCert($2.SslCert v) { setField(1, v); }
  @$pb.TagNumber(1)

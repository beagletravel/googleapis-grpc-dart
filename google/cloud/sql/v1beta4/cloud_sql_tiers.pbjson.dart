...
final $typed_data.Uint8List sqlTiersListRequestDescriptor = $convert.base64Decode('ChNTcWxUaWVyc0xpc3RSZXF1ZXN0EhgKB3Byb2plY3QYASABKAlSB3Byb2plY3Q=');
...
const TiersListResponse$json = const {
  ...
  '2': const [
    ...
    const {'1': 'items', '3': 2, '4': 3, '5': 11, '6': '.google.cloud.sql.v1beta4.Tier', '10': 'items'},
  ],
};

/// Descriptor for `TiersListResponse`. Decode as a `google.protobuf.DescriptorProto`.
final $typed_data.Uint8List tiersListResponseDescriptor = $convert.base64Decode('ChFUaWVyc0xpc3RSZXNwb25zZRISCgRraW5kGAEgASgJUgRraW5kEjQKBWl0ZW1zGAIgAygLMh4uZ29vZ2xlLmNsb3VkLnNxbC52MWJldGE0LlRpZXJSBWl0ZW1z');
...
final $typed_data.Uint8List tierDescriptor = $convert.base64Decode('CgRUaWVyEhIKBHRpZXIYASABKAlSBHRpZXISEAoDUkFNGAIgASgDUgNSQU0SEgoEa2luZBgDIAEoCVIEa2luZBIdCgpEaXNrX1F1b3RhGAQgASgDUglEaXNrUXVvdGESFgoGcmVnaW9uGAUgAygJUgZyZWdpb24=');

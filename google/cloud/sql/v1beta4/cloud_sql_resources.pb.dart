...
class AclEntry extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'AclEntry', package: const $pb.PackageName(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'google.cloud.sql.v1beta4'), createEmptyInstance: create)
    ..aOS(1, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'value')
    ..aOM<$0.Timestamp>(2, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'expirationTime', subBuilder: $0.Timestamp.create)
  ...
  'Will be removed in next major version')
  AclEntry copyWith(void Function(AclEntry) updates) => super.copyWith((message) => updates(message as AclEntry)) as AclEntry; // ignore: deprecated_member_use
  ...
  @$pb.TagNumber(2)
  set expirationTime($0.Timestamp v) { setField(2, v); }
  @$pb.TagNumber(2)
...
class ApiWarning extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'ApiWarning', package: const $pb.PackageName(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'google.cloud.sql.v1beta4'), createEmptyInstance: create)
    ..e<ApiWarning_SqlApiWarningCode>(1, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'code', $pb.PbFieldType.OE, defaultOrMaker: ApiWarning_SqlApiWarningCode.SQL_API_WARNING_CODE_UNSPECIFIED, valueOf: ApiWarning_SqlApiWarningCode.valueOf, enumValues: ApiWarning_SqlApiWarningCode.values)
  ...
  'Use [GeneratedMessageGenericExtensions.rebuild] instead. '
  'Will be removed in next major version')
  ApiWarning copyWith(void Function(ApiWarning) updates) => super.copyWith((message) => updates(message as ApiWarning)) as ApiWarning; // ignore: deprecated_member_use
  $pb.BuilderInfo get info_ => _i;
  @$core.pragma('dart2js:noInline')
...
class BackupRetentionSettings extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'BackupRetentionSettings', package: const $pb.PackageName(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'google.cloud.sql.v1beta4'), createEmptyInstance: create)
    ..e<BackupRetentionSettings_RetentionUnit>(1, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'retentionUnit', $pb.PbFieldType.OE, defaultOrMaker: BackupRetentionSettings_RetentionUnit.RETENTION_UNIT_UNSPECIFIED, valueOf: BackupRetentionSettings_RetentionUnit.valueOf, enumValues: BackupRetentionSettings_RetentionUnit.values)
    ..aOM<$1.Int32Value>(2, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'retainedBackups', subBuilder: $1.Int32Value.create)
    ..hasRequiredFields = false
  ;
  ...
  'Use [GeneratedMessageGenericExtensions.rebuild] instead. '
  'Will be removed in next major version')
  BackupRetentionSettings copyWith(void Function(BackupRetentionSettings) updates) => super.copyWith((message) => updates(message as BackupRetentionSettings)) as BackupRetentionSettings; // ignore: deprecated_member_use
  $pb.BuilderInfo get info_ => _i;
  @$core.pragma('dart2js:noInline')
  ...
  @$pb.TagNumber(2)
  set retainedBackups($1.Int32Value v) { setField(2, v); }
  @$pb.TagNumber(2)
...
class BackupConfiguration extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'BackupConfiguration', package: const $pb.PackageName(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'google.cloud.sql.v1beta4'), createEmptyInstance: create)
    ..aOS(1, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'startTime')
    ..aOM<$1.BoolValue>(2, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'enabled', subBuilder: $1.BoolValue.create)
    ..aOS(3, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'kind')
    ..aOM<$1.BoolValue>(4, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'binaryLogEnabled', subBuilder: $1.BoolValue.create)
    ..aOM<$1.BoolValue>(5, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'replicationLogArchivingEnabled', subBuilder: $1.BoolValue.create)
    ..aOS(6, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'location')
    ..aOM<$1.BoolValue>(7, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'pointInTimeRecoveryEnabled', subBuilder: $1.BoolValue.create)
    ..aOM<$1.Int32Value>(9, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'transactionLogRetentionDays', subBuilder: $1.Int32Value.create)
    ..aOM<BackupRetentionSettings>(10, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'backupRetentionSettings', subBuilder: BackupRetentionSettings.create)
    ..hasRequiredFields = false
  ;
  ...
  'Use [GeneratedMessageGenericExtensions.rebuild] instead. '
  'Will be removed in next major version')
  BackupConfiguration copyWith(void Function(BackupConfiguration) updates) => super.copyWith((message) => updates(message as BackupConfiguration)) as BackupConfiguration; // ignore: deprecated_member_use
  $pb.BuilderInfo get info_ => _i;
  @$core.pragma('dart2js:noInline')
  ...
  @$pb.TagNumber(4)
  set binaryLogEnabled($1.BoolValue v) { setField(4, v); }
  @$pb.TagNumber(4)
  ...
  @$pb.TagNumber(5)
  set replicationLogArchivingEnabled($1.BoolValue v) { setField(5, v); }
  @$pb.TagNumber(5)
  ...
  @$pb.TagNumber(7)
  set pointInTimeRecoveryEnabled($1.BoolValue v) { setField(7, v); }
  @$pb.TagNumber(7)
  ...
  @$pb.TagNumber(9)
  set transactionLogRetentionDays($1.Int32Value v) { setField(9, v); }
  @$pb.TagNumber(9)
...
class BackupRun extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'BackupRun', package: const $pb.PackageName(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'google.cloud.sql.v1beta4'), createEmptyInstance: create)
    ..aOS(1, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'kind')
    ..e<SqlBackupRunStatus>(2, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'status', $pb.PbFieldType.OE, defaultOrMaker: SqlBackupRunStatus.SQL_BACKUP_RUN_STATUS_UNSPECIFIED, valueOf: SqlBackupRunStatus.valueOf, enumValues: SqlBackupRunStatus.values)
    ..aOM<$0.Timestamp>(3, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'enqueuedTime', subBuilder: $0.Timestamp.create)
    ...
    ..aOM<OperationError>(7, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'error', subBuilder: OperationError.create)
    ..e<SqlBackupRunType>(8, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'type', $pb.PbFieldType.OE, defaultOrMaker: SqlBackupRunType.SQL_BACKUP_RUN_TYPE_UNSPECIFIED, valueOf: SqlBackupRunType.valueOf, enumValues: SqlBackupRunType.values)
    ..aOS(9, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'description')
    ..aOM<$0.Timestamp>(10, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'windowStartTime', subBuilder: $0.Timestamp.create)
    ..aOS(11, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'instance')
    ..aOS(12, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'selfLink')
    ..aOS(13, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'location')
    ..aOM<DiskEncryptionConfiguration>(16, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'diskEncryptionConfiguration', subBuilder: DiskEncryptionConfiguration.create)
    ..aOM<DiskEncryptionStatus>(17, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'diskEncryptionStatus', subBuilder: DiskEncryptionStatus.create)
    ..e<SqlBackupKind>(19, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'backupKind', $pb.PbFieldType.OE, defaultOrMaker: SqlBackupKind.SQL_BACKUP_KIND_UNSPECIFIED, valueOf: SqlBackupKind.valueOf, enumValues: SqlBackupKind.values)
    ..hasRequiredFields = false
  ;
  ...
  'Use [GeneratedMessageGenericExtensions.rebuild] instead. '
  'Will be removed in next major version')
  BackupRun copyWith(void Function(BackupRun) updates) => super.copyWith((message) => updates(message as BackupRun)) as BackupRun; // ignore: deprecated_member_use
  $pb.BuilderInfo get info_ => _i;
  @$core.pragma('dart2js:noInline')
  ...
  @$pb.TagNumber(3)
  set enqueuedTime($0.Timestamp v) { setField(3, v); }
  @$pb.TagNumber(3)
  ...
  @$pb.TagNumber(10)
  set windowStartTime($0.Timestamp v) { setField(10, v); }
  @$pb.TagNumber(10)
...
class BackupRunsListResponse extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'BackupRunsListResponse', package: const $pb.PackageName(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'google.cloud.sql.v1beta4'), createEmptyInstance: create)
    ..aOS(1, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'kind')
    ..pc<BackupRun>(2, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'items', $pb.PbFieldType.PM, subBuilder: BackupRun.create)
  ...
  'Use [GeneratedMessageGenericExtensions.rebuild] instead. '
  'Will be removed in next major version')
  BackupRunsListResponse copyWith(void Function(BackupRunsListResponse) updates) => super.copyWith((message) => updates(message as BackupRunsListResponse)) as BackupRunsListResponse; // ignore: deprecated_member_use
  $pb.BuilderInfo get info_ => _i;
  @$core.pragma('dart2js:noInline')
...
class BinLogCoordinates extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'BinLogCoordinates', package: const $pb.PackageName(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'google.cloud.sql.v1beta4'), createEmptyInstance: create)
    ..aOS(1, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'binLogFileName')
    ..aInt64(2, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'binLogPosition')
    ..aOS(3, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'kind')
    ..hasRequiredFields = false
  ;
  ...
  'Use [GeneratedMessageGenericExtensions.rebuild] instead. '
  'Will be removed in next major version')
  BinLogCoordinates copyWith(void Function(BinLogCoordinates) updates) => super.copyWith((message) => updates(message as BinLogCoordinates)) as BinLogCoordinates; // ignore: deprecated_member_use
  $pb.BuilderInfo get info_ => _i;
  @$core.pragma('dart2js:noInline')
...
class BackupContext extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'BackupContext', package: const $pb.PackageName(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'google.cloud.sql.v1beta4'), createEmptyInstance: create)
    ..aInt64(1, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'backupId')
  ...
  'Use [GeneratedMessageGenericExtensions.rebuild] instead. '
  'Will be removed in next major version')
  BackupContext copyWith(void Function(BackupContext) updates) => super.copyWith((message) => updates(message as BackupContext)) as BackupContext; // ignore: deprecated_member_use
  $pb.BuilderInfo get info_ => _i;
  @$core.pragma('dart2js:noInline')
...
class CloneContext extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'CloneContext', package: const $pb.PackageName(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'google.cloud.sql.v1beta4'), createEmptyInstance: create)
    ..aOS(1, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'kind')
    ..aInt64(2, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'pitrTimestampMs')
    ..aOS(3, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'destinationInstanceName')
    ..aOM<BinLogCoordinates>(4, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'binLogCoordinates', subBuilder: BinLogCoordinates.create)
    ..aOM<$0.Timestamp>(5, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'pointInTime', subBuilder: $0.Timestamp.create)
    ..aOS(6, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'allocatedIpRange')
    ..hasRequiredFields = false
  ;
  ...
  'Use [GeneratedMessageGenericExtensions.rebuild] instead. '
  'Will be removed in next major version')
  CloneContext copyWith(void Function(CloneContext) updates) => super.copyWith((message) => updates(message as CloneContext)) as CloneContext; // ignore: deprecated_member_use
  $pb.BuilderInfo get info_ => _i;
  @$core.pragma('dart2js:noInline')
  ...
  @$pb.TagNumber(5)
  set pointInTime($0.Timestamp v) { setField(5, v); }
  @$pb.TagNumber(5)
...
class Database extends $pb.GeneratedMessage {
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'Database', package: const $pb.PackageName(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'google.cloud.sql.v1beta4'), createEmptyInstance: create)
    ..oo(0, [9])
    ..aOS(1, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'kind')
    ..aOS(2, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'charset')
    ..aOS(3, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'collation')
    ..aOS(4, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'etag')
    ..aOS(5, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'name')
    ..aOS(6, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'instance')
    ..aOS(7, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'selfLink')
    ..aOS(8, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'project')
    ..aOM<SqlServerDatabaseDetails>(9, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'sqlserverDatabaseDetails', subBuilder: SqlServerDatabaseDetails.create)
    ..hasRequiredFields = false
  ;
...
class SqlServerDatabaseDetails extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'SqlServerDatabaseDetails', package: const $pb.PackageName(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'google.cloud.sql.v1beta4'), createEmptyInstance: create)
    ..a<$core.int>(1, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'compatibilityLevel', $pb.PbFieldType.O3)
    ..aOS(2, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'recoveryModel')
    ..hasRequiredFields = false
  ;
  ...
  'Use [GeneratedMessageGenericExtensions.rebuild] instead. '
  'Will be removed in next major version')
  SqlServerDatabaseDetails copyWith(void Function(SqlServerDatabaseDetails) updates) => super.copyWith((message) => updates(message as SqlServerDatabaseDetails)) as SqlServerDatabaseDetails; // ignore: deprecated_member_use
  $pb.BuilderInfo get info_ => _i;
  @$core.pragma('dart2js:noInline')
...
class DatabaseFlags extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'DatabaseFlags', package: const $pb.PackageName(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'google.cloud.sql.v1beta4'), createEmptyInstance: create)
  ...
  'Use [GeneratedMessageGenericExtensions.rebuild] instead. '
  'Will be removed in next major version')
  DatabaseFlags copyWith(void Function(DatabaseFlags) updates) => super.copyWith((message) => updates(message as DatabaseFlags)) as DatabaseFlags; // ignore: deprecated_member_use
  $pb.BuilderInfo get info_ => _i;
  @$core.pragma('dart2js:noInline')
...
class SyncFlags extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'SyncFlags', package: const $pb.PackageName(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'google.cloud.sql.v1beta4'), createEmptyInstance: create)
    ..aOS(1, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'name')
    ..aOS(2, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'value')
    ..hasRequiredFields = false
  ;
  ...
  'Use [GeneratedMessageGenericExtensions.rebuild] instead. '
  'Will be removed in next major version')
  SyncFlags copyWith(void Function(SyncFlags) updates) => super.copyWith((message) => updates(message as SyncFlags)) as SyncFlags; // ignore: deprecated_member_use
  $pb.BuilderInfo get info_ => _i;
  @$core.pragma('dart2js:noInline')
...
class InstanceReference extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'InstanceReference', package: const $pb.PackageName(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'google.cloud.sql.v1beta4'), createEmptyInstance: create)
    ..aOS(1, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'name')
  ...
  'Use [GeneratedMessageGenericExtensions.rebuild] instead. '
  'Will be removed in next major version')
  InstanceReference copyWith(void Function(InstanceReference) updates) => super.copyWith((message) => updates(message as InstanceReference)) as InstanceReference; // ignore: deprecated_member_use
  $pb.BuilderInfo get info_ => _i;
  @$core.pragma('dart2js:noInline')
...
class DatabaseInstance_SqlFailoverReplica extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'DatabaseInstance.SqlFailoverReplica', package: const $pb.PackageName(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'google.cloud.sql.v1beta4'), createEmptyInstance: create)
    ..aOS(1, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'name')
    ..aOM<$1.BoolValue>(2, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'available', subBuilder: $1.BoolValue.create)
    ..hasRequiredFields = false
  ;
  ...
  'Use [GeneratedMessageGenericExtensions.rebuild] instead. '
  'Will be removed in next major version')
  DatabaseInstance_SqlFailoverReplica copyWith(void Function(DatabaseInstance_SqlFailoverReplica) updates) => super.copyWith((message) => updates(message as DatabaseInstance_SqlFailoverReplica)) as DatabaseInstance_SqlFailoverReplica; // ignore: deprecated_member_use
  $pb.BuilderInfo get info_ => _i;
  @$core.pragma('dart2js:noInline')
  ...
  @$pb.TagNumber(2)
  set available($1.BoolValue v) { setField(2, v); }
  @$pb.TagNumber(2)
...
class DatabaseInstance_SqlScheduledMaintenance extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'DatabaseInstance.SqlScheduledMaintenance', package: const $pb.PackageName(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'google.cloud.sql.v1beta4'), createEmptyInstance: create)
    ..aOM<$0.Timestamp>(1, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'startTime', subBuilder: $0.Timestamp.create)
    ..aOB(2, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'canDefer')
    ..aOB(3, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'canReschedule')
    ..aOM<$0.Timestamp>(4, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'scheduleDeadlineTime', subBuilder: $0.Timestamp.create)
    ..hasRequiredFields = false
  ;
  ...
  'Use [GeneratedMessageGenericExtensions.rebuild] instead. '
  'Will be removed in next major version')
  DatabaseInstance_SqlScheduledMaintenance copyWith(void Function(DatabaseInstance_SqlScheduledMaintenance) updates) => super.copyWith((message) => updates(message as DatabaseInstance_SqlScheduledMaintenance)) as DatabaseInstance_SqlScheduledMaintenance; // ignore: deprecated_member_use
  $pb.BuilderInfo get info_ => _i;
  @$core.pragma('dart2js:noInline')
  ...
  @$pb.TagNumber(4)
  set scheduleDeadlineTime($0.Timestamp v) { setField(4, v); }
  @$pb.TagNumber(4)
...
class DatabaseInstance_SqlOutOfDiskReport extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'DatabaseInstance.SqlOutOfDiskReport', package: const $pb.PackageName(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'google.cloud.sql.v1beta4'), createEmptyInstance: create)
    ..e<DatabaseInstance_SqlOutOfDiskReport_SqlOutOfDiskState>(1, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'sqlOutOfDiskState', $pb.PbFieldType.OE, defaultOrMaker: DatabaseInstance_SqlOutOfDiskReport_SqlOutOfDiskState.SQL_OUT_OF_DISK_STATE_UNSPECIFIED, valueOf: DatabaseInstance_SqlOutOfDiskReport_SqlOutOfDiskState.valueOf, enumValues: DatabaseInstance_SqlOutOfDiskReport_SqlOutOfDiskState.values)
    ..a<$core.int>(2, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'sqlMinRecommendedIncreaseSizeGb', $pb.PbFieldType.O3)
    ..hasRequiredFields = false
  ;
  ...
  'Use [GeneratedMessageGenericExtensions.rebuild] instead. '
  'Will be removed in next major version')
  DatabaseInstance_SqlOutOfDiskReport copyWith(void Function(DatabaseInstance_SqlOutOfDiskReport) updates) => super.copyWith((message) => updates(message as DatabaseInstance_SqlOutOfDiskReport)) as DatabaseInstance_SqlOutOfDiskReport; // ignore: deprecated_member_use
  $pb.BuilderInfo get info_ => _i;
  @$core.pragma('dart2js:noInline')
...
class DatabaseInstance extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'DatabaseInstance', package: const $pb.PackageName(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'google.cloud.sql.v1beta4'), createEmptyInstance: create)
    ..aOS(1, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'kind')
    ..e<DatabaseInstance_SqlInstanceState>(2, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'state', $pb.PbFieldType.OE, defaultOrMaker: DatabaseInstance_SqlInstanceState.SQL_INSTANCE_STATE_UNSPECIFIED, valueOf: DatabaseInstance_SqlInstanceState.valueOf, enumValues: DatabaseInstance_SqlInstanceState.values)
    ..e<SqlDatabaseVersion>(3, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'databaseVersion', $pb.PbFieldType.OE, defaultOrMaker: SqlDatabaseVersion.SQL_DATABASE_VERSION_UNSPECIFIED, valueOf: SqlDatabaseVersion.valueOf, enumValues: SqlDatabaseVersion.values)
    ..aOM<Settings>(4, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'settings', subBuilder: Settings.create)
    ..aOS(5, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'etag')
    ..aOM<DatabaseInstance_SqlFailoverReplica>(6, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'failoverReplica', subBuilder: DatabaseInstance_SqlFailoverReplica.create)
    ..aOS(7, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'masterInstanceName')
    ..pPS(8, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'replicaNames')
    ..aOM<$1.Int64Value>(9, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'maxDiskSize', subBuilder: $1.Int64Value.create)
    ..aOM<$1.Int64Value>(10, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'currentDiskSize', subBuilder: $1.Int64Value.create)
    ..pc<IpMapping>(11, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'ipAddresses', $pb.PbFieldType.PM, subBuilder: IpMapping.create)
    ..aOM<SslCert>(12, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'serverCaCert', subBuilder: SslCert.create)
    ..e<SqlInstanceType>(13, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'instanceType', $pb.PbFieldType.OE, defaultOrMaker: SqlInstanceType.SQL_INSTANCE_TYPE_UNSPECIFIED, valueOf: SqlInstanceType.valueOf, enumValues: SqlInstanceType.values)
    ..aOS(14, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'project')
    ..aOS(15, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'ipv6Address')
    ..aOS(16, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'serviceAccountEmailAddress')
    ..aOM<OnPremisesConfiguration>(17, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'onPremisesConfiguration', subBuilder: OnPremisesConfiguration.create)
    ..aOM<ReplicaConfiguration>(18, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'replicaConfiguration', subBuilder: ReplicaConfiguration.create)
    ..e<SqlBackendType>(19, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'backendType', $pb.PbFieldType.OE, defaultOrMaker: SqlBackendType.SQL_BACKEND_TYPE_UNSPECIFIED, valueOf: SqlBackendType.valueOf, enumValues: SqlBackendType.values)
    ..aOS(20, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'selfLink')
    ..pc<SqlSuspensionReason>(21, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'suspensionReason', $pb.PbFieldType.PE, valueOf: SqlSuspensionReason.valueOf, enumValues: SqlSuspensionReason.values)
    ..aOS(22, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'connectionName')
    ..aOS(23, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'name')
    ..aOS(24, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'region')
    ..aOS(25, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'gceZone')
    ..aOM<DiskEncryptionConfiguration>(26, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'diskEncryptionConfiguration', subBuilder: DiskEncryptionConfiguration.create)
    ..aOM<DiskEncryptionStatus>(27, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'diskEncryptionStatus', subBuilder: DiskEncryptionStatus.create)
    ..aOS(29, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'rootPassword')
    ..aOM<DatabaseInstance_SqlScheduledMaintenance>(30, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'scheduledMaintenance', subBuilder: DatabaseInstance_SqlScheduledMaintenance.create)
    ..aOS(34, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'secondaryGceZone')
    ..aOM<$1.BoolValue>(35, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'satisfiesPzs', subBuilder: $1.BoolValue.create)
    ..aOM<DatabaseInstance_SqlOutOfDiskReport>(38, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'outOfDiskReport', subBuilder: DatabaseInstance_SqlOutOfDiskReport.create)
    ..aOM<$0.Timestamp>(39, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'createTime', subBuilder: $0.Timestamp.create)
    ..aOS(40, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'databaseInstalledVersion')
    ..pPS(41, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'availableMaintenanceVersions')
    ..aOS(42, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'maintenanceVersion')
    ..hasRequiredFields = false
  ;
  ...
  @$core.Deprecated('This field is deprecated.')
    ...
    if (availableMaintenanceVersions != null) {
      _result.availableMaintenanceVersions.addAll(availableMaintenanceVersions);
    }
    if (maintenanceVersion != null) {
      _result.maintenanceVersion = maintenanceVersion;
    }
    return _result;
  }
  ...
  'Use [GeneratedMessageGenericExtensions.rebuild] instead. '
  'Will be removed in next major version')
  DatabaseInstance copyWith(void Function(DatabaseInstance) updates) => super.copyWith((message) => updates(message as DatabaseInstance)) as DatabaseInstance; // ignore: deprecated_member_use
  $pb.BuilderInfo get info_ => _i;
  @$core.pragma('dart2js:noInline')
  ...
  @$core.Deprecated('This field is deprecated.')
  @$pb.TagNumber(9)
  set maxDiskSize($1.Int64Value v) { setField(9, v); }
  @$core.Deprecated('This field is deprecated.')
  @$pb.TagNumber(9)
  ...
  @$core.Deprecated('This field is deprecated.')
  @$pb.TagNumber(10)
  set currentDiskSize($1.Int64Value v) { setField(10, v); }
  @$core.Deprecated('This field is deprecated.')
  @$pb.TagNumber(10)
  ...
  @$pb.TagNumber(35)
  set satisfiesPzs($1.BoolValue v) { setField(35, v); }
  @$pb.TagNumber(35)
  ...
  @$pb.TagNumber(39)
  set createTime($0.Timestamp v) { setField(39, v); }
  @$pb.TagNumber(39)
...
class DatabasesListResponse extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'DatabasesListResponse', package: const $pb.PackageName(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'google.cloud.sql.v1beta4'), createEmptyInstance: create)
    ..aOS(1, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'kind')
    ..pc<Database>(2, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'items', $pb.PbFieldType.PM, subBuilder: Database.create)
    ..hasRequiredFields = false
  ;
  ...
  'Use [GeneratedMessageGenericExtensions.rebuild] instead. '
  'Will be removed in next major version')
  DatabasesListResponse copyWith(void Function(DatabasesListResponse) updates) => super.copyWith((message) => updates(message as DatabasesListResponse)) as DatabasesListResponse; // ignore: deprecated_member_use
  $pb.BuilderInfo get info_ => _i;
  @$core.pragma('dart2js:noInline')
...
class DemoteMasterConfiguration extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'DemoteMasterConfiguration', package: const $pb.PackageName(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'google.cloud.sql.v1beta4'), createEmptyInstance: create)
    ..aOS(1, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'kind')
    ..aOM<DemoteMasterMySqlReplicaConfiguration>(2, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'mysqlReplicaConfiguration', subBuilder: DemoteMasterMySqlReplicaConfiguration.create)
    ..hasRequiredFields = false
  ;
  ...
  'Use [GeneratedMessageGenericExtensions.rebuild] instead. '
  'Will be removed in next major version')
  DemoteMasterConfiguration copyWith(void Function(DemoteMasterConfiguration) updates) => super.copyWith((message) => updates(message as DemoteMasterConfiguration)) as DemoteMasterConfiguration; // ignore: deprecated_member_use
  $pb.BuilderInfo get info_ => _i;
  @$core.pragma('dart2js:noInline')
...
class DemoteMasterContext extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'DemoteMasterContext', package: const $pb.PackageName(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'google.cloud.sql.v1beta4'), createEmptyInstance: create)
    ..aOS(1, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'kind')
    ..aOM<$1.BoolValue>(2, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'verifyGtidConsistency', subBuilder: $1.BoolValue.create)
    ..aOS(3, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'masterInstanceName')
    ..aOM<DemoteMasterConfiguration>(4, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'replicaConfiguration', subBuilder: DemoteMasterConfiguration.create)
    ..aOB(5, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'skipReplicationSetup')
    ..hasRequiredFields = false
  ;
  ...
  'Use [GeneratedMessageGenericExtensions.rebuild] instead. '
  'Will be removed in next major version')
  DemoteMasterContext copyWith(void Function(DemoteMasterContext) updates) => super.copyWith((message) => updates(message as DemoteMasterContext)) as DemoteMasterContext; // ignore: deprecated_member_use
  $pb.BuilderInfo get info_ => _i;
  @$core.pragma('dart2js:noInline')
  ...
  @$pb.TagNumber(2)
  set verifyGtidConsistency($1.BoolValue v) { setField(2, v); }
  @$pb.TagNumber(2)
...
class DemoteMasterMySqlReplicaConfiguration extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'DemoteMasterMySqlReplicaConfiguration', package: const $pb.PackageName(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'google.cloud.sql.v1beta4'), createEmptyInstance: create)
    ..aOS(1, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'kind')
    ..aOS(2, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'username')
    ..aOS(3, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'password')
    ..aOS(4, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'clientKey')
    ..aOS(5, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'clientCertificate')
    ..aOS(6, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'caCertificate')
    ..hasRequiredFields = false
  ;
  ...
  'Use [GeneratedMessageGenericExtensions.rebuild] instead. '
  'Will be removed in next major version')
  DemoteMasterMySqlReplicaConfiguration copyWith(void Function(DemoteMasterMySqlReplicaConfiguration) updates) => super.copyWith((message) => updates(message as DemoteMasterMySqlReplicaConfiguration)) as DemoteMasterMySqlReplicaConfiguration; // ignore: deprecated_member_use
  $pb.BuilderInfo get info_ => _i;
  @$core.pragma('dart2js:noInline')
...
class ExportContext_SqlCsvExportOptions extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'ExportContext.SqlCsvExportOptions', package: const $pb.PackageName(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'google.cloud.sql.v1beta4'), createEmptyInstance: create)
    ..aOS(1, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'selectQuery')
    ..aOS(2, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'escapeCharacter')
    ..aOS(3, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'quoteCharacter')
    ..aOS(4, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'fieldsTerminatedBy')
    ..aOS(6, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'linesTerminatedBy')
    ..hasRequiredFields = false
  ;
  ...
  'Use [GeneratedMessageGenericExtensions.rebuild] instead. '
  'Will be removed in next major version')
  ExportContext_SqlCsvExportOptions copyWith(void Function(ExportContext_SqlCsvExportOptions) updates) => super.copyWith((message) => updates(message as ExportContext_SqlCsvExportOptions)) as ExportContext_SqlCsvExportOptions; // ignore: deprecated_member_use
  $pb.BuilderInfo get info_ => _i;
  @$core.pragma('dart2js:noInline')
...
class ExportContext_SqlExportOptions_MysqlExportOptions extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'ExportContext.SqlExportOptions.MysqlExportOptions', package: const $pb.PackageName(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'google.cloud.sql.v1beta4'), createEmptyInstance: create)
    ..aOM<$1.Int32Value>(1, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'masterData', subBuilder: $1.Int32Value.create)
    ..hasRequiredFields = false
  ;
  ...
  'Use [GeneratedMessageGenericExtensions.rebuild] instead. '
  'Will be removed in next major version')
  ExportContext_SqlExportOptions_MysqlExportOptions copyWith(void Function(ExportContext_SqlExportOptions_MysqlExportOptions) updates) => super.copyWith((message) => updates(message as ExportContext_SqlExportOptions_MysqlExportOptions)) as ExportContext_SqlExportOptions_MysqlExportOptions; // ignore: deprecated_member_use
  $pb.BuilderInfo get info_ => _i;
  @$core.pragma('dart2js:noInline')
  ...
  @$pb.TagNumber(1)
  set masterData($1.Int32Value v) { setField(1, v); }
  @$pb.TagNumber(1)
...
class ExportContext_SqlExportOptions extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'ExportContext.SqlExportOptions', package: const $pb.PackageName(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'google.cloud.sql.v1beta4'), createEmptyInstance: create)
    ..pPS(1, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'tables')
    ..aOM<$1.BoolValue>(2, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'schemaOnly', subBuilder: $1.BoolValue.create)
    ..aOM<ExportContext_SqlExportOptions_MysqlExportOptions>(3, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'mysqlExportOptions', subBuilder: ExportContext_SqlExportOptions_MysqlExportOptions.create)
    ..hasRequiredFields = false
  ;
  ...
  'Use [GeneratedMessageGenericExtensions.rebuild] instead. '
  'Will be removed in next major version')
  ExportContext_SqlExportOptions copyWith(void Function(ExportContext_SqlExportOptions) updates) => super.copyWith((message) => updates(message as ExportContext_SqlExportOptions)) as ExportContext_SqlExportOptions; // ignore: deprecated_member_use
  $pb.BuilderInfo get info_ => _i;
  @$core.pragma('dart2js:noInline')
  ...
  @$pb.TagNumber(2)
  set schemaOnly($1.BoolValue v) { setField(2, v); }
  @$pb.TagNumber(2)
...
class ExportContext extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'ExportContext', package: const $pb.PackageName(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'google.cloud.sql.v1beta4'), createEmptyInstance: create)
    ..aOS(1, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'uri')
    ..pPS(2, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'databases')
    ..aOS(3, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'kind')
    ..aOM<ExportContext_SqlExportOptions>(4, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'sqlExportOptions', subBuilder: ExportContext_SqlExportOptions.create)
    ..aOM<ExportContext_SqlCsvExportOptions>(5, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'csvExportOptions', subBuilder: ExportContext_SqlCsvExportOptions.create)
    ..e<SqlFileType>(6, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'fileType', $pb.PbFieldType.OE, defaultOrMaker: SqlFileType.SQL_FILE_TYPE_UNSPECIFIED, valueOf: SqlFileType.valueOf, enumValues: SqlFileType.values)
    ..aOM<$1.BoolValue>(8, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'offload', subBuilder: $1.BoolValue.create)
    ..hasRequiredFields = false
  ;
  ...
  'Use [GeneratedMessageGenericExtensions.rebuild] instead. '
  'Will be removed in next major version')
  ExportContext copyWith(void Function(ExportContext) updates) => super.copyWith((message) => updates(message as ExportContext)) as ExportContext; // ignore: deprecated_member_use
  $pb.BuilderInfo get info_ => _i;
  @$core.pragma('dart2js:noInline')
  ...
  @$pb.TagNumber(8)
  set offload($1.BoolValue v) { setField(8, v); }
  @$pb.TagNumber(8)
...
class FailoverContext extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'FailoverContext', package: const $pb.PackageName(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'google.cloud.sql.v1beta4'), createEmptyInstance: create)
    ..aInt64(1, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'settingsVersion')
    ..aOS(2, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'kind')
    ..hasRequiredFields = false
  ;
  ...
  'Use [GeneratedMessageGenericExtensions.rebuild] instead. '
  'Will be removed in next major version')
  FailoverContext copyWith(void Function(FailoverContext) updates) => super.copyWith((message) => updates(message as FailoverContext)) as FailoverContext; // ignore: deprecated_member_use
  $pb.BuilderInfo get info_ => _i;
  @$core.pragma('dart2js:noInline')
...
class Flag extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'Flag', package: const $pb.PackageName(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'google.cloud.sql.v1beta4'), createEmptyInstance: create)
    ..aOS(1, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'name')
    ..e<SqlFlagType>(2, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'type', $pb.PbFieldType.OE, defaultOrMaker: SqlFlagType.SQL_FLAG_TYPE_UNSPECIFIED, valueOf: SqlFlagType.valueOf, enumValues: SqlFlagType.values)
    ..pc<SqlDatabaseVersion>(3, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'appliesTo', $pb.PbFieldType.PE, valueOf: SqlDatabaseVersion.valueOf, enumValues: SqlDatabaseVersion.values)
    ..pPS(4, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'allowedStringValues')
    ..aOM<$1.Int64Value>(5, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'minValue', subBuilder: $1.Int64Value.create)
    ..aOM<$1.Int64Value>(6, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'maxValue', subBuilder: $1.Int64Value.create)
    ..aOM<$1.BoolValue>(7, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'requiresRestart', subBuilder: $1.BoolValue.create)
    ..aOS(8, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'kind')
    ..aOM<$1.BoolValue>(9, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'inBeta', subBuilder: $1.BoolValue.create)
    ..p<$fixnum.Int64>(10, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'allowedIntValues', $pb.PbFieldType.P6)
    ..hasRequiredFields = false
  ;
  ...
  'Use [GeneratedMessageGenericExtensions.rebuild] instead. '
  'Will be removed in next major version')
  Flag copyWith(void Function(Flag) updates) => super.copyWith((message) => updates(message as Flag)) as Flag; // ignore: deprecated_member_use
  $pb.BuilderInfo get info_ => _i;
  @$core.pragma('dart2js:noInline')
  ...
  @$pb.TagNumber(5)
  set minValue($1.Int64Value v) { setField(5, v); }
  @$pb.TagNumber(5)
  ...
  @$pb.TagNumber(6)
  set maxValue($1.Int64Value v) { setField(6, v); }
  @$pb.TagNumber(6)
  ...
  @$pb.TagNumber(7)
  set requiresRestart($1.BoolValue v) { setField(7, v); }
  @$pb.TagNumber(7)
  ...
  @$pb.TagNumber(9)
  set inBeta($1.BoolValue v) { setField(9, v); }
  @$pb.TagNumber(9)
...
class FlagsListResponse extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'FlagsListResponse', package: const $pb.PackageName(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'google.cloud.sql.v1beta4'), createEmptyInstance: create)
    ..aOS(1, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'kind')
    ..pc<Flag>(2, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'items', $pb.PbFieldType.PM, subBuilder: Flag.create)
    ..hasRequiredFields = false
  ;
  ...
  'Use [GeneratedMessageGenericExtensions.rebuild] instead. '
  'Will be removed in next major version')
  FlagsListResponse copyWith(void Function(FlagsListResponse) updates) => super.copyWith((message) => updates(message as FlagsListResponse)) as FlagsListResponse; // ignore: deprecated_member_use
  $pb.BuilderInfo get info_ => _i;
  @$core.pragma('dart2js:noInline')
...
class ImportContext_SqlCsvImportOptions extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'ImportContext.SqlCsvImportOptions', package: const $pb.PackageName(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'google.cloud.sql.v1beta4'), createEmptyInstance: create)
    ..aOS(1, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'table')
    ..pPS(2, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'columns')
    ..aOS(4, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'escapeCharacter')
    ..aOS(5, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'quoteCharacter')
    ..aOS(6, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'fieldsTerminatedBy')
    ..aOS(8, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'linesTerminatedBy')
    ..hasRequiredFields = false
  ;
  ...
  'Use [GeneratedMessageGenericExtensions.rebuild] instead. '
  'Will be removed in next major version')
  ImportContext_SqlCsvImportOptions copyWith(void Function(ImportContext_SqlCsvImportOptions) updates) => super.copyWith((message) => updates(message as ImportContext_SqlCsvImportOptions)) as ImportContext_SqlCsvImportOptions; // ignore: deprecated_member_use
  $pb.BuilderInfo get info_ => _i;
  @$core.pragma('dart2js:noInline')
...
class ImportContext_SqlBakImportOptions_EncryptionOptions extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'ImportContext.SqlBakImportOptions.EncryptionOptions', package: const $pb.PackageName(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'google.cloud.sql.v1beta4'), createEmptyInstance: create)
    ..aOS(1, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'certPath')
    ..aOS(2, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'pvkPath')
    ..aOS(3, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'pvkPassword')
    ..hasRequiredFields = false
  ;
  ...
  'Use [GeneratedMessageGenericExtensions.rebuild] instead. '
  'Will be removed in next major version')
  ImportContext_SqlBakImportOptions_EncryptionOptions copyWith(void Function(ImportContext_SqlBakImportOptions_EncryptionOptions) updates) => super.copyWith((message) => updates(message as ImportContext_SqlBakImportOptions_EncryptionOptions)) as ImportContext_SqlBakImportOptions_EncryptionOptions; // ignore: deprecated_member_use
  $pb.BuilderInfo get info_ => _i;
  @$core.pragma('dart2js:noInline')
...
class ImportContext_SqlBakImportOptions extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'ImportContext.SqlBakImportOptions', package: const $pb.PackageName(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'google.cloud.sql.v1beta4'), createEmptyInstance: create)
    ..aOM<ImportContext_SqlBakImportOptions_EncryptionOptions>(1, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'encryptionOptions', subBuilder: ImportContext_SqlBakImportOptions_EncryptionOptions.create)
    ..hasRequiredFields = false
  ;
  ...
  'Use [GeneratedMessageGenericExtensions.rebuild] instead. '
  'Will be removed in next major version')
  ImportContext_SqlBakImportOptions copyWith(void Function(ImportContext_SqlBakImportOptions) updates) => super.copyWith((message) => updates(message as ImportContext_SqlBakImportOptions)) as ImportContext_SqlBakImportOptions; // ignore: deprecated_member_use
  $pb.BuilderInfo get info_ => _i;
  @$core.pragma('dart2js:noInline')
...
class ImportContext extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'ImportContext', package: const $pb.PackageName(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'google.cloud.sql.v1beta4'), createEmptyInstance: create)
    ..aOS(1, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'uri')
    ..aOS(2, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'database')
    ..aOS(3, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'kind')
    ..e<SqlFileType>(4, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'fileType', $pb.PbFieldType.OE, defaultOrMaker: SqlFileType.SQL_FILE_TYPE_UNSPECIFIED, valueOf: SqlFileType.valueOf, enumValues: SqlFileType.values)
    ..aOM<ImportContext_SqlCsvImportOptions>(5, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'csvImportOptions', subBuilder: ImportContext_SqlCsvImportOptions.create)
    ..aOS(6, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'importUser')
    ..aOM<ImportContext_SqlBakImportOptions>(7, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'bakImportOptions', subBuilder: ImportContext_SqlBakImportOptions.create)
    ..hasRequiredFields = false
  ;
  ...
  'Use [GeneratedMessageGenericExtensions.rebuild] instead. '
  'Will be removed in next major version')
  ImportContext copyWith(void Function(ImportContext) updates) => super.copyWith((message) => updates(message as ImportContext)) as ImportContext; // ignore: deprecated_member_use
  $pb.BuilderInfo get info_ => _i;
  @$core.pragma('dart2js:noInline')
...
class InstancesCloneRequest extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'InstancesCloneRequest', package: const $pb.PackageName(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'google.cloud.sql.v1beta4'), createEmptyInstance: create)
    ..aOM<CloneContext>(1, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'cloneContext', subBuilder: CloneContext.create)
    ..hasRequiredFields = false
  ;
  ...
  'Use [GeneratedMessageGenericExtensions.rebuild] instead. '
  'Will be removed in next major version')
  InstancesCloneRequest copyWith(void Function(InstancesCloneRequest) updates) => super.copyWith((message) => updates(message as InstancesCloneRequest)) as InstancesCloneRequest; // ignore: deprecated_member_use
  $pb.BuilderInfo get info_ => _i;
  @$core.pragma('dart2js:noInline')
...
class InstancesDemoteMasterRequest extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'InstancesDemoteMasterRequest', package: const $pb.PackageName(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'google.cloud.sql.v1beta4'), createEmptyInstance: create)
    ..aOM<DemoteMasterContext>(1, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'demoteMasterContext', subBuilder: DemoteMasterContext.create)
    ..hasRequiredFields = false
  ;
  ...
  'Use [GeneratedMessageGenericExtensions.rebuild] instead. '
  'Will be removed in next major version')
  InstancesDemoteMasterRequest copyWith(void Function(InstancesDemoteMasterRequest) updates) => super.copyWith((message) => updates(message as InstancesDemoteMasterRequest)) as InstancesDemoteMasterRequest; // ignore: deprecated_member_use
  $pb.BuilderInfo get info_ => _i;
  @$core.pragma('dart2js:noInline')
...
class InstancesExportRequest extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'InstancesExportRequest', package: const $pb.PackageName(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'google.cloud.sql.v1beta4'), createEmptyInstance: create)
    ..aOM<ExportContext>(1, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'exportContext', subBuilder: ExportContext.create)
    ..hasRequiredFields = false
  ;
  ...
  'Use [GeneratedMessageGenericExtensions.rebuild] instead. '
  'Will be removed in next major version')
  InstancesExportRequest copyWith(void Function(InstancesExportRequest) updates) => super.copyWith((message) => updates(message as InstancesExportRequest)) as InstancesExportRequest; // ignore: deprecated_member_use
  $pb.BuilderInfo get info_ => _i;
  @$core.pragma('dart2js:noInline')
...
class InstancesFailoverRequest extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'InstancesFailoverRequest', package: const $pb.PackageName(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'google.cloud.sql.v1beta4'), createEmptyInstance: create)
    ..aOM<FailoverContext>(1, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'failoverContext', subBuilder: FailoverContext.create)
    ..hasRequiredFields = false
  ;
  ...
  'Use [GeneratedMessageGenericExtensions.rebuild] instead. '
  'Will be removed in next major version')
  InstancesFailoverRequest copyWith(void Function(InstancesFailoverRequest) updates) => super.copyWith((message) => updates(message as InstancesFailoverRequest)) as InstancesFailoverRequest; // ignore: deprecated_member_use
  $pb.BuilderInfo get info_ => _i;
  @$core.pragma('dart2js:noInline')
...
class InstancesImportRequest extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'InstancesImportRequest', package: const $pb.PackageName(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'google.cloud.sql.v1beta4'), createEmptyInstance: create)
    ..aOM<ImportContext>(1, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'importContext', subBuilder: ImportContext.create)
    ..hasRequiredFields = false
  ;
  ...
  'Use [GeneratedMessageGenericExtensions.rebuild] instead. '
  'Will be removed in next major version')
  InstancesImportRequest copyWith(void Function(InstancesImportRequest) updates) => super.copyWith((message) => updates(message as InstancesImportRequest)) as InstancesImportRequest; // ignore: deprecated_member_use
  $pb.BuilderInfo get info_ => _i;
  @$core.pragma('dart2js:noInline')
...
class MySqlSyncConfig extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'MySqlSyncConfig', package: const $pb.PackageName(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'google.cloud.sql.v1beta4'), createEmptyInstance: create)
    ..pc<SyncFlags>(1, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'initialSyncFlags', $pb.PbFieldType.PM, subBuilder: SyncFlags.create)
    ..hasRequiredFields = false
  ;
  ...
  'Use [GeneratedMessageGenericExtensions.rebuild] instead. '
  'Will be removed in next major version')
  MySqlSyncConfig copyWith(void Function(MySqlSyncConfig) updates) => super.copyWith((message) => updates(message as MySqlSyncConfig)) as MySqlSyncConfig; // ignore: deprecated_member_use
  $pb.BuilderInfo get info_ => _i;
  @$core.pragma('dart2js:noInline')
...
class InstancesListResponse extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'InstancesListResponse', package: const $pb.PackageName(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'google.cloud.sql.v1beta4'), createEmptyInstance: create)
    ..aOS(1, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'kind')
    ..pc<ApiWarning>(2, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'warnings', $pb.PbFieldType.PM, subBuilder: ApiWarning.create)
    ..pc<DatabaseInstance>(3, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'items', $pb.PbFieldType.PM, subBuilder: DatabaseInstance.create)
  ...
  'Use [GeneratedMessageGenericExtensions.rebuild] instead. '
  'Will be removed in next major version')
  InstancesListResponse copyWith(void Function(InstancesListResponse) updates) => super.copyWith((message) => updates(message as InstancesListResponse)) as InstancesListResponse; // ignore: deprecated_member_use
  $pb.BuilderInfo get info_ => _i;
  @$core.pragma('dart2js:noInline')
...
class InstancesListServerCasResponse extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'InstancesListServerCasResponse', package: const $pb.PackageName(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'google.cloud.sql.v1beta4'), createEmptyInstance: create)
    ..pc<SslCert>(1, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'certs', $pb.PbFieldType.PM, subBuilder: SslCert.create)
    ..aOS(2, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'activeVersion')
    ..aOS(3, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'kind')
    ..hasRequiredFields = false
  ;
  ...
  'Use [GeneratedMessageGenericExtensions.rebuild] instead. '
  'Will be removed in next major version')
  InstancesListServerCasResponse copyWith(void Function(InstancesListServerCasResponse) updates) => super.copyWith((message) => updates(message as InstancesListServerCasResponse)) as InstancesListServerCasResponse; // ignore: deprecated_member_use
  $pb.BuilderInfo get info_ => _i;
  @$core.pragma('dart2js:noInline')
...
class InstancesRestoreBackupRequest extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'InstancesRestoreBackupRequest', package: const $pb.PackageName(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'google.cloud.sql.v1beta4'), createEmptyInstance: create)
    ..aOM<RestoreBackupContext>(1, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'restoreBackupContext', subBuilder: RestoreBackupContext.create)
    ..hasRequiredFields = false
  ;
  ...
  'Use [GeneratedMessageGenericExtensions.rebuild] instead. '
  'Will be removed in next major version')
  InstancesRestoreBackupRequest copyWith(void Function(InstancesRestoreBackupRequest) updates) => super.copyWith((message) => updates(message as InstancesRestoreBackupRequest)) as InstancesRestoreBackupRequest; // ignore: deprecated_member_use
  $pb.BuilderInfo get info_ => _i;
  @$core.pragma('dart2js:noInline')
...
class InstancesRotateServerCaRequest extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'InstancesRotateServerCaRequest', package: const $pb.PackageName(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'google.cloud.sql.v1beta4'), createEmptyInstance: create)
    ..aOM<RotateServerCaContext>(1, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'rotateServerCaContext', subBuilder: RotateServerCaContext.create)
    ..hasRequiredFields = false
  ;
  ...
  'Use [GeneratedMessageGenericExtensions.rebuild] instead. '
  'Will be removed in next major version')
  InstancesRotateServerCaRequest copyWith(void Function(InstancesRotateServerCaRequest) updates) => super.copyWith((message) => updates(message as InstancesRotateServerCaRequest)) as InstancesRotateServerCaRequest; // ignore: deprecated_member_use
  $pb.BuilderInfo get info_ => _i;
  @$core.pragma('dart2js:noInline')
...
class InstancesTruncateLogRequest extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'InstancesTruncateLogRequest', package: const $pb.PackageName(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'google.cloud.sql.v1beta4'), createEmptyInstance: create)
    ..aOM<TruncateLogContext>(1, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'truncateLogContext', subBuilder: TruncateLogContext.create)
    ..hasRequiredFields = false
  ;
  ...
  'Use [GeneratedMessageGenericExtensions.rebuild] instead. '
  'Will be removed in next major version')
  InstancesTruncateLogRequest copyWith(void Function(InstancesTruncateLogRequest) updates) => super.copyWith((message) => updates(message as InstancesTruncateLogRequest)) as InstancesTruncateLogRequest; // ignore: deprecated_member_use
  $pb.BuilderInfo get info_ => _i;
  @$core.pragma('dart2js:noInline')
...
class SqlInstancesVerifyExternalSyncSettingsResponse extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'SqlInstancesVerifyExternalSyncSettingsResponse', package: const $pb.PackageName(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'google.cloud.sql.v1beta4'), createEmptyInstance: create)
    ..aOS(1, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'kind')
    ..pc<SqlExternalSyncSettingError>(2, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'errors', $pb.PbFieldType.PM, subBuilder: SqlExternalSyncSettingError.create)
    ..pc<SqlExternalSyncSettingError>(3, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'warnings', $pb.PbFieldType.PM, subBuilder: SqlExternalSyncSettingError.create)
    ..hasRequiredFields = false
  ;
  ...
  'Use [GeneratedMessageGenericExtensions.rebuild] instead. '
  'Will be removed in next major version')
  SqlInstancesVerifyExternalSyncSettingsResponse copyWith(void Function(SqlInstancesVerifyExternalSyncSettingsResponse) updates) => super.copyWith((message) => updates(message as SqlInstancesVerifyExternalSyncSettingsResponse)) as SqlInstancesVerifyExternalSyncSettingsResponse; // ignore: deprecated_member_use
  $pb.BuilderInfo get info_ => _i;
  @$core.pragma('dart2js:noInline')
...
class SqlExternalSyncSettingError extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'SqlExternalSyncSettingError', package: const $pb.PackageName(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'google.cloud.sql.v1beta4'), createEmptyInstance: create)
    ..aOS(1, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'kind')
    ..e<SqlExternalSyncSettingError_SqlExternalSyncSettingErrorType>(2, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'type', $pb.PbFieldType.OE, defaultOrMaker: SqlExternalSyncSettingError_SqlExternalSyncSettingErrorType.SQL_EXTERNAL_SYNC_SETTING_ERROR_TYPE_UNSPECIFIED, valueOf: SqlExternalSyncSettingError_SqlExternalSyncSettingErrorType.valueOf, enumValues: SqlExternalSyncSettingError_SqlExternalSyncSettingErrorType.values)
  ...
  'Use [GeneratedMessageGenericExtensions.rebuild] instead. '
  'Will be removed in next major version')
  SqlExternalSyncSettingError copyWith(void Function(SqlExternalSyncSettingError) updates) => super.copyWith((message) => updates(message as SqlExternalSyncSettingError)) as SqlExternalSyncSettingError; // ignore: deprecated_member_use
  $pb.BuilderInfo get info_ => _i;
  @$core.pragma('dart2js:noInline')
...
class IpConfiguration extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'IpConfiguration', package: const $pb.PackageName(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'google.cloud.sql.v1beta4'), createEmptyInstance: create)
    ..aOM<$1.BoolValue>(1, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'ipv4Enabled', subBuilder: $1.BoolValue.create)
    ..aOS(2, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'privateNetwork')
    ..aOM<$1.BoolValue>(3, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'requireSsl', subBuilder: $1.BoolValue.create)
    ..pc<AclEntry>(4, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'authorizedNetworks', $pb.PbFieldType.PM, subBuilder: AclEntry.create)
    ..aOS(6, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'allocatedIpRange')
    ..hasRequiredFields = false
  ;
  ...
  'Use [GeneratedMessageGenericExtensions.rebuild] instead. '
  'Will be removed in next major version')
  IpConfiguration copyWith(void Function(IpConfiguration) updates) => super.copyWith((message) => updates(message as IpConfiguration)) as IpConfiguration; // ignore: deprecated_member_use
  $pb.BuilderInfo get info_ => _i;
  @$core.pragma('dart2js:noInline')
  ...
  @$pb.TagNumber(1)
  set ipv4Enabled($1.BoolValue v) { setField(1, v); }
  @$pb.TagNumber(1)
  ...
  @$pb.TagNumber(3)
  set requireSsl($1.BoolValue v) { setField(3, v); }
  @$pb.TagNumber(3)
...
class IpMapping extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'IpMapping', package: const $pb.PackageName(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'google.cloud.sql.v1beta4'), createEmptyInstance: create)
    ..e<SqlIpAddressType>(1, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'type', $pb.PbFieldType.OE, defaultOrMaker: SqlIpAddressType.SQL_IP_ADDRESS_TYPE_UNSPECIFIED, valueOf: SqlIpAddressType.valueOf, enumValues: SqlIpAddressType.values)
    ..aOS(2, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'ipAddress')
    ..aOM<$0.Timestamp>(3, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'timeToRetire', subBuilder: $0.Timestamp.create)
    ..hasRequiredFields = false
  ;
  ...
  'Use [GeneratedMessageGenericExtensions.rebuild] instead. '
  'Will be removed in next major version')
  IpMapping copyWith(void Function(IpMapping) updates) => super.copyWith((message) => updates(message as IpMapping)) as IpMapping; // ignore: deprecated_member_use
  $pb.BuilderInfo get info_ => _i;
  @$core.pragma('dart2js:noInline')
  ...
  @$pb.TagNumber(3)
  set timeToRetire($0.Timestamp v) { setField(3, v); }
  @$pb.TagNumber(3)
...
class LocationPreference extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'LocationPreference', package: const $pb.PackageName(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'google.cloud.sql.v1beta4'), createEmptyInstance: create)
    ..aOS(1, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'followGaeApplication')
    ..aOS(2, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'zone')
    ..aOS(3, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'kind')
    ..aOS(4, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'secondaryZone')
    ..hasRequiredFields = false
  ;
  ...
  'Use [GeneratedMessageGenericExtensions.rebuild] instead. '
  'Will be removed in next major version')
  LocationPreference copyWith(void Function(LocationPreference) updates) => super.copyWith((message) => updates(message as LocationPreference)) as LocationPreference; // ignore: deprecated_member_use
  $pb.BuilderInfo get info_ => _i;
  @$core.pragma('dart2js:noInline')
...
class MaintenanceWindow extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'MaintenanceWindow', package: const $pb.PackageName(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'google.cloud.sql.v1beta4'), createEmptyInstance: create)
    ..aOM<$1.Int32Value>(1, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'hour', subBuilder: $1.Int32Value.create)
    ..aOM<$1.Int32Value>(2, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'day', subBuilder: $1.Int32Value.create)
    ..e<SqlUpdateTrack>(3, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'updateTrack', $pb.PbFieldType.OE, defaultOrMaker: SqlUpdateTrack.SQL_UPDATE_TRACK_UNSPECIFIED, valueOf: SqlUpdateTrack.valueOf, enumValues: SqlUpdateTrack.values)
    ..aOS(4, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'kind')
    ..hasRequiredFields = false
  ;
  ...
  @$pb.TagNumber(1)
  set hour($1.Int32Value v) { setField(1, v); }
  @$pb.TagNumber(1)
  ...
  @$pb.TagNumber(2)
  set day($1.Int32Value v) { setField(2, v); }
  @$pb.TagNumber(2)
...
class DenyMaintenancePeriod extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'DenyMaintenancePeriod', package: const $pb.PackageName(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'google.cloud.sql.v1beta4'), createEmptyInstance: create)
  ...
  'Use [GeneratedMessageGenericExtensions.rebuild] instead. '
  'Will be removed in next major version')
  DenyMaintenancePeriod copyWith(void Function(DenyMaintenancePeriod) updates) => super.copyWith((message) => updates(message as DenyMaintenancePeriod)) as DenyMaintenancePeriod; // ignore: deprecated_member_use
  $pb.BuilderInfo get info_ => _i;
  @$core.pragma('dart2js:noInline')
...
class InsightsConfig extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'InsightsConfig', package: const $pb.PackageName(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'google.cloud.sql.v1beta4'), createEmptyInstance: create)
    ..aOB(1, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'queryInsightsEnabled')
    ..aOB(2, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'recordClientAddress')
    ..aOB(3, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'recordApplicationTags')
    ..aOM<$1.Int32Value>(4, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'queryStringLength', subBuilder: $1.Int32Value.create)
    ..aOM<$1.Int32Value>(5, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'queryPlansPerMinute', subBuilder: $1.Int32Value.create)
    ..hasRequiredFields = false
  ;
  ...
  'Use [GeneratedMessageGenericExtensions.rebuild] instead. '
  'Will be removed in next major version')
  InsightsConfig copyWith(void Function(InsightsConfig) updates) => super.copyWith((message) => updates(message as InsightsConfig)) as InsightsConfig; // ignore: deprecated_member_use
  $pb.BuilderInfo get info_ => _i;
  @$core.pragma('dart2js:noInline')
  ...
  @$pb.TagNumber(4)
  set queryStringLength($1.Int32Value v) { setField(4, v); }
  @$pb.TagNumber(4)
  ...
  @$pb.TagNumber(5)
  set queryPlansPerMinute($1.Int32Value v) { setField(5, v); }
  @$pb.TagNumber(5)
...
class MySqlReplicaConfiguration extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'MySqlReplicaConfiguration', package: const $pb.PackageName(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'google.cloud.sql.v1beta4'), createEmptyInstance: create)
    ..aOS(1, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'dumpFilePath')
    ..aOS(2, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'username')
    ..aOS(3, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'password')
    ..aOM<$1.Int32Value>(4, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'connectRetryInterval', subBuilder: $1.Int32Value.create)
    ..aOM<$1.Int64Value>(5, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'masterHeartbeatPeriod', subBuilder: $1.Int64Value.create)
    ..aOS(6, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'caCertificate')
    ..aOS(7, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'clientCertificate')
    ..aOS(8, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'clientKey')
    ..aOS(9, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'sslCipher')
    ..aOM<$1.BoolValue>(10, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'verifyServerCertificate', subBuilder: $1.BoolValue.create)
    ..aOS(11, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'kind')
    ..hasRequiredFields = false
  ;
  ...
  'Use [GeneratedMessageGenericExtensions.rebuild] instead. '
  'Will be removed in next major version')
  MySqlReplicaConfiguration copyWith(void Function(MySqlReplicaConfiguration) updates) => super.copyWith((message) => updates(message as MySqlReplicaConfiguration)) as MySqlReplicaConfiguration; // ignore: deprecated_member_use
  $pb.BuilderInfo get info_ => _i;
  @$core.pragma('dart2js:noInline')
  ...
  @$pb.TagNumber(4)
  set connectRetryInterval($1.Int32Value v) { setField(4, v); }
  @$pb.TagNumber(4)
  ...
  @$pb.TagNumber(5)
  set masterHeartbeatPeriod($1.Int64Value v) { setField(5, v); }
  @$pb.TagNumber(5)
  ...
  @$pb.TagNumber(10)
  set verifyServerCertificate($1.BoolValue v) { setField(10, v); }
  @$pb.TagNumber(10)
...
class OnPremisesConfiguration extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'OnPremisesConfiguration', package: const $pb.PackageName(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'google.cloud.sql.v1beta4'), createEmptyInstance: create)
    ..aOS(1, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'hostPort')
    ..aOS(2, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'kind')
    ...
    ..aOS(6, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'clientCertificate')
    ..aOS(7, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'clientKey')
    ..aOS(8, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'dumpFilePath')
    ..aOM<InstanceReference>(15, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'sourceInstance', subBuilder: InstanceReference.create)
    ..hasRequiredFields = false
  ;
  ...
  'Use [GeneratedMessageGenericExtensions.rebuild] instead. '
  'Will be removed in next major version')
  OnPremisesConfiguration copyWith(void Function(OnPremisesConfiguration) updates) => super.copyWith((message) => updates(message as OnPremisesConfiguration)) as OnPremisesConfiguration; // ignore: deprecated_member_use
  $pb.BuilderInfo get info_ => _i;
  @$core.pragma('dart2js:noInline')
...
class DiskEncryptionConfiguration extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'DiskEncryptionConfiguration', package: const $pb.PackageName(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'google.cloud.sql.v1beta4'), createEmptyInstance: create)
  ...
  'Use [GeneratedMessageGenericExtensions.rebuild] instead. '
  'Will be removed in next major version')
  DiskEncryptionConfiguration copyWith(void Function(DiskEncryptionConfiguration) updates) => super.copyWith((message) => updates(message as DiskEncryptionConfiguration)) as DiskEncryptionConfiguration; // ignore: deprecated_member_use
  $pb.BuilderInfo get info_ => _i;
  @$core.pragma('dart2js:noInline')
...
class DiskEncryptionStatus extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'DiskEncryptionStatus', package: const $pb.PackageName(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'google.cloud.sql.v1beta4'), createEmptyInstance: create)
    ..aOS(1, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'kmsKeyVersionName')
    ..aOS(2, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'kind')
    ..hasRequiredFields = false
  ;
  ...
  'Use [GeneratedMessageGenericExtensions.rebuild] instead. '
  'Will be removed in next major version')
  DiskEncryptionStatus copyWith(void Function(DiskEncryptionStatus) updates) => super.copyWith((message) => updates(message as DiskEncryptionStatus)) as DiskEncryptionStatus; // ignore: deprecated_member_use
  $pb.BuilderInfo get info_ => _i;
  @$core.pragma('dart2js:noInline')
...
class Operation extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'Operation', package: const $pb.PackageName(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'google.cloud.sql.v1beta4'), createEmptyInstance: create)
    ..aOS(1, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'kind')
    ..aOS(2, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'targetLink')
    ..e<Operation_SqlOperationStatus>(3, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'status', $pb.PbFieldType.OE, defaultOrMaker: Operation_SqlOperationStatus.SQL_OPERATION_STATUS_UNSPECIFIED, valueOf: Operation_SqlOperationStatus.valueOf, enumValues: Operation_SqlOperationStatus.values)
    ...
    ..aOM<OperationErrors>(8, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'error', subBuilder: OperationErrors.create)
    ..e<Operation_SqlOperationType>(9, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'operationType', $pb.PbFieldType.OE, defaultOrMaker: Operation_SqlOperationType.SQL_OPERATION_TYPE_UNSPECIFIED, valueOf: Operation_SqlOperationType.valueOf, enumValues: Operation_SqlOperationType.values)
    ..aOM<ImportContext>(10, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'importContext', subBuilder: ImportContext.create)
    ..aOM<ExportContext>(11, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'exportContext', subBuilder: ExportContext.create)
    ...
    ..aOS(14, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'selfLink')
    ..aOS(15, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'targetProject')
    ..aOM<BackupContext>(17, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'backupContext', subBuilder: BackupContext.create)
    ..hasRequiredFields = false
  ;
...
class OperationError extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'OperationError', package: const $pb.PackageName(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'google.cloud.sql.v1beta4'), createEmptyInstance: create)
    ..aOS(1, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'kind')
  ...
  'Use [GeneratedMessageGenericExtensions.rebuild] instead. '
  'Will be removed in next major version')
  OperationError copyWith(void Function(OperationError) updates) => super.copyWith((message) => updates(message as OperationError)) as OperationError; // ignore: deprecated_member_use
  $pb.BuilderInfo get info_ => _i;
  @$core.pragma('dart2js:noInline')
...
class OperationErrors extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'OperationErrors', package: const $pb.PackageName(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'google.cloud.sql.v1beta4'), createEmptyInstance: create)
    ..aOS(1, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'kind')
    ..pc<OperationError>(2, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'errors', $pb.PbFieldType.PM, subBuilder: OperationError.create)
    ..hasRequiredFields = false
  ;
  ...
  'Use [GeneratedMessageGenericExtensions.rebuild] instead. '
  'Will be removed in next major version')
  OperationErrors copyWith(void Function(OperationErrors) updates) => super.copyWith((message) => updates(message as OperationErrors)) as OperationErrors; // ignore: deprecated_member_use
  $pb.BuilderInfo get info_ => _i;
  @$core.pragma('dart2js:noInline')
...
class PasswordValidationPolicy extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'PasswordValidationPolicy', package: const $pb.PackageName(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'google.cloud.sql.v1beta4'), createEmptyInstance: create)
    ..aOM<$1.Int32Value>(1, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'minLength', subBuilder: $1.Int32Value.create)
    ..e<PasswordValidationPolicy_Complexity>(2, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'complexity', $pb.PbFieldType.OE, defaultOrMaker: PasswordValidationPolicy_Complexity.COMPLEXITY_UNSPECIFIED, valueOf: PasswordValidationPolicy_Complexity.valueOf, enumValues: PasswordValidationPolicy_Complexity.values)
    ..aOM<$1.Int32Value>(3, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'reuseInterval', subBuilder: $1.Int32Value.create)
    ..aOM<$1.BoolValue>(4, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'disallowUsernameSubstring', subBuilder: $1.BoolValue.create)
    ..aOM<$2.Duration>(5, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'passwordChangeInterval', subBuilder: $2.Duration.create)
    ..aOM<$1.BoolValue>(6, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'enablePasswordPolicy', subBuilder: $1.BoolValue.create)
    ..hasRequiredFields = false
  ;
  ...
  factory PasswordValidationPolicy({
    ...
    $1.BoolValue? enablePasswordPolicy,
  }) {
    final _result = create();
    if (minLength != null) {
    ...
    if (enablePasswordPolicy != null) {
      _result.enablePasswordPolicy = enablePasswordPolicy;
    }
    return _result;
  }
  ...
  'Use [GeneratedMessageGenericExtensions.rebuild] instead. '
  'Will be removed in next major version')
  PasswordValidationPolicy copyWith(void Function(PasswordValidationPolicy) updates) => super.copyWith((message) => updates(message as PasswordValidationPolicy)) as PasswordValidationPolicy; // ignore: deprecated_member_use
  $pb.BuilderInfo get info_ => _i;
  @$core.pragma('dart2js:noInline')
  ...
  @$pb.TagNumber(1)
  set minLength($1.Int32Value v) { setField(1, v); }
  @$pb.TagNumber(1)
  ...
  @$pb.TagNumber(3)
  set reuseInterval($1.Int32Value v) { setField(3, v); }
  @$pb.TagNumber(3)
  ...
  @$pb.TagNumber(4)
  set disallowUsernameSubstring($1.BoolValue v) { setField(4, v); }
  @$pb.TagNumber(4)
  ...
  @$pb.TagNumber(5)
  set passwordChangeInterval($2.Duration v) { setField(5, v); }
  @$pb.TagNumber(5)
  ...
  @$pb.TagNumber(6)
  $1.BoolValue get enablePasswordPolicy => $_getN(5);
  @$pb.TagNumber(6)
  set enablePasswordPolicy($1.BoolValue v) { setField(6, v); }
  @$pb.TagNumber(6)
  $core.bool hasEnablePasswordPolicy() => $_has(5);
  @$pb.TagNumber(6)
  void clearEnablePasswordPolicy() => clearField(6);
  @$pb.TagNumber(6)
  $1.BoolValue ensureEnablePasswordPolicy() => $_ensure(5);
}

class OperationsListResponse extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'OperationsListResponse', package: const $pb.PackageName(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'google.cloud.sql.v1beta4'), createEmptyInstance: create)
    ..aOS(1, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'kind')
    ..pc<Operation>(2, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'items', $pb.PbFieldType.PM, subBuilder: Operation.create)
    ..aOS(3, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'nextPageToken')
    ..hasRequiredFields = false
  ;
  ...
  'Use [GeneratedMessageGenericExtensions.rebuild] instead. '
  'Will be removed in next major version')
  OperationsListResponse copyWith(void Function(OperationsListResponse) updates) => super.copyWith((message) => updates(message as OperationsListResponse)) as OperationsListResponse; // ignore: deprecated_member_use
  $pb.BuilderInfo get info_ => _i;
  @$core.pragma('dart2js:noInline')
...
class ReplicaConfiguration extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'ReplicaConfiguration', package: const $pb.PackageName(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'google.cloud.sql.v1beta4'), createEmptyInstance: create)
    ..aOS(1, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'kind')
    ..aOM<MySqlReplicaConfiguration>(2, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'mysqlReplicaConfiguration', subBuilder: MySqlReplicaConfiguration.create)
    ..aOM<$1.BoolValue>(3, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'failoverTarget', subBuilder: $1.BoolValue.create)
    ..hasRequiredFields = false
  ;
  ...
  'Use [GeneratedMessageGenericExtensions.rebuild] instead. '
  'Will be removed in next major version')
  ReplicaConfiguration copyWith(void Function(ReplicaConfiguration) updates) => super.copyWith((message) => updates(message as ReplicaConfiguration)) as ReplicaConfiguration; // ignore: deprecated_member_use
  $pb.BuilderInfo get info_ => _i;
  @$core.pragma('dart2js:noInline')
  ...
  @$pb.TagNumber(3)
  set failoverTarget($1.BoolValue v) { setField(3, v); }
  @$pb.TagNumber(3)
...
class RestoreBackupContext extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'RestoreBackupContext', package: const $pb.PackageName(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'google.cloud.sql.v1beta4'), createEmptyInstance: create)
    ..aOS(1, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'kind')
    ..aInt64(2, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'backupRunId')
    ..aOS(3, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'instanceId')
  ...
  'Use [GeneratedMessageGenericExtensions.rebuild] instead. '
  'Will be removed in next major version')
  RestoreBackupContext copyWith(void Function(RestoreBackupContext) updates) => super.copyWith((message) => updates(message as RestoreBackupContext)) as RestoreBackupContext; // ignore: deprecated_member_use
  $pb.BuilderInfo get info_ => _i;
  @$core.pragma('dart2js:noInline')
...
class RotateServerCaContext extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'RotateServerCaContext', package: const $pb.PackageName(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'google.cloud.sql.v1beta4'), createEmptyInstance: create)
    ..aOS(1, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'kind')
    ..aOS(2, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'nextVersion')
    ..hasRequiredFields = false
  ;
  ...
  'Use [GeneratedMessageGenericExtensions.rebuild] instead. '
  'Will be removed in next major version')
  RotateServerCaContext copyWith(void Function(RotateServerCaContext) updates) => super.copyWith((message) => updates(message as RotateServerCaContext)) as RotateServerCaContext; // ignore: deprecated_member_use
  $pb.BuilderInfo get info_ => _i;
  @$core.pragma('dart2js:noInline')
...
class Settings extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'Settings', package: const $pb.PackageName(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'google.cloud.sql.v1beta4'), createEmptyInstance: create)
    ..aOM<$1.Int64Value>(1, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'settingsVersion', subBuilder: $1.Int64Value.create)
    ..pPS(2, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'authorizedGaeApplications')
    ..aOS(3, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'tier')
    ..aOS(4, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'kind')
    ..m<$core.String, $core.String>(5, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'userLabels', entryClassName: 'Settings.UserLabelsEntry', keyFieldType: $pb.PbFieldType.OS, valueFieldType: $pb.PbFieldType.OS, packageName: const $pb.PackageName('google.cloud.sql.v1beta4'))
    ..e<SqlAvailabilityType>(6, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'availabilityType', $pb.PbFieldType.OE, defaultOrMaker: SqlAvailabilityType.SQL_AVAILABILITY_TYPE_UNSPECIFIED, valueOf: SqlAvailabilityType.valueOf, enumValues: SqlAvailabilityType.values)
    ..e<SqlPricingPlan>(7, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'pricingPlan', $pb.PbFieldType.OE, defaultOrMaker: SqlPricingPlan.SQL_PRICING_PLAN_UNSPECIFIED, valueOf: SqlPricingPlan.valueOf, enumValues: SqlPricingPlan.values)
    ..e<SqlReplicationType>(8, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'replicationType', $pb.PbFieldType.OE, defaultOrMaker: SqlReplicationType.SQL_REPLICATION_TYPE_UNSPECIFIED, valueOf: SqlReplicationType.valueOf, enumValues: SqlReplicationType.values)
    ..aOM<$1.Int64Value>(9, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'storageAutoResizeLimit', subBuilder: $1.Int64Value.create)
    ..e<Settings_SqlActivationPolicy>(10, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'activationPolicy', $pb.PbFieldType.OE, defaultOrMaker: Settings_SqlActivationPolicy.SQL_ACTIVATION_POLICY_UNSPECIFIED, valueOf: Settings_SqlActivationPolicy.valueOf, enumValues: Settings_SqlActivationPolicy.values)
    ..aOM<IpConfiguration>(11, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'ipConfiguration', subBuilder: IpConfiguration.create)
    ..aOM<$1.BoolValue>(12, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'storageAutoResize', subBuilder: $1.BoolValue.create)
    ..aOM<LocationPreference>(13, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'locationPreference', subBuilder: LocationPreference.create)
    ..pc<DatabaseFlags>(14, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'databaseFlags', $pb.PbFieldType.PM, subBuilder: DatabaseFlags.create)
    ..e<SqlDataDiskType>(15, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'dataDiskType', $pb.PbFieldType.OE, defaultOrMaker: SqlDataDiskType.SQL_DATA_DISK_TYPE_UNSPECIFIED, valueOf: SqlDataDiskType.valueOf, enumValues: SqlDataDiskType.values)
    ..aOM<MaintenanceWindow>(16, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'maintenanceWindow', subBuilder: MaintenanceWindow.create)
    ..aOM<BackupConfiguration>(17, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'backupConfiguration', subBuilder: BackupConfiguration.create)
    ..aOM<$1.BoolValue>(18, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'databaseReplicationEnabled', subBuilder: $1.BoolValue.create)
    ..aOM<$1.BoolValue>(19, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'crashSafeReplicationEnabled', subBuilder: $1.BoolValue.create)
    ..aOM<$1.Int64Value>(20, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'dataDiskSizeGb', subBuilder: $1.Int64Value.create)
    ..aOM<SqlActiveDirectoryConfig>(22, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'activeDirectoryConfig', subBuilder: SqlActiveDirectoryConfig.create)
    ..aOS(23, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'collation')
    ..pc<DenyMaintenancePeriod>(24, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'denyMaintenancePeriods', $pb.PbFieldType.PM, subBuilder: DenyMaintenancePeriod.create)
    ..aOM<InsightsConfig>(25, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'insightsConfig', subBuilder: InsightsConfig.create)
    ..aOM<PasswordValidationPolicy>(27, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'passwordValidationPolicy', subBuilder: PasswordValidationPolicy.create)
    ..aOM<SqlServerAuditConfig>(29, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'sqlServerAuditConfig', subBuilder: SqlServerAuditConfig.create)
    ..hasRequiredFields = false
  ;
  ...
  @$pb.TagNumber(1)
  set settingsVersion($1.Int64Value v) { setField(1, v); }
  @$pb.TagNumber(1)
  $core.bool hasSettingsVersion() => $_has(0);
  @$pb.TagNumber(1)
  void clearSettingsVersion() => clearField(1);
  ...
  @$pb.TagNumber(9)
  set storageAutoResizeLimit($1.Int64Value v) { setField(9, v); }
  @$pb.TagNumber(9)
  ...
  @$pb.TagNumber(12)
  set storageAutoResize($1.BoolValue v) { setField(12, v); }
  @$pb.TagNumber(12)
  ...
  @$pb.TagNumber(18)
  set databaseReplicationEnabled($1.BoolValue v) { setField(18, v); }
  @$pb.TagNumber(18)
  ...
  @$core.Deprecated('This field is deprecated.')
  @$pb.TagNumber(19)
  set crashSafeReplicationEnabled($1.BoolValue v) { setField(19, v); }
  @$core.Deprecated('This field is deprecated.')
  @$pb.TagNumber(19)
  ...
  @$pb.TagNumber(20)
  set dataDiskSizeGb($1.Int64Value v) { setField(20, v); }
  @$pb.TagNumber(20)
...
class SslCert extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'SslCert', package: const $pb.PackageName(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'google.cloud.sql.v1beta4'), createEmptyInstance: create)
    ..aOS(1, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'kind')
    ..aOS(2, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'certSerialNumber')
    ..aOS(3, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'cert')
    ..aOM<$0.Timestamp>(4, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'createTime', subBuilder: $0.Timestamp.create)
    ..aOS(5, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'commonName')
    ..aOM<$0.Timestamp>(6, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'expirationTime', subBuilder: $0.Timestamp.create)
    ..aOS(7, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'sha1Fingerprint')
    ..aOS(8, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'instance')
    ..aOS(9, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'selfLink')
    ..hasRequiredFields = false
  ;
  ...
  'Use [GeneratedMessageGenericExtensions.rebuild] instead. '
  'Will be removed in next major version')
  SslCert copyWith(void Function(SslCert) updates) => super.copyWith((message) => updates(message as SslCert)) as SslCert; // ignore: deprecated_member_use
  $pb.BuilderInfo get info_ => _i;
  @$core.pragma('dart2js:noInline')
...
class SslCertDetail extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'SslCertDetail', package: const $pb.PackageName(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'google.cloud.sql.v1beta4'), createEmptyInstance: create)
    ..aOM<SslCert>(1, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'certInfo', subBuilder: SslCert.create)
    ..aOS(2, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'certPrivateKey')
    ..hasRequiredFields = false
  ;
  ...
  'Use [GeneratedMessageGenericExtensions.rebuild] instead. '
  'Will be removed in next major version')
  SslCertDetail copyWith(void Function(SslCertDetail) updates) => super.copyWith((message) => updates(message as SslCertDetail)) as SslCertDetail; // ignore: deprecated_member_use
  $pb.BuilderInfo get info_ => _i;
  @$core.pragma('dart2js:noInline')
...
class SslCertsCreateEphemeralRequest extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'SslCertsCreateEphemeralRequest', package: const $pb.PackageName(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'google.cloud.sql.v1beta4'), createEmptyInstance: create)
  ...
  'Use [GeneratedMessageGenericExtensions.rebuild] instead. '
  'Will be removed in next major version')
  SslCertsCreateEphemeralRequest copyWith(void Function(SslCertsCreateEphemeralRequest) updates) => super.copyWith((message) => updates(message as SslCertsCreateEphemeralRequest)) as SslCertsCreateEphemeralRequest; // ignore: deprecated_member_use
  $pb.BuilderInfo get info_ => _i;
  @$core.pragma('dart2js:noInline')
...
class SslCertsInsertRequest extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'SslCertsInsertRequest', package: const $pb.PackageName(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'google.cloud.sql.v1beta4'), createEmptyInstance: create)
    ..aOS(1, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'commonName')
    ..hasRequiredFields = false
  ;
  ...
  'Use [GeneratedMessageGenericExtensions.rebuild] instead. '
  'Will be removed in next major version')
  SslCertsInsertRequest copyWith(void Function(SslCertsInsertRequest) updates) => super.copyWith((message) => updates(message as SslCertsInsertRequest)) as SslCertsInsertRequest; // ignore: deprecated_member_use
  $pb.BuilderInfo get info_ => _i;
  @$core.pragma('dart2js:noInline')
...
class SqlInstancesRescheduleMaintenanceRequestBody_Reschedule extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'SqlInstancesRescheduleMaintenanceRequestBody.Reschedule', package: const $pb.PackageName(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'google.cloud.sql.v1beta4'), createEmptyInstance: create)
    ..e<SqlInstancesRescheduleMaintenanceRequestBody_RescheduleType>(1, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'rescheduleType', $pb.PbFieldType.OE, defaultOrMaker: SqlInstancesRescheduleMaintenanceRequestBody_RescheduleType.RESCHEDULE_TYPE_UNSPECIFIED, valueOf: SqlInstancesRescheduleMaintenanceRequestBody_RescheduleType.valueOf, enumValues: SqlInstancesRescheduleMaintenanceRequestBody_RescheduleType.values)
    ..aOM<$0.Timestamp>(2, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'scheduleTime', subBuilder: $0.Timestamp.create)
    ..hasRequiredFields = false
  ;
  ...
  'Use [GeneratedMessageGenericExtensions.rebuild] instead. '
  'Will be removed in next major version')
  SqlInstancesRescheduleMaintenanceRequestBody_Reschedule copyWith(void Function(SqlInstancesRescheduleMaintenanceRequestBody_Reschedule) updates) => super.copyWith((message) => updates(message as SqlInstancesRescheduleMaintenanceRequestBody_Reschedule)) as SqlInstancesRescheduleMaintenanceRequestBody_Reschedule; // ignore: deprecated_member_use
  $pb.BuilderInfo get info_ => _i;
  @$core.pragma('dart2js:noInline')
  ...
  @$pb.TagNumber(2)
  set scheduleTime($0.Timestamp v) { setField(2, v); }
  @$pb.TagNumber(2)
...
class SqlInstancesRescheduleMaintenanceRequestBody extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'SqlInstancesRescheduleMaintenanceRequestBody', package: const $pb.PackageName(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'google.cloud.sql.v1beta4'), createEmptyInstance: create)
    ..aOM<SqlInstancesRescheduleMaintenanceRequestBody_Reschedule>(3, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'reschedule', subBuilder: SqlInstancesRescheduleMaintenanceRequestBody_Reschedule.create)
    ..hasRequiredFields = false
  ;
  ...
  'Use [GeneratedMessageGenericExtensions.rebuild] instead. '
  'Will be removed in next major version')
  SqlInstancesRescheduleMaintenanceRequestBody copyWith(void Function(SqlInstancesRescheduleMaintenanceRequestBody) updates) => super.copyWith((message) => updates(message as SqlInstancesRescheduleMaintenanceRequestBody)) as SqlInstancesRescheduleMaintenanceRequestBody; // ignore: deprecated_member_use
  $pb.BuilderInfo get info_ => _i;
  @$core.pragma('dart2js:noInline')
...
class SslCertsInsertResponse extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'SslCertsInsertResponse', package: const $pb.PackageName(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'google.cloud.sql.v1beta4'), createEmptyInstance: create)
    ..aOS(1, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'kind')
    ..aOM<Operation>(2, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'operation', subBuilder: Operation.create)
    ..aOM<SslCert>(3, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'serverCaCert', subBuilder: SslCert.create)
    ..aOM<SslCertDetail>(4, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'clientCert', subBuilder: SslCertDetail.create)
    ..hasRequiredFields = false
  ;
  ...
  'Use [GeneratedMessageGenericExtensions.rebuild] instead. '
  'Will be removed in next major version')
  SslCertsInsertResponse copyWith(void Function(SslCertsInsertResponse) updates) => super.copyWith((message) => updates(message as SslCertsInsertResponse)) as SslCertsInsertResponse; // ignore: deprecated_member_use
  $pb.BuilderInfo get info_ => _i;
  @$core.pragma('dart2js:noInline')
...
class SslCertsListResponse extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'SslCertsListResponse', package: const $pb.PackageName(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'google.cloud.sql.v1beta4'), createEmptyInstance: create)
    ..aOS(1, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'kind')
    ..pc<SslCert>(2, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'items', $pb.PbFieldType.PM, subBuilder: SslCert.create)
    ..hasRequiredFields = false
  ;
  ...
  'Use [GeneratedMessageGenericExtensions.rebuild] instead. '
  'Will be removed in next major version')
  SslCertsListResponse copyWith(void Function(SslCertsListResponse) updates) => super.copyWith((message) => updates(message as SslCertsListResponse)) as SslCertsListResponse; // ignore: deprecated_member_use
  $pb.BuilderInfo get info_ => _i;
  @$core.pragma('dart2js:noInline')
...
class TruncateLogContext extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'TruncateLogContext', package: const $pb.PackageName(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'google.cloud.sql.v1beta4'), createEmptyInstance: create)
    ..aOS(1, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'kind')
    ..aOS(2, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'logType')
    ..hasRequiredFields = false
  ;
  ...
  'Use [GeneratedMessageGenericExtensions.rebuild] instead. '
  'Will be removed in next major version')
  TruncateLogContext copyWith(void Function(TruncateLogContext) updates) => super.copyWith((message) => updates(message as TruncateLogContext)) as TruncateLogContext; // ignore: deprecated_member_use
  $pb.BuilderInfo get info_ => _i;
  @$core.pragma('dart2js:noInline')
...
class SqlActiveDirectoryConfig extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'SqlActiveDirectoryConfig', package: const $pb.PackageName(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'google.cloud.sql.v1beta4'), createEmptyInstance: create)
    ..aOS(1, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'kind')
  ...
  'Use [GeneratedMessageGenericExtensions.rebuild] instead. '
  'Will be removed in next major version')
  SqlActiveDirectoryConfig copyWith(void Function(SqlActiveDirectoryConfig) updates) => super.copyWith((message) => updates(message as SqlActiveDirectoryConfig)) as SqlActiveDirectoryConfig; // ignore: deprecated_member_use
  $pb.BuilderInfo get info_ => _i;
  @$core.pragma('dart2js:noInline')
...
class SqlServerAuditConfig extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'SqlServerAuditConfig', package: const $pb.PackageName(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'google.cloud.sql.v1beta4'), createEmptyInstance: create)
    ..aOS(1, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'kind')
    ..aOS(2, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'bucket')
    ..aOM<$2.Duration>(3, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'retentionInterval', subBuilder: $2.Duration.create)
    ..aOM<$2.Duration>(4, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'uploadInterval', subBuilder: $2.Duration.create)
    ..hasRequiredFields = false
  ;
  ...
  factory SqlServerAuditConfig({
    $core.String? kind,
    $core.String? bucket,
    $2.Duration? retentionInterval,
    $2.Duration? uploadInterval,
  }) {
    final _result = create();
    if (kind != null) {
      _result.kind = kind;
    ...
    if (retentionInterval != null) {
      _result.retentionInterval = retentionInterval;
    }
    if (uploadInterval != null) {
      _result.uploadInterval = uploadInterval;
    }
    return _result;
  }
  ...
  'Use [GeneratedMessageGenericExtensions.rebuild] instead. '
  'Will be removed in next major version')
  SqlServerAuditConfig copyWith(void Function(SqlServerAuditConfig) updates) => super.copyWith((message) => updates(message as SqlServerAuditConfig)) as SqlServerAuditConfig; // ignore: deprecated_member_use
  $pb.BuilderInfo get info_ => _i;
  @$core.pragma('dart2js:noInline')
  ...
  @$pb.TagNumber(3)
  $2.Duration get retentionInterval => $_getN(2);
  @$pb.TagNumber(3)
  set retentionInterval($2.Duration v) { setField(3, v); }
  @$pb.TagNumber(3)
  $core.bool hasRetentionInterval() => $_has(2);
  @$pb.TagNumber(3)
  void clearRetentionInterval() => clearField(3);
  @$pb.TagNumber(3)
  $2.Duration ensureRetentionInterval() => $_ensure(2);

  @$pb.TagNumber(4)
  $2.Duration get uploadInterval => $_getN(3);
  @$pb.TagNumber(4)
  set uploadInterval($2.Duration v) { setField(4, v); }
  @$pb.TagNumber(4)
  $core.bool hasUploadInterval() => $_has(3);
  @$pb.TagNumber(4)
  void clearUploadInterval() => clearField(4);
  @$pb.TagNumber(4)
  $2.Duration ensureUploadInterval() => $_ensure(3);
}

...
class SqlBackupRunsDeleteRequest extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'SqlBackupRunsDeleteRequest', package: const $pb.PackageName(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'google.cloud.sql.v1'), createEmptyInstance: create)
...
class SqlBackupRunsGetRequest extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'SqlBackupRunsGetRequest', package: const $pb.PackageName(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'google.cloud.sql.v1'), createEmptyInstance: create)
    ..aInt64(1, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'id')
    ..aOS(2, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'instance')
    ..aOS(3, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'project')
    ..hasRequiredFields = false
...
class SqlBackupRunsInsertRequest extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'SqlBackupRunsInsertRequest', package: const $pb.PackageName(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'google.cloud.sql.v1'), createEmptyInstance: create)
    ...
    ..aOM<BackupRun>(100, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'body', subBuilder: BackupRun.create)
    ..hasRequiredFields = false
  ;
...
class SqlBackupRunsListRequest extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'SqlBackupRunsListRequest', package: const $pb.PackageName(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'google.cloud.sql.v1'), createEmptyInstance: create)
    ..aOS(1, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'instance')
...
class BackupRun extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'BackupRun', package: const $pb.PackageName(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'google.cloud.sql.v1'), createEmptyInstance: create)
    ...
    ..aOM<$2.Timestamp>(3, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'enqueuedTime', subBuilder: $2.Timestamp.create)
    ...
    ..aOM<$1.OperationError>(7, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'error', subBuilder: $1.OperationError.create)
    ...
    ..aOM<$2.Timestamp>(10, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'windowStartTime', subBuilder: $2.Timestamp.create)
    ...
    ..aOM<$1.DiskEncryptionConfiguration>(16, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'diskEncryptionConfiguration', subBuilder: $1.DiskEncryptionConfiguration.create)
    ..aOM<$1.DiskEncryptionStatus>(17, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'diskEncryptionStatus', subBuilder: $1.DiskEncryptionStatus.create)
  ...
  @$pb.TagNumber(3)
  set enqueuedTime($2.Timestamp v) { setField(3, v); }
  @$pb.TagNumber(3)
  ...
  @$pb.TagNumber(7)
  set error($1.OperationError v) { setField(7, v); }
  @$pb.TagNumber(7)
  ...
  @$pb.TagNumber(10)
  set windowStartTime($2.Timestamp v) { setField(10, v); }
  @$pb.TagNumber(10)
  ...
  @$pb.TagNumber(16)
  set diskEncryptionConfiguration($1.DiskEncryptionConfiguration v) { setField(16, v); }
  @$pb.TagNumber(16)
  $core.bool hasDiskEncryptionConfiguration() => $_has(13);
  @$pb.TagNumber(16)
  void clearDiskEncryptionConfiguration() => clearField(16);
  @$pb.TagNumber(16)
  $1.DiskEncryptionConfiguration ensureDiskEncryptionConfiguration() => $_ensure(13);

  @$pb.TagNumber(17)
  $1.DiskEncryptionStatus get diskEncryptionStatus => $_getN(14);
  @$pb.TagNumber(17)
  set diskEncryptionStatus($1.DiskEncryptionStatus v) { setField(17, v); }
  @$pb.TagNumber(17)
...
class BackupRunsListResponse extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'BackupRunsListResponse', package: const $pb.PackageName(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'google.cloud.sql.v1'), createEmptyInstance: create)
    ..aOS(1, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'kind')

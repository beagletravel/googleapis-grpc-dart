...
const TiersListResponse$json = const {
  ...
  '2': const [
    ...
    const {'1': 'items', '3': 2, '4': 3, '5': 11, '6': '.google.cloud.sql.v1.Tier', '10': 'items'},
  ],
};

/// Descriptor for `TiersListResponse`. Decode as a `google.protobuf.DescriptorProto`.
final $typed_data.Uint8List tiersListResponseDescriptor = $convert.base64Decode('ChFUaWVyc0xpc3RSZXNwb25zZRISCgRraW5kGAEgASgJUgRraW5kEi8KBWl0ZW1zGAIgAygLMhkuZ29vZ2xlLmNsb3VkLnNxbC52MS5UaWVyUgVpdGVtcw==');

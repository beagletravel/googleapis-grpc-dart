...
const SqlDatabasesInsertRequest$json = const {
  ...
  '2': const [
    ...
    const {'1': 'body', '3': 100, '4': 1, '5': 11, '6': '.google.cloud.sql.v1.Database', '10': 'body'},
  ],
};

/// Descriptor for `SqlDatabasesInsertRequest`. Decode as a `google.protobuf.DescriptorProto`.
final $typed_data.Uint8List sqlDatabasesInsertRequestDescriptor = $convert.base64Decode('ChlTcWxEYXRhYmFzZXNJbnNlcnRSZXF1ZXN0EhoKCGluc3RhbmNlGAEgASgJUghpbnN0YW5jZRIYCgdwcm9qZWN0GAIgASgJUgdwcm9qZWN0EjEKBGJvZHkYZCABKAsyHS5nb29nbGUuY2xvdWQuc3FsLnYxLkRhdGFiYXNlUgRib2R5');
...
final $typed_data.Uint8List sqlDatabasesUpdateRequestDescriptor = $convert.base64Decode('ChlTcWxEYXRhYmFzZXNVcGRhdGVSZXF1ZXN0EhoKCGRhdGFiYXNlGAEgASgJUghkYXRhYmFzZRIaCghpbnN0YW5jZRgCIAEoCVIIaW5zdGFuY2USGAoHcHJvamVjdBgDIAEoCVIHcHJvamVjdBIxCgRib2R5GGQgASgLMh0uZ29vZ2xlLmNsb3VkLnNxbC52MS5EYXRhYmFzZVIEYm9keQ==');
...
const DatabasesListResponse$json = const {
  ...
  '2': const [
    ...
    const {'1': 'items', '3': 2, '4': 3, '5': 11, '6': '.google.cloud.sql.v1.Database', '10': 'items'},
  ],
};

/// Descriptor for `DatabasesListResponse`. Decode as a `google.protobuf.DescriptorProto`.
final $typed_data.Uint8List databasesListResponseDescriptor = $convert.base64Decode('ChVEYXRhYmFzZXNMaXN0UmVzcG9uc2USEgoEa2luZBgBIAEoCVIEa2luZBIzCgVpdGVtcxgCIAMoCzIdLmdvb2dsZS5jbG91ZC5zcWwudjEuRGF0YWJhc2VSBWl0ZW1z');

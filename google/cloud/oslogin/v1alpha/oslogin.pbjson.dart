...
final $typed_data.Uint8List loginProfileDescriptor = $convert.base64Decode('');
...
final $typed_data.Uint8List deletePosixAccountRequestDescriptor = $convert.base64Decode('ChlEZWxldGVQb3NpeEFjY291bnRSZXF1ZXN0EhIKBG5hbWUYASABKAlSBG5hbWU=');
...
final $typed_data.Uint8List deleteSshPublicKeyRequestDescriptor = $convert.base64Decode('ChlEZWxldGVTc2hQdWJsaWNLZXlSZXF1ZXN0EhIKBG5hbWUYASABKAlSBG5hbWU=');
...
final $typed_data.Uint8List getLoginProfileRequestDescriptor = $convert.base64Decode('ChZHZXRMb2dpblByb2ZpbGVSZXF1ZXN0EhIKBG5hbWUYASABKAlSBG5hbWU=');
...
final $typed_data.Uint8List getSshPublicKeyRequestDescriptor = $convert.base64Decode('ChZHZXRTc2hQdWJsaWNLZXlSZXF1ZXN0EhIKBG5hbWUYASABKAlSBG5hbWU=');
...
final $typed_data.Uint8List importSshPublicKeyRequestDescriptor = $convert.base64Decode('ChlJbXBvcnRTc2hQdWJsaWNLZXlSZXF1ZXN0EhYKBnBhcmVudBgBIAEoCVIGcGFyZW50Ek8KDnNzaF9wdWJsaWNfa2V5GAIgASgLMikuZ29vZ2xlLmNsb3VkLm9zbG9naW4uY29tbW9uLlNzaFB1YmxpY0tleVIMc3NoUHVibGljS2V5Eh0KCnByb2plY3RfaWQYAyABKAlSCXByb2plY3RJZA==');
...
final $typed_data.Uint8List importSshPublicKeyResponseDescriptor = $convert.base64Decode('ChpJbXBvcnRTc2hQdWJsaWNLZXlSZXNwb25zZRJPCg1sb2dpbl9wcm9maWxlGAEgASgLMiouZ29vZ2xlLmNsb3VkLm9zbG9naW4udjFhbHBoYS5Mb2dpblByb2ZpbGVSDGxvZ2luUHJvZmlsZQ==');
...
final $typed_data.Uint8List updateSshPublicKeyRequestDescriptor = $convert.base64Decode('ChlVcGRhdGVTc2hQdWJsaWNLZXlSZXF1ZXN0EhIKBG5hbWUYASABKAlSBG5hbWUSTwoOc3NoX3B1YmxpY19rZXkYAiABKAsyKS5nb29nbGUuY2xvdWQub3Nsb2dpbi5jb21tb24uU3NoUHVibGljS2V5Ugxzc2hQdWJsaWNLZXkSOwoLdXBkYXRlX21hc2sYAyABKAsyGi5nb29nbGUucHJvdG9idWYuRmllbGRNYXNrUgp1cGRhdGVNYXNr');

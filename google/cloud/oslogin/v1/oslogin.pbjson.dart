...
const LoginProfile$json = const {
  ...
  '2': const [
    ...
    const {'1': 'ssh_public_keys', '3': 3, '4': 3, '5': 11, '6': '.google.cloud.oslogin.v1.LoginProfile.SshPublicKeysEntry', '10': 'sshPublicKeys'},
  ],
...
final $typed_data.Uint8List loginProfileDescriptor = $convert.base64Decode('');
...
final $typed_data.Uint8List getLoginProfileRequestDescriptor = $convert.base64Decode('ChZHZXRMb2dpblByb2ZpbGVSZXF1ZXN0Ej8KBG5hbWUYASABKAlCK+BBAvpBJRIjb3Nsb2dpbi5nb29nbGVhcGlzLmNvbS9Qb3NpeEFjY291bnRSBG5hbWUSHQoKcHJvamVjdF9pZBgCIAEoCVIJcHJvamVjdElkEhsKCXN5c3RlbV9pZBgDIAEoCVIIc3lzdGVtSWQ=');
...
final $typed_data.Uint8List importSshPublicKeyRequestDescriptor = $convert.base64Decode('');
...
const ImportSshPublicKeyResponse$json = const {
  ...
  '2': const [
    const {'1': 'login_profile', '3': 1, '4': 1, '5': 11, '6': '.google.cloud.oslogin.v1.LoginProfile', '10': 'loginProfile'},
  ],
};

/// Descriptor for `ImportSshPublicKeyResponse`. Decode as a `google.protobuf.DescriptorProto`.
final $typed_data.Uint8List importSshPublicKeyResponseDescriptor = $convert.base64Decode('ChpJbXBvcnRTc2hQdWJsaWNLZXlSZXNwb25zZRJKCg1sb2dpbl9wcm9maWxlGAEgASgLMiUuZ29vZ2xlLmNsb3VkLm9zbG9naW4udjEuTG9naW5Qcm9maWxlUgxsb2dpblByb2ZpbGU=');

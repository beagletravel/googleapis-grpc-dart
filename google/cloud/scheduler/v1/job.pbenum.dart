...
class Job_State extends $pb.ProtobufEnum {
  ...
  static const Job_State ENABLED = Job_State._(1, const $core.bool.fromEnvironment('protobuf.omit_enum_names') ? '' : 'ENABLED');
  static const Job_State PAUSED = Job_State._(2, const $core.bool.fromEnvironment('protobuf.omit_enum_names') ? '' : 'PAUSED');
  static const Job_State DISABLED = Job_State._(3, const $core.bool.fromEnvironment('protobuf.omit_enum_names') ? '' : 'DISABLED');
  static const Job_State UPDATE_FAILED = Job_State._(4, const $core.bool.fromEnvironment('protobuf.omit_enum_names') ? '' : 'UPDATE_FAILED');

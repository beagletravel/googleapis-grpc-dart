...
class Job extends $pb.GeneratedMessage {
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'Job', package: const $pb.PackageName(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'google.cloud.scheduler.v1beta1'), createEmptyInstance: create)
    ..oo(0, [4, 5, 6])
    ..aOS(1, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'name')
    ..aOS(2, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'description')
    ..aOM<$0.PubsubTarget>(4, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'pubsubTarget', subBuilder: $0.PubsubTarget.create)
    ..aOM<$0.AppEngineHttpTarget>(5, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'appEngineHttpTarget', subBuilder: $0.AppEngineHttpTarget.create)
    ..aOM<$0.HttpTarget>(6, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'httpTarget', subBuilder: $0.HttpTarget.create)
    ..aOM<$1.Timestamp>(9, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'userUpdateTime', subBuilder: $1.Timestamp.create)
    ..e<Job_State>(10, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'state', $pb.PbFieldType.OE, defaultOrMaker: Job_State.STATE_UNSPECIFIED, valueOf: Job_State.valueOf, enumValues: Job_State.values)
    ..aOM<$2.Status>(11, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'status', subBuilder: $2.Status.create)
    ..aOM<$1.Timestamp>(17, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'scheduleTime', subBuilder: $1.Timestamp.create)
    ..aOM<$1.Timestamp>(18, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'lastAttemptTime', subBuilder: $1.Timestamp.create)
    ..aOM<RetryConfig>(19, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'retryConfig', subBuilder: RetryConfig.create)
    ..aOS(20, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'schedule')
    ..aOS(21, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'timeZone')
    ..aOM<$3.Duration>(22, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'attemptDeadline', subBuilder: $3.Duration.create)
...
class RetryConfig extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'RetryConfig', package: const $pb.PackageName(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'google.cloud.scheduler.v1beta1'), createEmptyInstance: create)
    ..a<$core.int>(1, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'retryCount', $pb.PbFieldType.O3)
    ..aOM<$3.Duration>(2, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'maxRetryDuration', subBuilder: $3.Duration.create)
    ..aOM<$3.Duration>(3, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'minBackoffDuration', subBuilder: $3.Duration.create)
    ..aOM<$3.Duration>(4, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'maxBackoffDuration', subBuilder: $3.Duration.create)

...
const Domain$json = const {
  ...
  '2': const [
    ...
    const {'1': 'labels', '3': 2, '4': 3, '5': 11, '6': '.google.cloud.managedidentities.v1beta1.Domain.LabelsEntry', '8': const {}, '10': 'labels'},
    ...
    const {'1': 'state', '3': 13, '4': 1, '5': 14, '6': '.google.cloud.managedidentities.v1beta1.Domain.State', '8': const {}, '10': 'state'},
    const {'1': 'status_message', '3': 14, '4': 1, '5': 9, '8': const {}, '10': 'statusMessage'},
    const {'1': 'trusts', '3': 15, '4': 3, '5': 11, '6': '.google.cloud.managedidentities.v1beta1.Trust', '8': const {}, '10': 'trusts'},
  ],
...
const Trust$json = const {
  ...
  '2': const [
    ...
    const {'1': 'state', '3': 9, '4': 1, '5': 14, '6': '.google.cloud.managedidentities.v1beta1.Trust.State', '8': const {}, '10': 'state'},
...
final $typed_data.Uint8List trustDescriptor = $convert.base64Decode('');

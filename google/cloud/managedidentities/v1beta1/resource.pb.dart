...
class Domain extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'Domain', package: const $pb.PackageName(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'google.cloud.managedidentities.v1beta1'), createEmptyInstance: create)
    ..aOS(1, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'name')
    ..m<$core.String, $core.String>(2, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'labels', entryClassName: 'Domain.LabelsEntry', keyFieldType: $pb.PbFieldType.OS, valueFieldType: $pb.PbFieldType.OS, packageName: const $pb.PackageName('google.cloud.managedidentities.v1beta1'))
    ..pPS(3, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'authorizedNetworks')
    ..aOS(4, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'reservedIpRange')
    ..pPS(5, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'locations')
    ..aOS(6, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'admin')
    ..aOS(10, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'fqdn')
    ...
    ..e<Domain_State>(13, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'state', $pb.PbFieldType.OE, defaultOrMaker: Domain_State.STATE_UNSPECIFIED, valueOf: Domain_State.valueOf, enumValues: Domain_State.values)
    ..aOS(14, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'statusMessage')
    ..pc<Trust>(15, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'trusts', $pb.PbFieldType.PM, subBuilder: Trust.create)
...
class Trust extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'Trust', package: const $pb.PackageName(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'google.cloud.managedidentities.v1beta1'), createEmptyInstance: create)
    ..aOS(1, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'targetDomainName')
    ..e<Trust_TrustType>(2, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'trustType', $pb.PbFieldType.OE, defaultOrMaker: Trust_TrustType.TRUST_TYPE_UNSPECIFIED, valueOf: Trust_TrustType.valueOf, enumValues: Trust_TrustType.values)
    ..e<Trust_TrustDirection>(3, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'trustDirection', $pb.PbFieldType.OE, defaultOrMaker: Trust_TrustDirection.TRUST_DIRECTION_UNSPECIFIED, valueOf: Trust_TrustDirection.valueOf, enumValues: Trust_TrustDirection.values)
    ..aOB(4, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'selectiveAuthentication')
    ..pPS(5, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'targetDnsIpAddresses')
    ..aOS(6, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'trustHandshakeSecret')
    ...
    ..e<Trust_State>(9, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'state', $pb.PbFieldType.OE, defaultOrMaker: Trust_State.STATE_UNSPECIFIED, valueOf: Trust_State.valueOf, enumValues: Trust_State.values)
    ..aOS(11, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'stateDescription')
    ..aOM<$0.Timestamp>(12, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'lastTrustHeartbeatTime', subBuilder: $0.Timestamp.create)
    ..hasRequiredFields = false
  ;
  ...
  @$pb.TagNumber(12)
  set lastTrustHeartbeatTime($0.Timestamp v) { setField(12, v); }
  @$pb.TagNumber(12)

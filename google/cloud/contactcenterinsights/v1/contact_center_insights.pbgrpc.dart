...
class ContactCenterInsightsClient extends $grpc.Client {
  ...
  $grpc.ResponseFuture<$3.View> createView($2.CreateViewRequest request,
      {$grpc.CallOptions? options}) {
    return $createUnaryCall(_$createView, request, options: options);
  }

  $grpc.ResponseFuture<$3.View> getView($2.GetViewRequest request,
      {$grpc.CallOptions? options}) {
  ...
  $grpc.ResponseFuture<$3.View> updateView($2.UpdateViewRequest request,
      {$grpc.CallOptions? options}) {
...
abstract class ContactCenterInsightsServiceBase extends $grpc.Service {
  ...
  ContactCenterInsightsServiceBase() {
    ...
    $addMethod($grpc.ServiceMethod<$2.UpdateSettingsRequest, $3.Settings>(
        ...
        ($3.Settings value) => value.writeToBuffer()));
    $addMethod($grpc.ServiceMethod<$2.CreateViewRequest, $3.View>(
        'CreateView',
        createView_Pre,
        false,
        false,
        ($core.List<$core.int> value) => $2.CreateViewRequest.fromBuffer(value),
        ($3.View value) => value.writeToBuffer()));
    $addMethod($grpc.ServiceMethod<$2.GetViewRequest, $3.View>(
        'GetView',
        getView_Pre,
        false,
        false,
    ...
    $addMethod($grpc.ServiceMethod<$2.UpdateViewRequest, $3.View>(
        'UpdateView',
        updateView_Pre,
        false,
        false,
  ...
  $async.Future<$3.View> createView_Pre($grpc.ServiceCall call,
      $async.Future<$2.CreateViewRequest> request) async {
    return createView(call, await request);
  }

  $async.Future<$3.View> getView_Pre(
  ...
  $async.Future<$3.View> updateView_Pre($grpc.ServiceCall call,
  ...
  $async.Future<$3.View> createView(
      $grpc.ServiceCall call, $2.CreateViewRequest request);
  $async.Future<$3.View> getView(
  ...
  $async.Future<$3.View> updateView(

...
class NamespaceView extends $pb.ProtobufEnum {
  static const NamespaceView NAMESPACE_VIEW_UNSPECIFIED = NamespaceView._(0, const $core.bool.fromEnvironment('protobuf.omit_enum_names') ? '' : 'NAMESPACE_VIEW_UNSPECIFIED');
  static const NamespaceView NAMESPACE_VIEW_BASIC = NamespaceView._(1, const $core.bool.fromEnvironment('protobuf.omit_enum_names') ? '' : 'NAMESPACE_VIEW_BASIC');
  static const NamespaceView NAMESPACE_VIEW_FULL = NamespaceView._(2, const $core.bool.fromEnvironment('protobuf.omit_enum_names') ? '' : 'NAMESPACE_VIEW_FULL');

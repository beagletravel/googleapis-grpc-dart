...
class ScanRun extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'ScanRun', package: const $pb.PackageName(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'google.cloud.websecurityscanner.v1beta'), createEmptyInstance: create)
    ..aOS(1, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'name')
    ..e<ScanRun_ExecutionState>(2, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'executionState', $pb.PbFieldType.OE, defaultOrMaker: ScanRun_ExecutionState.EXECUTION_STATE_UNSPECIFIED, valueOf: ScanRun_ExecutionState.valueOf, enumValues: ScanRun_ExecutionState.values)
    ..e<ScanRun_ResultState>(3, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'resultState', $pb.PbFieldType.OE, defaultOrMaker: ScanRun_ResultState.RESULT_STATE_UNSPECIFIED, valueOf: ScanRun_ResultState.valueOf, enumValues: ScanRun_ResultState.values)
    ...
    ..aInt64(6, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'urlsCrawledCount')
    ..aInt64(7, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'urlsTestedCount')
    ..aOB(8, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'hasVulnerabilities')
    ..a<$core.int>(9, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'progressPercent', $pb.PbFieldType.O3)
    ..aOM<$1.ScanRunErrorTrace>(10, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'errorTrace', subBuilder: $1.ScanRunErrorTrace.create)
    ..pc<$2.ScanRunWarningTrace>(11, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'warningTraces', $pb.PbFieldType.PM, subBuilder: $2.ScanRunWarningTrace.create)
  ...
  factory ScanRun({
    ...
    $1.ScanRunErrorTrace? errorTrace,
    $core.Iterable<$2.ScanRunWarningTrace>? warningTraces,
  }) {
    ...
    if (errorTrace != null) {
      _result.errorTrace = errorTrace;
    }
    if (warningTraces != null) {
      _result.warningTraces.addAll(warningTraces);
    }
    return _result;
  }
  ...
  'Will be removed in next major version')
  ScanRun copyWith(void Function(ScanRun) updates) => super.copyWith((message) => updates(message as ScanRun)) as ScanRun; // ignore: deprecated_member_use
  ...
  @$pb.TagNumber(10)
  set errorTrace($1.ScanRunErrorTrace v) { setField(10, v); }
  @$pb.TagNumber(10)

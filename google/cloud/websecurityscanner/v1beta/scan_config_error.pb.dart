...
class ScanConfigError extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'ScanConfigError', package: const $pb.PackageName(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'google.cloud.websecurityscanner.v1beta'), createEmptyInstance: create)
    ..e<ScanConfigError_Code>(1, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'code', $pb.PbFieldType.OE, defaultOrMaker: ScanConfigError_Code.CODE_UNSPECIFIED, valueOf: ScanConfigError_Code.valueOf, enumValues: ScanConfigError_Code.values)
  ...
  'Will be removed in next major version')
  ScanConfigError copyWith(void Function(ScanConfigError) updates) => super.copyWith((message) => updates(message as ScanConfigError)) as ScanConfigError; // ignore: deprecated_member_use

...
class ScanRunErrorTrace extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'ScanRunErrorTrace', package: const $pb.PackageName(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'google.cloud.websecurityscanner.v1beta'), createEmptyInstance: create)
    ..e<ScanRunErrorTrace_Code>(1, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'code', $pb.PbFieldType.OE, defaultOrMaker: ScanRunErrorTrace_Code.CODE_UNSPECIFIED, valueOf: ScanRunErrorTrace_Code.valueOf, enumValues: ScanRunErrorTrace_Code.values)
    ..aOM<$0.ScanConfigError>(2, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'scanConfigError', subBuilder: $0.ScanConfigError.create)
    ..a<$core.int>(3, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'mostCommonHttpErrorCode', $pb.PbFieldType.O3)
  ...
  'Will be removed in next major version')
  ScanRunErrorTrace copyWith(void Function(ScanRunErrorTrace) updates) => super.copyWith((message) => updates(message as ScanRunErrorTrace)) as ScanRunErrorTrace; // ignore: deprecated_member_use
  ...
  @$pb.TagNumber(2)
  set scanConfigError($0.ScanConfigError v) { setField(2, v); }
  @$pb.TagNumber(2)

...
class Finding extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'Finding', package: const $pb.PackageName(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'google.cloud.websecurityscanner.v1alpha'), createEmptyInstance: create)
    ..aOS(1, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'name')
    ..e<Finding_FindingType>(2, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'findingType', $pb.PbFieldType.OE, defaultOrMaker: Finding_FindingType.FINDING_TYPE_UNSPECIFIED, valueOf: Finding_FindingType.valueOf, enumValues: Finding_FindingType.values)
  ...
  factory Finding({
    $core.String? name,
    Finding_FindingType? findingType,

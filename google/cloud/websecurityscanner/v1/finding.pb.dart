...
class Finding extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'Finding', package: const $pb.PackageName(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'google.cloud.websecurityscanner.v1'), createEmptyInstance: create)
    ..aOS(1, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'name')
    ..aOS(2, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'findingType')
    ..aOS(3, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'httpMethod')
    ..aOS(4, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'fuzzedUrl')
    ...
    ..aOS(7, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'reproductionUrl')
    ..aOS(8, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'frameUrl')
    ..aOS(9, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'finalUrl')
    ..aOS(10, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'trackingId')
    ..aOM<$0.OutdatedLibrary>(11, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'outdatedLibrary', subBuilder: $0.OutdatedLibrary.create)
    ..aOM<$0.ViolatingResource>(12, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'violatingResource', subBuilder: $0.ViolatingResource.create)
    ..aOM<$0.VulnerableParameters>(13, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'vulnerableParameters', subBuilder: $0.VulnerableParameters.create)
    ..aOM<$0.Xss>(14, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'xss', subBuilder: $0.Xss.create)
    ..aOM<$0.VulnerableHeaders>(15, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'vulnerableHeaders', subBuilder: $0.VulnerableHeaders.create)
    ..aOM<$0.Form>(16, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'form', subBuilder: $0.Form.create)
    ..e<Finding_Severity>(17, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'severity', $pb.PbFieldType.OE, defaultOrMaker: Finding_Severity.SEVERITY_UNSPECIFIED, valueOf: Finding_Severity.valueOf, enumValues: Finding_Severity.values)
  ...
  @$pb.TagNumber(15)
  set vulnerableHeaders($0.VulnerableHeaders v) { setField(15, v); }
  @$pb.TagNumber(15)
  ...
  @$pb.TagNumber(16)
  set form($0.Form v) { setField(16, v); }
  @$pb.TagNumber(16)

...
class FinalizeMfaEnrollmentRequest extends $pb.GeneratedMessage {
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'FinalizeMfaEnrollmentRequest', package: const $pb.PackageName(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'google.cloud.identitytoolkit.v2'), createEmptyInstance: create)
    ..oo(0, [4])
    ...
    ..aOM<$1.FinalizeMfaPhoneRequestInfo>(4, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'phoneVerificationInfo', subBuilder: $1.FinalizeMfaPhoneRequestInfo.create)
    ..aOS(5, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'tenantId')
  ...
  'Will be removed in next major version')
  FinalizeMfaEnrollmentRequest copyWith(void Function(FinalizeMfaEnrollmentRequest) updates) => super.copyWith((message) => updates(message as FinalizeMfaEnrollmentRequest)) as FinalizeMfaEnrollmentRequest; // ignore: deprecated_member_use
  ...
  @$pb.TagNumber(4)
  set phoneVerificationInfo($1.FinalizeMfaPhoneRequestInfo v) { setField(4, v); }
  @$pb.TagNumber(4)
...
class FinalizeMfaEnrollmentResponse extends $pb.GeneratedMessage {
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'FinalizeMfaEnrollmentResponse', package: const $pb.PackageName(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'google.cloud.identitytoolkit.v2'), createEmptyInstance: create)
    ..oo(0, [3])
    ..aOS(1, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'idToken')
    ..aOS(2, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'refreshToken')
    ..aOM<$1.FinalizeMfaPhoneResponseInfo>(3, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'phoneAuthInfo', subBuilder: $1.FinalizeMfaPhoneResponseInfo.create)
    ..hasRequiredFields = false
  ;
  ...
  'Use [GeneratedMessageGenericExtensions.rebuild] instead. '
  'Will be removed in next major version')
  FinalizeMfaEnrollmentResponse copyWith(void Function(FinalizeMfaEnrollmentResponse) updates) => super.copyWith((message) => updates(message as FinalizeMfaEnrollmentResponse)) as FinalizeMfaEnrollmentResponse; // ignore: deprecated_member_use
  $pb.BuilderInfo get info_ => _i;
  @$core.pragma('dart2js:noInline')
  ...
  @$pb.TagNumber(3)
  set phoneAuthInfo($1.FinalizeMfaPhoneResponseInfo v) { setField(3, v); }
  @$pb.TagNumber(3)
...
class StartMfaEnrollmentRequest extends $pb.GeneratedMessage {
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'StartMfaEnrollmentRequest', package: const $pb.PackageName(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'google.cloud.identitytoolkit.v2'), createEmptyInstance: create)
    ..oo(0, [3])
    ..aOS(1, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'idToken')
    ..aOM<$1.StartMfaPhoneRequestInfo>(3, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'phoneEnrollmentInfo', subBuilder: $1.StartMfaPhoneRequestInfo.create)
    ..aOS(4, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'tenantId')
    ..hasRequiredFields = false
  ;
  ...
  'Use [GeneratedMessageGenericExtensions.rebuild] instead. '
  'Will be removed in next major version')
  StartMfaEnrollmentRequest copyWith(void Function(StartMfaEnrollmentRequest) updates) => super.copyWith((message) => updates(message as StartMfaEnrollmentRequest)) as StartMfaEnrollmentRequest; // ignore: deprecated_member_use
  $pb.BuilderInfo get info_ => _i;
  @$core.pragma('dart2js:noInline')
  ...
  @$pb.TagNumber(3)
  set phoneEnrollmentInfo($1.StartMfaPhoneRequestInfo v) { setField(3, v); }
  @$pb.TagNumber(3)
...
class StartMfaEnrollmentResponse extends $pb.GeneratedMessage {
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'StartMfaEnrollmentResponse', package: const $pb.PackageName(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'google.cloud.identitytoolkit.v2'), createEmptyInstance: create)
    ..oo(0, [1])
    ..aOM<$1.StartMfaPhoneResponseInfo>(1, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'phoneSessionInfo', subBuilder: $1.StartMfaPhoneResponseInfo.create)
    ..hasRequiredFields = false
  ;
  ...
  'Use [GeneratedMessageGenericExtensions.rebuild] instead. '
  'Will be removed in next major version')
  StartMfaEnrollmentResponse copyWith(void Function(StartMfaEnrollmentResponse) updates) => super.copyWith((message) => updates(message as StartMfaEnrollmentResponse)) as StartMfaEnrollmentResponse; // ignore: deprecated_member_use
  $pb.BuilderInfo get info_ => _i;
  @$core.pragma('dart2js:noInline')
  ...
  @$pb.TagNumber(1)
  set phoneSessionInfo($1.StartMfaPhoneResponseInfo v) { setField(1, v); }
  @$pb.TagNumber(1)
...
class WithdrawMfaRequest extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'WithdrawMfaRequest', package: const $pb.PackageName(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'google.cloud.identitytoolkit.v2'), createEmptyInstance: create)
    ..aOS(1, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'idToken')
    ..aOS(2, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'mfaEnrollmentId')
    ..aOS(3, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'tenantId')
    ..hasRequiredFields = false
  ;
  ...
  'Use [GeneratedMessageGenericExtensions.rebuild] instead. '
  'Will be removed in next major version')
  WithdrawMfaRequest copyWith(void Function(WithdrawMfaRequest) updates) => super.copyWith((message) => updates(message as WithdrawMfaRequest)) as WithdrawMfaRequest; // ignore: deprecated_member_use
  $pb.BuilderInfo get info_ => _i;
  @$core.pragma('dart2js:noInline')
...
class WithdrawMfaResponse extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'WithdrawMfaResponse', package: const $pb.PackageName(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'google.cloud.identitytoolkit.v2'), createEmptyInstance: create)
    ..aOS(1, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'idToken')
    ..aOS(2, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'refreshToken')
    ..hasRequiredFields = false
  ;
  ...
  'Use [GeneratedMessageGenericExtensions.rebuild] instead. '
  'Will be removed in next major version')
  WithdrawMfaResponse copyWith(void Function(WithdrawMfaResponse) updates) => super.copyWith((message) => updates(message as WithdrawMfaResponse)) as WithdrawMfaResponse; // ignore: deprecated_member_use
  $pb.BuilderInfo get info_ => _i;
  @$core.pragma('dart2js:noInline')

...
class AutoRetrievalInfo extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'AutoRetrievalInfo', package: const $pb.PackageName(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'google.cloud.identitytoolkit.v2'), createEmptyInstance: create)
    ..aOS(1, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'appSignatureHash')
  ...
  'Will be removed in next major version')
  AutoRetrievalInfo copyWith(void Function(AutoRetrievalInfo) updates) => super.copyWith((message) => updates(message as AutoRetrievalInfo)) as AutoRetrievalInfo; // ignore: deprecated_member_use
...
class StartMfaPhoneRequestInfo extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'StartMfaPhoneRequestInfo', package: const $pb.PackageName(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'google.cloud.identitytoolkit.v2'), createEmptyInstance: create)
    ..aOS(1, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'phoneNumber')
    ..aOS(2, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'iosReceipt')
    ..aOS(3, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'iosSecret')
    ..aOS(4, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'recaptchaToken')
    ..aOM<AutoRetrievalInfo>(5, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'autoRetrievalInfo', subBuilder: AutoRetrievalInfo.create)
    ..aOS(6, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'safetyNetToken')
    ..hasRequiredFields = false
  ;
  ...
  'Use [GeneratedMessageGenericExtensions.rebuild] instead. '
  'Will be removed in next major version')
  StartMfaPhoneRequestInfo copyWith(void Function(StartMfaPhoneRequestInfo) updates) => super.copyWith((message) => updates(message as StartMfaPhoneRequestInfo)) as StartMfaPhoneRequestInfo; // ignore: deprecated_member_use
  $pb.BuilderInfo get info_ => _i;
  @$core.pragma('dart2js:noInline')
...
class StartMfaPhoneResponseInfo extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'StartMfaPhoneResponseInfo', package: const $pb.PackageName(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'google.cloud.identitytoolkit.v2'), createEmptyInstance: create)
    ..aOS(1, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'sessionInfo')
    ..hasRequiredFields = false
  ;
  ...
  'Use [GeneratedMessageGenericExtensions.rebuild] instead. '
  'Will be removed in next major version')
  StartMfaPhoneResponseInfo copyWith(void Function(StartMfaPhoneResponseInfo) updates) => super.copyWith((message) => updates(message as StartMfaPhoneResponseInfo)) as StartMfaPhoneResponseInfo; // ignore: deprecated_member_use
  $pb.BuilderInfo get info_ => _i;
  @$core.pragma('dart2js:noInline')
...
class FinalizeMfaPhoneRequestInfo extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'FinalizeMfaPhoneRequestInfo', package: const $pb.PackageName(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'google.cloud.identitytoolkit.v2'), createEmptyInstance: create)
    ..aOS(1, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'sessionInfo')
    ..aOS(2, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'code')
    ..aOS(3, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'androidVerificationProof')
  ...
  'Use [GeneratedMessageGenericExtensions.rebuild] instead. '
  'Will be removed in next major version')
  FinalizeMfaPhoneRequestInfo copyWith(void Function(FinalizeMfaPhoneRequestInfo) updates) => super.copyWith((message) => updates(message as FinalizeMfaPhoneRequestInfo)) as FinalizeMfaPhoneRequestInfo; // ignore: deprecated_member_use
  $pb.BuilderInfo get info_ => _i;
  @$core.pragma('dart2js:noInline')
...
class FinalizeMfaPhoneResponseInfo extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'FinalizeMfaPhoneResponseInfo', package: const $pb.PackageName(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'google.cloud.identitytoolkit.v2'), createEmptyInstance: create)
    ..aOS(1, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'androidVerificationProof')
    ..aOM<$0.Timestamp>(2, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'androidVerificationProofExpireTime', subBuilder: $0.Timestamp.create)
  ...
  factory FinalizeMfaPhoneResponseInfo({
    ...
    if (androidVerificationProofExpireTime != null) {
      _result.androidVerificationProofExpireTime = androidVerificationProofExpireTime;
    }
    if (phoneNumber != null) {
      _result.phoneNumber = phoneNumber;
    }
  ...
  'Use [GeneratedMessageGenericExtensions.rebuild] instead. '
  'Will be removed in next major version')
  FinalizeMfaPhoneResponseInfo copyWith(void Function(FinalizeMfaPhoneResponseInfo) updates) => super.copyWith((message) => updates(message as FinalizeMfaPhoneResponseInfo)) as FinalizeMfaPhoneResponseInfo; // ignore: deprecated_member_use
  $pb.BuilderInfo get info_ => _i;
  @$core.pragma('dart2js:noInline')
  ...
  @$pb.TagNumber(2)
  set androidVerificationProofExpireTime($0.Timestamp v) { setField(2, v); }
  @$pb.TagNumber(2)

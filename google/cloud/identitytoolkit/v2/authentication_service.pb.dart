...
class FinalizeMfaSignInRequest extends $pb.GeneratedMessage {
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'FinalizeMfaSignInRequest', package: const $pb.PackageName(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'google.cloud.identitytoolkit.v2'), createEmptyInstance: create)
    ..oo(0, [3])
    ..aOS(2, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'mfaPendingCredential')
    ..aOM<$1.FinalizeMfaPhoneRequestInfo>(3, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'phoneVerificationInfo', subBuilder: $1.FinalizeMfaPhoneRequestInfo.create)
  ...
  'Will be removed in next major version')
  FinalizeMfaSignInRequest copyWith(void Function(FinalizeMfaSignInRequest) updates) => super.copyWith((message) => updates(message as FinalizeMfaSignInRequest)) as FinalizeMfaSignInRequest; // ignore: deprecated_member_use
  ...
  @$pb.TagNumber(3)
  set phoneVerificationInfo($1.FinalizeMfaPhoneRequestInfo v) { setField(3, v); }
  @$pb.TagNumber(3)
...
class FinalizeMfaSignInResponse extends $pb.GeneratedMessage {
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'FinalizeMfaSignInResponse', package: const $pb.PackageName(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'google.cloud.identitytoolkit.v2'), createEmptyInstance: create)
    ..oo(0, [3])
  ...
  'Use [GeneratedMessageGenericExtensions.rebuild] instead. '
  'Will be removed in next major version')
  FinalizeMfaSignInResponse copyWith(void Function(FinalizeMfaSignInResponse) updates) => super.copyWith((message) => updates(message as FinalizeMfaSignInResponse)) as FinalizeMfaSignInResponse; // ignore: deprecated_member_use
  $pb.BuilderInfo get info_ => _i;
  @$core.pragma('dart2js:noInline')
...
class StartMfaSignInRequest extends $pb.GeneratedMessage {
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'StartMfaSignInRequest', package: const $pb.PackageName(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'google.cloud.identitytoolkit.v2'), createEmptyInstance: create)
    ..oo(0, [4])
    ..aOS(2, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'mfaPendingCredential')
    ..aOS(3, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'mfaEnrollmentId')
    ..aOM<$1.StartMfaPhoneRequestInfo>(4, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'phoneSignInInfo', subBuilder: $1.StartMfaPhoneRequestInfo.create)
  ...
  'Use [GeneratedMessageGenericExtensions.rebuild] instead. '
  'Will be removed in next major version')
  StartMfaSignInRequest copyWith(void Function(StartMfaSignInRequest) updates) => super.copyWith((message) => updates(message as StartMfaSignInRequest)) as StartMfaSignInRequest; // ignore: deprecated_member_use
  $pb.BuilderInfo get info_ => _i;
  @$core.pragma('dart2js:noInline')
  ...
  @$pb.TagNumber(4)
  set phoneSignInInfo($1.StartMfaPhoneRequestInfo v) { setField(4, v); }
  @$pb.TagNumber(4)
...
class StartMfaSignInResponse extends $pb.GeneratedMessage {
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'StartMfaSignInResponse', package: const $pb.PackageName(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'google.cloud.identitytoolkit.v2'), createEmptyInstance: create)
    ..oo(0, [1])
    ..aOM<$1.StartMfaPhoneResponseInfo>(1, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'phoneResponseInfo', subBuilder: $1.StartMfaPhoneResponseInfo.create)
    ..hasRequiredFields = false
  ;
  ...
  'Use [GeneratedMessageGenericExtensions.rebuild] instead. '
  'Will be removed in next major version')
  StartMfaSignInResponse copyWith(void Function(StartMfaSignInResponse) updates) => super.copyWith((message) => updates(message as StartMfaSignInResponse)) as StartMfaSignInResponse; // ignore: deprecated_member_use
  $pb.BuilderInfo get info_ => _i;
  @$core.pragma('dart2js:noInline')
  ...
  @$pb.TagNumber(1)
  set phoneResponseInfo($1.StartMfaPhoneResponseInfo v) { setField(1, v); }
  @$pb.TagNumber(1)

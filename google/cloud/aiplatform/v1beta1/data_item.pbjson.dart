...
const DataItem$json = const {
  ...
  '2': const [
    ...
    const {'1': 'labels', '3': 3, '4': 3, '5': 11, '6': '.google.cloud.aiplatform.v1beta1.DataItem.LabelsEntry', '8': const {}, '10': 'labels'},
    const {'1': 'payload', '3': 4, '4': 1, '5': 11, '6': '.google.protobuf.Value', '8': const {}, '10': 'payload'},
...
final $typed_data.Uint8List dataItemDescriptor = $convert.base64Decode('');

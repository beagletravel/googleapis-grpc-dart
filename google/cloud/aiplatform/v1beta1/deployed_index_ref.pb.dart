...
class DeployedIndexRef extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'DeployedIndexRef', package: const $pb.PackageName(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'google.cloud.aiplatform.v1beta1'), createEmptyInstance: create)
  ...
  'Will be removed in next major version')
  DeployedIndexRef copyWith(void Function(DeployedIndexRef) updates) => super.copyWith((message) => updates(message as DeployedIndexRef)) as DeployedIndexRef; // ignore: deprecated_member_use

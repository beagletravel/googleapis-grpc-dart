...
class IndexEndpoint extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'IndexEndpoint', package: const $pb.PackageName(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'google.cloud.aiplatform.v1beta1'), createEmptyInstance: create)
    ..aOS(1, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'name')
    ..aOS(2, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'displayName')
    ..aOS(3, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'description')
    ..pc<DeployedIndex>(4, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'deployedIndexes', $pb.PbFieldType.PM, subBuilder: DeployedIndex.create)
    ..aOS(5, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'etag')
    ..m<$core.String, $core.String>(6, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'labels', entryClassName: 'IndexEndpoint.LabelsEntry', keyFieldType: $pb.PbFieldType.OS, valueFieldType: $pb.PbFieldType.OS, packageName: const $pb.PackageName('google.cloud.aiplatform.v1beta1'))
    ...
    ..aOB(10, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'enablePrivateServiceConnect')
  ...
  'Will be removed in next major version')
  IndexEndpoint copyWith(void Function(IndexEndpoint) updates) => super.copyWith((message) => updates(message as IndexEndpoint)) as IndexEndpoint; // ignore: deprecated_member_use
...
class DeployedIndex extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'DeployedIndex', package: const $pb.PackageName(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'google.cloud.aiplatform.v1beta1'), createEmptyInstance: create)
    ...
    ..aOM<IndexPrivateEndpoints>(5, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'privateEndpoints', subBuilder: IndexPrivateEndpoints.create)
    ..aOM<$0.Timestamp>(6, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'indexSyncTime', subBuilder: $0.Timestamp.create)
    ..aOM<$1.AutomaticResources>(7, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'automaticResources', subBuilder: $1.AutomaticResources.create)
    ..aOB(8, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'enableAccessLogging')
    ..aOM<DeployedIndexAuthConfig>(9, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'deployedIndexAuthConfig', subBuilder: DeployedIndexAuthConfig.create)
    ..pPS(10, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'reservedIpRanges')
    ..aOS(11, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'deploymentGroup')
    ..aOM<$1.DedicatedResources>(16, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'dedicatedResources', subBuilder: $1.DedicatedResources.create)
    ..hasRequiredFields = false
  ;
  ...
  'Use [GeneratedMessageGenericExtensions.rebuild] instead. '
  'Will be removed in next major version')
  DeployedIndex copyWith(void Function(DeployedIndex) updates) => super.copyWith((message) => updates(message as DeployedIndex)) as DeployedIndex; // ignore: deprecated_member_use
  $pb.BuilderInfo get info_ => _i;
  @$core.pragma('dart2js:noInline')
  ...
  @$pb.TagNumber(6)
  set indexSyncTime($0.Timestamp v) { setField(6, v); }
  @$pb.TagNumber(6)
  ...
  @$pb.TagNumber(7)
  set automaticResources($1.AutomaticResources v) { setField(7, v); }
  @$pb.TagNumber(7)
  ...
  @$pb.TagNumber(16)
  $1.DedicatedResources get dedicatedResources => $_getN(11);
  @$pb.TagNumber(16)
  set dedicatedResources($1.DedicatedResources v) { setField(16, v); }
  @$pb.TagNumber(16)
  $core.bool hasDedicatedResources() => $_has(11);
  @$pb.TagNumber(16)
  void clearDedicatedResources() => clearField(16);
  @$pb.TagNumber(16)
  $1.DedicatedResources ensureDedicatedResources() => $_ensure(11);
}

class DeployedIndexAuthConfig_AuthProvider extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'DeployedIndexAuthConfig.AuthProvider', package: const $pb.PackageName(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'google.cloud.aiplatform.v1beta1'), createEmptyInstance: create)
    ..pPS(1, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'audiences')
    ..pPS(2, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'allowedIssuers')
    ..hasRequiredFields = false
  ;
  ...
  'Use [GeneratedMessageGenericExtensions.rebuild] instead. '
  'Will be removed in next major version')
  DeployedIndexAuthConfig_AuthProvider copyWith(void Function(DeployedIndexAuthConfig_AuthProvider) updates) => super.copyWith((message) => updates(message as DeployedIndexAuthConfig_AuthProvider)) as DeployedIndexAuthConfig_AuthProvider; // ignore: deprecated_member_use
  $pb.BuilderInfo get info_ => _i;
  @$core.pragma('dart2js:noInline')
...
class DeployedIndexAuthConfig extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'DeployedIndexAuthConfig', package: const $pb.PackageName(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'google.cloud.aiplatform.v1beta1'), createEmptyInstance: create)
    ..aOM<DeployedIndexAuthConfig_AuthProvider>(1, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'authProvider', subBuilder: DeployedIndexAuthConfig_AuthProvider.create)
    ..hasRequiredFields = false
  ;
  ...
  'Use [GeneratedMessageGenericExtensions.rebuild] instead. '
  'Will be removed in next major version')
  DeployedIndexAuthConfig copyWith(void Function(DeployedIndexAuthConfig) updates) => super.copyWith((message) => updates(message as DeployedIndexAuthConfig)) as DeployedIndexAuthConfig; // ignore: deprecated_member_use
  $pb.BuilderInfo get info_ => _i;
  @$core.pragma('dart2js:noInline')
...
class IndexPrivateEndpoints extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'IndexPrivateEndpoints', package: const $pb.PackageName(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'google.cloud.aiplatform.v1beta1'), createEmptyInstance: create)
    ..aOS(1, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'matchGrpcAddress')
    ..aOS(2, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'serviceAttachment')
    ..hasRequiredFields = false
  ;
  ...
  'Use [GeneratedMessageGenericExtensions.rebuild] instead. '
  'Will be removed in next major version')
  IndexPrivateEndpoints copyWith(void Function(IndexPrivateEndpoints) updates) => super.copyWith((message) => updates(message as IndexPrivateEndpoints)) as IndexPrivateEndpoints; // ignore: deprecated_member_use
  $pb.BuilderInfo get info_ => _i;
  @$core.pragma('dart2js:noInline')

...
class TrainingPipeline extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'TrainingPipeline', package: const $pb.PackageName(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'google.cloud.aiplatform.v1beta1'), createEmptyInstance: create)
    ..aOS(1, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'name')
    ..aOS(2, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'displayName')
    ..aOM<InputDataConfig>(3, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'inputDataConfig', subBuilder: InputDataConfig.create)
    ..aOS(4, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'trainingTaskDefinition')
    ..aOM<$0.Value>(5, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'trainingTaskInputs', subBuilder: $0.Value.create)
    ..aOM<$0.Value>(6, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'trainingTaskMetadata', subBuilder: $0.Value.create)
    ..aOM<$1.Model>(7, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'modelToUpload', subBuilder: $1.Model.create)
    ..e<$6.PipelineState>(9, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'state', $pb.PbFieldType.OE, defaultOrMaker: $6.PipelineState.PIPELINE_STATE_UNSPECIFIED, valueOf: $6.PipelineState.valueOf, enumValues: $6.PipelineState.values)
    ...
    ..aOM<$3.Timestamp>(12, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'startTime', subBuilder: $3.Timestamp.create)
    ..aOM<$3.Timestamp>(13, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'endTime', subBuilder: $3.Timestamp.create)
    ..aOM<$3.Timestamp>(14, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'updateTime', subBuilder: $3.Timestamp.create)
    ..m<$core.String, $core.String>(15, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'labels', entryClassName: 'TrainingPipeline.LabelsEntry', keyFieldType: $pb.PbFieldType.OS, valueFieldType: $pb.PbFieldType.OS, packageName: const $pb.PackageName('google.cloud.aiplatform.v1beta1'))
    ..aOM<$4.EncryptionSpec>(18, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'encryptionSpec', subBuilder: $4.EncryptionSpec.create)
    ..aOS(21, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'parentModel')
    ..aOS(22, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'modelId')
  ...
  'Will be removed in next major version')
  TrainingPipeline copyWith(void Function(TrainingPipeline) updates) => super.copyWith((message) => updates(message as TrainingPipeline)) as TrainingPipeline; // ignore: deprecated_member_use
  ...
  @$pb.TagNumber(5)
  set trainingTaskInputs($0.Value v) { setField(5, v); }
  @$pb.TagNumber(5)
  ...
  @$pb.TagNumber(6)
  set trainingTaskMetadata($0.Value v) { setField(6, v); }
  @$pb.TagNumber(6)
  ...
  @$pb.TagNumber(7)
  set modelToUpload($1.Model v) { setField(7, v); }
  @$pb.TagNumber(7)
  ...
  @$pb.TagNumber(9)
  set state($6.PipelineState v) { setField(9, v); }
  @$pb.TagNumber(9)
  ...
  @$pb.TagNumber(12)
  set startTime($3.Timestamp v) { setField(12, v); }
  @$pb.TagNumber(12)
  ...
  @$pb.TagNumber(13)
  set endTime($3.Timestamp v) { setField(13, v); }
  @$pb.TagNumber(13)
  ...
  @$pb.TagNumber(18)
  set encryptionSpec($4.EncryptionSpec v) { setField(18, v); }
  @$pb.TagNumber(18)
...
class InputDataConfig extends $pb.GeneratedMessage {
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'InputDataConfig', package: const $pb.PackageName(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'google.cloud.aiplatform.v1beta1'), createEmptyInstance: create)
    ..oo(0, [2, 3, 4, 5, 12])
    ..oo(1, [8, 10])
    ..aOS(1, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'datasetId')
    ..aOM<FractionSplit>(2, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'fractionSplit', subBuilder: FractionSplit.create)
    ..aOM<FilterSplit>(3, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'filterSplit', subBuilder: FilterSplit.create)
    ..aOM<PredefinedSplit>(4, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'predefinedSplit', subBuilder: PredefinedSplit.create)
    ..aOM<TimestampSplit>(5, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'timestampSplit', subBuilder: TimestampSplit.create)
    ..aOS(6, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'annotationsFilter')
    ..aOM<$5.GcsDestination>(8, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'gcsDestination', subBuilder: $5.GcsDestination.create)
    ..aOS(9, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'annotationSchemaUri')
    ..aOM<$5.BigQueryDestination>(10, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'bigqueryDestination', subBuilder: $5.BigQueryDestination.create)
    ..aOM<StratifiedSplit>(12, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'stratifiedSplit', subBuilder: StratifiedSplit.create)
    ..hasRequiredFields = false
  ;
  ...
  'Use [GeneratedMessageGenericExtensions.rebuild] instead. '
  'Will be removed in next major version')
  InputDataConfig copyWith(void Function(InputDataConfig) updates) => super.copyWith((message) => updates(message as InputDataConfig)) as InputDataConfig; // ignore: deprecated_member_use
  $pb.BuilderInfo get info_ => _i;
  @$core.pragma('dart2js:noInline')
  ...
  @$pb.TagNumber(8)
  set gcsDestination($5.GcsDestination v) { setField(8, v); }
  @$pb.TagNumber(8)
  ...
  @$pb.TagNumber(9)
  set annotationSchemaUri($core.String v) { $_setString(7, v); }
  @$pb.TagNumber(9)
  ...
  @$pb.TagNumber(10)
  set bigqueryDestination($5.BigQueryDestination v) { setField(10, v); }
  @$pb.TagNumber(10)
...
class FractionSplit extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'FractionSplit', package: const $pb.PackageName(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'google.cloud.aiplatform.v1beta1'), createEmptyInstance: create)
    ..a<$core.double>(1, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'trainingFraction', $pb.PbFieldType.OD)
    ..a<$core.double>(2, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'validationFraction', $pb.PbFieldType.OD)
    ..a<$core.double>(3, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'testFraction', $pb.PbFieldType.OD)
    ..hasRequiredFields = false
  ;
  ...
  'Use [GeneratedMessageGenericExtensions.rebuild] instead. '
  'Will be removed in next major version')
  FractionSplit copyWith(void Function(FractionSplit) updates) => super.copyWith((message) => updates(message as FractionSplit)) as FractionSplit; // ignore: deprecated_member_use
  $pb.BuilderInfo get info_ => _i;
  @$core.pragma('dart2js:noInline')
...
class FilterSplit extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'FilterSplit', package: const $pb.PackageName(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'google.cloud.aiplatform.v1beta1'), createEmptyInstance: create)
    ..aOS(1, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'trainingFilter')
    ..aOS(2, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'validationFilter')
    ..aOS(3, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'testFilter')
    ..hasRequiredFields = false
  ;
  ...
  'Use [GeneratedMessageGenericExtensions.rebuild] instead. '
  'Will be removed in next major version')
  FilterSplit copyWith(void Function(FilterSplit) updates) => super.copyWith((message) => updates(message as FilterSplit)) as FilterSplit; // ignore: deprecated_member_use
  $pb.BuilderInfo get info_ => _i;
  @$core.pragma('dart2js:noInline')
...
class PredefinedSplit extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'PredefinedSplit', package: const $pb.PackageName(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'google.cloud.aiplatform.v1beta1'), createEmptyInstance: create)
  ...
  'Use [GeneratedMessageGenericExtensions.rebuild] instead. '
  'Will be removed in next major version')
  PredefinedSplit copyWith(void Function(PredefinedSplit) updates) => super.copyWith((message) => updates(message as PredefinedSplit)) as PredefinedSplit; // ignore: deprecated_member_use
  $pb.BuilderInfo get info_ => _i;
  @$core.pragma('dart2js:noInline')
...
class TimestampSplit extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'TimestampSplit', package: const $pb.PackageName(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'google.cloud.aiplatform.v1beta1'), createEmptyInstance: create)
    ..a<$core.double>(1, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'trainingFraction', $pb.PbFieldType.OD)
    ..a<$core.double>(2, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'validationFraction', $pb.PbFieldType.OD)
    ..a<$core.double>(3, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'testFraction', $pb.PbFieldType.OD)
  ...
  'Use [GeneratedMessageGenericExtensions.rebuild] instead. '
  'Will be removed in next major version')
  TimestampSplit copyWith(void Function(TimestampSplit) updates) => super.copyWith((message) => updates(message as TimestampSplit)) as TimestampSplit; // ignore: deprecated_member_use
  $pb.BuilderInfo get info_ => _i;
  @$core.pragma('dart2js:noInline')
...
class StratifiedSplit extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'StratifiedSplit', package: const $pb.PackageName(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'google.cloud.aiplatform.v1beta1'), createEmptyInstance: create)
    ..a<$core.double>(1, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'trainingFraction', $pb.PbFieldType.OD)
    ..a<$core.double>(2, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'validationFraction', $pb.PbFieldType.OD)
    ..a<$core.double>(3, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'testFraction', $pb.PbFieldType.OD)
    ..aOS(4, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'key')
  ...
  'Use [GeneratedMessageGenericExtensions.rebuild] instead. '
  'Will be removed in next major version')
  StratifiedSplit copyWith(void Function(StratifiedSplit) updates) => super.copyWith((message) => updates(message as StratifiedSplit)) as StratifiedSplit; // ignore: deprecated_member_use
  $pb.BuilderInfo get info_ => _i;
  @$core.pragma('dart2js:noInline')

...
class UnmanagedContainerModel extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'UnmanagedContainerModel', package: const $pb.PackageName(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'google.cloud.aiplatform.v1beta1'), createEmptyInstance: create)
    ..aOS(1, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'artifactUri')
    ..aOM<$0.PredictSchemata>(2, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'predictSchemata', subBuilder: $0.PredictSchemata.create)
    ..aOM<$0.ModelContainerSpec>(3, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'containerSpec', subBuilder: $0.ModelContainerSpec.create)
  ...
  'Will be removed in next major version')
  UnmanagedContainerModel copyWith(void Function(UnmanagedContainerModel) updates) => super.copyWith((message) => updates(message as UnmanagedContainerModel)) as UnmanagedContainerModel; // ignore: deprecated_member_use
  ...
  @$pb.TagNumber(2)
  set predictSchemata($0.PredictSchemata v) { setField(2, v); }
  @$pb.TagNumber(2)
  ...
  @$pb.TagNumber(3)
  set containerSpec($0.ModelContainerSpec v) { setField(3, v); }
  @$pb.TagNumber(3)

...
class ManualBatchTuningParameters extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'ManualBatchTuningParameters', package: const $pb.PackageName(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'google.cloud.aiplatform.v1beta1'), createEmptyInstance: create)
    ..a<$core.int>(1, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'batchSize', $pb.PbFieldType.O3)
  ...
  'Will be removed in next major version')
  ManualBatchTuningParameters copyWith(void Function(ManualBatchTuningParameters) updates) => super.copyWith((message) => updates(message as ManualBatchTuningParameters)) as ManualBatchTuningParameters; // ignore: deprecated_member_use

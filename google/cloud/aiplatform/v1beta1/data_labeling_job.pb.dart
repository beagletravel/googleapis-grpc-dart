...
class DataLabelingJob extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'DataLabelingJob', package: const $pb.PackageName(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'google.cloud.aiplatform.v1beta1'), createEmptyInstance: create)
    ..aOS(1, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'name')
    ..aOS(2, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'displayName')
    ..pPS(3, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'datasets')
    ..a<$core.int>(4, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'labelerCount', $pb.PbFieldType.O3)
    ..aOS(5, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'instructionUri')
    ..aOS(6, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'inputsSchemaUri')
    ..aOM<$0.Value>(7, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'inputs', subBuilder: $0.Value.create)
    ..e<$5.JobState>(8, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'state', $pb.PbFieldType.OE, defaultOrMaker: $5.JobState.JOB_STATE_UNSPECIFIED, valueOf: $5.JobState.valueOf, enumValues: $5.JobState.values)
    ...
    ..m<$core.String, $core.String>(11, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'labels', entryClassName: 'DataLabelingJob.LabelsEntry', keyFieldType: $pb.PbFieldType.OS, valueFieldType: $pb.PbFieldType.OS, packageName: const $pb.PackageName('google.cloud.aiplatform.v1beta1'))
    ..m<$core.String, $core.String>(12, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'annotationLabels', entryClassName: 'DataLabelingJob.AnnotationLabelsEntry', keyFieldType: $pb.PbFieldType.OS, valueFieldType: $pb.PbFieldType.OS, packageName: const $pb.PackageName('google.cloud.aiplatform.v1beta1'))
    ..a<$core.int>(13, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'labelingProgress', $pb.PbFieldType.O3)
    ..aOM<$2.Money>(14, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'currentSpend', subBuilder: $2.Money.create)
    ..pPS(16, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'specialistPools')
    ..aOM<$3.EncryptionSpec>(20, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'encryptionSpec', subBuilder: $3.EncryptionSpec.create)
    ..aOM<ActiveLearningConfig>(21, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'activeLearningConfig', subBuilder: ActiveLearningConfig.create)
    ..aOM<$4.Status>(22, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'error', subBuilder: $4.Status.create)
  ...
  'Will be removed in next major version')
  DataLabelingJob copyWith(void Function(DataLabelingJob) updates) => super.copyWith((message) => updates(message as DataLabelingJob)) as DataLabelingJob; // ignore: deprecated_member_use
  ...
  @$pb.TagNumber(7)
  set inputs($0.Value v) { setField(7, v); }
  @$pb.TagNumber(7)
  ...
  @$pb.TagNumber(8)
  set state($5.JobState v) { setField(8, v); }
  @$pb.TagNumber(8)
  ...
  @$pb.TagNumber(14)
  set currentSpend($2.Money v) { setField(14, v); }
  @$pb.TagNumber(14)
  ...
  @$pb.TagNumber(20)
  set encryptionSpec($3.EncryptionSpec v) { setField(20, v); }
  @$pb.TagNumber(20)
  ...
  @$pb.TagNumber(22)
  set error($4.Status v) { setField(22, v); }
  @$pb.TagNumber(22)
...
class ActiveLearningConfig extends $pb.GeneratedMessage {
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'ActiveLearningConfig', package: const $pb.PackageName(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'google.cloud.aiplatform.v1beta1'), createEmptyInstance: create)
    ..oo(0, [1, 2])
    ..aInt64(1, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'maxDataItemCount')
    ..a<$core.int>(2, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'maxDataItemPercentage', $pb.PbFieldType.O3)
    ..aOM<SampleConfig>(3, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'sampleConfig', subBuilder: SampleConfig.create)
    ..aOM<TrainingConfig>(4, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'trainingConfig', subBuilder: TrainingConfig.create)
    ..hasRequiredFields = false
  ;
  ...
  'Use [GeneratedMessageGenericExtensions.rebuild] instead. '
  'Will be removed in next major version')
  ActiveLearningConfig copyWith(void Function(ActiveLearningConfig) updates) => super.copyWith((message) => updates(message as ActiveLearningConfig)) as ActiveLearningConfig; // ignore: deprecated_member_use
  $pb.BuilderInfo get info_ => _i;
  @$core.pragma('dart2js:noInline')
...
class SampleConfig extends $pb.GeneratedMessage {
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'SampleConfig', package: const $pb.PackageName(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'google.cloud.aiplatform.v1beta1'), createEmptyInstance: create)
    ..oo(0, [1])
    ..oo(1, [3])
    ..a<$core.int>(1, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'initialBatchSamplePercentage', $pb.PbFieldType.O3)
    ..a<$core.int>(3, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'followingBatchSamplePercentage', $pb.PbFieldType.O3)
    ..e<SampleConfig_SampleStrategy>(5, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'sampleStrategy', $pb.PbFieldType.OE, defaultOrMaker: SampleConfig_SampleStrategy.SAMPLE_STRATEGY_UNSPECIFIED, valueOf: SampleConfig_SampleStrategy.valueOf, enumValues: SampleConfig_SampleStrategy.values)
    ..hasRequiredFields = false
  ;
  ...
  'Use [GeneratedMessageGenericExtensions.rebuild] instead. '
  'Will be removed in next major version')
  SampleConfig copyWith(void Function(SampleConfig) updates) => super.copyWith((message) => updates(message as SampleConfig)) as SampleConfig; // ignore: deprecated_member_use
  $pb.BuilderInfo get info_ => _i;
  @$core.pragma('dart2js:noInline')
...
class TrainingConfig extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'TrainingConfig', package: const $pb.PackageName(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'google.cloud.aiplatform.v1beta1'), createEmptyInstance: create)
    ..aInt64(1, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'timeoutTrainingMilliHours')
    ..hasRequiredFields = false
  ;
  ...
  'Use [GeneratedMessageGenericExtensions.rebuild] instead. '
  'Will be removed in next major version')
  TrainingConfig copyWith(void Function(TrainingConfig) updates) => super.copyWith((message) => updates(message as TrainingConfig)) as TrainingConfig; // ignore: deprecated_member_use
  $pb.BuilderInfo get info_ => _i;
  @$core.pragma('dart2js:noInline')

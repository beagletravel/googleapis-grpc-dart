...
class BatchPredictionJob_InputConfig extends $pb.GeneratedMessage {
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'BatchPredictionJob.InputConfig', package: const $pb.PackageName(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'google.cloud.aiplatform.v1beta1'), createEmptyInstance: create)
    ..oo(0, [2, 3])
    ..aOS(1, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'instancesFormat')
    ..aOM<$9.GcsSource>(2, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'gcsSource', subBuilder: $9.GcsSource.create)
    ..aOM<$9.BigQuerySource>(3, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'bigquerySource', subBuilder: $9.BigQuerySource.create)
  ...
  'Will be removed in next major version')
  BatchPredictionJob_InputConfig copyWith(void Function(BatchPredictionJob_InputConfig) updates) => super.copyWith((message) => updates(message as BatchPredictionJob_InputConfig)) as BatchPredictionJob_InputConfig; // ignore: deprecated_member_use
  ...
  @$pb.TagNumber(2)
  set gcsSource($9.GcsSource v) { setField(2, v); }
  @$pb.TagNumber(2)
  ...
  @$pb.TagNumber(3)
  set bigquerySource($9.BigQuerySource v) { setField(3, v); }
  @$pb.TagNumber(3)
...
class BatchPredictionJob_OutputConfig extends $pb.GeneratedMessage {
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'BatchPredictionJob.OutputConfig', package: const $pb.PackageName(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'google.cloud.aiplatform.v1beta1'), createEmptyInstance: create)
    ..oo(0, [2, 3])
    ..aOS(1, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'predictionsFormat')
    ..aOM<$9.GcsDestination>(2, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'gcsDestination', subBuilder: $9.GcsDestination.create)
    ..aOM<$9.BigQueryDestination>(3, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'bigqueryDestination', subBuilder: $9.BigQueryDestination.create)
    ..hasRequiredFields = false
  ;
  ...
  'Use [GeneratedMessageGenericExtensions.rebuild] instead. '
  'Will be removed in next major version')
  BatchPredictionJob_OutputConfig copyWith(void Function(BatchPredictionJob_OutputConfig) updates) => super.copyWith((message) => updates(message as BatchPredictionJob_OutputConfig)) as BatchPredictionJob_OutputConfig; // ignore: deprecated_member_use
  $pb.BuilderInfo get info_ => _i;
  @$core.pragma('dart2js:noInline')
  ...
  @$pb.TagNumber(2)
  set gcsDestination($9.GcsDestination v) { setField(2, v); }
  @$pb.TagNumber(2)
  ...
  @$pb.TagNumber(3)
  set bigqueryDestination($9.BigQueryDestination v) { setField(3, v); }
  @$pb.TagNumber(3)
...
class BatchPredictionJob_OutputInfo extends $pb.GeneratedMessage {
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'BatchPredictionJob.OutputInfo', package: const $pb.PackageName(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'google.cloud.aiplatform.v1beta1'), createEmptyInstance: create)
    ..oo(0, [1, 2])
    ...
    ..aOS(4, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'bigqueryOutputTable')
    ..hasRequiredFields = false
  ;
  ...
  'Use [GeneratedMessageGenericExtensions.rebuild] instead. '
  'Will be removed in next major version')
  BatchPredictionJob_OutputInfo copyWith(void Function(BatchPredictionJob_OutputInfo) updates) => super.copyWith((message) => updates(message as BatchPredictionJob_OutputInfo)) as BatchPredictionJob_OutputInfo; // ignore: deprecated_member_use
  $pb.BuilderInfo get info_ => _i;
  @$core.pragma('dart2js:noInline')
...
class BatchPredictionJob extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'BatchPredictionJob', package: const $pb.PackageName(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'google.cloud.aiplatform.v1beta1'), createEmptyInstance: create)
    ...
    ..aOM<BatchPredictionJob_InputConfig>(4, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'inputConfig', subBuilder: BatchPredictionJob_InputConfig.create)
    ..aOM<$0.Value>(5, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'modelParameters', subBuilder: $0.Value.create)
    ..aOM<BatchPredictionJob_OutputConfig>(6, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'outputConfig', subBuilder: BatchPredictionJob_OutputConfig.create)
    ..aOM<$1.BatchDedicatedResources>(7, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'dedicatedResources', subBuilder: $1.BatchDedicatedResources.create)
    ..aOM<$2.ManualBatchTuningParameters>(8, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'manualBatchTuningParameters', subBuilder: $2.ManualBatchTuningParameters.create)
    ..aOM<BatchPredictionJob_OutputInfo>(9, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'outputInfo', subBuilder: BatchPredictionJob_OutputInfo.create)
    ..e<$10.JobState>(10, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'state', $pb.PbFieldType.OE, defaultOrMaker: $10.JobState.JOB_STATE_UNSPECIFIED, valueOf: $10.JobState.valueOf, enumValues: $10.JobState.values)
    ..aOM<$3.Status>(11, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'error', subBuilder: $3.Status.create)
    ..pc<$3.Status>(12, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'partialFailures', $pb.PbFieldType.PM, subBuilder: $3.Status.create)
    ..aOM<$1.ResourcesConsumed>(13, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'resourcesConsumed', subBuilder: $1.ResourcesConsumed.create)
    ..aOM<$4.CompletionStats>(14, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'completionStats', subBuilder: $4.CompletionStats.create)
    ..aOM<$5.Timestamp>(15, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'createTime', subBuilder: $5.Timestamp.create)
    ..aOM<$5.Timestamp>(16, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'startTime', subBuilder: $5.Timestamp.create)
    ..aOM<$5.Timestamp>(17, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'endTime', subBuilder: $5.Timestamp.create)
    ..aOM<$5.Timestamp>(18, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'updateTime', subBuilder: $5.Timestamp.create)
    ..m<$core.String, $core.String>(19, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'labels', entryClassName: 'BatchPredictionJob.LabelsEntry', keyFieldType: $pb.PbFieldType.OS, valueFieldType: $pb.PbFieldType.OS, packageName: const $pb.PackageName('google.cloud.aiplatform.v1beta1'))
    ..aOB(23, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'generateExplanation')
    ..aOM<$6.EncryptionSpec>(24, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'encryptionSpec', subBuilder: $6.EncryptionSpec.create)
    ..aOM<$7.ExplanationSpec>(25, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'explanationSpec', subBuilder: $7.ExplanationSpec.create)
    ..aOM<$8.UnmanagedContainerModel>(28, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'unmanagedContainerModel', subBuilder: $8.UnmanagedContainerModel.create)
    ..aOS(29, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'serviceAccount')
    ..aOS(30, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'modelVersionId')
    ..hasRequiredFields = false
  ;
  ...
  'Use [GeneratedMessageGenericExtensions.rebuild] instead. '
  'Will be removed in next major version')
  BatchPredictionJob copyWith(void Function(BatchPredictionJob) updates) => super.copyWith((message) => updates(message as BatchPredictionJob)) as BatchPredictionJob; // ignore: deprecated_member_use
  $pb.BuilderInfo get info_ => _i;
  @$core.pragma('dart2js:noInline')
  ...
  @$pb.TagNumber(5)
  set modelParameters($0.Value v) { setField(5, v); }
  @$pb.TagNumber(5)
  ...
  @$pb.TagNumber(7)
  set dedicatedResources($1.BatchDedicatedResources v) { setField(7, v); }
  @$pb.TagNumber(7)
  ...
  @$pb.TagNumber(8)
  set manualBatchTuningParameters($2.ManualBatchTuningParameters v) { setField(8, v); }
  @$pb.TagNumber(8)
  $core.bool hasManualBatchTuningParameters() => $_has(7);
  @$pb.TagNumber(8)
  void clearManualBatchTuningParameters() => clearField(8);
  @$pb.TagNumber(8)
  $2.ManualBatchTuningParameters ensureManualBatchTuningParameters() => $_ensure(7);
  ...
  @$pb.TagNumber(10)
  set state($10.JobState v) { setField(10, v); }
  @$pb.TagNumber(10)
  ...
  @$pb.TagNumber(11)
  set error($3.Status v) { setField(11, v); }
  @$pb.TagNumber(11)
  ...
  @$pb.TagNumber(13)
  set resourcesConsumed($1.ResourcesConsumed v) { setField(13, v); }
  @$pb.TagNumber(13)
  ...
  @$pb.TagNumber(14)
  set completionStats($4.CompletionStats v) { setField(14, v); }
  @$pb.TagNumber(14)
  ...
  @$pb.TagNumber(15)
  set createTime($5.Timestamp v) { setField(15, v); }
  @$pb.TagNumber(15)
  ...
  @$pb.TagNumber(16)
  set startTime($5.Timestamp v) { setField(16, v); }
  @$pb.TagNumber(16)
  ...
  @$pb.TagNumber(17)
  set endTime($5.Timestamp v) { setField(17, v); }
  @$pb.TagNumber(17)
  ...
  @$pb.TagNumber(18)
  set updateTime($5.Timestamp v) { setField(18, v); }
  @$pb.TagNumber(18)
  ...
  @$pb.TagNumber(24)
  set encryptionSpec($6.EncryptionSpec v) { setField(24, v); }
  @$pb.TagNumber(24)
  ...
  @$pb.TagNumber(25)
  set explanationSpec($7.ExplanationSpec v) { setField(25, v); }
  @$pb.TagNumber(25)
  ...
  @$pb.TagNumber(28)
  set unmanagedContainerModel($8.UnmanagedContainerModel v) { setField(28, v); }
  @$pb.TagNumber(28)
  ...
  @$pb.TagNumber(30)
  $core.String get modelVersionId => $_getSZ(24);
  @$pb.TagNumber(30)
  set modelVersionId($core.String v) { $_setString(24, v); }
  @$pb.TagNumber(30)
  $core.bool hasModelVersionId() => $_has(24);
  @$pb.TagNumber(30)

...
class LineageSubgraph extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'LineageSubgraph', package: const $pb.PackageName(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'google.cloud.aiplatform.v1beta1'), createEmptyInstance: create)
    ..pc<$0.Artifact>(1, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'artifacts', $pb.PbFieldType.PM, subBuilder: $0.Artifact.create)
    ..pc<$1.Execution>(2, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'executions', $pb.PbFieldType.PM, subBuilder: $1.Execution.create)
    ..pc<$2.Event>(3, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'events', $pb.PbFieldType.PM, subBuilder: $2.Event.create)
  ...
  'Will be removed in next major version')
  LineageSubgraph copyWith(void Function(LineageSubgraph) updates) => super.copyWith((message) => updates(message as LineageSubgraph)) as LineageSubgraph; // ignore: deprecated_member_use

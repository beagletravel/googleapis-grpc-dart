...
class IdMatcher extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'IdMatcher', package: const $pb.PackageName(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'google.cloud.aiplatform.v1beta1'), createEmptyInstance: create)
  ...
  'Will be removed in next major version')
  IdMatcher copyWith(void Function(IdMatcher) updates) => super.copyWith((message) => updates(message as IdMatcher)) as IdMatcher; // ignore: deprecated_member_use
...
class FeatureSelector extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'FeatureSelector', package: const $pb.PackageName(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'google.cloud.aiplatform.v1beta1'), createEmptyInstance: create)
    ..aOM<IdMatcher>(1, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'idMatcher', subBuilder: IdMatcher.create)
    ..hasRequiredFields = false
  ;
  ...
  'Use [GeneratedMessageGenericExtensions.rebuild] instead. '
  'Will be removed in next major version')
  FeatureSelector copyWith(void Function(FeatureSelector) updates) => super.copyWith((message) => updates(message as FeatureSelector)) as FeatureSelector; // ignore: deprecated_member_use
  $pb.BuilderInfo get info_ => _i;
  @$core.pragma('dart2js:noInline')

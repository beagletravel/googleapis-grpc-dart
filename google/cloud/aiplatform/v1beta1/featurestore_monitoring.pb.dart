...
class FeaturestoreMonitoringConfig_SnapshotAnalysis extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'FeaturestoreMonitoringConfig.SnapshotAnalysis', package: const $pb.PackageName(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'google.cloud.aiplatform.v1beta1'), createEmptyInstance: create)
    ..aOB(1, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'disabled')
    ..aOM<$0.Duration>(2, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'monitoringInterval', subBuilder: $0.Duration.create)
  ...
  @$core.Deprecated('This field is deprecated.')
  @$pb.TagNumber(2)
  set monitoringInterval($0.Duration v) { setField(2, v); }
  @$core.Deprecated('This field is deprecated.')
  @$pb.TagNumber(2)
  ...
  @$pb.TagNumber(3)
  set monitoringIntervalDays($core.int v) { $_setSignedInt32(2, v); }
  @$pb.TagNumber(3)
  ...
  @$pb.TagNumber(4)
  $core.int get stalenessDays => $_getIZ(3);
  @$pb.TagNumber(4)
  set stalenessDays($core.int v) { $_setSignedInt32(3, v); }
  @$pb.TagNumber(4)
  $core.bool hasStalenessDays() => $_has(3);
  @$pb.TagNumber(4)
...
class FeaturestoreMonitoringConfig_ImportFeaturesAnalysis extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'FeaturestoreMonitoringConfig.ImportFeaturesAnalysis', package: const $pb.PackageName(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'google.cloud.aiplatform.v1beta1'), createEmptyInstance: create)
...
class FeaturestoreMonitoringConfig_ThresholdConfig extends $pb.GeneratedMessage {
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'FeaturestoreMonitoringConfig.ThresholdConfig', package: const $pb.PackageName(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'google.cloud.aiplatform.v1beta1'), createEmptyInstance: create)
    ..oo(0, [1])
...
class FeaturestoreMonitoringConfig extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'FeaturestoreMonitoringConfig', package: const $pb.PackageName(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'google.cloud.aiplatform.v1beta1'), createEmptyInstance: create)

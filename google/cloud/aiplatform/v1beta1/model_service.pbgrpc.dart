...
class ModelServiceClient extends $grpc.Client {
  ...
  static final _$listModelVersions = $grpc.ClientMethod<
          $2.ListModelVersionsRequest, $2.ListModelVersionsResponse>(
      '/google.cloud.aiplatform.v1beta1.ModelService/ListModelVersions',
      ($2.ListModelVersionsRequest value) => value.writeToBuffer(),
      ($core.List<$core.int> value) =>
          $2.ListModelVersionsResponse.fromBuffer(value));
  ...
  static final _$deleteModel =
      $grpc.ClientMethod<$2.DeleteModelRequest, $0.Operation>(
          ...
          ($core.List<$core.int> value) => $0.Operation.fromBuffer(value));
  static final _$deleteModelVersion =
      $grpc.ClientMethod<$2.DeleteModelVersionRequest, $0.Operation>(
          '/google.cloud.aiplatform.v1beta1.ModelService/DeleteModelVersion',
          ($2.DeleteModelVersionRequest value) => value.writeToBuffer(),
          ($core.List<$core.int> value) => $0.Operation.fromBuffer(value));
  static final _$mergeVersionAliases =
      $grpc.ClientMethod<$2.MergeVersionAliasesRequest, $3.Model>(
          '/google.cloud.aiplatform.v1beta1.ModelService/MergeVersionAliases',
          ($2.MergeVersionAliasesRequest value) => value.writeToBuffer(),
          ($core.List<$core.int> value) => $3.Model.fromBuffer(value));
  static final _$exportModel =
      $grpc.ClientMethod<$2.ExportModelRequest, $0.Operation>(
          ...
          ($core.List<$core.int> value) => $0.Operation.fromBuffer(value));
  static final _$importModelEvaluation =
      $grpc.ClientMethod<$2.ImportModelEvaluationRequest, $4.ModelEvaluation>(
          '/google.cloud.aiplatform.v1beta1.ModelService/ImportModelEvaluation',
          ($2.ImportModelEvaluationRequest value) => value.writeToBuffer(),
          ($core.List<$core.int> value) =>
  ...
  $grpc.ResponseFuture<$2.ListModelVersionsResponse> listModelVersions(
      $2.ListModelVersionsRequest request,
      {$grpc.CallOptions? options}) {
  ...
  $grpc.ResponseFuture<$0.Operation> deleteModelVersion(
      $2.DeleteModelVersionRequest request,
      {$grpc.CallOptions? options}) {
    return $createUnaryCall(_$deleteModelVersion, request, options: options);
  }

  $grpc.ResponseFuture<$3.Model> mergeVersionAliases(
      $2.MergeVersionAliasesRequest request,
      {$grpc.CallOptions? options}) {
  ...
  $grpc.ResponseFuture<$4.ModelEvaluation> importModelEvaluation(
      $2.ImportModelEvaluationRequest request,
      {$grpc.CallOptions? options}) {
...
abstract class ModelServiceBase extends $grpc.Service {
  ...
  ModelServiceBase() {
    ...
    $addMethod($grpc.ServiceMethod<$2.ListModelVersionsRequest,
            $2.ListModelVersionsResponse>(
        'ListModelVersions',
        listModelVersions_Pre,
        false,
        false,
        ($core.List<$core.int> value) =>
            $2.ListModelVersionsRequest.fromBuffer(value),
        ($2.ListModelVersionsResponse value) => value.writeToBuffer()));
    ...
    $addMethod($grpc.ServiceMethod<$2.DeleteModelRequest, $0.Operation>(
        ...
        ($0.Operation value) => value.writeToBuffer()));
    $addMethod($grpc.ServiceMethod<$2.DeleteModelVersionRequest, $0.Operation>(
        'DeleteModelVersion',
        deleteModelVersion_Pre,
        false,
        false,
        ($core.List<$core.int> value) =>
            $2.DeleteModelVersionRequest.fromBuffer(value),
        ($0.Operation value) => value.writeToBuffer()));
    $addMethod($grpc.ServiceMethod<$2.MergeVersionAliasesRequest, $3.Model>(
        'MergeVersionAliases',
        mergeVersionAliases_Pre,
        false,
        false,
        ($core.List<$core.int> value) =>
            $2.MergeVersionAliasesRequest.fromBuffer(value),
        ($3.Model value) => value.writeToBuffer()));
    $addMethod($grpc.ServiceMethod<$2.ExportModelRequest, $0.Operation>(
        ...
        ($0.Operation value) => value.writeToBuffer()));
    $addMethod($grpc.ServiceMethod<$2.ImportModelEvaluationRequest,
            $4.ModelEvaluation>(
        ...
        false,
        ($core.List<$core.int> value) =>
            $2.ImportModelEvaluationRequest.fromBuffer(value),
  ...
  $async.Future<$2.ListModelVersionsResponse> listModelVersions_Pre(
      $grpc.ServiceCall call,
      $async.Future<$2.ListModelVersionsRequest> request) async {
  ...
  $async.Future<$0.Operation> deleteModelVersion_Pre($grpc.ServiceCall call,
      $async.Future<$2.DeleteModelVersionRequest> request) async {
    return deleteModelVersion(call, await request);
  }

  $async.Future<$3.Model> mergeVersionAliases_Pre($grpc.ServiceCall call,
      $async.Future<$2.MergeVersionAliasesRequest> request) async {
  ...
  $async.Future<$4.ModelEvaluation> importModelEvaluation_Pre(
      $grpc.ServiceCall call,
      $async.Future<$2.ImportModelEvaluationRequest> request) async {
  ...
  $async.Future<$2.ListModelVersionsResponse> listModelVersions(
      $grpc.ServiceCall call, $2.ListModelVersionsRequest request);
  ...
  $async.Future<$0.Operation> deleteModelVersion(
      $grpc.ServiceCall call, $2.DeleteModelVersionRequest request);
  $async.Future<$3.Model> mergeVersionAliases(
      $grpc.ServiceCall call, $2.MergeVersionAliasesRequest request);
  $async.Future<$0.Operation> exportModel(
      $grpc.ServiceCall call, $2.ExportModelRequest request);
  $async.Future<$4.ModelEvaluation> importModelEvaluation(
      $grpc.ServiceCall call, $2.ImportModelEvaluationRequest request);

...
class DeployedModelRef extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'DeployedModelRef', package: const $pb.PackageName(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'google.cloud.aiplatform.v1beta1'), createEmptyInstance: create)
  ...
  'Will be removed in next major version')
  DeployedModelRef copyWith(void Function(DeployedModelRef) updates) => super.copyWith((message) => updates(message as DeployedModelRef)) as DeployedModelRef; // ignore: deprecated_member_use

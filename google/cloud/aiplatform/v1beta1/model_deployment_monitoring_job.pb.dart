...
class ModelDeploymentMonitoringJob_LatestMonitoringPipelineMetadata extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'ModelDeploymentMonitoringJob.LatestMonitoringPipelineMetadata', package: const $pb.PackageName(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'google.cloud.aiplatform.v1beta1'), createEmptyInstance: create)
    ..aOM<$1.Timestamp>(1, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'runTime', subBuilder: $1.Timestamp.create)
  ...
  'Will be removed in next major version')
  ModelDeploymentMonitoringJob_LatestMonitoringPipelineMetadata copyWith(void Function(ModelDeploymentMonitoringJob_LatestMonitoringPipelineMetadata) updates) => super.copyWith((message) => updates(message as ModelDeploymentMonitoringJob_LatestMonitoringPipelineMetadata)) as ModelDeploymentMonitoringJob_LatestMonitoringPipelineMetadata; // ignore: deprecated_member_use
  ...
  @$pb.TagNumber(1)
  $1.Timestamp get runTime => $_getN(0);
  @$pb.TagNumber(1)
  set runTime($1.Timestamp v) { setField(1, v); }
  @$pb.TagNumber(1)
  $core.bool hasRunTime() => $_has(0);
  @$pb.TagNumber(1)
  void clearRunTime() => clearField(1);
  @$pb.TagNumber(1)
  $1.Timestamp ensureRunTime() => $_ensure(0);
...
class ModelDeploymentMonitoringJob extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'ModelDeploymentMonitoringJob', package: const $pb.PackageName(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'google.cloud.aiplatform.v1beta1'), createEmptyInstance: create)
    ...
    ..e<$8.JobState>(4, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'state', $pb.PbFieldType.OE, defaultOrMaker: $8.JobState.JOB_STATE_UNSPECIFIED, valueOf: $8.JobState.valueOf, enumValues: $8.JobState.values)
    ..e<ModelDeploymentMonitoringJob_MonitoringScheduleState>(5, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'scheduleState', $pb.PbFieldType.OE, defaultOrMaker: ModelDeploymentMonitoringJob_MonitoringScheduleState.MONITORING_SCHEDULE_STATE_UNSPECIFIED, valueOf: ModelDeploymentMonitoringJob_MonitoringScheduleState.valueOf, enumValues: ModelDeploymentMonitoringJob_MonitoringScheduleState.values)
    ..pc<ModelDeploymentMonitoringObjectiveConfig>(6, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'modelDeploymentMonitoringObjectiveConfigs', $pb.PbFieldType.PM, subBuilder: ModelDeploymentMonitoringObjectiveConfig.create)
    ..aOM<ModelDeploymentMonitoringScheduleConfig>(7, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'modelDeploymentMonitoringScheduleConfig', subBuilder: ModelDeploymentMonitoringScheduleConfig.create)
    ..aOM<$0.SamplingStrategy>(8, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'loggingSamplingStrategy', subBuilder: $0.SamplingStrategy.create)
    ..aOS(9, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'predictInstanceSchemaUri')
    ..pc<ModelDeploymentMonitoringBigQueryTable>(10, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'bigqueryTables', $pb.PbFieldType.PM, subBuilder: ModelDeploymentMonitoringBigQueryTable.create)
    ..m<$core.String, $core.String>(11, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'labels', entryClassName: 'ModelDeploymentMonitoringJob.LabelsEntry', keyFieldType: $pb.PbFieldType.OS, valueFieldType: $pb.PbFieldType.OS, packageName: const $pb.PackageName('google.cloud.aiplatform.v1beta1'))
    ...
    ..aOM<$1.Timestamp>(14, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'nextScheduleTime', subBuilder: $1.Timestamp.create)
    ..aOM<$0.ModelMonitoringAlertConfig>(15, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'modelMonitoringAlertConfig', subBuilder: $0.ModelMonitoringAlertConfig.create)
    ..aOS(16, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'analysisInstanceSchemaUri')
    ..aOM<$2.Duration>(17, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'logTtl', subBuilder: $2.Duration.create)
    ..aOM<$3.Value>(19, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'samplePredictInstance', subBuilder: $3.Value.create)
    ..aOM<$4.GcsDestination>(20, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'statsAnomaliesBaseDirectory', subBuilder: $4.GcsDestination.create)
    ..aOM<$5.EncryptionSpec>(21, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'encryptionSpec', subBuilder: $5.EncryptionSpec.create)
    ..aOB(22, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'enableMonitoringPipelineLogs')
    ..aOM<$6.Status>(23, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'error', subBuilder: $6.Status.create)
    ..aOM<ModelDeploymentMonitoringJob_LatestMonitoringPipelineMetadata>(25, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'latestMonitoringPipelineMetadata', subBuilder: ModelDeploymentMonitoringJob_LatestMonitoringPipelineMetadata.create)
    ..hasRequiredFields = false
  ;
  ...
  factory ModelDeploymentMonitoringJob({
    ...
    if (modelDeploymentMonitoringObjectiveConfigs != null) {
      _result.modelDeploymentMonitoringObjectiveConfigs.addAll(modelDeploymentMonitoringObjectiveConfigs);
    }
    if (modelDeploymentMonitoringScheduleConfig != null) {
      _result.modelDeploymentMonitoringScheduleConfig = modelDeploymentMonitoringScheduleConfig;
    }
    ...
    if (latestMonitoringPipelineMetadata != null) {
      _result.latestMonitoringPipelineMetadata = latestMonitoringPipelineMetadata;
    }
    return _result;
  }
  ...
  'Use [GeneratedMessageGenericExtensions.rebuild] instead. '
  'Will be removed in next major version')
  ModelDeploymentMonitoringJob copyWith(void Function(ModelDeploymentMonitoringJob) updates) => super.copyWith((message) => updates(message as ModelDeploymentMonitoringJob)) as ModelDeploymentMonitoringJob; // ignore: deprecated_member_use
  $pb.BuilderInfo get info_ => _i;
  @$core.pragma('dart2js:noInline')
  ...
  @$pb.TagNumber(4)
  set state($8.JobState v) { setField(4, v); }
  @$pb.TagNumber(4)
  ...
  @$pb.TagNumber(8)
  set loggingSamplingStrategy($0.SamplingStrategy v) { setField(8, v); }
  @$pb.TagNumber(8)
  ...
  @$pb.TagNumber(14)
  set nextScheduleTime($1.Timestamp v) { setField(14, v); }
  @$pb.TagNumber(14)
  ...
  @$pb.TagNumber(15)
  set modelMonitoringAlertConfig($0.ModelMonitoringAlertConfig v) { setField(15, v); }
  @$pb.TagNumber(15)
  $core.bool hasModelMonitoringAlertConfig() => $_has(14);
  @$pb.TagNumber(15)
  void clearModelMonitoringAlertConfig() => clearField(15);
  @$pb.TagNumber(15)
  $0.ModelMonitoringAlertConfig ensureModelMonitoringAlertConfig() => $_ensure(14);
  ...
  @$pb.TagNumber(17)
  set logTtl($2.Duration v) { setField(17, v); }
  @$pb.TagNumber(17)
  ...
  @$pb.TagNumber(19)
  set samplePredictInstance($3.Value v) { setField(19, v); }
  @$pb.TagNumber(19)
  ...
  @$pb.TagNumber(20)
  set statsAnomaliesBaseDirectory($4.GcsDestination v) { setField(20, v); }
  @$pb.TagNumber(20)
  ...
  @$pb.TagNumber(21)
  set encryptionSpec($5.EncryptionSpec v) { setField(21, v); }
  @$pb.TagNumber(21)
  ...
  @$pb.TagNumber(23)
  set error($6.Status v) { setField(23, v); }
  @$pb.TagNumber(23)
...
class ModelDeploymentMonitoringBigQueryTable extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'ModelDeploymentMonitoringBigQueryTable', package: const $pb.PackageName(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'google.cloud.aiplatform.v1beta1'), createEmptyInstance: create)
    ..e<ModelDeploymentMonitoringBigQueryTable_LogSource>(1, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'logSource', $pb.PbFieldType.OE, defaultOrMaker: ModelDeploymentMonitoringBigQueryTable_LogSource.LOG_SOURCE_UNSPECIFIED, valueOf: ModelDeploymentMonitoringBigQueryTable_LogSource.valueOf, enumValues: ModelDeploymentMonitoringBigQueryTable_LogSource.values)
    ..e<ModelDeploymentMonitoringBigQueryTable_LogType>(2, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'logType', $pb.PbFieldType.OE, defaultOrMaker: ModelDeploymentMonitoringBigQueryTable_LogType.LOG_TYPE_UNSPECIFIED, valueOf: ModelDeploymentMonitoringBigQueryTable_LogType.valueOf, enumValues: ModelDeploymentMonitoringBigQueryTable_LogType.values)
    ..aOS(3, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'bigqueryTablePath')
    ..hasRequiredFields = false
  ;
  ...
  'Use [GeneratedMessageGenericExtensions.rebuild] instead. '
  'Will be removed in next major version')
  ModelDeploymentMonitoringBigQueryTable copyWith(void Function(ModelDeploymentMonitoringBigQueryTable) updates) => super.copyWith((message) => updates(message as ModelDeploymentMonitoringBigQueryTable)) as ModelDeploymentMonitoringBigQueryTable; // ignore: deprecated_member_use
  $pb.BuilderInfo get info_ => _i;
  @$core.pragma('dart2js:noInline')
...
class ModelDeploymentMonitoringObjectiveConfig extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'ModelDeploymentMonitoringObjectiveConfig', package: const $pb.PackageName(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'google.cloud.aiplatform.v1beta1'), createEmptyInstance: create)
    ..aOS(1, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'deployedModelId')
    ..aOM<$0.ModelMonitoringObjectiveConfig>(2, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'objectiveConfig', subBuilder: $0.ModelMonitoringObjectiveConfig.create)
    ..hasRequiredFields = false
  ;
  ...
  'Use [GeneratedMessageGenericExtensions.rebuild] instead. '
  'Will be removed in next major version')
  ModelDeploymentMonitoringObjectiveConfig copyWith(void Function(ModelDeploymentMonitoringObjectiveConfig) updates) => super.copyWith((message) => updates(message as ModelDeploymentMonitoringObjectiveConfig)) as ModelDeploymentMonitoringObjectiveConfig; // ignore: deprecated_member_use
  $pb.BuilderInfo get info_ => _i;
  @$core.pragma('dart2js:noInline')
  ...
  @$pb.TagNumber(2)
  set objectiveConfig($0.ModelMonitoringObjectiveConfig v) { setField(2, v); }
  @$pb.TagNumber(2)
...
class ModelDeploymentMonitoringScheduleConfig extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'ModelDeploymentMonitoringScheduleConfig', package: const $pb.PackageName(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'google.cloud.aiplatform.v1beta1'), createEmptyInstance: create)
    ..aOM<$2.Duration>(1, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'monitorInterval', subBuilder: $2.Duration.create)
    ..hasRequiredFields = false
  ;
  ...
  'Use [GeneratedMessageGenericExtensions.rebuild] instead. '
  'Will be removed in next major version')
  ModelDeploymentMonitoringScheduleConfig copyWith(void Function(ModelDeploymentMonitoringScheduleConfig) updates) => super.copyWith((message) => updates(message as ModelDeploymentMonitoringScheduleConfig)) as ModelDeploymentMonitoringScheduleConfig; // ignore: deprecated_member_use
  $pb.BuilderInfo get info_ => _i;
  @$core.pragma('dart2js:noInline')
  ...
  @$pb.TagNumber(1)
  set monitorInterval($2.Duration v) { setField(1, v); }
  @$pb.TagNumber(1)
...
class ModelMonitoringStatsAnomalies_FeatureHistoricStatsAnomalies extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'ModelMonitoringStatsAnomalies.FeatureHistoricStatsAnomalies', package: const $pb.PackageName(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'google.cloud.aiplatform.v1beta1'), createEmptyInstance: create)
    ..aOS(1, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'featureDisplayName')
    ..aOM<$0.ThresholdConfig>(3, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'threshold', subBuilder: $0.ThresholdConfig.create)
    ..aOM<$7.FeatureStatsAnomaly>(4, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'trainingStats', subBuilder: $7.FeatureStatsAnomaly.create)
    ..pc<$7.FeatureStatsAnomaly>(5, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'predictionStats', $pb.PbFieldType.PM, subBuilder: $7.FeatureStatsAnomaly.create)
    ..hasRequiredFields = false
  ;
  ...
  'Use [GeneratedMessageGenericExtensions.rebuild] instead. '
  'Will be removed in next major version')
  ModelMonitoringStatsAnomalies_FeatureHistoricStatsAnomalies copyWith(void Function(ModelMonitoringStatsAnomalies_FeatureHistoricStatsAnomalies) updates) => super.copyWith((message) => updates(message as ModelMonitoringStatsAnomalies_FeatureHistoricStatsAnomalies)) as ModelMonitoringStatsAnomalies_FeatureHistoricStatsAnomalies; // ignore: deprecated_member_use
  $pb.BuilderInfo get info_ => _i;
  @$core.pragma('dart2js:noInline')
  ...
  @$pb.TagNumber(3)
  set threshold($0.ThresholdConfig v) { setField(3, v); }
  @$pb.TagNumber(3)
  ...
  @$pb.TagNumber(4)
  set trainingStats($7.FeatureStatsAnomaly v) { setField(4, v); }
  @$pb.TagNumber(4)
...
class ModelMonitoringStatsAnomalies extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'ModelMonitoringStatsAnomalies', package: const $pb.PackageName(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'google.cloud.aiplatform.v1beta1'), createEmptyInstance: create)
    ..e<ModelDeploymentMonitoringObjectiveType>(1, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'objective', $pb.PbFieldType.OE, defaultOrMaker: ModelDeploymentMonitoringObjectiveType.MODEL_DEPLOYMENT_MONITORING_OBJECTIVE_TYPE_UNSPECIFIED, valueOf: ModelDeploymentMonitoringObjectiveType.valueOf, enumValues: ModelDeploymentMonitoringObjectiveType.values)
    ..aOS(2, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'deployedModelId')
    ..a<$core.int>(3, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'anomalyCount', $pb.PbFieldType.O3)
    ..pc<ModelMonitoringStatsAnomalies_FeatureHistoricStatsAnomalies>(4, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'featureStats', $pb.PbFieldType.PM, subBuilder: ModelMonitoringStatsAnomalies_FeatureHistoricStatsAnomalies.create)
    ..hasRequiredFields = false
  ;
  ...
  'Use [GeneratedMessageGenericExtensions.rebuild] instead. '
  'Will be removed in next major version')
  ModelMonitoringStatsAnomalies copyWith(void Function(ModelMonitoringStatsAnomalies) updates) => super.copyWith((message) => updates(message as ModelMonitoringStatsAnomalies)) as ModelMonitoringStatsAnomalies; // ignore: deprecated_member_use
  $pb.BuilderInfo get info_ => _i;
  @$core.pragma('dart2js:noInline')

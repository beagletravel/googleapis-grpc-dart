...
class Endpoint extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'Endpoint', package: const $pb.PackageName(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'google.cloud.aiplatform.v1beta1'), createEmptyInstance: create)
    ..aOS(1, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'name')
    ..aOS(2, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'displayName')
    ..aOS(3, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'description')
    ..pc<DeployedModel>(4, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'deployedModels', $pb.PbFieldType.PM, subBuilder: DeployedModel.create)
    ..m<$core.String, $core.int>(5, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'trafficSplit', entryClassName: 'Endpoint.TrafficSplitEntry', keyFieldType: $pb.PbFieldType.OS, valueFieldType: $pb.PbFieldType.O3, packageName: const $pb.PackageName('google.cloud.aiplatform.v1beta1'))
    ..aOS(6, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'etag')
    ..m<$core.String, $core.String>(7, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'labels', entryClassName: 'Endpoint.LabelsEntry', keyFieldType: $pb.PbFieldType.OS, valueFieldType: $pb.PbFieldType.OS, packageName: const $pb.PackageName('google.cloud.aiplatform.v1beta1'))
    ...
    ..aOS(13, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'network')
    ..aOS(14, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'modelDeploymentMonitoringJob')
    ..aOB(17, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'enablePrivateServiceConnect')
    ..aOM<PredictRequestResponseLoggingConfig>(18, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'predictRequestResponseLoggingConfig', subBuilder: PredictRequestResponseLoggingConfig.create)
  ...
  @$core.Deprecated('This field is deprecated.')
    ...
    if (predictRequestResponseLoggingConfig != null) {
      _result.predictRequestResponseLoggingConfig = predictRequestResponseLoggingConfig;
    }
    return _result;
  }
...
class DeployedModel extends $pb.GeneratedMessage {
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'DeployedModel', package: const $pb.PackageName(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'google.cloud.aiplatform.v1beta1'), createEmptyInstance: create)
    ..oo(0, [7, 8])
    ...
    ..aOM<$2.DedicatedResources>(7, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'dedicatedResources', subBuilder: $2.DedicatedResources.create)
    ..aOM<$2.AutomaticResources>(8, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'automaticResources', subBuilder: $2.AutomaticResources.create)
    ..aOM<$3.ExplanationSpec>(9, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'explanationSpec', subBuilder: $3.ExplanationSpec.create)
    ..aOS(11, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'serviceAccount')
    ..aOB(12, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'enableContainerLogging')
    ..aOB(13, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'enableAccessLogging')
    ..aOM<PrivateEndpoints>(14, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'privateEndpoints', subBuilder: PrivateEndpoints.create)
    ..aOS(18, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'modelVersionId')
    ..hasRequiredFields = false
  ;
  ...
  factory DeployedModel({
    ...
    if (enableContainerLogging != null) {
      _result.enableContainerLogging = enableContainerLogging;
    }
  ...
  'Use [GeneratedMessageGenericExtensions.rebuild] instead. '
  'Will be removed in next major version')
  DeployedModel copyWith(void Function(DeployedModel) updates) => super.copyWith((message) => updates(message as DeployedModel)) as DeployedModel; // ignore: deprecated_member_use
  $pb.BuilderInfo get info_ => _i;
  @$core.pragma('dart2js:noInline')
  ...
  @$pb.TagNumber(7)
  set dedicatedResources($2.DedicatedResources v) { setField(7, v); }
  @$pb.TagNumber(7)
  ...
  @$pb.TagNumber(8)
  set automaticResources($2.AutomaticResources v) { setField(8, v); }
  @$pb.TagNumber(8)
  ...
  @$pb.TagNumber(9)
  set explanationSpec($3.ExplanationSpec v) { setField(9, v); }
  @$pb.TagNumber(9)
  ...
  @$pb.TagNumber(12)
  $core.bool get enableContainerLogging => $_getBF(8);
  @$pb.TagNumber(12)
  set enableContainerLogging($core.bool v) { $_setBool(8, v); }
  @$pb.TagNumber(12)
  $core.bool hasEnableContainerLogging() => $_has(8);
  @$pb.TagNumber(12)
  void clearEnableContainerLogging() => clearField(12);

  @$pb.TagNumber(13)
  $core.bool get enableAccessLogging => $_getBF(9);
  @$pb.TagNumber(13)
  set enableAccessLogging($core.bool v) { $_setBool(9, v); }
  @$pb.TagNumber(13)
  $core.bool hasEnableAccessLogging() => $_has(9);
  @$pb.TagNumber(13)
  void clearEnableAccessLogging() => clearField(13);

  @$pb.TagNumber(14)
  PrivateEndpoints get privateEndpoints => $_getN(10);
  @$pb.TagNumber(14)
  set privateEndpoints(PrivateEndpoints v) { setField(14, v); }
  @$pb.TagNumber(14)
  $core.bool hasPrivateEndpoints() => $_has(10);
  @$pb.TagNumber(14)
  void clearPrivateEndpoints() => clearField(14);
  @$pb.TagNumber(14)
  PrivateEndpoints ensurePrivateEndpoints() => $_ensure(10);

  @$pb.TagNumber(18)
  $core.String get modelVersionId => $_getSZ(11);
  @$pb.TagNumber(18)
  set modelVersionId($core.String v) { $_setString(11, v); }
  @$pb.TagNumber(18)
  $core.bool hasModelVersionId() => $_has(11);
  @$pb.TagNumber(18)
  void clearModelVersionId() => clearField(18);
}

class PrivateEndpoints extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'PrivateEndpoints', package: const $pb.PackageName(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'google.cloud.aiplatform.v1beta1'), createEmptyInstance: create)
    ..aOS(1, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'predictHttpUri')
    ..aOS(2, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'explainHttpUri')
    ..aOS(3, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'healthHttpUri')
    ..aOS(4, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'serviceAttachment')
    ..hasRequiredFields = false
  ;
  ...
  'Use [GeneratedMessageGenericExtensions.rebuild] instead. '
  'Will be removed in next major version')
  PrivateEndpoints copyWith(void Function(PrivateEndpoints) updates) => super.copyWith((message) => updates(message as PrivateEndpoints)) as PrivateEndpoints; // ignore: deprecated_member_use
  $pb.BuilderInfo get info_ => _i;
  @$core.pragma('dart2js:noInline')
...
class PredictRequestResponseLoggingConfig extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'PredictRequestResponseLoggingConfig', package: const $pb.PackageName(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'google.cloud.aiplatform.v1beta1'), createEmptyInstance: create)
    ..aOB(1, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'enabled')
    ..a<$core.double>(2, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'samplingRate', $pb.PbFieldType.OD)
    ..aOM<$4.BigQueryDestination>(3, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'bigqueryDestination', subBuilder: $4.BigQueryDestination.create)
    ..hasRequiredFields = false
  ;
  ...
  factory PredictRequestResponseLoggingConfig({
    ...
    $4.BigQueryDestination? bigqueryDestination,
  }) {
    final _result = create();
    if (enabled != null) {
  ...
  'Use [GeneratedMessageGenericExtensions.rebuild] instead. '
  'Will be removed in next major version')
  PredictRequestResponseLoggingConfig copyWith(void Function(PredictRequestResponseLoggingConfig) updates) => super.copyWith((message) => updates(message as PredictRequestResponseLoggingConfig)) as PredictRequestResponseLoggingConfig; // ignore: deprecated_member_use
  $pb.BuilderInfo get info_ => _i;
  @$core.pragma('dart2js:noInline')
  ...
  @$pb.TagNumber(3)
  $4.BigQueryDestination get bigqueryDestination => $_getN(2);
  @$pb.TagNumber(3)
  set bigqueryDestination($4.BigQueryDestination v) { setField(3, v); }
  @$pb.TagNumber(3)
  $core.bool hasBigqueryDestination() => $_has(2);
  @$pb.TagNumber(3)
  void clearBigqueryDestination() => clearField(3);
  @$pb.TagNumber(3)
  $4.BigQueryDestination ensureBigqueryDestination() => $_ensure(2);
}

...
class EncryptionSpec extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'EncryptionSpec', package: const $pb.PackageName(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'google.cloud.aiplatform.v1beta1'), createEmptyInstance: create)
  ...
  'Will be removed in next major version')
  EncryptionSpec copyWith(void Function(EncryptionSpec) updates) => super.copyWith((message) => updates(message as EncryptionSpec)) as EncryptionSpec; // ignore: deprecated_member_use

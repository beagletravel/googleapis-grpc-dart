...
class SampleConfig_SampleStrategy extends $pb.ProtobufEnum {
  static const SampleConfig_SampleStrategy SAMPLE_STRATEGY_UNSPECIFIED = SampleConfig_SampleStrategy._(0, const $core.bool.fromEnvironment('protobuf.omit_enum_names') ? '' : 'SAMPLE_STRATEGY_UNSPECIFIED');
  static const SampleConfig_SampleStrategy UNCERTAINTY = SampleConfig_SampleStrategy._(1, const $core.bool.fromEnvironment('protobuf.omit_enum_names') ? '' : 'UNCERTAINTY');

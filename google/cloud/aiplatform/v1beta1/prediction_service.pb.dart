...
class PredictRequest extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'PredictRequest', package: const $pb.PackageName(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'google.cloud.aiplatform.v1beta1'), createEmptyInstance: create)
    ..aOS(1, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'endpoint')
    ..pc<$2.Value>(2, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'instances', $pb.PbFieldType.PM, subBuilder: $2.Value.create)
    ..aOM<$2.Value>(3, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'parameters', subBuilder: $2.Value.create)
  ...
  @$pb.TagNumber(3)
  set parameters($2.Value v) { setField(3, v); }
  @$pb.TagNumber(3)
...
class PredictResponse extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'PredictResponse', package: const $pb.PackageName(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'google.cloud.aiplatform.v1beta1'), createEmptyInstance: create)
    ..pc<$2.Value>(1, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'predictions', $pb.PbFieldType.PM, subBuilder: $2.Value.create)
    ...
    ..aOS(4, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'modelDisplayName')
    ..aOS(5, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'modelVersionId')
    ..hasRequiredFields = false
  ;
...
class RawPredictRequest extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'RawPredictRequest', package: const $pb.PackageName(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'google.cloud.aiplatform.v1beta1'), createEmptyInstance: create)
    ..aOS(1, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'endpoint')
    ..aOM<$1.HttpBody>(2, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'httpBody', subBuilder: $1.HttpBody.create)
    ..hasRequiredFields = false
  ;
  ...
  'Use [GeneratedMessageGenericExtensions.rebuild] instead. '
  'Will be removed in next major version')
  RawPredictRequest copyWith(void Function(RawPredictRequest) updates) => super.copyWith((message) => updates(message as RawPredictRequest)) as RawPredictRequest; // ignore: deprecated_member_use
  $pb.BuilderInfo get info_ => _i;
  @$core.pragma('dart2js:noInline')
  ...
  @$pb.TagNumber(2)
  set httpBody($1.HttpBody v) { setField(2, v); }
  @$pb.TagNumber(2)
...
class ExplainRequest extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'ExplainRequest', package: const $pb.PackageName(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'google.cloud.aiplatform.v1beta1'), createEmptyInstance: create)
    ..aOS(1, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'endpoint')
    ..pc<$2.Value>(2, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'instances', $pb.PbFieldType.PM, subBuilder: $2.Value.create)
    ..aOS(3, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'deployedModelId')
    ..aOM<$2.Value>(4, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'parameters', subBuilder: $2.Value.create)
    ..aOM<$3.ExplanationSpecOverride>(5, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'explanationSpecOverride', subBuilder: $3.ExplanationSpecOverride.create)
    ..hasRequiredFields = false
  ;
  ...
  'Use [GeneratedMessageGenericExtensions.rebuild] instead. '
  'Will be removed in next major version')
  ExplainRequest copyWith(void Function(ExplainRequest) updates) => super.copyWith((message) => updates(message as ExplainRequest)) as ExplainRequest; // ignore: deprecated_member_use
  $pb.BuilderInfo get info_ => _i;
  @$core.pragma('dart2js:noInline')
  ...
  @$pb.TagNumber(4)
  set parameters($2.Value v) { setField(4, v); }
  @$pb.TagNumber(4)
  ...
  @$pb.TagNumber(5)
  set explanationSpecOverride($3.ExplanationSpecOverride v) { setField(5, v); }
  @$pb.TagNumber(5)
...
class ExplainResponse extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'ExplainResponse', package: const $pb.PackageName(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'google.cloud.aiplatform.v1beta1'), createEmptyInstance: create)
    ..pc<$3.Explanation>(1, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'explanations', $pb.PbFieldType.PM, subBuilder: $3.Explanation.create)
    ..aOS(2, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'deployedModelId')
    ..pc<$2.Value>(3, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'predictions', $pb.PbFieldType.PM, subBuilder: $2.Value.create)
    ..hasRequiredFields = false
  ;
  ...
  'Use [GeneratedMessageGenericExtensions.rebuild] instead. '
  'Will be removed in next major version')
  ExplainResponse copyWith(void Function(ExplainResponse) updates) => super.copyWith((message) => updates(message as ExplainResponse)) as ExplainResponse; // ignore: deprecated_member_use
  $pb.BuilderInfo get info_ => _i;
  @$core.pragma('dart2js:noInline')

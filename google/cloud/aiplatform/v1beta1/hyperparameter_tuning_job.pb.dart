...
class HyperparameterTuningJob extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'HyperparameterTuningJob', package: const $pb.PackageName(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'google.cloud.aiplatform.v1beta1'), createEmptyInstance: create)
    ..aOS(1, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'name')
    ..aOS(2, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'displayName')
    ..aOM<$0.StudySpec>(4, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'studySpec', subBuilder: $0.StudySpec.create)
    ..a<$core.int>(5, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'maxTrialCount', $pb.PbFieldType.O3)
    ..a<$core.int>(6, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'parallelTrialCount', $pb.PbFieldType.O3)
    ..a<$core.int>(7, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'maxFailedTrialCount', $pb.PbFieldType.O3)
    ..aOM<$1.CustomJobSpec>(8, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'trialJobSpec', subBuilder: $1.CustomJobSpec.create)
    ..pc<$0.Trial>(9, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'trials', $pb.PbFieldType.PM, subBuilder: $0.Trial.create)
    ..e<$5.JobState>(10, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'state', $pb.PbFieldType.OE, defaultOrMaker: $5.JobState.JOB_STATE_UNSPECIFIED, valueOf: $5.JobState.valueOf, enumValues: $5.JobState.values)
    ..aOM<$2.Timestamp>(11, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'createTime', subBuilder: $2.Timestamp.create)
    ..aOM<$2.Timestamp>(12, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'startTime', subBuilder: $2.Timestamp.create)
    ...
    ..m<$core.String, $core.String>(16, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'labels', entryClassName: 'HyperparameterTuningJob.LabelsEntry', keyFieldType: $pb.PbFieldType.OS, valueFieldType: $pb.PbFieldType.OS, packageName: const $pb.PackageName('google.cloud.aiplatform.v1beta1'))
    ..aOM<$4.EncryptionSpec>(17, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'encryptionSpec', subBuilder: $4.EncryptionSpec.create)
  ...
  'Will be removed in next major version')
  HyperparameterTuningJob copyWith(void Function(HyperparameterTuningJob) updates) => super.copyWith((message) => updates(message as HyperparameterTuningJob)) as HyperparameterTuningJob; // ignore: deprecated_member_use
  ...
  @$pb.TagNumber(4)
  set studySpec($0.StudySpec v) { setField(4, v); }
  @$pb.TagNumber(4)
  ...
  @$pb.TagNumber(8)
  set trialJobSpec($1.CustomJobSpec v) { setField(8, v); }
  @$pb.TagNumber(8)
  ...
  @$pb.TagNumber(10)
  set state($5.JobState v) { setField(10, v); }
  @$pb.TagNumber(10)
  ...
  @$pb.TagNumber(12)
  set startTime($2.Timestamp v) { setField(12, v); }
  @$pb.TagNumber(12)
  ...
  @$pb.TagNumber(17)
  set encryptionSpec($4.EncryptionSpec v) { setField(17, v); }
  @$pb.TagNumber(17)

...
const GenericOperationMetadata$json = const {
  ...
  '2': const [
    const {'1': 'partial_failures', '3': 1, '4': 3, '5': 11, '6': '.google.rpc.Status', '8': const {}, '10': 'partialFailures'},
...
final $typed_data.Uint8List genericOperationMetadataDescriptor = $convert.base64Decode('');
...
final $typed_data.Uint8List deleteOperationMetadataDescriptor = $convert.base64Decode('ChdEZWxldGVPcGVyYXRpb25NZXRhZGF0YRJkChBnZW5lcmljX21ldGFkYXRhGAEgASgLMjkuZ29vZ2xlLmNsb3VkLmFpcGxhdGZvcm0udjFiZXRhMS5HZW5lcmljT3BlcmF0aW9uTWV0YWRhdGFSD2dlbmVyaWNNZXRhZGF0YQ==');

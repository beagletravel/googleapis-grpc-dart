...
class PipelineJob_RuntimeConfig extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'PipelineJob.RuntimeConfig', package: const $pb.PackageName(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'google.cloud.aiplatform.v1beta1'), createEmptyInstance: create)
    ..m<$core.String, $4.Value>(1, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'parameters', entryClassName: 'PipelineJob.RuntimeConfig.ParametersEntry', keyFieldType: $pb.PbFieldType.OS, valueFieldType: $pb.PbFieldType.OM, valueCreator: $4.Value.create, packageName: const $pb.PackageName('google.cloud.aiplatform.v1beta1'))
    ..aOS(2, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'gcsOutputDirectory')
    ..m<$core.String, $1.Value>(3, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'parameterValues', entryClassName: 'PipelineJob.RuntimeConfig.ParameterValuesEntry', keyFieldType: $pb.PbFieldType.OS, valueFieldType: $pb.PbFieldType.OM, valueCreator: $1.Value.create, packageName: const $pb.PackageName('google.cloud.aiplatform.v1beta1'))
  ...
  'Will be removed in next major version')
  PipelineJob_RuntimeConfig copyWith(void Function(PipelineJob_RuntimeConfig) updates) => super.copyWith((message) => updates(message as PipelineJob_RuntimeConfig)) as PipelineJob_RuntimeConfig; // ignore: deprecated_member_use
...
class PipelineJob extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'PipelineJob', package: const $pb.PackageName(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'google.cloud.aiplatform.v1beta1'), createEmptyInstance: create)
    ...
    ..aOM<$0.Timestamp>(4, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'startTime', subBuilder: $0.Timestamp.create)
    ..aOM<$0.Timestamp>(5, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'endTime', subBuilder: $0.Timestamp.create)
    ..aOM<$0.Timestamp>(6, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'updateTime', subBuilder: $0.Timestamp.create)
    ..aOM<$1.Struct>(7, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'pipelineSpec', subBuilder: $1.Struct.create)
    ..e<$8.PipelineState>(8, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'state', $pb.PbFieldType.OE, defaultOrMaker: $8.PipelineState.PIPELINE_STATE_UNSPECIFIED, valueOf: $8.PipelineState.valueOf, enumValues: $8.PipelineState.values)
    ..aOM<PipelineJobDetail>(9, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'jobDetail', subBuilder: PipelineJobDetail.create)
    ..aOM<$2.Status>(10, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'error', subBuilder: $2.Status.create)
    ..m<$core.String, $core.String>(11, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'labels', entryClassName: 'PipelineJob.LabelsEntry', keyFieldType: $pb.PbFieldType.OS, valueFieldType: $pb.PbFieldType.OS, packageName: const $pb.PackageName('google.cloud.aiplatform.v1beta1'))
    ..aOM<PipelineJob_RuntimeConfig>(12, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'runtimeConfig', subBuilder: PipelineJob_RuntimeConfig.create)
    ..aOM<$3.EncryptionSpec>(16, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'encryptionSpec', subBuilder: $3.EncryptionSpec.create)
    ...
    ..aOS(19, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'templateUri')
    ..aOM<PipelineTemplateMetadata>(20, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'templateMetadata', subBuilder: PipelineTemplateMetadata.create)
    ..hasRequiredFields = false
  ;
  ...
  factory PipelineJob({
    ...
    if (templateUri != null) {
      _result.templateUri = templateUri;
    }
    if (templateMetadata != null) {
      _result.templateMetadata = templateMetadata;
    }
    return _result;
  }
  ...
  'Use [GeneratedMessageGenericExtensions.rebuild] instead. '
  'Will be removed in next major version')
  PipelineJob copyWith(void Function(PipelineJob) updates) => super.copyWith((message) => updates(message as PipelineJob)) as PipelineJob; // ignore: deprecated_member_use
  $pb.BuilderInfo get info_ => _i;
  @$core.pragma('dart2js:noInline')
  ...
  @$pb.TagNumber(7)
  set pipelineSpec($1.Struct v) { setField(7, v); }
  @$pb.TagNumber(7)
  ...
  @$pb.TagNumber(8)
  set state($8.PipelineState v) { setField(8, v); }
  @$pb.TagNumber(8)
  ...
  @$pb.TagNumber(10)
  set error($2.Status v) { setField(10, v); }
  @$pb.TagNumber(10)
  ...
  @$pb.TagNumber(16)
  set encryptionSpec($3.EncryptionSpec v) { setField(16, v); }
  @$pb.TagNumber(16)
...
class PipelineTemplateMetadata extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'PipelineTemplateMetadata', package: const $pb.PackageName(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'google.cloud.aiplatform.v1beta1'), createEmptyInstance: create)
  ...
  'Use [GeneratedMessageGenericExtensions.rebuild] instead. '
  'Will be removed in next major version')
  PipelineTemplateMetadata copyWith(void Function(PipelineTemplateMetadata) updates) => super.copyWith((message) => updates(message as PipelineTemplateMetadata)) as PipelineTemplateMetadata; // ignore: deprecated_member_use
  $pb.BuilderInfo get info_ => _i;
  @$core.pragma('dart2js:noInline')
...
class PipelineJobDetail extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'PipelineJobDetail', package: const $pb.PackageName(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'google.cloud.aiplatform.v1beta1'), createEmptyInstance: create)
    ..aOM<$5.Context>(1, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'pipelineContext', subBuilder: $5.Context.create)
    ..aOM<$5.Context>(2, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'pipelineRunContext', subBuilder: $5.Context.create)
    ..pc<PipelineTaskDetail>(3, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'taskDetails', $pb.PbFieldType.PM, subBuilder: PipelineTaskDetail.create)
    ..hasRequiredFields = false
  ;
  ...
  'Use [GeneratedMessageGenericExtensions.rebuild] instead. '
  'Will be removed in next major version')
  PipelineJobDetail copyWith(void Function(PipelineJobDetail) updates) => super.copyWith((message) => updates(message as PipelineJobDetail)) as PipelineJobDetail; // ignore: deprecated_member_use
  $pb.BuilderInfo get info_ => _i;
  @$core.pragma('dart2js:noInline')
  ...
  @$pb.TagNumber(1)
  set pipelineContext($5.Context v) { setField(1, v); }
  @$pb.TagNumber(1)
  ...
  @$pb.TagNumber(2)
  set pipelineRunContext($5.Context v) { setField(2, v); }
  @$pb.TagNumber(2)
...
class PipelineTaskDetail_PipelineTaskStatus extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'PipelineTaskDetail.PipelineTaskStatus', package: const $pb.PackageName(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'google.cloud.aiplatform.v1beta1'), createEmptyInstance: create)
    ..aOM<$0.Timestamp>(1, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'updateTime', subBuilder: $0.Timestamp.create)
    ..e<PipelineTaskDetail_State>(2, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'state', $pb.PbFieldType.OE, defaultOrMaker: PipelineTaskDetail_State.STATE_UNSPECIFIED, valueOf: PipelineTaskDetail_State.valueOf, enumValues: PipelineTaskDetail_State.values)
    ..aOM<$2.Status>(3, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'error', subBuilder: $2.Status.create)
    ..hasRequiredFields = false
  ;
  ...
  'Use [GeneratedMessageGenericExtensions.rebuild] instead. '
  'Will be removed in next major version')
  PipelineTaskDetail_PipelineTaskStatus copyWith(void Function(PipelineTaskDetail_PipelineTaskStatus) updates) => super.copyWith((message) => updates(message as PipelineTaskDetail_PipelineTaskStatus)) as PipelineTaskDetail_PipelineTaskStatus; // ignore: deprecated_member_use
  $pb.BuilderInfo get info_ => _i;
  @$core.pragma('dart2js:noInline')
  ...
  @$pb.TagNumber(3)
  set error($2.Status v) { setField(3, v); }
  @$pb.TagNumber(3)
...
class PipelineTaskDetail_ArtifactList extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'PipelineTaskDetail.ArtifactList', package: const $pb.PackageName(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'google.cloud.aiplatform.v1beta1'), createEmptyInstance: create)
    ..pc<$7.Artifact>(1, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'artifacts', $pb.PbFieldType.PM, subBuilder: $7.Artifact.create)
    ..hasRequiredFields = false
  ;
  ...
  'Use [GeneratedMessageGenericExtensions.rebuild] instead. '
  'Will be removed in next major version')
  PipelineTaskDetail_ArtifactList copyWith(void Function(PipelineTaskDetail_ArtifactList) updates) => super.copyWith((message) => updates(message as PipelineTaskDetail_ArtifactList)) as PipelineTaskDetail_ArtifactList; // ignore: deprecated_member_use
  $pb.BuilderInfo get info_ => _i;
  @$core.pragma('dart2js:noInline')
...
class PipelineTaskDetail extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'PipelineTaskDetail', package: const $pb.PackageName(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'google.cloud.aiplatform.v1beta1'), createEmptyInstance: create)
    ..aInt64(1, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'taskId')
    ..aOS(2, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'taskName')
    ..aOM<$0.Timestamp>(3, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'createTime', subBuilder: $0.Timestamp.create)
    ..aOM<$0.Timestamp>(4, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'startTime', subBuilder: $0.Timestamp.create)
    ..aOM<$0.Timestamp>(5, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'endTime', subBuilder: $0.Timestamp.create)
    ..aOM<PipelineTaskExecutorDetail>(6, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'executorDetail', subBuilder: PipelineTaskExecutorDetail.create)
    ..e<PipelineTaskDetail_State>(7, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'state', $pb.PbFieldType.OE, defaultOrMaker: PipelineTaskDetail_State.STATE_UNSPECIFIED, valueOf: PipelineTaskDetail_State.valueOf, enumValues: PipelineTaskDetail_State.values)
    ..aOM<$6.Execution>(8, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'execution', subBuilder: $6.Execution.create)
    ..aOM<$2.Status>(9, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'error', subBuilder: $2.Status.create)
    ..m<$core.String, PipelineTaskDetail_ArtifactList>(10, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'inputs', entryClassName: 'PipelineTaskDetail.InputsEntry', keyFieldType: $pb.PbFieldType.OS, valueFieldType: $pb.PbFieldType.OM, valueCreator: PipelineTaskDetail_ArtifactList.create, packageName: const $pb.PackageName('google.cloud.aiplatform.v1beta1'))
    ..m<$core.String, PipelineTaskDetail_ArtifactList>(11, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'outputs', entryClassName: 'PipelineTaskDetail.OutputsEntry', keyFieldType: $pb.PbFieldType.OS, valueFieldType: $pb.PbFieldType.OM, valueCreator: PipelineTaskDetail_ArtifactList.create, packageName: const $pb.PackageName('google.cloud.aiplatform.v1beta1'))
    ..aInt64(12, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'parentTaskId')
    ..pc<PipelineTaskDetail_PipelineTaskStatus>(13, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'pipelineTaskStatus', $pb.PbFieldType.PM, subBuilder: PipelineTaskDetail_PipelineTaskStatus.create)
    ..hasRequiredFields = false
  ;
  ...
  'Use [GeneratedMessageGenericExtensions.rebuild] instead. '
  'Will be removed in next major version')
  PipelineTaskDetail copyWith(void Function(PipelineTaskDetail) updates) => super.copyWith((message) => updates(message as PipelineTaskDetail)) as PipelineTaskDetail; // ignore: deprecated_member_use
  $pb.BuilderInfo get info_ => _i;
  @$core.pragma('dart2js:noInline')
  ...
  @$pb.TagNumber(8)
  set execution($6.Execution v) { setField(8, v); }
  @$pb.TagNumber(8)
  ...
  @$pb.TagNumber(9)
  set error($2.Status v) { setField(9, v); }
  @$pb.TagNumber(9)
...
class PipelineTaskExecutorDetail_ContainerDetail extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'PipelineTaskExecutorDetail.ContainerDetail', package: const $pb.PackageName(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'google.cloud.aiplatform.v1beta1'), createEmptyInstance: create)
    ..aOS(1, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'mainJob')
    ..aOS(2, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'preCachingCheckJob')
    ..hasRequiredFields = false
  ;
  ...
  'Use [GeneratedMessageGenericExtensions.rebuild] instead. '
  'Will be removed in next major version')
  PipelineTaskExecutorDetail_ContainerDetail copyWith(void Function(PipelineTaskExecutorDetail_ContainerDetail) updates) => super.copyWith((message) => updates(message as PipelineTaskExecutorDetail_ContainerDetail)) as PipelineTaskExecutorDetail_ContainerDetail; // ignore: deprecated_member_use
  $pb.BuilderInfo get info_ => _i;
  @$core.pragma('dart2js:noInline')
...
class PipelineTaskExecutorDetail_CustomJobDetail extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'PipelineTaskExecutorDetail.CustomJobDetail', package: const $pb.PackageName(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'google.cloud.aiplatform.v1beta1'), createEmptyInstance: create)
    ..aOS(1, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'job')
    ..hasRequiredFields = false
  ;
  ...
  'Use [GeneratedMessageGenericExtensions.rebuild] instead. '
  'Will be removed in next major version')
  PipelineTaskExecutorDetail_CustomJobDetail copyWith(void Function(PipelineTaskExecutorDetail_CustomJobDetail) updates) => super.copyWith((message) => updates(message as PipelineTaskExecutorDetail_CustomJobDetail)) as PipelineTaskExecutorDetail_CustomJobDetail; // ignore: deprecated_member_use
  $pb.BuilderInfo get info_ => _i;
  @$core.pragma('dart2js:noInline')
...
class PipelineTaskExecutorDetail extends $pb.GeneratedMessage {
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'PipelineTaskExecutorDetail', package: const $pb.PackageName(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'google.cloud.aiplatform.v1beta1'), createEmptyInstance: create)
    ..oo(0, [1, 2])
    ..aOM<PipelineTaskExecutorDetail_ContainerDetail>(1, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'containerDetail', subBuilder: PipelineTaskExecutorDetail_ContainerDetail.create)
    ..aOM<PipelineTaskExecutorDetail_CustomJobDetail>(2, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'customJobDetail', subBuilder: PipelineTaskExecutorDetail_CustomJobDetail.create)
    ..hasRequiredFields = false
  ;
  ...
  'Use [GeneratedMessageGenericExtensions.rebuild] instead. '
  'Will be removed in next major version')
  PipelineTaskExecutorDetail copyWith(void Function(PipelineTaskExecutorDetail) updates) => super.copyWith((message) => updates(message as PipelineTaskExecutorDetail)) as PipelineTaskExecutorDetail; // ignore: deprecated_member_use
  $pb.BuilderInfo get info_ => _i;
  @$core.pragma('dart2js:noInline')

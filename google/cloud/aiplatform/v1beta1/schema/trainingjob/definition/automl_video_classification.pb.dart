...
class AutoMlVideoClassification extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'AutoMlVideoClassification', package: const $pb.PackageName(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'google.cloud.aiplatform.v1beta1.schema.trainingjob.definition'), createEmptyInstance: create)
    ..aOM<AutoMlVideoClassificationInputs>(1, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'inputs', subBuilder: AutoMlVideoClassificationInputs.create)
  ...
  'Will be removed in next major version')
  AutoMlVideoClassification copyWith(void Function(AutoMlVideoClassification) updates) => super.copyWith((message) => updates(message as AutoMlVideoClassification)) as AutoMlVideoClassification; // ignore: deprecated_member_use
...
class AutoMlVideoClassificationInputs extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'AutoMlVideoClassificationInputs', package: const $pb.PackageName(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'google.cloud.aiplatform.v1beta1.schema.trainingjob.definition'), createEmptyInstance: create)
    ..e<AutoMlVideoClassificationInputs_ModelType>(1, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'modelType', $pb.PbFieldType.OE, defaultOrMaker: AutoMlVideoClassificationInputs_ModelType.MODEL_TYPE_UNSPECIFIED, valueOf: AutoMlVideoClassificationInputs_ModelType.valueOf, enumValues: AutoMlVideoClassificationInputs_ModelType.values)
    ..hasRequiredFields = false
  ;
  ...
  'Use [GeneratedMessageGenericExtensions.rebuild] instead. '
  'Will be removed in next major version')
  AutoMlVideoClassificationInputs copyWith(void Function(AutoMlVideoClassificationInputs) updates) => super.copyWith((message) => updates(message as AutoMlVideoClassificationInputs)) as AutoMlVideoClassificationInputs; // ignore: deprecated_member_use
  $pb.BuilderInfo get info_ => _i;
  @$core.pragma('dart2js:noInline')

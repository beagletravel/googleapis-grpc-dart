...
const AutoMlTextClassification$json = const {
  ...
  '2': const [
    const {'1': 'inputs', '3': 1, '4': 1, '5': 11, '6': '.google.cloud.aiplatform.v1beta1.schema.trainingjob.definition.AutoMlTextClassificationInputs', '10': 'inputs'},
  ],
};

/// Descriptor for `AutoMlTextClassification`. Decode as a `google.protobuf.DescriptorProto`.
final $typed_data.Uint8List autoMlTextClassificationDescriptor = $convert.base64Decode('ChhBdXRvTWxUZXh0Q2xhc3NpZmljYXRpb24SdQoGaW5wdXRzGAEgASgLMl0uZ29vZ2xlLmNsb3VkLmFpcGxhdGZvcm0udjFiZXRhMS5zY2hlbWEudHJhaW5pbmdqb2IuZGVmaW5pdGlvbi5BdXRvTWxUZXh0Q2xhc3NpZmljYXRpb25JbnB1dHNSBmlucHV0cw==');
...
final $typed_data.Uint8List autoMlTextClassificationInputsDescriptor = $convert.base64Decode('Ch5BdXRvTWxUZXh0Q2xhc3NpZmljYXRpb25JbnB1dHMSHwoLbXVsdGlfbGFiZWwYASABKAhSCm11bHRpTGFiZWw=');

...
class AutoMlVideoActionRecognition extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'AutoMlVideoActionRecognition', package: const $pb.PackageName(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'google.cloud.aiplatform.v1beta1.schema.trainingjob.definition'), createEmptyInstance: create)
    ..aOM<AutoMlVideoActionRecognitionInputs>(1, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'inputs', subBuilder: AutoMlVideoActionRecognitionInputs.create)
  ...
  'Will be removed in next major version')
  AutoMlVideoActionRecognition copyWith(void Function(AutoMlVideoActionRecognition) updates) => super.copyWith((message) => updates(message as AutoMlVideoActionRecognition)) as AutoMlVideoActionRecognition; // ignore: deprecated_member_use
...
class AutoMlVideoActionRecognitionInputs extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'AutoMlVideoActionRecognitionInputs', package: const $pb.PackageName(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'google.cloud.aiplatform.v1beta1.schema.trainingjob.definition'), createEmptyInstance: create)
    ..e<AutoMlVideoActionRecognitionInputs_ModelType>(1, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'modelType', $pb.PbFieldType.OE, defaultOrMaker: AutoMlVideoActionRecognitionInputs_ModelType.MODEL_TYPE_UNSPECIFIED, valueOf: AutoMlVideoActionRecognitionInputs_ModelType.valueOf, enumValues: AutoMlVideoActionRecognitionInputs_ModelType.values)
    ..hasRequiredFields = false
  ;
  ...
  'Use [GeneratedMessageGenericExtensions.rebuild] instead. '
  'Will be removed in next major version')
  AutoMlVideoActionRecognitionInputs copyWith(void Function(AutoMlVideoActionRecognitionInputs) updates) => super.copyWith((message) => updates(message as AutoMlVideoActionRecognitionInputs)) as AutoMlVideoActionRecognitionInputs; // ignore: deprecated_member_use
  $pb.BuilderInfo get info_ => _i;
  @$core.pragma('dart2js:noInline')

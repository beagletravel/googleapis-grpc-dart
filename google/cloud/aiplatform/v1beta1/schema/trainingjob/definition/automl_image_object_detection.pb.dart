...
class AutoMlImageObjectDetection extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'AutoMlImageObjectDetection', package: const $pb.PackageName(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'google.cloud.aiplatform.v1beta1.schema.trainingjob.definition'), createEmptyInstance: create)
    ..aOM<AutoMlImageObjectDetectionInputs>(1, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'inputs', subBuilder: AutoMlImageObjectDetectionInputs.create)
    ..aOM<AutoMlImageObjectDetectionMetadata>(2, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'metadata', subBuilder: AutoMlImageObjectDetectionMetadata.create)
  ...
  'Will be removed in next major version')
  AutoMlImageObjectDetection copyWith(void Function(AutoMlImageObjectDetection) updates) => super.copyWith((message) => updates(message as AutoMlImageObjectDetection)) as AutoMlImageObjectDetection; // ignore: deprecated_member_use
...
class AutoMlImageObjectDetectionInputs extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'AutoMlImageObjectDetectionInputs', package: const $pb.PackageName(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'google.cloud.aiplatform.v1beta1.schema.trainingjob.definition'), createEmptyInstance: create)
    ..e<AutoMlImageObjectDetectionInputs_ModelType>(1, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'modelType', $pb.PbFieldType.OE, defaultOrMaker: AutoMlImageObjectDetectionInputs_ModelType.MODEL_TYPE_UNSPECIFIED, valueOf: AutoMlImageObjectDetectionInputs_ModelType.valueOf, enumValues: AutoMlImageObjectDetectionInputs_ModelType.values)
    ..aInt64(2, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'budgetMilliNodeHours')
    ..aOB(3, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'disableEarlyStopping')
    ..hasRequiredFields = false
  ;
  ...
  'Use [GeneratedMessageGenericExtensions.rebuild] instead. '
  'Will be removed in next major version')
  AutoMlImageObjectDetectionInputs copyWith(void Function(AutoMlImageObjectDetectionInputs) updates) => super.copyWith((message) => updates(message as AutoMlImageObjectDetectionInputs)) as AutoMlImageObjectDetectionInputs; // ignore: deprecated_member_use
  $pb.BuilderInfo get info_ => _i;
  @$core.pragma('dart2js:noInline')
...
class AutoMlImageObjectDetectionMetadata extends $pb.GeneratedMessage {
  ...
  'Use [GeneratedMessageGenericExtensions.rebuild] instead. '
  'Will be removed in next major version')
  AutoMlImageObjectDetectionMetadata copyWith(void Function(AutoMlImageObjectDetectionMetadata) updates) => super.copyWith((message) => updates(message as AutoMlImageObjectDetectionMetadata)) as AutoMlImageObjectDetectionMetadata; // ignore: deprecated_member_use
  $pb.BuilderInfo get info_ => _i;
  @$core.pragma('dart2js:noInline')

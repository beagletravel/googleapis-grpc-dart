...
class ExportEvaluatedDataItemsConfig extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'ExportEvaluatedDataItemsConfig', package: const $pb.PackageName(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'google.cloud.aiplatform.v1beta1.schema.trainingjob.definition'), createEmptyInstance: create)
    ..aOS(1, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'destinationBigqueryUri')
    ..aOB(2, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'overrideExistingTable')
  ...
  'Will be removed in next major version')
  ExportEvaluatedDataItemsConfig copyWith(void Function(ExportEvaluatedDataItemsConfig) updates) => super.copyWith((message) => updates(message as ExportEvaluatedDataItemsConfig)) as ExportEvaluatedDataItemsConfig; // ignore: deprecated_member_use

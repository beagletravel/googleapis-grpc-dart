...
class AutoMlImageSegmentation extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'AutoMlImageSegmentation', package: const $pb.PackageName(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'google.cloud.aiplatform.v1beta1.schema.trainingjob.definition'), createEmptyInstance: create)
    ..aOM<AutoMlImageSegmentationInputs>(1, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'inputs', subBuilder: AutoMlImageSegmentationInputs.create)
    ..aOM<AutoMlImageSegmentationMetadata>(2, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'metadata', subBuilder: AutoMlImageSegmentationMetadata.create)
  ...
  'Will be removed in next major version')
  AutoMlImageSegmentation copyWith(void Function(AutoMlImageSegmentation) updates) => super.copyWith((message) => updates(message as AutoMlImageSegmentation)) as AutoMlImageSegmentation; // ignore: deprecated_member_use
...
class AutoMlImageSegmentationInputs extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'AutoMlImageSegmentationInputs', package: const $pb.PackageName(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'google.cloud.aiplatform.v1beta1.schema.trainingjob.definition'), createEmptyInstance: create)
    ..e<AutoMlImageSegmentationInputs_ModelType>(1, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'modelType', $pb.PbFieldType.OE, defaultOrMaker: AutoMlImageSegmentationInputs_ModelType.MODEL_TYPE_UNSPECIFIED, valueOf: AutoMlImageSegmentationInputs_ModelType.valueOf, enumValues: AutoMlImageSegmentationInputs_ModelType.values)
    ..aInt64(2, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'budgetMilliNodeHours')
    ..aOS(3, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'baseModelId')
    ..hasRequiredFields = false
  ;
  ...
  'Use [GeneratedMessageGenericExtensions.rebuild] instead. '
  'Will be removed in next major version')
  AutoMlImageSegmentationInputs copyWith(void Function(AutoMlImageSegmentationInputs) updates) => super.copyWith((message) => updates(message as AutoMlImageSegmentationInputs)) as AutoMlImageSegmentationInputs; // ignore: deprecated_member_use
  $pb.BuilderInfo get info_ => _i;
  @$core.pragma('dart2js:noInline')
...
class AutoMlImageSegmentationMetadata extends $pb.GeneratedMessage {
  ...
  'Use [GeneratedMessageGenericExtensions.rebuild] instead. '
  'Will be removed in next major version')
  AutoMlImageSegmentationMetadata copyWith(void Function(AutoMlImageSegmentationMetadata) updates) => super.copyWith((message) => updates(message as AutoMlImageSegmentationMetadata)) as AutoMlImageSegmentationMetadata; // ignore: deprecated_member_use
  $pb.BuilderInfo get info_ => _i;
  @$core.pragma('dart2js:noInline')

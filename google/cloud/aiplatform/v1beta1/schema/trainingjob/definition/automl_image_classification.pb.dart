...
class AutoMlImageClassification extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'AutoMlImageClassification', package: const $pb.PackageName(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'google.cloud.aiplatform.v1beta1.schema.trainingjob.definition'), createEmptyInstance: create)
    ..aOM<AutoMlImageClassificationInputs>(1, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'inputs', subBuilder: AutoMlImageClassificationInputs.create)
    ..aOM<AutoMlImageClassificationMetadata>(2, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'metadata', subBuilder: AutoMlImageClassificationMetadata.create)
  ...
  'Will be removed in next major version')
  AutoMlImageClassification copyWith(void Function(AutoMlImageClassification) updates) => super.copyWith((message) => updates(message as AutoMlImageClassification)) as AutoMlImageClassification; // ignore: deprecated_member_use
...
class AutoMlImageClassificationInputs extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'AutoMlImageClassificationInputs', package: const $pb.PackageName(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'google.cloud.aiplatform.v1beta1.schema.trainingjob.definition'), createEmptyInstance: create)
    ..e<AutoMlImageClassificationInputs_ModelType>(1, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'modelType', $pb.PbFieldType.OE, defaultOrMaker: AutoMlImageClassificationInputs_ModelType.MODEL_TYPE_UNSPECIFIED, valueOf: AutoMlImageClassificationInputs_ModelType.valueOf, enumValues: AutoMlImageClassificationInputs_ModelType.values)
    ..aOS(2, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'baseModelId')
    ..aInt64(3, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'budgetMilliNodeHours')
    ..aOB(4, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'disableEarlyStopping')
    ..aOB(5, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'multiLabel')
    ..hasRequiredFields = false
  ;
  ...
  'Use [GeneratedMessageGenericExtensions.rebuild] instead. '
  'Will be removed in next major version')
  AutoMlImageClassificationInputs copyWith(void Function(AutoMlImageClassificationInputs) updates) => super.copyWith((message) => updates(message as AutoMlImageClassificationInputs)) as AutoMlImageClassificationInputs; // ignore: deprecated_member_use
  $pb.BuilderInfo get info_ => _i;
  @$core.pragma('dart2js:noInline')
...
class AutoMlImageClassificationMetadata extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'AutoMlImageClassificationMetadata', package: const $pb.PackageName(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'google.cloud.aiplatform.v1beta1.schema.trainingjob.definition'), createEmptyInstance: create)
    ..aInt64(1, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'costMilliNodeHours')
    ..e<AutoMlImageClassificationMetadata_SuccessfulStopReason>(2, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'successfulStopReason', $pb.PbFieldType.OE, defaultOrMaker: AutoMlImageClassificationMetadata_SuccessfulStopReason.SUCCESSFUL_STOP_REASON_UNSPECIFIED, valueOf: AutoMlImageClassificationMetadata_SuccessfulStopReason.valueOf, enumValues: AutoMlImageClassificationMetadata_SuccessfulStopReason.values)
    ..hasRequiredFields = false
  ;
  ...
  'Use [GeneratedMessageGenericExtensions.rebuild] instead. '
  'Will be removed in next major version')
  AutoMlImageClassificationMetadata copyWith(void Function(AutoMlImageClassificationMetadata) updates) => super.copyWith((message) => updates(message as AutoMlImageClassificationMetadata)) as AutoMlImageClassificationMetadata; // ignore: deprecated_member_use
  $pb.BuilderInfo get info_ => _i;
  @$core.pragma('dart2js:noInline')

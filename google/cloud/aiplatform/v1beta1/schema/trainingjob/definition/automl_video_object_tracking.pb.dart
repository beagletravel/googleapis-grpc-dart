...
class AutoMlVideoObjectTracking extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'AutoMlVideoObjectTracking', package: const $pb.PackageName(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'google.cloud.aiplatform.v1beta1.schema.trainingjob.definition'), createEmptyInstance: create)
    ..aOM<AutoMlVideoObjectTrackingInputs>(1, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'inputs', subBuilder: AutoMlVideoObjectTrackingInputs.create)
  ...
  'Will be removed in next major version')
  AutoMlVideoObjectTracking copyWith(void Function(AutoMlVideoObjectTracking) updates) => super.copyWith((message) => updates(message as AutoMlVideoObjectTracking)) as AutoMlVideoObjectTracking; // ignore: deprecated_member_use
...
class AutoMlVideoObjectTrackingInputs extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'AutoMlVideoObjectTrackingInputs', package: const $pb.PackageName(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'google.cloud.aiplatform.v1beta1.schema.trainingjob.definition'), createEmptyInstance: create)
    ..e<AutoMlVideoObjectTrackingInputs_ModelType>(1, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'modelType', $pb.PbFieldType.OE, defaultOrMaker: AutoMlVideoObjectTrackingInputs_ModelType.MODEL_TYPE_UNSPECIFIED, valueOf: AutoMlVideoObjectTrackingInputs_ModelType.valueOf, enumValues: AutoMlVideoObjectTrackingInputs_ModelType.values)
    ..hasRequiredFields = false
  ;
  ...
  'Use [GeneratedMessageGenericExtensions.rebuild] instead. '
  'Will be removed in next major version')
  AutoMlVideoObjectTrackingInputs copyWith(void Function(AutoMlVideoObjectTrackingInputs) updates) => super.copyWith((message) => updates(message as AutoMlVideoObjectTrackingInputs)) as AutoMlVideoObjectTrackingInputs; // ignore: deprecated_member_use
  $pb.BuilderInfo get info_ => _i;
  @$core.pragma('dart2js:noInline')

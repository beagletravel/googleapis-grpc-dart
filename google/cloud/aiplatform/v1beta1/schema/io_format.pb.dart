...
class PredictionResult_Error extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'PredictionResult.Error', package: const $pb.PackageName(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'google.cloud.aiplatform.v1beta1.schema'), createEmptyInstance: create)
    ..e<$1.Code>(1, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'status', $pb.PbFieldType.OE, defaultOrMaker: $1.Code.OK, valueOf: $1.Code.valueOf, enumValues: $1.Code.values)
  ...
  'Will be removed in next major version')
  PredictionResult_Error copyWith(void Function(PredictionResult_Error) updates) => super.copyWith((message) => updates(message as PredictionResult_Error)) as PredictionResult_Error; // ignore: deprecated_member_use
  ...
  @$pb.TagNumber(1)
  set status($1.Code v) { setField(1, v); }
  @$pb.TagNumber(1)
...
class PredictionResult extends $pb.GeneratedMessage {
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'PredictionResult', package: const $pb.PackageName(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'google.cloud.aiplatform.v1beta1.schema'), createEmptyInstance: create)
    ..oo(0, [1, 2])
    ..aOM<$0.Struct>(1, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'instance', subBuilder: $0.Struct.create)
    ..aOS(2, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'key')
    ..aOM<$0.Value>(3, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'prediction', subBuilder: $0.Value.create)
    ..aOM<PredictionResult_Error>(4, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'error', subBuilder: PredictionResult_Error.create)
    ..hasRequiredFields = false
  ;
  ...
  @$pb.TagNumber(1)
  set instance($0.Struct v) { setField(1, v); }
  @$pb.TagNumber(1)
  ...
  @$pb.TagNumber(3)
  set prediction($0.Value v) { setField(3, v); }
  @$pb.TagNumber(3)

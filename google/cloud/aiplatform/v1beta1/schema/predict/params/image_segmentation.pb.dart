...
class ImageSegmentationPredictionParams extends $pb.GeneratedMessage {
  ...
  'Will be removed in next major version')
  ImageSegmentationPredictionParams copyWith(void Function(ImageSegmentationPredictionParams) updates) => super.copyWith((message) => updates(message as ImageSegmentationPredictionParams)) as ImageSegmentationPredictionParams; // ignore: deprecated_member_use

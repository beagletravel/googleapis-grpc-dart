...
class VideoObjectTrackingPredictionParams extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'VideoObjectTrackingPredictionParams', package: const $pb.PackageName(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'google.cloud.aiplatform.v1beta1.schema.predict.params'), createEmptyInstance: create)
    ...
    ..a<$core.double>(3, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'minBoundingBoxSize', $pb.PbFieldType.OF)
  ...
  'Will be removed in next major version')
  VideoObjectTrackingPredictionParams copyWith(void Function(VideoObjectTrackingPredictionParams) updates) => super.copyWith((message) => updates(message as VideoObjectTrackingPredictionParams)) as VideoObjectTrackingPredictionParams; // ignore: deprecated_member_use

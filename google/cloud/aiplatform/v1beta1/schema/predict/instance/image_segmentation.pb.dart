...
class ImageSegmentationPredictionInstance extends $pb.GeneratedMessage {
  ...
  'Will be removed in next major version')
  ImageSegmentationPredictionInstance copyWith(void Function(ImageSegmentationPredictionInstance) updates) => super.copyWith((message) => updates(message as ImageSegmentationPredictionInstance)) as ImageSegmentationPredictionInstance; // ignore: deprecated_member_use

...
class TextExtractionPredictionInstance extends $pb.GeneratedMessage {
  ...
  'Will be removed in next major version')
  TextExtractionPredictionInstance copyWith(void Function(TextExtractionPredictionInstance) updates) => super.copyWith((message) => updates(message as TextExtractionPredictionInstance)) as TextExtractionPredictionInstance; // ignore: deprecated_member_use

...
class VideoObjectTrackingPredictionResult_Frame extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'VideoObjectTrackingPredictionResult.Frame', package: const $pb.PackageName(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'google.cloud.aiplatform.v1beta1.schema.predict.prediction'), createEmptyInstance: create)
    ..aOM<$0.Duration>(1, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'timeOffset', subBuilder: $0.Duration.create)
    ..aOM<$1.FloatValue>(2, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'xMin', subBuilder: $1.FloatValue.create)
    ..aOM<$1.FloatValue>(3, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'xMax', subBuilder: $1.FloatValue.create)
    ..aOM<$1.FloatValue>(4, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'yMin', subBuilder: $1.FloatValue.create)
    ..aOM<$1.FloatValue>(5, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'yMax', subBuilder: $1.FloatValue.create)
  ...
  'Will be removed in next major version')
  VideoObjectTrackingPredictionResult_Frame copyWith(void Function(VideoObjectTrackingPredictionResult_Frame) updates) => super.copyWith((message) => updates(message as VideoObjectTrackingPredictionResult_Frame)) as VideoObjectTrackingPredictionResult_Frame; // ignore: deprecated_member_use
  ...
  @$pb.TagNumber(2)
  set xMin($1.FloatValue v) { setField(2, v); }
  @$pb.TagNumber(2)
  ...
  @$pb.TagNumber(3)
  set xMax($1.FloatValue v) { setField(3, v); }
  @$pb.TagNumber(3)
  ...
  @$pb.TagNumber(4)
  set yMin($1.FloatValue v) { setField(4, v); }
  @$pb.TagNumber(4)
  ...
  @$pb.TagNumber(5)
  set yMax($1.FloatValue v) { setField(5, v); }
  @$pb.TagNumber(5)
...
class VideoObjectTrackingPredictionResult extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'VideoObjectTrackingPredictionResult', package: const $pb.PackageName(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'google.cloud.aiplatform.v1beta1.schema.predict.prediction'), createEmptyInstance: create)
    ..aOS(1, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'id')
    ..aOS(2, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'displayName')
    ..aOM<$0.Duration>(3, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'timeSegmentStart', subBuilder: $0.Duration.create)
    ..aOM<$0.Duration>(4, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'timeSegmentEnd', subBuilder: $0.Duration.create)
    ..aOM<$1.FloatValue>(5, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'confidence', subBuilder: $1.FloatValue.create)
    ..pc<VideoObjectTrackingPredictionResult_Frame>(6, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'frames', $pb.PbFieldType.PM, subBuilder: VideoObjectTrackingPredictionResult_Frame.create)
    ..hasRequiredFields = false
  ;
  ...
  'Use [GeneratedMessageGenericExtensions.rebuild] instead. '
  'Will be removed in next major version')
  VideoObjectTrackingPredictionResult copyWith(void Function(VideoObjectTrackingPredictionResult) updates) => super.copyWith((message) => updates(message as VideoObjectTrackingPredictionResult)) as VideoObjectTrackingPredictionResult; // ignore: deprecated_member_use
  $pb.BuilderInfo get info_ => _i;
  @$core.pragma('dart2js:noInline')
  ...
  @$pb.TagNumber(3)
  set timeSegmentStart($0.Duration v) { setField(3, v); }
  @$pb.TagNumber(3)
  ...
  @$pb.TagNumber(4)
  set timeSegmentEnd($0.Duration v) { setField(4, v); }
  @$pb.TagNumber(4)
  ...
  @$pb.TagNumber(5)
  set confidence($1.FloatValue v) { setField(5, v); }
  @$pb.TagNumber(5)

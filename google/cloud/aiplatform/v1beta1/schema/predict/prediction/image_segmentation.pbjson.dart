...
const ImageSegmentationPredictionResult$json = const {
  ...
  '2': const [
    ...
    const {'1': 'confidence_mask', '3': 2, '4': 1, '5': 9, '10': 'confidenceMask'},
  ],
};

/// Descriptor for `ImageSegmentationPredictionResult`. Decode as a `google.protobuf.DescriptorProto`.
final $typed_data.Uint8List imageSegmentationPredictionResultDescriptor = $convert.base64Decode('CiFJbWFnZVNlZ21lbnRhdGlvblByZWRpY3Rpb25SZXN1bHQSIwoNY2F0ZWdvcnlfbWFzaxgBIAEoCVIMY2F0ZWdvcnlNYXNrEicKD2NvbmZpZGVuY2VfbWFzaxgCIAEoCVIOY29uZmlkZW5jZU1hc2s=');

...
class ClassificationPredictionResult extends $pb.GeneratedMessage {
  ...
  'Will be removed in next major version')
  ClassificationPredictionResult copyWith(void Function(ClassificationPredictionResult) updates) => super.copyWith((message) => updates(message as ClassificationPredictionResult)) as ClassificationPredictionResult; // ignore: deprecated_member_use

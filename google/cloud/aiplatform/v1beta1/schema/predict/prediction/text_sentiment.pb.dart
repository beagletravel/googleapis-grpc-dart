...
class TextSentimentPredictionResult extends $pb.GeneratedMessage {
  ...
  'Will be removed in next major version')
  TextSentimentPredictionResult copyWith(void Function(TextSentimentPredictionResult) updates) => super.copyWith((message) => updates(message as TextSentimentPredictionResult)) as TextSentimentPredictionResult; // ignore: deprecated_member_use

...
class TabularRegressionPredictionResult extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'TabularRegressionPredictionResult', package: const $pb.PackageName(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'google.cloud.aiplatform.v1beta1.schema.predict.prediction'), createEmptyInstance: create)
    ..a<$core.double>(1, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'value', $pb.PbFieldType.OF)
    ..a<$core.double>(2, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'lowerBound', $pb.PbFieldType.OF)
    ..a<$core.double>(3, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'upperBound', $pb.PbFieldType.OF)
  ...
  'Will be removed in next major version')
  TabularRegressionPredictionResult copyWith(void Function(TabularRegressionPredictionResult) updates) => super.copyWith((message) => updates(message as TabularRegressionPredictionResult)) as TabularRegressionPredictionResult; // ignore: deprecated_member_use

...
class VideoClassificationPredictionResult extends $pb.GeneratedMessage {
  ...
  'Will be removed in next major version')
  VideoClassificationPredictionResult copyWith(void Function(VideoClassificationPredictionResult) updates) => super.copyWith((message) => updates(message as VideoClassificationPredictionResult)) as VideoClassificationPredictionResult; // ignore: deprecated_member_use

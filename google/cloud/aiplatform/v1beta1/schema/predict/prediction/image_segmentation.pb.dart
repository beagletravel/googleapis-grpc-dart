...
class ImageSegmentationPredictionResult extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'ImageSegmentationPredictionResult', package: const $pb.PackageName(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'google.cloud.aiplatform.v1beta1.schema.predict.prediction'), createEmptyInstance: create)
    ..aOS(1, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'categoryMask')
    ..aOS(2, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'confidenceMask')
  ...
  'Will be removed in next major version')
  ImageSegmentationPredictionResult copyWith(void Function(ImageSegmentationPredictionResult) updates) => super.copyWith((message) => updates(message as ImageSegmentationPredictionResult)) as ImageSegmentationPredictionResult; // ignore: deprecated_member_use

...
class TimeSeriesForecastingPredictionResult extends $pb.GeneratedMessage {
  ...
  'Will be removed in next major version')
  TimeSeriesForecastingPredictionResult copyWith(void Function(TimeSeriesForecastingPredictionResult) updates) => super.copyWith((message) => updates(message as TimeSeriesForecastingPredictionResult)) as TimeSeriesForecastingPredictionResult; // ignore: deprecated_member_use

...
class VideoActionRecognitionPredictionResult extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'VideoActionRecognitionPredictionResult', package: const $pb.PackageName(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'google.cloud.aiplatform.v1beta1.schema.predict.prediction'), createEmptyInstance: create)
    ..aOS(1, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'id')
    ..aOS(2, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'displayName')
    ..aOM<$0.Duration>(4, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'timeSegmentStart', subBuilder: $0.Duration.create)
    ..aOM<$0.Duration>(5, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'timeSegmentEnd', subBuilder: $0.Duration.create)
    ..aOM<$1.FloatValue>(6, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'confidence', subBuilder: $1.FloatValue.create)
  ...
  'Will be removed in next major version')
  VideoActionRecognitionPredictionResult copyWith(void Function(VideoActionRecognitionPredictionResult) updates) => super.copyWith((message) => updates(message as VideoActionRecognitionPredictionResult)) as VideoActionRecognitionPredictionResult; // ignore: deprecated_member_use
  ...
  @$pb.TagNumber(4)
  set timeSegmentStart($0.Duration v) { setField(4, v); }
  @$pb.TagNumber(4)
  ...
  @$pb.TagNumber(5)
  set timeSegmentEnd($0.Duration v) { setField(5, v); }
  @$pb.TagNumber(5)
  ...
  @$pb.TagNumber(6)
  set confidence($1.FloatValue v) { setField(6, v); }
  @$pb.TagNumber(6)

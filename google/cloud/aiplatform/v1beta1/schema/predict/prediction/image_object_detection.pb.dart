...
class ImageObjectDetectionPredictionResult extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'ImageObjectDetectionPredictionResult', package: const $pb.PackageName(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'google.cloud.aiplatform.v1beta1.schema.predict.prediction'), createEmptyInstance: create)
    ...
    ..p<$core.double>(3, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'confidences', $pb.PbFieldType.PF)
    ..pc<$0.ListValue>(4, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'bboxes', $pb.PbFieldType.PM, subBuilder: $0.ListValue.create)
  ...
  'Will be removed in next major version')
  ImageObjectDetectionPredictionResult copyWith(void Function(ImageObjectDetectionPredictionResult) updates) => super.copyWith((message) => updates(message as ImageObjectDetectionPredictionResult)) as ImageObjectDetectionPredictionResult; // ignore: deprecated_member_use

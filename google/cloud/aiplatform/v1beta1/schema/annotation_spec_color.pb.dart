...
class AnnotationSpecColor extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'AnnotationSpecColor', package: const $pb.PackageName(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'google.cloud.aiplatform.v1beta1.schema'), createEmptyInstance: create)
    ..aOM<$0.Color>(1, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'color', subBuilder: $0.Color.create)
  ...
  'Will be removed in next major version')
  AnnotationSpecColor copyWith(void Function(AnnotationSpecColor) updates) => super.copyWith((message) => updates(message as AnnotationSpecColor)) as AnnotationSpecColor; // ignore: deprecated_member_use

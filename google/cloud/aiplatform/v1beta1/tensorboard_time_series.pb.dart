...
class TensorboardTimeSeries_Metadata extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'TensorboardTimeSeries.Metadata', package: const $pb.PackageName(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'google.cloud.aiplatform.v1beta1'), createEmptyInstance: create)
    ..aInt64(1, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'maxStep')
    ..aOM<$0.Timestamp>(2, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'maxWallTime', subBuilder: $0.Timestamp.create)
    ..aInt64(3, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'maxBlobSequenceLength')
  ...
  'Will be removed in next major version')
  TensorboardTimeSeries_Metadata copyWith(void Function(TensorboardTimeSeries_Metadata) updates) => super.copyWith((message) => updates(message as TensorboardTimeSeries_Metadata)) as TensorboardTimeSeries_Metadata; // ignore: deprecated_member_use
  ...
  @$pb.TagNumber(2)
  set maxWallTime($0.Timestamp v) { setField(2, v); }
  @$pb.TagNumber(2)
...
class TensorboardTimeSeries extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'TensorboardTimeSeries', package: const $pb.PackageName(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'google.cloud.aiplatform.v1beta1'), createEmptyInstance: create)
    ..aOS(1, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'name')
    ..aOS(2, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'displayName')
    ..aOS(3, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'description')
    ..e<TensorboardTimeSeries_ValueType>(4, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'valueType', $pb.PbFieldType.OE, defaultOrMaker: TensorboardTimeSeries_ValueType.VALUE_TYPE_UNSPECIFIED, valueOf: TensorboardTimeSeries_ValueType.valueOf, enumValues: TensorboardTimeSeries_ValueType.values)
    ...
    ..a<$core.List<$core.int>>(9, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'pluginData', $pb.PbFieldType.OY)
    ..aOM<TensorboardTimeSeries_Metadata>(10, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'metadata', subBuilder: TensorboardTimeSeries_Metadata.create)
    ..hasRequiredFields = false
  ;
  ...
  'Use [GeneratedMessageGenericExtensions.rebuild] instead. '
  'Will be removed in next major version')
  TensorboardTimeSeries copyWith(void Function(TensorboardTimeSeries) updates) => super.copyWith((message) => updates(message as TensorboardTimeSeries)) as TensorboardTimeSeries; // ignore: deprecated_member_use
  $pb.BuilderInfo get info_ => _i;
  @$core.pragma('dart2js:noInline')

...
class MetadataSchema extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'MetadataSchema', package: const $pb.PackageName(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'google.cloud.aiplatform.v1beta1'), createEmptyInstance: create)
    ...
    ..e<MetadataSchema_MetadataSchemaType>(4, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'schemaType', $pb.PbFieldType.OE, defaultOrMaker: MetadataSchema_MetadataSchemaType.METADATA_SCHEMA_TYPE_UNSPECIFIED, valueOf: MetadataSchema_MetadataSchemaType.valueOf, enumValues: MetadataSchema_MetadataSchemaType.values)
  ...
  'Will be removed in next major version')
  MetadataSchema copyWith(void Function(MetadataSchema) updates) => super.copyWith((message) => updates(message as MetadataSchema)) as MetadataSchema; // ignore: deprecated_member_use

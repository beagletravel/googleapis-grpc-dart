...
class ModelEvaluationSlice_Slice extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'ModelEvaluationSlice.Slice', package: const $pb.PackageName(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'google.cloud.aiplatform.v1beta1'), createEmptyInstance: create)
    ..aOS(1, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'dimension')
  ...
  'Will be removed in next major version')
  ModelEvaluationSlice_Slice copyWith(void Function(ModelEvaluationSlice_Slice) updates) => super.copyWith((message) => updates(message as ModelEvaluationSlice_Slice)) as ModelEvaluationSlice_Slice; // ignore: deprecated_member_use
...
class ModelEvaluationSlice extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'ModelEvaluationSlice', package: const $pb.PackageName(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'google.cloud.aiplatform.v1beta1'), createEmptyInstance: create)
    ..aOS(1, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'name')
    ..aOM<ModelEvaluationSlice_Slice>(2, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'slice', subBuilder: ModelEvaluationSlice_Slice.create)
    ..aOS(3, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'metricsSchemaUri')
    ..aOM<$0.Value>(4, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'metrics', subBuilder: $0.Value.create)
  ...
  'Use [GeneratedMessageGenericExtensions.rebuild] instead. '
  'Will be removed in next major version')
  ModelEvaluationSlice copyWith(void Function(ModelEvaluationSlice) updates) => super.copyWith((message) => updates(message as ModelEvaluationSlice)) as ModelEvaluationSlice; // ignore: deprecated_member_use
  $pb.BuilderInfo get info_ => _i;
  @$core.pragma('dart2js:noInline')
  ...
  @$pb.TagNumber(4)
  set metrics($0.Value v) { setField(4, v); }
  @$pb.TagNumber(4)

...
class FeatureStatsAnomaly extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'FeatureStatsAnomaly', package: const $pb.PackageName(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'google.cloud.aiplatform.v1beta1'), createEmptyInstance: create)
    ..a<$core.double>(1, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'score', $pb.PbFieldType.OD)
    ..aOS(3, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'statsUri')
    ..aOS(4, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'anomalyUri')
    ..a<$core.double>(5, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'distributionDeviation', $pb.PbFieldType.OD)
    ...
    ..a<$core.double>(9, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'anomalyDetectionThreshold', $pb.PbFieldType.OD)
  ...
  'Will be removed in next major version')
  FeatureStatsAnomaly copyWith(void Function(FeatureStatsAnomaly) updates) => super.copyWith((message) => updates(message as FeatureStatsAnomaly)) as FeatureStatsAnomaly; // ignore: deprecated_member_use

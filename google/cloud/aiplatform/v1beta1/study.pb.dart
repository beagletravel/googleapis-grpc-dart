...
class Study extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'Study', package: const $pb.PackageName(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'google.cloud.aiplatform.v1beta1'), createEmptyInstance: create)
    ..aOS(1, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'name')
    ..aOS(2, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'displayName')
    ..aOM<StudySpec>(3, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'studySpec', subBuilder: StudySpec.create)
    ..e<Study_State>(4, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'state', $pb.PbFieldType.OE, defaultOrMaker: Study_State.STATE_UNSPECIFIED, valueOf: Study_State.valueOf, enumValues: Study_State.values)
    ..aOM<$0.Timestamp>(5, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'createTime', subBuilder: $0.Timestamp.create)
    ..aOS(6, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'inactiveReason')
...
class Trial_Parameter extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'Trial.Parameter', package: const $pb.PackageName(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'google.cloud.aiplatform.v1beta1'), createEmptyInstance: create)
    ..aOS(1, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'parameterId')
    ..aOM<$1.Value>(2, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'value', subBuilder: $1.Value.create)
    ..hasRequiredFields = false
  ;
  ...
  'Use [GeneratedMessageGenericExtensions.rebuild] instead. '
  'Will be removed in next major version')
  Trial_Parameter copyWith(void Function(Trial_Parameter) updates) => super.copyWith((message) => updates(message as Trial_Parameter)) as Trial_Parameter; // ignore: deprecated_member_use
  $pb.BuilderInfo get info_ => _i;
  @$core.pragma('dart2js:noInline')
  ...
  @$pb.TagNumber(2)
  set value($1.Value v) { setField(2, v); }
  @$pb.TagNumber(2)
...
class Trial extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'Trial', package: const $pb.PackageName(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'google.cloud.aiplatform.v1beta1'), createEmptyInstance: create)
    ..aOS(1, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'name')
    ..aOS(2, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'id')
    ..e<Trial_State>(3, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'state', $pb.PbFieldType.OE, defaultOrMaker: Trial_State.STATE_UNSPECIFIED, valueOf: Trial_State.valueOf, enumValues: Trial_State.values)
    ..pc<Trial_Parameter>(4, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'parameters', $pb.PbFieldType.PM, subBuilder: Trial_Parameter.create)
    ..aOM<Measurement>(5, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'finalMeasurement', subBuilder: Measurement.create)
    ..pc<Measurement>(6, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'measurements', $pb.PbFieldType.PM, subBuilder: Measurement.create)
    ..aOM<$0.Timestamp>(7, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'startTime', subBuilder: $0.Timestamp.create)
    ..aOM<$0.Timestamp>(8, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'endTime', subBuilder: $0.Timestamp.create)
    ..aOS(9, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'clientId')
    ..aOS(10, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'infeasibleReason')
    ..aOS(11, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'customJob')
    ..m<$core.String, $core.String>(12, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'webAccessUris', entryClassName: 'Trial.WebAccessUrisEntry', keyFieldType: $pb.PbFieldType.OS, valueFieldType: $pb.PbFieldType.OS, packageName: const $pb.PackageName('google.cloud.aiplatform.v1beta1'))
    ..hasRequiredFields = false
  ;
  ...
  'Use [GeneratedMessageGenericExtensions.rebuild] instead. '
  'Will be removed in next major version')
  Trial copyWith(void Function(Trial) updates) => super.copyWith((message) => updates(message as Trial)) as Trial; // ignore: deprecated_member_use
  $pb.BuilderInfo get info_ => _i;
  @$core.pragma('dart2js:noInline')
  ...
  @$pb.TagNumber(7)
  set startTime($0.Timestamp v) { setField(7, v); }
  @$pb.TagNumber(7)
...
class StudySpec_MetricSpec extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'StudySpec.MetricSpec', package: const $pb.PackageName(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'google.cloud.aiplatform.v1beta1'), createEmptyInstance: create)
    ..aOS(1, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'metricId')
    ..e<StudySpec_MetricSpec_GoalType>(2, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'goal', $pb.PbFieldType.OE, defaultOrMaker: StudySpec_MetricSpec_GoalType.GOAL_TYPE_UNSPECIFIED, valueOf: StudySpec_MetricSpec_GoalType.valueOf, enumValues: StudySpec_MetricSpec_GoalType.values)
    ..hasRequiredFields = false
  ;
  ...
  'Use [GeneratedMessageGenericExtensions.rebuild] instead. '
  'Will be removed in next major version')
  StudySpec_MetricSpec copyWith(void Function(StudySpec_MetricSpec) updates) => super.copyWith((message) => updates(message as StudySpec_MetricSpec)) as StudySpec_MetricSpec; // ignore: deprecated_member_use
  $pb.BuilderInfo get info_ => _i;
  @$core.pragma('dart2js:noInline')
...
class StudySpec_ParameterSpec_DoubleValueSpec extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'StudySpec.ParameterSpec.DoubleValueSpec', package: const $pb.PackageName(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'google.cloud.aiplatform.v1beta1'), createEmptyInstance: create)
    ..a<$core.double>(1, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'minValue', $pb.PbFieldType.OD)
    ..a<$core.double>(2, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'maxValue', $pb.PbFieldType.OD)
    ..a<$core.double>(4, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'defaultValue', $pb.PbFieldType.OD)
    ..hasRequiredFields = false
  ;
  ...
  'Use [GeneratedMessageGenericExtensions.rebuild] instead. '
  'Will be removed in next major version')
  StudySpec_ParameterSpec_DoubleValueSpec copyWith(void Function(StudySpec_ParameterSpec_DoubleValueSpec) updates) => super.copyWith((message) => updates(message as StudySpec_ParameterSpec_DoubleValueSpec)) as StudySpec_ParameterSpec_DoubleValueSpec; // ignore: deprecated_member_use
  $pb.BuilderInfo get info_ => _i;
  @$core.pragma('dart2js:noInline')
...
class StudySpec_ParameterSpec_IntegerValueSpec extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'StudySpec.ParameterSpec.IntegerValueSpec', package: const $pb.PackageName(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'google.cloud.aiplatform.v1beta1'), createEmptyInstance: create)
    ..aInt64(1, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'minValue')
    ..aInt64(2, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'maxValue')
    ..aInt64(4, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'defaultValue')
    ..hasRequiredFields = false
  ;
  ...
  'Use [GeneratedMessageGenericExtensions.rebuild] instead. '
  'Will be removed in next major version')
  StudySpec_ParameterSpec_IntegerValueSpec copyWith(void Function(StudySpec_ParameterSpec_IntegerValueSpec) updates) => super.copyWith((message) => updates(message as StudySpec_ParameterSpec_IntegerValueSpec)) as StudySpec_ParameterSpec_IntegerValueSpec; // ignore: deprecated_member_use
  $pb.BuilderInfo get info_ => _i;
  @$core.pragma('dart2js:noInline')
...
class StudySpec_ParameterSpec_CategoricalValueSpec extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'StudySpec.ParameterSpec.CategoricalValueSpec', package: const $pb.PackageName(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'google.cloud.aiplatform.v1beta1'), createEmptyInstance: create)
    ..pPS(1, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'values')
    ..aOS(3, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'defaultValue')
    ..hasRequiredFields = false
  ;
  ...
  'Use [GeneratedMessageGenericExtensions.rebuild] instead. '
  'Will be removed in next major version')
  StudySpec_ParameterSpec_CategoricalValueSpec copyWith(void Function(StudySpec_ParameterSpec_CategoricalValueSpec) updates) => super.copyWith((message) => updates(message as StudySpec_ParameterSpec_CategoricalValueSpec)) as StudySpec_ParameterSpec_CategoricalValueSpec; // ignore: deprecated_member_use
  $pb.BuilderInfo get info_ => _i;
  @$core.pragma('dart2js:noInline')
...
class StudySpec_ParameterSpec_DiscreteValueSpec extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'StudySpec.ParameterSpec.DiscreteValueSpec', package: const $pb.PackageName(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'google.cloud.aiplatform.v1beta1'), createEmptyInstance: create)
    ..p<$core.double>(1, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'values', $pb.PbFieldType.PD)
    ..a<$core.double>(3, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'defaultValue', $pb.PbFieldType.OD)
    ..hasRequiredFields = false
  ;
  ...
  'Use [GeneratedMessageGenericExtensions.rebuild] instead. '
  'Will be removed in next major version')
  StudySpec_ParameterSpec_DiscreteValueSpec copyWith(void Function(StudySpec_ParameterSpec_DiscreteValueSpec) updates) => super.copyWith((message) => updates(message as StudySpec_ParameterSpec_DiscreteValueSpec)) as StudySpec_ParameterSpec_DiscreteValueSpec; // ignore: deprecated_member_use
  $pb.BuilderInfo get info_ => _i;
  @$core.pragma('dart2js:noInline')
...
class StudySpec_ParameterSpec_ConditionalParameterSpec_DiscreteValueCondition extends $pb.GeneratedMessage {
  ...
  'Use [GeneratedMessageGenericExtensions.rebuild] instead. '
  'Will be removed in next major version')
  StudySpec_ParameterSpec_ConditionalParameterSpec_DiscreteValueCondition copyWith(void Function(StudySpec_ParameterSpec_ConditionalParameterSpec_DiscreteValueCondition) updates) => super.copyWith((message) => updates(message as StudySpec_ParameterSpec_ConditionalParameterSpec_DiscreteValueCondition)) as StudySpec_ParameterSpec_ConditionalParameterSpec_DiscreteValueCondition; // ignore: deprecated_member_use
  $pb.BuilderInfo get info_ => _i;
  @$core.pragma('dart2js:noInline')
...
class StudySpec_ParameterSpec_ConditionalParameterSpec_IntValueCondition extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'StudySpec.ParameterSpec.ConditionalParameterSpec.IntValueCondition', package: const $pb.PackageName(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'google.cloud.aiplatform.v1beta1'), createEmptyInstance: create)
...
class StudySpec_ParameterSpec_ConditionalParameterSpec_CategoricalValueCondition extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'StudySpec.ParameterSpec.ConditionalParameterSpec.CategoricalValueCondition', package: const $pb.PackageName(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'google.cloud.aiplatform.v1beta1'), createEmptyInstance: create)
    ..pPS(1, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'values')
    ..hasRequiredFields = false
  ;
...
class StudySpec_ParameterSpec_ConditionalParameterSpec extends $pb.GeneratedMessage {
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'StudySpec.ParameterSpec.ConditionalParameterSpec', package: const $pb.PackageName(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'google.cloud.aiplatform.v1beta1'), createEmptyInstance: create)
    ..oo(0, [2, 3, 4])
    ..aOM<StudySpec_ParameterSpec>(1, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'parameterSpec', subBuilder: StudySpec_ParameterSpec.create)
    ..aOM<StudySpec_ParameterSpec_ConditionalParameterSpec_DiscreteValueCondition>(2, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'parentDiscreteValues', subBuilder: StudySpec_ParameterSpec_ConditionalParameterSpec_DiscreteValueCondition.create)
    ..aOM<StudySpec_ParameterSpec_ConditionalParameterSpec_IntValueCondition>(3, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'parentIntValues', subBuilder: StudySpec_ParameterSpec_ConditionalParameterSpec_IntValueCondition.create)
    ..aOM<StudySpec_ParameterSpec_ConditionalParameterSpec_CategoricalValueCondition>(4, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'parentCategoricalValues', subBuilder: StudySpec_ParameterSpec_ConditionalParameterSpec_CategoricalValueCondition.create)
    ..hasRequiredFields = false
  ;
  ...
  'Use [GeneratedMessageGenericExtensions.rebuild] instead. '
  'Will be removed in next major version')
  StudySpec_ParameterSpec_ConditionalParameterSpec copyWith(void Function(StudySpec_ParameterSpec_ConditionalParameterSpec) updates) => super.copyWith((message) => updates(message as StudySpec_ParameterSpec_ConditionalParameterSpec)) as StudySpec_ParameterSpec_ConditionalParameterSpec; // ignore: deprecated_member_use
  $pb.BuilderInfo get info_ => _i;
  @$core.pragma('dart2js:noInline')
...
class StudySpec_ParameterSpec extends $pb.GeneratedMessage {
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'StudySpec.ParameterSpec', package: const $pb.PackageName(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'google.cloud.aiplatform.v1beta1'), createEmptyInstance: create)
    ..oo(0, [2, 3, 4, 5])
    ..aOS(1, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'parameterId')
    ..aOM<StudySpec_ParameterSpec_DoubleValueSpec>(2, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'doubleValueSpec', subBuilder: StudySpec_ParameterSpec_DoubleValueSpec.create)
    ..aOM<StudySpec_ParameterSpec_IntegerValueSpec>(3, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'integerValueSpec', subBuilder: StudySpec_ParameterSpec_IntegerValueSpec.create)
    ..aOM<StudySpec_ParameterSpec_CategoricalValueSpec>(4, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'categoricalValueSpec', subBuilder: StudySpec_ParameterSpec_CategoricalValueSpec.create)
    ..aOM<StudySpec_ParameterSpec_DiscreteValueSpec>(5, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'discreteValueSpec', subBuilder: StudySpec_ParameterSpec_DiscreteValueSpec.create)
    ..e<StudySpec_ParameterSpec_ScaleType>(6, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'scaleType', $pb.PbFieldType.OE, defaultOrMaker: StudySpec_ParameterSpec_ScaleType.SCALE_TYPE_UNSPECIFIED, valueOf: StudySpec_ParameterSpec_ScaleType.valueOf, enumValues: StudySpec_ParameterSpec_ScaleType.values)
    ..pc<StudySpec_ParameterSpec_ConditionalParameterSpec>(10, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'conditionalParameterSpecs', $pb.PbFieldType.PM, subBuilder: StudySpec_ParameterSpec_ConditionalParameterSpec.create)
    ..hasRequiredFields = false
  ;
  ...
  'Use [GeneratedMessageGenericExtensions.rebuild] instead. '
  'Will be removed in next major version')
  StudySpec_ParameterSpec copyWith(void Function(StudySpec_ParameterSpec) updates) => super.copyWith((message) => updates(message as StudySpec_ParameterSpec)) as StudySpec_ParameterSpec; // ignore: deprecated_member_use
  $pb.BuilderInfo get info_ => _i;
  @$core.pragma('dart2js:noInline')
...
class StudySpec_DecayCurveAutomatedStoppingSpec extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'StudySpec.DecayCurveAutomatedStoppingSpec', package: const $pb.PackageName(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'google.cloud.aiplatform.v1beta1'), createEmptyInstance: create)
    ..aOB(1, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'useElapsedDuration')
    ..hasRequiredFields = false
  ;
  ...
  'Use [GeneratedMessageGenericExtensions.rebuild] instead. '
  'Will be removed in next major version')
  StudySpec_DecayCurveAutomatedStoppingSpec copyWith(void Function(StudySpec_DecayCurveAutomatedStoppingSpec) updates) => super.copyWith((message) => updates(message as StudySpec_DecayCurveAutomatedStoppingSpec)) as StudySpec_DecayCurveAutomatedStoppingSpec; // ignore: deprecated_member_use
  $pb.BuilderInfo get info_ => _i;
  @$core.pragma('dart2js:noInline')
...
class StudySpec_MedianAutomatedStoppingSpec extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'StudySpec.MedianAutomatedStoppingSpec', package: const $pb.PackageName(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'google.cloud.aiplatform.v1beta1'), createEmptyInstance: create)
    ..aOB(1, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'useElapsedDuration')
    ..hasRequiredFields = false
  ;
  ...
  'Use [GeneratedMessageGenericExtensions.rebuild] instead. '
  'Will be removed in next major version')
  StudySpec_MedianAutomatedStoppingSpec copyWith(void Function(StudySpec_MedianAutomatedStoppingSpec) updates) => super.copyWith((message) => updates(message as StudySpec_MedianAutomatedStoppingSpec)) as StudySpec_MedianAutomatedStoppingSpec; // ignore: deprecated_member_use
  $pb.BuilderInfo get info_ => _i;
  @$core.pragma('dart2js:noInline')
...
class StudySpec_ConvexAutomatedStoppingSpec extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'StudySpec.ConvexAutomatedStoppingSpec', package: const $pb.PackageName(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'google.cloud.aiplatform.v1beta1'), createEmptyInstance: create)
    ..aInt64(1, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'maxStepCount')
    ..aInt64(2, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'minStepCount')
    ..aInt64(3, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'minMeasurementCount')
    ..aOS(4, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'learningRateParameterName')
    ..aOB(5, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'useElapsedDuration')
    ..hasRequiredFields = false
  ;
  ...
  factory StudySpec_ConvexAutomatedStoppingSpec({
    ...
    if (maxStepCount != null) {
      _result.maxStepCount = maxStepCount;
    }
    if (minStepCount != null) {
      _result.minStepCount = minStepCount;
    }
    if (minMeasurementCount != null) {
      _result.minMeasurementCount = minMeasurementCount;
    }
    if (learningRateParameterName != null) {
      _result.learningRateParameterName = learningRateParameterName;
    }
    if (useElapsedDuration != null) {
      _result.useElapsedDuration = useElapsedDuration;
    }
  ...
  'Use [GeneratedMessageGenericExtensions.rebuild] instead. '
  'Will be removed in next major version')
  StudySpec_ConvexAutomatedStoppingSpec copyWith(void Function(StudySpec_ConvexAutomatedStoppingSpec) updates) => super.copyWith((message) => updates(message as StudySpec_ConvexAutomatedStoppingSpec)) as StudySpec_ConvexAutomatedStoppingSpec; // ignore: deprecated_member_use
  $pb.BuilderInfo get info_ => _i;
  @$core.pragma('dart2js:noInline')
...
class StudySpec_ConvexStopConfig extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'StudySpec.ConvexStopConfig', package: const $pb.PackageName(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'google.cloud.aiplatform.v1beta1'), createEmptyInstance: create)
    ..aInt64(1, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'maxNumSteps')
    ..aInt64(2, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'minNumSteps')
    ..aInt64(3, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'autoregressiveOrder')
    ..aOS(4, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'learningRateParameterName')
    ..aOB(5, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'useSeconds')
    ..hasRequiredFields = false
  ;

  StudySpec_ConvexStopConfig._() : super();
  factory StudySpec_ConvexStopConfig({
    $fixnum.Int64? maxNumSteps,
    $fixnum.Int64? minNumSteps,
    $fixnum.Int64? autoregressiveOrder,
    $core.String? learningRateParameterName,
    $core.bool? useSeconds,
  }) {
    final _result = create();
    if (maxNumSteps != null) {
      _result.maxNumSteps = maxNumSteps;
    }
    if (minNumSteps != null) {
      _result.minNumSteps = minNumSteps;
    }
    if (autoregressiveOrder != null) {
      _result.autoregressiveOrder = autoregressiveOrder;
    }
    if (learningRateParameterName != null) {
      _result.learningRateParameterName = learningRateParameterName;
    }
    if (useSeconds != null) {
      _result.useSeconds = useSeconds;
    }
    return _result;
  }
  factory StudySpec_ConvexStopConfig.fromBuffer($core.List<$core.int> i, [$pb.ExtensionRegistry r = $pb.ExtensionRegistry.EMPTY]) => create()..mergeFromBuffer(i, r);
  factory StudySpec_ConvexStopConfig.fromJson($core.String i, [$pb.ExtensionRegistry r = $pb.ExtensionRegistry.EMPTY]) => create()..mergeFromJson(i, r);
  @$core.Deprecated(
  'Using this can add significant overhead to your binary. '
  'Use [GeneratedMessageGenericExtensions.deepCopy] instead. '
  'Will be removed in next major version')
  StudySpec_ConvexStopConfig clone() => StudySpec_ConvexStopConfig()..mergeFromMessage(this);
  @$core.Deprecated(
  'Using this can add significant overhead to your binary. '
  'Use [GeneratedMessageGenericExtensions.rebuild] instead. '
  'Will be removed in next major version')
  StudySpec_ConvexStopConfig copyWith(void Function(StudySpec_ConvexStopConfig) updates) => super.copyWith((message) => updates(message as StudySpec_ConvexStopConfig)) as StudySpec_ConvexStopConfig; // ignore: deprecated_member_use
  $pb.BuilderInfo get info_ => _i;
  @$core.pragma('dart2js:noInline')
  static StudySpec_ConvexStopConfig create() => StudySpec_ConvexStopConfig._();
  StudySpec_ConvexStopConfig createEmptyInstance() => create();
  static $pb.PbList<StudySpec_ConvexStopConfig> createRepeated() => $pb.PbList<StudySpec_ConvexStopConfig>();
  @$core.pragma('dart2js:noInline')
  static StudySpec_ConvexStopConfig getDefault() => _defaultInstance ??= $pb.GeneratedMessage.$_defaultFor<StudySpec_ConvexStopConfig>(create);
  static StudySpec_ConvexStopConfig? _defaultInstance;

  @$pb.TagNumber(1)
  $fixnum.Int64 get maxNumSteps => $_getI64(0);
  @$pb.TagNumber(1)
  set maxNumSteps($fixnum.Int64 v) { $_setInt64(0, v); }
  @$pb.TagNumber(1)
  $core.bool hasMaxNumSteps() => $_has(0);
  @$pb.TagNumber(1)
  void clearMaxNumSteps() => clearField(1);

  @$pb.TagNumber(2)
  $fixnum.Int64 get minNumSteps => $_getI64(1);
  @$pb.TagNumber(2)
  set minNumSteps($fixnum.Int64 v) { $_setInt64(1, v); }
  @$pb.TagNumber(2)
  $core.bool hasMinNumSteps() => $_has(1);
  @$pb.TagNumber(2)
  void clearMinNumSteps() => clearField(2);

  @$pb.TagNumber(3)
  $fixnum.Int64 get autoregressiveOrder => $_getI64(2);
  @$pb.TagNumber(3)
  set autoregressiveOrder($fixnum.Int64 v) { $_setInt64(2, v); }
  @$pb.TagNumber(3)
  $core.bool hasAutoregressiveOrder() => $_has(2);
  @$pb.TagNumber(3)
  void clearAutoregressiveOrder() => clearField(3);
  ...
  @$pb.TagNumber(5)
  $core.bool get useSeconds => $_getBF(4);
  @$pb.TagNumber(5)
  set useSeconds($core.bool v) { $_setBool(4, v); }
  @$pb.TagNumber(5)
  $core.bool hasUseSeconds() => $_has(4);
  @$pb.TagNumber(5)
  void clearUseSeconds() => clearField(5);
}
...
class StudySpec extends $pb.GeneratedMessage {
  static const $core.Map<$core.int, StudySpec_AutomatedStoppingSpec> _StudySpec_AutomatedStoppingSpecByTag = {
    ...
    8 : StudySpec_AutomatedStoppingSpec.convexStopConfig,
    9 : StudySpec_AutomatedStoppingSpec.convexAutomatedStoppingSpec,
    0 : StudySpec_AutomatedStoppingSpec.notSet
  };
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'StudySpec', package: const $pb.PackageName(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'google.cloud.aiplatform.v1beta1'), createEmptyInstance: create)
    ..oo(0, [4, 5, 8, 9])
    ..pc<StudySpec_MetricSpec>(1, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'metrics', $pb.PbFieldType.PM, subBuilder: StudySpec_MetricSpec.create)
    ..pc<StudySpec_ParameterSpec>(2, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'parameters', $pb.PbFieldType.PM, subBuilder: StudySpec_ParameterSpec.create)
    ..e<StudySpec_Algorithm>(3, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'algorithm', $pb.PbFieldType.OE, defaultOrMaker: StudySpec_Algorithm.ALGORITHM_UNSPECIFIED, valueOf: StudySpec_Algorithm.valueOf, enumValues: StudySpec_Algorithm.values)
    ..aOM<StudySpec_DecayCurveAutomatedStoppingSpec>(4, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'decayCurveStoppingSpec', subBuilder: StudySpec_DecayCurveAutomatedStoppingSpec.create)
    ..aOM<StudySpec_MedianAutomatedStoppingSpec>(5, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'medianAutomatedStoppingSpec', subBuilder: StudySpec_MedianAutomatedStoppingSpec.create)
    ..e<StudySpec_ObservationNoise>(6, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'observationNoise', $pb.PbFieldType.OE, defaultOrMaker: StudySpec_ObservationNoise.OBSERVATION_NOISE_UNSPECIFIED, valueOf: StudySpec_ObservationNoise.valueOf, enumValues: StudySpec_ObservationNoise.values)
    ..e<StudySpec_MeasurementSelectionType>(7, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'measurementSelectionType', $pb.PbFieldType.OE, defaultOrMaker: StudySpec_MeasurementSelectionType.MEASUREMENT_SELECTION_TYPE_UNSPECIFIED, valueOf: StudySpec_MeasurementSelectionType.valueOf, enumValues: StudySpec_MeasurementSelectionType.values)
    ..aOM<StudySpec_ConvexStopConfig>(8, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'convexStopConfig', subBuilder: StudySpec_ConvexStopConfig.create)
    ..aOM<StudySpec_ConvexAutomatedStoppingSpec>(9, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'convexAutomatedStoppingSpec', subBuilder: StudySpec_ConvexAutomatedStoppingSpec.create)
    ..hasRequiredFields = false
  ;
  ...
  @$core.Deprecated('This field is deprecated.')
    StudySpec_ConvexStopConfig? convexStopConfig,
    ...
    if (convexStopConfig != null) {
      ...
      _result.convexStopConfig = convexStopConfig;
    }
    if (convexAutomatedStoppingSpec != null) {
      _result.convexAutomatedStoppingSpec = convexAutomatedStoppingSpec;
    }
    return _result;
  }
  ...
  'Use [GeneratedMessageGenericExtensions.rebuild] instead. '
  'Will be removed in next major version')
  StudySpec copyWith(void Function(StudySpec) updates) => super.copyWith((message) => updates(message as StudySpec)) as StudySpec; // ignore: deprecated_member_use
  $pb.BuilderInfo get info_ => _i;
  @$core.pragma('dart2js:noInline')
  ...
  @$core.Deprecated('This field is deprecated.')
  @$pb.TagNumber(8)
  StudySpec_ConvexStopConfig get convexStopConfig => $_getN(7);
  @$core.Deprecated('This field is deprecated.')
  @$pb.TagNumber(8)
  set convexStopConfig(StudySpec_ConvexStopConfig v) { setField(8, v); }
  @$core.Deprecated('This field is deprecated.')
  @$pb.TagNumber(8)
  $core.bool hasConvexStopConfig() => $_has(7);
  @$core.Deprecated('This field is deprecated.')
  @$pb.TagNumber(8)
  void clearConvexStopConfig() => clearField(8);
  @$core.Deprecated('This field is deprecated.')
  @$pb.TagNumber(8)
  StudySpec_ConvexStopConfig ensureConvexStopConfig() => $_ensure(7);

  @$pb.TagNumber(9)
  StudySpec_ConvexAutomatedStoppingSpec get convexAutomatedStoppingSpec => $_getN(8);
  @$pb.TagNumber(9)
  set convexAutomatedStoppingSpec(StudySpec_ConvexAutomatedStoppingSpec v) { setField(9, v); }
  @$pb.TagNumber(9)
  $core.bool hasConvexAutomatedStoppingSpec() => $_has(8);
  @$pb.TagNumber(9)
  void clearConvexAutomatedStoppingSpec() => clearField(9);
  @$pb.TagNumber(9)
  StudySpec_ConvexAutomatedStoppingSpec ensureConvexAutomatedStoppingSpec() => $_ensure(8);
}

class Measurement_Metric extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'Measurement.Metric', package: const $pb.PackageName(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'google.cloud.aiplatform.v1beta1'), createEmptyInstance: create)
    ..aOS(1, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'metricId')
  ...
  'Use [GeneratedMessageGenericExtensions.rebuild] instead. '
  'Will be removed in next major version')
  Measurement_Metric copyWith(void Function(Measurement_Metric) updates) => super.copyWith((message) => updates(message as Measurement_Metric)) as Measurement_Metric; // ignore: deprecated_member_use
  $pb.BuilderInfo get info_ => _i;
  @$core.pragma('dart2js:noInline')
...
class Measurement extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'Measurement', package: const $pb.PackageName(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'google.cloud.aiplatform.v1beta1'), createEmptyInstance: create)
    ..aOM<$2.Duration>(1, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'elapsedDuration', subBuilder: $2.Duration.create)
    ..aInt64(2, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'stepCount')
    ..pc<Measurement_Metric>(3, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'metrics', $pb.PbFieldType.PM, subBuilder: Measurement_Metric.create)
    ..hasRequiredFields = false
  ;
  ...
  @$pb.TagNumber(1)
  set elapsedDuration($2.Duration v) { setField(1, v); }
  @$pb.TagNumber(1)

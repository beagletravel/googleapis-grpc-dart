...
class EntityType extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'EntityType', package: const $pb.PackageName(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'google.cloud.aiplatform.v1beta1'), createEmptyInstance: create)
    ...
    ..m<$core.String, $core.String>(6, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'labels', entryClassName: 'EntityType.LabelsEntry', keyFieldType: $pb.PbFieldType.OS, valueFieldType: $pb.PbFieldType.OS, packageName: const $pb.PackageName('google.cloud.aiplatform.v1beta1'))
    ..aOS(7, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'etag')
    ..aOM<$1.FeaturestoreMonitoringConfig>(8, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'monitoringConfig', subBuilder: $1.FeaturestoreMonitoringConfig.create)
  ...
  @$pb.TagNumber(8)
  set monitoringConfig($1.FeaturestoreMonitoringConfig v) { setField(8, v); }
  @$pb.TagNumber(8)

...
class Model_ExportFormat extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'Model.ExportFormat', package: const $pb.PackageName(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'google.cloud.aiplatform.v1beta1'), createEmptyInstance: create)
    ..aOS(1, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'id')
    ..pc<Model_ExportFormat_ExportableContent>(2, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'exportableContents', $pb.PbFieldType.PE, valueOf: Model_ExportFormat_ExportableContent.valueOf, enumValues: Model_ExportFormat_ExportableContent.values)
  ...
  'Will be removed in next major version')
  Model_ExportFormat copyWith(void Function(Model_ExportFormat) updates) => super.copyWith((message) => updates(message as Model_ExportFormat)) as Model_ExportFormat; // ignore: deprecated_member_use
...
class Model extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'Model', package: const $pb.PackageName(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'google.cloud.aiplatform.v1beta1'), createEmptyInstance: create)
    ..aOS(1, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'name')
    ..aOS(2, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'displayName')
    ..aOS(3, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'description')
    ..aOM<PredictSchemata>(4, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'predictSchemata', subBuilder: PredictSchemata.create)
    ..aOS(5, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'metadataSchemaUri')
    ..aOM<$0.Value>(6, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'metadata', subBuilder: $0.Value.create)
    ..aOS(7, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'trainingPipeline')
    ..aOM<ModelContainerSpec>(9, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'containerSpec', subBuilder: ModelContainerSpec.create)
    ..pc<Model_DeploymentResourcesType>(10, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'supportedDeploymentResourcesTypes', $pb.PbFieldType.PE, valueOf: Model_DeploymentResourcesType.valueOf, enumValues: Model_DeploymentResourcesType.values)
    ..pPS(11, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'supportedInputStorageFormats')
    ..pPS(12, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'supportedOutputStorageFormats')
    ...
    ..pc<$2.DeployedModelRef>(15, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'deployedModels', $pb.PbFieldType.PM, subBuilder: $2.DeployedModelRef.create)
    ..aOS(16, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'etag')
    ..m<$core.String, $core.String>(17, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'labels', entryClassName: 'Model.LabelsEntry', keyFieldType: $pb.PbFieldType.OS, valueFieldType: $pb.PbFieldType.OS, packageName: const $pb.PackageName('google.cloud.aiplatform.v1beta1'))
    ..pc<Model_ExportFormat>(20, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'supportedExportFormats', $pb.PbFieldType.PM, subBuilder: Model_ExportFormat.create)
    ..aOM<$3.ExplanationSpec>(23, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'explanationSpec', subBuilder: $3.ExplanationSpec.create)
    ..aOM<$4.EncryptionSpec>(24, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'encryptionSpec', subBuilder: $4.EncryptionSpec.create)
    ..aOS(26, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'artifactUri')
    ..aOS(28, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'versionId')
    ..pPS(29, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'versionAliases')
    ..aOS(30, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'versionDescription')
    ..aOM<$1.Timestamp>(31, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'versionCreateTime', subBuilder: $1.Timestamp.create)
    ..aOM<$1.Timestamp>(32, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'versionUpdateTime', subBuilder: $1.Timestamp.create)
    ..hasRequiredFields = false
  ;
  ...
  factory Model({
    ...
    if (supportedDeploymentResourcesTypes != null) {
      _result.supportedDeploymentResourcesTypes.addAll(supportedDeploymentResourcesTypes);
    }
    ...
    if (supportedOutputStorageFormats != null) {
      _result.supportedOutputStorageFormats.addAll(supportedOutputStorageFormats);
    }
    if (createTime != null) {
    ...
    if (versionUpdateTime != null) {
      _result.versionUpdateTime = versionUpdateTime;
    }
    return _result;
  }
  ...
  @$pb.TagNumber(6)
  set metadata($0.Value v) { setField(6, v); }
  @$pb.TagNumber(6)
  ...
  @$pb.TagNumber(23)
  set explanationSpec($3.ExplanationSpec v) { setField(23, v); }
  @$pb.TagNumber(23)
  ...
  @$pb.TagNumber(24)
  set encryptionSpec($4.EncryptionSpec v) { setField(24, v); }
  @$pb.TagNumber(24)
  ...
  @$pb.TagNumber(31)
  $1.Timestamp get versionCreateTime => $_getN(23);
  @$pb.TagNumber(31)
  set versionCreateTime($1.Timestamp v) { setField(31, v); }
  @$pb.TagNumber(31)
  $core.bool hasVersionCreateTime() => $_has(23);
  @$pb.TagNumber(31)
  void clearVersionCreateTime() => clearField(31);
  @$pb.TagNumber(31)
  $1.Timestamp ensureVersionCreateTime() => $_ensure(23);

  @$pb.TagNumber(32)
  $1.Timestamp get versionUpdateTime => $_getN(24);
  @$pb.TagNumber(32)
  set versionUpdateTime($1.Timestamp v) { setField(32, v); }
  @$pb.TagNumber(32)
  $core.bool hasVersionUpdateTime() => $_has(24);
  @$pb.TagNumber(32)
  void clearVersionUpdateTime() => clearField(32);
  @$pb.TagNumber(32)
  $1.Timestamp ensureVersionUpdateTime() => $_ensure(24);
}

class PredictSchemata extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'PredictSchemata', package: const $pb.PackageName(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'google.cloud.aiplatform.v1beta1'), createEmptyInstance: create)
    ..aOS(1, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'instanceSchemaUri')
    ..aOS(2, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'parametersSchemaUri')
    ..aOS(3, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'predictionSchemaUri')
    ..hasRequiredFields = false
  ;
  ...
  'Use [GeneratedMessageGenericExtensions.rebuild] instead. '
  'Will be removed in next major version')
  PredictSchemata copyWith(void Function(PredictSchemata) updates) => super.copyWith((message) => updates(message as PredictSchemata)) as PredictSchemata; // ignore: deprecated_member_use
  $pb.BuilderInfo get info_ => _i;
  @$core.pragma('dart2js:noInline')
...
class ModelContainerSpec extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'ModelContainerSpec', package: const $pb.PackageName(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'google.cloud.aiplatform.v1beta1'), createEmptyInstance: create)
    ...
    ..pc<Port>(5, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'ports', $pb.PbFieldType.PM, subBuilder: Port.create)
    ..aOS(6, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'predictRoute')
    ..aOS(7, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'healthRoute')
    ..hasRequiredFields = false
  ;
  ...
  'Use [GeneratedMessageGenericExtensions.rebuild] instead. '
  'Will be removed in next major version')
  ModelContainerSpec copyWith(void Function(ModelContainerSpec) updates) => super.copyWith((message) => updates(message as ModelContainerSpec)) as ModelContainerSpec; // ignore: deprecated_member_use
  $pb.BuilderInfo get info_ => _i;
  @$core.pragma('dart2js:noInline')
...
class Port extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'Port', package: const $pb.PackageName(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'google.cloud.aiplatform.v1beta1'), createEmptyInstance: create)
    ..a<$core.int>(3, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'containerPort', $pb.PbFieldType.O3)
    ..hasRequiredFields = false
  ;

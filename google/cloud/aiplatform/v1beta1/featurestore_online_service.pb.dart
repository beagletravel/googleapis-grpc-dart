...
class ReadFeatureValuesRequest extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'ReadFeatureValuesRequest', package: const $pb.PackageName(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'google.cloud.aiplatform.v1beta1'), createEmptyInstance: create)
    ...
    ..aOM<$1.FeatureSelector>(3, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'featureSelector', subBuilder: $1.FeatureSelector.create)
  ...
  'Will be removed in next major version')
  ReadFeatureValuesRequest copyWith(void Function(ReadFeatureValuesRequest) updates) => super.copyWith((message) => updates(message as ReadFeatureValuesRequest)) as ReadFeatureValuesRequest; // ignore: deprecated_member_use
  ...
  @$pb.TagNumber(3)
  set featureSelector($1.FeatureSelector v) { setField(3, v); }
  @$pb.TagNumber(3)
...
class ReadFeatureValuesResponse_FeatureDescriptor extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'ReadFeatureValuesResponse.FeatureDescriptor', package: const $pb.PackageName(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'google.cloud.aiplatform.v1beta1'), createEmptyInstance: create)
  ...
  'Use [GeneratedMessageGenericExtensions.rebuild] instead. '
  'Will be removed in next major version')
  ReadFeatureValuesResponse_FeatureDescriptor copyWith(void Function(ReadFeatureValuesResponse_FeatureDescriptor) updates) => super.copyWith((message) => updates(message as ReadFeatureValuesResponse_FeatureDescriptor)) as ReadFeatureValuesResponse_FeatureDescriptor; // ignore: deprecated_member_use
  $pb.BuilderInfo get info_ => _i;
  @$core.pragma('dart2js:noInline')
...
class ReadFeatureValuesResponse_Header extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'ReadFeatureValuesResponse.Header', package: const $pb.PackageName(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'google.cloud.aiplatform.v1beta1'), createEmptyInstance: create)
    ..aOS(1, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'entityType')
    ..pc<ReadFeatureValuesResponse_FeatureDescriptor>(2, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'featureDescriptors', $pb.PbFieldType.PM, subBuilder: ReadFeatureValuesResponse_FeatureDescriptor.create)
    ..hasRequiredFields = false
  ;
  ...
  'Use [GeneratedMessageGenericExtensions.rebuild] instead. '
  'Will be removed in next major version')
  ReadFeatureValuesResponse_Header copyWith(void Function(ReadFeatureValuesResponse_Header) updates) => super.copyWith((message) => updates(message as ReadFeatureValuesResponse_Header)) as ReadFeatureValuesResponse_Header; // ignore: deprecated_member_use
  $pb.BuilderInfo get info_ => _i;
  @$core.pragma('dart2js:noInline')
...
class ReadFeatureValuesResponse_EntityView_Data extends $pb.GeneratedMessage {
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'ReadFeatureValuesResponse.EntityView.Data', package: const $pb.PackageName(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'google.cloud.aiplatform.v1beta1'), createEmptyInstance: create)
    ..oo(0, [1, 2])
    ..aOM<FeatureValue>(1, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'value', subBuilder: FeatureValue.create)
    ..aOM<FeatureValueList>(2, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'values', subBuilder: FeatureValueList.create)
    ..hasRequiredFields = false
  ;
  ...
  'Use [GeneratedMessageGenericExtensions.rebuild] instead. '
  'Will be removed in next major version')
  ReadFeatureValuesResponse_EntityView_Data copyWith(void Function(ReadFeatureValuesResponse_EntityView_Data) updates) => super.copyWith((message) => updates(message as ReadFeatureValuesResponse_EntityView_Data)) as ReadFeatureValuesResponse_EntityView_Data; // ignore: deprecated_member_use
  $pb.BuilderInfo get info_ => _i;
  @$core.pragma('dart2js:noInline')
...
class ReadFeatureValuesResponse_EntityView extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'ReadFeatureValuesResponse.EntityView', package: const $pb.PackageName(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'google.cloud.aiplatform.v1beta1'), createEmptyInstance: create)
    ..aOS(1, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'entityId')
    ..pc<ReadFeatureValuesResponse_EntityView_Data>(2, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'data', $pb.PbFieldType.PM, subBuilder: ReadFeatureValuesResponse_EntityView_Data.create)
    ..hasRequiredFields = false
  ;
  ...
  'Use [GeneratedMessageGenericExtensions.rebuild] instead. '
  'Will be removed in next major version')
  ReadFeatureValuesResponse_EntityView copyWith(void Function(ReadFeatureValuesResponse_EntityView) updates) => super.copyWith((message) => updates(message as ReadFeatureValuesResponse_EntityView)) as ReadFeatureValuesResponse_EntityView; // ignore: deprecated_member_use
  $pb.BuilderInfo get info_ => _i;
  @$core.pragma('dart2js:noInline')
...
class ReadFeatureValuesResponse extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'ReadFeatureValuesResponse', package: const $pb.PackageName(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'google.cloud.aiplatform.v1beta1'), createEmptyInstance: create)
    ..aOM<ReadFeatureValuesResponse_Header>(1, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'header', subBuilder: ReadFeatureValuesResponse_Header.create)
    ..aOM<ReadFeatureValuesResponse_EntityView>(2, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'entityView', subBuilder: ReadFeatureValuesResponse_EntityView.create)
    ..hasRequiredFields = false
  ;
  ...
  'Use [GeneratedMessageGenericExtensions.rebuild] instead. '
  'Will be removed in next major version')
  ReadFeatureValuesResponse copyWith(void Function(ReadFeatureValuesResponse) updates) => super.copyWith((message) => updates(message as ReadFeatureValuesResponse)) as ReadFeatureValuesResponse; // ignore: deprecated_member_use
  $pb.BuilderInfo get info_ => _i;
  @$core.pragma('dart2js:noInline')
...
class StreamingReadFeatureValuesRequest extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'StreamingReadFeatureValuesRequest', package: const $pb.PackageName(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'google.cloud.aiplatform.v1beta1'), createEmptyInstance: create)
    ..aOS(1, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'entityType')
  ...
  'Use [GeneratedMessageGenericExtensions.rebuild] instead. '
  'Will be removed in next major version')
  StreamingReadFeatureValuesRequest copyWith(void Function(StreamingReadFeatureValuesRequest) updates) => super.copyWith((message) => updates(message as StreamingReadFeatureValuesRequest)) as StreamingReadFeatureValuesRequest; // ignore: deprecated_member_use
  $pb.BuilderInfo get info_ => _i;
  @$core.pragma('dart2js:noInline')
...
class FeatureValue_Metadata extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'FeatureValue.Metadata', package: const $pb.PackageName(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'google.cloud.aiplatform.v1beta1'), createEmptyInstance: create)
    ..aOM<$3.Timestamp>(1, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'generateTime', subBuilder: $3.Timestamp.create)
    ..hasRequiredFields = false
  ;
  ...
  'Use [GeneratedMessageGenericExtensions.rebuild] instead. '
  'Will be removed in next major version')
  FeatureValue_Metadata copyWith(void Function(FeatureValue_Metadata) updates) => super.copyWith((message) => updates(message as FeatureValue_Metadata)) as FeatureValue_Metadata; // ignore: deprecated_member_use
  $pb.BuilderInfo get info_ => _i;
  @$core.pragma('dart2js:noInline')
  ...
  @$pb.TagNumber(1)
  set generateTime($3.Timestamp v) { setField(1, v); }
  @$pb.TagNumber(1)
...
class FeatureValue extends $pb.GeneratedMessage {
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'FeatureValue', package: const $pb.PackageName(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'google.cloud.aiplatform.v1beta1'), createEmptyInstance: create)
    ...
    ..aOM<$2.BoolArray>(7, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'boolArrayValue', subBuilder: $2.BoolArray.create)
    ..aOM<$2.DoubleArray>(8, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'doubleArrayValue', subBuilder: $2.DoubleArray.create)
    ..aOM<$2.Int64Array>(11, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'int64ArrayValue', subBuilder: $2.Int64Array.create)
    ..aOM<$2.StringArray>(12, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'stringArrayValue', subBuilder: $2.StringArray.create)
    ..a<$core.List<$core.int>>(13, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'bytesValue', $pb.PbFieldType.OY)
    ..aOM<FeatureValue_Metadata>(14, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'metadata', subBuilder: FeatureValue_Metadata.create)
    ..hasRequiredFields = false
  ;
  ...
  'Use [GeneratedMessageGenericExtensions.rebuild] instead. '
  'Will be removed in next major version')
  FeatureValue copyWith(void Function(FeatureValue) updates) => super.copyWith((message) => updates(message as FeatureValue)) as FeatureValue; // ignore: deprecated_member_use
  $pb.BuilderInfo get info_ => _i;
  @$core.pragma('dart2js:noInline')
  ...
  @$pb.TagNumber(7)
  set boolArrayValue($2.BoolArray v) { setField(7, v); }
  @$pb.TagNumber(7)
  ...
  @$pb.TagNumber(8)
  set doubleArrayValue($2.DoubleArray v) { setField(8, v); }
  @$pb.TagNumber(8)
  ...
  @$pb.TagNumber(11)
  set int64ArrayValue($2.Int64Array v) { setField(11, v); }
  @$pb.TagNumber(11)
  ...
  @$pb.TagNumber(12)
  set stringArrayValue($2.StringArray v) { setField(12, v); }
  @$pb.TagNumber(12)
...
class FeatureValueList extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'FeatureValueList', package: const $pb.PackageName(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'google.cloud.aiplatform.v1beta1'), createEmptyInstance: create)
    ..pc<FeatureValue>(1, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'values', $pb.PbFieldType.PM, subBuilder: FeatureValue.create)
    ..hasRequiredFields = false
  ;
  ...
  'Use [GeneratedMessageGenericExtensions.rebuild] instead. '
  'Will be removed in next major version')
  FeatureValueList copyWith(void Function(FeatureValueList) updates) => super.copyWith((message) => updates(message as FeatureValueList)) as FeatureValueList; // ignore: deprecated_member_use
  $pb.BuilderInfo get info_ => _i;
  @$core.pragma('dart2js:noInline')

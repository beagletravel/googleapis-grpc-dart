...
class ModelMonitoringObjectiveConfig_ExplanationConfig_ExplanationBaseline_PredictionFormat extends $pb.ProtobufEnum {
  static const ModelMonitoringObjectiveConfig_ExplanationConfig_ExplanationBaseline_PredictionFormat PREDICTION_FORMAT_UNSPECIFIED = ModelMonitoringObjectiveConfig_ExplanationConfig_ExplanationBaseline_PredictionFormat._(0, const $core.bool.fromEnvironment('protobuf.omit_enum_names') ? '' : 'PREDICTION_FORMAT_UNSPECIFIED');
  static const ModelMonitoringObjectiveConfig_ExplanationConfig_ExplanationBaseline_PredictionFormat JSONL = ModelMonitoringObjectiveConfig_ExplanationConfig_ExplanationBaseline_PredictionFormat._(2, const $core.bool.fromEnvironment('protobuf.omit_enum_names') ? '' : 'JSONL');
  static const ModelMonitoringObjectiveConfig_ExplanationConfig_ExplanationBaseline_PredictionFormat BIGQUERY = ModelMonitoringObjectiveConfig_ExplanationConfig_ExplanationBaseline_PredictionFormat._(3, const $core.bool.fromEnvironment('protobuf.omit_enum_names') ? '' : 'BIGQUERY');

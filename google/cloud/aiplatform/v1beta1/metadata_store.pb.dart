...
class MetadataStore_MetadataStoreState extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'MetadataStore.MetadataStoreState', package: const $pb.PackageName(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'google.cloud.aiplatform.v1beta1'), createEmptyInstance: create)
    ..aInt64(1, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'diskUtilizationBytes')
  ...
  'Will be removed in next major version')
  MetadataStore_MetadataStoreState copyWith(void Function(MetadataStore_MetadataStoreState) updates) => super.copyWith((message) => updates(message as MetadataStore_MetadataStoreState)) as MetadataStore_MetadataStoreState; // ignore: deprecated_member_use
...
class MetadataStore extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'MetadataStore', package: const $pb.PackageName(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'google.cloud.aiplatform.v1beta1'), createEmptyInstance: create)
    ...
    ..aOM<$1.EncryptionSpec>(5, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'encryptionSpec', subBuilder: $1.EncryptionSpec.create)
    ..aOS(6, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'description')
    ..aOM<MetadataStore_MetadataStoreState>(7, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'state', subBuilder: MetadataStore_MetadataStoreState.create)
    ..hasRequiredFields = false
  ;
  ...
  'Use [GeneratedMessageGenericExtensions.rebuild] instead. '
  'Will be removed in next major version')
  MetadataStore copyWith(void Function(MetadataStore) updates) => super.copyWith((message) => updates(message as MetadataStore)) as MetadataStore; // ignore: deprecated_member_use
  $pb.BuilderInfo get info_ => _i;
  @$core.pragma('dart2js:noInline')
  ...
  @$pb.TagNumber(5)
  set encryptionSpec($1.EncryptionSpec v) { setField(5, v); }
  @$pb.TagNumber(5)

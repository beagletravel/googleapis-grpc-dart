...
const TensorboardTimeSeries$json = const {
  ...
  '2': const [
    ...
    const {'1': 'value_type', '3': 4, '4': 1, '5': 14, '6': '.google.cloud.aiplatform.v1beta1.TensorboardTimeSeries.ValueType', '8': const {}, '10': 'valueType'},
    ...
    const {'1': 'plugin_name', '3': 8, '4': 1, '5': 9, '8': const {}, '10': 'pluginName'},
    const {'1': 'plugin_data', '3': 9, '4': 1, '5': 12, '10': 'pluginData'},
    const {'1': 'metadata', '3': 10, '4': 1, '5': 11, '6': '.google.cloud.aiplatform.v1beta1.TensorboardTimeSeries.Metadata', '8': const {}, '10': 'metadata'},
  ],
...
const TensorboardTimeSeries_Metadata$json = const {
  '1': 'Metadata',
  '2': const [
    const {'1': 'max_step', '3': 1, '4': 1, '5': 3, '8': const {}, '10': 'maxStep'},
    const {'1': 'max_wall_time', '3': 2, '4': 1, '5': 11, '6': '.google.protobuf.Timestamp', '8': const {}, '10': 'maxWallTime'},
    const {'1': 'max_blob_sequence_length', '3': 3, '4': 1, '5': 3, '8': const {}, '10': 'maxBlobSequenceLength'},
  ],
};
...
final $typed_data.Uint8List tensorboardTimeSeriesDescriptor = $convert.base64Decode('');

...
class OnlinePredictionLogEntry extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'OnlinePredictionLogEntry', package: const $pb.PackageName(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'google.cloud.aiplatform.logging'), createEmptyInstance: create)
    ...
    ..aInt64(3, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'instanceCount')
    ..aInt64(4, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'predictionCount')
    ..aOM<$0.Status>(5, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'error', subBuilder: $0.Status.create)
  ...
  'Will be removed in next major version')
  OnlinePredictionLogEntry copyWith(void Function(OnlinePredictionLogEntry) updates) => super.copyWith((message) => updates(message as OnlinePredictionLogEntry)) as OnlinePredictionLogEntry; // ignore: deprecated_member_use
  ...
  @$pb.TagNumber(5)
  set error($0.Status v) { setField(5, v); }
  @$pb.TagNumber(5)

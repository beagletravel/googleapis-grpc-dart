...
const FeatureStatsAnomaly$json = const {
  ...
  '2': const [
    ...
    const {'1': 'distribution_deviation', '3': 5, '4': 1, '5': 1, '10': 'distributionDeviation'},
    const {'1': 'anomaly_detection_threshold', '3': 9, '4': 1, '5': 1, '10': 'anomalyDetectionThreshold'},
...
final $typed_data.Uint8List featureStatsAnomalyDescriptor = $convert.base64Decode('');

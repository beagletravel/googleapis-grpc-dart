...
class AutoMlTables extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'AutoMlTables', package: const $pb.PackageName(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'google.cloud.aiplatform.v1.schema.trainingjob.definition'), createEmptyInstance: create)
    ..aOM<AutoMlTablesInputs>(1, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'inputs', subBuilder: AutoMlTablesInputs.create)
    ..aOM<AutoMlTablesMetadata>(2, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'metadata', subBuilder: AutoMlTablesMetadata.create)
  ...
  'Will be removed in next major version')
  AutoMlTables copyWith(void Function(AutoMlTables) updates) => super.copyWith((message) => updates(message as AutoMlTables)) as AutoMlTables; // ignore: deprecated_member_use
...
class AutoMlTablesInputs_Transformation_AutoTransformation extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'AutoMlTablesInputs.Transformation.AutoTransformation', package: const $pb.PackageName(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'google.cloud.aiplatform.v1.schema.trainingjob.definition'), createEmptyInstance: create)
  ...
  'Use [GeneratedMessageGenericExtensions.rebuild] instead. '
  'Will be removed in next major version')
  AutoMlTablesInputs_Transformation_AutoTransformation copyWith(void Function(AutoMlTablesInputs_Transformation_AutoTransformation) updates) => super.copyWith((message) => updates(message as AutoMlTablesInputs_Transformation_AutoTransformation)) as AutoMlTablesInputs_Transformation_AutoTransformation; // ignore: deprecated_member_use
  $pb.BuilderInfo get info_ => _i;
  @$core.pragma('dart2js:noInline')
...
class AutoMlTablesInputs_Transformation_NumericTransformation extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'AutoMlTablesInputs.Transformation.NumericTransformation', package: const $pb.PackageName(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'google.cloud.aiplatform.v1.schema.trainingjob.definition'), createEmptyInstance: create)
    ..aOS(1, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'columnName')
    ..aOB(2, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'invalidValuesAllowed')
    ..hasRequiredFields = false
  ;
  ...
  'Use [GeneratedMessageGenericExtensions.rebuild] instead. '
  'Will be removed in next major version')
  AutoMlTablesInputs_Transformation_NumericTransformation copyWith(void Function(AutoMlTablesInputs_Transformation_NumericTransformation) updates) => super.copyWith((message) => updates(message as AutoMlTablesInputs_Transformation_NumericTransformation)) as AutoMlTablesInputs_Transformation_NumericTransformation; // ignore: deprecated_member_use
  $pb.BuilderInfo get info_ => _i;
  @$core.pragma('dart2js:noInline')
...
class AutoMlTablesInputs_Transformation_CategoricalTransformation extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'AutoMlTablesInputs.Transformation.CategoricalTransformation', package: const $pb.PackageName(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'google.cloud.aiplatform.v1.schema.trainingjob.definition'), createEmptyInstance: create)
    ..aOS(1, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'columnName')
    ..hasRequiredFields = false
  ;
  ...
  'Use [GeneratedMessageGenericExtensions.rebuild] instead. '
  'Will be removed in next major version')
  AutoMlTablesInputs_Transformation_CategoricalTransformation copyWith(void Function(AutoMlTablesInputs_Transformation_CategoricalTransformation) updates) => super.copyWith((message) => updates(message as AutoMlTablesInputs_Transformation_CategoricalTransformation)) as AutoMlTablesInputs_Transformation_CategoricalTransformation; // ignore: deprecated_member_use
  $pb.BuilderInfo get info_ => _i;
  @$core.pragma('dart2js:noInline')
...
class AutoMlTablesInputs_Transformation_TimestampTransformation extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'AutoMlTablesInputs.Transformation.TimestampTransformation', package: const $pb.PackageName(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'google.cloud.aiplatform.v1.schema.trainingjob.definition'), createEmptyInstance: create)
    ..aOS(1, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'columnName')
    ..aOS(2, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'timeFormat')
    ..aOB(3, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'invalidValuesAllowed')
    ..hasRequiredFields = false
  ;
...
class AutoMlTablesInputs_Transformation_TextTransformation extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'AutoMlTablesInputs.Transformation.TextTransformation', package: const $pb.PackageName(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'google.cloud.aiplatform.v1.schema.trainingjob.definition'), createEmptyInstance: create)
    ..aOS(1, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'columnName')
    ..hasRequiredFields = false
  ;
  ...
  'Use [GeneratedMessageGenericExtensions.rebuild] instead. '
  'Will be removed in next major version')
  AutoMlTablesInputs_Transformation_TextTransformation copyWith(void Function(AutoMlTablesInputs_Transformation_TextTransformation) updates) => super.copyWith((message) => updates(message as AutoMlTablesInputs_Transformation_TextTransformation)) as AutoMlTablesInputs_Transformation_TextTransformation; // ignore: deprecated_member_use
  $pb.BuilderInfo get info_ => _i;
  @$core.pragma('dart2js:noInline')
...
class AutoMlTablesInputs_Transformation_NumericArrayTransformation extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'AutoMlTablesInputs.Transformation.NumericArrayTransformation', package: const $pb.PackageName(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'google.cloud.aiplatform.v1.schema.trainingjob.definition'), createEmptyInstance: create)
    ..aOS(1, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'columnName')
    ..aOB(2, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'invalidValuesAllowed')
    ..hasRequiredFields = false
  ;
  ...
  'Use [GeneratedMessageGenericExtensions.rebuild] instead. '
  'Will be removed in next major version')
  AutoMlTablesInputs_Transformation_NumericArrayTransformation copyWith(void Function(AutoMlTablesInputs_Transformation_NumericArrayTransformation) updates) => super.copyWith((message) => updates(message as AutoMlTablesInputs_Transformation_NumericArrayTransformation)) as AutoMlTablesInputs_Transformation_NumericArrayTransformation; // ignore: deprecated_member_use
  $pb.BuilderInfo get info_ => _i;
  @$core.pragma('dart2js:noInline')
...
class AutoMlTablesInputs_Transformation_CategoricalArrayTransformation extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'AutoMlTablesInputs.Transformation.CategoricalArrayTransformation', package: const $pb.PackageName(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'google.cloud.aiplatform.v1.schema.trainingjob.definition'), createEmptyInstance: create)
    ..aOS(1, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'columnName')
    ..hasRequiredFields = false
  ;
  ...
  'Use [GeneratedMessageGenericExtensions.rebuild] instead. '
  'Will be removed in next major version')
  AutoMlTablesInputs_Transformation_CategoricalArrayTransformation copyWith(void Function(AutoMlTablesInputs_Transformation_CategoricalArrayTransformation) updates) => super.copyWith((message) => updates(message as AutoMlTablesInputs_Transformation_CategoricalArrayTransformation)) as AutoMlTablesInputs_Transformation_CategoricalArrayTransformation; // ignore: deprecated_member_use
  $pb.BuilderInfo get info_ => _i;
  @$core.pragma('dart2js:noInline')
...
class AutoMlTablesInputs_Transformation_TextArrayTransformation extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'AutoMlTablesInputs.Transformation.TextArrayTransformation', package: const $pb.PackageName(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'google.cloud.aiplatform.v1.schema.trainingjob.definition'), createEmptyInstance: create)
    ..aOS(1, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'columnName')
    ..hasRequiredFields = false
  ;
  ...
  'Use [GeneratedMessageGenericExtensions.rebuild] instead. '
  'Will be removed in next major version')
  AutoMlTablesInputs_Transformation_TextArrayTransformation copyWith(void Function(AutoMlTablesInputs_Transformation_TextArrayTransformation) updates) => super.copyWith((message) => updates(message as AutoMlTablesInputs_Transformation_TextArrayTransformation)) as AutoMlTablesInputs_Transformation_TextArrayTransformation; // ignore: deprecated_member_use
  $pb.BuilderInfo get info_ => _i;
  @$core.pragma('dart2js:noInline')
...
class AutoMlTablesInputs_Transformation extends $pb.GeneratedMessage {
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'AutoMlTablesInputs.Transformation', package: const $pb.PackageName(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'google.cloud.aiplatform.v1.schema.trainingjob.definition'), createEmptyInstance: create)
    ..oo(0, [1, 2, 3, 4, 5, 6, 7, 8])
    ..aOM<AutoMlTablesInputs_Transformation_AutoTransformation>(1, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'auto', subBuilder: AutoMlTablesInputs_Transformation_AutoTransformation.create)
    ..aOM<AutoMlTablesInputs_Transformation_NumericTransformation>(2, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'numeric', subBuilder: AutoMlTablesInputs_Transformation_NumericTransformation.create)
    ..aOM<AutoMlTablesInputs_Transformation_CategoricalTransformation>(3, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'categorical', subBuilder: AutoMlTablesInputs_Transformation_CategoricalTransformation.create)
    ..aOM<AutoMlTablesInputs_Transformation_TimestampTransformation>(4, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'timestamp', subBuilder: AutoMlTablesInputs_Transformation_TimestampTransformation.create)
    ..aOM<AutoMlTablesInputs_Transformation_TextTransformation>(5, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'text', subBuilder: AutoMlTablesInputs_Transformation_TextTransformation.create)
    ..aOM<AutoMlTablesInputs_Transformation_NumericArrayTransformation>(6, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'repeatedNumeric', subBuilder: AutoMlTablesInputs_Transformation_NumericArrayTransformation.create)
    ..aOM<AutoMlTablesInputs_Transformation_CategoricalArrayTransformation>(7, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'repeatedCategorical', subBuilder: AutoMlTablesInputs_Transformation_CategoricalArrayTransformation.create)
    ..aOM<AutoMlTablesInputs_Transformation_TextArrayTransformation>(8, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'repeatedText', subBuilder: AutoMlTablesInputs_Transformation_TextArrayTransformation.create)
    ..hasRequiredFields = false
  ;
  ...
  'Use [GeneratedMessageGenericExtensions.rebuild] instead. '
  'Will be removed in next major version')
  AutoMlTablesInputs_Transformation copyWith(void Function(AutoMlTablesInputs_Transformation) updates) => super.copyWith((message) => updates(message as AutoMlTablesInputs_Transformation)) as AutoMlTablesInputs_Transformation; // ignore: deprecated_member_use
  $pb.BuilderInfo get info_ => _i;
  @$core.pragma('dart2js:noInline')
...
class AutoMlTablesInputs extends $pb.GeneratedMessage {
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'AutoMlTablesInputs', package: const $pb.PackageName(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'google.cloud.aiplatform.v1.schema.trainingjob.definition'), createEmptyInstance: create)
    ..oo(0, [5, 6])
    ..aOS(1, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'predictionType')
    ..aOS(2, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'targetColumn')
    ..pc<AutoMlTablesInputs_Transformation>(3, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'transformations', $pb.PbFieldType.PM, subBuilder: AutoMlTablesInputs_Transformation.create)
    ..aOS(4, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'optimizationObjective')
    ..a<$core.double>(5, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'optimizationObjectiveRecallValue', $pb.PbFieldType.OF)
    ..a<$core.double>(6, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'optimizationObjectivePrecisionValue', $pb.PbFieldType.OF)
    ..aInt64(7, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'trainBudgetMilliNodeHours')
    ..aOB(8, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'disableEarlyStopping')
    ..aOS(9, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'weightColumnName')
    ..aOM<$0.ExportEvaluatedDataItemsConfig>(10, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'exportEvaluatedDataItemsConfig', subBuilder: $0.ExportEvaluatedDataItemsConfig.create)
    ..pPS(11, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'additionalExperiments')
    ..hasRequiredFields = false
  ;
  ...
  factory AutoMlTablesInputs({
    ...
    if (optimizationObjectiveRecallValue != null) {
      _result.optimizationObjectiveRecallValue = optimizationObjectiveRecallValue;
    }
    if (optimizationObjectivePrecisionValue != null) {
      _result.optimizationObjectivePrecisionValue = optimizationObjectivePrecisionValue;
    }
  ...
  'Use [GeneratedMessageGenericExtensions.rebuild] instead. '
  'Will be removed in next major version')
  AutoMlTablesInputs copyWith(void Function(AutoMlTablesInputs) updates) => super.copyWith((message) => updates(message as AutoMlTablesInputs)) as AutoMlTablesInputs; // ignore: deprecated_member_use
  $pb.BuilderInfo get info_ => _i;
  @$core.pragma('dart2js:noInline')
  ...
  @$pb.TagNumber(10)
  $0.ExportEvaluatedDataItemsConfig get exportEvaluatedDataItemsConfig => $_getN(9);
  @$pb.TagNumber(10)
  set exportEvaluatedDataItemsConfig($0.ExportEvaluatedDataItemsConfig v) { setField(10, v); }
  @$pb.TagNumber(10)
  $core.bool hasExportEvaluatedDataItemsConfig() => $_has(9);
  @$pb.TagNumber(10)
  void clearExportEvaluatedDataItemsConfig() => clearField(10);
  @$pb.TagNumber(10)
  $0.ExportEvaluatedDataItemsConfig ensureExportEvaluatedDataItemsConfig() => $_ensure(9);
...
class AutoMlTablesMetadata extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'AutoMlTablesMetadata', package: const $pb.PackageName(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'google.cloud.aiplatform.v1.schema.trainingjob.definition'), createEmptyInstance: create)
    ..aInt64(1, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'trainCostMilliNodeHours')
    ..hasRequiredFields = false
  ;
  ...
  'Use [GeneratedMessageGenericExtensions.rebuild] instead. '
  'Will be removed in next major version')
  AutoMlTablesMetadata copyWith(void Function(AutoMlTablesMetadata) updates) => super.copyWith((message) => updates(message as AutoMlTablesMetadata)) as AutoMlTablesMetadata; // ignore: deprecated_member_use
  $pb.BuilderInfo get info_ => _i;
  @$core.pragma('dart2js:noInline')

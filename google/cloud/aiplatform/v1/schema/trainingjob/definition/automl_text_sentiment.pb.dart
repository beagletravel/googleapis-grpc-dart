...
class AutoMlTextSentiment extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'AutoMlTextSentiment', package: const $pb.PackageName(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'google.cloud.aiplatform.v1.schema.trainingjob.definition'), createEmptyInstance: create)
    ..aOM<AutoMlTextSentimentInputs>(1, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'inputs', subBuilder: AutoMlTextSentimentInputs.create)
  ...
  'Will be removed in next major version')
  AutoMlTextSentiment copyWith(void Function(AutoMlTextSentiment) updates) => super.copyWith((message) => updates(message as AutoMlTextSentiment)) as AutoMlTextSentiment; // ignore: deprecated_member_use
...
class AutoMlTextSentimentInputs extends $pb.GeneratedMessage {
  ...
  'Use [GeneratedMessageGenericExtensions.rebuild] instead. '
  'Will be removed in next major version')
  AutoMlTextSentimentInputs copyWith(void Function(AutoMlTextSentimentInputs) updates) => super.copyWith((message) => updates(message as AutoMlTextSentimentInputs)) as AutoMlTextSentimentInputs; // ignore: deprecated_member_use
  $pb.BuilderInfo get info_ => _i;
  @$core.pragma('dart2js:noInline')

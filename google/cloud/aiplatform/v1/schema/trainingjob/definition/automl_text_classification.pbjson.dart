...
const AutoMlTextClassification$json = const {
  ...
  '2': const [
    const {'1': 'inputs', '3': 1, '4': 1, '5': 11, '6': '.google.cloud.aiplatform.v1.schema.trainingjob.definition.AutoMlTextClassificationInputs', '10': 'inputs'},
  ],
};

/// Descriptor for `AutoMlTextClassification`. Decode as a `google.protobuf.DescriptorProto`.
final $typed_data.Uint8List autoMlTextClassificationDescriptor = $convert.base64Decode('ChhBdXRvTWxUZXh0Q2xhc3NpZmljYXRpb24ScAoGaW5wdXRzGAEgASgLMlguZ29vZ2xlLmNsb3VkLmFpcGxhdGZvcm0udjEuc2NoZW1hLnRyYWluaW5nam9iLmRlZmluaXRpb24uQXV0b01sVGV4dENsYXNzaWZpY2F0aW9uSW5wdXRzUgZpbnB1dHM=');

...
class AutoMlTextExtraction extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'AutoMlTextExtraction', package: const $pb.PackageName(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'google.cloud.aiplatform.v1.schema.trainingjob.definition'), createEmptyInstance: create)
    ..aOM<AutoMlTextExtractionInputs>(1, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'inputs', subBuilder: AutoMlTextExtractionInputs.create)
  ...
  'Will be removed in next major version')
  AutoMlTextExtraction copyWith(void Function(AutoMlTextExtraction) updates) => super.copyWith((message) => updates(message as AutoMlTextExtraction)) as AutoMlTextExtraction; // ignore: deprecated_member_use
...
class AutoMlTextExtractionInputs extends $pb.GeneratedMessage {
  ...
  'Use [GeneratedMessageGenericExtensions.rebuild] instead. '
  'Will be removed in next major version')
  AutoMlTextExtractionInputs copyWith(void Function(AutoMlTextExtractionInputs) updates) => super.copyWith((message) => updates(message as AutoMlTextExtractionInputs)) as AutoMlTextExtractionInputs; // ignore: deprecated_member_use
  $pb.BuilderInfo get info_ => _i;
  @$core.pragma('dart2js:noInline')

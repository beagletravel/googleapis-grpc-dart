...
const AutoMlTextSentiment$json = const {
  ...
  '2': const [
    const {'1': 'inputs', '3': 1, '4': 1, '5': 11, '6': '.google.cloud.aiplatform.v1.schema.trainingjob.definition.AutoMlTextSentimentInputs', '10': 'inputs'},
  ],
};

/// Descriptor for `AutoMlTextSentiment`. Decode as a `google.protobuf.DescriptorProto`.
final $typed_data.Uint8List autoMlTextSentimentDescriptor = $convert.base64Decode('ChNBdXRvTWxUZXh0U2VudGltZW50EmsKBmlucHV0cxgBIAEoCzJTLmdvb2dsZS5jbG91ZC5haXBsYXRmb3JtLnYxLnNjaGVtYS50cmFpbmluZ2pvYi5kZWZpbml0aW9uLkF1dG9NbFRleHRTZW50aW1lbnRJbnB1dHNSBmlucHV0cw==');

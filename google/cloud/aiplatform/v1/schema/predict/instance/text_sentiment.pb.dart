...
class TextSentimentPredictionInstance extends $pb.GeneratedMessage {
  ...
  'Will be removed in next major version')
  TextSentimentPredictionInstance copyWith(void Function(TextSentimentPredictionInstance) updates) => super.copyWith((message) => updates(message as TextSentimentPredictionInstance)) as TextSentimentPredictionInstance; // ignore: deprecated_member_use

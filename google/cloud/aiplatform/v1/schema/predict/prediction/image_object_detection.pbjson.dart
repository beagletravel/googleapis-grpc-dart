...
const ImageObjectDetectionPredictionResult$json = const {
  ...
  '2': const [
    ...
    const {'1': 'bboxes', '3': 4, '4': 3, '5': 11, '6': '.google.protobuf.ListValue', '10': 'bboxes'},
  ],
};

/// Descriptor for `ImageObjectDetectionPredictionResult`. Decode as a `google.protobuf.DescriptorProto`.
final $typed_data.Uint8List imageObjectDetectionPredictionResultDescriptor = $convert.base64Decode('CiRJbWFnZU9iamVjdERldGVjdGlvblByZWRpY3Rpb25SZXN1bHQSEAoDaWRzGAEgAygDUgNpZHMSIwoNZGlzcGxheV9uYW1lcxgCIAMoCVIMZGlzcGxheU5hbWVzEiAKC2NvbmZpZGVuY2VzGAMgAygCUgtjb25maWRlbmNlcxIyCgZiYm94ZXMYBCADKAsyGi5nb29nbGUucHJvdG9idWYuTGlzdFZhbHVlUgZiYm94ZXM=');

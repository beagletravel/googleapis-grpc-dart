...
class VideoClassificationPredictionParams extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'VideoClassificationPredictionParams', package: const $pb.PackageName(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'google.cloud.aiplatform.v1.schema.predict.params'), createEmptyInstance: create)
    ...
    ..aOB(3, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'segmentClassification')
    ..aOB(4, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'shotClassification')
    ..aOB(5, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'oneSecIntervalClassification')
  ...
  'Will be removed in next major version')
  VideoClassificationPredictionParams copyWith(void Function(VideoClassificationPredictionParams) updates) => super.copyWith((message) => updates(message as VideoClassificationPredictionParams)) as VideoClassificationPredictionParams; // ignore: deprecated_member_use

...
class ImageClassificationPredictionParams extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'ImageClassificationPredictionParams', package: const $pb.PackageName(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'google.cloud.aiplatform.v1.schema.predict.params'), createEmptyInstance: create)
  ...
  'Will be removed in next major version')
  ImageClassificationPredictionParams copyWith(void Function(ImageClassificationPredictionParams) updates) => super.copyWith((message) => updates(message as ImageClassificationPredictionParams)) as ImageClassificationPredictionParams; // ignore: deprecated_member_use

...
class ModelMonitoringObjectiveConfig_TrainingDataset extends $pb.GeneratedMessage {
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'ModelMonitoringObjectiveConfig.TrainingDataset', package: const $pb.PackageName(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'google.cloud.aiplatform.v1'), createEmptyInstance: create)
    ..oo(0, [3, 4, 5])
    ..aOS(2, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'dataFormat')
    ..aOS(3, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'dataset')
    ..aOM<$0.GcsSource>(4, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'gcsSource', subBuilder: $0.GcsSource.create)
    ..aOM<$0.BigQuerySource>(5, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'bigquerySource', subBuilder: $0.BigQuerySource.create)
    ..aOS(6, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'targetField')
    ..aOM<SamplingStrategy>(7, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'loggingSamplingStrategy', subBuilder: SamplingStrategy.create)
  ...
  'Will be removed in next major version')
  ModelMonitoringObjectiveConfig_TrainingDataset copyWith(void Function(ModelMonitoringObjectiveConfig_TrainingDataset) updates) => super.copyWith((message) => updates(message as ModelMonitoringObjectiveConfig_TrainingDataset)) as ModelMonitoringObjectiveConfig_TrainingDataset; // ignore: deprecated_member_use
  ...
  @$pb.TagNumber(4)
  set gcsSource($0.GcsSource v) { setField(4, v); }
  @$pb.TagNumber(4)
  ...
  @$pb.TagNumber(5)
  set bigquerySource($0.BigQuerySource v) { setField(5, v); }
  @$pb.TagNumber(5)
...
class ModelMonitoringObjectiveConfig_TrainingPredictionSkewDetectionConfig extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'ModelMonitoringObjectiveConfig.TrainingPredictionSkewDetectionConfig', package: const $pb.PackageName(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'google.cloud.aiplatform.v1'), createEmptyInstance: create)
    ..m<$core.String, ThresholdConfig>(1, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'skewThresholds', entryClassName: 'ModelMonitoringObjectiveConfig.TrainingPredictionSkewDetectionConfig.SkewThresholdsEntry', keyFieldType: $pb.PbFieldType.OS, valueFieldType: $pb.PbFieldType.OM, valueCreator: ThresholdConfig.create, packageName: const $pb.PackageName('google.cloud.aiplatform.v1'))
    ..m<$core.String, ThresholdConfig>(2, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'attributionScoreSkewThresholds', entryClassName: 'ModelMonitoringObjectiveConfig.TrainingPredictionSkewDetectionConfig.AttributionScoreSkewThresholdsEntry', keyFieldType: $pb.PbFieldType.OS, valueFieldType: $pb.PbFieldType.OM, valueCreator: ThresholdConfig.create, packageName: const $pb.PackageName('google.cloud.aiplatform.v1'))
    ..hasRequiredFields = false
  ;
  ...
  factory ModelMonitoringObjectiveConfig_TrainingPredictionSkewDetectionConfig({
    ...
    if (attributionScoreSkewThresholds != null) {
      _result.attributionScoreSkewThresholds.addAll(attributionScoreSkewThresholds);
    }
    return _result;
  }
  ...
  'Use [GeneratedMessageGenericExtensions.rebuild] instead. '
  'Will be removed in next major version')
  ModelMonitoringObjectiveConfig_TrainingPredictionSkewDetectionConfig copyWith(void Function(ModelMonitoringObjectiveConfig_TrainingPredictionSkewDetectionConfig) updates) => super.copyWith((message) => updates(message as ModelMonitoringObjectiveConfig_TrainingPredictionSkewDetectionConfig)) as ModelMonitoringObjectiveConfig_TrainingPredictionSkewDetectionConfig; // ignore: deprecated_member_use
  $pb.BuilderInfo get info_ => _i;
  @$core.pragma('dart2js:noInline')
...
class ModelMonitoringObjectiveConfig_PredictionDriftDetectionConfig extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'ModelMonitoringObjectiveConfig.PredictionDriftDetectionConfig', package: const $pb.PackageName(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'google.cloud.aiplatform.v1'), createEmptyInstance: create)
    ..m<$core.String, ThresholdConfig>(1, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'driftThresholds', entryClassName: 'ModelMonitoringObjectiveConfig.PredictionDriftDetectionConfig.DriftThresholdsEntry', keyFieldType: $pb.PbFieldType.OS, valueFieldType: $pb.PbFieldType.OM, valueCreator: ThresholdConfig.create, packageName: const $pb.PackageName('google.cloud.aiplatform.v1'))
    ..m<$core.String, ThresholdConfig>(2, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'attributionScoreDriftThresholds', entryClassName: 'ModelMonitoringObjectiveConfig.PredictionDriftDetectionConfig.AttributionScoreDriftThresholdsEntry', keyFieldType: $pb.PbFieldType.OS, valueFieldType: $pb.PbFieldType.OM, valueCreator: ThresholdConfig.create, packageName: const $pb.PackageName('google.cloud.aiplatform.v1'))
    ..hasRequiredFields = false
  ;
  ...
  factory ModelMonitoringObjectiveConfig_PredictionDriftDetectionConfig({
    ...
    if (attributionScoreDriftThresholds != null) {
      _result.attributionScoreDriftThresholds.addAll(attributionScoreDriftThresholds);
    }
    return _result;
  }
  ...
  'Use [GeneratedMessageGenericExtensions.rebuild] instead. '
  'Will be removed in next major version')
  ModelMonitoringObjectiveConfig_PredictionDriftDetectionConfig copyWith(void Function(ModelMonitoringObjectiveConfig_PredictionDriftDetectionConfig) updates) => super.copyWith((message) => updates(message as ModelMonitoringObjectiveConfig_PredictionDriftDetectionConfig)) as ModelMonitoringObjectiveConfig_PredictionDriftDetectionConfig; // ignore: deprecated_member_use
  $pb.BuilderInfo get info_ => _i;
  @$core.pragma('dart2js:noInline')
...
class ModelMonitoringObjectiveConfig_ExplanationConfig_ExplanationBaseline extends $pb.GeneratedMessage {
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'ModelMonitoringObjectiveConfig.ExplanationConfig.ExplanationBaseline', package: const $pb.PackageName(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'google.cloud.aiplatform.v1'), createEmptyInstance: create)
    ..oo(0, [2, 3])
    ..e<ModelMonitoringObjectiveConfig_ExplanationConfig_ExplanationBaseline_PredictionFormat>(1, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'predictionFormat', $pb.PbFieldType.OE, defaultOrMaker: ModelMonitoringObjectiveConfig_ExplanationConfig_ExplanationBaseline_PredictionFormat.PREDICTION_FORMAT_UNSPECIFIED, valueOf: ModelMonitoringObjectiveConfig_ExplanationConfig_ExplanationBaseline_PredictionFormat.valueOf, enumValues: ModelMonitoringObjectiveConfig_ExplanationConfig_ExplanationBaseline_PredictionFormat.values)
    ..aOM<$0.GcsDestination>(2, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'gcs', subBuilder: $0.GcsDestination.create)
    ..aOM<$0.BigQueryDestination>(3, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'bigquery', subBuilder: $0.BigQueryDestination.create)
    ..hasRequiredFields = false
  ;
  ...
  @$pb.TagNumber(2)
  set gcs($0.GcsDestination v) { setField(2, v); }
  @$pb.TagNumber(2)
  ...
  @$pb.TagNumber(3)
  set bigquery($0.BigQueryDestination v) { setField(3, v); }
  @$pb.TagNumber(3)
...
class ModelMonitoringObjectiveConfig_ExplanationConfig extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'ModelMonitoringObjectiveConfig.ExplanationConfig', package: const $pb.PackageName(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'google.cloud.aiplatform.v1'), createEmptyInstance: create)
    ..aOB(1, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'enableFeatureAttributes')
    ..aOM<ModelMonitoringObjectiveConfig_ExplanationConfig_ExplanationBaseline>(2, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'explanationBaseline', subBuilder: ModelMonitoringObjectiveConfig_ExplanationConfig_ExplanationBaseline.create)
    ..hasRequiredFields = false
  ;
  ...
  'Use [GeneratedMessageGenericExtensions.rebuild] instead. '
  'Will be removed in next major version')
  ModelMonitoringObjectiveConfig_ExplanationConfig copyWith(void Function(ModelMonitoringObjectiveConfig_ExplanationConfig) updates) => super.copyWith((message) => updates(message as ModelMonitoringObjectiveConfig_ExplanationConfig)) as ModelMonitoringObjectiveConfig_ExplanationConfig; // ignore: deprecated_member_use
  $pb.BuilderInfo get info_ => _i;
  @$core.pragma('dart2js:noInline')
...
class ModelMonitoringObjectiveConfig extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'ModelMonitoringObjectiveConfig', package: const $pb.PackageName(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'google.cloud.aiplatform.v1'), createEmptyInstance: create)
    ..aOM<ModelMonitoringObjectiveConfig_TrainingDataset>(1, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'trainingDataset', subBuilder: ModelMonitoringObjectiveConfig_TrainingDataset.create)
    ..aOM<ModelMonitoringObjectiveConfig_TrainingPredictionSkewDetectionConfig>(2, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'trainingPredictionSkewDetectionConfig', subBuilder: ModelMonitoringObjectiveConfig_TrainingPredictionSkewDetectionConfig.create)
    ..aOM<ModelMonitoringObjectiveConfig_PredictionDriftDetectionConfig>(3, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'predictionDriftDetectionConfig', subBuilder: ModelMonitoringObjectiveConfig_PredictionDriftDetectionConfig.create)
    ..aOM<ModelMonitoringObjectiveConfig_ExplanationConfig>(5, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'explanationConfig', subBuilder: ModelMonitoringObjectiveConfig_ExplanationConfig.create)
    ..hasRequiredFields = false
  ;
  ...
  factory ModelMonitoringObjectiveConfig({
    ...
    if (trainingPredictionSkewDetectionConfig != null) {
      _result.trainingPredictionSkewDetectionConfig = trainingPredictionSkewDetectionConfig;
    }
  ...
  'Use [GeneratedMessageGenericExtensions.rebuild] instead. '
  'Will be removed in next major version')
  ModelMonitoringObjectiveConfig copyWith(void Function(ModelMonitoringObjectiveConfig) updates) => super.copyWith((message) => updates(message as ModelMonitoringObjectiveConfig)) as ModelMonitoringObjectiveConfig; // ignore: deprecated_member_use
  $pb.BuilderInfo get info_ => _i;
  @$core.pragma('dart2js:noInline')
...
class ModelMonitoringAlertConfig_EmailAlertConfig extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'ModelMonitoringAlertConfig.EmailAlertConfig', package: const $pb.PackageName(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'google.cloud.aiplatform.v1'), createEmptyInstance: create)
    ..pPS(1, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'userEmails')
    ..hasRequiredFields = false
  ;
  ...
  'Use [GeneratedMessageGenericExtensions.rebuild] instead. '
  'Will be removed in next major version')
  ModelMonitoringAlertConfig_EmailAlertConfig copyWith(void Function(ModelMonitoringAlertConfig_EmailAlertConfig) updates) => super.copyWith((message) => updates(message as ModelMonitoringAlertConfig_EmailAlertConfig)) as ModelMonitoringAlertConfig_EmailAlertConfig; // ignore: deprecated_member_use
  $pb.BuilderInfo get info_ => _i;
  @$core.pragma('dart2js:noInline')
...
class ModelMonitoringAlertConfig extends $pb.GeneratedMessage {
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'ModelMonitoringAlertConfig', package: const $pb.PackageName(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'google.cloud.aiplatform.v1'), createEmptyInstance: create)
    ..oo(0, [1])
    ..aOM<ModelMonitoringAlertConfig_EmailAlertConfig>(1, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'emailAlertConfig', subBuilder: ModelMonitoringAlertConfig_EmailAlertConfig.create)
    ..aOB(2, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'enableLogging')
    ..hasRequiredFields = false
  ;
  ...
  'Use [GeneratedMessageGenericExtensions.rebuild] instead. '
  'Will be removed in next major version')
  ModelMonitoringAlertConfig copyWith(void Function(ModelMonitoringAlertConfig) updates) => super.copyWith((message) => updates(message as ModelMonitoringAlertConfig)) as ModelMonitoringAlertConfig; // ignore: deprecated_member_use
  $pb.BuilderInfo get info_ => _i;
  @$core.pragma('dart2js:noInline')
...
class ThresholdConfig extends $pb.GeneratedMessage {
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'ThresholdConfig', package: const $pb.PackageName(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'google.cloud.aiplatform.v1'), createEmptyInstance: create)
    ..oo(0, [1])
  ...
  'Use [GeneratedMessageGenericExtensions.rebuild] instead. '
  'Will be removed in next major version')
  ThresholdConfig copyWith(void Function(ThresholdConfig) updates) => super.copyWith((message) => updates(message as ThresholdConfig)) as ThresholdConfig; // ignore: deprecated_member_use
  $pb.BuilderInfo get info_ => _i;
  @$core.pragma('dart2js:noInline')
...
class SamplingStrategy_RandomSampleConfig extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'SamplingStrategy.RandomSampleConfig', package: const $pb.PackageName(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'google.cloud.aiplatform.v1'), createEmptyInstance: create)
    ..a<$core.double>(1, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'sampleRate', $pb.PbFieldType.OD)
    ..hasRequiredFields = false
  ;
  ...
  'Use [GeneratedMessageGenericExtensions.rebuild] instead. '
  'Will be removed in next major version')
  SamplingStrategy_RandomSampleConfig copyWith(void Function(SamplingStrategy_RandomSampleConfig) updates) => super.copyWith((message) => updates(message as SamplingStrategy_RandomSampleConfig)) as SamplingStrategy_RandomSampleConfig; // ignore: deprecated_member_use
  $pb.BuilderInfo get info_ => _i;
  @$core.pragma('dart2js:noInline')
...
class SamplingStrategy extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'SamplingStrategy', package: const $pb.PackageName(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'google.cloud.aiplatform.v1'), createEmptyInstance: create)
    ..aOM<SamplingStrategy_RandomSampleConfig>(1, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'randomSampleConfig', subBuilder: SamplingStrategy_RandomSampleConfig.create)
    ..hasRequiredFields = false
  ;
  ...
  'Use [GeneratedMessageGenericExtensions.rebuild] instead. '
  'Will be removed in next major version')
  SamplingStrategy copyWith(void Function(SamplingStrategy) updates) => super.copyWith((message) => updates(message as SamplingStrategy)) as SamplingStrategy; // ignore: deprecated_member_use
  $pb.BuilderInfo get info_ => _i;
  @$core.pragma('dart2js:noInline')

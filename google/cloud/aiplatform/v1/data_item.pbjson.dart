...
const DataItem$json = const {
  ...
  '2': const [
    ...
    const {'1': 'labels', '3': 3, '4': 3, '5': 11, '6': '.google.cloud.aiplatform.v1.DataItem.LabelsEntry', '8': const {}, '10': 'labels'},
...
final $typed_data.Uint8List dataItemDescriptor = $convert.base64Decode('');

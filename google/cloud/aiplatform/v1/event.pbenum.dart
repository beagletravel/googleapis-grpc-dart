...
class Event_Type extends $pb.ProtobufEnum {
  ...
  static const Event_Type INPUT = Event_Type._(1, const $core.bool.fromEnvironment('protobuf.omit_enum_names') ? '' : 'INPUT');
  static const Event_Type OUTPUT = Event_Type._(2, const $core.bool.fromEnvironment('protobuf.omit_enum_names') ? '' : 'OUTPUT');

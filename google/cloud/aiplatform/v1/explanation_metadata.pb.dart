...
class ExplanationMetadata_InputMetadata_FeatureValueDomain extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'ExplanationMetadata.InputMetadata.FeatureValueDomain', package: const $pb.PackageName(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'google.cloud.aiplatform.v1'), createEmptyInstance: create)
    ..a<$core.double>(1, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'minValue', $pb.PbFieldType.OF)
    ..a<$core.double>(2, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'maxValue', $pb.PbFieldType.OF)
    ..a<$core.double>(3, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'originalMean', $pb.PbFieldType.OF)
    ..a<$core.double>(4, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'originalStddev', $pb.PbFieldType.OF)
  ...
  'Will be removed in next major version')
  ExplanationMetadata_InputMetadata_FeatureValueDomain copyWith(void Function(ExplanationMetadata_InputMetadata_FeatureValueDomain) updates) => super.copyWith((message) => updates(message as ExplanationMetadata_InputMetadata_FeatureValueDomain)) as ExplanationMetadata_InputMetadata_FeatureValueDomain; // ignore: deprecated_member_use
...
class ExplanationMetadata_InputMetadata_Visualization extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'ExplanationMetadata.InputMetadata.Visualization', package: const $pb.PackageName(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'google.cloud.aiplatform.v1'), createEmptyInstance: create)
    ..e<ExplanationMetadata_InputMetadata_Visualization_Type>(1, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'type', $pb.PbFieldType.OE, defaultOrMaker: ExplanationMetadata_InputMetadata_Visualization_Type.TYPE_UNSPECIFIED, valueOf: ExplanationMetadata_InputMetadata_Visualization_Type.valueOf, enumValues: ExplanationMetadata_InputMetadata_Visualization_Type.values)
    ..e<ExplanationMetadata_InputMetadata_Visualization_Polarity>(2, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'polarity', $pb.PbFieldType.OE, defaultOrMaker: ExplanationMetadata_InputMetadata_Visualization_Polarity.POLARITY_UNSPECIFIED, valueOf: ExplanationMetadata_InputMetadata_Visualization_Polarity.valueOf, enumValues: ExplanationMetadata_InputMetadata_Visualization_Polarity.values)
    ..e<ExplanationMetadata_InputMetadata_Visualization_ColorMap>(3, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'colorMap', $pb.PbFieldType.OE, defaultOrMaker: ExplanationMetadata_InputMetadata_Visualization_ColorMap.COLOR_MAP_UNSPECIFIED, valueOf: ExplanationMetadata_InputMetadata_Visualization_ColorMap.valueOf, enumValues: ExplanationMetadata_InputMetadata_Visualization_ColorMap.values)
    ..a<$core.double>(4, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'clipPercentUpperbound', $pb.PbFieldType.OF)
    ..a<$core.double>(5, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'clipPercentLowerbound', $pb.PbFieldType.OF)
    ..e<ExplanationMetadata_InputMetadata_Visualization_OverlayType>(6, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'overlayType', $pb.PbFieldType.OE, defaultOrMaker: ExplanationMetadata_InputMetadata_Visualization_OverlayType.OVERLAY_TYPE_UNSPECIFIED, valueOf: ExplanationMetadata_InputMetadata_Visualization_OverlayType.valueOf, enumValues: ExplanationMetadata_InputMetadata_Visualization_OverlayType.values)
    ..hasRequiredFields = false
  ;
  ...
  'Use [GeneratedMessageGenericExtensions.rebuild] instead. '
  'Will be removed in next major version')
  ExplanationMetadata_InputMetadata_Visualization copyWith(void Function(ExplanationMetadata_InputMetadata_Visualization) updates) => super.copyWith((message) => updates(message as ExplanationMetadata_InputMetadata_Visualization)) as ExplanationMetadata_InputMetadata_Visualization; // ignore: deprecated_member_use
  $pb.BuilderInfo get info_ => _i;
  @$core.pragma('dart2js:noInline')
...
class ExplanationMetadata_InputMetadata extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'ExplanationMetadata.InputMetadata', package: const $pb.PackageName(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'google.cloud.aiplatform.v1'), createEmptyInstance: create)
    ...
    ..aOS(2, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'inputTensorName')
    ..e<ExplanationMetadata_InputMetadata_Encoding>(3, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'encoding', $pb.PbFieldType.OE, defaultOrMaker: ExplanationMetadata_InputMetadata_Encoding.ENCODING_UNSPECIFIED, valueOf: ExplanationMetadata_InputMetadata_Encoding.valueOf, enumValues: ExplanationMetadata_InputMetadata_Encoding.values)
    ..aOS(4, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'modality')
    ..aOM<ExplanationMetadata_InputMetadata_FeatureValueDomain>(5, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'featureValueDomain', subBuilder: ExplanationMetadata_InputMetadata_FeatureValueDomain.create)
    ..aOS(6, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'indicesTensorName')
    ..aOS(7, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'denseShapeTensorName')
    ..pPS(8, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'indexFeatureMapping')
    ..aOS(9, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'encodedTensorName')
    ..pc<$0.Value>(10, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'encodedBaselines', $pb.PbFieldType.PM, subBuilder: $0.Value.create)
    ..aOM<ExplanationMetadata_InputMetadata_Visualization>(11, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'visualization', subBuilder: ExplanationMetadata_InputMetadata_Visualization.create)
    ..aOS(12, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'groupName')
    ..hasRequiredFields = false
  ;
  ...
  'Use [GeneratedMessageGenericExtensions.rebuild] instead. '
  'Will be removed in next major version')
  ExplanationMetadata_InputMetadata copyWith(void Function(ExplanationMetadata_InputMetadata) updates) => super.copyWith((message) => updates(message as ExplanationMetadata_InputMetadata)) as ExplanationMetadata_InputMetadata; // ignore: deprecated_member_use
  $pb.BuilderInfo get info_ => _i;
  @$core.pragma('dart2js:noInline')
...
class ExplanationMetadata_OutputMetadata extends $pb.GeneratedMessage {
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'ExplanationMetadata.OutputMetadata', package: const $pb.PackageName(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'google.cloud.aiplatform.v1'), createEmptyInstance: create)
    ..oo(0, [1, 2])
    ..aOM<$0.Value>(1, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'indexDisplayNameMapping', subBuilder: $0.Value.create)
    ..aOS(2, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'displayNameMappingKey')
    ..aOS(3, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'outputTensorName')
    ..hasRequiredFields = false
  ;
  ...
  'Use [GeneratedMessageGenericExtensions.rebuild] instead. '
  'Will be removed in next major version')
  ExplanationMetadata_OutputMetadata copyWith(void Function(ExplanationMetadata_OutputMetadata) updates) => super.copyWith((message) => updates(message as ExplanationMetadata_OutputMetadata)) as ExplanationMetadata_OutputMetadata; // ignore: deprecated_member_use
  $pb.BuilderInfo get info_ => _i;
  @$core.pragma('dart2js:noInline')
  ...
  @$pb.TagNumber(1)
  set indexDisplayNameMapping($0.Value v) { setField(1, v); }
  @$pb.TagNumber(1)
...
class ExplanationMetadata extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'ExplanationMetadata', package: const $pb.PackageName(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'google.cloud.aiplatform.v1'), createEmptyInstance: create)
    ..m<$core.String, ExplanationMetadata_InputMetadata>(1, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'inputs', entryClassName: 'ExplanationMetadata.InputsEntry', keyFieldType: $pb.PbFieldType.OS, valueFieldType: $pb.PbFieldType.OM, valueCreator: ExplanationMetadata_InputMetadata.create, packageName: const $pb.PackageName('google.cloud.aiplatform.v1'))
    ..m<$core.String, ExplanationMetadata_OutputMetadata>(2, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'outputs', entryClassName: 'ExplanationMetadata.OutputsEntry', keyFieldType: $pb.PbFieldType.OS, valueFieldType: $pb.PbFieldType.OM, valueCreator: ExplanationMetadata_OutputMetadata.create, packageName: const $pb.PackageName('google.cloud.aiplatform.v1'))
    ..aOS(3, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'featureAttributionsSchemaUri')
    ..hasRequiredFields = false
  ;
  ...
  'Use [GeneratedMessageGenericExtensions.rebuild] instead. '
  'Will be removed in next major version')
  ExplanationMetadata copyWith(void Function(ExplanationMetadata) updates) => super.copyWith((message) => updates(message as ExplanationMetadata)) as ExplanationMetadata; // ignore: deprecated_member_use
  $pb.BuilderInfo get info_ => _i;
  @$core.pragma('dart2js:noInline')

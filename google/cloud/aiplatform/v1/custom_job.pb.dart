...
class CustomJob extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'CustomJob', package: const $pb.PackageName(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'google.cloud.aiplatform.v1'), createEmptyInstance: create)
    ..aOS(1, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'name')
    ..aOS(2, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'displayName')
    ..aOM<CustomJobSpec>(4, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'jobSpec', subBuilder: CustomJobSpec.create)
    ..e<$7.JobState>(5, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'state', $pb.PbFieldType.OE, defaultOrMaker: $7.JobState.JOB_STATE_UNSPECIFIED, valueOf: $7.JobState.valueOf, enumValues: $7.JobState.values)
    ...
    ..aOM<$1.Status>(10, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'error', subBuilder: $1.Status.create)
    ..m<$core.String, $core.String>(11, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'labels', entryClassName: 'CustomJob.LabelsEntry', keyFieldType: $pb.PbFieldType.OS, valueFieldType: $pb.PbFieldType.OS, packageName: const $pb.PackageName('google.cloud.aiplatform.v1'))
    ..aOM<$2.EncryptionSpec>(12, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'encryptionSpec', subBuilder: $2.EncryptionSpec.create)
    ..m<$core.String, $core.String>(16, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'webAccessUris', entryClassName: 'CustomJob.WebAccessUrisEntry', keyFieldType: $pb.PbFieldType.OS, valueFieldType: $pb.PbFieldType.OS, packageName: const $pb.PackageName('google.cloud.aiplatform.v1'))
  ...
  'Will be removed in next major version')
  CustomJob copyWith(void Function(CustomJob) updates) => super.copyWith((message) => updates(message as CustomJob)) as CustomJob; // ignore: deprecated_member_use
  ...
  @$pb.TagNumber(5)
  set state($7.JobState v) { setField(5, v); }
  @$pb.TagNumber(5)
  ...
  @$pb.TagNumber(10)
  set error($1.Status v) { setField(10, v); }
  @$pb.TagNumber(10)
  ...
  @$pb.TagNumber(12)
  set encryptionSpec($2.EncryptionSpec v) { setField(12, v); }
  @$pb.TagNumber(12)
...
class CustomJobSpec extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'CustomJobSpec', package: const $pb.PackageName(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'google.cloud.aiplatform.v1'), createEmptyInstance: create)
    ..pc<WorkerPoolSpec>(1, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'workerPoolSpecs', $pb.PbFieldType.PM, subBuilder: WorkerPoolSpec.create)
    ..aOM<Scheduling>(3, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'scheduling', subBuilder: Scheduling.create)
    ..aOS(4, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'serviceAccount')
    ..aOS(5, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'network')
    ..aOM<$3.GcsDestination>(6, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'baseOutputDirectory', subBuilder: $3.GcsDestination.create)
    ..aOS(7, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'tensorboard')
    ..aOB(10, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'enableWebAccess')
    ..pPS(13, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'reservedIpRanges')
    ..hasRequiredFields = false
  ;
  ...
  'Use [GeneratedMessageGenericExtensions.rebuild] instead. '
  'Will be removed in next major version')
  CustomJobSpec copyWith(void Function(CustomJobSpec) updates) => super.copyWith((message) => updates(message as CustomJobSpec)) as CustomJobSpec; // ignore: deprecated_member_use
  $pb.BuilderInfo get info_ => _i;
  @$core.pragma('dart2js:noInline')
  ...
  @$pb.TagNumber(6)
  set baseOutputDirectory($3.GcsDestination v) { setField(6, v); }
  @$pb.TagNumber(6)
...
class WorkerPoolSpec extends $pb.GeneratedMessage {
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'WorkerPoolSpec', package: const $pb.PackageName(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'google.cloud.aiplatform.v1'), createEmptyInstance: create)
    ..oo(0, [6, 7])
    ..aOM<$4.MachineSpec>(1, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'machineSpec', subBuilder: $4.MachineSpec.create)
    ..aInt64(2, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'replicaCount')
    ..pc<$4.NfsMount>(4, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'nfsMounts', $pb.PbFieldType.PM, subBuilder: $4.NfsMount.create)
    ..aOM<$4.DiskSpec>(5, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'diskSpec', subBuilder: $4.DiskSpec.create)
    ..aOM<ContainerSpec>(6, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'containerSpec', subBuilder: ContainerSpec.create)
    ..aOM<PythonPackageSpec>(7, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'pythonPackageSpec', subBuilder: PythonPackageSpec.create)
    ..hasRequiredFields = false
  ;
  ...
  factory WorkerPoolSpec({
    ...
    $core.Iterable<$4.NfsMount>? nfsMounts,
    $4.DiskSpec? diskSpec,
    ...
    if (nfsMounts != null) {
      _result.nfsMounts.addAll(nfsMounts);
    }
    if (diskSpec != null) {
  ...
  'Use [GeneratedMessageGenericExtensions.rebuild] instead. '
  'Will be removed in next major version')
  WorkerPoolSpec copyWith(void Function(WorkerPoolSpec) updates) => super.copyWith((message) => updates(message as WorkerPoolSpec)) as WorkerPoolSpec; // ignore: deprecated_member_use
  $pb.BuilderInfo get info_ => _i;
  @$core.pragma('dart2js:noInline')
  ...
  @$pb.TagNumber(1)
  set machineSpec($4.MachineSpec v) { setField(1, v); }
  @$pb.TagNumber(1)
  ...
  @$pb.TagNumber(4)
  $core.List<$4.NfsMount> get nfsMounts => $_getList(2);

  @$pb.TagNumber(5)
  $4.DiskSpec get diskSpec => $_getN(3);
  @$pb.TagNumber(5)
  set diskSpec($4.DiskSpec v) { setField(5, v); }
  @$pb.TagNumber(5)
  $core.bool hasDiskSpec() => $_has(3);
  @$pb.TagNumber(5)
  void clearDiskSpec() => clearField(5);
  @$pb.TagNumber(5)
  $4.DiskSpec ensureDiskSpec() => $_ensure(3);
...
class ContainerSpec extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'ContainerSpec', package: const $pb.PackageName(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'google.cloud.aiplatform.v1'), createEmptyInstance: create)
    ..aOS(1, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'imageUri')
    ..pPS(2, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'command')
    ..pPS(3, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'args')
    ..pc<$5.EnvVar>(4, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'env', $pb.PbFieldType.PM, subBuilder: $5.EnvVar.create)
    ..hasRequiredFields = false
  ;
...
class PythonPackageSpec extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'PythonPackageSpec', package: const $pb.PackageName(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'google.cloud.aiplatform.v1'), createEmptyInstance: create)
    ..aOS(1, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'executorImageUri')
    ..pPS(2, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'packageUris')
    ..aOS(3, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'pythonModule')
    ..pPS(4, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'args')
    ..pc<$5.EnvVar>(5, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'env', $pb.PbFieldType.PM, subBuilder: $5.EnvVar.create)
    ..hasRequiredFields = false
  ;
  ...
  'Use [GeneratedMessageGenericExtensions.rebuild] instead. '
  'Will be removed in next major version')
  PythonPackageSpec copyWith(void Function(PythonPackageSpec) updates) => super.copyWith((message) => updates(message as PythonPackageSpec)) as PythonPackageSpec; // ignore: deprecated_member_use
  $pb.BuilderInfo get info_ => _i;
  @$core.pragma('dart2js:noInline')
...
class Scheduling extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'Scheduling', package: const $pb.PackageName(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'google.cloud.aiplatform.v1'), createEmptyInstance: create)
    ..aOM<$6.Duration>(1, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'timeout', subBuilder: $6.Duration.create)
    ..aOB(3, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'restartJobOnWorkerRestart')
    ..hasRequiredFields = false
  ;
  ...
  'Use [GeneratedMessageGenericExtensions.rebuild] instead. '
  'Will be removed in next major version')
  Scheduling copyWith(void Function(Scheduling) updates) => super.copyWith((message) => updates(message as Scheduling)) as Scheduling; // ignore: deprecated_member_use
  $pb.BuilderInfo get info_ => _i;
  @$core.pragma('dart2js:noInline')
  ...
  @$pb.TagNumber(1)
  set timeout($6.Duration v) { setField(1, v); }
  @$pb.TagNumber(1)

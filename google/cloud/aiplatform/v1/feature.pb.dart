...
import 'feature_monitoring_stats.pb.dart' as $1;
...
class Feature_MonitoringStatsAnomaly extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'Feature.MonitoringStatsAnomaly', package: const $pb.PackageName(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'google.cloud.aiplatform.v1'), createEmptyInstance: create)
    ...
    ..aOM<$1.FeatureStatsAnomaly>(2, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'featureStatsAnomaly', subBuilder: $1.FeatureStatsAnomaly.create)
  ...
  factory Feature_MonitoringStatsAnomaly({
    ...
    $1.FeatureStatsAnomaly? featureStatsAnomaly,
  }) {
  ...
  @$pb.TagNumber(2)
  $1.FeatureStatsAnomaly get featureStatsAnomaly => $_getN(1);
  @$pb.TagNumber(2)
  set featureStatsAnomaly($1.FeatureStatsAnomaly v) { setField(2, v); }
  @$pb.TagNumber(2)
  $core.bool hasFeatureStatsAnomaly() => $_has(1);
  @$pb.TagNumber(2)
  void clearFeatureStatsAnomaly() => clearField(2);
  @$pb.TagNumber(2)
  $1.FeatureStatsAnomaly ensureFeatureStatsAnomaly() => $_ensure(1);
}

class Feature extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'Feature', package: const $pb.PackageName(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'google.cloud.aiplatform.v1'), createEmptyInstance: create)
    ...
    ..m<$core.String, $core.String>(6, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'labels', entryClassName: 'Feature.LabelsEntry', keyFieldType: $pb.PbFieldType.OS, valueFieldType: $pb.PbFieldType.OS, packageName: const $pb.PackageName('google.cloud.aiplatform.v1'))
  ...
  @$pb.TagNumber(11)
  $core.List<Feature_MonitoringStatsAnomaly> get monitoringStatsAnomalies => $_getList(7);

  @$pb.TagNumber(12)
  $core.bool get disableMonitoring => $_getBF(8);
  @$pb.TagNumber(12)
  set disableMonitoring($core.bool v) { $_setBool(8, v); }
  @$pb.TagNumber(12)
  $core.bool hasDisableMonitoring() => $_has(8);
  @$pb.TagNumber(12)

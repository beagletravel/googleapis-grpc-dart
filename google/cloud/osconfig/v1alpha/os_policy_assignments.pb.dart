...
class OSPolicyAssignment_LabelSet extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'OSPolicyAssignment.LabelSet', package: const $pb.PackageName(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'google.cloud.osconfig.v1alpha'), createEmptyInstance: create)
    ..m<$core.String, $core.String>(1, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'labels', entryClassName: 'OSPolicyAssignment.LabelSet.LabelsEntry', keyFieldType: $pb.PbFieldType.OS, valueFieldType: $pb.PbFieldType.OS, packageName: const $pb.PackageName('google.cloud.osconfig.v1alpha'))
  ...
  'Will be removed in next major version')
  OSPolicyAssignment_LabelSet copyWith(void Function(OSPolicyAssignment_LabelSet) updates) => super.copyWith((message) => updates(message as OSPolicyAssignment_LabelSet)) as OSPolicyAssignment_LabelSet; // ignore: deprecated_member_use
...
class OSPolicyAssignment_InstanceFilter_Inventory extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'OSPolicyAssignment.InstanceFilter.Inventory', package: const $pb.PackageName(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'google.cloud.osconfig.v1alpha'), createEmptyInstance: create)
  ...
  'Use [GeneratedMessageGenericExtensions.rebuild] instead. '
  'Will be removed in next major version')
  OSPolicyAssignment_InstanceFilter_Inventory copyWith(void Function(OSPolicyAssignment_InstanceFilter_Inventory) updates) => super.copyWith((message) => updates(message as OSPolicyAssignment_InstanceFilter_Inventory)) as OSPolicyAssignment_InstanceFilter_Inventory; // ignore: deprecated_member_use
  $pb.BuilderInfo get info_ => _i;
  @$core.pragma('dart2js:noInline')
...
class OSPolicyAssignment_InstanceFilter extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'OSPolicyAssignment.InstanceFilter', package: const $pb.PackageName(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'google.cloud.osconfig.v1alpha'), createEmptyInstance: create)
    ..aOB(1, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'all')
    ..pPS(2, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'osShortNames')
    ..pc<OSPolicyAssignment_LabelSet>(3, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'inclusionLabels', $pb.PbFieldType.PM, subBuilder: OSPolicyAssignment_LabelSet.create)
    ..pc<OSPolicyAssignment_LabelSet>(4, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'exclusionLabels', $pb.PbFieldType.PM, subBuilder: OSPolicyAssignment_LabelSet.create)
    ..pc<OSPolicyAssignment_InstanceFilter_Inventory>(5, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'inventories', $pb.PbFieldType.PM, subBuilder: OSPolicyAssignment_InstanceFilter_Inventory.create)
    ..hasRequiredFields = false
  ;
  ...
  @$core.Deprecated('This field is deprecated.')
    $core.Iterable<$core.String>? osShortNames,
    ...
    if (osShortNames != null) {
      // ignore: deprecated_member_use_from_same_package
      _result.osShortNames.addAll(osShortNames);
    }
  ...
  'Use [GeneratedMessageGenericExtensions.rebuild] instead. '
  'Will be removed in next major version')
  OSPolicyAssignment_InstanceFilter copyWith(void Function(OSPolicyAssignment_InstanceFilter) updates) => super.copyWith((message) => updates(message as OSPolicyAssignment_InstanceFilter)) as OSPolicyAssignment_InstanceFilter; // ignore: deprecated_member_use
  $pb.BuilderInfo get info_ => _i;
  @$core.pragma('dart2js:noInline')
  ...
  @$core.Deprecated('This field is deprecated.')
  @$pb.TagNumber(2)
  $core.List<$core.String> get osShortNames => $_getList(1);

  @$pb.TagNumber(3)
  $core.List<OSPolicyAssignment_LabelSet> get inclusionLabels => $_getList(2);

  @$pb.TagNumber(4)
  $core.List<OSPolicyAssignment_LabelSet> get exclusionLabels => $_getList(3);

  @$pb.TagNumber(5)
  $core.List<OSPolicyAssignment_InstanceFilter_Inventory> get inventories => $_getList(4);
}

class OSPolicyAssignment_Rollout extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'OSPolicyAssignment.Rollout', package: const $pb.PackageName(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'google.cloud.osconfig.v1alpha'), createEmptyInstance: create)
    ..aOM<$2.FixedOrPercent>(1, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'disruptionBudget', subBuilder: $2.FixedOrPercent.create)
    ..aOM<$3.Duration>(2, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'minWaitDuration', subBuilder: $3.Duration.create)
    ..hasRequiredFields = false
  ;
  ...
  'Use [GeneratedMessageGenericExtensions.rebuild] instead. '
  'Will be removed in next major version')
  OSPolicyAssignment_Rollout copyWith(void Function(OSPolicyAssignment_Rollout) updates) => super.copyWith((message) => updates(message as OSPolicyAssignment_Rollout)) as OSPolicyAssignment_Rollout; // ignore: deprecated_member_use
  $pb.BuilderInfo get info_ => _i;
  @$core.pragma('dart2js:noInline')
  ...
  @$pb.TagNumber(1)
  set disruptionBudget($2.FixedOrPercent v) { setField(1, v); }
  @$pb.TagNumber(1)
  ...
  @$pb.TagNumber(2)
  set minWaitDuration($3.Duration v) { setField(2, v); }
  @$pb.TagNumber(2)
...
class OSPolicyAssignment extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'OSPolicyAssignment', package: const $pb.PackageName(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'google.cloud.osconfig.v1alpha'), createEmptyInstance: create)
    ..aOS(1, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'name')
    ..aOS(2, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'description')
    ..pc<$0.OSPolicy>(3, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'osPolicies', $pb.PbFieldType.PM, subBuilder: $0.OSPolicy.create)
    ..aOM<OSPolicyAssignment_InstanceFilter>(4, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'instanceFilter', subBuilder: OSPolicyAssignment_InstanceFilter.create)
    ..aOM<OSPolicyAssignment_Rollout>(5, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'rollout', subBuilder: OSPolicyAssignment_Rollout.create)
    ..aOS(6, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'revisionId')
    ..aOM<$1.Timestamp>(7, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'revisionCreateTime', subBuilder: $1.Timestamp.create)
    ..aOS(8, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'etag')
    ..e<OSPolicyAssignment_RolloutState>(9, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'rolloutState', $pb.PbFieldType.OE, defaultOrMaker: OSPolicyAssignment_RolloutState.ROLLOUT_STATE_UNSPECIFIED, valueOf: OSPolicyAssignment_RolloutState.valueOf, enumValues: OSPolicyAssignment_RolloutState.values)
    ..aOB(10, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'baseline')
    ..aOB(11, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'deleted')
    ..aOB(12, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'reconciling')
    ..aOS(13, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'uid')
    ..hasRequiredFields = false
  ;
  ...
  'Use [GeneratedMessageGenericExtensions.rebuild] instead. '
  'Will be removed in next major version')
  OSPolicyAssignment copyWith(void Function(OSPolicyAssignment) updates) => super.copyWith((message) => updates(message as OSPolicyAssignment)) as OSPolicyAssignment; // ignore: deprecated_member_use
  $pb.BuilderInfo get info_ => _i;
  @$core.pragma('dart2js:noInline')
  ...
  @$pb.TagNumber(7)
  set revisionCreateTime($1.Timestamp v) { setField(7, v); }
  @$pb.TagNumber(7)
...
class OSPolicyAssignmentOperationMetadata extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'OSPolicyAssignmentOperationMetadata', package: const $pb.PackageName(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'google.cloud.osconfig.v1alpha'), createEmptyInstance: create)
    ..aOS(1, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'osPolicyAssignment')
    ..e<OSPolicyAssignmentOperationMetadata_APIMethod>(2, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'apiMethod', $pb.PbFieldType.OE, defaultOrMaker: OSPolicyAssignmentOperationMetadata_APIMethod.API_METHOD_UNSPECIFIED, valueOf: OSPolicyAssignmentOperationMetadata_APIMethod.valueOf, enumValues: OSPolicyAssignmentOperationMetadata_APIMethod.values)
    ..e<OSPolicyAssignmentOperationMetadata_RolloutState>(3, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'rolloutState', $pb.PbFieldType.OE, defaultOrMaker: OSPolicyAssignmentOperationMetadata_RolloutState.ROLLOUT_STATE_UNSPECIFIED, valueOf: OSPolicyAssignmentOperationMetadata_RolloutState.valueOf, enumValues: OSPolicyAssignmentOperationMetadata_RolloutState.values)
    ..aOM<$1.Timestamp>(4, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'rolloutStartTime', subBuilder: $1.Timestamp.create)
    ..aOM<$1.Timestamp>(5, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'rolloutUpdateTime', subBuilder: $1.Timestamp.create)
    ..hasRequiredFields = false
  ;
  ...
  'Use [GeneratedMessageGenericExtensions.rebuild] instead. '
  'Will be removed in next major version')
  OSPolicyAssignmentOperationMetadata copyWith(void Function(OSPolicyAssignmentOperationMetadata) updates) => super.copyWith((message) => updates(message as OSPolicyAssignmentOperationMetadata)) as OSPolicyAssignmentOperationMetadata; // ignore: deprecated_member_use
  $pb.BuilderInfo get info_ => _i;
  @$core.pragma('dart2js:noInline')
  ...
  @$pb.TagNumber(4)
  set rolloutStartTime($1.Timestamp v) { setField(4, v); }
  @$pb.TagNumber(4)
  ...
  @$pb.TagNumber(5)
  set rolloutUpdateTime($1.Timestamp v) { setField(5, v); }
  @$pb.TagNumber(5)
...
class CreateOSPolicyAssignmentRequest extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'CreateOSPolicyAssignmentRequest', package: const $pb.PackageName(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'google.cloud.osconfig.v1alpha'), createEmptyInstance: create)
    ..aOS(1, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'parent')
    ..aOM<OSPolicyAssignment>(2, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'osPolicyAssignment', subBuilder: OSPolicyAssignment.create)
    ..aOS(3, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'osPolicyAssignmentId')
    ..hasRequiredFields = false
  ;
  ...
  'Use [GeneratedMessageGenericExtensions.rebuild] instead. '
  'Will be removed in next major version')
  CreateOSPolicyAssignmentRequest copyWith(void Function(CreateOSPolicyAssignmentRequest) updates) => super.copyWith((message) => updates(message as CreateOSPolicyAssignmentRequest)) as CreateOSPolicyAssignmentRequest; // ignore: deprecated_member_use
  $pb.BuilderInfo get info_ => _i;
  @$core.pragma('dart2js:noInline')
...
class UpdateOSPolicyAssignmentRequest extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'UpdateOSPolicyAssignmentRequest', package: const $pb.PackageName(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'google.cloud.osconfig.v1alpha'), createEmptyInstance: create)
    ..aOM<OSPolicyAssignment>(1, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'osPolicyAssignment', subBuilder: OSPolicyAssignment.create)
  ...
  'Use [GeneratedMessageGenericExtensions.rebuild] instead. '
  'Will be removed in next major version')
  UpdateOSPolicyAssignmentRequest copyWith(void Function(UpdateOSPolicyAssignmentRequest) updates) => super.copyWith((message) => updates(message as UpdateOSPolicyAssignmentRequest)) as UpdateOSPolicyAssignmentRequest; // ignore: deprecated_member_use
  $pb.BuilderInfo get info_ => _i;
  @$core.pragma('dart2js:noInline')
...
class GetOSPolicyAssignmentRequest extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'GetOSPolicyAssignmentRequest', package: const $pb.PackageName(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'google.cloud.osconfig.v1alpha'), createEmptyInstance: create)
    ..aOS(1, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'name')
    ..hasRequiredFields = false
  ;
  ...
  'Use [GeneratedMessageGenericExtensions.rebuild] instead. '
  'Will be removed in next major version')
  GetOSPolicyAssignmentRequest copyWith(void Function(GetOSPolicyAssignmentRequest) updates) => super.copyWith((message) => updates(message as GetOSPolicyAssignmentRequest)) as GetOSPolicyAssignmentRequest; // ignore: deprecated_member_use
  $pb.BuilderInfo get info_ => _i;
  @$core.pragma('dart2js:noInline')
...
class ListOSPolicyAssignmentsRequest extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'ListOSPolicyAssignmentsRequest', package: const $pb.PackageName(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'google.cloud.osconfig.v1alpha'), createEmptyInstance: create)
    ..aOS(1, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'parent')
  ...
  'Use [GeneratedMessageGenericExtensions.rebuild] instead. '
  'Will be removed in next major version')
  ListOSPolicyAssignmentsRequest copyWith(void Function(ListOSPolicyAssignmentsRequest) updates) => super.copyWith((message) => updates(message as ListOSPolicyAssignmentsRequest)) as ListOSPolicyAssignmentsRequest; // ignore: deprecated_member_use
  $pb.BuilderInfo get info_ => _i;
  @$core.pragma('dart2js:noInline')
...
class ListOSPolicyAssignmentsResponse extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'ListOSPolicyAssignmentsResponse', package: const $pb.PackageName(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'google.cloud.osconfig.v1alpha'), createEmptyInstance: create)
    ..pc<OSPolicyAssignment>(1, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'osPolicyAssignments', $pb.PbFieldType.PM, subBuilder: OSPolicyAssignment.create)
  ...
  'Use [GeneratedMessageGenericExtensions.rebuild] instead. '
  'Will be removed in next major version')
  ListOSPolicyAssignmentsResponse copyWith(void Function(ListOSPolicyAssignmentsResponse) updates) => super.copyWith((message) => updates(message as ListOSPolicyAssignmentsResponse)) as ListOSPolicyAssignmentsResponse; // ignore: deprecated_member_use
  $pb.BuilderInfo get info_ => _i;
  @$core.pragma('dart2js:noInline')
...
class ListOSPolicyAssignmentRevisionsRequest extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'ListOSPolicyAssignmentRevisionsRequest', package: const $pb.PackageName(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'google.cloud.osconfig.v1alpha'), createEmptyInstance: create)
    ..aOS(1, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'name')
    ..a<$core.int>(2, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'pageSize', $pb.PbFieldType.O3)
    ..aOS(3, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'pageToken')
    ..hasRequiredFields = false
  ...
  'Use [GeneratedMessageGenericExtensions.rebuild] instead. '
  'Will be removed in next major version')
  ListOSPolicyAssignmentRevisionsRequest copyWith(void Function(ListOSPolicyAssignmentRevisionsRequest) updates) => super.copyWith((message) => updates(message as ListOSPolicyAssignmentRevisionsRequest)) as ListOSPolicyAssignmentRevisionsRequest; // ignore: deprecated_member_use
  $pb.BuilderInfo get info_ => _i;
  @$core.pragma('dart2js:noInline')
...
class ListOSPolicyAssignmentRevisionsResponse extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'ListOSPolicyAssignmentRevisionsResponse', package: const $pb.PackageName(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'google.cloud.osconfig.v1alpha'), createEmptyInstance: create)
    ..pc<OSPolicyAssignment>(1, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'osPolicyAssignments', $pb.PbFieldType.PM, subBuilder: OSPolicyAssignment.create)
    ..aOS(2, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'nextPageToken')
    ..hasRequiredFields = false
  ;
  ...
  'Use [GeneratedMessageGenericExtensions.rebuild] instead. '
  'Will be removed in next major version')
  ListOSPolicyAssignmentRevisionsResponse copyWith(void Function(ListOSPolicyAssignmentRevisionsResponse) updates) => super.copyWith((message) => updates(message as ListOSPolicyAssignmentRevisionsResponse)) as ListOSPolicyAssignmentRevisionsResponse; // ignore: deprecated_member_use
  $pb.BuilderInfo get info_ => _i;
  @$core.pragma('dart2js:noInline')
...
class DeleteOSPolicyAssignmentRequest extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'DeleteOSPolicyAssignmentRequest', package: const $pb.PackageName(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'google.cloud.osconfig.v1alpha'), createEmptyInstance: create)
    ..aOS(1, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'name')
    ..hasRequiredFields = false
  ;
  ...
  'Use [GeneratedMessageGenericExtensions.rebuild] instead. '
  'Will be removed in next major version')
  DeleteOSPolicyAssignmentRequest copyWith(void Function(DeleteOSPolicyAssignmentRequest) updates) => super.copyWith((message) => updates(message as DeleteOSPolicyAssignmentRequest)) as DeleteOSPolicyAssignmentRequest; // ignore: deprecated_member_use
  $pb.BuilderInfo get info_ => _i;
  @$core.pragma('dart2js:noInline')

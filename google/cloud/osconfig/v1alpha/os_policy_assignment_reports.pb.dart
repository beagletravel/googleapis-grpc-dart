...
class GetOSPolicyAssignmentReportRequest extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'GetOSPolicyAssignmentReportRequest', package: const $pb.PackageName(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'google.cloud.osconfig.v1alpha'), createEmptyInstance: create)
  ...
  'Will be removed in next major version')
  GetOSPolicyAssignmentReportRequest copyWith(void Function(GetOSPolicyAssignmentReportRequest) updates) => super.copyWith((message) => updates(message as GetOSPolicyAssignmentReportRequest)) as GetOSPolicyAssignmentReportRequest; // ignore: deprecated_member_use
...
class ListOSPolicyAssignmentReportsRequest extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'ListOSPolicyAssignmentReportsRequest', package: const $pb.PackageName(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'google.cloud.osconfig.v1alpha'), createEmptyInstance: create)
  ...
  'Use [GeneratedMessageGenericExtensions.rebuild] instead. '
  'Will be removed in next major version')
  ListOSPolicyAssignmentReportsRequest copyWith(void Function(ListOSPolicyAssignmentReportsRequest) updates) => super.copyWith((message) => updates(message as ListOSPolicyAssignmentReportsRequest)) as ListOSPolicyAssignmentReportsRequest; // ignore: deprecated_member_use
  $pb.BuilderInfo get info_ => _i;
  @$core.pragma('dart2js:noInline')
...
class ListOSPolicyAssignmentReportsResponse extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'ListOSPolicyAssignmentReportsResponse', package: const $pb.PackageName(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'google.cloud.osconfig.v1alpha'), createEmptyInstance: create)
    ..pc<OSPolicyAssignmentReport>(1, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'osPolicyAssignmentReports', $pb.PbFieldType.PM, subBuilder: OSPolicyAssignmentReport.create)
  ...
  'Use [GeneratedMessageGenericExtensions.rebuild] instead. '
  'Will be removed in next major version')
  ListOSPolicyAssignmentReportsResponse copyWith(void Function(ListOSPolicyAssignmentReportsResponse) updates) => super.copyWith((message) => updates(message as ListOSPolicyAssignmentReportsResponse)) as ListOSPolicyAssignmentReportsResponse; // ignore: deprecated_member_use
  $pb.BuilderInfo get info_ => _i;
  @$core.pragma('dart2js:noInline')
...
class OSPolicyAssignmentReport_OSPolicyCompliance_OSPolicyResourceCompliance_ExecResourceOutput extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'OSPolicyAssignmentReport.OSPolicyCompliance.OSPolicyResourceCompliance.ExecResourceOutput', package: const $pb.PackageName(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'google.cloud.osconfig.v1alpha'), createEmptyInstance: create)
    ..a<$core.List<$core.int>>(2, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'enforcementOutput', $pb.PbFieldType.OY)
    ..hasRequiredFields = false
  ;
...
class OSPolicyAssignmentReport_OSPolicyCompliance_OSPolicyResourceCompliance extends $pb.GeneratedMessage {
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'OSPolicyAssignmentReport.OSPolicyCompliance.OSPolicyResourceCompliance', package: const $pb.PackageName(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'google.cloud.osconfig.v1alpha'), createEmptyInstance: create)
    ..oo(0, [5])
    ..aOS(1, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'osPolicyResourceId')
    ..pc<OSPolicyAssignmentReport_OSPolicyCompliance_OSPolicyResourceCompliance_OSPolicyResourceConfigStep>(2, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'configSteps', $pb.PbFieldType.PM, subBuilder: OSPolicyAssignmentReport_OSPolicyCompliance_OSPolicyResourceCompliance_OSPolicyResourceConfigStep.create)
    ..e<OSPolicyAssignmentReport_OSPolicyCompliance_OSPolicyResourceCompliance_ComplianceState>(3, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'complianceState', $pb.PbFieldType.OE, defaultOrMaker: OSPolicyAssignmentReport_OSPolicyCompliance_OSPolicyResourceCompliance_ComplianceState.UNKNOWN, valueOf: OSPolicyAssignmentReport_OSPolicyCompliance_OSPolicyResourceCompliance_ComplianceState.valueOf, enumValues: OSPolicyAssignmentReport_OSPolicyCompliance_OSPolicyResourceCompliance_ComplianceState.values)
    ..aOS(4, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'complianceStateReason')
    ..aOM<OSPolicyAssignmentReport_OSPolicyCompliance_OSPolicyResourceCompliance_ExecResourceOutput>(5, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'execResourceOutput', subBuilder: OSPolicyAssignmentReport_OSPolicyCompliance_OSPolicyResourceCompliance_ExecResourceOutput.create)
    ..hasRequiredFields = false
  ;
...
class OSPolicyAssignmentReport_OSPolicyCompliance extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'OSPolicyAssignmentReport.OSPolicyCompliance', package: const $pb.PackageName(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'google.cloud.osconfig.v1alpha'), createEmptyInstance: create)
    ..aOS(1, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'osPolicyId')
    ..e<OSPolicyAssignmentReport_OSPolicyCompliance_ComplianceState>(2, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'complianceState', $pb.PbFieldType.OE, defaultOrMaker: OSPolicyAssignmentReport_OSPolicyCompliance_ComplianceState.UNKNOWN, valueOf: OSPolicyAssignmentReport_OSPolicyCompliance_ComplianceState.valueOf, enumValues: OSPolicyAssignmentReport_OSPolicyCompliance_ComplianceState.values)
    ..aOS(3, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'complianceStateReason')
    ..pc<OSPolicyAssignmentReport_OSPolicyCompliance_OSPolicyResourceCompliance>(4, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'osPolicyResourceCompliances', $pb.PbFieldType.PM, subBuilder: OSPolicyAssignmentReport_OSPolicyCompliance_OSPolicyResourceCompliance.create)
    ..hasRequiredFields = false
  ;
  ...
  'Use [GeneratedMessageGenericExtensions.rebuild] instead. '
  'Will be removed in next major version')
  OSPolicyAssignmentReport_OSPolicyCompliance copyWith(void Function(OSPolicyAssignmentReport_OSPolicyCompliance) updates) => super.copyWith((message) => updates(message as OSPolicyAssignmentReport_OSPolicyCompliance)) as OSPolicyAssignmentReport_OSPolicyCompliance; // ignore: deprecated_member_use
  $pb.BuilderInfo get info_ => _i;
  @$core.pragma('dart2js:noInline')
...
class OSPolicyAssignmentReport extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'OSPolicyAssignmentReport', package: const $pb.PackageName(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'google.cloud.osconfig.v1alpha'), createEmptyInstance: create)
    ..aOS(1, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'name')
    ...
    ..pc<OSPolicyAssignmentReport_OSPolicyCompliance>(4, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'osPolicyCompliances', $pb.PbFieldType.PM, subBuilder: OSPolicyAssignmentReport_OSPolicyCompliance.create)
    ..aOM<$0.Timestamp>(5, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'updateTime', subBuilder: $0.Timestamp.create)
    ..aOS(6, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'lastRunId')
    ..hasRequiredFields = false
  ;
  ...
  'Use [GeneratedMessageGenericExtensions.rebuild] instead. '
  'Will be removed in next major version')
  OSPolicyAssignmentReport copyWith(void Function(OSPolicyAssignmentReport) updates) => super.copyWith((message) => updates(message as OSPolicyAssignmentReport)) as OSPolicyAssignmentReport; // ignore: deprecated_member_use
  $pb.BuilderInfo get info_ => _i;
  @$core.pragma('dart2js:noInline')

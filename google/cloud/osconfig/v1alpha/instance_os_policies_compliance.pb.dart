...
class InstanceOSPoliciesCompliance_OSPolicyCompliance extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'InstanceOSPoliciesCompliance.OSPolicyCompliance', package: const $pb.PackageName(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'google.cloud.osconfig.v1alpha'), createEmptyInstance: create)
    ...
    ..e<$1.OSPolicyComplianceState>(4, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'state', $pb.PbFieldType.OE, defaultOrMaker: $1.OSPolicyComplianceState.OS_POLICY_COMPLIANCE_STATE_UNSPECIFIED, valueOf: $1.OSPolicyComplianceState.valueOf, enumValues: $1.OSPolicyComplianceState.values)
    ..pc<$1.OSPolicyResourceCompliance>(5, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'osPolicyResourceCompliances', $pb.PbFieldType.PM, subBuilder: $1.OSPolicyResourceCompliance.create)
  ...
  'Will be removed in next major version')
  InstanceOSPoliciesCompliance_OSPolicyCompliance copyWith(void Function(InstanceOSPoliciesCompliance_OSPolicyCompliance) updates) => super.copyWith((message) => updates(message as InstanceOSPoliciesCompliance_OSPolicyCompliance)) as InstanceOSPoliciesCompliance_OSPolicyCompliance; // ignore: deprecated_member_use
  ...
  @$pb.TagNumber(4)
  set state($1.OSPolicyComplianceState v) { setField(4, v); }
  @$pb.TagNumber(4)
  ...
  @$pb.TagNumber(5)
  $core.List<$1.OSPolicyResourceCompliance> get osPolicyResourceCompliances => $_getList(3);
}

class InstanceOSPoliciesCompliance extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'InstanceOSPoliciesCompliance', package: const $pb.PackageName(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'google.cloud.osconfig.v1alpha'), createEmptyInstance: create)
    ..aOS(1, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'name')
    ..aOS(2, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'instance')
    ..e<$1.OSPolicyComplianceState>(3, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'state', $pb.PbFieldType.OE, defaultOrMaker: $1.OSPolicyComplianceState.OS_POLICY_COMPLIANCE_STATE_UNSPECIFIED, valueOf: $1.OSPolicyComplianceState.valueOf, enumValues: $1.OSPolicyComplianceState.values)
    ..aOS(4, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'detailedState')
    ..aOS(5, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'detailedStateReason')
    ..pc<InstanceOSPoliciesCompliance_OSPolicyCompliance>(6, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'osPolicyCompliances', $pb.PbFieldType.PM, subBuilder: InstanceOSPoliciesCompliance_OSPolicyCompliance.create)
    ..aOM<$0.Timestamp>(7, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'lastComplianceCheckTime', subBuilder: $0.Timestamp.create)
    ..aOS(8, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'lastComplianceRunId')
    ..hasRequiredFields = false
  ;
  ...
  'Use [GeneratedMessageGenericExtensions.rebuild] instead. '
  'Will be removed in next major version')
  InstanceOSPoliciesCompliance copyWith(void Function(InstanceOSPoliciesCompliance) updates) => super.copyWith((message) => updates(message as InstanceOSPoliciesCompliance)) as InstanceOSPoliciesCompliance; // ignore: deprecated_member_use
  $pb.BuilderInfo get info_ => _i;
  @$core.pragma('dart2js:noInline')
  ...
  $1.OSPolicyComplianceState get state => $_getN(2);
  @$pb.TagNumber(3)
  set state($1.OSPolicyComplianceState v) { setField(3, v); }
  @$pb.TagNumber(3)
  $core.bool hasState() => $_has(2);
  @$pb.TagNumber(3)
  ...
  @$pb.TagNumber(7)
  set lastComplianceCheckTime($0.Timestamp v) { setField(7, v); }
  @$pb.TagNumber(7)
...
class GetInstanceOSPoliciesComplianceRequest extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'GetInstanceOSPoliciesComplianceRequest', package: const $pb.PackageName(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'google.cloud.osconfig.v1alpha'), createEmptyInstance: create)
    ..aOS(1, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'name')
    ..hasRequiredFields = false
  ;
  ...
  'Use [GeneratedMessageGenericExtensions.rebuild] instead. '
  'Will be removed in next major version')
  GetInstanceOSPoliciesComplianceRequest copyWith(void Function(GetInstanceOSPoliciesComplianceRequest) updates) => super.copyWith((message) => updates(message as GetInstanceOSPoliciesComplianceRequest)) as GetInstanceOSPoliciesComplianceRequest; // ignore: deprecated_member_use
  $pb.BuilderInfo get info_ => _i;
  @$core.pragma('dart2js:noInline')
...
class ListInstanceOSPoliciesCompliancesRequest extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'ListInstanceOSPoliciesCompliancesRequest', package: const $pb.PackageName(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'google.cloud.osconfig.v1alpha'), createEmptyInstance: create)
  ...
  'Use [GeneratedMessageGenericExtensions.rebuild] instead. '
  'Will be removed in next major version')
  ListInstanceOSPoliciesCompliancesRequest copyWith(void Function(ListInstanceOSPoliciesCompliancesRequest) updates) => super.copyWith((message) => updates(message as ListInstanceOSPoliciesCompliancesRequest)) as ListInstanceOSPoliciesCompliancesRequest; // ignore: deprecated_member_use
  $pb.BuilderInfo get info_ => _i;
  @$core.pragma('dart2js:noInline')
...
class ListInstanceOSPoliciesCompliancesResponse extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'ListInstanceOSPoliciesCompliancesResponse', package: const $pb.PackageName(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'google.cloud.osconfig.v1alpha'), createEmptyInstance: create)
    ..pc<InstanceOSPoliciesCompliance>(1, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'instanceOsPoliciesCompliances', $pb.PbFieldType.PM, subBuilder: InstanceOSPoliciesCompliance.create)
  ...
  factory ListInstanceOSPoliciesCompliancesResponse({
    ...
    if (instanceOsPoliciesCompliances != null) {
      _result.instanceOsPoliciesCompliances.addAll(instanceOsPoliciesCompliances);
    }
  ...
  'Use [GeneratedMessageGenericExtensions.rebuild] instead. '
  'Will be removed in next major version')
  ListInstanceOSPoliciesCompliancesResponse copyWith(void Function(ListInstanceOSPoliciesCompliancesResponse) updates) => super.copyWith((message) => updates(message as ListInstanceOSPoliciesCompliancesResponse)) as ListInstanceOSPoliciesCompliancesResponse; // ignore: deprecated_member_use
  $pb.BuilderInfo get info_ => _i;
  @$core.pragma('dart2js:noInline')

...
class FixedOrPercent extends $pb.GeneratedMessage {
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'FixedOrPercent', package: const $pb.PackageName(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'google.cloud.osconfig.v1alpha'), createEmptyInstance: create)
    ..oo(0, [1, 2])
    ..a<$core.int>(1, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'fixed', $pb.PbFieldType.O3)
    ..a<$core.int>(2, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'percent', $pb.PbFieldType.O3)
  ...
  'Will be removed in next major version')
  FixedOrPercent copyWith(void Function(FixedOrPercent) updates) => super.copyWith((message) => updates(message as FixedOrPercent)) as FixedOrPercent; // ignore: deprecated_member_use

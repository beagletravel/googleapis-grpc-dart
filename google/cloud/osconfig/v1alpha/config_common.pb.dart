...
class OSPolicyResourceConfigStep extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'OSPolicyResourceConfigStep', package: const $pb.PackageName(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'google.cloud.osconfig.v1alpha'), createEmptyInstance: create)
    ..e<OSPolicyResourceConfigStep_Type>(1, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'type', $pb.PbFieldType.OE, defaultOrMaker: OSPolicyResourceConfigStep_Type.TYPE_UNSPECIFIED, valueOf: OSPolicyResourceConfigStep_Type.valueOf, enumValues: OSPolicyResourceConfigStep_Type.values)
    ..e<OSPolicyResourceConfigStep_Outcome>(2, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'outcome', $pb.PbFieldType.OE, defaultOrMaker: OSPolicyResourceConfigStep_Outcome.OUTCOME_UNSPECIFIED, valueOf: OSPolicyResourceConfigStep_Outcome.valueOf, enumValues: OSPolicyResourceConfigStep_Outcome.values)
  ...
  'Will be removed in next major version')
  OSPolicyResourceConfigStep copyWith(void Function(OSPolicyResourceConfigStep) updates) => super.copyWith((message) => updates(message as OSPolicyResourceConfigStep)) as OSPolicyResourceConfigStep; // ignore: deprecated_member_use
...
class OSPolicyResourceCompliance_ExecResourceOutput extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'OSPolicyResourceCompliance.ExecResourceOutput', package: const $pb.PackageName(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'google.cloud.osconfig.v1alpha'), createEmptyInstance: create)
  ...
  'Use [GeneratedMessageGenericExtensions.rebuild] instead. '
  'Will be removed in next major version')
  OSPolicyResourceCompliance_ExecResourceOutput copyWith(void Function(OSPolicyResourceCompliance_ExecResourceOutput) updates) => super.copyWith((message) => updates(message as OSPolicyResourceCompliance_ExecResourceOutput)) as OSPolicyResourceCompliance_ExecResourceOutput; // ignore: deprecated_member_use
  $pb.BuilderInfo get info_ => _i;
  @$core.pragma('dart2js:noInline')
...
class OSPolicyResourceCompliance extends $pb.GeneratedMessage {
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'OSPolicyResourceCompliance', package: const $pb.PackageName(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'google.cloud.osconfig.v1alpha'), createEmptyInstance: create)
    ..oo(0, [4])
    ..aOS(1, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'osPolicyResourceId')
    ..pc<OSPolicyResourceConfigStep>(2, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'configSteps', $pb.PbFieldType.PM, subBuilder: OSPolicyResourceConfigStep.create)
    ..e<OSPolicyComplianceState>(3, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'state', $pb.PbFieldType.OE, defaultOrMaker: OSPolicyComplianceState.OS_POLICY_COMPLIANCE_STATE_UNSPECIFIED, valueOf: OSPolicyComplianceState.valueOf, enumValues: OSPolicyComplianceState.values)
    ..aOM<OSPolicyResourceCompliance_ExecResourceOutput>(4, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'execResourceOutput', subBuilder: OSPolicyResourceCompliance_ExecResourceOutput.create)
    ..hasRequiredFields = false
  ;
  ...
  'Use [GeneratedMessageGenericExtensions.rebuild] instead. '
  'Will be removed in next major version')
  OSPolicyResourceCompliance copyWith(void Function(OSPolicyResourceCompliance) updates) => super.copyWith((message) => updates(message as OSPolicyResourceCompliance)) as OSPolicyResourceCompliance; // ignore: deprecated_member_use
  $pb.BuilderInfo get info_ => _i;
  @$core.pragma('dart2js:noInline')

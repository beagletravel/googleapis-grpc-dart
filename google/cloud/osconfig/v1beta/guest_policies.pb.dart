...
class GuestPolicy extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'GuestPolicy', package: const $pb.PackageName(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'google.cloud.osconfig.v1beta'), createEmptyInstance: create)
    ...
    ..aOM<Assignment>(6, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'assignment', subBuilder: Assignment.create)
    ..pc<Package>(7, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'packages', $pb.PbFieldType.PM, subBuilder: Package.create)
    ..pc<PackageRepository>(8, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'packageRepositories', $pb.PbFieldType.PM, subBuilder: PackageRepository.create)
    ..pc<SoftwareRecipe>(9, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'recipes', $pb.PbFieldType.PM, subBuilder: SoftwareRecipe.create)
  ...
  'Will be removed in next major version')
  GuestPolicy copyWith(void Function(GuestPolicy) updates) => super.copyWith((message) => updates(message as GuestPolicy)) as GuestPolicy; // ignore: deprecated_member_use
...
class Assignment_GroupLabel extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'Assignment.GroupLabel', package: const $pb.PackageName(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'google.cloud.osconfig.v1beta'), createEmptyInstance: create)
    ..m<$core.String, $core.String>(1, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'labels', entryClassName: 'Assignment.GroupLabel.LabelsEntry', keyFieldType: $pb.PbFieldType.OS, valueFieldType: $pb.PbFieldType.OS, packageName: const $pb.PackageName('google.cloud.osconfig.v1beta'))
    ..hasRequiredFields = false
  ;
  ...
  'Use [GeneratedMessageGenericExtensions.rebuild] instead. '
  'Will be removed in next major version')
  Assignment_GroupLabel copyWith(void Function(Assignment_GroupLabel) updates) => super.copyWith((message) => updates(message as Assignment_GroupLabel)) as Assignment_GroupLabel; // ignore: deprecated_member_use
  $pb.BuilderInfo get info_ => _i;
  @$core.pragma('dart2js:noInline')
...
class Assignment_OsType extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'Assignment.OsType', package: const $pb.PackageName(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'google.cloud.osconfig.v1beta'), createEmptyInstance: create)
    ..aOS(1, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'osShortName')
    ..aOS(2, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'osVersion')
    ..aOS(3, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'osArchitecture')
    ..hasRequiredFields = false
  ;
  ...
  'Use [GeneratedMessageGenericExtensions.rebuild] instead. '
  'Will be removed in next major version')
  Assignment_OsType copyWith(void Function(Assignment_OsType) updates) => super.copyWith((message) => updates(message as Assignment_OsType)) as Assignment_OsType; // ignore: deprecated_member_use
  $pb.BuilderInfo get info_ => _i;
  @$core.pragma('dart2js:noInline')
...
class Assignment extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'Assignment', package: const $pb.PackageName(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'google.cloud.osconfig.v1beta'), createEmptyInstance: create)
    ..pc<Assignment_GroupLabel>(1, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'groupLabels', $pb.PbFieldType.PM, subBuilder: Assignment_GroupLabel.create)
    ..pPS(2, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'zones')
    ..pPS(3, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'instances')
    ..pPS(4, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'instanceNamePrefixes')
    ..pc<Assignment_OsType>(5, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'osTypes', $pb.PbFieldType.PM, subBuilder: Assignment_OsType.create)
    ..hasRequiredFields = false
  ;
...
class Package extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'Package', package: const $pb.PackageName(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'google.cloud.osconfig.v1beta'), createEmptyInstance: create)
    ..aOS(1, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'name')
    ..e<DesiredState>(2, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'desiredState', $pb.PbFieldType.OE, defaultOrMaker: DesiredState.DESIRED_STATE_UNSPECIFIED, valueOf: DesiredState.valueOf, enumValues: DesiredState.values)
    ..e<Package_Manager>(3, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'manager', $pb.PbFieldType.OE, defaultOrMaker: Package_Manager.MANAGER_UNSPECIFIED, valueOf: Package_Manager.valueOf, enumValues: Package_Manager.values)
    ..hasRequiredFields = false
  ;
...
class AptRepository extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'AptRepository', package: const $pb.PackageName(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'google.cloud.osconfig.v1beta'), createEmptyInstance: create)
    ..e<AptRepository_ArchiveType>(1, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'archiveType', $pb.PbFieldType.OE, defaultOrMaker: AptRepository_ArchiveType.ARCHIVE_TYPE_UNSPECIFIED, valueOf: AptRepository_ArchiveType.valueOf, enumValues: AptRepository_ArchiveType.values)
    ..aOS(2, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'uri')
    ..aOS(3, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'distribution')
    ..pPS(4, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'components')
    ..aOS(5, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'gpgKey')
    ..hasRequiredFields = false
  ;
  ...
  'Use [GeneratedMessageGenericExtensions.rebuild] instead. '
  'Will be removed in next major version')
  AptRepository copyWith(void Function(AptRepository) updates) => super.copyWith((message) => updates(message as AptRepository)) as AptRepository; // ignore: deprecated_member_use
  $pb.BuilderInfo get info_ => _i;
  @$core.pragma('dart2js:noInline')
...
class YumRepository extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'YumRepository', package: const $pb.PackageName(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'google.cloud.osconfig.v1beta'), createEmptyInstance: create)
    ...
    ..pPS(4, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'gpgKeys')
    ..hasRequiredFields = false
  ;
  ...
  'Use [GeneratedMessageGenericExtensions.rebuild] instead. '
  'Will be removed in next major version')
  YumRepository copyWith(void Function(YumRepository) updates) => super.copyWith((message) => updates(message as YumRepository)) as YumRepository; // ignore: deprecated_member_use
  $pb.BuilderInfo get info_ => _i;
  @$core.pragma('dart2js:noInline')
...
class ZypperRepository extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'ZypperRepository', package: const $pb.PackageName(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'google.cloud.osconfig.v1beta'), createEmptyInstance: create)
    ..aOS(1, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'id')
    ..aOS(2, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'displayName')
    ..aOS(3, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'baseUrl')
    ..pPS(4, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'gpgKeys')
  ...
  'Use [GeneratedMessageGenericExtensions.rebuild] instead. '
  'Will be removed in next major version')
  ZypperRepository copyWith(void Function(ZypperRepository) updates) => super.copyWith((message) => updates(message as ZypperRepository)) as ZypperRepository; // ignore: deprecated_member_use
  $pb.BuilderInfo get info_ => _i;
  @$core.pragma('dart2js:noInline')
...
class GooRepository extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'GooRepository', package: const $pb.PackageName(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'google.cloud.osconfig.v1beta'), createEmptyInstance: create)
    ..aOS(1, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'name')
  ...
  'Use [GeneratedMessageGenericExtensions.rebuild] instead. '
  'Will be removed in next major version')
  GooRepository copyWith(void Function(GooRepository) updates) => super.copyWith((message) => updates(message as GooRepository)) as GooRepository; // ignore: deprecated_member_use
  $pb.BuilderInfo get info_ => _i;
  @$core.pragma('dart2js:noInline')
...
class PackageRepository extends $pb.GeneratedMessage {
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'PackageRepository', package: const $pb.PackageName(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'google.cloud.osconfig.v1beta'), createEmptyInstance: create)
    ..oo(0, [1, 2, 3, 4])
    ..aOM<AptRepository>(1, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'apt', subBuilder: AptRepository.create)
    ..aOM<YumRepository>(2, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'yum', subBuilder: YumRepository.create)
    ..aOM<ZypperRepository>(3, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'zypper', subBuilder: ZypperRepository.create)
    ..aOM<GooRepository>(4, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'goo', subBuilder: GooRepository.create)
    ..hasRequiredFields = false
  ;
  ...
  'Use [GeneratedMessageGenericExtensions.rebuild] instead. '
  'Will be removed in next major version')
  PackageRepository copyWith(void Function(PackageRepository) updates) => super.copyWith((message) => updates(message as PackageRepository)) as PackageRepository; // ignore: deprecated_member_use
  $pb.BuilderInfo get info_ => _i;
  @$core.pragma('dart2js:noInline')
...
class SoftwareRecipe_Artifact_Remote extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'SoftwareRecipe.Artifact.Remote', package: const $pb.PackageName(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'google.cloud.osconfig.v1beta'), createEmptyInstance: create)
    ..aOS(1, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'uri')
    ..aOS(2, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'checksum')
    ..hasRequiredFields = false
  ;
  ...
  'Use [GeneratedMessageGenericExtensions.rebuild] instead. '
  'Will be removed in next major version')
  SoftwareRecipe_Artifact_Remote copyWith(void Function(SoftwareRecipe_Artifact_Remote) updates) => super.copyWith((message) => updates(message as SoftwareRecipe_Artifact_Remote)) as SoftwareRecipe_Artifact_Remote; // ignore: deprecated_member_use
  $pb.BuilderInfo get info_ => _i;
  @$core.pragma('dart2js:noInline')
...
class SoftwareRecipe_Artifact_Gcs extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'SoftwareRecipe.Artifact.Gcs', package: const $pb.PackageName(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'google.cloud.osconfig.v1beta'), createEmptyInstance: create)
  ...
  'Use [GeneratedMessageGenericExtensions.rebuild] instead. '
  'Will be removed in next major version')
  SoftwareRecipe_Artifact_Gcs copyWith(void Function(SoftwareRecipe_Artifact_Gcs) updates) => super.copyWith((message) => updates(message as SoftwareRecipe_Artifact_Gcs)) as SoftwareRecipe_Artifact_Gcs; // ignore: deprecated_member_use
  $pb.BuilderInfo get info_ => _i;
  @$core.pragma('dart2js:noInline')
...
class SoftwareRecipe_Artifact extends $pb.GeneratedMessage {
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'SoftwareRecipe.Artifact', package: const $pb.PackageName(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'google.cloud.osconfig.v1beta'), createEmptyInstance: create)
    ..oo(0, [2, 3])
    ..aOS(1, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'id')
    ..aOM<SoftwareRecipe_Artifact_Remote>(2, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'remote', subBuilder: SoftwareRecipe_Artifact_Remote.create)
    ..aOM<SoftwareRecipe_Artifact_Gcs>(3, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'gcs', subBuilder: SoftwareRecipe_Artifact_Gcs.create)
    ..aOB(4, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'allowInsecure')
    ..hasRequiredFields = false
  ;
  ...
  'Use [GeneratedMessageGenericExtensions.rebuild] instead. '
  'Will be removed in next major version')
  SoftwareRecipe_Artifact copyWith(void Function(SoftwareRecipe_Artifact) updates) => super.copyWith((message) => updates(message as SoftwareRecipe_Artifact)) as SoftwareRecipe_Artifact; // ignore: deprecated_member_use
  $pb.BuilderInfo get info_ => _i;
  @$core.pragma('dart2js:noInline')
...
class SoftwareRecipe_Step_CopyFile extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'SoftwareRecipe.Step.CopyFile', package: const $pb.PackageName(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'google.cloud.osconfig.v1beta'), createEmptyInstance: create)
    ..aOS(1, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'artifactId')
    ...
    ..aOS(4, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'permissions')
    ..hasRequiredFields = false
  ;
  ...
  'Use [GeneratedMessageGenericExtensions.rebuild] instead. '
  'Will be removed in next major version')
  SoftwareRecipe_Step_CopyFile copyWith(void Function(SoftwareRecipe_Step_CopyFile) updates) => super.copyWith((message) => updates(message as SoftwareRecipe_Step_CopyFile)) as SoftwareRecipe_Step_CopyFile; // ignore: deprecated_member_use
  $pb.BuilderInfo get info_ => _i;
  @$core.pragma('dart2js:noInline')
...
class SoftwareRecipe_Step_ExtractArchive extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'SoftwareRecipe.Step.ExtractArchive', package: const $pb.PackageName(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'google.cloud.osconfig.v1beta'), createEmptyInstance: create)
    ..aOS(1, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'artifactId')
    ..aOS(2, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'destination')
    ..e<SoftwareRecipe_Step_ExtractArchive_ArchiveType>(3, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'type', $pb.PbFieldType.OE, defaultOrMaker: SoftwareRecipe_Step_ExtractArchive_ArchiveType.ARCHIVE_TYPE_UNSPECIFIED, valueOf: SoftwareRecipe_Step_ExtractArchive_ArchiveType.valueOf, enumValues: SoftwareRecipe_Step_ExtractArchive_ArchiveType.values)
    ..hasRequiredFields = false
  ;
  ...
  'Use [GeneratedMessageGenericExtensions.rebuild] instead. '
  'Will be removed in next major version')
  SoftwareRecipe_Step_ExtractArchive copyWith(void Function(SoftwareRecipe_Step_ExtractArchive) updates) => super.copyWith((message) => updates(message as SoftwareRecipe_Step_ExtractArchive)) as SoftwareRecipe_Step_ExtractArchive; // ignore: deprecated_member_use
  $pb.BuilderInfo get info_ => _i;
  @$core.pragma('dart2js:noInline')
...
class SoftwareRecipe_Step_InstallMsi extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'SoftwareRecipe.Step.InstallMsi', package: const $pb.PackageName(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'google.cloud.osconfig.v1beta'), createEmptyInstance: create)
    ..aOS(1, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'artifactId')
    ..pPS(2, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'flags')
    ..p<$core.int>(3, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'allowedExitCodes', $pb.PbFieldType.P3)
    ..hasRequiredFields = false
  ;
  ...
  'Use [GeneratedMessageGenericExtensions.rebuild] instead. '
  'Will be removed in next major version')
  SoftwareRecipe_Step_InstallMsi copyWith(void Function(SoftwareRecipe_Step_InstallMsi) updates) => super.copyWith((message) => updates(message as SoftwareRecipe_Step_InstallMsi)) as SoftwareRecipe_Step_InstallMsi; // ignore: deprecated_member_use
  $pb.BuilderInfo get info_ => _i;
  @$core.pragma('dart2js:noInline')
...
class SoftwareRecipe_Step_InstallDpkg extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'SoftwareRecipe.Step.InstallDpkg', package: const $pb.PackageName(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'google.cloud.osconfig.v1beta'), createEmptyInstance: create)
    ..aOS(1, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'artifactId')
    ..hasRequiredFields = false
  ;
  ...
  'Use [GeneratedMessageGenericExtensions.rebuild] instead. '
  'Will be removed in next major version')
  SoftwareRecipe_Step_InstallDpkg copyWith(void Function(SoftwareRecipe_Step_InstallDpkg) updates) => super.copyWith((message) => updates(message as SoftwareRecipe_Step_InstallDpkg)) as SoftwareRecipe_Step_InstallDpkg; // ignore: deprecated_member_use
  $pb.BuilderInfo get info_ => _i;
  @$core.pragma('dart2js:noInline')
...
class SoftwareRecipe_Step_InstallRpm extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'SoftwareRecipe.Step.InstallRpm', package: const $pb.PackageName(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'google.cloud.osconfig.v1beta'), createEmptyInstance: create)
    ..aOS(1, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'artifactId')
    ..hasRequiredFields = false
  ;
  ...
  'Use [GeneratedMessageGenericExtensions.rebuild] instead. '
  'Will be removed in next major version')
  SoftwareRecipe_Step_InstallRpm copyWith(void Function(SoftwareRecipe_Step_InstallRpm) updates) => super.copyWith((message) => updates(message as SoftwareRecipe_Step_InstallRpm)) as SoftwareRecipe_Step_InstallRpm; // ignore: deprecated_member_use
  $pb.BuilderInfo get info_ => _i;
  @$core.pragma('dart2js:noInline')
...
class SoftwareRecipe_Step_ExecFile extends $pb.GeneratedMessage {
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'SoftwareRecipe.Step.ExecFile', package: const $pb.PackageName(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'google.cloud.osconfig.v1beta'), createEmptyInstance: create)
    ..oo(0, [1, 2])
    ..aOS(1, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'artifactId')
    ...
    ..p<$core.int>(4, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'allowedExitCodes', $pb.PbFieldType.P3)
    ..hasRequiredFields = false
  ;
  ...
  'Use [GeneratedMessageGenericExtensions.rebuild] instead. '
  'Will be removed in next major version')
  SoftwareRecipe_Step_ExecFile copyWith(void Function(SoftwareRecipe_Step_ExecFile) updates) => super.copyWith((message) => updates(message as SoftwareRecipe_Step_ExecFile)) as SoftwareRecipe_Step_ExecFile; // ignore: deprecated_member_use
  $pb.BuilderInfo get info_ => _i;
  @$core.pragma('dart2js:noInline')
...
class SoftwareRecipe_Step_RunScript extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'SoftwareRecipe.Step.RunScript', package: const $pb.PackageName(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'google.cloud.osconfig.v1beta'), createEmptyInstance: create)
    ..aOS(1, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'script')
    ..p<$core.int>(2, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'allowedExitCodes', $pb.PbFieldType.P3)
    ..e<SoftwareRecipe_Step_RunScript_Interpreter>(3, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'interpreter', $pb.PbFieldType.OE, defaultOrMaker: SoftwareRecipe_Step_RunScript_Interpreter.INTERPRETER_UNSPECIFIED, valueOf: SoftwareRecipe_Step_RunScript_Interpreter.valueOf, enumValues: SoftwareRecipe_Step_RunScript_Interpreter.values)
    ..hasRequiredFields = false
  ;
  ...
  'Use [GeneratedMessageGenericExtensions.rebuild] instead. '
  'Will be removed in next major version')
  SoftwareRecipe_Step_RunScript copyWith(void Function(SoftwareRecipe_Step_RunScript) updates) => super.copyWith((message) => updates(message as SoftwareRecipe_Step_RunScript)) as SoftwareRecipe_Step_RunScript; // ignore: deprecated_member_use
  $pb.BuilderInfo get info_ => _i;
  @$core.pragma('dart2js:noInline')
...
class SoftwareRecipe_Step extends $pb.GeneratedMessage {
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'SoftwareRecipe.Step', package: const $pb.PackageName(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'google.cloud.osconfig.v1beta'), createEmptyInstance: create)
    ..oo(0, [1, 2, 3, 4, 5, 6, 7])
    ..aOM<SoftwareRecipe_Step_CopyFile>(1, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'fileCopy', subBuilder: SoftwareRecipe_Step_CopyFile.create)
    ..aOM<SoftwareRecipe_Step_ExtractArchive>(2, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'archiveExtraction', subBuilder: SoftwareRecipe_Step_ExtractArchive.create)
    ..aOM<SoftwareRecipe_Step_InstallMsi>(3, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'msiInstallation', subBuilder: SoftwareRecipe_Step_InstallMsi.create)
    ..aOM<SoftwareRecipe_Step_InstallDpkg>(4, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'dpkgInstallation', subBuilder: SoftwareRecipe_Step_InstallDpkg.create)
    ..aOM<SoftwareRecipe_Step_InstallRpm>(5, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'rpmInstallation', subBuilder: SoftwareRecipe_Step_InstallRpm.create)
    ..aOM<SoftwareRecipe_Step_ExecFile>(6, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'fileExec', subBuilder: SoftwareRecipe_Step_ExecFile.create)
    ..aOM<SoftwareRecipe_Step_RunScript>(7, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'scriptRun', subBuilder: SoftwareRecipe_Step_RunScript.create)
    ..hasRequiredFields = false
  ;
  ...
  'Use [GeneratedMessageGenericExtensions.rebuild] instead. '
  'Will be removed in next major version')
  SoftwareRecipe_Step copyWith(void Function(SoftwareRecipe_Step) updates) => super.copyWith((message) => updates(message as SoftwareRecipe_Step)) as SoftwareRecipe_Step; // ignore: deprecated_member_use
  $pb.BuilderInfo get info_ => _i;
  @$core.pragma('dart2js:noInline')
...
class SoftwareRecipe extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'SoftwareRecipe', package: const $pb.PackageName(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'google.cloud.osconfig.v1beta'), createEmptyInstance: create)
    ..aOS(1, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'name')
    ..aOS(2, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'version')
    ..pc<SoftwareRecipe_Artifact>(3, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'artifacts', $pb.PbFieldType.PM, subBuilder: SoftwareRecipe_Artifact.create)
    ..pc<SoftwareRecipe_Step>(4, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'installSteps', $pb.PbFieldType.PM, subBuilder: SoftwareRecipe_Step.create)
    ..pc<SoftwareRecipe_Step>(5, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'updateSteps', $pb.PbFieldType.PM, subBuilder: SoftwareRecipe_Step.create)
    ..e<DesiredState>(6, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'desiredState', $pb.PbFieldType.OE, defaultOrMaker: DesiredState.DESIRED_STATE_UNSPECIFIED, valueOf: DesiredState.valueOf, enumValues: DesiredState.values)
    ..hasRequiredFields = false
  ;
  ...
  'Use [GeneratedMessageGenericExtensions.rebuild] instead. '
  'Will be removed in next major version')
  SoftwareRecipe copyWith(void Function(SoftwareRecipe) updates) => super.copyWith((message) => updates(message as SoftwareRecipe)) as SoftwareRecipe; // ignore: deprecated_member_use
  $pb.BuilderInfo get info_ => _i;
  @$core.pragma('dart2js:noInline')
...
class CreateGuestPolicyRequest extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'CreateGuestPolicyRequest', package: const $pb.PackageName(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'google.cloud.osconfig.v1beta'), createEmptyInstance: create)
    ..aOS(1, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'parent')
    ..aOS(2, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'guestPolicyId')
    ..aOM<GuestPolicy>(3, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'guestPolicy', subBuilder: GuestPolicy.create)
    ..hasRequiredFields = false
  ;
  ...
  'Use [GeneratedMessageGenericExtensions.rebuild] instead. '
  'Will be removed in next major version')
  CreateGuestPolicyRequest copyWith(void Function(CreateGuestPolicyRequest) updates) => super.copyWith((message) => updates(message as CreateGuestPolicyRequest)) as CreateGuestPolicyRequest; // ignore: deprecated_member_use
  $pb.BuilderInfo get info_ => _i;
  @$core.pragma('dart2js:noInline')
...
class GetGuestPolicyRequest extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'GetGuestPolicyRequest', package: const $pb.PackageName(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'google.cloud.osconfig.v1beta'), createEmptyInstance: create)
    ..aOS(1, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'name')
    ..hasRequiredFields = false
  ;
  ...
  'Use [GeneratedMessageGenericExtensions.rebuild] instead. '
  'Will be removed in next major version')
  GetGuestPolicyRequest copyWith(void Function(GetGuestPolicyRequest) updates) => super.copyWith((message) => updates(message as GetGuestPolicyRequest)) as GetGuestPolicyRequest; // ignore: deprecated_member_use
  $pb.BuilderInfo get info_ => _i;
  @$core.pragma('dart2js:noInline')
...
class ListGuestPoliciesRequest extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'ListGuestPoliciesRequest', package: const $pb.PackageName(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'google.cloud.osconfig.v1beta'), createEmptyInstance: create)
    ..aOS(1, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'parent')
  ...
  'Use [GeneratedMessageGenericExtensions.rebuild] instead. '
  'Will be removed in next major version')
  ListGuestPoliciesRequest copyWith(void Function(ListGuestPoliciesRequest) updates) => super.copyWith((message) => updates(message as ListGuestPoliciesRequest)) as ListGuestPoliciesRequest; // ignore: deprecated_member_use
  $pb.BuilderInfo get info_ => _i;
  @$core.pragma('dart2js:noInline')
...
class ListGuestPoliciesResponse extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'ListGuestPoliciesResponse', package: const $pb.PackageName(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'google.cloud.osconfig.v1beta'), createEmptyInstance: create)
    ..pc<GuestPolicy>(1, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'guestPolicies', $pb.PbFieldType.PM, subBuilder: GuestPolicy.create)
  ...
  'Use [GeneratedMessageGenericExtensions.rebuild] instead. '
  'Will be removed in next major version')
  ListGuestPoliciesResponse copyWith(void Function(ListGuestPoliciesResponse) updates) => super.copyWith((message) => updates(message as ListGuestPoliciesResponse)) as ListGuestPoliciesResponse; // ignore: deprecated_member_use
  $pb.BuilderInfo get info_ => _i;
  @$core.pragma('dart2js:noInline')
...
class UpdateGuestPolicyRequest extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'UpdateGuestPolicyRequest', package: const $pb.PackageName(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'google.cloud.osconfig.v1beta'), createEmptyInstance: create)
    ..aOM<GuestPolicy>(1, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'guestPolicy', subBuilder: GuestPolicy.create)
  ...
  'Use [GeneratedMessageGenericExtensions.rebuild] instead. '
  'Will be removed in next major version')
  UpdateGuestPolicyRequest copyWith(void Function(UpdateGuestPolicyRequest) updates) => super.copyWith((message) => updates(message as UpdateGuestPolicyRequest)) as UpdateGuestPolicyRequest; // ignore: deprecated_member_use
  $pb.BuilderInfo get info_ => _i;
  @$core.pragma('dart2js:noInline')
...
class DeleteGuestPolicyRequest extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'DeleteGuestPolicyRequest', package: const $pb.PackageName(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'google.cloud.osconfig.v1beta'), createEmptyInstance: create)
    ..aOS(1, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'name')
    ..hasRequiredFields = false
  ;
  ...
  'Use [GeneratedMessageGenericExtensions.rebuild] instead. '
  'Will be removed in next major version')
  DeleteGuestPolicyRequest copyWith(void Function(DeleteGuestPolicyRequest) updates) => super.copyWith((message) => updates(message as DeleteGuestPolicyRequest)) as DeleteGuestPolicyRequest; // ignore: deprecated_member_use
  $pb.BuilderInfo get info_ => _i;
  @$core.pragma('dart2js:noInline')
...
class LookupEffectiveGuestPolicyRequest extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'LookupEffectiveGuestPolicyRequest', package: const $pb.PackageName(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'google.cloud.osconfig.v1beta'), createEmptyInstance: create)
    ..aOS(1, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'instance')
    ..aOS(2, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'osShortName')
    ..aOS(3, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'osVersion')
    ..aOS(4, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'osArchitecture')
    ..hasRequiredFields = false
  ;
  ...
  'Use [GeneratedMessageGenericExtensions.rebuild] instead. '
  'Will be removed in next major version')
  LookupEffectiveGuestPolicyRequest copyWith(void Function(LookupEffectiveGuestPolicyRequest) updates) => super.copyWith((message) => updates(message as LookupEffectiveGuestPolicyRequest)) as LookupEffectiveGuestPolicyRequest; // ignore: deprecated_member_use
  $pb.BuilderInfo get info_ => _i;
  @$core.pragma('dart2js:noInline')
...
class EffectiveGuestPolicy_SourcedPackage extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'EffectiveGuestPolicy.SourcedPackage', package: const $pb.PackageName(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'google.cloud.osconfig.v1beta'), createEmptyInstance: create)
  ...
  'Use [GeneratedMessageGenericExtensions.rebuild] instead. '
  'Will be removed in next major version')
  EffectiveGuestPolicy_SourcedPackage copyWith(void Function(EffectiveGuestPolicy_SourcedPackage) updates) => super.copyWith((message) => updates(message as EffectiveGuestPolicy_SourcedPackage)) as EffectiveGuestPolicy_SourcedPackage; // ignore: deprecated_member_use
  $pb.BuilderInfo get info_ => _i;
  @$core.pragma('dart2js:noInline')
...
class EffectiveGuestPolicy_SourcedPackageRepository extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'EffectiveGuestPolicy.SourcedPackageRepository', package: const $pb.PackageName(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'google.cloud.osconfig.v1beta'), createEmptyInstance: create)
    ..aOS(1, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'source')
    ..aOM<PackageRepository>(2, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'packageRepository', subBuilder: PackageRepository.create)
    ..hasRequiredFields = false
  ;
  ...
  'Use [GeneratedMessageGenericExtensions.rebuild] instead. '
  'Will be removed in next major version')
  EffectiveGuestPolicy_SourcedPackageRepository copyWith(void Function(EffectiveGuestPolicy_SourcedPackageRepository) updates) => super.copyWith((message) => updates(message as EffectiveGuestPolicy_SourcedPackageRepository)) as EffectiveGuestPolicy_SourcedPackageRepository; // ignore: deprecated_member_use
  $pb.BuilderInfo get info_ => _i;
  @$core.pragma('dart2js:noInline')
...
class EffectiveGuestPolicy_SourcedSoftwareRecipe extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'EffectiveGuestPolicy.SourcedSoftwareRecipe', package: const $pb.PackageName(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'google.cloud.osconfig.v1beta'), createEmptyInstance: create)
    ..aOS(1, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'source')
    ..aOM<SoftwareRecipe>(2, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'softwareRecipe', subBuilder: SoftwareRecipe.create)
    ..hasRequiredFields = false
  ;
  ...
  'Use [GeneratedMessageGenericExtensions.rebuild] instead. '
  'Will be removed in next major version')
  EffectiveGuestPolicy_SourcedSoftwareRecipe copyWith(void Function(EffectiveGuestPolicy_SourcedSoftwareRecipe) updates) => super.copyWith((message) => updates(message as EffectiveGuestPolicy_SourcedSoftwareRecipe)) as EffectiveGuestPolicy_SourcedSoftwareRecipe; // ignore: deprecated_member_use
  $pb.BuilderInfo get info_ => _i;
  @$core.pragma('dart2js:noInline')
...
class EffectiveGuestPolicy extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'EffectiveGuestPolicy', package: const $pb.PackageName(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'google.cloud.osconfig.v1beta'), createEmptyInstance: create)
    ..pc<EffectiveGuestPolicy_SourcedPackage>(1, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'packages', $pb.PbFieldType.PM, subBuilder: EffectiveGuestPolicy_SourcedPackage.create)
    ..pc<EffectiveGuestPolicy_SourcedPackageRepository>(2, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'packageRepositories', $pb.PbFieldType.PM, subBuilder: EffectiveGuestPolicy_SourcedPackageRepository.create)
    ..pc<EffectiveGuestPolicy_SourcedSoftwareRecipe>(3, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'softwareRecipes', $pb.PbFieldType.PM, subBuilder: EffectiveGuestPolicy_SourcedSoftwareRecipe.create)
    ..hasRequiredFields = false
  ;
  ...
  'Use [GeneratedMessageGenericExtensions.rebuild] instead. '
  'Will be removed in next major version')
  EffectiveGuestPolicy copyWith(void Function(EffectiveGuestPolicy) updates) => super.copyWith((message) => updates(message as EffectiveGuestPolicy)) as EffectiveGuestPolicy; // ignore: deprecated_member_use
  $pb.BuilderInfo get info_ => _i;
  @$core.pragma('dart2js:noInline')

...
class OsConfigServiceClient extends $grpc.Client {
  ...
  static final _$updatePatchDeployment =
      $grpc.ClientMethod<$1.UpdatePatchDeploymentRequest, $1.PatchDeployment>(
          '/google.cloud.osconfig.v1.OsConfigService/UpdatePatchDeployment',
          ($1.UpdatePatchDeploymentRequest value) => value.writeToBuffer(),
          ($core.List<$core.int> value) =>
              $1.PatchDeployment.fromBuffer(value));
  static final _$pausePatchDeployment =
      $grpc.ClientMethod<$1.PausePatchDeploymentRequest, $1.PatchDeployment>(
          '/google.cloud.osconfig.v1.OsConfigService/PausePatchDeployment',
          ($1.PausePatchDeploymentRequest value) => value.writeToBuffer(),
          ($core.List<$core.int> value) =>
              $1.PatchDeployment.fromBuffer(value));
  static final _$resumePatchDeployment =
      $grpc.ClientMethod<$1.ResumePatchDeploymentRequest, $1.PatchDeployment>(
          '/google.cloud.osconfig.v1.OsConfigService/ResumePatchDeployment',
          ($1.ResumePatchDeploymentRequest value) => value.writeToBuffer(),
          ($core.List<$core.int> value) =>
              $1.PatchDeployment.fromBuffer(value));
  ...
  $grpc.ResponseFuture<$1.PatchDeployment> updatePatchDeployment(
      $1.UpdatePatchDeploymentRequest request,
      {$grpc.CallOptions? options}) {
    return $createUnaryCall(_$updatePatchDeployment, request, options: options);
  }

  $grpc.ResponseFuture<$1.PatchDeployment> pausePatchDeployment(
      $1.PausePatchDeploymentRequest request,
      {$grpc.CallOptions? options}) {
    return $createUnaryCall(_$pausePatchDeployment, request, options: options);
  }

  $grpc.ResponseFuture<$1.PatchDeployment> resumePatchDeployment(
      $1.ResumePatchDeploymentRequest request,
      {$grpc.CallOptions? options}) {
...
abstract class OsConfigServiceBase extends $grpc.Service {
  ...
  OsConfigServiceBase() {
    ...
    $addMethod($grpc.ServiceMethod<$1.UpdatePatchDeploymentRequest,
            $1.PatchDeployment>(
        ...
        false,
        ($core.List<$core.int> value) =>
            $1.UpdatePatchDeploymentRequest.fromBuffer(value),
        ($1.PatchDeployment value) => value.writeToBuffer()));
    $addMethod(
        $grpc.ServiceMethod<$1.PausePatchDeploymentRequest, $1.PatchDeployment>(
            'PausePatchDeployment',
            pausePatchDeployment_Pre,
            false,
            false,
            ($core.List<$core.int> value) =>
                $1.PausePatchDeploymentRequest.fromBuffer(value),
            ($1.PatchDeployment value) => value.writeToBuffer()));
    $addMethod($grpc.ServiceMethod<$1.ResumePatchDeploymentRequest,
            $1.PatchDeployment>(
        ...
        false,
        ($core.List<$core.int> value) =>
            $1.ResumePatchDeploymentRequest.fromBuffer(value),
        ($1.PatchDeployment value) => value.writeToBuffer()));
  }
  ...
  $async.Future<$1.PatchDeployment> updatePatchDeployment_Pre(
      $grpc.ServiceCall call,
      $async.Future<$1.UpdatePatchDeploymentRequest> request) async {
    return updatePatchDeployment(call, await request);
  }

  $async.Future<$1.PatchDeployment> pausePatchDeployment_Pre(
      $grpc.ServiceCall call,
      $async.Future<$1.PausePatchDeploymentRequest> request) async {
    return pausePatchDeployment(call, await request);
  }

  $async.Future<$1.PatchDeployment> resumePatchDeployment_Pre(
      $grpc.ServiceCall call,
      $async.Future<$1.ResumePatchDeploymentRequest> request) async {
  ...
  $async.Future<$1.PatchDeployment> updatePatchDeployment(
      $grpc.ServiceCall call, $1.UpdatePatchDeploymentRequest request);
  $async.Future<$1.PatchDeployment> pausePatchDeployment(
      $grpc.ServiceCall call, $1.PausePatchDeploymentRequest request);
  $async.Future<$1.PatchDeployment> resumePatchDeployment(
      $grpc.ServiceCall call, $1.ResumePatchDeploymentRequest request);
}

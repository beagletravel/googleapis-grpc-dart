...
final $typed_data.Uint8List listOSPolicyAssignmentReportsRequestDescriptor = $convert.base64Decode('');
...
const ListOSPolicyAssignmentReportsResponse$json = const {
  ...
  '2': const [
    const {'1': 'os_policy_assignment_reports', '3': 1, '4': 3, '5': 11, '6': '.google.cloud.osconfig.v1.OSPolicyAssignmentReport', '10': 'osPolicyAssignmentReports'},
    const {'1': 'next_page_token', '3': 2, '4': 1, '5': 9, '10': 'nextPageToken'},
  ],
};

/// Descriptor for `ListOSPolicyAssignmentReportsResponse`. Decode as a `google.protobuf.DescriptorProto`.
final $typed_data.Uint8List listOSPolicyAssignmentReportsResponseDescriptor = $convert.base64Decode('');
...
const OSPolicyAssignmentReport$json = const {
  ...
  '2': const [
    ...
    const {'1': 'os_policy_compliances', '3': 4, '4': 3, '5': 11, '6': '.google.cloud.osconfig.v1.OSPolicyAssignmentReport.OSPolicyCompliance', '10': 'osPolicyCompliances'},
...
const OSPolicyAssignmentReport_OSPolicyCompliance$json = const {
  ...
  '2': const [
    ...
    const {'1': 'compliance_state', '3': 2, '4': 1, '5': 14, '6': '.google.cloud.osconfig.v1.OSPolicyAssignmentReport.OSPolicyCompliance.ComplianceState', '10': 'complianceState'},
    const {'1': 'compliance_state_reason', '3': 3, '4': 1, '5': 9, '10': 'complianceStateReason'},
    const {'1': 'os_policy_resource_compliances', '3': 4, '4': 3, '5': 11, '6': '.google.cloud.osconfig.v1.OSPolicyAssignmentReport.OSPolicyCompliance.OSPolicyResourceCompliance', '10': 'osPolicyResourceCompliances'},
  ],
...
const OSPolicyAssignmentReport_OSPolicyCompliance_OSPolicyResourceCompliance$json = const {
  ...
  '2': const [
    ...
    const {'1': 'config_steps', '3': 2, '4': 3, '5': 11, '6': '.google.cloud.osconfig.v1.OSPolicyAssignmentReport.OSPolicyCompliance.OSPolicyResourceCompliance.OSPolicyResourceConfigStep', '10': 'configSteps'},
    const {'1': 'compliance_state', '3': 3, '4': 1, '5': 14, '6': '.google.cloud.osconfig.v1.OSPolicyAssignmentReport.OSPolicyCompliance.OSPolicyResourceCompliance.ComplianceState', '10': 'complianceState'},
    const {'1': 'compliance_state_reason', '3': 4, '4': 1, '5': 9, '10': 'complianceStateReason'},
    const {'1': 'exec_resource_output', '3': 5, '4': 1, '5': 11, '6': '.google.cloud.osconfig.v1.OSPolicyAssignmentReport.OSPolicyCompliance.OSPolicyResourceCompliance.ExecResourceOutput', '9': 0, '10': 'execResourceOutput'},
  ],
...
const OSPolicyAssignmentReport_OSPolicyCompliance_OSPolicyResourceCompliance_OSPolicyResourceConfigStep$json = const {
  ...
  '2': const [
    const {'1': 'type', '3': 1, '4': 1, '5': 14, '6': '.google.cloud.osconfig.v1.OSPolicyAssignmentReport.OSPolicyCompliance.OSPolicyResourceCompliance.OSPolicyResourceConfigStep.Type', '10': 'type'},

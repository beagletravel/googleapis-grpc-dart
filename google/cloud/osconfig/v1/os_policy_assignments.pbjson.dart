...
const OSPolicyAssignment$json = const {
  ...
  '2': const [
    ...
    const {'1': 'os_policies', '3': 3, '4': 3, '5': 11, '6': '.google.cloud.osconfig.v1.OSPolicy', '8': const {}, '10': 'osPolicies'},
    const {'1': 'instance_filter', '3': 4, '4': 1, '5': 11, '6': '.google.cloud.osconfig.v1.OSPolicyAssignment.InstanceFilter', '8': const {}, '10': 'instanceFilter'},
    const {'1': 'rollout', '3': 5, '4': 1, '5': 11, '6': '.google.cloud.osconfig.v1.OSPolicyAssignment.Rollout', '8': const {}, '10': 'rollout'},
    ...
    const {'1': 'rollout_state', '3': 9, '4': 1, '5': 14, '6': '.google.cloud.osconfig.v1.OSPolicyAssignment.RolloutState', '8': const {}, '10': 'rolloutState'},
...
const OSPolicyAssignment_LabelSet$json = const {
  '1': 'LabelSet',
  '2': const [
    const {'1': 'labels', '3': 1, '4': 3, '5': 11, '6': '.google.cloud.osconfig.v1.OSPolicyAssignment.LabelSet.LabelsEntry', '10': 'labels'},
  ],
...
const OSPolicyAssignment_InstanceFilter$json = const {
  ...
  '2': const [
    ...
    const {'1': 'inclusion_labels', '3': 2, '4': 3, '5': 11, '6': '.google.cloud.osconfig.v1.OSPolicyAssignment.LabelSet', '10': 'inclusionLabels'},
    const {'1': 'exclusion_labels', '3': 3, '4': 3, '5': 11, '6': '.google.cloud.osconfig.v1.OSPolicyAssignment.LabelSet', '10': 'exclusionLabels'},
    const {'1': 'inventories', '3': 4, '4': 3, '5': 11, '6': '.google.cloud.osconfig.v1.OSPolicyAssignment.InstanceFilter.Inventory', '10': 'inventories'},
  ],
...
const OSPolicyAssignment_Rollout$json = const {
  '1': 'Rollout',
  '2': const [
    const {'1': 'disruption_budget', '3': 1, '4': 1, '5': 11, '6': '.google.cloud.osconfig.v1.FixedOrPercent', '8': const {}, '10': 'disruptionBudget'},
...
const OSPolicyAssignmentOperationMetadata$json = const {
  ...
  '2': const [
    ...
    const {'1': 'api_method', '3': 2, '4': 1, '5': 14, '6': '.google.cloud.osconfig.v1.OSPolicyAssignmentOperationMetadata.APIMethod', '10': 'apiMethod'},
    const {'1': 'rollout_state', '3': 3, '4': 1, '5': 14, '6': '.google.cloud.osconfig.v1.OSPolicyAssignmentOperationMetadata.RolloutState', '10': 'rolloutState'},
...
const CreateOSPolicyAssignmentRequest$json = const {
  ...
  '2': const [
    ...
    const {'1': 'os_policy_assignment', '3': 2, '4': 1, '5': 11, '6': '.google.cloud.osconfig.v1.OSPolicyAssignment', '8': const {}, '10': 'osPolicyAssignment'},
...
final $typed_data.Uint8List createOSPolicyAssignmentRequestDescriptor = $convert.base64Decode('');
...
const UpdateOSPolicyAssignmentRequest$json = const {
  ...
  '2': const [
    const {'1': 'os_policy_assignment', '3': 1, '4': 1, '5': 11, '6': '.google.cloud.osconfig.v1.OSPolicyAssignment', '8': const {}, '10': 'osPolicyAssignment'},
...
final $typed_data.Uint8List updateOSPolicyAssignmentRequestDescriptor = $convert.base64Decode('');
...
const ListOSPolicyAssignmentsResponse$json = const {
  ...
  '2': const [
    const {'1': 'os_policy_assignments', '3': 1, '4': 3, '5': 11, '6': '.google.cloud.osconfig.v1.OSPolicyAssignment', '10': 'osPolicyAssignments'},
    const {'1': 'next_page_token', '3': 2, '4': 1, '5': 9, '10': 'nextPageToken'},
  ],
};

/// Descriptor for `ListOSPolicyAssignmentsResponse`. Decode as a `google.protobuf.DescriptorProto`.
final $typed_data.Uint8List listOSPolicyAssignmentsResponseDescriptor = $convert.base64Decode('Ch9MaXN0T1NQb2xpY3lBc3NpZ25tZW50c1Jlc3BvbnNlEmAKFW9zX3BvbGljeV9hc3NpZ25tZW50cxgBIAMoCzIsLmdvb2dsZS5jbG91ZC5vc2NvbmZpZy52MS5PU1BvbGljeUFzc2lnbm1lbnRSE29zUG9saWN5QXNzaWdubWVudHMSJgoPbmV4dF9wYWdlX3Rva2VuGAIgASgJUg1uZXh0UGFnZVRva2Vu');
...
final $typed_data.Uint8List listOSPolicyAssignmentRevisionsResponseDescriptor = $convert.base64Decode('CidMaXN0T1NQb2xpY3lBc3NpZ25tZW50UmV2aXNpb25zUmVzcG9uc2USYAoVb3NfcG9saWN5X2Fzc2lnbm1lbnRzGAEgAygLMiwuZ29vZ2xlLmNsb3VkLm9zY29uZmlnLnYxLk9TUG9saWN5QXNzaWdubWVudFITb3NQb2xpY3lBc3NpZ25tZW50cxImCg9uZXh0X3BhZ2VfdG9rZW4YAiABKAlSDW5leHRQYWdlVG9rZW4=');

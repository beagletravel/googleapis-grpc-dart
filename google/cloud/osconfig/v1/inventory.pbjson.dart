...
const Inventory$json = const {
  ...
  '2': const [
    ...
    const {'1': 'os_info', '3': 1, '4': 1, '5': 11, '6': '.google.cloud.osconfig.v1.Inventory.OsInfo', '10': 'osInfo'},
    const {'1': 'items', '3': 2, '4': 3, '5': 11, '6': '.google.cloud.osconfig.v1.Inventory.ItemsEntry', '10': 'items'},
...
const Inventory_Item$json = const {
  ...
  '2': const [
    ...
    const {'1': 'origin_type', '3': 2, '4': 1, '5': 14, '6': '.google.cloud.osconfig.v1.Inventory.Item.OriginType', '10': 'originType'},
    ...
    const {'1': 'type', '3': 5, '4': 1, '5': 14, '6': '.google.cloud.osconfig.v1.Inventory.Item.Type', '10': 'type'},
    const {'1': 'installed_package', '3': 6, '4': 1, '5': 11, '6': '.google.cloud.osconfig.v1.Inventory.SoftwarePackage', '9': 0, '10': 'installedPackage'},
    const {'1': 'available_package', '3': 7, '4': 1, '5': 11, '6': '.google.cloud.osconfig.v1.Inventory.SoftwarePackage', '9': 0, '10': 'availablePackage'},
  ],
...
const Inventory_SoftwarePackage$json = const {
  '1': 'SoftwarePackage',
  '2': const [
    const {'1': 'yum_package', '3': 1, '4': 1, '5': 11, '6': '.google.cloud.osconfig.v1.Inventory.VersionedPackage', '9': 0, '10': 'yumPackage'},
    const {'1': 'apt_package', '3': 2, '4': 1, '5': 11, '6': '.google.cloud.osconfig.v1.Inventory.VersionedPackage', '9': 0, '10': 'aptPackage'},
    const {'1': 'zypper_package', '3': 3, '4': 1, '5': 11, '6': '.google.cloud.osconfig.v1.Inventory.VersionedPackage', '9': 0, '10': 'zypperPackage'},
    const {'1': 'googet_package', '3': 4, '4': 1, '5': 11, '6': '.google.cloud.osconfig.v1.Inventory.VersionedPackage', '9': 0, '10': 'googetPackage'},
    const {'1': 'zypper_patch', '3': 5, '4': 1, '5': 11, '6': '.google.cloud.osconfig.v1.Inventory.ZypperPatch', '9': 0, '10': 'zypperPatch'},
    const {'1': 'wua_package', '3': 6, '4': 1, '5': 11, '6': '.google.cloud.osconfig.v1.Inventory.WindowsUpdatePackage', '9': 0, '10': 'wuaPackage'},
    const {'1': 'qfe_package', '3': 7, '4': 1, '5': 11, '6': '.google.cloud.osconfig.v1.Inventory.WindowsQuickFixEngineeringPackage', '9': 0, '10': 'qfePackage'},
    const {'1': 'cos_package', '3': 8, '4': 1, '5': 11, '6': '.google.cloud.osconfig.v1.Inventory.VersionedPackage', '9': 0, '10': 'cosPackage'},
    const {'1': 'windows_application', '3': 9, '4': 1, '5': 11, '6': '.google.cloud.osconfig.v1.Inventory.WindowsApplication', '9': 0, '10': 'windowsApplication'},
  ],
  '8': const [
    const {'1': 'details'},
  ],
...
const Inventory_WindowsUpdatePackage$json = const {
  ...
  '2': const [
    ...
    const {'1': 'categories', '3': 3, '4': 3, '5': 11, '6': '.google.cloud.osconfig.v1.Inventory.WindowsUpdatePackage.WindowsUpdateCategory', '10': 'categories'},
...
const GetInventoryRequest$json = const {
  ...
  '2': const [
    ...
    const {'1': 'view', '3': 2, '4': 1, '5': 14, '6': '.google.cloud.osconfig.v1.InventoryView', '10': 'view'},
  ],
};

/// Descriptor for `GetInventoryRequest`. Decode as a `google.protobuf.DescriptorProto`.
final $typed_data.Uint8List getInventoryRequestDescriptor = $convert.base64Decode('ChNHZXRJbnZlbnRvcnlSZXF1ZXN0Ej0KBG5hbWUYASABKAlCKeBBAvpBIwohb3Njb25maWcuZ29vZ2xlYXBpcy5jb20vSW52ZW50b3J5UgRuYW1lEjsKBHZpZXcYAiABKA4yJy5nb29nbGUuY2xvdWQub3Njb25maWcudjEuSW52ZW50b3J5Vmlld1IEdmlldw==');
...
final $typed_data.Uint8List listInventoriesRequestDescriptor = $convert.base64Decode('');
...
const ListInventoriesResponse$json = const {
  ...
  '2': const [
    const {'1': 'inventories', '3': 1, '4': 3, '5': 11, '6': '.google.cloud.osconfig.v1.Inventory', '10': 'inventories'},
    const {'1': 'next_page_token', '3': 2, '4': 1, '5': 9, '10': 'nextPageToken'},
  ],
};

/// Descriptor for `ListInventoriesResponse`. Decode as a `google.protobuf.DescriptorProto`.
final $typed_data.Uint8List listInventoriesResponseDescriptor = $convert.base64Decode('ChdMaXN0SW52ZW50b3JpZXNSZXNwb25zZRJFCgtpbnZlbnRvcmllcxgBIAMoCzIjLmdvb2dsZS5jbG91ZC5vc2NvbmZpZy52MS5JbnZlbnRvcnlSC2ludmVudG9yaWVzEiYKD25leHRfcGFnZV90b2tlbhgCIAEoCVINbmV4dFBhZ2VUb2tlbg==');

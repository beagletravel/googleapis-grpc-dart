...
class ReceiveTaskNotificationRequest extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'ReceiveTaskNotificationRequest', package: const $pb.PackageName(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'google.cloud.osconfig.agentendpoint.v1beta'), createEmptyInstance: create)
...
class ReceiveTaskNotificationResponse extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'ReceiveTaskNotificationResponse', package: const $pb.PackageName(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'google.cloud.osconfig.agentendpoint.v1beta'), createEmptyInstance: create)
    ..hasRequiredFields = false
  ;
...
class StartNextTaskRequest extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'StartNextTaskRequest', package: const $pb.PackageName(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'google.cloud.osconfig.agentendpoint.v1beta'), createEmptyInstance: create)
    ..aOS(1, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'instanceIdToken')
    ..hasRequiredFields = false
  ;
...
class StartNextTaskResponse extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'StartNextTaskResponse', package: const $pb.PackageName(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'google.cloud.osconfig.agentendpoint.v1beta'), createEmptyInstance: create)
    ..aOM<$2.Task>(1, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'task', subBuilder: $2.Task.create)
    ..hasRequiredFields = false
  ;
  ...
  @$pb.TagNumber(1)
  set task($2.Task v) { setField(1, v); }
  @$pb.TagNumber(1)
...
class ReportTaskProgressRequest extends $pb.GeneratedMessage {
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'ReportTaskProgressRequest', package: const $pb.PackageName(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'google.cloud.osconfig.agentendpoint.v1beta'), createEmptyInstance: create)
    ..oo(0, [4, 5])
    ..aOS(1, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'instanceIdToken')
    ..aOS(2, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'taskId')
    ..e<$2.TaskType>(3, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'taskType', $pb.PbFieldType.OE, defaultOrMaker: $2.TaskType.TASK_TYPE_UNSPECIFIED, valueOf: $2.TaskType.valueOf, enumValues: $2.TaskType.values)
    ..aOM<$2.ApplyPatchesTaskProgress>(4, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'applyPatchesTaskProgress', subBuilder: $2.ApplyPatchesTaskProgress.create)
    ..aOM<$2.ExecStepTaskProgress>(5, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'execStepTaskProgress', subBuilder: $2.ExecStepTaskProgress.create)
    ..hasRequiredFields = false
  ;
  ...
  @$pb.TagNumber(3)
  set taskType($2.TaskType v) { setField(3, v); }
  @$pb.TagNumber(3)
  ...
  @$pb.TagNumber(4)
  set applyPatchesTaskProgress($2.ApplyPatchesTaskProgress v) { setField(4, v); }
  @$pb.TagNumber(4)
  ...
  @$pb.TagNumber(5)
  set execStepTaskProgress($2.ExecStepTaskProgress v) { setField(5, v); }
  @$pb.TagNumber(5)
...
class ReportTaskProgressResponse extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'ReportTaskProgressResponse', package: const $pb.PackageName(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'google.cloud.osconfig.agentendpoint.v1beta'), createEmptyInstance: create)
    ..e<$2.TaskDirective>(1, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'taskDirective', $pb.PbFieldType.OE, defaultOrMaker: $2.TaskDirective.TASK_DIRECTIVE_UNSPECIFIED, valueOf: $2.TaskDirective.valueOf, enumValues: $2.TaskDirective.values)
    ..hasRequiredFields = false
  ;
  ...
  @$pb.TagNumber(1)
  set taskDirective($2.TaskDirective v) { setField(1, v); }
  @$pb.TagNumber(1)
...
class ReportTaskCompleteRequest extends $pb.GeneratedMessage {
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'ReportTaskCompleteRequest', package: const $pb.PackageName(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'google.cloud.osconfig.agentendpoint.v1beta'), createEmptyInstance: create)
    ..oo(0, [5, 6])
    ..aOS(1, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'instanceIdToken')
    ..aOS(2, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'taskId')
    ..e<$2.TaskType>(3, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'taskType', $pb.PbFieldType.OE, defaultOrMaker: $2.TaskType.TASK_TYPE_UNSPECIFIED, valueOf: $2.TaskType.valueOf, enumValues: $2.TaskType.values)
    ..aOS(4, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'errorMessage')
    ..aOM<$2.ApplyPatchesTaskOutput>(5, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'applyPatchesTaskOutput', subBuilder: $2.ApplyPatchesTaskOutput.create)
    ..aOM<$2.ExecStepTaskOutput>(6, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'execStepTaskOutput', subBuilder: $2.ExecStepTaskOutput.create)
    ..hasRequiredFields = false
  ;
  ...
  @$pb.TagNumber(5)
  set applyPatchesTaskOutput($2.ApplyPatchesTaskOutput v) { setField(5, v); }
  @$pb.TagNumber(5)
  ...
  @$pb.TagNumber(6)
  set execStepTaskOutput($2.ExecStepTaskOutput v) { setField(6, v); }
  @$pb.TagNumber(6)
...
class ReportTaskCompleteResponse extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'ReportTaskCompleteResponse', package: const $pb.PackageName(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'google.cloud.osconfig.agentendpoint.v1beta'), createEmptyInstance: create)
    ..hasRequiredFields = false
  ;
...
class RegisterAgentRequest extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'RegisterAgentRequest', package: const $pb.PackageName(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'google.cloud.osconfig.agentendpoint.v1beta'), createEmptyInstance: create)
    ..aOS(1, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'instanceIdToken')
    ..aOS(2, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'agentVersion')
...
class RegisterAgentResponse extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'RegisterAgentResponse', package: const $pb.PackageName(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'google.cloud.osconfig.agentendpoint.v1beta'), createEmptyInstance: create)
    ..hasRequiredFields = false
  ;

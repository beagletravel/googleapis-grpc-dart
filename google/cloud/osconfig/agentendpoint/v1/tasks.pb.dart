...
class Task extends $pb.GeneratedMessage {
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'Task', package: const $pb.PackageName(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'google.cloud.osconfig.agentendpoint.v1'), createEmptyInstance: create)
    ..oo(0, [4, 5, 7])
    ..aOS(1, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'taskId')
    ..e<TaskType>(2, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'taskType', $pb.PbFieldType.OE, defaultOrMaker: TaskType.TASK_TYPE_UNSPECIFIED, valueOf: TaskType.valueOf, enumValues: TaskType.values)
    ..e<TaskDirective>(3, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'taskDirective', $pb.PbFieldType.OE, defaultOrMaker: TaskDirective.TASK_DIRECTIVE_UNSPECIFIED, valueOf: TaskDirective.valueOf, enumValues: TaskDirective.values)
    ..aOM<ApplyPatchesTask>(4, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'applyPatchesTask', subBuilder: ApplyPatchesTask.create)
    ..aOM<ExecStepTask>(5, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'execStepTask', subBuilder: ExecStepTask.create)
    ..m<$core.String, $core.String>(6, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'serviceLabels', entryClassName: 'Task.ServiceLabelsEntry', keyFieldType: $pb.PbFieldType.OS, valueFieldType: $pb.PbFieldType.OS, packageName: const $pb.PackageName('google.cloud.osconfig.agentendpoint.v1'))
    ..aOM<ApplyConfigTask>(7, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'applyConfigTask', subBuilder: ApplyConfigTask.create)
...
class ApplyPatchesTask extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'ApplyPatchesTask', package: const $pb.PackageName(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'google.cloud.osconfig.agentendpoint.v1'), createEmptyInstance: create)
    ..aOM<$0.PatchConfig>(1, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'patchConfig', subBuilder: $0.PatchConfig.create)
    ..aOB(3, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'dryRun')
    ..hasRequiredFields = false
  ;
  ...
  'Use [GeneratedMessageGenericExtensions.rebuild] instead. '
  'Will be removed in next major version')
  ApplyPatchesTask copyWith(void Function(ApplyPatchesTask) updates) => super.copyWith((message) => updates(message as ApplyPatchesTask)) as ApplyPatchesTask; // ignore: deprecated_member_use
  $pb.BuilderInfo get info_ => _i;
  @$core.pragma('dart2js:noInline')
  ...
  @$pb.TagNumber(1)
  set patchConfig($0.PatchConfig v) { setField(1, v); }
  @$pb.TagNumber(1)
...
class ApplyPatchesTaskProgress extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'ApplyPatchesTaskProgress', package: const $pb.PackageName(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'google.cloud.osconfig.agentendpoint.v1'), createEmptyInstance: create)
    ..e<ApplyPatchesTaskProgress_State>(1, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'state', $pb.PbFieldType.OE, defaultOrMaker: ApplyPatchesTaskProgress_State.STATE_UNSPECIFIED, valueOf: ApplyPatchesTaskProgress_State.valueOf, enumValues: ApplyPatchesTaskProgress_State.values)
    ..hasRequiredFields = false
  ;
  ...
  'Use [GeneratedMessageGenericExtensions.rebuild] instead. '
  'Will be removed in next major version')
  ApplyPatchesTaskProgress copyWith(void Function(ApplyPatchesTaskProgress) updates) => super.copyWith((message) => updates(message as ApplyPatchesTaskProgress)) as ApplyPatchesTaskProgress; // ignore: deprecated_member_use
  $pb.BuilderInfo get info_ => _i;
  @$core.pragma('dart2js:noInline')
...
class ApplyPatchesTaskOutput extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'ApplyPatchesTaskOutput', package: const $pb.PackageName(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'google.cloud.osconfig.agentendpoint.v1'), createEmptyInstance: create)
    ..e<ApplyPatchesTaskOutput_State>(1, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'state', $pb.PbFieldType.OE, defaultOrMaker: ApplyPatchesTaskOutput_State.STATE_UNSPECIFIED, valueOf: ApplyPatchesTaskOutput_State.valueOf, enumValues: ApplyPatchesTaskOutput_State.values)
    ..hasRequiredFields = false
  ;
  ...
  'Use [GeneratedMessageGenericExtensions.rebuild] instead. '
  'Will be removed in next major version')
  ApplyPatchesTaskOutput copyWith(void Function(ApplyPatchesTaskOutput) updates) => super.copyWith((message) => updates(message as ApplyPatchesTaskOutput)) as ApplyPatchesTaskOutput; // ignore: deprecated_member_use
  $pb.BuilderInfo get info_ => _i;
  @$core.pragma('dart2js:noInline')
...
class ExecStepTask extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'ExecStepTask', package: const $pb.PackageName(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'google.cloud.osconfig.agentendpoint.v1'), createEmptyInstance: create)
    ..aOM<$0.ExecStep>(1, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'execStep', subBuilder: $0.ExecStep.create)
    ..hasRequiredFields = false
  ;
  ...
  'Use [GeneratedMessageGenericExtensions.rebuild] instead. '
  'Will be removed in next major version')
  ExecStepTask copyWith(void Function(ExecStepTask) updates) => super.copyWith((message) => updates(message as ExecStepTask)) as ExecStepTask; // ignore: deprecated_member_use
  $pb.BuilderInfo get info_ => _i;
  @$core.pragma('dart2js:noInline')
  ...
  @$pb.TagNumber(1)
  set execStep($0.ExecStep v) { setField(1, v); }
  @$pb.TagNumber(1)
...
class ExecStepTaskProgress extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'ExecStepTaskProgress', package: const $pb.PackageName(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'google.cloud.osconfig.agentendpoint.v1'), createEmptyInstance: create)
    ..e<ExecStepTaskProgress_State>(1, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'state', $pb.PbFieldType.OE, defaultOrMaker: ExecStepTaskProgress_State.STATE_UNSPECIFIED, valueOf: ExecStepTaskProgress_State.valueOf, enumValues: ExecStepTaskProgress_State.values)
    ..hasRequiredFields = false
  ;
  ...
  'Use [GeneratedMessageGenericExtensions.rebuild] instead. '
  'Will be removed in next major version')
  ExecStepTaskProgress copyWith(void Function(ExecStepTaskProgress) updates) => super.copyWith((message) => updates(message as ExecStepTaskProgress)) as ExecStepTaskProgress; // ignore: deprecated_member_use
  $pb.BuilderInfo get info_ => _i;
  @$core.pragma('dart2js:noInline')
...
class ExecStepTaskOutput extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'ExecStepTaskOutput', package: const $pb.PackageName(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'google.cloud.osconfig.agentendpoint.v1'), createEmptyInstance: create)
    ..e<ExecStepTaskOutput_State>(1, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'state', $pb.PbFieldType.OE, defaultOrMaker: ExecStepTaskOutput_State.STATE_UNSPECIFIED, valueOf: ExecStepTaskOutput_State.valueOf, enumValues: ExecStepTaskOutput_State.values)
  ...
  'Use [GeneratedMessageGenericExtensions.rebuild] instead. '
  'Will be removed in next major version')
  ExecStepTaskOutput copyWith(void Function(ExecStepTaskOutput) updates) => super.copyWith((message) => updates(message as ExecStepTaskOutput)) as ExecStepTaskOutput; // ignore: deprecated_member_use
  $pb.BuilderInfo get info_ => _i;
  @$core.pragma('dart2js:noInline')
...
class ApplyConfigTask_OSPolicy extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'ApplyConfigTask.OSPolicy', package: const $pb.PackageName(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'google.cloud.osconfig.agentendpoint.v1'), createEmptyInstance: create)
    ..aOS(1, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'id')
    ..e<$1.OSPolicy_Mode>(2, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'mode', $pb.PbFieldType.OE, defaultOrMaker: $1.OSPolicy_Mode.MODE_UNSPECIFIED, valueOf: $1.OSPolicy_Mode.valueOf, enumValues: $1.OSPolicy_Mode.values)
    ..aOS(3, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'osPolicyAssignment')
    ..pc<$1.OSPolicy_Resource>(4, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'resources', $pb.PbFieldType.PM, subBuilder: $1.OSPolicy_Resource.create)
    ..hasRequiredFields = false
  ;
  ...
  'Use [GeneratedMessageGenericExtensions.rebuild] instead. '
  'Will be removed in next major version')
  ApplyConfigTask_OSPolicy copyWith(void Function(ApplyConfigTask_OSPolicy) updates) => super.copyWith((message) => updates(message as ApplyConfigTask_OSPolicy)) as ApplyConfigTask_OSPolicy; // ignore: deprecated_member_use
  $pb.BuilderInfo get info_ => _i;
  @$core.pragma('dart2js:noInline')
  ...
  @$pb.TagNumber(2)
  set mode($1.OSPolicy_Mode v) { setField(2, v); }
  @$pb.TagNumber(2)
...
class ApplyConfigTask extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'ApplyConfigTask', package: const $pb.PackageName(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'google.cloud.osconfig.agentendpoint.v1'), createEmptyInstance: create)
    ..pc<ApplyConfigTask_OSPolicy>(1, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'osPolicies', $pb.PbFieldType.PM, subBuilder: ApplyConfigTask_OSPolicy.create)
    ..hasRequiredFields = false
  ;
  ...
  'Use [GeneratedMessageGenericExtensions.rebuild] instead. '
  'Will be removed in next major version')
  ApplyConfigTask copyWith(void Function(ApplyConfigTask) updates) => super.copyWith((message) => updates(message as ApplyConfigTask)) as ApplyConfigTask; // ignore: deprecated_member_use
  $pb.BuilderInfo get info_ => _i;
  @$core.pragma('dart2js:noInline')
...
class ApplyConfigTaskProgress extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'ApplyConfigTaskProgress', package: const $pb.PackageName(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'google.cloud.osconfig.agentendpoint.v1'), createEmptyInstance: create)
    ..e<ApplyConfigTaskProgress_State>(1, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'state', $pb.PbFieldType.OE, defaultOrMaker: ApplyConfigTaskProgress_State.STATE_UNSPECIFIED, valueOf: ApplyConfigTaskProgress_State.valueOf, enumValues: ApplyConfigTaskProgress_State.values)
    ..hasRequiredFields = false
  ;
  ...
  'Use [GeneratedMessageGenericExtensions.rebuild] instead. '
  'Will be removed in next major version')
  ApplyConfigTaskProgress copyWith(void Function(ApplyConfigTaskProgress) updates) => super.copyWith((message) => updates(message as ApplyConfigTaskProgress)) as ApplyConfigTaskProgress; // ignore: deprecated_member_use
  $pb.BuilderInfo get info_ => _i;
  @$core.pragma('dart2js:noInline')
...
class ApplyConfigTaskOutput_OSPolicyResult extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'ApplyConfigTaskOutput.OSPolicyResult', package: const $pb.PackageName(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'google.cloud.osconfig.agentendpoint.v1'), createEmptyInstance: create)
    ..aOS(1, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'osPolicyId')
    ..aOS(2, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'osPolicyAssignment')
    ..pc<$2.OSPolicyResourceCompliance>(3, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'osPolicyResourceCompliances', $pb.PbFieldType.PM, subBuilder: $2.OSPolicyResourceCompliance.create)
    ..hasRequiredFields = false
  ;
  ...
  'Use [GeneratedMessageGenericExtensions.rebuild] instead. '
  'Will be removed in next major version')
  ApplyConfigTaskOutput_OSPolicyResult copyWith(void Function(ApplyConfigTaskOutput_OSPolicyResult) updates) => super.copyWith((message) => updates(message as ApplyConfigTaskOutput_OSPolicyResult)) as ApplyConfigTaskOutput_OSPolicyResult; // ignore: deprecated_member_use
  $pb.BuilderInfo get info_ => _i;
  @$core.pragma('dart2js:noInline')
  ...
  @$pb.TagNumber(3)
  $core.List<$2.OSPolicyResourceCompliance> get osPolicyResourceCompliances => $_getList(2);
}

class ApplyConfigTaskOutput extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'ApplyConfigTaskOutput', package: const $pb.PackageName(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'google.cloud.osconfig.agentendpoint.v1'), createEmptyInstance: create)
    ..e<ApplyConfigTaskOutput_State>(1, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'state', $pb.PbFieldType.OE, defaultOrMaker: ApplyConfigTaskOutput_State.STATE_UNSPECIFIED, valueOf: ApplyConfigTaskOutput_State.valueOf, enumValues: ApplyConfigTaskOutput_State.values)
    ..pc<ApplyConfigTaskOutput_OSPolicyResult>(2, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'osPolicyResults', $pb.PbFieldType.PM, subBuilder: ApplyConfigTaskOutput_OSPolicyResult.create)
    ..hasRequiredFields = false
  ;
  ...
  'Use [GeneratedMessageGenericExtensions.rebuild] instead. '
  'Will be removed in next major version')
  ApplyConfigTaskOutput copyWith(void Function(ApplyConfigTaskOutput) updates) => super.copyWith((message) => updates(message as ApplyConfigTaskOutput)) as ApplyConfigTaskOutput; // ignore: deprecated_member_use
  $pb.BuilderInfo get info_ => _i;
  @$core.pragma('dart2js:noInline')

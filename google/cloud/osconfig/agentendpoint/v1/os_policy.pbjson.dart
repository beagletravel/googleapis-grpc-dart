...
const OSPolicy_Resource$json = const {
  ...
  '2': const [
    ...
    const {'1': 'pkg', '3': 2, '4': 1, '5': 11, '6': '.google.cloud.osconfig.agentendpoint.v1.OSPolicy.Resource.PackageResource', '9': 0, '10': 'pkg'},
    const {'1': 'repository', '3': 3, '4': 1, '5': 11, '6': '.google.cloud.osconfig.agentendpoint.v1.OSPolicy.Resource.RepositoryResource', '9': 0, '10': 'repository'},
    const {'1': 'exec', '3': 4, '4': 1, '5': 11, '6': '.google.cloud.osconfig.agentendpoint.v1.OSPolicy.Resource.ExecResource', '9': 0, '10': 'exec'},
    const {'1': 'file', '3': 5, '4': 1, '5': 11, '6': '.google.cloud.osconfig.agentendpoint.v1.OSPolicy.Resource.FileResource', '9': 0, '10': 'file'},
  ],
...
const OSPolicy_Resource_File$json = const {
  '1': 'File',
  '2': const [
    const {'1': 'remote', '3': 1, '4': 1, '5': 11, '6': '.google.cloud.osconfig.agentendpoint.v1.OSPolicy.Resource.File.Remote', '9': 0, '10': 'remote'},
    const {'1': 'gcs', '3': 2, '4': 1, '5': 11, '6': '.google.cloud.osconfig.agentendpoint.v1.OSPolicy.Resource.File.Gcs', '9': 0, '10': 'gcs'},
...
const OSPolicy_Resource_PackageResource$json = const {
  '1': 'PackageResource',
  '2': const [
    const {'1': 'desired_state', '3': 1, '4': 1, '5': 14, '6': '.google.cloud.osconfig.agentendpoint.v1.OSPolicy.Resource.PackageResource.DesiredState', '8': const {}, '10': 'desiredState'},
    const {'1': 'apt', '3': 2, '4': 1, '5': 11, '6': '.google.cloud.osconfig.agentendpoint.v1.OSPolicy.Resource.PackageResource.APT', '9': 0, '10': 'apt'},
    const {'1': 'deb', '3': 3, '4': 1, '5': 11, '6': '.google.cloud.osconfig.agentendpoint.v1.OSPolicy.Resource.PackageResource.Deb', '9': 0, '10': 'deb'},
    const {'1': 'yum', '3': 4, '4': 1, '5': 11, '6': '.google.cloud.osconfig.agentendpoint.v1.OSPolicy.Resource.PackageResource.YUM', '9': 0, '10': 'yum'},
    const {'1': 'zypper', '3': 5, '4': 1, '5': 11, '6': '.google.cloud.osconfig.agentendpoint.v1.OSPolicy.Resource.PackageResource.Zypper', '9': 0, '10': 'zypper'},
    const {'1': 'rpm', '3': 6, '4': 1, '5': 11, '6': '.google.cloud.osconfig.agentendpoint.v1.OSPolicy.Resource.PackageResource.RPM', '9': 0, '10': 'rpm'},
    const {'1': 'googet', '3': 7, '4': 1, '5': 11, '6': '.google.cloud.osconfig.agentendpoint.v1.OSPolicy.Resource.PackageResource.GooGet', '9': 0, '10': 'googet'},
    const {'1': 'msi', '3': 8, '4': 1, '5': 11, '6': '.google.cloud.osconfig.agentendpoint.v1.OSPolicy.Resource.PackageResource.MSI', '9': 0, '10': 'msi'},
  ],
...
const OSPolicy_Resource_PackageResource_Deb$json = const {
  '1': 'Deb',
  '2': const [
    const {'1': 'source', '3': 1, '4': 1, '5': 11, '6': '.google.cloud.osconfig.agentendpoint.v1.OSPolicy.Resource.File', '8': const {}, '10': 'source'},
...
const OSPolicy_Resource_RepositoryResource$json = const {
  ...
  '2': const [
    const {'1': 'apt', '3': 1, '4': 1, '5': 11, '6': '.google.cloud.osconfig.agentendpoint.v1.OSPolicy.Resource.RepositoryResource.AptRepository', '9': 0, '10': 'apt'},
    const {'1': 'yum', '3': 2, '4': 1, '5': 11, '6': '.google.cloud.osconfig.agentendpoint.v1.OSPolicy.Resource.RepositoryResource.YumRepository', '9': 0, '10': 'yum'},
    const {'1': 'zypper', '3': 3, '4': 1, '5': 11, '6': '.google.cloud.osconfig.agentendpoint.v1.OSPolicy.Resource.RepositoryResource.ZypperRepository', '9': 0, '10': 'zypper'},
    const {'1': 'goo', '3': 4, '4': 1, '5': 11, '6': '.google.cloud.osconfig.agentendpoint.v1.OSPolicy.Resource.RepositoryResource.GooRepository', '9': 0, '10': 'goo'},
  ],
...
const OSPolicy_Resource_RepositoryResource_AptRepository$json = const {
  '1': 'AptRepository',
  '2': const [
    const {'1': 'archive_type', '3': 1, '4': 1, '5': 14, '6': '.google.cloud.osconfig.agentendpoint.v1.OSPolicy.Resource.RepositoryResource.AptRepository.ArchiveType', '8': const {}, '10': 'archiveType'},
...
const OSPolicy_Resource_ExecResource$json = const {
  '1': 'ExecResource',
  '2': const [
    const {'1': 'validate', '3': 1, '4': 1, '5': 11, '6': '.google.cloud.osconfig.agentendpoint.v1.OSPolicy.Resource.ExecResource.Exec', '8': const {}, '10': 'validate'},
    const {'1': 'enforce', '3': 2, '4': 1, '5': 11, '6': '.google.cloud.osconfig.agentendpoint.v1.OSPolicy.Resource.ExecResource.Exec', '10': 'enforce'},
  ],
...
const OSPolicy_Resource_ExecResource_Exec$json = const {
  '1': 'Exec',
  '2': const [
    const {'1': 'file', '3': 1, '4': 1, '5': 11, '6': '.google.cloud.osconfig.agentendpoint.v1.OSPolicy.Resource.File', '9': 0, '10': 'file'},
    const {'1': 'script', '3': 2, '4': 1, '5': 9, '9': 0, '10': 'script'},
    const {'1': 'args', '3': 3, '4': 3, '5': 9, '10': 'args'},
    const {'1': 'interpreter', '3': 4, '4': 1, '5': 14, '6': '.google.cloud.osconfig.agentendpoint.v1.OSPolicy.Resource.ExecResource.Exec.Interpreter', '8': const {}, '10': 'interpreter'},
...
const OSPolicy_Resource_FileResource$json = const {
  ...
  '2': const [
    ...
    const {'1': 'state', '3': 4, '4': 1, '5': 14, '6': '.google.cloud.osconfig.agentendpoint.v1.OSPolicy.Resource.FileResource.DesiredState', '8': const {}, '10': 'state'},

...
const GSuiteAddOnsLogEntry$json = const {
  ...
  '2': const [
    ...
    const {'1': 'deployment_function', '3': 3, '4': 1, '5': 9, '10': 'deploymentFunction'},
  ],
};

/// Descriptor for `GSuiteAddOnsLogEntry`. Decode as a `google.protobuf.DescriptorProto`.
final $typed_data.Uint8List gSuiteAddOnsLogEntryDescriptor = $convert.base64Decode('ChRHU3VpdGVBZGRPbnNMb2dFbnRyeRIeCgpkZXBsb3ltZW50GAEgASgJUgpkZXBsb3ltZW50EigKBWVycm9yGAIgASgLMhIuZ29vZ2xlLnJwYy5TdGF0dXNSBWVycm9yEi8KE2RlcGxveW1lbnRfZnVuY3Rpb24YAyABKAlSEmRlcGxveW1lbnRGdW5jdGlvbg==');

...
class GSuiteAddOnsLogEntry extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'GSuiteAddOnsLogEntry', package: const $pb.PackageName(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'google.cloud.gsuiteaddons.logging.v1'), createEmptyInstance: create)
    ..aOS(1, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'deployment')
    ..aOM<$0.Status>(2, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'error', subBuilder: $0.Status.create)
    ..aOS(3, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'deploymentFunction')
  ...
  'Will be removed in next major version')
  GSuiteAddOnsLogEntry copyWith(void Function(GSuiteAddOnsLogEntry) updates) => super.copyWith((message) => updates(message as GSuiteAddOnsLogEntry)) as GSuiteAddOnsLogEntry; // ignore: deprecated_member_use

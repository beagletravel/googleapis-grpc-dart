...
class Input_SecurityRule extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'Input.SecurityRule', package: const $pb.PackageName(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'google.cloud.video.livestream.v1'), createEmptyInstance: create)
    ..pPS(1, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'ipRanges')
  ...
  'Will be removed in next major version')
  Input_SecurityRule copyWith(void Function(Input_SecurityRule) updates) => super.copyWith((message) => updates(message as Input_SecurityRule)) as Input_SecurityRule; // ignore: deprecated_member_use
...
class Input extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'Input', package: const $pb.PackageName(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'google.cloud.video.livestream.v1'), createEmptyInstance: create)
    ...
    ..m<$core.String, $core.String>(4, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'labels', entryClassName: 'Input.LabelsEntry', keyFieldType: $pb.PbFieldType.OS, valueFieldType: $pb.PbFieldType.OS, packageName: const $pb.PackageName('google.cloud.video.livestream.v1'))
    ..e<Input_Type>(5, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'type', $pb.PbFieldType.OE, defaultOrMaker: Input_Type.TYPE_UNSPECIFIED, valueOf: Input_Type.valueOf, enumValues: Input_Type.values)
    ..aOS(6, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'uri')
    ..aOM<$1.PreprocessingConfig>(9, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'preprocessingConfig', subBuilder: $1.PreprocessingConfig.create)
    ..aOM<Input_SecurityRule>(12, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'securityRules', subBuilder: Input_SecurityRule.create)
    ..e<Input_Tier>(14, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'tier', $pb.PbFieldType.OE, defaultOrMaker: Input_Tier.TIER_UNSPECIFIED, valueOf: Input_Tier.valueOf, enumValues: Input_Tier.values)
    ..aOM<InputStreamProperty>(15, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'inputStreamProperty', subBuilder: InputStreamProperty.create)
    ..hasRequiredFields = false
  ;
  ...
  @$pb.TagNumber(9)
  set preprocessingConfig($1.PreprocessingConfig v) { setField(9, v); }
  @$pb.TagNumber(9)
...
class Channel_Output extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'Channel.Output', package: const $pb.PackageName(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'google.cloud.video.livestream.v1'), createEmptyInstance: create)
  ...
  'Use [GeneratedMessageGenericExtensions.rebuild] instead. '
  'Will be removed in next major version')
  Channel_Output copyWith(void Function(Channel_Output) updates) => super.copyWith((message) => updates(message as Channel_Output)) as Channel_Output; // ignore: deprecated_member_use
  $pb.BuilderInfo get info_ => _i;
  @$core.pragma('dart2js:noInline')
...
class Channel extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'Channel', package: const $pb.PackageName(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'google.cloud.video.livestream.v1'), createEmptyInstance: create)
    ..aOS(1, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'name')
    ..aOM<$0.Timestamp>(2, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'createTime', subBuilder: $0.Timestamp.create)
    ..aOM<$0.Timestamp>(3, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'updateTime', subBuilder: $0.Timestamp.create)
    ..m<$core.String, $core.String>(4, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'labels', entryClassName: 'Channel.LabelsEntry', keyFieldType: $pb.PbFieldType.OS, valueFieldType: $pb.PbFieldType.OS, packageName: const $pb.PackageName('google.cloud.video.livestream.v1'))
    ..aOS(6, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'activeInput')
    ..aOM<Channel_Output>(9, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'output', subBuilder: Channel_Output.create)
    ..pc<$1.ElementaryStream>(10, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'elementaryStreams', $pb.PbFieldType.PM, subBuilder: $1.ElementaryStream.create)
    ..pc<$1.MuxStream>(11, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'muxStreams', $pb.PbFieldType.PM, subBuilder: $1.MuxStream.create)
    ..pc<$1.Manifest>(12, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'manifests', $pb.PbFieldType.PM, subBuilder: $1.Manifest.create)
    ..pc<$1.SpriteSheet>(13, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'spriteSheets', $pb.PbFieldType.PM, subBuilder: $1.SpriteSheet.create)
    ..e<Channel_StreamingState>(14, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'streamingState', $pb.PbFieldType.OE, defaultOrMaker: Channel_StreamingState.STREAMING_STATE_UNSPECIFIED, valueOf: Channel_StreamingState.valueOf, enumValues: Channel_StreamingState.values)
    ..pc<InputAttachment>(16, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'inputAttachments', $pb.PbFieldType.PM, subBuilder: InputAttachment.create)
    ..aOM<$2.Status>(18, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'streamingError', subBuilder: $2.Status.create)
    ..aOM<LogConfig>(19, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'logConfig', subBuilder: LogConfig.create)
    ..hasRequiredFields = false
  ;
  ...
  @$pb.TagNumber(18)
  set streamingError($2.Status v) { setField(18, v); }
  @$pb.TagNumber(18)
...
class LogConfig extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'LogConfig', package: const $pb.PackageName(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'google.cloud.video.livestream.v1'), createEmptyInstance: create)
    ..e<LogConfig_LogSeverity>(1, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'logSeverity', $pb.PbFieldType.OE, defaultOrMaker: LogConfig_LogSeverity.LOG_SEVERITY_UNSPECIFIED, valueOf: LogConfig_LogSeverity.valueOf, enumValues: LogConfig_LogSeverity.values)
    ..hasRequiredFields = false
  ;
  ...
  factory LogConfig({
    ...
    final _result = create();
    if (logSeverity != null) {
      _result.logSeverity = logSeverity;
    }
    return _result;
  }
  ...
  'Use [GeneratedMessageGenericExtensions.rebuild] instead. '
  'Will be removed in next major version')
  LogConfig copyWith(void Function(LogConfig) updates) => super.copyWith((message) => updates(message as LogConfig)) as LogConfig; // ignore: deprecated_member_use
  $pb.BuilderInfo get info_ => _i;
  @$core.pragma('dart2js:noInline')
...
class InputStreamProperty extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'InputStreamProperty', package: const $pb.PackageName(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'google.cloud.video.livestream.v1'), createEmptyInstance: create)
    ..aOM<$0.Timestamp>(1, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'lastEstablishTime', subBuilder: $0.Timestamp.create)
    ..pc<VideoStreamProperty>(2, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'videoStreams', $pb.PbFieldType.PM, subBuilder: VideoStreamProperty.create)
    ..pc<AudioStreamProperty>(3, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'audioStreams', $pb.PbFieldType.PM, subBuilder: AudioStreamProperty.create)
    ..hasRequiredFields = false
  ;
  ...
  'Use [GeneratedMessageGenericExtensions.rebuild] instead. '
  'Will be removed in next major version')
  InputStreamProperty copyWith(void Function(InputStreamProperty) updates) => super.copyWith((message) => updates(message as InputStreamProperty)) as InputStreamProperty; // ignore: deprecated_member_use
  $pb.BuilderInfo get info_ => _i;
  @$core.pragma('dart2js:noInline')
  ...
  @$pb.TagNumber(1)
  set lastEstablishTime($0.Timestamp v) { setField(1, v); }
  @$pb.TagNumber(1)
...
class VideoStreamProperty extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'VideoStreamProperty', package: const $pb.PackageName(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'google.cloud.video.livestream.v1'), createEmptyInstance: create)
    ..a<$core.int>(1, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'index', $pb.PbFieldType.O3)
    ..aOM<VideoFormat>(2, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'videoFormat', subBuilder: VideoFormat.create)
    ..hasRequiredFields = false
  ;
  ...
  'Use [GeneratedMessageGenericExtensions.rebuild] instead. '
  'Will be removed in next major version')
  VideoStreamProperty copyWith(void Function(VideoStreamProperty) updates) => super.copyWith((message) => updates(message as VideoStreamProperty)) as VideoStreamProperty; // ignore: deprecated_member_use
  $pb.BuilderInfo get info_ => _i;
  @$core.pragma('dart2js:noInline')
...
class VideoFormat extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'VideoFormat', package: const $pb.PackageName(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'google.cloud.video.livestream.v1'), createEmptyInstance: create)
    ..aOS(1, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'codec')
    ..a<$core.int>(2, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'widthPixels', $pb.PbFieldType.O3)
    ..a<$core.int>(3, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'heightPixels', $pb.PbFieldType.O3)
    ..a<$core.double>(4, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'frameRate', $pb.PbFieldType.OD)
    ..hasRequiredFields = false
  ;
  ...
  'Use [GeneratedMessageGenericExtensions.rebuild] instead. '
  'Will be removed in next major version')
  VideoFormat copyWith(void Function(VideoFormat) updates) => super.copyWith((message) => updates(message as VideoFormat)) as VideoFormat; // ignore: deprecated_member_use
  $pb.BuilderInfo get info_ => _i;
  @$core.pragma('dart2js:noInline')
...
class AudioStreamProperty extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'AudioStreamProperty', package: const $pb.PackageName(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'google.cloud.video.livestream.v1'), createEmptyInstance: create)
    ..a<$core.int>(1, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'index', $pb.PbFieldType.O3)
    ..aOM<AudioFormat>(2, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'audioFormat', subBuilder: AudioFormat.create)
    ..hasRequiredFields = false
  ;
  ...
  'Use [GeneratedMessageGenericExtensions.rebuild] instead. '
  'Will be removed in next major version')
  AudioStreamProperty copyWith(void Function(AudioStreamProperty) updates) => super.copyWith((message) => updates(message as AudioStreamProperty)) as AudioStreamProperty; // ignore: deprecated_member_use
  $pb.BuilderInfo get info_ => _i;
  @$core.pragma('dart2js:noInline')
...
class AudioFormat extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'AudioFormat', package: const $pb.PackageName(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'google.cloud.video.livestream.v1'), createEmptyInstance: create)
    ..aOS(1, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'codec')
    ..a<$core.int>(2, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'channelCount', $pb.PbFieldType.O3)
    ..pPS(3, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'channelLayout')
    ..hasRequiredFields = false
  ;
...
class InputAttachment_AutomaticFailover extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'InputAttachment.AutomaticFailover', package: const $pb.PackageName(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'google.cloud.video.livestream.v1'), createEmptyInstance: create)
    ..pPS(1, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'inputKeys')
    ..hasRequiredFields = false
  ;
  ...
  'Use [GeneratedMessageGenericExtensions.rebuild] instead. '
  'Will be removed in next major version')
  InputAttachment_AutomaticFailover copyWith(void Function(InputAttachment_AutomaticFailover) updates) => super.copyWith((message) => updates(message as InputAttachment_AutomaticFailover)) as InputAttachment_AutomaticFailover; // ignore: deprecated_member_use
  $pb.BuilderInfo get info_ => _i;
  @$core.pragma('dart2js:noInline')
...
class InputAttachment extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'InputAttachment', package: const $pb.PackageName(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'google.cloud.video.livestream.v1'), createEmptyInstance: create)
    ..aOS(1, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'key')
    ..aOS(2, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'input')
    ..aOM<InputAttachment_AutomaticFailover>(3, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'automaticFailover', subBuilder: InputAttachment_AutomaticFailover.create)
    ..hasRequiredFields = false
  ;
  ...
  'Use [GeneratedMessageGenericExtensions.rebuild] instead. '
  'Will be removed in next major version')
  InputAttachment copyWith(void Function(InputAttachment) updates) => super.copyWith((message) => updates(message as InputAttachment)) as InputAttachment; // ignore: deprecated_member_use
  $pb.BuilderInfo get info_ => _i;
  @$core.pragma('dart2js:noInline')
...
class Event_AdBreakTask extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'Event.AdBreakTask', package: const $pb.PackageName(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'google.cloud.video.livestream.v1'), createEmptyInstance: create)
  ...
  'Use [GeneratedMessageGenericExtensions.rebuild] instead. '
  'Will be removed in next major version')
  Event_AdBreakTask copyWith(void Function(Event_AdBreakTask) updates) => super.copyWith((message) => updates(message as Event_AdBreakTask)) as Event_AdBreakTask; // ignore: deprecated_member_use
  $pb.BuilderInfo get info_ => _i;
  @$core.pragma('dart2js:noInline')
...
class Event extends $pb.GeneratedMessage {
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'Event', package: const $pb.PackageName(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'google.cloud.video.livestream.v1'), createEmptyInstance: create)
    ..oo(0, [6])
    ..aOS(1, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'name')
    ..aOM<$0.Timestamp>(2, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'createTime', subBuilder: $0.Timestamp.create)
    ..aOM<$0.Timestamp>(3, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'updateTime', subBuilder: $0.Timestamp.create)
    ..m<$core.String, $core.String>(4, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'labels', entryClassName: 'Event.LabelsEntry', keyFieldType: $pb.PbFieldType.OS, valueFieldType: $pb.PbFieldType.OS, packageName: const $pb.PackageName('google.cloud.video.livestream.v1'))
    ..aOM<Event_AdBreakTask>(6, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'adBreak', subBuilder: Event_AdBreakTask.create)
    ..aOB(9, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'executeNow')
    ..aOM<$0.Timestamp>(10, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'executionTime', subBuilder: $0.Timestamp.create)
    ..e<Event_State>(11, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'state', $pb.PbFieldType.OE, defaultOrMaker: Event_State.STATE_UNSPECIFIED, valueOf: Event_State.valueOf, enumValues: Event_State.values)
    ..aOM<$2.Status>(12, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'error', subBuilder: $2.Status.create)
    ..hasRequiredFields = false
  ;
  ...
  @$pb.TagNumber(9)
  set executeNow($core.bool v) { $_setBool(5, v); }
  @$pb.TagNumber(9)
  ...
  @$pb.TagNumber(10)
  set executionTime($0.Timestamp v) { setField(10, v); }
  @$pb.TagNumber(10)
  ...
  @$pb.TagNumber(12)
  set error($2.Status v) { setField(12, v); }
  @$pb.TagNumber(12)

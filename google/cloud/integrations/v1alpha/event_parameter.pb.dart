...
class EventParameter extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'EventParameter', package: const $pb.PackageName(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'google.cloud.integrations.v1alpha'), createEmptyInstance: create)
    ..aOS(1, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'key')
    ..aOM<$0.ValueType>(2, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'value', subBuilder: $0.ValueType.create)
  ...
  'Will be removed in next major version')
  EventParameter copyWith(void Function(EventParameter) updates) => super.copyWith((message) => updates(message as EventParameter)) as EventParameter; // ignore: deprecated_member_use
  ...
  @$pb.TagNumber(2)
  set value($0.ValueType v) { setField(2, v); }
  @$pb.TagNumber(2)

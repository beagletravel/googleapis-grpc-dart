...
const TaskConfig$json = const {
  ...
  '2': const [
    ...
    const {'1': 'parameters', '3': 3, '4': 3, '5': 11, '6': '.google.cloud.integrations.v1alpha.TaskConfig.ParametersEntry', '8': const {}, '10': 'parameters'},
    const {'1': 'failure_policy', '3': 4, '4': 1, '5': 11, '6': '.google.cloud.integrations.v1alpha.FailurePolicy', '8': const {}, '10': 'failurePolicy'},
    const {'1': 'synchronous_call_failure_policy', '3': 5, '4': 1, '5': 11, '6': '.google.cloud.integrations.v1alpha.FailurePolicy', '8': const {}, '10': 'synchronousCallFailurePolicy'},
    const {'1': 'next_tasks', '3': 6, '4': 3, '5': 11, '6': '.google.cloud.integrations.v1alpha.NextTask', '8': const {}, '10': 'nextTasks'},
    const {'1': 'next_tasks_execution_policy', '3': 7, '4': 1, '5': 14, '6': '.google.cloud.integrations.v1alpha.TaskConfig.NextTasksExecutionPolicy', '8': const {}, '10': 'nextTasksExecutionPolicy'},
    const {'1': 'task_execution_strategy', '3': 8, '4': 1, '5': 14, '6': '.google.cloud.integrations.v1alpha.TaskConfig.TaskExecutionStrategy', '8': const {}, '10': 'taskExecutionStrategy'},
    const {'1': 'display_name', '3': 9, '4': 1, '5': 9, '8': const {}, '10': 'displayName'},
    const {'1': 'success_policy', '3': 10, '4': 1, '5': 11, '6': '.google.cloud.integrations.v1alpha.SuccessPolicy', '8': const {}, '10': 'successPolicy'},
    const {'1': 'json_validation_option', '3': 11, '4': 1, '5': 14, '6': '.google.cloud.integrations.v1alpha.JsonValidationOption', '8': const {}, '10': 'jsonValidationOption'},
  ],
  '3': const [TaskConfig_ParametersEntry$json],
  '4': const [TaskConfig_NextTasksExecutionPolicy$json, TaskConfig_TaskExecutionStrategy$json],
};
...
final $typed_data.Uint8List successPolicyDescriptor = $convert.base64Decode('Cg1TdWNjZXNzUG9saWN5ElwKC2ZpbmFsX3N0YXRlGAEgASgOMjsuZ29vZ2xlLmNsb3VkLmludGVncmF0aW9ucy52MWFscGhhLlN1Y2Nlc3NQb2xpY3kuRmluYWxTdGF0ZVIKZmluYWxTdGF0ZSJHCgpGaW5hbFN0YXRlEhsKF0ZJTkFMX1NUQVRFX1VOU1BFQ0lGSUVEEAASDQoJU1VDQ0VFREVEEAESDQoJU1VTUEVOREVEEAI=');
@$core.Deprecated('Use failurePolicyDescriptor instead')
const FailurePolicy$json = const {
  '1': 'FailurePolicy',
  '2': const [
    const {'1': 'retry_strategy', '3': 1, '4': 1, '5': 14, '6': '.google.cloud.integrations.v1alpha.FailurePolicy.RetryStrategy', '10': 'retryStrategy'},
    const {'1': 'max_retries', '3': 2, '4': 1, '5': 5, '10': 'maxRetries'},
    const {'1': 'interval_time', '3': 3, '4': 1, '5': 11, '6': '.google.protobuf.Timestamp', '10': 'intervalTime'},
  ],
...
final $typed_data.Uint8List nextTaskDescriptor = $convert.base64Decode('CghOZXh0VGFzaxIkCg50YXNrX2NvbmZpZ19pZBgBIAEoCVIMdGFza0NvbmZpZ0lkEhcKB3Rhc2tfaWQYAiABKAlSBnRhc2tJZBIcCgljb25kaXRpb24YAyABKAlSCWNvbmRpdGlvbhIhCgxkaXNwbGF5X25hbWUYBCABKAlSC2Rpc3BsYXlOYW1l');

...
class ExecutionInfo extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'ExecutionInfo', package: const $pb.PackageName(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'google.cloud.integrations.v1alpha'), createEmptyInstance: create)
    ..aOS(1, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'eventExecutionInfoId')
    ..aOS(2, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'integration')
    ..aOS(3, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'integrationVersion')
    ..aOS(4, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'projectId')
    ..aOS(5, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'triggerId')
    ..m<$core.String, $1.EventParameter>(6, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'requestParams', entryClassName: 'ExecutionInfo.RequestParamsEntry', keyFieldType: $pb.PbFieldType.OS, valueFieldType: $pb.PbFieldType.OM, valueCreator: $1.EventParameter.create, packageName: const $pb.PackageName('google.cloud.integrations.v1alpha'))
    ..m<$core.String, $1.EventParameter>(7, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'responseParams', entryClassName: 'ExecutionInfo.ResponseParamsEntry', keyFieldType: $pb.PbFieldType.OS, valueFieldType: $pb.PbFieldType.OM, valueCreator: $1.EventParameter.create, packageName: const $pb.PackageName('google.cloud.integrations.v1alpha'))
    ..e<ExecutionInfo_PostMethod>(8, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'postMethod', $pb.PbFieldType.OE, defaultOrMaker: ExecutionInfo_PostMethod.POST_METHOD_UNSPECIFIED, valueOf: ExecutionInfo_PostMethod.valueOf, enumValues: ExecutionInfo_PostMethod.values)
    ..aOM<EventExecutionDetails>(9, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'eventExecutionDetails', subBuilder: EventExecutionDetails.create)
    ..pc<ErrorDetail>(10, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'errors', $pb.PbFieldType.PM, subBuilder: ErrorDetail.create)
    ..e<$3.Product>(11, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'product', $pb.PbFieldType.OE, defaultOrMaker: $3.Product.PRODUCT_UNSPECIFIED, valueOf: $3.Product.valueOf, enumValues: $3.Product.values)
    ..aOS(12, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'requestId')
    ..pc<$0.TaskConfig>(13, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'taskConfigs', $pb.PbFieldType.PM, subBuilder: $0.TaskConfig.create)
  ...
  @$pb.TagNumber(1)
  set eventExecutionInfoId($core.String v) { $_setString(0, v); }
  @$pb.TagNumber(1)
  ...
  @$pb.TagNumber(2)
  set integration($core.String v) { $_setString(1, v); }
  @$pb.TagNumber(2)
  ...
  @$pb.TagNumber(3)
  set integrationVersion($core.String v) { $_setString(2, v); }
  @$pb.TagNumber(3)
  ...
  @$pb.TagNumber(8)
  set postMethod(ExecutionInfo_PostMethod v) { setField(8, v); }
  @$pb.TagNumber(8)
  ...
  @$pb.TagNumber(9)
  set eventExecutionDetails(EventExecutionDetails v) { setField(9, v); }
  @$pb.TagNumber(9)
  ...
  @$pb.TagNumber(11)
  set product($3.Product v) { setField(11, v); }
  @$pb.TagNumber(11)
...
class EventExecutionDetails extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'EventExecutionDetails', package: const $pb.PackageName(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'google.cloud.integrations.v1alpha'), createEmptyInstance: create)
    ..e<EventExecutionDetails_EventExecutionState>(1, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'eventExecutionState', $pb.PbFieldType.OE, defaultOrMaker: EventExecutionDetails_EventExecutionState.EVENT_EXECUTION_STATE_UNSPECIFIED, valueOf: EventExecutionDetails_EventExecutionState.valueOf, enumValues: EventExecutionDetails_EventExecutionState.values)
    ..pc<EventExecutionSnapshot>(2, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'eventExecutionSnapshot', $pb.PbFieldType.PM, subBuilder: EventExecutionSnapshot.create)
    ..pc<AttemptStats>(3, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'eventAttemptStats', $pb.PbFieldType.PM, subBuilder: AttemptStats.create)
    ..aOM<$2.Timestamp>(4, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'nextExecutionTime', subBuilder: $2.Timestamp.create)
    ..a<$core.int>(5, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'eventRetriesCount', $pb.PbFieldType.O3)
    ..hasRequiredFields = false
  ;
  ...
  factory EventExecutionDetails.fromBuffer($core.List<$core.int> i, [$pb.ExtensionRegistry r = $pb.ExtensionRegistry.EMPTY]) => create()..mergeFromBuffer(i, r);
  factory EventExecutionDetails.fromJson($core.String i, [$pb.ExtensionRegistry r = $pb.ExtensionRegistry.EMPTY]) => create()..mergeFromJson(i, r);
  @$core.Deprecated(
  'Using this can add significant overhead to your binary. '
  'Use [GeneratedMessageGenericExtensions.deepCopy] instead. '
  'Will be removed in next major version')
  EventExecutionDetails clone() => EventExecutionDetails()..mergeFromMessage(this);
  @$core.Deprecated(
  'Using this can add significant overhead to your binary. '
  'Use [GeneratedMessageGenericExtensions.rebuild] instead. '
  'Will be removed in next major version')
  EventExecutionDetails copyWith(void Function(EventExecutionDetails) updates) => super.copyWith((message) => updates(message as EventExecutionDetails)) as EventExecutionDetails; // ignore: deprecated_member_use
  $pb.BuilderInfo get info_ => _i;
  @$core.pragma('dart2js:noInline')
  static EventExecutionDetails create() => EventExecutionDetails._();
  EventExecutionDetails createEmptyInstance() => create();
  static $pb.PbList<EventExecutionDetails> createRepeated() => $pb.PbList<EventExecutionDetails>();
  @$core.pragma('dart2js:noInline')
  static EventExecutionDetails getDefault() => _defaultInstance ??= $pb.GeneratedMessage.$_defaultFor<EventExecutionDetails>(create);
  static EventExecutionDetails? _defaultInstance;

  @$pb.TagNumber(1)
  EventExecutionDetails_EventExecutionState get eventExecutionState => $_getN(0);
  @$pb.TagNumber(1)
  set eventExecutionState(EventExecutionDetails_EventExecutionState v) { setField(1, v); }
  @$pb.TagNumber(1)
  ...
  @$pb.TagNumber(4)
  set nextExecutionTime($2.Timestamp v) { setField(4, v); }
  @$pb.TagNumber(4)
  ...
  @$pb.TagNumber(5)
  set eventRetriesCount($core.int v) { $_setSignedInt32(4, v); }
  @$pb.TagNumber(5)
...
class EventExecutionSnapshot_EventExecutionSnapshotMetadata extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'EventExecutionSnapshot.EventExecutionSnapshotMetadata', package: const $pb.PackageName(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'google.cloud.integrations.v1alpha'), createEmptyInstance: create)
    ..aOS(1, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'taskNumber')
    ..aOS(2, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'task')
    ..a<$core.int>(3, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'eventAttemptNum', $pb.PbFieldType.O3)
    ..a<$core.int>(4, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'taskAttemptNum', $pb.PbFieldType.O3)
    ..hasRequiredFields = false
  ;
  ...
  factory EventExecutionSnapshot_EventExecutionSnapshotMetadata.fromBuffer($core.List<$core.int> i, [$pb.ExtensionRegistry r = $pb.ExtensionRegistry.EMPTY]) => create()..mergeFromBuffer(i, r);
  factory EventExecutionSnapshot_EventExecutionSnapshotMetadata.fromJson($core.String i, [$pb.ExtensionRegistry r = $pb.ExtensionRegistry.EMPTY]) => create()..mergeFromJson(i, r);
  @$core.Deprecated(
  'Using this can add significant overhead to your binary. '
  'Use [GeneratedMessageGenericExtensions.deepCopy] instead. '
  'Will be removed in next major version')
  EventExecutionSnapshot_EventExecutionSnapshotMetadata clone() => EventExecutionSnapshot_EventExecutionSnapshotMetadata()..mergeFromMessage(this);
  @$core.Deprecated(
  'Using this can add significant overhead to your binary. '
  'Use [GeneratedMessageGenericExtensions.rebuild] instead. '
  'Will be removed in next major version')
  EventExecutionSnapshot_EventExecutionSnapshotMetadata copyWith(void Function(EventExecutionSnapshot_EventExecutionSnapshotMetadata) updates) => super.copyWith((message) => updates(message as EventExecutionSnapshot_EventExecutionSnapshotMetadata)) as EventExecutionSnapshot_EventExecutionSnapshotMetadata; // ignore: deprecated_member_use
  $pb.BuilderInfo get info_ => _i;
  @$core.pragma('dart2js:noInline')
  static EventExecutionSnapshot_EventExecutionSnapshotMetadata create() => EventExecutionSnapshot_EventExecutionSnapshotMetadata._();
  EventExecutionSnapshot_EventExecutionSnapshotMetadata createEmptyInstance() => create();
  static $pb.PbList<EventExecutionSnapshot_EventExecutionSnapshotMetadata> createRepeated() => $pb.PbList<EventExecutionSnapshot_EventExecutionSnapshotMetadata>();
  @$core.pragma('dart2js:noInline')
  static EventExecutionSnapshot_EventExecutionSnapshotMetadata getDefault() => _defaultInstance ??= $pb.GeneratedMessage.$_defaultFor<EventExecutionSnapshot_EventExecutionSnapshotMetadata>(create);
  static EventExecutionSnapshot_EventExecutionSnapshotMetadata? _defaultInstance;
  ...
  @$pb.TagNumber(3)
  set eventAttemptNum($core.int v) { $_setSignedInt32(2, v); }
  @$pb.TagNumber(3)
...
class EventExecutionSnapshot extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'EventExecutionSnapshot', package: const $pb.PackageName(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'google.cloud.integrations.v1alpha'), createEmptyInstance: create)
    ..aOS(1, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'checkpointTaskNumber')
    ..aOM<$2.Timestamp>(2, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'snapshotTime', subBuilder: $2.Timestamp.create)
    ..aOM<EventExecutionSnapshot_EventExecutionSnapshotMetadata>(3, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'eventExecutionSnapshotMetadata', subBuilder: EventExecutionSnapshot_EventExecutionSnapshotMetadata.create)
    ..pc<TaskExecutionDetails>(4, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'taskExecutionDetails', $pb.PbFieldType.PM, subBuilder: TaskExecutionDetails.create)
    ..pc<ConditionResult>(5, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'conditionResults', $pb.PbFieldType.PM, subBuilder: ConditionResult.create)
    ..m<$core.String, $1.EventParameter>(6, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'eventParams', entryClassName: 'EventExecutionSnapshot.EventParamsEntry', keyFieldType: $pb.PbFieldType.OS, valueFieldType: $pb.PbFieldType.OM, valueCreator: $1.EventParameter.create, packageName: const $pb.PackageName('google.cloud.integrations.v1alpha'))
    ..m<$core.String, $1.EventParameter>(7, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'diffParams', entryClassName: 'EventExecutionSnapshot.DiffParamsEntry', keyFieldType: $pb.PbFieldType.OS, valueFieldType: $pb.PbFieldType.OM, valueCreator: $1.EventParameter.create, packageName: const $pb.PackageName('google.cloud.integrations.v1alpha'))
    ..hasRequiredFields = false
  ;
  ...
  factory EventExecutionSnapshot({
    ...
    EventExecutionSnapshot_EventExecutionSnapshotMetadata? eventExecutionSnapshotMetadata,
  ...
  factory EventExecutionSnapshot.fromBuffer($core.List<$core.int> i, [$pb.ExtensionRegistry r = $pb.ExtensionRegistry.EMPTY]) => create()..mergeFromBuffer(i, r);
  factory EventExecutionSnapshot.fromJson($core.String i, [$pb.ExtensionRegistry r = $pb.ExtensionRegistry.EMPTY]) => create()..mergeFromJson(i, r);
  @$core.Deprecated(
  'Using this can add significant overhead to your binary. '
  'Use [GeneratedMessageGenericExtensions.deepCopy] instead. '
  'Will be removed in next major version')
  EventExecutionSnapshot clone() => EventExecutionSnapshot()..mergeFromMessage(this);
  @$core.Deprecated(
  'Using this can add significant overhead to your binary. '
  'Use [GeneratedMessageGenericExtensions.rebuild] instead. '
  'Will be removed in next major version')
  EventExecutionSnapshot copyWith(void Function(EventExecutionSnapshot) updates) => super.copyWith((message) => updates(message as EventExecutionSnapshot)) as EventExecutionSnapshot; // ignore: deprecated_member_use
  $pb.BuilderInfo get info_ => _i;
  @$core.pragma('dart2js:noInline')
  static EventExecutionSnapshot create() => EventExecutionSnapshot._();
  EventExecutionSnapshot createEmptyInstance() => create();
  static $pb.PbList<EventExecutionSnapshot> createRepeated() => $pb.PbList<EventExecutionSnapshot>();
  @$core.pragma('dart2js:noInline')
  static EventExecutionSnapshot getDefault() => _defaultInstance ??= $pb.GeneratedMessage.$_defaultFor<EventExecutionSnapshot>(create);
  ...
  @$pb.TagNumber(2)
  set snapshotTime($2.Timestamp v) { setField(2, v); }
  @$pb.TagNumber(2)
  ...
  @$pb.TagNumber(3)
  EventExecutionSnapshot_EventExecutionSnapshotMetadata get eventExecutionSnapshotMetadata => $_getN(2);
  @$pb.TagNumber(3)
  set eventExecutionSnapshotMetadata(EventExecutionSnapshot_EventExecutionSnapshotMetadata v) { setField(3, v); }
  @$pb.TagNumber(3)
  $core.bool hasEventExecutionSnapshotMetadata() => $_has(2);
  @$pb.TagNumber(3)
  void clearEventExecutionSnapshotMetadata() => clearField(3);
  @$pb.TagNumber(3)
  EventExecutionSnapshot_EventExecutionSnapshotMetadata ensureEventExecutionSnapshotMetadata() => $_ensure(2);
...
class TaskExecutionDetails extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'TaskExecutionDetails', package: const $pb.PackageName(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'google.cloud.integrations.v1alpha'), createEmptyInstance: create)
    ..aOS(1, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'taskNumber')
    ..e<TaskExecutionDetails_TaskExecutionState>(2, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'taskExecutionState', $pb.PbFieldType.OE, defaultOrMaker: TaskExecutionDetails_TaskExecutionState.TASK_EXECUTION_STATE_UNSPECIFIED, valueOf: TaskExecutionDetails_TaskExecutionState.valueOf, enumValues: TaskExecutionDetails_TaskExecutionState.values)
    ..pc<AttemptStats>(3, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'taskAttemptStats', $pb.PbFieldType.PM, subBuilder: AttemptStats.create)
    ..hasRequiredFields = false
  ;
  ...
  'Use [GeneratedMessageGenericExtensions.rebuild] instead. '
  'Will be removed in next major version')
  TaskExecutionDetails copyWith(void Function(TaskExecutionDetails) updates) => super.copyWith((message) => updates(message as TaskExecutionDetails)) as TaskExecutionDetails; // ignore: deprecated_member_use
  $pb.BuilderInfo get info_ => _i;
  @$core.pragma('dart2js:noInline')
...
class AttemptStats extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'AttemptStats', package: const $pb.PackageName(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'google.cloud.integrations.v1alpha'), createEmptyInstance: create)
  ...
  'Use [GeneratedMessageGenericExtensions.rebuild] instead. '
  'Will be removed in next major version')
  AttemptStats copyWith(void Function(AttemptStats) updates) => super.copyWith((message) => updates(message as AttemptStats)) as AttemptStats; // ignore: deprecated_member_use
  $pb.BuilderInfo get info_ => _i;
  @$core.pragma('dart2js:noInline')
...
class ErrorDetail extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'ErrorDetail', package: const $pb.PackageName(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'google.cloud.integrations.v1alpha'), createEmptyInstance: create)
    ..aOS(1, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'errorMessage')
    ..a<$core.int>(2, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'taskNumber', $pb.PbFieldType.O3)
    ..hasRequiredFields = false
  ;
...
class ConditionResult extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'ConditionResult', package: const $pb.PackageName(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'google.cloud.integrations.v1alpha'), createEmptyInstance: create)
    ..aOS(1, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'currentTaskNumber')
    ..aOS(2, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'nextTaskNumber')
  ...
  'Use [GeneratedMessageGenericExtensions.rebuild] instead. '
  'Will be removed in next major version')
  ConditionResult copyWith(void Function(ConditionResult) updates) => super.copyWith((message) => updates(message as ConditionResult)) as ConditionResult; // ignore: deprecated_member_use
  $pb.BuilderInfo get info_ => _i;
  @$core.pragma('dart2js:noInline')

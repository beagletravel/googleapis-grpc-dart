...
class TaskConfig extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'TaskConfig', package: const $pb.PackageName(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'google.cloud.integrations.v1alpha'), createEmptyInstance: create)
    ...
    ..m<$core.String, $0.EventParameter>(3, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'parameters', entryClassName: 'TaskConfig.ParametersEntry', keyFieldType: $pb.PbFieldType.OS, valueFieldType: $pb.PbFieldType.OM, valueCreator: $0.EventParameter.create, packageName: const $pb.PackageName('google.cloud.integrations.v1alpha'))
    ..aOM<FailurePolicy>(4, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'failurePolicy', subBuilder: FailurePolicy.create)
    ..aOM<FailurePolicy>(5, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'synchronousCallFailurePolicy', subBuilder: FailurePolicy.create)
    ..pc<NextTask>(6, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'nextTasks', $pb.PbFieldType.PM, subBuilder: NextTask.create)
    ..e<TaskConfig_NextTasksExecutionPolicy>(7, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'nextTasksExecutionPolicy', $pb.PbFieldType.OE, defaultOrMaker: TaskConfig_NextTasksExecutionPolicy.NEXT_TASKS_EXECUTION_POLICY_UNSPECIFIED, valueOf: TaskConfig_NextTasksExecutionPolicy.valueOf, enumValues: TaskConfig_NextTasksExecutionPolicy.values)
    ..e<TaskConfig_TaskExecutionStrategy>(8, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'taskExecutionStrategy', $pb.PbFieldType.OE, defaultOrMaker: TaskConfig_TaskExecutionStrategy.TASK_EXECUTION_STRATEGY_UNSPECIFIED, valueOf: TaskConfig_TaskExecutionStrategy.valueOf, enumValues: TaskConfig_TaskExecutionStrategy.values)
    ..aOS(9, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'displayName')
    ..aOM<SuccessPolicy>(10, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'successPolicy', subBuilder: SuccessPolicy.create)
    ..e<$2.JsonValidationOption>(11, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'jsonValidationOption', $pb.PbFieldType.OE, defaultOrMaker: $2.JsonValidationOption.JSON_VALIDATION_OPTION_UNSPECIFIED, valueOf: $2.JsonValidationOption.valueOf, enumValues: $2.JsonValidationOption.values)
  ...
  'Will be removed in next major version')
  TaskConfig copyWith(void Function(TaskConfig) updates) => super.copyWith((message) => updates(message as TaskConfig)) as TaskConfig; // ignore: deprecated_member_use
  ...
  @$pb.TagNumber(11)
  set jsonValidationOption($2.JsonValidationOption v) { setField(11, v); }
  @$pb.TagNumber(11)
...
class SuccessPolicy extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'SuccessPolicy', package: const $pb.PackageName(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'google.cloud.integrations.v1alpha'), createEmptyInstance: create)
    ..e<SuccessPolicy_FinalState>(1, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'finalState', $pb.PbFieldType.OE, defaultOrMaker: SuccessPolicy_FinalState.FINAL_STATE_UNSPECIFIED, valueOf: SuccessPolicy_FinalState.valueOf, enumValues: SuccessPolicy_FinalState.values)
    ..hasRequiredFields = false
  ;
  ...
  'Use [GeneratedMessageGenericExtensions.rebuild] instead. '
  'Will be removed in next major version')
  SuccessPolicy copyWith(void Function(SuccessPolicy) updates) => super.copyWith((message) => updates(message as SuccessPolicy)) as SuccessPolicy; // ignore: deprecated_member_use
  $pb.BuilderInfo get info_ => _i;
  @$core.pragma('dart2js:noInline')
...
class FailurePolicy extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'FailurePolicy', package: const $pb.PackageName(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'google.cloud.integrations.v1alpha'), createEmptyInstance: create)
    ..e<FailurePolicy_RetryStrategy>(1, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'retryStrategy', $pb.PbFieldType.OE, defaultOrMaker: FailurePolicy_RetryStrategy.RETRY_STRATEGY_UNSPECIFIED, valueOf: FailurePolicy_RetryStrategy.valueOf, enumValues: FailurePolicy_RetryStrategy.values)
    ..a<$core.int>(2, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'maxRetries', $pb.PbFieldType.O3)
    ..aOM<$1.Timestamp>(3, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'intervalTime', subBuilder: $1.Timestamp.create)
    ..hasRequiredFields = false
  ;
  ...
  @$pb.TagNumber(3)
  set intervalTime($1.Timestamp v) { setField(3, v); }
  @$pb.TagNumber(3)
...
class NextTask extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'NextTask', package: const $pb.PackageName(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'google.cloud.integrations.v1alpha'), createEmptyInstance: create)
    ..aOS(1, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'taskConfigId')
    ..aOS(2, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'taskId')
  ...
  'Use [GeneratedMessageGenericExtensions.rebuild] instead. '
  'Will be removed in next major version')
  NextTask copyWith(void Function(NextTask) updates) => super.copyWith((message) => updates(message as NextTask)) as NextTask; // ignore: deprecated_member_use
  $pb.BuilderInfo get info_ => _i;
  @$core.pragma('dart2js:noInline')

...
class EndpointPolicy extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'EndpointPolicy', package: const $pb.PackageName(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'google.cloud.networkservices.v1beta1'), createEmptyInstance: create)
    ...
    ..m<$core.String, $core.String>(4, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'labels', entryClassName: 'EndpointPolicy.LabelsEntry', keyFieldType: $pb.PbFieldType.OS, valueFieldType: $pb.PbFieldType.OS, packageName: const $pb.PackageName('google.cloud.networkservices.v1beta1'))
    ..e<EndpointPolicy_EndpointPolicyType>(5, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'type', $pb.PbFieldType.OE, defaultOrMaker: EndpointPolicy_EndpointPolicyType.ENDPOINT_POLICY_TYPE_UNSPECIFIED, valueOf: EndpointPolicy_EndpointPolicyType.valueOf, enumValues: EndpointPolicy_EndpointPolicyType.values)
    ..aOS(7, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'authorizationPolicy')
    ..aOM<$1.EndpointMatcher>(9, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'endpointMatcher', subBuilder: $1.EndpointMatcher.create)
    ..aOM<$1.TrafficPortSelector>(10, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'trafficPortSelector', subBuilder: $1.TrafficPortSelector.create)
    ..aOS(11, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'description')
    ..aOS(12, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'serverTlsPolicy')
    ..aOS(13, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'clientTlsPolicy')
  ...
  'Will be removed in next major version')
  EndpointPolicy copyWith(void Function(EndpointPolicy) updates) => super.copyWith((message) => updates(message as EndpointPolicy)) as EndpointPolicy; // ignore: deprecated_member_use
  ...
  @$pb.TagNumber(9)
  set endpointMatcher($1.EndpointMatcher v) { setField(9, v); }
  @$pb.TagNumber(9)
  ...
  @$pb.TagNumber(10)
  set trafficPortSelector($1.TrafficPortSelector v) { setField(10, v); }
  @$pb.TagNumber(10)
...
class ListEndpointPoliciesRequest extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'ListEndpointPoliciesRequest', package: const $pb.PackageName(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'google.cloud.networkservices.v1beta1'), createEmptyInstance: create)
  ...
  'Use [GeneratedMessageGenericExtensions.rebuild] instead. '
  'Will be removed in next major version')
  ListEndpointPoliciesRequest copyWith(void Function(ListEndpointPoliciesRequest) updates) => super.copyWith((message) => updates(message as ListEndpointPoliciesRequest)) as ListEndpointPoliciesRequest; // ignore: deprecated_member_use
  $pb.BuilderInfo get info_ => _i;
  @$core.pragma('dart2js:noInline')
...
class ListEndpointPoliciesResponse extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'ListEndpointPoliciesResponse', package: const $pb.PackageName(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'google.cloud.networkservices.v1beta1'), createEmptyInstance: create)
    ..pc<EndpointPolicy>(1, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'endpointPolicies', $pb.PbFieldType.PM, subBuilder: EndpointPolicy.create)
  ...
  'Use [GeneratedMessageGenericExtensions.rebuild] instead. '
  'Will be removed in next major version')
  ListEndpointPoliciesResponse copyWith(void Function(ListEndpointPoliciesResponse) updates) => super.copyWith((message) => updates(message as ListEndpointPoliciesResponse)) as ListEndpointPoliciesResponse; // ignore: deprecated_member_use
  $pb.BuilderInfo get info_ => _i;
  @$core.pragma('dart2js:noInline')
...
class GetEndpointPolicyRequest extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'GetEndpointPolicyRequest', package: const $pb.PackageName(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'google.cloud.networkservices.v1beta1'), createEmptyInstance: create)
    ..aOS(1, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'name')
    ..hasRequiredFields = false
  ;
  ...
  'Use [GeneratedMessageGenericExtensions.rebuild] instead. '
  'Will be removed in next major version')
  GetEndpointPolicyRequest copyWith(void Function(GetEndpointPolicyRequest) updates) => super.copyWith((message) => updates(message as GetEndpointPolicyRequest)) as GetEndpointPolicyRequest; // ignore: deprecated_member_use
  $pb.BuilderInfo get info_ => _i;
  @$core.pragma('dart2js:noInline')
...
class CreateEndpointPolicyRequest extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'CreateEndpointPolicyRequest', package: const $pb.PackageName(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'google.cloud.networkservices.v1beta1'), createEmptyInstance: create)
    ..aOS(1, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'parent')
    ..aOS(2, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'endpointPolicyId')
    ..aOM<EndpointPolicy>(3, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'endpointPolicy', subBuilder: EndpointPolicy.create)
    ..hasRequiredFields = false
  ;
  ...
  'Use [GeneratedMessageGenericExtensions.rebuild] instead. '
  'Will be removed in next major version')
  CreateEndpointPolicyRequest copyWith(void Function(CreateEndpointPolicyRequest) updates) => super.copyWith((message) => updates(message as CreateEndpointPolicyRequest)) as CreateEndpointPolicyRequest; // ignore: deprecated_member_use
  $pb.BuilderInfo get info_ => _i;
  @$core.pragma('dart2js:noInline')
...
class UpdateEndpointPolicyRequest extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'UpdateEndpointPolicyRequest', package: const $pb.PackageName(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'google.cloud.networkservices.v1beta1'), createEmptyInstance: create)
    ..aOM<$2.FieldMask>(1, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'updateMask', subBuilder: $2.FieldMask.create)
    ..aOM<EndpointPolicy>(2, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'endpointPolicy', subBuilder: EndpointPolicy.create)
    ..hasRequiredFields = false
  ;
  ...
  'Use [GeneratedMessageGenericExtensions.rebuild] instead. '
  'Will be removed in next major version')
  UpdateEndpointPolicyRequest copyWith(void Function(UpdateEndpointPolicyRequest) updates) => super.copyWith((message) => updates(message as UpdateEndpointPolicyRequest)) as UpdateEndpointPolicyRequest; // ignore: deprecated_member_use
  $pb.BuilderInfo get info_ => _i;
  @$core.pragma('dart2js:noInline')
...
class DeleteEndpointPolicyRequest extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'DeleteEndpointPolicyRequest', package: const $pb.PackageName(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'google.cloud.networkservices.v1beta1'), createEmptyInstance: create)
    ..aOS(1, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'name')
    ..hasRequiredFields = false
  ;
  ...
  'Use [GeneratedMessageGenericExtensions.rebuild] instead. '
  'Will be removed in next major version')
  DeleteEndpointPolicyRequest copyWith(void Function(DeleteEndpointPolicyRequest) updates) => super.copyWith((message) => updates(message as DeleteEndpointPolicyRequest)) as DeleteEndpointPolicyRequest; // ignore: deprecated_member_use
  $pb.BuilderInfo get info_ => _i;
  @$core.pragma('dart2js:noInline')

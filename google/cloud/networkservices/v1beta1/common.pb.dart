...
class OperationMetadata extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'OperationMetadata', package: const $pb.PackageName(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'google.cloud.networkservices.v1beta1'), createEmptyInstance: create)
...
class TrafficPortSelector extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'TrafficPortSelector', package: const $pb.PackageName(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'google.cloud.networkservices.v1beta1'), createEmptyInstance: create)
  ...
  'Use [GeneratedMessageGenericExtensions.rebuild] instead. '
  'Will be removed in next major version')
  TrafficPortSelector copyWith(void Function(TrafficPortSelector) updates) => super.copyWith((message) => updates(message as TrafficPortSelector)) as TrafficPortSelector; // ignore: deprecated_member_use
  $pb.BuilderInfo get info_ => _i;
  @$core.pragma('dart2js:noInline')
...
class EndpointMatcher_MetadataLabelMatcher_MetadataLabels extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'EndpointMatcher.MetadataLabelMatcher.MetadataLabels', package: const $pb.PackageName(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'google.cloud.networkservices.v1beta1'), createEmptyInstance: create)
    ..aOS(1, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'labelName')
    ..aOS(2, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'labelValue')
    ..hasRequiredFields = false
  ;
  ...
  'Use [GeneratedMessageGenericExtensions.rebuild] instead. '
  'Will be removed in next major version')
  EndpointMatcher_MetadataLabelMatcher_MetadataLabels copyWith(void Function(EndpointMatcher_MetadataLabelMatcher_MetadataLabels) updates) => super.copyWith((message) => updates(message as EndpointMatcher_MetadataLabelMatcher_MetadataLabels)) as EndpointMatcher_MetadataLabelMatcher_MetadataLabels; // ignore: deprecated_member_use
  $pb.BuilderInfo get info_ => _i;
  @$core.pragma('dart2js:noInline')
...
class EndpointMatcher_MetadataLabelMatcher extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'EndpointMatcher.MetadataLabelMatcher', package: const $pb.PackageName(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'google.cloud.networkservices.v1beta1'), createEmptyInstance: create)
    ..e<EndpointMatcher_MetadataLabelMatcher_MetadataLabelMatchCriteria>(1, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'metadataLabelMatchCriteria', $pb.PbFieldType.OE, defaultOrMaker: EndpointMatcher_MetadataLabelMatcher_MetadataLabelMatchCriteria.METADATA_LABEL_MATCH_CRITERIA_UNSPECIFIED, valueOf: EndpointMatcher_MetadataLabelMatcher_MetadataLabelMatchCriteria.valueOf, enumValues: EndpointMatcher_MetadataLabelMatcher_MetadataLabelMatchCriteria.values)
    ..pc<EndpointMatcher_MetadataLabelMatcher_MetadataLabels>(2, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'metadataLabels', $pb.PbFieldType.PM, subBuilder: EndpointMatcher_MetadataLabelMatcher_MetadataLabels.create)
    ..hasRequiredFields = false
  ;
  ...
  'Use [GeneratedMessageGenericExtensions.rebuild] instead. '
  'Will be removed in next major version')
  EndpointMatcher_MetadataLabelMatcher copyWith(void Function(EndpointMatcher_MetadataLabelMatcher) updates) => super.copyWith((message) => updates(message as EndpointMatcher_MetadataLabelMatcher)) as EndpointMatcher_MetadataLabelMatcher; // ignore: deprecated_member_use
  $pb.BuilderInfo get info_ => _i;
  @$core.pragma('dart2js:noInline')
...
class EndpointMatcher extends $pb.GeneratedMessage {
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'EndpointMatcher', package: const $pb.PackageName(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'google.cloud.networkservices.v1beta1'), createEmptyInstance: create)
    ..oo(0, [1])
    ..aOM<EndpointMatcher_MetadataLabelMatcher>(1, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'metadataLabelMatcher', subBuilder: EndpointMatcher_MetadataLabelMatcher.create)
    ..hasRequiredFields = false
  ;
  ...
  'Use [GeneratedMessageGenericExtensions.rebuild] instead. '
  'Will be removed in next major version')
  EndpointMatcher copyWith(void Function(EndpointMatcher) updates) => super.copyWith((message) => updates(message as EndpointMatcher)) as EndpointMatcher; // ignore: deprecated_member_use
  $pb.BuilderInfo get info_ => _i;
  @$core.pragma('dart2js:noInline')

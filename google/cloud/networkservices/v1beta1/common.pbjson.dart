...
const EndpointMatcher$json = const {
  '1': 'EndpointMatcher',
  '2': const [
    const {'1': 'metadata_label_matcher', '3': 1, '4': 1, '5': 11, '6': '.google.cloud.networkservices.v1beta1.EndpointMatcher.MetadataLabelMatcher', '9': 0, '10': 'metadataLabelMatcher'},
  ],
...
const EndpointMatcher_MetadataLabelMatcher$json = const {
  ...
  '2': const [
    const {'1': 'metadata_label_match_criteria', '3': 1, '4': 1, '5': 14, '6': '.google.cloud.networkservices.v1beta1.EndpointMatcher.MetadataLabelMatcher.MetadataLabelMatchCriteria', '10': 'metadataLabelMatchCriteria'},
    const {'1': 'metadata_labels', '3': 2, '4': 3, '5': 11, '6': '.google.cloud.networkservices.v1beta1.EndpointMatcher.MetadataLabelMatcher.MetadataLabels', '10': 'metadataLabels'},
  ],
...
final $typed_data.Uint8List endpointMatcherDescriptor = $convert.base64Decode('');

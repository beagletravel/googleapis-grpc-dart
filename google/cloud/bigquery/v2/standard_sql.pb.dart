...
class StandardSqlDataType extends $pb.GeneratedMessage {
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'StandardSqlDataType', package: const $pb.PackageName(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'google.cloud.bigquery.v2'), createEmptyInstance: create)
    ..oo(0, [2, 3])
    ..e<StandardSqlDataType_TypeKind>(1, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'typeKind', $pb.PbFieldType.OE, defaultOrMaker: StandardSqlDataType_TypeKind.TYPE_KIND_UNSPECIFIED, valueOf: StandardSqlDataType_TypeKind.valueOf, enumValues: StandardSqlDataType_TypeKind.values)
    ..aOM<StandardSqlDataType>(2, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'arrayElementType', subBuilder: StandardSqlDataType.create)
    ..aOM<StandardSqlStructType>(3, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'structType', subBuilder: StandardSqlStructType.create)
  ...
  'Will be removed in next major version')
  StandardSqlDataType copyWith(void Function(StandardSqlDataType) updates) => super.copyWith((message) => updates(message as StandardSqlDataType)) as StandardSqlDataType; // ignore: deprecated_member_use
...
class StandardSqlField extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'StandardSqlField', package: const $pb.PackageName(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'google.cloud.bigquery.v2'), createEmptyInstance: create)
    ..aOS(1, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'name')
    ..aOM<StandardSqlDataType>(2, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'type', subBuilder: StandardSqlDataType.create)
    ..hasRequiredFields = false
  ;
  ...
  'Use [GeneratedMessageGenericExtensions.rebuild] instead. '
  'Will be removed in next major version')
  StandardSqlField copyWith(void Function(StandardSqlField) updates) => super.copyWith((message) => updates(message as StandardSqlField)) as StandardSqlField; // ignore: deprecated_member_use
  $pb.BuilderInfo get info_ => _i;
  @$core.pragma('dart2js:noInline')
...
class StandardSqlStructType extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'StandardSqlStructType', package: const $pb.PackageName(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'google.cloud.bigquery.v2'), createEmptyInstance: create)
    ..pc<StandardSqlField>(1, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'fields', $pb.PbFieldType.PM, subBuilder: StandardSqlField.create)
    ..hasRequiredFields = false
  ;
  ...
  'Use [GeneratedMessageGenericExtensions.rebuild] instead. '
  'Will be removed in next major version')
  StandardSqlStructType copyWith(void Function(StandardSqlStructType) updates) => super.copyWith((message) => updates(message as StandardSqlStructType)) as StandardSqlStructType; // ignore: deprecated_member_use
  $pb.BuilderInfo get info_ => _i;
  @$core.pragma('dart2js:noInline')
...
class StandardSqlTableType extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'StandardSqlTableType', package: const $pb.PackageName(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'google.cloud.bigquery.v2'), createEmptyInstance: create)
    ..pc<StandardSqlField>(1, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'columns', $pb.PbFieldType.PM, subBuilder: StandardSqlField.create)
    ..hasRequiredFields = false
  ;
  ...
  'Use [GeneratedMessageGenericExtensions.rebuild] instead. '
  'Will be removed in next major version')
  StandardSqlTableType copyWith(void Function(StandardSqlTableType) updates) => super.copyWith((message) => updates(message as StandardSqlTableType)) as StandardSqlTableType; // ignore: deprecated_member_use
  $pb.BuilderInfo get info_ => _i;
  @$core.pragma('dart2js:noInline')

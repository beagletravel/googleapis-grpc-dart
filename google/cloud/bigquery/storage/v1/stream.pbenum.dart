...
class DataFormat extends $pb.ProtobufEnum {
  ...
  static const DataFormat AVRO = DataFormat._(1, const $core.bool.fromEnvironment('protobuf.omit_enum_names') ? '' : 'AVRO');
  static const DataFormat ARROW = DataFormat._(2, const $core.bool.fromEnvironment('protobuf.omit_enum_names') ? '' : 'ARROW');
...
class WriteStream_Type extends $pb.ProtobufEnum {
  static const WriteStream_Type TYPE_UNSPECIFIED = WriteStream_Type._(0, const $core.bool.fromEnvironment('protobuf.omit_enum_names') ? '' : 'TYPE_UNSPECIFIED');
  static const WriteStream_Type COMMITTED = WriteStream_Type._(1, const $core.bool.fromEnvironment('protobuf.omit_enum_names') ? '' : 'COMMITTED');
  static const WriteStream_Type PENDING = WriteStream_Type._(2, const $core.bool.fromEnvironment('protobuf.omit_enum_names') ? '' : 'PENDING');
  static const WriteStream_Type BUFFERED = WriteStream_Type._(3, const $core.bool.fromEnvironment('protobuf.omit_enum_names') ? '' : 'BUFFERED');
...
class WriteStream_WriteMode extends $pb.ProtobufEnum {
  static const WriteStream_WriteMode WRITE_MODE_UNSPECIFIED = WriteStream_WriteMode._(0, const $core.bool.fromEnvironment('protobuf.omit_enum_names') ? '' : 'WRITE_MODE_UNSPECIFIED');
  static const WriteStream_WriteMode INSERT = WriteStream_WriteMode._(1, const $core.bool.fromEnvironment('protobuf.omit_enum_names') ? '' : 'INSERT');

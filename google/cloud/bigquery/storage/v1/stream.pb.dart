...
class ReadSession_TableModifiers extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'ReadSession.TableModifiers', package: const $pb.PackageName(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'google.cloud.bigquery.storage.v1'), createEmptyInstance: create)
    ..aOM<$0.Timestamp>(1, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'snapshotTime', subBuilder: $0.Timestamp.create)
  ...
  'Will be removed in next major version')
  ReadSession_TableModifiers copyWith(void Function(ReadSession_TableModifiers) updates) => super.copyWith((message) => updates(message as ReadSession_TableModifiers)) as ReadSession_TableModifiers; // ignore: deprecated_member_use
  ...
  @$pb.TagNumber(1)
  set snapshotTime($0.Timestamp v) { setField(1, v); }
  @$pb.TagNumber(1)
...
class ReadSession_TableReadOptions extends $pb.GeneratedMessage {
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'ReadSession.TableReadOptions', package: const $pb.PackageName(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'google.cloud.bigquery.storage.v1'), createEmptyInstance: create)
    ..oo(0, [3])
    ..pPS(1, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'selectedFields')
    ..aOS(2, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'rowRestriction')
    ..aOM<$2.ArrowSerializationOptions>(3, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'arrowSerializationOptions', subBuilder: $2.ArrowSerializationOptions.create)
    ..hasRequiredFields = false
  ;
  ...
  'Use [GeneratedMessageGenericExtensions.rebuild] instead. '
  'Will be removed in next major version')
  ReadSession_TableReadOptions copyWith(void Function(ReadSession_TableReadOptions) updates) => super.copyWith((message) => updates(message as ReadSession_TableReadOptions)) as ReadSession_TableReadOptions; // ignore: deprecated_member_use
  $pb.BuilderInfo get info_ => _i;
  @$core.pragma('dart2js:noInline')
  ...
  @$pb.TagNumber(3)
  set arrowSerializationOptions($2.ArrowSerializationOptions v) { setField(3, v); }
  @$pb.TagNumber(3)
...
class ReadSession extends $pb.GeneratedMessage {
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'ReadSession', package: const $pb.PackageName(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'google.cloud.bigquery.storage.v1'), createEmptyInstance: create)
    ..oo(0, [4, 5])
    ..aOS(1, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'name')
    ..aOM<$0.Timestamp>(2, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'expireTime', subBuilder: $0.Timestamp.create)
    ..e<DataFormat>(3, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'dataFormat', $pb.PbFieldType.OE, defaultOrMaker: DataFormat.DATA_FORMAT_UNSPECIFIED, valueOf: DataFormat.valueOf, enumValues: DataFormat.values)
    ..aOM<$1.AvroSchema>(4, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'avroSchema', subBuilder: $1.AvroSchema.create)
    ..aOM<$2.ArrowSchema>(5, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'arrowSchema', subBuilder: $2.ArrowSchema.create)
    ..aOS(6, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'table')
    ..aOM<ReadSession_TableModifiers>(7, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'tableModifiers', subBuilder: ReadSession_TableModifiers.create)
    ..aOM<ReadSession_TableReadOptions>(8, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'readOptions', subBuilder: ReadSession_TableReadOptions.create)
    ..pc<ReadStream>(10, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'streams', $pb.PbFieldType.PM, subBuilder: ReadStream.create)
    ..aInt64(12, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'estimatedTotalBytesScanned')
    ..aOS(13, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'traceId')
    ..hasRequiredFields = false
  ;
  ...
  @$pb.TagNumber(2)
  set expireTime($0.Timestamp v) { setField(2, v); }
  @$pb.TagNumber(2)
  ...
  @$pb.TagNumber(4)
  set avroSchema($1.AvroSchema v) { setField(4, v); }
  @$pb.TagNumber(4)
  ...
  @$pb.TagNumber(5)
  set arrowSchema($2.ArrowSchema v) { setField(5, v); }
  @$pb.TagNumber(5)
...
class ReadStream extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'ReadStream', package: const $pb.PackageName(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'google.cloud.bigquery.storage.v1'), createEmptyInstance: create)
    ..aOS(1, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'name')
    ..hasRequiredFields = false
  ;
  ...
  'Use [GeneratedMessageGenericExtensions.rebuild] instead. '
  'Will be removed in next major version')
  ReadStream copyWith(void Function(ReadStream) updates) => super.copyWith((message) => updates(message as ReadStream)) as ReadStream; // ignore: deprecated_member_use
  $pb.BuilderInfo get info_ => _i;
  @$core.pragma('dart2js:noInline')
...
class WriteStream extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'WriteStream', package: const $pb.PackageName(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'google.cloud.bigquery.storage.v1'), createEmptyInstance: create)
    ..aOS(1, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'name')
    ..e<WriteStream_Type>(2, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'type', $pb.PbFieldType.OE, defaultOrMaker: WriteStream_Type.TYPE_UNSPECIFIED, valueOf: WriteStream_Type.valueOf, enumValues: WriteStream_Type.values)
    ..aOM<$0.Timestamp>(3, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'createTime', subBuilder: $0.Timestamp.create)
    ..aOM<$0.Timestamp>(4, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'commitTime', subBuilder: $0.Timestamp.create)
    ..aOM<$3.TableSchema>(5, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'tableSchema', subBuilder: $3.TableSchema.create)
    ..e<WriteStream_WriteMode>(7, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'writeMode', $pb.PbFieldType.OE, defaultOrMaker: WriteStream_WriteMode.WRITE_MODE_UNSPECIFIED, valueOf: WriteStream_WriteMode.valueOf, enumValues: WriteStream_WriteMode.values)
    ..hasRequiredFields = false
  ;
  ...
  'Use [GeneratedMessageGenericExtensions.rebuild] instead. '
  'Will be removed in next major version')
  WriteStream copyWith(void Function(WriteStream) updates) => super.copyWith((message) => updates(message as WriteStream)) as WriteStream; // ignore: deprecated_member_use
  $pb.BuilderInfo get info_ => _i;
  @$core.pragma('dart2js:noInline')
  ...
  @$pb.TagNumber(4)
  set commitTime($0.Timestamp v) { setField(4, v); }
  @$pb.TagNumber(4)
  ...
  @$pb.TagNumber(5)
  set tableSchema($3.TableSchema v) { setField(5, v); }
  @$pb.TagNumber(5)

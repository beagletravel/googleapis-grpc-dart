...
class DataFormat extends $pb.ProtobufEnum {
  ...
  static const DataFormat ARROW = DataFormat._(3, const $core.bool.fromEnvironment('protobuf.omit_enum_names') ? '' : 'ARROW');
...
class ShardingStrategy extends $pb.ProtobufEnum {
  static const ShardingStrategy SHARDING_STRATEGY_UNSPECIFIED = ShardingStrategy._(0, const $core.bool.fromEnvironment('protobuf.omit_enum_names') ? '' : 'SHARDING_STRATEGY_UNSPECIFIED');
  static const ShardingStrategy LIQUID = ShardingStrategy._(1, const $core.bool.fromEnvironment('protobuf.omit_enum_names') ? '' : 'LIQUID');
  static const ShardingStrategy BALANCED = ShardingStrategy._(2, const $core.bool.fromEnvironment('protobuf.omit_enum_names') ? '' : 'BALANCED');

...
class Stream extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'Stream', package: const $pb.PackageName(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'google.cloud.bigquery.storage.v1beta1'), createEmptyInstance: create)
...
class StreamPosition extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'StreamPosition', package: const $pb.PackageName(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'google.cloud.bigquery.storage.v1beta1'), createEmptyInstance: create)
...
class ReadSession extends $pb.GeneratedMessage {
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'ReadSession', package: const $pb.PackageName(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'google.cloud.bigquery.storage.v1beta1'), createEmptyInstance: create)
    ..oo(0, [5, 6])
    ..aOS(1, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'name')
    ..aOM<$2.Timestamp>(2, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'expireTime', subBuilder: $2.Timestamp.create)
    ..pc<Stream>(4, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'streams', $pb.PbFieldType.PM, subBuilder: Stream.create)
    ..aOM<$3.AvroSchema>(5, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'avroSchema', subBuilder: $3.AvroSchema.create)
    ..aOM<$4.ArrowSchema>(6, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'arrowSchema', subBuilder: $4.ArrowSchema.create)
    ..aOM<$5.TableReference>(7, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'tableReference', subBuilder: $5.TableReference.create)
    ..aOM<$5.TableModifiers>(8, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'tableModifiers', subBuilder: $5.TableModifiers.create)
    ..e<ShardingStrategy>(9, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'shardingStrategy', $pb.PbFieldType.OE, defaultOrMaker: ShardingStrategy.SHARDING_STRATEGY_UNSPECIFIED, valueOf: ShardingStrategy.valueOf, enumValues: ShardingStrategy.values)
    ..hasRequiredFields = false
  ;
  ...
  'Use [GeneratedMessageGenericExtensions.rebuild] instead. '
  'Will be removed in next major version')
  ReadSession copyWith(void Function(ReadSession) updates) => super.copyWith((message) => updates(message as ReadSession)) as ReadSession; // ignore: deprecated_member_use
  $pb.BuilderInfo get info_ => _i;
  @$core.pragma('dart2js:noInline')
  ...
  @$pb.TagNumber(5)
  set avroSchema($3.AvroSchema v) { setField(5, v); }
  @$pb.TagNumber(5)
  ...
  @$pb.TagNumber(6)
  set arrowSchema($4.ArrowSchema v) { setField(6, v); }
  @$pb.TagNumber(6)
  ...
  @$pb.TagNumber(7)
  set tableReference($5.TableReference v) { setField(7, v); }
  @$pb.TagNumber(7)
  ...
  @$pb.TagNumber(8)
  set tableModifiers($5.TableModifiers v) { setField(8, v); }
  @$pb.TagNumber(8)
...
class CreateReadSessionRequest extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'CreateReadSessionRequest', package: const $pb.PackageName(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'google.cloud.bigquery.storage.v1beta1'), createEmptyInstance: create)
    ..aOM<$5.TableReference>(1, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'tableReference', subBuilder: $5.TableReference.create)
    ..aOM<$5.TableModifiers>(2, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'tableModifiers', subBuilder: $5.TableModifiers.create)
    ..a<$core.int>(3, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'requestedStreams', $pb.PbFieldType.O3)
    ..aOM<$6.TableReadOptions>(4, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'readOptions', subBuilder: $6.TableReadOptions.create)
    ..e<DataFormat>(5, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'format', $pb.PbFieldType.OE, defaultOrMaker: DataFormat.DATA_FORMAT_UNSPECIFIED, valueOf: DataFormat.valueOf, enumValues: DataFormat.values)
    ..aOS(6, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'parent')
    ..e<ShardingStrategy>(7, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'shardingStrategy', $pb.PbFieldType.OE, defaultOrMaker: ShardingStrategy.SHARDING_STRATEGY_UNSPECIFIED, valueOf: ShardingStrategy.valueOf, enumValues: ShardingStrategy.values)
    ..hasRequiredFields = false
  ;
  ...
  @$pb.TagNumber(1)
  set tableReference($5.TableReference v) { setField(1, v); }
  @$pb.TagNumber(1)
  ...
  @$pb.TagNumber(2)
  set tableModifiers($5.TableModifiers v) { setField(2, v); }
  @$pb.TagNumber(2)
  ...
  @$pb.TagNumber(4)
  set readOptions($6.TableReadOptions v) { setField(4, v); }
  @$pb.TagNumber(4)
...
class ReadRowsRequest extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'ReadRowsRequest', package: const $pb.PackageName(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'google.cloud.bigquery.storage.v1beta1'), createEmptyInstance: create)
    ..aOM<StreamPosition>(1, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'readPosition', subBuilder: StreamPosition.create)
    ..hasRequiredFields = false
  ;
...
class StreamStatus extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'StreamStatus', package: const $pb.PackageName(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'google.cloud.bigquery.storage.v1beta1'), createEmptyInstance: create)
    ..aInt64(1, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'estimatedRowCount')
    ..a<$core.double>(2, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'fractionConsumed', $pb.PbFieldType.OF)
    ..aOB(3, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'isSplittable')
    ..aOM<Progress>(4, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'progress', subBuilder: Progress.create)
    ..hasRequiredFields = false
  ;
  ...
  'Use [GeneratedMessageGenericExtensions.rebuild] instead. '
  'Will be removed in next major version')
  StreamStatus copyWith(void Function(StreamStatus) updates) => super.copyWith((message) => updates(message as StreamStatus)) as StreamStatus; // ignore: deprecated_member_use
  $pb.BuilderInfo get info_ => _i;
  @$core.pragma('dart2js:noInline')
...
class Progress extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'Progress', package: const $pb.PackageName(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'google.cloud.bigquery.storage.v1beta1'), createEmptyInstance: create)
    ..a<$core.double>(1, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'atResponseStart', $pb.PbFieldType.OF)
    ..a<$core.double>(2, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'atResponseEnd', $pb.PbFieldType.OF)
    ..hasRequiredFields = false
  ;
...
class ThrottleStatus extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'ThrottleStatus', package: const $pb.PackageName(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'google.cloud.bigquery.storage.v1beta1'), createEmptyInstance: create)
  ...
  'Use [GeneratedMessageGenericExtensions.rebuild] instead. '
  'Will be removed in next major version')
  ThrottleStatus copyWith(void Function(ThrottleStatus) updates) => super.copyWith((message) => updates(message as ThrottleStatus)) as ThrottleStatus; // ignore: deprecated_member_use
  $pb.BuilderInfo get info_ => _i;
  @$core.pragma('dart2js:noInline')
...
class ReadRowsResponse extends $pb.GeneratedMessage {
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'ReadRowsResponse', package: const $pb.PackageName(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'google.cloud.bigquery.storage.v1beta1'), createEmptyInstance: create)
    ..oo(0, [3, 4])
    ..aOM<StreamStatus>(2, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'status', subBuilder: StreamStatus.create)
    ..aOM<$3.AvroRows>(3, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'avroRows', subBuilder: $3.AvroRows.create)
    ..aOM<$4.ArrowRecordBatch>(4, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'arrowRecordBatch', subBuilder: $4.ArrowRecordBatch.create)
    ..aOM<ThrottleStatus>(5, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'throttleStatus', subBuilder: ThrottleStatus.create)
  ...
  @$pb.TagNumber(3)
  set avroRows($3.AvroRows v) { setField(3, v); }
  @$pb.TagNumber(3)
  ...
  @$pb.TagNumber(4)
  set arrowRecordBatch($4.ArrowRecordBatch v) { setField(4, v); }
  @$pb.TagNumber(4)
...
class BatchCreateReadSessionStreamsRequest extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'BatchCreateReadSessionStreamsRequest', package: const $pb.PackageName(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'google.cloud.bigquery.storage.v1beta1'), createEmptyInstance: create)
    ..aOM<ReadSession>(1, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'session', subBuilder: ReadSession.create)
    ..a<$core.int>(2, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'requestedStreams', $pb.PbFieldType.O3)
    ..hasRequiredFields = false
  ;
  ...
  'Use [GeneratedMessageGenericExtensions.rebuild] instead. '
  'Will be removed in next major version')
  BatchCreateReadSessionStreamsRequest copyWith(void Function(BatchCreateReadSessionStreamsRequest) updates) => super.copyWith((message) => updates(message as BatchCreateReadSessionStreamsRequest)) as BatchCreateReadSessionStreamsRequest; // ignore: deprecated_member_use
  $pb.BuilderInfo get info_ => _i;
  @$core.pragma('dart2js:noInline')
...
class BatchCreateReadSessionStreamsResponse extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'BatchCreateReadSessionStreamsResponse', package: const $pb.PackageName(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'google.cloud.bigquery.storage.v1beta1'), createEmptyInstance: create)
    ..pc<Stream>(1, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'streams', $pb.PbFieldType.PM, subBuilder: Stream.create)
    ..hasRequiredFields = false
  ;
  ...
  'Use [GeneratedMessageGenericExtensions.rebuild] instead. '
  'Will be removed in next major version')
  BatchCreateReadSessionStreamsResponse copyWith(void Function(BatchCreateReadSessionStreamsResponse) updates) => super.copyWith((message) => updates(message as BatchCreateReadSessionStreamsResponse)) as BatchCreateReadSessionStreamsResponse; // ignore: deprecated_member_use
  $pb.BuilderInfo get info_ => _i;
  @$core.pragma('dart2js:noInline')
...
class FinalizeStreamRequest extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'FinalizeStreamRequest', package: const $pb.PackageName(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'google.cloud.bigquery.storage.v1beta1'), createEmptyInstance: create)
    ..aOM<Stream>(2, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'stream', subBuilder: Stream.create)
    ..hasRequiredFields = false
  ;
  ...
  'Use [GeneratedMessageGenericExtensions.rebuild] instead. '
  'Will be removed in next major version')
  FinalizeStreamRequest copyWith(void Function(FinalizeStreamRequest) updates) => super.copyWith((message) => updates(message as FinalizeStreamRequest)) as FinalizeStreamRequest; // ignore: deprecated_member_use
  $pb.BuilderInfo get info_ => _i;
  @$core.pragma('dart2js:noInline')
...
class SplitReadStreamRequest extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'SplitReadStreamRequest', package: const $pb.PackageName(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'google.cloud.bigquery.storage.v1beta1'), createEmptyInstance: create)
    ..aOM<Stream>(1, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'originalStream', subBuilder: Stream.create)
    ..a<$core.double>(2, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'fraction', $pb.PbFieldType.OF)
    ..hasRequiredFields = false
  ;
...
class SplitReadStreamResponse extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'SplitReadStreamResponse', package: const $pb.PackageName(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'google.cloud.bigquery.storage.v1beta1'), createEmptyInstance: create)
    ..aOM<Stream>(1, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'primaryStream', subBuilder: Stream.create)
    ..aOM<Stream>(2, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'remainderStream', subBuilder: Stream.create)
    ..hasRequiredFields = false
  ;

...
const TableSchema$json = const {
  '1': 'TableSchema',
  '2': const [
    const {'1': 'fields', '3': 1, '4': 3, '5': 11, '6': '.google.cloud.bigquery.storage.v1beta2.TableFieldSchema', '10': 'fields'},
  ],
};

/// Descriptor for `TableSchema`. Decode as a `google.protobuf.DescriptorProto`.
final $typed_data.Uint8List tableSchemaDescriptor = $convert.base64Decode('CgtUYWJsZVNjaGVtYRJPCgZmaWVsZHMYASADKAsyNy5nb29nbGUuY2xvdWQuYmlncXVlcnkuc3RvcmFnZS52MWJldGEyLlRhYmxlRmllbGRTY2hlbWFSBmZpZWxkcw==');
@$core.Deprecated('Use tableFieldSchemaDescriptor instead')
const TableFieldSchema$json = const {
  '1': 'TableFieldSchema',
  '2': const [
    const {'1': 'name', '3': 1, '4': 1, '5': 9, '8': const {}, '10': 'name'},
    const {'1': 'type', '3': 2, '4': 1, '5': 14, '6': '.google.cloud.bigquery.storage.v1beta2.TableFieldSchema.Type', '8': const {}, '10': 'type'},
    const {'1': 'mode', '3': 3, '4': 1, '5': 14, '6': '.google.cloud.bigquery.storage.v1beta2.TableFieldSchema.Mode', '8': const {}, '10': 'mode'},
    const {'1': 'fields', '3': 4, '4': 3, '5': 11, '6': '.google.cloud.bigquery.storage.v1beta2.TableFieldSchema', '8': const {}, '10': 'fields'},

...
class ProtoSchema extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'ProtoSchema', package: const $pb.PackageName(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'google.cloud.bigquery.storage.v1beta2'), createEmptyInstance: create)
    ..aOM<$0.DescriptorProto>(1, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'protoDescriptor', subBuilder: $0.DescriptorProto.create)
  ;
  ...
  'Will be removed in next major version')
  ProtoSchema copyWith(void Function(ProtoSchema) updates) => super.copyWith((message) => updates(message as ProtoSchema)) as ProtoSchema; // ignore: deprecated_member_use
  ...
  @$pb.TagNumber(1)
  set protoDescriptor($0.DescriptorProto v) { setField(1, v); }
  @$pb.TagNumber(1)
...
class ProtoRows extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'ProtoRows', package: const $pb.PackageName(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'google.cloud.bigquery.storage.v1beta2'), createEmptyInstance: create)
    ..p<$core.List<$core.int>>(1, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'serializedRows', $pb.PbFieldType.PY)
  ...
  'Use [GeneratedMessageGenericExtensions.rebuild] instead. '
  'Will be removed in next major version')
  ProtoRows copyWith(void Function(ProtoRows) updates) => super.copyWith((message) => updates(message as ProtoRows)) as ProtoRows; // ignore: deprecated_member_use
  $pb.BuilderInfo get info_ => _i;
  @$core.pragma('dart2js:noInline')

...
class CreateReadSessionRequest extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'CreateReadSessionRequest', package: const $pb.PackageName(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'google.cloud.bigquery.storage.v1beta2'), createEmptyInstance: create)
    ..aOS(1, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'parent')
    ..aOM<$1.ReadSession>(2, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'readSession', subBuilder: $1.ReadSession.create)
    ..a<$core.int>(3, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'maxStreamCount', $pb.PbFieldType.O3)
  ...
  'Will be removed in next major version')
  CreateReadSessionRequest copyWith(void Function(CreateReadSessionRequest) updates) => super.copyWith((message) => updates(message as CreateReadSessionRequest)) as CreateReadSessionRequest; // ignore: deprecated_member_use
  ...
  @$pb.TagNumber(2)
  set readSession($1.ReadSession v) { setField(2, v); }
  @$pb.TagNumber(2)
...
class ReadRowsRequest extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'ReadRowsRequest', package: const $pb.PackageName(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'google.cloud.bigquery.storage.v1beta2'), createEmptyInstance: create)
    ..aOS(1, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'readStream')
...
class ThrottleState extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'ThrottleState', package: const $pb.PackageName(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'google.cloud.bigquery.storage.v1beta2'), createEmptyInstance: create)
    ..a<$core.int>(1, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'throttlePercent', $pb.PbFieldType.O3)
    ..hasRequiredFields = false
  ;
  ...
  'Use [GeneratedMessageGenericExtensions.rebuild] instead. '
  'Will be removed in next major version')
  ThrottleState copyWith(void Function(ThrottleState) updates) => super.copyWith((message) => updates(message as ThrottleState)) as ThrottleState; // ignore: deprecated_member_use
  $pb.BuilderInfo get info_ => _i;
  @$core.pragma('dart2js:noInline')
...
class StreamStats_Progress extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'StreamStats.Progress', package: const $pb.PackageName(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'google.cloud.bigquery.storage.v1beta2'), createEmptyInstance: create)
    ..a<$core.double>(1, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'atResponseStart', $pb.PbFieldType.OD)
    ..a<$core.double>(2, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'atResponseEnd', $pb.PbFieldType.OD)
    ..hasRequiredFields = false
  ;
  ...
  'Use [GeneratedMessageGenericExtensions.rebuild] instead. '
  'Will be removed in next major version')
  StreamStats_Progress copyWith(void Function(StreamStats_Progress) updates) => super.copyWith((message) => updates(message as StreamStats_Progress)) as StreamStats_Progress; // ignore: deprecated_member_use
  $pb.BuilderInfo get info_ => _i;
  @$core.pragma('dart2js:noInline')
...
class StreamStats extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'StreamStats', package: const $pb.PackageName(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'google.cloud.bigquery.storage.v1beta2'), createEmptyInstance: create)
    ..aOM<StreamStats_Progress>(2, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'progress', subBuilder: StreamStats_Progress.create)
    ..hasRequiredFields = false
  ;
  ...
  'Use [GeneratedMessageGenericExtensions.rebuild] instead. '
  'Will be removed in next major version')
  StreamStats copyWith(void Function(StreamStats) updates) => super.copyWith((message) => updates(message as StreamStats)) as StreamStats; // ignore: deprecated_member_use
  $pb.BuilderInfo get info_ => _i;
  @$core.pragma('dart2js:noInline')
...
class ReadRowsResponse extends $pb.GeneratedMessage {
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'ReadRowsResponse', package: const $pb.PackageName(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'google.cloud.bigquery.storage.v1beta2'), createEmptyInstance: create)
    ..oo(0, [3, 4])
    ..oo(1, [7, 8])
    ..aOM<StreamStats>(2, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'stats', subBuilder: StreamStats.create)
    ..aOM<$2.AvroRows>(3, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'avroRows', subBuilder: $2.AvroRows.create)
    ..aOM<$3.ArrowRecordBatch>(4, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'arrowRecordBatch', subBuilder: $3.ArrowRecordBatch.create)
    ..aOM<ThrottleState>(5, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'throttleState', subBuilder: ThrottleState.create)
    ..aInt64(6, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'rowCount')
    ..aOM<$2.AvroSchema>(7, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'avroSchema', subBuilder: $2.AvroSchema.create)
    ..aOM<$3.ArrowSchema>(8, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'arrowSchema', subBuilder: $3.ArrowSchema.create)
    ..hasRequiredFields = false
  ;
  ...
  @$pb.TagNumber(3)
  set avroRows($2.AvroRows v) { setField(3, v); }
  @$pb.TagNumber(3)
  ...
  @$pb.TagNumber(4)
  set arrowRecordBatch($3.ArrowRecordBatch v) { setField(4, v); }
  @$pb.TagNumber(4)
  ...
  @$pb.TagNumber(7)
  set avroSchema($2.AvroSchema v) { setField(7, v); }
  @$pb.TagNumber(7)
  ...
  @$pb.TagNumber(8)
  set arrowSchema($3.ArrowSchema v) { setField(8, v); }
  @$pb.TagNumber(8)
...
class SplitReadStreamRequest extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'SplitReadStreamRequest', package: const $pb.PackageName(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'google.cloud.bigquery.storage.v1beta2'), createEmptyInstance: create)
    ..aOS(1, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'name')
    ..a<$core.double>(2, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'fraction', $pb.PbFieldType.OD)
    ..hasRequiredFields = false
  ;
  ...
  'Use [GeneratedMessageGenericExtensions.rebuild] instead. '
  'Will be removed in next major version')
  SplitReadStreamRequest copyWith(void Function(SplitReadStreamRequest) updates) => super.copyWith((message) => updates(message as SplitReadStreamRequest)) as SplitReadStreamRequest; // ignore: deprecated_member_use
  $pb.BuilderInfo get info_ => _i;
  @$core.pragma('dart2js:noInline')
...
class SplitReadStreamResponse extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'SplitReadStreamResponse', package: const $pb.PackageName(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'google.cloud.bigquery.storage.v1beta2'), createEmptyInstance: create)
    ..aOM<$1.ReadStream>(1, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'primaryStream', subBuilder: $1.ReadStream.create)
    ..aOM<$1.ReadStream>(2, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'remainderStream', subBuilder: $1.ReadStream.create)
    ..hasRequiredFields = false
  ;
  ...
  'Use [GeneratedMessageGenericExtensions.rebuild] instead. '
  'Will be removed in next major version')
  SplitReadStreamResponse copyWith(void Function(SplitReadStreamResponse) updates) => super.copyWith((message) => updates(message as SplitReadStreamResponse)) as SplitReadStreamResponse; // ignore: deprecated_member_use
  $pb.BuilderInfo get info_ => _i;
  @$core.pragma('dart2js:noInline')
  ...
  @$pb.TagNumber(1)
  set primaryStream($1.ReadStream v) { setField(1, v); }
  @$pb.TagNumber(1)
  ...
  @$pb.TagNumber(2)
  set remainderStream($1.ReadStream v) { setField(2, v); }
  @$pb.TagNumber(2)
...
class CreateWriteStreamRequest extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'CreateWriteStreamRequest', package: const $pb.PackageName(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'google.cloud.bigquery.storage.v1beta2'), createEmptyInstance: create)
    ..aOS(1, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'parent')
    ..aOM<$1.WriteStream>(2, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'writeStream', subBuilder: $1.WriteStream.create)
    ..hasRequiredFields = false
  ;
  ...
  'Use [GeneratedMessageGenericExtensions.rebuild] instead. '
  'Will be removed in next major version')
  CreateWriteStreamRequest copyWith(void Function(CreateWriteStreamRequest) updates) => super.copyWith((message) => updates(message as CreateWriteStreamRequest)) as CreateWriteStreamRequest; // ignore: deprecated_member_use
  $pb.BuilderInfo get info_ => _i;
  @$core.pragma('dart2js:noInline')
  ...
  @$pb.TagNumber(2)
  set writeStream($1.WriteStream v) { setField(2, v); }
  @$pb.TagNumber(2)
...
class AppendRowsRequest_ProtoData extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'AppendRowsRequest.ProtoData', package: const $pb.PackageName(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'google.cloud.bigquery.storage.v1beta2'), createEmptyInstance: create)
    ..aOM<$5.ProtoSchema>(1, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'writerSchema', subBuilder: $5.ProtoSchema.create)
    ..aOM<$5.ProtoRows>(2, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'rows', subBuilder: $5.ProtoRows.create)
  ;
  ...
  'Use [GeneratedMessageGenericExtensions.rebuild] instead. '
  'Will be removed in next major version')
  AppendRowsRequest_ProtoData copyWith(void Function(AppendRowsRequest_ProtoData) updates) => super.copyWith((message) => updates(message as AppendRowsRequest_ProtoData)) as AppendRowsRequest_ProtoData; // ignore: deprecated_member_use
  $pb.BuilderInfo get info_ => _i;
  @$core.pragma('dart2js:noInline')
  ...
  @$pb.TagNumber(1)
  set writerSchema($5.ProtoSchema v) { setField(1, v); }
  @$pb.TagNumber(1)
  ...
  @$pb.TagNumber(2)
  set rows($5.ProtoRows v) { setField(2, v); }
  @$pb.TagNumber(2)
...
class AppendRowsRequest extends $pb.GeneratedMessage {
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'AppendRowsRequest', package: const $pb.PackageName(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'google.cloud.bigquery.storage.v1beta2'), createEmptyInstance: create)
    ..oo(0, [4])
    ..aOS(1, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'writeStream')
    ..aOM<$4.Int64Value>(2, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'offset', subBuilder: $4.Int64Value.create)
    ..aOM<AppendRowsRequest_ProtoData>(4, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'protoRows', subBuilder: AppendRowsRequest_ProtoData.create)
    ..aOS(6, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'traceId')
  ;
  ...
  'Use [GeneratedMessageGenericExtensions.rebuild] instead. '
  'Will be removed in next major version')
  AppendRowsRequest copyWith(void Function(AppendRowsRequest) updates) => super.copyWith((message) => updates(message as AppendRowsRequest)) as AppendRowsRequest; // ignore: deprecated_member_use
  $pb.BuilderInfo get info_ => _i;
  @$core.pragma('dart2js:noInline')
  ...
  @$pb.TagNumber(2)
  set offset($4.Int64Value v) { setField(2, v); }
  @$pb.TagNumber(2)
  $core.bool hasOffset() => $_has(1);
  @$pb.TagNumber(2)
  void clearOffset() => clearField(2);
...
class AppendRowsResponse_AppendResult extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'AppendRowsResponse.AppendResult', package: const $pb.PackageName(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'google.cloud.bigquery.storage.v1beta2'), createEmptyInstance: create)
    ..aOM<$4.Int64Value>(1, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'offset', subBuilder: $4.Int64Value.create)
    ..hasRequiredFields = false
  ;
  ...
  'Use [GeneratedMessageGenericExtensions.rebuild] instead. '
  'Will be removed in next major version')
  AppendRowsResponse_AppendResult copyWith(void Function(AppendRowsResponse_AppendResult) updates) => super.copyWith((message) => updates(message as AppendRowsResponse_AppendResult)) as AppendRowsResponse_AppendResult; // ignore: deprecated_member_use
  $pb.BuilderInfo get info_ => _i;
  @$core.pragma('dart2js:noInline')
  ...
  @$pb.TagNumber(1)
  set offset($4.Int64Value v) { setField(1, v); }
  @$pb.TagNumber(1)
...
class AppendRowsResponse extends $pb.GeneratedMessage {
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'AppendRowsResponse', package: const $pb.PackageName(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'google.cloud.bigquery.storage.v1beta2'), createEmptyInstance: create)
    ..oo(0, [1, 2])
    ..aOM<AppendRowsResponse_AppendResult>(1, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'appendResult', subBuilder: AppendRowsResponse_AppendResult.create)
    ..aOM<$6.Status>(2, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'error', subBuilder: $6.Status.create)
    ..aOM<$7.TableSchema>(3, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'updatedSchema', subBuilder: $7.TableSchema.create)
    ..hasRequiredFields = false
  ;
  ...
  'Use [GeneratedMessageGenericExtensions.rebuild] instead. '
  'Will be removed in next major version')
  AppendRowsResponse copyWith(void Function(AppendRowsResponse) updates) => super.copyWith((message) => updates(message as AppendRowsResponse)) as AppendRowsResponse; // ignore: deprecated_member_use
  $pb.BuilderInfo get info_ => _i;
  @$core.pragma('dart2js:noInline')
  ...
  @$pb.TagNumber(2)
  set error($6.Status v) { setField(2, v); }
  @$pb.TagNumber(2)
  ...
  @$pb.TagNumber(3)
  set updatedSchema($7.TableSchema v) { setField(3, v); }
  @$pb.TagNumber(3)
...
class GetWriteStreamRequest extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'GetWriteStreamRequest', package: const $pb.PackageName(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'google.cloud.bigquery.storage.v1beta2'), createEmptyInstance: create)
    ..aOS(1, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'name')
    ..hasRequiredFields = false
  ;
  ...
  'Use [GeneratedMessageGenericExtensions.rebuild] instead. '
  'Will be removed in next major version')
  GetWriteStreamRequest copyWith(void Function(GetWriteStreamRequest) updates) => super.copyWith((message) => updates(message as GetWriteStreamRequest)) as GetWriteStreamRequest; // ignore: deprecated_member_use
  $pb.BuilderInfo get info_ => _i;
  @$core.pragma('dart2js:noInline')
...
class BatchCommitWriteStreamsRequest extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'BatchCommitWriteStreamsRequest', package: const $pb.PackageName(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'google.cloud.bigquery.storage.v1beta2'), createEmptyInstance: create)
    ..aOS(1, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'parent')
    ..pPS(2, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'writeStreams')
    ..hasRequiredFields = false
  ;
  ...
  'Use [GeneratedMessageGenericExtensions.rebuild] instead. '
  'Will be removed in next major version')
  BatchCommitWriteStreamsRequest copyWith(void Function(BatchCommitWriteStreamsRequest) updates) => super.copyWith((message) => updates(message as BatchCommitWriteStreamsRequest)) as BatchCommitWriteStreamsRequest; // ignore: deprecated_member_use
  $pb.BuilderInfo get info_ => _i;
  @$core.pragma('dart2js:noInline')
...
class BatchCommitWriteStreamsResponse extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'BatchCommitWriteStreamsResponse', package: const $pb.PackageName(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'google.cloud.bigquery.storage.v1beta2'), createEmptyInstance: create)
    ..aOM<$8.Timestamp>(1, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'commitTime', subBuilder: $8.Timestamp.create)
    ..pc<StorageError>(2, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'streamErrors', $pb.PbFieldType.PM, subBuilder: StorageError.create)
    ..hasRequiredFields = false
  ;
  ...
  'Use [GeneratedMessageGenericExtensions.rebuild] instead. '
  'Will be removed in next major version')
  BatchCommitWriteStreamsResponse copyWith(void Function(BatchCommitWriteStreamsResponse) updates) => super.copyWith((message) => updates(message as BatchCommitWriteStreamsResponse)) as BatchCommitWriteStreamsResponse; // ignore: deprecated_member_use
  $pb.BuilderInfo get info_ => _i;
  @$core.pragma('dart2js:noInline')
  ...
  @$pb.TagNumber(1)
  set commitTime($8.Timestamp v) { setField(1, v); }
  @$pb.TagNumber(1)
...
class FinalizeWriteStreamRequest extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'FinalizeWriteStreamRequest', package: const $pb.PackageName(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'google.cloud.bigquery.storage.v1beta2'), createEmptyInstance: create)
    ..aOS(1, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'name')
    ..hasRequiredFields = false
  ;
  ...
  'Use [GeneratedMessageGenericExtensions.rebuild] instead. '
  'Will be removed in next major version')
  FinalizeWriteStreamRequest copyWith(void Function(FinalizeWriteStreamRequest) updates) => super.copyWith((message) => updates(message as FinalizeWriteStreamRequest)) as FinalizeWriteStreamRequest; // ignore: deprecated_member_use
  $pb.BuilderInfo get info_ => _i;
  @$core.pragma('dart2js:noInline')
...
class FinalizeWriteStreamResponse extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'FinalizeWriteStreamResponse', package: const $pb.PackageName(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'google.cloud.bigquery.storage.v1beta2'), createEmptyInstance: create)
    ..aInt64(1, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'rowCount')
    ..hasRequiredFields = false
  ;
  ...
  'Use [GeneratedMessageGenericExtensions.rebuild] instead. '
  'Will be removed in next major version')
  FinalizeWriteStreamResponse copyWith(void Function(FinalizeWriteStreamResponse) updates) => super.copyWith((message) => updates(message as FinalizeWriteStreamResponse)) as FinalizeWriteStreamResponse; // ignore: deprecated_member_use
  $pb.BuilderInfo get info_ => _i;
  @$core.pragma('dart2js:noInline')
...
class FlushRowsRequest extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'FlushRowsRequest', package: const $pb.PackageName(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'google.cloud.bigquery.storage.v1beta2'), createEmptyInstance: create)
    ..aOS(1, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'writeStream')
    ..aOM<$4.Int64Value>(2, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'offset', subBuilder: $4.Int64Value.create)
    ..hasRequiredFields = false
  ;
  ...
  'Use [GeneratedMessageGenericExtensions.rebuild] instead. '
  'Will be removed in next major version')
  FlushRowsRequest copyWith(void Function(FlushRowsRequest) updates) => super.copyWith((message) => updates(message as FlushRowsRequest)) as FlushRowsRequest; // ignore: deprecated_member_use
  $pb.BuilderInfo get info_ => _i;
  @$core.pragma('dart2js:noInline')
...
class FlushRowsResponse extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'FlushRowsResponse', package: const $pb.PackageName(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'google.cloud.bigquery.storage.v1beta2'), createEmptyInstance: create)
  ...
  'Use [GeneratedMessageGenericExtensions.rebuild] instead. '
  'Will be removed in next major version')
  FlushRowsResponse copyWith(void Function(FlushRowsResponse) updates) => super.copyWith((message) => updates(message as FlushRowsResponse)) as FlushRowsResponse; // ignore: deprecated_member_use
  $pb.BuilderInfo get info_ => _i;
  @$core.pragma('dart2js:noInline')
...
class StorageError extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'StorageError', package: const $pb.PackageName(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'google.cloud.bigquery.storage.v1beta2'), createEmptyInstance: create)
    ..e<StorageError_StorageErrorCode>(1, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'code', $pb.PbFieldType.OE, defaultOrMaker: StorageError_StorageErrorCode.STORAGE_ERROR_CODE_UNSPECIFIED, valueOf: StorageError_StorageErrorCode.valueOf, enumValues: StorageError_StorageErrorCode.values)
  ...
  'Use [GeneratedMessageGenericExtensions.rebuild] instead. '
  'Will be removed in next major version')
  StorageError copyWith(void Function(StorageError) updates) => super.copyWith((message) => updates(message as StorageError)) as StorageError; // ignore: deprecated_member_use
  $pb.BuilderInfo get info_ => _i;
  @$core.pragma('dart2js:noInline')

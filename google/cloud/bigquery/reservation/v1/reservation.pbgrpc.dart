...
class ReservationServiceClient extends $grpc.Client {
  ...
  static final _$moveAssignment = $grpc.ClientMethod<$0.MoveAssignmentRequest,
      ...
      ($core.List<$core.int> value) => $0.Assignment.fromBuffer(value));
  static final _$updateAssignment = $grpc.ClientMethod<
          $0.UpdateAssignmentRequest, $0.Assignment>(
      '/google.cloud.bigquery.reservation.v1.ReservationService/UpdateAssignment',
      ($0.UpdateAssignmentRequest value) => value.writeToBuffer(),
      ($core.List<$core.int> value) => $0.Assignment.fromBuffer(value));
  ...
  $grpc.ResponseFuture<$0.Assignment> updateAssignment(
      $0.UpdateAssignmentRequest request,
      {$grpc.CallOptions? options}) {
...
abstract class ReservationServiceBase extends $grpc.Service {
  ...
  ReservationServiceBase() {
    ...
    $addMethod($grpc.ServiceMethod<$0.MoveAssignmentRequest, $0.Assignment>(
        ...
        ($0.Assignment value) => value.writeToBuffer()));
    $addMethod($grpc.ServiceMethod<$0.UpdateAssignmentRequest, $0.Assignment>(
        'UpdateAssignment',
        updateAssignment_Pre,
        false,
        false,
        ($core.List<$core.int> value) =>
            $0.UpdateAssignmentRequest.fromBuffer(value),
        ($0.Assignment value) => value.writeToBuffer()));
    $addMethod(
  ...
  $async.Future<$0.Assignment> updateAssignment_Pre($grpc.ServiceCall call,
      $async.Future<$0.UpdateAssignmentRequest> request) async {
  ...
  $async.Future<$0.Assignment> updateAssignment(
      $grpc.ServiceCall call, $0.UpdateAssignmentRequest request);

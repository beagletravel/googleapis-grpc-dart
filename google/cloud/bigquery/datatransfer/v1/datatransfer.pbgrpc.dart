...
class DataTransferServiceClient extends $grpc.Client {
  ...
  static final _$enrollDataSources = $grpc.ClientMethod<
          $0.EnrollDataSourcesRequest, $2.Empty>(
      '/google.cloud.bigquery.datatransfer.v1.DataTransferService/EnrollDataSources',
      ($0.EnrollDataSourcesRequest value) => value.writeToBuffer(),
      ($core.List<$core.int> value) => $2.Empty.fromBuffer(value));
  ...
  $grpc.ResponseFuture<$0.StartManualTransferRunsResponse>
      startManualTransferRuns($0.StartManualTransferRunsRequest request,
          {$grpc.CallOptions? options}) {
    return $createUnaryCall(_$startManualTransferRuns, request,
        options: options);
  }
  ...
  $grpc.ResponseFuture<$2.Empty> enrollDataSources(
      $0.EnrollDataSourcesRequest request,
      {$grpc.CallOptions? options}) {
...
abstract class DataTransferServiceBase extends $grpc.Service {
  ...
  DataTransferServiceBase() {
    ...
    $addMethod($grpc.ServiceMethod<$0.EnrollDataSourcesRequest, $2.Empty>(
        'EnrollDataSources',
        enrollDataSources_Pre,
        false,
        false,
        ($core.List<$core.int> value) =>
            $0.EnrollDataSourcesRequest.fromBuffer(value),
        ($2.Empty value) => value.writeToBuffer()));
  }
  ...
  $async.Future<$2.Empty> enrollDataSources_Pre($grpc.ServiceCall call,
      $async.Future<$0.EnrollDataSourcesRequest> request) async {
  ...
  $async.Future<$2.Empty> enrollDataSources(
      $grpc.ServiceCall call, $0.EnrollDataSourcesRequest request);
}

...
class EmailPreferences extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'EmailPreferences', package: const $pb.PackageName(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'google.cloud.bigquery.datatransfer.v1'), createEmptyInstance: create)
    ..aOB(1, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'enableFailureEmail')
  ...
  'Will be removed in next major version')
  EmailPreferences copyWith(void Function(EmailPreferences) updates) => super.copyWith((message) => updates(message as EmailPreferences)) as EmailPreferences; // ignore: deprecated_member_use
...
class ScheduleOptions extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'ScheduleOptions', package: const $pb.PackageName(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'google.cloud.bigquery.datatransfer.v1'), createEmptyInstance: create)
    ...
    ..aOB(3, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'disableAutoScheduling')
    ..hasRequiredFields = false
  ;
  ...
  'Use [GeneratedMessageGenericExtensions.rebuild] instead. '
  'Will be removed in next major version')
  ScheduleOptions copyWith(void Function(ScheduleOptions) updates) => super.copyWith((message) => updates(message as ScheduleOptions)) as ScheduleOptions; // ignore: deprecated_member_use
  $pb.BuilderInfo get info_ => _i;
  @$core.pragma('dart2js:noInline')
...
class UserInfo extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'UserInfo', package: const $pb.PackageName(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'google.cloud.bigquery.datatransfer.v1'), createEmptyInstance: create)
...
class TransferConfig extends $pb.GeneratedMessage {
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'TransferConfig', package: const $pb.PackageName(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'google.cloud.bigquery.datatransfer.v1'), createEmptyInstance: create)
    ..oo(0, [2])
    ..aOS(1, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'name')
    ..aOS(2, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'destinationDatasetId')
    ...
    ..aOS(5, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'dataSourceId')
    ..aOS(7, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'schedule')
    ..aOM<$0.Timestamp>(8, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'nextRunTime', subBuilder: $0.Timestamp.create)
    ..aOM<$1.Struct>(9, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'params', subBuilder: $1.Struct.create)
    ..e<TransferState>(10, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'state', $pb.PbFieldType.OE, defaultOrMaker: TransferState.TRANSFER_STATE_UNSPECIFIED, valueOf: TransferState.valueOf, enumValues: TransferState.values)
    ..aInt64(11, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'userId')
    ..a<$core.int>(12, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'dataRefreshWindowDays', $pb.PbFieldType.O3)
    ..aOB(13, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'disabled')
    ..aOS(14, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'datasetRegion')
    ..aOS(15, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'notificationPubsubTopic')
    ..aOM<EmailPreferences>(18, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'emailPreferences', subBuilder: EmailPreferences.create)
    ..aOM<ScheduleOptions>(24, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'scheduleOptions', subBuilder: ScheduleOptions.create)
    ..aOM<UserInfo>(27, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'ownerInfo', subBuilder: UserInfo.create)
    ..hasRequiredFields = false
  ;
  ...
  'Use [GeneratedMessageGenericExtensions.rebuild] instead. '
  'Will be removed in next major version')
  TransferConfig copyWith(void Function(TransferConfig) updates) => super.copyWith((message) => updates(message as TransferConfig)) as TransferConfig; // ignore: deprecated_member_use
  $pb.BuilderInfo get info_ => _i;
  @$core.pragma('dart2js:noInline')
  ...
  @$pb.TagNumber(8)
  set nextRunTime($0.Timestamp v) { setField(8, v); }
  @$pb.TagNumber(8)
  ...
  @$pb.TagNumber(9)
  set params($1.Struct v) { setField(9, v); }
  @$pb.TagNumber(9)
...
class TransferRun extends $pb.GeneratedMessage {
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'TransferRun', package: const $pb.PackageName(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'google.cloud.bigquery.datatransfer.v1'), createEmptyInstance: create)
    ..oo(0, [2])
    ..aOS(1, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'name')
    ..aOS(2, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'destinationDatasetId')
    ..aOM<$0.Timestamp>(3, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'scheduleTime', subBuilder: $0.Timestamp.create)
    ...
    ..aOS(7, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'dataSourceId')
    ..e<TransferState>(8, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'state', $pb.PbFieldType.OE, defaultOrMaker: TransferState.TRANSFER_STATE_UNSPECIFIED, valueOf: TransferState.valueOf, enumValues: TransferState.values)
    ..aOM<$1.Struct>(9, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'params', subBuilder: $1.Struct.create)
    ..aOM<$0.Timestamp>(10, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'runTime', subBuilder: $0.Timestamp.create)
    ..aInt64(11, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'userId')
    ..aOS(12, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'schedule')
    ..aOM<$2.Status>(21, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'errorStatus', subBuilder: $2.Status.create)
    ..aOS(23, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'notificationPubsubTopic')
    ..aOM<EmailPreferences>(25, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'emailPreferences', subBuilder: EmailPreferences.create)
    ..hasRequiredFields = false
  ;
  ...
  'Use [GeneratedMessageGenericExtensions.rebuild] instead. '
  'Will be removed in next major version')
  TransferRun copyWith(void Function(TransferRun) updates) => super.copyWith((message) => updates(message as TransferRun)) as TransferRun; // ignore: deprecated_member_use
  $pb.BuilderInfo get info_ => _i;
  @$core.pragma('dart2js:noInline')
  ...
  @$pb.TagNumber(3)
  set scheduleTime($0.Timestamp v) { setField(3, v); }
  @$pb.TagNumber(3)
  ...
  @$pb.TagNumber(10)
  set runTime($0.Timestamp v) { setField(10, v); }
  @$pb.TagNumber(10)
  ...
  @$pb.TagNumber(21)
  set errorStatus($2.Status v) { setField(21, v); }
  @$pb.TagNumber(21)
...
class TransferMessage extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'TransferMessage', package: const $pb.PackageName(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'google.cloud.bigquery.datatransfer.v1'), createEmptyInstance: create)
    ..aOM<$0.Timestamp>(1, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'messageTime', subBuilder: $0.Timestamp.create)
    ..e<TransferMessage_MessageSeverity>(2, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'severity', $pb.PbFieldType.OE, defaultOrMaker: TransferMessage_MessageSeverity.MESSAGE_SEVERITY_UNSPECIFIED, valueOf: TransferMessage_MessageSeverity.valueOf, enumValues: TransferMessage_MessageSeverity.values)
  ...
  @$pb.TagNumber(1)
  set messageTime($0.Timestamp v) { setField(1, v); }
  @$pb.TagNumber(1)

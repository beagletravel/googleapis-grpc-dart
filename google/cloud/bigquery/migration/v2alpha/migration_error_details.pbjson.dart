...
const ResourceErrorDetail$json = const {
  ...
  '2': const [
    ...
    const {'1': 'error_details', '3': 2, '4': 3, '5': 11, '6': '.google.cloud.bigquery.migration.v2alpha.ErrorDetail', '8': const {}, '10': 'errorDetails'},
...
final $typed_data.Uint8List resourceErrorDetailDescriptor = $convert.base64Decode('');
@$core.Deprecated('Use errorDetailDescriptor instead')
const ErrorDetail$json = const {
  '1': 'ErrorDetail',
  '2': const [
    const {'1': 'location', '3': 1, '4': 1, '5': 11, '6': '.google.cloud.bigquery.migration.v2alpha.ErrorLocation', '8': const {}, '10': 'location'},
...
final $typed_data.Uint8List errorDetailDescriptor = $convert.base64Decode('CgtFcnJvckRldGFpbBJXCghsb2NhdGlvbhgBIAEoCzI2Lmdvb2dsZS5jbG91ZC5iaWdxdWVyeS5taWdyYXRpb24udjJhbHBoYS5FcnJvckxvY2F0aW9uQgPgQQFSCGxvY2F0aW9uEjkKCmVycm9yX2luZm8YAiABKAsyFS5nb29nbGUucnBjLkVycm9ySW5mb0ID4EECUgllcnJvckluZm8=');

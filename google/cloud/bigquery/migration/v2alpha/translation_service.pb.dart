...
class TranslateQueryRequest extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'TranslateQueryRequest', package: const $pb.PackageName(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'google.cloud.bigquery.migration.v2alpha'), createEmptyInstance: create)
    ..aOS(1, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'parent')
    ..e<TranslateQueryRequest_SqlTranslationSourceDialect>(2, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'sourceDialect', $pb.PbFieldType.OE, defaultOrMaker: TranslateQueryRequest_SqlTranslationSourceDialect.SQL_TRANSLATION_SOURCE_DIALECT_UNSPECIFIED, valueOf: TranslateQueryRequest_SqlTranslationSourceDialect.valueOf, enumValues: TranslateQueryRequest_SqlTranslationSourceDialect.values)
  ...
  'Will be removed in next major version')
  TranslateQueryRequest copyWith(void Function(TranslateQueryRequest) updates) => super.copyWith((message) => updates(message as TranslateQueryRequest)) as TranslateQueryRequest; // ignore: deprecated_member_use
...
class TranslateQueryResponse extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'TranslateQueryResponse', package: const $pb.PackageName(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'google.cloud.bigquery.migration.v2alpha'), createEmptyInstance: create)
    ..aOS(1, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'translatedQuery')
    ..pc<SqlTranslationError>(2, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'errors', $pb.PbFieldType.PM, subBuilder: SqlTranslationError.create)
    ..pc<SqlTranslationWarning>(3, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'warnings', $pb.PbFieldType.PM, subBuilder: SqlTranslationWarning.create)
    ..aOS(4, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'translationJob')
    ..hasRequiredFields = false
  ;
  ...
  factory TranslateQueryResponse({
    ...
    if (translationJob != null) {
      _result.translationJob = translationJob;
    }
    return _result;
  }
  ...
  'Use [GeneratedMessageGenericExtensions.rebuild] instead. '
  'Will be removed in next major version')
  TranslateQueryResponse copyWith(void Function(TranslateQueryResponse) updates) => super.copyWith((message) => updates(message as TranslateQueryResponse)) as TranslateQueryResponse; // ignore: deprecated_member_use
  $pb.BuilderInfo get info_ => _i;
  @$core.pragma('dart2js:noInline')
...
class SqlTranslationErrorDetail extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'SqlTranslationErrorDetail', package: const $pb.PackageName(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'google.cloud.bigquery.migration.v2alpha'), createEmptyInstance: create)
    ..aInt64(1, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'row')
  ...
  'Use [GeneratedMessageGenericExtensions.rebuild] instead. '
  'Will be removed in next major version')
  SqlTranslationErrorDetail copyWith(void Function(SqlTranslationErrorDetail) updates) => super.copyWith((message) => updates(message as SqlTranslationErrorDetail)) as SqlTranslationErrorDetail; // ignore: deprecated_member_use
  $pb.BuilderInfo get info_ => _i;
  @$core.pragma('dart2js:noInline')
...
class SqlTranslationError extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'SqlTranslationError', package: const $pb.PackageName(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'google.cloud.bigquery.migration.v2alpha'), createEmptyInstance: create)
    ..e<SqlTranslationError_SqlTranslationErrorType>(1, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'errorType', $pb.PbFieldType.OE, defaultOrMaker: SqlTranslationError_SqlTranslationErrorType.SQL_TRANSLATION_ERROR_TYPE_UNSPECIFIED, valueOf: SqlTranslationError_SqlTranslationErrorType.valueOf, enumValues: SqlTranslationError_SqlTranslationErrorType.values)
    ..aOM<SqlTranslationErrorDetail>(2, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'errorDetail', subBuilder: SqlTranslationErrorDetail.create)
    ..hasRequiredFields = false
  ;
  ...
  'Use [GeneratedMessageGenericExtensions.rebuild] instead. '
  'Will be removed in next major version')
  SqlTranslationError copyWith(void Function(SqlTranslationError) updates) => super.copyWith((message) => updates(message as SqlTranslationError)) as SqlTranslationError; // ignore: deprecated_member_use
  $pb.BuilderInfo get info_ => _i;
  @$core.pragma('dart2js:noInline')
...
class SqlTranslationWarning extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'SqlTranslationWarning', package: const $pb.PackageName(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'google.cloud.bigquery.migration.v2alpha'), createEmptyInstance: create)
    ..aOM<SqlTranslationErrorDetail>(1, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'warningDetail', subBuilder: SqlTranslationErrorDetail.create)
    ..hasRequiredFields = false
  ;
  ...
  'Use [GeneratedMessageGenericExtensions.rebuild] instead. '
  'Will be removed in next major version')
  SqlTranslationWarning copyWith(void Function(SqlTranslationWarning) updates) => super.copyWith((message) => updates(message as SqlTranslationWarning)) as SqlTranslationWarning; // ignore: deprecated_member_use
  $pb.BuilderInfo get info_ => _i;
  @$core.pragma('dart2js:noInline')

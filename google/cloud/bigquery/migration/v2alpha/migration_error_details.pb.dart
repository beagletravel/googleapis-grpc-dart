...
class ResourceErrorDetail extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'ResourceErrorDetail', package: const $pb.PackageName(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'google.cloud.bigquery.migration.v2alpha'), createEmptyInstance: create)
    ..aOM<$0.ResourceInfo>(1, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'resourceInfo', subBuilder: $0.ResourceInfo.create)
    ..pc<ErrorDetail>(2, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'errorDetails', $pb.PbFieldType.PM, subBuilder: ErrorDetail.create)
    ..a<$core.int>(3, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'errorCount', $pb.PbFieldType.O3)
  ...
  'Will be removed in next major version')
  ResourceErrorDetail copyWith(void Function(ResourceErrorDetail) updates) => super.copyWith((message) => updates(message as ResourceErrorDetail)) as ResourceErrorDetail; // ignore: deprecated_member_use
  ...
  @$pb.TagNumber(1)
  set resourceInfo($0.ResourceInfo v) { setField(1, v); }
  @$pb.TagNumber(1)
...
class ErrorDetail extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'ErrorDetail', package: const $pb.PackageName(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'google.cloud.bigquery.migration.v2alpha'), createEmptyInstance: create)
    ..aOM<ErrorLocation>(1, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'location', subBuilder: ErrorLocation.create)
    ..aOM<$0.ErrorInfo>(2, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'errorInfo', subBuilder: $0.ErrorInfo.create)
    ..hasRequiredFields = false
  ;
  ...
  @$pb.TagNumber(2)
  set errorInfo($0.ErrorInfo v) { setField(2, v); }
  @$pb.TagNumber(2)
...
class ErrorLocation extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'ErrorLocation', package: const $pb.PackageName(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'google.cloud.bigquery.migration.v2alpha'), createEmptyInstance: create)

...
class TranslateQueryRequest_SqlTranslationSourceDialect extends $pb.ProtobufEnum {
  static const TranslateQueryRequest_SqlTranslationSourceDialect SQL_TRANSLATION_SOURCE_DIALECT_UNSPECIFIED = TranslateQueryRequest_SqlTranslationSourceDialect._(0, const $core.bool.fromEnvironment('protobuf.omit_enum_names') ? '' : 'SQL_TRANSLATION_SOURCE_DIALECT_UNSPECIFIED');
  static const TranslateQueryRequest_SqlTranslationSourceDialect TERADATA = TranslateQueryRequest_SqlTranslationSourceDialect._(1, const $core.bool.fromEnvironment('protobuf.omit_enum_names') ? '' : 'TERADATA');
...
class SqlTranslationError_SqlTranslationErrorType extends $pb.ProtobufEnum {
  static const SqlTranslationError_SqlTranslationErrorType SQL_TRANSLATION_ERROR_TYPE_UNSPECIFIED = SqlTranslationError_SqlTranslationErrorType._(0, const $core.bool.fromEnvironment('protobuf.omit_enum_names') ? '' : 'SQL_TRANSLATION_ERROR_TYPE_UNSPECIFIED');
  static const SqlTranslationError_SqlTranslationErrorType SQL_PARSE_ERROR = SqlTranslationError_SqlTranslationErrorType._(1, const $core.bool.fromEnvironment('protobuf.omit_enum_names') ? '' : 'SQL_PARSE_ERROR');
  static const SqlTranslationError_SqlTranslationErrorType UNSUPPORTED_SQL_FUNCTION = SqlTranslationError_SqlTranslationErrorType._(2, const $core.bool.fromEnvironment('protobuf.omit_enum_names') ? '' : 'UNSUPPORTED_SQL_FUNCTION');

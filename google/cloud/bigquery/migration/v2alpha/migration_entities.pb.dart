...
import 'assessment_task.pb.dart' as $3;
import 'translation_task.pb.dart' as $4;
import 'migration_metrics.pb.dart' as $5;
import 'migration_error_details.pb.dart' as $6;
...
class MigrationWorkflow extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'MigrationWorkflow', package: const $pb.PackageName(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'google.cloud.bigquery.migration.v2alpha'), createEmptyInstance: create)
    ..aOS(1, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'name')
    ..m<$core.String, MigrationTask>(2, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'tasks', entryClassName: 'MigrationWorkflow.TasksEntry', keyFieldType: $pb.PbFieldType.OS, valueFieldType: $pb.PbFieldType.OM, valueCreator: MigrationTask.create, packageName: const $pb.PackageName('google.cloud.bigquery.migration.v2alpha'))
    ..e<MigrationWorkflow_State>(3, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'state', $pb.PbFieldType.OE, defaultOrMaker: MigrationWorkflow_State.STATE_UNSPECIFIED, valueOf: MigrationWorkflow_State.valueOf, enumValues: MigrationWorkflow_State.values)
    ..aOM<$0.Timestamp>(4, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'createTime', subBuilder: $0.Timestamp.create)
    ..aOM<$0.Timestamp>(5, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'lastUpdateTime', subBuilder: $0.Timestamp.create)
  ...
  'Will be removed in next major version')
  MigrationWorkflow copyWith(void Function(MigrationWorkflow) updates) => super.copyWith((message) => updates(message as MigrationWorkflow)) as MigrationWorkflow; // ignore: deprecated_member_use
  ...
  @$pb.TagNumber(5)
  set lastUpdateTime($0.Timestamp v) { setField(5, v); }
  @$pb.TagNumber(5)
...
class MigrationTask extends $pb.GeneratedMessage {
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'MigrationTask', package: const $pb.PackageName(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'google.cloud.bigquery.migration.v2alpha'), createEmptyInstance: create)
    ..oo(0, [12, 13])
    ...
    ..e<MigrationTask_State>(4, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'state', $pb.PbFieldType.OE, defaultOrMaker: MigrationTask_State.STATE_UNSPECIFIED, valueOf: MigrationTask_State.valueOf, enumValues: MigrationTask_State.values)
    ..aOM<$2.ErrorInfo>(5, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'processingError', subBuilder: $2.ErrorInfo.create)
    ..aOM<$0.Timestamp>(6, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'createTime', subBuilder: $0.Timestamp.create)
    ..aOM<$0.Timestamp>(7, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'lastUpdateTime', subBuilder: $0.Timestamp.create)
    ..aOM<MigrationTaskOrchestrationResult>(10, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'orchestrationResult', subBuilder: MigrationTaskOrchestrationResult.create)
    ..aOM<$3.AssessmentTaskDetails>(12, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'assessmentTaskDetails', subBuilder: $3.AssessmentTaskDetails.create)
    ..aOM<$4.TranslationTaskDetails>(13, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'translationTaskDetails', subBuilder: $4.TranslationTaskDetails.create)
    ..hasRequiredFields = false
  ;
  ...
  factory MigrationTask({
    ...
    $3.AssessmentTaskDetails? assessmentTaskDetails,
    $4.TranslationTaskDetails? translationTaskDetails,
  }) {
    final _result = create();
    if (id != null) {
      _result.id = id;
    ...
    if (orchestrationResult != null) {
      _result.orchestrationResult = orchestrationResult;
    }
    if (assessmentTaskDetails != null) {
      _result.assessmentTaskDetails = assessmentTaskDetails;
    }
    if (translationTaskDetails != null) {
      _result.translationTaskDetails = translationTaskDetails;
    }
    return _result;
  }
  ...
  'Use [GeneratedMessageGenericExtensions.rebuild] instead. '
  'Will be removed in next major version')
  MigrationTask copyWith(void Function(MigrationTask) updates) => super.copyWith((message) => updates(message as MigrationTask)) as MigrationTask; // ignore: deprecated_member_use
  $pb.BuilderInfo get info_ => _i;
  @$core.pragma('dart2js:noInline')
  ...
  @$pb.TagNumber(5)
  set processingError($2.ErrorInfo v) { setField(5, v); }
  @$pb.TagNumber(5)
  ...
  @$pb.TagNumber(7)
  set lastUpdateTime($0.Timestamp v) { setField(7, v); }
  @$pb.TagNumber(7)
  ...
  @$pb.TagNumber(12)
  $3.AssessmentTaskDetails get assessmentTaskDetails => $_getN(8);
  @$pb.TagNumber(12)
  set assessmentTaskDetails($3.AssessmentTaskDetails v) { setField(12, v); }
  @$pb.TagNumber(12)
  $core.bool hasAssessmentTaskDetails() => $_has(8);
  @$pb.TagNumber(12)
  void clearAssessmentTaskDetails() => clearField(12);
  @$pb.TagNumber(12)
  $3.AssessmentTaskDetails ensureAssessmentTaskDetails() => $_ensure(8);

  @$pb.TagNumber(13)
  $4.TranslationTaskDetails get translationTaskDetails => $_getN(9);
  @$pb.TagNumber(13)
  set translationTaskDetails($4.TranslationTaskDetails v) { setField(13, v); }
  @$pb.TagNumber(13)
  $core.bool hasTranslationTaskDetails() => $_has(9);
  @$pb.TagNumber(13)
  void clearTranslationTaskDetails() => clearField(13);
  @$pb.TagNumber(13)
  $4.TranslationTaskDetails ensureTranslationTaskDetails() => $_ensure(9);
}

class MigrationSubtask extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'MigrationSubtask', package: const $pb.PackageName(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'google.cloud.bigquery.migration.v2alpha'), createEmptyInstance: create)
    ..aOS(1, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'name')
    ...
    ..e<MigrationSubtask_State>(5, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'state', $pb.PbFieldType.OE, defaultOrMaker: MigrationSubtask_State.STATE_UNSPECIFIED, valueOf: MigrationSubtask_State.valueOf, enumValues: MigrationSubtask_State.values)
    ..aOM<$2.ErrorInfo>(6, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'processingError', subBuilder: $2.ErrorInfo.create)
    ..aOM<$0.Timestamp>(7, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'createTime', subBuilder: $0.Timestamp.create)
    ..aOM<$0.Timestamp>(8, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'lastUpdateTime', subBuilder: $0.Timestamp.create)
    ..pc<$5.TimeSeries>(11, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'metrics', $pb.PbFieldType.PM, subBuilder: $5.TimeSeries.create)
    ..pc<$6.ResourceErrorDetail>(12, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'resourceErrorDetails', $pb.PbFieldType.PM, subBuilder: $6.ResourceErrorDetail.create)
    ..a<$core.int>(13, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'resourceErrorCount', $pb.PbFieldType.O3)
    ..hasRequiredFields = false
  ;
  ...
  factory MigrationSubtask({
    ...
    $0.Timestamp? createTime,
    $0.Timestamp? lastUpdateTime,
    $core.Iterable<$5.TimeSeries>? metrics,
    $core.Iterable<$6.ResourceErrorDetail>? resourceErrorDetails,
  ...
  'Use [GeneratedMessageGenericExtensions.rebuild] instead. '
  'Will be removed in next major version')
  MigrationSubtask copyWith(void Function(MigrationSubtask) updates) => super.copyWith((message) => updates(message as MigrationSubtask)) as MigrationSubtask; // ignore: deprecated_member_use
  $pb.BuilderInfo get info_ => _i;
  @$core.pragma('dart2js:noInline')
  ...
  $2.ErrorInfo get processingError => $_getN(4);
  @$pb.TagNumber(6)
  set processingError($2.ErrorInfo v) { setField(6, v); }
  @$pb.TagNumber(6)
  $core.bool hasProcessingError() => $_has(4);
  @$pb.TagNumber(6)
  ...
  $0.Timestamp get lastUpdateTime => $_getN(6);
  @$pb.TagNumber(8)
  set lastUpdateTime($0.Timestamp v) { setField(8, v); }
  @$pb.TagNumber(8)
  $core.bool hasLastUpdateTime() => $_has(6);
  @$pb.TagNumber(8)
  ...
  @$pb.TagNumber(11)
  $core.List<$5.TimeSeries> get metrics => $_getList(7);

  @$pb.TagNumber(12)
  $core.List<$6.ResourceErrorDetail> get resourceErrorDetails => $_getList(8);
...
class MigrationTaskOrchestrationResult extends $pb.GeneratedMessage {
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'MigrationTaskOrchestrationResult', package: const $pb.PackageName(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'google.cloud.bigquery.migration.v2alpha'), createEmptyInstance: create)
    ..oo(0, [1])
    ..aOM<$3.AssessmentOrchestrationResultDetails>(1, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'assessmentDetails', subBuilder: $3.AssessmentOrchestrationResultDetails.create)
    ..hasRequiredFields = false
  ;

  MigrationTaskOrchestrationResult._() : super();
  factory MigrationTaskOrchestrationResult({
    $3.AssessmentOrchestrationResultDetails? assessmentDetails,
  }) {
    final _result = create();
    if (assessmentDetails != null) {
      _result.assessmentDetails = assessmentDetails;
    }
    return _result;
  }
  ...
  'Use [GeneratedMessageGenericExtensions.rebuild] instead. '
  'Will be removed in next major version')
  MigrationTaskOrchestrationResult copyWith(void Function(MigrationTaskOrchestrationResult) updates) => super.copyWith((message) => updates(message as MigrationTaskOrchestrationResult)) as MigrationTaskOrchestrationResult; // ignore: deprecated_member_use
  $pb.BuilderInfo get info_ => _i;
  @$core.pragma('dart2js:noInline')
  ...
  @$pb.TagNumber(1)
  $3.AssessmentOrchestrationResultDetails get assessmentDetails => $_getN(0);
  @$pb.TagNumber(1)
  set assessmentDetails($3.AssessmentOrchestrationResultDetails v) { setField(1, v); }
  @$pb.TagNumber(1)
  $core.bool hasAssessmentDetails() => $_has(0);
  @$pb.TagNumber(1)
  void clearAssessmentDetails() => clearField(1);
  @$pb.TagNumber(1)
  $3.AssessmentOrchestrationResultDetails ensureAssessmentDetails() => $_ensure(0);
}

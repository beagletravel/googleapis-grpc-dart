...
class TranslationFileMapping extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'TranslationFileMapping', package: const $pb.PackageName(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'google.cloud.bigquery.migration.v2alpha'), createEmptyInstance: create)
    ..aOS(1, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'inputPath')
    ..aOS(2, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'outputPath')
  ...
  'Will be removed in next major version')
  TranslationFileMapping copyWith(void Function(TranslationFileMapping) updates) => super.copyWith((message) => updates(message as TranslationFileMapping)) as TranslationFileMapping; // ignore: deprecated_member_use
...
class TranslationTaskDetails extends $pb.GeneratedMessage {
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'TranslationTaskDetails', package: const $pb.PackageName(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'google.cloud.bigquery.migration.v2alpha'), createEmptyInstance: create)
    ..oo(0, [10, 11])
    ..aOS(1, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'inputPath')
    ..aOS(2, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'outputPath')
    ..aOS(3, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'schemaPath')
    ..e<TranslationTaskDetails_FileEncoding>(4, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'fileEncoding', $pb.PbFieldType.OE, defaultOrMaker: TranslationTaskDetails_FileEncoding.FILE_ENCODING_UNSPECIFIED, valueOf: TranslationTaskDetails_FileEncoding.valueOf, enumValues: TranslationTaskDetails_FileEncoding.values)
    ..aOM<IdentifierSettings>(5, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'identifierSettings', subBuilder: IdentifierSettings.create)
    ..m<$core.String, TranslationTaskDetails_TokenType>(6, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'specialTokenMap', entryClassName: 'TranslationTaskDetails.SpecialTokenMapEntry', keyFieldType: $pb.PbFieldType.OS, valueFieldType: $pb.PbFieldType.OE, valueOf: TranslationTaskDetails_TokenType.valueOf, enumValues: TranslationTaskDetails_TokenType.values, packageName: const $pb.PackageName('google.cloud.bigquery.migration.v2alpha'))
    ..aOM<Filter>(7, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'filter', subBuilder: Filter.create)
    ..aOM<TeradataOptions>(10, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'teradataOptions', subBuilder: TeradataOptions.create)
    ..aOM<BteqOptions>(11, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'bteqOptions', subBuilder: BteqOptions.create)
    ..pc<TranslationFileMapping>(12, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'filePaths', $pb.PbFieldType.PM, subBuilder: TranslationFileMapping.create)
    ..aOS(13, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'translationExceptionTable')
    ..hasRequiredFields = false
  ;
  ...
  'Use [GeneratedMessageGenericExtensions.rebuild] instead. '
  'Will be removed in next major version')
  TranslationTaskDetails copyWith(void Function(TranslationTaskDetails) updates) => super.copyWith((message) => updates(message as TranslationTaskDetails)) as TranslationTaskDetails; // ignore: deprecated_member_use
  $pb.BuilderInfo get info_ => _i;
  @$core.pragma('dart2js:noInline')
...
class Filter extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'Filter', package: const $pb.PackageName(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'google.cloud.bigquery.migration.v2alpha'), createEmptyInstance: create)
    ..pPS(1, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'inputFileExclusionPrefixes')
    ..hasRequiredFields = false
  ;
...
class IdentifierSettings extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'IdentifierSettings', package: const $pb.PackageName(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'google.cloud.bigquery.migration.v2alpha'), createEmptyInstance: create)
    ..e<IdentifierSettings_IdentifierCase>(1, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'outputIdentifierCase', $pb.PbFieldType.OE, defaultOrMaker: IdentifierSettings_IdentifierCase.IDENTIFIER_CASE_UNSPECIFIED, valueOf: IdentifierSettings_IdentifierCase.valueOf, enumValues: IdentifierSettings_IdentifierCase.values)
    ..e<IdentifierSettings_IdentifierRewriteMode>(2, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'identifierRewriteMode', $pb.PbFieldType.OE, defaultOrMaker: IdentifierSettings_IdentifierRewriteMode.IDENTIFIER_REWRITE_MODE_UNSPECIFIED, valueOf: IdentifierSettings_IdentifierRewriteMode.valueOf, enumValues: IdentifierSettings_IdentifierRewriteMode.values)
    ..hasRequiredFields = false
  ;
  ...
  'Use [GeneratedMessageGenericExtensions.rebuild] instead. '
  'Will be removed in next major version')
  IdentifierSettings copyWith(void Function(IdentifierSettings) updates) => super.copyWith((message) => updates(message as IdentifierSettings)) as IdentifierSettings; // ignore: deprecated_member_use
  $pb.BuilderInfo get info_ => _i;
  @$core.pragma('dart2js:noInline')
...
class TeradataOptions extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'TeradataOptions', package: const $pb.PackageName(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'google.cloud.bigquery.migration.v2alpha'), createEmptyInstance: create)
    ..hasRequiredFields = false
  ;
  ...
  'Use [GeneratedMessageGenericExtensions.rebuild] instead. '
  'Will be removed in next major version')
  TeradataOptions copyWith(void Function(TeradataOptions) updates) => super.copyWith((message) => updates(message as TeradataOptions)) as TeradataOptions; // ignore: deprecated_member_use
  $pb.BuilderInfo get info_ => _i;
  @$core.pragma('dart2js:noInline')
...
class BteqOptions extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'BteqOptions', package: const $pb.PackageName(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'google.cloud.bigquery.migration.v2alpha'), createEmptyInstance: create)
    ..aOM<DatasetReference>(1, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'projectDataset', subBuilder: DatasetReference.create)
    ..aOS(2, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'defaultPathUri')
    ..m<$core.String, $core.String>(3, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'fileReplacementMap', entryClassName: 'BteqOptions.FileReplacementMapEntry', keyFieldType: $pb.PbFieldType.OS, valueFieldType: $pb.PbFieldType.OS, packageName: const $pb.PackageName('google.cloud.bigquery.migration.v2alpha'))
    ..hasRequiredFields = false
  ;
  ...
  'Use [GeneratedMessageGenericExtensions.rebuild] instead. '
  'Will be removed in next major version')
  BteqOptions copyWith(void Function(BteqOptions) updates) => super.copyWith((message) => updates(message as BteqOptions)) as BteqOptions; // ignore: deprecated_member_use
  $pb.BuilderInfo get info_ => _i;
  @$core.pragma('dart2js:noInline')
...
class DatasetReference extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'DatasetReference', package: const $pb.PackageName(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'google.cloud.bigquery.migration.v2alpha'), createEmptyInstance: create)
  ...
  'Use [GeneratedMessageGenericExtensions.rebuild] instead. '
  'Will be removed in next major version')
  DatasetReference copyWith(void Function(DatasetReference) updates) => super.copyWith((message) => updates(message as DatasetReference)) as DatasetReference; // ignore: deprecated_member_use
  $pb.BuilderInfo get info_ => _i;
  @$core.pragma('dart2js:noInline')

...
import '../../../../rpc/error_details.pb.dart' as $1;
import 'translation_config.pb.dart' as $2;
...
class MigrationWorkflow extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'MigrationWorkflow', package: const $pb.PackageName(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'google.cloud.bigquery.migration.v2'), createEmptyInstance: create)
...
class MigrationTask extends $pb.GeneratedMessage {
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'MigrationTask', package: const $pb.PackageName(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'google.cloud.bigquery.migration.v2'), createEmptyInstance: create)
    ..oo(0, [14])
    ...
    ..aOM<$1.ErrorInfo>(5, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'processingError', subBuilder: $1.ErrorInfo.create)
    ...
    ..aOM<$2.TranslationConfigDetails>(14, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'translationConfigDetails', subBuilder: $2.TranslationConfigDetails.create)
    ..hasRequiredFields = false
  ;
  ...
  factory MigrationTask({
    ...
    $1.ErrorInfo? processingError,
    $0.Timestamp? createTime,
    $0.Timestamp? lastUpdateTime,
    $2.TranslationConfigDetails? translationConfigDetails,
  }) {
    final _result = create();
    if (id != null) {
      _result.id = id;
    ...
    if (translationConfigDetails != null) {
      _result.translationConfigDetails = translationConfigDetails;
    }
    return _result;
  }
  ...
  @$pb.TagNumber(5)
  $1.ErrorInfo get processingError => $_getN(3);
  @$pb.TagNumber(5)
  set processingError($1.ErrorInfo v) { setField(5, v); }
  @$pb.TagNumber(5)
  $core.bool hasProcessingError() => $_has(3);
  @$pb.TagNumber(5)
  void clearProcessingError() => clearField(5);
  @$pb.TagNumber(5)
  $1.ErrorInfo ensureProcessingError() => $_ensure(3);
  ...
  @$pb.TagNumber(14)
  $2.TranslationConfigDetails get translationConfigDetails => $_getN(6);
  @$pb.TagNumber(14)
  set translationConfigDetails($2.TranslationConfigDetails v) { setField(14, v); }
  @$pb.TagNumber(14)
  $core.bool hasTranslationConfigDetails() => $_has(6);
  @$pb.TagNumber(14)
  void clearTranslationConfigDetails() => clearField(14);
  @$pb.TagNumber(14)
  $2.TranslationConfigDetails ensureTranslationConfigDetails() => $_ensure(6);
}

class MigrationSubtask extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'MigrationSubtask', package: const $pb.PackageName(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'google.cloud.bigquery.migration.v2'), createEmptyInstance: create)
    ..aOS(1, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'name')
    ...
    ..aOM<$1.ErrorInfo>(6, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'processingError', subBuilder: $1.ErrorInfo.create)
    ...
    ..pc<$3.TimeSeries>(11, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'metrics', $pb.PbFieldType.PM, subBuilder: $3.TimeSeries.create)
    ..pc<$4.ResourceErrorDetail>(12, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'resourceErrorDetails', $pb.PbFieldType.PM, subBuilder: $4.ResourceErrorDetail.create)
  ...
  @$pb.TagNumber(6)
  $1.ErrorInfo get processingError => $_getN(4);
  @$pb.TagNumber(6)
  set processingError($1.ErrorInfo v) { setField(6, v); }
  @$pb.TagNumber(6)
  $core.bool hasProcessingError() => $_has(4);
  @$pb.TagNumber(6)
  void clearProcessingError() => clearField(6);
  @$pb.TagNumber(6)
  $1.ErrorInfo ensureProcessingError() => $_ensure(4);

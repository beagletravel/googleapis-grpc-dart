...
final $typed_data.Uint8List audioEncodingDescriptor = $convert.base64Decode('Cg1BdWRpb0VuY29kaW5nEh4KGkFVRElPX0VOQ09ESU5HX1VOU1BFQ0lGSUVEEAASDAoITElORUFSMTYQARIHCgNNUDMQAhIPCgtNUDNfNjRfS0JQUxAEEgwKCE9HR19PUFVTEAMSCQoFTVVMQVcQBRIICgRBTEFXEAY=');
...
final $typed_data.Uint8List listVoicesResponseDescriptor = $convert.base64Decode('ChJMaXN0Vm9pY2VzUmVzcG9uc2USQAoGdm9pY2VzGAEgAygLMiguZ29vZ2xlLmNsb3VkLnRleHR0b3NwZWVjaC52MWJldGExLlZvaWNlUgZ2b2ljZXM=');
...
final $typed_data.Uint8List voiceDescriptor = $convert.base64Decode('');
...
const SynthesizeSpeechRequest$json = const {
  ...
  '2': const [
    const {'1': 'input', '3': 1, '4': 1, '5': 11, '6': '.google.cloud.texttospeech.v1beta1.SynthesisInput', '8': const {}, '10': 'input'},
    const {'1': 'voice', '3': 2, '4': 1, '5': 11, '6': '.google.cloud.texttospeech.v1beta1.VoiceSelectionParams', '8': const {}, '10': 'voice'},
    const {'1': 'audio_config', '3': 3, '4': 1, '5': 11, '6': '.google.cloud.texttospeech.v1beta1.AudioConfig', '8': const {}, '10': 'audioConfig'},
    const {'1': 'enable_time_pointing', '3': 4, '4': 3, '5': 14, '6': '.google.cloud.texttospeech.v1beta1.SynthesizeSpeechRequest.TimepointType', '10': 'enableTimePointing'},
  ],
...
final $typed_data.Uint8List synthesizeSpeechRequestDescriptor = $convert.base64Decode('');
...
final $typed_data.Uint8List synthesisInputDescriptor = $convert.base64Decode('Cg5TeW50aGVzaXNJbnB1dBIUCgR0ZXh0GAEgASgJSABSBHRleHQSFAoEc3NtbBgCIAEoCUgAUgRzc21sQg4KDGlucHV0X3NvdXJjZQ==');
...
const VoiceSelectionParams$json = const {
  ...
  '2': const [
    ...
    const {'1': 'name', '3': 2, '4': 1, '5': 9, '10': 'name'},
    const {'1': 'ssml_gender', '3': 3, '4': 1, '5': 14, '6': '.google.cloud.texttospeech.v1beta1.SsmlVoiceGender', '10': 'ssmlGender'},
    const {'1': 'custom_voice', '3': 4, '4': 1, '5': 11, '6': '.google.cloud.texttospeech.v1beta1.CustomVoiceParams', '10': 'customVoice'},
  ],
};

/// Descriptor for `VoiceSelectionParams`. Decode as a `google.protobuf.DescriptorProto`.
final $typed_data.Uint8List voiceSelectionParamsDescriptor = $convert.base64Decode('');
@$core.Deprecated('Use audioConfigDescriptor instead')
const AudioConfig$json = const {
  '1': 'AudioConfig',
  '2': const [
    const {'1': 'audio_encoding', '3': 1, '4': 1, '5': 14, '6': '.google.cloud.texttospeech.v1beta1.AudioEncoding', '8': const {}, '10': 'audioEncoding'},
...
final $typed_data.Uint8List audioConfigDescriptor = $convert.base64Decode('');
...
const CustomVoiceParams$json = const {
  ...
  '2': const [
    ...
    const {'1': 'reported_usage', '3': 3, '4': 1, '5': 14, '6': '.google.cloud.texttospeech.v1beta1.CustomVoiceParams.ReportedUsage', '8': const {}, '10': 'reportedUsage'},
  ],
...
const SynthesizeSpeechResponse$json = const {
  ...
  '2': const [
    ...
    const {'1': 'timepoints', '3': 2, '4': 3, '5': 11, '6': '.google.cloud.texttospeech.v1beta1.Timepoint', '10': 'timepoints'},
    const {'1': 'audio_config', '3': 4, '4': 1, '5': 11, '6': '.google.cloud.texttospeech.v1beta1.AudioConfig', '10': 'audioConfig'},
  ],
};

/// Descriptor for `SynthesizeSpeechResponse`. Decode as a `google.protobuf.DescriptorProto`.
final $typed_data.Uint8List synthesizeSpeechResponseDescriptor = $convert.base64Decode('');
...
final $typed_data.Uint8List timepointDescriptor = $convert.base64Decode('CglUaW1lcG9pbnQSGwoJbWFya19uYW1lGAQgASgJUghtYXJrTmFtZRIhCgx0aW1lX3NlY29uZHMYAyABKAFSC3RpbWVTZWNvbmRz');

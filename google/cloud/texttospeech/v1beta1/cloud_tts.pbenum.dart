...
class AudioEncoding extends $pb.ProtobufEnum {
  ...
  static const AudioEncoding MP3_64_KBPS = AudioEncoding._(4, const $core.bool.fromEnvironment('protobuf.omit_enum_names') ? '' : 'MP3_64_KBPS');
...
class SynthesizeSpeechRequest_TimepointType extends $pb.ProtobufEnum {
  static const SynthesizeSpeechRequest_TimepointType TIMEPOINT_TYPE_UNSPECIFIED = SynthesizeSpeechRequest_TimepointType._(0, const $core.bool.fromEnvironment('protobuf.omit_enum_names') ? '' : 'TIMEPOINT_TYPE_UNSPECIFIED');
  static const SynthesizeSpeechRequest_TimepointType SSML_MARK = SynthesizeSpeechRequest_TimepointType._(1, const $core.bool.fromEnvironment('protobuf.omit_enum_names') ? '' : 'SSML_MARK');

  static const $core.List<SynthesizeSpeechRequest_TimepointType> values = <SynthesizeSpeechRequest_TimepointType> [
    TIMEPOINT_TYPE_UNSPECIFIED,
    SSML_MARK,
  ];

  static final $core.Map<$core.int, SynthesizeSpeechRequest_TimepointType> _byValue = $pb.ProtobufEnum.initByValue(values);
  static SynthesizeSpeechRequest_TimepointType? valueOf($core.int value) => _byValue[value];

  const SynthesizeSpeechRequest_TimepointType._($core.int v, $core.String n) : super(v, n);
}

...
final $typed_data.Uint8List audioEncodingDescriptor = $convert.base64Decode('Cg1BdWRpb0VuY29kaW5nEh4KGkFVRElPX0VOQ09ESU5HX1VOU1BFQ0lGSUVEEAASDAoITElORUFSMTYQARIHCgNNUDMQAhIMCghPR0dfT1BVUxADEgkKBU1VTEFXEAUSCAoEQUxBVxAG');
...
final $typed_data.Uint8List voiceSelectionParamsDescriptor = $convert.base64Decode('');
...
const CustomVoiceParams$json = const {
  ...
  '2': const [
    ...
    const {'1': 'reported_usage', '3': 3, '4': 1, '5': 14, '6': '.google.cloud.texttospeech.v1.CustomVoiceParams.ReportedUsage', '8': const {}, '10': 'reportedUsage'},
  ],
...
final $typed_data.Uint8List customVoiceParamsDescriptor = $convert.base64Decode('');

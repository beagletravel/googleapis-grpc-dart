...
class CertificateAuthority_AccessUrls extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'CertificateAuthority.AccessUrls', package: const $pb.PackageName(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'google.cloud.security.privateca.v1'), createEmptyInstance: create)
    ..aOS(1, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'caCertificateAccessUrl')
    ..pPS(2, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'crlAccessUrls')
  ...
  'Will be removed in next major version')
  CertificateAuthority_AccessUrls copyWith(void Function(CertificateAuthority_AccessUrls) updates) => super.copyWith((message) => updates(message as CertificateAuthority_AccessUrls)) as CertificateAuthority_AccessUrls; // ignore: deprecated_member_use
...
class CertificateAuthority_KeyVersionSpec extends $pb.GeneratedMessage {
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'CertificateAuthority.KeyVersionSpec', package: const $pb.PackageName(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'google.cloud.security.privateca.v1'), createEmptyInstance: create)
    ..oo(0, [1, 2])
    ..aOS(1, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'cloudKmsKeyVersion')
    ..e<CertificateAuthority_SignHashAlgorithm>(2, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'algorithm', $pb.PbFieldType.OE, defaultOrMaker: CertificateAuthority_SignHashAlgorithm.SIGN_HASH_ALGORITHM_UNSPECIFIED, valueOf: CertificateAuthority_SignHashAlgorithm.valueOf, enumValues: CertificateAuthority_SignHashAlgorithm.values)
    ..hasRequiredFields = false
  ;
  ...
  'Use [GeneratedMessageGenericExtensions.rebuild] instead. '
  'Will be removed in next major version')
  CertificateAuthority_KeyVersionSpec copyWith(void Function(CertificateAuthority_KeyVersionSpec) updates) => super.copyWith((message) => updates(message as CertificateAuthority_KeyVersionSpec)) as CertificateAuthority_KeyVersionSpec; // ignore: deprecated_member_use
  $pb.BuilderInfo get info_ => _i;
  @$core.pragma('dart2js:noInline')
...
class CertificateAuthority extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'CertificateAuthority', package: const $pb.PackageName(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'google.cloud.security.privateca.v1'), createEmptyInstance: create)
    ..aOS(1, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'name')
    ..e<CertificateAuthority_Type>(2, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'type', $pb.PbFieldType.OE, defaultOrMaker: CertificateAuthority_Type.TYPE_UNSPECIFIED, valueOf: CertificateAuthority_Type.valueOf, enumValues: CertificateAuthority_Type.values)
    ..aOM<CertificateConfig>(3, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'config', subBuilder: CertificateConfig.create)
    ..aOM<$0.Duration>(4, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'lifetime', subBuilder: $0.Duration.create)
    ..aOM<CertificateAuthority_KeyVersionSpec>(5, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'keySpec', subBuilder: CertificateAuthority_KeyVersionSpec.create)
    ..aOM<SubordinateConfig>(6, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'subordinateConfig', subBuilder: SubordinateConfig.create)
    ..e<CaPool_Tier>(7, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'tier', $pb.PbFieldType.OE, defaultOrMaker: CaPool_Tier.TIER_UNSPECIFIED, valueOf: CaPool_Tier.valueOf, enumValues: CaPool_Tier.values)
    ..e<CertificateAuthority_State>(8, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'state', $pb.PbFieldType.OE, defaultOrMaker: CertificateAuthority_State.STATE_UNSPECIFIED, valueOf: CertificateAuthority_State.valueOf, enumValues: CertificateAuthority_State.values)
    ..pPS(9, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'pemCaCertificates')
    ..pc<CertificateDescription>(10, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'caCertificateDescriptions', $pb.PbFieldType.PM, subBuilder: CertificateDescription.create)
    ..aOS(11, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'gcsBucket')
    ..aOM<CertificateAuthority_AccessUrls>(12, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'accessUrls', subBuilder: CertificateAuthority_AccessUrls.create)
    ..aOM<$1.Timestamp>(13, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'createTime', subBuilder: $1.Timestamp.create)
    ..aOM<$1.Timestamp>(14, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'updateTime', subBuilder: $1.Timestamp.create)
    ..aOM<$1.Timestamp>(15, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'deleteTime', subBuilder: $1.Timestamp.create)
    ..aOM<$1.Timestamp>(16, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'expireTime', subBuilder: $1.Timestamp.create)
    ..m<$core.String, $core.String>(17, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'labels', entryClassName: 'CertificateAuthority.LabelsEntry', keyFieldType: $pb.PbFieldType.OS, valueFieldType: $pb.PbFieldType.OS, packageName: const $pb.PackageName('google.cloud.security.privateca.v1'))
    ..hasRequiredFields = false
  ;
  ...
  'Use [GeneratedMessageGenericExtensions.rebuild] instead. '
  'Will be removed in next major version')
  CertificateAuthority copyWith(void Function(CertificateAuthority) updates) => super.copyWith((message) => updates(message as CertificateAuthority)) as CertificateAuthority; // ignore: deprecated_member_use
  $pb.BuilderInfo get info_ => _i;
  @$core.pragma('dart2js:noInline')
  ...
  @$pb.TagNumber(4)
  set lifetime($0.Duration v) { setField(4, v); }
  @$pb.TagNumber(4)
  ...
  @$pb.TagNumber(13)
  set createTime($1.Timestamp v) { setField(13, v); }
  @$pb.TagNumber(13)
  ...
  @$pb.TagNumber(14)
  set updateTime($1.Timestamp v) { setField(14, v); }
  @$pb.TagNumber(14)
  ...
  @$pb.TagNumber(15)
  set deleteTime($1.Timestamp v) { setField(15, v); }
  @$pb.TagNumber(15)
  ...
  @$pb.TagNumber(16)
  set expireTime($1.Timestamp v) { setField(16, v); }
  @$pb.TagNumber(16)
...
class CaPool_PublishingOptions extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'CaPool.PublishingOptions', package: const $pb.PackageName(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'google.cloud.security.privateca.v1'), createEmptyInstance: create)
    ..aOB(1, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'publishCaCert')
    ..aOB(2, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'publishCrl')
    ..hasRequiredFields = false
  ;
  ...
  'Use [GeneratedMessageGenericExtensions.rebuild] instead. '
  'Will be removed in next major version')
  CaPool_PublishingOptions copyWith(void Function(CaPool_PublishingOptions) updates) => super.copyWith((message) => updates(message as CaPool_PublishingOptions)) as CaPool_PublishingOptions; // ignore: deprecated_member_use
  $pb.BuilderInfo get info_ => _i;
  @$core.pragma('dart2js:noInline')
...
class CaPool_IssuancePolicy_AllowedKeyType_RsaKeyType extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'CaPool.IssuancePolicy.AllowedKeyType.RsaKeyType', package: const $pb.PackageName(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'google.cloud.security.privateca.v1'), createEmptyInstance: create)
    ..aInt64(1, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'minModulusSize')
    ..aInt64(2, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'maxModulusSize')
    ..hasRequiredFields = false
  ;
  ...
  'Use [GeneratedMessageGenericExtensions.rebuild] instead. '
  'Will be removed in next major version')
  CaPool_IssuancePolicy_AllowedKeyType_RsaKeyType copyWith(void Function(CaPool_IssuancePolicy_AllowedKeyType_RsaKeyType) updates) => super.copyWith((message) => updates(message as CaPool_IssuancePolicy_AllowedKeyType_RsaKeyType)) as CaPool_IssuancePolicy_AllowedKeyType_RsaKeyType; // ignore: deprecated_member_use
  $pb.BuilderInfo get info_ => _i;
  @$core.pragma('dart2js:noInline')
...
class CaPool_IssuancePolicy_AllowedKeyType_EcKeyType extends $pb.GeneratedMessage {
  ...
  'Use [GeneratedMessageGenericExtensions.rebuild] instead. '
  'Will be removed in next major version')
  CaPool_IssuancePolicy_AllowedKeyType_EcKeyType copyWith(void Function(CaPool_IssuancePolicy_AllowedKeyType_EcKeyType) updates) => super.copyWith((message) => updates(message as CaPool_IssuancePolicy_AllowedKeyType_EcKeyType)) as CaPool_IssuancePolicy_AllowedKeyType_EcKeyType; // ignore: deprecated_member_use
  $pb.BuilderInfo get info_ => _i;
  @$core.pragma('dart2js:noInline')
...
class CaPool_IssuancePolicy_AllowedKeyType extends $pb.GeneratedMessage {
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'CaPool.IssuancePolicy.AllowedKeyType', package: const $pb.PackageName(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'google.cloud.security.privateca.v1'), createEmptyInstance: create)
    ..oo(0, [1, 2])
    ..aOM<CaPool_IssuancePolicy_AllowedKeyType_RsaKeyType>(1, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'rsa', subBuilder: CaPool_IssuancePolicy_AllowedKeyType_RsaKeyType.create)
    ..aOM<CaPool_IssuancePolicy_AllowedKeyType_EcKeyType>(2, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'ellipticCurve', subBuilder: CaPool_IssuancePolicy_AllowedKeyType_EcKeyType.create)
    ..hasRequiredFields = false
  ;
  ...
  'Use [GeneratedMessageGenericExtensions.rebuild] instead. '
  'Will be removed in next major version')
  CaPool_IssuancePolicy_AllowedKeyType copyWith(void Function(CaPool_IssuancePolicy_AllowedKeyType) updates) => super.copyWith((message) => updates(message as CaPool_IssuancePolicy_AllowedKeyType)) as CaPool_IssuancePolicy_AllowedKeyType; // ignore: deprecated_member_use
  $pb.BuilderInfo get info_ => _i;
  @$core.pragma('dart2js:noInline')
...
class CaPool_IssuancePolicy_IssuanceModes extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'CaPool.IssuancePolicy.IssuanceModes', package: const $pb.PackageName(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'google.cloud.security.privateca.v1'), createEmptyInstance: create)
    ..aOB(1, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'allowCsrBasedIssuance')
    ..aOB(2, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'allowConfigBasedIssuance')
    ..hasRequiredFields = false
  ;
  ...
  'Use [GeneratedMessageGenericExtensions.rebuild] instead. '
  'Will be removed in next major version')
  CaPool_IssuancePolicy_IssuanceModes copyWith(void Function(CaPool_IssuancePolicy_IssuanceModes) updates) => super.copyWith((message) => updates(message as CaPool_IssuancePolicy_IssuanceModes)) as CaPool_IssuancePolicy_IssuanceModes; // ignore: deprecated_member_use
  $pb.BuilderInfo get info_ => _i;
  @$core.pragma('dart2js:noInline')
...
class CaPool_IssuancePolicy extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'CaPool.IssuancePolicy', package: const $pb.PackageName(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'google.cloud.security.privateca.v1'), createEmptyInstance: create)
    ..pc<CaPool_IssuancePolicy_AllowedKeyType>(1, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'allowedKeyTypes', $pb.PbFieldType.PM, subBuilder: CaPool_IssuancePolicy_AllowedKeyType.create)
    ..aOM<$0.Duration>(2, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'maximumLifetime', subBuilder: $0.Duration.create)
    ..aOM<CaPool_IssuancePolicy_IssuanceModes>(3, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'allowedIssuanceModes', subBuilder: CaPool_IssuancePolicy_IssuanceModes.create)
    ..aOM<X509Parameters>(4, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'baselineValues', subBuilder: X509Parameters.create)
    ..aOM<CertificateIdentityConstraints>(5, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'identityConstraints', subBuilder: CertificateIdentityConstraints.create)
    ..aOM<CertificateExtensionConstraints>(6, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'passthroughExtensions', subBuilder: CertificateExtensionConstraints.create)
    ..hasRequiredFields = false
  ;
  ...
  'Use [GeneratedMessageGenericExtensions.rebuild] instead. '
  'Will be removed in next major version')
  CaPool_IssuancePolicy copyWith(void Function(CaPool_IssuancePolicy) updates) => super.copyWith((message) => updates(message as CaPool_IssuancePolicy)) as CaPool_IssuancePolicy; // ignore: deprecated_member_use
  $pb.BuilderInfo get info_ => _i;
  @$core.pragma('dart2js:noInline')
  ...
  @$pb.TagNumber(2)
  set maximumLifetime($0.Duration v) { setField(2, v); }
  @$pb.TagNumber(2)
...
class CaPool extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'CaPool', package: const $pb.PackageName(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'google.cloud.security.privateca.v1'), createEmptyInstance: create)
    ..aOS(1, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'name')
    ..e<CaPool_Tier>(2, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'tier', $pb.PbFieldType.OE, defaultOrMaker: CaPool_Tier.TIER_UNSPECIFIED, valueOf: CaPool_Tier.valueOf, enumValues: CaPool_Tier.values)
    ..aOM<CaPool_IssuancePolicy>(3, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'issuancePolicy', subBuilder: CaPool_IssuancePolicy.create)
    ..aOM<CaPool_PublishingOptions>(4, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'publishingOptions', subBuilder: CaPool_PublishingOptions.create)
    ..m<$core.String, $core.String>(5, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'labels', entryClassName: 'CaPool.LabelsEntry', keyFieldType: $pb.PbFieldType.OS, valueFieldType: $pb.PbFieldType.OS, packageName: const $pb.PackageName('google.cloud.security.privateca.v1'))
    ..hasRequiredFields = false
  ;
  ...
  'Use [GeneratedMessageGenericExtensions.rebuild] instead. '
  'Will be removed in next major version')
  CaPool copyWith(void Function(CaPool) updates) => super.copyWith((message) => updates(message as CaPool)) as CaPool; // ignore: deprecated_member_use
  $pb.BuilderInfo get info_ => _i;
  @$core.pragma('dart2js:noInline')
...
class CertificateRevocationList_RevokedCertificate extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'CertificateRevocationList.RevokedCertificate', package: const $pb.PackageName(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'google.cloud.security.privateca.v1'), createEmptyInstance: create)
    ..aOS(1, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'certificate')
    ..aOS(2, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'hexSerialNumber')
    ..e<RevocationReason>(3, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'revocationReason', $pb.PbFieldType.OE, defaultOrMaker: RevocationReason.REVOCATION_REASON_UNSPECIFIED, valueOf: RevocationReason.valueOf, enumValues: RevocationReason.values)
    ..hasRequiredFields = false
  ;
  ...
  'Use [GeneratedMessageGenericExtensions.rebuild] instead. '
  'Will be removed in next major version')
  CertificateRevocationList_RevokedCertificate copyWith(void Function(CertificateRevocationList_RevokedCertificate) updates) => super.copyWith((message) => updates(message as CertificateRevocationList_RevokedCertificate)) as CertificateRevocationList_RevokedCertificate; // ignore: deprecated_member_use
  $pb.BuilderInfo get info_ => _i;
  @$core.pragma('dart2js:noInline')
...
class CertificateRevocationList extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'CertificateRevocationList', package: const $pb.PackageName(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'google.cloud.security.privateca.v1'), createEmptyInstance: create)
    ..aOS(1, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'name')
    ..aInt64(2, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'sequenceNumber')
    ..pc<CertificateRevocationList_RevokedCertificate>(3, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'revokedCertificates', $pb.PbFieldType.PM, subBuilder: CertificateRevocationList_RevokedCertificate.create)
    ..aOS(4, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'pemCrl')
    ..aOS(5, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'accessUrl')
    ..e<CertificateRevocationList_State>(6, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'state', $pb.PbFieldType.OE, defaultOrMaker: CertificateRevocationList_State.STATE_UNSPECIFIED, valueOf: CertificateRevocationList_State.valueOf, enumValues: CertificateRevocationList_State.values)
    ..aOM<$1.Timestamp>(7, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'createTime', subBuilder: $1.Timestamp.create)
    ..aOM<$1.Timestamp>(8, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'updateTime', subBuilder: $1.Timestamp.create)
    ..aOS(9, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'revisionId')
    ..m<$core.String, $core.String>(10, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'labels', entryClassName: 'CertificateRevocationList.LabelsEntry', keyFieldType: $pb.PbFieldType.OS, valueFieldType: $pb.PbFieldType.OS, packageName: const $pb.PackageName('google.cloud.security.privateca.v1'))
    ..hasRequiredFields = false
  ;
  ...
  'Use [GeneratedMessageGenericExtensions.rebuild] instead. '
  'Will be removed in next major version')
  CertificateRevocationList copyWith(void Function(CertificateRevocationList) updates) => super.copyWith((message) => updates(message as CertificateRevocationList)) as CertificateRevocationList; // ignore: deprecated_member_use
  $pb.BuilderInfo get info_ => _i;
  @$core.pragma('dart2js:noInline')
...
class Certificate_RevocationDetails extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'Certificate.RevocationDetails', package: const $pb.PackageName(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'google.cloud.security.privateca.v1'), createEmptyInstance: create)
    ..e<RevocationReason>(1, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'revocationState', $pb.PbFieldType.OE, defaultOrMaker: RevocationReason.REVOCATION_REASON_UNSPECIFIED, valueOf: RevocationReason.valueOf, enumValues: RevocationReason.values)
    ..aOM<$1.Timestamp>(2, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'revocationTime', subBuilder: $1.Timestamp.create)
    ..hasRequiredFields = false
  ;
  ...
  'Use [GeneratedMessageGenericExtensions.rebuild] instead. '
  'Will be removed in next major version')
  Certificate_RevocationDetails copyWith(void Function(Certificate_RevocationDetails) updates) => super.copyWith((message) => updates(message as Certificate_RevocationDetails)) as Certificate_RevocationDetails; // ignore: deprecated_member_use
  $pb.BuilderInfo get info_ => _i;
  @$core.pragma('dart2js:noInline')
  ...
  @$pb.TagNumber(2)
  set revocationTime($1.Timestamp v) { setField(2, v); }
  @$pb.TagNumber(2)
...
class Certificate extends $pb.GeneratedMessage {
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'Certificate', package: const $pb.PackageName(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'google.cloud.security.privateca.v1'), createEmptyInstance: create)
    ..oo(0, [2, 3])
    ..aOS(1, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'name')
    ..aOS(2, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'pemCsr')
    ..aOM<CertificateConfig>(3, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'config', subBuilder: CertificateConfig.create)
    ..aOS(4, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'issuerCertificateAuthority')
    ..aOM<$0.Duration>(5, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'lifetime', subBuilder: $0.Duration.create)
    ..aOS(6, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'certificateTemplate')
    ..e<SubjectRequestMode>(7, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'subjectMode', $pb.PbFieldType.OE, defaultOrMaker: SubjectRequestMode.SUBJECT_REQUEST_MODE_UNSPECIFIED, valueOf: SubjectRequestMode.valueOf, enumValues: SubjectRequestMode.values)
    ..aOM<Certificate_RevocationDetails>(8, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'revocationDetails', subBuilder: Certificate_RevocationDetails.create)
    ..aOS(9, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'pemCertificate')
    ..aOM<CertificateDescription>(10, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'certificateDescription', subBuilder: CertificateDescription.create)
    ..pPS(11, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'pemCertificateChain')
    ..aOM<$1.Timestamp>(12, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'createTime', subBuilder: $1.Timestamp.create)
    ..aOM<$1.Timestamp>(13, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'updateTime', subBuilder: $1.Timestamp.create)
    ..m<$core.String, $core.String>(14, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'labels', entryClassName: 'Certificate.LabelsEntry', keyFieldType: $pb.PbFieldType.OS, valueFieldType: $pb.PbFieldType.OS, packageName: const $pb.PackageName('google.cloud.security.privateca.v1'))
    ..hasRequiredFields = false
  ;
  ...
  @$pb.TagNumber(5)
  set lifetime($0.Duration v) { setField(5, v); }
  @$pb.TagNumber(5)
  ...
  @$pb.TagNumber(12)
  set createTime($1.Timestamp v) { setField(12, v); }
  @$pb.TagNumber(12)
  ...
  @$pb.TagNumber(13)
  set updateTime($1.Timestamp v) { setField(13, v); }
  @$pb.TagNumber(13)
...
class CertificateTemplate extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'CertificateTemplate', package: const $pb.PackageName(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'google.cloud.security.privateca.v1'), createEmptyInstance: create)
    ..aOS(1, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'name')
    ..aOM<X509Parameters>(2, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'predefinedValues', subBuilder: X509Parameters.create)
    ..aOM<CertificateIdentityConstraints>(3, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'identityConstraints', subBuilder: CertificateIdentityConstraints.create)
    ..aOM<CertificateExtensionConstraints>(4, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'passthroughExtensions', subBuilder: CertificateExtensionConstraints.create)
    ...
    ..aOM<$1.Timestamp>(7, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'updateTime', subBuilder: $1.Timestamp.create)
    ..m<$core.String, $core.String>(8, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'labels', entryClassName: 'CertificateTemplate.LabelsEntry', keyFieldType: $pb.PbFieldType.OS, valueFieldType: $pb.PbFieldType.OS, packageName: const $pb.PackageName('google.cloud.security.privateca.v1'))
    ..hasRequiredFields = false
  ;
  ...
  'Use [GeneratedMessageGenericExtensions.rebuild] instead. '
  'Will be removed in next major version')
  CertificateTemplate copyWith(void Function(CertificateTemplate) updates) => super.copyWith((message) => updates(message as CertificateTemplate)) as CertificateTemplate; // ignore: deprecated_member_use
  $pb.BuilderInfo get info_ => _i;
  @$core.pragma('dart2js:noInline')
  ...
  @$pb.TagNumber(7)
  set updateTime($1.Timestamp v) { setField(7, v); }
  @$pb.TagNumber(7)
...
class X509Parameters_CaOptions extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'X509Parameters.CaOptions', package: const $pb.PackageName(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'google.cloud.security.privateca.v1'), createEmptyInstance: create)
    ..aOB(1, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'isCa')
    ..a<$core.int>(2, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'maxIssuerPathLength', $pb.PbFieldType.O3)
    ..hasRequiredFields = false
  ;
  ...
  'Use [GeneratedMessageGenericExtensions.rebuild] instead. '
  'Will be removed in next major version')
  X509Parameters_CaOptions copyWith(void Function(X509Parameters_CaOptions) updates) => super.copyWith((message) => updates(message as X509Parameters_CaOptions)) as X509Parameters_CaOptions; // ignore: deprecated_member_use
  $pb.BuilderInfo get info_ => _i;
  @$core.pragma('dart2js:noInline')
...
class X509Parameters extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'X509Parameters', package: const $pb.PackageName(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'google.cloud.security.privateca.v1'), createEmptyInstance: create)
    ..aOM<KeyUsage>(1, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'keyUsage', subBuilder: KeyUsage.create)
    ..aOM<X509Parameters_CaOptions>(2, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'caOptions', subBuilder: X509Parameters_CaOptions.create)
    ..pc<ObjectId>(3, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'policyIds', $pb.PbFieldType.PM, subBuilder: ObjectId.create)
    ..pPS(4, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'aiaOcspServers')
    ..pc<X509Extension>(5, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'additionalExtensions', $pb.PbFieldType.PM, subBuilder: X509Extension.create)
    ..hasRequiredFields = false
  ;
  ...
  'Use [GeneratedMessageGenericExtensions.rebuild] instead. '
  'Will be removed in next major version')
  X509Parameters copyWith(void Function(X509Parameters) updates) => super.copyWith((message) => updates(message as X509Parameters)) as X509Parameters; // ignore: deprecated_member_use
  $pb.BuilderInfo get info_ => _i;
  @$core.pragma('dart2js:noInline')
...
class SubordinateConfig_SubordinateConfigChain extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'SubordinateConfig.SubordinateConfigChain', package: const $pb.PackageName(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'google.cloud.security.privateca.v1'), createEmptyInstance: create)
    ..pPS(1, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'pemCertificates')
    ..hasRequiredFields = false
  ;
  ...
  'Use [GeneratedMessageGenericExtensions.rebuild] instead. '
  'Will be removed in next major version')
  SubordinateConfig_SubordinateConfigChain copyWith(void Function(SubordinateConfig_SubordinateConfigChain) updates) => super.copyWith((message) => updates(message as SubordinateConfig_SubordinateConfigChain)) as SubordinateConfig_SubordinateConfigChain; // ignore: deprecated_member_use
  $pb.BuilderInfo get info_ => _i;
  @$core.pragma('dart2js:noInline')
...
class SubordinateConfig extends $pb.GeneratedMessage {
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'SubordinateConfig', package: const $pb.PackageName(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'google.cloud.security.privateca.v1'), createEmptyInstance: create)
    ..oo(0, [1, 2])
    ..aOS(1, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'certificateAuthority')
    ..aOM<SubordinateConfig_SubordinateConfigChain>(2, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'pemIssuerChain', subBuilder: SubordinateConfig_SubordinateConfigChain.create)
    ..hasRequiredFields = false
  ;
  ...
  'Use [GeneratedMessageGenericExtensions.rebuild] instead. '
  'Will be removed in next major version')
  SubordinateConfig copyWith(void Function(SubordinateConfig) updates) => super.copyWith((message) => updates(message as SubordinateConfig)) as SubordinateConfig; // ignore: deprecated_member_use
  $pb.BuilderInfo get info_ => _i;
  @$core.pragma('dart2js:noInline')
...
class PublicKey extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'PublicKey', package: const $pb.PackageName(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'google.cloud.security.privateca.v1'), createEmptyInstance: create)
    ..a<$core.List<$core.int>>(1, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'key', $pb.PbFieldType.OY)
    ..e<PublicKey_KeyFormat>(2, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'format', $pb.PbFieldType.OE, defaultOrMaker: PublicKey_KeyFormat.KEY_FORMAT_UNSPECIFIED, valueOf: PublicKey_KeyFormat.valueOf, enumValues: PublicKey_KeyFormat.values)
    ..hasRequiredFields = false
  ;
...
class CertificateConfig_SubjectConfig extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'CertificateConfig.SubjectConfig', package: const $pb.PackageName(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'google.cloud.security.privateca.v1'), createEmptyInstance: create)
    ..aOM<Subject>(1, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'subject', subBuilder: Subject.create)
    ..aOM<SubjectAltNames>(2, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'subjectAltName', subBuilder: SubjectAltNames.create)
    ..hasRequiredFields = false
  ;
  ...
  'Use [GeneratedMessageGenericExtensions.rebuild] instead. '
  'Will be removed in next major version')
  CertificateConfig_SubjectConfig copyWith(void Function(CertificateConfig_SubjectConfig) updates) => super.copyWith((message) => updates(message as CertificateConfig_SubjectConfig)) as CertificateConfig_SubjectConfig; // ignore: deprecated_member_use
  $pb.BuilderInfo get info_ => _i;
  @$core.pragma('dart2js:noInline')
...
class CertificateConfig extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'CertificateConfig', package: const $pb.PackageName(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'google.cloud.security.privateca.v1'), createEmptyInstance: create)
    ..aOM<CertificateConfig_SubjectConfig>(1, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'subjectConfig', subBuilder: CertificateConfig_SubjectConfig.create)
    ..aOM<X509Parameters>(2, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'x509Config', subBuilder: X509Parameters.create)
    ..aOM<PublicKey>(3, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'publicKey', subBuilder: PublicKey.create)
    ..hasRequiredFields = false
  ;
  ...
  'Use [GeneratedMessageGenericExtensions.rebuild] instead. '
  'Will be removed in next major version')
  CertificateConfig copyWith(void Function(CertificateConfig) updates) => super.copyWith((message) => updates(message as CertificateConfig)) as CertificateConfig; // ignore: deprecated_member_use
  $pb.BuilderInfo get info_ => _i;
  @$core.pragma('dart2js:noInline')
...
class CertificateDescription_SubjectDescription extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'CertificateDescription.SubjectDescription', package: const $pb.PackageName(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'google.cloud.security.privateca.v1'), createEmptyInstance: create)
    ..aOM<Subject>(1, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'subject', subBuilder: Subject.create)
    ..aOM<SubjectAltNames>(2, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'subjectAltName', subBuilder: SubjectAltNames.create)
    ..aOS(3, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'hexSerialNumber')
    ..aOM<$0.Duration>(4, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'lifetime', subBuilder: $0.Duration.create)
    ..aOM<$1.Timestamp>(5, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'notBeforeTime', subBuilder: $1.Timestamp.create)
    ..aOM<$1.Timestamp>(6, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'notAfterTime', subBuilder: $1.Timestamp.create)
    ..hasRequiredFields = false
  ;
  ...
  'Use [GeneratedMessageGenericExtensions.rebuild] instead. '
  'Will be removed in next major version')
  CertificateDescription_SubjectDescription copyWith(void Function(CertificateDescription_SubjectDescription) updates) => super.copyWith((message) => updates(message as CertificateDescription_SubjectDescription)) as CertificateDescription_SubjectDescription; // ignore: deprecated_member_use
  $pb.BuilderInfo get info_ => _i;
  @$core.pragma('dart2js:noInline')
  ...
  @$pb.TagNumber(5)
  set notBeforeTime($1.Timestamp v) { setField(5, v); }
  @$pb.TagNumber(5)
  ...
  @$pb.TagNumber(6)
  set notAfterTime($1.Timestamp v) { setField(6, v); }
  @$pb.TagNumber(6)
...
class CertificateDescription_KeyId extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'CertificateDescription.KeyId', package: const $pb.PackageName(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'google.cloud.security.privateca.v1'), createEmptyInstance: create)
  ...
  'Use [GeneratedMessageGenericExtensions.rebuild] instead. '
  'Will be removed in next major version')
  CertificateDescription_KeyId copyWith(void Function(CertificateDescription_KeyId) updates) => super.copyWith((message) => updates(message as CertificateDescription_KeyId)) as CertificateDescription_KeyId; // ignore: deprecated_member_use
  $pb.BuilderInfo get info_ => _i;
  @$core.pragma('dart2js:noInline')
...
class CertificateDescription_CertificateFingerprint extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'CertificateDescription.CertificateFingerprint', package: const $pb.PackageName(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'google.cloud.security.privateca.v1'), createEmptyInstance: create)
    ..aOS(1, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'sha256Hash')
    ..hasRequiredFields = false
  ;
  ...
  'Use [GeneratedMessageGenericExtensions.rebuild] instead. '
  'Will be removed in next major version')
  CertificateDescription_CertificateFingerprint copyWith(void Function(CertificateDescription_CertificateFingerprint) updates) => super.copyWith((message) => updates(message as CertificateDescription_CertificateFingerprint)) as CertificateDescription_CertificateFingerprint; // ignore: deprecated_member_use
  $pb.BuilderInfo get info_ => _i;
  @$core.pragma('dart2js:noInline')
...
class CertificateDescription extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'CertificateDescription', package: const $pb.PackageName(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'google.cloud.security.privateca.v1'), createEmptyInstance: create)
    ..aOM<CertificateDescription_SubjectDescription>(1, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'subjectDescription', subBuilder: CertificateDescription_SubjectDescription.create)
    ..aOM<X509Parameters>(2, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'x509Description', subBuilder: X509Parameters.create)
    ..aOM<PublicKey>(3, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'publicKey', subBuilder: PublicKey.create)
    ..aOM<CertificateDescription_KeyId>(4, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'subjectKeyId', subBuilder: CertificateDescription_KeyId.create)
    ..aOM<CertificateDescription_KeyId>(5, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'authorityKeyId', subBuilder: CertificateDescription_KeyId.create)
    ..pPS(6, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'crlDistributionPoints')
    ..pPS(7, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'aiaIssuingCertificateUrls')
    ..aOM<CertificateDescription_CertificateFingerprint>(8, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'certFingerprint', subBuilder: CertificateDescription_CertificateFingerprint.create)
    ..hasRequiredFields = false
  ;
  ...
  'Use [GeneratedMessageGenericExtensions.rebuild] instead. '
  'Will be removed in next major version')
  CertificateDescription copyWith(void Function(CertificateDescription) updates) => super.copyWith((message) => updates(message as CertificateDescription)) as CertificateDescription; // ignore: deprecated_member_use
  $pb.BuilderInfo get info_ => _i;
  @$core.pragma('dart2js:noInline')
...
class ObjectId extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'ObjectId', package: const $pb.PackageName(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'google.cloud.security.privateca.v1'), createEmptyInstance: create)
    ..p<$core.int>(1, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'objectIdPath', $pb.PbFieldType.P3)
    ..hasRequiredFields = false
  ;
...
class X509Extension extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'X509Extension', package: const $pb.PackageName(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'google.cloud.security.privateca.v1'), createEmptyInstance: create)
    ..aOM<ObjectId>(1, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'objectId', subBuilder: ObjectId.create)
    ..aOB(2, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'critical')
  ...
  'Use [GeneratedMessageGenericExtensions.rebuild] instead. '
  'Will be removed in next major version')
  X509Extension copyWith(void Function(X509Extension) updates) => super.copyWith((message) => updates(message as X509Extension)) as X509Extension; // ignore: deprecated_member_use
  $pb.BuilderInfo get info_ => _i;
  @$core.pragma('dart2js:noInline')
...
class KeyUsage_KeyUsageOptions extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'KeyUsage.KeyUsageOptions', package: const $pb.PackageName(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'google.cloud.security.privateca.v1'), createEmptyInstance: create)
    ..aOB(1, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'digitalSignature')
    ..aOB(2, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'contentCommitment')
    ..aOB(3, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'keyEncipherment')
    ..aOB(4, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'dataEncipherment')
    ..aOB(5, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'keyAgreement')
    ..aOB(6, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'certSign')
    ..aOB(7, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'crlSign')
    ..aOB(8, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'encipherOnly')
    ..aOB(9, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'decipherOnly')
    ..hasRequiredFields = false
  ;
  ...
  'Use [GeneratedMessageGenericExtensions.rebuild] instead. '
  'Will be removed in next major version')
  KeyUsage_KeyUsageOptions copyWith(void Function(KeyUsage_KeyUsageOptions) updates) => super.copyWith((message) => updates(message as KeyUsage_KeyUsageOptions)) as KeyUsage_KeyUsageOptions; // ignore: deprecated_member_use
  $pb.BuilderInfo get info_ => _i;
  @$core.pragma('dart2js:noInline')
...
class KeyUsage_ExtendedKeyUsageOptions extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'KeyUsage.ExtendedKeyUsageOptions', package: const $pb.PackageName(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'google.cloud.security.privateca.v1'), createEmptyInstance: create)
    ..aOB(1, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'serverAuth')
    ..aOB(2, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'clientAuth')
    ..aOB(3, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'codeSigning')
    ..aOB(4, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'emailProtection')
    ..aOB(5, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'timeStamping')
    ..aOB(6, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'ocspSigning')
    ..hasRequiredFields = false
  ;
  ...
  'Use [GeneratedMessageGenericExtensions.rebuild] instead. '
  'Will be removed in next major version')
  KeyUsage_ExtendedKeyUsageOptions copyWith(void Function(KeyUsage_ExtendedKeyUsageOptions) updates) => super.copyWith((message) => updates(message as KeyUsage_ExtendedKeyUsageOptions)) as KeyUsage_ExtendedKeyUsageOptions; // ignore: deprecated_member_use
  $pb.BuilderInfo get info_ => _i;
  @$core.pragma('dart2js:noInline')
...
class KeyUsage extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'KeyUsage', package: const $pb.PackageName(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'google.cloud.security.privateca.v1'), createEmptyInstance: create)
    ..aOM<KeyUsage_KeyUsageOptions>(1, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'baseKeyUsage', subBuilder: KeyUsage_KeyUsageOptions.create)
    ..aOM<KeyUsage_ExtendedKeyUsageOptions>(2, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'extendedKeyUsage', subBuilder: KeyUsage_ExtendedKeyUsageOptions.create)
    ..pc<ObjectId>(3, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'unknownExtendedKeyUsages', $pb.PbFieldType.PM, subBuilder: ObjectId.create)
    ..hasRequiredFields = false
  ;
  ...
  'Use [GeneratedMessageGenericExtensions.rebuild] instead. '
  'Will be removed in next major version')
  KeyUsage copyWith(void Function(KeyUsage) updates) => super.copyWith((message) => updates(message as KeyUsage)) as KeyUsage; // ignore: deprecated_member_use
  $pb.BuilderInfo get info_ => _i;
  @$core.pragma('dart2js:noInline')
...
class Subject extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'Subject', package: const $pb.PackageName(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'google.cloud.security.privateca.v1'), createEmptyInstance: create)
    ...
    ..aOS(3, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'organization')
    ..aOS(4, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'organizationalUnit')
    ..aOS(5, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'locality')
    ..aOS(6, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'province')
    ..aOS(7, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'streetAddress')
  ...
  'Use [GeneratedMessageGenericExtensions.rebuild] instead. '
  'Will be removed in next major version')
  Subject copyWith(void Function(Subject) updates) => super.copyWith((message) => updates(message as Subject)) as Subject; // ignore: deprecated_member_use
  $pb.BuilderInfo get info_ => _i;
  @$core.pragma('dart2js:noInline')
...
class SubjectAltNames extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'SubjectAltNames', package: const $pb.PackageName(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'google.cloud.security.privateca.v1'), createEmptyInstance: create)
    ..pPS(1, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'dnsNames')
    ..pPS(2, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'uris')
    ..pPS(3, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'emailAddresses')
    ..pPS(4, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'ipAddresses')
    ..pc<X509Extension>(5, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'customSans', $pb.PbFieldType.PM, subBuilder: X509Extension.create)
    ..hasRequiredFields = false
  ;
  ...
  'Use [GeneratedMessageGenericExtensions.rebuild] instead. '
  'Will be removed in next major version')
  SubjectAltNames copyWith(void Function(SubjectAltNames) updates) => super.copyWith((message) => updates(message as SubjectAltNames)) as SubjectAltNames; // ignore: deprecated_member_use
  $pb.BuilderInfo get info_ => _i;
  @$core.pragma('dart2js:noInline')
...
class CertificateIdentityConstraints extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'CertificateIdentityConstraints', package: const $pb.PackageName(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'google.cloud.security.privateca.v1'), createEmptyInstance: create)
    ..aOM<$2.Expr>(1, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'celExpression', subBuilder: $2.Expr.create)
    ..aOB(2, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'allowSubjectPassthrough')
    ..aOB(3, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'allowSubjectAltNamesPassthrough')
    ..hasRequiredFields = false
  ;
  ...
  'Use [GeneratedMessageGenericExtensions.rebuild] instead. '
  'Will be removed in next major version')
  CertificateIdentityConstraints copyWith(void Function(CertificateIdentityConstraints) updates) => super.copyWith((message) => updates(message as CertificateIdentityConstraints)) as CertificateIdentityConstraints; // ignore: deprecated_member_use
  $pb.BuilderInfo get info_ => _i;
  @$core.pragma('dart2js:noInline')
  ...
  @$pb.TagNumber(1)
  set celExpression($2.Expr v) { setField(1, v); }
  @$pb.TagNumber(1)
...
class CertificateExtensionConstraints extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'CertificateExtensionConstraints', package: const $pb.PackageName(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'google.cloud.security.privateca.v1'), createEmptyInstance: create)
    ..pc<CertificateExtensionConstraints_KnownCertificateExtension>(1, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'knownExtensions', $pb.PbFieldType.PE, valueOf: CertificateExtensionConstraints_KnownCertificateExtension.valueOf, enumValues: CertificateExtensionConstraints_KnownCertificateExtension.values)
    ..pc<ObjectId>(2, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'additionalExtensions', $pb.PbFieldType.PM, subBuilder: ObjectId.create)
    ..hasRequiredFields = false
  ;
  ...
  'Use [GeneratedMessageGenericExtensions.rebuild] instead. '
  'Will be removed in next major version')
  CertificateExtensionConstraints copyWith(void Function(CertificateExtensionConstraints) updates) => super.copyWith((message) => updates(message as CertificateExtensionConstraints)) as CertificateExtensionConstraints; // ignore: deprecated_member_use
  $pb.BuilderInfo get info_ => _i;
  @$core.pragma('dart2js:noInline')

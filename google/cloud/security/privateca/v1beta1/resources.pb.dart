...
class CertificateAuthority_IssuingOptions extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'CertificateAuthority.IssuingOptions', package: const $pb.PackageName(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'google.cloud.security.privateca.v1beta1'), createEmptyInstance: create)
    ..aOB(1, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'includeCaCertUrl')
    ..aOB(2, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'includeCrlAccessUrl')
  ...
  'Will be removed in next major version')
  CertificateAuthority_IssuingOptions copyWith(void Function(CertificateAuthority_IssuingOptions) updates) => super.copyWith((message) => updates(message as CertificateAuthority_IssuingOptions)) as CertificateAuthority_IssuingOptions; // ignore: deprecated_member_use
...
class CertificateAuthority_CertificateAuthorityPolicy_AllowedConfigList extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'CertificateAuthority.CertificateAuthorityPolicy.AllowedConfigList', package: const $pb.PackageName(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'google.cloud.security.privateca.v1beta1'), createEmptyInstance: create)
    ..pc<ReusableConfigWrapper>(1, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'allowedConfigValues', $pb.PbFieldType.PM, subBuilder: ReusableConfigWrapper.create)
    ..hasRequiredFields = false
  ;
...
class CertificateAuthority_CertificateAuthorityPolicy_AllowedSubjectAltNames extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'CertificateAuthority.CertificateAuthorityPolicy.AllowedSubjectAltNames', package: const $pb.PackageName(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'google.cloud.security.privateca.v1beta1'), createEmptyInstance: create)
    ..pPS(1, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'allowedDnsNames')
    ..pPS(2, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'allowedUris')
    ..pPS(3, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'allowedEmailAddresses')
    ..pPS(4, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'allowedIps')
    ..aOB(5, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'allowGlobbingDnsWildcards')
    ..aOB(6, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'allowCustomSans')
    ..hasRequiredFields = false
  ;
...
class CertificateAuthority_CertificateAuthorityPolicy_IssuanceModes extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'CertificateAuthority.CertificateAuthorityPolicy.IssuanceModes', package: const $pb.PackageName(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'google.cloud.security.privateca.v1beta1'), createEmptyInstance: create)
...
class CertificateAuthority_CertificateAuthorityPolicy extends $pb.GeneratedMessage {
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'CertificateAuthority.CertificateAuthorityPolicy', package: const $pb.PackageName(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'google.cloud.security.privateca.v1beta1'), createEmptyInstance: create)
    ..oo(0, [1, 2])
    ..aOM<CertificateAuthority_CertificateAuthorityPolicy_AllowedConfigList>(1, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'allowedConfigList', subBuilder: CertificateAuthority_CertificateAuthorityPolicy_AllowedConfigList.create)
    ..aOM<ReusableConfigWrapper>(2, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'overwriteConfigValues', subBuilder: ReusableConfigWrapper.create)
    ..pc<Subject>(3, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'allowedLocationsAndOrganizations', $pb.PbFieldType.PM, subBuilder: Subject.create)
    ..pPS(4, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'allowedCommonNames')
    ..aOM<CertificateAuthority_CertificateAuthorityPolicy_AllowedSubjectAltNames>(5, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'allowedSans', subBuilder: CertificateAuthority_CertificateAuthorityPolicy_AllowedSubjectAltNames.create)
    ..aOM<$0.Duration>(6, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'maximumLifetime', subBuilder: $0.Duration.create)
    ..aOM<CertificateAuthority_CertificateAuthorityPolicy_IssuanceModes>(8, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'allowedIssuanceModes', subBuilder: CertificateAuthority_CertificateAuthorityPolicy_IssuanceModes.create)
    ..hasRequiredFields = false
  ;
  ...
  factory CertificateAuthority_CertificateAuthorityPolicy({
    ...
    if (allowedLocationsAndOrganizations != null) {
      _result.allowedLocationsAndOrganizations.addAll(allowedLocationsAndOrganizations);
    }
  ...
  'Use [GeneratedMessageGenericExtensions.rebuild] instead. '
  'Will be removed in next major version')
  CertificateAuthority_CertificateAuthorityPolicy copyWith(void Function(CertificateAuthority_CertificateAuthorityPolicy) updates) => super.copyWith((message) => updates(message as CertificateAuthority_CertificateAuthorityPolicy)) as CertificateAuthority_CertificateAuthorityPolicy; // ignore: deprecated_member_use
  $pb.BuilderInfo get info_ => _i;
  @$core.pragma('dart2js:noInline')
  ...
  @$pb.TagNumber(6)
  set maximumLifetime($0.Duration v) { setField(6, v); }
  @$pb.TagNumber(6)
...
class CertificateAuthority_AccessUrls extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'CertificateAuthority.AccessUrls', package: const $pb.PackageName(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'google.cloud.security.privateca.v1beta1'), createEmptyInstance: create)
    ..aOS(1, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'caCertificateAccessUrl')
    ..aOS(2, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'crlAccessUrl')
    ..hasRequiredFields = false
  ;
...
class CertificateAuthority_KeyVersionSpec extends $pb.GeneratedMessage {
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'CertificateAuthority.KeyVersionSpec', package: const $pb.PackageName(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'google.cloud.security.privateca.v1beta1'), createEmptyInstance: create)
    ..oo(0, [1, 2])
...
class CertificateAuthority extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'CertificateAuthority', package: const $pb.PackageName(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'google.cloud.security.privateca.v1beta1'), createEmptyInstance: create)
    ...
    ..e<CertificateAuthority_Tier>(3, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'tier', $pb.PbFieldType.OE, defaultOrMaker: CertificateAuthority_Tier.TIER_UNSPECIFIED, valueOf: CertificateAuthority_Tier.valueOf, enumValues: CertificateAuthority_Tier.values)
    ..aOM<CertificateConfig>(4, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'config', subBuilder: CertificateConfig.create)
    ..aOM<$0.Duration>(5, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'lifetime', subBuilder: $0.Duration.create)
    ..aOM<CertificateAuthority_KeyVersionSpec>(6, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'keySpec', subBuilder: CertificateAuthority_KeyVersionSpec.create)
    ..aOM<CertificateAuthority_CertificateAuthorityPolicy>(7, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'certificatePolicy', subBuilder: CertificateAuthority_CertificateAuthorityPolicy.create)
    ..aOM<CertificateAuthority_IssuingOptions>(8, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'issuingOptions', subBuilder: CertificateAuthority_IssuingOptions.create)
    ..pPS(9, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'pemCaCertificates')
    ..e<CertificateAuthority_State>(10, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'state', $pb.PbFieldType.OE, defaultOrMaker: CertificateAuthority_State.STATE_UNSPECIFIED, valueOf: CertificateAuthority_State.valueOf, enumValues: CertificateAuthority_State.values)
    ..pc<CertificateDescription>(12, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'caCertificateDescriptions', $pb.PbFieldType.PM, subBuilder: CertificateDescription.create)
    ..aOS(13, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'gcsBucket')
    ..aOM<CertificateAuthority_AccessUrls>(14, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'accessUrls', subBuilder: CertificateAuthority_AccessUrls.create)
    ..aOM<$1.Timestamp>(15, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'createTime', subBuilder: $1.Timestamp.create)
    ..aOM<$1.Timestamp>(16, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'updateTime', subBuilder: $1.Timestamp.create)
    ..aOM<$1.Timestamp>(17, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'deleteTime', subBuilder: $1.Timestamp.create)
    ..m<$core.String, $core.String>(18, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'labels', entryClassName: 'CertificateAuthority.LabelsEntry', keyFieldType: $pb.PbFieldType.OS, valueFieldType: $pb.PbFieldType.OS, packageName: const $pb.PackageName('google.cloud.security.privateca.v1beta1'))
    ..aOM<SubordinateConfig>(19, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'subordinateConfig', subBuilder: SubordinateConfig.create)
    ..hasRequiredFields = false
  ;
  ...
  @$pb.TagNumber(16)
  set updateTime($1.Timestamp v) { setField(16, v); }
  @$pb.TagNumber(16)
  ...
  @$pb.TagNumber(17)
  set deleteTime($1.Timestamp v) { setField(17, v); }
  @$pb.TagNumber(17)
...
class CertificateRevocationList extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'CertificateRevocationList', package: const $pb.PackageName(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'google.cloud.security.privateca.v1beta1'), createEmptyInstance: create)
    ..aOS(1, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'name')
    ...
    ..m<$core.String, $core.String>(9, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'labels', entryClassName: 'CertificateRevocationList.LabelsEntry', keyFieldType: $pb.PbFieldType.OS, valueFieldType: $pb.PbFieldType.OS, packageName: const $pb.PackageName('google.cloud.security.privateca.v1beta1'))
    ..hasRequiredFields = false
  ;
...
class Certificate_RevocationDetails extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'Certificate.RevocationDetails', package: const $pb.PackageName(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'google.cloud.security.privateca.v1beta1'), createEmptyInstance: create)
...
class Certificate extends $pb.GeneratedMessage {
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'Certificate', package: const $pb.PackageName(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'google.cloud.security.privateca.v1beta1'), createEmptyInstance: create)
    ..oo(0, [2, 3])
    ..aOS(1, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'name')
    ...
    ..aOM<Certificate_RevocationDetails>(5, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'revocationDetails', subBuilder: Certificate_RevocationDetails.create)
    ..aOS(6, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'pemCertificate')
    ..aOM<CertificateDescription>(7, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'certificateDescription', subBuilder: CertificateDescription.create)
    ..pPS(8, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'pemCertificateChain')
    ..aOM<$1.Timestamp>(9, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'createTime', subBuilder: $1.Timestamp.create)
    ..aOM<$1.Timestamp>(10, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'updateTime', subBuilder: $1.Timestamp.create)
    ..m<$core.String, $core.String>(11, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'labels', entryClassName: 'Certificate.LabelsEntry', keyFieldType: $pb.PbFieldType.OS, valueFieldType: $pb.PbFieldType.OS, packageName: const $pb.PackageName('google.cloud.security.privateca.v1beta1'))
    ..hasRequiredFields = false
  ;
...
class ReusableConfig extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'ReusableConfig', package: const $pb.PackageName(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'google.cloud.security.privateca.v1beta1'), createEmptyInstance: create)
    ..aOS(1, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'name')
    ..aOM<ReusableConfigValues>(2, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'values', subBuilder: ReusableConfigValues.create)
    ...
    ..aOM<$1.Timestamp>(5, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'updateTime', subBuilder: $1.Timestamp.create)
    ..m<$core.String, $core.String>(6, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'labels', entryClassName: 'ReusableConfig.LabelsEntry', keyFieldType: $pb.PbFieldType.OS, valueFieldType: $pb.PbFieldType.OS, packageName: const $pb.PackageName('google.cloud.security.privateca.v1beta1'))
    ..hasRequiredFields = false
  ;
  ...
  'Use [GeneratedMessageGenericExtensions.rebuild] instead. '
  'Will be removed in next major version')
  ReusableConfig copyWith(void Function(ReusableConfig) updates) => super.copyWith((message) => updates(message as ReusableConfig)) as ReusableConfig; // ignore: deprecated_member_use
  $pb.BuilderInfo get info_ => _i;
  @$core.pragma('dart2js:noInline')
...
class ReusableConfigValues_CaOptions extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'ReusableConfigValues.CaOptions', package: const $pb.PackageName(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'google.cloud.security.privateca.v1beta1'), createEmptyInstance: create)
    ..aOM<$2.BoolValue>(1, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'isCa', subBuilder: $2.BoolValue.create)
    ..aOM<$2.Int32Value>(2, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'maxIssuerPathLength', subBuilder: $2.Int32Value.create)
    ..hasRequiredFields = false
  ;
  ...
  'Use [GeneratedMessageGenericExtensions.rebuild] instead. '
  'Will be removed in next major version')
  ReusableConfigValues_CaOptions copyWith(void Function(ReusableConfigValues_CaOptions) updates) => super.copyWith((message) => updates(message as ReusableConfigValues_CaOptions)) as ReusableConfigValues_CaOptions; // ignore: deprecated_member_use
  $pb.BuilderInfo get info_ => _i;
  @$core.pragma('dart2js:noInline')
  ...
  @$pb.TagNumber(1)
  set isCa($2.BoolValue v) { setField(1, v); }
  @$pb.TagNumber(1)
  ...
  @$pb.TagNumber(2)
  set maxIssuerPathLength($2.Int32Value v) { setField(2, v); }
  @$pb.TagNumber(2)
...
class ReusableConfigValues extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'ReusableConfigValues', package: const $pb.PackageName(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'google.cloud.security.privateca.v1beta1'), createEmptyInstance: create)
    ..aOM<KeyUsage>(1, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'keyUsage', subBuilder: KeyUsage.create)
    ..aOM<ReusableConfigValues_CaOptions>(2, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'caOptions', subBuilder: ReusableConfigValues_CaOptions.create)
  ...
  'Use [GeneratedMessageGenericExtensions.rebuild] instead. '
  'Will be removed in next major version')
  ReusableConfigValues copyWith(void Function(ReusableConfigValues) updates) => super.copyWith((message) => updates(message as ReusableConfigValues)) as ReusableConfigValues; // ignore: deprecated_member_use
  $pb.BuilderInfo get info_ => _i;
  @$core.pragma('dart2js:noInline')
...
class ReusableConfigWrapper extends $pb.GeneratedMessage {
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'ReusableConfigWrapper', package: const $pb.PackageName(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'google.cloud.security.privateca.v1beta1'), createEmptyInstance: create)
    ..oo(0, [1, 2])
    ..aOS(1, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'reusableConfig')
    ..aOM<ReusableConfigValues>(2, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'reusableConfigValues', subBuilder: ReusableConfigValues.create)
    ..hasRequiredFields = false
  ;
  ...
  'Use [GeneratedMessageGenericExtensions.rebuild] instead. '
  'Will be removed in next major version')
  ReusableConfigWrapper copyWith(void Function(ReusableConfigWrapper) updates) => super.copyWith((message) => updates(message as ReusableConfigWrapper)) as ReusableConfigWrapper; // ignore: deprecated_member_use
  $pb.BuilderInfo get info_ => _i;
  @$core.pragma('dart2js:noInline')
...
class SubordinateConfig_SubordinateConfigChain extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'SubordinateConfig.SubordinateConfigChain', package: const $pb.PackageName(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'google.cloud.security.privateca.v1beta1'), createEmptyInstance: create)
...
class SubordinateConfig extends $pb.GeneratedMessage {
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'SubordinateConfig', package: const $pb.PackageName(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'google.cloud.security.privateca.v1beta1'), createEmptyInstance: create)
    ..oo(0, [1, 2])
...
class PublicKey extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'PublicKey', package: const $pb.PackageName(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'google.cloud.security.privateca.v1beta1'), createEmptyInstance: create)
    ..e<PublicKey_KeyType>(1, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'type', $pb.PbFieldType.OE, defaultOrMaker: PublicKey_KeyType.KEY_TYPE_UNSPECIFIED, valueOf: PublicKey_KeyType.valueOf, enumValues: PublicKey_KeyType.values)
...
class CertificateConfig_SubjectConfig extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'CertificateConfig.SubjectConfig', package: const $pb.PackageName(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'google.cloud.security.privateca.v1beta1'), createEmptyInstance: create)
    ..aOM<Subject>(1, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'subject', subBuilder: Subject.create)
    ..aOS(2, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'commonName')
    ..aOM<SubjectAltNames>(3, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'subjectAltName', subBuilder: SubjectAltNames.create)
    ..hasRequiredFields = false
  ;
...
class CertificateConfig extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'CertificateConfig', package: const $pb.PackageName(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'google.cloud.security.privateca.v1beta1'), createEmptyInstance: create)
    ...
    ..aOM<ReusableConfigWrapper>(2, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'reusableConfig', subBuilder: ReusableConfigWrapper.create)
...
class CertificateDescription_SubjectDescription extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'CertificateDescription.SubjectDescription', package: const $pb.PackageName(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'google.cloud.security.privateca.v1beta1'), createEmptyInstance: create)
    ..aOM<Subject>(1, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'subject', subBuilder: Subject.create)
    ..aOS(2, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'commonName')
    ..aOM<SubjectAltNames>(3, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'subjectAltName', subBuilder: SubjectAltNames.create)
    ..aOS(4, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'hexSerialNumber')
    ..aOM<$0.Duration>(5, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'lifetime', subBuilder: $0.Duration.create)
    ..aOM<$1.Timestamp>(6, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'notBeforeTime', subBuilder: $1.Timestamp.create)
    ..aOM<$1.Timestamp>(7, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'notAfterTime', subBuilder: $1.Timestamp.create)
    ..hasRequiredFields = false
  ;
  ...
  @$pb.TagNumber(6)
  set notBeforeTime($1.Timestamp v) { setField(6, v); }
  @$pb.TagNumber(6)
  ...
  @$pb.TagNumber(7)
  set notAfterTime($1.Timestamp v) { setField(7, v); }
  @$pb.TagNumber(7)
...
class CertificateDescription_KeyId extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'CertificateDescription.KeyId', package: const $pb.PackageName(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'google.cloud.security.privateca.v1beta1'), createEmptyInstance: create)
...
class CertificateDescription extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'CertificateDescription', package: const $pb.PackageName(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'google.cloud.security.privateca.v1beta1'), createEmptyInstance: create)
    ...
    ..aOM<ReusableConfigValues>(2, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'configValues', subBuilder: ReusableConfigValues.create)
    ..aOM<PublicKey>(3, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'publicKey', subBuilder: PublicKey.create)
...
class ObjectId extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'ObjectId', package: const $pb.PackageName(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'google.cloud.security.privateca.v1beta1'), createEmptyInstance: create)
...
class X509Extension extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'X509Extension', package: const $pb.PackageName(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'google.cloud.security.privateca.v1beta1'), createEmptyInstance: create)
...
class KeyUsage_KeyUsageOptions extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'KeyUsage.KeyUsageOptions', package: const $pb.PackageName(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'google.cloud.security.privateca.v1beta1'), createEmptyInstance: create)
...
class KeyUsage_ExtendedKeyUsageOptions extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'KeyUsage.ExtendedKeyUsageOptions', package: const $pb.PackageName(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'google.cloud.security.privateca.v1beta1'), createEmptyInstance: create)
...
class KeyUsage extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'KeyUsage', package: const $pb.PackageName(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'google.cloud.security.privateca.v1beta1'), createEmptyInstance: create)
...
class Subject extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'Subject', package: const $pb.PackageName(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'google.cloud.security.privateca.v1beta1'), createEmptyInstance: create)
    ..aOS(1, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'countryCode')
    ..aOS(2, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'organization')
    ..aOS(3, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'organizationalUnit')
    ..aOS(4, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'locality')
    ..aOS(5, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'province')
    ..aOS(6, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'streetAddress')
    ..aOS(7, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'postalCode')
    ..hasRequiredFields = false
  ;
...
class SubjectAltNames extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'SubjectAltNames', package: const $pb.PackageName(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'google.cloud.security.privateca.v1beta1'), createEmptyInstance: create)

...
class RecognizeRequest extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'RecognizeRequest', package: const $pb.PackageName(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'google.cloud.speech.v1p1beta1'), createEmptyInstance: create)
    ...
    ..aOM<RecognitionAudio>(2, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'audio', subBuilder: RecognitionAudio.create)
...
class LongRunningRecognizeRequest extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'LongRunningRecognizeRequest', package: const $pb.PackageName(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'google.cloud.speech.v1p1beta1'), createEmptyInstance: create)
    ..aOM<RecognitionConfig>(1, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'config', subBuilder: RecognitionConfig.create)
    ..aOM<RecognitionAudio>(2, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'audio', subBuilder: RecognitionAudio.create)
    ..aOM<TranscriptOutputConfig>(4, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'outputConfig', subBuilder: TranscriptOutputConfig.create)
    ..hasRequiredFields = false
  ;
  ...
  factory LongRunningRecognizeRequest.fromBuffer($core.List<$core.int> i, [$pb.ExtensionRegistry r = $pb.ExtensionRegistry.EMPTY]) => create()..mergeFromBuffer(i, r);
  factory LongRunningRecognizeRequest.fromJson($core.String i, [$pb.ExtensionRegistry r = $pb.ExtensionRegistry.EMPTY]) => create()..mergeFromJson(i, r);
  @$core.Deprecated(
  'Using this can add significant overhead to your binary. '
  'Use [GeneratedMessageGenericExtensions.deepCopy] instead. '
  'Will be removed in next major version')
  ...
  'Use [GeneratedMessageGenericExtensions.rebuild] instead. '
  'Will be removed in next major version')
  LongRunningRecognizeRequest copyWith(void Function(LongRunningRecognizeRequest) updates) => super.copyWith((message) => updates(message as LongRunningRecognizeRequest)) as LongRunningRecognizeRequest; // ignore: deprecated_member_use
  $pb.BuilderInfo get info_ => _i;
  @$core.pragma('dart2js:noInline')
  ...
  @$pb.TagNumber(4)
  set outputConfig(TranscriptOutputConfig v) { setField(4, v); }
  @$pb.TagNumber(4)
...
class TranscriptOutputConfig extends $pb.GeneratedMessage {
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'TranscriptOutputConfig', package: const $pb.PackageName(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'google.cloud.speech.v1p1beta1'), createEmptyInstance: create)
    ..oo(0, [1])
  ...
  factory TranscriptOutputConfig.fromBuffer($core.List<$core.int> i, [$pb.ExtensionRegistry r = $pb.ExtensionRegistry.EMPTY]) => create()..mergeFromBuffer(i, r);
  factory TranscriptOutputConfig.fromJson($core.String i, [$pb.ExtensionRegistry r = $pb.ExtensionRegistry.EMPTY]) => create()..mergeFromJson(i, r);
  @$core.Deprecated(
  'Using this can add significant overhead to your binary. '
  'Use [GeneratedMessageGenericExtensions.deepCopy] instead. '
  'Will be removed in next major version')
  ...
  'Use [GeneratedMessageGenericExtensions.rebuild] instead. '
  'Will be removed in next major version')
  TranscriptOutputConfig copyWith(void Function(TranscriptOutputConfig) updates) => super.copyWith((message) => updates(message as TranscriptOutputConfig)) as TranscriptOutputConfig; // ignore: deprecated_member_use
  $pb.BuilderInfo get info_ => _i;
  @$core.pragma('dart2js:noInline')
...
class StreamingRecognizeRequest extends $pb.GeneratedMessage {
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'StreamingRecognizeRequest', package: const $pb.PackageName(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'google.cloud.speech.v1p1beta1'), createEmptyInstance: create)
    ..oo(0, [1, 2])
...
class StreamingRecognitionConfig extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'StreamingRecognitionConfig', package: const $pb.PackageName(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'google.cloud.speech.v1p1beta1'), createEmptyInstance: create)
    ..aOM<RecognitionConfig>(1, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'config', subBuilder: RecognitionConfig.create)
...
class RecognitionConfig extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'RecognitionConfig', package: const $pb.PackageName(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'google.cloud.speech.v1p1beta1'), createEmptyInstance: create)
    ..e<RecognitionConfig_AudioEncoding>(1, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'encoding', $pb.PbFieldType.OE, defaultOrMaker: RecognitionConfig_AudioEncoding.ENCODING_UNSPECIFIED, valueOf: RecognitionConfig_AudioEncoding.valueOf, enumValues: RecognitionConfig_AudioEncoding.values)
    ...
    ..aOB(5, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'profanityFilter')
    ..pc<SpeechContext>(6, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'speechContexts', $pb.PbFieldType.PM, subBuilder: SpeechContext.create)
    ...
    ..aOM<RecognitionMetadata>(9, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'metadata', subBuilder: RecognitionMetadata.create)
    ...
    ..aOB(14, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'useEnhanced')
    ..aOB(15, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'enableWordConfidence')
    ..aOB(16, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'enableSpeakerDiarization')
    ..a<$core.int>(17, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'diarizationSpeakerCount', $pb.PbFieldType.O3)
    ..pPS(18, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'alternativeLanguageCodes')
    ..aOM<SpeakerDiarizationConfig>(19, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'diarizationConfig', subBuilder: SpeakerDiarizationConfig.create)
    ..aOM<$3.SpeechAdaptation>(20, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'adaptation', subBuilder: $3.SpeechAdaptation.create)
    ..aOM<$4.BoolValue>(22, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'enableSpokenPunctuation', subBuilder: $4.BoolValue.create)
    ..aOM<$4.BoolValue>(23, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'enableSpokenEmojis', subBuilder: $4.BoolValue.create)
    ..aOM<$3.TranscriptNormalization>(24, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'transcriptNormalization', subBuilder: $3.TranscriptNormalization.create)
    ..hasRequiredFields = false
  ;
  ...
  @$core.Deprecated('This field is deprecated.')
    ...
    if (transcriptNormalization != null) {
      _result.transcriptNormalization = transcriptNormalization;
    }
    return _result;
  }
  ...
  @$pb.TagNumber(5)
  set profanityFilter($core.bool v) { $_setBool(4, v); }
  @$pb.TagNumber(5)
  ...
  @$pb.TagNumber(7)
  set audioChannelCount($core.int v) { $_setSignedInt32(6, v); }
  @$pb.TagNumber(7)
  ...
  @$pb.TagNumber(8)
  set enableWordTimeOffsets($core.bool v) { $_setBool(7, v); }
  @$pb.TagNumber(8)
  ...
  @$pb.TagNumber(9)
  set metadata(RecognitionMetadata v) { setField(9, v); }
  @$pb.TagNumber(9)
  ...
  @$pb.TagNumber(11)
  set enableAutomaticPunctuation($core.bool v) { $_setBool(9, v); }
  @$pb.TagNumber(11)
  ...
  @$pb.TagNumber(12)
  set enableSeparateRecognitionPerChannel($core.bool v) { $_setBool(10, v); }
  @$pb.TagNumber(12)
  ...
  @$pb.TagNumber(14)
  set useEnhanced($core.bool v) { $_setBool(12, v); }
  @$pb.TagNumber(14)
  ...
  @$pb.TagNumber(15)
  set enableWordConfidence($core.bool v) { $_setBool(13, v); }
  @$pb.TagNumber(15)
  ...
  @$core.Deprecated('This field is deprecated.')
  @$pb.TagNumber(16)
  set enableSpeakerDiarization($core.bool v) { $_setBool(14, v); }
  @$core.Deprecated('This field is deprecated.')
  @$pb.TagNumber(16)
  ...
  @$core.Deprecated('This field is deprecated.')
  @$pb.TagNumber(17)
  set diarizationSpeakerCount($core.int v) { $_setSignedInt32(15, v); }
  @$core.Deprecated('This field is deprecated.')
  @$pb.TagNumber(17)
  ...
  @$pb.TagNumber(19)
  set diarizationConfig(SpeakerDiarizationConfig v) { setField(19, v); }
  @$pb.TagNumber(19)
  ...
  @$pb.TagNumber(20)
  set adaptation($3.SpeechAdaptation v) { setField(20, v); }
  @$pb.TagNumber(20)
  ...
  @$pb.TagNumber(22)
  $4.BoolValue get enableSpokenPunctuation => $_getN(19);
  @$pb.TagNumber(22)
  set enableSpokenPunctuation($4.BoolValue v) { setField(22, v); }
  @$pb.TagNumber(22)
  $core.bool hasEnableSpokenPunctuation() => $_has(19);
  @$pb.TagNumber(22)
  void clearEnableSpokenPunctuation() => clearField(22);
  @$pb.TagNumber(22)
  $4.BoolValue ensureEnableSpokenPunctuation() => $_ensure(19);

  @$pb.TagNumber(23)
  $4.BoolValue get enableSpokenEmojis => $_getN(20);
  @$pb.TagNumber(23)
  set enableSpokenEmojis($4.BoolValue v) { setField(23, v); }
  @$pb.TagNumber(23)
  $core.bool hasEnableSpokenEmojis() => $_has(20);
  @$pb.TagNumber(23)
  void clearEnableSpokenEmojis() => clearField(23);
  @$pb.TagNumber(23)
  $4.BoolValue ensureEnableSpokenEmojis() => $_ensure(20);

  @$pb.TagNumber(24)
  $3.TranscriptNormalization get transcriptNormalization => $_getN(21);
  @$pb.TagNumber(24)
  set transcriptNormalization($3.TranscriptNormalization v) { setField(24, v); }
  @$pb.TagNumber(24)
  $core.bool hasTranscriptNormalization() => $_has(21);
  @$pb.TagNumber(24)
  void clearTranscriptNormalization() => clearField(24);
  @$pb.TagNumber(24)
  $3.TranscriptNormalization ensureTranscriptNormalization() => $_ensure(21);
}

class SpeakerDiarizationConfig extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'SpeakerDiarizationConfig', package: const $pb.PackageName(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'google.cloud.speech.v1p1beta1'), createEmptyInstance: create)
    ..aOB(1, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'enableSpeakerDiarization')
    ..a<$core.int>(2, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'minSpeakerCount', $pb.PbFieldType.O3)
    ..a<$core.int>(3, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'maxSpeakerCount', $pb.PbFieldType.O3)
  ...
  factory SpeakerDiarizationConfig.fromBuffer($core.List<$core.int> i, [$pb.ExtensionRegistry r = $pb.ExtensionRegistry.EMPTY]) => create()..mergeFromBuffer(i, r);
  factory SpeakerDiarizationConfig.fromJson($core.String i, [$pb.ExtensionRegistry r = $pb.ExtensionRegistry.EMPTY]) => create()..mergeFromJson(i, r);
  @$core.Deprecated(
  'Using this can add significant overhead to your binary. '
  'Use [GeneratedMessageGenericExtensions.deepCopy] instead. '
  'Will be removed in next major version')
  ...
  'Use [GeneratedMessageGenericExtensions.rebuild] instead. '
  'Will be removed in next major version')
  SpeakerDiarizationConfig copyWith(void Function(SpeakerDiarizationConfig) updates) => super.copyWith((message) => updates(message as SpeakerDiarizationConfig)) as SpeakerDiarizationConfig; // ignore: deprecated_member_use
  $pb.BuilderInfo get info_ => _i;
  @$core.pragma('dart2js:noInline')
  ...
  @$pb.TagNumber(1)
  set enableSpeakerDiarization($core.bool v) { $_setBool(0, v); }
  @$pb.TagNumber(1)
  ...
  @$pb.TagNumber(2)
  set minSpeakerCount($core.int v) { $_setSignedInt32(1, v); }
  @$pb.TagNumber(2)
  ...
  @$pb.TagNumber(3)
  set maxSpeakerCount($core.int v) { $_setSignedInt32(2, v); }
  @$pb.TagNumber(3)
  ...
  @$core.Deprecated('This field is deprecated.')
  @$pb.TagNumber(5)
  set speakerTag($core.int v) { $_setSignedInt32(3, v); }
  @$core.Deprecated('This field is deprecated.')
  @$pb.TagNumber(5)
...
class RecognitionMetadata extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'RecognitionMetadata', package: const $pb.PackageName(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'google.cloud.speech.v1p1beta1'), createEmptyInstance: create)
    ..e<RecognitionMetadata_InteractionType>(1, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'interactionType', $pb.PbFieldType.OE, defaultOrMaker: RecognitionMetadata_InteractionType.INTERACTION_TYPE_UNSPECIFIED, valueOf: RecognitionMetadata_InteractionType.valueOf, enumValues: RecognitionMetadata_InteractionType.values)
    ..a<$core.int>(3, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'industryNaicsCodeOfAudio', $pb.PbFieldType.OU3)
    ..e<RecognitionMetadata_MicrophoneDistance>(4, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'microphoneDistance', $pb.PbFieldType.OE, defaultOrMaker: RecognitionMetadata_MicrophoneDistance.MICROPHONE_DISTANCE_UNSPECIFIED, valueOf: RecognitionMetadata_MicrophoneDistance.valueOf, enumValues: RecognitionMetadata_MicrophoneDistance.values)
    ..e<RecognitionMetadata_OriginalMediaType>(5, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'originalMediaType', $pb.PbFieldType.OE, defaultOrMaker: RecognitionMetadata_OriginalMediaType.ORIGINAL_MEDIA_TYPE_UNSPECIFIED, valueOf: RecognitionMetadata_OriginalMediaType.valueOf, enumValues: RecognitionMetadata_OriginalMediaType.values)
    ..e<RecognitionMetadata_RecordingDeviceType>(6, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'recordingDeviceType', $pb.PbFieldType.OE, defaultOrMaker: RecognitionMetadata_RecordingDeviceType.RECORDING_DEVICE_TYPE_UNSPECIFIED, valueOf: RecognitionMetadata_RecordingDeviceType.valueOf, enumValues: RecognitionMetadata_RecordingDeviceType.values)
    ..aOS(7, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'recordingDeviceName')
    ..aOS(8, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'originalMimeType')
    ..aInt64(9, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'obfuscatedId')
    ..aOS(10, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'audioTopic')
    ..hasRequiredFields = false
  ;
  ...
  @$core.Deprecated('This field is deprecated.')
    ...
    if (obfuscatedId != null) {
      // ignore: deprecated_member_use_from_same_package
      _result.obfuscatedId = obfuscatedId;
    }
    if (audioTopic != null) {
  ...
  factory RecognitionMetadata.fromBuffer($core.List<$core.int> i, [$pb.ExtensionRegistry r = $pb.ExtensionRegistry.EMPTY]) => create()..mergeFromBuffer(i, r);
  factory RecognitionMetadata.fromJson($core.String i, [$pb.ExtensionRegistry r = $pb.ExtensionRegistry.EMPTY]) => create()..mergeFromJson(i, r);
  @$core.Deprecated(
  'Using this can add significant overhead to your binary. '
  'Use [GeneratedMessageGenericExtensions.deepCopy] instead. '
  'Will be removed in next major version')
  ...
  'Use [GeneratedMessageGenericExtensions.rebuild] instead. '
  'Will be removed in next major version')
  RecognitionMetadata copyWith(void Function(RecognitionMetadata) updates) => super.copyWith((message) => updates(message as RecognitionMetadata)) as RecognitionMetadata; // ignore: deprecated_member_use
  $pb.BuilderInfo get info_ => _i;
  @$core.pragma('dart2js:noInline')
  ...
  @$pb.TagNumber(1)
  set interactionType(RecognitionMetadata_InteractionType v) { setField(1, v); }
  @$pb.TagNumber(1)
  ...
  @$pb.TagNumber(3)
  set industryNaicsCodeOfAudio($core.int v) { $_setUnsignedInt32(1, v); }
  @$pb.TagNumber(3)
  ...
  @$pb.TagNumber(4)
  set microphoneDistance(RecognitionMetadata_MicrophoneDistance v) { setField(4, v); }
  @$pb.TagNumber(4)
  ...
  @$pb.TagNumber(5)
  set originalMediaType(RecognitionMetadata_OriginalMediaType v) { setField(5, v); }
  @$pb.TagNumber(5)
  ...
  @$pb.TagNumber(6)
  set recordingDeviceType(RecognitionMetadata_RecordingDeviceType v) { setField(6, v); }
  @$pb.TagNumber(6)
  ...
  @$pb.TagNumber(7)
  set recordingDeviceName($core.String v) { $_setString(5, v); }
  @$pb.TagNumber(7)
  ...
  @$pb.TagNumber(8)
  set originalMimeType($core.String v) { $_setString(6, v); }
  @$pb.TagNumber(8)
  ...
  @$core.Deprecated('This field is deprecated.')
  @$pb.TagNumber(9)
  set obfuscatedId($fixnum.Int64 v) { $_setInt64(7, v); }
  @$core.Deprecated('This field is deprecated.')
  @$pb.TagNumber(9)
  ...
  @$pb.TagNumber(10)
  set audioTopic($core.String v) { $_setString(8, v); }
  @$pb.TagNumber(10)
...
class SpeechContext extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'SpeechContext', package: const $pb.PackageName(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'google.cloud.speech.v1p1beta1'), createEmptyInstance: create)
    ..pPS(1, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'phrases')
    ..a<$core.double>(4, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'boost', $pb.PbFieldType.OF)
    ..hasRequiredFields = false
  ;
...
class RecognitionAudio extends $pb.GeneratedMessage {
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'RecognitionAudio', package: const $pb.PackageName(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'google.cloud.speech.v1p1beta1'), createEmptyInstance: create)
    ..oo(0, [1, 2])
  ...
  factory RecognitionAudio.fromBuffer($core.List<$core.int> i, [$pb.ExtensionRegistry r = $pb.ExtensionRegistry.EMPTY]) => create()..mergeFromBuffer(i, r);
  factory RecognitionAudio.fromJson($core.String i, [$pb.ExtensionRegistry r = $pb.ExtensionRegistry.EMPTY]) => create()..mergeFromJson(i, r);
  @$core.Deprecated(
  'Using this can add significant overhead to your binary. '
  'Use [GeneratedMessageGenericExtensions.deepCopy] instead. '
  'Will be removed in next major version')
  ...
  'Use [GeneratedMessageGenericExtensions.rebuild] instead. '
  'Will be removed in next major version')
  RecognitionAudio copyWith(void Function(RecognitionAudio) updates) => super.copyWith((message) => updates(message as RecognitionAudio)) as RecognitionAudio; // ignore: deprecated_member_use
  $pb.BuilderInfo get info_ => _i;
  @$core.pragma('dart2js:noInline')
...
class RecognizeResponse extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'RecognizeResponse', package: const $pb.PackageName(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'google.cloud.speech.v1p1beta1'), createEmptyInstance: create)
    ..pc<SpeechRecognitionResult>(2, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'results', $pb.PbFieldType.PM, subBuilder: SpeechRecognitionResult.create)
    ..aOM<$5.Duration>(3, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'totalBilledTime', subBuilder: $5.Duration.create)
    ..hasRequiredFields = false
  ;
  ...
  @$pb.TagNumber(3)
  set totalBilledTime($5.Duration v) { setField(3, v); }
  @$pb.TagNumber(3)
...
class LongRunningRecognizeResponse extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'LongRunningRecognizeResponse', package: const $pb.PackageName(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'google.cloud.speech.v1p1beta1'), createEmptyInstance: create)
    ..pc<SpeechRecognitionResult>(2, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'results', $pb.PbFieldType.PM, subBuilder: SpeechRecognitionResult.create)
    ..aOM<$5.Duration>(3, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'totalBilledTime', subBuilder: $5.Duration.create)
    ..aOM<TranscriptOutputConfig>(6, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'outputConfig', subBuilder: TranscriptOutputConfig.create)
    ..aOM<$6.Status>(7, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'outputError', subBuilder: $6.Status.create)
    ..hasRequiredFields = false
  ;
  ...
  factory LongRunningRecognizeResponse.fromBuffer($core.List<$core.int> i, [$pb.ExtensionRegistry r = $pb.ExtensionRegistry.EMPTY]) => create()..mergeFromBuffer(i, r);
  factory LongRunningRecognizeResponse.fromJson($core.String i, [$pb.ExtensionRegistry r = $pb.ExtensionRegistry.EMPTY]) => create()..mergeFromJson(i, r);
  @$core.Deprecated(
  'Using this can add significant overhead to your binary. '
  'Use [GeneratedMessageGenericExtensions.deepCopy] instead. '
  'Will be removed in next major version')
  ...
  'Use [GeneratedMessageGenericExtensions.rebuild] instead. '
  'Will be removed in next major version')
  LongRunningRecognizeResponse copyWith(void Function(LongRunningRecognizeResponse) updates) => super.copyWith((message) => updates(message as LongRunningRecognizeResponse)) as LongRunningRecognizeResponse; // ignore: deprecated_member_use
  $pb.BuilderInfo get info_ => _i;
  @$core.pragma('dart2js:noInline')
  ...
  TranscriptOutputConfig get outputConfig => $_getN(2);
  @$pb.TagNumber(6)
  set outputConfig(TranscriptOutputConfig v) { setField(6, v); }
  @$pb.TagNumber(6)
  $core.bool hasOutputConfig() => $_has(2);
  @$pb.TagNumber(6)
  ...
  @$pb.TagNumber(7)
  set outputError($6.Status v) { setField(7, v); }
  @$pb.TagNumber(7)
...
class LongRunningRecognizeMetadata extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'LongRunningRecognizeMetadata', package: const $pb.PackageName(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'google.cloud.speech.v1p1beta1'), createEmptyInstance: create)
    ...
    ..aOM<$7.Timestamp>(3, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'lastUpdateTime', subBuilder: $7.Timestamp.create)
    ..aOS(4, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'uri')
    ..aOM<TranscriptOutputConfig>(5, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'outputConfig', subBuilder: TranscriptOutputConfig.create)
    ..hasRequiredFields = false
  ;
  ...
  factory LongRunningRecognizeMetadata.fromBuffer($core.List<$core.int> i, [$pb.ExtensionRegistry r = $pb.ExtensionRegistry.EMPTY]) => create()..mergeFromBuffer(i, r);
  factory LongRunningRecognizeMetadata.fromJson($core.String i, [$pb.ExtensionRegistry r = $pb.ExtensionRegistry.EMPTY]) => create()..mergeFromJson(i, r);
  @$core.Deprecated(
  'Using this can add significant overhead to your binary. '
  'Use [GeneratedMessageGenericExtensions.deepCopy] instead. '
  'Will be removed in next major version')
  ...
  'Use [GeneratedMessageGenericExtensions.rebuild] instead. '
  'Will be removed in next major version')
  LongRunningRecognizeMetadata copyWith(void Function(LongRunningRecognizeMetadata) updates) => super.copyWith((message) => updates(message as LongRunningRecognizeMetadata)) as LongRunningRecognizeMetadata; // ignore: deprecated_member_use
  $pb.BuilderInfo get info_ => _i;
  @$core.pragma('dart2js:noInline')
  ...
  @$pb.TagNumber(3)
  set lastUpdateTime($7.Timestamp v) { setField(3, v); }
  @$pb.TagNumber(3)
  ...
  @$pb.TagNumber(5)
  set outputConfig(TranscriptOutputConfig v) { setField(5, v); }
  @$pb.TagNumber(5)
...
class StreamingRecognizeResponse extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'StreamingRecognizeResponse', package: const $pb.PackageName(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'google.cloud.speech.v1p1beta1'), createEmptyInstance: create)
    ..aOM<$6.Status>(1, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'error', subBuilder: $6.Status.create)
    ..pc<StreamingRecognitionResult>(2, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'results', $pb.PbFieldType.PM, subBuilder: StreamingRecognitionResult.create)
    ..e<StreamingRecognizeResponse_SpeechEventType>(4, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'speechEventType', $pb.PbFieldType.OE, defaultOrMaker: StreamingRecognizeResponse_SpeechEventType.SPEECH_EVENT_UNSPECIFIED, valueOf: StreamingRecognizeResponse_SpeechEventType.valueOf, enumValues: StreamingRecognizeResponse_SpeechEventType.values)
    ..aOM<$5.Duration>(5, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'totalBilledTime', subBuilder: $5.Duration.create)
    ..hasRequiredFields = false
  ;
  ...
  @$pb.TagNumber(1)
  set error($6.Status v) { setField(1, v); }
  @$pb.TagNumber(1)
  ...
  @$pb.TagNumber(5)
  set totalBilledTime($5.Duration v) { setField(5, v); }
  @$pb.TagNumber(5)
...
class StreamingRecognitionResult extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'StreamingRecognitionResult', package: const $pb.PackageName(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'google.cloud.speech.v1p1beta1'), createEmptyInstance: create)
    ...
    ..aOM<$5.Duration>(4, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'resultEndTime', subBuilder: $5.Duration.create)
  ...
  @$pb.TagNumber(4)
  set resultEndTime($5.Duration v) { setField(4, v); }
  @$pb.TagNumber(4)
...
class SpeechRecognitionResult extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'SpeechRecognitionResult', package: const $pb.PackageName(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'google.cloud.speech.v1p1beta1'), createEmptyInstance: create)
    ..pc<SpeechRecognitionAlternative>(1, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'alternatives', $pb.PbFieldType.PM, subBuilder: SpeechRecognitionAlternative.create)
...
class SpeechRecognitionAlternative extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'SpeechRecognitionAlternative', package: const $pb.PackageName(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'google.cloud.speech.v1p1beta1'), createEmptyInstance: create)
...
class WordInfo extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'WordInfo', package: const $pb.PackageName(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'google.cloud.speech.v1p1beta1'), createEmptyInstance: create)
    ..aOM<$5.Duration>(1, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'startTime', subBuilder: $5.Duration.create)
    ..aOM<$5.Duration>(2, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'endTime', subBuilder: $5.Duration.create)
  ...
  @$pb.TagNumber(1)
  set startTime($5.Duration v) { setField(1, v); }
  @$pb.TagNumber(1)
  ...
  @$pb.TagNumber(2)
  set endTime($5.Duration v) { setField(2, v); }
  @$pb.TagNumber(2)

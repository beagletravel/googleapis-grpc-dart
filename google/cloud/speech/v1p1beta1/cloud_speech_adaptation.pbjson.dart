...
const CreatePhraseSetRequest$json = const {
  ...
  '2': const [
    ...
    const {'1': 'phrase_set', '3': 3, '4': 1, '5': 11, '6': '.google.cloud.speech.v1p1beta1.PhraseSet', '8': const {}, '10': 'phraseSet'},
  ],
};

/// Descriptor for `CreatePhraseSetRequest`. Decode as a `google.protobuf.DescriptorProto`.
final $typed_data.Uint8List createPhraseSetRequestDescriptor = $convert.base64Decode('');
...
const UpdatePhraseSetRequest$json = const {
  ...
  '2': const [
    const {'1': 'phrase_set', '3': 1, '4': 1, '5': 11, '6': '.google.cloud.speech.v1p1beta1.PhraseSet', '8': const {}, '10': 'phraseSet'},
    const {'1': 'update_mask', '3': 2, '4': 1, '5': 11, '6': '.google.protobuf.FieldMask', '10': 'updateMask'},
  ],
};

/// Descriptor for `UpdatePhraseSetRequest`. Decode as a `google.protobuf.DescriptorProto`.
final $typed_data.Uint8List updatePhraseSetRequestDescriptor = $convert.base64Decode('ChZVcGRhdGVQaHJhc2VTZXRSZXF1ZXN0EkwKCnBocmFzZV9zZXQYASABKAsyKC5nb29nbGUuY2xvdWQuc3BlZWNoLnYxcDFiZXRhMS5QaHJhc2VTZXRCA+BBAlIJcGhyYXNlU2V0EjsKC3VwZGF0ZV9tYXNrGAIgASgLMhouZ29vZ2xlLnByb3RvYnVmLkZpZWxkTWFza1IKdXBkYXRlTWFzaw==');
...
const ListPhraseSetResponse$json = const {
  ...
  '2': const [
    const {'1': 'phrase_sets', '3': 1, '4': 3, '5': 11, '6': '.google.cloud.speech.v1p1beta1.PhraseSet', '10': 'phraseSets'},
    const {'1': 'next_page_token', '3': 2, '4': 1, '5': 9, '10': 'nextPageToken'},
  ],
};

/// Descriptor for `ListPhraseSetResponse`. Decode as a `google.protobuf.DescriptorProto`.
final $typed_data.Uint8List listPhraseSetResponseDescriptor = $convert.base64Decode('ChVMaXN0UGhyYXNlU2V0UmVzcG9uc2USSQoLcGhyYXNlX3NldHMYASADKAsyKC5nb29nbGUuY2xvdWQuc3BlZWNoLnYxcDFiZXRhMS5QaHJhc2VTZXRSCnBocmFzZVNldHMSJgoPbmV4dF9wYWdlX3Rva2VuGAIgASgJUg1uZXh0UGFnZVRva2Vu');
...
const CreateCustomClassRequest$json = const {
  ...
  '2': const [
    ...
    const {'1': 'custom_class', '3': 3, '4': 1, '5': 11, '6': '.google.cloud.speech.v1p1beta1.CustomClass', '8': const {}, '10': 'customClass'},
  ],
};

/// Descriptor for `CreateCustomClassRequest`. Decode as a `google.protobuf.DescriptorProto`.
final $typed_data.Uint8List createCustomClassRequestDescriptor = $convert.base64Decode('');
...
const UpdateCustomClassRequest$json = const {
  ...
  '2': const [
    const {'1': 'custom_class', '3': 1, '4': 1, '5': 11, '6': '.google.cloud.speech.v1p1beta1.CustomClass', '8': const {}, '10': 'customClass'},
    const {'1': 'update_mask', '3': 2, '4': 1, '5': 11, '6': '.google.protobuf.FieldMask', '10': 'updateMask'},
  ],
};

/// Descriptor for `UpdateCustomClassRequest`. Decode as a `google.protobuf.DescriptorProto`.
final $typed_data.Uint8List updateCustomClassRequestDescriptor = $convert.base64Decode('ChhVcGRhdGVDdXN0b21DbGFzc1JlcXVlc3QSUgoMY3VzdG9tX2NsYXNzGAEgASgLMiouZ29vZ2xlLmNsb3VkLnNwZWVjaC52MXAxYmV0YTEuQ3VzdG9tQ2xhc3NCA+BBAlILY3VzdG9tQ2xhc3MSOwoLdXBkYXRlX21hc2sYAiABKAsyGi5nb29nbGUucHJvdG9idWYuRmllbGRNYXNrUgp1cGRhdGVNYXNr');
...
const ListCustomClassesResponse$json = const {
  ...
  '2': const [
    const {'1': 'custom_classes', '3': 1, '4': 3, '5': 11, '6': '.google.cloud.speech.v1p1beta1.CustomClass', '10': 'customClasses'},
    const {'1': 'next_page_token', '3': 2, '4': 1, '5': 9, '10': 'nextPageToken'},
  ],
};

/// Descriptor for `ListCustomClassesResponse`. Decode as a `google.protobuf.DescriptorProto`.
final $typed_data.Uint8List listCustomClassesResponseDescriptor = $convert.base64Decode('ChlMaXN0Q3VzdG9tQ2xhc3Nlc1Jlc3BvbnNlElEKDmN1c3RvbV9jbGFzc2VzGAEgAygLMiouZ29vZ2xlLmNsb3VkLnNwZWVjaC52MXAxYmV0YTEuQ3VzdG9tQ2xhc3NSDWN1c3RvbUNsYXNzZXMSJgoPbmV4dF9wYWdlX3Rva2VuGAIgASgJUg1uZXh0UGFnZVRva2Vu');

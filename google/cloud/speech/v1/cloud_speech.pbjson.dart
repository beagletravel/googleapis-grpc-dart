...
const RecognizeRequest$json = const {
  '1': 'RecognizeRequest',
  '2': const [
    const {'1': 'config', '3': 1, '4': 1, '5': 11, '6': '.google.cloud.speech.v1.RecognitionConfig', '8': const {}, '10': 'config'},
    const {'1': 'audio', '3': 2, '4': 1, '5': 11, '6': '.google.cloud.speech.v1.RecognitionAudio', '8': const {}, '10': 'audio'},
  ],
};

/// Descriptor for `RecognizeRequest`. Decode as a `google.protobuf.DescriptorProto`.
final $typed_data.Uint8List recognizeRequestDescriptor = $convert.base64Decode('ChBSZWNvZ25pemVSZXF1ZXN0EkYKBmNvbmZpZxgBIAEoCzIpLmdvb2dsZS5jbG91ZC5zcGVlY2gudjEuUmVjb2duaXRpb25Db25maWdCA+BBAlIGY29uZmlnEkMKBWF1ZGlvGAIgASgLMiguZ29vZ2xlLmNsb3VkLnNwZWVjaC52MS5SZWNvZ25pdGlvbkF1ZGlvQgPgQQJSBWF1ZGlv');
...
const LongRunningRecognizeRequest$json = const {
  ...
  '2': const [
    const {'1': 'config', '3': 1, '4': 1, '5': 11, '6': '.google.cloud.speech.v1.RecognitionConfig', '8': const {}, '10': 'config'},
    const {'1': 'audio', '3': 2, '4': 1, '5': 11, '6': '.google.cloud.speech.v1.RecognitionAudio', '8': const {}, '10': 'audio'},
    const {'1': 'output_config', '3': 4, '4': 1, '5': 11, '6': '.google.cloud.speech.v1.TranscriptOutputConfig', '8': const {}, '10': 'outputConfig'},
  ],
};

/// Descriptor for `LongRunningRecognizeRequest`. Decode as a `google.protobuf.DescriptorProto`.
final $typed_data.Uint8List longRunningRecognizeRequestDescriptor = $convert.base64Decode('');
...
final $typed_data.Uint8List streamingRecognizeRequestDescriptor = $convert.base64Decode('ChlTdHJlYW1pbmdSZWNvZ25pemVSZXF1ZXN0El8KEHN0cmVhbWluZ19jb25maWcYASABKAsyMi5nb29nbGUuY2xvdWQuc3BlZWNoLnYxLlN0cmVhbWluZ1JlY29nbml0aW9uQ29uZmlnSABSD3N0cmVhbWluZ0NvbmZpZxIlCg1hdWRpb19jb250ZW50GAIgASgMSABSDGF1ZGlvQ29udGVudEITChFzdHJlYW1pbmdfcmVxdWVzdA==');
...
final $typed_data.Uint8List streamingRecognitionConfigDescriptor = $convert.base64Decode('ChpTdHJlYW1pbmdSZWNvZ25pdGlvbkNvbmZpZxJGCgZjb25maWcYASABKAsyKS5nb29nbGUuY2xvdWQuc3BlZWNoLnYxLlJlY29nbml0aW9uQ29uZmlnQgPgQQJSBmNvbmZpZxIpChBzaW5nbGVfdXR0ZXJhbmNlGAIgASgIUg9zaW5nbGVVdHRlcmFuY2USJwoPaW50ZXJpbV9yZXN1bHRzGAMgASgIUg5pbnRlcmltUmVzdWx0cw==');
...
const RecognitionConfig$json = const {
  ...
  '2': const [
    ...
    const {'1': 'adaptation', '3': 20, '4': 1, '5': 11, '6': '.google.cloud.speech.v1.SpeechAdaptation', '10': 'adaptation'},
    ...
    const {'1': 'diarization_config', '3': 19, '4': 1, '5': 11, '6': '.google.cloud.speech.v1.SpeakerDiarizationConfig', '10': 'diarizationConfig'},
...
const RecognitionMetadata$json = const {
  ...
  '2': const [
    const {'1': 'interaction_type', '3': 1, '4': 1, '5': 14, '6': '.google.cloud.speech.v1.RecognitionMetadata.InteractionType', '10': 'interactionType'},
    const {'1': 'industry_naics_code_of_audio', '3': 3, '4': 1, '5': 13, '10': 'industryNaicsCodeOfAudio'},
    const {'1': 'microphone_distance', '3': 4, '4': 1, '5': 14, '6': '.google.cloud.speech.v1.RecognitionMetadata.MicrophoneDistance', '10': 'microphoneDistance'},
    const {'1': 'original_media_type', '3': 5, '4': 1, '5': 14, '6': '.google.cloud.speech.v1.RecognitionMetadata.OriginalMediaType', '10': 'originalMediaType'},
    const {'1': 'recording_device_type', '3': 6, '4': 1, '5': 14, '6': '.google.cloud.speech.v1.RecognitionMetadata.RecordingDeviceType', '10': 'recordingDeviceType'},
...
final $typed_data.Uint8List recognitionMetadataDescriptor = $convert.base64Decode('');
...
final $typed_data.Uint8List recognizeResponseDescriptor = $convert.base64Decode('ChFSZWNvZ25pemVSZXNwb25zZRJJCgdyZXN1bHRzGAIgAygLMi8uZ29vZ2xlLmNsb3VkLnNwZWVjaC52MS5TcGVlY2hSZWNvZ25pdGlvblJlc3VsdFIHcmVzdWx0cxJFChF0b3RhbF9iaWxsZWRfdGltZRgDIAEoCzIZLmdvb2dsZS5wcm90b2J1Zi5EdXJhdGlvblIPdG90YWxCaWxsZWRUaW1l');
...
const LongRunningRecognizeResponse$json = const {
  ...
  '2': const [
    const {'1': 'results', '3': 2, '4': 3, '5': 11, '6': '.google.cloud.speech.v1.SpeechRecognitionResult', '10': 'results'},
    const {'1': 'total_billed_time', '3': 3, '4': 1, '5': 11, '6': '.google.protobuf.Duration', '10': 'totalBilledTime'},
    const {'1': 'output_config', '3': 6, '4': 1, '5': 11, '6': '.google.cloud.speech.v1.TranscriptOutputConfig', '10': 'outputConfig'},
...
final $typed_data.Uint8List longRunningRecognizeResponseDescriptor = $convert.base64Decode('');
...
final $typed_data.Uint8List streamingRecognizeResponseDescriptor = $convert.base64Decode('');
...
final $typed_data.Uint8List streamingRecognitionResultDescriptor = $convert.base64Decode('');
...
final $typed_data.Uint8List speechRecognitionResultDescriptor = $convert.base64Decode('');
...
final $typed_data.Uint8List speechRecognitionAlternativeDescriptor = $convert.base64Decode('ChxTcGVlY2hSZWNvZ25pdGlvbkFsdGVybmF0aXZlEh4KCnRyYW5zY3JpcHQYASABKAlSCnRyYW5zY3JpcHQSHgoKY29uZmlkZW5jZRgCIAEoAlIKY29uZmlkZW5jZRI2CgV3b3JkcxgDIAMoCzIgLmdvb2dsZS5jbG91ZC5zcGVlY2gudjEuV29yZEluZm9SBXdvcmRz');

...
class SuggestQueriesRequest extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'SuggestQueriesRequest', package: const $pb.PackageName(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'google.cloud.dataqna.v1alpha'), createEmptyInstance: create)
    ...
    ..pc<SuggestionType>(4, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'suggestionTypes', $pb.PbFieldType.PE, valueOf: SuggestionType.valueOf, enumValues: SuggestionType.values)
  ...
  'Will be removed in next major version')
  SuggestQueriesRequest copyWith(void Function(SuggestQueriesRequest) updates) => super.copyWith((message) => updates(message as SuggestQueriesRequest)) as SuggestQueriesRequest; // ignore: deprecated_member_use
...
class Suggestion extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'Suggestion', package: const $pb.PackageName(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'google.cloud.dataqna.v1alpha'), createEmptyInstance: create)
    ..aOM<SuggestionInfo>(1, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'suggestionInfo', subBuilder: SuggestionInfo.create)
    ..a<$core.double>(2, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'rankingScore', $pb.PbFieldType.OD)
    ..e<SuggestionType>(3, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'suggestionType', $pb.PbFieldType.OE, defaultOrMaker: SuggestionType.SUGGESTION_TYPE_UNSPECIFIED, valueOf: SuggestionType.valueOf, enumValues: SuggestionType.values)
    ..hasRequiredFields = false
  ;
...
class SuggestionInfo_MatchInfo extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'SuggestionInfo.MatchInfo', package: const $pb.PackageName(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'google.cloud.dataqna.v1alpha'), createEmptyInstance: create)
    ..a<$core.int>(1, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'startCharIndex', $pb.PbFieldType.O3)
  ...
  'Use [GeneratedMessageGenericExtensions.rebuild] instead. '
  'Will be removed in next major version')
  SuggestionInfo_MatchInfo copyWith(void Function(SuggestionInfo_MatchInfo) updates) => super.copyWith((message) => updates(message as SuggestionInfo_MatchInfo)) as SuggestionInfo_MatchInfo; // ignore: deprecated_member_use
  $pb.BuilderInfo get info_ => _i;
  @$core.pragma('dart2js:noInline')
...
class SuggestionInfo extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'SuggestionInfo', package: const $pb.PackageName(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'google.cloud.dataqna.v1alpha'), createEmptyInstance: create)
    ..aOM<$1.AnnotatedString>(1, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'annotatedSuggestion', subBuilder: $1.AnnotatedString.create)
    ..pc<SuggestionInfo_MatchInfo>(2, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'queryMatches', $pb.PbFieldType.PM, subBuilder: SuggestionInfo_MatchInfo.create)
    ..hasRequiredFields = false
  ;
  ...
  'Use [GeneratedMessageGenericExtensions.rebuild] instead. '
  'Will be removed in next major version')
  SuggestionInfo copyWith(void Function(SuggestionInfo) updates) => super.copyWith((message) => updates(message as SuggestionInfo)) as SuggestionInfo; // ignore: deprecated_member_use
  $pb.BuilderInfo get info_ => _i;
  @$core.pragma('dart2js:noInline')
  ...
  @$pb.TagNumber(1)
  set annotatedSuggestion($1.AnnotatedString v) { setField(1, v); }
  @$pb.TagNumber(1)
...
class SuggestQueriesResponse extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'SuggestQueriesResponse', package: const $pb.PackageName(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'google.cloud.dataqna.v1alpha'), createEmptyInstance: create)
  ...
  'Use [GeneratedMessageGenericExtensions.rebuild] instead. '
  'Will be removed in next major version')
  SuggestQueriesResponse copyWith(void Function(SuggestQueriesResponse) updates) => super.copyWith((message) => updates(message as SuggestQueriesResponse)) as SuggestQueriesResponse; // ignore: deprecated_member_use
  $pb.BuilderInfo get info_ => _i;
  @$core.pragma('dart2js:noInline')

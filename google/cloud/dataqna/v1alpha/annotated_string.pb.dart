...
class AnnotatedString_SemanticMarkup extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'AnnotatedString.SemanticMarkup', package: const $pb.PackageName(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'google.cloud.dataqna.v1alpha'), createEmptyInstance: create)
    ..e<AnnotatedString_SemanticMarkupType>(1, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'type', $pb.PbFieldType.OE, defaultOrMaker: AnnotatedString_SemanticMarkupType.MARKUP_TYPE_UNSPECIFIED, valueOf: AnnotatedString_SemanticMarkupType.valueOf, enumValues: AnnotatedString_SemanticMarkupType.values)
    ..a<$core.int>(2, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'startCharIndex', $pb.PbFieldType.O3)
  ...
  'Will be removed in next major version')
  AnnotatedString_SemanticMarkup copyWith(void Function(AnnotatedString_SemanticMarkup) updates) => super.copyWith((message) => updates(message as AnnotatedString_SemanticMarkup)) as AnnotatedString_SemanticMarkup; // ignore: deprecated_member_use
...
class AnnotatedString extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'AnnotatedString', package: const $pb.PackageName(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'google.cloud.dataqna.v1alpha'), createEmptyInstance: create)
    ..aOS(1, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'textFormatted')
    ..aOS(2, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'htmlFormatted')
    ..pc<AnnotatedString_SemanticMarkup>(3, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'markups', $pb.PbFieldType.PM, subBuilder: AnnotatedString_SemanticMarkup.create)
    ..hasRequiredFields = false
  ;
  ...
  'Use [GeneratedMessageGenericExtensions.rebuild] instead. '
  'Will be removed in next major version')
  AnnotatedString copyWith(void Function(AnnotatedString) updates) => super.copyWith((message) => updates(message as AnnotatedString)) as AnnotatedString; // ignore: deprecated_member_use
  $pb.BuilderInfo get info_ => _i;
  @$core.pragma('dart2js:noInline')

...
class UserFeedback extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'UserFeedback', package: const $pb.PackageName(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'google.cloud.dataqna.v1alpha'), createEmptyInstance: create)
    ..aOS(1, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'name')
    ..aOS(2, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'freeFormFeedback')
    ..e<UserFeedback_UserFeedbackRating>(3, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'rating', $pb.PbFieldType.OE, defaultOrMaker: UserFeedback_UserFeedbackRating.USER_FEEDBACK_RATING_UNSPECIFIED, valueOf: UserFeedback_UserFeedbackRating.valueOf, enumValues: UserFeedback_UserFeedbackRating.values)
  ...
  'Will be removed in next major version')
  UserFeedback copyWith(void Function(UserFeedback) updates) => super.copyWith((message) => updates(message as UserFeedback)) as UserFeedback; // ignore: deprecated_member_use

...
class Question extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'Question', package: const $pb.PackageName(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'google.cloud.dataqna.v1alpha'), createEmptyInstance: create)
    ...
    ..pPS(4, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'dataSourceAnnotations')
    ..aOM<InterpretError>(5, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'interpretError', subBuilder: InterpretError.create)
    ..pc<Interpretation>(6, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'interpretations', $pb.PbFieldType.PM, subBuilder: Interpretation.create)
    ...
    ..aOM<DebugFlags>(9, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'debugFlags', subBuilder: DebugFlags.create)
    ..aOM<$1.Any>(10, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'debugInfo', subBuilder: $1.Any.create)
  ...
  @$pb.TagNumber(10)
  set debugInfo($1.Any v) { setField(10, v); }
  @$pb.TagNumber(10)
...
class InterpretError_InterpretErrorDetails extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'InterpretError.InterpretErrorDetails', package: const $pb.PackageName(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'google.cloud.dataqna.v1alpha'), createEmptyInstance: create)
    ..aOM<InterpretError_InterpretUnsupportedDetails>(1, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'unsupportedDetails', subBuilder: InterpretError_InterpretUnsupportedDetails.create)
    ..aOM<InterpretError_InterpretIncompleteQueryDetails>(2, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'incompleteQueryDetails', subBuilder: InterpretError_InterpretIncompleteQueryDetails.create)
    ..aOM<InterpretError_InterpretAmbiguityDetails>(3, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'ambiguityDetails', subBuilder: InterpretError_InterpretAmbiguityDetails.create)
    ..hasRequiredFields = false
  ;
  ...
  'Use [GeneratedMessageGenericExtensions.rebuild] instead. '
  'Will be removed in next major version')
  InterpretError_InterpretErrorDetails copyWith(void Function(InterpretError_InterpretErrorDetails) updates) => super.copyWith((message) => updates(message as InterpretError_InterpretErrorDetails)) as InterpretError_InterpretErrorDetails; // ignore: deprecated_member_use
  $pb.BuilderInfo get info_ => _i;
  @$core.pragma('dart2js:noInline')
...
class InterpretError_InterpretUnsupportedDetails extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'InterpretError.InterpretUnsupportedDetails', package: const $pb.PackageName(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'google.cloud.dataqna.v1alpha'), createEmptyInstance: create)
    ..pPS(1, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'operators')
    ..pPS(2, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'intent')
    ..hasRequiredFields = false
  ;
  ...
  'Use [GeneratedMessageGenericExtensions.rebuild] instead. '
  'Will be removed in next major version')
  InterpretError_InterpretUnsupportedDetails copyWith(void Function(InterpretError_InterpretUnsupportedDetails) updates) => super.copyWith((message) => updates(message as InterpretError_InterpretUnsupportedDetails)) as InterpretError_InterpretUnsupportedDetails; // ignore: deprecated_member_use
  $pb.BuilderInfo get info_ => _i;
  @$core.pragma('dart2js:noInline')
...
class InterpretError_InterpretIncompleteQueryDetails extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'InterpretError.InterpretIncompleteQueryDetails', package: const $pb.PackageName(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'google.cloud.dataqna.v1alpha'), createEmptyInstance: create)
    ..pc<InterpretEntity>(1, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'entities', $pb.PbFieldType.PE, valueOf: InterpretEntity.valueOf, enumValues: InterpretEntity.values)
    ..hasRequiredFields = false
  ;
  ...
  'Use [GeneratedMessageGenericExtensions.rebuild] instead. '
  'Will be removed in next major version')
  InterpretError_InterpretIncompleteQueryDetails copyWith(void Function(InterpretError_InterpretIncompleteQueryDetails) updates) => super.copyWith((message) => updates(message as InterpretError_InterpretIncompleteQueryDetails)) as InterpretError_InterpretIncompleteQueryDetails; // ignore: deprecated_member_use
  $pb.BuilderInfo get info_ => _i;
  @$core.pragma('dart2js:noInline')
...
class InterpretError_InterpretAmbiguityDetails extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'InterpretError.InterpretAmbiguityDetails', package: const $pb.PackageName(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'google.cloud.dataqna.v1alpha'), createEmptyInstance: create)
    ..hasRequiredFields = false
  ;
  ...
  'Use [GeneratedMessageGenericExtensions.rebuild] instead. '
  'Will be removed in next major version')
  InterpretError_InterpretAmbiguityDetails copyWith(void Function(InterpretError_InterpretAmbiguityDetails) updates) => super.copyWith((message) => updates(message as InterpretError_InterpretAmbiguityDetails)) as InterpretError_InterpretAmbiguityDetails; // ignore: deprecated_member_use
  $pb.BuilderInfo get info_ => _i;
  @$core.pragma('dart2js:noInline')
...
class InterpretError extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'InterpretError', package: const $pb.PackageName(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'google.cloud.dataqna.v1alpha'), createEmptyInstance: create)
    ..aOS(1, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'message')
    ..e<InterpretError_InterpretErrorCode>(2, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'code', $pb.PbFieldType.OE, defaultOrMaker: InterpretError_InterpretErrorCode.INTERPRET_ERROR_CODE_UNSPECIFIED, valueOf: InterpretError_InterpretErrorCode.valueOf, enumValues: InterpretError_InterpretErrorCode.values)
    ..aOM<InterpretError_InterpretErrorDetails>(3, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'details', subBuilder: InterpretError_InterpretErrorDetails.create)
    ..hasRequiredFields = false
  ;
  ...
  'Use [GeneratedMessageGenericExtensions.rebuild] instead. '
  'Will be removed in next major version')
  InterpretError copyWith(void Function(InterpretError) updates) => super.copyWith((message) => updates(message as InterpretError)) as InterpretError; // ignore: deprecated_member_use
  $pb.BuilderInfo get info_ => _i;
  @$core.pragma('dart2js:noInline')
...
class ExecutionInfo extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'ExecutionInfo', package: const $pb.PackageName(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'google.cloud.dataqna.v1alpha'), createEmptyInstance: create)
    ..aOM<$2.Status>(1, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'jobCreationStatus', subBuilder: $2.Status.create)
    ..e<ExecutionInfo_JobExecutionState>(2, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'jobExecutionState', $pb.PbFieldType.OE, defaultOrMaker: ExecutionInfo_JobExecutionState.JOB_EXECUTION_STATE_UNSPECIFIED, valueOf: ExecutionInfo_JobExecutionState.valueOf, enumValues: ExecutionInfo_JobExecutionState.values)
    ..aOM<$0.Timestamp>(3, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'createTime', subBuilder: $0.Timestamp.create)
    ..aOM<BigQueryJob>(4, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'bigqueryJob', subBuilder: BigQueryJob.create)
    ..hasRequiredFields = false
  ;
  ...
  'Use [GeneratedMessageGenericExtensions.rebuild] instead. '
  'Will be removed in next major version')
  ExecutionInfo copyWith(void Function(ExecutionInfo) updates) => super.copyWith((message) => updates(message as ExecutionInfo)) as ExecutionInfo; // ignore: deprecated_member_use
  $pb.BuilderInfo get info_ => _i;
  @$core.pragma('dart2js:noInline')
  ...
  @$pb.TagNumber(1)
  set jobCreationStatus($2.Status v) { setField(1, v); }
  @$pb.TagNumber(1)
...
class BigQueryJob extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'BigQueryJob', package: const $pb.PackageName(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'google.cloud.dataqna.v1alpha'), createEmptyInstance: create)
  ...
  'Use [GeneratedMessageGenericExtensions.rebuild] instead. '
  'Will be removed in next major version')
  BigQueryJob copyWith(void Function(BigQueryJob) updates) => super.copyWith((message) => updates(message as BigQueryJob)) as BigQueryJob; // ignore: deprecated_member_use
  $pb.BuilderInfo get info_ => _i;
  @$core.pragma('dart2js:noInline')
...
class Interpretation extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'Interpretation', package: const $pb.PackageName(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'google.cloud.dataqna.v1alpha'), createEmptyInstance: create)
    ..pPS(1, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'dataSources')
    ..a<$core.double>(2, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'confidence', $pb.PbFieldType.OD)
    ..pPS(3, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'unusedPhrases')
    ..aOM<HumanReadable>(4, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'humanReadable', subBuilder: HumanReadable.create)
    ..aOM<InterpretationStructure>(5, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'interpretationStructure', subBuilder: InterpretationStructure.create)
    ..aOM<DataQuery>(6, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'dataQuery', subBuilder: DataQuery.create)
    ..aOM<ExecutionInfo>(7, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'executionInfo', subBuilder: ExecutionInfo.create)
    ..hasRequiredFields = false
  ;
  ...
  'Use [GeneratedMessageGenericExtensions.rebuild] instead. '
  'Will be removed in next major version')
  Interpretation copyWith(void Function(Interpretation) updates) => super.copyWith((message) => updates(message as Interpretation)) as Interpretation; // ignore: deprecated_member_use
  $pb.BuilderInfo get info_ => _i;
  @$core.pragma('dart2js:noInline')
...
class DataQuery extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'DataQuery', package: const $pb.PackageName(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'google.cloud.dataqna.v1alpha'), createEmptyInstance: create)
  ...
  'Use [GeneratedMessageGenericExtensions.rebuild] instead. '
  'Will be removed in next major version')
  DataQuery copyWith(void Function(DataQuery) updates) => super.copyWith((message) => updates(message as DataQuery)) as DataQuery; // ignore: deprecated_member_use
  $pb.BuilderInfo get info_ => _i;
  @$core.pragma('dart2js:noInline')
...
class HumanReadable extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'HumanReadable', package: const $pb.PackageName(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'google.cloud.dataqna.v1alpha'), createEmptyInstance: create)
    ..aOM<$3.AnnotatedString>(1, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'generatedInterpretation', subBuilder: $3.AnnotatedString.create)
    ..aOM<$3.AnnotatedString>(2, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'originalQuestion', subBuilder: $3.AnnotatedString.create)
    ..hasRequiredFields = false
  ;
  ...
  'Use [GeneratedMessageGenericExtensions.rebuild] instead. '
  'Will be removed in next major version')
  HumanReadable copyWith(void Function(HumanReadable) updates) => super.copyWith((message) => updates(message as HumanReadable)) as HumanReadable; // ignore: deprecated_member_use
  $pb.BuilderInfo get info_ => _i;
  @$core.pragma('dart2js:noInline')
  ...
  @$pb.TagNumber(1)
  set generatedInterpretation($3.AnnotatedString v) { setField(1, v); }
  @$pb.TagNumber(1)
  ...
  @$pb.TagNumber(2)
  set originalQuestion($3.AnnotatedString v) { setField(2, v); }
  @$pb.TagNumber(2)
...
class InterpretationStructure_ColumnInfo extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'InterpretationStructure.ColumnInfo', package: const $pb.PackageName(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'google.cloud.dataqna.v1alpha'), createEmptyInstance: create)
    ..aOS(1, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'outputAlias')
  ...
  'Use [GeneratedMessageGenericExtensions.rebuild] instead. '
  'Will be removed in next major version')
  InterpretationStructure_ColumnInfo copyWith(void Function(InterpretationStructure_ColumnInfo) updates) => super.copyWith((message) => updates(message as InterpretationStructure_ColumnInfo)) as InterpretationStructure_ColumnInfo; // ignore: deprecated_member_use
  $pb.BuilderInfo get info_ => _i;
  @$core.pragma('dart2js:noInline')
...
class InterpretationStructure extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'InterpretationStructure', package: const $pb.PackageName(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'google.cloud.dataqna.v1alpha'), createEmptyInstance: create)
    ..pc<InterpretationStructure_VisualizationType>(1, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'visualizationTypes', $pb.PbFieldType.PE, valueOf: InterpretationStructure_VisualizationType.valueOf, enumValues: InterpretationStructure_VisualizationType.values)
    ..pc<InterpretationStructure_ColumnInfo>(2, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'columnInfo', $pb.PbFieldType.PM, subBuilder: InterpretationStructure_ColumnInfo.create)
    ..hasRequiredFields = false
  ;
  ...
  'Use [GeneratedMessageGenericExtensions.rebuild] instead. '
  'Will be removed in next major version')
  InterpretationStructure copyWith(void Function(InterpretationStructure) updates) => super.copyWith((message) => updates(message as InterpretationStructure)) as InterpretationStructure; // ignore: deprecated_member_use
  $pb.BuilderInfo get info_ => _i;
  @$core.pragma('dart2js:noInline')
...
class DebugFlags extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'DebugFlags', package: const $pb.PackageName(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'google.cloud.dataqna.v1alpha'), createEmptyInstance: create)
    ..aOB(1, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'includeVaQuery')
    ..aOB(2, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'includeNestedVaQuery')
    ..aOB(3, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'includeHumanInterpretation')
    ..aOB(4, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'includeAquaDebugResponse')
    ..aInt64(5, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'timeOverride')
    ..aOB(6, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'isInternalGoogleUser')
    ..aOB(7, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'ignoreCache')
    ..aOB(8, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'includeSearchEntitiesRpc')
    ..aOB(9, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'includeListColumnAnnotationsRpc')
    ..aOB(10, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'includeVirtualAnalystEntities')
    ..aOB(11, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'includeTableList')
    ..aOB(12, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'includeDomainList')
    ..hasRequiredFields = false
  ;
  ...
  'Use [GeneratedMessageGenericExtensions.rebuild] instead. '
  'Will be removed in next major version')
  DebugFlags copyWith(void Function(DebugFlags) updates) => super.copyWith((message) => updates(message as DebugFlags)) as DebugFlags; // ignore: deprecated_member_use
  $pb.BuilderInfo get info_ => _i;
  @$core.pragma('dart2js:noInline')

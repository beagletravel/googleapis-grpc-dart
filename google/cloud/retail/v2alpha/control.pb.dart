...
class Control extends $pb.GeneratedMessage {
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'Control', package: const $pb.PackageName(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'google.cloud.retail.v2alpha'), createEmptyInstance: create)
    ..oo(0, [3, 4])
    ...
    ..pc<$1.SearchSolutionUseCase>(7, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'searchSolutionUseCase', $pb.PbFieldType.PE, valueOf: $1.SearchSolutionUseCase.valueOf, enumValues: $1.SearchSolutionUseCase.values)
  ...
  factory Control({
    ...
    $core.Iterable<$1.SearchSolutionUseCase>? searchSolutionUseCase,
  }) {
    ...
    if (searchSolutionUseCase != null) {
      _result.searchSolutionUseCase.addAll(searchSolutionUseCase);
    }
    return _result;
  }
  ...
  @$pb.TagNumber(7)
  $core.List<$1.SearchSolutionUseCase> get searchSolutionUseCase => $_getList(6);
}

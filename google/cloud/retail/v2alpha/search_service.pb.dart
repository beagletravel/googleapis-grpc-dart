...
class SearchRequest_FacetSpec_FacetKey extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'SearchRequest.FacetSpec.FacetKey', package: const $pb.PackageName(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'google.cloud.retail.v2alpha'), createEmptyInstance: create)
    ..aOS(1, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'key')
    ..pc<$1.Interval>(2, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'intervals', $pb.PbFieldType.PM, subBuilder: $1.Interval.create)
    ..pPS(3, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'restrictedValues')
    ...
    ..pPS(8, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'prefixes')
    ..pPS(9, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'contains')
  ...
  'Will be removed in next major version')
  SearchRequest_FacetSpec_FacetKey copyWith(void Function(SearchRequest_FacetSpec_FacetKey) updates) => super.copyWith((message) => updates(message as SearchRequest_FacetSpec_FacetKey)) as SearchRequest_FacetSpec_FacetKey; // ignore: deprecated_member_use
...
class SearchRequest_FacetSpec extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'SearchRequest.FacetSpec', package: const $pb.PackageName(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'google.cloud.retail.v2alpha'), createEmptyInstance: create)
    ..aOM<SearchRequest_FacetSpec_FacetKey>(1, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'facetKey', subBuilder: SearchRequest_FacetSpec_FacetKey.create)
    ..a<$core.int>(2, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'limit', $pb.PbFieldType.O3)
    ..pPS(3, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'excludedFilterKeys')
    ..aOB(4, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'enableDynamicPosition')
    ..hasRequiredFields = false
  ;
  ...
  'Use [GeneratedMessageGenericExtensions.rebuild] instead. '
  'Will be removed in next major version')
  SearchRequest_FacetSpec copyWith(void Function(SearchRequest_FacetSpec) updates) => super.copyWith((message) => updates(message as SearchRequest_FacetSpec)) as SearchRequest_FacetSpec; // ignore: deprecated_member_use
  $pb.BuilderInfo get info_ => _i;
  @$core.pragma('dart2js:noInline')
...
class SearchRequest_DynamicFacetSpec extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'SearchRequest.DynamicFacetSpec', package: const $pb.PackageName(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'google.cloud.retail.v2alpha'), createEmptyInstance: create)
    ..e<SearchRequest_DynamicFacetSpec_Mode>(1, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'mode', $pb.PbFieldType.OE, defaultOrMaker: SearchRequest_DynamicFacetSpec_Mode.MODE_UNSPECIFIED, valueOf: SearchRequest_DynamicFacetSpec_Mode.valueOf, enumValues: SearchRequest_DynamicFacetSpec_Mode.values)
    ..hasRequiredFields = false
  ;
  ...
  'Use [GeneratedMessageGenericExtensions.rebuild] instead. '
  'Will be removed in next major version')
  SearchRequest_DynamicFacetSpec copyWith(void Function(SearchRequest_DynamicFacetSpec) updates) => super.copyWith((message) => updates(message as SearchRequest_DynamicFacetSpec)) as SearchRequest_DynamicFacetSpec; // ignore: deprecated_member_use
  $pb.BuilderInfo get info_ => _i;
  @$core.pragma('dart2js:noInline')
...
class SearchRequest_BoostSpec_ConditionBoostSpec extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'SearchRequest.BoostSpec.ConditionBoostSpec', package: const $pb.PackageName(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'google.cloud.retail.v2alpha'), createEmptyInstance: create)
    ..aOS(1, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'condition')
    ..a<$core.double>(2, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'boost', $pb.PbFieldType.OF)
    ..hasRequiredFields = false
  ;
  ...
  'Use [GeneratedMessageGenericExtensions.rebuild] instead. '
  'Will be removed in next major version')
  SearchRequest_BoostSpec_ConditionBoostSpec copyWith(void Function(SearchRequest_BoostSpec_ConditionBoostSpec) updates) => super.copyWith((message) => updates(message as SearchRequest_BoostSpec_ConditionBoostSpec)) as SearchRequest_BoostSpec_ConditionBoostSpec; // ignore: deprecated_member_use
  $pb.BuilderInfo get info_ => _i;
  @$core.pragma('dart2js:noInline')
...
class SearchRequest_BoostSpec extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'SearchRequest.BoostSpec', package: const $pb.PackageName(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'google.cloud.retail.v2alpha'), createEmptyInstance: create)
    ..pc<SearchRequest_BoostSpec_ConditionBoostSpec>(1, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'conditionBoostSpecs', $pb.PbFieldType.PM, subBuilder: SearchRequest_BoostSpec_ConditionBoostSpec.create)
    ..aOB(2, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'skipBoostSpecValidation')
    ..hasRequiredFields = false
  ;
  ...
  factory SearchRequest_BoostSpec({
    ...
    if (skipBoostSpecValidation != null) {
      _result.skipBoostSpecValidation = skipBoostSpecValidation;
    }
    return _result;
  }
  ...
  'Use [GeneratedMessageGenericExtensions.rebuild] instead. '
  'Will be removed in next major version')
  SearchRequest_BoostSpec copyWith(void Function(SearchRequest_BoostSpec) updates) => super.copyWith((message) => updates(message as SearchRequest_BoostSpec)) as SearchRequest_BoostSpec; // ignore: deprecated_member_use
  $pb.BuilderInfo get info_ => _i;
  @$core.pragma('dart2js:noInline')
...
class SearchRequest_QueryExpansionSpec extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'SearchRequest.QueryExpansionSpec', package: const $pb.PackageName(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'google.cloud.retail.v2alpha'), createEmptyInstance: create)
    ..e<SearchRequest_QueryExpansionSpec_Condition>(1, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'condition', $pb.PbFieldType.OE, defaultOrMaker: SearchRequest_QueryExpansionSpec_Condition.CONDITION_UNSPECIFIED, valueOf: SearchRequest_QueryExpansionSpec_Condition.valueOf, enumValues: SearchRequest_QueryExpansionSpec_Condition.values)
    ..aOB(2, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'pinUnexpandedResults')
    ..hasRequiredFields = false
  ;
  ...
  'Use [GeneratedMessageGenericExtensions.rebuild] instead. '
  'Will be removed in next major version')
  SearchRequest_QueryExpansionSpec copyWith(void Function(SearchRequest_QueryExpansionSpec) updates) => super.copyWith((message) => updates(message as SearchRequest_QueryExpansionSpec)) as SearchRequest_QueryExpansionSpec; // ignore: deprecated_member_use
  $pb.BuilderInfo get info_ => _i;
  @$core.pragma('dart2js:noInline')
...
class SearchRequest_PersonalizationSpec extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'SearchRequest.PersonalizationSpec', package: const $pb.PackageName(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'google.cloud.retail.v2alpha'), createEmptyInstance: create)
    ..e<SearchRequest_PersonalizationSpec_Mode>(1, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'mode', $pb.PbFieldType.OE, defaultOrMaker: SearchRequest_PersonalizationSpec_Mode.MODE_UNSPECIFIED, valueOf: SearchRequest_PersonalizationSpec_Mode.valueOf, enumValues: SearchRequest_PersonalizationSpec_Mode.values)
    ..hasRequiredFields = false
  ;
  ...
  'Use [GeneratedMessageGenericExtensions.rebuild] instead. '
  'Will be removed in next major version')
  SearchRequest_PersonalizationSpec copyWith(void Function(SearchRequest_PersonalizationSpec) updates) => super.copyWith((message) => updates(message as SearchRequest_PersonalizationSpec)) as SearchRequest_PersonalizationSpec; // ignore: deprecated_member_use
  $pb.BuilderInfo get info_ => _i;
  @$core.pragma('dart2js:noInline')
...
class SearchRequest extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'SearchRequest', package: const $pb.PackageName(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'google.cloud.retail.v2alpha'), createEmptyInstance: create)
    ..aOS(1, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'placement')
    ...
    ..aOS(4, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'visitorId')
    ..aOM<$1.UserInfo>(5, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'userInfo', subBuilder: $1.UserInfo.create)
    ...
    ..aOS(10, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'filter')
    ..aOS(11, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'orderBy')
    ..pc<SearchRequest_FacetSpec>(12, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'facetSpecs', $pb.PbFieldType.PM, subBuilder: SearchRequest_FacetSpec.create)
    ..aOM<SearchRequest_BoostSpec>(13, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'boostSpec', subBuilder: SearchRequest_BoostSpec.create)
    ..aOM<SearchRequest_QueryExpansionSpec>(14, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'queryExpansionSpec', subBuilder: SearchRequest_QueryExpansionSpec.create)
    ..e<SearchRequest_RelevanceThreshold>(15, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'relevanceThreshold', $pb.PbFieldType.OE, defaultOrMaker: SearchRequest_RelevanceThreshold.RELEVANCE_THRESHOLD_UNSPECIFIED, valueOf: SearchRequest_RelevanceThreshold.valueOf, enumValues: SearchRequest_RelevanceThreshold.values)
    ..pPS(17, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'variantRollupKeys')
    ..aOM<SearchRequest_DynamicFacetSpec>(21, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'dynamicFacetSpec', subBuilder: SearchRequest_DynamicFacetSpec.create)
    ..pPS(23, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'pageCategories')
    ..aOS(28, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'canonicalFilter')
    ..e<SearchRequest_SearchMode>(31, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'searchMode', $pb.PbFieldType.OE, defaultOrMaker: SearchRequest_SearchMode.SEARCH_MODE_UNSPECIFIED, valueOf: SearchRequest_SearchMode.valueOf, enumValues: SearchRequest_SearchMode.values)
    ..aOM<SearchRequest_PersonalizationSpec>(32, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'personalizationSpec', subBuilder: SearchRequest_PersonalizationSpec.create)
    ..hasRequiredFields = false
  ;
  ...
  @$core.Deprecated('This field is deprecated.')
    ...
    if (personalizationSpec != null) {
      _result.personalizationSpec = personalizationSpec;
    }
    return _result;
  }
  ...
  @$pb.TagNumber(5)
  set userInfo($1.UserInfo v) { setField(5, v); }
  @$pb.TagNumber(5)
  ...
  @$pb.TagNumber(15)
  set relevanceThreshold(SearchRequest_RelevanceThreshold v) { setField(15, v); }
  @$pb.TagNumber(15)
  ...
  @$pb.TagNumber(28)
  set canonicalFilter($core.String v) { $_setString(17, v); }
  @$pb.TagNumber(28)
  ...
  @$pb.TagNumber(32)
  SearchRequest_PersonalizationSpec get personalizationSpec => $_getN(19);
  @$pb.TagNumber(32)
  set personalizationSpec(SearchRequest_PersonalizationSpec v) { setField(32, v); }
  @$pb.TagNumber(32)
  $core.bool hasPersonalizationSpec() => $_has(19);
  @$pb.TagNumber(32)
  void clearPersonalizationSpec() => clearField(32);
  @$pb.TagNumber(32)
  SearchRequest_PersonalizationSpec ensurePersonalizationSpec() => $_ensure(19);
}

class SearchResponse_SearchResult extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'SearchResponse.SearchResult', package: const $pb.PackageName(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'google.cloud.retail.v2alpha'), createEmptyInstance: create)
    ..aOS(1, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'id')
    ..aOM<$2.Product>(2, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'product', subBuilder: $2.Product.create)
    ..a<$core.int>(3, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'matchingVariantCount', $pb.PbFieldType.O3)
    ..m<$core.String, $3.FieldMask>(4, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'matchingVariantFields', entryClassName: 'SearchResponse.SearchResult.MatchingVariantFieldsEntry', keyFieldType: $pb.PbFieldType.OS, valueFieldType: $pb.PbFieldType.OM, valueCreator: $3.FieldMask.create, packageName: const $pb.PackageName('google.cloud.retail.v2alpha'))
    ..m<$core.String, $4.Value>(5, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'variantRollupValues', entryClassName: 'SearchResponse.SearchResult.VariantRollupValuesEntry', keyFieldType: $pb.PbFieldType.OS, valueFieldType: $pb.PbFieldType.OM, valueCreator: $4.Value.create, packageName: const $pb.PackageName('google.cloud.retail.v2alpha'))
    ..hasRequiredFields = false
  ;
  ...
  'Use [GeneratedMessageGenericExtensions.rebuild] instead. '
  'Will be removed in next major version')
  SearchResponse_SearchResult copyWith(void Function(SearchResponse_SearchResult) updates) => super.copyWith((message) => updates(message as SearchResponse_SearchResult)) as SearchResponse_SearchResult; // ignore: deprecated_member_use
  $pb.BuilderInfo get info_ => _i;
  @$core.pragma('dart2js:noInline')
  ...
  @$pb.TagNumber(2)
  set product($2.Product v) { setField(2, v); }
  @$pb.TagNumber(2)
  ...
  @$pb.TagNumber(4)
  $core.Map<$core.String, $3.FieldMask> get matchingVariantFields => $_getMap(3);
...
class SearchResponse_Facet_FacetValue extends $pb.GeneratedMessage {
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'SearchResponse.Facet.FacetValue', package: const $pb.PackageName(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'google.cloud.retail.v2alpha'), createEmptyInstance: create)
    ..oo(0, [1, 2])
    ..aOS(1, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'value')
    ..aOM<$1.Interval>(2, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'interval', subBuilder: $1.Interval.create)
  ...
  'Use [GeneratedMessageGenericExtensions.rebuild] instead. '
  'Will be removed in next major version')
  SearchResponse_Facet_FacetValue copyWith(void Function(SearchResponse_Facet_FacetValue) updates) => super.copyWith((message) => updates(message as SearchResponse_Facet_FacetValue)) as SearchResponse_Facet_FacetValue; // ignore: deprecated_member_use
  $pb.BuilderInfo get info_ => _i;
  @$core.pragma('dart2js:noInline')
  ...
  @$pb.TagNumber(2)
  set interval($1.Interval v) { setField(2, v); }
  @$pb.TagNumber(2)
...
class SearchResponse_Facet extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'SearchResponse.Facet', package: const $pb.PackageName(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'google.cloud.retail.v2alpha'), createEmptyInstance: create)
    ..aOS(1, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'key')
    ..pc<SearchResponse_Facet_FacetValue>(2, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'values', $pb.PbFieldType.PM, subBuilder: SearchResponse_Facet_FacetValue.create)
    ..aOB(3, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'dynamicFacet')
    ..hasRequiredFields = false
  ;
  ...
  'Use [GeneratedMessageGenericExtensions.rebuild] instead. '
  'Will be removed in next major version')
  SearchResponse_Facet copyWith(void Function(SearchResponse_Facet) updates) => super.copyWith((message) => updates(message as SearchResponse_Facet)) as SearchResponse_Facet; // ignore: deprecated_member_use
  $pb.BuilderInfo get info_ => _i;
  @$core.pragma('dart2js:noInline')
...
class SearchResponse_QueryExpansionInfo extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'SearchResponse.QueryExpansionInfo', package: const $pb.PackageName(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'google.cloud.retail.v2alpha'), createEmptyInstance: create)
    ..aOB(1, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'expandedQuery')
    ..aInt64(2, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'pinnedResultCount')
    ..hasRequiredFields = false
  ;
  ...
  'Use [GeneratedMessageGenericExtensions.rebuild] instead. '
  'Will be removed in next major version')
  SearchResponse_QueryExpansionInfo copyWith(void Function(SearchResponse_QueryExpansionInfo) updates) => super.copyWith((message) => updates(message as SearchResponse_QueryExpansionInfo)) as SearchResponse_QueryExpansionInfo; // ignore: deprecated_member_use
  $pb.BuilderInfo get info_ => _i;
  @$core.pragma('dart2js:noInline')
...
class SearchResponse extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'SearchResponse', package: const $pb.PackageName(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'google.cloud.retail.v2alpha'), createEmptyInstance: create)
    ..pc<SearchResponse_SearchResult>(1, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'results', $pb.PbFieldType.PM, subBuilder: SearchResponse_SearchResult.create)
    ..pc<SearchResponse_Facet>(2, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'facets', $pb.PbFieldType.PM, subBuilder: SearchResponse_Facet.create)
    ..a<$core.int>(3, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'totalSize', $pb.PbFieldType.O3)
    ..aOS(4, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'correctedQuery')
    ..aOS(5, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'attributionToken')
    ..aOS(6, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'nextPageToken')
    ..aOM<SearchResponse_QueryExpansionInfo>(7, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'queryExpansionInfo', subBuilder: SearchResponse_QueryExpansionInfo.create)
    ..aOS(10, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'redirectUri')
    ..pPS(12, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'appliedControls')
    ..pc<SearchRequest_BoostSpec_ConditionBoostSpec>(14, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'invalidConditionBoostSpecs', $pb.PbFieldType.PM, subBuilder: SearchRequest_BoostSpec_ConditionBoostSpec.create)
    ..hasRequiredFields = false
  ;
  ...
  factory SearchResponse({
    ...
    if (appliedControls != null) {
      _result.appliedControls.addAll(appliedControls);
    }
    if (invalidConditionBoostSpecs != null) {
      _result.invalidConditionBoostSpecs.addAll(invalidConditionBoostSpecs);
    }
    return _result;
  }

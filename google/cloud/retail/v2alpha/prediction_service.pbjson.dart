...
const PredictRequest$json = const {
  ...
  '2': const [
    ...
    const {'1': 'params', '3': 7, '4': 3, '5': 11, '6': '.google.cloud.retail.v2alpha.PredictRequest.ParamsEntry', '10': 'params'},
    const {'1': 'labels', '3': 8, '4': 3, '5': 11, '6': '.google.cloud.retail.v2alpha.PredictRequest.LabelsEntry', '10': 'labels'},
  ],
...
const PredictResponse$json = const {
  '1': 'PredictResponse',
  '2': const [
    const {'1': 'results', '3': 1, '4': 3, '5': 11, '6': '.google.cloud.retail.v2alpha.PredictResponse.PredictionResult', '10': 'results'},
...
const PredictResponse_PredictionResult$json = const {
  ...
  '2': const [
    ...
    const {'1': 'metadata', '3': 2, '4': 3, '5': 11, '6': '.google.cloud.retail.v2alpha.PredictResponse.PredictionResult.MetadataEntry', '10': 'metadata'},
  ],
...
final $typed_data.Uint8List predictResponseDescriptor = $convert.base64Decode('');

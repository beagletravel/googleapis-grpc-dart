...
const CreateServingConfigRequest$json = const {
  ...
  '2': const [
    ...
    const {'1': 'serving_config', '3': 2, '4': 1, '5': 11, '6': '.google.cloud.retail.v2alpha.ServingConfig', '8': const {}, '10': 'servingConfig'},
...
final $typed_data.Uint8List createServingConfigRequestDescriptor = $convert.base64Decode('');
...
const UpdateServingConfigRequest$json = const {
  ...
  '2': const [
    const {'1': 'serving_config', '3': 1, '4': 1, '5': 11, '6': '.google.cloud.retail.v2alpha.ServingConfig', '8': const {}, '10': 'servingConfig'},
    const {'1': 'update_mask', '3': 2, '4': 1, '5': 11, '6': '.google.protobuf.FieldMask', '10': 'updateMask'},
  ],
};

/// Descriptor for `UpdateServingConfigRequest`. Decode as a `google.protobuf.DescriptorProto`.
final $typed_data.Uint8List updateServingConfigRequestDescriptor = $convert.base64Decode('ChpVcGRhdGVTZXJ2aW5nQ29uZmlnUmVxdWVzdBJWCg5zZXJ2aW5nX2NvbmZpZxgBIAEoCzIqLmdvb2dsZS5jbG91ZC5yZXRhaWwudjJhbHBoYS5TZXJ2aW5nQ29uZmlnQgPgQQJSDXNlcnZpbmdDb25maWcSOwoLdXBkYXRlX21hc2sYAiABKAsyGi5nb29nbGUucHJvdG9idWYuRmllbGRNYXNrUgp1cGRhdGVNYXNr');
...
const ListServingConfigsResponse$json = const {
  ...
  '2': const [
    const {'1': 'serving_configs', '3': 1, '4': 3, '5': 11, '6': '.google.cloud.retail.v2alpha.ServingConfig', '10': 'servingConfigs'},
    const {'1': 'next_page_token', '3': 2, '4': 1, '5': 9, '10': 'nextPageToken'},
  ],
};

/// Descriptor for `ListServingConfigsResponse`. Decode as a `google.protobuf.DescriptorProto`.
final $typed_data.Uint8List listServingConfigsResponseDescriptor = $convert.base64Decode('ChpMaXN0U2VydmluZ0NvbmZpZ3NSZXNwb25zZRJTCg9zZXJ2aW5nX2NvbmZpZ3MYASADKAsyKi5nb29nbGUuY2xvdWQucmV0YWlsLnYyYWxwaGEuU2VydmluZ0NvbmZpZ1IOc2VydmluZ0NvbmZpZ3MSJgoPbmV4dF9wYWdlX3Rva2VuGAIgASgJUg1uZXh0UGFnZVRva2Vu');

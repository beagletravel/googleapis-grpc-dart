...
class ExportErrorsConfig extends $pb.GeneratedMessage {
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'ExportErrorsConfig', package: const $pb.PackageName(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'google.cloud.retail.v2alpha'), createEmptyInstance: create)
    ..oo(0, [1])
  ...
  'Will be removed in next major version')
  ExportErrorsConfig copyWith(void Function(ExportErrorsConfig) updates) => super.copyWith((message) => updates(message as ExportErrorsConfig)) as ExportErrorsConfig; // ignore: deprecated_member_use
...
class ExportMetadata extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'ExportMetadata', package: const $pb.PackageName(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'google.cloud.retail.v2alpha'), createEmptyInstance: create)
  ...
  'Use [GeneratedMessageGenericExtensions.rebuild] instead. '
  'Will be removed in next major version')
  ExportMetadata copyWith(void Function(ExportMetadata) updates) => super.copyWith((message) => updates(message as ExportMetadata)) as ExportMetadata; // ignore: deprecated_member_use
  $pb.BuilderInfo get info_ => _i;
  @$core.pragma('dart2js:noInline')
...
class ExportProductsResponse extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'ExportProductsResponse', package: const $pb.PackageName(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'google.cloud.retail.v2alpha'), createEmptyInstance: create)
    ..pc<$1.Status>(1, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'errorSamples', $pb.PbFieldType.PM, subBuilder: $1.Status.create)
    ..aOM<ExportErrorsConfig>(2, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'errorsConfig', subBuilder: ExportErrorsConfig.create)
    ..hasRequiredFields = false
  ;
  ...
  'Use [GeneratedMessageGenericExtensions.rebuild] instead. '
  'Will be removed in next major version')
  ExportProductsResponse copyWith(void Function(ExportProductsResponse) updates) => super.copyWith((message) => updates(message as ExportProductsResponse)) as ExportProductsResponse; // ignore: deprecated_member_use
  $pb.BuilderInfo get info_ => _i;
  @$core.pragma('dart2js:noInline')
...
class ExportUserEventsResponse extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'ExportUserEventsResponse', package: const $pb.PackageName(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'google.cloud.retail.v2alpha'), createEmptyInstance: create)
    ..pc<$1.Status>(1, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'errorSamples', $pb.PbFieldType.PM, subBuilder: $1.Status.create)
    ..aOM<ExportErrorsConfig>(2, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'errorsConfig', subBuilder: ExportErrorsConfig.create)
    ..hasRequiredFields = false
  ;
  ...
  'Use [GeneratedMessageGenericExtensions.rebuild] instead. '
  'Will be removed in next major version')
  ExportUserEventsResponse copyWith(void Function(ExportUserEventsResponse) updates) => super.copyWith((message) => updates(message as ExportUserEventsResponse)) as ExportUserEventsResponse; // ignore: deprecated_member_use
  $pb.BuilderInfo get info_ => _i;
  @$core.pragma('dart2js:noInline')

...
const Condition$json = const {
  '1': 'Condition',
  '2': const [
    const {'1': 'query_terms', '3': 1, '4': 3, '5': 11, '6': '.google.cloud.retail.v2alpha.Condition.QueryTerm', '10': 'queryTerms'},
    const {'1': 'active_time_range', '3': 3, '4': 3, '5': 11, '6': '.google.cloud.retail.v2alpha.Condition.TimeRange', '10': 'activeTimeRange'},
  ],
...
final $typed_data.Uint8List conditionDescriptor = $convert.base64Decode('');
@$core.Deprecated('Use ruleDescriptor instead')
const Rule$json = const {
  '1': 'Rule',
  '2': const [
    const {'1': 'boost_action', '3': 2, '4': 1, '5': 11, '6': '.google.cloud.retail.v2alpha.Rule.BoostAction', '9': 0, '10': 'boostAction'},
    const {'1': 'redirect_action', '3': 3, '4': 1, '5': 11, '6': '.google.cloud.retail.v2alpha.Rule.RedirectAction', '9': 0, '10': 'redirectAction'},
    const {'1': 'oneway_synonyms_action', '3': 6, '4': 1, '5': 11, '6': '.google.cloud.retail.v2alpha.Rule.OnewaySynonymsAction', '9': 0, '10': 'onewaySynonymsAction'},
    const {'1': 'do_not_associate_action', '3': 7, '4': 1, '5': 11, '6': '.google.cloud.retail.v2alpha.Rule.DoNotAssociateAction', '9': 0, '10': 'doNotAssociateAction'},
    const {'1': 'replacement_action', '3': 8, '4': 1, '5': 11, '6': '.google.cloud.retail.v2alpha.Rule.ReplacementAction', '9': 0, '10': 'replacementAction'},
    const {'1': 'ignore_action', '3': 9, '4': 1, '5': 11, '6': '.google.cloud.retail.v2alpha.Rule.IgnoreAction', '9': 0, '10': 'ignoreAction'},
    const {'1': 'filter_action', '3': 10, '4': 1, '5': 11, '6': '.google.cloud.retail.v2alpha.Rule.FilterAction', '9': 0, '10': 'filterAction'},
    const {'1': 'twoway_synonyms_action', '3': 11, '4': 1, '5': 11, '6': '.google.cloud.retail.v2alpha.Rule.TwowaySynonymsAction', '9': 0, '10': 'twowaySynonymsAction'},
    const {'1': 'condition', '3': 1, '4': 1, '5': 11, '6': '.google.cloud.retail.v2alpha.Condition', '8': const {}, '10': 'condition'},
  ],
...
final $typed_data.Uint8List ruleDescriptor = $convert.base64Decode('');
...
const PriceInfo$json = const {
  ...
  '2': const [
    ...
    const {'1': 'price_range', '3': 7, '4': 1, '5': 11, '6': '.google.cloud.retail.v2alpha.PriceInfo.PriceRange', '8': const {}, '10': 'priceRange'},
  ],
...
const PriceInfo_PriceRange$json = const {
  '1': 'PriceRange',
  '2': const [
    const {'1': 'price', '3': 1, '4': 1, '5': 11, '6': '.google.cloud.retail.v2alpha.Interval', '10': 'price'},
    const {'1': 'original_price', '3': 2, '4': 1, '5': 11, '6': '.google.cloud.retail.v2alpha.Interval', '10': 'originalPrice'},
  ],
};

/// Descriptor for `PriceInfo`. Decode as a `google.protobuf.DescriptorProto`.
final $typed_data.Uint8List priceInfoDescriptor = $convert.base64Decode('');
...
const LocalInventory$json = const {
  ...
  '2': const [
    ...
    const {'1': 'price_info', '3': 2, '4': 1, '5': 11, '6': '.google.cloud.retail.v2alpha.PriceInfo', '10': 'priceInfo'},
    const {'1': 'attributes', '3': 3, '4': 3, '5': 11, '6': '.google.cloud.retail.v2alpha.LocalInventory.AttributesEntry', '10': 'attributes'},
...
const LocalInventory_AttributesEntry$json = const {
  ...
  '2': const [
    ...
    const {'1': 'value', '3': 2, '4': 1, '5': 11, '6': '.google.cloud.retail.v2alpha.CustomAttribute', '10': 'value'},
  ],
  '7': const {'7': true},
};

/// Descriptor for `LocalInventory`. Decode as a `google.protobuf.DescriptorProto`.
final $typed_data.Uint8List localInventoryDescriptor = $convert.base64Decode('');

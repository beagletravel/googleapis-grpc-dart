...
const CreateControlRequest$json = const {
  ...
  '2': const [
    ...
    const {'1': 'control', '3': 2, '4': 1, '5': 11, '6': '.google.cloud.retail.v2beta.Control', '8': const {}, '10': 'control'},
...
final $typed_data.Uint8List createControlRequestDescriptor = $convert.base64Decode('ChRDcmVhdGVDb250cm9sUmVxdWVzdBI9CgZwYXJlbnQYASABKAlCJeBBAvpBHwodcmV0YWlsLmdvb2dsZWFwaXMuY29tL0NhdGFsb2dSBnBhcmVudBJCCgdjb250cm9sGAIgASgLMiMuZ29vZ2xlLmNsb3VkLnJldGFpbC52MmJldGEuQ29udHJvbEID4EECUgdjb250cm9sEiIKCmNvbnRyb2xfaWQYAyABKAlCA+BBAlIJY29udHJvbElk');
@$core.Deprecated('Use updateControlRequestDescriptor instead')
const UpdateControlRequest$json = const {
  '1': 'UpdateControlRequest',
  '2': const [
    const {'1': 'control', '3': 1, '4': 1, '5': 11, '6': '.google.cloud.retail.v2beta.Control', '8': const {}, '10': 'control'},
    const {'1': 'update_mask', '3': 2, '4': 1, '5': 11, '6': '.google.protobuf.FieldMask', '10': 'updateMask'},
  ],
};

/// Descriptor for `UpdateControlRequest`. Decode as a `google.protobuf.DescriptorProto`.
final $typed_data.Uint8List updateControlRequestDescriptor = $convert.base64Decode('ChRVcGRhdGVDb250cm9sUmVxdWVzdBJCCgdjb250cm9sGAEgASgLMiMuZ29vZ2xlLmNsb3VkLnJldGFpbC52MmJldGEuQ29udHJvbEID4EECUgdjb250cm9sEjsKC3VwZGF0ZV9tYXNrGAIgASgLMhouZ29vZ2xlLnByb3RvYnVmLkZpZWxkTWFza1IKdXBkYXRlTWFzaw==');
...
const ListControlsResponse$json = const {
  ...
  '2': const [
    const {'1': 'controls', '3': 1, '4': 3, '5': 11, '6': '.google.cloud.retail.v2beta.Control', '10': 'controls'},
    const {'1': 'next_page_token', '3': 2, '4': 1, '5': 9, '10': 'nextPageToken'},
  ],
};

/// Descriptor for `ListControlsResponse`. Decode as a `google.protobuf.DescriptorProto`.
final $typed_data.Uint8List listControlsResponseDescriptor = $convert.base64Decode('ChRMaXN0Q29udHJvbHNSZXNwb25zZRI/Cghjb250cm9scxgBIAMoCzIjLmdvb2dsZS5jbG91ZC5yZXRhaWwudjJiZXRhLkNvbnRyb2xSCGNvbnRyb2xzEiYKD25leHRfcGFnZV90b2tlbhgCIAEoCVINbmV4dFBhZ2VUb2tlbg==');

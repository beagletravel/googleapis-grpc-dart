...
const UserEvent$json = const {
  ...
  '2': const [
    ...
    const {'1': 'product_details', '3': 6, '4': 3, '5': 11, '6': '.google.cloud.retail.v2beta.ProductDetail', '10': 'productDetails'},
    const {'1': 'completion_detail', '3': 22, '4': 1, '5': 11, '6': '.google.cloud.retail.v2beta.CompletionDetail', '10': 'completionDetail'},
    const {'1': 'attributes', '3': 7, '4': 3, '5': 11, '6': '.google.cloud.retail.v2beta.UserEvent.AttributesEntry', '10': 'attributes'},
    const {'1': 'cart_id', '3': 8, '4': 1, '5': 9, '10': 'cartId'},
    const {'1': 'purchase_transaction', '3': 9, '4': 1, '5': 11, '6': '.google.cloud.retail.v2beta.PurchaseTransaction', '10': 'purchaseTransaction'},
    ...
    const {'1': 'user_info', '3': 12, '4': 1, '5': 11, '6': '.google.cloud.retail.v2beta.UserInfo', '10': 'userInfo'},
...
final $typed_data.Uint8List userEventDescriptor = $convert.base64Decode('');
...
final $typed_data.Uint8List productDetailDescriptor = $convert.base64Decode('Cg1Qcm9kdWN0RGV0YWlsEkIKB3Byb2R1Y3QYASABKAsyIy5nb29nbGUuY2xvdWQucmV0YWlsLnYyYmV0YS5Qcm9kdWN0QgPgQQJSB3Byb2R1Y3QSNwoIcXVhbnRpdHkYAiABKAsyGy5nb29nbGUucHJvdG9idWYuSW50MzJWYWx1ZVIIcXVhbnRpdHk=');

...
const ProductInlineSource$json = const {
  ...
  '2': const [
    const {'1': 'products', '3': 1, '4': 3, '5': 11, '6': '.google.cloud.retail.v2.Product', '8': const {}, '10': 'products'},
  ],
};

/// Descriptor for `ProductInlineSource`. Decode as a `google.protobuf.DescriptorProto`.
final $typed_data.Uint8List productInlineSourceDescriptor = $convert.base64Decode('ChNQcm9kdWN0SW5saW5lU291cmNlEkAKCHByb2R1Y3RzGAEgAygLMh8uZ29vZ2xlLmNsb3VkLnJldGFpbC52Mi5Qcm9kdWN0QgPgQQJSCHByb2R1Y3Rz');
@$core.Deprecated('Use userEventInlineSourceDescriptor instead')
const UserEventInlineSource$json = const {
  '1': 'UserEventInlineSource',
  '2': const [
    const {'1': 'user_events', '3': 1, '4': 3, '5': 11, '6': '.google.cloud.retail.v2.UserEvent', '8': const {}, '10': 'userEvents'},
  ],
};

/// Descriptor for `UserEventInlineSource`. Decode as a `google.protobuf.DescriptorProto`.
final $typed_data.Uint8List userEventInlineSourceDescriptor = $convert.base64Decode('ChVVc2VyRXZlbnRJbmxpbmVTb3VyY2USRwoLdXNlcl9ldmVudHMYASADKAsyIS5nb29nbGUuY2xvdWQucmV0YWlsLnYyLlVzZXJFdmVudEID4EECUgp1c2VyRXZlbnRz');
...
const ImportProductsRequest$json = const {
  ...
  '2': const [
    ...
    const {'1': 'input_config', '3': 2, '4': 1, '5': 11, '6': '.google.cloud.retail.v2.ProductInputConfig', '8': const {}, '10': 'inputConfig'},
    const {'1': 'errors_config', '3': 3, '4': 1, '5': 11, '6': '.google.cloud.retail.v2.ImportErrorsConfig', '10': 'errorsConfig'},
    const {'1': 'update_mask', '3': 4, '4': 1, '5': 11, '6': '.google.protobuf.FieldMask', '10': 'updateMask'},
    const {'1': 'reconciliation_mode', '3': 5, '4': 1, '5': 14, '6': '.google.cloud.retail.v2.ImportProductsRequest.ReconciliationMode', '10': 'reconciliationMode'},
...
final $typed_data.Uint8List importProductsRequestDescriptor = $convert.base64Decode('');
...
const ImportUserEventsRequest$json = const {
  ...
  '2': const [
    const {'1': 'parent', '3': 1, '4': 1, '5': 9, '8': const {}, '10': 'parent'},
    const {'1': 'input_config', '3': 2, '4': 1, '5': 11, '6': '.google.cloud.retail.v2.UserEventInputConfig', '8': const {}, '10': 'inputConfig'},
    const {'1': 'errors_config', '3': 3, '4': 1, '5': 11, '6': '.google.cloud.retail.v2.ImportErrorsConfig', '10': 'errorsConfig'},
  ],
};

/// Descriptor for `ImportUserEventsRequest`. Decode as a `google.protobuf.DescriptorProto`.
final $typed_data.Uint8List importUserEventsRequestDescriptor = $convert.base64Decode('');
...
const ImportCompletionDataRequest$json = const {
  ...
  '2': const [
    const {'1': 'parent', '3': 1, '4': 1, '5': 9, '8': const {}, '10': 'parent'},
    const {'1': 'input_config', '3': 2, '4': 1, '5': 11, '6': '.google.cloud.retail.v2.CompletionDataInputConfig', '8': const {}, '10': 'inputConfig'},
...
final $typed_data.Uint8List importCompletionDataRequestDescriptor = $convert.base64Decode('');
@$core.Deprecated('Use productInputConfigDescriptor instead')
const ProductInputConfig$json = const {
  '1': 'ProductInputConfig',
  '2': const [
    const {'1': 'product_inline_source', '3': 1, '4': 1, '5': 11, '6': '.google.cloud.retail.v2.ProductInlineSource', '9': 0, '10': 'productInlineSource'},
    const {'1': 'gcs_source', '3': 2, '4': 1, '5': 11, '6': '.google.cloud.retail.v2.GcsSource', '9': 0, '10': 'gcsSource'},
    const {'1': 'big_query_source', '3': 3, '4': 1, '5': 11, '6': '.google.cloud.retail.v2.BigQuerySource', '9': 0, '10': 'bigQuerySource'},
  ],
  '8': const [
    const {'1': 'source'},
  ],
...
final $typed_data.Uint8List productInputConfigDescriptor = $convert.base64Decode('');
@$core.Deprecated('Use userEventInputConfigDescriptor instead')
const UserEventInputConfig$json = const {
  '1': 'UserEventInputConfig',
  '2': const [
    const {'1': 'user_event_inline_source', '3': 1, '4': 1, '5': 11, '6': '.google.cloud.retail.v2.UserEventInlineSource', '8': const {}, '9': 0, '10': 'userEventInlineSource'},
    const {'1': 'gcs_source', '3': 2, '4': 1, '5': 11, '6': '.google.cloud.retail.v2.GcsSource', '8': const {}, '9': 0, '10': 'gcsSource'},
    const {'1': 'big_query_source', '3': 3, '4': 1, '5': 11, '6': '.google.cloud.retail.v2.BigQuerySource', '8': const {}, '9': 0, '10': 'bigQuerySource'},
  ],
  '8': const [
    const {'1': 'source'},
  ],
...
final $typed_data.Uint8List userEventInputConfigDescriptor = $convert.base64Decode('');
...
const CompletionDataInputConfig$json = const {
  ...
  '2': const [
    const {'1': 'big_query_source', '3': 1, '4': 1, '5': 11, '6': '.google.cloud.retail.v2.BigQuerySource', '8': const {}, '9': 0, '10': 'bigQuerySource'},
  ],
  '8': const [
    const {'1': 'source'},
  ],
...
final $typed_data.Uint8List completionDataInputConfigDescriptor = $convert.base64Decode('ChlDb21wbGV0aW9uRGF0YUlucHV0Q29uZmlnElcKEGJpZ19xdWVyeV9zb3VyY2UYASABKAsyJi5nb29nbGUuY2xvdWQucmV0YWlsLnYyLkJpZ1F1ZXJ5U291cmNlQgPgQQJIAFIOYmlnUXVlcnlTb3VyY2VCCAoGc291cmNl');
...
const ImportProductsResponse$json = const {
  ...
  '2': const [
    ...
    const {'1': 'errors_config', '3': 2, '4': 1, '5': 11, '6': '.google.cloud.retail.v2.ImportErrorsConfig', '10': 'errorsConfig'},
  ],
};

/// Descriptor for `ImportProductsResponse`. Decode as a `google.protobuf.DescriptorProto`.
final $typed_data.Uint8List importProductsResponseDescriptor = $convert.base64Decode('ChZJbXBvcnRQcm9kdWN0c1Jlc3BvbnNlEjcKDWVycm9yX3NhbXBsZXMYASADKAsyEi5nb29nbGUucnBjLlN0YXR1c1IMZXJyb3JTYW1wbGVzEk8KDWVycm9yc19jb25maWcYAiABKAsyKi5nb29nbGUuY2xvdWQucmV0YWlsLnYyLkltcG9ydEVycm9yc0NvbmZpZ1IMZXJyb3JzQ29uZmln');
...
const ImportUserEventsResponse$json = const {
  ...
  '2': const [
    const {'1': 'error_samples', '3': 1, '4': 3, '5': 11, '6': '.google.rpc.Status', '10': 'errorSamples'},
    const {'1': 'errors_config', '3': 2, '4': 1, '5': 11, '6': '.google.cloud.retail.v2.ImportErrorsConfig', '10': 'errorsConfig'},
    const {'1': 'import_summary', '3': 3, '4': 1, '5': 11, '6': '.google.cloud.retail.v2.UserEventImportSummary', '10': 'importSummary'},
  ],
};

/// Descriptor for `ImportUserEventsResponse`. Decode as a `google.protobuf.DescriptorProto`.
final $typed_data.Uint8List importUserEventsResponseDescriptor = $convert.base64Decode('');

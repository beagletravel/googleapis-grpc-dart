...
const PriceInfo$json = const {
  ...
  '2': const [
    ...
    const {'1': 'price_range', '3': 7, '4': 1, '5': 11, '6': '.google.cloud.retail.v2.PriceInfo.PriceRange', '8': const {}, '10': 'priceRange'},
  ],
...
const PriceInfo_PriceRange$json = const {
  '1': 'PriceRange',
  '2': const [
    const {'1': 'price', '3': 1, '4': 1, '5': 11, '6': '.google.cloud.retail.v2.Interval', '10': 'price'},
    const {'1': 'original_price', '3': 2, '4': 1, '5': 11, '6': '.google.cloud.retail.v2.Interval', '10': 'originalPrice'},
  ],
};

/// Descriptor for `PriceInfo`. Decode as a `google.protobuf.DescriptorProto`.
final $typed_data.Uint8List priceInfoDescriptor = $convert.base64Decode('');
...
const LocalInventory$json = const {
  ...
  '2': const [
    ...
    const {'1': 'price_info', '3': 2, '4': 1, '5': 11, '6': '.google.cloud.retail.v2.PriceInfo', '10': 'priceInfo'},
    const {'1': 'attributes', '3': 3, '4': 3, '5': 11, '6': '.google.cloud.retail.v2.LocalInventory.AttributesEntry', '10': 'attributes'},
...
final $typed_data.Uint8List localInventoryDescriptor = $convert.base64Decode('');

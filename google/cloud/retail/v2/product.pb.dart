...
class Product extends $pb.GeneratedMessage {
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'Product', package: const $pb.PackageName(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'google.cloud.retail.v2'), createEmptyInstance: create)
    ..oo(0, [16, 17])
    ..aOS(1, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'name')
    ..aOS(2, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'id')
    ..e<Product_Type>(3, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'type', $pb.PbFieldType.OE, defaultOrMaker: Product_Type.TYPE_UNSPECIFIED, valueOf: Product_Type.valueOf, enumValues: Product_Type.values)
    ..aOS(4, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'primaryProductId')
    ..pPS(5, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'collectionMemberIds')
    ..aOS(6, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'gtin')
    ..pPS(7, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'categories')
    ..aOS(8, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'title')
    ..pPS(9, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'brands')
    ...
    ..m<$core.String, $0.CustomAttribute>(12, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'attributes', entryClassName: 'Product.AttributesEntry', keyFieldType: $pb.PbFieldType.OS, valueFieldType: $pb.PbFieldType.OM, valueCreator: $0.CustomAttribute.create, packageName: const $pb.PackageName('google.cloud.retail.v2'))
    ..pPS(13, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'tags')
    ..aOM<$0.PriceInfo>(14, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'priceInfo', subBuilder: $0.PriceInfo.create)
    ..aOM<$0.Rating>(15, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'rating', subBuilder: $0.Rating.create)
    ..aOM<$1.Timestamp>(16, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'expireTime', subBuilder: $1.Timestamp.create)
    ..aOM<$2.Duration>(17, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'ttl', subBuilder: $2.Duration.create)
    ..aOM<$1.Timestamp>(18, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'availableTime', subBuilder: $1.Timestamp.create)
    ..e<Product_Availability>(19, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'availability', $pb.PbFieldType.OE, defaultOrMaker: Product_Availability.AVAILABILITY_UNSPECIFIED, valueOf: Product_Availability.valueOf, enumValues: Product_Availability.values)
    ..aOM<$3.Int32Value>(20, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'availableQuantity', subBuilder: $3.Int32Value.create)
    ..pc<$0.FulfillmentInfo>(21, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'fulfillmentInfo', $pb.PbFieldType.PM, subBuilder: $0.FulfillmentInfo.create)
    ..aOS(22, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'uri')
    ..pc<$0.Image>(23, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'images', $pb.PbFieldType.PM, subBuilder: $0.Image.create)
    ..aOM<$0.Audience>(24, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'audience', subBuilder: $0.Audience.create)
    ..aOM<$0.ColorInfo>(25, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'colorInfo', subBuilder: $0.ColorInfo.create)
    ..pPS(26, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'sizes')
    ..pPS(27, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'materials')
    ..pPS(28, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'patterns')
    ..pPS(29, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'conditions')
    ..aOM<$4.FieldMask>(30, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'retrievableFields', subBuilder: $4.FieldMask.create)
    ..pc<Product>(31, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'variants', $pb.PbFieldType.PM, subBuilder: Product.create)
    ..aOM<$1.Timestamp>(33, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'publishTime', subBuilder: $1.Timestamp.create)
    ..pc<$5.Promotion>(34, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'promotions', $pb.PbFieldType.PM, subBuilder: $5.Promotion.create)
  ...
  factory Product({
    ...
    $core.Iterable<$5.Promotion>? promotions,
  }) {
  ...
  @$pb.TagNumber(14)
  set priceInfo($0.PriceInfo v) { setField(14, v); }
  @$pb.TagNumber(14)
  ...
  @$pb.TagNumber(15)
  set rating($0.Rating v) { setField(15, v); }
  @$pb.TagNumber(15)
  ...
  @$pb.TagNumber(17)
  set ttl($2.Duration v) { setField(17, v); }
  @$pb.TagNumber(17)
  ...
  @$pb.TagNumber(18)
  set availableTime($1.Timestamp v) { setField(18, v); }
  @$pb.TagNumber(18)
  ...
  @$pb.TagNumber(20)
  set availableQuantity($3.Int32Value v) { setField(20, v); }
  @$pb.TagNumber(20)
  ...
  @$pb.TagNumber(24)
  set audience($0.Audience v) { setField(24, v); }
  @$pb.TagNumber(24)
  ...
  @$pb.TagNumber(25)
  set colorInfo($0.ColorInfo v) { setField(25, v); }
  @$pb.TagNumber(25)
  ...
  @$pb.TagNumber(30)
  set retrievableFields($4.FieldMask v) { setField(30, v); }
  @$pb.TagNumber(30)
  ...
  @$pb.TagNumber(33)
  set publishTime($1.Timestamp v) { setField(33, v); }
  @$pb.TagNumber(33)
  ...
  @$pb.TagNumber(34)
  $core.List<$5.Promotion> get promotions => $_getList(32);
}

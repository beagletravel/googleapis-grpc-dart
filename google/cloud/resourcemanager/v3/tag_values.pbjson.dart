...
final $typed_data.Uint8List listTagValuesRequestDescriptor = $convert.base64Decode('ChRMaXN0VGFnVmFsdWVzUmVxdWVzdBIhCgZwYXJlbnQYASABKAlCCeBBAvpBAxIBKlIGcGFyZW50EiAKCXBhZ2Vfc2l6ZRgCIAEoBUID4EEBUghwYWdlU2l6ZRIiCgpwYWdlX3Rva2VuGAMgASgJQgPgQQFSCXBhZ2VUb2tlbg==');
@$core.Deprecated('Use listTagValuesResponseDescriptor instead')
const ListTagValuesResponse$json = const {
  '1': 'ListTagValuesResponse',
  '2': const [
    const {'1': 'tag_values', '3': 1, '4': 3, '5': 11, '6': '.google.cloud.resourcemanager.v3.TagValue', '10': 'tagValues'},
    const {'1': 'next_page_token', '3': 2, '4': 1, '5': 9, '10': 'nextPageToken'},
  ],
};

/// Descriptor for `ListTagValuesResponse`. Decode as a `google.protobuf.DescriptorProto`.
final $typed_data.Uint8List listTagValuesResponseDescriptor = $convert.base64Decode('ChVMaXN0VGFnVmFsdWVzUmVzcG9uc2USSAoKdGFnX3ZhbHVlcxgBIAMoCzIpLmdvb2dsZS5jbG91ZC5yZXNvdXJjZW1hbmFnZXIudjMuVGFnVmFsdWVSCXRhZ1ZhbHVlcxImCg9uZXh0X3BhZ2VfdG9rZW4YAiABKAlSDW5leHRQYWdlVG9rZW4=');
...
final $typed_data.Uint8List getTagValueRequestDescriptor = $convert.base64Decode('ChJHZXRUYWdWYWx1ZVJlcXVlc3QSSAoEbmFtZRgBIAEoCUI04EEC+kEuCixjbG91ZHJlc291cmNlbWFuYWdlci5nb29nbGVhcGlzLmNvbS9UYWdWYWx1ZVIEbmFtZQ==');
@$core.Deprecated('Use createTagValueRequestDescriptor instead')
const CreateTagValueRequest$json = const {
  '1': 'CreateTagValueRequest',
  '2': const [
    const {'1': 'tag_value', '3': 1, '4': 1, '5': 11, '6': '.google.cloud.resourcemanager.v3.TagValue', '8': const {}, '10': 'tagValue'},
...
final $typed_data.Uint8List createTagValueRequestDescriptor = $convert.base64Decode('ChVDcmVhdGVUYWdWYWx1ZVJlcXVlc3QSSwoJdGFnX3ZhbHVlGAEgASgLMikuZ29vZ2xlLmNsb3VkLnJlc291cmNlbWFuYWdlci52My5UYWdWYWx1ZUID4EECUgh0YWdWYWx1ZRIoCg12YWxpZGF0ZV9vbmx5GAIgASgIQgPgQQFSDHZhbGlkYXRlT25seQ==');
...
final $typed_data.Uint8List createTagValueMetadataDescriptor = $convert.base64Decode('ChZDcmVhdGVUYWdWYWx1ZU1ldGFkYXRh');
...
final $typed_data.Uint8List updateTagValueRequestDescriptor = $convert.base64Decode('');
...
final $typed_data.Uint8List updateTagValueMetadataDescriptor = $convert.base64Decode('ChZVcGRhdGVUYWdWYWx1ZU1ldGFkYXRh');
...
final $typed_data.Uint8List deleteTagValueRequestDescriptor = $convert.base64Decode('ChVEZWxldGVUYWdWYWx1ZVJlcXVlc3QSSAoEbmFtZRgBIAEoCUI04EEC+kEuCixjbG91ZHJlc291cmNlbWFuYWdlci5nb29nbGVhcGlzLmNvbS9UYWdWYWx1ZVIEbmFtZRIoCg12YWxpZGF0ZV9vbmx5GAIgASgIQgPgQQFSDHZhbGlkYXRlT25seRIXCgRldGFnGAMgASgJQgPgQQFSBGV0YWc=');
...
final $typed_data.Uint8List deleteTagValueMetadataDescriptor = $convert.base64Decode('ChZEZWxldGVUYWdWYWx1ZU1ldGFkYXRh');

...
const Project$json = const {
  ...
  '2': const [
    ...
    const {'1': 'state', '3': 4, '4': 1, '5': 14, '6': '.google.cloud.resourcemanager.v3.Project.State', '8': const {}, '10': 'state'},
    ...
    const {'1': 'labels', '3': 10, '4': 3, '5': 11, '6': '.google.cloud.resourcemanager.v3.Project.LabelsEntry', '8': const {}, '10': 'labels'},
  ],
...
final $typed_data.Uint8List getProjectRequestDescriptor = $convert.base64Decode('ChFHZXRQcm9qZWN0UmVxdWVzdBJHCgRuYW1lGAEgASgJQjPgQQL6QS0KK2Nsb3VkcmVzb3VyY2VtYW5hZ2VyLmdvb2dsZWFwaXMuY29tL1Byb2plY3RSBG5hbWU=');
...
final $typed_data.Uint8List listProjectsRequestDescriptor = $convert.base64Decode('ChNMaXN0UHJvamVjdHNSZXF1ZXN0EiEKBnBhcmVudBgBIAEoCUIJ4EEC+kEDEgEqUgZwYXJlbnQSIgoKcGFnZV90b2tlbhgCIAEoCUID4EEBUglwYWdlVG9rZW4SIAoJcGFnZV9zaXplGAMgASgFQgPgQQFSCHBhZ2VTaXplEiYKDHNob3dfZGVsZXRlZBgEIAEoCEID4EEBUgtzaG93RGVsZXRlZA==');
@$core.Deprecated('Use listProjectsResponseDescriptor instead')
const ListProjectsResponse$json = const {
  '1': 'ListProjectsResponse',
  '2': const [
    const {'1': 'projects', '3': 1, '4': 3, '5': 11, '6': '.google.cloud.resourcemanager.v3.Project', '10': 'projects'},
    const {'1': 'next_page_token', '3': 2, '4': 1, '5': 9, '10': 'nextPageToken'},
  ],
};

/// Descriptor for `ListProjectsResponse`. Decode as a `google.protobuf.DescriptorProto`.
final $typed_data.Uint8List listProjectsResponseDescriptor = $convert.base64Decode('ChRMaXN0UHJvamVjdHNSZXNwb25zZRJECghwcm9qZWN0cxgBIAMoCzIoLmdvb2dsZS5jbG91ZC5yZXNvdXJjZW1hbmFnZXIudjMuUHJvamVjdFIIcHJvamVjdHMSJgoPbmV4dF9wYWdlX3Rva2VuGAIgASgJUg1uZXh0UGFnZVRva2Vu');
...
final $typed_data.Uint8List searchProjectsRequestDescriptor = $convert.base64Decode('ChVTZWFyY2hQcm9qZWN0c1JlcXVlc3QSGQoFcXVlcnkYASABKAlCA+BBAVIFcXVlcnkSIgoKcGFnZV90b2tlbhgCIAEoCUID4EEBUglwYWdlVG9rZW4SIAoJcGFnZV9zaXplGAMgASgFQgPgQQFSCHBhZ2VTaXpl');
...
final $typed_data.Uint8List searchProjectsResponseDescriptor = $convert.base64Decode('ChZTZWFyY2hQcm9qZWN0c1Jlc3BvbnNlEkQKCHByb2plY3RzGAEgAygLMiguZ29vZ2xlLmNsb3VkLnJlc291cmNlbWFuYWdlci52My5Qcm9qZWN0Ughwcm9qZWN0cxImCg9uZXh0X3BhZ2VfdG9rZW4YAiABKAlSDW5leHRQYWdlVG9rZW4=');
@$core.Deprecated('Use createProjectRequestDescriptor instead')
const CreateProjectRequest$json = const {
  '1': 'CreateProjectRequest',
  '2': const [
    const {'1': 'project', '3': 1, '4': 1, '5': 11, '6': '.google.cloud.resourcemanager.v3.Project', '8': const {}, '10': 'project'},
  ],
};

/// Descriptor for `CreateProjectRequest`. Decode as a `google.protobuf.DescriptorProto`.
final $typed_data.Uint8List createProjectRequestDescriptor = $convert.base64Decode('ChRDcmVhdGVQcm9qZWN0UmVxdWVzdBJHCgdwcm9qZWN0GAEgASgLMiguZ29vZ2xlLmNsb3VkLnJlc291cmNlbWFuYWdlci52My5Qcm9qZWN0QgPgQQJSB3Byb2plY3Q=');
...
final $typed_data.Uint8List createProjectMetadataDescriptor = $convert.base64Decode('ChVDcmVhdGVQcm9qZWN0TWV0YWRhdGESOwoLY3JlYXRlX3RpbWUYASABKAsyGi5nb29nbGUucHJvdG9idWYuVGltZXN0YW1wUgpjcmVhdGVUaW1lEhoKCGdldHRhYmxlGAIgASgIUghnZXR0YWJsZRIUCgVyZWFkeRgDIAEoCFIFcmVhZHk=');
...
final $typed_data.Uint8List updateProjectRequestDescriptor = $convert.base64Decode('ChRVcGRhdGVQcm9qZWN0UmVxdWVzdBJHCgdwcm9qZWN0GAEgASgLMiguZ29vZ2xlLmNsb3VkLnJlc291cmNlbWFuYWdlci52My5Qcm9qZWN0QgPgQQJSB3Byb2plY3QSQAoLdXBkYXRlX21hc2sYAiABKAsyGi5nb29nbGUucHJvdG9idWYuRmllbGRNYXNrQgPgQQFSCnVwZGF0ZU1hc2s=');
...
final $typed_data.Uint8List updateProjectMetadataDescriptor = $convert.base64Decode('ChVVcGRhdGVQcm9qZWN0TWV0YWRhdGE=');
...
final $typed_data.Uint8List moveProjectRequestDescriptor = $convert.base64Decode('ChJNb3ZlUHJvamVjdFJlcXVlc3QSRwoEbmFtZRgBIAEoCUIz4EEC+kEtCitjbG91ZHJlc291cmNlbWFuYWdlci5nb29nbGVhcGlzLmNvbS9Qcm9qZWN0UgRuYW1lEjgKEmRlc3RpbmF0aW9uX3BhcmVudBgCIAEoCUIJ4EEC+kEDEgEqUhFkZXN0aW5hdGlvblBhcmVudA==');
...
final $typed_data.Uint8List moveProjectMetadataDescriptor = $convert.base64Decode('ChNNb3ZlUHJvamVjdE1ldGFkYXRh');
...
final $typed_data.Uint8List deleteProjectRequestDescriptor = $convert.base64Decode('ChREZWxldGVQcm9qZWN0UmVxdWVzdBJHCgRuYW1lGAEgASgJQjPgQQL6QS0KK2Nsb3VkcmVzb3VyY2VtYW5hZ2VyLmdvb2dsZWFwaXMuY29tL1Byb2plY3RSBG5hbWU=');
...
final $typed_data.Uint8List deleteProjectMetadataDescriptor = $convert.base64Decode('ChVEZWxldGVQcm9qZWN0TWV0YWRhdGE=');
...
final $typed_data.Uint8List undeleteProjectRequestDescriptor = $convert.base64Decode('ChZVbmRlbGV0ZVByb2plY3RSZXF1ZXN0EkcKBG5hbWUYASABKAlCM+BBAvpBLQorY2xvdWRyZXNvdXJjZW1hbmFnZXIuZ29vZ2xlYXBpcy5jb20vUHJvamVjdFIEbmFtZQ==');
...
final $typed_data.Uint8List undeleteProjectMetadataDescriptor = $convert.base64Decode('ChdVbmRlbGV0ZVByb2plY3RNZXRhZGF0YQ==');

...
const Organization$json = const {
  ...
  '2': const [
    ...
    const {'1': 'directory_customer_id', '3': 3, '4': 1, '5': 9, '8': const {}, '9': 0, '10': 'directoryCustomerId'},
    const {'1': 'state', '3': 4, '4': 1, '5': 14, '6': '.google.cloud.resourcemanager.v3.Organization.State', '8': const {}, '10': 'state'},
...
final $typed_data.Uint8List getOrganizationRequestDescriptor = $convert.base64Decode('ChZHZXRPcmdhbml6YXRpb25SZXF1ZXN0EkwKBG5hbWUYASABKAlCOOBBAvpBMgowY2xvdWRyZXNvdXJjZW1hbmFnZXIuZ29vZ2xlYXBpcy5jb20vT3JnYW5pemF0aW9uUgRuYW1l');
...
final $typed_data.Uint8List searchOrganizationsRequestDescriptor = $convert.base64Decode('ChpTZWFyY2hPcmdhbml6YXRpb25zUmVxdWVzdBIgCglwYWdlX3NpemUYASABKAVCA+BBAVIIcGFnZVNpemUSIgoKcGFnZV90b2tlbhgCIAEoCUID4EEBUglwYWdlVG9rZW4SGQoFcXVlcnkYAyABKAlCA+BBAVIFcXVlcnk=');
...
const SearchOrganizationsResponse$json = const {
  ...
  '2': const [
    const {'1': 'organizations', '3': 1, '4': 3, '5': 11, '6': '.google.cloud.resourcemanager.v3.Organization', '10': 'organizations'},
    const {'1': 'next_page_token', '3': 2, '4': 1, '5': 9, '10': 'nextPageToken'},
  ],
};

/// Descriptor for `SearchOrganizationsResponse`. Decode as a `google.protobuf.DescriptorProto`.
final $typed_data.Uint8List searchOrganizationsResponseDescriptor = $convert.base64Decode('ChtTZWFyY2hPcmdhbml6YXRpb25zUmVzcG9uc2USUwoNb3JnYW5pemF0aW9ucxgBIAMoCzItLmdvb2dsZS5jbG91ZC5yZXNvdXJjZW1hbmFnZXIudjMuT3JnYW5pemF0aW9uUg1vcmdhbml6YXRpb25zEiYKD25leHRfcGFnZV90b2tlbhgCIAEoCVINbmV4dFBhZ2VUb2tlbg==');
...
final $typed_data.Uint8List deleteOrganizationMetadataDescriptor = $convert.base64Decode('ChpEZWxldGVPcmdhbml6YXRpb25NZXRhZGF0YQ==');
...
final $typed_data.Uint8List undeleteOrganizationMetadataDescriptor = $convert.base64Decode('ChxVbmRlbGV0ZU9yZ2FuaXphdGlvbk1ldGFkYXRh');

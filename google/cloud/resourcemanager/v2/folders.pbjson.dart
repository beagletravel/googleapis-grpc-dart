...
const Folder$json = const {
  ...
  '2': const [
    ...
    const {'1': 'lifecycle_state', '3': 4, '4': 1, '5': 14, '6': '.google.cloud.resourcemanager.v2.Folder.LifecycleState', '8': const {}, '10': 'lifecycleState'},
...
final $typed_data.Uint8List folderDescriptor = $convert.base64Decode('');
...
final $typed_data.Uint8List listFoldersResponseDescriptor = $convert.base64Decode('ChNMaXN0Rm9sZGVyc1Jlc3BvbnNlEkEKB2ZvbGRlcnMYASADKAsyJy5nb29nbGUuY2xvdWQucmVzb3VyY2VtYW5hZ2VyLnYyLkZvbGRlclIHZm9sZGVycxImCg9uZXh0X3BhZ2VfdG9rZW4YAiABKAlSDW5leHRQYWdlVG9rZW4=');
...
final $typed_data.Uint8List searchFoldersRequestDescriptor = $convert.base64Decode('ChRTZWFyY2hGb2xkZXJzUmVxdWVzdBIgCglwYWdlX3NpemUYASABKAVCA+BBAVIIcGFnZVNpemUSIgoKcGFnZV90b2tlbhgCIAEoCUID4EEBUglwYWdlVG9rZW4SFAoFcXVlcnkYAyABKAlSBXF1ZXJ5');
...
final $typed_data.Uint8List searchFoldersResponseDescriptor = $convert.base64Decode('ChVTZWFyY2hGb2xkZXJzUmVzcG9uc2USQQoHZm9sZGVycxgBIAMoCzInLmdvb2dsZS5jbG91ZC5yZXNvdXJjZW1hbmFnZXIudjIuRm9sZGVyUgdmb2xkZXJzEiYKD25leHRfcGFnZV90b2tlbhgCIAEoCVINbmV4dFBhZ2VUb2tlbg==');
...
const CreateFolderRequest$json = const {
  ...
  '2': const [
    const {'1': 'parent', '3': 1, '4': 1, '5': 9, '8': const {}, '10': 'parent'},
    const {'1': 'folder', '3': 2, '4': 1, '5': 11, '6': '.google.cloud.resourcemanager.v2.Folder', '8': const {}, '10': 'folder'},
  ],
};

/// Descriptor for `CreateFolderRequest`. Decode as a `google.protobuf.DescriptorProto`.
final $typed_data.Uint8List createFolderRequestDescriptor = $convert.base64Decode('ChNDcmVhdGVGb2xkZXJSZXF1ZXN0EiEKBnBhcmVudBgBIAEoCUIJ4EEC+kEDEgEqUgZwYXJlbnQSRAoGZm9sZGVyGAIgASgLMicuZ29vZ2xlLmNsb3VkLnJlc291cmNlbWFuYWdlci52Mi5Gb2xkZXJCA+BBAlIGZm9sZGVy');
...
const UpdateFolderRequest$json = const {
  ...
  '2': const [
    const {'1': 'folder', '3': 1, '4': 1, '5': 11, '6': '.google.cloud.resourcemanager.v2.Folder', '8': const {}, '10': 'folder'},
...
final $typed_data.Uint8List updateFolderRequestDescriptor = $convert.base64Decode('ChNVcGRhdGVGb2xkZXJSZXF1ZXN0EkQKBmZvbGRlchgBIAEoCzInLmdvb2dsZS5jbG91ZC5yZXNvdXJjZW1hbmFnZXIudjIuRm9sZGVyQgPgQQJSBmZvbGRlchJACgt1cGRhdGVfbWFzaxgCIAEoCzIaLmdvb2dsZS5wcm90b2J1Zi5GaWVsZE1hc2tCA+BBAlIKdXBkYXRlTWFzaw==');
...
final $typed_data.Uint8List deleteFolderRequestDescriptor = $convert.base64Decode('ChNEZWxldGVGb2xkZXJSZXF1ZXN0EkYKBG5hbWUYASABKAlCMuBBAvpBLAoqY2xvdWRyZXNvdXJjZW1hbmFnZXIuZ29vZ2xlYXBpcy5jb20vRm9sZGVyUgRuYW1lEikKEHJlY3Vyc2l2ZV9kZWxldGUYAiABKAhSD3JlY3Vyc2l2ZURlbGV0ZQ==');

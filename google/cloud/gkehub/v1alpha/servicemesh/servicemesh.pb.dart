...
class FeatureState extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'FeatureState', package: const $pb.PackageName(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'google.cloud.gkehub.servicemesh.v1alpha'), createEmptyInstance: create)
    ..pc<AnalysisMessage>(1, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'analysisMessages', $pb.PbFieldType.PM, subBuilder: AnalysisMessage.create)
...
class MembershipState extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'MembershipState', package: const $pb.PackageName(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'google.cloud.gkehub.servicemesh.v1alpha'), createEmptyInstance: create)
    ..pc<AnalysisMessage>(1, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'analysisMessages', $pb.PbFieldType.PM, subBuilder: AnalysisMessage.create)
    ..hasRequiredFields = false
  ;
...
class AnalysisMessageBase_Type extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'AnalysisMessageBase.Type', package: const $pb.PackageName(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'google.cloud.gkehub.servicemesh.v1alpha'), createEmptyInstance: create)
  ...
  'Use [GeneratedMessageGenericExtensions.rebuild] instead. '
  'Will be removed in next major version')
  AnalysisMessageBase_Type copyWith(void Function(AnalysisMessageBase_Type) updates) => super.copyWith((message) => updates(message as AnalysisMessageBase_Type)) as AnalysisMessageBase_Type; // ignore: deprecated_member_use
  $pb.BuilderInfo get info_ => _i;
  @$core.pragma('dart2js:noInline')
...
class AnalysisMessageBase extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'AnalysisMessageBase', package: const $pb.PackageName(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'google.cloud.gkehub.servicemesh.v1alpha'), createEmptyInstance: create)
    ..aOM<AnalysisMessageBase_Type>(1, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'type', subBuilder: AnalysisMessageBase_Type.create)
    ..e<AnalysisMessageBase_Level>(2, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'level', $pb.PbFieldType.OE, defaultOrMaker: AnalysisMessageBase_Level.LEVEL_UNSPECIFIED, valueOf: AnalysisMessageBase_Level.valueOf, enumValues: AnalysisMessageBase_Level.values)
    ..aOS(3, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'documentationUrl')
    ..hasRequiredFields = false
  ;
  ...
  'Use [GeneratedMessageGenericExtensions.rebuild] instead. '
  'Will be removed in next major version')
  AnalysisMessageBase copyWith(void Function(AnalysisMessageBase) updates) => super.copyWith((message) => updates(message as AnalysisMessageBase)) as AnalysisMessageBase; // ignore: deprecated_member_use
  $pb.BuilderInfo get info_ => _i;
  @$core.pragma('dart2js:noInline')
...
class AnalysisMessage extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'AnalysisMessage', package: const $pb.PackageName(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'google.cloud.gkehub.servicemesh.v1alpha'), createEmptyInstance: create)
    ..aOM<AnalysisMessageBase>(1, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'messageBase', subBuilder: AnalysisMessageBase.create)
    ..aOS(2, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'description')
    ..pPS(3, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'resourcePaths')
    ..aOM<$0.Struct>(4, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'args', subBuilder: $0.Struct.create)
    ..hasRequiredFields = false
  ;
  ...
  'Use [GeneratedMessageGenericExtensions.rebuild] instead. '
  'Will be removed in next major version')
  AnalysisMessage copyWith(void Function(AnalysisMessage) updates) => super.copyWith((message) => updates(message as AnalysisMessage)) as AnalysisMessage; // ignore: deprecated_member_use
  $pb.BuilderInfo get info_ => _i;
  @$core.pragma('dart2js:noInline')
  ...
  @$pb.TagNumber(4)
  set args($0.Struct v) { setField(4, v); }
  @$pb.TagNumber(4)

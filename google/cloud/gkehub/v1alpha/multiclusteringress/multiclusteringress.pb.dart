...
class FeatureSpec extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'FeatureSpec', package: const $pb.PackageName(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'google.cloud.gkehub.multiclusteringress.v1alpha'), createEmptyInstance: create)
    ..aOS(1, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'configMembership')
    ..e<Billing>(2, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'billing', $pb.PbFieldType.OE, defaultOrMaker: Billing.BILLING_UNSPECIFIED, valueOf: Billing.valueOf, enumValues: Billing.values)
  ...
  'Will be removed in next major version')
  FeatureSpec copyWith(void Function(FeatureSpec) updates) => super.copyWith((message) => updates(message as FeatureSpec)) as FeatureSpec; // ignore: deprecated_member_use

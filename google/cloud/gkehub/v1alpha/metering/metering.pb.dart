...
class MembershipState extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'MembershipState', package: const $pb.PackageName(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'google.cloud.gkehub.metering.v1alpha'), createEmptyInstance: create)
    ..aOM<$0.Timestamp>(1, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'lastMeasurementTime', subBuilder: $0.Timestamp.create)
    ..a<$core.double>(3, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'preciseLastMeasuredClusterVcpuCapacity', $pb.PbFieldType.OF)
  ...
  factory MembershipState({
    ...
    if (preciseLastMeasuredClusterVcpuCapacity != null) {
      _result.preciseLastMeasuredClusterVcpuCapacity = preciseLastMeasuredClusterVcpuCapacity;
    }
    return _result;
  }
  ...
  @$pb.TagNumber(1)
  set lastMeasurementTime($0.Timestamp v) { setField(1, v); }
  @$pb.TagNumber(1)

...
import 'cloudauditlogging/cloudauditlogging.pb.dart' as $2;
import 'servicemesh/servicemesh.pb.dart' as $3;
import 'configmanagement/configmanagement.pb.dart' as $4;
import 'metering/metering.pb.dart' as $5;
...
class Feature extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'Feature', package: const $pb.PackageName(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'google.cloud.gkehub.v1alpha'), createEmptyInstance: create)
    ..aOS(1, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'name')
    ..m<$core.String, $core.String>(2, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'labels', entryClassName: 'Feature.LabelsEntry', keyFieldType: $pb.PbFieldType.OS, valueFieldType: $pb.PbFieldType.OS, packageName: const $pb.PackageName('google.cloud.gkehub.v1alpha'))
    ..aOM<FeatureResourceState>(3, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'resourceState', subBuilder: FeatureResourceState.create)
    ..aOM<CommonFeatureSpec>(4, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'spec', subBuilder: CommonFeatureSpec.create)
    ..m<$core.String, MembershipFeatureSpec>(5, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'membershipSpecs', entryClassName: 'Feature.MembershipSpecsEntry', keyFieldType: $pb.PbFieldType.OS, valueFieldType: $pb.PbFieldType.OM, valueCreator: MembershipFeatureSpec.create, packageName: const $pb.PackageName('google.cloud.gkehub.v1alpha'))
    ..aOM<CommonFeatureState>(6, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'state', subBuilder: CommonFeatureState.create)
    ..m<$core.String, MembershipFeatureState>(7, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'membershipStates', entryClassName: 'Feature.MembershipStatesEntry', keyFieldType: $pb.PbFieldType.OS, valueFieldType: $pb.PbFieldType.OM, valueCreator: MembershipFeatureState.create, packageName: const $pb.PackageName('google.cloud.gkehub.v1alpha'))
    ...
    ..aOM<$0.Timestamp>(10, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'deleteTime', subBuilder: $0.Timestamp.create)
  ...
  @$pb.TagNumber(10)
  set deleteTime($0.Timestamp v) { setField(10, v); }
  @$pb.TagNumber(10)
...
class FeatureResourceState extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'FeatureResourceState', package: const $pb.PackageName(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'google.cloud.gkehub.v1alpha'), createEmptyInstance: create)
    ..e<FeatureResourceState_State>(1, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'state', $pb.PbFieldType.OE, defaultOrMaker: FeatureResourceState_State.STATE_UNSPECIFIED, valueOf: FeatureResourceState_State.valueOf, enumValues: FeatureResourceState_State.values)
    ..hasRequiredFields = false
  ;
  ...
  'Use [GeneratedMessageGenericExtensions.rebuild] instead. '
  'Will be removed in next major version')
  FeatureResourceState copyWith(void Function(FeatureResourceState) updates) => super.copyWith((message) => updates(message as FeatureResourceState)) as FeatureResourceState; // ignore: deprecated_member_use
  $pb.BuilderInfo get info_ => _i;
  @$core.pragma('dart2js:noInline')
...
class FeatureState extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'FeatureState', package: const $pb.PackageName(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'google.cloud.gkehub.v1alpha'), createEmptyInstance: create)
    ..e<FeatureState_Code>(1, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'code', $pb.PbFieldType.OE, defaultOrMaker: FeatureState_Code.CODE_UNSPECIFIED, valueOf: FeatureState_Code.valueOf, enumValues: FeatureState_Code.values)
  ...
  'Use [GeneratedMessageGenericExtensions.rebuild] instead. '
  'Will be removed in next major version')
  FeatureState copyWith(void Function(FeatureState) updates) => super.copyWith((message) => updates(message as FeatureState)) as FeatureState; // ignore: deprecated_member_use
  $pb.BuilderInfo get info_ => _i;
  @$core.pragma('dart2js:noInline')
...
class CommonFeatureSpec extends $pb.GeneratedMessage {
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'CommonFeatureSpec', package: const $pb.PackageName(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'google.cloud.gkehub.v1alpha'), createEmptyInstance: create)
    ..oo(0, [102, 108])
    ..aOM<$1.FeatureSpec>(102, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'multiclusteringress', subBuilder: $1.FeatureSpec.create)
    ..aOM<$2.FeatureSpec>(108, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'cloudauditlogging', subBuilder: $2.FeatureSpec.create)
    ..hasRequiredFields = false
  ;
  ...
  factory CommonFeatureSpec({
    ...
    $2.FeatureSpec? cloudauditlogging,
  }) {
    final _result = create();
    ...
    if (cloudauditlogging != null) {
      _result.cloudauditlogging = cloudauditlogging;
    }
    return _result;
  }
  ...
  'Use [GeneratedMessageGenericExtensions.rebuild] instead. '
  'Will be removed in next major version')
  CommonFeatureSpec copyWith(void Function(CommonFeatureSpec) updates) => super.copyWith((message) => updates(message as CommonFeatureSpec)) as CommonFeatureSpec; // ignore: deprecated_member_use
  $pb.BuilderInfo get info_ => _i;
  @$core.pragma('dart2js:noInline')
  ...
  @$pb.TagNumber(102)
  set multiclusteringress($1.FeatureSpec v) { setField(102, v); }
  @$pb.TagNumber(102)
  ...
  @$pb.TagNumber(108)
  $2.FeatureSpec get cloudauditlogging => $_getN(1);
  @$pb.TagNumber(108)
  set cloudauditlogging($2.FeatureSpec v) { setField(108, v); }
  @$pb.TagNumber(108)
  $core.bool hasCloudauditlogging() => $_has(1);
  @$pb.TagNumber(108)
  void clearCloudauditlogging() => clearField(108);
  @$pb.TagNumber(108)
  $2.FeatureSpec ensureCloudauditlogging() => $_ensure(1);
}
...
class CommonFeatureState extends $pb.GeneratedMessage {
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'CommonFeatureState', package: const $pb.PackageName(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'google.cloud.gkehub.v1alpha'), createEmptyInstance: create)
    ..oo(0, [100])
    ..aOM<FeatureState>(1, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'state', subBuilder: FeatureState.create)
    ..aOM<$3.FeatureState>(100, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'servicemesh', subBuilder: $3.FeatureState.create)
    ..hasRequiredFields = false
  ;
  ...
  factory CommonFeatureState({
    ...
    if (servicemesh != null) {
      _result.servicemesh = servicemesh;
    }
    return _result;
  }
  ...
  'Use [GeneratedMessageGenericExtensions.rebuild] instead. '
  'Will be removed in next major version')
  CommonFeatureState copyWith(void Function(CommonFeatureState) updates) => super.copyWith((message) => updates(message as CommonFeatureState)) as CommonFeatureState; // ignore: deprecated_member_use
  $pb.BuilderInfo get info_ => _i;
  @$core.pragma('dart2js:noInline')
  ...
  @$pb.TagNumber(100)
  $3.FeatureState get servicemesh => $_getN(1);
  @$pb.TagNumber(100)
  set servicemesh($3.FeatureState v) { setField(100, v); }
  @$pb.TagNumber(100)
  $core.bool hasServicemesh() => $_has(1);
  @$pb.TagNumber(100)
  void clearServicemesh() => clearField(100);
  @$pb.TagNumber(100)
  $3.FeatureState ensureServicemesh() => $_ensure(1);
}
...
class MembershipFeatureSpec extends $pb.GeneratedMessage {
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'MembershipFeatureSpec', package: const $pb.PackageName(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'google.cloud.gkehub.v1alpha'), createEmptyInstance: create)
    ..oo(0, [106])
    ..aOM<$4.MembershipSpec>(106, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'configmanagement', subBuilder: $4.MembershipSpec.create)
    ..hasRequiredFields = false
  ;

  MembershipFeatureSpec._() : super();
  factory MembershipFeatureSpec({
    $4.MembershipSpec? configmanagement,
  }) {
    final _result = create();
  ...
  'Use [GeneratedMessageGenericExtensions.rebuild] instead. '
  'Will be removed in next major version')
  MembershipFeatureSpec copyWith(void Function(MembershipFeatureSpec) updates) => super.copyWith((message) => updates(message as MembershipFeatureSpec)) as MembershipFeatureSpec; // ignore: deprecated_member_use
  $pb.BuilderInfo get info_ => _i;
  @$core.pragma('dart2js:noInline')
  ...
  @$pb.TagNumber(106)
  $4.MembershipSpec get configmanagement => $_getN(0);
  @$pb.TagNumber(106)
  set configmanagement($4.MembershipSpec v) { setField(106, v); }
  @$pb.TagNumber(106)
  $core.bool hasConfigmanagement() => $_has(0);
  @$pb.TagNumber(106)
  void clearConfigmanagement() => clearField(106);
  @$pb.TagNumber(106)
  $4.MembershipSpec ensureConfigmanagement() => $_ensure(0);
}
...
class MembershipFeatureState extends $pb.GeneratedMessage {
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'MembershipFeatureState', package: const $pb.PackageName(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'google.cloud.gkehub.v1alpha'), createEmptyInstance: create)
    ..oo(0, [100, 104, 106])
    ..aOM<FeatureState>(1, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'state', subBuilder: FeatureState.create)
    ..aOM<$3.MembershipState>(100, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'servicemesh', subBuilder: $3.MembershipState.create)
    ..aOM<$5.MembershipState>(104, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'metering', subBuilder: $5.MembershipState.create)
    ..aOM<$4.MembershipState>(106, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'configmanagement', subBuilder: $4.MembershipState.create)
    ..hasRequiredFields = false
  ;
  ...
  factory MembershipFeatureState({
    FeatureState? state,
    $3.MembershipState? servicemesh,
    $5.MembershipState? metering,
    $4.MembershipState? configmanagement,
  }) {
    final _result = create();
    if (state != null) {
      _result.state = state;
  ...
  'Use [GeneratedMessageGenericExtensions.rebuild] instead. '
  'Will be removed in next major version')
  MembershipFeatureState copyWith(void Function(MembershipFeatureState) updates) => super.copyWith((message) => updates(message as MembershipFeatureState)) as MembershipFeatureState; // ignore: deprecated_member_use
  $pb.BuilderInfo get info_ => _i;
  @$core.pragma('dart2js:noInline')
  ...
  @$pb.TagNumber(100)
  $3.MembershipState get servicemesh => $_getN(1);
  @$pb.TagNumber(100)
  set servicemesh($3.MembershipState v) { setField(100, v); }
  @$pb.TagNumber(100)
  $core.bool hasServicemesh() => $_has(1);
  @$pb.TagNumber(100)
  void clearServicemesh() => clearField(100);
  @$pb.TagNumber(100)
  $3.MembershipState ensureServicemesh() => $_ensure(1);

  @$pb.TagNumber(104)
  $5.MembershipState get metering => $_getN(2);
  @$pb.TagNumber(104)
  set metering($5.MembershipState v) { setField(104, v); }
  @$pb.TagNumber(104)
  $core.bool hasMetering() => $_has(2);
  @$pb.TagNumber(104)
  void clearMetering() => clearField(104);
  @$pb.TagNumber(104)
  $5.MembershipState ensureMetering() => $_ensure(2);

  @$pb.TagNumber(106)
  $4.MembershipState get configmanagement => $_getN(3);
  @$pb.TagNumber(106)
  set configmanagement($4.MembershipState v) { setField(106, v); }
  @$pb.TagNumber(106)
  $core.bool hasConfigmanagement() => $_has(3);
  @$pb.TagNumber(106)
  void clearConfigmanagement() => clearField(106);
  @$pb.TagNumber(106)
  $4.MembershipState ensureConfigmanagement() => $_ensure(3);
}

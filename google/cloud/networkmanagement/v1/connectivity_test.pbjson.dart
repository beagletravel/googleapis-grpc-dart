...
const ConnectivityTest$json = const {
  ...
  '2': const [
    ...
    const {'1': 'source', '3': 3, '4': 1, '5': 11, '6': '.google.cloud.networkmanagement.v1.Endpoint', '8': const {}, '10': 'source'},
    const {'1': 'destination', '3': 4, '4': 1, '5': 11, '6': '.google.cloud.networkmanagement.v1.Endpoint', '8': const {}, '10': 'destination'},
    ...
    const {'1': 'labels', '3': 8, '4': 3, '5': 11, '6': '.google.cloud.networkmanagement.v1.ConnectivityTest.LabelsEntry', '10': 'labels'},
    ...
    const {'1': 'reachability_details', '3': 12, '4': 1, '5': 11, '6': '.google.cloud.networkmanagement.v1.ReachabilityDetails', '8': const {}, '10': 'reachabilityDetails'},
  ],
...
const Endpoint$json = const {
  ...
  '2': const [
    ...
    const {'1': 'network_type', '3': 5, '4': 1, '5': 14, '6': '.google.cloud.networkmanagement.v1.Endpoint.NetworkType', '10': 'networkType'},
...
final $typed_data.Uint8List endpointDescriptor = $convert.base64Decode('');
@$core.Deprecated('Use reachabilityDetailsDescriptor instead')
const ReachabilityDetails$json = const {
  '1': 'ReachabilityDetails',
  '2': const [
    const {'1': 'result', '3': 1, '4': 1, '5': 14, '6': '.google.cloud.networkmanagement.v1.ReachabilityDetails.Result', '10': 'result'},
    ...
    const {'1': 'traces', '3': 5, '4': 3, '5': 11, '6': '.google.cloud.networkmanagement.v1.Trace', '10': 'traces'},
  ],
...
final $typed_data.Uint8List reachabilityDetailsDescriptor = $convert.base64Decode('');

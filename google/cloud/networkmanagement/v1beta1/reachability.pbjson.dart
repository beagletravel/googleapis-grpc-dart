...
final $typed_data.Uint8List listConnectivityTestsRequestDescriptor = $convert.base64Decode('ChxMaXN0Q29ubmVjdGl2aXR5VGVzdHNSZXF1ZXN0EhsKBnBhcmVudBgBIAEoCUID4EECUgZwYXJlbnQSGwoJcGFnZV9zaXplGAIgASgFUghwYWdlU2l6ZRIdCgpwYWdlX3Rva2VuGAMgASgJUglwYWdlVG9rZW4SFgoGZmlsdGVyGAQgASgJUgZmaWx0ZXISGQoIb3JkZXJfYnkYBSABKAlSB29yZGVyQnk=');
...
const ListConnectivityTestsResponse$json = const {
  ...
  '2': const [
    const {'1': 'resources', '3': 1, '4': 3, '5': 11, '6': '.google.cloud.networkmanagement.v1beta1.ConnectivityTest', '10': 'resources'},
...
final $typed_data.Uint8List listConnectivityTestsResponseDescriptor = $convert.base64Decode('');
...
final $typed_data.Uint8List getConnectivityTestRequestDescriptor = $convert.base64Decode('ChpHZXRDb25uZWN0aXZpdHlUZXN0UmVxdWVzdBIXCgRuYW1lGAEgASgJQgPgQQJSBG5hbWU=');
...
const CreateConnectivityTestRequest$json = const {
  ...
  '2': const [
    const {'1': 'parent', '3': 1, '4': 1, '5': 9, '8': const {}, '10': 'parent'},
    const {'1': 'test_id', '3': 2, '4': 1, '5': 9, '8': const {}, '10': 'testId'},
    const {'1': 'resource', '3': 3, '4': 1, '5': 11, '6': '.google.cloud.networkmanagement.v1beta1.ConnectivityTest', '8': const {}, '10': 'resource'},
  ],
};

/// Descriptor for `CreateConnectivityTestRequest`. Decode as a `google.protobuf.DescriptorProto`.
final $typed_data.Uint8List createConnectivityTestRequestDescriptor = $convert.base64Decode('Ch1DcmVhdGVDb25uZWN0aXZpdHlUZXN0UmVxdWVzdBIbCgZwYXJlbnQYASABKAlCA+BBAlIGcGFyZW50EhwKB3Rlc3RfaWQYAiABKAlCA+BBAlIGdGVzdElkElkKCHJlc291cmNlGAMgASgLMjguZ29vZ2xlLmNsb3VkLm5ldHdvcmttYW5hZ2VtZW50LnYxYmV0YTEuQ29ubmVjdGl2aXR5VGVzdEID4EECUghyZXNvdXJjZQ==');
...
const UpdateConnectivityTestRequest$json = const {
  ...
  '2': const [
    ...
    const {'1': 'resource', '3': 2, '4': 1, '5': 11, '6': '.google.cloud.networkmanagement.v1beta1.ConnectivityTest', '8': const {}, '10': 'resource'},
  ],
};

/// Descriptor for `UpdateConnectivityTestRequest`. Decode as a `google.protobuf.DescriptorProto`.
final $typed_data.Uint8List updateConnectivityTestRequestDescriptor = $convert.base64Decode('Ch1VcGRhdGVDb25uZWN0aXZpdHlUZXN0UmVxdWVzdBJACgt1cGRhdGVfbWFzaxgBIAEoCzIaLmdvb2dsZS5wcm90b2J1Zi5GaWVsZE1hc2tCA+BBAlIKdXBkYXRlTWFzaxJZCghyZXNvdXJjZRgCIAEoCzI4Lmdvb2dsZS5jbG91ZC5uZXR3b3JrbWFuYWdlbWVudC52MWJldGExLkNvbm5lY3Rpdml0eVRlc3RCA+BBAlIIcmVzb3VyY2U=');
...
final $typed_data.Uint8List deleteConnectivityTestRequestDescriptor = $convert.base64Decode('Ch1EZWxldGVDb25uZWN0aXZpdHlUZXN0UmVxdWVzdBIXCgRuYW1lGAEgASgJQgPgQQJSBG5hbWU=');
...
final $typed_data.Uint8List rerunConnectivityTestRequestDescriptor = $convert.base64Decode('ChxSZXJ1bkNvbm5lY3Rpdml0eVRlc3RSZXF1ZXN0EhcKBG5hbWUYASABKAlCA+BBAlIEbmFtZQ==');

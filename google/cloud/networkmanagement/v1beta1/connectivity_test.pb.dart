...
class ConnectivityTest extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'ConnectivityTest', package: const $pb.PackageName(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'google.cloud.networkmanagement.v1beta1'), createEmptyInstance: create)
    ..aOS(1, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'name')
    ..aOS(2, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'description')
    ..aOM<Endpoint>(3, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'source', subBuilder: Endpoint.create)
    ..aOM<Endpoint>(4, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'destination', subBuilder: Endpoint.create)
    ..aOS(5, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'protocol')
    ..pPS(6, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'relatedProjects')
    ..aOS(7, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'displayName')
    ..m<$core.String, $core.String>(8, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'labels', entryClassName: 'ConnectivityTest.LabelsEntry', keyFieldType: $pb.PbFieldType.OS, valueFieldType: $pb.PbFieldType.OS, packageName: const $pb.PackageName('google.cloud.networkmanagement.v1beta1'))
    ...
    ..aOM<ReachabilityDetails>(12, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'reachabilityDetails', subBuilder: ReachabilityDetails.create)
    ..aOM<ProbingDetails>(14, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'probingDetails', subBuilder: ProbingDetails.create)
  ...
  'Will be removed in next major version')
  ConnectivityTest copyWith(void Function(ConnectivityTest) updates) => super.copyWith((message) => updates(message as ConnectivityTest)) as ConnectivityTest; // ignore: deprecated_member_use
...
class Endpoint extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'Endpoint', package: const $pb.PackageName(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'google.cloud.networkmanagement.v1beta1'), createEmptyInstance: create)
    ...
    ..aOS(3, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'instance')
    ..aOS(4, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'network')
    ..e<Endpoint_NetworkType>(5, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'networkType', $pb.PbFieldType.OE, defaultOrMaker: Endpoint_NetworkType.NETWORK_TYPE_UNSPECIFIED, valueOf: Endpoint_NetworkType.valueOf, enumValues: Endpoint_NetworkType.values)
    ..aOS(6, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'projectId')
    ..aOS(7, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'gkeMasterCluster')
    ..aOS(8, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'cloudSqlInstance')
    ..hasRequiredFields = false
  ;
...
class ReachabilityDetails extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'ReachabilityDetails', package: const $pb.PackageName(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'google.cloud.networkmanagement.v1beta1'), createEmptyInstance: create)
    ..e<ReachabilityDetails_Result>(1, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'result', $pb.PbFieldType.OE, defaultOrMaker: ReachabilityDetails_Result.RESULT_UNSPECIFIED, valueOf: ReachabilityDetails_Result.valueOf, enumValues: ReachabilityDetails_Result.values)
    ..aOM<$0.Timestamp>(2, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'verifyTime', subBuilder: $0.Timestamp.create)
    ..aOM<$1.Status>(3, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'error', subBuilder: $1.Status.create)
    ..pc<$2.Trace>(5, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'traces', $pb.PbFieldType.PM, subBuilder: $2.Trace.create)
    ..hasRequiredFields = false
  ;
  ...
  'Use [GeneratedMessageGenericExtensions.rebuild] instead. '
  'Will be removed in next major version')
  ReachabilityDetails copyWith(void Function(ReachabilityDetails) updates) => super.copyWith((message) => updates(message as ReachabilityDetails)) as ReachabilityDetails; // ignore: deprecated_member_use
  $pb.BuilderInfo get info_ => _i;
  @$core.pragma('dart2js:noInline')
  ...
  @$pb.TagNumber(2)
  set verifyTime($0.Timestamp v) { setField(2, v); }
  @$pb.TagNumber(2)
  ...
  @$pb.TagNumber(3)
  set error($1.Status v) { setField(3, v); }
  @$pb.TagNumber(3)
...
class LatencyPercentile extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'LatencyPercentile', package: const $pb.PackageName(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'google.cloud.networkmanagement.v1beta1'), createEmptyInstance: create)
    ..a<$core.int>(1, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'percent', $pb.PbFieldType.O3)
    ..aInt64(2, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'latencyMicros')
    ..hasRequiredFields = false
  ;
  ...
  'Use [GeneratedMessageGenericExtensions.rebuild] instead. '
  'Will be removed in next major version')
  LatencyPercentile copyWith(void Function(LatencyPercentile) updates) => super.copyWith((message) => updates(message as LatencyPercentile)) as LatencyPercentile; // ignore: deprecated_member_use
  $pb.BuilderInfo get info_ => _i;
  @$core.pragma('dart2js:noInline')
...
class LatencyDistribution extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'LatencyDistribution', package: const $pb.PackageName(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'google.cloud.networkmanagement.v1beta1'), createEmptyInstance: create)
    ..pc<LatencyPercentile>(1, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'latencyPercentiles', $pb.PbFieldType.PM, subBuilder: LatencyPercentile.create)
    ..hasRequiredFields = false
  ;
  ...
  'Use [GeneratedMessageGenericExtensions.rebuild] instead. '
  'Will be removed in next major version')
  LatencyDistribution copyWith(void Function(LatencyDistribution) updates) => super.copyWith((message) => updates(message as LatencyDistribution)) as LatencyDistribution; // ignore: deprecated_member_use
  $pb.BuilderInfo get info_ => _i;
  @$core.pragma('dart2js:noInline')
...
class ProbingDetails extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'ProbingDetails', package: const $pb.PackageName(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'google.cloud.networkmanagement.v1beta1'), createEmptyInstance: create)
    ..e<ProbingDetails_ProbingResult>(1, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'result', $pb.PbFieldType.OE, defaultOrMaker: ProbingDetails_ProbingResult.PROBING_RESULT_UNSPECIFIED, valueOf: ProbingDetails_ProbingResult.valueOf, enumValues: ProbingDetails_ProbingResult.values)
    ..aOM<$0.Timestamp>(2, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'verifyTime', subBuilder: $0.Timestamp.create)
    ..aOM<$1.Status>(3, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'error', subBuilder: $1.Status.create)
    ..e<ProbingDetails_ProbingAbortCause>(4, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'abortCause', $pb.PbFieldType.OE, defaultOrMaker: ProbingDetails_ProbingAbortCause.PROBING_ABORT_CAUSE_UNSPECIFIED, valueOf: ProbingDetails_ProbingAbortCause.valueOf, enumValues: ProbingDetails_ProbingAbortCause.values)
    ..a<$core.int>(5, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'sentProbeCount', $pb.PbFieldType.O3)
    ..a<$core.int>(6, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'successfulProbeCount', $pb.PbFieldType.O3)
    ..aOM<$2.EndpointInfo>(7, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'endpointInfo', subBuilder: $2.EndpointInfo.create)
    ..aOM<LatencyDistribution>(8, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'probingLatency', subBuilder: LatencyDistribution.create)
    ..hasRequiredFields = false
  ;
  ...
  'Use [GeneratedMessageGenericExtensions.rebuild] instead. '
  'Will be removed in next major version')
  ProbingDetails copyWith(void Function(ProbingDetails) updates) => super.copyWith((message) => updates(message as ProbingDetails)) as ProbingDetails; // ignore: deprecated_member_use
  $pb.BuilderInfo get info_ => _i;
  @$core.pragma('dart2js:noInline')
  ...
  @$pb.TagNumber(7)
  set endpointInfo($2.EndpointInfo v) { setField(7, v); }
  @$pb.TagNumber(7)

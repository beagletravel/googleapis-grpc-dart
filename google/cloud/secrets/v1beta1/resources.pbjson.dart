...
const Secret$json = const {
  ...
  '2': const [
    ...
    const {'1': 'replication', '3': 2, '4': 1, '5': 11, '6': '.google.cloud.secrets.v1beta1.Replication', '8': const {}, '10': 'replication'},
    const {'1': 'create_time', '3': 3, '4': 1, '5': 11, '6': '.google.protobuf.Timestamp', '8': const {}, '10': 'createTime'},
    const {'1': 'labels', '3': 4, '4': 3, '5': 11, '6': '.google.cloud.secrets.v1beta1.Secret.LabelsEntry', '10': 'labels'},
  ],
...
const SecretVersion$json = const {
  ...
  '2': const [
    ...
    const {'1': 'state', '3': 4, '4': 1, '5': 14, '6': '.google.cloud.secrets.v1beta1.SecretVersion.State', '8': const {}, '10': 'state'},
  ],
...
const Replication$json = const {
  '1': 'Replication',
  '2': const [
    const {'1': 'automatic', '3': 1, '4': 1, '5': 11, '6': '.google.cloud.secrets.v1beta1.Replication.Automatic', '9': 0, '10': 'automatic'},
    const {'1': 'user_managed', '3': 2, '4': 1, '5': 11, '6': '.google.cloud.secrets.v1beta1.Replication.UserManaged', '9': 0, '10': 'userManaged'},
  ],
...
const Replication_UserManaged$json = const {
  '1': 'UserManaged',
  '2': const [
    const {'1': 'replicas', '3': 1, '4': 3, '5': 11, '6': '.google.cloud.secrets.v1beta1.Replication.UserManaged.Replica', '8': const {}, '10': 'replicas'},
  ],
...
final $typed_data.Uint8List replicationDescriptor = $convert.base64Decode('');
...
final $typed_data.Uint8List secretPayloadDescriptor = $convert.base64Decode('Cg1TZWNyZXRQYXlsb2FkEhIKBGRhdGEYASABKAxSBGRhdGE=');

...
class CloudRedisClient extends $grpc.Client {
  ...
  static final _$getInstanceAuthString = $grpc.ClientMethod<
          $2.GetInstanceAuthStringRequest, $2.InstanceAuthString>(
      '/google.cloud.redis.v1beta1.CloudRedis/GetInstanceAuthString',
      ($2.GetInstanceAuthStringRequest value) => value.writeToBuffer(),
      ($core.List<$core.int> value) => $2.InstanceAuthString.fromBuffer(value));
  ...
  static final _$deleteInstance =
      $grpc.ClientMethod<$2.DeleteInstanceRequest, $0.Operation>(
          ...
          ($core.List<$core.int> value) => $0.Operation.fromBuffer(value));
  static final _$rescheduleMaintenance =
      $grpc.ClientMethod<$2.RescheduleMaintenanceRequest, $0.Operation>(
          '/google.cloud.redis.v1beta1.CloudRedis/RescheduleMaintenance',
          ($2.RescheduleMaintenanceRequest value) => value.writeToBuffer(),
          ($core.List<$core.int> value) => $0.Operation.fromBuffer(value));
  ...
  $grpc.ResponseFuture<$2.InstanceAuthString> getInstanceAuthString(
      $2.GetInstanceAuthStringRequest request,
      {$grpc.CallOptions? options}) {
  ...
  $grpc.ResponseFuture<$0.Operation> rescheduleMaintenance(
      $2.RescheduleMaintenanceRequest request,
      {$grpc.CallOptions? options}) {
...
abstract class CloudRedisServiceBase extends $grpc.Service {
  ...
  CloudRedisServiceBase() {
    ...
    $addMethod($grpc.ServiceMethod<$2.GetInstanceAuthStringRequest,
            $2.InstanceAuthString>(
        'GetInstanceAuthString',
        getInstanceAuthString_Pre,
        false,
        false,
        ($core.List<$core.int> value) =>
            $2.GetInstanceAuthStringRequest.fromBuffer(value),
        ($2.InstanceAuthString value) => value.writeToBuffer()));
    ...
    $addMethod($grpc.ServiceMethod<$2.DeleteInstanceRequest, $0.Operation>(
        ...
        ($0.Operation value) => value.writeToBuffer()));
    $addMethod(
        $grpc.ServiceMethod<$2.RescheduleMaintenanceRequest, $0.Operation>(
            'RescheduleMaintenance',
            rescheduleMaintenance_Pre,
            false,
            false,
            ($core.List<$core.int> value) =>
                $2.RescheduleMaintenanceRequest.fromBuffer(value),
            ($0.Operation value) => value.writeToBuffer()));
  }
  ...
  $async.Future<$2.InstanceAuthString> getInstanceAuthString_Pre(
      $grpc.ServiceCall call,
      $async.Future<$2.GetInstanceAuthStringRequest> request) async {
  ...
  $async.Future<$0.Operation> rescheduleMaintenance_Pre($grpc.ServiceCall call,
      $async.Future<$2.RescheduleMaintenanceRequest> request) async {
  ...
  $async.Future<$2.InstanceAuthString> getInstanceAuthString(
      $grpc.ServiceCall call, $2.GetInstanceAuthStringRequest request);
  ...
  $async.Future<$0.Operation> rescheduleMaintenance(
      $grpc.ServiceCall call, $2.RescheduleMaintenanceRequest request);
}

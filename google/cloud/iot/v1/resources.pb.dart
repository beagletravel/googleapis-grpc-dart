...
class Device extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'Device', package: const $pb.PackageName(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'google.cloud.iot.v1'), createEmptyInstance: create)
    ..aOS(1, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'id')
    ..aOS(2, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'name')
    ..a<$fixnum.Int64>(3, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'numId', $pb.PbFieldType.OU6, defaultOrMaker: $fixnum.Int64.ZERO)
    ..aOM<$0.Timestamp>(7, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'lastHeartbeatTime', subBuilder: $0.Timestamp.create)
    ..aOM<$0.Timestamp>(8, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'lastEventTime', subBuilder: $0.Timestamp.create)
    ..aOM<$0.Timestamp>(10, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'lastErrorTime', subBuilder: $0.Timestamp.create)
    ..aOM<$1.Status>(11, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'lastErrorStatus', subBuilder: $1.Status.create)
    ..pc<DeviceCredential>(12, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'credentials', $pb.PbFieldType.PM, subBuilder: DeviceCredential.create)
    ..aOM<DeviceConfig>(13, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'config', subBuilder: DeviceConfig.create)
    ..aOM<$0.Timestamp>(14, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'lastConfigAckTime', subBuilder: $0.Timestamp.create)
    ..aOM<DeviceState>(16, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'state', subBuilder: DeviceState.create)
    ..m<$core.String, $core.String>(17, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'metadata', entryClassName: 'Device.MetadataEntry', keyFieldType: $pb.PbFieldType.OS, valueFieldType: $pb.PbFieldType.OS, packageName: const $pb.PackageName('google.cloud.iot.v1'))
    ..aOM<$0.Timestamp>(18, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'lastConfigSendTime', subBuilder: $0.Timestamp.create)
    ..aOB(19, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'blocked')
    ..aOM<$0.Timestamp>(20, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'lastStateTime', subBuilder: $0.Timestamp.create)
    ..e<LogLevel>(21, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'logLevel', $pb.PbFieldType.OE, defaultOrMaker: LogLevel.LOG_LEVEL_UNSPECIFIED, valueOf: LogLevel.valueOf, enumValues: LogLevel.values)
    ..aOM<GatewayConfig>(24, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'gatewayConfig', subBuilder: GatewayConfig.create)
  ...
  @$pb.TagNumber(7)
  set lastHeartbeatTime($0.Timestamp v) { setField(7, v); }
  @$pb.TagNumber(7)
  ...
  @$pb.TagNumber(8)
  set lastEventTime($0.Timestamp v) { setField(8, v); }
  @$pb.TagNumber(8)
  ...
  @$pb.TagNumber(10)
  set lastErrorTime($0.Timestamp v) { setField(10, v); }
  @$pb.TagNumber(10)
  ...
  @$pb.TagNumber(11)
  set lastErrorStatus($1.Status v) { setField(11, v); }
  @$pb.TagNumber(11)
  ...
  @$pb.TagNumber(14)
  set lastConfigAckTime($0.Timestamp v) { setField(14, v); }
  @$pb.TagNumber(14)
  ...
  @$pb.TagNumber(18)
  set lastConfigSendTime($0.Timestamp v) { setField(18, v); }
  @$pb.TagNumber(18)
  ...
  @$pb.TagNumber(20)
  set lastStateTime($0.Timestamp v) { setField(20, v); }
  @$pb.TagNumber(20)
...
class GatewayConfig extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'GatewayConfig', package: const $pb.PackageName(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'google.cloud.iot.v1'), createEmptyInstance: create)
    ..e<GatewayType>(1, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'gatewayType', $pb.PbFieldType.OE, defaultOrMaker: GatewayType.GATEWAY_TYPE_UNSPECIFIED, valueOf: GatewayType.valueOf, enumValues: GatewayType.values)
    ..e<GatewayAuthMethod>(2, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'gatewayAuthMethod', $pb.PbFieldType.OE, defaultOrMaker: GatewayAuthMethod.GATEWAY_AUTH_METHOD_UNSPECIFIED, valueOf: GatewayAuthMethod.valueOf, enumValues: GatewayAuthMethod.values)
    ..aOS(3, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'lastAccessedGatewayId')
    ..aOM<$0.Timestamp>(4, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'lastAccessedGatewayTime', subBuilder: $0.Timestamp.create)
    ..hasRequiredFields = false
  ;
  ...
  'Use [GeneratedMessageGenericExtensions.rebuild] instead. '
  'Will be removed in next major version')
  GatewayConfig copyWith(void Function(GatewayConfig) updates) => super.copyWith((message) => updates(message as GatewayConfig)) as GatewayConfig; // ignore: deprecated_member_use
  $pb.BuilderInfo get info_ => _i;
  @$core.pragma('dart2js:noInline')
  ...
  @$pb.TagNumber(4)
  set lastAccessedGatewayTime($0.Timestamp v) { setField(4, v); }
  @$pb.TagNumber(4)
...
class DeviceRegistry extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'DeviceRegistry', package: const $pb.PackageName(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'google.cloud.iot.v1'), createEmptyInstance: create)
    ..aOS(1, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'id')
    ..aOS(2, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'name')
    ..aOM<MqttConfig>(4, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'mqttConfig', subBuilder: MqttConfig.create)
    ..aOM<StateNotificationConfig>(7, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'stateNotificationConfig', subBuilder: StateNotificationConfig.create)
    ..pc<RegistryCredential>(8, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'credentials', $pb.PbFieldType.PM, subBuilder: RegistryCredential.create)
    ..aOM<HttpConfig>(9, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'httpConfig', subBuilder: HttpConfig.create)
    ..pc<EventNotificationConfig>(10, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'eventNotificationConfigs', $pb.PbFieldType.PM, subBuilder: EventNotificationConfig.create)
    ..e<LogLevel>(11, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'logLevel', $pb.PbFieldType.OE, defaultOrMaker: LogLevel.LOG_LEVEL_UNSPECIFIED, valueOf: LogLevel.valueOf, enumValues: LogLevel.values)
    ..hasRequiredFields = false
  ;
  ...
  'Use [GeneratedMessageGenericExtensions.rebuild] instead. '
  'Will be removed in next major version')
  DeviceRegistry copyWith(void Function(DeviceRegistry) updates) => super.copyWith((message) => updates(message as DeviceRegistry)) as DeviceRegistry; // ignore: deprecated_member_use
  $pb.BuilderInfo get info_ => _i;
  @$core.pragma('dart2js:noInline')
...
class MqttConfig extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'MqttConfig', package: const $pb.PackageName(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'google.cloud.iot.v1'), createEmptyInstance: create)
    ..e<MqttState>(1, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'mqttEnabledState', $pb.PbFieldType.OE, defaultOrMaker: MqttState.MQTT_STATE_UNSPECIFIED, valueOf: MqttState.valueOf, enumValues: MqttState.values)
    ..hasRequiredFields = false
  ;
  ...
  'Use [GeneratedMessageGenericExtensions.rebuild] instead. '
  'Will be removed in next major version')
  MqttConfig copyWith(void Function(MqttConfig) updates) => super.copyWith((message) => updates(message as MqttConfig)) as MqttConfig; // ignore: deprecated_member_use
  $pb.BuilderInfo get info_ => _i;
  @$core.pragma('dart2js:noInline')
...
class HttpConfig extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'HttpConfig', package: const $pb.PackageName(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'google.cloud.iot.v1'), createEmptyInstance: create)
    ..e<HttpState>(1, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'httpEnabledState', $pb.PbFieldType.OE, defaultOrMaker: HttpState.HTTP_STATE_UNSPECIFIED, valueOf: HttpState.valueOf, enumValues: HttpState.values)
    ..hasRequiredFields = false
  ;
...
class EventNotificationConfig extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'EventNotificationConfig', package: const $pb.PackageName(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'google.cloud.iot.v1'), createEmptyInstance: create)
    ..aOS(1, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'pubsubTopicName')
    ..aOS(2, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'subfolderMatches')
    ..hasRequiredFields = false
  ;
  ...
  'Use [GeneratedMessageGenericExtensions.rebuild] instead. '
  'Will be removed in next major version')
  EventNotificationConfig copyWith(void Function(EventNotificationConfig) updates) => super.copyWith((message) => updates(message as EventNotificationConfig)) as EventNotificationConfig; // ignore: deprecated_member_use
  $pb.BuilderInfo get info_ => _i;
  @$core.pragma('dart2js:noInline')
...
class StateNotificationConfig extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'StateNotificationConfig', package: const $pb.PackageName(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'google.cloud.iot.v1'), createEmptyInstance: create)
    ..aOS(1, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'pubsubTopicName')
    ..hasRequiredFields = false
  ;
  ...
  'Use [GeneratedMessageGenericExtensions.rebuild] instead. '
  'Will be removed in next major version')
  StateNotificationConfig copyWith(void Function(StateNotificationConfig) updates) => super.copyWith((message) => updates(message as StateNotificationConfig)) as StateNotificationConfig; // ignore: deprecated_member_use
  $pb.BuilderInfo get info_ => _i;
  @$core.pragma('dart2js:noInline')
...
class RegistryCredential extends $pb.GeneratedMessage {
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'RegistryCredential', package: const $pb.PackageName(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'google.cloud.iot.v1'), createEmptyInstance: create)
    ..oo(0, [1])
    ..aOM<PublicKeyCertificate>(1, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'publicKeyCertificate', subBuilder: PublicKeyCertificate.create)
    ..hasRequiredFields = false
  ;
  ...
  'Use [GeneratedMessageGenericExtensions.rebuild] instead. '
  'Will be removed in next major version')
  RegistryCredential copyWith(void Function(RegistryCredential) updates) => super.copyWith((message) => updates(message as RegistryCredential)) as RegistryCredential; // ignore: deprecated_member_use
  $pb.BuilderInfo get info_ => _i;
  @$core.pragma('dart2js:noInline')
...
class X509CertificateDetails extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'X509CertificateDetails', package: const $pb.PackageName(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'google.cloud.iot.v1'), createEmptyInstance: create)
    ...
    ..aOM<$0.Timestamp>(4, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'expiryTime', subBuilder: $0.Timestamp.create)
    ..aOS(5, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'signatureAlgorithm')
    ..aOS(6, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'publicKeyType')
    ..hasRequiredFields = false
  ;
  ...
  'Use [GeneratedMessageGenericExtensions.rebuild] instead. '
  'Will be removed in next major version')
  X509CertificateDetails copyWith(void Function(X509CertificateDetails) updates) => super.copyWith((message) => updates(message as X509CertificateDetails)) as X509CertificateDetails; // ignore: deprecated_member_use
  $pb.BuilderInfo get info_ => _i;
  @$core.pragma('dart2js:noInline')
  ...
  @$pb.TagNumber(4)
  set expiryTime($0.Timestamp v) { setField(4, v); }
  @$pb.TagNumber(4)
...
class PublicKeyCertificate extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'PublicKeyCertificate', package: const $pb.PackageName(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'google.cloud.iot.v1'), createEmptyInstance: create)
    ..e<PublicKeyCertificateFormat>(1, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'format', $pb.PbFieldType.OE, defaultOrMaker: PublicKeyCertificateFormat.UNSPECIFIED_PUBLIC_KEY_CERTIFICATE_FORMAT, valueOf: PublicKeyCertificateFormat.valueOf, enumValues: PublicKeyCertificateFormat.values)
    ..aOS(2, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'certificate')
    ..aOM<X509CertificateDetails>(3, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'x509Details', subBuilder: X509CertificateDetails.create)
    ..hasRequiredFields = false
  ;
  ...
  'Use [GeneratedMessageGenericExtensions.rebuild] instead. '
  'Will be removed in next major version')
  PublicKeyCertificate copyWith(void Function(PublicKeyCertificate) updates) => super.copyWith((message) => updates(message as PublicKeyCertificate)) as PublicKeyCertificate; // ignore: deprecated_member_use
  $pb.BuilderInfo get info_ => _i;
  @$core.pragma('dart2js:noInline')
...
class DeviceCredential extends $pb.GeneratedMessage {
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'DeviceCredential', package: const $pb.PackageName(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'google.cloud.iot.v1'), createEmptyInstance: create)
    ..oo(0, [2])
    ..aOM<PublicKeyCredential>(2, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'publicKey', subBuilder: PublicKeyCredential.create)
  ...
  'Use [GeneratedMessageGenericExtensions.rebuild] instead. '
  'Will be removed in next major version')
  DeviceCredential copyWith(void Function(DeviceCredential) updates) => super.copyWith((message) => updates(message as DeviceCredential)) as DeviceCredential; // ignore: deprecated_member_use
  $pb.BuilderInfo get info_ => _i;
  @$core.pragma('dart2js:noInline')
...
class PublicKeyCredential extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'PublicKeyCredential', package: const $pb.PackageName(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'google.cloud.iot.v1'), createEmptyInstance: create)
    ..e<PublicKeyFormat>(1, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'format', $pb.PbFieldType.OE, defaultOrMaker: PublicKeyFormat.UNSPECIFIED_PUBLIC_KEY_FORMAT, valueOf: PublicKeyFormat.valueOf, enumValues: PublicKeyFormat.values)
  ...
  'Use [GeneratedMessageGenericExtensions.rebuild] instead. '
  'Will be removed in next major version')
  PublicKeyCredential copyWith(void Function(PublicKeyCredential) updates) => super.copyWith((message) => updates(message as PublicKeyCredential)) as PublicKeyCredential; // ignore: deprecated_member_use
  $pb.BuilderInfo get info_ => _i;
  @$core.pragma('dart2js:noInline')
...
class DeviceConfig extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'DeviceConfig', package: const $pb.PackageName(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'google.cloud.iot.v1'), createEmptyInstance: create)
    ..aInt64(1, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'version')
    ..aOM<$0.Timestamp>(2, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'cloudUpdateTime', subBuilder: $0.Timestamp.create)
    ..aOM<$0.Timestamp>(3, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'deviceAckTime', subBuilder: $0.Timestamp.create)
    ..a<$core.List<$core.int>>(4, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'binaryData', $pb.PbFieldType.OY)
    ..hasRequiredFields = false
  ;
  ...
  'Use [GeneratedMessageGenericExtensions.rebuild] instead. '
  'Will be removed in next major version')
  DeviceConfig copyWith(void Function(DeviceConfig) updates) => super.copyWith((message) => updates(message as DeviceConfig)) as DeviceConfig; // ignore: deprecated_member_use
  $pb.BuilderInfo get info_ => _i;
  @$core.pragma('dart2js:noInline')
  ...
  @$pb.TagNumber(2)
  set cloudUpdateTime($0.Timestamp v) { setField(2, v); }
  @$pb.TagNumber(2)
  ...
  @$pb.TagNumber(3)
  set deviceAckTime($0.Timestamp v) { setField(3, v); }
  @$pb.TagNumber(3)
...
class DeviceState extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'DeviceState', package: const $pb.PackageName(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'google.cloud.iot.v1'), createEmptyInstance: create)

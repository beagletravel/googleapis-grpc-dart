...
class Registration extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'Registration', package: const $pb.PackageName(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'google.cloud.domains.v1alpha2'), createEmptyInstance: create)
    ..aOS(1, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'name')
    ..aOS(2, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'domainName')
    ..aOM<$3.Timestamp>(3, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'createTime', subBuilder: $3.Timestamp.create)
    ..aOM<$3.Timestamp>(6, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'expireTime', subBuilder: $3.Timestamp.create)
    ..e<Registration_State>(7, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'state', $pb.PbFieldType.OE, defaultOrMaker: Registration_State.STATE_UNSPECIFIED, valueOf: Registration_State.valueOf, enumValues: Registration_State.values)
    ..pc<Registration_Issue>(8, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'issues', $pb.PbFieldType.PE, valueOf: Registration_Issue.valueOf, enumValues: Registration_Issue.values)
    ..m<$core.String, $core.String>(9, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'labels', entryClassName: 'Registration.LabelsEntry', keyFieldType: $pb.PbFieldType.OS, valueFieldType: $pb.PbFieldType.OS, packageName: const $pb.PackageName('google.cloud.domains.v1alpha2'))
    ..aOM<ManagementSettings>(10, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'managementSettings', subBuilder: ManagementSettings.create)
    ..aOM<DnsSettings>(11, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'dnsSettings', subBuilder: DnsSettings.create)
    ..aOM<ContactSettings>(12, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'contactSettings', subBuilder: ContactSettings.create)
    ..aOM<ContactSettings>(13, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'pendingContactSettings', subBuilder: ContactSettings.create)
    ..pc<ContactPrivacy>(14, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'supportedPrivacy', $pb.PbFieldType.PE, valueOf: ContactPrivacy.valueOf, enumValues: ContactPrivacy.values)
  ...
  @$pb.TagNumber(6)
  set expireTime($3.Timestamp v) { setField(6, v); }
  @$pb.TagNumber(6)
...
class ManagementSettings extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'ManagementSettings', package: const $pb.PackageName(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'google.cloud.domains.v1alpha2'), createEmptyInstance: create)
    ..e<ManagementSettings_RenewalMethod>(3, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'renewalMethod', $pb.PbFieldType.OE, defaultOrMaker: ManagementSettings_RenewalMethod.RENEWAL_METHOD_UNSPECIFIED, valueOf: ManagementSettings_RenewalMethod.valueOf, enumValues: ManagementSettings_RenewalMethod.values)
    ..e<TransferLockState>(4, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'transferLockState', $pb.PbFieldType.OE, defaultOrMaker: TransferLockState.TRANSFER_LOCK_STATE_UNSPECIFIED, valueOf: TransferLockState.valueOf, enumValues: TransferLockState.values)
    ..hasRequiredFields = false
  ;
  ...
  'Use [GeneratedMessageGenericExtensions.rebuild] instead. '
  'Will be removed in next major version')
  ManagementSettings copyWith(void Function(ManagementSettings) updates) => super.copyWith((message) => updates(message as ManagementSettings)) as ManagementSettings; // ignore: deprecated_member_use
  $pb.BuilderInfo get info_ => _i;
  @$core.pragma('dart2js:noInline')
...
class DnsSettings_CustomDns extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'DnsSettings.CustomDns', package: const $pb.PackageName(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'google.cloud.domains.v1alpha2'), createEmptyInstance: create)
    ..pPS(1, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'nameServers')
    ..pc<DnsSettings_DsRecord>(2, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'dsRecords', $pb.PbFieldType.PM, subBuilder: DnsSettings_DsRecord.create)
    ..hasRequiredFields = false
  ;
  ...
  'Use [GeneratedMessageGenericExtensions.rebuild] instead. '
  'Will be removed in next major version')
  DnsSettings_CustomDns copyWith(void Function(DnsSettings_CustomDns) updates) => super.copyWith((message) => updates(message as DnsSettings_CustomDns)) as DnsSettings_CustomDns; // ignore: deprecated_member_use
  $pb.BuilderInfo get info_ => _i;
  @$core.pragma('dart2js:noInline')
...
class DnsSettings_GoogleDomainsDns extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'DnsSettings.GoogleDomainsDns', package: const $pb.PackageName(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'google.cloud.domains.v1alpha2'), createEmptyInstance: create)
    ..pPS(1, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'nameServers')
    ..e<DnsSettings_DsState>(2, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'dsState', $pb.PbFieldType.OE, defaultOrMaker: DnsSettings_DsState.DS_STATE_UNSPECIFIED, valueOf: DnsSettings_DsState.valueOf, enumValues: DnsSettings_DsState.values)
    ..pc<DnsSettings_DsRecord>(3, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'dsRecords', $pb.PbFieldType.PM, subBuilder: DnsSettings_DsRecord.create)
    ..hasRequiredFields = false
  ;
  ...
  'Use [GeneratedMessageGenericExtensions.rebuild] instead. '
  'Will be removed in next major version')
  DnsSettings_GoogleDomainsDns copyWith(void Function(DnsSettings_GoogleDomainsDns) updates) => super.copyWith((message) => updates(message as DnsSettings_GoogleDomainsDns)) as DnsSettings_GoogleDomainsDns; // ignore: deprecated_member_use
  $pb.BuilderInfo get info_ => _i;
  @$core.pragma('dart2js:noInline')
...
class DnsSettings_DsRecord extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'DnsSettings.DsRecord', package: const $pb.PackageName(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'google.cloud.domains.v1alpha2'), createEmptyInstance: create)
    ..a<$core.int>(1, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'keyTag', $pb.PbFieldType.O3)
    ..e<DnsSettings_DsRecord_Algorithm>(2, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'algorithm', $pb.PbFieldType.OE, defaultOrMaker: DnsSettings_DsRecord_Algorithm.ALGORITHM_UNSPECIFIED, valueOf: DnsSettings_DsRecord_Algorithm.valueOf, enumValues: DnsSettings_DsRecord_Algorithm.values)
    ..e<DnsSettings_DsRecord_DigestType>(3, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'digestType', $pb.PbFieldType.OE, defaultOrMaker: DnsSettings_DsRecord_DigestType.DIGEST_TYPE_UNSPECIFIED, valueOf: DnsSettings_DsRecord_DigestType.valueOf, enumValues: DnsSettings_DsRecord_DigestType.values)
    ..aOS(4, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'digest')
    ..hasRequiredFields = false
  ;
  ...
  'Use [GeneratedMessageGenericExtensions.rebuild] instead. '
  'Will be removed in next major version')
  DnsSettings_DsRecord copyWith(void Function(DnsSettings_DsRecord) updates) => super.copyWith((message) => updates(message as DnsSettings_DsRecord)) as DnsSettings_DsRecord; // ignore: deprecated_member_use
  $pb.BuilderInfo get info_ => _i;
  @$core.pragma('dart2js:noInline')
...
class DnsSettings_GlueRecord extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'DnsSettings.GlueRecord', package: const $pb.PackageName(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'google.cloud.domains.v1alpha2'), createEmptyInstance: create)
    ..aOS(1, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'hostName')
    ..pPS(2, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'ipv4Addresses')
    ..pPS(3, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'ipv6Addresses')
    ..hasRequiredFields = false
  ;
  ...
  'Use [GeneratedMessageGenericExtensions.rebuild] instead. '
  'Will be removed in next major version')
  DnsSettings_GlueRecord copyWith(void Function(DnsSettings_GlueRecord) updates) => super.copyWith((message) => updates(message as DnsSettings_GlueRecord)) as DnsSettings_GlueRecord; // ignore: deprecated_member_use
  $pb.BuilderInfo get info_ => _i;
  @$core.pragma('dart2js:noInline')
...
class DnsSettings extends $pb.GeneratedMessage {
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'DnsSettings', package: const $pb.PackageName(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'google.cloud.domains.v1alpha2'), createEmptyInstance: create)
    ..oo(0, [1, 2])
    ..aOM<DnsSettings_CustomDns>(1, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'customDns', subBuilder: DnsSettings_CustomDns.create)
    ..aOM<DnsSettings_GoogleDomainsDns>(2, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'googleDomainsDns', subBuilder: DnsSettings_GoogleDomainsDns.create)
    ..pc<DnsSettings_GlueRecord>(4, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'glueRecords', $pb.PbFieldType.PM, subBuilder: DnsSettings_GlueRecord.create)
    ..hasRequiredFields = false
  ;
  ...
  'Use [GeneratedMessageGenericExtensions.rebuild] instead. '
  'Will be removed in next major version')
  DnsSettings copyWith(void Function(DnsSettings) updates) => super.copyWith((message) => updates(message as DnsSettings)) as DnsSettings; // ignore: deprecated_member_use
  $pb.BuilderInfo get info_ => _i;
  @$core.pragma('dart2js:noInline')
...
class ContactSettings_Contact extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'ContactSettings.Contact', package: const $pb.PackageName(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'google.cloud.domains.v1alpha2'), createEmptyInstance: create)
    ..aOM<$4.PostalAddress>(1, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'postalAddress', subBuilder: $4.PostalAddress.create)
    ..aOS(2, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'email')
    ..aOS(3, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'phoneNumber')
    ..aOS(4, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'faxNumber')
    ..hasRequiredFields = false
  ;
  ...
  'Use [GeneratedMessageGenericExtensions.rebuild] instead. '
  'Will be removed in next major version')
  ContactSettings_Contact copyWith(void Function(ContactSettings_Contact) updates) => super.copyWith((message) => updates(message as ContactSettings_Contact)) as ContactSettings_Contact; // ignore: deprecated_member_use
  $pb.BuilderInfo get info_ => _i;
  @$core.pragma('dart2js:noInline')
  ...
  @$pb.TagNumber(1)
  set postalAddress($4.PostalAddress v) { setField(1, v); }
  @$pb.TagNumber(1)
...
class ContactSettings extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'ContactSettings', package: const $pb.PackageName(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'google.cloud.domains.v1alpha2'), createEmptyInstance: create)
    ..e<ContactPrivacy>(1, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'privacy', $pb.PbFieldType.OE, defaultOrMaker: ContactPrivacy.CONTACT_PRIVACY_UNSPECIFIED, valueOf: ContactPrivacy.valueOf, enumValues: ContactPrivacy.values)
    ..aOM<ContactSettings_Contact>(2, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'registrantContact', subBuilder: ContactSettings_Contact.create)
    ..aOM<ContactSettings_Contact>(3, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'adminContact', subBuilder: ContactSettings_Contact.create)
    ..aOM<ContactSettings_Contact>(4, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'technicalContact', subBuilder: ContactSettings_Contact.create)
    ..hasRequiredFields = false
  ;
  ...
  'Use [GeneratedMessageGenericExtensions.rebuild] instead. '
  'Will be removed in next major version')
  ContactSettings copyWith(void Function(ContactSettings) updates) => super.copyWith((message) => updates(message as ContactSettings)) as ContactSettings; // ignore: deprecated_member_use
  $pb.BuilderInfo get info_ => _i;
  @$core.pragma('dart2js:noInline')
...
class SearchDomainsRequest extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'SearchDomainsRequest', package: const $pb.PackageName(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'google.cloud.domains.v1alpha2'), createEmptyInstance: create)
  ...
  'Use [GeneratedMessageGenericExtensions.rebuild] instead. '
  'Will be removed in next major version')
  SearchDomainsRequest copyWith(void Function(SearchDomainsRequest) updates) => super.copyWith((message) => updates(message as SearchDomainsRequest)) as SearchDomainsRequest; // ignore: deprecated_member_use
  $pb.BuilderInfo get info_ => _i;
  @$core.pragma('dart2js:noInline')
...
class SearchDomainsResponse extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'SearchDomainsResponse', package: const $pb.PackageName(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'google.cloud.domains.v1alpha2'), createEmptyInstance: create)
    ..pc<RegisterParameters>(1, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'registerParameters', $pb.PbFieldType.PM, subBuilder: RegisterParameters.create)
    ..hasRequiredFields = false
  ;
  ...
  'Use [GeneratedMessageGenericExtensions.rebuild] instead. '
  'Will be removed in next major version')
  SearchDomainsResponse copyWith(void Function(SearchDomainsResponse) updates) => super.copyWith((message) => updates(message as SearchDomainsResponse)) as SearchDomainsResponse; // ignore: deprecated_member_use
  $pb.BuilderInfo get info_ => _i;
  @$core.pragma('dart2js:noInline')
...
class RetrieveRegisterParametersRequest extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'RetrieveRegisterParametersRequest', package: const $pb.PackageName(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'google.cloud.domains.v1alpha2'), createEmptyInstance: create)
  ...
  'Use [GeneratedMessageGenericExtensions.rebuild] instead. '
  'Will be removed in next major version')
  RetrieveRegisterParametersRequest copyWith(void Function(RetrieveRegisterParametersRequest) updates) => super.copyWith((message) => updates(message as RetrieveRegisterParametersRequest)) as RetrieveRegisterParametersRequest; // ignore: deprecated_member_use
  $pb.BuilderInfo get info_ => _i;
  @$core.pragma('dart2js:noInline')
...
class RetrieveRegisterParametersResponse extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'RetrieveRegisterParametersResponse', package: const $pb.PackageName(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'google.cloud.domains.v1alpha2'), createEmptyInstance: create)
    ..aOM<RegisterParameters>(1, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'registerParameters', subBuilder: RegisterParameters.create)
    ..hasRequiredFields = false
  ;
  ...
  'Use [GeneratedMessageGenericExtensions.rebuild] instead. '
  'Will be removed in next major version')
  RetrieveRegisterParametersResponse copyWith(void Function(RetrieveRegisterParametersResponse) updates) => super.copyWith((message) => updates(message as RetrieveRegisterParametersResponse)) as RetrieveRegisterParametersResponse; // ignore: deprecated_member_use
  $pb.BuilderInfo get info_ => _i;
  @$core.pragma('dart2js:noInline')
...
class RegisterDomainRequest extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'RegisterDomainRequest', package: const $pb.PackageName(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'google.cloud.domains.v1alpha2'), createEmptyInstance: create)
    ..aOS(1, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'parent')
    ..aOM<Registration>(2, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'registration', subBuilder: Registration.create)
    ..pc<DomainNotice>(3, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'domainNotices', $pb.PbFieldType.PE, valueOf: DomainNotice.valueOf, enumValues: DomainNotice.values)
    ..pc<ContactNotice>(4, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'contactNotices', $pb.PbFieldType.PE, valueOf: ContactNotice.valueOf, enumValues: ContactNotice.values)
    ..aOM<$5.Money>(5, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'yearlyPrice', subBuilder: $5.Money.create)
    ..aOB(6, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'validateOnly')
    ..hasRequiredFields = false
  ;
  ...
  'Use [GeneratedMessageGenericExtensions.rebuild] instead. '
  'Will be removed in next major version')
  RegisterDomainRequest copyWith(void Function(RegisterDomainRequest) updates) => super.copyWith((message) => updates(message as RegisterDomainRequest)) as RegisterDomainRequest; // ignore: deprecated_member_use
  $pb.BuilderInfo get info_ => _i;
  @$core.pragma('dart2js:noInline')
  ...
  @$pb.TagNumber(5)
  set yearlyPrice($5.Money v) { setField(5, v); }
  @$pb.TagNumber(5)
...
class RetrieveTransferParametersRequest extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'RetrieveTransferParametersRequest', package: const $pb.PackageName(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'google.cloud.domains.v1alpha2'), createEmptyInstance: create)
    ..aOS(1, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'domainName')
    ..aOS(2, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'location')
    ..hasRequiredFields = false
  ;
  ...
  'Use [GeneratedMessageGenericExtensions.rebuild] instead. '
  'Will be removed in next major version')
  RetrieveTransferParametersRequest copyWith(void Function(RetrieveTransferParametersRequest) updates) => super.copyWith((message) => updates(message as RetrieveTransferParametersRequest)) as RetrieveTransferParametersRequest; // ignore: deprecated_member_use
  $pb.BuilderInfo get info_ => _i;
  @$core.pragma('dart2js:noInline')
...
class RetrieveTransferParametersResponse extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'RetrieveTransferParametersResponse', package: const $pb.PackageName(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'google.cloud.domains.v1alpha2'), createEmptyInstance: create)
    ..aOM<TransferParameters>(1, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'transferParameters', subBuilder: TransferParameters.create)
    ..hasRequiredFields = false
  ;
  ...
  'Use [GeneratedMessageGenericExtensions.rebuild] instead. '
  'Will be removed in next major version')
  RetrieveTransferParametersResponse copyWith(void Function(RetrieveTransferParametersResponse) updates) => super.copyWith((message) => updates(message as RetrieveTransferParametersResponse)) as RetrieveTransferParametersResponse; // ignore: deprecated_member_use
  $pb.BuilderInfo get info_ => _i;
  @$core.pragma('dart2js:noInline')
...
class TransferDomainRequest extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'TransferDomainRequest', package: const $pb.PackageName(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'google.cloud.domains.v1alpha2'), createEmptyInstance: create)
    ..aOS(1, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'parent')
    ..aOM<Registration>(2, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'registration', subBuilder: Registration.create)
    ..pc<ContactNotice>(3, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'contactNotices', $pb.PbFieldType.PE, valueOf: ContactNotice.valueOf, enumValues: ContactNotice.values)
    ..aOM<$5.Money>(4, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'yearlyPrice', subBuilder: $5.Money.create)
    ..aOM<AuthorizationCode>(5, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'authorizationCode', subBuilder: AuthorizationCode.create)
    ..aOB(6, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'validateOnly')
    ..hasRequiredFields = false
  ;
  ...
  'Use [GeneratedMessageGenericExtensions.rebuild] instead. '
  'Will be removed in next major version')
  TransferDomainRequest copyWith(void Function(TransferDomainRequest) updates) => super.copyWith((message) => updates(message as TransferDomainRequest)) as TransferDomainRequest; // ignore: deprecated_member_use
  $pb.BuilderInfo get info_ => _i;
  @$core.pragma('dart2js:noInline')
  ...
  @$pb.TagNumber(4)
  set yearlyPrice($5.Money v) { setField(4, v); }
  @$pb.TagNumber(4)
...
class ListRegistrationsRequest extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'ListRegistrationsRequest', package: const $pb.PackageName(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'google.cloud.domains.v1alpha2'), createEmptyInstance: create)
    ..aOS(1, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'parent')
  ...
  'Use [GeneratedMessageGenericExtensions.rebuild] instead. '
  'Will be removed in next major version')
  ListRegistrationsRequest copyWith(void Function(ListRegistrationsRequest) updates) => super.copyWith((message) => updates(message as ListRegistrationsRequest)) as ListRegistrationsRequest; // ignore: deprecated_member_use
  $pb.BuilderInfo get info_ => _i;
  @$core.pragma('dart2js:noInline')
...
class ListRegistrationsResponse extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'ListRegistrationsResponse', package: const $pb.PackageName(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'google.cloud.domains.v1alpha2'), createEmptyInstance: create)
    ..pc<Registration>(1, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'registrations', $pb.PbFieldType.PM, subBuilder: Registration.create)
  ...
  'Use [GeneratedMessageGenericExtensions.rebuild] instead. '
  'Will be removed in next major version')
  ListRegistrationsResponse copyWith(void Function(ListRegistrationsResponse) updates) => super.copyWith((message) => updates(message as ListRegistrationsResponse)) as ListRegistrationsResponse; // ignore: deprecated_member_use
  $pb.BuilderInfo get info_ => _i;
  @$core.pragma('dart2js:noInline')
...
class GetRegistrationRequest extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'GetRegistrationRequest', package: const $pb.PackageName(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'google.cloud.domains.v1alpha2'), createEmptyInstance: create)
    ..aOS(1, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'name')
    ..hasRequiredFields = false
  ;
  ...
  'Use [GeneratedMessageGenericExtensions.rebuild] instead. '
  'Will be removed in next major version')
  GetRegistrationRequest copyWith(void Function(GetRegistrationRequest) updates) => super.copyWith((message) => updates(message as GetRegistrationRequest)) as GetRegistrationRequest; // ignore: deprecated_member_use
  $pb.BuilderInfo get info_ => _i;
  @$core.pragma('dart2js:noInline')
...
class UpdateRegistrationRequest extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'UpdateRegistrationRequest', package: const $pb.PackageName(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'google.cloud.domains.v1alpha2'), createEmptyInstance: create)
  ...
  'Use [GeneratedMessageGenericExtensions.rebuild] instead. '
  'Will be removed in next major version')
  UpdateRegistrationRequest copyWith(void Function(UpdateRegistrationRequest) updates) => super.copyWith((message) => updates(message as UpdateRegistrationRequest)) as UpdateRegistrationRequest; // ignore: deprecated_member_use
  $pb.BuilderInfo get info_ => _i;
  @$core.pragma('dart2js:noInline')
...
class ConfigureManagementSettingsRequest extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'ConfigureManagementSettingsRequest', package: const $pb.PackageName(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'google.cloud.domains.v1alpha2'), createEmptyInstance: create)
    ..aOS(1, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'registration')
    ..aOM<ManagementSettings>(2, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'managementSettings', subBuilder: ManagementSettings.create)
  ...
  'Use [GeneratedMessageGenericExtensions.rebuild] instead. '
  'Will be removed in next major version')
  ConfigureManagementSettingsRequest copyWith(void Function(ConfigureManagementSettingsRequest) updates) => super.copyWith((message) => updates(message as ConfigureManagementSettingsRequest)) as ConfigureManagementSettingsRequest; // ignore: deprecated_member_use
  $pb.BuilderInfo get info_ => _i;
  @$core.pragma('dart2js:noInline')
...
class ConfigureDnsSettingsRequest extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'ConfigureDnsSettingsRequest', package: const $pb.PackageName(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'google.cloud.domains.v1alpha2'), createEmptyInstance: create)
    ..aOS(1, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'registration')
    ..aOM<DnsSettings>(2, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'dnsSettings', subBuilder: DnsSettings.create)
    ..aOM<$6.FieldMask>(3, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'updateMask', subBuilder: $6.FieldMask.create)
  ...
  'Use [GeneratedMessageGenericExtensions.rebuild] instead. '
  'Will be removed in next major version')
  ConfigureDnsSettingsRequest copyWith(void Function(ConfigureDnsSettingsRequest) updates) => super.copyWith((message) => updates(message as ConfigureDnsSettingsRequest)) as ConfigureDnsSettingsRequest; // ignore: deprecated_member_use
  $pb.BuilderInfo get info_ => _i;
  @$core.pragma('dart2js:noInline')
...
class ConfigureContactSettingsRequest extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'ConfigureContactSettingsRequest', package: const $pb.PackageName(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'google.cloud.domains.v1alpha2'), createEmptyInstance: create)
    ..aOS(1, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'registration')
    ..aOM<ContactSettings>(2, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'contactSettings', subBuilder: ContactSettings.create)
    ..aOM<$6.FieldMask>(3, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'updateMask', subBuilder: $6.FieldMask.create)
    ..pc<ContactNotice>(4, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'contactNotices', $pb.PbFieldType.PE, valueOf: ContactNotice.valueOf, enumValues: ContactNotice.values)
  ...
  'Use [GeneratedMessageGenericExtensions.rebuild] instead. '
  'Will be removed in next major version')
  ConfigureContactSettingsRequest copyWith(void Function(ConfigureContactSettingsRequest) updates) => super.copyWith((message) => updates(message as ConfigureContactSettingsRequest)) as ConfigureContactSettingsRequest; // ignore: deprecated_member_use
  $pb.BuilderInfo get info_ => _i;
  @$core.pragma('dart2js:noInline')
...
class ExportRegistrationRequest extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'ExportRegistrationRequest', package: const $pb.PackageName(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'google.cloud.domains.v1alpha2'), createEmptyInstance: create)
    ..aOS(1, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'name')
    ..hasRequiredFields = false
  ;
  ...
  'Use [GeneratedMessageGenericExtensions.rebuild] instead. '
  'Will be removed in next major version')
  ExportRegistrationRequest copyWith(void Function(ExportRegistrationRequest) updates) => super.copyWith((message) => updates(message as ExportRegistrationRequest)) as ExportRegistrationRequest; // ignore: deprecated_member_use
  $pb.BuilderInfo get info_ => _i;
  @$core.pragma('dart2js:noInline')
...
class DeleteRegistrationRequest extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'DeleteRegistrationRequest', package: const $pb.PackageName(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'google.cloud.domains.v1alpha2'), createEmptyInstance: create)
    ..aOS(1, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'name')
    ..hasRequiredFields = false
  ;
  ...
  'Use [GeneratedMessageGenericExtensions.rebuild] instead. '
  'Will be removed in next major version')
  DeleteRegistrationRequest copyWith(void Function(DeleteRegistrationRequest) updates) => super.copyWith((message) => updates(message as DeleteRegistrationRequest)) as DeleteRegistrationRequest; // ignore: deprecated_member_use
  $pb.BuilderInfo get info_ => _i;
  @$core.pragma('dart2js:noInline')
...
class RetrieveAuthorizationCodeRequest extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'RetrieveAuthorizationCodeRequest', package: const $pb.PackageName(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'google.cloud.domains.v1alpha2'), createEmptyInstance: create)
    ..aOS(1, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'registration')
    ..hasRequiredFields = false
  ;
  ...
  'Use [GeneratedMessageGenericExtensions.rebuild] instead. '
  'Will be removed in next major version')
  RetrieveAuthorizationCodeRequest copyWith(void Function(RetrieveAuthorizationCodeRequest) updates) => super.copyWith((message) => updates(message as RetrieveAuthorizationCodeRequest)) as RetrieveAuthorizationCodeRequest; // ignore: deprecated_member_use
  $pb.BuilderInfo get info_ => _i;
  @$core.pragma('dart2js:noInline')
...
class ResetAuthorizationCodeRequest extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'ResetAuthorizationCodeRequest', package: const $pb.PackageName(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'google.cloud.domains.v1alpha2'), createEmptyInstance: create)
    ..aOS(1, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'registration')
    ..hasRequiredFields = false
  ;
  ...
  'Use [GeneratedMessageGenericExtensions.rebuild] instead. '
  'Will be removed in next major version')
  ResetAuthorizationCodeRequest copyWith(void Function(ResetAuthorizationCodeRequest) updates) => super.copyWith((message) => updates(message as ResetAuthorizationCodeRequest)) as ResetAuthorizationCodeRequest; // ignore: deprecated_member_use
  $pb.BuilderInfo get info_ => _i;
  @$core.pragma('dart2js:noInline')
...
class RegisterParameters extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'RegisterParameters', package: const $pb.PackageName(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'google.cloud.domains.v1alpha2'), createEmptyInstance: create)
    ..aOS(1, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'domainName')
    ..e<RegisterParameters_Availability>(2, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'availability', $pb.PbFieldType.OE, defaultOrMaker: RegisterParameters_Availability.AVAILABILITY_UNSPECIFIED, valueOf: RegisterParameters_Availability.valueOf, enumValues: RegisterParameters_Availability.values)
    ..pc<ContactPrivacy>(3, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'supportedPrivacy', $pb.PbFieldType.PE, valueOf: ContactPrivacy.valueOf, enumValues: ContactPrivacy.values)
    ..pc<DomainNotice>(4, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'domainNotices', $pb.PbFieldType.PE, valueOf: DomainNotice.valueOf, enumValues: DomainNotice.values)
    ..aOM<$5.Money>(5, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'yearlyPrice', subBuilder: $5.Money.create)
    ..hasRequiredFields = false
  ;
  ...
  'Use [GeneratedMessageGenericExtensions.rebuild] instead. '
  'Will be removed in next major version')
  RegisterParameters copyWith(void Function(RegisterParameters) updates) => super.copyWith((message) => updates(message as RegisterParameters)) as RegisterParameters; // ignore: deprecated_member_use
  $pb.BuilderInfo get info_ => _i;
  @$core.pragma('dart2js:noInline')
...
class TransferParameters extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'TransferParameters', package: const $pb.PackageName(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'google.cloud.domains.v1alpha2'), createEmptyInstance: create)
    ..aOS(1, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'domainName')
    ..aOS(2, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'currentRegistrar')
    ..pPS(3, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'nameServers')
    ..e<TransferLockState>(4, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'transferLockState', $pb.PbFieldType.OE, defaultOrMaker: TransferLockState.TRANSFER_LOCK_STATE_UNSPECIFIED, valueOf: TransferLockState.valueOf, enumValues: TransferLockState.values)
    ..pc<ContactPrivacy>(5, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'supportedPrivacy', $pb.PbFieldType.PE, valueOf: ContactPrivacy.valueOf, enumValues: ContactPrivacy.values)
    ..aOM<$5.Money>(6, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'yearlyPrice', subBuilder: $5.Money.create)
    ..hasRequiredFields = false
  ;
  ...
  'Use [GeneratedMessageGenericExtensions.rebuild] instead. '
  'Will be removed in next major version')
  TransferParameters copyWith(void Function(TransferParameters) updates) => super.copyWith((message) => updates(message as TransferParameters)) as TransferParameters; // ignore: deprecated_member_use
  $pb.BuilderInfo get info_ => _i;
  @$core.pragma('dart2js:noInline')
  ...
  @$pb.TagNumber(6)
  set yearlyPrice($5.Money v) { setField(6, v); }
  @$pb.TagNumber(6)
...
class AuthorizationCode extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'AuthorizationCode', package: const $pb.PackageName(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'google.cloud.domains.v1alpha2'), createEmptyInstance: create)
  ...
  'Use [GeneratedMessageGenericExtensions.rebuild] instead. '
  'Will be removed in next major version')
  AuthorizationCode copyWith(void Function(AuthorizationCode) updates) => super.copyWith((message) => updates(message as AuthorizationCode)) as AuthorizationCode; // ignore: deprecated_member_use
  $pb.BuilderInfo get info_ => _i;
  @$core.pragma('dart2js:noInline')
...
class OperationMetadata extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'OperationMetadata', package: const $pb.PackageName(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'google.cloud.domains.v1alpha2'), createEmptyInstance: create)
    ...
    ..aOS(6, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'apiVersion')
    ..hasRequiredFields = false
  ;

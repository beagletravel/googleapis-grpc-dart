...
final $typed_data.Uint8List databaseEngineDescriptor = $convert.base64Decode('Cg5EYXRhYmFzZUVuZ2luZRIfChtEQVRBQkFTRV9FTkdJTkVfVU5TUEVDSUZJRUQQABIJCgVNWVNRTBABEg4KClBPU1RHUkVTUUwQAg==');
...
final $typed_data.Uint8List databaseProviderDescriptor = $convert.base64Decode('ChBEYXRhYmFzZVByb3ZpZGVyEiEKHURBVEFCQVNFX1BST1ZJREVSX1VOU1BFQ0lGSUVEEAASDAoIQ0xPVURTUUwQARIHCgNSRFMQAg==');
@$core.Deprecated('Use sslConfigDescriptor instead')
const SslConfig$json = const {
  '1': 'SslConfig',
  '2': const [
    const {'1': 'type', '3': 1, '4': 1, '5': 14, '6': '.google.cloud.clouddms.v1.SslConfig.SslType', '8': const {}, '10': 'type'},
    const {'1': 'client_key', '3': 2, '4': 1, '5': 9, '8': const {}, '10': 'clientKey'},
    const {'1': 'client_certificate', '3': 3, '4': 1, '5': 9, '8': const {}, '10': 'clientCertificate'},
    const {'1': 'ca_certificate', '3': 4, '4': 1, '5': 9, '8': const {}, '10': 'caCertificate'},
  ],
...
const MySqlConnectionProfile$json = const {
  ...
  '2': const [
    ...
    const {'1': 'password_set', '3': 5, '4': 1, '5': 8, '8': const {}, '10': 'passwordSet'},
    const {'1': 'ssl', '3': 6, '4': 1, '5': 11, '6': '.google.cloud.clouddms.v1.SslConfig', '10': 'ssl'},
...
final $typed_data.Uint8List mySqlConnectionProfileDescriptor = $convert.base64Decode('');
...
final $typed_data.Uint8List postgreSqlConnectionProfileDescriptor = $convert.base64Decode('');
...
const CloudSqlConnectionProfile$json = const {
  ...
  '2': const [
    const {'1': 'cloud_sql_id', '3': 1, '4': 1, '5': 9, '8': const {}, '10': 'cloudSqlId'},
    const {'1': 'settings', '3': 2, '4': 1, '5': 11, '6': '.google.cloud.clouddms.v1.CloudSqlSettings', '8': const {}, '10': 'settings'},
    const {'1': 'private_ip', '3': 3, '4': 1, '5': 9, '8': const {}, '10': 'privateIp'},
    const {'1': 'public_ip', '3': 4, '4': 1, '5': 9, '8': const {}, '10': 'publicIp'},
  ],
};

/// Descriptor for `CloudSqlConnectionProfile`. Decode as a `google.protobuf.DescriptorProto`.
final $typed_data.Uint8List cloudSqlConnectionProfileDescriptor = $convert.base64Decode('');
@$core.Deprecated('Use sqlAclEntryDescriptor instead')
const SqlAclEntry$json = const {
  '1': 'SqlAclEntry',
  '2': const [
    const {'1': 'value', '3': 1, '4': 1, '5': 9, '10': 'value'},
    const {'1': 'expire_time', '3': 10, '4': 1, '5': 11, '6': '.google.protobuf.Timestamp', '9': 0, '10': 'expireTime'},
    const {'1': 'ttl', '3': 11, '4': 1, '5': 11, '6': '.google.protobuf.Duration', '8': const {}, '9': 0, '10': 'ttl'},
...
final $typed_data.Uint8List sqlAclEntryDescriptor = $convert.base64Decode('CgtTcWxBY2xFbnRyeRIUCgV2YWx1ZRgBIAEoCVIFdmFsdWUSPQoLZXhwaXJlX3RpbWUYCiABKAsyGi5nb29nbGUucHJvdG9idWYuVGltZXN0YW1wSABSCmV4cGlyZVRpbWUSMgoDdHRsGAsgASgLMhkuZ29vZ2xlLnByb3RvYnVmLkR1cmF0aW9uQgPgQQRIAFIDdHRsEhQKBWxhYmVsGAMgASgJUgVsYWJlbEIMCgpleHBpcmF0aW9u');
@$core.Deprecated('Use sqlIpConfigDescriptor instead')
const SqlIpConfig$json = const {
  '1': 'SqlIpConfig',
  '2': const [
    const {'1': 'enable_ipv4', '3': 1, '4': 1, '5': 11, '6': '.google.protobuf.BoolValue', '10': 'enableIpv4'},
    ...
    const {'1': 'authorized_networks', '3': 4, '4': 3, '5': 11, '6': '.google.cloud.clouddms.v1.SqlAclEntry', '10': 'authorizedNetworks'},
  ],
};

/// Descriptor for `SqlIpConfig`. Decode as a `google.protobuf.DescriptorProto`.
final $typed_data.Uint8List sqlIpConfigDescriptor = $convert.base64Decode('');
@$core.Deprecated('Use cloudSqlSettingsDescriptor instead')
const CloudSqlSettings$json = const {
  '1': 'CloudSqlSettings',
  '2': const [
    const {'1': 'database_version', '3': 1, '4': 1, '5': 14, '6': '.google.cloud.clouddms.v1.CloudSqlSettings.SqlDatabaseVersion', '10': 'databaseVersion'},
    const {'1': 'user_labels', '3': 2, '4': 3, '5': 11, '6': '.google.cloud.clouddms.v1.CloudSqlSettings.UserLabelsEntry', '10': 'userLabels'},
    const {'1': 'tier', '3': 3, '4': 1, '5': 9, '10': 'tier'},
    const {'1': 'storage_auto_resize_limit', '3': 4, '4': 1, '5': 11, '6': '.google.protobuf.Int64Value', '10': 'storageAutoResizeLimit'},
    const {'1': 'activation_policy', '3': 5, '4': 1, '5': 14, '6': '.google.cloud.clouddms.v1.CloudSqlSettings.SqlActivationPolicy', '10': 'activationPolicy'},
    const {'1': 'ip_config', '3': 6, '4': 1, '5': 11, '6': '.google.cloud.clouddms.v1.SqlIpConfig', '10': 'ipConfig'},
    const {'1': 'auto_storage_increase', '3': 7, '4': 1, '5': 11, '6': '.google.protobuf.BoolValue', '10': 'autoStorageIncrease'},
    const {'1': 'database_flags', '3': 8, '4': 3, '5': 11, '6': '.google.cloud.clouddms.v1.CloudSqlSettings.DatabaseFlagsEntry', '10': 'databaseFlags'},
    const {'1': 'data_disk_type', '3': 9, '4': 1, '5': 14, '6': '.google.cloud.clouddms.v1.CloudSqlSettings.SqlDataDiskType', '10': 'dataDiskType'},
    const {'1': 'data_disk_size_gb', '3': 10, '4': 1, '5': 11, '6': '.google.protobuf.Int64Value', '10': 'dataDiskSizeGb'},
    const {'1': 'zone', '3': 11, '4': 1, '5': 9, '10': 'zone'},
    const {'1': 'source_id', '3': 12, '4': 1, '5': 9, '10': 'sourceId'},
    const {'1': 'root_password', '3': 13, '4': 1, '5': 9, '8': const {}, '10': 'rootPassword'},
    const {'1': 'root_password_set', '3': 14, '4': 1, '5': 8, '8': const {}, '10': 'rootPasswordSet'},
    const {'1': 'collation', '3': 15, '4': 1, '5': 9, '10': 'collation'},
  ],
  '3': const [CloudSqlSettings_UserLabelsEntry$json, CloudSqlSettings_DatabaseFlagsEntry$json],
  '4': const [CloudSqlSettings_SqlActivationPolicy$json, CloudSqlSettings_SqlDataDiskType$json, CloudSqlSettings_SqlDatabaseVersion$json],
};
...
final $typed_data.Uint8List staticIpConnectivityDescriptor = $convert.base64Decode('ChRTdGF0aWNJcENvbm5lY3Rpdml0eQ==');
...
const ReverseSshConnectivity$json = const {
  ...
  '2': const [
    ...
    const {'1': 'vm_port', '3': 2, '4': 1, '5': 5, '8': const {}, '10': 'vmPort'},
...
final $typed_data.Uint8List reverseSshConnectivityDescriptor = $convert.base64Decode('ChZSZXZlcnNlU3NoQ29ubmVjdGl2aXR5EhgKBXZtX2lwGAEgASgJQgPgQQJSBHZtSXASHAoHdm1fcG9ydBgCIAEoBUID4EECUgZ2bVBvcnQSDgoCdm0YAyABKAlSAnZtEhAKA3ZwYxgEIAEoCVIDdnBj');
...
final $typed_data.Uint8List vpcPeeringConnectivityDescriptor = $convert.base64Decode('ChZWcGNQZWVyaW5nQ29ubmVjdGl2aXR5EhAKA3ZwYxgBIAEoCVIDdnBj');
@$core.Deprecated('Use databaseTypeDescriptor instead')
const DatabaseType$json = const {
  '1': 'DatabaseType',
  '2': const [
    const {'1': 'provider', '3': 1, '4': 1, '5': 14, '6': '.google.cloud.clouddms.v1.DatabaseProvider', '10': 'provider'},
    const {'1': 'engine', '3': 2, '4': 1, '5': 14, '6': '.google.cloud.clouddms.v1.DatabaseEngine', '10': 'engine'},
  ],
};

/// Descriptor for `DatabaseType`. Decode as a `google.protobuf.DescriptorProto`.
final $typed_data.Uint8List databaseTypeDescriptor = $convert.base64Decode('CgxEYXRhYmFzZVR5cGUSRgoIcHJvdmlkZXIYASABKA4yKi5nb29nbGUuY2xvdWQuY2xvdWRkbXMudjEuRGF0YWJhc2VQcm92aWRlclIIcHJvdmlkZXISQAoGZW5naW5lGAIgASgOMiguZ29vZ2xlLmNsb3VkLmNsb3VkZG1zLnYxLkRhdGFiYXNlRW5naW5lUgZlbmdpbmU=');
...
const MigrationJob$json = const {
  ...
  '2': const [
    ...
    const {'1': 'labels', '3': 4, '4': 3, '5': 11, '6': '.google.cloud.clouddms.v1.MigrationJob.LabelsEntry', '10': 'labels'},
    const {'1': 'display_name', '3': 5, '4': 1, '5': 9, '10': 'displayName'},
    const {'1': 'state', '3': 6, '4': 1, '5': 14, '6': '.google.cloud.clouddms.v1.MigrationJob.State', '10': 'state'},
    const {'1': 'phase', '3': 7, '4': 1, '5': 14, '6': '.google.cloud.clouddms.v1.MigrationJob.Phase', '8': const {}, '10': 'phase'},
    const {'1': 'type', '3': 8, '4': 1, '5': 14, '6': '.google.cloud.clouddms.v1.MigrationJob.Type', '8': const {}, '10': 'type'},
    const {'1': 'dump_path', '3': 9, '4': 1, '5': 9, '10': 'dumpPath'},
    const {'1': 'source', '3': 10, '4': 1, '5': 9, '8': const {}, '10': 'source'},
    const {'1': 'destination', '3': 11, '4': 1, '5': 9, '8': const {}, '10': 'destination'},
    const {'1': 'reverse_ssh_connectivity', '3': 101, '4': 1, '5': 11, '6': '.google.cloud.clouddms.v1.ReverseSshConnectivity', '9': 0, '10': 'reverseSshConnectivity'},
    const {'1': 'vpc_peering_connectivity', '3': 102, '4': 1, '5': 11, '6': '.google.cloud.clouddms.v1.VpcPeeringConnectivity', '9': 0, '10': 'vpcPeeringConnectivity'},
    const {'1': 'static_ip_connectivity', '3': 103, '4': 1, '5': 11, '6': '.google.cloud.clouddms.v1.StaticIpConnectivity', '9': 0, '10': 'staticIpConnectivity'},
    const {'1': 'duration', '3': 12, '4': 1, '5': 11, '6': '.google.protobuf.Duration', '8': const {}, '10': 'duration'},
    const {'1': 'error', '3': 13, '4': 1, '5': 11, '6': '.google.rpc.Status', '8': const {}, '10': 'error'},
    const {'1': 'source_database', '3': 14, '4': 1, '5': 11, '6': '.google.cloud.clouddms.v1.DatabaseType', '10': 'sourceDatabase'},
    const {'1': 'destination_database', '3': 15, '4': 1, '5': 11, '6': '.google.cloud.clouddms.v1.DatabaseType', '10': 'destinationDatabase'},
    const {'1': 'end_time', '3': 16, '4': 1, '5': 11, '6': '.google.protobuf.Timestamp', '8': const {}, '10': 'endTime'},
  ],
  '3': const [MigrationJob_LabelsEntry$json],
  '4': const [MigrationJob_State$json, MigrationJob_Phase$json, MigrationJob_Type$json],
  '7': const {},
  '8': const [
...
const ConnectionProfile$json = const {
  ...
  '2': const [
    ...
    const {'1': 'create_time', '3': 2, '4': 1, '5': 11, '6': '.google.protobuf.Timestamp', '8': const {}, '10': 'createTime'},
    const {'1': 'update_time', '3': 3, '4': 1, '5': 11, '6': '.google.protobuf.Timestamp', '8': const {}, '10': 'updateTime'},
    const {'1': 'labels', '3': 4, '4': 3, '5': 11, '6': '.google.cloud.clouddms.v1.ConnectionProfile.LabelsEntry', '10': 'labels'},
    const {'1': 'state', '3': 5, '4': 1, '5': 14, '6': '.google.cloud.clouddms.v1.ConnectionProfile.State', '10': 'state'},
    const {'1': 'display_name', '3': 6, '4': 1, '5': 9, '10': 'displayName'},
    const {'1': 'mysql', '3': 100, '4': 1, '5': 11, '6': '.google.cloud.clouddms.v1.MySqlConnectionProfile', '9': 0, '10': 'mysql'},
    const {'1': 'postgresql', '3': 101, '4': 1, '5': 11, '6': '.google.cloud.clouddms.v1.PostgreSqlConnectionProfile', '9': 0, '10': 'postgresql'},
    const {'1': 'cloudsql', '3': 102, '4': 1, '5': 11, '6': '.google.cloud.clouddms.v1.CloudSqlConnectionProfile', '9': 0, '10': 'cloudsql'},
    const {'1': 'error', '3': 7, '4': 1, '5': 11, '6': '.google.rpc.Status', '8': const {}, '10': 'error'},
    const {'1': 'provider', '3': 8, '4': 1, '5': 14, '6': '.google.cloud.clouddms.v1.DatabaseProvider', '10': 'provider'},
  ],
...
final $typed_data.Uint8List connectionProfileDescriptor = $convert.base64Decode('');
...
const MigrationJobVerificationError$json = const {
  ...
  '2': const [
    const {'1': 'error_code', '3': 1, '4': 1, '5': 14, '6': '.google.cloud.clouddms.v1.MigrationJobVerificationError.ErrorCode', '8': const {}, '10': 'errorCode'},
    const {'1': 'error_message', '3': 2, '4': 1, '5': 9, '8': const {}, '10': 'errorMessage'},
    const {'1': 'error_detail_message', '3': 3, '4': 1, '5': 9, '8': const {}, '10': 'errorDetailMessage'},
  ],

...
class SslConfig extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'SslConfig', package: const $pb.PackageName(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'google.cloud.clouddms.v1'), createEmptyInstance: create)
    ..e<SslConfig_SslType>(1, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'type', $pb.PbFieldType.OE, defaultOrMaker: SslConfig_SslType.SSL_TYPE_UNSPECIFIED, valueOf: SslConfig_SslType.valueOf, enumValues: SslConfig_SslType.values)
    ..aOS(2, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'clientKey')
    ..aOS(3, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'clientCertificate')
    ..aOS(4, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'caCertificate')
  ...
  'Will be removed in next major version')
  SslConfig copyWith(void Function(SslConfig) updates) => super.copyWith((message) => updates(message as SslConfig)) as SslConfig; // ignore: deprecated_member_use
...
class MySqlConnectionProfile extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'MySqlConnectionProfile', package: const $pb.PackageName(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'google.cloud.clouddms.v1'), createEmptyInstance: create)
    ...
    ..aOB(5, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'passwordSet')
    ..aOM<SslConfig>(6, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'ssl', subBuilder: SslConfig.create)
    ..aOS(7, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'cloudSqlId')
    ..hasRequiredFields = false
  ;
  ...
  'Use [GeneratedMessageGenericExtensions.rebuild] instead. '
  'Will be removed in next major version')
  MySqlConnectionProfile copyWith(void Function(MySqlConnectionProfile) updates) => super.copyWith((message) => updates(message as MySqlConnectionProfile)) as MySqlConnectionProfile; // ignore: deprecated_member_use
  $pb.BuilderInfo get info_ => _i;
  @$core.pragma('dart2js:noInline')
...
class PostgreSqlConnectionProfile extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'PostgreSqlConnectionProfile', package: const $pb.PackageName(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'google.cloud.clouddms.v1'), createEmptyInstance: create)
    ..aOS(1, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'host')
    ..a<$core.int>(2, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'port', $pb.PbFieldType.O3)
    ..aOS(3, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'username')
    ..aOS(4, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'password')
  ...
  'Use [GeneratedMessageGenericExtensions.rebuild] instead. '
  'Will be removed in next major version')
  PostgreSqlConnectionProfile copyWith(void Function(PostgreSqlConnectionProfile) updates) => super.copyWith((message) => updates(message as PostgreSqlConnectionProfile)) as PostgreSqlConnectionProfile; // ignore: deprecated_member_use
  $pb.BuilderInfo get info_ => _i;
  @$core.pragma('dart2js:noInline')
...
class CloudSqlConnectionProfile extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'CloudSqlConnectionProfile', package: const $pb.PackageName(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'google.cloud.clouddms.v1'), createEmptyInstance: create)
    ..aOS(1, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'cloudSqlId')
    ..aOM<CloudSqlSettings>(2, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'settings', subBuilder: CloudSqlSettings.create)
    ..aOS(3, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'privateIp')
    ..aOS(4, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'publicIp')
    ..hasRequiredFields = false
  ;
  ...
  'Use [GeneratedMessageGenericExtensions.rebuild] instead. '
  'Will be removed in next major version')
  CloudSqlConnectionProfile copyWith(void Function(CloudSqlConnectionProfile) updates) => super.copyWith((message) => updates(message as CloudSqlConnectionProfile)) as CloudSqlConnectionProfile; // ignore: deprecated_member_use
  $pb.BuilderInfo get info_ => _i;
  @$core.pragma('dart2js:noInline')
...
class SqlAclEntry extends $pb.GeneratedMessage {
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'SqlAclEntry', package: const $pb.PackageName(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'google.cloud.clouddms.v1'), createEmptyInstance: create)
    ..oo(0, [10, 11])
    ..aOS(1, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'value')
    ..aOS(3, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'label')
    ..aOM<$0.Timestamp>(10, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'expireTime', subBuilder: $0.Timestamp.create)
    ..aOM<$1.Duration>(11, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'ttl', subBuilder: $1.Duration.create)
    ..hasRequiredFields = false
  ;
  ...
  'Use [GeneratedMessageGenericExtensions.rebuild] instead. '
  'Will be removed in next major version')
  SqlAclEntry copyWith(void Function(SqlAclEntry) updates) => super.copyWith((message) => updates(message as SqlAclEntry)) as SqlAclEntry; // ignore: deprecated_member_use
  $pb.BuilderInfo get info_ => _i;
  @$core.pragma('dart2js:noInline')
  ...
  @$pb.TagNumber(10)
  set expireTime($0.Timestamp v) { setField(10, v); }
  @$pb.TagNumber(10)
  ...
  @$pb.TagNumber(11)
  set ttl($1.Duration v) { setField(11, v); }
  @$pb.TagNumber(11)
...
class SqlIpConfig extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'SqlIpConfig', package: const $pb.PackageName(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'google.cloud.clouddms.v1'), createEmptyInstance: create)
    ..aOM<$2.BoolValue>(1, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'enableIpv4', subBuilder: $2.BoolValue.create)
    ..aOS(2, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'privateNetwork')
    ..aOM<$2.BoolValue>(3, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'requireSsl', subBuilder: $2.BoolValue.create)
    ..pc<SqlAclEntry>(4, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'authorizedNetworks', $pb.PbFieldType.PM, subBuilder: SqlAclEntry.create)
    ..hasRequiredFields = false
  ;
  ...
  'Use [GeneratedMessageGenericExtensions.rebuild] instead. '
  'Will be removed in next major version')
  SqlIpConfig copyWith(void Function(SqlIpConfig) updates) => super.copyWith((message) => updates(message as SqlIpConfig)) as SqlIpConfig; // ignore: deprecated_member_use
  $pb.BuilderInfo get info_ => _i;
  @$core.pragma('dart2js:noInline')
  ...
  @$pb.TagNumber(1)
  set enableIpv4($2.BoolValue v) { setField(1, v); }
  @$pb.TagNumber(1)
  ...
  @$pb.TagNumber(3)
  set requireSsl($2.BoolValue v) { setField(3, v); }
  @$pb.TagNumber(3)
...
class CloudSqlSettings extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'CloudSqlSettings', package: const $pb.PackageName(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'google.cloud.clouddms.v1'), createEmptyInstance: create)
    ..e<CloudSqlSettings_SqlDatabaseVersion>(1, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'databaseVersion', $pb.PbFieldType.OE, defaultOrMaker: CloudSqlSettings_SqlDatabaseVersion.SQL_DATABASE_VERSION_UNSPECIFIED, valueOf: CloudSqlSettings_SqlDatabaseVersion.valueOf, enumValues: CloudSqlSettings_SqlDatabaseVersion.values)
    ..m<$core.String, $core.String>(2, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'userLabels', entryClassName: 'CloudSqlSettings.UserLabelsEntry', keyFieldType: $pb.PbFieldType.OS, valueFieldType: $pb.PbFieldType.OS, packageName: const $pb.PackageName('google.cloud.clouddms.v1'))
    ..aOS(3, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'tier')
    ..aOM<$2.Int64Value>(4, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'storageAutoResizeLimit', subBuilder: $2.Int64Value.create)
    ..e<CloudSqlSettings_SqlActivationPolicy>(5, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'activationPolicy', $pb.PbFieldType.OE, defaultOrMaker: CloudSqlSettings_SqlActivationPolicy.SQL_ACTIVATION_POLICY_UNSPECIFIED, valueOf: CloudSqlSettings_SqlActivationPolicy.valueOf, enumValues: CloudSqlSettings_SqlActivationPolicy.values)
    ..aOM<SqlIpConfig>(6, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'ipConfig', subBuilder: SqlIpConfig.create)
    ..aOM<$2.BoolValue>(7, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'autoStorageIncrease', subBuilder: $2.BoolValue.create)
    ..m<$core.String, $core.String>(8, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'databaseFlags', entryClassName: 'CloudSqlSettings.DatabaseFlagsEntry', keyFieldType: $pb.PbFieldType.OS, valueFieldType: $pb.PbFieldType.OS, packageName: const $pb.PackageName('google.cloud.clouddms.v1'))
    ..e<CloudSqlSettings_SqlDataDiskType>(9, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'dataDiskType', $pb.PbFieldType.OE, defaultOrMaker: CloudSqlSettings_SqlDataDiskType.SQL_DATA_DISK_TYPE_UNSPECIFIED, valueOf: CloudSqlSettings_SqlDataDiskType.valueOf, enumValues: CloudSqlSettings_SqlDataDiskType.values)
    ..aOM<$2.Int64Value>(10, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'dataDiskSizeGb', subBuilder: $2.Int64Value.create)
    ..aOS(11, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'zone')
    ..aOS(12, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'sourceId')
    ..aOS(13, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'rootPassword')
    ..aOB(14, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'rootPasswordSet')
    ..aOS(15, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'collation')
    ..hasRequiredFields = false
  ;
  ...
  'Use [GeneratedMessageGenericExtensions.rebuild] instead. '
  'Will be removed in next major version')
  CloudSqlSettings copyWith(void Function(CloudSqlSettings) updates) => super.copyWith((message) => updates(message as CloudSqlSettings)) as CloudSqlSettings; // ignore: deprecated_member_use
  $pb.BuilderInfo get info_ => _i;
  @$core.pragma('dart2js:noInline')
  ...
  @$pb.TagNumber(4)
  set storageAutoResizeLimit($2.Int64Value v) { setField(4, v); }
  @$pb.TagNumber(4)
  ...
  @$pb.TagNumber(7)
  set autoStorageIncrease($2.BoolValue v) { setField(7, v); }
  @$pb.TagNumber(7)
  ...
  @$pb.TagNumber(10)
  set dataDiskSizeGb($2.Int64Value v) { setField(10, v); }
  @$pb.TagNumber(10)
...
class StaticIpConnectivity extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'StaticIpConnectivity', package: const $pb.PackageName(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'google.cloud.clouddms.v1'), createEmptyInstance: create)
    ..hasRequiredFields = false
  ;
  ...
  'Use [GeneratedMessageGenericExtensions.rebuild] instead. '
  'Will be removed in next major version')
  StaticIpConnectivity copyWith(void Function(StaticIpConnectivity) updates) => super.copyWith((message) => updates(message as StaticIpConnectivity)) as StaticIpConnectivity; // ignore: deprecated_member_use
  $pb.BuilderInfo get info_ => _i;
  @$core.pragma('dart2js:noInline')
...
class ReverseSshConnectivity extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'ReverseSshConnectivity', package: const $pb.PackageName(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'google.cloud.clouddms.v1'), createEmptyInstance: create)
    ..aOS(1, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'vmIp')
    ..a<$core.int>(2, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'vmPort', $pb.PbFieldType.O3)
    ..aOS(3, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'vm')
    ..aOS(4, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'vpc')
    ..hasRequiredFields = false
  ;
  ...
  'Use [GeneratedMessageGenericExtensions.rebuild] instead. '
  'Will be removed in next major version')
  ReverseSshConnectivity copyWith(void Function(ReverseSshConnectivity) updates) => super.copyWith((message) => updates(message as ReverseSshConnectivity)) as ReverseSshConnectivity; // ignore: deprecated_member_use
  $pb.BuilderInfo get info_ => _i;
  @$core.pragma('dart2js:noInline')
...
class VpcPeeringConnectivity extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'VpcPeeringConnectivity', package: const $pb.PackageName(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'google.cloud.clouddms.v1'), createEmptyInstance: create)
  ...
  'Use [GeneratedMessageGenericExtensions.rebuild] instead. '
  'Will be removed in next major version')
  VpcPeeringConnectivity copyWith(void Function(VpcPeeringConnectivity) updates) => super.copyWith((message) => updates(message as VpcPeeringConnectivity)) as VpcPeeringConnectivity; // ignore: deprecated_member_use
  $pb.BuilderInfo get info_ => _i;
  @$core.pragma('dart2js:noInline')
...
class DatabaseType extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'DatabaseType', package: const $pb.PackageName(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'google.cloud.clouddms.v1'), createEmptyInstance: create)
    ..e<DatabaseProvider>(1, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'provider', $pb.PbFieldType.OE, defaultOrMaker: DatabaseProvider.DATABASE_PROVIDER_UNSPECIFIED, valueOf: DatabaseProvider.valueOf, enumValues: DatabaseProvider.values)
    ..e<DatabaseEngine>(2, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'engine', $pb.PbFieldType.OE, defaultOrMaker: DatabaseEngine.DATABASE_ENGINE_UNSPECIFIED, valueOf: DatabaseEngine.valueOf, enumValues: DatabaseEngine.values)
    ..hasRequiredFields = false
  ;
  ...
  'Use [GeneratedMessageGenericExtensions.rebuild] instead. '
  'Will be removed in next major version')
  DatabaseType copyWith(void Function(DatabaseType) updates) => super.copyWith((message) => updates(message as DatabaseType)) as DatabaseType; // ignore: deprecated_member_use
  $pb.BuilderInfo get info_ => _i;
  @$core.pragma('dart2js:noInline')
...
class MigrationJob extends $pb.GeneratedMessage {
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'MigrationJob', package: const $pb.PackageName(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'google.cloud.clouddms.v1'), createEmptyInstance: create)
    ..oo(0, [101, 102, 103])
    ...
    ..m<$core.String, $core.String>(4, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'labels', entryClassName: 'MigrationJob.LabelsEntry', keyFieldType: $pb.PbFieldType.OS, valueFieldType: $pb.PbFieldType.OS, packageName: const $pb.PackageName('google.cloud.clouddms.v1'))
    ..aOS(5, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'displayName')
    ..e<MigrationJob_State>(6, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'state', $pb.PbFieldType.OE, defaultOrMaker: MigrationJob_State.STATE_UNSPECIFIED, valueOf: MigrationJob_State.valueOf, enumValues: MigrationJob_State.values)
    ..e<MigrationJob_Phase>(7, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'phase', $pb.PbFieldType.OE, defaultOrMaker: MigrationJob_Phase.PHASE_UNSPECIFIED, valueOf: MigrationJob_Phase.valueOf, enumValues: MigrationJob_Phase.values)
    ..e<MigrationJob_Type>(8, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'type', $pb.PbFieldType.OE, defaultOrMaker: MigrationJob_Type.TYPE_UNSPECIFIED, valueOf: MigrationJob_Type.valueOf, enumValues: MigrationJob_Type.values)
    ..aOS(9, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'dumpPath')
    ..aOS(10, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'source')
    ..aOS(11, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'destination')
    ..aOM<$1.Duration>(12, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'duration', subBuilder: $1.Duration.create)
    ..aOM<$3.Status>(13, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'error', subBuilder: $3.Status.create)
    ..aOM<DatabaseType>(14, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'sourceDatabase', subBuilder: DatabaseType.create)
    ..aOM<DatabaseType>(15, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'destinationDatabase', subBuilder: DatabaseType.create)
    ..aOM<$0.Timestamp>(16, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'endTime', subBuilder: $0.Timestamp.create)
    ..aOM<ReverseSshConnectivity>(101, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'reverseSshConnectivity', subBuilder: ReverseSshConnectivity.create)
    ..aOM<VpcPeeringConnectivity>(102, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'vpcPeeringConnectivity', subBuilder: VpcPeeringConnectivity.create)
    ..aOM<StaticIpConnectivity>(103, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'staticIpConnectivity', subBuilder: StaticIpConnectivity.create)
    ..hasRequiredFields = false
  ;
  ...
  'Use [GeneratedMessageGenericExtensions.rebuild] instead. '
  'Will be removed in next major version')
  MigrationJob copyWith(void Function(MigrationJob) updates) => super.copyWith((message) => updates(message as MigrationJob)) as MigrationJob; // ignore: deprecated_member_use
  $pb.BuilderInfo get info_ => _i;
  @$core.pragma('dart2js:noInline')
  ...
  @$pb.TagNumber(12)
  set duration($1.Duration v) { setField(12, v); }
  @$pb.TagNumber(12)
  ...
  @$pb.TagNumber(13)
  set error($3.Status v) { setField(13, v); }
  @$pb.TagNumber(13)
  ...
  @$pb.TagNumber(16)
  set endTime($0.Timestamp v) { setField(16, v); }
  @$pb.TagNumber(16)
...
class ConnectionProfile extends $pb.GeneratedMessage {
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'ConnectionProfile', package: const $pb.PackageName(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'google.cloud.clouddms.v1'), createEmptyInstance: create)
    ..oo(0, [100, 101, 102])
    ..aOS(1, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'name')
    ..aOM<$0.Timestamp>(2, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'createTime', subBuilder: $0.Timestamp.create)
    ..aOM<$0.Timestamp>(3, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'updateTime', subBuilder: $0.Timestamp.create)
    ..m<$core.String, $core.String>(4, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'labels', entryClassName: 'ConnectionProfile.LabelsEntry', keyFieldType: $pb.PbFieldType.OS, valueFieldType: $pb.PbFieldType.OS, packageName: const $pb.PackageName('google.cloud.clouddms.v1'))
    ..e<ConnectionProfile_State>(5, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'state', $pb.PbFieldType.OE, defaultOrMaker: ConnectionProfile_State.STATE_UNSPECIFIED, valueOf: ConnectionProfile_State.valueOf, enumValues: ConnectionProfile_State.values)
    ..aOS(6, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'displayName')
    ..aOM<$3.Status>(7, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'error', subBuilder: $3.Status.create)
    ..e<DatabaseProvider>(8, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'provider', $pb.PbFieldType.OE, defaultOrMaker: DatabaseProvider.DATABASE_PROVIDER_UNSPECIFIED, valueOf: DatabaseProvider.valueOf, enumValues: DatabaseProvider.values)
    ..aOM<MySqlConnectionProfile>(100, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'mysql', subBuilder: MySqlConnectionProfile.create)
    ..aOM<PostgreSqlConnectionProfile>(101, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'postgresql', subBuilder: PostgreSqlConnectionProfile.create)
    ..aOM<CloudSqlConnectionProfile>(102, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'cloudsql', subBuilder: CloudSqlConnectionProfile.create)
    ..hasRequiredFields = false
  ;
  ...
  @$pb.TagNumber(7)
  set error($3.Status v) { setField(7, v); }
  @$pb.TagNumber(7)
...
class MigrationJobVerificationError extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'MigrationJobVerificationError', package: const $pb.PackageName(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'google.cloud.clouddms.v1'), createEmptyInstance: create)
    ..e<MigrationJobVerificationError_ErrorCode>(1, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'errorCode', $pb.PbFieldType.OE, defaultOrMaker: MigrationJobVerificationError_ErrorCode.ERROR_CODE_UNSPECIFIED, valueOf: MigrationJobVerificationError_ErrorCode.valueOf, enumValues: MigrationJobVerificationError_ErrorCode.values)
    ..aOS(2, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'errorMessage')
    ..aOS(3, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'errorDetailMessage')
    ..hasRequiredFields = false
  ;
  ...
  'Use [GeneratedMessageGenericExtensions.rebuild] instead. '
  'Will be removed in next major version')
  MigrationJobVerificationError copyWith(void Function(MigrationJobVerificationError) updates) => super.copyWith((message) => updates(message as MigrationJobVerificationError)) as MigrationJobVerificationError; // ignore: deprecated_member_use
  $pb.BuilderInfo get info_ => _i;
  @$core.pragma('dart2js:noInline')

...
class DatabaseType extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'DatabaseType', package: const $pb.PackageName(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'google.cloud.clouddms.logging.v1'), createEmptyInstance: create)
...
class LoggedMigrationJob extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'LoggedMigrationJob', package: const $pb.PackageName(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'google.cloud.clouddms.logging.v1'), createEmptyInstance: create)
    ..aOS(1, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'name')
    ..m<$core.String, $core.String>(2, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'labels', entryClassName: 'LoggedMigrationJob.LabelsEntry', keyFieldType: $pb.PbFieldType.OS, valueFieldType: $pb.PbFieldType.OS, packageName: const $pb.PackageName('google.cloud.clouddms.logging.v1'))
    ..aOS(3, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'displayName')
    ..e<LoggedMigrationJob_State>(4, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'state', $pb.PbFieldType.OE, defaultOrMaker: LoggedMigrationJob_State.STATE_UNSPECIFIED, valueOf: LoggedMigrationJob_State.valueOf, enumValues: LoggedMigrationJob_State.values)
    ..e<LoggedMigrationJob_Phase>(5, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'phase', $pb.PbFieldType.OE, defaultOrMaker: LoggedMigrationJob_Phase.PHASE_UNSPECIFIED, valueOf: LoggedMigrationJob_Phase.valueOf, enumValues: LoggedMigrationJob_Phase.values)
    ..e<LoggedMigrationJob_Type>(6, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'type', $pb.PbFieldType.OE, defaultOrMaker: LoggedMigrationJob_Type.TYPE_UNSPECIFIED, valueOf: LoggedMigrationJob_Type.valueOf, enumValues: LoggedMigrationJob_Type.values)
    ..aOS(7, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'dumpPath')
    ...
    ..aOM<$0.Duration>(10, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'duration', subBuilder: $0.Duration.create)
    ..e<LoggedMigrationJob_ConnectivityType>(11, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'connectivityType', $pb.PbFieldType.OE, defaultOrMaker: LoggedMigrationJob_ConnectivityType.CONNECTIVITY_TYPE_UNSPECIFIED, valueOf: LoggedMigrationJob_ConnectivityType.valueOf, enumValues: LoggedMigrationJob_ConnectivityType.values)
    ..aOM<$1.Status>(12, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'error', subBuilder: $1.Status.create)
    ..aOM<$2.Timestamp>(13, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'endTime', subBuilder: $2.Timestamp.create)
  ...
  'Use [GeneratedMessageGenericExtensions.rebuild] instead. '
  'Will be removed in next major version')
  LoggedMigrationJob copyWith(void Function(LoggedMigrationJob) updates) => super.copyWith((message) => updates(message as LoggedMigrationJob)) as LoggedMigrationJob; // ignore: deprecated_member_use
  $pb.BuilderInfo get info_ => _i;
  @$core.pragma('dart2js:noInline')
  ...
  @$pb.TagNumber(10)
  set duration($0.Duration v) { setField(10, v); }
  @$pb.TagNumber(10)
  ...
  @$pb.TagNumber(12)
  set error($1.Status v) { setField(12, v); }
  @$pb.TagNumber(12)
  ...
  @$pb.TagNumber(13)
  set endTime($2.Timestamp v) { setField(13, v); }
  @$pb.TagNumber(13)
...
class MySqlConnectionProfile extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'MySqlConnectionProfile', package: const $pb.PackageName(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'google.cloud.clouddms.logging.v1'), createEmptyInstance: create)
    ..e<MySqlConnectionProfile_Version>(1, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'version', $pb.PbFieldType.OE, defaultOrMaker: MySqlConnectionProfile_Version.VERSION_UNSPECIFIED, valueOf: MySqlConnectionProfile_Version.valueOf, enumValues: MySqlConnectionProfile_Version.values)
    ..aOS(2, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'cloudSqlId')
    ..hasRequiredFields = false
  ;
...
class PostgreSqlConnectionProfile extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'PostgreSqlConnectionProfile', package: const $pb.PackageName(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'google.cloud.clouddms.logging.v1'), createEmptyInstance: create)
    ..e<PostgreSqlConnectionProfile_Version>(1, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'version', $pb.PbFieldType.OE, defaultOrMaker: PostgreSqlConnectionProfile_Version.VERSION_UNSPECIFIED, valueOf: PostgreSqlConnectionProfile_Version.valueOf, enumValues: PostgreSqlConnectionProfile_Version.values)
    ..aOS(2, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'cloudSqlId')
    ..hasRequiredFields = false
  ;
...
class CloudSqlConnectionProfile extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'CloudSqlConnectionProfile', package: const $pb.PackageName(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'google.cloud.clouddms.logging.v1'), createEmptyInstance: create)
...
class LoggedConnectionProfile extends $pb.GeneratedMessage {
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'LoggedConnectionProfile', package: const $pb.PackageName(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'google.cloud.clouddms.logging.v1'), createEmptyInstance: create)
    ..oo(0, [100, 101, 102])
    ..aOS(1, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'name')
    ..m<$core.String, $core.String>(2, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'labels', entryClassName: 'LoggedConnectionProfile.LabelsEntry', keyFieldType: $pb.PbFieldType.OS, valueFieldType: $pb.PbFieldType.OS, packageName: const $pb.PackageName('google.cloud.clouddms.logging.v1'))
    ..e<LoggedConnectionProfile_State>(3, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'state', $pb.PbFieldType.OE, defaultOrMaker: LoggedConnectionProfile_State.STATE_UNSPECIFIED, valueOf: LoggedConnectionProfile_State.valueOf, enumValues: LoggedConnectionProfile_State.values)
    ..aOS(4, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'displayName')
    ..aOM<$1.Status>(5, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'error', subBuilder: $1.Status.create)
    ..e<DatabaseProvider>(6, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'provider', $pb.PbFieldType.OE, defaultOrMaker: DatabaseProvider.DATABASE_PROVIDER_UNSPECIFIED, valueOf: DatabaseProvider.valueOf, enumValues: DatabaseProvider.values)
  ...
  'Use [GeneratedMessageGenericExtensions.rebuild] instead. '
  'Will be removed in next major version')
  LoggedConnectionProfile copyWith(void Function(LoggedConnectionProfile) updates) => super.copyWith((message) => updates(message as LoggedConnectionProfile)) as LoggedConnectionProfile; // ignore: deprecated_member_use
  $pb.BuilderInfo get info_ => _i;
  @$core.pragma('dart2js:noInline')
  ...
  @$pb.TagNumber(5)
  set error($1.Status v) { setField(5, v); }
  @$pb.TagNumber(5)
...
class MigrationJobEventLog extends $pb.GeneratedMessage {
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'MigrationJobEventLog', package: const $pb.PackageName(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'google.cloud.clouddms.logging.v1'), createEmptyInstance: create)
    ..oo(0, [200, 201])
    ..aOM<LoggedMigrationJob>(1, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'migrationJob', subBuilder: LoggedMigrationJob.create)
    ..aOM<$2.Timestamp>(2, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'occurrenceTimestamp', subBuilder: $2.Timestamp.create)
    ..a<$core.int>(3, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'code', $pb.PbFieldType.O3)
    ..aOS(4, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'textMessage')
    ..a<$core.int>(200, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'originalCode', $pb.PbFieldType.O3)
    ..aOS(201, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'originalMessage')
    ..hasRequiredFields = false
  ;
  ...
  'Use [GeneratedMessageGenericExtensions.rebuild] instead. '
  'Will be removed in next major version')
  MigrationJobEventLog copyWith(void Function(MigrationJobEventLog) updates) => super.copyWith((message) => updates(message as MigrationJobEventLog)) as MigrationJobEventLog; // ignore: deprecated_member_use
  $pb.BuilderInfo get info_ => _i;
  @$core.pragma('dart2js:noInline')
  ...
  @$pb.TagNumber(2)
  set occurrenceTimestamp($2.Timestamp v) { setField(2, v); }
  @$pb.TagNumber(2)
...
class ConnectionProfileEventLog extends $pb.GeneratedMessage {
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'ConnectionProfileEventLog', package: const $pb.PackageName(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'google.cloud.clouddms.logging.v1'), createEmptyInstance: create)
    ..oo(0, [200, 201])
    ..aOM<LoggedConnectionProfile>(1, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'connectionProfile', subBuilder: LoggedConnectionProfile.create)
    ..aOM<$2.Timestamp>(2, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'occurrenceTimestamp', subBuilder: $2.Timestamp.create)
    ..a<$core.int>(3, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'code', $pb.PbFieldType.O3)
    ..aOS(4, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'textMessage')
    ..a<$core.int>(200, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'originalCode', $pb.PbFieldType.O3)
  ...
  'Use [GeneratedMessageGenericExtensions.rebuild] instead. '
  'Will be removed in next major version')
  ConnectionProfileEventLog copyWith(void Function(ConnectionProfileEventLog) updates) => super.copyWith((message) => updates(message as ConnectionProfileEventLog)) as ConnectionProfileEventLog; // ignore: deprecated_member_use
  $pb.BuilderInfo get info_ => _i;
  @$core.pragma('dart2js:noInline')

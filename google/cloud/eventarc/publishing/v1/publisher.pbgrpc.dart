...
class PublisherClient extends $grpc.Client {
  ...
  static final _$publishEvents =
      $grpc.ClientMethod<$0.PublishEventsRequest, $0.PublishEventsResponse>(
          '/google.cloud.eventarc.publishing.v1.Publisher/PublishEvents',
          ($0.PublishEventsRequest value) => value.writeToBuffer(),
          ($core.List<$core.int> value) =>
              $0.PublishEventsResponse.fromBuffer(value));
  ...
  $grpc.ResponseFuture<$0.PublishEventsResponse> publishEvents(
      $0.PublishEventsRequest request,
      {$grpc.CallOptions? options}) {
...
abstract class PublisherServiceBase extends $grpc.Service {
  ...
  PublisherServiceBase() {
    $addMethod($grpc.ServiceMethod<$0.PublishChannelConnectionEventsRequest,
        ...
        ($0.PublishChannelConnectionEventsResponse value) =>
            value.writeToBuffer()));
    $addMethod(
        $grpc.ServiceMethod<$0.PublishEventsRequest, $0.PublishEventsResponse>(
            'PublishEvents',
            publishEvents_Pre,
            false,
            false,
            ($core.List<$core.int> value) =>
                $0.PublishEventsRequest.fromBuffer(value),
            ($0.PublishEventsResponse value) => value.writeToBuffer()));
  }
  ...
  $async.Future<$0.PublishEventsResponse> publishEvents_Pre(
      $grpc.ServiceCall call,
      $async.Future<$0.PublishEventsRequest> request) async {
  ...
  $async.Future<$0.PublishChannelConnectionEventsResponse>
      publishChannelConnectionEvents($grpc.ServiceCall call,
          $0.PublishChannelConnectionEventsRequest request);
  $async.Future<$0.PublishEventsResponse> publishEvents(
      $grpc.ServiceCall call, $0.PublishEventsRequest request);
}

...
final $typed_data.Uint8List getSupportAccountRequestDescriptor = $convert.base64Decode('ChhHZXRTdXBwb3J0QWNjb3VudFJlcXVlc3QSEgoEbmFtZRgBIAEoCVIEbmFtZQ==');
...
final $typed_data.Uint8List listSupportAccountsRequestDescriptor = $convert.base64Decode('ChpMaXN0U3VwcG9ydEFjY291bnRzUmVxdWVzdBIWCgZmaWx0ZXIYASABKAlSBmZpbHRlchIbCglwYWdlX3NpemUYAiABKANSCHBhZ2VTaXplEh0KCnBhZ2VfdG9rZW4YAyABKAlSCXBhZ2VUb2tlbg==');
...
final $typed_data.Uint8List listSupportAccountsResponseDescriptor = $convert.base64Decode('ChtMaXN0U3VwcG9ydEFjY291bnRzUmVzcG9uc2USRwoIYWNjb3VudHMYASADKAsyKy5nb29nbGUuY2xvdWQuc3VwcG9ydC5jb21tb24uU3VwcG9ydEFjY291bnRSCGFjY291bnRzEiYKD25leHRfcGFnZV90b2tlbhgCIAEoCVINbmV4dFBhZ2VUb2tlbg==');
...
final $typed_data.Uint8List getCaseRequestDescriptor = $convert.base64Decode('Cg5HZXRDYXNlUmVxdWVzdBISCgRuYW1lGAEgASgJUgRuYW1l');
...
final $typed_data.Uint8List listCasesRequestDescriptor = $convert.base64Decode('ChBMaXN0Q2FzZXNSZXF1ZXN0EhIKBG5hbWUYASABKAlSBG5hbWUSFgoGZmlsdGVyGAIgASgJUgZmaWx0ZXISGwoJcGFnZV9zaXplGAMgASgDUghwYWdlU2l6ZRIdCgpwYWdlX3Rva2VuGAQgASgJUglwYWdlVG9rZW4=');
...
final $typed_data.Uint8List listCasesResponseDescriptor = $convert.base64Decode('ChFMaXN0Q2FzZXNSZXNwb25zZRI3CgVjYXNlcxgBIAMoCzIhLmdvb2dsZS5jbG91ZC5zdXBwb3J0LmNvbW1vbi5DYXNlUgVjYXNlcxImCg9uZXh0X3BhZ2VfdG9rZW4YAiABKAlSDW5leHRQYWdlVG9rZW4=');
...
final $typed_data.Uint8List listCommentsRequestDescriptor = $convert.base64Decode('ChNMaXN0Q29tbWVudHNSZXF1ZXN0EhIKBG5hbWUYASABKAlSBG5hbWU=');
...
final $typed_data.Uint8List listCommentsResponseDescriptor = $convert.base64Decode('ChRMaXN0Q29tbWVudHNSZXNwb25zZRJACghjb21tZW50cxgBIAMoCzIkLmdvb2dsZS5jbG91ZC5zdXBwb3J0LmNvbW1vbi5Db21tZW50Ughjb21tZW50cw==');
...
final $typed_data.Uint8List createCaseRequestDescriptor = $convert.base64Decode('ChFDcmVhdGVDYXNlUmVxdWVzdBIWCgZwYXJlbnQYASABKAlSBnBhcmVudBI1CgRjYXNlGAIgASgLMiEuZ29vZ2xlLmNsb3VkLnN1cHBvcnQuY29tbW9uLkNhc2VSBGNhc2U=');
...
final $typed_data.Uint8List updateCaseRequestDescriptor = $convert.base64Decode('ChFVcGRhdGVDYXNlUmVxdWVzdBI1CgRjYXNlGAEgASgLMiEuZ29vZ2xlLmNsb3VkLnN1cHBvcnQuY29tbW9uLkNhc2VSBGNhc2USOwoLdXBkYXRlX21hc2sYAiABKAsyGi5nb29nbGUucHJvdG9idWYuRmllbGRNYXNrUgp1cGRhdGVNYXNr');
...
final $typed_data.Uint8List createCommentRequestDescriptor = $convert.base64Decode('ChRDcmVhdGVDb21tZW50UmVxdWVzdBISCgRuYW1lGAEgASgJUgRuYW1lEj4KB2NvbW1lbnQYAiABKAsyJC5nb29nbGUuY2xvdWQuc3VwcG9ydC5jb21tb24uQ29tbWVudFIHY29tbWVudA==');
...
final $typed_data.Uint8List getIssueTaxonomyRequestDescriptor = $convert.base64Decode('ChdHZXRJc3N1ZVRheG9ub215UmVxdWVzdA==');

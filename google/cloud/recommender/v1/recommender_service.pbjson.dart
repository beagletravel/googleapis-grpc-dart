...
const ListInsightsResponse$json = const {
  ...
  '2': const [
    const {'1': 'insights', '3': 1, '4': 3, '5': 11, '6': '.google.cloud.recommender.v1.Insight', '10': 'insights'},
    const {'1': 'next_page_token', '3': 2, '4': 1, '5': 9, '10': 'nextPageToken'},
  ],
};

/// Descriptor for `ListInsightsResponse`. Decode as a `google.protobuf.DescriptorProto`.
final $typed_data.Uint8List listInsightsResponseDescriptor = $convert.base64Decode('ChRMaXN0SW5zaWdodHNSZXNwb25zZRJACghpbnNpZ2h0cxgBIAMoCzIkLmdvb2dsZS5jbG91ZC5yZWNvbW1lbmRlci52MS5JbnNpZ2h0UghpbnNpZ2h0cxImCg9uZXh0X3BhZ2VfdG9rZW4YAiABKAlSDW5leHRQYWdlVG9rZW4=');
...
const MarkInsightAcceptedRequest$json = const {
  ...
  '2': const [
    const {'1': 'name', '3': 1, '4': 1, '5': 9, '8': const {}, '10': 'name'},
    const {'1': 'state_metadata', '3': 2, '4': 3, '5': 11, '6': '.google.cloud.recommender.v1.MarkInsightAcceptedRequest.StateMetadataEntry', '8': const {}, '10': 'stateMetadata'},
...
final $typed_data.Uint8List markInsightAcceptedRequestDescriptor = $convert.base64Decode('');
...
const ListRecommendationsResponse$json = const {
  ...
  '2': const [
    const {'1': 'recommendations', '3': 1, '4': 3, '5': 11, '6': '.google.cloud.recommender.v1.Recommendation', '10': 'recommendations'},
    const {'1': 'next_page_token', '3': 2, '4': 1, '5': 9, '10': 'nextPageToken'},
  ],
};

/// Descriptor for `ListRecommendationsResponse`. Decode as a `google.protobuf.DescriptorProto`.
final $typed_data.Uint8List listRecommendationsResponseDescriptor = $convert.base64Decode('ChtMaXN0UmVjb21tZW5kYXRpb25zUmVzcG9uc2USVQoPcmVjb21tZW5kYXRpb25zGAEgAygLMisuZ29vZ2xlLmNsb3VkLnJlY29tbWVuZGVyLnYxLlJlY29tbWVuZGF0aW9uUg9yZWNvbW1lbmRhdGlvbnMSJgoPbmV4dF9wYWdlX3Rva2VuGAIgASgJUg1uZXh0UGFnZVRva2Vu');
...
const MarkRecommendationClaimedRequest$json = const {
  ...
  '2': const [
    const {'1': 'name', '3': 1, '4': 1, '5': 9, '8': const {}, '10': 'name'},
    const {'1': 'state_metadata', '3': 2, '4': 3, '5': 11, '6': '.google.cloud.recommender.v1.MarkRecommendationClaimedRequest.StateMetadataEntry', '10': 'stateMetadata'},
    const {'1': 'etag', '3': 3, '4': 1, '5': 9, '8': const {}, '10': 'etag'},
  ],
...
final $typed_data.Uint8List markRecommendationClaimedRequestDescriptor = $convert.base64Decode('');
...
const MarkRecommendationSucceededRequest$json = const {
  ...
  '2': const [
    const {'1': 'name', '3': 1, '4': 1, '5': 9, '8': const {}, '10': 'name'},
    const {'1': 'state_metadata', '3': 2, '4': 3, '5': 11, '6': '.google.cloud.recommender.v1.MarkRecommendationSucceededRequest.StateMetadataEntry', '10': 'stateMetadata'},
    const {'1': 'etag', '3': 3, '4': 1, '5': 9, '8': const {}, '10': 'etag'},
  ],
...
final $typed_data.Uint8List markRecommendationSucceededRequestDescriptor = $convert.base64Decode('');
...
const MarkRecommendationFailedRequest$json = const {
  ...
  '2': const [
    const {'1': 'name', '3': 1, '4': 1, '5': 9, '8': const {}, '10': 'name'},
    const {'1': 'state_metadata', '3': 2, '4': 3, '5': 11, '6': '.google.cloud.recommender.v1.MarkRecommendationFailedRequest.StateMetadataEntry', '10': 'stateMetadata'},
    const {'1': 'etag', '3': 3, '4': 1, '5': 9, '8': const {}, '10': 'etag'},
  ],
...
final $typed_data.Uint8List markRecommendationFailedRequestDescriptor = $convert.base64Decode('');

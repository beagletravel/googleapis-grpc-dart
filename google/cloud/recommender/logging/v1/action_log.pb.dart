...
import '../../v1/recommendation.pbenum.dart' as $0;
import '../../v1/insight.pbenum.dart' as $1;

class ActionLog extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'ActionLog', package: const $pb.PackageName(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'google.cloud.recommender.logging.v1'), createEmptyInstance: create)
    ..aOS(1, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'actor')
    ..e<$0.RecommendationStateInfo_State>(2, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'state', $pb.PbFieldType.OE, defaultOrMaker: $0.RecommendationStateInfo_State.STATE_UNSPECIFIED, valueOf: $0.RecommendationStateInfo_State.valueOf, enumValues: $0.RecommendationStateInfo_State.values)
    ..m<$core.String, $core.String>(3, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'stateMetadata', entryClassName: 'ActionLog.StateMetadataEntry', keyFieldType: $pb.PbFieldType.OS, valueFieldType: $pb.PbFieldType.OS, packageName: const $pb.PackageName('google.cloud.recommender.logging.v1'))
    ..aOS(4, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'recommendationName')
  ...
  'Will be removed in next major version')
  ActionLog copyWith(void Function(ActionLog) updates) => super.copyWith((message) => updates(message as ActionLog)) as ActionLog; // ignore: deprecated_member_use
  ...
  @$pb.TagNumber(2)
  set state($0.RecommendationStateInfo_State v) { setField(2, v); }
  @$pb.TagNumber(2)
...
class InsightActionLog extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'InsightActionLog', package: const $pb.PackageName(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'google.cloud.recommender.logging.v1'), createEmptyInstance: create)
    ..aOS(1, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'actor')
    ..e<$1.InsightStateInfo_State>(2, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'state', $pb.PbFieldType.OE, defaultOrMaker: $1.InsightStateInfo_State.STATE_UNSPECIFIED, valueOf: $1.InsightStateInfo_State.valueOf, enumValues: $1.InsightStateInfo_State.values)
    ..m<$core.String, $core.String>(3, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'stateMetadata', entryClassName: 'InsightActionLog.StateMetadataEntry', keyFieldType: $pb.PbFieldType.OS, valueFieldType: $pb.PbFieldType.OS, packageName: const $pb.PackageName('google.cloud.recommender.logging.v1'))
    ..aOS(4, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'insight')
    ..hasRequiredFields = false
  ;
  ...
  'Use [GeneratedMessageGenericExtensions.rebuild] instead. '
  'Will be removed in next major version')
  InsightActionLog copyWith(void Function(InsightActionLog) updates) => super.copyWith((message) => updates(message as InsightActionLog)) as InsightActionLog; // ignore: deprecated_member_use
  $pb.BuilderInfo get info_ => _i;
  @$core.pragma('dart2js:noInline')
  ...
  @$pb.TagNumber(2)
  set state($1.InsightStateInfo_State v) { setField(2, v); }
  @$pb.TagNumber(2)
  $core.bool hasState() => $_has(1);
  @$pb.TagNumber(2)
  void clearState() => clearField(2);

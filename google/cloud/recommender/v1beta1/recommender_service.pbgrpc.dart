...
class RecommenderClient extends $grpc.Client {
  ...
  static final _$markRecommendationFailed = $grpc.ClientMethod<
          $0.MarkRecommendationFailedRequest, $2.Recommendation>(
      ...
      ($core.List<$core.int> value) => $2.Recommendation.fromBuffer(value));
  static final _$getRecommenderConfig =
      $grpc.ClientMethod<$0.GetRecommenderConfigRequest, $3.RecommenderConfig>(
          '/google.cloud.recommender.v1beta1.Recommender/GetRecommenderConfig',
          ($0.GetRecommenderConfigRequest value) => value.writeToBuffer(),
          ($core.List<$core.int> value) =>
              $3.RecommenderConfig.fromBuffer(value));
  static final _$updateRecommenderConfig = $grpc.ClientMethod<
          $0.UpdateRecommenderConfigRequest, $3.RecommenderConfig>(
      '/google.cloud.recommender.v1beta1.Recommender/UpdateRecommenderConfig',
      ($0.UpdateRecommenderConfigRequest value) => value.writeToBuffer(),
      ($core.List<$core.int> value) => $3.RecommenderConfig.fromBuffer(value));
  static final _$getInsightTypeConfig =
      $grpc.ClientMethod<$0.GetInsightTypeConfigRequest, $4.InsightTypeConfig>(
          '/google.cloud.recommender.v1beta1.Recommender/GetInsightTypeConfig',
          ($0.GetInsightTypeConfigRequest value) => value.writeToBuffer(),
          ($core.List<$core.int> value) =>
              $4.InsightTypeConfig.fromBuffer(value));
  static final _$updateInsightTypeConfig = $grpc.ClientMethod<
          $0.UpdateInsightTypeConfigRequest, $4.InsightTypeConfig>(
      '/google.cloud.recommender.v1beta1.Recommender/UpdateInsightTypeConfig',
      ($0.UpdateInsightTypeConfigRequest value) => value.writeToBuffer(),
      ($core.List<$core.int> value) => $4.InsightTypeConfig.fromBuffer(value));
  ...
  $grpc.ResponseFuture<$3.RecommenderConfig> getRecommenderConfig(
      $0.GetRecommenderConfigRequest request,
      {$grpc.CallOptions? options}) {
    return $createUnaryCall(_$getRecommenderConfig, request, options: options);
  }

  $grpc.ResponseFuture<$3.RecommenderConfig> updateRecommenderConfig(
      $0.UpdateRecommenderConfigRequest request,
      {$grpc.CallOptions? options}) {
    return $createUnaryCall(_$updateRecommenderConfig, request,
        options: options);
  }

  $grpc.ResponseFuture<$4.InsightTypeConfig> getInsightTypeConfig(
      $0.GetInsightTypeConfigRequest request,
      {$grpc.CallOptions? options}) {
    return $createUnaryCall(_$getInsightTypeConfig, request, options: options);
  }

  $grpc.ResponseFuture<$4.InsightTypeConfig> updateInsightTypeConfig(
      $0.UpdateInsightTypeConfigRequest request,
      {$grpc.CallOptions? options}) {
    return $createUnaryCall(_$updateInsightTypeConfig, request,
        options: options);
  }
}
...
abstract class RecommenderServiceBase extends $grpc.Service {
  ...
  RecommenderServiceBase() {
    ...
    $addMethod($grpc.ServiceMethod<$0.MarkRecommendationFailedRequest,
        ...
        ($2.Recommendation value) => value.writeToBuffer()));
    $addMethod($grpc.ServiceMethod<$0.GetRecommenderConfigRequest,
            $3.RecommenderConfig>(
        ...
        false,
        ($core.List<$core.int> value) =>
            $0.GetRecommenderConfigRequest.fromBuffer(value),
        ($3.RecommenderConfig value) => value.writeToBuffer()));
    $addMethod($grpc.ServiceMethod<$0.UpdateRecommenderConfigRequest,
            $3.RecommenderConfig>(
        ...
        false,
        ($core.List<$core.int> value) =>
            $0.UpdateRecommenderConfigRequest.fromBuffer(value),
        ($3.RecommenderConfig value) => value.writeToBuffer()));
    $addMethod($grpc.ServiceMethod<$0.GetInsightTypeConfigRequest,
            $4.InsightTypeConfig>(
        ...
        false,
        ($core.List<$core.int> value) =>
            $0.GetInsightTypeConfigRequest.fromBuffer(value),
        ($4.InsightTypeConfig value) => value.writeToBuffer()));
    $addMethod($grpc.ServiceMethod<$0.UpdateInsightTypeConfigRequest,
            $4.InsightTypeConfig>(
        ...
        false,
        ($core.List<$core.int> value) =>
            $0.UpdateInsightTypeConfigRequest.fromBuffer(value),
        ($4.InsightTypeConfig value) => value.writeToBuffer()));
  }
  ...
  $async.Future<$3.RecommenderConfig> getRecommenderConfig_Pre(
      $grpc.ServiceCall call,
      $async.Future<$0.GetRecommenderConfigRequest> request) async {
    return getRecommenderConfig(call, await request);
  }

  $async.Future<$3.RecommenderConfig> updateRecommenderConfig_Pre(
      $grpc.ServiceCall call,
      $async.Future<$0.UpdateRecommenderConfigRequest> request) async {
    return updateRecommenderConfig(call, await request);
  }

  $async.Future<$4.InsightTypeConfig> getInsightTypeConfig_Pre(
      $grpc.ServiceCall call,
      $async.Future<$0.GetInsightTypeConfigRequest> request) async {
    return getInsightTypeConfig(call, await request);
  }

  $async.Future<$4.InsightTypeConfig> updateInsightTypeConfig_Pre(
      $grpc.ServiceCall call,
      $async.Future<$0.UpdateInsightTypeConfigRequest> request) async {
  ...
  $async.Future<$3.RecommenderConfig> getRecommenderConfig(
      $grpc.ServiceCall call, $0.GetRecommenderConfigRequest request);
  $async.Future<$3.RecommenderConfig> updateRecommenderConfig(
      $grpc.ServiceCall call, $0.UpdateRecommenderConfigRequest request);
  $async.Future<$4.InsightTypeConfig> getInsightTypeConfig(
      $grpc.ServiceCall call, $0.GetInsightTypeConfigRequest request);
  $async.Future<$4.InsightTypeConfig> updateInsightTypeConfig(
      $grpc.ServiceCall call, $0.UpdateInsightTypeConfigRequest request);
}

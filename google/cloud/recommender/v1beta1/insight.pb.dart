...
class Insight_RecommendationReference extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'Insight.RecommendationReference', package: const $pb.PackageName(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'google.cloud.recommender.v1beta1'), createEmptyInstance: create)
    ..aOS(1, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'recommendation')
  ...
  'Will be removed in next major version')
  Insight_RecommendationReference copyWith(void Function(Insight_RecommendationReference) updates) => super.copyWith((message) => updates(message as Insight_RecommendationReference)) as Insight_RecommendationReference; // ignore: deprecated_member_use
...
class Insight extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'Insight', package: const $pb.PackageName(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'google.cloud.recommender.v1beta1'), createEmptyInstance: create)
    ..aOS(1, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'name')
    ..aOS(2, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'description')
    ..aOM<$0.Struct>(3, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'content', subBuilder: $0.Struct.create)
    ..aOM<$1.Timestamp>(4, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'lastRefreshTime', subBuilder: $1.Timestamp.create)
    ..aOM<$2.Duration>(5, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'observationPeriod', subBuilder: $2.Duration.create)
    ..aOM<InsightStateInfo>(6, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'stateInfo', subBuilder: InsightStateInfo.create)
    ..e<Insight_Category>(7, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'category', $pb.PbFieldType.OE, defaultOrMaker: Insight_Category.CATEGORY_UNSPECIFIED, valueOf: Insight_Category.valueOf, enumValues: Insight_Category.values)
    ..pc<Insight_RecommendationReference>(8, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'associatedRecommendations', $pb.PbFieldType.PM, subBuilder: Insight_RecommendationReference.create)
    ..pPS(9, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'targetResources')
    ..aOS(10, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'insightSubtype')
    ..aOS(11, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'etag')
    ..e<Insight_Severity>(15, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'severity', $pb.PbFieldType.OE, defaultOrMaker: Insight_Severity.SEVERITY_UNSPECIFIED, valueOf: Insight_Severity.valueOf, enumValues: Insight_Severity.values)
    ..hasRequiredFields = false
  ;
  ...
  'Use [GeneratedMessageGenericExtensions.rebuild] instead. '
  'Will be removed in next major version')
  Insight copyWith(void Function(Insight) updates) => super.copyWith((message) => updates(message as Insight)) as Insight; // ignore: deprecated_member_use
  $pb.BuilderInfo get info_ => _i;
  @$core.pragma('dart2js:noInline')
  ...
  @$pb.TagNumber(3)
  set content($0.Struct v) { setField(3, v); }
  @$pb.TagNumber(3)
  ...
  @$pb.TagNumber(4)
  set lastRefreshTime($1.Timestamp v) { setField(4, v); }
  @$pb.TagNumber(4)
  ...
  @$pb.TagNumber(5)
  set observationPeriod($2.Duration v) { setField(5, v); }
  @$pb.TagNumber(5)
...
class InsightStateInfo extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'InsightStateInfo', package: const $pb.PackageName(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'google.cloud.recommender.v1beta1'), createEmptyInstance: create)
    ..e<InsightStateInfo_State>(1, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'state', $pb.PbFieldType.OE, defaultOrMaker: InsightStateInfo_State.STATE_UNSPECIFIED, valueOf: InsightStateInfo_State.valueOf, enumValues: InsightStateInfo_State.values)
    ..m<$core.String, $core.String>(2, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'stateMetadata', entryClassName: 'InsightStateInfo.StateMetadataEntry', keyFieldType: $pb.PbFieldType.OS, valueFieldType: $pb.PbFieldType.OS, packageName: const $pb.PackageName('google.cloud.recommender.v1beta1'))
    ..hasRequiredFields = false
  ;
  ...
  'Use [GeneratedMessageGenericExtensions.rebuild] instead. '
  'Will be removed in next major version')
  InsightStateInfo copyWith(void Function(InsightStateInfo) updates) => super.copyWith((message) => updates(message as InsightStateInfo)) as InsightStateInfo; // ignore: deprecated_member_use
  $pb.BuilderInfo get info_ => _i;
  @$core.pragma('dart2js:noInline')

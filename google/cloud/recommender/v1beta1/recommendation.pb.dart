...
class Recommendation_InsightReference extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'Recommendation.InsightReference', package: const $pb.PackageName(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'google.cloud.recommender.v1beta1'), createEmptyInstance: create)
    ..aOS(1, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'insight')
  ...
  'Will be removed in next major version')
  Recommendation_InsightReference copyWith(void Function(Recommendation_InsightReference) updates) => super.copyWith((message) => updates(message as Recommendation_InsightReference)) as Recommendation_InsightReference; // ignore: deprecated_member_use
...
class Recommendation extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'Recommendation', package: const $pb.PackageName(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'google.cloud.recommender.v1beta1'), createEmptyInstance: create)
    ..aOS(1, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'name')
    ..aOS(2, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'description')
    ..aOM<$0.Timestamp>(4, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'lastRefreshTime', subBuilder: $0.Timestamp.create)
    ..aOM<Impact>(5, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'primaryImpact', subBuilder: Impact.create)
    ..pc<Impact>(6, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'additionalImpact', $pb.PbFieldType.PM, subBuilder: Impact.create)
    ..aOM<RecommendationContent>(7, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'content', subBuilder: RecommendationContent.create)
    ..aOM<RecommendationStateInfo>(10, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'stateInfo', subBuilder: RecommendationStateInfo.create)
    ..aOS(11, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'etag')
    ..aOS(12, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'recommenderSubtype')
    ..pc<Recommendation_InsightReference>(14, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'associatedInsights', $pb.PbFieldType.PM, subBuilder: Recommendation_InsightReference.create)
    ..e<Recommendation_Priority>(17, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'priority', $pb.PbFieldType.OE, defaultOrMaker: Recommendation_Priority.PRIORITY_UNSPECIFIED, valueOf: Recommendation_Priority.valueOf, enumValues: Recommendation_Priority.values)
    ..aOS(18, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'xorGroupId')
    ..hasRequiredFields = false
  ;
  ...
  @$pb.TagNumber(4)
  set lastRefreshTime($0.Timestamp v) { setField(4, v); }
  @$pb.TagNumber(4)
...
class RecommendationContent extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'RecommendationContent', package: const $pb.PackageName(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'google.cloud.recommender.v1beta1'), createEmptyInstance: create)
    ..pc<OperationGroup>(2, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'operationGroups', $pb.PbFieldType.PM, subBuilder: OperationGroup.create)
    ..aOM<$1.Struct>(3, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'overview', subBuilder: $1.Struct.create)
    ..hasRequiredFields = false
  ;
  ...
  'Use [GeneratedMessageGenericExtensions.rebuild] instead. '
  'Will be removed in next major version')
  RecommendationContent copyWith(void Function(RecommendationContent) updates) => super.copyWith((message) => updates(message as RecommendationContent)) as RecommendationContent; // ignore: deprecated_member_use
  $pb.BuilderInfo get info_ => _i;
  @$core.pragma('dart2js:noInline')
  ...
  @$pb.TagNumber(3)
  $1.Struct get overview => $_getN(1);
  @$pb.TagNumber(3)
  set overview($1.Struct v) { setField(3, v); }
  @$pb.TagNumber(3)
  $core.bool hasOverview() => $_has(1);
  @$pb.TagNumber(3)
  void clearOverview() => clearField(3);
  @$pb.TagNumber(3)
  $1.Struct ensureOverview() => $_ensure(1);
}

class OperationGroup extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'OperationGroup', package: const $pb.PackageName(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'google.cloud.recommender.v1beta1'), createEmptyInstance: create)
  ...
  'Use [GeneratedMessageGenericExtensions.rebuild] instead. '
  'Will be removed in next major version')
  OperationGroup copyWith(void Function(OperationGroup) updates) => super.copyWith((message) => updates(message as OperationGroup)) as OperationGroup; // ignore: deprecated_member_use
  $pb.BuilderInfo get info_ => _i;
  @$core.pragma('dart2js:noInline')
...
class Operation extends $pb.GeneratedMessage {
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'Operation', package: const $pb.PackageName(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'google.cloud.recommender.v1beta1'), createEmptyInstance: create)
    ..oo(0, [7, 10])
    ..aOS(1, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'action')
    ..aOS(2, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'resourceType')
    ...
    ..aOS(5, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'sourceResource')
    ..aOS(6, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'sourcePath')
    ..aOM<$1.Value>(7, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'value', subBuilder: $1.Value.create)
    ..m<$core.String, $1.Value>(8, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'pathFilters', entryClassName: 'Operation.PathFiltersEntry', keyFieldType: $pb.PbFieldType.OS, valueFieldType: $pb.PbFieldType.OM, valueCreator: $1.Value.create, packageName: const $pb.PackageName('google.cloud.recommender.v1beta1'))
    ..aOM<ValueMatcher>(10, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'valueMatcher', subBuilder: ValueMatcher.create)
    ..m<$core.String, ValueMatcher>(11, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'pathValueMatchers', entryClassName: 'Operation.PathValueMatchersEntry', keyFieldType: $pb.PbFieldType.OS, valueFieldType: $pb.PbFieldType.OM, valueCreator: ValueMatcher.create, packageName: const $pb.PackageName('google.cloud.recommender.v1beta1'))
    ..hasRequiredFields = false
  ;
  ...
  @$pb.TagNumber(7)
  set value($1.Value v) { setField(7, v); }
  @$pb.TagNumber(7)
...
class ValueMatcher extends $pb.GeneratedMessage {
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'ValueMatcher', package: const $pb.PackageName(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'google.cloud.recommender.v1beta1'), createEmptyInstance: create)
    ..oo(0, [1])
    ..aOS(1, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'matchesPattern')
    ..hasRequiredFields = false
  ;
  ...
  'Use [GeneratedMessageGenericExtensions.rebuild] instead. '
  'Will be removed in next major version')
  ValueMatcher copyWith(void Function(ValueMatcher) updates) => super.copyWith((message) => updates(message as ValueMatcher)) as ValueMatcher; // ignore: deprecated_member_use
  $pb.BuilderInfo get info_ => _i;
  @$core.pragma('dart2js:noInline')
...
class CostProjection extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'CostProjection', package: const $pb.PackageName(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'google.cloud.recommender.v1beta1'), createEmptyInstance: create)
    ..aOM<$2.Money>(1, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'cost', subBuilder: $2.Money.create)
  ...
  'Use [GeneratedMessageGenericExtensions.rebuild] instead. '
  'Will be removed in next major version')
  CostProjection copyWith(void Function(CostProjection) updates) => super.copyWith((message) => updates(message as CostProjection)) as CostProjection; // ignore: deprecated_member_use
  $pb.BuilderInfo get info_ => _i;
  @$core.pragma('dart2js:noInline')
  ...
  @$pb.TagNumber(1)
  set cost($2.Money v) { setField(1, v); }
  @$pb.TagNumber(1)
...
class SecurityProjection extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'SecurityProjection', package: const $pb.PackageName(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'google.cloud.recommender.v1beta1'), createEmptyInstance: create)
    ..aOM<$1.Struct>(2, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'details', subBuilder: $1.Struct.create)
    ..hasRequiredFields = false
  ;
  ...
  'Use [GeneratedMessageGenericExtensions.rebuild] instead. '
  'Will be removed in next major version')
  SecurityProjection copyWith(void Function(SecurityProjection) updates) => super.copyWith((message) => updates(message as SecurityProjection)) as SecurityProjection; // ignore: deprecated_member_use
  $pb.BuilderInfo get info_ => _i;
  @$core.pragma('dart2js:noInline')
  ...
  @$pb.TagNumber(2)
  $1.Struct get details => $_getN(0);
  @$pb.TagNumber(2)
  set details($1.Struct v) { setField(2, v); }
  @$pb.TagNumber(2)
  $core.bool hasDetails() => $_has(0);
  @$pb.TagNumber(2)
  void clearDetails() => clearField(2);
  @$pb.TagNumber(2)
  $1.Struct ensureDetails() => $_ensure(0);
}

class SustainabilityProjection extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'SustainabilityProjection', package: const $pb.PackageName(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'google.cloud.recommender.v1beta1'), createEmptyInstance: create)
    ..a<$core.double>(1, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'kgCO2e', $pb.PbFieldType.OD)
    ..aOM<$3.Duration>(2, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'duration', subBuilder: $3.Duration.create)
    ..hasRequiredFields = false
  ;
  ...
  'Use [GeneratedMessageGenericExtensions.rebuild] instead. '
  'Will be removed in next major version')
  SustainabilityProjection copyWith(void Function(SustainabilityProjection) updates) => super.copyWith((message) => updates(message as SustainabilityProjection)) as SustainabilityProjection; // ignore: deprecated_member_use
  $pb.BuilderInfo get info_ => _i;
  @$core.pragma('dart2js:noInline')
...
class Impact extends $pb.GeneratedMessage {
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'Impact', package: const $pb.PackageName(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'google.cloud.recommender.v1beta1'), createEmptyInstance: create)
    ..oo(0, [100, 101, 102])
    ..e<Impact_Category>(1, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'category', $pb.PbFieldType.OE, defaultOrMaker: Impact_Category.CATEGORY_UNSPECIFIED, valueOf: Impact_Category.valueOf, enumValues: Impact_Category.values)
    ..aOM<CostProjection>(100, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'costProjection', subBuilder: CostProjection.create)
    ..aOM<SecurityProjection>(101, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'securityProjection', subBuilder: SecurityProjection.create)
    ..aOM<SustainabilityProjection>(102, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'sustainabilityProjection', subBuilder: SustainabilityProjection.create)
    ..hasRequiredFields = false
  ;
  ...
  factory Impact({
    ...
    if (securityProjection != null) {
      _result.securityProjection = securityProjection;
    }
    if (sustainabilityProjection != null) {
      _result.sustainabilityProjection = sustainabilityProjection;
    }
    return _result;
  }
  ...
  'Use [GeneratedMessageGenericExtensions.rebuild] instead. '
  'Will be removed in next major version')
  Impact copyWith(void Function(Impact) updates) => super.copyWith((message) => updates(message as Impact)) as Impact; // ignore: deprecated_member_use
  $pb.BuilderInfo get info_ => _i;
  @$core.pragma('dart2js:noInline')
...
class RecommendationStateInfo extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'RecommendationStateInfo', package: const $pb.PackageName(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'google.cloud.recommender.v1beta1'), createEmptyInstance: create)
    ..e<RecommendationStateInfo_State>(1, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'state', $pb.PbFieldType.OE, defaultOrMaker: RecommendationStateInfo_State.STATE_UNSPECIFIED, valueOf: RecommendationStateInfo_State.valueOf, enumValues: RecommendationStateInfo_State.values)
    ..m<$core.String, $core.String>(2, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'stateMetadata', entryClassName: 'RecommendationStateInfo.StateMetadataEntry', keyFieldType: $pb.PbFieldType.OS, valueFieldType: $pb.PbFieldType.OS, packageName: const $pb.PackageName('google.cloud.recommender.v1beta1'))
    ..hasRequiredFields = false
  ;
  ...
  'Use [GeneratedMessageGenericExtensions.rebuild] instead. '
  'Will be removed in next major version')
  RecommendationStateInfo copyWith(void Function(RecommendationStateInfo) updates) => super.copyWith((message) => updates(message as RecommendationStateInfo)) as RecommendationStateInfo; // ignore: deprecated_member_use
  $pb.BuilderInfo get info_ => _i;
  @$core.pragma('dart2js:noInline')

...
class CommonOperationMetadata extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'CommonOperationMetadata', package: const $pb.PackageName(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'google.cloud.documentai.v1beta3'), createEmptyInstance: create)
    ..e<CommonOperationMetadata_State>(1, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'state', $pb.PbFieldType.OE, defaultOrMaker: CommonOperationMetadata_State.STATE_UNSPECIFIED, valueOf: CommonOperationMetadata_State.valueOf, enumValues: CommonOperationMetadata_State.values)
  ...
  'Will be removed in next major version')
  CommonOperationMetadata copyWith(void Function(CommonOperationMetadata) updates) => super.copyWith((message) => updates(message as CommonOperationMetadata)) as CommonOperationMetadata; // ignore: deprecated_member_use

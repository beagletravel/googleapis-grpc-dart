...
class ProcessorType_LocationInfo extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'ProcessorType.LocationInfo', package: const $pb.PackageName(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'google.cloud.documentai.v1beta3'), createEmptyInstance: create)
  ...
  'Will be removed in next major version')
  ProcessorType_LocationInfo copyWith(void Function(ProcessorType_LocationInfo) updates) => super.copyWith((message) => updates(message as ProcessorType_LocationInfo)) as ProcessorType_LocationInfo; // ignore: deprecated_member_use
...
class ProcessorType extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'ProcessorType', package: const $pb.PackageName(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'google.cloud.documentai.v1beta3'), createEmptyInstance: create)
    ..aOS(1, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'name')
    ..aOS(2, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'type')
    ..aOS(3, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'category')
    ..pc<ProcessorType_LocationInfo>(4, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'availableLocations', $pb.PbFieldType.PM, subBuilder: ProcessorType_LocationInfo.create)
    ..aOB(6, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'allowCreation')
    ..hasRequiredFields = false
  ;
  ...
  'Use [GeneratedMessageGenericExtensions.rebuild] instead. '
  'Will be removed in next major version')
  ProcessorType copyWith(void Function(ProcessorType) updates) => super.copyWith((message) => updates(message as ProcessorType)) as ProcessorType; // ignore: deprecated_member_use
  $pb.BuilderInfo get info_ => _i;
  @$core.pragma('dart2js:noInline')

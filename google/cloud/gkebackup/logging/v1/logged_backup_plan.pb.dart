...
class LoggedBackupPlan_RetentionPolicy extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'LoggedBackupPlan.RetentionPolicy', package: const $pb.PackageName(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'google.cloud.gkebackup.logging.v1'), createEmptyInstance: create)
  ...
  'Will be removed in next major version')
  LoggedBackupPlan_RetentionPolicy copyWith(void Function(LoggedBackupPlan_RetentionPolicy) updates) => super.copyWith((message) => updates(message as LoggedBackupPlan_RetentionPolicy)) as LoggedBackupPlan_RetentionPolicy; // ignore: deprecated_member_use
...
class LoggedBackupPlan_Schedule extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'LoggedBackupPlan.Schedule', package: const $pb.PackageName(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'google.cloud.gkebackup.logging.v1'), createEmptyInstance: create)
  ...
  'Use [GeneratedMessageGenericExtensions.rebuild] instead. '
  'Will be removed in next major version')
  LoggedBackupPlan_Schedule copyWith(void Function(LoggedBackupPlan_Schedule) updates) => super.copyWith((message) => updates(message as LoggedBackupPlan_Schedule)) as LoggedBackupPlan_Schedule; // ignore: deprecated_member_use
  $pb.BuilderInfo get info_ => _i;
  @$core.pragma('dart2js:noInline')
...
class LoggedBackupPlan_BackupConfig extends $pb.GeneratedMessage {
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'LoggedBackupPlan.BackupConfig', package: const $pb.PackageName(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'google.cloud.gkebackup.logging.v1'), createEmptyInstance: create)
    ..oo(0, [1, 2, 3])
    ..aOB(1, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'allNamespaces')
    ..aOM<$0.Namespaces>(2, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'selectedNamespaces', subBuilder: $0.Namespaces.create)
    ..aOM<$0.NamespacedNames>(3, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'selectedApplications', subBuilder: $0.NamespacedNames.create)
    ...
    ..aOM<$0.EncryptionKey>(6, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'encryptionKey', subBuilder: $0.EncryptionKey.create)
    ..hasRequiredFields = false
  ;
  ...
  'Use [GeneratedMessageGenericExtensions.rebuild] instead. '
  'Will be removed in next major version')
  LoggedBackupPlan_BackupConfig copyWith(void Function(LoggedBackupPlan_BackupConfig) updates) => super.copyWith((message) => updates(message as LoggedBackupPlan_BackupConfig)) as LoggedBackupPlan_BackupConfig; // ignore: deprecated_member_use
  $pb.BuilderInfo get info_ => _i;
  @$core.pragma('dart2js:noInline')
  ...
  @$pb.TagNumber(2)
  set selectedNamespaces($0.Namespaces v) { setField(2, v); }
  @$pb.TagNumber(2)
  ...
  @$pb.TagNumber(3)
  set selectedApplications($0.NamespacedNames v) { setField(3, v); }
  @$pb.TagNumber(3)
  ...
  @$pb.TagNumber(6)
  set encryptionKey($0.EncryptionKey v) { setField(6, v); }
  @$pb.TagNumber(6)
...
class LoggedBackupPlan extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'LoggedBackupPlan', package: const $pb.PackageName(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'google.cloud.gkebackup.logging.v1'), createEmptyInstance: create)
    ...
    ..aOM<LoggedBackupPlan_RetentionPolicy>(3, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'retentionPolicy', subBuilder: LoggedBackupPlan_RetentionPolicy.create)
    ..m<$core.String, $core.String>(4, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'labels', entryClassName: 'LoggedBackupPlan.LabelsEntry', keyFieldType: $pb.PbFieldType.OS, valueFieldType: $pb.PbFieldType.OS, packageName: const $pb.PackageName('google.cloud.gkebackup.logging.v1'))
    ..aOM<LoggedBackupPlan_Schedule>(5, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'backupSchedule', subBuilder: LoggedBackupPlan_Schedule.create)
    ..aOB(6, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'deactivated')
    ..aOM<LoggedBackupPlan_BackupConfig>(7, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'backupConfig', subBuilder: LoggedBackupPlan_BackupConfig.create)
    ..hasRequiredFields = false
  ;
  ...
  'Use [GeneratedMessageGenericExtensions.rebuild] instead. '
  'Will be removed in next major version')
  LoggedBackupPlan copyWith(void Function(LoggedBackupPlan) updates) => super.copyWith((message) => updates(message as LoggedBackupPlan)) as LoggedBackupPlan; // ignore: deprecated_member_use
  $pb.BuilderInfo get info_ => _i;
  @$core.pragma('dart2js:noInline')

...
class ChangeType extends $pb.ProtobufEnum {
  ...
  static const ChangeType CREATION = ChangeType._(1, const $core.bool.fromEnvironment('protobuf.omit_enum_names') ? '' : 'CREATION');
  static const ChangeType UPDATE = ChangeType._(2, const $core.bool.fromEnvironment('protobuf.omit_enum_names') ? '' : 'UPDATE');
  static const ChangeType DELETION = ChangeType._(3, const $core.bool.fromEnvironment('protobuf.omit_enum_names') ? '' : 'DELETION');

...
class BackupPlanChange extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'BackupPlanChange', package: const $pb.PackageName(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'google.cloud.gkebackup.logging.v1'), createEmptyInstance: create)
    ..aOS(1, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'backupPlan')
    ..e<ChangeType>(2, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'changeType', $pb.PbFieldType.OE, defaultOrMaker: ChangeType.CHANGE_TYPE_UNSPECIFIED, valueOf: ChangeType.valueOf, enumValues: ChangeType.values)
    ..aOM<$0.FieldMask>(3, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'updateMask', subBuilder: $0.FieldMask.create)
    ..aOM<$1.LoggedBackupPlan>(4, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'inputBackupPlan', subBuilder: $1.LoggedBackupPlan.create)
    ..aOM<$2.Status>(5, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'error', subBuilder: $2.Status.create)
  ...
  'Will be removed in next major version')
  BackupPlanChange copyWith(void Function(BackupPlanChange) updates) => super.copyWith((message) => updates(message as BackupPlanChange)) as BackupPlanChange; // ignore: deprecated_member_use
  ...
  @$pb.TagNumber(4)
  set inputBackupPlan($1.LoggedBackupPlan v) { setField(4, v); }
  @$pb.TagNumber(4)
  ...
  @$pb.TagNumber(5)
  set error($2.Status v) { setField(5, v); }
  @$pb.TagNumber(5)
...
class BackupChange extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'BackupChange', package: const $pb.PackageName(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'google.cloud.gkebackup.logging.v1'), createEmptyInstance: create)
    ...
    ..aOM<$3.LoggedBackup>(5, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'inputBackup', subBuilder: $3.LoggedBackup.create)
    ..aOM<$2.Status>(6, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'error', subBuilder: $2.Status.create)
    ..hasRequiredFields = false
  ;
  ...
  'Use [GeneratedMessageGenericExtensions.rebuild] instead. '
  'Will be removed in next major version')
  BackupChange copyWith(void Function(BackupChange) updates) => super.copyWith((message) => updates(message as BackupChange)) as BackupChange; // ignore: deprecated_member_use
  $pb.BuilderInfo get info_ => _i;
  @$core.pragma('dart2js:noInline')
  ...
  @$pb.TagNumber(5)
  set inputBackup($3.LoggedBackup v) { setField(5, v); }
  @$pb.TagNumber(5)
  ...
  @$pb.TagNumber(6)
  set error($2.Status v) { setField(6, v); }
  @$pb.TagNumber(6)
...
class RestorePlanChange extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'RestorePlanChange', package: const $pb.PackageName(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'google.cloud.gkebackup.logging.v1'), createEmptyInstance: create)
    ..aOS(1, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'restorePlan')
    ..e<ChangeType>(2, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'changeType', $pb.PbFieldType.OE, defaultOrMaker: ChangeType.CHANGE_TYPE_UNSPECIFIED, valueOf: ChangeType.valueOf, enumValues: ChangeType.values)
    ..aOM<$0.FieldMask>(3, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'updateMask', subBuilder: $0.FieldMask.create)
    ..aOM<$4.LoggedRestorePlan>(4, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'inputRestorePlan', subBuilder: $4.LoggedRestorePlan.create)
    ..aOM<$2.Status>(5, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'error', subBuilder: $2.Status.create)
    ..hasRequiredFields = false
  ;
  ...
  'Use [GeneratedMessageGenericExtensions.rebuild] instead. '
  'Will be removed in next major version')
  RestorePlanChange copyWith(void Function(RestorePlanChange) updates) => super.copyWith((message) => updates(message as RestorePlanChange)) as RestorePlanChange; // ignore: deprecated_member_use
  $pb.BuilderInfo get info_ => _i;
  @$core.pragma('dart2js:noInline')
  ...
  @$pb.TagNumber(4)
  set inputRestorePlan($4.LoggedRestorePlan v) { setField(4, v); }
  @$pb.TagNumber(4)
...
class RestoreChange extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'RestoreChange', package: const $pb.PackageName(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'google.cloud.gkebackup.logging.v1'), createEmptyInstance: create)
    ..aOS(1, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'restore')
    ..e<ChangeType>(2, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'changeType', $pb.PbFieldType.OE, defaultOrMaker: ChangeType.CHANGE_TYPE_UNSPECIFIED, valueOf: ChangeType.valueOf, enumValues: ChangeType.values)
    ..aOM<$0.FieldMask>(3, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'updateMask', subBuilder: $0.FieldMask.create)
    ..aOM<$5.LoggedRestore>(4, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'inputRestore', subBuilder: $5.LoggedRestore.create)
    ..aOM<$2.Status>(5, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'error', subBuilder: $2.Status.create)
    ..hasRequiredFields = false
  ;
  ...
  'Use [GeneratedMessageGenericExtensions.rebuild] instead. '
  'Will be removed in next major version')
  RestoreChange copyWith(void Function(RestoreChange) updates) => super.copyWith((message) => updates(message as RestoreChange)) as RestoreChange; // ignore: deprecated_member_use
  $pb.BuilderInfo get info_ => _i;
  @$core.pragma('dart2js:noInline')
  ...
  @$pb.TagNumber(4)
  set inputRestore($5.LoggedRestore v) { setField(4, v); }
  @$pb.TagNumber(4)

...
class DatastreamClient extends $grpc.Client {
  ...
  static final _$createConnectionProfile =
      $grpc.ClientMethod<$2.CreateConnectionProfileRequest, $0.Operation>(
  ...
  static final _$updateConnectionProfile =
      $grpc.ClientMethod<$2.UpdateConnectionProfileRequest, $0.Operation>(
          '/google.cloud.datastream.v1.Datastream/UpdateConnectionProfile',
          ($2.UpdateConnectionProfileRequest value) => value.writeToBuffer(),
          ($core.List<$core.int> value) => $0.Operation.fromBuffer(value));
  static final _$deleteConnectionProfile =
      $grpc.ClientMethod<$2.DeleteConnectionProfileRequest, $0.Operation>(
  ...
  static final _$deleteStream =
      $grpc.ClientMethod<$2.DeleteStreamRequest, $0.Operation>(
          ...
          ($core.List<$core.int> value) => $0.Operation.fromBuffer(value));
  static final _$getStreamObject =
      $grpc.ClientMethod<$2.GetStreamObjectRequest, $3.StreamObject>(
          '/google.cloud.datastream.v1.Datastream/GetStreamObject',
          ($2.GetStreamObjectRequest value) => value.writeToBuffer(),
          ($core.List<$core.int> value) => $3.StreamObject.fromBuffer(value));
  static final _$lookupStreamObject =
      $grpc.ClientMethod<$2.LookupStreamObjectRequest, $3.StreamObject>(
          '/google.cloud.datastream.v1.Datastream/LookupStreamObject',
          ($2.LookupStreamObjectRequest value) => value.writeToBuffer(),
          ($core.List<$core.int> value) => $3.StreamObject.fromBuffer(value));
  static final _$listStreamObjects = $grpc.ClientMethod<
          $2.ListStreamObjectsRequest, $2.ListStreamObjectsResponse>(
      '/google.cloud.datastream.v1.Datastream/ListStreamObjects',
      ($2.ListStreamObjectsRequest value) => value.writeToBuffer(),
      ($core.List<$core.int> value) =>
          $2.ListStreamObjectsResponse.fromBuffer(value));
  static final _$startBackfillJob = $grpc.ClientMethod<
          $2.StartBackfillJobRequest, $2.StartBackfillJobResponse>(
      '/google.cloud.datastream.v1.Datastream/StartBackfillJob',
      ($2.StartBackfillJobRequest value) => value.writeToBuffer(),
      ($core.List<$core.int> value) =>
          $2.StartBackfillJobResponse.fromBuffer(value));
  static final _$stopBackfillJob =
      $grpc.ClientMethod<$2.StopBackfillJobRequest, $2.StopBackfillJobResponse>(
          '/google.cloud.datastream.v1.Datastream/StopBackfillJob',
          ($2.StopBackfillJobRequest value) => value.writeToBuffer(),
          ($core.List<$core.int> value) =>
              $2.StopBackfillJobResponse.fromBuffer(value));
  ...
  static final _$createPrivateConnection =
      $grpc.ClientMethod<$2.CreatePrivateConnectionRequest, $0.Operation>(
  ...
  static final _$deletePrivateConnection =
      $grpc.ClientMethod<$2.DeletePrivateConnectionRequest, $0.Operation>(
  ...
  $grpc.ResponseFuture<$3.StreamObject> getStreamObject(
      $2.GetStreamObjectRequest request,
      {$grpc.CallOptions? options}) {
    return $createUnaryCall(_$getStreamObject, request, options: options);
  }

  $grpc.ResponseFuture<$3.StreamObject> lookupStreamObject(
      $2.LookupStreamObjectRequest request,
      {$grpc.CallOptions? options}) {
    return $createUnaryCall(_$lookupStreamObject, request, options: options);
  }

  $grpc.ResponseFuture<$2.ListStreamObjectsResponse> listStreamObjects(
      $2.ListStreamObjectsRequest request,
      {$grpc.CallOptions? options}) {
    return $createUnaryCall(_$listStreamObjects, request, options: options);
  }

  $grpc.ResponseFuture<$2.StartBackfillJobResponse> startBackfillJob(
      $2.StartBackfillJobRequest request,
      {$grpc.CallOptions? options}) {
    return $createUnaryCall(_$startBackfillJob, request, options: options);
  }

  $grpc.ResponseFuture<$2.StopBackfillJobResponse> stopBackfillJob(
      $2.StopBackfillJobRequest request,
      {$grpc.CallOptions? options}) {
...
abstract class DatastreamServiceBase extends $grpc.Service {
  ...
  DatastreamServiceBase() {
    ...
    $addMethod($grpc.ServiceMethod<$2.DeleteStreamRequest, $0.Operation>(
        ...
        ($0.Operation value) => value.writeToBuffer()));
    $addMethod($grpc.ServiceMethod<$2.GetStreamObjectRequest, $3.StreamObject>(
        'GetStreamObject',
        getStreamObject_Pre,
        false,
        false,
        ($core.List<$core.int> value) =>
            $2.GetStreamObjectRequest.fromBuffer(value),
        ($3.StreamObject value) => value.writeToBuffer()));
    $addMethod(
        $grpc.ServiceMethod<$2.LookupStreamObjectRequest, $3.StreamObject>(
            'LookupStreamObject',
            lookupStreamObject_Pre,
            false,
            false,
            ($core.List<$core.int> value) =>
                $2.LookupStreamObjectRequest.fromBuffer(value),
            ($3.StreamObject value) => value.writeToBuffer()));
    $addMethod($grpc.ServiceMethod<$2.ListStreamObjectsRequest,
            $2.ListStreamObjectsResponse>(
        'ListStreamObjects',
        listStreamObjects_Pre,
        false,
        false,
        ($core.List<$core.int> value) =>
            $2.ListStreamObjectsRequest.fromBuffer(value),
        ($2.ListStreamObjectsResponse value) => value.writeToBuffer()));
    $addMethod($grpc.ServiceMethod<$2.StartBackfillJobRequest,
            $2.StartBackfillJobResponse>(
        'StartBackfillJob',
        startBackfillJob_Pre,
        false,
        false,
        ($core.List<$core.int> value) =>
            $2.StartBackfillJobRequest.fromBuffer(value),
        ($2.StartBackfillJobResponse value) => value.writeToBuffer()));
    $addMethod($grpc.ServiceMethod<$2.StopBackfillJobRequest,
            $2.StopBackfillJobResponse>(
        'StopBackfillJob',
        stopBackfillJob_Pre,
        false,
        false,
        ($core.List<$core.int> value) =>
            $2.StopBackfillJobRequest.fromBuffer(value),
        ($2.StopBackfillJobResponse value) => value.writeToBuffer()));
  ...
  $async.Future<$3.StreamObject> getStreamObject_Pre($grpc.ServiceCall call,
      $async.Future<$2.GetStreamObjectRequest> request) async {
    return getStreamObject(call, await request);
  }

  $async.Future<$3.StreamObject> lookupStreamObject_Pre($grpc.ServiceCall call,
      $async.Future<$2.LookupStreamObjectRequest> request) async {
    return lookupStreamObject(call, await request);
  }

  $async.Future<$2.ListStreamObjectsResponse> listStreamObjects_Pre(
      $grpc.ServiceCall call,
      $async.Future<$2.ListStreamObjectsRequest> request) async {
    return listStreamObjects(call, await request);
  }

  $async.Future<$2.StartBackfillJobResponse> startBackfillJob_Pre(
      $grpc.ServiceCall call,
      $async.Future<$2.StartBackfillJobRequest> request) async {
    return startBackfillJob(call, await request);
  }

  $async.Future<$2.StopBackfillJobResponse> stopBackfillJob_Pre(
      $grpc.ServiceCall call,
      $async.Future<$2.StopBackfillJobRequest> request) async {
  ...
  $async.Future<$3.StreamObject> getStreamObject(
      $grpc.ServiceCall call, $2.GetStreamObjectRequest request);
  $async.Future<$3.StreamObject> lookupStreamObject(
      $grpc.ServiceCall call, $2.LookupStreamObjectRequest request);
  $async.Future<$2.ListStreamObjectsResponse> listStreamObjects(
      $grpc.ServiceCall call, $2.ListStreamObjectsRequest request);
  $async.Future<$2.StartBackfillJobResponse> startBackfillJob(
      $grpc.ServiceCall call, $2.StartBackfillJobRequest request);
  $async.Future<$2.StopBackfillJobResponse> stopBackfillJob(
      $grpc.ServiceCall call, $2.StopBackfillJobRequest request);

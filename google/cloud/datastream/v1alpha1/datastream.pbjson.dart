...
const DiscoverConnectionProfileRequest$json = const {
  ...
  '2': const [
    ...
    const {'1': 'connection_profile', '3': 200, '4': 1, '5': 11, '6': '.google.cloud.datastream.v1alpha1.ConnectionProfile', '9': 0, '10': 'connectionProfile'},
    const {'1': 'connection_profile_name', '3': 201, '4': 1, '5': 9, '9': 0, '10': 'connectionProfileName'},
    const {'1': 'recursive', '3': 3, '4': 1, '5': 8, '9': 1, '10': 'recursive'},
    const {'1': 'recursion_depth', '3': 4, '4': 1, '5': 5, '9': 1, '10': 'recursionDepth'},
    const {'1': 'oracle_rdbms', '3': 100, '4': 1, '5': 11, '6': '.google.cloud.datastream.v1alpha1.OracleRdbms', '9': 2, '10': 'oracleRdbms'},
    const {'1': 'mysql_rdbms', '3': 101, '4': 1, '5': 11, '6': '.google.cloud.datastream.v1alpha1.MysqlRdbms', '9': 2, '10': 'mysqlRdbms'},
  ],
  '8': const [
    const {'1': 'target'},
    const {'1': 'depth'},
...
final $typed_data.Uint8List discoverConnectionProfileRequestDescriptor = $convert.base64Decode('');
...
const DiscoverConnectionProfileResponse$json = const {
  ...
  '2': const [
    const {'1': 'oracle_rdbms', '3': 100, '4': 1, '5': 11, '6': '.google.cloud.datastream.v1alpha1.OracleRdbms', '9': 0, '10': 'oracleRdbms'},
    const {'1': 'mysql_rdbms', '3': 101, '4': 1, '5': 11, '6': '.google.cloud.datastream.v1alpha1.MysqlRdbms', '9': 0, '10': 'mysqlRdbms'},
  ],
  '8': const [
    const {'1': 'data_object'},
  ],
...
final $typed_data.Uint8List discoverConnectionProfileResponseDescriptor = $convert.base64Decode('');
...
const FetchErrorsRequest$json = const {
  ...
  '2': const [
    const {'1': 'stream', '3': 1, '4': 1, '5': 9, '8': const {}, '10': 'stream'},
  ],
};

/// Descriptor for `FetchErrorsRequest`. Decode as a `google.protobuf.DescriptorProto`.
final $typed_data.Uint8List fetchErrorsRequestDescriptor = $convert.base64Decode('ChJGZXRjaEVycm9yc1JlcXVlc3QSPQoGc3RyZWFtGAEgASgJQiX6QSIKIGRhdGFzdHJlYW0uZ29vZ2xlYXBpcy5jb20vU3RyZWFtUgZzdHJlYW0=');
@$core.Deprecated('Use fetchErrorsResponseDescriptor instead')
const FetchErrorsResponse$json = const {
  '1': 'FetchErrorsResponse',
  '2': const [
    const {'1': 'errors', '3': 1, '4': 3, '5': 11, '6': '.google.cloud.datastream.v1alpha1.Error', '10': 'errors'},
  ],
};

/// Descriptor for `FetchErrorsResponse`. Decode as a `google.protobuf.DescriptorProto`.
final $typed_data.Uint8List fetchErrorsResponseDescriptor = $convert.base64Decode('ChNGZXRjaEVycm9yc1Jlc3BvbnNlEj8KBmVycm9ycxgBIAMoCzInLmdvb2dsZS5jbG91ZC5kYXRhc3RyZWFtLnYxYWxwaGExLkVycm9yUgZlcnJvcnM=');
...
const ListConnectionProfilesResponse$json = const {
  ...
  '2': const [
    const {'1': 'connection_profiles', '3': 1, '4': 3, '5': 11, '6': '.google.cloud.datastream.v1alpha1.ConnectionProfile', '10': 'connectionProfiles'},
    const {'1': 'next_page_token', '3': 2, '4': 1, '5': 9, '10': 'nextPageToken'},
...
final $typed_data.Uint8List listConnectionProfilesResponseDescriptor = $convert.base64Decode('');
...
const CreateConnectionProfileRequest$json = const {
  ...
  '2': const [
    ...
    const {'1': 'connection_profile', '3': 3, '4': 1, '5': 11, '6': '.google.cloud.datastream.v1alpha1.ConnectionProfile', '8': const {}, '10': 'connectionProfile'},
...
const UpdateConnectionProfileRequest$json = const {
  ...
  '2': const [
    ...
    const {'1': 'connection_profile', '3': 2, '4': 1, '5': 11, '6': '.google.cloud.datastream.v1alpha1.ConnectionProfile', '8': const {}, '10': 'connectionProfile'},
...
final $typed_data.Uint8List updateConnectionProfileRequestDescriptor = $convert.base64Decode('');
...
const ListStreamsResponse$json = const {
  ...
  '2': const [
    const {'1': 'streams', '3': 1, '4': 3, '5': 11, '6': '.google.cloud.datastream.v1alpha1.Stream', '10': 'streams'},
    const {'1': 'next_page_token', '3': 2, '4': 1, '5': 9, '10': 'nextPageToken'},
    const {'1': 'unreachable', '3': 3, '4': 3, '5': 9, '10': 'unreachable'},
  ],
};
...
final $typed_data.Uint8List listStreamsResponseDescriptor = $convert.base64Decode('ChNMaXN0U3RyZWFtc1Jlc3BvbnNlEkIKB3N0cmVhbXMYASADKAsyKC5nb29nbGUuY2xvdWQuZGF0YXN0cmVhbS52MWFscGhhMS5TdHJlYW1SB3N0cmVhbXMSJgoPbmV4dF9wYWdlX3Rva2VuGAIgASgJUg1uZXh0UGFnZVRva2VuEiAKC3VucmVhY2hhYmxlGAMgAygJUgt1bnJlYWNoYWJsZQ==');
...
const CreateStreamRequest$json = const {
  ...
  '2': const [
    ...
    const {'1': 'stream', '3': 3, '4': 1, '5': 11, '6': '.google.cloud.datastream.v1alpha1.Stream', '8': const {}, '10': 'stream'},
    const {'1': 'request_id', '3': 4, '4': 1, '5': 9, '8': const {}, '10': 'requestId'},
...
const UpdateStreamRequest$json = const {
  ...
  '2': const [
    const {'1': 'update_mask', '3': 1, '4': 1, '5': 11, '6': '.google.protobuf.FieldMask', '8': const {}, '10': 'updateMask'},
    const {'1': 'stream', '3': 2, '4': 1, '5': 11, '6': '.google.cloud.datastream.v1alpha1.Stream', '8': const {}, '10': 'stream'},
    const {'1': 'request_id', '3': 3, '4': 1, '5': 9, '8': const {}, '10': 'requestId'},
...
final $typed_data.Uint8List updateStreamRequestDescriptor = $convert.base64Decode('');
...
const OperationMetadata$json = const {
  ...
  '2': const [
    ...
    const {'1': 'validation_result', '3': 8, '4': 1, '5': 11, '6': '.google.cloud.datastream.v1alpha1.ValidationResult', '8': const {}, '10': 'validationResult'},
  ],
};
...
const CreatePrivateConnectionRequest$json = const {
  ...
  '2': const [
    ...
    const {'1': 'private_connection', '3': 3, '4': 1, '5': 11, '6': '.google.cloud.datastream.v1alpha1.PrivateConnection', '8': const {}, '10': 'privateConnection'},
    const {'1': 'request_id', '3': 4, '4': 1, '5': 9, '8': const {}, '10': 'requestId'},
  ],
};
...
const ListPrivateConnectionsResponse$json = const {
  ...
  '2': const [
    const {'1': 'private_connections', '3': 1, '4': 3, '5': 11, '6': '.google.cloud.datastream.v1alpha1.PrivateConnection', '10': 'privateConnections'},
    const {'1': 'next_page_token', '3': 2, '4': 1, '5': 9, '10': 'nextPageToken'},
    const {'1': 'unreachable', '3': 3, '4': 3, '5': 9, '10': 'unreachable'},
  ],
};
...
final $typed_data.Uint8List listPrivateConnectionsResponseDescriptor = $convert.base64Decode('');
...
const CreateRouteRequest$json = const {
  ...
  '2': const [
    ...
    const {'1': 'route', '3': 3, '4': 1, '5': 11, '6': '.google.cloud.datastream.v1alpha1.Route', '8': const {}, '10': 'route'},
    const {'1': 'request_id', '3': 4, '4': 1, '5': 9, '8': const {}, '10': 'requestId'},
  ],
};

/// Descriptor for `CreateRouteRequest`. Decode as a `google.protobuf.DescriptorProto`.
final $typed_data.Uint8List createRouteRequestDescriptor = $convert.base64Decode('');
...
const ListRoutesResponse$json = const {
  ...
  '2': const [
    const {'1': 'routes', '3': 1, '4': 3, '5': 11, '6': '.google.cloud.datastream.v1alpha1.Route', '10': 'routes'},
    const {'1': 'next_page_token', '3': 2, '4': 1, '5': 9, '10': 'nextPageToken'},
    const {'1': 'unreachable', '3': 3, '4': 3, '5': 9, '10': 'unreachable'},
  ],
};
...
final $typed_data.Uint8List listRoutesResponseDescriptor = $convert.base64Decode('ChJMaXN0Um91dGVzUmVzcG9uc2USPwoGcm91dGVzGAEgAygLMicuZ29vZ2xlLmNsb3VkLmRhdGFzdHJlYW0udjFhbHBoYTEuUm91dGVSBnJvdXRlcxImCg9uZXh0X3BhZ2VfdG9rZW4YAiABKAlSDW5leHRQYWdlVG9rZW4SIAoLdW5yZWFjaGFibGUYAyADKAlSC3VucmVhY2hhYmxl');

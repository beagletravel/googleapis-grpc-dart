...
class GcsFileFormat extends $pb.ProtobufEnum {
  static const GcsFileFormat GCS_FILE_FORMAT_UNSPECIFIED = GcsFileFormat._(0, const $core.bool.fromEnvironment('protobuf.omit_enum_names') ? '' : 'GCS_FILE_FORMAT_UNSPECIFIED');
  static const GcsFileFormat AVRO = GcsFileFormat._(1, const $core.bool.fromEnvironment('protobuf.omit_enum_names') ? '' : 'AVRO');
...
class SchemaFileFormat extends $pb.ProtobufEnum {
  static const SchemaFileFormat SCHEMA_FILE_FORMAT_UNSPECIFIED = SchemaFileFormat._(0, const $core.bool.fromEnvironment('protobuf.omit_enum_names') ? '' : 'SCHEMA_FILE_FORMAT_UNSPECIFIED');
  static const SchemaFileFormat NO_SCHEMA_FILE = SchemaFileFormat._(1, const $core.bool.fromEnvironment('protobuf.omit_enum_names') ? '' : 'NO_SCHEMA_FILE');
  static const SchemaFileFormat AVRO_SCHEMA_FILE = SchemaFileFormat._(2, const $core.bool.fromEnvironment('protobuf.omit_enum_names') ? '' : 'AVRO_SCHEMA_FILE');
...
class Stream_State extends $pb.ProtobufEnum {
  ...
  static const Stream_State CREATED = Stream_State._(1, const $core.bool.fromEnvironment('protobuf.omit_enum_names') ? '' : 'CREATED');
...
class Validation_Status extends $pb.ProtobufEnum {
  static const Validation_Status STATUS_UNSPECIFIED = Validation_Status._(0, const $core.bool.fromEnvironment('protobuf.omit_enum_names') ? '' : 'STATUS_UNSPECIFIED');
  static const Validation_Status NOT_EXECUTED = Validation_Status._(1, const $core.bool.fromEnvironment('protobuf.omit_enum_names') ? '' : 'NOT_EXECUTED');
  static const Validation_Status FAILED = Validation_Status._(2, const $core.bool.fromEnvironment('protobuf.omit_enum_names') ? '' : 'FAILED');
  static const Validation_Status PASSED = Validation_Status._(3, const $core.bool.fromEnvironment('protobuf.omit_enum_names') ? '' : 'PASSED');

...
final $typed_data.Uint8List operationTypeDescriptor = $convert.base64Decode('Cg1PcGVyYXRpb25UeXBlEhkKFU9QRVJBVElPTl9VTlNQRUNJRklFRBAAEhMKD0NSRUFURV9GVU5DVElPThABEhMKD1VQREFURV9GVU5DVElPThACEhMKD0RFTEVURV9GVU5DVElPThAD');
...
const OperationMetadataV1$json = const {
  ...
  '2': const [
    ...
    const {'1': 'type', '3': 2, '4': 1, '5': 14, '6': '.google.cloud.functions.v1.OperationType', '10': 'type'},
...
final $typed_data.Uint8List operationMetadataV1Descriptor = $convert.base64Decode('');

...
final $typed_data.Uint8List cloudFunctionStatusDescriptor = $convert.base64Decode('ChNDbG91ZEZ1bmN0aW9uU3RhdHVzEiUKIUNMT1VEX0ZVTkNUSU9OX1NUQVRVU19VTlNQRUNJRklFRBAAEgoKBkFDVElWRRABEgsKB09GRkxJTkUQAhIWChJERVBMT1lfSU5fUFJPR1JFU1MQAxIWChJERUxFVEVfSU5fUFJPR1JFU1MQBBILCgdVTktOT1dOEAU=');
...
const CloudFunction$json = const {
  ...
  '2': const [
    ...
    const {'1': 'source_archive_url', '3': 3, '4': 1, '5': 9, '9': 0, '10': 'sourceArchiveUrl'},
    const {'1': 'source_repository', '3': 4, '4': 1, '5': 11, '6': '.google.cloud.functions.v1.SourceRepository', '9': 0, '10': 'sourceRepository'},
    const {'1': 'source_upload_url', '3': 16, '4': 1, '5': 9, '9': 0, '10': 'sourceUploadUrl'},
    const {'1': 'https_trigger', '3': 5, '4': 1, '5': 11, '6': '.google.cloud.functions.v1.HttpsTrigger', '9': 1, '10': 'httpsTrigger'},
    const {'1': 'event_trigger', '3': 6, '4': 1, '5': 11, '6': '.google.cloud.functions.v1.EventTrigger', '9': 1, '10': 'eventTrigger'},
    const {'1': 'status', '3': 7, '4': 1, '5': 14, '6': '.google.cloud.functions.v1.CloudFunctionStatus', '8': const {}, '10': 'status'},
    const {'1': 'entry_point', '3': 8, '4': 1, '5': 9, '10': 'entryPoint'},
    const {'1': 'runtime', '3': 19, '4': 1, '5': 9, '10': 'runtime'},
    const {'1': 'timeout', '3': 9, '4': 1, '5': 11, '6': '.google.protobuf.Duration', '10': 'timeout'},
    const {'1': 'available_memory_mb', '3': 10, '4': 1, '5': 5, '10': 'availableMemoryMb'},
    const {'1': 'service_account_email', '3': 11, '4': 1, '5': 9, '10': 'serviceAccountEmail'},
    const {'1': 'update_time', '3': 12, '4': 1, '5': 11, '6': '.google.protobuf.Timestamp', '8': const {}, '10': 'updateTime'},
    const {'1': 'version_id', '3': 14, '4': 1, '5': 3, '8': const {}, '10': 'versionId'},
    const {'1': 'labels', '3': 15, '4': 3, '5': 11, '6': '.google.cloud.functions.v1.CloudFunction.LabelsEntry', '10': 'labels'},
    const {'1': 'environment_variables', '3': 17, '4': 3, '5': 11, '6': '.google.cloud.functions.v1.CloudFunction.EnvironmentVariablesEntry', '10': 'environmentVariables'},
    const {'1': 'build_environment_variables', '3': 28, '4': 3, '5': 11, '6': '.google.cloud.functions.v1.CloudFunction.BuildEnvironmentVariablesEntry', '10': 'buildEnvironmentVariables'},
    ...
    const {'1': 'vpc_connector_egress_settings', '3': 23, '4': 1, '5': 14, '6': '.google.cloud.functions.v1.CloudFunction.VpcConnectorEgressSettings', '10': 'vpcConnectorEgressSettings'},
    const {'1': 'ingress_settings', '3': 24, '4': 1, '5': 14, '6': '.google.cloud.functions.v1.CloudFunction.IngressSettings', '10': 'ingressSettings'},
    const {'1': 'kms_key_name', '3': 25, '4': 1, '5': 9, '8': const {}, '10': 'kmsKeyName'},
    const {'1': 'build_worker_pool', '3': 26, '4': 1, '5': 9, '10': 'buildWorkerPool'},
    const {'1': 'build_id', '3': 27, '4': 1, '5': 9, '8': const {}, '10': 'buildId'},
    const {'1': 'build_name', '3': 33, '4': 1, '5': 9, '8': const {}, '10': 'buildName'},
    const {'1': 'secret_environment_variables', '3': 29, '4': 3, '5': 11, '6': '.google.cloud.functions.v1.SecretEnvVar', '10': 'secretEnvironmentVariables'},
    const {'1': 'secret_volumes', '3': 30, '4': 3, '5': 11, '6': '.google.cloud.functions.v1.SecretVolume', '10': 'secretVolumes'},
    const {'1': 'source_token', '3': 31, '4': 1, '5': 9, '8': const {}, '10': 'sourceToken'},
    const {'1': 'docker_repository', '3': 34, '4': 1, '5': 9, '8': const {}, '10': 'dockerRepository'},
  ],
  '3': const [CloudFunction_LabelsEntry$json, CloudFunction_EnvironmentVariablesEntry$json, CloudFunction_BuildEnvironmentVariablesEntry$json],
  '4': const [CloudFunction_VpcConnectorEgressSettings$json, CloudFunction_IngressSettings$json],
  '7': const {},
  '8': const [
    const {'1': 'source_code'},
    const {'1': 'trigger'},
...
final $typed_data.Uint8List httpsTriggerDescriptor = $convert.base64Decode('');
...
const EventTrigger$json = const {
  ...
  '2': const [
    ...
    const {'1': 'failure_policy', '3': 5, '4': 1, '5': 11, '6': '.google.cloud.functions.v1.FailurePolicy', '10': 'failurePolicy'},
  ],
};

/// Descriptor for `EventTrigger`. Decode as a `google.protobuf.DescriptorProto`.
final $typed_data.Uint8List eventTriggerDescriptor = $convert.base64Decode('CgxFdmVudFRyaWdnZXISHQoKZXZlbnRfdHlwZRgBIAEoCVIJZXZlbnRUeXBlEhoKCHJlc291cmNlGAIgASgJUghyZXNvdXJjZRIYCgdzZXJ2aWNlGAMgASgJUgdzZXJ2aWNlEk8KDmZhaWx1cmVfcG9saWN5GAUgASgLMiguZ29vZ2xlLmNsb3VkLmZ1bmN0aW9ucy52MS5GYWlsdXJlUG9saWN5Ug1mYWlsdXJlUG9saWN5');
@$core.Deprecated('Use failurePolicyDescriptor instead')
const FailurePolicy$json = const {
  '1': 'FailurePolicy',
  '2': const [
    const {'1': 'retry', '3': 1, '4': 1, '5': 11, '6': '.google.cloud.functions.v1.FailurePolicy.Retry', '9': 0, '10': 'retry'},
  ],
...
final $typed_data.Uint8List failurePolicyDescriptor = $convert.base64Decode('Cg1GYWlsdXJlUG9saWN5EkYKBXJldHJ5GAEgASgLMi4uZ29vZ2xlLmNsb3VkLmZ1bmN0aW9ucy52MS5GYWlsdXJlUG9saWN5LlJldHJ5SABSBXJldHJ5GgcKBVJldHJ5QggKBmFjdGlvbg==');
...
final $typed_data.Uint8List secretEnvVarDescriptor = $convert.base64Decode('CgxTZWNyZXRFbnZWYXISEAoDa2V5GAEgASgJUgNrZXkSHQoKcHJvamVjdF9pZBgCIAEoCVIJcHJvamVjdElkEhYKBnNlY3JldBgDIAEoCVIGc2VjcmV0EhgKB3ZlcnNpb24YBCABKAlSB3ZlcnNpb24=');
...
const SecretVolume$json = const {
  ...
  '2': const [
    ...
    const {'1': 'project_id', '3': 2, '4': 1, '5': 9, '10': 'projectId'},
    const {'1': 'secret', '3': 3, '4': 1, '5': 9, '10': 'secret'},
    const {'1': 'versions', '3': 4, '4': 3, '5': 11, '6': '.google.cloud.functions.v1.SecretVolume.SecretVersion', '10': 'versions'},
  ],
...
final $typed_data.Uint8List secretVolumeDescriptor = $convert.base64Decode('');
...
const CreateFunctionRequest$json = const {
  ...
  '2': const [
    ...
    const {'1': 'function', '3': 2, '4': 1, '5': 11, '6': '.google.cloud.functions.v1.CloudFunction', '8': const {}, '10': 'function'},
  ],
};

/// Descriptor for `CreateFunctionRequest`. Decode as a `google.protobuf.DescriptorProto`.
final $typed_data.Uint8List createFunctionRequestDescriptor = $convert.base64Decode('ChVDcmVhdGVGdW5jdGlvblJlcXVlc3QSRQoIbG9jYXRpb24YASABKAlCKeBBAvpBIwohbG9jYXRpb25zLmdvb2dsZWFwaXMuY29tL0xvY2F0aW9uUghsb2NhdGlvbhJJCghmdW5jdGlvbhgCIAEoCzIoLmdvb2dsZS5jbG91ZC5mdW5jdGlvbnMudjEuQ2xvdWRGdW5jdGlvbkID4EECUghmdW5jdGlvbg==');
@$core.Deprecated('Use updateFunctionRequestDescriptor instead')
const UpdateFunctionRequest$json = const {
  '1': 'UpdateFunctionRequest',
  '2': const [
    const {'1': 'function', '3': 1, '4': 1, '5': 11, '6': '.google.cloud.functions.v1.CloudFunction', '8': const {}, '10': 'function'},
    const {'1': 'update_mask', '3': 2, '4': 1, '5': 11, '6': '.google.protobuf.FieldMask', '10': 'updateMask'},
  ],
};

/// Descriptor for `UpdateFunctionRequest`. Decode as a `google.protobuf.DescriptorProto`.
final $typed_data.Uint8List updateFunctionRequestDescriptor = $convert.base64Decode('ChVVcGRhdGVGdW5jdGlvblJlcXVlc3QSSQoIZnVuY3Rpb24YASABKAsyKC5nb29nbGUuY2xvdWQuZnVuY3Rpb25zLnYxLkNsb3VkRnVuY3Rpb25CA+BBAlIIZnVuY3Rpb24SOwoLdXBkYXRlX21hc2sYAiABKAsyGi5nb29nbGUucHJvdG9idWYuRmllbGRNYXNrUgp1cGRhdGVNYXNr');
...
final $typed_data.Uint8List getFunctionRequestDescriptor = $convert.base64Decode('ChJHZXRGdW5jdGlvblJlcXVlc3QSRwoEbmFtZRgBIAEoCUIz4EEC+kEtCitjbG91ZGZ1bmN0aW9ucy5nb29nbGVhcGlzLmNvbS9DbG91ZEZ1bmN0aW9uUgRuYW1l');
...
final $typed_data.Uint8List listFunctionsRequestDescriptor = $convert.base64Decode('ChRMaXN0RnVuY3Rpb25zUmVxdWVzdBI+CgZwYXJlbnQYASABKAlCJvpBIwohbG9jYXRpb25zLmdvb2dsZWFwaXMuY29tL0xvY2F0aW9uUgZwYXJlbnQSGwoJcGFnZV9zaXplGAIgASgFUghwYWdlU2l6ZRIdCgpwYWdlX3Rva2VuGAMgASgJUglwYWdlVG9rZW4=');
@$core.Deprecated('Use listFunctionsResponseDescriptor instead')
const ListFunctionsResponse$json = const {
  '1': 'ListFunctionsResponse',
  '2': const [
    const {'1': 'functions', '3': 1, '4': 3, '5': 11, '6': '.google.cloud.functions.v1.CloudFunction', '10': 'functions'},
...
final $typed_data.Uint8List listFunctionsResponseDescriptor = $convert.base64Decode('ChVMaXN0RnVuY3Rpb25zUmVzcG9uc2USRgoJZnVuY3Rpb25zGAEgAygLMiguZ29vZ2xlLmNsb3VkLmZ1bmN0aW9ucy52MS5DbG91ZEZ1bmN0aW9uUglmdW5jdGlvbnMSJgoPbmV4dF9wYWdlX3Rva2VuGAIgASgJUg1uZXh0UGFnZVRva2VuEiAKC3VucmVhY2hhYmxlGAMgAygJUgt1bnJlYWNoYWJsZQ==');
...
final $typed_data.Uint8List deleteFunctionRequestDescriptor = $convert.base64Decode('ChVEZWxldGVGdW5jdGlvblJlcXVlc3QSRwoEbmFtZRgBIAEoCUIz4EEC+kEtCitjbG91ZGZ1bmN0aW9ucy5nb29nbGVhcGlzLmNvbS9DbG91ZEZ1bmN0aW9uUgRuYW1l');
...
final $typed_data.Uint8List callFunctionRequestDescriptor = $convert.base64Decode('ChNDYWxsRnVuY3Rpb25SZXF1ZXN0EkcKBG5hbWUYASABKAlCM+BBAvpBLQorY2xvdWRmdW5jdGlvbnMuZ29vZ2xlYXBpcy5jb20vQ2xvdWRGdW5jdGlvblIEbmFtZRIXCgRkYXRhGAIgASgJQgPgQQJSBGRhdGE=');
...
final $typed_data.Uint8List callFunctionResponseDescriptor = $convert.base64Decode('ChRDYWxsRnVuY3Rpb25SZXNwb25zZRIhCgxleGVjdXRpb25faWQYASABKAlSC2V4ZWN1dGlvbklkEhYKBnJlc3VsdBgCIAEoCVIGcmVzdWx0EhQKBWVycm9yGAMgASgJUgVlcnJvcg==');
...
final $typed_data.Uint8List generateUploadUrlRequestDescriptor = $convert.base64Decode('ChhHZW5lcmF0ZVVwbG9hZFVybFJlcXVlc3QSFgoGcGFyZW50GAEgASgJUgZwYXJlbnQ=');
...
final $typed_data.Uint8List generateUploadUrlResponseDescriptor = $convert.base64Decode('ChlHZW5lcmF0ZVVwbG9hZFVybFJlc3BvbnNlEh0KCnVwbG9hZF91cmwYASABKAlSCXVwbG9hZFVybA==');
...
final $typed_data.Uint8List generateDownloadUrlRequestDescriptor = $convert.base64Decode('ChpHZW5lcmF0ZURvd25sb2FkVXJsUmVxdWVzdBISCgRuYW1lGAEgASgJUgRuYW1lEh0KCnZlcnNpb25faWQYAiABKARSCXZlcnNpb25JZA==');
...
final $typed_data.Uint8List generateDownloadUrlResponseDescriptor = $convert.base64Decode('ChtHZW5lcmF0ZURvd25sb2FkVXJsUmVzcG9uc2USIQoMZG93bmxvYWRfdXJsGAEgASgJUgtkb3dubG9hZFVybA==');

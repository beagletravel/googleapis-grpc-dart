...
import '../../../identity/accesscontextmanager/v1/service_perimeter.pb.dart' as $4;
...
class Asset extends $pb.GeneratedMessage {
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'Asset', package: const $pb.PackageName(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'google.cloud.asset.v1p7beta1'), createEmptyInstance: create)
    ..oo(0, [7, 8, 9])
    ...
    ..aOM<$0.Policy>(4, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'iamPolicy', subBuilder: $0.Policy.create)
    ..pc<$1.Policy>(6, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'orgPolicy', $pb.PbFieldType.PM, subBuilder: $1.Policy.create)
    ..aOM<$2.AccessPolicy>(7, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'accessPolicy', subBuilder: $2.AccessPolicy.create)
    ..aOM<$3.AccessLevel>(8, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'accessLevel', subBuilder: $3.AccessLevel.create)
    ..aOM<$4.ServicePerimeter>(9, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'servicePerimeter', subBuilder: $4.ServicePerimeter.create)
    ..pPS(10, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'ancestors')
    ..aOM<$5.Timestamp>(11, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'updateTime', subBuilder: $5.Timestamp.create)
  ...
  @$pb.TagNumber(4)
  set iamPolicy($0.Policy v) { setField(4, v); }
  @$pb.TagNumber(4)
  ...
  @$pb.TagNumber(7)
  set accessPolicy($2.AccessPolicy v) { setField(7, v); }
  @$pb.TagNumber(7)
  ...
  @$pb.TagNumber(8)
  set accessLevel($3.AccessLevel v) { setField(8, v); }
  @$pb.TagNumber(8)
  ...
  @$pb.TagNumber(9)
  set servicePerimeter($4.ServicePerimeter v) { setField(9, v); }
  @$pb.TagNumber(9)
  ...
  @$pb.TagNumber(11)
  set updateTime($5.Timestamp v) { setField(11, v); }
  @$pb.TagNumber(11)
...
class Resource extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'Resource', package: const $pb.PackageName(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'google.cloud.asset.v1p7beta1'), createEmptyInstance: create)
    ...
    ..aOM<$6.Struct>(6, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'data', subBuilder: $6.Struct.create)
...
class RelatedAssets extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'RelatedAssets', package: const $pb.PackageName(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'google.cloud.asset.v1p7beta1'), createEmptyInstance: create)
...
class RelationshipAttributes extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'RelationshipAttributes', package: const $pb.PackageName(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'google.cloud.asset.v1p7beta1'), createEmptyInstance: create)
...
class RelatedAsset extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'RelatedAsset', package: const $pb.PackageName(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'google.cloud.asset.v1p7beta1'), createEmptyInstance: create)

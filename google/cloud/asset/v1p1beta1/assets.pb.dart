...
class StandardResourceMetadata extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'StandardResourceMetadata', package: const $pb.PackageName(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'google.cloud.asset.v1p1beta1'), createEmptyInstance: create)
    ...
    ..pPS(10, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'additionalAttributes')
    ..aOS(11, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'location')
    ..m<$core.String, $core.String>(12, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'labels', entryClassName: 'StandardResourceMetadata.LabelsEntry', keyFieldType: $pb.PbFieldType.OS, valueFieldType: $pb.PbFieldType.OS, packageName: const $pb.PackageName('google.cloud.asset.v1p1beta1'))
    ..pPS(13, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'networkTags')
  ...
  'Will be removed in next major version')
  StandardResourceMetadata copyWith(void Function(StandardResourceMetadata) updates) => super.copyWith((message) => updates(message as StandardResourceMetadata)) as StandardResourceMetadata; // ignore: deprecated_member_use
...
class IamPolicySearchResult_Explanation extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'IamPolicySearchResult.Explanation', package: const $pb.PackageName(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'google.cloud.asset.v1p1beta1'), createEmptyInstance: create)
    ..m<$core.String, Permissions>(1, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'matchedPermissions', entryClassName: 'IamPolicySearchResult.Explanation.MatchedPermissionsEntry', keyFieldType: $pb.PbFieldType.OS, valueFieldType: $pb.PbFieldType.OM, valueCreator: Permissions.create, packageName: const $pb.PackageName('google.cloud.asset.v1p1beta1'))
    ..hasRequiredFields = false
  ;
...
class IamPolicySearchResult extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'IamPolicySearchResult', package: const $pb.PackageName(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'google.cloud.asset.v1p1beta1'), createEmptyInstance: create)
    ..aOS(1, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'resource')
    ..aOS(3, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'project')
    ..aOM<$0.Policy>(4, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'policy', subBuilder: $0.Policy.create)
    ..aOM<IamPolicySearchResult_Explanation>(5, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'explanation', subBuilder: IamPolicySearchResult_Explanation.create)
    ..hasRequiredFields = false
  ;
  ...
  @$pb.TagNumber(4)
  set policy($0.Policy v) { setField(4, v); }
  @$pb.TagNumber(4)
...
class Permissions extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'Permissions', package: const $pb.PackageName(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'google.cloud.asset.v1p1beta1'), createEmptyInstance: create)

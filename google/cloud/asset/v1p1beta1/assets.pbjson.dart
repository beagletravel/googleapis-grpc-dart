...
const StandardResourceMetadata$json = const {
  ...
  '2': const [
    ...
    const {'1': 'additional_attributes', '3': 10, '4': 3, '5': 9, '10': 'additionalAttributes'},
    const {'1': 'location', '3': 11, '4': 1, '5': 9, '10': 'location'},
    const {'1': 'labels', '3': 12, '4': 3, '5': 11, '6': '.google.cloud.asset.v1p1beta1.StandardResourceMetadata.LabelsEntry', '10': 'labels'},
...
final $typed_data.Uint8List standardResourceMetadataDescriptor = $convert.base64Decode('');
...
const IamPolicySearchResult$json = const {
  ...
  '2': const [
    ...
    const {'1': 'project', '3': 3, '4': 1, '5': 9, '10': 'project'},
    const {'1': 'policy', '3': 4, '4': 1, '5': 11, '6': '.google.iam.v1.Policy', '10': 'policy'},
    const {'1': 'explanation', '3': 5, '4': 1, '5': 11, '6': '.google.cloud.asset.v1p1beta1.IamPolicySearchResult.Explanation', '10': 'explanation'},
  ],
...
const IamPolicySearchResult_Explanation$json = const {
  '1': 'Explanation',
  '2': const [
    const {'1': 'matched_permissions', '3': 1, '4': 3, '5': 11, '6': '.google.cloud.asset.v1p1beta1.IamPolicySearchResult.Explanation.MatchedPermissionsEntry', '10': 'matchedPermissions'},
  ],
...
final $typed_data.Uint8List permissionsDescriptor = $convert.base64Decode('CgtQZXJtaXNzaW9ucxIgCgtwZXJtaXNzaW9ucxgBIAMoCVILcGVybWlzc2lvbnM=');

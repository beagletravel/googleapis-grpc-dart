...
final $typed_data.Uint8List contentTypeDescriptor = $convert.base64Decode('CgtDb250ZW50VHlwZRIcChhDT05URU5UX1RZUEVfVU5TUEVDSUZJRUQQABIMCghSRVNPVVJDRRABEg4KCklBTV9QT0xJQ1kQAg==');
...
const CreateFeedRequest$json = const {
  ...
  '2': const [
    ...
    const {'1': 'feed', '3': 3, '4': 1, '5': 11, '6': '.google.cloud.asset.v1p2beta1.Feed', '8': const {}, '10': 'feed'},
  ],
};

/// Descriptor for `CreateFeedRequest`. Decode as a `google.protobuf.DescriptorProto`.
final $typed_data.Uint8List createFeedRequestDescriptor = $convert.base64Decode('ChFDcmVhdGVGZWVkUmVxdWVzdBIbCgZwYXJlbnQYASABKAlCA+BBAlIGcGFyZW50EhwKB2ZlZWRfaWQYAiABKAlCA+BBAlIGZmVlZElkEjsKBGZlZWQYAyABKAsyIi5nb29nbGUuY2xvdWQuYXNzZXQudjFwMmJldGExLkZlZWRCA+BBAlIEZmVlZA==');
...
const ListFeedsResponse$json = const {
  '1': 'ListFeedsResponse',
  '2': const [
    const {'1': 'feeds', '3': 1, '4': 3, '5': 11, '6': '.google.cloud.asset.v1p2beta1.Feed', '10': 'feeds'},
  ],
};

/// Descriptor for `ListFeedsResponse`. Decode as a `google.protobuf.DescriptorProto`.
final $typed_data.Uint8List listFeedsResponseDescriptor = $convert.base64Decode('ChFMaXN0RmVlZHNSZXNwb25zZRI4CgVmZWVkcxgBIAMoCzIiLmdvb2dsZS5jbG91ZC5hc3NldC52MXAyYmV0YTEuRmVlZFIFZmVlZHM=');
@$core.Deprecated('Use updateFeedRequestDescriptor instead')
const UpdateFeedRequest$json = const {
  '1': 'UpdateFeedRequest',
  '2': const [
    const {'1': 'feed', '3': 1, '4': 1, '5': 11, '6': '.google.cloud.asset.v1p2beta1.Feed', '8': const {}, '10': 'feed'},
...
final $typed_data.Uint8List updateFeedRequestDescriptor = $convert.base64Decode('ChFVcGRhdGVGZWVkUmVxdWVzdBI7CgRmZWVkGAEgASgLMiIuZ29vZ2xlLmNsb3VkLmFzc2V0LnYxcDJiZXRhMS5GZWVkQgPgQQJSBGZlZWQSQAoLdXBkYXRlX21hc2sYAiABKAsyGi5nb29nbGUucHJvdG9idWYuRmllbGRNYXNrQgPgQQJSCnVwZGF0ZU1hc2s=');
...
const OutputConfig$json = const {
  '1': 'OutputConfig',
  '2': const [
    const {'1': 'gcs_destination', '3': 1, '4': 1, '5': 11, '6': '.google.cloud.asset.v1p2beta1.GcsDestination', '9': 0, '10': 'gcsDestination'},
  ],
  '8': const [
    const {'1': 'destination'},
  ],
...
final $typed_data.Uint8List outputConfigDescriptor = $convert.base64Decode('CgxPdXRwdXRDb25maWcSVwoPZ2NzX2Rlc3RpbmF0aW9uGAEgASgLMiwuZ29vZ2xlLmNsb3VkLmFzc2V0LnYxcDJiZXRhMS5HY3NEZXN0aW5hdGlvbkgAUg5nY3NEZXN0aW5hdGlvbkINCgtkZXN0aW5hdGlvbg==');
...
final $typed_data.Uint8List gcsDestinationDescriptor = $convert.base64Decode('Cg5HY3NEZXN0aW5hdGlvbhISCgN1cmkYASABKAlIAFIDdXJpQgwKCm9iamVjdF91cmk=');
...
const FeedOutputConfig$json = const {
  '1': 'FeedOutputConfig',
  '2': const [
    const {'1': 'pubsub_destination', '3': 1, '4': 1, '5': 11, '6': '.google.cloud.asset.v1p2beta1.PubsubDestination', '9': 0, '10': 'pubsubDestination'},
  ],
  '8': const [
    const {'1': 'destination'},
  ],
...
final $typed_data.Uint8List feedOutputConfigDescriptor = $convert.base64Decode('ChBGZWVkT3V0cHV0Q29uZmlnEmAKEnB1YnN1Yl9kZXN0aW5hdGlvbhgBIAEoCzIvLmdvb2dsZS5jbG91ZC5hc3NldC52MXAyYmV0YTEuUHVic3ViRGVzdGluYXRpb25IAFIRcHVic3ViRGVzdGluYXRpb25CDQoLZGVzdGluYXRpb24=');
...
const Feed$json = const {
  ...
  '2': const [
    ...
    const {'1': 'content_type', '3': 4, '4': 1, '5': 14, '6': '.google.cloud.asset.v1p2beta1.ContentType', '10': 'contentType'},
    const {'1': 'feed_output_config', '3': 5, '4': 1, '5': 11, '6': '.google.cloud.asset.v1p2beta1.FeedOutputConfig', '8': const {}, '10': 'feedOutputConfig'},
  ],
  '7': const {},
};

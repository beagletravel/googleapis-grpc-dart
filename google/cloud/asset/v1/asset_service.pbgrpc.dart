...
class AssetServiceClient extends $grpc.Client {
  ...
  static final _$createSavedQuery =
      $grpc.ClientMethod<$2.CreateSavedQueryRequest, $2.SavedQuery>(
          '/google.cloud.asset.v1.AssetService/CreateSavedQuery',
          ($2.CreateSavedQueryRequest value) => value.writeToBuffer(),
          ($core.List<$core.int> value) => $2.SavedQuery.fromBuffer(value));
  static final _$getSavedQuery =
      $grpc.ClientMethod<$2.GetSavedQueryRequest, $2.SavedQuery>(
          '/google.cloud.asset.v1.AssetService/GetSavedQuery',
          ($2.GetSavedQueryRequest value) => value.writeToBuffer(),
          ($core.List<$core.int> value) => $2.SavedQuery.fromBuffer(value));
  static final _$listSavedQueries = $grpc.ClientMethod<
          $2.ListSavedQueriesRequest, $2.ListSavedQueriesResponse>(
      '/google.cloud.asset.v1.AssetService/ListSavedQueries',
      ($2.ListSavedQueriesRequest value) => value.writeToBuffer(),
      ($core.List<$core.int> value) =>
          $2.ListSavedQueriesResponse.fromBuffer(value));
  static final _$updateSavedQuery =
      $grpc.ClientMethod<$2.UpdateSavedQueryRequest, $2.SavedQuery>(
          '/google.cloud.asset.v1.AssetService/UpdateSavedQuery',
          ($2.UpdateSavedQueryRequest value) => value.writeToBuffer(),
          ($core.List<$core.int> value) => $2.SavedQuery.fromBuffer(value));
  static final _$deleteSavedQuery =
      $grpc.ClientMethod<$2.DeleteSavedQueryRequest, $1.Empty>(
          '/google.cloud.asset.v1.AssetService/DeleteSavedQuery',
          ($2.DeleteSavedQueryRequest value) => value.writeToBuffer(),
          ($core.List<$core.int> value) => $1.Empty.fromBuffer(value));
  static final _$batchGetEffectiveIamPolicies = $grpc.ClientMethod<
          $2.BatchGetEffectiveIamPoliciesRequest,
          $2.BatchGetEffectiveIamPoliciesResponse>(
      '/google.cloud.asset.v1.AssetService/BatchGetEffectiveIamPolicies',
      ($2.BatchGetEffectiveIamPoliciesRequest value) => value.writeToBuffer(),
      ($core.List<$core.int> value) =>
          $2.BatchGetEffectiveIamPoliciesResponse.fromBuffer(value));
  ...
  $grpc.ResponseFuture<$2.SavedQuery> createSavedQuery(
      $2.CreateSavedQueryRequest request,
      {$grpc.CallOptions? options}) {
    return $createUnaryCall(_$createSavedQuery, request, options: options);
  }

  $grpc.ResponseFuture<$2.SavedQuery> getSavedQuery(
      $2.GetSavedQueryRequest request,
      {$grpc.CallOptions? options}) {
    return $createUnaryCall(_$getSavedQuery, request, options: options);
  }

  $grpc.ResponseFuture<$2.ListSavedQueriesResponse> listSavedQueries(
      $2.ListSavedQueriesRequest request,
      {$grpc.CallOptions? options}) {
    return $createUnaryCall(_$listSavedQueries, request, options: options);
  }

  $grpc.ResponseFuture<$2.SavedQuery> updateSavedQuery(
      $2.UpdateSavedQueryRequest request,
      {$grpc.CallOptions? options}) {
    return $createUnaryCall(_$updateSavedQuery, request, options: options);
  }

  $grpc.ResponseFuture<$1.Empty> deleteSavedQuery(
      $2.DeleteSavedQueryRequest request,
      {$grpc.CallOptions? options}) {
    return $createUnaryCall(_$deleteSavedQuery, request, options: options);
  }

  $grpc.ResponseFuture<$2.BatchGetEffectiveIamPoliciesResponse>
      batchGetEffectiveIamPolicies(
          $2.BatchGetEffectiveIamPoliciesRequest request,
          {$grpc.CallOptions? options}) {
    return $createUnaryCall(_$batchGetEffectiveIamPolicies, request,
        options: options);
  }
}
...
abstract class AssetServiceBase extends $grpc.Service {
  ...
  AssetServiceBase() {
    ...
    $addMethod($grpc.ServiceMethod<$2.CreateSavedQueryRequest, $2.SavedQuery>(
        'CreateSavedQuery',
        createSavedQuery_Pre,
        false,
        false,
        ($core.List<$core.int> value) =>
            $2.CreateSavedQueryRequest.fromBuffer(value),
        ($2.SavedQuery value) => value.writeToBuffer()));
    $addMethod($grpc.ServiceMethod<$2.GetSavedQueryRequest, $2.SavedQuery>(
        'GetSavedQuery',
        getSavedQuery_Pre,
        false,
        false,
        ($core.List<$core.int> value) =>
            $2.GetSavedQueryRequest.fromBuffer(value),
        ($2.SavedQuery value) => value.writeToBuffer()));
    $addMethod($grpc.ServiceMethod<$2.ListSavedQueriesRequest,
            $2.ListSavedQueriesResponse>(
        'ListSavedQueries',
        listSavedQueries_Pre,
        false,
        false,
        ($core.List<$core.int> value) =>
            $2.ListSavedQueriesRequest.fromBuffer(value),
        ($2.ListSavedQueriesResponse value) => value.writeToBuffer()));
    $addMethod($grpc.ServiceMethod<$2.UpdateSavedQueryRequest, $2.SavedQuery>(
        'UpdateSavedQuery',
        updateSavedQuery_Pre,
        false,
        false,
        ($core.List<$core.int> value) =>
            $2.UpdateSavedQueryRequest.fromBuffer(value),
        ($2.SavedQuery value) => value.writeToBuffer()));
    $addMethod($grpc.ServiceMethod<$2.DeleteSavedQueryRequest, $1.Empty>(
        'DeleteSavedQuery',
        deleteSavedQuery_Pre,
        false,
        false,
        ($core.List<$core.int> value) =>
            $2.DeleteSavedQueryRequest.fromBuffer(value),
        ($1.Empty value) => value.writeToBuffer()));
    $addMethod($grpc.ServiceMethod<$2.BatchGetEffectiveIamPoliciesRequest,
            $2.BatchGetEffectiveIamPoliciesResponse>(
        'BatchGetEffectiveIamPolicies',
        ...
        false,
        ($core.List<$core.int> value) =>
            $2.BatchGetEffectiveIamPoliciesRequest.fromBuffer(value),
        ($2.BatchGetEffectiveIamPoliciesResponse value) =>
            value.writeToBuffer()));
  }
  ...
  $async.Future<$2.SavedQuery> createSavedQuery_Pre($grpc.ServiceCall call,
      $async.Future<$2.CreateSavedQueryRequest> request) async {
    return createSavedQuery(call, await request);
  }

  $async.Future<$2.SavedQuery> getSavedQuery_Pre($grpc.ServiceCall call,
      $async.Future<$2.GetSavedQueryRequest> request) async {
    return getSavedQuery(call, await request);
  }

  $async.Future<$2.ListSavedQueriesResponse> listSavedQueries_Pre(
      $grpc.ServiceCall call,
      $async.Future<$2.ListSavedQueriesRequest> request) async {
    return listSavedQueries(call, await request);
  }

  $async.Future<$2.SavedQuery> updateSavedQuery_Pre($grpc.ServiceCall call,
      $async.Future<$2.UpdateSavedQueryRequest> request) async {
    return updateSavedQuery(call, await request);
  }

  $async.Future<$1.Empty> deleteSavedQuery_Pre($grpc.ServiceCall call,
      $async.Future<$2.DeleteSavedQueryRequest> request) async {
    return deleteSavedQuery(call, await request);
  }

  $async.Future<$2.BatchGetEffectiveIamPoliciesResponse>
      batchGetEffectiveIamPolicies_Pre($grpc.ServiceCall call,
          $async.Future<$2.BatchGetEffectiveIamPoliciesRequest> request) async {
  ...
  $async.Future<$2.SavedQuery> createSavedQuery(
      $grpc.ServiceCall call, $2.CreateSavedQueryRequest request);
  $async.Future<$2.SavedQuery> getSavedQuery(
      $grpc.ServiceCall call, $2.GetSavedQueryRequest request);
  $async.Future<$2.ListSavedQueriesResponse> listSavedQueries(
      $grpc.ServiceCall call, $2.ListSavedQueriesRequest request);
  $async.Future<$2.SavedQuery> updateSavedQuery(
      $grpc.ServiceCall call, $2.UpdateSavedQueryRequest request);
  $async.Future<$1.Empty> deleteSavedQuery(
      $grpc.ServiceCall call, $2.DeleteSavedQueryRequest request);
  $async.Future<$2.BatchGetEffectiveIamPoliciesResponse>
      batchGetEffectiveIamPolicies($grpc.ServiceCall call,
          $2.BatchGetEffectiveIamPoliciesRequest request);
}

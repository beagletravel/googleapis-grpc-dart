...
import '../../../identity/accesscontextmanager/v1/service_perimeter.pb.dart' as $5;
...
class TemporalAsset extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'TemporalAsset', package: const $pb.PackageName(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'google.cloud.asset.v1'), createEmptyInstance: create)
    ...
    ..aOM<Asset>(3, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'asset', subBuilder: Asset.create)
    ..e<TemporalAsset_PriorAssetState>(4, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'priorAssetState', $pb.PbFieldType.OE, defaultOrMaker: TemporalAsset_PriorAssetState.PRIOR_ASSET_STATE_UNSPECIFIED, valueOf: TemporalAsset_PriorAssetState.valueOf, enumValues: TemporalAsset_PriorAssetState.values)
    ..aOM<Asset>(5, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'priorAsset', subBuilder: Asset.create)
  ...
  'Will be removed in next major version')
  TemporalAsset copyWith(void Function(TemporalAsset) updates) => super.copyWith((message) => updates(message as TemporalAsset)) as TemporalAsset; // ignore: deprecated_member_use
...
class TimeWindow extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'TimeWindow', package: const $pb.PackageName(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'google.cloud.asset.v1'), createEmptyInstance: create)
...
class Asset extends $pb.GeneratedMessage {
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'Asset', package: const $pb.PackageName(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'google.cloud.asset.v1'), createEmptyInstance: create)
    ..oo(0, [7, 8, 9])
    ..aOS(1, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'name')
    ..aOS(2, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'assetType')
    ..aOM<Resource>(3, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'resource', subBuilder: Resource.create)
    ..aOM<$1.Policy>(4, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'iamPolicy', subBuilder: $1.Policy.create)
    ..pc<$2.Policy>(6, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'orgPolicy', $pb.PbFieldType.PM, subBuilder: $2.Policy.create)
    ..aOM<$3.AccessPolicy>(7, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'accessPolicy', subBuilder: $3.AccessPolicy.create)
    ..aOM<$4.AccessLevel>(8, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'accessLevel', subBuilder: $4.AccessLevel.create)
    ..aOM<$5.ServicePerimeter>(9, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'servicePerimeter', subBuilder: $5.ServicePerimeter.create)
    ..pPS(10, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'ancestors')
    ..aOM<$0.Timestamp>(11, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'updateTime', subBuilder: $0.Timestamp.create)
    ..aOM<$6.Inventory>(12, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'osInventory', subBuilder: $6.Inventory.create)
    ..aOM<RelatedAssets>(13, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'relatedAssets', subBuilder: RelatedAssets.create)
    ..aOM<RelatedAsset>(15, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'relatedAsset', subBuilder: RelatedAsset.create)
    ..hasRequiredFields = false
  ;
  ...
  @$core.Deprecated('This field is deprecated.')
    ...
    if (relatedAsset != null) {
      _result.relatedAsset = relatedAsset;
    }
    return _result;
  }
  ...
  @$pb.TagNumber(7)
  set accessPolicy($3.AccessPolicy v) { setField(7, v); }
  @$pb.TagNumber(7)
  ...
  @$pb.TagNumber(8)
  set accessLevel($4.AccessLevel v) { setField(8, v); }
  @$pb.TagNumber(8)
  ...
  @$pb.TagNumber(9)
  set servicePerimeter($5.ServicePerimeter v) { setField(9, v); }
  @$pb.TagNumber(9)
  ...
  @$pb.TagNumber(12)
  set osInventory($6.Inventory v) { setField(12, v); }
  @$pb.TagNumber(12)
...
class Resource extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'Resource', package: const $pb.PackageName(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'google.cloud.asset.v1'), createEmptyInstance: create)
    ..aOS(1, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'version')
    ..aOS(2, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'discoveryDocumentUri')
    ..aOS(3, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'discoveryName')
    ..aOS(4, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'resourceUrl')
    ..aOS(5, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'parent')
    ..aOM<$7.Struct>(6, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'data', subBuilder: $7.Struct.create)
  ...
  @$pb.TagNumber(6)
  set data($7.Struct v) { setField(6, v); }
  @$pb.TagNumber(6)
...
class RelatedAssets extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'RelatedAssets', package: const $pb.PackageName(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'google.cloud.asset.v1'), createEmptyInstance: create)
    ..aOM<RelationshipAttributes>(1, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'relationshipAttributes', subBuilder: RelationshipAttributes.create)
    ..pc<RelatedAsset>(2, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'assets', $pb.PbFieldType.PM, subBuilder: RelatedAsset.create)
    ..hasRequiredFields = false
  ;
  ...
  'Use [GeneratedMessageGenericExtensions.rebuild] instead. '
  'Will be removed in next major version')
  RelatedAssets copyWith(void Function(RelatedAssets) updates) => super.copyWith((message) => updates(message as RelatedAssets)) as RelatedAssets; // ignore: deprecated_member_use
  $pb.BuilderInfo get info_ => _i;
  @$core.pragma('dart2js:noInline')
...
class RelationshipAttributes extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'RelationshipAttributes', package: const $pb.PackageName(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'google.cloud.asset.v1'), createEmptyInstance: create)
    ..aOS(1, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'sourceResourceType')
    ..aOS(2, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'targetResourceType')
  ...
  'Use [GeneratedMessageGenericExtensions.rebuild] instead. '
  'Will be removed in next major version')
  RelationshipAttributes copyWith(void Function(RelationshipAttributes) updates) => super.copyWith((message) => updates(message as RelationshipAttributes)) as RelationshipAttributes; // ignore: deprecated_member_use
  $pb.BuilderInfo get info_ => _i;
  @$core.pragma('dart2js:noInline')
...
class RelatedAsset extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'RelatedAsset', package: const $pb.PackageName(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'google.cloud.asset.v1'), createEmptyInstance: create)
    ..aOS(1, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'asset')
    ..aOS(2, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'assetType')
    ..pPS(3, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'ancestors')
    ..aOS(4, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'relationshipType')
    ..hasRequiredFields = false
  ;
  ...
  'Use [GeneratedMessageGenericExtensions.rebuild] instead. '
  'Will be removed in next major version')
  RelatedAsset copyWith(void Function(RelatedAsset) updates) => super.copyWith((message) => updates(message as RelatedAsset)) as RelatedAsset; // ignore: deprecated_member_use
  $pb.BuilderInfo get info_ => _i;
  @$core.pragma('dart2js:noInline')
...
class ResourceSearchResult extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'ResourceSearchResult', package: const $pb.PackageName(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'google.cloud.asset.v1'), createEmptyInstance: create)
    ..aOS(1, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'name')
    ..aOS(2, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'assetType')
    ...
    ..m<$core.String, $core.String>(7, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'labels', entryClassName: 'ResourceSearchResult.LabelsEntry', keyFieldType: $pb.PbFieldType.OS, valueFieldType: $pb.PbFieldType.OS, packageName: const $pb.PackageName('google.cloud.asset.v1'))
    ..pPS(8, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'networkTags')
    ..aOM<$7.Struct>(9, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'additionalAttributes', subBuilder: $7.Struct.create)
    ..aOS(10, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'kmsKey')
    ...
    ..aOS(13, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'state')
    ..pc<VersionedResource>(16, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'versionedResources', $pb.PbFieldType.PM, subBuilder: VersionedResource.create)
    ..pPS(17, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'folders')
    ..aOS(18, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'organization')
    ..aOS(19, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'parentFullResourceName')
    ..pc<AttachedResource>(20, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'attachedResources', $pb.PbFieldType.PM, subBuilder: AttachedResource.create)
    ..m<$core.String, RelatedResources>(21, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'relationships', entryClassName: 'ResourceSearchResult.RelationshipsEntry', keyFieldType: $pb.PbFieldType.OS, valueFieldType: $pb.PbFieldType.OM, valueCreator: RelatedResources.create, packageName: const $pb.PackageName('google.cloud.asset.v1'))
    ..pPS(23, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'tagKeys')
    ..pPS(25, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'tagValues')
    ..pPS(26, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'tagValueIds')
    ..aOS(103, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'parentAssetType')
    ..hasRequiredFields = false
  ;
  ...
  factory ResourceSearchResult({
    ...
    if (tagValueIds != null) {
      _result.tagValueIds.addAll(tagValueIds);
    }
  ...
  'Use [GeneratedMessageGenericExtensions.rebuild] instead. '
  'Will be removed in next major version')
  ResourceSearchResult copyWith(void Function(ResourceSearchResult) updates) => super.copyWith((message) => updates(message as ResourceSearchResult)) as ResourceSearchResult; // ignore: deprecated_member_use
  $pb.BuilderInfo get info_ => _i;
  @$core.pragma('dart2js:noInline')
  ...
  @$pb.TagNumber(9)
  set additionalAttributes($7.Struct v) { setField(9, v); }
  @$pb.TagNumber(9)
  ...
  @$pb.TagNumber(103)
  $core.String get parentAssetType => $_getSZ(22);
  @$pb.TagNumber(103)
  set parentAssetType($core.String v) { $_setString(22, v); }
  @$pb.TagNumber(103)
  $core.bool hasParentAssetType() => $_has(22);
  @$pb.TagNumber(103)
  void clearParentAssetType() => clearField(103);
}

class VersionedResource extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'VersionedResource', package: const $pb.PackageName(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'google.cloud.asset.v1'), createEmptyInstance: create)
    ..aOS(1, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'version')
    ..aOM<$7.Struct>(2, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'resource', subBuilder: $7.Struct.create)
    ..hasRequiredFields = false
  ;
  ...
  'Use [GeneratedMessageGenericExtensions.rebuild] instead. '
  'Will be removed in next major version')
  VersionedResource copyWith(void Function(VersionedResource) updates) => super.copyWith((message) => updates(message as VersionedResource)) as VersionedResource; // ignore: deprecated_member_use
  $pb.BuilderInfo get info_ => _i;
  @$core.pragma('dart2js:noInline')
  ...
  @$pb.TagNumber(2)
  set resource($7.Struct v) { setField(2, v); }
  @$pb.TagNumber(2)
...
class AttachedResource extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'AttachedResource', package: const $pb.PackageName(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'google.cloud.asset.v1'), createEmptyInstance: create)
    ..aOS(1, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'assetType')
    ..pc<VersionedResource>(3, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'versionedResources', $pb.PbFieldType.PM, subBuilder: VersionedResource.create)
    ..hasRequiredFields = false
  ;
  ...
  'Use [GeneratedMessageGenericExtensions.rebuild] instead. '
  'Will be removed in next major version')
  AttachedResource copyWith(void Function(AttachedResource) updates) => super.copyWith((message) => updates(message as AttachedResource)) as AttachedResource; // ignore: deprecated_member_use
  $pb.BuilderInfo get info_ => _i;
  @$core.pragma('dart2js:noInline')
...
class RelatedResources extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'RelatedResources', package: const $pb.PackageName(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'google.cloud.asset.v1'), createEmptyInstance: create)
    ..pc<RelatedResource>(1, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'relatedResources', $pb.PbFieldType.PM, subBuilder: RelatedResource.create)
    ..hasRequiredFields = false
  ;
  ...
  'Use [GeneratedMessageGenericExtensions.rebuild] instead. '
  'Will be removed in next major version')
  RelatedResources copyWith(void Function(RelatedResources) updates) => super.copyWith((message) => updates(message as RelatedResources)) as RelatedResources; // ignore: deprecated_member_use
  $pb.BuilderInfo get info_ => _i;
  @$core.pragma('dart2js:noInline')
...
class RelatedResource extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'RelatedResource', package: const $pb.PackageName(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'google.cloud.asset.v1'), createEmptyInstance: create)
    ..aOS(1, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'assetType')
    ..aOS(2, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'fullResourceName')
    ..hasRequiredFields = false
  ;
  ...
  'Use [GeneratedMessageGenericExtensions.rebuild] instead. '
  'Will be removed in next major version')
  RelatedResource copyWith(void Function(RelatedResource) updates) => super.copyWith((message) => updates(message as RelatedResource)) as RelatedResource; // ignore: deprecated_member_use
  $pb.BuilderInfo get info_ => _i;
  @$core.pragma('dart2js:noInline')
...
class IamPolicySearchResult_Explanation_Permissions extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'IamPolicySearchResult.Explanation.Permissions', package: const $pb.PackageName(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'google.cloud.asset.v1'), createEmptyInstance: create)
    ..pPS(1, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'permissions')
    ..hasRequiredFields = false
  ;
  ...
  'Use [GeneratedMessageGenericExtensions.rebuild] instead. '
  'Will be removed in next major version')
  IamPolicySearchResult_Explanation_Permissions copyWith(void Function(IamPolicySearchResult_Explanation_Permissions) updates) => super.copyWith((message) => updates(message as IamPolicySearchResult_Explanation_Permissions)) as IamPolicySearchResult_Explanation_Permissions; // ignore: deprecated_member_use
  $pb.BuilderInfo get info_ => _i;
  @$core.pragma('dart2js:noInline')
...
class IamPolicySearchResult_Explanation extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'IamPolicySearchResult.Explanation', package: const $pb.PackageName(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'google.cloud.asset.v1'), createEmptyInstance: create)
    ..m<$core.String, IamPolicySearchResult_Explanation_Permissions>(1, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'matchedPermissions', entryClassName: 'IamPolicySearchResult.Explanation.MatchedPermissionsEntry', keyFieldType: $pb.PbFieldType.OS, valueFieldType: $pb.PbFieldType.OM, valueCreator: IamPolicySearchResult_Explanation_Permissions.create, packageName: const $pb.PackageName('google.cloud.asset.v1'))
    ..hasRequiredFields = false
  ;
  ...
  'Use [GeneratedMessageGenericExtensions.rebuild] instead. '
  'Will be removed in next major version')
  IamPolicySearchResult_Explanation copyWith(void Function(IamPolicySearchResult_Explanation) updates) => super.copyWith((message) => updates(message as IamPolicySearchResult_Explanation)) as IamPolicySearchResult_Explanation; // ignore: deprecated_member_use
  $pb.BuilderInfo get info_ => _i;
  @$core.pragma('dart2js:noInline')
...
class IamPolicySearchResult extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'IamPolicySearchResult', package: const $pb.PackageName(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'google.cloud.asset.v1'), createEmptyInstance: create)
    ...
    ..aOM<$1.Policy>(3, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'policy', subBuilder: $1.Policy.create)
    ..aOM<IamPolicySearchResult_Explanation>(4, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'explanation', subBuilder: IamPolicySearchResult_Explanation.create)
    ..aOS(5, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'assetType')
    ..pPS(6, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'folders')
    ..aOS(7, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'organization')
    ..hasRequiredFields = false
  ;
  ...
  'Use [GeneratedMessageGenericExtensions.rebuild] instead. '
  'Will be removed in next major version')
  IamPolicySearchResult copyWith(void Function(IamPolicySearchResult) updates) => super.copyWith((message) => updates(message as IamPolicySearchResult)) as IamPolicySearchResult; // ignore: deprecated_member_use
  $pb.BuilderInfo get info_ => _i;
  @$core.pragma('dart2js:noInline')
  ...
  @$pb.TagNumber(3)
  set policy($1.Policy v) { setField(3, v); }
  @$pb.TagNumber(3)
...
class IamPolicyAnalysisState extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'IamPolicyAnalysisState', package: const $pb.PackageName(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'google.cloud.asset.v1'), createEmptyInstance: create)
    ..e<$8.Code>(1, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'code', $pb.PbFieldType.OE, defaultOrMaker: $8.Code.OK, valueOf: $8.Code.valueOf, enumValues: $8.Code.values)
  ...
  'Use [GeneratedMessageGenericExtensions.rebuild] instead. '
  'Will be removed in next major version')
  IamPolicyAnalysisState copyWith(void Function(IamPolicyAnalysisState) updates) => super.copyWith((message) => updates(message as IamPolicyAnalysisState)) as IamPolicyAnalysisState; // ignore: deprecated_member_use
  $pb.BuilderInfo get info_ => _i;
  @$core.pragma('dart2js:noInline')
  ...
  @$pb.TagNumber(1)
  set code($8.Code v) { setField(1, v); }
  @$pb.TagNumber(1)
...
class ConditionEvaluation extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'ConditionEvaluation', package: const $pb.PackageName(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'google.cloud.asset.v1'), createEmptyInstance: create)
    ..e<ConditionEvaluation_EvaluationValue>(1, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'evaluationValue', $pb.PbFieldType.OE, defaultOrMaker: ConditionEvaluation_EvaluationValue.EVALUATION_VALUE_UNSPECIFIED, valueOf: ConditionEvaluation_EvaluationValue.valueOf, enumValues: ConditionEvaluation_EvaluationValue.values)
    ..hasRequiredFields = false
  ;
  ...
  'Use [GeneratedMessageGenericExtensions.rebuild] instead. '
  'Will be removed in next major version')
  ConditionEvaluation copyWith(void Function(ConditionEvaluation) updates) => super.copyWith((message) => updates(message as ConditionEvaluation)) as ConditionEvaluation; // ignore: deprecated_member_use
  $pb.BuilderInfo get info_ => _i;
  @$core.pragma('dart2js:noInline')
...
class IamPolicyAnalysisResult_Resource extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'IamPolicyAnalysisResult.Resource', package: const $pb.PackageName(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'google.cloud.asset.v1'), createEmptyInstance: create)
    ..aOS(1, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'fullResourceName')
    ..aOM<IamPolicyAnalysisState>(2, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'analysisState', subBuilder: IamPolicyAnalysisState.create)
    ..hasRequiredFields = false
  ;
  ...
  'Use [GeneratedMessageGenericExtensions.rebuild] instead. '
  'Will be removed in next major version')
  IamPolicyAnalysisResult_Resource copyWith(void Function(IamPolicyAnalysisResult_Resource) updates) => super.copyWith((message) => updates(message as IamPolicyAnalysisResult_Resource)) as IamPolicyAnalysisResult_Resource; // ignore: deprecated_member_use
  $pb.BuilderInfo get info_ => _i;
  @$core.pragma('dart2js:noInline')
...
class IamPolicyAnalysisResult_Access extends $pb.GeneratedMessage {
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'IamPolicyAnalysisResult.Access', package: const $pb.PackageName(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'google.cloud.asset.v1'), createEmptyInstance: create)
    ..oo(0, [1, 2])
    ...
    ..aOM<IamPolicyAnalysisState>(3, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'analysisState', subBuilder: IamPolicyAnalysisState.create)
    ..hasRequiredFields = false
  ;
  ...
  'Use [GeneratedMessageGenericExtensions.rebuild] instead. '
  'Will be removed in next major version')
  IamPolicyAnalysisResult_Access copyWith(void Function(IamPolicyAnalysisResult_Access) updates) => super.copyWith((message) => updates(message as IamPolicyAnalysisResult_Access)) as IamPolicyAnalysisResult_Access; // ignore: deprecated_member_use
  $pb.BuilderInfo get info_ => _i;
  @$core.pragma('dart2js:noInline')
...
class IamPolicyAnalysisResult_Identity extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'IamPolicyAnalysisResult.Identity', package: const $pb.PackageName(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'google.cloud.asset.v1'), createEmptyInstance: create)
    ..aOS(1, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'name')
    ..aOM<IamPolicyAnalysisState>(2, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'analysisState', subBuilder: IamPolicyAnalysisState.create)
    ..hasRequiredFields = false
  ;
  ...
  'Use [GeneratedMessageGenericExtensions.rebuild] instead. '
  'Will be removed in next major version')
  IamPolicyAnalysisResult_Identity copyWith(void Function(IamPolicyAnalysisResult_Identity) updates) => super.copyWith((message) => updates(message as IamPolicyAnalysisResult_Identity)) as IamPolicyAnalysisResult_Identity; // ignore: deprecated_member_use
  $pb.BuilderInfo get info_ => _i;
  @$core.pragma('dart2js:noInline')
...
class IamPolicyAnalysisResult_Edge extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'IamPolicyAnalysisResult.Edge', package: const $pb.PackageName(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'google.cloud.asset.v1'), createEmptyInstance: create)
    ..aOS(1, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'sourceNode')
    ..aOS(2, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'targetNode')
    ..hasRequiredFields = false
  ;
  ...
  'Use [GeneratedMessageGenericExtensions.rebuild] instead. '
  'Will be removed in next major version')
  IamPolicyAnalysisResult_Edge copyWith(void Function(IamPolicyAnalysisResult_Edge) updates) => super.copyWith((message) => updates(message as IamPolicyAnalysisResult_Edge)) as IamPolicyAnalysisResult_Edge; // ignore: deprecated_member_use
  $pb.BuilderInfo get info_ => _i;
  @$core.pragma('dart2js:noInline')
...
class IamPolicyAnalysisResult_AccessControlList extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'IamPolicyAnalysisResult.AccessControlList', package: const $pb.PackageName(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'google.cloud.asset.v1'), createEmptyInstance: create)
    ..pc<IamPolicyAnalysisResult_Resource>(1, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'resources', $pb.PbFieldType.PM, subBuilder: IamPolicyAnalysisResult_Resource.create)
    ..pc<IamPolicyAnalysisResult_Access>(2, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'accesses', $pb.PbFieldType.PM, subBuilder: IamPolicyAnalysisResult_Access.create)
    ..pc<IamPolicyAnalysisResult_Edge>(3, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'resourceEdges', $pb.PbFieldType.PM, subBuilder: IamPolicyAnalysisResult_Edge.create)
    ..aOM<ConditionEvaluation>(4, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'conditionEvaluation', subBuilder: ConditionEvaluation.create)
    ..hasRequiredFields = false
  ;
  ...
  'Use [GeneratedMessageGenericExtensions.rebuild] instead. '
  'Will be removed in next major version')
  IamPolicyAnalysisResult_AccessControlList copyWith(void Function(IamPolicyAnalysisResult_AccessControlList) updates) => super.copyWith((message) => updates(message as IamPolicyAnalysisResult_AccessControlList)) as IamPolicyAnalysisResult_AccessControlList; // ignore: deprecated_member_use
  $pb.BuilderInfo get info_ => _i;
  @$core.pragma('dart2js:noInline')
...
class IamPolicyAnalysisResult_IdentityList extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'IamPolicyAnalysisResult.IdentityList', package: const $pb.PackageName(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'google.cloud.asset.v1'), createEmptyInstance: create)
    ..pc<IamPolicyAnalysisResult_Identity>(1, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'identities', $pb.PbFieldType.PM, subBuilder: IamPolicyAnalysisResult_Identity.create)
    ..pc<IamPolicyAnalysisResult_Edge>(2, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'groupEdges', $pb.PbFieldType.PM, subBuilder: IamPolicyAnalysisResult_Edge.create)
    ..hasRequiredFields = false
  ;
  ...
  'Use [GeneratedMessageGenericExtensions.rebuild] instead. '
  'Will be removed in next major version')
  IamPolicyAnalysisResult_IdentityList copyWith(void Function(IamPolicyAnalysisResult_IdentityList) updates) => super.copyWith((message) => updates(message as IamPolicyAnalysisResult_IdentityList)) as IamPolicyAnalysisResult_IdentityList; // ignore: deprecated_member_use
  $pb.BuilderInfo get info_ => _i;
  @$core.pragma('dart2js:noInline')
...
class IamPolicyAnalysisResult extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'IamPolicyAnalysisResult', package: const $pb.PackageName(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'google.cloud.asset.v1'), createEmptyInstance: create)
    ..aOS(1, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'attachedResourceFullName')
    ..aOM<$1.Binding>(2, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'iamBinding', subBuilder: $1.Binding.create)
    ..pc<IamPolicyAnalysisResult_AccessControlList>(3, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'accessControlLists', $pb.PbFieldType.PM, subBuilder: IamPolicyAnalysisResult_AccessControlList.create)
    ..aOM<IamPolicyAnalysisResult_IdentityList>(4, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'identityList', subBuilder: IamPolicyAnalysisResult_IdentityList.create)
    ..aOB(5, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'fullyExplored')
    ..hasRequiredFields = false
  ;
  ...
  'Use [GeneratedMessageGenericExtensions.rebuild] instead. '
  'Will be removed in next major version')
  IamPolicyAnalysisResult copyWith(void Function(IamPolicyAnalysisResult) updates) => super.copyWith((message) => updates(message as IamPolicyAnalysisResult)) as IamPolicyAnalysisResult; // ignore: deprecated_member_use
  $pb.BuilderInfo get info_ => _i;
  @$core.pragma('dart2js:noInline')
  ...
  @$pb.TagNumber(2)
  set iamBinding($1.Binding v) { setField(2, v); }
  @$pb.TagNumber(2)

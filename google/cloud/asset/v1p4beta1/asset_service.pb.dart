...
class IamPolicyAnalysisQuery_ResourceSelector extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'IamPolicyAnalysisQuery.ResourceSelector', package: const $pb.PackageName(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'google.cloud.asset.v1p4beta1'), createEmptyInstance: create)
...
class IamPolicyAnalysisQuery_IdentitySelector extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'IamPolicyAnalysisQuery.IdentitySelector', package: const $pb.PackageName(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'google.cloud.asset.v1p4beta1'), createEmptyInstance: create)
...
class IamPolicyAnalysisQuery_AccessSelector extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'IamPolicyAnalysisQuery.AccessSelector', package: const $pb.PackageName(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'google.cloud.asset.v1p4beta1'), createEmptyInstance: create)
...
class IamPolicyAnalysisQuery extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'IamPolicyAnalysisQuery', package: const $pb.PackageName(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'google.cloud.asset.v1p4beta1'), createEmptyInstance: create)
...
class AnalyzeIamPolicyRequest_Options extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'AnalyzeIamPolicyRequest.Options', package: const $pb.PackageName(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'google.cloud.asset.v1p4beta1'), createEmptyInstance: create)
    ...
    ..aOM<$3.Duration>(7, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'executionTimeout', subBuilder: $3.Duration.create)
    ..hasRequiredFields = false
  ;
  ...
  factory AnalyzeIamPolicyRequest_Options.fromBuffer($core.List<$core.int> i, [$pb.ExtensionRegistry r = $pb.ExtensionRegistry.EMPTY]) => create()..mergeFromBuffer(i, r);
  factory AnalyzeIamPolicyRequest_Options.fromJson($core.String i, [$pb.ExtensionRegistry r = $pb.ExtensionRegistry.EMPTY]) => create()..mergeFromJson(i, r);
  @$core.Deprecated(
  'Using this can add significant overhead to your binary. '
  'Use [GeneratedMessageGenericExtensions.deepCopy] instead. '
  'Will be removed in next major version')
  AnalyzeIamPolicyRequest_Options clone() => AnalyzeIamPolicyRequest_Options()..mergeFromMessage(this);
  @$core.Deprecated(
  'Using this can add significant overhead to your binary. '
  'Use [GeneratedMessageGenericExtensions.rebuild] instead. '
  'Will be removed in next major version')
  AnalyzeIamPolicyRequest_Options copyWith(void Function(AnalyzeIamPolicyRequest_Options) updates) => super.copyWith((message) => updates(message as AnalyzeIamPolicyRequest_Options)) as AnalyzeIamPolicyRequest_Options; // ignore: deprecated_member_use
  $pb.BuilderInfo get info_ => _i;
  @$core.pragma('dart2js:noInline')
  static AnalyzeIamPolicyRequest_Options create() => AnalyzeIamPolicyRequest_Options._();
  AnalyzeIamPolicyRequest_Options createEmptyInstance() => create();
  static $pb.PbList<AnalyzeIamPolicyRequest_Options> createRepeated() => $pb.PbList<AnalyzeIamPolicyRequest_Options>();
  @$core.pragma('dart2js:noInline')
  static AnalyzeIamPolicyRequest_Options getDefault() => _defaultInstance ??= $pb.GeneratedMessage.$_defaultFor<AnalyzeIamPolicyRequest_Options>(create);
  ...
  @$pb.TagNumber(7)
  set executionTimeout($3.Duration v) { setField(7, v); }
  @$pb.TagNumber(7)
...
class AnalyzeIamPolicyRequest extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'AnalyzeIamPolicyRequest', package: const $pb.PackageName(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'google.cloud.asset.v1p4beta1'), createEmptyInstance: create)
    ...
    ..aOM<AnalyzeIamPolicyRequest_Options>(2, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'options', subBuilder: AnalyzeIamPolicyRequest_Options.create)
    ..hasRequiredFields = false
  ;
  ...
  @$pb.TagNumber(2)
  set options(AnalyzeIamPolicyRequest_Options v) { setField(2, v); }
  @$pb.TagNumber(2)
...
class AnalyzeIamPolicyResponse_IamPolicyAnalysis extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'AnalyzeIamPolicyResponse.IamPolicyAnalysis', package: const $pb.PackageName(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'google.cloud.asset.v1p4beta1'), createEmptyInstance: create)
    ..aOM<IamPolicyAnalysisQuery>(1, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'analysisQuery', subBuilder: IamPolicyAnalysisQuery.create)
...
class AnalyzeIamPolicyResponse extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'AnalyzeIamPolicyResponse', package: const $pb.PackageName(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'google.cloud.asset.v1p4beta1'), createEmptyInstance: create)
    ...
    ..aOB(3, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'fullyExplored')
    ..pc<$4.IamPolicyAnalysisResult_AnalysisState>(4, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'nonCriticalErrors', $pb.PbFieldType.PM, subBuilder: $4.IamPolicyAnalysisResult_AnalysisState.create)
    ..hasRequiredFields = false
  ;
  ...
  @$pb.TagNumber(4)
  $core.List<$4.IamPolicyAnalysisResult_AnalysisState> get nonCriticalErrors => $_getList(3);
}

class IamPolicyAnalysisOutputConfig_GcsDestination extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'IamPolicyAnalysisOutputConfig.GcsDestination', package: const $pb.PackageName(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'google.cloud.asset.v1p4beta1'), createEmptyInstance: create)
...
class IamPolicyAnalysisOutputConfig extends $pb.GeneratedMessage {
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'IamPolicyAnalysisOutputConfig', package: const $pb.PackageName(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'google.cloud.asset.v1p4beta1'), createEmptyInstance: create)
    ..oo(0, [1])
...
class ExportIamPolicyAnalysisRequest_Options extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'ExportIamPolicyAnalysisRequest.Options', package: const $pb.PackageName(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'google.cloud.asset.v1p4beta1'), createEmptyInstance: create)
    ..aOB(1, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'expandGroups')
    ..aOB(2, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'expandRoles')
    ..aOB(3, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'expandResources')
    ..aOB(4, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'outputResourceEdges')
  ...
  factory ExportIamPolicyAnalysisRequest_Options.fromBuffer($core.List<$core.int> i, [$pb.ExtensionRegistry r = $pb.ExtensionRegistry.EMPTY]) => create()..mergeFromBuffer(i, r);
  factory ExportIamPolicyAnalysisRequest_Options.fromJson($core.String i, [$pb.ExtensionRegistry r = $pb.ExtensionRegistry.EMPTY]) => create()..mergeFromJson(i, r);
  @$core.Deprecated(
  'Using this can add significant overhead to your binary. '
  'Use [GeneratedMessageGenericExtensions.deepCopy] instead. '
  'Will be removed in next major version')
  ExportIamPolicyAnalysisRequest_Options clone() => ExportIamPolicyAnalysisRequest_Options()..mergeFromMessage(this);
  @$core.Deprecated(
  'Using this can add significant overhead to your binary. '
  'Use [GeneratedMessageGenericExtensions.rebuild] instead. '
  'Will be removed in next major version')
  ExportIamPolicyAnalysisRequest_Options copyWith(void Function(ExportIamPolicyAnalysisRequest_Options) updates) => super.copyWith((message) => updates(message as ExportIamPolicyAnalysisRequest_Options)) as ExportIamPolicyAnalysisRequest_Options; // ignore: deprecated_member_use
  $pb.BuilderInfo get info_ => _i;
  @$core.pragma('dart2js:noInline')
  static ExportIamPolicyAnalysisRequest_Options create() => ExportIamPolicyAnalysisRequest_Options._();
  ExportIamPolicyAnalysisRequest_Options createEmptyInstance() => create();
  static $pb.PbList<ExportIamPolicyAnalysisRequest_Options> createRepeated() => $pb.PbList<ExportIamPolicyAnalysisRequest_Options>();
  @$core.pragma('dart2js:noInline')
  static ExportIamPolicyAnalysisRequest_Options getDefault() => _defaultInstance ??= $pb.GeneratedMessage.$_defaultFor<ExportIamPolicyAnalysisRequest_Options>(create);
...
class ExportIamPolicyAnalysisRequest extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'ExportIamPolicyAnalysisRequest', package: const $pb.PackageName(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'google.cloud.asset.v1p4beta1'), createEmptyInstance: create)
    ..aOM<IamPolicyAnalysisQuery>(1, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'analysisQuery', subBuilder: IamPolicyAnalysisQuery.create)
    ..aOM<ExportIamPolicyAnalysisRequest_Options>(2, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'options', subBuilder: ExportIamPolicyAnalysisRequest_Options.create)
    ..aOM<IamPolicyAnalysisOutputConfig>(3, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'outputConfig', subBuilder: IamPolicyAnalysisOutputConfig.create)
    ..hasRequiredFields = false
  ;
  ...
  factory ExportIamPolicyAnalysisRequest.fromBuffer($core.List<$core.int> i, [$pb.ExtensionRegistry r = $pb.ExtensionRegistry.EMPTY]) => create()..mergeFromBuffer(i, r);
  factory ExportIamPolicyAnalysisRequest.fromJson($core.String i, [$pb.ExtensionRegistry r = $pb.ExtensionRegistry.EMPTY]) => create()..mergeFromJson(i, r);
  @$core.Deprecated(
  'Using this can add significant overhead to your binary. '
  'Use [GeneratedMessageGenericExtensions.deepCopy] instead. '
  'Will be removed in next major version')
  ExportIamPolicyAnalysisRequest clone() => ExportIamPolicyAnalysisRequest()..mergeFromMessage(this);
  @$core.Deprecated(
  'Using this can add significant overhead to your binary. '
  'Use [GeneratedMessageGenericExtensions.rebuild] instead. '
  'Will be removed in next major version')
  ExportIamPolicyAnalysisRequest copyWith(void Function(ExportIamPolicyAnalysisRequest) updates) => super.copyWith((message) => updates(message as ExportIamPolicyAnalysisRequest)) as ExportIamPolicyAnalysisRequest; // ignore: deprecated_member_use
  $pb.BuilderInfo get info_ => _i;
  @$core.pragma('dart2js:noInline')
  static ExportIamPolicyAnalysisRequest create() => ExportIamPolicyAnalysisRequest._();
  ExportIamPolicyAnalysisRequest createEmptyInstance() => create();
  static $pb.PbList<ExportIamPolicyAnalysisRequest> createRepeated() => $pb.PbList<ExportIamPolicyAnalysisRequest>();
  @$core.pragma('dart2js:noInline')
  static ExportIamPolicyAnalysisRequest getDefault() => _defaultInstance ??= $pb.GeneratedMessage.$_defaultFor<ExportIamPolicyAnalysisRequest>(create);
  ...
  @$pb.TagNumber(2)
  set options(ExportIamPolicyAnalysisRequest_Options v) { setField(2, v); }
  @$pb.TagNumber(2)
  $core.bool hasOptions() => $_has(1);
  @$pb.TagNumber(2)
  void clearOptions() => clearField(2);
  ...
  @$pb.TagNumber(3)
  set outputConfig(IamPolicyAnalysisOutputConfig v) { setField(3, v); }
  @$pb.TagNumber(3)
...
class ExportIamPolicyAnalysisResponse extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'ExportIamPolicyAnalysisResponse', package: const $pb.PackageName(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'google.cloud.asset.v1p4beta1'), createEmptyInstance: create)
    ..aOM<IamPolicyAnalysisOutputConfig>(1, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'outputConfig', subBuilder: IamPolicyAnalysisOutputConfig.create)
    ..hasRequiredFields = false
  ;
  ...
  factory ExportIamPolicyAnalysisResponse.fromBuffer($core.List<$core.int> i, [$pb.ExtensionRegistry r = $pb.ExtensionRegistry.EMPTY]) => create()..mergeFromBuffer(i, r);
  factory ExportIamPolicyAnalysisResponse.fromJson($core.String i, [$pb.ExtensionRegistry r = $pb.ExtensionRegistry.EMPTY]) => create()..mergeFromJson(i, r);
  @$core.Deprecated(
  'Using this can add significant overhead to your binary. '
  'Use [GeneratedMessageGenericExtensions.deepCopy] instead. '
  'Will be removed in next major version')
  ExportIamPolicyAnalysisResponse clone() => ExportIamPolicyAnalysisResponse()..mergeFromMessage(this);
  @$core.Deprecated(
  'Using this can add significant overhead to your binary. '
  'Use [GeneratedMessageGenericExtensions.rebuild] instead. '
  'Will be removed in next major version')
  ExportIamPolicyAnalysisResponse copyWith(void Function(ExportIamPolicyAnalysisResponse) updates) => super.copyWith((message) => updates(message as ExportIamPolicyAnalysisResponse)) as ExportIamPolicyAnalysisResponse; // ignore: deprecated_member_use
  $pb.BuilderInfo get info_ => _i;
  @$core.pragma('dart2js:noInline')
  static ExportIamPolicyAnalysisResponse create() => ExportIamPolicyAnalysisResponse._();
  ExportIamPolicyAnalysisResponse createEmptyInstance() => create();
  static $pb.PbList<ExportIamPolicyAnalysisResponse> createRepeated() => $pb.PbList<ExportIamPolicyAnalysisResponse>();
  @$core.pragma('dart2js:noInline')
  static ExportIamPolicyAnalysisResponse getDefault() => _defaultInstance ??= $pb.GeneratedMessage.$_defaultFor<ExportIamPolicyAnalysisResponse>(create);
  static ExportIamPolicyAnalysisResponse? _defaultInstance;

  @$pb.TagNumber(1)
  IamPolicyAnalysisOutputConfig get outputConfig => $_getN(0);
  @$pb.TagNumber(1)
  set outputConfig(IamPolicyAnalysisOutputConfig v) { setField(1, v); }
  @$pb.TagNumber(1)

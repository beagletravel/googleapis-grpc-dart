...
class IamPolicyAnalysisResult_AnalysisState extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'IamPolicyAnalysisResult.AnalysisState', package: const $pb.PackageName(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'google.cloud.asset.v1p4beta1'), createEmptyInstance: create)
    ..e<$1.Code>(1, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'code', $pb.PbFieldType.OE, defaultOrMaker: $1.Code.OK, valueOf: $1.Code.valueOf, enumValues: $1.Code.values)
  ...
  factory IamPolicyAnalysisResult_AnalysisState.fromBuffer($core.List<$core.int> i, [$pb.ExtensionRegistry r = $pb.ExtensionRegistry.EMPTY]) => create()..mergeFromBuffer(i, r);
  factory IamPolicyAnalysisResult_AnalysisState.fromJson($core.String i, [$pb.ExtensionRegistry r = $pb.ExtensionRegistry.EMPTY]) => create()..mergeFromJson(i, r);
  @$core.Deprecated(
  'Using this can add significant overhead to your binary. '
  'Use [GeneratedMessageGenericExtensions.deepCopy] instead. '
  'Will be removed in next major version')
  IamPolicyAnalysisResult_AnalysisState clone() => IamPolicyAnalysisResult_AnalysisState()..mergeFromMessage(this);
  @$core.Deprecated(
  'Using this can add significant overhead to your binary. '
  'Use [GeneratedMessageGenericExtensions.rebuild] instead. '
  'Will be removed in next major version')
  IamPolicyAnalysisResult_AnalysisState copyWith(void Function(IamPolicyAnalysisResult_AnalysisState) updates) => super.copyWith((message) => updates(message as IamPolicyAnalysisResult_AnalysisState)) as IamPolicyAnalysisResult_AnalysisState; // ignore: deprecated_member_use
  $pb.BuilderInfo get info_ => _i;
  @$core.pragma('dart2js:noInline')
  static IamPolicyAnalysisResult_AnalysisState create() => IamPolicyAnalysisResult_AnalysisState._();
  IamPolicyAnalysisResult_AnalysisState createEmptyInstance() => create();
  static $pb.PbList<IamPolicyAnalysisResult_AnalysisState> createRepeated() => $pb.PbList<IamPolicyAnalysisResult_AnalysisState>();
  @$core.pragma('dart2js:noInline')
  static IamPolicyAnalysisResult_AnalysisState getDefault() => _defaultInstance ??= $pb.GeneratedMessage.$_defaultFor<IamPolicyAnalysisResult_AnalysisState>(create);
  static IamPolicyAnalysisResult_AnalysisState? _defaultInstance;

  @$pb.TagNumber(1)
  $1.Code get code => $_getN(0);
  @$pb.TagNumber(1)
  set code($1.Code v) { setField(1, v); }
  @$pb.TagNumber(1)
...
class IamPolicyAnalysisResult_Resource extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'IamPolicyAnalysisResult.Resource', package: const $pb.PackageName(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'google.cloud.asset.v1p4beta1'), createEmptyInstance: create)
    ..aOS(1, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'fullResourceName')
    ..aOM<IamPolicyAnalysisResult_AnalysisState>(2, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'analysisState', subBuilder: IamPolicyAnalysisResult_AnalysisState.create)
    ..hasRequiredFields = false
  ;
  ...
  @$pb.TagNumber(2)
  set analysisState(IamPolicyAnalysisResult_AnalysisState v) { setField(2, v); }
  @$pb.TagNumber(2)
...
class IamPolicyAnalysisResult_Access extends $pb.GeneratedMessage {
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'IamPolicyAnalysisResult.Access', package: const $pb.PackageName(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'google.cloud.asset.v1p4beta1'), createEmptyInstance: create)
    ..oo(0, [1, 2])
    ...
    ..aOM<IamPolicyAnalysisResult_AnalysisState>(3, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'analysisState', subBuilder: IamPolicyAnalysisResult_AnalysisState.create)
    ..hasRequiredFields = false
  ;
  ...
  @$pb.TagNumber(3)
  set analysisState(IamPolicyAnalysisResult_AnalysisState v) { setField(3, v); }
  @$pb.TagNumber(3)
...
class IamPolicyAnalysisResult_Edge extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'IamPolicyAnalysisResult.Edge', package: const $pb.PackageName(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'google.cloud.asset.v1p4beta1'), createEmptyInstance: create)
...
class IamPolicyAnalysisResult_Identity extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'IamPolicyAnalysisResult.Identity', package: const $pb.PackageName(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'google.cloud.asset.v1p4beta1'), createEmptyInstance: create)
...
class IamPolicyAnalysisResult_AccessControlList extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'IamPolicyAnalysisResult.AccessControlList', package: const $pb.PackageName(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'google.cloud.asset.v1p4beta1'), createEmptyInstance: create)
...
class IamPolicyAnalysisResult_IdentityList extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'IamPolicyAnalysisResult.IdentityList', package: const $pb.PackageName(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'google.cloud.asset.v1p4beta1'), createEmptyInstance: create)
...
class IamPolicyAnalysisResult extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'IamPolicyAnalysisResult', package: const $pb.PackageName(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'google.cloud.asset.v1p4beta1'), createEmptyInstance: create)
    ..aOS(1, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'attachedResourceFullName')
    ..aOM<$0.Binding>(2, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'iamBinding', subBuilder: $0.Binding.create)
  ...
  @$pb.TagNumber(2)
  set iamBinding($0.Binding v) { setField(2, v); }
  @$pb.TagNumber(2)

...
const IamPolicyAnalysisQuery$json = const {
  ...
  '2': const [
    ...
    const {'1': 'resource_selector', '3': 2, '4': 1, '5': 11, '6': '.google.cloud.asset.v1p4beta1.IamPolicyAnalysisQuery.ResourceSelector', '8': const {}, '10': 'resourceSelector'},
    const {'1': 'identity_selector', '3': 3, '4': 1, '5': 11, '6': '.google.cloud.asset.v1p4beta1.IamPolicyAnalysisQuery.IdentitySelector', '8': const {}, '10': 'identitySelector'},
    const {'1': 'access_selector', '3': 4, '4': 1, '5': 11, '6': '.google.cloud.asset.v1p4beta1.IamPolicyAnalysisQuery.AccessSelector', '8': const {}, '10': 'accessSelector'},
  ],
  '3': const [IamPolicyAnalysisQuery_ResourceSelector$json, IamPolicyAnalysisQuery_IdentitySelector$json, IamPolicyAnalysisQuery_AccessSelector$json],
};
...
const AnalyzeIamPolicyRequest$json = const {
  ...
  '2': const [
    const {'1': 'analysis_query', '3': 1, '4': 1, '5': 11, '6': '.google.cloud.asset.v1p4beta1.IamPolicyAnalysisQuery', '8': const {}, '10': 'analysisQuery'},
    const {'1': 'options', '3': 2, '4': 1, '5': 11, '6': '.google.cloud.asset.v1p4beta1.AnalyzeIamPolicyRequest.Options', '8': const {}, '10': 'options'},
  ],
...
const AnalyzeIamPolicyResponse$json = const {
  ...
  '2': const [
    const {'1': 'main_analysis', '3': 1, '4': 1, '5': 11, '6': '.google.cloud.asset.v1p4beta1.AnalyzeIamPolicyResponse.IamPolicyAnalysis', '10': 'mainAnalysis'},
    const {'1': 'service_account_impersonation_analysis', '3': 2, '4': 3, '5': 11, '6': '.google.cloud.asset.v1p4beta1.AnalyzeIamPolicyResponse.IamPolicyAnalysis', '10': 'serviceAccountImpersonationAnalysis'},
    const {'1': 'fully_explored', '3': 3, '4': 1, '5': 8, '10': 'fullyExplored'},
    const {'1': 'non_critical_errors', '3': 4, '4': 3, '5': 11, '6': '.google.cloud.asset.v1p4beta1.IamPolicyAnalysisResult.AnalysisState', '10': 'nonCriticalErrors'},
  ],
...
const AnalyzeIamPolicyResponse_IamPolicyAnalysis$json = const {
  '1': 'IamPolicyAnalysis',
  '2': const [
    const {'1': 'analysis_query', '3': 1, '4': 1, '5': 11, '6': '.google.cloud.asset.v1p4beta1.IamPolicyAnalysisQuery', '10': 'analysisQuery'},
    const {'1': 'analysis_results', '3': 2, '4': 3, '5': 11, '6': '.google.cloud.asset.v1p4beta1.IamPolicyAnalysisResult', '10': 'analysisResults'},
    const {'1': 'fully_explored', '3': 3, '4': 1, '5': 8, '10': 'fullyExplored'},
  ],
};

/// Descriptor for `AnalyzeIamPolicyResponse`. Decode as a `google.protobuf.DescriptorProto`.
final $typed_data.Uint8List analyzeIamPolicyResponseDescriptor = $convert.base64Decode('');
...
const IamPolicyAnalysisOutputConfig$json = const {
  ...
  '2': const [
    const {'1': 'gcs_destination', '3': 1, '4': 1, '5': 11, '6': '.google.cloud.asset.v1p4beta1.IamPolicyAnalysisOutputConfig.GcsDestination', '9': 0, '10': 'gcsDestination'},
  ],
...
final $typed_data.Uint8List iamPolicyAnalysisOutputConfigDescriptor = $convert.base64Decode('');
...
const ExportIamPolicyAnalysisRequest$json = const {
  ...
  '2': const [
    const {'1': 'analysis_query', '3': 1, '4': 1, '5': 11, '6': '.google.cloud.asset.v1p4beta1.IamPolicyAnalysisQuery', '8': const {}, '10': 'analysisQuery'},
    const {'1': 'options', '3': 2, '4': 1, '5': 11, '6': '.google.cloud.asset.v1p4beta1.ExportIamPolicyAnalysisRequest.Options', '8': const {}, '10': 'options'},
    const {'1': 'output_config', '3': 3, '4': 1, '5': 11, '6': '.google.cloud.asset.v1p4beta1.IamPolicyAnalysisOutputConfig', '8': const {}, '10': 'outputConfig'},
  ],
...
const ExportIamPolicyAnalysisResponse$json = const {
  ...
  '2': const [
    const {'1': 'output_config', '3': 1, '4': 1, '5': 11, '6': '.google.cloud.asset.v1p4beta1.IamPolicyAnalysisOutputConfig', '10': 'outputConfig'},
  ],
};

/// Descriptor for `ExportIamPolicyAnalysisResponse`. Decode as a `google.protobuf.DescriptorProto`.
final $typed_data.Uint8List exportIamPolicyAnalysisResponseDescriptor = $convert.base64Decode('Ch9FeHBvcnRJYW1Qb2xpY3lBbmFseXNpc1Jlc3BvbnNlEmAKDW91dHB1dF9jb25maWcYASABKAsyOy5nb29nbGUuY2xvdWQuYXNzZXQudjFwNGJldGExLklhbVBvbGljeUFuYWx5c2lzT3V0cHV0Q29uZmlnUgxvdXRwdXRDb25maWc=');

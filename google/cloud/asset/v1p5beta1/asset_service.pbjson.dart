...
final $typed_data.Uint8List contentTypeDescriptor = $convert.base64Decode('CgtDb250ZW50VHlwZRIcChhDT05URU5UX1RZUEVfVU5TUEVDSUZJRUQQABIMCghSRVNPVVJDRRABEg4KCklBTV9QT0xJQ1kQAhIOCgpPUkdfUE9MSUNZEAQSEQoNQUNDRVNTX1BPTElDWRAF');
...
const ListAssetsRequest$json = const {
  ...
  '2': const [
    ...
    const {'1': 'content_type', '3': 4, '4': 1, '5': 14, '6': '.google.cloud.asset.v1p5beta1.ContentType', '10': 'contentType'},
...
final $typed_data.Uint8List listAssetsRequestDescriptor = $convert.base64Decode('');
...
const ListAssetsResponse$json = const {
  ...
  '2': const [
    ...
    const {'1': 'assets', '3': 2, '4': 3, '5': 11, '6': '.google.cloud.asset.v1p5beta1.Asset', '10': 'assets'},
...
final $typed_data.Uint8List listAssetsResponseDescriptor = $convert.base64Decode('ChJMaXN0QXNzZXRzUmVzcG9uc2USNwoJcmVhZF90aW1lGAEgASgLMhouZ29vZ2xlLnByb3RvYnVmLlRpbWVzdGFtcFIIcmVhZFRpbWUSOwoGYXNzZXRzGAIgAygLMiMuZ29vZ2xlLmNsb3VkLmFzc2V0LnYxcDViZXRhMS5Bc3NldFIGYXNzZXRzEiYKD25leHRfcGFnZV90b2tlbhgDIAEoCVINbmV4dFBhZ2VUb2tlbg==');

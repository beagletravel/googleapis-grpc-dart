...
class Asset extends $pb.GeneratedMessage {
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'Asset', package: const $pb.PackageName(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'google.cloud.asset.v1p5beta1'), createEmptyInstance: create)
    ..oo(0, [7, 8, 9])
...
class Resource extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'Resource', package: const $pb.PackageName(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'google.cloud.asset.v1p5beta1'), createEmptyInstance: create)
    ...
    ..aOM<$5.Struct>(6, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'data', subBuilder: $5.Struct.create)
    ..hasRequiredFields = false
  ;
  ...
  @$pb.TagNumber(6)
  set data($5.Struct v) { setField(6, v); }
  @$pb.TagNumber(6)

...
class KeyRing extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'KeyRing', package: const $pb.PackageName(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'google.cloud.kms.v1'), createEmptyInstance: create)
  ...
  'Will be removed in next major version')
  KeyRing copyWith(void Function(KeyRing) updates) => super.copyWith((message) => updates(message as KeyRing)) as KeyRing; // ignore: deprecated_member_use
...
class CryptoKey extends $pb.GeneratedMessage {
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'CryptoKey', package: const $pb.PackageName(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'google.cloud.kms.v1'), createEmptyInstance: create)
    ..oo(0, [8])
    ..aOS(1, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'name')
    ..aOM<CryptoKeyVersion>(2, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'primary', subBuilder: CryptoKeyVersion.create)
    ..e<CryptoKey_CryptoKeyPurpose>(3, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'purpose', $pb.PbFieldType.OE, defaultOrMaker: CryptoKey_CryptoKeyPurpose.CRYPTO_KEY_PURPOSE_UNSPECIFIED, valueOf: CryptoKey_CryptoKeyPurpose.valueOf, enumValues: CryptoKey_CryptoKeyPurpose.values)
    ..aOM<$0.Timestamp>(5, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'createTime', subBuilder: $0.Timestamp.create)
    ..aOM<$0.Timestamp>(7, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'nextRotationTime', subBuilder: $0.Timestamp.create)
    ..aOM<$1.Duration>(8, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'rotationPeriod', subBuilder: $1.Duration.create)
    ..m<$core.String, $core.String>(10, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'labels', entryClassName: 'CryptoKey.LabelsEntry', keyFieldType: $pb.PbFieldType.OS, valueFieldType: $pb.PbFieldType.OS, packageName: const $pb.PackageName('google.cloud.kms.v1'))
    ..aOM<CryptoKeyVersionTemplate>(11, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'versionTemplate', subBuilder: CryptoKeyVersionTemplate.create)
    ..aOB(13, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'importOnly')
    ..aOM<$1.Duration>(14, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'destroyScheduledDuration', subBuilder: $1.Duration.create)
    ..aOS(15, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'cryptoKeyBackend')
    ..hasRequiredFields = false
  ;
  ...
  factory CryptoKey({
    ...
    if (cryptoKeyBackend != null) {
      _result.cryptoKeyBackend = cryptoKeyBackend;
    }
    return _result;
  }
  ...
  @$pb.TagNumber(14)
  set destroyScheduledDuration($1.Duration v) { setField(14, v); }
  @$pb.TagNumber(14)
...
class CryptoKeyVersionTemplate extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'CryptoKeyVersionTemplate', package: const $pb.PackageName(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'google.cloud.kms.v1'), createEmptyInstance: create)
    ..e<ProtectionLevel>(1, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'protectionLevel', $pb.PbFieldType.OE, defaultOrMaker: ProtectionLevel.PROTECTION_LEVEL_UNSPECIFIED, valueOf: ProtectionLevel.valueOf, enumValues: ProtectionLevel.values)
    ..e<CryptoKeyVersion_CryptoKeyVersionAlgorithm>(3, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'algorithm', $pb.PbFieldType.OE, defaultOrMaker: CryptoKeyVersion_CryptoKeyVersionAlgorithm.CRYPTO_KEY_VERSION_ALGORITHM_UNSPECIFIED, valueOf: CryptoKeyVersion_CryptoKeyVersionAlgorithm.valueOf, enumValues: CryptoKeyVersion_CryptoKeyVersionAlgorithm.values)
    ..hasRequiredFields = false
  ;
  ...
  'Use [GeneratedMessageGenericExtensions.rebuild] instead. '
  'Will be removed in next major version')
  CryptoKeyVersionTemplate copyWith(void Function(CryptoKeyVersionTemplate) updates) => super.copyWith((message) => updates(message as CryptoKeyVersionTemplate)) as CryptoKeyVersionTemplate; // ignore: deprecated_member_use
  $pb.BuilderInfo get info_ => _i;
  @$core.pragma('dart2js:noInline')
...
class KeyOperationAttestation_CertificateChains extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'KeyOperationAttestation.CertificateChains', package: const $pb.PackageName(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'google.cloud.kms.v1'), createEmptyInstance: create)
    ..pPS(1, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'caviumCerts')
    ..pPS(2, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'googleCardCerts')
    ..pPS(3, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'googlePartitionCerts')
    ..hasRequiredFields = false
  ;
  ...
  factory KeyOperationAttestation_CertificateChains({
    ...
    final _result = create();
    if (caviumCerts != null) {
      _result.caviumCerts.addAll(caviumCerts);
    }
    if (googleCardCerts != null) {
      _result.googleCardCerts.addAll(googleCardCerts);
    }
    if (googlePartitionCerts != null) {
      _result.googlePartitionCerts.addAll(googlePartitionCerts);
    }
    return _result;
  }
  ...
  'Use [GeneratedMessageGenericExtensions.rebuild] instead. '
  'Will be removed in next major version')
  KeyOperationAttestation_CertificateChains copyWith(void Function(KeyOperationAttestation_CertificateChains) updates) => super.copyWith((message) => updates(message as KeyOperationAttestation_CertificateChains)) as KeyOperationAttestation_CertificateChains; // ignore: deprecated_member_use
  $pb.BuilderInfo get info_ => _i;
  @$core.pragma('dart2js:noInline')
...
class KeyOperationAttestation extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'KeyOperationAttestation', package: const $pb.PackageName(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'google.cloud.kms.v1'), createEmptyInstance: create)
    ..e<KeyOperationAttestation_AttestationFormat>(4, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'format', $pb.PbFieldType.OE, defaultOrMaker: KeyOperationAttestation_AttestationFormat.ATTESTATION_FORMAT_UNSPECIFIED, valueOf: KeyOperationAttestation_AttestationFormat.valueOf, enumValues: KeyOperationAttestation_AttestationFormat.values)
    ..a<$core.List<$core.int>>(5, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'content', $pb.PbFieldType.OY)
    ..aOM<KeyOperationAttestation_CertificateChains>(6, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'certChains', subBuilder: KeyOperationAttestation_CertificateChains.create)
    ..hasRequiredFields = false
  ;
  ...
  'Use [GeneratedMessageGenericExtensions.rebuild] instead. '
  'Will be removed in next major version')
  KeyOperationAttestation copyWith(void Function(KeyOperationAttestation) updates) => super.copyWith((message) => updates(message as KeyOperationAttestation)) as KeyOperationAttestation; // ignore: deprecated_member_use
  $pb.BuilderInfo get info_ => _i;
  @$core.pragma('dart2js:noInline')
...
class CryptoKeyVersion extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'CryptoKeyVersion', package: const $pb.PackageName(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'google.cloud.kms.v1'), createEmptyInstance: create)
    ..aOS(1, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'name')
    ..e<CryptoKeyVersion_CryptoKeyVersionState>(3, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'state', $pb.PbFieldType.OE, defaultOrMaker: CryptoKeyVersion_CryptoKeyVersionState.CRYPTO_KEY_VERSION_STATE_UNSPECIFIED, valueOf: CryptoKeyVersion_CryptoKeyVersionState.valueOf, enumValues: CryptoKeyVersion_CryptoKeyVersionState.values)
    ..aOM<$0.Timestamp>(4, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'createTime', subBuilder: $0.Timestamp.create)
    ..aOM<$0.Timestamp>(5, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'destroyTime', subBuilder: $0.Timestamp.create)
    ..aOM<$0.Timestamp>(6, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'destroyEventTime', subBuilder: $0.Timestamp.create)
    ..e<ProtectionLevel>(7, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'protectionLevel', $pb.PbFieldType.OE, defaultOrMaker: ProtectionLevel.PROTECTION_LEVEL_UNSPECIFIED, valueOf: ProtectionLevel.valueOf, enumValues: ProtectionLevel.values)
    ..aOM<KeyOperationAttestation>(8, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'attestation', subBuilder: KeyOperationAttestation.create)
    ..e<CryptoKeyVersion_CryptoKeyVersionAlgorithm>(10, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'algorithm', $pb.PbFieldType.OE, defaultOrMaker: CryptoKeyVersion_CryptoKeyVersionAlgorithm.CRYPTO_KEY_VERSION_ALGORITHM_UNSPECIFIED, valueOf: CryptoKeyVersion_CryptoKeyVersionAlgorithm.valueOf, enumValues: CryptoKeyVersion_CryptoKeyVersionAlgorithm.values)
    ..aOM<$0.Timestamp>(11, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'generateTime', subBuilder: $0.Timestamp.create)
    ..aOS(14, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'importJob')
    ..aOM<$0.Timestamp>(15, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'importTime', subBuilder: $0.Timestamp.create)
    ..aOS(16, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'importFailureReason')
    ..aOM<ExternalProtectionLevelOptions>(17, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'externalProtectionLevelOptions', subBuilder: ExternalProtectionLevelOptions.create)
    ..aOB(18, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'reimportEligible')
    ..hasRequiredFields = false
  ;
  ...
  'Use [GeneratedMessageGenericExtensions.rebuild] instead. '
  'Will be removed in next major version')
  CryptoKeyVersion copyWith(void Function(CryptoKeyVersion) updates) => super.copyWith((message) => updates(message as CryptoKeyVersion)) as CryptoKeyVersion; // ignore: deprecated_member_use
  $pb.BuilderInfo get info_ => _i;
  @$core.pragma('dart2js:noInline')
  ...
  @$pb.TagNumber(15)
  set importTime($0.Timestamp v) { setField(15, v); }
  @$pb.TagNumber(15)
...
class PublicKey extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'PublicKey', package: const $pb.PackageName(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'google.cloud.kms.v1'), createEmptyInstance: create)
    ..aOS(1, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'pem')
    ..e<CryptoKeyVersion_CryptoKeyVersionAlgorithm>(2, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'algorithm', $pb.PbFieldType.OE, defaultOrMaker: CryptoKeyVersion_CryptoKeyVersionAlgorithm.CRYPTO_KEY_VERSION_ALGORITHM_UNSPECIFIED, valueOf: CryptoKeyVersion_CryptoKeyVersionAlgorithm.valueOf, enumValues: CryptoKeyVersion_CryptoKeyVersionAlgorithm.values)
    ..aOM<$2.Int64Value>(3, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'pemCrc32c', subBuilder: $2.Int64Value.create)
    ..aOS(4, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'name')
    ..e<ProtectionLevel>(5, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'protectionLevel', $pb.PbFieldType.OE, defaultOrMaker: ProtectionLevel.PROTECTION_LEVEL_UNSPECIFIED, valueOf: ProtectionLevel.valueOf, enumValues: ProtectionLevel.values)
    ..hasRequiredFields = false
  ;
  ...
  @$pb.TagNumber(3)
  set pemCrc32c($2.Int64Value v) { setField(3, v); }
  @$pb.TagNumber(3)
...
class ImportJob_WrappingPublicKey extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'ImportJob.WrappingPublicKey', package: const $pb.PackageName(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'google.cloud.kms.v1'), createEmptyInstance: create)
    ..aOS(1, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'pem')
    ..hasRequiredFields = false
  ;
  ...
  'Use [GeneratedMessageGenericExtensions.rebuild] instead. '
  'Will be removed in next major version')
  ImportJob_WrappingPublicKey copyWith(void Function(ImportJob_WrappingPublicKey) updates) => super.copyWith((message) => updates(message as ImportJob_WrappingPublicKey)) as ImportJob_WrappingPublicKey; // ignore: deprecated_member_use
  $pb.BuilderInfo get info_ => _i;
  @$core.pragma('dart2js:noInline')
...
class ImportJob extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'ImportJob', package: const $pb.PackageName(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'google.cloud.kms.v1'), createEmptyInstance: create)
    ..aOS(1, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'name')
    ..e<ImportJob_ImportMethod>(2, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'importMethod', $pb.PbFieldType.OE, defaultOrMaker: ImportJob_ImportMethod.IMPORT_METHOD_UNSPECIFIED, valueOf: ImportJob_ImportMethod.valueOf, enumValues: ImportJob_ImportMethod.values)
    ..aOM<$0.Timestamp>(3, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'createTime', subBuilder: $0.Timestamp.create)
    ..aOM<$0.Timestamp>(4, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'generateTime', subBuilder: $0.Timestamp.create)
    ..aOM<$0.Timestamp>(5, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'expireTime', subBuilder: $0.Timestamp.create)
    ..e<ImportJob_ImportJobState>(6, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'state', $pb.PbFieldType.OE, defaultOrMaker: ImportJob_ImportJobState.IMPORT_JOB_STATE_UNSPECIFIED, valueOf: ImportJob_ImportJobState.valueOf, enumValues: ImportJob_ImportJobState.values)
    ..aOM<ImportJob_WrappingPublicKey>(7, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'publicKey', subBuilder: ImportJob_WrappingPublicKey.create)
    ..aOM<KeyOperationAttestation>(8, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'attestation', subBuilder: KeyOperationAttestation.create)
    ..e<ProtectionLevel>(9, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'protectionLevel', $pb.PbFieldType.OE, defaultOrMaker: ProtectionLevel.PROTECTION_LEVEL_UNSPECIFIED, valueOf: ProtectionLevel.valueOf, enumValues: ProtectionLevel.values)
    ..aOM<$0.Timestamp>(10, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'expireEventTime', subBuilder: $0.Timestamp.create)
    ..hasRequiredFields = false
  ;
  ...
  'Use [GeneratedMessageGenericExtensions.rebuild] instead. '
  'Will be removed in next major version')
  ImportJob copyWith(void Function(ImportJob) updates) => super.copyWith((message) => updates(message as ImportJob)) as ImportJob; // ignore: deprecated_member_use
  $pb.BuilderInfo get info_ => _i;
  @$core.pragma('dart2js:noInline')
  ...
  @$pb.TagNumber(4)
  set generateTime($0.Timestamp v) { setField(4, v); }
  @$pb.TagNumber(4)
  ...
  @$pb.TagNumber(10)
  set expireEventTime($0.Timestamp v) { setField(10, v); }
  @$pb.TagNumber(10)
...
class ExternalProtectionLevelOptions extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'ExternalProtectionLevelOptions', package: const $pb.PackageName(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'google.cloud.kms.v1'), createEmptyInstance: create)
    ..aOS(1, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'externalKeyUri')
    ..aOS(2, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'ekmConnectionKeyPath')
    ..hasRequiredFields = false
  ;
  ...
  factory ExternalProtectionLevelOptions({
    ...
    if (ekmConnectionKeyPath != null) {
      _result.ekmConnectionKeyPath = ekmConnectionKeyPath;
    }
    return _result;
  }
  ...
  'Use [GeneratedMessageGenericExtensions.rebuild] instead. '
  'Will be removed in next major version')
  ExternalProtectionLevelOptions copyWith(void Function(ExternalProtectionLevelOptions) updates) => super.copyWith((message) => updates(message as ExternalProtectionLevelOptions)) as ExternalProtectionLevelOptions; // ignore: deprecated_member_use
  $pb.BuilderInfo get info_ => _i;
  @$core.pragma('dart2js:noInline')

...
final $typed_data.Uint8List annotationSourceDescriptor = $convert.base64Decode('ChBBbm5vdGF0aW9uU291cmNlEiEKHUFOTk9UQVRJT05fU09VUkNFX1VOU1BFQ0lGSUVEEAASDAoIT1BFUkFUT1IQAw==');
...
final $typed_data.Uint8List annotationSentimentDescriptor = $convert.base64Decode('ChNBbm5vdGF0aW9uU2VudGltZW50EiQKIEFOTk9UQVRJT05fU0VOVElNRU5UX1VOU1BFQ0lGSUVEEAASDAoITkVHQVRJVkUQARIMCghQT1NJVElWRRAC');
...
final $typed_data.Uint8List annotationTypeDescriptor = $convert.base64Decode('');
...
final $typed_data.Uint8List annotationDescriptor = $convert.base64Decode('');
...
const AnnotationValue$json = const {
  ...
  '2': const [
    ...
    const {'1': 'text_entity_extraction_annotation', '3': 10, '4': 1, '5': 11, '6': '.google.cloud.datalabeling.v1beta1.TextEntityExtractionAnnotation', '9': 0, '10': 'textEntityExtractionAnnotation'},
...
final $typed_data.Uint8List imageClassificationAnnotationDescriptor = $convert.base64Decode('Ch1JbWFnZUNsYXNzaWZpY2F0aW9uQW5ub3RhdGlvbhJaCg9hbm5vdGF0aW9uX3NwZWMYASABKAsyMS5nb29nbGUuY2xvdWQuZGF0YWxhYmVsaW5nLnYxYmV0YTEuQW5ub3RhdGlvblNwZWNSDmFubm90YXRpb25TcGVj');
...
final $typed_data.Uint8List boundingPolyDescriptor = $convert.base64Decode('CgxCb3VuZGluZ1BvbHkSRQoIdmVydGljZXMYASADKAsyKS5nb29nbGUuY2xvdWQuZGF0YWxhYmVsaW5nLnYxYmV0YTEuVmVydGV4Ugh2ZXJ0aWNlcw==');
...
final $typed_data.Uint8List normalizedBoundingPolyDescriptor = $convert.base64Decode('ChZOb3JtYWxpemVkQm91bmRpbmdQb2x5EmQKE25vcm1hbGl6ZWRfdmVydGljZXMYASADKAsyMy5nb29nbGUuY2xvdWQuZGF0YWxhYmVsaW5nLnYxYmV0YTEuTm9ybWFsaXplZFZlcnRleFISbm9ybWFsaXplZFZlcnRpY2Vz');
...
final $typed_data.Uint8List imageBoundingPolyAnnotationDescriptor = $convert.base64Decode('');
...
final $typed_data.Uint8List polylineDescriptor = $convert.base64Decode('CghQb2x5bGluZRJFCgh2ZXJ0aWNlcxgBIAMoCzIpLmdvb2dsZS5jbG91ZC5kYXRhbGFiZWxpbmcudjFiZXRhMS5WZXJ0ZXhSCHZlcnRpY2Vz');
...
final $typed_data.Uint8List normalizedPolylineDescriptor = $convert.base64Decode('ChJOb3JtYWxpemVkUG9seWxpbmUSZAoTbm9ybWFsaXplZF92ZXJ0aWNlcxgBIAMoCzIzLmdvb2dsZS5jbG91ZC5kYXRhbGFiZWxpbmcudjFiZXRhMS5Ob3JtYWxpemVkVmVydGV4UhJub3JtYWxpemVkVmVydGljZXM=');
...
final $typed_data.Uint8List imagePolylineAnnotationDescriptor = $convert.base64Decode('');
...
final $typed_data.Uint8List imageSegmentationAnnotationDescriptor = $convert.base64Decode('');
...
final $typed_data.Uint8List textClassificationAnnotationDescriptor = $convert.base64Decode('ChxUZXh0Q2xhc3NpZmljYXRpb25Bbm5vdGF0aW9uEloKD2Fubm90YXRpb25fc3BlYxgBIAEoCzIxLmdvb2dsZS5jbG91ZC5kYXRhbGFiZWxpbmcudjFiZXRhMS5Bbm5vdGF0aW9uU3BlY1IOYW5ub3RhdGlvblNwZWM=');
...
const TextEntityExtractionAnnotation$json = const {
  ...
  '2': const [
    const {'1': 'annotation_spec', '3': 1, '4': 1, '5': 11, '6': '.google.cloud.datalabeling.v1beta1.AnnotationSpec', '10': 'annotationSpec'},
    const {'1': 'sequential_segment', '3': 2, '4': 1, '5': 11, '6': '.google.cloud.datalabeling.v1beta1.SequentialSegment', '10': 'sequentialSegment'},
  ],
};

/// Descriptor for `TextEntityExtractionAnnotation`. Decode as a `google.protobuf.DescriptorProto`.
final $typed_data.Uint8List textEntityExtractionAnnotationDescriptor = $convert.base64Decode('');
...
final $typed_data.Uint8List sequentialSegmentDescriptor = $convert.base64Decode('ChFTZXF1ZW50aWFsU2VnbWVudBIUCgVzdGFydBgBIAEoBVIFc3RhcnQSEAoDZW5kGAIgASgFUgNlbmQ=');
...
final $typed_data.Uint8List timeSegmentDescriptor = $convert.base64Decode('CgtUaW1lU2VnbWVudBJFChFzdGFydF90aW1lX29mZnNldBgBIAEoCzIZLmdvb2dsZS5wcm90b2J1Zi5EdXJhdGlvblIPc3RhcnRUaW1lT2Zmc2V0EkEKD2VuZF90aW1lX29mZnNldBgCIAEoCzIZLmdvb2dsZS5wcm90b2J1Zi5EdXJhdGlvblINZW5kVGltZU9mZnNldA==');
...
final $typed_data.Uint8List videoClassificationAnnotationDescriptor = $convert.base64Decode('');
...
final $typed_data.Uint8List objectTrackingFrameDescriptor = $convert.base64Decode('');
...
final $typed_data.Uint8List videoObjectTrackingAnnotationDescriptor = $convert.base64Decode('');
...
final $typed_data.Uint8List videoEventAnnotationDescriptor = $convert.base64Decode('');
...
final $typed_data.Uint8List annotationMetadataDescriptor = $convert.base64Decode('ChJBbm5vdGF0aW9uTWV0YWRhdGESYAoRb3BlcmF0b3JfbWV0YWRhdGEYAiABKAsyMy5nb29nbGUuY2xvdWQuZGF0YWxhYmVsaW5nLnYxYmV0YTEuT3BlcmF0b3JNZXRhZGF0YVIQb3BlcmF0b3JNZXRhZGF0YQ==');
...
final $typed_data.Uint8List operatorMetadataDescriptor = $convert.base64Decode('ChBPcGVyYXRvck1ldGFkYXRhEhQKBXNjb3JlGAEgASgCUgVzY29yZRIfCgt0b3RhbF92b3RlcxgCIAEoBVIKdG90YWxWb3RlcxIfCgtsYWJlbF92b3RlcxgDIAEoBVIKbGFiZWxWb3RlcxIaCghjb21tZW50cxgEIAMoCVIIY29tbWVudHM=');

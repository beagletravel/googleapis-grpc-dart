...
class AnnotationSpecSet extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'AnnotationSpecSet', package: const $pb.PackageName(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'google.cloud.datalabeling.v1beta1'), createEmptyInstance: create)
    ..aOS(1, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'name')
    ..aOS(2, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'displayName')
    ..aOS(3, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'description')
    ..pc<AnnotationSpec>(4, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'annotationSpecs', $pb.PbFieldType.PM, subBuilder: AnnotationSpec.create)
    ..pPS(5, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'blockingResources')
  ...
  factory AnnotationSpecSet({
    ...
    if (annotationSpecs != null) {
      _result.annotationSpecs.addAll(annotationSpecs);
    }
  ...
  'Will be removed in next major version')
  AnnotationSpecSet copyWith(void Function(AnnotationSpecSet) updates) => super.copyWith((message) => updates(message as AnnotationSpecSet)) as AnnotationSpecSet; // ignore: deprecated_member_use
...
class AnnotationSpec extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'AnnotationSpec', package: const $pb.PackageName(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'google.cloud.datalabeling.v1beta1'), createEmptyInstance: create)

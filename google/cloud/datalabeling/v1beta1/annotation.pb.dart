...
class Annotation extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'Annotation', package: const $pb.PackageName(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'google.cloud.datalabeling.v1beta1'), createEmptyInstance: create)
    ..aOS(1, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'name')
    ..e<AnnotationSource>(2, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'annotationSource', $pb.PbFieldType.OE, defaultOrMaker: AnnotationSource.ANNOTATION_SOURCE_UNSPECIFIED, valueOf: AnnotationSource.valueOf, enumValues: AnnotationSource.values)
    ..aOM<AnnotationValue>(3, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'annotationValue', subBuilder: AnnotationValue.create)
    ..aOM<AnnotationMetadata>(4, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'annotationMetadata', subBuilder: AnnotationMetadata.create)
    ..e<AnnotationSentiment>(6, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'annotationSentiment', $pb.PbFieldType.OE, defaultOrMaker: AnnotationSentiment.ANNOTATION_SENTIMENT_UNSPECIFIED, valueOf: AnnotationSentiment.valueOf, enumValues: AnnotationSentiment.values)
...
class AnnotationValue extends $pb.GeneratedMessage {
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'AnnotationValue', package: const $pb.PackageName(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'google.cloud.datalabeling.v1beta1'), createEmptyInstance: create)
    ..oo(0, [1, 2, 3, 4, 5, 6, 8, 9, 10])
    ..aOM<ImageClassificationAnnotation>(1, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'imageClassificationAnnotation', subBuilder: ImageClassificationAnnotation.create)
    ..aOM<ImageBoundingPolyAnnotation>(2, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'imageBoundingPolyAnnotation', subBuilder: ImageBoundingPolyAnnotation.create)
    ..aOM<TextClassificationAnnotation>(3, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'textClassificationAnnotation', subBuilder: TextClassificationAnnotation.create)
    ..aOM<VideoClassificationAnnotation>(4, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'videoClassificationAnnotation', subBuilder: VideoClassificationAnnotation.create)
    ..aOM<VideoObjectTrackingAnnotation>(5, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'videoObjectTrackingAnnotation', subBuilder: VideoObjectTrackingAnnotation.create)
    ..aOM<VideoEventAnnotation>(6, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'videoEventAnnotation', subBuilder: VideoEventAnnotation.create)
    ..aOM<ImagePolylineAnnotation>(8, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'imagePolylineAnnotation', subBuilder: ImagePolylineAnnotation.create)
    ..aOM<ImageSegmentationAnnotation>(9, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'imageSegmentationAnnotation', subBuilder: ImageSegmentationAnnotation.create)
    ..aOM<TextEntityExtractionAnnotation>(10, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'textEntityExtractionAnnotation', subBuilder: TextEntityExtractionAnnotation.create)
    ..hasRequiredFields = false
  ;
  ...
  'Use [GeneratedMessageGenericExtensions.rebuild] instead. '
  'Will be removed in next major version')
  AnnotationValue copyWith(void Function(AnnotationValue) updates) => super.copyWith((message) => updates(message as AnnotationValue)) as AnnotationValue; // ignore: deprecated_member_use
  $pb.BuilderInfo get info_ => _i;
  @$core.pragma('dart2js:noInline')
...
class ImageClassificationAnnotation extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'ImageClassificationAnnotation', package: const $pb.PackageName(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'google.cloud.datalabeling.v1beta1'), createEmptyInstance: create)
    ..aOM<$0.AnnotationSpec>(1, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'annotationSpec', subBuilder: $0.AnnotationSpec.create)
    ..hasRequiredFields = false
  ;
  ...
  'Use [GeneratedMessageGenericExtensions.rebuild] instead. '
  'Will be removed in next major version')
  ImageClassificationAnnotation copyWith(void Function(ImageClassificationAnnotation) updates) => super.copyWith((message) => updates(message as ImageClassificationAnnotation)) as ImageClassificationAnnotation; // ignore: deprecated_member_use
  $pb.BuilderInfo get info_ => _i;
  @$core.pragma('dart2js:noInline')
...
class Vertex extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'Vertex', package: const $pb.PackageName(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'google.cloud.datalabeling.v1beta1'), createEmptyInstance: create)
...
class NormalizedVertex extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'NormalizedVertex', package: const $pb.PackageName(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'google.cloud.datalabeling.v1beta1'), createEmptyInstance: create)
...
class BoundingPoly extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'BoundingPoly', package: const $pb.PackageName(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'google.cloud.datalabeling.v1beta1'), createEmptyInstance: create)
    ..pc<Vertex>(1, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'vertices', $pb.PbFieldType.PM, subBuilder: Vertex.create)
    ..hasRequiredFields = false
  ;
...
class NormalizedBoundingPoly extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'NormalizedBoundingPoly', package: const $pb.PackageName(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'google.cloud.datalabeling.v1beta1'), createEmptyInstance: create)
    ..pc<NormalizedVertex>(1, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'normalizedVertices', $pb.PbFieldType.PM, subBuilder: NormalizedVertex.create)
    ..hasRequiredFields = false
  ;
...
class ImageBoundingPolyAnnotation extends $pb.GeneratedMessage {
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'ImageBoundingPolyAnnotation', package: const $pb.PackageName(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'google.cloud.datalabeling.v1beta1'), createEmptyInstance: create)
    ..oo(0, [2, 3])
    ..aOM<$0.AnnotationSpec>(1, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'annotationSpec', subBuilder: $0.AnnotationSpec.create)
    ..aOM<BoundingPoly>(2, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'boundingPoly', subBuilder: BoundingPoly.create)
    ..aOM<NormalizedBoundingPoly>(3, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'normalizedBoundingPoly', subBuilder: NormalizedBoundingPoly.create)
    ..hasRequiredFields = false
  ;
  ...
  'Use [GeneratedMessageGenericExtensions.rebuild] instead. '
  'Will be removed in next major version')
  ImageBoundingPolyAnnotation copyWith(void Function(ImageBoundingPolyAnnotation) updates) => super.copyWith((message) => updates(message as ImageBoundingPolyAnnotation)) as ImageBoundingPolyAnnotation; // ignore: deprecated_member_use
  $pb.BuilderInfo get info_ => _i;
  @$core.pragma('dart2js:noInline')
...
class Polyline extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'Polyline', package: const $pb.PackageName(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'google.cloud.datalabeling.v1beta1'), createEmptyInstance: create)
    ..pc<Vertex>(1, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'vertices', $pb.PbFieldType.PM, subBuilder: Vertex.create)
    ..hasRequiredFields = false
  ;
  ...
  'Use [GeneratedMessageGenericExtensions.rebuild] instead. '
  'Will be removed in next major version')
  Polyline copyWith(void Function(Polyline) updates) => super.copyWith((message) => updates(message as Polyline)) as Polyline; // ignore: deprecated_member_use
  $pb.BuilderInfo get info_ => _i;
  @$core.pragma('dart2js:noInline')
...
class NormalizedPolyline extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'NormalizedPolyline', package: const $pb.PackageName(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'google.cloud.datalabeling.v1beta1'), createEmptyInstance: create)
    ..pc<NormalizedVertex>(1, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'normalizedVertices', $pb.PbFieldType.PM, subBuilder: NormalizedVertex.create)
    ..hasRequiredFields = false
  ;
  ...
  'Use [GeneratedMessageGenericExtensions.rebuild] instead. '
  'Will be removed in next major version')
  NormalizedPolyline copyWith(void Function(NormalizedPolyline) updates) => super.copyWith((message) => updates(message as NormalizedPolyline)) as NormalizedPolyline; // ignore: deprecated_member_use
  $pb.BuilderInfo get info_ => _i;
  @$core.pragma('dart2js:noInline')
...
class ImagePolylineAnnotation extends $pb.GeneratedMessage {
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'ImagePolylineAnnotation', package: const $pb.PackageName(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'google.cloud.datalabeling.v1beta1'), createEmptyInstance: create)
    ..oo(0, [2, 3])
    ..aOM<$0.AnnotationSpec>(1, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'annotationSpec', subBuilder: $0.AnnotationSpec.create)
    ..aOM<Polyline>(2, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'polyline', subBuilder: Polyline.create)
    ..aOM<NormalizedPolyline>(3, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'normalizedPolyline', subBuilder: NormalizedPolyline.create)
    ..hasRequiredFields = false
  ;
  ...
  'Use [GeneratedMessageGenericExtensions.rebuild] instead. '
  'Will be removed in next major version')
  ImagePolylineAnnotation copyWith(void Function(ImagePolylineAnnotation) updates) => super.copyWith((message) => updates(message as ImagePolylineAnnotation)) as ImagePolylineAnnotation; // ignore: deprecated_member_use
  $pb.BuilderInfo get info_ => _i;
  @$core.pragma('dart2js:noInline')
...
class ImageSegmentationAnnotation extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'ImageSegmentationAnnotation', package: const $pb.PackageName(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'google.cloud.datalabeling.v1beta1'), createEmptyInstance: create)
    ..m<$core.String, $0.AnnotationSpec>(1, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'annotationColors', entryClassName: 'ImageSegmentationAnnotation.AnnotationColorsEntry', keyFieldType: $pb.PbFieldType.OS, valueFieldType: $pb.PbFieldType.OM, valueCreator: $0.AnnotationSpec.create, packageName: const $pb.PackageName('google.cloud.datalabeling.v1beta1'))
    ..aOS(2, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'mimeType')
    ..a<$core.List<$core.int>>(3, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'imageBytes', $pb.PbFieldType.OY)
    ..hasRequiredFields = false
  ;
  ...
  'Use [GeneratedMessageGenericExtensions.rebuild] instead. '
  'Will be removed in next major version')
  ImageSegmentationAnnotation copyWith(void Function(ImageSegmentationAnnotation) updates) => super.copyWith((message) => updates(message as ImageSegmentationAnnotation)) as ImageSegmentationAnnotation; // ignore: deprecated_member_use
  $pb.BuilderInfo get info_ => _i;
  @$core.pragma('dart2js:noInline')
...
class TextClassificationAnnotation extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'TextClassificationAnnotation', package: const $pb.PackageName(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'google.cloud.datalabeling.v1beta1'), createEmptyInstance: create)
    ..aOM<$0.AnnotationSpec>(1, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'annotationSpec', subBuilder: $0.AnnotationSpec.create)
    ..hasRequiredFields = false
  ;
  ...
  'Use [GeneratedMessageGenericExtensions.rebuild] instead. '
  'Will be removed in next major version')
  TextClassificationAnnotation copyWith(void Function(TextClassificationAnnotation) updates) => super.copyWith((message) => updates(message as TextClassificationAnnotation)) as TextClassificationAnnotation; // ignore: deprecated_member_use
  $pb.BuilderInfo get info_ => _i;
  @$core.pragma('dart2js:noInline')
...
class TextEntityExtractionAnnotation extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'TextEntityExtractionAnnotation', package: const $pb.PackageName(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'google.cloud.datalabeling.v1beta1'), createEmptyInstance: create)
    ..aOM<$0.AnnotationSpec>(1, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'annotationSpec', subBuilder: $0.AnnotationSpec.create)
    ..aOM<SequentialSegment>(2, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'sequentialSegment', subBuilder: SequentialSegment.create)
    ..hasRequiredFields = false
  ;
  ...
  'Use [GeneratedMessageGenericExtensions.rebuild] instead. '
  'Will be removed in next major version')
  TextEntityExtractionAnnotation copyWith(void Function(TextEntityExtractionAnnotation) updates) => super.copyWith((message) => updates(message as TextEntityExtractionAnnotation)) as TextEntityExtractionAnnotation; // ignore: deprecated_member_use
  $pb.BuilderInfo get info_ => _i;
  @$core.pragma('dart2js:noInline')
...
class SequentialSegment extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'SequentialSegment', package: const $pb.PackageName(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'google.cloud.datalabeling.v1beta1'), createEmptyInstance: create)
  ...
  'Use [GeneratedMessageGenericExtensions.rebuild] instead. '
  'Will be removed in next major version')
  SequentialSegment copyWith(void Function(SequentialSegment) updates) => super.copyWith((message) => updates(message as SequentialSegment)) as SequentialSegment; // ignore: deprecated_member_use
  $pb.BuilderInfo get info_ => _i;
  @$core.pragma('dart2js:noInline')
...
class TimeSegment extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'TimeSegment', package: const $pb.PackageName(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'google.cloud.datalabeling.v1beta1'), createEmptyInstance: create)
    ..aOM<$1.Duration>(1, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'startTimeOffset', subBuilder: $1.Duration.create)
    ..aOM<$1.Duration>(2, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'endTimeOffset', subBuilder: $1.Duration.create)
    ..hasRequiredFields = false
  ;
  ...
  'Use [GeneratedMessageGenericExtensions.rebuild] instead. '
  'Will be removed in next major version')
  TimeSegment copyWith(void Function(TimeSegment) updates) => super.copyWith((message) => updates(message as TimeSegment)) as TimeSegment; // ignore: deprecated_member_use
  $pb.BuilderInfo get info_ => _i;
  @$core.pragma('dart2js:noInline')
...
class VideoClassificationAnnotation extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'VideoClassificationAnnotation', package: const $pb.PackageName(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'google.cloud.datalabeling.v1beta1'), createEmptyInstance: create)
    ..aOM<TimeSegment>(1, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'timeSegment', subBuilder: TimeSegment.create)
    ..aOM<$0.AnnotationSpec>(2, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'annotationSpec', subBuilder: $0.AnnotationSpec.create)
    ..hasRequiredFields = false
  ;
  ...
  'Use [GeneratedMessageGenericExtensions.rebuild] instead. '
  'Will be removed in next major version')
  VideoClassificationAnnotation copyWith(void Function(VideoClassificationAnnotation) updates) => super.copyWith((message) => updates(message as VideoClassificationAnnotation)) as VideoClassificationAnnotation; // ignore: deprecated_member_use
  $pb.BuilderInfo get info_ => _i;
  @$core.pragma('dart2js:noInline')
...
class ObjectTrackingFrame extends $pb.GeneratedMessage {
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'ObjectTrackingFrame', package: const $pb.PackageName(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'google.cloud.datalabeling.v1beta1'), createEmptyInstance: create)
    ..oo(0, [1, 2])
    ..aOM<BoundingPoly>(1, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'boundingPoly', subBuilder: BoundingPoly.create)
    ..aOM<NormalizedBoundingPoly>(2, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'normalizedBoundingPoly', subBuilder: NormalizedBoundingPoly.create)
    ..aOM<$1.Duration>(3, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'timeOffset', subBuilder: $1.Duration.create)
    ..hasRequiredFields = false
  ;
...
class VideoObjectTrackingAnnotation extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'VideoObjectTrackingAnnotation', package: const $pb.PackageName(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'google.cloud.datalabeling.v1beta1'), createEmptyInstance: create)
    ..aOM<$0.AnnotationSpec>(1, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'annotationSpec', subBuilder: $0.AnnotationSpec.create)
    ..aOM<TimeSegment>(2, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'timeSegment', subBuilder: TimeSegment.create)
    ..pc<ObjectTrackingFrame>(3, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'objectTrackingFrames', $pb.PbFieldType.PM, subBuilder: ObjectTrackingFrame.create)
    ..hasRequiredFields = false
  ;
  ...
  'Use [GeneratedMessageGenericExtensions.rebuild] instead. '
  'Will be removed in next major version')
  VideoObjectTrackingAnnotation copyWith(void Function(VideoObjectTrackingAnnotation) updates) => super.copyWith((message) => updates(message as VideoObjectTrackingAnnotation)) as VideoObjectTrackingAnnotation; // ignore: deprecated_member_use
  $pb.BuilderInfo get info_ => _i;
  @$core.pragma('dart2js:noInline')
...
class VideoEventAnnotation extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'VideoEventAnnotation', package: const $pb.PackageName(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'google.cloud.datalabeling.v1beta1'), createEmptyInstance: create)
    ..aOM<$0.AnnotationSpec>(1, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'annotationSpec', subBuilder: $0.AnnotationSpec.create)
    ..aOM<TimeSegment>(2, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'timeSegment', subBuilder: TimeSegment.create)
    ..hasRequiredFields = false
  ;
  ...
  'Use [GeneratedMessageGenericExtensions.rebuild] instead. '
  'Will be removed in next major version')
  VideoEventAnnotation copyWith(void Function(VideoEventAnnotation) updates) => super.copyWith((message) => updates(message as VideoEventAnnotation)) as VideoEventAnnotation; // ignore: deprecated_member_use
  $pb.BuilderInfo get info_ => _i;
  @$core.pragma('dart2js:noInline')
...
class AnnotationMetadata extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'AnnotationMetadata', package: const $pb.PackageName(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'google.cloud.datalabeling.v1beta1'), createEmptyInstance: create)
    ..aOM<OperatorMetadata>(2, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'operatorMetadata', subBuilder: OperatorMetadata.create)
    ..hasRequiredFields = false
  ;
  ...
  'Use [GeneratedMessageGenericExtensions.rebuild] instead. '
  'Will be removed in next major version')
  AnnotationMetadata copyWith(void Function(AnnotationMetadata) updates) => super.copyWith((message) => updates(message as AnnotationMetadata)) as AnnotationMetadata; // ignore: deprecated_member_use
  $pb.BuilderInfo get info_ => _i;
  @$core.pragma('dart2js:noInline')
...
class OperatorMetadata extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'OperatorMetadata', package: const $pb.PackageName(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'google.cloud.datalabeling.v1beta1'), createEmptyInstance: create)
    ..a<$core.double>(1, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'score', $pb.PbFieldType.OF)
    ..a<$core.int>(2, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'totalVotes', $pb.PbFieldType.O3)
    ..a<$core.int>(3, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'labelVotes', $pb.PbFieldType.O3)
    ..pPS(4, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'comments')
    ..hasRequiredFields = false
  ;
  ...
  'Use [GeneratedMessageGenericExtensions.rebuild] instead. '
  'Will be removed in next major version')
  OperatorMetadata copyWith(void Function(OperatorMetadata) updates) => super.copyWith((message) => updates(message as OperatorMetadata)) as OperatorMetadata; // ignore: deprecated_member_use
  $pb.BuilderInfo get info_ => _i;
  @$core.pragma('dart2js:noInline')

...
class EvaluationJob extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'EvaluationJob', package: const $pb.PackageName(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'google.cloud.datalabeling.v1beta1'), createEmptyInstance: create)
    ..aOS(1, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'name')
    ..aOS(2, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'description')
    ..e<EvaluationJob_State>(3, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'state', $pb.PbFieldType.OE, defaultOrMaker: EvaluationJob_State.STATE_UNSPECIFIED, valueOf: EvaluationJob_State.valueOf, enumValues: EvaluationJob_State.values)
    ..aOS(4, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'schedule')
    ..aOS(5, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'modelVersion')
    ..aOM<EvaluationJobConfig>(6, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'evaluationJobConfig', subBuilder: EvaluationJobConfig.create)
    ..aOS(7, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'annotationSpecSet')
    ..aOB(8, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'labelMissingGroundTruth')
    ..pc<Attempt>(9, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'attempts', $pb.PbFieldType.PM, subBuilder: Attempt.create)
  ...
  'Will be removed in next major version')
  EvaluationJob copyWith(void Function(EvaluationJob) updates) => super.copyWith((message) => updates(message as EvaluationJob)) as EvaluationJob; // ignore: deprecated_member_use
...
class EvaluationJobConfig extends $pb.GeneratedMessage {
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'EvaluationJobConfig', package: const $pb.PackageName(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'google.cloud.datalabeling.v1beta1'), createEmptyInstance: create)
    ..oo(0, [4, 5, 8])
    ..aOM<$1.InputConfig>(1, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'inputConfig', subBuilder: $1.InputConfig.create)
    ..aOM<$2.EvaluationConfig>(2, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'evaluationConfig', subBuilder: $2.EvaluationConfig.create)
    ..aOM<$3.HumanAnnotationConfig>(3, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'humanAnnotationConfig', subBuilder: $3.HumanAnnotationConfig.create)
    ..aOM<$3.ImageClassificationConfig>(4, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'imageClassificationConfig', subBuilder: $3.ImageClassificationConfig.create)
    ..aOM<$3.BoundingPolyConfig>(5, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'boundingPolyConfig', subBuilder: $3.BoundingPolyConfig.create)
    ..aOM<$3.TextClassificationConfig>(8, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'textClassificationConfig', subBuilder: $3.TextClassificationConfig.create)
    ..m<$core.String, $core.String>(9, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'bigqueryImportKeys', entryClassName: 'EvaluationJobConfig.BigqueryImportKeysEntry', keyFieldType: $pb.PbFieldType.OS, valueFieldType: $pb.PbFieldType.OS, packageName: const $pb.PackageName('google.cloud.datalabeling.v1beta1'))
    ..a<$core.int>(10, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'exampleCount', $pb.PbFieldType.O3)
    ..a<$core.double>(11, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'exampleSamplePercentage', $pb.PbFieldType.OD)
    ..aOM<EvaluationJobAlertConfig>(13, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'evaluationJobAlertConfig', subBuilder: EvaluationJobAlertConfig.create)
    ..hasRequiredFields = false
  ;
  ...
  'Use [GeneratedMessageGenericExtensions.rebuild] instead. '
  'Will be removed in next major version')
  EvaluationJobConfig copyWith(void Function(EvaluationJobConfig) updates) => super.copyWith((message) => updates(message as EvaluationJobConfig)) as EvaluationJobConfig; // ignore: deprecated_member_use
  $pb.BuilderInfo get info_ => _i;
  @$core.pragma('dart2js:noInline')
  ...
  @$pb.TagNumber(1)
  set inputConfig($1.InputConfig v) { setField(1, v); }
  @$pb.TagNumber(1)
  ...
  @$pb.TagNumber(2)
  set evaluationConfig($2.EvaluationConfig v) { setField(2, v); }
  @$pb.TagNumber(2)
  ...
  @$pb.TagNumber(3)
  set humanAnnotationConfig($3.HumanAnnotationConfig v) { setField(3, v); }
  @$pb.TagNumber(3)
  ...
  @$pb.TagNumber(4)
  set imageClassificationConfig($3.ImageClassificationConfig v) { setField(4, v); }
  @$pb.TagNumber(4)
  ...
  @$pb.TagNumber(5)
  set boundingPolyConfig($3.BoundingPolyConfig v) { setField(5, v); }
  @$pb.TagNumber(5)
  ...
  @$pb.TagNumber(8)
  set textClassificationConfig($3.TextClassificationConfig v) { setField(8, v); }
  @$pb.TagNumber(8)
...
class EvaluationJobAlertConfig extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'EvaluationJobAlertConfig', package: const $pb.PackageName(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'google.cloud.datalabeling.v1beta1'), createEmptyInstance: create)
    ..aOS(1, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'email')
    ..a<$core.double>(2, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'minAcceptableMeanAveragePrecision', $pb.PbFieldType.OD)
    ..hasRequiredFields = false
  ;
  ...
  factory EvaluationJobAlertConfig({
    ...
    if (minAcceptableMeanAveragePrecision != null) {
      _result.minAcceptableMeanAveragePrecision = minAcceptableMeanAveragePrecision;
    }
    return _result;
  }
  ...
  'Use [GeneratedMessageGenericExtensions.rebuild] instead. '
  'Will be removed in next major version')
  EvaluationJobAlertConfig copyWith(void Function(EvaluationJobAlertConfig) updates) => super.copyWith((message) => updates(message as EvaluationJobAlertConfig)) as EvaluationJobAlertConfig; // ignore: deprecated_member_use
  $pb.BuilderInfo get info_ => _i;
  @$core.pragma('dart2js:noInline')
...
class Attempt extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'Attempt', package: const $pb.PackageName(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'google.cloud.datalabeling.v1beta1'), createEmptyInstance: create)
    ..aOM<$0.Timestamp>(1, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'attemptTime', subBuilder: $0.Timestamp.create)
    ..pc<$4.Status>(2, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'partialFailures', $pb.PbFieldType.PM, subBuilder: $4.Status.create)
    ..hasRequiredFields = false
  ;
  ...
  @$pb.TagNumber(1)
  set attemptTime($0.Timestamp v) { setField(1, v); }
  @$pb.TagNumber(1)

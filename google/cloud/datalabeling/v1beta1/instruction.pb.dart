...
class Instruction extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'Instruction', package: const $pb.PackageName(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'google.cloud.datalabeling.v1beta1'), createEmptyInstance: create)
    ...
    ..e<$1.DataType>(6, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'dataType', $pb.PbFieldType.OE, defaultOrMaker: $1.DataType.DATA_TYPE_UNSPECIFIED, valueOf: $1.DataType.valueOf, enumValues: $1.DataType.values)
    ..aOM<CsvInstruction>(7, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'csvInstruction', subBuilder: CsvInstruction.create)
    ..aOM<PdfInstruction>(9, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'pdfInstruction', subBuilder: PdfInstruction.create)
    ..pPS(10, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'blockingResources')
  ...
  'Will be removed in next major version')
  Instruction copyWith(void Function(Instruction) updates) => super.copyWith((message) => updates(message as Instruction)) as Instruction; // ignore: deprecated_member_use
...
class CsvInstruction extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'CsvInstruction', package: const $pb.PackageName(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'google.cloud.datalabeling.v1beta1'), createEmptyInstance: create)
    ..aOS(1, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'gcsFileUri')
    ..hasRequiredFields = false
  ;
  ...
  'Use [GeneratedMessageGenericExtensions.rebuild] instead. '
  'Will be removed in next major version')
  CsvInstruction copyWith(void Function(CsvInstruction) updates) => super.copyWith((message) => updates(message as CsvInstruction)) as CsvInstruction; // ignore: deprecated_member_use
  $pb.BuilderInfo get info_ => _i;
  @$core.pragma('dart2js:noInline')
...
class PdfInstruction extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'PdfInstruction', package: const $pb.PackageName(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'google.cloud.datalabeling.v1beta1'), createEmptyInstance: create)
    ..aOS(1, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'gcsFileUri')
    ..hasRequiredFields = false
  ;
  ...
  'Use [GeneratedMessageGenericExtensions.rebuild] instead. '
  'Will be removed in next major version')
  PdfInstruction copyWith(void Function(PdfInstruction) updates) => super.copyWith((message) => updates(message as PdfInstruction)) as PdfInstruction; // ignore: deprecated_member_use
  $pb.BuilderInfo get info_ => _i;
  @$core.pragma('dart2js:noInline')

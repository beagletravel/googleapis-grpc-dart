...
final $typed_data.Uint8List networkEndpointDescriptor = $convert.base64Decode('Cg9OZXR3b3JrRW5kcG9pbnQSHQoKaXBfYWRkcmVzcxgBIAEoCVIJaXBBZGRyZXNzEhIKBHBvcnQYAiABKAVSBHBvcnQ=');
...
const Node$json = const {
  ...
  '2': const [
    ...
    const {'1': 'state', '3': 9, '4': 1, '5': 14, '6': '.google.cloud.tpu.v1.Node.State', '8': const {}, '10': 'state'},
    const {'1': 'health_description', '3': 10, '4': 1, '5': 9, '8': const {}, '10': 'healthDescription'},
    const {'1': 'tensorflow_version', '3': 11, '4': 1, '5': 9, '8': const {}, '10': 'tensorflowVersion'},
    const {'1': 'network', '3': 12, '4': 1, '5': 9, '10': 'network'},
    const {'1': 'cidr_block', '3': 13, '4': 1, '5': 9, '10': 'cidrBlock'},
    const {'1': 'service_account', '3': 15, '4': 1, '5': 9, '8': const {}, '10': 'serviceAccount'},
    const {'1': 'create_time', '3': 16, '4': 1, '5': 11, '6': '.google.protobuf.Timestamp', '8': const {}, '10': 'createTime'},
    const {'1': 'scheduling_config', '3': 17, '4': 1, '5': 11, '6': '.google.cloud.tpu.v1.SchedulingConfig', '10': 'schedulingConfig'},
    const {'1': 'network_endpoints', '3': 21, '4': 3, '5': 11, '6': '.google.cloud.tpu.v1.NetworkEndpoint', '8': const {}, '10': 'networkEndpoints'},
    const {'1': 'health', '3': 22, '4': 1, '5': 14, '6': '.google.cloud.tpu.v1.Node.Health', '10': 'health'},
    const {'1': 'labels', '3': 24, '4': 3, '5': 11, '6': '.google.cloud.tpu.v1.Node.LabelsEntry', '10': 'labels'},
    const {'1': 'use_service_networking', '3': 27, '4': 1, '5': 8, '10': 'useServiceNetworking'},
    const {'1': 'api_version', '3': 38, '4': 1, '5': 14, '6': '.google.cloud.tpu.v1.Node.ApiVersion', '8': const {}, '10': 'apiVersion'},
    const {'1': 'symptoms', '3': 39, '4': 3, '5': 11, '6': '.google.cloud.tpu.v1.Symptom', '8': const {}, '10': 'symptoms'},
  ],
...
final $typed_data.Uint8List listNodesRequestDescriptor = $convert.base64Decode('ChBMaXN0Tm9kZXNSZXF1ZXN0EjcKBnBhcmVudBgBIAEoCUIf4EEC+kEZEhd0cHUuZ29vZ2xlYXBpcy5jb20vTm9kZVIGcGFyZW50EhsKCXBhZ2Vfc2l6ZRgCIAEoBVIIcGFnZVNpemUSHQoKcGFnZV90b2tlbhgDIAEoCVIJcGFnZVRva2Vu');
@$core.Deprecated('Use listNodesResponseDescriptor instead')
const ListNodesResponse$json = const {
  '1': 'ListNodesResponse',
  '2': const [
    const {'1': 'nodes', '3': 1, '4': 3, '5': 11, '6': '.google.cloud.tpu.v1.Node', '10': 'nodes'},
...
final $typed_data.Uint8List listNodesResponseDescriptor = $convert.base64Decode('ChFMaXN0Tm9kZXNSZXNwb25zZRIvCgVub2RlcxgBIAMoCzIZLmdvb2dsZS5jbG91ZC50cHUudjEuTm9kZVIFbm9kZXMSJgoPbmV4dF9wYWdlX3Rva2VuGAIgASgJUg1uZXh0UGFnZVRva2VuEiAKC3VucmVhY2hhYmxlGAMgAygJUgt1bnJlYWNoYWJsZQ==');
...
const CreateNodeRequest$json = const {
  ...
  '2': const [
    ...
    const {'1': 'node', '3': 3, '4': 1, '5': 11, '6': '.google.cloud.tpu.v1.Node', '8': const {}, '10': 'node'},
  ],
};

/// Descriptor for `CreateNodeRequest`. Decode as a `google.protobuf.DescriptorProto`.
final $typed_data.Uint8List createNodeRequestDescriptor = $convert.base64Decode('ChFDcmVhdGVOb2RlUmVxdWVzdBI3CgZwYXJlbnQYASABKAlCH+BBAvpBGRIXdHB1Lmdvb2dsZWFwaXMuY29tL05vZGVSBnBhcmVudBIXCgdub2RlX2lkGAIgASgJUgZub2RlSWQSMgoEbm9kZRgDIAEoCzIZLmdvb2dsZS5jbG91ZC50cHUudjEuTm9kZUID4EECUgRub2Rl');
...
const ReimageNodeRequest$json = const {
  ...
  '2': const [
    ...
    const {'1': 'tensorflow_version', '3': 2, '4': 1, '5': 9, '10': 'tensorflowVersion'},
  ],
};

/// Descriptor for `ReimageNodeRequest`. Decode as a `google.protobuf.DescriptorProto`.
final $typed_data.Uint8List reimageNodeRequestDescriptor = $convert.base64Decode('ChJSZWltYWdlTm9kZVJlcXVlc3QSEgoEbmFtZRgBIAEoCVIEbmFtZRItChJ0ZW5zb3JmbG93X3ZlcnNpb24YAiABKAlSEXRlbnNvcmZsb3dWZXJzaW9u');
...
final $typed_data.Uint8List tensorFlowVersionDescriptor = $convert.base64Decode('ChFUZW5zb3JGbG93VmVyc2lvbhISCgRuYW1lGAEgASgJUgRuYW1lEhgKB3ZlcnNpb24YAiABKAlSB3ZlcnNpb246e+pBeAokdHB1Lmdvb2dsZWFwaXMuY29tL1RlbnNvckZsb3dWZXJzaW9uElBwcm9qZWN0cy97cHJvamVjdH0vbG9jYXRpb25zL3tsb2NhdGlvbn0vdGVuc29yRmxvd1ZlcnNpb25zL3t0ZW5zb3JfZmxvd192ZXJzaW9ufQ==');
...
final $typed_data.Uint8List getTensorFlowVersionRequestDescriptor = $convert.base64Decode('ChtHZXRUZW5zb3JGbG93VmVyc2lvblJlcXVlc3QSQAoEbmFtZRgBIAEoCUIs4EEC+kEmCiR0cHUuZ29vZ2xlYXBpcy5jb20vVGVuc29yRmxvd1ZlcnNpb25SBG5hbWU=');
...
final $typed_data.Uint8List listTensorFlowVersionsRequestDescriptor = $convert.base64Decode('');
...
const ListTensorFlowVersionsResponse$json = const {
  ...
  '2': const [
    const {'1': 'tensorflow_versions', '3': 1, '4': 3, '5': 11, '6': '.google.cloud.tpu.v1.TensorFlowVersion', '10': 'tensorflowVersions'},
    const {'1': 'next_page_token', '3': 2, '4': 1, '5': 9, '10': 'nextPageToken'},
    const {'1': 'unreachable', '3': 3, '4': 3, '5': 9, '10': 'unreachable'},
  ],
};
...
final $typed_data.Uint8List listTensorFlowVersionsResponseDescriptor = $convert.base64Decode('');
...
const ListAcceleratorTypesResponse$json = const {
  ...
  '2': const [
    const {'1': 'accelerator_types', '3': 1, '4': 3, '5': 11, '6': '.google.cloud.tpu.v1.AcceleratorType', '10': 'acceleratorTypes'},
    const {'1': 'next_page_token', '3': 2, '4': 1, '5': 9, '10': 'nextPageToken'},
    const {'1': 'unreachable', '3': 3, '4': 3, '5': 9, '10': 'unreachable'},
  ],
};
...
final $typed_data.Uint8List listAcceleratorTypesResponseDescriptor = $convert.base64Decode('ChxMaXN0QWNjZWxlcmF0b3JUeXBlc1Jlc3BvbnNlElEKEWFjY2VsZXJhdG9yX3R5cGVzGAEgAygLMiQuZ29vZ2xlLmNsb3VkLnRwdS52MS5BY2NlbGVyYXRvclR5cGVSEGFjY2VsZXJhdG9yVHlwZXMSJgoPbmV4dF9wYWdlX3Rva2VuGAIgASgJUg1uZXh0UGFnZVRva2VuEiAKC3VucmVhY2hhYmxlGAMgAygJUgt1bnJlYWNoYWJsZQ==');
...
const Symptom$json = const {
  ...
  '2': const [
    const {'1': 'create_time', '3': 1, '4': 1, '5': 11, '6': '.google.protobuf.Timestamp', '10': 'createTime'},
    const {'1': 'symptom_type', '3': 2, '4': 1, '5': 14, '6': '.google.cloud.tpu.v1.Symptom.SymptomType', '10': 'symptomType'},
...
final $typed_data.Uint8List symptomDescriptor = $convert.base64Decode('');

...
const GuestAttributes$json = const {
  ...
  '2': const [
    ...
    const {'1': 'query_value', '3': 2, '4': 1, '5': 11, '6': '.google.cloud.tpu.v2alpha1.GuestAttributesValue', '10': 'queryValue'},
  ],
};

/// Descriptor for `GuestAttributes`. Decode as a `google.protobuf.DescriptorProto`.
final $typed_data.Uint8List guestAttributesDescriptor = $convert.base64Decode('Cg9HdWVzdEF0dHJpYnV0ZXMSHQoKcXVlcnlfcGF0aBgBIAEoCVIJcXVlcnlQYXRoElAKC3F1ZXJ5X3ZhbHVlGAIgASgLMi8uZ29vZ2xlLmNsb3VkLnRwdS52MmFscGhhMS5HdWVzdEF0dHJpYnV0ZXNWYWx1ZVIKcXVlcnlWYWx1ZQ==');
@$core.Deprecated('Use guestAttributesValueDescriptor instead')
const GuestAttributesValue$json = const {
  '1': 'GuestAttributesValue',
  '2': const [
    const {'1': 'items', '3': 1, '4': 3, '5': 11, '6': '.google.cloud.tpu.v2alpha1.GuestAttributesEntry', '10': 'items'},
  ],
};

/// Descriptor for `GuestAttributesValue`. Decode as a `google.protobuf.DescriptorProto`.
final $typed_data.Uint8List guestAttributesValueDescriptor = $convert.base64Decode('ChRHdWVzdEF0dHJpYnV0ZXNWYWx1ZRJFCgVpdGVtcxgBIAMoCzIvLmdvb2dsZS5jbG91ZC50cHUudjJhbHBoYTEuR3Vlc3RBdHRyaWJ1dGVzRW50cnlSBWl0ZW1z');
...
final $typed_data.Uint8List guestAttributesEntryDescriptor = $convert.base64Decode('ChRHdWVzdEF0dHJpYnV0ZXNFbnRyeRIcCgluYW1lc3BhY2UYASABKAlSCW5hbWVzcGFjZRIQCgNrZXkYAiABKAlSA2tleRIUCgV2YWx1ZRgDIAEoCVIFdmFsdWU=');
...
const AttachedDisk$json = const {
  ...
  '2': const [
    ...
    const {'1': 'mode', '3': 4, '4': 1, '5': 14, '6': '.google.cloud.tpu.v2alpha1.AttachedDisk.DiskMode', '10': 'mode'},
  ],
...
final $typed_data.Uint8List attachedDiskDescriptor = $convert.base64Decode('CgxBdHRhY2hlZERpc2sSHwoLc291cmNlX2Rpc2sYAyABKAlSCnNvdXJjZURpc2sSRAoEbW9kZRgEIAEoDjIwLmdvb2dsZS5jbG91ZC50cHUudjJhbHBoYTEuQXR0YWNoZWREaXNrLkRpc2tNb2RlUgRtb2RlIkQKCERpc2tNb2RlEhkKFURJU0tfTU9ERV9VTlNQRUNJRklFRBAAEg4KClJFQURfV1JJVEUQARINCglSRUFEX09OTFkQAg==');
...
final $typed_data.Uint8List schedulingConfigDescriptor = $convert.base64Decode('ChBTY2hlZHVsaW5nQ29uZmlnEiAKC3ByZWVtcHRpYmxlGAEgASgIUgtwcmVlbXB0aWJsZRIaCghyZXNlcnZlZBgCIAEoCFIIcmVzZXJ2ZWQ=');
...
const NetworkEndpoint$json = const {
  ...
  '2': const [
    ...
    const {'1': 'access_config', '3': 5, '4': 1, '5': 11, '6': '.google.cloud.tpu.v2alpha1.AccessConfig', '10': 'accessConfig'},
  ],
};

/// Descriptor for `NetworkEndpoint`. Decode as a `google.protobuf.DescriptorProto`.
final $typed_data.Uint8List networkEndpointDescriptor = $convert.base64Decode('Cg9OZXR3b3JrRW5kcG9pbnQSHQoKaXBfYWRkcmVzcxgBIAEoCVIJaXBBZGRyZXNzEhIKBHBvcnQYAiABKAVSBHBvcnQSTAoNYWNjZXNzX2NvbmZpZxgFIAEoCzInLmdvb2dsZS5jbG91ZC50cHUudjJhbHBoYTEuQWNjZXNzQ29uZmlnUgxhY2Nlc3NDb25maWc=');
@$core.Deprecated('Use accessConfigDescriptor instead')
const AccessConfig$json = const {
  '1': 'AccessConfig',
  '2': const [
    const {'1': 'external_ip', '3': 1, '4': 1, '5': 9, '8': const {}, '10': 'externalIp'},
  ],
};

/// Descriptor for `AccessConfig`. Decode as a `google.protobuf.DescriptorProto`.
final $typed_data.Uint8List accessConfigDescriptor = $convert.base64Decode('CgxBY2Nlc3NDb25maWcSJAoLZXh0ZXJuYWxfaXAYASABKAlCA+BBA1IKZXh0ZXJuYWxJcA==');
...
const NetworkConfig$json = const {
  ...
  '2': const [
    ...
    const {'1': 'enable_external_ips', '3': 3, '4': 1, '5': 8, '10': 'enableExternalIps'},
  ],
};

/// Descriptor for `NetworkConfig`. Decode as a `google.protobuf.DescriptorProto`.
final $typed_data.Uint8List networkConfigDescriptor = $convert.base64Decode('Cg1OZXR3b3JrQ29uZmlnEhgKB25ldHdvcmsYASABKAlSB25ldHdvcmsSHgoKc3VibmV0d29yaxgCIAEoCVIKc3VibmV0d29yaxIuChNlbmFibGVfZXh0ZXJuYWxfaXBzGAMgASgIUhFlbmFibGVFeHRlcm5hbElwcw==');
...
final $typed_data.Uint8List serviceAccountDescriptor = $convert.base64Decode('Cg5TZXJ2aWNlQWNjb3VudBIUCgVlbWFpbBgBIAEoCVIFZW1haWwSFAoFc2NvcGUYAiADKAlSBXNjb3Bl');
...
const Node$json = const {
  ...
  '2': const [
    ...
    const {'1': 'accelerator_type', '3': 5, '4': 1, '5': 9, '8': const {}, '10': 'acceleratorType'},
    const {'1': 'state', '3': 9, '4': 1, '5': 14, '6': '.google.cloud.tpu.v2alpha1.Node.State', '8': const {}, '10': 'state'},
    const {'1': 'health_description', '3': 10, '4': 1, '5': 9, '8': const {}, '10': 'healthDescription'},
    const {'1': 'runtime_version', '3': 11, '4': 1, '5': 9, '8': const {}, '10': 'runtimeVersion'},
    const {'1': 'network_config', '3': 36, '4': 1, '5': 11, '6': '.google.cloud.tpu.v2alpha1.NetworkConfig', '10': 'networkConfig'},
    const {'1': 'cidr_block', '3': 13, '4': 1, '5': 9, '10': 'cidrBlock'},
    const {'1': 'service_account', '3': 37, '4': 1, '5': 11, '6': '.google.cloud.tpu.v2alpha1.ServiceAccount', '10': 'serviceAccount'},
    const {'1': 'create_time', '3': 16, '4': 1, '5': 11, '6': '.google.protobuf.Timestamp', '8': const {}, '10': 'createTime'},
    const {'1': 'scheduling_config', '3': 17, '4': 1, '5': 11, '6': '.google.cloud.tpu.v2alpha1.SchedulingConfig', '10': 'schedulingConfig'},
    const {'1': 'network_endpoints', '3': 21, '4': 3, '5': 11, '6': '.google.cloud.tpu.v2alpha1.NetworkEndpoint', '8': const {}, '10': 'networkEndpoints'},
    const {'1': 'health', '3': 22, '4': 1, '5': 14, '6': '.google.cloud.tpu.v2alpha1.Node.Health', '10': 'health'},
    const {'1': 'labels', '3': 24, '4': 3, '5': 11, '6': '.google.cloud.tpu.v2alpha1.Node.LabelsEntry', '10': 'labels'},
    const {'1': 'metadata', '3': 34, '4': 3, '5': 11, '6': '.google.cloud.tpu.v2alpha1.Node.MetadataEntry', '10': 'metadata'},
    const {'1': 'tags', '3': 40, '4': 3, '5': 9, '10': 'tags'},
    const {'1': 'id', '3': 33, '4': 1, '5': 3, '8': const {}, '10': 'id'},
    const {'1': 'data_disks', '3': 41, '4': 3, '5': 11, '6': '.google.cloud.tpu.v2alpha1.AttachedDisk', '10': 'dataDisks'},
    const {'1': 'api_version', '3': 38, '4': 1, '5': 14, '6': '.google.cloud.tpu.v2alpha1.Node.ApiVersion', '8': const {}, '10': 'apiVersion'},
    const {'1': 'symptoms', '3': 39, '4': 3, '5': 11, '6': '.google.cloud.tpu.v2alpha1.Symptom', '8': const {}, '10': 'symptoms'},
  ],
...
final $typed_data.Uint8List listNodesRequestDescriptor = $convert.base64Decode('ChBMaXN0Tm9kZXNSZXF1ZXN0EjcKBnBhcmVudBgBIAEoCUIf4EEC+kEZChd0cHUuZ29vZ2xlYXBpcy5jb20vTm9kZVIGcGFyZW50EhsKCXBhZ2Vfc2l6ZRgCIAEoBVIIcGFnZVNpemUSHQoKcGFnZV90b2tlbhgDIAEoCVIJcGFnZVRva2Vu');
@$core.Deprecated('Use listNodesResponseDescriptor instead')
const ListNodesResponse$json = const {
  '1': 'ListNodesResponse',
  '2': const [
    const {'1': 'nodes', '3': 1, '4': 3, '5': 11, '6': '.google.cloud.tpu.v2alpha1.Node', '10': 'nodes'},
...
final $typed_data.Uint8List listNodesResponseDescriptor = $convert.base64Decode('ChFMaXN0Tm9kZXNSZXNwb25zZRI1CgVub2RlcxgBIAMoCzIfLmdvb2dsZS5jbG91ZC50cHUudjJhbHBoYTEuTm9kZVIFbm9kZXMSJgoPbmV4dF9wYWdlX3Rva2VuGAIgASgJUg1uZXh0UGFnZVRva2VuEiAKC3VucmVhY2hhYmxlGAMgAygJUgt1bnJlYWNoYWJsZQ==');
...
final $typed_data.Uint8List getNodeRequestDescriptor = $convert.base64Decode('Cg5HZXROb2RlUmVxdWVzdBIzCgRuYW1lGAEgASgJQh/gQQL6QRkKF3RwdS5nb29nbGVhcGlzLmNvbS9Ob2RlUgRuYW1l');
...
const CreateNodeRequest$json = const {
  ...
  '2': const [
    ...
    const {'1': 'node', '3': 3, '4': 1, '5': 11, '6': '.google.cloud.tpu.v2alpha1.Node', '8': const {}, '10': 'node'},
  ],
};

/// Descriptor for `CreateNodeRequest`. Decode as a `google.protobuf.DescriptorProto`.
final $typed_data.Uint8List createNodeRequestDescriptor = $convert.base64Decode('ChFDcmVhdGVOb2RlUmVxdWVzdBJBCgZwYXJlbnQYASABKAlCKeBBAvpBIwohbG9jYXRpb25zLmdvb2dsZWFwaXMuY29tL0xvY2F0aW9uUgZwYXJlbnQSFwoHbm9kZV9pZBgCIAEoCVIGbm9kZUlkEjgKBG5vZGUYAyABKAsyHy5nb29nbGUuY2xvdWQudHB1LnYyYWxwaGExLk5vZGVCA+BBAlIEbm9kZQ==');
...
final $typed_data.Uint8List deleteNodeRequestDescriptor = $convert.base64Decode('ChFEZWxldGVOb2RlUmVxdWVzdBIzCgRuYW1lGAEgASgJQh/gQQL6QRkKF3RwdS5nb29nbGVhcGlzLmNvbS9Ob2RlUgRuYW1l');
...
final $typed_data.Uint8List stopNodeRequestDescriptor = $convert.base64Decode('Cg9TdG9wTm9kZVJlcXVlc3QSEgoEbmFtZRgBIAEoCVIEbmFtZQ==');
...
final $typed_data.Uint8List startNodeRequestDescriptor = $convert.base64Decode('ChBTdGFydE5vZGVSZXF1ZXN0EhIKBG5hbWUYASABKAlSBG5hbWU=');
...
const UpdateNodeRequest$json = const {
  ...
  '2': const [
    ...
    const {'1': 'node', '3': 2, '4': 1, '5': 11, '6': '.google.cloud.tpu.v2alpha1.Node', '8': const {}, '10': 'node'},
  ],
};

/// Descriptor for `UpdateNodeRequest`. Decode as a `google.protobuf.DescriptorProto`.
final $typed_data.Uint8List updateNodeRequestDescriptor = $convert.base64Decode('ChFVcGRhdGVOb2RlUmVxdWVzdBJACgt1cGRhdGVfbWFzaxgBIAEoCzIaLmdvb2dsZS5wcm90b2J1Zi5GaWVsZE1hc2tCA+BBAlIKdXBkYXRlTWFzaxI4CgRub2RlGAIgASgLMh8uZ29vZ2xlLmNsb3VkLnRwdS52MmFscGhhMS5Ob2RlQgPgQQJSBG5vZGU=');
...
final $typed_data.Uint8List serviceIdentityDescriptor = $convert.base64Decode('Cg9TZXJ2aWNlSWRlbnRpdHkSFAoFZW1haWwYASABKAlSBWVtYWls');
...
final $typed_data.Uint8List generateServiceIdentityRequestDescriptor = $convert.base64Decode('Ch5HZW5lcmF0ZVNlcnZpY2VJZGVudGl0eVJlcXVlc3QSQQoGcGFyZW50GAEgASgJQingQQL6QSMKIWxvY2F0aW9ucy5nb29nbGVhcGlzLmNvbS9Mb2NhdGlvblIGcGFyZW50');
...
const GenerateServiceIdentityResponse$json = const {
  ...
  '2': const [
    const {'1': 'identity', '3': 1, '4': 1, '5': 11, '6': '.google.cloud.tpu.v2alpha1.ServiceIdentity', '10': 'identity'},
  ],
};

/// Descriptor for `GenerateServiceIdentityResponse`. Decode as a `google.protobuf.DescriptorProto`.
final $typed_data.Uint8List generateServiceIdentityResponseDescriptor = $convert.base64Decode('Ch9HZW5lcmF0ZVNlcnZpY2VJZGVudGl0eVJlc3BvbnNlEkYKCGlkZW50aXR5GAEgASgLMiouZ29vZ2xlLmNsb3VkLnRwdS52MmFscGhhMS5TZXJ2aWNlSWRlbnRpdHlSCGlkZW50aXR5');
...
final $typed_data.Uint8List acceleratorTypeDescriptor = $convert.base64Decode('Cg9BY2NlbGVyYXRvclR5cGUSEgoEbmFtZRgBIAEoCVIEbmFtZRISCgR0eXBlGAIgASgJUgR0eXBlOnTqQXEKInRwdS5nb29nbGVhcGlzLmNvbS9BY2NlbGVyYXRvclR5cGUSS3Byb2plY3RzL3twcm9qZWN0fS9sb2NhdGlvbnMve2xvY2F0aW9ufS9hY2NlbGVyYXRvclR5cGVzL3thY2NlbGVyYXRvcl90eXBlfQ==');
...
final $typed_data.Uint8List getAcceleratorTypeRequestDescriptor = $convert.base64Decode('ChlHZXRBY2NlbGVyYXRvclR5cGVSZXF1ZXN0Ej4KBG5hbWUYASABKAlCKuBBAvpBJAoidHB1Lmdvb2dsZWFwaXMuY29tL0FjY2VsZXJhdG9yVHlwZVIEbmFtZQ==');
...
final $typed_data.Uint8List listAcceleratorTypesRequestDescriptor = $convert.base64Decode('');
...
const ListAcceleratorTypesResponse$json = const {
  ...
  '2': const [
    const {'1': 'accelerator_types', '3': 1, '4': 3, '5': 11, '6': '.google.cloud.tpu.v2alpha1.AcceleratorType', '10': 'acceleratorTypes'},
    const {'1': 'next_page_token', '3': 2, '4': 1, '5': 9, '10': 'nextPageToken'},
    const {'1': 'unreachable', '3': 3, '4': 3, '5': 9, '10': 'unreachable'},
  ],
};
...
final $typed_data.Uint8List listAcceleratorTypesResponseDescriptor = $convert.base64Decode('');
...
final $typed_data.Uint8List runtimeVersionDescriptor = $convert.base64Decode('Cg5SdW50aW1lVmVyc2lvbhISCgRuYW1lGAEgASgJUgRuYW1lEhgKB3ZlcnNpb24YAiABKAlSB3ZlcnNpb246cepBbgohdHB1Lmdvb2dsZWFwaXMuY29tL1J1bnRpbWVWZXJzaW9uEklwcm9qZWN0cy97cHJvamVjdH0vbG9jYXRpb25zL3tsb2NhdGlvbn0vcnVudGltZVZlcnNpb25zL3tydW50aW1lX3ZlcnNpb259');
...
final $typed_data.Uint8List getRuntimeVersionRequestDescriptor = $convert.base64Decode('ChhHZXRSdW50aW1lVmVyc2lvblJlcXVlc3QSPQoEbmFtZRgBIAEoCUIp4EEC+kEjCiF0cHUuZ29vZ2xlYXBpcy5jb20vUnVudGltZVZlcnNpb25SBG5hbWU=');
...
final $typed_data.Uint8List listRuntimeVersionsRequestDescriptor = $convert.base64Decode('');
...
const ListRuntimeVersionsResponse$json = const {
  ...
  '2': const [
    const {'1': 'runtime_versions', '3': 1, '4': 3, '5': 11, '6': '.google.cloud.tpu.v2alpha1.RuntimeVersion', '10': 'runtimeVersions'},
    const {'1': 'next_page_token', '3': 2, '4': 1, '5': 9, '10': 'nextPageToken'},
    const {'1': 'unreachable', '3': 3, '4': 3, '5': 9, '10': 'unreachable'},
  ],
};
...
final $typed_data.Uint8List listRuntimeVersionsResponseDescriptor = $convert.base64Decode('ChtMaXN0UnVudGltZVZlcnNpb25zUmVzcG9uc2USVAoQcnVudGltZV92ZXJzaW9ucxgBIAMoCzIpLmdvb2dsZS5jbG91ZC50cHUudjJhbHBoYTEuUnVudGltZVZlcnNpb25SD3J1bnRpbWVWZXJzaW9ucxImCg9uZXh0X3BhZ2VfdG9rZW4YAiABKAlSDW5leHRQYWdlVG9rZW4SIAoLdW5yZWFjaGFibGUYAyADKAlSC3VucmVhY2hhYmxl');
@$core.Deprecated('Use symptomDescriptor instead')
const Symptom$json = const {
  '1': 'Symptom',
  '2': const [
    const {'1': 'create_time', '3': 1, '4': 1, '5': 11, '6': '.google.protobuf.Timestamp', '10': 'createTime'},
    const {'1': 'symptom_type', '3': 2, '4': 1, '5': 14, '6': '.google.cloud.tpu.v2alpha1.Symptom.SymptomType', '10': 'symptomType'},
...
final $typed_data.Uint8List symptomDescriptor = $convert.base64Decode('');
...
final $typed_data.Uint8List getGuestAttributesRequestDescriptor = $convert.base64Decode('ChlHZXRHdWVzdEF0dHJpYnV0ZXNSZXF1ZXN0EjMKBG5hbWUYASABKAlCH+BBAvpBGQoXdHB1Lmdvb2dsZWFwaXMuY29tL05vZGVSBG5hbWUSHQoKcXVlcnlfcGF0aBgCIAEoCVIJcXVlcnlQYXRoEh0KCndvcmtlcl9pZHMYAyADKAlSCXdvcmtlcklkcw==');
...
const GetGuestAttributesResponse$json = const {
  ...
  '2': const [
    const {'1': 'guest_attributes', '3': 1, '4': 3, '5': 11, '6': '.google.cloud.tpu.v2alpha1.GuestAttributes', '10': 'guestAttributes'},
  ],
};

/// Descriptor for `GetGuestAttributesResponse`. Decode as a `google.protobuf.DescriptorProto`.
final $typed_data.Uint8List getGuestAttributesResponseDescriptor = $convert.base64Decode('ChpHZXRHdWVzdEF0dHJpYnV0ZXNSZXNwb25zZRJVChBndWVzdF9hdHRyaWJ1dGVzGAEgAygLMiouZ29vZ2xlLmNsb3VkLnRwdS52MmFscGhhMS5HdWVzdEF0dHJpYnV0ZXNSD2d1ZXN0QXR0cmlidXRlcw==');

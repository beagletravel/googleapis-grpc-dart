...
class CreateEnvironmentRequest extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'CreateEnvironmentRequest', package: const $pb.PackageName(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'google.cloud.orchestration.airflow.service.v1beta1'), createEmptyInstance: create)
    ..aOS(1, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'parent')
    ..aOM<Environment>(2, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'environment', subBuilder: Environment.create)
...
class GetEnvironmentRequest extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'GetEnvironmentRequest', package: const $pb.PackageName(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'google.cloud.orchestration.airflow.service.v1beta1'), createEmptyInstance: create)
...
class ListEnvironmentsRequest extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'ListEnvironmentsRequest', package: const $pb.PackageName(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'google.cloud.orchestration.airflow.service.v1beta1'), createEmptyInstance: create)
    ..aOS(1, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'parent')
...
class ListEnvironmentsResponse extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'ListEnvironmentsResponse', package: const $pb.PackageName(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'google.cloud.orchestration.airflow.service.v1beta1'), createEmptyInstance: create)
...
class DeleteEnvironmentRequest extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'DeleteEnvironmentRequest', package: const $pb.PackageName(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'google.cloud.orchestration.airflow.service.v1beta1'), createEmptyInstance: create)
    ..aOS(1, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'name')
    ..hasRequiredFields = false
  ;
...
class UpdateEnvironmentRequest extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'UpdateEnvironmentRequest', package: const $pb.PackageName(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'google.cloud.orchestration.airflow.service.v1beta1'), createEmptyInstance: create)
    ..aOM<Environment>(1, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'environment', subBuilder: Environment.create)
...
class RestartWebServerRequest extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'RestartWebServerRequest', package: const $pb.PackageName(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'google.cloud.orchestration.airflow.service.v1beta1'), createEmptyInstance: create)
    ..aOS(1, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'name')
    ..hasRequiredFields = false
  ;
  ...
  factory RestartWebServerRequest.fromBuffer($core.List<$core.int> i, [$pb.ExtensionRegistry r = $pb.ExtensionRegistry.EMPTY]) => create()..mergeFromBuffer(i, r);
  factory RestartWebServerRequest.fromJson($core.String i, [$pb.ExtensionRegistry r = $pb.ExtensionRegistry.EMPTY]) => create()..mergeFromJson(i, r);
  @$core.Deprecated(
  'Using this can add significant overhead to your binary. '
  'Use [GeneratedMessageGenericExtensions.deepCopy] instead. '
  'Will be removed in next major version')
  RestartWebServerRequest clone() => RestartWebServerRequest()..mergeFromMessage(this);
  @$core.Deprecated(
  'Using this can add significant overhead to your binary. '
  'Use [GeneratedMessageGenericExtensions.rebuild] instead. '
  'Will be removed in next major version')
  RestartWebServerRequest copyWith(void Function(RestartWebServerRequest) updates) => super.copyWith((message) => updates(message as RestartWebServerRequest)) as RestartWebServerRequest; // ignore: deprecated_member_use
  $pb.BuilderInfo get info_ => _i;
  @$core.pragma('dart2js:noInline')
  static RestartWebServerRequest create() => RestartWebServerRequest._();
  RestartWebServerRequest createEmptyInstance() => create();
  static $pb.PbList<RestartWebServerRequest> createRepeated() => $pb.PbList<RestartWebServerRequest>();
  @$core.pragma('dart2js:noInline')
  static RestartWebServerRequest getDefault() => _defaultInstance ??= $pb.GeneratedMessage.$_defaultFor<RestartWebServerRequest>(create);
...
class EnvironmentConfig extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'EnvironmentConfig', package: const $pb.PackageName(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'google.cloud.orchestration.airflow.service.v1beta1'), createEmptyInstance: create)
    ..aOS(1, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'gkeCluster')
    ..aOS(2, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'dagGcsPrefix')
    ..a<$core.int>(3, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'nodeCount', $pb.PbFieldType.O3)
    ..aOM<SoftwareConfig>(4, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'softwareConfig', subBuilder: SoftwareConfig.create)
    ..aOM<NodeConfig>(5, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'nodeConfig', subBuilder: NodeConfig.create)
    ..aOS(6, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'airflowUri')
    ..aOM<PrivateEnvironmentConfig>(7, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'privateEnvironmentConfig', subBuilder: PrivateEnvironmentConfig.create)
    ..aOM<WebServerNetworkAccessControl>(9, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'webServerNetworkAccessControl', subBuilder: WebServerNetworkAccessControl.create)
    ..aOM<DatabaseConfig>(10, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'databaseConfig', subBuilder: DatabaseConfig.create)
    ..aOM<WebServerConfig>(11, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'webServerConfig', subBuilder: WebServerConfig.create)
    ..aOM<EncryptionConfig>(12, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'encryptionConfig', subBuilder: EncryptionConfig.create)
    ..aOM<MaintenanceWindow>(13, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'maintenanceWindow', subBuilder: MaintenanceWindow.create)
    ..aOM<WorkloadsConfig>(15, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'workloadsConfig', subBuilder: WorkloadsConfig.create)
    ..e<EnvironmentConfig_EnvironmentSize>(16, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'environmentSize', $pb.PbFieldType.OE, defaultOrMaker: EnvironmentConfig_EnvironmentSize.ENVIRONMENT_SIZE_UNSPECIFIED, valueOf: EnvironmentConfig_EnvironmentSize.valueOf, enumValues: EnvironmentConfig_EnvironmentSize.values)
    ..hasRequiredFields = false
  ;
  ...
  @$pb.TagNumber(9)
  set webServerNetworkAccessControl(WebServerNetworkAccessControl v) { setField(9, v); }
  @$pb.TagNumber(9)
  ...
  @$pb.TagNumber(10)
  set databaseConfig(DatabaseConfig v) { setField(10, v); }
  @$pb.TagNumber(10)
  ...
  @$pb.TagNumber(11)
  set webServerConfig(WebServerConfig v) { setField(11, v); }
  @$pb.TagNumber(11)
  ...
  @$pb.TagNumber(13)
  set maintenanceWindow(MaintenanceWindow v) { setField(13, v); }
  @$pb.TagNumber(13)
...
class WebServerNetworkAccessControl_AllowedIpRange extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'WebServerNetworkAccessControl.AllowedIpRange', package: const $pb.PackageName(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'google.cloud.orchestration.airflow.service.v1beta1'), createEmptyInstance: create)
  ...
  'Use [GeneratedMessageGenericExtensions.rebuild] instead. '
  'Will be removed in next major version')
  WebServerNetworkAccessControl_AllowedIpRange copyWith(void Function(WebServerNetworkAccessControl_AllowedIpRange) updates) => super.copyWith((message) => updates(message as WebServerNetworkAccessControl_AllowedIpRange)) as WebServerNetworkAccessControl_AllowedIpRange; // ignore: deprecated_member_use
  $pb.BuilderInfo get info_ => _i;
  @$core.pragma('dart2js:noInline')
...
class WebServerNetworkAccessControl extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'WebServerNetworkAccessControl', package: const $pb.PackageName(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'google.cloud.orchestration.airflow.service.v1beta1'), createEmptyInstance: create)
    ..pc<WebServerNetworkAccessControl_AllowedIpRange>(1, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'allowedIpRanges', $pb.PbFieldType.PM, subBuilder: WebServerNetworkAccessControl_AllowedIpRange.create)
    ..hasRequiredFields = false
  ;
  ...
  'Use [GeneratedMessageGenericExtensions.rebuild] instead. '
  'Will be removed in next major version')
  WebServerNetworkAccessControl copyWith(void Function(WebServerNetworkAccessControl) updates) => super.copyWith((message) => updates(message as WebServerNetworkAccessControl)) as WebServerNetworkAccessControl; // ignore: deprecated_member_use
  $pb.BuilderInfo get info_ => _i;
  @$core.pragma('dart2js:noInline')
...
class SoftwareConfig extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'SoftwareConfig', package: const $pb.PackageName(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'google.cloud.orchestration.airflow.service.v1beta1'), createEmptyInstance: create)
    ..aOS(1, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'imageVersion')
    ..m<$core.String, $core.String>(2, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'airflowConfigOverrides', entryClassName: 'SoftwareConfig.AirflowConfigOverridesEntry', keyFieldType: $pb.PbFieldType.OS, valueFieldType: $pb.PbFieldType.OS, packageName: const $pb.PackageName('google.cloud.orchestration.airflow.service.v1beta1'))
    ..m<$core.String, $core.String>(3, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'pypiPackages', entryClassName: 'SoftwareConfig.PypiPackagesEntry', keyFieldType: $pb.PbFieldType.OS, valueFieldType: $pb.PbFieldType.OS, packageName: const $pb.PackageName('google.cloud.orchestration.airflow.service.v1beta1'))
    ..m<$core.String, $core.String>(4, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'envVariables', entryClassName: 'SoftwareConfig.EnvVariablesEntry', keyFieldType: $pb.PbFieldType.OS, valueFieldType: $pb.PbFieldType.OS, packageName: const $pb.PackageName('google.cloud.orchestration.airflow.service.v1beta1'))
    ..aOS(6, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'pythonVersion')
    ..hasRequiredFields = false
  ;
...
class IPAllocationPolicy extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'IPAllocationPolicy', package: const $pb.PackageName(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'google.cloud.orchestration.airflow.service.v1beta1'), createEmptyInstance: create)
    ..aOB(1, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'useIpAliases')
    ..aOS(2, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'clusterSecondaryRangeName')
    ..aOS(3, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'servicesSecondaryRangeName')
    ..aOS(4, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'clusterIpv4CidrBlock')
    ..aOS(5, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'servicesIpv4CidrBlock')
    ..hasRequiredFields = false
  ;
...
class NodeConfig extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'NodeConfig', package: const $pb.PackageName(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'google.cloud.orchestration.airflow.service.v1beta1'), createEmptyInstance: create)
    ...
    ..aOS(4, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'subnetwork')
    ..a<$core.int>(5, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'diskSizeGb', $pb.PbFieldType.O3)
    ..pPS(6, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'oauthScopes')
    ..aOS(7, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'serviceAccount')
    ..pPS(8, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'tags')
    ..aOM<IPAllocationPolicy>(9, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'ipAllocationPolicy', subBuilder: IPAllocationPolicy.create)
    ..a<$core.int>(10, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'maxPodsPerNode', $pb.PbFieldType.O3)
    ..hasRequiredFields = false
  ;
  ...
  @$pb.TagNumber(10)
  set maxPodsPerNode($core.int v) { $_setSignedInt32(9, v); }
  @$pb.TagNumber(10)
...
class PrivateClusterConfig extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'PrivateClusterConfig', package: const $pb.PackageName(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'google.cloud.orchestration.airflow.service.v1beta1'), createEmptyInstance: create)
    ..aOB(1, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'enablePrivateEndpoint')
    ..aOS(2, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'masterIpv4CidrBlock')
    ..aOS(3, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'masterIpv4ReservedRange')
    ..hasRequiredFields = false
  ;
...
class PrivateEnvironmentConfig extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'PrivateEnvironmentConfig', package: const $pb.PackageName(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'google.cloud.orchestration.airflow.service.v1beta1'), createEmptyInstance: create)
    ..aOB(1, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'enablePrivateEnvironment')
    ..aOM<PrivateClusterConfig>(2, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'privateClusterConfig', subBuilder: PrivateClusterConfig.create)
    ..aOS(3, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'webServerIpv4CidrBlock')
    ..aOS(4, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'cloudSqlIpv4CidrBlock')
    ..aOS(5, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'webServerIpv4ReservedRange')
    ..aOS(7, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'cloudComposerNetworkIpv4CidrBlock')
    ..aOS(8, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'cloudComposerNetworkIpv4ReservedRange')
    ..hasRequiredFields = false
  ;
  ...
  factory PrivateEnvironmentConfig({
    ...
    if (cloudComposerNetworkIpv4CidrBlock != null) {
      _result.cloudComposerNetworkIpv4CidrBlock = cloudComposerNetworkIpv4CidrBlock;
    }
    if (cloudComposerNetworkIpv4ReservedRange != null) {
      _result.cloudComposerNetworkIpv4ReservedRange = cloudComposerNetworkIpv4ReservedRange;
    }
    return _result;
  }
  ...
  'Use [GeneratedMessageGenericExtensions.rebuild] instead. '
  'Will be removed in next major version')
  PrivateEnvironmentConfig copyWith(void Function(PrivateEnvironmentConfig) updates) => super.copyWith((message) => updates(message as PrivateEnvironmentConfig)) as PrivateEnvironmentConfig; // ignore: deprecated_member_use
  $pb.BuilderInfo get info_ => _i;
  @$core.pragma('dart2js:noInline')
  ...
  @$pb.TagNumber(7)
  set cloudComposerNetworkIpv4CidrBlock($core.String v) { $_setString(5, v); }
  @$pb.TagNumber(7)
  ...
  @$pb.TagNumber(8)
  set cloudComposerNetworkIpv4ReservedRange($core.String v) { $_setString(6, v); }
  @$pb.TagNumber(8)
...
class DatabaseConfig extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'DatabaseConfig', package: const $pb.PackageName(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'google.cloud.orchestration.airflow.service.v1beta1'), createEmptyInstance: create)
  ...
  'Use [GeneratedMessageGenericExtensions.rebuild] instead. '
  'Will be removed in next major version')
  DatabaseConfig copyWith(void Function(DatabaseConfig) updates) => super.copyWith((message) => updates(message as DatabaseConfig)) as DatabaseConfig; // ignore: deprecated_member_use
  $pb.BuilderInfo get info_ => _i;
  @$core.pragma('dart2js:noInline')
...
class WebServerConfig extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'WebServerConfig', package: const $pb.PackageName(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'google.cloud.orchestration.airflow.service.v1beta1'), createEmptyInstance: create)
    ..aOS(1, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'machineType')
    ..hasRequiredFields = false
  ;
  ...
  'Use [GeneratedMessageGenericExtensions.rebuild] instead. '
  'Will be removed in next major version')
  WebServerConfig copyWith(void Function(WebServerConfig) updates) => super.copyWith((message) => updates(message as WebServerConfig)) as WebServerConfig; // ignore: deprecated_member_use
  $pb.BuilderInfo get info_ => _i;
  @$core.pragma('dart2js:noInline')
...
class EncryptionConfig extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'EncryptionConfig', package: const $pb.PackageName(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'google.cloud.orchestration.airflow.service.v1beta1'), createEmptyInstance: create)
...
class MaintenanceWindow extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'MaintenanceWindow', package: const $pb.PackageName(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'google.cloud.orchestration.airflow.service.v1beta1'), createEmptyInstance: create)
    ...
    ..aOS(3, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'recurrence')
    ..hasRequiredFields = false
  ;
...
class WorkloadsConfig_SchedulerResource extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'WorkloadsConfig.SchedulerResource', package: const $pb.PackageName(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'google.cloud.orchestration.airflow.service.v1beta1'), createEmptyInstance: create)
    ..a<$core.double>(1, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'cpu', $pb.PbFieldType.OF)
    ..a<$core.double>(2, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'memoryGb', $pb.PbFieldType.OF)
    ..a<$core.double>(3, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'storageGb', $pb.PbFieldType.OF)
  ...
  'Use [GeneratedMessageGenericExtensions.rebuild] instead. '
  'Will be removed in next major version')
  WorkloadsConfig_SchedulerResource copyWith(void Function(WorkloadsConfig_SchedulerResource) updates) => super.copyWith((message) => updates(message as WorkloadsConfig_SchedulerResource)) as WorkloadsConfig_SchedulerResource; // ignore: deprecated_member_use
  $pb.BuilderInfo get info_ => _i;
  @$core.pragma('dart2js:noInline')
...
class WorkloadsConfig_WebServerResource extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'WorkloadsConfig.WebServerResource', package: const $pb.PackageName(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'google.cloud.orchestration.airflow.service.v1beta1'), createEmptyInstance: create)
    ..a<$core.double>(1, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'cpu', $pb.PbFieldType.OF)
    ..a<$core.double>(2, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'memoryGb', $pb.PbFieldType.OF)
    ..a<$core.double>(3, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'storageGb', $pb.PbFieldType.OF)
    ..hasRequiredFields = false
  ...
  'Use [GeneratedMessageGenericExtensions.rebuild] instead. '
  'Will be removed in next major version')
  WorkloadsConfig_WebServerResource copyWith(void Function(WorkloadsConfig_WebServerResource) updates) => super.copyWith((message) => updates(message as WorkloadsConfig_WebServerResource)) as WorkloadsConfig_WebServerResource; // ignore: deprecated_member_use
  $pb.BuilderInfo get info_ => _i;
  @$core.pragma('dart2js:noInline')
...
class WorkloadsConfig_WorkerResource extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'WorkloadsConfig.WorkerResource', package: const $pb.PackageName(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'google.cloud.orchestration.airflow.service.v1beta1'), createEmptyInstance: create)
    ..a<$core.double>(1, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'cpu', $pb.PbFieldType.OF)
    ..a<$core.double>(2, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'memoryGb', $pb.PbFieldType.OF)
    ..a<$core.double>(3, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'storageGb', $pb.PbFieldType.OF)
    ..a<$core.int>(4, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'minCount', $pb.PbFieldType.O3)
    ..a<$core.int>(5, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'maxCount', $pb.PbFieldType.O3)
    ..hasRequiredFields = false
  ;
  ...
  'Use [GeneratedMessageGenericExtensions.rebuild] instead. '
  'Will be removed in next major version')
  WorkloadsConfig_WorkerResource copyWith(void Function(WorkloadsConfig_WorkerResource) updates) => super.copyWith((message) => updates(message as WorkloadsConfig_WorkerResource)) as WorkloadsConfig_WorkerResource; // ignore: deprecated_member_use
  $pb.BuilderInfo get info_ => _i;
  @$core.pragma('dart2js:noInline')
...
class WorkloadsConfig extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'WorkloadsConfig', package: const $pb.PackageName(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'google.cloud.orchestration.airflow.service.v1beta1'), createEmptyInstance: create)
    ..aOM<WorkloadsConfig_SchedulerResource>(1, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'scheduler', subBuilder: WorkloadsConfig_SchedulerResource.create)
    ..aOM<WorkloadsConfig_WebServerResource>(2, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'webServer', subBuilder: WorkloadsConfig_WebServerResource.create)
    ..aOM<WorkloadsConfig_WorkerResource>(3, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'worker', subBuilder: WorkloadsConfig_WorkerResource.create)
    ..hasRequiredFields = false
  ;
  ...
  'Use [GeneratedMessageGenericExtensions.rebuild] instead. '
  'Will be removed in next major version')
  WorkloadsConfig copyWith(void Function(WorkloadsConfig) updates) => super.copyWith((message) => updates(message as WorkloadsConfig)) as WorkloadsConfig; // ignore: deprecated_member_use
  $pb.BuilderInfo get info_ => _i;
  @$core.pragma('dart2js:noInline')
...
class Environment extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'Environment', package: const $pb.PackageName(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'google.cloud.orchestration.airflow.service.v1beta1'), createEmptyInstance: create)
    ..aOS(1, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'name')
    ..aOM<EnvironmentConfig>(2, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'config', subBuilder: EnvironmentConfig.create)
    ..aOS(3, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'uuid')
    ..e<Environment_State>(4, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'state', $pb.PbFieldType.OE, defaultOrMaker: Environment_State.STATE_UNSPECIFIED, valueOf: Environment_State.valueOf, enumValues: Environment_State.values)
    ...
    ..m<$core.String, $core.String>(7, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'labels', entryClassName: 'Environment.LabelsEntry', keyFieldType: $pb.PbFieldType.OS, valueFieldType: $pb.PbFieldType.OS, packageName: const $pb.PackageName('google.cloud.orchestration.airflow.service.v1beta1'))
    ..hasRequiredFields = false
  ;
...
class CheckUpgradeRequest extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'CheckUpgradeRequest', package: const $pb.PackageName(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'google.cloud.orchestration.airflow.service.v1beta1'), createEmptyInstance: create)
    ..aOS(1, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'environment')
    ..aOS(2, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'imageVersion')
    ..hasRequiredFields = false
  ;
  ...
  factory CheckUpgradeRequest.fromBuffer($core.List<$core.int> i, [$pb.ExtensionRegistry r = $pb.ExtensionRegistry.EMPTY]) => create()..mergeFromBuffer(i, r);
  factory CheckUpgradeRequest.fromJson($core.String i, [$pb.ExtensionRegistry r = $pb.ExtensionRegistry.EMPTY]) => create()..mergeFromJson(i, r);
  @$core.Deprecated(
  'Using this can add significant overhead to your binary. '
  'Use [GeneratedMessageGenericExtensions.deepCopy] instead. '
  'Will be removed in next major version')
  ...
  'Use [GeneratedMessageGenericExtensions.rebuild] instead. '
  'Will be removed in next major version')
  CheckUpgradeRequest copyWith(void Function(CheckUpgradeRequest) updates) => super.copyWith((message) => updates(message as CheckUpgradeRequest)) as CheckUpgradeRequest; // ignore: deprecated_member_use
  $pb.BuilderInfo get info_ => _i;
  @$core.pragma('dart2js:noInline')
  static CheckUpgradeRequest create() => CheckUpgradeRequest._();
  CheckUpgradeRequest createEmptyInstance() => create();
  static $pb.PbList<CheckUpgradeRequest> createRepeated() => $pb.PbList<CheckUpgradeRequest>();
  @$core.pragma('dart2js:noInline')
  static CheckUpgradeRequest getDefault() => _defaultInstance ??= $pb.GeneratedMessage.$_defaultFor<CheckUpgradeRequest>(create);
  ...
  @$pb.TagNumber(2)
  set imageVersion($core.String v) { $_setString(1, v); }
  @$pb.TagNumber(2)
...
class CheckUpgradeResponse extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'CheckUpgradeResponse', package: const $pb.PackageName(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'google.cloud.orchestration.airflow.service.v1beta1'), createEmptyInstance: create)
    ..aOS(1, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'buildLogUri')
    ..aOS(3, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'pypiConflictBuildLogExtract')
    ..e<CheckUpgradeResponse_ConflictResult>(4, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'containsPypiModulesConflict', $pb.PbFieldType.OE, defaultOrMaker: CheckUpgradeResponse_ConflictResult.CONFLICT_RESULT_UNSPECIFIED, valueOf: CheckUpgradeResponse_ConflictResult.valueOf, enumValues: CheckUpgradeResponse_ConflictResult.values)
    ..aOS(5, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'imageVersion')
    ..m<$core.String, $core.String>(6, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'pypiDependencies', entryClassName: 'CheckUpgradeResponse.PypiDependenciesEntry', keyFieldType: $pb.PbFieldType.OS, valueFieldType: $pb.PbFieldType.OS, packageName: const $pb.PackageName('google.cloud.orchestration.airflow.service.v1beta1'))
    ..hasRequiredFields = false
  ;
  ...
  'Use [GeneratedMessageGenericExtensions.rebuild] instead. '
  'Will be removed in next major version')
  CheckUpgradeResponse copyWith(void Function(CheckUpgradeResponse) updates) => super.copyWith((message) => updates(message as CheckUpgradeResponse)) as CheckUpgradeResponse; // ignore: deprecated_member_use
  $pb.BuilderInfo get info_ => _i;
  @$core.pragma('dart2js:noInline')

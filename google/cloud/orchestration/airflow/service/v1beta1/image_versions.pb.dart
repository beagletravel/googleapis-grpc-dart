...
class ListImageVersionsRequest extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'ListImageVersionsRequest', package: const $pb.PackageName(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'google.cloud.orchestration.airflow.service.v1beta1'), createEmptyInstance: create)
    ...
    ..aOB(4, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'includePastReleases')
  ...
  'Will be removed in next major version')
  ListImageVersionsRequest copyWith(void Function(ListImageVersionsRequest) updates) => super.copyWith((message) => updates(message as ListImageVersionsRequest)) as ListImageVersionsRequest; // ignore: deprecated_member_use
...
class ListImageVersionsResponse extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'ListImageVersionsResponse', package: const $pb.PackageName(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'google.cloud.orchestration.airflow.service.v1beta1'), createEmptyInstance: create)
    ..pc<ImageVersion>(1, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'imageVersions', $pb.PbFieldType.PM, subBuilder: ImageVersion.create)
  ...
  'Use [GeneratedMessageGenericExtensions.rebuild] instead. '
  'Will be removed in next major version')
  ListImageVersionsResponse copyWith(void Function(ListImageVersionsResponse) updates) => super.copyWith((message) => updates(message as ListImageVersionsResponse)) as ListImageVersionsResponse; // ignore: deprecated_member_use
  $pb.BuilderInfo get info_ => _i;
  @$core.pragma('dart2js:noInline')
...
class ImageVersion extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'ImageVersion', package: const $pb.PackageName(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'google.cloud.orchestration.airflow.service.v1beta1'), createEmptyInstance: create)
    ..aOS(1, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'imageVersionId')
    ..aOB(2, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'isDefault')
    ..pPS(3, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'supportedPythonVersions')
    ..aOM<$1.Date>(4, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'releaseDate', subBuilder: $1.Date.create)
    ..aOB(5, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'creationDisabled')
    ..aOB(6, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'upgradeDisabled')
    ..hasRequiredFields = false
  ;
  ...
  'Use [GeneratedMessageGenericExtensions.rebuild] instead. '
  'Will be removed in next major version')
  ImageVersion copyWith(void Function(ImageVersion) updates) => super.copyWith((message) => updates(message as ImageVersion)) as ImageVersion; // ignore: deprecated_member_use
  $pb.BuilderInfo get info_ => _i;
  @$core.pragma('dart2js:noInline')
  ...
  @$pb.TagNumber(4)
  set releaseDate($1.Date v) { setField(4, v); }
  @$pb.TagNumber(4)

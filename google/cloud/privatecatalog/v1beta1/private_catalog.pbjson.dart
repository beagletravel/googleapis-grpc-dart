...
final $typed_data.Uint8List searchCatalogsRequestDescriptor = $convert.base64Decode('ChVTZWFyY2hDYXRhbG9nc1JlcXVlc3QSHwoIcmVzb3VyY2UYASABKAlCA+BBAlIIcmVzb3VyY2USFAoFcXVlcnkYAiABKAlSBXF1ZXJ5EhsKCXBhZ2Vfc2l6ZRgDIAEoBVIIcGFnZVNpemUSHQoKcGFnZV90b2tlbhgEIAEoCVIJcGFnZVRva2Vu');
...
const SearchCatalogsResponse$json = const {
  ...
  '2': const [
    const {'1': 'catalogs', '3': 1, '4': 3, '5': 11, '6': '.google.cloud.privatecatalog.v1beta1.Catalog', '10': 'catalogs'},
    const {'1': 'next_page_token', '3': 2, '4': 1, '5': 9, '10': 'nextPageToken'},
  ],
};

/// Descriptor for `SearchCatalogsResponse`. Decode as a `google.protobuf.DescriptorProto`.
final $typed_data.Uint8List searchCatalogsResponseDescriptor = $convert.base64Decode('ChZTZWFyY2hDYXRhbG9nc1Jlc3BvbnNlEkgKCGNhdGFsb2dzGAEgAygLMiwuZ29vZ2xlLmNsb3VkLnByaXZhdGVjYXRhbG9nLnYxYmV0YTEuQ2F0YWxvZ1IIY2F0YWxvZ3MSJgoPbmV4dF9wYWdlX3Rva2VuGAIgASgJUg1uZXh0UGFnZVRva2Vu');
...
final $typed_data.Uint8List searchProductsRequestDescriptor = $convert.base64Decode('ChVTZWFyY2hQcm9kdWN0c1JlcXVlc3QSHwoIcmVzb3VyY2UYASABKAlCA+BBAlIIcmVzb3VyY2USFAoFcXVlcnkYAiABKAlSBXF1ZXJ5EhsKCXBhZ2Vfc2l6ZRgDIAEoBVIIcGFnZVNpemUSHQoKcGFnZV90b2tlbhgEIAEoCVIJcGFnZVRva2Vu');
...
const SearchProductsResponse$json = const {
  ...
  '2': const [
    const {'1': 'products', '3': 1, '4': 3, '5': 11, '6': '.google.cloud.privatecatalog.v1beta1.Product', '10': 'products'},
    const {'1': 'next_page_token', '3': 2, '4': 1, '5': 9, '10': 'nextPageToken'},
  ],
};

/// Descriptor for `SearchProductsResponse`. Decode as a `google.protobuf.DescriptorProto`.
final $typed_data.Uint8List searchProductsResponseDescriptor = $convert.base64Decode('ChZTZWFyY2hQcm9kdWN0c1Jlc3BvbnNlEkgKCHByb2R1Y3RzGAEgAygLMiwuZ29vZ2xlLmNsb3VkLnByaXZhdGVjYXRhbG9nLnYxYmV0YTEuUHJvZHVjdFIIcHJvZHVjdHMSJgoPbmV4dF9wYWdlX3Rva2VuGAIgASgJUg1uZXh0UGFnZVRva2Vu');
...
final $typed_data.Uint8List searchVersionsRequestDescriptor = $convert.base64Decode('ChVTZWFyY2hWZXJzaW9uc1JlcXVlc3QSHwoIcmVzb3VyY2UYASABKAlCA+BBAlIIcmVzb3VyY2USGQoFcXVlcnkYAiABKAlCA+BBAlIFcXVlcnkSGwoJcGFnZV9zaXplGAMgASgFUghwYWdlU2l6ZRIdCgpwYWdlX3Rva2VuGAQgASgJUglwYWdlVG9rZW4=');
...
const SearchVersionsResponse$json = const {
  ...
  '2': const [
    const {'1': 'versions', '3': 1, '4': 3, '5': 11, '6': '.google.cloud.privatecatalog.v1beta1.Version', '10': 'versions'},
    const {'1': 'next_page_token', '3': 2, '4': 1, '5': 9, '10': 'nextPageToken'},
  ],
};

/// Descriptor for `SearchVersionsResponse`. Decode as a `google.protobuf.DescriptorProto`.
final $typed_data.Uint8List searchVersionsResponseDescriptor = $convert.base64Decode('ChZTZWFyY2hWZXJzaW9uc1Jlc3BvbnNlEkgKCHZlcnNpb25zGAEgAygLMiwuZ29vZ2xlLmNsb3VkLnByaXZhdGVjYXRhbG9nLnYxYmV0YTEuVmVyc2lvblIIdmVyc2lvbnMSJgoPbmV4dF9wYWdlX3Rva2VuGAIgASgJUg1uZXh0UGFnZVRva2Vu');
...
final $typed_data.Uint8List catalogDescriptor = $convert.base64Decode('');
@$core.Deprecated('Use productDescriptor instead')
const Product$json = const {
  '1': 'Product',
  '2': const [
    const {'1': 'name', '3': 1, '4': 1, '5': 9, '8': const {}, '10': 'name'},
    const {'1': 'asset_type', '3': 2, '4': 1, '5': 9, '8': const {}, '10': 'assetType'},
    const {'1': 'display_metadata', '3': 3, '4': 1, '5': 11, '6': '.google.protobuf.Struct', '8': const {}, '10': 'displayMetadata'},
    const {'1': 'icon_uri', '3': 4, '4': 1, '5': 9, '8': const {}, '10': 'iconUri'},
    const {'1': 'asset_references', '3': 10, '4': 3, '5': 11, '6': '.google.cloud.privatecatalog.v1beta1.AssetReference', '8': const {}, '10': 'assetReferences'},
...
const AssetReference$json = const {
  ...
  '2': const [
    ...
    const {'1': 'inputs', '3': 6, '4': 1, '5': 11, '6': '.google.cloud.privatecatalog.v1beta1.Inputs', '8': const {}, '10': 'inputs'},
    const {'1': 'validation_status', '3': 7, '4': 1, '5': 14, '6': '.google.cloud.privatecatalog.v1beta1.AssetReference.AssetValidationState', '8': const {}, '10': 'validationStatus'},
    const {'1': 'validation_operation', '3': 8, '4': 1, '5': 11, '6': '.google.longrunning.Operation', '8': const {}, '10': 'validationOperation'},
    const {'1': 'asset', '3': 10, '4': 1, '5': 9, '8': const {}, '9': 0, '10': 'asset'},
    const {
      '1': 'gcs_path',
      '3': 11,
      '4': 1,
    ...
    const {'1': 'git_source', '3': 15, '4': 1, '5': 11, '6': '.google.cloud.privatecatalog.v1beta1.GitSource', '8': const {}, '9': 0, '10': 'gitSource'},
    const {'1': 'gcs_source', '3': 16, '4': 1, '5': 11, '6': '.google.cloud.privatecatalog.v1beta1.GcsSource', '8': const {}, '10': 'gcsSource'},
...
final $typed_data.Uint8List gcsSourceDescriptor = $convert.base64Decode('CglHY3NTb3VyY2USHgoIZ2NzX3BhdGgYASABKAlCA+BBA1IHZ2NzUGF0aBIjCgpnZW5lcmF0aW9uGAIgASgDQgPgQQNSCmdlbmVyYXRpb24SQAoLdXBkYXRlX3RpbWUYAyABKAsyGi5nb29nbGUucHJvdG9idWYuVGltZXN0YW1wQgPgQQNSCnVwZGF0ZVRpbWU=');
...
final $typed_data.Uint8List gitSourceDescriptor = $convert.base64Decode('CglHaXRTb3VyY2USEgoEcmVwbxgBIAEoCVIEcmVwbxIQCgNkaXIYAiABKAlSA2RpchIYCgZjb21taXQYAyABKAlIAFIGY29tbWl0EhgKBmJyYW5jaBgEIAEoCUgAUgZicmFuY2gSEgoDdGFnGAUgASgJSABSA3RhZ0IFCgNyZWY=');
...
const Version$json = const {
  ...
  '2': const [
    const {'1': 'name', '3': 1, '4': 1, '5': 9, '8': const {}, '10': 'name'},
    const {'1': 'description', '3': 2, '4': 1, '5': 9, '8': const {}, '10': 'description'},
    const {'1': 'asset', '3': 3, '4': 1, '5': 11, '6': '.google.protobuf.Struct', '8': const {}, '10': 'asset'},
    const {'1': 'create_time', '3': 5, '4': 1, '5': 11, '6': '.google.protobuf.Timestamp', '8': const {}, '10': 'createTime'},
    const {'1': 'update_time', '3': 6, '4': 1, '5': 11, '6': '.google.protobuf.Timestamp', '8': const {}, '10': 'updateTime'},
  ],
  '7': const {},

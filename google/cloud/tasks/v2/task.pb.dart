...
class Task extends $pb.GeneratedMessage {
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'Task', package: const $pb.PackageName(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'google.cloud.tasks.v2'), createEmptyInstance: create)
    ..oo(0, [2, 3])
    ..aOS(1, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'name')
    ..aOM<$0.AppEngineHttpRequest>(2, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'appEngineHttpRequest', subBuilder: $0.AppEngineHttpRequest.create)
    ..aOM<$0.HttpRequest>(3, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'httpRequest', subBuilder: $0.HttpRequest.create)
    ...
    ..aOM<$2.Duration>(6, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'dispatchDeadline', subBuilder: $2.Duration.create)
    ..a<$core.int>(7, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'dispatchCount', $pb.PbFieldType.O3)
    ..a<$core.int>(8, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'responseCount', $pb.PbFieldType.O3)
    ..aOM<Attempt>(9, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'firstAttempt', subBuilder: Attempt.create)
    ..aOM<Attempt>(10, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'lastAttempt', subBuilder: Attempt.create)
    ..e<Task_View>(11, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'view', $pb.PbFieldType.OE, defaultOrMaker: Task_View.VIEW_UNSPECIFIED, valueOf: Task_View.valueOf, enumValues: Task_View.values)
  ...
  @$pb.TagNumber(2)
  set appEngineHttpRequest($0.AppEngineHttpRequest v) { setField(2, v); }
  @$pb.TagNumber(2)
  ...
  @$pb.TagNumber(3)
  set httpRequest($0.HttpRequest v) { setField(3, v); }
  @$pb.TagNumber(3)
  ...
  @$pb.TagNumber(6)
  set dispatchDeadline($2.Duration v) { setField(6, v); }
  @$pb.TagNumber(6)
...
class Attempt extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'Attempt', package: const $pb.PackageName(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'google.cloud.tasks.v2'), createEmptyInstance: create)

...
const HttpRequest$json = const {
  ...
  '2': const [
    ...
    const {'1': 'http_method', '3': 2, '4': 1, '5': 14, '6': '.google.cloud.tasks.v2.HttpMethod', '10': 'httpMethod'},
    const {'1': 'headers', '3': 3, '4': 3, '5': 11, '6': '.google.cloud.tasks.v2.HttpRequest.HeadersEntry', '10': 'headers'},
    const {'1': 'body', '3': 4, '4': 1, '5': 12, '10': 'body'},
    const {'1': 'oauth_token', '3': 5, '4': 1, '5': 11, '6': '.google.cloud.tasks.v2.OAuthToken', '9': 0, '10': 'oauthToken'},
    const {'1': 'oidc_token', '3': 6, '4': 1, '5': 11, '6': '.google.cloud.tasks.v2.OidcToken', '9': 0, '10': 'oidcToken'},
  ],
...
final $typed_data.Uint8List httpRequestDescriptor = $convert.base64Decode('');
...
final $typed_data.Uint8List appEngineHttpRequestDescriptor = $convert.base64Decode('');

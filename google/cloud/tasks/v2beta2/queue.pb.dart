...
class Queue extends $pb.GeneratedMessage {
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'Queue', package: const $pb.PackageName(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'google.cloud.tasks.v2beta2'), createEmptyInstance: create)
    ..oo(0, [3, 4])
    ..aOS(1, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'name')
    ..aOM<$0.AppEngineHttpTarget>(3, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'appEngineHttpTarget', subBuilder: $0.AppEngineHttpTarget.create)
    ..aOM<$0.PullTarget>(4, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'pullTarget', subBuilder: $0.PullTarget.create)
    ..aOM<RateLimits>(5, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'rateLimits', subBuilder: RateLimits.create)
    ..aOM<RetryConfig>(6, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'retryConfig', subBuilder: RetryConfig.create)
    ..e<Queue_State>(7, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'state', $pb.PbFieldType.OE, defaultOrMaker: Queue_State.STATE_UNSPECIFIED, valueOf: Queue_State.valueOf, enumValues: Queue_State.values)
    ..aOM<$1.Timestamp>(8, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'purgeTime', subBuilder: $1.Timestamp.create)
    ..aOM<$2.Duration>(9, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'taskTtl', subBuilder: $2.Duration.create)
    ..aOM<$2.Duration>(10, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'tombstoneTtl', subBuilder: $2.Duration.create)
    ..aOM<QueueStats>(16, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'stats', subBuilder: QueueStats.create)
  ...
  @$pb.TagNumber(3)
  set appEngineHttpTarget($0.AppEngineHttpTarget v) { setField(3, v); }
  @$pb.TagNumber(3)
  ...
  @$pb.TagNumber(4)
  set pullTarget($0.PullTarget v) { setField(4, v); }
  @$pb.TagNumber(4)
  ...
  @$pb.TagNumber(8)
  set purgeTime($1.Timestamp v) { setField(8, v); }
  @$pb.TagNumber(8)
  ...
  @$pb.TagNumber(9)
  set taskTtl($2.Duration v) { setField(9, v); }
  @$pb.TagNumber(9)
  ...
  @$pb.TagNumber(10)
  set tombstoneTtl($2.Duration v) { setField(10, v); }
  @$pb.TagNumber(10)
...
class RateLimits extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'RateLimits', package: const $pb.PackageName(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'google.cloud.tasks.v2beta2'), createEmptyInstance: create)
    ..a<$core.double>(1, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'maxTasksDispatchedPerSecond', $pb.PbFieldType.OD)
    ..a<$core.int>(2, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'maxBurstSize', $pb.PbFieldType.O3)
    ..a<$core.int>(3, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'maxConcurrentTasks', $pb.PbFieldType.O3)
    ..hasRequiredFields = false
  ;
...
class RetryConfig extends $pb.GeneratedMessage {
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'RetryConfig', package: const $pb.PackageName(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'google.cloud.tasks.v2beta2'), createEmptyInstance: create)
    ..oo(0, [1, 2])
    ..a<$core.int>(1, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'maxAttempts', $pb.PbFieldType.O3)
    ..aOB(2, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'unlimitedAttempts')
    ..aOM<$2.Duration>(3, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'maxRetryDuration', subBuilder: $2.Duration.create)
    ..aOM<$2.Duration>(4, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'minBackoff', subBuilder: $2.Duration.create)
    ..aOM<$2.Duration>(5, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'maxBackoff', subBuilder: $2.Duration.create)
    ..a<$core.int>(6, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'maxDoublings', $pb.PbFieldType.O3)
    ..hasRequiredFields = false
  ;
  ...
  @$pb.TagNumber(3)
  set maxRetryDuration($2.Duration v) { setField(3, v); }
  @$pb.TagNumber(3)
  ...
  @$pb.TagNumber(4)
  set minBackoff($2.Duration v) { setField(4, v); }
  @$pb.TagNumber(4)
  ...
  @$pb.TagNumber(5)
  set maxBackoff($2.Duration v) { setField(5, v); }
  @$pb.TagNumber(5)
...
class QueueStats extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'QueueStats', package: const $pb.PackageName(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'google.cloud.tasks.v2beta2'), createEmptyInstance: create)

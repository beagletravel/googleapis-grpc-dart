...
final $typed_data.Uint8List httpMethodDescriptor = $convert.base64Decode('CgpIdHRwTWV0aG9kEhsKF0hUVFBfTUVUSE9EX1VOU1BFQ0lGSUVEEAASCAoEUE9TVBABEgcKA0dFVBACEggKBEhFQUQQAxIHCgNQVVQQBBIKCgZERUxFVEUQBQ==');
...
final $typed_data.Uint8List pullTargetDescriptor = $convert.base64Decode('CgpQdWxsVGFyZ2V0');
...
final $typed_data.Uint8List appEngineHttpTargetDescriptor = $convert.base64Decode('ChNBcHBFbmdpbmVIdHRwVGFyZ2V0EmsKG2FwcF9lbmdpbmVfcm91dGluZ19vdmVycmlkZRgBIAEoCzIsLmdvb2dsZS5jbG91ZC50YXNrcy52MmJldGEyLkFwcEVuZ2luZVJvdXRpbmdSGGFwcEVuZ2luZVJvdXRpbmdPdmVycmlkZQ==');
...
final $typed_data.Uint8List appEngineHttpRequestDescriptor = $convert.base64Decode('');

...
final $typed_data.Uint8List featureDescriptor = $convert.base64Decode('CgdGZWF0dXJlEhcKE0ZFQVRVUkVfVU5TUEVDSUZJRUQQABITCg9MQUJFTF9ERVRFQ1RJT04QARIZChVTSE9UX0NIQU5HRV9ERVRFQ1RJT04QAhIeChpFWFBMSUNJVF9DT05URU5UX0RFVEVDVElPThADEhgKFFNQRUVDSF9UUkFOU0NSSVBUSU9OEAY=');
...
const AnnotateVideoRequest$json = const {
  ...
  '2': const [
    ...
    const {'1': 'features', '3': 2, '4': 3, '5': 14, '6': '.google.cloud.videointelligence.v1p1beta1.Feature', '8': const {}, '10': 'features'},
...
final $typed_data.Uint8List annotateVideoRequestDescriptor = $convert.base64Decode('');
...
final $typed_data.Uint8List labelDetectionConfigDescriptor = $convert.base64Decode('');
...
final $typed_data.Uint8List labelSegmentDescriptor = $convert.base64Decode('CgxMYWJlbFNlZ21lbnQSUAoHc2VnbWVudBgBIAEoCzI2Lmdvb2dsZS5jbG91ZC52aWRlb2ludGVsbGlnZW5jZS52MXAxYmV0YTEuVmlkZW9TZWdtZW50UgdzZWdtZW50Eh4KCmNvbmZpZGVuY2UYAiABKAJSCmNvbmZpZGVuY2U=');
...
final $typed_data.Uint8List labelAnnotationDescriptor = $convert.base64Decode('');
...
final $typed_data.Uint8List explicitContentFrameDescriptor = $convert.base64Decode('ChRFeHBsaWNpdENvbnRlbnRGcmFtZRI6Cgt0aW1lX29mZnNldBgBIAEoCzIZLmdvb2dsZS5wcm90b2J1Zi5EdXJhdGlvblIKdGltZU9mZnNldBJrChZwb3Jub2dyYXBoeV9saWtlbGlob29kGAIgASgOMjQuZ29vZ2xlLmNsb3VkLnZpZGVvaW50ZWxsaWdlbmNlLnYxcDFiZXRhMS5MaWtlbGlob29kUhVwb3Jub2dyYXBoeUxpa2VsaWhvb2Q=');
...
final $typed_data.Uint8List explicitContentAnnotationDescriptor = $convert.base64Decode('ChlFeHBsaWNpdENvbnRlbnRBbm5vdGF0aW9uElYKBmZyYW1lcxgBIAMoCzI+Lmdvb2dsZS5jbG91ZC52aWRlb2ludGVsbGlnZW5jZS52MXAxYmV0YTEuRXhwbGljaXRDb250ZW50RnJhbWVSBmZyYW1lcw==');
...
final $typed_data.Uint8List videoAnnotationResultsDescriptor = $convert.base64Decode('');
...
final $typed_data.Uint8List annotateVideoResponseDescriptor = $convert.base64Decode('ChVBbm5vdGF0ZVZpZGVvUmVzcG9uc2USbwoSYW5ub3RhdGlvbl9yZXN1bHRzGAEgAygLMkAuZ29vZ2xlLmNsb3VkLnZpZGVvaW50ZWxsaWdlbmNlLnYxcDFiZXRhMS5WaWRlb0Fubm90YXRpb25SZXN1bHRzUhFhbm5vdGF0aW9uUmVzdWx0cw==');
...
final $typed_data.Uint8List annotateVideoProgressDescriptor = $convert.base64Decode('ChVBbm5vdGF0ZVZpZGVvUHJvZ3Jlc3MScgoTYW5ub3RhdGlvbl9wcm9ncmVzcxgBIAMoCzJBLmdvb2dsZS5jbG91ZC52aWRlb2ludGVsbGlnZW5jZS52MXAxYmV0YTEuVmlkZW9Bbm5vdGF0aW9uUHJvZ3Jlc3NSEmFubm90YXRpb25Qcm9ncmVzcw==');
...
const SpeechTranscriptionConfig$json = const {
  ...
  '2': const [
    ...
    const {'1': 'speech_contexts', '3': 4, '4': 3, '5': 11, '6': '.google.cloud.videointelligence.v1p1beta1.SpeechContext', '8': const {}, '10': 'speechContexts'},
...
final $typed_data.Uint8List speechTranscriptionDescriptor = $convert.base64Decode('ChNTcGVlY2hUcmFuc2NyaXB0aW9uEmoKDGFsdGVybmF0aXZlcxgBIAMoCzJGLmdvb2dsZS5jbG91ZC52aWRlb2ludGVsbGlnZW5jZS52MXAxYmV0YTEuU3BlZWNoUmVjb2duaXRpb25BbHRlcm5hdGl2ZVIMYWx0ZXJuYXRpdmVz');
...
final $typed_data.Uint8List speechRecognitionAlternativeDescriptor = $convert.base64Decode('ChxTcGVlY2hSZWNvZ25pdGlvbkFsdGVybmF0aXZlEh4KCnRyYW5zY3JpcHQYASABKAlSCnRyYW5zY3JpcHQSIwoKY29uZmlkZW5jZRgCIAEoAkID4EEDUgpjb25maWRlbmNlEkgKBXdvcmRzGAMgAygLMjIuZ29vZ2xlLmNsb3VkLnZpZGVvaW50ZWxsaWdlbmNlLnYxcDFiZXRhMS5Xb3JkSW5mb1IFd29yZHM=');
...
final $typed_data.Uint8List wordInfoDescriptor = $convert.base64Decode('CghXb3JkSW5mbxI4CgpzdGFydF90aW1lGAEgASgLMhkuZ29vZ2xlLnByb3RvYnVmLkR1cmF0aW9uUglzdGFydFRpbWUSNAoIZW5kX3RpbWUYAiABKAsyGS5nb29nbGUucHJvdG9idWYuRHVyYXRpb25SB2VuZFRpbWUSEgoEd29yZBgDIAEoCVIEd29yZA==');

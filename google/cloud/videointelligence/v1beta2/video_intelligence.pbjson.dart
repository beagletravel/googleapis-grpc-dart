...
final $typed_data.Uint8List featureDescriptor = $convert.base64Decode('CgdGZWF0dXJlEhcKE0ZFQVRVUkVfVU5TUEVDSUZJRUQQABITCg9MQUJFTF9ERVRFQ1RJT04QARIZChVTSE9UX0NIQU5HRV9ERVRFQ1RJT04QAhIeChpFWFBMSUNJVF9DT05URU5UX0RFVEVDVElPThADEhIKDkZBQ0VfREVURUNUSU9OEAQ=');
...
const AnnotateVideoRequest$json = const {
  ...
  '2': const [
    ...
    const {'1': 'features', '3': 2, '4': 3, '5': 14, '6': '.google.cloud.videointelligence.v1beta2.Feature', '8': const {}, '10': 'features'},
...
final $typed_data.Uint8List videoContextDescriptor = $convert.base64Decode('');
...
final $typed_data.Uint8List labelDetectionConfigDescriptor = $convert.base64Decode('');
...
final $typed_data.Uint8List faceDetectionConfigDescriptor = $convert.base64Decode('ChNGYWNlRGV0ZWN0aW9uQ29uZmlnEhQKBW1vZGVsGAEgASgJUgVtb2RlbBI0ChZpbmNsdWRlX2JvdW5kaW5nX2JveGVzGAIgASgIUhRpbmNsdWRlQm91bmRpbmdCb3hlcw==');
...
final $typed_data.Uint8List labelSegmentDescriptor = $convert.base64Decode('CgxMYWJlbFNlZ21lbnQSTgoHc2VnbWVudBgBIAEoCzI0Lmdvb2dsZS5jbG91ZC52aWRlb2ludGVsbGlnZW5jZS52MWJldGEyLlZpZGVvU2VnbWVudFIHc2VnbWVudBIeCgpjb25maWRlbmNlGAIgASgCUgpjb25maWRlbmNl');
...
final $typed_data.Uint8List labelAnnotationDescriptor = $convert.base64Decode('');
...
final $typed_data.Uint8List explicitContentFrameDescriptor = $convert.base64Decode('ChRFeHBsaWNpdENvbnRlbnRGcmFtZRI6Cgt0aW1lX29mZnNldBgBIAEoCzIZLmdvb2dsZS5wcm90b2J1Zi5EdXJhdGlvblIKdGltZU9mZnNldBJpChZwb3Jub2dyYXBoeV9saWtlbGlob29kGAIgASgOMjIuZ29vZ2xlLmNsb3VkLnZpZGVvaW50ZWxsaWdlbmNlLnYxYmV0YTIuTGlrZWxpaG9vZFIVcG9ybm9ncmFwaHlMaWtlbGlob29k');
...
final $typed_data.Uint8List explicitContentAnnotationDescriptor = $convert.base64Decode('ChlFeHBsaWNpdENvbnRlbnRBbm5vdGF0aW9uElQKBmZyYW1lcxgBIAMoCzI8Lmdvb2dsZS5jbG91ZC52aWRlb2ludGVsbGlnZW5jZS52MWJldGEyLkV4cGxpY2l0Q29udGVudEZyYW1lUgZmcmFtZXM=');
...
final $typed_data.Uint8List faceSegmentDescriptor = $convert.base64Decode('CgtGYWNlU2VnbWVudBJOCgdzZWdtZW50GAEgASgLMjQuZ29vZ2xlLmNsb3VkLnZpZGVvaW50ZWxsaWdlbmNlLnYxYmV0YTIuVmlkZW9TZWdtZW50UgdzZWdtZW50');
...
final $typed_data.Uint8List faceFrameDescriptor = $convert.base64Decode('');
...
final $typed_data.Uint8List faceAnnotationDescriptor = $convert.base64Decode('');
...
final $typed_data.Uint8List videoAnnotationResultsDescriptor = $convert.base64Decode('');
...
final $typed_data.Uint8List annotateVideoResponseDescriptor = $convert.base64Decode('ChVBbm5vdGF0ZVZpZGVvUmVzcG9uc2USbQoSYW5ub3RhdGlvbl9yZXN1bHRzGAEgAygLMj4uZ29vZ2xlLmNsb3VkLnZpZGVvaW50ZWxsaWdlbmNlLnYxYmV0YTIuVmlkZW9Bbm5vdGF0aW9uUmVzdWx0c1IRYW5ub3RhdGlvblJlc3VsdHM=');
...
final $typed_data.Uint8List annotateVideoProgressDescriptor = $convert.base64Decode('ChVBbm5vdGF0ZVZpZGVvUHJvZ3Jlc3MScAoTYW5ub3RhdGlvbl9wcm9ncmVzcxgBIAMoCzI/Lmdvb2dsZS5jbG91ZC52aWRlb2ludGVsbGlnZW5jZS52MWJldGEyLlZpZGVvQW5ub3RhdGlvblByb2dyZXNzUhJhbm5vdGF0aW9uUHJvZ3Jlc3M=');

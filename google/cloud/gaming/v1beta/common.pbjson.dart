...
const OperationMetadata$json = const {
  ...
  '2': const [
    ...
    const {'1': 'operation_status', '3': 9, '4': 3, '5': 11, '6': '.google.cloud.gaming.v1beta.OperationMetadata.OperationStatusEntry', '8': const {}, '10': 'operationStatus'},
  ],
...
const OperationMetadata_OperationStatusEntry$json = const {
  ...
  '2': const [
    ...
    const {'1': 'value', '3': 2, '4': 1, '5': 11, '6': '.google.cloud.gaming.v1beta.OperationStatus', '10': 'value'},
  ],
  '7': const {'7': true},
};
...
const OperationStatus$json = const {
  ...
  '2': const [
    ...
    const {'1': 'error_code', '3': 2, '4': 1, '5': 14, '6': '.google.cloud.gaming.v1beta.OperationStatus.ErrorCode', '10': 'errorCode'},
...
final $typed_data.Uint8List operationStatusDescriptor = $convert.base64Decode('');
@$core.Deprecated('Use labelSelectorDescriptor instead')
const LabelSelector$json = const {
  '1': 'LabelSelector',
  '2': const [
    const {'1': 'labels', '3': 1, '4': 3, '5': 11, '6': '.google.cloud.gaming.v1beta.LabelSelector.LabelsEntry', '10': 'labels'},
  ],
...
final $typed_data.Uint8List labelSelectorDescriptor = $convert.base64Decode('Cg1MYWJlbFNlbGVjdG9yEk0KBmxhYmVscxgBIAMoCzI1Lmdvb2dsZS5jbG91ZC5nYW1pbmcudjFiZXRhLkxhYmVsU2VsZWN0b3IuTGFiZWxzRW50cnlSBmxhYmVscxo5CgtMYWJlbHNFbnRyeRIQCgNrZXkYASABKAlSA2tleRIUCgV2YWx1ZRgCIAEoCVIFdmFsdWU6AjgB');
...
const TargetDetails$json = const {
  ...
  '2': const [
    ...
    const {'1': 'fleet_details', '3': 3, '4': 3, '5': 11, '6': '.google.cloud.gaming.v1beta.TargetDetails.TargetFleetDetails', '10': 'fleetDetails'},
  ],
...
const TargetDetails_TargetFleetDetails$json = const {
  ...
  '2': const [
    const {'1': 'fleet', '3': 1, '4': 1, '5': 11, '6': '.google.cloud.gaming.v1beta.TargetDetails.TargetFleetDetails.TargetFleet', '10': 'fleet'},
    const {'1': 'autoscaler', '3': 2, '4': 1, '5': 11, '6': '.google.cloud.gaming.v1beta.TargetDetails.TargetFleetDetails.TargetFleetAutoscaler', '10': 'autoscaler'},
  ],
...
const TargetDetails_TargetFleetDetails_TargetFleet$json = const {
  ...
  '2': const [
    ...
    const {'1': 'spec_source', '3': 2, '4': 1, '5': 11, '6': '.google.cloud.gaming.v1beta.SpecSource', '10': 'specSource'},
  ],
};
...
final $typed_data.Uint8List targetDetailsDescriptor = $convert.base64Decode('');
@$core.Deprecated('Use targetStateDescriptor instead')
const TargetState$json = const {
  '1': 'TargetState',
  '2': const [
    const {'1': 'details', '3': 1, '4': 3, '5': 11, '6': '.google.cloud.gaming.v1beta.TargetDetails', '10': 'details'},
  ],
};

/// Descriptor for `TargetState`. Decode as a `google.protobuf.DescriptorProto`.
final $typed_data.Uint8List targetStateDescriptor = $convert.base64Decode('CgtUYXJnZXRTdGF0ZRJDCgdkZXRhaWxzGAEgAygLMikuZ29vZ2xlLmNsb3VkLmdhbWluZy52MWJldGEuVGFyZ2V0RGV0YWlsc1IHZGV0YWlscw==');
@$core.Deprecated('Use deployedFleetDetailsDescriptor instead')
const DeployedFleetDetails$json = const {
  '1': 'DeployedFleetDetails',
  '2': const [
    const {'1': 'deployed_fleet', '3': 1, '4': 1, '5': 11, '6': '.google.cloud.gaming.v1beta.DeployedFleetDetails.DeployedFleet', '10': 'deployedFleet'},
    const {'1': 'deployed_autoscaler', '3': 2, '4': 1, '5': 11, '6': '.google.cloud.gaming.v1beta.DeployedFleetDetails.DeployedFleetAutoscaler', '10': 'deployedAutoscaler'},
  ],
...
const DeployedFleetDetails_DeployedFleet$json = const {
  ...
  '2': const [
    ...
    const {'1': 'spec_source', '3': 3, '4': 1, '5': 11, '6': '.google.cloud.gaming.v1beta.SpecSource', '10': 'specSource'},
    const {'1': 'status', '3': 5, '4': 1, '5': 11, '6': '.google.cloud.gaming.v1beta.DeployedFleetDetails.DeployedFleet.DeployedFleetStatus', '10': 'status'},
  ],
...
const DeployedFleetDetails_DeployedFleetAutoscaler$json = const {
  ...
  '2': const [
    ...
    const {'1': 'spec_source', '3': 4, '4': 1, '5': 11, '6': '.google.cloud.gaming.v1beta.SpecSource', '10': 'specSource'},

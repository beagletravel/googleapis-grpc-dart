...
class CustomerEvent extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'CustomerEvent', package: const $pb.PackageName(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'google.cloud.channel.v1'), createEmptyInstance: create)
    ..aOS(1, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'customer')
    ..e<CustomerEvent_Type>(2, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'eventType', $pb.PbFieldType.OE, defaultOrMaker: CustomerEvent_Type.TYPE_UNSPECIFIED, valueOf: CustomerEvent_Type.valueOf, enumValues: CustomerEvent_Type.values)
  ...
  'Will be removed in next major version')
  CustomerEvent copyWith(void Function(CustomerEvent) updates) => super.copyWith((message) => updates(message as CustomerEvent)) as CustomerEvent; // ignore: deprecated_member_use
...
class EntitlementEvent extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'EntitlementEvent', package: const $pb.PackageName(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'google.cloud.channel.v1'), createEmptyInstance: create)
    ..aOS(1, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'entitlement')
    ..e<EntitlementEvent_Type>(2, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'eventType', $pb.PbFieldType.OE, defaultOrMaker: EntitlementEvent_Type.TYPE_UNSPECIFIED, valueOf: EntitlementEvent_Type.valueOf, enumValues: EntitlementEvent_Type.values)
    ..hasRequiredFields = false
  ;
  ...
  'Use [GeneratedMessageGenericExtensions.rebuild] instead. '
  'Will be removed in next major version')
  EntitlementEvent copyWith(void Function(EntitlementEvent) updates) => super.copyWith((message) => updates(message as EntitlementEvent)) as EntitlementEvent; // ignore: deprecated_member_use
  $pb.BuilderInfo get info_ => _i;
  @$core.pragma('dart2js:noInline')
...
class SubscriberEvent extends $pb.GeneratedMessage {
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'SubscriberEvent', package: const $pb.PackageName(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'google.cloud.channel.v1'), createEmptyInstance: create)
    ..oo(0, [1, 2])
    ..aOM<CustomerEvent>(1, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'customerEvent', subBuilder: CustomerEvent.create)
    ..aOM<EntitlementEvent>(2, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'entitlementEvent', subBuilder: EntitlementEvent.create)
    ..hasRequiredFields = false
  ;
  ...
  'Use [GeneratedMessageGenericExtensions.rebuild] instead. '
  'Will be removed in next major version')
  SubscriberEvent copyWith(void Function(SubscriberEvent) updates) => super.copyWith((message) => updates(message as SubscriberEvent)) as SubscriberEvent; // ignore: deprecated_member_use
  $pb.BuilderInfo get info_ => _i;
  @$core.pragma('dart2js:noInline')

...
class Customer extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'Customer', package: const $pb.PackageName(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'google.cloud.channel.v1'), createEmptyInstance: create)
    ..aOS(1, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'name')
    ..aOS(2, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'orgDisplayName')
    ..aOM<$0.PostalAddress>(3, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'orgPostalAddress', subBuilder: $0.PostalAddress.create)
    ..aOM<ContactInfo>(4, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'primaryContactInfo', subBuilder: ContactInfo.create)
    ..aOS(5, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'alternateEmail')
    ...
    ..aOS(9, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'cloudIdentityId')
    ..aOS(10, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'languageCode')
    ..aOM<$2.CloudIdentityInfo>(12, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'cloudIdentityInfo', subBuilder: $2.CloudIdentityInfo.create)
    ..aOS(13, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'channelPartnerId')
  ...
  @$pb.TagNumber(3)
  set orgPostalAddress($0.PostalAddress v) { setField(3, v); }
  @$pb.TagNumber(3)
  ...
  @$pb.TagNumber(12)
  set cloudIdentityInfo($2.CloudIdentityInfo v) { setField(12, v); }
  @$pb.TagNumber(12)
...
class ContactInfo extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'ContactInfo', package: const $pb.PackageName(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'google.cloud.channel.v1'), createEmptyInstance: create)

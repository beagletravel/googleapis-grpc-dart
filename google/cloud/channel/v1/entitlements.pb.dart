...
class Entitlement extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'Entitlement', package: const $pb.PackageName(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'google.cloud.channel.v1'), createEmptyInstance: create)
    ...
    ..aOS(8, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'offer')
    ..aOM<CommitmentSettings>(12, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'commitmentSettings', subBuilder: CommitmentSettings.create)
    ..e<Entitlement_ProvisioningState>(13, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'provisioningState', $pb.PbFieldType.OE, defaultOrMaker: Entitlement_ProvisioningState.PROVISIONING_STATE_UNSPECIFIED, valueOf: Entitlement_ProvisioningState.valueOf, enumValues: Entitlement_ProvisioningState.values)
    ..aOM<ProvisionedService>(16, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'provisionedService', subBuilder: ProvisionedService.create)
    ..pc<Entitlement_SuspensionReason>(18, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'suspensionReasons', $pb.PbFieldType.PE, valueOf: Entitlement_SuspensionReason.valueOf, enumValues: Entitlement_SuspensionReason.values)
    ..aOS(19, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'purchaseOrderId')
    ..aOM<TrialSettings>(21, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'trialSettings', subBuilder: TrialSettings.create)
    ..aOM<AssociationInfo>(23, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'associationInfo', subBuilder: AssociationInfo.create)
    ..pc<Parameter>(26, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'parameters', $pb.PbFieldType.PM, subBuilder: Parameter.create)
  ...
  'Will be removed in next major version')
  Entitlement copyWith(void Function(Entitlement) updates) => super.copyWith((message) => updates(message as Entitlement)) as Entitlement; // ignore: deprecated_member_use
...
class Parameter extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'Parameter', package: const $pb.PackageName(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'google.cloud.channel.v1'), createEmptyInstance: create)
    ..aOS(1, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'name')
    ..aOM<$1.Value>(2, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'value', subBuilder: $1.Value.create)
    ..aOB(3, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'editable')
    ..hasRequiredFields = false
  ;
...
class AssociationInfo extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'AssociationInfo', package: const $pb.PackageName(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'google.cloud.channel.v1'), createEmptyInstance: create)
    ..aOS(1, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'baseEntitlement')
    ..hasRequiredFields = false
  ;
  ...
  'Use [GeneratedMessageGenericExtensions.rebuild] instead. '
  'Will be removed in next major version')
  AssociationInfo copyWith(void Function(AssociationInfo) updates) => super.copyWith((message) => updates(message as AssociationInfo)) as AssociationInfo; // ignore: deprecated_member_use
  $pb.BuilderInfo get info_ => _i;
  @$core.pragma('dart2js:noInline')
...
class ProvisionedService extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'ProvisionedService', package: const $pb.PackageName(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'google.cloud.channel.v1'), createEmptyInstance: create)
    ..aOS(1, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'provisioningId')
    ..aOS(2, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'productId')
    ..aOS(3, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'skuId')
    ..hasRequiredFields = false
  ;
  ...
  'Use [GeneratedMessageGenericExtensions.rebuild] instead. '
  'Will be removed in next major version')
  ProvisionedService copyWith(void Function(ProvisionedService) updates) => super.copyWith((message) => updates(message as ProvisionedService)) as ProvisionedService; // ignore: deprecated_member_use
  $pb.BuilderInfo get info_ => _i;
  @$core.pragma('dart2js:noInline')
...
class CommitmentSettings extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'CommitmentSettings', package: const $pb.PackageName(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'google.cloud.channel.v1'), createEmptyInstance: create)
    ...
    ..aOM<RenewalSettings>(4, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'renewalSettings', subBuilder: RenewalSettings.create)
    ..hasRequiredFields = false
  ;
  ...
  'Use [GeneratedMessageGenericExtensions.rebuild] instead. '
  'Will be removed in next major version')
  CommitmentSettings copyWith(void Function(CommitmentSettings) updates) => super.copyWith((message) => updates(message as CommitmentSettings)) as CommitmentSettings; // ignore: deprecated_member_use
  $pb.BuilderInfo get info_ => _i;
  @$core.pragma('dart2js:noInline')
...
class RenewalSettings extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'RenewalSettings', package: const $pb.PackageName(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'google.cloud.channel.v1'), createEmptyInstance: create)
    ..aOB(1, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'enableRenewal')
    ..aOB(2, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'resizeUnitCount')
    ..e<$2.PaymentPlan>(5, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'paymentPlan', $pb.PbFieldType.OE, defaultOrMaker: $2.PaymentPlan.PAYMENT_PLAN_UNSPECIFIED, valueOf: $2.PaymentPlan.valueOf, enumValues: $2.PaymentPlan.values)
    ..aOM<$2.Period>(6, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'paymentCycle', subBuilder: $2.Period.create)
    ..hasRequiredFields = false
  ;
  ...
  'Use [GeneratedMessageGenericExtensions.rebuild] instead. '
  'Will be removed in next major version')
  RenewalSettings copyWith(void Function(RenewalSettings) updates) => super.copyWith((message) => updates(message as RenewalSettings)) as RenewalSettings; // ignore: deprecated_member_use
  $pb.BuilderInfo get info_ => _i;
  @$core.pragma('dart2js:noInline')
  ...
  @$pb.TagNumber(5)
  set paymentPlan($2.PaymentPlan v) { setField(5, v); }
  @$pb.TagNumber(5)
  ...
  @$pb.TagNumber(6)
  set paymentCycle($2.Period v) { setField(6, v); }
  @$pb.TagNumber(6)
...
class TrialSettings extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'TrialSettings', package: const $pb.PackageName(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'google.cloud.channel.v1'), createEmptyInstance: create)
    ..aOB(1, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'trial')
    ..aOM<$0.Timestamp>(2, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'endTime', subBuilder: $0.Timestamp.create)
    ..hasRequiredFields = false
  ;
  ...
  'Use [GeneratedMessageGenericExtensions.rebuild] instead. '
  'Will be removed in next major version')
  TrialSettings copyWith(void Function(TrialSettings) updates) => super.copyWith((message) => updates(message as TrialSettings)) as TrialSettings; // ignore: deprecated_member_use
  $pb.BuilderInfo get info_ => _i;
  @$core.pragma('dart2js:noInline')
...
class TransferableSku extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'TransferableSku', package: const $pb.PackageName(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'google.cloud.channel.v1'), createEmptyInstance: create)
    ..aOM<TransferEligibility>(9, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'transferEligibility', subBuilder: TransferEligibility.create)
    ..aOM<$3.Sku>(11, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'sku', subBuilder: $3.Sku.create)
    ..aOM<$3.Sku>(12, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'legacySku', subBuilder: $3.Sku.create)
    ..hasRequiredFields = false
  ;
  ...
  'Use [GeneratedMessageGenericExtensions.rebuild] instead. '
  'Will be removed in next major version')
  TransferableSku copyWith(void Function(TransferableSku) updates) => super.copyWith((message) => updates(message as TransferableSku)) as TransferableSku; // ignore: deprecated_member_use
  $pb.BuilderInfo get info_ => _i;
  @$core.pragma('dart2js:noInline')
  ...
  @$pb.TagNumber(12)
  set legacySku($3.Sku v) { setField(12, v); }
  @$pb.TagNumber(12)
...
class TransferEligibility extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'TransferEligibility', package: const $pb.PackageName(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'google.cloud.channel.v1'), createEmptyInstance: create)
    ..aOB(1, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'isEligible')
    ..aOS(2, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'description')
    ..e<TransferEligibility_Reason>(3, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'ineligibilityReason', $pb.PbFieldType.OE, defaultOrMaker: TransferEligibility_Reason.REASON_UNSPECIFIED, valueOf: TransferEligibility_Reason.valueOf, enumValues: TransferEligibility_Reason.values)
    ..hasRequiredFields = false
  ;
  ...
  'Use [GeneratedMessageGenericExtensions.rebuild] instead. '
  'Will be removed in next major version')
  TransferEligibility copyWith(void Function(TransferEligibility) updates) => super.copyWith((message) => updates(message as TransferEligibility)) as TransferEligibility; // ignore: deprecated_member_use
  $pb.BuilderInfo get info_ => _i;
  @$core.pragma('dart2js:noInline')

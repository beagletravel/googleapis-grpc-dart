...
class ChannelPartnerLink extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'ChannelPartnerLink', package: const $pb.PackageName(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'google.cloud.channel.v1'), createEmptyInstance: create)
    ..aOS(1, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'name')
    ..aOS(2, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'resellerCloudIdentityId')
    ..e<ChannelPartnerLinkState>(3, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'linkState', $pb.PbFieldType.OE, defaultOrMaker: ChannelPartnerLinkState.CHANNEL_PARTNER_LINK_STATE_UNSPECIFIED, valueOf: ChannelPartnerLinkState.valueOf, enumValues: ChannelPartnerLinkState.values)
    ..aOS(4, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'inviteLinkUri')
    ...
    ..aOS(7, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'publicId')
    ..aOM<$1.CloudIdentityInfo>(8, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'channelPartnerCloudIdentityInfo', subBuilder: $1.CloudIdentityInfo.create)
  ...
  'Will be removed in next major version')
  ChannelPartnerLink copyWith(void Function(ChannelPartnerLink) updates) => super.copyWith((message) => updates(message as ChannelPartnerLink)) as ChannelPartnerLink; // ignore: deprecated_member_use
  ...
  @$pb.TagNumber(8)
  set channelPartnerCloudIdentityInfo($1.CloudIdentityInfo v) { setField(8, v); }
  @$pb.TagNumber(8)

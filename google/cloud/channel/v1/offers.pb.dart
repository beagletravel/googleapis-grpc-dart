...
class Offer extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'Offer', package: const $pb.PackageName(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'google.cloud.channel.v1'), createEmptyInstance: create)
    ..aOS(1, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'name')
    ..aOM<$0.MarketingInfo>(2, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'marketingInfo', subBuilder: $0.MarketingInfo.create)
    ..aOM<$0.Sku>(3, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'sku', subBuilder: $0.Sku.create)
    ..aOM<Plan>(4, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'plan', subBuilder: Plan.create)
    ..aOM<Constraints>(5, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'constraints', subBuilder: Constraints.create)
    ..pc<PriceByResource>(6, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'priceByResources', $pb.PbFieldType.PM, subBuilder: PriceByResource.create)
    ...
    ..pc<ParameterDefinition>(9, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'parameterDefinitions', $pb.PbFieldType.PM, subBuilder: ParameterDefinition.create)
  ...
  'Will be removed in next major version')
  Offer copyWith(void Function(Offer) updates) => super.copyWith((message) => updates(message as Offer)) as Offer; // ignore: deprecated_member_use
  ...
  @$pb.TagNumber(2)
  set marketingInfo($0.MarketingInfo v) { setField(2, v); }
  @$pb.TagNumber(2)
...
class ParameterDefinition extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'ParameterDefinition', package: const $pb.PackageName(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'google.cloud.channel.v1'), createEmptyInstance: create)
    ..aOS(1, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'name')
    ..e<ParameterDefinition_ParameterType>(2, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'parameterType', $pb.PbFieldType.OE, defaultOrMaker: ParameterDefinition_ParameterType.PARAMETER_TYPE_UNSPECIFIED, valueOf: ParameterDefinition_ParameterType.valueOf, enumValues: ParameterDefinition_ParameterType.values)
    ..aOM<$2.Value>(3, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'minValue', subBuilder: $2.Value.create)
    ..aOM<$2.Value>(4, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'maxValue', subBuilder: $2.Value.create)
    ..pc<$2.Value>(5, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'allowedValues', $pb.PbFieldType.PM, subBuilder: $2.Value.create)
    ..aOB(6, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'optional')
    ..hasRequiredFields = false
  ;
  ...
  'Use [GeneratedMessageGenericExtensions.rebuild] instead. '
  'Will be removed in next major version')
  ParameterDefinition copyWith(void Function(ParameterDefinition) updates) => super.copyWith((message) => updates(message as ParameterDefinition)) as ParameterDefinition; // ignore: deprecated_member_use
  $pb.BuilderInfo get info_ => _i;
  @$core.pragma('dart2js:noInline')
  ...
  @$pb.TagNumber(3)
  set minValue($2.Value v) { setField(3, v); }
  @$pb.TagNumber(3)
  ...
  @$pb.TagNumber(4)
  set maxValue($2.Value v) { setField(4, v); }
  @$pb.TagNumber(4)
...
class Constraints extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'Constraints', package: const $pb.PackageName(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'google.cloud.channel.v1'), createEmptyInstance: create)
    ..aOM<CustomerConstraints>(1, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'customerConstraints', subBuilder: CustomerConstraints.create)
    ..hasRequiredFields = false
  ;
...
class CustomerConstraints extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'CustomerConstraints', package: const $pb.PackageName(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'google.cloud.channel.v1'), createEmptyInstance: create)
    ..pPS(1, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'allowedRegions')
    ..pc<$2.CloudIdentityInfo_CustomerType>(2, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'allowedCustomerTypes', $pb.PbFieldType.PE, valueOf: $2.CloudIdentityInfo_CustomerType.valueOf, enumValues: $2.CloudIdentityInfo_CustomerType.values)
    ..pc<PromotionalOrderType>(3, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'promotionalOrderTypes', $pb.PbFieldType.PE, valueOf: PromotionalOrderType.valueOf, enumValues: PromotionalOrderType.values)
    ..hasRequiredFields = false
  ;
  ...
  'Use [GeneratedMessageGenericExtensions.rebuild] instead. '
  'Will be removed in next major version')
  CustomerConstraints copyWith(void Function(CustomerConstraints) updates) => super.copyWith((message) => updates(message as CustomerConstraints)) as CustomerConstraints; // ignore: deprecated_member_use
  $pb.BuilderInfo get info_ => _i;
  @$core.pragma('dart2js:noInline')
  ...
  @$pb.TagNumber(2)
  $core.List<$2.CloudIdentityInfo_CustomerType> get allowedCustomerTypes => $_getList(1);
...
class Plan extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'Plan', package: const $pb.PackageName(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'google.cloud.channel.v1'), createEmptyInstance: create)
    ..e<PaymentPlan>(1, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'paymentPlan', $pb.PbFieldType.OE, defaultOrMaker: PaymentPlan.PAYMENT_PLAN_UNSPECIFIED, valueOf: PaymentPlan.valueOf, enumValues: PaymentPlan.values)
    ..e<PaymentType>(2, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'paymentType', $pb.PbFieldType.OE, defaultOrMaker: PaymentType.PAYMENT_TYPE_UNSPECIFIED, valueOf: PaymentType.valueOf, enumValues: PaymentType.values)
    ..aOM<Period>(3, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'paymentCycle', subBuilder: Period.create)
    ..aOM<Period>(4, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'trialPeriod', subBuilder: Period.create)
    ..aOS(5, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'billingAccount')
    ..hasRequiredFields = false
  ;
...
class PriceByResource extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'PriceByResource', package: const $pb.PackageName(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'google.cloud.channel.v1'), createEmptyInstance: create)
    ..e<ResourceType>(1, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'resourceType', $pb.PbFieldType.OE, defaultOrMaker: ResourceType.RESOURCE_TYPE_UNSPECIFIED, valueOf: ResourceType.valueOf, enumValues: ResourceType.values)
    ..aOM<Price>(2, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'price', subBuilder: Price.create)
    ..pc<PricePhase>(3, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'pricePhases', $pb.PbFieldType.PM, subBuilder: PricePhase.create)
    ..hasRequiredFields = false
  ;
  ...
  'Use [GeneratedMessageGenericExtensions.rebuild] instead. '
  'Will be removed in next major version')
  PriceByResource copyWith(void Function(PriceByResource) updates) => super.copyWith((message) => updates(message as PriceByResource)) as PriceByResource; // ignore: deprecated_member_use
  $pb.BuilderInfo get info_ => _i;
  @$core.pragma('dart2js:noInline')
...
class Price extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'Price', package: const $pb.PackageName(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'google.cloud.channel.v1'), createEmptyInstance: create)
    ..aOM<$3.Money>(1, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'basePrice', subBuilder: $3.Money.create)
    ..a<$core.double>(2, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'discount', $pb.PbFieldType.OD)
    ..aOM<$3.Money>(3, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'effectivePrice', subBuilder: $3.Money.create)
    ..aOS(4, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'externalPriceUri')
    ..hasRequiredFields = false
  ;
  ...
  @$pb.TagNumber(1)
  set basePrice($3.Money v) { setField(1, v); }
  @$pb.TagNumber(1)
  ...
  @$pb.TagNumber(3)
  set effectivePrice($3.Money v) { setField(3, v); }
  @$pb.TagNumber(3)
...
class PricePhase extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'PricePhase', package: const $pb.PackageName(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'google.cloud.channel.v1'), createEmptyInstance: create)
    ..e<PeriodType>(1, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'periodType', $pb.PbFieldType.OE, defaultOrMaker: PeriodType.PERIOD_TYPE_UNSPECIFIED, valueOf: PeriodType.valueOf, enumValues: PeriodType.values)
    ..a<$core.int>(2, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'firstPeriod', $pb.PbFieldType.O3)
    ..a<$core.int>(3, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'lastPeriod', $pb.PbFieldType.O3)
    ..aOM<Price>(4, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'price', subBuilder: Price.create)
    ..pc<PriceTier>(5, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'priceTiers', $pb.PbFieldType.PM, subBuilder: PriceTier.create)
    ..hasRequiredFields = false
  ;
  ...
  'Use [GeneratedMessageGenericExtensions.rebuild] instead. '
  'Will be removed in next major version')
  PricePhase copyWith(void Function(PricePhase) updates) => super.copyWith((message) => updates(message as PricePhase)) as PricePhase; // ignore: deprecated_member_use
  $pb.BuilderInfo get info_ => _i;
  @$core.pragma('dart2js:noInline')
...
class PriceTier extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'PriceTier', package: const $pb.PackageName(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'google.cloud.channel.v1'), createEmptyInstance: create)
    ..a<$core.int>(1, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'firstResource', $pb.PbFieldType.O3)
    ..a<$core.int>(2, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'lastResource', $pb.PbFieldType.O3)
    ..aOM<Price>(3, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'price', subBuilder: Price.create)
    ..hasRequiredFields = false
  ;
  ...
  'Use [GeneratedMessageGenericExtensions.rebuild] instead. '
  'Will be removed in next major version')
  PriceTier copyWith(void Function(PriceTier) updates) => super.copyWith((message) => updates(message as PriceTier)) as PriceTier; // ignore: deprecated_member_use
  $pb.BuilderInfo get info_ => _i;
  @$core.pragma('dart2js:noInline')
...
class Period extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'Period', package: const $pb.PackageName(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'google.cloud.channel.v1'), createEmptyInstance: create)
    ..a<$core.int>(1, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'duration', $pb.PbFieldType.O3)
    ..e<PeriodType>(2, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'periodType', $pb.PbFieldType.OE, defaultOrMaker: PeriodType.PERIOD_TYPE_UNSPECIFIED, valueOf: PeriodType.valueOf, enumValues: PeriodType.values)
    ..hasRequiredFields = false
  ;

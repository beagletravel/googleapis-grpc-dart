...
class EduData extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'EduData', package: const $pb.PackageName(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'google.cloud.channel.v1'), createEmptyInstance: create)
    ..e<EduData_InstituteType>(1, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'instituteType', $pb.PbFieldType.OE, defaultOrMaker: EduData_InstituteType.INSTITUTE_TYPE_UNSPECIFIED, valueOf: EduData_InstituteType.valueOf, enumValues: EduData_InstituteType.values)
    ..e<EduData_InstituteSize>(2, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'instituteSize', $pb.PbFieldType.OE, defaultOrMaker: EduData_InstituteSize.INSTITUTE_SIZE_UNSPECIFIED, valueOf: EduData_InstituteSize.valueOf, enumValues: EduData_InstituteSize.values)
  ...
  'Will be removed in next major version')
  EduData copyWith(void Function(EduData) updates) => super.copyWith((message) => updates(message as EduData)) as EduData; // ignore: deprecated_member_use
...
class CloudIdentityInfo extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'CloudIdentityInfo', package: const $pb.PackageName(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'google.cloud.channel.v1'), createEmptyInstance: create)
    ..e<CloudIdentityInfo_CustomerType>(1, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'customerType', $pb.PbFieldType.OE, defaultOrMaker: CloudIdentityInfo_CustomerType.CUSTOMER_TYPE_UNSPECIFIED, valueOf: CloudIdentityInfo_CustomerType.valueOf, enumValues: CloudIdentityInfo_CustomerType.values)
    ..aOB(4, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'isDomainVerified')
    ..aOS(6, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'alternateEmail')
    ...
    ..aOS(9, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'primaryDomain')
    ..aOS(10, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'adminConsoleUri')
    ..aOM<EduData>(22, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'eduData', subBuilder: EduData.create)
    ..hasRequiredFields = false
  ;
  ...
  'Use [GeneratedMessageGenericExtensions.rebuild] instead. '
  'Will be removed in next major version')
  CloudIdentityInfo copyWith(void Function(CloudIdentityInfo) updates) => super.copyWith((message) => updates(message as CloudIdentityInfo)) as CloudIdentityInfo; // ignore: deprecated_member_use
  $pb.BuilderInfo get info_ => _i;
  @$core.pragma('dart2js:noInline')
...
class Value extends $pb.GeneratedMessage {
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'Value', package: const $pb.PackageName(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'google.cloud.channel.v1'), createEmptyInstance: create)
    ..oo(0, [1, 2, 3, 4, 5])
    ...
    ..aOM<$0.Any>(4, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'protoValue', subBuilder: $0.Any.create)
  ...
  @$pb.TagNumber(4)
  set protoValue($0.Any v) { setField(4, v); }
  @$pb.TagNumber(4)
...
class AdminUser extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'AdminUser', package: const $pb.PackageName(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'google.cloud.channel.v1'), createEmptyInstance: create)

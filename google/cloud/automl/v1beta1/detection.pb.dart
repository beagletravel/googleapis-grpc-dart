...
class ImageObjectDetectionAnnotation extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'ImageObjectDetectionAnnotation', package: const $pb.PackageName(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'google.cloud.automl.v1beta1'), createEmptyInstance: create)
    ..aOM<$0.BoundingPoly>(1, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'boundingBox', subBuilder: $0.BoundingPoly.create)
  ...
  'Will be removed in next major version')
  ImageObjectDetectionAnnotation copyWith(void Function(ImageObjectDetectionAnnotation) updates) => super.copyWith((message) => updates(message as ImageObjectDetectionAnnotation)) as ImageObjectDetectionAnnotation; // ignore: deprecated_member_use
...
class VideoObjectTrackingAnnotation extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'VideoObjectTrackingAnnotation', package: const $pb.PackageName(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'google.cloud.automl.v1beta1'), createEmptyInstance: create)
    ..aOS(1, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'instanceId')
    ..aOM<$1.Duration>(2, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'timeOffset', subBuilder: $1.Duration.create)
    ..aOM<$0.BoundingPoly>(3, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'boundingBox', subBuilder: $0.BoundingPoly.create)
  ...
  @$pb.TagNumber(2)
  set timeOffset($1.Duration v) { setField(2, v); }
  @$pb.TagNumber(2)
  ...
  @$pb.TagNumber(3)
  set boundingBox($0.BoundingPoly v) { setField(3, v); }
  @$pb.TagNumber(3)
...
class BoundingBoxMetricsEntry_ConfidenceMetricsEntry extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'BoundingBoxMetricsEntry.ConfidenceMetricsEntry', package: const $pb.PackageName(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'google.cloud.automl.v1beta1'), createEmptyInstance: create)
  ...
  'Use [GeneratedMessageGenericExtensions.rebuild] instead. '
  'Will be removed in next major version')
  BoundingBoxMetricsEntry_ConfidenceMetricsEntry copyWith(void Function(BoundingBoxMetricsEntry_ConfidenceMetricsEntry) updates) => super.copyWith((message) => updates(message as BoundingBoxMetricsEntry_ConfidenceMetricsEntry)) as BoundingBoxMetricsEntry_ConfidenceMetricsEntry; // ignore: deprecated_member_use
  $pb.BuilderInfo get info_ => _i;
  @$core.pragma('dart2js:noInline')
...
class BoundingBoxMetricsEntry extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'BoundingBoxMetricsEntry', package: const $pb.PackageName(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'google.cloud.automl.v1beta1'), createEmptyInstance: create)
    ..a<$core.double>(1, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'iouThreshold', $pb.PbFieldType.OF)
    ..a<$core.double>(2, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'meanAveragePrecision', $pb.PbFieldType.OF)
    ..pc<BoundingBoxMetricsEntry_ConfidenceMetricsEntry>(3, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'confidenceMetricsEntries', $pb.PbFieldType.PM, subBuilder: BoundingBoxMetricsEntry_ConfidenceMetricsEntry.create)
    ..hasRequiredFields = false
  ;
  ...
  'Use [GeneratedMessageGenericExtensions.rebuild] instead. '
  'Will be removed in next major version')
  BoundingBoxMetricsEntry copyWith(void Function(BoundingBoxMetricsEntry) updates) => super.copyWith((message) => updates(message as BoundingBoxMetricsEntry)) as BoundingBoxMetricsEntry; // ignore: deprecated_member_use
  $pb.BuilderInfo get info_ => _i;
  @$core.pragma('dart2js:noInline')
...
class ImageObjectDetectionEvaluationMetrics extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'ImageObjectDetectionEvaluationMetrics', package: const $pb.PackageName(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'google.cloud.automl.v1beta1'), createEmptyInstance: create)
    ..a<$core.int>(1, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'evaluatedBoundingBoxCount', $pb.PbFieldType.O3)
    ..pc<BoundingBoxMetricsEntry>(2, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'boundingBoxMetricsEntries', $pb.PbFieldType.PM, subBuilder: BoundingBoxMetricsEntry.create)
    ..a<$core.double>(3, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'boundingBoxMeanAveragePrecision', $pb.PbFieldType.OF)
    ..hasRequiredFields = false
  ;
  ...
  'Use [GeneratedMessageGenericExtensions.rebuild] instead. '
  'Will be removed in next major version')
  ImageObjectDetectionEvaluationMetrics copyWith(void Function(ImageObjectDetectionEvaluationMetrics) updates) => super.copyWith((message) => updates(message as ImageObjectDetectionEvaluationMetrics)) as ImageObjectDetectionEvaluationMetrics; // ignore: deprecated_member_use
  $pb.BuilderInfo get info_ => _i;
  @$core.pragma('dart2js:noInline')
...
class VideoObjectTrackingEvaluationMetrics extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'VideoObjectTrackingEvaluationMetrics', package: const $pb.PackageName(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'google.cloud.automl.v1beta1'), createEmptyInstance: create)
    ..a<$core.int>(1, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'evaluatedFrameCount', $pb.PbFieldType.O3)
    ..a<$core.int>(2, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'evaluatedBoundingBoxCount', $pb.PbFieldType.O3)
    ..pc<BoundingBoxMetricsEntry>(4, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'boundingBoxMetricsEntries', $pb.PbFieldType.PM, subBuilder: BoundingBoxMetricsEntry.create)
    ..a<$core.double>(6, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'boundingBoxMeanAveragePrecision', $pb.PbFieldType.OF)
    ..hasRequiredFields = false
  ;

  VideoObjectTrackingEvaluationMetrics._() : super();
  factory VideoObjectTrackingEvaluationMetrics({
    $core.int? evaluatedFrameCount,
    $core.int? evaluatedBoundingBoxCount,
    $core.Iterable<BoundingBoxMetricsEntry>? boundingBoxMetricsEntries,
    $core.double? boundingBoxMeanAveragePrecision,
  }) {
    final _result = create();
    if (evaluatedFrameCount != null) {
      _result.evaluatedFrameCount = evaluatedFrameCount;
    }
    if (evaluatedBoundingBoxCount != null) {
      _result.evaluatedBoundingBoxCount = evaluatedBoundingBoxCount;
    }
  ...
  factory VideoObjectTrackingEvaluationMetrics.fromBuffer($core.List<$core.int> i, [$pb.ExtensionRegistry r = $pb.ExtensionRegistry.EMPTY]) => create()..mergeFromBuffer(i, r);
  factory VideoObjectTrackingEvaluationMetrics.fromJson($core.String i, [$pb.ExtensionRegistry r = $pb.ExtensionRegistry.EMPTY]) => create()..mergeFromJson(i, r);
  @$core.Deprecated(
  'Using this can add significant overhead to your binary. '
  'Use [GeneratedMessageGenericExtensions.deepCopy] instead. '
  'Will be removed in next major version')
  VideoObjectTrackingEvaluationMetrics clone() => VideoObjectTrackingEvaluationMetrics()..mergeFromMessage(this);
  @$core.Deprecated(
  'Using this can add significant overhead to your binary. '
  'Use [GeneratedMessageGenericExtensions.rebuild] instead. '
  'Will be removed in next major version')
  VideoObjectTrackingEvaluationMetrics copyWith(void Function(VideoObjectTrackingEvaluationMetrics) updates) => super.copyWith((message) => updates(message as VideoObjectTrackingEvaluationMetrics)) as VideoObjectTrackingEvaluationMetrics; // ignore: deprecated_member_use
  $pb.BuilderInfo get info_ => _i;
  @$core.pragma('dart2js:noInline')
  static VideoObjectTrackingEvaluationMetrics create() => VideoObjectTrackingEvaluationMetrics._();
  VideoObjectTrackingEvaluationMetrics createEmptyInstance() => create();
  static $pb.PbList<VideoObjectTrackingEvaluationMetrics> createRepeated() => $pb.PbList<VideoObjectTrackingEvaluationMetrics>();
  @$core.pragma('dart2js:noInline')
  static VideoObjectTrackingEvaluationMetrics getDefault() => _defaultInstance ??= $pb.GeneratedMessage.$_defaultFor<VideoObjectTrackingEvaluationMetrics>(create);
  static VideoObjectTrackingEvaluationMetrics? _defaultInstance;

  @$pb.TagNumber(1)
  $core.int get evaluatedFrameCount => $_getIZ(0);
  @$pb.TagNumber(1)
  set evaluatedFrameCount($core.int v) { $_setSignedInt32(0, v); }
  @$pb.TagNumber(1)
  ...
  @$pb.TagNumber(2)
  set evaluatedBoundingBoxCount($core.int v) { $_setSignedInt32(1, v); }
  @$pb.TagNumber(2)
  ...
  @$pb.TagNumber(4)
  $core.List<BoundingBoxMetricsEntry> get boundingBoxMetricsEntries => $_getList(2);

  @$pb.TagNumber(6)
  $core.double get boundingBoxMeanAveragePrecision => $_getN(3);
  @$pb.TagNumber(6)
  set boundingBoxMeanAveragePrecision($core.double v) { $_setFloat(3, v); }
  @$pb.TagNumber(6)

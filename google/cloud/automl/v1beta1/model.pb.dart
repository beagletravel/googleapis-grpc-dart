...
class Model extends $pb.GeneratedMessage {
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'Model', package: const $pb.PackageName(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'google.cloud.automl.v1beta1'), createEmptyInstance: create)
    ..oo(0, [13, 14, 15, 19, 20, 21, 22, 23, 24])
    ..aOS(1, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'name')
    ..aOS(2, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'displayName')
    ..aOS(3, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'datasetId')
    ..aOM<$0.Timestamp>(7, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'createTime', subBuilder: $0.Timestamp.create)
    ..e<Model_DeploymentState>(8, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'deploymentState', $pb.PbFieldType.OE, defaultOrMaker: Model_DeploymentState.DEPLOYMENT_STATE_UNSPECIFIED, valueOf: Model_DeploymentState.valueOf, enumValues: Model_DeploymentState.values)
    ..aOM<$0.Timestamp>(11, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'updateTime', subBuilder: $0.Timestamp.create)
    ..aOM<$1.ImageClassificationModelMetadata>(13, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'imageClassificationModelMetadata', subBuilder: $1.ImageClassificationModelMetadata.create)
    ..aOM<$2.TextClassificationModelMetadata>(14, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'textClassificationModelMetadata', subBuilder: $2.TextClassificationModelMetadata.create)
    ..aOM<$3.TranslationModelMetadata>(15, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'translationModelMetadata', subBuilder: $3.TranslationModelMetadata.create)
    ..aOM<$2.TextExtractionModelMetadata>(19, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'textExtractionModelMetadata', subBuilder: $2.TextExtractionModelMetadata.create)
    ..aOM<$1.ImageObjectDetectionModelMetadata>(20, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'imageObjectDetectionModelMetadata', subBuilder: $1.ImageObjectDetectionModelMetadata.create)
    ..aOM<$4.VideoObjectTrackingModelMetadata>(21, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'videoObjectTrackingModelMetadata', subBuilder: $4.VideoObjectTrackingModelMetadata.create)
    ..aOM<$2.TextSentimentModelMetadata>(22, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'textSentimentModelMetadata', subBuilder: $2.TextSentimentModelMetadata.create)
    ..aOM<$4.VideoClassificationModelMetadata>(23, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'videoClassificationModelMetadata', subBuilder: $4.VideoClassificationModelMetadata.create)
    ..aOM<$5.TablesModelMetadata>(24, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'tablesModelMetadata', subBuilder: $5.TablesModelMetadata.create)
  ...
  factory Model({
    ...
    if (imageClassificationModelMetadata != null) {
      _result.imageClassificationModelMetadata = imageClassificationModelMetadata;
    }
    ...
    if (imageObjectDetectionModelMetadata != null) {
      _result.imageObjectDetectionModelMetadata = imageObjectDetectionModelMetadata;
    }
    if (videoObjectTrackingModelMetadata != null) {
      _result.videoObjectTrackingModelMetadata = videoObjectTrackingModelMetadata;
    }
    ...
    if (videoClassificationModelMetadata != null) {
      _result.videoClassificationModelMetadata = videoClassificationModelMetadata;
    }
  ...
  @$pb.TagNumber(13)
  $1.ImageClassificationModelMetadata get imageClassificationModelMetadata => $_getN(6);
  @$pb.TagNumber(13)
  set imageClassificationModelMetadata($1.ImageClassificationModelMetadata v) { setField(13, v); }
  @$pb.TagNumber(13)
  $core.bool hasImageClassificationModelMetadata() => $_has(6);
  @$pb.TagNumber(13)
  void clearImageClassificationModelMetadata() => clearField(13);
  @$pb.TagNumber(13)
  $1.ImageClassificationModelMetadata ensureImageClassificationModelMetadata() => $_ensure(6);

  @$pb.TagNumber(14)
  $2.TextClassificationModelMetadata get textClassificationModelMetadata => $_getN(7);
  @$pb.TagNumber(14)
  set textClassificationModelMetadata($2.TextClassificationModelMetadata v) { setField(14, v); }
  @$pb.TagNumber(14)
  $core.bool hasTextClassificationModelMetadata() => $_has(7);
  @$pb.TagNumber(14)
  void clearTextClassificationModelMetadata() => clearField(14);
  @$pb.TagNumber(14)
  $2.TextClassificationModelMetadata ensureTextClassificationModelMetadata() => $_ensure(7);

  @$pb.TagNumber(15)
  $3.TranslationModelMetadata get translationModelMetadata => $_getN(8);
  @$pb.TagNumber(15)
  set translationModelMetadata($3.TranslationModelMetadata v) { setField(15, v); }
  @$pb.TagNumber(15)
  ...
  @$pb.TagNumber(19)
  set textExtractionModelMetadata($2.TextExtractionModelMetadata v) { setField(19, v); }
  @$pb.TagNumber(19)
  $core.bool hasTextExtractionModelMetadata() => $_has(9);
  @$pb.TagNumber(19)
  void clearTextExtractionModelMetadata() => clearField(19);
  @$pb.TagNumber(19)
  $2.TextExtractionModelMetadata ensureTextExtractionModelMetadata() => $_ensure(9);

  @$pb.TagNumber(20)
  $1.ImageObjectDetectionModelMetadata get imageObjectDetectionModelMetadata => $_getN(10);
  @$pb.TagNumber(20)
  set imageObjectDetectionModelMetadata($1.ImageObjectDetectionModelMetadata v) { setField(20, v); }
  @$pb.TagNumber(20)
  $core.bool hasImageObjectDetectionModelMetadata() => $_has(10);
  @$pb.TagNumber(20)
  void clearImageObjectDetectionModelMetadata() => clearField(20);
  @$pb.TagNumber(20)
  $1.ImageObjectDetectionModelMetadata ensureImageObjectDetectionModelMetadata() => $_ensure(10);

  @$pb.TagNumber(21)
  $4.VideoObjectTrackingModelMetadata get videoObjectTrackingModelMetadata => $_getN(11);
  @$pb.TagNumber(21)
  set videoObjectTrackingModelMetadata($4.VideoObjectTrackingModelMetadata v) { setField(21, v); }
  @$pb.TagNumber(21)
  $core.bool hasVideoObjectTrackingModelMetadata() => $_has(11);
  @$pb.TagNumber(21)
  void clearVideoObjectTrackingModelMetadata() => clearField(21);
  @$pb.TagNumber(21)
  $4.VideoObjectTrackingModelMetadata ensureVideoObjectTrackingModelMetadata() => $_ensure(11);

  @$pb.TagNumber(22)
  $2.TextSentimentModelMetadata get textSentimentModelMetadata => $_getN(12);
  @$pb.TagNumber(22)
  set textSentimentModelMetadata($2.TextSentimentModelMetadata v) { setField(22, v); }
  @$pb.TagNumber(22)
  $core.bool hasTextSentimentModelMetadata() => $_has(12);
  @$pb.TagNumber(22)
  void clearTextSentimentModelMetadata() => clearField(22);
  @$pb.TagNumber(22)
  $2.TextSentimentModelMetadata ensureTextSentimentModelMetadata() => $_ensure(12);

  @$pb.TagNumber(23)
  $4.VideoClassificationModelMetadata get videoClassificationModelMetadata => $_getN(13);
  @$pb.TagNumber(23)
  set videoClassificationModelMetadata($4.VideoClassificationModelMetadata v) { setField(23, v); }
  @$pb.TagNumber(23)
  $core.bool hasVideoClassificationModelMetadata() => $_has(13);
  @$pb.TagNumber(23)
  void clearVideoClassificationModelMetadata() => clearField(23);
  @$pb.TagNumber(23)
  $4.VideoClassificationModelMetadata ensureVideoClassificationModelMetadata() => $_ensure(13);

  @$pb.TagNumber(24)
  $5.TablesModelMetadata get tablesModelMetadata => $_getN(14);
  @$pb.TagNumber(24)
  set tablesModelMetadata($5.TablesModelMetadata v) { setField(24, v); }
  @$pb.TagNumber(24)

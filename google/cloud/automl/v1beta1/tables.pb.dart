...
class TablesDatasetMetadata extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'TablesDatasetMetadata', package: const $pb.PackageName(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'google.cloud.automl.v1beta1'), createEmptyInstance: create)
    ..aOS(1, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'primaryTableSpecId')
    ..aOS(2, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'targetColumnSpecId')
    ..aOS(3, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'weightColumnSpecId')
    ..aOS(4, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'mlUseColumnSpecId')
    ..m<$core.String, $1.CorrelationStats>(6, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'targetColumnCorrelations', entryClassName: 'TablesDatasetMetadata.TargetColumnCorrelationsEntry', keyFieldType: $pb.PbFieldType.OS, valueFieldType: $pb.PbFieldType.OM, valueCreator: $1.CorrelationStats.create, packageName: const $pb.PackageName('google.cloud.automl.v1beta1'))
    ..aOM<$0.Timestamp>(7, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'statsUpdateTime', subBuilder: $0.Timestamp.create)
  ...
  @$pb.TagNumber(6)
  $core.Map<$core.String, $1.CorrelationStats> get targetColumnCorrelations => $_getMap(4);

  @$pb.TagNumber(7)
  $0.Timestamp get statsUpdateTime => $_getN(5);
  @$pb.TagNumber(7)
  set statsUpdateTime($0.Timestamp v) { setField(7, v); }
  @$pb.TagNumber(7)
...
class TablesModelMetadata extends $pb.GeneratedMessage {
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'TablesModelMetadata', package: const $pb.PackageName(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'google.cloud.automl.v1beta1'), createEmptyInstance: create)
    ..oo(0, [17, 18])
    ..aOM<$2.ColumnSpec>(2, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'targetColumnSpec', subBuilder: $2.ColumnSpec.create)
    ..pc<$2.ColumnSpec>(3, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'inputFeatureColumnSpecs', $pb.PbFieldType.PM, subBuilder: $2.ColumnSpec.create)
    ..aOS(4, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'optimizationObjective')
    ..pc<TablesModelColumnInfo>(5, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'tablesModelColumnInfo', $pb.PbFieldType.PM, subBuilder: TablesModelColumnInfo.create)
    ..aInt64(6, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'trainBudgetMilliNodeHours')
    ..aInt64(7, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'trainCostMilliNodeHours')
    ..aOB(12, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'disableEarlyStopping')
    ..a<$core.double>(17, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'optimizationObjectiveRecallValue', $pb.PbFieldType.OF)
    ..a<$core.double>(18, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'optimizationObjectivePrecisionValue', $pb.PbFieldType.OF)
    ..hasRequiredFields = false
  ;
  ...
  'Use [GeneratedMessageGenericExtensions.rebuild] instead. '
  'Will be removed in next major version')
  TablesModelMetadata copyWith(void Function(TablesModelMetadata) updates) => super.copyWith((message) => updates(message as TablesModelMetadata)) as TablesModelMetadata; // ignore: deprecated_member_use
  $pb.BuilderInfo get info_ => _i;
  @$core.pragma('dart2js:noInline')
  ...
  @$pb.TagNumber(2)
  set targetColumnSpec($2.ColumnSpec v) { setField(2, v); }
  @$pb.TagNumber(2)
...
class TablesAnnotation extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'TablesAnnotation', package: const $pb.PackageName(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'google.cloud.automl.v1beta1'), createEmptyInstance: create)
    ..a<$core.double>(1, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'score', $pb.PbFieldType.OF)
    ..aOM<$3.Value>(2, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'value', subBuilder: $3.Value.create)
    ..pc<TablesModelColumnInfo>(3, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'tablesModelColumnInfo', $pb.PbFieldType.PM, subBuilder: TablesModelColumnInfo.create)
    ..aOM<$4.DoubleRange>(4, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'predictionInterval', subBuilder: $4.DoubleRange.create)
    ..a<$core.double>(5, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'baselineScore', $pb.PbFieldType.OF)
    ..hasRequiredFields = false
  ;
  ...
  'Use [GeneratedMessageGenericExtensions.rebuild] instead. '
  'Will be removed in next major version')
  TablesAnnotation copyWith(void Function(TablesAnnotation) updates) => super.copyWith((message) => updates(message as TablesAnnotation)) as TablesAnnotation; // ignore: deprecated_member_use
  $pb.BuilderInfo get info_ => _i;
  @$core.pragma('dart2js:noInline')
  ...
  @$pb.TagNumber(2)
  set value($3.Value v) { setField(2, v); }
  @$pb.TagNumber(2)
  ...
  @$pb.TagNumber(4)
  set predictionInterval($4.DoubleRange v) { setField(4, v); }
  @$pb.TagNumber(4)
...
class TablesModelColumnInfo extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'TablesModelColumnInfo', package: const $pb.PackageName(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'google.cloud.automl.v1beta1'), createEmptyInstance: create)
    ..aOS(1, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'columnSpecName')
    ..aOS(2, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'columnDisplayName')
    ..a<$core.double>(3, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'featureImportance', $pb.PbFieldType.OF)
    ..hasRequiredFields = false
  ;
  ...
  'Use [GeneratedMessageGenericExtensions.rebuild] instead. '
  'Will be removed in next major version')
  TablesModelColumnInfo copyWith(void Function(TablesModelColumnInfo) updates) => super.copyWith((message) => updates(message as TablesModelColumnInfo)) as TablesModelColumnInfo; // ignore: deprecated_member_use
  $pb.BuilderInfo get info_ => _i;
  @$core.pragma('dart2js:noInline')

...
class DataType extends $pb.GeneratedMessage {
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'DataType', package: const $pb.PackageName(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'google.cloud.automl.v1beta1'), createEmptyInstance: create)
    ..oo(0, [2, 3, 5])
    ..e<TypeCode>(1, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'typeCode', $pb.PbFieldType.OE, defaultOrMaker: TypeCode.TYPE_CODE_UNSPECIFIED, valueOf: TypeCode.valueOf, enumValues: TypeCode.values)
    ..aOM<DataType>(2, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'listElementType', subBuilder: DataType.create)
    ..aOM<StructType>(3, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'structType', subBuilder: StructType.create)
    ..aOB(4, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'nullable')
    ..aOS(5, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'timeFormat')
  ...
  'Will be removed in next major version')
  DataType copyWith(void Function(DataType) updates) => super.copyWith((message) => updates(message as DataType)) as DataType; // ignore: deprecated_member_use
...
class StructType extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'StructType', package: const $pb.PackageName(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'google.cloud.automl.v1beta1'), createEmptyInstance: create)
    ..m<$core.String, DataType>(1, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'fields', entryClassName: 'StructType.FieldsEntry', keyFieldType: $pb.PbFieldType.OS, valueFieldType: $pb.PbFieldType.OM, valueCreator: DataType.create, packageName: const $pb.PackageName('google.cloud.automl.v1beta1'))
    ..hasRequiredFields = false
  ;

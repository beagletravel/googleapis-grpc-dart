...
class ColumnSpec_CorrelatedColumn extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'ColumnSpec.CorrelatedColumn', package: const $pb.PackageName(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'google.cloud.automl.v1beta1'), createEmptyInstance: create)
    ..aOS(1, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'columnSpecId')
    ..aOM<$1.CorrelationStats>(2, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'correlationStats', subBuilder: $1.CorrelationStats.create)
  ...
  'Will be removed in next major version')
  ColumnSpec_CorrelatedColumn copyWith(void Function(ColumnSpec_CorrelatedColumn) updates) => super.copyWith((message) => updates(message as ColumnSpec_CorrelatedColumn)) as ColumnSpec_CorrelatedColumn; // ignore: deprecated_member_use
...
class ColumnSpec extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'ColumnSpec', package: const $pb.PackageName(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'google.cloud.automl.v1beta1'), createEmptyInstance: create)
    ..aOS(1, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'name')
    ..aOM<$0.DataType>(2, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'dataType', subBuilder: $0.DataType.create)
    ..aOS(3, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'displayName')
    ..aOM<$1.DataStats>(4, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'dataStats', subBuilder: $1.DataStats.create)
    ..pc<ColumnSpec_CorrelatedColumn>(5, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'topCorrelatedColumns', $pb.PbFieldType.PM, subBuilder: ColumnSpec_CorrelatedColumn.create)
  ...
  'Use [GeneratedMessageGenericExtensions.rebuild] instead. '
  'Will be removed in next major version')
  ColumnSpec copyWith(void Function(ColumnSpec) updates) => super.copyWith((message) => updates(message as ColumnSpec)) as ColumnSpec; // ignore: deprecated_member_use
  $pb.BuilderInfo get info_ => _i;
  @$core.pragma('dart2js:noInline')

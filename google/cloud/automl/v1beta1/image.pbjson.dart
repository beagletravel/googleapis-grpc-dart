...
const ImageClassificationDatasetMetadata$json = const {
  ...
  '2': const [
    const {'1': 'classification_type', '3': 1, '4': 1, '5': 14, '6': '.google.cloud.automl.v1beta1.ClassificationType', '10': 'classificationType'},
  ],
};

/// Descriptor for `ImageClassificationDatasetMetadata`. Decode as a `google.protobuf.DescriptorProto`.
final $typed_data.Uint8List imageClassificationDatasetMetadataDescriptor = $convert.base64Decode('CiJJbWFnZUNsYXNzaWZpY2F0aW9uRGF0YXNldE1ldGFkYXRhEmAKE2NsYXNzaWZpY2F0aW9uX3R5cGUYASABKA4yLy5nb29nbGUuY2xvdWQuYXV0b21sLnYxYmV0YTEuQ2xhc3NpZmljYXRpb25UeXBlUhJjbGFzc2lmaWNhdGlvblR5cGU=');
...
final $typed_data.Uint8List imageClassificationModelMetadataDescriptor = $convert.base64Decode('');
...
final $typed_data.Uint8List imageObjectDetectionModelMetadataDescriptor = $convert.base64Decode('');
...
final $typed_data.Uint8List imageClassificationModelDeploymentMetadataDescriptor = $convert.base64Decode('CipJbWFnZUNsYXNzaWZpY2F0aW9uTW9kZWxEZXBsb3ltZW50TWV0YWRhdGESHQoKbm9kZV9jb3VudBgBIAEoA1IJbm9kZUNvdW50');
...
final $typed_data.Uint8List imageObjectDetectionModelDeploymentMetadataDescriptor = $convert.base64Decode('CitJbWFnZU9iamVjdERldGVjdGlvbk1vZGVsRGVwbG95bWVudE1ldGFkYXRhEh0KCm5vZGVfY291bnQYASABKANSCW5vZGVDb3VudA==');

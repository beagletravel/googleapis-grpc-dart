...
class ModelEvaluation extends $pb.GeneratedMessage {
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'ModelEvaluation', package: const $pb.PackageName(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'google.cloud.automl.v1beta1'), createEmptyInstance: create)
    ...
    ..a<$core.int>(6, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'evaluatedExampleCount', $pb.PbFieldType.O3)
    ..aOM<$1.ClassificationEvaluationMetrics>(8, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'classificationEvaluationMetrics', subBuilder: $1.ClassificationEvaluationMetrics.create)
    ..aOM<$2.TranslationEvaluationMetrics>(9, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'translationEvaluationMetrics', subBuilder: $2.TranslationEvaluationMetrics.create)
    ..aOM<$3.TextSentimentEvaluationMetrics>(11, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'textSentimentEvaluationMetrics', subBuilder: $3.TextSentimentEvaluationMetrics.create)
    ..aOM<$4.ImageObjectDetectionEvaluationMetrics>(12, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'imageObjectDetectionEvaluationMetrics', subBuilder: $4.ImageObjectDetectionEvaluationMetrics.create)
    ..aOM<$5.TextExtractionEvaluationMetrics>(13, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'textExtractionEvaluationMetrics', subBuilder: $5.TextExtractionEvaluationMetrics.create)
    ..aOM<$4.VideoObjectTrackingEvaluationMetrics>(14, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'videoObjectTrackingEvaluationMetrics', subBuilder: $4.VideoObjectTrackingEvaluationMetrics.create)
    ..aOS(15, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'displayName')
    ..aOM<$6.RegressionEvaluationMetrics>(24, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'regressionEvaluationMetrics', subBuilder: $6.RegressionEvaluationMetrics.create)
  ...
  factory ModelEvaluation({
    ...
    $4.ImageObjectDetectionEvaluationMetrics? imageObjectDetectionEvaluationMetrics,
    $5.TextExtractionEvaluationMetrics? textExtractionEvaluationMetrics,
    $4.VideoObjectTrackingEvaluationMetrics? videoObjectTrackingEvaluationMetrics,
    ...
    if (imageObjectDetectionEvaluationMetrics != null) {
      _result.imageObjectDetectionEvaluationMetrics = imageObjectDetectionEvaluationMetrics;
    }
    ...
    if (videoObjectTrackingEvaluationMetrics != null) {
      _result.videoObjectTrackingEvaluationMetrics = videoObjectTrackingEvaluationMetrics;
    }
    if (displayName != null) {
  ...
  @$pb.TagNumber(8)
  $1.ClassificationEvaluationMetrics ensureClassificationEvaluationMetrics() => $_ensure(4);
  ...
  @$pb.TagNumber(9)
  $2.TranslationEvaluationMetrics ensureTranslationEvaluationMetrics() => $_ensure(5);
  ...
  @$pb.TagNumber(11)
  $3.TextSentimentEvaluationMetrics ensureTextSentimentEvaluationMetrics() => $_ensure(6);
  ...
  @$pb.TagNumber(12)
  $4.ImageObjectDetectionEvaluationMetrics ensureImageObjectDetectionEvaluationMetrics() => $_ensure(7);
  ...
  @$pb.TagNumber(13)
  $5.TextExtractionEvaluationMetrics ensureTextExtractionEvaluationMetrics() => $_ensure(8);

  @$pb.TagNumber(14)
  $4.VideoObjectTrackingEvaluationMetrics get videoObjectTrackingEvaluationMetrics => $_getN(9);
  @$pb.TagNumber(14)
  set videoObjectTrackingEvaluationMetrics($4.VideoObjectTrackingEvaluationMetrics v) { setField(14, v); }
  @$pb.TagNumber(14)
  $core.bool hasVideoObjectTrackingEvaluationMetrics() => $_has(9);
  @$pb.TagNumber(14)
  void clearVideoObjectTrackingEvaluationMetrics() => clearField(14);
  @$pb.TagNumber(14)
  $4.VideoObjectTrackingEvaluationMetrics ensureVideoObjectTrackingEvaluationMetrics() => $_ensure(9);
  ...
  @$pb.TagNumber(24)
  $6.RegressionEvaluationMetrics ensureRegressionEvaluationMetrics() => $_ensure(11);
}

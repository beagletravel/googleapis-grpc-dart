...
class AnnotationPayload extends $pb.GeneratedMessage {
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'AnnotationPayload', package: const $pb.PackageName(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'google.cloud.automl.v1beta1'), createEmptyInstance: create)
    ..oo(0, [2, 3, 4, 6, 7, 8, 9, 10])
    ..aOS(1, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'annotationSpecId')
    ..aOM<$0.TranslationAnnotation>(2, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'translation', subBuilder: $0.TranslationAnnotation.create)
    ..aOM<$1.ClassificationAnnotation>(3, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'classification', subBuilder: $1.ClassificationAnnotation.create)
    ..aOM<$2.ImageObjectDetectionAnnotation>(4, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'imageObjectDetection', subBuilder: $2.ImageObjectDetectionAnnotation.create)
    ..aOS(5, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'displayName')
    ..aOM<$3.TextExtractionAnnotation>(6, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'textExtraction', subBuilder: $3.TextExtractionAnnotation.create)
    ..aOM<$4.TextSentimentAnnotation>(7, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'textSentiment', subBuilder: $4.TextSentimentAnnotation.create)
    ..aOM<$2.VideoObjectTrackingAnnotation>(8, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'videoObjectTracking', subBuilder: $2.VideoObjectTrackingAnnotation.create)
    ..aOM<$1.VideoClassificationAnnotation>(9, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'videoClassification', subBuilder: $1.VideoClassificationAnnotation.create)
    ..aOM<$5.TablesAnnotation>(10, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'tables', subBuilder: $5.TablesAnnotation.create)
  ...
  'Will be removed in next major version')
  AnnotationPayload copyWith(void Function(AnnotationPayload) updates) => super.copyWith((message) => updates(message as AnnotationPayload)) as AnnotationPayload; // ignore: deprecated_member_use
  ...
  @$pb.TagNumber(8)
  set videoObjectTracking($2.VideoObjectTrackingAnnotation v) { setField(8, v); }
  @$pb.TagNumber(8)

...
final $typed_data.Uint8List textClassificationDatasetMetadataDescriptor = $convert.base64Decode('CiFUZXh0Q2xhc3NpZmljYXRpb25EYXRhc2V0TWV0YWRhdGESYAoTY2xhc3NpZmljYXRpb25fdHlwZRgBIAEoDjIvLmdvb2dsZS5jbG91ZC5hdXRvbWwudjFiZXRhMS5DbGFzc2lmaWNhdGlvblR5cGVSEmNsYXNzaWZpY2F0aW9uVHlwZQ==');
...
const TextClassificationModelMetadata$json = const {
  ...
  '2': const [
    const {'1': 'classification_type', '3': 3, '4': 1, '5': 14, '6': '.google.cloud.automl.v1beta1.ClassificationType', '10': 'classificationType'},
  ],
};

/// Descriptor for `TextClassificationModelMetadata`. Decode as a `google.protobuf.DescriptorProto`.
final $typed_data.Uint8List textClassificationModelMetadataDescriptor = $convert.base64Decode('Ch9UZXh0Q2xhc3NpZmljYXRpb25Nb2RlbE1ldGFkYXRhEmAKE2NsYXNzaWZpY2F0aW9uX3R5cGUYAyABKA4yLy5nb29nbGUuY2xvdWQuYXV0b21sLnYxYmV0YTEuQ2xhc3NpZmljYXRpb25UeXBlUhJjbGFzc2lmaWNhdGlvblR5cGU=');
...
final $typed_data.Uint8List textExtractionDatasetMetadataDescriptor = $convert.base64Decode('Ch1UZXh0RXh0cmFjdGlvbkRhdGFzZXRNZXRhZGF0YQ==');
...
const TextExtractionModelMetadata$json = const {
  ...
  '2': const [
    const {'1': 'model_hint', '3': 3, '4': 1, '5': 9, '10': 'modelHint'},
  ],
};

/// Descriptor for `TextExtractionModelMetadata`. Decode as a `google.protobuf.DescriptorProto`.
final $typed_data.Uint8List textExtractionModelMetadataDescriptor = $convert.base64Decode('ChtUZXh0RXh0cmFjdGlvbk1vZGVsTWV0YWRhdGESHQoKbW9kZWxfaGludBgDIAEoCVIJbW9kZWxIaW50');
...
final $typed_data.Uint8List textSentimentDatasetMetadataDescriptor = $convert.base64Decode('ChxUZXh0U2VudGltZW50RGF0YXNldE1ldGFkYXRhEiMKDXNlbnRpbWVudF9tYXgYASABKAVSDHNlbnRpbWVudE1heA==');
...
final $typed_data.Uint8List textSentimentModelMetadataDescriptor = $convert.base64Decode('ChpUZXh0U2VudGltZW50TW9kZWxNZXRhZGF0YQ==');

...
class Image extends $pb.GeneratedMessage {
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'Image', package: const $pb.PackageName(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'google.cloud.automl.v1beta1'), createEmptyInstance: create)
    ..oo(0, [1, 6])
    ..a<$core.List<$core.int>>(1, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'imageBytes', $pb.PbFieldType.OY)
    ..aOS(4, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'thumbnailUri')
    ..aOM<$0.InputConfig>(6, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'inputConfig', subBuilder: $0.InputConfig.create)
  ...
  @$pb.TagNumber(6)
  set inputConfig($0.InputConfig v) { setField(6, v); }
  @$pb.TagNumber(6)
...
class TextSnippet extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'TextSnippet', package: const $pb.PackageName(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'google.cloud.automl.v1beta1'), createEmptyInstance: create)
    ...
    ..aOS(4, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'contentUri')
    ..hasRequiredFields = false
  ;
  ...
  'Use [GeneratedMessageGenericExtensions.rebuild] instead. '
  'Will be removed in next major version')
  TextSnippet copyWith(void Function(TextSnippet) updates) => super.copyWith((message) => updates(message as TextSnippet)) as TextSnippet; // ignore: deprecated_member_use
  $pb.BuilderInfo get info_ => _i;
  @$core.pragma('dart2js:noInline')
...
class DocumentDimensions extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'DocumentDimensions', package: const $pb.PackageName(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'google.cloud.automl.v1beta1'), createEmptyInstance: create)
    ..e<DocumentDimensions_DocumentDimensionUnit>(1, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'unit', $pb.PbFieldType.OE, defaultOrMaker: DocumentDimensions_DocumentDimensionUnit.DOCUMENT_DIMENSION_UNIT_UNSPECIFIED, valueOf: DocumentDimensions_DocumentDimensionUnit.valueOf, enumValues: DocumentDimensions_DocumentDimensionUnit.values)
    ..a<$core.double>(2, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'width', $pb.PbFieldType.OF)
    ..a<$core.double>(3, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'height', $pb.PbFieldType.OF)
    ..hasRequiredFields = false
  ;
  ...
  'Use [GeneratedMessageGenericExtensions.rebuild] instead. '
  'Will be removed in next major version')
  DocumentDimensions copyWith(void Function(DocumentDimensions) updates) => super.copyWith((message) => updates(message as DocumentDimensions)) as DocumentDimensions; // ignore: deprecated_member_use
  $pb.BuilderInfo get info_ => _i;
  @$core.pragma('dart2js:noInline')
...
class Document_Layout extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'Document.Layout', package: const $pb.PackageName(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'google.cloud.automl.v1beta1'), createEmptyInstance: create)
    ..aOM<$1.TextSegment>(1, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'textSegment', subBuilder: $1.TextSegment.create)
    ...
    ..e<Document_Layout_TextSegmentType>(4, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'textSegmentType', $pb.PbFieldType.OE, defaultOrMaker: Document_Layout_TextSegmentType.TEXT_SEGMENT_TYPE_UNSPECIFIED, valueOf: Document_Layout_TextSegmentType.valueOf, enumValues: Document_Layout_TextSegmentType.values)
    ..hasRequiredFields = false
  ;
  ...
  'Use [GeneratedMessageGenericExtensions.rebuild] instead. '
  'Will be removed in next major version')
  Document_Layout copyWith(void Function(Document_Layout) updates) => super.copyWith((message) => updates(message as Document_Layout)) as Document_Layout; // ignore: deprecated_member_use
  $pb.BuilderInfo get info_ => _i;
  @$core.pragma('dart2js:noInline')
  ...
  @$pb.TagNumber(1)
  set textSegment($1.TextSegment v) { setField(1, v); }
  @$pb.TagNumber(1)
...
class Document extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'Document', package: const $pb.PackageName(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'google.cloud.automl.v1beta1'), createEmptyInstance: create)
    ..aOM<$0.DocumentInputConfig>(1, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'inputConfig', subBuilder: $0.DocumentInputConfig.create)
    ..aOM<TextSnippet>(2, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'documentText', subBuilder: TextSnippet.create)
    ..pc<Document_Layout>(3, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'layout', $pb.PbFieldType.PM, subBuilder: Document_Layout.create)
    ..aOM<DocumentDimensions>(4, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'documentDimensions', subBuilder: DocumentDimensions.create)
    ..a<$core.int>(5, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'pageCount', $pb.PbFieldType.O3)
    ..hasRequiredFields = false
  ;
  ...
  @$pb.TagNumber(1)
  set inputConfig($0.DocumentInputConfig v) { setField(1, v); }
  @$pb.TagNumber(1)
...
class Row extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'Row', package: const $pb.PackageName(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'google.cloud.automl.v1beta1'), createEmptyInstance: create)
    ..pPS(2, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'columnSpecIds')
    ..pc<$3.Value>(3, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'values', $pb.PbFieldType.PM, subBuilder: $3.Value.create)
    ..hasRequiredFields = false
  ;
...
class ExamplePayload extends $pb.GeneratedMessage {
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'ExamplePayload', package: const $pb.PackageName(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'google.cloud.automl.v1beta1'), createEmptyInstance: create)
    ..oo(0, [1, 2, 3, 4])
    ..aOM<Image>(1, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'image', subBuilder: Image.create)
    ..aOM<TextSnippet>(2, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'textSnippet', subBuilder: TextSnippet.create)
    ..aOM<Row>(3, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'row', subBuilder: Row.create)
    ..aOM<Document>(4, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'document', subBuilder: Document.create)
    ..hasRequiredFields = false
  ;
  ...
  'Use [GeneratedMessageGenericExtensions.rebuild] instead. '
  'Will be removed in next major version')
  ExamplePayload copyWith(void Function(ExamplePayload) updates) => super.copyWith((message) => updates(message as ExamplePayload)) as ExamplePayload; // ignore: deprecated_member_use
  $pb.BuilderInfo get info_ => _i;
  @$core.pragma('dart2js:noInline')

...
class ClassificationAnnotation extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'ClassificationAnnotation', package: const $pb.PackageName(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'google.cloud.automl.v1beta1'), createEmptyInstance: create)
  ...
  'Will be removed in next major version')
  ClassificationAnnotation copyWith(void Function(ClassificationAnnotation) updates) => super.copyWith((message) => updates(message as ClassificationAnnotation)) as ClassificationAnnotation; // ignore: deprecated_member_use
...
class VideoClassificationAnnotation extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'VideoClassificationAnnotation', package: const $pb.PackageName(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'google.cloud.automl.v1beta1'), createEmptyInstance: create)
    ..aOS(1, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'type')
    ..aOM<ClassificationAnnotation>(2, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'classificationAnnotation', subBuilder: ClassificationAnnotation.create)
    ..aOM<$0.TimeSegment>(3, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'timeSegment', subBuilder: $0.TimeSegment.create)
    ..hasRequiredFields = false
  ;
  ...
  factory VideoClassificationAnnotation({
    ...
    if (classificationAnnotation != null) {
      _result.classificationAnnotation = classificationAnnotation;
    }
    if (timeSegment != null) {
  ...
  @$pb.TagNumber(3)
  set timeSegment($0.TimeSegment v) { setField(3, v); }
  @$pb.TagNumber(3)
...
class ClassificationEvaluationMetrics_ConfidenceMetricsEntry extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'ClassificationEvaluationMetrics.ConfidenceMetricsEntry', package: const $pb.PackageName(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'google.cloud.automl.v1beta1'), createEmptyInstance: create)
    ...
    ..a<$core.double>(8, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'falsePositiveRate', $pb.PbFieldType.OF)
    ..a<$core.double>(9, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'falsePositiveRateAt1', $pb.PbFieldType.OF)
    ..aInt64(10, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'truePositiveCount')
    ..aInt64(11, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'falsePositiveCount')
    ..aInt64(12, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'falseNegativeCount')
    ..aInt64(13, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'trueNegativeCount')
    ..a<$core.int>(14, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'positionThreshold', $pb.PbFieldType.O3)
    ..hasRequiredFields = false
  ;
  ...
  'Use [GeneratedMessageGenericExtensions.rebuild] instead. '
  'Will be removed in next major version')
  ClassificationEvaluationMetrics_ConfidenceMetricsEntry copyWith(void Function(ClassificationEvaluationMetrics_ConfidenceMetricsEntry) updates) => super.copyWith((message) => updates(message as ClassificationEvaluationMetrics_ConfidenceMetricsEntry)) as ClassificationEvaluationMetrics_ConfidenceMetricsEntry; // ignore: deprecated_member_use
  $pb.BuilderInfo get info_ => _i;
  @$core.pragma('dart2js:noInline')
...
class ClassificationEvaluationMetrics_ConfusionMatrix_Row extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'ClassificationEvaluationMetrics.ConfusionMatrix.Row', package: const $pb.PackageName(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'google.cloud.automl.v1beta1'), createEmptyInstance: create)
    ..p<$core.int>(1, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'exampleCount', $pb.PbFieldType.P3)
    ..hasRequiredFields = false
  ;
  ...
  'Use [GeneratedMessageGenericExtensions.rebuild] instead. '
  'Will be removed in next major version')
  ClassificationEvaluationMetrics_ConfusionMatrix_Row copyWith(void Function(ClassificationEvaluationMetrics_ConfusionMatrix_Row) updates) => super.copyWith((message) => updates(message as ClassificationEvaluationMetrics_ConfusionMatrix_Row)) as ClassificationEvaluationMetrics_ConfusionMatrix_Row; // ignore: deprecated_member_use
  $pb.BuilderInfo get info_ => _i;
  @$core.pragma('dart2js:noInline')
...
class ClassificationEvaluationMetrics_ConfusionMatrix extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'ClassificationEvaluationMetrics.ConfusionMatrix', package: const $pb.PackageName(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'google.cloud.automl.v1beta1'), createEmptyInstance: create)
    ..pPS(1, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'annotationSpecId')
    ..pc<ClassificationEvaluationMetrics_ConfusionMatrix_Row>(2, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'row', $pb.PbFieldType.PM, subBuilder: ClassificationEvaluationMetrics_ConfusionMatrix_Row.create)
    ..pPS(3, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'displayName')
    ..hasRequiredFields = false
  ;
  ...
  'Use [GeneratedMessageGenericExtensions.rebuild] instead. '
  'Will be removed in next major version')
  ClassificationEvaluationMetrics_ConfusionMatrix copyWith(void Function(ClassificationEvaluationMetrics_ConfusionMatrix) updates) => super.copyWith((message) => updates(message as ClassificationEvaluationMetrics_ConfusionMatrix)) as ClassificationEvaluationMetrics_ConfusionMatrix; // ignore: deprecated_member_use
  $pb.BuilderInfo get info_ => _i;
  @$core.pragma('dart2js:noInline')
...
class ClassificationEvaluationMetrics extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'ClassificationEvaluationMetrics', package: const $pb.PackageName(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'google.cloud.automl.v1beta1'), createEmptyInstance: create)
    ..a<$core.double>(1, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'auPrc', $pb.PbFieldType.OF)
    ..a<$core.double>(2, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'baseAuPrc', $pb.PbFieldType.OF)
    ..pc<ClassificationEvaluationMetrics_ConfidenceMetricsEntry>(3, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'confidenceMetricsEntry', $pb.PbFieldType.PM, subBuilder: ClassificationEvaluationMetrics_ConfidenceMetricsEntry.create)
    ..aOM<ClassificationEvaluationMetrics_ConfusionMatrix>(4, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'confusionMatrix', subBuilder: ClassificationEvaluationMetrics_ConfusionMatrix.create)
    ..pPS(5, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'annotationSpecId')
    ..a<$core.double>(6, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'auRoc', $pb.PbFieldType.OF)
    ..a<$core.double>(7, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'logLoss', $pb.PbFieldType.OF)
    ..hasRequiredFields = false
  ;
  ...
  'Use [GeneratedMessageGenericExtensions.rebuild] instead. '
  'Will be removed in next major version')
  ClassificationEvaluationMetrics copyWith(void Function(ClassificationEvaluationMetrics) updates) => super.copyWith((message) => updates(message as ClassificationEvaluationMetrics)) as ClassificationEvaluationMetrics; // ignore: deprecated_member_use
  $pb.BuilderInfo get info_ => _i;
  @$core.pragma('dart2js:noInline')

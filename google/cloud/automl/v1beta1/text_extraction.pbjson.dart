...
const TextExtractionAnnotation$json = const {
  ...
  '2': const [
    const {'1': 'text_segment', '3': 3, '4': 1, '5': 11, '6': '.google.cloud.automl.v1beta1.TextSegment', '9': 0, '10': 'textSegment'},
...
final $typed_data.Uint8List textExtractionAnnotationDescriptor = $convert.base64Decode('ChhUZXh0RXh0cmFjdGlvbkFubm90YXRpb24STQoMdGV4dF9zZWdtZW50GAMgASgLMiguZ29vZ2xlLmNsb3VkLmF1dG9tbC52MWJldGExLlRleHRTZWdtZW50SABSC3RleHRTZWdtZW50EhQKBXNjb3JlGAEgASgCUgVzY29yZUIMCgphbm5vdGF0aW9u');
...
final $typed_data.Uint8List textExtractionEvaluationMetricsDescriptor = $convert.base64Decode('');

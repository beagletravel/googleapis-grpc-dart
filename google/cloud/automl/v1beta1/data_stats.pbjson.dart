...
const DataStats$json = const {
  ...
  '2': const [
    ...
    const {'1': 'valid_value_count', '3': 9, '4': 1, '5': 3, '10': 'validValueCount'},
  ],
  '8': const [
    const {'1': 'stats'},
  ],
...
final $typed_data.Uint8List dataStatsDescriptor = $convert.base64Decode('');
...
final $typed_data.Uint8List float64StatsDescriptor = $convert.base64Decode('');
...
final $typed_data.Uint8List stringStatsDescriptor = $convert.base64Decode('CgtTdHJpbmdTdGF0cxJhChF0b3BfdW5pZ3JhbV9zdGF0cxgBIAMoCzI1Lmdvb2dsZS5jbG91ZC5hdXRvbWwudjFiZXRhMS5TdHJpbmdTdGF0cy5VbmlncmFtU3RhdHNSD3RvcFVuaWdyYW1TdGF0cxo6CgxVbmlncmFtU3RhdHMSFAoFdmFsdWUYASABKAlSBXZhbHVlEhQKBWNvdW50GAIgASgDUgVjb3VudA==');
...
final $typed_data.Uint8List timestampStatsDescriptor = $convert.base64Decode('');
...
final $typed_data.Uint8List arrayStatsDescriptor = $convert.base64Decode('CgpBcnJheVN0YXRzEkkKDG1lbWJlcl9zdGF0cxgCIAEoCzImLmdvb2dsZS5jbG91ZC5hdXRvbWwudjFiZXRhMS5EYXRhU3RhdHNSC21lbWJlclN0YXRz');
...
final $typed_data.Uint8List structStatsDescriptor = $convert.base64Decode('');
...
final $typed_data.Uint8List categoryStatsDescriptor = $convert.base64Decode('');
...
final $typed_data.Uint8List correlationStatsDescriptor = $convert.base64Decode('ChBDb3JyZWxhdGlvblN0YXRzEhsKCWNyYW1lcnNfdhgBIAEoAVIIY3JhbWVyc1Y=');

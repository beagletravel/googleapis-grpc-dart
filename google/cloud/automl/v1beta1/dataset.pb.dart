...
class Dataset extends $pb.GeneratedMessage {
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'Dataset', package: const $pb.PackageName(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'google.cloud.automl.v1beta1'), createEmptyInstance: create)
    ...
    ..aOM<$4.VideoObjectTrackingDatasetMetadata>(29, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'videoObjectTrackingDatasetMetadata', subBuilder: $4.VideoObjectTrackingDatasetMetadata.create)
    ...
    ..aOM<$4.VideoClassificationDatasetMetadata>(31, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'videoClassificationDatasetMetadata', subBuilder: $4.VideoClassificationDatasetMetadata.create)
    ..aOM<$5.TablesDatasetMetadata>(33, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'tablesDatasetMetadata', subBuilder: $5.TablesDatasetMetadata.create)
  ...
  factory Dataset({
    ...
    $4.VideoObjectTrackingDatasetMetadata? videoObjectTrackingDatasetMetadata,
    $3.TextSentimentDatasetMetadata? textSentimentDatasetMetadata,
    $4.VideoClassificationDatasetMetadata? videoClassificationDatasetMetadata,
    $5.TablesDatasetMetadata? tablesDatasetMetadata,
  }) {
    ...
    if (videoObjectTrackingDatasetMetadata != null) {
      _result.videoObjectTrackingDatasetMetadata = videoObjectTrackingDatasetMetadata;
    }
    ...
    if (videoClassificationDatasetMetadata != null) {
      _result.videoClassificationDatasetMetadata = videoClassificationDatasetMetadata;
    }
    if (tablesDatasetMetadata != null) {
      _result.tablesDatasetMetadata = tablesDatasetMetadata;
    }
    return _result;
  }
  ...
  @$pb.TagNumber(29)
  $4.VideoObjectTrackingDatasetMetadata get videoObjectTrackingDatasetMetadata => $_getN(11);
  @$pb.TagNumber(29)
  set videoObjectTrackingDatasetMetadata($4.VideoObjectTrackingDatasetMetadata v) { setField(29, v); }
  @$pb.TagNumber(29)
  $core.bool hasVideoObjectTrackingDatasetMetadata() => $_has(11);
  @$pb.TagNumber(29)
  void clearVideoObjectTrackingDatasetMetadata() => clearField(29);
  @$pb.TagNumber(29)
  $4.VideoObjectTrackingDatasetMetadata ensureVideoObjectTrackingDatasetMetadata() => $_ensure(11);

  @$pb.TagNumber(30)
  $3.TextSentimentDatasetMetadata get textSentimentDatasetMetadata => $_getN(12);
  @$pb.TagNumber(30)
  ...
  @$pb.TagNumber(30)
  $3.TextSentimentDatasetMetadata ensureTextSentimentDatasetMetadata() => $_ensure(12);

  @$pb.TagNumber(31)
  $4.VideoClassificationDatasetMetadata get videoClassificationDatasetMetadata => $_getN(13);
  @$pb.TagNumber(31)
  set videoClassificationDatasetMetadata($4.VideoClassificationDatasetMetadata v) { setField(31, v); }
  @$pb.TagNumber(31)
  $core.bool hasVideoClassificationDatasetMetadata() => $_has(13);
  @$pb.TagNumber(31)
  void clearVideoClassificationDatasetMetadata() => clearField(31);
  @$pb.TagNumber(31)
  $4.VideoClassificationDatasetMetadata ensureVideoClassificationDatasetMetadata() => $_ensure(13);

  @$pb.TagNumber(33)
  $5.TablesDatasetMetadata get tablesDatasetMetadata => $_getN(14);
  @$pb.TagNumber(33)
  set tablesDatasetMetadata($5.TablesDatasetMetadata v) { setField(33, v); }
  @$pb.TagNumber(33)

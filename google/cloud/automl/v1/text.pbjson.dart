...
const TextClassificationDatasetMetadata$json = const {
  ...
  '2': const [
    const {'1': 'classification_type', '3': 1, '4': 1, '5': 14, '6': '.google.cloud.automl.v1.ClassificationType', '10': 'classificationType'},
  ],
};

/// Descriptor for `TextClassificationDatasetMetadata`. Decode as a `google.protobuf.DescriptorProto`.
final $typed_data.Uint8List textClassificationDatasetMetadataDescriptor = $convert.base64Decode('CiFUZXh0Q2xhc3NpZmljYXRpb25EYXRhc2V0TWV0YWRhdGESWwoTY2xhc3NpZmljYXRpb25fdHlwZRgBIAEoDjIqLmdvb2dsZS5jbG91ZC5hdXRvbWwudjEuQ2xhc3NpZmljYXRpb25UeXBlUhJjbGFzc2lmaWNhdGlvblR5cGU=');
...
const TextClassificationModelMetadata$json = const {
  ...
  '2': const [
    const {'1': 'classification_type', '3': 3, '4': 1, '5': 14, '6': '.google.cloud.automl.v1.ClassificationType', '10': 'classificationType'},
  ],
};

/// Descriptor for `TextClassificationModelMetadata`. Decode as a `google.protobuf.DescriptorProto`.
final $typed_data.Uint8List textClassificationModelMetadataDescriptor = $convert.base64Decode('Ch9UZXh0Q2xhc3NpZmljYXRpb25Nb2RlbE1ldGFkYXRhElsKE2NsYXNzaWZpY2F0aW9uX3R5cGUYAyABKA4yKi5nb29nbGUuY2xvdWQuYXV0b21sLnYxLkNsYXNzaWZpY2F0aW9uVHlwZVISY2xhc3NpZmljYXRpb25UeXBl');
...
final $typed_data.Uint8List textExtractionModelMetadataDescriptor = $convert.base64Decode('ChtUZXh0RXh0cmFjdGlvbk1vZGVsTWV0YWRhdGE=');

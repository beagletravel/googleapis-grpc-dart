...
class AuthorizationPolicy_Action extends $pb.ProtobufEnum {
  static const AuthorizationPolicy_Action ACTION_UNSPECIFIED = AuthorizationPolicy_Action._(0, const $core.bool.fromEnvironment('protobuf.omit_enum_names') ? '' : 'ACTION_UNSPECIFIED');
  static const AuthorizationPolicy_Action ALLOW = AuthorizationPolicy_Action._(1, const $core.bool.fromEnvironment('protobuf.omit_enum_names') ? '' : 'ALLOW');
  static const AuthorizationPolicy_Action DENY = AuthorizationPolicy_Action._(2, const $core.bool.fromEnvironment('protobuf.omit_enum_names') ? '' : 'DENY');

...
class ServerTlsPolicy_MTLSPolicy extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'ServerTlsPolicy.MTLSPolicy', package: const $pb.PackageName(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'google.cloud.networksecurity.v1beta1'), createEmptyInstance: create)
    ..pc<$1.ValidationCA>(1, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'clientValidationCa', $pb.PbFieldType.PM, subBuilder: $1.ValidationCA.create)
  ...
  'Will be removed in next major version')
  ServerTlsPolicy_MTLSPolicy copyWith(void Function(ServerTlsPolicy_MTLSPolicy) updates) => super.copyWith((message) => updates(message as ServerTlsPolicy_MTLSPolicy)) as ServerTlsPolicy_MTLSPolicy; // ignore: deprecated_member_use
...
class ServerTlsPolicy extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'ServerTlsPolicy', package: const $pb.PackageName(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'google.cloud.networksecurity.v1beta1'), createEmptyInstance: create)
    ...
    ..m<$core.String, $core.String>(5, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'labels', entryClassName: 'ServerTlsPolicy.LabelsEntry', keyFieldType: $pb.PbFieldType.OS, valueFieldType: $pb.PbFieldType.OS, packageName: const $pb.PackageName('google.cloud.networksecurity.v1beta1'))
    ..aOB(6, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'allowOpen')
    ..aOM<$1.CertificateProvider>(7, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'serverCertificate', subBuilder: $1.CertificateProvider.create)
    ..aOM<ServerTlsPolicy_MTLSPolicy>(8, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'mtlsPolicy', subBuilder: ServerTlsPolicy_MTLSPolicy.create)
    ..hasRequiredFields = false
  ;
  ...
  'Use [GeneratedMessageGenericExtensions.rebuild] instead. '
  'Will be removed in next major version')
  ServerTlsPolicy copyWith(void Function(ServerTlsPolicy) updates) => super.copyWith((message) => updates(message as ServerTlsPolicy)) as ServerTlsPolicy; // ignore: deprecated_member_use
  $pb.BuilderInfo get info_ => _i;
  @$core.pragma('dart2js:noInline')
  ...
  @$pb.TagNumber(7)
  set serverCertificate($1.CertificateProvider v) { setField(7, v); }
  @$pb.TagNumber(7)
...
class ListServerTlsPoliciesRequest extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'ListServerTlsPoliciesRequest', package: const $pb.PackageName(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'google.cloud.networksecurity.v1beta1'), createEmptyInstance: create)
  ...
  'Use [GeneratedMessageGenericExtensions.rebuild] instead. '
  'Will be removed in next major version')
  ListServerTlsPoliciesRequest copyWith(void Function(ListServerTlsPoliciesRequest) updates) => super.copyWith((message) => updates(message as ListServerTlsPoliciesRequest)) as ListServerTlsPoliciesRequest; // ignore: deprecated_member_use
  $pb.BuilderInfo get info_ => _i;
  @$core.pragma('dart2js:noInline')
...
class ListServerTlsPoliciesResponse extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'ListServerTlsPoliciesResponse', package: const $pb.PackageName(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'google.cloud.networksecurity.v1beta1'), createEmptyInstance: create)
    ..pc<ServerTlsPolicy>(1, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'serverTlsPolicies', $pb.PbFieldType.PM, subBuilder: ServerTlsPolicy.create)
  ...
  'Use [GeneratedMessageGenericExtensions.rebuild] instead. '
  'Will be removed in next major version')
  ListServerTlsPoliciesResponse copyWith(void Function(ListServerTlsPoliciesResponse) updates) => super.copyWith((message) => updates(message as ListServerTlsPoliciesResponse)) as ListServerTlsPoliciesResponse; // ignore: deprecated_member_use
  $pb.BuilderInfo get info_ => _i;
  @$core.pragma('dart2js:noInline')
...
class GetServerTlsPolicyRequest extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'GetServerTlsPolicyRequest', package: const $pb.PackageName(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'google.cloud.networksecurity.v1beta1'), createEmptyInstance: create)
    ..aOS(1, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'name')
    ..hasRequiredFields = false
  ;
  ...
  'Use [GeneratedMessageGenericExtensions.rebuild] instead. '
  'Will be removed in next major version')
  GetServerTlsPolicyRequest copyWith(void Function(GetServerTlsPolicyRequest) updates) => super.copyWith((message) => updates(message as GetServerTlsPolicyRequest)) as GetServerTlsPolicyRequest; // ignore: deprecated_member_use
  $pb.BuilderInfo get info_ => _i;
  @$core.pragma('dart2js:noInline')
...
class CreateServerTlsPolicyRequest extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'CreateServerTlsPolicyRequest', package: const $pb.PackageName(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'google.cloud.networksecurity.v1beta1'), createEmptyInstance: create)
    ..aOS(1, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'parent')
    ..aOS(2, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'serverTlsPolicyId')
    ..aOM<ServerTlsPolicy>(3, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'serverTlsPolicy', subBuilder: ServerTlsPolicy.create)
    ..hasRequiredFields = false
  ;
  ...
  'Use [GeneratedMessageGenericExtensions.rebuild] instead. '
  'Will be removed in next major version')
  CreateServerTlsPolicyRequest copyWith(void Function(CreateServerTlsPolicyRequest) updates) => super.copyWith((message) => updates(message as CreateServerTlsPolicyRequest)) as CreateServerTlsPolicyRequest; // ignore: deprecated_member_use
  $pb.BuilderInfo get info_ => _i;
  @$core.pragma('dart2js:noInline')
...
class UpdateServerTlsPolicyRequest extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'UpdateServerTlsPolicyRequest', package: const $pb.PackageName(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'google.cloud.networksecurity.v1beta1'), createEmptyInstance: create)
    ..aOM<$2.FieldMask>(1, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'updateMask', subBuilder: $2.FieldMask.create)
    ..aOM<ServerTlsPolicy>(2, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'serverTlsPolicy', subBuilder: ServerTlsPolicy.create)
    ..hasRequiredFields = false
  ;
  ...
  'Use [GeneratedMessageGenericExtensions.rebuild] instead. '
  'Will be removed in next major version')
  UpdateServerTlsPolicyRequest copyWith(void Function(UpdateServerTlsPolicyRequest) updates) => super.copyWith((message) => updates(message as UpdateServerTlsPolicyRequest)) as UpdateServerTlsPolicyRequest; // ignore: deprecated_member_use
  $pb.BuilderInfo get info_ => _i;
  @$core.pragma('dart2js:noInline')
  ...
  @$pb.TagNumber(1)
  set updateMask($2.FieldMask v) { setField(1, v); }
  @$pb.TagNumber(1)
...
class DeleteServerTlsPolicyRequest extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'DeleteServerTlsPolicyRequest', package: const $pb.PackageName(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'google.cloud.networksecurity.v1beta1'), createEmptyInstance: create)
    ..aOS(1, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'name')
    ..hasRequiredFields = false
  ;
  ...
  'Use [GeneratedMessageGenericExtensions.rebuild] instead. '
  'Will be removed in next major version')
  DeleteServerTlsPolicyRequest copyWith(void Function(DeleteServerTlsPolicyRequest) updates) => super.copyWith((message) => updates(message as DeleteServerTlsPolicyRequest)) as DeleteServerTlsPolicyRequest; // ignore: deprecated_member_use
  $pb.BuilderInfo get info_ => _i;
  @$core.pragma('dart2js:noInline')

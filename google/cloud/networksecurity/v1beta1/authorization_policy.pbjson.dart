...
const AuthorizationPolicy$json = const {
  ...
  '2': const [
    ...
    const {'1': 'labels', '3': 5, '4': 3, '5': 11, '6': '.google.cloud.networksecurity.v1beta1.AuthorizationPolicy.LabelsEntry', '8': const {}, '10': 'labels'},
    const {'1': 'action', '3': 6, '4': 1, '5': 14, '6': '.google.cloud.networksecurity.v1beta1.AuthorizationPolicy.Action', '8': const {}, '10': 'action'},
    const {'1': 'rules', '3': 7, '4': 3, '5': 11, '6': '.google.cloud.networksecurity.v1beta1.AuthorizationPolicy.Rule', '8': const {}, '10': 'rules'},
  ],
  '3': const [AuthorizationPolicy_Rule$json, AuthorizationPolicy_LabelsEntry$json],
...
const AuthorizationPolicy_Rule$json = const {
  '1': 'Rule',
  '2': const [
    const {'1': 'sources', '3': 1, '4': 3, '5': 11, '6': '.google.cloud.networksecurity.v1beta1.AuthorizationPolicy.Rule.Source', '8': const {}, '10': 'sources'},
    const {'1': 'destinations', '3': 2, '4': 3, '5': 11, '6': '.google.cloud.networksecurity.v1beta1.AuthorizationPolicy.Rule.Destination', '8': const {}, '10': 'destinations'},
  ],
  '3': const [AuthorizationPolicy_Rule_Source$json, AuthorizationPolicy_Rule_Destination$json],
};
...
const AuthorizationPolicy_Rule_Source$json = const {
  '1': 'Source',
  '2': const [
    const {'1': 'principals', '3': 1, '4': 3, '5': 9, '8': const {}, '10': 'principals'},
    const {'1': 'ip_blocks', '3': 2, '4': 3, '5': 9, '8': const {}, '10': 'ipBlocks'},
  ],
};
...
const AuthorizationPolicy_Rule_Destination$json = const {
  ...
  '2': const [
    ...
    const {'1': 'methods', '3': 4, '4': 3, '5': 9, '8': const {}, '10': 'methods'},
    const {'1': 'http_header_match', '3': 5, '4': 1, '5': 11, '6': '.google.cloud.networksecurity.v1beta1.AuthorizationPolicy.Rule.Destination.HttpHeaderMatch', '8': const {}, '10': 'httpHeaderMatch'},
  ],
...
const AuthorizationPolicy_Rule_Destination_HttpHeaderMatch$json = const {
  '1': 'HttpHeaderMatch',
  '2': const [
    const {'1': 'regex_match', '3': 2, '4': 1, '5': 9, '8': const {}, '9': 0, '10': 'regexMatch'},
    const {'1': 'header_name', '3': 1, '4': 1, '5': 9, '8': const {}, '10': 'headerName'},
  ],
  '8': const [
    const {'1': 'type'},
  ],
...
final $typed_data.Uint8List listAuthorizationPoliciesRequestDescriptor = $convert.base64Decode('CiBMaXN0QXV0aG9yaXphdGlvblBvbGljaWVzUmVxdWVzdBJBCgZwYXJlbnQYASABKAlCKeBBAvpBIwohbG9jYXRpb25zLmdvb2dsZWFwaXMuY29tL0xvY2F0aW9uUgZwYXJlbnQSGwoJcGFnZV9zaXplGAIgASgFUghwYWdlU2l6ZRIdCgpwYWdlX3Rva2VuGAMgASgJUglwYWdlVG9rZW4=');
...
const ListAuthorizationPoliciesResponse$json = const {
  ...
  '2': const [
    const {'1': 'authorization_policies', '3': 1, '4': 3, '5': 11, '6': '.google.cloud.networksecurity.v1beta1.AuthorizationPolicy', '10': 'authorizationPolicies'},
    const {'1': 'next_page_token', '3': 2, '4': 1, '5': 9, '10': 'nextPageToken'},
  ],
};

/// Descriptor for `ListAuthorizationPoliciesResponse`. Decode as a `google.protobuf.DescriptorProto`.
final $typed_data.Uint8List listAuthorizationPoliciesResponseDescriptor = $convert.base64Decode('CiFMaXN0QXV0aG9yaXphdGlvblBvbGljaWVzUmVzcG9uc2UScAoWYXV0aG9yaXphdGlvbl9wb2xpY2llcxgBIAMoCzI5Lmdvb2dsZS5jbG91ZC5uZXR3b3Jrc2VjdXJpdHkudjFiZXRhMS5BdXRob3JpemF0aW9uUG9saWN5UhVhdXRob3JpemF0aW9uUG9saWNpZXMSJgoPbmV4dF9wYWdlX3Rva2VuGAIgASgJUg1uZXh0UGFnZVRva2Vu');
...
final $typed_data.Uint8List getAuthorizationPolicyRequestDescriptor = $convert.base64Decode('Ch1HZXRBdXRob3JpemF0aW9uUG9saWN5UmVxdWVzdBJOCgRuYW1lGAEgASgJQjrgQQL6QTQKMm5ldHdvcmtzZWN1cml0eS5nb29nbGVhcGlzLmNvbS9BdXRob3JpemF0aW9uUG9saWN5UgRuYW1l');
...
const CreateAuthorizationPolicyRequest$json = const {
  ...
  '2': const [
    const {'1': 'parent', '3': 1, '4': 1, '5': 9, '8': const {}, '10': 'parent'},
    const {'1': 'authorization_policy_id', '3': 2, '4': 1, '5': 9, '8': const {}, '10': 'authorizationPolicyId'},
    const {'1': 'authorization_policy', '3': 3, '4': 1, '5': 11, '6': '.google.cloud.networksecurity.v1beta1.AuthorizationPolicy', '8': const {}, '10': 'authorizationPolicy'},
  ],
};

/// Descriptor for `CreateAuthorizationPolicyRequest`. Decode as a `google.protobuf.DescriptorProto`.
final $typed_data.Uint8List createAuthorizationPolicyRequestDescriptor = $convert.base64Decode('');
...
const UpdateAuthorizationPolicyRequest$json = const {
  ...
  '2': const [
    ...
    const {'1': 'authorization_policy', '3': 2, '4': 1, '5': 11, '6': '.google.cloud.networksecurity.v1beta1.AuthorizationPolicy', '8': const {}, '10': 'authorizationPolicy'},
  ],
};

/// Descriptor for `UpdateAuthorizationPolicyRequest`. Decode as a `google.protobuf.DescriptorProto`.
final $typed_data.Uint8List updateAuthorizationPolicyRequestDescriptor = $convert.base64Decode('');
...
final $typed_data.Uint8List deleteAuthorizationPolicyRequestDescriptor = $convert.base64Decode('CiBEZWxldGVBdXRob3JpemF0aW9uUG9saWN5UmVxdWVzdBJOCgRuYW1lGAEgASgJQjrgQQL6QTQKMm5ldHdvcmtzZWN1cml0eS5nb29nbGVhcGlzLmNvbS9BdXRob3JpemF0aW9uUG9saWN5UgRuYW1l');

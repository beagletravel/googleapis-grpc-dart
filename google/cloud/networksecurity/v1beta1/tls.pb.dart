...
class GrpcEndpoint extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'GrpcEndpoint', package: const $pb.PackageName(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'google.cloud.networksecurity.v1beta1'), createEmptyInstance: create)
    ..aOS(1, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'targetUri')
  ...
  'Will be removed in next major version')
  GrpcEndpoint copyWith(void Function(GrpcEndpoint) updates) => super.copyWith((message) => updates(message as GrpcEndpoint)) as GrpcEndpoint; // ignore: deprecated_member_use
...
class ValidationCA extends $pb.GeneratedMessage {
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'ValidationCA', package: const $pb.PackageName(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'google.cloud.networksecurity.v1beta1'), createEmptyInstance: create)
    ..oo(0, [2, 3])
    ..aOM<GrpcEndpoint>(2, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'grpcEndpoint', subBuilder: GrpcEndpoint.create)
    ..aOM<CertificateProviderInstance>(3, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'certificateProviderInstance', subBuilder: CertificateProviderInstance.create)
    ..hasRequiredFields = false
  ;
  ...
  'Use [GeneratedMessageGenericExtensions.rebuild] instead. '
  'Will be removed in next major version')
  ValidationCA copyWith(void Function(ValidationCA) updates) => super.copyWith((message) => updates(message as ValidationCA)) as ValidationCA; // ignore: deprecated_member_use
  $pb.BuilderInfo get info_ => _i;
  @$core.pragma('dart2js:noInline')
...
class CertificateProviderInstance extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'CertificateProviderInstance', package: const $pb.PackageName(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'google.cloud.networksecurity.v1beta1'), createEmptyInstance: create)
    ..aOS(1, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'pluginInstance')
    ..hasRequiredFields = false
  ;
  ...
  'Use [GeneratedMessageGenericExtensions.rebuild] instead. '
  'Will be removed in next major version')
  CertificateProviderInstance copyWith(void Function(CertificateProviderInstance) updates) => super.copyWith((message) => updates(message as CertificateProviderInstance)) as CertificateProviderInstance; // ignore: deprecated_member_use
  $pb.BuilderInfo get info_ => _i;
  @$core.pragma('dart2js:noInline')
...
class CertificateProvider extends $pb.GeneratedMessage {
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'CertificateProvider', package: const $pb.PackageName(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'google.cloud.networksecurity.v1beta1'), createEmptyInstance: create)
    ..oo(0, [2, 3])
    ..aOM<GrpcEndpoint>(2, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'grpcEndpoint', subBuilder: GrpcEndpoint.create)
    ..aOM<CertificateProviderInstance>(3, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'certificateProviderInstance', subBuilder: CertificateProviderInstance.create)
    ..hasRequiredFields = false
  ...
  'Use [GeneratedMessageGenericExtensions.rebuild] instead. '
  'Will be removed in next major version')
  CertificateProvider copyWith(void Function(CertificateProvider) updates) => super.copyWith((message) => updates(message as CertificateProvider)) as CertificateProvider; // ignore: deprecated_member_use
  $pb.BuilderInfo get info_ => _i;
  @$core.pragma('dart2js:noInline')

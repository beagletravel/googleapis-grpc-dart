...
class ClientTlsPolicy extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'ClientTlsPolicy', package: const $pb.PackageName(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'google.cloud.networksecurity.v1beta1'), createEmptyInstance: create)
    ...
    ..m<$core.String, $core.String>(5, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'labels', entryClassName: 'ClientTlsPolicy.LabelsEntry', keyFieldType: $pb.PbFieldType.OS, valueFieldType: $pb.PbFieldType.OS, packageName: const $pb.PackageName('google.cloud.networksecurity.v1beta1'))
    ..aOS(6, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'sni')
    ..aOM<$1.CertificateProvider>(7, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'clientCertificate', subBuilder: $1.CertificateProvider.create)
    ..pc<$1.ValidationCA>(8, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'serverValidationCa', $pb.PbFieldType.PM, subBuilder: $1.ValidationCA.create)
  ...
  'Will be removed in next major version')
  ClientTlsPolicy copyWith(void Function(ClientTlsPolicy) updates) => super.copyWith((message) => updates(message as ClientTlsPolicy)) as ClientTlsPolicy; // ignore: deprecated_member_use
  ...
  @$pb.TagNumber(7)
  set clientCertificate($1.CertificateProvider v) { setField(7, v); }
  @$pb.TagNumber(7)
...
class ListClientTlsPoliciesRequest extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'ListClientTlsPoliciesRequest', package: const $pb.PackageName(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'google.cloud.networksecurity.v1beta1'), createEmptyInstance: create)
  ...
  'Use [GeneratedMessageGenericExtensions.rebuild] instead. '
  'Will be removed in next major version')
  ListClientTlsPoliciesRequest copyWith(void Function(ListClientTlsPoliciesRequest) updates) => super.copyWith((message) => updates(message as ListClientTlsPoliciesRequest)) as ListClientTlsPoliciesRequest; // ignore: deprecated_member_use
  $pb.BuilderInfo get info_ => _i;
  @$core.pragma('dart2js:noInline')
...
class ListClientTlsPoliciesResponse extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'ListClientTlsPoliciesResponse', package: const $pb.PackageName(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'google.cloud.networksecurity.v1beta1'), createEmptyInstance: create)
    ..pc<ClientTlsPolicy>(1, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'clientTlsPolicies', $pb.PbFieldType.PM, subBuilder: ClientTlsPolicy.create)
  ...
  'Use [GeneratedMessageGenericExtensions.rebuild] instead. '
  'Will be removed in next major version')
  ListClientTlsPoliciesResponse copyWith(void Function(ListClientTlsPoliciesResponse) updates) => super.copyWith((message) => updates(message as ListClientTlsPoliciesResponse)) as ListClientTlsPoliciesResponse; // ignore: deprecated_member_use
  $pb.BuilderInfo get info_ => _i;
  @$core.pragma('dart2js:noInline')
...
class GetClientTlsPolicyRequest extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'GetClientTlsPolicyRequest', package: const $pb.PackageName(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'google.cloud.networksecurity.v1beta1'), createEmptyInstance: create)
    ..aOS(1, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'name')
    ..hasRequiredFields = false
  ;
  ...
  'Use [GeneratedMessageGenericExtensions.rebuild] instead. '
  'Will be removed in next major version')
  GetClientTlsPolicyRequest copyWith(void Function(GetClientTlsPolicyRequest) updates) => super.copyWith((message) => updates(message as GetClientTlsPolicyRequest)) as GetClientTlsPolicyRequest; // ignore: deprecated_member_use
  $pb.BuilderInfo get info_ => _i;
  @$core.pragma('dart2js:noInline')
...
class CreateClientTlsPolicyRequest extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'CreateClientTlsPolicyRequest', package: const $pb.PackageName(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'google.cloud.networksecurity.v1beta1'), createEmptyInstance: create)
    ..aOS(1, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'parent')
    ..aOS(2, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'clientTlsPolicyId')
    ..aOM<ClientTlsPolicy>(3, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'clientTlsPolicy', subBuilder: ClientTlsPolicy.create)
    ..hasRequiredFields = false
  ;
  ...
  'Use [GeneratedMessageGenericExtensions.rebuild] instead. '
  'Will be removed in next major version')
  CreateClientTlsPolicyRequest copyWith(void Function(CreateClientTlsPolicyRequest) updates) => super.copyWith((message) => updates(message as CreateClientTlsPolicyRequest)) as CreateClientTlsPolicyRequest; // ignore: deprecated_member_use
  $pb.BuilderInfo get info_ => _i;
  @$core.pragma('dart2js:noInline')
...
class UpdateClientTlsPolicyRequest extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'UpdateClientTlsPolicyRequest', package: const $pb.PackageName(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'google.cloud.networksecurity.v1beta1'), createEmptyInstance: create)
    ..aOM<$2.FieldMask>(1, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'updateMask', subBuilder: $2.FieldMask.create)
    ..aOM<ClientTlsPolicy>(2, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'clientTlsPolicy', subBuilder: ClientTlsPolicy.create)
    ..hasRequiredFields = false
  ;
  ...
  'Use [GeneratedMessageGenericExtensions.rebuild] instead. '
  'Will be removed in next major version')
  UpdateClientTlsPolicyRequest copyWith(void Function(UpdateClientTlsPolicyRequest) updates) => super.copyWith((message) => updates(message as UpdateClientTlsPolicyRequest)) as UpdateClientTlsPolicyRequest; // ignore: deprecated_member_use
  $pb.BuilderInfo get info_ => _i;
  @$core.pragma('dart2js:noInline')
...
class DeleteClientTlsPolicyRequest extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'DeleteClientTlsPolicyRequest', package: const $pb.PackageName(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'google.cloud.networksecurity.v1beta1'), createEmptyInstance: create)
    ..aOS(1, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'name')
    ..hasRequiredFields = false
  ;
  ...
  'Use [GeneratedMessageGenericExtensions.rebuild] instead. '
  'Will be removed in next major version')
  DeleteClientTlsPolicyRequest copyWith(void Function(DeleteClientTlsPolicyRequest) updates) => super.copyWith((message) => updates(message as DeleteClientTlsPolicyRequest)) as DeleteClientTlsPolicyRequest; // ignore: deprecated_member_use
  $pb.BuilderInfo get info_ => _i;
  @$core.pragma('dart2js:noInline')

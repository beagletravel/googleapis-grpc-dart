...
class AuthorizationPolicy_Rule_Source extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'AuthorizationPolicy.Rule.Source', package: const $pb.PackageName(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'google.cloud.networksecurity.v1beta1'), createEmptyInstance: create)
    ..pPS(1, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'principals')
    ..pPS(2, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'ipBlocks')
  ...
  'Will be removed in next major version')
  AuthorizationPolicy_Rule_Source copyWith(void Function(AuthorizationPolicy_Rule_Source) updates) => super.copyWith((message) => updates(message as AuthorizationPolicy_Rule_Source)) as AuthorizationPolicy_Rule_Source; // ignore: deprecated_member_use
...
class AuthorizationPolicy_Rule_Destination_HttpHeaderMatch extends $pb.GeneratedMessage {
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'AuthorizationPolicy.Rule.Destination.HttpHeaderMatch', package: const $pb.PackageName(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'google.cloud.networksecurity.v1beta1'), createEmptyInstance: create)
    ..oo(0, [2])
    ..aOS(1, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'headerName')
    ..aOS(2, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'regexMatch')
    ..hasRequiredFields = false
  ;
  ...
  'Use [GeneratedMessageGenericExtensions.rebuild] instead. '
  'Will be removed in next major version')
  AuthorizationPolicy_Rule_Destination_HttpHeaderMatch copyWith(void Function(AuthorizationPolicy_Rule_Destination_HttpHeaderMatch) updates) => super.copyWith((message) => updates(message as AuthorizationPolicy_Rule_Destination_HttpHeaderMatch)) as AuthorizationPolicy_Rule_Destination_HttpHeaderMatch; // ignore: deprecated_member_use
  $pb.BuilderInfo get info_ => _i;
  @$core.pragma('dart2js:noInline')
...
class AuthorizationPolicy_Rule_Destination extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'AuthorizationPolicy.Rule.Destination', package: const $pb.PackageName(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'google.cloud.networksecurity.v1beta1'), createEmptyInstance: create)
    ..pPS(1, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'hosts')
    ..p<$core.int>(2, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'ports', $pb.PbFieldType.PU3)
    ..pPS(4, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'methods')
    ..aOM<AuthorizationPolicy_Rule_Destination_HttpHeaderMatch>(5, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'httpHeaderMatch', subBuilder: AuthorizationPolicy_Rule_Destination_HttpHeaderMatch.create)
    ..hasRequiredFields = false
  ;
  ...
  'Use [GeneratedMessageGenericExtensions.rebuild] instead. '
  'Will be removed in next major version')
  AuthorizationPolicy_Rule_Destination copyWith(void Function(AuthorizationPolicy_Rule_Destination) updates) => super.copyWith((message) => updates(message as AuthorizationPolicy_Rule_Destination)) as AuthorizationPolicy_Rule_Destination; // ignore: deprecated_member_use
  $pb.BuilderInfo get info_ => _i;
  @$core.pragma('dart2js:noInline')
...
class AuthorizationPolicy_Rule extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'AuthorizationPolicy.Rule', package: const $pb.PackageName(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'google.cloud.networksecurity.v1beta1'), createEmptyInstance: create)
    ..pc<AuthorizationPolicy_Rule_Source>(1, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'sources', $pb.PbFieldType.PM, subBuilder: AuthorizationPolicy_Rule_Source.create)
    ..pc<AuthorizationPolicy_Rule_Destination>(2, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'destinations', $pb.PbFieldType.PM, subBuilder: AuthorizationPolicy_Rule_Destination.create)
    ..hasRequiredFields = false
  ;
  ...
  'Use [GeneratedMessageGenericExtensions.rebuild] instead. '
  'Will be removed in next major version')
  AuthorizationPolicy_Rule copyWith(void Function(AuthorizationPolicy_Rule) updates) => super.copyWith((message) => updates(message as AuthorizationPolicy_Rule)) as AuthorizationPolicy_Rule; // ignore: deprecated_member_use
  $pb.BuilderInfo get info_ => _i;
  @$core.pragma('dart2js:noInline')
...
class AuthorizationPolicy extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'AuthorizationPolicy', package: const $pb.PackageName(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'google.cloud.networksecurity.v1beta1'), createEmptyInstance: create)
    ...
    ..m<$core.String, $core.String>(5, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'labels', entryClassName: 'AuthorizationPolicy.LabelsEntry', keyFieldType: $pb.PbFieldType.OS, valueFieldType: $pb.PbFieldType.OS, packageName: const $pb.PackageName('google.cloud.networksecurity.v1beta1'))
    ..e<AuthorizationPolicy_Action>(6, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'action', $pb.PbFieldType.OE, defaultOrMaker: AuthorizationPolicy_Action.ACTION_UNSPECIFIED, valueOf: AuthorizationPolicy_Action.valueOf, enumValues: AuthorizationPolicy_Action.values)
    ..pc<AuthorizationPolicy_Rule>(7, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'rules', $pb.PbFieldType.PM, subBuilder: AuthorizationPolicy_Rule.create)
    ..hasRequiredFields = false
  ;
  ...
  'Use [GeneratedMessageGenericExtensions.rebuild] instead. '
  'Will be removed in next major version')
  AuthorizationPolicy copyWith(void Function(AuthorizationPolicy) updates) => super.copyWith((message) => updates(message as AuthorizationPolicy)) as AuthorizationPolicy; // ignore: deprecated_member_use
  $pb.BuilderInfo get info_ => _i;
  @$core.pragma('dart2js:noInline')
...
class ListAuthorizationPoliciesRequest extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'ListAuthorizationPoliciesRequest', package: const $pb.PackageName(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'google.cloud.networksecurity.v1beta1'), createEmptyInstance: create)
  ...
  'Use [GeneratedMessageGenericExtensions.rebuild] instead. '
  'Will be removed in next major version')
  ListAuthorizationPoliciesRequest copyWith(void Function(ListAuthorizationPoliciesRequest) updates) => super.copyWith((message) => updates(message as ListAuthorizationPoliciesRequest)) as ListAuthorizationPoliciesRequest; // ignore: deprecated_member_use
  $pb.BuilderInfo get info_ => _i;
  @$core.pragma('dart2js:noInline')
...
class ListAuthorizationPoliciesResponse extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'ListAuthorizationPoliciesResponse', package: const $pb.PackageName(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'google.cloud.networksecurity.v1beta1'), createEmptyInstance: create)
    ..pc<AuthorizationPolicy>(1, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'authorizationPolicies', $pb.PbFieldType.PM, subBuilder: AuthorizationPolicy.create)
  ...
  'Use [GeneratedMessageGenericExtensions.rebuild] instead. '
  'Will be removed in next major version')
  ListAuthorizationPoliciesResponse copyWith(void Function(ListAuthorizationPoliciesResponse) updates) => super.copyWith((message) => updates(message as ListAuthorizationPoliciesResponse)) as ListAuthorizationPoliciesResponse; // ignore: deprecated_member_use
  $pb.BuilderInfo get info_ => _i;
  @$core.pragma('dart2js:noInline')
...
class GetAuthorizationPolicyRequest extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'GetAuthorizationPolicyRequest', package: const $pb.PackageName(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'google.cloud.networksecurity.v1beta1'), createEmptyInstance: create)
    ..aOS(1, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'name')
    ..hasRequiredFields = false
  ;
  ...
  'Use [GeneratedMessageGenericExtensions.rebuild] instead. '
  'Will be removed in next major version')
  GetAuthorizationPolicyRequest copyWith(void Function(GetAuthorizationPolicyRequest) updates) => super.copyWith((message) => updates(message as GetAuthorizationPolicyRequest)) as GetAuthorizationPolicyRequest; // ignore: deprecated_member_use
  $pb.BuilderInfo get info_ => _i;
  @$core.pragma('dart2js:noInline')
...
class CreateAuthorizationPolicyRequest extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'CreateAuthorizationPolicyRequest', package: const $pb.PackageName(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'google.cloud.networksecurity.v1beta1'), createEmptyInstance: create)
    ..aOS(1, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'parent')
    ..aOS(2, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'authorizationPolicyId')
    ..aOM<AuthorizationPolicy>(3, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'authorizationPolicy', subBuilder: AuthorizationPolicy.create)
    ..hasRequiredFields = false
  ;
  ...
  'Use [GeneratedMessageGenericExtensions.rebuild] instead. '
  'Will be removed in next major version')
  CreateAuthorizationPolicyRequest copyWith(void Function(CreateAuthorizationPolicyRequest) updates) => super.copyWith((message) => updates(message as CreateAuthorizationPolicyRequest)) as CreateAuthorizationPolicyRequest; // ignore: deprecated_member_use
  $pb.BuilderInfo get info_ => _i;
  @$core.pragma('dart2js:noInline')
...
class UpdateAuthorizationPolicyRequest extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'UpdateAuthorizationPolicyRequest', package: const $pb.PackageName(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'google.cloud.networksecurity.v1beta1'), createEmptyInstance: create)
    ..aOM<$1.FieldMask>(1, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'updateMask', subBuilder: $1.FieldMask.create)
    ..aOM<AuthorizationPolicy>(2, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'authorizationPolicy', subBuilder: AuthorizationPolicy.create)
    ..hasRequiredFields = false
  ;
  ...
  'Use [GeneratedMessageGenericExtensions.rebuild] instead. '
  'Will be removed in next major version')
  UpdateAuthorizationPolicyRequest copyWith(void Function(UpdateAuthorizationPolicyRequest) updates) => super.copyWith((message) => updates(message as UpdateAuthorizationPolicyRequest)) as UpdateAuthorizationPolicyRequest; // ignore: deprecated_member_use
  $pb.BuilderInfo get info_ => _i;
  @$core.pragma('dart2js:noInline')
...
class DeleteAuthorizationPolicyRequest extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'DeleteAuthorizationPolicyRequest', package: const $pb.PackageName(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'google.cloud.networksecurity.v1beta1'), createEmptyInstance: create)
    ..aOS(1, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'name')
    ..hasRequiredFields = false
  ;
  ...
  'Use [GeneratedMessageGenericExtensions.rebuild] instead. '
  'Will be removed in next major version')
  DeleteAuthorizationPolicyRequest copyWith(void Function(DeleteAuthorizationPolicyRequest) updates) => super.copyWith((message) => updates(message as DeleteAuthorizationPolicyRequest)) as DeleteAuthorizationPolicyRequest; // ignore: deprecated_member_use
  $pb.BuilderInfo get info_ => _i;
  @$core.pragma('dart2js:noInline')

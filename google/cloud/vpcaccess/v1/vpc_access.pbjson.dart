...
const Connector$json = const {
  ...
  '2': const [
    ...
    const {'1': 'state', '3': 4, '4': 1, '5': 14, '6': '.google.cloud.vpcaccess.v1.Connector.State', '8': const {}, '10': 'state'},
    const {'1': 'min_throughput', '3': 5, '4': 1, '5': 5, '10': 'minThroughput'},
    const {'1': 'max_throughput', '3': 6, '4': 1, '5': 5, '10': 'maxThroughput'},
    const {'1': 'connected_projects', '3': 7, '4': 3, '5': 9, '8': const {}, '10': 'connectedProjects'},
    const {'1': 'subnet', '3': 8, '4': 1, '5': 11, '6': '.google.cloud.vpcaccess.v1.Connector.Subnet', '10': 'subnet'},
  ],
...
const CreateConnectorRequest$json = const {
  ...
  '2': const [
    ...
    const {'1': 'connector_id', '3': 2, '4': 1, '5': 9, '8': const {}, '10': 'connectorId'},
    const {'1': 'connector', '3': 3, '4': 1, '5': 11, '6': '.google.cloud.vpcaccess.v1.Connector', '8': const {}, '10': 'connector'},
  ],
};

/// Descriptor for `CreateConnectorRequest`. Decode as a `google.protobuf.DescriptorProto`.
final $typed_data.Uint8List createConnectorRequestDescriptor = $convert.base64Decode('');
...
final $typed_data.Uint8List getConnectorRequestDescriptor = $convert.base64Decode('ChNHZXRDb25uZWN0b3JSZXF1ZXN0Ej4KBG5hbWUYASABKAlCKuBBAvpBJAoidnBjYWNjZXNzLmdvb2dsZWFwaXMuY29tL0Nvbm5lY3RvclIEbmFtZQ==');
...
final $typed_data.Uint8List listConnectorsRequestDescriptor = $convert.base64Decode('ChVMaXN0Q29ubmVjdG9yc1JlcXVlc3QSQQoGcGFyZW50GAEgASgJQingQQL6QSMKIWxvY2F0aW9ucy5nb29nbGVhcGlzLmNvbS9Mb2NhdGlvblIGcGFyZW50EhsKCXBhZ2Vfc2l6ZRgCIAEoBVIIcGFnZVNpemUSHQoKcGFnZV90b2tlbhgDIAEoCVIJcGFnZVRva2Vu');
...
const ListConnectorsResponse$json = const {
  ...
  '2': const [
    const {'1': 'connectors', '3': 1, '4': 3, '5': 11, '6': '.google.cloud.vpcaccess.v1.Connector', '10': 'connectors'},
    const {'1': 'next_page_token', '3': 2, '4': 1, '5': 9, '10': 'nextPageToken'},
  ],
};

/// Descriptor for `ListConnectorsResponse`. Decode as a `google.protobuf.DescriptorProto`.
final $typed_data.Uint8List listConnectorsResponseDescriptor = $convert.base64Decode('ChZMaXN0Q29ubmVjdG9yc1Jlc3BvbnNlEkQKCmNvbm5lY3RvcnMYASADKAsyJC5nb29nbGUuY2xvdWQudnBjYWNjZXNzLnYxLkNvbm5lY3RvclIKY29ubmVjdG9ycxImCg9uZXh0X3BhZ2VfdG9rZW4YAiABKAlSDW5leHRQYWdlVG9rZW4=');
...
final $typed_data.Uint8List deleteConnectorRequestDescriptor = $convert.base64Decode('ChZEZWxldGVDb25uZWN0b3JSZXF1ZXN0Ej4KBG5hbWUYASABKAlCKuBBAvpBJAoidnBjYWNjZXNzLmdvb2dsZWFwaXMuY29tL0Nvbm5lY3RvclIEbmFtZQ==');
@$core.Deprecated('Use operationMetadataDescriptor instead')
const OperationMetadata$json = const {
  '1': 'OperationMetadata',
  '2': const [
    const {'1': 'method', '3': 1, '4': 1, '5': 9, '8': const {}, '10': 'method'},

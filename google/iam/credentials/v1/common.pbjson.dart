...
final $typed_data.Uint8List generateAccessTokenResponseDescriptor = $convert.base64Decode('ChtHZW5lcmF0ZUFjY2Vzc1Rva2VuUmVzcG9uc2USIQoMYWNjZXNzX3Rva2VuGAEgASgJUgthY2Nlc3NUb2tlbhI7CgtleHBpcmVfdGltZRgDIAEoCzIaLmdvb2dsZS5wcm90b2J1Zi5UaW1lc3RhbXBSCmV4cGlyZVRpbWU=');
...
const SignBlobRequest$json = const {
  ...
  '2': const [
    ...
    const {'1': 'payload', '3': 5, '4': 1, '5': 12, '8': const {}, '10': 'payload'},
  ],
};

/// Descriptor for `SignBlobRequest`. Decode as a `google.protobuf.DescriptorProto`.
final $typed_data.Uint8List signBlobRequestDescriptor = $convert.base64Decode('Cg9TaWduQmxvYlJlcXVlc3QSPQoEbmFtZRgBIAEoCUIp4EEC+kEjCiFpYW0uZ29vZ2xlYXBpcy5jb20vU2VydmljZUFjY291bnRSBG5hbWUSHAoJZGVsZWdhdGVzGAMgAygJUglkZWxlZ2F0ZXMSHQoHcGF5bG9hZBgFIAEoDEID4EECUgdwYXlsb2Fk');
...
final $typed_data.Uint8List signBlobResponseDescriptor = $convert.base64Decode('ChBTaWduQmxvYlJlc3BvbnNlEhUKBmtleV9pZBgBIAEoCVIFa2V5SWQSHwoLc2lnbmVkX2Jsb2IYBCABKAxSCnNpZ25lZEJsb2I=');
...
const SignJwtRequest$json = const {
  ...
  '2': const [
    const {'1': 'name', '3': 1, '4': 1, '5': 9, '8': const {}, '10': 'name'},
    const {'1': 'delegates', '3': 3, '4': 3, '5': 9, '10': 'delegates'},
    const {'1': 'payload', '3': 5, '4': 1, '5': 9, '8': const {}, '10': 'payload'},
  ],
};

/// Descriptor for `SignJwtRequest`. Decode as a `google.protobuf.DescriptorProto`.
final $typed_data.Uint8List signJwtRequestDescriptor = $convert.base64Decode('Cg5TaWduSnd0UmVxdWVzdBI9CgRuYW1lGAEgASgJQingQQL6QSMKIWlhbS5nb29nbGVhcGlzLmNvbS9TZXJ2aWNlQWNjb3VudFIEbmFtZRIcCglkZWxlZ2F0ZXMYAyADKAlSCWRlbGVnYXRlcxIdCgdwYXlsb2FkGAUgASgJQgPgQQJSB3BheWxvYWQ=');
...
final $typed_data.Uint8List signJwtResponseDescriptor = $convert.base64Decode('Cg9TaWduSnd0UmVzcG9uc2USFQoGa2V5X2lkGAEgASgJUgVrZXlJZBIdCgpzaWduZWRfand0GAIgASgJUglzaWduZWRKd3Q=');
...
const GenerateIdTokenRequest$json = const {
  ...
  '2': const [
    const {'1': 'name', '3': 1, '4': 1, '5': 9, '8': const {}, '10': 'name'},
    const {'1': 'delegates', '3': 2, '4': 3, '5': 9, '10': 'delegates'},
    const {'1': 'audience', '3': 3, '4': 1, '5': 9, '8': const {}, '10': 'audience'},
...
final $typed_data.Uint8List generateIdTokenRequestDescriptor = $convert.base64Decode('ChZHZW5lcmF0ZUlkVG9rZW5SZXF1ZXN0Ej0KBG5hbWUYASABKAlCKeBBAvpBIwohaWFtLmdvb2dsZWFwaXMuY29tL1NlcnZpY2VBY2NvdW50UgRuYW1lEhwKCWRlbGVnYXRlcxgCIAMoCVIJZGVsZWdhdGVzEh8KCGF1ZGllbmNlGAMgASgJQgPgQQJSCGF1ZGllbmNlEiMKDWluY2x1ZGVfZW1haWwYBCABKAhSDGluY2x1ZGVFbWFpbA==');
...
final $typed_data.Uint8List generateIdTokenResponseDescriptor = $convert.base64Decode('ChdHZW5lcmF0ZUlkVG9rZW5SZXNwb25zZRIUCgV0b2tlbhgBIAEoCVIFdG9rZW4=');

...
class Policy extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'Policy', package: const $pb.PackageName(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'google.iam.v1'), createEmptyInstance: create)
    ..a<$core.int>(1, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'version', $pb.PbFieldType.O3)
    ..a<$core.List<$core.int>>(3, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'etag', $pb.PbFieldType.OY)
    ..pc<Binding>(4, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'bindings', $pb.PbFieldType.PM, subBuilder: Binding.create)
    ..pc<AuditConfig>(6, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'auditConfigs', $pb.PbFieldType.PM, subBuilder: AuditConfig.create)
...
class Binding extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'Binding', package: const $pb.PackageName(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'google.iam.v1'), createEmptyInstance: create)
    ...
    ..aOM<$0.Expr>(3, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'condition', subBuilder: $0.Expr.create)
    ..hasRequiredFields = false
  ;
  ...
  'Use [GeneratedMessageGenericExtensions.rebuild] instead. '
  'Will be removed in next major version')
  Binding copyWith(void Function(Binding) updates) => super.copyWith((message) => updates(message as Binding)) as Binding; // ignore: deprecated_member_use
  $pb.BuilderInfo get info_ => _i;
  @$core.pragma('dart2js:noInline')
...
class AuditConfig extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'AuditConfig', package: const $pb.PackageName(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'google.iam.v1'), createEmptyInstance: create)
    ..aOS(1, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'service')
    ..pc<AuditLogConfig>(3, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'auditLogConfigs', $pb.PbFieldType.PM, subBuilder: AuditLogConfig.create)
    ..hasRequiredFields = false
  ;
  ...
  'Use [GeneratedMessageGenericExtensions.rebuild] instead. '
  'Will be removed in next major version')
  AuditConfig copyWith(void Function(AuditConfig) updates) => super.copyWith((message) => updates(message as AuditConfig)) as AuditConfig; // ignore: deprecated_member_use
  $pb.BuilderInfo get info_ => _i;
  @$core.pragma('dart2js:noInline')
...
class AuditLogConfig extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'AuditLogConfig', package: const $pb.PackageName(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'google.iam.v1'), createEmptyInstance: create)
    ..e<AuditLogConfig_LogType>(1, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'logType', $pb.PbFieldType.OE, defaultOrMaker: AuditLogConfig_LogType.LOG_TYPE_UNSPECIFIED, valueOf: AuditLogConfig_LogType.valueOf, enumValues: AuditLogConfig_LogType.values)
    ..pPS(2, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'exemptedMembers')
    ..hasRequiredFields = false
  ;
  ...
  'Use [GeneratedMessageGenericExtensions.rebuild] instead. '
  'Will be removed in next major version')
  AuditLogConfig copyWith(void Function(AuditLogConfig) updates) => super.copyWith((message) => updates(message as AuditLogConfig)) as AuditLogConfig; // ignore: deprecated_member_use
  $pb.BuilderInfo get info_ => _i;
  @$core.pragma('dart2js:noInline')
...
class PolicyDelta extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'PolicyDelta', package: const $pb.PackageName(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'google.iam.v1'), createEmptyInstance: create)
    ..pc<BindingDelta>(1, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'bindingDeltas', $pb.PbFieldType.PM, subBuilder: BindingDelta.create)
    ..pc<AuditConfigDelta>(2, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'auditConfigDeltas', $pb.PbFieldType.PM, subBuilder: AuditConfigDelta.create)
    ..hasRequiredFields = false
  ;
  ...
  'Use [GeneratedMessageGenericExtensions.rebuild] instead. '
  'Will be removed in next major version')
  PolicyDelta copyWith(void Function(PolicyDelta) updates) => super.copyWith((message) => updates(message as PolicyDelta)) as PolicyDelta; // ignore: deprecated_member_use
  $pb.BuilderInfo get info_ => _i;
  @$core.pragma('dart2js:noInline')
...
class BindingDelta extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'BindingDelta', package: const $pb.PackageName(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'google.iam.v1'), createEmptyInstance: create)
    ..e<BindingDelta_Action>(1, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'action', $pb.PbFieldType.OE, defaultOrMaker: BindingDelta_Action.ACTION_UNSPECIFIED, valueOf: BindingDelta_Action.valueOf, enumValues: BindingDelta_Action.values)
  ...
  'Use [GeneratedMessageGenericExtensions.rebuild] instead. '
  'Will be removed in next major version')
  BindingDelta copyWith(void Function(BindingDelta) updates) => super.copyWith((message) => updates(message as BindingDelta)) as BindingDelta; // ignore: deprecated_member_use
  $pb.BuilderInfo get info_ => _i;
  @$core.pragma('dart2js:noInline')
...
class AuditConfigDelta extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'AuditConfigDelta', package: const $pb.PackageName(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'google.iam.v1'), createEmptyInstance: create)
    ..e<AuditConfigDelta_Action>(1, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'action', $pb.PbFieldType.OE, defaultOrMaker: AuditConfigDelta_Action.ACTION_UNSPECIFIED, valueOf: AuditConfigDelta_Action.valueOf, enumValues: AuditConfigDelta_Action.values)
  ...
  'Use [GeneratedMessageGenericExtensions.rebuild] instead. '
  'Will be removed in next major version')
  AuditConfigDelta copyWith(void Function(AuditConfigDelta) updates) => super.copyWith((message) => updates(message as AuditConfigDelta)) as AuditConfigDelta; // ignore: deprecated_member_use
  $pb.BuilderInfo get info_ => _i;
  @$core.pragma('dart2js:noInline')

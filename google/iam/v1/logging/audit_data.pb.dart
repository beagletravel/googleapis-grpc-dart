...
class AuditData extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'AuditData', package: const $pb.PackageName(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'google.iam.v1.logging'), createEmptyInstance: create)
    ..aOM<$0.PolicyDelta>(2, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'policyDelta', subBuilder: $0.PolicyDelta.create)
  ...
  @$pb.TagNumber(2)
  set policyDelta($0.PolicyDelta v) { setField(2, v); }
  @$pb.TagNumber(2)

...
const Policy$json = const {
  ...
  '2': const [
    ...
    const {'1': 'audit_configs', '3': 6, '4': 3, '5': 11, '6': '.google.iam.v1.AuditConfig', '10': 'auditConfigs'},
    const {'1': 'etag', '3': 3, '4': 1, '5': 12, '10': 'etag'},
  ],
};

/// Descriptor for `Policy`. Decode as a `google.protobuf.DescriptorProto`.
final $typed_data.Uint8List policyDescriptor = $convert.base64Decode('CgZQb2xpY3kSGAoHdmVyc2lvbhgBIAEoBVIHdmVyc2lvbhIyCghiaW5kaW5ncxgEIAMoCzIWLmdvb2dsZS5pYW0udjEuQmluZGluZ1IIYmluZGluZ3MSPwoNYXVkaXRfY29uZmlncxgGIAMoCzIaLmdvb2dsZS5pYW0udjEuQXVkaXRDb25maWdSDGF1ZGl0Q29uZmlncxISCgRldGFnGAMgASgMUgRldGFn');
...
final $typed_data.Uint8List bindingDescriptor = $convert.base64Decode('CgdCaW5kaW5nEhIKBHJvbGUYASABKAlSBHJvbGUSGAoHbWVtYmVycxgCIAMoCVIHbWVtYmVycxIvCgljb25kaXRpb24YAyABKAsyES5nb29nbGUudHlwZS5FeHByUgljb25kaXRpb24=');
@$core.Deprecated('Use auditConfigDescriptor instead')
const AuditConfig$json = const {
  '1': 'AuditConfig',
  '2': const [
    const {'1': 'service', '3': 1, '4': 1, '5': 9, '10': 'service'},
    const {'1': 'audit_log_configs', '3': 3, '4': 3, '5': 11, '6': '.google.iam.v1.AuditLogConfig', '10': 'auditLogConfigs'},
  ],
};

/// Descriptor for `AuditConfig`. Decode as a `google.protobuf.DescriptorProto`.
final $typed_data.Uint8List auditConfigDescriptor = $convert.base64Decode('CgtBdWRpdENvbmZpZxIYCgdzZXJ2aWNlGAEgASgJUgdzZXJ2aWNlEkkKEWF1ZGl0X2xvZ19jb25maWdzGAMgAygLMh0uZ29vZ2xlLmlhbS52MS5BdWRpdExvZ0NvbmZpZ1IPYXVkaXRMb2dDb25maWdz');
@$core.Deprecated('Use auditLogConfigDescriptor instead')
const AuditLogConfig$json = const {
  '1': 'AuditLogConfig',
  '2': const [
    const {'1': 'log_type', '3': 1, '4': 1, '5': 14, '6': '.google.iam.v1.AuditLogConfig.LogType', '10': 'logType'},
    const {'1': 'exempted_members', '3': 2, '4': 3, '5': 9, '10': 'exemptedMembers'},
  ],
...
final $typed_data.Uint8List auditLogConfigDescriptor = $convert.base64Decode('');
...
final $typed_data.Uint8List policyDeltaDescriptor = $convert.base64Decode('CgtQb2xpY3lEZWx0YRJCCg5iaW5kaW5nX2RlbHRhcxgBIAMoCzIbLmdvb2dsZS5pYW0udjEuQmluZGluZ0RlbHRhUg1iaW5kaW5nRGVsdGFzEk8KE2F1ZGl0X2NvbmZpZ19kZWx0YXMYAiADKAsyHy5nb29nbGUuaWFtLnYxLkF1ZGl0Q29uZmlnRGVsdGFSEWF1ZGl0Q29uZmlnRGVsdGFz');
...
final $typed_data.Uint8List auditConfigDeltaDescriptor = $convert.base64Decode('');

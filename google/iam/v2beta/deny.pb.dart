...
class DenyRule extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'DenyRule', package: const $pb.PackageName(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'google.iam.v2beta'), createEmptyInstance: create)
    ..pPS(1, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'deniedPrincipals')
    ..pPS(2, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'exceptionPrincipals')
    ..pPS(3, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'deniedPermissions')
    ..pPS(4, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'exceptionPermissions')
    ..aOM<$0.Expr>(5, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'denialCondition', subBuilder: $0.Expr.create)
  ...
  'Will be removed in next major version')
  DenyRule copyWith(void Function(DenyRule) updates) => super.copyWith((message) => updates(message as DenyRule)) as DenyRule; // ignore: deprecated_member_use
  ...
  @$pb.TagNumber(5)
  set denialCondition($0.Expr v) { setField(5, v); }
  @$pb.TagNumber(5)

...
class AuditData_PermissionDelta extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'AuditData.PermissionDelta', package: const $pb.PackageName(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'google.iam.admin.v1'), createEmptyInstance: create)
    ..pPS(1, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'addedPermissions')
    ..pPS(2, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'removedPermissions')
  ...
  'Will be removed in next major version')
  AuditData_PermissionDelta copyWith(void Function(AuditData_PermissionDelta) updates) => super.copyWith((message) => updates(message as AuditData_PermissionDelta)) as AuditData_PermissionDelta; // ignore: deprecated_member_use
...
class AuditData extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'AuditData', package: const $pb.PackageName(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'google.iam.admin.v1'), createEmptyInstance: create)
    ..aOM<AuditData_PermissionDelta>(1, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'permissionDelta', subBuilder: AuditData_PermissionDelta.create)
    ..hasRequiredFields = false
  ;

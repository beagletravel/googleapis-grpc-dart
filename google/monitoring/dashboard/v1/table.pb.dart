...
class TimeSeriesTable_TableDataSet extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'TimeSeriesTable.TableDataSet', package: const $pb.PackageName(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'google.monitoring.dashboard.v1'), createEmptyInstance: create)
    ...
    ..aOS(2, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'tableTemplate')
    ..aOM<$1.Duration>(3, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'minAlignmentPeriod', subBuilder: $1.Duration.create)
    ..aOM<$2.TableDisplayOptions>(4, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'tableDisplayOptions', subBuilder: $2.TableDisplayOptions.create)
  ...
  'Will be removed in next major version')
  TimeSeriesTable_TableDataSet copyWith(void Function(TimeSeriesTable_TableDataSet) updates) => super.copyWith((message) => updates(message as TimeSeriesTable_TableDataSet)) as TimeSeriesTable_TableDataSet; // ignore: deprecated_member_use
  ...
  @$pb.TagNumber(3)
  set minAlignmentPeriod($1.Duration v) { setField(3, v); }
  @$pb.TagNumber(3)
  ...
  @$pb.TagNumber(4)
  set tableDisplayOptions($2.TableDisplayOptions v) { setField(4, v); }
  @$pb.TagNumber(4)
...
class TimeSeriesTable extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'TimeSeriesTable', package: const $pb.PackageName(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'google.monitoring.dashboard.v1'), createEmptyInstance: create)
    ..pc<TimeSeriesTable_TableDataSet>(1, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'dataSets', $pb.PbFieldType.PM, subBuilder: TimeSeriesTable_TableDataSet.create)
    ..hasRequiredFields = false
  ;
  ...
  'Use [GeneratedMessageGenericExtensions.rebuild] instead. '
  'Will be removed in next major version')
  TimeSeriesTable copyWith(void Function(TimeSeriesTable) updates) => super.copyWith((message) => updates(message as TimeSeriesTable)) as TimeSeriesTable; // ignore: deprecated_member_use
  $pb.BuilderInfo get info_ => _i;
  @$core.pragma('dart2js:noInline')

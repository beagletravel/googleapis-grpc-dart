...
class PickTimeSeriesFilter_Method extends $pb.ProtobufEnum {
  static const PickTimeSeriesFilter_Method METHOD_UNSPECIFIED = PickTimeSeriesFilter_Method._(0, const $core.bool.fromEnvironment('protobuf.omit_enum_names') ? '' : 'METHOD_UNSPECIFIED');
  static const PickTimeSeriesFilter_Method METHOD_MEAN = PickTimeSeriesFilter_Method._(1, const $core.bool.fromEnvironment('protobuf.omit_enum_names') ? '' : 'METHOD_MEAN');
  static const PickTimeSeriesFilter_Method METHOD_MAX = PickTimeSeriesFilter_Method._(2, const $core.bool.fromEnvironment('protobuf.omit_enum_names') ? '' : 'METHOD_MAX');
  static const PickTimeSeriesFilter_Method METHOD_MIN = PickTimeSeriesFilter_Method._(3, const $core.bool.fromEnvironment('protobuf.omit_enum_names') ? '' : 'METHOD_MIN');
  static const PickTimeSeriesFilter_Method METHOD_SUM = PickTimeSeriesFilter_Method._(4, const $core.bool.fromEnvironment('protobuf.omit_enum_names') ? '' : 'METHOD_SUM');
  static const PickTimeSeriesFilter_Method METHOD_LATEST = PickTimeSeriesFilter_Method._(5, const $core.bool.fromEnvironment('protobuf.omit_enum_names') ? '' : 'METHOD_LATEST');

  static const $core.List<PickTimeSeriesFilter_Method> values = <PickTimeSeriesFilter_Method> [
    METHOD_UNSPECIFIED,
    METHOD_MEAN,
    METHOD_MAX,
    METHOD_MIN,
  ...
  static final $core.Map<$core.int, PickTimeSeriesFilter_Method> _byValue = $pb.ProtobufEnum.initByValue(values);
  static PickTimeSeriesFilter_Method? valueOf($core.int value) => _byValue[value];

  const PickTimeSeriesFilter_Method._($core.int v, $core.String n) : super(v, n);
}

class PickTimeSeriesFilter_Direction extends $pb.ProtobufEnum {
  static const PickTimeSeriesFilter_Direction DIRECTION_UNSPECIFIED = PickTimeSeriesFilter_Direction._(0, const $core.bool.fromEnvironment('protobuf.omit_enum_names') ? '' : 'DIRECTION_UNSPECIFIED');
  static const PickTimeSeriesFilter_Direction TOP = PickTimeSeriesFilter_Direction._(1, const $core.bool.fromEnvironment('protobuf.omit_enum_names') ? '' : 'TOP');
  static const PickTimeSeriesFilter_Direction BOTTOM = PickTimeSeriesFilter_Direction._(2, const $core.bool.fromEnvironment('protobuf.omit_enum_names') ? '' : 'BOTTOM');

  static const $core.List<PickTimeSeriesFilter_Direction> values = <PickTimeSeriesFilter_Direction> [
    DIRECTION_UNSPECIFIED,
    TOP,
    BOTTOM,
  ];

  static final $core.Map<$core.int, PickTimeSeriesFilter_Direction> _byValue = $pb.ProtobufEnum.initByValue(values);
  static PickTimeSeriesFilter_Direction? valueOf($core.int value) => _byValue[value];

  const PickTimeSeriesFilter_Direction._($core.int v, $core.String n) : super(v, n);
}

class StatisticalTimeSeriesFilter_Method extends $pb.ProtobufEnum {
  static const StatisticalTimeSeriesFilter_Method METHOD_UNSPECIFIED = StatisticalTimeSeriesFilter_Method._(0, const $core.bool.fromEnvironment('protobuf.omit_enum_names') ? '' : 'METHOD_UNSPECIFIED');
  static const StatisticalTimeSeriesFilter_Method METHOD_CLUSTER_OUTLIER = StatisticalTimeSeriesFilter_Method._(1, const $core.bool.fromEnvironment('protobuf.omit_enum_names') ? '' : 'METHOD_CLUSTER_OUTLIER');

  static const $core.List<StatisticalTimeSeriesFilter_Method> values = <StatisticalTimeSeriesFilter_Method> [
    METHOD_UNSPECIFIED,
    METHOD_CLUSTER_OUTLIER,
  ];

  static final $core.Map<$core.int, StatisticalTimeSeriesFilter_Method> _byValue = $pb.ProtobufEnum.initByValue(values);
  static StatisticalTimeSeriesFilter_Method? valueOf($core.int value) => _byValue[value];

  const StatisticalTimeSeriesFilter_Method._($core.int v, $core.String n) : super(v, n);
}

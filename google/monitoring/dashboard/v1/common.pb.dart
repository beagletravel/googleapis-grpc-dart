...
class Aggregation extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'Aggregation', package: const $pb.PackageName(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'google.monitoring.dashboard.v1'), createEmptyInstance: create)
    ..aOM<$0.Duration>(1, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'alignmentPeriod', subBuilder: $0.Duration.create)
    ..e<Aggregation_Aligner>(2, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'perSeriesAligner', $pb.PbFieldType.OE, defaultOrMaker: Aggregation_Aligner.ALIGN_NONE, valueOf: Aggregation_Aligner.valueOf, enumValues: Aggregation_Aligner.values)
    ..e<Aggregation_Reducer>(4, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'crossSeriesReducer', $pb.PbFieldType.OE, defaultOrMaker: Aggregation_Reducer.REDUCE_NONE, valueOf: Aggregation_Reducer.valueOf, enumValues: Aggregation_Reducer.values)
    ..pPS(5, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'groupByFields')
  ...
  'Will be removed in next major version')
  Aggregation copyWith(void Function(Aggregation) updates) => super.copyWith((message) => updates(message as Aggregation)) as Aggregation; // ignore: deprecated_member_use
  ...
  @$pb.TagNumber(1)
  set alignmentPeriod($0.Duration v) { setField(1, v); }
  @$pb.TagNumber(1)
...
class PickTimeSeriesFilter extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'PickTimeSeriesFilter', package: const $pb.PackageName(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'google.monitoring.dashboard.v1'), createEmptyInstance: create)
    ..e<PickTimeSeriesFilter_Method>(1, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'rankingMethod', $pb.PbFieldType.OE, defaultOrMaker: PickTimeSeriesFilter_Method.METHOD_UNSPECIFIED, valueOf: PickTimeSeriesFilter_Method.valueOf, enumValues: PickTimeSeriesFilter_Method.values)
    ..a<$core.int>(2, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'numTimeSeries', $pb.PbFieldType.O3)
    ..e<PickTimeSeriesFilter_Direction>(3, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'direction', $pb.PbFieldType.OE, defaultOrMaker: PickTimeSeriesFilter_Direction.DIRECTION_UNSPECIFIED, valueOf: PickTimeSeriesFilter_Direction.valueOf, enumValues: PickTimeSeriesFilter_Direction.values)
    ..hasRequiredFields = false
  ;
  ...
  'Use [GeneratedMessageGenericExtensions.rebuild] instead. '
  'Will be removed in next major version')
  PickTimeSeriesFilter copyWith(void Function(PickTimeSeriesFilter) updates) => super.copyWith((message) => updates(message as PickTimeSeriesFilter)) as PickTimeSeriesFilter; // ignore: deprecated_member_use
  $pb.BuilderInfo get info_ => _i;
  @$core.pragma('dart2js:noInline')
...
class StatisticalTimeSeriesFilter extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'StatisticalTimeSeriesFilter', package: const $pb.PackageName(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'google.monitoring.dashboard.v1'), createEmptyInstance: create)
    ..e<StatisticalTimeSeriesFilter_Method>(1, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'rankingMethod', $pb.PbFieldType.OE, defaultOrMaker: StatisticalTimeSeriesFilter_Method.METHOD_UNSPECIFIED, valueOf: StatisticalTimeSeriesFilter_Method.valueOf, enumValues: StatisticalTimeSeriesFilter_Method.values)
    ..a<$core.int>(2, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'numTimeSeries', $pb.PbFieldType.O3)
    ..hasRequiredFields = false
  ;
  ...
  'Use [GeneratedMessageGenericExtensions.rebuild] instead. '
  'Will be removed in next major version')
  StatisticalTimeSeriesFilter copyWith(void Function(StatisticalTimeSeriesFilter) updates) => super.copyWith((message) => updates(message as StatisticalTimeSeriesFilter)) as StatisticalTimeSeriesFilter; // ignore: deprecated_member_use
  $pb.BuilderInfo get info_ => _i;
  @$core.pragma('dart2js:noInline')

...
class DashboardFilter extends $pb.GeneratedMessage {
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'DashboardFilter', package: const $pb.PackageName(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'google.monitoring.dashboard.v1'), createEmptyInstance: create)
    ..oo(0, [4])
    ..aOS(1, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'labelKey')
    ..aOS(3, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'templateVariable')
    ..aOS(4, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'stringValue')
    ..e<DashboardFilter_FilterType>(5, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'filterType', $pb.PbFieldType.OE, defaultOrMaker: DashboardFilter_FilterType.FILTER_TYPE_UNSPECIFIED, valueOf: DashboardFilter_FilterType.valueOf, enumValues: DashboardFilter_FilterType.values)
  ...
  'Will be removed in next major version')
  DashboardFilter copyWith(void Function(DashboardFilter) updates) => super.copyWith((message) => updates(message as DashboardFilter)) as DashboardFilter; // ignore: deprecated_member_use

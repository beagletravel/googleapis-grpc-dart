...
class Widget extends $pb.GeneratedMessage {
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'Widget', package: const $pb.PackageName(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'google.monitoring.dashboard.v1'), createEmptyInstance: create)
    ..oo(0, [2, 3, 4, 5, 7, 8, 9, 10])
    ..aOS(1, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'title')
    ..aOM<$0.XyChart>(2, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'xyChart', subBuilder: $0.XyChart.create)
    ..aOM<$1.Scorecard>(3, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'scorecard', subBuilder: $1.Scorecard.create)
    ..aOM<$2.Text>(4, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'text', subBuilder: $2.Text.create)
    ..aOM<$3.Empty>(5, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'blank', subBuilder: $3.Empty.create)
    ..aOM<$4.AlertChart>(7, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'alertChart', subBuilder: $4.AlertChart.create)
    ..aOM<$5.TimeSeriesTable>(8, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'timeSeriesTable', subBuilder: $5.TimeSeriesTable.create)
    ..aOM<$6.CollapsibleGroup>(9, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'collapsibleGroup', subBuilder: $6.CollapsibleGroup.create)
    ..aOM<$7.LogsPanel>(10, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'logsPanel', subBuilder: $7.LogsPanel.create)
  ...
  @$pb.TagNumber(2)
  set xyChart($0.XyChart v) { setField(2, v); }
  @$pb.TagNumber(2)
  ...
  @$pb.TagNumber(3)
  set scorecard($1.Scorecard v) { setField(3, v); }
  @$pb.TagNumber(3)
  ...
  @$pb.TagNumber(4)
  set text($2.Text v) { setField(4, v); }
  @$pb.TagNumber(4)
  ...
  @$pb.TagNumber(7)
  set alertChart($4.AlertChart v) { setField(7, v); }
  @$pb.TagNumber(7)
  ...
  @$pb.TagNumber(8)
  set timeSeriesTable($5.TimeSeriesTable v) { setField(8, v); }
  @$pb.TagNumber(8)
  ...
  @$pb.TagNumber(9)
  set collapsibleGroup($6.CollapsibleGroup v) { setField(9, v); }
  @$pb.TagNumber(9)
  ...
  @$pb.TagNumber(10)
  set logsPanel($7.LogsPanel v) { setField(10, v); }
  @$pb.TagNumber(10)

...
class XyChart_DataSet extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'XyChart.DataSet', package: const $pb.PackageName(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'google.monitoring.dashboard.v1'), createEmptyInstance: create)
    ..aOM<$1.TimeSeriesQuery>(1, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'timeSeriesQuery', subBuilder: $1.TimeSeriesQuery.create)
    ..e<XyChart_DataSet_PlotType>(2, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'plotType', $pb.PbFieldType.OE, defaultOrMaker: XyChart_DataSet_PlotType.PLOT_TYPE_UNSPECIFIED, valueOf: XyChart_DataSet_PlotType.valueOf, enumValues: XyChart_DataSet_PlotType.values)
    ..aOS(3, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'legendTemplate')
    ..aOM<$0.Duration>(4, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'minAlignmentPeriod', subBuilder: $0.Duration.create)
    ..e<XyChart_DataSet_TargetAxis>(5, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'targetAxis', $pb.PbFieldType.OE, defaultOrMaker: XyChart_DataSet_TargetAxis.TARGET_AXIS_UNSPECIFIED, valueOf: XyChart_DataSet_TargetAxis.valueOf, enumValues: XyChart_DataSet_TargetAxis.values)
  ...
  'Will be removed in next major version')
  XyChart_DataSet copyWith(void Function(XyChart_DataSet) updates) => super.copyWith((message) => updates(message as XyChart_DataSet)) as XyChart_DataSet; // ignore: deprecated_member_use
  ...
  @$pb.TagNumber(1)
  set timeSeriesQuery($1.TimeSeriesQuery v) { setField(1, v); }
  @$pb.TagNumber(1)
  ...
  @$pb.TagNumber(4)
  set minAlignmentPeriod($0.Duration v) { setField(4, v); }
  @$pb.TagNumber(4)
...
class XyChart_Axis extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'XyChart.Axis', package: const $pb.PackageName(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'google.monitoring.dashboard.v1'), createEmptyInstance: create)
    ..aOS(1, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'label')
    ..e<XyChart_Axis_Scale>(2, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'scale', $pb.PbFieldType.OE, defaultOrMaker: XyChart_Axis_Scale.SCALE_UNSPECIFIED, valueOf: XyChart_Axis_Scale.valueOf, enumValues: XyChart_Axis_Scale.values)
    ..hasRequiredFields = false
  ;
  ...
  'Use [GeneratedMessageGenericExtensions.rebuild] instead. '
  'Will be removed in next major version')
  XyChart_Axis copyWith(void Function(XyChart_Axis) updates) => super.copyWith((message) => updates(message as XyChart_Axis)) as XyChart_Axis; // ignore: deprecated_member_use
  $pb.BuilderInfo get info_ => _i;
  @$core.pragma('dart2js:noInline')
...
class XyChart extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'XyChart', package: const $pb.PackageName(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'google.monitoring.dashboard.v1'), createEmptyInstance: create)
    ..pc<XyChart_DataSet>(1, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'dataSets', $pb.PbFieldType.PM, subBuilder: XyChart_DataSet.create)
    ..aOM<$0.Duration>(4, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'timeshiftDuration', subBuilder: $0.Duration.create)
    ..pc<$1.Threshold>(5, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'thresholds', $pb.PbFieldType.PM, subBuilder: $1.Threshold.create)
    ..aOM<XyChart_Axis>(6, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'xAxis', subBuilder: XyChart_Axis.create)
    ..aOM<XyChart_Axis>(7, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'yAxis', subBuilder: XyChart_Axis.create)
    ..aOM<ChartOptions>(8, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'chartOptions', subBuilder: ChartOptions.create)
    ..aOM<XyChart_Axis>(9, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'y2Axis', subBuilder: XyChart_Axis.create)
    ..hasRequiredFields = false
  ;
  ...
  'Use [GeneratedMessageGenericExtensions.rebuild] instead. '
  'Will be removed in next major version')
  XyChart copyWith(void Function(XyChart) updates) => super.copyWith((message) => updates(message as XyChart)) as XyChart; // ignore: deprecated_member_use
  $pb.BuilderInfo get info_ => _i;
  @$core.pragma('dart2js:noInline')
  ...
  @$pb.TagNumber(4)
  set timeshiftDuration($0.Duration v) { setField(4, v); }
  @$pb.TagNumber(4)
...
class ChartOptions extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'ChartOptions', package: const $pb.PackageName(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'google.monitoring.dashboard.v1'), createEmptyInstance: create)
    ..e<ChartOptions_Mode>(1, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'mode', $pb.PbFieldType.OE, defaultOrMaker: ChartOptions_Mode.MODE_UNSPECIFIED, valueOf: ChartOptions_Mode.valueOf, enumValues: ChartOptions_Mode.values)
    ..hasRequiredFields = false
  ;
  ...
  'Use [GeneratedMessageGenericExtensions.rebuild] instead. '
  'Will be removed in next major version')
  ChartOptions copyWith(void Function(ChartOptions) updates) => super.copyWith((message) => updates(message as ChartOptions)) as ChartOptions; // ignore: deprecated_member_use
  $pb.BuilderInfo get info_ => _i;
  @$core.pragma('dart2js:noInline')

...
class Dashboard extends $pb.GeneratedMessage {
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'Dashboard', package: const $pb.PackageName(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'google.monitoring.dashboard.v1'), createEmptyInstance: create)
    ..oo(0, [5, 6, 8, 9])
    ...
    ..aOM<$0.GridLayout>(5, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'gridLayout', subBuilder: $0.GridLayout.create)
    ..aOM<$0.MosaicLayout>(6, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'mosaicLayout', subBuilder: $0.MosaicLayout.create)
    ..aOM<$0.RowLayout>(8, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'rowLayout', subBuilder: $0.RowLayout.create)
    ..aOM<$0.ColumnLayout>(9, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'columnLayout', subBuilder: $0.ColumnLayout.create)
    ..pc<$1.DashboardFilter>(11, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'dashboardFilters', $pb.PbFieldType.PM, subBuilder: $1.DashboardFilter.create)
    ..m<$core.String, $core.String>(12, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'labels', entryClassName: 'Dashboard.LabelsEntry', keyFieldType: $pb.PbFieldType.OS, valueFieldType: $pb.PbFieldType.OS, packageName: const $pb.PackageName('google.monitoring.dashboard.v1'))
  ...
  @$pb.TagNumber(5)
  set gridLayout($0.GridLayout v) { setField(5, v); }
  @$pb.TagNumber(5)
  ...
  @$pb.TagNumber(6)
  set mosaicLayout($0.MosaicLayout v) { setField(6, v); }
  @$pb.TagNumber(6)
  ...
  @$pb.TagNumber(8)
  set rowLayout($0.RowLayout v) { setField(8, v); }
  @$pb.TagNumber(8)
  ...
  @$pb.TagNumber(9)
  set columnLayout($0.ColumnLayout v) { setField(9, v); }
  @$pb.TagNumber(9)

...
const XyChart$json = const {
  '1': 'XyChart',
  '2': const [
    const {'1': 'data_sets', '3': 1, '4': 3, '5': 11, '6': '.google.monitoring.dashboard.v1.XyChart.DataSet', '8': const {}, '10': 'dataSets'},
    const {'1': 'timeshift_duration', '3': 4, '4': 1, '5': 11, '6': '.google.protobuf.Duration', '10': 'timeshiftDuration'},
    const {'1': 'thresholds', '3': 5, '4': 3, '5': 11, '6': '.google.monitoring.dashboard.v1.Threshold', '10': 'thresholds'},
    const {'1': 'x_axis', '3': 6, '4': 1, '5': 11, '6': '.google.monitoring.dashboard.v1.XyChart.Axis', '10': 'xAxis'},
    const {'1': 'y_axis', '3': 7, '4': 1, '5': 11, '6': '.google.monitoring.dashboard.v1.XyChart.Axis', '10': 'yAxis'},
    const {'1': 'y2_axis', '3': 9, '4': 1, '5': 11, '6': '.google.monitoring.dashboard.v1.XyChart.Axis', '10': 'y2Axis'},
    const {'1': 'chart_options', '3': 8, '4': 1, '5': 11, '6': '.google.monitoring.dashboard.v1.ChartOptions', '10': 'chartOptions'},
  ],
...
const XyChart_DataSet$json = const {
  '1': 'DataSet',
  '2': const [
    const {'1': 'time_series_query', '3': 1, '4': 1, '5': 11, '6': '.google.monitoring.dashboard.v1.TimeSeriesQuery', '8': const {}, '10': 'timeSeriesQuery'},
    const {'1': 'plot_type', '3': 2, '4': 1, '5': 14, '6': '.google.monitoring.dashboard.v1.XyChart.DataSet.PlotType', '10': 'plotType'},
    const {'1': 'legend_template', '3': 3, '4': 1, '5': 9, '10': 'legendTemplate'},
    const {'1': 'min_alignment_period', '3': 4, '4': 1, '5': 11, '6': '.google.protobuf.Duration', '8': const {}, '10': 'minAlignmentPeriod'},
    const {'1': 'target_axis', '3': 5, '4': 1, '5': 14, '6': '.google.monitoring.dashboard.v1.XyChart.DataSet.TargetAxis', '8': const {}, '10': 'targetAxis'},
  ],
...
const XyChart_Axis$json = const {
  ...
  '2': const [
    ...
    const {'1': 'scale', '3': 2, '4': 1, '5': 14, '6': '.google.monitoring.dashboard.v1.XyChart.Axis.Scale', '10': 'scale'},
  ],
...
final $typed_data.Uint8List chartOptionsDescriptor = $convert.base64Decode('CgxDaGFydE9wdGlvbnMSRQoEbW9kZRgBIAEoDjIxLmdvb2dsZS5tb25pdG9yaW5nLmRhc2hib2FyZC52MS5DaGFydE9wdGlvbnMuTW9kZVIEbW9kZSI9CgRNb2RlEhQKEE1PREVfVU5TUEVDSUZJRUQQABIJCgVDT0xPUhABEgkKBVhfUkFZEAISCQoFU1RBVFMQAw==');

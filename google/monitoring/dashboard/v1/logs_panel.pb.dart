...
class LogsPanel extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'LogsPanel', package: const $pb.PackageName(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'google.monitoring.dashboard.v1'), createEmptyInstance: create)
  ...
  'Will be removed in next major version')
  LogsPanel copyWith(void Function(LogsPanel) updates) => super.copyWith((message) => updates(message as LogsPanel)) as LogsPanel; // ignore: deprecated_member_use

...
class NotificationChannelDescriptor extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'NotificationChannelDescriptor', package: const $pb.PackageName(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'google.monitoring.v3'), createEmptyInstance: create)
    ...
    ..pc<$3.ServiceTier>(5, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'supportedTiers', $pb.PbFieldType.PE, valueOf: $3.ServiceTier.valueOf, enumValues: $3.ServiceTier.values)
  ...
  'Will be removed in next major version')
  NotificationChannelDescriptor copyWith(void Function(NotificationChannelDescriptor) updates) => super.copyWith((message) => updates(message as NotificationChannelDescriptor)) as NotificationChannelDescriptor; // ignore: deprecated_member_use
...
class NotificationChannel extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'NotificationChannel', package: const $pb.PackageName(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'google.monitoring.v3'), createEmptyInstance: create)
    ..aOS(1, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'type')
    ..aOS(3, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'displayName')
    ..aOS(4, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'description')
    ..m<$core.String, $core.String>(5, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'labels', entryClassName: 'NotificationChannel.LabelsEntry', keyFieldType: $pb.PbFieldType.OS, valueFieldType: $pb.PbFieldType.OS, packageName: const $pb.PackageName('google.monitoring.v3'))
    ..aOS(6, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'name')
    ..m<$core.String, $core.String>(8, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'userLabels', entryClassName: 'NotificationChannel.UserLabelsEntry', keyFieldType: $pb.PbFieldType.OS, valueFieldType: $pb.PbFieldType.OS, packageName: const $pb.PackageName('google.monitoring.v3'))
    ..e<NotificationChannel_VerificationStatus>(9, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'verificationStatus', $pb.PbFieldType.OE, defaultOrMaker: NotificationChannel_VerificationStatus.VERIFICATION_STATUS_UNSPECIFIED, valueOf: NotificationChannel_VerificationStatus.valueOf, enumValues: NotificationChannel_VerificationStatus.values)
    ..aOM<$1.BoolValue>(11, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'enabled', subBuilder: $1.BoolValue.create)
    ..aOM<$2.MutationRecord>(12, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'creationRecord', subBuilder: $2.MutationRecord.create)
    ..pc<$2.MutationRecord>(13, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'mutationRecords', $pb.PbFieldType.PM, subBuilder: $2.MutationRecord.create)
    ..hasRequiredFields = false
  ;
  ...
  @$pb.TagNumber(11)
  set enabled($1.BoolValue v) { setField(11, v); }
  @$pb.TagNumber(11)
  ...
  @$pb.TagNumber(12)
  set creationRecord($2.MutationRecord v) { setField(12, v); }
  @$pb.TagNumber(12)

...
final $typed_data.Uint8List listNotificationChannelDescriptorsRequestDescriptor = $convert.base64Decode('CilMaXN0Tm90aWZpY2F0aW9uQ2hhbm5lbERlc2NyaXB0b3JzUmVxdWVzdBJTCgRuYW1lGAQgASgJQj/gQQL6QTkSN21vbml0b3JpbmcuZ29vZ2xlYXBpcy5jb20vTm90aWZpY2F0aW9uQ2hhbm5lbERlc2NyaXB0b3JSBG5hbWUSGwoJcGFnZV9zaXplGAIgASgFUghwYWdlU2l6ZRIdCgpwYWdlX3Rva2VuGAMgASgJUglwYWdlVG9rZW4=');
...
final $typed_data.Uint8List listNotificationChannelDescriptorsResponseDescriptor = $convert.base64Decode('CipMaXN0Tm90aWZpY2F0aW9uQ2hhbm5lbERlc2NyaXB0b3JzUmVzcG9uc2USZAoTY2hhbm5lbF9kZXNjcmlwdG9ycxgBIAMoCzIzLmdvb2dsZS5tb25pdG9yaW5nLnYzLk5vdGlmaWNhdGlvbkNoYW5uZWxEZXNjcmlwdG9yUhJjaGFubmVsRGVzY3JpcHRvcnMSJgoPbmV4dF9wYWdlX3Rva2VuGAIgASgJUg1uZXh0UGFnZVRva2Vu');
...
final $typed_data.Uint8List getNotificationChannelDescriptorRequestDescriptor = $convert.base64Decode('CidHZXROb3RpZmljYXRpb25DaGFubmVsRGVzY3JpcHRvclJlcXVlc3QSUwoEbmFtZRgDIAEoCUI/4EEC+kE5Cjdtb25pdG9yaW5nLmdvb2dsZWFwaXMuY29tL05vdGlmaWNhdGlvbkNoYW5uZWxEZXNjcmlwdG9yUgRuYW1l');
...
const CreateNotificationChannelRequest$json = const {
  ...
  '2': const [
    const {'1': 'name', '3': 3, '4': 1, '5': 9, '8': const {}, '10': 'name'},
    const {'1': 'notification_channel', '3': 2, '4': 1, '5': 11, '6': '.google.monitoring.v3.NotificationChannel', '8': const {}, '10': 'notificationChannel'},
  ],
};

/// Descriptor for `CreateNotificationChannelRequest`. Decode as a `google.protobuf.DescriptorProto`.
final $typed_data.Uint8List createNotificationChannelRequestDescriptor = $convert.base64Decode('');
...
final $typed_data.Uint8List listNotificationChannelsRequestDescriptor = $convert.base64Decode('');
...
final $typed_data.Uint8List listNotificationChannelsResponseDescriptor = $convert.base64Decode('');
...
final $typed_data.Uint8List getNotificationChannelRequestDescriptor = $convert.base64Decode('Ch1HZXROb3RpZmljYXRpb25DaGFubmVsUmVxdWVzdBJJCgRuYW1lGAMgASgJQjXgQQL6QS8KLW1vbml0b3JpbmcuZ29vZ2xlYXBpcy5jb20vTm90aWZpY2F0aW9uQ2hhbm5lbFIEbmFtZQ==');
...
const UpdateNotificationChannelRequest$json = const {
  ...
  '2': const [
    ...
    const {'1': 'notification_channel', '3': 3, '4': 1, '5': 11, '6': '.google.monitoring.v3.NotificationChannel', '8': const {}, '10': 'notificationChannel'},
  ],
};

/// Descriptor for `UpdateNotificationChannelRequest`. Decode as a `google.protobuf.DescriptorProto`.
final $typed_data.Uint8List updateNotificationChannelRequestDescriptor = $convert.base64Decode('');
...
final $typed_data.Uint8List deleteNotificationChannelRequestDescriptor = $convert.base64Decode('CiBEZWxldGVOb3RpZmljYXRpb25DaGFubmVsUmVxdWVzdBJJCgRuYW1lGAMgASgJQjXgQQL6QS8KLW1vbml0b3JpbmcuZ29vZ2xlYXBpcy5jb20vTm90aWZpY2F0aW9uQ2hhbm5lbFIEbmFtZRIUCgVmb3JjZRgFIAEoCFIFZm9yY2U=');
...
final $typed_data.Uint8List sendNotificationChannelVerificationCodeRequestDescriptor = $convert.base64Decode('Ci5TZW5kTm90aWZpY2F0aW9uQ2hhbm5lbFZlcmlmaWNhdGlvbkNvZGVSZXF1ZXN0EkkKBG5hbWUYASABKAlCNeBBAvpBLwotbW9uaXRvcmluZy5nb29nbGVhcGlzLmNvbS9Ob3RpZmljYXRpb25DaGFubmVsUgRuYW1l');
...
final $typed_data.Uint8List getNotificationChannelVerificationCodeRequestDescriptor = $convert.base64Decode('Ci1HZXROb3RpZmljYXRpb25DaGFubmVsVmVyaWZpY2F0aW9uQ29kZVJlcXVlc3QSSQoEbmFtZRgBIAEoCUI14EEC+kEvCi1tb25pdG9yaW5nLmdvb2dsZWFwaXMuY29tL05vdGlmaWNhdGlvbkNoYW5uZWxSBG5hbWUSOwoLZXhwaXJlX3RpbWUYAiABKAsyGi5nb29nbGUucHJvdG9idWYuVGltZXN0YW1wUgpleHBpcmVUaW1l');
...
final $typed_data.Uint8List getNotificationChannelVerificationCodeResponseDescriptor = $convert.base64Decode('Ci5HZXROb3RpZmljYXRpb25DaGFubmVsVmVyaWZpY2F0aW9uQ29kZVJlc3BvbnNlEhIKBGNvZGUYASABKAlSBGNvZGUSOwoLZXhwaXJlX3RpbWUYAiABKAsyGi5nb29nbGUucHJvdG9idWYuVGltZXN0YW1wUgpleHBpcmVUaW1l');
...
final $typed_data.Uint8List verifyNotificationChannelRequestDescriptor = $convert.base64Decode('CiBWZXJpZnlOb3RpZmljYXRpb25DaGFubmVsUmVxdWVzdBJJCgRuYW1lGAEgASgJQjXgQQL6QS8KLW1vbml0b3JpbmcuZ29vZ2xlYXBpcy5jb20vTm90aWZpY2F0aW9uQ2hhbm5lbFIEbmFtZRIXCgRjb2RlGAIgASgJQgPgQQJSBGNvZGU=');

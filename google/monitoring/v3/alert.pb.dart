...
class AlertPolicy_Documentation extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'AlertPolicy.Documentation', package: const $pb.PackageName(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'google.monitoring.v3'), createEmptyInstance: create)
  ...
  'Will be removed in next major version')
  AlertPolicy_Documentation copyWith(void Function(AlertPolicy_Documentation) updates) => super.copyWith((message) => updates(message as AlertPolicy_Documentation)) as AlertPolicy_Documentation; // ignore: deprecated_member_use
...
class AlertPolicy_Condition_Trigger extends $pb.GeneratedMessage {
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'AlertPolicy.Condition.Trigger', package: const $pb.PackageName(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'google.monitoring.v3'), createEmptyInstance: create)
    ..oo(0, [1, 2])
    ..a<$core.int>(1, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'count', $pb.PbFieldType.O3)
    ..a<$core.double>(2, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'percent', $pb.PbFieldType.OD)
    ..hasRequiredFields = false
  ;
  ...
  'Use [GeneratedMessageGenericExtensions.rebuild] instead. '
  'Will be removed in next major version')
  AlertPolicy_Condition_Trigger copyWith(void Function(AlertPolicy_Condition_Trigger) updates) => super.copyWith((message) => updates(message as AlertPolicy_Condition_Trigger)) as AlertPolicy_Condition_Trigger; // ignore: deprecated_member_use
  $pb.BuilderInfo get info_ => _i;
  @$core.pragma('dart2js:noInline')
...
class AlertPolicy_Condition_MetricThreshold extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'AlertPolicy.Condition.MetricThreshold', package: const $pb.PackageName(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'google.monitoring.v3'), createEmptyInstance: create)
    ..aOS(2, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'filter')
    ..e<$4.ComparisonType>(4, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'comparison', $pb.PbFieldType.OE, defaultOrMaker: $4.ComparisonType.COMPARISON_UNSPECIFIED, valueOf: $4.ComparisonType.valueOf, enumValues: $4.ComparisonType.values)
    ..a<$core.double>(5, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'thresholdValue', $pb.PbFieldType.OD)
    ..aOM<$3.Duration>(6, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'duration', subBuilder: $3.Duration.create)
    ..aOM<AlertPolicy_Condition_Trigger>(7, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'trigger', subBuilder: AlertPolicy_Condition_Trigger.create)
    ..pc<$4.Aggregation>(8, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'aggregations', $pb.PbFieldType.PM, subBuilder: $4.Aggregation.create)
    ..aOS(9, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'denominatorFilter')
    ..pc<$4.Aggregation>(10, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'denominatorAggregations', $pb.PbFieldType.PM, subBuilder: $4.Aggregation.create)
    ..hasRequiredFields = false
  ;
  ...
  'Use [GeneratedMessageGenericExtensions.rebuild] instead. '
  'Will be removed in next major version')
  AlertPolicy_Condition_MetricThreshold copyWith(void Function(AlertPolicy_Condition_MetricThreshold) updates) => super.copyWith((message) => updates(message as AlertPolicy_Condition_MetricThreshold)) as AlertPolicy_Condition_MetricThreshold; // ignore: deprecated_member_use
  $pb.BuilderInfo get info_ => _i;
  @$core.pragma('dart2js:noInline')
  ...
  @$pb.TagNumber(4)
  set comparison($4.ComparisonType v) { setField(4, v); }
  @$pb.TagNumber(4)
...
class AlertPolicy_Condition_MetricAbsence extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'AlertPolicy.Condition.MetricAbsence', package: const $pb.PackageName(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'google.monitoring.v3'), createEmptyInstance: create)
    ...
    ..aOM<AlertPolicy_Condition_Trigger>(3, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'trigger', subBuilder: AlertPolicy_Condition_Trigger.create)
    ..pc<$4.Aggregation>(5, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'aggregations', $pb.PbFieldType.PM, subBuilder: $4.Aggregation.create)
    ..hasRequiredFields = false
  ;
  ...
  'Use [GeneratedMessageGenericExtensions.rebuild] instead. '
  'Will be removed in next major version')
  AlertPolicy_Condition_MetricAbsence copyWith(void Function(AlertPolicy_Condition_MetricAbsence) updates) => super.copyWith((message) => updates(message as AlertPolicy_Condition_MetricAbsence)) as AlertPolicy_Condition_MetricAbsence; // ignore: deprecated_member_use
  $pb.BuilderInfo get info_ => _i;
  @$core.pragma('dart2js:noInline')
...
class AlertPolicy_Condition_LogMatch extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'AlertPolicy.Condition.LogMatch', package: const $pb.PackageName(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'google.monitoring.v3'), createEmptyInstance: create)
    ..aOS(1, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'filter')
    ..m<$core.String, $core.String>(2, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'labelExtractors', entryClassName: 'AlertPolicy.Condition.LogMatch.LabelExtractorsEntry', keyFieldType: $pb.PbFieldType.OS, valueFieldType: $pb.PbFieldType.OS, packageName: const $pb.PackageName('google.monitoring.v3'))
    ..hasRequiredFields = false
  ;
  ...
  'Use [GeneratedMessageGenericExtensions.rebuild] instead. '
  'Will be removed in next major version')
  AlertPolicy_Condition_LogMatch copyWith(void Function(AlertPolicy_Condition_LogMatch) updates) => super.copyWith((message) => updates(message as AlertPolicy_Condition_LogMatch)) as AlertPolicy_Condition_LogMatch; // ignore: deprecated_member_use
  $pb.BuilderInfo get info_ => _i;
  @$core.pragma('dart2js:noInline')
...
class AlertPolicy_Condition_MonitoringQueryLanguageCondition extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'AlertPolicy.Condition.MonitoringQueryLanguageCondition', package: const $pb.PackageName(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'google.monitoring.v3'), createEmptyInstance: create)
  ...
  'Use [GeneratedMessageGenericExtensions.rebuild] instead. '
  'Will be removed in next major version')
  AlertPolicy_Condition_MonitoringQueryLanguageCondition copyWith(void Function(AlertPolicy_Condition_MonitoringQueryLanguageCondition) updates) => super.copyWith((message) => updates(message as AlertPolicy_Condition_MonitoringQueryLanguageCondition)) as AlertPolicy_Condition_MonitoringQueryLanguageCondition; // ignore: deprecated_member_use
  $pb.BuilderInfo get info_ => _i;
  @$core.pragma('dart2js:noInline')
...
class AlertPolicy_Condition extends $pb.GeneratedMessage {
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'AlertPolicy.Condition', package: const $pb.PackageName(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'google.monitoring.v3'), createEmptyInstance: create)
    ..oo(0, [1, 2, 19, 20])
    ..aOM<AlertPolicy_Condition_MetricThreshold>(1, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'conditionThreshold', subBuilder: AlertPolicy_Condition_MetricThreshold.create)
    ..aOM<AlertPolicy_Condition_MetricAbsence>(2, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'conditionAbsent', subBuilder: AlertPolicy_Condition_MetricAbsence.create)
    ...
    ..aOM<AlertPolicy_Condition_MonitoringQueryLanguageCondition>(19, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'conditionMonitoringQueryLanguage', subBuilder: AlertPolicy_Condition_MonitoringQueryLanguageCondition.create)
    ..aOM<AlertPolicy_Condition_LogMatch>(20, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'conditionMatchedLog', subBuilder: AlertPolicy_Condition_LogMatch.create)
    ..hasRequiredFields = false
  ;
  ...
  factory AlertPolicy_Condition({
    ...
    if (conditionMonitoringQueryLanguage != null) {
      _result.conditionMonitoringQueryLanguage = conditionMonitoringQueryLanguage;
    }
  ...
  'Use [GeneratedMessageGenericExtensions.rebuild] instead. '
  'Will be removed in next major version')
  AlertPolicy_Condition copyWith(void Function(AlertPolicy_Condition) updates) => super.copyWith((message) => updates(message as AlertPolicy_Condition)) as AlertPolicy_Condition; // ignore: deprecated_member_use
  $pb.BuilderInfo get info_ => _i;
  @$core.pragma('dart2js:noInline')
...
class AlertPolicy_AlertStrategy_NotificationRateLimit extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'AlertPolicy.AlertStrategy.NotificationRateLimit', package: const $pb.PackageName(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'google.monitoring.v3'), createEmptyInstance: create)
    ..aOM<$3.Duration>(1, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'period', subBuilder: $3.Duration.create)
    ..hasRequiredFields = false
  ;
  ...
  'Use [GeneratedMessageGenericExtensions.rebuild] instead. '
  'Will be removed in next major version')
  AlertPolicy_AlertStrategy_NotificationRateLimit copyWith(void Function(AlertPolicy_AlertStrategy_NotificationRateLimit) updates) => super.copyWith((message) => updates(message as AlertPolicy_AlertStrategy_NotificationRateLimit)) as AlertPolicy_AlertStrategy_NotificationRateLimit; // ignore: deprecated_member_use
  $pb.BuilderInfo get info_ => _i;
  @$core.pragma('dart2js:noInline')
  ...
  @$pb.TagNumber(1)
  set period($3.Duration v) { setField(1, v); }
  @$pb.TagNumber(1)
...
class AlertPolicy_AlertStrategy extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'AlertPolicy.AlertStrategy', package: const $pb.PackageName(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'google.monitoring.v3'), createEmptyInstance: create)
    ..aOM<AlertPolicy_AlertStrategy_NotificationRateLimit>(1, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'notificationRateLimit', subBuilder: AlertPolicy_AlertStrategy_NotificationRateLimit.create)
    ..aOM<$3.Duration>(3, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'autoClose', subBuilder: $3.Duration.create)
    ..hasRequiredFields = false
  ;
  ...
  'Use [GeneratedMessageGenericExtensions.rebuild] instead. '
  'Will be removed in next major version')
  AlertPolicy_AlertStrategy copyWith(void Function(AlertPolicy_AlertStrategy) updates) => super.copyWith((message) => updates(message as AlertPolicy_AlertStrategy)) as AlertPolicy_AlertStrategy; // ignore: deprecated_member_use
  $pb.BuilderInfo get info_ => _i;
  @$core.pragma('dart2js:noInline')
  ...
  @$pb.TagNumber(3)
  set autoClose($3.Duration v) { setField(3, v); }
  @$pb.TagNumber(3)
...
class AlertPolicy extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'AlertPolicy', package: const $pb.PackageName(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'google.monitoring.v3'), createEmptyInstance: create)
    ..aOS(1, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'name')
    ..aOS(2, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'displayName')
    ..e<AlertPolicy_ConditionCombinerType>(6, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'combiner', $pb.PbFieldType.OE, defaultOrMaker: AlertPolicy_ConditionCombinerType.COMBINE_UNSPECIFIED, valueOf: AlertPolicy_ConditionCombinerType.valueOf, enumValues: AlertPolicy_ConditionCombinerType.values)
    ..aOM<$0.MutationRecord>(10, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'creationRecord', subBuilder: $0.MutationRecord.create)
    ..aOM<$0.MutationRecord>(11, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'mutationRecord', subBuilder: $0.MutationRecord.create)
    ..pc<AlertPolicy_Condition>(12, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'conditions', $pb.PbFieldType.PM, subBuilder: AlertPolicy_Condition.create)
    ..aOM<AlertPolicy_Documentation>(13, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'documentation', subBuilder: AlertPolicy_Documentation.create)
    ..pPS(14, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'notificationChannels')
    ..m<$core.String, $core.String>(16, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'userLabels', entryClassName: 'AlertPolicy.UserLabelsEntry', keyFieldType: $pb.PbFieldType.OS, valueFieldType: $pb.PbFieldType.OS, packageName: const $pb.PackageName('google.monitoring.v3'))
    ..aOM<$1.BoolValue>(17, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'enabled', subBuilder: $1.BoolValue.create)
    ..aOM<$2.Status>(18, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'validity', subBuilder: $2.Status.create)
    ..aOM<AlertPolicy_AlertStrategy>(21, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'alertStrategy', subBuilder: AlertPolicy_AlertStrategy.create)
    ..hasRequiredFields = false
  ;
  ...
  'Use [GeneratedMessageGenericExtensions.rebuild] instead. '
  'Will be removed in next major version')
  AlertPolicy copyWith(void Function(AlertPolicy) updates) => super.copyWith((message) => updates(message as AlertPolicy)) as AlertPolicy; // ignore: deprecated_member_use
  $pb.BuilderInfo get info_ => _i;
  @$core.pragma('dart2js:noInline')
  ...
  @$pb.TagNumber(10)
  set creationRecord($0.MutationRecord v) { setField(10, v); }
  @$pb.TagNumber(10)
  ...
  @$pb.TagNumber(11)
  set mutationRecord($0.MutationRecord v) { setField(11, v); }
  @$pb.TagNumber(11)
  ...
  @$pb.TagNumber(17)
  set enabled($1.BoolValue v) { setField(17, v); }
  @$pb.TagNumber(17)
  ...
  @$pb.TagNumber(18)
  set validity($2.Status v) { setField(18, v); }
  @$pb.TagNumber(18)

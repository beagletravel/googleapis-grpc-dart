...
const AlertPolicy$json = const {
  ...
  '2': const [
    ...
    const {'1': 'validity', '3': 18, '4': 1, '5': 11, '6': '.google.rpc.Status', '10': 'validity'},
    ...
    const {'1': 'alert_strategy', '3': 21, '4': 1, '5': 11, '6': '.google.monitoring.v3.AlertPolicy.AlertStrategy', '10': 'alertStrategy'},
  ],
  '3': const [AlertPolicy_Documentation$json, AlertPolicy_Condition$json, AlertPolicy_AlertStrategy$json, AlertPolicy_UserLabelsEntry$json],
...
const AlertPolicy_Condition$json = const {
  ...
  '2': const [
    ...
    const {'1': 'condition_matched_log', '3': 20, '4': 1, '5': 11, '6': '.google.monitoring.v3.AlertPolicy.Condition.LogMatch', '9': 0, '10': 'conditionMatchedLog'},
    const {'1': 'condition_monitoring_query_language', '3': 19, '4': 1, '5': 11, '6': '.google.monitoring.v3.AlertPolicy.Condition.MonitoringQueryLanguageCondition', '9': 0, '10': 'conditionMonitoringQueryLanguage'},
  ],
  '3': const [AlertPolicy_Condition_Trigger$json, AlertPolicy_Condition_MetricThreshold$json, AlertPolicy_Condition_MetricAbsence$json, AlertPolicy_Condition_LogMatch$json, AlertPolicy_Condition_MonitoringQueryLanguageCondition$json],
  '7': const {},
  '8': const [
    const {'1': 'condition'},
  ],
...
const AlertPolicy_Condition_LogMatch$json = const {
  ...
  '2': const [
    const {'1': 'filter', '3': 1, '4': 1, '5': 9, '8': const {}, '10': 'filter'},
    const {'1': 'label_extractors', '3': 2, '4': 3, '5': 11, '6': '.google.monitoring.v3.AlertPolicy.Condition.LogMatch.LabelExtractorsEntry', '10': 'labelExtractors'},
  ],
...
const AlertPolicy_AlertStrategy$json = const {
  '1': 'AlertStrategy',
  '2': const [
    const {'1': 'notification_rate_limit', '3': 1, '4': 1, '5': 11, '6': '.google.monitoring.v3.AlertPolicy.AlertStrategy.NotificationRateLimit', '10': 'notificationRateLimit'},
    const {'1': 'auto_close', '3': 3, '4': 1, '5': 11, '6': '.google.protobuf.Duration', '10': 'autoClose'},
  ],
...
const AlertPolicy_AlertStrategy_NotificationRateLimit$json = const {
  ...
  '2': const [
    const {'1': 'period', '3': 1, '4': 1, '5': 11, '6': '.google.protobuf.Duration', '10': 'period'},
  ],
};
...
final $typed_data.Uint8List alertPolicyDescriptor = $convert.base64Decode('');

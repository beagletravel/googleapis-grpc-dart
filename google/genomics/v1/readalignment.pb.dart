...
class LinearAlignment extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'LinearAlignment', package: const $pb.PackageName(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'google.genomics.v1'), createEmptyInstance: create)
    ..aOM<$0.Position>(1, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'position', subBuilder: $0.Position.create)
    ..a<$core.int>(2, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'mappingQuality', $pb.PbFieldType.O3)
    ..pc<$1.CigarUnit>(3, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'cigar', $pb.PbFieldType.PM, subBuilder: $1.CigarUnit.create)
  ...
  'Will be removed in next major version')
  LinearAlignment copyWith(void Function(LinearAlignment) updates) => super.copyWith((message) => updates(message as LinearAlignment)) as LinearAlignment; // ignore: deprecated_member_use
...
class Read extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'Read', package: const $pb.PackageName(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'google.genomics.v1'), createEmptyInstance: create)
    ..aOS(1, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'id')
    ..aOS(2, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'readGroupId')
    ..aOS(3, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'readGroupSetId')
    ..aOS(4, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'fragmentName')
    ..aOB(5, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'properPlacement')
    ..aOB(6, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'duplicateFragment')
    ..a<$core.int>(7, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'fragmentLength', $pb.PbFieldType.O3)
    ..a<$core.int>(8, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'readNumber', $pb.PbFieldType.O3)
    ..a<$core.int>(9, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'numberReads', $pb.PbFieldType.O3)
    ..aOB(10, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'failedVendorQualityChecks')
    ..aOM<LinearAlignment>(11, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'alignment', subBuilder: LinearAlignment.create)
    ..aOB(12, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'secondaryAlignment')
    ..aOB(13, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'supplementaryAlignment')
    ..aOS(14, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'alignedSequence')
    ..p<$core.int>(15, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'alignedQuality', $pb.PbFieldType.P3)
    ..aOM<$0.Position>(16, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'nextMatePosition', subBuilder: $0.Position.create)
    ..m<$core.String, $2.ListValue>(17, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'info', entryClassName: 'Read.InfoEntry', keyFieldType: $pb.PbFieldType.OS, valueFieldType: $pb.PbFieldType.OM, valueCreator: $2.ListValue.create, packageName: const $pb.PackageName('google.genomics.v1'))
    ..hasRequiredFields = false
  ;
  ...
  'Use [GeneratedMessageGenericExtensions.rebuild] instead. '
  'Will be removed in next major version')
  Read copyWith(void Function(Read) updates) => super.copyWith((message) => updates(message as Read)) as Read; // ignore: deprecated_member_use
  $pb.BuilderInfo get info_ => _i;
  @$core.pragma('dart2js:noInline')
  ...
  @$pb.TagNumber(16)
  set nextMatePosition($0.Position v) { setField(16, v); }
  @$pb.TagNumber(16)

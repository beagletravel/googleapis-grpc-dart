...
class ReadGroupSet extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'ReadGroupSet', package: const $pb.PackageName(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'google.genomics.v1'), createEmptyInstance: create)
    ...
    ..pc<$0.ReadGroup>(6, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'readGroups', $pb.PbFieldType.PM, subBuilder: $0.ReadGroup.create)
    ..m<$core.String, $1.ListValue>(7, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'info', entryClassName: 'ReadGroupSet.InfoEntry', keyFieldType: $pb.PbFieldType.OS, valueFieldType: $pb.PbFieldType.OM, valueCreator: $1.ListValue.create, packageName: const $pb.PackageName('google.genomics.v1'))
  ...
  'Will be removed in next major version')
  ReadGroupSet copyWith(void Function(ReadGroupSet) updates) => super.copyWith((message) => updates(message as ReadGroupSet)) as ReadGroupSet; // ignore: deprecated_member_use

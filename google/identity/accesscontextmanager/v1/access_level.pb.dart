...
class AccessLevel extends $pb.GeneratedMessage {
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'AccessLevel', package: const $pb.PackageName(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'google.identity.accesscontextmanager.v1'), createEmptyInstance: create)
    ..oo(0, [4, 5])
    ..aOS(1, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'name')
    ..aOS(2, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'title')
    ..aOS(3, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'description')
    ..aOM<BasicLevel>(4, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'basic', subBuilder: BasicLevel.create)
    ..aOM<CustomLevel>(5, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'custom', subBuilder: CustomLevel.create)
  ...
  'Will be removed in next major version')
  AccessLevel copyWith(void Function(AccessLevel) updates) => super.copyWith((message) => updates(message as AccessLevel)) as AccessLevel; // ignore: deprecated_member_use
...
class BasicLevel extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'BasicLevel', package: const $pb.PackageName(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'google.identity.accesscontextmanager.v1'), createEmptyInstance: create)
    ..pc<Condition>(1, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'conditions', $pb.PbFieldType.PM, subBuilder: Condition.create)
    ..e<BasicLevel_ConditionCombiningFunction>(2, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'combiningFunction', $pb.PbFieldType.OE, defaultOrMaker: BasicLevel_ConditionCombiningFunction.AND, valueOf: BasicLevel_ConditionCombiningFunction.valueOf, enumValues: BasicLevel_ConditionCombiningFunction.values)
    ..hasRequiredFields = false
  ;
  ...
  'Use [GeneratedMessageGenericExtensions.rebuild] instead. '
  'Will be removed in next major version')
  BasicLevel copyWith(void Function(BasicLevel) updates) => super.copyWith((message) => updates(message as BasicLevel)) as BasicLevel; // ignore: deprecated_member_use
  $pb.BuilderInfo get info_ => _i;
  @$core.pragma('dart2js:noInline')
...
class Condition extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'Condition', package: const $pb.PackageName(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'google.identity.accesscontextmanager.v1'), createEmptyInstance: create)
    ..pPS(1, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'ipSubnetworks')
    ..aOM<DevicePolicy>(2, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'devicePolicy', subBuilder: DevicePolicy.create)
    ..pPS(3, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'requiredAccessLevels')
    ..aOB(5, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'negate')
    ..pPS(6, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'members')
    ..pPS(7, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'regions')
    ..hasRequiredFields = false
  ;
...
class CustomLevel extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'CustomLevel', package: const $pb.PackageName(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'google.identity.accesscontextmanager.v1'), createEmptyInstance: create)
    ..aOM<$1.Expr>(1, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'expr', subBuilder: $1.Expr.create)
    ..hasRequiredFields = false
  ;
  ...
  'Use [GeneratedMessageGenericExtensions.rebuild] instead. '
  'Will be removed in next major version')
  CustomLevel copyWith(void Function(CustomLevel) updates) => super.copyWith((message) => updates(message as CustomLevel)) as CustomLevel; // ignore: deprecated_member_use
  $pb.BuilderInfo get info_ => _i;
  @$core.pragma('dart2js:noInline')
  ...
  @$pb.TagNumber(1)
  set expr($1.Expr v) { setField(1, v); }
  @$pb.TagNumber(1)
...
class DevicePolicy extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'DevicePolicy', package: const $pb.PackageName(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'google.identity.accesscontextmanager.v1'), createEmptyInstance: create)
    ..aOB(1, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'requireScreenlock')
    ..pc<$2.DeviceEncryptionStatus>(2, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'allowedEncryptionStatuses', $pb.PbFieldType.PE, valueOf: $2.DeviceEncryptionStatus.valueOf, enumValues: $2.DeviceEncryptionStatus.values)
    ..pc<OsConstraint>(3, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'osConstraints', $pb.PbFieldType.PM, subBuilder: OsConstraint.create)
    ..pc<$2.DeviceManagementLevel>(6, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'allowedDeviceManagementLevels', $pb.PbFieldType.PE, valueOf: $2.DeviceManagementLevel.valueOf, enumValues: $2.DeviceManagementLevel.values)
    ..aOB(7, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'requireAdminApproval')
    ..aOB(8, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'requireCorpOwned')
    ..hasRequiredFields = false
  ;
  ...
  factory DevicePolicy({
    ...
    if (allowedDeviceManagementLevels != null) {
      _result.allowedDeviceManagementLevels.addAll(allowedDeviceManagementLevels);
    }
  ...
  'Use [GeneratedMessageGenericExtensions.rebuild] instead. '
  'Will be removed in next major version')
  DevicePolicy copyWith(void Function(DevicePolicy) updates) => super.copyWith((message) => updates(message as DevicePolicy)) as DevicePolicy; // ignore: deprecated_member_use
  $pb.BuilderInfo get info_ => _i;
  @$core.pragma('dart2js:noInline')
  ...
  @$pb.TagNumber(2)
  $core.List<$2.DeviceEncryptionStatus> get allowedEncryptionStatuses => $_getList(1);

  @$pb.TagNumber(3)
  $core.List<OsConstraint> get osConstraints => $_getList(2);

  @$pb.TagNumber(6)
  $core.List<$2.DeviceManagementLevel> get allowedDeviceManagementLevels => $_getList(3);
...
class OsConstraint extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'OsConstraint', package: const $pb.PackageName(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'google.identity.accesscontextmanager.v1'), createEmptyInstance: create)
    ..e<$2.OsType>(1, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'osType', $pb.PbFieldType.OE, defaultOrMaker: $2.OsType.OS_UNSPECIFIED, valueOf: $2.OsType.valueOf, enumValues: $2.OsType.values)
    ..aOS(2, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'minimumVersion')
    ..aOB(3, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'requireVerifiedChromeOs')
    ..hasRequiredFields = false
  ;
  ...
  'Use [GeneratedMessageGenericExtensions.rebuild] instead. '
  'Will be removed in next major version')
  OsConstraint copyWith(void Function(OsConstraint) updates) => super.copyWith((message) => updates(message as OsConstraint)) as OsConstraint; // ignore: deprecated_member_use
  $pb.BuilderInfo get info_ => _i;
  @$core.pragma('dart2js:noInline')
  ...
  @$pb.TagNumber(1)
  set osType($2.OsType v) { setField(1, v); }
  @$pb.TagNumber(1)

...
class BasicLevel_ConditionCombiningFunction extends $pb.ProtobufEnum {
  static const BasicLevel_ConditionCombiningFunction AND = BasicLevel_ConditionCombiningFunction._(0, const $core.bool.fromEnvironment('protobuf.omit_enum_names') ? '' : 'AND');
  static const BasicLevel_ConditionCombiningFunction OR = BasicLevel_ConditionCombiningFunction._(1, const $core.bool.fromEnvironment('protobuf.omit_enum_names') ? '' : 'OR');

...
class GcpUserAccessBinding extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'GcpUserAccessBinding', package: const $pb.PackageName(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'google.identity.accesscontextmanager.v1'), createEmptyInstance: create)
    ..aOS(1, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'name')
    ..aOS(2, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'groupKey')
    ..pPS(3, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'accessLevels')
  ...
  'Will be removed in next major version')
  GcpUserAccessBinding copyWith(void Function(GcpUserAccessBinding) updates) => super.copyWith((message) => updates(message as GcpUserAccessBinding)) as GcpUserAccessBinding; // ignore: deprecated_member_use

...
final $typed_data.Uint8List buildTargetDescriptor = $convert.base64Decode('CgtCdWlsZFRhcmdldBISCgRuYW1lGAEgASgJUgRuYW1lOkvqQUgKKWNocm9tZW9zbW9ibGFiLmdvb2dsZWFwaXMuY29tL0J1aWxkVGFyZ2V0EhtidWlsZFRhcmdldHMve2J1aWxkX3RhcmdldH0=');
...
final $typed_data.Uint8List modelDescriptor = $convert.base64Decode('CgVNb2RlbBISCgRuYW1lGAEgASgJUgRuYW1lOlTqQVEKI2Nocm9tZW9zbW9ibGFiLmdvb2dsZWFwaXMuY29tL01vZGVsEipidWlsZFRhcmdldHMve2J1aWxkX3RhcmdldH0vbW9kZWxzL3ttb2RlbH0=');
...
final $typed_data.Uint8List milestoneDescriptor = $convert.base64Decode('CglNaWxlc3RvbmUSEgoEbmFtZRgBIAEoCVIEbmFtZTpE6kFBCidjaHJvbWVvc21vYmxhYi5nb29nbGVhcGlzLmNvbS9NaWxlc3RvbmUSFm1pbGVzdG9uZXMve21pbGVzdG9uZX0=');
@$core.Deprecated('Use buildDescriptor instead')
const Build$json = const {
  '1': 'Build',
  '2': const [
    const {'1': 'name', '3': 1, '4': 1, '5': 9, '10': 'name'},
    const {'1': 'milestone', '3': 2, '4': 1, '5': 9, '8': const {}, '10': 'milestone'},
    const {'1': 'build_version', '3': 3, '4': 1, '5': 9, '10': 'buildVersion'},
    const {'1': 'status', '3': 4, '4': 1, '5': 14, '6': '.google.chromeos.moblab.v1beta1.Build.BuildStatus', '10': 'status'},
    const {'1': 'type', '3': 5, '4': 1, '5': 14, '6': '.google.chromeos.moblab.v1beta1.Build.BuildType', '10': 'type'},
    const {'1': 'branch', '3': 6, '4': 1, '5': 9, '10': 'branch'},
    const {'1': 'rw_firmware_version', '3': 7, '4': 1, '5': 9, '10': 'rwFirmwareVersion'},
  ],
...
final $typed_data.Uint8List buildArtifactDescriptor = $convert.base64Decode('');

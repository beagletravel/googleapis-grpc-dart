...
class ComputeCustomRoutesResponse_FallbackInfo extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'ComputeCustomRoutesResponse.FallbackInfo', package: const $pb.PackageName(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'google.maps.routes.v1'), createEmptyInstance: create)
    ..e<$1.FallbackRoutingMode>(1, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'routingMode', $pb.PbFieldType.OE, defaultOrMaker: $1.FallbackRoutingMode.FALLBACK_ROUTING_MODE_UNSPECIFIED, valueOf: $1.FallbackRoutingMode.valueOf, enumValues: $1.FallbackRoutingMode.values)
    ..e<$1.FallbackReason>(2, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'routingModeReason', $pb.PbFieldType.OE, defaultOrMaker: $1.FallbackReason.FALLBACK_REASON_UNSPECIFIED, valueOf: $1.FallbackReason.valueOf, enumValues: $1.FallbackReason.values)
    ..e<ComputeCustomRoutesResponse_FallbackInfo_FallbackRouteObjective>(3, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'routeObjective', $pb.PbFieldType.OE, defaultOrMaker: ComputeCustomRoutesResponse_FallbackInfo_FallbackRouteObjective.FALLBACK_ROUTE_OBJECTIVE_UNSPECIFIED, valueOf: ComputeCustomRoutesResponse_FallbackInfo_FallbackRouteObjective.valueOf, enumValues: ComputeCustomRoutesResponse_FallbackInfo_FallbackRouteObjective.values)
  ...
  'Will be removed in next major version')
  ComputeCustomRoutesResponse_FallbackInfo copyWith(void Function(ComputeCustomRoutesResponse_FallbackInfo) updates) => super.copyWith((message) => updates(message as ComputeCustomRoutesResponse_FallbackInfo)) as ComputeCustomRoutesResponse_FallbackInfo; // ignore: deprecated_member_use
  ...
  @$pb.TagNumber(1)
  set routingMode($1.FallbackRoutingMode v) { setField(1, v); }
  @$pb.TagNumber(1)
  ...
  @$pb.TagNumber(2)
  set routingModeReason($1.FallbackReason v) { setField(2, v); }
  @$pb.TagNumber(2)
...
class ComputeCustomRoutesResponse extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'ComputeCustomRoutesResponse', package: const $pb.PackageName(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'google.maps.routes.v1'), createEmptyInstance: create)
    ..aOM<$0.CustomRoute>(5, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'fastestRoute', subBuilder: $0.CustomRoute.create)
    ..aOM<$0.CustomRoute>(6, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'shortestRoute', subBuilder: $0.CustomRoute.create)
    ..pc<$0.CustomRoute>(7, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'routes', $pb.PbFieldType.PM, subBuilder: $0.CustomRoute.create)
    ..aOM<ComputeCustomRoutesResponse_FallbackInfo>(8, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'fallbackInfo', subBuilder: ComputeCustomRoutesResponse_FallbackInfo.create)
    ..hasRequiredFields = false
  ;
  ...
  'Use [GeneratedMessageGenericExtensions.rebuild] instead. '
  'Will be removed in next major version')
  ComputeCustomRoutesResponse copyWith(void Function(ComputeCustomRoutesResponse) updates) => super.copyWith((message) => updates(message as ComputeCustomRoutesResponse)) as ComputeCustomRoutesResponse; // ignore: deprecated_member_use
  $pb.BuilderInfo get info_ => _i;
  @$core.pragma('dart2js:noInline')
  ...
  @$pb.TagNumber(5)
  set fastestRoute($0.CustomRoute v) { setField(5, v); }
  @$pb.TagNumber(5)
  ...
  @$pb.TagNumber(6)
  set shortestRoute($0.CustomRoute v) { setField(6, v); }
  @$pb.TagNumber(6)

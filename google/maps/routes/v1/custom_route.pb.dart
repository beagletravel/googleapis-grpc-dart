...
class CustomRoute extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'CustomRoute', package: const $pb.PackageName(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'google.maps.routes.v1'), createEmptyInstance: create)
    ..aOM<$0.Route>(11, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'route', subBuilder: $0.Route.create)
  ...
  'Will be removed in next major version')
  CustomRoute copyWith(void Function(CustomRoute) updates) => super.copyWith((message) => updates(message as CustomRoute)) as CustomRoute; // ignore: deprecated_member_use
  ...
  @$pb.TagNumber(11)
  set route($0.Route v) { setField(11, v); }
  @$pb.TagNumber(11)

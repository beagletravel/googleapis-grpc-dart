...
class ComputeRoutesRequest extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'ComputeRoutesRequest', package: const $pb.PackageName(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'google.maps.routes.v1'), createEmptyInstance: create)
    ...
    ..e<RouteTravelMode>(4, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'travelMode', $pb.PbFieldType.OE, defaultOrMaker: RouteTravelMode.TRAVEL_MODE_UNSPECIFIED, valueOf: RouteTravelMode.valueOf, enumValues: RouteTravelMode.values)
    ..e<RoutingPreference>(5, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'routingPreference', $pb.PbFieldType.OE, defaultOrMaker: RoutingPreference.ROUTING_PREFERENCE_UNSPECIFIED, valueOf: RoutingPreference.valueOf, enumValues: RoutingPreference.values)
    ..e<$2.PolylineQuality>(6, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'polylineQuality', $pb.PbFieldType.OE, defaultOrMaker: $2.PolylineQuality.POLYLINE_QUALITY_UNSPECIFIED, valueOf: $2.PolylineQuality.valueOf, enumValues: $2.PolylineQuality.values)
    ..aOM<$1.Timestamp>(7, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'departureTime', subBuilder: $1.Timestamp.create)
    ..aOB(8, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'computeAlternativeRoutes')
    ..aOM<RouteModifiers>(9, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'routeModifiers', subBuilder: RouteModifiers.create)
    ..aOS(10, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'languageCode')
    ..e<Units>(11, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'units', $pb.PbFieldType.OE, defaultOrMaker: Units.UNITS_UNSPECIFIED, valueOf: Units.valueOf, enumValues: Units.values)
    ..e<$2.PolylineEncoding>(12, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'polylineEncoding', $pb.PbFieldType.OE, defaultOrMaker: $2.PolylineEncoding.POLYLINE_ENCODING_UNSPECIFIED, valueOf: $2.PolylineEncoding.valueOf, enumValues: $2.PolylineEncoding.values)
  ...
  'Will be removed in next major version')
  ComputeRoutesRequest copyWith(void Function(ComputeRoutesRequest) updates) => super.copyWith((message) => updates(message as ComputeRoutesRequest)) as ComputeRoutesRequest; // ignore: deprecated_member_use
  ...
  @$pb.TagNumber(6)
  set polylineQuality($2.PolylineQuality v) { setField(6, v); }
  @$pb.TagNumber(6)
  ...
  @$pb.TagNumber(12)
  set polylineEncoding($2.PolylineEncoding v) { setField(12, v); }
  @$pb.TagNumber(12)
...
class RouteModifiers extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'RouteModifiers', package: const $pb.PackageName(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'google.maps.routes.v1'), createEmptyInstance: create)
    ..aOB(1, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'avoidTolls')
    ..aOB(2, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'avoidHighways')
    ..aOB(3, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'avoidFerries')
    ..aOB(4, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'avoidIndoor')
    ..aOM<VehicleInfo>(5, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'vehicleInfo', subBuilder: VehicleInfo.create)
    ..pc<$3.TollPass>(6, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'tollPasses', $pb.PbFieldType.PE, valueOf: $3.TollPass.valueOf, enumValues: $3.TollPass.values)
    ..hasRequiredFields = false
  ;
  ...
  'Use [GeneratedMessageGenericExtensions.rebuild] instead. '
  'Will be removed in next major version')
  RouteModifiers copyWith(void Function(RouteModifiers) updates) => super.copyWith((message) => updates(message as RouteModifiers)) as RouteModifiers; // ignore: deprecated_member_use
  $pb.BuilderInfo get info_ => _i;
  @$core.pragma('dart2js:noInline')
...
class VehicleInfo extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'VehicleInfo', package: const $pb.PackageName(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'google.maps.routes.v1'), createEmptyInstance: create)
    ..aOS(1, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'licensePlateLastCharacter')
    ..e<$4.VehicleEmissionType>(2, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'emissionType', $pb.PbFieldType.OE, defaultOrMaker: $4.VehicleEmissionType.VEHICLE_EMISSION_TYPE_UNSPECIFIED, valueOf: $4.VehicleEmissionType.valueOf, enumValues: $4.VehicleEmissionType.values)
    ..hasRequiredFields = false
  ;
  ...
  'Use [GeneratedMessageGenericExtensions.rebuild] instead. '
  'Will be removed in next major version')
  VehicleInfo copyWith(void Function(VehicleInfo) updates) => super.copyWith((message) => updates(message as VehicleInfo)) as VehicleInfo; // ignore: deprecated_member_use
  $pb.BuilderInfo get info_ => _i;
  @$core.pragma('dart2js:noInline')
  ...
  @$pb.TagNumber(2)
  set emissionType($4.VehicleEmissionType v) { setField(2, v); }
  @$pb.TagNumber(2)

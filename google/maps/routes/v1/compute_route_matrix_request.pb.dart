...
class ComputeRouteMatrixRequest extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'ComputeRouteMatrixRequest', package: const $pb.PackageName(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'google.maps.routes.v1'), createEmptyInstance: create)
    ..pc<RouteMatrixOrigin>(1, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'origins', $pb.PbFieldType.PM, subBuilder: RouteMatrixOrigin.create)
    ..pc<RouteMatrixDestination>(2, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'destinations', $pb.PbFieldType.PM, subBuilder: RouteMatrixDestination.create)
    ..e<$2.RouteTravelMode>(3, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'travelMode', $pb.PbFieldType.OE, defaultOrMaker: $2.RouteTravelMode.TRAVEL_MODE_UNSPECIFIED, valueOf: $2.RouteTravelMode.valueOf, enumValues: $2.RouteTravelMode.values)
    ..e<$2.RoutingPreference>(4, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'routingPreference', $pb.PbFieldType.OE, defaultOrMaker: $2.RoutingPreference.ROUTING_PREFERENCE_UNSPECIFIED, valueOf: $2.RoutingPreference.valueOf, enumValues: $2.RoutingPreference.values)
    ..aOM<$0.Timestamp>(5, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'departureTime', subBuilder: $0.Timestamp.create)
  ...
  'Will be removed in next major version')
  ComputeRouteMatrixRequest copyWith(void Function(ComputeRouteMatrixRequest) updates) => super.copyWith((message) => updates(message as ComputeRouteMatrixRequest)) as ComputeRouteMatrixRequest; // ignore: deprecated_member_use
  ...
  @$pb.TagNumber(3)
  set travelMode($2.RouteTravelMode v) { setField(3, v); }
  @$pb.TagNumber(3)
  ...
  @$pb.TagNumber(4)
  set routingPreference($2.RoutingPreference v) { setField(4, v); }
  @$pb.TagNumber(4)
  ...
  @$pb.TagNumber(5)
  set departureTime($0.Timestamp v) { setField(5, v); }
  @$pb.TagNumber(5)
...
class RouteMatrixOrigin extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'RouteMatrixOrigin', package: const $pb.PackageName(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'google.maps.routes.v1'), createEmptyInstance: create)
    ..aOM<$1.Waypoint>(1, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'waypoint', subBuilder: $1.Waypoint.create)
    ..aOM<$2.RouteModifiers>(2, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'routeModifiers', subBuilder: $2.RouteModifiers.create)
    ..hasRequiredFields = false
  ;
  ...
  'Use [GeneratedMessageGenericExtensions.rebuild] instead. '
  'Will be removed in next major version')
  RouteMatrixOrigin copyWith(void Function(RouteMatrixOrigin) updates) => super.copyWith((message) => updates(message as RouteMatrixOrigin)) as RouteMatrixOrigin; // ignore: deprecated_member_use
  $pb.BuilderInfo get info_ => _i;
  @$core.pragma('dart2js:noInline')
  ...
  @$pb.TagNumber(1)
  set waypoint($1.Waypoint v) { setField(1, v); }
  @$pb.TagNumber(1)
  ...
  @$pb.TagNumber(2)
  set routeModifiers($2.RouteModifiers v) { setField(2, v); }
  @$pb.TagNumber(2)
...
class RouteMatrixDestination extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'RouteMatrixDestination', package: const $pb.PackageName(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'google.maps.routes.v1'), createEmptyInstance: create)
    ..aOM<$1.Waypoint>(1, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'waypoint', subBuilder: $1.Waypoint.create)
    ..hasRequiredFields = false
  ;
  ...
  'Use [GeneratedMessageGenericExtensions.rebuild] instead. '
  'Will be removed in next major version')
  RouteMatrixDestination copyWith(void Function(RouteMatrixDestination) updates) => super.copyWith((message) => updates(message as RouteMatrixDestination)) as RouteMatrixDestination; // ignore: deprecated_member_use
  $pb.BuilderInfo get info_ => _i;
  @$core.pragma('dart2js:noInline')

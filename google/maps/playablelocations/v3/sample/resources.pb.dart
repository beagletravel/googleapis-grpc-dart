...
class PlayableLocation extends $pb.GeneratedMessage {
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'PlayableLocation', package: const $pb.PackageName(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'google.maps.playablelocations.v3.sample'), createEmptyInstance: create)
    ..oo(0, [2, 3])
    ..aOS(1, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'name')
    ..aOS(2, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'placeId')
    ..aOS(3, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'plusCode')
    ..pPS(4, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'types')
    ..aOM<$0.LatLng>(5, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'centerPoint', subBuilder: $0.LatLng.create)
    ..aOM<$0.LatLng>(6, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'snappedPoint', subBuilder: $0.LatLng.create)
  ...
  'Will be removed in next major version')
  PlayableLocation copyWith(void Function(PlayableLocation) updates) => super.copyWith((message) => updates(message as PlayableLocation)) as PlayableLocation; // ignore: deprecated_member_use
  ...
  @$pb.TagNumber(5)
  set centerPoint($0.LatLng v) { setField(5, v); }
  @$pb.TagNumber(5)
  ...
  @$pb.TagNumber(6)
  set snappedPoint($0.LatLng v) { setField(6, v); }
  @$pb.TagNumber(6)
...
class SpacingOptions extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'SpacingOptions', package: const $pb.PackageName(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'google.maps.playablelocations.v3.sample'), createEmptyInstance: create)
    ..a<$core.double>(1, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'minSpacingMeters', $pb.PbFieldType.OD)
    ..e<SpacingOptions_PointType>(2, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'pointType', $pb.PbFieldType.OE, defaultOrMaker: SpacingOptions_PointType.POINT_TYPE_UNSPECIFIED, valueOf: SpacingOptions_PointType.valueOf, enumValues: SpacingOptions_PointType.values)
    ..hasRequiredFields = false
  ;
  ...
  'Use [GeneratedMessageGenericExtensions.rebuild] instead. '
  'Will be removed in next major version')
  SpacingOptions copyWith(void Function(SpacingOptions) updates) => super.copyWith((message) => updates(message as SpacingOptions)) as SpacingOptions; // ignore: deprecated_member_use
  $pb.BuilderInfo get info_ => _i;
  @$core.pragma('dart2js:noInline')
...
class Filter extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'Filter', package: const $pb.PackageName(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'google.maps.playablelocations.v3.sample'), createEmptyInstance: create)
    ..a<$core.int>(1, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'maxLocationCount', $pb.PbFieldType.O3)
    ..aOM<SpacingOptions>(2, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'spacing', subBuilder: SpacingOptions.create)
    ..pPS(3, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'includedTypes')
    ..hasRequiredFields = false
  ;
...
class Criterion extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'Criterion', package: const $pb.PackageName(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'google.maps.playablelocations.v3.sample'), createEmptyInstance: create)
    ..a<$core.int>(1, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'gameObjectType', $pb.PbFieldType.O3)
    ..aOM<Filter>(2, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'filter', subBuilder: Filter.create)
    ..aOM<$1.FieldMask>(3, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'fieldsToReturn', subBuilder: $1.FieldMask.create)
    ..hasRequiredFields = false
  ;
  ...
  'Use [GeneratedMessageGenericExtensions.rebuild] instead. '
  'Will be removed in next major version')
  Criterion copyWith(void Function(Criterion) updates) => super.copyWith((message) => updates(message as Criterion)) as Criterion; // ignore: deprecated_member_use
  $pb.BuilderInfo get info_ => _i;
  @$core.pragma('dart2js:noInline')
  ...
  @$pb.TagNumber(3)
  set fieldsToReturn($1.FieldMask v) { setField(3, v); }
  @$pb.TagNumber(3)
...
class AreaFilter extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'AreaFilter', package: const $pb.PackageName(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'google.maps.playablelocations.v3.sample'), createEmptyInstance: create)
    ..a<$fixnum.Int64>(1, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 's2CellId', $pb.PbFieldType.OF6, defaultOrMaker: $fixnum.Int64.ZERO)
    ..hasRequiredFields = false
  ;
  ...
  'Use [GeneratedMessageGenericExtensions.rebuild] instead. '
  'Will be removed in next major version')
  AreaFilter copyWith(void Function(AreaFilter) updates) => super.copyWith((message) => updates(message as AreaFilter)) as AreaFilter; // ignore: deprecated_member_use
  $pb.BuilderInfo get info_ => _i;
  @$core.pragma('dart2js:noInline')
...
class PlayableLocationList extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'PlayableLocationList', package: const $pb.PackageName(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'google.maps.playablelocations.v3.sample'), createEmptyInstance: create)
    ..pc<PlayableLocation>(1, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'locations', $pb.PbFieldType.PM, subBuilder: PlayableLocation.create)
    ..hasRequiredFields = false
  ;
  ...
  'Use [GeneratedMessageGenericExtensions.rebuild] instead. '
  'Will be removed in next major version')
  PlayableLocationList copyWith(void Function(PlayableLocationList) updates) => super.copyWith((message) => updates(message as PlayableLocationList)) as PlayableLocationList; // ignore: deprecated_member_use
  $pb.BuilderInfo get info_ => _i;
  @$core.pragma('dart2js:noInline')

...
class SamplePlayableLocationsRequest extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'SamplePlayableLocationsRequest', package: const $pb.PackageName(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'google.maps.playablelocations.v3'), createEmptyInstance: create)
    ..aOM<$1.AreaFilter>(1, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'areaFilter', subBuilder: $1.AreaFilter.create)
    ..pc<$1.Criterion>(2, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'criteria', $pb.PbFieldType.PM, subBuilder: $1.Criterion.create)
  ...
  'Will be removed in next major version')
  SamplePlayableLocationsRequest copyWith(void Function(SamplePlayableLocationsRequest) updates) => super.copyWith((message) => updates(message as SamplePlayableLocationsRequest)) as SamplePlayableLocationsRequest; // ignore: deprecated_member_use
  ...
  @$pb.TagNumber(1)
  set areaFilter($1.AreaFilter v) { setField(1, v); }
  @$pb.TagNumber(1)
...
class SamplePlayableLocationsResponse extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'SamplePlayableLocationsResponse', package: const $pb.PackageName(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'google.maps.playablelocations.v3'), createEmptyInstance: create)
    ..m<$core.int, $1.PlayableLocationList>(1, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'locationsPerGameObjectType', entryClassName: 'SamplePlayableLocationsResponse.LocationsPerGameObjectTypeEntry', keyFieldType: $pb.PbFieldType.O3, valueFieldType: $pb.PbFieldType.OM, valueCreator: $1.PlayableLocationList.create, packageName: const $pb.PackageName('google.maps.playablelocations.v3'))
    ..aOM<$2.Duration>(9, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'ttl', subBuilder: $2.Duration.create)
    ..hasRequiredFields = false
  ;
  ...
  'Use [GeneratedMessageGenericExtensions.rebuild] instead. '
  'Will be removed in next major version')
  SamplePlayableLocationsResponse copyWith(void Function(SamplePlayableLocationsResponse) updates) => super.copyWith((message) => updates(message as SamplePlayableLocationsResponse)) as SamplePlayableLocationsResponse; // ignore: deprecated_member_use
  $pb.BuilderInfo get info_ => _i;
  @$core.pragma('dart2js:noInline')
  ...
  @$pb.TagNumber(1)
  $core.Map<$core.int, $1.PlayableLocationList> get locationsPerGameObjectType => $_getMap(0);

  @$pb.TagNumber(9)
  $2.Duration get ttl => $_getN(1);
  @$pb.TagNumber(9)
  set ttl($2.Duration v) { setField(9, v); }
  @$pb.TagNumber(9)
...
class LogPlayerReportsRequest extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'LogPlayerReportsRequest', package: const $pb.PackageName(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'google.maps.playablelocations.v3'), createEmptyInstance: create)
    ..pc<$3.PlayerReport>(1, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'playerReports', $pb.PbFieldType.PM, subBuilder: $3.PlayerReport.create)
    ..aOS(2, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'requestId')
    ..aOM<$4.ClientInfo>(3, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'clientInfo', subBuilder: $4.ClientInfo.create)
    ..hasRequiredFields = false
  ;
  ...
  'Use [GeneratedMessageGenericExtensions.rebuild] instead. '
  'Will be removed in next major version')
  LogPlayerReportsRequest copyWith(void Function(LogPlayerReportsRequest) updates) => super.copyWith((message) => updates(message as LogPlayerReportsRequest)) as LogPlayerReportsRequest; // ignore: deprecated_member_use
  $pb.BuilderInfo get info_ => _i;
  @$core.pragma('dart2js:noInline')
  ...
  @$pb.TagNumber(3)
  set clientInfo($4.ClientInfo v) { setField(3, v); }
  @$pb.TagNumber(3)
...
class LogPlayerReportsResponse extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'LogPlayerReportsResponse', package: const $pb.PackageName(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'google.maps.playablelocations.v3'), createEmptyInstance: create)
    ..hasRequiredFields = false
  ;
  ...
  'Use [GeneratedMessageGenericExtensions.rebuild] instead. '
  'Will be removed in next major version')
  LogPlayerReportsResponse copyWith(void Function(LogPlayerReportsResponse) updates) => super.copyWith((message) => updates(message as LogPlayerReportsResponse)) as LogPlayerReportsResponse; // ignore: deprecated_member_use
  $pb.BuilderInfo get info_ => _i;
  @$core.pragma('dart2js:noInline')
...
class LogImpressionsRequest extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'LogImpressionsRequest', package: const $pb.PackageName(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'google.maps.playablelocations.v3'), createEmptyInstance: create)
    ..pc<$3.Impression>(1, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'impressions', $pb.PbFieldType.PM, subBuilder: $3.Impression.create)
    ..aOS(2, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'requestId')
    ..aOM<$4.ClientInfo>(3, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'clientInfo', subBuilder: $4.ClientInfo.create)
    ..hasRequiredFields = false
  ;
  ...
  'Use [GeneratedMessageGenericExtensions.rebuild] instead. '
  'Will be removed in next major version')
  LogImpressionsRequest copyWith(void Function(LogImpressionsRequest) updates) => super.copyWith((message) => updates(message as LogImpressionsRequest)) as LogImpressionsRequest; // ignore: deprecated_member_use
  $pb.BuilderInfo get info_ => _i;
  @$core.pragma('dart2js:noInline')
...
class LogImpressionsResponse extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'LogImpressionsResponse', package: const $pb.PackageName(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'google.maps.playablelocations.v3'), createEmptyInstance: create)
    ..hasRequiredFields = false
  ;
  ...
  'Use [GeneratedMessageGenericExtensions.rebuild] instead. '
  'Will be removed in next major version')
  LogImpressionsResponse copyWith(void Function(LogImpressionsResponse) updates) => super.copyWith((message) => updates(message as LogImpressionsResponse)) as LogImpressionsResponse; // ignore: deprecated_member_use
  $pb.BuilderInfo get info_ => _i;
  @$core.pragma('dart2js:noInline')

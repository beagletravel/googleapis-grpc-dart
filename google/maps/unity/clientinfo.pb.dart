...
class ClientInfo extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'ClientInfo', package: const $pb.PackageName(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'google.maps.unity'), createEmptyInstance: create)
    ...
    ..e<ClientInfo_Platform>(3, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'platform', $pb.PbFieldType.OE, defaultOrMaker: ClientInfo_Platform.PLATFORM_UNSPECIFIED, valueOf: ClientInfo_Platform.valueOf, enumValues: ClientInfo_Platform.values)
    ..aOS(4, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'operatingSystem')
    ..aOS(5, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'apiClient')
    ...
    ..aOS(8, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'operatingSystemBuild')
  ...
  @$pb.TagNumber(3)
  set platform(ClientInfo_Platform v) { setField(3, v); }
  @$pb.TagNumber(3)
  ...
  @$pb.TagNumber(4)
  set operatingSystem($core.String v) { $_setString(3, v); }
  @$pb.TagNumber(4)
  ...
  @$pb.TagNumber(5)
  set apiClient($core.String v) { $_setString(4, v); }
  @$pb.TagNumber(5)
  ...
  @$pb.TagNumber(8)
  set operatingSystemBuild($core.String v) { $_setString(7, v); }
  @$pb.TagNumber(8)

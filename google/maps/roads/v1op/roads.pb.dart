...
class SnapToRoadsRequest extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'SnapToRoadsRequest', package: const $pb.PackageName(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'google.maps.roads.v1op'), createEmptyInstance: create)
    ..aOS(1, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'path')
    ..aOB(2, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'interpolate')
    ..aOS(3, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'assetId')
    ..e<TravelMode>(4, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'travelMode', $pb.PbFieldType.OE, defaultOrMaker: TravelMode.TRAVEL_MODE_UNSPECIFIED, valueOf: TravelMode.valueOf, enumValues: TravelMode.values)
  ...
  'Will be removed in next major version')
  SnapToRoadsRequest copyWith(void Function(SnapToRoadsRequest) updates) => super.copyWith((message) => updates(message as SnapToRoadsRequest)) as SnapToRoadsRequest; // ignore: deprecated_member_use
...
class SnappedPoint extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'SnappedPoint', package: const $pb.PackageName(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'google.maps.roads.v1op'), createEmptyInstance: create)
    ..aOM<$1.LatLng>(1, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'location', subBuilder: $1.LatLng.create)
    ..aOM<$2.UInt32Value>(2, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'originalIndex', subBuilder: $2.UInt32Value.create)
    ..aOS(3, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'placeId')
    ..hasRequiredFields = false
  ;
  ...
  'Use [GeneratedMessageGenericExtensions.rebuild] instead. '
  'Will be removed in next major version')
  SnappedPoint copyWith(void Function(SnappedPoint) updates) => super.copyWith((message) => updates(message as SnappedPoint)) as SnappedPoint; // ignore: deprecated_member_use
  $pb.BuilderInfo get info_ => _i;
  @$core.pragma('dart2js:noInline')
  ...
  @$pb.TagNumber(2)
  set originalIndex($2.UInt32Value v) { setField(2, v); }
  @$pb.TagNumber(2)
...
class SnapToRoadsResponse extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'SnapToRoadsResponse', package: const $pb.PackageName(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'google.maps.roads.v1op'), createEmptyInstance: create)
    ..pc<SnappedPoint>(1, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'snappedPoints', $pb.PbFieldType.PM, subBuilder: SnappedPoint.create)
    ..aOS(2, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'warningMessage')
    ..hasRequiredFields = false
  ;
  ...
  'Use [GeneratedMessageGenericExtensions.rebuild] instead. '
  'Will be removed in next major version')
  SnapToRoadsResponse copyWith(void Function(SnapToRoadsResponse) updates) => super.copyWith((message) => updates(message as SnapToRoadsResponse)) as SnapToRoadsResponse; // ignore: deprecated_member_use
  $pb.BuilderInfo get info_ => _i;
  @$core.pragma('dart2js:noInline')
...
class ListNearestRoadsRequest extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'ListNearestRoadsRequest', package: const $pb.PackageName(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'google.maps.roads.v1op'), createEmptyInstance: create)
    ..aOS(1, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'points')
    ..e<TravelMode>(2, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'travelMode', $pb.PbFieldType.OE, defaultOrMaker: TravelMode.TRAVEL_MODE_UNSPECIFIED, valueOf: TravelMode.valueOf, enumValues: TravelMode.values)
    ..hasRequiredFields = false
  ;
  ...
  'Use [GeneratedMessageGenericExtensions.rebuild] instead. '
  'Will be removed in next major version')
  ListNearestRoadsRequest copyWith(void Function(ListNearestRoadsRequest) updates) => super.copyWith((message) => updates(message as ListNearestRoadsRequest)) as ListNearestRoadsRequest; // ignore: deprecated_member_use
  $pb.BuilderInfo get info_ => _i;
  @$core.pragma('dart2js:noInline')
...
class ListNearestRoadsResponse extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'ListNearestRoadsResponse', package: const $pb.PackageName(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'google.maps.roads.v1op'), createEmptyInstance: create)
    ..pc<SnappedPoint>(1, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'snappedPoints', $pb.PbFieldType.PM, subBuilder: SnappedPoint.create)
    ..hasRequiredFields = false
  ;
  ...
  'Use [GeneratedMessageGenericExtensions.rebuild] instead. '
  'Will be removed in next major version')
  ListNearestRoadsResponse copyWith(void Function(ListNearestRoadsResponse) updates) => super.copyWith((message) => updates(message as ListNearestRoadsResponse)) as ListNearestRoadsResponse; // ignore: deprecated_member_use
  $pb.BuilderInfo get info_ => _i;
  @$core.pragma('dart2js:noInline')

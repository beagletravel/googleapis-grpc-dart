...
class Task_JourneySharingInfo extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'Task.JourneySharingInfo', package: const $pb.PackageName(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'maps.fleetengine.delivery.v1'), createEmptyInstance: create)
    ..pc<$0.VehicleJourneySegment>(1, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'remainingVehicleJourneySegments', $pb.PbFieldType.PM, subBuilder: $0.VehicleJourneySegment.create)
    ..aOM<$3.DeliveryVehicleLocation>(2, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'lastLocation', subBuilder: $3.DeliveryVehicleLocation.create)
    ..aOB(3, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'lastLocationSnappable')
  ...
  'Will be removed in next major version')
  Task_JourneySharingInfo copyWith(void Function(Task_JourneySharingInfo) updates) => super.copyWith((message) => updates(message as Task_JourneySharingInfo)) as Task_JourneySharingInfo; // ignore: deprecated_member_use
  ...
  @$pb.TagNumber(1)
  $core.List<$0.VehicleJourneySegment> get remainingVehicleJourneySegments => $_getList(0);

  @$pb.TagNumber(2)
  $3.DeliveryVehicleLocation get lastLocation => $_getN(1);
  @$pb.TagNumber(2)
  set lastLocation($3.DeliveryVehicleLocation v) { setField(2, v); }
  @$pb.TagNumber(2)
...
class Task extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'Task', package: const $pb.PackageName(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'maps.fleetengine.delivery.v1'), createEmptyInstance: create)
    ..aOS(1, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'name')
    ..e<Task_Type>(2, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'type', $pb.PbFieldType.OE, defaultOrMaker: Task_Type.TYPE_UNSPECIFIED, valueOf: Task_Type.valueOf, enumValues: Task_Type.values)
    ..e<Task_State>(3, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'state', $pb.PbFieldType.OE, defaultOrMaker: Task_State.STATE_UNSPECIFIED, valueOf: Task_State.valueOf, enumValues: Task_State.values)
    ..aOS(4, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'trackingId')
    ..aOS(5, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'deliveryVehicleId')
    ..aOM<$0.LocationInfo>(6, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'plannedLocation', subBuilder: $0.LocationInfo.create)
    ..aOM<$1.Duration>(7, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'taskDuration', subBuilder: $1.Duration.create)
    ..aOM<Task_JourneySharingInfo>(8, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'journeySharingInfo', subBuilder: Task_JourneySharingInfo.create)
    ..e<Task_TaskOutcome>(9, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'taskOutcome', $pb.PbFieldType.OE, defaultOrMaker: Task_TaskOutcome.TASK_OUTCOME_UNSPECIFIED, valueOf: Task_TaskOutcome.valueOf, enumValues: Task_TaskOutcome.values)
    ..aOM<$2.Timestamp>(10, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'taskOutcomeTime', subBuilder: $2.Timestamp.create)
    ..aOM<$0.LocationInfo>(11, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'taskOutcomeLocation', subBuilder: $0.LocationInfo.create)
    ..e<Task_TaskOutcomeLocationSource>(12, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'taskOutcomeLocationSource', $pb.PbFieldType.OE, defaultOrMaker: Task_TaskOutcomeLocationSource.TASK_OUTCOME_LOCATION_SOURCE_UNSPECIFIED, valueOf: Task_TaskOutcomeLocationSource.valueOf, enumValues: Task_TaskOutcomeLocationSource.values)
    ..hasRequiredFields = false
  ;
  ...
  @$pb.TagNumber(6)
  set plannedLocation($0.LocationInfo v) { setField(6, v); }
  @$pb.TagNumber(6)
  ...
  @$pb.TagNumber(7)
  set taskDuration($1.Duration v) { setField(7, v); }
  @$pb.TagNumber(7)
  ...
  @$pb.TagNumber(10)
  set taskOutcomeTime($2.Timestamp v) { setField(10, v); }
  @$pb.TagNumber(10)
  ...
  @$pb.TagNumber(11)
  set taskOutcomeLocation($0.LocationInfo v) { setField(11, v); }
  @$pb.TagNumber(11)

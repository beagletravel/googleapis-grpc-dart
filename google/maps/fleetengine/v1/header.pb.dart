...
class RequestHeader extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'RequestHeader', package: const $pb.PackageName(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'maps.fleetengine.v1'), createEmptyInstance: create)
    ...
    ..e<RequestHeader_SdkType>(6, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'sdkType', $pb.PbFieldType.OE, defaultOrMaker: RequestHeader_SdkType.SDK_TYPE_UNSPECIFIED, valueOf: RequestHeader_SdkType.valueOf, enumValues: RequestHeader_SdkType.values)
    ...
    ..e<RequestHeader_Platform>(9, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'platform', $pb.PbFieldType.OE, defaultOrMaker: RequestHeader_Platform.PLATFORM_UNSPECIFIED, valueOf: RequestHeader_Platform.valueOf, enumValues: RequestHeader_Platform.values)

...
class Vehicle_VehicleType extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'Vehicle.VehicleType', package: const $pb.PackageName(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'maps.fleetengine.v1'), createEmptyInstance: create)
    ..e<Vehicle_VehicleType_Category>(1, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'category', $pb.PbFieldType.OE, defaultOrMaker: Vehicle_VehicleType_Category.UNKNOWN, valueOf: Vehicle_VehicleType_Category.valueOf, enumValues: Vehicle_VehicleType_Category.values)
  ...
  'Will be removed in next major version')
  Vehicle_VehicleType copyWith(void Function(Vehicle_VehicleType) updates) => super.copyWith((message) => updates(message as Vehicle_VehicleType)) as Vehicle_VehicleType; // ignore: deprecated_member_use
...
class Vehicle extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'Vehicle', package: const $pb.PackageName(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'maps.fleetengine.v1'), createEmptyInstance: create)
    ..aOS(1, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'name')
    ..e<VehicleState>(2, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'vehicleState', $pb.PbFieldType.OE, defaultOrMaker: VehicleState.UNKNOWN_VEHICLE_STATE, valueOf: VehicleState.valueOf, enumValues: VehicleState.values)
    ..pc<$0.TripType>(3, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'supportedTripTypes', $pb.PbFieldType.PE, valueOf: $0.TripType.valueOf, enumValues: $0.TripType.values)
    ..pPS(4, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'currentTrips')
    ..aOM<$0.VehicleLocation>(5, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'lastLocation', subBuilder: $0.VehicleLocation.create)
    ..a<$core.int>(6, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'maximumCapacity', $pb.PbFieldType.O3)
    ..pc<$0.VehicleAttribute>(8, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'attributes', $pb.PbFieldType.PM, subBuilder: $0.VehicleAttribute.create)
    ..aOM<Vehicle_VehicleType>(9, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'vehicleType', subBuilder: Vehicle_VehicleType.create)
    ..aOM<LicensePlate>(10, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'licensePlate', subBuilder: LicensePlate.create)
    ..pc<$0.TerminalLocation>(12, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'route', $pb.PbFieldType.PM, subBuilder: $0.TerminalLocation.create)
    ..aOM<$1.Timestamp>(15, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'currentRouteSegmentVersion', subBuilder: $1.Timestamp.create)
    ..aOM<$1.Timestamp>(16, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'waypointsVersion', subBuilder: $1.Timestamp.create)
    ..aOM<$2.Int32Value>(18, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'remainingDistanceMeters', subBuilder: $2.Int32Value.create)
    ..aOM<$1.Timestamp>(19, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'etaToFirstWaypoint', subBuilder: $1.Timestamp.create)
    ..aOS(20, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'currentRouteSegment')
    ..pc<$0.TripWaypoint>(22, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'waypoints', $pb.PbFieldType.PM, subBuilder: $0.TripWaypoint.create)
    ..aOB(23, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'backToBackEnabled')
    ..aOM<$0.TripWaypoint>(24, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'currentRouteSegmentEndPoint', subBuilder: $0.TripWaypoint.create)
    ..aOM<$2.Int32Value>(25, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'remainingTimeSeconds', subBuilder: $2.Int32Value.create)
    ..e<$0.NavigationStatus>(26, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'navigationStatus', $pb.PbFieldType.OE, defaultOrMaker: $0.NavigationStatus.UNKNOWN_NAVIGATION_STATUS, valueOf: $0.NavigationStatus.valueOf, enumValues: $0.NavigationStatus.values)
    ..aOM<DeviceSettings>(27, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'deviceSettings', subBuilder: DeviceSettings.create)
    ..aOM<TrafficPolylineData>(28, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'currentRouteSegmentTraffic', subBuilder: TrafficPolylineData.create)
    ..hasRequiredFields = false
  ;
  ...
  @$pb.TagNumber(5)
  set lastLocation($0.VehicleLocation v) { setField(5, v); }
  @$pb.TagNumber(5)
  ...
  @$pb.TagNumber(15)
  set currentRouteSegmentVersion($1.Timestamp v) { setField(15, v); }
  @$pb.TagNumber(15)
  ...
  @$pb.TagNumber(16)
  set waypointsVersion($1.Timestamp v) { setField(16, v); }
  @$pb.TagNumber(16)
  ...
  @$pb.TagNumber(18)
  set remainingDistanceMeters($2.Int32Value v) { setField(18, v); }
  @$pb.TagNumber(18)
  ...
  @$pb.TagNumber(19)
  set etaToFirstWaypoint($1.Timestamp v) { setField(19, v); }
  @$pb.TagNumber(19)
  ...
  @$pb.TagNumber(24)
  set currentRouteSegmentEndPoint($0.TripWaypoint v) { setField(24, v); }
  @$pb.TagNumber(24)
  ...
  @$pb.TagNumber(25)
  set remainingTimeSeconds($2.Int32Value v) { setField(25, v); }
  @$pb.TagNumber(25)
  ...
  @$pb.TagNumber(26)
  set navigationStatus($0.NavigationStatus v) { setField(26, v); }
  @$pb.TagNumber(26)
...
class BatteryInfo extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'BatteryInfo', package: const $pb.PackageName(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'maps.fleetengine.v1'), createEmptyInstance: create)
    ..e<BatteryStatus>(1, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'batteryStatus', $pb.PbFieldType.OE, defaultOrMaker: BatteryStatus.UNKNOWN_BATTERY_STATUS, valueOf: BatteryStatus.valueOf, enumValues: BatteryStatus.values)
    ..e<PowerSource>(2, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'powerSource', $pb.PbFieldType.OE, defaultOrMaker: PowerSource.UNKNOWN_POWER_SOURCE, valueOf: PowerSource.valueOf, enumValues: PowerSource.values)
    ..a<$core.double>(3, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'batteryPercentage', $pb.PbFieldType.OF)
    ..hasRequiredFields = false
  ;
  ...
  'Use [GeneratedMessageGenericExtensions.rebuild] instead. '
  'Will be removed in next major version')
  BatteryInfo copyWith(void Function(BatteryInfo) updates) => super.copyWith((message) => updates(message as BatteryInfo)) as BatteryInfo; // ignore: deprecated_member_use
  $pb.BuilderInfo get info_ => _i;
  @$core.pragma('dart2js:noInline')
...
class DeviceSettings extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'DeviceSettings', package: const $pb.PackageName(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'maps.fleetengine.v1'), createEmptyInstance: create)
    ..e<LocationPowerSaveMode>(1, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'locationPowerSaveMode', $pb.PbFieldType.OE, defaultOrMaker: LocationPowerSaveMode.UNKNOWN_LOCATION_POWER_SAVE_MODE, valueOf: LocationPowerSaveMode.valueOf, enumValues: LocationPowerSaveMode.values)
    ..aOB(2, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'isPowerSaveMode')
    ..aOB(3, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'isInteractive')
    ..aOM<BatteryInfo>(4, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'batteryInfo', subBuilder: BatteryInfo.create)
    ..hasRequiredFields = false
  ;
  ...
  'Use [GeneratedMessageGenericExtensions.rebuild] instead. '
  'Will be removed in next major version')
  DeviceSettings copyWith(void Function(DeviceSettings) updates) => super.copyWith((message) => updates(message as DeviceSettings)) as DeviceSettings; // ignore: deprecated_member_use
  $pb.BuilderInfo get info_ => _i;
  @$core.pragma('dart2js:noInline')
...
class LicensePlate extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'LicensePlate', package: const $pb.PackageName(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'maps.fleetengine.v1'), createEmptyInstance: create)
    ..aOS(1, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'countryCode')
    ..aOS(2, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'lastCharacter')
    ..hasRequiredFields = false
  ;
  ...
  'Use [GeneratedMessageGenericExtensions.rebuild] instead. '
  'Will be removed in next major version')
  LicensePlate copyWith(void Function(LicensePlate) updates) => super.copyWith((message) => updates(message as LicensePlate)) as LicensePlate; // ignore: deprecated_member_use
  $pb.BuilderInfo get info_ => _i;
  @$core.pragma('dart2js:noInline')
...
class VisualTrafficReportPolylineRendering_RoadStretch extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'VisualTrafficReportPolylineRendering.RoadStretch', package: const $pb.PackageName(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'maps.fleetengine.v1'), createEmptyInstance: create)
    ..e<VisualTrafficReportPolylineRendering_RoadStretch_Style>(1, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'style', $pb.PbFieldType.OE, defaultOrMaker: VisualTrafficReportPolylineRendering_RoadStretch_Style.STYLE_UNSPECIFIED, valueOf: VisualTrafficReportPolylineRendering_RoadStretch_Style.valueOf, enumValues: VisualTrafficReportPolylineRendering_RoadStretch_Style.values)
    ..a<$core.int>(2, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'offsetMeters', $pb.PbFieldType.O3)
    ..a<$core.int>(3, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'lengthMeters', $pb.PbFieldType.O3)
    ..hasRequiredFields = false
  ;
  ...
  'Use [GeneratedMessageGenericExtensions.rebuild] instead. '
  'Will be removed in next major version')
  VisualTrafficReportPolylineRendering_RoadStretch copyWith(void Function(VisualTrafficReportPolylineRendering_RoadStretch) updates) => super.copyWith((message) => updates(message as VisualTrafficReportPolylineRendering_RoadStretch)) as VisualTrafficReportPolylineRendering_RoadStretch; // ignore: deprecated_member_use
  $pb.BuilderInfo get info_ => _i;
  @$core.pragma('dart2js:noInline')
...
class VisualTrafficReportPolylineRendering extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'VisualTrafficReportPolylineRendering', package: const $pb.PackageName(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'maps.fleetengine.v1'), createEmptyInstance: create)
    ..pc<VisualTrafficReportPolylineRendering_RoadStretch>(1, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'roadStretch', $pb.PbFieldType.PM, subBuilder: VisualTrafficReportPolylineRendering_RoadStretch.create)
    ..hasRequiredFields = false
  ;
  ...
  'Use [GeneratedMessageGenericExtensions.rebuild] instead. '
  'Will be removed in next major version')
  VisualTrafficReportPolylineRendering copyWith(void Function(VisualTrafficReportPolylineRendering) updates) => super.copyWith((message) => updates(message as VisualTrafficReportPolylineRendering)) as VisualTrafficReportPolylineRendering; // ignore: deprecated_member_use
  $pb.BuilderInfo get info_ => _i;
  @$core.pragma('dart2js:noInline')
...
class TrafficPolylineData extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'TrafficPolylineData', package: const $pb.PackageName(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'maps.fleetengine.v1'), createEmptyInstance: create)
    ..aOM<VisualTrafficReportPolylineRendering>(1, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'trafficRendering', subBuilder: VisualTrafficReportPolylineRendering.create)
    ..hasRequiredFields = false
  ;
  ...
  'Use [GeneratedMessageGenericExtensions.rebuild] instead. '
  'Will be removed in next major version')
  TrafficPolylineData copyWith(void Function(TrafficPolylineData) updates) => super.copyWith((message) => updates(message as TrafficPolylineData)) as TrafficPolylineData; // ignore: deprecated_member_use
  $pb.BuilderInfo get info_ => _i;
  @$core.pragma('dart2js:noInline')

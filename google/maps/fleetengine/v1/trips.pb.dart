...
class Trip extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'Trip', package: const $pb.PackageName(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'maps.fleetengine.v1'), createEmptyInstance: create)
    ..aOS(1, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'name')
    ..aOS(2, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'vehicleId')
    ..e<TripStatus>(3, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'tripStatus', $pb.PbFieldType.OE, defaultOrMaker: TripStatus.UNKNOWN_TRIP_STATUS, valueOf: TripStatus.valueOf, enumValues: TripStatus.values)
    ..e<$0.TripType>(4, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'tripType', $pb.PbFieldType.OE, defaultOrMaker: $0.TripType.UNKNOWN_TRIP_TYPE, valueOf: $0.TripType.valueOf, enumValues: $0.TripType.values)
    ..aOM<$0.TerminalLocation>(5, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'pickupPoint', subBuilder: $0.TerminalLocation.create)
    ..aOM<$1.Timestamp>(6, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'pickupTime', subBuilder: $1.Timestamp.create)
    ..aOM<$0.TerminalLocation>(7, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'dropoffPoint', subBuilder: $0.TerminalLocation.create)
    ..aOM<$1.Timestamp>(8, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'dropoffTime', subBuilder: $1.Timestamp.create)
    ..pc<$2.LatLng>(9, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'route', $pb.PbFieldType.PM, subBuilder: $2.LatLng.create)
    ..a<$core.int>(10, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'numberOfPassengers', $pb.PbFieldType.O3)
    ..aOM<$0.VehicleLocation>(11, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'lastLocation', subBuilder: $0.VehicleLocation.create)
    ..aOM<$3.Int32Value>(12, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'remainingDistanceMeters', subBuilder: $3.Int32Value.create)
    ..aOM<$1.Timestamp>(13, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'etaToFirstWaypoint', subBuilder: $1.Timestamp.create)
    ..pc<$0.TerminalLocation>(14, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'intermediateDestinations', $pb.PbFieldType.PM, subBuilder: $0.TerminalLocation.create)
    ..a<$core.int>(15, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'intermediateDestinationIndex', $pb.PbFieldType.O3)
    ..pc<$0.TripWaypoint>(16, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'remainingWaypoints', $pb.PbFieldType.PM, subBuilder: $0.TripWaypoint.create)
    ..aOM<$1.Timestamp>(17, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'currentRouteSegmentVersion', subBuilder: $1.Timestamp.create)
    ..aOM<$1.Timestamp>(19, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'remainingWaypointsVersion', subBuilder: $1.Timestamp.create)
    ..pc<$0.TripWaypoint>(20, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'vehicleWaypoints', $pb.PbFieldType.PM, subBuilder: $0.TripWaypoint.create)
    ..aOS(21, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'currentRouteSegment')
    ..aOM<StopLocation>(22, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'actualPickupPoint', subBuilder: StopLocation.create)
    ..aOM<StopLocation>(23, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'actualDropoffPoint', subBuilder: StopLocation.create)
    ...
    ..aOM<$1.Timestamp>(25, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'intermediateDestinationsVersion', subBuilder: $1.Timestamp.create)
    ..aOB(26, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'lastLocationSnappable')
    ..aOM<$4.Duration>(27, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'remainingTimeToFirstWaypoint', subBuilder: $4.Duration.create)
    ..aOM<$5.ConsumableTrafficPolyline>(28, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'currentRouteSegmentTraffic', subBuilder: $5.ConsumableTrafficPolyline.create)
    ..aOM<$1.Timestamp>(29, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'remainingWaypointsRouteVersion', subBuilder: $1.Timestamp.create)
    ..aOM<$1.Timestamp>(30, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'currentRouteSegmentTrafficVersion', subBuilder: $1.Timestamp.create)
    ..e<TripView>(31, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'view', $pb.PbFieldType.OE, defaultOrMaker: TripView.TRIP_VIEW_UNSPECIFIED, valueOf: TripView.valueOf, enumValues: TripView.values)
    ..aOM<StopLocation>(32, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'actualPickupArrivalPoint', subBuilder: StopLocation.create)
    ..pc<StopLocation>(33, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'actualIntermediateDestinationArrivalPoints', $pb.PbFieldType.PM, subBuilder: StopLocation.create)
    ..pc<StopLocation>(34, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'actualIntermediateDestinations', $pb.PbFieldType.PM, subBuilder: StopLocation.create)
  ...
  factory Trip({
    ...
    if (currentRouteSegmentTrafficVersion != null) {
      _result.currentRouteSegmentTrafficVersion = currentRouteSegmentTrafficVersion;
    }
    if (view != null) {
      _result.view = view;
    }
    ...
    if (actualIntermediateDestinationArrivalPoints != null) {
      _result.actualIntermediateDestinationArrivalPoints.addAll(actualIntermediateDestinationArrivalPoints);
    }
    if (actualIntermediateDestinations != null) {
      _result.actualIntermediateDestinations.addAll(actualIntermediateDestinations);
    }
    return _result;
  }
  ...
  @$pb.TagNumber(2)
  set vehicleId($core.String v) { $_setString(1, v); }
  @$pb.TagNumber(2)
  ...
  @$pb.TagNumber(3)
  set tripStatus(TripStatus v) { setField(3, v); }
  @$pb.TagNumber(3)
  ...
  @$pb.TagNumber(4)
  set tripType($0.TripType v) { setField(4, v); }
  @$pb.TagNumber(4)
  ...
  @$pb.TagNumber(5)
  set pickupPoint($0.TerminalLocation v) { setField(5, v); }
  @$pb.TagNumber(5)
  ...
  @$pb.TagNumber(6)
  set pickupTime($1.Timestamp v) { setField(6, v); }
  @$pb.TagNumber(6)
  ...
  @$pb.TagNumber(7)
  set dropoffPoint($0.TerminalLocation v) { setField(7, v); }
  @$pb.TagNumber(7)
  ...
  @$pb.TagNumber(8)
  set dropoffTime($1.Timestamp v) { setField(8, v); }
  @$pb.TagNumber(8)
  ...
  @$pb.TagNumber(10)
  set numberOfPassengers($core.int v) { $_setSignedInt32(9, v); }
  @$pb.TagNumber(10)
  ...
  @$pb.TagNumber(11)
  set lastLocation($0.VehicleLocation v) { setField(11, v); }
  @$pb.TagNumber(11)
  ...
  @$pb.TagNumber(12)
  set remainingDistanceMeters($3.Int32Value v) { setField(12, v); }
  @$pb.TagNumber(12)
  ...
  @$pb.TagNumber(13)
  set etaToFirstWaypoint($1.Timestamp v) { setField(13, v); }
  @$pb.TagNumber(13)
  ...
  @$pb.TagNumber(15)
  set intermediateDestinationIndex($core.int v) { $_setSignedInt32(14, v); }
  @$pb.TagNumber(15)
  ...
  @$pb.TagNumber(17)
  set currentRouteSegmentVersion($1.Timestamp v) { setField(17, v); }
  @$pb.TagNumber(17)
  ...
  @$pb.TagNumber(19)
  set remainingWaypointsVersion($1.Timestamp v) { setField(19, v); }
  @$pb.TagNumber(19)
  ...
  @$pb.TagNumber(21)
  set currentRouteSegment($core.String v) { $_setString(19, v); }
  @$pb.TagNumber(21)
  ...
  @$pb.TagNumber(22)
  set actualPickupPoint(StopLocation v) { setField(22, v); }
  @$pb.TagNumber(22)
  ...
  @$pb.TagNumber(23)
  set actualDropoffPoint(StopLocation v) { setField(23, v); }
  @$pb.TagNumber(23)
  ...
  @$pb.TagNumber(25)
  set intermediateDestinationsVersion($1.Timestamp v) { setField(25, v); }
  @$pb.TagNumber(25)
  ...
  @$pb.TagNumber(26)
  set lastLocationSnappable($core.bool v) { $_setBool(24, v); }
  @$pb.TagNumber(26)
  ...
  @$pb.TagNumber(27)
  set remainingTimeToFirstWaypoint($4.Duration v) { setField(27, v); }
  @$pb.TagNumber(27)
  ...
  @$pb.TagNumber(28)
  set currentRouteSegmentTraffic($5.ConsumableTrafficPolyline v) { setField(28, v); }
  @$pb.TagNumber(28)
  $core.bool hasCurrentRouteSegmentTraffic() => $_has(26);
  @$pb.TagNumber(28)
  void clearCurrentRouteSegmentTraffic() => clearField(28);
  @$pb.TagNumber(28)
  $5.ConsumableTrafficPolyline ensureCurrentRouteSegmentTraffic() => $_ensure(26);

  @$pb.TagNumber(29)
  $1.Timestamp get remainingWaypointsRouteVersion => $_getN(27);
  @$pb.TagNumber(29)
  set remainingWaypointsRouteVersion($1.Timestamp v) { setField(29, v); }
  @$pb.TagNumber(29)
  ...
  @$pb.TagNumber(30)
  set currentRouteSegmentTrafficVersion($1.Timestamp v) { setField(30, v); }
  @$pb.TagNumber(30)
  ...
  @$pb.TagNumber(31)
  set view(TripView v) { setField(31, v); }
  @$pb.TagNumber(31)
  ...
  @$pb.TagNumber(32)
  set actualPickupArrivalPoint(StopLocation v) { setField(32, v); }
  @$pb.TagNumber(32)
  ...
  @$pb.TagNumber(33)
  $core.List<StopLocation> get actualIntermediateDestinationArrivalPoints => $_getList(31);
...
class StopLocation extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'StopLocation', package: const $pb.PackageName(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'maps.fleetengine.v1'), createEmptyInstance: create)
    ..aOM<$2.LatLng>(1, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'point', subBuilder: $2.LatLng.create)
    ..aOM<$1.Timestamp>(2, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'timestamp', subBuilder: $1.Timestamp.create)
    ..aOM<$1.Timestamp>(3, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'stopTime', subBuilder: $1.Timestamp.create)
    ..hasRequiredFields = false
  ;
  ...
  factory StopLocation.fromBuffer($core.List<$core.int> i, [$pb.ExtensionRegistry r = $pb.ExtensionRegistry.EMPTY]) => create()..mergeFromBuffer(i, r);
  ...
  'Use [GeneratedMessageGenericExtensions.rebuild] instead. '
  'Will be removed in next major version')
  StopLocation copyWith(void Function(StopLocation) updates) => super.copyWith((message) => updates(message as StopLocation)) as StopLocation; // ignore: deprecated_member_use
  $pb.BuilderInfo get info_ => _i;
  @$core.pragma('dart2js:noInline')
  static StopLocation create() => StopLocation._();
  StopLocation createEmptyInstance() => create();
  static $pb.PbList<StopLocation> createRepeated() => $pb.PbList<StopLocation>();
  @$core.pragma('dart2js:noInline')
  static StopLocation getDefault() => _defaultInstance ??= $pb.GeneratedMessage.$_defaultFor<StopLocation>(create);
  static StopLocation? _defaultInstance;

  @$pb.TagNumber(1)
  $2.LatLng get point => $_getN(0);
  @$pb.TagNumber(1)
  set point($2.LatLng v) { setField(1, v); }
  @$pb.TagNumber(1)

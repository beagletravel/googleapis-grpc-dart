...
class CreateTripRequest extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'CreateTripRequest', package: const $pb.PackageName(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'maps.fleetengine.v1'), createEmptyInstance: create)
    ...
    ..aOM<$1.Trip>(4, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'trip', subBuilder: $1.Trip.create)
    ..aOS(5, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'tripId')
  ...
  @$pb.TagNumber(4)
  set trip($1.Trip v) { setField(4, v); }
  @$pb.TagNumber(4)
...
class GetTripRequest extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'GetTripRequest', package: const $pb.PackageName(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'maps.fleetengine.v1'), createEmptyInstance: create)
    ..aOM<$3.RequestHeader>(1, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'header', subBuilder: $3.RequestHeader.create)
    ..aOS(3, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'name')
    ..aOM<$4.Timestamp>(6, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'currentRouteSegmentVersion', subBuilder: $4.Timestamp.create)
    ..aOM<$4.Timestamp>(7, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'remainingWaypointsVersion', subBuilder: $4.Timestamp.create)
    ..e<$7.PolylineFormatType>(8, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'routeFormatType', $pb.PbFieldType.OE, defaultOrMaker: $7.PolylineFormatType.UNKNOWN_FORMAT_TYPE, valueOf: $7.PolylineFormatType.valueOf, enumValues: $7.PolylineFormatType.values)
    ..aOM<$4.Timestamp>(9, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'currentRouteSegmentTrafficVersion', subBuilder: $4.Timestamp.create)
    ..aOM<$4.Timestamp>(10, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'remainingWaypointsRouteVersion', subBuilder: $4.Timestamp.create)
    ..e<$1.TripView>(11, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'view', $pb.PbFieldType.OE, defaultOrMaker: $1.TripView.TRIP_VIEW_UNSPECIFIED, valueOf: $1.TripView.valueOf, enumValues: $1.TripView.values)
    ..hasRequiredFields = false
  ;
  ...
  'Use [GeneratedMessageGenericExtensions.rebuild] instead. '
  'Will be removed in next major version')
  GetTripRequest copyWith(void Function(GetTripRequest) updates) => super.copyWith((message) => updates(message as GetTripRequest)) as GetTripRequest; // ignore: deprecated_member_use
  $pb.BuilderInfo get info_ => _i;
  @$core.pragma('dart2js:noInline')
  ...
  @$pb.TagNumber(6)
  set currentRouteSegmentVersion($4.Timestamp v) { setField(6, v); }
  @$pb.TagNumber(6)
  ...
  @$pb.TagNumber(7)
  set remainingWaypointsVersion($4.Timestamp v) { setField(7, v); }
  @$pb.TagNumber(7)
  ...
  @$pb.TagNumber(8)
  set routeFormatType($7.PolylineFormatType v) { setField(8, v); }
  @$pb.TagNumber(8)
  ...
  @$pb.TagNumber(9)
  set currentRouteSegmentTrafficVersion($4.Timestamp v) { setField(9, v); }
  @$pb.TagNumber(9)
  ...
  @$pb.TagNumber(10)
  set remainingWaypointsRouteVersion($4.Timestamp v) { setField(10, v); }
  @$pb.TagNumber(10)
  ...
  @$pb.TagNumber(11)
  set view($1.TripView v) { setField(11, v); }
  @$pb.TagNumber(11)
...
class ReportBillableTripRequest extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'ReportBillableTripRequest', package: const $pb.PackageName(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'maps.fleetengine.v1'), createEmptyInstance: create)
    ..aOS(2, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'name')
    ..aOS(3, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'countryCode')
    ..e<$1.BillingPlatformIdentifier>(5, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'platform', $pb.PbFieldType.OE, defaultOrMaker: $1.BillingPlatformIdentifier.BILLING_PLATFORM_IDENTIFIER_UNSPECIFIED, valueOf: $1.BillingPlatformIdentifier.valueOf, enumValues: $1.BillingPlatformIdentifier.values)
    ..pPS(6, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'relatedIds')
    ..e<ReportBillableTripRequest_SolutionType>(7, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'solutionType', $pb.PbFieldType.OE, defaultOrMaker: ReportBillableTripRequest_SolutionType.SOLUTION_TYPE_UNSPECIFIED, valueOf: ReportBillableTripRequest_SolutionType.valueOf, enumValues: ReportBillableTripRequest_SolutionType.values)
    ..hasRequiredFields = false
  ;
  ...
  'Use [GeneratedMessageGenericExtensions.rebuild] instead. '
  'Will be removed in next major version')
  ReportBillableTripRequest copyWith(void Function(ReportBillableTripRequest) updates) => super.copyWith((message) => updates(message as ReportBillableTripRequest)) as ReportBillableTripRequest; // ignore: deprecated_member_use
  $pb.BuilderInfo get info_ => _i;
  @$core.pragma('dart2js:noInline')
  ...
  @$pb.TagNumber(5)
  set platform($1.BillingPlatformIdentifier v) { setField(5, v); }
  @$pb.TagNumber(5)
...
class UpdateTripRequest extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'UpdateTripRequest', package: const $pb.PackageName(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'maps.fleetengine.v1'), createEmptyInstance: create)
    ..aOM<$3.RequestHeader>(1, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'header', subBuilder: $3.RequestHeader.create)
    ..aOS(3, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'name')
    ..aOM<$1.Trip>(4, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'trip', subBuilder: $1.Trip.create)
...
class SearchTripsRequest extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'SearchTripsRequest', package: const $pb.PackageName(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'maps.fleetengine.v1'), createEmptyInstance: create)
    ..aOM<$3.RequestHeader>(1, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'header', subBuilder: $3.RequestHeader.create)
    ..aOS(3, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'parent')
    ..aOS(4, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'vehicleId')
    ..aOB(5, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'activeTripsOnly')
    ...
    ..aOM<$6.Duration>(8, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'minimumStaleness', subBuilder: $6.Duration.create)
    ..hasRequiredFields = false
  ;
  ...
  @$pb.TagNumber(8)
  set minimumStaleness($6.Duration v) { setField(8, v); }
  @$pb.TagNumber(8)
...
class SearchTripsResponse extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'SearchTripsResponse', package: const $pb.PackageName(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'maps.fleetengine.v1'), createEmptyInstance: create)
    ..pc<$1.Trip>(1, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'trips', $pb.PbFieldType.PM, subBuilder: $1.Trip.create)

...
class DomainMapping extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'DomainMapping', package: const $pb.PackageName(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'google.appengine.v1'), createEmptyInstance: create)
    ..aOS(1, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'name')
    ..aOS(2, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'id')
    ..aOM<SslSettings>(3, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'sslSettings', subBuilder: SslSettings.create)
    ..pc<ResourceRecord>(4, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'resourceRecords', $pb.PbFieldType.PM, subBuilder: ResourceRecord.create)
  ...
  'Will be removed in next major version')
  DomainMapping copyWith(void Function(DomainMapping) updates) => super.copyWith((message) => updates(message as DomainMapping)) as DomainMapping; // ignore: deprecated_member_use
...
class SslSettings extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'SslSettings', package: const $pb.PackageName(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'google.appengine.v1'), createEmptyInstance: create)
    ..aOS(1, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'certificateId')
    ..e<SslSettings_SslManagementType>(3, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'sslManagementType', $pb.PbFieldType.OE, defaultOrMaker: SslSettings_SslManagementType.SSL_MANAGEMENT_TYPE_UNSPECIFIED, valueOf: SslSettings_SslManagementType.valueOf, enumValues: SslSettings_SslManagementType.values)
  ...
  'Use [GeneratedMessageGenericExtensions.rebuild] instead. '
  'Will be removed in next major version')
  SslSettings copyWith(void Function(SslSettings) updates) => super.copyWith((message) => updates(message as SslSettings)) as SslSettings; // ignore: deprecated_member_use
  $pb.BuilderInfo get info_ => _i;
  @$core.pragma('dart2js:noInline')
...
class ResourceRecord extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'ResourceRecord', package: const $pb.PackageName(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'google.appengine.v1'), createEmptyInstance: create)
    ..aOS(1, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'name')
    ..aOS(2, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'rrdata')
    ..e<ResourceRecord_RecordType>(3, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'type', $pb.PbFieldType.OE, defaultOrMaker: ResourceRecord_RecordType.RECORD_TYPE_UNSPECIFIED, valueOf: ResourceRecord_RecordType.valueOf, enumValues: ResourceRecord_RecordType.values)
    ..hasRequiredFields = false
  ;
  ...
  'Use [GeneratedMessageGenericExtensions.rebuild] instead. '
  'Will be removed in next major version')
  ResourceRecord copyWith(void Function(ResourceRecord) updates) => super.copyWith((message) => updates(message as ResourceRecord)) as ResourceRecord; // ignore: deprecated_member_use
  $pb.BuilderInfo get info_ => _i;
  @$core.pragma('dart2js:noInline')

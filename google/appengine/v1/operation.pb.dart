...
enum OperationMetadataV1_MethodMetadata {
  createVersionMetadata, 
  notSet
}

class OperationMetadataV1 extends $pb.GeneratedMessage {
  static const $core.Map<$core.int, OperationMetadataV1_MethodMetadata> _OperationMetadataV1_MethodMetadataByTag = {
    8 : OperationMetadataV1_MethodMetadata.createVersionMetadata,
    0 : OperationMetadataV1_MethodMetadata.notSet
  };
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'OperationMetadataV1', package: const $pb.PackageName(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'google.appengine.v1'), createEmptyInstance: create)
    ..oo(0, [8])
  ...
  'Will be removed in next major version')
  OperationMetadataV1 copyWith(void Function(OperationMetadataV1) updates) => super.copyWith((message) => updates(message as OperationMetadataV1)) as OperationMetadataV1; // ignore: deprecated_member_use
  ...
  OperationMetadataV1_MethodMetadata whichMethodMetadata() => _OperationMetadataV1_MethodMetadataByTag[$_whichOneof(0)]!;
  ...
  @$pb.TagNumber(8)
  set createVersionMetadata(CreateVersionMetadataV1 v) { setField(8, v); }
  @$pb.TagNumber(8)
...
class CreateVersionMetadataV1 extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'CreateVersionMetadataV1', package: const $pb.PackageName(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'google.appengine.v1'), createEmptyInstance: create)
  ...
  factory CreateVersionMetadataV1.fromBuffer($core.List<$core.int> i, [$pb.ExtensionRegistry r = $pb.ExtensionRegistry.EMPTY]) => create()..mergeFromBuffer(i, r);
  factory CreateVersionMetadataV1.fromJson($core.String i, [$pb.ExtensionRegistry r = $pb.ExtensionRegistry.EMPTY]) => create()..mergeFromJson(i, r);
  @$core.Deprecated(
  'Using this can add significant overhead to your binary. '
  'Use [GeneratedMessageGenericExtensions.deepCopy] instead. '
  'Will be removed in next major version')
  CreateVersionMetadataV1 clone() => CreateVersionMetadataV1()..mergeFromMessage(this);
  @$core.Deprecated(
  'Using this can add significant overhead to your binary. '
  'Use [GeneratedMessageGenericExtensions.rebuild] instead. '
  'Will be removed in next major version')
  CreateVersionMetadataV1 copyWith(void Function(CreateVersionMetadataV1) updates) => super.copyWith((message) => updates(message as CreateVersionMetadataV1)) as CreateVersionMetadataV1; // ignore: deprecated_member_use
  $pb.BuilderInfo get info_ => _i;
  @$core.pragma('dart2js:noInline')
  static CreateVersionMetadataV1 create() => CreateVersionMetadataV1._();
  CreateVersionMetadataV1 createEmptyInstance() => create();
  static $pb.PbList<CreateVersionMetadataV1> createRepeated() => $pb.PbList<CreateVersionMetadataV1>();
  @$core.pragma('dart2js:noInline')
  static CreateVersionMetadataV1 getDefault() => _defaultInstance ??= $pb.GeneratedMessage.$_defaultFor<CreateVersionMetadataV1>(create);

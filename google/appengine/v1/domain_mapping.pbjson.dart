...
const DomainMapping$json = const {
  ...
  '2': const [
    ...
    const {'1': 'ssl_settings', '3': 3, '4': 1, '5': 11, '6': '.google.appengine.v1.SslSettings', '10': 'sslSettings'},
    const {'1': 'resource_records', '3': 4, '4': 3, '5': 11, '6': '.google.appengine.v1.ResourceRecord', '10': 'resourceRecords'},
  ],
};

/// Descriptor for `DomainMapping`. Decode as a `google.protobuf.DescriptorProto`.
final $typed_data.Uint8List domainMappingDescriptor = $convert.base64Decode('');
@$core.Deprecated('Use sslSettingsDescriptor instead')
const SslSettings$json = const {
  '1': 'SslSettings',
  '2': const [
    const {'1': 'certificate_id', '3': 1, '4': 1, '5': 9, '10': 'certificateId'},
    const {'1': 'ssl_management_type', '3': 3, '4': 1, '5': 14, '6': '.google.appengine.v1.SslSettings.SslManagementType', '10': 'sslManagementType'},
    const {'1': 'pending_managed_certificate_id', '3': 4, '4': 1, '5': 9, '10': 'pendingManagedCertificateId'},
  ],
...
const ResourceRecord$json = const {
  ...
  '2': const [
    ...
    const {'1': 'type', '3': 3, '4': 1, '5': 14, '6': '.google.appengine.v1.ResourceRecord.RecordType', '10': 'type'},
  ],
...
final $typed_data.Uint8List resourceRecordDescriptor = $convert.base64Decode('');

...
final $typed_data.Uint8List authFailActionDescriptor = $convert.base64Decode('Cg5BdXRoRmFpbEFjdGlvbhIgChxBVVRIX0ZBSUxfQUNUSU9OX1VOU1BFQ0lGSUVEEAASHQoZQVVUSF9GQUlMX0FDVElPTl9SRURJUkVDVBABEiEKHUFVVEhfRkFJTF9BQ1RJT05fVU5BVVRIT1JJWkVEEAI=');
...
final $typed_data.Uint8List loginRequirementDescriptor = $convert.base64Decode('ChBMb2dpblJlcXVpcmVtZW50EhUKEUxPR0lOX1VOU1BFQ0lGSUVEEAASEgoOTE9HSU5fT1BUSU9OQUwQARIPCgtMT0dJTl9BRE1JThACEhIKDkxPR0lOX1JFUVVJUkVEEAM=');
...
final $typed_data.Uint8List securityLevelDescriptor = $convert.base64Decode('Cg1TZWN1cml0eUxldmVsEhYKElNFQ1VSRV9VTlNQRUNJRklFRBAAEhIKDlNFQ1VSRV9ERUZBVUxUEAASEAoMU0VDVVJFX05FVkVSEAESEwoPU0VDVVJFX09QVElPTkFMEAISEQoNU0VDVVJFX0FMV0FZUxADGgIQAQ==');
@$core.Deprecated('Use apiConfigHandlerDescriptor instead')
const ApiConfigHandler$json = const {
  '1': 'ApiConfigHandler',
  '2': const [
    const {'1': 'auth_fail_action', '3': 1, '4': 1, '5': 14, '6': '.google.appengine.v1beta.AuthFailAction', '10': 'authFailAction'},
    const {'1': 'login', '3': 2, '4': 1, '5': 14, '6': '.google.appengine.v1beta.LoginRequirement', '10': 'login'},
    const {'1': 'script', '3': 3, '4': 1, '5': 9, '10': 'script'},
    const {'1': 'security_level', '3': 4, '4': 1, '5': 14, '6': '.google.appengine.v1beta.SecurityLevel', '10': 'securityLevel'},
    const {'1': 'url', '3': 5, '4': 1, '5': 9, '10': 'url'},
  ],
};

/// Descriptor for `ApiConfigHandler`. Decode as a `google.protobuf.DescriptorProto`.
final $typed_data.Uint8List apiConfigHandlerDescriptor = $convert.base64Decode('');
@$core.Deprecated('Use errorHandlerDescriptor instead')
const ErrorHandler$json = const {
  '1': 'ErrorHandler',
  '2': const [
    const {'1': 'error_code', '3': 1, '4': 1, '5': 14, '6': '.google.appengine.v1beta.ErrorHandler.ErrorCode', '10': 'errorCode'},
...
final $typed_data.Uint8List errorHandlerDescriptor = $convert.base64Decode('');
@$core.Deprecated('Use urlMapDescriptor instead')
const UrlMap$json = const {
  '1': 'UrlMap',
  '2': const [
    const {'1': 'url_regex', '3': 1, '4': 1, '5': 9, '10': 'urlRegex'},
    const {'1': 'static_files', '3': 2, '4': 1, '5': 11, '6': '.google.appengine.v1beta.StaticFilesHandler', '9': 0, '10': 'staticFiles'},
    const {'1': 'script', '3': 3, '4': 1, '5': 11, '6': '.google.appengine.v1beta.ScriptHandler', '9': 0, '10': 'script'},
    const {'1': 'api_endpoint', '3': 4, '4': 1, '5': 11, '6': '.google.appengine.v1beta.ApiEndpointHandler', '9': 0, '10': 'apiEndpoint'},
    const {'1': 'security_level', '3': 5, '4': 1, '5': 14, '6': '.google.appengine.v1beta.SecurityLevel', '10': 'securityLevel'},
    const {'1': 'login', '3': 6, '4': 1, '5': 14, '6': '.google.appengine.v1beta.LoginRequirement', '10': 'login'},
    const {'1': 'auth_fail_action', '3': 7, '4': 1, '5': 14, '6': '.google.appengine.v1beta.AuthFailAction', '10': 'authFailAction'},
    const {'1': 'redirect_http_response_code', '3': 8, '4': 1, '5': 14, '6': '.google.appengine.v1beta.UrlMap.RedirectHttpResponseCode', '10': 'redirectHttpResponseCode'},
  ],
...
const StaticFilesHandler$json = const {
  ...
  '2': const [
    ...
    const {'1': 'http_headers', '3': 3, '4': 3, '5': 11, '6': '.google.appengine.v1beta.StaticFilesHandler.HttpHeadersEntry', '10': 'httpHeaders'},
...
final $typed_data.Uint8List scriptHandlerDescriptor = $convert.base64Decode('Cg1TY3JpcHRIYW5kbGVyEh8KC3NjcmlwdF9wYXRoGAEgASgJUgpzY3JpcHRQYXRo');
...
final $typed_data.Uint8List apiEndpointHandlerDescriptor = $convert.base64Decode('ChJBcGlFbmRwb2ludEhhbmRsZXISHwoLc2NyaXB0X3BhdGgYASABKAlSCnNjcmlwdFBhdGg=');
...
final $typed_data.Uint8List healthCheckDescriptor = $convert.base64Decode('');
...
const LivenessCheck$json = const {
  ...
  '2': const [
    ...
    const {'1': 'check_interval', '3': 5, '4': 1, '5': 11, '6': '.google.protobuf.Duration', '10': 'checkInterval'},
    const {'1': 'timeout', '3': 6, '4': 1, '5': 11, '6': '.google.protobuf.Duration', '10': 'timeout'},
    const {'1': 'initial_delay', '3': 7, '4': 1, '5': 11, '6': '.google.protobuf.Duration', '10': 'initialDelay'},
  ],
};

/// Descriptor for `LivenessCheck`. Decode as a `google.protobuf.DescriptorProto`.
final $typed_data.Uint8List livenessCheckDescriptor = $convert.base64Decode('');
...
final $typed_data.Uint8List libraryDescriptor = $convert.base64Decode('CgdMaWJyYXJ5EhIKBG5hbWUYASABKAlSBG5hbWUSGAoHdmVyc2lvbhgCIAEoCVIHdmVyc2lvbg==');

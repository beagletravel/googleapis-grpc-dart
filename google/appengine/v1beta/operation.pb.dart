...
class OperationMetadataV1Beta extends $pb.GeneratedMessage {
  static const $core.Map<$core.int, OperationMetadataV1Beta_MethodMetadata> _OperationMetadataV1Beta_MethodMetadataByTag = {
    8 : OperationMetadataV1Beta_MethodMetadata.createVersionMetadata,
    0 : OperationMetadataV1Beta_MethodMetadata.notSet
  };
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'OperationMetadataV1Beta', package: const $pb.PackageName(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'google.appengine.v1beta'), createEmptyInstance: create)
    ..oo(0, [8])
    ..aOS(1, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'method')
    ..aOM<$0.Timestamp>(2, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'insertTime', subBuilder: $0.Timestamp.create)
  ...
  factory OperationMetadataV1Beta.fromBuffer($core.List<$core.int> i, [$pb.ExtensionRegistry r = $pb.ExtensionRegistry.EMPTY]) => create()..mergeFromBuffer(i, r);
  factory OperationMetadataV1Beta.fromJson($core.String i, [$pb.ExtensionRegistry r = $pb.ExtensionRegistry.EMPTY]) => create()..mergeFromJson(i, r);
  @$core.Deprecated(
  'Using this can add significant overhead to your binary. '
  'Use [GeneratedMessageGenericExtensions.deepCopy] instead. '
  'Will be removed in next major version')
  OperationMetadataV1Beta clone() => OperationMetadataV1Beta()..mergeFromMessage(this);
  @$core.Deprecated(
  'Using this can add significant overhead to your binary. '
  'Use [GeneratedMessageGenericExtensions.rebuild] instead. '
  'Will be removed in next major version')
  OperationMetadataV1Beta copyWith(void Function(OperationMetadataV1Beta) updates) => super.copyWith((message) => updates(message as OperationMetadataV1Beta)) as OperationMetadataV1Beta; // ignore: deprecated_member_use
  ...
  static $pb.PbList<OperationMetadataV1Beta> createRepeated() => $pb.PbList<OperationMetadataV1Beta>();
  @$core.pragma('dart2js:noInline')
  static OperationMetadataV1Beta getDefault() => _defaultInstance ??= $pb.GeneratedMessage.$_defaultFor<OperationMetadataV1Beta>(create);
  static OperationMetadataV1Beta? _defaultInstance;

  OperationMetadataV1Beta_MethodMetadata whichMethodMetadata() => _OperationMetadataV1Beta_MethodMetadataByTag[$_whichOneof(0)]!;
  ...
  @$pb.TagNumber(6)
  set ephemeralMessage($core.String v) { $_setString(5, v); }
  @$pb.TagNumber(6)
  ...
  @$pb.TagNumber(8)
  set createVersionMetadata(CreateVersionMetadataV1Beta v) { setField(8, v); }
  @$pb.TagNumber(8)
...
class CreateVersionMetadataV1Beta extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'CreateVersionMetadataV1Beta', package: const $pb.PackageName(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'google.appengine.v1beta'), createEmptyInstance: create)
  ...
  factory CreateVersionMetadataV1Beta.fromBuffer($core.List<$core.int> i, [$pb.ExtensionRegistry r = $pb.ExtensionRegistry.EMPTY]) => create()..mergeFromBuffer(i, r);
  factory CreateVersionMetadataV1Beta.fromJson($core.String i, [$pb.ExtensionRegistry r = $pb.ExtensionRegistry.EMPTY]) => create()..mergeFromJson(i, r);
  @$core.Deprecated(
  'Using this can add significant overhead to your binary. '
  'Use [GeneratedMessageGenericExtensions.deepCopy] instead. '
  'Will be removed in next major version')
  CreateVersionMetadataV1Beta clone() => CreateVersionMetadataV1Beta()..mergeFromMessage(this);
  @$core.Deprecated(
  'Using this can add significant overhead to your binary. '
  'Use [GeneratedMessageGenericExtensions.rebuild] instead. '
  'Will be removed in next major version')
  CreateVersionMetadataV1Beta copyWith(void Function(CreateVersionMetadataV1Beta) updates) => super.copyWith((message) => updates(message as CreateVersionMetadataV1Beta)) as CreateVersionMetadataV1Beta; // ignore: deprecated_member_use
  $pb.BuilderInfo get info_ => _i;
  @$core.pragma('dart2js:noInline')
  static CreateVersionMetadataV1Beta create() => CreateVersionMetadataV1Beta._();
  CreateVersionMetadataV1Beta createEmptyInstance() => create();
  static $pb.PbList<CreateVersionMetadataV1Beta> createRepeated() => $pb.PbList<CreateVersionMetadataV1Beta>();
  @$core.pragma('dart2js:noInline')
  static CreateVersionMetadataV1Beta getDefault() => _defaultInstance ??= $pb.GeneratedMessage.$_defaultFor<CreateVersionMetadataV1Beta>(create);

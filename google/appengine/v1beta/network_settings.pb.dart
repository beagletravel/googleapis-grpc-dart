...
class NetworkSettings extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'NetworkSettings', package: const $pb.PackageName(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'google.appengine.v1beta'), createEmptyInstance: create)
    ..e<NetworkSettings_IngressTrafficAllowed>(1, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'ingressTrafficAllowed', $pb.PbFieldType.OE, defaultOrMaker: NetworkSettings_IngressTrafficAllowed.INGRESS_TRAFFIC_ALLOWED_UNSPECIFIED, valueOf: NetworkSettings_IngressTrafficAllowed.valueOf, enumValues: NetworkSettings_IngressTrafficAllowed.values)
  ...
  @$pb.TagNumber(1)
  set ingressTrafficAllowed(NetworkSettings_IngressTrafficAllowed v) { setField(1, v); }
  @$pb.TagNumber(1)

...
class LocationMetadata extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'LocationMetadata', package: const $pb.PackageName(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'google.appengine.v1beta'), createEmptyInstance: create)
    ..aOB(2, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'standardEnvironmentAvailable')
    ..aOB(4, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'flexibleEnvironmentAvailable')
    ..aOB(6, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'searchApiAvailable')
  ...
  @$pb.TagNumber(2)
  set standardEnvironmentAvailable($core.bool v) { $_setBool(0, v); }
  @$pb.TagNumber(2)
  ...
  @$pb.TagNumber(4)
  set flexibleEnvironmentAvailable($core.bool v) { $_setBool(1, v); }
  @$pb.TagNumber(4)
  ...
  @$pb.TagNumber(6)
  set searchApiAvailable($core.bool v) { $_setBool(2, v); }
  @$pb.TagNumber(6)

...
const Service$json = const {
  ...
  '2': const [
    ...
    const {'1': 'split', '3': 3, '4': 1, '5': 11, '6': '.google.appengine.v1beta.TrafficSplit', '10': 'split'},
    const {'1': 'network_settings', '3': 6, '4': 1, '5': 11, '6': '.google.appengine.v1beta.NetworkSettings', '10': 'networkSettings'},
  ],
};

/// Descriptor for `Service`. Decode as a `google.protobuf.DescriptorProto`.
final $typed_data.Uint8List serviceDescriptor = $convert.base64Decode('CgdTZXJ2aWNlEhIKBG5hbWUYASABKAlSBG5hbWUSDgoCaWQYAiABKAlSAmlkEjsKBXNwbGl0GAMgASgLMiUuZ29vZ2xlLmFwcGVuZ2luZS52MWJldGEuVHJhZmZpY1NwbGl0UgVzcGxpdBJTChBuZXR3b3JrX3NldHRpbmdzGAYgASgLMiguZ29vZ2xlLmFwcGVuZ2luZS52MWJldGEuTmV0d29ya1NldHRpbmdzUg9uZXR3b3JrU2V0dGluZ3M=');
@$core.Deprecated('Use trafficSplitDescriptor instead')
const TrafficSplit$json = const {
  '1': 'TrafficSplit',
  '2': const [
    const {'1': 'shard_by', '3': 1, '4': 1, '5': 14, '6': '.google.appengine.v1beta.TrafficSplit.ShardBy', '10': 'shardBy'},
    const {'1': 'allocations', '3': 2, '4': 3, '5': 11, '6': '.google.appengine.v1beta.TrafficSplit.AllocationsEntry', '10': 'allocations'},
  ],

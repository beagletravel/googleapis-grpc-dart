...
class ApiConfigHandler extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'ApiConfigHandler', package: const $pb.PackageName(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'google.appengine.v1beta'), createEmptyInstance: create)
    ..e<AuthFailAction>(1, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'authFailAction', $pb.PbFieldType.OE, defaultOrMaker: AuthFailAction.AUTH_FAIL_ACTION_UNSPECIFIED, valueOf: AuthFailAction.valueOf, enumValues: AuthFailAction.values)
    ..e<LoginRequirement>(2, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'login', $pb.PbFieldType.OE, defaultOrMaker: LoginRequirement.LOGIN_UNSPECIFIED, valueOf: LoginRequirement.valueOf, enumValues: LoginRequirement.values)
    ..aOS(3, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'script')
    ..e<SecurityLevel>(4, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'securityLevel', $pb.PbFieldType.OE, defaultOrMaker: SecurityLevel.SECURE_UNSPECIFIED, valueOf: SecurityLevel.valueOf, enumValues: SecurityLevel.values)
  ...
  factory ApiConfigHandler.fromBuffer($core.List<$core.int> i, [$pb.ExtensionRegistry r = $pb.ExtensionRegistry.EMPTY]) => create()..mergeFromBuffer(i, r);
  factory ApiConfigHandler.fromJson($core.String i, [$pb.ExtensionRegistry r = $pb.ExtensionRegistry.EMPTY]) => create()..mergeFromJson(i, r);
  @$core.Deprecated(
  ...
  'Will be removed in next major version')
  ApiConfigHandler copyWith(void Function(ApiConfigHandler) updates) => super.copyWith((message) => updates(message as ApiConfigHandler)) as ApiConfigHandler; // ignore: deprecated_member_use
  $pb.BuilderInfo get info_ => _i;
  @$core.pragma('dart2js:noInline')
  static ApiConfigHandler create() => ApiConfigHandler._();
  ApiConfigHandler createEmptyInstance() => create();
  static $pb.PbList<ApiConfigHandler> createRepeated() => $pb.PbList<ApiConfigHandler>();
  @$core.pragma('dart2js:noInline')
  static ApiConfigHandler getDefault() => _defaultInstance ??= $pb.GeneratedMessage.$_defaultFor<ApiConfigHandler>(create);
...
class ErrorHandler extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'ErrorHandler', package: const $pb.PackageName(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'google.appengine.v1beta'), createEmptyInstance: create)
    ..e<ErrorHandler_ErrorCode>(1, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'errorCode', $pb.PbFieldType.OE, defaultOrMaker: ErrorHandler_ErrorCode.ERROR_CODE_UNSPECIFIED, valueOf: ErrorHandler_ErrorCode.valueOf, enumValues: ErrorHandler_ErrorCode.values)
    ..aOS(2, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'staticFile')
  ...
  @$pb.TagNumber(2)
  set staticFile($core.String v) { $_setString(1, v); }
  @$pb.TagNumber(2)
...
class UrlMap extends $pb.GeneratedMessage {
  static const $core.Map<$core.int, UrlMap_HandlerType> _UrlMap_HandlerTypeByTag = {
    2 : UrlMap_HandlerType.staticFiles,
    3 : UrlMap_HandlerType.script,
    4 : UrlMap_HandlerType.apiEndpoint,
    0 : UrlMap_HandlerType.notSet
  };
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'UrlMap', package: const $pb.PackageName(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'google.appengine.v1beta'), createEmptyInstance: create)
    ..oo(0, [2, 3, 4])
    ..aOS(1, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'urlRegex')
    ..aOM<StaticFilesHandler>(2, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'staticFiles', subBuilder: StaticFilesHandler.create)
    ..aOM<ScriptHandler>(3, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'script', subBuilder: ScriptHandler.create)
    ..aOM<ApiEndpointHandler>(4, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'apiEndpoint', subBuilder: ApiEndpointHandler.create)
    ..e<SecurityLevel>(5, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'securityLevel', $pb.PbFieldType.OE, defaultOrMaker: SecurityLevel.SECURE_UNSPECIFIED, valueOf: SecurityLevel.valueOf, enumValues: SecurityLevel.values)
    ..e<LoginRequirement>(6, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'login', $pb.PbFieldType.OE, defaultOrMaker: LoginRequirement.LOGIN_UNSPECIFIED, valueOf: LoginRequirement.valueOf, enumValues: LoginRequirement.values)
  ...
  factory UrlMap.fromBuffer($core.List<$core.int> i, [$pb.ExtensionRegistry r = $pb.ExtensionRegistry.EMPTY]) => create()..mergeFromBuffer(i, r);
  factory UrlMap.fromJson($core.String i, [$pb.ExtensionRegistry r = $pb.ExtensionRegistry.EMPTY]) => create()..mergeFromJson(i, r);
  @$core.Deprecated(
  'Using this can add significant overhead to your binary. '
  'Use [GeneratedMessageGenericExtensions.deepCopy] instead. '
  'Will be removed in next major version')
  ...
  'Use [GeneratedMessageGenericExtensions.rebuild] instead. '
  'Will be removed in next major version')
  UrlMap copyWith(void Function(UrlMap) updates) => super.copyWith((message) => updates(message as UrlMap)) as UrlMap; // ignore: deprecated_member_use
  $pb.BuilderInfo get info_ => _i;
  @$core.pragma('dart2js:noInline')
  ...
  @$core.pragma('dart2js:noInline')
  static UrlMap getDefault() => _defaultInstance ??= $pb.GeneratedMessage.$_defaultFor<UrlMap>(create);
  static UrlMap? _defaultInstance;

  UrlMap_HandlerType whichHandlerType() => _UrlMap_HandlerTypeByTag[$_whichOneof(0)]!;
  void clearHandlerType() => clearField($_whichOneof(0));

  @$pb.TagNumber(1)
  $core.String get urlRegex => $_getSZ(0);
  @$pb.TagNumber(1)
  set urlRegex($core.String v) { $_setString(0, v); }
  @$pb.TagNumber(1)
...
class StaticFilesHandler extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'StaticFilesHandler', package: const $pb.PackageName(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'google.appengine.v1beta'), createEmptyInstance: create)
    ..aOS(1, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'path')
    ..aOS(2, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'uploadPathRegex')
    ..m<$core.String, $core.String>(3, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'httpHeaders', entryClassName: 'StaticFilesHandler.HttpHeadersEntry', keyFieldType: $pb.PbFieldType.OS, valueFieldType: $pb.PbFieldType.OS, packageName: const $pb.PackageName('google.appengine.v1beta'))
  ...
  factory StaticFilesHandler.fromBuffer($core.List<$core.int> i, [$pb.ExtensionRegistry r = $pb.ExtensionRegistry.EMPTY]) => create()..mergeFromBuffer(i, r);
  factory StaticFilesHandler.fromJson($core.String i, [$pb.ExtensionRegistry r = $pb.ExtensionRegistry.EMPTY]) => create()..mergeFromJson(i, r);
  @$core.Deprecated(
  'Using this can add significant overhead to your binary. '
  'Use [GeneratedMessageGenericExtensions.deepCopy] instead. '
  'Will be removed in next major version')
  ...
  'Use [GeneratedMessageGenericExtensions.rebuild] instead. '
  'Will be removed in next major version')
  StaticFilesHandler copyWith(void Function(StaticFilesHandler) updates) => super.copyWith((message) => updates(message as StaticFilesHandler)) as StaticFilesHandler; // ignore: deprecated_member_use
  $pb.BuilderInfo get info_ => _i;
  @$core.pragma('dart2js:noInline')
  static StaticFilesHandler create() => StaticFilesHandler._();
  StaticFilesHandler createEmptyInstance() => create();
  static $pb.PbList<StaticFilesHandler> createRepeated() => $pb.PbList<StaticFilesHandler>();
  @$core.pragma('dart2js:noInline')
  static StaticFilesHandler getDefault() => _defaultInstance ??= $pb.GeneratedMessage.$_defaultFor<StaticFilesHandler>(create);
  ...
  @$pb.TagNumber(2)
  set uploadPathRegex($core.String v) { $_setString(1, v); }
  @$pb.TagNumber(2)
  ...
  @$pb.TagNumber(5)
  set expiration($0.Duration v) { setField(5, v); }
  @$pb.TagNumber(5)
  ...
  @$pb.TagNumber(6)
  set requireMatchingFile($core.bool v) { $_setBool(5, v); }
  @$pb.TagNumber(6)
  ...
  @$pb.TagNumber(7)
  set applicationReadable($core.bool v) { $_setBool(6, v); }
  @$pb.TagNumber(7)
...
class ScriptHandler extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'ScriptHandler', package: const $pb.PackageName(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'google.appengine.v1beta'), createEmptyInstance: create)
    ..aOS(1, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'scriptPath')
    ..hasRequiredFields = false
  ;
  ...
  factory ScriptHandler.fromBuffer($core.List<$core.int> i, [$pb.ExtensionRegistry r = $pb.ExtensionRegistry.EMPTY]) => create()..mergeFromBuffer(i, r);
  factory ScriptHandler.fromJson($core.String i, [$pb.ExtensionRegistry r = $pb.ExtensionRegistry.EMPTY]) => create()..mergeFromJson(i, r);
  @$core.Deprecated(
  'Using this can add significant overhead to your binary. '
  'Use [GeneratedMessageGenericExtensions.deepCopy] instead. '
  'Will be removed in next major version')
  ...
  'Use [GeneratedMessageGenericExtensions.rebuild] instead. '
  'Will be removed in next major version')
  ScriptHandler copyWith(void Function(ScriptHandler) updates) => super.copyWith((message) => updates(message as ScriptHandler)) as ScriptHandler; // ignore: deprecated_member_use
  $pb.BuilderInfo get info_ => _i;
  @$core.pragma('dart2js:noInline')
  static ScriptHandler create() => ScriptHandler._();
  ScriptHandler createEmptyInstance() => create();
  static $pb.PbList<ScriptHandler> createRepeated() => $pb.PbList<ScriptHandler>();
  @$core.pragma('dart2js:noInline')
  static ScriptHandler getDefault() => _defaultInstance ??= $pb.GeneratedMessage.$_defaultFor<ScriptHandler>(create);
  static ScriptHandler? _defaultInstance;

  @$pb.TagNumber(1)
  $core.String get scriptPath => $_getSZ(0);
  @$pb.TagNumber(1)
  set scriptPath($core.String v) { $_setString(0, v); }
  @$pb.TagNumber(1)
...
class ApiEndpointHandler extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'ApiEndpointHandler', package: const $pb.PackageName(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'google.appengine.v1beta'), createEmptyInstance: create)
    ..aOS(1, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'scriptPath')
    ..hasRequiredFields = false
  ;
  ...
  factory ApiEndpointHandler.fromBuffer($core.List<$core.int> i, [$pb.ExtensionRegistry r = $pb.ExtensionRegistry.EMPTY]) => create()..mergeFromBuffer(i, r);
  factory ApiEndpointHandler.fromJson($core.String i, [$pb.ExtensionRegistry r = $pb.ExtensionRegistry.EMPTY]) => create()..mergeFromJson(i, r);
  @$core.Deprecated(
  'Using this can add significant overhead to your binary. '
  'Use [GeneratedMessageGenericExtensions.deepCopy] instead. '
  'Will be removed in next major version')
  ...
  'Use [GeneratedMessageGenericExtensions.rebuild] instead. '
  'Will be removed in next major version')
  ApiEndpointHandler copyWith(void Function(ApiEndpointHandler) updates) => super.copyWith((message) => updates(message as ApiEndpointHandler)) as ApiEndpointHandler; // ignore: deprecated_member_use
  $pb.BuilderInfo get info_ => _i;
  @$core.pragma('dart2js:noInline')
  static ApiEndpointHandler create() => ApiEndpointHandler._();
  ApiEndpointHandler createEmptyInstance() => create();
  static $pb.PbList<ApiEndpointHandler> createRepeated() => $pb.PbList<ApiEndpointHandler>();
  @$core.pragma('dart2js:noInline')
  static ApiEndpointHandler getDefault() => _defaultInstance ??= $pb.GeneratedMessage.$_defaultFor<ApiEndpointHandler>(create);
...
class HealthCheck extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'HealthCheck', package: const $pb.PackageName(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'google.appengine.v1beta'), createEmptyInstance: create)
    ..aOB(1, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'disableHealthCheck')
    ..aOS(2, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'host')
    ..a<$core.int>(3, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'healthyThreshold', $pb.PbFieldType.OU3)
    ..a<$core.int>(4, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'unhealthyThreshold', $pb.PbFieldType.OU3)
  ...
  @$pb.TagNumber(1)
  set disableHealthCheck($core.bool v) { $_setBool(0, v); }
  @$pb.TagNumber(1)
  ...
  @$pb.TagNumber(3)
  set healthyThreshold($core.int v) { $_setUnsignedInt32(2, v); }
  @$pb.TagNumber(3)
  ...
  @$pb.TagNumber(4)
  set unhealthyThreshold($core.int v) { $_setUnsignedInt32(3, v); }
  @$pb.TagNumber(4)
  ...
  @$pb.TagNumber(5)
  set restartThreshold($core.int v) { $_setUnsignedInt32(4, v); }
  @$pb.TagNumber(5)
  ...
  @$pb.TagNumber(6)
  set checkInterval($0.Duration v) { setField(6, v); }
  @$pb.TagNumber(6)
  ...
  @$pb.TagNumber(7)
  set timeout($0.Duration v) { setField(7, v); }
  @$pb.TagNumber(7)
...
class ReadinessCheck extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'ReadinessCheck', package: const $pb.PackageName(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'google.appengine.v1beta'), createEmptyInstance: create)
    ..aOS(1, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'path')
    ..aOS(2, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'host')
    ..a<$core.int>(3, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'failureThreshold', $pb.PbFieldType.OU3)
    ..a<$core.int>(4, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'successThreshold', $pb.PbFieldType.OU3)
  ...
  factory ReadinessCheck.fromBuffer($core.List<$core.int> i, [$pb.ExtensionRegistry r = $pb.ExtensionRegistry.EMPTY]) => create()..mergeFromBuffer(i, r);
  factory ReadinessCheck.fromJson($core.String i, [$pb.ExtensionRegistry r = $pb.ExtensionRegistry.EMPTY]) => create()..mergeFromJson(i, r);
  @$core.Deprecated(
  'Using this can add significant overhead to your binary. '
  'Use [GeneratedMessageGenericExtensions.deepCopy] instead. '
  'Will be removed in next major version')
  ...
  'Use [GeneratedMessageGenericExtensions.rebuild] instead. '
  'Will be removed in next major version')
  ReadinessCheck copyWith(void Function(ReadinessCheck) updates) => super.copyWith((message) => updates(message as ReadinessCheck)) as ReadinessCheck; // ignore: deprecated_member_use
  $pb.BuilderInfo get info_ => _i;
  @$core.pragma('dart2js:noInline')
  static ReadinessCheck create() => ReadinessCheck._();
  ReadinessCheck createEmptyInstance() => create();
  static $pb.PbList<ReadinessCheck> createRepeated() => $pb.PbList<ReadinessCheck>();
  @$core.pragma('dart2js:noInline')
  static ReadinessCheck getDefault() => _defaultInstance ??= $pb.GeneratedMessage.$_defaultFor<ReadinessCheck>(create);
  ...
  @$pb.TagNumber(3)
  set failureThreshold($core.int v) { $_setUnsignedInt32(2, v); }
  @$pb.TagNumber(3)
  ...
  @$pb.TagNumber(4)
  set successThreshold($core.int v) { $_setUnsignedInt32(3, v); }
  @$pb.TagNumber(4)
  ...
  @$pb.TagNumber(5)
  set checkInterval($0.Duration v) { setField(5, v); }
  @$pb.TagNumber(5)
  ...
  @$pb.TagNumber(6)
  set timeout($0.Duration v) { setField(6, v); }
  @$pb.TagNumber(6)
  ...
  @$pb.TagNumber(7)
  set appStartTimeout($0.Duration v) { setField(7, v); }
  @$pb.TagNumber(7)
...
class LivenessCheck extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'LivenessCheck', package: const $pb.PackageName(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'google.appengine.v1beta'), createEmptyInstance: create)
    ..aOS(1, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'path')
    ..aOS(2, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'host')
    ..a<$core.int>(3, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'failureThreshold', $pb.PbFieldType.OU3)
    ..a<$core.int>(4, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'successThreshold', $pb.PbFieldType.OU3)
  ...
  factory LivenessCheck.fromBuffer($core.List<$core.int> i, [$pb.ExtensionRegistry r = $pb.ExtensionRegistry.EMPTY]) => create()..mergeFromBuffer(i, r);
  factory LivenessCheck.fromJson($core.String i, [$pb.ExtensionRegistry r = $pb.ExtensionRegistry.EMPTY]) => create()..mergeFromJson(i, r);
  @$core.Deprecated(
  'Using this can add significant overhead to your binary. '
  'Use [GeneratedMessageGenericExtensions.deepCopy] instead. '
  'Will be removed in next major version')
  ...
  'Use [GeneratedMessageGenericExtensions.rebuild] instead. '
  'Will be removed in next major version')
  LivenessCheck copyWith(void Function(LivenessCheck) updates) => super.copyWith((message) => updates(message as LivenessCheck)) as LivenessCheck; // ignore: deprecated_member_use
  $pb.BuilderInfo get info_ => _i;
  @$core.pragma('dart2js:noInline')
  static LivenessCheck create() => LivenessCheck._();
  LivenessCheck createEmptyInstance() => create();
  static $pb.PbList<LivenessCheck> createRepeated() => $pb.PbList<LivenessCheck>();
  @$core.pragma('dart2js:noInline')
  static LivenessCheck getDefault() => _defaultInstance ??= $pb.GeneratedMessage.$_defaultFor<LivenessCheck>(create);
  ...
  @$pb.TagNumber(7)
  set initialDelay($0.Duration v) { setField(7, v); }
  @$pb.TagNumber(7)
...
class Library extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'Library', package: const $pb.PackageName(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'google.appengine.v1beta'), createEmptyInstance: create)
  ...
  'Use [GeneratedMessageGenericExtensions.rebuild] instead. '
  'Will be removed in next major version')
  Library copyWith(void Function(Library) updates) => super.copyWith((message) => updates(message as Library)) as Library; // ignore: deprecated_member_use
  $pb.BuilderInfo get info_ => _i;
  @$core.pragma('dart2js:noInline')

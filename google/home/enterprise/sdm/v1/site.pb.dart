...
class Structure extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'Structure', package: const $pb.PackageName(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'google.home.enterprise.sdm.v1'), createEmptyInstance: create)
    ..aOS(1, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'name')
    ..aOM<$0.Struct>(2, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'traits', subBuilder: $0.Struct.create)
  ...
  'Will be removed in next major version')
  Structure copyWith(void Function(Structure) updates) => super.copyWith((message) => updates(message as Structure)) as Structure; // ignore: deprecated_member_use
  ...
  @$pb.TagNumber(2)
  set traits($0.Struct v) { setField(2, v); }
  @$pb.TagNumber(2)
...
class Room extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'Room', package: const $pb.PackageName(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'google.home.enterprise.sdm.v1'), createEmptyInstance: create)
    ..aOS(1, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'name')
    ..aOM<$0.Struct>(2, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'traits', subBuilder: $0.Struct.create)
    ..hasRequiredFields = false
  ;

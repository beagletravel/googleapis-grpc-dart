...
class Device extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'Device', package: const $pb.PackageName(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'google.home.graph.v1'), createEmptyInstance: create)
    ..aOS(1, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'id')
    ..aOS(2, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'type')
    ..pPS(3, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'traits')
    ..aOM<DeviceNames>(4, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'name', subBuilder: DeviceNames.create)
    ..aOB(5, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'willReportState')
    ..aOS(6, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'roomHint')
    ..aOS(7, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'structureHint')
    ..aOM<DeviceInfo>(8, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'deviceInfo', subBuilder: DeviceInfo.create)
    ..aOM<$0.Struct>(9, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'attributes', subBuilder: $0.Struct.create)
    ..aOM<$0.Struct>(10, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'customData', subBuilder: $0.Struct.create)
    ..pc<AgentOtherDeviceId>(11, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'otherDeviceIds', $pb.PbFieldType.PM, subBuilder: AgentOtherDeviceId.create)
    ..aOB(12, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'notificationSupportedByAgent')
  ...
  @$pb.TagNumber(10)
  set customData($0.Struct v) { setField(10, v); }
  @$pb.TagNumber(10)
  ...
  @$pb.TagNumber(12)
  set notificationSupportedByAgent($core.bool v) { $_setBool(11, v); }
  @$pb.TagNumber(12)
...
class DeviceNames extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'DeviceNames', package: const $pb.PackageName(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'google.home.graph.v1'), createEmptyInstance: create)
    ..aOS(1, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'name')
    ..pPS(2, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'nicknames')
    ..pPS(3, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'defaultNames')
    ..hasRequiredFields = false
  ;
  ...
  factory DeviceNames.fromBuffer($core.List<$core.int> i, [$pb.ExtensionRegistry r = $pb.ExtensionRegistry.EMPTY]) => create()..mergeFromBuffer(i, r);
  factory DeviceNames.fromJson($core.String i, [$pb.ExtensionRegistry r = $pb.ExtensionRegistry.EMPTY]) => create()..mergeFromJson(i, r);
  @$core.Deprecated(
  'Using this can add significant overhead to your binary. '
  'Use [GeneratedMessageGenericExtensions.deepCopy] instead. '
  'Will be removed in next major version')
  ...
  'Use [GeneratedMessageGenericExtensions.rebuild] instead. '
  'Will be removed in next major version')
  DeviceNames copyWith(void Function(DeviceNames) updates) => super.copyWith((message) => updates(message as DeviceNames)) as DeviceNames; // ignore: deprecated_member_use
  $pb.BuilderInfo get info_ => _i;
  @$core.pragma('dart2js:noInline')
  ...
  @$core.pragma('dart2js:noInline')
  static DeviceNames getDefault() => _defaultInstance ??= $pb.GeneratedMessage.$_defaultFor<DeviceNames>(create);
...
class DeviceInfo extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'DeviceInfo', package: const $pb.PackageName(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'google.home.graph.v1'), createEmptyInstance: create)
    ..aOS(1, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'manufacturer')
    ..aOS(2, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'model')
    ..aOS(3, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'hwVersion')
    ..aOS(4, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'swVersion')
    ..hasRequiredFields = false
  ;
...
class AgentOtherDeviceId extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'AgentOtherDeviceId', package: const $pb.PackageName(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'google.home.graph.v1'), createEmptyInstance: create)
  ...
  factory AgentOtherDeviceId.fromBuffer($core.List<$core.int> i, [$pb.ExtensionRegistry r = $pb.ExtensionRegistry.EMPTY]) => create()..mergeFromBuffer(i, r);
  factory AgentOtherDeviceId.fromJson($core.String i, [$pb.ExtensionRegistry r = $pb.ExtensionRegistry.EMPTY]) => create()..mergeFromJson(i, r);
  @$core.Deprecated(
  'Using this can add significant overhead to your binary. '
  'Use [GeneratedMessageGenericExtensions.deepCopy] instead. '
  'Will be removed in next major version')
  ...
  'Use [GeneratedMessageGenericExtensions.rebuild] instead. '
  'Will be removed in next major version')
  AgentOtherDeviceId copyWith(void Function(AgentOtherDeviceId) updates) => super.copyWith((message) => updates(message as AgentOtherDeviceId)) as AgentOtherDeviceId; // ignore: deprecated_member_use
  $pb.BuilderInfo get info_ => _i;
  @$core.pragma('dart2js:noInline')
  static AgentOtherDeviceId create() => AgentOtherDeviceId._();
  AgentOtherDeviceId createEmptyInstance() => create();
  static $pb.PbList<AgentOtherDeviceId> createRepeated() => $pb.PbList<AgentOtherDeviceId>();
  @$core.pragma('dart2js:noInline')
  static AgentOtherDeviceId getDefault() => _defaultInstance ??= $pb.GeneratedMessage.$_defaultFor<AgentOtherDeviceId>(create);

...
const RequestSyncDevicesRequest$json = const {
  ...
  '2': const [
    const {'1': 'agent_user_id', '3': 1, '4': 1, '5': 9, '8': const {}, '10': 'agentUserId'},
...
final $typed_data.Uint8List requestSyncDevicesRequestDescriptor = $convert.base64Decode('ChlSZXF1ZXN0U3luY0RldmljZXNSZXF1ZXN0EicKDWFnZW50X3VzZXJfaWQYASABKAlCA+BBAlILYWdlbnRVc2VySWQSGQoFYXN5bmMYAiABKAhCA+BBAVIFYXN5bmM=');
...
final $typed_data.Uint8List requestSyncDevicesResponseDescriptor = $convert.base64Decode('ChpSZXF1ZXN0U3luY0RldmljZXNSZXNwb25zZQ==');
...
const ReportStateAndNotificationRequest$json = const {
  ...
  '2': const [
    ...
    const {'1': 'agent_user_id', '3': 2, '4': 1, '5': 9, '8': const {}, '10': 'agentUserId'},
    const {
      '1': 'follow_up_token',
      '3': 5,
      '4': 1,
...
final $typed_data.Uint8List reportStateAndNotificationResponseDescriptor = $convert.base64Decode('CiJSZXBvcnRTdGF0ZUFuZE5vdGlmaWNhdGlvblJlc3BvbnNlEh0KCnJlcXVlc3RfaWQYASABKAlSCXJlcXVlc3RJZA==');
...
final $typed_data.Uint8List stateAndNotificationPayloadDescriptor = $convert.base64Decode('ChtTdGF0ZUFuZE5vdGlmaWNhdGlvblBheWxvYWQSUAoHZGV2aWNlcxgBIAEoCzI2Lmdvb2dsZS5ob21lLmdyYXBoLnYxLlJlcG9ydFN0YXRlQW5kTm90aWZpY2F0aW9uRGV2aWNlUgdkZXZpY2Vz');
...
final $typed_data.Uint8List reportStateAndNotificationDeviceDescriptor = $convert.base64Decode('CiBSZXBvcnRTdGF0ZUFuZE5vdGlmaWNhdGlvbkRldmljZRIvCgZzdGF0ZXMYASABKAsyFy5nb29nbGUucHJvdG9idWYuU3RydWN0UgZzdGF0ZXMSPQoNbm90aWZpY2F0aW9ucxgCIAEoCzIXLmdvb2dsZS5wcm90b2J1Zi5TdHJ1Y3RSDW5vdGlmaWNhdGlvbnM=');
...
final $typed_data.Uint8List deleteAgentUserRequestDescriptor = $convert.base64Decode('ChZEZWxldGVBZ2VudFVzZXJSZXF1ZXN0Eh0KCnJlcXVlc3RfaWQYASABKAlSCXJlcXVlc3RJZBJSCg1hZ2VudF91c2VyX2lkGAIgASgJQi7gQQL6QSgKJmhvbWVncmFwaC5nb29nbGVhcGlzLmNvbS9BZ2VudFVzZXJQYXRoUgthZ2VudFVzZXJJZA==');
...
const QueryRequest$json = const {
  ...
  '2': const [
    const {'1': 'request_id', '3': 1, '4': 1, '5': 9, '10': 'requestId'},
    const {'1': 'agent_user_id', '3': 2, '4': 1, '5': 9, '8': const {}, '10': 'agentUserId'},
    const {'1': 'inputs', '3': 3, '4': 3, '5': 11, '6': '.google.home.graph.v1.QueryRequestInput', '8': const {}, '10': 'inputs'},
  ],
};

/// Descriptor for `QueryRequest`. Decode as a `google.protobuf.DescriptorProto`.
final $typed_data.Uint8List queryRequestDescriptor = $convert.base64Decode('CgxRdWVyeVJlcXVlc3QSHQoKcmVxdWVzdF9pZBgBIAEoCVIJcmVxdWVzdElkEicKDWFnZW50X3VzZXJfaWQYAiABKAlCA+BBAlILYWdlbnRVc2VySWQSRAoGaW5wdXRzGAMgAygLMicuZ29vZ2xlLmhvbWUuZ3JhcGgudjEuUXVlcnlSZXF1ZXN0SW5wdXRCA+BBAlIGaW5wdXRz');
...
final $typed_data.Uint8List queryRequestInputDescriptor = $convert.base64Decode('ChFRdWVyeVJlcXVlc3RJbnB1dBJDCgdwYXlsb2FkGAEgASgLMikuZ29vZ2xlLmhvbWUuZ3JhcGgudjEuUXVlcnlSZXF1ZXN0UGF5bG9hZFIHcGF5bG9hZA==');
...
final $typed_data.Uint8List queryRequestPayloadDescriptor = $convert.base64Decode('ChNRdWVyeVJlcXVlc3RQYXlsb2FkEj0KB2RldmljZXMYASADKAsyIy5nb29nbGUuaG9tZS5ncmFwaC52MS5BZ2VudERldmljZUlkUgdkZXZpY2Vz');
...
final $typed_data.Uint8List agentDeviceIdDescriptor = $convert.base64Decode('Cg1BZ2VudERldmljZUlkEg4KAmlkGAEgASgJUgJpZA==');
...
final $typed_data.Uint8List queryResponseDescriptor = $convert.base64Decode('Cg1RdWVyeVJlc3BvbnNlEh0KCnJlcXVlc3RfaWQYASABKAlSCXJlcXVlc3RJZBJECgdwYXlsb2FkGAIgASgLMiouZ29vZ2xlLmhvbWUuZ3JhcGgudjEuUXVlcnlSZXNwb25zZVBheWxvYWRSB3BheWxvYWQ=');
...
final $typed_data.Uint8List queryResponsePayloadDescriptor = $convert.base64Decode('ChRRdWVyeVJlc3BvbnNlUGF5bG9hZBJRCgdkZXZpY2VzGAEgAygLMjcuZ29vZ2xlLmhvbWUuZ3JhcGgudjEuUXVlcnlSZXNwb25zZVBheWxvYWQuRGV2aWNlc0VudHJ5UgdkZXZpY2VzGlMKDERldmljZXNFbnRyeRIQCgNrZXkYASABKAlSA2tleRItCgV2YWx1ZRgCIAEoCzIXLmdvb2dsZS5wcm90b2J1Zi5TdHJ1Y3RSBXZhbHVlOgI4AQ==');
...
final $typed_data.Uint8List syncRequestDescriptor = $convert.base64Decode('CgtTeW5jUmVxdWVzdBIdCgpyZXF1ZXN0X2lkGAEgASgJUglyZXF1ZXN0SWQSJwoNYWdlbnRfdXNlcl9pZBgCIAEoCUID4EECUgthZ2VudFVzZXJJZA==');
...
final $typed_data.Uint8List syncResponseDescriptor = $convert.base64Decode('CgxTeW5jUmVzcG9uc2USHQoKcmVxdWVzdF9pZBgBIAEoCVIJcmVxdWVzdElkEkMKB3BheWxvYWQYAiABKAsyKS5nb29nbGUuaG9tZS5ncmFwaC52MS5TeW5jUmVzcG9uc2VQYXlsb2FkUgdwYXlsb2Fk');
...
final $typed_data.Uint8List syncResponsePayloadDescriptor = $convert.base64Decode('ChNTeW5jUmVzcG9uc2VQYXlsb2FkEiIKDWFnZW50X3VzZXJfaWQYASABKAlSC2FnZW50VXNlcklkEjYKB2RldmljZXMYAiADKAsyHC5nb29nbGUuaG9tZS5ncmFwaC52MS5EZXZpY2VSB2RldmljZXM=');

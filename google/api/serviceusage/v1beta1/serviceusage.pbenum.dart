...
class GetServiceIdentityResponse_IdentityState extends $pb.ProtobufEnum {
  static const GetServiceIdentityResponse_IdentityState IDENTITY_STATE_UNSPECIFIED = GetServiceIdentityResponse_IdentityState._(0, const $core.bool.fromEnvironment('protobuf.omit_enum_names') ? '' : 'IDENTITY_STATE_UNSPECIFIED');
  static const GetServiceIdentityResponse_IdentityState ACTIVE = GetServiceIdentityResponse_IdentityState._(1, const $core.bool.fromEnvironment('protobuf.omit_enum_names') ? '' : 'ACTIVE');

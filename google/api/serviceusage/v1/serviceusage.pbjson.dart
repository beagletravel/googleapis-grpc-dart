...
const EnableServiceResponse$json = const {
  ...
  '2': const [
    const {'1': 'service', '3': 1, '4': 1, '5': 11, '6': '.google.api.serviceusage.v1.Service', '10': 'service'},
  ],
};

/// Descriptor for `EnableServiceResponse`. Decode as a `google.protobuf.DescriptorProto`.
final $typed_data.Uint8List enableServiceResponseDescriptor = $convert.base64Decode('ChVFbmFibGVTZXJ2aWNlUmVzcG9uc2USPQoHc2VydmljZRgBIAEoCzIjLmdvb2dsZS5hcGkuc2VydmljZXVzYWdlLnYxLlNlcnZpY2VSB3NlcnZpY2U=');
@$core.Deprecated('Use disableServiceRequestDescriptor instead')
const DisableServiceRequest$json = const {
  '1': 'DisableServiceRequest',
  '2': const [
    const {'1': 'name', '3': 1, '4': 1, '5': 9, '10': 'name'},
    const {'1': 'disable_dependent_services', '3': 2, '4': 1, '5': 8, '10': 'disableDependentServices'},
    const {'1': 'check_if_service_has_usage', '3': 3, '4': 1, '5': 14, '6': '.google.api.serviceusage.v1.DisableServiceRequest.CheckIfServiceHasUsage', '10': 'checkIfServiceHasUsage'},
  ],
...
final $typed_data.Uint8List disableServiceResponseDescriptor = $convert.base64Decode('ChZEaXNhYmxlU2VydmljZVJlc3BvbnNlEj0KB3NlcnZpY2UYASABKAsyIy5nb29nbGUuYXBpLnNlcnZpY2V1c2FnZS52MS5TZXJ2aWNlUgdzZXJ2aWNl');
...
const ListServicesResponse$json = const {
  ...
  '2': const [
    const {'1': 'services', '3': 1, '4': 3, '5': 11, '6': '.google.api.serviceusage.v1.Service', '10': 'services'},
    const {'1': 'next_page_token', '3': 2, '4': 1, '5': 9, '10': 'nextPageToken'},
  ],
};

/// Descriptor for `ListServicesResponse`. Decode as a `google.protobuf.DescriptorProto`.
final $typed_data.Uint8List listServicesResponseDescriptor = $convert.base64Decode('ChRMaXN0U2VydmljZXNSZXNwb25zZRI/CghzZXJ2aWNlcxgBIAMoCzIjLmdvb2dsZS5hcGkuc2VydmljZXVzYWdlLnYxLlNlcnZpY2VSCHNlcnZpY2VzEiYKD25leHRfcGFnZV90b2tlbhgCIAEoCVINbmV4dFBhZ2VUb2tlbg==');
...
const BatchEnableServicesResponse$json = const {
  ...
  '2': const [
    const {'1': 'services', '3': 1, '4': 3, '5': 11, '6': '.google.api.serviceusage.v1.Service', '10': 'services'},
    const {'1': 'failures', '3': 2, '4': 3, '5': 11, '6': '.google.api.serviceusage.v1.BatchEnableServicesResponse.EnableFailure', '10': 'failures'},
  ],
...
final $typed_data.Uint8List batchEnableServicesResponseDescriptor = $convert.base64Decode('');
...
final $typed_data.Uint8List batchGetServicesRequestDescriptor = $convert.base64Decode('ChdCYXRjaEdldFNlcnZpY2VzUmVxdWVzdBIWCgZwYXJlbnQYASABKAlSBnBhcmVudBIUCgVuYW1lcxgCIAMoCVIFbmFtZXM=');
...
final $typed_data.Uint8List batchGetServicesResponseDescriptor = $convert.base64Decode('ChhCYXRjaEdldFNlcnZpY2VzUmVzcG9uc2USPwoIc2VydmljZXMYASADKAsyIy5nb29nbGUuYXBpLnNlcnZpY2V1c2FnZS52MS5TZXJ2aWNlUghzZXJ2aWNlcw==');

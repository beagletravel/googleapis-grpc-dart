...
class Service extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'Service', package: const $pb.PackageName(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'google.api'), createEmptyInstance: create)
    ...
    ..pc<$1.Type>(4, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'types', $pb.PbFieldType.PM, subBuilder: $1.Type.create)
    ..pc<$1.Enum>(5, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'enums', $pb.PbFieldType.PM, subBuilder: $1.Enum.create)
    ..aOM<$2.Documentation>(6, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'documentation', subBuilder: $2.Documentation.create)

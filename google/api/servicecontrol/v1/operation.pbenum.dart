...
class Operation_Importance extends $pb.ProtobufEnum {
  static const Operation_Importance LOW = Operation_Importance._(0, const $core.bool.fromEnvironment('protobuf.omit_enum_names') ? '' : 'LOW');
  static const Operation_Importance HIGH = Operation_Importance._(1, const $core.bool.fromEnvironment('protobuf.omit_enum_names') ? '' : 'HIGH');

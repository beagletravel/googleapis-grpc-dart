...
class Distribution_LinearBuckets extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'Distribution.LinearBuckets', package: const $pb.PackageName(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'google.api.servicecontrol.v1'), createEmptyInstance: create)
  ...
  factory Distribution_LinearBuckets.fromBuffer($core.List<$core.int> i, [$pb.ExtensionRegistry r = $pb.ExtensionRegistry.EMPTY]) => create()..mergeFromBuffer(i, r);
  factory Distribution_LinearBuckets.fromJson($core.String i, [$pb.ExtensionRegistry r = $pb.ExtensionRegistry.EMPTY]) => create()..mergeFromJson(i, r);
  @$core.Deprecated(
  'Using this can add significant overhead to your binary. '
  'Use [GeneratedMessageGenericExtensions.deepCopy] instead. '
  'Will be removed in next major version')
  Distribution_LinearBuckets clone() => Distribution_LinearBuckets()..mergeFromMessage(this);
  @$core.Deprecated(
  'Using this can add significant overhead to your binary. '
  'Use [GeneratedMessageGenericExtensions.rebuild] instead. '
  'Will be removed in next major version')
  Distribution_LinearBuckets copyWith(void Function(Distribution_LinearBuckets) updates) => super.copyWith((message) => updates(message as Distribution_LinearBuckets)) as Distribution_LinearBuckets; // ignore: deprecated_member_use
  ...
  static $pb.PbList<Distribution_LinearBuckets> createRepeated() => $pb.PbList<Distribution_LinearBuckets>();
  @$core.pragma('dart2js:noInline')
  static Distribution_LinearBuckets getDefault() => _defaultInstance ??= $pb.GeneratedMessage.$_defaultFor<Distribution_LinearBuckets>(create);
...
class Distribution_ExponentialBuckets extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'Distribution.ExponentialBuckets', package: const $pb.PackageName(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'google.api.servicecontrol.v1'), createEmptyInstance: create)
    ..a<$core.int>(1, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'numFiniteBuckets', $pb.PbFieldType.O3)
  ...
  factory Distribution_ExponentialBuckets.fromBuffer($core.List<$core.int> i, [$pb.ExtensionRegistry r = $pb.ExtensionRegistry.EMPTY]) => create()..mergeFromBuffer(i, r);
  factory Distribution_ExponentialBuckets.fromJson($core.String i, [$pb.ExtensionRegistry r = $pb.ExtensionRegistry.EMPTY]) => create()..mergeFromJson(i, r);
  @$core.Deprecated(
  'Using this can add significant overhead to your binary. '
  'Use [GeneratedMessageGenericExtensions.deepCopy] instead. '
  'Will be removed in next major version')
  Distribution_ExponentialBuckets clone() => Distribution_ExponentialBuckets()..mergeFromMessage(this);
  @$core.Deprecated(
  'Using this can add significant overhead to your binary. '
  'Use [GeneratedMessageGenericExtensions.rebuild] instead. '
  'Will be removed in next major version')
  Distribution_ExponentialBuckets copyWith(void Function(Distribution_ExponentialBuckets) updates) => super.copyWith((message) => updates(message as Distribution_ExponentialBuckets)) as Distribution_ExponentialBuckets; // ignore: deprecated_member_use
  $pb.BuilderInfo get info_ => _i;
  @$core.pragma('dart2js:noInline')
  static Distribution_ExponentialBuckets create() => Distribution_ExponentialBuckets._();
  Distribution_ExponentialBuckets createEmptyInstance() => create();
  static $pb.PbList<Distribution_ExponentialBuckets> createRepeated() => $pb.PbList<Distribution_ExponentialBuckets>();
  @$core.pragma('dart2js:noInline')
  static Distribution_ExponentialBuckets getDefault() => _defaultInstance ??= $pb.GeneratedMessage.$_defaultFor<Distribution_ExponentialBuckets>(create);
...
class Distribution_ExplicitBuckets extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'Distribution.ExplicitBuckets', package: const $pb.PackageName(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'google.api.servicecontrol.v1'), createEmptyInstance: create)
    ..p<$core.double>(1, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'bounds', $pb.PbFieldType.PD)
    ..hasRequiredFields = false
  ;
  ...
  factory Distribution_ExplicitBuckets.fromBuffer($core.List<$core.int> i, [$pb.ExtensionRegistry r = $pb.ExtensionRegistry.EMPTY]) => create()..mergeFromBuffer(i, r);
  factory Distribution_ExplicitBuckets.fromJson($core.String i, [$pb.ExtensionRegistry r = $pb.ExtensionRegistry.EMPTY]) => create()..mergeFromJson(i, r);
  @$core.Deprecated(
  'Using this can add significant overhead to your binary. '
  'Use [GeneratedMessageGenericExtensions.deepCopy] instead. '
  'Will be removed in next major version')
  Distribution_ExplicitBuckets clone() => Distribution_ExplicitBuckets()..mergeFromMessage(this);
  @$core.Deprecated(
  'Using this can add significant overhead to your binary. '
  'Use [GeneratedMessageGenericExtensions.rebuild] instead. '
  'Will be removed in next major version')
  Distribution_ExplicitBuckets copyWith(void Function(Distribution_ExplicitBuckets) updates) => super.copyWith((message) => updates(message as Distribution_ExplicitBuckets)) as Distribution_ExplicitBuckets; // ignore: deprecated_member_use
  $pb.BuilderInfo get info_ => _i;
  @$core.pragma('dart2js:noInline')
  static Distribution_ExplicitBuckets create() => Distribution_ExplicitBuckets._();
  Distribution_ExplicitBuckets createEmptyInstance() => create();
  static $pb.PbList<Distribution_ExplicitBuckets> createRepeated() => $pb.PbList<Distribution_ExplicitBuckets>();
  @$core.pragma('dart2js:noInline')
  static Distribution_ExplicitBuckets getDefault() => _defaultInstance ??= $pb.GeneratedMessage.$_defaultFor<Distribution_ExplicitBuckets>(create);
...
class Distribution extends $pb.GeneratedMessage {
  static const $core.Map<$core.int, Distribution_BucketOption> _Distribution_BucketOptionByTag = {
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'Distribution', package: const $pb.PackageName(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'google.api.servicecontrol.v1'), createEmptyInstance: create)
    ..oo(0, [7, 8, 9])
    ...
    ..a<$core.double>(3, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'minimum', $pb.PbFieldType.OD)
    ...
    ..pc<$0.Distribution_Exemplar>(10, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'exemplars', $pb.PbFieldType.PM, subBuilder: $0.Distribution_Exemplar.create)
    ..hasRequiredFields = false
  ;
  ...
  Distribution_BucketOption whichBucketOption() => _Distribution_BucketOptionByTag[$_whichOneof(0)]!;
  ...
  @$pb.TagNumber(3)
  set minimum($core.double v) { $_setDouble(2, v); }
  @$pb.TagNumber(3)
  ...
  @$pb.TagNumber(4)
  set maximum($core.double v) { $_setDouble(3, v); }
  @$pb.TagNumber(4)
  ...
  @$pb.TagNumber(5)
  set sumOfSquaredDeviation($core.double v) { $_setDouble(4, v); }
  @$pb.TagNumber(5)
  ...
  @$pb.TagNumber(7)
  set linearBuckets(Distribution_LinearBuckets v) { setField(7, v); }
  @$pb.TagNumber(7)
  ...
  @$pb.TagNumber(8)
  set exponentialBuckets(Distribution_ExponentialBuckets v) { setField(8, v); }
  @$pb.TagNumber(8)
  ...
  @$pb.TagNumber(9)
  set explicitBuckets(Distribution_ExplicitBuckets v) { setField(9, v); }
  @$pb.TagNumber(9)
  ...
  @$pb.TagNumber(10)
  $core.List<$0.Distribution_Exemplar> get exemplars => $_getList(9);
}

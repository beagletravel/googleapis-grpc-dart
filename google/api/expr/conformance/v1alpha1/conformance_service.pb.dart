...
class ParseRequest extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'ParseRequest', package: const $pb.PackageName(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'google.api.expr.conformance.v1alpha1'), createEmptyInstance: create)
    ..aOS(1, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'celSource')
    ..aOS(2, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'syntaxVersion')
    ..aOS(3, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'sourceLocation')
    ..aOB(4, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'disableMacros')
...
class ParseResponse extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'ParseResponse', package: const $pb.PackageName(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'google.api.expr.conformance.v1alpha1'), createEmptyInstance: create)
    ..aOM<$1.ParsedExpr>(1, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'parsedExpr', subBuilder: $1.ParsedExpr.create)
    ..pc<$2.Status>(2, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'issues', $pb.PbFieldType.PM, subBuilder: $2.Status.create)
    ..hasRequiredFields = false
  ;
  ...
  @$pb.TagNumber(1)
  set parsedExpr($1.ParsedExpr v) { setField(1, v); }
  @$pb.TagNumber(1)
...
class CheckRequest extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'CheckRequest', package: const $pb.PackageName(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'google.api.expr.conformance.v1alpha1'), createEmptyInstance: create)
    ..aOM<$1.ParsedExpr>(1, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'parsedExpr', subBuilder: $1.ParsedExpr.create)
    ..pc<$3.Decl>(2, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'typeEnv', $pb.PbFieldType.PM, subBuilder: $3.Decl.create)
...
class CheckResponse extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'CheckResponse', package: const $pb.PackageName(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'google.api.expr.conformance.v1alpha1'), createEmptyInstance: create)
    ..aOM<$3.CheckedExpr>(1, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'checkedExpr', subBuilder: $3.CheckedExpr.create)
    ..pc<$2.Status>(2, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'issues', $pb.PbFieldType.PM, subBuilder: $2.Status.create)
    ..hasRequiredFields = false
  ;
  ...
  @$pb.TagNumber(1)
  set checkedExpr($3.CheckedExpr v) { setField(1, v); }
  @$pb.TagNumber(1)
...
class EvalRequest extends $pb.GeneratedMessage {
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'EvalRequest', package: const $pb.PackageName(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'google.api.expr.conformance.v1alpha1'), createEmptyInstance: create)
    ..oo(0, [1, 2])
    ..aOM<$1.ParsedExpr>(1, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'parsedExpr', subBuilder: $1.ParsedExpr.create)
    ..aOM<$3.CheckedExpr>(2, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'checkedExpr', subBuilder: $3.CheckedExpr.create)
    ..m<$core.String, $4.ExprValue>(3, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'bindings', entryClassName: 'EvalRequest.BindingsEntry', keyFieldType: $pb.PbFieldType.OS, valueFieldType: $pb.PbFieldType.OM, valueCreator: $4.ExprValue.create, packageName: const $pb.PackageName('google.api.expr.conformance.v1alpha1'))
  ...
  'Use [GeneratedMessageGenericExtensions.rebuild] instead. '
  'Will be removed in next major version')
  EvalRequest copyWith(void Function(EvalRequest) updates) => super.copyWith((message) => updates(message as EvalRequest)) as EvalRequest; // ignore: deprecated_member_use
  $pb.BuilderInfo get info_ => _i;
  @$core.pragma('dart2js:noInline')
  ...
  @$pb.TagNumber(2)
  set checkedExpr($3.CheckedExpr v) { setField(2, v); }
  @$pb.TagNumber(2)
...
class EvalResponse extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'EvalResponse', package: const $pb.PackageName(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'google.api.expr.conformance.v1alpha1'), createEmptyInstance: create)
    ..aOM<$4.ExprValue>(1, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'result', subBuilder: $4.ExprValue.create)
    ..pc<$2.Status>(2, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'issues', $pb.PbFieldType.PM, subBuilder: $2.Status.create)
    ..hasRequiredFields = false
  ;
  ...
  'Use [GeneratedMessageGenericExtensions.rebuild] instead. '
  'Will be removed in next major version')
  EvalResponse copyWith(void Function(EvalResponse) updates) => super.copyWith((message) => updates(message as EvalResponse)) as EvalResponse; // ignore: deprecated_member_use
  $pb.BuilderInfo get info_ => _i;
  @$core.pragma('dart2js:noInline')
  ...
  @$pb.TagNumber(1)
  set result($4.ExprValue v) { setField(1, v); }
  @$pb.TagNumber(1)
...
class IssueDetails extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'IssueDetails', package: const $pb.PackageName(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'google.api.expr.conformance.v1alpha1'), createEmptyInstance: create)
    ..e<IssueDetails_Severity>(1, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'severity', $pb.PbFieldType.OE, defaultOrMaker: IssueDetails_Severity.SEVERITY_UNSPECIFIED, valueOf: IssueDetails_Severity.valueOf, enumValues: IssueDetails_Severity.values)
    ..aOM<$1.SourcePosition>(2, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'position', subBuilder: $1.SourcePosition.create)
  ...
  'Use [GeneratedMessageGenericExtensions.rebuild] instead. '
  'Will be removed in next major version')
  IssueDetails copyWith(void Function(IssueDetails) updates) => super.copyWith((message) => updates(message as IssueDetails)) as IssueDetails; // ignore: deprecated_member_use
  $pb.BuilderInfo get info_ => _i;
  @$core.pragma('dart2js:noInline')
  ...
  @$pb.TagNumber(2)
  set position($1.SourcePosition v) { setField(2, v); }
  @$pb.TagNumber(2)

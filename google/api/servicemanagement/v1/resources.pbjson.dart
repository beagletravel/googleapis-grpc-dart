...
const ManagedService$json = const {
  ...
  '2': const [
    ...
    const {'1': 'producer_project_id', '3': 3, '4': 1, '5': 9, '10': 'producerProjectId'},
  ],
};

/// Descriptor for `ManagedService`. Decode as a `google.protobuf.DescriptorProto`.
final $typed_data.Uint8List managedServiceDescriptor = $convert.base64Decode('Cg5NYW5hZ2VkU2VydmljZRIhCgxzZXJ2aWNlX25hbWUYAiABKAlSC3NlcnZpY2VOYW1lEi4KE3Byb2R1Y2VyX3Byb2plY3RfaWQYAyABKAlSEXByb2R1Y2VyUHJvamVjdElk');
@$core.Deprecated('Use operationMetadataDescriptor instead')
const OperationMetadata$json = const {
  '1': 'OperationMetadata',
  '2': const [
    const {'1': 'resource_names', '3': 1, '4': 3, '5': 9, '10': 'resourceNames'},
    const {'1': 'steps', '3': 2, '4': 3, '5': 11, '6': '.google.api.servicemanagement.v1.OperationMetadata.Step', '10': 'steps'},
    const {'1': 'progress_percentage', '3': 3, '4': 1, '5': 5, '10': 'progressPercentage'},
...
const OperationMetadata_Step$json = const {
  ...
  '2': const [
    ...
    const {'1': 'status', '3': 4, '4': 1, '5': 14, '6': '.google.api.servicemanagement.v1.OperationMetadata.Status', '10': 'status'},
  ],
};
...
final $typed_data.Uint8List operationMetadataDescriptor = $convert.base64Decode('');
@$core.Deprecated('Use diagnosticDescriptor instead')
const Diagnostic$json = const {
  '1': 'Diagnostic',
  '2': const [
    const {'1': 'location', '3': 1, '4': 1, '5': 9, '10': 'location'},
    const {'1': 'kind', '3': 2, '4': 1, '5': 14, '6': '.google.api.servicemanagement.v1.Diagnostic.Kind', '10': 'kind'},
...
final $typed_data.Uint8List diagnosticDescriptor = $convert.base64Decode('CgpEaWFnbm9zdGljEhoKCGxvY2F0aW9uGAEgASgJUghsb2NhdGlvbhJECgRraW5kGAIgASgOMjAuZ29vZ2xlLmFwaS5zZXJ2aWNlbWFuYWdlbWVudC52MS5EaWFnbm9zdGljLktpbmRSBGtpbmQSGAoHbWVzc2FnZRgDIAEoCVIHbWVzc2FnZSIeCgRLaW5kEgsKB1dBUk5JTkcQABIJCgVFUlJPUhAB');
@$core.Deprecated('Use configSourceDescriptor instead')
const ConfigSource$json = const {
  '1': 'ConfigSource',
  '2': const [
    const {'1': 'id', '3': 5, '4': 1, '5': 9, '10': 'id'},
    const {'1': 'files', '3': 2, '4': 3, '5': 11, '6': '.google.api.servicemanagement.v1.ConfigFile', '10': 'files'},
  ],
};

/// Descriptor for `ConfigSource`. Decode as a `google.protobuf.DescriptorProto`.
final $typed_data.Uint8List configSourceDescriptor = $convert.base64Decode('CgxDb25maWdTb3VyY2USDgoCaWQYBSABKAlSAmlkEkEKBWZpbGVzGAIgAygLMisuZ29vZ2xlLmFwaS5zZXJ2aWNlbWFuYWdlbWVudC52MS5Db25maWdGaWxlUgVmaWxlcw==');
...
const ConfigFile$json = const {
  ...
  '2': const [
    ...
    const {'1': 'file_type', '3': 4, '4': 1, '5': 14, '6': '.google.api.servicemanagement.v1.ConfigFile.FileType', '10': 'fileType'},
  ],
...
final $typed_data.Uint8List configFileDescriptor = $convert.base64Decode('');
...
final $typed_data.Uint8List configRefDescriptor = $convert.base64Decode('CglDb25maWdSZWYSEgoEbmFtZRgBIAEoCVIEbmFtZQ==');
@$core.Deprecated('Use changeReportDescriptor instead')
const ChangeReport$json = const {
  '1': 'ChangeReport',
  '2': const [
    const {'1': 'config_changes', '3': 1, '4': 3, '5': 11, '6': '.google.api.ConfigChange', '10': 'configChanges'},
  ],
};

/// Descriptor for `ChangeReport`. Decode as a `google.protobuf.DescriptorProto`.
final $typed_data.Uint8List changeReportDescriptor = $convert.base64Decode('CgxDaGFuZ2VSZXBvcnQSPwoOY29uZmlnX2NoYW5nZXMYASADKAsyGC5nb29nbGUuYXBpLkNvbmZpZ0NoYW5nZVINY29uZmlnQ2hhbmdlcw==');
@$core.Deprecated('Use rolloutDescriptor instead')
const Rollout$json = const {
  '1': 'Rollout',
  '2': const [
    const {'1': 'rollout_id', '3': 1, '4': 1, '5': 9, '8': const {}, '10': 'rolloutId'},
    const {'1': 'create_time', '3': 2, '4': 1, '5': 11, '6': '.google.protobuf.Timestamp', '10': 'createTime'},
    const {'1': 'created_by', '3': 3, '4': 1, '5': 9, '10': 'createdBy'},
    const {'1': 'status', '3': 4, '4': 1, '5': 14, '6': '.google.api.servicemanagement.v1.Rollout.RolloutStatus', '10': 'status'},
    const {'1': 'traffic_percent_strategy', '3': 5, '4': 1, '5': 11, '6': '.google.api.servicemanagement.v1.Rollout.TrafficPercentStrategy', '9': 0, '10': 'trafficPercentStrategy'},
    const {'1': 'delete_service_strategy', '3': 200, '4': 1, '5': 11, '6': '.google.api.servicemanagement.v1.Rollout.DeleteServiceStrategy', '9': 0, '10': 'deleteServiceStrategy'},
...
const Rollout_TrafficPercentStrategy$json = const {
  ...
  '2': const [
    const {'1': 'percentages', '3': 1, '4': 3, '5': 11, '6': '.google.api.servicemanagement.v1.Rollout.TrafficPercentStrategy.PercentagesEntry', '10': 'percentages'},
  ],

...
final $typed_data.Uint8List listServicesRequestDescriptor = $convert.base64Decode('ChNMaXN0U2VydmljZXNSZXF1ZXN0Ei4KE3Byb2R1Y2VyX3Byb2plY3RfaWQYASABKAlSEXByb2R1Y2VyUHJvamVjdElkEhsKCXBhZ2Vfc2l6ZRgFIAEoBVIIcGFnZVNpemUSHQoKcGFnZV90b2tlbhgGIAEoCVIJcGFnZVRva2VuEiMKC2NvbnN1bWVyX2lkGAcgASgJQgIYAVIKY29uc3VtZXJJZA==');
...
final $typed_data.Uint8List listServicesResponseDescriptor = $convert.base64Decode('ChRMaXN0U2VydmljZXNSZXNwb25zZRJLCghzZXJ2aWNlcxgBIAMoCzIvLmdvb2dsZS5hcGkuc2VydmljZW1hbmFnZW1lbnQudjEuTWFuYWdlZFNlcnZpY2VSCHNlcnZpY2VzEiYKD25leHRfcGFnZV90b2tlbhgCIAEoCVINbmV4dFBhZ2VUb2tlbg==');
...
final $typed_data.Uint8List getServiceRequestDescriptor = $convert.base64Decode('ChFHZXRTZXJ2aWNlUmVxdWVzdBImCgxzZXJ2aWNlX25hbWUYASABKAlCA+BBAlILc2VydmljZU5hbWU=');
@$core.Deprecated('Use createServiceRequestDescriptor instead')
const CreateServiceRequest$json = const {
  '1': 'CreateServiceRequest',
  '2': const [
    const {'1': 'service', '3': 1, '4': 1, '5': 11, '6': '.google.api.servicemanagement.v1.ManagedService', '8': const {}, '10': 'service'},
  ],
};

/// Descriptor for `CreateServiceRequest`. Decode as a `google.protobuf.DescriptorProto`.
final $typed_data.Uint8List createServiceRequestDescriptor = $convert.base64Decode('ChRDcmVhdGVTZXJ2aWNlUmVxdWVzdBJOCgdzZXJ2aWNlGAEgASgLMi8uZ29vZ2xlLmFwaS5zZXJ2aWNlbWFuYWdlbWVudC52MS5NYW5hZ2VkU2VydmljZUID4EECUgdzZXJ2aWNl');
...
final $typed_data.Uint8List deleteServiceRequestDescriptor = $convert.base64Decode('ChREZWxldGVTZXJ2aWNlUmVxdWVzdBImCgxzZXJ2aWNlX25hbWUYASABKAlCA+BBAlILc2VydmljZU5hbWU=');
...
final $typed_data.Uint8List undeleteServiceRequestDescriptor = $convert.base64Decode('ChZVbmRlbGV0ZVNlcnZpY2VSZXF1ZXN0EiYKDHNlcnZpY2VfbmFtZRgBIAEoCUID4EECUgtzZXJ2aWNlTmFtZQ==');
...
final $typed_data.Uint8List undeleteServiceResponseDescriptor = $convert.base64Decode('ChdVbmRlbGV0ZVNlcnZpY2VSZXNwb25zZRJJCgdzZXJ2aWNlGAEgASgLMi8uZ29vZ2xlLmFwaS5zZXJ2aWNlbWFuYWdlbWVudC52MS5NYW5hZ2VkU2VydmljZVIHc2VydmljZQ==');
...
final $typed_data.Uint8List getServiceConfigRequestDescriptor = $convert.base64Decode('');
...
final $typed_data.Uint8List listServiceConfigsRequestDescriptor = $convert.base64Decode('ChlMaXN0U2VydmljZUNvbmZpZ3NSZXF1ZXN0EiYKDHNlcnZpY2VfbmFtZRgBIAEoCUID4EECUgtzZXJ2aWNlTmFtZRIdCgpwYWdlX3Rva2VuGAIgASgJUglwYWdlVG9rZW4SGwoJcGFnZV9zaXplGAMgASgFUghwYWdlU2l6ZQ==');
...
final $typed_data.Uint8List listServiceConfigsResponseDescriptor = $convert.base64Decode('ChpMaXN0U2VydmljZUNvbmZpZ3NSZXNwb25zZRI8Cg9zZXJ2aWNlX2NvbmZpZ3MYASADKAsyEy5nb29nbGUuYXBpLlNlcnZpY2VSDnNlcnZpY2VDb25maWdzEiYKD25leHRfcGFnZV90b2tlbhgCIAEoCVINbmV4dFBhZ2VUb2tlbg==');
...
const CreateServiceConfigRequest$json = const {
  ...
  '2': const [
    const {'1': 'service_name', '3': 1, '4': 1, '5': 9, '8': const {}, '10': 'serviceName'},
    const {'1': 'service_config', '3': 2, '4': 1, '5': 11, '6': '.google.api.Service', '8': const {}, '10': 'serviceConfig'},
  ],
};

/// Descriptor for `CreateServiceConfigRequest`. Decode as a `google.protobuf.DescriptorProto`.
final $typed_data.Uint8List createServiceConfigRequestDescriptor = $convert.base64Decode('ChpDcmVhdGVTZXJ2aWNlQ29uZmlnUmVxdWVzdBImCgxzZXJ2aWNlX25hbWUYASABKAlCA+BBAlILc2VydmljZU5hbWUSPwoOc2VydmljZV9jb25maWcYAiABKAsyEy5nb29nbGUuYXBpLlNlcnZpY2VCA+BBAlINc2VydmljZUNvbmZpZw==');
...
const SubmitConfigSourceRequest$json = const {
  ...
  '2': const [
    const {'1': 'service_name', '3': 1, '4': 1, '5': 9, '8': const {}, '10': 'serviceName'},
    const {'1': 'config_source', '3': 2, '4': 1, '5': 11, '6': '.google.api.servicemanagement.v1.ConfigSource', '8': const {}, '10': 'configSource'},
...
final $typed_data.Uint8List submitConfigSourceRequestDescriptor = $convert.base64Decode('');
...
final $typed_data.Uint8List submitConfigSourceResponseDescriptor = $convert.base64Decode('ChpTdWJtaXRDb25maWdTb3VyY2VSZXNwb25zZRI6Cg5zZXJ2aWNlX2NvbmZpZxgBIAEoCzITLmdvb2dsZS5hcGkuU2VydmljZVINc2VydmljZUNvbmZpZw==');
...
const CreateServiceRolloutRequest$json = const {
  ...
  '2': const [
    const {'1': 'service_name', '3': 1, '4': 1, '5': 9, '8': const {}, '10': 'serviceName'},
    const {'1': 'rollout', '3': 2, '4': 1, '5': 11, '6': '.google.api.servicemanagement.v1.Rollout', '8': const {}, '10': 'rollout'},
  ],
};

/// Descriptor for `CreateServiceRolloutRequest`. Decode as a `google.protobuf.DescriptorProto`.
final $typed_data.Uint8List createServiceRolloutRequestDescriptor = $convert.base64Decode('ChtDcmVhdGVTZXJ2aWNlUm9sbG91dFJlcXVlc3QSJgoMc2VydmljZV9uYW1lGAEgASgJQgPgQQJSC3NlcnZpY2VOYW1lEkcKB3JvbGxvdXQYAiABKAsyKC5nb29nbGUuYXBpLnNlcnZpY2VtYW5hZ2VtZW50LnYxLlJvbGxvdXRCA+BBAlIHcm9sbG91dA==');
...
final $typed_data.Uint8List listServiceRolloutsRequestDescriptor = $convert.base64Decode('ChpMaXN0U2VydmljZVJvbGxvdXRzUmVxdWVzdBImCgxzZXJ2aWNlX25hbWUYASABKAlCA+BBAlILc2VydmljZU5hbWUSHQoKcGFnZV90b2tlbhgCIAEoCVIJcGFnZVRva2VuEhsKCXBhZ2Vfc2l6ZRgDIAEoBVIIcGFnZVNpemUSGwoGZmlsdGVyGAQgASgJQgPgQQJSBmZpbHRlcg==');
...
final $typed_data.Uint8List listServiceRolloutsResponseDescriptor = $convert.base64Decode('ChtMaXN0U2VydmljZVJvbGxvdXRzUmVzcG9uc2USRAoIcm9sbG91dHMYASADKAsyKC5nb29nbGUuYXBpLnNlcnZpY2VtYW5hZ2VtZW50LnYxLlJvbGxvdXRSCHJvbGxvdXRzEiYKD25leHRfcGFnZV90b2tlbhgCIAEoCVINbmV4dFBhZ2VUb2tlbg==');
...
final $typed_data.Uint8List getServiceRolloutRequestDescriptor = $convert.base64Decode('ChhHZXRTZXJ2aWNlUm9sbG91dFJlcXVlc3QSJgoMc2VydmljZV9uYW1lGAEgASgJQgPgQQJSC3NlcnZpY2VOYW1lEiIKCnJvbGxvdXRfaWQYAiABKAlCA+BBAlIJcm9sbG91dElk');
...
const GenerateConfigReportRequest$json = const {
  ...
  '2': const [
    const {'1': 'new_config', '3': 1, '4': 1, '5': 11, '6': '.google.protobuf.Any', '8': const {}, '10': 'newConfig'},
    const {'1': 'old_config', '3': 2, '4': 1, '5': 11, '6': '.google.protobuf.Any', '8': const {}, '10': 'oldConfig'},
  ],
};

/// Descriptor for `GenerateConfigReportRequest`. Decode as a `google.protobuf.DescriptorProto`.
final $typed_data.Uint8List generateConfigReportRequestDescriptor = $convert.base64Decode('ChtHZW5lcmF0ZUNvbmZpZ1JlcG9ydFJlcXVlc3QSOAoKbmV3X2NvbmZpZxgBIAEoCzIULmdvb2dsZS5wcm90b2J1Zi5BbnlCA+BBAlIJbmV3Q29uZmlnEjgKCm9sZF9jb25maWcYAiABKAsyFC5nb29nbGUucHJvdG9idWYuQW55QgPgQQFSCW9sZENvbmZpZw==');

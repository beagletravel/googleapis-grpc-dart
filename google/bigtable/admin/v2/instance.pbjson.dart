...
const Cluster$json = const {
  ...
  '2': const [
    ...
    const {'1': 'state', '3': 3, '4': 1, '5': 14, '6': '.google.bigtable.admin.v2.Cluster.State', '8': const {}, '10': 'state'},
    const {'1': 'serve_nodes', '3': 4, '4': 1, '5': 5, '10': 'serveNodes'},
    const {'1': 'cluster_config', '3': 7, '4': 1, '5': 11, '6': '.google.bigtable.admin.v2.Cluster.ClusterConfig', '9': 0, '10': 'clusterConfig'},
    const {'1': 'default_storage_type', '3': 5, '4': 1, '5': 14, '6': '.google.bigtable.admin.v2.StorageType', '8': const {}, '10': 'defaultStorageType'},
    const {'1': 'encryption_config', '3': 6, '4': 1, '5': 11, '6': '.google.bigtable.admin.v2.Cluster.EncryptionConfig', '8': const {}, '10': 'encryptionConfig'},
  ],
  '3': const [Cluster_ClusterAutoscalingConfig$json, Cluster_ClusterConfig$json, Cluster_EncryptionConfig$json],
...
const Cluster_ClusterAutoscalingConfig$json = const {
  ...
  '2': const [
    const {'1': 'autoscaling_limits', '3': 1, '4': 1, '5': 11, '6': '.google.bigtable.admin.v2.AutoscalingLimits', '8': const {}, '10': 'autoscalingLimits'},
    const {'1': 'autoscaling_targets', '3': 2, '4': 1, '5': 11, '6': '.google.bigtable.admin.v2.AutoscalingTargets', '8': const {}, '10': 'autoscalingTargets'},
  ],
};
...
const Cluster_ClusterConfig$json = const {
  '1': 'ClusterConfig',
  '2': const [
    const {'1': 'cluster_autoscaling_config', '3': 1, '4': 1, '5': 11, '6': '.google.bigtable.admin.v2.Cluster.ClusterAutoscalingConfig', '10': 'clusterAutoscalingConfig'},
  ],
};
...
final $typed_data.Uint8List appProfileDescriptor = $convert.base64Decode('');
@$core.Deprecated('Use hotTabletDescriptor instead')
const HotTablet$json = const {
  '1': 'HotTablet',
  '2': const [
    const {'1': 'name', '3': 1, '4': 1, '5': 9, '10': 'name'},
    const {'1': 'table_name', '3': 2, '4': 1, '5': 9, '8': const {}, '10': 'tableName'},

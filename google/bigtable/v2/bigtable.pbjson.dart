...
const ReadRowsRequest$json = const {
  '1': 'ReadRowsRequest',
  '2': const [
    const {'1': 'table_name', '3': 1, '4': 1, '5': 9, '8': const {}, '10': 'tableName'},
...
final $typed_data.Uint8List readRowsRequestDescriptor = $convert.base64Decode('');
...
final $typed_data.Uint8List readRowsResponseDescriptor = $convert.base64Decode('');
...
final $typed_data.Uint8List sampleRowKeysRequestDescriptor = $convert.base64Decode('ChRTYW1wbGVSb3dLZXlzUmVxdWVzdBJJCgp0YWJsZV9uYW1lGAEgASgJQirgQQL6QSQKImJpZ3RhYmxlYWRtaW4uZ29vZ2xlYXBpcy5jb20vVGFibGVSCXRhYmxlTmFtZRIkCg5hcHBfcHJvZmlsZV9pZBgCIAEoCVIMYXBwUHJvZmlsZUlk');
...
final $typed_data.Uint8List sampleRowKeysResponseDescriptor = $convert.base64Decode('ChVTYW1wbGVSb3dLZXlzUmVzcG9uc2USFwoHcm93X2tleRgBIAEoDFIGcm93S2V5EiEKDG9mZnNldF9ieXRlcxgCIAEoA1ILb2Zmc2V0Qnl0ZXM=');
...
const MutateRowRequest$json = const {
  ...
  '2': const [
    ...
    const {'1': 'row_key', '3': 2, '4': 1, '5': 12, '8': const {}, '10': 'rowKey'},
    const {'1': 'mutations', '3': 3, '4': 3, '5': 11, '6': '.google.bigtable.v2.Mutation', '8': const {}, '10': 'mutations'},
  ],
};

/// Descriptor for `MutateRowRequest`. Decode as a `google.protobuf.DescriptorProto`.
final $typed_data.Uint8List mutateRowRequestDescriptor = $convert.base64Decode('');
...
final $typed_data.Uint8List mutateRowResponseDescriptor = $convert.base64Decode('ChFNdXRhdGVSb3dSZXNwb25zZQ==');
...
const MutateRowsRequest$json = const {
  ...
  '2': const [
    ...
    const {'1': 'entries', '3': 2, '4': 3, '5': 11, '6': '.google.bigtable.v2.MutateRowsRequest.Entry', '8': const {}, '10': 'entries'},
  ],
...
const MutateRowsRequest_Entry$json = const {
  ...
  '2': const [
    const {'1': 'row_key', '3': 1, '4': 1, '5': 12, '10': 'rowKey'},
    const {'1': 'mutations', '3': 2, '4': 3, '5': 11, '6': '.google.bigtable.v2.Mutation', '8': const {}, '10': 'mutations'},
  ],
};

/// Descriptor for `MutateRowsRequest`. Decode as a `google.protobuf.DescriptorProto`.
final $typed_data.Uint8List mutateRowsRequestDescriptor = $convert.base64Decode('');
...
final $typed_data.Uint8List mutateRowsResponseDescriptor = $convert.base64Decode('ChJNdXRhdGVSb3dzUmVzcG9uc2USRgoHZW50cmllcxgBIAMoCzIsLmdvb2dsZS5iaWd0YWJsZS52Mi5NdXRhdGVSb3dzUmVzcG9uc2UuRW50cnlSB2VudHJpZXMaSQoFRW50cnkSFAoFaW5kZXgYASABKANSBWluZGV4EioKBnN0YXR1cxgCIAEoCzISLmdvb2dsZS5ycGMuU3RhdHVzUgZzdGF0dXM=');
...
final $typed_data.Uint8List checkAndMutateRowResponseDescriptor = $convert.base64Decode('ChlDaGVja0FuZE11dGF0ZVJvd1Jlc3BvbnNlEisKEXByZWRpY2F0ZV9tYXRjaGVkGAEgASgIUhBwcmVkaWNhdGVNYXRjaGVk');
...
final $typed_data.Uint8List pingAndWarmRequestDescriptor = $convert.base64Decode('ChJQaW5nQW5kV2FybVJlcXVlc3QSQQoEbmFtZRgBIAEoCUIt4EEC+kEnCiViaWd0YWJsZWFkbWluLmdvb2dsZWFwaXMuY29tL0luc3RhbmNlUgRuYW1lEiQKDmFwcF9wcm9maWxlX2lkGAIgASgJUgxhcHBQcm9maWxlSWQ=');
...
final $typed_data.Uint8List pingAndWarmResponseDescriptor = $convert.base64Decode('ChNQaW5nQW5kV2FybVJlc3BvbnNl');
...
const ReadModifyWriteRowRequest$json = const {
  ...
  '2': const [
    ...
    const {'1': 'app_profile_id', '3': 4, '4': 1, '5': 9, '10': 'appProfileId'},
    const {'1': 'row_key', '3': 2, '4': 1, '5': 12, '8': const {}, '10': 'rowKey'},
    const {'1': 'rules', '3': 3, '4': 3, '5': 11, '6': '.google.bigtable.v2.ReadModifyWriteRule', '8': const {}, '10': 'rules'},
  ],
};

/// Descriptor for `ReadModifyWriteRowRequest`. Decode as a `google.protobuf.DescriptorProto`.
final $typed_data.Uint8List readModifyWriteRowRequestDescriptor = $convert.base64Decode('');
...
final $typed_data.Uint8List readModifyWriteRowResponseDescriptor = $convert.base64Decode('ChpSZWFkTW9kaWZ5V3JpdGVSb3dSZXNwb25zZRIpCgNyb3cYASABKAsyFy5nb29nbGUuYmlndGFibGUudjIuUm93UgNyb3c=');

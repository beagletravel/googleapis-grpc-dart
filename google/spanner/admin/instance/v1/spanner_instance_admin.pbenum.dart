...
class ReplicaInfo_ReplicaType extends $pb.ProtobufEnum {
  static const ReplicaInfo_ReplicaType TYPE_UNSPECIFIED = ReplicaInfo_ReplicaType._(0, const $core.bool.fromEnvironment('protobuf.omit_enum_names') ? '' : 'TYPE_UNSPECIFIED');
  static const ReplicaInfo_ReplicaType READ_WRITE = ReplicaInfo_ReplicaType._(1, const $core.bool.fromEnvironment('protobuf.omit_enum_names') ? '' : 'READ_WRITE');
  static const ReplicaInfo_ReplicaType READ_ONLY = ReplicaInfo_ReplicaType._(2, const $core.bool.fromEnvironment('protobuf.omit_enum_names') ? '' : 'READ_ONLY');
  static const ReplicaInfo_ReplicaType WITNESS = ReplicaInfo_ReplicaType._(3, const $core.bool.fromEnvironment('protobuf.omit_enum_names') ? '' : 'WITNESS');

...
final $typed_data.Uint8List databaseDialectDescriptor = $convert.base64Decode('Cg9EYXRhYmFzZURpYWxlY3QSIAocREFUQUJBU0VfRElBTEVDVF9VTlNQRUNJRklFRBAAEhcKE0dPT0dMRV9TVEFOREFSRF9TUUwQARIOCgpQT1NUR1JFU1FMEAI=');
...
final $typed_data.Uint8List operationProgressDescriptor = $convert.base64Decode('ChFPcGVyYXRpb25Qcm9ncmVzcxIpChBwcm9ncmVzc19wZXJjZW50GAEgASgFUg9wcm9ncmVzc1BlcmNlbnQSOQoKc3RhcnRfdGltZRgCIAEoCzIaLmdvb2dsZS5wcm90b2J1Zi5UaW1lc3RhbXBSCXN0YXJ0VGltZRI1CghlbmRfdGltZRgDIAEoCzIaLmdvb2dsZS5wcm90b2J1Zi5UaW1lc3RhbXBSB2VuZFRpbWU=');
...
final $typed_data.Uint8List encryptionConfigDescriptor = $convert.base64Decode('ChBFbmNyeXB0aW9uQ29uZmlnEkgKDGttc19rZXlfbmFtZRgCIAEoCUIm+kEjCiFjbG91ZGttcy5nb29nbGVhcGlzLmNvbS9DcnlwdG9LZXlSCmttc0tleU5hbWU=');
@$core.Deprecated('Use encryptionInfoDescriptor instead')
const EncryptionInfo$json = const {
  '1': 'EncryptionInfo',
  '2': const [
    const {'1': 'encryption_type', '3': 3, '4': 1, '5': 14, '6': '.google.spanner.admin.database.v1.EncryptionInfo.Type', '8': const {}, '10': 'encryptionType'},
...
final $typed_data.Uint8List encryptionInfoDescriptor = $convert.base64Decode('');

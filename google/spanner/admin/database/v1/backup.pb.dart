...
class Backup extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'Backup', package: const $pb.PackageName(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'google.spanner.admin.database.v1'), createEmptyInstance: create)
    ..aOS(1, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'name')
    ..aOS(2, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'database')
    ..aOM<$2.Timestamp>(3, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'expireTime', subBuilder: $2.Timestamp.create)
    ...
    ..e<Backup_State>(6, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'state', $pb.PbFieldType.OE, defaultOrMaker: Backup_State.STATE_UNSPECIFIED, valueOf: Backup_State.valueOf, enumValues: Backup_State.values)
    ..pPS(7, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'referencingDatabases')
    ..aOM<$3.EncryptionInfo>(8, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'encryptionInfo', subBuilder: $3.EncryptionInfo.create)
    ..aOM<$2.Timestamp>(9, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'versionTime', subBuilder: $2.Timestamp.create)
    ..e<$3.DatabaseDialect>(10, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'databaseDialect', $pb.PbFieldType.OE, defaultOrMaker: $3.DatabaseDialect.DATABASE_DIALECT_UNSPECIFIED, valueOf: $3.DatabaseDialect.valueOf, enumValues: $3.DatabaseDialect.values)
    ..pPS(11, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'referencingBackups')
    ..aOM<$2.Timestamp>(12, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'maxExpireTime', subBuilder: $2.Timestamp.create)
  ...
  @$pb.TagNumber(3)
  set expireTime($2.Timestamp v) { setField(3, v); }
  @$pb.TagNumber(3)
  ...
  @$pb.TagNumber(6)
  set state(Backup_State v) { setField(6, v); }
  @$pb.TagNumber(6)
  ...
  @$pb.TagNumber(8)
  set encryptionInfo($3.EncryptionInfo v) { setField(8, v); }
  @$pb.TagNumber(8)
  ...
  @$pb.TagNumber(9)
  set versionTime($2.Timestamp v) { setField(9, v); }
  @$pb.TagNumber(9)
  ...
  @$pb.TagNumber(10)
  set databaseDialect($3.DatabaseDialect v) { setField(10, v); }
  @$pb.TagNumber(10)
  ...
  @$pb.TagNumber(12)
  set maxExpireTime($2.Timestamp v) { setField(12, v); }
  @$pb.TagNumber(12)
...
class CreateBackupRequest extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'CreateBackupRequest', package: const $pb.PackageName(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'google.spanner.admin.database.v1'), createEmptyInstance: create)
    ...
    ..aOM<CreateBackupEncryptionConfig>(4, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'encryptionConfig', subBuilder: CreateBackupEncryptionConfig.create)
    ..hasRequiredFields = false
  ;
  ...
  @$pb.TagNumber(4)
  set encryptionConfig(CreateBackupEncryptionConfig v) { setField(4, v); }
  @$pb.TagNumber(4)
...
class CreateBackupMetadata extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'CreateBackupMetadata', package: const $pb.PackageName(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'google.spanner.admin.database.v1'), createEmptyInstance: create)
    ..aOS(1, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'name')
    ..aOS(2, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'database')
    ..aOM<$3.OperationProgress>(3, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'progress', subBuilder: $3.OperationProgress.create)
    ..aOM<$2.Timestamp>(4, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'cancelTime', subBuilder: $2.Timestamp.create)
    ..hasRequiredFields = false
  ;
  ...
  @$pb.TagNumber(3)
  set progress($3.OperationProgress v) { setField(3, v); }
  @$pb.TagNumber(3)
  ...
  @$pb.TagNumber(4)
  set cancelTime($2.Timestamp v) { setField(4, v); }
  @$pb.TagNumber(4)
...
class CopyBackupRequest extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'CopyBackupRequest', package: const $pb.PackageName(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'google.spanner.admin.database.v1'), createEmptyInstance: create)
    ..aOS(1, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'parent')
    ..aOS(2, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'backupId')
    ..aOS(3, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'sourceBackup')
    ..aOM<$2.Timestamp>(4, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'expireTime', subBuilder: $2.Timestamp.create)
    ..aOM<CopyBackupEncryptionConfig>(5, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'encryptionConfig', subBuilder: CopyBackupEncryptionConfig.create)
    ..hasRequiredFields = false
  ;
  ...
  factory CopyBackupRequest.fromBuffer($core.List<$core.int> i, [$pb.ExtensionRegistry r = $pb.ExtensionRegistry.EMPTY]) => create()..mergeFromBuffer(i, r);
  factory CopyBackupRequest.fromJson($core.String i, [$pb.ExtensionRegistry r = $pb.ExtensionRegistry.EMPTY]) => create()..mergeFromJson(i, r);
  @$core.Deprecated(
  'Using this can add significant overhead to your binary. '
  'Use [GeneratedMessageGenericExtensions.deepCopy] instead. '
  'Will be removed in next major version')
  ...
  'Use [GeneratedMessageGenericExtensions.rebuild] instead. '
  'Will be removed in next major version')
  CopyBackupRequest copyWith(void Function(CopyBackupRequest) updates) => super.copyWith((message) => updates(message as CopyBackupRequest)) as CopyBackupRequest; // ignore: deprecated_member_use
  $pb.BuilderInfo get info_ => _i;
  @$core.pragma('dart2js:noInline')
  static CopyBackupRequest create() => CopyBackupRequest._();
  CopyBackupRequest createEmptyInstance() => create();
  static $pb.PbList<CopyBackupRequest> createRepeated() => $pb.PbList<CopyBackupRequest>();
  @$core.pragma('dart2js:noInline')
  static CopyBackupRequest getDefault() => _defaultInstance ??= $pb.GeneratedMessage.$_defaultFor<CopyBackupRequest>(create);
  ...
  @$pb.TagNumber(5)
  set encryptionConfig(CopyBackupEncryptionConfig v) { setField(5, v); }
  @$pb.TagNumber(5)
...
class CopyBackupMetadata extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'CopyBackupMetadata', package: const $pb.PackageName(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'google.spanner.admin.database.v1'), createEmptyInstance: create)
    ..aOS(1, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'name')
    ..aOS(2, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'sourceBackup')
    ..aOM<$3.OperationProgress>(3, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'progress', subBuilder: $3.OperationProgress.create)
    ..aOM<$2.Timestamp>(4, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'cancelTime', subBuilder: $2.Timestamp.create)
    ..hasRequiredFields = false
  ;
  ...
  factory CopyBackupMetadata.fromBuffer($core.List<$core.int> i, [$pb.ExtensionRegistry r = $pb.ExtensionRegistry.EMPTY]) => create()..mergeFromBuffer(i, r);
  factory CopyBackupMetadata.fromJson($core.String i, [$pb.ExtensionRegistry r = $pb.ExtensionRegistry.EMPTY]) => create()..mergeFromJson(i, r);
  @$core.Deprecated(
  'Using this can add significant overhead to your binary. '
  'Use [GeneratedMessageGenericExtensions.deepCopy] instead. '
  'Will be removed in next major version')
  ...
  'Use [GeneratedMessageGenericExtensions.rebuild] instead. '
  'Will be removed in next major version')
  CopyBackupMetadata copyWith(void Function(CopyBackupMetadata) updates) => super.copyWith((message) => updates(message as CopyBackupMetadata)) as CopyBackupMetadata; // ignore: deprecated_member_use
  $pb.BuilderInfo get info_ => _i;
  @$core.pragma('dart2js:noInline')
  static CopyBackupMetadata create() => CopyBackupMetadata._();
  CopyBackupMetadata createEmptyInstance() => create();
  static $pb.PbList<CopyBackupMetadata> createRepeated() => $pb.PbList<CopyBackupMetadata>();
  @$core.pragma('dart2js:noInline')
  static CopyBackupMetadata getDefault() => _defaultInstance ??= $pb.GeneratedMessage.$_defaultFor<CopyBackupMetadata>(create);
...
class UpdateBackupRequest extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'UpdateBackupRequest', package: const $pb.PackageName(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'google.spanner.admin.database.v1'), createEmptyInstance: create)
    ..aOM<Backup>(1, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'backup', subBuilder: Backup.create)
...
class GetBackupRequest extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'GetBackupRequest', package: const $pb.PackageName(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'google.spanner.admin.database.v1'), createEmptyInstance: create)
    ..aOS(1, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'name')
    ..hasRequiredFields = false
  ;
...
class DeleteBackupRequest extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'DeleteBackupRequest', package: const $pb.PackageName(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'google.spanner.admin.database.v1'), createEmptyInstance: create)
    ..aOS(1, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'name')
    ..hasRequiredFields = false
  ;
...
class ListBackupsRequest extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'ListBackupsRequest', package: const $pb.PackageName(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'google.spanner.admin.database.v1'), createEmptyInstance: create)
    ..aOS(1, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'parent')
...
class ListBackupsResponse extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'ListBackupsResponse', package: const $pb.PackageName(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'google.spanner.admin.database.v1'), createEmptyInstance: create)
...
class ListBackupOperationsRequest extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'ListBackupOperationsRequest', package: const $pb.PackageName(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'google.spanner.admin.database.v1'), createEmptyInstance: create)
    ..aOS(1, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'parent')
    ..aOS(2, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'filter')
    ..a<$core.int>(3, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'pageSize', $pb.PbFieldType.O3)
    ..aOS(4, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'pageToken')
  ...
  factory ListBackupOperationsRequest.fromBuffer($core.List<$core.int> i, [$pb.ExtensionRegistry r = $pb.ExtensionRegistry.EMPTY]) => create()..mergeFromBuffer(i, r);
  factory ListBackupOperationsRequest.fromJson($core.String i, [$pb.ExtensionRegistry r = $pb.ExtensionRegistry.EMPTY]) => create()..mergeFromJson(i, r);
  @$core.Deprecated(
  'Using this can add significant overhead to your binary. '
  'Use [GeneratedMessageGenericExtensions.deepCopy] instead. '
  'Will be removed in next major version')
  ListBackupOperationsRequest clone() => ListBackupOperationsRequest()..mergeFromMessage(this);
  @$core.Deprecated(
  'Using this can add significant overhead to your binary. '
  'Use [GeneratedMessageGenericExtensions.rebuild] instead. '
  'Will be removed in next major version')
  ListBackupOperationsRequest copyWith(void Function(ListBackupOperationsRequest) updates) => super.copyWith((message) => updates(message as ListBackupOperationsRequest)) as ListBackupOperationsRequest; // ignore: deprecated_member_use
  $pb.BuilderInfo get info_ => _i;
  @$core.pragma('dart2js:noInline')
  static ListBackupOperationsRequest create() => ListBackupOperationsRequest._();
  ListBackupOperationsRequest createEmptyInstance() => create();
  static $pb.PbList<ListBackupOperationsRequest> createRepeated() => $pb.PbList<ListBackupOperationsRequest>();
  @$core.pragma('dart2js:noInline')
  static ListBackupOperationsRequest getDefault() => _defaultInstance ??= $pb.GeneratedMessage.$_defaultFor<ListBackupOperationsRequest>(create);
...
class ListBackupOperationsResponse extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'ListBackupOperationsResponse', package: const $pb.PackageName(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'google.spanner.admin.database.v1'), createEmptyInstance: create)
    ..pc<$0.Operation>(1, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'operations', $pb.PbFieldType.PM, subBuilder: $0.Operation.create)
    ..aOS(2, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'nextPageToken')
    ..hasRequiredFields = false
  ;
  ...
  factory ListBackupOperationsResponse.fromBuffer($core.List<$core.int> i, [$pb.ExtensionRegistry r = $pb.ExtensionRegistry.EMPTY]) => create()..mergeFromBuffer(i, r);
  factory ListBackupOperationsResponse.fromJson($core.String i, [$pb.ExtensionRegistry r = $pb.ExtensionRegistry.EMPTY]) => create()..mergeFromJson(i, r);
  @$core.Deprecated(
  'Using this can add significant overhead to your binary. '
  'Use [GeneratedMessageGenericExtensions.deepCopy] instead. '
  'Will be removed in next major version')
  ListBackupOperationsResponse clone() => ListBackupOperationsResponse()..mergeFromMessage(this);
  @$core.Deprecated(
  'Using this can add significant overhead to your binary. '
  'Use [GeneratedMessageGenericExtensions.rebuild] instead. '
  'Will be removed in next major version')
  ListBackupOperationsResponse copyWith(void Function(ListBackupOperationsResponse) updates) => super.copyWith((message) => updates(message as ListBackupOperationsResponse)) as ListBackupOperationsResponse; // ignore: deprecated_member_use
  $pb.BuilderInfo get info_ => _i;
  @$core.pragma('dart2js:noInline')
  static ListBackupOperationsResponse create() => ListBackupOperationsResponse._();
  ListBackupOperationsResponse createEmptyInstance() => create();
  static $pb.PbList<ListBackupOperationsResponse> createRepeated() => $pb.PbList<ListBackupOperationsResponse>();
  @$core.pragma('dart2js:noInline')
  static ListBackupOperationsResponse getDefault() => _defaultInstance ??= $pb.GeneratedMessage.$_defaultFor<ListBackupOperationsResponse>(create);
...
class BackupInfo extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'BackupInfo', package: const $pb.PackageName(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'google.spanner.admin.database.v1'), createEmptyInstance: create)
    ..aOS(1, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'backup')
    ...
    ..aOM<$2.Timestamp>(4, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'versionTime', subBuilder: $2.Timestamp.create)
    ..hasRequiredFields = false
  ;
  ...
  'Use [GeneratedMessageGenericExtensions.rebuild] instead. '
  'Will be removed in next major version')
  BackupInfo copyWith(void Function(BackupInfo) updates) => super.copyWith((message) => updates(message as BackupInfo)) as BackupInfo; // ignore: deprecated_member_use
  $pb.BuilderInfo get info_ => _i;
  @$core.pragma('dart2js:noInline')
  ...
  @$pb.TagNumber(4)
  set versionTime($2.Timestamp v) { setField(4, v); }
  @$pb.TagNumber(4)
...
class CreateBackupEncryptionConfig extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'CreateBackupEncryptionConfig', package: const $pb.PackageName(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'google.spanner.admin.database.v1'), createEmptyInstance: create)
    ..e<CreateBackupEncryptionConfig_EncryptionType>(1, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'encryptionType', $pb.PbFieldType.OE, defaultOrMaker: CreateBackupEncryptionConfig_EncryptionType.ENCRYPTION_TYPE_UNSPECIFIED, valueOf: CreateBackupEncryptionConfig_EncryptionType.valueOf, enumValues: CreateBackupEncryptionConfig_EncryptionType.values)
  ...
  factory CreateBackupEncryptionConfig.fromBuffer($core.List<$core.int> i, [$pb.ExtensionRegistry r = $pb.ExtensionRegistry.EMPTY]) => create()..mergeFromBuffer(i, r);
  factory CreateBackupEncryptionConfig.fromJson($core.String i, [$pb.ExtensionRegistry r = $pb.ExtensionRegistry.EMPTY]) => create()..mergeFromJson(i, r);
  @$core.Deprecated(
  'Using this can add significant overhead to your binary. '
  'Use [GeneratedMessageGenericExtensions.deepCopy] instead. '
  'Will be removed in next major version')
  CreateBackupEncryptionConfig clone() => CreateBackupEncryptionConfig()..mergeFromMessage(this);
  @$core.Deprecated(
  'Using this can add significant overhead to your binary. '
  'Use [GeneratedMessageGenericExtensions.rebuild] instead. '
  'Will be removed in next major version')
  CreateBackupEncryptionConfig copyWith(void Function(CreateBackupEncryptionConfig) updates) => super.copyWith((message) => updates(message as CreateBackupEncryptionConfig)) as CreateBackupEncryptionConfig; // ignore: deprecated_member_use
  $pb.BuilderInfo get info_ => _i;
  @$core.pragma('dart2js:noInline')
  static CreateBackupEncryptionConfig create() => CreateBackupEncryptionConfig._();
  CreateBackupEncryptionConfig createEmptyInstance() => create();
  static $pb.PbList<CreateBackupEncryptionConfig> createRepeated() => $pb.PbList<CreateBackupEncryptionConfig>();
  @$core.pragma('dart2js:noInline')
  static CreateBackupEncryptionConfig getDefault() => _defaultInstance ??= $pb.GeneratedMessage.$_defaultFor<CreateBackupEncryptionConfig>(create);
  ...
  @$pb.TagNumber(1)
  set encryptionType(CreateBackupEncryptionConfig_EncryptionType v) { setField(1, v); }
  @$pb.TagNumber(1)
...
class CopyBackupEncryptionConfig extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'CopyBackupEncryptionConfig', package: const $pb.PackageName(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'google.spanner.admin.database.v1'), createEmptyInstance: create)
    ..e<CopyBackupEncryptionConfig_EncryptionType>(1, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'encryptionType', $pb.PbFieldType.OE, defaultOrMaker: CopyBackupEncryptionConfig_EncryptionType.ENCRYPTION_TYPE_UNSPECIFIED, valueOf: CopyBackupEncryptionConfig_EncryptionType.valueOf, enumValues: CopyBackupEncryptionConfig_EncryptionType.values)
    ..aOS(2, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'kmsKeyName')
    ..hasRequiredFields = false
  ;
  ...
  factory CopyBackupEncryptionConfig.fromBuffer($core.List<$core.int> i, [$pb.ExtensionRegistry r = $pb.ExtensionRegistry.EMPTY]) => create()..mergeFromBuffer(i, r);
  factory CopyBackupEncryptionConfig.fromJson($core.String i, [$pb.ExtensionRegistry r = $pb.ExtensionRegistry.EMPTY]) => create()..mergeFromJson(i, r);
  @$core.Deprecated(
  'Using this can add significant overhead to your binary. '
  'Use [GeneratedMessageGenericExtensions.deepCopy] instead. '
  'Will be removed in next major version')
  CopyBackupEncryptionConfig clone() => CopyBackupEncryptionConfig()..mergeFromMessage(this);
  @$core.Deprecated(
  'Using this can add significant overhead to your binary. '
  'Use [GeneratedMessageGenericExtensions.rebuild] instead. '
  'Will be removed in next major version')
  CopyBackupEncryptionConfig copyWith(void Function(CopyBackupEncryptionConfig) updates) => super.copyWith((message) => updates(message as CopyBackupEncryptionConfig)) as CopyBackupEncryptionConfig; // ignore: deprecated_member_use
  $pb.BuilderInfo get info_ => _i;
  @$core.pragma('dart2js:noInline')
  ...
  static $pb.PbList<CopyBackupEncryptionConfig> createRepeated() => $pb.PbList<CopyBackupEncryptionConfig>();
  @$core.pragma('dart2js:noInline')
  static CopyBackupEncryptionConfig getDefault() => _defaultInstance ??= $pb.GeneratedMessage.$_defaultFor<CopyBackupEncryptionConfig>(create);
  static CopyBackupEncryptionConfig? _defaultInstance;

  @$pb.TagNumber(1)
  CopyBackupEncryptionConfig_EncryptionType get encryptionType => $_getN(0);
  @$pb.TagNumber(1)
  set encryptionType(CopyBackupEncryptionConfig_EncryptionType v) { setField(1, v); }
  @$pb.TagNumber(1)
  $core.bool hasEncryptionType() => $_has(0);
  @$pb.TagNumber(1)
  void clearEncryptionType() => clearField(1);
